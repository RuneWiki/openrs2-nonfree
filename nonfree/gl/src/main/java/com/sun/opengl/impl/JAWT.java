...
public abstract class JAWT {
	...
	private static int method5007() {
		return Class184.method4959() ? JAWT_Sub1.method5028() : JAWT_Sub2.method5039();
	}

	@OriginalMember(owner = "gl!com/sun/opengl/impl/JAWT", name = "create", descriptor = "()Lgl!com/sun/opengl/impl/JAWT;")
	public static JAWT method5029() {
		return method5030(Class183.method4951(method5007()));
	}
	...
	private static JAWT method5030(@OriginalArg(0) ByteBuffer arg0) {
		return Class184.method4959() ? new JAWT_Sub1(arg0) : new JAWT_Sub2(arg0);
	}

	@OriginalMember(owner = "gl!com/sun/opengl/impl/JAWT", name = "getJAWT", descriptor = "()Lgl!com/sun/opengl/impl/JAWT;")
	public static JAWT method5037() {
		if (aJAWT3 == null) {
			...
			synchronized (JAWT.class) {
				if (aJAWT3 == null) {
					AccessController.doPrivileged(new PrivilegedAction() {
						...
						@Override
						public Object run() {
							@Pc(1) JAWT local1 = JAWT.method5029();
							local1.method5032();
							if (!JAWTFactory.method5040(local1)) {
	...
	public final JAWT_DrawingSurface method5033(@OriginalArg(0) Object arg0) {
		@Pc(5) ByteBuffer local5 = this.GetDrawingSurface0(this.method5031(), arg0);
		return local5 == null ? null : JAWT_DrawingSurface.method5053(local5.order(ByteOrder.nativeOrder()));
	}
	...
	public final void method5034(@OriginalArg(0) JAWT_DrawingSurface arg0) {
		this.FreeDrawingSurface0(this.method5031(), arg0 == null ? null : arg0.method5054());
	}
	...
	public final void method5035() {
		this.Lock0(this.method5031());
	}
