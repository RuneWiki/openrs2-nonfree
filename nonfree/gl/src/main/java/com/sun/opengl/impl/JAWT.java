...
public abstract class JAWT {
	...
	private static int method4916() {
		return Class184.method4868() ? JAWT_Sub1.method4937() : JAWT_Sub2.method4948();
	}

	@OriginalMember(owner = "gl!com/sun/opengl/impl/JAWT", name = "create", descriptor = "()Lgl!com/sun/opengl/impl/JAWT;")
	public static JAWT method4938() {
		return method4939(Class183.method4860(method4916()));
	}
	...
	private static JAWT method4939(@OriginalArg(0) ByteBuffer arg0) {
		return Class184.method4868() ? new JAWT_Sub1(arg0) : new JAWT_Sub2(arg0);
	}

	@OriginalMember(owner = "gl!com/sun/opengl/impl/JAWT", name = "getJAWT", descriptor = "()Lgl!com/sun/opengl/impl/JAWT;")
	public static JAWT method4946() {
		if (aJAWT3 == null) {
			...
			synchronized (JAWT.class) {
				if (aJAWT3 == null) {
					AccessController.doPrivileged(new PrivilegedAction() {
						...
						@Override
						public Object run() {
							@Pc(1) JAWT local1 = JAWT.method4938();
							local1.method4941();
							if (!JAWTFactory.method4949(local1)) {
	...
	public final JAWT_DrawingSurface method4942(@OriginalArg(0) Object arg0) {
		@Pc(5) ByteBuffer local5 = this.GetDrawingSurface0(this.method4940(), arg0);
		return local5 == null ? null : JAWT_DrawingSurface.method4962(local5.order(ByteOrder.nativeOrder()));
	}
	...
	public final void method4943(@OriginalArg(0) JAWT_DrawingSurface arg0) {
		this.FreeDrawingSurface0(this.method4940(), arg0 == null ? null : arg0.method4963());
	}
	...
	public final void method4944() {
		this.Lock0(this.method4940());
	}
	...
	public final void method4945() {
		this.Unlock0(this.method4940());
	}
