...
public abstract class JAWT {
	...
	private static int method4386() {
		return Class184.method4338() ? JAWT_Sub1.method4407() : JAWT_Sub2.method4418();
	}

	@OriginalMember(owner = "gl!com/sun/opengl/impl/JAWT", name = "create", descriptor = "()Lgl!com/sun/opengl/impl/JAWT;")
	public static JAWT method4408() {
		return method4409(Class183.method4330(method4386()));
	}
	...
	private static JAWT method4409(@OriginalArg(0) ByteBuffer arg0) {
		return Class184.method4338() ? new JAWT_Sub1(arg0) : new JAWT_Sub2(arg0);
	}

	@OriginalMember(owner = "gl!com/sun/opengl/impl/JAWT", name = "getJAWT", descriptor = "()Lgl!com/sun/opengl/impl/JAWT;")
	public static JAWT method4416() {
		if (aJAWT3 == null) {
			...
			synchronized (JAWT.class) {
				if (aJAWT3 == null) {
					AccessController.doPrivileged(new PrivilegedAction() {
						...
						@Override
						public Object run() {
							@Pc(1) JAWT local1 = JAWT.method4408();
							local1.method4411();
							if (!JAWTFactory.method4419(local1)) {
	...
	public final JAWT_DrawingSurface method4412(@OriginalArg(0) Object arg0) {
		@Pc(5) ByteBuffer local5 = this.GetDrawingSurface0(this.method4410(), arg0);
		return local5 == null ? null : JAWT_DrawingSurface.method4432(local5.order(ByteOrder.nativeOrder()));
	}
	...
	public final void method4413(@OriginalArg(0) JAWT_DrawingSurface arg0) {
		this.FreeDrawingSurface0(this.method4410(), arg0 == null ? null : arg0.method4433());
	}
	...
	public final void method4415() {
		this.Unlock0(this.method4410());
	}
