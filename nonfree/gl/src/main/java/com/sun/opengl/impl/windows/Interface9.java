...
public interface Interface9 {
	...
	boolean method5213(@OriginalArg(0) long arg0, @OriginalArg(1) int[] arg1, @OriginalArg(3) float[] arg2, @OriginalArg(6) int[] arg3, @OriginalArg(8) int[] arg4);
	...
	boolean method5215(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int[] arg3, @OriginalArg(6) int[] arg4);

	@OriginalMember(owner = "gl!com/sun/opengl/impl/windows/WGLExt", name = "wglSwapIntervalEXT", descriptor = "(I)Z")
	boolean method5216(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "gl!com/sun/opengl/impl/windows/WGLExt", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z")
	boolean method5217(@OriginalArg(0) String arg0);
}
