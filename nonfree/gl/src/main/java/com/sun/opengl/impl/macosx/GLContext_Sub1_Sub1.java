...
public abstract class GLContext_Sub1_Sub1 extends GLContext_Sub1 {
	...
	protected abstract boolean method5090();

	@OriginalMember(owner = "gl!com/sun/opengl/impl/macosx/MacOSXGLContext", name = "create", descriptor = "(ZZ)Z")
	protected final boolean method5091() {
		@Pc(1) long local1 = 0L;
		@Pc(4) int[] local4 = new int[1];
		@Pc(8) GLCapabilities local8 = this.aClass195_Sub1_2.method5094();
		...
		@Pc(160) long local160 = CGL.method5072(local11, local131, local14);
		if (local160 == 0L) {
			throw new GLException("Unable to allocate pixel format with requested GLCapabilities");
		}
		try {
			this.aLong1376 = CGL.method5071(local1, this.aClass195_Sub1_2.method5093(), local160, local4);
			if (this.aLong1376 != 0L) {
				...
				CGL.method5073(local160, local11, local131, local14);
	...
	protected int makeCurrentImpl() throws GLException {
		...
		if (!CGL.makeCurrentContext(this.aLong1376)) {
	...
	protected final void releaseImpl() throws GLException {
		if (!CGL.clearCurrentContext(this.aLong1376)) {
	...
	protected final void destroyImpl() throws GLException {
		if (this.aLong1376 != 0L) {
			if (!CGL.deleteContext(this.aLong1376)) {
	...
	public final void setSwapInterval(@OriginalArg(0) int arg0) {
		...
		CGL.setSwapInterval(this.aLong1376, arg0);
	}
