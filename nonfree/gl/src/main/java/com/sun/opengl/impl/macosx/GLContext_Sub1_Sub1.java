...
public abstract class GLContext_Sub1_Sub1 extends GLContext_Sub1 {
	...
	protected abstract boolean method4697();

	@OriginalMember(owner = "gl!com/sun/opengl/impl/macosx/MacOSXGLContext", name = "create", descriptor = "(ZZ)Z")
	protected final boolean method4698() {
		@Pc(1) long local1 = 0L;
		@Pc(4) int[] local4 = new int[1];
		@Pc(8) GLCapabilities local8 = this.aClass195_Sub1_2.method4701();
		...
		@Pc(160) long local160 = CGL.method4679(local11, local131, local14);
		if (local160 == 0L) {
			throw new GLException("Unable to allocate pixel format with requested GLCapabilities");
		}
		try {
			this.aLong1262 = CGL.method4678(local1, this.aClass195_Sub1_2.method4700(), local160, local4);
			if (this.aLong1262 != 0L) {
				...
				CGL.method4680(local160, local11, local131, local14);
	...
	protected int makeCurrentImpl() throws GLException {
		...
		if (!CGL.makeCurrentContext(this.aLong1262)) {
	...
	protected final void releaseImpl() throws GLException {
		if (!CGL.clearCurrentContext(this.aLong1262)) {
	...
	protected final void destroyImpl() throws GLException {
		if (this.aLong1262 != 0L) {
			if (!CGL.deleteContext(this.aLong1262)) {
	...
	public final void setSwapInterval(@OriginalArg(0) int arg0) {
		...
		CGL.setSwapInterval(this.aLong1262, arg0);
	}
