...
public class GLContext_Sub1_Sub2 extends GLContext_Sub1 {
	...
	public final Object method4844() {
	...
	private void method4846() {
		if (this.aClass195_Sub2_2.method4848() == 0L) {
			throw new GLException("Internal error: attempted to create OpenGL context without an associated drawable");
		}
		this.aLong1320 = WGL.wglCreateContext(this.aClass195_Sub2_2.method4848());
		if (this.aLong1320 == 0L) {
			throw new GLException("Unable to create OpenGL context for device context " + toHexString(this.aClass195_Sub2_2.method4848()));
		}
	}
	...
	protected int makeCurrentImpl() throws GLException {
		...
		if (!WGL.wglMakeCurrent(this.aClass195_Sub2_2.method4848(), this.aLong1320)) {
	...
	protected final void destroyImpl() throws GLException {
		if (this.aLong1320 != 0L) {
			if (!WGL.wglDeleteContext(this.aLong1320)) {
	...
	protected final void resetGLFunctionAvailability() {
		...
		this.resetProcAddressTable(this.method4847());
	}
	...
	public final Class203 method4847() {
	...
	public final String getPlatformExtensionsString() {
		...
		return this.aBoolean472 ? this.method4845().method4821() : "";
	}
	...
	public final void setSwapInterval(@OriginalArg(0) int arg0) {
		@Pc(2) Interface9 local2 = this.method4845();
		if (local2.method4824("WGL_EXT_swap_control")) {
			local2.method4823(arg0);
		}
	}
}
