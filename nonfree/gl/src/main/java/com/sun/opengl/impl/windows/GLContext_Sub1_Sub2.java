...
public class GLContext_Sub1_Sub2 extends GLContext_Sub1 {
	...
	public final Object method4616() {
		return this.method4617();
	}
	...
	private void method4618() {
		if (this.aClass195_Sub2_2.method4620() == 0L) {
			throw new GLException("Internal error: attempted to create OpenGL context without an associated drawable");
		}
		this.aLong1322 = WGL.wglCreateContext(this.aClass195_Sub2_2.method4620());
		if (this.aLong1322 == 0L) {
			throw new GLException("Unable to create OpenGL context for device context " + toHexString(this.aClass195_Sub2_2.method4620()));
		}
	}
	...
	protected int makeCurrentImpl() throws GLException {
		...
		if (!WGL.wglMakeCurrent(this.aClass195_Sub2_2.method4620(), this.aLong1322)) {
	...
	protected final void destroyImpl() throws GLException {
		if (this.aLong1322 != 0L) {
			if (!WGL.wglDeleteContext(this.aLong1322)) {
	...
	protected final void resetGLFunctionAvailability() {
		...
		this.resetProcAddressTable(this.method4619());
	}
	...
	public final Class203 method4619() {
	...
	public final String getPlatformExtensionsString() {
		if (!this.aBoolean499) {
			this.aBoolean500 = WGL.wglGetProcAddress("wglGetExtensionsStringEXT") != 0L;
			this.aBoolean499 = true;
		}
		return this.aBoolean500 ? this.method4617().method4593() : "";
	}
	...
	public final void setSwapInterval(@OriginalArg(0) int arg0) {
		@Pc(2) Interface9 local2 = this.method4617();
		if (local2.method4596("WGL_EXT_swap_control")) {
			local2.method4595(arg0);
		}
	}
}
