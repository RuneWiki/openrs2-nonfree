...
public class GLContext_Sub1_Sub2 extends GLContext_Sub1 {
	...
	public final Object method5146() {
	...
	private void method5148() {
		if (this.aClass195_Sub2_2.method5150() == 0L) {
			throw new GLException("Internal error: attempted to create OpenGL context without an associated drawable");
		}
		this.aLong1321 = WGL.wglCreateContext(this.aClass195_Sub2_2.method5150());
		if (this.aLong1321 == 0L) {
			throw new GLException("Unable to create OpenGL context for device context " + toHexString(this.aClass195_Sub2_2.method5150()));
		}
	}
	...
	protected int makeCurrentImpl() throws GLException {
		...
		if (!WGL.wglMakeCurrent(this.aClass195_Sub2_2.method5150(), this.aLong1321)) {
	...
	protected final void destroyImpl() throws GLException {
		if (this.aLong1321 != 0L) {
			if (!WGL.wglDeleteContext(this.aLong1321)) {
	...
	protected final void resetGLFunctionAvailability() {
		...
		this.resetProcAddressTable(this.method5149());
	}
	...
	public final Class203 method5149() {
	...
	public final String getPlatformExtensionsString() {
		if (!this.aBoolean365) {
			this.aBoolean366 = WGL.wglGetProcAddress("wglGetExtensionsStringEXT") != 0L;
			this.aBoolean365 = true;
		}
		return this.aBoolean366 ? this.method5147().method5123() : "";
	}
	...
	public final void setSwapInterval(@OriginalArg(0) int arg0) {
		@Pc(2) Interface9 local2 = this.method5147();
		if (local2.method5126("WGL_EXT_swap_control")) {
			local2.method5125(arg0);
		}
	}
}
