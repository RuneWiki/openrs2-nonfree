...
public final class WGLExtImpl implements Interface9 {
	...
	@Override
	public boolean method4820(@OriginalArg(0) long arg0, @OriginalArg(1) int[] arg1, @OriginalArg(3) float[] arg2, @OriginalArg(6) int[] arg3, @OriginalArg(8) int[] arg4) {
		if (arg1 != null && arg1.length <= 0) {
			...
			@Pc(104) long local104 = this.aGLContext_Sub1_Sub2_1.method4847().aLong1269;
			if (local104 == 0L) {
	...
	public String method4821() {
		@Pc(4) long local4 = this.aGLContext_Sub1_Sub2_1.method4847().aLong1289;
		if (local4 == 0L) {
	...
	@Override
	public boolean method4822(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int[] arg3, @OriginalArg(6) int[] arg4) {
		if (arg3 != null && arg3.length <= 0) {
			throw new GLException("array offset argument \"piAttributes_offset\" (" + ") equals or exceeds array length (" + arg3.length + ")");
		} else if (arg4 == null || arg4.length > 0) {
			@Pc(54) long local54 = this.aGLContext_Sub1_Sub2_1.method4847().aLong1295;
			if (local54 == 0L) {
	...
	public boolean method4823(@OriginalArg(0) int arg0) {
		@Pc(4) long local4 = this.aGLContext_Sub1_Sub2_1.method4847().aLong1315;
		if (local4 == 0L) {
	...
	@Override
	public boolean method4824(@OriginalArg(0) String arg0) {
