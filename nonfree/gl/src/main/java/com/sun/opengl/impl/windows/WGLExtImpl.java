...
public final class WGLExtImpl implements Interface9 {
	...
	@Override
	public boolean method4592(@OriginalArg(0) long arg0, @OriginalArg(1) int[] arg1, @OriginalArg(3) float[] arg2, @OriginalArg(6) int[] arg3, @OriginalArg(8) int[] arg4) {
		if (arg1 != null && arg1.length <= 0) {
			...
			@Pc(104) long local104 = this.aGLContext_Sub1_Sub2_1.method4619().aLong1271;
			if (local104 == 0L) {
	...
	public String method4593() {
		@Pc(4) long local4 = this.aGLContext_Sub1_Sub2_1.method4619().aLong1291;
		if (local4 == 0L) {
	...
	@Override
	public boolean method4594(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int[] arg3, @OriginalArg(6) int[] arg4) {
		if (arg3 != null && arg3.length <= 0) {
			throw new GLException("array offset argument \"piAttributes_offset\" (" + ") equals or exceeds array length (" + arg3.length + ")");
		} else if (arg4 == null || arg4.length > 0) {
			@Pc(54) long local54 = this.aGLContext_Sub1_Sub2_1.method4619().aLong1297;
			if (local54 == 0L) {
	...
	@Override
	public boolean method4595(@OriginalArg(0) int arg0) {
		@Pc(4) long local4 = this.aGLContext_Sub1_Sub2_1.method4619().aLong1317;
		if (local4 == 0L) {
	...
	@Override
	public boolean method4596(@OriginalArg(0) String arg0) {
