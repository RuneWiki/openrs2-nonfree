...
public abstract class JAWT_DrawingSurface {
	...
	public static JAWT_DrawingSurface method5053(@OriginalArg(0) ByteBuffer arg0) {
		return Class184.method4959() ? new JAWT_DrawingSurface_Sub1(arg0) : new JAWT_DrawingSurface_Sub2(arg0);
	}
	...
	public final JAWT_DrawingSurfaceInfo method5056() {
		@Pc(4) ByteBuffer local4 = this.GetDrawingSurfaceInfo0(this.method5054());
		return local4 == null ? null : JAWT_DrawingSurfaceInfo.method5067(local4.order(ByteOrder.nativeOrder()));
	}
	...
	public final void method5057(@OriginalArg(0) JAWT_DrawingSurfaceInfo arg0) {
		this.FreeDrawingSurfaceInfo0(this.method5054(), arg0 == null ? null : arg0.method5068());
	}
	...
	public final void method5058() {
		this.Unlock0(this.method5054());
	}
