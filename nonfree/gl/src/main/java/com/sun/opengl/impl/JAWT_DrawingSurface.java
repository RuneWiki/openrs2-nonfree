...
public abstract class JAWT_DrawingSurface {
	...
	public static JAWT_DrawingSurface method4575(@OriginalArg(0) ByteBuffer arg0) {
		return Class184.method4481() ? new JAWT_DrawingSurface_Sub1(arg0) : new JAWT_DrawingSurface_Sub2(arg0);
	}
	...
	public final ByteBuffer method4576() {
		return this.aClass192_6.method4500();
	}

	@OriginalMember(owner = "gl!com/sun/opengl/impl/JAWT_DrawingSurface", name = "Lock", descriptor = "()I")
	public final int method4577() {
		return this.Lock0(this.method4576());
	}
	...
	public final JAWT_DrawingSurfaceInfo method4578() {
		@Pc(4) ByteBuffer local4 = this.GetDrawingSurfaceInfo0(this.method4576());
		return local4 == null ? null : JAWT_DrawingSurfaceInfo.method4589(local4.order(ByteOrder.nativeOrder()));
	}
	...
	public final void method4579(@OriginalArg(0) JAWT_DrawingSurfaceInfo arg0) {
		this.FreeDrawingSurfaceInfo0(this.method4576(), arg0 == null ? null : arg0.method4590());
	}
