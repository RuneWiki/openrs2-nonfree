...
public abstract class JAWT_DrawingSurface {
	...
	public static JAWT_DrawingSurface method4660(@OriginalArg(0) ByteBuffer arg0) {
		return Class184.method4566() ? new JAWT_DrawingSurface_Sub1(arg0) : new JAWT_DrawingSurface_Sub2(arg0);
	}
	...
	public final ByteBuffer method4661() {
		return this.aClass192_6.method4585();
	}

	@OriginalMember(owner = "gl!com/sun/opengl/impl/JAWT_DrawingSurface", name = "Lock", descriptor = "()I")
	public final int method4662() {
		return this.Lock0(this.method4661());
	}
	...
	public final JAWT_DrawingSurfaceInfo method4663() {
		@Pc(4) ByteBuffer local4 = this.GetDrawingSurfaceInfo0(this.method4661());
		return local4 == null ? null : JAWT_DrawingSurfaceInfo.method4674(local4.order(ByteOrder.nativeOrder()));
	}
	...
	public final void method4664(@OriginalArg(0) JAWT_DrawingSurfaceInfo arg0) {
		this.FreeDrawingSurfaceInfo0(this.method4661(), arg0 == null ? null : arg0.method4675());
	}
