...
public abstract class JAWT_DrawingSurface {
	...
	public static JAWT_DrawingSurface method4962(@OriginalArg(0) ByteBuffer arg0) {
		return Class184.method4868() ? new JAWT_DrawingSurface_Sub1(arg0) : new JAWT_DrawingSurface_Sub2(arg0);
	}
	...
	public final ByteBuffer method4963() {
		return this.aClass192_6.method4887();
	}

	@OriginalMember(owner = "gl!com/sun/opengl/impl/JAWT_DrawingSurface", name = "Lock", descriptor = "()I")
	public final int method4964() {
		return this.Lock0(this.method4963());
	}
	...
	public final JAWT_DrawingSurfaceInfo method4965() {
		@Pc(4) ByteBuffer local4 = this.GetDrawingSurfaceInfo0(this.method4963());
		return local4 == null ? null : JAWT_DrawingSurfaceInfo.method4976(local4.order(ByteOrder.nativeOrder()));
	}
	...
	public final void method4966(@OriginalArg(0) JAWT_DrawingSurfaceInfo arg0) {
		this.FreeDrawingSurfaceInfo0(this.method4963(), arg0 == null ? null : arg0.method4977());
	}
