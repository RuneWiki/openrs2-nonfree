...
public abstract class JAWT_DrawingSurface {
	...
	public static JAWT_DrawingSurface method4432(@OriginalArg(0) ByteBuffer arg0) {
		return Class184.method4338() ? new JAWT_DrawingSurface_Sub1(arg0) : new JAWT_DrawingSurface_Sub2(arg0);
	}
	...
	public final JAWT_DrawingSurfaceInfo method4435() {
		@Pc(4) ByteBuffer local4 = this.GetDrawingSurfaceInfo0(this.method4433());
		return local4 == null ? null : JAWT_DrawingSurfaceInfo.method4446(local4.order(ByteOrder.nativeOrder()));
	}
	...
	public final void method4436(@OriginalArg(0) JAWT_DrawingSurfaceInfo arg0) {
		this.FreeDrawingSurfaceInfo0(this.method4433(), arg0 == null ? null : arg0.method4447());
	}
