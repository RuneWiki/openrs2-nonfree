...
public abstract class GLContext_Sub1 extends GLContext {
	...
	public boolean isExtensionAvailable(@OriginalArg(0) String arg0) {
		return this.functionAvailability.method4994(this.mapToRealGLExtensionName(arg0));
	}
}
