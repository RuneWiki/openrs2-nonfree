...
public final class GLContext_Sub1_Sub1_Sub1 extends GLContext_Sub1_Sub1 {
	...
	protected int makeCurrentImpl() throws GLException {
		@Pc(3) int local3 = this.aClass195_Sub1_Sub1_1.method4474();
		if (local3 == 1) {
			return 0;
		}
		@Pc(16) int local16;
		try {
			...
			if (local16 == 1 || local16 == 2) {
				CGL.updateContext(this.aLong1264);
			}
		} finally {
			this.aClass195_Sub1_Sub1_1.method4475();
		}
		return local16;
	}

	@OriginalMember(owner = "gl!com/sun/opengl/impl/macosx/MacOSXOnscreenGLContext", name = "swapBuffers", descriptor = "()V")
	public void method4471() throws GLException {
		if (!CGL.flushBuffer(this.aLong1264)) {
