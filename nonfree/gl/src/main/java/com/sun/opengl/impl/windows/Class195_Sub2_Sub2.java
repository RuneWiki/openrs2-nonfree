...
public final class Class195_Sub2_Sub2 extends Class195_Sub2 {
	...
	public void swapBuffers() throws GLException {
		@Pc(2) int local2 = this.method4855();
		if (local2 == 1) {
			return;
		}
		try {
			if (!WGL.SwapBuffers(this.aLong1321) && WGL.GetLastError() != 0) {
				throw new GLException("Error swapping buffers");
			}
		} finally {
			this.method4856(false);
		}
	}
	...
	public int method4855() {
		if (this.aLong1321 != 0L) {
			...
			this.aJAWT_DrawingSurface2 = JAWT.method4644().method4640(this.aComponent4);
			if (this.aJAWT_DrawingSurface2 == null) {
				return 1;
			}
			@Pc(26) int local26 = this.aJAWT_DrawingSurface2.method4662();
			if ((local26 & 0x1) != 0) {
				JAWT.method4644().method4641(this.aJAWT_DrawingSurface2);
				this.aJAWT_DrawingSurface2 = null;
				return 1;
			}
			this.aJAWT_DrawingSurfaceInfo2 = this.aJAWT_DrawingSurface2.method4663();
			if (this.aJAWT_DrawingSurfaceInfo2 == null) {
				this.aJAWT_DrawingSurface2.method4665();
				JAWT.method4644().method4641(this.aJAWT_DrawingSurface2);
				this.aJAWT_DrawingSurface2 = null;
				return 1;
			}
			this.aLong1321 = ((Class201) this.aJAWT_DrawingSurfaceInfo2.method4676()).method4714();
			if (this.aLong1321 == 0L) {
				this.aJAWT_DrawingSurface2.method4664(this.aJAWT_DrawingSurfaceInfo2);
				this.aJAWT_DrawingSurface2.method4665();
				JAWT.method4644().method4641(this.aJAWT_DrawingSurface2);
				this.aJAWT_DrawingSurface2 = null;
	...
	public void method4856(@OriginalArg(0) boolean arg0) {
		if (!arg0 || this.aLong1321 == 0L) {
			return;
		}
		this.aJAWT_DrawingSurface2.method4664(this.aJAWT_DrawingSurfaceInfo2);
		this.aJAWT_DrawingSurface2.method4665();
