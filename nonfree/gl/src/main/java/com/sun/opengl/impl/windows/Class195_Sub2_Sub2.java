...
public final class Class195_Sub2_Sub2 extends Class195_Sub2 {
	...
	public void swapBuffers() throws GLException {
		@Pc(2) int local2 = this.method5248();
		if (local2 == 1) {
			return;
		}
		try {
			if (!WGL.SwapBuffers(this.aLong1435) && WGL.GetLastError() != 0) {
				throw new GLException("Error swapping buffers");
			}
		} finally {
			this.method5249(false);
		}
	}
	...
	public int method5248() {
		if (this.aLong1435 != 0L) {
			...
			this.aJAWT_DrawingSurface2 = JAWT.method5037().method5033(this.aComponent4);
			if (this.aJAWT_DrawingSurface2 == null) {
				return 1;
			}
			@Pc(26) int local26 = this.aJAWT_DrawingSurface2.method5055();
			if ((local26 & 0x1) != 0) {
				JAWT.method5037().method5034(this.aJAWT_DrawingSurface2);
				this.aJAWT_DrawingSurface2 = null;
				return 1;
			}
			this.aJAWT_DrawingSurfaceInfo2 = this.aJAWT_DrawingSurface2.method5056();
			if (this.aJAWT_DrawingSurfaceInfo2 == null) {
				this.aJAWT_DrawingSurface2.method5058();
				JAWT.method5037().method5034(this.aJAWT_DrawingSurface2);
				this.aJAWT_DrawingSurface2 = null;
				return 1;
			}
			this.aLong1435 = ((Class201) this.aJAWT_DrawingSurfaceInfo2.method5069()).method5107();
			if (this.aLong1435 == 0L) {
				this.aJAWT_DrawingSurface2.method5057(this.aJAWT_DrawingSurfaceInfo2);
				this.aJAWT_DrawingSurface2.method5058();
				JAWT.method5037().method5034(this.aJAWT_DrawingSurface2);
				this.aJAWT_DrawingSurface2 = null;
