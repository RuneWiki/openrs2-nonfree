...
public abstract class XVisualInfo {
	...
	public static int size() {
		return Class184.method4481() ? XVisualInfo32.size() : XVisualInfo64.size();
	}
	...
	public static XVisualInfo create() {
		return create(Class183.method4473(size()));
	}
	...
	public static XVisualInfo create(@OriginalArg(0) ByteBuffer arg0) {
		return Class184.method4481() ? new XVisualInfo32(arg0) : new XVisualInfo64(arg0);
	}
	...
	public final ByteBuffer getBuffer() {
		return this.accessor.method4500();
	}
