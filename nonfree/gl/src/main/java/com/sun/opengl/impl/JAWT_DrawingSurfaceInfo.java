...
public abstract class JAWT_DrawingSurfaceInfo {
	...
	public static JAWT_DrawingSurfaceInfo method4976(@OriginalArg(0) ByteBuffer arg0) {
		return Class184.method4868() ? new JAWT_DrawingSurfaceInfo_Sub1(arg0) : new JAWT_DrawingSurfaceInfo_Sub2(arg0);
	}
	...
	private static Interface8 method4979(@OriginalArg(0) ByteBuffer arg0) {
		if (aMethod6 == null) {
	...
	public final ByteBuffer method4977() {
		return this.aClass192_9.method4887();
	}
	...
	public final Interface8 method4978() {
		return method4979(this.platformInfo0(this.method4977()));
	}
