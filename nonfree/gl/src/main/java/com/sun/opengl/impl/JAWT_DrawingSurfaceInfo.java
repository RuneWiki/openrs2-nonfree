...
public abstract class JAWT_DrawingSurfaceInfo {
	...
	public static JAWT_DrawingSurfaceInfo method4520(@OriginalArg(0) ByteBuffer arg0) {
		return Class184.method4412() ? new JAWT_DrawingSurfaceInfo_Sub1(arg0) : new JAWT_DrawingSurfaceInfo_Sub2(arg0);
	}
	...
	private static Interface8 method4523(@OriginalArg(0) ByteBuffer arg0) {
		if (aMethod6 == null) {
	...
	public final ByteBuffer method4521() {
		return this.aClass192_9.method4431();
	}
	...
	public final Interface8 method4522() {
		return method4523(this.platformInfo0(this.method4521()));
	}
