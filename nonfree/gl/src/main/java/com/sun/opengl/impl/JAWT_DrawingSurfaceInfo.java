...
public abstract class JAWT_DrawingSurfaceInfo {
	...
	public static JAWT_DrawingSurfaceInfo method4674(@OriginalArg(0) ByteBuffer arg0) {
		return Class184.method4566() ? new JAWT_DrawingSurfaceInfo_Sub1(arg0) : new JAWT_DrawingSurfaceInfo_Sub2(arg0);
	}
	...
	private static Interface8 method4677(@OriginalArg(0) ByteBuffer arg0) {
		if (aMethod6 == null) {
	...
	public final ByteBuffer method4675() {
		return this.aClass192_9.method4585();
	}
	...
	public final Interface8 method4676() {
		return method4677(this.platformInfo0(this.method4675()));
	}
