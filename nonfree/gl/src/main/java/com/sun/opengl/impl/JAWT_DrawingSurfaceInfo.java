...
public abstract class JAWT_DrawingSurfaceInfo {
	...
	public static JAWT_DrawingSurfaceInfo method5067(@OriginalArg(0) ByteBuffer arg0) {
		return Class184.method4959() ? new JAWT_DrawingSurfaceInfo_Sub1(arg0) : new JAWT_DrawingSurfaceInfo_Sub2(arg0);
	}
	...
	private static Interface8 method5070(@OriginalArg(0) ByteBuffer arg0) {
		if (aMethod6 == null) {
	...
	public final ByteBuffer method5068() {
		return this.aClass192_9.method4978();
	}
	...
	public final Interface8 method5069() {
		return method5070(this.platformInfo0(this.method5068()));
	}
