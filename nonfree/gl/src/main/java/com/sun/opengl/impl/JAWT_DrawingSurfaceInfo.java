...
public abstract class JAWT_DrawingSurfaceInfo {
	...
	public static JAWT_DrawingSurfaceInfo method4446(@OriginalArg(0) ByteBuffer arg0) {
		return Class184.method4338() ? new JAWT_DrawingSurfaceInfo_Sub1(arg0) : new JAWT_DrawingSurfaceInfo_Sub2(arg0);
	}
	...
	private static Interface8 method4449(@OriginalArg(0) ByteBuffer arg0) {
		if (aMethod6 == null) {
	...
	public final ByteBuffer method4447() {
		return this.aClass192_9.method4357();
	}
	...
	public final Interface8 method4448() {
		return method4449(this.platformInfo0(this.method4447()));
	}
