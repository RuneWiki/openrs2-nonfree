...
public final class Class193 {
	...
	private static String method4375(@OriginalArg(0) String arg0) {
	...
	public boolean method4373(@OriginalArg(0) String arg0) {
		this.method4374();
		return this.aHashSet1.contains(method4375(arg0));
	}
	...
	private void method4374() {
		...
		@Pc(53) int local53 = local50.method4376();
		@Pc(56) int local56 = local50.method4377();
		while (local53 > 0) {
			while (local56 >= 0) {
