...
public final class Class193 {
	...
	private static String method4518(@OriginalArg(0) String arg0) {
	...
	public boolean method4516(@OriginalArg(0) String arg0) {
		this.method4517();
		return this.aHashSet1.contains(method4518(arg0));
	}
	...
	private void method4517() {
		...
		@Pc(53) int local53 = local50.method4519();
		@Pc(56) int local56 = local50.method4520();
		while (local53 > 0) {
			while (local56 >= 0) {
