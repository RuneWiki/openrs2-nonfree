...
public final class Class193 {
	...
	private static String method4905(@OriginalArg(0) String arg0) {
	...
	public boolean method4903(@OriginalArg(0) String arg0) {
		this.method4904();
		return this.aHashSet1.contains(method4905(arg0));
	}
	...
	private void method4904() {
		...
		@Pc(53) int local53 = local50.method4906();
		@Pc(56) int local56 = local50.method4907();
		while (local53 > 0) {
			while (local56 >= 0) {
