...
public final class Class193 {
	...
	private static String method4996(@OriginalArg(0) String arg0) {
	...
	public boolean method4994(@OriginalArg(0) String arg0) {
		this.method4995();
		return this.aHashSet1.contains(method4996(arg0));
	}
	...
	private void method4995() {
		...
		@Pc(53) int local53 = local50.method4997();
		@Pc(56) int local56 = local50.method4998();
		while (local53 > 0) {
			while (local56 >= 0) {
