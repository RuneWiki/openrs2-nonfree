...
public final class Class193 {
	...
	private static String method4449(@OriginalArg(0) String arg0) {
	...
	public boolean method4447(@OriginalArg(0) String arg0) {
		this.method4448();
		return this.aHashSet1.contains(method4449(arg0));
	}
	...
	private void method4448() {
		...
		@Pc(53) int local53 = local50.method4450();
		@Pc(56) int local56 = local50.method4451();
		while (local53 > 0) {
			while (local56 >= 0) {
