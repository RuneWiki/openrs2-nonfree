...
public final class Class195_Sub1_Sub1 extends Class195_Sub1 {
	...
	public void swapBuffers() throws GLException {
		((GLContext_Sub1_Sub1_Sub1) GLContext.getCurrent()).method4545();
	}

	@OriginalMember(owner = "gl!com/sun/opengl/impl/macosx/MacOSXOnscreenGLDrawable", name = "getView", descriptor = "()J")
	@Override
	public long method4546() {
		return this.aLong1262;
	}

	@OriginalMember(owner = "gl!com/sun/opengl/impl/macosx/MacOSXOnscreenGLDrawable", name = "lockSurface", descriptor = "()I")
	public int method4548() throws GLException {
		if (this.aLong1262 != 0L) {
			return 3;
		} else if (this.aBoolean369) {
			this.aJAWT_DrawingSurface1 = JAWT.method4490().method4486(this.aComponent3);
			if (this.aJAWT_DrawingSurface1 == null) {
				return 1;
			}
			@Pc(26) int local26 = this.aJAWT_DrawingSurface1.method4508();
			if ((local26 & 0x1) != 0) {
				JAWT.method4490().method4487(this.aJAWT_DrawingSurface1);
			...
			if (this.aBoolean370) {
				AccessController.doPrivileged(new PrivilegedAction() {
					...
					@Override
					public Object run() {
						Class195_Sub1_Sub1.this.aJAWT_DrawingSurfaceInfo1 = Class195_Sub1_Sub1.this.aJAWT_DrawingSurface1.method4509();
						return null;
					}
				});
				this.aBoolean370 = false;
			} else {
				this.aJAWT_DrawingSurfaceInfo1 = this.aJAWT_DrawingSurface1.method4509();
			}
			if (this.aJAWT_DrawingSurfaceInfo1 == null) {
				this.aJAWT_DrawingSurface1.method4511();
				JAWT.method4490().method4487(this.aJAWT_DrawingSurface1);
				this.aJAWT_DrawingSurface1 = null;
				return 1;
			}
			@Pc(77) Class199 local77 = (Class199) this.aJAWT_DrawingSurfaceInfo1.method4522();
			if (local77 != null) {
				this.aLong1262 = local77.method4537();
			}
			if (this.aLong1262 == 0L) {
				this.aJAWT_DrawingSurface1.method4510(this.aJAWT_DrawingSurfaceInfo1);
				this.aJAWT_DrawingSurface1.method4511();
				JAWT.method4490().method4487(this.aJAWT_DrawingSurface1);
				this.aJAWT_DrawingSurface1 = null;
	...
	public void method4549() throws GLException {
		if (this.aLong1262 == 0L) {
			return;
		}
		this.aJAWT_DrawingSurface1.method4510(this.aJAWT_DrawingSurfaceInfo1);
