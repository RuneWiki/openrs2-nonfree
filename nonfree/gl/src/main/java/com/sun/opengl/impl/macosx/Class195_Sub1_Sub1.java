...
public final class Class195_Sub1_Sub1 extends Class195_Sub1 {
	...
	public void swapBuffers() throws GLException {
		((GLContext_Sub1_Sub1_Sub1) GLContext.getCurrent()).method4699();
	}
	...
	public long method4700() {
		return this.aLong1263;
	}

	@OriginalMember(owner = "gl!com/sun/opengl/impl/macosx/MacOSXOnscreenGLDrawable", name = "lockSurface", descriptor = "()I")
	public int method4702() throws GLException {
		if (this.aLong1263 != 0L) {
			return 3;
		} else if (this.aBoolean465) {
			this.aJAWT_DrawingSurface1 = JAWT.method4644().method4640(this.aComponent3);
			if (this.aJAWT_DrawingSurface1 == null) {
				return 1;
			}
			@Pc(26) int local26 = this.aJAWT_DrawingSurface1.method4662();
			if ((local26 & 0x1) != 0) {
				JAWT.method4644().method4641(this.aJAWT_DrawingSurface1);
			...
			if (this.aBoolean466) {
				AccessController.doPrivileged(new PrivilegedAction() {
					...
					@Override
					public Object run() {
						Class195_Sub1_Sub1.this.aJAWT_DrawingSurfaceInfo1 = Class195_Sub1_Sub1.this.aJAWT_DrawingSurface1.method4663();
						return null;
					}
				});
				this.aBoolean466 = false;
			} else {
				this.aJAWT_DrawingSurfaceInfo1 = this.aJAWT_DrawingSurface1.method4663();
			}
			if (this.aJAWT_DrawingSurfaceInfo1 == null) {
				this.aJAWT_DrawingSurface1.method4665();
				JAWT.method4644().method4641(this.aJAWT_DrawingSurface1);
				this.aJAWT_DrawingSurface1 = null;
				return 1;
			}
			@Pc(77) Class199 local77 = (Class199) this.aJAWT_DrawingSurfaceInfo1.method4676();
			if (local77 != null) {
				this.aLong1263 = local77.method4691();
			}
			if (this.aLong1263 == 0L) {
				this.aJAWT_DrawingSurface1.method4664(this.aJAWT_DrawingSurfaceInfo1);
				this.aJAWT_DrawingSurface1.method4665();
				JAWT.method4644().method4641(this.aJAWT_DrawingSurface1);
				this.aJAWT_DrawingSurface1 = null;
	...
	public void method4703() throws GLException {
		if (this.aLong1263 == 0L) {
			return;
		}
		this.aJAWT_DrawingSurface1.method4664(this.aJAWT_DrawingSurfaceInfo1);
