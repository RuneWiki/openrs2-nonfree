...
public final class Class195_Sub1_Sub1 extends Class195_Sub1 {
	...
	public void swapBuffers() throws GLException {
		((GLContext_Sub1_Sub1_Sub1) GLContext.getCurrent()).method5001();
	}

	@OriginalMember(owner = "gl!com/sun/opengl/impl/macosx/MacOSXOnscreenGLDrawable", name = "getView", descriptor = "()J")
	@Override
	public long method5002() {
		return this.aLong1264;
	}

	@OriginalMember(owner = "gl!com/sun/opengl/impl/macosx/MacOSXOnscreenGLDrawable", name = "lockSurface", descriptor = "()I")
	public int method5004() throws GLException {
		if (this.aLong1264 != 0L) {
			return 3;
		} else if (this.aBoolean359) {
			this.aJAWT_DrawingSurface1 = JAWT.method4946().method4942(this.aComponent3);
			if (this.aJAWT_DrawingSurface1 == null) {
				return 1;
			}
			@Pc(26) int local26 = this.aJAWT_DrawingSurface1.method4964();
			if ((local26 & 0x1) != 0) {
				JAWT.method4946().method4943(this.aJAWT_DrawingSurface1);
			...
			if (this.aBoolean360) {
				AccessController.doPrivileged(new PrivilegedAction() {
					...
					@Override
					public Object run() {
						Class195_Sub1_Sub1.this.aJAWT_DrawingSurfaceInfo1 = Class195_Sub1_Sub1.this.aJAWT_DrawingSurface1.method4965();
						return null;
					}
				});
				this.aBoolean360 = false;
			} else {
				this.aJAWT_DrawingSurfaceInfo1 = this.aJAWT_DrawingSurface1.method4965();
			}
			if (this.aJAWT_DrawingSurfaceInfo1 == null) {
				this.aJAWT_DrawingSurface1.method4967();
				JAWT.method4946().method4943(this.aJAWT_DrawingSurface1);
				this.aJAWT_DrawingSurface1 = null;
				return 1;
			}
			@Pc(77) Class199 local77 = (Class199) this.aJAWT_DrawingSurfaceInfo1.method4978();
			if (local77 != null) {
				this.aLong1264 = local77.method4993();
			}
			if (this.aLong1264 == 0L) {
				this.aJAWT_DrawingSurface1.method4966(this.aJAWT_DrawingSurfaceInfo1);
				this.aJAWT_DrawingSurface1.method4967();
				JAWT.method4946().method4943(this.aJAWT_DrawingSurface1);
				this.aJAWT_DrawingSurface1 = null;
	...
	public void method5005() throws GLException {
		if (this.aLong1264 == 0L) {
			return;
		}
		this.aJAWT_DrawingSurface1.method4966(this.aJAWT_DrawingSurfaceInfo1);
