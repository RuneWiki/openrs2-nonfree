...
public abstract class Class195_Sub2 extends Class195 {
	...
	protected static Class202 method5243(@OriginalArg(0) GLCapabilities arg0) {
		@Pc(8) int local8 = arg0.getRedBits() + arg0.getGreenBits() + arg0.getBlueBits();
		if (local8 < 15) {
			throw new GLException("Bit depths < 15 (i.e., non-true-color) not supported");
		}
		@Pc(18) Class202 local18 = method5244();
		...
		local18.method5178(local33);
		local18.method5180();
		local18.method5181((byte) local8);
		local18.method5182((byte) arg0.getRedBits());
		local18.method5184((byte) arg0.getGreenBits());
		local18.method5186((byte) arg0.getBlueBits());
		local18.method5188((byte) arg0.getAlphaBits());
		@Pc(91) int local91 = arg0.getAccumRedBits() + arg0.getAccumGreenBits() + arg0.getAccumBlueBits();
		local18.method5190((byte) local91);
		local18.method5191((byte) arg0.getAccumRedBits());
		local18.method5193((byte) arg0.getAccumGreenBits());
		local18.method5195((byte) arg0.getAccumBlueBits());
		local18.method5197((byte) arg0.getAccumAlphaBits());
		local18.method5199((byte) arg0.getDepthBits());
		local18.method5201((byte) arg0.getStencilBits());
		local18.method5203();
		return local18;
	}
	...
	private static Class202 method5244() {
		@Pc(1) Class202 local1 = Class202.method5173();
		local1.method5176((short) Class202.method5109());
		local1.method5177();
		return local1;
	}
	...
	private static GLCapabilities method5245(@OriginalArg(0) Class202 arg0) {
		if ((arg0.method5179() & 0x20) == 0) {
			return null;
		}
		@Pc(10) GLCapabilities local10 = new GLCapabilities();
		local10.setRedBits(arg0.method5183());
		local10.setGreenBits(arg0.method5185());
		local10.setBlueBits(arg0.method5187());
		local10.setAlphaBits(arg0.method5189());
		local10.setAccumRedBits(arg0.method5192());
		local10.setAccumGreenBits(arg0.method5194());
		local10.setAccumBlueBits(arg0.method5196());
		local10.setAccumAlphaBits(arg0.method5198());
		local10.setDepthBits(arg0.method5200());
		local10.setStencilBits(arg0.method5202());
		local10.setDoubleBuffered((arg0.method5179() & 0x1) != 0);
		local10.setStereo((arg0.method5179() & 0x2) != 0);
		local10.setHardwareAccelerated((arg0.method5179() & 0x40) == 0 || (arg0.method5179() & 0x1000) != 0);
		return local10;
	}
	...
	private static boolean method5246(@OriginalArg(0) GLCapabilities arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Interface9 arg2, @OriginalArg(3) int[] arg3) throws GLException {
		if (!arg2.method5217("WGL_ARB_pixel_format")) {
			return false;
		}
		@Pc(7) byte local7 = 0;
		...
		if (arg2.method5217("WGL_ARB_multisample") && arg0.getSampleBuffers()) {
			arg1[local10++] = 8257;
			arg1[local10++] = 1;
			arg1[local10++] = 8258;
	...
	private static GLCapabilities method5247(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2) {
	...
	public final long method5241() {
		return this.aLong1435;
	}

	@OriginalMember(owner = "gl!com/sun/opengl/impl/windows/WindowsGLDrawable", name = "choosePixelFormat", descriptor = "(Z)V")
	protected final void method5242() {
		@Pc(15) Class202 local15;
		@Pc(12) int local12;
		if ((local12 = WGL.GetPixelFormat(this.aLong1435)) != 0) {
			local15 = method5244();
			if (WGL.method5206(this.aLong1435, local12, Class202.method5109(), local15) == 0) {
				throw new GLException("Unable to describe pixel format " + local12 + " of window set by Java2D/OpenGL pipeline");
			}
			this.setChosenGLCapabilities(method5245(local15));
		...
		if (this.aGLCapabilities5.getSampleBuffers()) {
			...
			if (local56 != null) {
				local56.makeCurrent();
				local58 = (Interface9) local56.method5237();
			}
		}
		@Pc(82) int local82 = -1;
		...
		if (local58 != null) {
			try {
				@Pc(94) boolean local94 = local58.method5217("WGL_ARB_pixel_format");
				if (local94) {
					@Pc(100) boolean local100 = local58.method5217("WGL_ARB_multisample");
					@Pc(103) int[] local103 = new int[512];
					@Pc(106) int[] local106 = new int[512];
					@Pc(109) float[] local109 = new float[1];
					if (method5246(this.aGLCapabilities5, local103, local58, null)) {
						@Pc(119) int[] local119 = new int[256];
						@Pc(122) int[] local122 = new int[1];
						if (local58.method5213(this.aLong1435, local103, local109, local119, local122)) {
							local50 = local122[0];
							if (local50 > 0) {
						...
						local103[0] = 8192;
						if (local58.method5215(this.aLong1435, 0, 1, local103, local106)) {
							local50 = local106[0];
							...
							for (@Pc(267) int local267 = 0; local267 < local50; local267++) {
								if (!local58.method5215(this.aLong1435, local267 + 1, local248, local103, local106)) {
									throw new GLException("Error getting pixel format attributes for pixel format " + (local267 + 1) + " of device context");
								}
								local48[local267] = method5247(local103, local248, local106);
							}
							local88 = true;
						} else {
		...
		if (!local88) {
			local15 = method5243(this.aGLCapabilities5);
			local82 = WGL.method5205(this.aLong1435, local15) - 1;
			local50 = WGL.method5206(this.aLong1435, 1, 0, null);
			if (local50 == 0) {
			...
			for (@Pc(381) int local381 = 0; local381 < local50; local381++) {
				if (WGL.method5206(this.aLong1435, local381 + 1, Class202.method5109(), local15) == 0) {
					throw new GLException("Error describing pixel format " + (local381 + 1) + " of device context");
				}
				local48[local381] = method5245(local15);
			}
		}
		...
		local426++;
		if (WGL.method5206(this.aLong1435, local426, Class202.method5109(), local15) == 0) {
			throw new GLException("Error re-describing the chosen pixel format: " + WGL.GetLastError());
		} else if (WGL.method5207(this.aLong1435, local426, local15)) {
			if (local455 == null) {
				this.setChosenGLCapabilities(method5245(local15));
			} else {
			...
			throw new GLException("Unable to set pixel format " + local426 + " for device context " + toHexString(this.aLong1435) + ": error code " + local497);
		}
	}
}
