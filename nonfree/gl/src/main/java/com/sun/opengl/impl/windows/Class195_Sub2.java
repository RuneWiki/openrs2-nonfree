...
public abstract class Class195_Sub2 extends Class195 {
	...
	protected static Class202 method5152(@OriginalArg(0) GLCapabilities arg0) {
		@Pc(8) int local8 = arg0.getRedBits() + arg0.getGreenBits() + arg0.getBlueBits();
		if (local8 < 15) {
			throw new GLException("Bit depths < 15 (i.e., non-true-color) not supported");
		}
		@Pc(18) Class202 local18 = method5153();
		...
		local18.method5087(local33);
		local18.method5089();
		local18.method5090((byte) local8);
		local18.method5091((byte) arg0.getRedBits());
		local18.method5093((byte) arg0.getGreenBits());
		local18.method5095((byte) arg0.getBlueBits());
		local18.method5097((byte) arg0.getAlphaBits());
		@Pc(91) int local91 = arg0.getAccumRedBits() + arg0.getAccumGreenBits() + arg0.getAccumBlueBits();
		local18.method5099((byte) local91);
		local18.method5100((byte) arg0.getAccumRedBits());
		local18.method5102((byte) arg0.getAccumGreenBits());
		local18.method5104((byte) arg0.getAccumBlueBits());
		local18.method5106((byte) arg0.getAccumAlphaBits());
		local18.method5108((byte) arg0.getDepthBits());
		local18.method5110((byte) arg0.getStencilBits());
		local18.method5112();
		return local18;
	}
	...
	private static Class202 method5153() {
		@Pc(1) Class202 local1 = Class202.method5082();
		local1.method5085((short) Class202.method5018());
		local1.method5086();
		return local1;
	}
	...
	private static GLCapabilities method5154(@OriginalArg(0) Class202 arg0) {
		if ((arg0.method5088() & 0x20) == 0) {
			return null;
		}
		@Pc(10) GLCapabilities local10 = new GLCapabilities();
		local10.setRedBits(arg0.method5092());
		local10.setGreenBits(arg0.method5094());
		local10.setBlueBits(arg0.method5096());
		local10.setAlphaBits(arg0.method5098());
		local10.setAccumRedBits(arg0.method5101());
		local10.setAccumGreenBits(arg0.method5103());
		local10.setAccumBlueBits(arg0.method5105());
		local10.setAccumAlphaBits(arg0.method5107());
		local10.setDepthBits(arg0.method5109());
		local10.setStencilBits(arg0.method5111());
		local10.setDoubleBuffered((arg0.method5088() & 0x1) != 0);
		local10.setStereo((arg0.method5088() & 0x2) != 0);
		local10.setHardwareAccelerated((arg0.method5088() & 0x40) == 0 || (arg0.method5088() & 0x1000) != 0);
		return local10;
	}
	...
	private static boolean method5155(@OriginalArg(0) GLCapabilities arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Interface9 arg2, @OriginalArg(3) int[] arg3) throws GLException {
		if (!arg2.method5126("WGL_ARB_pixel_format")) {
			return false;
		}
		@Pc(7) byte local7 = 0;
		...
		if (arg2.method5126("WGL_ARB_multisample") && arg0.getSampleBuffers()) {
			arg1[local10++] = 8257;
			arg1[local10++] = 1;
			arg1[local10++] = 8258;
	...
	private static GLCapabilities method5156(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2) {
	...
	public final long method5150() {
		return this.aLong1322;
	}

	@OriginalMember(owner = "gl!com/sun/opengl/impl/windows/WindowsGLDrawable", name = "choosePixelFormat", descriptor = "(Z)V")
	protected final void method5151() {
		@Pc(15) Class202 local15;
		@Pc(12) int local12;
		if ((local12 = WGL.GetPixelFormat(this.aLong1322)) != 0) {
			local15 = method5153();
			if (WGL.method5115(this.aLong1322, local12, Class202.method5018(), local15) == 0) {
				throw new GLException("Unable to describe pixel format " + local12 + " of window set by Java2D/OpenGL pipeline");
			}
			this.setChosenGLCapabilities(method5154(local15));
		...
		if (this.aGLCapabilities5.getSampleBuffers()) {
			...
			if (local56 != null) {
				local56.makeCurrent();
				local58 = (Interface9) local56.method5146();
			}
		}
		@Pc(82) int local82 = -1;
		...
		if (local58 != null) {
			try {
				@Pc(94) boolean local94 = local58.method5126("WGL_ARB_pixel_format");
				if (local94) {
					@Pc(100) boolean local100 = local58.method5126("WGL_ARB_multisample");
					@Pc(103) int[] local103 = new int[512];
					@Pc(106) int[] local106 = new int[512];
					@Pc(109) float[] local109 = new float[1];
					if (method5155(this.aGLCapabilities5, local103, local58, null)) {
						@Pc(119) int[] local119 = new int[256];
						@Pc(122) int[] local122 = new int[1];
						if (local58.method5122(this.aLong1322, local103, local109, local119, local122)) {
							local50 = local122[0];
							if (local50 > 0) {
						...
						local103[0] = 8192;
						if (local58.method5124(this.aLong1322, 0, 1, local103, local106)) {
							local50 = local106[0];
							...
							for (@Pc(267) int local267 = 0; local267 < local50; local267++) {
								if (!local58.method5124(this.aLong1322, local267 + 1, local248, local103, local106)) {
									throw new GLException("Error getting pixel format attributes for pixel format " + (local267 + 1) + " of device context");
								}
								local48[local267] = method5156(local103, local248, local106);
							}
							local88 = true;
						} else {
		...
		if (!local88) {
			local15 = method5152(this.aGLCapabilities5);
			local82 = WGL.method5114(this.aLong1322, local15) - 1;
			local50 = WGL.method5115(this.aLong1322, 1, 0, null);
			if (local50 == 0) {
			...
			for (@Pc(381) int local381 = 0; local381 < local50; local381++) {
				if (WGL.method5115(this.aLong1322, local381 + 1, Class202.method5018(), local15) == 0) {
					throw new GLException("Error describing pixel format " + (local381 + 1) + " of device context");
				}
				local48[local381] = method5154(local15);
			}
		}
		...
		local426++;
		if (WGL.method5115(this.aLong1322, local426, Class202.method5018(), local15) == 0) {
			throw new GLException("Error re-describing the chosen pixel format: " + WGL.GetLastError());
		} else if (WGL.method5116(this.aLong1322, local426, local15)) {
			if (local455 == null) {
				this.setChosenGLCapabilities(method5154(local15));
			} else {
			...
			throw new GLException("Unable to set pixel format " + local426 + " for device context " + toHexString(this.aLong1322) + ": error code " + local497);
		}
	}
}
