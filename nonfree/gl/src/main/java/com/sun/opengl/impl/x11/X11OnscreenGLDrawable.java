...
public final class X11OnscreenGLDrawable extends X11GLDrawable {
	...
	public int lockSurface() throws GLException {
		if (this.drawable != 0L) {
			...
			this.ds = JAWT.method4416().method4412(this.component);
			if (this.ds == null) {
				return 1;
			}
			@Pc(26) int local26 = this.ds.method4434();
			if ((local26 & 0x1) != 0) {
				JAWT.method4416().method4413(this.ds);
				this.ds = null;
				return 1;
			}
			this.dsi = this.ds.method4435();
			if (this.dsi == null) {
				this.ds.method4437();
				JAWT.method4416().method4413(this.ds);
				this.ds = null;
			...
			@Pc(64) JAWT_X11DrawingSurfaceInfo local64 = (JAWT_X11DrawingSurfaceInfo) this.dsi.method4448();
