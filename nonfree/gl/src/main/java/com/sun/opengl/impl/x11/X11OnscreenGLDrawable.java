...
public final class X11OnscreenGLDrawable extends X11GLDrawable {
	...
	public int lockSurface() throws GLException {
		if (this.drawable != 0L) {
			...
			this.ds = JAWT.method4490().method4486(this.component);
			if (this.ds == null) {
				return 1;
			}
			@Pc(26) int local26 = this.ds.method4508();
			if ((local26 & 0x1) != 0) {
				JAWT.method4490().method4487(this.ds);
				this.ds = null;
				return 1;
			}
			this.dsi = this.ds.method4509();
			if (this.dsi == null) {
				this.ds.method4511();
				JAWT.method4490().method4487(this.ds);
				this.ds = null;
			...
			@Pc(64) JAWT_X11DrawingSurfaceInfo local64 = (JAWT_X11DrawingSurfaceInfo) this.dsi.method4522();
