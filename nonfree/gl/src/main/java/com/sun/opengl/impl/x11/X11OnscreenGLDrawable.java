...
public final class X11OnscreenGLDrawable extends X11GLDrawable {
	...
	public int lockSurface() throws GLException {
		if (this.drawable != 0L) {
			...
			this.ds = JAWT.method4644().method4640(this.component);
			if (this.ds == null) {
				return 1;
			}
			@Pc(26) int local26 = this.ds.method4662();
			if ((local26 & 0x1) != 0) {
				JAWT.method4644().method4641(this.ds);
				this.ds = null;
				return 1;
			}
			this.dsi = this.ds.method4663();
			if (this.dsi == null) {
				this.ds.method4665();
				JAWT.method4644().method4641(this.ds);
				this.ds = null;
			...
			@Pc(64) JAWT_X11DrawingSurfaceInfo local64 = (JAWT_X11DrawingSurfaceInfo) this.dsi.method4676();
