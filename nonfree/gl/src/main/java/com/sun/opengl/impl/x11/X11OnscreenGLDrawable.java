...
public final class X11OnscreenGLDrawable extends X11GLDrawable {
	...
	public int lockSurface() throws GLException {
		if (this.drawable != 0L) {
			...
			this.ds = JAWT.method4559().method4555(this.component);
			if (this.ds == null) {
				return 1;
			}
			@Pc(26) int local26 = this.ds.method4577();
			if ((local26 & 0x1) != 0) {
				JAWT.method4559().method4556(this.ds);
				this.ds = null;
				return 1;
			}
			this.dsi = this.ds.method4578();
			if (this.dsi == null) {
				this.ds.method4580();
				JAWT.method4559().method4556(this.ds);
				this.ds = null;
			...
			@Pc(64) JAWT_X11DrawingSurfaceInfo local64 = (JAWT_X11DrawingSurfaceInfo) this.dsi.method4591();
