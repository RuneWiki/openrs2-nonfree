...
public final class Class191 {
	...
	private static final boolean aBoolean498 = !ProcAddressHelper.class.desiredAssertionStatus();
	...
	public static void method4977(@OriginalArg(0) Object arg0, @OriginalArg(1) Interface7 arg1) throws RuntimeException {
		...
		for (@Pc(7) int local7 = 0; local7 < local5.length; local7++) {
			...
			if (local16.startsWith("_addressof_")) {
				...
				try {
					...
					if (!aBoolean498 && local32.getType() != Long.TYPE) {
