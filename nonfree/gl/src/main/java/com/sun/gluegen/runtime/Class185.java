...
public final class Class185 {
	...
	private static boolean aBoolean350;
		...
		AccessController.doPrivileged(new PrivilegedAction() {
			...
			public Object run() {
				...
				if (local3.startsWith("wind")) {
					Class185.anInt6242 = 1;
				} else if (local3.startsWith("mac os x")) {
					Class185.anInt6242 = 3;
				} else {
					Class185.anInt6242 = 2;
				}
				Class185.aBoolean349 = System.getProperty("gluegen.debug.NativeLibrary") != null;
				return null;
			}
		});
		switch(anInt6242) {
	...
	public static Class185 method4873(@OriginalArg(0) String arg0, @OriginalArg(1) ClassLoader arg1) {
		return method4874(arg0, arg0, arg0, arg1);
	}
	...
	private static Class185 method4874(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2, @OriginalArg(4) ClassLoader arg3) {
		@Pc(6) List local6 = method4876(arg0, arg1, arg2, arg3);
		...
		do {
			...
			local32 = anInterface6_1.method4900(local16);
		} while (local32 == 0L);
		if (aBoolean349) {
	...
	private static List method4876(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2, @OriginalArg(4) ClassLoader arg3) {
		@Pc(3) ArrayList local3 = new ArrayList();
		@Pc(8) String local8 = method4877(arg0, arg1, arg2);
		if (local8 == null) {
			return local3;
		}
		...
		@Pc(29) String[] local29 = method4878(local8);
		for (@Pc(33) int local33 = 0; local33 < local29.length; local33++) {
			local3.add(local29[local33]);
		}
		@Pc(49) String local49 = method4880(local8, arg3);
		if (aBoolean349) {
		...
		if (local77 != null) {
			...
			while (local85.hasMoreTokens()) {
				method4879(local85.nextToken(), local29, local3);
			}
		}
		...
		method4879(local100, local29, local3);
		if (anInt6242 == 3) {
			method4879("/Library/Frameworks/" + local8 + ".Framework", local29, local3);
			method4879("/System/Library/Frameworks/" + local8 + ".Framework", local29, local3);
		}
		return local3;
	}
	...
	private static String method4877(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2) {
		switch(anInt6242) {
			case 1:
				return arg0;
			case 2:
	...
	private static String[] method4878(@OriginalArg(0) String arg0) {
		@Pc(35) int local35;
	...
	private static void method4879(@OriginalArg(0) String arg0, @OriginalArg(1) String[] arg1, @OriginalArg(2) List arg2) {
	...
	private static String method4880(@OriginalArg(0) String arg0, @OriginalArg(1) ClassLoader arg1) {
		if (arg1 == null) {
			return null;
		}
		if (!aBoolean350) {
	...
	public void method4875() {
		...
		@Pc(12) long local12 = this.aLong204;
		this.aLong204 = 0L;
		anInterface6_1.method4901(local12);
	}
}
