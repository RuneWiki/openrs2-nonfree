...
public final class Class185 {
	...
	private static boolean aBoolean497;
		...
		AccessController.doPrivileged(new PrivilegedAction() {
			...
			public Object run() {
				...
				if (local3.startsWith("wind")) {
					Class185.anInt6221 = 1;
				} else if (local3.startsWith("mac os x")) {
					Class185.anInt6221 = 3;
				} else {
					Class185.anInt6221 = 2;
				}
				Class185.aBoolean496 = System.getProperty("gluegen.debug.NativeLibrary") != null;
				return null;
			}
		});
		switch(anInt6221) {
			case 1:
				...
				aStringArray37 = new String[] { "" };
				aStringArray38 = new String[] { ".dll" };
				break;
			case 2:
				anInterface6_1 = new UnixDynamicLinkerImpl();
				aStringArray37 = new String[] { "lib" };
				aStringArray38 = new String[] { ".so" };
				break;
			case 3:
				anInterface6_1 = new MacOSXDynamicLinkerImpl();
				aStringArray37 = new String[] { "lib", "" };
				aStringArray38 = new String[] { ".dylib", ".jnilib", "" };
				break;
			default:
	...
	public static Class185 method4964(@OriginalArg(0) String arg0, @OriginalArg(1) ClassLoader arg1) {
		return method4965(arg0, arg0, arg0, arg1);
	}
	...
	private static Class185 method4965(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2, @OriginalArg(4) ClassLoader arg3) {
		@Pc(6) List local6 = method4967(arg0, arg1, arg2, arg3);
		...
		do {
			...
			local32 = anInterface6_1.method4991(local16);
		} while (local32 == 0L);
		if (aBoolean496) {
	...
	private static List method4967(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2, @OriginalArg(4) ClassLoader arg3) {
		@Pc(3) ArrayList local3 = new ArrayList();
		@Pc(8) String local8 = method4968(arg0, arg1, arg2);
		if (local8 == null) {
			return local3;
		}
		...
		@Pc(29) String[] local29 = method4969(local8);
		for (@Pc(33) int local33 = 0; local33 < local29.length; local33++) {
			local3.add(local29[local33]);
		}
		@Pc(49) String local49 = method4971(local8, arg3);
		if (aBoolean496) {
		...
		if (local77 != null) {
			...
			while (local85.hasMoreTokens()) {
				method4970(local85.nextToken(), local29, local3);
			}
		}
		...
		method4970(local100, local29, local3);
		if (anInt6221 == 3) {
			method4970("/Library/Frameworks/" + local8 + ".Framework", local29, local3);
			method4970("/System/Library/Frameworks/" + local8 + ".Framework", local29, local3);
		}
		return local3;
	}
	...
	private static String method4968(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2) {
		switch(anInt6221) {
			case 1:
				return arg0;
			case 2:
	...
	private static String[] method4969(@OriginalArg(0) String arg0) {
		@Pc(35) int local35;
		if (arg0.startsWith(aStringArray37[0])) {
			if (arg0.endsWith(aStringArray38[0])) {
				return new String[] { arg0 };
			}
			@Pc(24) int local24 = arg0.indexOf(aStringArray38[0]);
			@Pc(26) boolean local26 = true;
			if (local24 >= 0) {
				for (local35 = local24 + aStringArray38[0].length(); local35 < arg0.length(); local35++) {
		...
		@Pc(73) String[] local73 = new String[aStringArray37.length * aStringArray38.length];
		@Pc(75) int local75 = 0;
		for (local35 = 0; local35 < aStringArray37.length; local35++) {
			for (@Pc(83) int local83 = 0; local83 < aStringArray38.length; local83++) {
				local73[local75++] = aStringArray37[local35] + arg0 + aStringArray38[local83];
			}
		}
		return local73;
	}
	...
	private static void method4970(@OriginalArg(0) String arg0, @OriginalArg(1) String[] arg1, @OriginalArg(2) List arg2) {
	...
	private static String method4971(@OriginalArg(0) String arg0, @OriginalArg(1) ClassLoader arg1) {
		if (arg1 == null) {
			return null;
		}
		if (!aBoolean497) {
	...
	public static boolean method4976() {
		aBoolean497 = true;
		return true;
	}
	...
	public void method4966() {
		...
		@Pc(12) long local12 = this.aLong317;
		this.aLong317 = 0L;
		anInterface6_1.method4992(local12);
	}
}
