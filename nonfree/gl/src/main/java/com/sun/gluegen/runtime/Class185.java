...
public final class Class185 {
	...
	private static String[] aStringArray39;
		...
		AccessController.doPrivileged(new PrivilegedAction() {
			...
			public Object run() {
				...
				if (local3.startsWith("wind")) {
					Class185.anInt5563 = 1;
				} else if (local3.startsWith("mac os x")) {
					Class185.anInt5563 = 3;
				} else {
					Class185.anInt5563 = 2;
				}
				Class185.aBoolean359 = System.getProperty("gluegen.debug.NativeLibrary") != null;
				return null;
			}
		});
		switch(anInt5563) {
			case 1:
				...
				aStringArray39 = new String[] { "" };
				aStringArray40 = new String[] { ".dll" };
				break;
			case 2:
				anInterface6_1 = new UnixDynamicLinkerImpl();
				aStringArray39 = new String[] { "lib" };
				aStringArray40 = new String[] { ".so" };
				break;
			case 3:
				anInterface6_1 = new MacOSXDynamicLinkerImpl();
				aStringArray39 = new String[] { "lib", "" };
				aStringArray40 = new String[] { ".dylib", ".jnilib", "" };
				break;
			default:
	...
	public static Class185 method4417(@OriginalArg(0) String arg0, @OriginalArg(1) ClassLoader arg1) {
		return method4418(arg0, arg0, arg0, arg1);
	}
	...
	private static Class185 method4418(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2, @OriginalArg(4) ClassLoader arg3) {
		@Pc(6) List local6 = method4420(arg0, arg1, arg2, arg3);
		...
		do {
			...
			local32 = anInterface6_1.method4444(local16);
		} while (local32 == 0L);
		if (aBoolean359) {
	...
	private static List method4420(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2, @OriginalArg(4) ClassLoader arg3) {
		@Pc(3) ArrayList local3 = new ArrayList();
		@Pc(8) String local8 = method4421(arg0, arg1, arg2);
		if (local8 == null) {
			return local3;
		}
		...
		@Pc(29) String[] local29 = method4422(local8);
		for (@Pc(33) int local33 = 0; local33 < local29.length; local33++) {
			local3.add(local29[local33]);
		}
		@Pc(49) String local49 = method4424(local8, arg3);
		if (aBoolean359) {
		...
		if (local77 != null) {
			...
			while (local85.hasMoreTokens()) {
				method4423(local85.nextToken(), local29, local3);
			}
		}
		...
		method4423(local100, local29, local3);
		if (anInt5563 == 3) {
			method4423("/Library/Frameworks/" + local8 + ".Framework", local29, local3);
			method4423("/System/Library/Frameworks/" + local8 + ".Framework", local29, local3);
		}
		return local3;
	}
	...
	private static String method4421(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2) {
		switch(anInt5563) {
			case 1:
				return arg0;
			case 2:
	...
	private static String[] method4422(@OriginalArg(0) String arg0) {
		@Pc(35) int local35;
		if (arg0.startsWith(aStringArray39[0])) {
			if (arg0.endsWith(aStringArray40[0])) {
				return new String[] { arg0 };
			}
			@Pc(24) int local24 = arg0.indexOf(aStringArray40[0]);
			@Pc(26) boolean local26 = true;
			if (local24 >= 0) {
				for (local35 = local24 + aStringArray40[0].length(); local35 < arg0.length(); local35++) {
		...
		@Pc(73) String[] local73 = new String[aStringArray39.length * aStringArray40.length];
		@Pc(75) int local75 = 0;
		for (local35 = 0; local35 < aStringArray39.length; local35++) {
			for (@Pc(83) int local83 = 0; local83 < aStringArray40.length; local83++) {
				local73[local75++] = aStringArray39[local35] + arg0 + aStringArray40[local83];
			}
		}
		return local73;
	}
	...
	private static void method4423(@OriginalArg(0) String arg0, @OriginalArg(1) String[] arg1, @OriginalArg(2) List arg2) {
	...
	private static String method4424(@OriginalArg(0) String arg0, @OriginalArg(1) ClassLoader arg1) {
		if (arg1 == null) {
			return null;
		}
		if (!aBoolean360) {
	...
	public static boolean method4429() {
		aBoolean360 = true;
		return true;
	}
	...
	public void method4419() {
		...
		@Pc(12) long local12 = this.aLong202;
		this.aLong202 = 0L;
		anInterface6_1.method4445(local12);
	}
}
