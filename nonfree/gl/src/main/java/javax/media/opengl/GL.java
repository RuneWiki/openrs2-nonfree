...
public interface GL {
	...
	void glClearDepth(@OriginalArg(0) float arg0);
	...
	void glMaterialfv(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float[] arg2, @OriginalArg(3) int arg3);
	...
	void glNormal3f(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2);
	...
	void glPointSize(@OriginalArg(0) float arg0);
	...
	void glDrawArrays(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
