...
public final class opengl implements GL {
	...
	@OriginalMember(owner = "gl!jaggl/opengl", name = "<init>", descriptor = "(Lgl!jaggl/context;)V")
	...
	public boolean isExtensionAvailable(@OriginalArg(0) String arg0) {
		return this.context.isExtensionAvailable(arg0);
	}
	...
	public void setSwapInterval(@OriginalArg(0) int arg0) {
		this.context.setSwapInterval(arg0);
	}
	...
	public native void glMultiTexCoord2i(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
	...
	public native void glPointParameterfARB(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1);
	...
	public native void glInterleavedArrays(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) long arg2);
	...
	@Override
	public void glMaterialfv(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float[] arg2, @OriginalArg(3) int arg3) {
	...
	public native void glPointSize(@OriginalArg(0) float arg0);
