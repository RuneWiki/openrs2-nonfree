...
public final class Class7_Sub30_Sub2 extends Class7_Sub30 {

	@OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(IIIIIF)V")
	public Class7_Sub30_Sub2(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5) {
