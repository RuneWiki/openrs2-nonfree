...
public final class Static13 {
	...
	public static Js5Index aClass20_9;

	@OriginalMember(owner = "client!c", name = "I", descriptor = "Lclient!ec;")
	private static JagString aClass22_89 = Static60.method1113("Connection lost");

	@OriginalMember(owner = "client!c", name = "w", descriptor = "Lclient!ec;")
	public static JagString aClass22_84 = aClass22_89;

	@OriginalMember(owner = "client!c", name = "x", descriptor = "Lclient!ec;")
	public static JagString aClass22_85 = Static60.method1113(")1j");

	@OriginalMember(owner = "client!c", name = "z", descriptor = "Lclient!ec;")
	public static JagString aClass22_86 = Static60.method1113("");

	@OriginalMember(owner = "client!c", name = "G", descriptor = "Lclient!ec;")
	private static JagString aClass22_87 = Static60.method1113("Your profile will be transferred in:");

	@OriginalMember(owner = "client!c", name = "bb", descriptor = "Lclient!ec;")
	private static JagString aClass22_90 = Static60.method1113("World");

	@OriginalMember(owner = "client!c", name = "H", descriptor = "Lclient!ec;")
	public static JagString aClass22_88 = aClass22_90;
	...
	public static JagString aClass22_91 = aClass22_90;

	@OriginalMember(owner = "client!c", name = "Fb", descriptor = "Lclient!ec;")
	public static JagString aClass22_92 = aClass22_87;
	...
	public static void method217(@OriginalArg(0) PathingEntity arg0) {
		if (arg0.anInt2482 == Client.anInt2877 || arg0.anInt2474 == -1 || arg0.anInt2477 != 0 || arg0.anInt2492 + 1 > Static79.method1437(arg0.anInt2474).anIntArray327[arg0.anInt2483]) {
			@Pc(35) int local35 = arg0.anInt2482 - arg0.anInt2488;
			@Pc(41) int local41 = Client.anInt2877 - arg0.anInt2488;
	...
	public static SoftwareFont method218(@OriginalArg(0) byte[] arg0) {
		if (arg0 == null) {
			return null;
		} else {
			@Pc(24) SoftwareFont local24 = new SoftwareFont(arg0, Static57.anIntArray171, Static61.anIntArray175, Static105.anIntArray297, Static30.anIntArray77, Static27.anIntArray75, Static124.aByteArrayArray9);
			Static57.method1094();
			return local24;
		}
	}
		...
		for (@Pc(27) int local27 = 0; local27 < local21; local27++) {
			...
			if (local40 != null && local40.method1614()) {
				...
				if (local99 >= 0 && local99 < 104 && local94 >= 0 && local94 < 104) {
					if (local40.aClass4_Sub1_Sub3_Sub3_1 == null || local40.anInt1735 > Client.anInt2877 || Client.anInt2877 >= local40.anInt1747) {
	...
	public static IfType method225(@OriginalArg(1) IfType arg0) {
