...
public final class Static653 {
	...
	@OriginalMember(owner = "client!gs", name = "a", descriptor = "([B[IIIIIIILclient!gs;)I")
	public static int method3335(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub11_Sub4 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt3885 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!gs", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!gs;)I")
	public static int method3338(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub11_Sub4 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt3877 += arg10.anInt3880 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt3882 = arg4 >> 2;
		arg10.anInt3886 = arg5 >> 2;
		arg10.anInt3885 = arg2 << 8;
		return arg3 >> 1;
	}
	...
	@OriginalMember(owner = "client!gs", name = "a", descriptor = "(II[B[IIIIIIILclient!gs;II)I")
	public static int method3340(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub11_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!gs", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!gs;)I")
	public static int method3342(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub11_Sub4 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt3877 += arg10.anInt3880 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!gs", name = "a", descriptor = "(Lclient!ct;III)Lclient!gs;")
	public static Class2_Sub11_Sub4 method3343(@OriginalArg(0) Class2_Sub14_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray17 == null || arg0.aByteArray17.length == 0 ? null : new Class2_Sub11_Sub4(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!gs", name = "a", descriptor = "([B[IIIIIIIILclient!gs;)I")
	public static int method3345(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub11_Sub4 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt3882 += arg8.anInt3889 * (local24 - arg3);
		arg8.anInt3886 += arg8.anInt3881 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt3877 = arg4 >> 2;
		arg8.anInt3885 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!gs", name = "a", descriptor = "(II[B[IIIIIIIILclient!gs;II)I")
	public static int method3349(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub11_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!gs", name = "a", descriptor = "(I[B[IIIIIIIILclient!gs;)I")
	public static int method3351(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub11_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!gs", name = "b", descriptor = "(II[B[IIIIIIIILclient!gs;II)I")
	public static int method3354(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub11_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt3882 -= arg8.anInt3889 * arg3;
		arg8.anInt3886 -= arg8.anInt3881 * arg3;
		@Pc(32) int local32;
	...
	public static int method3355(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub11_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		...
		local63 = arg3 >> 1;
		arg10.anInt3877 += arg10.anInt3880 * local63;
		arg10.anInt3882 = arg4;
		arg10.anInt3886 = arg5;
		arg10.anInt3885 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!gs", name = "b", descriptor = "([B[IIIIIIILclient!gs;)I")
	public static int method3356(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub11_Sub4 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!gs", name = "b", descriptor = "(I[B[IIIIIIIILclient!gs;)I")
	public static int method3358(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub11_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!gs", name = "c", descriptor = "(II[B[IIIIIIIILclient!gs;II)I")
	public static int method3359(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub11_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!gs", name = "b", descriptor = "([B[IIIIIIIILclient!gs;)I")
	public static int method3362(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub11_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt3882 += arg8.anInt3889 * (local22 - arg3);
		arg8.anInt3886 += arg8.anInt3881 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!gs", name = "d", descriptor = "(II[B[IIIIIIIILclient!gs;II)I")
	public static int method3364(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub11_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt3882 -= arg8.anInt3889 * arg3;
		arg8.anInt3886 -= arg8.anInt3881 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!gs", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!gs;II)I")
	...
	@OriginalMember(owner = "client!gs", name = "b", descriptor = "(II[B[IIIIIIILclient!gs;II)I")
	public static int method3367(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub11_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
