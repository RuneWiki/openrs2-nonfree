...
public final class Static51 {
	...
	public static void method845(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class20 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Class55 arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8) {
		...
		if (arg2 == 10 || arg2 == 11) {
			...
			arg5.method1440(arg7, arg8, arg1, local55, local118, null, Static5.anIntArray37[arg6], 0, local77, local65);
			if (local59.aBoolean77) {
			...
			arg5.method1440(arg7, arg8, arg1, local55, local118, null, Static99.anIntArray13[arg6], 0, local77, local65);
			if (local59.aBoolean77) {
				arg3.method528(local59.aBoolean79, arg6, arg1, arg8, arg2);
			}
		} else {
			...
			if (arg2 == 2) {
				...
				arg5.method1440(arg7, arg8, arg1, local55, local490, local500, Static5.anIntArray37[arg6], Static5.anIntArray37[local468], local77, local65);
				if (local59.aBoolean77) {
					arg3.method528(local59.aBoolean79, arg6, arg1, arg8, arg2);
				}
			} else if (arg2 == 3) {
				...
				if (arg2 == 4) {
					...
					arg5.method1446(arg7, arg8, arg1, local55, local118, Static5.anIntArray37[arg6], arg6 * 512, 0, 0, local77, local65);
				} else if (arg2 == 5) {
					...
					arg5.method1446(arg7, arg8, arg1, local55, local500, Static5.anIntArray37[arg6], arg6 * 512, Static83.anIntArray429[arg6] * local468, local468 * Static55.anIntArray298[arg6], local77, local65);
				} else if (arg2 == 6) {
					if (local59.anInt1048 == -1 && local59.anIntArray210 == null) {
						local118 = local59.method765(0, local23, local45, local13, 4, local35);
					} else {
	...
	public static void method846(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub2_Sub12_Sub1_Sub1 arg1, @OriginalArg(2) int arg2) {
		if ((arg2 & 0x80) != 0) {
			arg1.anInt2324 = Static56.aClass2_Sub3_Sub1_5.method1705();
		...
		if ((arg2 & 0x40) != 0) {
			...
			Static56.aClass2_Sub3_Sub1_5.method1692(local30, local27);
			Static59.aClass2_Sub3Array1[arg0] = local35;
			arg1.method918(local35);
		}
		if ((arg2 & 0x10) != 0) {
			arg1.aClass40_660 = Static56.aClass2_Sub3_Sub1_5.method1721();
			...
			} else if (arg1 == Static88.aClass2_Sub2_Sub12_Sub1_Sub1_1) {
				Static58.method989(2, arg1.aClass40_395, arg1.aClass40_660);
			}
			arg1.anInt2301 = 0;
			arg1.anInt2294 = 150;
		...
		if ((arg2 & 0x8) != 0) {
			...
			local124 = Static56.aClass2_Sub3_Sub1_5.method1715();
			if (local27 == 65535) {
				local27 = -1;
			}
		...
		if ((arg2 & 0x100) != 0) {
			arg1.anInt2317 = Static56.aClass2_Sub3_Sub1_5.method1715();
			arg1.anInt2321 = Static56.aClass2_Sub3_Sub1_5.method1706();
			arg1.anInt2311 = Static56.aClass2_Sub3_Sub1_5.method1715();
			arg1.anInt2286 = Static56.aClass2_Sub3_Sub1_5.method1715();
			arg1.anInt2277 = Static56.aClass2_Sub3_Sub1_5.method1705() + Static107.anInt2511;
			arg1.anInt2297 = Static56.aClass2_Sub3_Sub1_5.method1681() + Static107.anInt2511;
			arg1.anInt2314 = Static56.aClass2_Sub3_Sub1_5.method1706();
			arg1.method1543();
		}
		if ((arg2 & 0x400) != 0) {
			arg1.anInt2302 = Static56.aClass2_Sub3_Sub1_5.method1681();
			local27 = Static56.aClass2_Sub3_Sub1_5.method1728();
			arg1.anInt2291 = 0;
			if (arg1.anInt2302 == 65535) {
				arg1.anInt2302 = -1;
			}
			arg1.anInt2320 = Static107.anInt2511 + (local27 & 0xFFFF);
			if (arg1.anInt2320 > Static107.anInt2511) {
				arg1.anInt2291 = -1;
			}
		...
		if ((arg2 & 0x1) != 0) {
			local27 = Static56.aClass2_Sub3_Sub1_5.method1705();
			local124 = Static56.aClass2_Sub3_Sub1_5.method1715();
			local141 = Static56.aClass2_Sub3_Sub1_5.method1715();
			@Pc(332) int local332 = Static56.aClass2_Sub3_Sub1_5.anInt2546;
			if (arg1.aClass40_395 != null && arg1.aClass33_2 != null) {
				...
				if (local124 <= 1) {
					for (@Pc(350) int local350 = 0; local350 < Static99.anInt121; local350++) {
				...
				if (!local340 && Static19.anInt440 == 0) {
					Static95.aClass2_Sub3_4.anInt2546 = 0;
					Static56.aClass2_Sub3_Sub1_5.method1692(Static95.aClass2_Sub3_4.aByteArray24, local141);
					Static95.aClass2_Sub3_4.anInt2546 = 0;
					@Pc(392) Class40 local392 = Static7.method192(Static95.aClass2_Sub3_4).method1166();
			...
			Static56.aClass2_Sub3_Sub1_5.anInt2546 = local332 + local141;
		}
		if ((arg2 & 0x200) != 0) {
			local27 = Static56.aClass2_Sub3_Sub1_5.method1708();
			local124 = Static56.aClass2_Sub3_Sub1_5.method1708();
			arg1.method1540(local27, Static107.anInt2511, local124);
			arg1.anInt2315 = Static107.anInt2511 + 300;
			arg1.anInt2298 = Static56.aClass2_Sub3_Sub1_5.method1706();
			arg1.anInt2279 = Static56.aClass2_Sub3_Sub1_5.method1715();
		}
		if ((arg2 & 0x20) != 0) {
			...
			arg1.anInt2315 = Static107.anInt2511 + 300;
			arg1.anInt2298 = Static56.aClass2_Sub3_Sub1_5.method1706();
			arg1.anInt2279 = Static56.aClass2_Sub3_Sub1_5.method1706();
		}
		if ((arg2 & 0x2) != 0) {
			arg1.anInt2280 = Static56.aClass2_Sub3_Sub1_5.method1705();
			arg1.anInt2292 = Static56.aClass2_Sub3_Sub1_5.method1681();
		}
	}
