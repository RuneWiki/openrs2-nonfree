...
public final class Static398 {
	...
	public static int method3186(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lclient!cu;II)Lclient!lc;")
	public static Class2_Sub2_Sub2 method3187(@OriginalArg(0) Class2_Sub4_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray19 == null || arg0.aByteArray19.length == 0 ? null : new Class2_Sub2_Sub2(arg0, (int) ((long) arg0.anInt954 * 256L * (long) 100 / (long) (Static221.anInt4100 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!lc", name = "a", descriptor = "([B[IIIIIIIILclient!lc;)I")
	public static int method3189(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub2_Sub2 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt3457 += arg8.anInt3451 * (local22 - arg3);
		arg8.anInt3459 += arg8.anInt3453 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt3460 = arg4 >> 2;
		arg8.anInt3461 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!lc", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!lc;II)I")
	public static int method3193(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub2_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt3460 -= arg10.anInt3458 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt3460 += arg10.anInt3458 * local63;
		arg10.anInt3457 = arg4;
		arg10.anInt3459 = arg5;
		arg10.anInt3461 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!lc", name = "a", descriptor = "(II[B[IIIIIIIILclient!lc;II)I")
	public static int method3195(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub2_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt3457 -= arg8.anInt3451 * arg3;
		arg8.anInt3459 -= arg8.anInt3453 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!lc", name = "a", descriptor = "(II[B[IIIIIIILclient!lc;II)I")
	public static int method3199(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub2_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!lc", name = "a", descriptor = "([B[IIIIIIILclient!lc;)I")
	public static int method3200(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub2_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt3461 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!lc", name = "b", descriptor = "([B[IIIIIIILclient!lc;)I")
	public static int method3203(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub2_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!lc", name = "b", descriptor = "(II[B[IIIIIIIILclient!lc;II)I")
	public static int method3206(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub2_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!lc", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!lc;)I")
	public static int method3207(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub2_Sub2 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt3460 += arg10.anInt3458 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt3457 = arg4 >> 2;
		arg10.anInt3459 = arg5 >> 2;
		arg10.anInt3461 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!lc", name = "b", descriptor = "(II[B[IIIIIIILclient!lc;II)I")
	public static int method3208(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub2_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!lc", name = "b", descriptor = "([B[IIIIIIIILclient!lc;)I")
	public static int method3210(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub2_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt3457 += arg8.anInt3451 * (local24 - arg3);
		arg8.anInt3459 += arg8.anInt3453 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	public static int method3211(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!lc", name = "c", descriptor = "(II[B[IIIIIIIILclient!lc;II)I")
	public static int method3212(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub2_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt3457 -= arg8.anInt3451 * arg3;
		arg8.anInt3459 -= arg8.anInt3453 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!lc", name = "a", descriptor = "(I[B[IIIIIIIILclient!lc;)I")
	public static int method3214(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub2_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lclient!cu;III)Lclient!lc;")
	public static Class2_Sub2_Sub2 method3215(@OriginalArg(0) Class2_Sub4_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray19 == null || arg0.aByteArray19.length == 0 ? null : new Class2_Sub2_Sub2(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!lc", name = "b", descriptor = "(I[B[IIIIIIIILclient!lc;)I")
	public static int method3216(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub2_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!lc", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!lc;)I")
	public static int method3218(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub2_Sub2 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt3460 += arg10.anInt3458 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!lc", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!lc;II)I")
	public static int method3221(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub2_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt3460 -= arg10.anInt3458 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!lc", name = "d", descriptor = "(II[B[IIIIIIIILclient!lc;II)I")
	public static int method3222(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub2_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
