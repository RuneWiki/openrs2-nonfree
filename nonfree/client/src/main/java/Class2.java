...
public abstract class Class2 {
	...
	public final void method5912(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class74 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		if (arg4 == 0) {
			return;
		}
		...
		this.method5913(local37, local50, local67, local85, local102, local118, arg6, arg7, arg8);
	}

	@OriginalMember(owner = "client!aa", name = "a", descriptor = "(FFFFFFLclient!i;II)V")
	protected abstract void method5913(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) Class74 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8);

	@OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIII)V")
	public final void method5914(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	private void method5915(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg4 == 0) {
			return;
		}
		@Pc(9) double local9 = (double) (arg5 & 0xFFFF) * 9.587379924285257E-5D;
	...
	public final void method5917(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Class74 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		this.method5912(arg0, arg1, (float) this.d() / 2.0F, (float) this.ga() / 2.0F, 4096, arg2, arg3, arg4, arg5);
	}
	...
	public final void method5918(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.PA(arg0, arg1, arg2, arg3, 1, 0, 1);
	}

	@OriginalMember(owner = "client!aa", name = "a", descriptor = "(FFIIIII)V")
	public final void method5919(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4) {
		this.method5915(arg0, arg1, (float) this.d() / 2.0F, (float) this.ga() / 2.0F, arg2, arg3, 0, arg4);
	}
	...
	public final void method5920(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.method5915(arg0, arg1, (float) this.d() / 2.0F, (float) this.ga() / 2.0F, arg2, arg3, 1, 0);
	}
	...
	public final void method5921(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
