...
public final class Class2 {
	...
	public static void method22() {
		try {
			...
			signlink.reporterror("1378, " + true + ", " + local14.toString());
	...
	private void method25(@OriginalArg(1) Class1_Sub3_Sub3 arg0) {
		try {
			@Pc(12) int local12 = -1;
			while (true) {
				while (true) {
					@Pc(15) int local15 = arg0.method391();
					if (local15 == 0) {
					...
					if (local15 == 1) {
						...
						this.anInt43 = arg0.method391();
					} else if (local15 == 15) {
						this.anInt44 = arg0.method391();
					} else if (local15 == 17) {
						this.aBoolean7 = false;
					} else if (local15 == 18) {
						this.aBoolean8 = false;
					} else if (local15 == 19) {
						local12 = arg0.method391();
						if (local12 == 1) {
							this.aBoolean9 = true;
						}
					} else if (local15 == 21) {
						...
						this.aByte2 = arg0.method392();
					} else if (local15 == 39) {
						this.aByte3 = arg0.method392();
					} else if (local15 >= 30 && local15 < 39) {
						if (this.aStringArray1 == null) {
							this.aStringArray1 = new String[5];
						}
						this.aStringArray1[local15 - 30] = arg0.method398();
						...
						for (local33 = 0; local33 < local23; local33++) {
							this.anIntArray6[local33] = arg0.method393();
							this.anIntArray7[local33] = arg0.method393();
						}
					} else if (local15 == 60) {
						...
						this.anInt48 = arg0.method393();
					} else if (local15 == 69) {
						this.anInt55 = arg0.method391();
					} else if (local15 == 70) {
						this.anInt52 = arg0.method394();
					} else if (local15 == 71) {
						this.anInt53 = arg0.method394();
					} else if (local15 == 72) {
			...
			signlink.reporterror("20782, " + false + ", " + arg0 + ", " + local409.toString());
			throw new RuntimeException();
		}
	}
	...
	public Class1_Sub3_Sub1 method26(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (local56 == null) {
			...
			if (local200 == null) {
				...
				aClass35_1.method528((long) local91, local200);
			}
			...
			@Pc(284) Class1_Sub3_Sub1 local284 = new Class1_Sub3_Sub1(local200, this.anIntArray6 == null, !this.aBoolean13, anInt38, arg1 == 0 && arg6 == -1 && !local235 && !local250);
			if (arg6 != -1) {
				local284.method230();
			...
			if (local235) {
				local284.method239(this.anInt51, this.anInt50, this.anInt49);
			}
			if (local250) {
				local284.method236(this.anInt53, this.anInt52, this.anInt54);
			}
			local284.method240(this.aByte2 + 64, this.aByte3 * 5 + 768, -50, -10, -50, !this.aBoolean11);
			if (this.aBoolean7) {
				local284.anInt372 = local284.anInt368;
			}
			aClass35_2.method528(local47, local284);
