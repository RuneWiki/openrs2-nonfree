...
public final class Static399 {
	...
	@OriginalMember(owner = "client!ib", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!ib;)I")
	public static int method2225(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub7_Sub2 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt2728 += arg10.anInt2737 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt2727 = arg4 >> 2;
		arg10.anInt2736 = arg5 >> 2;
		arg10.anInt2739 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!ib", name = "a", descriptor = "(II[B[IIIIIIIILclient!ib;II)I")
	public static int method2226(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub7_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ib", name = "a", descriptor = "([B[IIIIIIIILclient!ib;)I")
	public static int method2228(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub7_Sub2 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt2727 += arg8.anInt2730 * (local24 - arg3);
		arg8.anInt2736 += arg8.anInt2732 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt2728 = arg4 >> 2;
		arg8.anInt2739 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ib", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!ib;II)I")
	public static int method2229(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub7_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt2728 -= arg10.anInt2737 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt2728 += arg10.anInt2737 * local63;
		arg10.anInt2727 = arg4;
		arg10.anInt2736 = arg5;
		arg10.anInt2739 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!ib", name = "a", descriptor = "(I[B[IIIIIIIILclient!ib;)I")
	public static int method2231(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub7_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
	...
	public static int method2232(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ib", name = "b", descriptor = "([B[IIIIIIIILclient!ib;)I")
	public static int method2236(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub7_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt2727 += arg8.anInt2730 * (local22 - arg3);
		arg8.anInt2736 += arg8.anInt2732 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!ib", name = "a", descriptor = "(II[B[IIIIIIILclient!ib;II)I")
	public static int method2237(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub7_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ib", name = "b", descriptor = "(II[B[IIIIIIIILclient!ib;II)I")
	public static int method2240(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub7_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt2727 -= arg8.anInt2730 * arg3;
		arg8.anInt2736 -= arg8.anInt2732 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ib", name = "a", descriptor = "([B[IIIIIIILclient!ib;)I")
	public static int method2241(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub7_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt2739 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ib", name = "c", descriptor = "(II[B[IIIIIIIILclient!ib;II)I")
	public static int method2242(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub7_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lclient!uk;III)Lclient!ib;")
	public static Class1_Sub7_Sub2 method2243(@OriginalArg(0) Class1_Sub31_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray84 == null || arg0.aByteArray84.length == 0 ? null : new Class1_Sub7_Sub2(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!ib", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!ib;II)I")
	public static int method2245(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub7_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt2728 -= arg10.anInt2737 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!ib", name = "b", descriptor = "(I[B[IIIIIIIILclient!ib;)I")
	public static int method2247(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub7_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!ib", name = "b", descriptor = "(II[B[IIIIIIILclient!ib;II)I")
	public static int method2250(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub7_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lclient!uk;II)Lclient!ib;")
	public static Class1_Sub7_Sub2 method2255(@OriginalArg(0) Class1_Sub31_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray84 == null || arg0.aByteArray84.length == 0 ? null : new Class1_Sub7_Sub2(arg0, (int) ((long) arg0.anInt5825 * 256L * (long) 100 / (long) (Static212.anInt3652 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!ib", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!ib;)I")
	public static int method2256(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub7_Sub2 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt2728 += arg10.anInt2737 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	public static int method2258(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ib", name = "d", descriptor = "(II[B[IIIIIIIILclient!ib;II)I")
	public static int method2259(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub7_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt2727 -= arg8.anInt2730 * arg3;
		arg8.anInt2736 -= arg8.anInt2732 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ib", name = "b", descriptor = "([B[IIIIIIILclient!ib;)I")
	public static int method2261(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub7_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
