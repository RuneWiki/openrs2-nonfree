...
public final class Frame_Sub1 extends Frame {
	...
	@OriginalMember(owner = "client!VZJCTUDQ", name = "a", descriptor = "Lclient!NHAOTYHM;")
	private Applet_Sub1 anApplet_Sub1_2;

	@OriginalMember(owner = "client!VZJCTUDQ", name = "<init>", descriptor = "(ILclient!NHAOTYHM;II)V")
	public Frame_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) Applet_Sub1 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			...
			signlink.reporterror("49335, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + local33.toString());
