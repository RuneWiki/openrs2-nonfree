...
public final class Frame_Sub1 extends Frame {
	...
	@OriginalMember(owner = "client!SZXWXMTH", name = "b", descriptor = "Lclient!SXKUAOFD;")
	private Applet_Sub1 anApplet_Sub1_1;

	@OriginalMember(owner = "client!SZXWXMTH", name = "<init>", descriptor = "(IIILclient!SXKUAOFD;)V")
	public Frame_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Applet_Sub1 arg3) {
		try {
			...
			signlink.reporterror("57415, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + local37.toString());
