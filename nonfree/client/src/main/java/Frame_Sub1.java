...
public final class Frame_Sub1 extends Frame {
	...
	@OriginalMember(owner = "client!b", name = "<init>", descriptor = "(ILclient!a;IB)V")
	public Frame_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) Applet_Sub1 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		try {
			...
			signlink.reporterror("79005, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + local34.toString());
