...
public final class Frame_Sub1 extends Frame {
	...
	private int anInt52 = 568;

	@OriginalMember(owner = "client!b", name = "c", descriptor = "Lclient!a;")
	private Applet_Sub1 anApplet_Sub1_1;

	@OriginalMember(owner = "client!b", name = "<init>", descriptor = "(IILclient!a;B)V")
	public Frame_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Applet_Sub1 arg2, @OriginalArg(3) byte arg3) {
		try {
			...
			signlink.reporterror("77500, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + local37.toString());
