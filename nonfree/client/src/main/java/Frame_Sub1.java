...
public final class Frame_Sub1 extends Frame {
	...
	@OriginalMember(owner = "client!WSQCMTWN", name = "a", descriptor = "Lclient!VTYHSWDE;")
	private Applet_Sub1 anApplet_Sub1_2;

	@OriginalMember(owner = "client!WSQCMTWN", name = "<init>", descriptor = "(BILclient!VTYHSWDE;I)V")
	public Frame_Sub1(@OriginalArg(0) byte arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Applet_Sub1 arg2, @OriginalArg(3) int arg3) {
		try {
			...
			signlink.reporterror("9955, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + local31.toString());
