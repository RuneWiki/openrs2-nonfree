...
public final class Static268 {
	...
	public static void method3817() {
		Static403.aClass352_37.method7656();
	}

	@OriginalMember(owner = "client!iw", name = "a", descriptor = "(IB)Lclient!aea;")
	public static Class4_Sub2 method3824(@OriginalArg(0) int arg0) {
		if (arg0 == 0) {
			...
			return new Class4_Sub2_Sub29_Sub1();
		} else if (arg0 == 19) {
