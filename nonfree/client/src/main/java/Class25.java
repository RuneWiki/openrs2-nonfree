...
public final class Class25 {
	...
	public static void method414(@OriginalArg(0) Class39 arg0) {
		@Pc(11) Class1_Sub3_Sub3 local11 = new Class1_Sub3_Sub3(363, arg0.method536("fragmentsenc.txt", null));
		@Pc(21) Class1_Sub3_Sub3 local21 = new Class1_Sub3_Sub3(363, arg0.method536("badenc.txt", null));
		@Pc(31) Class1_Sub3_Sub3 local31 = new Class1_Sub3_Sub3(363, arg0.method536("domainenc.txt", null));
		@Pc(41) Class1_Sub3_Sub3 local41 = new Class1_Sub3_Sub3(363, arg0.method536("tldlist.txt", null));
	...
	private static void method416(@OriginalArg(1) Class1_Sub3_Sub3 arg0) {
		try {
			...
			signlink.reporterror("86833, " + true + ", " + arg0 + ", " + local51.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!mc", name = "a", descriptor = "(ILclient!kb;)V")
	private static void method417(@OriginalArg(1) Class1_Sub3_Sub3 arg0) {
		try {
			@Pc(2) int local2 = arg0.method396();
			aCharArrayArray1 = new char[local2][];
			aByteArrayArrayArray8 = new byte[local2][][];
			method420(aByteArrayArrayArray8, aCharArrayArray1, arg0, (byte) 1);
		} catch (@Pc(25) RuntimeException local25) {
			signlink.reporterror("34550, " + -33152 + ", " + arg0 + ", " + local25.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lclient!kb;I)V")
	private static void method418(@OriginalArg(0) Class1_Sub3_Sub3 arg0) {
		try {
			@Pc(2) int local2 = arg0.method396();
			aCharArrayArray2 = new char[local2][];
			method421(arg0, aCharArrayArray2);
		} catch (@Pc(14) RuntimeException local14) {
			signlink.reporterror("77072, " + arg0 + ", " + -717 + ", " + local14.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!mc", name = "b", descriptor = "(ILclient!kb;)V")
	private static void method419(@OriginalArg(1) Class1_Sub3_Sub3 arg0) {
		try {
			...
			signlink.reporterror("14267, " + 24882 + ", " + arg0 + ", " + local28.toString());
			throw new RuntimeException();
		}
	}
	...
	private static void method421(@OriginalArg(1) Class1_Sub3_Sub3 arg0, @OriginalArg(2) char[][] arg1) {
		try {
			...
			signlink.reporterror("81110, " + -178 + ", " + arg0 + ", " + arg1 + ", " + local46.toString());
			throw new RuntimeException();
		}
	}
	...
	private static void method422(@OriginalArg(0) char[] arg0) {
		try {
			...
			signlink.reporterror("86890, " + arg0 + ", " + 0 + ", " + local68.toString());
			throw new RuntimeException();
		}
	}
	...
	private static boolean method423(@OriginalArg(1) char arg0) {
		try {
			...
			signlink.reporterror("68887, " + 16180 + ", " + arg0 + ", " + local32.toString());
			throw new RuntimeException();
		}
	}
	...
	public static String method424(@OriginalArg(0) String arg0) {
		try {
			...
			signlink.reporterror("37188, " + arg0 + ", " + 0 + ", " + local112.toString());
			throw new RuntimeException();
		}
	}
	...
	private static void method425(@OriginalArg(0) char[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) char[] arg2) {
		try {
			for (@Pc(1) int local1 = 0; local1 < arg2.length; local1++) {
				if (arg0[local1] != '*' && method449(arg2[local1])) {
	...
	private static void method426(@OriginalArg(0) byte arg0, @OriginalArg(1) char[] arg1) {
		try {
			...
			for (@Pc(13) int local13 = 0; local13 < arg1.length; local13++) {
				@Pc(19) char local19 = arg1[local13];
				if (!method446(local19)) {
					...
					arg1[local13] = (char) (local19 + 'a' - 65);
				}
			}
	...
	private static void method427(@OriginalArg(1) char[] arg0) {
		try {
			...
			signlink.reporterror("90308, " + true + ", " + arg0 + ", " + local32.toString());
			throw new RuntimeException();
		}
	}
	...
	private static void method428(@OriginalArg(1) char[] arg0) {
		try {
			...
			signlink.reporterror("68434, " + 120 + ", " + arg0 + ", " + local71.toString());
			throw new RuntimeException();
		}
	}
	...
	private static void method429(@OriginalArg(0) char[] arg0, @OriginalArg(2) char[] arg1, @OriginalArg(3) char[] arg2, @OriginalArg(4) char[] arg3) {
		try {
			if (arg2.length <= arg3.length) {
				...
				for (@Pc(15) int local15 = 0; local15 <= arg3.length - arg2.length; local15 += local23) {
					...
					if (local21 >= arg2.length) {
						...
						@Pc(116) int local116 = method430(local15, arg3, (byte) 6, arg1);
			...
			signlink.reporterror("98022, " + arg0 + ", " + -706 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + local159.toString());
			throw new RuntimeException();
		}
	}
	...
	private static int method430(@OriginalArg(0) int arg0, @OriginalArg(1) char[] arg1, @OriginalArg(2) byte arg2, @OriginalArg(3) char[] arg3) {
		try {
			...
			@Pc(37) int local37 = 0;
			for (@Pc(41) int local41 = arg0 - 1; local41 >= 0 && method444(arg3[local41]); local41--) {
				if (arg3[local41] == '*') {
					local37++;
				}
			}
	...
	private static int method431(@OriginalArg(0) char[] arg0, @OriginalArg(1) char[] arg1, @OriginalArg(2) int arg2) {
		try {
			...
			signlink.reporterror("48464, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + -808 + ", " + local86.toString());
			throw new RuntimeException();
		}
	}
	...
	private static void method432(@OriginalArg(0) char[] arg0) {
		try {
			...
			signlink.reporterror("31380, " + arg0 + ", " + 0 + ", " + local85.toString());
			throw new RuntimeException();
		}
	}
	...
	private static void method433(@OriginalArg(0) char[] arg0, @OriginalArg(1) int arg1, @OriginalArg(3) char[] arg2, @OriginalArg(4) char[] arg3, @OriginalArg(5) char[] arg4) {
		try {
			...
			signlink.reporterror("17147, " + arg0 + ", " + arg1 + ", " + true + ", " + arg2 + ", " + arg3 + ", " + arg4 + ", " + local352.toString());
			throw new RuntimeException();
		}
	}
	...
	private static int method434(@OriginalArg(0) char[] arg0, @OriginalArg(2) char[] arg1, @OriginalArg(3) int arg2) {
		try {
			...
			signlink.reporterror("73918, " + arg0 + ", " + false + ", " + arg1 + ", " + arg2 + ", " + local83.toString());
			throw new RuntimeException();
		}
	}
	...
	private static int method435(@OriginalArg(0) char[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) char[] arg2) {
		try {
			...
			signlink.reporterror("17610, " + arg0 + ", " + -678 + ", " + arg1 + ", " + arg2 + ", " + local86.toString());
			throw new RuntimeException();
		}
	}
	...
	private static void method436(@OriginalArg(1) byte[][] arg0, @OriginalArg(2) char[] arg1, @OriginalArg(3) char[] arg2) {
		try {
			...
			signlink.reporterror("10220, " + -102 + ", " + arg0 + ", " + arg1 + ", " + arg2 + ", " + local437.toString());
			throw new RuntimeException();
		}
	}
	...
	private static boolean method437(@OriginalArg(1) byte arg0, @OriginalArg(2) byte[][] arg1, @OriginalArg(3) byte arg2) {
		try {
			...
			signlink.reporterror("65186, " + 841 + ", " + arg0 + ", " + arg1 + ", " + arg2 + ", " + local106.toString());
			throw new RuntimeException();
		}
	}
	...
	private static int method438(@OriginalArg(1) char arg0, @OriginalArg(2) char arg1, @OriginalArg(3) char arg2) {
		try {
			...
			signlink.reporterror("22330, " + -81 + ", " + arg0 + ", " + arg1 + ", " + arg2 + ", " + local77.toString());
			throw new RuntimeException();
		}
	}
	...
	private static int method439(@OriginalArg(0) char arg0, @OriginalArg(1) char arg1, @OriginalArg(2) char arg2) {
		try {
			...
			signlink.reporterror("72478, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + 7326 + ", " + local503.toString());
			throw new RuntimeException();
		}
	}
	...
	private static byte method440(@OriginalArg(1) char arg0) {
		try {
			...
			signlink.reporterror("37807, " + 0 + ", " + arg0 + ", " + local39.toString());
			throw new RuntimeException();
		}
	}
	...
	private static void method441(@OriginalArg(1) char[] arg0) {
		try {
			...
			while (true) {
				do {
					@Pc(112) int local112;
					if ((local112 = method442(149, arg0, local5)) == -1) {
						return;
					}
			...
			signlink.reporterror("18716, " + 8 + ", " + arg0 + ", " + local116.toString());
			throw new RuntimeException();
		}
	}
	...
	private static int method443(@OriginalArg(1) int arg0, @OriginalArg(2) char[] arg1) {
		try {
			...
			signlink.reporterror("22999, " + 6 + ", " + arg0 + ", " + arg1 + ", " + local31.toString());
			throw new RuntimeException();
		}
	}
	...
	private static boolean method444(@OriginalArg(0) char arg0) {
		try {
			...
			signlink.reporterror("40138, " + arg0 + ", " + 2 + ", " + local19.toString());
			throw new RuntimeException();
		}
	}
	...
	private static boolean method445(@OriginalArg(0) char arg0) {
		try {
			...
			signlink.reporterror("85337, " + arg0 + ", " + 13 + ", " + local34.toString());
			throw new RuntimeException();
		}
	}
	...
	private static boolean method446(@OriginalArg(1) char arg0) {
		try {
			...
			signlink.reporterror("88324, " + -175 + ", " + arg0 + ", " + local22.toString());
			throw new RuntimeException();
		}
	}
	...
	private static boolean method447(@OriginalArg(0) char arg0) {
		try {
			...
			signlink.reporterror("12677, " + arg0 + ", " + 10361 + ", " + local15.toString());
			throw new RuntimeException();
		}
	}
	...
	private static boolean method448(@OriginalArg(1) char arg0) {
		try {
			...
			signlink.reporterror("54545, " + 0 + ", " + arg0 + ", " + local14.toString());
			throw new RuntimeException();
		}
	}
	...
	private static boolean method449(@OriginalArg(1) char arg0) {
		try {
			...
			signlink.reporterror("31350, " + 0 + ", " + arg0 + ", " + local20.toString());
			throw new RuntimeException();
		}
	}
	...
	private static boolean method450(@OriginalArg(0) char[] arg0) {
		try {
			...
			signlink.reporterror("69798, " + arg0 + ", " + 6 + ", " + local96.toString());
			throw new RuntimeException();
		}
	}
	...
	private static int method451(@OriginalArg(1) char[] arg0) {
		try {
			...
			signlink.reporterror("78520, " + 5 + ", " + arg0 + ", " + local94.toString());
			throw new RuntimeException();
		}
	}
}
