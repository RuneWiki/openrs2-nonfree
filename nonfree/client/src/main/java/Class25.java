...
public abstract class Class25 {
	...
	public abstract void M(@OriginalArg(0) Class25 arg0);

	@OriginalMember(owner = "client!q", name = "a", descriptor = "(III[I)V")
	public abstract void method5881(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3);
	...
	public abstract Class25 method5883();
