...
public abstract class Class25 {
	...
	public final void method6956(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public final void method6957(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4) {
		this.method6961(arg0, arg1, (float) this.EA() / 2.0F, (float) this.ma() / 2.0F, arg2, arg3, 0, arg4);
	}
	...
	public final void method6958(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.i(arg0, arg1, arg2, arg3, 1, 0, 1);
	}

	@OriginalMember(owner = "client!ha", name = "a", descriptor = "(FFFFIILclient!pa;II)V")
	public final void method6959(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class87 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		if (arg4 == 0) {
			return;
		}
		...
		this.method6963(local37, local50, local67, local85, local102, local118, arg6, arg7, arg8);
	}
	...
	public final void method6960(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	private void method6961(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg4 == 0) {
			return;
		}
		@Pc(9) double local9 = (double) (arg5 & 0xFFFF) * 9.587379924285257E-5D;
	...
	public final void method6962(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.method6961(arg0, arg1, (float) this.EA() / 2.0F, (float) this.ma() / 2.0F, arg2, arg3, 1, 0);
	}

	@OriginalMember(owner = "client!ha", name = "a", descriptor = "(FFFFFFLclient!pa;II)V")
	protected abstract void method6963(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) Class87 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8);

	@OriginalMember(owner = "client!ha", name = "a", descriptor = "(FFIILclient!pa;II)V")
	public final void method6964(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Class87 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		this.method6959(arg0, arg1, (float) this.EA() / 2.0F, (float) this.ma() / 2.0F, 4096, arg2, arg3, arg4, arg5);
	}
