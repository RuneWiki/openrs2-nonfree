...
public final class Static114 {
	...
	private static JagString aClass22_879 = Static60.method1113("Please enter your password)3");
	...
	public static JagString aClass22_880 = aClass22_879;

	@OriginalMember(owner = "client!td", name = "ob", descriptor = "Lclient!ec;")
	public static JagString aClass22_881 = Static60.method1113("nicht hergestellt werden)3");

	@OriginalMember(owner = "client!td", name = "rb", descriptor = "Lclient!ec;")
	public static JagString aClass22_882 = Static60.method1113("sind fehlgeschlagen)3 Bitte warten Sie 5 Minuten)1");
	...
	public static void method1818(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		...
		@Pc(37) int local37 = Pix3D.anIntArray9[Static39.anInt957];
		@Pc(41) int local41 = local29 - Static60.anInt1788;
		@Pc(49) int local49 = Pix3D.anIntArray12[Static39.anInt957];
		@Pc(53) int local53 = Pix3D.anIntArray9[Static96.anInt2480];
		@Pc(57) int local57 = Pix3D.anIntArray12[Static96.anInt2480];
	...
	public static void method1819(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Pix32 arg3, @OriginalArg(5) int arg4) {
		if (arg3 == null) {
			return;
		}
		...
		@Pc(38) int local38 = Pix3D.anIntArray9[local12];
		@Pc(46) int local46 = local38 * 256 / (Static25.anInt574 + 256);
		@Pc(50) int local50 = Pix3D.anIntArray12[local12];
	...
	public static Pix8 method1820(@OriginalArg(0) JagString arg0, @OriginalArg(1) Js5Index arg1, @OriginalArg(3) JagString arg2) {
	...
	public static void method1821(@OriginalArg(0) Js5Index arg0, @OriginalArg(1) Js5Index arg1) {
