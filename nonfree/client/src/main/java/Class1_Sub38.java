...
public final class Class1_Sub38 extends Class1 {
	...
	public Class1_Sub38(@OriginalArg(0) byte[] arg0) {
		this.method4555(arg0);
	}

	@OriginalMember(owner = "client!ra", name = "b", descriptor = "([B)V")
	private void method4555(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub21 local4 = new Class1_Sub21(arg0);
		this.anInt5250 = local4.method5716();
		this.anInt5253 = local4.method5716();
		this.anInt5254 = local4.method5716();
		this.anInt5255 = local4.method5716();
		if (this.anInt5255 < 0) {
			this.anInt5255 = ~this.anInt5255;
			this.aBoolean432 = true;
		}
		@Pc(40) int local40 = local4.method5716();
		this.aByteArrayArray17 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method5720();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method5730(local64, local49);
			this.aByteArrayArray17[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!ra", name = "a", descriptor = "([I)Lclient!ig;")
	public Class1_Sub20_Sub1 method4557(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray61 == null) {
			this.anInt5247 = 0;
			this.aFloatArray22 = new float[Static255.anInt5249];
			this.aByteArray61 = new byte[this.anInt5253];
			this.anInt5256 = 0;
			this.anInt5257 = 0;
		}
		while (this.anInt5257 < this.aByteArrayArray17.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method4559(this.anInt5257);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt5256;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt5253 - local47) {
					local50 = this.anInt5253 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray61[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt5256;
				}
				this.anInt5256 = local47;
			}
			this.anInt5257++;
		}
		this.aFloatArray22 = null;
		@Pc(129) byte[] local129 = this.aByteArray61;
		this.aByteArray61 = null;
		return new Class1_Sub20_Sub1(this.anInt5250, local129, this.anInt5254, this.anInt5255, this.aBoolean432);
	}

	@OriginalMember(owner = "client!ra", name = "c", descriptor = "(I)[F")
	private float[] method4559(@OriginalArg(0) int arg0) {
		Static255.method4556(this.aByteArrayArray17[arg0]);
		Static255.method4558();
		@Pc(15) int local15 = Static255.method4563(Static92.method1447(Static255.anIntArray489.length - 1));
		@Pc(19) boolean local19 = Static255.aBooleanArray22[local15];
		@Pc(25) int local25 = local19 ? Static255.anInt5249 : Static255.anInt5246;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static255.method4558() != 0;
			local29 = Static255.method4558() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static255.anInt5246 >> 2);
			local67 = (local25 >> 2) + (Static255.anInt5246 >> 2);
			local71 = Static255.anInt5246 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static255.anInt5246 >> 2);
			local104 = local25 + (Static255.anInt5246 >> 2) - (local25 >> 2);
			local108 = Static255.anInt5246 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class30 local123 = Static255.aClass30Array1[Static255.anIntArray489[local15]];
		@Pc(126) int local126 = local123.anInt615;
		@Pc(131) int local131 = local123.anIntArray35[local126];
		@Pc(140) boolean local140 = !Static255.aClass200Array1[local131].method5403();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt614; local144++) {
			@Pc(152) Class160 local152 = Static255.aClass160Array1[local123.anIntArray36[local144]];
			local154 = Static255.aFloatArray19;
			local152.method4201(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt615;
			local176 = local123.anIntArray35[local171];
			Static255.aClass200Array1[local176].method5408(Static255.aFloatArray19, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static255.aFloatArray19[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static255.aFloatArray19;
			...
			@Pc(252) float[] local252 = local19 ? Static255.aFloatArray21 : Static255.aFloatArray20;
			@Pc(258) float[] local258 = local19 ? Static255.aFloatArray23 : Static255.aFloatArray17;
			@Pc(264) float[] local264 = local19 ? Static255.aFloatArray16 : Static255.aFloatArray18;
			@Pc(270) int[] local270 = local19 ? Static255.anIntArray491 : Static255.anIntArray490;
			...
			@Pc(486) int local486 = Static92.method1447(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static255.aFloatArray19[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static255.aFloatArray19[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt5247 > 0) {
			local176 = this.anInt5247 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean433) {
				for (local212 = 0; local212 < this.anInt5248; local212++) {
					local1254 = (this.anInt5247 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static255.aFloatArray19[local212];
				}
			}
		}
		local154 = this.aFloatArray22;
		this.aFloatArray22 = Static255.aFloatArray19;
		Static255.aFloatArray19 = local154;
		this.anInt5247 = local25;
		this.anInt5248 = local104 - (local25 >> 1);
		this.aBoolean433 = local140;
		return local1228;
	}
}
