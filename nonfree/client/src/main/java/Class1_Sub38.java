...
public final class Class1_Sub38 extends Class1 {
	...
	public Class1_Sub38(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) boolean arg3) {
		this.anInt5957 = arg0;
		this.anInt5959 = arg1;
		this.anIntArray476 = arg2;
		if (arg3) {
			@Pc(16) int[] local16 = new int[this.anInt5959];
			@Pc(20) int[] local20 = new int[this.anInt5959];
			@Pc(24) int[] local24 = new int[this.anInt5959];
			if (Static344.anIntArray475 == null || Static344.anIntArray475.length < this.anIntArray476.length) {
				Static344.anIntArray475 = new int[this.anIntArray476.length];
			}
			@Pc(40) int local40 = this.anInt5959;
			@Pc(43) int local43 = this.anInt5959;
			...
			for (@Pc(61) int local61 = 2; local61 >= 0; local61--) {
				for (local64 = local47; local64 >= 0; local64--) {
					local58--;
					@Pc(71) int local71 = this.anIntArray476[local58];
			...
			for (@Pc(116) int local116 = local51; local116 >= 0; local116--) {
				...
				for (local64 = local47; local64 >= 0; local64--) {
					...
					local114--;
					Static344.anIntArray475[local114] = local165 << 16 | local169 << 8 | local173;
				...
				for (local64 = local47; local64 >= 0; local64--) {
					local58--;
					@Pc(236) int local236 = this.anIntArray476[local58];
					local59--;
					@Pc(242) int local242 = this.anIntArray476[local59];
			...
			@Pc(306) int[] local306 = this.anIntArray476;
			this.anIntArray476 = Static344.anIntArray475;
			Static344.anIntArray475 = local306;
		}
	}

	@OriginalMember(owner = "client!ri", name = "a", descriptor = "()[I")
	public int[] method4822() {
		return this.anIntArray476;
	}

	@OriginalMember(owner = "client!ri", name = "a", descriptor = "(II)V")
	public void method4823(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 == 0 && arg1 == 0) {
			return;
		}
		if (Static344.anIntArray475 == null || Static344.anIntArray475.length < this.anIntArray476.length) {
		...
		@Pc(21) int local21 = this.anIntArray476.length;
		@Pc(28) int local28 = this.anInt5959 - 1;
		@Pc(33) int local33 = this.anInt5959 * arg1;
		@Pc(37) int local37 = local21 - 1;
		for (@Pc(39) int local39 = 0; local39 < local21; local39 += this.anInt5959) {
			@Pc(46) int local46 = local39 + local33 & local37;
			for (@Pc(48) int local48 = 0; local48 < this.anInt5959; local48++) {
				@Pc(53) int local53 = local39 + local48;
				@Pc(61) int local61 = local46 + (local48 + arg0 & local28);
				Static344.anIntArray475[local53] = this.anIntArray476[local61];
			}
		}
		@Pc(84) int[] local84 = this.anIntArray476;
		this.anIntArray476 = Static344.anIntArray475;
		Static344.anIntArray475 = local84;
	}
}
