...
public interface Interface5 {
	...
	void method4599(@OriginalArg(0) Class126 arg0);
	...
	void method4602(@OriginalArg(0) Class126 arg0);

	@OriginalMember(owner = "client!fg", name = "a", descriptor = "(I[BI)V")
	void method4603(@OriginalArg(0) int arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!fg", name = "d", descriptor = "(Lclient!kj;)V")
	void method4604(@OriginalArg(0) Class126 arg0);
}
