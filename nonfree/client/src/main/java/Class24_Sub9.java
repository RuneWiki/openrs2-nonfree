...
public final class Class24_Sub9 extends Class24 {

	@OriginalMember(owner = "client!gha", name = "<init>", descriptor = "(Lclient!hia;)V")
	public Class24_Sub9(@OriginalArg(0) Class5_Sub20 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!gha", name = "<init>", descriptor = "(ILclient!hia;)V")
	public Class24_Sub9(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub20 arg1) {
		super(arg0, arg1);
	}
