...
public final class Static41 {
	...
	public static LruCache aClass33_16 = new LruCache(100);

	@OriginalMember(owner = "client!ge", name = "Wb", descriptor = "Lclient!ja;")
	public static LruCache aClass33_17 = new LruCache(30);

	@OriginalMember(owner = "client!ge", name = "Yb", descriptor = "Lclient!ec;")
	private static JagString aClass22_285 = Static60.method1113("Walk here");

	@OriginalMember(owner = "client!ge", name = "Xb", descriptor = "Lclient!ec;")
	public static JagString aClass22_284 = aClass22_285;
	...
	public static boolean method745(@OriginalArg(0) Js5Index arg0, @OriginalArg(1) Js5Index arg1, @OriginalArg(2) MidiPcmStream arg2, @OriginalArg(4) Js5Index arg3) {
	...
	public static boolean method754(@OriginalArg(0) Js5Index arg0, @OriginalArg(1) int arg1) {
	...
	public static void method756(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) CollisionMap[] arg5, @OriginalArg(7) byte[] arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8) {
		...
		@Pc(90) Packet local90 = new Packet(arg6);
