...
public final class Class2_Sub2_Sub14 extends Class2_Sub2 {
	...
	private Class2_Sub2_Sub14() {
		...
		this.aClass2_Sub3_2.anInt7238 = 1;
		this.aClass2_Sub3_3 = new Class2_Sub3_Sub1();
		this.aClass2_Sub3_3.anInt7238 = 1;
		this.aClass2_Sub3_1 = new Class2_Sub3_Sub1();
		this.aClass2_Sub3Array30 = new Class2_Sub3[] { this.aClass2_Sub3_3, this.aClass2_Sub3_1, this.aClass2_Sub3_2 };
		this.aClass2_Sub3_1.anInt7238 = 1;
	}

	@OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Lclient!bt;)V", line = 358)
	public Class2_Sub2_Sub14(@OriginalArg(0) Class2_Sub4 arg0) {
		@Pc(7) int local7 = arg0.method4816();
		@Pc(9) int local9 = 0;
		@Pc(11) int local11 = 0;
		...
		for (@Pc(20) int local20 = 0; local20 < local7; local20++) {
			@Pc(26) Class2_Sub3 local26 = Static263.method4929(arg0);
			if (local26.method6479() >= 0) {
				local9++;
			}
			if (local26.method6483() >= 0) {
				local11++;
			}
			@Pc(43) int local43 = local26.aClass2_Sub3Array42.length;
			local14[local20] = new int[local43];
			for (local50 = 0; local50 < local43; local50++) {
				local14[local20][local50] = arg0.method4816();
			}
		...
		for (@Pc(95) int local95 = 0; local95 < local7; local95++) {
			...
			@Pc(130) int local130 = local102.method6479();
			@Pc(134) int local134 = local102.method6483();
			if (local130 > 0) {
		...
		this.aClass2_Sub3_3 = this.aClass2_Sub3Array30[arg0.method4816()];
		this.aClass2_Sub3_1 = this.aClass2_Sub3Array30[arg0.method4816()];
		this.aClass2_Sub3_2 = this.aClass2_Sub3Array30[arg0.method4816()];
	}

	@OriginalMember(owner = "client!qm", name = "a", descriptor = "(ZLclient!r;Lclient!ci;ZII)[F", line = 10)
	public float[] method4957(@OriginalArg(1) Class197 arg0, @OriginalArg(2) Interface2 arg1, @OriginalArg(3) boolean arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		Static104.aClass197_24 = arg0;
		Static239.anInterface2_6 = arg1;
		for (@Pc(11) int local11 = 0; local11 < this.aClass2_Sub3Array30.length; local11++) {
			this.aClass2_Sub3Array30[local11].method6476(arg3, arg4);
		}
		Static146.method2791(arg4, arg3);
		...
		for (@Pc(55) int local55 = 0; local55 < arg3; local55++) {
			...
			if (this.aClass2_Sub3_3.aBoolean487) {
				@Pc(87) int[] local87 = this.aClass2_Sub3_3.method6486(local55);
				local71 = local87;
				local75 = local87;
				local79 = local87;
			} else {
				@Pc(67) int[][] local67 = this.aClass2_Sub3_3.method6480(local55);
				local71 = local67[0];
				local75 = local67[2];
				local79 = local67[1];
			}
			...
			if (this.aClass2_Sub3_1.aBoolean487) {
				local105 = this.aClass2_Sub3_1.method6486(local55);
			} else {
				local105 = this.aClass2_Sub3_1.method6480(local55)[0];
			}
			if (arg2) {
				local53 = local55 << 2;
			}
			...
			if (this.aClass2_Sub3_2.aBoolean487) {
				local131 = this.aClass2_Sub3_2.method6486(local55);
			} else {
				local131 = this.aClass2_Sub3_2.method6480(local55)[0];
			}
		...
		for (@Pc(236) int local236 = 0; local236 < this.aClass2_Sub3Array30.length; local236++) {
			this.aClass2_Sub3Array30[local236].method6478();
		}
		return local38;
	}

	@OriginalMember(owner = "client!qm", name = "a", descriptor = "(ILclient!ci;Lclient!r;)Z", line = 127)
	public boolean method4958(@OriginalArg(1) Interface2 arg0, @OriginalArg(2) Class197 arg1) {
		@Pc(9) int local9;
		if (Class2_Sub16.anInt2418 >= 0) {
			for (local9 = 0; local9 < this.anIntArray371.length; local9++) {
				if (!arg1.method5089(this.anIntArray371[local9], Class2_Sub16.anInt2418)) {
					return false;
				}
			}
		} else {
			for (local9 = 0; local9 < this.anIntArray371.length; local9++) {
				if (!arg1.method5088(this.anIntArray371[local9])) {
					return false;
				}
			}
		}
		for (local9 = 0; local9 < this.anIntArray370.length; local9++) {
			if (!arg0.method2659(this.anIntArray370[local9])) {
				return false;
			}
		}
		return true;
	...
	@OriginalMember(owner = "client!qm", name = "a", descriptor = "(ZDIILclient!r;ZILclient!ci;)[I", line = 186)
	public int[] method4959(@OriginalArg(0) boolean arg0, @OriginalArg(1) double arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Class197 arg4, @OriginalArg(5) boolean arg5, @OriginalArg(7) Interface2 arg6) {
		Static104.aClass197_24 = arg4;
		Static239.anInterface2_6 = arg6;
		for (@Pc(19) int local19 = 0; local19 < this.aClass2_Sub3Array30.length; local19++) {
			this.aClass2_Sub3Array30[local19].method6476(arg3, arg2);
		}
		Static5.method86(arg1);
		Static146.method2791(arg2, arg3);
		...
		for (@Pc(69) int local69 = 0; local69 < arg3; local69++) {
			...
			@Pc(91) int[] local91;
			if (this.aClass2_Sub3_3.aBoolean487) {
				@Pc(85) int[] local85 = this.aClass2_Sub3_3.method6486(local69);
				local87 = local85;
				local89 = local85;
				local91 = local85;
			} else {
				@Pc(99) int[][] local99 = this.aClass2_Sub3_3.method6480(local69);
				local87 = local99[0];
				local89 = local99[1];
				local91 = local99[2];
			}
			for (@Pc(113) int local113 = local51; local113 != local53; local113 += local55) {
				...
				local139 = Class2_Sub2_Sub7.anIntArray145[local139];
				local121 = Class2_Sub2_Sub7.anIntArray145[local121];
				if (local156 < 0) {
					local156 = 0;
				}
				local156 = Class2_Sub2_Sub7.anIntArray145[local156];
		...
		for (@Pc(229) int local229 = 0; local229 < this.aClass2_Sub3Array30.length; local229++) {
			this.aClass2_Sub3Array30[local229].method6478();
		}
		return local47;
	}

	@OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lclient!ci;Lclient!r;DIZII)[I", line = 448)
	public int[] method4961(@OriginalArg(0) Interface2 arg0, @OriginalArg(1) Class197 arg1, @OriginalArg(2) double arg2, @OriginalArg(4) boolean arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		Static104.aClass197_24 = arg1;
		Static239.anInterface2_6 = arg0;
		for (@Pc(11) int local11 = 0; local11 < this.aClass2_Sub3Array30.length; local11++) {
			this.aClass2_Sub3Array30[local11].method6476(arg5, arg4);
		}
		Static5.method86(arg2);
		Static146.method2791(arg4, arg5);
		...
		for (@Pc(54) int local54 = 0; local54 < arg5; local54++) {
			...
			@Pc(66) int[] local66;
			if (this.aClass2_Sub3_3.aBoolean487) {
				local66 = this.aClass2_Sub3_3.method6486(local54);
				local68 = local66;
				local70 = local66;
				local72 = local66;
			} else {
				@Pc(80) int[][] local80 = this.aClass2_Sub3_3.method6480(local54);
				local68 = local80[0];
				local70 = local80[1];
				local72 = local80[2];
			}
			if (this.aClass2_Sub3_1.aBoolean487) {
				local66 = this.aClass2_Sub3_1.method6486(local54);
			} else {
				local66 = this.aClass2_Sub3_1.method6480(local54)[0];
			}
			if (arg3) {
				local47 = local54;
			}
			for (@Pc(120) int local120 = arg4 - 1; local120 >= 0; local120--) {
				...
				local128 = Class2_Sub2_Sub7.anIntArray145[local128];
				if (local158 < 0) {
					local158 = 0;
				}
				local143 = Class2_Sub2_Sub7.anIntArray145[local143];
				local158 = Class2_Sub2_Sub7.anIntArray145[local158];
				@Pc(205) int local205;
		...
		for (@Pc(261) int local261 = 0; local261 < this.aClass2_Sub3Array30.length; local261++) {
			this.aClass2_Sub3Array30[local261].method6478();
		}
		return local45;
	}
}
