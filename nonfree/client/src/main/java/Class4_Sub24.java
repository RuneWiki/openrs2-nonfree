...
public final class Class4_Sub24 extends Class4 {
	...
	public Class4_Sub24(@OriginalArg(0) byte[] arg0) {
		this.method4067(arg0);
	}

	@OriginalMember(owner = "client!jda", name = "a", descriptor = "([I)Lclient!fc;")
	public Class4_Sub16_Sub1 method4063(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray52 == null) {
			this.anInt4775 = 0;
			this.aFloatArray28 = new float[Static239.anInt4769];
			this.aByteArray52 = new byte[this.anInt4767];
			this.anInt4777 = 0;
			this.anInt4776 = 0;
		}
		while (this.anInt4776 < this.aByteArrayArray21.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method4071(this.anInt4776);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt4777;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt4767 - local47) {
					local50 = this.anInt4767 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray52[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt4777;
				}
				this.anInt4777 = local47;
			}
			this.anInt4776++;
		}
		...
		return new Class4_Sub16_Sub1(this.anInt4771, local129, this.anInt4770, this.anInt4768, this.aBoolean355);
	}

	@OriginalMember(owner = "client!jda", name = "b", descriptor = "([B)V")
	private void method4067(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class4_Sub9 local4 = new Class4_Sub9(arg0);
		this.anInt4771 = local4.method6026();
		this.anInt4767 = local4.method6026();
		this.anInt4770 = local4.method6026();
		this.anInt4768 = local4.method6026();
		if (this.anInt4768 < 0) {
			this.anInt4768 = ~this.anInt4768;
			this.aBoolean355 = true;
		}
		@Pc(40) int local40 = local4.method6026();
		this.aByteArrayArray21 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method6015();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method5966(local49, local64);
			this.aByteArrayArray21[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!jda", name = "c", descriptor = "(I)[F")
	private float[] method4071(@OriginalArg(0) int arg0) {
		Static239.method4064(this.aByteArrayArray21[arg0]);
		Static239.method4069();
		@Pc(15) int local15 = Static239.method4061(Static415.method5946(Static239.anIntArray419.length - 1));
		@Pc(19) boolean local19 = Static239.aBooleanArray20[local15];
		@Pc(25) int local25 = local19 ? Static239.anInt4769 : Static239.anInt4773;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static239.method4069() != 0;
			local29 = Static239.method4069() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static239.anInt4773 >> 2);
			local67 = (local25 >> 2) + (Static239.anInt4773 >> 2);
			local71 = Static239.anInt4773 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static239.anInt4773 >> 2);
			local104 = local25 + (Static239.anInt4773 >> 2) - (local25 >> 2);
			local108 = Static239.anInt4773 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class359 local123 = Static239.aClass359Array1[Static239.anIntArray419[local15]];
		@Pc(126) int local126 = local123.anInt9709;
		@Pc(131) int local131 = local123.anIntArray720[local126];
		@Pc(140) boolean local140 = !Static239.aClass33Array1[local131].method707();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt9710; local144++) {
			@Pc(152) Class55 local152 = Static239.aClass55Array1[local123.anIntArray719[local144]];
			local154 = Static239.aFloatArray27;
			local152.method1121(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt9709;
			local176 = local123.anIntArray720[local171];
			Static239.aClass33Array1[local176].method703(Static239.aFloatArray27, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static239.aFloatArray27[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static239.aFloatArray27;
			...
			@Pc(252) float[] local252 = local19 ? Static239.aFloatArray30 : Static239.aFloatArray29;
			@Pc(258) float[] local258 = local19 ? Static239.aFloatArray32 : Static239.aFloatArray31;
			@Pc(264) float[] local264 = local19 ? Static239.aFloatArray33 : Static239.aFloatArray34;
			@Pc(270) int[] local270 = local19 ? Static239.anIntArray421 : Static239.anIntArray420;
			...
			@Pc(486) int local486 = Static415.method5946(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static239.aFloatArray27[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static239.aFloatArray27[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt4775 > 0) {
			local176 = this.anInt4775 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean357) {
				for (local212 = 0; local212 < this.anInt4766; local212++) {
					local1254 = (this.anInt4775 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static239.aFloatArray27[local212];
				}
			}
		}
		local154 = this.aFloatArray28;
		this.aFloatArray28 = Static239.aFloatArray27;
		Static239.aFloatArray27 = local154;
		this.anInt4775 = local25;
		this.anInt4766 = local104 - (local25 >> 1);
		this.aBoolean357 = local140;
		return local1228;
	}
}
