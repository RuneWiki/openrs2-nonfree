...
public final class Class4_Sub24 extends Class4 {
	...
	public Class4_Sub24(@OriginalArg(0) byte[] arg0) {
		this.method3668(arg0);
	}

	@OriginalMember(owner = "client!qn", name = "b", descriptor = "(I)[F")
	private float[] method3664(@OriginalArg(0) int arg0) {
		Static231.method3666(this.aByteArrayArray37[arg0]);
		Static231.method3669();
		@Pc(15) int local15 = Static231.method3674(Static170.method2713(Static231.anIntArray468.length - 1));
		@Pc(19) boolean local19 = Static231.aBooleanArray23[local15];
		@Pc(25) int local25 = local19 ? Static231.anInt4416 : Static231.anInt4414;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static231.method3669() != 0;
			local29 = Static231.method3669() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static231.anInt4414 >> 2);
			local67 = (local25 >> 2) + (Static231.anInt4414 >> 2);
			local71 = Static231.anInt4414 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static231.anInt4414 >> 2);
			local104 = local25 + (Static231.anInt4414 >> 2) - (local25 >> 2);
			local108 = Static231.anInt4414 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class152 local123 = Static231.aClass152Array1[Static231.anIntArray468[local15]];
		@Pc(126) int local126 = local123.anInt4455;
		@Pc(131) int local131 = local123.anIntArray476[local126];
		@Pc(140) boolean local140 = !Static231.aClass18Array1[local131].method269();
		for (@Pc(144) int local144 = 0; local144 < local123.anInt4456; local144++) {
			@Pc(155) Class158 local155 = Static231.aClass158Array1[local123.anIntArray477[local144]];
			@Pc(157) float[] local157 = Static231.aFloatArray50;
			local155.method3992(local157, local25 >> 1, local140);
		}
		@Pc(176) int local176;
		if (!local140) {
			local131 = local123.anInt4455;
			local176 = local123.anIntArray476[local131];
			Static231.aClass18Array1[local176].method266(Static231.aFloatArray50, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local131 = local25 >> 1; local131 < local25; local131++) {
				Static231.aFloatArray50[local131] = 0.0F;
			}
		} else {
			local131 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static231.aFloatArray50;
			@Pc(216) int local216;
			...
			@Pc(252) float[] local252 = local19 ? Static231.aFloatArray48 : Static231.aFloatArray46;
			@Pc(258) float[] local258 = local19 ? Static231.aFloatArray51 : Static231.aFloatArray49;
			@Pc(264) float[] local264 = local19 ? Static231.aFloatArray45 : Static231.aFloatArray47;
			@Pc(270) int[] local270 = local19 ? Static231.anIntArray470 : Static231.anIntArray469;
			@Pc(272) int local272;
			...
			local272 = Static170.method2713(local25 - 1);
			@Pc(488) int local488;
			@Pc(499) int local499;
			@Pc(503) int local503;
			@Pc(505) int local505;
			...
			for (local488 = local59; local488 < local67; local488++) {
				...
				Static231.aFloatArray50[local488] *= (float) Math.sin((double) local309 * 1.5707963267948966D * (double) local309);
			}
		...
		if (this.anInt4423 > 0) {
			local176 = this.anInt4423 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1257) int local1257;
			if (!this.aBoolean308) {
				for (local212 = 0; local212 < this.anInt4417; local212++) {
					local1257 = (this.anInt4423 >> 1) + local212;
					local1228[local212] += this.aFloatArray52[local1257];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1257 = local1228.length + local212 - (local25 >> 1);
					local1228[local1257] += Static231.aFloatArray50[local212];
				}
			}
		}
		@Pc(1301) float[] local1301 = this.aFloatArray52;
		this.aFloatArray52 = Static231.aFloatArray50;
		Static231.aFloatArray50 = local1301;
		this.anInt4423 = local25;
		this.anInt4417 = local104 - (local25 >> 1);
		this.aBoolean308 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!qn", name = "b", descriptor = "([B)V")
	private void method3668(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class4_Sub10 local4 = new Class4_Sub10(arg0);
		this.anInt4418 = local4.method4632();
		this.anInt4415 = local4.method4632();
		this.anInt4420 = local4.method4632();
		this.anInt4421 = local4.method4632();
		if (this.anInt4421 < 0) {
			this.anInt4421 = ~this.anInt4421;
			this.aBoolean310 = true;
		}
		@Pc(40) int local40 = local4.method4632();
		this.aByteArrayArray37 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(51) int local51 = 0;
			@Pc(55) int local55;
			do {
				local55 = local4.method4666();
				local51 += local55;
			} while (local55 >= 255);
			@Pc(67) byte[] local67 = new byte[local51];
			local4.method4649(local51, local67);
			this.aByteArrayArray37[local46] = local67;
		}
	}

	@OriginalMember(owner = "client!qn", name = "a", descriptor = "([I)Lclient!pb;")
	public Class4_Sub8_Sub1 method3672(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray60 == null) {
			this.anInt4423 = 0;
			this.aFloatArray52 = new float[Static231.anInt4416];
			this.aByteArray60 = new byte[this.anInt4415];
			this.anInt4425 = 0;
			this.anInt4424 = 0;
		}
		while (this.anInt4424 < this.aByteArrayArray37.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(47) float[] local47 = this.method3664(this.anInt4424);
			if (local47 != null) {
				@Pc(52) int local52 = this.anInt4425;
				@Pc(55) int local55 = local47.length;
				if (local55 > this.anInt4415 - local52) {
					local55 = this.anInt4415 - local52;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local52 - this.anInt4425;
				}
				this.anInt4425 = local52;
			}
			this.anInt4424++;
		}
		...
		return new Class4_Sub8_Sub1(this.anInt4418, local129, this.anInt4420, this.anInt4421, this.aBoolean310);
	}
}
