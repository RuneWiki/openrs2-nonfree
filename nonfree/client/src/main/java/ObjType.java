...
public final class ObjType extends DoublyLinkable {
	...
	public Model method982(@OriginalArg(1) boolean arg0) {
		...
		@Pc(41) Model local41 = Static86.method1524(Static29.aClass20_15, local13);
		if (local16 != -1) {
			@Pc(49) Model local49 = Static86.method1524(Static29.aClass20_15, local16);
			if (local19 == -1) {
				@Pc(91) Model[] local91 = new Model[] { local41, local49 };
				local41 = new Model(local91, 2);
			} else {
				@Pc(57) Model local57 = Static86.method1524(Static29.aClass20_15, local19);
				@Pc(72) Model[] local72 = new Model[] { local41, local49, local57 };
				local41 = new Model(local72, 3);
			}
		}
	...
	public SoftwareModel method983(@OriginalArg(0) int arg0) {
		...
		@Pc(58) SoftwareModel local58 = (SoftwareModel) Static42.aClass33_13.method998((long) this.anInt1456);
		if (local58 != null) {
			return local58;
		}
		@Pc(68) Model local68 = Static86.method1524(Static29.aClass20_15, this.anInt1463);
		if (local68 == null) {
			return null;
		}
	...
	public Model method986(@OriginalArg(1) boolean arg0) {
		...
		@Pc(29) Model local29 = Static86.method1524(Static29.aClass20_15, local8);
		if (local11 != -1) {
			@Pc(37) Model local37 = Static86.method1524(Static29.aClass20_15, local11);
			@Pc(48) Model[] local48 = new Model[] { local29, local37 };
			local29 = new Model(local48, 2);
		}
		@Pc(59) int local59;
		if (this.aShortArray11 != null) {
	...
	public void method988(@OriginalArg(0) Packet arg0) {
		while (true) {
	...
	private void method990(@OriginalArg(1) Packet arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 1) {
	...
	public Model method995(@OriginalArg(0) int arg0) {
		@Pc(23) int local23;
		if (this.anIntArray145 != null && arg0 > 1) {
			@Pc(21) int local21 = -1;
		...
		@Pc(65) Model local65 = Static86.method1524(Static29.aClass20_15, this.anInt1463);
		if (local65 == null) {
			return null;
		}
		if (this.anInt1434 != 128 || this.anInt1459 != 128 || this.anInt1432 != 128) {
