...
public final class Class1_Sub16 extends Class1 {
	...
	@OriginalMember(owner = "client!me", name = "a", descriptor = "([I)Lclient!u;")
	public Class1_Sub14_Sub1 method1386(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray19 == null) {
			this.anInt1999 = 0;
			this.aFloatArray7 = new float[Static69.anInt1998];
			this.aByteArray19 = new byte[this.anInt1994];
			this.anInt2004 = 0;
			this.anInt2003 = 0;
		}
		while (this.anInt2003 < this.aByteArrayArray5.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1396(this.anInt2003);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2004;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt1994 - local47) {
					local50 = this.anInt1994 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2004;
				}
				this.anInt2004 = local47;
			}
			this.anInt2003++;
		}
		...
		return new Class1_Sub14_Sub1(this.anInt2000, local129, this.anInt2002, this.anInt1993, this.aBoolean79);
	}

	@OriginalMember(owner = "client!me", name = "b", descriptor = "([B)V")
	private void method1390(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub12 local4 = new Class1_Sub12(arg0);
		this.anInt2000 = local4.method1210();
		this.anInt1994 = local4.method1210();
		this.anInt2002 = local4.method1210();
		this.anInt1993 = local4.method1210();
		if (this.anInt1993 < 0) {
			this.anInt1993 = ~this.anInt1993;
			this.aBoolean79 = true;
		}
		@Pc(40) int local40 = local4.method1210();
		this.aByteArrayArray5 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method1190();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method1186(local49, local64);
			this.aByteArrayArray5[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!me", name = "d", descriptor = "(I)[F")
	private float[] method1396(@OriginalArg(0) int arg0) {
		Static69.method1388(this.aByteArrayArray5[arg0]);
		Static69.method1389();
		@Pc(15) int local15 = Static69.method1392(Static16.method414(Static69.anIntArray316.length - 1));
		@Pc(19) boolean local19 = Static69.aBooleanArray13[local15];
		@Pc(25) int local25 = local19 ? Static69.anInt1998 : Static69.anInt2001;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static69.method1389() != 0;
			local29 = Static69.method1389() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static69.anInt2001 >> 2);
			local67 = (local25 >> 2) + (Static69.anInt2001 >> 2);
			local71 = Static69.anInt2001 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static69.anInt2001 >> 2);
			local104 = local25 + (Static69.anInt2001 >> 2) - (local25 >> 2);
			local108 = Static69.anInt2001 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class18 local123 = Static69.aClass18Array1[Static69.anIntArray316[local15]];
		@Pc(126) int local126 = local123.anInt690;
		@Pc(131) int local131 = local123.anIntArray99[local126];
		@Pc(140) boolean local140 = !Static69.aClass47Array1[local131].method1402();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt689; local144++) {
			@Pc(152) Class28 local152 = Static69.aClass28Array1[local123.anIntArray100[local144]];
			local154 = Static69.aFloatArray6;
			local152.method674(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt690;
			local176 = local123.anIntArray99[local171];
			Static69.aClass47Array1[local176].method1408(Static69.aFloatArray6, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static69.aFloatArray6[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static69.aFloatArray6;
			...
			@Pc(252) float[] local252 = local19 ? Static69.aFloatArray2 : Static69.aFloatArray3;
			@Pc(258) float[] local258 = local19 ? Static69.aFloatArray5 : Static69.aFloatArray8;
			@Pc(264) float[] local264 = local19 ? Static69.aFloatArray4 : Static69.aFloatArray1;
			@Pc(270) int[] local270 = local19 ? Static69.anIntArray318 : Static69.anIntArray317;
			...
			@Pc(486) int local486 = Static16.method414(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static69.aFloatArray6[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static69.aFloatArray6[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt1999 > 0) {
			local176 = this.anInt1999 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean78) {
				for (local212 = 0; local212 < this.anInt1995; local212++) {
					local1254 = (this.anInt1999 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static69.aFloatArray6[local212];
				}
			}
		}
		local154 = this.aFloatArray7;
		this.aFloatArray7 = Static69.aFloatArray6;
		Static69.aFloatArray6 = local154;
		this.anInt1999 = local25;
		this.anInt1995 = local104 - (local25 >> 1);
		this.aBoolean78 = local140;
		return local1228;
	}
}
