...
public final class Class1_Sub16 extends Class1 {
	...
	public Class1_Sub16(@OriginalArg(0) byte[] arg0) {
		this.method1812(arg0);
	}

	@OriginalMember(owner = "client!gh", name = "a", descriptor = "([I)Lclient!nq;")
	public Class1_Sub28_Sub1 method1808(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray21 == null) {
			this.anInt2292 = 0;
			this.aFloatArray13 = new float[Static134.anInt2291];
			this.aByteArray21 = new byte[this.anInt2286];
			this.anInt2297 = 0;
			this.anInt2296 = 0;
		}
		while (this.anInt2296 < this.aByteArrayArray17.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1813(this.anInt2296);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2297;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt2286 - local47) {
					local50 = this.anInt2286 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray21[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2297;
				}
				this.anInt2297 = local47;
			}
			this.anInt2296++;
		}
		this.aFloatArray13 = null;
		@Pc(129) byte[] local129 = this.aByteArray21;
		this.aByteArray21 = null;
		return new Class1_Sub28_Sub1(this.anInt2288, local129, this.anInt2294, this.anInt2295, this.aBoolean168);
	}

	@OriginalMember(owner = "client!gh", name = "b", descriptor = "([B)V")
	private void method1812(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub11 local4 = new Class1_Sub11(arg0);
		this.anInt2288 = local4.method4487();
		this.anInt2286 = local4.method4487();
		this.anInt2294 = local4.method4487();
		this.anInt2295 = local4.method4487();
		if (this.anInt2295 < 0) {
			this.anInt2295 = ~this.anInt2295;
			this.aBoolean168 = true;
		}
		@Pc(40) int local40 = local4.method4487();
		this.aByteArrayArray17 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method4463();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method4471(local64, local49);
			this.aByteArrayArray17[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!gh", name = "f", descriptor = "(I)[F")
	private float[] method1813(@OriginalArg(0) int arg0) {
		Static134.method1805(this.aByteArrayArray17[arg0]);
		Static134.method1809();
		@Pc(15) int local15 = Static134.method1810(Static66.method998(Static134.anIntArray109.length - 1));
		@Pc(19) boolean local19 = Static134.aBooleanArray13[local15];
		@Pc(25) int local25 = local19 ? Static134.anInt2291 : Static134.anInt2290;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static134.method1809() != 0;
			local29 = Static134.method1809() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static134.anInt2290 >> 2);
			local67 = (local25 >> 2) + (Static134.anInt2290 >> 2);
			local71 = Static134.anInt2290 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static134.anInt2290 >> 2);
			local104 = local25 + (Static134.anInt2290 >> 2) - (local25 >> 2);
			local108 = Static134.anInt2290 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class110 local123 = Static134.aClass110Array1[Static134.anIntArray109[local15]];
		@Pc(126) int local126 = local123.anInt2693;
		@Pc(131) int local131 = local123.anIntArray139[local126];
		@Pc(140) boolean local140 = !Static134.aClass265Array1[local131].method5597();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt2692; local144++) {
			@Pc(152) Class90 local152 = Static134.aClass90Array1[local123.anIntArray138[local144]];
			local154 = Static134.aFloatArray9;
			local152.method1781(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt2693;
			local176 = local123.anIntArray139[local171];
			Static134.aClass265Array1[local176].method5593(Static134.aFloatArray9, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static134.aFloatArray9[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static134.aFloatArray9;
			...
			@Pc(252) float[] local252 = local19 ? Static134.aFloatArray10 : Static134.aFloatArray14;
			@Pc(258) float[] local258 = local19 ? Static134.aFloatArray8 : Static134.aFloatArray11;
			@Pc(264) float[] local264 = local19 ? Static134.aFloatArray7 : Static134.aFloatArray12;
			@Pc(270) int[] local270 = local19 ? Static134.anIntArray110 : Static134.anIntArray111;
			...
			@Pc(486) int local486 = Static66.method998(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static134.aFloatArray9[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static134.aFloatArray9[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt2292 > 0) {
			local176 = this.anInt2292 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean167) {
				for (local212 = 0; local212 < this.anInt2289; local212++) {
					local1254 = (this.anInt2292 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static134.aFloatArray9[local212];
				}
			}
		}
		local154 = this.aFloatArray13;
		this.aFloatArray13 = Static134.aFloatArray9;
		Static134.aFloatArray9 = local154;
		this.anInt2292 = local25;
		this.anInt2289 = local104 - (local25 >> 1);
		this.aBoolean167 = local140;
		return local1228;
	}
}
