...
public final class Class7_Sub5 extends Class7 {
	...
	@OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Lclient!qea;)V")
	public Class7_Sub5(@OriginalArg(0) Class3_Sub41 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(ILclient!qea;)V")
	public Class7_Sub5(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub41 arg1) {
		super(arg0, arg1);
	}
