...
public final class Class2_Sub21 extends Class2 {
	...
	public Class2_Sub21(@OriginalArg(0) byte[] arg0) {
		this.method2565(arg0);
	}

	@OriginalMember(owner = "client!sc", name = "a", descriptor = "([I)Lclient!qc;")
	public Class2_Sub20_Sub1 method2563(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray40 == null) {
			this.anInt3724 = 0;
			this.aFloatArray6 = new float[Static177.anInt3728];
			this.aByteArray40 = new byte[this.anInt3731];
			this.anInt3733 = 0;
			this.anInt3734 = 0;
		}
		while (this.anInt3734 < this.aByteArrayArray9.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method2564(this.anInt3734);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt3733;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt3731 - local47) {
					local50 = this.anInt3731 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt3733;
				}
				this.anInt3733 = local47;
			}
			this.anInt3734++;
		}
		...
		return new Class2_Sub20_Sub1(this.anInt3726, local129, this.anInt3732, this.anInt3727, this.aBoolean161);
	}

	@OriginalMember(owner = "client!sc", name = "e", descriptor = "(I)[F")
	private float[] method2564(@OriginalArg(0) int arg0) {
		Static177.method2559(this.aByteArrayArray9[arg0]);
		Static177.method2569();
		@Pc(15) int local15 = Static177.method2560(Static122.method1924(Static177.anIntArray325.length - 1));
		@Pc(19) boolean local19 = Static177.aBooleanArray20[local15];
		@Pc(25) int local25 = local19 ? Static177.anInt3728 : Static177.anInt3730;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static177.method2569() != 0;
			local29 = Static177.method2569() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static177.anInt3730 >> 2);
			local67 = (local25 >> 2) + (Static177.anInt3730 >> 2);
			local71 = Static177.anInt3730 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static177.anInt3730 >> 2);
			local104 = local25 + (Static177.anInt3730 >> 2) - (local25 >> 2);
			local108 = Static177.anInt3730 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class65 local123 = Static177.aClass65Array1[Static177.anIntArray325[local15]];
		@Pc(126) int local126 = local123.anInt2817;
		@Pc(131) int local131 = local123.anIntArray250[local126];
		@Pc(140) boolean local140 = !Static177.aClass103Array1[local131].method2937();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt2816; local144++) {
			@Pc(152) Class81 local152 = Static177.aClass81Array1[local123.anIntArray249[local144]];
			local154 = Static177.aFloatArray7;
			local152.method2361(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt2817;
			local176 = local123.anIntArray250[local171];
			Static177.aClass103Array1[local176].method2936(Static177.aFloatArray7, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static177.aFloatArray7[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static177.aFloatArray7;
			...
			@Pc(252) float[] local252 = local19 ? Static177.aFloatArray3 : Static177.aFloatArray5;
			@Pc(258) float[] local258 = local19 ? Static177.aFloatArray2 : Static177.aFloatArray4;
			@Pc(264) float[] local264 = local19 ? Static177.aFloatArray8 : Static177.aFloatArray1;
			@Pc(270) int[] local270 = local19 ? Static177.anIntArray326 : Static177.anIntArray324;
			...
			@Pc(486) int local486 = Static122.method1924(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static177.aFloatArray7[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static177.aFloatArray7[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt3724 > 0) {
			local176 = this.anInt3724 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean162) {
				for (local212 = 0; local212 < this.anInt3729; local212++) {
					local1254 = (this.anInt3724 >> 1) + local212;
					local1228[local212] += this.aFloatArray6[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static177.aFloatArray7[local212];
				}
			}
		}
		local154 = this.aFloatArray6;
		this.aFloatArray6 = Static177.aFloatArray7;
		Static177.aFloatArray7 = local154;
		this.anInt3724 = local25;
		this.anInt3729 = local104 - (local25 >> 1);
		this.aBoolean162 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!sc", name = "a", descriptor = "([B)V")
	private void method2565(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub11 local4 = new Class2_Sub11(arg0);
		this.anInt3726 = local4.method1577();
		this.anInt3731 = local4.method1577();
		this.anInt3732 = local4.method1577();
		this.anInt3727 = local4.method1577();
		if (this.anInt3727 < 0) {
			this.anInt3727 = ~this.anInt3727;
			this.aBoolean161 = true;
		}
		@Pc(40) int local40 = local4.method1577();
		this.aByteArrayArray9 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method1534();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method1541(local64, local49);
