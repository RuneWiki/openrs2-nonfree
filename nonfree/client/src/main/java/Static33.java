...
public final class Static33 {
	...
	public static SpotAnimType method549(@OriginalArg(0) int arg0) {
		@Pc(6) SpotAnimType local6 = (SpotAnimType) Static78.aClass33_26.method998((long) arg0);
		if (local6 != null) {
			return local6;
		}
		@Pc(28) byte[] local28 = Static35.aClass20_19.method597(13, arg0);
		local6 = new SpotAnimType();
		local6.anInt2761 = arg0;
		if (local28 != null) {
			local6.method1786(new Packet(local28));
		}
