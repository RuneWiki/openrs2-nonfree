...
public final class Class56 {
	...
	@OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lclient!bf;Lclient!ci;)V", line = 64)
	...
	public void method1789() {
		this.aClass98_8.method2616();
	}

	@OriginalMember(owner = "client!ea", name = "a", descriptor = "(IB)Lclient!al;", line = 16)
	public Class8_Sub1 method1790(@OriginalArg(0) int arg0) {
		@Pc(6) Object local6 = this.aClass98_8.method2614((long) arg0);
		if (local6 != null) {
			return (Class8_Sub1) local6;
		} else if (this.anInterface2_3.method2659(arg0)) {
			@Pc(28) Class229 local28 = this.anInterface2_3.method2660(arg0);
			@Pc(35) int local35 = local28.aBoolean441 ? 64 : 128;
			@Pc(73) Class8_Sub1 local73;
			if (local28.aBoolean437 && this.aClass19_Sub1_9.method2894()) {
				@Pc(52) float[] local52 = this.anInterface2_3.method2662(arg0, local35, 0.7F, local35);
				local73 = new Class8_Sub1(this.aClass19_Sub1_9, 3553, 34842, local35, local35, local28.aByte66 != 0, local52, 6408);
			} else {
				@Pc(84) int[] local84 = this.anInterface2_3.method2658(0.7F, local35, local35, arg0);
				local73 = new Class8_Sub1(this.aClass19_Sub1_9, 3553, 6408, local35, local35, local28.aByte66 != 0, local84, false);
			}
			local73.method3639(local28.aBoolean436, local28.aBoolean439);
			this.aClass98_8.method2626((long) arg0, local73);
			return local73;
		} else {
			return null;
		}
