...
public final class Class6_Sub16 extends Class6 {
	...
	private byte[][] aByteArrayArray45;
	...
	private void method2553(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class6_Sub15 local4 = new Class6_Sub15(arg0);
		this.anInt2609 = local4.method3015();
		this.anInt2615 = local4.method3015();
		this.anInt2611 = local4.method3015();
		this.anInt2613 = local4.method3015();
		if (this.anInt2613 < 0) {
			this.anInt2613 = ~this.anInt2613;
			this.aBoolean204 = true;
		}
		@Pc(40) int local40 = local4.method3015();
		this.aByteArrayArray45 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method3030();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method3019(local49, 0, local64);
			this.aByteArrayArray45[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!eia", name = "a", descriptor = "([I)Lclient!vfa;")
	public Class6_Sub54_Sub1 method2555(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray17 == null) {
			this.anInt2608 = 0;
			this.aFloatArray31 = new float[Static132.anInt2614];
			this.aByteArray17 = new byte[this.anInt2615];
			this.anInt2618 = 0;
			this.anInt2619 = 0;
		}
		while (this.anInt2619 < this.aByteArrayArray45.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method2559(this.anInt2619);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2618;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt2615 - local47) {
					local50 = this.anInt2615 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2618;
				}
				this.anInt2618 = local47;
			}
			this.anInt2619++;
		}
		this.aFloatArray31 = null;
		@Pc(129) byte[] local129 = this.aByteArray17;
		this.aByteArray17 = null;
		return new Class6_Sub54_Sub1(this.anInt2609, local129, this.anInt2611, this.anInt2613, this.aBoolean204);
	}

	@OriginalMember(owner = "client!eia", name = "b", descriptor = "(I)[F")
	private float[] method2559(@OriginalArg(0) int arg0) {
		Static132.method2551(this.aByteArrayArray45[arg0]);
		Static132.method2552();
		@Pc(15) int local15 = Static132.method2558(Static23.method257(Static132.anIntArray134.length - 1));
		@Pc(19) boolean local19 = Static132.aBooleanArray8[local15];
		@Pc(25) int local25 = local19 ? Static132.anInt2614 : Static132.anInt2612;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static132.method2552() != 0;
			local29 = Static132.method2552() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static132.anInt2612 >> 2);
			local67 = (local25 >> 2) + (Static132.anInt2612 >> 2);
			local71 = Static132.anInt2612 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static132.anInt2612 >> 2);
			local104 = local25 + (Static132.anInt2612 >> 2) - (local25 >> 2);
			local108 = Static132.anInt2612 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class254 local123 = Static132.aClass254Array1[Static132.anIntArray134[local15]];
		@Pc(126) int local126 = local123.anInt6906;
		@Pc(131) int local131 = local123.anIntArray431[local126];
		@Pc(140) boolean local140 = !Static132.aClass206Array1[local131].method4871();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt6905; local144++) {
			@Pc(152) Class248 local152 = Static132.aClass248Array1[local123.anIntArray430[local144]];
			local154 = Static132.aFloatArray33;
			local152.method6036(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt6906;
			local176 = local123.anIntArray431[local171];
			Static132.aClass206Array1[local176].method4868(Static132.aFloatArray33, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static132.aFloatArray33[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static132.aFloatArray33;
			...
			@Pc(252) float[] local252 = local19 ? Static132.aFloatArray29 : Static132.aFloatArray34;
			@Pc(258) float[] local258 = local19 ? Static132.aFloatArray30 : Static132.aFloatArray36;
			@Pc(264) float[] local264 = local19 ? Static132.aFloatArray32 : Static132.aFloatArray35;
			@Pc(270) int[] local270 = local19 ? Static132.anIntArray136 : Static132.anIntArray135;
			...
			@Pc(486) int local486 = Static23.method257(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static132.aFloatArray33[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static132.aFloatArray33[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt2608 > 0) {
			local176 = this.anInt2608 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean203) {
				for (local212 = 0; local212 < this.anInt2617; local212++) {
					local1254 = (this.anInt2608 >> 1) + local212;
					local1228[local212] += this.aFloatArray31[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static132.aFloatArray33[local212];
				}
			}
		}
		local154 = this.aFloatArray31;
		this.aFloatArray31 = Static132.aFloatArray33;
		Static132.aFloatArray33 = local154;
		this.anInt2608 = local25;
		this.anInt2617 = local104 - (local25 >> 1);
		this.aBoolean203 = local140;
		return local1228;
	}
}
