...
public class Class606 {
	...
	static void method31906(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class312 arg3) {
		...
		for (@Pc(5) int local5 = 63; local5 >= 0; local5--) {
			...
			Class660.method32825(false, true, 1662920483);
			@Pc(31) int local31 = Class685.anIntArray522[local23];
			Class46.method896(false, true, 1173794949);
			arg0.method20653(arg1, ((63 - local5) * -1490598249 * arg3.anInt3982 >> 6) + arg2, arg3.anInt3981 * 1215292027, (arg3.anInt3982 * -1490598249 >> 6) + 1, local31 | 0xFF000000, 0);
		}
	}
	...
	static void method31907(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class312 arg3) {
		...
		for (@Pc(5) int local5 = 63; local5 >= 0; local5--) {
			@Pc(23) int local23 = (local5 & 0x3F) << 10 | (local3 & 0x7) << 7 | local1 & 0x7F;
			Class660.method32825(false, true, 1013938962);
			@Pc(31) int local31 = Class685.anIntArray522[local23];
	...
	static void method31908(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class312 arg3) {
		...
		for (@Pc(5) int local5 = 63; local5 >= 0; local5--) {
			@Pc(23) int local23 = (local5 & 0x3F) << 10 | (local3 & 0x7) << 7 | local1 & 0x7F;
			Class660.method32825(false, true, 1608842228);
			@Pc(31) int local31 = Class685.anIntArray522[local23];
	...
	static void method31909(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class312 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte arg4) {
		...
		arg0.method20625(Class172.anIntArray269);
		arg0.method20562();
		@Pc(86) Class611 local86 = client.aClass532_1.method30443(1884925766);
		@Pc(95) int local95;
		@Pc(99) int local99;
		@Pc(105) int local105;
		@Pc(107) int local107;
		...
		if (local8 == null) {
			Class172.aClass100_40.method18183((float) arg2 + (float) (arg1.anInt3981 * 1215292027) / 2.0F, (float) (arg1.anInt3982 * -1490598249) / 2.0F + (float) arg3, (float) local163, (float) local175, local107, local105 << 2, 1, -1, 1);
		} else {
			Class172.aClass100_40.method18186((float) arg2 + (float) (arg1.anInt3981 * 1215292027) / 2.0F, (float) arg3 + (float) (arg1.anInt3982 * -1490598249) / 2.0F, (float) local163, (float) local175, local107, local105 << 2, local8, arg2, arg3);
		}
		@Pc(249) Class584 local249 = client.aClass532_1.method30587(-484613851);
		@Pc(261) int local261;
		@Pc(275) int local275;
		@Pc(287) int local287;
		@Pc(297) int local297;
		...
		for (local261 = 0; local261 < Class172.anInt3176 * 906807861; local261++) {
			...
			@Pc(367) Class610 local367 = (Class610) client.aClass532_1.method30466(1161509209).method18261(Class172.anIntArray271[local261], -1264690199);
			if (local367.anIntArray492 != null) {
				local367 = local367.method31982(Class624.aClass120_1, Class624.aClass120_1, 90754467);
		...
		Class331.method27384(local95, local99, arg1, local6, arg2, arg3, (short) 28482);
		if (Class429.anInt4781 * -1453926679 != 4) {
			if (Class172.anInt3179 * -820036969 != -1) {
				local261 = Class172.anInt3179 * 1014819420 + 2 - local95 / 128 + (Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.method19997(842279579) - 1) * 2;
				local275 = Class172.anInt3174 * -879462196 + 2 - local99 / 128 + (Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.method19997(1473374830) - 1) * 2;
			...
			if (!Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aClass659_1.method32798(-125905710)) {
				arg0.method20600(arg1.anInt3981 * 1215292027 / 2 + arg2 - 1, arg1.anInt3982 * -1490598249 / 2 + arg3 - 1, 3, 3, -1, (byte) 121);
			}
		}
		arg0.method20463(Class172.anIntArray269[0], Class172.anIntArray269[1], Class172.anIntArray269[2], Class172.anIntArray269[3]);
	}

	@OriginalMember(owner = "client!v", name = "p", descriptor = "(I)V", line = 69)
	public static void method31910(@OriginalArg(0) int arg0) {
	...
	static final void method31911(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, -257666618);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class689.method36525(local16, local22, arg0, -1633511480);
	}

	@OriginalMember(owner = "client!v", name = "gc", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;B)V", line = 6106)
	static final void method31912(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) byte arg3) {
