...
public class Class324 {
	...
	void method27280(@OriginalArg(0) Class315 arg0) {
		arg0.method27136(this.anInt4134 * 8 + this.anInt4137);
	}
	...
	void method27283(@OriginalArg(0) Class315 arg0) {
		@Pc(2) int local2 = arg0.method27073();
		@Pc(5) int local5 = arg0.method27072();
		arg0.method27136(24);
		this.anInt4136 = arg0.method27136(16);
		this.anInt4135 = arg0.method27136(24);
		if (this.anIntArray401 == null || this.anIntArray401.length != this.anInt4135) {
			this.anIntArray401 = new int[this.anInt4135];
		}
		@Pc(40) boolean local40 = arg0.method27130() != 0;
		@Pc(44) int local44;
		@Pc(50) int local50;
		@Pc(65) int local65;
		if (local40) {
			local44 = 0;
			local50 = arg0.method27136(5) + 1;
			while (local44 < this.anInt4135) {
				@Pc(63) int local63 = arg0.method27136(Class548.method31014(this.anInt4135 - local44, -1389676103));
			...
			@Pc(86) boolean local86 = arg0.method27130() != 0;
			for (local50 = 0; local50 < this.anInt4135; local50++) {
				if (local86 && arg0.method27130() == 0) {
					this.anIntArray401[local50] = 0;
				} else {
					this.anIntArray401[local50] = arg0.method27136(5) + 1;
				}
			}
		}
		this.method27282();
		local44 = arg0.method27136(4);
		if (local44 > 0) {
			@Pc(128) float local128 = arg0.method27071(arg0.method27136(32));
			@Pc(134) float local134 = arg0.method27071(arg0.method27136(32));
			local65 = arg0.method27136(4) + 1;
			@Pc(147) boolean local147 = arg0.method27130() != 0;
			@Pc(156) int local156;
			if (local44 == 1) {
				local156 = method27281(this.anInt4135, this.anInt4136);
			} else {
			...
			for (local169 = 0; local169 < local156; local169++) {
				this.anIntArray403[local169] = arg0.method27136(local65);
			}
		...
		this.anInt4137 = arg0.method27073() - local2;
		this.anInt4134 = arg0.method27072() - local5;
	}

	@OriginalMember(owner = "client!hu", name = "f", descriptor = "(Lclient!hk;)I", line = 184)
	int method27284(@OriginalArg(0) Class315 arg0) {
		@Pc(1) int local1;
		for (local1 = 0; this.anIntArray402[local1] >= 0; local1 = arg0.method27130() == 0 ? local1 + 1 : this.anIntArray402[local1]) {
		}
		return ~this.anIntArray402[local1];
	}

	@OriginalMember(owner = "client!hu", name = "w", descriptor = "(Lclient!hk;)[F", line = 190)
	float[] method27285(@OriginalArg(0) Class315 arg0) {
		return this.aFloatArrayArray25[this.method27284(arg0)];
	}

	@OriginalMember(owner = "client!hu", name = "l", descriptor = "(II)I", line = 20)
	static int method27286(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(10) int local10 = (int) Math.pow((double) arg0, 1.0D / (double) arg1) + 1;
		while (true) {
			@Pc(12) int local12 = local10;
			@Pc(14) int local14 = arg1;
	...
	void method27288(@OriginalArg(0) Class315 arg0) {
		@Pc(2) int local2 = arg0.method27073();
		@Pc(5) int local5 = arg0.method27072();
		arg0.method27136(24);
		this.anInt4136 = arg0.method27136(16);
		...
		if (local40) {
			...
			local50 = arg0.method27136(5) + 1;
			while (local44 < this.anInt4135) {
				@Pc(63) int local63 = arg0.method27136(Class548.method31014(this.anInt4135 - local44, 125125818));
				for (local65 = 0; local65 < local63; local65++) {
					this.anIntArray401[local44++] = local50;
				}
				local50++;
	...
	void method27289(@OriginalArg(0) Class315 arg0) {
		@Pc(2) int local2 = arg0.method27073();
		@Pc(5) int local5 = arg0.method27072();
		arg0.method27136(24);
		this.anInt4136 = arg0.method27136(16);
		...
		if (local40) {
			...
			local50 = arg0.method27136(5) + 1;
			while (local44 < this.anInt4135) {
				@Pc(63) int local63 = arg0.method27136(Class548.method31014(this.anInt4135 - local44, -811741050));
				for (local65 = 0; local65 < local63; local65++) {
					this.anIntArray401[local44++] = local50;
				}
				local50++;
	...
	int method27290(@OriginalArg(0) Class315 arg0) {
		@Pc(1) int local1;
		for (local1 = 0; this.anIntArray402[local1] >= 0; local1 = arg0.method27130() == 0 ? local1 + 1 : this.anIntArray402[local1]) {
		}
		return ~this.anIntArray402[local1];
	...
	void method27293(@OriginalArg(0) Class315 arg0) {
		arg0.method27136(this.anInt4134 * 8 + this.anInt4137);
	}
