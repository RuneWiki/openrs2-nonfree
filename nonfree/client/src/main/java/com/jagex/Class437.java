...
public class Class437 {
	...
	static final void method28816(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anInt5891 -= 1189701933;
	}

	@OriginalMember(owner = "client!nh", name = "agz", descriptor = "(Lclient!yf;I)V", line = 10741)
	static final void method28817(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static void method28819(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		while (true) {
			@Pc(3) int local3 = arg0.method22413((short) 16384);
			switch(local3) {
				case 0:
					Class249.anInt3841 = arg0.method22415(-1434290800) * -1784392859;
					Class249.anInt3839 = arg0.method22415(-1434290800) * -1584427833;
					break;
				case 255:
					return;
			}
