...
public abstract class Class553 implements Interface60, Runnable, FocusListener, WindowListener {
	...
	final void method24841(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) throws Exception {
		...
		label131: while (local176 < 4) {
			...
			while (true) {
				...
				if (!this.method24843(local209, false, (byte) -11)) {
					local176++;
					break;
				}
				local201++;
		...
		Class294.method26597(Class564.aFile4, (byte) 21);
		Class430.method28759(1719882568);
	...
	public void destroy() {
		if (!aBoolean591) {
			aLong241 = Class305.method26796(4543014) * -992610302756464965L;
			Class212.method25439(5000L);
			this.method24896(false, 242259386);
		}
	}

	@OriginalMember(owner = "client!sk", name = "k", descriptor = "(Ljava/io/File;Ljava/io/File;I)V", line = 318)
	void method24842(@OriginalArg(0) File arg0, @OriginalArg(1) File arg1, @OriginalArg(2) int arg2) {
		try {
			@Pc(6) Class38 local6 = new Class38(aFile2, "rw", 10000L);
			@Pc(11) Class93_Sub41 local11 = new Class93_Sub41(500);
			local11.method22510(3, (byte) -88);
			local11.method22510(arg1 == null ? 0 : 1, (byte) -102);
			local11.method22404(arg0.getPath(), -1489303680);
			if (arg1 != null) {
				local11.method22404(arg1.getPath(), -1489303680);
			}
	...
	boolean method24843(@OriginalArg(0) File arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) byte arg2) {
		try {
	...
	synchronized void method24844(@OriginalArg(0) String arg0, @OriginalArg(1) byte arg1) {
	...
	synchronized void method24845(@OriginalArg(0) int arg0) {
		this.method24847(-1978270461);
		@Pc(5) Container local5 = Class504.method30196(-283088421);
		Class125_Sub3.aCanvas1 = new Canvas_Sub1(local5);
		this.method24935(local5, 1220248857);
	}
	...
	void method24847(@OriginalArg(0) int arg0) {
	...
	final boolean method24848(@OriginalArg(0) int arg0) {
		...
		if (local4.equals("jagex.com") || local4.endsWith(".jagex.com")) {
			...
			if (local4.endsWith("192.168.1.")) {
				...
				this.method24898("invalidhost", -1177588208);
				return false;
			}
		}
	}
	...
	File method24849(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		if (aFile2.exists()) {
			try {
				...
				local58.anInt3070 = 0;
				local84 = local58.method22413((short) 16384);
				if (local84 < 1 || local84 > 3) {
					throw new IOException("" + local84);
				}
				@Pc(127) int local127 = 0;
				if (local84 > 1) {
					local127 = local58.method22413((short) 16384);
				}
				if (local84 <= 2) {
					local36 = local58.method22428(1918013460);
					if (local127 == 1) {
						local38 = local58.method22428(-360628168);
					}
				} else {
					local36 = local58.method22429(-1927749946);
					if (local127 == 1) {
						local38 = local58.method22429(1319692524);
					}
				}
			...
			if (local36 != null) {
				...
				if (!this.method24843(local174, true, (byte) -57)) {
					local36 = null;
				}
			}
		}
		if (local36 == null && arg2 == 0) {
			label103: for (@Pc(203) int local203 = 0; local203 < Class133.aStringArray16.length; local203++) {
				for (@Pc(209) int local209 = 0; local209 < Class676.aStringArray34.length; local209++) {
					...
					if (local235.exists() && this.method24843(new File(local235, "test.dat"), true, (byte) -31)) {
		...
		if (local40) {
			this.method24842(new File(local36), (File) null, -1497248091);
		}
		return new File(local36);
	}

	@OriginalMember(owner = "client!sk", name = "h", descriptor = "(I)V", line = 522)
	void method24850(@OriginalArg(0) int arg0) {
		if (Class392.aString197 != null) {
			...
			if (local5.indexOf("sun") != -1 || local5.indexOf("apple") != -1) {
				...
				if (local17.equals("1.1") || local17.startsWith("1.1.") || local17.equals("1.2") || local17.startsWith("1.2.") || local17.equals("1.3") || local17.startsWith("1.3.") || local17.equals("1.4") || local17.startsWith("1.4.") || local17.equals("1.5") || local17.startsWith("1.5.") || local17.equals("1.6.0")) {
					this.method24898("wrongjava", -44089755);
					return;
				}
				if (local17.startsWith("1.6.0_")) {
					@Pc(72) int local72;
					for (local72 = 6; local72 < local17.length() && Class498.method30136(local17.charAt(local72), (byte) 1); local72++) {
					}
					...
					if (Class633.method32304(local89, 250407149) && Class616.method32090(local89, (byte) 8) < 10) {
						this.method24898("wrongjava", 660211670);
						return;
					}
				}
			}
		...
		this.method24845(-1483631858);
		this.method24859(1344353626);
		aClass147_2 = Class450.method28933(984252925);
		while (aLong241 * -8807787511991959949L == 0L || Class305.method26796(778989178) < aLong241 * -8807787511991959949L) {
			...
			for (@Pc(154) int local154 = 0; local154 < anInt3423 * 970166197; local154++) {
				this.method24851((byte) -19);
			}
			this.method24852(787203204);
			Class256.method26013(Class125_Sub3.aCanvas1, 165759862);
		}
	}

	@OriginalMember(owner = "client!sk", name = "g", descriptor = "(B)V", line = 565)
	void method24851(@OriginalArg(0) byte arg0) {
		@Pc(2) long local2 = Class305.method26796(826221803);
		...
		this.method24860(-263225392);
	}

	@OriginalMember(owner = "client!sk", name = "i", descriptor = "(I)V", line = 577)
	void method24852(@OriginalArg(0) int arg0) {
		@Pc(2) long local2 = Class305.method26796(1511073804);
	...
	void method24854(@OriginalArg(0) Container arg0) {
		...
		arg0.setLayout((LayoutManager) null);
		...
		aBoolean586 = true;
		aBoolean590 = false;
		aLong239 = Class305.method26796(1033826531) * -4981684860522027511L;
	}
	...
	public void stop() {
		if (!aBoolean591) {
			aLong241 = (Class305.method26796(1835689683) + 4000L) * -992610302756464965L;
		}
	}
	...
	public final synchronized void paint(@OriginalArg(0) Graphics arg0) {
		...
		aBoolean586 = true;
		if (Class305.method26796(322683967) - aLong239 * -8866144438303274951L > 1000L) {
	...
	void method24856(@OriginalArg(0) File arg0, @OriginalArg(1) File arg1) {
		try {
			@Pc(6) Class38 local6 = new Class38(aFile2, "rw", 10000L);
			@Pc(11) Class93_Sub41 local11 = new Class93_Sub41(500);
			local11.method22510(3, (byte) -83);
			local11.method22510(arg1 == null ? 0 : 1, (byte) -56);
			local11.method22404(arg0.getPath(), -1489303680);
			if (arg1 != null) {
				local11.method22404(arg1.getPath(), -1489303680);
			}
	...
	final void method24857(@OriginalArg(0) Class559 arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean arg7) {
		try {
			this.method24865(Class555.aClass555_4, arg7, 1101059334);
			anInt3413 = (anInt3408 = arg0.method31115(-820575818) * 1671148283) * -1040934271;
			Class504.anInt5201 = (anInt3416 = arg0.method31116(-567283080) * 490799697) * 500427957;
			anInt3414 = 0;
			anInt3415 = 0;
			if (Class343.method27518((byte) 45) == Class555.aClass555_5) {
				anInt3413 += arg0.method31117(-1175088513) * 1522031862;
				Class504.anInt5201 += arg0.method31118(-1743498683) * 1706598026;
				this.method24844(arg0.method31119((byte) -13), (byte) 114);
			}
			Class69.anApplet1 = Class32_Sub10.anApplet2;
			this.method24841(arg1, arg2, arg3, arg4, arg5, arg6, -616301363);
		} catch (@Pc(67) Throwable local67) {
			Class646.method32610((String) null, local67, 1579532191);
			this.method24898("crash", 1979386679);
		}
	}
	...
	public void method24835() {
		if (!aBoolean591) {
			aLong241 = (Class305.method26796(1220090424) + 4000L) * -992610302756464965L;
		}
	}
	...
	abstract void method24859(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!sk", name = "ac", descriptor = "(I)V")
	abstract void method24860(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!sk", name = "ai", descriptor = "(I)V")
	abstract void method24861(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!sk", name = "aw", descriptor = "(B)V")
	abstract void method24862(@OriginalArg(0) byte arg0);
	...
	public void run() {
		...
		label50: {
			try {
				var6 = true;
				this.method24850(1286359357);
				var6 = false;
				break label50;
			} catch (@Pc(8) ThreadDeath local8) {
				throw local8;
			} catch (@Pc(11) Throwable local11) {
				Class646.method32610(this.method24853((byte) 112), local11, 552130837);
				this.method24898("crash", -684708272);
				var6 = false;
			} finally {
				if (var6) {
					this.method24896(true, -266556112);
				}
			}
			this.method24896(true, -1353705725);
			return;
		}
		this.method24896(true, -2097600644);
	}
	...
	public void method24864(@OriginalArg(0) byte arg0) throws Exception_Sub1 {
		if (this.aBoolean587) {
			return;
		}
		Class376.method28046(672839876).method31617("jaclib", (byte) -43);
		try {
	...
	void method24865(@OriginalArg(0) Class555 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2) {
		if (arg0 == null) {
	...
	public void method24867() {
		...
		label50: {
			try {
				var6 = true;
				this.method24850(709894690);
				var6 = false;
				break label50;
			} catch (@Pc(8) ThreadDeath local8) {
				throw local8;
			} catch (@Pc(11) Throwable local11) {
				Class646.method32610(this.method24853((byte) 69), local11, 932771544);
				this.method24898("crash", -2040856707);
				var6 = false;
			} finally {
				if (var6) {
					this.method24896(true, -1014019599);
				}
			}
			this.method24896(true, 326649974);
			return;
		}
		this.method24896(true, -512812427);
	}
	...
	public void method24869() {
		...
		label50: {
			try {
				var6 = true;
				this.method24850(1546186898);
				var6 = false;
				break label50;
			} catch (@Pc(8) ThreadDeath local8) {
				throw local8;
			} catch (@Pc(11) Throwable local11) {
				Class646.method32610(this.method24853((byte) 92), local11, 258427659);
				this.method24898("crash", -584675640);
				var6 = false;
			} finally {
				if (var6) {
					this.method24896(true, 211633769);
				}
			}
			this.method24896(true, -275160914);
			return;
		}
		this.method24896(true, -1076171819);
	}
	...
	File method24874(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		...
		if (aFile2.exists()) {
			try {
				...
				if (local84 <= 2) {
					local36 = local58.method22428(-954973916);
					if (local127 == 1) {
						local38 = local58.method22428(-914566597);
					}
				} else {
					local36 = local58.method22429(-2049293466);
					if (local127 == 1) {
						local38 = local58.method22429(1078310015);
					}
				}
			...
			if (local36 != null) {
				local174 = new File(local36, "test.dat");
				if (!this.method24843(local174, true, (byte) -4)) {
					local36 = null;
				}
			}
		}
		if (local36 == null && arg2 == 0) {
			label103: for (@Pc(203) int local203 = 0; local203 < Class133.aStringArray16.length; local203++) {
				for (@Pc(209) int local209 = 0; local209 < Class676.aStringArray34.length; local209++) {
					@Pc(235) File local235 = new File(Class676.aStringArray34[local209] + Class133.aStringArray16[local203] + File.separatorChar + arg0 + File.separatorChar);
					if (local235.exists() && this.method24843(new File(local235, "test.dat"), true, (byte) -66)) {
						local36 = local235.toString();
						local40 = true;
						break label103;
					}
	...
	final void method24879(@OriginalArg(0) Class559 arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean arg7, @OriginalArg(8) int arg8) {
		try {
			this.method24865(Class555.aClass555_4, arg7, 1331913860);
			anInt3413 = (anInt3408 = arg0.method31115(-820575818) * 1671148283) * -1040934271;
			Class504.anInt5201 = (anInt3416 = arg0.method31116(-567283080) * 490799697) * 500427957;
			anInt3414 = 0;
			anInt3415 = 0;
			if (Class343.method27518((byte) 115) == Class555.aClass555_5) {
				anInt3413 += arg0.method31117(-1726618611) * 1522031862;
				Class504.anInt5201 += arg0.method31118(-1743498683) * 1706598026;
				this.method24844(arg0.method31119((byte) -78), (byte) 99);
			}
			Class69.anApplet1 = Class32_Sub10.anApplet2;
			this.method24841(arg1, arg2, arg3, arg4, arg5, arg6, -616301363);
		} catch (@Pc(67) Throwable local67) {
			Class646.method32610((String) null, local67, 1692810338);
			this.method24898("crash", 1399590744);
		}
	}
	...
	final void method24880(@OriginalArg(0) Class559 arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean arg7) {
		try {
			this.method24865(Class555.aClass555_4, arg7, 917811850);
			anInt3413 = (anInt3408 = arg0.method31115(-820575818) * 1671148283) * -1040934271;
			Class504.anInt5201 = (anInt3416 = arg0.method31116(-567283080) * 490799697) * 500427957;
			anInt3414 = 0;
			anInt3415 = 0;
			if (Class343.method27518((byte) 44) == Class555.aClass555_5) {
				anInt3413 += arg0.method31117(1426116554) * 1522031862;
				Class504.anInt5201 += arg0.method31118(-1743498683) * 1706598026;
				this.method24844(arg0.method31119((byte) -47), (byte) 125);
			}
			Class69.anApplet1 = Class32_Sub10.anApplet2;
			this.method24841(arg1, arg2, arg3, arg4, arg5, arg6, -616301363);
		} catch (@Pc(67) Throwable local67) {
			Class646.method32610((String) null, local67, 1089355595);
			this.method24898("crash", 2102320563);
		}
	}
	...
	final void method24881(@OriginalArg(0) Class559 arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean arg7) {
		try {
			this.method24865(Class555.aClass555_4, arg7, -868112265);
			anInt3413 = (anInt3408 = arg0.method31115(-820575818) * 1671148283) * -1040934271;
			Class504.anInt5201 = (anInt3416 = arg0.method31116(-567283080) * 490799697) * 500427957;
			anInt3414 = 0;
			anInt3415 = 0;
			if (Class343.method27518((byte) 9) == Class555.aClass555_5) {
				anInt3413 += arg0.method31117(-1311792139) * 1522031862;
				Class504.anInt5201 += arg0.method31118(-1743498683) * 1706598026;
				this.method24844(arg0.method31119((byte) -87), (byte) 105);
			}
			Class69.anApplet1 = Class32_Sub10.anApplet2;
			this.method24841(arg1, arg2, arg3, arg4, arg5, arg6, -616301363);
		} catch (@Pc(67) Throwable local67) {
			Class646.method32610((String) null, local67, 823907050);
			this.method24898("crash", -1380350714);
		}
	}
	...
	final void method24882(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) throws Exception {
		...
		label131: while (local176 < 4) {
			...
			while (true) {
				...
				@Pc(209) File local209 = local199[local201];
				if (!this.method24843(local209, false, (byte) -108)) {
					local176++;
					break;
				}
				local201++;
		...
		Class294.method26597(Class564.aFile4, (byte) 24);
		Class430.method28759(638430743);
	...
	File method24883(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		...
		if (aFile2.exists()) {
			try {
				...
				if (local84 <= 2) {
					local36 = local58.method22428(490795334);
					if (local127 == 1) {
						local38 = local58.method22428(368323162);
					}
				} else {
					local36 = local58.method22429(-139136361);
					if (local127 == 1) {
						local38 = local58.method22429(496690280);
					}
				}
			...
			if (local36 != null) {
				local174 = new File(local36, "test.dat");
				if (!this.method24843(local174, true, (byte) -114)) {
					local36 = null;
				}
			}
		}
		if (local36 == null && arg2 == 0) {
			label103: for (@Pc(203) int local203 = 0; local203 < Class133.aStringArray16.length; local203++) {
				for (@Pc(209) int local209 = 0; local209 < Class676.aStringArray34.length; local209++) {
					@Pc(235) File local235 = new File(Class676.aStringArray34[local209] + Class133.aStringArray16[local203] + File.separatorChar + arg0 + File.separatorChar);
					if (local235.exists() && this.method24843(new File(local235, "test.dat"), true, (byte) -5)) {
						local36 = local235.toString();
						local40 = true;
						break label103;
					}
	...
	void method24884(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) byte arg2) {
		if (this.aBoolean592) {
			return;
		}
		this.aBoolean592 = true;
	...
	File method24885(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		...
		if (aFile2.exists()) {
			try {
				...
				if (local84 <= 2) {
					local36 = local58.method22428(1036988259);
					if (local127 == 1) {
						local38 = local58.method22428(1821938129);
					}
				} else {
					local36 = local58.method22429(612036406);
					if (local127 == 1) {
						local38 = local58.method22429(1946811762);
					}
				}
			...
			if (local36 != null) {
				local174 = new File(local36, "test.dat");
				if (!this.method24843(local174, true, (byte) -68)) {
					local36 = null;
				}
			}
		}
		if (local36 == null && arg2 == 0) {
			label103: for (@Pc(203) int local203 = 0; local203 < Class133.aStringArray16.length; local203++) {
				for (@Pc(209) int local209 = 0; local209 < Class676.aStringArray34.length; local209++) {
					@Pc(235) File local235 = new File(Class676.aStringArray34[local209] + Class133.aStringArray16[local203] + File.separatorChar + arg0 + File.separatorChar);
					if (local235.exists() && this.method24843(new File(local235, "test.dat"), true, (byte) -44)) {
						local36 = local235.toString();
						local40 = true;
						break label103;
					}
	...
	public void method24886() {
		...
		label50: {
			try {
				var6 = true;
				this.method24850(76237799);
				var6 = false;
				break label50;
			} catch (@Pc(8) ThreadDeath local8) {
				throw local8;
			} catch (@Pc(11) Throwable local11) {
				Class646.method32610(this.method24853((byte) 65), local11, 661422765);
				this.method24898("crash", -582446019);
				var6 = false;
			} finally {
				if (var6) {
					this.method24896(true, -1331069602);
				}
			}
			this.method24896(true, -216665316);
			return;
		}
		this.method24896(true, -1507795961);
	}
	...
	void method24887(@OriginalArg(0) File arg0, @OriginalArg(1) File arg1) {
		try {
			@Pc(6) Class38 local6 = new Class38(aFile2, "rw", 10000L);
			@Pc(11) Class93_Sub41 local11 = new Class93_Sub41(500);
			local11.method22510(3, (byte) -6);
			local11.method22510(arg1 == null ? 0 : 1, (byte) -118);
			local11.method22404(arg0.getPath(), -1489303680);
			if (arg1 != null) {
				local11.method22404(arg1.getPath(), -1489303680);
			}
	...
	public final synchronized void method24838(@OriginalArg(0) Graphics arg0) {
		...
		aBoolean586 = true;
		if (Class305.method26796(648936748) - aLong239 * -8866144438303274951L > 1000L) {
			@Pc(16) Rectangle local16 = arg0.getClipBounds();
			if (local16 == null || local16.width >= anInt3413 * -108363597 && local16.height >= Class504.anInt5201 * 2090134413) {
				aBoolean590 = true;
			}
	...
	public static void method24891(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		arg0.method22405(local2, 0, 24, 2026842986);
	}
	...
	final void method24896(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		synchronized (this) {
			if (aBoolean591) {
				return;
			}
		...
		if (Class10.method166(628717055)) {
			Class376.method28046(672839876).method31624(-998187544);
		}
		if (Class125_Sub3.aCanvas1 != null) {
			try {
				Class125_Sub3.aCanvas1.removeFocusListener(this);
	...
	void method24898(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		if (this.aBoolean592) {
			return;
		}
		this.aBoolean592 = true;
	...
	void method24899(@OriginalArg(0) Container arg0) {
		...
		aBoolean586 = true;
		aBoolean590 = false;
		aLong239 = Class305.method26796(1219722229) * -4981684860522027511L;
	}
	...
	File method24903(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		...
		if (aFile2.exists()) {
			try {
				...
				if (local84 <= 2) {
					local36 = local58.method22428(1569283594);
					if (local127 == 1) {
						local38 = local58.method22428(-213334342);
					}
				} else {
					local36 = local58.method22429(757385102);
					if (local127 == 1) {
						local38 = local58.method22429(321840681);
					}
				}
			...
			if (local36 != null) {
				local174 = new File(local36, "test.dat");
				if (!this.method24843(local174, true, (byte) -98)) {
					local36 = null;
				}
			}
		}
		if (local36 == null && arg2 == 0) {
			label103: for (@Pc(203) int local203 = 0; local203 < Class133.aStringArray16.length; local203++) {
				for (@Pc(209) int local209 = 0; local209 < Class676.aStringArray34.length; local209++) {
					@Pc(235) File local235 = new File(Class676.aStringArray34[local209] + Class133.aStringArray16[local203] + File.separatorChar + arg0 + File.separatorChar);
					if (local235.exists() && this.method24843(new File(local235, "test.dat"), true, (byte) -118)) {
						local36 = local235.toString();
						local40 = true;
						break label103;
					}
	...
	void method24904() {
		if (Class392.aString197 != null) {
			...
			if (local5.indexOf("sun") != -1 || local5.indexOf("apple") != -1) {
				@Pc(17) String local17 = Class95.aString12;
				if (local17.equals("1.1") || local17.startsWith("1.1.") || local17.equals("1.2") || local17.startsWith("1.2.") || local17.equals("1.3") || local17.startsWith("1.3.") || local17.equals("1.4") || local17.startsWith("1.4.") || local17.equals("1.5") || local17.startsWith("1.5.") || local17.equals("1.6.0")) {
					this.method24898("wrongjava", -1965439405);
					return;
				}
				if (local17.startsWith("1.6.0_")) {
					@Pc(72) int local72;
					...
					@Pc(89) String local89 = local17.substring(6, local72);
					if (Class633.method32304(local89, 250407149) && Class616.method32090(local89, (byte) 8) < 10) {
						this.method24898("wrongjava", 1364960903);
						return;
					}
				}
			}
		...
		anInt3422 = Runtime.getRuntime().availableProcessors() * -1401201395;
		this.method24845(-1483631858);
		this.method24859(1791314116);
		aClass147_2 = Class450.method28933(-652952171);
		while (aLong241 * -8807787511991959949L == 0L || Class305.method26796(-262068893) < aLong241 * -8807787511991959949L) {
			anInt3423 = aClass147_2.method12686(aLong238 * 3394915126462843437L) * -709089635;
			for (@Pc(154) int local154 = 0; local154 < anInt3423 * 970166197; local154++) {
				this.method24851((byte) -24);
			}
			this.method24852(-171033447);
			Class256.method26013(Class125_Sub3.aCanvas1, 165759862);
		}
	}
	...
	void method24905() {
		if (Class392.aString197 != null) {
			...
			if (local5.indexOf("sun") != -1 || local5.indexOf("apple") != -1) {
				@Pc(17) String local17 = Class95.aString12;
				if (local17.equals("1.1") || local17.startsWith("1.1.") || local17.equals("1.2") || local17.startsWith("1.2.") || local17.equals("1.3") || local17.startsWith("1.3.") || local17.equals("1.4") || local17.startsWith("1.4.") || local17.equals("1.5") || local17.startsWith("1.5.") || local17.equals("1.6.0")) {
					this.method24898("wrongjava", 1169828676);
					return;
				}
				if (local17.startsWith("1.6.0_")) {
					@Pc(72) int local72;
					...
					@Pc(89) String local89 = local17.substring(6, local72);
					if (Class633.method32304(local89, 250407149) && Class616.method32090(local89, (byte) 8) < 10) {
						this.method24898("wrongjava", 1191446614);
						return;
					}
				}
			}
		...
		anInt3422 = Runtime.getRuntime().availableProcessors() * -1401201395;
		this.method24845(-1483631858);
		this.method24859(184891866);
		aClass147_2 = Class450.method28933(1469083926);
		while (aLong241 * -8807787511991959949L == 0L || Class305.method26796(1516693151) < aLong241 * -8807787511991959949L) {
			anInt3423 = aClass147_2.method12686(aLong238 * 3394915126462843437L) * -709089635;
			for (@Pc(154) int local154 = 0; local154 < anInt3423 * 970166197; local154++) {
				this.method24851((byte) -95);
			}
			this.method24852(778132536);
			Class256.method26013(Class125_Sub3.aCanvas1, 165759862);
		}
	}
	...
	public void method24906() {
		...
		label50: {
			try {
				var6 = true;
				this.method24850(1225712396);
				var6 = false;
				break label50;
			} catch (@Pc(8) ThreadDeath local8) {
				throw local8;
			} catch (@Pc(11) Throwable local11) {
				Class646.method32610(this.method24853((byte) 96), local11, 1212936138);
				this.method24898("crash", -772458594);
				var6 = false;
			} finally {
				if (var6) {
					this.method24896(true, -1699987452);
				}
			}
			this.method24896(true, -377334594);
			return;
		}
		this.method24896(true, 241226325);
	}
	...
	void method24907() {
		if (Class392.aString197 != null) {
			...
			if (local5.indexOf("sun") != -1 || local5.indexOf("apple") != -1) {
				@Pc(17) String local17 = Class95.aString12;
				if (local17.equals("1.1") || local17.startsWith("1.1.") || local17.equals("1.2") || local17.startsWith("1.2.") || local17.equals("1.3") || local17.startsWith("1.3.") || local17.equals("1.4") || local17.startsWith("1.4.") || local17.equals("1.5") || local17.startsWith("1.5.") || local17.equals("1.6.0")) {
					this.method24898("wrongjava", 1619997299);
					return;
				}
				if (local17.startsWith("1.6.0_")) {
					@Pc(72) int local72;
					...
					@Pc(89) String local89 = local17.substring(6, local72);
					if (Class633.method32304(local89, 250407149) && Class616.method32090(local89, (byte) 8) < 10) {
						this.method24898("wrongjava", 58034280);
						return;
					}
				}
			}
		...
		anInt3422 = Runtime.getRuntime().availableProcessors() * -1401201395;
		this.method24845(-1483631858);
		this.method24859(1509528789);
		aClass147_2 = Class450.method28933(2065172053);
		while (aLong241 * -8807787511991959949L == 0L || Class305.method26796(1972040643) < aLong241 * -8807787511991959949L) {
			anInt3423 = aClass147_2.method12686(aLong238 * 3394915126462843437L) * -709089635;
			for (@Pc(154) int local154 = 0; local154 < anInt3423 * 970166197; local154++) {
				this.method24851((byte) -79);
			}
			this.method24852(1419382199);
			Class256.method26013(Class125_Sub3.aCanvas1, 165759862);
		}
	}
	...
	void method24908() {
		@Pc(2) long local2 = Class305.method26796(-399227516);
		@Pc(8) long local8 = aLongArray22[anInt3409 * 950088787];
		aLongArray22[anInt3409 * 950088787] = local2;
		anInt3409 = (anInt3409 * 950088787 + 1 & 0x1F) * -185651237;
		if (local8 != 0L && local2 > local8) {
	...
	void method24909() {
		@Pc(2) long local2 = Class305.method26796(815538933);
		@Pc(8) long local8 = aLongArray22[anInt3409 * 950088787];
		aLongArray22[anInt3409 * 950088787] = local2;
		anInt3409 = (anInt3409 * 950088787 + 1 & 0x1F) * -185651237;
		if (local8 != 0L && local2 > local8) {
	...
	void method24910() {
		@Pc(2) long local2 = Class305.method26796(692459437);
		@Pc(12) long local12 = aLongArray21[anInt3411 * -1288987007 - 1 & 0x1F];
		@Pc(18) long local18 = aLongArray21[anInt3411 * -1288987007];
		aLongArray21[anInt3411 * -1288987007] = local2;
		anInt3411 = (anInt3411 * -1288987007 + 1 & 0x1F) * -1990811263;
	...
	void method24911() {
		@Pc(2) long local2 = Class305.method26796(-169016978);
		@Pc(12) long local12 = aLongArray21[anInt3411 * -1288987007 - 1 & 0x1F];
		@Pc(18) long local18 = aLongArray21[anInt3411 * -1288987007];
		aLongArray21[anInt3411 * -1288987007] = local2;
		anInt3411 = (anInt3411 * -1288987007 + 1 & 0x1F) * -1990811263;
	...
	void method24912() {
		@Pc(2) long local2 = Class305.method26796(428472719);
		@Pc(12) long local12 = aLongArray21[anInt3411 * -1288987007 - 1 & 0x1F];
		@Pc(18) long local18 = aLongArray21[anInt3411 * -1288987007];
		aLongArray21[anInt3411 * -1288987007] = local2;
		anInt3411 = (anInt3411 * -1288987007 + 1 & 0x1F) * -1990811263;
	...
	final void method24914(@OriginalArg(0) boolean arg0) {
		synchronized (this) {
			if (aBoolean591) {
				return;
			}
		...
		if (Class10.method166(1573015288)) {
			Class376.method28046(672839876).method31624(-1000571758);
		}
		if (Class125_Sub3.aCanvas1 != null) {
			try {
				Class125_Sub3.aCanvas1.removeFocusListener(this);
	...
	void method24916() {
		if (Class392.aString197 != null) {
			...
			if (local5.indexOf("sun") != -1 || local5.indexOf("apple") != -1) {
				@Pc(17) String local17 = Class95.aString12;
				if (local17.equals("1.1") || local17.startsWith("1.1.") || local17.equals("1.2") || local17.startsWith("1.2.") || local17.equals("1.3") || local17.startsWith("1.3.") || local17.equals("1.4") || local17.startsWith("1.4.") || local17.equals("1.5") || local17.startsWith("1.5.") || local17.equals("1.6.0")) {
					this.method24898("wrongjava", 1979615946);
					return;
				}
				if (local17.startsWith("1.6.0_")) {
					@Pc(72) int local72;
					...
					@Pc(89) String local89 = local17.substring(6, local72);
					if (Class633.method32304(local89, 250407149) && Class616.method32090(local89, (byte) 8) < 10) {
						this.method24898("wrongjava", -519295078);
						return;
					}
				}
			}
		...
		anInt3422 = Runtime.getRuntime().availableProcessors() * -1401201395;
		this.method24845(-1483631858);
		this.method24859(-100444539);
		aClass147_2 = Class450.method28933(-1514142770);
		while (aLong241 * -8807787511991959949L == 0L || Class305.method26796(1347965270) < aLong241 * -8807787511991959949L) {
			anInt3423 = aClass147_2.method12686(aLong238 * 3394915126462843437L) * -709089635;
			for (@Pc(154) int local154 = 0; local154 < anInt3423 * 970166197; local154++) {
				this.method24851((byte) 42);
			}
			this.method24852(2058044390);
			Class256.method26013(Class125_Sub3.aCanvas1, 165759862);
		}
	}
	...
	public static final void method24918(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) Color arg2, @OriginalArg(3) Color arg3, @OriginalArg(4) Color arg4) {
		try {
			...
			try {
				...
				local2.drawImage(Class115.anImage3, 0, 0, (ImageObserver) null);
	...
	public void method24834() {
		if (!aBoolean591) {
			aLong241 = (Class305.method26796(2091017695) + 4000L) * -992610302756464965L;
		}
	}
	...
	public void method24836() {
		if (!aBoolean591) {
			aLong241 = (Class305.method26796(766378930) + 4000L) * -992610302756464965L;
		}
	}
	...
	public void method24837() {
		if (!aBoolean591) {
			aLong241 = (Class305.method26796(1594748392) + 4000L) * -992610302756464965L;
		}
	}
	...
	final void method24925(@OriginalArg(0) boolean arg0) {
		synchronized (this) {
			if (aBoolean591) {
				return;
			}
		...
		if (Class10.method166(237690969)) {
			Class376.method28046(672839876).method31624(-1046733038);
		}
		if (Class125_Sub3.aCanvas1 != null) {
			try {
				Class125_Sub3.aCanvas1.removeFocusListener(this);
	...
	void method24935(@OriginalArg(0) Container arg0, @OriginalArg(1) int arg1) {
		arg0.setBackground(Color.black);
		arg0.setLayout((LayoutManager) null);
		arg0.add(Class125_Sub3.aCanvas1);
		Class125_Sub3.aCanvas1.setSize(anInt3408 * -1378711501, anInt3416 * 2091353777);
		...
		aBoolean586 = true;
		aBoolean590 = false;
		aLong239 = Class305.method26796(-275359244) * -4981684860522027511L;
	}
	...
	void method24940() {
		@Pc(2) long local2 = Class305.method26796(1515076156);
		@Pc(12) long local12 = aLongArray21[anInt3411 * -1288987007 - 1 & 0x1F];
		@Pc(18) long local18 = aLongArray21[anInt3411 * -1288987007];
		aLongArray21[anInt3411 * -1288987007] = local2;
		anInt3411 = (anInt3411 * -1288987007 + 1 & 0x1F) * -1990811263;
	...
	void method24944() {
		if (Class392.aString197 != null) {
			...
			if (local5.indexOf("sun") != -1 || local5.indexOf("apple") != -1) {
				@Pc(17) String local17 = Class95.aString12;
				if (local17.equals("1.1") || local17.startsWith("1.1.") || local17.equals("1.2") || local17.startsWith("1.2.") || local17.equals("1.3") || local17.startsWith("1.3.") || local17.equals("1.4") || local17.startsWith("1.4.") || local17.equals("1.5") || local17.startsWith("1.5.") || local17.equals("1.6.0")) {
					this.method24898("wrongjava", -313025265);
					return;
				}
				if (local17.startsWith("1.6.0_")) {
					@Pc(72) int local72;
					...
					@Pc(89) String local89 = local17.substring(6, local72);
					if (Class633.method32304(local89, 250407149) && Class616.method32090(local89, (byte) 8) < 10) {
						this.method24898("wrongjava", 1128403157);
						return;
					}
				}
			}
		...
		anInt3422 = Runtime.getRuntime().availableProcessors() * -1401201395;
		this.method24845(-1483631858);
		this.method24859(-273589671);
		aClass147_2 = Class450.method28933(688839595);
		while (aLong241 * -8807787511991959949L == 0L || Class305.method26796(933605808) < aLong241 * -8807787511991959949L) {
			anInt3423 = aClass147_2.method12686(aLong238 * 3394915126462843437L) * -709089635;
			for (@Pc(154) int local154 = 0; local154 < anInt3423 * 970166197; local154++) {
				this.method24851((byte) -64);
			}
			this.method24852(1116521221);
			Class256.method26013(Class125_Sub3.aCanvas1, 165759862);
		}
	}
	...
	public void method24945() throws Exception_Sub1 {
		...
		Class376.method28046(672839876).method31617("jaclib", (byte) -87);
		try {
			QueryPerformanceCounter.init();
		} catch (@Pc(12) Throwable local12) {
			if (Class339.aString179.startsWith("win")) {
	...
	void method24946(@OriginalArg(0) File arg0, @OriginalArg(1) File arg1) {
		try {
			@Pc(6) Class38 local6 = new Class38(aFile2, "rw", 10000L);
			@Pc(11) Class93_Sub41 local11 = new Class93_Sub41(500);
			local11.method22510(3, (byte) -36);
			local11.method22510(arg1 == null ? 0 : 1, (byte) -7);
			local11.method22404(arg0.getPath(), -1489303680);
			if (arg1 != null) {
				local11.method22404(arg1.getPath(), -1489303680);
			}
	...
	final void method24948(@OriginalArg(0) boolean arg0) {
		synchronized (this) {
			if (aBoolean591) {
				return;
			}
		...
		if (Class10.method166(492037067)) {
			Class376.method28046(672839876).method31624(-1575976234);
		}
		if (Class125_Sub3.aCanvas1 != null) {
			try {
				Class125_Sub3.aCanvas1.removeFocusListener(this);
	...
	static final void method24949(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(82) Class539 local82 = Class274.aClass258_1.method26119(Class275.aClass275_13, Class274.aClass258_1, local13, local23, local43, Class280.aClass280_7.method26450(-743817974), Class278.aClass278_2, 0.0F, 0.0F, (Class472) null, 0, local53, false, 96674096);
		if (local82 != null) {
			Class274.aClass258_1.method26134(local82, local63, local33, -895310388);
		}
	}
	...
	public static int method24951(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	public static Class3 method24952(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(2) Class3[] local2 = Class529.method30399((byte) 32);
