...
public class Class109_Sub3 extends Class109 {
			...
			if (local1096 == -1) {
				...
				if (local1137 == 32766) {
					...
					if (local1268 == 0) {
						...
						local1318 = (float) arg1.anIntArray349[local1290];
					...
					local1174 = (long) (local1147 << 16 | local1257);
	...
	boolean method7028(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Class470 arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) int arg6) {
		...
		for (local223 = 0; local223 < 8; local223++) {
			local232 = (float) this.anIntArray79[local223];
			local238 = (float) this.anIntArray80[local223];
			local244 = (float) this.anIntArray72[local223];
		...
		if (local13 && (float) local223 > local15 && (float) arg0 < local17 && (float) local413 > local19 && (float) arg1 < local21) {
			...
			for (local457 = 0; local457 < this.anInt815; local457++) {
				local232 = (float) this.anIntArray70[local457];
				local238 = (float) this.anIntArray81[local457];
				local244 = (float) this.anIntArray71[local457];
				local270 = local3.aFloatArray116[2] * local232 + local3.aFloatArray116[6] * local238 + local3.aFloatArray116[10] * local244 + local3.aFloatArray116[14];
				local296 = local3.aFloatArray116[3] * local232 + local3.aFloatArray116[7] * local238 + local3.aFloatArray116[11] * local244 + local3.aFloatArray116[15];
				@Pc(593) int local593;
				@Pc(600) int local600;
								...
								if (local145 == local15[local182] && local159 == local21[local182] && local131 == local18[local182]) {
									...
									if (local234 != -1) {
										if (local40 == null) {
											...
											local40 = this.aClass423_1.aShortArray128 = Class702.method36722(this.aShortArray35, 2038053695);
											local44 = this.aClass423_1.aShortArray127 = Class702.method36722(this.aShortArray31, 2038053695);
											local48 = this.aClass423_1.aShortArray129 = Class702.method36722(this.aShortArray32, 2038053695);
											local52 = this.aClass423_1.aByteArray92 = Class335.method27408(this.aByteArray24, 1719251266);
										}
										if (local68 == null) {
											@Pc(325) Class423 local325 = local2.aClass423_1 = new Class423();
											local68 = local325.aShortArray128 = Class702.method36722(local24, 2038053695);
											local72 = local325.aShortArray127 = Class702.method36722(local27, 2038053695);
											local76 = local325.aShortArray129 = Class702.method36722(local30, 2038053695);
											local80 = local325.aByteArray92 = Class335.method27408(local33, 1719251266);
										}
	...
	public boolean method6880() {
		...
		for (@Pc(6) int local6 = 0; local6 < this.aShortArray33.length; local6++) {
			if (this.aShortArray33[local6] != -1 && !this.aClass104_Sub2_4.aClass406_3.method28565(this.aClass104_Sub2_4.aClass225_6.method25597(this.aShortArray33[local6], 272175222), -1)) {
				return false;
			}
		}
		return true;
		...
		if ((this.anInt813 & 0x37) == 0) {
			...
			for (@Pc(272) int local272 = 0; local272 < this.anIntArray73.length; local272++) {
				...
				if (local294 == -1) {
					...
					local296 = !Class588.method31649(local310.aByte114, (byte) 10);
				...
				switch(local726) {
					...
					case 5:
						if (this.aClass104_Sub2_4.aBoolean462) {
							...
							local855.method21396(local728.aByte112, local728.anInt3807 * 1731185285, 369288027);
							...
							local855.method21394(-1717143377);
						}
						break;
					case 6:
						local22.method10102(!Class588.method31649(local726, (byte) 10));
						break;
					case 7:
						local22.aClass472_39.method29537(this.aClass104_Sub2_4.aClass489_72.aFloatArray116[12], this.aClass104_Sub2_4.aClass489_72.aFloatArray116[13], this.aClass104_Sub2_4.aClass489_72.aFloatArray116[14]);
						local22.aClass472_39.method29613(local442);
	...
	public boolean method6977() {
		...
		for (@Pc(6) int local6 = 0; local6 < this.aShortArray33.length; local6++) {
			if (this.aShortArray33[local6] != -1 && !this.aClass104_Sub2_4.aClass406_3.method28565(this.aClass104_Sub2_4.aClass225_6.method25597(this.aShortArray33[local6], -462350719), -1)) {
				return false;
			}
		}
		return true;
	...
	public boolean method6976() {
		...
		for (@Pc(6) int local6 = 0; local6 < this.aShortArray33.length; local6++) {
			if (this.aShortArray33[local6] != -1 && !this.aClass104_Sub2_4.aClass406_3.method28565(this.aClass104_Sub2_4.aClass225_6.method25597(this.aShortArray33[local6], 460984749), -1)) {
				return false;
			}
		}
		return true;
	...
	public boolean method6978() {
		...
		for (@Pc(6) int local6 = 0; local6 < this.aShortArray33.length; local6++) {
			if (this.aShortArray33[local6] != -1 && !this.aClass104_Sub2_4.aClass406_3.method28565(this.aClass104_Sub2_4.aClass225_6.method25597(this.aShortArray33[local6], -374710708), -1)) {
				return false;
			}
		}
		return true;
