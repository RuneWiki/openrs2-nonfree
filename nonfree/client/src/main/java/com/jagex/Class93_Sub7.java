...
public class Class93_Sub7 extends Class93 {
	...
	void method12729(@OriginalArg(0) short arg0) {
		if (this.aClass104_Sub1_29.aBoolean106) {
			this.aClass93_Sub41_8.method22454(arg0, 2144235018);
		} else {
			this.aClass93_Sub41_8.method22393(arg0, -1186779702);
		}
	}
		...
		for (@Pc(34) int local34 = this.anInt1454; local34 <= this.anInt1455; local34++) {
			for (@Pc(41) int local41 = this.anInt1453; local41 <= this.anInt1452; local41++) {
				...
				if (local49 > -arg2 && local49 < arg2 && local53 > -arg2 && local53 < arg2 && arg3[local49 + arg2][local53 + arg2]) {
					...
					this.aClass104_Sub1_29.method3836(this.aClass193_11, (Class193) null, this.aClass193_12, (Class193) null);
	...
	void method12731(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		local240 = (float) (this.aClass93_Sub16_1.method13520(-1982084866) - local11);
		local250 = (float) (this.aClass93_Sub16_1.method13521(1655674161) - local28);
		local257 = (float) (this.aClass93_Sub16_1.method13522(1321135326) - local21);
		...
		this.aClass93_Sub41_Sub1_2.method22510(local538, (byte) -80);
		this.aClass93_Sub41_Sub1_2.method22510(local553, (byte) -37);
		this.aClass93_Sub41_Sub1_2.method22510(local566, (byte) -37);
		this.aClass93_Sub41_Sub1_2.method22510(255, (byte) -40);
	...
	void method12732(@OriginalArg(0) short arg0) {
		if (this.aClass104_Sub1_29.aBoolean106) {
			this.aClass93_Sub41_8.method22454(arg0, 2131065806);
		} else {
			this.aClass93_Sub41_8.method22393(arg0, -1592249828);
		}
	}
	...
	Class93_Sub7(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) Class99_Sub2 arg1, @OriginalArg(2) Class93_Sub16 arg2, @OriginalArg(3) int[] arg3) {
		...
		this.aFloatArrayArray14 = (float[][]) null;
		this.aFloatArrayArray16 = (float[][]) null;
		this.aFloatArrayArray15 = (float[][]) null;
	}
	...
	void method12733(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		local240 = (float) (this.aClass93_Sub16_1.method13520(-1209115712) - local11);
		local250 = (float) (this.aClass93_Sub16_1.method13521(1655674161) - local28);
		local257 = (float) (this.aClass93_Sub16_1.method13522(973410424) - local21);
		local264 = (float) Math.sqrt((double) (local240 * local240 + local250 * local250 + local257 * local257));
		local271 = 1.0F / local264;
		local240 *= local271;
		local250 *= local271;
		...
		this.aClass93_Sub41_Sub1_2.method22510(local538, (byte) -48);
		this.aClass93_Sub41_Sub1_2.method22510(local553, (byte) -103);
		this.aClass93_Sub41_Sub1_2.method22510(local566, (byte) -54);
		this.aClass93_Sub41_Sub1_2.method22510(255, (byte) -15);
		this.method12729(local70);
	}
