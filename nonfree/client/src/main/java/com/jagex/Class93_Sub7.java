...
public class Class93_Sub7 extends Class93 {
	...
	Class93_Sub7(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) Class99_Sub2 arg1, @OriginalArg(2) Class93_Sub16 arg2, @OriginalArg(3) int[] arg3) {
		...
		@Pc(22) int local22 = this.aClass93_Sub16_1.method13523() - (arg1.anInt412 * -1678286317 >> 1);
		this.anInt1453 = this.aClass93_Sub16_1.method13520() - local22 >> arg1.anInt415 * -373302705;
		this.anInt1452 = this.aClass93_Sub16_1.method13520() + local22 >> arg1.anInt415 * -373302705;
		this.anInt1454 = this.aClass93_Sub16_1.method13522() - local22 >> arg1.anInt415 * -373302705;
		this.anInt1455 = this.aClass93_Sub16_1.method13522() + local22 >> arg1.anInt415 * -373302705;
			...
			if (local127 > 0 && local127 < this.aClass99_Sub2_1.anInt413 * -143202029 - 1) {
				for (local140 = 0; local140 <= local82; local140++) {
					...
					if (local148 > 0 && local148 < this.aClass99_Sub2_1.anInt414 * -1667858293 - 1) {
						local175 = arg1.method2482(local148 + 1, local127) - arg1.method2482(local148 - 1, local127);
						local191 = arg1.method2482(local148, local127 + 1) - arg1.method2482(local148, local127 - 1);
		...
		if (this.anInt1456 > 0) {
			...
			this.aClass16_10 = new Class16(Class134_Sub2.method10212(this.anInt1456));
			local127 = 0;
			local119 = 0;
	...
	void method12729(@OriginalArg(0) short arg0) {
		if (this.aClass104_Sub1_29.aBoolean106) {
			this.aClass93_Sub41_8.method22454(arg0);
		} else {
			this.aClass93_Sub41_8.method22393(arg0);
		}
	}
	...
	void method12731(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		@Pc(28) int local28 = this.aClass99_Sub2_1.method2480(local11, local21);
		...
		local240 = this.aClass93_Sub16_1.method13520() - local11;
		local250 = this.aClass93_Sub16_1.method13521() - local28;
		local257 = this.aClass93_Sub16_1.method13522() - local21;
		local264 = (float) Math.sqrt((double) (local240 * local240 + local250 * local250 + local257 * local257));
		local271 = 1.0F / local264;
		local240 *= local271;
		local250 *= local271;
		local257 *= local271;
		local280 = local264 / (float) this.aClass93_Sub16_1.method13523();
		...
		@Pc(528) int local528 = this.aClass93_Sub16_1.method13539();
		...
		this.aClass93_Sub41_Sub1_2.method22510(local538);
		this.aClass93_Sub41_Sub1_2.method22510(local553);
		this.aClass93_Sub41_Sub1_2.method22510(local566);
		this.aClass93_Sub41_Sub1_2.method22510(255);
		...
		for (@Pc(34) int local34 = this.anInt1454; local34 <= this.anInt1455; local34++) {
			for (@Pc(41) int local41 = this.anInt1453; local41 <= this.anInt1452; local41++) {
				...
				if (local49 > -arg2 && local49 < arg2 && local53 > -arg2 && local53 < arg2 && arg3[local49 + arg2][local53 + arg2]) {
					this.aClass104_Sub1_29.method3792((int) (this.aClass93_Sub16_1.method13525() * 255.0F) << 24);
