...
public class Class284 implements Interface26 {
	...
	public static int method26484(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) String arg1) {
		@Pc(4) int local4 = arg0.anInt3070 * 212851357;
		@Pc(8) byte[] local8 = Class269.method26271(arg1);
		arg0.method22639(local8.length);
		arg0.anInt3070 += Class350.aClass337_1.method27451(local8, 0, local8.length, arg0.aByteArray58, arg0.anInt3070 * 212851357) * -1445626955;
	...
	Class284(@OriginalArg(0) Class303 arg0, @OriginalArg(1) Class93_Sub41 arg1) {
		this.this$0 = arg0;
		if (arg1.method22415() == 65535) {
			this.aClass466_1 = null;
		} else {
			arg1.anInt3070 -= 1403713386;
			this.aClass466_1 = arg0.anInterface27_2.method25528().method1463(arg1);
		}
	}
	...
	public void method26715(@OriginalArg(0) Class297 arg0) {
		if (this.aClass466_1 != null) {
			arg0.method26624().method33468((Class108) this.this$0.anInterface27_2.method25528().method18261(this.aClass466_1.anInt5092 * -1181855333), this.aClass466_1.anObject19);
		}
	}
	...
	static final void method26486(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		arg0.method20467(arg1, arg2, arg3 + arg1, arg4 + arg2);
		arg0.method20600(arg1, arg2, arg3, arg4, -16777216);
		...
		if (Class604.aClass100_50 == null || Class604.aClass100_50.method18189() != local31 || Class604.aClass100_50.method18165() != local33) {
			...
			Class159_Sub1.method14520(arg0, false, false, client.aBoolean620, true);
			arg0.method20501();
			Class604.aClass100_50 = arg0.method20613(local58, local66, local31, local33, true);
		}
		Class604.aClass100_50.method18169(local58, local66);
		...
		arg0.method20653(local142, local156, local124, local132, local158, 1);
		arg0.method20478(local142, local156, local124, local132, local158, 0);
		for (@Pc(184) Class93_Sub29 local184 = (Class93_Sub29) Class159_Sub1.aClass22_28.method445(); local184 != null; local184 = (Class93_Sub29) Class159_Sub1.aClass22_28.method415()) {
			@Pc(195) Class322 local195 = (Class322) Class159_Sub1.aClass32_Sub2_2.method18261(local184.anInt1603 * 1208139441);
			if (Class32_Sub11.method17037(local195)) {
				...
				if (local209 != null) {
					...
					arg0.method20600(local268 - 2, local281 - 2, 4, 4, local247 << 24 | 0xFFFF00);
				}
			}
		}
		Class159_Sub1.aClass240_34.method25832(5);
	}

	@OriginalMember(owner = "client!gc", name = "si", descriptor = "(Lclient!yf;I)V", line = 8206)
	static final void method26485(@OriginalArg(0) Class681 arg0) {
	...
	static final void method26487(@OriginalArg(0) Class681 arg0) {
