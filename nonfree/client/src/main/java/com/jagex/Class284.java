...
public class Class284 implements Interface26 {
	...
	public void method26715(@OriginalArg(0) Class297 arg0, @OriginalArg(1) byte arg1) {
		if (this.aClass466_1 != null) {
			arg0.method26624(-2044048665).method33468((Class108) this.this$0.anInterface27_2.method25528((byte) -32).method18261(this.aClass466_1.anInt5092 * -1181855333, 1495013738), this.aClass466_1.anObject19, -1982962417);
		}
	}
	...
	Class284(@OriginalArg(0) Class303 arg0, @OriginalArg(1) Class93_Sub41 arg1) {
		this.this$0 = arg0;
		if (arg1.method22415(-1434290800) == 65535) {
			this.aClass466_1 = null;
		} else {
			arg1.anInt3070 -= 1403713386;
			this.aClass466_1 = arg0.anInterface27_2.method25528((byte) -12).method1463(arg1, (byte) 33);
		}
	}
	...
	public void method26714(@OriginalArg(0) Class297 arg0) {
		if (this.aClass466_1 != null) {
			arg0.method26624(1838875806).method33468((Class108) this.this$0.anInterface27_2.method25528((byte) 1).method18261(this.aClass466_1.anInt5092 * -1181855333, -2036295823), this.aClass466_1.anObject19, -1383761232);
		}
	}
	...
	public void method26713(@OriginalArg(0) Class297 arg0) {
		if (this.aClass466_1 != null) {
			arg0.method26624(355717944).method33468((Class108) this.this$0.anInterface27_2.method25528((byte) -38).method18261(this.aClass466_1.anInt5092 * -1181855333, -1907853590), this.aClass466_1.anObject19, -1729143292);
		}
	}
	...
	public static int method26484(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		...
		arg0.method22639(local8.length, (byte) -26);
	...
	static final void method26485(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method26486(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) byte arg5) {
		arg0.method20467(arg1, arg2, arg3 + arg1, arg4 + arg2);
		arg0.method20600(arg1, arg2, arg3, arg4, -16777216, (byte) 119);
		...
		for (@Pc(184) Class93_Sub29 local184 = (Class93_Sub29) Class159_Sub1.aClass22_28.method445((byte) 70); local184 != null; local184 = (Class93_Sub29) Class159_Sub1.aClass22_28.method415(1881187987)) {
			...
			if (Class32_Sub11.method17037(local195, (byte) 82)) {
				...
				if (local209 != null) {
					...
					arg0.method20600(local268 - 2, local281 - 2, 4, 4, local247 << 24 | 0xFFFF00, (byte) 103);
				}
			}
		}
		Class159_Sub1.aClass240_34.method25832(5, (byte) -45);
	}
