...
class Class277 implements Interface58 {
	...
	static void method26360(@OriginalArg(0) Class572[][][] arg0) {
				...
				for (@Pc(17) int local17 = 0; local17 < local9[local11].length; local17++) {
					...
					if (local29 != null) {
						if (local29.aClass132_Sub1_Sub4_1 instanceof Interface61) {
							((Interface61) local29.aClass132_Sub1_Sub4_1).method13405();
						}
						if (local29.aClass132_Sub1_Sub3_1 instanceof Interface61) {
							((Interface61) local29.aClass132_Sub1_Sub3_1).method13405();
						}
						if (local29.aClass132_Sub1_Sub3_2 instanceof Interface61) {
							((Interface61) local29.aClass132_Sub1_Sub3_2).method13405();
						}
						if (local29.aClass132_Sub1_Sub2_1 instanceof Interface61) {
							((Interface61) local29.aClass132_Sub1_Sub2_1).method13405();
						}
						if (local29.aClass132_Sub1_Sub2_2 instanceof Interface61) {
							((Interface61) local29.aClass132_Sub1_Sub2_2).method13405();
						}
						for (@Pc(80) Class590 local80 = local29.aClass590_1; local80 != null; local80 = local80.aClass590_2) {
							...
							if (local86 instanceof Interface61) {
								((Interface61) local86).method13405();
							}
						}
					}
				}
	...
	static final void method26362(@OriginalArg(0) Class681 arg0) {
	...
	static final void method26355(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = ((Class47) aClass32_Sub12_1.method18261(local12)).anInt152 * -945892479;
	}

	@OriginalMember(owner = "client!fw", name = "aha", descriptor = "(Lclient!yf;B)V", line = 10880)
	static final void method26353(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = ((Class263) Class32.aClass32_Sub17_23.method18261(local12)).anInt3871 * -1681798739;
	}

	@OriginalMember(owner = "client!fw", name = "ahn", descriptor = "(Lclient!yf;I)V", line = 11002)
	static final void method26361(@OriginalArg(0) Class681 arg0) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class166_Sub24.method15871();
	}

	@OriginalMember(owner = "client!fw", name = "me", descriptor = "(B)V", line = 12414)
	public static void method26357() {
		if (Class343.method27518() == Class555.aClass555_3) {
			return;
		}
		try {
			@Pc(9) String local9 = Class32_Sub10.anApplet2.getParameter(Class461.aClass461_26.aString211);
			@Pc(17) int local17 = (int) (Class305.method26796() / 86400000L) - 11745;
			@Pc(30) String local30 = "usrdob=" + local17 + "; version=1; path=/; domain=" + local9;
			Class70.method1231(Class32_Sub10.anApplet2, "document.cookie=\"" + local30 + "\"");
		} catch (@Pc(45) Throwable local45) {
		}
	}

	@OriginalMember(owner = "client!fw", name = "mq", descriptor = "(I)V", line = 12487)
	static void method26358() {
		if (Class280.aClass693_1 != Class693.aClass693_12) {
			Class447.aClass447_13.method28904();
		}
	}

	@OriginalMember(owner = "client!fw", name = "awo", descriptor = "(Lclient!yf;B)V", line = 13630)
	static final void method26359(@OriginalArg(0) Class681 arg0) {
		@Pc(2) Class154_Sub1 local2 = Class687.method36501();
		if (local2 != null) {
			...
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = local2.method14148();
			arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = local2.method14154();
	...
	static final void method26354(@OriginalArg(0) Class681 arg0) {
