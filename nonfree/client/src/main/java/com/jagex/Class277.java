...
class Class277 implements Interface58 {
	...
	public void method26351(@OriginalArg(0) Object arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) Object[] arg2) {
		...
		@Pc(6) Class472 local6 = local2.method30806((short) -5662);
		@Pc(10) float local10 = local2.method30847(585376764);
		@Pc(14) float local14 = local2.method30808((byte) 1);
		@Pc(21) Class472 local21 = Class472.method29574(local6, this.this$0.method26030(-819325062));
	...
	public void method26350(@OriginalArg(0) Object arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) Object[] arg2, @OriginalArg(3) byte arg3) {
		@Pc(2) Class539 local2 = (Class539) arg0;
		@Pc(6) Class472 local6 = local2.method30806((short) 119);
		@Pc(10) float local10 = local2.method30847(273033167);
		@Pc(14) float local14 = local2.method30808((byte) 1);
		@Pc(21) Class472 local21 = Class472.method29574(local6, this.this$0.method26030(-1870758685));
		@Pc(23) float local23 = 0.0F;
		@Pc(26) float local26 = local21.method29565();
		if (local26 >= local14) {
			local23 = 0.0F;
	...
	public void method26352(@OriginalArg(0) Object arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) Object[] arg2) {
		@Pc(2) Class539 local2 = (Class539) arg0;
		@Pc(6) Class472 local6 = local2.method30806((short) -21690);
		@Pc(10) float local10 = local2.method30847(-587425773);
		@Pc(14) float local14 = local2.method30808((byte) 1);
		@Pc(21) Class472 local21 = Class472.method29574(local6, this.this$0.method26030(-1585771865));
		@Pc(23) float local23 = 0.0F;
		@Pc(26) float local26 = local21.method29565();
		if (local26 >= local14) {
			local23 = 0.0F;
	...
	static final void method26353(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method26354(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method26355(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
	...
	static final void method26356(@OriginalArg(0) long arg0) {
		...
		Class49.method16607((byte) -67);
	}

	@OriginalMember(owner = "client!fw", name = "me", descriptor = "(B)V", line = 12414)
	public static void method26357(@OriginalArg(0) byte arg0) {
		if (Class343.method27518((byte) 66) == Class555.aClass555_3) {
			return;
		}
		try {
			@Pc(9) String local9 = Class32_Sub10.anApplet2.getParameter(Class461.aClass461_26.aString211);
			@Pc(17) int local17 = (int) (Class305.method26796(1236000300) / 86400000L) - 11745;
	...
	static void method26358(@OriginalArg(0) int arg0) {
		if (Class280.aClass693_1 != Class693.aClass693_12) {
			Class447.aClass447_13.method28904(-2042335748);
		}
	}

	@OriginalMember(owner = "client!fw", name = "awo", descriptor = "(Lclient!yf;B)V", line = 13630)
	static final void method26359(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(2) Class154_Sub1 local2 = Class687.method36501(1986137124);
		if (local2 != null) {
			...
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = local2.method14148(-2125525230);
			arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = local2.method14154((byte) -75);
	...
	static void method26360(@OriginalArg(0) Class572[][][] arg0, @OriginalArg(1) int arg1) {
	...
	static final void method26361(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class166_Sub24.method15871(1434635284);
	}

	@OriginalMember(owner = "client!fw", name = "sf", descriptor = "(Lclient!yf;B)V", line = 8290)
	static final void method26362(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
