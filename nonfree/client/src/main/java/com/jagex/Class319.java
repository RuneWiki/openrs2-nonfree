...
public class Class319 implements Interface75 {
	...
	static final void method27218(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class286.method26526(local11, local14, arg0, -1706148552);
	}

	@OriginalMember(owner = "client!hp", name = "vq", descriptor = "(Lclient!yf;I)V", line = 8723)
	static final void method27219(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(14) Class312 local14 = Class659.method32805(arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091], 161735741);
	...
	static final void method27220(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method27221(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		if (!Class642.method32523(local13, local28, 1726186060)) {
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!hp", name = "k", descriptor = "(B)Z", line = 100)
	static boolean method27222(@OriginalArg(0) byte arg0) {
		try {
			@Pc(3) Class91 local3 = new Class91();
			@Pc(8) byte[] local8 = local3.method1704(Class366.aByteArray86, -227101470);
			Class288.method26550(local8, -699304736);
			return true;
	...
	static Class54_Sub1 method27223(@OriginalArg(0) byte arg0) {
		...
		if (local7) {
			try {
				...
				if (Class51.aClass93_Sub36_1.aClass166_Sub4_2.method15424((byte) 95) == 3) {
		...
		if (local9) {
			try {
				...
				if (Class51.aClass93_Sub36_1.aClass166_Sub4_2.method15424((byte) 31) == 5) {
		...
		if (local5) {
			try {
				...
				if (Class51.aClass93_Sub36_1.aClass166_Sub4_2.method15424((byte) 75) == 1) {
		...
		if ((local61 <= 100000 || local59 <= 100000) && local61 <= local59) {
			Class251.method25967(local3, 1, local61 == -1 ? local59 : local61, (byte) 106);
		} else {
			Class251.method25967(local3, 3, local59 == -1 ? local61 : local59, (byte) 111);
		}
		return local3;
	}

	@OriginalMember(owner = "client!hp", name = "ay", descriptor = "(Lclient!dh;IIIIIII)V", line = 1145)
	static void method27224(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		arg0.method20600(arg1, arg2, arg3, arg4, arg5, (byte) 69);
		arg0.method20600(arg1 + 1, arg2 + 1, arg3 - 2, 16, arg6, (byte) 80);
		arg0.method20472(arg1 + 1, arg2 + 18, arg3 - 2, arg4 - 19, arg6, 1373199322);
	}
