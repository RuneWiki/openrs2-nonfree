...
public class Class93_Sub32 extends Class93 {
	...
	boolean method13921(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	boolean method13917(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	void method13915(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2) {
		arg2[0] = this.anInt1618 * 1148825861;
		arg2[1] = this.anInt1613 * 1917342539 - this.anInt1616 * -1215398805 + arg0;
		arg2[2] = arg1 + (this.anInt1614 * 840213537 - this.anInt1619 * -144202293);
	}
	...
	void method13919(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2) {
		arg2[0] = 0;
		arg2[1] = arg0 + (this.anInt1616 * -1215398805 - this.anInt1613 * 1917342539);
		arg2[2] = this.anInt1619 * -144202293 - this.anInt1614 * 840213537 + arg1;
	}
	...
	public static boolean method13931(@OriginalArg(0) char arg0) {
		if (arg0 >= ' ' && arg0 <= '~') {
			return true;
	...
	static int method13929(@OriginalArg(0) Class312 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method13930(@OriginalArg(0) Class681 arg0) {
