...
public class Class126_Sub2 extends Class126 {
	...
	void method10040(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) byte arg2) {
		...
		if (arg1) {
			this.aClass115_3.method8210(this.aClass93_Sub33_Sub1_21, this.aClass460_7.aFloat293, this.aClass460_7.aFloat292, this.aClass460_7.aFloat291, this.aClass460_7.aFloat294, 1891475941);
		} else {
			this.aClass115_3.method8309(this.aClass93_Sub33_Sub1_18, Math.min(Math.max(this.aFloat121, 0.0F), 1.0F), (byte) -86);
		}
		this.aClass115_3.method8259(this.aClass93_Sub33_Sub1_22, this.aClass472_37.aFloat317, this.aClass472_37.aFloat318, this.aClass472_37.aFloat319, -1492527849);
	}
	...
	void method10045(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1) {
		...
		if (arg1) {
			this.aClass115_3.method8210(this.aClass93_Sub33_Sub1_21, this.aClass460_7.aFloat293, this.aClass460_7.aFloat292, this.aClass460_7.aFloat291, this.aClass460_7.aFloat294, 1155712834);
		} else {
			this.aClass115_3.method8309(this.aClass93_Sub33_Sub1_18, Math.min(Math.max(this.aFloat121, 0.0F), 1.0F), (byte) -73);
		}
		this.aClass115_3.method8259(this.aClass93_Sub33_Sub1_22, this.aClass472_37.aFloat317, this.aClass472_37.aFloat318, this.aClass472_37.aFloat319, 723167992);
	}
	...
	void method10046(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1) {
		...
		if (arg1) {
			this.aClass115_3.method8210(this.aClass93_Sub33_Sub1_21, this.aClass460_7.aFloat293, this.aClass460_7.aFloat292, this.aClass460_7.aFloat291, this.aClass460_7.aFloat294, 1534554383);
		} else {
			this.aClass115_3.method8309(this.aClass93_Sub33_Sub1_18, Math.min(Math.max(this.aFloat121, 0.0F), 1.0F), (byte) -42);
		}
		this.aClass115_3.method8259(this.aClass93_Sub33_Sub1_22, this.aClass472_37.aFloat317, this.aClass472_37.aFloat318, this.aClass472_37.aFloat319, 1211981701);
	}
	...
	void method10047(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1) {
		...
		if (arg1) {
			this.aClass115_3.method8210(this.aClass93_Sub33_Sub1_21, this.aClass460_7.aFloat293, this.aClass460_7.aFloat292, this.aClass460_7.aFloat291, this.aClass460_7.aFloat294, 677112254);
		} else {
			this.aClass115_3.method8309(this.aClass93_Sub33_Sub1_18, Math.min(Math.max(this.aFloat121, 0.0F), 1.0F), (byte) -51);
		}
		this.aClass115_3.method8259(this.aClass93_Sub33_Sub1_22, this.aClass472_37.aFloat317, this.aClass472_37.aFloat318, this.aClass472_37.aFloat319, 2111896077);
	}
	...
	void method10048(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1) {
		...
		if (arg1) {
			this.aClass115_3.method8210(this.aClass93_Sub33_Sub1_21, this.aClass460_7.aFloat293, this.aClass460_7.aFloat292, this.aClass460_7.aFloat291, this.aClass460_7.aFloat294, 120310903);
		} else {
			this.aClass115_3.method8309(this.aClass93_Sub33_Sub1_18, Math.min(Math.max(this.aFloat121, 0.0F), 1.0F), (byte) -23);
		}
		this.aClass115_3.method8259(this.aClass93_Sub33_Sub1_22, this.aClass472_37.aFloat317, this.aClass472_37.aFloat318, this.aClass472_37.aFloat319, 1859299356);
	}

	@OriginalMember(owner = "client!ahr", name = "lm", descriptor = "(Ljava/lang/String;I)V", line = 12039)
	public static final void method10049(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		if (Class93_Sub1_Sub2.aClass170Array1 == null) {
			return;
		}
		@Pc(5) Class175 local5 = Class330.method27372(-1569486854);
		@Pc(11) Class93_Sub22 local11 = Class102.method2592(Class446.aClass446_34, local5.aClass24_2, (byte) 107);
		local11.aClass93_Sub41_Sub2_1.method22510(Class46.method894(arg0, -1727046151), (byte) -93);
		local11.aClass93_Sub41_Sub2_1.method22402(arg0, -1517906929);
		local5.method24351(local11, -1632891367);
	}
