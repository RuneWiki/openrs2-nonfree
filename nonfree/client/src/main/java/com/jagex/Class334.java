...
public class Class334 {
	...
	static final boolean method27401(@OriginalArg(0) int arg0) {
		return arg0 < 7;
	}

	@OriginalMember(owner = "client!id", name = "ci", descriptor = "(Lclient!aop;[BIIIILclient!xe;Lclient!xe;I)I", line = 335)
	public static final int method27402(@OriginalArg(0) Class32_Sub14 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class656 arg6, @OriginalArg(7) Class656 arg7) {
		@Pc(1) int local1 = 0;
	...
	public static void method27403(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) String arg3) {
		@Pc(4) Class312 local4 = Class124_Sub2.method9308(arg1, arg2);
		if (local4 == null) {
			return;
		}
		if (local4.anObjectArray26 != null) {
			...
			Class211.method25429(local15);
		}
		if (!client.method25238(local4).method13619(arg0 - 1)) {
			return;
		}
		@Pc(45) Class175 local45 = Class330.method27372();
		...
		if (local4.aString167 == null || local4.aClass310_7 == null) {
			Class493.method30013(local45, local4, arg0, arg1, arg2);
			return;
		}
		@Pc(73) Class93_Sub22 local73 = Class102.method2592(Class446.aClass446_106, local45.aClass24_2);
		local73.aClass93_Sub41_Sub2_1.method22510(Class46.method894(local4.aString167) + 7 + 1);
		local73.aClass93_Sub41_Sub2_1.method22402(local4.aString167);
		local73.aClass93_Sub41_Sub2_1.method22590(arg2);
		local73.aClass93_Sub41_Sub2_1.method22447(arg0);
		local73.aClass93_Sub41_Sub2_1.method22448(local4.aClass310_7.method36920());
		local73.aClass93_Sub41_Sub2_1.method22466(arg1);
		local45.method24351(local73);
	}
}
