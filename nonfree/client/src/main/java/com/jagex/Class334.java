...
public class Class334 {
	...
	public static final int method27402(@OriginalArg(0) Class32_Sub14 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class656 arg6, @OriginalArg(7) Class656 arg7, @OriginalArg(8) int arg8) {
		...
		@Pc(8) int local8 = -1;
		label73: while (true) {
			@Pc(12) int local12 = local6.method22464(2075753934);
			if (local12 == 0) {
				return local1;
			}
			local8 += local12;
			...
			while (true) {
						...
						do {
							do {
								do {
									@Pc(27) int local27;
									do {
										local27 = local6.method22632((byte) -14);
										if (local27 == 0) {
											continue label73;
										}
				...
				} while (local36.anInt5709 * 1175627307 == Class615.aClass615_24.anInt5628 * 948246811 && Class51.aClass93_Sub36_1.aClass166_Sub3_1.method15402(1402098336) == 0 && local68.anInt5592 * 1067969079 == 0 && local68.anInt5591 * -297318857 != 1 && !local68.aBoolean835);
				if (!local68.method31994(arg7, (short) 9804)) {
	...
	public static void method27403(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) String arg3, @OriginalArg(4) short arg4) {
		...
		if (!client.method25238(local4).method13619(arg0 - 1, -244589856)) {
			return;
		}
		@Pc(45) Class175 local45 = Class330.method27372(-1502628854);
		...
		if (local4.aString167 == null || local4.aClass310_7 == null) {
			Class493.method30013(local45, local4, arg0, arg1, arg2, 1999052883);
			return;
		}
		@Pc(73) Class93_Sub22 local73 = Class102.method2592(Class446.aClass446_106, local45.aClass24_2, (byte) 71);
		local73.aClass93_Sub41_Sub2_1.method22510(Class46.method894(local4.aString167, -1710534944) + 7 + 1, (byte) -1);
		local73.aClass93_Sub41_Sub2_1.method22402(local4.aString167, -905461201);
		local73.aClass93_Sub41_Sub2_1.method22590(arg2, (byte) 59);
		local73.aClass93_Sub41_Sub2_1.method22447(arg0, -1733657513);
		local73.aClass93_Sub41_Sub2_1.method22448(local4.aClass310_7.method36920(), (byte) -109);
		local73.aClass93_Sub41_Sub2_1.method22466(arg1, 844689790);
		local45.method24351(local73, -2068554359);
	}
}
