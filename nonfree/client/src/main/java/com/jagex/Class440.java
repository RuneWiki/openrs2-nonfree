...
public class Class440 {
	...
	static final void method28847(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method28848(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, -39199903);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class583.method31424(local16, local22, arg0, 1860815549);
	}
	...
	public static int method28850(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
	...
	static final void method28851(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anInt5891 -= 201819375;
		@Pc(8) Class390[] local8 = Class708.method36756(866835469);
		@Pc(11) Class392[] local11 = Class252.method25978(-1875628985);
	...
	public static String method28852(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) byte arg3) {
		...
		return arg1 == 3 ? Class362.method27848(arg0, arg1, arg2, (byte) 24) : Integer.toString(local14 / 10) + local14 % 10 + "-" + Class69.aStringArrayArray1[arg1][local18] + "-" + local22 + " " + local26 / 10 + local26 % 10 + ":" + local30 / 10 + local30 % 10;
	}
