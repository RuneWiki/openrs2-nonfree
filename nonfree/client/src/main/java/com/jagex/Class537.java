...
public class Class537 {
	...
	static final void method30760(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!rt", name = "apq", descriptor = "(Lclient!yf;S)V", line = 12666)
	static final void method30761(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
		@Pc(17) boolean local17 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091] == 1;
		if (local17) {
			Class322.method27274(3, 1589735282);
		} else {
			Class322.method27274(2, -1917962815);
		}
	}
}
