...
public class Class344 {
	...
	public final String method27524(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
	...
	public boolean method27525(@OriginalArg(0) int arg0) {
	...
	public final boolean method27527(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg0.isEmpty() || arg0.length() > 10 || !Class53_Sub1.method14952(arg0.charAt(0), (byte) 87)) {
			return false;
		}
		@Pc(17) Class346 local17 = this.method27546(arg0, -2477816);
		if (local17 != null) {
			this.aLinkedList2.remove(local17);
		}
		this.aLinkedList2.add(new Class346(arg0, arg1, arg2));
		this.method27531(1281612045);
		return true;
	}

	@OriginalMember(owner = "client!io", name = "ag", descriptor = "()V", line = 119)
	final void method27528() {
		this.aString180 = "";
	...
	public final void method27529(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
	...
	public final void method27530(@OriginalArg(0) int arg0) {
		this.aLinkedList2.clear();
		this.aString180 = "";
	}

	@OriginalMember(owner = "client!io", name = "p", descriptor = "(I)V", line = 119)
	final void method27531(@OriginalArg(0) int arg0) {
		this.aString180 = "";
		for (@Pc(4) int local4 = 0; local4 < this.aLinkedList2.size(); local4++) {
			@Pc(15) Class346 local15 = (Class346) this.aLinkedList2.get(local4);
			@Pc(20) char local20 = local15.aString181.charAt(0);
	...
	public boolean method27533() {
		return this.aBoolean724;
	}

	@OriginalMember(owner = "client!io", name = "c", descriptor = "(Z)V", line = 21)
	public void method27534(@OriginalArg(0) boolean arg0) {
		this.aBoolean724 = arg0;
	}

	@OriginalMember(owner = "client!io", name = "r", descriptor = "(Z)V", line = 21)
	public void method27535(@OriginalArg(0) boolean arg0) {
		this.aBoolean724 = arg0;
	}

	@OriginalMember(owner = "client!io", name = "v", descriptor = "(C)Z", line = 29)
	public static final boolean method27536(@OriginalArg(0) char arg0) {
	...
	public final boolean method27537(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg0.isEmpty() || arg0.length() > 10 || !Class53_Sub1.method14952(arg0.charAt(0), (byte) 60)) {
			return false;
		}
		@Pc(17) Class346 local17 = this.method27546(arg0, -72563851);
		if (local17 != null) {
			this.aLinkedList2.remove(local17);
		}
		this.aLinkedList2.add(new Class346(arg0, arg1, arg2));
		this.method27531(1544580348);
		return true;
	}

	@OriginalMember(owner = "client!io", name = "m", descriptor = "(I)I", line = 25)
	public int method27538(@OriginalArg(0) int arg0) {
		return this.aLinkedList2.size();
	}

	@OriginalMember(owner = "client!io", name = "y", descriptor = "(Ljava/lang/String;)Lclient!iq;", line = 46)
	final Class346 method27539(@OriginalArg(0) String arg0) {
		@Pc(3) Iterator local3 = this.aLinkedList2.iterator();
	...
	final Class346 method27540(@OriginalArg(0) String arg0) {
		@Pc(3) Iterator local3 = this.aLinkedList2.iterator();
		@Pc(10) Class346 local10;
		do {
			if (!local3.hasNext()) {
	...
	public final void method27541(@OriginalArg(0) String arg0) {
		@Pc(3) Iterator local3 = this.aLinkedList2.iterator();
		while (local3.hasNext()) {
			@Pc(10) Class346 local10 = (Class346) local3.next();
			if (local10.aString181.equals(arg0)) {
	...
	public final void method27542(@OriginalArg(0) String arg0) {
		@Pc(3) Iterator local3 = this.aLinkedList2.iterator();
		while (local3.hasNext()) {
			@Pc(10) Class346 local10 = (Class346) local3.next();
			if (local10.aString181.equals(arg0)) {
	...
	public final void method27545() {
		this.aLinkedList2.clear();
		this.aString180 = "";
	}

	@OriginalMember(owner = "client!io", name = "w", descriptor = "(Ljava/lang/String;I)Lclient!iq;", line = 46)
	final Class346 method27546(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Iterator local3 = this.aLinkedList2.iterator();
		@Pc(10) Class346 local10;
		do {
			if (!local3.hasNext()) {
	...
	final Class346 method27547(@OriginalArg(0) String arg0) {
		@Pc(3) Iterator local3 = this.aLinkedList2.iterator();
		@Pc(10) Class346 local10;
		do {
			if (!local3.hasNext()) {
	...
	public final String method27549(@OriginalArg(0) String arg0) {
		if (this.aLinkedList2.isEmpty()) {
			return arg0;
		}
		@Pc(11) StringBuilder local11 = new StringBuilder(arg0.length());
	...
	public final String method27551(@OriginalArg(0) String arg0) {
		if (this.aLinkedList2.isEmpty()) {
			return arg0;
		}
		@Pc(11) StringBuilder local11 = new StringBuilder(arg0.length());
	...
	public static Class100 method27552(@OriginalArg(0) int arg0) {
		return Class625.aClass100_51;
	}

	@OriginalMember(owner = "client!io", name = "p", descriptor = "(Lclient!yf;B)V", line = 62)
	static void method27553(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class452.method28961((byte) -30);
	}
	...
	static final void method27554(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		Class168.method17627(local11, local14, arg0, (byte) -53);
	}
	...
	static final void method27555(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class557.aClass297_1.method26622(local12, 1849330986).method26750((short) -15353);
	}
	...
	static final void method27557(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		Class51.aClass93_Sub36_1.method14357(Class51.aClass93_Sub36_1.aClass166_Sub35_2, arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091], (byte) 93);
