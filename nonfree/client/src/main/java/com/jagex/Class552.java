...
public class Class552 {
	...
	void method31036() {
		...
		for (@Pc(13) int local13 = 0; local13 < local11; local13++) {
			this.aClass544Array1[local13].method30949(-1389306394);
		}
	}

	@OriginalMember(owner = "client!sj", name = "e", descriptor = "(III)V", line = 210)
	void method31037(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	Class544 method31038(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	...
	Class544 method31039(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2) {
		return this.aClass544Array1[((arg1 & 0xFF) >>> 8 - this.anInt5316 * 1013448115) + ((arg0 & this.anInt5315 * 854596103) << this.anInt5316 * 1013448115)];
	}
	...
	void method31040() {
		@Pc(11) int local11 = 0x1 << this.anInt5316 * 1013448115 + this.anInt5317 * 2017352243;
		for (@Pc(13) int local13 = 0; local13 < local11; local13++) {
			this.aClass544Array1[local13].method30949(-1298740145);
		}
	}

	@OriginalMember(owner = "client!sj", name = "k", descriptor = "(II)V", line = 210)
	void method31041(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.aClass544Array1 != null && arg1 == this.anInt5316 * 1013448115 && this.anInt5317 * 2017352243 == arg0) {
			return;
		}
		this.anInt5317 = arg0 * -1573113605;
	...
	void method31042() {
		@Pc(11) int local11 = 0x1 << this.anInt5316 * 1013448115 + this.anInt5317 * 2017352243;
		for (@Pc(13) int local13 = 0; local13 < local11; local13++) {
			this.aClass544Array1[local13].method30949(338837355);
		}
	}

	@OriginalMember(owner = "client!sj", name = "u", descriptor = "(IB)Lclient!sa;", line = 225)
	Class544 method31043(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		return this.aClass544Array1[((arg1 & 0xFF) >>> 8 - this.anInt5316 * 1013448115) + ((arg0 & this.anInt5315 * 854596103) << this.anInt5316 * 1013448115)];
	}

	@OriginalMember(owner = "client!sj", name = "n", descriptor = "(I)V", line = 220)
	void method31044(@OriginalArg(0) int arg0) {
		@Pc(11) int local11 = 0x1 << this.anInt5316 * 1013448115 + this.anInt5317 * 2017352243;
		for (@Pc(13) int local13 = 0; local13 < local11; local13++) {
			this.aClass544Array1[local13].method30949(944517978);
		}
	}

	@OriginalMember(owner = "client!sj", name = "en", descriptor = "(Lclient!yf;I)V", line = 5838)
	static final void method31045(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1240682464);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class644.method32601(local16, local22, arg0, (byte) -32);
	}

	@OriginalMember(owner = "client!sj", name = "hm", descriptor = "(Lclient!ahm;IB)V", line = 4175)
	static void method31046(@OriginalArg(0) Class132_Sub1_Sub1_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		if (arg0.anIntArray236 == null) {
			return;
		}
		@Pc(9) Class707 local9 = (Class707) Class107.method18119(Class707.method36745(1800155645), arg1, -1915563430);
		@Pc(16) int local16 = arg0.anIntArray236[local9.method36750((byte) -92)];
		if (local16 != arg0.aClass19_3.method23554((byte) 124)) {
			arg0.aClass19_3.method23556(local16, arg0.aClass19_3.method23604((short) -20791), -849002901);
			arg0.anInt2760 = arg0.anInt2763 * 609116505;
		}
	}

	@OriginalMember(owner = "client!sj", name = "n", descriptor = "(Lclient!ase;II)V", line = 91)
	static final void method31047(@OriginalArg(0) Class93_Sub41_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	static void method31048(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
