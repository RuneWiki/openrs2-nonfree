...
public class Class132_Sub1_Sub2_Sub2 extends Class132_Sub1_Sub2 implements Interface61 {
	...
	boolean method24290(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(4) Class610 local4 = this.aClass558_2.method31071((short) 16754);
		if (local4.aClass463_2 == null) {
			@Pc(26) Class109 local26 = this.aClass558_2.method31072(arg0, 131072, false, false, -986145784);
			return local26 == null ? false : local26.method6859(arg1, arg2, this.method24226(), false, 0);
		} else {
			return arg0.method20490(arg1, arg2, this.method24226(), local4.aClass463_2, -1294804070);
		}
	}
	...
	public void method13402(@OriginalArg(0) Class104 arg0) {
		this.aClass558_2.method31076(arg0, (byte) -54);
	}
	...
	public void method12446(@OriginalArg(0) Class620 arg0, @OriginalArg(1) int arg1) {
		this.aClass558_2.method31099(arg0, -1302764671);
	}
	...
	Class573 method24271(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class109 local8 = this.aClass558_2.method31072(arg0, 2048, false, true, -645408041);
		if (local8 == null) {
			return null;
		}
		@Pc(15) Class470 local15 = this.method24226();
		@Pc(18) Class458 local18 = this.method24229();
		@Pc(23) Class573 local23 = Class125_Sub1.method9214(this.aBoolean288, 373147274);
		@Pc(30) int local30 = (int) local18.aClass472_61.aFloat317 >> 9;
		@Pc(37) int local37 = (int) local18.aClass472_61.aFloat319 >> 9;
		this.aClass558_2.method31073(arg0, local8, local15, local30, local30, local37, local37, true, (byte) 67);
		@Pc(54) Class610 local54 = this.aClass558_2.method31071((short) 8505);
		if (local54.aClass463_2 == null) {
			local8.method6947(local15, this.aClass241Array21[0], 0);
		} else {
			local8.method6947(local15, (Class241) null, 0);
			arg0.method20492(local15, this.aClass241Array21[0], local54.aClass463_2);
		}
		if (this.aClass558_2.aClass674_7 != null) {
			@Pc(90) Class229 local90 = this.aClass558_2.aClass674_7.method33127();
			arg0.method20497(local90);
		}
		this.aBoolean289 = local8.method6865() || this.aClass558_2.aClass674_7 != null;
		if (this.aClass600_3 == null) {
			this.aClass600_3 = Class62.method1154((int) local18.aClass472_61.aFloat317, (int) local18.aClass472_61.aFloat318, (int) local18.aClass472_61.aFloat319, local8, 1727024172);
		} else {
	...
	void method24267(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class109 local8 = this.aClass558_2.method31072(arg0, 262144, true, true, -1045119152);
		if (local8 == null) {
			return;
		}
		...
		this.aClass558_2.method31073(arg0, local8, local13, local23, local23, local30, local30, false, (byte) 53);
	}
	...
	public void method13417(@OriginalArg(0) Class104 arg0, @OriginalArg(1) byte arg1) {
		this.aClass558_2.method31075(arg0, -1497248091);
	}
	...
	public void method13422(@OriginalArg(0) Class104 arg0) {
		this.aClass558_2.method31076(arg0, (byte) 16);
	}
	...
	Class573 method24266(@OriginalArg(0) Class104 arg0) {
		@Pc(8) Class109 local8 = this.aClass558_2.method31072(arg0, 2048, false, true, -1890050058);
		if (local8 == null) {
			return null;
		}
		@Pc(15) Class470 local15 = this.method24226();
		...
		@Pc(30) int local30 = (int) local18.aClass472_61.aFloat317 >> 9;
		@Pc(37) int local37 = (int) local18.aClass472_61.aFloat319 >> 9;
		this.aClass558_2.method31073(arg0, local8, local15, local30, local30, local37, local37, true, (byte) 14);
		@Pc(54) Class610 local54 = this.aClass558_2.method31071((short) -12929);
		if (local54.aClass463_2 == null) {
			local8.method6947(local15, this.aClass241Array21[0], 0);
		} else {
			local8.method6947(local15, (Class241) null, 0);
		...
		this.aBoolean289 = local8.method6865() || this.aClass558_2.aClass674_7 != null;
		if (this.aClass600_3 == null) {
			this.aClass600_3 = Class62.method1154((int) local18.aClass472_61.aFloat317, (int) local18.aClass472_61.aFloat318, (int) local18.aClass472_61.aFloat319, local8, 2137785510);
		} else {
	...
	boolean method24259(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		@Pc(4) Class610 local4 = this.aClass558_2.method31071((short) 10039);
		if (local4.aClass463_2 == null) {
			@Pc(26) Class109 local26 = this.aClass558_2.method31072(arg0, 131072, false, false, -1230304468);
			return local26 == null ? false : local26.method6859(arg1, arg2, this.method24226(), false, 0);
		} else {
			return arg0.method20490(arg1, arg2, this.method24226(), local4.aClass463_2, -1648189737);
		}
	}
	...
	public void method12447(@OriginalArg(0) Class620 arg0) {
		this.aClass558_2.method31099(arg0, -760821712);
	}
	...
	public void method13424(@OriginalArg(0) Class104 arg0) {
		this.aClass558_2.method31076(arg0, (byte) 89);
	}
	...
	public Class132_Sub1_Sub2_Sub2(@OriginalArg(0) Class585 arg0, @OriginalArg(1) Class104 arg1, @OriginalArg(2) Class32_Sub14 arg2, @OriginalArg(3) Class610 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) boolean arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) Class458 arg14) {
		super(arg0, arg6, arg7, arg8, arg4, arg5, Class664.method32884(arg10, arg11, -1256918501), arg14);
	...
	public int method24282() {
		return this.aClass558_2.method31096(1662302312);
	}
	...
	void method24294(@OriginalArg(0) Class104 arg0) {
		@Pc(8) Class109 local8 = this.aClass558_2.method31072(arg0, 262144, true, true, -98480076);
		if (local8 == null) {
			return;
		}
		@Pc(13) Class470 local13 = this.method24226();
		...
		@Pc(23) int local23 = (int) local16.aClass472_61.aFloat317 >> 9;
		@Pc(30) int local30 = (int) local16.aClass472_61.aFloat319 >> 9;
		this.aClass558_2.method31073(arg0, local8, local13, local23, local23, local30, local30, false, (byte) 66);
	}

	@OriginalMember(owner = "client!ajj", name = "fe", descriptor = "(Lclient!dh;)V", line = 90)
	@Override
	void method24303(@OriginalArg(0) Class104 arg0) {
		@Pc(8) Class109 local8 = this.aClass558_2.method31072(arg0, 262144, true, true, -1272450186);
		if (local8 == null) {
			return;
		}
		@Pc(13) Class470 local13 = this.method24226();
		...
		@Pc(23) int local23 = (int) local16.aClass472_61.aFloat317 >> 9;
		@Pc(30) int local30 = (int) local16.aClass472_61.aFloat319 >> 9;
		this.aClass558_2.method31073(arg0, local8, local13, local23, local23, local30, local30, false, (byte) 81);
	}
	...
	public boolean method13406(@OriginalArg(0) int arg0) {
		return this.aClass558_2.method31074((byte) 116);
	}
	...
	public void method12448(@OriginalArg(0) Class620 arg0) {
		this.aClass558_2.method31099(arg0, -2083512954);
	}
	...
	public void method12450(@OriginalArg(0) Class620 arg0) {
		this.aClass558_2.method31099(arg0, 1664798441);
	}
