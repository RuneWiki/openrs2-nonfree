...
public abstract class Class129 {
	...
	abstract void method21470(@OriginalArg(0) Graphics arg0);

	@OriginalMember(owner = "client!jq", name = "e", descriptor = "(Ljava/awt/Graphics;B)V")
	abstract void method21471(@OriginalArg(0) Graphics arg0, @OriginalArg(1) byte arg1);

	@OriginalMember(owner = "client!jq", name = "n", descriptor = "(Ljava/awt/Graphics;)V")
	abstract void method21472(@OriginalArg(0) Graphics arg0);

	@OriginalMember(owner = "client!jq", name = "w", descriptor = "(Ljava/awt/Graphics;)V")
	abstract void method21473(@OriginalArg(0) Graphics arg0);

	@OriginalMember(owner = "client!jq", name = "k", descriptor = "(Ljava/awt/Graphics;)V")
	abstract void method21474(@OriginalArg(0) Graphics arg0);
	...
	static final void method21476(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) byte arg3) {
	...
	static final void method21477(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method21478(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
	...
	public static void method21479(@OriginalArg(0) Class54_Sub1 arg0, @OriginalArg(1) byte arg1) {
		Class370.method27995(arg0, -1826400890);
	}

	@OriginalMember(owner = "client!jq", name = "ne", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;B)V", line = 7337)
	static final void method21480(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) byte arg3) {
		...
		arg0.anObjectArray26 = Class499.method30148(local13, arg2, -660401871);
