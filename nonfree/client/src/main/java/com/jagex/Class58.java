...
public class Class58 {
	...
	public Class93_Sub1_Sub18 method1092(@OriginalArg(0) int arg0) {
		...
		@Pc(22) byte[] local22;
		if (arg0 >= 32768) {
			local22 = this.aClass497_9.method30044(1, arg0 & 0x7FFF, (byte) 0);
		} else {
			local22 = this.aClass497_10.method30044(1, arg0, (byte) 0);
		}
		local6 = new Class93_Sub1_Sub18();
		local6.aClass58_1 = this;
		if (local22 != null) {
			local6.method22939(new Class93_Sub41(local22), 1189701933);
		}
		if (arg0 >= 32768) {
			local6.method22924((byte) 46);
		}
	...
	public Class58(@OriginalArg(0) Class717 arg0, @OriginalArg(1) Class497 arg1, @OriginalArg(2) Class497 arg2, @OriginalArg(3) Interface72 arg3) {
		...
		if (this.aClass497_10 != null) {
			this.anInt226 = this.aClass497_10.method30062(1, 604609588) * -44765849;
		}
		if (this.aClass497_9 != null) {
			this.anInt227 = this.aClass497_9.method30062(1, 716796422) * -1847166895;
		}
	}
	...
	public static int method1100(@OriginalArg(0) Random arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if (arg1 <= 0) {
		...
		} else if (Class364.method27900(arg1, -2049762220)) {
			...
			return Class580.method31387(local60, arg1, (byte) -51);
		}
	}

	@OriginalMember(owner = "client!ach", name = "auh", descriptor = "(Lclient!yf;B)V", line = 13413)
	static final void method1101(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub35_5.method16223(288048339);
	}
	...
	static final void method1103(@OriginalArg(0) Class132_Sub1_Sub1_Sub1 arg0, @OriginalArg(1) int arg1) {
		@Pc(2) Class19_Sub3 local2 = arg0.aClass19_Sub3_3;
		if (local2.method23552(-1698628681) && local2.method23573(1, 1931530995) && local2.method23581(-1228609165)) {
			if (local2.aBoolean379) {
				local2.method23558(arg0.method19966(690430450).method32134(1558609568), false, true, (byte) 104);
				local2.aBoolean379 = local2.method23552(1084107836);
			}
			local2.method23570(2047917235);
		}
		for (@Pc(38) int local38 = 0; local38 < arg0.aClass554Array3.length; local38++) {
			if (arg0.aClass554Array3[local38].anInt5319 * 601549465 != -1) {
				...
				if (local58.method23561((byte) 0)) {
					...
					@Pc(78) Class263 local78 = local58.method23553(34907548);
					if (local74.aBoolean881) {
						if (local78.anInt3867 * -2017474589 == 3) {
							if (arg0.anInt2760 * -215928493 > 0 && arg0.anInt2780 * -2095106181 <= client.anInt3485 && arg0.anInt2762 * -1538623211 < client.anInt3485) {
								local58.method23568(-1, 341782871);
				...
				if (local58.method23573(1, 1828525999) && local58.method23581(-1228609165)) {
					local58.method23568(-1, -43548635);
					arg0.aClass554Array3[local38].anInt5319 = 1020147287;
				}
			}
		}
		@Pc(163) Class19 local163 = arg0.aClass19_3;
		if (local163.method23552(1805634571)) {
			label84: {
				@Pc(171) Class263 local171 = local163.method23553(1749416823);
				if (local171.anInt3867 * -2017474589 == 3) {
					if (arg0.anInt2760 * -215928493 > 0 && arg0.anInt2780 * -2095106181 <= client.anInt3485 && arg0.anInt2762 * -1538623211 < client.anInt3485) {
						arg0.anIntArray236 = null;
						local163.method23568(-1, 667180543);
						break label84;
					}
				} else if (local171.anInt3867 * -2017474589 == 1) {
					if (arg0.anInt2760 * -215928493 > 0 && arg0.anInt2780 * -2095106181 <= client.anInt3485 && arg0.anInt2762 * -1538623211 < client.anInt3485) {
						local163.method23563(1, (byte) 2);
						break label84;
					}
					local163.method23563(0, (byte) 2);
				}
				if (local163.method23573(1, 1589306671) && local163.method23581(-1228609165)) {
					arg0.anIntArray236 = null;
					local163.method23568(-1, 1460087915);
				}
			}
		}
		for (@Pc(252) int local252 = 0; local252 < arg0.aClass19_Sub1_Sub1Array3.length; local252++) {
			...
			if (local262 != null) {
				...
				} else if (local262.method23573(1, -864576594) && local262.method23581(-1228609165)) {
