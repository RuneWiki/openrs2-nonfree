...
public class Class688 implements Interface13, Interface5 {
	...
	void method36514(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt5914 = Class596.method31761(arg0.method22417()) * 381855547;
		} else if (arg1 == 2) {
			this.anInt5915 = arg0.method22413() * 462296013;
		} else if (arg1 == 3) {
			this.anInt5915 = arg0.method22415() * 462296013;
			...
			this.anInt5916 = Class596.method31761(arg0.method22417()) * 690404605;
		} else if (arg1 != 8) {
			if (arg1 == 9) {
				this.anInt5920 = (arg0.method22415() << 2) * -385517409;
			} else if (arg1 == 10) {
				this.aBoolean880 = false;
			} else if (arg1 == 11) {
				this.anInt5919 = arg0.method22413() * 1312159921;
			} else if (arg1 == 12) {
				this.aBoolean879 = true;
			} else if (arg1 == 13) {
				this.anInt5917 = arg0.method22417() * 1411996013;
			} else if (arg1 == 14) {
				this.anInt5918 = (arg0.method22413() << 2) * -2115298315;
			} else if (arg1 == 16) {
				this.anInt5921 = arg0.method22413() * -254619793;
			} else if (arg1 == 20) {
				this.anInt5922 = arg0.method22415() * -1979108485;
			} else if (arg1 == 21) {
				this.anInt5923 = arg0.method22413() * 812149361;
			} else if (arg1 == 22) {
				this.anInt5924 = arg0.method22415() * -1842172205;
			}
		}
	}
	...
	static final void method36521(@OriginalArg(0) int arg0) {
		@Pc(5) int local5 = client.anInt3485 - client.anInt3483 * -1638909865;
		if (local5 >= 100) {
			Class429.anInt4781 = Class20.method376() * -1279696551;
		...
		@Pc(188) int local188;
		if (Class20.method376() == 3) {
			@Pc(45) Class93_Sub30 local45 = Class65.aClass123_Sub1_2.method8952().method21404();
			@Pc(49) Class611 local49 = client.aClass532_1.method30443();
			...
			client.anInt3571 = (int) ((float) (Class627.anInt5706 * -103954239) + (float) ((int) ((double) (client.anInt3569 * -1968459517) / (Math.tan((double) (Class65.aClass123_Sub1_2.method9027() / 2.0F)) * 4.0D)) - Class627.anInt5706 * -103954239) * local35) * 1984904847;
			...
			Class716.method36876(Class72.anInt241 * -1022856553, Class305.method26801((int) local244.aFloat317, (int) local244.aFloat319, Class512.anInt5209 * 1177442423) - client.anInt3484 * 1974760385, Class441.anInt4886 * -953396699, local201, local240, (local201 >> 3) * 3 + 600 << 2, arg0);
	...
	static final void method36520(@OriginalArg(0) Class132_Sub1 arg0, @OriginalArg(1) Class681 arg1) {
