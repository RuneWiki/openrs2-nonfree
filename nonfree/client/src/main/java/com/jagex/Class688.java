...
public class Class688 implements Interface13, Interface5 {
	...
	void method36514(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg1 == 1) {
			this.anInt5914 = Class596.method31761(arg0.method22417((short) -17573), 438047981) * 381855547;
		} else if (arg1 == 2) {
			this.anInt5915 = arg0.method22413((short) 16384) * 462296013;
		} else if (arg1 == 3) {
			this.anInt5915 = arg0.method22415(-1434290800) * 462296013;
			...
			this.anInt5916 = Class596.method31761(arg0.method22417((short) -22795), -1198838908) * 690404605;
		} else if (arg1 != 8) {
			if (arg1 == 9) {
				this.anInt5920 = (arg0.method22415(-1434290800) << 2) * -385517409;
			} else if (arg1 == 10) {
				this.aBoolean880 = false;
			} else if (arg1 == 11) {
				this.anInt5919 = arg0.method22413((short) 16384) * 1312159921;
			} else if (arg1 == 12) {
				this.aBoolean879 = true;
			} else if (arg1 == 13) {
				this.anInt5917 = arg0.method22417((short) 1535) * 1411996013;
			} else if (arg1 == 14) {
				this.anInt5918 = (arg0.method22413((short) 16384) << 2) * -2115298315;
			} else if (arg1 == 16) {
				this.anInt5921 = arg0.method22413((short) 16384) * -254619793;
			} else if (arg1 == 20) {
				this.anInt5922 = arg0.method22415(-1434290800) * -1979108485;
			} else if (arg1 == 21) {
				this.anInt5923 = arg0.method22413((short) 16384) * 812149361;
			} else if (arg1 == 22) {
				this.anInt5924 = arg0.method22415(-1434290800) * -1842172205;
			}
		}
	}
	...
	void method36515(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt5914 = Class596.method31761(arg0.method22417((short) 355), -1259307527) * 381855547;
		} else if (arg1 == 2) {
			this.anInt5915 = arg0.method22413((short) 16384) * 462296013;
		} else if (arg1 == 3) {
			this.anInt5915 = arg0.method22415(-1434290800) * 462296013;
			...
			this.anInt5916 = Class596.method31761(arg0.method22417((short) 14855), -1126559479) * 690404605;
		} else if (arg1 != 8) {
			if (arg1 == 9) {
				this.anInt5920 = (arg0.method22415(-1434290800) << 2) * -385517409;
			} else if (arg1 == 10) {
				...
				this.anInt5917 = arg0.method22417((short) 8261) * 1411996013;
			} else if (arg1 == 14) {
				this.anInt5918 = (arg0.method22413((short) 16384) << 2) * -2115298315;
			} else if (arg1 == 16) {
				this.anInt5921 = arg0.method22413((short) 16384) * -254619793;
	...
	void method36516(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt5914 = Class596.method31761(arg0.method22417((short) 8249), -953503906) * 381855547;
		} else if (arg1 == 2) {
			this.anInt5915 = arg0.method22413((short) 16384) * 462296013;
		} else if (arg1 == 3) {
			this.anInt5915 = arg0.method22415(-1434290800) * 462296013;
			...
			this.anInt5916 = Class596.method31761(arg0.method22417((short) 11633), -1281320112) * 690404605;
		} else if (arg1 != 8) {
			if (arg1 == 9) {
				this.anInt5920 = (arg0.method22415(-1434290800) << 2) * -385517409;
			} else if (arg1 == 10) {
				...
				this.anInt5917 = arg0.method22417((short) 7118) * 1411996013;
			} else if (arg1 == 14) {
				this.anInt5918 = (arg0.method22413((short) 16384) << 2) * -2115298315;
			} else if (arg1 == 16) {
				this.anInt5921 = arg0.method22413((short) 16384) * -254619793;
	...
	void method36517(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt5914 = Class596.method31761(arg0.method22417((short) -10155), -1397523664) * 381855547;
		} else if (arg1 == 2) {
			this.anInt5915 = arg0.method22413((short) 16384) * 462296013;
		} else if (arg1 == 3) {
			this.anInt5915 = arg0.method22415(-1434290800) * 462296013;
			...
			this.anInt5916 = Class596.method31761(arg0.method22417((short) 16547), 1023455760) * 690404605;
		} else if (arg1 != 8) {
			if (arg1 == 9) {
				this.anInt5920 = (arg0.method22415(-1434290800) << 2) * -385517409;
			} else if (arg1 == 10) {
				...
				this.anInt5917 = arg0.method22417((short) -269) * 1411996013;
			} else if (arg1 == 14) {
				this.anInt5918 = (arg0.method22413((short) 16384) << 2) * -2115298315;
			} else if (arg1 == 16) {
				this.anInt5921 = arg0.method22413((short) 16384) * -254619793;
	...
	static int method36518(@OriginalArg(0) int arg0) {
		return arg0 == 16711935 ? -1 : Class682.method33276(arg0, -1675598323);
	}

	@OriginalMember(owner = "client!yn", name = "s", descriptor = "(I)I", line = 66)
	static int method36519(@OriginalArg(0) int arg0) {
		return arg0 == 16711935 ? -1 : Class682.method33276(arg0, -1967555660);
	}
	...
	static final void method36520(@OriginalArg(0) Class132_Sub1 arg0, @OriginalArg(1) Class681 arg1, @OriginalArg(2) int arg2) {
	...
	static final void method36521(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (Class20.method376(2013206566) == 3) {
			@Pc(45) Class93_Sub30 local45 = Class65.aClass123_Sub1_2.method8952((byte) -76).method21404((byte) 42);
			@Pc(49) Class611 local49 = client.aClass532_1.method30443(1876469160);
			Class620.anInt5644 = ((int) ((double) Class65.aClass123_Sub1_2.method8961((byte) 122) * 2607.5945876176133D) & 0x3FFF) * -1151839067;
			...
			client.anInt3571 = (int) ((float) (Class627.anInt5706 * -103954239) + (float) ((int) ((double) (client.anInt3569 * -1968459517) / (Math.tan((double) (Class65.aClass123_Sub1_2.method9027(-1674847276) / 2.0F)) * 4.0D)) - Class627.anInt5706 * -103954239) * local35) * 1984904847;
			...
			@Pc(244) Class472 local244 = Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.method24229().aClass472_61;
			Class716.method36876(Class72.anInt241 * -1022856553, Class305.method26801((int) local244.aFloat317, (int) local244.aFloat319, Class512.anInt5209 * 1177442423, (byte) -78) - client.anInt3484 * 1974760385, Class441.anInt4886 * -953396699, local201, local240, (local201 >> 3) * 3 + 600 << 2, arg0, (byte) -12);
