...
class Class581 implements Comparator {
	...
	public int method31391(@OriginalArg(0) Object arg0, @OriginalArg(1) Object arg1) {
		return this.method31394((Class535) arg0, (Class535) arg1, 1270196902);
	}
	...
	public int compare(@OriginalArg(0) Object arg0, @OriginalArg(1) Object arg1) {
		return this.method31394((Class535) arg0, (Class535) arg1, 2029148113);
	}
	...
	int method31394(@OriginalArg(0) Class535 arg0, @OriginalArg(1) Class535 arg1, @OriginalArg(2) int arg2) {
		@Pc(3) float local3 = arg0.method30682(994722973);
		@Pc(7) float local7 = arg1.method30682(591153586);
		if (local7 > local3) {
			return 1;
	...
	int method31396(@OriginalArg(0) Class535 arg0, @OriginalArg(1) Class535 arg1) {
		@Pc(3) float local3 = arg0.method30682(-1838276395);
		@Pc(7) float local7 = arg1.method30682(419896320);
		if (local7 > local3) {
			return 1;
		} else if (local7 < local3) {
			return -1;
	...
	static final void method31397(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		if (Class65.aClass123_Sub1_2.method8986((byte) -7) != Class338.aClass338_7) {
			throw new RuntimeException();
		}
		((Class25_Sub1) Class65.aClass123_Sub1_2.method9040(1735468072)).method15965(arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091], (byte) -5);
	}

	@OriginalMember(owner = "client!tt", name = "n", descriptor = "(II)V", line = 46)
	static void method31398(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		Class173.anInt3254 = arg0 * -484055331;
		Class173.aClass240_64.method25833((byte) -74);
	}

	@OriginalMember(owner = "client!tt", name = "f", descriptor = "(II)Lclient!cr;", line = 89)
	static Class211 method31399(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
