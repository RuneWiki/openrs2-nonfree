...
public class Class389 implements Interface33 {
	...
	public void method28283() {
		this.aClass100_43 = Class219.method25509(this.aClass497_113, this.aClass398_1.anInt4672 * 1316736809, (byte) 91);
	}

	@OriginalMember(owner = "client!ku", name = "e", descriptor = "(I)V", line = 21)
	@Override
	public void method28280(@OriginalArg(0) int arg0) {
		this.aClass100_43 = Class219.method25509(this.aClass497_113, this.aClass398_1.anInt4672 * 1316736809, (byte) 90);
	}
	...
	public void method28281(@OriginalArg(0) boolean arg0) {
		...
		@Pc(39) int local39 = this.aClass100_43.method18166();
		@Pc(41) int local41 = 0;
		...
		this.aClass100_43.method18203(local41, local55, local43, local49);
	}
	...
	public boolean method28279(@OriginalArg(0) int arg0) {
		return this.aClass497_113.method30054(this.aClass398_1.anInt4672 * 1316736809, -512225963);
	}

	@OriginalMember(owner = "client!ku", name = "l", descriptor = "()V", line = 21)
	@Override
	public void method28284() {
		this.aClass100_43 = Class219.method25509(this.aClass497_113, this.aClass398_1.anInt4672 * 1316736809, (byte) 121);
	}
	...
	public static void method28263(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		Class370.method27995(new Class53_Sub1(arg0, arg1, arg2, client.anInt3451 * 555943359, Class520.aClass144_3.anInt1338 * 1582435851, Class520.aClass144_3.anInt1337 * 446642039, Class520.aClass144_3.method11146(-1999613021), Class520.aClass144_3.method11162(-771229500), Class477.aClass480_2.method29734(-385607886)), -2031366575);
	}

	@OriginalMember(owner = "client!ku", name = "ly", descriptor = "(Lclient!yf;B)V", line = 7073)
	static final void method28264(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 55046256);
		Class314.method26937(local16, arg0, -412761498);
	}

	@OriginalMember(owner = "client!ku", name = "amz", descriptor = "(Lclient!yf;I)V", line = 12096)
	static final void method28265(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		Class119.method8603(-1311816136);
	}

	@OriginalMember(owner = "client!ku", name = "ac", descriptor = "(B)V", line = 934)
	public static void method28266(@OriginalArg(0) byte arg0) {
		Class531.method30435(273005801);
	}

	@OriginalMember(owner = "client!ku", name = "k", descriptor = "(Lclient!alw;I)Lclient!kp;", line = 16)
	public static Class125 method28267(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class125 local3 = Class32_Sub4.method16727(arg0, -423624971);
		@Pc(7) int local7 = arg0.method22419(-118643075);
		@Pc(11) int local11 = arg0.method22419(-118643075);
		@Pc(15) int local15 = arg0.method22436(-1258003561);
	...
	static final void method28268(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static void method28269(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		Class93_Sub6.anInt1444 = arg0 * -2047869623;
		Class93_Sub6.aClass240_19.method25833((byte) -82);
	}

	@OriginalMember(owner = "client!ku", name = "qm", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;I)V", line = 7976)
	static final void method28270(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		arg0.anObjectArray8 = Class499.method30148(local13, arg2, 2023375430);
		arg0.aBoolean680 = true;
	}

	@OriginalMember(owner = "client!ku", name = "afc", descriptor = "(Lclient!yf;B)V", line = 10519)
	static final void method28271(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anInt5888 -= 1915061582;
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class488.method29821((String) arg0.anObjectArray45[arg0.anInt5888 * 587908375], (String) arg0.anObjectArray45[arg0.anInt5888 * 587908375 + 1], Class106.aClass717_8, -1678452234);
	}

	@OriginalMember(owner = "client!ku", name = "b", descriptor = "(IB)Ljava/lang/String;", line = 623)
	static String method28272(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
