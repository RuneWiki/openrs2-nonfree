...
public class Class104_Sub1 extends Class104 {
	...
	long method3760(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3) {
		if (!this.aBoolean96) {
			...
			this.method20441(this.aClass112_Sub1_1, (byte) 1);
			...
			this.method20442(this.aClass112_Sub1_1, -1497248091);
			return 0L;
		}
	...
	void method20481(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if ((float) local63 < this.aFloat48) {
			...
			local132 = Class278.method26365(local132, 423254006);
	...
	public Class100 method20499(@OriginalArg(0) Class105 arg0, @OriginalArg(1) boolean arg1) {
		...
		@Pc(15) Class100 local15 = this.method20498(local3, 0, arg0.method7206(), arg0.method7206(), arg0.method7198(), 438797212);
	...
	Class104_Sub1(@OriginalArg(0) Canvas arg0, @OriginalArg(1) Class225 arg1, @OriginalArg(2) Interface24 arg2, @OriginalArg(3) Interface48 arg3, @OriginalArg(4) Interface46 arg4, @OriginalArg(5) Interface47 arg5, @OriginalArg(6) int arg6) {
		...
		try {
			try {
				...
				this.anUnsafe1 = (Unsafe) local304.get((Object) null);
			} catch (@Pc(315) Exception local315) {
			}
			this.anInt566 = arg6;
			Class376.method28046(672839876).method31617("jaclib", (byte) -77);
			Class376.method28046(672839876).method31617("jaggl", (byte) 4);
			...
			if (this.aBoolean107 || local467) {
				@Pc(487) String[] local487 = client.method25402(this.aString22.replace('/', ' '), ' ', 1507834600);
			...
			Class660.method32825(false, true, 2109210722);
			...
			this.method20437(arg0, new Class112_Sub2_Sub3(this, arg0, local345), (byte) 0);
	...
	void method3769() {
		...
		for (local1 = 0; local1 < this.anInt540; local1++) {
			...
			aFloatArray10[0] = (float) local10.method13520(542004574);
			aFloatArray10[1] = (float) local10.method13521(1655674161);
			aFloatArray10[2] = (float) local10.method13522(161210452);
	...
	public long method20457(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.method3760(arg0, arg1, (int[]) null, (int[]) null);
	}
	...
	public final synchronized void method20419(@OriginalArg(0) int arg0) {
		...
		if (this.method20819() > 100663296 && Class305.method26796(820112033) > this.aLong24 + 60000L) {
			System.gc();
			this.aLong24 = Class305.method26796(957675934);
		}
	...
	public final synchronized void method20561(@OriginalArg(0) int arg0) {
		...
		this.aClass201_1.method24637();
		if (this.method20819() > 100663296 && Class305.method26796(-276400607) > this.aLong24 + 60000L) {
			System.gc();
			this.aLong24 = Class305.method26796(2138243042);
		}
		this.anInt530 = local5;
	}
	...
	public void method20612(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		OpenGL.glReadPixelsub(0, 0, this.anInt2900 * 106932625, this.anInt2882 * -28194907, 32993, 5121, (byte[]) null, 0);
		OpenGL.glBindBufferARB(35051, 0);
		this.method20442(this.aClass112_Sub1_1, -1497248091);
	...
	int method3861() {
		...
		@Pc(48) String[] local48 = client.method25402(local40.replace('.', ' '), ' ', 1791622707);
		if (local48.length >= 2) {
			try {
	...
	int method3888() {
		...
		@Pc(40) String local40 = OpenGL.glGetString(7938);
		@Pc(48) String[] local48 = client.method25402(local40.replace('.', ' '), ' ', 1590325042);
		if (local48.length >= 2) {
			try {
				@Pc(58) int local58 = Class616.method32090(local48[0], (byte) 8);
				@Pc(64) int local64 = Class616.method32090(local48[1], (byte) 8);
