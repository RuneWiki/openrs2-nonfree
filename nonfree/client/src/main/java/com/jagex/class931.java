...
public class class931 extends class366 {
	...
	public class931(class656 arg0) {
		...
		while (var4.hasNext()) {
			...
			class480[] var6 = (class480[]) (class480[]) this.field10679.get(var5);
	...
	public void method5874() {
		...
		while (true) {
			...
			do {
				...
				var3 = (class480[]) (class480[]) this.field10679.get(var2);
				if (!var2.field4856) {
					boolean var4 = false;
	...
	public class480 method5865(class473 arg0) {
		...
		synchronized (this.field10679) {
			class480[] var3 = (class480[]) (class480[]) this.field10679.get(arg0);
			if (var3 == null) {
				return null;
			}
	...
	public void method5868() {
		...
		synchronized (var1) {
			...
			while (var3.hasNext()) {
				...
				class480[] var5 = (class480[]) (class480[]) var1.get(var4);
		...
		while (!var8) {
			...
			synchronized (var1) {
				...
				while (var10.hasNext()) {
					...
					class480[] var12 = (class480[]) (class480[]) var1.get(var11);
