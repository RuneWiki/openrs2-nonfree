...
public class Class356 implements Interface4 {
	...
	static final void method27706(@OriginalArg(0) int arg0) {
		...
		if (local18 != null) {
			local9 = local18.method22873(-1678286317);
			local13 = local18.method22874((byte) -117);
		}
		...
		Class550.method31032((Class93_Sub40) null, client.anInt3526 * -703563959, 0, 0, client.anInt3408 * -1378711501, client.anInt3416 * 2091353777, 0, 0, local9, local13, 1276438620);
		if (Class378.aClass312_10 != null) {
			Class169.method18344(local9, local13, (byte) 13);
		}
	}
	...
	static final void method27707(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1444193686);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class286.method26537(local16, local22, arg0, (byte) 0);
	}

	@OriginalMember(owner = "client!ja", name = "h", descriptor = "(Lclient!dh;IIB)V", line = 587)
	static void method27708(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		if (arg1 < 0 || arg2 < 0 || Class454.aClass489_97 == null) {
			return;
		}
		@Pc(10) Class611 local10 = client.aClass532_1.method30443(1734040433);
		@Pc(13) Class489 local13 = arg0.method20507();
		Class448.method28919(arg0, -65432338);
		...
		if (client.aClass532_1.method30459(-944469908) == null) {
			return;
		}
		@Pc(52) int local52;
		@Pc(165) int local165;
		...
		if (!client.aBoolean625 || (Class253.anInt3851 * 735260021 & 0x40) != 0) {
			...
			if (local146 > 0.0F) {
				...
				local50 = local165 + (Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.method19997(1810294225) - 1 << 8) >> 9;
				local52 = local172 + (Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.method19997(1197289251) - 1 << 8) >> 9;
				@Pc(199) byte local199 = Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aByte100;
				if (local199 < 3 && (client.aClass532_1.method30509(53537281).aByteArrayArrayArray12[1][local165 >> 9][local172 >> 9] & 0x2) != 0) {
					local220 = local199 + 1;
				}
			}
			if (local50 != -1 && local52 != -1) {
				if (client.aBoolean625 && (Class253.anInt3851 * 735260021 & 0x40) != 0) {
					...
					if (local244 == null) {
						...
						Class280.method26458(client.aString145, " " + Class430.aString206 + " ", Class271.anInt3885 * -308125347, 59, -1, 0L, local50, local52, true, false, (long) (local50 << 0 | local52), true, (byte) -91);
					}
				} else {
					if (Class620.aBoolean843) {
						Class280.method26458(Class74.aClass74_134.method1259(Class106.aClass717_8, (byte) 40), "", -1, 60, -1, 0L, local50, local52, true, false, (long) (local50 << 0 | local52), true, (byte) -65);
					}
					Class280.method26458(Class511.aString220, "", client.anInt3518 * -2102645197, 23, -1, 0L, local50, local52, true, false, (long) (local50 << 0 | local52), true, (byte) -67);
				}
			}
		}
		@Pc(331) Class569 local331 = client.aClass532_1.method30459(-1986714007).aClass569_2;
		local52 = arg1;
		...
		while (true) {
			...
			do {
				...
				do {
					do {
						do {
							...
							while (true) {
								...
								while (true) {
									...
									} while (!local348.method31337(arg0, local52, local335, -2023671172));
									...
									var40 = local409.method19997(-1710213319);
									...
									if ((var40 & 0x1) == 0 && ((int) local417.aFloat317 & 0x1FF) == 0 && ((int) local417.aFloat319 & 0x1FF) == 0 || (var40 & 0x1) == 1 && ((int) local417.aFloat317 & 0x1FF) == 256 && ((int) local417.aFloat319 & 0x1FF) == 256) {
										local467 = (int) local417.aFloat317 - (local409.method19997(1116519041) - 1 << 8);
										var52 = (int) local417.aFloat319 - (local409.method19997(-361428485) - 1 << 8);
										for (local165 = 0; local165 < client.anInt3540 * 568731113; local165++) {
											...
											if (local494 != null) {
												...
												if (client.anInt3485 != local501.anInt2765 * -1318108809 && local501.aBoolean453) {
													var24 = local501.method24229().aClass472_61;
													...
													if (var25 >= local467 && local501.aClass336_1.anInt4154 * 447008399 <= local409.method19997(288757668) - (var25 - local467 >> 9) && var26 >= var52 && local501.aClass336_1.anInt4154 * 447008399 <= local409.method19997(358324131) - (var26 - var52 >> 9)) {
														Class660.method32821(local501, local348.aClass132_Sub1_25.aByte100 != Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aByte100, 396868177);
										...
										for (local220 = 0; local220 < local165; local220++) {
											...
											if (local615 != null && client.anInt3485 != local615.anInt2765 * -1318108809 && local615 != local409 && local615.aBoolean453) {
												...
												var26 = (int) local635.aFloat317 - (local615.method19997(-1113927820) - 1 << 8);
												var27 = (int) local635.aFloat319 - (local615.method19997(-756202682) - 1 << 8);
												if (var26 >= local467 && local615.method19997(1881095119) <= local409.method19997(-1708335614) - (var26 - local467 >> 9) && var27 >= var52 && local615.method19997(1537105344) <= local409.method19997(-164832952) - (var27 - var52 >> 9)) {
								...
								if ((local742.aClass336_1.anInt4154 * 447008399 & 0x1) == 0 && ((int) local750.aFloat317 & 0x1FF) == 0 && ((int) local750.aFloat319 & 0x1FF) == 0 || (local742.aClass336_1.anInt4154 * 447008399 & 0x1) == 1 && ((int) local750.aFloat317 & 0x1FF) == 256 && ((int) local750.aFloat319 & 0x1FF) == 256) {
										...
										if (local837 != null) {
											...
											if (client.anInt3485 != local845.anInt2765 * -1318108809 && local742 != local845 && local845.aBoolean453) {
												...
												if (var65 >= local808 && local845.aClass336_1.anInt4154 * 447008399 <= local742.aClass336_1.anInt4154 * 447008399 - (var65 - local808 >> 9) && var25 >= local467 && local845.aClass336_1.anInt4154 * 447008399 <= local742.aClass336_1.anInt4154 * 447008399 - (var25 - local467 >> 9)) {
													Class660.method32821(local845, local348.aClass132_Sub1_25.aByte100 != Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aByte100, 405215604);
									...
									for (local172 = 0; local172 < var52; local172++) {
										...
										if (local966 != null && client.anInt3485 != local966.anInt2765 * -1318108809 && local966.aBoolean453) {
											var24 = local966.method24229().aClass472_61;
											var25 = (int) var24.aFloat317 - (local966.method19997(-533217829) - 1 << 8);
											var26 = (int) var24.aFloat319 - (local966.method19997(1079559687) - 1 << 8);
											if (var25 >= local808 && local966.method19997(-219816868) <= local742.aClass336_1.anInt4154 * 447008399 - (var25 - local808 >> 9) && var26 >= local467 && local966.method19997(-1331557076) <= local742.aClass336_1.anInt4154 * 447008399 - (var26 - local467 >> 9)) {
								...
								if (client.anInt3485 != local742.anInt2765 * -1318108809) {
									Class660.method32821(local742, local348.aClass132_Sub1_25.aByte100 != Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aByte100, 1297908743);
								...
								if (local1119 != null) {
									...
									while (local1129 != null) {
										...
										if (client.aBoolean625 && Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aByte100 == local348.aClass132_Sub1_25.aByte100) {
											...
											if ((Class253.anInt3851 * 735260021 & 0x1) != 0 && (local1186 == null || local1140.method945(Class650.anInt5797 * -759562015, local1186.anInt265 * 951920133, 2012113814) != local1186.anInt265 * 951920133)) {
												Class280.method26458(client.aString145, client.aString142 + " " + Class430.aString206 + " " + Class306.method26823(local172, 540275177) + local1140.aString6, Class271.anInt3885 * -308125347, 17, -1, (long) (-308533965 * local1129.anInt1405), local378, local383, true, false, (long) local467, false, (byte) -4);
											}
										}
										if (local348.aClass132_Sub1_25.aByte100 == Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aByte100) {
											...
											for (var65 = local1258.length - 1; var65 >= 0; var65--) {
												if (local1258[var65] != null) {
													...
													Class280.method26458(local1258[var65], Class306.method26823(local172, 1541510692) + local1140.aString6, var26, local1271, -1, (long) (local1129.anInt1405 * -308533965), local378, local383, true, false, (long) local467, false, (byte) -7);
												}
											}
										}
						...
						local1374 = (Class610) client.aClass532_1.method30466(1852926377).method18261(local1364.method13423(-1037211373), -1453809969);
						if (local1374.anIntArray492 != null) {
							local1374 = local1374.method31982(Class624.aClass120_1, Class624.aClass120_1, 374913403);
						}
					...
					if (client.aBoolean625 && Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aByte100 == local348.aClass132_Sub1_25.aByte100) {
						...
						if ((Class253.anInt3851 * 735260021 & 0x4) != 0 && (local1409 == null || local1374.method31986(Class650.anInt5797 * -759562015, local1409.anInt265 * 951920133, 95951680) != local1409.anInt265 * 951920133)) {
							Class280.method26458(client.aString145, client.aString142 + " " + Class430.aString206 + " " + Class306.method26823(65535, -700896380) + local1374.aString233, Class271.anInt3885 * -308125347, 2, -1, Class497.method30129(local1364, local378, local383, -1424099805), local378, local383, true, false, (long) local1364.hashCode(), false, (byte) -45);
						}
					}
			...
			for (local467 = local1481.length - 1; local467 >= 0; local467--) {
				if (local1481[local467] != null) {
					...
					local172 = local1374.method31991(local467, (short) -9302);
					if (local172 != -1) {
						local165 = local172;
					}
					Class280.method26458(local1481[local467], Class306.method26823(65535, -694159958) + local1374.aString233, local165, local1497, -1, Class497.method30129(local1364, local378, local383, -1424099805), local378, local383, true, false, (long) local1364.hashCode(), false, (byte) 0);
				}
			}
		}
	}
