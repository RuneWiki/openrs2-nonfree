...
final class Class155_Sub2 extends Class155 {
	...
	static void method15310(@OriginalArg(0) Class54_Sub1 arg0, @OriginalArg(1) int arg1) {
		...
		if (Class553.anInt3419 * 1798078423 >= 96) {
			...
			if (local11 <= 100) {
				Class642.method32521((byte) 79);
				local18 = 4;
			} else if (local11 <= 500) {
				Class586.method31641((byte) 79);
				local18 = 3;
			} else if (local11 <= 1003) {
				Class260.method26153(-155783093);
				local18 = 2;
			} else {
				Class238.method25796(true, -2058307396);
				local18 = 1;
			}
			arg0.method14875(0, local11, (short) 832);
		} else {
			Class238.method25796(true, -777147487);
			local18 = 1;
			arg0.method14870(64, 1666227099);
		}
		if (Class51.aClass93_Sub36_1.aClass166_Sub4_2.method15424((byte) 45) == 0) {
