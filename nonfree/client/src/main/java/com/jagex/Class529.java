...
public class Class529 {
	...
	public static Class702 method30398(@OriginalArg(0) int arg0) {
		@Pc(2) Class702[] local2 = Class520.method30343();
	...
	static final int method30400(@OriginalArg(0) int arg0) {
		return arg0 < 7 ? 8 : 11;
	}

	@OriginalMember(owner = "client!rg", name = "s", descriptor = "(I)Z", line = 226)
	static boolean method30397() {
	...
	static final void method30401(@OriginalArg(0) Class681 arg0) {
		...
		@Pc(60) Class39 local60 = (Class39) Class19.aClass32_Sub7_5.method18261(local23);
		if (local60.aClass519_2.method36920() != local13) {
			throw new RuntimeException();
		} else if (local60.aClass519_1.method36920() == Class519.aClass519_7.method36920()) {
			@Pc(84) int[] local84 = local60.method767(local47);
