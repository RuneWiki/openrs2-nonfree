...
public class Class529 {
	...
	static boolean method30397(@OriginalArg(0) int arg0) {
	...
	public static Class702 method30398(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(2) Class702[] local2 = Class520.method30343((byte) -91);
	...
	static Class3[] method30399(@OriginalArg(0) byte arg0) {
	...
	static final int method30400(@OriginalArg(0) int arg0, @OriginalArg(1) short arg1) {
		return arg0 < 7 ? 8 : 11;
	}
