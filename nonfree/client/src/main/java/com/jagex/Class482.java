...
public class Class482 {
	...
	void method29759(@OriginalArg(0) int arg0, @OriginalArg(1) Class472 arg1) {
		this.aClass472Array2[arg0].method29538(arg1);
		this.method29758();
	}

	@OriginalMember(owner = "client!ph", name = "c", descriptor = "(ILclient!ox;)V", line = 19)
	void method29768(@OriginalArg(0) int arg0, @OriginalArg(1) Class472 arg1) {
		this.aClass472Array2[arg0].method29538(arg1);
		this.method29758();
	}

	@OriginalMember(owner = "client!ph", name = "r", descriptor = "(ILclient!ox;)V", line = 19)
	void method29769(@OriginalArg(0) int arg0, @OriginalArg(1) Class472 arg1) {
		this.aClass472Array2[arg0].method29538(arg1);
		this.method29758();
	}

	@OriginalMember(owner = "client!ph", name = "p", descriptor = "(ILclient!ox;)V", line = 19)
	void method29772(@OriginalArg(0) int arg0, @OriginalArg(1) Class472 arg1) {
		this.aClass472Array2[arg0].method29538(arg1);
		this.method29758();
	}

	@OriginalMember(owner = "client!ph", name = "d", descriptor = "(ILclient!ox;)V", line = 19)
	void method29777(@OriginalArg(0) int arg0, @OriginalArg(1) Class472 arg1) {
		this.aClass472Array2[arg0].method29538(arg1);
		this.method29758();
	}
	...
	double[] method29774(@OriginalArg(0) float arg0) {
		@Pc(2) double[] local2 = new double[3];
		@Pc(6) float local6 = arg0 * arg0;
		@Pc(10) float local10 = local6 * arg0;
		@Pc(25) double local25 = (double) ((this.aClass472Array2[1].aFloat317 - this.aClass472Array2[0].aFloat317) * 3.0F);
	...
	float method29763(@OriginalArg(0) float arg0) {
		if (this.aFloat320 == -1.0F) {
			this.method29764();
		}
		if (arg0 <= 0.0F) {
	...
	float method29775(@OriginalArg(0) float arg0) {
		if (this.aFloat320 == -1.0F) {
			this.method29764();
		}
		if (arg0 <= 0.0F) {
	...
	void method29760() {
		@Pc(1) byte local1 = 20;
		@Pc(5) double[] local5 = this.method29774(0.0F);
		@Pc(7) float local7 = 0.0F;
		@Pc(9) Class472 local9 = Class472.method29528();
		@Pc(22) double[] local22;
		@Pc(11) int local11;
		for (local11 = 1; local11 <= local1; local11++) {
			local22 = this.method29774((float) local11 / (float) local1);
		...
		local5 = this.method29774(0.0F);
		@Pc(81) float local81 = 0.0F;
		for (@Pc(83) int local83 = 1; local83 <= local11; local83++) {
			local22 = this.method29774((float) local83 / (float) local11);
			local9.aFloat317 = (float) (local22[0] - local5[0]);
			local9.aFloat318 = (float) (local22[1] - local5[1]);
			local9.aFloat319 = (float) (local22[2] - local5[2]);
			@Pc(127) float local127 = local9.method29565();
			local81 += local127;
