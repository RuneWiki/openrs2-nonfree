...
public class Class133_Sub1 extends Class133 {
	...
	public static Class133 method10074(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(3) Class133 local3 = Class449.method28928(arg0, 216811848);
	...
	static final void method10075(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
			...
			while (local13 != 0 && local19 < arg0.aClass19_Sub1_Sub1Array3.length) {
				if ((local13 & 0x1) != 0) {
					if (local9 == -1) {
						...
						if (local58 != null && local58.method23552(-492776415)) {
							if (local9 == local58.method23554((byte) 17)) {
								if (local53 == 0) {
									arg0.aClass19_Sub1_Sub1Array3[local19] = null;
									local58 = null;
								} else if (local53 == 1) {
									local58.method23570(1602702541);
									local58.anInt3224 = local17 * -754803697;
								} else if (local53 == 2) {
									local58.method23628((short) -7094);
								}
							} else if (local48.anInt3873 * -1789992573 >= local58.method23553(168831707).anInt3873 * -1789992573) {
								arg0.aClass19_Sub1_Sub1Array3[local19] = null;
								local58 = null;
							}
						}
						if (local58 == null || !local58.method23552(1427306587)) {
							local58 = arg0.aClass19_Sub1_Sub1Array3[local19] = new Class19_Sub1_Sub1(arg0);
							local58.method23568(local9, 1121104828);
							local58.anInt3224 = local17 * -754803697;
						}
					}
				}
	...
	static final void method10079(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(16) Class312 local16 = Class659.method32805(local12, 276630658);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class183.method24573(local16, local22, arg0, -968264252);
	}
}
