...
public class Class99_Sub2 extends Class99 {
	...
	public void method2473(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) Class237 arg10, @OriginalArg(11) boolean arg11) {
		...
		for (@Pc(96) int local96 = 0; local96 < arg6.length; local96++) {
			...
			if ((this.anInt371 & 0x20) != 0 && local104 != -1 && local3.method25597(local104).aBoolean656) {
				local108 = 128;
				local104 = -1;
			}
			...
			for (local163 = this.aClass16_4.method215(local158); local163 != null; local163 = this.aClass16_4.method216()) {
				@Pc(168) Class93_Sub24 local168 = (Class93_Sub24) local163;
				if (local168.anInt1580 == local104 && local168.aFloat149 == (float) local108 && local168.aClass237_4.method25769(arg10)) {
					break;
				}
			}
			if (local163 == null) {
	...
	public void method2508() {
		if (this.anInt375 > 0) {
			...
			this.aClass93Array2 = new Class93[this.aClass16_4.method218()];
			this.aClass16_4.method217(this.aClass93Array2);
			...
			@Pc(163) int local163 = Class278.method26365(this.anInt375 / 4);
			if (local163 < 1) {
				local163 = 1;
			}
						...
						for (@Pc(462) int local462 = 0; local462 < local236.length; local462++) {
							...
							if (local832 == null) {
								...
								if (this.aClass104_Sub1_12.aBoolean106) {
									...
									local152.f((float) (this.method2480(local477, local488) + local514));
									...
									local152.w((float) (this.method2480(local477, local488) + local514));
			...
			local152.l();
			this.anInterface14_1 = this.aClass104_Sub1_12.method3831(local18, local147, local152.n(), false);
			...
			Class659.method32813(local1508, this.aClass93Array2);
	...
	void method2375(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		...
		if (!this.aClass22_3.method418()) {
			local109 = this.aClass104_Sub1_12.anInt562;
			@Pc(191) int local191 = this.aClass104_Sub1_12.anInt563;
			this.aClass104_Sub1_12.method20871(0, local191, this.aClass104_Sub1_12.anInt564);
			...
			for (@Pc(243) Class93 local243 = this.aClass22_3.method445(); local243 != null; local243 = this.aClass22_3.method415()) {
			...
			this.aClass104_Sub1_12.method20871(local109, local191, this.aClass104_Sub1_12.anInt564);
		}
		if (this.aClass205_1 == null) {
			return;
		}
		...
		this.aClass205_1.method24676(arg0, arg1, arg2, arg3, arg4);
		OpenGL.glPopMatrix();
	}
	...
	public void method2479(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean[][] arg7) {
		@Pc(4) Class112 local4 = this.aClass104_Sub1_12.method20434();
		...
		this.aClass104_Sub1_12.method3801(-2);
		this.aClass104_Sub1_12.method3804(null);
		aFloatArray2[0] = (float) arg2 / ((float) (this.anInt412 * -1678286317) * 128.0F * (float) local4.method23736());
		aFloatArray2[1] = 0.0F;
		aFloatArray2[2] = 0.0F;
		aFloatArray2[3] = 0.0F;
		aFloatArray2[4] = 0.0F;
		aFloatArray2[5] = (float) arg2 / ((float) (this.anInt412 * -1678286317) * 128.0F * (float) local4.method23737());
		aFloatArray2[6] = 0.0F;
		aFloatArray2[7] = 0.0F;
		aFloatArray2[8] = 0.0F;
		aFloatArray2[9] = 0.0F;
		...
		aFloatArray2[12] = -1.0F - ((float) (arg3 * arg2) / 128.0F - (float) (arg0 * 2)) / (float) local4.method23736();
		aFloatArray2[13] = 1.0F - ((float) (arg1 * 2) + (float) (arg6 * arg2) / 128.0F) / (float) local4.method23737();
					...
					if (arg7[local317 - arg3][local303 - arg4]) {
						...
						if (local335 != null) {
							for (local339 = 0; local339 < local335.length; local339++) {
								local297.method22454(local335[local339] & 0xFFFF);
								local293++;
							}
						}
					}
			...
			for (local303 = arg4; local303 < arg6; local303++) {
				...
				for (local317 = arg3; local317 < arg5; local317++) {
					if (arg7[local317 - arg3][local303 - arg4]) {
						...
						if (local335 != null) {
							for (local339 = 0; local339 < local335.length; local339++) {
								local297.method22393(local335[local339] & 0xFFFF);
								local293++;
							}
						}
					}
	...
	public Class93_Sub1_Sub4 method2484(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class93_Sub1_Sub4 arg2) {
		...
		if (local22 != null && local22.method23520(local19, local19)) {
			local31 = local22;
			local22.method23526();
		} else {
			local31 = new Class93_Sub1_Sub4_Sub2(this.aClass104_Sub1_12, local19, local19);
		}
		local31.method23519(0, 0, local19, local19);
	...
	void method2376(@OriginalArg(0) Class93_Sub1_Sub4_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		while (local42 < local16) {
			...
			if ((local76 - local85) * (local90 - local99) - (local90 - local81) * (local94 - local85) > 0) {
				arg0.method23522(local81, local90, local99, local76, local85, local94);
			}
		}
	}
	...
	public boolean method2488(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (this.aClass205_1 == null || arg0 == null) {
			...
			return this.aClass205_1.method24686(arg0, local20, local34);
		}
	}
	...
	public void method2485(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (this.aClass205_1 != null && arg0 != null) {
			...
			this.aClass205_1.method24677(arg0, local19, local33);
		}
	}
	...
	public void method2496(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (this.aClass205_1 != null && arg0 != null) {
			@Pc(19) int local19 = arg1 - (arg2 * this.aClass104_Sub1_12.anInt545 >> 8) >> this.aClass104_Sub1_12.anInt532;
			@Pc(33) int local33 = arg3 - (arg2 * this.aClass104_Sub1_12.anInt561 >> 8) >> this.aClass104_Sub1_12.anInt532;
			this.aClass205_1.method24678(arg0, local19, local33);
		}
	}
	...
	public void method2502(@OriginalArg(0) Class93_Sub16 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass22_3.method407(new Class93_Sub7(this.aClass104_Sub1_12, this, arg0, arg1));
	}
