...
public class Class633 {
	...
	public Class633(@OriginalArg(0) Class497 arg0) {
		@Pc(15) byte[] local15 = arg0.method30059(Class649.aClass649_10.anInt5795 * -51136173, (byte) 38);
		this.method32299(new Class93_Sub41(local15), 1868036314);
	}

	@OriginalMember(owner = "client!wc", name = "e", descriptor = "(Lclient!alw;I)V", line = 17)
	void method32299(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		while (true) {
			...
			switch(local3) {
				case 0:
					return;
				case 1:
					this.anInt5725 = arg0.method22436(-43527878) * 6838107;
					this.anInt5724 = arg0.method22436(-11331444) * 1053266949;
					break;
				default:
					return;
			}
		...
		while (true) {
			...
			switch(local3) {
				case 0:
					return;
				case 1:
					this.anInt5725 = arg0.method22436(-771342481) * 6838107;
					this.anInt5724 = arg0.method22436(-835178155) * 1053266949;
					break;
				default:
					return;
			}
		...
		while (true) {
			...
			switch(local3) {
				case 0:
					return;
				case 1:
					this.anInt5725 = arg0.method22436(-1933547126) * 6838107;
					this.anInt5724 = arg0.method22436(-1324206958) * 1053266949;
					break;
				default:
					return;
			}
		...
		while (true) {
			...
			switch(local3) {
				case 0:
					return;
				case 1:
					this.anInt5725 = arg0.method22436(-1813371893) * 6838107;
					this.anInt5724 = arg0.method22436(-2136963461) * 1053266949;
					break;
				default:
					return;
			}
	...
	public static void method32303(@OriginalArg(0) byte arg0) {
	...
	static final void method32305(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1127057995);
		Class577.method31357(local16, arg0, -1508905117);
	}

	@OriginalMember(owner = "client!wc", name = "bbv", descriptor = "(Lclient!yf;B)V", line = 14385)
	static final void method32306(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static Class93_Sub22 method32307(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(22) Class611 local22 = client.aClass532_1.method30443(1811251602);
		local1.aClass93_Sub41_Sub2_1.method22454(arg1 + local22.anInt5624 * -1994307635, 2136457997);
		local1.aClass93_Sub41_Sub2_1.method22510(Class28.method601(1440469475) ? 1 : 0, (byte) -82);
		...
		Class723.method36943(603445051);
		return local1;
	}

	@OriginalMember(owner = "client!wc", name = "e", descriptor = "(B)[Lclient!zg;", line = 16)
	public static Class704[] method32308(@OriginalArg(0) byte arg0) {
	...
	static void method32309(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
