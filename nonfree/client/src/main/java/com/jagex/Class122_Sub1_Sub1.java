...
public class Class122_Sub1_Sub1 extends Class122_Sub1 {
	...
	void method20224(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(17) int local17 = ((Class125_Sub2_Sub1) this.aClass125_5).anInt2993 * -1108091727 * Class300.method26716(1577996507) / 10 % local3;
		this.aClass100_31.method18178(arg0 - local3 + local17, arg1, local3 + arg2 - local17, arg3);
	}
	...
	void method20221(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(3) int local3 = this.aClass100_31.method18160();
		@Pc(17) int local17 = ((Class125_Sub2_Sub1) this.aClass125_5).anInt2993 * -1108091727 * Class300.method26716(1798470309) / 10 % local3;
		this.aClass100_31.method18178(arg0 - local3 + local17, arg1, local3 + arg2 - local17, arg3);
	}
	...
	void method20222(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(3) int local3 = this.aClass100_31.method18160();
		@Pc(17) int local17 = ((Class125_Sub2_Sub1) this.aClass125_5).anInt2993 * -1108091727 * Class300.method26716(1362687040) / 10 % local3;
		this.aClass100_31.method18178(arg0 - local3 + local17, arg1, local3 + arg2 - local17, arg3);
	}
	...
	void method20223(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(3) int local3 = this.aClass100_31.method18160();
		@Pc(17) int local17 = ((Class125_Sub2_Sub1) this.aClass125_5).anInt2993 * -1108091727 * Class300.method26716(1005043723) / 10 % local3;
		this.aClass100_31.method18178(arg0 - local3 + local17, arg1, local3 + arg2 - local17, arg3);
	}
