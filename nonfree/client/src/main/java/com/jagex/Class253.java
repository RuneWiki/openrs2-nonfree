...
public final class Class253 {
	...
	public Class93_Sub1 method25983(@OriginalArg(0) long arg0) {
		...
		if (local5 != null) {
			this.aClass18_14.method268(local5);
		}
		return local5;
	}

	@OriginalMember(owner = "client!ex", name = "f", descriptor = "(J)Lclient!aky;", line = 23)
	public Class93_Sub1 method25987(@OriginalArg(0) long arg0) {
		@Pc(5) Class93_Sub1 local5 = (Class93_Sub1) this.aClass16_25.method215(arg0);
		if (local5 != null) {
			this.aClass18_14.method268(local5);
		}
	...
	public Class93_Sub1 method25988(@OriginalArg(0) long arg0) {
		@Pc(5) Class93_Sub1 local5 = (Class93_Sub1) this.aClass16_25.method215(arg0);
		if (local5 != null) {
			this.aClass18_14.method268(local5);
		}
	...
	public void method25985(@OriginalArg(0) Class93_Sub1 arg0, @OriginalArg(1) long arg1) {
		if (this.anInt3850 * -1756416813 == 0) {
			@Pc(9) Class93_Sub1 local9 = this.aClass18_14.method244();
			local9.method23969();
			local9.method23976();
			if (local9 == this.aClass93_Sub1_69) {
				local9 = this.aClass18_14.method244();
				local9.method23969();
				local9.method23976();
			}
		} else {
		...
		this.aClass18_14.method268(arg0);
	}

	@OriginalMember(owner = "client!ex", name = "l", descriptor = "(Lclient!aky;J)V", line = 32)
	public void method25989(@OriginalArg(0) Class93_Sub1 arg0, @OriginalArg(1) long arg1) {
		if (this.anInt3850 * -1756416813 == 0) {
			@Pc(9) Class93_Sub1 local9 = this.aClass18_14.method244();
			local9.method23969();
			local9.method23976();
	...
	public void method25990(@OriginalArg(0) Class93_Sub1 arg0, @OriginalArg(1) long arg1) {
		if (this.anInt3850 * -1756416813 == 0) {
			@Pc(9) Class93_Sub1 local9 = this.aClass18_14.method244();
			local9.method23969();
			local9.method23976();
	...
	public void method25984() {
		this.aClass18_14.method245();
		this.aClass16_25.method219();
	...
	static final void method25993(@OriginalArg(0) Class681 arg0) {
		...
		Class35.method687(local14, local25);
	}

	@OriginalMember(owner = "client!ex", name = "abs", descriptor = "(Lclient!yf;I)V", line = 10451)
	static final void method25991(@OriginalArg(0) Class681 arg0) {
	...
	static final void method25994(@OriginalArg(0) Class681 arg0) {
	...
	static final void method25992(@OriginalArg(0) Class681 arg0) {
