...
public class class419 {
	...
	public void method6297(int arg0, int arg1, int arg2, float arg3, float arg4, float arg5) {
		if (arg0 == 0) {
			...
			this.field4278 = 0.0F;
			this.field4277 = 0.0F;
			this.field4276 = (float) (arg1 * 2);
			this.field4287 = (float) (arg2 * 2);
			this.field4284 = 1.0F;
	...
	public void method6319(float arg0, float arg1, float arg2, float[] arg3) {
		...
		arg3[0] = (float) (int) (this.field4278 * var7 + this.field4277 * var6 + this.field4276 * var5);
		arg3[1] = (float) (int) (this.field4281 * var7 + this.field4287 * var6 + this.field4279 * var5);
		arg3[2] = (float) (int) (this.field4284 * var7 + this.field4283 * var6 + this.field4275 * var5);
	}
	...
	public void method6320(float[] arg0) {
		...
		arg0[0] = (float) (int) (this.field4278 * var4 + this.field4277 * var3 + this.field4276 * var2);
		arg0[1] = (float) (int) (this.field4281 * var4 + this.field4287 * var3 + this.field4279 * var2);
		arg0[2] = (float) (int) (this.field4284 * var4 + this.field4283 * var3 + this.field4275 * var2);
	}
