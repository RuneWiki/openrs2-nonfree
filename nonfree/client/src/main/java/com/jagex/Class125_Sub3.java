...
public class Class125_Sub3 extends Class125 {
	...
	static final void method10063(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		for (@Pc(4) Class149_Sub6 local4 = (Class149_Sub6) client.aClass21_6.method390(); local4 != null; local4 = (Class149_Sub6) client.aClass21_6.method377()) {
			if (client.anInt3485 >= local4.anInt1473 * -2062413229) {
				local4.method23766();
			} else {
				Class166_Sub11.method15594(local4.anInt1476 * -280800109, (local4.anInt1472 * -374049833 << 9) + 256, (local4.anInt1474 * -965608087 << 9) + 256, 0, local4.anInt1475 * 1432638006, false, false);
				Class118_Sub1.aClass106_3.method7526(local4.aString43, (int) ((float) arg0 + client.aFloatArray93[0]), (int) (client.aFloatArray93[1] + (float) arg1), local4.anInt1477 * -1204675145 | 0xFF000000, 0);
			}
		}
	}

	@OriginalMember(owner = "client!ahs", name = "ack", descriptor = "(Lclient!yf;I)V", line = 9956)
	static final void method10062(@OriginalArg(0) Class681 arg0) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class557.aClass297_1.method26674().method36920();
	}
}
