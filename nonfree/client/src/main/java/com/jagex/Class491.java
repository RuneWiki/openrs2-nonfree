...
public class Class491 {
	...
	static void method29979(@OriginalArg(0) byte arg0) {
	...
	static final void method29980(@OriginalArg(0) int arg0) {
		Class354.method27696(client.aClass312_5, -1174743804);
			...
			if (Class82.aClass153_1.method14062(1413691472)) {
				...
				if (client.aBoolean616) {
					...
					if (client.aClass312_6 != null && client.method25279(client.aClass312_5) != null) {
						Class132_Sub1_Sub1_Sub1.method20045(client.aClass312_5, client.aClass312_6, -1885814787);
					}
				} else if ((client.anInt3519 * -169503325 == 1 || method29981((byte) -82)) && Class454.anInt5042 * -1838307953 > 2) {
					Class659.method32804(client.anInt3528 * -75226417 + client.anInt3533 * 517790231, client.anInt3459 * -762673807 + client.anInt3529 * 84488847, (byte) 1);
				} else if (Class91.method1707(-1909108699)) {
					Class659.method32804(client.anInt3528 * -75226417 + client.anInt3533 * 517790231, client.anInt3529 * 84488847 + client.anInt3459 * -762673807, (byte) 1);
				}
	...
	static boolean method29981(@OriginalArg(0) byte arg0) {
