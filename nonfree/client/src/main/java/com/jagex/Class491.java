...
public class Class491 {
	...
	static void method29979() {
		if (Class625.aClass100_51 != null && Class625.aClass100_51.method18189() == Class625.aTwitchWebcamFrameData1.width && Class625.aClass100_51.method18165() == Class625.aTwitchWebcamFrameData1.height) {
			Class625.aClass100_51.method18199(0, 0, Class625.aTwitchWebcamFrameData1.width, Class625.aTwitchWebcamFrameData1.height, Class625.aTwitchWebcamFrameData1.buffer, 0, Class625.aTwitchWebcamFrameData1.width);
		} else {
			Class625.aClass100_51 = Class694.aClass104_14.method20487(Class625.aTwitchWebcamFrameData1.buffer, 0, Class625.aTwitchWebcamFrameData1.width, Class625.aTwitchWebcamFrameData1.width, Class625.aTwitchWebcamFrameData1.height, false);
		}
	}

	@OriginalMember(owner = "client!ps", name = "ks", descriptor = "(I)V", line = 11719)
	static final void method29980() {
		Class354.method27696(client.aClass312_5);
		Class550.anInt5314 += 487066403;
		if (client.aBoolean628 && client.aBoolean614) {
			@Pc(24) int local24 = Class82.aClass153_1.method14058();
			@Pc(28) int local28 = Class82.aClass153_1.method14064();
			...
			if (Class82.aClass153_1.method14062()) {
				...
				if (client.aBoolean616) {
					...
					if (client.aClass312_5.anObjectArray6 != null) {
						...
						local157.anInt1995 = local117 * -1524396813;
						local157.anInt1998 = local119 * 519538413;
						@Pc(173) Class312 local173 = client.method25279(client.aClass312_5);
					...
					if (client.aClass312_6 != null && client.method25279(client.aClass312_5) != null) {
						Class132_Sub1_Sub1_Sub1.method20045(client.aClass312_5, client.aClass312_6);
					}
				} else if ((client.anInt3519 * -169503325 == 1 || method29981()) && Class454.anInt5042 * -1838307953 > 2) {
					Class659.method32804(client.anInt3528 * -75226417 + client.anInt3533 * 517790231, client.anInt3459 * -762673807 + client.anInt3529 * 84488847);
				} else if (Class91.method1707()) {
					Class659.method32804(client.anInt3528 * -75226417 + client.anInt3533 * 517790231, client.anInt3529 * 84488847 + client.anInt3459 * -762673807);
				}
