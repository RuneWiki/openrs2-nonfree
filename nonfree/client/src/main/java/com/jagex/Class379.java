...
public class Class379 implements Interface12 {
	...
	public static void method28104(@OriginalArg(0) float arg0, @OriginalArg(1) Class472 arg1, @OriginalArg(2) Class472 arg2, @OriginalArg(3) Class472 arg3, @OriginalArg(4) Class472 arg4, @OriginalArg(5) Class472 arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) float arg9) {
	...
	public static Class440[] method28094() {
	...
	void method28084(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) boolean arg1) {
		while (true) {
			...
			this.method28083(arg0, local3, arg1);
		}
	}
	...
	void method28089(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) boolean arg1) {
		while (true) {
			@Pc(3) int local3 = arg0.method22413();
			if (local3 == 0) {
				return;
	...
	void method28081(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		@Pc(6) Class387 local6 = (Class387) Class107.method18119(Class224.method25595(), arg1);
		switch(local6.anInt4650 * 1505518425) {
			case 7:
				this.anInt4619 = arg0.method22413() * 633542449;
				this.anInt4621 = arg0.method22413() * -942339801;
			case 9:
			default:
				break;
			case 14:
				@Pc(32) int local32 = arg0.method22413();
				this.aClass138_73 = (Class138) Class107.method18119(Class138.method11526(), local32);
				if (this.aClass138_73 == null) {
					throw new IllegalStateException("");
				}
				this.anInt4620 = arg0.method22436() * 1639192877;
				if (this.aClass127_1 != null) {
					@Pc(66) Interface11 local66 = (Interface11) this.aClass127_1.aMap16.get(this.aClass138_73);
					if (local66 != null) {
						this.aClass108_1 = (Class108) local66.method18261(this.anInt4620 * 1982504613);
					} else if (!arg2) {
						throw new IllegalStateException("");
					}
				}
	...
	void method28083(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		@Pc(6) Class387 local6 = (Class387) Class107.method18119(Class224.method25595(), arg1);
		switch(local6.anInt4650 * 1505518425) {
			case 7:
				this.anInt4619 = arg0.method22413() * 633542449;
	...
	static Class93_Sub1_Sub11 method28106() {
		@Pc(4) Class93_Sub1_Sub11 local4 = (Class93_Sub1_Sub11) Class93_Sub1_Sub11.aClass18_11.method246();
		if (local4 != null) {
			local4.method23969();
			local4.method23976();
			return local4;
		...
		do {
			local4 = (Class93_Sub1_Sub11) Class93_Sub1_Sub11.aClass18_12.method246();
			if (local4 == null) {
				return null;
			}
			if (local4.method21877() > Class305.method26796()) {
				return null;
			}
			local4.method23969();
			local4.method23976();
	...
	public int method28080(@OriginalArg(0) int arg0) {
	...
	public int method28082(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) throws Exception_Sub7 {
		@Pc(11) int local11 = anIntArray433[this.anInt4621 * -613951849 - this.anInt4619 * -1814502959];
	...
	static char method28098(@OriginalArg(0) char arg0) {
		if (arg0 == 198) {
			return 'E';
		} else if (arg0 == 230) {
			return 'e';
	...
	public static void method28101(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class497 arg1) {
	...
	static void method28100() {
		@Pc(2) Class240 local2 = Class330.aClass240_79;
		synchronized (Class330.aClass240_79) {
			Class330.aClass240_79.method25837();
		}
	}

	@OriginalMember(owner = "client!kh", name = "h", descriptor = "(I)V", line = 727)
	public static void method28103() {
		Class312.aClass240_74.method25837();
		Class312.aClass240_77.method25837();
		Class312.aClass240_75.method25837();
		Class312.aClass240_76.method25837();
	}

	@OriginalMember(owner = "client!kh", name = "ao", descriptor = "(Lclient!dh;I)V", line = 1119)
	static void method28099(@OriginalArg(0) Class104 arg0) {
		if (Class454.aBoolean774) {
			Class93_Sub1.method23977(arg0);
		} else {
			Class372.method28018(arg0);
		}
	}

	@OriginalMember(owner = "client!kh", name = "ke", descriptor = "(Lclient!yf;I)V", line = 6749)
	static final void method28107(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class420.method28739(local16, local22, arg0);
	}

	@OriginalMember(owner = "client!kh", name = "nw", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;B)V", line = 7399)
	static final void method28105(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
	...
	static final void method28095(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class375.method28041(local16, local22, arg0);
	}

	@OriginalMember(owner = "client!kh", name = "tq", descriptor = "(Lclient!yf;B)V", line = 8527)
	static final void method28096(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12);
		Class93_Sub3.method11815(local16, arg0);
	}

	@OriginalMember(owner = "client!kh", name = "xr", descriptor = "(Lclient!yf;I)V", line = 9188)
	static final void method28097(@OriginalArg(0) Class681 arg0) {
	...
	static final void method28102(@OriginalArg(0) Class681 arg0) {
