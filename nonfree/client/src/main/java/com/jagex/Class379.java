...
public class Class379 implements Interface12 {
	...
	public void method36654(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
		this.method28089(arg0, false, -493230055);
	}

	@OriginalMember(owner = "client!kh", name = "p", descriptor = "(II)I", line = 83)
	public int method28080(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	void method28081(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		@Pc(6) Class387 local6 = (Class387) Class107.method18119(Class224.method25595(388455393), arg1, -1915563430);
		switch(local6.anInt4650 * 1505518425) {
			case 7:
				this.anInt4619 = arg0.method22413((short) 16384) * 633542449;
				this.anInt4621 = arg0.method22413((short) 16384) * -942339801;
			case 9:
			default:
				break;
			case 14:
				@Pc(32) int local32 = arg0.method22413((short) 16384);
				this.aClass138_73 = (Class138) Class107.method18119(Class138.method11526(910692260), local32, -1915563430);
				if (this.aClass138_73 == null) {
					throw new IllegalStateException("");
				}
				this.anInt4620 = arg0.method22436(-1512236357) * 1639192877;
	...
	public int method28082(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws Exception_Sub7 {
		@Pc(11) int local11 = anIntArray433[this.anInt4621 * -613951849 - this.anInt4619 * -1814502959];
	...
	void method28083(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3) {
		@Pc(6) Class387 local6 = (Class387) Class107.method18119(Class224.method25595(50615375), arg1, -1915563430);
		switch(local6.anInt4650 * 1505518425) {
			case 7:
				this.anInt4619 = arg0.method22413((short) 16384) * 633542449;
				this.anInt4621 = arg0.method22413((short) 16384) * -942339801;
			...
			case 14:
				@Pc(32) int local32 = arg0.method22413((short) 16384);
				this.aClass138_73 = (Class138) Class107.method18119(Class138.method11526(625044942), local32, -1915563430);
				if (this.aClass138_73 == null) {
					throw new IllegalStateException("");
				}
				this.anInt4620 = arg0.method22436(-865376851) * 1639192877;
				if (this.aClass127_1 != null) {
					@Pc(66) Interface11 local66 = (Interface11) this.aClass127_1.aMap16.get(this.aClass138_73);
					if (local66 != null) {
	...
	void method28084(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) boolean arg1) {
		while (true) {
			...
			this.method28083(arg0, local3, arg1, 206574286);
		}
	}

	@OriginalMember(owner = "client!kh", name = "r", descriptor = "(Lclient!alw;Z)V", line = 41)
	void method28085(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) boolean arg1) {
		while (true) {
			@Pc(3) int local3 = arg0.method22413((short) 16384);
			if (local3 == 0) {
				return;
			}
			this.method28083(arg0, local3, arg1, -875383904);
		}
	}

	@OriginalMember(owner = "client!kh", name = "v", descriptor = "(Lclient!alw;Z)V", line = 41)
	void method28086(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) boolean arg1) {
		while (true) {
			@Pc(3) int local3 = arg0.method22413((short) 16384);
			if (local3 == 0) {
				return;
			}
			this.method28083(arg0, local3, arg1, 361725780);
		}
	}

	@OriginalMember(owner = "client!kh", name = "y", descriptor = "(I)I", line = 83)
	public int method28087(@OriginalArg(0) int arg0) {
		@Pc(11) int local11 = anIntArray433[this.anInt4621 * -613951849 - this.anInt4619 * -1814502959];
		return arg0 >> this.anInt4619 * -1814502959 & local11;
	}

	@OriginalMember(owner = "client!kh", name = "s", descriptor = "(I)I", line = 83)
	public int method28088(@OriginalArg(0) int arg0) {
		@Pc(11) int local11 = anIntArray433[this.anInt4621 * -613951849 - this.anInt4619 * -1814502959];
		return arg0 >> this.anInt4619 * -1814502959 & local11;
	}

	@OriginalMember(owner = "client!kh", name = "u", descriptor = "(Lclient!alw;ZI)V", line = 41)
	void method28089(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2) {
		while (true) {
			@Pc(3) int local3 = arg0.method22413((short) 16384);
			if (local3 == 0) {
				return;
			}
			this.method28083(arg0, local3, arg1, 979652591);
		}
	}
	...
	public int method28092(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) throws Exception_Sub7 {
		@Pc(11) int local11 = anIntArray433[this.anInt4621 * -613951849 - this.anInt4619 * -1814502959];
		if (arg1 < 0 || arg1 > local11) {
			throw new Exception_Sub7(this.aString195 == null ? Integer.toString(this.anInt4622 * -15749287) : this.aString195, arg1, local11);
		}
	...
	public int method28093(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) throws Exception_Sub7 {
		@Pc(11) int local11 = anIntArray433[this.anInt4621 * -613951849 - this.anInt4619 * -1814502959];
		if (arg1 < 0 || arg1 > local11) {
			throw new Exception_Sub7(this.aString195 == null ? Integer.toString(this.anInt4622 * -15749287) : this.aString195, arg1, local11);
		}
	...
	public static Class440[] method28094(@OriginalArg(0) int arg0) {
	...
	static final void method28095(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1528285061);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class375.method28041(local16, local22, arg0, (byte) 27);
	}

	@OriginalMember(owner = "client!kh", name = "tq", descriptor = "(Lclient!yf;B)V", line = 8527)
	static final void method28096(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1626527135);
	...
	static final void method28097(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static char method28098(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1) {
		if (arg0 == 'Æ') {
			return 'E';
		} else if (arg0 == 'æ') {
			return 'e';
	...
	static void method28099(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		if (Class454.aBoolean774) {
			Class93_Sub1.method23977(arg0, -1138258603);
		} else {
			Class372.method28018(arg0, -1470452289);
		}
	}

	@OriginalMember(owner = "client!kh", name = "w", descriptor = "(B)V", line = 159)
	static void method28100(@OriginalArg(0) byte arg0) {
		@Pc(2) Class240 local2 = Class330.aClass240_79;
		synchronized (Class330.aClass240_79) {
			Class330.aClass240_79.method25837(1161602830);
		}
	}

	@OriginalMember(owner = "client!kh", name = "l", descriptor = "(Lclient!dh;Lclient!py;I)V", line = 98)
	public static void method28101(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class497 arg1, @OriginalArg(2) int arg2) {
		@Pc(6) Class105[] local6 = Class203.method24651(arg1, Class393.anInt4655 * -862282487, 0);
		...
		local6 = Class203.method24651(arg1, Class393.anInt4660 * 1530987473, 0);
		Class393.aClass100Array7 = new Class100[local6.length];
		for (local12 = 0; local12 < local6.length; local12++) {
			Class393.aClass100Array7[local12] = arg0.method20499(local6[local12], true);
		}
		local6 = Class203.method24651(arg1, Class393.anInt4656 * 1048499503, 0);
		...
		local6 = Class203.method24651(arg1, Class393.anInt4652 * -512546131, 0);
		Class393.aClass100Array6 = new Class100[local6.length];
		local68 = 12;
		for (local70 = 0; local70 < local6.length; local70++) {
			local6[local70].method7172(-local68 + (int) (Math.random() * (double) local68 * 2.0D), -local68 + (int) (Math.random() * (double) local68 * 2.0D), -local68 + (int) (Math.random() * (double) local68 * 2.0D));
			Class393.aClass100Array6[local70] = arg0.method20499(local6[local70], true);
		}
		local6 = Class203.method24651(arg1, Class393.anInt4658 * 1492309703, 0);
		...
		Class284.aClass100_42 = arg0.method20499(Class203.method24652(arg1, Class393.anInt4659 * -71569053, 0), true);
	...
	static final void method28102(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	public static void method28103(@OriginalArg(0) int arg0) {
		Class312.aClass240_74.method25837(1161602830);
		Class312.aClass240_77.method25837(1161602830);
		Class312.aClass240_75.method25837(1161602830);
		Class312.aClass240_76.method25837(1161602830);
	}

	@OriginalMember(owner = "client!kh", name = "e", descriptor = "(FLclient!ox;Lclient!ox;Lclient!ox;Lclient!ox;Lclient!ox;FFFFI)V", line = 12)
	public static void method28104(@OriginalArg(0) float arg0, @OriginalArg(1) Class472 arg1, @OriginalArg(2) Class472 arg2, @OriginalArg(3) Class472 arg3, @OriginalArg(4) Class472 arg4, @OriginalArg(5) Class472 arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) float arg9, @OriginalArg(10) int arg10) {
	...
	static final void method28105(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) byte arg3) {
		...
		Class499.method30148(local13, arg2, -1049422236);
	}

	@OriginalMember(owner = "client!kh", name = "m", descriptor = "(B)Lclient!ars;", line = 65)
	static Class93_Sub1_Sub11 method28106(@OriginalArg(0) byte arg0) {
		...
		do {
			...
			if (local4.method21877((byte) 34) > Class305.method26796(540804487)) {
				return null;
			}
	...
	static final void method28107(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1537493195);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class420.method28739(local16, local22, arg0, (byte) -127);
	}
}
