...
public abstract class Class122 implements Interface33 {
	...
	public void method28283() {
		@Pc(10) Class5 local10 = Class691.method36594(this.aClass497_89, this.aClass125_5.anInt2986 * -1726029297, Class157.aClass462_2, -827100733);
	...
	public void method28285(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		@Pc(19) int local19 = this.aClass125_5.aClass390_7.method28273(this.aClass125_5.anInt2983 * 1135283731, client.anInt3511 * 2040043391, -1156484062) + this.aClass125_5.anInt2981 * 483768335;
		@Pc(39) int local39 = this.aClass125_5.aClass392_7.method28290(this.aClass125_5.anInt2980 * -1017655207, client.anInt3512 * -817449061, (short) 255) + this.aClass125_5.anInt2982 * 2099407685;
		this.method20211(arg0, local19, local39, (short) 29116);
		this.method20212(arg0, local19, local39, 1261112801);
		@Pc(55) String local55 = Class653.aClass357_1.method27738((byte) -83);
		if (Class305.method26796(94466000) - this.aLong131 * -4000576377463988303L > 10000L) {
			local55 = local55 + " (" + Class653.aClass357_1.method27741(602155627).anInt4590 * -909097621 + ")";
		}
	...
	public boolean method28279(@OriginalArg(0) int arg0) {
		...
		if (!this.aClass497_90.method30054(this.aClass125_5.anInt2986 * -1726029297, -512225963)) {
			local1 = false;
		}
		if (!this.aClass497_89.method30054(this.aClass125_5.anInt2986 * -1726029297, -512225963)) {
			local1 = false;
		}
		return local1;
	}
	...
	abstract void method20211(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) short arg3);

	@OriginalMember(owner = "client!kz", name = "p", descriptor = "(ZIII)V")
	abstract void method20212(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3);

	@OriginalMember(owner = "client!kz", name = "d", descriptor = "(B)I", line = 51)
	int method20213(@OriginalArg(0) byte arg0) {
		@Pc(3) int local3 = Class653.aClass357_1.method27737(1285578807);
		@Pc(7) int local7 = local3 * 100;
		if (local3 == this.anInt2827 * 466791593 && local3 != 0) {
			@Pc(20) int local20 = Class653.aClass357_1.method27760(-1340940817);
			if (local20 > local3) {
				...
				if (local32 > 0L) {
					...
					@Pc(58) long local58 = (Class305.method26796(805217755) - this.aLong131 * -4000576377463988303L) * 10000L;
					if (local58 < local48) {
			...
			this.aLong131 = Class305.method26796(879923751) * 4433505070836107601L;
		}
		return local7;
	}
	...
	public void method28281(@OriginalArg(0) boolean arg0) {
		@Pc(19) int local19 = this.aClass125_5.aClass390_7.method28273(this.aClass125_5.anInt2983 * 1135283731, client.anInt3511 * 2040043391, 1833193692) + this.aClass125_5.anInt2981 * 483768335;
		@Pc(39) int local39 = this.aClass125_5.aClass392_7.method28290(this.aClass125_5.anInt2980 * -1017655207, client.anInt3512 * -817449061, (short) 255) + this.aClass125_5.anInt2982 * 2099407685;
		this.method20211(arg0, local19, local39, (short) 23483);
		this.method20212(arg0, local19, local39, 1261112801);
		@Pc(55) String local55 = Class653.aClass357_1.method27738((byte) -113);
		if (Class305.method26796(-116299067) - this.aLong131 * -4000576377463988303L > 10000L) {
			local55 = local55 + " (" + Class653.aClass357_1.method27741(602155627).anInt4590 * -909097621 + ")";
		}
		this.aClass106_8.method7526(local55, this.aClass125_5.anInt2983 * 1135283731 / 2 + local19, this.aClass125_5.anInt2985 * -1946839755 + local39 + this.aClass125_5.anInt2980 * -1017655207 / 2 + 4, this.aClass125_5.anInt2984 * 291173831, -1, 1357185837);
	}
	...
	public void method28282(@OriginalArg(0) boolean arg0) {
		@Pc(19) int local19 = this.aClass125_5.aClass390_7.method28273(this.aClass125_5.anInt2983 * 1135283731, client.anInt3511 * 2040043391, -141363417) + this.aClass125_5.anInt2981 * 483768335;
		@Pc(39) int local39 = this.aClass125_5.aClass392_7.method28290(this.aClass125_5.anInt2980 * -1017655207, client.anInt3512 * -817449061, (short) 255) + this.aClass125_5.anInt2982 * 2099407685;
		this.method20211(arg0, local19, local39, (short) 7219);
		this.method20212(arg0, local19, local39, 1261112801);
		@Pc(55) String local55 = Class653.aClass357_1.method27738((byte) -15);
		if (Class305.method26796(1260776468) - this.aLong131 * -4000576377463988303L > 10000L) {
			local55 = local55 + " (" + Class653.aClass357_1.method27741(602155627).anInt4590 * -909097621 + ")";
		}
		this.aClass106_8.method7526(local55, this.aClass125_5.anInt2983 * 1135283731 / 2 + local19, this.aClass125_5.anInt2985 * -1946839755 + local39 + this.aClass125_5.anInt2980 * -1017655207 / 2 + 4, this.aClass125_5.anInt2984 * 291173831, -1, 1357185837);
	}
	...
	public void method28280(@OriginalArg(0) int arg0) {
		@Pc(10) Class5 local10 = Class691.method36594(this.aClass497_89, this.aClass125_5.anInt2986 * -1726029297, Class157.aClass462_2, -868470660);
		this.aClass106_8 = Class694.aClass104_14.method20506(local10, Class203.method24650(this.aClass497_90, this.aClass125_5.anInt2986 * -1726029297), true);
	}
	...
	public void method28284() {
		@Pc(10) Class5 local10 = Class691.method36594(this.aClass497_89, this.aClass125_5.anInt2986 * -1726029297, Class157.aClass462_2, -687538583);
		this.aClass106_8 = Class694.aClass104_14.method20506(local10, Class203.method24650(this.aClass497_90, this.aClass125_5.anInt2986 * -1726029297), true);
	}
	...
	int method20215() {
		...
		@Pc(7) int local7 = local3 * 100;
		if (local3 == this.anInt2827 * 466791593 && local3 != 0) {
			@Pc(20) int local20 = Class653.aClass357_1.method27760(-1251945600);
			if (local20 > local3) {
				@Pc(32) long local32 = this.aLong131 * -4000576377463988303L - Class653.aClass357_1.method27758(2010044839);
				if (local32 > 0L) {
					@Pc(48) long local48 = local32 * 10000L / (long) local3 * (long) (local20 - local3);
					@Pc(58) long local58 = (Class305.method26796(563181815) - this.aLong131 * -4000576377463988303L) * 10000L;
					if (local58 < local48) {
						local7 = (int) ((long) (local3 * 100) + (long) (local20 - local3) * 100L * local58 / local48);
					} else {
						local7 = local20 * 100;
			...
			this.anInt2827 = local3 * -1466255463;
			this.aLong131 = Class305.method26796(915094059) * 4433505070836107601L;
		}
		return local7;
	}

	@OriginalMember(owner = "client!kz", name = "v", descriptor = "(ZII)V")
	abstract void method20216(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!kz", name = "o", descriptor = "(ZII)V")
	abstract void method20217(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!kz", name = "afq", descriptor = "(Lclient!yf;I)V", line = 10463)
	static final void method20218(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method20219(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	}

	@OriginalMember(owner = "client!kz", name = "bfm", descriptor = "(Lclient!yf;I)V", line = 15145)
	static final void method20220(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
