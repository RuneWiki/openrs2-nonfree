...
public class Class608 implements Interface13 {
	...
	public Class100 method31937(@OriginalArg(0) Class104 arg0) {
		...
		if (local17 == null) {
			this.method31943(arg0, -1568063096);
	...
	public void method36654(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
		while (true) {
			...
			this.method31944(arg0, local3, -679950115);
		}
	}
	...
	public final Class608 method31938(@OriginalArg(0) Interface21 arg0, @OriginalArg(1) Interface23 arg1, @OriginalArg(2) int arg2) {
		@Pc(1) int local1 = -1;
	...
	public String method31939(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		while (true) {
			...
			local2 = local2.substring(0, local18) + Class107.method18120(local14, false, -449951645) + local2.substring(local18 + 2);
		}
	}
	...
	public void method36655(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			...
			this.method31944(arg0, local3, -145894470);
		}
	}
	...
	public Class100 method31940(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		...
		if (local17 == null) {
			this.method31943(arg0, 1387012624);
	...
	public Class100 method31941(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		if (this.anInt5572 * -183740945 < 0) {
			return null;
		}
		@Pc(17) Class100 local17 = (Class100) this.aClass152_1.aClass240_21.method25839((long) (this.anInt5572 * -183740945));
		if (local17 == null) {
			this.method31943(arg0, -802502247);
			local17 = (Class100) this.aClass152_1.aClass240_21.method25839((long) (this.anInt5572 * -183740945));
		}
		return local17;
	}
	...
	public Class100 method31942(@OriginalArg(0) Class104 arg0, @OriginalArg(1) byte arg1) {
		...
		if (local17 == null) {
			this.method31943(arg0, -510801439);
	...
	void method31943(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class497 local3 = this.aClass152_1.aClass497_45;
		@Pc(33) Class105 local33;
		if (this.anInt5568 * -804410055 >= 0 && this.aClass152_1.aClass240_21.method25839((long) (this.anInt5568 * -804410055)) == null && local3.method30054(this.anInt5568 * -804410055, -512225963)) {
		...
		if (this.anInt5571 * -2131988551 >= 0 && this.aClass152_1.aClass240_21.method25839((long) (this.anInt5571 * -2131988551)) == null && local3.method30054(this.anInt5571 * -2131988551, -512225963)) {
		...
		if (this.anInt5572 * -183740945 >= 0 && this.aClass152_1.aClass240_21.method25839((long) (this.anInt5572 * -183740945)) == null && local3.method30054(this.anInt5572 * -183740945, -512225963)) {
		...
		if (this.anInt5573 * 202498537 >= 0 && this.aClass152_1.aClass240_21.method25839((long) (this.anInt5573 * 202498537)) == null && local3.method30054(this.anInt5573 * 202498537, -512225963)) {
	...
	void method31944(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg1 == 1) {
			this.anInt5579 = arg0.method22436(-1419708709) * 903627193;
		} else if (arg1 == 2) {
			this.anInt5569 = arg0.method22417((short) -11080) * 890968413;
			this.aBoolean827 = true;
		} else if (arg1 == 3) {
			this.anInt5568 = arg0.method22436(-969449569) * 1766142217;
		} else if (arg1 == 4) {
			this.anInt5572 = arg0.method22436(-192295129) * 199719183;
		} else if (arg1 == 5) {
			this.anInt5571 = arg0.method22436(-1292514137) * 1507387017;
		} else if (arg1 == 6) {
			this.anInt5573 = arg0.method22436(-2044399646) * 729089625;
		} else if (arg1 == 7) {
			this.anInt5574 = arg0.method22482((byte) -89) * -1733504063;
		} else if (arg1 == 8) {
			this.aString232 = arg0.method22428(1487593062);
		} else if (arg1 == 9) {
			this.anInt5570 = arg0.method22415(-1434290800) * 212534357;
		} else if (arg1 == 10) {
			this.anInt5576 = arg0.method22482((byte) -29) * 426052467;
		} else if (arg1 == 11) {
			this.anInt5575 = 0;
		} else if (arg1 == 12) {
			this.anInt5578 = arg0.method22413((short) 16384) * -2079109471;
		} else if (arg1 == 13) {
			this.anInt5563 = arg0.method22482((byte) -27) * -4667447;
		} else if (arg1 == 14) {
			this.anInt5575 = arg0.method22415(-1434290800) * 2128038707;
		} else if (arg1 == 16) {
			this.anInt5577 = arg0.method22482((byte) -95) * 311657605;
			this.anInt5562 = arg0.method22482((byte) -83) * -303555573;
		} else if (arg1 == 17 || arg1 == 18) {
			this.anInt5580 = arg0.method22415(-1434290800) * -1319444603;
			if (this.anInt5580 * 878854477 == 65535) {
				this.anInt5580 = 1319444603;
			}
			this.anInt5581 = arg0.method22415(-1434290800) * -1550157383;
			if (this.anInt5581 * 2096741513 == 65535) {
				this.anInt5581 = 1550157383;
			}
			@Pc(208) int local208 = -1;
			if (arg1 == 18) {
				local208 = arg0.method22415(-1434290800);
				if (local208 == 65535) {
					local208 = -1;
				}
			}
			@Pc(224) int local224 = arg0.method22413((short) 16384);
			this.anIntArray487 = new int[local224 + 2];
			for (@Pc(232) int local232 = 0; local232 <= local224; local232++) {
				this.anIntArray487[local232] = arg0.method22415(-1434290800);
			...
			this.anInt5582 = arg0.method22415(-1434290800) * 319020291;
		} else if (arg1 == 20) {
			this.anInt5583 = arg0.method22415(-1434290800) * -59333593;
		}
	}
	...
	public Class100 method31945(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		...
		if (local17 == null) {
			this.method31943(arg0, -203340882);
	...
	public void method36657(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			...
			this.method31944(arg0, local3, 1743892855);
		}
	}
	...
	public void method36658(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			...
			this.method31944(arg0, local3, 1043599542);
		}
	}
	...
	public Class100 method31946(@OriginalArg(0) Class104 arg0) {
		...
		@Pc(17) Class100 local17 = (Class100) this.aClass152_1.aClass240_21.method25839((long) (this.anInt5571 * -2131988551));
		if (local17 == null) {
			this.method31943(arg0, 2103949479);
			local17 = (Class100) this.aClass152_1.aClass240_21.method25839((long) (this.anInt5571 * -2131988551));
		}
		return local17;
	}
	...
	void method31947(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt5579 = arg0.method22436(-360546306) * 903627193;
		} else if (arg1 == 2) {
			this.anInt5569 = arg0.method22417((short) 2934) * 890968413;
			this.aBoolean827 = true;
		} else if (arg1 == 3) {
			this.anInt5568 = arg0.method22436(-124438954) * 1766142217;
		} else if (arg1 == 4) {
			this.anInt5572 = arg0.method22436(-210484620) * 199719183;
		} else if (arg1 == 5) {
			this.anInt5571 = arg0.method22436(-1079965448) * 1507387017;
		} else if (arg1 == 6) {
			this.anInt5573 = arg0.method22436(-327289363) * 729089625;
		} else if (arg1 == 7) {
			this.anInt5574 = arg0.method22482((byte) -127) * -1733504063;
		} else if (arg1 == 8) {
			this.aString232 = arg0.method22428(-611590438);
		} else if (arg1 == 9) {
			this.anInt5570 = arg0.method22415(-1434290800) * 212534357;
		} else if (arg1 == 10) {
			this.anInt5576 = arg0.method22482((byte) -48) * 426052467;
		} else if (arg1 == 11) {
			this.anInt5575 = 0;
		} else if (arg1 == 12) {
			this.anInt5578 = arg0.method22413((short) 16384) * -2079109471;
		} else if (arg1 == 13) {
			this.anInt5563 = arg0.method22482((byte) -30) * -4667447;
		} else if (arg1 == 14) {
			this.anInt5575 = arg0.method22415(-1434290800) * 2128038707;
		} else if (arg1 == 16) {
			this.anInt5577 = arg0.method22482((byte) -126) * 311657605;
			this.anInt5562 = arg0.method22482((byte) -20) * -303555573;
		} else if (arg1 == 17 || arg1 == 18) {
			this.anInt5580 = arg0.method22415(-1434290800) * -1319444603;
			if (this.anInt5580 * 878854477 == 65535) {
				this.anInt5580 = 1319444603;
	...
	public Class100 method31949(@OriginalArg(0) Class104 arg0) {
		...
		@Pc(17) Class100 local17 = (Class100) this.aClass152_1.aClass240_21.method25839((long) (this.anInt5572 * -183740945));
		if (local17 == null) {
			this.method31943(arg0, -564484658);
			local17 = (Class100) this.aClass152_1.aClass240_21.method25839((long) (this.anInt5572 * -183740945));
		}
		return local17;
	}
	...
	public Class100 method31950(@OriginalArg(0) Class104 arg0) {
		...
		@Pc(17) Class100 local17 = (Class100) this.aClass152_1.aClass240_21.method25839((long) (this.anInt5571 * -2131988551));
		if (local17 == null) {
			this.method31943(arg0, -100449606);
			local17 = (Class100) this.aClass152_1.aClass240_21.method25839((long) (this.anInt5571 * -2131988551));
		}
		return local17;
	}
	...
	public Class100 method31951(@OriginalArg(0) Class104 arg0) {
		...
		@Pc(17) Class100 local17 = (Class100) this.aClass152_1.aClass240_21.method25839((long) (this.anInt5571 * -2131988551));
		if (local17 == null) {
			this.method31943(arg0, 63511426);
			local17 = (Class100) this.aClass152_1.aClass240_21.method25839((long) (this.anInt5571 * -2131988551));
		}
		return local17;
	}
	...
	public Class100 method31952(@OriginalArg(0) Class104 arg0) {
		...
		@Pc(17) Class100 local17 = (Class100) this.aClass152_1.aClass240_21.method25839((long) (this.anInt5573 * 202498537));
		if (local17 == null) {
			this.method31943(arg0, -593219328);
			local17 = (Class100) this.aClass152_1.aClass240_21.method25839((long) (this.anInt5573 * 202498537));
		}
		return local17;
	}
	...
	public void method36656(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			...
			this.method31944(arg0, local3, -147046238);
		}
	}
	...
	public Class100 method31954(@OriginalArg(0) Class104 arg0) {
		...
		@Pc(17) Class100 local17 = (Class100) this.aClass152_1.aClass240_21.method25839((long) (this.anInt5573 * 202498537));
		if (local17 == null) {
			this.method31943(arg0, -966149929);
			local17 = (Class100) this.aClass152_1.aClass240_21.method25839((long) (this.anInt5573 * 202498537));
		}
		return local17;
	}
	...
	public Class100 method31955(@OriginalArg(0) Class104 arg0) {
		...
		@Pc(17) Class100 local17 = (Class100) this.aClass152_1.aClass240_21.method25839((long) (this.anInt5573 * 202498537));
		if (local17 == null) {
			this.method31943(arg0, -155311382);
			local17 = (Class100) this.aClass152_1.aClass240_21.method25839((long) (this.anInt5573 * 202498537));
		}
		return local17;
	}
	...
	static final void method31958(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1973597293);
	...
	public static float method31959(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2) {
	...
	static final void method31961(@OriginalArg(0) byte arg0) {
		...
		for (@Pc(7) int local7 = 0; local7 < local3; local7++) {
			...
			if (local16 != null) {
				Class233.method25732(local16, false, (byte) -63);
			}
		}
	}

	@OriginalMember(owner = "client!vb", name = "n", descriptor = "(B)I", line = 81)
	public static int method31962(@OriginalArg(0) byte arg0) {
