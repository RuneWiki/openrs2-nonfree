...
public class Class353 implements Interface13, Interface5 {
	...
	void method27682(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt4206 = arg0.method22415() * 710093151;
		} else if (arg1 == 2) {
			this.aBoolean726 = true;
		} else if (arg1 == 3) {
			this.anInt4212 = arg0.method22482() * 1413484159;
			this.anInt4209 = arg0.method22482() * 1586091789;
			this.anInt4207 = arg0.method22482() * 2129323107;
		} else if (arg1 == 4) {
			this.anInt4210 = arg0.method22413() * -371871043;
		} else if (arg1 == 5) {
			this.anInt4208 = arg0.method22436() * -1794285659;
		} else if (arg1 == 6) {
			this.anInt4211 = arg0.method22417() * 2147126775;
		} else if (arg1 == 7) {
			this.anInt4213 = arg0.method22482() * -227932087;
			this.anInt4214 = arg0.method22482() * 905769807;
			this.anInt4215 = arg0.method22482() * -326223519;
		}
	}

	@OriginalMember(owner = "client!iy", name = "u", descriptor = "(Lclient!alw;IB)V", line = 32)
	void method27683(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt4206 = arg0.method22415() * 710093151;
		} else if (arg1 == 2) {
			this.aBoolean726 = true;
	...
	public static boolean method27685() {
		return Class527.aString222.startsWith("win");
	}

	@OriginalMember(owner = "client!iy", name = "as", descriptor = "(III)I", line = 473)
	public static int method27686(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	static final void method27687(@OriginalArg(0) Class93_Sub1_Sub7 arg0, @OriginalArg(1) Class681 arg1) {
		arg1.anIntArray519[(arg1.anInt5891 += 1189701933) * -1497248091 - 1] = Class166_Sub14.method15657(arg0);
		arg1.anObjectArray45[(arg1.anInt5888 += 957530791) * 587908375 - 1] = Class358.method27779(arg0);
		arg1.anObjectArray45[(arg1.anInt5888 += 957530791) * 587908375 - 1] = Class451.method28950(arg0);
		arg1.anObjectArray45[(arg1.anInt5888 += 957530791) * 587908375 - 1] = Class200.method24629(arg0);
	}

	@OriginalMember(owner = "client!iy", name = "bn", descriptor = "(Lclient!yf;B)V", line = 5123)
	static final void method27688(@OriginalArg(0) Class681 arg0) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		if (local8.aClass312_13.anInt3970 * 532402067 != -1) {
			@Pc(32) Class312 local32 = local8.method33228();
			local32.aClass312Array2[local8.aClass312_13.anInt3970 * 532402067] = null;
			Class354.method27696(local32);
	...
	static final void method27689(@OriginalArg(0) Class681 arg0) {
	...
	static final void method27690(@OriginalArg(0) Class681 arg0) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
	...
	static final void method27691(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= -725861497;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		@Pc(33) int local33 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 2];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class89.method1599(local13, local23, local33, true);
	}
}
