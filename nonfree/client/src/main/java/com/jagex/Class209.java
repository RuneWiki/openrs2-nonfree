...
public class Class209 {
	...
	boolean method25405(@OriginalArg(0) Class88_Sub3 arg0, @OriginalArg(1) Class88_Sub3 arg1, @OriginalArg(2) float arg2) {
		if (!this.method25406()) {
			return false;
		}
		...
		this.aClass104_Sub1_46.method20441(local8, (byte) 1);
		local8.method23434(0, local20);
		if (local8.method23441()) {
			OpenGL.glPushMatrix();
		...
		local8.method23434(0, (Interface18) null);
		this.aClass104_Sub1_46.method20442(local8, -1497248091);
		return local22;
	}
	...
	boolean method25406() {
		if (this.aClass104_Sub1_46.aBoolean90 && this.aClass104_Sub1_46.aBoolean103 && this.aClass191_8 == null) {
			...
			if (local16 != null) {
				this.aClass191_8 = Class191.method24590(this.aClass104_Sub1_46, new Class190[] { local16 });
			}
		}
