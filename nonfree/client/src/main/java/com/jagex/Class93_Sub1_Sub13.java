...
public class Class93_Sub1_Sub13 extends Class93_Sub1 {
	...
	public Class93_Sub1_Sub13(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) Interface21 arg1) {
		...
		@Pc(9) int local9 = this.method22339(arg0);
		@Pc(11) int local11 = 0;
		@Pc(14) Class560[] local14 = Class527.method30390();
		while (arg0.anInt3070 * 212851357 < local9) {
			@Pc(26) Class560 local26 = this.method22338(arg0, local14);
			this.method22340(arg0, local11, local26);
			local11++;
		}
	}

	@OriginalMember(owner = "client!asc", name = "e", descriptor = "(Lclient!alw;[Lclient!ss;I)Lclient!ss;", line = 43)
	Class560 method22338(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) Class560[] arg1) {
	...
	int method22339(@OriginalArg(0) Class93_Sub41 arg0) {
		arg0.anInt3070 = (arg0.aByteArray58.length - 2) * -1445626955;
		@Pc(12) int local12 = arg0.method22415();
		@Pc(22) int local22 = arg0.aByteArray58.length - 2 - local12 - 16;
		arg0.anInt3070 = local22 * -1445626955;
		@Pc(31) int local31 = arg0.method22419();
		this.anInt3065 = arg0.method22415() * 1021108073;
		this.anInt3064 = arg0.method22415() * 1216778353;
		this.anInt3066 = arg0.method22415() * 2025161781;
		this.anInt3067 = arg0.method22415() * 1141903489;
		this.anInt3068 = arg0.method22415() * -116941733;
		this.anInt3063 = arg0.method22415() * -14211277;
		@Pc(77) int local77 = arg0.method22413();
		if (local77 > 0) {
			this.aClass16Array1 = new Class16[local77];
			for (@Pc(85) int local85 = 0; local85 < local77; local85++) {
				@Pc(92) int local92 = arg0.method22415();
				@Pc(103) Class16 local103 = new Class16(local92 > 0 ? Class134_Sub2.method10212(local92) : 1);
				this.aClass16Array1[local85] = local103;
				while (local92-- > 0) {
					@Pc(115) int local115 = arg0.method22419();
					@Pc(119) int local119 = arg0.method22419();
					local103.method221(new Class93_Sub14(local119), (long) local115);
				}
			}
		}
		arg0.anInt3070 = 0;
		this.aString106 = arg0.method22426();
	...
	void method22340(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class560 arg2) {
		@Pc(3) int local3 = this.aClass560Array1.length;
		if (arg2 == Class560.aClass560_799 || arg2 == Class560.aClass560_513) {
			@Pc(18) Class138 local18 = (Class138) Class107.method18119(Class138.method11526(), arg0.method22413());
			@Pc(22) int local22 = arg0.method22415();
			if (this.anObjectArray5 == null) {
				this.anObjectArray5 = new Object[local3];
			}
			this.anObjectArray5[arg1] = this.anInterface21_3.method27954(local18, local22);
			if (this.anIntArray259 == null) {
				this.anIntArray259 = new int[local3];
			}
			this.anIntArray259[arg1] = arg0.method22413();
		} else if (Class560.aClass560_6 == arg2) {
			@Pc(68) Class500 local68 = (Class500) Class107.method18119(Class500.method30159(), arg0.method22413());
			switch(local68.anInt5196 * -1217885029) {
				case 1:
					if (this.anObjectArray5 == null) {
						this.anObjectArray5 = new Object[local3];
					}
					this.anObjectArray5[arg1] = arg0.method22427().intern();
					break;
				case 2:
					if (this.anIntArray259 == null) {
						this.anIntArray259 = new int[local3];
					...
					this.anIntArray259[arg1] = arg0.method22419();
					break;
				case 3:
				default:
					throw new RuntimeException();
				case 4:
					...
					this.anObjectArray5[arg1] = arg0.method22423();
			}
		} else if (arg2 == Class560.aClass560_4 || Class560.aClass560_5 == arg2) {
			@Pc(139) int local139 = arg0.method22415();
			if (this.anObjectArray5 == null) {
				this.anObjectArray5 = new Object[local3];
			}
			this.anObjectArray5[arg1] = this.anInterface21_3.method27953(local139);
			if (this.anIntArray259 == null) {
				this.anIntArray259 = new int[local3];
			}
			this.anIntArray259[arg1] = arg0.method22413();
