...
public class Class597 {
	...
	public Class597(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class93_Sub41 arg2, @OriginalArg(3) int arg3) {
		if (Class288.anIntArray370 == null) {
			Class290.method26563();
		}
		this.anInt5520 = arg2.method22413() * -348646843;
		...
		@Pc(56) int local56 = arg2.method22415() << arg3;
		@Pc(62) int local62 = arg2.method22415() << arg3;
		@Pc(68) int local68 = arg2.method22415() << arg3;
		@Pc(72) int local72 = arg2.method22413();
		...
		for (local84 = 0; local84 < this.aShortArray142.length; local84++) {
			@Pc(94) short local94 = (short) arg2.method22415();
		...
		local84 = Class685.anIntArray524 == null ? Class685.anIntArray522[Class366.method27947(arg2.method22415()) & 0xFFFF] : Class685.anIntArray524[arg2.method22415()];
		@Pc(163) int local163 = arg2.method22413();
		this.anInt5528 = (local163 & 0x1F) * 219824953;
		this.anInt5525 = ((local163 & 0xE0) << 3) * -102991915;
		if (this.anInt5528 * 365017865 != 31) {
			this.method31778();
		}
		this.anInt5507 = arg2.method22482() * -1667838963;
		this.method31768(arg0, local56, local68, local62, local72, local84);
	}

	@OriginalMember(owner = "client!ul", name = "e", descriptor = "(Lclient!dh;IIIIII)V", line = 77)
	void method31768(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
	...
	public void method31767(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	void method31766(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		@Pc(32) int local32;
		if (arg1) {
			local32 = 2048;
		} else {
		...
		@Pc(91) float local91 = local84 * this.aClass93_Sub16_3.method13567();
		this.aClass93_Sub16_3.method13527(local91);
		this.aClass93_Sub16_3.method13537();
	}
	...
	static void method31769() {
		Class288.anIntArray370 = Class122_Sub3.method10157(2048, 35, 8, 8, 4, 0.4F, true);
	}
	...
	public static final void method31781(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) Color arg2, @OriginalArg(3) Color arg3, @OriginalArg(4) Color arg4) {
		try {
	...
	static final void method31782(@OriginalArg(0) Class681 arg0) {
		...
		if (Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aClass658_1 != null) {
			Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aClass658_1.method32787(local16);
		}
	}

	@OriginalMember(owner = "client!ul", name = "xk", descriptor = "(Lclient!yf;I)V", line = 9222)
	static final void method31779(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class431.method28781(local13, local23, true);
	}

	@OriginalMember(owner = "client!ul", name = "agl", descriptor = "(Lclient!yf;I)V", line = 10767)
	static final void method31783(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		@Pc(29) Class87 local29 = (Class87) Class124.aClass32_Sub21_7.method18261(local23);
		if (local29.method1508()) {
			arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = ((Class47) Class277.aClass32_Sub12_1.method18261(local13)).method922(local23, local29.aString11);
		} else {
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = ((Class47) Class277.aClass32_Sub12_1.method18261(local13)).method945(local23, local29.anInt265 * 951920133);
		}
	}

	@OriginalMember(owner = "client!ul", name = "atz", descriptor = "(Lclient!yf;I)V", line = 13293)
	static final void method31784(@OriginalArg(0) Class681 arg0) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub7_1.method15502();
	}

	@OriginalMember(owner = "client!ul", name = "aze", descriptor = "(Lclient!yf;I)V", line = 14119)
	static final void method31780(@OriginalArg(0) Class681 arg0) {
		@Pc(1) boolean local1 = true;
		if (client.aBoolean632) {
			try {
				@Pc(7) Object local7 = Class447.aClass447_8.method28902();
				if (local7 != null) {
