...
public class Class597 {
	...
	public Class597(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class93_Sub41 arg2, @OriginalArg(3) int arg3) {
		...
		this.anInt5520 = arg2.method22413((short) 16384) * -348646843;
		...
		@Pc(56) int local56 = arg2.method22415(-1434290800) << arg3;
		@Pc(62) int local62 = arg2.method22415(-1434290800) << arg3;
		@Pc(68) int local68 = arg2.method22415(-1434290800) << arg3;
		@Pc(72) int local72 = arg2.method22413((short) 16384);
		...
		for (local84 = 0; local84 < this.aShortArray142.length; local84++) {
			@Pc(94) short local94 = (short) arg2.method22415(-1434290800);
		...
		local84 = Class685.anIntArray524 == null ? Class685.anIntArray522[Class366.method27947(arg2.method22415(-1434290800), -328645812) & 0xFFFF] : Class685.anIntArray524[arg2.method22415(-1434290800)];
		@Pc(163) int local163 = arg2.method22413((short) 16384);
		this.anInt5528 = (local163 & 0x1F) * 219824953;
		this.anInt5525 = ((local163 & 0xE0) << 3) * -102991915;
		if (this.anInt5528 * 365017865 != 31) {
			this.method31778(-1852746510);
		}
		this.anInt5507 = arg2.method22482((byte) -97) * -1667838963;
		this.method31768(arg0, local56, local68, local62, local72, local84, 1702353788);
	}

	@OriginalMember(owner = "client!ul", name = "k", descriptor = "(IZI)V", line = 190)
	void method31766(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2) {
		@Pc(32) int local32;
		if (arg1) {
			local32 = 2048;
		} else {
	...
	public void method31767(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
	...
	void method31768(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.aClass93_Sub16_3 = arg0.method20526(arg1, arg2, arg3, arg4, arg5, 1.0F);
	}

	@OriginalMember(owner = "client!ul", name = "r", descriptor = "()V", line = 221)
	static void method31769() {
		Class288.anIntArray370 = Class122_Sub3.method10157(2048, 35, 8, 8, 4, 0.4F, true, 2018772054);
	}

	@OriginalMember(owner = "client!ul", name = "w", descriptor = "(Lclient!dh;IIIII)V", line = 77)
	void method31770(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		this.aClass93_Sub16_3 = arg0.method20526(arg1, arg2, arg3, arg4, arg5, 1.0F);
	}

	@OriginalMember(owner = "client!ul", name = "l", descriptor = "(IIII)V", line = 81)
	public void method31771(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.anInt5523 = arg0 * -225441611;
		this.anInt5527 = arg3 * 1691663947;
		this.anInt5502 = arg2 * 1968954047;
		this.anInt5524 = arg1 * 291390787;
	...
	public void method31772(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.anInt5523 = arg0 * -225441611;
		this.anInt5527 = arg3 * 1691663947;
		this.anInt5502 = arg2 * 1968954047;
		this.anInt5524 = arg1 * 291390787;
	...
	static void method31776() {
		Class288.anIntArray370 = Class122_Sub3.method10157(2048, 35, 8, 8, 4, 0.4F, true, 2117174641);
	}

	@OriginalMember(owner = "client!ul", name = "v", descriptor = "()V", line = 221)
	static void method31777() {
		Class288.anIntArray370 = Class122_Sub3.method10157(2048, 35, 8, 8, 4, 0.4F, true, 2064110556);
	}

	@OriginalMember(owner = "client!ul", name = "m", descriptor = "(I)V", line = 88)
	void method31778(@OriginalArg(0) int arg0) {
		switch(this.anInt5528 * 365017865) {
			case 2:
				this.anInt5523 = -225441611;
				this.anInt5527 = 0;
	...
	static final void method31779(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class431.method28781(local13, local23, true, (byte) 113);
	}
	...
	static final void method31780(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		if (client.aBoolean632) {
			try {
				@Pc(7) Object local7 = Class447.aClass447_8.method28902((short) 255);
				if (local7 != null) {
	...
	public static final void method31781(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) Color arg2, @OriginalArg(3) Color arg3, @OriginalArg(4) Color arg4, @OriginalArg(5) int arg5) {
		try {
	...
	static final void method31782(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		if (Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aClass658_1 != null) {
			Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aClass658_1.method32787(local16, (byte) 73);
		}
	}
	...
	static final void method31783(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		if (local29.method1508(1429228259)) {
			arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = ((Class47) Class277.aClass32_Sub12_1.method18261(local13, -1108511711)).method922(local23, local29.aString11, (byte) -76);
		} else {
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = ((Class47) Class277.aClass32_Sub12_1.method18261(local13, -83147903)).method945(local23, local29.anInt265 * 951920133, 1208021862);
		}
	}
	...
	static final void method31784(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub7_1.method15502((byte) -125);
	}
}
