...
class Class262 implements Interface39 {
	...
	public static int method26169(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1) {
	...
	public float method26346() {
		return (float) Class51.aClass93_Sub36_1.aClass166_Sub35_1.method16223() / 255.0F;
	}
	...
	public static final void method26173() {
		@Pc(4) int local4 = Class51.aClass93_Sub36_1.aClass166_Sub15_2.method15673();
		if (local4 == 0) {
			client.aClass532_1.method30491(null);
			Class75.method1270(0);
		} else if (local4 == 1 || local4 == 3) {
			Class249.method25945((byte) 0);
			Class75.method1270(512);
			if (client.aClass532_1.method30459() != null) {
				Class110.method20148();
			}
		} else {
			Class249.method25945((byte) (client.anInt3495 * 1815175593 - 4 & 0xFF));
			Class75.method1270(2);
		}
		client.anInt3559 = Class512.anInt5209 * -1452064847;
	}

	@OriginalMember(owner = "client!ff", name = "fx", descriptor = "(Lclient!yf;I)V", line = 5924)
	static final void method26170(@OriginalArg(0) Class681 arg0) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class533.method30602(local11, local14, arg0);
	}

	@OriginalMember(owner = "client!ff", name = "jz", descriptor = "(Lclient!yf;I)V", line = 6701)
	static final void method26171(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= -1915563430;
	}

	@OriginalMember(owner = "client!ff", name = "alp", descriptor = "(Lclient!yf;I)V", line = 11947)
	static final void method26172(@OriginalArg(0) Class681 arg0) {
