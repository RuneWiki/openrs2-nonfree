...
class Class262 implements Interface39 {
	...
	public float method26346() {
		return (float) Class51.aClass93_Sub36_1.aClass166_Sub35_1.method16223(1740916554) / 255.0F;
	}
	...
	public float method26345(@OriginalArg(0) int arg0) {
		return (float) Class51.aClass93_Sub36_1.aClass166_Sub35_1.method16223(-1754336219) / 255.0F;
	}

	@OriginalMember(owner = "client!ff", name = "d", descriptor = "(Ljava/lang/String;Ljava/lang/String;B)I", line = 184)
	public static int method26169(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) byte arg2) {
		if (Class625.aBoolean848) {
			return Class330.method27372(-2045565124) == client.aClass175_2 ? Class166_Sub13.aTwitchTV1.Login(arg0, arg1) : 42;
		} else {
			return 12;
		}
	}
	...
	static final void method26170(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class533.method30602(local11, local14, arg0, (byte) -84);
	}

	@OriginalMember(owner = "client!ff", name = "jz", descriptor = "(Lclient!yf;I)V", line = 6701)
	static final void method26171(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	public static final void method26173(@OriginalArg(0) int arg0) {
		@Pc(4) int local4 = Class51.aClass93_Sub36_1.aClass166_Sub15_2.method15673(1349843171);
		if (local4 == 0) {
			client.aClass532_1.method30491((byte[][][]) null, 1388606318);
			...
			if (client.aClass532_1.method30459(-1092450087) != null) {
				Class110.method20148(-2108217161);
			}
		} else {
	...
	static void method26174(@OriginalArg(0) short arg0) {
