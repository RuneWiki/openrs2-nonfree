...
public abstract class Class107 {
	...
	static final void method18116(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method18117(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method18118(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		if (local12 == -1) {
		...
		@Pc(29) Class611 local29 = client.aClass532_1.method30443(1893284929);
		local21 -= local29.anInt5623 * 270611681;
		if (local21 < 0) {
			local21 = 0;
		} else if (local21 >= client.aClass532_1.method30444(-1357363239)) {
			local21 = client.aClass532_1.method30444(1080896010);
		}
		local25 -= local29.anInt5624 * -1994307635;
		if (local25 < 0) {
			local25 = 0;
		} else if (local25 >= client.aClass532_1.method30474((short) 128)) {
			local25 = client.aClass532_1.method30474((short) 128);
		}
	...
	public static Interface75 method18119(@OriginalArg(0) Interface75[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	public static String method18120(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2) {
		return arg1 && arg0 >= 0 ? Class703.method36725(arg0, 10, arg1, -235499267) : Integer.toString(arg0);
	}

	@OriginalMember(owner = "client!dz", name = "uz", descriptor = "(Lclient!yf;I)V", line = 8601)
	static final void method18121(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1478859549);
	...
	static void method18122(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class610 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		@Pc(40) Class100 local40 = local8.method1174(arg0, arg2, arg1.aBoolean836, 608157392);
		if (local40 == null) {
			return;
		}
		...
		@Pc(74) int local74 = local40.method18166();
		if (local8.aBoolean30) {
			local71 = local48 * 4;
			local74 = local53 * 4;
		}
		if (local8.anInt233 * -1811914921 == 0) {
			local40.method18203(arg3, arg4 - (local53 - 1) * 4, local71, local74);
		} else {
			local40.method18176(arg3, arg4 - (local53 - 1) * 4, local71, local74, 0, local8.anInt233 * -1811914921 | 0xFF000000, 1);
		}
	}

	@OriginalMember(owner = "client!dz", name = "z", descriptor = "([I[Ljava/lang/Object;I)V", line = 183)
	public static void method18123(@OriginalArg(0) int[] arg0, @OriginalArg(1) Object[] arg1, @OriginalArg(2) int arg2) {
		Class350.method27634(arg0, arg1, 0, arg0.length - 1, -135837942);
	}
}
