...
public abstract class Class107 {
	...
	public static Interface75 method18119(@OriginalArg(0) Interface75[] arg0, @OriginalArg(1) int arg1) {
	...
	public static String method18120(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
	...
	public static void method18123(@OriginalArg(0) int[] arg0, @OriginalArg(1) Object[] arg1) {
	...
	static void method18122(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class610 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(8) Class65 local8 = (Class65) Class466.aClass32_Sub20_3.method18261(arg1.anInt5601 * -303013723);
		...
		@Pc(40) Class100 local40 = local8.method1174(arg0, arg2, arg1.aBoolean836);
		if (local40 == null) {
			return;
		}
	...
	static final void method18121(@OriginalArg(0) Class681 arg0) {
	...
	static final void method18116(@OriginalArg(0) Class681 arg0) {
	...
	static final void method18117(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class36.method693((char) local12) ? 1 : 0;
	}

	@OriginalMember(owner = "client!dz", name = "any", descriptor = "(Lclient!yf;B)V", line = 12219)
	static final void method18118(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		if (local12 == -1) {
		...
		@Pc(29) Class611 local29 = client.aClass532_1.method30443();
		local21 -= local29.anInt5623 * 270611681;
		if (local21 < 0) {
			local21 = 0;
		} else if (local21 >= client.aClass532_1.method30444()) {
			local21 = client.aClass532_1.method30444();
		}
		local25 -= local29.anInt5624 * -1994307635;
		if (local25 < 0) {
			local25 = 0;
		} else if (local25 >= client.aClass532_1.method30474()) {
			local25 = client.aClass532_1.method30474();
		}
