...
public class Class542 {
	...
	public static void method30931(@OriginalArg(0) boolean arg0) {
		Class274.aClass258_1.method26032((short) -13558);
	...
	public static void method30932(@OriginalArg(0) boolean arg0) {
		...
		for (@Pc(13) int local13 = 0; local13 < local11.length; local13++) {
			...
			local21.anInt3300 = 0;
			if (!local21.aBoolean564 && local21.method24356((byte) 39) != null) {
				@Pc(52) Class93_Sub22 local52 = Class102.method2592(Class446.aClass446_105, local21.aClass24_2, (byte) 13);
				local21.method24351(local52, -1864049693);
				try {
					local21.method24350((byte) 113);
				} catch (@Pc(61) IOException local61) {
					local21.aBoolean564 = true;
				}
			}
		}
		Class274.aClass258_1.method26032((short) -5435);
	}
	...
	public static void method30933(@OriginalArg(0) boolean arg0) {
		Class274.aClass258_1.method26032((short) 1631);
		...
		for (@Pc(13) int local13 = 0; local13 < local11.length; local13++) {
			...
			local21.anInt3300 = 0;
			if (!local21.aBoolean564 && local21.method24356((byte) 2) != null) {
				@Pc(52) Class93_Sub22 local52 = Class102.method2592(Class446.aClass446_105, local21.aClass24_2, (byte) 112);
				local21.method24351(local52, -1994753786);
				try {
					local21.method24350((byte) 118);
				} catch (@Pc(61) IOException local61) {
					local21.aBoolean564 = true;
				}
			}
		}
		Class274.aClass258_1.method26032((short) -523);
	}

	@OriginalMember(owner = "client!rz", name = "cn", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;I)V", line = 5334)
	static final void method30934(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		Class237.method25776(arg1, arg0, (byte) 92);
		if (arg0.anInt3971 * -158526639 == 0) {
			Class548.method31016(arg1, arg0, false, 663954921);
		}
	}

	@OriginalMember(owner = "client!rz", name = "yn", descriptor = "(Lclient!yf;B)V", line = 9268)
	static final void method30935(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	public static void method30936(@OriginalArg(0) int arg0) {
		Class563.method31195();
	}

	@OriginalMember(owner = "client!rz", name = "h", descriptor = "(IB)V", line = 147)
	public static void method30937(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		@Pc(4) Class93_Sub1_Sub11 local4 = Class371.method28006(13, (long) arg0);
		local4.method21865(2145665316);
	}
}
