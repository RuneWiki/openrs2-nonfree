...
class Class518 implements Interface55 {
	...
	static final void method30304(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5891 -= -725861497;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		@Pc(33) int local33 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 2];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class258.method26139(local13, local23, local33, 2046032822);
	}
	...
	public static void method30305(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(3) Class611 local3 = client.aClass532_1.method30443(1708149186);
		@Pc(10) int local10 = arg1 + local3.anInt5623 * 270611681;
		@Pc(17) int local17 = local3.anInt5624 * -1994307635 + arg2;
		if (client.aClass532_1.method30459(-1692526925) == null || client.aClass532_1.method30544(-1000241849) == Class526.aClass526_2 || arg1 < 0 || arg2 < 0 || arg1 >= client.aClass532_1.method30444(978808638) || arg2 >= client.aClass532_1.method30474((short) 128)) {
			return;
		}
		...
		if (local57 == null) {
			client.aClass532_1.method30459(-1541129926).method31471(arg0, arg1, arg2, (byte) 0);
			return;
		}
		@Pc(75) Class93_Sub3 local75 = (Class93_Sub3) local57.aClass22_17.method445((byte) 102);
		if (local75 == null) {
			client.aClass532_1.method30459(-1343606828).method31471(arg0, arg1, arg2, (byte) 0);
			return;
		}
		@Pc(89) int local89 = -1;
		@Pc(91) int local91 = -1;
		...
		@Pc(109) Class132_Sub1_Sub5_Sub1 local109 = (Class132_Sub1_Sub5_Sub1) client.aClass532_1.method30459(-1363026273).method31471(arg0, arg1, arg2, (byte) 0);
		if (local109 == null) {
			local109 = new Class132_Sub1_Sub5_Sub1(client.aClass532_1.method30459(-1098561897), arg1 << 9, client.aClass532_1.method30459(-1889998591).aClass99Array1[arg0].method2482(arg1, arg2, -1141511953), arg2 << 9, arg0, arg0);
		} else {
			...
			local109.aClass585_23 = client.aClass532_1.method30459(-1964126979);
		}
		...
		@Pc(274) int local274 = Class305.method26801((arg1 << 9) + 256, (arg2 << 9) + 256, arg0, (byte) -114);
		...
		if (client.aClass532_1.method30509(-1897195293).method30330(arg1, arg2, -662808309)) {
			local109.aByte99++;
		}
		client.aClass532_1.method30459(-1861143396).method31447(arg0, arg1, arg2, local274, local109, (short) 4365);
	}

	@OriginalMember(owner = "client!qv", name = "w", descriptor = "(Lclient!yf;I)V", line = 40)
	static void method30306(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
