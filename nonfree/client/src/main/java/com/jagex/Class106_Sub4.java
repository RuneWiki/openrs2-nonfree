...
public class Class106_Sub4 extends Class106 {
	...
	Class106_Sub4(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) Class5 arg1, @OriginalArg(2) Class105 arg2, @OriginalArg(3) boolean arg3) {
		...
		if (arg3) {
			...
			this.aClass88_Sub2_Sub1_4 = Class88_Sub2_Sub1.method18102(arg0, Class206.aClass206_19, Class226.aClass226_22, this.aClass5_10.anInt12 * -2141347013, this.aClass5_10.anInt13 * -345881099, false, local38, Class206.aClass206_19);
			...
			if (arg2.method7154()) {
				...
				@Pc(227) Class105_Sub1 local227 = (Class105_Sub1) arg2;
				local166 = local227.method7171(false);
				if (local227.method7211()) {
			...
			this.aClass88_Sub2_Sub1_4 = Class88_Sub2_Sub1.method18101(arg0, this.aClass5_10.anInt12 * -2141347013, this.aClass5_10.anInt13 * -345881099, false, local19, 0, 0);
			this.aBoolean170 = false;
		}
		this.aClass88_Sub2_Sub1_4.method18041(this.aClass5_10.anInt11 * 286794121 != 1);
		...
		for (local43 = 0; local43 < 256; local43++) {
			local77 = arg1.method62(local43);
			local85 = arg1.method33(local43);
			@Pc(355) short[] local355 = this.aClass5_10.method65(local43);
			...
			@Pc(397) int local397 = this.aClass5_10.method64(local43);
			this.aClass182_6.method24559(local43);
			OpenGL.glBegin(7);
	...
	void method7533(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		...
		this.aClass182_6.method24560(arg0);
