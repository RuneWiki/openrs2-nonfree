...
public class Class233 implements Interface75 {
	...
	static final Class233 aClass233_4 = new Class233(0, 0, (String) null, 0);

	@OriginalMember(owner = "client!dt", name = "n", descriptor = "Lclient!dt;")
	static final Class233 aClass233_2 = new Class233(1, 1, (String) null, 3);

	@OriginalMember(owner = "client!dt", name = "m", descriptor = "Lclient!dt;")
	static final Class233 aClass233_5 = new Class233(2, 2, (String) null, 3);

	@OriginalMember(owner = "client!dt", name = "k", descriptor = "Lclient!dt;")
	static final Class233 aClass233_1 = new Class233(3, 3, (String) null, 6);

	@OriginalMember(owner = "client!dt", name = "f", descriptor = "Lclient!dt;")
	static final Class233 aClass233_3 = new Class233(4, 4, (String) null, 1);
	...
	int method25727(@OriginalArg(0) int arg0) {
		return this.anInt3752 * 2005986515;
	}
	...
	static Class233 method25729(@OriginalArg(0) int arg0) {
		@Pc(6) Class233 local6 = (Class233) Class107.method18119(Class484.method29792(-71261155), arg0, -1915563430);
		if (local6 == null) {
			local6 = aClass233_4;
		}
		return local6;
	...
	static Class233 method25730(@OriginalArg(0) int arg0) {
		@Pc(6) Class233 local6 = (Class233) Class107.method18119(Class484.method29792(1675780644), arg0, -1915563430);
		if (local6 == null) {
			local6 = aClass233_4;
		}
		return local6;
	...
	static final void method25732(@OriginalArg(0) Class132_Sub1_Sub1_Sub1 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) byte arg2) {
		...
		if (arg0.anInt2780 * -2095106181 > client.anInt3485) {
			...
			Class391.method28289(arg0, 1709961333);
		} else {
		...
		@Pc(79) int local79;
		if ((int) local40.aFloat317 < 512 || (int) local40.aFloat319 < 512 || (int) local40.aFloat317 >= (client.aClass532_1.method30444(-1759365087) - 1) * 512 || (int) local40.aFloat319 >= (client.aClass532_1.method30474((short) 128) - 1) * 512) {
			arg0.aClass19_3.method23568(-1, 1232633249);
			for (local79 = 0; local79 < arg0.aClass554Array3.length; local79++) {
				arg0.aClass554Array3[local79].anInt5319 = 1020147287;
				arg0.aClass554Array3[local79].aClass19_7.method23568(-1, 264288096);
			}
			...
			local4 = 0;
			arg0.method24231((float) (arg0.anIntArray240[0] * 512 + arg0.method19997(-446245406) * 256), local40.aFloat318, (float) (arg0.anIntArray239[0] * 512 + arg0.method19997(1874595208) * 256));
			arg0.method19974((byte) -87);
		}
		if (arg0 == Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3 && ((int) local40.aFloat317 < 6144 || (int) local40.aFloat319 < 6144 || (int) local40.aFloat317 >= (client.aClass532_1.method30444(540916552) - 12) * 512 || (int) local40.aFloat319 >= (client.aClass532_1.method30474((short) 128) - 12) * 512)) {
			arg0.aClass19_3.method23568(-1, 709870896);
			for (local79 = 0; local79 < arg0.aClass554Array3.length; local79++) {
				arg0.aClass554Array3[local79].anInt5319 = 1020147287;
				arg0.aClass554Array3[local79].aClass19_7.method23568(-1, 1624789129);
			}
			arg0.anIntArray236 = null;
			arg0.anInt2780 = 0;
			arg0.anInt2762 = 0;
			local2 = Class707.aClass707_5.aByte176;
			local4 = 0;
			arg0.method24231((float) (arg0.anIntArray240[0] * 512 + arg0.method19997(-932437891) * 256), local40.aFloat318, (float) (arg0.anIntArray239[0] * 512 + arg0.method19997(-1495544396) * 256));
			arg0.method19974((byte) -7);
		}
		local79 = Class721.method36921(arg0, (byte) -57);
		Class669.method32945(arg0, -648220126);
		Class504.method30201(arg0, local2, local4, local79, -1077736889);
		Class552.method31046(arg0, local2, (byte) 54);
		Class58.method1103(arg0, 749925756);
		@Pc(279) Class471 local279 = Class471.method29521();
		local279.method29467(Class464.method29282(arg0.aClass523_7.method30363(-1178491922)), Class464.method29282(arg0.aClass523_8.method30363(-351037450)), Class464.method29282(arg0.aClass523_9.method30363(1915370671)));
	...
	static final void method25733(@OriginalArg(0) int arg0) {
		...
		if (Class512.anInt5209 * 1177442423 != client.anInt3559 * -1248097113) {
			Class262.method26173(2147444241);
		}
	}

	@OriginalMember(owner = "client!dt", name = "c", descriptor = "(Ljava/lang/String;ZI)V", line = 199)
	public static void method25734(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2) {
		if (13 == client.anInt3435 * -849002901 && (!Class251.method25973(1137219895) && !Class631.method32282(-901725234))) {
