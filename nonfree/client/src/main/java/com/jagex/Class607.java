...
public class Class607 implements Interface67 {
	...
	public boolean method32251(@OriginalArg(0) Class93_Sub23 arg0, @OriginalArg(1) Interface66[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class158 arg3) {
		for (@Pc(1) int local1 = 0; local1 < arg2 && local1 < arg1.length; local1++) {
			...
			if (local12 != null && local12.method13696() == this.anInt5558 * 504824481 && local12.method13689() == this.anInt5559 * 1060431903) {
				return true;
			}
		}
		return false;
	...
	@Override
	public boolean method32253(@OriginalArg(0) Class93_Sub23 arg0, @OriginalArg(1) Interface66[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class158 arg3) {
		for (@Pc(1) int local1 = 0; local1 < arg2 && local1 < arg1.length; local1++) {
			@Pc(12) Interface66 local12 = arg1[local1];
			if (local12 != null && local12.method13696() == this.anInt5558 * 504824481 && local12.method13689() == this.anInt5559 * 1060431903) {
				return true;
	...
	static final void method31924(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class129.method21476(local16, local22, arg0);
	}

	@OriginalMember(owner = "client!va", name = "sz", descriptor = "(Lclient!yf;I)V", line = 8283)
	static final void method31925(@OriginalArg(0) Class681 arg0) {
	...
	static final void method31929(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12);
	...
	static final void method31923(@OriginalArg(0) Class681 arg0) {
	...
	static final void method31927(@OriginalArg(0) Class681 arg0) {
		@Pc(13) String local13 = (String) arg0.anObjectArray45[(arg0.anInt5888 -= 957530791) * 587908375];
		@Pc(19) Class93_Sub22 local19 = Class102.method2592(Class446.aClass446_62, client.aClass175_1.aClass24_2);
		local19.aClass93_Sub41_Sub2_1.method22510(Class46.method894(local13));
		local19.aClass93_Sub41_Sub2_1.method22402(local13);
		client.aClass175_1.method24351(local19);
	}

	@OriginalMember(owner = "client!va", name = "aei", descriptor = "(Lclient!yf;B)V", line = 10380)
	static final void method31921(@OriginalArg(0) Class681 arg0) {
	...
	static final void method31926(@OriginalArg(0) Class681 arg0) {
		@Pc(13) CharSequence local13 = (CharSequence) arg0.anObjectArray45[(arg0.anInt5888 -= 957530791) * 587908375];
		arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = Class25_Sub2.method16021(local13);
	}
}
