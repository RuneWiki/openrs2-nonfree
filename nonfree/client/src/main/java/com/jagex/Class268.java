...
public class Class268 implements Interface13, Interface5 {
	...
	void method26260(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		@Pc(10) int local10;
		@Pc(12) int local12;
		if (arg1 == 2) {
			this.aBooleanArray23 = new boolean[400];
			local10 = arg0.method22632();
			for (local12 = 0; local12 < local10; local12++) {
				this.aBooleanArray23[arg0.method22632()] = true;
			}
		} else if (arg1 == 3) {
			arg0.method22413();
			local10 = arg0.method22632();
	...
	public static void method26264(@OriginalArg(0) Class390 arg0, @OriginalArg(1) Class392 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10) {
	...
	static final void method26266() {
		...
		if (!Class454.aBoolean773) {
			Class264.method26212();
		}
		for (@Pc(27) int local27 = 0; local27 < 100 && Class247.method25919(client.aClass175_2); local27++) {
		}
		...
		while (Class33.method677()) {
			local52 = Class102.method2592(Class446.aClass446_74, client.aClass175_2.aClass24_2);
			local52.aClass93_Sub41_Sub2_1.method22510(0);
			local63 = local52.aClass93_Sub41_Sub2_1.anInt3070 * 212851357;
			Class359.method27788(local52.aClass93_Sub41_Sub2_1);
			local52.aClass93_Sub41_Sub2_1.method22537(local52.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local63);
			client.aClass175_2.method24351(local52);
		}
		@Pc(129) int local129;
		if (Class653.aClass678_2 == null) {
			if (Class305.method26796() >= Class442.aLong276 * 2005126307215913191L) {
				Class653.aClass678_2 = client.aClass698_1.method36698(Class50.aClass28_5.aString4);
			}
		} else if (Class653.aClass678_2.anInt5886 * 1528915565 != -1) {
			local52 = Class102.method2592(Class446.aClass446_76, client.aClass175_2.aClass24_2);
			...
			@Pc(127) long local127 = Class305.method26796();
			local129 = -1;
			...
			local52.aClass93_Sub41_Sub2_1.method22590(Class653.aClass678_2.anInt5886 * 1528915565);
			local52.aClass93_Sub41_Sub2_1.method22448(client.anInt3407 * 1249273355);
			local52.aClass93_Sub41_Sub2_1.method22510(local129);
			client.aClass175_2.method24351(local52);
			Class653.aClass678_2 = null;
			Class442.aLong276 = (local127 + 30000L) * 3040038476132704983L;
		}
		Class285.method26513();
		Class591.method31696();
		@Pc(226) Class93_Sub23 local226 = (Class93_Sub23) client.aClass22_45.method445();
		if (client.aClass532_1.method30459() != null) {
			if (Class429.anInt4781 * -1453926679 == 5) {
				Class166_Sub6.method15485();
		...
		if (Class253.method25995()) {
			Class226.method25608();
		} else if (Class429.anInt4781 * -1453926679 == 3) {
			@Pc(278) Class611 local278 = client.aClass532_1.method30443();
			...
			if (Class120.aLong32 * 3284406794071211249L <= 0L) {
				Class120.aLong32 = Class305.method26796() * -7990349007261731823L;
			}
			@Pc(311) float local311 = (float) (Class305.method26796() - Class120.aLong32 * 3284406794071211249L);
			@Pc(316) int local316 = 1000 / Class451.method28948();
			@Pc(322) int local322 = (int) ((double) local316 * 1.25D);
			while (local311 > 0.0F) {
				@Pc(331) float local331 = Math.min(local311, (float) local322);
				Class65.aClass123_Sub1_2.method8924(local331 / 1000.0F, client.aClass532_1.method30460().anIntArrayArrayArray14, client.aClass532_1.method30509(), local285, local129);
				local311 -= local322;
			}
			Class120.aLong32 = Class305.method26796() * -7990349007261731823L;
		}
		Class233.method25733();
		if (client.anInt3435 * -849002901 != 18) {
			return;
		}
		client.aClass532_1.method30532().method32987(client.aClass532_1);
		Class296.method26610();
		...
		if (client.anInt3463 * 1819062465 == 3) {
			Class608.method31961();
			Class110_Sub1.method6370();
		} else if (Class119.aClass650_2.anInterface67_5.method32253(local226, client.anInterface66Array1, client.anInt3450 * -938319179, Class112_Sub2_Sub2.aClass158_2)) {
			Class501.method30172(false);
		} else {
			if (client.anInt3463 * 1819062465 == 2 && Class661.method32840(client.anInt3462 * 1756332913)) {
				client.aClass532_1.method30465(new Class537(Class526.aClass526_2, null));
				client.anInt3463 = 389013313;
			}
			if (client.anInt3463 * 1819062465 == 1 && client.anInt3435 * -849002901 != 3) {
				Class249.aClass16_24.method219();
				client.anInt3463 = 0;
				client.anInt3556 = client.anInt3485 * 389330083;
				client.anInt3436 = 0;
				client.aBoolean613 = false;
				Class212.method25444();
			}
				...
				if (client.anInt3463 * 1819062465 == 0) {
					for (local285 = 0; local285 < Class249.aClass239Array1.length; local285++) {
						...
						if (local528.aBoolean662) {
							@Pc(536) Class132_Sub1_Sub1_Sub1 local536 = local528.method25807();
							Class233.method25732(local536, true);
						}
					}
				}
			}
		}
		Class393.method28323();
		Class147.method12704();
		Class663.method32869();
		Class275.method26344(false);
		Class602.method31868(Class694.aClass104_14, Class619.aClass225_8);
		...
		Class32_Sub15.method17181(null, -1, -1);
		if (!client.aBoolean625) {
			client.anInt3520 = 410366683;
		}
		Class356.method27706();
		client.anInt3565 += -782787733;
		@Pc(622) Class93_Sub22 local622;
		if (client.aBoolean635) {
			local622 = Class102.method2592(Class446.aClass446_10, client.aClass175_2.aClass24_2);
			local622.aClass93_Sub41_Sub2_1.method22467(Class570.anInt5397 * -554382929 << 28 | Class523.anInt5225 * -2075541317 << 14 | Class562.anInt5352 * 1760194437);
			client.aClass175_2.method24351(local622);
		...
		while (true) {
			...
			do {
				local652 = (Class93_Sub39) client.aClass22_48.method408();
				if (local652 == null) {
					while (true) {
						do {
							local652 = (Class93_Sub39) client.aClass22_49.method408();
							if (local652 == null) {
								while (true) {
									do {
										local652 = (Class93_Sub39) client.aClass22_47.method408();
										if (local652 == null) {
											if (Class378.aClass312_10 == null) {
												client.anInt3535 = 0;
											}
											if (client.aClass312_5 != null) {
												Class491.method29980();
											}
											Class593.method31723();
											if (client.anInt3514 * 2055688893 > 0 && Class112_Sub2_Sub2.aClass158_2.method14308(82) && Class112_Sub2_Sub2.aClass158_2.method14308(81) && client.anInt3446 * 1897469075 != 0) {
												...
												@Pc(855) Class611 local855 = client.aClass532_1.method30443();
												Class684.method33424(local63, local855.anInt5623 * 270611681 + Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.anIntArray240[0], local855.anInt5624 * -1994307635 + Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.anIntArray239[0]);
											}
											for (local63 = 0; local63 < 5; local63++) {
												@Pc(885) int local885 = client.anIntArray318[local63]++;
											}
											if (Class596.aClass113_Sub1_1.aBoolean171 && Class596.aClass113_Sub1_1.aLong26 * 333245577734160197L < Class305.method26796() - 60000L) {
												Class25.method23134();
											}
											Class596.aClass113_Sub1_1.method7413();
											for (@Pc(913) Class149_Sub2 local913 = (Class149_Sub2) client.aClass21_8.method390(); local913 != null; local913 = (Class149_Sub2) client.aClass21_8.method377()) {
												if ((long) (local913.anInt1400 * 147268085) < Class305.method26796() / 1000L - 5L) {
													if (local913.aShort77 > 0) {
														Class227.method25614(5, 0, "", "", "", local913.aString42 + Class74.aClass74_1.method1259(Class106.aClass717_8), null);
													}
													if (local913.aShort77 == 0) {
														Class227.method25614(5, 0, "", "", "", local913.aString42 + Class74.aClass74_126.method1259(Class106.aClass717_8), null);
													}
													local913.method23766();
												}
											}
											...
											if (client.aClass175_2.anInt3300 * -1270889673 > 50) {
												local622 = Class102.method2592(Class446.aClass446_105, client.aClass175_2.aClass24_2);
												client.aClass175_2.method24351(local622);
											}
											...
											try {
												client.aClass175_2.method24350();
										...
										local671 = Class659.method32805(local659.anInt3985 * 897022795);
	...
	static final void method26267(@OriginalArg(0) Class681 arg0) {
	...
	static final void method26265(@OriginalArg(0) Class681 arg0) {
