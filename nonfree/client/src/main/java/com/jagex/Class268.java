...
public class Class268 implements Interface13, Interface5 {
	...
	void method26260(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if (arg1 == 2) {
			...
			local10 = arg0.method22632((byte) -25);
			for (local12 = 0; local12 < local10; local12++) {
				this.aBooleanArray23[arg0.method22632((byte) -77)] = true;
			}
		} else if (arg1 == 3) {
			arg0.method22413((short) 16384);
			local10 = arg0.method22632((byte) -110);
			for (local12 = 0; local12 < local10; local12++) {
				arg0.method22632((byte) -125);
				arg0.method22413((short) 16384);
			}
		}
	}
	...
	void method26261(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		if (arg1 == 2) {
			this.aBooleanArray23 = new boolean[400];
			local10 = arg0.method22632((byte) -54);
			for (local12 = 0; local12 < local10; local12++) {
				this.aBooleanArray23[arg0.method22632((byte) -41)] = true;
			}
		} else if (arg1 == 3) {
			arg0.method22413((short) 16384);
			local10 = arg0.method22632((byte) -88);
			for (local12 = 0; local12 < local10; local12++) {
				arg0.method22632((byte) -80);
				arg0.method22413((short) 16384);
			}
		}
	}
	...
	void method26262(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		if (arg1 == 2) {
			this.aBooleanArray23 = new boolean[400];
			local10 = arg0.method22632((byte) -3);
			for (local12 = 0; local12 < local10; local12++) {
				this.aBooleanArray23[arg0.method22632((byte) -1)] = true;
			}
		} else if (arg1 == 3) {
			arg0.method22413((short) 16384);
			local10 = arg0.method22632((byte) -100);
			for (local12 = 0; local12 < local10; local12++) {
				arg0.method22632((byte) -19);
				arg0.method22413((short) 16384);
			}
		}
	}
	...
	void method26263(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		if (arg1 == 2) {
			this.aBooleanArray23 = new boolean[400];
			local10 = arg0.method22632((byte) -84);
			for (local12 = 0; local12 < local10; local12++) {
				this.aBooleanArray23[arg0.method22632((byte) -51)] = true;
			}
		} else if (arg1 == 3) {
			arg0.method22413((short) 16384);
			local10 = arg0.method22632((byte) -58);
			for (local12 = 0; local12 < local10; local12++) {
				arg0.method22632((byte) -74);
				arg0.method22413((short) 16384);
			}
		}
	}
	...
	static final void method26265(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5891 -= 1189701933;
	}

	@OriginalMember(owner = "client!fm", name = "fe", descriptor = "(I)V", line = 2879)
	static final void method26266(@OriginalArg(0) int arg0) {
		...
		if (!Class454.aBoolean773) {
			Class264.method26212((byte) -109);
		}
		for (@Pc(27) int local27 = 0; local27 < 100 && Class247.method25919(client.aClass175_2, -305693694); local27++) {
		}
		...
		while (Class33.method677(-1408990993)) {
			...
			local52.aClass93_Sub41_Sub2_1.method22510(0, (byte) -38);
			local63 = local52.aClass93_Sub41_Sub2_1.anInt3070 * 212851357;
			Class359.method27788(local52.aClass93_Sub41_Sub2_1, -1023210575);
			local52.aClass93_Sub41_Sub2_1.method22537(local52.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local63, (byte) 87);
			client.aClass175_2.method24351(local52, -1777674683);
		}
		@Pc(129) int local129;
		if (Class653.aClass678_2 == null) {
			if (Class305.method26796(1272065378) >= Class442.aLong276 * 2005126307215913191L) {
				Class653.aClass678_2 = client.aClass698_1.method36698(Class50.aClass28_5.aString4, (byte) 1);
			}
			...
			@Pc(127) long local127 = Class305.method26796(1230136145);
			local129 = -1;
			...
			local52.aClass93_Sub41_Sub2_1.method22590(Class653.aClass678_2.anInt5886 * 1528915565, (byte) 42);
			local52.aClass93_Sub41_Sub2_1.method22448(client.anInt3407 * 1249273355, (byte) -74);
			local52.aClass93_Sub41_Sub2_1.method22510(local129, (byte) 3);
			client.aClass175_2.method24351(local52, -1641840970);
		...
		@Pc(285) int local285;
		if (Class253.method25995((byte) 19)) {
			Class226.method25608((byte) 21);
		} else if (Class429.anInt4781 * -1453926679 == 3) {
			@Pc(278) Class611 local278 = client.aClass532_1.method30443(1948712438);
			...
			if (Class120.aLong32 * 3284406794071211249L <= 0L) {
				Class120.aLong32 = Class305.method26796(-45083014) * -7990349007261731823L;
			}
			@Pc(311) float local311 = (float) (Class305.method26796(1348635194) - Class120.aLong32 * 3284406794071211249L);
			@Pc(316) int local316 = 1000 / Class451.method28948((byte) 3);
			@Pc(322) int local322 = (int) ((double) local316 * 1.25D);
			while (local311 > 0.0F) {
				@Pc(331) float local331 = Math.min(local311, (float) local322);
				Class65.aClass123_Sub1_2.method8924(local331 / 1000.0F, client.aClass532_1.method30460(-310507201).anIntArrayArrayArray14, client.aClass532_1.method30509(209855820), local285, local129, 1160510591);
				local311 -= (float) local322;
			}
			Class120.aLong32 = Class305.method26796(889115132) * -7990349007261731823L;
		}
		Class233.method25733(273180016);
		if (client.anInt3435 * -849002901 != 18) {
			return;
		}
		client.aClass532_1.method30532((byte) -85).method32987(client.aClass532_1, (byte) 3);
		Class296.method26610((byte) 47);
		...
		if (client.anInt3463 * 1819062465 == 3) {
			...
			Class501.method30172(false, 294148195);
		} else {
			if (client.anInt3463 * 1819062465 == 2 && Class661.method32840(client.anInt3462 * 1756332913, -1517051870)) {
				client.aClass532_1.method30465(new Class537(Class526.aClass526_2, (Class93_Sub41_Sub2) null), 1326237852);
			...
			if (client.anInt3463 * 1819062465 == 1 && client.anInt3435 * -849002901 != 3) {
				...
				Class212.method25444(-1241016248);
			}
			if (client.anInt3463 * 1819062465 == 0) {
				...
				if (client.anInt3436 * 1328106925 < Class249.aClass110Array1.length) {
					do {
						...
						local487.method20138(1642322074);
				...
				if (client.anInt3463 * 1819062465 == 0) {
					for (local285 = 0; local285 < Class249.aClass239Array1.length; local285++) {
						...
						if (local528.aBoolean662) {
							@Pc(536) Class132_Sub1_Sub1_Sub1 local536 = local528.method25807(-538637995);
							Class233.method25732(local536, true, (byte) 9);
						}
					}
				}
			}
		}
		Class393.method28323((byte) 55);
		Class147.method12704((byte) 1);
		Class663.method32869((byte) -92);
		Class275.method26344(false, (byte) 6);
		Class602.method31868(Class694.aClass104_14, Class619.aClass225_8, 141796524);
		...
		Class32_Sub15.method17181((Class312) null, -1, -1, (byte) 13);
		if (!client.aBoolean625) {
			client.anInt3520 = 410366683;
		}
		Class356.method27706(-1043586684);
		...
		if (client.aBoolean635) {
			...
			local622.aClass93_Sub41_Sub2_1.method22467(Class570.anInt5397 * -554382929 << 28 | Class523.anInt5225 * -2075541317 << 14 | Class562.anInt5352 * 1760194437, (byte) -15);
			client.aClass175_2.method24351(local622, -1920560437);
		...
		while (true) {
			...
			do {
				...
				if (local652 == null) {
					while (true) {
						do {
									...
									do {
										...
										if (local652 == null) {
											...
											if (client.aClass312_5 != null) {
												Class491.method29980(619345558);
											}
											Class593.method31723((byte) 72);
											if (client.anInt3514 * 2055688893 > 0 && Class112_Sub2_Sub2.aClass158_2.method14308(82, -898822318) && Class112_Sub2_Sub2.aClass158_2.method14308(81, -714138076) && client.anInt3446 * 1897469075 != 0) {
												...
												@Pc(855) Class611 local855 = client.aClass532_1.method30443(1691996593);
												Class684.method33424(local63, local855.anInt5623 * 270611681 + Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.anIntArray240[0], local855.anInt5624 * -1994307635 + Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.anIntArray239[0], (byte) 118);
											}
											for (local63 = 0; local63 < 5; local63++) {
												@Pc(885) int local885 = client.anIntArray318[local63]++;
											}
											if (Class596.aClass113_Sub1_1.aBoolean171 && Class596.aClass113_Sub1_1.aLong26 * 333245577734160197L < Class305.method26796(929682342) - 60000L) {
												Class25.method23134(268643627);
											}
											...
											for (@Pc(913) Class149_Sub2 local913 = (Class149_Sub2) client.aClass21_8.method390((short) 15439); local913 != null; local913 = (Class149_Sub2) client.aClass21_8.method377(-1915563430)) {
												if ((long) (local913.anInt1400 * 147268085) < Class305.method26796(128851323) / 1000L - 5L) {
													if (local913.aShort77 > 0) {
														Class227.method25614(5, 0, "", "", "", local913.aString42 + Class74.aClass74_1.method1259(Class106.aClass717_8, (byte) 40), (Class443) null, -1832767344);
													}
													if (local913.aShort77 == 0) {
														Class227.method25614(5, 0, "", "", "", local913.aString42 + Class74.aClass74_126.method1259(Class106.aClass717_8, (byte) -22), (Class443) null, -1919256656);
													}
											...
											if (client.aClass175_2.anInt3300 * -1270889673 > 50) {
												...
												client.aClass175_2.method24351(local622, -1516030500);
											}
											...
											try {
												client.aClass175_2.method24350((byte) 34);
										...
										local671 = Class659.method32805(local659.anInt3985 * 897022795, -203225570);
							...
							local671 = Class659.method32805(local659.anInt3985 * 897022795, 1761075059);
				...
				local671 = Class659.method32805(local659.anInt3985 * 897022795, 1435531487);
			} while (local671 == null || local671.aClass312Array2 == null || local659.anInt3970 * 532402067 >= local671.aClass312Array2.length || local671.aClass312Array2[local659.anInt3970 * 532402067] != local659);
	...
	static final void method26267(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
