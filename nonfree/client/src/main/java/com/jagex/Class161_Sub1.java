...
public class Class161_Sub1 extends Class161 {
	...
	static final float method14754(@OriginalArg(0) float arg0) {
		return arg0 * arg0 * arg0 * ((arg0 * 6.0F - 15.0F) * arg0 + 10.0F);
	}

	@OriginalMember(owner = "client!aln", name = "z", descriptor = "(F)F", line = 19)
	static final float method14755(@OriginalArg(0) float arg0) {
		return arg0 * arg0 * arg0 * ((arg0 * 6.0F - 15.0F) * arg0 + 10.0F);
	}

	@OriginalMember(owner = "client!aln", name = "l", descriptor = "(F)F", line = 19)
	static final float method14758(@OriginalArg(0) float arg0) {
		return arg0 * arg0 * arg0 * ((arg0 * 6.0F - 15.0F) * arg0 + 10.0F);
	}

	@OriginalMember(owner = "client!aln", name = "k", descriptor = "(F)F", line = 19)
	static final float method14759(@OriginalArg(0) float arg0) {
		return arg0 * arg0 * arg0 * ((arg0 * 6.0F - 15.0F) * arg0 + 10.0F);
	}

	@OriginalMember(owner = "client!aln", name = "f", descriptor = "(FFF)F", line = 23)
	static final float method14752(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
		return arg0 + (arg1 - arg0) * arg2;
	}

	@OriginalMember(owner = "client!aln", name = "d", descriptor = "(FFF)F", line = 23)
	static final float method14753(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
		return arg0 + (arg1 - arg0) * arg2;
	}
	...
	static final float method14750(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3) {
	...
	static final float method14751(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3) {
		@Pc(3) float[] local3 = aFloatArrayArray20[arg0];
		return local3[0] * arg1 + local3[1] * arg2 + local3[2] * arg3;
	}
