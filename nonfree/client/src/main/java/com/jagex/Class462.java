...
public class Class462 implements Interface1 {
	...
	public int method29235() {
		return this.method29267(false, -2141688061);
	}

	@OriginalMember(owner = "client!oi", name = "e", descriptor = "(Lclient!oq;I)V", line = 34)
	public void method29236(@OriginalArg(0) Interface50 arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(9) int local9 = 0; local9 < this.anIntArray450.length; local9++) {
			...
			@Pc(26) Class5 local26 = Class691.method36594(this.aClass497_120, local19, this, 209627663);
			@Pc(32) byte[] local32 = this.aClass497_119.method30059(local19, (byte) 111);
	...
	public void method29237(@OriginalArg(0) short arg0) {
		this.aMap23 = null;
	}
	...
	Class5 method29238(@OriginalArg(0) Interface50 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) boolean arg3) {
		...
		if (arg3) {
			this.aClass497_119.method30054(arg1, -512225963);
		}
		@Pc(47) Class5 local47 = (Class5) this.aClass240_87.method25839((long) arg1);
		if (local47 != null) {
			return local47;
		}
		local47 = Class691.method36594(this.aClass497_120, arg1, this, -416109031);
		if (local47 == null) {
			return null;
		} else {
			if (arg2) {
	...
	public int method29239(@OriginalArg(0) byte arg0) {
	...
	public Class5 method29241(@OriginalArg(0) Interface50 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		return this.method29242(arg0, arg1, true, true, (byte) 4);
	}

	@OriginalMember(owner = "client!oi", name = "u", descriptor = "(Lclient!oq;IZZB)Lclient!aac;", line = 92)
	Class5 method29242(@OriginalArg(0) Interface50 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) byte arg4) {
		if (arg1 == -1) {
			return null;
		}
		if (this.anIntArray450 != null) {
		...
		local47 = Class691.method36594(this.aClass497_120, arg1, this, -104063542);
		if (local47 == null) {
			return null;
		} else {
			if (arg2) {
	...
	public void method29243(@OriginalArg(0) byte arg0) {
		this.aClass240_87.method25833((byte) -20);
		this.aClass240_86.method25833((byte) -125);
		if (this.aClass240_88 != null) {
			this.aClass240_88.method25833((byte) -21);
		}
	}

	@OriginalMember(owner = "client!oi", name = "p", descriptor = "(II)V", line = 116)
	public void method29244(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aClass240_87.method25832(arg0, (byte) -40);
		this.aClass240_86.method25832(arg0, (byte) -91);
		if (this.aClass240_88 != null) {
			this.aClass240_88.method25832(arg0, (byte) -113);
		}
	}

	@OriginalMember(owner = "client!oi", name = "d", descriptor = "(I)V", line = 122)
	public void method29245(@OriginalArg(0) int arg0) {
		this.aClass240_87.method25837(1161602830);
		this.aClass240_86.method25837(1161602830);
		if (this.aClass240_88 != null) {
			this.aClass240_88.method25837(1161602830);
		}
	}

	@OriginalMember(owner = "client!oi", name = "au", descriptor = "()V", line = 110)
	public void method29246() {
		this.aClass240_87.method25833((byte) -41);
		this.aClass240_86.method25833((byte) -9);
		if (this.aClass240_88 != null) {
			this.aClass240_88.method25833((byte) -104);
		}
	}
	...
	public Class100[] method29228(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		...
		if (arg0 == null) {
			...
			if (this.aClass104_10 != arg0) {
				this.aClass240_88.method25833((byte) -59);
			}
		...
		@Pc(34) Class100[] local34 = (Class100[]) (Class100[]) this.aClass240_88.method25839((long) arg1);
		if (local34 == null) {
	...
	public void method29247(@OriginalArg(0) Interface50 arg0) {
		...
		for (@Pc(9) int local9 = 0; local9 < this.anIntArray450.length; local9++) {
			@Pc(19) int local19 = this.anIntArray450[local9];
			@Pc(26) Class5 local26 = Class691.method36594(this.aClass497_120, local19, this, 343282216);
			@Pc(32) byte[] local32 = this.aClass497_119.method30059(local19, (byte) 55);
	...
	public void method29248(@OriginalArg(0) Interface50 arg0) {
		...
		for (@Pc(9) int local9 = 0; local9 < this.anIntArray450.length; local9++) {
			@Pc(19) int local19 = this.anIntArray450[local9];
			@Pc(26) Class5 local26 = Class691.method36594(this.aClass497_120, local19, this, 411128337);
			@Pc(32) byte[] local32 = this.aClass497_119.method30059(local19, (byte) 112);
	...
	public int method29249(@OriginalArg(0) boolean arg0) {
		if (this.anIntArray450 == null) {
			...
			for (@Pc(20) int local20 = 0; local20 < this.anIntArray450.length; local20++) {
				...
				if (this.aClass497_119.method30054(local30, -512225963)) {
					local18++;
				}
				if (this.aClass497_120.method30054(local30, -512225963)) {
					local18++;
				}
			}
			return local18;
	...
	public Class5 method29254(@OriginalArg(0) Interface50 arg0, @OriginalArg(1) int arg1) {
		return this.method29242(arg0, arg1, true, true, (byte) -97);
	}

	@OriginalMember(owner = "client!oi", name = "a", descriptor = "()I", line = 49)
	public int method29255() {
		return this.method29267(false, -2101593486);
	}

	@OriginalMember(owner = "client!oi", name = "m", descriptor = "(I)I", line = 49)
	public int method29256(@OriginalArg(0) int arg0) {
		return this.method29267(false, -2061195266);
	}
	...
	public Class5 method29257(@OriginalArg(0) Interface50 arg0, @OriginalArg(1) int arg1) {
		return this.method29242(arg0, arg1, true, true, (byte) 18);
	}
	...
	public Class100[] method29229(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if (arg0 == null) {
			...
			if (this.aClass104_10 != arg0) {
				this.aClass240_88.method25833((byte) -22);
			}
			this.aClass104_10 = arg0;
		}
		if (arg0 == null) {
	...
	public Object method29263(@OriginalArg(0) Interface50 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) boolean arg3) {
		...
		@Pc(55) byte[] local55 = this.aClass497_119.method30059(arg1, (byte) 19);
		if (local55 == null) {
			return null;
		}
		@Pc(67) Class5 local67 = this.method29242(arg0, arg1, arg2, false, (byte) -21);
		if (local67 == null) {
			return null;
		} else {
	...
	public Object method29264(@OriginalArg(0) Interface50 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4) {
		if (arg1 == -1) {
			return null;
		}
		if (this.anIntArray450 != null) {
		...
		@Pc(55) byte[] local55 = this.aClass497_119.method30059(arg1, (byte) 58);
		if (local55 == null) {
			return null;
		}
		@Pc(67) Class5 local67 = this.method29242(arg0, arg1, arg2, false, (byte) -85);
		if (local67 == null) {
			return null;
		} else {
	...
	public void method29265() {
		this.aClass240_87.method25833((byte) -83);
		this.aClass240_86.method25833((byte) -92);
		if (this.aClass240_88 != null) {
			this.aClass240_88.method25833((byte) -66);
		}
	}
	...
	public int method29267(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		if (this.anIntArray450 == null) {
			return 0;
		} else if (arg0 || this.aMap23 == null) {
			@Pc(18) int local18 = 0;
	...
	public Class5 method29268(@OriginalArg(0) Interface50 arg0, @OriginalArg(1) int arg1) {
		return this.method29242(arg0, arg1, true, true, (byte) -54);
	}

	@OriginalMember(owner = "client!oi", name = "am", descriptor = "()V", line = 110)
	public void method29269() {
		this.aClass240_87.method25833((byte) -112);
		this.aClass240_86.method25833((byte) -77);
		if (this.aClass240_88 != null) {
			this.aClass240_88.method25833((byte) -6);
		}
	}
	...
	public void method29270(@OriginalArg(0) int arg0) {
		this.aClass240_87.method25832(arg0, (byte) -75);
		this.aClass240_86.method25832(arg0, (byte) 64);
		if (this.aClass240_88 != null) {
			this.aClass240_88.method25832(arg0, (byte) -3);
		}
	}

	@OriginalMember(owner = "client!oi", name = "ap", descriptor = "(I)V", line = 116)
	public void method29271(@OriginalArg(0) int arg0) {
		this.aClass240_87.method25832(arg0, (byte) -113);
		this.aClass240_86.method25832(arg0, (byte) 1);
		if (this.aClass240_88 != null) {
			this.aClass240_88.method25832(arg0, (byte) 21);
		}
	}
	...
	public Class100[] method29231(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		...
		if (arg0 == null) {
			...
			if (this.aClass104_10 != arg0) {
				this.aClass240_88.method25833((byte) -42);
			}
			this.aClass104_10 = arg0;
		}
		if (arg0 == null) {
	...
	public Class100[] method29227(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		...
		if (arg0 == null) {
			...
			if (this.aClass104_10 != arg0) {
				this.aClass240_88.method25833((byte) -7);
			}
			this.aClass104_10 = arg0;
		}
		if (arg0 == null) {
	...
	static final void method29276(@OriginalArg(0) int arg0, @OriginalArg(1) Class16 arg1, @OriginalArg(2) int arg2) {
	...
	public static void method29277(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class610 arg3, @OriginalArg(4) byte arg4) {
		for (@Pc(4) Class93_Sub13 local4 = (Class93_Sub13) Class93_Sub13.aClass22_21.method445((byte) 111); local4 != null; local4 = (Class93_Sub13) Class93_Sub13.aClass22_21.method415(214003930)) {
			if (local4.anInt1506 * 1124978351 == arg0 && local4.anInt1513 * 792297037 == arg1 << 9 && arg2 << 9 == local4.anInt1507 * -1881471885 && arg3.anInt5587 * 365009633 == local4.aClass610_1.anInt5587 * 365009633) {
				if (local4.aClass539_3 != null) {
					local4.aClass539_3.method30791(100, (byte) -97);
					Class274.aClass258_1.method26068(local4.aClass539_3, 1930326226);
	...
	static final void method29278(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub40_1.method16362(1912416434);
	}
}
