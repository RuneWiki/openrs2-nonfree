...
public class Class238 implements Runnable {
	...
	void method25780(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
	...
	long method25781(@OriginalArg(0) byte arg0) {
		return this.aLong248 * 6879739500665774177L;
	}
	...
	public void run() {
		while (this.aBoolean661) {
			this.method25783(16711935);
		}
	}

	@OriginalMember(owner = "client!e", name = "k", descriptor = "(I)V", line = 41)
	void method25783(@OriginalArg(0) int arg0) {
	...
	void method25795(@OriginalArg(0) int arg0) {
		this.aBoolean661 = false;
	}

	@OriginalMember(owner = "client!e", name = "p", descriptor = "(ZI)V", line = 341)
	public static void method25796(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		...
		Class51.aClass93_Sub36_1.method14357(Class51.aClass93_Sub36_1.aClass166_Sub12_1, Class332.aClass332_6.anInt4147 * 595334117, (byte) 59);
		...
		Class610.method32021(93204721);
		client.aClass532_1.method30532((byte) 23).method33003(-2040495528);
		client.aBoolean609 = true;
	}

	@OriginalMember(owner = "client!e", name = "o", descriptor = "(Lclient!yf;I)V", line = 75)
	static void method25797(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[arg0.anInt5891 * -1497248091 - 2] = ((Class347) Class288.aClass55_Sub2_1.method18261(arg0.anIntArray519[arg0.anInt5891 * -1497248091 - 2], 1506735470)).method27587(Class624.aClass120_1, arg0.anIntArray519[arg0.anInt5891 * -1497248091 - 1], (byte) -16) ? 1 : 0;
		arg0.anInt5891 -= 1189701933;
	}

	@OriginalMember(owner = "client!e", name = "wa", descriptor = "(Lclient!yf;I)V", line = 8925)
	static final void method25798(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		Class274.aClass258_1.method26074(Class275.aClass275_9, local13, local23, local43, Class280.aClass280_7.method26450(-998236720), Class278.aClass278_2, 0.0F, 0.0F, (Class472) null, 0, local45, local33, 1283013387);
	}
	...
	static final void method25799(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		((Class25_Sub1) Class65.aClass123_Sub1_2.method9040(-1358253356)).method15970(arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091], (byte) -12);
	}

	@OriginalMember(owner = "client!e", name = "ag", descriptor = "(B)V", line = 649)
	public static final void method25800(@OriginalArg(0) byte arg0) {
	...
	static final void method25801(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		Class51.aClass93_Sub36_1.method14357(Class51.aClass93_Sub36_1.aClass166_Sub35_1, arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091], (byte) 44);
	...
	static final void method25802(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(16) Class312 local16 = Class659.method32805(local12, -599896618);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class273.method26325(local16, local22, arg0, 2027400183);
	}
}
