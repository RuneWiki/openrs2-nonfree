...
public class Class717 implements Interface75 {
	...
	String method36883(@OriginalArg(0) byte arg0) {
		return this.aString244;
	}
	...
	public String toString() {
		return this.method36883((byte) -74).toLowerCase(Locale.ENGLISH);
	}

	static {
		@Pc(72) Class717[] local72 = method36886(65534);
	...
	public String method36884() {
		return this.method36883((byte) -15).toLowerCase(Locale.ENGLISH);
	}

	@OriginalMember(owner = "client!zt", name = "l", descriptor = "()[Lclient!zt;", line = 42)
	public static Class717[] method36885() {
	...
	public static Class717[] method36886(@OriginalArg(0) int arg0) {
		return new Class717[] { aClass717_13, aClass717_14, aClass717_15, aClass717_16, aClass717_12, aClass717_10, aClass717_11 };
	}
	...
	public Locale method36889(@OriginalArg(0) int arg0) {
		return this.aLocale1;
	}

	@OriginalMember(owner = "client!zt", name = "w", descriptor = "(II)Lclient!zt;", line = 70)
	public static Class717 method36890(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	static float method36893(@OriginalArg(0) Class230 arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2) {
		...
		if (arg0.aBoolean648) {
			...
			@Pc(82) int local82 = Class614.method32069(local39, 3, 0.0F, true, 1.0F, true, local72, (byte) -2);
			if (local82 == 1) {
				local35 = local72[0];
			} else {
				local35 = 0.0F;
	...
	static final void method36894(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1716955397);
	...
	public static void method36895(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) byte arg4) {
		...
		if (!Class694.aClass104_14.method20423()) {
			arg3 = true;
		}
		Class687.method36503(local4, arg0, arg1, arg2, arg3, (byte) -126);
	}

	@OriginalMember(owner = "client!zt", name = "uv", descriptor = "(Lclient!yf;I)V", line = 8643)
	static final void method36896(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 196555249);
	...
	public static Class93_Sub29 method36897(@OriginalArg(0) int arg0) {
		...
		for (@Pc(11) Class93_Sub29 local11 = (Class93_Sub29) Class159_Sub1.aClass20_1.next(); local11 != null; local11 = (Class93_Sub29) Class159_Sub1.aClass20_1.next()) {
			...
			if (local22 != null && local22.aBoolean711 && local22.method27258(Class159_Sub1.anInterface21_2, Class159_Sub1.anInterface23_2, -1868745929)) {
				return local11;
			}
		}
		return null;
