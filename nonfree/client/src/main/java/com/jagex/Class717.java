...
public class Class717 implements Interface75 {
	...
	static {
		@Pc(72) Class717[] local72 = method36886();
	...
	public static Class717[] method36886() {
		return new Class717[] { aClass717_13, aClass717_14, aClass717_15, aClass717_16, aClass717_12, aClass717_10, aClass717_11 };
	}
	...
	public static Class717 method36890(@OriginalArg(0) int arg0) {
	...
	public String toString() {
		return this.method36883().toLowerCase(Locale.ENGLISH);
	}
	...
	static float method36893(@OriginalArg(0) Class230 arg0, @OriginalArg(1) float arg1) {
		if (arg0 == null) {
			return 0.0F;
		}
		@Pc(10) float local10;
	...
	public static Class93_Sub29 method36897() {
		...
		for (@Pc(11) Class93_Sub29 local11 = (Class93_Sub29) Class159_Sub1.aClass20_1.next(); local11 != null; local11 = (Class93_Sub29) Class159_Sub1.aClass20_1.next()) {
			@Pc(22) Class322 local22 = (Class322) Class159_Sub1.aClass32_Sub2_2.method18261(local11.anInt1603 * 1208139441);
			if (local22 != null && local22.aBoolean711 && local22.method27258(Class159_Sub1.anInterface21_2, Class159_Sub1.anInterface23_2)) {
				return local11;
			}
		}
		return null;
	...
	public static void method36895(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		client.aLong244 = 0L;
		@Pc(4) int local4 = Class255.method26008();
		if (arg0 == 3 || local4 == 3) {
			arg3 = true;
		}
		...
		Class687.method36503(local4, arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!zt", name = "uj", descriptor = "(Lclient!yf;S)V", line = 8619)
	static final void method36894(@OriginalArg(0) Class681 arg0) {
	...
	static final void method36896(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12);
