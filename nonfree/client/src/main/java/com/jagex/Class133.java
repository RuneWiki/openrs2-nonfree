...
public class Class133 implements Interface32 {
	...
	public static Class133 method10071(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(3) int local3 = arg0.method22436(-617007490);
		@Pc(10) Class390 local10 = Class708.method36756(36102269)[arg0.method22413((short) 16384)];
		@Pc(17) Class392 local17 = Class252.method25978(2094587407)[arg0.method22413((short) 16384)];
		@Pc(21) int local21 = arg0.method22482((byte) -13);
		@Pc(25) int local25 = arg0.method22482((byte) -93);
	...
	public static Class320 method10072(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class320 arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4) {
		if (!Class589.aClass497_132.method30092(arg0, -1392918358)) {
			return null;
		}
		@Pc(11) int local11 = Class589.aClass497_132.method30062(arg0, 481794000);
		...
		for (@Pc(43) int local43 = 0; local43 < local11; local43++) {
			if (arg2.aClass312Array3[local43] == null) {
				@Pc(58) byte[] local58 = Class589.aClass497_132.method30079(arg0, local43, arg1, (byte) -19);
				if (local58 != null) {
					@Pc(70) Class312 local70 = arg2.aClass312Array3[local43] = new Class312();
					local70.anInt3953 = (local43 + (arg0 << 16)) * -212068725;
					local70.method26846(new Class93_Sub41(local58), -253284198);
				}
			}
		}
		return arg2;
	...
	static final void method10073(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class372.aClass58_2.method1097(local13, -737304293).anIntArray266[local23];
	}
}
