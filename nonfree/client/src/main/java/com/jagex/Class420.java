...
public class Class420 {
	...
	public void method28716(@OriginalArg(0) float arg0, @OriginalArg(1) int arg1) {
		if (this.anInterface39_1 == null) {
			this.aFloat289 = arg0;
			this.aFloat288 = this.aFloat290;
			this.aLong273 = Class305.method26796(2072934304) * 4369100113735516591L;
	...
	public void method28717(@OriginalArg(0) float arg0) {
		if (this.anInterface39_1 == null) {
			this.aFloat289 = arg0;
			this.aFloat288 = this.aFloat290;
			this.aLong273 = Class305.method26796(1956192130) * 4369100113735516591L;
			this.aLong274 = this.aLong273 * -3919147337030305897L + -6132218746663857596L;
		}
	}
	...
	public float method28718(@OriginalArg(0) int arg0) {
		...
		for (@Pc(3) Class420 local3 = this; local3 != null; local3 = local3.method28723(-225665097)) {
			local1 *= local3.method28725(1811768599);
		}
		return local1;
	}

	@OriginalMember(owner = "client!mj", name = "m", descriptor = "(I)V", line = 41)
	void method28719(@OriginalArg(0) int arg0) {
		if (this.anInterface39_1 != null) {
			...
			if (local7 != this.aFloat290 && this.aFloat289 < 0.0F) {
				...
				this.aLong273 = Class305.method26796(1393668606) * 4369100113735516591L;
				this.aLong274 = this.aLong273 * -3919147337030305897L + -6132218746663857596L;
			}
		}
		if (this.aFloat289 >= 0.0F) {
			@Pc(46) long local46 = Class305.method26796(1537009655);
	...
	public float method28720(@OriginalArg(0) byte arg0) {
		@Pc(2) float local2 = this.aFloat290;
		for (@Pc(5) Class420 local5 = this.aClass420_1; local5 != null; local5 = local5.method28723(301931772)) {
			local2 *= local5.method28721(-2146128389);
		}
		return Math.min(Math.max(local2, 0.0F), 1.0F);
	}

	@OriginalMember(owner = "client!mj", name = "f", descriptor = "(I)F", line = 81)
	public float method28721(@OriginalArg(0) int arg0) {
	...
	public float method28722() {
		@Pc(1) float local1 = 1.0F;
		for (@Pc(3) Class420 local3 = this; local3 != null; local3 = local3.method28723(-175844491)) {
			local1 *= local3.method28725(-1881490739);
		}
		return local1;
	}

	@OriginalMember(owner = "client!mj", name = "l", descriptor = "(I)Lclient!mj;", line = 94)
	public Class420 method28723(@OriginalArg(0) int arg0) {
	...
	float method28725(@OriginalArg(0) int arg0) {
	...
	void method28726() {
		if (this.anInterface39_1 != null) {
			...
			if (local7 != this.aFloat290 && this.aFloat289 < 0.0F) {
				this.aFloat288 = this.aFloat290;
				this.aFloat289 = local7;
				this.aLong273 = Class305.method26796(1468855489) * 4369100113735516591L;
				this.aLong274 = this.aLong273 * -3919147337030305897L + -6132218746663857596L;
			}
		}
		if (this.aFloat289 >= 0.0F) {
			@Pc(46) long local46 = Class305.method26796(669632225);
			if (local46 > this.aLong274 * -8234214018386827511L) {
				this.aFloat290 = this.aFloat289;
				this.aFloat289 = -1.0F;
			} else {
	...
	void method28727() {
		if (this.anInterface39_1 != null) {
			...
			if (local7 != this.aFloat290 && this.aFloat289 < 0.0F) {
				this.aFloat288 = this.aFloat290;
				this.aFloat289 = local7;
				this.aLong273 = Class305.method26796(623687549) * 4369100113735516591L;
				this.aLong274 = this.aLong273 * -3919147337030305897L + -6132218746663857596L;
			}
		}
		if (this.aFloat289 >= 0.0F) {
			@Pc(46) long local46 = Class305.method26796(-410144119);
			if (local46 > this.aLong274 * -8234214018386827511L) {
				this.aFloat290 = this.aFloat289;
				this.aFloat289 = -1.0F;
			} else {
	...
	public float method28728() {
		@Pc(2) float local2 = this.aFloat290;
		for (@Pc(5) Class420 local5 = this.aClass420_1; local5 != null; local5 = local5.method28723(-302931422)) {
			local2 *= local5.method28721(-2146043773);
		}
		return Math.min(Math.max(local2, 0.0F), 1.0F);
	}
	...
	public float method28729() {
		@Pc(2) float local2 = this.aFloat290;
		for (@Pc(5) Class420 local5 = this.aClass420_1; local5 != null; local5 = local5.method28723(920305939)) {
			local2 *= local5.method28721(-2145347027);
		}
		return Math.min(Math.max(local2, 0.0F), 1.0F);
	}
	...
	public float method28730() {
		@Pc(2) float local2 = this.aFloat290;
		for (@Pc(5) Class420 local5 = this.aClass420_1; local5 != null; local5 = local5.method28723(1264919152)) {
			local2 *= local5.method28721(-2146825825);
		}
		return Math.min(Math.max(local2, 0.0F), 1.0F);
	}
	...
	public float method28731() {
		@Pc(2) float local2 = this.aFloat290;
		for (@Pc(5) Class420 local5 = this.aClass420_1; local5 != null; local5 = local5.method28723(-1391428381)) {
			local2 *= local5.method28721(-2146865528);
		}
		return Math.min(Math.max(local2, 0.0F), 1.0F);
	}
	...
	public void method28732(@OriginalArg(0) float arg0) {
		if (this.anInterface39_1 == null) {
			this.aFloat289 = arg0;
			this.aFloat288 = this.aFloat290;
			this.aLong273 = Class305.method26796(1807958343) * 4369100113735516591L;
			this.aLong274 = this.aLong273 * -3919147337030305897L + -6132218746663857596L;
		}
	}
	...
	public float method28733() {
		@Pc(1) float local1 = 1.0F;
		for (@Pc(3) Class420 local3 = this; local3 != null; local3 = local3.method28723(-1728179325)) {
			local1 *= local3.method28725(-798688961);
		}
		return local1;
	}
	...
	public void method28737(@OriginalArg(0) float arg0) {
		if (this.anInterface39_1 == null) {
			this.aFloat289 = arg0;
			this.aFloat288 = this.aFloat290;
			this.aLong273 = Class305.method26796(-174390281) * 4369100113735516591L;
			this.aLong274 = this.aLong273 * -3919147337030305897L + -6132218746663857596L;
		}
	}

	@OriginalMember(owner = "client!mj", name = "cr", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;I)V", line = 5401)
	static final void method28738(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		if (arg0.anInt3970 * 532402067 == -1 && !arg1.aBoolean708) {
			Class39.method770(arg0.anInt3953 * -1549590237, (short) 20077);
		}
	}

	@OriginalMember(owner = "client!mj", name = "kz", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;B)V", line = 6745)
	static final void method28739(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) byte arg3) {
		arg0.aStringArray23 = null;
	}

	@OriginalMember(owner = "client!mj", name = "ti", descriptor = "(Lclient!hf;IIFIIIIIIB)V", line = 8386)
	static void method28740(@OriginalArg(0) Class312 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) byte arg10) {
		...
		arg0.aClass331_2.aLong259 = Class388.method28249((byte) 127) * 6591543353939106377L;
		arg0.aClass331_2.method27374(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, (byte) 4);
	}

	@OriginalMember(owner = "client!mj", name = "ahs", descriptor = "(Lclient!yf;I)V", line = 11015)
	static final void method28741(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(15) Class175 local15 = Class330.method27372(-1652783239);
		@Pc(21) Class93_Sub22 local21 = Class102.method2592(Class446.aClass446_46, local15.aClass24_2, (byte) 93);
		local21.aClass93_Sub41_Sub2_1.method22510(local12, (byte) -27);
		local15.method24351(local21, -2010054592);
	}

	@OriginalMember(owner = "client!mj", name = "amf", descriptor = "(Lclient!yf;I)V", line = 12075)
	static final void method28742(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static void method28743(@OriginalArg(0) Class93_Sub1_Sub8 arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(9) Class93_Sub1_Sub8 local9 = (Class93_Sub1_Sub8) Class454.aClass18_16.method246(-1025661837); local9 != null; local9 = (Class93_Sub1_Sub8) Class454.aClass18_16.method253(1110350297)) {
			if (Class19_Sub3.method17555(arg0.method21719(2140014573), local9.method21719(-2000658221), 1385938362)) {
				Class658.method32790(arg0, local9, 2131854032);
				local1 = true;
				break;
			}
		}
	...
	public static Class509[] method28744(@OriginalArg(0) int arg0) {
	...
	static void method28745(@OriginalArg(0) Class312 arg0, @OriginalArg(1) byte arg1) {
		...
		local40.aClass93_Sub41_Sub2_1.method22465(arg0.anInt3953 * -1549590237, 907143239);
		local40.aClass93_Sub41_Sub2_1.method22454(arg0.anInt4045 * 307668159, 2134260399);
		local40.aClass93_Sub41_Sub2_1.method22458(client.anInt3524 * -239149331, -1850331297);
		local40.aClass93_Sub41_Sub2_1.method22458(arg0.anInt3970 * 532402067, -1666236355);
		local40.aClass93_Sub41_Sub2_1.method22458(client.anInt3523 * 1573685689, -1922842379);
		local40.aClass93_Sub41_Sub2_1.method22465(Class148.anInt1394 * -278883695, 907143239);
		client.aClass175_2.method24351(local40, -1894315664);
	}
