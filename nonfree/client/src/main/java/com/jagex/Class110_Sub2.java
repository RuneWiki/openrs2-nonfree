...
public class Class110_Sub2 extends Class110 {
	...
	public void method20140() {
		Class249.aClass239Array1[this.anInt810 * -1650090685].method25807(-1446974014).method19952(this.anInt809 * 373227231, true, 438634515);
	}

	@OriginalMember(owner = "client!afn", name = "<init>", descriptor = "(Lclient!alw;)V", line = 10)
	Class110_Sub2(@OriginalArg(0) Class93_Sub41 arg0) {
		super(arg0);
		this.anInt810 = arg0.method22415(-1434290800) * 591189867;
		this.anInt809 = arg0.method22415(-1434290800) * 1021066527;
	}

	@OriginalMember(owner = "client!afn", name = "n", descriptor = "(I)V", line = 16)
	@Override
	public void method20138(@OriginalArg(0) int arg0) {
		Class249.aClass239Array1[this.anInt810 * -1650090685].method25807(72566524).method19952(this.anInt809 * 373227231, true, 474115672);
	}
}
