...
public class Class501 {
	...
	void method30168() {
		if (this.aClass93_Sub41_16 != null && !this.aBoolean785) {
			this.aClass93_Sub41_16.method22651((byte) 1);
		}
	...
	public static void method30172(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		...
		if (!arg0) {
			if (Class249.aClass110Array1 != null) {
				...
				for (@Pc(18) int local18 = 0; local18 < local16.length; local18++) {
					...
					local26.method20144(-2003464695);
				}
			}
			if (Class249.anInt3842 * -1535788867 != -1) {
				Class274.aClass258_1.method26118(Class249.anInt3842 * -1535788867, 255, (byte) 0);
			}
		}
		...
		local68.aClass93_Sub41_Sub2_1.method22510(arg0 ? 1 : 0, (byte) -67);
		client.aClass175_2.method24351(local68, -1619193338);
	}
