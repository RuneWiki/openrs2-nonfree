...
public class Class550 {
	...
	static void method31028(@OriginalArg(0) long[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg2 >= arg3) {
			return;
		}
		...
		method31028(arg0, arg1, arg2, local10 - 1, -431849412);
		method31028(arg0, arg1, local10 + 1, arg3, -993940483);
	}

	@OriginalMember(owner = "client!sh", name = "bj", descriptor = "(Lclient!yf;I)V", line = 5271)
	static final void method31029(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class391.method28288(local11, local14, arg0, 2095211317);
	}
	...
	static void method31031(@OriginalArg(0) Class312 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) byte arg4) {
		...
		if (client.aBoolean615 && (client.method25238(arg0).anInt1550 * -622772683 != 0 || arg0.anInt3971 * -158526639 == 0)) {
	...
	static final void method31032(@OriginalArg(0) Class93_Sub40 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10) {
		if (!Class383.method28145(arg1, (int[]) null, 633209048)) {
			return;
		}
		if (arg0 == null || arg0.method23193((byte) 35)) {
			@Pc(21) Class320 local21 = Class166_Sub1.aClass320Array1[arg1];
			client.method25272(local21, local21.method27227(855839648), -1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
		} else {
	...
	static final void method31033(@OriginalArg(0) Class312[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		for (@Pc(1) int local1 = 0; local1 < arg0.length; local1++) {
			@Pc(9) Class312 local9 = arg0[local1];
			if (local9 != null) {
				if (local9.anInt3971 * -158526639 == 0) {
					if (local9.aClass312Array1 != null) {
						method31033(local9.aClass312Array1, arg1, (byte) 41);
					}
					@Pc(35) Class93_Sub40 local35 = (Class93_Sub40) client.aClass16_22.method215((long) (local9.anInt3953 * -1549590237));
					if (local35 != null) {
						Class189.method24584(local35.anInt3172 * 1220811495, arg1, 780494749);
					}
				}
				...
				if (arg1 == 1 && local9.anObjectArray34 != null) {
					if (local9.anInt3970 * 532402067 >= 0) {
						@Pc(83) Class312 local83 = Class659.method32805(local9.anInt3953 * -1549590237, 546421086);
	...
	public static void method31034(@OriginalArg(0) Class657 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method31035(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.method19978(1927066028).method32026((short) 448);
	}
}
