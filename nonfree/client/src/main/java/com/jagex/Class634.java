...
public class Class634 {
	...
	int method32312(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = 0;
		for (@Pc(3) int local3 = 0; local3 < this.anIntArray501.length && arg0 >= this.anIntArray501[local3]; local3++) {
			local1 = local3 + 1;
		}
	...
	int method32316(@OriginalArg(0) int arg0) {
		if (arg0 < 1) {
			return 0;
		} else {
	...
	static final void method32321() {
		Class285.method26517();
		client.aClass532_1.method30462();
		@Pc(6) int local6;
	...
	static final void method32319(@OriginalArg(0) Class681 arg0) {
	...
	static final void method32320(@OriginalArg(0) Class681 arg0) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub35_3.method16223();
	}
}
