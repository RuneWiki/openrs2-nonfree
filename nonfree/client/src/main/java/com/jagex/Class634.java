...
public class Class634 {
	...
	int method32310(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = 0;
	...
	Class634(@OriginalArg(0) int[] arg0) {
		...
		this.method32311((byte) 51);
	}

	@OriginalMember(owner = "client!wd", name = "e", descriptor = "(B)V", line = 26)
	final void method32311(@OriginalArg(0) byte arg0) {
	...
	static final void method32319(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method32320(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub35_3.method16223(-77427108);
	}

	@OriginalMember(owner = "client!wd", name = "fa", descriptor = "(I)V", line = 2530)
	static final void method32321(@OriginalArg(0) int arg0) {
		Class285.method26517(2095162445);
		client.aClass532_1.method30462((byte) -13);
		@Pc(6) int local6;
		...
		Class322.method27274(Class20.method376(1437601641), -1555248762);
		client.anInt3455 = 0;
		Class624.aClass120_1.aClass647_1.method32642((byte) -15);
