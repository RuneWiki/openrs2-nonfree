...
public class Class82 {
	...
	public Class82(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1) {
		@Pc(7) byte[] local7 = arg0.method30044(arg1, 0, (byte) 0);
	...
	public Class82(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(9) byte[] local9 = arg0.method30044(arg1, arg2 + 1, (byte) 0);
	...
	void method1382(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
		this.aClass500_1 = (Class500) Class107.method18119(Class500.method30159(-2085726699), arg0.method22413((short) 16384), -1915563430);
		@Pc(13) int local13 = arg0.method22596((short) -3184);
		this.aMap5 = new HashMap(local13);
		while (local13-- > 0) {
			@Pc(28) Object local28 = this.aClass500_1.method30156(arg0, (byte) 0);
			@Pc(32) int local32 = arg0.method22596((short) -11628);
			@Pc(36) ArrayList local36 = new ArrayList();
			while (local32-- > 0) {
				@Pc(43) int local43 = arg0.method22596((short) -1723);
				local36.add(local43);
			}
		...
		for (@Pc(9) int local9 = 0; local9 < local3; local9++) {
			...
			if (local18 != null && local18 != Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3 && local18.aString82 != null && local18.aString82.equalsIgnoreCase(arg1)) {
				...
				if (local35 != null) {
					...
					local102.aClass93_Sub41_Sub2_1.method22454(local5[local9], 2129512639);
					local102.aClass93_Sub41_Sub2_1.method22446(0, -1591808004);
					client.aClass175_2.method24351(local102, -2107828542);
				}
				local7 = true;
				break;
			}
	...
	public static String method1385(@OriginalArg(0) CharSequence arg0, @OriginalArg(1) Class83 arg1, @OriginalArg(2) byte arg2) {
		...
		for (@Pc(54) int local54 = local6; local54 < local9; local54++) {
			...
			if (Class687.method36502(local61, (byte) 0)) {
				@Pc(70) char local70 = Class549.method31027(local61, 2072969717);
				if (local70 != '\u0000') {
