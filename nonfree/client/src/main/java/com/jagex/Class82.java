...
public class Class82 {
	...
	public Class82(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(9) byte[] local9 = arg0.method30044(arg1, arg2 + 1);
		this.method1382(new Class93_Sub41(local9));
	}
	...
	public Class82(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1) {
		@Pc(7) byte[] local7 = arg0.method30044(arg1, 0);
		this.method1382(new Class93_Sub41(local7));
	}

	@OriginalMember(owner = "client!adh", name = "e", descriptor = "(Lclient!alw;B)V", line = 29)
	void method1382(@OriginalArg(0) Class93_Sub41 arg0) {
		this.aClass500_1 = (Class500) Class107.method18119(Class500.method30159(), arg0.method22413());
		@Pc(13) int local13 = arg0.method22596();
		this.aMap5 = new HashMap(local13);
		while (local13-- > 0) {
			@Pc(28) Object local28 = this.aClass500_1.method30156(arg0);
			@Pc(32) int local32 = arg0.method22596();
			@Pc(36) ArrayList local36 = new ArrayList();
			while (local32-- > 0) {
				@Pc(43) int local43 = arg0.method22596();
				local36.add(local43);
			}
	...
	public static String method1385(@OriginalArg(0) CharSequence arg0, @OriginalArg(1) Class83 arg1) {
		if (arg0 == null) {
			return null;
		}
		@Pc(6) int local6 = 0;
		@Pc(9) int local9 = arg0.length();
		while (local6 < local9 && Class573.method31342(arg0.charAt(local6))) {
			local6++;
		}
		while (local9 > local6 && Class573.method31342(arg0.charAt(local9 - 1))) {
			local9--;
		}
		@Pc(37) int local37 = local9 - local6;
		if (local37 < 1 || local37 > Class153.method14099(arg1)) {
			return null;
		}
		...
		for (@Pc(54) int local54 = local6; local54 < local9; local54++) {
			...
			if (Class687.method36502(local61)) {
				@Pc(70) char local70 = Class549.method31027(local61);
				if (local70 != 0) {
	...
	public static void method1384(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1) {
		...
		for (@Pc(9) int local9 = 0; local9 < local3; local9++) {
			...
			if (local18 != null && local18 != Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3 && local18.aString82 != null && local18.aString82.equalsIgnoreCase(arg1)) {
				...
				if (local35 != null) {
					@Pc(102) Class93_Sub22 local102 = Class102.method2592(local35, client.aClass175_2.aClass24_2);
					local102.aClass93_Sub41_Sub2_1.method22454(local5[local9]);
					local102.aClass93_Sub41_Sub2_1.method22446(0);
					client.aClass175_2.method24351(local102);
				}
				local7 = true;
				break;
			}
		...
		if (!local7) {
			Class103.method2811(4, Class74.aClass74_127.method1259(Class106.aClass717_8) + arg1);
		}
	}
}
