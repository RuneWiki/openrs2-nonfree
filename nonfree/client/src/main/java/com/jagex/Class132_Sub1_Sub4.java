...
public abstract class Class132_Sub1_Sub4 extends Class132_Sub1 {
	...
	int method24309(@OriginalArg(0) Class93_Sub16[] arg0, @OriginalArg(1) short arg1) {
		if (this.aBoolean560) {
			...
			this.anInt1496 = this.method24274((int) local6.aFloat317 >> this.aClass585_23.anInt5438 * -358186793, (int) local6.aFloat319 >> this.aClass585_23.anInt5438 * -358186793, this.aClass93_Sub16Array15, 2108716433) * 1467316381;
	...
	int method24264(@OriginalArg(0) Class93_Sub16[] arg0) {
		if (this.aBoolean560) {
			@Pc(6) Class472 local6 = this.method24229().aClass472_61;
			this.anInt1496 = this.method24274((int) local6.aFloat317 >> this.aClass585_23.anInt5438 * -358186793, (int) local6.aFloat319 >> this.aClass585_23.anInt5438 * -358186793, this.aClass93_Sub16Array15, 1657491468) * 1467316381;
			this.aBoolean560 = false;
		}
		for (@Pc(38) int local38 = 0; local38 < this.anInt1496 * -452145739; local38++) {
			arg0[local38] = this.aClass93_Sub16Array15[local38];
	...
	int method24302(@OriginalArg(0) Class93_Sub16[] arg0) {
		if (this.aBoolean560) {
			@Pc(6) Class472 local6 = this.method24229().aClass472_61;
			this.anInt1496 = this.method24274((int) local6.aFloat317 >> this.aClass585_23.anInt5438 * -358186793, (int) local6.aFloat319 >> this.aClass585_23.anInt5438 * -358186793, this.aClass93_Sub16Array15, 2124642463) * 1467316381;
			this.aBoolean560 = false;
		}
		for (@Pc(38) int local38 = 0; local38 < this.anInt1496 * -452145739; local38++) {
			arg0[local38] = this.aClass93_Sub16Array15[local38];
