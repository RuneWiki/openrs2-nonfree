...
public class Class359 {
	...
	static final void method27787(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub20_1.method15774((byte) -94) ? 1 : 0;
	}

	@OriginalMember(owner = "client!jf", name = "m", descriptor = "(Lclient!ase;I)V", line = 27)
	public static void method27788(@OriginalArg(0) Class93_Sub41_Sub2 arg0, @OriginalArg(1) int arg1) {
		@Pc(4) Class93_Sub37 local4 = (Class93_Sub37) Class60.aClass22_2.method445((byte) 37);
		if (local4 == null) {
			return;
		}
		@Pc(12) int local12 = arg0.anInt3070 * 212851357;
		arg0.method22395(local4.anInt1958 * 1291580777, (byte) 15);
			...
			if (local4.anIntArray195[local21] == 0) {
				try {
					...
					if (local46 == 0) {
						...
						arg0.method22395(local58, (byte) 53);
					} else if (local46 == 1) {
						local54 = local4.aFieldArray1[local21];
						local54.setInt((Object) null, local4.anIntArray196[local21]);
						arg0.method22510(0, (byte) -86);
					} else if (local46 == 2) {
						local54 = local4.aFieldArray1[local21];
						local58 = local54.getModifiers();
						arg0.method22510(0, (byte) -65);
						arg0.method22395(local58, (byte) 7);
					}
					...
					if (local46 == 3) {
						...
						if (local151 == null) {
							arg0.method22510(0, (byte) -57);
						} else if (local151 instanceof Number) {
							arg0.method22510(1, (byte) -15);
							arg0.method22399(((Number) local151).longValue());
						} else if (local151 instanceof String) {
							arg0.method22510(2, (byte) -95);
							arg0.method22402((String) local151, 1647525420);
						} else {
							arg0.method22510(4, (byte) -115);
						}
					} else if (local46 == 4) {
						local114 = local4.aMethodArray1[local21];
						local58 = local114.getModifiers();
						arg0.method22510(0, (byte) -7);
						arg0.method22395(local58, (byte) 55);
					}
				} catch (@Pc(210) ClassNotFoundException local210) {
					arg0.method22510(-10, (byte) -14);
				} catch (@Pc(216) InvalidClassException local216) {
					arg0.method22510(-11, (byte) -39);
				} catch (@Pc(222) StreamCorruptedException local222) {
					arg0.method22510(-12, (byte) -41);
				} catch (@Pc(228) OptionalDataException local228) {
					arg0.method22510(-13, (byte) -36);
				} catch (@Pc(234) IllegalAccessException local234) {
					arg0.method22510(-14, (byte) -46);
				} catch (@Pc(240) IllegalArgumentException local240) {
					arg0.method22510(-15, (byte) -59);
				} catch (@Pc(246) InvocationTargetException local246) {
					arg0.method22510(-16, (byte) -128);
				} catch (@Pc(252) SecurityException local252) {
					arg0.method22510(-17, (byte) -25);
				} catch (@Pc(258) IOException local258) {
					arg0.method22510(-18, (byte) -68);
				} catch (@Pc(264) NullPointerException local264) {
					arg0.method22510(-19, (byte) -53);
				} catch (@Pc(270) Exception local270) {
					arg0.method22510(-20, (byte) -64);
				} catch (@Pc(276) Throwable local276) {
					arg0.method22510(-21, (byte) -57);
				}
			} else {
				arg0.method22510(local4.anIntArray195[local21], (byte) -62);
			}
		}
		arg0.method22506(local12, 1327030711);
		local4.method23969(-1774062480);
	}

	@OriginalMember(owner = "client!jf", name = "vk", descriptor = "(Lclient!yf;I)V", line = 8916)
	static final void method27789(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		Class274.aClass258_1.method26057(arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091], -650860313);
	}

	@OriginalMember(owner = "client!jf", name = "e", descriptor = "(IIIIIIILclient!oe;B)V", line = 39)
	public static void method27790(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) Class458 arg7, @OriginalArg(8) byte arg8) {
		...
		if (local1 == null) {
			...
			if (arg1 >= 0 && arg2 >= 0 && arg1 < client.aClass532_1.method30444(510184718) && arg2 < client.aClass532_1.method30474((short) 128)) {
				Class593.method31720(local1, (byte) 70);
			}
	...
	public static void method27791(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(5) Class93_Sub1_Sub13 local5 = Class623.method32150(Class155.aClass155_68, arg0, -1, (short) -23624);
		if (local5 == null) {
			return;
		}
	...
	static String method27792(@OriginalArg(0) int arg0, @OriginalArg(1) Class717 arg1, @OriginalArg(2) Class645 arg2, @OriginalArg(3) int arg3) {
		if (arg0 < 100000) {
			return Class389.method28272(arg2.anInt5777 * 1305571991, (byte) 64) + arg0 + Class47.aString8;
		} else if (arg0 < 10000000) {
			return Class389.method28272(arg2.anInt5778 * -1668431833, (byte) 74) + arg0 / 1000 + Class74.aClass74_75.method1259(arg1, (byte) 35) + Class47.aString8;
		} else {
			return Class389.method28272(arg2.anInt5779 * -1266008869, (byte) 12) + arg0 / 1000000 + Class74.aClass74_68.method1259(arg1, (byte) -16) + Class47.aString8;
		}
	}
}
