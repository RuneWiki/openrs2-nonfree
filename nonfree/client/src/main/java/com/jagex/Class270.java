...
public class Class270 {
	...
	public int method26277(@OriginalArg(0) int arg0) {
	...
	public Class279 method26278(@OriginalArg(0) int arg0) {
		return (Class279) this.aList8.get(arg0);
	}

	@OriginalMember(owner = "client!fo", name = "k", descriptor = "(Lclient!fy;I)I", line = 30)
	public int method26285(@OriginalArg(0) Class279 arg0) {
		return this.method26280(arg0, -1);
	}
	...
	public int method26275(@OriginalArg(0) Class279 arg0, @OriginalArg(1) int arg1) {
		...
		} else if (this.method26277(arg0.anInt3891 * 1676750823) == -1) {
			if (arg1 == -1) {
	...
	public int method26280(@OriginalArg(0) Class279 arg0, @OriginalArg(1) int arg1) {
		if (this.aList8.size() == 5) {
			throw new RuntimeException("");
		} else if (this.method26277(arg0.anInt3891 * 1676750823) == -1) {
			if (arg1 == -1) {
	...
	public void method26281(@OriginalArg(0) int arg0) {
	...
	public static Class109 method26298(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Class109 arg5, @OriginalArg(6) short arg6, @OriginalArg(7) byte arg7, @OriginalArg(8) Class19 arg8) {
		if (arg5 == null) {
			return null;
		}
		@Pc(5) int local5 = 2055;
		if (arg8 != null) {
			local5 |= arg8.method23564();
			local5 &= 0xFFFFFDFF;
		}
	...
	static final void method26296(@OriginalArg(0) Class681 arg0) {
	...
	static final void method26297(@OriginalArg(0) Class681 arg0) {
	...
	static final void method26299(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		...
		@Pc(44) Class93_Sub40 local44 = (Class93_Sub40) client.aClass16_22.method220();
		while (local12-- > 0) {
			local44 = (Class93_Sub40) client.aClass16_22.method222();
		}
