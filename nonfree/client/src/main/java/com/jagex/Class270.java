...
public class Class270 {
	...
	public int method26275(@OriginalArg(0) Class279 arg0, @OriginalArg(1) int arg1) {
	...
	public int method26276(@OriginalArg(0) int arg0) {
	...
	public Class279 method26278(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public int method26280(@OriginalArg(0) Class279 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (this.aList8.size() == 5) {
			throw new RuntimeException("");
	...
	public void method26281(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aList8.remove(arg0);
	}

	@OriginalMember(owner = "client!fo", name = "y", descriptor = "(I)V", line = 42)
	public void method26282(@OriginalArg(0) int arg0) {
		this.aList8.remove(arg0);
	}
	...
	public int method26284(@OriginalArg(0) int arg0) {
		for (@Pc(1) int local1 = 0; local1 < this.aList8.size(); local1++) {
			if (((Class279) this.aList8.get(local1)).anInt3891 * 1676750823 == arg0) {
				return local1;
			}
	...
	public int method26285(@OriginalArg(0) Class279 arg0, @OriginalArg(1) int arg1) {
		return this.method26280(arg0, -1, -1732060473);
	}

	@OriginalMember(owner = "client!fo", name = "q", descriptor = "(I)V", line = 42)
	public void method26286(@OriginalArg(0) int arg0) {
		this.aList8.remove(arg0);
	}

	@OriginalMember(owner = "client!fo", name = "c", descriptor = "(Lclient!fy;)I", line = 30)
	public int method26287(@OriginalArg(0) Class279 arg0) {
		return this.method26280(arg0, -1, 1974077087);
	}

	@OriginalMember(owner = "client!fo", name = "l", descriptor = "(I)V", line = 46)
	public void method26288(@OriginalArg(0) int arg0) {
		this.aList8.clear();
	}

	@OriginalMember(owner = "client!fo", name = "v", descriptor = "(Lclient!fy;I)I", line = 34)
	public int method26289(@OriginalArg(0) Class279 arg0, @OriginalArg(1) int arg1) {
		if (this.aList8.size() == 5) {
			throw new RuntimeException("");
	...
	public int method26290(@OriginalArg(0) Class279 arg0, @OriginalArg(1) int arg1) {
		if (this.aList8.size() == 5) {
			throw new RuntimeException("");
	...
	public int method26291(@OriginalArg(0) Class279 arg0, @OriginalArg(1) int arg1) {
		if (this.aList8.size() == 5) {
			throw new RuntimeException("");
	...
	public int method26292(@OriginalArg(0) Class279 arg0) {
		return this.method26280(arg0, -1, 2048426316);
	}
	...
	static final void method26296(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method26297(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	public static Class109 method26298(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Class109 arg5, @OriginalArg(6) short arg6, @OriginalArg(7) byte arg7, @OriginalArg(8) Class19 arg8, @OriginalArg(9) int arg9) {
		if (arg5 == null) {
			return null;
		}
		@Pc(5) int local5 = 2055;
		if (arg8 != null) {
			local5 |= arg8.method23564(-1871244151);
			local5 &= 0xFFFFFDFF;
		}
		...
		synchronized (Class330.aClass240_79) {
			local35 = (Class109) Class330.aClass240_79.method25839(local26);
		}
		if (local35 == null || arg0.method20693(local35.method6825(), local5) != 0) {
			...
			local35 = arg0.method20510(local66, local5, Class330.anInt4146 * -1710939251, 64, 768);
			@Pc(154) Class240 local154 = Class330.aClass240_79;
			synchronized (Class330.aClass240_79) {
				Class330.aClass240_79.method25830(local35, local26);
			}
		}
		...
		if (arg8 == null) {
			...
			arg8.method23567(local35, (byte) 110);
		}
		if (arg2 != 0) {
