...
public class Class637 {
	...
	public Class637(@OriginalArg(0) Class497 arg0) {
		@Pc(14) byte[] local14 = arg0.method30059(Class649.aClass649_9.anInt5795 * -51136173);
		if (local14 == null) {
		}
		this.method32449(new Class93_Sub41(local14));
	}

	@OriginalMember(owner = "client!wh", name = "e", descriptor = "(Lclient!alw;S)V", line = 36)
	void method32449(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			...
			if (local3 == 1) {
				this.anInt5742 = arg0.method22419() * 665851349;
			} else if (local3 == 2) {
				this.anInt5743 = arg0.method22419() * -840389275;
			} else if (local3 == 3) {
				this.anInt5744 = arg0.method22419() * -1776279231;
			} else if (local3 == 4) {
				this.anInt5745 = arg0.method22413() * -167208525;
			} else if (local3 == 5) {
				this.anInt5746 = arg0.method22413() * 329391631;
			} else if (local3 == 6) {
				this.anInt5747 = arg0.method22419() * 793463205;
			} else if (local3 == 7) {
				this.anInt5738 = arg0.method22419() * -650604495;
			} else if (local3 >= 100) {
				local3 -= 100;
				this.anIntArrayArray66[local3 & (int) (Math.pow(2.0D, 3.0D) - 1.0D)][local3 >> 3] = arg0.method22415();
			}
		}
	}
	...
	static final void method32455(@OriginalArg(0) Class681 arg0) {
		@Pc(2) Class154_Sub1 local2 = Class443.method28870();
		if (local2 != null) {
	...
	static final void method32454(@OriginalArg(0) Class681 arg0) {
		...
		if (local27.length() <= 500 && local38.length() <= 500) {
			Class330.method27371(local12, local27, local38);
		}
	}
}
