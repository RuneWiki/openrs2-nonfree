...
public class Class189 {
	...
	static String method24583(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	static final void method24584(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (Class383.method28145(arg0, null)) {
			Class550.method31033(Class166_Sub1.aClass320Array1[arg0].aClass312Array3, arg1);
		}
	}

	@OriginalMember(owner = "client!bl", name = "azm", descriptor = "(Lclient!yf;B)V", line = 14201)
	static final void method24582(@OriginalArg(0) Class681 arg0) {
