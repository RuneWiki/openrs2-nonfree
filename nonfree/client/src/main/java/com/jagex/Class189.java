...
public class Class189 {
	...
	static final void method24582(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!bl", name = "n", descriptor = "([BIII)Ljava/lang/String;", line = 62)
	static String method24583(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	static final void method24584(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (Class383.method28145(arg0, (int[]) null, 1588031466)) {
			Class550.method31033(Class166_Sub1.aClass320Array1[arg0].aClass312Array3, arg1, (byte) 49);
		}
	}
}
