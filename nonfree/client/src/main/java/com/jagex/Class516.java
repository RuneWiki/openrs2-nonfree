...
public class Class516 {
	...
	public static Class160 method30289(@OriginalArg(0) Socket arg0, @OriginalArg(1) int arg1) throws IOException {
	...
	public static int method30278(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(3) int local3 = arg2 & 0x3;
		if (local3 == 0) {
			return arg0;
		} else if (local3 == 1) {
	...
	public static int method30279(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		if ((arg5 & 0x1) == 1) {
	...
	static final void method30290(@OriginalArg(0) Class681 arg0) {
