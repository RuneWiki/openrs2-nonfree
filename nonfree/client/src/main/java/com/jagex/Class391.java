...
public class Class391 implements Interface33 {
	...
	int method28286(@OriginalArg(0) Class106 arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		return arg0.method7563(arg1, arg4 + arg2, arg4 + arg3, this.aClass383_1.anInt4638 * -1061715617 - arg4 * 2, this.aClass383_1.anInt4639 * -1224526545 - arg4 * 2, this.aClass383_1.anInt4636 * 2084249013, this.aClass383_1.anInt4637 * 766491199, 0, 0, 0, (Class100[]) null, (int[]) null, (Class96) null, 0, 0, (short) 657);
	}
	...
	public void method28285(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		@Pc(9) Class376 local9 = this.aClass377_2.method28050(this.aClass383_1.anInt4640 * -87994391, 1980145941);
		if (local9 == null) {
			return;
		}
		@Pc(32) int local32 = this.aClass383_1.aClass390_10.method28273(this.aClass383_1.anInt4638 * -1061715617, client.anInt3511 * 2040043391, -281081870) + this.aClass383_1.anInt4634 * -798260597;
		@Pc(52) int local52 = this.aClass383_1.aClass392_10.method28290(this.aClass383_1.anInt4639 * -1224526545, client.anInt3512 * -817449061, (short) 255) + this.aClass383_1.anInt4635 * -1626253363;
		if (this.aClass383_1.aBoolean740) {
			Class694.aClass104_14.method20478(local32, local52, this.aClass383_1.anInt4638 * -1061715617, this.aClass383_1.anInt4639 * -1224526545, this.aClass383_1.anInt4633 * 447508329, 0);
		}
		local52 += this.method28286(Class118_Sub1.aClass106_3, local9.aString192, local32, local52, 5, 880463574) * 12;
		local52 += 8;
		if (this.aClass383_1.aBoolean740) {
			Class694.aClass104_14.method20484(local32, local52, local32 + this.aClass383_1.anInt4638 * -1061715617 - 1, local52, this.aClass383_1.anInt4633 * 447508329, 0);
		}
		local52++;
	...
	public void method28281(@OriginalArg(0) boolean arg0) {
		@Pc(9) Class376 local9 = this.aClass377_2.method28050(this.aClass383_1.anInt4640 * -87994391, 1420835547);
		if (local9 == null) {
			return;
		}
		@Pc(32) int local32 = this.aClass383_1.aClass390_10.method28273(this.aClass383_1.anInt4638 * -1061715617, client.anInt3511 * 2040043391, 1499997051) + this.aClass383_1.anInt4634 * -798260597;
		@Pc(52) int local52 = this.aClass383_1.aClass392_10.method28290(this.aClass383_1.anInt4639 * -1224526545, client.anInt3512 * -817449061, (short) 255) + this.aClass383_1.anInt4635 * -1626253363;
		if (this.aClass383_1.aBoolean740) {
			Class694.aClass104_14.method20478(local32, local52, this.aClass383_1.anInt4638 * -1061715617, this.aClass383_1.anInt4639 * -1224526545, this.aClass383_1.anInt4633 * 447508329, 0);
		}
	...
	public void method28282(@OriginalArg(0) boolean arg0) {
		@Pc(9) Class376 local9 = this.aClass377_2.method28050(this.aClass383_1.anInt4640 * -87994391, -1080400681);
		if (local9 == null) {
			return;
		}
		@Pc(32) int local32 = this.aClass383_1.aClass390_10.method28273(this.aClass383_1.anInt4638 * -1061715617, client.anInt3511 * 2040043391, -595781350) + this.aClass383_1.anInt4634 * -798260597;
		@Pc(52) int local52 = this.aClass383_1.aClass392_10.method28290(this.aClass383_1.anInt4639 * -1224526545, client.anInt3512 * -817449061, (short) 255) + this.aClass383_1.anInt4635 * -1626253363;
		if (this.aClass383_1.aBoolean740) {
			Class694.aClass104_14.method20478(local32, local52, this.aClass383_1.anInt4638 * -1061715617, this.aClass383_1.anInt4639 * -1224526545, this.aClass383_1.anInt4633 * 447508329, 0);
		}
	...
	public boolean method28279(@OriginalArg(0) int arg0) {
		return this.aClass377_2.method28054((byte) 0);
	}
	...
	static final void method28287(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method28288(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		Class237.method25776(arg1, arg0, (byte) 48);
		if (arg0.anInt3971 * -158526639 == 0) {
			Class548.method31016(arg1, arg0, false, 1481485788);
		}
		if (arg0.anInt3970 * 532402067 == -1 && !arg1.aBoolean708) {
			Class110_Sub1.method6372(arg0.anInt3953 * -1549590237, (byte) -47);
		}
	}

	@OriginalMember(owner = "client!kw", name = "gd", descriptor = "(Lclient!ahm;I)V", line = 3902)
	static final void method28289(@OriginalArg(0) Class132_Sub1_Sub1_Sub1 arg0, @OriginalArg(1) int arg1) {
		@Pc(2) Class19 local2 = arg0.aClass19_3;
		if (arg0.anInt2762 * -1538623211 == client.anInt3485 || !local2.method23552(392779085) || local2.method23575(1, -1338319326)) {
			...
			@Pc(45) int local45 = arg0.anInt2775 * -1016506880 + arg0.method19997(-1274879683) * 256;
			@Pc(56) int local56 = arg0.anInt2777 * -294398464 + arg0.method19997(1416437668) * 256;
			@Pc(67) int local67 = arg0.anInt2793 * -195442176 + arg0.method19997(927700343) * 256;
			@Pc(78) int local78 = arg0.anInt2778 * 1120552448 + arg0.method19997(-219874162) * 256;
			...
			@Pc(111) int local111 = Class305.method26801(local90, local102, arg0.anInt2773 * -1628091145, (byte) 0);
			@Pc(120) int local120 = Class305.method26801(local67, local78, arg0.anInt2779 * -1734662383, (byte) -20);
			@Pc(132) int local132 = ((local27 - local34) * local111 + local120 * local34) / local27;
			arg0.method24231((float) local90, (float) local132, (float) local102);
		}
		arg0.anInt2791 = 0;
		arg0.method19952(arg0.anInt2782 * -1729677103, false, 1713513919);
	}
}
