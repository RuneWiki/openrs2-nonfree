...
public class Class391 implements Interface33 {
	...
	public boolean method28279() {
		return this.aClass377_2.method28054();
	}
	...
	public void method28285(@OriginalArg(0) boolean arg0) {
		@Pc(9) Class376 local9 = this.aClass377_2.method28050(this.aClass383_1.anInt4640 * -87994391);
		if (local9 == null) {
			return;
		}
		@Pc(32) int local32 = this.aClass383_1.aClass390_10.method28273(this.aClass383_1.anInt4638 * -1061715617, client.anInt3511 * 2040043391) + this.aClass383_1.anInt4634 * -798260597;
		@Pc(52) int local52 = this.aClass383_1.aClass392_10.method28290(this.aClass383_1.anInt4639 * -1224526545, client.anInt3512 * -817449061) + this.aClass383_1.anInt4635 * -1626253363;
		...
		local52 += this.method28286(Class118_Sub1.aClass106_3, local9.aString192, local32, local52, 5) * 12;
		local52 += 8;
		if (this.aClass383_1.aBoolean740) {
		...
		local52++;
		local52 += this.method28286(Class118_Sub1.aClass106_3, local9.aString193, local32, local52, 5) * 12;
		local52 += 5;
		@Pc(144) int local144 = local52 + this.method28286(Class118_Sub1.aClass106_3, local9.aString194, local32, local52, 5) * 12;
	}
	...
	int method28286(@OriginalArg(0) Class106 arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		return arg0.method7563(arg1, arg4 + arg2, arg4 + arg3, this.aClass383_1.anInt4638 * -1061715617 - arg4 * 2, this.aClass383_1.anInt4639 * -1224526545 - arg4 * 2, this.aClass383_1.anInt4636 * 2084249013, this.aClass383_1.anInt4637 * 766491199, 0, 0, 0, null, null, null, 0, 0);
	}

	@OriginalMember(owner = "client!kw", name = "gd", descriptor = "(Lclient!ahm;I)V", line = 3902)
	static final void method28289(@OriginalArg(0) Class132_Sub1_Sub1_Sub1 arg0) {
		@Pc(2) Class19 local2 = arg0.aClass19_3;
		if (arg0.anInt2762 * -1538623211 == client.anInt3485 || !local2.method23552() || local2.method23575(1)) {
			...
			@Pc(45) int local45 = arg0.anInt2775 * -1016506880 + arg0.method19997() * 256;
			@Pc(56) int local56 = arg0.anInt2777 * -294398464 + arg0.method19997() * 256;
			@Pc(67) int local67 = arg0.anInt2793 * -195442176 + arg0.method19997() * 256;
			@Pc(78) int local78 = arg0.anInt2778 * 1120552448 + arg0.method19997() * 256;
			...
			@Pc(111) int local111 = Class305.method26801(local90, local102, arg0.anInt2773 * -1628091145);
			@Pc(120) int local120 = Class305.method26801(local67, local78, arg0.anInt2779 * -1734662383);
		...
		arg0.anInt2791 = 0;
		arg0.method19952(arg0.anInt2782 * -1729677103, false);
	}

	@OriginalMember(owner = "client!kw", name = "bf", descriptor = "(Lclient!yf;B)V", line = 5081)
	static final void method28287(@OriginalArg(0) Class681 arg0) {
	...
	static final void method28288(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
		...
		Class237.method25776(arg1, arg0);
		if (arg0.anInt3971 * -158526639 == 0) {
			Class548.method31016(arg1, arg0, false);
		}
		if (arg0.anInt3970 * 532402067 == -1 && !arg1.aBoolean708) {
			Class110_Sub1.method6372(arg0.anInt3953 * -1549590237);
		}
	}
}
