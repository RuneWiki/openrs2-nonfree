...
public class Class81 {
	...
	public Class81(@OriginalArg(0) Class702 arg0, @OriginalArg(1) Class717 arg1, @OriginalArg(2) Class497 arg2) {
		...
		@Pc(14) Class93_Sub41 local14 = new Class93_Sub41(this.aClass497_12.method30044(0, 0));
		@Pc(29) int local29 = local14.aByteArray58 == null || local14.aByteArray58.length < 1 ? -1 : local14.method22413();
		if (local29 < 4) {
			this.aClass90Array1 = new Class90[0];
			this.anInt247 = -1987484731;
		} else {
			@Pc(44) int local44 = local14.method22413();
			@Pc(47) Class388[] local47 = Class352.method27671();
			@Pc(49) boolean local49 = true;
			@Pc(58) int local58;
			@Pc(66) int local66;
			if (local44 == local47.length) {
				for (local58 = 0; local58 < local47.length; local58++) {
					local66 = local14.method22413();
			...
			if (local49) {
				local58 = local14.method22413();
				local66 = local14.method22413();
				@Pc(107) int local107;
				@Pc(103) int local103;
				if (local29 > 2) {
					this.anInt247 = local14.method22482() * 1987484731;
					local103 = local14.method22417();
					local107 = local14.method22415();
				} else {
					this.anInt247 = -1987484731;
					local103 = 0;
					local107 = 0;
				...
				for (local123 = 0; local123 < local58; local123++) {
					@Pc(130) int local130 = local14.method22413();
					@Pc(139) boolean local139 = local14.method22413() == 1;
					@Pc(143) int local143 = local14.method22415();
					...
					if (this.anInt247 * -1778000653 == -1) {
						...
						for (local154 = 0; local154 < local143; local154++) {
							local161 = local14.method22415();
							local165 = local14.method22417();
							local169 = local14.method22415();
				...
				for (local123 = 0; local123 < local66 + 1; local123++) {
					if (this.aClass90Array1[local123] == null) {
						this.aClass90Array1[local123] = this.method1367(local103, local107);
					}
				}
			} else {
				this.aClass90Array1 = new Class90[0];
	...
	Class90 method1367(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt247 * -1778000653 == -1) {
	...
	public Class86 method1368(@OriginalArg(0) int arg0) {
		@Pc(6) byte[] local6 = this.aClass497_12.method30044(arg0, 0);
		@Pc(10) Class86 local10 = new Class86();
		local10.method1491(new Class93_Sub41(local6));
		return local10;
	}
	...
	static float method1379(@OriginalArg(0) Class248 arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3) {
	...
	public Class84[] method1369(@OriginalArg(0) int arg0) {
		if (arg0 < 0 || arg0 >= this.aClass90Array1.length) {
			return this.method1367(0, 0).aClass84Array1;
		}
		...
		for (@Pc(58) int local58 = local39; local58 < local48.length; local58++) {
			@Pc(72) int local72 = Class58.method1100(local43, local48.length - local39) + local39;
	...
	static final void method1378(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
	...
	static final void method1377(@OriginalArg(0) Class681 arg0) {
		Class447.aClass447_5.method28904();
	}
}
