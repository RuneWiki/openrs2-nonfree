...
public class Class250 {
	...
	void method25947(@OriginalArg(0) Class239 arg0, @OriginalArg(1) int arg1) {
		@Pc(4) int local4 = this.anIntArray356[0];
		arg0.method25803(arg1, local4 >>> 16, local4 & 0xFFFF, -1020254641);
		@Pc(18) Class132_Sub1_Sub1_Sub1 local18 = arg0.method25807(1254220821);
		local18.anInt2763 = 0;
	...
	Class250(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(5) int local5 = arg0.method22632((byte) -55);
		...
		for (@Pc(15) int local15 = 0; local15 < local5; local15++) {
			...
			@Pc(31) int local31 = arg0.method22415(-1434290800);
			@Pc(35) int local35 = arg0.method22415(-1434290800);
	...
	void method25948(@OriginalArg(0) Class239 arg0, @OriginalArg(1) int arg1) {
		@Pc(4) int local4 = this.anIntArray356[0];
		arg0.method25803(arg1, local4 >>> 16, local4 & 0xFFFF, 349463304);
		@Pc(18) Class132_Sub1_Sub1_Sub1 local18 = arg0.method25807(1919822049);
		local18.anInt2763 = 0;
		for (@Pc(27) int local27 = this.anIntArray355.length - 1; local27 >= 0; local27--) {
			@Pc(34) int local34 = this.anIntArray355[local27];
			@Pc(39) int local39 = this.anIntArray356[local27];
	...
	void method25949(@OriginalArg(0) Class239 arg0, @OriginalArg(1) int arg1) {
		@Pc(4) int local4 = this.anIntArray356[0];
		arg0.method25803(arg1, local4 >>> 16, local4 & 0xFFFF, -939862014);
		@Pc(18) Class132_Sub1_Sub1_Sub1 local18 = arg0.method25807(-1290844368);
		local18.anInt2763 = 0;
		for (@Pc(27) int local27 = this.anIntArray355.length - 1; local27 >= 0; local27--) {
			@Pc(34) int local34 = this.anIntArray355[local27];
			@Pc(39) int local39 = this.anIntArray356[local27];
	...
	void method25950(@OriginalArg(0) Class239 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(4) int local4 = this.anIntArray356[0];
		arg0.method25803(arg1, local4 >>> 16, local4 & 0xFFFF, 1307858294);
		@Pc(18) Class132_Sub1_Sub1_Sub1 local18 = arg0.method25807(-582845844);
		local18.anInt2763 = 0;
		for (@Pc(27) int local27 = this.anIntArray355.length - 1; local27 >= 0; local27--) {
			@Pc(34) int local34 = this.anIntArray355[local27];
			@Pc(39) int local39 = this.anIntArray356[local27];
	...
	static final void method25951(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method25952(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method25953(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method25955(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1563000145);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class542.method30934(local16, local22, arg0, 1189701933);
	}

	@OriginalMember(owner = "client!er", name = "e", descriptor = "(Lclient!yu;Lclient!ze;II)I", line = 11)
	public static int method25956(@OriginalArg(0) Class693 arg0, @OriginalArg(1) Class703 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
