...
public class Class27 {
	...
	static byte[] method591(@OriginalArg(0) File arg0, @OriginalArg(1) int arg1) {
		try {
			@Pc(2) byte[] local2 = new byte[arg1];
			Class305.method26803(arg0, local2, arg1);
			return local2;
	...
	static void method586(@OriginalArg(0) Class681 arg0) {
		arg0.anIntArray519[arg0.anInt5891 * -1497248091 - 2] = ((Class347) Class288.aClass55_Sub2_1.method18261(arg0.anIntArray519[arg0.anInt5891 * -1497248091 - 2])).method27589(Class624.aClass120_1, arg0.anIntArray519[arg0.anInt5891 * -1497248091 - 1]) ? 1 : 0;
		arg0.anInt5891 -= 1189701933;
	}

	@OriginalMember(owner = "client!ab", name = "p", descriptor = "([BB)V", line = 623)
	static void method585(@OriginalArg(0) byte[] arg0) {
		...
		while (true) {
			...
			if (local8 == 1) {
				Class671.anInt5859 = local4.method22415() * -1748294101;
			} else if (local8 == 10) {
				local4.method22415();
			}
		}
	...
	static final void method587(@OriginalArg(0) Class681 arg0) {
		...
		Class354.method27696(local14);
	}

	@OriginalMember(owner = "client!ab", name = "alf", descriptor = "(Lclient!yf;I)V", line = 11921)
	static final void method588(@OriginalArg(0) Class681 arg0) {
	...
	static final void method590(@OriginalArg(0) Class681 arg0) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!ab", name = "bcv", descriptor = "(Lclient!kr;I)Lclient!eh;", line = 14587)
	static Interface20 method589(@OriginalArg(0) Class386 arg0) {
