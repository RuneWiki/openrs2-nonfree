...
public class Class27 {
	...
	static void method585(@OriginalArg(0) byte[] arg0, @OriginalArg(1) byte arg1) {
		...
		while (true) {
			...
			if (local8 == 1) {
				Class671.anInt5859 = local4.method22415(-1434290800) * -1748294101;
			} else if (local8 == 10) {
				local4.method22415(-1434290800);
			}
		}
	}
	...
	static void method586(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[arg0.anInt5891 * -1497248091 - 2] = ((Class347) Class288.aClass55_Sub2_1.method18261(arg0.anIntArray519[-1497248091 * arg0.anInt5891 - 2], 957882178)).method27589(Class624.aClass120_1, arg0.anIntArray519[arg0.anInt5891 * -1497248091 - 1], -2112159817) ? 1 : 0;
		arg0.anInt5891 -= 1189701933;
	}

	@OriginalMember(owner = "client!ab", name = "bt", descriptor = "(Lclient!yf;I)V", line = 5134)
	static final void method587(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(14) Class312 local14 = Class659.method32805(arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091], -8048167);
		local14.aClass312Array2 = null;
		local14.aClass312Array1 = null;
		Class354.method27696(local14, -1174743804);
	}
	...
	static byte[] method591(@OriginalArg(0) File arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		try {
			...
			Class305.method26803(arg0, local2, arg1, 1354045309);
			return local2;
