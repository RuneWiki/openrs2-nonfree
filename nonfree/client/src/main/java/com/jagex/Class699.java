...
public class Class699 implements Interface31 {
	...
	public static int method36706(@OriginalArg(0) int arg0) {
		...
		@Pc(19) Class104 local19 = Class5.method79(0, local3, (Class225) null, (Interface24) null, (Interface48) null, (Interface46) null, (Interface47) null, (Class497) null, 0, 636490669);
		@Pc(22) long local22 = Class305.method26796(1712770404);
		@Pc(24) int local24;
		for (local24 = 0; local24 < 10000; local24++) {
			local19.method20851(5, 10, 100.0F, 75, 50, 100.0F, 15, 90, 100.0F, -65536, -65536, -65536, 1);
		}
		local24 = (int) (Class305.method26796(-384106333) - local22);
		local19.method20600(0, 0, 100, 100, -16777216, (byte) 32);
		local19.method20877(-858326133);
		return local24;
	}

	@OriginalMember(owner = "client!z", name = "e", descriptor = "(B)V", line = 30)
	static void method36707(@OriginalArg(0) byte arg0) {
		Class366.aClass240_80.method25833((byte) -112);
	}

	@OriginalMember(owner = "client!z", name = "nf", descriptor = "(Lclient!yf;B)V", line = 7466)
	static final void method36708(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, -668486315);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class170.method21484(local16, local22, arg0, (byte) 0);
	}

	@OriginalMember(owner = "client!z", name = "ca", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;I)V", line = 5357)
	static final void method36709(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
