...
public class Class699 implements Interface31 {
	...
	@Override
	public Interface29 method36705(@OriginalArg(0) Class363 arg0, @OriginalArg(1) int arg1) {
		if (Class363.aClass363_1 == arg0) {
			return client.aClass132_Sub1_Sub1_Sub1_Sub2Array1[arg1];
		}
		if (Class363.aClass363_2 == arg0) {
	...
	public static int method36706() {
		@Pc(3) Canvas local3 = new Canvas();
		local3.setSize(100, 100);
		@Pc(19) Class104 local19 = Class5.method79(0, local3, null, null, null, null, null, null, 0);
		@Pc(22) long local22 = Class305.method26796();
		@Pc(24) int local24;
		for (local24 = 0; local24 < 10000; local24++) {
			local19.method20851(5, 10, 100.0F, 75, 50, 100.0F, 15, 90, 100.0F, -65536, -65536, -65536, 1);
		}
		local24 = (int) (Class305.method26796() - local22);
		local19.method20600(0, 0, 100, 100, -16777216);
		local19.method20877();
		return local24;
	}

	@OriginalMember(owner = "client!z", name = "e", descriptor = "(B)V", line = 30)
	static void method36707() {
		Class366.aClass240_80.method25833();
	}

	@OriginalMember(owner = "client!z", name = "ca", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;I)V", line = 5357)
	static final void method36709(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
	...
	static final void method36708(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class170.method21484(local16, local22, arg0);
	}

	@OriginalMember(owner = "client!z", name = "aln", descriptor = "(Lclient!yf;B)V", line = 11834)
	static final void method36710(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		if (Class4.aBoolean2) {
			Class717.method36895(3, local13, local23, false);
