...
public class Class689 {
	...
	static void method36523(@OriginalArg(0) Class93_Sub39 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(12) Class93_Sub1_Sub13 local12 = Class407.method28583(local8, 1200487767);
		if (local12 == null) {
			return;
		}
	...
	static final void method36524(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class251.method25970(local11, local14, arg0, 1944953898);
	}

	@OriginalMember(owner = "client!yo", name = "rf", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;I)V", line = 8060)
	static final void method36525(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		arg0.anObjectArray41 = Class499.method30148(local13, arg2, -1318530352);
		arg0.aBoolean680 = true;
	}

	@OriginalMember(owner = "client!yo", name = "aaj", descriptor = "(Lclient!yf;I)V", line = 9726)
	static final void method36526(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method36527(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub20_1.method15775(-1831440856) == 2 ? 1 : 0;
	}
	...
	static final void method36528(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		Class267.method26248(local13, local23 >> 14 & 0x3FFF, local23 & 0x3FFF, true, 1302861754);
	}

	@OriginalMember(owner = "client!yo", name = "hb", descriptor = "(B)V", line = 4378)
	static final void method36529(@OriginalArg(0) byte arg0) {
		Class143.method11063(Class694.aClass104_14, (long) client.anInt3485);
		if (client.anInt3526 * -703563959 != -1) {
			Class19.method23634(client.anInt3526 * -703563959, 1117783766);
		}
		@Pc(15) int local15;
		...
		Class510.method30245(Class694.aClass104_14, 1483618617);
		local15 = Class168.method17628(572497392);
		if (local15 == -1) {
		...
		Class696.method36650(local15, -683792111);
		client.anInt3480 = 0;
	}
}
