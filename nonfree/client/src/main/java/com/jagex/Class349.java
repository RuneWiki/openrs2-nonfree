...
public class Class349 {
	...
	static boolean method27625(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		return Class110.method20146(arg0, arg1, "openjs");
	}

	@OriginalMember(owner = "client!iu", name = "n", descriptor = "(S)Z", line = 123)
	static boolean method27624() {
		return Class411.anInt4746 * 276097583 == -1 ? Class93_Sub3.method11813(Class411.aString200, Class411.aString201) : Class219.method25512();
	}

	@OriginalMember(owner = "client!iu", name = "je", descriptor = "(Lclient!yf;I)V", line = 6649)
	static final void method27629(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= 1189701933;
	}

	@OriginalMember(owner = "client!iu", name = "kb", descriptor = "(Lclient!hf;I)Z", line = 11816)
	static boolean method27628(@OriginalArg(0) Class312 arg0) {
		@Pc(2) Class93_Sub19 local2 = client.method25238(arg0);
		if (local2.method13639() > 0) {
			return true;
		} else if (local2.method13630()) {
			return true;
		} else {
	...
	static final void method27626(@OriginalArg(0) Class681 arg0) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!iu", name = "awd", descriptor = "(Lclient!yf;I)V", line = 13777)
	static final void method27627(@OriginalArg(0) Class681 arg0) {
