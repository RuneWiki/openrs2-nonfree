...
public class Class86 {
	...
	void method1491(@OriginalArg(0) Class93_Sub41 arg0) {
		this.anInterface32Array1 = new Interface32[arg0.method22413()];
		@Pc(8) Class388[] local8 = Class352.method27671();
		for (@Pc(10) int local10 = 0; local10 < this.anInterface32Array1.length; local10++) {
			this.anInterface32Array1[local10] = this.method1492(arg0, local8[arg0.method22413()]);
		}
	}
	...
	Interface32 method1490(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) Class388 arg1) {
		if (Class388.aClass388_4 == arg1) {
			return Class148_Sub1.method11759(arg0);
		} else if (arg1 == Class388.aClass388_2) {
			return Class679.method33237(arg0);
		} else if (Class388.aClass388_5 == arg1) {
			return Class466.method29326(arg0);
		} else if (arg1 == Class388.aClass388_6) {
			return Class121_Sub1.method8710(arg0);
		} else if (arg1 == Class388.aClass388_8) {
			return Class449.method28928(arg0);
		} else if (arg1 == Class388.aClass388_3) {
			return Class389.method28267(arg0);
		} else if (arg1 == Class388.aClass388_7) {
			return Class661.method32844(arg0);
		} else if (arg1 == Class388.aClass388_1) {
			return Class249.method25946(arg0);
		} else if (Class388.aClass388_9 == arg1) {
			return Class590.method31690(arg0);
		} else if (arg1 == Class388.aClass388_10) {
			return Class496.method30043(arg0);
		} else if (arg1 == Class388.aClass388_11) {
			return Class66.method1198(arg0);
		} else {
			return null;
		}
	}
	...
	public static void method1494(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg2 >= arg3) {
			return;
		}
		...
		method1494(arg0, arg1, arg2, local10 - 1);
		method1494(arg0, arg1, local10 + 1, arg3);
	}

	@OriginalMember(owner = "client!adn", name = "dl", descriptor = "(Lclient!yf;I)V", line = 5611)
	static final void method1495(@OriginalArg(0) Class681 arg0) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class686.method33484(local11, local14, arg0);
	}
}
