...
public class Class86 {
	...
	Interface32 method1490(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) Class388 arg1) {
		if (Class388.aClass388_4 == arg1) {
			...
			return Class679.method33237(arg0, 1443923962);
			...
			return Class449.method28928(arg0, 1469790899);
		} else if (arg1 == Class388.aClass388_3) {
			return Class389.method28267(arg0, -306182323);
		} else if (arg1 == Class388.aClass388_7) {
			return Class661.method32844(arg0, (byte) 44);
		} else if (arg1 == Class388.aClass388_1) {
			return Class249.method25946(arg0, (byte) 114);
		} else if (Class388.aClass388_9 == arg1) {
			return Class590.method31690(arg0, -891080090);
		} else if (arg1 == Class388.aClass388_10) {
			return Class496.method30043(arg0, -1201705695);
	...
	void method1491(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		this.anInterface32Array1 = new Interface32[arg0.method22413((short) 16384)];
		@Pc(8) Class388[] local8 = Class352.method27671(392010971);
		for (@Pc(10) int local10 = 0; local10 < this.anInterface32Array1.length; local10++) {
			this.anInterface32Array1[local10] = this.method1492(arg0, local8[arg0.method22413((short) 16384)], 98630545);
		}
	}
	...
	Interface32 method1492(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) Class388 arg1, @OriginalArg(2) int arg2) {
		if (Class388.aClass388_4 == arg1) {
			...
			return Class449.method28928(arg0, 1040159588);
		} else if (arg1 == Class388.aClass388_3) {
			return Class389.method28267(arg0, -765917292);
		} else if (arg1 == Class388.aClass388_7) {
			return Class661.method32844(arg0, (byte) 36);
		} else if (arg1 == Class388.aClass388_1) {
			return Class249.method25946(arg0, (byte) 79);
		} else if (Class388.aClass388_9 == arg1) {
			return Class590.method31690(arg0, -1544199103);
		} else if (arg1 == Class388.aClass388_10) {
			return Class496.method30043(arg0, -1425693500);
		} else if (arg1 == Class388.aClass388_11) {
			return Class66.method1198(arg0, 1059403033);
		} else {
			return null;
	...
	void method1493(@OriginalArg(0) Class93_Sub41 arg0) {
		this.anInterface32Array1 = new Interface32[arg0.method22413((short) 16384)];
		@Pc(8) Class388[] local8 = Class352.method27671(1352072445);
		for (@Pc(10) int local10 = 0; local10 < this.anInterface32Array1.length; local10++) {
			this.anInterface32Array1[local10] = this.method1492(arg0, local8[arg0.method22413((short) 16384)], 98630545);
		}
	}
	...
	static final void method1495(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		Class686.method33484(local11, local14, arg0, -28977544);
	}
}
