...
public class Class331 {
	...
	public void method27374(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) byte arg9) {
		this.method27376(arg0, 2047970158);
	...
	public void method27375(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.method27376(arg0, 2047970158);
		this.anIntArray408[arg0] = arg1;
	}

	@OriginalMember(owner = "client!ia", name = "m", descriptor = "(II)V", line = 65)
	void method27376(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	void method27378(@OriginalArg(0) int arg0) {
		if (arg0 < this.anIntArray408.length) {
			return;
		}
		@Pc(9) int[] local9 = new int[arg0 + 1];
	...
	public void method27379(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		this.method27376(arg0, 2047970158);
		this.anIntArray408[arg0] = arg1;
		this.aFloatArray105[arg0] = arg2;
		this.anIntArrayArray52[arg0][0] = arg3;
	...
	void method27380(@OriginalArg(0) int arg0) {
		if (arg0 < this.anIntArray408.length) {
			return;
		}
		@Pc(9) int[] local9 = new int[arg0 + 1];
	...
	public void method27383(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.method27376(arg0, 2047970158);
		this.anIntArray408[arg0] = arg1;
	}

	@OriginalMember(owner = "client!ia", name = "y", descriptor = "(IILclient!hf;Lclient!hx;IIS)V", line = 578)
	static void method27384(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class312 arg2, @OriginalArg(3) Class327 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) short arg6) {
	...
	static final void method27385(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub17_1.method16543(local12, -2095582490);
	}

	@OriginalMember(owner = "client!ia", name = "n", descriptor = "(Ljava/lang/Object;ZI)[B", line = 25)
	public static byte[] method27386(@OriginalArg(0) Object arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2) {
		if (arg0 == null) {
			return null;
		} else if (arg0 instanceof byte[]) {
			@Pc(11) byte[] local11 = (byte[]) (byte[]) arg0;
