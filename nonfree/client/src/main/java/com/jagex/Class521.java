...
public final class Class521 {
	...
	public Object method30346(@OriginalArg(0) Object arg0) {
		synchronized (this) {
			...
			if (local19 == null) {
				...
				this.method30354(local19, false);
	...
	public Object method30347(@OriginalArg(0) Object arg0, @OriginalArg(1) Object arg1) {
		synchronized (this) {
			if (this.aLong285 * -8222533772526471457L != -1L) {
				this.method30349();
			}
			...
			if (this.method30345() && this.aMap24.size() == this.anInt5221 * 176969143) {
	...
	void method30353(@OriginalArg(0) Class503 arg0, @OriginalArg(1) boolean arg1) {
		if (!arg1) {
			...
			if (this.method30345() && !this.anAbstractQueue_Sub1_3.remove(arg0)) {
	...
	void method30354(@OriginalArg(0) Class503 arg0, @OriginalArg(1) boolean arg1) {
		if (!arg1) {
			this.anAbstractQueue_Sub1_2.remove(arg0);
			if (this.method30345() && !this.anAbstractQueue_Sub1_3.remove(arg0)) {
				throw new IllegalStateException("");
	...
	static final void method30357(@OriginalArg(0) Class681 arg0) {
