...
public final class Class521 {
	...
	boolean method30345(@OriginalArg(0) byte arg0) {
	...
	public Object method30346(@OriginalArg(0) Object arg0, @OriginalArg(1) int arg1) {
		synchronized (this) {
			if (this.aLong285 * -8222533772526471457L != -1L) {
				this.method30349(-1643552988);
			}
			@Pc(19) Class503 local19 = (Class503) this.aMap24.get(arg0);
			if (local19 == null) {
				return null;
			} else {
				this.method30354(local19, false, 336274797);
	...
	public Object method30347(@OriginalArg(0) Object arg0, @OriginalArg(1) Object arg1, @OriginalArg(2) int arg2) {
		synchronized (this) {
			if (this.aLong285 * -8222533772526471457L != -1L) {
				this.method30349(124565619);
			}
			@Pc(19) Class503 local19 = (Class503) this.aMap24.get(arg0);
			if (local19 != null) {
			...
			if (this.method30345((byte) 40) && this.aMap24.size() == this.anInt5221 * 176969143) {
			...
			this.method30354(local54, true, 336274797);
			return null;
		}
	}
	...
	void method30349(@OriginalArg(0) int arg0) {
		if (this.aLong285 * -8222533772526471457L == -1L) {
			throw new IllegalStateException("");
		}
		@Pc(18) long local18 = System.currentTimeMillis() - this.aLong285 * -8222533772526471457L;
	...
	public Object method30350(@OriginalArg(0) Object arg0) {
		synchronized (this) {
			if (this.aLong285 * -8222533772526471457L != -1L) {
				this.method30349(-1757210109);
			}
			@Pc(19) Class503 local19 = (Class503) this.aMap24.get(arg0);
			if (local19 == null) {
				return null;
	...
	public Object method30351(@OriginalArg(0) Object arg0) {
		synchronized (this) {
			if (this.aLong285 * -8222533772526471457L != -1L) {
				this.method30349(-541816986);
			}
			@Pc(19) Class503 local19 = (Class503) this.aMap24.get(arg0);
			if (local19 == null) {
				return null;
	...
	public Object method30352(@OriginalArg(0) Object arg0, @OriginalArg(1) Object arg1) {
		synchronized (this) {
			if (this.aLong285 * -8222533772526471457L != -1L) {
				this.method30349(886123381);
			}
			@Pc(19) Class503 local19 = (Class503) this.aMap24.get(arg0);
			if (local19 != null) {
				@Pc(25) Object local25 = local19.anObject21;
	...
	void method30353(@OriginalArg(0) Class503 arg0, @OriginalArg(1) boolean arg1) {
		if (!arg1) {
			this.anAbstractQueue_Sub1_2.remove(arg0);
			if (this.method30345((byte) 40) && !this.anAbstractQueue_Sub1_3.remove(arg0)) {
				throw new IllegalStateException("");
			}
		}
	...
	void method30354(@OriginalArg(0) Class503 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2) {
		if (!arg1) {
			this.anAbstractQueue_Sub1_2.remove(arg0);
			if (this.method30345((byte) 40) && !this.anAbstractQueue_Sub1_3.remove(arg0)) {
				throw new IllegalStateException("");
