...
public abstract class Class156 {
	...
	void method14188(@OriginalArg(0) int arg0) {
		...
		synchronized (this.aClass240_23) {
			this.aClass240_23.method25832(arg0, (byte) -8);
		}
	}

	@OriginalMember(owner = "client!uy", name = "e", descriptor = "(I)V", line = 98)
	void method14189(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_23;
		synchronized (this.aClass240_23) {
			this.aClass240_23.method25833((byte) -117);
		}
	}
	...
	void method14190() {
		@Pc(3) Class240 local3 = this.aClass240_23;
		synchronized (this.aClass240_23) {
			this.aClass240_23.method25833((byte) -108);
		}
	}
	...
	void method14191(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_23;
		synchronized (this.aClass240_23) {
			this.aClass240_23.method25837(1161602830);
		}
	}
	...
	void method14192() {
		@Pc(3) Class240 local3 = this.aClass240_23;
		synchronized (this.aClass240_23) {
			this.aClass240_23.method25833((byte) -105);
		}
	}
	...
	void method14193(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_23;
		synchronized (this.aClass240_23) {
			this.aClass240_23.method25832(arg0, (byte) -41);
		}
	}
	...
	void method14194(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_23;
		synchronized (this.aClass240_23) {
			this.aClass240_23.method25832(arg0, (byte) -39);
		}
	}
	...
	void method14195(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class240 local3 = this.aClass240_23;
		synchronized (this.aClass240_23) {
			this.aClass240_23.method25832(arg0, (byte) -52);
		}
	}

	@OriginalMember(owner = "client!uy", name = "hz", descriptor = "(Lclient!yf;I)V", line = 6450)
	static final void method14196(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		@Pc(32) boolean local32 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091] == 1;
		Class453.method28965(local11, local14, arg0, local32 ? Class310.aClass310_4 : Class310.aClass310_3, (byte) -65);
	}
	...
	public static final void method14198(@OriginalArg(0) int arg0) {
		@Pc(7) String local7 = Class712.aString243 == null ? Class508.method30234(-1465158934) : Class712.aString243;
		Class338.method27468(local7, false, client.aBoolean596, (byte) -51);
	}
}
