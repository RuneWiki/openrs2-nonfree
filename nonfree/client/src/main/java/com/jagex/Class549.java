...
public class Class549 {
	...
	static byte[] method31022(@OriginalArg(0) InputStream arg0, @OriginalArg(1) int arg1) throws IOException {
		...
		synchronized (aClass565_1) {
			if (!aClass565_1.method31238(local2)) {
	...
	public static boolean method31025(@OriginalArg(0) int arg0) {
	...
	static char method31027(@OriginalArg(0) char arg0) {
		switch(arg0) {
			case ' ':
			case '-':
			case '_':
	...
	static final void method31023(@OriginalArg(0) Class681 arg0) {
		...
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class500.method30166(local13);
	}

	@OriginalMember(owner = "client!sg", name = "ane", descriptor = "(Lclient!yf;I)V", line = 12178)
	static final void method31024(@OriginalArg(0) Class681 arg0) {
		Class164.method15286();
	}

	@OriginalMember(owner = "client!sg", name = "bfx", descriptor = "(Lclient!yf;I)V", line = 15141)
	static final void method31026(@OriginalArg(0) Class681 arg0) {
