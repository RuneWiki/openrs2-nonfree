...
public abstract class Class119 implements Interface4 {
	...
	void method8589(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.anInt996 = arg0 * -1239030717;
		@Pc(8) Class240 local8 = this.aClass240_18;
		synchronized (this.aClass240_18) {
			this.aClass240_18.method25833((byte) -60);
		}
		local8 = this.aClass240_17;
		synchronized (this.aClass240_17) {
			this.aClass240_17.method25833((byte) -37);
		}
	}

	@OriginalMember(owner = "client!ih", name = "p", descriptor = "(I)V", line = 721)
	void method8590(@OriginalArg(0) int arg0) {
		this.anInt996 = arg0 * -1239030717;
		@Pc(8) Class240 local8 = this.aClass240_18;
		synchronized (this.aClass240_18) {
			this.aClass240_18.method25833((byte) -1);
		}
		local8 = this.aClass240_17;
		synchronized (this.aClass240_17) {
			this.aClass240_17.method25833((byte) -12);
		}
	}
	...
	void method8591(@OriginalArg(0) byte arg0) {
		@Pc(3) Class240 local3 = this.aClass240_18;
		synchronized (this.aClass240_18) {
			this.aClass240_18.method25833((byte) -125);
		}
		local3 = this.aClass240_17;
		synchronized (this.aClass240_17) {
			this.aClass240_17.method25833((byte) -88);
		}
	}

	@OriginalMember(owner = "client!ih", name = "k", descriptor = "(II)V", line = 740)
	void method8592(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class240 local3 = this.aClass240_18;
		synchronized (this.aClass240_18) {
			this.aClass240_18.method25832(arg0, (byte) -13);
		}
		local3 = this.aClass240_17;
		synchronized (this.aClass240_17) {
			this.aClass240_17.method25832(arg0, (byte) 25);
		}
	}

	@OriginalMember(owner = "client!ih", name = "e", descriptor = "(ZI)V", line = 715)
	void method8593(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
	...
	void method8595(@OriginalArg(0) boolean arg0) {
		if (arg0 != this.aBoolean178) {
			this.aBoolean178 = arg0;
	...
	void method8596(@OriginalArg(0) boolean arg0) {
		if (arg0 != this.aBoolean178) {
			this.aBoolean178 = arg0;
	...
	void method8597(@OriginalArg(0) int arg0) {
		...
		@Pc(8) Class240 local8 = this.aClass240_18;
		synchronized (this.aClass240_18) {
			this.aClass240_18.method25833((byte) -76);
		}
		local8 = this.aClass240_17;
		synchronized (this.aClass240_17) {
			this.aClass240_17.method25833((byte) -25);
		}
	}
	...
	void method8598(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_18;
		synchronized (this.aClass240_18) {
			this.aClass240_18.method25837(1161602830);
		}
		local3 = this.aClass240_17;
		synchronized (this.aClass240_17) {
			this.aClass240_17.method25837(1161602830);
		}
	}

	@OriginalMember(owner = "client!ih", name = "d", descriptor = "(I)V", line = 721)
	void method8599(@OriginalArg(0) int arg0) {
		this.anInt996 = arg0 * -1239030717;
		@Pc(8) Class240 local8 = this.aClass240_18;
		synchronized (this.aClass240_18) {
			this.aClass240_18.method25833((byte) -124);
		}
		local8 = this.aClass240_17;
		synchronized (this.aClass240_17) {
			this.aClass240_17.method25833((byte) -38);
		}
	}

	@OriginalMember(owner = "client!ih", name = "c", descriptor = "(I)V", line = 740)
	void method8600(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_18;
		synchronized (this.aClass240_18) {
			this.aClass240_18.method25832(arg0, (byte) -28);
		}
		local3 = this.aClass240_17;
		synchronized (this.aClass240_17) {
			this.aClass240_17.method25832(arg0, (byte) -80);
		}
	}
