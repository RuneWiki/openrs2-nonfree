...
public class Class129_Sub1 extends Class129 {
	...
	@Override
	void method21471(@OriginalArg(0) Graphics arg0, @OriginalArg(1) byte arg1) {
		@Pc(6) String local6;
		if (this.aBoolean185) {
		...
		arg0.drawString(local6, this.this$0.method27886(this.aFontMetrics1.stringWidth(local6), -92858805) + this.anInt2994 * -228338075, this.this$0.method27882(0, 1676822063) + this.anInt2995 * 1110069385);
	}
	...
	void method21474(@OriginalArg(0) Graphics arg0) {
		...
		arg0.setFont(this.aFont2);
		arg0.setColor(this.aColor1);
		arg0.drawString(local6, this.this$0.method27886(this.aFontMetrics1.stringWidth(local6), -1381621623) + this.anInt2994 * -228338075, this.this$0.method27882(0, 1676822063) + this.anInt2995 * 1110069385);
	}
	...
	void method21472(@OriginalArg(0) Graphics arg0) {
		...
		arg0.setFont(this.aFont2);
		arg0.setColor(this.aColor1);
		arg0.drawString(local6, this.this$0.method27886(this.aFontMetrics1.stringWidth(local6), -951158467) + this.anInt2994 * -228338075, this.this$0.method27882(0, 1676822063) + this.anInt2995 * 1110069385);
	}
	...
	void method21470(@OriginalArg(0) Graphics arg0) {
		...
		arg0.setFont(this.aFont2);
		arg0.setColor(this.aColor1);
		arg0.drawString(local6, this.this$0.method27886(this.aFontMetrics1.stringWidth(local6), -1272788882) + this.anInt2994 * -228338075, this.this$0.method27882(0, 1676822063) + this.anInt2995 * 1110069385);
	}
	...
	void method21475(@OriginalArg(0) Graphics arg0) {
		...
		arg0.setFont(this.aFont2);
		arg0.setColor(this.aColor1);
		arg0.drawString(local6, this.this$0.method27886(this.aFontMetrics1.stringWidth(local6), -1891925021) + this.anInt2994 * -228338075, this.this$0.method27882(0, 1676822063) + this.anInt2995 * 1110069385);
	}
	...
	void method21473(@OriginalArg(0) Graphics arg0) {
		...
		arg0.setFont(this.aFont2);
		arg0.setColor(this.aColor1);
		arg0.drawString(local6, this.this$0.method27886(this.aFontMetrics1.stringWidth(local6), -826355461) + this.anInt2994 * -228338075, this.this$0.method27882(0, 1676822063) + this.anInt2995 * 1110069385);
	}

	@OriginalMember(owner = "client!ahj", name = "hp", descriptor = "(I)V", line = 4831)
	static final void method9403(@OriginalArg(0) int arg0) {
		@Pc(3) byte[][][] local3 = client.aClass532_1.method30458((byte) 1);
		@Pc(12) byte local12 = (byte) (client.anInt3495 * 1815175593 - 4 & 0xFF);
		@Pc(20) int local20 = client.anInt3495 * 1815175593 % client.aClass532_1.method30444(-274794987);
		@Pc(22) int local22;
		for (local22 = 0; local22 < 4; local22++) {
			for (@Pc(27) int local27 = 0; local27 < client.aClass532_1.method30474((short) 128); local27++) {
		...
		@Pc(85) Class520 local85 = client.aClass532_1.method30509(1067802396);
		@Pc(89) Class585 local89 = client.aClass532_1.method30459(-1099623889);
		@Pc(135) int local135;
		if (Class429.anInt4781 * -1453926679 != 2 && Class429.anInt4781 * -1453926679 != 3 && Class175.anInt3306 * -364465283 == -1) {
			local135 = Class305.method26801(Class163.anInt2002 * -1331168249, Class270.anInt3884 * 466086187, Class512.anInt5209 * 1177442423, (byte) -125);
		...
		@Pc(108) Class611 local108 = client.aClass532_1.method30443(1743971959);
		@Pc(146) int local146;
		if (Class429.anInt4781 * -1453926679 == 3) {
			@Pc(119) Class472 local119 = Class65.aClass123_Sub1_2.method9040(151249317).method23122(1189701933);
		...
		@Pc(254) int local254;
		if (Class429.anInt4781 * -1453926679 == 3) {
			@Pc(243) Class472 local243 = Class65.aClass123_Sub1_2.method8952((byte) -96).method21402((byte) 121);
		...
		@Pc(327) int local327;
		if (local85.method30327(local254, local265, 2018688317)) {
			local327 = Class305.method26801(Class163.anInt2002 * -1331168249, Class270.anInt3884 * 466086187, 3, (byte) -34);
		...
		if (local327 == 0 && local366 == 0 || local327 <= -client.aClass532_1.method30444(-2114499121) || local327 >= client.aClass532_1.method30444(-1164889554) || local366 <= -client.aClass532_1.method30474((short) 128) || local366 >= client.aClass532_1.method30474((short) 128)) {
			if (Class429.anInt4781 * -1453926679 != 3) {
				Class646.method32610(local254 + Class430.aString204 + local265 + " " + local307 + Class430.aString204 + local311 + " " + local108.anInt5623 * 270611681 + Class430.aString204 + local108.anInt5624 * -1994307635, new RuntimeException(), 920682847);
			}
			return;
		}
		@Pc(449) int local449;
	...
	static final void method9404(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method9405(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		if (arg0 == 28) {
			...
			try {
				if (arg0 == 29) {
					...
					@Pc(43) Class598 local43 = client.aClass532_1.method30459(-1150496302).aClass598_2;
					...
					if (arg0 == 5) {
						...
						Class510.method30248((byte) 24);
						Class684.method33423((byte) -14);
						...
						client.aClass532_1.aLong286 = Class305.method26796(1446244823) * -3941212876594184505L;
						...
						if (arg0 == 19) {
							...
							local254 = Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.method24229().aClass472_61;
							Class314.method26939("" + client.aClass532_1.method30459(-1760172918).aClass99Array1[Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aByte100].method2482((int) local254.aFloat317 >> 9, (int) local254.aFloat319 >> 9, -1873977538), -2098111029);
						} else if (arg0 == 27) {
							Class314.method26939(Class312.aClass240_74.method25835((byte) 112) + " " + Class312.aClass240_74.method25834(2001532068), -1863985851);
							Class314.method26939(Class312.aClass240_77.method25835((byte) 110) + " " + Class312.aClass240_77.method25834(1696400475), -1906909831);
						} else if (arg0 == 8) {
