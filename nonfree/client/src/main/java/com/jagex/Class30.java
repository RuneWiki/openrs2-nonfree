...
public class Class30 implements Interface13, Interface5 {
	...
	void method617(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 3) {
			...
			for (@Pc(22) int local22 = arg0.method22413((short) 16384); local22 != 255; local22 = arg0.method22413((short) 16384)) {
				...
				for (@Pc(34) int local34 = 0; local34 < local29; local34++) {
					local32[local34] = (Class519) Class107.method18119(Class519.method30312(1543250623), arg0.method22632((byte) -33), -1915563430);
				}
				this.anObjectArrayArray1[local22] = Class166_Sub38.method16326(arg0, local32, -932100834);
				this.aClass519ArrayArray1[local22] = local32;
			}
		} else if (arg1 == 4) {
			this.anInt105 = arg0.method22596((short) 6058) * 586759731;
		}
	}
	...
	void method618(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 3) {
			...
			for (@Pc(22) int local22 = arg0.method22413((short) 16384); local22 != 255; local22 = arg0.method22413((short) 16384)) {
				...
				@Pc(32) Class519[] local32 = new Class519[local29];
				for (@Pc(34) int local34 = 0; local34 < local29; local34++) {
					local32[local34] = (Class519) Class107.method18119(Class519.method30312(1860785111), arg0.method22632((byte) -58), -1915563430);
				}
				this.anObjectArrayArray1[local22] = Class166_Sub38.method16326(arg0, local32, -486098583);
				this.aClass519ArrayArray1[local22] = local32;
			}
		} else if (arg1 == 4) {
			this.anInt105 = arg0.method22596((short) -6368) * 586759731;
		}
	}
	...
	void method619(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg1 == 3) {
			...
			for (@Pc(22) int local22 = arg0.method22413((short) 16384); local22 != 255; local22 = arg0.method22413((short) 16384)) {
				...
				@Pc(32) Class519[] local32 = new Class519[local29];
				for (@Pc(34) int local34 = 0; local34 < local29; local34++) {
					local32[local34] = (Class519) Class107.method18119(Class519.method30312(1688759182), arg0.method22632((byte) -119), -1915563430);
				}
				this.anObjectArrayArray1[local22] = Class166_Sub38.method16326(arg0, local32, -1452468992);
				this.aClass519ArrayArray1[local22] = local32;
			}
		} else if (arg1 == 4) {
			this.anInt105 = arg0.method22596((short) -9339) * 586759731;
		}
	}
	...
	void method623(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 3) {
			...
			for (@Pc(22) int local22 = arg0.method22413((short) 16384); local22 != 255; local22 = arg0.method22413((short) 16384)) {
				...
				@Pc(32) Class519[] local32 = new Class519[local29];
				for (@Pc(34) int local34 = 0; local34 < local29; local34++) {
					local32[local34] = (Class519) Class107.method18119(Class519.method30312(1865591604), arg0.method22632((byte) -41), -1915563430);
				}
				this.anObjectArrayArray1[local22] = Class166_Sub38.method16326(arg0, local32, -1802627876);
				this.aClass519ArrayArray1[local22] = local32;
			}
		} else if (arg1 == 4) {
			this.anInt105 = arg0.method22596((short) -8336) * 586759731;
		}
	}
	...
	void method624(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 3) {
			...
			for (@Pc(22) int local22 = arg0.method22413((short) 16384); local22 != 255; local22 = arg0.method22413((short) 16384)) {
				...
				@Pc(32) Class519[] local32 = new Class519[local29];
				for (@Pc(34) int local34 = 0; local34 < local29; local34++) {
					local32[local34] = (Class519) Class107.method18119(Class519.method30312(1507909282), arg0.method22632((byte) -83), -1915563430);
				}
				this.anObjectArrayArray1[local22] = Class166_Sub38.method16326(arg0, local32, -1626946471);
				this.aClass519ArrayArray1[local22] = local32;
			}
		} else if (arg1 == 4) {
			this.anInt105 = arg0.method22596((short) -6125) * 586759731;
		}
	}
	...
	void method625(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 3) {
			...
			for (@Pc(22) int local22 = arg0.method22413((short) 16384); local22 != 255; local22 = arg0.method22413((short) 16384)) {
				...
				@Pc(32) Class519[] local32 = new Class519[local29];
				for (@Pc(34) int local34 = 0; local34 < local29; local34++) {
					local32[local34] = (Class519) Class107.method18119(Class519.method30312(1698160951), arg0.method22632((byte) -19), -1915563430);
				}
				this.anObjectArrayArray1[local22] = Class166_Sub38.method16326(arg0, local32, 712117700);
				this.aClass519ArrayArray1[local22] = local32;
			}
		} else if (arg1 == 4) {
			this.anInt105 = arg0.method22596((short) 1719) * 586759731;
		}
	}

	@OriginalMember(owner = "client!abc", name = "go", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;I)V", line = 6056)
	static final void method626(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		arg0.method26872(local13, local24, local35, -645249360);
		Class354.method27696(arg0, -1174743804);
		if (arg0.anInt3970 * 532402067 == -1 && !arg1.aBoolean708) {
			Class41.method817(arg0.anInt3953 * -1549590237, local13, 1469693779);
		}
	}
