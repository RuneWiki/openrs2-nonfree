...
public class Class100_Sub3_Sub2 extends Class100_Sub3 {
	...
	void method17976(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(3) int local3 = arg6 - arg2;
		for (@Pc(5) int local5 = 0; local5 < arg3; local5++) {
			@Pc(16) int local16 = (arg1 + local5) * arg2 + arg0;
			for (@Pc(18) int local18 = 0; local18 < arg2; local18++) {
			...
			if (anInt2570 == 0) {
				...
				while (local12 < 0) {
					...
					if (local18 >= 0 && local20 >= 0 && local18 - (this.anInt2553 << 12) < 0 && local20 - (this.anInt2568 << 12) < 0) {
						while (local22 < 0) {
							this.method17974((local20 >> 12) * this.anInt2553 + (local18 >> 12), local16++, local3, arg0, arg1);
							local22++;
						}
					}
					local12++;
	...
	void method17974(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(20) int local20;
		@Pc(28) int local28;
		@Pc(36) int local36;
		@Pc(44) int local44;
