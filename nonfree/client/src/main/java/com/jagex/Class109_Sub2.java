...
public class Class109_Sub2 extends Class109 {
	...
	Class109_Sub2(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) Class231 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		for (@Pc(120) int local120 = 0; local120 < arg1.anInt3743; local120++) {
			if (arg1.aByteArray72 == null || arg1.aByteArray72[local120] != 2) {
				if (arg1.aShortArray90 != null && arg1.aShortArray90[local120] != -1) {
					@Pc(153) Class235 local153 = local104.method25597(arg1.aShortArray90[local120] & 0xFFFF);
		...
		for (@Pc(229) int local229 = 0; local229 < this.anInt792; local229++) {
			...
			if (arg1.aClass227Array1 != null) {
				...
				for (local254 = 0; local254 < arg1.aClass227Array1.length; local254++) {
					...
					if (local237 == local264.anInt3648 * 1084874511) {
						@Pc(278) Class442 local278 = local107.method28945(local264.anInt3647 * 422903595);
						if (local278.aBoolean769) {
							local252 = true;
						}
						if (local278.anInt4892 * -153468217 != -1) {
							@Pc(297) Class235 local297 = local104.method25597(local278.anInt4892 * -153468217);
			...
			if (arg1.aClass234Array4 != null) {
				...
				for (local254 = 0; local254 < arg1.aClass234Array4.length; local254++) {
					...
					if (local237 == local336.anInt3755 * 171091685) {
						@Pc(352) Class439 local352 = this.aClass104_Sub1_26.anInterface46_6.method28821(local336.anInt3767 * -343583539);
			...
			if (arg1.aShortArray90 != null) {
				...
				if (local374 != -1) {
					local239 = local104.method25597(local374 & 0xFFFF);
		...
		Class121.method8707(local218, local111);
		...
		if (arg1.aClass227Array1 != null) {
			...
			for (local237 = 0; local237 < this.anInt789; local237++) {
				...
				@Pc(607) Class442 local607 = local107.method28945(local599.anInt3647 * 422903595);
				local486 = -1;
		...
		for (local611 = 0; local611 < this.anInt792; local611++) {
			...
			if (local1195 != -1 && (this.anInt783 & 0x40) != 0 && local104.method25597(local1195).aBoolean656) {
				local1195 = -1;
			}
	...
	Class109 method6585(@OriginalArg(0) Class109_Sub2 arg0, @OriginalArg(1) Class109_Sub2 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		arg0.aByte4 = 0;
		arg0.anInt782 = arg2;
	...
	Class109 method6616(@OriginalArg(0) Class109_Sub2 arg0, @OriginalArg(1) Class109_Sub2 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		arg0.aByte4 = 0;
		arg0.anInt782 = arg2;
		arg0.anInt783 = this.anInt783;
		arg0.aShort57 = this.aShort57;
	...
	public void method6834(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class99 arg2, @OriginalArg(3) Class99 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (arg0 == 1) {
			for (local195 = 0; local195 < this.anInt785; local195++) {
				this.anIntArray62[local195] = this.anIntArray62[local195] + arg2.method2481(this.anIntArray61[local195] + arg4, this.anIntArray60[local195] + arg6) - arg5;
			}
		} else {
			@Pc(239) int local239;
			@Pc(252) int local252;
			if (arg0 == 2) {
				...
				for (local239 = 0; local239 < this.anInt785; local239++) {
					...
					if (local252 < arg1) {
						this.anIntArray62[local239] += (arg2.method2481(this.anIntArray61[local239] + arg4, this.anIntArray60[local239] + arg6) - arg5) * (arg1 - local252) / arg1;
					}
				}
			} else {
				@Pc(323) int local323;
				if (arg0 == 3) {
					...
					for (local239 = 0; local239 < this.anInt785; local239++) {
						this.anIntArray62[local239] = this.anIntArray62[local239] + (arg3.method2481(this.anIntArray61[local239] + arg4, this.anIntArray60[local239] + arg6) - arg5) + local195;
					}
				} else if (arg0 == 5) {
					local195 = this.aShort63 - this.aShort60;
					for (local239 = 0; local239 < this.anInt785; local239++) {
								...
								if (local145 == local15[local182] && local159 == local21[local182] && local131 == local18[local182]) {
									...
									if (local234 != -1) {
										if (local40 == null) {
											...
											local40 = this.aClass217_1.aShortArray87 = Class702.method36722(this.aShortArray24);
											local44 = this.aClass217_1.aShortArray86 = Class702.method36722(this.aShortArray25);
											local48 = this.aClass217_1.aShortArray85 = Class702.method36722(this.aShortArray17);
											local52 = this.aClass217_1.aByteArray67 = Class335.method27408(this.aByteArray22);
										}
										if (local68 == null) {
											@Pc(325) Class217 local325 = local2.aClass217_1 = new Class217();
											local68 = local325.aShortArray87 = Class702.method36722(local24);
											local72 = local325.aShortArray86 = Class702.method36722(local27);
											local76 = local325.aShortArray85 = Class702.method36722(local30);
											local80 = local325.aByteArray67 = Class335.method27408(local33);
										}
	...
	public boolean method6976() {
		...
		for (@Pc(6) int local6 = 0; local6 < this.aShortArray26.length; local6++) {
			if (this.aShortArray26[local6] != -1) {
				@Pc(29) Class235 local29 = this.aClass104_Sub1_26.aClass225_6.method25597(this.aShortArray26[local6] & 0xFFFF);
	...
	void method6591(@OriginalArg(0) boolean arg0) {
		...
		if (this.aClass104_Sub1_26.aBoolean106) {
			for (local37 = 0; local37 < this.anInt787; local37++) {
				local31.method22454(this.aShortArray21[local37]);
				local31.method22454(this.aShortArray20[local37]);
				local31.method22454(this.aShortArray18[local37]);
			}
		} else {
			for (local37 = 0; local37 < this.anInt787; local37++) {
				local31.method22393(this.aShortArray21[local37]);
				local31.method22393(this.aShortArray20[local37]);
				local31.method22393(this.aShortArray18[local37]);
			}
		}
		...
		if (arg0) {
			if (this.anInterface16_2 == null) {
				...
				this.anInterface16_2.method2561(local31.aByteArray58, local31.anInt3070 * 212851357);
			}
			...
			if (this.aClass104_Sub1_26.aBoolean106) {
				for (local178 = 0; local178 < this.anInt785; local178++) {
					...
					for (local217 = local208; local217 < local215 && this.aShortArray23[local217] != 0; local217++) {
						...
						local170.method22395(local189);
						local170.method22395(local196);
						local170.method22395(local203);
					}
				}
			} else {
				for (local178 = 0; local178 < this.anInt785; local178++) {
					...
					for (local217 = local208; local217 < local215 && this.aShortArray23[local217] != 0; local217++) {
						local235 = (this.aShortArray23[local217] & 0xFFFF) - 1;
						local170.anInt3070 = local235 * local91 * -1445626955;
						local170.method22396(local189);
						local170.method22396(local196);
						local170.method22396(local203);
					}
				}
			}
		}
		...
		if (local10) {
			if (this.aClass193_10 == null) {
				...
				for (@Pc(422) int local422 = 0; local422 < this.anInt792; local422++) {
					...
					local170.method22510(local555);
					local170.method22510(local570);
					local170.method22510(local585);
					local170.method22510(255 - (this.aByteArray21[local422] & 0xFF));
	...
	int method6586(@OriginalArg(0) int arg0, @OriginalArg(1) short arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		...
		if (arg1 != -1) {
			@Pc(17) Class235 local17 = this.aClass104_Sub1_26.aClass225_6.method25597(arg1 & 0xFFFF);
