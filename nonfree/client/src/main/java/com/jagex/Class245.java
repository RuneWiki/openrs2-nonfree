...
class Class245 implements Runnable {
				...
				if (!this.this$0.aBoolean258) {
					...
					while (true) {
						...
						for (@Pc(32) int local32 = 0; local32 < local30.length; local32++) {
							local30[local32].method30655((byte) -117);
						}
					}
				}
			} catch (@Pc(49) Exception local49) {
				Class646.method32610((String) null, local49, 1512059078);
			}
			return;
		}
	}
			...
			try {
				if (!this.this$0.aBoolean258) {
					...
					while (true) {
						...
						@Pc(30) Class535[] local30 = (Class535[]) (Class535[]) local9.get(local20);
						for (@Pc(32) int local32 = 0; local32 < local30.length; local32++) {
							local30[local32].method30655((byte) -114);
						}
					}
				}
			} catch (@Pc(49) Exception local49) {
				Class646.method32610((String) null, local49, 2062066211);
			}
			return;
		}
	}
			...
			try {
				if (!this.this$0.aBoolean258) {
					...
					while (true) {
						...
						@Pc(30) Class535[] local30 = (Class535[]) (Class535[]) local9.get(local20);
						for (@Pc(32) int local32 = 0; local32 < local30.length; local32++) {
							local30[local32].method30655((byte) -19);
						}
					}
				}
			} catch (@Pc(49) Exception local49) {
				Class646.method32610((String) null, local49, 415488374);
			}
			return;
		}
	}
			...
			try {
				if (!this.this$0.aBoolean258) {
					...
					while (true) {
						...
						@Pc(30) Class535[] local30 = (Class535[]) (Class535[]) local9.get(local20);
						for (@Pc(32) int local32 = 0; local32 < local30.length; local32++) {
							local30[local32].method30655((byte) -119);
						}
					}
				}
			} catch (@Pc(49) Exception local49) {
				Class646.method32610((String) null, local49, 457435595);
			}
			return;
		}
	}
			...
			try {
				if (!this.this$0.aBoolean258) {
					...
					while (true) {
						...
						@Pc(30) Class535[] local30 = (Class535[]) (Class535[]) local9.get(local20);
						for (@Pc(32) int local32 = 0; local32 < local30.length; local32++) {
							local30[local32].method30655((byte) -46);
						}
					}
				}
			} catch (@Pc(49) Exception local49) {
				Class646.method32610((String) null, local49, 1148923478);
			}
			return;
		}
	}
	...
	static final void method25899(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static void method25900(@OriginalArg(0) byte arg0) {
