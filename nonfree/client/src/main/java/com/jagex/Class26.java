...
public class Class26 implements Interface13, Interface5 {
	...
	void method572(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		if (arg1 == 1) {
			this.anInt88 = arg0.method22417((short) 5787) * 1304772293;
			this.method573(this.anInt88 * -1647734771, 693908015);
		} else if (arg1 == 2) {
			this.anInt84 = arg0.method22415(-1434290800) * -1078353519;
			if (this.anInt84 * -990036111 == 65535) {
				this.anInt84 = 1078353519;
			}
		} else if (arg1 == 3) {
			this.anInt85 = (arg0.method22415(-1434290800) << 2) * -2018615685;
		} else if (arg1 == 4) {
	...
	void method577(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt88 = arg0.method22417((short) -8546) * 1304772293;
			this.method573(this.anInt88 * -1647734771, 693908015);
		} else if (arg1 == 2) {
			this.anInt84 = arg0.method22415(-1434290800) * -1078353519;
			if (this.anInt84 * -990036111 == 65535) {
	...
	static boolean method579(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		arg0.method20501();
		Class305.method26796(825107433);
		if (!arg0.method20514(2114416749)) {
			return false;
		}
		@Pc(14) int local14 = client.aClass532_1.method30444(514819425);
		@Pc(18) int local18 = client.aClass532_1.method30474((short) 128);
		@Pc(22) Class520 local22 = client.aClass532_1.method30509(-706123304);
		@Pc(26) Class585 local26 = client.aClass532_1.method30459(-1444248603);
		...
		for (local78 = local72; local78 < local14 + local72; local78++) {
			for (@Pc(85) int local85 = local74; local85 < local18 + local74; local85++) {
				for (local92 = local28; local92 <= 3; local92++) {
					if (local92 < arg1 || local22.method30329(arg1, local92, local78, local85, (byte) -54)) {
		...
		if (Class172.aBoolean519) {
			Class172.aClass100_40 = arg0.method20496(local78, local78, false, true);
			local162 = arg0.method20444();
			local162.method23434(0, Class172.aClass100_40.method18167());
			...
			Class172.aClass100_40 = arg0.method20498(local148, 0, local78, local78, local78, 438797212);
		}
		client.aClass532_1.method30532((byte) 33).method32967(730324292);
		...
		for (@Pc(304) int local304 = local72; local304 < local14 + local72; local304 += local70) {
			for (@Pc(311) int local311 = local74; local311 < local18 + local74; local311 += local70) {
				...
				for (@Pc(384) int local384 = local28; local384 <= 3; local384++) {
					...
					for (local389 = 0; local389 <= local373; local389++) {
						for (local394 = 0; local394 <= local373; local394++) {
							local297[local389][local394] = local384 < arg1 || local22.method30329(arg1, local384, local389 + local322, local328 + local394, (byte) -108);
						}
					}
					...
					for (local389 = -4; local389 < local70; local389++) {
						for (local394 = -4; local394 < local70; local394++) {
							...
							if (local451 >= local72 && local455 >= local74 && (local384 < arg1 || local22.method30329(arg1, local384, local451, local455, (byte) -76))) {
								@Pc(474) int local474 = local384;
								if (local22.method30330(local451, local455, -662808309)) {
									local474 = local384 - 1;
								}
								if (local474 >= 0) {
									Class352.method27665(arg0, local474, local451, local455, local389 * 4 + local318, (local70 - local394) * 4 + local320 - 4, local253, local266, -1566612262);
								}
							}
						}
					}
				...
				arg0.method20501();
				if (!Class172.aBoolean519) {
					Class172.aClass100_40.method18170((local304 - local72) * 4 + 48, local18 * 4 + 48 - (local311 - local74) * 4 - local70 * 4, local70 * 4, local70 * 4, local318, local320);
					if (Class172.aBoolean520) {
						Class172.aClass100_40.method18169(256, 0);
						try {
							arg0.method20414(-1733131800);
		...
		if (!Class172.aBoolean522) {
			Class110_Sub15.method20151(arg1, 1757293797);
			@Pc(637) Class584 local637 = client.aClass532_1.method30587(-304373563);
			if (local637 != null) {
				Class542.aClass32_Sub2_3.method16652(1024, 64, -1613328696);
				@Pc(649) Class611 local649 = client.aClass532_1.method30443(1819027207);
