...
public class Class26 implements Interface13, Interface5 {
	...
	void method572(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt88 = arg0.method22417() * 1304772293;
			this.method573(this.anInt88 * -1647734771);
		} else if (arg1 == 2) {
			this.anInt84 = arg0.method22415() * -1078353519;
			if (this.anInt84 * -990036111 == 65535) {
				this.anInt84 = 1078353519;
			}
		} else if (arg1 == 3) {
			this.anInt85 = (arg0.method22415() << 2) * -2018615685;
		} else if (arg1 == 4) {
	...
	void method573(@OriginalArg(0) int arg0) {
	...
	static boolean method579(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		arg0.method20501();
		...
		if (Class172.aBoolean519) {
			...
			Class172.aClass100_40 = arg0.method20498(local148, 0, local78, local78, local78);
		}
		...
		Class172.aClass22_43.method406();
				...
				for (local318 = 0; local318 < local637.anInt5436 * 1285867561; local318++) {
					...
					if (local320 >> 28 == Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aByte100) {
						...
						if (local322 >= 0 && local322 < local14 && local328 >= 0 && local328 < local18) {
							Class172.aClass22_43.method407(new Class93_Sub14(local318));
						} else {
