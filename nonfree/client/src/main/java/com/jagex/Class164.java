...
public abstract class Class164 implements Interface4 {
	...
	void method15270() {
		...
		synchronized (this.aClass240_39) {
			this.aClass240_39.method25837(1161602830);
		}
	}
	...
	void method15271(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		@Pc(3) Class240 local3 = this.aClass240_39;
		synchronized (this.aClass240_39) {
			this.aClass240_39.method25832(arg0, (byte) -23);
		}
	}
	...
	void method15273(@OriginalArg(0) int arg0) {
		...
		@Pc(8) Class240 local8 = this.aClass240_39;
		synchronized (this.aClass240_39) {
			this.aClass240_39.method25833((byte) -77);
		}
	}

	@OriginalMember(owner = "client!yc", name = "w", descriptor = "(I)V", line = 211)
	void method15274(@OriginalArg(0) int arg0) {
		this.anInt2017 = arg0 * 702484223;
		@Pc(8) Class240 local8 = this.aClass240_39;
		synchronized (this.aClass240_39) {
			this.aClass240_39.method25833((byte) -104);
		}
	}

	@OriginalMember(owner = "client!yc", name = "d", descriptor = "(I)V", line = 224)
	void method15275(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_39;
		synchronized (this.aClass240_39) {
			this.aClass240_39.method25832(arg0, (byte) -90);
		}
	}

	@OriginalMember(owner = "client!yc", name = "u", descriptor = "(I)V", line = 211)
	void method15276(@OriginalArg(0) int arg0) {
		this.anInt2017 = arg0 * 702484223;
		@Pc(8) Class240 local8 = this.aClass240_39;
		synchronized (this.aClass240_39) {
			this.aClass240_39.method25833((byte) -53);
		}
	}
	...
	void method15278() {
		@Pc(3) Class240 local3 = this.aClass240_39;
		synchronized (this.aClass240_39) {
			this.aClass240_39.method25833((byte) -15);
		}
	}
	...
	void method15280(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_39;
		synchronized (this.aClass240_39) {
			this.aClass240_39.method25832(arg0, (byte) -50);
		}
	}
	...
	void method15281(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_39;
		synchronized (this.aClass240_39) {
			this.aClass240_39.method25832(arg0, (byte) -49);
		}
	}

	@OriginalMember(owner = "client!yc", name = "e", descriptor = "(II)V", line = 211)
	void method15282(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.anInt2017 = arg0 * 702484223;
		@Pc(8) Class240 local8 = this.aClass240_39;
		synchronized (this.aClass240_39) {
			this.aClass240_39.method25833((byte) -39);
		}
	}
	...
	void method15284(@OriginalArg(0) byte arg0) {
		@Pc(3) Class240 local3 = this.aClass240_39;
		synchronized (this.aClass240_39) {
			this.aClass240_39.method25833((byte) -11);
		}
	}

	@OriginalMember(owner = "client!yc", name = "r", descriptor = "(Ljava/lang/CharSequence;Ljava/lang/CharSequence;I)I", line = 161)
	public static int method15285(@OriginalArg(0) CharSequence arg0, @OriginalArg(1) CharSequence arg1, @OriginalArg(2) int arg2) {
