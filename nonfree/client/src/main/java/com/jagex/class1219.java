		...
		if (var8.field3512 != null) {
			...
			for (int var81 = 0; var81 < var8.field3489.length; var81++) {
				...
				if (var82.field3542 == 0) {
					var13 += (double) (var82.field3551 * arg1);
					var15 += (double) (var82.field3552 * arg1);
					var17 += (double) (var82.field3553 * arg1);
					var19 = true;
				} else {
		...
		if (var19) {
			while (true) {
				if (!(var13 > 32767.0D) && !(var15 > 32767.0D) && !(var17 > 32767.0D) && !(var13 < -32767.0D) && !(var15 < -32767.0D) && !(var17 < -32767.0D)) {
					this.field12530 = (short) (int) var13;
					this.field12529 = (short) (int) var15;
					this.field12528 = (short) (int) var17;
					break;
				}
				var13 /= 2.0D;
				var15 /= 2.0D;
