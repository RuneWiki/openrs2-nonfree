...
public class Class230 {
	...
	int method25626(@OriginalArg(0) int arg0) {
	...
	int method25627(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		Class263.method26198(arg0.method22413((short) 16384), -1925978155);
		this.aClass222_6 = Class151.method13978(arg0.method22413((short) 16384), (byte) 0);
		this.aClass222_7 = Class151.method13978(arg0.method22413((short) 16384), (byte) 0);
		this.aBoolean647 = arg0.method22413((short) 16384) != 0;
		...
		for (local40 = 0; local40 < local3; local40++) {
			...
			local47.method25996(arg0, arg1, -1454412503);
		...
		this.aFloatArray98 = new float[this.method25631(1939832912) + 1];
		for (local40 = this.method25629(583954492); local40 <= this.method25640(-1679471766); local40++) {
			this.aFloatArray98[local40 - this.method25629(583954492)] = Class158.method14311(this, (float) local40, -698015169);
		}
		this.aFloat277 = Class158.method14311(this, (float) (this.method25629(583954492) - 1), 1544378774);
		this.aFloat274 = Class158.method14311(this, (float) (this.method25640(-193465815) + 1), 2060419373);
		return local3;
	}

	@OriginalMember(owner = "client!dn", name = "n", descriptor = "(II)F", line = 56)
	float method25628(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 < this.method25629(583954492)) {
			return this.aFloat277;
		} else if (arg0 > this.method25640(2613642)) {
			return this.aFloat274;
		} else {
			return this.aFloatArray98[arg0 - this.method25629(583954492)];
		}
	}

	@OriginalMember(owner = "client!dn", name = "m", descriptor = "(I)I", line = 67)
	int method25629(@OriginalArg(0) int arg0) {
	...
	Class254 method25630(@OriginalArg(0) float arg0) {
		@Pc(4) int local4 = this.method25632(arg0, (byte) -67);
	...
	int method25631(@OriginalArg(0) int arg0) {
		return this.method25640(-277014503) - this.method25629(583954492);
	}

	@OriginalMember(owner = "client!dn", name = "w", descriptor = "(FB)I", line = 81)
	int method25632(@OriginalArg(0) float arg0, @OriginalArg(1) byte arg1) {
		...
		} else if (arg0 < (float) this.method25629(583954492) || arg0 > (float) this.method25640(-1951807406)) {
			return -1;
		} else {
			@Pc(67) int local67 = this.method25626(-1507711602);
	...
	Class254 method25633(@OriginalArg(0) float arg0, @OriginalArg(1) int arg1) {
		@Pc(4) int local4 = this.method25632(arg0, (byte) -15);
		return local4 >= 0 && local4 < this.aClass254Array1.length ? this.aClass254Array1[local4] : null;
	}

	@OriginalMember(owner = "client!dn", name = "q", descriptor = "()I", line = 72)
	int method25634() {
		return this.aClass254Array1 == null ? 0 : this.aClass254Array1[this.method25626(-1507711602) - 1].anInt3852 * 1727636433;
	}
	...
	int method25635(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		@Pc(3) int local3 = arg0.method22415(-1434290800);
		Class263.method26198(arg0.method22413((short) 16384), -1916519202);
		this.aClass222_6 = Class151.method13978(arg0.method22413((short) 16384), (byte) 0);
		this.aClass222_7 = Class151.method13978(arg0.method22413((short) 16384), (byte) 0);
		this.aBoolean647 = arg0.method22413((short) 16384) != 0;
		this.aClass254Array1 = new Class254[local3];
		...
		for (local40 = 0; local40 < local3; local40++) {
			@Pc(47) Class254 local47 = new Class254();
			local47.method25996(arg0, arg1, -1901686755);
			this.aClass254Array1[local40] = local47;
			if (local38 != null) {
				local38.aClass254_1 = local47;
			}
		...
		this.aFloatArray98 = new float[this.method25631(1824730251) + 1];
		for (local40 = this.method25629(583954492); local40 <= this.method25640(-2107843277); local40++) {
			this.aFloatArray98[local40 - this.method25629(583954492)] = Class158.method14311(this, (float) local40, -613383931);
		}
		this.aFloat277 = Class158.method14311(this, (float) (this.method25629(583954492) - 1), -2008326949);
		this.aFloat274 = Class158.method14311(this, (float) (this.method25640(-1625722769) + 1), -200822286);
		return local3;
	}

	@OriginalMember(owner = "client!dn", name = "a", descriptor = "(F)Lclient!ey;", line = 126)
	Class254 method25636(@OriginalArg(0) float arg0) {
		@Pc(4) int local4 = this.method25632(arg0, (byte) -112);
		return local4 >= 0 && local4 < this.aClass254Array1.length ? this.aClass254Array1[local4] : null;
	}
	...
	int method25637(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		@Pc(3) int local3 = arg0.method22415(-1434290800);
		Class263.method26198(arg0.method22413((short) 16384), -1579061855);
		this.aClass222_6 = Class151.method13978(arg0.method22413((short) 16384), (byte) 0);
		this.aClass222_7 = Class151.method13978(arg0.method22413((short) 16384), (byte) 0);
		this.aBoolean647 = arg0.method22413((short) 16384) != 0;
		this.aClass254Array1 = new Class254[local3];
		...
		for (local40 = 0; local40 < local3; local40++) {
			@Pc(47) Class254 local47 = new Class254();
			local47.method25996(arg0, arg1, 1246408303);
			this.aClass254Array1[local40] = local47;
			if (local38 != null) {
				local38.aClass254_1 = local47;
			}
		...
		this.aFloatArray98 = new float[this.method25631(1604094791) + 1];
		for (local40 = this.method25629(583954492); local40 <= this.method25640(-904815006); local40++) {
			this.aFloatArray98[local40 - this.method25629(583954492)] = Class158.method14311(this, (float) local40, 986538439);
		}
		this.aFloat277 = Class158.method14311(this, (float) (this.method25629(583954492) - 1), 1779469896);
		this.aFloat274 = Class158.method14311(this, (float) (this.method25640(-378456364) + 1), -779735763);
		return local3;
	}
	...
	float method25638(@OriginalArg(0) int arg0) {
		if (arg0 < this.method25629(583954492)) {
			return this.aFloat277;
		} else if (arg0 > this.method25640(-441996045)) {
			return this.aFloat274;
		} else {
			return this.aFloatArray98[arg0 - this.method25629(583954492)];
		}
	...
	float method25639(@OriginalArg(0) int arg0) {
		if (arg0 < this.method25629(583954492)) {
			return this.aFloat277;
		} else if (arg0 > this.method25640(-1256606992)) {
			return this.aFloat274;
		} else {
			return this.aFloatArray98[arg0 - this.method25629(583954492)];
		}
	...
	int method25640(@OriginalArg(0) int arg0) {
		return this.aClass254Array1 == null ? 0 : this.aClass254Array1[this.method25626(-1507711602) - 1].anInt3852 * 1727636433;
	}
	...
	Class254 method25643(@OriginalArg(0) float arg0) {
		@Pc(4) int local4 = this.method25632(arg0, (byte) -118);
		return local4 >= 0 && local4 < this.aClass254Array1.length ? this.aClass254Array1[local4] : null;
	}
	...
	int method25645() {
		return this.method25640(136306628) - this.method25629(583954492);
	}
	...
	float method25646(@OriginalArg(0) int arg0) {
		if (arg0 < this.method25629(583954492)) {
			return this.aFloat277;
		} else if (arg0 > this.method25640(-1493777469)) {
			return this.aFloat274;
		} else {
			return this.aFloatArray98[arg0 - this.method25629(583954492)];
		}
	...
	int method25647(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(3) int local3 = arg0.method22415(-1434290800);
		Class263.method26198(arg0.method22413((short) 16384), -1774552870);
		this.aClass222_6 = Class151.method13978(arg0.method22413((short) 16384), (byte) 0);
		this.aClass222_7 = Class151.method13978(arg0.method22413((short) 16384), (byte) 0);
		this.aBoolean647 = arg0.method22413((short) 16384) != 0;
		this.aClass254Array1 = new Class254[local3];
		...
		for (local40 = 0; local40 < local3; local40++) {
			@Pc(47) Class254 local47 = new Class254();
			local47.method25996(arg0, arg1, 758426843);
			this.aClass254Array1[local40] = local47;
			if (local38 != null) {
				local38.aClass254_1 = local47;
			}
		...
		this.aFloatArray98 = new float[this.method25631(1301336846) + 1];
		for (local40 = this.method25629(583954492); local40 <= this.method25640(-2043335122); local40++) {
			this.aFloatArray98[local40 - this.method25629(583954492)] = Class158.method14311(this, (float) local40, 1589252846);
		}
		this.aFloat277 = Class158.method14311(this, (float) (this.method25629(583954492) - 1), 1338927684);
		this.aFloat274 = Class158.method14311(this, (float) (this.method25640(-529509718) + 1), -2023648687);
		return local3;
	}
	...
	int method25650(@OriginalArg(0) float arg0) {
		if (this.anInt3735 * -534580841 >= 0 && (float) (this.aClass254Array1[this.anInt3735 * -534580841].anInt3852 * 1727636433) <= arg0 && (this.aClass254Array1[this.anInt3735 * -534580841].aClass254_1 == null || (float) (this.aClass254Array1[this.anInt3735 * -534580841].aClass254_1.anInt3852 * 1727636433) > arg0)) {
			return this.anInt3735 * -534580841;
		} else if (arg0 < (float) this.method25629(583954492) || arg0 > (float) this.method25640(-973816676)) {
			return -1;
		} else {
			@Pc(67) int local67 = this.method25626(-1507711602);
			@Pc(72) int local72 = this.anInt3735 * -534580841;
	...
	static final void method25651(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1168259715);
	...
	public static int method25652(@OriginalArg(0) Class471 arg0, @OriginalArg(1) int arg1) {
