...
public class Class630 {
	...
	static boolean method32266(@OriginalArg(0) String arg0) {
		if (arg0 == null) {
			return false;
		}
		try {
	...
	static boolean method32267(@OriginalArg(0) String arg0) {
		if (arg0 == null) {
			return false;
		}
		try {
	...
	public static long method32268() {
		try {
			...
			do {
				...
				if (local65 == -1) {
					local50.anInt3070 = 0;
					return local50.method22423(-1717217003);
				}
	...
	public static long method32269() {
		try {
			...
			do {
				...
				if (local65 == -1) {
					local50.anInt3070 = 0;
					return local50.method22423(1609455049);
				}
				local50.anInt3070 += local65 * -1445626955;
			} while (local50.anInt3070 * 212851357 < 1000);
			return 0L;
	...
	public static final int method32270(@OriginalArg(0) long arg0, @OriginalArg(1) String arg1) {
		...
		local8.method22510(10, (byte) -38);
		@Pc(44) int local44;
		for (local44 = 0; local44 < 4; local44++) {
			local8.method22395(local3.nextInt(), (byte) 40);
		}
		local8.method22395(local16[0], (byte) 5);
		local8.method22395(local16[1], (byte) -21);
		local8.method22399(arg0);
		local8.method22399(0L);
		for (local44 = 0; local44 < 4; local44++) {
			local8.method22395(local3.nextInt(), (byte) -44);
		}
		local8.method22416(aBigInteger7, aBigInteger8, (byte) -17);
		local13.method22510(10, (byte) -66);
		for (local44 = 0; local44 < 3; local44++) {
			local13.method22395(local3.nextInt(), (byte) 23);
		}
		local13.method22399(local3.nextLong());
		local13.method22398(local3.nextLong());
		Class314.method26940(local13, 2128804438);
		local13.method22399(local3.nextLong());
		local13.method22416(aBigInteger7, aBigInteger8, (byte) -84);
		local44 = Class46.method894(arg1, -1889900536);
		if (local44 % 8 != 0) {
			local44 += 8 - local44 % 8;
		}
		@Pc(146) Class93_Sub41 local146 = new Class93_Sub41(local44);
		local146.method22402(arg1, -85852108);
		local146.anInt3070 = local44 * -1445626955;
		local146.method22475(local16, -817017705);
		...
		local179.method22510(2, (byte) -8);
		local179.method22510(local8.anInt3070 * 212851357, (byte) -84);
		local179.method22405(local8.aByteArray58, 0, local8.anInt3070 * 212851357, 2026842986);
		local179.method22510(local13.anInt3070 * 212851357, (byte) -13);
		local179.method22405(local13.aByteArray58, 0, local13.anInt3070 * 212851357, 2026842986);
		local179.method22454(local146.anInt3070 * 212851357, 2132457506);
		local179.method22405(local146.aByteArray58, 0, local146.anInt3070 * 212851357, 2026842986);
		@Pc(239) String local239 = Class669.method32943(local179.aByteArray58, 2047889127);
		try {
			...
			local272.write("data2=" + Class25_Sub2.method16021(local239, (byte) 73) + "&dest=" + Class25_Sub2.method16021("passwordchoice.ws", (byte) 73));
			local272.flush();
			...
			do {
				...
				if (local316 == -1) {
					...
					if (local347.startsWith("OFFLINE")) {
						...
						local179.method22440(local16, 1442669960);
						...
						if (Class89.method1600(local347, (byte) 1)) {
							Class338.method27468(local347, true, client.aBoolean596, (byte) -125);
							return 2;
						} else {
							return 5;
						}
	...
	static final void method32272(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class606.method31912(local11, local14, arg0, (byte) 85);
	}

	@OriginalMember(owner = "client!w", name = "ayh", descriptor = "(Lclient!yf;I)V", line = 14070)
	static final void method32273(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		Class238.method25796(true, 1773551774);
	...
	public static boolean method32274(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1) {
	...
	public static void method32276(@OriginalArg(0) String arg0, @OriginalArg(1) byte arg1) {
		...
		local10.aClass93_Sub41_Sub2_1.method22454(0, 2144093970);
		@Pc(21) int local21 = local10.aClass93_Sub41_Sub2_1.anInt3070 * 212851357;
		local10.aClass93_Sub41_Sub2_1.method22402(arg0, 1419926272);
		local10.aClass93_Sub41_Sub2_1.anInt3070 += -1529454093;
		local10.aClass93_Sub41_Sub2_1.method22441(Class676.anIntArray516, local21, local10.aClass93_Sub41_Sub2_1.anInt3070 * 212851357, (byte) -65);
		local10.aClass93_Sub41_Sub2_1.method22407(local10.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local21, 2020888247);
		client.aClass175_1.method24351(local10, -1528137382);
