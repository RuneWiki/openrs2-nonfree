...
public class class835 extends class104 {
	...
	public void method1555() {
		this.field9437 = (byte[][]) null;
		this.field9447 = (byte[][]) null;
	}
				...
				if (arg7[var18 - arg3][var19 - arg4]) {
					if (this.field9425[var18][var19] != null) {
						...
						for (int var24 = 0; var24 < var23.field887; var24++) {
							arg10[var24] = (float) (var23.field884[var24] * var14 / this.field1233 + var16);
							arg11[var24] = (float) (var17 - var23.field882[var24] * var14 / this.field1233);
						}
					...
					if (this.field9438 == null) {
						if (this.field9429[var18][var19] != null) {
							...
							for (int var38 = 0; var38 < var37.field981; var38++) {
								arg10[var38] = (float) (var37.field975[var38] * var14 / this.field1233 + var16);
								arg11[var38] = (float) (var17 - var37.field978[var38] * var14 / this.field1233);
							}
						...
						for (int var24 = 0; var24 < var23.field919; var24++) {
							arg10[var24] = (float) (var23.field917[var24] * var14 / this.field1233 + var16);
							arg11[var24] = (float) (var17 - var23.field916[var24] * var14 / this.field1233);
						}
