...
public class Class685 {
	...
	public static short method33427(@OriginalArg(0) int arg0) {
	...
	public static int method33428(@OriginalArg(0) int arg0) {
	...
	public static int method33429(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	public static int method33430(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public static short method33435(@OriginalArg(0) int arg0) {
		@Pc(5) int local5 = arg0 >> 10 & 0x3F;
		@Pc(11) int local11 = arg0 >> 3 & 0x70;
		@Pc(15) int local15 = arg0 & 0x7F;
		@Pc(32) int local32 = local15 <= 64 ? local11 * local15 >> 7 : (127 - local15) * local11 >> 7;
	...
	public static int method33437(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(3) int local3 = 255 - arg2;
		@Pc(21) int local21 = (arg2 * (arg1 & 0xFF00FF) & 0xFF00FF00 | (arg1 & 0xFF00) * arg2 & 0xFF0000) >>> 8;
		return local21 + ((local3 * (arg0 & 0xFF00FF) & 0xFF00FF00 | (arg0 & 0xFF00) * local3 & 0xFF0000) >>> 8);
	}
	...
	public static int method33438(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public static void method33439(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1) {
		if (arg0) {
			anInt5905 += 1883407479;
			Class376.method28043(213749755);
		}
		if (arg1) {
			anInt5906 += -236883317;
			Class262.method26174((short) 8448);
		}
	}
	...
	public static void method33441(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1) {
		if (arg0) {
			anInt5905 += 1883407479;
			Class376.method28043(1427294686);
		}
		if (arg1) {
			anInt5906 += -236883317;
			Class262.method26174((short) 8448);
	...
	public static int method33442(@OriginalArg(0) int arg0) {
		@Pc(8) double local8 = (double) (arg0 >> 16 & 0xFF) / 256.0D;
		@Pc(17) double local17 = (double) (arg0 >> 8 & 0xFF) / 256.0D;
		@Pc(24) double local24 = (double) (arg0 & 0xFF) / 256.0D;
		@Pc(26) double local26 = local8;
	...
	public static void method33443(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1) {
		if (arg0) {
			anInt5905 += 1883407479;
			Class376.method28043(-1643142297);
		}
		if (arg1) {
			anInt5906 += -236883317;
			Class262.method26174((short) 8448);
	...
	public static int method33444(@OriginalArg(0) int arg0) {
		@Pc(8) double local8 = (double) (arg0 >> 16 & 0xFF) / 256.0D;
		@Pc(17) double local17 = (double) (arg0 >> 8 & 0xFF) / 256.0D;
		@Pc(24) double local24 = (double) (arg0 & 0xFF) / 256.0D;
		@Pc(26) double local26 = local8;
	...
	public static final int method33445(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 == -2) {
			return 12345678;
		} else if (arg0 == -1) {
			if (arg1 < 2) {
	...
	public static final int method33447(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 == -1) {
			return 12345678;
		}
	...
	public static int method33448(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2) {
	...
	public static final int method33449(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg2 > 243) {
			arg1 >>= 0x4;
		} else if (arg2 > 217) {
			arg1 >>= 0x3;
	...
	public static final int method33450(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg2 > 243) {
			arg1 >>= 0x4;
		} else if (arg2 > 217) {
			arg1 >>= 0x3;
	...
	static void method33451(@OriginalArg(0) int[] arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) float[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		if (arg3 >= arg4) {
			return;
		}
		...
		method33451(arg0, arg1, arg2, arg3, local10 - 1, -1558733387);
		method33451(arg0, arg1, arg2, local10 + 1, arg4, -1786317961);
	}

	@OriginalMember(owner = "client!yk", name = "ayt", descriptor = "(Lclient!yf;I)V", line = 14046)
	static final void method33452(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static long method33453(@OriginalArg(0) CharSequence arg0, @OriginalArg(1) byte arg1) {
		@Pc(1) long local1 = 0L;
		...
		for (@Pc(6) int local6 = 0; local6 < local4; local6++) {
			...
			if (local17 >= 'A' && local17 <= 'Z') {
				local1 += (long) (local17 + 1 - 65);
			} else if (local17 >= 'a' && local17 <= 'z') {
				local1 += (long) (local17 + 1 - 97);
			} else if (local17 >= '0' && local17 <= '9') {
				local1 += (long) (local17 + 27 - 48);
			}
