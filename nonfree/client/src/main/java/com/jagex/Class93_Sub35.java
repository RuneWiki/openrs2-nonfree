...
public abstract class Class93_Sub35 extends Class93 {
	...
	static void method19706(@OriginalArg(0) Class93_Sub41_Sub2 arg0, @OriginalArg(1) int arg1) {
		...
		if (local32 != 0) {
			...
			if (local32 == 1) {
				...
				if (local167 == 1) {
					...
					switch(local190) {
						case 0:
							local36.method20054(local172, local177 + 1, Class174.aByteArray64[arg1]);
							break;
						case 1:
							local36.method20054(local172 - 1, local177, Class174.aByteArray64[arg1]);
							break;
						case 2:
							local36.method20054(local172 + 1, local177, Class174.aByteArray64[arg1]);
							break;
				...
				local36.method20054(local172, local177, Class174.aByteArray64[arg1]);
			} else if (local32 == 2) {
				...
				local36.method20054(local167, local172, Class174.aByteArray64[arg1]);
			} else {
				...
				if (local162 == 0) {
					...
					if (local172 == Class707.aClass707_4.anInt5958 * -793472015) {
						...
						local36.method20054(local453, local460, Class174.aByteArray64[arg1]);
					}
	...
	static final void method19707(@OriginalArg(0) Class681 arg0) {
