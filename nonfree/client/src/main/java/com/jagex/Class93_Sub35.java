...
public abstract class Class93_Sub35 extends Class93 {
	...
	static void method19706(@OriginalArg(0) Class93_Sub41_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) short arg2) {
		@Pc(3) Class611 local3 = client.aClass532_1.method30443(2075446028);
		@Pc(13) boolean local13 = arg0.method22689(1, -2036436358) == 1;
		if (local13) {
			Class174.anIntArray279[(Class174.anInt3292 += 981825405) * 2140666325 - 1] = arg1;
		}
		@Pc(32) int local32 = arg0.method22689(2, -1678222890);
		...
		if (local32 != 0) {
			...
			@Pc(190) int local190;
			if (local32 == 1) {
				local162 = arg0.method22689(3, -504190790);
				local167 = arg0.method22689(1, 2069073106);
				local172 = local36.anIntArray240[0];
				local177 = local36.anIntArray239[0];
				if (local167 == 1) {
					Class174.aByteArray64[arg1] = Class707.aClass707_3.aByte176;
					local190 = arg0.method22689(2, 1489263378);
					switch(local190) {
						case 0:
							local36.method20054(local172, local177 + 1, Class174.aByteArray64[arg1], (byte) 122);
							break;
						case 1:
							local36.method20054(local172 - 1, local177, Class174.aByteArray64[arg1], (byte) 105);
							break;
						case 2:
							local36.method20054(local172 + 1, local177, Class174.aByteArray64[arg1], (byte) 30);
							break;
						case 3:
							local36.method20054(local172, local177 - 1, Class174.aByteArray64[arg1], (byte) 33);
					}
				}
				if (local162 == 0) {
					local172--;
				...
				local36.method20054(local172, local177, Class174.aByteArray64[arg1], (byte) 38);
			} else if (local32 == 2) {
				local162 = arg0.method22689(4, 293283928);
				...
				local36.method20054(local167, local172, Class174.aByteArray64[arg1], (byte) 59);
			} else {
				local162 = arg0.method22689(1, -348987267);
				@Pc(442) int local442;
				@Pc(453) int local453;
				@Pc(460) int local460;
				if (local162 == 0) {
					local167 = arg0.method22689(15, -900827812);
					...
					if (local172 == Class707.aClass707_4.anInt5958 * -793472015) {
						...
						local36.method20054(local453, local460, Class174.aByteArray64[arg1], (byte) 120);
					}
					local36.aByte100 = local36.aByte99 = (byte) (local36.aByte100 + local177 & 0x3);
					if (client.aClass532_1.method30509(1695451641).method30330(local453, local460, -662808309)) {
						local36.aByte99++;
					}
					...
					local167 = arg0.method22689(3, 1150118268);
					local172 = arg0.method22689(30, 1014192385);
					...
					if (local167 == Class707.aClass707_4.anInt5958 * -793472015) {
						...
						local36.method20054(local453, local460, Class174.aByteArray64[arg1], (byte) 109);
					}
					local36.aByte100 = local36.aByte99 = (byte) (local177 + local36.aByte100 & 0x3);
					if (client.aClass532_1.method30509(1137438638).method30330(local453, local460, -662808309)) {
						local36.aByte99++;
					}
			...
			Class707.method36745(1576935057);
			...
			if (local36.anInt2799 * 1643784853 == -1) {
				local59.anInt3376 = local36.aClass523_7.method30363(-210358709) * -373179301;
			} else {
			...
			if (arg0.method22689(1, 1402643434) != 0) {
