...
public class Class297 {
	...
	void method26611(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		((Class304) this.anArrayList3.get(arg0)).method26755(arg1, -1062072040);
	}
	...
	int method26614(@OriginalArg(0) int arg0) {
	...
	public int method26620(@OriginalArg(0) byte arg0) {
	...
	public Class304 method26622(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	void method26623(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		@Pc(5) Class304 local5 = (Class304) this.anArrayList3.get(arg0);
		local5.method26753(arg1 ? Class301.aClass301_2 : Class301.aClass301_3, 2077060238);
	}

	@OriginalMember(owner = "client!gq", name = "r", descriptor = "(I)Lclient!eh;", line = 158)
	public Interface20 method26624(@OriginalArg(0) int arg0) {
		return new Class113(Class138.aClass138_70, this.aClass40_1);
	}

	@OriginalMember(owner = "client!gq", name = "v", descriptor = "(Lclient!gy;B)V", line = 162)
	void method26625(@OriginalArg(0) Class304 arg0, @OriginalArg(1) byte arg1) {
		this.anArrayList3.add(arg0);
		this.method26613(758577125);
	}
	...
	public List method26627(@OriginalArg(0) byte arg0) {
		return Collections.unmodifiableList(this.anArrayList3);
	}

	@OriginalMember(owner = "client!gq", name = "y", descriptor = "(II)V", line = 176)
	void method26628(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.anArrayList4.remove(arg0);
	}

	@OriginalMember(owner = "client!gq", name = "q", descriptor = "(III)V", line = 180)
	void method26629(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		((Class304) this.anArrayList3.get(arg0)).method26746(arg1, (byte) 83);
		this.method26613(-1882768024);
	}

	@OriginalMember(owner = "client!gq", name = "x", descriptor = "(III)V", line = 185)
	void method26630(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(5) Class304 local5 = (Class304) this.anArrayList3.get(arg0);
		local5.method26792(arg1, 1886652544);
		local5.method26764(true, (byte) -128);
	}

	@OriginalMember(owner = "client!gq", name = "b", descriptor = "(II)V", line = 191)
	void method26631(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(5) Class304 local5 = (Class304) this.anArrayList3.get(arg0);
		local5.method26764(false, (byte) -128);
	}

	@OriginalMember(owner = "client!gq", name = "h", descriptor = "(IZS)V", line = 196)
	void method26632(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) short arg2) {
		@Pc(5) Class304 local5 = (Class304) this.anArrayList3.get(arg0);
		local5.method26753(arg1 ? Class301.aClass301_2 : Class301.aClass301_3, 2140516169);
	}

	@OriginalMember(owner = "client!gq", name = "j", descriptor = "(ILclient!gy;I)V", line = 223)
	void method26633(@OriginalArg(0) int arg0, @OriginalArg(1) Class304 arg1, @OriginalArg(2) int arg2) {
		@Pc(5) Class304 local5 = (Class304) this.anArrayList3.get(arg0);
		local5.method26759(arg1, -103983867);
	}
	...
	void method26639() {
		...
		while (local3.hasNext()) {
			@Pc(10) Class304 local10 = (Class304) local3.next();
			local10.method26753(Class301.aClass301_4, 1911069056);
		}
	}
	...
	void method26643(@OriginalArg(0) byte arg0) {
	...
	public Class301 method26644() {
		...
		@Pc(13) Class301 local13 = ((Class304) this.anArrayList3.get(0)).method26752((short) -25757);
		switch(local13.anInt3929 * 1122922251) {
			...
			default:
				...
				} while (local29.method26752((short) 14451) != Class301.aClass301_3);
				return Class301.aClass301_3;
		}
	}
	...
	public Class297(@OriginalArg(0) long arg0, @OriginalArg(1) Class93_Sub41 arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Interface27 arg3) {
		...
		@Pc(13) int local13 = arg1.method22413((short) 16384);
		if (local13 <= 0 || local13 > 1) {
			throw new IllegalStateException("");
		}
		@Pc(27) int local27 = arg1.method22413((short) 16384);
		this.aBoolean674 = (local27 & 0x1) != 0;
		this.aBoolean675 = (local27 & 0x2) != 0;
		this.aBoolean676 = (local27 & 0x4) != 0;
		this.anInt3926 = arg1.method22419(-118643075) * -2007260593;
		this.aLong253 = arg1.method22423(1417271561) * 2406700482966643721L;
		this.aString158 = arg1.method22427(1568738619);
		this.anInt3923 = arg1.method22482((byte) -9) * 786987457;
		arg1.method22419(-118643075);
		arg1.method22423(464392751);
		@Pc(94) int local94 = arg1.method22415(-1434290800);
		...
		local102 = arg1.method22415(-1434290800);
		...
		local132 = arg1.method22415(-1434290800);
		for (@Pc(163) int local163 = 0; local163 < local132; local163++) {
			@Pc(173) Class466 local173 = arg3.method25528((byte) -91).method1463(arg1, (byte) 28);
			this.aClass40_1.method776(local173.anInt5092 * -1181855333, local173.anObject19, (byte) 67);
		}
		if (!arg2) {
			arg1.method22415(-1434290800);
			arg1.method22415(-1434290800);
			arg1.method22415(-1434290800);
			arg1.method22415(-1434290800);
			arg1.method22415(-1434290800);
		}
		this.method26613(-935677119);
	}
	...
	public Class301 method26658() {
		...
		@Pc(13) Class301 local13 = ((Class304) this.anArrayList3.get(0)).method26752((short) 15601);
		switch(local13.anInt3929 * 1122922251) {
			case 1:
			case 2:
				return local13;
			default:
				...
				do {
					...
					local29 = (Class304) local22.next();
				} while (local29.method26752((short) -10793) != Class301.aClass301_3);
				return Class301.aClass301_3;
		}
	}

	@OriginalMember(owner = "client!gq", name = "n", descriptor = "(B)Ljava/util/List;", line = 79)
	public List method26659(@OriginalArg(0) byte arg0) {
		return Collections.unmodifiableList(this.anArrayList4);
	}

	@OriginalMember(owner = "client!gq", name = "o", descriptor = "(II)V", line = 167)
	void method26660(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.anArrayList3.remove(arg0);
		this.method26613(1642011608);
	}
	...
	void method26664(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		((Class304) this.anArrayList3.get(arg0)).method26755(arg1, -2129539254);
	}
	...
	void method26666(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		@Pc(5) Class304 local5 = (Class304) this.anArrayList3.get(arg0);
		local5.method26753(arg1 ? Class301.aClass301_2 : Class301.aClass301_3, 2052817658);
	}
	...
	public Class301 method26674(@OriginalArg(0) byte arg0) {
		if (this.anArrayList3.isEmpty()) {
			return Class301.aClass301_3;
		}
		@Pc(13) Class301 local13 = ((Class304) this.anArrayList3.get(0)).method26752((short) -826);
		switch(local13.anInt3929 * 1122922251) {
			case 1:
			case 2:
				return local13;
			default:
				...
				do {
					...
					local29 = (Class304) local22.next();
				} while (local29.method26752((short) -9472) != Class301.aClass301_3);
				return Class301.aClass301_3;
		}
	}
	...
	void method26677() {
		...
		for (@Pc(5) int local5 = 0; local5 < this.anArrayList3.size(); local5++) {
			@Pc(16) Class304 local16 = (Class304) this.anArrayList3.get(local5);
			@Pc(20) int local20 = local16.method26750((short) -10914);
			if (local20 > local1) {
				local1 = local20;
				local3 = local5;
			}
	...
	void method26679(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(5) Class304 local5 = (Class304) this.anArrayList3.get(arg0);
		local5.method26792(arg1, 1259943580);
		local5.method26764(true, (byte) -128);
	}
	...
	void method26680(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(5) Class304 local5 = (Class304) this.anArrayList3.get(arg0);
		local5.method26792(arg1, 1042683699);
		local5.method26764(true, (byte) -128);
	}

	@OriginalMember(owner = "client!gq", name = "s", descriptor = "(Lclient!ga;S)V", line = 172)
	void method26681(@OriginalArg(0) Class282 arg0, @OriginalArg(1) short arg1) {
		this.anArrayList4.add(arg0);
	}
	...
	void method26682() {
		...
		while (local3.hasNext()) {
			@Pc(10) Class304 local10 = (Class304) local3.next();
			local10.method26753(Class301.aClass301_1, 1985270339);
		}
	}
	...
	void method26684(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		@Pc(5) Class304 local5 = (Class304) this.anArrayList3.get(arg0);
		local5.method26753(arg1 ? Class301.aClass301_2 : Class301.aClass301_3, 2069668649);
	}
	...
	void method26685(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		((Class304) this.anArrayList3.get(arg0)).method26755(arg1, -129455002);
	}
	...
	void method26686(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		((Class304) this.anArrayList3.get(arg0)).method26746(arg1, (byte) 11);
		this.method26613(987414438);
	}
	...
	void method26687(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		((Class304) this.anArrayList3.get(arg0)).method26755(arg1, 1560713515);
	}
	...
	void method26688(@OriginalArg(0) int arg0, @OriginalArg(1) Class304 arg1) {
		@Pc(5) Class304 local5 = (Class304) this.anArrayList3.get(arg0);
		local5.method26759(arg1, -1358627470);
	}
	...
	void method26689() {
		...
		while (local3.hasNext()) {
			@Pc(10) Class304 local10 = (Class304) local3.next();
			local10.method26753(Class301.aClass301_1, 2134856380);
		}
	}
	...
	void method26690() {
		...
		while (local3.hasNext()) {
			@Pc(10) Class304 local10 = (Class304) local3.next();
			local10.method26753(Class301.aClass301_1, 2117640521);
		}
	}
	...
	void method26691() {
		...
		while (local3.hasNext()) {
			@Pc(10) Class304 local10 = (Class304) local3.next();
			local10.method26753(Class301.aClass301_1, 2121721680);
		}
	}
	...
	void method26692(@OriginalArg(0) Class304 arg0) {
		this.anArrayList3.add(arg0);
		this.method26613(-1246665786);
	}

	@OriginalMember(owner = "client!gq", name = "g", descriptor = "(I)V", line = 205)
	void method26693(@OriginalArg(0) int arg0) {
		@Pc(3) Iterator local3 = this.anArrayList3.iterator();
		while (local3.hasNext()) {
			@Pc(10) Class304 local10 = (Class304) local3.next();
			local10.method26753(Class301.aClass301_4, 2062967067);
		}
	}

	@OriginalMember(owner = "client!gq", name = "dg", descriptor = "(Lclient!yf;I)V", line = 5653)
	static final void method26694(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class237.method25771(local11, local14, arg0, (short) 5134);
	}

	@OriginalMember(owner = "client!gq", name = "age", descriptor = "(Lclient!yf;B)V", line = 10671)
	static final void method26695(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = Class440.method28852((long) arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091] * 60000L, Class106.aClass717_8.method36920(), true, (byte) -125) + " UTC";
	}

	@OriginalMember(owner = "client!gq", name = "aoi", descriptor = "(Lclient!yf;I)V", line = 12418)
	static final void method26696(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		if (!Class65.aClass123_Sub1_2.method9023(-1662199153).method27505(406481090)) {
			throw new RuntimeException();
		}
		@Pc(14) Class124_Sub3 local14 = (Class124_Sub3) Class65.aClass123_Sub1_2.method8952((byte) -51);
		local14.method21432(Class382.aClass479_2, -1, 0.0F, 1457100682);
		client.aBoolean619 = true;
	}

	@OriginalMember(owner = "client!gq", name = "awn", descriptor = "(Lclient!yf;B)V", line = 13573)
	static final void method26697(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anInt5891 -= -725861497;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		@Pc(33) int local33 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 2];
		@Pc(42) long local42 = Class569.method31311(0, 0, 12, local13, local23, local33, -230131351);
	...
	static Class93_Sub1_Sub20 method26698(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(8) Class93_Sub41 local8 = new Class93_Sub41(arg0.method30044(0, arg1, (byte) 0));
