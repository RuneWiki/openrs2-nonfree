...
public abstract class Class154 {
	...
	public boolean method14133(@OriginalArg(0) int arg0) {
	...
	public boolean method14135(@OriginalArg(0) int arg0) {
		return (this.anInt1650 * 803722663 & 0x4) != 0;
	}

	@OriginalMember(owner = "client!wg", name = "k", descriptor = "(B)Z", line = 27)
	public boolean method14136(@OriginalArg(0) byte arg0) {
	...
	public boolean method14139(@OriginalArg(0) short arg0) {
		return (this.anInt1650 * 803722663 & 0x2) != 0;
	}
	...
	static final void method14143(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		if (local23 == -1) {
			...
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class449.aClass514_1.method30267(local13, (byte) -12).method22371((char) local23, -642307170);
		}
	}

	@OriginalMember(owner = "client!wg", name = "aox", descriptor = "(Lclient!yf;S)V", line = 12624)
	static final void method14144(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) throws Exception_Sub3 {
	...
	static final void method14147(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		((Class25_Sub1) Class65.aClass123_Sub1_2.method9040(2039716393)).method15967(arg0.anIntArray519[arg0.anInt5891 * -1497248091], arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1], arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 2], 1854058851);
	}
}
