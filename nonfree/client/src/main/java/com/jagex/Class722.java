...
public class Class722 {
	...
	public static float method36926(@OriginalArg(0) Class471 arg0) {
		@Pc(4) Class472 local4 = Class472.method29529(0.0F, 0.0F, 1.0F);
		local4.method29572(arg0);
		@Pc(14) double local14 = 1.5707963267948966D - Math.acos((double) local4.aFloat318);
		local4.method29532();
	...
	public static float method36930(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1) {
		@Pc(5) double local5 = Math.atan2((double) arg0, (double) arg1);
		if (local5 < 0.0D) {
			local5 = local5 + 3.141592653589793D + 3.141592653589793D;
		}
	...
	public static float method36932(@OriginalArg(0) Class471 arg0) {
		@Pc(4) Class472 local4 = Class472.method29529(0.0F, 0.0F, 1.0F);
		local4.method29572(arg0);
		@Pc(15) double local15 = Math.atan2((double) local4.aFloat317, (double) local4.aFloat319);
		local4.method29532();
	...
	public static int method36922(@OriginalArg(0) Class471 arg0) {
		@Pc(4) Class472 local4 = Class472.method29529(0.0F, 0.0F, 1.0F);
		local4.method29572(arg0);
		@Pc(15) double local15 = Math.atan2((double) local4.aFloat317, (double) local4.aFloat319);
		local4.method29532();
