...
public class Class88_Sub1 extends Class88 {
	...
	Class88_Sub1(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) Class206 arg1, @OriginalArg(2) Class226 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int[][] arg5) {
		...
		if (arg4) {
			for (local22 = 0; local22 < 6; local22++) {
				method18068(local22 + 34069, Class104_Sub1.method3826(this.aClass206_16, this.aClass226_17), arg3, arg3, 32993, this.aClass104_Sub1_34.anInt527, arg5[local22]);
			}
		} else {
			for (local22 = 0; local22 < 6; local22++) {
	...
	Class88_Sub1(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) Class206 arg1, @OriginalArg(2) Class226 arg2, @OriginalArg(3) int arg3) {
		...
		this.aClass104_Sub1_34.method3804(this);
		for (@Pc(20) int local20 = 0; local20 < 6; local20++) {
			OpenGL.glTexImage2Dub(local20 + 34069, 0, Class104_Sub1.method3826(this.aClass206_16, this.aClass226_17), arg3, arg3, 0, Class104_Sub1.method3926(this.aClass206_16), 5121, (byte[]) null, 0);
		}
		this.method18041(true);
	}
