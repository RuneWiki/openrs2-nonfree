...
public class Class347 implements Interface13 {
	...
	void method27580(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg1 == 1) {
			this.aString183 = arg0.method22428(-27244283);
		} else if (arg1 == 2) {
			this.aString182 = arg0.method22428(1582697485);
		} else {
			@Pc(24) int local24;
			@Pc(31) int local31;
			if (arg1 == 3) {
				local24 = arg0.method22413((short) 16384);
				this.anIntArrayArray56 = new int[local24][3];
				for (local31 = 0; local31 < local24; local31++) {
					this.anIntArrayArray56[local31][0] = arg0.method22415(-1434290800);
					this.anIntArrayArray56[local31][1] = arg0.method22419(-118643075);
					this.anIntArrayArray56[local31][2] = arg0.method22419(-118643075);
				}
			} else if (arg1 == 4) {
				local24 = arg0.method22413((short) 16384);
				this.anIntArrayArray55 = new int[local24][3];
				for (local31 = 0; local31 < local24; local31++) {
					this.anIntArrayArray55[local31][0] = arg0.method22415(-1434290800);
					this.anIntArrayArray55[local31][1] = arg0.method22419(-118643075);
					this.anIntArrayArray55[local31][2] = arg0.method22419(-118643075);
				}
			} else if (arg1 == 5) {
				arg0.method22415(-1434290800);
			} else if (arg1 == 6) {
				this.anInt4197 = arg0.method22413((short) 16384) * 1236877151;
			} else if (arg1 == 7) {
				this.anInt4195 = arg0.method22413((short) 16384) * -1866901877;
			} else if (arg1 == 8) {
				this.aBoolean725 = true;
			} else if (arg1 == 9) {
				this.anInt4194 = arg0.method22413((short) 16384) * -1142464977;
			} else if (arg1 == 10) {
				local24 = arg0.method22413((short) 16384);
				this.anIntArray420 = new int[local24];
				for (local31 = 0; local31 < local24; local31++) {
					this.anIntArray420[local31] = arg0.method22419(-118643075);
				}
			} else if (arg1 == 12) {
				...
				for (local31 = 0; local31 < local24; local31++) {
					this.anIntArray419[local31] = arg0.method22415(-1434290800);
				}
			} else if (arg1 == 14) {
				local24 = arg0.method22413((short) 16384);
				this.anIntArrayArray57 = new int[local24][2];
				for (local31 = 0; local31 < local24; local31++) {
					this.anIntArrayArray57[local31][0] = arg0.method22413((short) 16384);
					this.anIntArrayArray57[local31][1] = arg0.method22413((short) 16384);
				}
			} else if (arg1 == 15) {
				this.anInt4196 = arg0.method22415(-1434290800) * -1049452577;
			} else if (arg1 == 17) {
				this.anInt4198 = arg0.method22436(-603798258) * -890023447;
			} else if (arg1 == 18) {
				local24 = arg0.method22413((short) 16384);
				...
				for (local31 = 0; local31 < local24; local31++) {
					this.anIntArray421[local31] = arg0.method22419(-118643075);
					this.anIntArray422[local31] = arg0.method22419(-118643075);
					this.anIntArray418[local31] = arg0.method22419(-118643075);
					this.aStringArray27[local31] = arg0.method22427(351510910);
				}
			} else if (arg1 == 19) {
				local24 = arg0.method22413((short) 16384);
				...
				for (local31 = 0; local31 < local24; local31++) {
					this.anIntArray423[local31] = arg0.method22419(-118643075);
					this.anIntArray424[local31] = arg0.method22419(-118643075);
					this.anIntArray425[local31] = arg0.method22419(-118643075);
					this.aStringArray26[local31] = arg0.method22427(934414664);
				}
			} else if (arg1 == 249) {
				local24 = arg0.method22413((short) 16384);
				...
				for (local31 = 0; local31 < local24; local31++) {
					@Pc(432) boolean local432 = arg0.method22413((short) 16384) == 1;
					@Pc(436) int local436 = arg0.method22417((short) 22961);
					@Pc(445) Class93 local445;
					if (local432) {
						local445 = new Class93_Sub15(arg0.method22427(1469063531));
					} else {
						local445 = new Class93_Sub14(arg0.method22419(-118643075));
					}
	...
	public int method27582(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		if (this.aClass16_31 == null) {
			return arg1;
		} else {
	...
	public boolean method27583(@OriginalArg(0) Interface23 arg0, @OriginalArg(1) int arg1) {
		@Pc(4) int local4;
	...
	public boolean method27584(@OriginalArg(0) Interface23 arg0, @OriginalArg(1) int arg1) {
		@Pc(4) int local4;
		if (this.anIntArrayArray56 != null) {
			for (local4 = 0; local4 < this.anIntArrayArray56.length; local4++) {
				@Pc(21) Class108 local21 = ((Interface21) arg0).method27954(Class138.aClass138_65, this.anIntArrayArray56[local4][0], -1497248091);
	...
	public boolean method27585(@OriginalArg(0) Interface23 arg0, @OriginalArg(1) int arg1) {
		if (Class387.method28244(arg0, this.anInterface11_12, (byte) -97) < this.anInt4196 * -643441633) {
			return false;
		}
		@Pc(16) int local16;
		...
		if (this.anIntArray419 != null) {
			for (local16 = 0; local16 < this.anIntArray419.length; local16++) {
				if (!((Class347) this.anInterface11_12.method18261(this.anIntArray419[local16], 2099280735)).method27584(arg0, -311349838)) {
					return false;
				}
			}
		}
	...
	public boolean method27586(@OriginalArg(0) Interface23 arg0, @OriginalArg(1) int arg1) {
		if (this.anIntArray419 == null || arg1 < 0 || arg1 >= this.anIntArray419.length) {
			...
			return ((Class347) this.anInterface11_12.method18261(this.anIntArray419[arg1], -2072938598)).method27584(arg0, -936672811);
		}
	}

	@OriginalMember(owner = "client!ir", name = "o", descriptor = "(Lclient!ep;IB)Z", line = 231)
	public boolean method27587(@OriginalArg(0) Interface23 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		if (this.anIntArrayArray57 == null || arg1 < 0 || arg1 >= this.anIntArrayArray57.length) {
			return false;
		} else {
			return ((Interface71) arg0).method8654(this.anIntArrayArray57[arg1][0], -1445626955) >= this.anIntArrayArray57[arg1][1];
	...
	void method27588(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.aString183 = arg0.method22428(-912525942);
		} else if (arg1 == 2) {
			this.aString182 = arg0.method22428(-565154774);
		} else {
			@Pc(24) int local24;
			@Pc(31) int local31;
			if (arg1 == 3) {
				...
				this.anInt4198 = arg0.method22436(-2045806079) * -890023447;
			} else if (arg1 == 18) {
				local24 = arg0.method22413((short) 16384);
				this.anIntArray421 = new int[local24];
				this.anIntArray422 = new int[local24];
				...
				for (local31 = 0; local31 < local24; local31++) {
					...
					this.anIntArray422[local31] = arg0.method22419(-118643075);
					this.anIntArray418[local31] = arg0.method22419(-118643075);
					this.aStringArray27[local31] = arg0.method22427(133722226);
				}
			} else if (arg1 == 19) {
				local24 = arg0.method22413((short) 16384);
				this.anIntArray423 = new int[local24];
				...
				for (local31 = 0; local31 < local24; local31++) {
					...
					this.anIntArray424[local31] = arg0.method22419(-118643075);
					this.anIntArray425[local31] = arg0.method22419(-118643075);
					this.aStringArray26[local31] = arg0.method22427(1448746706);
				}
			} else if (arg1 == 249) {
				local24 = arg0.method22413((short) 16384);
				if (this.aClass16_31 == null) {
				...
				for (local31 = 0; local31 < local24; local31++) {
					@Pc(432) boolean local432 = arg0.method22413((short) 16384) == 1;
					@Pc(436) int local436 = arg0.method22417((short) -22345);
					@Pc(445) Class93 local445;
					if (local432) {
						local445 = new Class93_Sub15(arg0.method22427(1799458221));
					} else {
						local445 = new Class93_Sub14(arg0.method22419(-118643075));
					}
					this.aClass16_31.method221(local445, (long) local436);
	...
	public boolean method27589(@OriginalArg(0) Interface23 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	public boolean method27590(@OriginalArg(0) Interface23 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (this.anIntArray423 == null || arg1 < 0 || arg1 >= this.anIntArray423.length) {
			return false;
		} else {
	...
	public String method27591(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		if (this.aClass16_31 == null) {
			return arg1;
		} else {
	...
	void method27592(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.aString183 = arg0.method22428(1287601349);
		} else if (arg1 == 2) {
			this.aString182 = arg0.method22428(-1023304718);
		} else {
			@Pc(24) int local24;
			@Pc(31) int local31;
			if (arg1 == 3) {
				...
				this.anInt4198 = arg0.method22436(-1378744211) * -890023447;
			} else if (arg1 == 18) {
				local24 = arg0.method22413((short) 16384);
				this.anIntArray421 = new int[local24];
				this.anIntArray422 = new int[local24];
				...
				for (local31 = 0; local31 < local24; local31++) {
					...
					this.anIntArray422[local31] = arg0.method22419(-118643075);
					this.anIntArray418[local31] = arg0.method22419(-118643075);
					this.aStringArray27[local31] = arg0.method22427(857839923);
				}
			} else if (arg1 == 19) {
				local24 = arg0.method22413((short) 16384);
				this.anIntArray423 = new int[local24];
				...
				for (local31 = 0; local31 < local24; local31++) {
					...
					this.anIntArray424[local31] = arg0.method22419(-118643075);
					this.anIntArray425[local31] = arg0.method22419(-118643075);
					this.aStringArray26[local31] = arg0.method22427(1404255233);
				}
			} else if (arg1 == 249) {
				local24 = arg0.method22413((short) 16384);
				if (this.aClass16_31 == null) {
				...
				for (local31 = 0; local31 < local24; local31++) {
					@Pc(432) boolean local432 = arg0.method22413((short) 16384) == 1;
					@Pc(436) int local436 = arg0.method22417((short) -14654);
					@Pc(445) Class93 local445;
					if (local432) {
						local445 = new Class93_Sub15(arg0.method22427(1461964744));
					} else {
						local445 = new Class93_Sub14(arg0.method22419(-118643075));
					}
					this.aClass16_31.method221(local445, (long) local436);
	...
	void method27593(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.aString183 = arg0.method22428(-587687428);
		} else if (arg1 == 2) {
			this.aString182 = arg0.method22428(200249069);
		} else {
			@Pc(24) int local24;
			@Pc(31) int local31;
			if (arg1 == 3) {
				...
				this.anInt4198 = arg0.method22436(-1408240230) * -890023447;
			} else if (arg1 == 18) {
				local24 = arg0.method22413((short) 16384);
				this.anIntArray421 = new int[local24];
				this.anIntArray422 = new int[local24];
				...
				for (local31 = 0; local31 < local24; local31++) {
					...
					this.anIntArray422[local31] = arg0.method22419(-118643075);
					this.anIntArray418[local31] = arg0.method22419(-118643075);
					this.aStringArray27[local31] = arg0.method22427(-139085680);
				}
			} else if (arg1 == 19) {
				local24 = arg0.method22413((short) 16384);
				this.anIntArray423 = new int[local24];
				...
				for (local31 = 0; local31 < local24; local31++) {
					...
					this.anIntArray424[local31] = arg0.method22419(-118643075);
					this.anIntArray425[local31] = arg0.method22419(-118643075);
					this.aStringArray26[local31] = arg0.method22427(1027698164);
				}
			} else if (arg1 == 249) {
				local24 = arg0.method22413((short) 16384);
				if (this.aClass16_31 == null) {
				...
				for (local31 = 0; local31 < local24; local31++) {
					@Pc(432) boolean local432 = arg0.method22413((short) 16384) == 1;
					@Pc(436) int local436 = arg0.method22417((short) -3752);
					@Pc(445) Class93 local445;
					if (local432) {
						local445 = new Class93_Sub15(arg0.method22427(1023655504));
					} else {
						local445 = new Class93_Sub14(arg0.method22419(-118643075));
					}
					this.aClass16_31.method221(local445, (long) local436);
	...
	public boolean method27594(@OriginalArg(0) Interface23 arg0, @OriginalArg(1) int arg1) {
		return Class387.method28244(arg0, this.anInterface11_12, (byte) -18) >= this.anInt4196 * -643441633;
	}
	...
	void method27595(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.aString183 = arg0.method22428(2039633577);
		} else if (arg1 == 2) {
			this.aString182 = arg0.method22428(-75241078);
		} else {
			@Pc(24) int local24;
			@Pc(31) int local31;
			if (arg1 == 3) {
				...
				this.anInt4198 = arg0.method22436(-1971574842) * -890023447;
			} else if (arg1 == 18) {
				local24 = arg0.method22413((short) 16384);
				this.anIntArray421 = new int[local24];
				this.anIntArray422 = new int[local24];
				...
				for (local31 = 0; local31 < local24; local31++) {
					...
					this.anIntArray422[local31] = arg0.method22419(-118643075);
					this.anIntArray418[local31] = arg0.method22419(-118643075);
					this.aStringArray27[local31] = arg0.method22427(1318692614);
				}
			} else if (arg1 == 19) {
				local24 = arg0.method22413((short) 16384);
				this.anIntArray423 = new int[local24];
				...
				for (local31 = 0; local31 < local24; local31++) {
					...
					this.anIntArray424[local31] = arg0.method22419(-118643075);
					this.anIntArray425[local31] = arg0.method22419(-118643075);
					this.aStringArray26[local31] = arg0.method22427(440818040);
				}
			} else if (arg1 == 249) {
				local24 = arg0.method22413((short) 16384);
				if (this.aClass16_31 == null) {
				...
				for (local31 = 0; local31 < local24; local31++) {
					@Pc(432) boolean local432 = arg0.method22413((short) 16384) == 1;
					@Pc(436) int local436 = arg0.method22417((short) -8570);
					@Pc(445) Class93 local445;
					if (local432) {
						local445 = new Class93_Sub15(arg0.method22427(2131800860));
					} else {
						local445 = new Class93_Sub14(arg0.method22419(-118643075));
					}
					this.aClass16_31.method221(local445, (long) local436);
	...
	public boolean method27600(@OriginalArg(0) Interface23 arg0) {
		if (Class387.method28244(arg0, this.anInterface11_12, (byte) 82) < this.anInt4196 * -643441633) {
			return false;
		}
		@Pc(16) int local16;
		if (this.anIntArrayArray57 != null) {
		...
		if (this.anIntArray419 != null) {
			for (local16 = 0; local16 < this.anIntArray419.length; local16++) {
				if (!((Class347) this.anInterface11_12.method18261(this.anIntArray419[local16], 1683047922)).method27584(arg0, 1416347485)) {
					return false;
				}
			}
		}
	...
	public boolean method27601(@OriginalArg(0) Interface23 arg0) {
		if (Class387.method28244(arg0, this.anInterface11_12, (byte) -42) < this.anInt4196 * -643441633) {
			return false;
		}
		@Pc(16) int local16;
		if (this.anIntArrayArray57 != null) {
		...
		if (this.anIntArray419 != null) {
			for (local16 = 0; local16 < this.anIntArray419.length; local16++) {
				if (!((Class347) this.anInterface11_12.method18261(this.anIntArray419[local16], 169140713)).method27584(arg0, -282194740)) {
					return false;
				}
			}
		}
	...
	public boolean method27602(@OriginalArg(0) Interface23 arg0) {
		return Class387.method28244(arg0, this.anInterface11_12, (byte) 59) >= this.anInt4196 * -643441633;
	}
	...
	public boolean method27603(@OriginalArg(0) Interface23 arg0) {
		return Class387.method28244(arg0, this.anInterface11_12, (byte) 76) >= this.anInt4196 * -643441633;
	}
	...
	public boolean method27604(@OriginalArg(0) Interface23 arg0) {
		return Class387.method28244(arg0, this.anInterface11_12, (byte) 6) >= this.anInt4196 * -643441633;
	}
	...
	public boolean method27606(@OriginalArg(0) Interface23 arg0, @OriginalArg(1) int arg1) {
		if (this.anIntArray419 == null || arg1 < 0 || arg1 >= this.anIntArray419.length) {
			...
			return ((Class347) this.anInterface11_12.method18261(this.anIntArray419[arg1], 902489864)).method27584(arg0, 505958932);
		}
	}
	...
	public boolean method27607(@OriginalArg(0) Interface23 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		if (this.anIntArray419 == null || arg1 < 0 || arg1 >= this.anIntArray419.length) {
			return false;
		} else {
			return ((Class347) this.anInterface11_12.method18261(this.anIntArray419[arg1], 670655413)).method27584(arg0, 1249952222);
		}
	}
	...
	public boolean method27609(@OriginalArg(0) Interface23 arg0, @OriginalArg(1) int arg1) {
		if (this.anIntArray419 == null || arg1 < 0 || arg1 >= this.anIntArray419.length) {
			...
			return ((Class347) this.anInterface11_12.method18261(this.anIntArray419[arg1], 272322942)).method27584(arg0, -432716996);
		}
	}

	@OriginalMember(owner = "client!ir", name = "ao", descriptor = "([ILjava/util/LinkedList;IIFI)V", line = 533)
	static void method27610(@OriginalArg(0) int[] arg0, @OriginalArg(1) LinkedList arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float arg4, @OriginalArg(5) int arg5) {
		if (arg1.isEmpty()) {
			return;
		}
	...
	static final void method27611(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1311135778);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class32_Sub19.method17404(local16, local22, arg0, -270386490);
	}

	@OriginalMember(owner = "client!ir", name = "xe", descriptor = "(Lclient!yf;B)V", line = 9200)
	static final void method27612(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anInt5891 -= -1915563430;
	}

	@OriginalMember(owner = "client!ir", name = "aiy", descriptor = "(Lclient!yf;B)V", line = 11246)
	static final void method27613(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anInt5891 -= -1915563430;
	...
	static final void method27614(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class420.method28738(local11, local14, arg0, -717159883);
	}

	@OriginalMember(owner = "client!ir", name = "e", descriptor = "(II)Lclient!jd;", line = 13)
	static Class358 method27615(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
