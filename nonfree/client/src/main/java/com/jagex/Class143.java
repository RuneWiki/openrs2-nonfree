...
public abstract class Class143 {
	...
	static final void method11067(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class12.method188(local16, local22, false, 0, arg0);
	}

	@OriginalMember(owner = "client!po", name = "uh", descriptor = "(Lclient!yf;I)V", line = 8667)
	static final void method11064(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12);
	...
	static final void method11066(@OriginalArg(0) Class681 arg0) {
	...
	static final void method11065(@OriginalArg(0) Class681 arg0) {
	...
	abstract Class486 method11050();

	@OriginalMember(owner = "client!po", name = "n", descriptor = "(II)[B")
	abstract byte[] method11051(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!po", name = "k", descriptor = "(II)I")
	abstract int method11052(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!po", name = "m", descriptor = "(IB)V")
	abstract void method11053(@OriginalArg(0) int arg0);
