...
public class Class339 {
	...
	Class93_Sub1_Sub15 method27473(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	int method27482(@OriginalArg(0) byte arg0) {
		return this.anInt4186 * 633919245;
	}
	...
	static final void method27484(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(13) String local13 = (String) arg0.anObjectArray45[(arg0.anInt5888 -= 957530791) * 587908375];
		Class488.method29823(local13, 1178489549);
	}

	@OriginalMember(owner = "client!ij", name = "ahx", descriptor = "(Lclient!yf;I)V", line = 10885)
	static final void method27485(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method27486(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub3_1.method15401((byte) 53) ? 1 : 0;
	}

	@OriginalMember(owner = "client!ij", name = "fz", descriptor = "(Lclient!ax;B)V", line = 2325)
	static void method27487(@OriginalArg(0) Class175 arg0, @OriginalArg(1) byte arg1) {
		@Pc(5) Class93_Sub22 local5 = Class102.method2592(Class446.aClass446_51, arg0.aClass24_2, (byte) 46);
		local5.aClass93_Sub41_Sub2_1.method22510(Class255.method26008(2033898723), (byte) -58);
		local5.aClass93_Sub41_Sub2_1.method22454(client.anInt3408 * -1378711501, 2145519216);
		local5.aClass93_Sub41_Sub2_1.method22454(client.anInt3416 * 2091353777, 2128531004);
		local5.aClass93_Sub41_Sub2_1.method22510(Class51.aClass93_Sub36_1.aClass166_Sub39_1.method16343(-1923223686), (byte) -120);
		arg0.method24351(local5, -2013322142);
	}

	@OriginalMember(owner = "client!ij", name = "ef", descriptor = "(ZI)V", line = 908)
	public static void method27488(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		Class159_Sub1.aBoolean355 = arg0;
	}

	@OriginalMember(owner = "client!ij", name = "e", descriptor = "(Lclient!ig;B)V", line = 14)
	public static void method27489(@OriginalArg(0) Class337 arg0, @OriginalArg(1) byte arg1) {
