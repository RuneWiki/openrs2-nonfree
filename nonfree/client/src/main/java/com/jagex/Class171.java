...
public class Class171 {
	...
	public static void method22015(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) Class104 arg2, @OriginalArg(3) Class106 arg3, @OriginalArg(4) Class5 arg4) {
		...
		if (Class93_Sub1_Sub1.aBoolean42 && local8) {
			...
			local90 = aClass390_8.method28273(local30, client.anInt3511 * 2040043391, 78279352) + anInt3055 * 1543350707;
			@Pc(102) int local102 = aClass392_8.method28290(local41, client.anInt3512 * -817449061, (short) 255) + Class355.anInt4219 * -246562615;
			...
			aClass105_1.method7155();
			local23.method7563(arg0, local48 + local90, local102 + local48, local30 - local48 * 2, local41 - local48 * 2, Class95.anInt320 * 2016248431 | 0xFF000000, -1, 1, 1, 0, (Class100[]) null, (int[]) null, (Class96) null, 0, 0, (short) 657);
			Class269.method26273(local90, local102, local30, local41, (byte) -31);
		} else {
			...
			Class269.method26273(local48 - local326, local90 - local326, local30 + local326 + local326, local326 + local326 + local41, (byte) -75);
		}
		if (!arg1) {
			return;
		}
	...
	static boolean method22018() {
		...
		if (Class63.aClass5_2 == null) {
			if (Class633.aClass497_137.method30054(anInt3057 * 57763875, -512225963)) {
				Class63.aClass5_2 = Class157.aClass462_2.method29241(client.anInterface50_1, anInt3057 * 57763875, -698567722);
			} else {
				local1 = false;
			}
		}
		if (aClass105_Sub2_1 == null) {
			if (Class110_Sub7.aClass497_22.method30054(anInt3057 * 57763875, -512225963)) {
	...
	static final void method22019(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1804055296);
	...
	static final void method22020(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		Class320.method27240(arg0, arg0.aClass132_Sub1_Sub1_Sub1_4, -1667506080);
	}
}
