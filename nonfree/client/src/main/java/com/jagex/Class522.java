...
public class Class522 {
	...
	static final void method30358(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method30359(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) byte arg6) {
		...
		for (local24 = 0; local24 < local15; local24++) {
			...
			if (client.anInt3463 * 1819062465 == 0) {
				...
				local45 = local37.method25807(-1735621956);
				...
				if (local37.anInt3823 * -376320861 >= 0) {
					...
					if (local29.anIntArray412 != null) {
						local29 = local29.method27423(Class624.aClass120_1, Class624.aClass120_1, (short) 10080);
						if (local29 == null) {
							continue;
						}
					}
				...
				if (local24 < local3) {
					...
					local29 = ((Class132_Sub1_Sub1_Sub1_Sub1) local45).aClass336_1;
					if (local29.anIntArray412 != null) {
						local29 = local29.method27423(Class624.aClass120_1, Class624.aClass120_1, (short) 22301);
						if (local29 == null) {
							continue;
						}
					}
			...
			Class119_Sub1.method8606(local45, local45.method24275(899866876), false, 256832087);
			if (!(client.aFloatArray93[0] < 0.0F)) {
				if (local45.method19970(-1556354584)) {
					@Pc(158) Class561 local158 = local45.method19971(-2035476267);
					if (local158 != null && client.anInt3464 * -1737509433 < client.anInt3558 * -359899149) {
						@Pc(171) String local171 = local158.method31138(1181407128);
						if (Class146.aClass344_3.method27525(1181342690)) {
							local171 = Class146.aClass344_3.method27524(local171, -1422298918);
						}
				...
				@Pc(487) int local487;
				if (!local45.aBoolean453 && !local45.aClass21_5.method384((byte) 27)) {
					for (@Pc(250) Class149_Sub3 local250 = (Class149_Sub3) local45.aClass21_5.method390((short) 11585); local250 != null; local250 = (Class149_Sub3) local45.aClass21_5.method377(-1915563430)) {
						...
						if (local257 != null) {
							...
							if (local269 == null || local269.aClass286_1 == Class286.aClass286_5) {
								local288 = local263.method31751(Class694.aClass104_14, local263.anInt5487 * 816546509, (byte) 1);
								local297 = local263.method31751(Class694.aClass104_14, local263.anInt5489 * -1393086115, (byte) 1);
							} else if (Class286.aClass286_3 == local269.aClass286_1) {
								local288 = local263.method31751(Class694.aClass104_14, local263.anInt5497 * 168300879, (byte) 1);
								local297 = local263.method31751(Class694.aClass104_14, local263.anInt5496 * 857036441, (byte) 1);
							} else {
								local288 = local263.method31751(Class694.aClass104_14, local263.anInt5493 * -1920415725, (byte) 1);
								local297 = local263.method31751(Class694.aClass104_14, local263.anInt5494 * -128291419, (byte) 1);
							}
					...
					if (local29 == null) {
						...
						for (local579 = 0; local579 < local577.anIntArray242.length; local579++) {
							if (local577.anIntArray242[local579] >= 0) {
								...
								local609 = (long) (local602 << 8 | local597);
						...
						if (local688 != null && local676 != null) {
							for (local597 = 0; local597 < local688.length; local597++) {
								if (local688[local597] >= 0 && local676[local597] >= 0) {
									local297 = null;
									local609 = (long) (local676[local597] << 8 | local688[local597]);
					...
					for (local791 = 0; local791 < local789.length; local791++) {
						...
						if (local799 != null && local799.anInt3247 * 1661685955 == 1 && client.anIntArray323[local24 - local3] == local799.anInt3246 * -1095042687) {
							...
							if (local799.anInt3245 * -459319451 == 0) {
								...
								local341 = Class451.method28948((byte) 3) * 1000 / (local799.anInt3245 * -459319451) / 2;
				...
				for (local787 = 0; local787 < Class93_Sub26.aClass645_15.anInt5791 * 124516327; local787++) {
					...
					if (local791 >= 0) {
						...
						if (local979 != null && local979.anIntArray487 != null) {
							local979 = local979.method31938(Class624.aClass120_1, Class624.aClass120_1, 1711353062);
							if (local979 == null) {
					...
					if (local1029 >= 0) {
						...
						if (local1031 != null && local1031.anIntArray487 != null) {
							local1031 = local1031.method31938(Class624.aClass120_1, Class624.aClass120_1, 1874145105);
						}
					}
					if (local579 - local602 <= client.anInt3485) {
						if (local979 == null) {
							...
							local409 = local45.method24275(899866876) / 2;
							Class119_Sub1.method8606(local45, local409, false, 256832087);
							if (client.aFloatArray93[0] > -1.0F) {
								client.aFloatArray93[0] += (float) Class93_Sub26.aClass645_15.anIntArray502[local787];
								client.aFloatArray93[1] += (float) Class93_Sub26.aClass645_15.anIntArray503[local787];
								...
								local1109 = local979.method31940(Class694.aClass104_14, -361285556);
								if (local1109 != null) {
									local1117 = local1109.method18189();
									local1109.method18163(client.anIntArray332);
									local1125 = client.anIntArray332[0];
								}
								local1111 = local979.method31941(Class694.aClass104_14, -1933985931);
								if (local1111 != null) {
									local1119 = local1111.method18189();
									local1111.method18163(client.anIntArray332);
									local1127 = client.anIntArray332[0];
								}
								local1113 = local979.method31942(Class694.aClass104_14, (byte) 9);
								if (local1113 != null) {
									local1121 = local1113.method18189();
									local1113.method18163(client.anIntArray332);
								...
								if (local1308 >= 0) {
									local1320 = (Class106) Class157.aClass462_2.method29264(client.anInterface50_1, local1308, true, local979.aBoolean827, 2124283828);
									local1326 = Class157.aClass462_2.method29241(client.anInterface50_1, local1308, -400764309);
								...
								if (local1031 != null) {
									...
									if (local1308 >= 0) {
										local1320 = (Class106) Class157.aClass462_2.method29264(client.anInterface50_1, local1308, true, local1031.aBoolean827, -688283145);
										local1326 = Class157.aClass462_2.method29241(client.anInterface50_1, local1308, -1750887372);
										if (local1320 != null && local1326 != null) {
											local1299 = local1320;
											local1303 = local1326;
										}
								...
								@Pc(1385) String local1385 = local979.method31939(local45.anIntArray233[local787], -1702976900);
								@Pc(1390) int local1390 = local1301.method36(local1385, -462224048);
								if (local1031 != null) {
									local1373 = local1031.method31939(local45.anIntArray238[local787], -1796516341);
								...
								if (local1642 >= 0 && local1642 < 255) {
									...
									if (local1111 != null) {
										local1111.method18173(local979.anInt5577 * 860345421 + (local1440 + local1604 - local1127), local979.anInt5562 * 1143246755 + local1617, 0, local1674, 1);
									}
									@Pc(1717) int local1717;
									if (local1109 != null) {
										for (local1717 = 0; local1717 < local1407; local1717++) {
											local1109.method18173(local1604 + local1448 - local1125 + local1717 * local1117 + local979.anInt5577 * 860345421, local1617 + local979.anInt5562 * 1143246755, 0, local1674, 1);
										}
									}
									if (local1113 != null) {
										local1113.method18173(local979.anInt5577 * 860345421 + (local1456 + local1604 - local1129), local1617 + local979.anInt5562 * 1143246755, 0, local1674, 1);
									}
									local1297.method7524(local1385, local1604 + local1450, local1626, local979.anInt5569 * -25820427 | local1670, 0, (byte) 0);
									if (local1031 != null) {
										if (local1131 != null) {
										...
										local1299.method7524(local1373, local1491 + local1604, local1628, local1031.anInt5569 * -25820427 | local1670, 0, (byte) 0);
									}
								} else {
									if (local1158 != null) {
									...
									if (local1111 != null) {
										local1111.method18169(local979.anInt5577 * 860345421 + (local1440 + local1604 - local1127), local979.anInt5562 * 1143246755 + local1617);
									}
									if (local1109 != null) {
										for (local1670 = 0; local1670 < local1407; local1670++) {
											local1109.method18169(local1117 * local1670 + (local1448 + local1604 - local1125) + local979.anInt5577 * 860345421, local979.anInt5562 * 1143246755 + local1617);
										}
									}
									if (local1113 != null) {
										local1113.method18169(local1604 + local1456 - local1129 + local979.anInt5577 * 860345421, local979.anInt5562 * 1143246755 + local1617);
									}
									local1297.method7524(local1385, local1604 + local1450, local1626, local979.anInt5569 * -25820427 | 0xFF000000, 0, (byte) 0);
									if (local1031 != null) {
										if (local1131 != null) {
										...
										local1299.method7524(local1373, local1491 + local1604, local1628, local1031.anInt5569 * -25820427 | 0xFF000000, 0, (byte) 0);
									}
								}
							}
						}
		...
		for (local24 = 0; local24 < client.anInt3496 * -2074465939; local24++) {
			...
			Class487.method29818(local2120, local2142, (local2120.anInt2764 -= 1428902295) * -1996734937, arg0, arg1, arg2, arg3, arg4, arg5, (byte) 15);
		}
		...
		for (local2113 = 0; local2113 < client.anInt3464 * -1737509433; local2113++) {
			...
			@Pc(2284) String local2284 = client.aClass561Array1[local2113].method31138(1465611768);
			if (Class146.aClass344_3.method27525(1564065214)) {
				local2284 = Class146.aClass344_3.method27524(local2284, -1422298918);
			}
			if (client.anInt3527 * -422098273 == 0) {
				local791 = 16776960;
				local597 = client.aClass561Array1[local2113].method31141((byte) 45);
				if (local597 < 6) {
				...
				if (local597 == 9) {
					local602 = 150 - client.aClass561Array1[local2113].method31142(-1362005860) * 150 / client.aClass561Array1[local2113].method31137((byte) -4);
					if (local602 < 50) {
				...
				if (local597 == 10) {
					local602 = 150 - client.aClass561Array1[local2113].method31142(-1725833249) * 150 / client.aClass561Array1[local2113].method31137((byte) -86);
					if (local602 < 50) {
				...
				if (local597 == 11) {
					local602 = 150 - client.aClass561Array1[local2113].method31142(-262713425) * 150 / client.aClass561Array1[local2113].method31137((byte) -10);
					if (local602 < 50) {
				...
				local1029 = client.aClass561Array1[local2113].method31140((byte) 0);
				if (local1029 == 0) {
				...
				if (local1029 == 3) {
					local341 = 150 - client.aClass561Array1[local2113].method31142(-301952503) * 150 / client.aClass561Array1[local2113].method31137((byte) -21);
				...
				if (local1029 == 4) {
					local341 = 150 - client.aClass561Array1[local2113].method31142(289894391) * 150 / client.aClass561Array1[local2113].method31137((byte) 84);
				...
				if (local1029 == 5) {
					local341 = 150 - client.aClass561Array1[local2113].method31142(-2067697804) * 150 / client.aClass561Array1[local2113].method31137((byte) -24);
					local409 = 0;
					if (local341 < 25) {
	...
	static final void method30360(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
