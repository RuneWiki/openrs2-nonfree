...
public class Class33_Sub1 extends Class33 {
	...
	@OriginalMember(owner = "client!anj", name = "l", descriptor = "Ljava/lang/String;")
	static final String aString64 = "java.net.useSystemProxies";

	@OriginalMember(owner = "client!anj", name = "v", descriptor = "Ljava/net/ProxySelector;")
	final ProxySelector aProxySelector1 = ProxySelector.getDefault();

	@OriginalMember(owner = "client!anj", name = "<init>", descriptor = "()V", line = 15)
	Class33_Sub1() {
	}

	@OriginalMember(owner = "client!anj", name = "c", descriptor = "(B)Ljava/net/Socket;", line = 20)
	@Override
	public Socket method16814() throws IOException {
		@Pc(3) boolean local3 = Boolean.parseBoolean(System.getProperty("java.net.useSystemProxies"));
		if (!local3) {
			System.setProperty("java.net.useSystemProxies", "true");
		}
		@Pc(19) boolean local19 = this.anInt2366 * -766038025 == 443;
		@Pc(41) List local41;
		@Pc(63) List local63;
		try {
			local41 = this.aProxySelector1.select(new URI((local19 ? "https" : "http") + "://" + this.aString63));
			local63 = this.aProxySelector1.select(new URI((local19 ? "http" : "https") + "://" + this.aString63));
		} catch (@Pc(65) URISyntaxException local65) {
			return this.method16809();
		}
		...
		for (@Pc(82) int local82 = 0; local82 < local80.length; local82++) {
			...
			try {
				@Pc(98) Socket local98 = this.method16816(local93);
				if (local98 != null) {
					return local98;
				}
	...
	@OriginalMember(owner = "client!anj", name = "l", descriptor = "()Ljava/net/Socket;", line = 20)
	@Override
	public Socket method16815() throws IOException {
		@Pc(3) boolean local3 = Boolean.parseBoolean(System.getProperty("java.net.useSystemProxies"));
		if (!local3) {
			System.setProperty("java.net.useSystemProxies", "true");
		}
	...
	@OriginalMember(owner = "client!anj", name = "q", descriptor = "(Ljava/net/Proxy;B)Ljava/net/Socket;", line = 59)
	Socket method16816(@OriginalArg(0) Proxy arg0) throws IOException {
			...
			try {
				...
				if (local63 != null) {
					...
					if ((Boolean) local72.invoke(local63)) {
						...
						@Pc(144) String local144 = (String) local106.invoke(local63, new URL("https://" + this.aString63 + "/"), "https");
						local24 = local116 + ": " + local144;
					}
				}
			} catch (@Pc(157) Exception local157) {
			}
			return this.method16819(local18.getHostName(), local18.getPort(), local24);
		} else if (arg0.type() == Type.SOCKS) {
			@Pc(175) Socket local175 = new Socket(arg0);
			local175.connect(new InetSocketAddress(this.aString63, this.anInt2366 * -766038025));
			return local175;
		} else {
			return null;
		}
	...
	@OriginalMember(owner = "client!anj", name = "d", descriptor = "(Ljava/net/Proxy;)Ljava/net/Socket;", line = 59)
	Socket method16817(@OriginalArg(0) Proxy arg0) throws IOException {
		if (arg0.type() == Type.DIRECT) {
			return this.method16809();
		}
		@Pc(10) SocketAddress local10 = arg0.address();
	...
	@OriginalMember(owner = "client!anj", name = "s", descriptor = "(Ljava/net/Proxy;)Ljava/net/Socket;", line = 59)
	Socket method16818(@OriginalArg(0) Proxy arg0) throws IOException {
		if (arg0.type() == Type.DIRECT) {
			return this.method16809();
		}
		@Pc(10) SocketAddress local10 = arg0.address();
	...
	@OriginalMember(owner = "client!anj", name = "x", descriptor = "(Ljava/lang/String;ILjava/lang/String;I)Ljava/net/Socket;", line = 97)
	Socket method16819(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2) throws IOException {
		@Pc(5) Socket local5 = new Socket(arg0, arg1);
		local5.setSoTimeout(10000);
		@Pc(11) OutputStream local11 = local5.getOutputStream();
		if (arg2 == null) {
			local11.write(("CONNECT " + this.aString63 + ":" + this.anInt2366 * -766038025 + " HTTP/1.0\n\n").getBytes(Charset.forName("ISO-8859-1")));
		} else {
			local11.write(("CONNECT " + this.aString63 + ":" + this.anInt2366 * -766038025 + " HTTP/1.0\n" + arg2 + "\n\n").getBytes(Charset.forName("ISO-8859-1")));
		}
		local11.flush();
			...
			if (local79.startsWith("HTTP/1.0 407") || local79.startsWith("HTTP/1.1 407")) {
				...
				while (local79 != null && local101 < 50) {
					if (local79.toLowerCase().startsWith(local103)) {
						...
						@Pc(126) int local126 = local79.indexOf(32);
						if (local126 != -1) {
							local79 = local79.substring(0, local126);
						}
	...
	@OriginalMember(owner = "client!anj", name = "r", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;", line = 97)
	Socket method16820(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2) throws IOException {
		@Pc(5) Socket local5 = new Socket(arg0, arg1);
		local5.setSoTimeout(10000);
		@Pc(11) OutputStream local11 = local5.getOutputStream();
		if (arg2 == null) {
