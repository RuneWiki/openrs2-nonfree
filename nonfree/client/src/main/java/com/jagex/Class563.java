...
public class Class563 {
	...
	static void method31193(@OriginalArg(0) Class104 arg0) {
		...
		aClass100_49 = arg0.method20498(local7, 0, 128, 128, 128, 438797212);
		aClass100_47 = arg0.method20498(local4, 0, 128, 128, 128, 438797212);
	}
	...
	void method31194(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class563 arg1) {
		...
		local222.method29855((float) (this.anInt5366 / 2), (float) (this.anInt5366 / 2), (float) local216, (float) local216, 50.0F, 50000.0F, (float) arg0.method20434((byte) -86).method23736(), (float) arg0.method20434((byte) -21).method23737(), 1024.0F);
		...
		local190.method6947(local264, (Class241) null, 1);
	...
	void method31198(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class563 arg1) {
		...
		@Pc(219) Class489 local219 = arg0.method20654();
		@Pc(222) Class489 local222 = arg0.method20507();
		local222.method29855((float) (this.anInt5366 / 2), (float) (this.anInt5366 / 2), (float) local216, (float) local216, 50.0F, 50000.0F, (float) arg0.method20434((byte) -64).method23736(), (float) arg0.method20434((byte) -12).method23737(), 1024.0F);
		arg0.method20519(local222);
		@Pc(258) Class470 local258 = new Class470();
		arg0.method20516(local258);
		@Pc(264) Class470 local264 = arg0.method20508();
	...
	void method31199(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class563 arg1) {
		...
		@Pc(219) Class489 local219 = arg0.method20654();
		@Pc(222) Class489 local222 = arg0.method20507();
		local222.method29855((float) (this.anInt5366 / 2), (float) (this.anInt5366 / 2), (float) local216, (float) local216, 50.0F, 50000.0F, (float) arg0.method20434((byte) -88).method23736(), (float) arg0.method20434((byte) -58).method23737(), 1024.0F);
		arg0.method20519(local222);
		@Pc(258) Class470 local258 = new Class470();
		arg0.method20516(local258);
		@Pc(264) Class470 local264 = arg0.method20508();
	...
	void method31200(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class563 arg1) {
		...
		@Pc(219) Class489 local219 = arg0.method20654();
		@Pc(222) Class489 local222 = arg0.method20507();
		local222.method29855((float) (this.anInt5366 / 2), (float) (this.anInt5366 / 2), (float) local216, (float) local216, 50.0F, 50000.0F, (float) arg0.method20434((byte) -41).method23736(), (float) arg0.method20434((byte) -75).method23737(), 1024.0F);
		arg0.method20519(local222);
		@Pc(258) Class470 local258 = new Class470();
		arg0.method20516(local258);
		@Pc(264) Class470 local264 = arg0.method20508();
	...
	void method31201(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class563 arg1) {
		...
		local195.method29855((float) (this.anInt5366 / 2), (float) (this.anInt5366 / 2), (float) local86, (float) local86, 50.0F, 50000.0F, (float) arg0.method20434((byte) -118).method23736(), (float) arg0.method20434((byte) -78).method23737(), 1024.0F);
		...
		local149.method6947(local236, (Class241) null, 1);
	...
	boolean method31204(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(143) int local143 = Class134_Sub2.method10212(this.anInt5371, (byte) 72);
		if (local143 > arg3) {
			local143 = Class278.method26365(arg3, 423254006);
		}
		if (local143 > 512) {
			local143 = 512;
		}
		...
		if (this.aClass100_48 == null) {
			if (this.anInt5357 == 0) {
				if (Class319.anInterface24_8.method6765(Class616.aClass616_2, this.anInt5376, -1, Class609.aClass609_2, 0.7F, this.anInt5366, this.anInt5366, false, -1630596103)) {
					...
					this.aClass100_48 = arg0.method20498(local33, 0, this.anInt5366, this.anInt5366, this.anInt5366, 438797212);
				}
	...
	void method31210(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class563 arg1) {
		...
		@Pc(219) Class489 local219 = arg0.method20654();
		@Pc(222) Class489 local222 = arg0.method20507();
		local222.method29855((float) (this.anInt5366 / 2), (float) (this.anInt5366 / 2), (float) local216, (float) local216, 50.0F, 50000.0F, (float) arg0.method20434((byte) -18).method23736(), (float) arg0.method20434((byte) -13).method23737(), 1024.0F);
		arg0.method20519(local222);
		@Pc(258) Class470 local258 = new Class470();
		arg0.method20516(local258);
		@Pc(264) Class470 local264 = arg0.method20508();
	...
	void method31211(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class563 arg1) {
		...
		@Pc(192) Class489 local192 = arg0.method20654();
		@Pc(195) Class489 local195 = arg0.method20507();
		local195.method29855((float) (this.anInt5366 / 2), (float) (this.anInt5366 / 2), (float) local86, (float) local86, 50.0F, 50000.0F, (float) arg0.method20434((byte) -111).method23736(), (float) arg0.method20434((byte) -64).method23737(), 1024.0F);
		arg0.method20519(local195);
		arg0.method20516(new Class470());
		@Pc(236) Class470 local236 = new Class470();
		local236.method29385(0.0F, 0.0F, (float) (50 - local149.method6867()));
	...
	boolean method31214(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(143) int local143 = Class134_Sub2.method10212(this.anInt5371, (byte) 28);
		if (local143 > arg3) {
			local143 = Class278.method26365(arg3, 423254006);
		}
		if (local143 > 512) {
