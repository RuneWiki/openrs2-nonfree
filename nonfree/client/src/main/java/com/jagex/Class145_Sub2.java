...
public class Class145_Sub2 extends Class145 {
	...
	Class145_Sub2(@OriginalArg(0) Class104_Sub2_Sub1 arg0, @OriginalArg(1) Class400[] arg1) {
		...
		for (@Pc(19) short local19 = 0; local19 < this.aClass400Array3.length; local19++) {
			...
			for (@Pc(33) int local33 = 0; local33 < local31.method28498(); local33++) {
				@Pc(41) Class399 local41 = local31.method28499(local33);
		...
		this.aClass104_Sub2_Sub1_9.method20913(this);
	}
	...
	public void method30884() {
		...
		this.aClass104_Sub2_Sub1_9.method21127(this);
	}
	...
	void method11486() {
		if (this.aLong48 != 0L) {
			this.aClass104_Sub2_Sub1_9.method19546(this.aLong48);
			this.aLong48 = 0L;
		}
	}
