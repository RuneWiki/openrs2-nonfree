...
public class Class248 {
	...
	static int method25925(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) float arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) float[] arg6) {
		...
		if (arg1 == 0) {
			...
			@Pc(225) int local225 = Class614.method32069(local190, arg1 - 1, arg2, false, arg4, false, local213, (byte) -121);
			if (local225 == -1) {
				return 0;
			}
	...
	static int method25926(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) float arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) float[] arg6) {
		...
		if (arg1 == 0) {
			...
			@Pc(213) float[] local213 = new float[arg1 + 1];
			@Pc(225) int local225 = Class614.method32069(local190, arg1 - 1, arg2, false, arg4, false, local213, (byte) 50);
			if (local225 == -1) {
				return 0;
			}
			@Pc(232) boolean local232 = false;
	...
	static final void method25930(@OriginalArg(0) byte arg0) {
		...
		@Pc(15) Class520 local15 = client.aClass532_1.method30509(665835011);
		@Pc(61) int local61;
		if (Class429.anInt4781 * -1453926679 != 2 && Class429.anInt4781 * -1453926679 != 3 && -364465283 * Class175.anInt3306 == -1) {
			local61 = Class305.method26801(Class163.anInt2002 * -1331168249, Class270.anInt3884 * 466086187, Class512.anInt5209 * 1177442423, (byte) -75);
		...
		@Pc(34) Class611 local34 = client.aClass532_1.method30443(1774726122);
		@Pc(72) int local72;
		if (Class429.anInt4781 * -1453926679 == 3) {
			@Pc(45) Class472 local45 = Class65.aClass123_Sub1_2.method9040(1051482140).method23122(1189701933);
		...
		@Pc(168) int local168;
		if (Class429.anInt4781 * -1453926679 == 3) {
			@Pc(157) Class472 local157 = Class65.aClass123_Sub1_2.method8952((byte) -73).method21402((byte) 18);
		...
		@Pc(241) int local241;
		if (local15.method30327(local168, local179, 1206306808)) {
			local241 = Class305.method26801(Class163.anInt2002 * -1331168249, Class270.anInt3884 * 466086187, 3, (byte) -81);
		...
		if (local241 == 0 && local273 == 0 || local241 <= -client.aClass532_1.method30444(571331926) || local241 >= client.aClass532_1.method30444(-1358540408) || local273 <= -client.aClass532_1.method30474((short) 128) || local273 >= client.aClass532_1.method30474((short) 128)) {
			if (Class429.anInt4781 * -1453926679 != 3) {
				Class646.method32610(local168 + Class430.aString204 + local179 + " " + local221 + Class430.aString204 + local225 + " " + local34.anInt5623 * 270611681 + Class430.aString204 + local34.anInt5624 * -1994307635, new RuntimeException(), 674335144);
			}
			return;
		}
		@Pc(357) int local357;
	...
	static void method25931(@OriginalArg(0) Float arg0, @OriginalArg(1) Float arg1, @OriginalArg(2) int arg2) {
		@Pc(48) Float local48;
