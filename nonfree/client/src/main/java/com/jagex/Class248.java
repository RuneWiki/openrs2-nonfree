...
public class Class248 {
	...
	static int method25925(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) float arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) float[] arg6) {
		...
		if (arg1 == 0) {
			...
			@Pc(225) int local225 = Class614.method32069(local190, arg1 - 1, arg2, false, arg4, false, local213);
			if (local225 == -1) {
				return 0;
			}
			...
			for (@Pc(240) int local240 = 0; local240 <= local225; local240++) {
				...
				if (local240 == 0) {
					local253 = arg2;
					local259 = Class368.method27962(local41, arg1, arg2);
					if (Math.abs(local259) <= local30 && arg3) {
						arg6[local43++] = arg2;
					}
				} else {
					local253 = local238;
				...
				local234 = Class368.method27962(local41, arg1, local238);
				if (local232) {
					local232 = false;
				...
				} else if (local259 < 0.0F && local234 > 0.0F || local259 > 0.0F && local234 < 0.0F) {
					arg6[local43++] = Class81.method1379(local185, local253, local238, 0.0F);
	...
	static int method25926(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) float arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) float[] arg6) {
		@Pc(1) float local1 = 0.0F;
		for (@Pc(3) int local3 = 0; local3 < arg1 + 1; local3++) {
			local1 += Math.abs(arg0[local3]);
		}
	...
	static float method25924(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2) {
	...
	static float method25927(@OriginalArg(0) Class248 arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3) {
		@Pc(9) float local9 = Class368.method27962(arg0.aFloatArray102, arg0.anInt3838 * 491727461, arg1);
		if (Math.abs(local9) < Class221.aFloat261) {
			return arg1;
		}
		@Pc(26) float local26 = Class368.method27962(arg0.aFloatArray102, arg0.anInt3838 * 491727461, arg2);
		...
		do {
			...
			if (local107) {
				...
				local26 = Class368.method27962(arg0.aFloatArray102, arg0.anInt3838 * 491727461, arg2);
	...
	static void method25931(@OriginalArg(0) Float arg0, @OriginalArg(1) Float arg1) {
		@Pc(48) Float local48;
	...
	static final void method25930() {
		client.aBoolean637 = false;
		if (Class512.anInt5209 * 1177442423 == 3) {
			return;
		}
		@Pc(11) Class472 local11 = Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.method24229().aClass472_61;
		@Pc(15) Class520 local15 = client.aClass532_1.method30509();
		@Pc(61) int local61;
		if (Class429.anInt4781 * -1453926679 != 2 && Class429.anInt4781 * -1453926679 != 3 && -364465283 * Class175.anInt3306 == -1) {
			local61 = Class305.method26801(Class163.anInt2002 * -1331168249, Class270.anInt3884 * 466086187, Class512.anInt5209 * 1177442423);
		...
		if (Class429.anInt4781 * -1453926679 == 3) {
			@Pc(45) Class472 local45 = Class65.aClass123_Sub1_2.method9040().method23122();
		...
		@Pc(168) int local168;
		if (Class429.anInt4781 * -1453926679 == 3) {
			@Pc(157) Class472 local157 = Class65.aClass123_Sub1_2.method8952().method21402();
		...
		@Pc(241) int local241;
		if (local15.method30327(local168, local179)) {
			local241 = Class305.method26801(Class163.anInt2002 * -1331168249, Class270.anInt3884 * 466086187, 3);
		...
		if (local241 == 0 && local273 == 0 || local241 <= -client.aClass532_1.method30444() || local241 >= client.aClass532_1.method30444() || local273 <= -client.aClass532_1.method30474() || local273 >= client.aClass532_1.method30474()) {
			if (Class429.anInt4781 * -1453926679 != 3) {
				Class646.method32610(local168 + Class430.aString204 + local179 + " " + local221 + Class430.aString204 + local225 + " " + local34.anInt5623 * 270611681 + Class430.aString204 + local34.anInt5624 * -1994307635, new RuntimeException());
			}
			return;
		}
		@Pc(357) int local357;
