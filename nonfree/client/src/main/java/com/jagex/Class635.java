...
public class Class635 implements Interface70 {
	...
	public void method32526(@OriginalArg(0) byte arg0) {
		...
		@Pc(12) byte[] local12 = this.aClass497_138.method30059(this.anInt5726 * -1942162375, (byte) 69);
		if (local12 == null) {
			return;
		}
	...
	public void method32533(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
		...
		synchronized (this.aClass240_90) {
			@Pc(28) List local28 = this.method32436((short) 17626);
			if (local28 != null) {
				local28.add(arg0);
				this.anInt5727 += arg0.aByteArray58.length * -165190447;
				this.method32435(local28, this.anInt5727 * -635997135, -1054317847);
			}
		}
	}
	...
	public Class539 method32543() {
		...
		local5.method30787(this, 1525624453);
		return local5;
	}
	...
	public boolean method32536(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		synchronized (this.aClass240_90) {
			@Pc(16) List local16 = this.method32436((short) 19137);
	...
	public int method32537(@OriginalArg(0) byte arg0) {
		...
		synchronized (this.aClass240_90) {
			@Pc(15) List local15 = this.method32436((short) 21488);
			if (local15 != null) {
				local6 = local15.size();
			}
			return local6;
	...
	public Class93_Sub41 method32534(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		synchronized (this.aClass240_90) {
			@Pc(24) List local24 = this.method32436((short) 32662);
	...
	public boolean method32547(@OriginalArg(0) short arg0) {
		...
		@Pc(9) List local9 = this.method32436((short) 7701);
	...
	void method32435(@OriginalArg(0) List arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		synchronized (this.aClass240_90) {
			...
			if (arg1 <= this.aClass240_90.method25834(1769254186)) {
				this.aClass240_90.method25831(arg0, (long) (this.anInt5726 * -1942162375), arg1, -1397003721);
			} else {
	...
	List method32436(@OriginalArg(0) short arg0) {
		...
		synchronized (this.aClass240_90) {
			local10 = (List) this.aClass240_90.method25839((long) (this.anInt5726 * -1942162375));
			if (local10 == null && this.aBoolean853) {
				local10 = new ArrayList();
				this.aClass240_90.method25831(local10, (long) (this.anInt5726 * -1942162375), 0, -1964857712);
			}
			return local10;
		}
	}
	...
	public void method32553() {
		...
		@Pc(12) byte[] local12 = this.aClass497_138.method30059(this.anInt5726 * -1942162375, (byte) 127);
		if (local12 == null) {
			return;
		}
		this.aByteArray112 = local12;
	...
	public Class93_Sub41 method32557(@OriginalArg(0) int arg0) {
		...
		@Pc(19) Class240 local19 = this.aClass240_90;
		synchronized (this.aClass240_90) {
			@Pc(24) List local24 = this.method32436((short) 6573);
			if (local24.size() > arg0) {
				local7 = (Class93_Sub41) local24.get(arg0);
			}
			return local7;
	...
	public Class539 method32542() {
		@Pc(5) Class539 local5 = new Class539(this.aClass146_4);
		local5.method30787(this, 1424618299);
		return local5;
	}
	...
	public Class539 method32544() {
		@Pc(5) Class539 local5 = new Class539(this.aClass146_4);
		local5.method30787(this, 1525237172);
		return local5;
	}
	...
	public Class539 method32545() {
		@Pc(5) Class539 local5 = new Class539(this.aClass146_4);
		local5.method30787(this, 2120323682);
		return local5;
	}
	...
	public Class93_Sub41 method32528(@OriginalArg(0) int arg0) {
		...
		@Pc(19) Class240 local19 = this.aClass240_90;
		synchronized (this.aClass240_90) {
			@Pc(24) List local24 = this.method32436((short) 3000);
			if (local24.size() > arg0) {
				local7 = (Class93_Sub41) local24.get(arg0);
			}
			return local7;
	...
	public void method32541() {
		...
		@Pc(12) byte[] local12 = this.aClass497_138.method30059(this.anInt5726 * -1942162375, (byte) 27);
		if (local12 == null) {
			return;
		}
		this.aByteArray112 = local12;
	...
	public int method32566() {
		...
		@Pc(10) Class240 local10 = this.aClass240_90;
		synchronized (this.aClass240_90) {
			@Pc(15) List local15 = this.method32436((short) 22073);
			if (local15 != null) {
				local6 = local15.size();
			}
			return local6;
	...
	public Class93_Sub41 method32569(@OriginalArg(0) int arg0) {
		...
		@Pc(19) Class240 local19 = this.aClass240_90;
		synchronized (this.aClass240_90) {
			@Pc(24) List local24 = this.method32436((short) 30064);
			if (local24.size() > arg0) {
				local7 = (Class93_Sub41) local24.get(arg0);
			}
			return local7;
	...
	public Class93_Sub41 method32571(@OriginalArg(0) int arg0) {
		...
		@Pc(19) Class240 local19 = this.aClass240_90;
		synchronized (this.aClass240_90) {
			@Pc(24) List local24 = this.method32436((short) 18943);
			if (local24.size() > arg0) {
				local7 = (Class93_Sub41) local24.get(arg0);
			}
			return local7;
	...
	public Class539 method32540(@OriginalArg(0) byte arg0) {
		@Pc(5) Class539 local5 = new Class539(this.aClass146_4);
		local5.method30787(this, 1178249081);
		return local5;
	}
	...
	public boolean method32560(@OriginalArg(0) int arg0) {
		...
		@Pc(11) Class240 local11 = this.aClass240_90;
		synchronized (this.aClass240_90) {
			@Pc(16) List local16 = this.method32436((short) 13443);
			if (local16 != null && local16.size() > arg0) {
				local7 = local16.get(arg0) != null;
			}
			return local7;
	...
	public boolean method32561(@OriginalArg(0) int arg0) {
		...
		@Pc(11) Class240 local11 = this.aClass240_90;
		synchronized (this.aClass240_90) {
			@Pc(16) List local16 = this.method32436((short) 30594);
			if (local16 != null && local16.size() > arg0) {
				local7 = local16.get(arg0) != null;
			}
			return local7;
	...
	public boolean method32563(@OriginalArg(0) int arg0) {
		...
		@Pc(11) Class240 local11 = this.aClass240_90;
		synchronized (this.aClass240_90) {
			@Pc(16) List local16 = this.method32436((short) 32096);
			if (local16 != null && local16.size() > arg0) {
				local7 = local16.get(arg0) != null;
			}
			return local7;
	...
	public int method32525() {
		...
		@Pc(10) Class240 local10 = this.aClass240_90;
		synchronized (this.aClass240_90) {
			@Pc(15) List local15 = this.method32436((short) 11802);
			if (local15 != null) {
				local6 = local15.size();
			}
			return local6;
	...
	public int method32580() {
		...
		@Pc(10) Class240 local10 = this.aClass240_90;
		synchronized (this.aClass240_90) {
			@Pc(15) List local15 = this.method32436((short) 19748);
			if (local15 != null) {
				local6 = local15.size();
			}
			return local6;
	...
	public boolean method32562(@OriginalArg(0) int arg0) {
		...
		@Pc(11) Class240 local11 = this.aClass240_90;
		synchronized (this.aClass240_90) {
			@Pc(16) List local16 = this.method32436((short) 17677);
			if (local16 != null && local16.size() > arg0) {
				local7 = local16.get(arg0) != null;
			}
			return local7;
	...
	public boolean method32573() {
		...
		@Pc(9) List local9 = this.method32436((short) 12691);
		if (local9 == null || local9.size() <= 0) {
			this.aBoolean852 = false;
		}
		return this.aBoolean852;
	...
	List method32438() {
		...
		synchronized (this.aClass240_90) {
			...
			if (local10 == null && this.aBoolean853) {
				local10 = new ArrayList();
				this.aClass240_90.method25831(local10, (long) (this.anInt5726 * -1942162375), 0, -972207965);
			}
			return local10;
		}
	}
	...
	public boolean method32572() {
		...
		@Pc(9) List local9 = this.method32436((short) 18561);
		if (local9 == null || local9.size() <= 0) {
			this.aBoolean852 = false;
		}
		return this.aBoolean852;
	...
	public void method32555(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		@Pc(23) Class240 local23 = this.aClass240_90;
		synchronized (this.aClass240_90) {
			@Pc(28) List local28 = this.method32436((short) 5618);
			if (local28 != null) {
				local28.add(arg0);
				this.anInt5727 += arg0.aByteArray58.length * -165190447;
				this.method32435(local28, this.anInt5727 * -635997135, -1054317847);
	...
	public boolean method32574() {
		...
		@Pc(9) List local9 = this.method32436((short) 27150);
		if (local9 == null || local9.size() <= 0) {
			this.aBoolean852 = false;
		}
		return this.aBoolean852;
	...
	static final void method32439(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		if (Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aClass658_1 != null) {
			Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aClass658_1.method32788(local13, local23, (byte) -104);
		}
	}

	@OriginalMember(owner = "client!we", name = "bfe", descriptor = "(Lclient!yf;I)V", line = 15160)
	static final void method32440(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static void method32441(@OriginalArg(0) short arg0) {
	...
	static final void method32442(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
