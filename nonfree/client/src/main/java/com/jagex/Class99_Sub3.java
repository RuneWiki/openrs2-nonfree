...
public class Class99_Sub3 extends Class99 {
				...
				for (local282 = 0; local282 < this.aClass93Array3.length; local282++) {
					...
					if (local293.anInt1541 != 0) {
						...
						if (local293.anInt1538 == -1) {
							...
							local399 = !Class588.method31649(local411.aByte114, (byte) 10);
						}
				...
				for (local282 = 0; local282 < this.aClass93Array3.length; local282++) {
					...
					if (local293.anInt1541 > 0) {
						...
						switch(local693) {
							...
							case 8:
							case 9:
								if (this.aClass104_Sub2_2.aBoolean462 || (this.anInt419 & 0x8) == 0 || !this.aClass104_Sub2_2.aClass128_Sub1_Sub1_6.method19642(-1171661504)) {
							...
							default:
								...
								break;
							case 6:
								local161.method10102(!Class588.method31649(local693, (byte) 10));
								break;
							case 7:
								local161.aClass472_39.method29537(this.aClass104_Sub2_2.aClass489_72.aFloatArray116[12], this.aClass104_Sub2_2.aClass489_72.aFloatArray116[13], this.aClass104_Sub2_2.aClass489_72.aFloatArray116[14]);
	...
	public void method2490(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean[][] arg7) {
		...
		@Pc(143) float local143 = (float) this.aClass104_Sub2_2.method20434((byte) -56).method23736();
		@Pc(150) float local150 = (float) this.aClass104_Sub2_2.method20434((byte) -55).method23737();
	...
	void method2517() {
		if ((this.anInt418 & 0x2) == 0) {
			this.anIntArrayArrayArray8 = (int[][][]) null;
			this.anIntArrayArrayArray11 = (int[][][]) null;
			this.anIntArrayArrayArray12 = (int[][][]) null;
		}
		this.anIntArrayArrayArray10 = (int[][][]) null;
		this.anIntArrayArrayArray7 = (int[][][]) null;
		this.anIntArrayArrayArray9 = (int[][][]) null;
		this.aClass93_Sub18ArrayArrayArray1 = (Class93_Sub18[][][]) null;
		this.aByteArrayArray9 = (byte[][]) null;
		this.aClass16_5 = null;
		this.aClass93Array4 = null;
		this.aFloatArrayArray5 = (float[][]) null;
		this.aFloatArrayArray6 = (float[][]) null;
		this.aFloatArrayArray4 = (float[][]) null;
	}
				...
				for (local282 = 0; local282 < this.aClass93Array3.length; local282++) {
					...
					if (local293.anInt1541 > 0) {
						...
						switch(local693) {
							...
							case 8:
							case 9:
								if (this.aClass104_Sub2_2.aBoolean462 || (this.anInt419 & 0x8) == 0 || !this.aClass104_Sub2_2.aClass128_Sub1_Sub1_6.method19642(-1338897291)) {
									local161.method10103(0);
								} else {
									@Pc(834) Class128_Sub1_Sub1 local834 = this.aClass104_Sub2_2.aClass128_Sub1_Sub1_6;
									if (local693 == 2) {
	...
	public void method2479(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean[][] arg7) {
		...
		this.aClass104_Sub2_2.method21030(local9);
		this.aClass104_Sub2_2.method20516(Class470.aClass470_54);
		@Pc(143) float local143 = (float) this.aClass104_Sub2_2.method20434((byte) -51).method23736();
		@Pc(150) float local150 = (float) this.aClass104_Sub2_2.method20434((byte) -7).method23737();
		@Pc(154) Class470 local154 = new Class470();
		@Pc(158) Class470 local158 = new Class470();
		local154.method29370(1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, 0.0F);
		local158.method29420((float) arg2 / ((float) (this.anInt412 * -1678286317) * 256.0F), (float) -arg2 / ((float) (this.anInt412 * -1678286317) * 256.0F), 1.0F / (this.aFloat24 - this.aFloat23));
	...
	public void method2492() {
		...
		local32 = Class278.method26365(this.anInt423 / 4, 423254006);
		if (local32 < 1) {
			local32 = 1;
		}
		...
		Class659.method32813(local436, this.aClass93Array3, -2082159576);
		this.method2516();
	}
	...
	public void method2508() {
		...
		Class659.method32813(local436, this.aClass93Array3, -392639590);
		this.method2516();
	}
				...
				for (local282 = 0; local282 < this.aClass93Array3.length; local282++) {
					...
					if (local293.anInt1541 > 0) {
						...
						switch(local693) {
							...
							case 8:
							case 9:
								if (this.aClass104_Sub2_2.aBoolean462 || (this.anInt419 & 0x8) == 0 || !this.aClass104_Sub2_2.aClass128_Sub1_Sub1_6.method19642(-1595083094)) {
									local161.method10103(0);
								} else {
									@Pc(834) Class128_Sub1_Sub1 local834 = this.aClass104_Sub2_2.aClass128_Sub1_Sub1_6;
									if (local693 == 2) {
	...
	public void method2493() {
		...
		Class659.method32813(local436, this.aClass93Array3, -1045554615);
		this.method2516();
	}
	...
	public void method2504(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean[][] arg7) {
		...
		this.aClass104_Sub2_2.method21030(local9);
		this.aClass104_Sub2_2.method20516(Class470.aClass470_54);
		@Pc(143) float local143 = (float) this.aClass104_Sub2_2.method20434((byte) -93).method23736();
		@Pc(150) float local150 = (float) this.aClass104_Sub2_2.method20434((byte) -35).method23737();
		@Pc(154) Class470 local154 = new Class470();
		@Pc(158) Class470 local158 = new Class470();
		local154.method29370(1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, 0.0F);
		local158.method29420((float) arg2 / ((float) (this.anInt412 * -1678286317) * 256.0F), (float) -arg2 / ((float) (this.anInt412 * -1678286317) * 256.0F), 1.0F / (this.aFloat24 - this.aFloat23));
		...
		for (@Pc(148) int local148 = 0; local148 <= this.anInt413 * -143202029; local148++) {
			for (@Pc(156) int local156 = 0; local156 <= this.anInt414 * -1667858293; local156++) {
				...
				if ((float) local169 < this.aFloat23) {
					this.aFloat23 = (float) local169;
				}
				if ((float) local169 > this.aFloat24) {
					this.aFloat24 = (float) local169;
				}
