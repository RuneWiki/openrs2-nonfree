...
class Class583 implements Runnable {
		...
		label36: while (true) {
			try {
				if (!this.this$0.aBoolean260) {
					@Pc(9) HashMap local9 = this.this$0.method11705(1158979694);
					...
					while (true) {
						...
						@Pc(30) Class535[] local30 = (Class535[]) (Class535[]) local9.get(local20);
						for (@Pc(32) int local32 = 0; local32 < local30.length; local32++) {
							local30[local32].method30655((byte) -81);
						}
					}
				}
			} catch (@Pc(49) Exception local49) {
				Class646.method32610((String) null, local49, 1294458701);
	...
	public void method31418() {
		label36: while (true) {
			try {
				if (!this.this$0.aBoolean260) {
					@Pc(9) HashMap local9 = this.this$0.method11705(-736748072);
					@Pc(13) Iterator local13 = local9.keySet().iterator();
					while (true) {
						@Pc(20) Class508 local20;
						do {
						...
						@Pc(30) Class535[] local30 = (Class535[]) (Class535[]) local9.get(local20);
						for (@Pc(32) int local32 = 0; local32 < local30.length; local32++) {
							local30[local32].method30655((byte) -14);
						}
					}
				}
			} catch (@Pc(49) Exception local49) {
				Class646.method32610((String) null, local49, 996341212);
				local49.printStackTrace();
			}
			return;
		}
	...
	public void method31419() {
		label36: while (true) {
			try {
				if (!this.this$0.aBoolean260) {
					@Pc(9) HashMap local9 = this.this$0.method11705(518425303);
					@Pc(13) Iterator local13 = local9.keySet().iterator();
					while (true) {
						@Pc(20) Class508 local20;
						do {
						...
						@Pc(30) Class535[] local30 = (Class535[]) (Class535[]) local9.get(local20);
						for (@Pc(32) int local32 = 0; local32 < local30.length; local32++) {
							local30[local32].method30655((byte) -87);
						}
					}
				}
			} catch (@Pc(49) Exception local49) {
				Class646.method32610((String) null, local49, 918568613);
				local49.printStackTrace();
			}
			return;
		}
	...
	public void method31420() {
		label36: while (true) {
			try {
				if (!this.this$0.aBoolean260) {
					@Pc(9) HashMap local9 = this.this$0.method11705(903810676);
					@Pc(13) Iterator local13 = local9.keySet().iterator();
					while (true) {
						@Pc(20) Class508 local20;
						do {
						...
						@Pc(30) Class535[] local30 = (Class535[]) (Class535[]) local9.get(local20);
						for (@Pc(32) int local32 = 0; local32 < local30.length; local32++) {
							local30[local32].method30655((byte) -22);
						}
					}
				}
			} catch (@Pc(49) Exception local49) {
				Class646.method32610((String) null, local49, 932750638);
				local49.printStackTrace();
			}
			return;
		}
	...
	public void run() {
		label36: while (true) {
			try {
				if (!this.this$0.aBoolean260) {
					@Pc(9) HashMap local9 = this.this$0.method11705(-829700731);
					@Pc(13) Iterator local13 = local9.keySet().iterator();
					while (true) {
						@Pc(20) Class508 local20;
						do {
						...
						@Pc(30) Class535[] local30 = (Class535[]) (Class535[]) local9.get(local20);
						for (@Pc(32) int local32 = 0; local32 < local30.length; local32++) {
							local30[local32].method30655((byte) -71);
						}
					}
				}
			} catch (@Pc(49) Exception local49) {
				Class646.method32610((String) null, local49, 265550361);
				local49.printStackTrace();
			}
			return;
		}
	...
	static final void method31421(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) throws Exception_Sub3 {
	...
	static final void method31422(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		Class453.method28965(local11, local14, arg0, arg0.aClass93_Sub28_4 == Class121.aClass93_Sub28_2 ? Class310.aClass310_5 : Class310.aClass310_1, (byte) -1);
	}
	...
	static final void method31424(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		if (arg0.anInt3971 * -158526639 == 0) {
			Class548.method31016(arg1, arg0, false, 1059373588);
		}
	}
}
