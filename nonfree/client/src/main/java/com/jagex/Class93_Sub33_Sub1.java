...
public abstract class Class93_Sub33_Sub1 extends Class93_Sub33 {
	...
	public Class323 method23650() {
		return this.aClass323_6;
	}

	@OriginalMember(owner = "client!aql", name = "e", descriptor = "(I)Z")
	public abstract boolean method23651(@OriginalArg(0) int arg0);
	...
	public abstract int method23656(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!aql", name = "l", descriptor = "(I)Z")
	public abstract boolean method23657(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!aql", name = "u", descriptor = "(I)Z")
	public abstract boolean method23658(@OriginalArg(0) int arg0);
	...
	String method23663(@OriginalArg(0) int arg0) {
	...
	public abstract int method23665(@OriginalArg(0) int arg0);
