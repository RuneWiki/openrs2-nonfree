...
public class Class431 {
	...
	void method28766(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt4798 = arg0.method22415(-1434290800) * -1773110991;
		} else if (arg1 == 2) {
			arg0.method22413((short) 16384);
		} else if (arg1 == 3) {
			this.anInt4794 = arg0.method22419(-118643075) * -1190025807;
			this.anInt4795 = arg0.method22419(-118643075) * 683389527;
			this.anInt4796 = arg0.method22419(-118643075) * 260864033;
		} else if (arg1 == 4) {
			this.anInt4800 = arg0.method22413((short) 16384) * -492674485;
			this.anInt4799 = arg0.method22419(-118643075) * -897187131;
		} else if (arg1 == 6) {
			this.anInt4792 = arg0.method22413((short) 16384) * 2134056573;
		} else if (arg1 == 8) {
	...
	void method28767(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		while (true) {
			@Pc(3) int local3 = arg0.method22413((short) 16384);
			if (local3 == 0) {
				return;
			}
			this.method28768(arg0, local3, 660021917);
		}
	}

	@OriginalMember(owner = "client!na", name = "n", descriptor = "(Lclient!alw;II)V", line = 43)
	void method28768(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg1 == 1) {
			this.anInt4798 = arg0.method22415(-1434290800) * -1773110991;
		} else if (arg1 == 2) {
			arg0.method22413((short) 16384);
	...
	void method28769(@OriginalArg(0) byte arg0) {
	...
	void method28770(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			@Pc(3) int local3 = arg0.method22413((short) 16384);
			if (local3 == 0) {
				return;
			}
			this.method28768(arg0, local3, 1907368799);
		}
	}

	@OriginalMember(owner = "client!na", name = "f", descriptor = "(Lclient!alw;)V", line = 36)
	void method28771(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			@Pc(3) int local3 = arg0.method22413((short) 16384);
			if (local3 == 0) {
				return;
			}
			this.method28768(arg0, local3, -333907352);
		}
	}
	...
	void method28772(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt4798 = arg0.method22415(-1434290800) * -1773110991;
		} else if (arg1 == 2) {
			arg0.method22413((short) 16384);
	...
	static void method28774(@OriginalArg(0) byte arg0) {
			...
			while (true) {
				while (true) {
					...
					if (local9 != null && Class125_Sub3.aCanvas1.isShowing() && Class20.aBoolean10) {
						local16.method22897(local9, 1989476160);
						if (!local16.method22896(133063708) && local16.method22873(-1678286317) < Class553.anInt3408 * -1378711501 && local16.method22874((byte) -67) < Class553.anInt3416 * 2091353777 && local16.method22873(-1678286317) >= 0 && local16.method22874((byte) -67) >= 0) {
							@Pc(67) int local67 = local16.method22890(-1553844929);
							if (local16.method22890(848223835) == -1) {
								Class655.aClass163_Sub1_1.method14903(local16, 1650852741);
							} else if (Class64.method1163(local67, -253175961)) {
								Class655.aClass163_Sub1_1.method14845(local16, (byte) 2);
							}
						}
					} else {
						local16.method22877((byte) -87);
					}
				}
			}
		}
	...
	static final void method28775(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method28776(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!na", name = "vg", descriptor = "(Lclient!yf;B)V", line = 8843)
	static final void method28777(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		local18.aClass93_Sub41_Sub2_1.method22454(local12, 2131625847);
		client.aClass175_2.method24351(local18, -1807660685);
	}
	...
	static final void method28778(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, -379497974);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class453.method28968(local16, local22, arg0, (short) 22262);
	}

	@OriginalMember(owner = "client!na", name = "jz", descriptor = "(Lclient!hq;Lclient!hf;I)Lclient!hf;", line = 10846)
	public static final Class312 method28779(@OriginalArg(0) Class320 arg0, @OriginalArg(1) Class312 arg1, @OriginalArg(2) int arg2) {
		if (arg1.anInt3985 * 897022795 != -1) {
			return arg0.method27228(arg1.anInt3985 * 897022795, 266839489);
		}
		if (!arg0.aBoolean708) {
			...
			for (@Pc(33) Class93_Sub40 local33 = (Class93_Sub40) local28.method160((byte) 45); local33 != null; local33 = (Class93_Sub40) local28.next()) {
				if (local23 == local33.anInt3172 * 1220811495) {
					return Class659.method32805((int) (local33.aLong232 * -3750704643647536275L), 62779510);
				}
			}
		}
		return null;
	...
	static final void method28780(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 326303476);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class257.method26022(local16, local22, arg0, (byte) 72);
	}

	@OriginalMember(owner = "client!na", name = "k", descriptor = "(IIZB)I", line = 58)
	public static int method28781(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) byte arg3) {
		@Pc(4) Class93_Sub6 local4 = Class557.method31065(arg0, arg2, (short) 255);
		if (local4 == null) {
			return 0;
		} else if (arg1 == -1) {
			return 0;
	...
	static void method28782(@OriginalArg(0) byte arg0) {
