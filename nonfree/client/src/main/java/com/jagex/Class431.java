...
public class Class431 {
	...
	void method28766(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt4798 = arg0.method22415() * -1773110991;
		} else if (arg1 == 2) {
			arg0.method22413();
		} else if (arg1 == 3) {
			this.anInt4794 = arg0.method22419() * -1190025807;
			this.anInt4795 = arg0.method22419() * 683389527;
			this.anInt4796 = arg0.method22419() * 260864033;
		} else if (arg1 == 4) {
			this.anInt4800 = arg0.method22413() * -492674485;
			this.anInt4799 = arg0.method22419() * -897187131;
		} else if (arg1 == 6) {
			this.anInt4792 = arg0.method22413() * 2134056573;
		} else if (arg1 == 8) {
	...
	void method28768(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt4798 = arg0.method22415() * -1773110991;
		} else if (arg1 == 2) {
			arg0.method22413();
	...
	public static int method28781(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
					...
					if (local9 != null && Class125_Sub3.aCanvas1.isShowing() && Class20.aBoolean10) {
						...
						if (!local16.method22896() && local16.method22873() < Class553.anInt3408 * -1378711501 && local16.method22874() < Class553.anInt3416 * 2091353777 && local16.method22873() >= 0 && local16.method22874() >= 0) {
							...
							if (local16.method22890() == -1) {
								Class655.aClass163_Sub1_1.method14903(local16);
							} else if (Class64.method1163(local67)) {
								Class655.aClass163_Sub1_1.method14845(local16);
							}
						}
					} else {
						local16.method22877();
	...
	static void method28782() {
		...
		Class159_Sub1.aClass16_15.method219();
		Class159_Sub1.aClass16_16.method219();
	...
	static final void method28780(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class257.method26022(local16, local22, arg0);
	}

	@OriginalMember(owner = "client!na", name = "fp", descriptor = "(Lclient!yf;I)V", line = 5957)
	static final void method28778(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class453.method28968(local16, local22, arg0);
	}

	@OriginalMember(owner = "client!na", name = "vg", descriptor = "(Lclient!yf;B)V", line = 8843)
	static final void method28777(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(18) Class93_Sub22 local18 = Class102.method2592(Class446.aClass446_101, client.aClass175_2.aClass24_2);
		local18.aClass93_Sub41_Sub2_1.method22454(local12);
		client.aClass175_2.method24351(local18);
	}

	@OriginalMember(owner = "client!na", name = "jz", descriptor = "(Lclient!hq;Lclient!hf;I)Lclient!hf;", line = 10846)
	public static final Class312 method28779(@OriginalArg(0) Class320 arg0, @OriginalArg(1) Class312 arg1) {
		if (arg1.anInt3985 * 897022795 != -1) {
			return arg0.method27228(arg1.anInt3985 * 897022795);
		}
		if (!arg0.aBoolean708) {
			@Pc(23) int local23 = arg1.anInt3953 * -1549590237 >>> 16;
			@Pc(28) Class10 local28 = new Class10(client.aClass16_22);
			for (@Pc(33) Class93_Sub40 local33 = (Class93_Sub40) local28.method160(); local33 != null; local33 = (Class93_Sub40) local28.next()) {
				if (local23 == local33.anInt3172 * 1220811495) {
					return Class659.method32805((int) (local33.aLong232 * -3750704643647536275L));
				}
			}
		}
		return null;
	...
	static final void method28775(@OriginalArg(0) Class681 arg0) {
		Class32_Sub7.method16823((String) arg0.anObjectArray45[(arg0.anInt5888 -= 957530791) * 587908375], false, false);
	}

	@OriginalMember(owner = "client!na", name = "azp", descriptor = "(Lclient!yf;I)V", line = 14213)
	static final void method28776(@OriginalArg(0) Class681 arg0) {
