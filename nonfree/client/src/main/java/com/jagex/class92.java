	...
	public boolean method1362() {
		...
		if (this.field1173) {
			if (this.field1163 == null) {
				...
				this.field1162.method15441((class126) null);
				this.field1162.method15439(0, (class130) null);
				this.field1162.method15439(1, (class130) null);
				...
				this.field1163.method15441((class126) null);
				this.field1163.method15439(0, (class130) null);
