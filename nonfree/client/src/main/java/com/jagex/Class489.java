...
public final class Class489 {
	...
	void method29832(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) boolean arg1) {
		if (!arg1) {
			for (@Pc(43) int local43 = 0; local43 < 16; local43++) {
				this.aFloatArray116[local43] = arg0.method22425(-1580746208);
			}
			return;
		}
		@Pc(5) Class470 local5 = new Class470();
		local5.method29376(Class464.method29282(arg0.method22482((byte) -74)));
		local5.method29377(Class464.method29282(arg0.method22482((byte) -63)));
		local5.method29378(Class464.method29282(arg0.method22482((byte) -52)));
		local5.method29387((float) arg0.method22482((byte) -48), (float) arg0.method22482((byte) -80), (float) arg0.method22482((byte) -55));
	...
	void method29833(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) boolean arg1) {
		if (!arg1) {
			for (@Pc(43) int local43 = 0; local43 < 16; local43++) {
				this.aFloatArray116[local43] = arg0.method22425(1460081112);
			}
			return;
		}
		@Pc(5) Class470 local5 = new Class470();
		local5.method29376(Class464.method29282(arg0.method22482((byte) -30)));
		local5.method29377(Class464.method29282(arg0.method22482((byte) -115)));
		local5.method29378(Class464.method29282(arg0.method22482((byte) -100)));
		local5.method29387((float) arg0.method22482((byte) -18), (float) arg0.method22482((byte) -65), (float) arg0.method22482((byte) -26));
		this.method29842(local5);
	}
	...
	public float[] method29835() {
		...
		if (Math.abs(local19) > 0.005D) {
			local30 = (double) this.aFloatArray116[2];
			local36 = (double) this.aFloatArray116[10];
			...
			local30 = (double) this.aFloatArray116[1];
			local36 = (double) this.aFloatArray116[0];
			local2[1] = (float) Math.atan2(local30, local36);
			local2[2] = 0.0F;
		}
		return local2;
	...
	void method29889(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) boolean arg1) {
		if (!arg1) {
			for (@Pc(43) int local43 = 0; local43 < 16; local43++) {
				this.aFloatArray116[local43] = arg0.method22425(1224159301);
			}
			return;
		}
		@Pc(5) Class470 local5 = new Class470();
		local5.method29376(Class464.method29282(arg0.method22482((byte) -127)));
		local5.method29377(Class464.method29282(arg0.method22482((byte) -107)));
		local5.method29378(Class464.method29282(arg0.method22482((byte) -71)));
		local5.method29387((float) arg0.method22482((byte) -83), (float) arg0.method22482((byte) -89), (float) arg0.method22482((byte) -71));
		this.method29842(local5);
	}
	...
	void method29890(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) boolean arg1) {
		if (!arg1) {
			for (@Pc(43) int local43 = 0; local43 < 16; local43++) {
				this.aFloatArray116[local43] = arg0.method22425(-1074601825);
			}
			return;
		}
		@Pc(5) Class470 local5 = new Class470();
		local5.method29376(Class464.method29282(arg0.method22482((byte) -73)));
		local5.method29377(Class464.method29282(arg0.method22482((byte) -79)));
		local5.method29378(Class464.method29282(arg0.method22482((byte) -17)));
		local5.method29387((float) arg0.method22482((byte) -77), (float) arg0.method22482((byte) -108), (float) arg0.method22482((byte) -80));
		this.method29842(local5);
	}
	...
	public void method29920(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5) {
		...
		if (arg0 == 0) {
			this.aFloatArray116[0] = (float) arg1;
			this.aFloatArray116[5] = (float) arg2;
			this.aFloatArray116[10] = 1.0F;
