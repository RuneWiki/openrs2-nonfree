...
public class Class623 {
	...
	static Class623 method32145(@OriginalArg(0) int arg0) {
		@Pc(2) Class623[] local2 = Class254.method25998((byte) -63);
	...
	static Class623 method32146(@OriginalArg(0) int arg0) {
		@Pc(2) Class623[] local2 = Class254.method25998((byte) -67);
		for (@Pc(4) int local4 = 0; local4 < local2.length; local4++) {
			@Pc(12) Class623 local12 = local2[local4];
			if (local12.anInt5681 * -1361159159 == arg0) {
				return local12;
	...
	static final void method32147(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class586.method31635(local11, local14, arg0, (byte) -5);
	}

	@OriginalMember(owner = "client!vs", name = "jf", descriptor = "(Lclient!ahm;[IIZI)V", line = 9985)
	public static void method32148(@OriginalArg(0) Class132_Sub1_Sub1_Sub1 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4) {
		@Pc(5) boolean local5;
		@Pc(7) int local7;
		if (arg0.anIntArray236 != null) {
			...
			if (local5 && local28.method23552(254631299)) {
				@Pc(39) Class263 local39 = arg0.aClass19_3.method23553(1556683228);
				@Pc(44) int local44 = local39.anInt3868 * 23893545;
				if (local44 == 1) {
					local28.method23595(arg2, (byte) -18);
				}
				if (local44 == 2) {
					local28.method23628((short) 5174);
				}
			}
		}
		local5 = true;
		for (local7 = 0; local7 < arg1.length; local7++) {
			...
			if (arg0.anIntArray236 == null || arg0.anIntArray236[local7] == -1 || ((Class263) Class32.aClass32_Sub17_23.method18261(arg1[local7], 1327322706)).anInt3873 * -1789992573 >= ((Class263) Class32.aClass32_Sub17_23.method18261(arg0.anIntArray236[local7], -98644071)).anInt3873 * -1789992573) {
				...
				arg0.aClass19_3.method23563(arg2, (byte) 2);
				if (arg3) {
	...
	static final void method32149(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		arg0.anObjectArray14 = Class499.method30148(local13, arg2, 1120168652);
		arg0.aBoolean680 = true;
	}

	@OriginalMember(owner = "client!vs", name = "m", descriptor = "(Lclient!uh;IIS)Lclient!asc;", line = 37)
	static Class93_Sub1_Sub13 method32150(@OriginalArg(0) Class155 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) short arg3) {
		...
		@Pc(28) byte[] local28 = Class542.aClass497_129.method30059(Class542.aClass497_129.method30068(local8, (short) 27900), (byte) 83);
		if (local28 == null) {
			...
			local28 = Class542.aClass497_129.method30059(Class542.aClass497_129.method30068(local8, (short) 8524), (byte) 72);
			if (local28 == null) {
				...
				local28 = Class542.aClass497_129.method30059(Class542.aClass497_129.method30068(local8, (short) 12933), (byte) 25);
				if (local28 == null) {
					return null;
					...
					Class695.aClass253_1.method25985(local16, (long) local8 << 16);
					return local16;
				}
			} else if (local28.length <= 1) {
				return null;
