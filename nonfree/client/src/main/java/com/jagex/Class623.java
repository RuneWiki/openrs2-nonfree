...
public class Class623 {
	...
	static Class93_Sub1_Sub13 method32150(@OriginalArg(0) Class155 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(28) byte[] local28 = Class542.aClass497_129.method30059(Class542.aClass497_129.method30068(local8));
		if (local28 == null) {
			...
			local28 = Class542.aClass497_129.method30059(Class542.aClass497_129.method30068(local8));
			if (local28 == null) {
				...
				if (local28 == null) {
					...
					try {
						local16 = Class113.method7407(local28);
	...
	static final void method32147(@OriginalArg(0) Class681 arg0) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class586.method31635(local11, local14, arg0);
	}

	@OriginalMember(owner = "client!vs", name = "mf", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;I)V", line = 7146)
	static final void method32149(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
		...
		arg0.anObjectArray14 = Class499.method30148(local13, arg2);
		arg0.aBoolean680 = true;
	}

	@OriginalMember(owner = "client!vs", name = "jf", descriptor = "(Lclient!ahm;[IIZI)V", line = 9985)
	public static void method32148(@OriginalArg(0) Class132_Sub1_Sub1_Sub1 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(5) boolean local5;
		@Pc(7) int local7;
		if (arg0.anIntArray236 != null) {
			...
			if (local5 && local28.method23552()) {
				@Pc(39) Class263 local39 = arg0.aClass19_3.method23553();
				@Pc(44) int local44 = local39.anInt3868 * 23893545;
				if (local44 == 1) {
					local28.method23595(arg2);
				}
				if (local44 == 2) {
					local28.method23628();
				}
		...
		for (local7 = 0; local7 < arg1.length; local7++) {
			...
			if (arg0.anIntArray236 == null || arg0.anIntArray236[local7] == -1 || ((Class263) Class32.aClass32_Sub17_23.method18261(arg1[local7])).anInt3873 * -1789992573 >= ((Class263) Class32.aClass32_Sub17_23.method18261(arg0.anIntArray236[local7])).anInt3873 * -1789992573) {
				arg0.anIntArray236 = arg1;
				arg0.aClass19_3.method23563(arg2);
				if (arg3) {
