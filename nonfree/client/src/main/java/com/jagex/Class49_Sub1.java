...
public class Class49_Sub1 extends Class49 {
	...
	@Override
	public Socket method16599() throws IOException {
		...
		for (@Pc(82) int local82 = 0; local82 < local80.length; local82++) {
			...
			try {
				@Pc(98) Socket local98 = this.method16612(local93);
				if (local98 != null) {
					return local98;
				}
	...
	Socket method16612(@OriginalArg(0) Proxy arg0) throws IOException {
		...
		if (arg0.type() == Type.HTTP) {
			...
			return this.method16616(local18.getHostName(), local18.getPort(), local24);
	...
	Socket method16616(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2) throws IOException {
		@Pc(5) Socket local5 = new Socket(arg0, arg1);
		local5.setSoTimeout(10000);
		@Pc(11) OutputStream local11 = local5.getOutputStream();
		if (arg2 == null) {
	...
	static final void method16619(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		@Pc(29) Class39 local29 = (Class39) Class19.aClass32_Sub7_5.method18261(local13);
		if (local29.aClass519_1 != Class519.aClass519_7) {
		}
		arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = local29.method749(local23);
	}
}
