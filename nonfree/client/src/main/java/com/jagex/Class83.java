...
public class Class83 implements Interface75 {
	...
	public static final int method1389(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (client.aClass532_1.method30459() == null) {
			return 0;
		}
		if (arg4 < 3) {
			@Pc(12) Class520 local12 = client.aClass532_1.method30509();
			@Pc(16) int local16 = arg0 >> 9;
			@Pc(20) int local20 = arg1 >> 9;
			if (arg2 < 0 || arg3 < 0 || arg2 > client.aClass532_1.method30444() - 1 || arg3 > client.aClass532_1.method30474() - 1) {
				return 0;
			}
			if (local16 < 1 || local20 < 1 || local16 > client.aClass532_1.method30444() - 1 || local20 > client.aClass532_1.method30474() - 1) {
				return 0;
			}
		...
		return client.aClass532_1.method30459().aClass99Array1[arg4].method2480(arg0, arg1);
	}
}
