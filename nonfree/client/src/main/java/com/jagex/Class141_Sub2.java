...
public class Class141_Sub2 extends Class141 implements Interface44 {
	...
	Class141_Sub2(@OriginalArg(0) Class104_Sub2_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int[][] arg3) {
		...
		if (arg2) {
			...
			for (local13 = 0; local13 < 6; local13++) {
				OpenGL.glTexImage2Di(local13 + 34069, 0, Class104_Sub2_Sub2.method21309(this.aClass206_15, this.aClass226_16), arg1, arg1, 0, Class104_Sub2_Sub2.method21317(this.aClass206_15), this.aClass104_Sub2_Sub2_8.anInt2963, arg3[local13], 0);
			}
		}
	}
