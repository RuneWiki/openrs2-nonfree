...
final class Class251 implements Interface23 {
	...
	public int method33454(@OriginalArg(0) Class379 arg0, @OriginalArg(1) int arg1) {
		@Pc(10) Class93_Sub14 local10 = (Class93_Sub14) Class249.aClass16_24.method215((long) (arg0.anInt4622 * -15749287) | 0x100000000L);
	...
	public static Class709 method25966(@OriginalArg(0) int arg0) {
	...
	static void method25967(@OriginalArg(0) Class54_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		arg0.method14871(arg1, 1494441756);
		@Pc(10) byte local10;
		if (arg2 > 100000) {
			Class642.method32521((byte) 14);
			local10 = 4;
		} else if (arg2 > 50000) {
			Class586.method31641((byte) 46);
			local10 = 3;
		} else if (arg2 > 10000) {
			Class260.method26153(1522173328);
			local10 = 2;
		} else {
			Class238.method25796(true, 1736405322);
			local10 = 1;
		}
		if (Class51.aClass93_Sub36_1.aClass166_Sub4_2.method15424((byte) 72) == arg1) {
	...
	static void method25968(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[arg0.anInt5891 * -1497248091 - 1] = ((Class347) Class288.aClass55_Sub2_1.method18261(arg0.anIntArray519[-1497248091 * arg0.anInt5891 - 1], 538953545)).method27594(Class624.aClass120_1, -56090989) ? 1 : 0;
	}

	@OriginalMember(owner = "client!et", name = "y", descriptor = "(Lclient!yf;I)V", line = 85)
	static void method25969(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method25970(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		arg0.anObjectArray29 = Class499.method30148(local13, arg2, -619820294);
		arg0.aBoolean680 = true;
	}

	@OriginalMember(owner = "client!et", name = "ald", descriptor = "(Lclient!yf;I)V", line = 11893)
	static final void method25971(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	public static final boolean method25973(@OriginalArg(0) int arg0) {
