...
public class Class657 {
	...
	public static String method32756(@OriginalArg(0) String arg0) {
	...
	public static String method32754(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	public static boolean method32757(@OriginalArg(0) char arg0) {
	...
	static final void method32755(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		Class676.method33222(local12);
	}

	@OriginalMember(owner = "client!xf", name = "lp", descriptor = "(Ljava/lang/String;II)V", line = 12010)
	public static final void method32753(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		@Pc(2) Class175 local2 = Class330.method27372();
		@Pc(8) Class93_Sub22 local8 = Class102.method2592(Class446.aClass446_56, local2.aClass24_2);
		local8.aClass93_Sub41_Sub2_1.method22510(Class46.method894(arg0) + 1);
		local8.aClass93_Sub41_Sub2_1.method22402(arg0);
		local8.aClass93_Sub41_Sub2_1.method22447(arg1);
