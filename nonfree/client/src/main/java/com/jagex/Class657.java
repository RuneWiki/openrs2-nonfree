...
public class Class657 {
	...
	public static final void method32753(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(2) Class175 local2 = Class330.method27372(-1553800594);
		@Pc(8) Class93_Sub22 local8 = Class102.method2592(Class446.aClass446_56, local2.aClass24_2, (byte) 31);
		local8.aClass93_Sub41_Sub2_1.method22510(Class46.method894(arg0, -2061366101) + 1, (byte) -21);
		local8.aClass93_Sub41_Sub2_1.method22402(arg0, 98344578);
		local8.aClass93_Sub41_Sub2_1.method22447(arg1, 1243726215);
		local2.method24351(local8, -2038067562);
	}
	...
	static final void method32755(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		Class676.method33222(local12, -1709818384);
	}

	@OriginalMember(owner = "client!xf", name = "e", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 9)
	public static String method32756(@OriginalArg(0) String arg0, @OriginalArg(1) byte arg1) {
	...
	public static boolean method32757(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1) {
