...
public class Class624 implements Interface67 {
	...
	public boolean method32253(@OriginalArg(0) Class93_Sub23 arg0, @OriginalArg(1) Interface66[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class158 arg3, @OriginalArg(4) int arg4) {
		if (arg0 != null) {
			if (this.anInt5684 * 1084088307 != arg0.method22890(1485620374)) {
				return false;
			}
			if (this.anInt5683 * 877816245 > arg0.method22875(-432282299)) {
				return false;
			}
	...
	public boolean method32251(@OriginalArg(0) Class93_Sub23 arg0, @OriginalArg(1) Interface66[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class158 arg3) {
		if (arg0 != null) {
			if (this.anInt5684 * 1084088307 != arg0.method22890(-633495157)) {
				return false;
			}
			if (this.anInt5683 * 877816245 > arg0.method22875(-432282299)) {
				return false;
	...
	public boolean method32252(@OriginalArg(0) Class93_Sub23 arg0, @OriginalArg(1) Interface66[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class158 arg3) {
		if (arg0 != null) {
			if (this.anInt5684 * 1084088307 != arg0.method22890(1846223849)) {
				return false;
			}
			if (this.anInt5683 * 877816245 > arg0.method22875(-432282299)) {
				return false;
	...
	static final void method32156(@OriginalArg(0) byte arg0) {
		Class687.anInt5907 -= 1465143003;
	}

	@OriginalMember(owner = "client!vu", name = "bdt", descriptor = "(Lclient!yf;B)V", line = 14803)
	static final void method32157(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = client.aClass270_1.method26278(local13, 1830450514).method26439(local23, -1113809210);
	}

	@OriginalMember(owner = "client!vu", name = "n", descriptor = "(ILjava/lang/String;III)Z", line = 55)
	public static boolean method32158(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
	...
	static final void method32159(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anInt5891 -= 1189701933;
	}

	@OriginalMember(owner = "client!vu", name = "jb", descriptor = "(I)V", line = 10150)
	public static void method32160(@OriginalArg(0) int arg0) {
		...
		if (local11 != null) {
			Class354.method27696(local11, -1174743804);
		}
	}
}
