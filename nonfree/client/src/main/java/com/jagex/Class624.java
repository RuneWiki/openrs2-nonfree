...
public class Class624 implements Interface67 {
	...
	public boolean method32253(@OriginalArg(0) Class93_Sub23 arg0, @OriginalArg(1) Interface66[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class158 arg3) {
		if (arg0 != null) {
			if (this.anInt5684 * 1084088307 != arg0.method22890()) {
				return false;
			}
			if (this.anInt5683 * 877816245 > arg0.method22875()) {
				return false;
			}
	...
	public static boolean method32158(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	static final void method32156() {
		Class687.anInt5907 -= 1465143003;
	}

	@OriginalMember(owner = "client!vu", name = "jd", descriptor = "(Lclient!yf;B)V", line = 6625)
	static final void method32159(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= 1189701933;
	}

	@OriginalMember(owner = "client!vu", name = "jb", descriptor = "(I)V", line = 10150)
	public static void method32160() {
		if (!client.aBoolean625) {
			return;
		}
		@Pc(11) Class312 local11 = Class124_Sub2.method9308(Class148.anInt1394 * -278883695, client.anInt3523 * 1573685689);
		if (local11 != null && local11.anObjectArray19 != null) {
			...
			Class211.method25429(local20);
		}
		client.anInt3520 = 410366683;
		client.anInt3524 = -1250176741;
		client.aBoolean625 = false;
		if (local11 != null) {
			Class354.method27696(local11);
		}
	}

	@OriginalMember(owner = "client!vu", name = "bdt", descriptor = "(Lclient!yf;B)V", line = 14803)
	static final void method32157(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = client.aClass270_1.method26278(local13).method26439(local23);
	}
}
