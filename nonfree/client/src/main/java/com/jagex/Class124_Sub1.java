...
public class Class124_Sub1 extends Class124 {
	...
	public void method21419(@OriginalArg(0) float arg0, @OriginalArg(1) int[][][] arg1, @OriginalArg(2) Class520 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		this.aClass471_2.method29480(local14, this.aClass123_13.method8967((short) -26138));
		if (Float.isNaN(this.aClass471_2.aFloat314)) {
			this.aClass471_2.method29464(local14);
		}
		local14.method29459();
		this.aClass472_16.method29538(this.anInterface29_1.method19938((byte) 90).method13870(-1459860639));
	...
	public void method9159(@OriginalArg(0) byte arg0) {
		if (this.anInterface29_1 != null) {
			this.anInterface29_1 = this.aClass123_13.method8940(-1893827957).method36705(this.anInterface29_1.method19946(65280), this.anInterface29_1.method19941(230905611), (byte) 32);
		}
	}

	@OriginalMember(owner = "client!ahd", name = "e", descriptor = "(F[[[ILclient!qx;IIB)V", line = 48)
	@Override
	public void method21421(@OriginalArg(0) float arg0, @OriginalArg(1) int[][][] arg1, @OriginalArg(2) Class520 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) byte arg5) {
		if (this.anInterface29_1 == null) {
			return;
		}
		this.method9161(arg1, arg2, arg3, arg4, (byte) -76);
		@Pc(14) Class471 local14 = this.method9160((byte) 47);
		this.aClass471_2.method29480(local14, this.aClass123_13.method8967((short) 23764));
		if (Float.isNaN(this.aClass471_2.aFloat314)) {
			this.aClass471_2.method29464(local14);
		}
		local14.method29459();
		this.aClass472_16.method29538(this.anInterface29_1.method19938((byte) 46).method13870(-268123421));
	...
	void method9161(@OriginalArg(0) int[][][] arg0, @OriginalArg(1) Class520 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte arg4) {
		if (!this.method21401(-338882669) || !this.aClass123_13.method8973(-670900429) && !this.aClass123_13.method8974(427282430)) {
			return;
		}
	...
	public void method9164() {
		if (this.anInterface29_1 != null) {
			this.anInterface29_1 = this.aClass123_13.method8940(-2125406909).method36705(this.anInterface29_1.method19946(65280), this.anInterface29_1.method19941(230905611), (byte) 32);
		}
	}

	@OriginalMember(owner = "client!ahd", name = "m", descriptor = "(B)Lclient!ox;", line = 170)
	@Override
	public Class472 method21402(@OriginalArg(0) byte arg0) {
	...
	@Override
	public double[] method21413(@OriginalArg(0) int arg0) {
		@Pc(2) double[] local2 = new double[3];
		@Pc(6) Class472 local6 = this.method21402((byte) 101);
		local2[0] = (double) local6.aFloat317;
		local2[1] = (double) local6.aFloat318;
		local2[2] = (double) local6.aFloat319;
		return local2;
	}
	...
	public float method9168(@OriginalArg(0) byte arg0) {
		return Class110_Sub15.method20152(this.aClass471_1, (byte) -74);
	}

	@OriginalMember(owner = "client!ahd", name = "at", descriptor = "(I)F", line = 206)
	public float method9169(@OriginalArg(0) int arg0) {
		return Class332.method27394(this.aClass471_1, 1191956569);
	}

	@OriginalMember(owner = "client!ahd", name = "w", descriptor = "(I)F", line = 210)
	@Override
	public float method21405(@OriginalArg(0) int arg0) {
		return 0.0F;
	}

	@OriginalMember(owner = "client!ahd", name = "l", descriptor = "(Lclient!ju;IIB)V", line = 214)
	@Override
	public void method21406(@OriginalArg(0) Class368 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		@Pc(3) Class472 local3 = this.method21402((byte) 61);
	...
	void method9170(@OriginalArg(0) int[][][] arg0, @OriginalArg(1) Class520 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (!this.method21401(-1146669639) || !this.aClass123_13.method8973(-841598397) && !this.aClass123_13.method8974(-2014046209)) {
			return;
		}
	...
	public Class93_Sub30 method21411() {
		@Pc(3) Class472 local3 = this.method21402((byte) 52);
	...
	public Class93_Sub30 method21412() {
		@Pc(3) Class472 local3 = this.method21402((byte) 111);
		@Pc(20) Class93_Sub30 local20 = new Class93_Sub30(this.anInt1016 * 526766745, (int) local3.aFloat317, (int) local3.aFloat318, (int) local3.aFloat319);
		local3.method29532();
		return local20;
	}
	...
	public Class93_Sub30 method21410() {
		@Pc(3) Class472 local3 = this.method21402((byte) 123);
		@Pc(20) Class93_Sub30 local20 = new Class93_Sub30(this.anInt1016 * 526766745, (int) local3.aFloat317, (int) local3.aFloat318, (int) local3.aFloat319);
		local3.method29532();
		return local20;
	}
	...
	@Override
	public boolean method21401(@OriginalArg(0) int arg0) {
		return !Float.isNaN(this.aClass472_15.aFloat317);
	}
	...
	public void method21417(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(5) Class363 local5 = Class90.method1601(arg0.method22413((short) 16384), -2018282831);
		@Pc(9) int local9 = arg0.method22415(-1434290800);
		...
		this.anInt1017 = arg0.method22415(-1434290800) * 822388973;
		this.anInterface29_1 = this.aClass123_13.method8940(-1680994591).method36705(local5, local9, (byte) 32);
	}
	...
	public void method21418(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(5) Class363 local5 = Class90.method1601(arg0.method22413((short) 16384), -1873131749);
		@Pc(9) int local9 = arg0.method22415(-1434290800);
		this.aClass472_14.method29536(arg0);
		this.aClass471_1.method29462(arg0);
		if (arg0.method22413((short) 16384) == 1) {
		...
		this.anInt1017 = arg0.method22415(-1434290800) * 822388973;
		this.anInterface29_1 = this.aClass123_13.method8940(-2119740420).method36705(local5, local9, (byte) 32);
	}
	...
	public void method21414(@OriginalArg(0) float arg0, @OriginalArg(1) int[][][] arg1, @OriginalArg(2) Class520 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		this.aClass471_2.method29480(local14, this.aClass123_13.method8967((short) 9655));
		if (Float.isNaN(this.aClass471_2.aFloat314)) {
			this.aClass471_2.method29464(local14);
		}
		local14.method29459();
		this.aClass472_16.method29538(this.anInterface29_1.method19938((byte) 104).method13870(-1383603256));
	...
	public void method21422(@OriginalArg(0) float arg0, @OriginalArg(1) int[][][] arg1, @OriginalArg(2) Class520 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		this.aClass471_2.method29480(local14, this.aClass123_13.method8967((short) 9640));
		if (Float.isNaN(this.aClass471_2.aFloat314)) {
			this.aClass471_2.method29464(local14);
		}
		local14.method29459();
		this.aClass472_16.method29538(this.anInterface29_1.method19938((byte) 39).method13870(853071011));
	...
	public double[] method21403() {
		@Pc(2) double[] local2 = new double[3];
		@Pc(6) Class472 local6 = this.method21402((byte) 20);
		local2[0] = (double) local6.aFloat317;
		local2[1] = (double) local6.aFloat318;
		local2[2] = (double) local6.aFloat319;
		return local2;
	...
	@Override
	public Class93_Sub30 method21404(@OriginalArg(0) byte arg0) {
		@Pc(3) Class472 local3 = this.method21402((byte) 40);
		@Pc(20) Class93_Sub30 local20 = new Class93_Sub30(this.anInt1016 * 526766745, (int) local3.aFloat317, (int) local3.aFloat318, (int) local3.aFloat319);
		local3.method29532();
		return local20;
	}
	...
	public void method9174() {
		if (this.anInterface29_1 != null) {
			this.anInterface29_1 = this.aClass123_13.method8940(-1800086256).method36705(this.anInterface29_1.method19946(65280), this.anInterface29_1.method19941(230905611), (byte) 32);
		}
	}
	...
	public void method21424(@OriginalArg(0) Class368 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(3) Class472 local3 = this.method21402((byte) 81);
		arg0.anInt4586 = ((int) local3.aFloat317 - arg1) * -255666073;
		arg0.anInt4587 = (int) -local3.aFloat318 * -543294551;
		arg0.anInt4588 = ((int) local3.aFloat319 - arg2) * -513444905;
		local3.method29532();
	...
	public void method9177() {
		if (this.anInterface29_1 != null) {
			this.anInterface29_1 = this.aClass123_13.method8940(-1820079769).method36705(this.anInterface29_1.method19946(65280), this.anInterface29_1.method19941(230905611), (byte) 32);
		}
	}

	@OriginalMember(owner = "client!ahd", name = "bf", descriptor = "()F", line = 202)
	public float method9178() {
		return Class110_Sub15.method20152(this.aClass471_1, (byte) -81);
	}
	...
	void method9179(@OriginalArg(0) int[][][] arg0, @OriginalArg(1) Class520 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (!this.method21401(-811652722) || !this.aClass123_13.method8973(1469855959) && !this.aClass123_13.method8974(-343419890)) {
			return;
		}
	...
	void method9180(@OriginalArg(0) int[][][] arg0, @OriginalArg(1) Class520 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (!this.method21401(1441795224) || !this.aClass123_13.method8973(-957457219) && !this.aClass123_13.method8974(663285406)) {
			return;
		}
	...
	void method9181(@OriginalArg(0) int[][][] arg0, @OriginalArg(1) Class520 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (!this.method21401(1105318035) || !this.aClass123_13.method8973(-1658735763) && !this.aClass123_13.method8974(1786354635)) {
			return;
		}
	...
	public void method21400(@OriginalArg(0) Class368 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(3) Class472 local3 = this.method21402((byte) 34);
		arg0.anInt4586 = ((int) local3.aFloat317 - arg1) * -255666073;
		arg0.anInt4587 = (int) -local3.aFloat318 * -543294551;
		arg0.anInt4588 = ((int) local3.aFloat319 - arg2) * -513444905;
		local3.method29532();
	...
	@Override
	public void method21407(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		@Pc(5) Class363 local5 = Class90.method1601(arg0.method22413((short) 16384), -2019869299);
		@Pc(9) int local9 = arg0.method22415(-1434290800);
		this.aClass472_14.method29536(arg0);
		this.aClass471_1.method29462(arg0);
		if (arg0.method22413((short) 16384) == 1) {
		...
		this.anInt1017 = arg0.method22415(-1434290800) * 822388973;
		this.anInterface29_1 = this.aClass123_13.method8940(-1864838711).method36705(local5, local9, (byte) 32);
	}

	@OriginalMember(owner = "client!ahd", name = "r", descriptor = "()Lclient!akt;", line = 187)
	@Override
	public Class93_Sub30 method21420() {
		@Pc(3) Class472 local3 = this.method21402((byte) 63);
		@Pc(20) Class93_Sub30 local20 = new Class93_Sub30(this.anInt1016 * 526766745, (int) local3.aFloat317, (int) local3.aFloat318, (int) local3.aFloat319);
		local3.method29532();
		return local20;
	}
	...
	public float method9186() {
		return Class110_Sub15.method20152(this.aClass471_1, (byte) -26);
	}

	@OriginalMember(owner = "client!ahd", name = "bk", descriptor = "()F", line = 206)
	public float method9187() {
		return Class332.method27394(this.aClass471_1, -1100871678);
	}

	@OriginalMember(owner = "client!ahd", name = "aes", descriptor = "(Lclient!yf;I)V", line = 10281)
	static final void method9188(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method9190(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
	...
	static final void method9191(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
	...
	static final void method9192(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static void method9193(@OriginalArg(0) byte arg0) {
		Class173.aClass240_64.method25837(1161602830);
	}
}
