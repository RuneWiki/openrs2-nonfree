...
public abstract class Class139 implements Interface36 {
	...
	void method29351(@OriginalArg(0) int arg0) {
		if (arg0 > this.anInt1386) {
			...
			if (this.anInt1384 > 0) {
				OpenGL.glBindBufferARB(this.anInt1385, this.anInt1384);
				OpenGL.glBufferDataARBub(this.anInt1385, arg0, (byte[]) null, 0, this.aBoolean259 ? 35040 : 35044);
				this.aClass104_Sub2_Sub2_9.anInt2917 += arg0 - this.anInt1386;
			} else {
				this.aNativeHeapBuffer3 = this.aClass104_Sub2_Sub2_9.method20915(arg0, false);
			}
			this.anInt1386 = arg0;
		}
		this.anInt1387 = arg0;
	...
	void method30885() {
		if (this.anInt1384 > 0) {
			this.aClass104_Sub2_Sub2_9.method21304(this.anInt1384, this.anInt1387);
			this.anInt1384 = -1;
		}
	}
	...
	void method11634() throws Throwable {
		this.method30884();
		super.finalize();
	}
