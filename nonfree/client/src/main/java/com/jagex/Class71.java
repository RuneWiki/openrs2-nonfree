...
public class Class71 {
	...
	static final void method1247(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method1249(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!acv", name = "l", descriptor = "(IIIIIIILclient!oe;IIB)V", line = 171)
	static final void method1250(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) Class458 arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) byte arg10) {
		if (arg2 < 1 || arg3 < 1 || arg2 > client.aClass532_1.method30444(-1664407314) - 2 || arg3 > client.aClass532_1.method30474((short) 128) - 2) {
			return;
		}
		@Pc(21) int local21 = arg0;
		if (arg0 < 3 && client.aClass532_1.method30509(-955291898).method30330(arg2, arg3, -662808309)) {
			local21 = arg0 + 1;
		}
		if (client.aClass532_1.method30459(-1273454175) == null) {
			return;
		}
		client.aClass532_1.method30460(-310507201).method10959(Class694.aClass104_14, arg0, arg1, arg2, arg3, (byte) -82);
		if (arg4 >= 0) {
			@Pc(55) int local55 = Class51.aClass93_Sub36_1.aClass166_Sub3_1.method15402(-286073295);
		...
		Class110_Sub15.method20151(Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aByte100, 1611540913);
	}
}
