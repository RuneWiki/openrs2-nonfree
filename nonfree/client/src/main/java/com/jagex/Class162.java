...
public abstract class Class162 {
	...
	void method14775(@OriginalArg(0) int arg0) {
		...
		synchronized (this.aClass240_37) {
			this.aClass240_37.method25833((byte) -127);
		}
	}
	...
	void method14776(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_37;
		synchronized (this.aClass240_37) {
			this.aClass240_37.method25832(arg0, (byte) 21);
		}
	}
	...
	void method14777(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_37;
		synchronized (this.aClass240_37) {
			this.aClass240_37.method25837(1161602830);
		}
	}
	...
	void method14778() {
		@Pc(3) Class240 local3 = this.aClass240_37;
		synchronized (this.aClass240_37) {
			this.aClass240_37.method25833((byte) -117);
		}
	}

	@OriginalMember(owner = "client!xd", name = "n", descriptor = "(II)V", line = 62)
	void method14779(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class240 local3 = this.aClass240_37;
		synchronized (this.aClass240_37) {
			this.aClass240_37.method25832(arg0, (byte) 59);
		}
	}
	...
	void method14780() {
		@Pc(3) Class240 local3 = this.aClass240_37;
		synchronized (this.aClass240_37) {
			this.aClass240_37.method25833((byte) -53);
		}
	}
	...
	void method14782(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_37;
		synchronized (this.aClass240_37) {
			this.aClass240_37.method25832(arg0, (byte) -79);
		}
	}
	...
	void method14783() {
		@Pc(3) Class240 local3 = this.aClass240_37;
		synchronized (this.aClass240_37) {
			this.aClass240_37.method25833((byte) -35);
		}
	}

	@OriginalMember(owner = "client!xd", name = "xb", descriptor = "(Lclient!yf;B)V", line = 9196)
	static final void method14784(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method14785(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static void method14786(@OriginalArg(0) byte arg0) {
		...
		@Pc(24) int local24;
		if (Class168.anInt2447 * -2005950823 != -1 && Class168.aLong111 * -473982398681043039L < Class305.method26796(420077591)) {
			for (local24 = Class168.anInt2447 * -2005950823; local24 < Class350.aStringArray28.length; local24++) {
				if (Class350.aStringArray28[local24].startsWith("pause")) {
					...
					Class168.aLong111 = (Class305.method26796(404393062) + (long) (local36 * 1000)) * 9101462360260179041L;
					return;
				}
		...
		for (local24 = 0; local24 < client.anInt3448 * -1523148821; local24++) {
			...
			if (local131 == 80) {
				...
				if (Class413.aClipboard1 != null) {
					...
					Class413.aClipboard1.setContents(new StringSelection(local165), (ClipboardOwner) null);
				}
			} else if (local131 == 67 && (local139 & 0x4) != 0) {
				if (Class413.aClipboard1 != null) {
					try {
						@Pc(220) Transferable local220 = Class413.aClipboard1.getContents((Object) null);
						if (local220 != null) {
				...
				Class168.anInt2445 = Class168.aString61.length() * -1799421149;
			} else if (Class239.method25820(local135, -948774027) || "\\/.:, _-+[]~@".indexOf(local135) != -1) {
	...
	static final void method14787(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method14788(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class557.aClass297_1.method26659((byte) -18).size();
	}
}
