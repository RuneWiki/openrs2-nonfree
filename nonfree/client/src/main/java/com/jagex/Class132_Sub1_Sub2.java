...
public abstract class Class132_Sub1_Sub2 extends Class132_Sub1 {
	...
	int method24309(@OriginalArg(0) Class93_Sub16[] arg0, @OriginalArg(1) short arg1) {
		if (this.aBoolean560) {
			...
			this.anInt1439 = this.method24274(local16, local26, this.aClass93_Sub16Array9, 2130075743) * 858024109;
	...
	int method24264(@OriginalArg(0) Class93_Sub16[] arg0) {
		if (this.aBoolean560) {
			...
			this.anInt1439 = this.method24274(local16, local26, this.aClass93_Sub16Array9, 1907189570) * 858024109;
			this.aBoolean560 = false;
		}
		for (@Pc(199) int local199 = 0; local199 < this.anInt1439 * 951139109; local199++) {
			arg0[local199] = this.aClass93_Sub16Array9[local199];
	...
	int method24302(@OriginalArg(0) Class93_Sub16[] arg0) {
		if (this.aBoolean560) {
			...
			this.anInt1439 = this.method24274(local16, local26, this.aClass93_Sub16Array9, 1933882196) * 858024109;
			this.aBoolean560 = false;
		}
		for (@Pc(199) int local199 = 0; local199 < this.anInt1439 * 951139109; local199++) {
			arg0[local199] = this.aClass93_Sub16Array9[local199];
