...
public class Class451 implements Interface48 {
	...
	public Class442 method28947(@OriginalArg(0) int arg0) {
		@Pc(6) Class442 local6 = (Class442) this.aClass240_84.method25839((long) arg0);
		if (local6 != null) {
			return local6;
		}
		@Pc(18) byte[] local18 = this.aClass497_118.method30044(0, arg0, (byte) 0);
		local6 = new Class442();
		if (local18 != null) {
			local6.method28858(new Class93_Sub41(local18), arg0, (byte) -1);
		}
		this.aClass240_84.method25830(local6, (long) arg0);
		return local6;
	}
	...
	public static final int method28948(@OriginalArg(0) byte arg0) {
	...
	static final void method28949(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anInt5891 -= 1189701933;
	}

	@OriginalMember(owner = "client!nw", name = "ar", descriptor = "(Lclient!arm;B)Ljava/lang/String;", line = 1079)
	public static String method28950(@OriginalArg(0) Class93_Sub1_Sub7 arg0, @OriginalArg(1) byte arg1) {
	...
	public static Class715[] method28951(@OriginalArg(0) int arg0) {
	...
	public static void method28952(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1) {
		try {
	...
	static final void method28953(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		@Pc(31) int local31 = client.aClass531ArrayArray1[local23][local13].method30426(-980370360);
