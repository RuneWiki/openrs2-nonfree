...
public class Class697 implements Interface13 {
	...
	final Class109 method36660(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class99 arg3, @OriginalArg(4) Class99 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) Class19 arg12, @OriginalArg(13) byte arg13, @OriginalArg(14) int arg14) {
		...
		synchronized (this.aClass164_1.aClass240_39) {
			local78 = (Class109) this.aClass164_1.aClass240_39.method25839((long) (this.anInt5941 * 143938719 | arg0.anInt2888 * 658538839 << 29));
		}
		if (local78 == null || arg0.method20693(local78.method6825(), local1) != 0) {
			if (local78 != null) {
				local1 = arg0.method20512(local1, local78.method6825());
			}
			...
			if (local129.anInt3738 < 13) {
				local129.method25671(2);
			}
			local78 = arg0.method20510(local129, local105, this.aClass164_1.anInt2017 * -2076184321, this.anInt5948 * -237693273 + 64, this.anInt5944 * -2056867909 + 850);
			@Pc(168) int local168;
			if (this.aShortArray151 != null) {
			...
			synchronized (this.aClass164_1.aClass240_39) {
				this.aClass164_1.aClass240_39.method25830(local78, (long) (this.anInt5941 * 143938719 | arg0.anInt2888 * 658538839 << 29));
			}
		}
		@Pc(247) Class109 local247 = local78.method6907(arg13, local1, true);
		if (arg12 != null) {
			arg12.method23565(local247, 0, 150255679);
		}
		if (this.anInt5945 * -1494200455 != 128 || this.anInt5946 * -438078453 != 128) {
			local247.method6833(this.anInt5945 * -1494200455, this.anInt5946 * -438078453, this.anInt5945 * -1494200455);
		}
		...
		if (local11) {
			if (arg3 == null) {
				...
				local247.method6834(this.aByte175, this.anInt5950 * 1374226323, arg3, arg4, arg5, arg6, arg7);
			}
		}
	...
	public void method36654(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
		while (true) {
			...
			this.method36669(arg0, local3, -614941657);
		}
	}

	@OriginalMember(owner = "client!yy", name = "o", descriptor = "(Lclient!dh;ILclient!aaq;B)Lclient!do;", line = 123)
	public final Class109 method36661(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class19 arg2, @OriginalArg(3) byte arg3) {
		return this.method36660(arg0, arg1, false, (Class99) null, (Class99) null, 0, 0, 0, 0, 0, 0, 0, arg2, arg3, -1747960127);
	}

	@OriginalMember(owner = "client!yy", name = "p", descriptor = "(Lclient!dh;IIIIILclient!aaq;BI)Lclient!do;", line = 127)
	public final Class109 method36662(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class19 arg6, @OriginalArg(7) byte arg7, @OriginalArg(8) int arg8) {
		return this.aByte175 == 3 ? this.method36660(arg0, arg1, true, (Class99) null, (Class99) null, 0, 0, 0, arg2, arg3, arg4, arg5, arg6, arg7, -1747960127) : this.method36660(arg0, arg1, false, (Class99) null, (Class99) null, 0, 0, 0, arg2, 0, 0, 0, arg6, arg7, -1747960127);
	}

	@OriginalMember(owner = "client!yy", name = "ae", descriptor = "()Z", line = 195)
	public final boolean method36663() {
		return this.anInt5942 * 431372497 == -1 ? true : this.aClass164_1.aClass497_58.method30053(this.anInt5942 * 431372497, 0, -403358355);
	}
	...
	public final Class109 method36664(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class99 arg3, @OriginalArg(4) Class99 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) Class19 arg8, @OriginalArg(9) byte arg9, @OriginalArg(10) byte arg10) {
		return this.method36660(arg0, arg1, true, arg3, arg4, arg5, arg6, arg7, arg2, 0, 0, 0, arg8, arg9, -1747960127);
	}

	@OriginalMember(owner = "client!yy", name = "r", descriptor = "(B)Z", line = 195)
	public final boolean method36665(@OriginalArg(0) byte arg0) {
		return this.anInt5942 * 431372497 == -1 ? true : this.aClass164_1.aClass497_58.method30053(this.anInt5942 * 431372497, 0, 1526379009);
	}
	...
	public void method36655(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			...
			this.method36669(arg0, local3, -84640348);
		}
	}

	@OriginalMember(owner = "client!yy", name = "s", descriptor = "(Lclient!dh;ILclient!aaq;B)Lclient!do;", line = 123)
	public final Class109 method36666(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class19 arg2, @OriginalArg(3) byte arg3) {
		return this.method36660(arg0, arg1, false, (Class99) null, (Class99) null, 0, 0, 0, 0, 0, 0, 0, arg2, arg3, -1747960127);
	}
	...
	public void method36658(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			...
			this.method36669(arg0, local3, -1449235498);
		}
	}
	...
	public void method36657(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			...
			this.method36669(arg0, local3, -1020211480);
		}
	}

	@OriginalMember(owner = "client!yy", name = "v", descriptor = "(Lclient!alw;I)V", line = 48)
	void method36667(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt5942 = arg0.method22436(-1923170064) * 1576345649;
		} else if (arg1 == 2) {
			this.anInt5949 = arg0.method22436(-1509646141) * 456410441;
		} else if (arg1 == 4) {
			this.anInt5945 = arg0.method22415(-1434290800) * 232123081;
		} else if (arg1 == 5) {
			this.anInt5946 = arg0.method22415(-1434290800) * -650872925;
		} else if (arg1 == 6) {
			this.anInt5947 = arg0.method22415(-1434290800) * 748175151;
		} else if (arg1 == 7) {
			this.anInt5948 = arg0.method22413((short) 16384) * -1527566057;
		} else if (arg1 == 8) {
			this.anInt5944 = arg0.method22413((short) 16384) * 1111932275;
		} else if (arg1 == 10) {
			...
			this.aByte175 = 3;
			this.anInt5950 = arg0.method22415(-1434290800) * -725340517;
		} else if (arg1 == 16) {
			this.aByte175 = 3;
			this.anInt5950 = arg0.method22419(-118643075) * -725340517;
		} else {
			@Pc(128) int local128;
			@Pc(138) int local138;
			if (arg1 == 40) {
				local128 = arg0.method22413((short) 16384);
				this.aShortArray151 = new short[local128];
				this.aShortArray152 = new short[local128];
				for (local138 = 0; local138 < local128; local138++) {
					this.aShortArray151[local138] = (short) arg0.method22415(-1434290800);
					this.aShortArray152[local138] = (short) arg0.method22415(-1434290800);
				}
			} else if (arg1 == 41) {
				local128 = arg0.method22413((short) 16384);
				...
				for (local138 = 0; local138 < local128; local138++) {
					this.aShortArray153[local138] = (short) arg0.method22415(-1434290800);
					this.aShortArray150[local138] = (short) arg0.method22415(-1434290800);
				}
			} else {
				@Pc(210) int local210;
				@Pc(226) int local226;
				...
				if (arg1 == 44) {
					local128 = arg0.method22415(-1434290800);
					local138 = 0;
	...
	public final Class109 method36668(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class99 arg3, @OriginalArg(4) Class99 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) Class19 arg8, @OriginalArg(9) byte arg9) {
		return this.method36660(arg0, arg1, true, arg3, arg4, arg5, arg6, arg7, arg2, 0, 0, 0, arg8, arg9, -1747960127);
	}

	@OriginalMember(owner = "client!yy", name = "u", descriptor = "(Lclient!alw;II)V", line = 48)
	void method36669(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg1 == 1) {
			this.anInt5942 = arg0.method22436(-1501880591) * 1576345649;
		} else if (arg1 == 2) {
			this.anInt5949 = arg0.method22436(-2011466936) * 456410441;
		} else if (arg1 == 4) {
			this.anInt5945 = arg0.method22415(-1434290800) * 232123081;
		} else if (arg1 == 5) {
			this.anInt5946 = arg0.method22415(-1434290800) * -650872925;
	...
	public final Class109 method36670(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class19 arg2, @OriginalArg(3) byte arg3) {
		return this.method36660(arg0, arg1, false, (Class99) null, (Class99) null, 0, 0, 0, 0, 0, 0, 0, arg2, arg3, -1747960127);
	}

	@OriginalMember(owner = "client!yy", name = "q", descriptor = "(Lclient!dh;IIIIILclient!aaq;B)Lclient!do;", line = 127)
	public final Class109 method36671(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class19 arg6, @OriginalArg(7) byte arg7) {
		return this.aByte175 == 3 ? this.method36660(arg0, arg1, true, (Class99) null, (Class99) null, 0, 0, 0, arg2, arg3, arg4, arg5, arg6, arg7, -1747960127) : this.method36660(arg0, arg1, false, (Class99) null, (Class99) null, 0, 0, 0, arg2, 0, 0, 0, arg6, arg7, -1747960127);
	}

	@OriginalMember(owner = "client!yy", name = "x", descriptor = "(Lclient!dh;IIIIILclient!aaq;B)Lclient!do;", line = 127)
	public final Class109 method36672(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class19 arg6, @OriginalArg(7) byte arg7) {
		return this.aByte175 == 3 ? this.method36660(arg0, arg1, true, (Class99) null, (Class99) null, 0, 0, 0, arg2, arg3, arg4, arg5, arg6, arg7, -1747960127) : this.method36660(arg0, arg1, false, (Class99) null, (Class99) null, 0, 0, 0, arg2, 0, 0, 0, arg6, arg7, -1747960127);
	}
	...
	public final Class109 method36674(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class99 arg3, @OriginalArg(4) Class99 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) Class19 arg8, @OriginalArg(9) byte arg9) {
		return this.method36660(arg0, arg1, true, arg3, arg4, arg5, arg6, arg7, arg2, 0, 0, 0, arg8, arg9, -1747960127);
	}

	@OriginalMember(owner = "client!yy", name = "a", descriptor = "(Lclient!dh;IILclient!cb;Lclient!cb;IIILclient!aaq;B)Lclient!do;", line = 132)
	public final Class109 method36675(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class99 arg3, @OriginalArg(4) Class99 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) Class19 arg8, @OriginalArg(9) byte arg9) {
		return this.method36660(arg0, arg1, true, arg3, arg4, arg5, arg6, arg7, arg2, 0, 0, 0, arg8, arg9, -1747960127);
	}
	...
	public void method36656(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			...
			this.method36669(arg0, local3, -455863785);
		}
	}
	...
	final Class109 method36676(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class99 arg3, @OriginalArg(4) Class99 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) Class19 arg12, @OriginalArg(13) byte arg13) {
		...
		@Pc(247) Class109 local247 = local78.method6907(arg13, local1, true);
		if (arg12 != null) {
			arg12.method23565(local247, 0, -1577972426);
		}
		if (this.anInt5945 * -1494200455 != 128 || this.anInt5946 * -438078453 != 128) {
			local247.method6833(this.anInt5945 * -1494200455, this.anInt5946 * -438078453, this.anInt5945 * -1494200455);
		}
	...
	public final boolean method36677() {
		return this.anInt5942 * 431372497 == -1 ? true : this.aClass164_1.aClass497_58.method30053(this.anInt5942 * 431372497, 0, 1829457231);
	}

	@OriginalMember(owner = "client!yy", name = "t", descriptor = "()Z", line = 195)
	public final boolean method36678() {
		return this.anInt5942 * 431372497 == -1 ? true : this.aClass164_1.aClass497_58.method30053(this.anInt5942 * 431372497, 0, -583114648);
	}

	@OriginalMember(owner = "client!yy", name = "z", descriptor = "(Lclient!dh;ILclient!aaq;BI)Lclient!do;", line = 123)
	public final Class109 method36679(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class19 arg2, @OriginalArg(3) byte arg3, @OriginalArg(4) int arg4) {
		return this.method36660(arg0, arg1, false, (Class99) null, (Class99) null, 0, 0, 0, 0, 0, 0, 0, arg2, arg3, -1747960127);
	}
	...
	static final void method36680(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		Class388.method28253(local13, local28, local38, local53, (byte) 0);
	}
}
