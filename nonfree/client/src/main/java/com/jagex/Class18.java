...
public class Class18 implements Iterable {
	...
	public Class93_Sub1 method246(@OriginalArg(0) int arg0) {
		return this.method247((Class93_Sub1) null, -580144460);
	}
	...
	static Class110 method271(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(7) Class89 local7 = Class271.method26306(local3, (byte) 80);
	...
	static boolean method272(@OriginalArg(0) Class93_Sub41_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(4) int local4 = arg0.method22689(2, -1249348482);
		@Pc(22) int local22;
		@Pc(27) int local27;
		@Pc(121) int local121;
		@Pc(125) int local125;
		...
		@Pc(135) int local135;
		if (local4 == 0) {
			if (arg0.method22689(1, 2022185544) != 0) {
				method272(arg0, arg1, 1181703894);
			}
			local22 = arg0.method22689(6, -1897194506);
			local27 = arg0.method22689(6, -2059073893);
			@Pc(37) boolean local37 = arg0.method22689(1, 1372140904) == 1;
			if (local37) {
			...
			@Pc(75) Class132_Sub1_Sub1_Sub1_Sub2 local75 = client.aClass132_Sub1_Sub1_Sub1_Sub2Array1[arg1] = new Class132_Sub1_Sub1_Sub1_Sub2(client.aClass532_1.method30459(-1820788427));
			local75.anInt2768 = arg1 * 171759809;
			if (Class174.aClass93_Sub41Array2[arg1] != null) {
				local75.method20066(Class174.aClass93_Sub41Array2[arg1], 2070630033);
			}
			if (Class174.aClass93_Sub41Array1[arg1] != null) {
				local75.method20048(Class174.aClass93_Sub41Array1[arg1], -1086348893);
			}
			local75.method19952(local64.anInt3376 * -659221549, true, -1693723577);
			...
			@Pc(139) Class611 local139 = client.aClass532_1.method30443(1759915115);
			...
			if (client.aClass532_1.method30509(-277650001).method30330(local150, local161, -662808309)) {
				local75.aByte99++;
			}
			...
			local22 = arg0.method22689(2, 1384763225);
			...
			@Pc(293) int local293;
			if (local4 != 2) {
				local22 = arg0.method22689(20, -675729298);
				...
				Class107.method18119(Class707.method36745(1375636269), local27 - 1, -1915563430);
				Class174.aClass200Array1[arg1].anInt3377 = ((local125 << 28) + (local131 << 14) + local135) * -1383292861;
				return false;
			}
			local22 = arg0.method22689(5, 1000755576);
			...
			Class107.method18119(Class707.method36745(945261972), Class174.aByteArray64[arg1], -1915563430);
