...
public class Class110_Sub21 extends Class110 {
	...
	Class110_Sub21(@OriginalArg(0) Class93_Sub41 arg0) {
		super(arg0);
		this.anInt992 = arg0.method22415(-1434290800) * 1783796673;
	}
	...
	static void method8545(@OriginalArg(0) Class312[] arg0, @OriginalArg(1) Class312 arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3) {
		...
		if (local64 != null) {
			Class568.method31297(local64.anInt3172 * 1220811495, local15, local31, arg2, (byte) -4);
		}
		...
		for (local86 = 0; local86 < local82; local86++) {
			...
			if (local95 != null) {
				local95.method19976(local15, local31, arg2, (byte) 22);
			}
		}
		for (local86 = 0; local86 < client.anInt3540 * 568731113; local86++) {
			...
			if (local123 != null) {
				((Class132_Sub1_Sub1_Sub1) local123.anObject5).method19976(local15, local31, arg2, (byte) 30);
			}
		}
	}
}
