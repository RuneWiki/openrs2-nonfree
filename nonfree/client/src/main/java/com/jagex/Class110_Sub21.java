...
public class Class110_Sub21 extends Class110 {
	...
	Class110_Sub21(@OriginalArg(0) Class93_Sub41 arg0) {
		super(arg0);
		this.anInt992 = arg0.method22415() * 1783796673;
	}

	@OriginalMember(owner = "client!agw", name = "n", descriptor = "(I)V", line = 14)
	@Override
	public void method20138() {
		Class152.aClass243Array2[this.anInt992 * 53967937].method25882();
	}
	...
	static String method8544(@OriginalArg(0) Class93_Sub1_Sub7 arg0) {
		if (arg0.aString98 == null || arg0.aString98.length() == 0) {
			return arg0.aString100 == null || arg0.aString100.length() <= 0 ? arg0.aString99 : arg0.aString99 + Class74.aClass74_140.method1259(Class106.aClass717_8) + arg0.aString100;
		} else if (arg0.aString100 == null || arg0.aString100.length() <= 0) {
			return arg0.aString99 + Class74.aClass74_140.method1259(Class106.aClass717_8) + arg0.aString98;
		} else {
			return arg0.aString99 + Class74.aClass74_140.method1259(Class106.aClass717_8) + arg0.aString100 + Class74.aClass74_140.method1259(Class106.aClass717_8) + arg0.aString98;
		}
	}

	@OriginalMember(owner = "client!agw", name = "jh", descriptor = "([Lclient!hf;Lclient!hf;ZI)V", line = 10883)
	static void method8545(@OriginalArg(0) Class312[] arg0, @OriginalArg(1) Class312 arg1, @OriginalArg(2) boolean arg2) {
		...
		Class206.method24700(arg0, arg1.anInt3953 * -1549590237, local15, local31, arg2);
		if (arg1.aClass312Array1 != null) {
			Class206.method24700(arg1.aClass312Array1, arg1.anInt3953 * -1549590237, local15, local31, arg2);
		}
		@Pc(64) Class93_Sub40 local64 = (Class93_Sub40) client.aClass16_22.method215((long) (arg1.anInt3953 * -1549590237));
		if (local64 != null) {
			Class568.method31297(local64.anInt3172 * 1220811495, local15, local31, arg2);
		}
		...
		for (local86 = 0; local86 < local82; local86++) {
			...
			if (local95 != null) {
				local95.method19976(local15, local31, arg2);
			}
		}
		for (local86 = 0; local86 < client.anInt3540 * 568731113; local86++) {
			...
			if (local123 != null) {
				((Class132_Sub1_Sub1_Sub1) local123.anObject5).method19976(local15, local31, arg2);
			}
		}
	}
}
