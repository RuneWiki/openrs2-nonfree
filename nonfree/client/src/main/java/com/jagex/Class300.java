...
public class Class300 implements Interface25 {
	...
	public void method26713(@OriginalArg(0) Class297 arg0) {
		arg0.method26625(this.aClass304_2, (byte) 124);
	}
	...
	public void method26715(@OriginalArg(0) Class297 arg0, @OriginalArg(1) byte arg1) {
		arg0.method26625(this.aClass304_2, (byte) 100);
	}
	...
	public void method26714(@OriginalArg(0) Class297 arg0) {
		arg0.method26625(this.aClass304_2, (byte) 16);
	}
	...
	Class300(@OriginalArg(0) Class303 arg0, @OriginalArg(1) Class93_Sub41 arg1) {
		this.this$0 = arg0;
		@Pc(13) boolean local13 = arg1.method22413((short) 16384) != 255;
		if (local13) {
	...
	public static int method26716(@OriginalArg(0) int arg0) {
		return Class653.aClass357_1.method27732(593453344);
	}

	@OriginalMember(owner = "client!gt", name = "u", descriptor = "(I)I", line = 333)
	static int method26717(@OriginalArg(0) int arg0) {
	...
	static final void method26718(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1853806941);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class275.method26342(local16, local22, arg0, -1627776056);
	}

	@OriginalMember(owner = "client!gt", name = "bbt", descriptor = "(Lclient!yf;I)V", line = 14390)
	static final void method26719(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5891 -= 1189701933;
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!gt", name = "m", descriptor = "(Ljava/io/File;I)[B", line = 31)
	public static byte[] method26720(@OriginalArg(0) File arg0, @OriginalArg(1) int arg1) {
		return Class27.method591(arg0, (int) arg0.length(), -185960568);
	}

	@OriginalMember(owner = "client!gt", name = "m", descriptor = "(IIIB)I", line = 37)
	public static int method26721(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
	...
	static boolean method26722(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class93_Sub29 arg1, @OriginalArg(2) Class322 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) byte arg5) {
		...
		if (arg2.anIntArray398 != null) {
			arg2 = arg2.method27252(Class159_Sub1.anInterface21_2, Class159_Sub1.anInterface23_2, (short) 565);
			if (arg2 == null) {
				return false;
			}
		}
		...
		if (arg2.anInt4126 * -498063801 != -1) {
			if (arg1.aBoolean340 && arg2.anInt4129 * 2059687735 != -1) {
				local130 = arg2.method27253(arg0, true, 2146874587);
			} else {
				local130 = arg2.method27253(arg0, false, 2094701490);
			}
			if (local130 != null) {
		...
		if (arg2.anInt4112 * -2050445699 != -1) {
			local306 = arg2.method27254(arg0, (byte) -93);
		}
		...
		if (arg2.aString174 != null) {
			Class254.method26001(arg2.anInt4116 * 1579741579, -1078358079);
		...
		if (local130 != null) {
			...
			if (local586 != null && arg2.anInt4112 * -2050445699 == -1) {
				...
				if (arg0 instanceof Class104_Sub2) {
					arg0.method20600(arg1.anInt1606 * 704671089 - local489 - 7, arg1.anInt1607 * 1844815193 - local495 - 7, local130.method18189() + 14, local130.method18189() + 14, local645, (byte) 91);
					arg0.method20600(arg1.anInt1606 * 704671089 - local489 - 5, arg1.anInt1607 * 1844815193 - local495 - 5, local130.method18189() + 10, local130.method18189() + 10, local645, (byte) 106);
					arg0.method20600(arg1.anInt1606 * 704671089 - local489 - 3, arg1.anInt1607 * 1844815193 - local495 - 3, local130.method18189() + 6, local130.method18189() + 6, local645, (byte) 58);
					arg0.method20600(arg1.anInt1606 * 704671089 - local489 - 1, arg1.anInt1607 * 1844815193 - local495 - 1, local130.method18189() + 2, local130.method18189() + 2, local645, (byte) 87);
					arg0.method20600(arg1.anInt1606 * 704671089 - local489, arg1.anInt1607 * 1844815193 - local495, local130.method18189(), local130.method18189(), local645, (byte) 23);
				} else {
					arg0.method20474(arg1.anInt1606 * 704671089 - local491, arg1.anInt1607 * 1844815193 - local497, local130.method18189() / 2 + 7, local645, 1717415110);
					arg0.method20474(arg1.anInt1606 * 704671089 - local491, arg1.anInt1607 * 1844815193 - local497 - local497 == 0 ? 0 : 1, local130.method18189() / 2 + 5, local645, 1703234046);
					arg0.method20474(arg1.anInt1606 * 704671089 - local491, arg1.anInt1607 * 1844815193 - local497 - local497 == 0 ? 0 : 1, local130.method18189() / 2 + 3, local645, 2063689017);
					arg0.method20474(arg1.anInt1606 * 704671089 - local491, arg1.anInt1607 * 1844815193 - local497 - local497 == 0 ? 0 : 1, local130.method18189() / 2 + 1, local645, 1590298050);
					arg0.method20474(arg1.anInt1606 * 704671089 - local491, arg1.anInt1607 * 1844815193 - local497 - local497 == 0 ? 0 : 1, local130.method18189() / 2, local645, 2088821106);
				}
			}
