...
public class class495 {
	...
	public void method7730() {
		this.field5062.method9980(this, (class660) null, 0);
	}
	...
	public void method7762(int arg0) {
		...
		if (arg0 == 3) {
			for (int var4 = 0; var4 < client.field10906; var4++) {
				...
				if (var5 != null) {
					...
					var8.field4308 -= (float) (var2 * 512);
					var8.field4313 -= (float) (var3 * 512);
			...
			for (int var12 = 0; var12 < client.field10906; var12++) {
				...
				if (var13 != null) {
					...
					var15.field4308 -= (float) (var2 * 512);
					var15.field4313 -= (float) (var3 * 512);
					...
					if ((int) var15.field4308 >= 0 && (int) var15.field4308 <= var10 && (int) var15.field4313 >= 0 && (int) var15.field4313 <= var11) {
						...
						if (var16) {
							...
							var14.method19156((class260) null);
							var13.method8440();
							var9 = true;
						}
					} else {
		...
		for (int var21 = 0; var21 < 2048; var21++) {
			...
			if (var22 != null) {
				...
				var24.field4308 -= (float) (var2 * 512);
				var24.field4313 -= (float) (var3 * 512);
	...
	public boolean method7723() {
		...
		if (client.field11005 == 0) {
			this.field5030.method8737((class140) null);
		} else {
		...
		if (var19) {
			...
			this.field5033.method7144(Statics.field8198, (int[][][]) null);
			this.field5030.method8703(false);
			if (this.field5036) {
				this.method7765(50);
			}
		...
		this.field5023.method7200(Statics.field8198, var19 ? this.field5030.field6917[0] : null, (class104) null);
		if (this.field5036) {
			this.method7765(75);
		}
		...
		if (var19) {
			...
			this.field5033.method7200(Statics.field8198, (class104) null, this.field5030.field6915[0]);
