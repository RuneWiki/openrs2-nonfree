...
public class class837 extends class104 {
		...
		for (int var9 = 0; var9 <= this.field1234; var9++) {
			for (int var10 = 0; var10 <= this.field1235; var10++) {
				...
				if ((float) var11 < this.field9495) {
					this.field9495 = (float) var11;
				}
				if ((float) var11 > this.field9512) {
					this.field9512 = (float) var11;
				}
	...
	public void method15414() {
		if ((this.field9490 & 0x2) == 0) {
			this.field9501 = (int[][][]) null;
			this.field9506 = (int[][][]) null;
			this.field9510 = (int[][][]) null;
		}
		this.field9503 = (int[][][]) null;
		this.field9499 = (int[][][]) null;
		this.field9502 = (int[][][]) null;
		this.field9507 = (class981[][][]) null;
		this.field9514 = (byte[][]) null;
		this.field9513 = null;
		this.field9497 = null;
		this.field9487 = (float[][]) null;
		this.field9515 = (float[][]) null;
		this.field9486 = (float[][]) null;
	}
