...
public class Class364 implements Interface30 {
	...
	final int method27886(@OriginalArg(0) int arg0) {
	...
	final int method27882(@OriginalArg(0) int arg0) {
	...
	public void method27924(@OriginalArg(0) boolean arg0) {
		if (!this.aBoolean734 && !this.aBoolean731) {
			...
			try {
				@Pc(13) String[] local13 = client.method25402(client.aString148, '|');
				if (local13.length < 3) {
					...
					for (@Pc(30) int local30 = 0; local30 < local13.length; local30++) {
						@Pc(42) String[] local42 = client.method25402(local13[local30].trim(), '=');
						if (local42[0].equals("halign")) {
							...
							if (local42[0].equals("image")) {
								local81 = client.method25402(local42[1], ',');
								try {
									local88 = this.method27893(local81[0]);
								} catch (@Pc(90) Exception local90) {
									local88 = null;
								}
								if (local88 != null) {
									local26.addImage(local88, local28++);
									this.aList20.add(new Class129_Sub2(this, local88, Class616.method32090(local81[1]), Class616.method32090(local81[2])));
								}
								...
								if (local88 != null) {
									local26.addImage(local88, local28++);
									this.aList20.add(new Class129_Sub2_Sub1(this, local88, Class616.method32090(local81[1]), Class616.method32090(local81[2]), Float.parseFloat(local81[3])));
								}
							} else if (local42[0].equals("progress")) {
								local81 = client.method25402(local42[1], ',');
								this.aList20.add(new Class129_Sub1(this, Boolean.parseBoolean(local81[0]), local81[1], Class616.method32090(local81[2]), Integer.decode(local81[3]), Class616.method32090(local81[4]), Class616.method32090(local81[5])));
							}
						}
					}
					local26.waitForAll();
		...
		try {
			this.aString189 = "" + Class653.aClass357_1.method27737() + "%";
			this.aString190 = Class653.aClass357_1.method27738();
	...
	public static boolean method27900(@OriginalArg(0) int arg0) {
	...
	void method27883() {
		Class597.method31781(Class653.aClass357_1.method27737(), Class653.aClass357_1.method27738(), client.aColorArray1[client.anInt3427 * 182213747], client.aColorArray2[client.anInt3427 * 182213747], client.aColorArray3[client.anInt3427 * 182213747]);
	}
	...
	static final void method27899(@OriginalArg(0) Class681 arg0) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class707.method36747(local11, local14, arg0);
	}
}
