...
public class Class364 implements Interface30 {
	...
	public void method27924(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		if (!this.aBoolean734 && !this.aBoolean731) {
			...
			try {
				@Pc(13) String[] local13 = client.method25402(client.aString148, '|', 1822851704);
				if (local13.length < 3) {
					...
					for (@Pc(30) int local30 = 0; local30 < local13.length; local30++) {
						@Pc(42) String[] local42 = client.method25402(local13[local30].trim(), '=', 1941630767);
						if (local42[0].equals("halign")) {
							...
							if (local42[0].equals("image")) {
								local81 = client.method25402(local42[1], ',', 1615197979);
								try {
									local88 = this.method27893(local81[0], -173246230);
								...
								local81 = client.method25402(local42[1], ',', 2101413543);
								try {
									local88 = this.method27893(local81[0], -720276248);
								...
								local81 = client.method25402(local42[1], ',', 1871956333);
		...
		try {
			this.aString189 = "" + Class653.aClass357_1.method27737(1285578807) + "%";
			this.aString190 = Class653.aClass357_1.method27738((byte) -48);
			...
			while (local299.hasNext()) {
				...
				local306.method21471(local282, (byte) -20);
			}
			local246.drawImage(Class115.anImage3, 0, 0, (ImageObserver) null);
	...
	void method27883() {
		Class597.method31781(Class653.aClass357_1.method27737(1285578807), Class653.aClass357_1.method27738((byte) -1), client.aColorArray1[client.anInt3427 * 182213747], client.aColorArray2[client.anInt3427 * 182213747], client.aColorArray3[client.anInt3427 * 182213747], -886980436);
	}

	@OriginalMember(owner = "client!jm", name = "f", descriptor = "(I)V", line = 159)
	void method27884(@OriginalArg(0) int arg0) {
		Class597.method31781(Class653.aClass357_1.method27737(1285578807), Class653.aClass357_1.method27738((byte) -79), client.aColorArray1[client.anInt3427 * 182213747], client.aColorArray2[client.anInt3427 * 182213747], client.aColorArray3[client.anInt3427 * 182213747], -886980436);
	}

	@OriginalMember(owner = "client!jm", name = "w", descriptor = "(B)V", line = 163)
	@Override
	public void method27925(@OriginalArg(0) byte arg0) {
		Class110.method20149((byte) -74);
	}

	@OriginalMember(owner = "client!jm", name = "x", descriptor = "(Ljava/lang/String;)Ljava/awt/Image;", line = 137)
	Image method27885(@OriginalArg(0) String arg0) throws IOException {
	...
	final int method27889(@OriginalArg(0) int arg0) {
		return this.aBoolean733 ? (Class553.anInt3408 * -1378711501 - arg0) / 2 : 0;
	}

	@OriginalMember(owner = "client!jm", name = "v", descriptor = "(I)I", line = 38)
	final int method27890(@OriginalArg(0) int arg0) {
		return this.aBoolean732 ? (Class553.anInt3416 * 2091353777 - arg0) / 2 : 0;
	}

	@OriginalMember(owner = "client!jm", name = "o", descriptor = "(I)I", line = 38)
	final int method27891(@OriginalArg(0) int arg0) {
		return this.aBoolean732 ? (Class553.anInt3416 * 2091353777 - arg0) / 2 : 0;
	}
	...
	Image method27892(@OriginalArg(0) String arg0) throws IOException {
		@Pc(1) InputStream local1 = null;
		try {
			local1 = Class32_Sub10.anApplet2.getClass().getClassLoader().getResourceAsStream(arg0);
			@Pc(10) byte[] local10 = new byte[12000];
	...
	Image method27893(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) throws IOException {
		@Pc(1) InputStream local1 = null;
		try {
			local1 = Class32_Sub10.anApplet2.getClass().getClassLoader().getResourceAsStream(arg0);
			@Pc(10) byte[] local10 = new byte[12000];
	...
	void method27894() {
		Class597.method31781(Class653.aClass357_1.method27737(1285578807), Class653.aClass357_1.method27738((byte) -88), client.aColorArray1[client.anInt3427 * 182213747], client.aColorArray2[client.anInt3427 * 182213747], client.aColorArray3[client.anInt3427 * 182213747], -886980436);
	}
	...
	public void method27929(@OriginalArg(0) boolean arg0) {
		if (!this.aBoolean734 && !this.aBoolean731) {
			this.aBoolean731 = true;
			try {
				@Pc(13) String[] local13 = client.method25402(client.aString148, '|', 1885218557);
				if (local13.length < 3) {
					this.aBoolean734 = true;
				} else {
					@Pc(26) MediaTracker local26 = new MediaTracker(Class125_Sub3.aCanvas1);
					@Pc(28) int local28 = 0;
					for (@Pc(30) int local30 = 0; local30 < local13.length; local30++) {
						@Pc(42) String[] local42 = client.method25402(local13[local30].trim(), '=', 1779216387);
						if (local42[0].equals("halign")) {
							this.aBoolean733 = Boolean.parseBoolean(local42[1]);
						} else if (local42[0].equals("valign")) {
							this.aBoolean732 = Boolean.parseBoolean(local42[1]);
							...
							@Pc(88) Image local88;
							if (local42[0].equals("image")) {
								local81 = client.method25402(local42[1], ',', 1700938706);
								try {
									local88 = this.method27893(local81[0], -818780408);
								} catch (@Pc(90) Exception local90) {
									local88 = null;
								}
								if (local88 != null) {
								...
								local81 = client.method25402(local42[1], ',', 2066863899);
								try {
									local88 = this.method27893(local81[0], 1110397707);
								} catch (@Pc(143) Exception local143) {
									local88 = null;
								}
								if (local88 != null) {
								...
								local81 = client.method25402(local42[1], ',', 1562150473);
								this.aList20.add(new Class129_Sub1(this, Boolean.parseBoolean(local81[0]), local81[1], Class616.method32090(local81[2], (byte) 8), Integer.decode(local81[3]), Class616.method32090(local81[4], (byte) 8), Class616.method32090(local81[5], (byte) 8)));
							}
						}
					}
		...
		try {
			this.aString189 = "" + Class653.aClass357_1.method27737(1285578807) + "%";
			this.aString190 = Class653.aClass357_1.method27738((byte) -87);
			if (Class115.anImage3 == null) {
				Class115.anImage3 = Class125_Sub3.aCanvas1.createImage(Class553.anInt3408 * -1378711501, Class553.anInt3416 * 2091353777);
			}
			@Pc(282) Graphics local282 = Class115.anImage3.getGraphics();
			...
			while (local299.hasNext()) {
				@Pc(306) Class129 local306 = (Class129) local299.next();
				local306.method21471(local282, (byte) 9);
			}
			local246.drawImage(Class115.anImage3, 0, 0, (ImageObserver) null);
		} catch (@Pc(320) Exception local320) {
			this.aBoolean734 = true;
	...
	void method27895() {
		Class597.method31781(Class653.aClass357_1.method27737(1285578807), Class653.aClass357_1.method27738((byte) -94), client.aColorArray1[client.anInt3427 * 182213747], client.aColorArray2[client.anInt3427 * 182213747], client.aColorArray3[client.anInt3427 * 182213747], -886980436);
	}

	@OriginalMember(owner = "client!jm", name = "i", descriptor = "()V", line = 163)
	@Override
	public void method27934() {
		Class110.method20149((byte) -53);
	}

	@OriginalMember(owner = "client!jm", name = "s", descriptor = "(Ljava/lang/String;)Ljava/awt/Image;", line = 137)
	Image method27896(@OriginalArg(0) String arg0) throws IOException {
		@Pc(1) InputStream local1 = null;
		try {
			local1 = Class32_Sub10.anApplet2.getClass().getClassLoader().getResourceAsStream(arg0);
			@Pc(10) byte[] local10 = new byte[12000];
	...
	Image method27897(@OriginalArg(0) String arg0) throws IOException {
		@Pc(1) InputStream local1 = null;
		try {
			local1 = Class32_Sub10.anApplet2.getClass().getClassLoader().getResourceAsStream(arg0);
			@Pc(10) byte[] local10 = new byte[12000];
	...
	Image method27898(@OriginalArg(0) String arg0) throws IOException {
		@Pc(1) InputStream local1 = null;
		try {
			local1 = Class32_Sub10.anApplet2.getClass().getClassLoader().getResourceAsStream(arg0);
			@Pc(10) byte[] local10 = new byte[12000];
	...
	public void method27935(@OriginalArg(0) boolean arg0) {
		if (!this.aBoolean734 && !this.aBoolean731) {
			this.aBoolean731 = true;
			try {
				@Pc(13) String[] local13 = client.method25402(client.aString148, '|', 1680840912);
				if (local13.length < 3) {
					this.aBoolean734 = true;
				} else {
					@Pc(26) MediaTracker local26 = new MediaTracker(Class125_Sub3.aCanvas1);
					@Pc(28) int local28 = 0;
					for (@Pc(30) int local30 = 0; local30 < local13.length; local30++) {
						@Pc(42) String[] local42 = client.method25402(local13[local30].trim(), '=', 2037301180);
						if (local42[0].equals("halign")) {
							this.aBoolean733 = Boolean.parseBoolean(local42[1]);
						} else if (local42[0].equals("valign")) {
							this.aBoolean732 = Boolean.parseBoolean(local42[1]);
							...
							@Pc(88) Image local88;
							if (local42[0].equals("image")) {
								local81 = client.method25402(local42[1], ',', 2035935230);
								try {
									local88 = this.method27893(local81[0], 649181535);
								} catch (@Pc(90) Exception local90) {
									local88 = null;
								}
								if (local88 != null) {
								...
								local81 = client.method25402(local42[1], ',', 1971352555);
								try {
									local88 = this.method27893(local81[0], -1118071479);
								} catch (@Pc(143) Exception local143) {
									local88 = null;
								}
								if (local88 != null) {
								...
								local81 = client.method25402(local42[1], ',', 1817015006);
								this.aList20.add(new Class129_Sub1(this, Boolean.parseBoolean(local81[0]), local81[1], Class616.method32090(local81[2], (byte) 8), Integer.decode(local81[3]), Class616.method32090(local81[4], (byte) 8), Class616.method32090(local81[5], (byte) 8)));
							}
						}
					}
		...
		try {
			this.aString189 = "" + Class653.aClass357_1.method27737(1285578807) + "%";
			this.aString190 = Class653.aClass357_1.method27738((byte) -94);
			if (Class115.anImage3 == null) {
				Class115.anImage3 = Class125_Sub3.aCanvas1.createImage(Class553.anInt3408 * -1378711501, Class553.anInt3416 * 2091353777);
			}
			@Pc(282) Graphics local282 = Class115.anImage3.getGraphics();
			...
			while (local299.hasNext()) {
				@Pc(306) Class129 local306 = (Class129) local299.next();
				local306.method21471(local282, (byte) -18);
			}
			local246.drawImage(Class115.anImage3, 0, 0, (ImageObserver) null);
		} catch (@Pc(320) Exception local320) {
			this.aBoolean734 = true;
	...
	static final void method27899(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class707.method36747(local11, local14, arg0, 1160214285);
	}

	@OriginalMember(owner = "client!jm", name = "l", descriptor = "(II)Z", line = 70)
	public static boolean method27900(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
