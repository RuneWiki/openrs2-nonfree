...
public class Class121_Sub1 extends Class121 {
	...
	public void method28282(@OriginalArg(0) boolean arg0) {
		@Pc(17) int local17 = this.aClass133_2.aClass390_6.method28273(this.aClass100_8.method18160(), client.anInt3511 * 2040043391, -1260493662) + this.aClass133_2.anInt1131 * -1599175185;
		@Pc(35) int local35 = this.aClass133_2.aClass392_6.method28290(this.aClass100_8.method18166(), client.anInt3512 * -817449061, (short) 255) + this.aClass133_2.anInt1132 * -1271918157;
		this.aClass100_8.method18181((float) (local17 + this.aClass100_8.method18160() / 2), (float) (local35 + this.aClass100_8.method18166() / 2), 4096, this.anInt1004 * -1472062523);
	...
	public void method28281(@OriginalArg(0) boolean arg0) {
		@Pc(17) int local17 = this.aClass133_2.aClass390_6.method28273(this.aClass100_8.method18160(), client.anInt3511 * 2040043391, -1152049963) + this.aClass133_2.anInt1131 * -1599175185;
		@Pc(35) int local35 = this.aClass133_2.aClass392_6.method28290(this.aClass100_8.method18166(), client.anInt3512 * -817449061, (short) 255) + this.aClass133_2.anInt1132 * -1271918157;
		this.aClass100_8.method18181((float) (local17 + this.aClass100_8.method18160() / 2), (float) (local35 + this.aClass100_8.method18166() / 2), 4096, this.anInt1004 * -1472062523);
		this.anInt1004 += ((Class133_Sub1) this.aClass133_2).anInt1134 * -95441819;
	}
	...
	public void method28285(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		@Pc(17) int local17 = this.aClass133_2.aClass390_6.method28273(this.aClass100_8.method18160(), client.anInt3511 * 2040043391, 2072623825) + this.aClass133_2.anInt1131 * -1599175185;
		@Pc(35) int local35 = this.aClass133_2.aClass392_6.method28290(this.aClass100_8.method18166(), client.anInt3512 * -817449061, (short) 255) + this.aClass133_2.anInt1132 * -1271918157;
		this.aClass100_8.method18181((float) (local17 + this.aClass100_8.method18160() / 2), (float) (local35 + this.aClass100_8.method18166() / 2), 4096, this.anInt1004 * -1472062523);
		this.anInt1004 += ((Class133_Sub1) this.aClass133_2).anInt1134 * -95441819;
	}
	...
	public static Class133 method8710(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class133 local3 = Class449.method28928(arg0, 1357920860);
		@Pc(7) int local7 = arg0.method22408(-87715282);
