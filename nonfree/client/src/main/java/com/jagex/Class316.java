...
public class Class316 {
	...
	void method27166(@OriginalArg(0) int[] arg0) {
		if (arg0 != null) {
	...
	void method27167(@OriginalArg(0) int[] arg0) {
		if (arg0 != null) {
			for (@Pc(4) int local4 = 0; local4 < arg0.length; local4++) {
				arg0[local4] = 0;
			}
	...
	void method27158(@OriginalArg(0) Class315 arg0) {
		this.aClass315_2 = arg0;
		@Pc(6) int local6 = this.aClass315_2.method27134();
		this.aClass315_2.method27136(16);
		this.anInt4092 = this.aClass315_2.method27130() == 0 ? 1 : this.aClass315_2.method27136(4) + 1;
		@Pc(77) int local77;
		if (this.aClass315_2.method27130() == 0) {
			this.anInt4093 = 0;
		} else {
			this.anInt4093 = this.aClass315_2.method27136(8) + 1;
			if (this.anIntArray388 != null && this.anIntArray388.length == this.anInt4093) {
				this.method27167(this.anIntArray388);
			} else {
				this.anIntArray388 = new int[this.anInt4093];
			}
			if (this.anIntArray391 != null && this.anIntArray391.length == this.anInt4093) {
				this.method27167(this.anIntArray391);
			} else {
				this.anIntArray391 = new int[this.anInt4093];
			}
			for (local77 = 0; local77 < this.anInt4093; local77++) {
				this.anIntArray388[local77] = this.aClass315_2.method27136(this.method27161(local6 - 1));
				this.anIntArray391[local77] = this.aClass315_2.method27136(this.method27161(local6 - 1));
			}
		}
		this.aClass315_2.method27136(2);
		if (this.anInt4092 > 1) {
			this.anIntArray387 = new int[local6];
			for (local77 = 0; local77 < local6; local77++) {
				this.anIntArray387[local77] = this.aClass315_2.method27136(4);
			}
		}
		if (this.anIntArray390 != null && this.anIntArray390.length == this.anInt4092) {
			this.method27167(this.anIntArray390);
		} else {
			this.anIntArray390 = new int[this.anInt4092];
		}
		if (this.anIntArray389 != null && this.anIntArray389.length == this.anInt4092) {
			this.method27167(this.anIntArray389);
		} else {
			this.anIntArray389 = new int[this.anInt4092];
		}
		for (local77 = 0; local77 < this.anInt4092; local77++) {
			this.aClass315_2.method27136(8);
			this.anIntArray390[local77] = this.aClass315_2.method27136(8);
			this.anIntArray389[local77] = this.aClass315_2.method27136(8);
		}
	}

	@OriginalMember(owner = "client!hl", name = "z", descriptor = "(Lclient!hk;)V", line = 25)
	void method27159(@OriginalArg(0) Class315 arg0) {
		this.aClass315_2 = arg0;
		@Pc(6) int local6 = this.aClass315_2.method27134();
		this.aClass315_2.method27136(16);
		this.anInt4092 = this.aClass315_2.method27130() == 0 ? 1 : this.aClass315_2.method27136(4) + 1;
	...
	int method27161(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = 0;
		while (arg0 > 0) {
			local1++;
			arg0 >>= 0x1;
	...
	int method27162(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = 0;
		while (arg0 > 0) {
			local1++;
			arg0 >>= 0x1;
