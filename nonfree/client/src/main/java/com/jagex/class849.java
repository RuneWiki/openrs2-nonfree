...
public class class849 extends class133 {
	...
	public class849(Canvas arg0, class125 arg1, class143 arg2, class383 arg3, class381 arg4, class378 arg5, int arg6) {
		...
		try {
			try {
				...
				this.field9878 = (Unsafe) var8.get((Object) null);
	...
	public void method2163(int arg0, int arg1, int arg2) {
		...
		OpenGL.glReadPixelsub(0, 0, this.field1615, this.field1588, 32993, 5121, (byte[]) null, 0);
	...
	public long method2158(int arg0, int arg1) {
		return this.method15733(arg0, arg1, (int[]) null, (int[]) null);
	}
	...
	public void method15742() {
		...
		for (var1 = 0; var1 < this.field9898; var1++) {
			...
			int var3 = var1 + 16386;
			field9894[0] = (float) var2.method17605();
			field9894[1] = (float) var2.method17606();
			field9894[2] = (float) var2.method17607();
			field9894[3] = 1.0F;
