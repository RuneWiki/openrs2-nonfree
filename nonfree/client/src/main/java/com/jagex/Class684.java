...
public class Class684 {
	...
	public float method33357(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public float method33360(@OriginalArg(0) int arg0) {
		return this.aFloat358;
	}

	@OriginalMember(owner = "client!yj", name = "<init>", descriptor = "()V", line = 28)
	public Class684() {
		this.method33413((short) 5805);
	}

	@OriginalMember(owner = "client!yj", name = "n", descriptor = "(Lclient!alw;I)Z", line = 57)
	public boolean method33361(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		@Pc(3) long local3 = arg0.method22423(1762565155);
		if (local3 == 0L) {
			this.anInt5897 = arg0.method22415(-1434290800) * -521668953;
			return false;
		}
		if ((local3 & Class680.aClass680_9.aLong307 * 7134854499111106275L) != 0L) {
			this.anInt5904 = arg0.method22419(-118643075) * -14325749;
		}
		if ((local3 & Class680.aClass680_1.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat358 = arg0.method22425(471391583);
		}
		if ((local3 & Class680.aClass680_22.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat356 = arg0.method22425(-64354544);
		}
		if ((local3 & Class680.aClass680_4.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat355 = arg0.method22425(-1965021142);
		}
		...
		if ((local3 & Class680.aClass680_13.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1605293267);
		}
		if ((local3 & Class680.aClass680_10.aLong307 * 7134854499111106275L) != 0L) {
			this.anInt5896 = arg0.method22419(-118643075) * -1757047085;
		}
		if ((local3 & Class680.aClass680_8.aLong307 * 7134854499111106275L) != 0L) {
			this.anInt5895 = arg0.method22415(-1434290800) * 268363761;
		}
		if ((local3 & Class680.aClass680_39.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1542518423);
		}
		if ((local3 & Class680.aClass680_40.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1989677016);
		}
		if ((local3 & Class680.aClass680_43.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-946274703);
		}
		if ((local3 & Class680.aClass680_2.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1342700002);
		}
		if ((local3 & Class680.aClass680_7.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat357 = arg0.method22425(-32617529);
		}
		if ((local3 & Class680.aClass680_14.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat359 = arg0.method22425(2063645248);
		}
		if ((local3 & Class680.aClass680_15.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat360 = arg0.method22425(-1279287504);
		}
		if ((local3 & Class680.aClass680_16.aLong307 * 7134854499111106275L) != 0L) {
			this.anInt5898 = arg0.method22415(-1434290800) * 304329139;
		}
		if ((local3 & Class680.aClass680_17.aLong307 * 7134854499111106275L) != 0L) {
			this.anInt5899 = arg0.method22415(-1434290800) * 972166225;
			this.anInt5900 = arg0.method22482((byte) -65) * -535776559;
			this.anInt5901 = arg0.method22482((byte) -18) * -1145348855;
			this.anInt5902 = arg0.method22482((byte) -38) * 1206173817;
			this.anInt5903 = arg0.method22415(-1434290800) * 1258086185;
		}
		if ((local3 & Class680.aClass680_18.aLong307 * 7134854499111106275L) != 0L) {
			this.anIntArray521[0] = arg0.method22415(-1434290800);
			this.aFloatArray122[0] = arg0.method22425(-337047699);
		}
		if ((local3 & Class680.aClass680_19.aLong307 * 7134854499111106275L) != 0L) {
			this.anIntArray521[1] = arg0.method22415(-1434290800);
			this.aFloatArray122[1] = arg0.method22425(-1442856252);
		}
		if ((local3 & Class680.aClass680_20.aLong307 * 7134854499111106275L) != 0L) {
			this.anIntArray521[2] = arg0.method22415(-1434290800);
			this.aFloatArray122[2] = arg0.method22425(-1989095495);
		}
	...
	public Class472 method33362(@OriginalArg(0) int arg0) {
	...
	public boolean method33378(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(3) long local3 = arg0.method22423(336671967);
		if (local3 == 0L) {
			this.anInt5897 = arg0.method22415(-1434290800) * -521668953;
			return false;
		}
		...
		if ((local3 & Class680.aClass680_1.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat358 = arg0.method22425(356891643);
		}
		if ((local3 & Class680.aClass680_22.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat356 = arg0.method22425(1334333912);
		}
		if ((local3 & Class680.aClass680_4.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat355 = arg0.method22425(-1887245744);
		}
		if ((local3 & Class680.aClass680_5.aLong307 * 7134854499111106275L) != 0L) {
			this.aClass472_66 = Class472.method29531(arg0);
		}
		if ((local3 & Class680.aClass680_13.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(1908029504);
		}
		if ((local3 & Class680.aClass680_10.aLong307 * 7134854499111106275L) != 0L) {
			this.anInt5896 = arg0.method22419(-118643075) * -1757047085;
		}
		...
		if ((local3 & Class680.aClass680_39.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(1684930371);
		}
		if ((local3 & Class680.aClass680_40.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1164621739);
		}
		if ((local3 & Class680.aClass680_43.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(1313755511);
		}
		if ((local3 & Class680.aClass680_2.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(1888770555);
		}
		if ((local3 & Class680.aClass680_7.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat357 = arg0.method22425(1388008981);
		}
		if ((local3 & Class680.aClass680_14.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat359 = arg0.method22425(-1499454135);
		}
		if ((local3 & Class680.aClass680_15.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat360 = arg0.method22425(561995874);
		}
		if ((local3 & Class680.aClass680_16.aLong307 * 7134854499111106275L) != 0L) {
			this.anInt5898 = arg0.method22415(-1434290800) * 304329139;
		}
		if ((local3 & Class680.aClass680_17.aLong307 * 7134854499111106275L) != 0L) {
			this.anInt5899 = arg0.method22415(-1434290800) * 972166225;
			this.anInt5900 = arg0.method22482((byte) -38) * -535776559;
			this.anInt5901 = arg0.method22482((byte) -37) * -1145348855;
			this.anInt5902 = arg0.method22482((byte) -47) * 1206173817;
			this.anInt5903 = arg0.method22415(-1434290800) * 1258086185;
		}
		if ((local3 & Class680.aClass680_18.aLong307 * 7134854499111106275L) != 0L) {
			this.anIntArray521[0] = arg0.method22415(-1434290800);
			this.aFloatArray122[0] = arg0.method22425(411792530);
		}
		if ((local3 & Class680.aClass680_19.aLong307 * 7134854499111106275L) != 0L) {
			this.anIntArray521[1] = arg0.method22415(-1434290800);
			this.aFloatArray122[1] = arg0.method22425(1669122634);
		}
		if ((local3 & Class680.aClass680_20.aLong307 * 7134854499111106275L) != 0L) {
			this.anIntArray521[2] = arg0.method22415(-1434290800);
			this.aFloatArray122[2] = arg0.method22425(-257529985);
		}
		if ((local3 & Class680.aClass680_21.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22419(-118643075);
		}
		...
		if ((local3 & Class680.aClass680_36.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-357362190);
		}
		if ((local3 & Class680.aClass680_24.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-2094475496);
		}
		if ((local3 & Class680.aClass680_25.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(2127206473);
		}
		if ((local3 & Class680.aClass680_26.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-568005931);
		}
		if ((local3 & Class680.aClass680_27.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-2023342953);
		}
		if ((local3 & Class680.aClass680_28.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22419(-118643075);
		}
		if ((local3 & Class680.aClass680_29.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(1823731378);
		}
		if ((local3 & Class680.aClass680_30.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(1071902988);
		}
		if ((local3 & Class680.aClass680_12.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1423934921);
		}
		if ((local3 & Class680.aClass680_32.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(674057298);
		}
		if ((local3 & Class680.aClass680_33.aLong307 * 7134854499111106275L) != 0L) {
			new Class472(arg0);
		}
		...
		if ((local3 & Class680.aClass680_37.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-386795373);
		}
		if ((local3 & Class680.aClass680_3.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(1422064667);
		}
		if ((local3 & Class680.aClass680_38.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(1173266850);
		}
		if ((local3 & Class680.aClass680_23.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-297366350);
		}
		if ((local3 & Class680.aClass680_45.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(2036986882);
		}
		if ((local3 & Class680.aClass680_41.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(124721549);
		}
		if ((local3 & Class680.aClass680_42.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1735999455);
		}
		if ((local3 & Class680.aClass680_6.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-393316646);
		}
		if ((local3 & Class680.aClass680_44.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22419(-118643075);
		}
	...
	public boolean method33379(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(3) long local3 = arg0.method22423(-1453861062);
		if (local3 == 0L) {
			this.anInt5897 = arg0.method22415(-1434290800) * -521668953;
			return false;
		}
		...
		if ((local3 & Class680.aClass680_1.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat358 = arg0.method22425(427086929);
		}
		if ((local3 & Class680.aClass680_22.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat356 = arg0.method22425(-1835703283);
		}
		if ((local3 & Class680.aClass680_4.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat355 = arg0.method22425(-266118701);
		}
		if ((local3 & Class680.aClass680_5.aLong307 * 7134854499111106275L) != 0L) {
			this.aClass472_66 = Class472.method29531(arg0);
		}
		if ((local3 & Class680.aClass680_13.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1579264135);
		}
		if ((local3 & Class680.aClass680_10.aLong307 * 7134854499111106275L) != 0L) {
			this.anInt5896 = arg0.method22419(-118643075) * -1757047085;
		}
		...
		if ((local3 & Class680.aClass680_39.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(358740711);
		}
		if ((local3 & Class680.aClass680_40.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1947241773);
		}
		if ((local3 & Class680.aClass680_43.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(1694214625);
		}
		if ((local3 & Class680.aClass680_2.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1411567409);
		}
		if ((local3 & Class680.aClass680_7.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat357 = arg0.method22425(-487079625);
		}
		if ((local3 & Class680.aClass680_14.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat359 = arg0.method22425(2013289382);
		}
		if ((local3 & Class680.aClass680_15.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat360 = arg0.method22425(-1797426037);
		}
		if ((local3 & Class680.aClass680_16.aLong307 * 7134854499111106275L) != 0L) {
			this.anInt5898 = arg0.method22415(-1434290800) * 304329139;
		}
		if ((local3 & Class680.aClass680_17.aLong307 * 7134854499111106275L) != 0L) {
			this.anInt5899 = arg0.method22415(-1434290800) * 972166225;
			this.anInt5900 = arg0.method22482((byte) -44) * -535776559;
			this.anInt5901 = arg0.method22482((byte) -44) * -1145348855;
			this.anInt5902 = arg0.method22482((byte) -28) * 1206173817;
			this.anInt5903 = arg0.method22415(-1434290800) * 1258086185;
		}
		if ((local3 & Class680.aClass680_18.aLong307 * 7134854499111106275L) != 0L) {
			this.anIntArray521[0] = arg0.method22415(-1434290800);
			this.aFloatArray122[0] = arg0.method22425(-364192595);
		}
		if ((local3 & Class680.aClass680_19.aLong307 * 7134854499111106275L) != 0L) {
			this.anIntArray521[1] = arg0.method22415(-1434290800);
			this.aFloatArray122[1] = arg0.method22425(-1298613563);
		}
		if ((local3 & Class680.aClass680_20.aLong307 * 7134854499111106275L) != 0L) {
			this.anIntArray521[2] = arg0.method22415(-1434290800);
			this.aFloatArray122[2] = arg0.method22425(-2085620513);
		}
		if ((local3 & Class680.aClass680_21.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22419(-118643075);
		}
		...
		if ((local3 & Class680.aClass680_36.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1804658405);
		}
		if ((local3 & Class680.aClass680_24.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-607293836);
		}
		if ((local3 & Class680.aClass680_25.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(290756391);
		}
		if ((local3 & Class680.aClass680_26.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(1766610792);
		}
		if ((local3 & Class680.aClass680_27.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1411259408);
		}
		if ((local3 & Class680.aClass680_28.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22419(-118643075);
		}
		if ((local3 & Class680.aClass680_29.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1236740844);
		}
		if ((local3 & Class680.aClass680_30.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1255293952);
		}
		if ((local3 & Class680.aClass680_12.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1350983496);
		}
		if ((local3 & Class680.aClass680_32.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(1155309684);
		}
		if ((local3 & Class680.aClass680_33.aLong307 * 7134854499111106275L) != 0L) {
			new Class472(arg0);
		}
		...
		if ((local3 & Class680.aClass680_37.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-439829234);
		}
		if ((local3 & Class680.aClass680_3.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(1843064582);
		}
		if ((local3 & Class680.aClass680_38.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1181223720);
		}
		if ((local3 & Class680.aClass680_23.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(1617324837);
		}
		if ((local3 & Class680.aClass680_45.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(1443148402);
		}
		if ((local3 & Class680.aClass680_41.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(894257149);
		}
		if ((local3 & Class680.aClass680_42.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1977106336);
		}
		if ((local3 & Class680.aClass680_6.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-57031794);
		}
		if ((local3 & Class680.aClass680_44.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22419(-118643075);
		}
	...
	public boolean method33380(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(3) long local3 = arg0.method22423(-1082134073);
		if (local3 == 0L) {
			this.anInt5897 = arg0.method22415(-1434290800) * -521668953;
			return false;
		}
		...
		if ((local3 & Class680.aClass680_1.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat358 = arg0.method22425(-410615072);
		}
		if ((local3 & Class680.aClass680_22.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat356 = arg0.method22425(2084725433);
		}
		if ((local3 & Class680.aClass680_4.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat355 = arg0.method22425(-1598801287);
		}
		if ((local3 & Class680.aClass680_5.aLong307 * 7134854499111106275L) != 0L) {
			this.aClass472_66 = Class472.method29531(arg0);
		}
		if ((local3 & Class680.aClass680_13.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(48750158);
		}
		if ((local3 & Class680.aClass680_10.aLong307 * 7134854499111106275L) != 0L) {
			this.anInt5896 = arg0.method22419(-118643075) * -1757047085;
		}
		...
		if ((local3 & Class680.aClass680_39.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1971658871);
		}
		if ((local3 & Class680.aClass680_40.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(271241502);
		}
		if ((local3 & Class680.aClass680_43.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(97265371);
		}
		if ((local3 & Class680.aClass680_2.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1464584433);
		}
		if ((local3 & Class680.aClass680_7.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat357 = arg0.method22425(-1305198801);
		}
		if ((local3 & Class680.aClass680_14.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat359 = arg0.method22425(1487719715);
		}
		if ((local3 & Class680.aClass680_15.aLong307 * 7134854499111106275L) != 0L) {
			this.aFloat360 = arg0.method22425(1620105168);
		}
		if ((local3 & Class680.aClass680_16.aLong307 * 7134854499111106275L) != 0L) {
			this.anInt5898 = arg0.method22415(-1434290800) * 304329139;
		}
		if ((local3 & Class680.aClass680_17.aLong307 * 7134854499111106275L) != 0L) {
			this.anInt5899 = arg0.method22415(-1434290800) * 972166225;
			this.anInt5900 = arg0.method22482((byte) -110) * -535776559;
			this.anInt5901 = arg0.method22482((byte) -31) * -1145348855;
			this.anInt5902 = arg0.method22482((byte) -90) * 1206173817;
			this.anInt5903 = arg0.method22415(-1434290800) * 1258086185;
		}
		if ((local3 & Class680.aClass680_18.aLong307 * 7134854499111106275L) != 0L) {
			this.anIntArray521[0] = arg0.method22415(-1434290800);
			this.aFloatArray122[0] = arg0.method22425(-1659870577);
		}
		if ((local3 & Class680.aClass680_19.aLong307 * 7134854499111106275L) != 0L) {
			this.anIntArray521[1] = arg0.method22415(-1434290800);
			this.aFloatArray122[1] = arg0.method22425(761790497);
		}
		if ((local3 & Class680.aClass680_20.aLong307 * 7134854499111106275L) != 0L) {
			this.anIntArray521[2] = arg0.method22415(-1434290800);
			this.aFloatArray122[2] = arg0.method22425(738929353);
		}
		if ((local3 & Class680.aClass680_21.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22419(-118643075);
		}
		...
		if ((local3 & Class680.aClass680_36.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-631017425);
		}
		if ((local3 & Class680.aClass680_24.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-278912871);
		}
		if ((local3 & Class680.aClass680_25.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-399652290);
		}
		if ((local3 & Class680.aClass680_26.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(448301607);
		}
		if ((local3 & Class680.aClass680_27.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1640471200);
		}
		if ((local3 & Class680.aClass680_28.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22419(-118643075);
		}
		if ((local3 & Class680.aClass680_29.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(1269673484);
		}
		if ((local3 & Class680.aClass680_30.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-1245105926);
		}
		if ((local3 & Class680.aClass680_12.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-748762783);
		}
		if ((local3 & Class680.aClass680_32.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-367443619);
		}
		if ((local3 & Class680.aClass680_33.aLong307 * 7134854499111106275L) != 0L) {
			new Class472(arg0);
		}
		...
		if ((local3 & Class680.aClass680_37.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-92907822);
		}
		if ((local3 & Class680.aClass680_3.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-112880301);
		}
		if ((local3 & Class680.aClass680_38.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(564311723);
		}
		if ((local3 & Class680.aClass680_23.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-228809554);
		}
		if ((local3 & Class680.aClass680_45.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(45565929);
		}
		if ((local3 & Class680.aClass680_41.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(-588494887);
		}
		if ((local3 & Class680.aClass680_42.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(183239242);
		}
		if ((local3 & Class680.aClass680_6.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22425(1058834539);
		}
		if ((local3 & Class680.aClass680_44.aLong307 * 7134854499111106275L) != 0L) {
			arg0.method22419(-118643075);
		}
	...
	public int method33393(@OriginalArg(0) byte arg0) {
		return this.anInt5898 * -766876293;
	}
	...
	public int method33399(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public int method33401(@OriginalArg(0) int arg0) {
		return this.anInt5896 * -253284005;
	}
	...
	void method33413(@OriginalArg(0) short arg0) {
		this.anInt5904 = 14325749;
		this.aFloat358 = -1.0F;
		this.aFloat356 = -1.0F;
		this.aFloat355 = -1.0F;
	...
	static final void method33421(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!yj", name = "ame", descriptor = "(Lclient!yf;I)V", line = 12026)
	static final void method33422(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		Class389.method28266((byte) 121);
		Class454.aBoolean774 = false;
	}

	@OriginalMember(owner = "client!yj", name = "ff", descriptor = "(B)V", line = 2634)
	static final void method33423(@OriginalArg(0) byte arg0) {
		Class682.aClass32_Sub1_3.method17811(1701372950);
		Class692.aClass32_Sub4_3.method17811(681435632);
		Class343.aClass32_Sub19_1.method17811(-928707022);
		client.aClass532_1.method30466(1073538312).method17811(-2055115919);
		Class162.aClass32_Sub3_2.method17811(1409459113);
		Class277.aClass32_Sub12_1.method17811(-899090766);
		Class32.aClass32_Sub17_23.method17811(652399493);
		Class501.aClass32_Sub18_1.method17811(1249715159);
		Class30.aClass32_Sub16_1.method17811(-1483298106);
		Class21.aClass79_Sub1_Sub1_1.method1421((byte) -39);
		aClass79_Sub1_Sub2_6.method1476(2022880669);
		...
		Class166_Sub6.aClass32_Sub5_1.method17811(559175715);
		Class466.aClass32_Sub20_3.method17811(-611820807);
		Class542.aClass32_Sub2_3.method17811(-1365094645);
		Class124.aClass32_Sub21_7.method17811(-1545053759);
		Class123.aClass32_Sub11_2.method17811(1383443525);
		Class51.aClass32_Sub9_1.method17811(1621289321);
		Class668.aClass32_Sub15_1.method17811(1363320538);
		Class311.aClass32_Sub6_1.method17811(1226545783);
		Class366.aClass32_Sub8_1.method17811(1641719089);
		Class534.aClass32_Sub10_1.method17811(443897402);
		Class546.method30969((short) -27376);
		Class379.method28103(1013448115);
		Class157.aClass462_2.method29245(-1476787182);
		Class124_Sub1.method9193((byte) 0);
		Class379.method28100((byte) -3);
		client.aClass240_66.method25837(1161602830);
		client.aClass240_69.method25837(1161602830);
		Class687.aClass240_96.method25837(1161602830);
		client.aClass240_70.method25837(1161602830);
		Class74.aClass32_1.method17811(794984993);
		Class276.aClass32_2.method17811(654738010);
		client.aClass240_67.method25837(1161602830);
	}

	@OriginalMember(owner = "client!yj", name = "gu", descriptor = "(IIIB)V", line = 3345)
	static final void method33424(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
	...
	static final void method33425(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		local19.aClass93_Sub41_Sub2_1.method22510(local13.length() + 1, (byte) -107);
		local19.aClass93_Sub41_Sub2_1.method22402(local13, -1780120468);
		client.aClass175_2.method24351(local19, -1984927484);
	}
}
