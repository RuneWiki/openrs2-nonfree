...
public class Class579 implements Interface62 {
	...
	static final void method31369(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method31371(@OriginalArg(0) int arg0) {
		...
		local2.method22668((byte) -27);
		@Pc(10) int local10 = local2.method22689(8, -495582830);
		@Pc(17) int local17;
			...
			if (local71 == 0) {
				...
				if (local97 == 0) {
					...
					if (local97 == 1) {
						client.anIntArray323[(client.anInt3540 += 2039022169) * 568731113 - 1] = local58;
						local66.anInt2786 = client.anInt3445 * 848722373;
						local159 = (Class706) Class107.method18119(Class615.method32086(595145625), local2.method22689(3, 968214772), -1915563430);
						local66.method18601(local159, Class707.aClass707_2.aByte176, -1297597723);
						@Pc(170) int local170 = local2.method22689(1, -2140374239);
						if (local170 == 1) {
							client.anIntArray306[(client.anInt3472 += -170330519) * 146012633 - 1] = local58;
						}
					} else if (local97 == 2) {
						client.anIntArray323[(client.anInt3540 += 2039022169) * 568731113 - 1] = local58;
						local66.anInt2786 = client.anInt3445 * 848722373;
						if (local2.method22689(1, -1532204574) == 1) {
							local159 = (Class706) Class107.method18119(Class615.method32086(529909126), local2.method22689(3, 1450922393), -1915563430);
							local66.method18601(local159, Class707.aClass707_3.aByte176, 57954609);
							@Pc(238) Class706 local238 = (Class706) Class107.method18119(Class615.method32086(1286385669), local2.method22689(3, 553320565), -1915563430);
							local66.method18601(local238, Class707.aClass707_3.aByte176, -26860206);
						} else {
							local159 = (Class706) Class107.method18119(Class615.method32086(1011890412), local2.method22689(3, 2143859615), -1915563430);
							local66.method18601(local159, Class707.aClass707_1.aByte176, -281436130);
						}
						@Pc(266) int local266 = local2.method22689(1, 1563282688);
						if (local266 == 1) {
							client.anIntArray306[(client.anInt3472 += -170330519) * 146012633 - 1] = local58;
						}
					} else if (local97 == 3) {
	...
	static final void method31372(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 857057915);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class129.method21480(local16, local22, arg0, (byte) -54);
	}

	@OriginalMember(owner = "client!tr", name = "ep", descriptor = "(IB)V", line = 833)
	static void method31373(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		Class93_Sub14.anInt1527 = arg0 * -1845499089;
		Class159_Sub1.anInt1956 = -130712985;
		Class159_Sub1.anInt1951 = -919990023;
		Class358.method27780(-668159149);
	}
}
