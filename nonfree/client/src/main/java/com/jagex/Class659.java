...
public class Class659 implements Interface75 {
	...
	public boolean method32794(@OriginalArg(0) int arg0) {
	...
	static void method32804(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		if (Class454.anInt5041 * -656229149 == 1) {
			Class169.method18338(Class102.aClass93_Sub1_Sub7_3, arg0, arg1, false, 1824286321);
	...
	public static Class312 method32805(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(3) int local3 = arg0 >> 16;
		if (Class166_Sub1.aClass320Array1[local3] == null || Class166_Sub1.aClass320Array1[local3].method27228(arg0, 865175819) == null) {
			@Pc(19) boolean local19 = Class383.method28145(local3, (int[]) null, 839823793);
			if (!local19) {
				return null;
			}
		}
		return Class166_Sub1.aClass320Array1[local3].method27228(arg0, 181682937);
	}

	@OriginalMember(owner = "client!xh", name = "e", descriptor = "(B)[Lclient!wa;", line = 14)
	public static Class631[] method32806(@OriginalArg(0) byte arg0) {
	...
	static final void method32807(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anInt5891 -= 1189701933;
	}

	@OriginalMember(owner = "client!xh", name = "tu", descriptor = "(Lclient!yf;I)V", line = 8350)
	static final void method32808(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = method32805(local12, -146989917);
		Class493.method30008(local16, arg0, 1376488456);
	}

	@OriginalMember(owner = "client!xh", name = "zk", descriptor = "(Lclient!yf;I)V", line = 9470)
	static final void method32809(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(18) Class39 local18 = (Class39) Class19.aClass32_Sub7_5.method18261(local12, -746105267);
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = local18.method747(885023744);
	}
	...
	static final void method32811(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(13) String local13 = (String) arg0.anObjectArray45[(arg0.anInt5888 -= 957530791) * 587908375];
		@Pc(26) int local26 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(32) Class5 local32 = Class157.aClass462_2.method29241(client.anInterface50_1, local26, -1804264195);
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = local32.method37(local13, Class110_Sub14.aClass100Array4, (byte) -34);
	}

	@OriginalMember(owner = "client!xh", name = "v", descriptor = "(B)Ljava/lang/String;", line = 147)
	public static String method32812(@OriginalArg(0) byte arg0) {
		return Class355.aString184;
	}

	@OriginalMember(owner = "client!xh", name = "d", descriptor = "([J[Ljava/lang/Object;I)V", line = 218)
	public static void method32813(@OriginalArg(0) long[] arg0, @OriginalArg(1) Object[] arg1, @OriginalArg(2) int arg2) {
		Class681.method33245(arg0, arg1, 0, arg0.length - 1, -1213995184);
	}

	@OriginalMember(owner = "client!xh", name = "w", descriptor = "(I)Z", line = 103)
	static boolean method32814(@OriginalArg(0) int arg0) {
		return Class168.aBoolean380;
	}

	@OriginalMember(owner = "client!xh", name = "eq", descriptor = "(Lclient!yf;S)V", line = 5787)
	static final void method32815(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
