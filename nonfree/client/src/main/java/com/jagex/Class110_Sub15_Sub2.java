...
public class Class110_Sub15_Sub2 extends Class110_Sub15 {
	...
	Class110_Sub15_Sub2(@OriginalArg(0) Class93_Sub41 arg0) {
		super(arg0);
		@Pc(6) int local6 = arg0.method22419();
		this.anInt2825 = (local6 >>> 16) * 1778595823;
		this.anInt2824 = (local6 & 0xFFFF) * 159157325;
		this.anInt2826 = arg0.method22413() * 256284111;
	}
	...
	public void method20140() {
		...
		if (local18 < 3 && client.aClass532_1.method30509().method30330(this.anInt2825 * 25876239, this.anInt2824 * -531264379)) {
			local18++;
		}
		@Pc(90) Class132_Sub1_Sub1_Sub5 local90 = new Class132_Sub1_Sub1_Sub5(client.aClass532_1.method30459(), this.anInt2821 * 1307909245, 0, this.anInt2826 * 1713131823, local18, local6, Class305.method26801(local6, local13, this.anInt2826 * 1713131823) - this.anInt2823 * -1630065793, local13, this.anInt2825 * 25876239, this.anInt2825 * 25876239, this.anInt2824 * -531264379, this.anInt2824 * -531264379, this.anInt2822 * 187367639, false, 0);
