...
public class Class7 {
		...
		if (this.aDisplayMode1 != null) {
			...
			if (!local8) {
				try {
					...
					local42.set(this.aGraphicsDevice1, (Object) null);
				} catch (@Pc(52) Throwable local52) {
				}
			}
			this.aDisplayMode1 = null;
		}
		this.method110((Frame) null, -1476386037);
	}
	...
	static final void method123(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		Class51.aClass93_Sub36_1.method14357(Class51.aClass93_Sub36_1.aClass166_Sub8_1, arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091], (byte) 71);
