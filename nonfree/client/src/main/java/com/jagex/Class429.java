...
public class Class429 {
	...
	public static Class49 method28754(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
	...
	static final void method28755(@OriginalArg(0) Class681 arg0) {
		@Pc(13) String local13 = (String) arg0.anObjectArray45[(arg0.anInt5888 -= 957530791) * 587908375];
		@Pc(15) int local15 = 0;
		if (Class633.method32304(local13)) {
			local15 = Class616.method32090(local13);
		}
		@Pc(29) Class93_Sub22 local29 = Class102.method2592(Class446.aClass446_123, client.aClass175_2.aClass24_2);
		local29.aClass93_Sub41_Sub2_1.method22395(local15);
		client.aClass175_2.method24351(local29);
	}

	@OriginalMember(owner = "client!mz", name = "aon", descriptor = "(Lclient!yf;I)V", line = 12606)
	static final void method28753(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(24) float local24 = Class464.method29282(arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1]);
		@Pc(29) Class93_Sub1_Sub17 local29 = Class65.aClass123_Sub1_2.method8947(local13);
		if (local29 == null) {
			throw new RuntimeException("");
		} else if (local29 instanceof Class93_Sub1_Sub17_Sub2) {
			((Class93_Sub1_Sub17_Sub2) local29).method23506(local24);
		} else {
			throw new RuntimeException("");
		}
	}
