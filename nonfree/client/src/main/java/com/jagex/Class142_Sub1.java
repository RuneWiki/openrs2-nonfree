...
public class Class142_Sub1 extends Class142 {
	...
	public static final int method10952(@OriginalArg(0) Class32_Sub14 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class656 arg6, @OriginalArg(7) Class656 arg7) {
		...
		@Pc(8) int local8 = -1;
		label73: while (true) {
			@Pc(12) int local12 = local6.method22464(1717424420);
			if (local12 == 0) {
				return local1;
			}
			local8 += local12;
			...
			while (true) {
						...
						do {
							do {
								do {
									@Pc(27) int local27;
									do {
										local27 = local6.method22632((byte) -64);
										if (local27 == 0) {
											continue label73;
										}
				...
				} while (local36.anInt5709 * 1175627307 == Class615.aClass615_24.anInt5628 * 948246811 && Class51.aClass93_Sub36_1.aClass166_Sub3_1.method15402(-602436248) == 0 && local68.anInt5592 * 1067969079 == 0 && local68.anInt5591 * -297318857 != 1 && !local68.aBoolean835);
				if (!local68.method31994(arg7, (short) 16811)) {
	...
	public final void method10953(@OriginalArg(0) Class104 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		@Pc(6) int local6 = -1;
		label91: while (true) {
			@Pc(10) int local10 = local4.method22464(1405362307);
			if (local10 == 0) {
				return;
			}
			local6 += local10;
			...
			while (true) {
						...
						do {
							do {
								do {
									...
									do {
										do {
											do {
												...
												do {
													do {
														@Pc(23) int local23 = local4.method22632((byte) -76);
														if (local23 == 0) {
															continue label91;
														}
														local19 += local23 - 1;
									...
									local129 = arg3 + Class641.method32511(local42 & 0x7, local36 & 0x7, arg8, local77.anInt5608 * 427800467, local77.anInt5603 * -774442965, local51.anInt5708 * -1626288991, (byte) -1);
									local153 = arg4 + Class106.method7576(local42 & 0x7, local36 & 0x7, arg8, local77.anInt5608 * 427800467, local77.anInt5603 * -774442965, local51.anInt5708 * -1626288991, -2111315739);
				...
				this.method10955(arg0, arg2, arg2, local129, local153, local6, local51.anInt5708 * -1626288991 + arg8 & 0x3, local51.anInt5709 * 1175627307, -1, 0, local51.aClass458_90, -1401671972);
			}
		}
	}
	...
	Interface61 method10954(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		if (arg1 == 0) {
			local1 = (Interface61) this.aClass585_5.method31440(arg0, arg2, arg3, -1309876799);
		}
		if (arg1 == 1) {
			local1 = (Interface61) this.aClass585_5.method31464(arg0, arg2, arg3, -2037283232);
		}
		if (arg1 == 2) {
			local1 = (Interface61) this.aClass585_5.method31585(arg0, arg2, arg3, client.anInterface62_1, (byte) 3);
		}
		if (arg1 == 3) {
			local1 = (Interface61) this.aClass585_5.method31496(arg0, arg2, arg3, -968156135);
		}
		return local1;
	}

	@OriginalMember(owner = "client!aih", name = "ca", descriptor = "(Lclient!dh;IIIIIIIIILclient!oe;I)V", line = 469)
	final void method10955(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) Class458 arg10, @OriginalArg(11) int arg11) {
		...
		if (Class51.aClass93_Sub36_1.aClass166_Sub14_1.method15654(-1684897143) == 0 && local17.aBoolean838) {
			return;
		}
		@Pc(37) int local37;
		@Pc(42) int local42;
		...
		if (local17.method31985(1892946812)) {
			Class643.method32583(arg2, arg3, arg4, arg6, local17, (Class132_Sub1_Sub1_Sub1_Sub1) null, (Class132_Sub1_Sub1_Sub1_Sub2) null, 694869299);
		}
		@Pc(252) boolean local252 = arg8 == -1 && (!local17.method32009((byte) 4) || local17.aBoolean831 && Class51.aClass93_Sub36_1.aClass166_Sub31_1.method16108((short) 29318) == 0) && local17.anIntArray492 == null && !local17.aBoolean840 && !local17.aBoolean841;
		if (aBoolean241 && (Class549.method31025(arg7, -1134295448) && local17.anInt5594 * 1349946317 != 1 || !(!Class281.method26460(arg7, -710594195) || local17.anInt5594 * 1349946317 != 0))) {
			return;
		}
		if (arg7 != Class615.aClass615_24.anInt5628 * 948246811) {
			...
			if (Class615.aClass615_21.anInt5628 * 948246811 == arg7 || arg7 == Class615.aClass615_22.anInt5628 * 948246811) {
				...
				if (this.aClass585_5.method31497(local426, false, -2013812986)) {
			...
			} else if (Class281.method26460(arg7, -927932646) || Class476.method29686(arg7, -783424709)) {
				if (local252) {
				...
				this.aClass585_5.method31497(local426, false, -1970586157);
				if (this.aBoolean232 && !this.aBoolean236 && Class281.method26460(arg7, 1592122379) && Class615.aClass615_11.anInt5628 * 948246811 != arg7 && arg2 > 0 && local17.anInt5594 * 1349946317 != 0) {
		...
		} else if (Class51.aClass93_Sub36_1.aClass166_Sub3_1.method15402(-392085377) != 0 || local17.anInt5592 * 1067969079 != 0 || local17.anInt5591 * -297318857 == 1 || local17.aBoolean835) {
			...
			this.aClass585_5.method31446(arg2, arg3, arg4, local333, (byte) 0);
		}
	}

	@OriginalMember(owner = "client!aih", name = "cp", descriptor = "(Lclient!dh;[BIIIIIIII)V", line = 427)
	public final void method10956(@OriginalArg(0) Class104 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		@Pc(4) Class93_Sub41 local4 = new Class93_Sub41(arg1);
		@Pc(6) int local6 = -1;
		label91: while (true) {
			@Pc(10) int local10 = local4.method22464(1697451881);
			if (local10 == 0) {
				return;
			}
			local6 += local10;
						...
						do {
							do {
								do {
									...
									do {
										do {
											do {
												...
												do {
													do {
														@Pc(23) int local23 = local4.method22632((byte) -25);
														if (local23 == 0) {
															continue label91;
														}
														local19 += local23 - 1;
									...
									local129 = arg3 + Class641.method32511(local42 & 0x7, local36 & 0x7, arg8, local77.anInt5608 * 427800467, local77.anInt5603 * -774442965, local51.anInt5708 * -1626288991, (byte) -1);
									local153 = arg4 + Class106.method7576(local42 & 0x7, local36 & 0x7, arg8, local77.anInt5608 * 427800467, local77.anInt5603 * -774442965, local51.anInt5708 * -1626288991, -1525040504);
									local157 = local129 + local89;
									local161 = local94 + local153;
								} while (local129 >= this.anInt1279 * -115974587);
							} while (local153 >= this.anInt1280 * -586018753);
	...
	boolean method10957(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) Class610 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) boolean arg14, @OriginalArg(15) Class99 arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) Class458 arg18, @OriginalArg(19) int arg19) {
		...
		if (Class615.aClass615_13.anInt5628 * 948246811 == arg1) {
			...
			this.aClass585_5.method31448(arg7, arg12, arg13, local53, (Class132_Sub1_Sub2) null, 1303565495);
			if (arg2 == 0) {
			...
			if (arg4.anInt5597 * 1128343593 != 64) {
				this.aClass585_5.method31494(arg7, arg12, arg13, arg4.anInt5597 * 1128343593, 2118916794);
			}
			return true;
		}
		...
		if (arg1 == Class615.aClass615_10.anInt5628 * 948246811) {
			...
			this.aClass585_5.method31448(arg7, arg12, arg13, local331, (Class132_Sub1_Sub2) null, 201739670);
			...
			this.aClass585_5.method31448(arg7, arg12, arg13, local331, local53, 463053404);
			...
			if (arg4.anInt5597 * 1128343593 != 64) {
				this.aClass585_5.method31494(arg7, arg12, arg13, arg4.anInt5597 * 1128343593, 2033173460);
			}
			return true;
			...
			this.aClass585_5.method31448(arg7, arg12, arg13, local331, (Class132_Sub1_Sub2) null, 1774273358);
			if (arg4.aBoolean834 && this.aBoolean232) {
				if (arg2 == 0) {
					arg15.method2474(arg12, arg13 + 1, 50);
				} else if (arg2 == 1) {
			...
			this.aClass585_5.method31497(local899, false, -2078323471);
			...
			if (arg4.anInt5597 * 1128343593 != 64) {
				this.aClass585_5.method31494(arg7, arg12, arg13, arg4.anInt5597 * 1128343593, 2102830930);
			}
			return true;
		} else {
			return false;
	...
	boolean method10958(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) Class610 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) Class458 arg14, @OriginalArg(15) byte arg15) {
		...
		if (Class615.aClass615_7.anInt5628 * 948246811 == arg1) {
			...
			this.aClass585_5.method31481(arg7, arg12, arg13, local39, (Class132_Sub1_Sub3) null, (byte) -6);
			return true;
		}
		@Pc(83) int local83;
		...
		if (Class615.aClass615_8.anInt5628 * 948246811 == arg1) {
			local83 = 65;
			local92 = (Interface61) this.aClass585_5.method31440(arg7, arg12, arg13, -1309876799);
			if (local92 != null) {
			...
			this.aClass585_5.method31481(arg7, arg12, arg13, local39, (Class132_Sub1_Sub3) null, (byte) 32);
			return true;
			...
			this.aClass585_5.method31481(arg7, arg12, arg13, local39, (Class132_Sub1_Sub3) null, (byte) 8);
			return true;
			...
			this.aClass585_5.method31481(arg7, arg12, arg13, local39, (Class132_Sub1_Sub3) null, (byte) 77);
			return true;
		} else if (Class615.aClass615_2.anInt5628 * 948246811 == arg1) {
			@Pc(418) int local418 = arg2 + 2 & 0x3;
			@Pc(420) int local420 = 33;
			@Pc(429) Interface61 local429 = (Interface61) this.aClass585_5.method31440(arg7, arg12, arg13, -1309876799);
			if (local429 != null) {
			...
			this.aClass585_5.method31481(arg7, arg12, arg13, local39, local525, (byte) 40);
			return true;
		} else {
			return false;
		}
	...
	void method10959(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) byte arg5) {
		...
		if (local19.method31985(819545494)) {
			Class462.method29277(arg1, arg3, arg4, local19, (byte) 22);
		}
		if (local7.method13406(-559427376)) {
			local7.method13409(arg0, (byte) 111);
		}
		if (arg2 == 0) {
			this.aClass585_5.method31453(arg1, arg3, arg4, (byte) 1);
			this.aClass585_5.method31610(arg1, arg3, arg4, (byte) 111);
			...
			this.aClass585_5.method31455(arg1, arg3, arg4, 2057399220);
			this.aClass585_5.method31456(arg1, arg3, arg4, 649756054);
		} else if (arg2 == 2) {
			this.aClass585_5.method31441(arg1, arg3, arg4, client.anInterface62_1, 1392748730);
			...
			this.aClass585_5.method31457(arg1, arg3, arg4, (byte) 82);
		}
	}

	@OriginalMember(owner = "client!aih", name = "ce", descriptor = "(Lclient!dh;Lclient!alw;IIB)V", line = 73)
	public final void method10960(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class93_Sub41 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte arg4) {
		if (this.aBoolean236) {
			return;
		}
		...
		while (true) {
			...
			while (arg1.anInt3070 * 212851357 < arg1.aByteArray58.length) {
				local27 = arg1.method22413((short) 16384);
				if (local27 != 0) {
					@Pc(121) int local121;
					@Pc(129) int local129;
					@Pc(133) int local133;
					if (local27 == 1) {
						local55 = arg1.method22413((short) 16384);
						if (local55 > 0) {
							for (local59 = 0; local59 < local55; local59++) {
								...
								if (local74.anInt5528 * 365017865 == 31) {
									@Pc(88) Class85 local88 = (Class85) Class668.aClass32_Sub15_1.method18261(arg1.method22415(-1434290800), 110165572);
									local74.method31767(local88.anInt260 * 649135051, local88.anInt262 * 2054784993, local88.anInt259 * 243149709, local88.anInt261 * -88051697, -81207454);
								}
								if (arg0.method20413() > 0) {
									...
									if (local133 >= 0 && local137 >= 0 && local133 < this.anInt1279 * -115974587 && local137 < this.anInt1280 * -586018753) {
										local113.method13543(local121, this.anIntArrayArrayArray14[local74.anInt5520 * -1484967795][local133][local137] - local113.method13521(1655674161), local129, -2115548501);
										this.aClass585_5.method31483(local74, (byte) 6);
									}
								}
							}
						}
						...
						local13.method33051(arg1, -688572878);
					} else if (local27 == 3) {
						if (local13 == null) {
							local13 = new Class672();
						}
						local13.method33052(arg1, 1976785945);
					} else if (local27 == 128) {
						if (local13 == null) {
							local13 = new Class672();
						}
						local13.method33054(arg1, this.aClass671_1, 218649240);
					} else if (local27 == 129) {
						if (this.aByteArrayArrayArray5 == null) {
							this.aByteArrayArrayArray5 = new byte[4][][];
						}
						for (local55 = 0; local55 < 4; local55++) {
							@Pc(246) byte local246 = arg1.method22414(2055395259);
							if (local246 == 0 && this.aByteArrayArrayArray5[local55] != null) {
								...
								for (local256 = 0; local256 < 64; local256 += 4) {
									for (local260 = 0; local260 < 64; local260 += 4) {
										@Pc(389) byte local389 = arg1.method22414(1584925073);
					...
					local13.method33049(arg1, this.aClass671_1, (byte) -12);
				}
			}
			for (local27 = 0; local27 < 8; local27++) {
				for (local55 = 0; local55 < 8; local55++) {
					...
					if (local59 >= 0 && local59 < this.anInt1279 * -115974587 >> 3 && local256 >= 0 && local256 < this.anInt1280 * -586018753 >> 3) {
						if (local13 != null) {
							this.aClass671_1.method32983(local59, local256, local13, 1075187593);
						}
	...
	public final void method10961(@OriginalArg(0) Class104 arg0, @OriginalArg(1) boolean arg1) {
				...
				for (local12 = 0; local12 < this.anInt1279 * -115974587; local12++) {
					for (local20 = 0; local20 < this.anInt1280 * -586018753; local20++) {
						if ((this.aClass520_2.aByteArrayArrayArray12[1][local12][local20] & 0x2) == 2) {
							this.aClass585_5.method31434(local12, local20, -2079279570);
						}
					}
				}
			}
		...
		this.aByteArrayArrayArray6 = (byte[][][]) null;
	}
		...
		while (true) {
			...
			while (arg1.anInt3070 * 212851357 < arg1.aByteArray58.length) {
				...
				if (local27 != 0) {
					...
					if (local27 == 1) {
						...
						if (local55 > 0) {
							for (local59 = 0; local59 < local55; local59++) {
								@Pc(74) Class597 local74 = new Class597(arg0, this.aClass585_5.anInt5438 * -358186793, arg1, 2);
								if (local74.anInt5528 * 365017865 == 31) {
									@Pc(88) Class85 local88 = (Class85) Class668.aClass32_Sub15_1.method18261(arg1.method22415(-1434290800), -1042531125);
									local74.method31767(local88.anInt260 * 649135051, local88.anInt262 * 2054784993, local88.anInt259 * 243149709, local88.anInt261 * -88051697, -81207454);
								}
								if (arg0.method20413() > 0) {
									@Pc(113) Class93_Sub16 local113 = local74.aClass93_Sub16_3;
									...
									@Pc(137) int local137 = local129 >> 9;
									if (local133 >= 0 && local137 >= 0 && local133 < this.anInt1279 * -115974587 && local137 < this.anInt1280 * -586018753) {
										local113.method13543(local121, this.anIntArrayArrayArray14[local74.anInt5520 * -1484967795][local133][local137] - local113.method13521(1655674161), local129, -1875168452);
										this.aClass585_5.method31483(local74, (byte) 6);
									}
								}
							}
						...
						local13.method33052(arg1, 2071158041);
					} else if (local27 == 128) {
						if (local13 == null) {
							local13 = new Class672();
						}
						local13.method33054(arg1, this.aClass671_1, 399586244);
					} else if (local27 == 129) {
						if (this.aByteArrayArrayArray5 == null) {
							this.aByteArrayArrayArray5 = new byte[4][][];
						}
						for (local55 = 0; local55 < 4; local55++) {
							@Pc(246) byte local246 = arg1.method22414(633862400);
							if (local246 == 0 && this.aByteArrayArrayArray5[local55] != null) {
								local256 = arg2;
								local260 = arg2 + 64;
								local121 = arg3;
								...
								for (local256 = 0; local256 < 64; local256 += 4) {
									for (local260 = 0; local260 < 64; local260 += 4) {
										@Pc(389) byte local389 = arg1.method22414(1115406076);
										for (local129 = local256 + arg2; local129 < local256 + 4 + arg2; local129++) {
											for (local133 = local260 + arg3; local133 < local260 + 4 + arg3; local133++) {
												if (local129 >= 0 && local129 < this.anInt1279 * -115974587 && local133 >= 0 && local133 < this.anInt1280 * -586018753) {
													this.aByteArrayArrayArray5[local55][local129][local133] = local389;
					...
					local13.method33049(arg1, this.aClass671_1, (byte) -29);
				}
			}
			for (local27 = 0; local27 < 8; local27++) {
				for (local55 = 0; local55 < 8; local55++) {
					...
					if (local59 >= 0 && local59 < this.anInt1279 * -115974587 >> 3 && local256 >= 0 && local256 < this.anInt1280 * -586018753 >> 3) {
						if (local13 != null) {
							this.aClass671_1.method32983(local59, local256, local13, 871754871);
						}
	...
	public final void method10963(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class93_Sub41 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) byte arg9) {
		if (this.aBoolean236) {
			return;
		}
		arg1.anInt3070 += 1319886248;
		...
		while (true) {
			...
			@Pc(70) int local70;
			while (arg1.anInt3070 * 212851357 < arg1.aByteArray58.length) {
				local39 = arg1.method22413((short) 16384);
				if (local39 != 0) {
					@Pc(136) int local136;
					@Pc(176) int local176;
					@Pc(194) int local194;
					@Pc(130) int local130;
					if (local39 == 1) {
						local66 = arg1.method22413((short) 16384);
						if (local66 > 0) {
							for (local70 = 0; local70 < local66; local70++) {
								...
								if (local85.anInt5528 * 365017865 == 31) {
									@Pc(99) Class85 local99 = (Class85) Class668.aClass32_Sub15_1.method18261(arg1.method22415(-1434290800), -908353382);
									local85.method31767(local99.anInt260 * 649135051, local99.anInt262 * 2054784993, local99.anInt259 * 243149709, local99.anInt261 * -88051697, -81207454);
								}
								if (arg0.method20413() > 0) {
									...
									if (arg5 == local85.anInt5520 * -1484967795 && local130 >= local21 && local130 < local21 + 8 && local136 >= local27 && local136 < local27 + 8) {
										local176 = (arg3 << 9) + Class477.method29702(local124.method13520(1260376996) & 0xFFF, local124.method13522(2129958887) & 0xFFF, arg8, (byte) 108);
										local194 = (arg4 << 9) + Class590.method31692(local124.method13520(910546986) & 0xFFF, local124.method13522(1085631640) & 0xFFF, arg8, 1788527300);
										local130 = local176 >> 9;
										local136 = local194 >> 9;
										if (local130 >= 0 && local136 >= 0 && local130 < this.anInt1279 * -115974587 && local136 < this.anInt1280 * -586018753) {
											...
											local124.method13543(local176, this.anIntArrayArrayArray14[local85.anInt5520 * -1484967795][local130][local136] - local124.method13521(1655674161), local194, -701326741);
											this.aClass585_5.method31483(local85, (byte) 6);
										}
									}
								}
							}
						...
						local13.method33052(arg1, 1565116669);
					} else if (local39 == 128) {
						if (local13 == null) {
							local13 = new Class672();
						}
						local13.method33054(arg1, this.aClass671_1, 1760045391);
					} else if (local39 == 129) {
						if (this.aByteArrayArrayArray5 == null) {
							this.aByteArrayArrayArray5 = new byte[4][][];
						}
						for (local66 = 0; local66 < 4; local66++) {
							@Pc(316) byte local316 = arg1.method22414(1541105232);
							@Pc(333) int local333;
							if (local316 == 0 && this.aByteArrayArrayArray5[arg2] != null) {
								...
								for (local329 = 0; local329 < 64; local329 += 4) {
									for (local333 = 0; local333 < 64; local333 += 4) {
										@Pc(463) byte local463 = arg1.method22414(742413516);
										if (local66 <= arg5) {
											for (local136 = local329; local136 < local329 + 4; local136++) {
												for (local176 = local333; local176 < local333 + 4; local176++) {
													if (local136 >= local21 && local136 < local21 + 8 && local176 >= local27 && local176 < local27 + 8) {
														local194 = arg3 + Class49.method16611(local136 & 0x7, local176 & 0x7, arg8, 1189701933);
					...
					local13.method33049(arg1, this.aClass671_1, (byte) 24);
				}
			}
			if (local13 != null) {
				this.aClass671_1.method32983(arg3 >> 3, arg4 >> 3, local13, -1191363159);
			}
		...
		while (true) {
			...
			while (arg1.anInt3070 * 212851357 < arg1.aByteArray58.length) {
				...
				if (local27 != 0) {
					...
					if (local27 == 1) {
						...
						if (local55 > 0) {
							for (local59 = 0; local59 < local55; local59++) {
								@Pc(74) Class597 local74 = new Class597(arg0, this.aClass585_5.anInt5438 * -358186793, arg1, 2);
								if (local74.anInt5528 * 365017865 == 31) {
									@Pc(88) Class85 local88 = (Class85) Class668.aClass32_Sub15_1.method18261(arg1.method22415(-1434290800), 904551016);
									local74.method31767(local88.anInt260 * 649135051, local88.anInt262 * 2054784993, local88.anInt259 * 243149709, local88.anInt261 * -88051697, -81207454);
								}
								if (arg0.method20413() > 0) {
									@Pc(113) Class93_Sub16 local113 = local74.aClass93_Sub16_3;
									...
									@Pc(137) int local137 = local129 >> 9;
									if (local133 >= 0 && local137 >= 0 && local133 < this.anInt1279 * -115974587 && local137 < this.anInt1280 * -586018753) {
										local113.method13543(local121, this.anIntArrayArrayArray14[local74.anInt5520 * -1484967795][local133][local137] - local113.method13521(1655674161), local129, -788866433);
										this.aClass585_5.method31483(local74, (byte) 6);
									}
								}
							}
						...
						local13.method33052(arg1, 829621983);
					} else if (local27 == 128) {
						if (local13 == null) {
							local13 = new Class672();
						}
						local13.method33054(arg1, this.aClass671_1, 1620217953);
					} else if (local27 == 129) {
						if (this.aByteArrayArrayArray5 == null) {
							this.aByteArrayArrayArray5 = new byte[4][][];
						}
						for (local55 = 0; local55 < 4; local55++) {
							@Pc(246) byte local246 = arg1.method22414(720380177);
							if (local246 == 0 && this.aByteArrayArrayArray5[local55] != null) {
								local256 = arg2;
								local260 = arg2 + 64;
								local121 = arg3;
								...
								for (local256 = 0; local256 < 64; local256 += 4) {
									for (local260 = 0; local260 < 64; local260 += 4) {
										@Pc(389) byte local389 = arg1.method22414(1990852908);
										for (local129 = local256 + arg2; local129 < local256 + 4 + arg2; local129++) {
											for (local133 = local260 + arg3; local133 < local260 + 4 + arg3; local133++) {
												if (local129 >= 0 && local129 < this.anInt1279 * -115974587 && local133 >= 0 && local133 < this.anInt1280 * -586018753) {
													this.aByteArrayArrayArray5[local55][local129][local133] = local389;
					...
					local13.method33049(arg1, this.aClass671_1, (byte) 27);
				}
			}
			for (local27 = 0; local27 < 8; local27++) {
				for (local55 = 0; local55 < 8; local55++) {
					...
					if (local59 >= 0 && local59 < this.anInt1279 * -115974587 >> 3 && local256 >= 0 && local256 < this.anInt1280 * -586018753 >> 3) {
						if (local13 != null) {
							this.aClass671_1.method32983(local59, local256, local13, -66105139);
						}
	...
	public final void method10965(@OriginalArg(0) Class104 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) byte arg2) {
		this.aClass585_5.method31469();
		if (!arg1) {
			@Pc(12) int local12;
			@Pc(20) int local20;
			if (this.anInt1292 * 604655629 > 1) {
				for (local12 = 0; local12 < this.anInt1279 * -115974587; local12++) {
					for (local20 = 0; local20 < this.anInt1280 * -586018753; local20++) {
						if ((this.aClass520_2.aByteArrayArrayArray12[1][local12][local20] & 0x2) == 2) {
							this.aClass585_5.method31434(local12, local20, 794758852);
						}
					}
				}
			}
	...
	public static final int method10966(@OriginalArg(0) Class32_Sub14 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class656 arg6, @OriginalArg(7) Class656 arg7) {
		...
		@Pc(8) int local8 = -1;
		label73: while (true) {
			@Pc(12) int local12 = local6.method22464(1737313311);
			if (local12 == 0) {
				return local1;
			}
			local8 += local12;
			...
			while (true) {
						...
						do {
							do {
								do {
									@Pc(27) int local27;
									do {
										local27 = local6.method22632((byte) -13);
										if (local27 == 0) {
											continue label73;
										}
										local36 = new Class629(local6);
				...
				} while (local36.anInt5709 * 1175627307 == Class615.aClass615_24.anInt5628 * 948246811 && Class51.aClass93_Sub36_1.aClass166_Sub3_1.method15402(-1496115445) == 0 && local68.anInt5592 * 1067969079 == 0 && local68.anInt5591 * -297318857 != 1 && !local68.aBoolean835);
				if (!local68.method31994(arg7, (short) 780)) {
					arg6.anInt5810 = local8 * -33749981;
					local1++;
				}
				local23 = true;
	...
	public static final int method10967(@OriginalArg(0) Class32_Sub14 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class656 arg6, @OriginalArg(7) Class656 arg7) {
		...
		@Pc(8) int local8 = -1;
		label73: while (true) {
			@Pc(12) int local12 = local6.method22464(1959290041);
			if (local12 == 0) {
				return local1;
			}
			local8 += local12;
			...
			while (true) {
						...
						do {
							do {
								do {
									@Pc(27) int local27;
									do {
										local27 = local6.method22632((byte) -25);
										if (local27 == 0) {
											continue label73;
										}
										local36 = new Class629(local6);
				...
				} while (local36.anInt5709 * 1175627307 == Class615.aClass615_24.anInt5628 * 948246811 && Class51.aClass93_Sub36_1.aClass166_Sub3_1.method15402(-1216062289) == 0 && local68.anInt5592 * 1067969079 == 0 && local68.anInt5591 * -297318857 != 1 && !local68.aBoolean835);
				if (!local68.method31994(arg7, (short) 27658)) {
					arg6.anInt5810 = local8 * -33749981;
					local1++;
				}
				local23 = true;
	...
	static final boolean method10968(@OriginalArg(0) Class32_Sub14 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		return local5.method31978(arg2, (byte) -12);
	}
	...
	public final void method10969(@OriginalArg(0) Class104 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(6) int local6 = -1;
		label66: while (true) {
			@Pc(10) int local10 = local4.method22464(2120694925);
			if (local10 == 0) {
				return;
			}
			local6 += local10;
			...
			while (true) {
				...
				do {
					...
					do {
						do {
							do {
								do {
									@Pc(24) int local24 = local4.method22632((byte) -106);
									if (local24 == 0) {
										continue label66;
									}
									local20 += local24 - 1;
				...
				this.method10955(arg0, local48, local48, local57, local61, local6, local53.anInt5708 * -1626288991, local53.anInt5709 * 1175627307, -1, 0, local53.aClass458_90, -1401671972);
			}
		}
	}
	...
	public final void method10970(@OriginalArg(0) Class104 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(6) int local6 = -1;
		label66: while (true) {
			@Pc(10) int local10 = local4.method22464(1285392261);
			if (local10 == 0) {
				return;
			}
			local6 += local10;
				...
				do {
					...
					do {
						do {
							do {
								do {
									@Pc(24) int local24 = local4.method22632((byte) -37);
									if (local24 == 0) {
										continue label66;
									}
									local20 += local24 - 1;
	...
	public final void method10971(@OriginalArg(0) Class104 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(6) int local6 = -1;
		label66: while (true) {
			@Pc(10) int local10 = local4.method22464(1927274145);
			if (local10 == 0) {
				return;
			}
			local6 += local10;
				...
				do {
					...
					do {
						do {
							do {
								do {
									@Pc(24) int local24 = local4.method22632((byte) -42);
									if (local24 == 0) {
										continue label66;
									}
									local20 += local24 - 1;
	...
	public final void method10972(@OriginalArg(0) Class104 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(6) int local6 = -1;
		label66: while (true) {
			@Pc(10) int local10 = local4.method22464(1504811884);
			if (local10 == 0) {
				return;
			}
			local6 += local10;
				...
				do {
					...
					do {
						do {
							do {
								do {
									@Pc(24) int local24 = local4.method22632((byte) -107);
									if (local24 == 0) {
										continue label66;
									}
									local20 += local24 - 1;
	...
	public final void method10973(@OriginalArg(0) Class104 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(6) int local6 = -1;
		label66: while (true) {
			@Pc(10) int local10 = local4.method22464(1625672509);
			if (local10 == 0) {
				return;
			}
			local6 += local10;
				...
				do {
					...
					do {
						do {
							do {
								do {
									@Pc(24) int local24 = local4.method22632((byte) -56);
									if (local24 == 0) {
										continue label66;
									}
									local20 += local24 - 1;
	...
	boolean method10974(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) Class610 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) boolean arg14, @OriginalArg(15) Class99 arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) Class458 arg18) {
		...
		if (Class615.aClass615_13.anInt5628 * 948246811 == arg1) {
			...
			this.aClass585_5.method31448(arg7, arg12, arg13, local53, (Class132_Sub1_Sub2) null, -392317038);
			if (arg2 == 0) {
				if (this.aBoolean232 && arg4.aBoolean834) {
					arg15.method2474(arg12, arg13, 50);
					arg15.method2474(arg12, arg13 + 1, 50);
			...
			if (arg4.anInt5597 * 1128343593 != 64) {
				this.aClass585_5.method31494(arg7, arg12, arg13, arg4.anInt5597 * 1128343593, 2062843511);
			}
			return true;
		}
		@Pc(331) Class132_Sub1_Sub2 local331;
		...
		if (arg1 == Class615.aClass615_10.anInt5628 * 948246811) {
			...
			this.aClass585_5.method31448(arg7, arg12, arg13, local331, (Class132_Sub1_Sub2) null, 1440938884);
			if (arg4.aBoolean834 && this.aBoolean232) {
				if (arg2 == 0) {
					arg15.method2474(arg12, arg13 + 1, 50);
				} else if (arg2 == 1) {
			...
			this.aClass585_5.method31448(arg7, arg12, arg13, local331, local53, -936173736);
			if ((arg4.anInt5594 * 1349946317 == 1 || aBoolean240 && arg4.anInt5594 * 1349946317 == -1) && !this.aBoolean236) {
				if (arg2 == 0) {
					this.aClass585_5.aClass598_2.method31825(1, arg7, arg12, arg13, arg4.anInt5595 * -2039712105, arg4.anInt5596 * 955083601);
					this.aClass585_5.aClass598_2.method31825(2, arg7, arg12, arg13 + 1, arg4.anInt5595 * -2039712105, arg4.anInt5596 * 955083601);
			...
			if (arg4.anInt5597 * 1128343593 != 64) {
				this.aClass585_5.method31494(arg7, arg12, arg13, arg4.anInt5597 * 1128343593, 2101075318);
			}
			return true;
		} else if (Class615.aClass615_5.anInt5628 * 948246811 == arg1) {
			if (arg3) {
			...
			this.aClass585_5.method31448(arg7, arg12, arg13, local331, (Class132_Sub1_Sub2) null, -793118018);
			if (arg4.aBoolean834 && this.aBoolean232) {
				if (arg2 == 0) {
					arg15.method2474(arg12, arg13 + 1, 50);
				} else if (arg2 == 1) {
			...
			this.aClass585_5.method31497(local899, false, -2002518365);
			if (arg4.anInt5594 * 1349946317 == 1 && !this.aBoolean236) {
				@Pc(957) byte local957;
				if ((arg2 & 0x1) == 0) {
					local957 = 8;
			...
			if (arg4.anInt5597 * 1128343593 != 64) {
				this.aClass585_5.method31494(arg7, arg12, arg13, arg4.anInt5597 * 1128343593, 2119525962);
			}
			return true;
		} else {
			return false;
	...
	public final void method10975(@OriginalArg(0) Class104 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		@Pc(6) int local6 = -1;
		label91: while (true) {
			@Pc(10) int local10 = local4.method22464(1616838902);
			if (local10 == 0) {
				return;
			}
			local6 += local10;
						...
						do {
							do {
								do {
									...
									do {
										do {
											do {
												...
												do {
													do {
														@Pc(23) int local23 = local4.method22632((byte) -36);
														if (local23 == 0) {
															continue label91;
														}
														local19 += local23 - 1;
									...
									local129 = arg3 + Class641.method32511(local42 & 0x7, local36 & 0x7, arg8, local77.anInt5608 * 427800467, local77.anInt5603 * -774442965, local51.anInt5708 * -1626288991, (byte) -1);
									local153 = arg4 + Class106.method7576(local42 & 0x7, local36 & 0x7, arg8, local77.anInt5608 * 427800467, local77.anInt5603 * -774442965, local51.anInt5708 * -1626288991, -1773157313);
									local157 = local129 + local89;
									local161 = local94 + local153;
								} while (local129 >= this.anInt1279 * -115974587);
							} while (local153 >= this.anInt1280 * -586018753);
	...
	public final void method10976(@OriginalArg(0) Class104 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(4) Class93_Sub41 local4 = new Class93_Sub41(arg1);
		@Pc(6) int local6 = -1;
		label66: while (true) {
			@Pc(10) int local10 = local4.method22464(1496907785);
			if (local10 == 0) {
				return;
			}
			local6 += local10;
				...
				do {
					...
					do {
						do {
							do {
								do {
									@Pc(24) int local24 = local4.method22632((byte) -26);
									if (local24 == 0) {
										continue label66;
									}
									local20 += local24 - 1;
	...
	final void method10977(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) Class458 arg10) {
		...
		if (Class51.aClass93_Sub36_1.aClass166_Sub14_1.method15654(-1138395363) == 0 && local17.aBoolean838) {
			return;
		}
		@Pc(37) int local37;
		@Pc(42) int local42;
		...
		@Pc(198) int local198 = (local42 << 8) + (arg4 << 9);
		@Pc(211) boolean local211 = this.aBoolean232 && !this.aBoolean236 && local17.aBoolean830;
		if (local17.method31985(1496718186)) {
			Class643.method32583(arg2, arg3, arg4, arg6, local17, (Class132_Sub1_Sub1_Sub1_Sub1) null, (Class132_Sub1_Sub1_Sub1_Sub2) null, 694869299);
		}
		@Pc(252) boolean local252 = arg8 == -1 && (!local17.method32009((byte) -17) || local17.aBoolean831 && Class51.aClass93_Sub36_1.aClass166_Sub31_1.method16108((short) 23182) == 0) && local17.anIntArray492 == null && !local17.aBoolean840 && !local17.aBoolean841;
		if (aBoolean241 && (Class549.method31025(arg7, -1331345271) && local17.anInt5594 * 1349946317 != 1 || !(!Class281.method26460(arg7, 1231996485) || local17.anInt5594 * 1349946317 != 0))) {
			return;
		}
		if (arg7 != Class615.aClass615_24.anInt5628 * 948246811) {
			@Pc(426) Class132_Sub1_Sub1 local426;
			...
			if (Class615.aClass615_21.anInt5628 * 948246811 == arg7 || arg7 == Class615.aClass615_22.anInt5628 * 948246811) {
				...
				if (this.aClass585_5.method31497(local426, false, -2142397325)) {
			...
			} else if (Class281.method26460(arg7, 1407992027) || Class476.method29686(arg7, -825987591)) {
				if (local252) {
					local378 = new Class132_Sub1_Sub1_Sub2(this.aClass585_5, arg0, this.aClass32_Sub14_1, local17, arg2, arg1, local190, local155, local198, this.aBoolean236, arg3, local37 + arg3 - 1, arg4, local42 + arg4 - 1, arg7, arg6, local211, true, arg10);
				...
				this.aClass585_5.method31497(local426, false, -1947287444);
				if (this.aBoolean232 && !this.aBoolean236 && Class281.method26460(arg7, -1352716932) && Class615.aClass615_11.anInt5628 * 948246811 != arg7 && arg2 > 0 && local17.anInt5594 * 1349946317 != 0) {
					this.aByteArrayArrayArray6[arg2][arg3][arg4] = (byte) (this.aByteArrayArrayArray6[arg2][arg3][arg4] | 0x4);
				}
		...
		} else if (Class51.aClass93_Sub36_1.aClass166_Sub3_1.method15402(-1733924144) != 0 || local17.anInt5592 * 1067969079 != 0 || local17.anInt5591 * -297318857 == 1 || local17.aBoolean835) {
			@Pc(333) Class132_Sub1_Sub4 local333;
			if (local252) {
				@Pc(323) Class132_Sub1_Sub4_Sub2 local323 = new Class132_Sub1_Sub4_Sub2(this.aClass585_5, arg0, this.aClass32_Sub14_1, local17, arg2, arg1, local190, local155, local198, this.aBoolean236, arg6, local211, arg10);
	...
	boolean method10978(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) Class610 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) boolean arg14, @OriginalArg(15) Class99 arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) Class458 arg18) {
		...
		if (Class615.aClass615_13.anInt5628 * 948246811 == arg1) {
			...
			this.aClass585_5.method31448(arg7, arg12, arg13, local53, (Class132_Sub1_Sub2) null, -967065086);
			if (arg2 == 0) {
				if (this.aBoolean232 && arg4.aBoolean834) {
					arg15.method2474(arg12, arg13, 50);
					arg15.method2474(arg12, arg13 + 1, 50);
			...
			if (arg4.anInt5597 * 1128343593 != 64) {
				this.aClass585_5.method31494(arg7, arg12, arg13, arg4.anInt5597 * 1128343593, 2076723479);
			}
			return true;
		}
		@Pc(331) Class132_Sub1_Sub2 local331;
		...
		if (arg1 == Class615.aClass615_10.anInt5628 * 948246811) {
			...
			this.aClass585_5.method31448(arg7, arg12, arg13, local331, (Class132_Sub1_Sub2) null, -1556982255);
			if (arg4.aBoolean834 && this.aBoolean232) {
				if (arg2 == 0) {
					arg15.method2474(arg12, arg13 + 1, 50);
				} else if (arg2 == 1) {
			...
			this.aClass585_5.method31448(arg7, arg12, arg13, local331, local53, 1068406428);
			if ((arg4.anInt5594 * 1349946317 == 1 || aBoolean240 && arg4.anInt5594 * 1349946317 == -1) && !this.aBoolean236) {
				if (arg2 == 0) {
					this.aClass585_5.aClass598_2.method31825(1, arg7, arg12, arg13, arg4.anInt5595 * -2039712105, arg4.anInt5596 * 955083601);
					this.aClass585_5.aClass598_2.method31825(2, arg7, arg12, arg13 + 1, arg4.anInt5595 * -2039712105, arg4.anInt5596 * 955083601);
			...
			if (arg4.anInt5597 * 1128343593 != 64) {
				this.aClass585_5.method31494(arg7, arg12, arg13, arg4.anInt5597 * 1128343593, 2036817184);
			}
			return true;
		} else if (Class615.aClass615_5.anInt5628 * 948246811 == arg1) {
			if (arg3) {
			...
			this.aClass585_5.method31448(arg7, arg12, arg13, local331, (Class132_Sub1_Sub2) null, 823296042);
			if (arg4.aBoolean834 && this.aBoolean232) {
				if (arg2 == 0) {
					arg15.method2474(arg12, arg13 + 1, 50);
				} else if (arg2 == 1) {
			...
			this.aClass585_5.method31497(local899, false, -2082658262);
			if (arg4.anInt5594 * 1349946317 == 1 && !this.aBoolean236) {
				@Pc(957) byte local957;
				if ((arg2 & 0x1) == 0) {
					local957 = 8;
			...
			if (arg4.anInt5597 * 1128343593 != 64) {
				this.aClass585_5.method31494(arg7, arg12, arg13, arg4.anInt5597 * 1128343593, 2107563648);
			}
			return true;
		} else {
			return false;
	...
	Interface61 method10979(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		if (arg1 == 1) {
			local1 = (Interface61) this.aClass585_5.method31464(arg0, arg2, arg3, -2048261820);
		}
		if (arg1 == 2) {
			local1 = (Interface61) this.aClass585_5.method31585(arg0, arg2, arg3, client.anInterface62_1, (byte) 3);
		}
	...
	boolean method10980(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) Class610 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) boolean arg14, @OriginalArg(15) Class99 arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) Class458 arg18) {
		...
		if (Class615.aClass615_13.anInt5628 * 948246811 == arg1) {
			...
			this.aClass585_5.method31448(arg7, arg12, arg13, local53, (Class132_Sub1_Sub2) null, -2035698952);
			if (arg2 == 0) {
				if (this.aBoolean232 && arg4.aBoolean834) {
					arg15.method2474(arg12, arg13, 50);
					arg15.method2474(arg12, arg13 + 1, 50);
			...
			if (arg4.anInt5597 * 1128343593 != 64) {
				this.aClass585_5.method31494(arg7, arg12, arg13, arg4.anInt5597 * 1128343593, 2051174199);
			}
			return true;
		}
		@Pc(331) Class132_Sub1_Sub2 local331;
		...
		if (arg1 == Class615.aClass615_10.anInt5628 * 948246811) {
			...
			this.aClass585_5.method31448(arg7, arg12, arg13, local331, (Class132_Sub1_Sub2) null, -196615372);
			if (arg4.aBoolean834 && this.aBoolean232) {
				if (arg2 == 0) {
					arg15.method2474(arg12, arg13 + 1, 50);
				} else if (arg2 == 1) {
			...
			this.aClass585_5.method31448(arg7, arg12, arg13, local331, local53, 416723625);
			if ((arg4.anInt5594 * 1349946317 == 1 || aBoolean240 && arg4.anInt5594 * 1349946317 == -1) && !this.aBoolean236) {
				if (arg2 == 0) {
					this.aClass585_5.aClass598_2.method31825(1, arg7, arg12, arg13, arg4.anInt5595 * -2039712105, arg4.anInt5596 * 955083601);
					this.aClass585_5.aClass598_2.method31825(2, arg7, arg12, arg13 + 1, arg4.anInt5595 * -2039712105, arg4.anInt5596 * 955083601);
			...
			if (arg4.anInt5597 * 1128343593 != 64) {
				this.aClass585_5.method31494(arg7, arg12, arg13, arg4.anInt5597 * 1128343593, 2069523779);
			}
			return true;
		} else if (Class615.aClass615_5.anInt5628 * 948246811 == arg1) {
			if (arg3) {
			...
			this.aClass585_5.method31448(arg7, arg12, arg13, local331, (Class132_Sub1_Sub2) null, -1988356073);
			if (arg4.aBoolean834 && this.aBoolean232) {
				if (arg2 == 0) {
					arg15.method2474(arg12, arg13 + 1, 50);
				} else if (arg2 == 1) {
			...
			this.aClass585_5.method31497(local899, false, -1948810001);
			if (arg4.anInt5594 * 1349946317 == 1 && !this.aBoolean236) {
				@Pc(957) byte local957;
				if ((arg2 & 0x1) == 0) {
					local957 = 8;
			...
			if (arg4.anInt5597 * 1128343593 != 64) {
				this.aClass585_5.method31494(arg7, arg12, arg13, arg4.anInt5597 * 1128343593, 2025999481);
			}
			return true;
		} else {
			return false;
	...
	boolean method10981(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) Class610 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) Class458 arg14) {
		...
		if (Class615.aClass615_7.anInt5628 * 948246811 == arg1) {
			...
			this.aClass585_5.method31481(arg7, arg12, arg13, local39, (Class132_Sub1_Sub3) null, (byte) -106);
			return true;
		}
		@Pc(83) int local83;
		@Pc(92) Interface61 local92;
		...
		if (Class615.aClass615_8.anInt5628 * 948246811 == arg1) {
			...
			this.aClass585_5.method31481(arg7, arg12, arg13, local39, (Class132_Sub1_Sub3) null, (byte) -59);
			return true;
		} else if (arg1 == Class615.aClass615_9.anInt5628 * 948246811) {
			local83 = 33;
			local92 = (Interface61) this.aClass585_5.method31440(arg7, arg12, arg13, -1309876799);
			...
			this.aClass585_5.method31481(arg7, arg12, arg13, local39, (Class132_Sub1_Sub3) null, (byte) 34);
			return true;
		} else if (arg1 == Class615.aClass615_16.anInt5628 * 948246811) {
			local83 = arg2 + 2 & 0x3;
			if (arg3) {
			...
			this.aClass585_5.method31481(arg7, arg12, arg13, local39, (Class132_Sub1_Sub3) null, (byte) 4);
			return true;
		} else if (Class615.aClass615_2.anInt5628 * 948246811 == arg1) {
			@Pc(418) int local418 = arg2 + 2 & 0x3;
			@Pc(420) int local420 = 33;
			...
			this.aClass585_5.method31481(arg7, arg12, arg13, local39, local525, (byte) -51);
			return true;
		} else {
			return false;
		}
	...
	void method10982(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (local19.method31985(762906085)) {
			Class462.method29277(arg1, arg3, arg4, local19, (byte) 33);
		}
		...
		if (arg2 == 0) {
			this.aClass585_5.method31453(arg1, arg3, arg4, (byte) 1);
			this.aClass585_5.method31610(arg1, arg3, arg4, (byte) 114);
			if (local19.anInt5594 * 1349946317 == 1) {
				if (local27 == 0) {
					this.aClass585_5.aClass598_2.method31787(1, arg1, arg3, arg4);
				} else if (local27 == 1) {
			...
			this.aClass585_5.method31441(arg1, arg3, arg4, client.anInterface62_1, 18005483);
			if (Class615.aClass615_6.anInt5628 * 948246811 == local23) {
				if ((local27 & 0x1) == 0) {
					this.aClass585_5.aClass598_2.method31787(8, arg1, arg3, arg4);
				} else {
			...
			this.aClass585_5.method31457(arg1, arg3, arg4, (byte) 11);
		}
	}
		...
		while (true) {
			...
			while (arg1.anInt3070 * 212851357 < arg1.aByteArray58.length) {
				...
				if (local27 != 0) {
					...
					if (local27 == 1) {
						...
						if (local55 > 0) {
							for (local59 = 0; local59 < local55; local59++) {
								@Pc(74) Class597 local74 = new Class597(arg0, this.aClass585_5.anInt5438 * -358186793, arg1, 2);
								if (local74.anInt5528 * 365017865 == 31) {
									@Pc(88) Class85 local88 = (Class85) Class668.aClass32_Sub15_1.method18261(arg1.method22415(-1434290800), -1035510331);
									local74.method31767(local88.anInt260 * 649135051, local88.anInt262 * 2054784993, local88.anInt259 * 243149709, local88.anInt261 * -88051697, -81207454);
								}
								if (arg0.method20413() > 0) {
									@Pc(113) Class93_Sub16 local113 = local74.aClass93_Sub16_3;
									...
									@Pc(137) int local137 = local129 >> 9;
									if (local133 >= 0 && local137 >= 0 && local133 < this.anInt1279 * -115974587 && local137 < this.anInt1280 * -586018753) {
										local113.method13543(local121, this.anIntArrayArrayArray14[local74.anInt5520 * -1484967795][local133][local137] - local113.method13521(1655674161), local129, -385871603);
										this.aClass585_5.method31483(local74, (byte) 6);
									}
								}
							}
						...
						local13.method33052(arg1, 1357827639);
					} else if (local27 == 128) {
						if (local13 == null) {
							local13 = new Class672();
						}
						local13.method33054(arg1, this.aClass671_1, 1554104531);
					} else if (local27 == 129) {
						if (this.aByteArrayArrayArray5 == null) {
							this.aByteArrayArrayArray5 = new byte[4][][];
						}
						for (local55 = 0; local55 < 4; local55++) {
							@Pc(246) byte local246 = arg1.method22414(834389538);
							if (local246 == 0 && this.aByteArrayArrayArray5[local55] != null) {
								local256 = arg2;
								local260 = arg2 + 64;
								local121 = arg3;
								...
								for (local256 = 0; local256 < 64; local256 += 4) {
									for (local260 = 0; local260 < 64; local260 += 4) {
										@Pc(389) byte local389 = arg1.method22414(772501868);
										for (local129 = local256 + arg2; local129 < local256 + 4 + arg2; local129++) {
											for (local133 = local260 + arg3; local133 < local260 + 4 + arg3; local133++) {
												if (local129 >= 0 && local129 < this.anInt1279 * -115974587 && local133 >= 0 && local133 < this.anInt1280 * -586018753) {
													this.aByteArrayArrayArray5[local55][local129][local133] = local389;
					...
					local13.method33049(arg1, this.aClass671_1, (byte) 63);
				}
			}
			for (local27 = 0; local27 < 8; local27++) {
				for (local55 = 0; local55 < 8; local55++) {
					...
					if (local59 >= 0 && local59 < this.anInt1279 * -115974587 >> 3 && local256 >= 0 && local256 < this.anInt1280 * -586018753 >> 3) {
						if (local13 != null) {
							this.aClass671_1.method32983(local59, local256, local13, 2144764471);
						}
	...
	Interface61 method10984(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		if (arg1 == 1) {
			local1 = (Interface61) this.aClass585_5.method31464(arg0, arg2, arg3, -2048992569);
		}
		if (arg1 == 2) {
			local1 = (Interface61) this.aClass585_5.method31585(arg0, arg2, arg3, client.anInterface62_1, (byte) 3);
		}
	...
	Interface61 method10985(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		if (arg1 == 1) {
			local1 = (Interface61) this.aClass585_5.method31464(arg0, arg2, arg3, -2058043489);
		}
		if (arg1 == 2) {
			local1 = (Interface61) this.aClass585_5.method31585(arg0, arg2, arg3, client.anInterface62_1, (byte) 3);
		}
	...
	final void method10986(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) Class458 arg10) {
		...
		if (Class51.aClass93_Sub36_1.aClass166_Sub14_1.method15654(-881210666) == 0 && local17.aBoolean838) {
			return;
		}
		@Pc(37) int local37;
		@Pc(42) int local42;
		...
		@Pc(198) int local198 = (local42 << 8) + (arg4 << 9);
		@Pc(211) boolean local211 = this.aBoolean232 && !this.aBoolean236 && local17.aBoolean830;
		if (local17.method31985(2046333735)) {
			Class643.method32583(arg2, arg3, arg4, arg6, local17, (Class132_Sub1_Sub1_Sub1_Sub1) null, (Class132_Sub1_Sub1_Sub1_Sub2) null, 694869299);
		}
		@Pc(252) boolean local252 = arg8 == -1 && (!local17.method32009((byte) -96) || local17.aBoolean831 && Class51.aClass93_Sub36_1.aClass166_Sub31_1.method16108((short) 3885) == 0) && local17.anIntArray492 == null && !local17.aBoolean840 && !local17.aBoolean841;
		if (aBoolean241 && (Class549.method31025(arg7, -2140254338) && local17.anInt5594 * 1349946317 != 1 || !(!Class281.method26460(arg7, -1679122361) || local17.anInt5594 * 1349946317 != 0))) {
			return;
		}
		if (arg7 != Class615.aClass615_24.anInt5628 * 948246811) {
			@Pc(426) Class132_Sub1_Sub1 local426;
			...
			if (Class615.aClass615_21.anInt5628 * 948246811 == arg7 || arg7 == Class615.aClass615_22.anInt5628 * 948246811) {
				...
				if (this.aClass585_5.method31497(local426, false, -1950005234)) {
			...
			} else if (Class281.method26460(arg7, 1340892987) || Class476.method29686(arg7, -2136962862)) {
				if (local252) {
					local378 = new Class132_Sub1_Sub1_Sub2(this.aClass585_5, arg0, this.aClass32_Sub14_1, local17, arg2, arg1, local190, local155, local198, this.aBoolean236, arg3, local37 + arg3 - 1, arg4, local42 + arg4 - 1, arg7, arg6, local211, true, arg10);
				...
				this.aClass585_5.method31497(local426, false, -2014285509);
				if (this.aBoolean232 && !this.aBoolean236 && Class281.method26460(arg7, 559319193) && Class615.aClass615_11.anInt5628 * 948246811 != arg7 && arg2 > 0 && local17.anInt5594 * 1349946317 != 0) {
					this.aByteArrayArrayArray6[arg2][arg3][arg4] = (byte) (this.aByteArrayArrayArray6[arg2][arg3][arg4] | 0x4);
				}
		...
		} else if (Class51.aClass93_Sub36_1.aClass166_Sub3_1.method15402(-1019863038) != 0 || local17.anInt5592 * 1067969079 != 0 || local17.anInt5591 * -297318857 == 1 || local17.aBoolean835) {
			@Pc(333) Class132_Sub1_Sub4 local333;
			if (local252) {
				@Pc(323) Class132_Sub1_Sub4_Sub2 local323 = new Class132_Sub1_Sub4_Sub2(this.aClass585_5, arg0, this.aClass32_Sub14_1, local17, arg2, arg1, local190, local155, local198, this.aBoolean236, arg6, local211, arg10);
	...
	Interface61 method10987(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (arg1 == 1) {
			local1 = (Interface61) this.aClass585_5.method31464(arg0, arg2, arg3, -2042186071);
		}
		if (arg1 == 2) {
			local1 = (Interface61) this.aClass585_5.method31585(arg0, arg2, arg3, client.anInterface62_1, (byte) 3);
		}
		...
		if (!arg1) {
			...
			if (this.anInt1292 * 604655629 > 1) {
				for (local12 = 0; local12 < this.anInt1279 * -115974587; local12++) {
					for (local20 = 0; local20 < this.anInt1280 * -586018753; local20++) {
						if ((this.aClass520_2.aByteArrayArrayArray12[1][local12][local20] & 0x2) == 2) {
							this.aClass585_5.method31434(local12, local20, 1092536433);
						}
					}
				}
			}
	...
	static final void method10989(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(1) boolean local1 = false;
		if (client.aBoolean632) {
			try {
				@Pc(43) Object local43 = Class447.aClass447_3.method28911(new Object[] { Class626.anInt5704 * 2085461781, Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aByte75 == 1, arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091] }, 466662730);
				if (local43 != null) {
	...
	static void method10991(@OriginalArg(0) Class104 arg0, @OriginalArg(1) byte arg1) {
		if (Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aByte100 != 405524325 * Class172.anInt3175 && client.aClass532_1.method30459(-1234365214) != null) {
			Class305.method26796(151523623);
