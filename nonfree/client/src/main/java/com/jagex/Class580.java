...
public class Class580 {
	...
	void method31375(@OriginalArg(0) int arg0) {
		if (this.aBoolean816 && this.aSourceDataLine1 != null) {
			this.anInt5413 = this.aSourceDataLine1.available() * -778815923;
		}
	}
	...
	void method31377(@OriginalArg(0) int arg0) {
		synchronized (this) {
				...
				while (true) {
					...
					while (local116.anInt5394 * 1902392331 > 0 && local130 < local5) {
						...
						if (local116.aFloat334 == this.aFloat335) {
							...
							local166 = (short) (int) ((float) local222 + local348 * local366);
							local141++;
	...
	void method31378(@OriginalArg(0) Class570 arg0, @OriginalArg(1) byte arg1) {
		this.aList23.add(arg0);
	}

	@OriginalMember(owner = "client!ts", name = "f", descriptor = "(Lclient!th;I)V", line = 508)
	void method31379(@OriginalArg(0) Class570 arg0, @OriginalArg(1) int arg1) {
	...
	void method31381(@OriginalArg(0) Class570 arg0) {
		this.aList23.add(arg0);
	}
	...
	static final void method31385(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method31386(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
		...
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class476.method29687(local13, (byte) 118) ? 1 : 0;
	}

	@OriginalMember(owner = "client!ts", name = "p", descriptor = "(IIB)I", line = 109)
	static int method31387(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
	...
	static final void method31388(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = client.aClass270_1.method26278(local13, -1111851480).method26376(local23, 310789150) ? 1 : 0;
	}

	@OriginalMember(owner = "client!ts", name = "ah", descriptor = "(B)J", line = 656)
	static long method31389(@OriginalArg(0) byte arg0) {
