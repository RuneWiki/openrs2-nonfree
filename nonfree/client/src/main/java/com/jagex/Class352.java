...
public class Class352 {
	...
	void method27652(@OriginalArg(0) int arg0) {
		@Pc(4) Class93_Sub33 local4 = this.method27659(arg0, -1511884902);
		if (local4 != null) {
	...
	public Class93_Sub33 method27653(@OriginalArg(0) String arg0, @OriginalArg(1) byte arg1) {
	...
	void method27654(@OriginalArg(0) int arg0) {
		@Pc(4) Class93_Sub33 local4 = this.method27659(arg0, 1356607212);
		if (local4 != null) {
	...
	void method27657(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(4) Class93_Sub33 local4 = this.method27659(arg0, -546215270);
		if (local4 != null) {
	...
	public Class93_Sub33 method27659(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg0 >= this.aClass93_Sub33Array1.length ? null : this.aClass93_Sub33Array1[arg0];
	}
	...
	public void method27660(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) Class93_Sub33 arg2) {
		@Pc(4) Class93_Sub33 local4 = this.method27653(arg1, (byte) 57);
		if (local4 != null && local4.anInt3226 * -612431395 != arg0) {
			throw new IllegalArgumentException(arg1);
		}
		this.method27657(arg0, -178771717);
		...
		this.aClass16_32.method221(arg2, this.anInterface28_4.method26840(arg1, 1687016731));
	...
	void method27661(@OriginalArg(0) int arg0) {
		@Pc(4) Class93_Sub33 local4 = this.method27659(arg0, -1993491878);
		if (local4 != null) {
	...
	public void method27662(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) Class93_Sub33 arg2) {
		@Pc(4) Class93_Sub33 local4 = this.method27653(arg1, (byte) 76);
		if (local4 != null && local4.anInt3226 * -612431395 != arg0) {
			throw new IllegalArgumentException(arg1);
		}
		this.method27657(arg0, 1170214005);
		if (arg0 >= this.aClass93_Sub33Array1.length) {
			@Pc(30) int local30;
			for (local30 = this.aClass93_Sub33Array1.length; local30 <= arg0; local30 += local30) {
			}
		...
		arg2.anInt3226 = arg0 * -474114443;
		arg2.aString120 = arg1;
		this.aClass16_32.method221(arg2, this.anInterface28_4.method26840(arg1, -1185553730));
		this.aClass93_Sub33Array1[arg0] = arg2;
	}
	...
	public void method27663(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) Class93_Sub33 arg2) {
		@Pc(4) Class93_Sub33 local4 = this.method27653(arg1, (byte) 122);
		if (local4 != null && local4.anInt3226 * -612431395 != arg0) {
			throw new IllegalArgumentException(arg1);
		}
		this.method27657(arg0, -1840374418);
		if (arg0 >= this.aClass93_Sub33Array1.length) {
			@Pc(30) int local30;
			for (local30 = this.aClass93_Sub33Array1.length; local30 <= arg0; local30 += local30) {
			}
		...
		arg2.anInt3226 = arg0 * -474114443;
		arg2.aString120 = arg1;
		this.aClass16_32.method221(arg2, this.anInterface28_4.method26840(arg1, 633658383));
		this.aClass93_Sub33Array1[arg0] = arg2;
	}

	@OriginalMember(owner = "client!ix", name = "k", descriptor = "(ILjava/lang/String;Lclient!akw;B)V", line = 43)
	public void method27664(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) Class93_Sub33 arg2, @OriginalArg(3) byte arg3) {
		@Pc(4) Class93_Sub33 local4 = this.method27653(arg1, (byte) 37);
		if (local4 != null && local4.anInt3226 * -612431395 != arg0) {
			throw new IllegalArgumentException(arg1);
		}
		this.method27657(arg0, -798924541);
		if (arg0 >= this.aClass93_Sub33Array1.length) {
			@Pc(30) int local30;
			for (local30 = this.aClass93_Sub33Array1.length; local30 <= arg0; local30 += local30) {
			}
		...
		arg2.anInt3226 = arg0 * -474114443;
		arg2.aString120 = arg1;
		this.aClass16_32.method221(arg2, this.anInterface28_4.method26840(arg1, -387623651));
		this.aClass93_Sub33Array1[arg0] = arg2;
	}

	@OriginalMember(owner = "client!ix", name = "c", descriptor = "(Lclient!dh;IIIIIIII)V", line = 347)
	static void method27665(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		@Pc(3) Class585 local3 = client.aClass532_1.method30459(-2139063039);
		...
		@Pc(50) int local50;
		if (local11 != null) {
			local24 = (Class610) client.aClass532_1.method30466(850690886).method18261(local11.method13423(-1037211373), -444023650);
		...
		if (local11 != null) {
			...
			if (-303013723 * local24.anInt5601 != -1) {
				...
				if (local30 == 0 || local30 == 2) {
					arg0.method20673(arg4, arg5 + 3, arg4 + 3, arg5, local50, 242132452);
				} else {
					arg0.method20673(arg4, arg5, arg4 + 3, arg5 + 3, local50, -1416038410);
				}
			}
		}
		...
		local24 = (Class610) client.aClass532_1.method30466(1742546820).method18261(local11.method13423(-1037211373), 592037436);
		local30 = local11.method13404(2001249884) & 0x3;
		if (-303013723 * local24.anInt5601 != -1) {
			Class107.method18122(arg0, local24, local30, arg4, arg5, 2144043100);
		}
	}

	@OriginalMember(owner = "client!ix", name = "n", descriptor = "(Ljava/io/InputStream;II)[B", line = 26)
	static byte[] method27666(@OriginalArg(0) InputStream arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
		...
		synchronized (Class549.aClass565_1) {
			if (!Class549.aClass565_1.method31238(local2, -1201282622)) {
	...
	static void method27667(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method27668(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5891 -= -1915563430;
	}

	@OriginalMember(owner = "client!ix", name = "bdz", descriptor = "(Lclient!yf;I)V", line = 14784)
	static final void method27669(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = client.aClass270_1.method26276(1824602219);
	}

	@OriginalMember(owner = "client!ix", name = "e", descriptor = "(I)[Lclient!aaj;", line = 11)
	static Class12[] method27670(@OriginalArg(0) int arg0) {
	...
	public static Class388[] method27671(@OriginalArg(0) int arg0) {
