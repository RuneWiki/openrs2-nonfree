...
public abstract class Class44 implements Interface4 {
	...
	void method17411(@OriginalArg(0) int arg0) {
		...
		synchronized (this.aClass240_59) {
			this.aClass240_59.method25832(arg0, (byte) -81);
		}
	...
	Class100 method17412(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class658 arg6, @OriginalArg(7) int arg7) {
	...
	Class100 method17413(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class104 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6, @OriginalArg(7) boolean arg7, @OriginalArg(8) int arg8, @OriginalArg(9) Class106 arg9, @OriginalArg(10) Class658 arg10, @OriginalArg(11) Class645 arg11, @OriginalArg(12) Interface11 arg12, @OriginalArg(13) int arg13) {
		if (!arg7) {
			@Pc(12) Class100 local12 = this.method17412(arg1, arg2, arg3, arg4, arg5, arg8, arg10, -1870789004);
			if (local12 != null) {
				return local12;
			}
		}
		...
		if (arg7) {
			local93 = arg0.method20498(local77, 0, 36, 36, 32, 438797212);
		} else {
			local93 = arg1.method20498(local77, 0, 36, 36, 32, 438797212);
		}
		if (!arg7) {
	...
	void method17414(@OriginalArg(0) boolean arg0, @OriginalArg(1) byte arg1) {
	...
	void method17415(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.anInt2426 = arg0 * -307559039;
		@Pc(8) Class240 local8 = this.aClass240_59;
		synchronized (this.aClass240_59) {
			this.aClass240_59.method25833((byte) -55);
		}
	}
	...
	void method17417(@OriginalArg(0) int arg0) {
		@Pc(3) Class652 local3 = this.aClass652_2;
		synchronized (this.aClass652_2) {
			this.aClass652_2.method32682();
		}
	...
	void method17418(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_59;
		synchronized (this.aClass240_59) {
			this.aClass240_59.method25837(1161602830);
		}
	...
	void method17419(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_59;
		synchronized (this.aClass240_59) {
			this.aClass240_59.method25833((byte) -5);
		}
		@Pc(20) Class652 local20 = this.aClass652_2;
		synchronized (this.aClass652_2) {
			this.aClass652_2.method32682();
	...
	void method17420(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		@Pc(3) Class240 local3 = this.aClass240_59;
		synchronized (this.aClass240_59) {
			this.aClass240_59.method25832(arg0, (byte) -29);
		}
		@Pc(21) Class652 local21 = this.aClass652_2;
		synchronized (this.aClass652_2) {
			this.aClass652_2.method32681(arg0);
	...
	void method17422(@OriginalArg(0) int arg0) {
		...
		@Pc(8) Class240 local8 = this.aClass240_59;
		synchronized (this.aClass240_59) {
			this.aClass240_59.method25833((byte) -51);
		}
	}
	...
	void method17423() {
		@Pc(3) Class240 local3 = this.aClass240_59;
		synchronized (this.aClass240_59) {
			this.aClass240_59.method25833((byte) -86);
		}
		@Pc(20) Class652 local20 = this.aClass652_2;
		synchronized (this.aClass652_2) {
			this.aClass652_2.method32682();
	...
	Class100 method17424(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class104 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6, @OriginalArg(7) boolean arg7, @OriginalArg(8) int arg8, @OriginalArg(9) Class106 arg9, @OriginalArg(10) Class658 arg10, @OriginalArg(11) Class645 arg11, @OriginalArg(12) Interface11 arg12) {
		if (!arg7) {
			@Pc(12) Class100 local12 = this.method17412(arg1, arg2, arg3, arg4, arg5, arg8, arg10, -1844638167);
			if (local12 != null) {
				return local12;
			}
		}
	...
	void method17425(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_59;
		synchronized (this.aClass240_59) {
			this.aClass240_59.method25832(arg0, (byte) 5);
		}
		@Pc(21) Class652 local21 = this.aClass652_2;
		synchronized (this.aClass652_2) {
			this.aClass652_2.method32681(arg0);
	...
	static final void method17429(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		Class430.method28761(local11, local14, arg0, 862007149);
	}
	...
	static final void method17430(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1885375190);
