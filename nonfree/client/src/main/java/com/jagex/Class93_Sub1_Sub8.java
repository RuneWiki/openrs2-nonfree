...
public class Class93_Sub1_Sub8 extends Class93_Sub1 {
	...
	boolean method21716(@OriginalArg(0) Class93_Sub1_Sub7 arg0) {
		...
		while (local10 != null) {
			if (Class19_Sub3.method17555(arg0.anInt3012 * -92627949, local10.anInt3012 * -92627949, 1385938362)) {
				Class615.method32087(arg0, local10, -1869149186);
	...
	boolean method21717(@OriginalArg(0) Class93_Sub1_Sub7 arg0, @OriginalArg(1) int arg1) {
		@Pc(1) boolean local1 = true;
		arg0.method23976((short) -3927);
		@Pc(10) Class93_Sub1_Sub7 local10 = (Class93_Sub1_Sub7) this.aClass18_10.method246(1597596279);
		while (local10 != null) {
			if (Class19_Sub3.method17555(arg0.anInt3012 * -92627949, local10.anInt3012 * -92627949, 1385938362)) {
				Class615.method32087(arg0, local10, -2032140513);
				this.anInt3013 += -280530287;
				return !local1;
			}
	...
	boolean method21718(@OriginalArg(0) Class93_Sub1_Sub7 arg0, @OriginalArg(1) short arg1) {
		@Pc(3) int local3 = this.method21719(2057192320);
		arg0.method23976((short) 21114);
		this.anInt3013 -= -280530287;
		if (this.anInt3013 * -2109043087 != 0) {
			return local3 != this.method21719(-2315352);
		}
	...
	int method21719(@OriginalArg(0) int arg0) {
		return this.aClass18_10.aClass93_Sub1_4 == this.aClass18_10.aClass93_Sub1_4.aClass93_Sub1_68 ? -1 : ((Class93_Sub1_Sub7) this.aClass18_10.aClass93_Sub1_4.aClass93_Sub1_68).anInt3012 * -92627949;
	}
	...
	boolean method21722(@OriginalArg(0) Class93_Sub1_Sub7 arg0) {
		@Pc(3) int local3 = this.method21719(1246044113);
		arg0.method23976((short) -4317);
		this.anInt3013 -= -280530287;
		if (this.anInt3013 * -2109043087 != 0) {
			return local3 != this.method21719(712876979);
		}
