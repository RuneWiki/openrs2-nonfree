...
public class Class110_Sub3 extends Class110 {
	...
	public void method20140() {
		Class249.aClass239Array1[this.anInt835 * -1364798489].method25804(this.anInt834 * 45612679, this.anInt838 * 479703155, this.anInt836 * 322253847, this.anInt837 * -2132965761, -1366563989);
	}

	@OriginalMember(owner = "client!afp", name = "n", descriptor = "(I)V", line = 23)
	@Override
	public void method20138(@OriginalArg(0) int arg0) {
		Class249.aClass239Array1[this.anInt835 * -1364798489].method25804(this.anInt834 * 45612679, this.anInt838 * 479703155, this.anInt836 * 322253847, this.anInt837 * -2132965761, -1588549366);
	}

	@OriginalMember(owner = "client!afp", name = "<init>", descriptor = "(Lclient!alw;)V", line = 13)
	Class110_Sub3(@OriginalArg(0) Class93_Sub41 arg0) {
		super(arg0);
		this.anInt835 = arg0.method22415(-1434290800) * 25858007;
		@Pc(13) int local13 = arg0.method22419(-118643075);
		this.anInt834 = (local13 >>> 16) * -1200593097;
		this.anInt838 = (local13 & 0xFFFF) * 541750459;
		this.anInt836 = arg0.method22413((short) 16384) * 1446986663;
		this.anInt837 = arg0.method22431(-358186793) * -1126680193;
	}
	...
	static final void method7101(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		Class499.method30148(local13, arg2, -1204439644);
	}
}
