...
public abstract class Class115 {
	...
	public Class93_Sub33_Sub1 method8198(@OriginalArg(0) String arg0, @OriginalArg(1) byte arg1) throws Exception_Sub2_Sub1 {
		@Pc(6) Class93_Sub33_Sub1 local6 = (Class93_Sub33_Sub1) this.aClass352_6.method27653(arg0, (byte) 45);
		if (local6 == null) {
	...
	public Class93_Sub33_Sub1 method8201(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return (Class93_Sub33_Sub1) this.aClass352_6.method27659(arg0, -803804167);
	}
	...
	public String method8227(@OriginalArg(0) int arg0) {
		return this.aString38;
	}

	@OriginalMember(owner = "client!ho", name = "ad", descriptor = "(IB)Lclient!aql;", line = 200)
	public Class93_Sub33_Sub1 method8228(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		return (Class93_Sub33_Sub1) this.aClass352_5.method27659(arg0, 306803012);
	}

	@OriginalMember(owner = "client!ho", name = "am", descriptor = "(Ljava/lang/String;S)Lclient!aql;", line = 204)
	public Class93_Sub33_Sub1 method8229(@OriginalArg(0) String arg0, @OriginalArg(1) short arg1) {
		return (Class93_Sub33_Sub1) this.aClass352_5.method27653(arg0, (byte) 104);
	}

	@OriginalMember(owner = "client!ho", name = "au", descriptor = "(I)I", line = 208)
	public int method8230(@OriginalArg(0) int arg0) {
		return this.anInt969 * 1811824185;
	}

	@OriginalMember(owner = "client!ho", name = "at", descriptor = "(I)I", line = 196)
	public int method8231(@OriginalArg(0) int arg0) {
	...
	public int method8241(@OriginalArg(0) Class116 arg0, @OriginalArg(1) int arg1) {
	...
	public Class116 method8258(@OriginalArg(0) int arg0) {
		@Pc(2) Class116[] local2 = this.aClass116Array3;
		for (@Pc(4) int local4 = 0; local4 < local2.length; local4++) {
			@Pc(12) Class116 local12 = local2[local4];
			if (local12.method8438()) {
	...
	public Class116 method8268(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) throws Exception_Sub2_Sub2 {
		@Pc(2) Class116[] local2 = this.aClass116Array3;
		for (@Pc(4) int local4 = 0; local4 < local2.length; local4++) {
			@Pc(12) Class116 local12 = local2[local4];
			@Pc(16) String local16 = local12.method8437((short) 256);
	...
	Class115(@OriginalArg(0) Class104_Sub2 arg0, @OriginalArg(1) Class314 arg1) {
		...
		for (local27 = 0; local27 < this.anInt969 * 1811824185; local27++) {
			this.aClass352_6.method27664(local27, arg1.aClass325Array1[local27].aString176, this.method8206(arg1.aClass325Array1[local27]), (byte) 58);
		}
		...
		for (local27 = 0; local27 < this.anInt970 * 1281809107; local27++) {
			this.aClass352_5.method27664(local27, arg1.aClass325Array2[local27].aString176, this.method8206(arg1.aClass325Array2[local27]), (byte) 95);
		}
	...
	public Class93_Sub33_Sub1 method8304(@OriginalArg(0) int arg0) {
		return (Class93_Sub33_Sub1) this.aClass352_5.method27659(arg0, 541698169);
	}
	...
	public Class93_Sub33_Sub1 method8307(@OriginalArg(0) int arg0) {
		return (Class93_Sub33_Sub1) this.aClass352_6.method27659(arg0, -518017370);
	}
	...
	public Class93_Sub33_Sub1 method8308(@OriginalArg(0) int arg0) {
		return (Class93_Sub33_Sub1) this.aClass352_6.method27659(arg0, -1147879684);
	}
	...
	static final void method8312(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) throws Exception_Sub3 {
		arg0.anInt5891 -= -725861497;
		Class65.aClass123_Sub1_2.method9025((float) arg0.anIntArray519[arg0.anInt5891 * -1497248091], (float) arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1], (float) arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 2], (byte) 0);
	}

	@OriginalMember(owner = "client!ho", name = "bex", descriptor = "(Lclient!yf;B)V", line = 14882)
	static final void method8313(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		Class146.aClass344_3.method27530(65280);
	}
	...
	static Class48 method8314(@OriginalArg(0) Class47 arg0, @OriginalArg(1) Class93_Sub41 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(8) int local8 = arg1.method22413((short) 16384);
		...
		if (local16) {
			if (arg2 <= 1) {
				local4.anIntArray14[0] = arg1.method22415(-1434290800);
				local4.anIntArray12[0] = arg1.method22415(-1434290800);
			} else {
				local4.anIntArray14[0] = arg1.method22436(-776001146);
				local4.anIntArray12[0] = arg1.method22436(-497046281);
			}
			if (arg0.anInt143 * 876926327 != -1 || arg0.anInt158 * 61740559 != -1) {
				if (arg2 <= 1) {
					local4.anIntArray14[1] = arg1.method22415(-1434290800);
					local4.anIntArray12[1] = arg1.method22415(-1434290800);
				} else {
					local4.anIntArray14[1] = arg1.method22436(-1520765468);
					local4.anIntArray12[1] = arg1.method22436(-548476675);
				}
			}
			if (arg0.anInt159 * -606200001 != -1 || arg0.anInt160 * -492567931 != -1) {
				if (arg2 <= 1) {
					local4.anIntArray14[2] = arg1.method22415(-1434290800);
					local4.anIntArray12[2] = arg1.method22415(-1434290800);
				} else {
					local4.anIntArray14[2] = arg1.method22436(-256435210);
					local4.anIntArray12[2] = arg1.method22436(-1341653095);
				}
			}
		}
		if (local24) {
			if (arg2 <= 1) {
				local4.anIntArray13[0] = arg1.method22415(-1434290800);
				local4.anIntArray15[0] = arg1.method22415(-1434290800);
			} else {
				local4.anIntArray13[0] = arg1.method22436(-1405354356);
				local4.anIntArray15[0] = arg1.method22436(-872500586);
			}
			if (arg0.anInt141 * 1052917305 != -1 || arg0.anInt168 * -1920351591 != -1) {
				if (arg2 <= 1) {
					local4.anIntArray13[1] = arg1.method22415(-1434290800);
					local4.anIntArray15[1] = arg1.method22415(-1434290800);
				} else {
					local4.anIntArray13[1] = arg1.method22436(-1817063843);
					local4.anIntArray15[1] = arg1.method22436(-1454531620);
				}
			}
		}
		@Pc(247) int local247;
		...
		@Pc(282) int local282;
		if (local32) {
			local247 = arg1.method22415(-1434290800);
			...
			for (local282 = 0; local282 < 4; local282++) {
				if (local250[local282] != 15) {
					local4.aShortArray6[local250[local282]] = (short) arg1.method22415(-1434290800);
				}
			}
		}
		if (local41) {
			local247 = arg1.method22413((short) 16384);
			local250 = new int[] { local247 & 0xF, local247 >> 4 & 0xF };
			for (local282 = 0; local282 < 2; local282++) {
				if (local250[local282] != 15) {
					local4.aShortArray7[local250[local282]] = (short) arg1.method22415(-1434290800);
				}
			}
		}
		return local4;
	...
	static final void method8315(@OriginalArg(0) Class681 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2) {
	...
	static final void method8316(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = arg0.aClass386_3.method28165((String) arg0.anObjectArray45[(arg0.anInt5888 -= 957530791) * 587908375], (byte) 26);
	}

	@OriginalMember(owner = "client!ho", name = "aid", descriptor = "(Lclient!yf;S)V", line = 11269)
	static final void method8317(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = Class372.aClass58_2.method1097(local12, -737304293).method22947(-1491104235);
	}
	...
	static final void method8319(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1121503173);
		Class202.method24645(local16, arg0, 211290235);
	}
}
