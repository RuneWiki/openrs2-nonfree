...
public class Class670 {
	...
	public static void method32953(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(3) Interface39 arg3) {
		if (aClass146_6 != null) {
			aClass146_6.method11689(567429094).method28657(arg0, arg1, arg2, arg3, -1618005872);
		}
	}
	...
	public static Class420 method32954(@OriginalArg(0) int arg0) {
		return aClass146_6 == null ? null : aClass146_6.method11689(-1145422705).method28660(arg0, (byte) 76);
	}

	@OriginalMember(owner = "client!xt", name = "cp", descriptor = "(Lclient!yf;I)V", line = 5350)
	static final void method32955(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class542.method30934(local11, local14, arg0, 1189701933);
	}

	@OriginalMember(owner = "client!xt", name = "z", descriptor = "(FFFF[FI)V", line = 320)
	static void method32956(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float[] arg4, @OriginalArg(5) int arg5) {
	...
	static final void method32957(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		arg0.anObjectArray31 = Class499.method30148(local13, arg2, 1823503780);
	...
	public static final void method32958(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		@Pc(2) Class175 local2 = Class330.method27372(-1999693521);
		@Pc(8) Class93_Sub22 local8 = Class102.method2592(Class446.aClass446_66, local2.aClass24_2, (byte) 124);
		if (arg1.length() > 30) {
			arg1 = arg1.substring(0, 30);
		}
		local8.aClass93_Sub41_Sub2_1.method22510(Class46.method894(arg0, -2112445074) + Class46.method894(arg1, -2002128209), (byte) -97);
		local8.aClass93_Sub41_Sub2_1.method22402(arg0, 660568065);
		local8.aClass93_Sub41_Sub2_1.method22402(arg1, 330355015);
		local2.method24351(local8, -2034693953);
	}

	@OriginalMember(owner = "client!xt", name = "ac", descriptor = "(IIB)V", line = 454)
	static void method32959(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
	...
	static final void method32960(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
