...
class Class267 implements Interface68 {
	...
	public void method26239(@OriginalArg(0) Interface70 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) byte arg4) {
		this.this$0.method26116(-955423366).add(arg0);
		if (arg3) {
			this.this$0.method26029(326757420).method25830(arg0, (long) arg2);
		} else {
			this.this$0.method26028(652954416).method25831(arg0, (long) arg2, arg0.method32530(-1889732018), -1831774392);
		}
	}
	...
	public void method26238(@OriginalArg(0) Interface70 arg0, @OriginalArg(1) int arg1) {
		if (arg0 != null) {
			this.this$0.method26028(652954416).method25839((long) arg0.method32558((byte) -15));
		}
	}
	...
	public void method26241(@OriginalArg(0) Interface70 arg0) {
		if (arg0 != null) {
			this.this$0.method26028(652954416).method25839((long) arg0.method32558((byte) 2));
		}
	}
	...
	public void method26240(@OriginalArg(0) Interface70 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		this.this$0.method26116(1150189696).add(arg0);
		if (arg3) {
			this.this$0.method26029(304691536).method25830(arg0, (long) arg2);
		} else {
			this.this$0.method26028(652954416).method25831(arg0, (long) arg2, arg0.method32530(-2066056507), -1418338687);
		}
	}
	...
	public void method26237(@OriginalArg(0) Interface70 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		this.this$0.method26116(584432444).add(arg0);
		if (arg3) {
			this.this$0.method26029(-1980514942).method25830(arg0, (long) arg2);
		} else {
			this.this$0.method26028(652954416).method25831(arg0, (long) arg2, arg0.method32530(-2053916371), 301859554);
		}
	}
	...
	public void method26242(@OriginalArg(0) Interface70 arg0) {
		if (arg0 != null) {
			this.this$0.method26028(652954416).method25839((long) arg0.method32558((byte) 40));
		}
	}
	...
	public void method26243(@OriginalArg(0) Interface70 arg0) {
		if (arg0 != null) {
			this.this$0.method26028(652954416).method25839((long) arg0.method32558((byte) 89));
		}
	}

	@OriginalMember(owner = "client!fl", name = "asw", descriptor = "(Lclient!yf;I)V", line = 13182)
	static final void method26244(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		Class51.aClass93_Sub36_1.method14357(Class51.aClass93_Sub36_1.aClass166_Sub24_1, arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091], (byte) 48);
	...
	public static void method26248(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4) {
