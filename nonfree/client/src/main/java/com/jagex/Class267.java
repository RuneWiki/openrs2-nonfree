...
class Class267 implements Interface68 {
	...
	@Override
	public void method26239(@OriginalArg(0) Interface70 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		this.this$0.method26116().add(arg0);
		if (arg3) {
			this.this$0.method26029().method25830(arg0, (long) arg2);
		} else {
			this.this$0.method26028().method25831(arg0, (long) arg2, arg0.method32530());
		}
	}

	@OriginalMember(owner = "client!fl", name = "m", descriptor = "(Lclient!wr;IIZ)V", line = 588)
	@Override
	public void method26240(@OriginalArg(0) Interface70 arg0, @OriginalArg(2) int arg1, @OriginalArg(3) boolean arg2) {
		this.this$0.method26116().add(arg0);
		if (arg2) {
			this.this$0.method26029().method25830(arg0, (long) arg1);
		} else {
			this.this$0.method26028().method25831(arg0, (long) arg1, arg0.method32530());
		}
	}

	@OriginalMember(owner = "client!fl", name = "k", descriptor = "(Lclient!wr;IIZ)V", line = 588)
	@Override
	public void method26237(@OriginalArg(0) Interface70 arg0, @OriginalArg(2) int arg1, @OriginalArg(3) boolean arg2) {
		this.this$0.method26116().add(arg0);
		if (arg2) {
			this.this$0.method26029().method25830(arg0, (long) arg1);
		} else {
	...
	@Override
	public void method26238(@OriginalArg(0) Interface70 arg0) {
		if (arg0 != null) {
			this.this$0.method26028().method25839((long) arg0.method32558());
		}
	}
	...
	public static void method26248(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
	...
	static final void method26246(@OriginalArg(0) Class681 arg0) {
	...
	static final void method26247(@OriginalArg(0) Class681 arg0) {
	...
	static final void method26245(@OriginalArg(0) Class681 arg0) {
	...
	static final void method26249(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = Class449.aClass514_1.method30267(local12).aString107;
	}

	@OriginalMember(owner = "client!fl", name = "asw", descriptor = "(Lclient!yf;I)V", line = 13182)
	static final void method26244(@OriginalArg(0) Class681 arg0) {
		Class51.aClass93_Sub36_1.method14357(Class51.aClass93_Sub36_1.aClass166_Sub24_1, arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091]);
