...
public abstract class Class124 {
	...
	public abstract boolean method21401(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!kl", name = "m", descriptor = "(B)Lclient!ox;")
	public abstract Class472 method21402(@OriginalArg(0) byte arg0);
	...
	public abstract Class93_Sub30 method21404(@OriginalArg(0) byte arg0);

	@OriginalMember(owner = "client!kl", name = "w", descriptor = "(I)F")
	public abstract float method21405(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!kl", name = "l", descriptor = "(Lclient!ju;IIB)V")
	public abstract void method21406(@OriginalArg(0) Class368 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3);

	@OriginalMember(owner = "client!kl", name = "u", descriptor = "(Lclient!alw;I)V")
	public abstract void method21407(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1);
	...
	public abstract double[] method21413(@OriginalArg(0) int arg0);
	...
	public abstract void method21421(@OriginalArg(0) float arg0, @OriginalArg(1) int[][][] arg1, @OriginalArg(2) Class520 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) byte arg5);
	...
	static final void method21425(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class493.method30014(local13, local23, true, false, 925159299);
	}

	@OriginalMember(owner = "client!kl", name = "adj", descriptor = "(Lclient!yf;I)V", line = 10173)
	static final void method21426(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
	...
	static final void method21427(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		local27.method16018(local13, (byte) -45);
		client.aBoolean619 = true;
	}

	@OriginalMember(owner = "client!kl", name = "aqr", descriptor = "(Lclient!yf;I)V", line = 12835)
	static final void method21428(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!kl", name = "bec", descriptor = "(Lclient!yf;I)V", line = 14843)
	static final void method21429(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5891 -= -725861497;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		@Pc(33) int local33 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 2];
		@Pc(43) Integer local43 = (Integer) client.aClass270_1.method26278(local13, -818402460).method26387(local23, local33, (byte) -91);
		if (local43 == null) {
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
		} else {
	...
	static void method21430(@OriginalArg(0) Class93_Sub41_Sub2 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) boolean local8 = arg0.method22413((short) 16384) == 1;
		if (!local8) {
			return;
		}
		@Pc(12) boolean local12 = false;
		@Pc(18) int local18 = arg0.method22664(-1905559379) << 24;
		@Pc(26) int local26 = local18 | arg0.method22664(-1795674623) << 16;
		@Pc(34) int local34 = local26 | arg0.method22664(-1708200762) << 8;
		@Pc(40) int local40 = local34 | arg0.method22664(-617258435);
		Class266.aClass306_1.method26817(Class413.aLong272 * 1983505324986122333L, local40, 823690709);
	}
}
