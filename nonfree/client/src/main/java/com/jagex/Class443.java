...
public class Class443 implements Interface75 {
	...
	public static Class584 method28868(@OriginalArg(0) Class497 arg0, @OriginalArg(1) String arg1, @OriginalArg(2) boolean arg2) {
		@Pc(4) int local4 = arg0.method30067(arg1);
		if (local4 == -1) {
			return new Class584(0);
		}
		@Pc(18) byte[] local18 = arg0.method30044(local4, 1);
		if (local18 == null) {
			return new Class584(0);
		}
		@Pc(30) Class93_Sub41 local30 = new Class93_Sub41(local18);
		@Pc(34) int local34 = local30.method22415();
		@Pc(39) Class584 local39 = new Class584(local34);
		@Pc(41) int local41 = 0;
		while (true) {
			while (local41 < local39.anInt5436 * 1285867561) {
				@Pc(51) int local51 = local30.method22419();
				@Pc(55) int local55 = local30.method22415();
				@Pc(59) int local59 = local30.method22413();
				if (!arg2 && local59 == 1) {
	...
	public static Class443[] method28865() {
	...
	static String method28871(@OriginalArg(0) String arg0) {
	...
	public static Class154_Sub1 method28870() {
	...
	static final void method28869(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class624.aClass120_1.method8669(local12);
	}
}
