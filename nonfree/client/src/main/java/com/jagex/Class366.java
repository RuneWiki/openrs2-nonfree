...
public class Class366 implements Interface30 {
	...
	public boolean method27926(@OriginalArg(0) long arg0) {
		return Class305.method26796(-370456410) >= arg0 + (long) (this.anInt4582 * 516378361);
	}
	...
	public static Class100 method27937(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1) {
		...
		if (local5 == null) {
			if (Class362.aBoolean729) {
				...
				local5 = Class288.method26550(arg0.method30059(arg1, (byte) 119), 1492785929);
			}
	...
	static boolean method27938() {
		try {
			...
			@Pc(8) byte[] local8 = local3.method1704(aByteArray86, -1260067008);
			Class288.method26550(local8, -96259959);
			return true;
	...
	public boolean method27930(@OriginalArg(0) long arg0) {
		return Class305.method26796(367667206) >= arg0 + (long) (this.anInt4582 * 516378361);
	}
	...
	Class366(@OriginalArg(0) Class86 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class385 arg3) {
		...
		for (@Pc(23) int local23 = 0; local23 < this.anInterface33Array1.length; local23++) {
			this.anInterface33Array1[local23] = arg3.method28159(this.aClass86_1.anInterface32Array1[local23], -1951974654);
		}
	}
	...
	static void method27939() {
		aClass240_80.method25833((byte) -81);
	}
	...
	public static Class100 method27940(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1) {
		...
		if (local5 == null) {
			if (Class362.aBoolean729) {
				...
				local5 = Class288.method26550(arg0.method30059(arg1, (byte) 27), 1068195550);
			}
			aClass240_80.method25830(local5, (long) arg1);
		}
		return local5;
	...
	public static Class100 method27941(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1) {
		...
		if (local5 == null) {
			if (Class362.aBoolean729) {
				...
				local5 = Class288.method26550(arg0.method30059(arg1, (byte) 72), -129582697);
			}
			aClass240_80.method25830(local5, (long) arg1);
		}
		return local5;
	...
	static boolean method27942() {
		try {
			@Pc(3) Class91 local3 = new Class91();
			@Pc(8) byte[] local8 = local3.method1704(aByteArray86, 887838131);
			Class288.method26550(local8, -974850973);
			return true;
		} catch (@Pc(15) Exception local15) {
			return false;
		}
	...
	static boolean method27943() {
		try {
			@Pc(3) Class91 local3 = new Class91();
			@Pc(8) byte[] local8 = local3.method1704(aByteArray86, 1366940594);
			Class288.method26550(local8, -400960712);
			return true;
		} catch (@Pc(15) Exception local15) {
			return false;
		}
	...
	static boolean method27944() {
		try {
			@Pc(3) Class91 local3 = new Class91();
			@Pc(8) byte[] local8 = local3.method1704(aByteArray86, -1441451908);
			Class288.method26550(local8, 349835396);
			return true;
		} catch (@Pc(15) Exception local15) {
			return false;
		}
	...
	static boolean method27945() {
		try {
			@Pc(3) Class91 local3 = new Class91();
			@Pc(8) byte[] local8 = local3.method1704(aByteArray86, -714356314);
			Class288.method26550(local8, 1168319153);
			return true;
		} catch (@Pc(15) Exception local15) {
			return false;
		}
		...
		while (true) {
			try {
				...
				if (!local19.isErrorAny() && local29 >= 0 && local33 >= 0) {
					...
					local62.grabPixels();
					return Class694.aClass104_14.method20498(local50, 0, local29, local29, local33, 438797212);
				}
				throw new RuntimeException("");
	...
	static final void method27948(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1080859204);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class341.method27501(local16, local22, arg0, -757503877);
	}
	...
	static final void method27949(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) byte arg3) {
		...
		arg0.anObjectArray35 = Class499.method30148(local13, arg2, 2116949236);
		arg0.aBoolean680 = true;
	}

	@OriginalMember(owner = "client!jr", name = "baf", descriptor = "(Lclient!yf;S)V", line = 14249)
	static final void method27950(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!jr", name = "aiz", descriptor = "(Lclient!yf;I)V", line = 11295)
	static final void method27951(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(15) Class175 local15 = Class330.method27372(-1899288836);
		@Pc(21) Class93_Sub22 local21 = Class102.method2592(Class446.aClass446_31, local15.aClass24_2, (byte) 7);
		local21.aClass93_Sub41_Sub2_1.method22510(0, (byte) -6);
		@Pc(32) int local32 = local21.aClass93_Sub41_Sub2_1.anInt3070 * 212851357;
		local21.aClass93_Sub41_Sub2_1.method22510(local12, (byte) -55);
		local21.aClass93_Sub41_Sub2_1.method22454(arg0.aClass434_1.anInt4807 * 526894191, 2143091659);
		arg0.aClass434_1.aClass93_Sub1_Sub18_1.method22921(local21.aClass93_Sub41_Sub2_1, arg0.aClass434_1.anIntArray445, -1891254382);
		local21.aClass93_Sub41_Sub2_1.method22537(local21.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local32, (byte) 70);
		local15.method24351(local21, -1659915406);
	}
}
