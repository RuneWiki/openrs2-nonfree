...
public abstract class Class49 {
	...
	public static int method16611(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	Socket method16596() throws IOException {
	...
	public static long method16609() {
		try {
			@Pc(14) URL local14 = new URL(Class119.method8605("services", false) + "m=accountappeal/login.ws");
	...
	static final void method16607() {
		...
		@Pc(33) Class520 local33 = client.aClass532_1.method30509();
		@Pc(37) Class585 local37 = client.aClass532_1.method30459();
		@Pc(43) int local43 = Class72.anInt241 * -1022856553 >> 9;
		@Pc(49) int local49 = Class441.anInt4886 * -953396699 >> 9;
		@Pc(61) int local61 = Class305.method26801(Class72.anInt241 * -1022856553, Class441.anInt4886 * -953396699, Class512.anInt5209 * 1177442423);
		@Pc(63) int local63 = 0;
		@Pc(87) int local87;
		if (local43 > 3 && local49 > 3 && local43 < client.aClass532_1.method30444() - 4 && local49 < client.aClass532_1.method30474() - 4) {
			for (local87 = local43 - 4; local87 <= local43 + 4; local87++) {
				for (@Pc(96) int local96 = local49 - 4; local96 <= local49 + 4; local96++) {
					...
					if (local105 < 3 && local33.method30330(local87, local96)) {
						local105++;
					}
					@Pc(117) int local117 = 0;
					@Pc(122) byte[][] local122 = client.aClass532_1.method30452(local105);
					if (local122 != null) {
						local117 = (local122[local87][local96] & 0xFF) * 8 << 2;
					}
					if (local37.aClass99Array1 != null && local37.aClass99Array1[local105] != null) {
						@Pc(159) int local159 = local61 - (local37.aClass99Array1[local105].method2482(local87, local96) - local117);
						if (local159 > local63) {
							local63 = local159;
						}
					}
	...
	static final void method16610(@OriginalArg(0) Class681 arg0) {
	...
	static final void method16608(@OriginalArg(0) Class681 arg0) {
		arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = ((Class132_Sub1_Sub1_Sub1_Sub2) arg0.aClass132_Sub1_Sub1_Sub1_4).method20052(true);
	}
	...
	public abstract Socket method16599() throws IOException;
