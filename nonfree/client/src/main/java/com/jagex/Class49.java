...
public abstract class Class49 {
	...
	public static Class49 method16594(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
	...
	public abstract Socket method16595() throws IOException;

	@OriginalMember(owner = "client!abx", name = "m", descriptor = "(I)Ljava/net/Socket;", line = 22)
	Socket method16596(@OriginalArg(0) int arg0) throws IOException {
	...
	public abstract Socket method16597() throws IOException;
	...
	public abstract Socket method16598() throws IOException;

	@OriginalMember(owner = "client!abx", name = "n", descriptor = "(I)Ljava/net/Socket;")
	public abstract Socket method16599(@OriginalArg(0) int arg0) throws IOException;

	@OriginalMember(owner = "client!abx", name = "u", descriptor = "(Ljava/lang/String;I)Lclient!abx;", line = 13)
	public static Class49 method16600(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class49_Sub1 local3 = new Class49_Sub1();
		local3.aString58 = arg0;
		local3.anInt2384 = arg1 * -381473519;
		return local3;
	...
	public static Class49 method16601(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class49_Sub1 local3 = new Class49_Sub1();
		local3.aString58 = arg0;
		local3.anInt2384 = arg1 * -381473519;
		return local3;
	...
	public abstract Socket method16602() throws IOException;

	@OriginalMember(owner = "client!abx", name = "d", descriptor = "(Ljava/lang/String;I)Lclient!abx;", line = 13)
	public static Class49 method16603(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class49_Sub1 local3 = new Class49_Sub1();
		local3.aString58 = arg0;
		local3.anInt2384 = arg1 * -381473519;
		return local3;
	...
	static final void method16607(@OriginalArg(0) byte arg0) {
		...
		@Pc(33) Class520 local33 = client.aClass532_1.method30509(494969536);
		@Pc(37) Class585 local37 = client.aClass532_1.method30459(-1038565011);
		@Pc(43) int local43 = Class72.anInt241 * -1022856553 >> 9;
		@Pc(49) int local49 = Class441.anInt4886 * -953396699 >> 9;
		@Pc(61) int local61 = Class305.method26801(Class72.anInt241 * -1022856553, Class441.anInt4886 * -953396699, Class512.anInt5209 * 1177442423, (byte) -91);
		@Pc(63) int local63 = 0;
		@Pc(87) int local87;
		if (local43 > 3 && local49 > 3 && local43 < client.aClass532_1.method30444(-247853602) - 4 && local49 < client.aClass532_1.method30474((short) 128) - 4) {
			for (local87 = local43 - 4; local87 <= local43 + 4; local87++) {
				for (@Pc(96) int local96 = local49 - 4; local96 <= local49 + 4; local96++) {
					...
					@Pc(122) byte[][] local122 = client.aClass532_1.method30452(local105, 796728889);
					if (local122 != null) {
	...
	static final void method16608(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = ((Class132_Sub1_Sub1_Sub1_Sub2) arg0.aClass132_Sub1_Sub1_Sub1_4).method20052(true, (byte) 91);
	}

	@OriginalMember(owner = "client!abx", name = "e", descriptor = "(I)J", line = 37)
	public static long method16609(@OriginalArg(0) int arg0) {
		try {
			...
			do {
				...
				if (local65 == -1) {
					local50.anInt3070 = 0;
					return local50.method22423(-2118205838);
				}
	...
	static final void method16610(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	public static int method16611(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
