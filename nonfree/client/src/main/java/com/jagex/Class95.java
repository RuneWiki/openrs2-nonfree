...
public class Class95 {
	...
	public static void method1800(@OriginalArg(0) int arg0) {
		if (client.anInt3435 * -849002901 == 0) {
			...
			client.aClass175_1.method24351(local10, -1573030867);
	...
	public static void method1801(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) Class104 arg2, @OriginalArg(3) Class106 arg3, @OriginalArg(4) Class5 arg4, @OriginalArg(5) byte arg5) {
		...
		if (Class93_Sub1_Sub1.aBoolean42 && local8) {
			...
			@Pc(23) Class106 local23 = arg2.method20506(local17, Class171.aClass105_Sub2_1, true);
			local30 = local17.method55(arg0, 250, (Interface2[]) null, -1910907678);
			local41 = local17.method49(arg0, 250, local17.anInt7 * -2059082111, (Interface2[]) null, (byte) 0);
			...
			local90 = Class171.aClass390_8.method28273(local30, client.anInt3511 * 2040043391, 15040190) + Class171.anInt3055 * 1543350707;
			@Pc(102) int local102 = Class171.aClass392_8.method28290(local41, client.anInt3512 * -817449061, (short) 255) + Class355.anInt4219 * -246562615;
			arg2.method20499(Class531.aClass105_3, false).method18179(local90 + Class171.aClass105_2.method7206(), local102 + Class171.aClass105_2.method7198(), local30 - Class171.aClass105_2.method7206() * 2, local41 - Class171.aClass105_2.method7198() * 2, 1, -1, 0);
			arg2.method20499(Class171.aClass105_2, true).method18169(local90, local102);
			Class171.aClass105_2.method7168();
			arg2.method20499(Class171.aClass105_2, true).method18169(local90 + local30 - local44, local102);
			Class171.aClass105_2.method7169();
			arg2.method20499(Class171.aClass105_2, true).method18169(local90 + local30 - local44, local41 + local102 - local44);
			Class171.aClass105_2.method7168();
			arg2.method20499(Class171.aClass105_2, true).method18169(local90, local102 + local41 - local44);
			Class171.aClass105_2.method7169();
			arg2.method20499(Class171.aClass105_1, true).method18178(local90, local102 + Class171.aClass105_2.method7198(), local44, local41 - Class171.aClass105_2.method7198() * 2);
			Class171.aClass105_1.method7155();
			arg2.method20499(Class171.aClass105_1, true).method18178(local90 + Class171.aClass105_2.method7206(), local102, local30 - Class171.aClass105_2.method7206() * 2, local44);
			Class171.aClass105_1.method7155();
			arg2.method20499(Class171.aClass105_1, true).method18178(local30 + local90 - local44, local102 + Class171.aClass105_2.method7198(), local44, local41 - Class171.aClass105_2.method7198() * 2);
			Class171.aClass105_1.method7155();
			arg2.method20499(Class171.aClass105_1, true).method18178(local90 + Class171.aClass105_2.method7206(), local41 + local102 - local44, local30 - Class171.aClass105_2.method7206() * 2, local44);
			Class171.aClass105_1.method7155();
			local23.method7563(arg0, local48 + local90, local102 + local48, local30 - local48 * 2, local41 - local48 * 2, anInt320 * 2016248431 | 0xFF000000, -1, 1, 1, 0, (Class100[]) null, (int[]) null, (Class96) null, 0, 0, (short) 657);
			Class269.method26273(local90, local102, local30, local41, (byte) -40);
		} else {
			local30 = arg4.method55(arg0, 250, (Interface2[]) null, -1910907678);
			local41 = arg4.method42(arg0, 250, (Interface2[]) null, -143202029) * 13;
			...
			arg3.method7563(arg0, local48, local90, local30, local41, -1, -1, 1, 1, 0, (Class100[]) null, (int[]) null, (Class96) null, 0, 0, (short) 657);
			Class269.method26273(local48 - local326, local90 - local326, local30 + local326 + local326, local326 + local326 + local41, (byte) -63);
		}
		if (!arg1) {
			return;
		}
	...
	static final void method1802(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		if (local35 == local41.anInt265 * 951920133) {
			local11.method26862(local25, 2087973884);
		} else {
			local11.method26860(local25, local35, 1662412852);
		}
	}
	...
	static final void method1803(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class342.method27510(local13, local26 == 1, (short) 31342);
	}
}
