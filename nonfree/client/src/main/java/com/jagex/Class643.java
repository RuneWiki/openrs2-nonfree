...
public class Class643 implements Interface70 {
	...
	public Class539 method32540(@OriginalArg(0) byte arg0) {
		...
		local5.method30787(this, 2085956518);
		return local5;
	}
	...
	public byte[] method32529(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		return this.aClass497_139.method30059(local1, (byte) 48);
	}
	...
	public Class539 method32542() {
		@Pc(5) Class539 local5 = new Class539(this.aClass146_5);
		local5.method30787(this, 1340705134);
		return local5;
	}
	...
	public Class539 method32544() {
		@Pc(5) Class539 local5 = new Class539(this.aClass146_5);
		local5.method30787(this, 1362272487);
		return local5;
	}
	...
	public Class539 method32545() {
		@Pc(5) Class539 local5 = new Class539(this.aClass146_5);
		local5.method30787(this, 1846192886);
		return local5;
	}
	...
	public byte[] method32546(@OriginalArg(0) int arg0) {
		...
		return this.aClass497_139.method30059(local1, (byte) 47);
	}
	...
	public Class539 method32543() {
		@Pc(5) Class539 local5 = new Class539(this.aClass146_5);
		local5.method30787(this, 2010119771);
		return local5;
	}
	...
	static final void method32582(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	public static void method32583(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Class610 arg4, @OriginalArg(5) Class132_Sub1_Sub1_Sub1_Sub1 arg5, @OriginalArg(6) Class132_Sub1_Sub1_Sub1_Sub2 arg6, @OriginalArg(7) int arg7) {
		...
		if (arg4 != null) {
			...
			Class274.aClass258_1.method26043(local3.anIntArray175, (byte) -64);
		} else if (arg5 != null) {
			local3.aClass132_Sub1_Sub1_Sub1_Sub1_1 = arg5;
			@Pc(191) Class336 local191 = arg5.aClass336_1;
			if (local191.anIntArray412 != null) {
				local3.aBoolean336 = true;
				local191 = local191.method27423(Class624.aClass120_1, Class624.aClass120_1, (short) 1984);
			}
			if (local191 != null) {
				...
				local3.anInt1522 = Class566.method31258(arg5, 586339351) * -1340593683;
			...
			local3.anInt1508 = (arg1 + arg6.method19997(1832763) << 9) * 440138643;
			local3.anInt1509 = (arg2 + arg6.method19997(1118149743) << 9) * -465070531;
