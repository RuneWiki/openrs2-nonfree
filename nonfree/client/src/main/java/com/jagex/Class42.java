...
public class Class42 {
	...
	static void method841(@OriginalArg(0) Class230 arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) float[] arg2, @OriginalArg(3) byte arg3) {
		...
		if ((double) local38 > 1.0D || local43 < -1.0F) {
			Class342.method27509(local38, local43, (byte) -75);
		}
		if (local38 != local61) {
		...
		Class670.method32956(0.0F, local38, local43, 1.0F, arg0.aFloatArray99, 752351645);
		Class670.method32956(arg2[0], arg2[1], arg2[2], arg2[3], arg0.aFloatArray97, 7399556);
	}
}
