...
public class Class42 {
	...
	public Class42(@OriginalArg(0) Class38 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
		...
		this.aLong6 = (this.aLong4 = arg0.method735() * -451821661113593867L) * -1558313948680994995L;
	...
	public void method830() throws IOException {
		this.method818();
		this.aClass38_1.method732();
	}
	...
	public void method819(@OriginalArg(0) byte[] arg0) throws IOException {
		this.method823(arg0, 0, arg0.length);
	}

	@OriginalMember(owner = "client!abp", name = "k", descriptor = "([BI)V", line = 42)
	public void method822(@OriginalArg(0) byte[] arg0) throws IOException {
		this.method823(arg0, 0, arg0.length);
	}

	@OriginalMember(owner = "client!abp", name = "f", descriptor = "([BIII)V", line = 47)
	public void method823(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
		try {
			...
			if (arg2 > this.aByteArray12.length) {
				...
				while (arg2 > 0) {
					local129 = this.aClass38_1.method726(arg0, arg1, arg2);
					if (local129 == -1) {
						break;
					}
	...
	void method833() throws IOException {
		...
		while (this.anInt131 * 1716434415 < this.aByteArray12.length) {
			...
			@Pc(65) int local65 = this.aClass38_1.method726(this.aByteArray12, this.anInt131 * 1716434415, local48);
			if (local65 == -1) {
				break;
			}
	...
	void method836() throws IOException {
		this.anInt131 = 0;
		if (this.aLong8 * -132147995563560847L != this.aLong9 * -9152026569603950939L) {
			this.aClass38_1.method723(this.aLong8 * -132147995563560847L);
			this.aLong9 = this.aLong8 * -297616410474490659L;
	...
	public void method824(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
		try {
			...
			if (arg2 > this.aByteArray13.length) {
				...
				this.aClass38_1.method722(arg0, arg1, arg2);
	...
	void method818() throws IOException {
		if (this.aLong7 * 5576541888797144539L == -1L) {
			return;
		}
		...
		this.aClass38_1.method722(this.aByteArray13, 0, this.anInt132 * -966644267);
	...
	static void method841(@OriginalArg(0) Class230 arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) float[] arg2) {
		if (arg0 == null) {
			return;
		}
