...
public class Class93_Sub34 extends Class93 {
	...
	Class93_Sub34(@OriginalArg(0) Class104_Sub2 arg0, @OriginalArg(1) Class99_Sub3 arg1, @OriginalArg(2) Class93_Sub16 arg2, @OriginalArg(3) int[] arg3) {
		...
		@Pc(31) int local31 = this.aClass93_Sub16_2.method13523() - (arg1.anInt412 * -1678286317 >> 1);
		this.anInt1626 = this.aClass93_Sub16_2.method13520() - local31 >> arg1.anInt415 * -373302705;
		this.anInt1625 = this.aClass93_Sub16_2.method13520() + local31 >> arg1.anInt415 * -373302705;
		this.anInt1629 = this.aClass93_Sub16_2.method13522() - local31 >> arg1.anInt415 * -373302705;
		this.anInt1624 = this.aClass93_Sub16_2.method13522() + local31 >> arg1.anInt415 * -373302705;
			...
			if (local136 > 0 && local136 < this.aClass99_Sub3_2.anInt413 * -143202029 - 1) {
				for (local149 = 0; local149 <= local91; local149++) {
					...
					if (local157 > 0 && local157 < this.aClass99_Sub3_2.anInt414 * -1667858293 - 1) {
						local184 = arg1.method2482(local157 + 1, local136) - arg1.method2482(local157 - 1, local136);
						local200 = arg1.method2482(local157, local136 + 1) - arg1.method2482(local157, local136 - 1);
		...
		if (this.anInt1628 > 0) {
			this.aClass16_12 = new Class16(Class134_Sub2.method10212(this.anInt1628));
	...
	void method13952() {
		this.anInterface40_2 = this.aClass104_Sub2_27.method20995(false);
		this.anInterface40_2.method29351(this.anInt1623);
		this.anInterface37_11 = this.aClass104_Sub2_27.method21013(false);
	...
	void method13953(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		@Pc(28) int local28 = this.aClass99_Sub3_2.method2480(local11, local21);
		...
		local261 = this.aClass93_Sub16_2.method13520() - local11;
		local271 = this.aClass93_Sub16_2.method13521() - local28;
		local278 = this.aClass93_Sub16_2.method13522() - local21;
		local285 = (float) Math.sqrt((double) (local261 * local261 + local271 * local271 + local278 * local278));
		local292 = 1.0F / local285;
		local261 *= local292;
		local271 *= local292;
		local278 *= local292;
		local301 = local285 / (float) this.aClass93_Sub16_2.method13523();
		...
		@Pc(549) int local549 = this.aClass93_Sub16_2.method13539();
	...
	void method13954(@OriginalArg(0) Class131 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean[][] arg4, @OriginalArg(5) boolean arg5) {
		...
		while (true) {
			if (local110 > this.anInt1624) {
				...
				@Pc(212) Interface40 local212 = this.aClass104_Sub2_27.method20916(local110 / 2);
	...
	void method13956(@OriginalArg(0) Class131 arg0, @OriginalArg(1) Interface40 arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(25) float local25 = this.aClass93_Sub16_2.method13525();
		arg0.aClass472_38.method29537(local25, local25, local25);
		this.aClass104_Sub2_27.method21048(0, this.anInterface37_11);
		this.aClass104_Sub2_27.method21106(this.aClass104_Sub2_27.aClass145_22);
		this.aClass104_Sub2_27.method21030(this.anInterface40_2);
		arg0.method10103(0);
	}

	@OriginalMember(owner = "client!akx", name = "d", descriptor = "(Lclient!jj;Lclient!ml;I)V", line = 315)
	void method13962(@OriginalArg(0) Class131 arg0, @OriginalArg(1) Interface40 arg1) {
		arg0.anInt1140 = 0;
		arg0.anInt1141 = this.anInt1627;
		arg0.anInt1138 = 0;
		arg0.anInt1137 = this.anInt1623 / 3;
	...
	void method13963(@OriginalArg(0) Class131 arg0, @OriginalArg(1) Interface40 arg1) {
		arg0.anInt1140 = 0;
		arg0.anInt1141 = this.anInt1627;
		arg0.anInt1138 = 0;
		arg0.anInt1137 = this.anInt1623 / 3;
