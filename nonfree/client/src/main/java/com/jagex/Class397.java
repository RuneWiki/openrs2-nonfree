...
public class Class397 {
	...
	static final void method28463(@OriginalArg(0) byte[] arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
	...
	boolean method28464(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if (local29 > 0 && local26 > 0) {
			...
			return method28471(this.aByteArray90, local23, local29, local26, local34, local123);
		} else {
			return false;
		}
	}
	...
	void method28465(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(2) Class93_Sub1_Sub4_Sub1 local2 = (Class93_Sub1_Sub4_Sub1) arg0;
		arg1 += local2.anInt3206 + 1;
		arg2 += local2.anInt3204 + 1;
		@Pc(23) int local23 = arg1 + arg2 * this.anInt4669;
		...
		if (local31 > 0 && local28 > 0) {
			method28469(this.aByteArray90, local2.aByteArray61, local25, local23, local31, local28, local36, local38);
			this.method28468(arg1, arg2, local31, local28);
		}
	}

	@OriginalMember(owner = "client!lg", name = "q", descriptor = "(IIII)V", line = 245)
	void method28466(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	boolean method28467(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(2) Class93_Sub1_Sub4_Sub1 local2 = (Class93_Sub1_Sub4_Sub1) arg0;
		arg1 += local2.anInt3206 + 1;
		arg2 += local2.anInt3204 + 1;
		@Pc(23) int local23 = arg1 + arg2 * this.anInt4669;
	...
	void method28468(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (this.aClass410ArrayArray1 == null) {
			return;
		}
		@Pc(9) int local9 = arg0 - 1 >> 7;
	...
	static final void method28469(@OriginalArg(0) byte[] arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		@Pc(4) int local4 = -(arg4 >> 2);
		@Pc(9) int local9 = -(arg4 & 0x3);
		for (@Pc(12) int local12 = -arg5; local12 < 0; local12++) {
			@Pc(16) int local16;
	...
	static final void method28470(@OriginalArg(0) byte[] arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		@Pc(4) int local4 = -(arg4 >> 2);
		@Pc(9) int local9 = -(arg4 & 0x3);
		for (@Pc(12) int local12 = -arg5; local12 < 0; local12++) {
			@Pc(16) int local16;
	...
	static final boolean method28471(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
	...
	void method28472(@OriginalArg(0) Class131 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean[][] arg4, @OriginalArg(5) boolean arg5) {
		this.aClass104_Sub2_35.method20518(false);
		...
		if (arg5) {
							...
							if (local60 - arg1 >= -arg3 && local60 - arg1 <= arg3) {
								for (local76 = local25; local76 < local32; local76++) {
									if (local76 - arg2 >= -arg3 && local76 - arg2 <= arg3 && arg4[local60 - arg1 + arg3][local76 - arg2 + arg3]) {
										arg0.aClass489_46.method29845(local12, local12, 1.0F, 1.0F);
										arg0.aClass489_46.aFloatArray116[12] = (float) -local34;
										arg0.aClass489_46.aFloatArray116[13] = (float) -local16;
										this.aClass410ArrayArray1[local34][local16].method28592(arg0);
										continue label144;
									}
								}
							}
			...
			if (local156.position() != 0) {
				...
				@Pc(314) Interface40 local314 = this.aClass104_Sub2_35.method20916(local34 / 2);
				...
				for (local60 = 0; local60 < this.anInt4670; local60++) {
					for (local76 = 0; local76 < this.anInt4668; local76++) {
						if (local152[local32] != 0) {
							arg0.aClass489_46.method29845(local12, local12, 1.0F, 1.0F);
							arg0.aClass489_46.aFloatArray116[12] = (float) -local76;
							arg0.aClass489_46.aFloatArray116[13] = (float) -local60;
							this.aClass410ArrayArray1[local76][local60].method28591(arg0, local314, local58, local152[local32] / 3);
		...
		this.aClass104_Sub2_35.method20518(true);
	}

	@OriginalMember(owner = "client!lg", name = "d", descriptor = "(Lclient!ara;II)V", line = 127)
	void method28473(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(2) Class93_Sub1_Sub4_Sub1 local2 = (Class93_Sub1_Sub4_Sub1) arg0;
		arg1 += local2.anInt3206 + 1;
		arg2 += local2.anInt3204 + 1;
		@Pc(23) int local23 = arg1 + arg2 * this.anInt4669;
	...
	void method28474(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(2) Class93_Sub1_Sub4_Sub1 local2 = (Class93_Sub1_Sub4_Sub1) arg0;
		arg1 += local2.anInt3206 + 1;
		arg2 += local2.anInt3204 + 1;
		@Pc(23) int local23 = arg1 + arg2 * this.anInt4669;
		...
		if (local31 > 0 && local28 > 0) {
			method28470(this.aByteArray90, local2.aByteArray61, local25, local23, local31, local28, local36, local38);
			this.method28468(arg1, arg2, local31, local28);
		}
	}

	@OriginalMember(owner = "client!lg", name = "r", descriptor = "(Lclient!ara;II)Z", line = 209)
	boolean method28475(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(2) Class93_Sub1_Sub4_Sub1 local2 = (Class93_Sub1_Sub4_Sub1) arg0;
		arg1 += local2.anInt3206 + 1;
		arg2 += local2.anInt3204 + 1;
		@Pc(23) int local23 = arg1 + arg2 * this.anInt4669;
	...
	boolean method28477(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(2) Class93_Sub1_Sub4_Sub1 local2 = (Class93_Sub1_Sub4_Sub1) arg0;
		arg1 += local2.anInt3206 + 1;
		arg2 += local2.anInt3204 + 1;
		@Pc(23) int local23 = arg1 + arg2 * this.anInt4669;
	...
	void method28478(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(2) Class93_Sub1_Sub4_Sub1 local2 = (Class93_Sub1_Sub4_Sub1) arg0;
		arg1 += local2.anInt3206 + 1;
		arg2 += local2.anInt3204 + 1;
		@Pc(23) int local23 = arg1 + arg2 * this.anInt4669;
	...
	void method28480(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (this.aClass410ArrayArray1 == null) {
			return;
		}
		@Pc(9) int local9 = arg0 - 1 >> 7;
	...
	void method28481(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (this.aClass410ArrayArray1 == null) {
			return;
		}
		@Pc(9) int local9 = arg0 - 1 >> 7;
	...
	boolean method28484(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(2) Class93_Sub1_Sub4_Sub1 local2 = (Class93_Sub1_Sub4_Sub1) arg0;
		arg1 += local2.anInt3206 + 1;
		arg2 += local2.anInt3204 + 1;
		@Pc(23) int local23 = arg1 + arg2 * this.anInt4669;
	...
	static final void method28486(@OriginalArg(0) byte[] arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		@Pc(4) int local4 = -(arg4 >> 2);
		@Pc(9) int local9 = -(arg4 & 0x3);
		for (@Pc(12) int local12 = -arg5; local12 < 0; local12++) {
			@Pc(16) int local16;
