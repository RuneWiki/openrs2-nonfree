...
public final class Class112_Sub2_Sub2_Sub1 extends Class112_Sub2_Sub2 {
	...
	@Override
	void method23699(@OriginalArg(0) int arg0) {
		super.method23699(1847457931);
		...
		@Pc(33) WritableRaster local33 = Raster.createWritableRaster(local19.createCompatibleSampleModel(this.anInt3228 * -2002865393, this.anInt3229 * 1581711909), local11, (Point) null);
	...
	public int method23755() {
		return this.method23754(0, 0);
	}

	@OriginalMember(owner = "client!ats", name = "g", descriptor = "(II)I", line = 35)
	@Override
	public final int method23754(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	@Override
	public final int method23760(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Graphics local3 = this.aCanvas5.getGraphics();
		if (local3 == null) {
			return 0;
		} else {
