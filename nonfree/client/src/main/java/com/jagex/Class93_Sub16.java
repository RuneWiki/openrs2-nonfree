...
public class Class93_Sub16 extends Class93 {
	...
	public final int method13522(@OriginalArg(0) int arg0) {
		return (int) this.aClass472_47.aFloat319;
	}

	@OriginalMember(owner = "client!akf", name = "k", descriptor = "(B)I", line = 52)
	public final int method13523(@OriginalArg(0) byte arg0) {
	...
	public void method13524(@OriginalArg(0) float arg0, @OriginalArg(1) int arg1) {
		...
		this.aLong73 = Class305.method26796(84671911) * -2834922336505842927L;
	}

	@OriginalMember(owner = "client!akf", name = "w", descriptor = "(I)F", line = 60)
	public final float method13525(@OriginalArg(0) int arg0) {
	...
	public void method13535(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		this.aLong74 = Class305.method26796(-299710577) * 3795665274651405733L;
	}
	...
	public void method13536(@OriginalArg(0) float arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		...
		this.anInt1534 = arg1 * -1061885795;
		this.aLong73 = Class305.method26796(1910097402) * -2834922336505842927L;
	}
	...
	public void method13537(@OriginalArg(0) int arg0) {
		...
		if (this.anInt1531 * 589853359 != this.anInt1533 * 858109453) {
			local11 = Class305.method26796(1896359579);
			...
			if (this.anInt1532 * 1570863755 > 0) {
				this.anInt1531 = Class125_Sub2_Sub1.method21469(this.anInt1535 * -410282901, this.anInt1533 * 858109453, (float) (this.anInt1536 * 2059530399 - this.anInt1532 * 1570863755) / (float) (this.anInt1536 * 2059530399) * 255.0F, 1306653889) * -1730403249;
			} else {
		...
		local11 = Class305.method26796(2143273690);
	...
	public final int method13539(@OriginalArg(0) byte arg0) {
		return this.anInt1531 * 589853359;
	}
	...
	Class93_Sub16(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5) {
		this.aClass472_47.method29537((float) arg0, (float) arg1, (float) arg2);
	...
	public void method13540(@OriginalArg(0) float arg0, @OriginalArg(1) int arg1) {
		...
		this.anInt1534 = arg1 * -1061885795;
		this.aLong73 = Class305.method26796(1716503372) * -2834922336505842927L;
	}

	@OriginalMember(owner = "client!akf", name = "ae", descriptor = "()I", line = 52)
	public final int method13541() {
		return this.anInt1529 * 1892312103;
	}

	@OriginalMember(owner = "client!akf", name = "ag", descriptor = "()I", line = 52)
	public final int method13542() {
		return this.anInt1529 * 1892312103;
	}
	...
	public final float method13546() {
		return this.aFloat144;
	}
	...
	public final float method13548() {
		return this.aFloat144;
	}

	@OriginalMember(owner = "client!akf", name = "at", descriptor = "()F", line = 64)
	public final float method13549() {
	...
	public void method13552() {
		...
		@Pc(18) long local18;
		if (this.anInt1531 * 589853359 != this.anInt1533 * 858109453) {
			local11 = Class305.method26796(1969153874);
			local18 = local11 - this.aLong74 * -2452759870572383699L;
			this.anInt1532 = (int) ((long) this.anInt1532 - local18 * -1443914461L);
			if (this.anInt1532 * 1570863755 > 0) {
				this.anInt1531 = Class125_Sub2_Sub1.method21469(this.anInt1535 * -410282901, this.anInt1533 * 858109453, (float) (this.anInt1536 * 2059530399 - this.anInt1532 * 1570863755) / (float) (this.anInt1536 * 2059530399) * 255.0F, 2106143898) * -1730403249;
			} else {
				this.anInt1531 = this.anInt1533 * 1097400835;
			}
			this.aLong74 = local11 * 3795665274651405733L;
		...
		local11 = Class305.method26796(1196618071);
		local18 = local11 - this.aLong73 * 3335590366832729585L;
		this.anInt1534 = (int) ((long) this.anInt1534 - local18 * -1061885795L);
		if (this.anInt1534 * 1239997877 > 0) {
			this.aFloat146 = (float) (this.anInt1528 * 306188305 - this.anInt1534 * 1239997877) / (float) (this.anInt1528 * 306188305) * (this.aFloat147 - this.aFloat145) + this.aFloat145;
	...
	public final float method13565() {
		return this.aFloat144;
	}
	...
	public void method13566(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		this.anInt1532 = arg1 * -1443914461;
		this.aLong74 = Class305.method26796(1147255061) * 3795665274651405733L;
	}

	@OriginalMember(owner = "client!akf", name = "l", descriptor = "(B)F", line = 64)
	public final float method13567(@OriginalArg(0) byte arg0) {
		return this.aFloat146;
	}
	...
	public void method13568() {
		...
		@Pc(18) long local18;
		if (this.anInt1531 * 589853359 != this.anInt1533 * 858109453) {
			local11 = Class305.method26796(1391861962);
			local18 = local11 - this.aLong74 * -2452759870572383699L;
			this.anInt1532 = (int) ((long) this.anInt1532 - local18 * -1443914461L);
			if (this.anInt1532 * 1570863755 > 0) {
				this.anInt1531 = Class125_Sub2_Sub1.method21469(this.anInt1535 * -410282901, this.anInt1533 * 858109453, (float) (this.anInt1536 * 2059530399 - this.anInt1532 * 1570863755) / (float) (this.anInt1536 * 2059530399) * 255.0F, 1530366803) * -1730403249;
			} else {
				this.anInt1531 = this.anInt1533 * 1097400835;
			}
			this.aLong74 = local11 * 3795665274651405733L;
		...
		local11 = Class305.method26796(1182573497);
		local18 = local11 - this.aLong73 * 3335590366832729585L;
		this.anInt1534 = (int) ((long) this.anInt1534 - local18 * -1061885795L);
		if (this.anInt1534 * 1239997877 > 0) {
			this.aFloat146 = (float) (this.anInt1528 * 306188305 - this.anInt1534 * 1239997877) / (float) (this.anInt1528 * 306188305) * (this.aFloat147 - this.aFloat145) + this.aFloat145;
	...
	public void method13570(@OriginalArg(0) float arg0, @OriginalArg(1) int arg1) {
		...
		this.anInt1534 = arg1 * -1061885795;
		this.aLong73 = Class305.method26796(1664315226) * -2834922336505842927L;
	}
	...
	public static Interface75 method13572(@OriginalArg(0) Class arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		...
		synchronized (Class711.aMap27) {
			...
			if (local8 == null) {
				local8 = new HashMap();
				@Pc(19) Interface75[] local19 = (Interface75[]) (Interface75[]) arg0.getEnumConstants();
	...
	static void method13573(@OriginalArg(0) int arg0) {
		if (Class114.aClass104_8 != null) {
			Class114.aClass104_8.method20877(-1071210768);
