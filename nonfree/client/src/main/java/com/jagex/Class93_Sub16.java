...
public class Class93_Sub16 extends Class93 {
	...
	public static Interface75 method13572(@OriginalArg(0) Class arg0, @OriginalArg(1) int arg1) {
	...
	static void method13573() {
		if (Class114.aClass104_8 != null) {
			Class114.aClass104_8.method20877();
	...
	public final float method13525() {
	...
	public final float method13567() {
		return this.aFloat146;
	}

	@OriginalMember(owner = "client!akf", name = "u", descriptor = "(FB)V", line = 68)
	public void method13527(@OriginalArg(0) float arg0) {
		this.aFloat144 = arg0;
	}
	...
	public void method13543(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.aClass472_47.method29537((float) arg0, (float) arg1, (float) arg2);
	}
	...
	public void method13533(@OriginalArg(0) int arg0) {
	...
	public void method13551(@OriginalArg(0) float arg0) {
		this.aFloat146 = arg0;
	}
	...
	public void method13535(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		this.aLong74 = Class305.method26796() * 3795665274651405733L;
	}
	...
	public void method13524(@OriginalArg(0) float arg0, @OriginalArg(1) int arg1) {
		...
		this.aLong73 = Class305.method26796() * -2834922336505842927L;
	}

	@OriginalMember(owner = "client!akf", name = "h", descriptor = "(FIB)V", line = 109)
	public void method13536(@OriginalArg(0) float arg0, @OriginalArg(1) int arg1) {
		this.aFloat147 = arg0;
		this.aFloat145 = this.aFloat146;
		this.anInt1528 = arg1 * -343744271;
		if (this.aFloat147 < 0.0F) {
	...
	public void method13537() {
		...
		if (this.anInt1531 * 589853359 != this.anInt1533 * 858109453) {
			...
			if (this.anInt1532 * 1570863755 > 0) {
				this.anInt1531 = Class125_Sub2_Sub1.method21469(this.anInt1535 * -410282901, this.anInt1533 * 858109453, (float) (this.anInt1536 * 2059530399 - this.anInt1532 * 1570863755) / (float) (this.anInt1536 * 2059530399) * 255.0F) * -1730403249;
			} else {
