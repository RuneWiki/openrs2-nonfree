...
public class Class723 {
	...
	public static synchronized byte[] method36934(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return method36935(arg0, false, 592143678);
	}
	...
	public static synchronized byte[] method36935(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2) {
		@Pc(21) byte[] local21;
	...
	public static void method36936(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1) {
		if (arg0 == null || arg1 == null) {
			Class588.anIntArray475 = null;
			anIntArray528 = null;
			aByteArrayArrayArray14 = (byte[][][]) null;
			return;
		}
	...
	public static void method36937(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1) {
		if (arg0 == null || arg1 == null) {
			Class588.anIntArray475 = null;
			anIntArray528 = null;
			aByteArrayArrayArray14 = (byte[][][]) null;
	...
	public static synchronized void method36938(@OriginalArg(0) byte[] arg0, @OriginalArg(1) byte arg1) {
	...
	public static synchronized byte[] method36939(@OriginalArg(0) int arg0) {
		return method36935(arg0, false, -1995390377);
	}

	@OriginalMember(owner = "client!zz", name = "u", descriptor = "(I)[B", line = 72)
	public static synchronized byte[] method36940(@OriginalArg(0) int arg0) {
		return method36935(arg0, false, -774839264);
	}
	...
	static final void method36942(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static void method36943(@OriginalArg(0) int arg0) {
		@Pc(3) Class93_Sub1_Sub11 local3 = Class371.method28006(14, 0L);
		local3.method21865(2144073280);
	}
}
