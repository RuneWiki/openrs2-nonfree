...
public class Class110_Sub4 extends Class110 {
	...
	Class110_Sub4(@OriginalArg(0) Class93_Sub41 arg0) {
		super(arg0);
		this.anInt862 = arg0.method22415(-1434290800) * -719734379;
		this.anInt860 = arg0.method22415(-1434290800) * -685673635;
		this.anInt861 = arg0.method22415(-1434290800) * -772206359;
		this.anInt859 = arg0.method22415(-1434290800) * 363761603;
		this.anInt863 = arg0.method22415(-1434290800) * -207321745;
	}
	...
	static void method7301(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class312 arg2, @OriginalArg(3) byte arg3) {
		...
		local10 += 15;
		@Pc(96) long local96 = client.aClass175_2.aClass238_1.method25781((byte) 44);
		@Pc(98) String local98 = "N/A";
		if (local96 != -1L) {
			local98 = local96 + "ms";
			if (local96 > 500L) {
				local98 = Class306.method26823(16711680, 2016878805) + local98 + Class306.method26823(16776960, 298459686);
			}
		}
		...
		local10 += 15;
		@Pc(169) long local169 = client.aClass175_1.aClass238_1.method25781((byte) 72);
		@Pc(171) String local171 = "N/A";
		if (local169 != -1L) {
			local171 = local169 + "ms";
			if (local169 > 500L) {
				local171 = Class306.method26823(16711680, 1779407828) + local171 + Class306.method26823(16776960, 1607586527);
			}
		}
		...
		@Pc(360) String local360 = "Cache:" + Class218.method25508(local340, 2, true, Class717.aClass717_15, -433742498) + "% (" + local328 + "%)";
