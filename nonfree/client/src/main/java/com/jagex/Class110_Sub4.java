...
public class Class110_Sub4 extends Class110 {
	...
	Class110_Sub4(@OriginalArg(0) Class93_Sub41 arg0) {
		super(arg0);
		this.anInt862 = arg0.method22415() * -719734379;
		this.anInt860 = arg0.method22415() * -685673635;
		this.anInt861 = arg0.method22415() * -772206359;
		this.anInt859 = arg0.method22415() * 363761603;
		this.anInt863 = arg0.method22415() * -207321745;
	}

	@OriginalMember(owner = "client!aft", name = "n", descriptor = "(I)V", line = 23)
	@Override
	public void method20138() {
		Class104_Sub3.method5765(this.anInt862 * 958187965, this.anInt861 * -1213937831, this.anInt860 * 1560115445, 100, 100, false);
		Class123.method9086(this.anInt859 * 1423792363, this.anInt863 * -394757745, 0);
	...
	public static void method7302(@OriginalArg(0) Class645 arg0) {
	...
	static void method7301(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class312 arg2) {
		...
		Class82.aClass106_1.method7525("Fps:" + client.anInt3407 * 1249273355 + " (" + client.anInt3417 * -2066467757 + " ms)", local6, local10, local14, -1);
		local10 += 15;
		...
		Class82.aClass106_1.method7525("Mem:" + local61 + "/" + local54 + "k", local6, local10, local63, -1);
		local10 += 15;
		@Pc(96) long local96 = client.aClass175_2.aClass238_1.method25781();
		@Pc(98) String local98 = "N/A";
		if (local96 != -1L) {
			local98 = local96 + "ms";
			if (local96 > 500L) {
				local98 = Class306.method26823(16711680) + local98 + Class306.method26823(16776960);
			}
		}
		Class82.aClass106_1.method7525("Game: In:" + client.aClass175_2.anInt3305 * -495442903 + "B/s " + "Out:" + client.aClass175_2.anInt3302 * 4621161 + "B/s " + "Ping:" + local98, local6, local10, -256, -1);
		local10 += 15;
		@Pc(169) long local169 = client.aClass175_1.aClass238_1.method25781();
		@Pc(171) String local171 = "N/A";
		if (local169 != -1L) {
			local171 = local169 + "ms";
			if (local169 > 500L) {
				local171 = Class306.method26823(16711680) + local171 + Class306.method26823(16776960);
			}
		}
		Class82.aClass106_1.method7525("Lobby: In:" + client.aClass175_1.anInt3305 * -495442903 + "B/s " + "Out:" + client.aClass175_1.anInt3302 * 4621161 + "B/s " + "Ping:" + local171, local6, local10, -256, -1);
		local10 += 15;
		@Pc(242) int local242 = Class694.aClass104_14.method20819() / 1024;
		Class82.aClass106_1.method7525("Offheap:" + local242 + "k", local6, local10, local242 > 65536 ? -65536 : -256, -1);
		local10 += 15;
		...
		for (@Pc(273) int local273 = 0; local273 < Class569.aClass143_Sub1Array2.length; local273++) {
			if (Class569.aClass143_Sub1Array2[local273] != null && Class569.aClass143_Sub1Array2[local273].method11085()) {
				local267 += Class569.aClass143_Sub1Array2[local273].method11074();
				local269 += Class569.aClass143_Sub1Array2[local273].method11075();
				local271 += Class569.aClass143_Sub1Array2[local273].method11076();
			}
		}
		...
		@Pc(360) String local360 = "Cache:" + Class218.method25508(local340, 2, true, Class717.aClass717_15) + "% (" + local328 + "%)";
		Class707.aClass106_13.method7525(local360, local6, local10, -256, -1);
		local10 += 12;
	}
}
