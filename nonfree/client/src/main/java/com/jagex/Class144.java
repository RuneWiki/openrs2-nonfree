...
public abstract class Class144 {
	...
	Class93_Sub1_Sub16_Sub3 method11145(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2, @OriginalArg(3) boolean arg3) {
		...
		if (arg3) {
			if (this.method11155() >= 500) {
				throw new RuntimeException();
			}
			this.aClass18_7.method268(local11);
		} else if (this.method11147() < 500) {
			this.aClass18_8.method268(local11);
		} else {
			throw new RuntimeException();
		}
		return local11;
	...
	public int method11160() {
		return this.aClass18_7.method249() + this.aClass18_9.method249();
	}

	@OriginalMember(owner = "client!pp", name = "ju", descriptor = "(Lclient!yf;I)V", line = 6633)
	static final void method11174(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= 1189701933;
	}

	@OriginalMember(owner = "client!pp", name = "ls", descriptor = "(Lclient!yf;I)V", line = 7062)
	static final void method11175(@OriginalArg(0) Class681 arg0) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		Class336.method27444(local11, arg0);
	}

	@OriginalMember(owner = "client!pp", name = "oe", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;I)V", line = 7658)
	static final void method11180(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
		...
		arg0.anObjectArray17 = Class499.method30148(local13, arg2);
		arg0.aBoolean680 = true;
	}

	@OriginalMember(owner = "client!pp", name = "tj", descriptor = "(Lclient!yf;I)V", line = 8376)
	static final void method11178(@OriginalArg(0) Class681 arg0) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		Class229.method25619(local11, arg0);
	}

	@OriginalMember(owner = "client!pp", name = "lq", descriptor = "(IZB)V", line = 12095)
	public static final void method11179(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		...
		@Pc(19) Class175 local19 = Class330.method27372();
		@Pc(25) Class93_Sub22 local25 = Class102.method2592(Class446.aClass446_26, local19.aClass24_2);
		local25.aClass93_Sub41_Sub2_1.method22510(Class46.method894(local16.aString191) + 3);
		local25.aClass93_Sub41_Sub2_1.method22454(arg0);
		local25.aClass93_Sub41_Sub2_1.method22510(arg1 ? 1 : 0);
		local25.aClass93_Sub41_Sub2_1.method22402(local16.aString191);
		local19.method24351(local25);
	}

	@OriginalMember(owner = "client!pp", name = "avt", descriptor = "(Lclient!yf;I)V", line = 13525)
	static final void method11176(@OriginalArg(0) Class681 arg0) {
	...
	static final void method11177(@OriginalArg(0) Class681 arg0) {
		Class624.method32160();
	}

	@OriginalMember(owner = "client!pp", name = "z", descriptor = "(ZI)V")
	public abstract void method11144(@OriginalArg(0) boolean arg0);

	@OriginalMember(owner = "client!pp", name = "p", descriptor = "(I)V")
	public abstract void method11148();

	@OriginalMember(owner = "client!pp", name = "w", descriptor = "(IIB)V")
	abstract void method11149(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1);

	@OriginalMember(owner = "client!pp", name = "l", descriptor = "(I)Z")
	public abstract boolean method11150();

	@OriginalMember(owner = "client!pp", name = "u", descriptor = "(Ljava/lang/Object;ZI)V")
	public abstract void method11151(@OriginalArg(0) Object arg0, @OriginalArg(1) boolean arg1);
	...
	public abstract void method11154();
	...
	public abstract void method11169();
