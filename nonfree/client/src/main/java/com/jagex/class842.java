...
public class class842 extends class116 {
	...
	public class842(class848 arg0, class120 arg1, int arg2, int arg3, int arg4, int arg5) {
		...
		if (!var43) {
			this.field9562 = (float[][]) null;
			this.field9561 = (float[][]) null;
		}
	...
	public void method15478(class419 arg0, class141 arg1, int arg2) {
		...
		for (int var31 = 0; var31 < this.field9603; var31++) {
			...
			if (var37 >= -var38) {
				this.field9578[var31] = (float) (int) (this.field9534.field840 * var35 / var38 + this.field9534.field853);
				this.field9607[var31] = (float) (int) (this.field9534.field854 * var36 / var38 + this.field9534.field857);
			} else {
		...
		if (var8 && arg0 > var9 && arg0 < var10 && arg1 > var11 && arg1 < var12) {
			...
			for (int var35 = 0; var35 < this.field9603; var35++) {
				...
				if (var39 >= -var40) {
					...
					this.field9578[var35] = (float) (int) (this.field9572.field9789 * var41 / var40 + this.field9572.field9814);
					this.field9607[var35] = (float) (int) (this.field9572.field9802 * var42 / var40 + this.field9572.field9806);
				} else {
	...
	public void method15488() {
		...
		this.field9593 = (short) (int) (Math.sqrt((double) var1) + 0.99D);
		this.field9598 = (short) (int) (Math.sqrt((double) var2) + 0.99D);
		this.field9592 = true;
	}
