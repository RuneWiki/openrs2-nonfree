...
public class Class528 {
	...
	Class528() {
		...
		if (Class51.aClass93_Sub36_1.aClass166_Sub14_1.method15654(-1287736392) == 1) {
	...
	static boolean method30392(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg0 == 59 || arg0 == 2 || arg0 == 8 || arg0 == 17 || arg0 == 15 || arg0 == 16 || arg0 == 58;
	}

	@OriginalMember(owner = "client!re", name = "l", descriptor = "(B)I", line = 94)
	public static int method30393(@OriginalArg(0) byte arg0) {
	...
	static final void method30394(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method30396(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) byte arg3) {
		...
		arg0.anObjectArray21 = Class499.method30148(local13, arg2, -1078700915);
