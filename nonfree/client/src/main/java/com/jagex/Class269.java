...
class Class269 implements Interface58 {
	...
	public void method26350(@OriginalArg(0) Object arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) Object[] arg2, @OriginalArg(3) byte arg3) {
		...
		@Pc(6) Class472 local6 = local2.method30806((short) -1580);
		@Pc(10) float local10 = local2.method30847(-756584846);
		@Pc(14) float local14 = local2.method30808((byte) 1);
		@Pc(21) Class472 local21 = Class472.method29574(local6, this.this$0.method26030(-1505746905));
	...
	public void method26351(@OriginalArg(0) Object arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) Object[] arg2) {
		@Pc(2) Class539 local2 = (Class539) arg0;
		@Pc(6) Class472 local6 = local2.method30806((short) -8262);
		@Pc(10) float local10 = local2.method30847(-601457725);
		@Pc(14) float local14 = local2.method30808((byte) 1);
		@Pc(21) Class472 local21 = Class472.method29574(local6, this.this$0.method26030(-823818015));
		@Pc(23) float local23 = 0.0F;
		@Pc(26) float local26 = local21.method29565();
		if (local26 >= local14) {
			local23 = 0.0F;
	...
	public void method26352(@OriginalArg(0) Object arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) Object[] arg2) {
		@Pc(2) Class539 local2 = (Class539) arg0;
		@Pc(6) Class472 local6 = local2.method30806((short) -21869);
		@Pc(10) float local10 = local2.method30847(-1323154846);
		@Pc(14) float local14 = local2.method30808((byte) 1);
		@Pc(21) Class472 local21 = Class472.method29574(local6, this.this$0.method26030(-1824443984));
		@Pc(23) float local23 = 0.0F;
		@Pc(26) float local26 = local21.method29565();
		if (local26 >= local14) {
			local23 = 0.0F;
	...
	static final void method26273(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte arg4) {
	...
	static final void method26274(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
