...
final class Class510 implements Interface9 {
	...
	static void method30245(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		if (Class454.aBoolean773) {
			Class379.method28099(arg0, -915127854);
		} else {
			Class612.method32056(arg0, 341027251);
		}
	}

	@OriginalMember(owner = "client!qm", name = "hb", descriptor = "(Lclient!yf;B)V", line = 6276)
	static final void method30246(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, -518589708);
	...
	public static void method30248(@OriginalArg(0) byte arg0) {
		if (Class75.aBoolean31) {
			return;
		}
		Class277.method26360(client.aClass532_1.method30459(-1344665081).aClass572ArrayArrayArray1, 1741982922);
		if (client.aClass532_1.method30459(-1571706188).aClass572ArrayArrayArray2 != null) {
			Class277.method26360(client.aClass532_1.method30459(-1592981131).aClass572ArrayArrayArray2, 1091328726);
		}
