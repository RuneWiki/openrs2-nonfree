...
public abstract class Class112_Sub1 extends Class112 {
	...
	public abstract void method23432(@OriginalArg(0) int arg0, @OriginalArg(1) Interface18 arg1);

	@OriginalMember(owner = "client!afq", name = "ag", descriptor = "(IIIIIIZZ)V")
	public abstract void method23433(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6, @OriginalArg(7) boolean arg7);

	@OriginalMember(owner = "client!afq", name = "b", descriptor = "(ILclient!dp;)V")
	public abstract void method23434(@OriginalArg(0) int arg0, @OriginalArg(1) Interface18 arg1);

	@OriginalMember(owner = "client!afq", name = "a", descriptor = "(IIIIIIZZ)V")
	public abstract void method23435(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6, @OriginalArg(7) boolean arg7);

	@OriginalMember(owner = "client!afq", name = "x", descriptor = "(Lclient!dw;)V")
	public abstract void method23436(@OriginalArg(0) Interface19 arg0);

	@OriginalMember(owner = "client!afq", name = "j", descriptor = "(ILclient!dp;)V")
	public abstract void method23437(@OriginalArg(0) int arg0, @OriginalArg(1) Interface18 arg1);
	...
	public abstract void method23439(@OriginalArg(0) Interface19 arg0);

	@OriginalMember(owner = "client!afq", name = "ae", descriptor = "(IIIIIIZZ)V")
	public abstract void method23440(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6, @OriginalArg(7) boolean arg7);

	@OriginalMember(owner = "client!afq", name = "h", descriptor = "()Z")
	public abstract boolean method23441();
	...
	static final void method23444(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
