...
public class RuntimeException_Sub1 extends RuntimeException {
	...
	public static void method23314(@OriginalArg(0) String arg0, @OriginalArg(1) Throwable arg1) {
		try {
			...
			Class273.method26329(local1, (short) 1698);
			...
			@Pc(126) URL local126 = new URL(local41, "clienterror.ws?c=" + anInt3188 * 978703369 + "&cs=" + anInt3189 * -1468759271 + "&u=" + (aString116 == null ? "" + aLong210 * -7577937061430114655L : Class25_Sub2.method16021(aString116, (byte) 73)) + "&v1=" + Class25_Sub2.method16021(local60, (byte) 73) + "&v2=" + Class25_Sub2.method16021(local62, (byte) 73) + "&e=" + local1);
	...
	public static void method23315(@OriginalArg(0) String arg0, @OriginalArg(1) Throwable arg1) {
		try {
			...
			Class273.method26329(local1, (short) 10559);
			local1 = Class25_Sub2.method16021(local1, (byte) 73);
			@Pc(41) URL local41 = null;
			if (Class69.anApplet1 != null) {
				local41 = Class69.anApplet1.getCodeBase();
