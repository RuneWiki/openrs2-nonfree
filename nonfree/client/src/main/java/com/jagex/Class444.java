...
public class Class444 implements Interface47 {
	...
	public Class431 method28875(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(18) byte[] local18 = this.aClass497_116.method30044(1, arg0, (byte) 0);
		local6 = new Class431();
		local6.anInt4791 = arg0 * 402822681;
		if (local18 != null) {
			local6.method28767(new Class93_Sub41(local18), 174301989);
		}
		local6.method28769((byte) 8);
	...
	public void method28878(@OriginalArg(0) int arg0) {
		this.aClass240_83.method25833((byte) -114);
	}
	...
	public Class431 method28876(@OriginalArg(0) int arg0) {
		...
		local6.anInt4791 = arg0 * 402822681;
		if (local18 != null) {
			local6.method28767(new Class93_Sub41(local18), 1093622530);
		}
		local6.method28769((byte) 8);
		this.aClass240_83.method25830(local6, (long) arg0);
		return local6;
	...
	public Class431 method28877(@OriginalArg(0) int arg0) {
		...
		local6.anInt4791 = arg0 * 402822681;
		if (local18 != null) {
			local6.method28767(new Class93_Sub41(local18), -242259655);
		}
		local6.method28769((byte) 8);
		this.aClass240_83.method25830(local6, (long) arg0);
		return local6;
	...
	public void method28879() {
		this.aClass240_83.method25833((byte) -122);
	}

	@OriginalMember(owner = "client!no", name = "w", descriptor = "()V", line = 29)
	public void method28880() {
		this.aClass240_83.method25833((byte) -84);
	}

	@OriginalMember(owner = "client!no", name = "aj", descriptor = "(Lclient!yf;ZZB)V", line = 5021)
	static final void method28881(@OriginalArg(0) Class681 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) byte arg3) {
	...
	static final void method28882(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub6_1.method16543(local12, 1863697913);
	}

	@OriginalMember(owner = "client!no", name = "w", descriptor = "(Ljava/lang/CharSequence;II[BII)I", line = 128)
	public static int method28883(@OriginalArg(0) CharSequence arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
	...
	static final void method28884(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		@Pc(17) Class93_Sub1_Sub15 local17 = Class220.method25541(local13, -1137288482);
		if (local17 != null) {
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = local17.anInt3087 * 812782679;
			arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = Class123_Sub1.method9095(local17.aLong190 * -9166377137725744335L, Class106.aClass717_8.anInt5963 * -1156137245, 304225723);
	...
	static final void method28885(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!no", name = "asa", descriptor = "(Lclient!yf;I)V", line = 13050)
	static final void method28886(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		Class51.aClass93_Sub36_1.method14357(Class51.aClass93_Sub36_1.aClass166_Sub19_1, arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091] == 1 ? 1 : 0, (byte) 32);
		Class610.method32021(-818545189);
		client.aClass532_1.method30532((byte) 56).method33003(612179344);
		Class106_Sub1.method5148(-555897078);
		client.aBoolean601 = false;
	}

	@OriginalMember(owner = "client!no", name = "bcn", descriptor = "(Lclient!yf;I)V", line = 14646)
	static final void method28887(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(1) int local1 = 0;
		@Pc(3) int local3 = 0;
	...
	static final void method28888(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
