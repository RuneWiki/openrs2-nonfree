...
public class Class481 {
	...
	public static void method29753(@OriginalArg(0) boolean arg0, @OriginalArg(1) byte arg1) {
		Class274.aClass258_1.method26032((short) 29858);
		...
		for (@Pc(13) int local13 = 0; local13 < local11.length; local13++) {
			...
			local21.anInt3300 = 0;
			if (!local21.aBoolean564 && local21.method24356((byte) 7) != null) {
				@Pc(52) Class93_Sub22 local52 = Class102.method2592(Class446.aClass446_105, local21.aClass24_2, (byte) 34);
				local21.method24351(local52, -1743193292);
				try {
					local21.method24350((byte) 60);
				} catch (@Pc(61) IOException local61) {
					local21.aBoolean564 = true;
				}
			}
		}
		Class274.aClass258_1.method26032((short) 4277);
	}

	@OriginalMember(owner = "client!pg", name = "z", descriptor = "(II)I", line = 63)
	public static int method29754(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public static void method29755(@OriginalArg(0) Class73 arg0, @OriginalArg(1) int arg1) {
		Class370.method27995(new Class599(arg0), -2102009315);
	}
	...
	public static void method29756(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (client.anInt3435 * -849002901 == 18 && arg0 != 3) {
			Class570.method31320(-668282493);
		}
		if (arg0 == 14 || arg0 == 19) {
			Class378.method28072(1093128507);
		}
		...
		if (arg0 == 4) {
			Class138.method11537(client.anInt3435 * -849002901 == 0 || client.anInt3435 * -849002901 == 12 || client.anInt3526 * -703563959 != Class93_Sub26.aClass645_15.anInt5766 * -221025663, -729963422);
			Class606.method31910(-1637013277);
		}
		...
		if (arg0 == 17 || arg0 == 9) {
			if (!Class349.method27624((short) 25902)) {
				return;
			}
		} else if (arg0 == 7 || arg0 == 15 && client.anInt3435 * -849002901 != 16) {
			if (!Class378.method28072(1142325507)) {
				return;
			}
		} else if (arg0 == 12) {
			Class166_Sub6.method15483((byte) 37);
		}
		...
		if (arg0 == 3 || arg0 == 4) {
			Class277.method26358(815773506);
		}
		local88 = arg0 == 1 || Class1.method15(arg0, 1453479910) || Class56.method18034(arg0, -1497248091);
		@Pc(188) boolean local188 = client.anInt3435 * -849002901 == 1 || Class1.method15(client.anInt3435 * -849002901, -895984920) || Class56.method18034(client.anInt3435 * -849002901, -1497248091);
		if (local88 != local188) {
