...
public class Class567 {
	...
	Class109 method31259(@OriginalArg(0) Class104 arg0) {
		...
		if (local7 == null) {
			...
			if (local7.anInt3738 < 13) {
				local7.method25671(2);
			}
			return arg0.method20510(local7, 2048, anInt5388 * 1726905857, 64, 768);
		}
	}
	...
	void method31261(@OriginalArg(0) Class585 arg0) {
		this.aLinkedList4 = new LinkedList();
		@Pc(8) Class520 local8 = client.aClass532_1.method30509(-1261392332);
		@Pc(12) Class611 local12 = client.aClass532_1.method30443(2012769476);
		...
		for (@Pc(29) int local29 = 1; local29 < this.anInt5387 * 554261149; local29++) {
			...
			while (local27.anInt5623 * 270611681 != local50.anInt5623 * 270611681 || local27.anInt5624 * -1994307635 != local50.anInt5624 * -1994307635) {
				...
				if (local144 >= 0 && local144 < arg0.anInt5443 * -200159665 && local154 >= 0 && local154 < arg0.anInt5444 * -1943751559) {
					...
					this.aLinkedList4.add(new Class132_Sub1_Sub1_Sub6(arg0, this, Class512.anInt5209 * 1177442423, local134, local176, Class305.method26801(local176, local182, Class512.anInt5209 * 1177442423, (byte) -77), local182));
				}
			}
			local27 = local50;
		}
	...
	public void method31262(@OriginalArg(0) Class585 arg0, @OriginalArg(1) byte arg1) {
		...
		while (local9.hasNext()) {
			...
			arg0.method31441(local16.aByte100, local16.aShort129, local16.aShort128, new Class579(local16), -864883262);
		}
	}

	@OriginalMember(owner = "client!ta", name = "k", descriptor = "(Lclient!tx;B)V", line = 73)
	void method31263(@OriginalArg(0) Class585 arg0, @OriginalArg(1) byte arg1) {
		this.aLinkedList4 = new LinkedList();
		@Pc(8) Class520 local8 = client.aClass532_1.method30509(1928147315);
		@Pc(12) Class611 local12 = client.aClass532_1.method30443(2006744981);
		@Pc(27) Class611 local27 = new Class611(Class512.anInt5209 * 1177442423, this.anIntArray468[0], this.anIntArray469[0]);
		for (@Pc(29) int local29 = 1; local29 < this.anInt5387 * 554261149; local29++) {
			@Pc(50) Class611 local50 = new Class611(Class512.anInt5209 * 1177442423, this.anIntArray468[local29], this.anIntArray469[local29]);
			while (local27.anInt5623 * 270611681 != local50.anInt5623 * 270611681 || local27.anInt5624 * -1994307635 != local50.anInt5624 * -1994307635) {
				...
				if (local144 >= 0 && local144 < arg0.anInt5443 * -200159665 && local154 >= 0 && local154 < arg0.anInt5444 * -1943751559) {
					...
					this.aLinkedList4.add(new Class132_Sub1_Sub1_Sub6(arg0, this, Class512.anInt5209 * 1177442423, local134, local176, Class305.method26801(local176, local182, Class512.anInt5209 * 1177442423, (byte) -53), local182));
				}
			}
			local27 = local50;
		}
	...
	Class109 method31267(@OriginalArg(0) Class104 arg0) {
		@Pc(7) Class231 local7 = Class231.method25655(Class86.aClass497_15, this.anInt5386 * 368086239, 0);
		if (local7 == null) {
			return null;
		} else {
	...
	Class109 method31268(@OriginalArg(0) Class104 arg0) {
		@Pc(7) Class231 local7 = Class231.method25655(Class86.aClass497_15, this.anInt5386 * 368086239, 0);
		if (local7 == null) {
			return null;
		} else {
	...
	Class109 method31269(@OriginalArg(0) Class104 arg0) {
		@Pc(7) Class231 local7 = Class231.method25655(Class86.aClass497_15, this.anInt5386 * 368086239, 0);
		if (local7 == null) {
			return null;
		} else {
	...
	public Class567(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class93_Sub41 arg1, @OriginalArg(2) int arg2) {
		...
		this.anInt5387 = arg1.method22431(-358186793) * -2092434507;
		this.anIntArray468 = new int[this.anInt5387 * 554261149];
		this.anIntArray469 = new int[this.anInt5387 * 554261149];
		@Pc(31) int local31 = arg1.method22415(-1434290800);
		@Pc(35) int local35 = arg1.method22415(-1434290800);
		for (@Pc(37) int local37 = 0; local37 < this.anInt5387 * 554261149; local37++) {
			this.anIntArray468[local37] = local31 + arg1.method22414(2042379259);
			this.anIntArray469[local37] = local35 + arg1.method22414(1818791330);
		}
		this.aClass109_8 = this.method31260(arg0, (short) 255);
	}

	@OriginalMember(owner = "client!ta", name = "n", descriptor = "(Lclient!tx;B)V", line = 49)
	public void method31270(@OriginalArg(0) Class585 arg0, @OriginalArg(1) byte arg1) {
		if (arg0 == null || this.anInt5387 * 554261149 <= 0) {
			return;
		}
		this.method31263(arg0, (byte) -40);
		...
		while (local14.hasNext()) {
			...
			arg0.method31497(local21, false, -1990476630);
		}
		this.aBoolean813 = true;
	}

	@OriginalMember(owner = "client!ta", name = "v", descriptor = "(Lclient!tx;)V", line = 49)
	public void method31271(@OriginalArg(0) Class585 arg0) {
		if (arg0 == null || this.anInt5387 * 554261149 <= 0) {
			return;
		}
		this.method31263(arg0, (byte) -18);
		@Pc(14) Iterator local14 = this.aLinkedList4.iterator();
		while (local14.hasNext()) {
			@Pc(21) Class132_Sub1_Sub1_Sub6 local21 = (Class132_Sub1_Sub1_Sub6) local14.next();
			arg0.method31497(local21, false, -1880366099);
		}
		this.aBoolean813 = true;
	}

	@OriginalMember(owner = "client!ta", name = "o", descriptor = "(Lclient!tx;)V", line = 62)
	public void method31272(@OriginalArg(0) Class585 arg0) {
		if (arg0 == null || this.aLinkedList4 == null) {
			return;
		}
		@Pc(9) Iterator local9 = this.aLinkedList4.iterator();
		while (local9.hasNext()) {
			@Pc(16) Class132_Sub1_Sub1_Sub6 local16 = (Class132_Sub1_Sub1_Sub6) local9.next();
			arg0.method31441(local16.aByte100, local16.aShort129, local16.aShort128, new Class579(local16), -656815608);
		}
	}

	@OriginalMember(owner = "client!ta", name = "r", descriptor = "(Lclient!dh;)Lclient!do;", line = 42)
	Class109 method31273(@OriginalArg(0) Class104 arg0) {
		@Pc(7) Class231 local7 = Class231.method25655(Class86.aClass497_15, this.anInt5386 * 368086239, 0);
		if (local7 == null) {
			return null;
		} else {
	...
	void method31274(@OriginalArg(0) Class585 arg0) {
		this.aLinkedList4 = new LinkedList();
		@Pc(8) Class520 local8 = client.aClass532_1.method30509(1357705550);
		@Pc(12) Class611 local12 = client.aClass532_1.method30443(2088962294);
		@Pc(27) Class611 local27 = new Class611(Class512.anInt5209 * 1177442423, this.anIntArray468[0], this.anIntArray469[0]);
		for (@Pc(29) int local29 = 1; local29 < this.anInt5387 * 554261149; local29++) {
			@Pc(50) Class611 local50 = new Class611(Class512.anInt5209 * 1177442423, this.anIntArray468[local29], this.anIntArray469[local29]);
			while (local27.anInt5623 * 270611681 != local50.anInt5623 * 270611681 || local27.anInt5624 * -1994307635 != local50.anInt5624 * -1994307635) {
				...
				if (local144 >= 0 && local144 < arg0.anInt5443 * -200159665 && local154 >= 0 && local154 < arg0.anInt5444 * -1943751559) {
					...
					this.aLinkedList4.add(new Class132_Sub1_Sub1_Sub6(arg0, this, Class512.anInt5209 * 1177442423, local134, local176, Class305.method26801(local176, local182, Class512.anInt5209 * 1177442423, (byte) -19), local182));
				}
			}
			local27 = local50;
		}
	...
	void method31275(@OriginalArg(0) Class585 arg0) {
		this.aLinkedList4 = new LinkedList();
		@Pc(8) Class520 local8 = client.aClass532_1.method30509(1209348711);
		@Pc(12) Class611 local12 = client.aClass532_1.method30443(2101845940);
		@Pc(27) Class611 local27 = new Class611(Class512.anInt5209 * 1177442423, this.anIntArray468[0], this.anIntArray469[0]);
		for (@Pc(29) int local29 = 1; local29 < this.anInt5387 * 554261149; local29++) {
			@Pc(50) Class611 local50 = new Class611(Class512.anInt5209 * 1177442423, this.anIntArray468[local29], this.anIntArray469[local29]);
			while (local27.anInt5623 * 270611681 != local50.anInt5623 * 270611681 || local27.anInt5624 * -1994307635 != local50.anInt5624 * -1994307635) {
				...
				if (local144 >= 0 && local144 < arg0.anInt5443 * -200159665 && local154 >= 0 && local154 < arg0.anInt5444 * -1943751559) {
					...
					this.aLinkedList4.add(new Class132_Sub1_Sub1_Sub6(arg0, this, Class512.anInt5209 * 1177442423, local134, local176, Class305.method26801(local176, local182, Class512.anInt5209 * 1177442423, (byte) -108), local182));
				}
			}
			local27 = local50;
		}
	...
	void method31276(@OriginalArg(0) Class585 arg0) {
		this.aLinkedList4 = new LinkedList();
		@Pc(8) Class520 local8 = client.aClass532_1.method30509(580292846);
		@Pc(12) Class611 local12 = client.aClass532_1.method30443(2101151843);
		@Pc(27) Class611 local27 = new Class611(Class512.anInt5209 * 1177442423, this.anIntArray468[0], this.anIntArray469[0]);
		for (@Pc(29) int local29 = 1; local29 < this.anInt5387 * 554261149; local29++) {
			@Pc(50) Class611 local50 = new Class611(Class512.anInt5209 * 1177442423, this.anIntArray468[local29], this.anIntArray469[local29]);
			while (local27.anInt5623 * 270611681 != local50.anInt5623 * 270611681 || local27.anInt5624 * -1994307635 != local50.anInt5624 * -1994307635) {
				...
				if (local144 >= 0 && local144 < arg0.anInt5443 * -200159665 && local154 >= 0 && local154 < arg0.anInt5444 * -1943751559) {
					...
					this.aLinkedList4.add(new Class132_Sub1_Sub1_Sub6(arg0, this, Class512.anInt5209 * 1177442423, local134, local176, Class305.method26801(local176, local182, Class512.anInt5209 * 1177442423, (byte) -99), local182));
				}
			}
			local27 = local50;
		}
	...
	public static void method31277(@OriginalArg(0) int arg0) {
	...
	static final void method31284(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		Class688.method36520(arg0.aClass132_Sub1_Sub5_Sub1_1, arg0, 1265451683);
	}
}
