...
public class Class567 {
	...
	public Class567(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class93_Sub41 arg1, @OriginalArg(2) int arg2) {
		...
		this.anInt5387 = arg1.method22431() * -2092434507;
		this.anIntArray468 = new int[this.anInt5387 * 554261149];
		this.anIntArray469 = new int[this.anInt5387 * 554261149];
		@Pc(31) int local31 = arg1.method22415();
		@Pc(35) int local35 = arg1.method22415();
		for (@Pc(37) int local37 = 0; local37 < this.anInt5387 * 554261149; local37++) {
			this.anIntArray468[local37] = local31 + arg1.method22414();
			this.anIntArray469[local37] = local35 + arg1.method22414();
		}
		this.aClass109_8 = this.method31260(arg0);
	}
	...
	Class109 method31260(@OriginalArg(0) Class104 arg0) {
		@Pc(7) Class231 local7 = Class231.method25655(Class86.aClass497_15, this.anInt5386 * 368086239, 0);
		if (local7 == null) {
			return null;
		} else {
	...
	public void method31270(@OriginalArg(0) Class585 arg0) {
		if (arg0 == null || this.anInt5387 * 554261149 <= 0) {
			return;
		}
		this.method31263(arg0);
		...
		while (local14.hasNext()) {
			...
			arg0.method31497(local21, false);
		}
	...
	public void method31262(@OriginalArg(0) Class585 arg0) {
		...
		while (local9.hasNext()) {
			...
			arg0.method31441(local16.aByte100, local16.aShort129, local16.aShort128, new Class579(local16));
		}
	}
	...
	void method31261(@OriginalArg(0) Class585 arg0) {
		...
		@Pc(8) Class520 local8 = client.aClass532_1.method30509();
		@Pc(12) Class611 local12 = client.aClass532_1.method30443();
		...
		for (@Pc(29) int local29 = 1; local29 < this.anInt5387 * 554261149; local29++) {
			...
			while (local27.anInt5623 * 270611681 != local50.anInt5623 * 270611681 || local27.anInt5624 * -1994307635 != local50.anInt5624 * -1994307635) {
				...
				if (local144 >= 0 && local144 < arg0.anInt5443 * -200159665 && local154 >= 0 && local154 < arg0.anInt5444 * -1943751559) {
					...
					if (local8.method30330(local144, local154)) {
						local134++;
					}
					this.aLinkedList4.add(new Class132_Sub1_Sub1_Sub6(arg0, this, Class512.anInt5209 * 1177442423, local134, local176, Class305.method26801(local176, local182, Class512.anInt5209 * 1177442423), local182));
				}
			}
			local27 = local50;
		}
	...
	void method31263(@OriginalArg(0) Class585 arg0) {
		this.aLinkedList4 = new LinkedList();
		@Pc(8) Class520 local8 = client.aClass532_1.method30509();
		@Pc(12) Class611 local12 = client.aClass532_1.method30443();
		@Pc(27) Class611 local27 = new Class611(Class512.anInt5209 * 1177442423, this.anIntArray468[0], this.anIntArray469[0]);
	...
	public boolean method31266(@OriginalArg(0) Class104 arg0) {
		this.aClass109_8 = this.method31260(arg0);
	...
	static final void method31284(@OriginalArg(0) Class681 arg0) {
		Class688.method36520(arg0.aClass132_Sub1_Sub5_Sub1_1, arg0);
	}
}
