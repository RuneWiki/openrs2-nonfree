...
public final class Class503 implements Comparable {
	...
	public boolean method30176(@OriginalArg(0) Object arg0) {
	...
	int method30177(@OriginalArg(0) Class503 arg0, @OriginalArg(1) byte arg1) {
	...
	int method30178(@OriginalArg(0) Class503 arg0) {
		if (this.aLong283 * 3216089845001939409L < arg0.aLong283 * 3216089845001939409L) {
			return -1;
		} else if (this.aLong283 * 3216089845001939409L > arg0.aLong283 * 3216089845001939409L) {
			return 1;
	...
	public int method30181(@OriginalArg(0) Object arg0) {
		return this.method30177((Class503) arg0, (byte) 1);
	}
	...
	public boolean method30184(@OriginalArg(0) Object arg0) {
		if (!(arg0 instanceof Class503)) {
			throw new IllegalArgumentException();
		}
		return this.anObject20.equals(((Class503) arg0).anObject20);
	...
	static final void method30188(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class389.method28270(local11, local14, arg0, 1298505453);
	}

	@OriginalMember(owner = "client!qd", name = "aoz", descriptor = "(Lclient!yf;I)V", line = 12640)
	static final void method30189(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) throws Exception_Sub3 {
		Class65.aClass123_Sub1_2.method8955((float) arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091] / 1000.0F, (byte) 8);
	}

	@OriginalMember(owner = "client!qd", name = "arx", descriptor = "(Lclient!yf;B)V", line = 12900)
	static final void method30190(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	}

	@OriginalMember(owner = "client!qd", name = "fi", descriptor = "(I)V", line = 2408)
	static void method30191(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = 0;
		if (Class51.aClass93_Sub36_1 != null) {
			local1 = Class51.aClass93_Sub36_1.aClass166_Sub24_1.method15865(692665550);
		}
		@Pc(23) int local23;
		@Pc(34) int local34;
		if (local1 == 2) {
