...
public class Class350 {
	...
	static String method27630(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		try {
			...
			arg0.anInt3070 += aClass337_1.method27457(arg0.aByteArray58, arg0.anInt3070 * 212851357, local11, 0, local3, (byte) 58) * -1445626955;
			return Class155.method15308(local11, 0, local3, (byte) 68);
	...
	public static void method27631(@OriginalArg(0) Class337 arg0) {
		aClass337_1 = arg0;
	}
	...
	public static int method27632(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) String arg1) {
		@Pc(4) int local4 = arg0.anInt3070 * 212851357;
		@Pc(8) byte[] local8 = Class269.method26271(arg1, (byte) -17);
		arg0.method22639(local8.length, (byte) -47);
	...
	static String method27633(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		try {
			@Pc(3) int local3 = arg0.method22632((byte) -70);
			if (local3 > arg1) {
				local3 = arg1;
			}
			@Pc(11) byte[] local11 = new byte[local3];
			arg0.anInt3070 += aClass337_1.method27457(arg0.aByteArray58, arg0.anInt3070 * 212851357, local11, 0, local3, (byte) 15) * -1445626955;
			return Class155.method15308(local11, 0, local3, (byte) 15);
		} catch (@Pc(39) Exception local39) {
			return "Cabbage";
		}
	}
	...
	public static void method27634(@OriginalArg(0) int[] arg0, @OriginalArg(1) Object[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg2 >= arg3) {
			return;
		}
		...
		method27634(arg0, arg1, arg2, local10 - 1, 1922837306);
		method27634(arg0, arg1, local10 + 1, arg3, 151102376);
	}

	@OriginalMember(owner = "client!iv", name = "e", descriptor = "([I[II)V", line = 19)
	public static void method27635(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2) {
		if (arg0 == null || arg1 == null) {
			Class588.anIntArray475 = null;
			Class723.anIntArray528 = null;
			Class723.aByteArrayArrayArray14 = (byte[][][]) null;
			return;
		}
	...
	static final void method27636(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 307799275);
	...
	static void method27637(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(4) Class93_Sub1_Sub11 local4 = Class371.method28006(11, (long) arg0);
		local4.method21801(-1727280149);
