...
public class Class335 {
	...
	static final void method27404(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method27405(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, -7933309);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class329.method27347(local16, local22, arg0, 1825123840);
	}

	@OriginalMember(owner = "client!ie", name = "np", descriptor = "(Lclient!yf;B)V", line = 7372)
	static final void method27406(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class370.method27999(local11, local14, arg0, (byte) -8);
	}

	@OriginalMember(owner = "client!ie", name = "azq", descriptor = "(Lclient!yf;I)V", line = 14185)
	static final void method27407(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub26_1.method15907((short) -21412) ? 1 : 0;
	}

	@OriginalMember(owner = "client!ie", name = "e", descriptor = "([BI)[B", line = 9)
	public static byte[] method27408(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		if (arg0 == null) {
			return null;
		} else {
	...
	public static void method27409(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(18) int local18 = 0; local18 < local14; local18++) {
			...
			if (local27.aString82 != null && local27.aString82.equalsIgnoreCase(arg0) && (local27 == Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3 && (Class253.anInt3851 * 735260021 & 0x10) != 0 || (Class253.anInt3851 * 735260021 & 0x8) != 0)) {
				...
				local58.aClass93_Sub41_Sub2_1.method22454(client.anInt3523 * 1573685689, 2133965049);
				local58.aClass93_Sub41_Sub2_1.method22446(0, -1591808004);
				local58.aClass93_Sub41_Sub2_1.method22590(client.anInt3524 * -239149331, (byte) -49);
				local58.aClass93_Sub41_Sub2_1.method22456(local16[local18], (short) 255);
				local58.aClass93_Sub41_Sub2_1.method22466(Class148.anInt1394 * -278883695, 844689790);
				client.aClass175_2.method24351(local58, -2145186804);
				Class498.method30137(local27.anIntArray240[0], local27.anIntArray239[0], -2062153340);
				local10 = true;
				break;
			}
		}
