...
public class Class88_Sub2 extends Class88 {
	...
	Class88_Sub2(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		this.anInt2545 = arg5;
		this.aClass104_Sub1_34.method3804(this);
		@Pc(24) Class112 local24 = this.aClass104_Sub1_34.method20434();
		if (local24 != null) {
	...
	void method18091(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int[] arg3, @OriginalArg(5) int[] arg4, @OriginalArg(6) int arg5) {
		@Pc(10) int[] local10 = arg4 == null ? new int[this.anInt2546 * this.anInt2545] : arg4;
		this.aClass104_Sub1_34.method3804(this);
		OpenGL.glGetTexImagei(this.anInt2543, 0, 32993, 5121, local10, 0);
		for (@Pc(24) int local24 = 0; local24 < arg2; local24++) {
			System.arraycopy(local10, (arg0 + (arg2 - 1) - local24) * this.anInt2546, arg3, arg5 + local24 * arg1, arg1);
		}
	}

	@OriginalMember(owner = "client!adt", name = "an", descriptor = "(IIII[I[II)V", line = 160)
	void method18092(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int[] arg3, @OriginalArg(5) int[] arg4, @OriginalArg(6) int arg5) {
		@Pc(10) int[] local10 = arg4 == null ? new int[this.anInt2546 * this.anInt2545] : arg4;
		this.aClass104_Sub1_34.method3804(this);
		OpenGL.glGetTexImagei(this.anInt2543, 0, 32993, 5121, local10, 0);
		for (@Pc(24) int local24 = 0; local24 < arg2; local24++) {
	...
	void method18094(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int[] arg3, @OriginalArg(5) int[] arg4, @OriginalArg(6) int arg5) {
		@Pc(10) int[] local10 = arg4 == null ? new int[this.anInt2546 * this.anInt2545] : arg4;
		this.aClass104_Sub1_34.method3804(this);
		OpenGL.glGetTexImagei(this.anInt2543, 0, 32993, 5121, local10, 0);
		for (@Pc(24) int local24 = 0; local24 < arg2; local24++) {
	...
	void method18095(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int[] arg3, @OriginalArg(5) int[] arg4, @OriginalArg(6) int arg5) {
		@Pc(10) int[] local10 = arg4 == null ? new int[this.anInt2546 * this.anInt2545] : arg4;
		this.aClass104_Sub1_34.method3804(this);
		OpenGL.glGetTexImagei(this.anInt2543, 0, 32993, 5121, local10, 0);
		for (@Pc(24) int local24 = 0; local24 < arg2; local24++) {
	...
	void method18083(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(4) Class112 local4 = this.aClass104_Sub1_34.method20434();
		if (local4 != null) {
