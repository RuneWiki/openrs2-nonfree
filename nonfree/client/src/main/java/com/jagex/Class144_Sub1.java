...
public class Class144_Sub1 extends Class144 {
	...
	public boolean method11150(@OriginalArg(0) int arg0) {
		...
		if (this.aClass160_1 != null) {
			@Pc(6) long local6 = Class305.method26796(1934196852);
		...
		try {
			...
			for (local69 = (Class93_Sub1_Sub16_Sub3) this.aClass18_7.method246(-1003169474); local69 != null; local69 = (Class93_Sub1_Sub16_Sub3) this.aClass18_7.method253(870914263)) {
				...
				this.aClass93_Sub41_5.method22510(1, (byte) -31);
			...
			for (local69 = (Class93_Sub1_Sub16_Sub3) this.aClass18_8.method246(1541395074); local69 != null; local69 = (Class93_Sub1_Sub16_Sub3) this.aClass18_8.method253(-373647470)) {
				this.aClass93_Sub41_5.anInt3070 = 0;
				this.aClass93_Sub41_5.method22510(0, (byte) -72);
				this.aClass93_Sub41_5.method22397(local69.aLong233 * -5980455722457358841L);
			...
			for (@Pc(162) int local162 = 0; local162 < 100; local162++) {
				...
				if (this.aClass93_Sub1_Sub16_Sub3_2 == null) {
					...
					if (this.aClass93_Sub41_6.anInt3070 * 212851357 >= 5) {
						...
						local219 = this.aClass93_Sub41_6.method22413((short) 16384);
						local272 = this.aClass93_Sub41_6.method22419(-118643075);
					...
					if (local365 == null) {
						...
						if (this.aClass93_Sub41_7.anInt3070 * 212851357 >= 5) {
							this.aClass93_Sub41_7.anInt3070 = 0;
							local272 = this.aClass93_Sub41_7.method22413((short) 16384);
							local454 = this.aClass93_Sub41_7.method22419(-118643075);
							...
							local365.method22510(local272, (byte) -81);
							local365.method22395(local454, (byte) -37);
							this.anInt1342 += -1763880151;
						}
					} else {
	...
	public void method11167() {
		...
		try {
			this.aClass93_Sub41_5.anInt3070 = 0;
			this.aClass93_Sub41_5.method22510(7, (byte) -27);
	...
	void method11161(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		this.aByte22 = (byte) (int) (Math.random() * 255.0D + 1.0D);
				...
				while (true) {
					...
					if (local40 == null) {
						if (this.aByte22 != 0) {
							try {
								this.aClass93_Sub41_5.anInt3070 = 0;
								this.aClass93_Sub41_5.method22510(4, (byte) -72);
								this.aClass93_Sub41_5.method22510(this.aByte22, (byte) -45);
								this.aClass93_Sub41_5.method22395(0, (byte) 97);
						...
						this.anInt1331 = 0;
						this.aLong45 = Class305.method26796(1946823292) * 416383678038968693L;
						return;
					}
	...
	public void method11148(@OriginalArg(0) int arg0) {
		...
		try {
			this.aClass93_Sub41_5.anInt3070 = 0;
			this.aClass93_Sub41_5.method22510(7, (byte) -60);
			this.aClass93_Sub41_5.method22397(0L);
	...
	void method11181(@OriginalArg(0) int arg0) {
		...
		try {
			this.aClass93_Sub41_5.anInt3070 = 0;
			this.aClass93_Sub41_5.method22510(6, (byte) -118);
			this.aClass93_Sub41_5.method22394(4, (byte) 79);
			this.aClass93_Sub41_5.method22454(0, 2144257347);
				...
				while (true) {
					...
					if (local40 == null) {
						if (this.aByte22 != 0) {
							try {
								this.aClass93_Sub41_5.anInt3070 = 0;
								this.aClass93_Sub41_5.method22510(4, (byte) -30);
								this.aClass93_Sub41_5.method22510(this.aByte22, (byte) -73);
								this.aClass93_Sub41_5.method22395(0, (byte) -17);
						...
						this.anInt1331 = 0;
						this.aLong45 = Class305.method26796(855699059) * 416383678038968693L;
						return;
					}
					local40.aClass93_Sub41_13 = null;
	...
	public void method11165(@OriginalArg(0) boolean arg0) {
		...
		try {
			this.aClass93_Sub41_5.anInt3070 = 0;
			this.aClass93_Sub41_5.method22510(arg0 ? 2 : 3, (byte) -36);
			this.aClass93_Sub41_5.method22397(0L);
	...
	public void method11166() {
		...
		try {
			this.aClass93_Sub41_5.anInt3070 = 0;
			this.aClass93_Sub41_5.method22510(7, (byte) -69);
			this.aClass93_Sub41_5.method22397(0L);
	...
	public boolean method11163() {
		@Pc(14) int local14;
		if (this.aClass160_1 != null) {
			@Pc(6) long local6 = Class305.method26796(724187755);
			local14 = (int) (local6 - this.aLong45 * -1879205428230144291L);
			this.aLong45 = local6 * 416383678038968693L;
			if (local14 > 200) {
				local14 = 200;
		...
		try {
			...
			for (local69 = (Class93_Sub1_Sub16_Sub3) this.aClass18_7.method246(-2095331395); local69 != null; local69 = (Class93_Sub1_Sub16_Sub3) this.aClass18_7.method253(1966968899)) {
				this.aClass93_Sub41_5.anInt3070 = 0;
				this.aClass93_Sub41_5.method22510(1, (byte) -13);
				this.aClass93_Sub41_5.method22397(local69.aLong233 * -5980455722457358841L);
			...
			for (local69 = (Class93_Sub1_Sub16_Sub3) this.aClass18_8.method246(-737906607); local69 != null; local69 = (Class93_Sub1_Sub16_Sub3) this.aClass18_8.method253(-99442777)) {
				this.aClass93_Sub41_5.anInt3070 = 0;
				this.aClass93_Sub41_5.method22510(0, (byte) -102);
				this.aClass93_Sub41_5.method22397(local69.aLong233 * -5980455722457358841L);
				...
				if (this.aClass93_Sub1_Sub16_Sub3_2 == null) {
					...
					if (local365 == null) {
						...
						if (this.aClass93_Sub41_7.anInt3070 * 212851357 >= 5) {
							...
							local365 = this.aClass93_Sub1_Sub16_Sub3_2.aClass93_Sub41_13 = new Class93_Sub41(this.aClass93_Sub1_Sub16_Sub3_2.aByte93 + local454 + local456);
							local365.method22510(local272, (byte) -91);
							local365.method22395(local454, (byte) -46);
							this.anInt1342 += -1763880151;
						}
					} else {
						local219 = local365.aByteArray58.length - this.aClass93_Sub1_Sub16_Sub3_2.aByte93;
	...
	public void method11144(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		...
		try {
			this.aClass93_Sub41_5.anInt3070 = 0;
			this.aClass93_Sub41_5.method22510(arg0 ? 2 : 3, (byte) -18);
			this.aClass93_Sub41_5.method22397(0L);
	...
	void method11182() {
		...
		try {
			this.aClass93_Sub41_5.anInt3070 = 0;
			this.aClass93_Sub41_5.method22510(6, (byte) -5);
			this.aClass93_Sub41_5.method22394(4, (byte) 76);
			this.aClass93_Sub41_5.method22454(0, 2143299554);
	...
	void method11183() {
		...
		try {
			this.aClass93_Sub41_5.anInt3070 = 0;
			this.aClass93_Sub41_5.method22510(6, (byte) -34);
			this.aClass93_Sub41_5.method22394(4, (byte) 33);
			this.aClass93_Sub41_5.method22454(0, 2130208905);
	...
	void method11184() {
		...
		try {
			this.aClass93_Sub41_5.anInt3070 = 0;
			this.aClass93_Sub41_5.method22510(6, (byte) -23);
			this.aClass93_Sub41_5.method22394(4, (byte) 15);
			this.aClass93_Sub41_5.method22454(0, 2141522626);
