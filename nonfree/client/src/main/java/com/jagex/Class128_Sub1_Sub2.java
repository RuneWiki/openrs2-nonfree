...
public class Class128_Sub1_Sub2 extends Class128_Sub1 {
	...
	public void method21394(@OriginalArg(0) int arg0) {
	...
	public void method21395(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public void method21396(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(8) float local8 = -5.0E-4F * (float) ((arg0 & 0x3) + 1);
		@Pc(19) float local19 = (float) ((arg0 >> 3 & 0x3) + 1) * 5.0E-4F;
		@Pc(28) float local28 = (arg0 & 0x40) == 0 ? 4.8828125E-4F : 9.765625E-4F;
		@Pc(36) boolean local36 = (arg0 & 0x80) != 0;
	...
	public void method21398(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(8) float local8 = -5.0E-4F * (float) ((arg0 & 0x3) + 1);
		@Pc(19) float local19 = (float) ((arg0 >> 3 & 0x3) + 1) * 5.0E-4F;
		@Pc(28) float local28 = (arg0 & 0x40) == 0 ? 4.8828125E-4F : 9.765625E-4F;
		@Pc(36) boolean local36 = (arg0 & 0x80) != 0;
