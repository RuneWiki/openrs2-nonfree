...
public class Class50 {
	...
	public static void method984(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		Class271.method26305(0, aClass154_Sub1Array1.length - 1, arg0, arg1, arg2, arg3, 564292647);
		anInt195 = 0;
		aClass678_1 = null;
	}
	...
	public static void method985() {
		...
		while (true) {
			while (anInt195 * -1020006083 < Class361.anInt4571 * 977343673) {
				@Pc(27) Class154_Sub1 local27 = Class367.method27961(anInt195 * -1020006083, (byte) -69);
				if (local27 != null && local27.anInt1655 * 1280583823 == -1) {
					if (aClass678_1 == null) {
						aClass678_1 = client.aClass698_1.method36698(local27.aString46, (byte) 1);
					}
	...
	public static void method986() {
		...
		while (true) {
			while (anInt195 * -1020006083 < Class361.anInt4571 * 977343673) {
				@Pc(27) Class154_Sub1 local27 = Class367.method27961(anInt195 * -1020006083, (byte) 18);
				if (local27 != null && local27.anInt1655 * 1280583823 == -1) {
					if (aClass678_1 == null) {
						aClass678_1 = client.aClass698_1.method36698(local27.aString46, (byte) 1);
					}
	...
	static void method988(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		...
		Class271.method26305(arg0, local10 - 1, arg2, arg3, arg4, arg5, 123146387);
		Class271.method26305(local10 + 1, arg1, arg2, arg3, arg4, arg5, 200281112);
	}
	...
	public static void method989(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		...
		aClass28_2.anInt100 = Class250.method25956(Class280.aClass693_1, Class703.aClass703_2, aClass28_2.anInt101 * 2142901097, -1608230696) * -1138615973;
		aClass28_2.anInt99 = Class654.method32719(Class280.aClass693_1, Class703.aClass703_2, aClass28_2.anInt101 * 2142901097, -986600748) * 702279345;
	}
	...
	public static void method990() {
		...
		while (true) {
			while (anInt195 * -1020006083 < Class361.anInt4571 * 977343673) {
				@Pc(27) Class154_Sub1 local27 = Class367.method27961(anInt195 * -1020006083, (byte) 60);
				if (local27 != null && local27.anInt1655 * 1280583823 == -1) {
					if (aClass678_1 == null) {
						aClass678_1 = client.aClass698_1.method36698(local27.aString46, (byte) 1);
					}
	...
	public static void method991() {
		if (Class94.aClass28_7.anInt101 * 2142901097 != -1) {
			Class624.method32158(Class94.aClass28_7.anInt101 * 2142901097, Class94.aClass28_7.aString4, Class94.aClass28_7.anInt100 * 721448659, Class94.aClass28_7.anInt99 * -1815897519, -1021247143);
		}
	}
	...
	static int method996(@OriginalArg(0) Class154_Sub1 arg0, @OriginalArg(1) Class154_Sub1 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		@Pc(6) int local6 = Class243.method25890(arg0, arg1, arg2, arg3, (byte) -26);
		if (local6 != 0) {
			return arg3 ? -local6 : local6;
		} else if (arg4 == -1) {
			return 0;
		} else {
			@Pc(28) int local28 = Class243.method25890(arg0, arg1, arg4, arg5, (byte) -127);
	...
	public static Class154_Sub1 method997() {
		return Class367.method27961(aClass28_5.anInt101 * 2142901097, (byte) 93);
	}

	@OriginalMember(owner = "client!abz", name = "ae", descriptor = "()Lclient!alc;", line = 105)
	public static Class154_Sub1 method998() {
		return Class367.method27961(aClass28_5.anInt101 * 2142901097, (byte) 29);
	}
	...
	public static void method999(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		Class271.method26305(0, aClass154_Sub1Array1.length - 1, arg0, arg1, arg2, arg3, 1494819559);
		anInt195 = 0;
		aClass678_1 = null;
	}
	...
	public static void method1000(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		Class271.method26305(0, aClass154_Sub1Array1.length - 1, arg0, arg1, arg2, arg3, 1753091934);
		anInt195 = 0;
		aClass678_1 = null;
	}
	...
	public static void method1001() {
		if (Class94.aClass28_7.anInt101 * 2142901097 != -1) {
			Class624.method32158(Class94.aClass28_7.anInt101 * 2142901097, Class94.aClass28_7.aString4, Class94.aClass28_7.anInt100 * 721448659, Class94.aClass28_7.anInt99 * -1815897519, -1553384514);
		}
	}
	...
	static int method1002(@OriginalArg(0) Class154_Sub1 arg0, @OriginalArg(1) Class154_Sub1 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		@Pc(6) int local6 = Class243.method25890(arg0, arg1, arg2, arg3, (byte) -12);
		if (local6 != 0) {
			return arg3 ? -local6 : local6;
		} else if (arg4 == -1) {
			return 0;
		} else {
			@Pc(28) int local28 = Class243.method25890(arg0, arg1, arg4, arg5, (byte) -23);
			return arg5 ? -local28 : local28;
		}
	}
	...
	static int method1003(@OriginalArg(0) Class154_Sub1 arg0, @OriginalArg(1) Class154_Sub1 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		@Pc(6) int local6 = Class243.method25890(arg0, arg1, arg2, arg3, (byte) -90);
		if (local6 != 0) {
			return arg3 ? -local6 : local6;
		} else if (arg4 == -1) {
			return 0;
		} else {
			@Pc(28) int local28 = Class243.method25890(arg0, arg1, arg4, arg5, (byte) -76);
			return arg5 ? -local28 : local28;
		}
	}
	...
	public static void method1004(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		...
		aClass28_2.aString4 = arg0;
		aClass28_2.anInt101 = (arg1 + 1099) * 470002905;
		aClass28_2.anInt100 = Class250.method25956(Class280.aClass693_1, Class703.aClass703_2, aClass28_2.anInt101 * 2142901097, 635696343) * -1138615973;
		aClass28_2.anInt99 = Class654.method32719(Class280.aClass693_1, Class703.aClass703_2, aClass28_2.anInt101 * 2142901097, 1731024311) * 702279345;
	}
	...
	static int method1005(@OriginalArg(0) Class154_Sub1 arg0, @OriginalArg(1) Class154_Sub1 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		...
		if (arg2 == 1) {
			...
			return Class488.method29821(arg0.method14154((byte) -85), arg1.method14154((byte) -37), Class106.aClass717_8, -826026012);
		} else if (arg2 == 3) {
			if (arg0.aString47.equals("-")) {
				...
				return Class488.method29821(arg0.aString47, arg1.aString47, Class106.aClass717_8, -1981895540);
			}
		} else if (arg2 == 4) {
