...
public class Class50 {
	...
	public static void method985() {
		...
		while (true) {
			while (anInt195 * -1020006083 < Class361.anInt4571 * 977343673) {
				@Pc(27) Class154_Sub1 local27 = Class367.method27961(anInt195 * -1020006083);
				if (local27 != null && local27.anInt1655 * 1280583823 == -1) {
					if (aClass678_1 == null) {
						aClass678_1 = client.aClass698_1.method36698(local27.aString46);
					}
	...
	public static void method989(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		...
		aClass28_2.anInt100 = Class250.method25956(Class280.aClass693_1, Class703.aClass703_2, aClass28_2.anInt101 * 2142901097) * -1138615973;
		aClass28_2.anInt99 = Class654.method32719(Class280.aClass693_1, Class703.aClass703_2, aClass28_2.anInt101 * 2142901097) * 702279345;
	}
	...
	public static void method991() {
		if (Class94.aClass28_7.anInt101 * 2142901097 != -1) {
			Class624.method32158(Class94.aClass28_7.anInt101 * 2142901097, Class94.aClass28_7.aString4, Class94.aClass28_7.anInt100 * 721448659, Class94.aClass28_7.anInt99 * -1815897519);
		}
	}
	...
	public static Class154_Sub1 method997() {
		return Class367.method27961(aClass28_5.anInt101 * 2142901097);
	}
	...
	public static void method984(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		Class271.method26305(0, aClass154_Sub1Array1.length - 1, arg0, arg1, arg2, arg3);
		anInt195 = 0;
		aClass678_1 = null;
	}
	...
	static void method988(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		...
		for (@Pc(26) int local26 = arg0; local26 < arg1; local26++) {
			if (Class288.method26548(aClass154_Sub1Array1[local26], local14, arg2, arg3, arg4, arg5) <= 0) {
		...
		Class271.method26305(arg0, local10 - 1, arg2, arg3, arg4, arg5);
		Class271.method26305(local10 + 1, arg1, arg2, arg3, arg4, arg5);
	}
	...
	static int method996(@OriginalArg(0) Class154_Sub1 arg0, @OriginalArg(1) Class154_Sub1 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		@Pc(6) int local6 = Class243.method25890(arg0, arg1, arg2, arg3);
		if (local6 != 0) {
			return arg3 ? -local6 : local6;
		} else if (arg4 == -1) {
			return 0;
		} else {
			@Pc(28) int local28 = Class243.method25890(arg0, arg1, arg4, arg5);
