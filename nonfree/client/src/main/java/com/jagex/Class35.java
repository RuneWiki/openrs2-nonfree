...
public class Class35 {
	...
	static final void method686(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		if (local32.aString11.equals(local26)) {
			arg0.method26862(local12, 602703457);
		} else {
			arg0.method26911(local12, local26, 1744495686);
		}
	}

	@OriginalMember(owner = "client!abh", name = "lf", descriptor = "(Ljava/lang/String;Ljava/lang/String;I)V", line = 12029)
	public static final void method687(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		@Pc(2) Class175 local2 = Class330.method27372(-1607413619);
		@Pc(8) Class93_Sub22 local8 = Class102.method2592(Class446.aClass446_102, local2.aClass24_2, (byte) 73);
		if (arg1.length() > 30) {
			arg1 = arg1.substring(0, 30);
		}
		local8.aClass93_Sub41_Sub2_1.method22510(Class46.method894(arg0, -1758564069) + Class46.method894(arg1, -1948018325), (byte) -24);
		local8.aClass93_Sub41_Sub2_1.method22402(arg1, -543354089);
		local8.aClass93_Sub41_Sub2_1.method22402(arg0, 832412331);
		local2.method24351(local8, -1632121537);
	}

	@OriginalMember(owner = "client!abh", name = "kl", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;S)V", line = 6820)
	static final void method688(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) short arg3) {
