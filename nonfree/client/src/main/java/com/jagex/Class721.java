...
public class Class721 implements Interface75 {
	...
	static final int method36921(@OriginalArg(0) Class132_Sub1_Sub1_Sub1 arg0) {
		...
		if (arg0.anInt2772 * -583289569 != -1) {
			...
			if (local15 != null) {
				local63 = Class472.method29574(arg0.method24229().aClass472_61, local15.method24229().aClass472_61);
				@Pc(67) int local67 = (int) local63.aFloat317;
				local71 = (int) local63.aFloat319;
				if (local67 != 0 || local71 != 0) {
					arg0.method19951((int) (Math.atan2((double) local67, (double) local71) * 2607.5945876176133D) & 0x3FFF);
				}
			}
		}
		if (arg0 instanceof Class132_Sub1_Sub1_Sub1_Sub2) {
			...
			if (local95.anInt2799 * 1643784853 != -1 && (local95.anInt2763 * -846948133 == 0 || local95.anInt2791 * 938318279 > 0)) {
				local95.method19951(local95.anInt2799 * 1643784853);
			...
			if (local129.anInt2642 * 310344423 != -1 && (local129.anInt2763 * -846948133 == 0 || local129.anInt2791 * 938318279 > 0)) {
				local63 = local129.method24229().aClass472_61;
				@Pc(154) Class611 local154 = client.aClass532_1.method30443();
				...
				if (local71 != 0 || local192 != 0) {
					local129.method19951((int) (Math.atan2((double) local71, (double) local192) * 2607.5945876176133D) & 0x3FFF);
				}
				local129.anInt2642 = -757135575;
			}
		}
		return arg0.method19990();
	}
}
