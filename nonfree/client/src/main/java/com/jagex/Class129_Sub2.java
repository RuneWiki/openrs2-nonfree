...
public class Class129_Sub2 extends Class129 {
	...
	void method21471(@OriginalArg(0) Graphics arg0) {
		@Pc(13) int local13 = this.this$0.method27886(this.anImage5.getWidth(null)) + this.anInt2994 * -228338075;
		@Pc(27) int local27 = this.this$0.method27882(this.anImage5.getHeight(null)) + this.anInt2995 * 1110069385;
