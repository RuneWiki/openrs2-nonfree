...
public class Class371 {
	...
	static final void method28000(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		if (arg0.anInt3970 * 532402067 == -1 && !arg1.aBoolean708) {
			Class542.method30937(arg0.anInt3953 * -1549590237, (byte) 85);
		}
	}

	@OriginalMember(owner = "client!jx", name = "aer", descriptor = "(Lclient!yf;I)V", line = 10274)
	static final void method28001(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method28002(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method28003(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	}

	@OriginalMember(owner = "client!jx", name = "m", descriptor = "(B)V", line = 93)
	public static final void method28004(@OriginalArg(0) byte arg0) {
		...
		for (local4 = (Class93_Sub8) Class93_Sub8.aClass22_18.method445((byte) 52); local4 != null; local4 = (Class93_Sub8) Class93_Sub8.aClass22_18.method415(1145395438)) {
			if (local4.aBoolean309) {
				...
				if (local4.anInt1462 * -1824529811 >= 0 && local4.anInt1464 * 275343381 >= 0 && local4.anInt1462 * -1824529811 < client.aClass532_1.method30444(1941313512) && local4.anInt1464 * 275343381 < client.aClass532_1.method30474((short) 128)) {
					Class593.method31720(local4, (byte) 91);
				}
			}
		}
	...
	static final void method28005(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method28008(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		Class328.method27325(arg0, -1497248091);
	}
}
