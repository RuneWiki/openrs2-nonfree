...
public class Class166_Sub25 extends Class166 {
	...
	public int method15887(@OriginalArg(0) int arg0) {
	...
	public void method15888() {
		if (this.anInt2379 * 960141055 != 1 && this.anInt2379 * 960141055 != 0) {
			this.anInt2379 = this.method16542((byte) -22) * -88839937;
		}
	}
	...
	static final void method15890(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(11) Class93_Sub1_Sub13 local11 = Class407.method28583(local7, 1200487767);
		if (local11 == null) {
