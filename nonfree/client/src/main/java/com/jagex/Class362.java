...
public class Class362 {
	...
	public static void method27809() {
		if (aClass370Array1 == null) {
			aClass370Array1 = Class370.method27993(-1391471269);
			Class146.aClass370_3 = aClass370Array1[0];
			Class661.aLong302 = Class305.method26796(-140334059) * -5556977673772728225L;
		}
		if (Class653.aClass357_1 == null) {
			Class393.method28317((byte) 25);
		}
		@Pc(19) Class370 local19 = Class146.aClass370_3;
		@Pc(22) int local22 = Class533.method30604(65280);
		if (Class146.aClass370_3 == local19) {
			...
			if (aBoolean730) {
				aBoolean730 = false;
				Class114.method7634(Class7.aString2, Class490.aString217, "", false, (byte) 107);
			}
		} else {
			...
			if (Class146.aClass370_3.aBoolean737 || local19.aBoolean737) {
				Class661.aLong302 = Class305.method26796(466577794) * -5556977673772728225L;
			}
		}
		if (Class653.aClass357_1 == null) {
			return;
		}
		Class653.aClass357_1.method27735(Class661.aLong302 * 3693219987677404063L, aString187, Class531.aString225, Class66.anInt237 * 1453631867, Class146.aClass370_3, (short) 174);
		if (anInterface30Array1 == null) {
			return;
		}
		for (@Pc(162) int local162 = anInt4573 * 815014065 + 1; local162 < anInterface30Array1.length; local162++) {
			if (anInterface30Array1[local162].method27932(2054591980) >= 100 && local162 - 1 == anInt4573 * 815014065 && client.anInt3435 * -849002901 != 5 && Class653.aClass357_1.method27743((byte) 53)) {
				try {
				...
				Class653.aClass357_1.method27765(anInterface30Array1[local162], (short) 4095);
				anInt4573 += 770058321;
				if (anInt4573 * 815014065 >= anInterface30Array1.length - 1 && anInterface30Array1.length > 1) {
					anInt4573 = (Class363.aClass81_1.method1374(-976903524) ? 0 : -1) * 770058321;
				}
			}
		}
	}
	...
	public static void method27811() {
		...
		Class642.method32522(false, (short) 3093);
		Class283.method26477((byte) 21);
	...
	static void method27813(@OriginalArg(0) byte[] arg0) {
		...
		while (true) {
			@Pc(8) int local8 = local4.method22413((short) 16384);
			if (local8 == 0) {
				return;
			}
			if (local8 == 1) {
				@Pc(19) int local19 = local4.method22415(-1434290800);
				Class274.aClass258_1.method26054(local19, -961237108);
			}
		}
	}
	...
	public static void method27815() {
		if (aClass370Array1 == null) {
			aClass370Array1 = Class370.method27993(-1442929899);
			Class146.aClass370_3 = aClass370Array1[0];
			Class661.aLong302 = Class305.method26796(1876477783) * -5556977673772728225L;
		}
		if (Class653.aClass357_1 == null) {
			Class393.method28317((byte) 61);
		}
		@Pc(19) Class370 local19 = Class146.aClass370_3;
		@Pc(22) int local22 = Class533.method30604(65280);
		if (Class146.aClass370_3 == local19) {
			...
			if (aBoolean730) {
				aBoolean730 = false;
				Class114.method7634(Class7.aString2, Class490.aString217, "", false, (byte) 10);
			}
		} else {
			...
			Class66.anInt237 = local19.anInt4592 * 640981761;
			if (Class146.aClass370_3.aBoolean737 || local19.aBoolean737) {
				Class661.aLong302 = Class305.method26796(1271462060) * -5556977673772728225L;
			}
		}
		if (Class653.aClass357_1 == null) {
			return;
		...
		for (@Pc(162) int local162 = anInt4573 * 815014065 + 1; local162 < anInterface30Array1.length; local162++) {
			if (anInterface30Array1[local162].method27932(-752942526) >= 100 && local162 - 1 == anInt4573 * 815014065 && client.anInt3435 * -849002901 != 5 && Class653.aClass357_1.method27743((byte) 57)) {
				try {
					anInterface30Array1[local162].method27923((short) 253);
				} catch (@Pc(196) Exception local196) {
					anInterface30Array1 = null;
				...
				Class653.aClass357_1.method27765(anInterface30Array1[local162], (short) -7125);
				anInt4573 += 770058321;
				if (anInt4573 * 815014065 >= anInterface30Array1.length - 1 && anInterface30Array1.length > 1) {
					anInt4573 = (Class363.aClass81_1.method1374(1078754474) ? 0 : -1) * 770058321;
				}
			}
		}
	}
	...
	public static void method27816() {
		if (aClass370Array1 == null) {
			aClass370Array1 = Class370.method27993(1081343309);
			Class146.aClass370_3 = aClass370Array1[0];
			Class661.aLong302 = Class305.method26796(1277800065) * -5556977673772728225L;
		}
		if (Class653.aClass357_1 == null) {
			Class393.method28317((byte) 23);
		}
		@Pc(19) Class370 local19 = Class146.aClass370_3;
		@Pc(22) int local22 = Class533.method30604(65280);
		if (Class146.aClass370_3 == local19) {
			...
			if (aBoolean730) {
				aBoolean730 = false;
				Class114.method7634(Class7.aString2, Class490.aString217, "", false, (byte) 97);
			}
		} else {
			...
			Class66.anInt237 = local19.anInt4592 * 640981761;
			if (Class146.aClass370_3.aBoolean737 || local19.aBoolean737) {
				Class661.aLong302 = Class305.method26796(-413445587) * -5556977673772728225L;
			}
		}
		if (Class653.aClass357_1 == null) {
			return;
		...
		for (@Pc(162) int local162 = anInt4573 * 815014065 + 1; local162 < anInterface30Array1.length; local162++) {
			if (anInterface30Array1[local162].method27932(1887866878) >= 100 && local162 - 1 == anInt4573 * 815014065 && client.anInt3435 * -849002901 != 5 && Class653.aClass357_1.method27743((byte) 80)) {
				try {
					anInterface30Array1[local162].method27923((short) 253);
				} catch (@Pc(196) Exception local196) {
					anInterface30Array1 = null;
				...
				Class653.aClass357_1.method27765(anInterface30Array1[local162], (short) 3590);
				anInt4573 += 770058321;
				if (anInt4573 * 815014065 >= anInterface30Array1.length - 1 && anInterface30Array1.length > 1) {
					anInt4573 = (Class363.aClass81_1.method1374(-1779074111) ? 0 : -1) * 770058321;
				}
			}
		}
	}
	...
	public static void method27817(@OriginalArg(0) boolean arg0) {
		if (Class653.aClass357_1 == null) {
			Class393.method28317((byte) 34);
		}
		if (arg0) {
			Class653.aClass357_1.method27731(-508395535);
		}
	}
	...
	static void method27818() {
		if (Class146.aClass370_3 != null) {
			...
			Class653.aClass357_1.method27735(Class661.aLong302 * 3693219987677404063L, Class146.aClass370_3.aClass74_177.method1259(Class106.aClass717_8, (byte) -29), Class146.aClass370_3.aClass74_177.method1259(Class106.aClass717_8, (byte) -92), Class146.aClass370_3.anInt4591 * 903713925, Class146.aClass370_3, (short) 174);
	...
	public static void method27819(@OriginalArg(0) boolean arg0) {
		if (Class653.aClass357_1 == null) {
			Class393.method28317((byte) 60);
		}
		if (arg0) {
			Class653.aClass357_1.method27731(711179283);
		}
	}
	...
	public static void method27820(@OriginalArg(0) boolean arg0) {
		if (Class653.aClass357_1 == null) {
			Class393.method28317((byte) 39);
		}
		if (arg0) {
			Class653.aClass357_1.method27731(1311931947);
		}
	}
	...
	public static void method27821(@OriginalArg(0) boolean arg0) {
		if (Class653.aClass357_1 == null) {
			Class393.method28317((byte) 124);
		}
		if (arg0) {
			Class653.aClass357_1.method27731(-666797119);
		}
	}

	@OriginalMember(owner = "client!ji", name = "ae", descriptor = "()I", line = 319)
	public static int method27822() {
		return Class653.aClass357_1.method27732(609014385);
	}
	...
	static void method27823(@OriginalArg(0) byte[] arg0) {
		...
		while (true) {
			...
			if (local8 == 1) {
				@Pc(19) int local19 = local4.method22415(-1434290800);
				Class274.aClass258_1.method26054(local19, -1255540297);
			}
		}
	}
	...
	public static int method27824() {
		return Class653.aClass357_1.method27732(1571062404);
	}
	...
	static int method27831() {
		@Pc(6) int local6;
		if (Class51.aClass93_Sub36_1.aClass166_Sub45_1.method16505((byte) -58) == 0) {
			for (local6 = 0; local6 < client.anInt3448 * -1523148821; local6++) {
				if (client.anInterface66Array2[local6].method13686((byte) -99) == 's' || client.anInterface66Array2[local6].method13686((byte) -89) == 'S') {
					...
					Class481.method29755(Class73.aClass73_9, -467876514);
					break;
				}
			}
		}
		if (Class370.aClass370_15 == Class146.aClass370_3) {
			...
			Class293.method26588(0, (String) null, true, 1352080022);
			aBoolean729 = !Class319.method27222((byte) 110);
		...
		if (Class370.aClass370_13 == Class146.aClass370_3) {
			local115 = Class7.aClass497_1.method30061(-1097982280);
			@Pc(119) boolean local119 = Class222.aClass497_97.method30061(-1788404118);
			local127 = Class569.aClass143_Sub1Array2[Class31.aClass31_28.method629(1426127376)].method11071(1189701933);
			@Pc(143) int local143 = local127 + Class569.aClass143_Sub1Array2[aBoolean729 ? Class31.aClass31_29.method629(1826386112) : Class31.aClass31_7.method629(1460082278)].method11071(1189701933);
			...
			@Pc(163) int local163 = local153 + (local119 ? 100 : Class222.aClass497_97.method30058(-1774909861));
			@Pc(173) int local173 = local163 + (local115 ? 100 : Class7.aClass497_1.method30058(-1774909861));
			if (local173 != 500) {
				return local173 / 5;
			}
			Class93_Sub26.aClass645_15 = new Class645(Class222.aClass497_97);
			Class659.aClass633_1 = new Class633(Class222.aClass497_97);
			Class292.method26580(Class93_Sub26.aClass645_15, (byte) 95);
			@Pc(198) int local198 = Class51.aClass93_Sub36_1.aClass166_Sub38_1.method16321(276510846);
		...
		if (Class146.aClass370_3 == Class370.aClass370_7) {
			Class157.aClass462_2 = new Class462(Class694.aClass104_14, Class17.aClass497_2, Class633.aClass497_137, Class173.method23800(-981389312));
		}
		@Pc(290) int local290;
		if (Class370.aClass370_8 == Class146.aClass370_3) {
			local6 = Class157.aClass462_2.method29256(-1556873080);
			local290 = Class157.aClass462_2.method29239((byte) 16);
			if (local6 < local290) {
		...
		if (Class370.aClass370_9 == Class146.aClass370_3) {
			if (anInterface30Array1 != null && anInterface30Array1.length > 0) {
				...
				if (anInterface30Array1.length > 1 && Class363.aClass81_1.method1374(1556065793) && anInterface30Array1[1].method27932(1569426037) < 100) {
					return 0;
				}
			}
			Class157.aClass462_2.method29236(client.anInterface50_1, 1664109974);
			Class520.method30339(Class694.aClass104_14, 1321684332);
		...
		if (Class370.aClass370_22 == Class146.aClass370_3) {
			...
			Class157.aClass462_2 = new Class462(Class694.aClass104_14, Class110_Sub7.aClass497_22, Class633.aClass497_137, Class173.method23800(1245252651));
		}
		if (Class146.aClass370_3 == Class370.aClass370_11) {
			@Pc(677) byte[] local677 = Class222.aClass497_97.method30059(Class649.aClass649_5.anInt5795 * -51136173, (byte) 93);
			if (local677 == null) {
				return 0;
			}
			Class274.aClass258_1 = new Class258();
			Class274.aClass258_1.method26031(50, 7340032, 228413960);
		...
		if (Class370.aClass370_5 == Class146.aClass370_3) {
			...
			Class27.method585(Class222.aClass497_97.method30059(Class649.aClass649_1.anInt5795 * -51136173, (byte) 24), (byte) -64);
		...
		if (Class370.aClass370_14 == Class146.aClass370_3) {
			if (-742728449 * Class93_Sub26.aClass645_15.anInt5773 != -1 && !Class86.aClass497_15.method30053(Class93_Sub26.aClass645_15.anInt5773 * -742728449, 0, 563965652)) {
				return 99;
			}
			...
			client.aClass532_1.method30449(Class273.aClass32_Sub14_8, 2087680265);
			...
			Class283.method26476(Class200.aClass497_96, Class86.aClass497_15, Class110_Sub7.aClass497_22, Class633.aClass497_137, -1002953568);
			...
			Class624.aClass120_1 = new Class120(Class21.aClass79_Sub1_Sub1_1, Class30.aClass32_Sub16_1, Class336.aClass644_1.method32594(1062924354));
			Class610.method32021(-1539114738);
			Class450.method28938(Class32.aClass32_Sub17_23, 923638569);
			Class120.method8671(Class599.aClass438_1, Class283.aClass444_1, 360743183);
			Class711.method36813(Class86.aClass497_15, Class619.aClass225_8, Class636.anInterface24_10, -1382698815);
			@Pc(1211) Class337 local1211 = new Class337(Class40.aClass497_4.method30071("huffman", "", 1200487767));
			Class339.method27489(local1211, (byte) 7);
		...
		if (Class370.aClass370_20 == Class146.aClass370_3) {
			local6 = Class96_Sub3.method2329(Class110_Sub7.aClass497_22, -615121503) + Class157.aClass462_2.method29267(true, -2009106133);
			local290 = Class15.method213(1309444066) + Class157.aClass462_2.method29239((byte) 16);
			if (local6 < local290) {
				return local6 * 100 / local290;
			}
		}
		if (Class146.aClass370_3 == Class370.aClass370_16) {
			Class159.method14503(Class144_Sub1.aClass497_42, Class710.aClass497_143, Class682.aClass32_Sub1_3, Class692.aClass32_Sub4_3, client.aClass532_1.method30466(1847782911), Class542.aClass32_Sub2_3, Class466.aClass32_Sub20_3, Class624.aClass120_1, Class624.aClass120_1);
		}
		if (Class146.aClass370_3 == Class370.aClass370_17) {
			Class596.aClass113_Sub1_1 = new Class113_Sub1(Class72.aClass79_Sub1_Sub2_2);
			Class605.method31905(-19928304);
			Class266.aClass306_1 = Class166_Sub29.method16069(1398347037);
			Class166_Sub15.aClass497_59.method30065(false, true, (byte) 4);
			Class110_Sub7.aClass497_22.method30065(true, true, (byte) 122);
			Class633.aClass497_137.method30065(true, true, (byte) 64);
			Class40.aClass497_4.method30065(true, true, (byte) 88);
			client.aBoolean603 = true;
		}
		if (Class146.aClass370_3 == Class370.aClass370_18 && Class93_Sub26.aClass645_15.anInt5766 * -221025663 != -1) {
			if (!Class383.method28145(Class93_Sub26.aClass645_15.anInt5766 * -221025663, (int[]) null, 1239101309)) {
				return 0;
			}
			local115 = true;
			for (local290 = 0; local290 < Class166_Sub1.aClass320Array1[Class93_Sub26.aClass645_15.anInt5766 * -221025663].aClass312Array3.length; local290++) {
				...
				if (local1343.anInt3971 * -158526639 == 5 && local1343.anInt3995 * -1566573331 != -1 && !Class110_Sub7.aClass497_22.method30053(local1343.anInt3995 * -1566573331, 0, 1661098302)) {
					local115 = false;
				}
			}
			if (!local115) {
		...
		if (Class146.aClass370_3 == Class370.aClass370_6) {
			Class653.aClass357_1.method27742((byte) -36);
			try {
				aThread6.join();
			...
			client.aBoolean595 = Class51.aClass93_Sub36_1.aClass166_Sub45_1.method16505((byte) 0) == 1;
			...
			if (client.aBoolean595) {
				...
				if (!client.aBoolean606) {
					Class481.method29755(Class73.aClass73_10, -1763069906);
				}
			} else {
				Class543.method30948(Class51.aClass93_Sub36_1.aClass166_Sub4_1.method15424((byte) 95), false, 1945646779);
				if (Class51.aClass93_Sub36_1.aClass166_Sub4_1.method15424((byte) 84) == 0) {
					Class481.method29755(Class73.aClass73_11, -855862138);
				}
			}
			Class717.method36895(Class51.aClass93_Sub36_1.aClass166_Sub23_1.method15844(1474666360), -1, -1, false, (byte) 106);
			Class157.aClass462_2.method29236(client.anInterface50_1, 1664109974);
			Class520.method30339(Class694.aClass104_14, 780062317);
			Class379.method28101(Class694.aClass104_14, Class110_Sub7.aClass497_22, 1001975439);
		}
		return Class300.method26717(-1299130735);
	}
	...
	static void method27832(@OriginalArg(0) byte[] arg0) {
		...
		while (true) {
			...
			if (local8 == 1) {
				@Pc(19) int local19 = local4.method22415(-1434290800);
				Class274.aClass258_1.method26054(local19, 962574703);
			}
		}
	}
	...
	public static int method27833() {
		return Class653.aClass357_1.method27732(1934465735);
	}
	...
	static void method27835(@OriginalArg(0) byte[] arg0) {
		...
		while (true) {
			...
			if (local8 == 1) {
				@Pc(19) int local19 = local4.method22415(-1434290800);
				Class274.aClass258_1.method26054(local19, -637073210);
			}
		}
	}
	...
	public static int method27838() {
		return Class653.aClass357_1.method27732(1393454301);
	}
	...
	public static void method27840() {
		...
		Class7.aString2 = Class411.aString200;
		Class490.aString217 = Class411.aString201;
		Class642.method32522(false, (short) 17177);
		Class283.method26477((byte) -34);
		aClass370Array1 = null;
		Class275.aClass496_1 = null;
		Class481.method29756(5, 1823202236);
	}
	...
	public static void method27841() {
		if (Class653.aClass357_1 != null) {
			Class653.aClass357_1.method27742((byte) -76);
		}
		if (aThread6 == null) {
			return;
		}
	...
	static final void method27842(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		arg0.anObjectArray28 = Class499.method30148(local13, arg2, -160433659);
		arg0.aBoolean680 = true;
	}

	@OriginalMember(owner = "client!ji", name = "agd", descriptor = "(Lclient!yf;I)V", line = 10694)
	static final void method27843(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method27844(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub8_1.method15528((short) 22102);
	}

	@OriginalMember(owner = "client!ji", name = "awe", descriptor = "(Lclient!yf;B)V", line = 13737)
	static final void method27845(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method27847(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		@Pc(13) String local13 = (String) arg2.anObjectArray45[(arg2.anInt5888 -= 957530791) * 587908375];
		if (Class532.method30597(local13, arg2, 1518522314) != null) {
			local13 = local13.substring(0, local13.length() - 1);
		}
		Class499.method30148(local13, arg2, 333482014);
	}

	@OriginalMember(owner = "client!ji", name = "m", descriptor = "(JIZB)Ljava/lang/String;", line = 59)
	static String method27848(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) byte arg3) {
