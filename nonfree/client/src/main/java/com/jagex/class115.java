...
public class class115 implements class685 {
	...
	@ObfuscatedName("dt.e")
	public static final class115 field1296 = new class115(0, 0, (String) null, 0);

	@ObfuscatedName("dt.n")
	public static final class115 field1292 = new class115(1, 1, (String) null, 3);

	@ObfuscatedName("dt.m")
	public static final class115 field1297 = new class115(2, 2, (String) null, 3);

	@ObfuscatedName("dt.k")
	public static final class115 field1291 = new class115(3, 3, (String) null, 6);

	@ObfuscatedName("dt.f")
	public static final class115 field1294 = new class115(4, 4, (String) null, 1);
