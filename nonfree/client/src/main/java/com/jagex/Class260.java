...
class Class260 implements Interface58 {
	...
	public void method26350(@OriginalArg(0) Object arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) Object[] arg2, @OriginalArg(3) byte arg3) {
		...
		@Pc(6) Class472 local6 = local2.method30806((short) -3064);
		@Pc(10) float local10 = local2.method30847(-1910177998);
		@Pc(14) float local14 = local2.method30808((byte) 1);
		@Pc(19) Class472 local19 = this.this$0.method26030(-1778975888);
		@Pc(23) Class472 local23 = Class472.method29574(local6, local19);
		@Pc(25) float local25 = 0.0F;
		@Pc(27) int local27 = 8192;
		@Pc(30) float local30 = local23.method29565();
	...
	public void method26351(@OriginalArg(0) Object arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) Object[] arg2) {
		@Pc(2) Class539 local2 = (Class539) arg0;
		@Pc(6) Class472 local6 = local2.method30806((short) -6079);
		@Pc(10) float local10 = local2.method30847(1481058266);
		@Pc(14) float local14 = local2.method30808((byte) 1);
		@Pc(19) Class472 local19 = this.this$0.method26030(-877387327);
		@Pc(23) Class472 local23 = Class472.method29574(local6, local19);
		@Pc(25) float local25 = 0.0F;
		@Pc(27) int local27 = 8192;
		@Pc(30) float local30 = local23.method29565();
	...
	public void method26352(@OriginalArg(0) Object arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) Object[] arg2) {
		@Pc(2) Class539 local2 = (Class539) arg0;
		@Pc(6) Class472 local6 = local2.method30806((short) -26723);
		@Pc(10) float local10 = local2.method30847(1487184598);
		@Pc(14) float local14 = local2.method30808((byte) 1);
		@Pc(19) Class472 local19 = this.this$0.method26030(-990702853);
		@Pc(23) Class472 local23 = Class472.method29574(local6, local19);
		@Pc(25) float local25 = 0.0F;
		@Pc(27) int local27 = 8192;
		@Pc(30) float local30 = local23.method29565();
	...
	public static void method26153(@OriginalArg(0) int arg0) {
		...
		Class51.aClass93_Sub36_1.method14357(Class51.aClass93_Sub36_1.aClass166_Sub12_1, Class332.aClass332_6.anInt4147 * 595334117, (byte) 67);
		...
		Class610.method32021(286513806);
		client.aClass532_1.method30532((byte) 79).method33003(-51699213);
	...
	static final void method26155(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	}
	...
	public static boolean method26157(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		if (arg0 == null) {
			return false;
		}
	...
	public static Class332 method26158(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		@Pc(2) Class332[] local2 = Class25_Sub1.method15995(-15550298);
	...
	static final void method26159(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub24_1.method15865(1045625469);
	}
