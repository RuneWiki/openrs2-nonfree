...
public class Class110_Sub7 extends Class110 {
	...
	Class110_Sub7(@OriginalArg(0) Class93_Sub41 arg0) {
		super(arg0);
		this.anInt908 = arg0.method22415() * -1675416095;
		this.anInt906 = arg0.method22415() * -307172735;
		this.aString28 = arg0.method22427();
		this.anInt907 = arg0.method22419() * 1048079171;
		this.anInt909 = arg0.method22415() * -1986684691;
	}

	@OriginalMember(owner = "client!agd", name = "f", descriptor = "()V", line = 23)
	@Override
	public void method20140() {
		Class586.method31638(Class512.anInt5209 * 1177442423, this.anInt908 * -1732389343, this.anInt906 * 2071811457, Class305.method26801(this.anInt908 * -1732389343, this.anInt906 * 2071811457, Class512.anInt5209 * 1177442423), this.anInt909 * 1294238949, this.anInt907 * 1147009387, this.aString28);
	}
	...
	static Class132_Sub1_Sub1_Sub1 method7943(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(10) Class572 local10 = client.aClass532_1.method30459().aClass572ArrayArrayArray3[arg0][arg1][arg2];
		if (local10 == null) {
			return null;
		}
		...
		for (@Pc(21) Class590 local21 = local10.aClass590_1; local21 != null; local21 = local21.aClass590_2) {
			...
			if (local27 instanceof Class132_Sub1_Sub1_Sub1) {
				...
				@Pc(43) int local43 = (local33.method19997() - 1) * 256 + 252;
	...
	static final void method7944(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class696.method36649(local16, local22, arg0);
	}
}
