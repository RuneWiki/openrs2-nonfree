...
public class Class110_Sub7 extends Class110 {
	...
	public void method20140() {
		Class586.method31638(Class512.anInt5209 * 1177442423, this.anInt908 * -1732389343, this.anInt906 * 2071811457, Class305.method26801(this.anInt908 * -1732389343, this.anInt906 * 2071811457, Class512.anInt5209 * 1177442423, (byte) -114), this.anInt909 * 1294238949, this.anInt907 * 1147009387, this.aString28, -1341391550);
	}

	@OriginalMember(owner = "client!agd", name = "n", descriptor = "(I)V", line = 23)
	@Override
	public void method20138(@OriginalArg(0) int arg0) {
		Class586.method31638(Class512.anInt5209 * 1177442423, this.anInt908 * -1732389343, this.anInt906 * 2071811457, Class305.method26801(this.anInt908 * -1732389343, this.anInt906 * 2071811457, Class512.anInt5209 * 1177442423, (byte) -71), this.anInt909 * 1294238949, this.anInt907 * 1147009387, this.aString28, -1341391550);
	}

	@OriginalMember(owner = "client!agd", name = "<init>", descriptor = "(Lclient!alw;)V", line = 14)
	Class110_Sub7(@OriginalArg(0) Class93_Sub41 arg0) {
		super(arg0);
		this.anInt908 = arg0.method22415(-1434290800) * -1675416095;
		this.anInt906 = arg0.method22415(-1434290800) * -307172735;
		this.aString28 = arg0.method22427(1044052563);
		this.anInt907 = arg0.method22419(-118643075) * 1048079171;
		this.anInt909 = arg0.method22415(-1434290800) * -1986684691;
	}
	...
	static Class132_Sub1_Sub1_Sub1 method7943(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(10) Class572 local10 = client.aClass532_1.method30459(-910933729).aClass572ArrayArrayArray3[arg0][arg1][arg2];
		if (local10 == null) {
			return null;
		}
		...
		for (@Pc(21) Class590 local21 = local10.aClass590_1; local21 != null; local21 = local21.aClass590_2) {
			...
			if (local27 instanceof Class132_Sub1_Sub1_Sub1) {
				...
				@Pc(43) int local43 = (local33.method19997(-1772760255) - 1) * 256 + 252;
				@Pc(47) Class472 local47 = local33.method24229().aClass472_61;
	...
	static final void method7944(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1161216956);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class696.method36649(local16, local22, arg0, 1726868414);
	}
}
