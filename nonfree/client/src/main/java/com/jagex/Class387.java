...
public class Class387 implements Interface75 {
	...
	static void method28242(@OriginalArg(0) short arg0) {
	...
	static final void method28243(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static int method28244(@OriginalArg(0) Interface23 arg0, @OriginalArg(1) Interface11 arg1, @OriginalArg(2) byte arg2) {
		@Pc(1) int local1 = 0;
		for (@Pc(3) int local3 = 0; local3 < arg1.method18262(182453511); local3++) {
			...
			if (local14.method27584(arg0, -458136851)) {
	...
	static final void method28245(@OriginalArg(0) int arg0) {
			...
			if (client.anInt3485 > local10.anInt3260 * -887925359) {
				...
				if (local10.anInt3263 * -1986528751 > 0) {
					if (client.anInt3463 * 1819062465 == 0) {
						@Pc(52) Class132_Sub1_Sub1_Sub1 local52 = Class249.aClass239Array1[local10.anInt3263 * -1986528751 - 1].method25807(1211361205);
						if (local52 != null) {
							@Pc(58) Class472 local58 = local52.method24229().aClass472_61;
							if ((int) local58.aFloat317 >= 0 && (int) local58.aFloat317 < client.aClass532_1.method30444(-953249206) * 512 && (int) local58.aFloat319 >= 0 && (int) local58.aFloat319 < client.aClass532_1.method30474((short) 128) * 512) {
								local10.method23913((int) local58.aFloat317, (int) local58.aFloat319, Class305.method26801((int) local58.aFloat317, (int) local58.aFloat319, local52.aByte100, (byte) -64) - local10.anInt3258 * 1286439089, client.anInt3485, 149362265);
							}
						}
					} else {
						...
						if (local121 != null) {
							...
							if ((int) local131.aFloat317 >= 0 && (int) local131.aFloat317 < client.aClass532_1.method30444(1489824965) * 512 && (int) local131.aFloat319 >= 0 && (int) local131.aFloat319 < client.aClass532_1.method30474((short) 128) * 512) {
								local10.method23913((int) local131.aFloat317, (int) local131.aFloat319, Class305.method26801((int) local131.aFloat317, (int) local131.aFloat319, local10.aByte100, (byte) -102) - local10.anInt3258 * 1286439089, client.anInt3485, -2057917338);
							}
						}
					}
				}
				if (local10.anInt3263 * -1986528751 < 0) {
					...
					if (local202 != null) {
						...
						if ((int) local131.aFloat317 >= 0 && (int) local131.aFloat317 < client.aClass532_1.method30444(-992582904) * 512 && (int) local131.aFloat319 >= 0 && (int) local131.aFloat319 < client.aClass532_1.method30474((short) 128) * 512) {
							local10.method23913((int) local131.aFloat317, (int) local131.aFloat319, Class305.method26801((int) local131.aFloat317, (int) local131.aFloat319, local10.aByte100, (byte) -38) - local10.anInt3258 * 1286439089, client.anInt3485, -216685054);
						}
					}
				}
				local10.method23920(client.anInt3480 * 1820654295, 2124873095);
				client.aClass532_1.method30459(-978430498).method31497(local10, true, -2048479155);
			}
		}
	}
}
