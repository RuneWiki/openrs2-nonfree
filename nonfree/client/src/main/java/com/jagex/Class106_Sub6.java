...
public class Class106_Sub6 extends Class106 {
	...
	Class106_Sub6(@OriginalArg(0) Class104_Sub2 arg0, @OriginalArg(1) Class5 arg1, @OriginalArg(2) Class105 arg2, @OriginalArg(3) boolean arg3) {
		...
		if (arg3) {
			...
			@Pc(162) int[] local162;
			if (arg2.method7154()) {
				@Pc(159) Class105_Sub2 local159 = (Class105_Sub2) arg2;
				local162 = local159.anIntArray82;
				@Pc(165) byte[] local165 = local159.aByteArray26;
				@Pc(168) byte[] local168 = local159.aByteArray25;
				if (local165 == null) {
		...
		for (local77 = 0; local77 < 256; local77++) {
			@Pc(352) short[] local352 = this.aClass5_10.method65(local77);
			...
			@Pc(414) int local414 = this.aClass5_10.method62(local77);
			@Pc(420) int local420 = this.aClass5_10.method33(local77);
	...
	void method7544(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		...
		if (this.aClass104_Sub2_5.method21266() != Class401.aClass401_3) {
			@Pc(12) int local12 = arg2 + this.aClass5_10.method64(arg0);
			@Pc(19) float local19 = (float) this.aClass5_10.method62(arg0);
			local26 = this.aClass5_10.method33(arg0);
		...
		local26 = this.aClass104_Sub2_5.method20434().method23736();
		@Pc(103) float local103 = (float) this.aClass104_Sub2_5.method20434().method23737();
