...
public class Class513 {
	...
	Class513(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) BigInteger arg1, @OriginalArg(2) BigInteger arg2) {
		...
		arg0.method22430(local26, 0, local26.length, (short) 4299);
		@Pc(40) byte[] local40;
		...
		@Pc(77) byte[] local77 = Class53_Sub1.method14953(arg0.aByteArray58, 5, arg0.anInt3070 * 212851357 - local26.length - 5, 573616195);
		@Pc(79) int local79;
		...
		for (local79 = 0; local79 < local8; local79++) {
			...
			@Pc(117) int local117 = arg0.method22419(-118643075);
			@Pc(121) int local121 = arg0.method22419(-118643075);
			@Pc(125) int local125 = arg0.method22419(-118643075);
			@Pc(129) int local129 = arg0.method22419(-118643075);
			@Pc(132) byte[] local132 = new byte[64];
			arg0.method22430(local132, 0, 64, (short) 4470);
	...
	static final void method30264(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method30265(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		client.anInt3458 = 0;
		client.anInt3472 = 0;
		client.anInt3445 += 538413373;
		Class579.method31371(-585921143);
		Class279.method26447(arg0, (byte) 49);
		Class466.method29328(-165946142);
		...
		for (local18 = 0; local18 < client.anInt3458 * 1235627729; local18++) {
			...
			if (local37.anInt2786 * -1429700591 != client.anInt3445 * -1933011435) {
				if (Class454.aBoolean773 && Class568.method31298(local27, (byte) 16)) {
					Class436.method28811(-916881791);
				}
				if (local37.aClass336_1.method27432((short) 2402)) {
					Class665.method32895(local37, -222919382);
				}
				local37.method18589((Class336) null, -1526757401);
		...
		if (local16) {
			...
			if (local134 == Class338.aClass338_4) {
				...
				local142.method16472(-2005412477);
			}
		}
