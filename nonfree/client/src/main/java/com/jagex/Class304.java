...
public class Class304 {
	...
	public String method26745(@OriginalArg(0) int arg0) {
		return this.aString159;
	}

	@OriginalMember(owner = "client!gy", name = "m", descriptor = "(IB)V", line = 62)
	void method26746(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	...
	public int method26748(@OriginalArg(0) byte arg0) {
	...
	public int method26750(@OriginalArg(0) short arg0) {
	...
	public Class301 method26752(@OriginalArg(0) short arg0) {
		return this.aClass301_5;
	}

	@OriginalMember(owner = "client!gy", name = "z", descriptor = "(Lclient!gv;I)V", line = 86)
	void method26753(@OriginalArg(0) Class301 arg0, @OriginalArg(1) int arg1) {
	...
	long method26756(@OriginalArg(0) int arg0) {
		return this.aLong255 * 1667669230986612213L;
	}

	@OriginalMember(owner = "client!gy", name = "r", descriptor = "(I)Z", line = 102)
	public boolean method26757(@OriginalArg(0) int arg0) {
		return this.aBoolean678;
	}

	@OriginalMember(owner = "client!gy", name = "v", descriptor = "(IB)Lclient!xz;", line = 106)
	public Class675 method26758(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		return this.aClass675Array2[arg0];
	}

	@OriginalMember(owner = "client!gy", name = "o", descriptor = "(Lclient!gy;I)V", line = 110)
	void method26759(@OriginalArg(0) Class304 arg0, @OriginalArg(1) int arg1) {
		for (@Pc(1) int local1 = 0; local1 < this.aClass675Array2.length; local1++) {
			this.aClass675Array2[local1].method33137(arg0.aClass675Array2[local1].method33152(-562477546), 1461935256);
			this.aClass675Array2[local1].method33141(this.aClass675Array2[local1].method33138(-593897075), 479175137);
		}
	...
	public void method26760(@OriginalArg(0) Interface27 arg0, @OriginalArg(1) byte arg1) {
		if (this.aClass40_3 == null) {
	...
	public Class40 method26761(@OriginalArg(0) int arg0) {
	...
	void method26764(@OriginalArg(0) boolean arg0, @OriginalArg(1) byte arg1) {
	...
	void method26776(@OriginalArg(0) Class304 arg0) {
		for (@Pc(1) int local1 = 0; local1 < this.aClass675Array2.length; local1++) {
			this.aClass675Array2[local1].method33137(arg0.aClass675Array2[local1].method33152(740705030), -1090041296);
			this.aClass675Array2[local1].method33141(this.aClass675Array2[local1].method33138(-823858861), 479175137);
		}
	...
	Class304(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Interface27 arg3) {
		if (arg1) {
			this.aLong255 = arg0.method22423(498727567) * 5817403946560140893L;
		} else {
			this.aLong255 = -5817403946560140893L;
		}
		if (arg2) {
			this.aString159 = arg0.method22426((byte) 45);
		}
		@Pc(25) int local25 = arg0.method22413((short) 16384);
		this.aBoolean678 = (local25 & 0x1) != 0;
		this.aBoolean677 = (local25 & 0x2) != 0;
		this.aClass675Array2 = new Class675[arg3.method25531((byte) 2).method32594(773227642)];
		@Pc(56) int local56 = arg0.method22413((short) 16384);
		if (local56 > this.aClass675Array2.length) {
			throw new IllegalStateException("");
		}
		@Pc(68) int local68;
		for (local68 = 0; local68 < this.aClass675Array2.length; local68++) {
			@Pc(89) Class675 local89 = this.aClass675Array2[local68] = new Class675(arg3.method25531((byte) 2).method32588(local68, (byte) 24), true);
			if (local68 < local56) {
				local89.method33137(arg0.method22419(-118643075), -1199731471);
			} else {
				local89.method33137(0, 729579119);
			}
			local89.method33141(local89.method33138(708553628), 479175137);
		}
		local68 = arg0.method22415(-1434290800);
		this.aClass40_2 = new Class40(arg3.method25539((byte) -2));
		for (@Pc(125) int local125 = 0; local125 < local68; local125++) {
			@Pc(135) Class466 local135 = arg3.method25539((byte) -13).method1463(arg0, (byte) 72);
			this.aClass40_2.method776(local135.anInt5092 * -1181855333, local135.anObject19, (byte) 53);
		}
		this.anInt3935 = arg0.method22415(-1434290800) * 557760827;
		if (this.anInt3935 * -1735233549 == 65535) {
			this.anInt3935 = -557760827;
		}
		this.anInt3937 = arg0.method22413((short) 16384) * -979420629;
		this.aClass301_5 = (Class301) Class107.method18119(Class301.method26728(1436235082), arg0.method22413((short) 16384), -1915563430);
		this.anInt3939 = arg0.method22413((short) 16384) * 1646854503;
	}
	...
	public boolean method26786(@OriginalArg(0) byte arg0) {
		return this.aBoolean677;
	}
	...
	void method26787(@OriginalArg(0) Class304 arg0) {
		for (@Pc(1) int local1 = 0; local1 < this.aClass675Array2.length; local1++) {
			this.aClass675Array2[local1].method33137(arg0.aClass675Array2[local1].method33152(188338854), -323050857);
			this.aClass675Array2[local1].method33141(this.aClass675Array2[local1].method33138(-682555343), 479175137);
		}
	...
	void method26792(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	static final void method26794(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
	...
	static boolean method26795(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
