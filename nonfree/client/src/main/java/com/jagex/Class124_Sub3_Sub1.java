...
public class Class124_Sub3_Sub1 extends Class124_Sub3 {
	...
	void method21447(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(16) int local16 = 0; local16 < arg1; local16++) {
			this.aFloatArray54[local16] = arg0.method22425(-82763124);
			this.aFloatArray53[local16] = arg0.method22425(56958792);
			this.aFloatArray55[local16] = arg0.method22425(2013091547);
		}
	}
	...
	void method21446(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		this.anInt2757 = 0;
		for (@Pc(16) int local16 = 0; local16 < arg1; local16++) {
			this.aFloatArray54[local16] = arg0.method22425(-487088661);
			this.aFloatArray53[local16] = arg0.method22425(2132499431);
			this.aFloatArray55[local16] = arg0.method22425(1442566832);
		}
	}
	...
	void method21436(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) short arg2) {
		...
		this.anInt2757 = 0;
		for (@Pc(16) int local16 = 0; local16 < arg1; local16++) {
			this.aFloatArray54[local16] = arg0.method22425(708077696);
			this.aFloatArray53[local16] = arg0.method22425(460868765);
			this.aFloatArray55[local16] = arg0.method22425(1002758382);
		}
	}
