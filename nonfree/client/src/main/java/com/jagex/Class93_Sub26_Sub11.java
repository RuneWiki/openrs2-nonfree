...
public class Class93_Sub26_Sub11 extends Class93_Sub26 {
	...
	void method21991(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
		this.anInt3040 = arg0.method22419(-118643075) * 747782121;
		this.anInt3041 = arg0.method22419(-118643075) * -1756715163;
	}
	...
	void method21992(@OriginalArg(0) Class386 arg0, @OriginalArg(1) int arg1) {
		arg0.method28179(this.anInt3040 * -1458272167, this.anInt3041 * 849425005, -1322514559);
	}
	...
	void method21994(@OriginalArg(0) Class386 arg0) {
		arg0.method28179(this.anInt3040 * -1458272167, this.anInt3041 * 849425005, -1328927281);
	}

	@OriginalMember(owner = "client!art", name = "f", descriptor = "(Lclient!kr;)V", line = 263)
	@Override
	void method21990(@OriginalArg(0) Class386 arg0) {
		arg0.method28179(this.anInt3040 * -1458272167, this.anInt3041 * 849425005, -1494115294);
	}

	@OriginalMember(owner = "client!art", name = "w", descriptor = "(Lclient!kr;)V", line = 263)
	@Override
	void method21995(@OriginalArg(0) Class386 arg0) {
		arg0.method28179(this.anInt3040 * -1458272167, this.anInt3041 * 849425005, -881684525);
	}
