...
public final class Class78 {
	...
	public void method1303(@OriginalArg(0) Object arg0, @OriginalArg(1) Object arg1) {
		if (arg0 == null) {
	...
	public static void method1317(@OriginalArg(0) int arg0) {
		if (arg0 < 1) {
	...
	public static int method1316(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (Class93_Sub26.aClass645_15.anInt5773 * -742728449 == -1) {
			return 1;
		}
		if (arg0 != Class51.aClass93_Sub36_1.aClass166_Sub4_2.method15424()) {
			Class704.method36732(arg0, Class74.aClass74_100.method1259(Class106.aClass717_8), true);
			if (Class51.aClass93_Sub36_1.aClass166_Sub4_2.method15424() != arg0) {
				return -1;
			}
		}
		try {
			@Pc(32) Dimension local32 = Class125_Sub3.aCanvas1.getSize();
			Class95.method1801(Class74.aClass74_100.method1259(Class106.aClass717_8), true, Class694.aClass104_14, Class82.aClass106_1, Class348.aClass5_14);
			@Pc(50) Class231 local50 = Class231.method25655(Class86.aClass497_15, Class93_Sub26.aClass645_15.anInt5773 * -742728449, 0);
			@Pc(53) long local53 = Class305.method26796();
			Class694.aClass104_14.method20466();
			client.aClass470_51.method29385(0.0F, 256.0F, 0.0F);
			Class694.aClass104_14.method20516(client.aClass470_51);
			@Pc(66) Class489 local66 = Class694.aClass104_14.method20507();
			local66.method29936((float) (local32.width / 2), (float) (local32.height / 2), 512.0F, 512.0F, (float) client.aClass532_1.method30476(), (float) client.aClass532_1.method30450(), (float) local32.width, (float) local32.height);
			Class694.aClass104_14.method20519(local66);
			Class694.aClass104_14.method20521(1.0F);
			Class694.aClass104_14.method20522(16777215, 0.5F, 0.5F, 20.0F, -50.0F, 30.0F);
			@Pc(116) Class109 local116 = Class694.aClass104_14.method20510(local50, 2048, 64, 64, 768);
			@Pc(118) int local118 = 0;
			label42: for (@Pc(120) int local120 = 0; local120 < 500; local120++) {
				Class694.aClass104_14.method20774(3, 0);
				for (@Pc(129) int local129 = 15; local129 >= 0; local129--) {
					for (@Pc(133) int local133 = 0; local133 <= local129; local133++) {
						client.aClass470_52.method29385((float) (((float) local133 - (float) local129 / 2.0F) * 512.0F), 0.0F, (float) ((local129 + 1) * 512));
						local116.method6947(client.aClass470_52, null, 0);
						local118++;
						if (Class305.method26796() - local53 >= (long) arg1) {
							break label42;
						}
					}
				}
			}
			Class694.aClass104_14.method20416();
			@Pc(189) long local189 = (long) (local118 * 1000) / (Class305.method26796() - local53);
			Class694.aClass104_14.method20774(3, 0);
			return (int) local189;
	...
	static final void method1315(@OriginalArg(0) Class681 arg0) {
