...
public final class Class78 {
	...
	static final void method1315(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	public static int method1316(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if (arg0 != Class51.aClass93_Sub36_1.aClass166_Sub4_2.method15424((byte) 59)) {
			Class704.method36732(arg0, Class74.aClass74_100.method1259(Class106.aClass717_8, (byte) -116), true, (byte) -18);
			if (Class51.aClass93_Sub36_1.aClass166_Sub4_2.method15424((byte) 116) != arg0) {
				return -1;
			}
		}
		try {
			...
			@Pc(53) long local53 = Class305.method26796(1680301932);
			...
			local66.method29936((float) (local32.width / 2), (float) (local32.height / 2), 512.0F, 512.0F, (float) client.aClass532_1.method30476(-1086647736), (float) client.aClass532_1.method30450(575023203), (float) local32.width, (float) local32.height);
			...
			label42: for (@Pc(120) int local120 = 0; local120 < 500; local120++) {
				...
				for (@Pc(129) int local129 = 15; local129 >= 0; local129--) {
					for (@Pc(133) int local133 = 0; local133 <= local129; local133++) {
						client.aClass470_52.method29385((float) (int) (((float) local133 - (float) local129 / 2.0F) * 512.0F), 0.0F, (float) ((local129 + 1) * 512));
						local116.method6947(client.aClass470_52, (Class241) null, 0);
						local118++;
						if (Class305.method26796(-167998623) - local53 >= (long) arg1) {
							break label42;
						}
					}
				}
			...
			@Pc(189) long local189 = (long) (local118 * 1000) / (Class305.method26796(1104549670) - local53);
			Class694.aClass104_14.method20774(3, 0);
			return (int) local189;
