...
public final class Class285 {
	...
	static final Calendar aCalendar4 = Calendar.getInstance(method26491("Europe/London", (byte) -59));
	...
	public static int method26488(@OriginalArg(0) Date arg0, @OriginalArg(1) TimeZone arg1, @OriginalArg(2) int arg2) {
	...
	static String method26489(@OriginalArg(0) Date arg0, @OriginalArg(1) String arg1, @OriginalArg(2) TimeZone arg2, @OriginalArg(3) Class717 arg3, @OriginalArg(4) int arg4) {
		if (aMap20 == null) {
			aMap20 = new HashMap(7);
			@Pc(9) Class717[] local9 = Class717.method36886(65534);
		...
		if (local37 == null) {
			local37 = new SimpleDateFormat(arg1, arg3.method36889(-1074144717));
		} else {
	...
	static TimeZone method26490(@OriginalArg(0) int arg0) {
		return method26491("Europe/London", (byte) 58);
	}

	@OriginalMember(owner = "client!gd", name = "k", descriptor = "(Ljava/lang/String;B)Ljava/util/TimeZone;", line = 55)
	static TimeZone method26491(@OriginalArg(0) String arg0, @OriginalArg(1) byte arg1) {
	...
	public static int method26492(@OriginalArg(0) Date arg0, @OriginalArg(1) TimeZone arg1, @OriginalArg(2) int arg2) {
		@Pc(2) Calendar local2 = aCalendar4;
		synchronized (aCalendar4) {
			aCalendar4.setTimeZone(arg1);
			aCalendar4.setTime(arg0);
	...
	public static int method26493(@OriginalArg(0) Date arg0, @OriginalArg(1) TimeZone arg1, @OriginalArg(2) int arg2) {
		@Pc(2) Calendar local2 = aCalendar4;
		synchronized (aCalendar4) {
			aCalendar4.setTimeZone(arg1);
			aCalendar4.setTime(arg0);
	...
	public static Date method26495(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public static String method26496(@OriginalArg(0) Date arg0, @OriginalArg(1) String arg1) {
		return method26489(arg0, arg1, method26490(-571647592), Class717.aClass717_15, 389364154);
	}
	...
	public static String method26497(@OriginalArg(0) Date arg0, @OriginalArg(1) String arg1) {
		return method26489(arg0, arg1, method26490(-2014659311), Class717.aClass717_15, 389364154);
	}
	...
	static String method26498(@OriginalArg(0) Date arg0, @OriginalArg(1) String arg1, @OriginalArg(2) TimeZone arg2, @OriginalArg(3) Class717 arg3) {
		...
		@Pc(37) SimpleDateFormat local37 = (SimpleDateFormat) local33.poll();
		if (local37 == null) {
			local37 = new SimpleDateFormat(arg1, arg3.method36889(-205921389));
		} else {
			local37.applyPattern(arg1);
		}
		local37.setTimeZone(arg2);
	...
	static String method26499(@OriginalArg(0) Date arg0, @OriginalArg(1) String arg1, @OriginalArg(2) TimeZone arg2, @OriginalArg(3) Class717 arg3) {
		...
		@Pc(37) SimpleDateFormat local37 = (SimpleDateFormat) local33.poll();
		if (local37 == null) {
			local37 = new SimpleDateFormat(arg1, arg3.method36889(-271368514));
		} else {
			local37.applyPattern(arg1);
		}
		local37.setTimeZone(arg2);
	...
	static String method26501(@OriginalArg(0) Date arg0, @OriginalArg(1) String arg1, @OriginalArg(2) TimeZone arg2, @OriginalArg(3) Class717 arg3) {
		...
		@Pc(37) SimpleDateFormat local37 = (SimpleDateFormat) local33.poll();
		if (local37 == null) {
			local37 = new SimpleDateFormat(arg1, arg3.method36889(-2117295303));
		} else {
			local37.applyPattern(arg1);
		}
		local37.setTimeZone(arg2);
	...
	static TimeZone method26506() {
		return method26491("Europe/London", (byte) -104);
	}
	...
	public static String method26512(@OriginalArg(0) Date arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		return method26489(arg0, arg1, method26490(-897392150), Class717.aClass717_15, 389364154);
	}

	@OriginalMember(owner = "client!gd", name = "l", descriptor = "(I)V", line = 113)
	public static void method26513(@OriginalArg(0) int arg0) {
		Class431.method28774((byte) -67);
		Class655.aClass163_Sub2_1.method14922((short) 9732);
		Class655.aClass163_Sub1_1.method14922((short) 21171);
		...
		if (client.anInt3450 * -938319179 > 0) {
			...
			local17.aClass93_Sub41_Sub2_1.method22454(client.anInt3450 * 541690580, 2125814869);
			for (local26 = 0; local26 < client.anInt3450 * -938319179; local26++) {
				...
				local17.aClass93_Sub41_Sub2_1.method22510(local35.method13696((byte) 0), (byte) -34);
				local17.aClass93_Sub41_Sub2_1.method22394((int) local43, (byte) 26);
			}
			client.aClass175_2.method24351(local17, -1754044428);
		}
		...
		if (client.aBoolean619 && Class655.anInt5808 * 660178843 <= 0) {
			...
			if (Class429.anInt4781 * -1453926679 != 3) {
				...
				local114 = Class155.method15307(local107.aClass471_1, -2086764803) >> 3;
				@Pc(116) short local116 = 1024;
				local26 = (local116 * 3 - (Class230.method25652(local107.aClass471_1, -1876010216) >> 3)) % (local116 * 2);
			} else {
				local114 = 0;
				local26 = 0;
			}
			...
			local153.aClass93_Sub41_Sub2_1.method22454(local114, 2132239081);
			client.aClass175_2.method24351(local153, -1929411858);
		}
		if (Class20.aBoolean10 != Class655.aBoolean861) {
			...
			local17.aClass93_Sub41_Sub2_1.method22510(Class20.aBoolean10 ? 1 : 0, (byte) -87);
			client.aClass175_2.method24351(local17, -1548378459);
		}
		if (!client.aBoolean601) {
			local17 = Class102.method2592(Class446.aClass446_19, client.aClass175_2.aClass24_2, (byte) 76);
			local17.aClass93_Sub41_Sub2_1.method22510(0, (byte) 4);
			...
			local17.aClass93_Sub41_Sub2_1.method22537(local17.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local26, (byte) 90);
			client.aClass175_2.method24351(local17, -1817093601);
			client.aBoolean601 = true;
		}
		if (client.aBoolean602 || Class51.aClass93_Sub36_1.aClass166_Sub4_1.method15424((byte) 79) != 1) {
			return;
		}
		...
		local259.aClass93_Sub41_Sub2_1.method22454(0, 2131881198);
		@Pc(270) int local270 = local259.aClass93_Sub41_Sub2_1.anInt3070 * 212851357;
		if (local253 == null || local253.length == 0) {
			local259.aClass93_Sub41_Sub2_1.method22510(0, (byte) -67);
		} else {
			local259.aClass93_Sub41_Sub2_1.method22510(1, (byte) -68);
			...
			label94: while (true) {
				if (local294 >= local253.length) {
					...
					local259.aClass93_Sub41_Sub2_1.method22652(local292.size(), -888816505);
					if (local292.size() <= 0) {
						break;
					}
					...
					local259.aClass93_Sub41_Sub2_1.method22411(local294, -1464683848);
					...
					while (true) {
						...
						local362 = (Integer) local355.next();
						if (local362 != local294) {
							local259.aClass93_Sub41_Sub2_1.method22411(local362 - local294, -1849944858);
						}
					}
				}
		...
		local259.aClass93_Sub41_Sub2_1.method22407(local259.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local270, -1045912997);
		client.aClass175_2.method24351(local259, -2052901139);
		client.aBoolean602 = true;
	}

	@OriginalMember(owner = "client!gd", name = "ry", descriptor = "(Lclient!yf;B)V", line = 8095)
	static final void method26514(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class375.method28041(local11, local14, arg0, (byte) 13);
	}

	@OriginalMember(owner = "client!gd", name = "xu", descriptor = "(Lclient!yf;I)V", line = 9126)
	static final void method26515(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method26516(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub2_1.method15373((byte) 75) ? 1 : 0;
	}

	@OriginalMember(owner = "client!gd", name = "fw", descriptor = "(I)V", line = 2523)
	static final void method26517(@OriginalArg(0) int arg0) {
		client.anInt3462 = -654237073;
		client.anInt3463 = 1167039939;
		Class36.aClass93_Sub41_1 = null;
		Class287.method26541(-100950526);
	}

	@OriginalMember(owner = "client!gd", name = "ga", descriptor = "(B)V", line = 3628)
	public static final void method26518(@OriginalArg(0) byte arg0) {
