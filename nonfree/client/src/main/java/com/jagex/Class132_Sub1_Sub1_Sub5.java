...
public class Class132_Sub1_Sub1_Sub5 extends Class132_Sub1_Sub1 {
	...
	Class109 method24091(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		return this.aClass19_5 == null || this.aClass19_5.method23581(-1228609165) ? local5.method36664(arg0, arg1, this.anInt3274 * -2021976064, local12, local27, (int) local31.aFloat317, (int) local31.aFloat318, (int) local31.aFloat319, (Class19) null, (byte) 2, (byte) -35) : local5.method36664(arg0, arg1, this.anInt3274 * -2021976064, local12, local27, (int) local31.aFloat317, (int) local31.aFloat318, (int) local31.aFloat319, this.aClass19_5, (byte) 2, (byte) 13);
	}
	...
	public int method24092(@OriginalArg(0) int arg0) {
	...
	public final void method24093(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.aClass19_5 != null && !this.aClass19_5.method23581(-1228609165)) {
			this.aClass19_5.method23573(arg0, -1000778064);
		}
	}

	@OriginalMember(owner = "client!aur", name = "k", descriptor = "(I)Z", line = 77)
	public final boolean method24094(@OriginalArg(0) int arg0) {
		return this.aClass19_5 == null || this.aClass19_5.method23581(-1228609165);
	}
	...
	Class109 method24095(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		@Pc(5) Class697 local5 = (Class697) Class501.aClass32_Sub18_1.method18261(arg2, 926486655);
		@Pc(12) Class99 local12 = this.aClass585_23.aClass99Array2[this.aByte100];
		@Pc(27) Class99 local27 = this.aByte99 < 3 ? this.aClass585_23.aClass99Array2[this.aByte99 + 1] : null;
		@Pc(31) Class472 local31 = this.method24229().aClass472_61;
		return this.aClass19_5 == null || this.aClass19_5.method23581(-1228609165) ? local5.method36664(arg0, arg1, this.anInt3274 * -2021976064, local12, local27, (int) local31.aFloat317, (int) local31.aFloat318, (int) local31.aFloat319, (Class19) null, (byte) 2, (byte) 90) : local5.method36664(arg0, arg1, this.anInt3274 * -2021976064, local12, local27, (int) local31.aFloat317, (int) local31.aFloat318, (int) local31.aFloat319, this.aClass19_5, (byte) 2, (byte) -12);
	}
	...
	Class573 method24271(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		@Pc(19) Class109 local19 = this.method24095(arg0, (this.anInt3274 * 1104211811 == 0 ? 0 : 5) | 0x800, this.anInt3276 * -1612299705, (byte) -40);
		if (local19 == null) {
			return null;
		}
		@Pc(26) Class470 local26 = this.method24226();
		this.method24097(arg0, local19, local26, (byte) 100);
	...
	void method24267(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		@Pc(9) Class109 local9 = this.method24095(arg0, 0, this.anInt3276 * -1612299705, (byte) -109);
		if (local9 != null) {
			this.method24097(arg0, local9, this.method24226(), (byte) 49);
		}
	}
	...
	public void method24096(@OriginalArg(0) byte arg0) {
		if (this.aClass674_5 != null) {
	...
	void method24097(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class109 arg1, @OriginalArg(2) Class470 arg2, @OriginalArg(3) byte arg3) {
	...
	public final boolean method24098(@OriginalArg(0) int arg0) {
		return this.aClass19_5 != null && !this.aClass19_5.method23561((byte) 0);
	}
	...
	Class573 method24266(@OriginalArg(0) Class104 arg0) {
		@Pc(19) Class109 local19 = this.method24095(arg0, (this.anInt3274 * 1104211811 == 0 ? 0 : 5) | 0x800, this.anInt3276 * -1612299705, (byte) -74);
		if (local19 == null) {
			return null;
		}
		@Pc(26) Class470 local26 = this.method24226();
		this.method24097(arg0, local19, local26, (byte) 65);
		@Pc(36) Class573 local36 = Class125_Sub1.method9214(false, 373147274);
		local19.method6947(local26, this.aClass241Array21[0], 0);
		if (this.aClass674_5 != null) {
			@Pc(52) Class229 local52 = this.aClass674_5.method33127();
	...
	void method24294(@OriginalArg(0) Class104 arg0) {
		@Pc(9) Class109 local9 = this.method24095(arg0, 0, this.anInt3276 * -1612299705, (byte) -31);
		if (local9 != null) {
			this.method24097(arg0, local9, this.method24226(), (byte) 125);
		}
	}
	...
	void method24303(@OriginalArg(0) Class104 arg0) {
		@Pc(9) Class109 local9 = this.method24095(arg0, 0, this.anInt3276 * -1612299705, (byte) -23);
		if (local9 != null) {
			this.method24097(arg0, local9, this.method24226(), (byte) 43);
		}
	}
	...
	Class109 method24106(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(27) Class99 local27 = this.aByte99 < 3 ? this.aClass585_23.aClass99Array2[this.aByte99 + 1] : null;
		@Pc(31) Class472 local31 = this.method24229().aClass472_61;
		return this.aClass19_5 == null || this.aClass19_5.method23581(-1228609165) ? local5.method36664(arg0, arg1, this.anInt3274 * -2021976064, local12, local27, (int) local31.aFloat317, (int) local31.aFloat318, (int) local31.aFloat319, (Class19) null, (byte) 2, (byte) -93) : local5.method36664(arg0, arg1, this.anInt3274 * -2021976064, local12, local27, (int) local31.aFloat317, (int) local31.aFloat318, (int) local31.aFloat319, this.aClass19_5, (byte) 2, (byte) 1);
	}
	...
	Class109 method24107(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(27) Class99 local27 = this.aByte99 < 3 ? this.aClass585_23.aClass99Array2[this.aByte99 + 1] : null;
		@Pc(31) Class472 local31 = this.method24229().aClass472_61;
		return this.aClass19_5 == null || this.aClass19_5.method23581(-1228609165) ? local5.method36664(arg0, arg1, this.anInt3274 * -2021976064, local12, local27, (int) local31.aFloat317, (int) local31.aFloat318, (int) local31.aFloat319, (Class19) null, (byte) 2, (byte) 86) : local5.method36664(arg0, arg1, this.anInt3274 * -2021976064, local12, local27, (int) local31.aFloat317, (int) local31.aFloat318, (int) local31.aFloat319, this.aClass19_5, (byte) 2, (byte) 19);
	}
	...
	Class109 method24108(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(27) Class99 local27 = this.aByte99 < 3 ? this.aClass585_23.aClass99Array2[this.aByte99 + 1] : null;
		@Pc(31) Class472 local31 = this.method24229().aClass472_61;
		return this.aClass19_5 == null || this.aClass19_5.method23581(-1228609165) ? local5.method36664(arg0, arg1, this.anInt3274 * -2021976064, local12, local27, (int) local31.aFloat317, (int) local31.aFloat318, (int) local31.aFloat319, (Class19) null, (byte) 2, (byte) 30) : local5.method36664(arg0, arg1, this.anInt3274 * -2021976064, local12, local27, (int) local31.aFloat317, (int) local31.aFloat318, (int) local31.aFloat319, this.aClass19_5, (byte) 2, (byte) 71);
	}
	...
	public Class132_Sub1_Sub1_Sub5(@OriginalArg(0) Class585 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) boolean arg13, @OriginalArg(14) int arg14) {
		...
		if (local54 != -1) {
			...
			this.aClass19_5.method23559(local54, arg2, local71, false, (short) -7862);
		}
		this.method24276(1, 371646378);
	}
