...
public class Class62 {
	...
	public static int method1138(@OriginalArg(0) Random arg0, @OriginalArg(1) int arg1) {
		...
		if (arg1 <= 0) {
		...
		} else if (Class364.method27900(arg1, -1431357474)) {
			...
			return Class580.method31387(local60, arg1, (byte) -91);
		}
	}
	...
	public static int method1142(@OriginalArg(0) Random arg0, @OriginalArg(1) int arg1) {
		...
		if (arg1 <= 0) {
			throw new IllegalArgumentException();
		} else if (Class364.method27900(arg1, -1356672725)) {
			return (int) (((long) arg0.nextInt() & 0xFFFFFFFFL) * (long) arg1 >> 32);
		} else {
			@Pc(57) int local57 = Integer.MIN_VALUE - (int) (4294967296L % (long) arg1);
			@Pc(60) int local60;
			...
			return Class580.method31387(local60, arg1, (byte) -66);
		}
	}
	...
	static final void method1152(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class618.method32099((byte) -21).method36920();
	}
