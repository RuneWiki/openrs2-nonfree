...
public abstract class Class124_Sub3 extends Class124 {
	...
	public void method21432(@OriginalArg(0) Class479 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(3) int arg3) {
		if (this.aClass479Array5 == null) {
			this.aClass479Array5 = new Class479[] { arg0 };
			this.aFloatArray70 = new float[] { arg2 };
			this.anIntArray257 = new int[] { arg1 };
	...
	public void method21414(@OriginalArg(0) float arg0, @OriginalArg(1) int[][][] arg1, @OriginalArg(2) Class520 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		@Pc(63) float local63 = 1.0F / (float) Class451.method28948((byte) 3);
		while (arg0 > 0.0F) {
			...
			while (arg0 > 0.0F && this.aFloat219 < local70) {
				this.aFloat220 = this.method21434(local70, this.aFloat220, Math.min(arg0, local63), (byte) -45);
				arg0 -= local63;
				this.method21433(this.aFloat220, local70, 31361810);
			}
		}
	}

	@OriginalMember(owner = "client!ahn", name = "ae", descriptor = "(FFI)V", line = 89)
	void method21433(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2) {
		this.aFloat219 += arg0;
	...
	abstract float method21434(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) byte arg3);

	@OriginalMember(owner = "client!ahn", name = "ah", descriptor = "(I)V")
	abstract void method21435(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!ahn", name = "v", descriptor = "()Lclient!akt;", line = 114)
	@Override
	public Class93_Sub30 method21412() {
		@Pc(3) Class472 local3 = this.method21402((byte) 41);
	...
	public void method21406(@OriginalArg(0) Class368 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		@Pc(3) Class472 local3 = this.method21402((byte) 121);
	...
	public void method21407(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		this.aFloat220 = 0.0F;
		this.anInt2979 = 0;
		@Pc(12) int local12 = arg0.method22413((short) 16384);
		...
		for (@Pc(22) int local22 = 0; local22 < local12; local22++) {
			...
			this.aFloatArray70[local22] = arg0.method22425(-1895027303);
		}
		this.method21436(arg0, local12, (short) -8989);
	}

	@OriginalMember(owner = "client!ahn", name = "ac", descriptor = "(Lclient!alw;IS)V")
	abstract void method21436(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) short arg2);
	...
	public void method21419(@OriginalArg(0) float arg0, @OriginalArg(1) int[][][] arg1, @OriginalArg(2) Class520 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		while (arg0 > 0.0F) {
			...
			while (arg0 > 0.0F && this.aFloat219 < local70) {
				this.aFloat220 = this.method21434(local70, this.aFloat220, Math.min(arg0, local63), (byte) -38);
				arg0 -= local63;
				this.method21433(this.aFloat220, local70, 517440481);
			}
		}
	}
	...
	public void method21422(@OriginalArg(0) float arg0, @OriginalArg(1) int[][][] arg1, @OriginalArg(2) Class520 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		while (arg0 > 0.0F) {
			...
			while (arg0 > 0.0F && this.aFloat219 < local70) {
				this.aFloat220 = this.method21434(local70, this.aFloat220, Math.min(arg0, local63), (byte) -19);
				arg0 -= local63;
				this.method21433(this.aFloat220, local70, 1314729891);
			}
		}
	}
	...
	public void method21421(@OriginalArg(0) float arg0, @OriginalArg(1) int[][][] arg1, @OriginalArg(2) Class520 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) byte arg5) {
		...
		while (arg0 > 0.0F) {
			...
			while (arg0 > 0.0F && this.aFloat219 < local70) {
				this.aFloat220 = this.method21434(local70, this.aFloat220, Math.min(arg0, local63), (byte) -16);
				arg0 -= local63;
				this.method21433(this.aFloat220, local70, 320129103);
			}
		}
	}
	...
	public Class93_Sub30 method21420() {
		@Pc(3) Class472 local3 = this.method21402((byte) 105);
		return new Class93_Sub30(0, (int) local3.aFloat317, (int) local3.aFloat318, (int) local3.aFloat319);
	}
	...
	public void method21417(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		for (@Pc(22) int local22 = 0; local22 < local12; local22++) {
			this.aClass479Array5[local22] = new Class479(arg0);
			this.aFloatArray70[local22] = arg0.method22425(694032064);
		}
		this.method21436(arg0, local12, (short) -6904);
	}

	@OriginalMember(owner = "client!ahn", name = "o", descriptor = "()Lclient!akt;", line = 114)
	@Override
	public Class93_Sub30 method21410() {
		@Pc(3) Class472 local3 = this.method21402((byte) 70);
		return new Class93_Sub30(0, (int) local3.aFloat317, (int) local3.aFloat318, (int) local3.aFloat319);
	}
	...
	public float method21445(@OriginalArg(0) int arg0) {
		return this.aClass479Array5[this.anInt2979 * -1041839613].method29720(this.aFloat219);
	}
	...
	public void method21418(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		for (@Pc(22) int local22 = 0; local22 < local12; local22++) {
			this.aClass479Array5[local22] = new Class479(arg0);
			this.aFloatArray70[local22] = arg0.method22425(190811027);
		}
		this.method21436(arg0, local12, (short) -26503);
	}

	@OriginalMember(owner = "client!ahn", name = "c", descriptor = "()Lclient!akt;", line = 114)
	@Override
	public Class93_Sub30 method21411() {
		@Pc(3) Class472 local3 = this.method21402((byte) 14);
		return new Class93_Sub30(0, (int) local3.aFloat317, (int) local3.aFloat318, (int) local3.aFloat319);
	}
	...
	public void method21424(@OriginalArg(0) Class368 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(3) Class472 local3 = this.method21402((byte) 80);
		arg0.anInt4586 = ((int) local3.aFloat317 - arg1) * -255666073;
		arg0.anInt4587 = (int) -local3.aFloat318 * -543294551;
		arg0.anInt4588 = ((int) local3.aFloat319 - arg2) * -513444905;
	}
	...
	public static Class14[] method21453(@OriginalArg(0) int arg0) {
		if (Class53.aClass14Array2 == null) {
			@Pc(6) Class14[] local6 = Class629.method32261(Class556.aClass7_1, -1574654625);
			@Pc(10) Class14[] local10 = new Class14[local6.length];
			@Pc(12) int local12 = 0;
			@Pc(17) int local17 = Class51.aClass93_Sub36_1.aClass166_Sub24_1.method15865(64980131);
			...
			Class107.method18123(local147, Class53.aClass14Array2, 343012351);
		}
		return Class53.aClass14Array2;
	}

	@OriginalMember(owner = "client!ahn", name = "r", descriptor = "(B)Lclient!zg;", line = 142)
	public static Class704 method21454(@OriginalArg(0) byte arg0) {
	...
	public static Class709[] method21455(@OriginalArg(0) int arg0) {
