...
public class Class20 implements Iterator {
	...
	static final void method374(@OriginalArg(0) Class132_Sub1_Sub1_Sub1 arg0) {
		@Pc(6) int local6 = arg0.anInt2780 * -2095106181 - client.anInt3485;
		@Pc(17) int local17 = arg0.anInt2775 * -1016506880 + arg0.method19997() * 256;
		@Pc(28) int local28 = arg0.anInt2777 * -294398464 + arg0.method19997() * 256;
		@Pc(37) int local37 = Class305.method26801(local17, local28, arg0.anInt2773 * -1628091145);
		@Pc(41) Class472 local41 = arg0.method24229().aClass472_61;
		arg0.method24231((float) ((int) local41.aFloat317 + (local17 - (int) local41.aFloat317) / local6), (float) ((int) local41.aFloat318 + (local37 - (int) local41.aFloat318) / local6), (float) ((int) local41.aFloat319 + (local28 - (int) local41.aFloat319) / local6));
		arg0.anInt2791 = 0;
		arg0.method19951(arg0.anInt2782 * -1729677103);
	}

	@OriginalMember(owner = "client!aar", name = "vd", descriptor = "(Lclient!yf;S)V", line = 8858)
	static final void method373(@OriginalArg(0) Class681 arg0) {
		...
		if (local19 != null && local19.anInt3171 * -256237711 == 3) {
			Class372.method28019(local19, true, true);
		}
	}
