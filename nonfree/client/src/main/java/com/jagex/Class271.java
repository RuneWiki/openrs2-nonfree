...
class Class271 implements Interface39 {
	...
	public float method26345(@OriginalArg(0) int arg0) {
		return (float) Class51.aClass93_Sub36_1.aClass166_Sub35_5.method16223(-1130756527) / 255.0F;
	}

	@OriginalMember(owner = "client!fp", name = "n", descriptor = "()F", line = 482)
	@Override
	public float method26346() {
		return (float) Class51.aClass93_Sub36_1.aClass166_Sub35_5.method16223(-142344880) / 255.0F;
	}

	@OriginalMember(owner = "client!fp", name = "ig", descriptor = "(Lclient!yf;B)V", line = 6477)
	static final void method26302(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1871146513);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class183.method24577(local16, local22, arg0, -2019214117);
	}

	@OriginalMember(owner = "client!fp", name = "pb", descriptor = "(Lclient!yf;I)V", line = 7721)
	static final void method26303(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1274641074);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class183.method24573(local16, local22, arg0, -753836288);
	}

	@OriginalMember(owner = "client!fp", name = "ayn", descriptor = "(Lclient!yf;B)V", line = 13980)
	static final void method26304(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static void method26305(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) int arg6) {
		if (arg0 >= arg1) {
			return;
		}
		...
		method26305(arg0, local10 - 1, arg2, arg3, arg4, arg5, 469894424);
		method26305(local10 + 1, arg1, arg2, arg3, arg4, arg5, 223756407);
	}

	@OriginalMember(owner = "client!fp", name = "n", descriptor = "(IB)Lclient!adr;", line = 49)
	public static Class89 method26306(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method26307(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (client.anInt3501 * -446949609 == 1) {
			...
			local20.method18169(local3 - 8, local7 - 8);
		}
