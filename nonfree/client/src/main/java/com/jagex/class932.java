...
public class class932 extends class366 {
	...
	public class932(class656 arg0) {
		...
		while (var4.hasNext()) {
			...
			class480[] var6 = (class480[]) (class480[]) this.field10688.get(var5);
	...
	public void method5874() {
		...
		while (true) {
			...
			do {
				...
				var3 = (class480[]) (class480[]) this.field10688.get(var2);
				if (!var2.field4856) {
					boolean var4 = false;
	...
	public class480 method5865(class473 arg0) {
		...
		synchronized (this.field10688) {
			class480[] var3 = (class480[]) (class480[]) this.field10688.get(arg0);
			if (var3 == null) {
				return null;
			}
