...
public class Class572 {
	...
	public static int method31333(@OriginalArg(0) Class104 arg0) {
	...
	static final void method31334(@OriginalArg(0) Class681 arg0) {
	...
	static void method31335(@OriginalArg(0) Class312 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(4) Class327 local4 = arg0.method26878(Class694.aClass104_14);
		if (local4 == null) {
			return;
		}
		Class694.aClass104_14.method20467(arg1, arg2, arg1 + arg0.anInt3981 * 1215292027, arg0.anInt3982 * -1490598249 + arg2);
		if (Class172.anInt3177 * 910154737 >= 3) {
			Class694.aClass104_14.method20505(-16777216, local4.aClass96_1, arg1, arg2);
			return;
		}
		@Pc(42) int local42;
		if (Class429.anInt4781 * -1453926679 == 3) {
			local42 = (int) -((double) Class65.aClass123_Sub1_2.method8962() * 2607.5945876176133D);
		} else {
			local42 = (int) -client.aFloat253;
		}
		local42 = local42 + client.anInt3477 * 1580280690 & 0x3FFF;
		local42 <<= 0x2;
		Class153.aClass100_18.method18185((float) arg1 + (float) (arg0.anInt3981 * 1215292027) / 2.0F, (float) (arg0.anInt3982 * -1490598249) / 2.0F + (float) arg2, 4226, local42, local4.aClass96_1, arg1, arg2);
	}
}
