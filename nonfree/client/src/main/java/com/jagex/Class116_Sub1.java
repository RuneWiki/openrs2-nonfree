...
public class Class116_Sub1 extends Class116 {
	...
	public boolean method8438() {
		...
		@Pc(112) int local112;
		for (local112 = 0; local112 < this.aClass115_Sub2_1.method8199(); local112++) {
			if (this.aClass115_Sub2_1.method8200(local112) == this) {
				local110 = local112;
				break;
			}
		}
		...
		for (local112 = 0; local112 < this.aClass115_Sub2_1.method8230(); local112++) {
			local149 = this.aClass115_Sub2_1.method8201(local112);
			if (local149 != null) {
				local149.method23651(local110);
			}
		}
		for (local112 = 0; local112 < this.aClass115_Sub2_1.method8231(); local112++) {
			local149 = this.aClass115_Sub2_1.method8228(local112);
			if (local149 != null) {
				local149.method23651(local110);
			}
		}
	...
	void method8444(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) Class489 arg1) {
		assert arg0.method23653() == Class323.aClass323_48;
	...
	void method8466(@OriginalArg(0) Class93_Sub33_Sub1 arg0, @OriginalArg(1) Class489 arg1) {
		assert arg0.method23653() == Class323.aClass323_50;
		@Pc(14) int local14 = ((Class93_Sub33_Sub1_Sub2) arg0).method23668();
		if (local14 != -1) {
