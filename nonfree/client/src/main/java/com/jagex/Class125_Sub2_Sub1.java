...
public class Class125_Sub2_Sub1 extends Class125_Sub2 {
	...
	public static int method21469(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2) {
	...
	static final void method21468(@OriginalArg(0) Class681 arg0) {
		...
		@Pc(31) Class124_Sub1 local31 = (Class124_Sub1) Class65.aClass123_Sub1_2.method8952();
		@Pc(36) Class25_Sub5 local36 = (Class25_Sub5) Class65.aClass123_Sub1_2.method9040();
		@Pc(40) Class472 local40 = local31.method9166();
		@Pc(43) Class472 local43 = Class472.method29530(local40);
		local43.aFloat318 += local12;
		@Pc(56) Class472 local56 = Class472.method29574(local36.method23120(), local43);
		local56.method29559();
		@Pc(63) float local63 = local31.method9167().method29565();
		Class492.method29982(local36.method23120(), local56, local40, local63, Class687.aClass472Array3);
		if (Class687.aClass472Array3[0] == null) {
			throw new RuntimeException("");
		}
		@Pc(92) Class472 local92;
		if (Class687.aClass472Array3[1] == null) {
			local92 = Class687.aClass472Array3[0];
		} else if (Class472.method29574(local36.method23120(), Class687.aClass472Array3[0]).method29565() < Class472.method29574(local36.method23120(), Class687.aClass472Array3[1]).method29565()) {
			local92 = Class687.aClass472Array3[1];
		} else {
			local92 = Class687.aClass472Array3[0];
		}
		@Pc(133) float local133 = Class608.method31959(local40.aFloat317 - local92.aFloat317, local40.aFloat319 - local92.aFloat319);
