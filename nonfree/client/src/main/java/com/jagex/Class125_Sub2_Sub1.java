...
public class Class125_Sub2_Sub1 extends Class125_Sub2 {
	...
	public static Class125 method21467(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(4) Class125_Sub2 local4 = (Class125_Sub2) Class661.method32844(arg0, (byte) 98);
		@Pc(8) int local8 = arg0.method22482((byte) -67);
	...
	static final void method21468(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		local43.aFloat318 += (float) local12;
		@Pc(56) Class472 local56 = Class472.method29574(local36.method23120(-1978084374), local43);
		local56.method29559();
		@Pc(63) float local63 = local31.method9167(-899460710).method29565();
		Class492.method29982(local36.method23120(-2128573944), local56, local40, local63, Class687.aClass472Array3);
		...
		} else if (Class472.method29574(local36.method23120(-1846279988), Class687.aClass472Array3[0]).method29565() < Class472.method29574(local36.method23120(1810058240), Class687.aClass472Array3[1]).method29565()) {
			local73 = Class687.aClass472Array3[1];
		} else {
			local73 = Class687.aClass472Array3[0];
		}
		@Pc(133) float local133 = Class608.method31959(local40.aFloat317 - local73.aFloat317, local40.aFloat319 - local73.aFloat319, -2006917831);
	...
	public static int method21469(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(3) int arg3) {
