...
public class Class648 {
	...
	static final void method32656(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(16) Class312 local16 = Class659.method32805(local12, 398267297);
	...
	static final void method32658(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		@Pc(26) Class611 local26 = client.aClass532_1.method30443(1787132275);
		local18 -= local26.anInt5623 * 270611681;
		if (local18 < 0) {
			local18 = 0;
		} else if (local18 >= client.aClass532_1.method30444(-1267149682)) {
			local18 = client.aClass532_1.method30444(1910607887);
		}
		local22 -= local26.anInt5624 * -1994307635;
		if (local22 < 0) {
			local22 = 0;
		} else if (local22 >= client.aClass532_1.method30474((short) 128)) {
			local22 = client.aClass532_1.method30474((short) 128);
		}
