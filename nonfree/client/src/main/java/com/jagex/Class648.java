...
public class Class648 {
	...
	static final void method32658(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(18) int local18 = local12 >> 14 & 0x3FFF;
		@Pc(22) int local22 = local12 & 0x3FFF;
		@Pc(26) Class611 local26 = client.aClass532_1.method30443();
		local18 -= local26.anInt5623 * 270611681;
		if (local18 < 0) {
			local18 = 0;
		} else if (local18 >= client.aClass532_1.method30444()) {
			local18 = client.aClass532_1.method30444();
		}
		local22 -= local26.anInt5624 * -1994307635;
		if (local22 < 0) {
			local22 = 0;
		} else if (local22 >= client.aClass532_1.method30474()) {
			local22 = client.aClass532_1.method30474();
		}
