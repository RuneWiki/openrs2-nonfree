...
public class Class318 {
	...
	void method27210(@OriginalArg(0) Class326 arg0) {
		this.aString172 = arg0.method27307();
		this.aString170 = arg0.method27307();
		this.aString171 = arg0.method27307();
		@Pc(18) int local18 = arg0.method27306();
		@Pc(22) int local22 = arg0.method27306();
		...
		for (local42 = 0; local42 < local18; local42++) {
			...
			this.aClass309Array1[local42].method26824(arg0);
		}
		for (local42 = 0; local42 < local22; local42++) {
			this.aClass309Array2[local42] = new Class309();
			this.aClass309Array2[local42].method26824(arg0);
		}
	}
	...
	static final void method27212(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
	...
	static final void method27213(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class480.method29750(local12, false);
	}
}
