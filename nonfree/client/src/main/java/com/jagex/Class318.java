...
public class Class318 {
	...
	void method27210(@OriginalArg(0) Class326 arg0, @OriginalArg(1) int arg1) {
		this.aString172 = arg0.method27307(867966216);
		this.aString170 = arg0.method27307(940618055);
		this.aString171 = arg0.method27307(1099444221);
		@Pc(18) int local18 = arg0.method27306(989114354);
		@Pc(22) int local22 = arg0.method27306(2069902156);
	...
	void method27211(@OriginalArg(0) Class326 arg0) {
		this.aString172 = arg0.method27307(1139616875);
		this.aString170 = arg0.method27307(-790536842);
		this.aString171 = arg0.method27307(-2071559287);
		@Pc(18) int local18 = arg0.method27306(1301324530);
		@Pc(22) int local22 = arg0.method27306(317767928);
		this.aClass309Array1 = local18 == 0 ? null : new Class309[local18];
		this.aClass309Array2 = local22 == 0 ? null : new Class309[local22];
		@Pc(42) int local42;
		for (local42 = 0; local42 < local18; local42++) {
	...
	static final void method27213(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class480.method29750(local12, false, (short) -31596);
	}
}
