...
public class Class640 {
	...
	public int method32468(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		...
		return this.method32474(local3, (byte) 112);
	}
	...
	public int method32474(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	...
	int method32476(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	...
	int method32477(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.method32476(arg0, (byte) 8) * 10;
	}
	...
	int method32483(@OriginalArg(0) int arg0) {
		return this.anInt5752 * -1398644273;
	}
	...
	Class640(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Class634 arg5, @OriginalArg(6) int arg6) {
		...
		if (arg2) {
			...
			this.anInt5753 = this.method32477(arg4, 1139625193) * -2085766573;
		} else {
	...
	public boolean method32487(@OriginalArg(0) int arg0) {
		return this.anInt5753 * 1025677787 != -1;
	}
	...
	public int method32489(@OriginalArg(0) int arg0) {
		@Pc(3) int local3 = arg0 / 10;
		return this.method32474(local3, (byte) 102);
	}
	...
	public int method32492(@OriginalArg(0) int arg0) {
		@Pc(3) int local3 = arg0 / 10;
		return this.method32474(local3, (byte) 22);
	}
	...
	static final void method32496(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		if (Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aClass658_1 != null) {
			Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aClass658_1.method32761(local13, local23, -130712985);
		}
	}
