...
public class Class110_Sub6 extends Class110 {
	...
	@Override
	boolean method20141() {
		Class274.aClass258_1.method26122(this.anInt895 * 1457115373, this.anInt896 * -1540749953, -1541526814);
		return true;
	}
	...
	public void method20138(@OriginalArg(0) int arg0) {
		Class274.aClass258_1.method26057(this.anInt895 * 1457115373, 1665204116);
	}

	@OriginalMember(owner = "client!agb", name = "k", descriptor = "(I)Z", line = 21)
	@Override
	boolean method20139(@OriginalArg(0) int arg0) {
		Class274.aClass258_1.method26122(this.anInt895 * 1457115373, this.anInt896 * -1540749953, -1997025870);
		return true;
	}
	...
	@Override
	boolean method20142() {
		Class274.aClass258_1.method26122(this.anInt895 * 1457115373, this.anInt896 * -1540749953, -1423012219);
		return true;
	}
	...
	public void method20140() {
		Class274.aClass258_1.method26057(this.anInt895 * 1457115373, -207516943);
	}

	@OriginalMember(owner = "client!agb", name = "<init>", descriptor = "(Lclient!alw;)V", line = 11)
	Class110_Sub6(@OriginalArg(0) Class93_Sub41 arg0) {
		super(arg0);
		this.anInt895 = arg0.method22415(-1434290800) * 204541157;
		this.anInt896 = arg0.method22413((short) 16384) * 1465367167;
	}
