...
public class Class539 {
	...
	public void method30787(@OriginalArg(0) Interface70 arg0, @OriginalArg(1) int arg1) {
	...
	public void method30791(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		...
		if (arg0 > 0) {
			...
			while (local33.hasNext()) {
				...
				if (local40.method30667(-2087611449) == this) {
					local40.method30636(0.0F, arg0, -37570847);
				} else {
					local33.remove();
				}
			}
	...
	public void method30795(@OriginalArg(0) byte arg0) {
		...
		if (this.aClass536_11 == Class536.aClass536_4 && this.aBoolean800) {
			@Pc(31) Class535 local31 = this.aClass146_3.method11674(this.anInterface70_1.method32531(859157841), (byte) 19);
			if (local31 != null) {
				local38 = this.anInterface70_1.method32527(827202555);
				@Pc(43) Class518 local43 = new Class518(this);
				@Pc(84) boolean local84 = local31.method30638(local38 ? null : this.anInterface70_1.method32529(0, 1643894185), local38 ? local43 : null, this.anInt5283 * 1397727437, this.anInt5284 * 1084945595 > 0 ? 0.0F : this.aFloat331, false, this.aBoolean801, this.anInt5281 * 722478837, this.aFloat333, this, 1221408403);
				if (local84) {
					this.aClass536_11 = Class536.aClass536_5;
					local31.method30687(this.anInterface58_6, -1540719604);
					local31.method30636(this.aFloat331, this.anInt5284 * 1084945595, -37570847);
					local31.method30639(55935924);
					this.aList21.add(local31);
					this.aBoolean800 = false;
				} else {
					if (local31.method30701(-1945830439) == Class511.aClass511_8) {
						this.aClass536_11 = Class536.aClass536_8;
					}
					local31.method30635((byte) 8);
				}
			}
		}
		...
		while (true) {
			while (local131.hasNext()) {
				...
				if (local140.method30667(-2087611449) == this) {
					if (Class536.aClass536_6 == this.aClass536_11) {
						if (local140.method30637(700480837) == 0.0F) {
							local140.method30640(-26842720);
						} else {
							local38 = false;
						}
					}
					if (local140.method30633((byte) -12) || local140.method30732(-511245246)) {
						local140.method30635((byte) 8);
						local131.remove();
					} else {
						local38 = false;
					}
	...
	public boolean method30801(@OriginalArg(0) byte arg0) {
		this.aBoolean802 = false;
		return this.anInt5282 * 1064024733 != 0;
	}

	@OriginalMember(owner = "client!rw", name = "y", descriptor = "(IB)V", line = 254)
	public void method30802(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	...
	public void method30805(@OriginalArg(0) Class472 arg0, @OriginalArg(1) int arg1) {
		this.aClass472_63 = arg0;
	}

	@OriginalMember(owner = "client!rw", name = "h", descriptor = "(S)Lclient!ox;", line = 268)
	public Class472 method30806(@OriginalArg(0) short arg0) {
	...
	public float method30808(@OriginalArg(0) byte arg0) {
		return this.aFloat330;
	}

	@OriginalMember(owner = "client!rw", name = "i", descriptor = "(FB)V", line = 280)
	public void method30809(@OriginalArg(0) float arg0, @OriginalArg(1) byte arg1) {
		this.aFloat332 = arg0;
	}
	...
	public void method30811(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) byte arg2) {
	...
	public void method30815(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		this.aBoolean801 = arg0;
		this.anInt5281 = arg1 * 1557714269;
	}

	@OriginalMember(owner = "client!rw", name = "ac", descriptor = "(FI)V", line = 327)
	public void method30816(@OriginalArg(0) float arg0, @OriginalArg(1) int arg1) {
		if (!(arg0 < 0.0F)) {
			this.aFloat333 = arg0;
		}
	}
	...
	public int method30830(@OriginalArg(0) int arg0) {
		return this.anInt5283 * 1397727437;
	}
	...
	public void method30831() {
		...
		while (local3.hasNext()) {
			@Pc(13) Class535 local13 = (Class535) local3.next();
			if (local13.method30667(-2087611449) == this) {
				local13.method30653(-2112218984);
			}
		}
	}

	@OriginalMember(owner = "client!rw", name = "q", descriptor = "(ZB)V", line = 257)
	public void method30832(@OriginalArg(0) boolean arg0, @OriginalArg(1) byte arg1) {
	}
	...
	public void method30834() {
		...
		while (local3.hasNext()) {
			@Pc(13) Class535 local13 = (Class535) local3.next();
			if (local13.method30667(-2087611449) == this) {
				local13.method30653(1213150922);
			}
		}
	}
	...
	public void method30836() {
		...
		while (local3.hasNext()) {
			@Pc(13) Class535 local13 = (Class535) local3.next();
			if (local13.method30667(-2087611449) == this) {
				local13.method30735(-1475096021);
			}
		}
	}
	...
	public void method30838() {
		...
		@Pc(38) boolean local38;
		if (this.aClass536_11 == Class536.aClass536_4 && this.aBoolean800) {
			@Pc(31) Class535 local31 = this.aClass146_3.method11674(this.anInterface70_1.method32531(-873763613), (byte) 4);
			if (local31 != null) {
				local38 = this.anInterface70_1.method32527(1143490218);
				@Pc(43) Class518 local43 = new Class518(this);
				@Pc(84) boolean local84 = local31.method30638(local38 ? null : this.anInterface70_1.method32529(0, 751327781), local38 ? local43 : null, this.anInt5283 * 1397727437, this.anInt5284 * 1084945595 > 0 ? 0.0F : this.aFloat331, false, this.aBoolean801, this.anInt5281 * 722478837, this.aFloat333, this, 900697747);
				if (local84) {
					this.aClass536_11 = Class536.aClass536_5;
					local31.method30687(this.anInterface58_6, 389589187);
					local31.method30636(this.aFloat331, this.anInt5284 * 1084945595, -37570847);
					local31.method30639(-217573438);
					this.aList21.add(local31);
					this.aBoolean800 = false;
				} else {
					if (local31.method30701(-1697507842) == Class511.aClass511_8) {
						this.aClass536_11 = Class536.aClass536_8;
					}
					local31.method30635((byte) 8);
				}
		...
		while (true) {
			while (local131.hasNext()) {
				...
				if (local140.method30667(-2087611449) == this) {
					if (Class536.aClass536_6 == this.aClass536_11) {
						if (local140.method30637(-743503147) == 0.0F) {
							local140.method30640(-392961540);
						} else {
							local38 = false;
						}
					}
					if (local140.method30633((byte) 46) || local140.method30732(-511245246)) {
						local140.method30635((byte) 8);
						local131.remove();
					} else {
						local38 = false;
	...
	public void method30839() {
		...
		@Pc(38) boolean local38;
		if (this.aClass536_11 == Class536.aClass536_4 && this.aBoolean800) {
			@Pc(31) Class535 local31 = this.aClass146_3.method11674(this.anInterface70_1.method32531(1009769798), (byte) 116);
			if (local31 != null) {
				local38 = this.anInterface70_1.method32527(2045886865);
				@Pc(43) Class518 local43 = new Class518(this);
				@Pc(84) boolean local84 = local31.method30638(local38 ? null : this.anInterface70_1.method32529(0, 536926244), local38 ? local43 : null, this.anInt5283 * 1397727437, this.anInt5284 * 1084945595 > 0 ? 0.0F : this.aFloat331, false, this.aBoolean801, this.anInt5281 * 722478837, this.aFloat333, this, 1980668717);
				if (local84) {
					this.aClass536_11 = Class536.aClass536_5;
					local31.method30687(this.anInterface58_6, -1661705536);
					local31.method30636(this.aFloat331, this.anInt5284 * 1084945595, -37570847);
					local31.method30639(2102025745);
					this.aList21.add(local31);
					this.aBoolean800 = false;
				} else {
					if (local31.method30701(-1999226342) == Class511.aClass511_8) {
						this.aClass536_11 = Class536.aClass536_8;
					}
					local31.method30635((byte) 8);
				}
		...
		while (true) {
			while (local131.hasNext()) {
				...
				if (local140.method30667(-2087611449) == this) {
					if (Class536.aClass536_6 == this.aClass536_11) {
						if (local140.method30637(-2007417145) == 0.0F) {
							local140.method30640(-1094787234);
						} else {
							local38 = false;
						}
					}
					if (local140.method30633((byte) -25) || local140.method30732(-511245246)) {
						local140.method30635((byte) 8);
						local131.remove();
					} else {
						local38 = false;
	...
	public void method30840() {
		...
		@Pc(38) boolean local38;
		if (this.aClass536_11 == Class536.aClass536_4 && this.aBoolean800) {
			@Pc(31) Class535 local31 = this.aClass146_3.method11674(this.anInterface70_1.method32531(1217178029), (byte) 57);
			if (local31 != null) {
				local38 = this.anInterface70_1.method32527(93896837);
				@Pc(43) Class518 local43 = new Class518(this);
				@Pc(84) boolean local84 = local31.method30638(local38 ? null : this.anInterface70_1.method32529(0, 750174722), local38 ? local43 : null, this.anInt5283 * 1397727437, this.anInt5284 * 1084945595 > 0 ? 0.0F : this.aFloat331, false, this.aBoolean801, this.anInt5281 * 722478837, this.aFloat333, this, 1325443871);
				if (local84) {
					this.aClass536_11 = Class536.aClass536_5;
					local31.method30687(this.anInterface58_6, -668552746);
					local31.method30636(this.aFloat331, this.anInt5284 * 1084945595, -37570847);
					local31.method30639(268925977);
					this.aList21.add(local31);
					this.aBoolean800 = false;
				} else {
					if (local31.method30701(-2020195530) == Class511.aClass511_8) {
						this.aClass536_11 = Class536.aClass536_8;
					}
					local31.method30635((byte) 8);
				}
		...
		while (true) {
			while (local131.hasNext()) {
				...
				if (local140.method30667(-2087611449) == this) {
					if (Class536.aClass536_6 == this.aClass536_11) {
						if (local140.method30637(-437375755) == 0.0F) {
							local140.method30640(-56427456);
						} else {
							local38 = false;
						}
					}
					if (local140.method30633((byte) 16) || local140.method30732(-511245246)) {
						local140.method30635((byte) 8);
						local131.remove();
					} else {
						local38 = false;
	...
	public float method30847(@OriginalArg(0) int arg0) {
		return this.aFloat332;
	}
	...
	public void method30852(@OriginalArg(0) int arg0) {
		if (Class536.aClass536_9 == this.aClass536_11 || this.aClass536_11 == Class536.aClass536_10 || Class536.aClass536_7 == this.aClass536_11 || this.aClass536_11 == Class536.aClass536_6) {
			return;
		}
		if ((Class536.aClass536_3 == this.aClass536_11 || Class536.aClass536_4 == this.aClass536_11) && !this.aBoolean800) {
	...
	public void method30855(@OriginalArg(0) boolean arg0) {
	}
	...
	public void method30857(@OriginalArg(0) boolean arg0) {
	}
	...
	public void method30859(@OriginalArg(0) Object arg0, @OriginalArg(1) byte arg1) {
		this.anObject26 = arg0;
	}
	...
	public Object method30869(@OriginalArg(0) int arg0) {
		return this.anObject25;
	}
	...
	public void method30875(@OriginalArg(0) float arg0, @OriginalArg(1) byte arg1) {
		this.aFloat330 = arg0;
	}
	...
	public void method30880(@OriginalArg(0) boolean arg0) {
	}
	...
	static Class302[] method30882(@OriginalArg(0) int arg0) {
	...
	static final boolean method30883(@OriginalArg(0) Class572[][][] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		...
		while (local51 != local58) {
			...
			if (local134) {
				local143 = client.aClass532_1.method30459(-1948542630).aClass99Array1[Class512.anInt5209 * 1177442423 + 1].method2482(local79, local101, -1740548441);
			...
			if (!local117) {
				...
				local101++;
				if (local101 < client.aClass532_1.method30474((short) 128)) {
					...
					if (local79 + 1 < client.aClass532_1.method30444(1277779931) && local14 != local3[Class512.anInt5209 * 1177442423][local79 + 1][local101] && (local31.aByteArrayArrayArray12[Class512.anInt5209 * 1177442423][local79][local101] & 0x4) == 0 && (local31.aByteArrayArrayArray12[Class512.anInt5209 * 1177442423][local79 + 1][local101 - 1] & 0x4) == 0) {
				...
				local101--;
				if (local79 + 1 < client.aClass532_1.method30444(139032878) && local14 != local3[Class512.anInt5209 * 1177442423][local79 + 1][local101]) {
				...
				if (local101 >= 0) {
					...
					if (local79 + 1 < client.aClass532_1.method30444(330584158) && local3[Class512.anInt5209 * 1177442423][local79 + 1][local101] != local14 && (local31.aByteArrayArrayArray12[Class512.anInt5209 * 1177442423][local79][local101] & 0x4) == 0 && (local31.aByteArrayArrayArray12[Class512.anInt5209 * 1177442423][local79 + 1][local101 + 1] & 0x4) == 0) {
