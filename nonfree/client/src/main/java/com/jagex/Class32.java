...
public class Class32 implements Interface11 {
	...
	public Interface13 method18261(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		local11 = this.method17821(arg0, -1291147084);
	...
	public void method17805(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_62;
		synchronized (this.aClass240_62) {
			this.aClass240_62.method25833((byte) -35);
	...
	public void method17806() {
		@Pc(3) Class240 local3 = this.aClass240_62;
		synchronized (this.aClass240_62) {
			this.aClass240_62.method25833((byte) -122);
		}
	}
	...
	public void method17807(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_62;
		synchronized (this.aClass240_62) {
			this.aClass240_62.method25833((byte) -45);
		}
	}
	...
	public void method17808(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class240 local3 = this.aClass240_62;
		synchronized (this.aClass240_62) {
			this.aClass240_62.method25832(arg0, (byte) 12);
		}
	}
	...
	public Interface13 method18264(@OriginalArg(0) int arg0) {
		...
		local11 = this.method17821(arg0, -853962308);
		local3 = this.aClass240_62;
		synchronized (this.aClass240_62) {
			this.aClass240_62.method25830(local11, (long) arg0);
			return local11;
	...
	public Class32(@OriginalArg(0) Class702 arg0, @OriginalArg(1) Class717 arg1, @OriginalArg(2) Class497 arg2, @OriginalArg(3) Class667 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Interface4 arg5) {
		...
		this.anInt2487 = Class546.method30973(this.aClass497_84, this.aClass667_31, (byte) -63) * 418600949;
	...
	public void method17810() {
		@Pc(3) Class240 local3 = this.aClass240_62;
		synchronized (this.aClass240_62) {
			this.aClass240_62.method25833((byte) -44);
		}
	}
	...
	public void method17811(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_62;
		synchronized (this.aClass240_62) {
			this.aClass240_62.method25837(1161602830);
		}
	}
	...
	public Interface13 method18265(@OriginalArg(0) int arg0) {
		...
		local11 = this.method17821(arg0, 822516821);
		local3 = this.aClass240_62;
		synchronized (this.aClass240_62) {
			this.aClass240_62.method25830(local11, (long) arg0);
			return local11;
	...
	public void method17812() {
		@Pc(3) Class240 local3 = this.aClass240_62;
		synchronized (this.aClass240_62) {
			this.aClass240_62.method25833((byte) -33);
		}
	}
	...
	public void method17813() {
		@Pc(3) Class240 local3 = this.aClass240_62;
		synchronized (this.aClass240_62) {
			this.aClass240_62.method25833((byte) -20);
		}
	}
	...
	public void method17814() {
		@Pc(3) Class240 local3 = this.aClass240_62;
		synchronized (this.aClass240_62) {
			this.aClass240_62.method25833((byte) -87);
		}
	}
	...
	public void method17815() {
		@Pc(3) Class240 local3 = this.aClass240_62;
		synchronized (this.aClass240_62) {
			this.aClass240_62.method25833((byte) -123);
		}
	}
	...
	public void method17817(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_62;
		synchronized (this.aClass240_62) {
			this.aClass240_62.method25832(arg0, (byte) 61);
		}
	}
	...
	public void method17818(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_62;
		synchronized (this.aClass240_62) {
			this.aClass240_62.method25832(arg0, (byte) 34);
		}
	}
	...
	public void method17819(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_62;
		synchronized (this.aClass240_62) {
			this.aClass240_62.method25832(arg0, (byte) -63);
		}
	}
	...
	Interface13 method17821(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class497 local3 = this.aClass497_84;
		@Pc(12) byte[] local12;
		synchronized (this.aClass497_84) {
			local12 = Class650.method32669(this.aClass497_84, this.aClass667_31, arg0, -1497248091);
		}
	...
	public void method17822(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class240 local3 = this.aClass240_62;
		synchronized (this.aClass240_62) {
			this.aClass240_62.method25833((byte) -8);
			this.aClass240_62 = new Class240(arg0);
		}
	}
	...
	public void method17825(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_62;
		synchronized (this.aClass240_62) {
			this.aClass240_62.method25832(arg0, (byte) -23);
		}
	}

	@OriginalMember(owner = "client!abe", name = "f", descriptor = "(IIZI)I", line = 69)
	public static int method17826(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3) {
		@Pc(1) int local1 = 0;
		@Pc(6) Class93_Sub6 local6 = Class557.method31065(arg0, arg2, (short) 255);
		if (local6 == null) {
			return 0;
		}
