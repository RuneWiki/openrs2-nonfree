...
public class Class135_Sub3 extends Class135 implements Interface38 {
	...
	Class135_Sub3(@OriginalArg(0) Class104_Sub2_Sub1 arg0, @OriginalArg(1) Class206 arg1, @OriginalArg(2) Class226 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (this.aClass104_Sub2_Sub1_8.aBoolean435) {
			...
			this.anInt1365 = Class134_Sub2.method10212(arg3);
			this.anInt1366 = Class134_Sub2.method10212(arg4);
			this.aFloat137 = (float) arg3 / (float) this.anInt1365;
			this.aFloat138 = (float) arg4 / (float) this.anInt1366;
		}
		this.aLong47 = IDirect3DDevice.CreateTexture(this.aClass104_Sub2_Sub1_8.aLong121, this.anInt1365, this.anInt1366, 0, arg5, Class104_Sub2_Sub1.method19534(this.aClass206_14, this.aClass226_15), arg6);
	}
	...
	Class135_Sub3(@OriginalArg(0) Class104_Sub2_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (this.aClass104_Sub2_Sub1_8.aBoolean435) {
			...
			this.anInt1365 = Class134_Sub2.method10212(arg1);
			this.anInt1366 = Class134_Sub2.method10212(arg2);
			...
			if (arg1 != this.anInt1365 || arg2 != this.anInt1366) {
				arg4 = this.aClass104_Sub2_Sub1_8.method20549(arg1, arg2, this.anInt1365, this.anInt1366, arg4, arg5, arg6);
				arg5 = 0;
				arg6 = this.anInt1365;
			}
		}
		...
		this.aClass104_Sub2_Sub1_8.method20889(arg6 * this.anInt1366 * this.aClass206_14.anInt3389 * -1639868421);
	...
	Class135_Sub3(@OriginalArg(0) Class104_Sub2_Sub1 arg0, @OriginalArg(1) Class206 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) byte[] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		if (this.aClass104_Sub2_Sub1_8.aBoolean435) {
			...
			this.anInt1365 = Class134_Sub2.method10212(arg2);
			this.anInt1366 = Class134_Sub2.method10212(arg3);
			...
			if (arg2 != this.anInt1365 || arg3 != this.anInt1366) {
				arg5 = this.aClass104_Sub2_Sub1_8.method20555(arg2, arg3, this.anInt1365, this.anInt1366, arg5, arg6, arg7, arg1.anInt3389 * -1639868421);
				arg6 = 0;
				arg7 = this.anInt1365;
			}
		}
		if (arg4) {
			this.aLong47 = IDirect3DDevice.CreateTexture(this.aClass104_Sub2_Sub1_8.aLong121, this.anInt1365, this.anInt1366, 0, 1024, Class104_Sub2_Sub1.method19534(this.aClass206_14, Class226.aClass226_22), 1);
		} else {
			this.aLong47 = IDirect3DDevice.CreateTexture(this.aClass104_Sub2_Sub1_8.aLong121, this.anInt1365, this.anInt1366, 1, 0, Class104_Sub2_Sub1.method19534(this.aClass206_14, Class226.aClass226_22), 1);
		}
		if (arg7 == 0) {
			arg7 = this.anInt1365;
		}
		this.aClass104_Sub2_Sub1_8.method20889(arg7 * this.anInt1366 * this.aClass206_14.anInt3389 * -1639868421);
	...
	Class135_Sub3(@OriginalArg(0) Class104_Sub2_Sub1 arg0, @OriginalArg(1) Class206 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) float[] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		if (this.aClass104_Sub2_Sub1_8.aBoolean435) {
			...
			this.aFloat138 = (float) arg3 / (float) this.anInt1366;
			if (arg2 != this.anInt1365 || arg3 != this.anInt1366) {
				arg5 = this.aClass104_Sub2_Sub1_8.method20529(arg2, arg3, this.anInt1365, this.anInt1366, arg5, arg6, arg7, arg1.anInt3389 * -1639868421);
				arg6 = 0;
				arg7 = this.anInt1365;
			}
		}
		if (arg4) {
			this.aLong47 = IDirect3DDevice.CreateTexture(this.aClass104_Sub2_Sub1_8.aLong121, this.anInt1365, this.anInt1366, 0, 1024, Class104_Sub2_Sub1.method19534(this.aClass206_14, Class226.aClass226_19), 1);
		} else {
			this.aLong47 = IDirect3DDevice.CreateTexture(this.aClass104_Sub2_Sub1_8.aLong121, this.anInt1365, this.anInt1366, 1, 0, Class104_Sub2_Sub1.method19534(this.aClass206_14, Class226.aClass226_19), 1);
		}
		if (arg7 == 0) {
			arg7 = this.anInt1365;
		}
		this.aClass104_Sub2_Sub1_8.method20889(arg7 * this.anInt1366 * this.aClass206_14.anInt3389 * -1639868421 * 4);
	...
	public void method11345(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		this.aClass104_Sub2_Sub1_8.method20889(arg6 * arg3 * this.aClass206_14.anInt3389 * -1639868421);
	...
	public void method11356(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte[] arg4, @OriginalArg(5) Class206 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		this.aClass104_Sub2_Sub1_8.method20889(arg7 * arg3 * this.aClass206_14.anInt3389 * -1639868421);
		@Pc(31) ByteBuffer local31 = this.aClass104_Sub2_Sub1_8.aByteBuffer7;
		local31.clear();
	...
	public void method11347(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int arg5) {
		...
		this.aClass104_Sub2_Sub1_8.method20889(arg2 * arg3 * 4);
	...
	public void method11363(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(7) int[] local7 = this.aClass104_Sub2_Sub1_8.method20448(arg4, arg5, arg2, arg3);
		if (local7 != null) {
	...
	public void method11411() {
		this.aClass104_Sub2_Sub1_8.method19525(this);
	}
