...
public abstract class Class112_Sub2 extends Class112 {
	...
	public abstract int method23754(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1);
	...
	abstract void method23756(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1);
	...
	public abstract int method23760(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1);

	@OriginalMember(owner = "client!afy", name = "e", descriptor = "(I)[Lclient!ev;", line = 19)
	static Class252[] method23761(@OriginalArg(0) int arg0) {
