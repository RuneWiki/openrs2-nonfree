...
public class Class495 implements Interface7 {
	...
	public int method30020() {
		return this.aClass497_125.method30061() ? 100 : this.aClass497_125.method30058();
	}
			...
			if (Class125_Sub2_Sub1.aFrame1 == null) {
				...
				if (local11 != null) {
					...
					if (Class694.aClass104_14 != null) {
						Class694.aClass104_14.method20515(Class125_Sub3.aCanvas1, client.anInt3408 * -1378711501, client.anInt3416 * 2091353777);
						Class503.method30187(Class694.aClass104_14, Class305.method26796());
					}
					if (local11 == Class628.aFrame2) {
						local34 = Class628.aFrame2.getInsets();
					...
					Class183.method24575();
					if (client.anInt3526 * -703563959 != -1) {
						Class618.method32101(true);
					}
	...
	static final void method30030(@OriginalArg(0) Class681 arg0) {
		Class274.aClass258_1.method26061();
	}

	@OriginalMember(owner = "client!pw", name = "ayv", descriptor = "(Lclient!yf;B)V", line = 13991)
	static final void method30027(@OriginalArg(0) Class681 arg0) {
	...
	static final void method30028(@OriginalArg(0) Class681 arg0) {
		...
		if (!Class53_Sub1.method14952(local19.charAt(0))) {
			throw new RuntimeException();
		} else if (local19.isEmpty() || local19.length() > 10) {
			throw new RuntimeException();
		} else if (!Class146.aClass344_3.method27527(local19, local27, local37)) {
			throw new RuntimeException();
		}
	}
}
