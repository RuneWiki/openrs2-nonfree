...
public class Class495 implements Interface7 {
	...
	public int method30020(@OriginalArg(0) int arg0) {
		return this.aClass497_125.method30061(-1875439651) ? 100 : this.aClass497_125.method30058(-1774909861);
	}

	@OriginalMember(owner = "client!pw", name = "m", descriptor = "()I", line = 15)
	@Override
	public int method30026() {
		return this.aClass497_125.method30061(-2027874295) ? 100 : this.aClass497_125.method30058(-1774909861);
	}

	@OriginalMember(owner = "client!pw", name = "k", descriptor = "()I", line = 15)
	@Override
	public int method30023() {
		return this.aClass497_125.method30061(-1978306692) ? 100 : this.aClass497_125.method30058(-1774909861);
	}
	...
	static final void method30027(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method30028(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		if (!Class53_Sub1.method14952(local19.charAt(0), (byte) 77)) {
			...
			throw new RuntimeException();
		} else if (!Class146.aClass344_3.method27527(local19, local27, local37, 476186666)) {
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!pw", name = "fd", descriptor = "(B)V", line = 2354)
	static void method30029(@OriginalArg(0) byte arg0) {
			...
			if (Class125_Sub2_Sub1.aFrame1 == null) {
				...
				if (local11 != null) {
					...
					if (Class255.method26008(1309306044) == 1) {
						...
						Class503.method30191(163431309);
					}
					...
					if (Class694.aClass104_14 != null) {
						Class694.aClass104_14.method20515(Class125_Sub3.aCanvas1, client.anInt3408 * -1378711501, client.anInt3416 * 2091353777, -1205668804);
						Class503.method30187(Class694.aClass104_14, Class305.method26796(1721059607));
					}
					if (local11 == Class628.aFrame2) {
						local34 = Class628.aFrame2.getInsets();
					...
					Class183.method24575(2139195022);
					if (client.anInt3526 * -703563959 != -1) {
						Class618.method32101(true, -1743495735);
					}
					Class555.method31053(1022489549);
				}
			}
		}
	}
