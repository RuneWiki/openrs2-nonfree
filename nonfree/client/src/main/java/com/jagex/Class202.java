...
public class Class202 {
	...
	static boolean method24643() {
		return !Class228.method25616(client.anInt3435 * -849002901);
	}

	@OriginalMember(owner = "client!cc", name = "x", descriptor = "(II)V", line = 142)
	public static void method24647(@OriginalArg(0) int arg0) {
	...
	static void method24646(@OriginalArg(0) String arg0) {
	...
	static final void method24645(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class681 arg1) {
		...
		if (arg0.anInt4001 * 1553054515 != 6) {
			...
			Class420.method28740(arg0, local27, local12, 1.0F, 0, 0, 0, 0, 0, 0);
	...
	static final void method24644(@OriginalArg(0) Class681 arg0) {
		...
		Class149_Sub3.method12319(local13, local27, local42);
	}
}
