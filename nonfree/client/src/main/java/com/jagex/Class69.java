...
public class Class69 {
	...
	public static String method1209(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1) {
		...
		return arg1 == 3 ? Class474.method29666(arg0, arg1) : Integer.toString(local5 / 10) + local5 % 10 + "-" + aStringArrayArray1[arg1][local9] + "-" + local13;
	}
	...
	public static String method1210(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		...
		return arg1 == 3 ? Class362.method27848(arg0, arg1, arg2) : Integer.toString(local14 / 10) + local14 % 10 + "-" + aStringArrayArray1[arg1][local18] + "-" + local22 + " " + local26 / 10 + local26 % 10 + ":" + local30 / 10 + local30 % 10;
	}
	...
	static String method1212(@OriginalArg(0) long arg0) {
		Class337.method27459(arg0);
		@Pc(5) int local5 = aCalendar1.get(5);
	...
	static String method1223(@OriginalArg(0) long arg0) {
		Class337.method27459(arg0);
		@Pc(5) int local5 = aCalendar1.get(5);
		@Pc(11) int local11 = aCalendar1.get(2) + 1;
		@Pc(15) int local15 = aCalendar1.get(1);
	...
	public static String method1213(@OriginalArg(0) long arg0) {
		Class337.method27459(arg0);
	...
	public static String method1214(@OriginalArg(0) long arg0) {
		Class337.method27459(arg0);
		@Pc(5) int local5 = aCalendar1.get(11);
		@Pc(9) int local9 = aCalendar1.get(12);
		@Pc(13) int local13 = aCalendar1.get(13);
	...
	static void method1228(@OriginalArg(0) Class489 arg0, @OriginalArg(2) float arg1, @OriginalArg(3) float arg2, @OriginalArg(4) float arg3, @OriginalArg(5) float arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6) {
		@Pc(3) int local3 = client.aClass532_1.method30450();
		@Pc(7) int local7 = client.aClass532_1.method30476();
		arg0.method29936(arg1, arg2, arg3, arg4, (float) local7, (float) local3, (float) arg5, (float) arg6);
	}
}
