...
public class Class69 {
	...
	public static String method1209(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1) {
		...
		return arg1 == 3 ? Class474.method29666(arg0, arg1, (byte) -110) : Integer.toString(local5 / 10) + local5 % 10 + "-" + aStringArrayArray1[arg1][local9] + "-" + local13;
	}
	...
	public static String method1210(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		...
		return arg1 == 3 ? Class362.method27848(arg0, arg1, arg2, (byte) 24) : Integer.toString(local14 / 10) + local14 % 10 + "-" + aStringArrayArray1[arg1][local18] + "-" + local22 + " " + local26 / 10 + local26 % 10 + ":" + local30 / 10 + local30 % 10;
	}
	...
	public static String method1217(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(9) int local9 = aCalendar1.get(2);
		@Pc(13) int local13 = aCalendar1.get(1);
		return arg1 == 3 ? Class474.method29666(arg0, arg1, (byte) -19) : Integer.toString(local5 / 10) + local5 % 10 + "-" + aStringArrayArray1[arg1][local9] + "-" + local13;
	}
	...
	static void method1228(@OriginalArg(0) Class489 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		@Pc(3) int local3 = client.aClass532_1.method30450(-1884407916);
		@Pc(7) int local7 = client.aClass532_1.method30476(-953546015);
		arg0.method29936(arg2, arg3, arg4, arg5, (float) local7, (float) local3, (float) arg6, (float) arg7);
	}
