...
public class Class326 {
	...
	String method27305() {
		@Pc(3) int local3 = this.method27306(739479950);
		if (local3 == -1) {
			return null;
		} else if (local3 > 256) {
	...
	int method27306(@OriginalArg(0) int arg0) {
		@Pc(1) short local1 = 0;
	...
	String method27307(@OriginalArg(0) int arg0) {
		@Pc(3) int local3 = this.method27306(2052350110);
		if (local3 == -1) {
			return null;
		} else if (local3 > 256) {
			throw new RuntimeException_Sub4();
	...
	String method27309() {
		@Pc(3) int local3 = this.method27306(1436308632);
		if (local3 == -1) {
			return null;
		} else if (local3 > 256) {
			throw new RuntimeException_Sub4();
