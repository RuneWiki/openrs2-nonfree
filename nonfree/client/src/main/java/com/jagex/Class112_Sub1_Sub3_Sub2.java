...
public class Class112_Sub1_Sub3_Sub2 extends Class112_Sub1_Sub3 {
	...
	public void method23436(@OriginalArg(0) Interface19 arg0) {
		...
		if (this.aBoolean529) {
			this.method23449(local2.method29648());
		}
	}
	...
	boolean method23448(@OriginalArg(0) int arg0, @OriginalArg(1) long arg1) {
		return e.method27716(IDirect3DDevice.SetRenderTarget(this.aClass104_Sub2_Sub1_10.aLong121, arg0, arg1));
	}

	@OriginalMember(owner = "client!ath", name = "ar", descriptor = "(IJ)Z", line = 86)
	boolean method23452(@OriginalArg(0) int arg0, @OriginalArg(1) long arg1) {
		return e.method27716(IDirect3DDevice.SetRenderTarget(this.aClass104_Sub2_Sub1_10.aLong121, arg0, arg1));
	}

	@OriginalMember(owner = "client!ath", name = "au", descriptor = "(IJ)Z", line = 86)
	boolean method23454(@OriginalArg(0) int arg0, @OriginalArg(1) long arg1) {
		return e.method27716(IDirect3DDevice.SetRenderTarget(this.aClass104_Sub2_Sub1_10.aLong121, arg0, arg1));
	}

	@OriginalMember(owner = "client!ath", name = "am", descriptor = "(IJ)Z", line = 86)
	boolean method23456(@OriginalArg(0) int arg0, @OriginalArg(1) long arg1) {
		return e.method27716(IDirect3DDevice.SetRenderTarget(this.aClass104_Sub2_Sub1_10.aLong121, arg0, arg1));
	}

	@OriginalMember(owner = "client!ath", name = "at", descriptor = "(J)Z", line = 90)
	boolean method23449(@OriginalArg(0) long arg0) {
		return e.method27716(IDirect3DDevice.SetDepthStencilSurface(this.aClass104_Sub2_Sub1_10.aLong121, arg0));
	}

	@OriginalMember(owner = "client!ath", name = "ap", descriptor = "(J)Z", line = 90)
	boolean method23455(@OriginalArg(0) long arg0) {
		return e.method27716(IDirect3DDevice.SetDepthStencilSurface(this.aClass104_Sub2_Sub1_10.aLong121, arg0));
	}
	...
	boolean method23739() {
		...
		if (this.anInterface52_1 != null) {
			this.method23449(this.anInterface52_1.method29648());
		}
	...
	void method23453() throws Throwable {
		this.method23450();
		super.finalize();
	}
}
