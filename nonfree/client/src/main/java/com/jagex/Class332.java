...
public class Class332 {
	...
	public static Class332 method27387(@OriginalArg(0) int arg0) {
		@Pc(2) Class332[] local2 = Class25_Sub1.method15995(-767537114);
	...
	public static Class332 method27388(@OriginalArg(0) int arg0) {
		@Pc(2) Class332[] local2 = Class25_Sub1.method15995(-1145668119);
		for (@Pc(4) int local4 = 0; local4 < local2.length; local4++) {
			@Pc(12) Class332 local12 = local2[local4];
			if (local12.anInt4147 * 595334117 == arg0) {
				return local12;
	...
	public static Class332 method27389(@OriginalArg(0) int arg0) {
		@Pc(2) Class332[] local2 = Class25_Sub1.method15995(-1121487001);
		for (@Pc(4) int local4 = 0; local4 < local2.length; local4++) {
			@Pc(12) Class332 local12 = local2[local4];
			if (local12.anInt4147 * 595334117 == arg0) {
				return local12;
	...
	public static Class332 method27390(@OriginalArg(0) int arg0) {
		@Pc(2) Class332[] local2 = Class25_Sub1.method15995(1406667206);
		for (@Pc(4) int local4 = 0; local4 < local2.length; local4++) {
			@Pc(12) Class332 local12 = local2[local4];
			if (local12.anInt4147 * 595334117 == arg0) {
				return local12;
	...
	static final void method27391(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 2009938100);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class104.method20878(local16, local22, arg0, (byte) 70);
	}
	...
	static final void method27393(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) byte arg3) {
		...
		arg0.anObjectArray39 = Class499.method30148(local13, arg2, -1104938487);
		arg0.aBoolean680 = true;
	}

	@OriginalMember(owner = "client!ib", name = "k", descriptor = "(Lclient!ov;I)F", line = 36)
	public static float method27394(@OriginalArg(0) Class471 arg0, @OriginalArg(1) int arg1) {
	...
	static void method27395(@OriginalArg(0) Class175 arg0, @OriginalArg(1) int arg1) {
		@Pc(5) Class93_Sub22 local5 = Class102.method2592(Class446.aClass446_82, arg0.aClass24_2, (byte) 93);
		arg0.method24351(local5, -1462283660);
	...
	static final void method27396(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub14_1.method16543(local12, -69207239);
	}
}
