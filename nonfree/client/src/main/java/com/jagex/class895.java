...
public class class895 extends class282 {
	...
	public void method4987(Graphics arg0) {
		int var2 = this.this$0.method4893(this.field10470.getWidth((ImageObserver) null)) + this.field2947;
		int var3 = this.this$0.method4887(this.field10470.getHeight((ImageObserver) null)) + this.field2948;
		arg0.drawImage(this.field10470, var2, var3, (ImageObserver) null);
	}
}
