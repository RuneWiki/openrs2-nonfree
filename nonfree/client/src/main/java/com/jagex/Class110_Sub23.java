...
public class Class110_Sub23 extends Class110 {
	...
	@Override
	public void method20138(@OriginalArg(0) int arg0) {
		if (this.aClass539_2 != null) {
			this.aClass539_2.method30852(827342689);
		}
	}
	...
	void method20143() {
		if (this.aClass539_2 != null) {
			this.aClass539_2.method30791(50, (byte) -48);
			Class274.aClass258_1.method26068(this.aClass539_2, 1858378071);
	...
	@Override
	void method20144(@OriginalArg(0) int arg0) {
		if (this.aClass539_2 != null) {
			this.aClass539_2.method30791(50, (byte) -63);
			Class274.aClass258_1.method26068(this.aClass539_2, 1474494591);
			this.aClass539_2 = null;
		}
	}
	...
	public void method20140() {
		if (this.aClass539_2 != null) {
			this.aClass539_2.method30852(-216699414);
		}
	}
	...
	Class110_Sub23(@OriginalArg(0) Class93_Sub41 arg0) {
		super(arg0);
		this.anInt1001 = arg0.method22415(-1434290800) * -313944289;
		this.anInt999 = arg0.method22413((short) 16384) * -2049916011;
		this.anInt998 = arg0.method22413((short) 16384) * -222526445;
		this.anInt1000 = arg0.method22413((short) 16384) * 1931014705;
		this.aClass539_2 = Class274.aClass258_1.method26119(Class275.aClass275_9, this, this.anInt1001 * 1891312863, this.anInt1000 * 484386513, this.anInt999 * -884314179, Class280.aClass280_7.method26450(-1440019737), Class278.aClass278_2, 0.0F, 0.0F, (Class472) null, 0, this.anInt998 * -413669861, false, -2052373249);
		if (this.aClass539_2 != null) {
			this.aClass539_2.method30803(-1234437357);
		}
	}
	...
	static boolean method8623(@OriginalArg(0) int arg0) {
		...
		if (Class171.aClass105_2 == null) {
			if (Class110_Sub7.aClass497_22.method30054(Class160.anInt1962 * 182602545, -512225963)) {
		...
		if (Class171.aClass105_1 == null) {
			if (Class110_Sub7.aClass497_22.method30054(Class296.anInt3919 * -278754945, -512225963)) {
		...
		if (Class531.aClass105_3 == null) {
			if (Class110_Sub7.aClass497_22.method30054(Class628.anInt5707 * 1184402739, -512225963)) {
		...
		if (Class63.aClass5_2 == null) {
			if (Class633.aClass497_137.method30054(Class171.anInt3057 * 57763875, -512225963)) {
				Class63.aClass5_2 = Class157.aClass462_2.method29241(client.anInterface50_1, Class171.anInt3057 * 57763875, -2053596534);
			} else {
				local1 = false;
			}
		}
		if (Class171.aClass105_Sub2_1 == null) {
			if (Class110_Sub7.aClass497_22.method30054(Class171.anInt3057 * 57763875, -512225963)) {
	...
	public static void method8624(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		for (local4 = (Class93_Sub13) Class93_Sub13.aClass22_22.method445((byte) 58); local4 != null; local4 = (Class93_Sub13) Class93_Sub13.aClass22_22.method415(1186384131)) {
			local29 = 1;
			local34 = local4.aClass132_Sub1_Sub1_Sub1_Sub1_1.method19966(930565507);
			local40 = local4.aClass132_Sub1_Sub1_Sub1_Sub1_1.aClass19_Sub3_3.method23554((byte) 79);
			...
			if (local4.anInt1515 * 1201626885 != local29) {
				local115 = Class566.method31258(local4.aClass132_Sub1_Sub1_Sub1_Sub1_1, -755129677);
				@Pc(119) Class336 local119 = local4.aClass132_Sub1_Sub1_Sub1_Sub1_1.aClass336_1;
				if (local119.anIntArray412 != null) {
					local119 = local119.method27423(Class624.aClass120_1, Class624.aClass120_1, (short) 29606);
				}
				if (local119 == null || local115 == -1) {
					...
					if (local4.aClass539_3 == null) {
						...
						if (local4.anInt1514 * 1666407207 <= 0) {
							local4.aClass539_3.method30791(100, (byte) -20);
							Class274.aClass258_1.method26068(local4.aClass539_3, 1609571703);
			...
			local4.anInt1508 = ((int) local218.aFloat317 + (local4.aClass132_Sub1_Sub1_Sub1_Sub1_1.method19997(-1666725116) << 8)) * 440138643;
			local4.anInt1507 = (int) local218.aFloat319 * 1539129531;
			local4.anInt1509 = ((int) local218.aFloat319 + (local4.aClass132_Sub1_Sub1_Sub1_Sub1_1.method19997(-4636485) << 8)) * -465070531;
		...
		for (local4 = (Class93_Sub13) Class93_Sub13.aClass16_11.method220((byte) 29); local4 != null; local4 = (Class93_Sub13) Class93_Sub13.aClass16_11.method222(1758003760)) {
			local29 = 1;
			local34 = local4.aClass132_Sub1_Sub1_Sub1_Sub2_1.method19966(985134320);
			local40 = local4.aClass132_Sub1_Sub1_Sub1_Sub2_1.aClass19_Sub3_3.method23554((byte) 16);
			...
			if (local29 != local4.anInt1515 * 1201626885) {
				...
				if (local4.anInt1522 * 486579173 == local115) {
					...
					if (local4.aClass539_3 == null) {
						...
						local4.anInt1514 -= 1825123840;
						if (local4.anInt1514 * 1666407207 <= 0) {
							local4.aClass539_3.method30791(100, (byte) -42);
							Class274.aClass258_1.method26068(local4.aClass539_3, 1527433662);
							local4.aClass539_3 = null;
							local384 = true;
						}
					}
			...
			local4.anInt1513 = (int) local218.aFloat317 * 1575742085;
			local4.anInt1508 = ((int) local218.aFloat317 + (local4.aClass132_Sub1_Sub1_Sub1_Sub2_1.method19997(-818242305) << 8)) * 440138643;
			local4.anInt1507 = (int) local218.aFloat319 * 1539129531;
			local4.anInt1509 = ((int) local218.aFloat319 + (local4.aClass132_Sub1_Sub1_Sub1_Sub2_1.method19997(734172845) << 8)) * -465070531;
