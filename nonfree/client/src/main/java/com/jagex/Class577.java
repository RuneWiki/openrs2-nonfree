...
class Class577 implements Runnable {
			...
			try {
				if (!this.this$0.aBoolean260) {
					...
					while (local9.hasNext()) {
						...
						local16.method31375(1356595631);
					}
					@Pc(25) HashMap local25 = this.this$0.method11705(-193915262);
					...
					while (true) {
						...
						do {
							if (!local29.hasNext()) {
								...
								while (local29.hasNext()) {
									...
									local72.method31376(-1553933522);
								}
						...
						@Pc(46) Class535[] local46 = (Class535[]) (Class535[]) local25.get(local36);
						for (@Pc(48) int local48 = 0; local48 < local46.length; local48++) {
							local46[local48].method30658((byte) 1);
						}
					}
				}
			} catch (@Pc(81) Exception local81) {
				Class646.method32610((String) null, local81, 2036494109);
		...
		label54: while (true) {
			try {
				if (!this.this$0.aBoolean260) {
					...
					while (local9.hasNext()) {
						@Pc(16) Class580 local16 = (Class580) local9.next();
						local16.method31375(774987040);
					}
					@Pc(25) HashMap local25 = this.this$0.method11705(798736998);
					@Pc(29) Iterator local29 = local25.keySet().iterator();
					while (true) {
						@Pc(36) Class508 local36;
						do {
							if (!local29.hasNext()) {
								...
								while (local29.hasNext()) {
									@Pc(72) Class580 local72 = (Class580) local29.next();
									local72.method31376(-1718214278);
								}
								Class212.method25439(6L);
								continue label54;
							}
				...
				Class646.method32610((String) null, local81, 1691675102);
				local81.printStackTrace();
			}
			return;
		}
		...
		label54: while (true) {
			try {
				if (!this.this$0.aBoolean260) {
					...
					while (local9.hasNext()) {
						@Pc(16) Class580 local16 = (Class580) local9.next();
						local16.method31375(-2066872527);
					}
					@Pc(25) HashMap local25 = this.this$0.method11705(22796649);
					@Pc(29) Iterator local29 = local25.keySet().iterator();
					while (true) {
						@Pc(36) Class508 local36;
						do {
				...
				Class646.method32610((String) null, local81, 376743634);
				local81.printStackTrace();
			}
			return;
		}
		...
		label54: while (true) {
			try {
				if (!this.this$0.aBoolean260) {
					...
					while (local9.hasNext()) {
						@Pc(16) Class580 local16 = (Class580) local9.next();
						local16.method31375(1230635892);
					}
					@Pc(25) HashMap local25 = this.this$0.method11705(-1195272089);
					@Pc(29) Iterator local29 = local25.keySet().iterator();
					while (true) {
						@Pc(36) Class508 local36;
						do {
							if (!local29.hasNext()) {
								...
								while (local29.hasNext()) {
									@Pc(72) Class580 local72 = (Class580) local29.next();
									local72.method31376(-1414424588);
								}
								Class212.method25439(6L);
								continue label54;
							}
				...
				Class646.method32610((String) null, local81, 2096297870);
				local81.printStackTrace();
			}
			return;
		}
		...
		label54: while (true) {
			try {
				if (!this.this$0.aBoolean260) {
					...
					while (local9.hasNext()) {
						@Pc(16) Class580 local16 = (Class580) local9.next();
						local16.method31375(-1371003472);
					}
					@Pc(25) HashMap local25 = this.this$0.method11705(-527242015);
					@Pc(29) Iterator local29 = local25.keySet().iterator();
					while (true) {
						@Pc(36) Class508 local36;
						do {
				...
				Class646.method32610((String) null, local81, 603499362);
				local81.printStackTrace();
			}
			return;
		}
	...
	static final void method31356(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!tp", name = "bw", descriptor = "(Lclient!hf;Lclient!yf;I)V", line = 5187)
	static final void method31357(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class681 arg1, @OriginalArg(2) int arg2) {
		if (client.method25238(arg0).method13618((byte) -39) && client.aClass312_7 == null) {
			Class1.method16(arg0.anInt3953 * -1549590237, arg0.anInt3970 * 532402067, -1547528376);
