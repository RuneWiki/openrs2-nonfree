...
public class Class658 {
	...
	public static void method32790(@OriginalArg(0) Class93_Sub1 arg0, @OriginalArg(1) Class93_Sub1 arg1) {
	...
	public void method32759(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class48[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) int arg6) {
	...
	public void method32760(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class32_Sub19 arg2) {
		@Pc(3) int local3 = anIntArray513[arg0];
		if (arg2.method18261(arg1) != null) {
	...
	public void method32761(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public void method32788(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public void method32787(@OriginalArg(0) boolean arg0) {
		this.aBoolean862 = arg0;
		this.method32764();
	}

	@OriginalMember(owner = "client!xg", name = "w", descriptor = "(IILclient!aon;B)V", line = 85)
	public void method32758(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class32_Sub12 arg2) {
		if (arg1 == -1) {
			this.anIntArray510[arg0] = 0;
		} else if (arg2.method18261(arg1) == null) {
			return;
		} else {
	...
	public Class109 method32772(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class32_Sub5 arg2, @OriginalArg(3) Class32_Sub19 arg3, @OriginalArg(4) Class32_Sub3 arg4, @OriginalArg(5) Class32_Sub12 arg5, @OriginalArg(6) Interface21 arg6, @OriginalArg(7) Interface23 arg7, @OriginalArg(8) Class19 arg8, @OriginalArg(9) Class19 arg9, @OriginalArg(10) Class19[] arg10, @OriginalArg(11) int[] arg11, @OriginalArg(12) int arg12, @OriginalArg(13) boolean arg13, @OriginalArg(14) Class651 arg14) {
		if (this.anInt5817 * 1405397749 != -1) {
			return ((Class336) arg4.method18261(this.anInt5817 * 1405397749)).method27418(arg0, arg1, arg2, arg6, arg7, arg8, arg9, arg10, arg11, arg12, null);
		}
		...
		@Pc(67) int local67;
		if (arg8 != null) {
			@Pc(48) Class263 local48 = arg8.method23553();
		...
		for (@Pc(264) int local264 = 0; local264 < local67; local264++) {
			if (arg10[local264] != null) {
				local29 |= arg10[local264].method23564();
				local254 = true;
			}
		}
		if (arg8 != null) {
			local29 |= arg8.method23564();
			local254 = true;
		}
		if (arg9 != null) {
			local29 |= arg9.method23564();
			local254 = true;
		}
		...
		if (-1790369147 * this.anInt5816 != -1) {
			local348 = (Class622) arg2.method18261(this.anInt5816 * -1790369147);
		}
		@Pc(385) int local385;
		@Pc(393) int local393;
		if (local338 == null || arg0.method20693(local338.method6825(), local29) != 0) {
			...
			while (true) {
					...
					if (local383) {
						...
						for (local393 = 0; local393 < local37.length; local393++) {
							...
							if ((local565 & 0x40000000) != 0) {
								...
								local614 = ((Class47) arg5.method18261(local565 & 0x3FFFFFFF)).method918(this.aBoolean862, local567);
								if (local614 != null) {
									local555[local393] = local614;
								}
							} else if ((local565 & Integer.MIN_VALUE) != 0) {
								local614 = ((Class369) arg3.method18261(local565 & 0x3FFFFFFF)).method27979();
								if (local614 != null) {
									local555[local393] = local614;
								}
							}
				...
				if ((local393 & 0x40000000) != 0) {
					...
					if (!((Class47) arg5.method18261(local393 & 0x3FFFFFFF)).method917(this.aBoolean862, local395)) {
						local383 = true;
					}
				} else if ((local393 & Integer.MIN_VALUE) != 0 && !((Class369) arg3.method18261(local393 & 0x3FFFFFFF)).method27978()) {
					local383 = true;
				}
				local385++;
			}
		...
		while (local385 < local67) {
			if (arg10[local385] != null) {
				arg10[local385].method23566(local906, 0, local393);
			}
			local385++;
			local393 <<= 0x1;
		}
		...
		if (arg8 != null && arg9 != null) {
			Class237.method25772(local906, arg8, arg9);
		} else if (arg8 != null) {
			arg8.method23565(local906, 0);
		} else if (arg9 != null) {
			arg9.method23565(local906, 0);
		}
		return local906;
	}
	...
	public Class109 method32766(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class32_Sub19 arg2, @OriginalArg(3) Class32_Sub3 arg3, @OriginalArg(4) Class32_Sub12 arg4, @OriginalArg(5) Interface21 arg5, @OriginalArg(6) Interface23 arg6, @OriginalArg(7) Class19 arg7) {
		if (this.anInt5817 * 1405397749 != -1) {
			return ((Class336) arg3.method18261(this.anInt5817 * 1405397749)).method27420(arg0, arg1, arg5, arg6, arg7, null);
		}
		@Pc(32) int local32 = arg7 == null ? arg1 : arg1 | arg7.method23564();
		...
		if (local44 == null || arg0.method20693(local44.method6825(), local32) != 0) {
			...
			for (@Pc(74) int local74 = 0; local74 < this.anIntArray510.length; local74++) {
				...
				if ((local84 & 0x40000000) != 0) {
					...
					if (!((Class47) arg4.method18261(local84 & 0x3FFFFFFF)).method919(this.aBoolean862, local86)) {
						local72 = true;
					}
				} else if ((local84 & Integer.MIN_VALUE) != 0 && !((Class369) arg2.method18261(local84 & 0x3FFFFFFF)).method27980()) {
					local72 = true;
				}
			}
			if (local72) {
			...
			for (@Pc(152) int local152 = 0; local152 < this.anIntArray510.length; local152++) {
				...
				if ((local162 & 0x40000000) != 0) {
					...
					local195 = ((Class47) arg4.method18261(local162 & 0x3FFFFFFF)).method920(this.aBoolean862, local164);
					if (local195 != null) {
						local148[local84++] = local195;
					}
				} else if ((local162 & Integer.MIN_VALUE) != 0) {
					local195 = ((Class369) arg2.method18261(local162 & 0x3FFFFFFF)).method27981();
					if (local195 != null) {
						local148[local84++] = local195;
					}
				}
	...
	public Class109 method32775(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class32_Sub19 arg2, @OriginalArg(3) Class32_Sub17 arg3, @OriginalArg(4) Class19 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		@Pc(10) int local10 = arg4 == null ? arg1 : arg1 | arg4.method23564();
		...
		if (local32 == null || arg0.method20693(local32.method6825(), local10) != 0) {
			...
			@Pc(65) int local65 = 0;
			if (!((Class369) arg2.method18261(arg5)).method27980() || !((Class369) arg2.method18261(arg6)).method27980() || !((Class369) arg2.method18261(arg7)).method27980()) {
				return null;
			}
			@Pc(97) Class231 local97 = ((Class369) arg2.method18261(arg5)).method27981();
			if (local97 != null) {
				local63[local65++] = local97;
			}
			local97 = ((Class369) arg2.method18261(arg6)).method27981();
			if (local97 != null) {
				local63[local65++] = local97;
			}
			local97 = ((Class369) arg2.method18261(arg7)).method27981();
			if (local97 != null) {
				local63[local65++] = local97;
			}
	...
	public Class109 method32776(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class32_Sub19 arg2, @OriginalArg(3) Class32_Sub17 arg3, @OriginalArg(4) Class19 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		@Pc(10) int local10 = arg4 == null ? arg1 : arg1 | arg4.method23564();
		@Pc(23) long local23 = (long) arg7 << 32 | (long) (arg6 << 16) | (long) arg5;
		@Pc(26) Class240 local26 = aClass240_92;
		@Pc(32) Class109 local32;
	...
	public static void method32782(@OriginalArg(0) int arg0) {
		...
		synchronized (aClass240_92) {
			aClass240_92.method25833();
		}
		local6 = aClass240_91;
		synchronized (aClass240_91) {
			aClass240_91.method25833();
		}
	}
	...
	public static void method32768() {
		@Pc(2) Class240 local2 = aClass240_91;
		synchronized (aClass240_91) {
			aClass240_91.method25837();
		}
		local2 = aClass240_92;
		synchronized (aClass240_92) {
			aClass240_92.method25837();
		}
	}

	@OriginalMember(owner = "client!xg", name = "mz", descriptor = "(Lclient!yf;B)V", line = 7265)
	static final void method32791(@OriginalArg(0) Class681 arg0) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class694.method36628(local11, local14, arg0);
	}

	@OriginalMember(owner = "client!xg", name = "bek", descriptor = "(Lclient!yf;I)V", line = 15060)
	static final void method32789(@OriginalArg(0) Class681 arg0) {
