...
public class Class25_Sub1 extends Class25 {
	...
	public void method15962(@OriginalArg(0) Class472 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) byte arg7) {
	...
	public void method15965(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	...
	public void method23128(@OriginalArg(0) float arg0) {
		@Pc(3) Class471 local3 = this.method15969(1360892946);
		...
		@Pc(97) Class93_Sub30 local97 = local93.method21404((byte) 6);
		...
		this.method15972(local101, (byte) -106);
	...
	public void method15966(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	...
	public Class472 method23120(@OriginalArg(0) int arg0) {
		...
		local6.method29543(this.aClass123_16.method8957(-311485086));
		return local6;
	}
	...
	public Class472 method23122(@OriginalArg(0) int arg0) {
		...
		local6.aFloat318 *= -1.0F;
		local6.method29543(this.aClass123_16.method8957(1695981577));
		return local6;
	}

	@OriginalMember(owner = "client!anb", name = "g", descriptor = "(IIII)V", line = 75)
	public void method15967(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	public void method23118(@OriginalArg(0) float arg0, @OriginalArg(1) byte arg1) {
		...
		@Pc(97) Class93_Sub30 local97 = local93.method21404((byte) 100);
		...
		local129.aFloat318 *= -1.0F;
		local101.method29543(local129);
		this.method15972(local101, (byte) -44);
		local93.method9297(new Class93_Sub30(local97.anInt1609 * -2022654167, (int) local101.aFloat317, (int) local101.aFloat318, (int) local101.aFloat319), -1049152339);
		anInt2244 = 0;
		anInt2246 = 0;
	}
	...
	public Class472 method23127() {
		...
		local6.method29572(Class471.method29471(this.aClass471_4));
		local6.aFloat318 *= -1.0F;
		local6.method29543(this.aClass123_16.method8957(-1021674833));
		return local6;
	}
	...
	public boolean method23132(@OriginalArg(0) int arg0) {
		return !Float.isNaN(this.aClass471_4.aFloat314) && this.aClass123_16.method8957(949988966) != null;
	}

	@OriginalMember(owner = "client!anb", name = "t", descriptor = "(I)Lclient!ov;", line = 143)
	public Class471 method15969(@OriginalArg(0) int arg0) {
	...
	public void method23123(@OriginalArg(0) Class368 arg0, @OriginalArg(1) Class470 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float arg4, @OriginalArg(5) byte arg5) {
		@Pc(5) Class472 local5 = Class472.method29530(this.aClass123_16.method8957(-2020101732));
	...
	public void method15970(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		anInt2244 = arg0 * 1097649223;
	}

	@OriginalMember(owner = "client!anb", name = "x", descriptor = "(II)V", line = 43)
	public void method15971(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public void method23124(@OriginalArg(0) float arg0) {
		...
		@Pc(97) Class93_Sub30 local97 = local93.method21404((byte) 94);
		...
		local129.aFloat318 *= -1.0F;
		local101.method29543(local129);
		this.method15972(local101, (byte) -98);
		local93.method9297(new Class93_Sub30(local97.anInt1609 * -2022654167, (int) local101.aFloat317, (int) local101.aFloat318, (int) local101.aFloat319), -1049152339);
		anInt2244 = 0;
		anInt2246 = 0;
	}
	...
	public boolean method23125() {
		return !Float.isNaN(this.aClass471_4.aFloat314) && this.aClass123_16.method8957(767970627) != null;
	}
	...
	void method15972(@OriginalArg(0) Class472 arg0, @OriginalArg(1) byte arg1) {
	...
	public void method23126(@OriginalArg(0) Class368 arg0, @OriginalArg(1) Class470 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float arg4) {
		@Pc(5) Class472 local5 = Class472.method29530(this.aClass123_16.method8957(-140818743));
		local5.aFloat317 -= (float) arg2;
		local5.aFloat319 -= (float) arg3;
		local5.aFloat318 *= -1.0F;
		arg1.method29374(Class471.method29471(this.aClass471_4));
	...
	public Class472 method23133() {
		...
		local6.method29572(Class471.method29471(this.aClass471_3));
		local6.aFloat318 *= -1.0F;
		local6.method29543(this.aClass123_16.method8957(-116592144));
		return local6;
	}
	...
	public Class472 method23117() {
		...
		local6.method29572(Class471.method29471(this.aClass471_3));
		local6.aFloat318 *= -1.0F;
		local6.method29543(this.aClass123_16.method8957(-1339681644));
		return local6;
	}
	...
	static Class332[] method15995(@OriginalArg(0) int arg0) {
