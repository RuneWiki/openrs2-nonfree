...
public class class1234 extends class1200 {
	...
	public final void method19725(int arg0, int arg1, int arg2, int arg3) {
		...
		if (!this.field12596) {
			...
			if (this.field12595) {
				var5.field4311 = (float) (client.method3660((int) var5.field4308, (int) var5.field4313, this.field11717) - this.field12599);
			}
	...
	public void method19729() {
		...
		var17.field4308 += (float) var14;
		var17.field4313 += (float) var15;
	...
	public final void method19732(int arg0) {
		...
		if (this.field12595) {
			var2.field4298.field4311 = (float) (client.method3660((int) var2.field4298.field4308, (int) var2.field4298.field4313, this.field11717) - this.field12599);
	...
	public void method16529() {
		...
		this.field12471 = this.field12472 = (short) (int) (var1.field4308 / 512.0F);
		this.field12468 = this.field12467 = (short) (int) (var1.field4313 / 512.0F);
	}
