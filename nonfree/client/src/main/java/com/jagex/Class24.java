...
public final class Class24 {
	...
	public final int method505(@OriginalArg(0) int arg0) {
	...
	public final int method506(@OriginalArg(0) int arg0) {
		if (this.anInt77 * -732254649 == 0) {
	...
	final void method507(@OriginalArg(0) int arg0) {
		this.anInt80 += (this.anInt81 += -1172788929) * -1222813753;
		for (@Pc(15) int local15 = 0; local15 < 256; local15++) {
			@Pc(23) int local23 = this.anIntArray6[local15];
			if ((local15 & 0x2) == 0) {
	...
	final void method508(@OriginalArg(0) int arg0) {
