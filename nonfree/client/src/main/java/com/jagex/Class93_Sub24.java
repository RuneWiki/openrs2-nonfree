...
public class Class93_Sub24 extends Class93 {
	...
	void method13760(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1) {
				...
				if (local32 != 0 && local27 != null) {
					...
					while (local40 < local27.length) {
						if ((local32 & 0x1 << local38++) == 0) {
							...
							local5.method22454(local27[local40++] & 0xFFFF, 2142644047);
							local1++;
							local5.method22454(local27[local40++] & 0xFFFF, 2146100159);
							local1++;
							local5.method22454(local27[local40++] & 0xFFFF, 2138598858);
							local1++;
						}
					}
				}
				...
				if (local32 != 0 && local27 != null) {
					...
					while (local40 < local27.length) {
						if ((local32 & 0x1 << local38++) == 0) {
							...
							local5.method22393(local27[local40++] & 0xFFFF, -1436042249);
							local1++;
							local5.method22393(local27[local40++] & 0xFFFF, -1572075607);
							local1++;
							local5.method22393(local27[local40++] & 0xFFFF, -1950477983);
							local1++;
						}
					}
				}
		...
		if (this.aClass104_Sub1_30.aBoolean72) {
			this.aClass104_Sub1_30.method20545(Integer.MAX_VALUE, this.aClass237_4);
		}
				...
				if (local32 != 0 && local27 != null) {
					...
					while (local40 < local27.length) {
						if ((local32 & 0x1 << local38++) == 0) {
							...
							local5.method22454(local27[local40++] & 0xFFFF, 2141581615);
							local1++;
							local5.method22454(local27[local40++] & 0xFFFF, 2142360938);
							local1++;
							local5.method22454(local27[local40++] & 0xFFFF, 2134228941);
							local1++;
						}
					}
				}
				...
				if (local32 != 0 && local27 != null) {
					...
					while (local40 < local27.length) {
						if ((local32 & 0x1 << local38++) == 0) {
							...
							local5.method22393(local27[local40++] & 0xFFFF, -1709502073);
							local1++;
							local5.method22393(local27[local40++] & 0xFFFF, -1911567);
							local1++;
							local5.method22393(local27[local40++] & 0xFFFF, -1021260162);
							local1++;
						}
					}
				}
				...
				if (local32 != 0 && local27 != null) {
					...
					while (local40 < local27.length) {
						if ((local32 & 0x1 << local38++) == 0) {
							...
							local5.method22454(local27[local40++] & 0xFFFF, 2129126149);
							local1++;
							local5.method22454(local27[local40++] & 0xFFFF, 2143558021);
							local1++;
							local5.method22454(local27[local40++] & 0xFFFF, 2145323368);
							local1++;
						}
					}
				}
				...
				if (local32 != 0 && local27 != null) {
					...
					while (local40 < local27.length) {
						if ((local32 & 0x1 << local38++) == 0) {
							...
							local5.method22393(local27[local40++] & 0xFFFF, -1179302735);
							local1++;
							local5.method22393(local27[local40++] & 0xFFFF, -755621991);
							local1++;
							local5.method22393(local27[local40++] & 0xFFFF, -913568354);
							local1++;
						}
					}
				}
	...
	Class93_Sub24(@OriginalArg(0) Class99_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class237 arg3) {
		...
		this.aClass101_Sub1_1 = new Class101_Sub1(this.aClass104_Sub1_30, 5123, (byte[]) null, 1);
	}
				...
				if (local32 != 0 && local27 != null) {
					...
					while (local40 < local27.length) {
						if ((local32 & 0x1 << local38++) == 0) {
							...
							local5.method22454(local27[local40++] & 0xFFFF, 2128652295);
							local1++;
							local5.method22454(local27[local40++] & 0xFFFF, 2144062975);
							local1++;
							local5.method22454(local27[local40++] & 0xFFFF, 2144122771);
							local1++;
						}
					}
				}
				...
				if (local32 != 0 && local27 != null) {
					...
					while (local40 < local27.length) {
						if ((local32 & 0x1 << local38++) == 0) {
							...
							local5.method22393(local27[local40++] & 0xFFFF, -784761081);
							local1++;
							local5.method22393(local27[local40++] & 0xFFFF, -1977702818);
							local1++;
							local5.method22393(local27[local40++] & 0xFFFF, -2122330677);
							local1++;
						}
					}
				}
