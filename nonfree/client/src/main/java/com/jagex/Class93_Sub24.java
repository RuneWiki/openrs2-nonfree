...
public class Class93_Sub24 extends Class93 {
	...
	void method13763(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) float arg3) {
		...
		@Pc(26) int local26;
		if (this.anInt1580 != -1) {
			@Pc(11) Class235 local11 = this.aClass104_Sub1_30.aClass225_6.method25597(this.anInt1580);
	...
	void method13760(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1) {
				...
				if (local32 != 0 && local27 != null) {
					...
					while (local40 < local27.length) {
						if ((local32 & 0x1 << local38++) == 0) {
							...
							local5.method22454(local27[local40++] & 0xFFFF);
							local1++;
							local5.method22454(local27[local40++] & 0xFFFF);
							local1++;
							local5.method22454(local27[local40++] & 0xFFFF);
				...
				if (local32 != 0 && local27 != null) {
					...
					while (local40 < local27.length) {
						if ((local32 & 0x1 << local38++) == 0) {
							...
							local5.method22393(local27[local40++] & 0xFFFF);
							local1++;
							local5.method22393(local27[local40++] & 0xFFFF);
							local1++;
							local5.method22393(local27[local40++] & 0xFFFF);
		...
		this.aClass101_Sub1_1.method2561(local5.aByteArray58, local5.anInt3070 * 212851357);
