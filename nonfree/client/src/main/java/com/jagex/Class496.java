...
public class Class496 {
	...
	Class143_Sub1 method30031(@OriginalArg(0) int arg0, @OriginalArg(1) Class593 arg1, @OriginalArg(2) Class593 arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) boolean arg4) {
		if (this.aClass513_1 == null) {
			...
			if (this.aClass513_2 != null && arg4) {
				...
				this.aClass143_Sub1Array1[arg0].method11080(this.aClass143_Sub1Array1[arg0].method11070(local82.anInt5162 * 583520325, local82.aByteArray95, local82.anInt5160 * -1785716067, local82.anInt5161 * 996913261, 1081483065), (short) -20828);
			}
			return local66;
		} else {
		...
		if (this.aClass143_Sub1Array1 == null) {
			...
			for (@Pc(62) int local62 = 0; local62 < this.aClass143_Sub1Array1.length; local62++) {
				if (this.aClass143_Sub1Array1[local62] != null) {
					...
					this.aClass143_Sub1Array1[local62].method11069(local79.anInt5162 * 583520325, local79.aByteArray95, local79.anInt5160 * -1785716067, local79.anInt5161 * 996913261, 1213741331);
	...
	public Class143_Sub1 method30033(@OriginalArg(0) int arg0, @OriginalArg(1) Class593 arg1, @OriginalArg(2) Class593 arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) byte arg4) {
		return this.method30034(arg0, arg1, arg2, true, arg3, -1240538863);
	}

	@OriginalMember(owner = "client!px", name = "m", descriptor = "(ILclient!uf;Lclient!uf;ZZI)Lclient!aij;", line = 60)
	Class143_Sub1 method30034(@OriginalArg(0) int arg0, @OriginalArg(1) Class593 arg1, @OriginalArg(2) Class593 arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		if (this.aClass513_1 == null) {
			throw new RuntimeException();
		} else if (arg0 < 0 || arg0 >= this.aClass143_Sub1Array1.length) {
			throw new RuntimeException();
			...
			if (this.aClass513_2 != null && arg4) {
				@Pc(82) Class491 local82 = this.aClass513_2.aClass491Array1[arg0];
				this.aClass143_Sub1Array1[arg0].method11080(this.aClass143_Sub1Array1[arg0].method11070(local82.anInt5162 * 583520325, local82.aByteArray95, local82.anInt5160 * -1785716067, local82.anInt5161 * 996913261, 1121277394), (short) -5220);
			}
			return local66;
		} else {
			return this.aClass143_Sub1Array1[arg0];
	...
	public void method30035(@OriginalArg(0) int arg0) {
		if (this.aClass143_Sub1Array1 == null) {
			return;
		}
		@Pc(5) int local5;
		...
		if (this.aClass513_1 == null) {
			...
			if (this.aClass93_Sub1_Sub16_Sub1_2 == null) {
				this.aClass93_Sub1_Sub16_Sub1_2 = this.aClass493_3.method29986(295817459);
				...
				try {
					...
					for (@Pc(95) int local95 = 0; local95 < this.aClass143_Sub1Array1.length; local95++) {
						if (this.aClass143_Sub1Array1[local95] != null && this.aClass143_Sub1Array1[local95].method11078(-575379816)) {
							...
							this.aClass143_Sub1Array1[local95].method11080(this.aClass143_Sub1Array1[local95].method11070(local118.anInt5162 * 583520325, local118.aByteArray95, local118.anInt5160 * -1785716067, local118.anInt5161 * 996913261, 698916621), (short) -19832);
						}
					}
	...
	public void method30036() {
		...
		if (this.aClass513_1 == null) {
			...
			if (this.aClass93_Sub1_Sub16_Sub1_2 == null) {
				this.aClass93_Sub1_Sub16_Sub1_2 = this.aClass493_3.method29986(-571165620);
			} else if (!this.aClass93_Sub1_Sub16_Sub1_2.aBoolean546) {
				...
				try {
					...
					for (@Pc(95) int local95 = 0; local95 < this.aClass143_Sub1Array1.length; local95++) {
						if (this.aClass143_Sub1Array1[local95] != null && this.aClass143_Sub1Array1[local95].method11078(-575379816)) {
							@Pc(118) Class491 local118 = this.aClass513_2.aClass491Array1[local95];
							this.aClass143_Sub1Array1[local95].method11080(this.aClass143_Sub1Array1[local95].method11070(local118.anInt5162 * 583520325, local118.aByteArray95, local118.anInt5160 * -1785716067, local118.anInt5161 * 996913261, 65014979), (short) -19886);
						}
					}
				} catch (@Pc(148) Exception local148) {
					for (@Pc(150) int local150 = 0; local150 < this.aClass143_Sub1Array1.length; local150++) {
	...
	public Class143_Sub1 method30037(@OriginalArg(0) int arg0, @OriginalArg(1) Class593 arg1, @OriginalArg(2) Class593 arg2, @OriginalArg(3) boolean arg3) {
		return this.method30034(arg0, arg1, arg2, true, arg3, -2029210063);
	}
	...
	public Class496(@OriginalArg(0) Class144 arg0, @OriginalArg(1) Class493 arg1, @OriginalArg(2) Class480 arg2, @OriginalArg(3) BigInteger arg3, @OriginalArg(4) BigInteger arg4) {
		...
		if (this.aClass493_3 != null) {
			this.aClass93_Sub1_Sub16_Sub1_2 = this.aClass493_3.method29986(-718903138);
		}
	}
	...
	Class143_Sub1 method30038(@OriginalArg(0) int arg0, @OriginalArg(1) Class593 arg1, @OriginalArg(2) Class593 arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) boolean arg4) {
		if (this.aClass513_1 == null) {
			...
			if (this.aClass513_2 != null && arg4) {
				@Pc(82) Class491 local82 = this.aClass513_2.aClass491Array1[arg0];
				this.aClass143_Sub1Array1[arg0].method11080(this.aClass143_Sub1Array1[arg0].method11070(local82.anInt5162 * 583520325, local82.aByteArray95, local82.anInt5160 * -1785716067, local82.anInt5161 * 996913261, 823167128), (short) -16267);
			}
			return local66;
		} else {
			return this.aClass143_Sub1Array1[arg0];
	...
	Class143_Sub1 method30039(@OriginalArg(0) int arg0, @OriginalArg(1) Class593 arg1, @OriginalArg(2) Class593 arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) boolean arg4) {
		if (this.aClass513_1 == null) {
			...
			if (this.aClass513_2 != null && arg4) {
				@Pc(82) Class491 local82 = this.aClass513_2.aClass491Array1[arg0];
				this.aClass143_Sub1Array1[arg0].method11080(this.aClass143_Sub1Array1[arg0].method11070(local82.anInt5162 * 583520325, local82.aByteArray95, local82.anInt5160 * -1785716067, local82.anInt5161 * 996913261, 383563466), (short) -20070);
			}
			return local66;
		} else {
			return this.aClass143_Sub1Array1[arg0];
	...
	public void method30040() {
		...
		if (this.aClass513_1 == null) {
			...
			if (this.aClass93_Sub1_Sub16_Sub1_2 == null) {
				this.aClass93_Sub1_Sub16_Sub1_2 = this.aClass493_3.method29986(-118609493);
			} else if (!this.aClass93_Sub1_Sub16_Sub1_2.aBoolean546) {
				...
				try {
					...
					for (@Pc(95) int local95 = 0; local95 < this.aClass143_Sub1Array1.length; local95++) {
						if (this.aClass143_Sub1Array1[local95] != null && this.aClass143_Sub1Array1[local95].method11078(-575379816)) {
							@Pc(118) Class491 local118 = this.aClass513_2.aClass491Array1[local95];
							this.aClass143_Sub1Array1[local95].method11080(this.aClass143_Sub1Array1[local95].method11070(local118.anInt5162 * 583520325, local118.aByteArray95, local118.anInt5160 * -1785716067, local118.anInt5161 * 996913261, 1301173477), (short) -6321);
						}
					}
				} catch (@Pc(148) Exception local148) {
					for (@Pc(150) int local150 = 0; local150 < this.aClass143_Sub1Array1.length; local150++) {
	...
	public boolean method30041() {
		...
		if (this.aClass143_Sub1Array1 == null) {
			...
			for (@Pc(62) int local62 = 0; local62 < this.aClass143_Sub1Array1.length; local62++) {
				if (this.aClass143_Sub1Array1[local62] != null) {
					@Pc(79) Class491 local79 = this.aClass513_1.aClass491Array1[local62];
					this.aClass143_Sub1Array1[local62].method11069(local79.anInt5162 * 583520325, local79.aByteArray95, local79.anInt5160 * -1785716067, local79.anInt5161 * 996913261, -1081366462);
					if (this.aClass143_Sub1Array1[local62].method11078(-575379816)) {
	...
	static final void method30042(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	public static Class125 method30043(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		@Pc(4) Class125_Sub2 local4 = (Class125_Sub2) Class661.method32844(arg0, (byte) 47);
		@Pc(8) int local8 = arg0.method22482((byte) -4);
