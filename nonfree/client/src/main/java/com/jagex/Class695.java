...
public class Class695 {
	...
	static Class93_Sub1_Sub13 method36629(@OriginalArg(0) int arg0) {
		@Pc(5) Class93_Sub1_Sub13 local5 = (Class93_Sub1_Sub13) aClass253_1.method25983((long) arg0);
		if (local5 != null) {
			return local5;
		}
		@Pc(15) byte[] local15 = Class542.aClass497_129.method30044(arg0, 0, (byte) 0);
	...
	static Class93_Sub1_Sub13 method36633(@OriginalArg(0) byte[] arg0) {
	...
	static Class93_Sub1_Sub13 method36634(@OriginalArg(0) byte[] arg0) {
		return new Class93_Sub1_Sub13(new Class93_Sub41(arg0), Class506.anInterface21_4);
	}

	@OriginalMember(owner = "client!yw", name = "p", descriptor = "(Lclient!uh;II)Lclient!asc;", line = 37)
	static Class93_Sub1_Sub13 method36635(@OriginalArg(0) Class155 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(28) byte[] local28 = Class542.aClass497_129.method30059(Class542.aClass497_129.method30068(local8, (short) 7096), (byte) 19);
		if (local28 == null) {
			...
			local28 = Class542.aClass497_129.method30059(Class542.aClass497_129.method30068(local8, (short) 8876), (byte) 95);
			if (local28 == null) {
				...
				local28 = Class542.aClass497_129.method30059(Class542.aClass497_129.method30068(local8, (short) 17112), (byte) 126);
				if (local28 == null) {
					return null;
					...
					aClass253_1.method25985(local16, (long) local8 << 16);
					return local16;
				}
			} else if (local28.length <= 1) {
				return null;
	...
	static Class93_Sub1_Sub13 method36636(@OriginalArg(0) Class155 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(8) int local8 = arg0.anInt2065 * 825039395 | arg1 << 10;
		@Pc(16) Class93_Sub1_Sub13 local16 = (Class93_Sub1_Sub13) aClass253_1.method25983((long) local8 << 16);
		if (local16 != null) {
			return local16;
		}
		@Pc(28) byte[] local28 = Class542.aClass497_129.method30059(Class542.aClass497_129.method30068(local8, (short) 7718), (byte) 127);
		if (local28 == null) {
			local8 = arg0.anInt2065 * 825039395 | arg2 + 65536 << 10;
			local16 = (Class93_Sub1_Sub13) aClass253_1.method25983((long) local8 << 16);
			if (local16 != null) {
			...
			local28 = Class542.aClass497_129.method30059(Class542.aClass497_129.method30068(local8, (short) 6978), (byte) 125);
			if (local28 == null) {
				local8 = arg0.anInt2065 * 825039395 | 0x3FFFC00;
				local16 = (Class93_Sub1_Sub13) aClass253_1.method25983((long) local8 << 16);
				if (local16 != null) {
				...
				local28 = Class542.aClass497_129.method30059(Class542.aClass497_129.method30068(local8, (short) 1708), (byte) 117);
				if (local28 == null) {
					return null;
				} else if (local28.length <= 1) {
					return null;
	...
	static final void method36640(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
		...
		if (Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3 == null || Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aString81 == null) {
			...
			local9 = Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.method20052(true, (byte) -71);
		}
