...
public abstract class Class152 {
	...
	void method13995() {
		...
		synchronized (this.aClass240_21) {
			this.aClass240_21.method25833((byte) -59);
		}
	}

	@OriginalMember(owner = "client!vl", name = "e", descriptor = "(I)V", line = 219)
	void method13996(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_21;
		synchronized (this.aClass240_21) {
			this.aClass240_21.method25833((byte) -50);
		}
	}
	...
	void method13997() {
		@Pc(3) Class240 local3 = this.aClass240_21;
		synchronized (this.aClass240_21) {
			this.aClass240_21.method25833((byte) -70);
		}
	}

	@OriginalMember(owner = "client!vl", name = "m", descriptor = "(I)V", line = 231)
	void method13998(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_21;
		synchronized (this.aClass240_21) {
			this.aClass240_21.method25837(1161602830);
		}
	}
	...
	void method13999() {
		@Pc(3) Class240 local3 = this.aClass240_21;
		synchronized (this.aClass240_21) {
			this.aClass240_21.method25833((byte) -86);
		}
	}
	...
	void method14000() {
		@Pc(3) Class240 local3 = this.aClass240_21;
		synchronized (this.aClass240_21) {
			this.aClass240_21.method25833((byte) -85);
		}
	}
	...
	void method14001(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class240 local3 = this.aClass240_21;
		synchronized (this.aClass240_21) {
			this.aClass240_21.method25832(arg0, (byte) 67);
		}
	}
	...
	static void method14003(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) Class93_Sub1_Sub7 arg7, @OriginalArg(8) Class106 arg8, @OriginalArg(9) Class5 arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) short arg12) {
		...
		@Pc(34) int[] local34 = Class477.method29706(arg7, 1909722664);
		...
		if (arg7.aBoolean503) {
			Class284.aClass100_42.method18169(arg2 + 5 + arg9.method37(local38, Class110_Sub14.aClass100Array4, (byte) -77), arg6 - arg9.anInt6 * -8978697);
		}
	}

	@OriginalMember(owner = "client!vl", name = "aks", descriptor = "(Lclient!yf;I)V", line = 11718)
	static final void method14004(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method14005(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static void method14006(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		if (arg0) {
			if (-703563959 * client.anInt3526 != -1) {
				Class535.method30753(client.anInt3526 * -703563959, 1770633861);
			}
			...
			Class361.method27802((byte) -79);
			client.anInt3526 = Class93_Sub26.aClass645_15.anInt5768 * 914533045;
			if (client.anInt3526 * -703563959 != -1) {
				Class618.method32101(false, -1213042793);
				Class635.method32441((short) 255);
				Class56.method18036(client.anInt3526 * -703563959, (int[]) null, 683653350);
			}
		}
