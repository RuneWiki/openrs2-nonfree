...
public class Class39 implements Interface13, Interface5 {
	...
	public int[] method746(@OriginalArg(0) Object arg0) {
		if (this.anInt123 * -1630596103 == 0) {
			...
			return (int[]) (int[]) this.aHashMap1.get(arg0);
		}
	}
	...
	void method752(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(8) char local8;
		if (arg1 == 1) {
			local8 = Class615.method32089(arg0.method22414(495285591), (short) 150);
			this.aClass519_2 = Class519.method30319(local8, (byte) 8);
		} else if (arg1 == 2) {
			local8 = Class615.method32089(arg0.method22414(1839076446), (short) 150);
			this.aClass519_1 = Class519.method30319(local8, (byte) 8);
		} else if (arg1 == 3) {
			this.aString5 = arg0.method22427(-139955878);
		} else if (arg1 == 4) {
			this.anInt124 = arg0.method22419(-118643075) * -1904745181;
		} else {
			@Pc(83) int local83;
			@Pc(73) int local73;
			if (arg1 == 5 || arg1 == 6) {
				this.anInt123 = arg0.method22415(-1434290800) * 507854409;
				this.aMap2 = new HashMap(this.anInt123 * -1630596103);
				for (local73 = 0; local73 < this.anInt123 * -1630596103; local73++) {
					local83 = arg0.method22419(-118643075);
					@Pc(90) Object local90;
					if (arg1 == 5) {
						local90 = arg0.method22427(1334482136);
					} else {
						local90 = Integer.valueOf(arg0.method22419(-118643075));
					}
					this.aMap2.put(Integer.valueOf(local83), local90);
				}
			} else if (arg1 == 7 || arg1 == 8) {
				local73 = arg0.method22415(-1434290800);
				this.anInt123 = arg0.method22415(-1434290800) * 507854409;
				this.anObjectArray1 = new Object[local73];
				for (local83 = 0; local83 < this.anInt123 * -1630596103; local83++) {
					@Pc(143) int local143 = arg0.method22415(-1434290800);
					if (arg1 == 7) {
						this.anObjectArray1[local143] = arg0.method22427(1595170634);
					} else {
						this.anObjectArray1[local143] = Integer.valueOf(arg0.method22419(-118643075));
					}
				}
			} else if (arg1 == 101) {
				this.aClass519_2 = (Class519) Class107.method18119(Class519.method30312(1296094007), arg0.method22632((byte) -9), -1915563430);
			} else if (arg1 == 102) {
				this.aClass519_1 = (Class519) Class107.method18119(Class519.method30312(1382853603), arg0.method22632((byte) -91), -1915563430);
			}
		}
	}
	...
	void method757(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) char local8;
		if (arg1 == 1) {
			local8 = Class615.method32089(arg0.method22414(555189002), (short) 150);
			this.aClass519_2 = Class519.method30319(local8, (byte) 8);
		} else if (arg1 == 2) {
			local8 = Class615.method32089(arg0.method22414(1205391096), (short) 150);
			this.aClass519_1 = Class519.method30319(local8, (byte) 8);
		} else if (arg1 == 3) {
			this.aString5 = arg0.method22427(182992110);
		} else if (arg1 == 4) {
			this.anInt124 = arg0.method22419(-118643075) * -1904745181;
		} else {
			@Pc(83) int local83;
			...
			if (arg1 == 5 || arg1 == 6) {
				...
				for (local73 = 0; local73 < this.anInt123 * -1630596103; local73++) {
					...
					@Pc(90) Object local90;
					if (arg1 == 5) {
						local90 = arg0.method22427(16080687);
					} else {
						local90 = Integer.valueOf(arg0.method22419(-118643075));
					}
					this.aMap2.put(Integer.valueOf(local83), local90);
				...
				for (local83 = 0; local83 < this.anInt123 * -1630596103; local83++) {
					@Pc(143) int local143 = arg0.method22415(-1434290800);
					if (arg1 == 7) {
						this.anObjectArray1[local143] = arg0.method22427(1501588332);
					} else {
						this.anObjectArray1[local143] = Integer.valueOf(arg0.method22419(-118643075));
					}
				}
			} else if (arg1 == 101) {
				this.aClass519_2 = (Class519) Class107.method18119(Class519.method30312(1675883141), arg0.method22632((byte) -112), -1915563430);
			} else if (arg1 == 102) {
				this.aClass519_1 = (Class519) Class107.method18119(Class519.method30312(1558760533), arg0.method22632((byte) -66), -1915563430);
			}
		}
	}
