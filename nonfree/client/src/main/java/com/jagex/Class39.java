...
public class Class39 implements Interface13, Interface5 {
	...
	void method752(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) char local8;
		if (arg1 == 1) {
			local8 = Class615.method32089(arg0.method22414());
			this.aClass519_2 = Class519.method30319(local8);
		} else if (arg1 == 2) {
			local8 = Class615.method32089(arg0.method22414());
			this.aClass519_1 = Class519.method30319(local8);
		} else if (arg1 == 3) {
			this.aString5 = arg0.method22427();
		} else if (arg1 == 4) {
			this.anInt124 = arg0.method22419() * -1904745181;
		} else {
			@Pc(83) int local83;
			@Pc(73) int local73;
			if (arg1 == 5 || arg1 == 6) {
				this.anInt123 = arg0.method22415() * 507854409;
				this.aMap2 = new HashMap(this.anInt123 * -1630596103);
				for (local73 = 0; local73 < this.anInt123 * -1630596103; local73++) {
					local83 = arg0.method22419();
					@Pc(90) Object local90;
					if (arg1 == 5) {
						local90 = arg0.method22427();
					} else {
						local90 = Integer.valueOf(arg0.method22419());
					}
					this.aMap2.put(Integer.valueOf(local83), local90);
				}
			} else if (arg1 == 7 || arg1 == 8) {
				local73 = arg0.method22415();
				this.anInt123 = arg0.method22415() * 507854409;
				this.anObjectArray1 = new Object[local73];
				for (local83 = 0; local83 < this.anInt123 * -1630596103; local83++) {
					@Pc(143) int local143 = arg0.method22415();
					if (arg1 == 7) {
						this.anObjectArray1[local143] = arg0.method22427();
					} else {
						this.anObjectArray1[local143] = Integer.valueOf(arg0.method22419());
					}
				}
			} else if (arg1 == 101) {
				this.aClass519_2 = (Class519) Class107.method18119(Class519.method30312(), arg0.method22632());
			} else if (arg1 == 102) {
				this.aClass519_1 = (Class519) Class107.method18119(Class519.method30312(), arg0.method22632());
			}
		}
	}
	...
	public int method748(@OriginalArg(0) int arg0) {
		@Pc(4) Object local4 = this.method750(arg0);
	...
	public String method749(@OriginalArg(0) int arg0) {
		@Pc(4) Object local4 = this.method750(arg0);
	...
	Object method750(@OriginalArg(0) int arg0) {
	...
	public boolean method751(@OriginalArg(0) Object arg0) {
	...
	public int[] method767(@OriginalArg(0) Object arg0) {
		if (this.anInt123 * -1630596103 == 0) {
			return null;
		} else {
			if (this.aHashMap1 == null) {
	...
	static Class method769(@OriginalArg(0) String arg0) throws ClassNotFoundException {
		if (arg0.equals("B")) {
			return Byte.TYPE;
