...
public class Class146_Sub1 extends Class146 {
	...
	long aLong49 = Class305.method26796(1728522643) * 4786657289008338497L;
	...
	public Class146_Sub1(@OriginalArg(0) Class657 arg0) {
		...
		while (local38.hasNext()) {
			local45 = (Class508) local38.next();
			@Pc(77) Class535[] local77 = (Class535[]) (Class535[]) this.aHashMap2.get(local45);
	...
	public Class535 method11690(@OriginalArg(0) Class508 arg0) {
		...
		synchronized (this.aHashMap2) {
			@Pc(11) Class535[] local11 = (Class535[]) (Class535[]) this.aHashMap2.get(arg0);
			if (local11 == null) {
				return null;
			}
			for (@Pc(20) int local20 = 0; local20 < local11.length; local20++) {
				@Pc(28) Class535 local28 = local11[local20];
				@Pc(32) Class511 local32 = local28.method30701(-1726879620);
				if (local32 == Class511.aClass511_2) {
					local28.method30743(338889278);
					return local28;
				}
			}
			return null;
	...
	public int method11673(@OriginalArg(0) Object arg0, @OriginalArg(1) int arg1) {
		@Pc(2) long local2 = Class305.method26796(1912241529);
		...
		synchronized (local3) {
			...
			while (local11.hasNext()) {
				...
				for (@Pc(26) int local26 = 0; local26 < local24.length; local26++) {
					if (local24[local26].method30701(-1714273549) != Class511.aClass511_2) {
						local24[local26].method30640(235431295);
			...
			synchronized (local3) {
				...
				while (local72.hasNext()) {
					...
					for (@Pc(87) int local87 = 0; local87 < local85.length; local87++) {
						if (local85[local87].method30701(-2071952800) != Class511.aClass511_2) {
	...
	public void method11679() {
		if (this.aClass412_1 != null) {
			this.aClass412_1.method28658(-1245067333);
		}
		...
		while (true) {
			...
			do {
				...
				local26 = (Class535[]) (Class535[]) this.aHashMap2.get(local19);
				...
				while (!local64) {
					@Pc(78) float local78 = local26[local69].method30682(1010766785);
					@Pc(84) Class511 local84 = local26[local69].method30701(-2057256311);
					if (local78 >= 0.0F) {
						local64 = true;
					} else if (local84 == Class511.aClass511_6 || Class511.aClass511_4 == local84 || local84 == Class511.aClass511_5) {
						local26[local69].method30640(-1268329901);
					}
					local69--;
					if (local69 < 0) {
						local64 = true;
			...
			while (local69 >= local26.length - local62) {
				@Pc(129) Class511 local129 = local26[local69].method30701(-2131841288);
				if (local129 == Class511.aClass511_6) {
					local26[local69].method30640(-1353156640);
				}
				local69--;
			}
		}
	...
	public int method11680(@OriginalArg(0) Object arg0) {
		@Pc(2) long local2 = Class305.method26796(1556658126);
		@Pc(15) int local15 = (int) (180000.0F / ((float) (local2 - this.aLong49 * 4944910247795538369L) / 1000.0F));
		this.aLong49 = local2 * 4786657289008338497L;
		return local15;
	}
	...
	public Class535 method11674(@OriginalArg(0) Class508 arg0, @OriginalArg(1) byte arg1) {
		...
		synchronized (this.aHashMap2) {
			...
			for (@Pc(20) int local20 = 0; local20 < local11.length; local20++) {
				@Pc(28) Class535 local28 = local11[local20];
				@Pc(32) Class511 local32 = local28.method30701(-1689264311);
				if (local32 == Class511.aClass511_2) {
					local28.method30743(1125196266);
					return local28;
				}
			}
			return null;
	...
	public void method11683(@OriginalArg(0) int arg0) {
		if (this.aClass412_1 != null) {
			this.aClass412_1.method28658(-1904978473);
		}
		@Pc(12) Iterator local12 = this.aHashMap2.keySet().iterator();
		while (true) {
			@Pc(26) Class535[] local26;
			...
			do {
				...
				local69 = local26.length - 1;
				while (!local64) {
					@Pc(78) float local78 = local26[local69].method30682(-778058228);
					@Pc(84) Class511 local84 = local26[local69].method30701(-1723051060);
					if (local78 >= 0.0F) {
						local64 = true;
					} else if (local84 == Class511.aClass511_6 || Class511.aClass511_4 == local84 || local84 == Class511.aClass511_5) {
						local26[local69].method30640(-361792943);
					}
					local69--;
					if (local69 < 0) {
						local64 = true;
			...
			while (local69 >= local26.length - local62) {
				@Pc(129) Class511 local129 = local26[local69].method30701(-1727827719);
				if (local129 == Class511.aClass511_6) {
					local26[local69].method30640(-1301582749);
				}
				local69--;
			}
		}
	...
	public Class535 method11694(@OriginalArg(0) Class508 arg0) {
		...
		synchronized (this.aHashMap2) {
			...
			for (@Pc(20) int local20 = 0; local20 < local11.length; local20++) {
				@Pc(28) Class535 local28 = local11[local20];
				@Pc(32) Class511 local32 = local28.method30701(-1812634558);
				if (local32 == Class511.aClass511_2) {
					local28.method30743(-756860905);
					return local28;
				}
			}
			return null;
	...
	public int method11698(@OriginalArg(0) Object arg0) {
		@Pc(2) long local2 = Class305.method26796(1178738522);
		@Pc(15) int local15 = (int) (180000.0F / ((float) (local2 - this.aLong49 * 4944910247795538369L) / 1000.0F));
		this.aLong49 = local2 * 4786657289008338497L;
		return local15;
	}
	...
	public Class535 method11691(@OriginalArg(0) Class508 arg0) {
		...
		synchronized (this.aHashMap2) {
			...
			for (@Pc(20) int local20 = 0; local20 < local11.length; local20++) {
				@Pc(28) Class535 local28 = local11[local20];
				@Pc(32) Class511 local32 = local28.method30701(-1847652397);
				if (local32 == Class511.aClass511_2) {
					local28.method30743(633173123);
					return local28;
				}
			}
			return null;
	...
	public void method11699() {
		...
		synchronized (local3) {
			...
			while (local11.hasNext()) {
				...
				@Pc(24) Class535[] local24 = (Class535[]) (Class535[]) local3.get(local18);
				for (@Pc(26) int local26 = 0; local26 < local24.length; local26++) {
					if (local24[local26].method30701(-2070712437) != Class511.aClass511_2) {
						local24[local26].method30640(-694122279);
						local24[local26].method30635((byte) 8);
					}
				}
			}
		...
		while (!local60) {
			...
			synchronized (local3) {
				...
				while (local72.hasNext()) {
					...
					@Pc(85) Class535[] local85 = (Class535[]) (Class535[]) local3.get(local79);
					for (@Pc(87) int local87 = 0; local87 < local85.length; local87++) {
						if (local85[local87].method30701(-1768901447) != Class511.aClass511_2) {
							local85[local87].method30752((byte) 0);
							local60 = false;
						}
					}
	...
	public void method11700() {
		...
		synchronized (local3) {
			...
			while (local11.hasNext()) {
				...
				@Pc(24) Class535[] local24 = (Class535[]) (Class535[]) local3.get(local18);
				for (@Pc(26) int local26 = 0; local26 < local24.length; local26++) {
					if (local24[local26].method30701(-1804138788) != Class511.aClass511_2) {
						local24[local26].method30640(-229896311);
						local24[local26].method30635((byte) 8);
					}
				}
			}
		...
		while (!local60) {
			...
			synchronized (local3) {
				...
				while (local72.hasNext()) {
					...
					@Pc(85) Class535[] local85 = (Class535[]) (Class535[]) local3.get(local79);
					for (@Pc(87) int local87 = 0; local87 < local85.length; local87++) {
						if (local85[local87].method30701(-1993243280) != Class511.aClass511_2) {
							local85[local87].method30752((byte) 0);
							local60 = false;
						}
					}
