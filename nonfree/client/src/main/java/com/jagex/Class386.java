...
public class Class386 {
	...
	void method28164(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.aBoolean741) {
	...
	public int method28165(@OriginalArg(0) String arg0, @OriginalArg(1) byte arg1) {
	...
	public int method28166(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	void method28167(@OriginalArg(0) int arg0) {
		...
		this.method28208(1494104843);
	}

	@OriginalMember(owner = "client!kr", name = "w", descriptor = "(II)Ljava/lang/Long;", line = 97)
	public Long method28168(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.aClass16_33 == null) {
			return null;
		} else {
	...
	public String method28169(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.aClass16_33 == null) {
			return null;
		} else {
			@Pc(10) Class93 local10 = this.aClass16_33.method215((long) arg0);
	...
	public int[] method28170(@OriginalArg(0) byte arg0) {
		if (this.anIntArray436 == null) {
			...
			Class118.method8414(local9, this.anIntArray436, 1303118663);
		}
		return this.anIntArray436;
	}

	@OriginalMember(owner = "client!kr", name = "z", descriptor = "(JLjava/lang/String;IB)V", line = 125)
	void method28171(@OriginalArg(0) long arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		...
		if (this.aBoolean741 != arg0 > 0L) {
			...
			if (arg0 > 0L && (this.aLongArray24 == null || this.anInt4642 * 849728367 >= this.aLongArray24.length) || arg1 != null && (this.aStringArray30 == null || this.anInt4642 * 849728367 >= this.aStringArray30.length)) {
				this.method28224(this.anInt4642 * 849728367 + 5, 1089814854);
			}
			if (this.aLongArray24 != null) {
	...
	void method28172(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 < 0 || arg0 >= this.anInt4642 * 849728367) {
			throw new RuntimeException("");
		}
		this.anInt4642 -= -2076644465;
	...
	void method28175(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	int method28176(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) byte arg2) {
	...
	int method28178(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte arg4) {
	...
	boolean method28179(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (this.aClass16_33 == null) {
			this.aClass16_33 = new Class16(4);
		} else {
	...
	boolean method28180(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(5) int local5 = (0x1 << arg2) - 1;
		@Pc(18) int local18 = arg3 == 31 ? -1 : (0x1 << arg3 + 1) - 1;
		@Pc(22) int local22 = local18 ^ local5;
		@Pc(26) int local26 = arg1 << arg2;
	...
	boolean method28182(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		if (arg1 == null) {
			arg1 = "";
		} else if (arg1.length() > 80) {
			arg1 = arg1.substring(0, 80);
	...
	void method28183(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
		@Pc(3) int local3 = arg0.method22413((short) 16384);
		if (local3 < 1 || local3 > 6) {
			throw new RuntimeException("" + local3);
		}
		@Pc(25) int local25 = arg0.method22413((short) 16384);
		if ((local25 & 0x1) != 0) {
		...
		this.anInt4641 = arg0.method22419(-118643075) * 352216175;
		this.anInt4643 = arg0.method22419(-118643075) * -1492565541;
		if (local3 <= 3 && this.anInt4643 * -770780589 != 0) {
			this.anInt4643 += 1641984992;
		}
		this.anInt4642 = arg0.method22415(-1434290800) * -2076644465;
		this.anInt4647 = arg0.method22413((short) 16384) * -1208367903;
		this.aString196 = arg0.method22427(2067629806);
		if (local3 >= 4) {
			arg0.method22419(-118643075);
		}
		this.aBoolean743 = arg0.method22413((short) 16384) == 1;
		this.aByte152 = arg0.method22414(1264150025);
		this.aByte151 = arg0.method22414(468472349);
		this.aByte154 = arg0.method22414(1590344084);
		this.aByte158 = arg0.method22414(1847212710);
		@Pc(266) int local266;
		if (this.anInt4642 * 849728367 > 0) {
			...
			for (local266 = 0; local266 < this.anInt4642 * 849728367; local266++) {
				if (this.aBoolean741) {
					this.aLongArray24[local266] = arg0.method22423(-1621101286);
				}
				if (this.aBoolean742) {
					this.aStringArray30[local266] = arg0.method22426((byte) 124);
				}
				this.aByteArray89[local266] = arg0.method22414(1141867113);
				if (local3 >= 2) {
					this.anIntArray434[local266] = arg0.method22419(-118643075);
				}
				if (local3 >= 5) {
					this.anIntArray435[local266] = arg0.method22415(-1434290800);
				} else {
					this.anIntArray435[local266] = 0;
				}
				if (local3 >= 6) {
					this.aBooleanArray30[local266] = arg0.method22413((short) 16384) == 1;
				} else {
					this.aBooleanArray30[local266] = false;
				}
			}
			this.method28208(1939784602);
		}
		if (this.anInt4647 * 1113751329 > 0) {
			...
			for (local266 = 0; local266 < this.anInt4647 * 1113751329; local266++) {
				if (this.aBoolean741) {
					this.aLongArray25[local266] = arg0.method22423(-944039061);
				}
				if (this.aBoolean742) {
					this.aStringArray29[local266] = arg0.method22426((byte) 29);
				}
			}
		}
		if (local3 < 3) {
	...
	void method28199(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		this.anInt4642 = arg0.method22415(-1434290800) * -2076644465;
		this.anInt4647 = arg0.method22413((short) 16384) * -1208367903;
		this.aString196 = arg0.method22427(220022173);
		if (local3 >= 4) {
			arg0.method22419(-118643075);
		}
		this.aBoolean743 = arg0.method22413((short) 16384) == 1;
		this.aByte152 = arg0.method22414(1706285512);
		this.aByte151 = arg0.method22414(1674253805);
		this.aByte154 = arg0.method22414(861559558);
		this.aByte158 = arg0.method22414(728122446);
		@Pc(266) int local266;
		if (this.anInt4642 * 849728367 > 0) {
			if (this.aBoolean741 && (this.aLongArray24 == null || this.aLongArray24.length < this.anInt4642 * 849728367)) {
				this.aLongArray24 = new long[this.anInt4642 * 849728367];
			...
			for (local266 = 0; local266 < this.anInt4642 * 849728367; local266++) {
				if (this.aBoolean741) {
					this.aLongArray24[local266] = arg0.method22423(-1553052440);
				}
				if (this.aBoolean742) {
					this.aStringArray30[local266] = arg0.method22426((byte) 81);
				}
				this.aByteArray89[local266] = arg0.method22414(549803572);
				if (local3 >= 2) {
					this.anIntArray434[local266] = arg0.method22419(-118643075);
				}
				if (local3 >= 5) {
		...
		if (this.anInt4647 * 1113751329 > 0) {
			...
			for (local266 = 0; local266 < this.anInt4647 * 1113751329; local266++) {
				if (this.aBoolean741) {
					this.aLongArray25[local266] = arg0.method22423(387340036);
				}
				if (this.aBoolean742) {
					this.aStringArray29[local266] = arg0.method22426((byte) 13);
				}
			}
		}
		if (local3 < 3) {
		...
		while (local266-- > 0) {
			...
			if (local467 == 0) {
				...
				@Pc(490) long local490 = arg0.method22423(1654970508);
				this.aClass16_33.method221(new Class93_Sub11(local490), (long) local463);
			} else if (local467 == 2) {
				@Pc(507) String local507 = arg0.method22427(493379777);
				this.aClass16_33.method221(new Class93_Sub15(local507), (long) local463);
			}
		}
	}
	...
	void method28202(@OriginalArg(0) long arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		...
		if (this.aBoolean741 != arg0 > 0L) {
			...
			if (arg0 > 0L && (this.aLongArray24 == null || this.anInt4642 * 849728367 >= this.aLongArray24.length) || arg1 != null && (this.aStringArray30 == null || this.anInt4642 * 849728367 >= this.aStringArray30.length)) {
				this.method28224(this.anInt4642 * 849728367 + 5, 1273563213);
			}
			if (this.aLongArray24 != null) {
				this.aLongArray24[this.anInt4642 * 849728367] = arg0;
			}
	...
	public Class386(@OriginalArg(0) Class93_Sub41 arg0) {
		this.method28183(arg0, (byte) 109);
	}
	...
	void method28208(@OriginalArg(0) int arg0) {
		if (this.anInt4642 * 849728367 == 0) {
			this.anInt4644 = -1375360501;
			this.anInt4646 = -1191219821;
			return;
	...
	void method28211(@OriginalArg(0) long arg0, @OriginalArg(1) String arg1) {
		...
		if (this.aBoolean741 != arg0 > 0L) {
			...
			if (arg0 > 0L && (this.aLongArray25 == null || this.anInt4647 * 1113751329 >= this.aLongArray25.length) || arg1 != null && (this.aStringArray29 == null || this.anInt4647 * 1113751329 >= this.aStringArray29.length)) {
				this.method28164(this.anInt4647 * 1113751329 + 5, 2113698400);
			}
			if (this.aLongArray25 != null) {
	...
	int method28212(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) byte arg2) {
	...
	void method28217(@OriginalArg(0) long arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		if (arg1 != null && arg1.length() == 0) {
			arg1 = null;
		}
		if (this.aBoolean741 != arg0 > 0L) {
			...
			if (arg0 > 0L && (this.aLongArray25 == null || this.anInt4647 * 1113751329 >= this.aLongArray25.length) || arg1 != null && (this.aStringArray29 == null || this.anInt4647 * 1113751329 >= this.aStringArray29.length)) {
				this.method28164(this.anInt4647 * 1113751329 + 5, 2145114076);
			}
			if (this.aLongArray25 != null) {
				this.aLongArray25[this.anInt4647 * 1113751329] = arg0;
			}
	...
	public int[] method28220() {
		if (this.anIntArray436 == null) {
			...
			Class118.method8414(local9, this.anIntArray436, 1124094290);
		}
		return this.anIntArray436;
	}
	...
	void method28224(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.aBoolean741) {
			if (this.aLongArray24 == null) {
				this.aLongArray24 = new long[arg0];
			} else {
	...
	int method28226(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		if (arg1 == 126 || arg1 == 127) {
			...
			this.aByteArray89[arg0] = arg1;
			this.method28208(1586180487);
			return arg0;
		}
	}

	@OriginalMember(owner = "client!kr", name = "f", descriptor = "(II)Ljava/lang/Integer;", line = 90)
	public Integer method28227(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.aClass16_33 == null) {
			return null;
		} else {
			@Pc(10) Class93 local10 = this.aClass16_33.method215((long) arg0);
	...
	static final void method28236(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1483858371);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class183.method24573(local16, local22, arg0, -1324104243);
	}
	...
	static final void method28239(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(16) long local16 = Class49.method16609(177889820);
		if (local16 == 0L) {
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 5;
		} else {
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class40.method797(local16, local13, (byte) 41);
		}
	}
}
