...
public abstract class Class157 {
	...
	Class34 aClass34_2 = new Class34((Object) null, (Object) null);
	...
	void method14239(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		if (arg0 != this.aBoolean344) {
			this.aBoolean344 = arg0;
	...
	void method14240(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_27;
		synchronized (this.aClass240_27) {
			this.aClass240_27.method25837(1161602830);
		}
		local3 = this.aClass240_29;
		synchronized (this.aClass240_29) {
			this.aClass240_29.method25837(1161602830);
		}
		local3 = this.aClass240_28;
		synchronized (this.aClass240_28) {
			this.aClass240_28.method25837(1161602830);
		}
	}

	@OriginalMember(owner = "client!vh", name = "m", descriptor = "(I)V", line = 754)
	void method14241(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_27;
		synchronized (this.aClass240_27) {
			this.aClass240_27.method25833((byte) -86);
		}
		local3 = this.aClass240_29;
		synchronized (this.aClass240_29) {
			this.aClass240_29.method25833((byte) -93);
		}
		local3 = this.aClass240_28;
		synchronized (this.aClass240_28) {
			this.aClass240_28.method25833((byte) -56);
		}
		this.aClass231Array2 = new Class231[4];
		this.aClass34_2 = new Class34((Object) null, (Object) null);
	}

	@OriginalMember(owner = "client!vh", name = "k", descriptor = "(IB)V", line = 768)
	void method14242(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		@Pc(3) Class240 local3 = this.aClass240_27;
		synchronized (this.aClass240_27) {
			this.aClass240_27.method25832(arg0, (byte) 21);
		}
		local3 = this.aClass240_29;
		synchronized (this.aClass240_29) {
			this.aClass240_29.method25832(arg0, (byte) -8);
		}
		local3 = this.aClass240_28;
		synchronized (this.aClass240_28) {
			this.aClass240_28.method25832(arg0, (byte) 47);
		}
	}
	...
	void method14247(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_27;
		synchronized (this.aClass240_27) {
			this.aClass240_27.method25832(arg0, (byte) 59);
		}
		local3 = this.aClass240_29;
		synchronized (this.aClass240_29) {
			this.aClass240_29.method25832(arg0, (byte) 17);
		}
		local3 = this.aClass240_28;
		synchronized (this.aClass240_28) {
			this.aClass240_28.method25832(arg0, (byte) 22);
		}
	}
	...
	void method14254(@OriginalArg(0) int arg0) {
		...
		synchronized (this.aClass240_27) {
			this.aClass240_27.method25833((byte) -37);
		}
		local8 = this.aClass240_29;
		synchronized (this.aClass240_29) {
			this.aClass240_29.method25833((byte) -25);
		}
		local8 = this.aClass240_28;
		synchronized (this.aClass240_28) {
			this.aClass240_28.method25833((byte) -98);
		}
	}
	...
	void method14255(@OriginalArg(0) int arg0) {
		...
		@Pc(8) Class240 local8 = this.aClass240_27;
		synchronized (this.aClass240_27) {
			this.aClass240_27.method25833((byte) -33);
		}
		local8 = this.aClass240_29;
		synchronized (this.aClass240_29) {
			this.aClass240_29.method25833((byte) -45);
		}
		local8 = this.aClass240_28;
		synchronized (this.aClass240_28) {
			this.aClass240_28.method25833((byte) -65);
		}
	}
	...
	void method14256(@OriginalArg(0) int arg0) {
		...
		@Pc(8) Class240 local8 = this.aClass240_27;
		synchronized (this.aClass240_27) {
			this.aClass240_27.method25833((byte) -56);
		}
		local8 = this.aClass240_29;
		synchronized (this.aClass240_29) {
			this.aClass240_29.method25833((byte) -81);
		}
		local8 = this.aClass240_28;
		synchronized (this.aClass240_28) {
			this.aClass240_28.method25833((byte) -108);
		}
	}
	...
	void method14257(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_27;
		synchronized (this.aClass240_27) {
			this.aClass240_27.method25832(arg0, (byte) -15);
		}
		local3 = this.aClass240_29;
		synchronized (this.aClass240_29) {
			this.aClass240_29.method25832(arg0, (byte) -75);
		}
		local3 = this.aClass240_28;
		synchronized (this.aClass240_28) {
			this.aClass240_28.method25832(arg0, (byte) 19);
		}
	}
	...
	void method14259(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_27;
		synchronized (this.aClass240_27) {
			this.aClass240_27.method25832(arg0, (byte) -63);
		}
		local3 = this.aClass240_29;
		synchronized (this.aClass240_29) {
			this.aClass240_29.method25832(arg0, (byte) 78);
		}
		local3 = this.aClass240_28;
		synchronized (this.aClass240_28) {
			this.aClass240_28.method25832(arg0, (byte) 31);
		}
	}
	...
	void method14260(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_27;
		synchronized (this.aClass240_27) {
			this.aClass240_27.method25832(arg0, (byte) -51);
		}
		local3 = this.aClass240_29;
		synchronized (this.aClass240_29) {
			this.aClass240_29.method25832(arg0, (byte) 79);
		}
		local3 = this.aClass240_28;
		synchronized (this.aClass240_28) {
			this.aClass240_28.method25832(arg0, (byte) -19);
	...
	void method14261(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		this.anInt1666 = arg0 * 1924988561;
		@Pc(8) Class240 local8 = this.aClass240_27;
		synchronized (this.aClass240_27) {
			this.aClass240_27.method25833((byte) -85);
		}
		local8 = this.aClass240_29;
		synchronized (this.aClass240_29) {
			this.aClass240_29.method25833((byte) 0);
		}
		local8 = this.aClass240_28;
		synchronized (this.aClass240_28) {
			this.aClass240_28.method25833((byte) -64);
		}
	}
	...
	void method14262(@OriginalArg(0) int arg0) {
		...
		@Pc(8) Class240 local8 = this.aClass240_27;
		synchronized (this.aClass240_27) {
			this.aClass240_27.method25833((byte) -127);
		}
		local8 = this.aClass240_29;
		synchronized (this.aClass240_29) {
			this.aClass240_29.method25833((byte) -4);
		}
		local8 = this.aClass240_28;
		synchronized (this.aClass240_28) {
			this.aClass240_28.method25833((byte) -112);
		}
	}
	...
	static final void method14264(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anInt5891 -= -1915563430;
	}

	@OriginalMember(owner = "client!vh", name = "ng", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;I)V", line = 7419)
	static final void method14265(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		arg0.anObjectArray6 = Class499.method30148(local13, arg2, 1887385644);
		arg0.aBoolean680 = true;
	}

	@OriginalMember(owner = "client!vh", name = "akl", descriptor = "(Lclient!yf;B)V", line = 11637)
	static final void method14266(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		@Pc(20) boolean local20 = local2.method23180(Class93_Sub14.anInt1527 * -1951188017 + Class159.anInt1915, Class159_Sub1.anInt1952 * -1606693775 + Class159.anInt1921, Class687.anIntArray525, 1965402495);
		if (local20) {
	...
	static final void method14267(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		for (local13 = 0; local13 < local9; local13++) {
			...
			if (local22 != null) {
				local22.method19975(arg0, arg1, arg2, arg3, arg4, arg5, arg6, 1749488960);
			}
		}
		for (local13 = 0; local13 < client.anInt3540 * 568731113; local13++) {
			...
			if (local53 != null) {
				((Class132_Sub1_Sub1_Sub1) local53.anObject5).method19975(arg0, arg1, arg2, arg3, arg4, arg5, arg6, 884517015);
			}
		}
	}
	...
	static void method14268(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		...
		Class159_Sub1.anInt1951 = -919990023;
		Class358.method27780(-2054254286);
	}

	@OriginalMember(owner = "client!vh", name = "jn", descriptor = "(Lclient!yf;B)V", line = 6645)
	static final void method14269(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anInt5891 -= -1915563430;
	}

	@OriginalMember(owner = "client!vh", name = "ov", descriptor = "(Lclient!yf;I)V", line = 7665)
	static final void method14270(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1871787898);
