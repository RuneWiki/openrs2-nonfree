...
public class Class66 {
	...
	public static byte[] method1189(@OriginalArg(0) int arg0) {
		@Pc(7) byte[] local7 = (byte[]) (byte[]) aClass521_1.method30346(arg0, -2039760756);
		if (local7 == null) {
			local7 = new byte[512];
			...
			aClass521_1.method30347(arg0, local7, -345690454);
		}
		return local7;
	}
	...
	public static byte[] method1191(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(7) byte[] local7 = (byte[]) (byte[]) aClass521_1.method30346(arg0, -1538769377);
		if (local7 == null) {
			local7 = new byte[512];
			@Pc(19) Random local19 = new Random((long) arg0);
			@Pc(21) int local21;
			...
			aClass521_1.method30347(arg0, local7, 1505535680);
		}
		return local7;
	}
	...
	public static byte[] method1192(@OriginalArg(0) int arg0) {
		@Pc(7) byte[] local7 = (byte[]) (byte[]) aClass521_1.method30346(arg0, -1874298370);
		if (local7 == null) {
			local7 = new byte[512];
			@Pc(19) Random local19 = new Random((long) arg0);
			@Pc(21) int local21;
			...
			aClass521_1.method30347(arg0, local7, -1412497993);
		}
		return local7;
	}
	...
	public static byte[] method1193(@OriginalArg(0) int arg0) {
		@Pc(7) byte[] local7 = (byte[]) (byte[]) aClass521_1.method30346(arg0, -1414917165);
		if (local7 == null) {
			local7 = new byte[512];
			@Pc(19) Random local19 = new Random((long) arg0);
			@Pc(21) int local21;
			...
			aClass521_1.method30347(arg0, local7, -681286533);
		}
		return local7;
	}

	@OriginalMember(owner = "client!acp", name = "bdv", descriptor = "(Lclient!yf;B)V", line = 14712)
	static final void method1194(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		Class584.method31428(local12, (byte) 7);
	}

	@OriginalMember(owner = "client!acp", name = "w", descriptor = "(I)[B", line = 37)
	public static byte[] method1195(@OriginalArg(0) int arg0) {
		@Pc(7) byte[] local7 = (byte[]) (byte[]) aClass521_1.method30346(arg0, -1971003707);
		if (local7 == null) {
			local7 = new byte[512];
			@Pc(19) Random local19 = new Random((long) arg0);
			@Pc(21) int local21;
			...
			aClass521_1.method30347(arg0, local7, -518468916);
		}
		return local7;
	}
	...
	static final void method1197(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 706483547);
	...
	public static Class382 method1198(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		@Pc(6) Class390 local6 = Class708.method36756(-266018790)[arg0.method22413((short) 16384)];
		@Pc(13) Class392 local13 = Class252.method25978(501236194)[arg0.method22413((short) 16384)];
		@Pc(17) int local17 = arg0.method22482((byte) -67);
		@Pc(21) int local21 = arg0.method22482((byte) -103);
		@Pc(25) int local25 = arg0.method22436(-2129557247);
		@Pc(29) int local29 = arg0.method22419(-118643075);
	...
	static void method1199(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class327 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) long arg7) {
		...
		@Pc(113) int local113 = local110.method18189();
		@Pc(116) int local116 = local110.method18165();
		...
		if (local179) {
			...
			Class552.aClass100Array8[arg6].method18180((float) (arg0.anInt3981 * 1215292027) / 2.0F + (float) arg2 + 0.0F, (float) arg3 + (float) (arg0.anInt3982 * -1490598249) / 2.0F - 0.0F, (float) Class552.aClass100Array8[arg6].method18160() / 2.0F, (float) local285, 4096, (int) (-local220 / 6.283185307179586D * 65535.0D));
		} else if (arg1 == null) {
			local110.method18169(local129 + arg2, arg3 + local145);
		} else {
			local110.method18174(local129 + arg2, local145 + arg3, arg1.aClass96_1, arg2, arg3);
		}
	}
}
