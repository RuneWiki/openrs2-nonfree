...
public class Class124_Sub3_Sub2 extends Class124_Sub3 {
	...
	@Override
	void method21436(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) short arg2) {
		this.aFloatArray59 = new float[arg1];
		this.aFloatArray58 = new float[arg1];
		this.anInt2871 = 0;
		for (@Pc(12) int local12 = 0; local12 < arg1; local12++) {
			this.aFloatArray59[local12] = arg0.method22425(1002418729);
			this.aFloatArray58[local12] = arg0.method22425(-725917367);
		}
	}

	@OriginalMember(owner = "client!aqt", name = "ah", descriptor = "(I)V", line = 17)
	@Override
	void method21435(@OriginalArg(0) int arg0) {
		this.anInt2871 += 1443423479;
	}

	@OriginalMember(owner = "client!aqt", name = "ag", descriptor = "(FFFB)F", line = 21)
	@Override
	float method21434(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) byte arg3) {
	...
	void method21433(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2) {
		...
		if (this.aFloat219 > (float) this.aClass479Array5[this.anInt2871 * -963830585].method29712()) {
			this.aFloat219 = (float) this.aClass479Array5[this.anInt2871 * -963830585].method29712();
		}
	}
	...
	void method21446(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		this.anInt2871 = 0;
		for (@Pc(12) int local12 = 0; local12 < arg1; local12++) {
			this.aFloatArray59[local12] = arg0.method22425(-991162414);
			this.aFloatArray58[local12] = arg0.method22425(-903416837);
		}
	}
	...
	void method21447(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		this.anInt2871 = 0;
		for (@Pc(12) int local12 = 0; local12 < arg1; local12++) {
			this.aFloatArray59[local12] = arg0.method22425(-1471601071);
			this.aFloatArray58[local12] = arg0.method22425(-1215756767);
		}
	}
