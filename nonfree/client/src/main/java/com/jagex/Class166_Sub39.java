...
public class Class166_Sub39 extends Class166 {
	...
	public void method16341(@OriginalArg(0) byte arg0) {
		if (this.aClass93_Sub36_49.aClass166_Sub4_2.method15425(-1976597121) && !Class136.method10214(this.aClass93_Sub36_49.aClass166_Sub4_2.method15424((byte) 112), 1318369364)) {
			this.anInt2379 = 0;
		}
	...
	public int method16549(@OriginalArg(0) int arg0) {
		return Class136.method10214(this.aClass93_Sub36_49.aClass166_Sub4_2.method15424((byte) 80), 1852548080) ? 1 : 3;
	}

	@OriginalMember(owner = "client!anq", name = "s", descriptor = "(I)Z", line = 29)
	public boolean method16342(@OriginalArg(0) int arg0) {
		return Class136.method10214(this.aClass93_Sub36_49.aClass166_Sub4_2.method15424((byte) 74), -1803583866);
	}

	@OriginalMember(owner = "client!anq", name = "k", descriptor = "(II)V", line = 39)
	@Override
	public void method16545(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public int method16543(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return Class136.method10214(this.aClass93_Sub36_49.aClass166_Sub4_2.method15424((byte) 91), 725654255) ? 1 : 3;
	}

	@OriginalMember(owner = "client!anq", name = "p", descriptor = "(I)I", line = 34)
	@Override
	public int method16540(@OriginalArg(0) int arg0) {
		return Class136.method10214(this.aClass93_Sub36_49.aClass166_Sub4_2.method15424((byte) 60), -971472745) ? 1 : 3;
	}

	@OriginalMember(owner = "client!anq", name = "y", descriptor = "(I)I", line = 43)
	public int method16343(@OriginalArg(0) int arg0) {
	...
	public boolean method16344() {
		return Class136.method10214(this.aClass93_Sub36_49.aClass166_Sub4_2.method15424((byte) 76), -1783170618);
	}
	...
	public void method16345() {
		if (this.aClass93_Sub36_49.aClass166_Sub4_2.method15425(-343545763) && !Class136.method10214(this.aClass93_Sub36_49.aClass166_Sub4_2.method15424((byte) 83), 1982732690)) {
			this.anInt2379 = 0;
		}
		if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 2) {
			this.anInt2379 = this.method16542((byte) -51) * -88839937;
		}
	}
