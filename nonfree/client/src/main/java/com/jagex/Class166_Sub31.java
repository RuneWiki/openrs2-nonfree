...
public class Class166_Sub31 extends Class166 {
	...
	public void method16106(@OriginalArg(0) int arg0) {
	...
	public int method16108(@OriginalArg(0) short arg0) {
		return this.anInt2379 * 960141055;
	}
	...
	public boolean method16109(@OriginalArg(0) int arg0) {
		return true;
	}
	...
	public static final void method16117(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		...
		@Pc(32) Class175 local32 = Class330.method27372(-2070490767);
		@Pc(38) Class93_Sub22 local38 = Class102.method2592(Class446.aClass446_96, local32.aClass24_2, (byte) 33);
		local38.aClass93_Sub41_Sub2_1.method22510(Class46.method894(local29, -1614772735) + 3, (byte) -37);
		local38.aClass93_Sub41_Sub2_1.method22510(arg0 ? 1 : 0, (byte) -29);
		local38.aClass93_Sub41_Sub2_1.method22454(arg1, 2136911152);
		local38.aClass93_Sub41_Sub2_1.method22402(local29, 1257477998);
		local32.method24351(local38, -2102181116);
	}
}
