...
public class AbstractQueue_Sub1 extends AbstractQueue {
	...
	void method23706(@OriginalArg(0) int arg0) {
		@Pc(7) int local7 = (this.aClass441Array1.length << 1) + 1;
		this.aClass441Array1 = (Class441[]) (Class441[]) Arrays.copyOf(this.aClass441Array1, local7);
	}
	...
	public boolean offer(@OriginalArg(0) Object arg0) {
		...
		if (local20 == 0) {
			...
			this.method23707(local20, 1741552882);
		}
		return true;
	}
	...
	public boolean remove(@OriginalArg(0) Object arg0) {
		...
		this.method23708(local5.anInt4885 * 1369561009, 604624722);
		if (local48 == this.aClass441Array1[local5.anInt4885 * 1369561009]) {
			this.method23707(local5.anInt4885 * 1369561009, 1741552882);
		}
		return true;
	}

	@OriginalMember(owner = "client!att", name = "n", descriptor = "(II)V", line = 89)
	void method23707(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(4) Class441 local4 = this.aClass441Array1[arg0];
		while (arg0 > 0) {
	...
	void method23708(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(4) Class441 local4 = this.aClass441Array1[arg0];
		@Pc(11) int local11 = this.anInt3230 * 2087138905 >>> 1;
		while (arg0 < local11) {
			@Pc(20) int local20 = (arg0 << 1) + 1;
	...
	void method23709(@OriginalArg(0) int arg0) {
		@Pc(4) Class441 local4 = this.aClass441Array1[arg0];
		@Pc(11) int local11 = this.anInt3230 * 2087138905 >>> 1;
		while (arg0 < local11) {
			@Pc(20) int local20 = (arg0 << 1) + 1;
	...
	public int method23713() {
		return this.anInt3230 * 2087138905;
	}

	@OriginalMember(owner = "client!att", name = "q", descriptor = "(I)V", line = 89)
	void method23714(@OriginalArg(0) int arg0) {
		@Pc(4) Class441 local4 = this.aClass441Array1[arg0];
		while (arg0 > 0) {
			@Pc(12) int local12 = arg0 - 1 >>> 1;
			@Pc(17) Class441 local17 = this.aClass441Array1[local12];
	...
	void method23727(@OriginalArg(0) int arg0) {
		@Pc(4) Class441 local4 = this.aClass441Array1[arg0];
		@Pc(11) int local11 = this.anInt3230 * 2087138905 >>> 1;
		while (arg0 < local11) {
			@Pc(20) int local20 = (arg0 << 1) + 1;
	...
	void method23729(@OriginalArg(0) int arg0) {
		@Pc(4) Class441 local4 = this.aClass441Array1[arg0];
		while (arg0 > 0) {
			@Pc(12) int local12 = arg0 - 1 >>> 1;
			@Pc(17) Class441 local17 = this.aClass441Array1[local12];
	...
	public boolean method23731(@OriginalArg(0) Object arg0) {
		...
		this.aClass441Array1[local5.anInt4885 * 1369561009] = local48;
		this.aClass441Array1[local5.anInt4885 * 1369561009].anInt4885 = local5.anInt4885;
		this.method23708(local5.anInt4885 * 1369561009, -1620982263);
		if (local48 == this.aClass441Array1[local5.anInt4885 * 1369561009]) {
			this.method23707(local5.anInt4885 * 1369561009, 1741552882);
		}
		return true;
