...
public class Class584 {
	...
	static final void method31427(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	public static void method31428(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		if (arg0 < 1) {
