...
public class Class205 {
	...
	void method24675(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
						...
						if (local68 - arg0 >= -arg2 && local68 - arg0 <= arg2) {
							for (@Pc(84) int local84 = local41; local84 < local48; local84++) {
								if (local84 - arg1 >= -arg2 && local84 - arg1 <= arg2 && arg3[local68 - arg0 + arg2][local84 - arg1 + arg2]) {
									...
									this.aClass195ArrayArray1[local50][local32].method24599();
									continue label128;
								}
							}
						}
			...
			for (local32 = 0; local32 < this.anInt3383; local32++) {
				...
				for (local50 = 0; local50 < this.anInt3385; local50++) {
									...
									if (local257 != null) {
										...
										if (this.aClass104_Sub1_45.aBoolean106) {
											for (local265 = 0; local265 < local257.length; local265++) {
												local192.method22454(local257[local265] & 0xFFFF, 2131751172);
												local59++;
											}
										} else {
											for (local265 = 0; local265 < local257.length; local265++) {
												local192.method22393(local257[local265] & 0xFFFF, -1059514351);
												local59++;
											}
										}
									}
					...
					if (local59 > 0) {
						...
						OpenGL.glTranslatef((float) -local50 / local28, (float) -local32 / local28, 1.0F);
						OpenGL.glMatrixMode(5888);
						this.aClass195ArrayArray1[local50][local32].method24611(local192.aByteArray58, local59);
					}
				}
			}
		}
							...
							for (@Pc(223) int local223 = local66; local223 < local68; local223++) {
								if (local223 - arg0 >= -arg2 && local223 - arg0 <= arg2 && arg3[local223 - arg0 + arg2][local197 - arg1 + arg2]) {
									...
									if (local257 != null) {
										...
										if (this.aClass104_Sub1_45.aBoolean106) {
											for (local265 = 0; local265 < local257.length; local265++) {
												local192.method22454(local257[local265] & 0xFFFF, 2142693823);
												local59++;
											}
										} else {
											for (local265 = 0; local265 < local257.length; local265++) {
												local192.method22393(local257[local265] & 0xFFFF, -437272909);
												local59++;
											}
										}
									}
	...
	void method24677(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if (local31 > 0 && local28 > 0) {
			method24681(this.aByteArray66, local2.aByteArray62, local25, local23, local31, local28, local36, local38);
			this.method24680(arg1, arg2, local31, local28);
		}
	}

	@OriginalMember(owner = "client!ci", name = "k", descriptor = "(Lclient!ara;II)V", line = 164)
	void method24678(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(2) Class93_Sub1_Sub4_Sub2 local2 = (Class93_Sub1_Sub4_Sub2) arg0;
		arg1 += local2.anInt3212 + 1;
		arg2 += local2.anInt3209 + 1;
		@Pc(23) int local23 = arg1 + arg2 * this.anInt3384;
		...
		if (local31 > 0 && local28 > 0) {
			method24682(this.aByteArray66, local2.aByteArray62, local25, local23, local31, local28, local36, local38);
			this.method24680(arg1, arg2, local31, local28);
		}
	}
	...
	void method24680(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	static final void method24681(@OriginalArg(0) byte[] arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
	...
	static final void method24682(@OriginalArg(0) byte[] arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		@Pc(4) int local4 = -(arg4 >> 2);
		@Pc(9) int local9 = -(arg4 & 0x3);
		for (@Pc(12) int local12 = -arg5; local12 < 0; local12++) {
			@Pc(16) int local16;
	...
	static final boolean method24683(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
	...
	static final void method24684(@OriginalArg(0) byte[] arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		@Pc(4) int local4 = -(arg4 >> 2);
		@Pc(9) int local9 = -(arg4 & 0x3);
		for (@Pc(12) int local12 = -arg5; local12 < 0; local12++) {
			@Pc(16) int local16;
	...
	void method24685(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		this.aClass104_Sub1_45.method3791(false);
		this.aClass104_Sub1_45.method3816(false);
		this.aClass104_Sub1_45.method3801(-2);
		this.aClass104_Sub1_45.method3805(1);
							...
							for (@Pc(223) int local223 = local66; local223 < local68; local223++) {
								if (local223 - arg0 >= -arg2 && local223 - arg0 <= arg2 && arg3[local223 - arg0 + arg2][local197 - arg1 + arg2]) {
									...
									if (local257 != null) {
										...
										if (this.aClass104_Sub1_45.aBoolean106) {
											for (local265 = 0; local265 < local257.length; local265++) {
												local192.method22454(local257[local265] & 0xFFFF, 2127846113);
												local59++;
											}
										} else {
											for (local265 = 0; local265 < local257.length; local265++) {
												local192.method22393(local257[local265] & 0xFFFF, -971449743);
												local59++;
											}
										}
									}
	...
	boolean method24686(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(2) Class93_Sub1_Sub4_Sub2 local2 = (Class93_Sub1_Sub4_Sub2) arg0;
		arg1 += local2.anInt3212 + 1;
		arg2 += local2.anInt3209 + 1;
		@Pc(23) int local23 = arg1 + arg2 * this.anInt3384;
		...
		if (local29 > 0 && local26 > 0) {
			...
			return method24683(this.aByteArray66, local23, local29, local26, local34, local123);
		} else {
			return false;
		}
	}
	...
	boolean method24687(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(2) Class93_Sub1_Sub4_Sub2 local2 = (Class93_Sub1_Sub4_Sub2) arg0;
		arg1 += local2.anInt3212 + 1;
		arg2 += local2.anInt3209 + 1;
		@Pc(23) int local23 = arg1 + arg2 * this.anInt3384;
	...
	void method24688(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (this.aClass195ArrayArray1 == null) {
			return;
		}
		@Pc(9) int local9 = arg0 - 1 >> 7;
	...
	void method24689(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (this.aClass195ArrayArray1 == null) {
			return;
		}
		@Pc(9) int local9 = arg0 - 1 >> 7;
	...
	void method24690(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		this.aClass104_Sub1_45.method3791(false);
		this.aClass104_Sub1_45.method3816(false);
		this.aClass104_Sub1_45.method3801(-2);
		this.aClass104_Sub1_45.method3805(1);
							...
							for (@Pc(223) int local223 = local66; local223 < local68; local223++) {
								if (local223 - arg0 >= -arg2 && local223 - arg0 <= arg2 && arg3[local223 - arg0 + arg2][local197 - arg1 + arg2]) {
									...
									if (local257 != null) {
										...
										if (this.aClass104_Sub1_45.aBoolean106) {
											for (local265 = 0; local265 < local257.length; local265++) {
												local192.method22454(local257[local265] & 0xFFFF, 2144950106);
												local59++;
											}
										} else {
											for (local265 = 0; local265 < local257.length; local265++) {
												local192.method22393(local257[local265] & 0xFFFF, -580967337);
												local59++;
											}
										}
									}
	...
	boolean method24695(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(2) Class93_Sub1_Sub4_Sub2 local2 = (Class93_Sub1_Sub4_Sub2) arg0;
		arg1 += local2.anInt3212 + 1;
		arg2 += local2.anInt3209 + 1;
		@Pc(23) int local23 = arg1 + arg2 * this.anInt3384;
	...
	static final void method24696(@OriginalArg(0) byte[] arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		@Pc(4) int local4 = -(arg4 >> 2);
		@Pc(9) int local9 = -(arg4 & 0x3);
		for (@Pc(12) int local12 = -arg5; local12 < 0; local12++) {
			@Pc(16) int local16;
