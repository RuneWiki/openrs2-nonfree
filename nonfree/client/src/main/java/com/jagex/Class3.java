...
public class Class3 {
	...
	public static Class3 method21(@OriginalArg(0) int arg0) {
		@Pc(2) Class3[] local2 = Class529.method30399((byte) 58);
	...
	static final void method22(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		if (local38.method22922(local23, (byte) -126).anInt5852 * 1337578489 != 0) {
			throw new RuntimeException("");
		}
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = local38.method22919(local23, local33, 2130732003);
	}

	@OriginalMember(owner = "client!aaa", name = "f", descriptor = "(B)V", line = 140)
	public static final void method23(@OriginalArg(0) byte arg0) {
		if (Class411.anInt4721 * 327612781 != 7) {
			Class411.aClass175_3.method24355((byte) 47);
			Class594.method31740(1712001575);
			Class680.method33243(1418060216);
		}
	}
}
