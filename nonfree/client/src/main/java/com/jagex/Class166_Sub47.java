...
public class Class166_Sub47 extends Class166 {
	...
	public void method16555(@OriginalArg(0) int arg0) {
		@Pc(5) int local5 = this.aClass93_Sub36_49.aClass166_Sub4_1.method15424((byte) 77);
	...
	int method16549(@OriginalArg(0) int arg0) {
		if (arg0 == 0) {
			...
			@Pc(19) int local19 = this.aClass93_Sub36_49.aClass166_Sub4_1.method15424((byte) 90);
	...
	int method16543(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 == 0) {
			...
			@Pc(19) int local19 = this.aClass93_Sub36_49.aClass166_Sub4_1.method15424((byte) 55);
			return local19 == 3 || local19 == 5 ? 1 : 3;
		}
	}
	...
	public int method16556(@OriginalArg(0) short arg0) {
		return this.anInt2379 * 960141055;
	}
	...
	@Override
	int method16541() {
		@Pc(5) int local5 = this.aClass93_Sub36_49.aClass166_Sub4_1.method15424((byte) 46);
	...
	@Override
	int method16550() {
		@Pc(5) int local5 = this.aClass93_Sub36_49.aClass166_Sub4_1.method15424((byte) 34);
		return local5 == 3 || local5 == 5 ? 0 : 0;
	}
	...
	@Override
	int method16547() {
		@Pc(5) int local5 = this.aClass93_Sub36_49.aClass166_Sub4_1.method15424((byte) 56);
		return local5 == 3 || local5 == 5 ? 0 : 0;
	}
	...
	@Override
	int method16548() {
		@Pc(5) int local5 = this.aClass93_Sub36_49.aClass166_Sub4_1.method15424((byte) 104);
		return local5 == 3 || local5 == 5 ? 0 : 0;
	}
	...
	int method16542(@OriginalArg(0) byte arg0) {
		@Pc(5) int local5 = this.aClass93_Sub36_49.aClass166_Sub4_1.method15424((byte) 64);
		return local5 == 3 || local5 == 5 ? 0 : 0;
	}

	@OriginalMember(owner = "client!anz", name = "y", descriptor = "()V", line = 20)
	public void method16557() {
		@Pc(5) int local5 = this.aClass93_Sub36_49.aClass166_Sub4_1.method15424((byte) 75);
		if (local5 != 3 && local5 != 5) {
			this.anInt2379 = 0;
		}
		...
		if (this.anInt2379 * 960141055 != 0 && this.anInt2379 * 960141055 != 1) {
			this.anInt2379 = this.method16542((byte) 5) * -88839937;
		}
	}
	...
	int method16540(@OriginalArg(0) int arg0) {
		if (arg0 == 0) {
			...
			@Pc(19) int local19 = this.aClass93_Sub36_49.aClass166_Sub4_1.method15424((byte) 92);
			return local19 == 3 || local19 == 5 ? 1 : 3;
		}
	}
}
