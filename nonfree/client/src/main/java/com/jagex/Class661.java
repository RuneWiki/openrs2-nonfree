...
public class Class661 implements Interface13 {
	...
	public void method36654(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
		while (true) {
			...
			this.method32835(arg0, local3, -1614610382);
		}
	}

	@OriginalMember(owner = "client!xj", name = "c", descriptor = "()Lclient!de;", line = 38)
	public synchronized Class105 method32833() {
		@Pc(10) Class105 local10 = (Class105) this.aClass162_1.aClass240_37.method25839((long) (this.anInt5825 * -1818466771));
		if (local10 != null) {
			return local10;
		}
		local10 = Class203.method24652(this.aClass162_1.aClass497_56, this.anInt5825 * -1818466771, 0);
		if (local10 != null) {
			this.aClass162_1.aClass240_37.method25830(local10, (long) (this.anInt5825 * -1818466771));
		}
		return local10;
	}
	...
	public synchronized Class105 method32834(@OriginalArg(0) int arg0) {
		@Pc(10) Class105 local10 = (Class105) this.aClass162_1.aClass240_37.method25839((long) (this.anInt5825 * -1818466771));
		if (local10 != null) {
			return local10;
		}
	...
	public void method36655(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			...
			this.method32835(arg0, local3, -1208991450);
		}
	}
	...
	public void method36656(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			...
			this.method32835(arg0, local3, -404219092);
		}
	}

	@OriginalMember(owner = "client!xj", name = "u", descriptor = "(Lclient!alw;II)V", line = 29)
	void method32835(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg1 == 1) {
			this.anInt5825 = arg0.method22436(-1502285807) * -1817257563;
		} else if (arg1 == 2) {
			this.anInt5826 = arg0.method22413((short) 16384) * 751866733;
			this.anInt5827 = arg0.method22413((short) 16384) * -2078419265;
		}
	}

	@OriginalMember(owner = "client!xj", name = "r", descriptor = "()Lclient!de;", line = 38)
	public synchronized Class105 method32836() {
		@Pc(10) Class105 local10 = (Class105) this.aClass162_1.aClass240_37.method25839((long) (this.anInt5825 * -1818466771));
		if (local10 != null) {
			return local10;
		}
	...
	public void method36658(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			...
			this.method32835(arg0, local3, -1378804945);
		}
	}
	...
	public void method36657(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			...
			this.method32835(arg0, local3, -328638672);
		}
	}

	@OriginalMember(owner = "client!xj", name = "an", descriptor = "(Lclient!yf;B)V", line = 5076)
	static final void method32839(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	public static boolean method32840(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (Class244.aClass244_2 == Class136.aClass244_1) {
			@Pc(23) byte[] local23 = Class446.aClass497_117.method30059(arg0, (byte) 58);
			if (local23 == null) {
				return false;
			}
			@Pc(33) Class93_Sub41 local33 = new Class93_Sub41(local23);
			Class437.method28819(local33, -1420512156);
			...
			local42 = local33.method22632((byte) -18);
			...
			local63 = local33.method22632((byte) -74);
			...
			local84 = local33.method22632((byte) -53);
			...
			local106 = local33.method22632((byte) -100);
			...
			local127 = local33.method22632((byte) -108);
		...
		if (Class136.aClass244_1 == Class244.aClass244_3) {
			...
			for (local40 = 0; local40 < local168.length; local40++) {
				...
				if (!local178.method25808(-582205390)) {
					local166 = false;
				}
			}
			...
			for (local40 = 0; local40 < local188.length; local40++) {
				...
				if (!local198.method20139(-2020544498)) {
					local166 = false;
				}
			}
			...
			for (local40 = 0; local40 < local208.length; local40++) {
				...
				if (!local218.method25883(-565555133)) {
					local166 = false;
				}
			}
			if (!local166) {
	...
	static final void method32843(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		Class499.method30148(local13, arg2, -922353742);
	}

	@OriginalMember(owner = "client!xj", name = "k", descriptor = "(Lclient!alw;B)Lclient!kp;", line = 24)
	public static Class125 method32844(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
		@Pc(3) Class125 local3 = Class32_Sub4.method16727(arg0, -423624971);
		@Pc(7) int local7 = arg0.method22436(-280326472);
		@Pc(11) int local11 = arg0.method22436(-1674557000);
		@Pc(15) int local15 = arg0.method22436(-1727622688);
		@Pc(19) int local19 = arg0.method22436(-1967552013);
		@Pc(23) int local23 = arg0.method22436(-794453534);
		@Pc(27) int local27 = arg0.method22436(-2087916654);
