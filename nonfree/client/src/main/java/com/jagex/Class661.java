...
public class Class661 implements Interface13 {
	...
	public static Class125 method32844(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(3) Class125 local3 = Class32_Sub4.method16727(arg0);
		@Pc(7) int local7 = arg0.method22436();
		@Pc(11) int local11 = arg0.method22436();
		@Pc(15) int local15 = arg0.method22436();
		@Pc(19) int local19 = arg0.method22436();
		@Pc(23) int local23 = arg0.method22436();
		@Pc(27) int local27 = arg0.method22436();
	...
	void method32835(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt5825 = arg0.method22436() * -1817257563;
		} else if (arg1 == 2) {
			this.anInt5826 = arg0.method22413() * 751866733;
			this.anInt5827 = arg0.method22413() * -2078419265;
		}
	}
	...
	public synchronized Class105 method32834() {
		@Pc(10) Class105 local10 = (Class105) this.aClass162_1.aClass240_37.method25839((long) (this.anInt5825 * -1818466771));
		if (local10 != null) {
			return local10;
		}
	...
	public static boolean method32840(@OriginalArg(0) int arg0) {
		...
		if (Class244.aClass244_2 == Class136.aClass244_1) {
			...
			for (local42 = 0; local42 < local40; local42++) {
				Class249.aClass22_51.method407(new Class93_Sub27(local33));
			}
			...
			for (@Pc(148) int local148 = 0; local148 < local127; local148++) {
				Class249.aClass110Array1[local148] = Class18.method271(local33);
			}
	...
	static void method32841(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
	...
	public static void method32842(@OriginalArg(0) Class132_Sub1_Sub1_Sub1_Sub2 arg0) {
	...
	static final void method32839(@OriginalArg(0) Class681 arg0) {
	...
	static final void method32843(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
