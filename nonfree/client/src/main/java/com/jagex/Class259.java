...
class Class259 implements Interface39 {
	...
	public float method26345(@OriginalArg(0) int arg0) {
		return (float) Class51.aClass93_Sub36_1.aClass166_Sub35_4.method16223(574500123) / 255.0F;
	}

	@OriginalMember(owner = "client!fc", name = "n", descriptor = "()F", line = 477)
	@Override
	public float method26346() {
		return (float) Class51.aClass93_Sub36_1.aClass166_Sub35_4.method16223(1170062514) / 255.0F;
	}

	@OriginalMember(owner = "client!fc", name = "axf", descriptor = "(Lclient!yf;I)V", line = 13947)
	static final void method26145(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method26146(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
