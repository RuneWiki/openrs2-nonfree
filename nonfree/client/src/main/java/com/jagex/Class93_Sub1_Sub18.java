...
public class Class93_Sub1_Sub18 extends Class93_Sub1 {
	...
	public int method22917(@OriginalArg(0) int arg0) {
	...
	public void method22918(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int[] arg1) {
		...
		for (@Pc(5) int local5 = 0; local5 < this.anIntArray265.length && local5 < arg1.length; local5++) {
			@Pc(22) int local22 = this.method22922(local5, (byte) -90).anInt5853 * -2006530395;
			if (local22 > 0) {
				arg0.method22549((long) arg1[local5], local22, 2010424915);
			}
		}
	}

	@OriginalMember(owner = "client!asq", name = "u", descriptor = "(III)I", line = 96)
	public int method22919(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	public String method22920(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
		...
		if (this.anIntArray265 != null) {
			for (@Pc(10) int local10 = 0; local10 < this.anIntArray265.length; local10++) {
				...
				local4.append(this.aClass58_1.method1093(this.method22922(local10, (byte) -35), this.anIntArrayArray46[local10], arg0.method22424(Class573.method31345(this.anIntArray265[local10], 1449752659).anInt5854 * -1499792773, -2140812451)));
			}
		}
	...
	public void method22921(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2) {
		if (this.anIntArray265 == null) {
			return;
		}
		for (@Pc(5) int local5 = 0; local5 < this.anIntArray265.length && local5 < arg1.length; local5++) {
			@Pc(22) int local22 = this.method22922(local5, (byte) -37).anInt5853 * -2006530395;
			if (local22 > 0) {
				arg0.method22549((long) arg1[local5], local22, 1316257943);
			}
		}
	}

	@OriginalMember(owner = "client!asq", name = "l", descriptor = "(IB)Lclient!xs;", line = 91)
	public Class669 method22922(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		return this.anIntArray265 == null || arg0 < 0 || arg0 > this.anIntArray265.length ? null : Class573.method31345(this.anIntArray265[arg0], 66598609);
	}
	...
	void method22924(@OriginalArg(0) byte arg0) {
		if (this.anIntArray266 != null) {
			for (@Pc(4) int local4 = 0; local4 < this.anIntArray266.length; local4++) {
				this.anIntArray266[local4] |= 0x8000;
			}
	...
	void method22925(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			...
			this.method22934(arg0, local3, (byte) 32);
		}
	}
	...
	void method22926(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			...
			this.method22934(arg0, local3, (byte) 73);
		}
	}
	...
	void method22927(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			...
			this.method22934(arg0, local3, (byte) 17);
		}
	}
	...
	void method22929(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.aStringArray21 = client.method25402(arg0.method22427(1128505285), '<', 1771584241);
			return;
		}
		@Pc(18) int local18;
		@Pc(24) int local24;
		if (arg1 == 2) {
			local18 = arg0.method22413((short) 16384);
			this.anIntArray266 = new int[local18];
			for (local24 = 0; local24 < local18; local24++) {
				this.anIntArray266[local24] = arg0.method22415(-1434290800);
			}
		} else if (arg1 == 3) {
			local18 = arg0.method22413((short) 16384);
			...
			for (local24 = 0; local24 < local18; local24++) {
				@Pc(61) int local61 = arg0.method22415(-1434290800);
				@Pc(65) Class669 local65 = Class573.method31345(local61, 1206101623);
				if (local65 != null) {
					...
					for (@Pc(84) int local84 = 0; local84 < local65.anInt5851 * -1775819283; local84++) {
						this.anIntArrayArray46[local24][local84] = arg0.method22415(-1434290800);
					}
				}
			}
		} else if (arg1 == 4) {
	...
	public void method22930(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int[] arg1) {
		...
		for (@Pc(5) int local5 = 0; local5 < this.anIntArray265.length && local5 < arg1.length; local5++) {
			@Pc(22) int local22 = this.method22922(local5, (byte) -43).anInt5853 * -2006530395;
			if (local22 > 0) {
				arg0.method22549((long) arg1[local5], local22, 1197842550);
			}
		}
	}
	...
	public void method22931(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int[] arg1) {
		...
		for (@Pc(5) int local5 = 0; local5 < this.anIntArray265.length && local5 < arg1.length; local5++) {
			@Pc(22) int local22 = this.method22922(local5, (byte) -67).anInt5853 * -2006530395;
			if (local22 > 0) {
				arg0.method22549((long) arg1[local5], local22, 841036994);
			}
		}
	}
	...
	public void method22932(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int[] arg1) {
		...
		for (@Pc(5) int local5 = 0; local5 < this.anIntArray265.length && local5 < arg1.length; local5++) {
			@Pc(22) int local22 = this.method22922(local5, (byte) -71).anInt5853 * -2006530395;
			if (local22 > 0) {
				arg0.method22549((long) arg1[local5], local22, 580108022);
			}
		}
	}
	...
	void method22934(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		if (arg1 == 1) {
			this.aStringArray21 = client.method25402(arg0.method22427(802627326), '<', 1972213578);
			return;
		}
		@Pc(18) int local18;
		@Pc(24) int local24;
		if (arg1 == 2) {
			...
			for (local24 = 0; local24 < local18; local24++) {
				@Pc(61) int local61 = arg0.method22415(-1434290800);
				@Pc(65) Class669 local65 = Class573.method31345(local61, -557748748);
				if (local65 != null) {
					this.anIntArray265[local24] = local61;
					this.anIntArrayArray46[local24] = new int[local65.anInt5851 * -1775819283];
					for (@Pc(84) int local84 = 0; local84 < local65.anInt5851 * -1775819283; local84++) {
	...
	void method22938(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.aStringArray21 = client.method25402(arg0.method22427(2126221792), '<', 2073624696);
			return;
		}
		@Pc(18) int local18;
		@Pc(24) int local24;
		if (arg1 == 2) {
			...
			for (local24 = 0; local24 < local18; local24++) {
				@Pc(61) int local61 = arg0.method22415(-1434290800);
				@Pc(65) Class669 local65 = Class573.method31345(local61, 2059298898);
				if (local65 != null) {
					this.anIntArray265[local24] = local61;
					this.anIntArrayArray46[local24] = new int[local65.anInt5851 * -1775819283];
					for (@Pc(84) int local84 = 0; local84 < local65.anInt5851 * -1775819283; local84++) {
	...
	void method22939(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		while (true) {
			@Pc(3) int local3 = arg0.method22413((short) 16384);
			if (local3 == 0) {
				return;
			}
			this.method22934(arg0, local3, (byte) 42);
		}
	}
	...
	public Class669 method22940(@OriginalArg(0) int arg0) {
		return this.anIntArray265 == null || arg0 < 0 || arg0 > this.anIntArray265.length ? null : Class573.method31345(this.anIntArray265[arg0], 1571567367);
	}
	...
	public Class669 method22941(@OriginalArg(0) int arg0) {
		return this.anIntArray265 == null || arg0 < 0 || arg0 > this.anIntArray265.length ? null : Class573.method31345(this.anIntArray265[arg0], -187134238);
	}
	...
	public Class669 method22943(@OriginalArg(0) int arg0) {
		return this.anIntArray265 == null || arg0 < 0 || arg0 > this.anIntArray265.length ? null : Class573.method31345(this.anIntArray265[arg0], -187579739);
	}
	...
	public String method22946(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		if (this.anIntArray265 != null) {
			for (@Pc(10) int local10 = 0; local10 < this.anIntArray265.length; local10++) {
				local4.append(this.aStringArray21[local10]);
				local4.append(this.aClass58_1.method1093(this.method22922(local10, (byte) -81), this.anIntArrayArray46[local10], arg0.method22424(Class573.method31345(this.anIntArray265[local10], -936189345).anInt5854 * -1499792773, 1836890668)));
			}
		}
		local4.append(this.aStringArray21[this.aStringArray21.length - 1]);
		return local4.toString();
	...
	public String method22947(@OriginalArg(0) int arg0) {
		@Pc(4) StringBuilder local4 = new StringBuilder(80);
		if (this.aStringArray21 == null) {
			return "";
		}
