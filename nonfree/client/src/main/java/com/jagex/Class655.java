...
public class Class655 {
	...
	public static void method32721() {
		Class431.method28774((byte) 5);
		aClass163_Sub2_1.method14922((short) 19868);
		aClass163_Sub1_1.method14922((short) 14738);
		...
		if (client.anInt3450 * -938319179 > 0) {
			...
			local17.aClass93_Sub41_Sub2_1.method22454(client.anInt3450 * 541690580, 2131005932);
			for (local26 = 0; local26 < client.anInt3450 * -938319179; local26++) {
				...
				local17.aClass93_Sub41_Sub2_1.method22510(local35.method13696((byte) 0), (byte) -115);
				local17.aClass93_Sub41_Sub2_1.method22394((int) local43, (byte) 119);
			}
			client.aClass175_2.method24351(local17, -1777655733);
		}
		...
		if (client.aBoolean619 && anInt5808 * 660178843 <= 0) {
			...
			if (Class429.anInt4781 * -1453926679 != 3) {
				...
				local114 = Class155.method15307(local107.aClass471_1, -610065933) >> 3;
				@Pc(116) short local116 = 1024;
				local26 = (local116 * 3 - (Class230.method25652(local107.aClass471_1, 1416294260) >> 3)) % (local116 * 2);
			} else {
				local114 = 0;
				local26 = 0;
			}
			@Pc(153) Class93_Sub22 local153 = Class102.method2592(Class446.aClass446_39, client.aClass175_2.aClass24_2, (byte) 16);
			local153.aClass93_Sub41_Sub2_1.method22456(local26, (short) 255);
			local153.aClass93_Sub41_Sub2_1.method22454(local114, 2140478834);
			client.aClass175_2.method24351(local153, -2066036156);
		}
		if (Class20.aBoolean10 != aBoolean861) {
			...
			local17.aClass93_Sub41_Sub2_1.method22510(Class20.aBoolean10 ? 1 : 0, (byte) -103);
			client.aClass175_2.method24351(local17, -1512555639);
		}
		if (!client.aBoolean601) {
			local17 = Class102.method2592(Class446.aClass446_19, client.aClass175_2.aClass24_2, (byte) 70);
			local17.aClass93_Sub41_Sub2_1.method22510(0, (byte) -99);
			...
			local17.aClass93_Sub41_Sub2_1.method22405(local214.aByteArray58, 0, local214.anInt3070 * 212851357, 2026842986);
			local17.aClass93_Sub41_Sub2_1.method22537(local17.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local26, (byte) 13);
			client.aClass175_2.method24351(local17, -1522319567);
			client.aBoolean601 = true;
		}
		if (client.aBoolean602 || Class51.aClass93_Sub36_1.aClass166_Sub4_1.method15424((byte) 119) != 1) {
			return;
		}
		...
		local259.aClass93_Sub41_Sub2_1.method22454(0, 2126321278);
		@Pc(270) int local270 = local259.aClass93_Sub41_Sub2_1.anInt3070 * 212851357;
		if (local253 == null || local253.length == 0) {
			local259.aClass93_Sub41_Sub2_1.method22510(0, (byte) -118);
		} else {
			local259.aClass93_Sub41_Sub2_1.method22510(1, (byte) -90);
			...
			label94: while (true) {
				if (local294 >= local253.length) {
					Class281.method26463(local288, local259.aClass93_Sub41_Sub2_1, -2075218078);
					local259.aClass93_Sub41_Sub2_1.method22652(local292.size(), 235699257);
					if (local292.size() <= 0) {
						break;
					}
					...
					local259.aClass93_Sub41_Sub2_1.method22411(local294, -1550631581);
					...
					while (true) {
						...
						local362 = (Integer) local355.next();
						if (local362 != local294) {
							local259.aClass93_Sub41_Sub2_1.method22411(local362 - local294, -1412914480);
						}
					}
				}
		...
		local259.aClass93_Sub41_Sub2_1.method22407(local259.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local270, 1059727717);
		client.aClass175_2.method24351(local259, -2130488370);
			...
			while (true) {
				while (true) {
					...
					if (local9 != null && Class125_Sub3.aCanvas1.isShowing() && Class20.aBoolean10) {
						local16.method22897(local9, 943340166);
						if (!local16.method22896(1252378458) && local16.method22873(-1678286317) < Class553.anInt3408 * -1378711501 && local16.method22874((byte) -87) < Class553.anInt3416 * 2091353777 && local16.method22873(-1678286317) >= 0 && local16.method22874((byte) -32) >= 0) {
							@Pc(67) int local67 = local16.method22890(-1927132435);
							if (local16.method22890(274949757) == -1) {
								aClass163_Sub1_1.method14903(local16, -429080581);
							} else if (Class64.method1163(local67, 1114876248)) {
								aClass163_Sub1_1.method14845(local16, (byte) 2);
							}
						}
					} else {
						local16.method22877((byte) -61);
					}
				}
			}
		}
	...
	public static void method32726() {
		Class693.method36617(474203229);
	}

	@OriginalMember(owner = "client!xc", name = "r", descriptor = "()V", line = 60)
	public static void method32727() {
		aClass163_Sub2_1.method14902(686976277);
		aClass163_Sub1_1.method14902(-721544363);
		...
		synchronized (aQueue3) {
			...
			while (true) {
				while (true) {
					...
					if (local9 != null && Class125_Sub3.aCanvas1.isShowing() && Class20.aBoolean10) {
						local16.method22897(local9, -1461133725);
						if (!local16.method22896(-1067338844) && local16.method22873(-1678286317) < Class553.anInt3408 * -1378711501 && local16.method22874((byte) -112) < Class553.anInt3416 * 2091353777 && local16.method22873(-1678286317) >= 0 && local16.method22874((byte) -64) >= 0) {
							@Pc(67) int local67 = local16.method22890(-1302953689);
							if (local16.method22890(2097196207) == -1) {
								aClass163_Sub1_1.method14903(local16, -824861930);
							} else if (Class64.method1163(local67, 664155187)) {
								aClass163_Sub1_1.method14845(local16, (byte) 2);
							}
						}
					} else {
						local16.method22877((byte) 48);
					}
				}
			}
		}
	...
	public static void method32729(@OriginalArg(0) Class93_Sub23 arg0) {
		if (Class106.method7580(client.anInt3435 * -849002901, 519414176)) {
			aClass163_Sub2_1.method14903(arg0, 1417579877);
		} else {
			arg0.method22877((byte) 101);
		}
	}
	...
	public static void method32730(@OriginalArg(0) Class93_Sub23 arg0) {
		if (Class106.method7580(client.anInt3435 * -849002901, 1504382181)) {
			aClass163_Sub2_1.method14903(arg0, -1235379709);
		} else {
			arg0.method22877((byte) -70);
		}
	}
	...
	public static void method32731(@OriginalArg(0) Class93_Sub23 arg0) {
		if (Class106.method7580(client.anInt3435 * -849002901, 706830764)) {
			aClass163_Sub2_1.method14903(arg0, -1297352303);
		} else {
			arg0.method22877((byte) -46);
		}
	}
	...
	public static void method32733(@OriginalArg(0) Class93_Sub23 arg0) {
		if (Class106.method7580(client.anInt3435 * -849002901, -1463731987)) {
			aClass163_Sub2_1.method14903(arg0, 1369601178);
		} else {
			arg0.method22877((byte) -3);
		}
	}
		...
		synchronized (aQueue3) {
			...
			while (true) {
				while (true) {
					...
					if (local9 != null && Class125_Sub3.aCanvas1.isShowing() && Class20.aBoolean10) {
						local16.method22897(local9, -416168884);
						if (!local16.method22896(-1772599632) && local16.method22873(-1678286317) < Class553.anInt3408 * -1378711501 && local16.method22874((byte) -50) < Class553.anInt3416 * 2091353777 && local16.method22873(-1678286317) >= 0 && local16.method22874((byte) -121) >= 0) {
							@Pc(67) int local67 = local16.method22890(-2074707108);
							if (local16.method22890(1707142653) == -1) {
								aClass163_Sub1_1.method14903(local16, 708132777);
							} else if (Class64.method1163(local67, 1252316270)) {
								aClass163_Sub1_1.method14845(local16, (byte) 2);
							}
						}
					} else {
						local16.method22877((byte) -39);
					}
				}
			}
		}
		...
		synchronized (aQueue3) {
			...
			while (true) {
				while (true) {
					...
					if (local9 != null && Class125_Sub3.aCanvas1.isShowing() && Class20.aBoolean10) {
						local16.method22897(local9, -1805998502);
						if (!local16.method22896(-2090127865) && local16.method22873(-1678286317) < Class553.anInt3408 * -1378711501 && local16.method22874((byte) -53) < Class553.anInt3416 * 2091353777 && local16.method22873(-1678286317) >= 0 && local16.method22874((byte) -78) >= 0) {
							@Pc(67) int local67 = local16.method22890(-2115319444);
							if (local16.method22890(-1388179120) == -1) {
								aClass163_Sub1_1.method14903(local16, 1719670031);
							} else if (Class64.method1163(local67, 1481689992)) {
								aClass163_Sub1_1.method14845(local16, (byte) 2);
							}
						}
					} else {
						local16.method22877((byte) 83);
					}
				}
			}
		}
	...
	public static void method32736() {
		aClass163_Sub2_1.method14902(-491166801);
		aClass163_Sub1_1.method14902(579207909);
		aLong299 = 2492000195029924361L;
		aBoolean861 = true;
	}
	...
	public static void method32737() {
		Class431.method28774((byte) -61);
		aClass163_Sub2_1.method14922((short) 15195);
		aClass163_Sub1_1.method14922((short) 5000);
		@Pc(17) Class93_Sub22 local17;
		@Pc(26) int local26;
		if (client.anInt3450 * -938319179 > 0) {
			local17 = Class102.method2592(Class446.aClass446_89, client.aClass175_2.aClass24_2, (byte) 50);
			local17.aClass93_Sub41_Sub2_1.method22454(client.anInt3450 * 541690580, 2144009053);
			for (local26 = 0; local26 < client.anInt3450 * -938319179; local26++) {
				@Pc(35) Interface66 local35 = client.anInterface66Array1[local26];
				...
				local17.aClass93_Sub41_Sub2_1.method22510(local35.method13696((byte) 0), (byte) -18);
				local17.aClass93_Sub41_Sub2_1.method22394((int) local43, (byte) 113);
			}
			client.aClass175_2.method24351(local17, -1944668896);
		}
		if (anInt5808 * 660178843 > 0) {
			anInt5808 -= 1066698387;
		}
		if (client.aBoolean619 && anInt5808 * 660178843 <= 0) {
			...
			if (Class429.anInt4781 * -1453926679 != 3) {
				...
				local114 = Class155.method15307(local107.aClass471_1, 1798878870) >> 3;
				@Pc(116) short local116 = 1024;
				local26 = (local116 * 3 - (Class230.method25652(local107.aClass471_1, -1353592533) >> 3)) % (local116 * 2);
			} else {
				local114 = 0;
				local26 = 0;
			}
			...
			local153.aClass93_Sub41_Sub2_1.method22456(local26, (short) 255);
			local153.aClass93_Sub41_Sub2_1.method22454(local114, 2133126999);
			client.aClass175_2.method24351(local153, -1478359312);
		}
		if (Class20.aBoolean10 != aBoolean861) {
			aBoolean861 = Class20.aBoolean10;
			local17 = Class102.method2592(Class446.aClass446_95, client.aClass175_2.aClass24_2, (byte) 55);
			local17.aClass93_Sub41_Sub2_1.method22510(Class20.aBoolean10 ? 1 : 0, (byte) -16);
			client.aClass175_2.method24351(local17, -1544655434);
		}
		if (!client.aBoolean601) {
			local17 = Class102.method2592(Class446.aClass446_19, client.aClass175_2.aClass24_2, (byte) 107);
			local17.aClass93_Sub41_Sub2_1.method22510(0, (byte) -67);
			local26 = local17.aClass93_Sub41_Sub2_1.anInt3070 * 212851357;
			@Pc(214) Class93_Sub41 local214 = Class51.aClass93_Sub36_1.method14356(446421675);
			local17.aClass93_Sub41_Sub2_1.method22405(local214.aByteArray58, 0, local214.anInt3070 * 212851357, 2026842986);
			local17.aClass93_Sub41_Sub2_1.method22537(local17.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local26, (byte) 5);
			client.aClass175_2.method24351(local17, -2095586228);
			client.aBoolean601 = true;
		}
		if (client.aBoolean602 || Class51.aClass93_Sub36_1.aClass166_Sub4_1.method15424((byte) 99) != 1) {
			return;
		}
		@Pc(253) int[] local253 = Class694.aClass104_14.method20712();
		@Pc(259) Class93_Sub22 local259 = Class102.method2592(Class446.aClass446_111, client.aClass175_2.aClass24_2, (byte) 76);
		local259.aClass93_Sub41_Sub2_1.method22454(0, 2141874759);
		@Pc(270) int local270 = local259.aClass93_Sub41_Sub2_1.anInt3070 * 212851357;
		if (local253 == null || local253.length == 0) {
			local259.aClass93_Sub41_Sub2_1.method22510(0, (byte) -8);
		} else {
			local259.aClass93_Sub41_Sub2_1.method22510(1, (byte) -96);
			@Pc(284) Class184[] local284 = Class184.method24580(1539890468);
			@Pc(288) HashSet local288 = new HashSet();
			@Pc(292) ArrayList local292 = new ArrayList();
			@Pc(294) int local294 = 0;
			label94: while (true) {
				if (local294 >= local253.length) {
					Class281.method26463(local288, local259.aClass93_Sub41_Sub2_1, -2075218078);
					local259.aClass93_Sub41_Sub2_1.method22652(local292.size(), 68704126);
					if (local292.size() <= 0) {
						break;
					}
					local294 = Integer.MAX_VALUE;
					...
					local259.aClass93_Sub41_Sub2_1.method22411(local294, -1561324827);
					local355 = local292.iterator();
					while (true) {
						if (!local355.hasNext()) {
							break label94;
						...
						local362 = (Integer) local355.next();
						if (local362 != local294) {
							local259.aClass93_Sub41_Sub2_1.method22411(local362 - local294, -1401181989);
						}
					}
				}
				@Pc(300) boolean local300 = false;
		...
		local259.aClass93_Sub41_Sub2_1.method22407(local259.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local270, -1743662539);
		client.aClass175_2.method24351(local259, -1666991457);
		client.aBoolean602 = true;
	}

	@OriginalMember(owner = "client!xc", name = "j", descriptor = "()V", line = 113)
	public static void method32738() {
		Class431.method28774((byte) -48);
		aClass163_Sub2_1.method14922((short) 8772);
		aClass163_Sub1_1.method14922((short) 30345);
		@Pc(17) Class93_Sub22 local17;
		@Pc(26) int local26;
		if (client.anInt3450 * -938319179 > 0) {
			local17 = Class102.method2592(Class446.aClass446_89, client.aClass175_2.aClass24_2, (byte) 71);
			local17.aClass93_Sub41_Sub2_1.method22454(client.anInt3450 * 541690580, 2145202535);
			for (local26 = 0; local26 < client.anInt3450 * -938319179; local26++) {
				@Pc(35) Interface66 local35 = client.anInterface66Array1[local26];
				...
				local17.aClass93_Sub41_Sub2_1.method22510(local35.method13696((byte) 0), (byte) -10);
				local17.aClass93_Sub41_Sub2_1.method22394((int) local43, (byte) 67);
			}
			client.aClass175_2.method24351(local17, -1841579982);
		}
		if (anInt5808 * 660178843 > 0) {
			anInt5808 -= 1066698387;
		}
		if (client.aBoolean619 && anInt5808 * 660178843 <= 0) {
			...
			if (Class429.anInt4781 * -1453926679 != 3) {
				...
				local114 = Class155.method15307(local107.aClass471_1, 471561054) >> 3;
				@Pc(116) short local116 = 1024;
				local26 = (local116 * 3 - (Class230.method25652(local107.aClass471_1, 333908081) >> 3)) % (local116 * 2);
			} else {
				local114 = 0;
				local26 = 0;
			}
			...
			local153.aClass93_Sub41_Sub2_1.method22456(local26, (short) 255);
			local153.aClass93_Sub41_Sub2_1.method22454(local114, 2146857954);
			client.aClass175_2.method24351(local153, -1878503447);
		}
		if (Class20.aBoolean10 != aBoolean861) {
			aBoolean861 = Class20.aBoolean10;
			local17 = Class102.method2592(Class446.aClass446_95, client.aClass175_2.aClass24_2, (byte) 58);
			local17.aClass93_Sub41_Sub2_1.method22510(Class20.aBoolean10 ? 1 : 0, (byte) -113);
			client.aClass175_2.method24351(local17, -2066428888);
		}
		if (!client.aBoolean601) {
			local17 = Class102.method2592(Class446.aClass446_19, client.aClass175_2.aClass24_2, (byte) 62);
			local17.aClass93_Sub41_Sub2_1.method22510(0, (byte) -105);
			local26 = local17.aClass93_Sub41_Sub2_1.anInt3070 * 212851357;
			@Pc(214) Class93_Sub41 local214 = Class51.aClass93_Sub36_1.method14356(-443355101);
			local17.aClass93_Sub41_Sub2_1.method22405(local214.aByteArray58, 0, local214.anInt3070 * 212851357, 2026842986);
			local17.aClass93_Sub41_Sub2_1.method22537(local17.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local26, (byte) 110);
			client.aClass175_2.method24351(local17, -1882665606);
			client.aBoolean601 = true;
		}
		if (client.aBoolean602 || Class51.aClass93_Sub36_1.aClass166_Sub4_1.method15424((byte) 87) != 1) {
			return;
		}
		@Pc(253) int[] local253 = Class694.aClass104_14.method20712();
		@Pc(259) Class93_Sub22 local259 = Class102.method2592(Class446.aClass446_111, client.aClass175_2.aClass24_2, (byte) 94);
		local259.aClass93_Sub41_Sub2_1.method22454(0, 2137571047);
		@Pc(270) int local270 = local259.aClass93_Sub41_Sub2_1.anInt3070 * 212851357;
		if (local253 == null || local253.length == 0) {
			local259.aClass93_Sub41_Sub2_1.method22510(0, (byte) -31);
		} else {
			local259.aClass93_Sub41_Sub2_1.method22510(1, (byte) -84);
			@Pc(284) Class184[] local284 = Class184.method24580(1539890468);
			@Pc(288) HashSet local288 = new HashSet();
			@Pc(292) ArrayList local292 = new ArrayList();
			@Pc(294) int local294 = 0;
			label94: while (true) {
				if (local294 >= local253.length) {
					Class281.method26463(local288, local259.aClass93_Sub41_Sub2_1, -2075218078);
					local259.aClass93_Sub41_Sub2_1.method22652(local292.size(), 161965767);
					if (local292.size() <= 0) {
						break;
					}
					local294 = Integer.MAX_VALUE;
					...
					local259.aClass93_Sub41_Sub2_1.method22411(local294, -1730642294);
					local355 = local292.iterator();
					while (true) {
						if (!local355.hasNext()) {
							break label94;
						...
						local362 = (Integer) local355.next();
						if (local362 != local294) {
							local259.aClass93_Sub41_Sub2_1.method22411(local362 - local294, -1827383859);
						}
					}
				}
				@Pc(300) boolean local300 = false;
		...
		local259.aClass93_Sub41_Sub2_1.method22407(local259.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local270, 1201816319);
		client.aClass175_2.method24351(local259, -1485111313);
		client.aBoolean602 = true;
	}
	...
	public static void method32739(@OriginalArg(0) Class93_Sub23 arg0) {
		if (Class106.method7580(client.anInt3435 * -849002901, -1879019015)) {
			aClass163_Sub2_1.method14903(arg0, -761470565);
		} else {
			arg0.method22877((byte) 14);
		}
	}

	@OriginalMember(owner = "client!xc", name = "dx", descriptor = "(Lclient!yf;B)V", line = 5646)
	static final void method32740(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 591501400);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class237.method25771(local16, local22, arg0, (short) -9940);
	}

	@OriginalMember(owner = "client!xc", name = "aoh", descriptor = "(Lclient!yf;I)V", line = 12616)
	static final void method32741(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) throws Exception_Sub3 {
	...
	static final void method32742(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub39_1.method16343(-430794875);
	}

	@OriginalMember(owner = "client!xc", name = "bar", descriptor = "(Lclient!yf;B)V", line = 14294)
	static final void method32743(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		if (Class694.aClass104_14.method20565()) {
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub28_1.method16543(local12, -1718640691);
		} else {
	...
	static final void method32744(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(4) Class561 local4 = arg0.aClass132_Sub1_Sub1_Sub1_4.method19971(-1514961960);
		if (local4 == null) {
			arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = "";
		} else {
			arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = local4.method31138(1363056965);
		}
	}

	@OriginalMember(owner = "client!xc", name = "m", descriptor = "(II)I", line = 39)
	static final int method32745(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg0 < 7 ? 7 : 10;
	}
}
