...
public class Class166_Sub11 extends Class166 {
	...
	static final void method15594(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) boolean arg6, @OriginalArg(7) int arg7) {
		if (!arg5 && (arg1 < 512 || arg2 < 512 || arg1 > (client.aClass532_1.method30444(648603660) - 2) * 512 || arg2 > (client.aClass532_1.method30474((short) 128) - 2) * 512)) {
			@Pc(27) float[] local27 = client.aFloatArray93;
			client.aFloatArray93[1] = -1.0F;
			local27[0] = -1.0F;
			return;
		}
		@Pc(44) int local44 = Class305.method26801(arg1, arg2, arg0, (byte) -3) - arg4;
		...
		Class694.aClass104_14.method20516(client.aClass470_51);
		if (!arg6) {
			client.aFloatArray93[0] -= (float) (client.anInt3432 * 706492895);
			client.aFloatArray93[1] -= (float) (client.anInt3568 * 1300190535);
		}
	}
}
