...
class Class247 implements Comparator {
	...
	public boolean method25907(@OriginalArg(0) Object arg0) {
		return super.equals(arg0);
	}

	@OriginalMember(owner = "client!el", name = "e", descriptor = "(Lclient!rq;Lclient!rq;I)I", line = 126)
	int method25908(@OriginalArg(0) Class535 arg0, @OriginalArg(1) Class535 arg1, @OriginalArg(2) int arg2) {
		@Pc(3) float local3 = arg0.method30682(-1732592269);
		@Pc(7) float local7 = arg1.method30682(85290336);
		if (local7 > local3) {
			return 1;
	...
	public int compare(@OriginalArg(0) Object arg0, @OriginalArg(1) Object arg1) {
		return this.method25908((Class535) arg0, (Class535) arg1, -866247073);
	}

	@OriginalMember(owner = "client!el", name = "n", descriptor = "(Lclient!rq;Lclient!rq;)I", line = 126)
	int method25909(@OriginalArg(0) Class535 arg0, @OriginalArg(1) Class535 arg1) {
		@Pc(3) float local3 = arg0.method30682(-1301690363);
		@Pc(7) float local7 = arg1.method30682(-1888685235);
		if (local7 > local3) {
			return 1;
		} else if (local7 < local3) {
			return -1;
	...
	public int method25910(@OriginalArg(0) Object arg0, @OriginalArg(1) Object arg1) {
		return this.method25908((Class535) arg0, (Class535) arg1, -866247073);
	}
	...
	static final void method25915(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 167649149);
	...
	static final void method25916(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		arg0.method26884(1229657527);
	}

	@OriginalMember(owner = "client!el", name = "auj", descriptor = "(Lclient!yf;B)V", line = 13345)
	static final void method25917(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub35_2.method16223(-374662973);
	}
	...
	static final void method25918(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class300.method26721(local13, local23, local33, (byte) -13);
	}

	@OriginalMember(owner = "client!el", name = "if", descriptor = "(Lclient!ax;I)Z", line = 6375)
	static final boolean method25919(@OriginalArg(0) Class175 arg0, @OriginalArg(1) int arg1) {
		try {
			return Class696.method36651(arg0, (byte) -8);
		} catch (@Pc(4) IOException local4) {
			if (client.anInt3435 * -849002901 == 15) {
				arg0.method24358((byte) 95);
				return false;
			} else {
			...
			@Pc(23) Class611 local23 = client.aClass532_1.method30443(1828891152);
			...
			Class646.method32610(local99, local19, 1224473706);
			Class642.method32522(false, (short) 17862);
			return true;
		}
	}
}
