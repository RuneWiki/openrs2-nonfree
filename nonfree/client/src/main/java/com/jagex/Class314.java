...
public class Class314 {
	...
	public Class314(@OriginalArg(0) byte[] arg0) throws Exception_Sub6 {
		this.method26933(arg0, (byte) 42);
	}

	@OriginalMember(owner = "client!hj", name = "e", descriptor = "([BB)V", line = 18)
	void method26933(@OriginalArg(0) byte[] arg0, @OriginalArg(1) byte arg1) throws Exception_Sub6 {
		@Pc(4) Class326 local4 = new Class326(arg0);
		@Pc(8) int local8 = local4.method27306(746793277);
		if (local8 != 4) {
			throw new Exception_Sub6(this, local8, 4);
		}
		this.aString169 = local4.method27307(-105563396);
		this.aClass325Array1 = new Class325[local4.method27306(2096003037)];
		this.aClass325Array2 = new Class325[local4.method27306(331468520)];
		this.aClass318Array1 = new Class318[local4.method27306(865351252)];
		@Pc(43) int local43;
	...
	void method26934(@OriginalArg(0) byte[] arg0) throws Exception_Sub6 {
		@Pc(4) Class326 local4 = new Class326(arg0);
		@Pc(8) int local8 = local4.method27306(615827035);
		if (local8 != 4) {
			throw new Exception_Sub6(this, local8, 4);
		}
		this.aString169 = local4.method27307(-734875769);
		this.aClass325Array1 = new Class325[local4.method27306(832338755)];
		this.aClass325Array2 = new Class325[local4.method27306(376802913)];
		this.aClass318Array1 = new Class318[local4.method27306(1480841173)];
		@Pc(43) int local43;
		for (local43 = 0; local43 < this.aClass325Array1.length; local43++) {
			this.aClass325Array1[local43] = new Class325();
	...
	void method26935(@OriginalArg(0) byte[] arg0) throws Exception_Sub6 {
		@Pc(4) Class326 local4 = new Class326(arg0);
		@Pc(8) int local8 = local4.method27306(820835501);
		if (local8 != 4) {
			throw new Exception_Sub6(this, local8, 4);
		}
		this.aString169 = local4.method27307(-2099154606);
		this.aClass325Array1 = new Class325[local4.method27306(1632339282)];
		this.aClass325Array2 = new Class325[local4.method27306(1565850658)];
		this.aClass318Array1 = new Class318[local4.method27306(742247751)];
		@Pc(43) int local43;
		for (local43 = 0; local43 < this.aClass325Array1.length; local43++) {
			this.aClass325Array1[local43] = new Class325();
	...
	void method26936(@OriginalArg(0) byte[] arg0) throws Exception_Sub6 {
		@Pc(4) Class326 local4 = new Class326(arg0);
		@Pc(8) int local8 = local4.method27306(713327371);
		if (local8 != 4) {
			throw new Exception_Sub6(this, local8, 4);
		}
		this.aString169 = local4.method27307(1509989241);
		this.aClass325Array1 = new Class325[local4.method27306(351632704)];
		this.aClass325Array2 = new Class325[local4.method27306(1316698116)];
		this.aClass318Array1 = new Class318[local4.method27306(1797268857)];
		@Pc(43) int local43;
		for (local43 = 0; local43 < this.aClass325Array1.length; local43++) {
			this.aClass325Array1[local43] = new Class325();
	...
	static final void method26937(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class681 arg1, @OriginalArg(2) int arg2) {
		@Pc(1) byte local1 = 10;
		Class348.method27623(arg0, local1, arg1, 542183118);
	}

	@OriginalMember(owner = "client!hj", name = "ban", descriptor = "(Lclient!yf;B)V", line = 14344)
	static final void method26938(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	public static void method26939(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		if (Class518.aStringArray31 == null) {
			Class555.method31054((short) -21040);
		}
		client.aCalendar3.setTime(new Date(Class305.method26796(187582194)));
	...
	static void method26941(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class93_Sub29 arg1, @OriginalArg(2) Class322 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		if (arg2.anInt4108 * -664150941 != 0) {
			arg0.method20600(local3, local7, arg6 + 10, arg5 + arg4 - local7 + 1, arg2.anInt4108 * -664150941, (byte) 48);
		}
		if (arg2.anInt4109 * 989664399 != 0) {
			arg0.method20472(local3, local7, arg6 + 10, arg4 + arg5 - local7 + 1, arg2.anInt4109 * 989664399, 1176708304);
		}
		...
		Class171.aClass106_9.method7563(arg2.aString174, arg3, arg4, arg6, arg5, local61 | 0xFF000000, Class159_Sub1.aClass637_2.anInt5738 * 2079115473, 1, 0, 0, (Class100[]) null, (int[]) null, (Class96) null, 0, 0, (short) 657);
	}

	@OriginalMember(owner = "client!hj", name = "m", descriptor = "(I)I", line = 74)
	public static int method26942(@OriginalArg(0) int arg0) {
		@Pc(2) Class54_Sub1 local2 = Class319.method27223((byte) -34);
		Class129.method21479(local2, (byte) -4);
		return local2.method14853(2032075540);
	}

	@OriginalMember(owner = "client!hj", name = "e", descriptor = "(I)[Lclient!zx;", line = 17)
	public static Class721[] method26943(@OriginalArg(0) int arg0) {
