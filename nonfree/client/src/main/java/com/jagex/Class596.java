...
public class Class596 implements Interface13 {
	...
	void method31749(@OriginalArg(0) Class104 arg0) {
		this.method31752(arg0, this.anInt5489 * -1393086115, 680192989);
		this.method31752(arg0, this.anInt5487 * 816546509, -1004585619);
		this.method31752(arg0, this.anInt5496 * 857036441, -434924340);
		this.method31752(arg0, this.anInt5497 * 168300879, 790777752);
		this.method31752(arg0, this.anInt5494 * -128291419, -1707027654);
		this.method31752(arg0, this.anInt5493 * -1920415725, -602504146);
	}
	...
	void method31750(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg1 == 1) {
			...
			this.anInt5495 = arg0.method22413((short) 16384) * 807636705;
		} else if (arg1 == 3) {
			this.anInt5490 = arg0.method22413((short) 16384) * -706719569;
		} else if (arg1 == 4) {
			this.anInt5491 = 0;
		} else if (arg1 == 5) {
			this.anInt5498 = arg0.method22415(-1434290800) * 1615480563;
		} else if (arg1 == 6) {
			arg0.method22413((short) 16384);
		} else if (arg1 == 7) {
			this.anInt5489 = arg0.method22436(-59609869) * 1792977653;
		} else if (arg1 == 8) {
			this.anInt5487 = arg0.method22436(-830125417) * -585876987;
		} else if (arg1 == 9) {
			this.anInt5496 = arg0.method22436(-571479904) * -1912693335;
		} else if (arg1 == 10) {
			this.anInt5497 = arg0.method22436(-1487729724) * 903374255;
		} else if (arg1 == 11) {
			this.anInt5491 = arg0.method22415(-1434290800) * 1574465001;
		} else if (arg1 == 12) {
			this.anInt5494 = arg0.method22436(-613389699) * 1845932589;
		} else if (arg1 == 13) {
			this.anInt5493 = arg0.method22436(-156704551) * 1355432475;
		}
	}

	@OriginalMember(owner = "client!uk", name = "z", descriptor = "(Lclient!dh;IB)Lclient!cm;", line = 59)
	public Class100 method31751(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		if (arg1 < 0) {
			return null;
		}
		@Pc(11) Class100 local11 = (Class100) this.aClass156_1.aClass240_23.method25839((long) arg1);
		if (local11 == null) {
			this.method31753(arg0, -1581055043);
	...
	void method31752(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(3) Class497 local3 = this.aClass156_1.aClass497_47;
		if (arg1 >= 0 && this.aClass156_1.aClass240_23.method25839((long) arg1) == null && local3.method30054(arg1, -512225963)) {
	...
	void method31753(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		this.method31752(arg0, this.anInt5489 * -1393086115, -850572670);
		this.method31752(arg0, this.anInt5487 * 816546509, -446791328);
		this.method31752(arg0, this.anInt5496 * 857036441, 1564069708);
		this.method31752(arg0, this.anInt5497 * 168300879, -814310435);
		this.method31752(arg0, this.anInt5494 * -128291419, 779292493);
		this.method31752(arg0, this.anInt5493 * -1920415725, 2133236713);
	}

	@OriginalMember(owner = "client!uk", name = "x", descriptor = "(Lclient!dh;)V", line = 79)
	void method31754(@OriginalArg(0) Class104 arg0) {
		this.method31752(arg0, this.anInt5489 * -1393086115, -1222561437);
		this.method31752(arg0, this.anInt5487 * 816546509, 151446484);
		this.method31752(arg0, this.anInt5496 * 857036441, -1259352210);
		this.method31752(arg0, this.anInt5497 * 168300879, 386086763);
		this.method31752(arg0, this.anInt5494 * -128291419, -264456894);
		this.method31752(arg0, this.anInt5493 * -1920415725, 702264914);
	}
	...
	void method31755(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			...
			this.anInt5489 = arg0.method22436(-1911236077) * 1792977653;
		} else if (arg1 == 8) {
			this.anInt5487 = arg0.method22436(-502598892) * -585876987;
		} else if (arg1 == 9) {
			this.anInt5496 = arg0.method22436(-674577347) * -1912693335;
		} else if (arg1 == 10) {
			this.anInt5497 = arg0.method22436(-1817691263) * 903374255;
		} else if (arg1 == 11) {
			this.anInt5491 = arg0.method22415(-1434290800) * 1574465001;
		} else if (arg1 == 12) {
			this.anInt5494 = arg0.method22436(-1006948826) * 1845932589;
		} else if (arg1 == 13) {
			this.anInt5493 = arg0.method22436(-651560597) * 1355432475;
		}
	}
	...
	void method31756(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			...
			this.anInt5489 = arg0.method22436(-49522556) * 1792977653;
		} else if (arg1 == 8) {
			this.anInt5487 = arg0.method22436(-1125724718) * -585876987;
		} else if (arg1 == 9) {
			this.anInt5496 = arg0.method22436(-658763671) * -1912693335;
		} else if (arg1 == 10) {
			this.anInt5497 = arg0.method22436(-15695181) * 903374255;
		} else if (arg1 == 11) {
			this.anInt5491 = arg0.method22415(-1434290800) * 1574465001;
		} else if (arg1 == 12) {
			this.anInt5494 = arg0.method22436(-388110835) * 1845932589;
		} else if (arg1 == 13) {
			this.anInt5493 = arg0.method22436(-2012933072) * 1355432475;
		}
	}
	...
	public Class100 method31757(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(11) Class100 local11 = (Class100) this.aClass156_1.aClass240_23.method25839((long) arg1);
		if (local11 == null) {
			this.method31753(arg0, -1358042784);
			local11 = (Class100) this.aClass156_1.aClass240_23.method25839((long) arg1);
		}
		return local11;
	}
	...
	public Class100 method31758(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(11) Class100 local11 = (Class100) this.aClass156_1.aClass240_23.method25839((long) arg1);
		if (local11 == null) {
			this.method31753(arg0, -2017839628);
			local11 = (Class100) this.aClass156_1.aClass240_23.method25839((long) arg1);
		}
		return local11;
	}
	...
	public Class100 method31759(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(11) Class100 local11 = (Class100) this.aClass156_1.aClass240_23.method25839((long) arg1);
		if (local11 == null) {
			this.method31753(arg0, -1154896092);
			local11 = (Class100) this.aClass156_1.aClass240_23.method25839((long) arg1);
		}
		return local11;
	}
	...
	static int method31761(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg0 == 16711935 ? -1 : Class682.method33276(arg0, -1432208910);
	}

	@OriginalMember(owner = "client!uk", name = "pc", descriptor = "(Lclient!yf;B)V", line = 7860)
	static final void method31762(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method31763(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		Class51.aClass93_Sub36_1.method14357(Class51.aClass93_Sub36_1.aClass166_Sub36_1, arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091], (byte) 116);
	...
	public static void method31764(@OriginalArg(0) Applet arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		Class564.anApplet3 = arg0;
		Class564.aString228 = arg1;
	}

	@OriginalMember(owner = "client!uk", name = "e", descriptor = "(B)[Lclient!db;", line = 140)
	static Class222[] method31765(@OriginalArg(0) byte arg0) {
