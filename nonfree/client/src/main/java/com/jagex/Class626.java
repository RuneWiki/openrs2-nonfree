...
public class Class626 {
	...
	static final void method32243(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class65.aClass123_Sub1_2.method8986((byte) -35) == null ? -1 : Class65.aClass123_Sub1_2.method8986((byte) -58).anInt4184 * -210852351;
	}

	@OriginalMember(owner = "client!vw", name = "e", descriptor = "(Lclient!py;Lclient!py;II)V", line = 16)
	public static void method32244(@OriginalArg(0) Class497 arg0, @OriginalArg(1) Class497 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
