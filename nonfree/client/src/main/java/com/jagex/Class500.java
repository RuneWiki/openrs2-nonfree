...
public class Class500 implements Interface75 {
	...
	public Object method30156(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
	...
	public static Interface9 method30157(@OriginalArg(0) Class arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class500 local3 = method30158(arg0, 513196918);
		if (local3 == null) {
	...
	static Class500 method30158(@OriginalArg(0) Class arg0, @OriginalArg(1) int arg1) {
		@Pc(2) Class500[] local2 = method30159(-1834477791);
	...
	public static Class500[] method30159(@OriginalArg(0) int arg0) {
	...
	static Class500 method30160(@OriginalArg(0) Class arg0) {
		@Pc(2) Class500[] local2 = method30159(-1802498777);
		for (@Pc(4) int local4 = 0; local4 < local2.length; local4++) {
			@Pc(12) Class500 local12 = local2[local4];
			if (arg0 == local12.aClass2) {
				return local12;
	...
	static Class500 method30161(@OriginalArg(0) Class arg0) {
		@Pc(2) Class500[] local2 = method30159(-2022207499);
		for (@Pc(4) int local4 = 0; local4 < local2.length; local4++) {
			@Pc(12) Class500 local12 = local2[local4];
			if (arg0 == local12.aClass2) {
				return local12;
	...
	public static Interface9 method30162(@OriginalArg(0) Class arg0) {
		@Pc(3) Class500 local3 = method30158(arg0, -44876368);
		if (local3 == null) {
			throw new IllegalArgumentException();
		}
		return local3.anInterface9_1;
	...
	public static Interface9 method30163(@OriginalArg(0) Class arg0) {
		@Pc(3) Class500 local3 = method30158(arg0, 1739346658);
		if (local3 == null) {
			throw new IllegalArgumentException();
		}
		return local3.anInterface9_1;
	...
	static final void method30164(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
		...
		local19.aClass93_Sub41_Sub2_1.method22510(local13.length() + 1, (byte) -74);
		local19.aClass93_Sub41_Sub2_1.method22402(local13, -288853937);
		client.aClass175_2.method24351(local19, -1861149337);
	}

	@OriginalMember(owner = "client!qa", name = "v", descriptor = "(Lclient!yf;I)V", line = 79)
	static void method30165(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(13) String local13 = (String) arg0.anObjectArray45[(arg0.anInt5888 -= 957530791) * 587908375];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class497.method30131(local13, 1683602857);
	}

	@OriginalMember(owner = "client!qa", name = "kt", descriptor = "(Ljava/lang/String;I)I", line = 11974)
	public static final int method30166(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		if (arg0 == null) {
			return -1;
		}
	...
	static final void method30167(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
