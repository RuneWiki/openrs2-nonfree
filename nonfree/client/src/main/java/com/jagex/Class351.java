...
public class Class351 {
	...
	static Class623 method27642(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(2) Class623[] local2 = Class254.method25998((byte) -69);
		for (@Pc(4) int local4 = 0; local4 < local2.length; local4++) {
	...
	static void method27643(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		for (@Pc(1) int local1 = 0; local1 < Class606.anInt5557 * 2035023117; local1++) {
			@Pc(10) int local10 = arg0.method22632((byte) -23);
	...
	static final void method27644(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method27645(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		if (local30.method1508(1429228259)) {
			arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = local11.method26883(local24, local30.aString11, -2111319918);
		} else {
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = local11.method26858(local24, local30.anInt265 * 951920133, 165204008);
		}
	}

	@OriginalMember(owner = "client!iw", name = "ux", descriptor = "(Lclient!yf;B)V", line = 8679)
	static final void method27646(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, -121337275);
	...
	static final void method27647(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(39) Class175 local39 = Class330.method27372(-1608641612);
		@Pc(45) Class93_Sub22 local45 = Class102.method2592(Class446.aClass446_9, local39.aClass24_2, (byte) 49);
		local45.aClass93_Sub41_Sub2_1.method22454(0, 2145264426);
		@Pc(56) int local56 = local45.aClass93_Sub41_Sub2_1.anInt3070 * 212851357;
		local45.aClass93_Sub41_Sub2_1.method22402(local14, -664135129);
		Class284.method26484(local45.aClass93_Sub41_Sub2_1, local25, -1497248091);
		local45.aClass93_Sub41_Sub2_1.method22407(local45.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local56, 857643681);
		local39.method24351(local45, -1594490576);
	}
	...
	static final void method27650(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1458907833);
		Class336.method27444(local16, arg0, -2125545030);
	}
}
