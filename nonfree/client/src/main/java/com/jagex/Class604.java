...
public class Class604 implements Interface75 {
	...
	static final void method31889(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class675.method33166(local16, local22, arg0);
	}

	@OriginalMember(owner = "client!uw", name = "zw", descriptor = "(Lclient!yf;I)V", line = 9428)
	static final void method31890(@OriginalArg(0) Class681 arg0) {
		...
		@Pc(49) Class39 local49 = (Class39) Class19.aClass32_Sub7_5.method18261(local33);
		if (local49.aClass519_2.method36920() != local13 || local49.aClass519_1.method36920() != local23) {
			...
			arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = local49.method749(local43);
		} else {
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = local49.method748(local43);
		}
	}

	@OriginalMember(owner = "client!uw", name = "abv", descriptor = "(Lclient!yf;I)V", line = 9809)
	static final void method31891(@OriginalArg(0) Class681 arg0) {
		@Pc(13) String local13 = (String) arg0.anObjectArray45[(arg0.anInt5888 -= 957530791) * 587908375];
		Class176.method24387(local13, true);
	}

	@OriginalMember(owner = "client!uw", name = "alv", descriptor = "(Lclient!yf;I)V", line = 11903)
	static final void method31892(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		if (local12 >= 1 && local12 <= 2) {
			Class51.aClass93_Sub36_1.method14357(Class51.aClass93_Sub36_1.aClass166_Sub23_1, local12);
			Class51.aClass93_Sub36_1.method14357(Class51.aClass93_Sub36_1.aClass166_Sub23_2, local12);
			Class106_Sub1.method5148();
		}
	}

	@OriginalMember(owner = "client!uw", name = "bad", descriptor = "(Lclient!yf;I)V", line = 14352)
	static final void method31893(@OriginalArg(0) Class681 arg0) {
