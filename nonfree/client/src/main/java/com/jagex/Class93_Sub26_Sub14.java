...
public class Class93_Sub26_Sub14 extends Class93_Sub26 {
	...
	void method21991(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
		this.anInt3053 = arg0.method22415(-1434290800) * 1887726291;
		this.anInt3050 = arg0.method22419(-118643075) * 1503455239;
		this.anInt3051 = arg0.method22413((short) 16384) * -1348153087;
		this.anInt3052 = arg0.method22413((short) 16384) * -2050172787;
	}
	...
	void method21992(@OriginalArg(0) Class386 arg0, @OriginalArg(1) int arg1) {
		arg0.method28178(this.anInt3053 * -1090028197, this.anInt3050 * -574487113, this.anInt3051 * 1375481601, this.anInt3052 * -554915259, (byte) -83);
	}

	@OriginalMember(owner = "client!ary", name = "k", descriptor = "(Lclient!kr;)V", line = 157)
	@Override
	void method21994(@OriginalArg(0) Class386 arg0) {
		arg0.method28178(this.anInt3053 * -1090028197, this.anInt3050 * -574487113, this.anInt3051 * 1375481601, this.anInt3052 * -554915259, (byte) 8);
	}

	@OriginalMember(owner = "client!ary", name = "w", descriptor = "(Lclient!kr;)V", line = 157)
	@Override
	void method21995(@OriginalArg(0) Class386 arg0) {
		arg0.method28178(this.anInt3053 * -1090028197, this.anInt3050 * -574487113, this.anInt3051 * 1375481601, this.anInt3052 * -554915259, (byte) -102);
	}

	@OriginalMember(owner = "client!ary", name = "f", descriptor = "(Lclient!kr;)V", line = 157)
	@Override
	void method21990(@OriginalArg(0) Class386 arg0) {
		arg0.method28178(this.anInt3053 * -1090028197, this.anInt3050 * -574487113, this.anInt3051 * 1375481601, this.anInt3052 * -554915259, (byte) -54);
	}
