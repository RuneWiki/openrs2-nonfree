...
public class Class243 {
	...
	Class243(@OriginalArg(0) Class93_Sub41 arg0) {
		this.anInt3833 = arg0.method22436(-1231296433) * 421769509;
		this.aClass615_1 = (Class615) Class107.method18119(Class1.method10(1523069168), arg0.method22413((short) 16384), -1915563430);
	}
	...
	void method25881(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte arg4) {
		Class359.method27790(arg0, arg1, arg2, this.aClass615_1.anInt5629 * 2081439295, this.anInt3833 * -1294794067, this.aClass615_1.anInt5628 * 948246811, arg3, (Class458) null, (byte) 78);
	...
	void method25882(@OriginalArg(0) byte arg0) {
		Class359.method27790(this.anInt3837 * 1569957707, this.anInt3834 * -1679422971, this.anInt3836 * 1376446607, this.aClass615_1.anInt5629 * 2081439295, -1, this.aClass615_1.anInt5628 * 948246811, this.anInt3835 * -1340857141, (Class458) null, (byte) 73);
	}

	@OriginalMember(owner = "client!ef", name = "m", descriptor = "(I)Z", line = 36)
	boolean method25883(@OriginalArg(0) int arg0) {
		...
		@Pc(22) boolean local22 = local13.method31978(this.aClass615_1.anInt5628 * 948246811, (byte) -60);
		@Pc(26) int[] local26 = local13.method31989(-344985243);
		if (local26 != null) {
			@Pc(30) int[] local30 = local26;
			for (@Pc(32) int local32 = 0; local32 < local30.length; local32++) {
				@Pc(40) int local40 = local30[local32];
				local22 &= ((Class263) Class32.aClass32_Sub17_23.method18261(local40, 922425536)).method26194((byte) -104);
			}
		}
		return local22;
	}
	...
	void method25884() {
		Class359.method27790(this.anInt3837 * 1569957707, this.anInt3834 * -1679422971, this.anInt3836 * 1376446607, this.aClass615_1.anInt5629 * 2081439295, -1, this.aClass615_1.anInt5628 * 948246811, this.anInt3835 * -1340857141, (Class458) null, (byte) 97);
	}

	@OriginalMember(owner = "client!ef", name = "f", descriptor = "()V", line = 32)
	void method25885() {
		Class359.method27790(this.anInt3837 * 1569957707, this.anInt3834 * -1679422971, this.anInt3836 * 1376446607, this.aClass615_1.anInt5629 * 2081439295, -1, this.aClass615_1.anInt5628 * 948246811, this.anInt3835 * -1340857141, (Class458) null, (byte) 61);
	}

	@OriginalMember(owner = "client!ef", name = "w", descriptor = "()V", line = 32)
	void method25886() {
		Class359.method27790(this.anInt3837 * 1569957707, this.anInt3834 * -1679422971, this.anInt3836 * 1376446607, this.aClass615_1.anInt5629 * 2081439295, -1, this.aClass615_1.anInt5628 * 948246811, this.anInt3835 * -1340857141, (Class458) null, (byte) 91);
	}
	...
	boolean method25887() {
		...
		@Pc(22) boolean local22 = local13.method31978(this.aClass615_1.anInt5628 * 948246811, (byte) -75);
		@Pc(26) int[] local26 = local13.method31989(432725978);
		if (local26 != null) {
			@Pc(30) int[] local30 = local26;
			for (@Pc(32) int local32 = 0; local32 < local30.length; local32++) {
				@Pc(40) int local40 = local30[local32];
				local22 &= ((Class263) Class32.aClass32_Sub17_23.method18261(local40, -106184449)).method26194((byte) -3);
			}
		}
		return local22;
	}
	...
	static final void method25888(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method25889(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 384444626);
	...
	static int method25890(@OriginalArg(0) Class154_Sub1 arg0, @OriginalArg(1) Class154_Sub1 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) byte arg4) {
		@Pc(7) int local7;
		@Pc(12) int local12;
		if (arg2 == 1) {
			...
			return Class488.method29821(arg0.method14154((byte) -36), arg1.method14154((byte) -121), Class106.aClass717_8, -264791838);
		} else if (arg2 == 3) {
			if (arg0.aString47.equals("-")) {
				...
				return Class488.method29821(arg0.aString47, arg1.aString47, Class106.aClass717_8, 437101550);
			}
		} else if (arg2 == 4) {
	...
	static final void method25891(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
