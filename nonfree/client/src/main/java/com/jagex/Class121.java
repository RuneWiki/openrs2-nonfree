...
public class Class121 implements Interface33 {
	...
	public void method28282(@OriginalArg(0) boolean arg0) {
		if (arg0) {
			@Pc(19) int local19 = this.aClass133_2.aClass390_6.method28273(this.aClass100_8.method18160(), client.anInt3511 * 2040043391, 1164798639) + this.aClass133_2.anInt1131 * -1599175185;
			@Pc(37) int local37 = this.aClass133_2.aClass392_6.method28290(this.aClass100_8.method18166(), client.anInt3512 * -817449061, (short) 255) + this.aClass133_2.anInt1132 * -1271918157;
			this.aClass100_8.method18169(local19, local37);
		}
	}
	...
	public void method28280(@OriginalArg(0) int arg0) {
		this.aClass100_8 = Class219.method25509(this.aClass497_29, this.aClass133_2.anInt1133 * 716586081, (byte) 123);
	}
	...
	public void method28285(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		if (arg0) {
			@Pc(19) int local19 = this.aClass133_2.aClass390_6.method28273(this.aClass100_8.method18160(), client.anInt3511 * 2040043391, 1457087606) + this.aClass133_2.anInt1131 * -1599175185;
			@Pc(37) int local37 = this.aClass133_2.aClass392_6.method28290(this.aClass100_8.method18166(), client.anInt3512 * -817449061, (short) 255) + this.aClass133_2.anInt1132 * -1271918157;
			this.aClass100_8.method18169(local19, local37);
		}
	}
	...
	public boolean method28279(@OriginalArg(0) int arg0) {
		return this.aClass497_29.method30054(this.aClass133_2.anInt1133 * 716586081, -512225963);
	}
	...
	public void method28281(@OriginalArg(0) boolean arg0) {
		if (arg0) {
			@Pc(19) int local19 = this.aClass133_2.aClass390_6.method28273(this.aClass100_8.method18160(), client.anInt3511 * 2040043391, -940416657) + this.aClass133_2.anInt1131 * -1599175185;
			@Pc(37) int local37 = this.aClass133_2.aClass392_6.method28290(this.aClass100_8.method18166(), client.anInt3512 * -817449061, (short) 255) + this.aClass133_2.anInt1132 * -1271918157;
			this.aClass100_8.method18169(local19, local37);
		}
	}
	...
	public void method28283() {
		this.aClass100_8 = Class219.method25509(this.aClass497_29, this.aClass133_2.anInt1133 * 716586081, (byte) 39);
	}

	@OriginalMember(owner = "client!jk", name = "l", descriptor = "()V", line = 20)
	@Override
	public void method28284() {
		this.aClass100_8 = Class219.method25509(this.aClass497_29, this.aClass133_2.anInt1133 * 716586081, (byte) 21);
	}
	...
	static final void method8704(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method8705(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method8706(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	public static void method8707(@OriginalArg(0) long[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) byte arg2) {
		Class550.method31028(arg0, arg1, 0, arg0.length - 1, -1505408746);
	}
	...
	public static int method8708(@OriginalArg(0) int arg0) {
		if (Class31.anInt106 * 617648335 == -1) {
			@Pc(7) Class31[] local7 = Class286.method26530((byte) 16);
	...
	static final void method8709(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1099080475);
