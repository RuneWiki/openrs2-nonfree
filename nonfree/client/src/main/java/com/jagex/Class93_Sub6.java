...
public class Class93_Sub6 extends Class93 {
	...
	public static int method12658(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		...
		@Pc(13) Class93_Sub6 local13 = Class557.method31065(arg0, arg3, (short) 255);
		@Pc(37) int local37;
		...
		return local5.method28080(local37, 1424306711);
	}
	...
	static void method12660(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		@Pc(4) Class93_Sub6 local4 = Class557.method31065(arg0, arg1, (short) 255);
		if (local4 == null) {
			return;
		}
	...
	final Class109 method12663(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class19 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class658 arg5, @OriginalArg(6) int arg6) {
		...
		if (arg2 != null) {
			local3 = arg1 | arg2.method23564(-2014248629);
		}
		@Pc(83) long local83 = this.method12659(local17, arg3, arg5 == null ? null : arg5.anIntArray511, arg4, 872529157);
		if (aClass240_19 != null) {
			local1 = (Class109) aClass240_19.method25839(local83);
		}
		if (local1 == null || arg0.method20693(local1.method6825(), local3) != 0) {
			if (local1 != null) {
				local3 = arg0.method20512(local3, local1.method6825());
			}
			@Pc(109) int local109 = local3;
			@Pc(111) boolean local111 = false;
			for (@Pc(113) int local113 = 0; local113 < local17.length; local113++) {
				if (local17[local113] != -1 && !((Class47) Class277.aClass32_Sub12_1.method18261(local17[local113], 1502071415)).method917(arg4, (Class48) null, -1231176817)) {
					local111 = true;
				}
			}
			if (local111) {
			...
			for (local149 = 0; local149 < local17.length; local149++) {
				if (local17[local149] != -1) {
					local147[local149] = ((Class47) Class277.aClass32_Sub12_1.method18261(local17[local149], 401021027)).method918(arg4, (Class48) null, -798141552);
				}
			}
			@Pc(207) int local207;
			@Pc(214) int local214;
				...
				for (local149 = 0; local149 < local5.anIntArrayArray65.length; local149++) {
					if (local5.anIntArrayArray65[local149] != null && local147[local149] != null) {
						...
						if (local228 != 0 || local235 != 0 || local242 != 0) {
							local147[local149].method25670(local228, local235, local242);
						}
						if (local207 != 0 || local214 != 0 || local221 != 0) {
							local147[local149].method25669(local207, local214, local221);
						}
					}
				}
			}
			...
			local1 = arg0.method20510(local281, local109, anInt1444 * -2144238343, 65, 852);
			if (arg5 != null) {
				local207 = 0;
				label123: while (true) {
					if (local207 >= 10) {
						...
						while (true) {
							...
							for (local214 = 0; local214 < Class138_Sub3.aShortArrayArray4[local207].length; local214++) {
								if (arg5.anIntArray512[local207] < Class79_Sub1_Sub2.aShortArrayArrayArray1[local207][local214].length) {
									local1.method6878(Class138_Sub3.aShortArrayArray4[local207][local214], Class79_Sub1_Sub2.aShortArrayArrayArray1[local207][local214][arg5.anIntArray512[local207]]);
								}
							}
							local207++;
						}
					...
					for (local214 = 0; local214 < Class618.aShortArrayArray6[local207].length; local214++) {
						if (arg5.anIntArray511[local207] < Class111.aShortArrayArrayArray3[local207][local214].length) {
							local1.method6993(Class618.aShortArrayArray6[local207][local214], Class111.aShortArrayArrayArray3[local207][local214][arg5.anIntArray511[local207]]);
						}
					}
					local207++;
				}
			...
			if (aClass240_19 != null) {
				...
				aClass240_19.method25830(local1, local83);
			}
		}
		if (arg2 == null) {
			return local1;
			...
			arg2.method23565(local411, 0, 726909592);
			return local411;
		}
	}
	...
	public static int method12665(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) boolean arg3) {
		...
		for (@Pc(12) int local12 = 0; local12 < local4.anIntArray173.length; local12++) {
			if (local4.anIntArray173[local12] >= 0 && local4.anIntArray173[local12] < Class277.aClass32_Sub12_1.anInt2487 * -152478627) {
				...
				@Pc(53) int local53 = local40.method945(arg1, ((Class87) Class124.aClass32_Sub21_7.method18261(arg1, 61109495)).anInt265 * 951920133, 1758654745);
				if (arg2) {
	...
	public static int method12670(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		...
		return local5.method28080(local37, 356664418);
	}
	...
	public static int method12671(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) boolean arg3) {
		...
		for (@Pc(12) int local12 = 0; local12 < local4.anIntArray173.length; local12++) {
			if (local4.anIntArray173[local12] >= 0 && local4.anIntArray173[local12] < Class277.aClass32_Sub12_1.anInt2487 * -152478627) {
				...
				@Pc(53) int local53 = local40.method945(arg1, ((Class87) Class124.aClass32_Sub21_7.method18261(arg1, -1669537007)).anInt265 * 951920133, 1394551160);
				if (arg2) {
					local10 += local53 * local4.anIntArray174[local12];
				} else if (local4.anIntArray174[local12] > 0) {
					local10 += local53;
	...
	final Class109 method12681(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class19 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class658 arg5) {
		...
		if (arg2 != null) {
			local3 = arg1 | arg2.method23564(-1848291544);
		}
		@Pc(83) long local83 = this.method12659(local17, arg3, arg5 == null ? null : arg5.anIntArray511, arg4, -492352189);
		if (aClass240_19 != null) {
			local1 = (Class109) aClass240_19.method25839(local83);
		}
		if (local1 == null || arg0.method20693(local1.method6825(), local3) != 0) {
			...
			@Pc(111) boolean local111 = false;
			for (@Pc(113) int local113 = 0; local113 < local17.length; local113++) {
				if (local17[local113] != -1 && !((Class47) Class277.aClass32_Sub12_1.method18261(local17[local113], -1051006597)).method917(arg4, (Class48) null, -1124244071)) {
					local111 = true;
				}
			}
			if (local111) {
			...
			for (local149 = 0; local149 < local17.length; local149++) {
				if (local17[local149] != -1) {
					local147[local149] = ((Class47) Class277.aClass32_Sub12_1.method18261(local17[local149], 1181971570)).method918(arg4, (Class48) null, -1149070636);
				}
			}
			@Pc(207) int local207;
			@Pc(214) int local214;
		...
		if (arg2 == null) {
			...
			@Pc(411) Class109 local411 = local1.method6907((byte) 1, local3, true);
			arg2.method23565(local411, 0, -718444510);
			return local411;
		}
	}
	...
	static void method12682(@OriginalArg(0) int arg0) {
		...
		aClass240_19.method25833((byte) -15);
	}
