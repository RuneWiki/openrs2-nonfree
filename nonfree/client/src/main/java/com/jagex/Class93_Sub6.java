...
public class Class93_Sub6 extends Class93 {
	...
	public static int method12658(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(5) Class379 local5 = (Class379) Class30.aClass32_Sub16_1.method18261(arg2);
		@Pc(8) Class108 local8 = local5.aClass108_1;
		@Pc(13) Class93_Sub6 local13 = Class557.method31065(arg0, arg3);
		@Pc(37) int local37;
		if (local13 == null || arg1 < 0 || arg1 >= local13.anIntArray174.length || local13.aClass40Array1 == null || local13.aClass40Array1[arg1] == null) {
			local37 = (Integer) local8.method7438();
		} else {
			local37 = local13.aClass40Array1[arg1].method781(local8.anInt867 * -1284841473);
		}
		return local5.method28080(local37);
	}
	...
	long method12659(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) boolean arg3) {
	...
	final Class109 method12663(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class19 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class658 arg5) {
		@Pc(1) Class109 local1 = null;
		@Pc(3) int local3 = arg1;
		@Pc(5) Class622 local5 = null;
		if (arg3 != -1) {
			local5 = (Class622) Class166_Sub6.aClass32_Sub5_1.method18261(arg3);
		}
		...
		if (arg2 != null) {
			local3 = arg1 | arg2.method23564();
		}
		@Pc(83) long local83 = this.method12659(local17, arg3, arg5 == null ? null : arg5.anIntArray511, arg4);
		...
		if (local1 == null || arg0.method20693(local1.method6825(), local3) != 0) {
			...
			for (@Pc(113) int local113 = 0; local113 < local17.length; local113++) {
				if (local17[local113] != -1 && !((Class47) Class277.aClass32_Sub12_1.method18261(local17[local113])).method917(arg4, null)) {
					local111 = true;
				}
			}
			if (local111) {
			...
			for (local149 = 0; local149 < local17.length; local149++) {
				if (local17[local149] != -1) {
					local147[local149] = ((Class47) Class277.aClass32_Sub12_1.method18261(local17[local149])).method918(arg4, null);
				}
			}
			@Pc(207) int local207;
			@Pc(214) int local214;
	...
	static void method12682(@OriginalArg(0) int arg0) {
		...
		aClass240_19.method25833();
	}

	@OriginalMember(owner = "client!ajo", name = "jw", descriptor = "(Lclient!yf;I)V", line = 6661)
	static final void method12683(@OriginalArg(0) Class681 arg0) {
