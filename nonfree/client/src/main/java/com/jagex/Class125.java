...
public class Class125 implements Interface32 {
	...
	static Class125 method21458(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(6) Class390 local6 = Class708.method36756(8644033)[arg0.method22413((short) 16384)];
		@Pc(13) Class392 local13 = Class252.method25978(973780826)[arg0.method22413((short) 16384)];
		@Pc(17) int local17 = arg0.method22482((byte) -29);
		@Pc(21) int local21 = arg0.method22482((byte) -79);
		@Pc(25) int local25 = arg0.method22415(-1434290800);
		@Pc(29) int local29 = arg0.method22415(-1434290800);
		@Pc(33) int local33 = arg0.method22482((byte) -111);
		@Pc(37) int local37 = arg0.method22436(-2087591759);
	...
	static void method21459(@OriginalArg(0) int[] arg0, @OriginalArg(1) double arg1) {
		@Pc(5) int local5;
		@Pc(18) int local18;
	...
	public static Class320 method21460(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return Class166_Sub1.aClass320Array1[arg0 >> 16];
	}

	@OriginalMember(owner = "client!kp", name = "ou", descriptor = "(Lclient!yf;I)V", line = 7651)
	static final void method21461(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class362.method27842(local11, local14, arg0, 1611628891);
	}

	@OriginalMember(owner = "client!kp", name = "ar", descriptor = "(IIIB)V", line = 253)
	static void method21462(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		@Pc(4) Class93_Sub1_Sub11 local4 = Class371.method28006(9, (long) arg0);
		local4.method21801(-1171764247);
	...
	public static void method21463(@OriginalArg(0) int arg0) {
