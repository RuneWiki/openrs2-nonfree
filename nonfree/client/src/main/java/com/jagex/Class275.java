...
public class Class275 {
	...
	public static void method26341(@OriginalArg(0) int arg0) {
		...
		synchronized (Class330.aClass240_79) {
			Class330.aClass240_79.method25833((byte) -106);
		}
	}

	@OriginalMember(owner = "client!ft", name = "el", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;I)V", line = 5733)
	static final void method26342(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		if (arg0.anInt3970 * 532402067 == -1 && !arg1.aBoolean708) {
			Class502.method30175(arg0.anInt3953 * -1549590237, -235547912);
		}
	}

	@OriginalMember(owner = "client!ft", name = "aay", descriptor = "(Lclient!yf;I)V", line = 9776)
	static final void method26343(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static void method26344(@OriginalArg(0) boolean arg0, @OriginalArg(1) byte arg1) {
		@Pc(3) Class611 local3 = Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.method19978(1927066028);
		@Pc(13) Class93_Sub1_Sub20 local13 = Class159_Sub1.method14508(local3.anInt5623 * 270611681, local3.anInt5624 * -1994307635);
		if (local13 == null) {
			local13 = Class159_Sub1.method14509(Class159_Sub1.aClass637_2.anInt5747 * 267023917);
		}
