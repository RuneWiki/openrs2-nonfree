...
public class Class540 implements Interface18, Interface19, Interface56 {
	...
	Class540(@OriginalArg(0) Class104_Sub2_Sub2 arg0, @OriginalArg(1) Class206 arg1, @OriginalArg(2) Class226 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		OpenGL.glRenderbufferStorageEXT(36161, Class104_Sub2_Sub2.method21309(this.aClass206_28, this.aClass226_33), arg3, arg4);
	}
	...
	Class540(@OriginalArg(0) Class104_Sub2_Sub2 arg0, @OriginalArg(1) Class206 arg1, @OriginalArg(2) Class226 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		this.anInt5285 = local19[0];
		OpenGL.glBindRenderbufferEXT(36161, this.anInt5285);
		OpenGL.glRenderbufferStorageMultisampleEXT(36161, arg5, Class104_Sub2_Sub2.method21309(this.aClass206_28, this.aClass226_33), arg3, arg4);
	}
	...
	void method30896() {
		if (this.anInt5285 != 0) {
			this.aClass104_Sub2_Sub2_11.method21303(this.anInt5285, this.anInt5286 * this.anInt5287 * this.aClass226_33.anInt3646 * -1066472467 * this.aClass206_28.anInt3389 * -1639868421);
			this.anInt5285 = 0;
		}
	}
	...
	void method30899() throws Throwable {
		this.method30898();
		super.finalize();
	}
}
