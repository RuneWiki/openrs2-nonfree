...
public class Class212 {
	...
	Class212(@OriginalArg(0) int arg0, @OriginalArg(1) Class93_Sub41 arg1, @OriginalArg(2) boolean arg2) {
		this.anInt3600 = arg1.method22482() * 1682249735;
		...
		for (@Pc(33) int local33 = 0; local33 < this.aClass489Array8.length; local33++) {
			...
			this.aFloatArrayArray23[local33][0] = arg1.method22425();
			this.aFloatArrayArray23[local33][1] = arg1.method22425();
			this.aFloatArrayArray23[local33][2] = arg1.method22425();
		}
	}
	...
	Class489 method25432(@OriginalArg(0) int arg0) {
		if (this.aClass489Array9[arg0] == null) {
			this.aClass489Array9[arg0] = new Class489(this.method25438(arg0));
	...
	Class489 method25431(@OriginalArg(0) int arg0) {
		if (this.aClass489Array7[arg0] == null) {
			this.aClass489Array7[arg0] = new Class489(this.method25438(arg0));
			if (this.aClass212_1 == null) {
				this.aClass489Array7[arg0].method29953(Class489.aClass489_99);
			} else {
				this.aClass489Array7[arg0].method29953(this.aClass212_1.method25433(arg0));
			}
		}
	...
	Class489 method25433(@OriginalArg(0) int arg0) {
		if (this.aClass489Array7[arg0] == null) {
			this.aClass489Array7[arg0] = new Class489(this.method25438(arg0));
			if (this.aClass212_1 == null) {
				this.aClass489Array7[arg0].method29953(Class489.aClass489_99);
	...
	static int method25443(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public static void method25444() {
		...
		Class249.anInt3842 = Class274.aClass258_1.method26053() * -1512963435;
	...
	static final void method25440(@OriginalArg(0) Class681 arg0) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class170.method21484(local11, local14, arg0);
	}

	@OriginalMember(owner = "client!cs", name = "ami", descriptor = "(Lclient!yf;B)V", line = 12165)
	static final void method25445(@OriginalArg(0) Class681 arg0) {
		if (Class429.anInt4781 * -1453926679 == 3) {
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = (int) ((double) Class65.aClass123_Sub1_2.method8962() * 2607.5945876176133D) >> 3;
		} else {
	...
	public static final void method25442(@OriginalArg(0) String arg0) {
		if (arg0 == null) {
			return;
		}
		...
		for (@Pc(13) int local13 = 0; local13 < client.anInt3573 * 1882800101; local13++) {
			...
			@Pc(30) String local30 = Class82.method1385(local25, client.aClass83_10);
			if (Class32_Sub10.method17005(arg0, local7, local25, local30)) {
				...
				@Pc(65) Class175 local65 = Class330.method27372();
				@Pc(71) Class93_Sub22 local71 = Class102.method2592(Class446.aClass446_44, local65.aClass24_2);
				local71.aClass93_Sub41_Sub2_1.method22510(Class46.method894(arg0));
				local71.aClass93_Sub41_Sub2_1.method22402(arg0);
				local65.method24351(local71);
				break;
			}
		}
	}
	...
	static final void method25441(@OriginalArg(0) Class681 arg0) {
		Class584.method31428(Class159_Sub1.anInt1949 * 1211831979);
	}
}
