...
public class Class325 {
	...
	void method27296(@OriginalArg(0) Class326 arg0, @OriginalArg(1) int arg1) {
		@Pc(3) int local3 = arg0.method27306(2111968903);
		this.aClass323_133 = Class449.method28930(379945710)[local3];
		@Pc(17) int local17;
		if (Class323.aClass323_9 == this.aClass323_133) {
			local17 = arg0.method27306(4220749);
			this.aClass323_132 = Class449.method28930(1869537355)[local17];
			this.anInt4138 = arg0.method27306(-10506204) * -592418195;
		}
		this.aString176 = arg0.method27307(729817088);
		this.aString177 = arg0.method27307(2050694886);
		local17 = arg0.method27306(1774332947);
		this.anIntArray404 = new int[local17];
		this.anIntArray405 = new int[local17];
		for (@Pc(54) int local54 = 0; local54 < local17; local54++) {
			this.anIntArray404[local54] = arg0.method27306(1925979308);
			this.anIntArray405[local54] = arg0.method27306(760590409);
		}
	}

	@OriginalMember(owner = "client!hv", name = "n", descriptor = "(Lclient!hw;)V", line = 61)
	void method27297(@OriginalArg(0) Class326 arg0) {
		@Pc(3) int local3 = arg0.method27306(1827444776);
		this.aClass323_133 = Class449.method28930(883563858)[local3];
		@Pc(17) int local17;
		if (Class323.aClass323_9 == this.aClass323_133) {
			local17 = arg0.method27306(492955076);
			this.aClass323_132 = Class449.method28930(1598590006)[local17];
			this.anInt4138 = arg0.method27306(191215798) * -592418195;
		}
		this.aString176 = arg0.method27307(-1485007811);
		this.aString177 = arg0.method27307(-605603775);
		local17 = arg0.method27306(1824383204);
		this.anIntArray404 = new int[local17];
		this.anIntArray405 = new int[local17];
		for (@Pc(54) int local54 = 0; local54 < local17; local54++) {
			this.anIntArray404[local54] = arg0.method27306(1757704821);
			this.anIntArray405[local54] = arg0.method27306(1613179921);
		}
	}

	@OriginalMember(owner = "client!hv", name = "m", descriptor = "(Lclient!hw;)V", line = 61)
	void method27298(@OriginalArg(0) Class326 arg0) {
		@Pc(3) int local3 = arg0.method27306(1981299989);
		this.aClass323_133 = Class449.method28930(339649391)[local3];
		@Pc(17) int local17;
		if (Class323.aClass323_9 == this.aClass323_133) {
			local17 = arg0.method27306(1625307413);
			this.aClass323_132 = Class449.method28930(1794091978)[local17];
			this.anInt4138 = arg0.method27306(1129541645) * -592418195;
		}
		this.aString176 = arg0.method27307(-2088652371);
		this.aString177 = arg0.method27307(-228685974);
		local17 = arg0.method27306(1358335381);
		this.anIntArray404 = new int[local17];
		this.anIntArray405 = new int[local17];
		for (@Pc(54) int local54 = 0; local54 < local17; local54++) {
			this.anIntArray404[local54] = arg0.method27306(4210160);
			this.anIntArray405[local54] = arg0.method27306(935821596);
		}
	}
	...
	static final void method27300(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(43) Class5 local43 = Class157.aClass462_2.method29241(client.anInterface50_1, local37, -1874981454);
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = local43.method55(local13, local27, Class110_Sub14.aClass100Array4, -1910907678);
	}

	@OriginalMember(owner = "client!hv", name = "aqx", descriptor = "(Lclient!yf;I)V", line = 12816)
	static final void method27301(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!hv", name = "lk", descriptor = "(Ljava/lang/String;ZB)I", line = 12352)
	public static int method27302(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) byte arg2) {
		...
		for (local36 = local20; local36 < local34; local36++) {
			...
			if (local44.aBoolean513 && local44.method22947(-1491104235).toLowerCase().indexOf(local2) != -1) {
				if (local10.size() >= 50) {
					return -1;
				}
				local10.add(local36);
				local14.add(local44.method22947(-1491104235));
			}
		}
		...
		@Pc(107) String[] local107 = (String[]) (String[]) local14.toArray(new String[Class143_Sub1.anIntArray158.length]);
	...
	static final void method27303(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, -666873988);
	...
	static final void method27304(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		Class335.method27409((String) arg0.anObjectArray45[(arg0.anInt5888 -= 957530791) * 587908375], -1287941740);
	}
}
