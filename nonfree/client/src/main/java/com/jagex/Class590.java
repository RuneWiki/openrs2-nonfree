...
public class Class590 {
	...
	void method31688(@OriginalArg(0) byte arg0) {
		if (anInt5475 * -242402193 < 500) {
			this.aClass132_Sub1_Sub1_1 = null;
			this.aClass590_2 = Class650.aClass590_3;
			Class650.aClass590_3 = this;
	...
	public static Class398 method31690(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		@Pc(3) int local3 = arg0.method22436(-1000341262);
		return new Class398(local3);
	}

	@OriginalMember(owner = "client!uc", name = "akp", descriptor = "(Lclient!yf;I)V", line = 11600)
	static final void method31691(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	public static int method31692(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
