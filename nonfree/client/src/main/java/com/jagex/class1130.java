...
public class class1130 extends class892 {
	...
	public void method19121(class997 arg0, byte arg1) {
		...
		if (var3 != var22) {
			...
			var24.field4308 = (float) ((this.field10450[0] << 9) + (this.method16546() << 8));
			var24.field4313 = (float) ((this.field10448[0] << 9) + (this.method16546() << 8));
	...
	public final void method19129(class997 arg0) {
		...
		var7.field4308 += (float) (this.method16546() - var5 << 8);
		var7.field4313 += (float) (this.method16546() - var5 << 8);
	...
	public void method19113(class133 arg0, class419 arg1, class116 arg2, long arg3, long arg4, int arg5, long arg6) {
		...
		if (var14 != null) {
			arg0.method2219(false);
			var14.method1813(arg1, (class141) null, 0);
			arg0.method2219(true);
		}
	}
	...
	public void method19118(int arg0, int arg1) {
		...
		var4.field4308 = (float) (this.field10450[0] * 512 + var3 * 256);
		var4.field4313 = (float) (this.field10448[0] * 512 + var3 * 256);
