...
public class Class93_Sub40_Sub3 extends Class93_Sub40 {
	...
	public boolean method23193(@OriginalArg(0) byte arg0) {
		...
		if (local6 == null) {
			...
			Class305.method26802(Class155.aClass155_64, this.anInt3172 * 1220811495, -1, local6, this.anInt3160 * -779181219, 936458645);
			return true;
		}
	}
	...
	public boolean method23192() {
		...
		if (local6 == null) {
			...
			Class305.method26802(Class155.aClass155_64, this.anInt3172 * 1220811495, -1, local6, this.anInt3160 * -779181219, 359177384);
			return true;
		}
	}
	...
	public boolean method23194() {
		...
		if (local6 == null) {
			...
			Class305.method26802(Class155.aClass155_64, this.anInt3172 * 1220811495, -1, local6, this.anInt3160 * -779181219, 1771021005);
			return true;
		}
	}
	...
	public boolean method23195() {
		...
		if (local6 == null) {
			...
			Class305.method26802(Class155.aClass155_64, this.anInt3172 * 1220811495, -1, local6, this.anInt3160 * -779181219, 1253440145);
			return true;
		}
	}
}
