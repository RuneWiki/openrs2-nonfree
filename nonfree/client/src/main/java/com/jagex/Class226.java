...
public class Class226 {
	...
	static final void method25606(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method25607(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class557.aClass297_1.method26622(local12, 223808178).method26748((byte) -1);
	}

	@OriginalMember(owner = "client!dg", name = "k", descriptor = "(B)V", line = 57)
	static void method25608(@OriginalArg(0) byte arg0) {
		...
		@Pc(13) Class472 local13 = local4.method21402((byte) 15);
		...
		if (Class82.aClass153_1.method14093(1207250565)) {
			...
			local68.method29466(1.0F, 0.0F, 0.0F, (float) (Class82.aClass153_1.method14064(72964087) - Class627.anInt5705 * -133818179) / 200.0F);
			...
			local96.method29465(local91, (float) (Class1.anInt1 * -719242275 - Class82.aClass153_1.method14058(-1368507220)) / 200.0F);
		...
		Class627.anInt5705 = Class82.aClass153_1.method14064(1069627507) * -155409771;
		local17.method29470();
		...
		@Pc(240) Class611 local240 = client.aClass532_1.method30443(2087749905);
		@Pc(247) int local247 = local240.anInt5623 * 270611681 << 9;
		@Pc(254) int local254 = local240.anInt5624 * -1994307635 << 9;
		Class1.aClass123_Sub1_1.method8924(0.02F, client.aClass532_1.method30460(-310507201).anIntArrayArrayArray14, client.aClass532_1.method30509(-608801050), local247, local254, 1160510591);
	}
}
