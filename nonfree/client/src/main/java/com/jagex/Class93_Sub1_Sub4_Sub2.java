...
public class Class93_Sub1_Sub4_Sub2 extends Class93_Sub1_Sub4 {
	...
	static final void method23518(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg3 >= arg4) {
			return;
		}
		arg1 += arg3;
	...
	boolean method23520(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.aByteArray62.length >= arg0 * arg1;
	}

	@OriginalMember(owner = "client!atk", name = "p", descriptor = "(IIIIII)V", line = 46)
	void method23521(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(1) int local1 = 0;
		if (arg1 != arg0) {
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (arg1 < arg2) {
					...
					while (true) {
						...
						if (arg1 < 0) {
							while (true) {
								...
								method23518(this.aByteArray62, arg0, 0, arg4 >> 16, arg5 >> 16);
								arg5 += local31;
								arg4 += local16;
								arg0 += this.anInt3210;
							}
						}
						method23518(this.aByteArray62, arg0, 0, arg3 >> 16, arg5 >> 16);
						arg5 += local31;
						arg3 += local1;
						arg0 += this.anInt3210;
					}
					...
					while (true) {
						...
						if (arg1 < 0) {
							while (true) {
								...
								method23518(this.aByteArray62, arg0, 0, arg5 >> 16, arg4 >> 16);
								arg5 += local31;
								arg4 += local16;
								arg0 += this.anInt3210;
							}
						}
						method23518(this.aByteArray62, arg0, 0, arg5 >> 16, arg3 >> 16);
						arg5 += local31;
						arg3 += local1;
						arg0 += this.anInt3210;
					}
				...
				if ((arg0 == arg2 || local31 >= local1) && (arg0 != arg2 || local16 <= local1)) {
					...
					while (true) {
						...
						method23518(this.aByteArray62, arg0, 0, arg3 >> 16, arg4 >> 16);
						arg4 += local31;
						arg3 += local1;
						arg0 += this.anInt3210;
					}
					...
					while (true) {
						...
						method23518(this.aByteArray62, arg0, 0, arg4 >> 16, arg3 >> 16);
						arg4 += local31;
						arg3 += local1;
						arg0 += this.anInt3210;
					}
			...
			if (arg2 < arg0) {
					...
					while (true) {
						...
						if (arg2 < 0) {
							while (true) {
								...
								method23518(this.aByteArray62, arg1, 0, arg3 >> 16, arg5 >> 16);
								arg3 += local1;
								arg5 += local31;
								arg1 += this.anInt3210;
							}
						}
						method23518(this.aByteArray62, arg1, 0, arg3 >> 16, arg4 >> 16);
						arg3 += local1;
						arg4 += local16;
						arg1 += this.anInt3210;
					}
					...
					while (true) {
						...
						if (arg2 < 0) {
							while (true) {
								...
								method23518(this.aByteArray62, arg1, 0, arg5 >> 16, arg3 >> 16);
								arg3 += local1;
								arg5 += local31;
								arg1 += this.anInt3210;
							}
						}
						method23518(this.aByteArray62, arg1, 0, arg4 >> 16, arg3 >> 16);
						arg3 += local1;
						arg4 += local16;
						arg1 += this.anInt3210;
					}
				...
				if (local1 < local16) {
					...
					while (true) {
						...
						method23518(this.aByteArray62, arg1, 0, arg5 >> 16, arg4 >> 16);
						arg5 += local1;
						arg4 += local16;
						arg1 += this.anInt3210;
					}
					...
					while (true) {
						...
						method23518(this.aByteArray62, arg1, 0, arg4 >> 16, arg5 >> 16);
						arg5 += local1;
						arg4 += local16;
						arg1 += this.anInt3210;
					}
				...
				while (true) {
					...
					if (arg0 < 0) {
						while (true) {
							...
							method23518(this.aByteArray62, arg2, 0, arg4 >> 16, arg3 >> 16);
							arg4 += local16;
							arg3 += local1;
							arg2 += this.anInt3210;
						}
					}
					method23518(this.aByteArray62, arg2, 0, arg4 >> 16, arg5 >> 16);
					arg4 += local16;
					arg5 += local31;
					arg2 += this.anInt3210;
				}
				...
				while (true) {
					...
					if (arg0 < 0) {
						while (true) {
							...
							method23518(this.aByteArray62, arg2, 0, arg3 >> 16, arg4 >> 16);
							arg4 += local16;
							arg3 += local1;
							arg2 += this.anInt3210;
						}
					}
					method23518(this.aByteArray62, arg2, 0, arg5 >> 16, arg4 >> 16);
					arg4 += local16;
					arg5 += local31;
					arg2 += this.anInt3210;
				}
			...
			if (local16 < local31) {
				...
				while (true) {
					...
					method23518(this.aByteArray62, arg2, 0, arg3 >> 16, arg5 >> 16);
					arg3 += local16;
					arg5 += local31;
					arg2 += this.anInt3210;
				}
				...
				while (true) {
					...
					method23518(this.aByteArray62, arg2, 0, arg5 >> 16, arg3 >> 16);
					arg3 += local16;
					arg5 += local31;
					arg2 += this.anInt3210;
				}
	...
	void method23522(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(1) int local1 = 0;
		if (arg1 != arg0) {
			local1 = (arg4 - arg3 << 16) / (arg1 - arg0);
		}
	...
	void method23523(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.anInt3212 = arg0;
		this.anInt3209 = arg1;
		this.anInt3210 = arg2 - arg0;
		this.anInt3213 = arg3 - arg1;
	...
	boolean method23525(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.aByteArray62.length >= arg0 * arg1;
	}
	...
	void method23529(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(1) int local1 = 0;
		if (arg1 != arg0) {
			local1 = (arg4 - arg3 << 16) / (arg1 - arg0);
		}
