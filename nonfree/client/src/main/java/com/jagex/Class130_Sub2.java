...
public class Class130_Sub2 extends Class130 {
	...
	boolean method10028() throws Exception_Sub2 {
		this.aClass115_2 = this.aClass104_Sub2_14.method20892("BatchedSprite");
		this.aClass93_Sub33_Sub1_17 = this.aClass115_2.method8198("SpriteSampler");
		this.aClass116_1 = this.aClass115_2.method8268("Normal");
		this.aClass115_2.method8203(this.aClass116_1);
		return true;
	}

	@OriginalMember(owner = "client!ahq", name = "f", descriptor = "(I)Z", line = 19)
	boolean method10029() throws Exception_Sub2 {
		this.aClass115_2 = this.aClass104_Sub2_14.method20892("BatchedSprite");
		this.aClass93_Sub33_Sub1_17 = this.aClass115_2.method8198("SpriteSampler");
		this.aClass116_1 = this.aClass115_2.method8268("Normal");
		this.aClass115_2.method8203(this.aClass116_1);
	...
	public void method10025() {
		...
		this.aClass115_2.method8293(this.aClass93_Sub33_Sub1_17, 0, this.anInterface38_12);
	}
	...
	static final void method10030(@OriginalArg(0) Class681 arg0) {
