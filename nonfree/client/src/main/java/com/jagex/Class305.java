...
public final class Class305 {
	...
	public static final synchronized long method26796(@OriginalArg(0) int arg0) {
	...
	public static final synchronized long method26797() {
		@Pc(1) long local1 = System.currentTimeMillis();
		if (local1 < aLong257 * 3821070258679340455L) {
			aLong256 += (aLong257 * 3821070258679340455L - local1) * 7664086464780785289L;
		}
	...
	static void method26798(@OriginalArg(0) Class573 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method26799(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
	...
	static final void method26800(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	public static final int method26801(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		if (client.aClass532_1.method30459(-1392626687) == null) {
			return 0;
		}
		@Pc(9) int local9 = arg0 >> 9;
		@Pc(13) int local13 = arg1 >> 9;
		if (local9 < 0 || local13 < 0 || local9 > client.aClass532_1.method30444(-474836985) - 1 || local13 > client.aClass532_1.method30474((short) 128) - 1) {
			return 0;
		}
		@Pc(35) int local35 = arg2;
		if (arg2 < 3 && (client.aClass532_1.method30509(-1502082692).aByteArrayArrayArray12[1][local9][local13] & 0x2) != 0) {
			local35 = arg2 + 1;
		}
		return client.aClass532_1.method30459(-1352859328).aClass99Array1[local35].method2480(arg0, arg1, 942007362);
	}

	@OriginalMember(owner = "client!gz", name = "l", descriptor = "(Lclient!uh;IILclient!ahm;II)V", line = 284)
	public static void method26802(@OriginalArg(0) Class155 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class132_Sub1_Sub1_Sub1 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
	...
	static void method26803(@OriginalArg(0) File arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) throws IOException {
