...
public final class Class305 {
	...
	static void method26803(@OriginalArg(0) File arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2) throws IOException {
	...
	public static final synchronized long method26796() {
	...
	static void method26798(@OriginalArg(0) Class573 arg0) {
	...
	public static void method26802(@OriginalArg(0) Class155 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class132_Sub1_Sub1_Sub1 arg3, @OriginalArg(4) int arg4) {
	...
	static final void method26799(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
		arg0.aBoolean690 = false;
		Class354.method27696(arg0);
	}

	@OriginalMember(owner = "client!gz", name = "iw", descriptor = "(IIIB)I", line = 6306)
	public static final int method26801(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (client.aClass532_1.method30459() == null) {
			return 0;
		}
		@Pc(9) int local9 = arg0 >> 9;
		@Pc(13) int local13 = arg1 >> 9;
		if (local9 < 0 || local13 < 0 || local9 > client.aClass532_1.method30444() - 1 || local13 > client.aClass532_1.method30474() - 1) {
			return 0;
		}
		@Pc(35) int local35 = arg2;
		if (arg2 < 3 && (client.aClass532_1.method30509().aByteArrayArrayArray12[1][local9][local13] & 0x2) != 0) {
			local35 = arg2 + 1;
		}
		return client.aClass532_1.method30459().aClass99Array1[local35].method2480(arg0, arg1);
	}

	@OriginalMember(owner = "client!gz", name = "ue", descriptor = "(Lclient!yf;B)V", line = 8716)
	static final void method26800(@OriginalArg(0) Class681 arg0) {
