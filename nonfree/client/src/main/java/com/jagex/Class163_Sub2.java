...
public class Class163_Sub2 extends Class163 {
	...
	void method14912(@OriginalArg(0) int arg0) {
		...
		@Pc(11) int local11 = this.method14904(local3, 32767, 1960704974);
		@Pc(15) int local15 = local3.method22874((byte) -91);
		if (local15 < 0) {
			local15 = 0;
		} else if (local15 > 65535) {
			local15 = 65535;
		}
		@Pc(29) int local29 = local3.method22873(-1678286317);
		if (local29 < 0) {
			local29 = 0;
		...
		if (local3.method22890(1106946160) == 2) {
			local41 = 1;
		}
		@Pc(54) Class93_Sub22 local54 = Class102.method2592(Class446.aClass446_47, client.aClass175_2.aClass24_2, (byte) 119);
		local54.aClass93_Sub41_Sub2_1.method22395(local29 | local15 << 16, (byte) 20);
		local54.aClass93_Sub41_Sub2_1.method22456(local11 | local41 << 15, (short) 255);
		client.aClass175_2.method24351(local54, -2063301593);
	}

	@OriginalMember(owner = "client!alt", name = "u", descriptor = "(I)Z", line = 34)
	@Override
	boolean method14914(@OriginalArg(0) int arg0) {
		return this.method14929(1134103010) != null || this.aLong106 * -1130360274060180351L < Class305.method26796(1076665732) - 2000L;
	}
	...
	void method14910() {
		...
		@Pc(11) int local11 = this.method14904(local3, 32767, -1725280454);
		@Pc(15) int local15 = local3.method22874((byte) -23);
		if (local15 < 0) {
			local15 = 0;
		} else if (local15 > 65535) {
			local15 = 65535;
		...
		@Pc(41) byte local41 = 0;
		if (local3.method22890(-1042519865) == 2) {
			local41 = 1;
		}
		@Pc(54) Class93_Sub22 local54 = Class102.method2592(Class446.aClass446_47, client.aClass175_2.aClass24_2, (byte) 35);
		local54.aClass93_Sub41_Sub2_1.method22395(local29 | local15 << 16, (byte) 38);
		local54.aClass93_Sub41_Sub2_1.method22456(local11 | local41 << 15, (short) 255);
		client.aClass175_2.method24351(local54, -1490890350);
	}
	...
	void method14911() {
		...
		@Pc(11) int local11 = this.method14904(local3, 32767, 1484218136);
		@Pc(15) int local15 = local3.method22874((byte) -107);
		if (local15 < 0) {
			local15 = 0;
		} else if (local15 > 65535) {
			local15 = 65535;
		...
		@Pc(41) byte local41 = 0;
		if (local3.method22890(214706887) == 2) {
			local41 = 1;
		}
		@Pc(54) Class93_Sub22 local54 = Class102.method2592(Class446.aClass446_47, client.aClass175_2.aClass24_2, (byte) 78);
		local54.aClass93_Sub41_Sub2_1.method22395(local29 | local15 << 16, (byte) -2);
		local54.aClass93_Sub41_Sub2_1.method22456(local11 | local41 << 15, (short) 255);
		client.aClass175_2.method24351(local54, -1921175465);
	}

	@OriginalMember(owner = "client!alt", name = "c", descriptor = "()Z", line = 34)
	@Override
	boolean method14900() {
		return this.method14929(542776431) != null || this.aLong106 * -1130360274060180351L < Class305.method26796(1094397478) - 2000L;
	}
