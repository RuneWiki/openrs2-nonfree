...
class Class506 implements Comparator {
	...
	int method30211(@OriginalArg(0) Class503 arg0, @OriginalArg(1) Class503 arg1) {
	...
	int method30218(@OriginalArg(0) Class503 arg0, @OriginalArg(1) Class503 arg1) {
		if (arg0.aLong284 * -2148301208355003327L > arg1.aLong284 * -2148301208355003327L) {
			return 1;
		} else if (arg0.aLong284 * -2148301208355003327L < arg1.aLong284 * -2148301208355003327L) {
			return -1;
	...
	public int compare(@OriginalArg(0) Object arg0, @OriginalArg(1) Object arg1) {
		return this.method30211((Class503) arg0, (Class503) arg1);
	}

	@OriginalMember(owner = "client!qi", name = "m", descriptor = "(Ljava/lang/Object;Ljava/lang/Object;)I", line = 15)
	public int method30212(@OriginalArg(0) Object arg0, @OriginalArg(1) Object arg1) {
		return this.method30211((Class503) arg0, (Class503) arg1);
	}

	@OriginalMember(owner = "client!qi", name = "e", descriptor = "(Lclient!dh;IILclient!hf;I)V", line = 17)
	static void method30221(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class312 arg3) {
	...
	public boolean method30214(@OriginalArg(0) Object arg0) {
		return super.equals(arg0);
	}

	@OriginalMember(owner = "client!qi", name = "rq", descriptor = "(Ljava/lang/Object;)Z", line = 19)
	public boolean method30215(@OriginalArg(0) Object arg0) {
		return super.equals(arg0);
	}
	...
	static final byte[] method30222(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class93_Sub41 local4 = new Class93_Sub41(arg0);
		@Pc(9) Class477 local9 = new Class477(local4);
		@Pc(13) Class484 local13 = local9.method29690();
		@Pc(17) int local17 = local9.method29691();
		if (local17 < 0 || Class497.anInt5175 * -1140330639 != 0 && local17 > Class497.anInt5175 * -1140330639) {
			...
			local4.method22430(local38, 0, local17);
			return local38;
		} else {
			@Pc(50) int local50 = local9.method29701();
			...
			if (Class484.aClass484_2 == local13) {
				...
				synchronized (Class497.aClass91_1) {
					Class497.aClass91_1.method1703(local4, local72);
				}
			} else if (local13 == Class484.aClass484_3) {
				try {
					local72 = Class587.method31647(local4, local50);
	...
	static final void method30219(@OriginalArg(0) Class681 arg0) {
	...
	static final void method30220(@OriginalArg(0) Class681 arg0) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class255.method26008();
	}
}
