...
class Class506 implements Comparator {
	...
	static final void method30219(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method30220(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
	...
	static void method30221(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class312 arg3, @OriginalArg(4) int arg4) {
		@Pc(1) byte local1 = 127;
		@Pc(3) byte local3 = 7;
		for (@Pc(5) int local5 = 63; local5 >= 0; local5--) {
			@Pc(23) int local23 = (local5 & 0x3F) << 10 | (local3 & 0x7) << 7 | local1 & 0x7F;
			Class660.method32825(false, true, 1902068381);
	...
	static final byte[] method30222(@OriginalArg(0) byte[] arg0, @OriginalArg(1) byte arg1) {
		@Pc(4) Class93_Sub41 local4 = new Class93_Sub41(arg0);
		@Pc(9) Class477 local9 = new Class477(local4);
		@Pc(13) Class484 local13 = local9.method29690((byte) -127);
		@Pc(17) int local17 = local9.method29691(-936234138);
		if (local17 < 0 || Class497.anInt5175 * -1140330639 != 0 && local17 > Class497.anInt5175 * -1140330639) {
			...
			local4.method22430(local38, 0, local17, (short) 3634);
			return local38;
		} else {
			...
			if (Class484.aClass484_2 == local13) {
				...
				try {
					local72 = Class587.method31647(local4, local50, 48301838);
