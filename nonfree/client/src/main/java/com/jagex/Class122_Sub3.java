...
public class Class122_Sub3 extends Class122 {
	...
	void method20217(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(11) int local11 = this.method20213((byte) 47) * 1135283731 * this.aClass125_5.anInt2983 / 10000;
		Class694.aClass104_14.method20653(arg1, arg2 + 2, local11, this.aClass125_5.anInt2980 * -1017655207 - 2, ((Class125_Sub3) this.aClass125_5).anInt1127 * 1895075645, 0);
		Class694.aClass104_14.method20653(arg1 + local11, arg2 + 2, this.aClass125_5.anInt2983 * 1135283731 - local11, this.aClass125_5.anInt2980 * -1017655207 - 2, 0, 0);
	}
	...
	void method20212(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(11) int local11 = this.method20213((byte) -27) * 1135283731 * this.aClass125_5.anInt2983 / 10000;
		Class694.aClass104_14.method20653(arg1, arg2 + 2, local11, this.aClass125_5.anInt2980 * -1017655207 - 2, ((Class125_Sub3) this.aClass125_5).anInt1127 * 1895075645, 0);
		Class694.aClass104_14.method20653(arg1 + local11, arg2 + 2, this.aClass125_5.anInt2983 * 1135283731 - local11, this.aClass125_5.anInt2980 * -1017655207 - 2, 0, 0);
	}
	...
	void method20214(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		Class694.aClass104_14.method20478(arg1 - 2, arg2, this.aClass125_5.anInt2983 * 1135283731 + 4, this.aClass125_5.anInt2980 * -1017655207 + 2, ((Class125_Sub3) this.aClass125_5).anInt1126 * -1360115643, 0);
	...
	void method20216(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(11) int local11 = this.method20213((byte) 50) * 1135283731 * this.aClass125_5.anInt2983 / 10000;
		Class694.aClass104_14.method20653(arg1, arg2 + 2, local11, this.aClass125_5.anInt2980 * -1017655207 - 2, ((Class125_Sub3) this.aClass125_5).anInt1127 * 1895075645, 0);
		Class694.aClass104_14.method20653(arg1 + local11, arg2 + 2, this.aClass125_5.anInt2983 * 1135283731 - local11, this.aClass125_5.anInt2980 * -1017655207 - 2, 0, 0);
	}

	@OriginalMember(owner = "client!ahx", name = "aff", descriptor = "(Lclient!yf;B)V", line = 10583)
	static final void method10156(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class239.method25820((char) local12, -702163615) ? 1 : 0;
	}
	...
	public static int[] method10157(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5, @OriginalArg(6) boolean arg6, @OriginalArg(7) int arg7) {
		...
		local6.method22789(0, local2, -1977192251);
		return local2;
	}
}
