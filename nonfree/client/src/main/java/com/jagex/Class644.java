...
public class Class644 implements Iterable {
	...
	public Class644(@OriginalArg(0) Class497 arg0) {
		this.method32587(arg0.method30059(Class649.aClass649_8.anInt5795 * -51136173));
	}
	...
	void method32587(@OriginalArg(0) byte[] arg0) {
		this.method32584();
		if (arg0 == null) {
			this.aClass640Array2 = new Class640[0];
		} else {
			this.method32586(new Class93_Sub41(arg0));
		}
	}
	...
	void method32585(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			...
			@Pc(13) int local13;
			if (local3 == 1) {
				local13 = arg0.method22413();
				@Pc(15) int local15 = 0;
				@Pc(19) LinkedList local19 = new LinkedList();
				for (@Pc(21) int local21 = 0; local21 < local13; local21++) {
					@Pc(28) int local28 = arg0.method22413();
					@Pc(32) int local32 = arg0.method22415();
					@Pc(36) int local36 = arg0.method22413();
					@Pc(38) int local38 = 0;
					@Pc(40) Class634 local40 = Class634.aClass634_1;
					@Pc(42) byte local42 = 1;
					@Pc(51) boolean local51 = (local36 & 0x1) != 0;
					if ((local36 & 0x2) != 0) {
						local38 = arg0.method22413();
					}
					if ((local36 & 0x4) != 0) {
						local40 = this.aClass634Array1[arg0.method22413()];
					}
					if ((local36 & 0x8) != 0) {
						local42 = arg0.method22414();
					}
					@Pc(87) boolean local87 = arg0.method22413() == 1;
				...
				while (local116.hasNext()) {
					...
					this.aClass640Array2[local123.method32483()] = local123;
				}
			} else if (local3 == 2) {
				this.aClass634Array1 = new Class634[arg0.method22413()];
				for (local13 = arg0.method22413(); local13 != 255; local13 = arg0.method22413()) {
					@Pc(153) int[] local153 = new int[arg0.method22415()];
					for (@Pc(155) int local155 = 0; local155 < local153.length; local155++) {
						local153[local155] = arg0.method22419();
					}
	...
	void method32586(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			@Pc(3) int local3 = arg0.method22413();
			if (local3 == 0) {
				return;
	...
	public static void method32603(@OriginalArg(0) int arg0) {
	...
	static final void method32600(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
	...
	static final void method32601(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
	...
	static final void method32602(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= 1189701933;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class481.method29754(local13);
	}
}
