...
public class Class219 {
	...
	public static Class100 method25509(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		@Pc(5) Class100 local5 = (Class100) Class366.aClass240_80.method25839((long) arg1);
		if (local5 == null) {
			if (Class362.aBoolean729) {
				local5 = Class694.aClass104_14.method20499(Class203.method24650(arg0, arg1), true);
			} else {
				local5 = Class288.method26550(arg0.method30059(arg1, (byte) 108), -348649236);
			}
			Class366.aClass240_80.method25830(local5, (long) arg1);
		}
		return local5;
	}

	@OriginalMember(owner = "client!cz", name = "om", descriptor = "(Lclient!yf;B)V", line = 7588)
	static final void method25510(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class528.method30396(local11, local14, arg0, (byte) 42);
	}

	@OriginalMember(owner = "client!cz", name = "bbk", descriptor = "(Lclient!yf;I)V", line = 14364)
	static final void method25511(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!cz", name = "y", descriptor = "(I)Z", line = 232)
	static boolean method25512(@OriginalArg(0) int arg0) {
		Class411.anInt4714 = 1757895756;
		Class411.aClass175_3 = client.aClass175_1;
		return Class507.method30228(Class411.aLong271 * 4457507688757033075L == -1L, true, "", "", Class411.aLong271 * 4457507688757033075L);
	}

	@OriginalMember(owner = "client!cz", name = "e", descriptor = "(Lclient!py;III)Lclient!aac;", line = 26)
	public static Class5 method25513(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return Class446.method28897(arg0, arg1, arg2, (Interface1) null, 156544913);
	}

	@OriginalMember(owner = "client!cz", name = "v", descriptor = "(I)V", line = 481)
	static void method25514(@OriginalArg(0) int arg0) {
		if (Class454.aClass93_Sub1_Sub8_1 != null) {
			Class454.aClass93_Sub1_Sub8_1 = null;
			Class269.method26273(Class301.anInt3931 * 1939408525, Class318.anInt4095 * -988861719, Class454.anInt5046 * -816478179, Class360.anInt4570 * 2144271703, (byte) 87);
		}
	}
}
