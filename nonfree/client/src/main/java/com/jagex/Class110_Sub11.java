...
public class Class110_Sub11 extends Class110 {
	...
	static int method8005(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 9) {
			arg0 = arg0 + 1 & 0x3;
		}
		if (arg1 == 10) {
	...
	Class110_Sub11(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if (arg1 == 0) {
			...
			this.anInt932 = arg0.method22415() * 1889407193;
		}
		if (arg2 == 0) {
			local9 = arg0.method22419();
			...
			this.anInt936 = arg0.method22415() * -1747394353;
		}
		if (arg1 == 0 && arg2 == 0) {
			this.anInt931 = arg0.method22413() * -1096938529;
		} else {
			this.anInt931 = 1096938529;
		}
		this.anInt938 = arg0.method22415() * 1126664009;
		this.anInt935 = arg0.method22413() * 763612073;
		this.anInt939 = arg0.method22413() * -1078377849;
		this.anInt941 = arg0.method22417() * 695785621;
		this.anInt942 = arg0.method22415() * 1398834857;
		this.anInt943 = arg0.method22413() * -804916185;
	}
	...
	public void method20138() {
		...
		if (this.anInt933 * -1702903417 >= 0) {
			...
			local33 = Class249.aClass239Array1[this.anInt932 * 2057662313].method25807();
		...
		if (this.anInt934 * -1258858133 >= 0) {
			...
			local33 = Class249.aClass239Array1[this.anInt936 * -1993333201].method25807();
			local37 = local33.method24229().aClass472_61;
		...
		@Pc(155) Class132_Sub1_Sub1_Sub4 local155 = new Class132_Sub1_Sub1_Sub4(client.aClass532_1.method30459(), this.anInt938 * 1146100473, local23, local23, local11, local18, this.anInt935 * -642905959 << 2, client.anInt3485, client.anInt3485 + this.anInt941 * 1271870141, this.anInt942 * -1988657767, local101, this.anInt932 * 2057662313 + 1, this.anInt936 * -1993333201 + 1, this.anInt939 * 2036589367 << 2, false, 0, 0);
		local155.method23913(local60, local67, this.anInt939 * 2036589367 << 2, client.anInt3485 + this.anInt941 * 1271870141);
		client.aClass22_46.method407(new Class93_Sub1_Sub6(local155));
	}
	...
	@Override
	boolean method20141() {
		@Pc(8) Class697 local8 = (Class697) Class501.aClass32_Sub18_1.method18261(this.anInt938 * 1146100473);
	...
	static final void method8006(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		Class110_Sub5.method7657(local12 >> 14 & 0x3FFF, local12 & 0x3FFF);
	}
}
