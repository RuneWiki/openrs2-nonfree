...
public class Class110_Sub11 extends Class110 {
	...
	public void method20138(@OriginalArg(0) int arg0) {
		...
		if (this.anInt933 * -1702903417 >= 0) {
			...
			local33 = Class249.aClass239Array1[this.anInt932 * 2057662313].method25807(105270749);
			local37 = local33.method24229().aClass472_61;
		...
		if (this.anInt934 * -1258858133 >= 0) {
			...
			local33 = Class249.aClass239Array1[this.anInt936 * -1993333201].method25807(-1530361495);
			local37 = local33.method24229().aClass472_61;
		...
		@Pc(155) Class132_Sub1_Sub1_Sub4 local155 = new Class132_Sub1_Sub1_Sub4(client.aClass532_1.method30459(-1772585750), this.anInt938 * 1146100473, local23, local23, local11, local18, this.anInt935 * -642905959 << 2, client.anInt3485, client.anInt3485 + this.anInt941 * 1271870141, this.anInt942 * -1988657767, local101, this.anInt932 * 2057662313 + 1, this.anInt936 * -1993333201 + 1, this.anInt939 * 2036589367 << 2, false, 0, 0);
		local155.method23913(local60, local67, this.anInt939 * 2036589367 << 2, client.anInt3485 + this.anInt941 * 1271870141, -1511764208);
	...
	public void method20140() {
		...
		if (this.anInt933 * -1702903417 >= 0) {
			...
			local33 = Class249.aClass239Array1[this.anInt932 * 2057662313].method25807(-810802185);
			local37 = local33.method24229().aClass472_61;
			local11 = (int) local37.aFloat317;
			local18 = (int) local37.aFloat319;
			local23 = local33.aByte100;
		...
		if (this.anInt934 * -1258858133 >= 0) {
			...
			local33 = Class249.aClass239Array1[this.anInt936 * -1993333201].method25807(-321403859);
			local37 = local33.method24229().aClass472_61;
			local60 = (int) local37.aFloat317;
			local67 = (int) local37.aFloat319;
			if (local23 < 0) {
		...
		@Pc(101) int local101 = this.anInt943 * -737657961 << 2;
		@Pc(155) Class132_Sub1_Sub1_Sub4 local155 = new Class132_Sub1_Sub1_Sub4(client.aClass532_1.method30459(-2018361671), this.anInt938 * 1146100473, local23, local23, local11, local18, this.anInt935 * -642905959 << 2, client.anInt3485, client.anInt3485 + this.anInt941 * 1271870141, this.anInt942 * -1988657767, local101, this.anInt932 * 2057662313 + 1, this.anInt936 * -1993333201 + 1, this.anInt939 * 2036589367 << 2, false, 0, 0);
		local155.method23913(local60, local67, this.anInt939 * 2036589367 << 2, client.anInt3485 + this.anInt941 * 1271870141, 63616125);
	...
	Class110_Sub11(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(9) int local9;
		if (arg1 == 0) {
			local9 = arg0.method22419(-118643075);
			...
			this.anInt932 = arg0.method22415(-1434290800) * 1889407193;
		}
		if (arg2 == 0) {
			local9 = arg0.method22419(-118643075);
			...
			this.anInt936 = arg0.method22415(-1434290800) * -1747394353;
		}
		if (arg1 == 0 && arg2 == 0) {
			this.anInt931 = arg0.method22413((short) 16384) * -1096938529;
		} else {
			this.anInt931 = 1096938529;
		}
		this.anInt938 = arg0.method22415(-1434290800) * 1126664009;
		this.anInt935 = arg0.method22413((short) 16384) * 763612073;
		this.anInt939 = arg0.method22413((short) 16384) * -1078377849;
		this.anInt941 = arg0.method22417((short) 20112) * 695785621;
		this.anInt942 = arg0.method22415(-1434290800) * 1398834857;
		this.anInt943 = arg0.method22413((short) 16384) * -804916185;
	}
