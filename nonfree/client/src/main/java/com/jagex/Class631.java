...
public class Class631 implements Interface75 {
	...
	static final void method32280(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method32281(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!wa", name = "m", descriptor = "(I)Z", line = 56)
	static boolean method32282(@OriginalArg(0) int arg0) {
		return Class588.aClass588_3 != null;
	}

	@OriginalMember(owner = "client!wa", name = "gl", descriptor = "(I)V", line = 3386)
	public static final void method32283(@OriginalArg(0) int arg0) {
		...
		@Pc(204) Class611 local204 = client.aClass532_1.method30443(1700360326);
