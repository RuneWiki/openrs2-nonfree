...
public abstract class Class127 implements Interface4 {
	...
	static final void method9257(@OriginalArg(0) Class93_Sub41_Sub2 arg0, @OriginalArg(1) int arg1) {
		@Pc(1) int local1 = 0;
		arg0.method22668((byte) -39);
		@Pc(6) int local6;
		@Pc(15) int local15;
		@Pc(38) int local38;
		for (local6 = 0; local6 < Class174.anInt3293 * -1081967415; local6++) {
			...
			if ((Class174.aByteArray63[local15] & 0x1) == 0) {
				if (local1 > 0) {
					...
					local38 = arg0.method22689(1, -1428365453);
					if (local38 == 0) {
						local1 = Class206.method24701(arg0, -1799819323);
						Class174.aByteArray63[local15] = (byte) (Class174.aByteArray63[local15] | 0x2);
					} else {
		...
		for (local6 = 0; local6 < Class174.anInt3293 * -1081967415; local6++) {
			...
			if ((Class174.aByteArray63[local15] & 0x1) != 0) {
				if (local1 > 0) {
					...
					local38 = arg0.method22689(1, 453222308);
					if (local38 == 0) {
						local1 = Class206.method24701(arg0, -972609649);
						Class174.aByteArray63[local15] = (byte) (Class174.aByteArray63[local15] | 0x2);
					} else {
		...
		for (local6 = 0; local6 < Class174.anInt3295 * 1575920431; local6++) {
			...
			if ((Class174.aByteArray63[local15] & 0x1) != 0) {
				if (local1 > 0) {
					...
					local38 = arg0.method22689(1, -515802717);
					if (local38 == 0) {
						local1 = Class206.method24701(arg0, -1341202410);
						Class174.aByteArray63[local15] = (byte) (Class174.aByteArray63[local15] | 0x2);
		...
		for (local6 = 0; local6 < Class174.anInt3295 * 1575920431; local6++) {
			...
			if ((Class174.aByteArray63[local15] & 0x1) == 0) {
				if (local1 > 0) {
					...
					local38 = arg0.method22689(1, 200211595);
					if (local38 == 0) {
						local1 = Class206.method24701(arg0, -1665931944);
						Class174.aByteArray63[local15] = (byte) (Class174.aByteArray63[local15] | 0x2);
	...
	public static Class109 method9258(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) byte arg6) {
		...
		@Pc(7) Class109 local7 = (Class109) Class173.aClass240_64.method25839(local2);
		...
		if (local7 == null) {
			...
			if (local17.anInt3738 < 13) {
				local17.method25671(2);
			}
			local7 = arg0.method20510(local17, local9, Class173.anInt3254 * 1919361397, 64, 768);
			Class173.aClass240_64.method25830(local7, local2);
		}
	...
	static final void method9259(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1567549978);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class371.method28000(local16, local22, arg0, 2000067708);
	}
	...
	static final void method9260(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		Class644.method32601(local11, local14, arg0, (byte) -27);
	}

	@OriginalMember(owner = "client!ka", name = "aab", descriptor = "(Lclient!yf;B)V", line = 9730)
	static final void method9261(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method9262(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		Class125.method21463(1852373697);
	}
	...
	static final void method9263(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1895084890);
