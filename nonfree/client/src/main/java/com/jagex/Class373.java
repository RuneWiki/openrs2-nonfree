...
public class Class373 {
	...
	static final void method28020(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(3) int local3 = Class698.anInt5951 * 1760260613;
		@Pc(7) int local7 = Class79_Sub1_Sub1.anInt255 * -1809813621;
		@Pc(9) int local9 = -1;
		if (Class4.aBoolean2) {
			@Pc(14) Class14[] local14 = Class124_Sub3.method21453(16711935);
	...
	static final void method28021(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		Class279.method26449(arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091], 2020016942);
	}

	@OriginalMember(owner = "client!kb", name = "ei", descriptor = "(I)V", line = 811)
	public static void method28022(@OriginalArg(0) int arg0) {
	...
	static final void method28024(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub2_1.method16543(local12, -628091418);
	}
}
