...
public class Class611 {
	...
	boolean method32023(@OriginalArg(0) Class611 arg0) {
		return this.method32043(arg0.anInt5625 * -78984409, arg0.anInt5623 * 270611681, arg0.anInt5624 * -1994307635, -868291596);
	}
	...
	public boolean method32024(@OriginalArg(0) Object arg0) {
		if (arg0 == this) {
			return true;
		} else if (arg0 instanceof Class611) {
			return this.method32029((Class611) arg0, -990229751);
		} else {
			return false;
		}
	}
	...
	public String method32025() {
		return this.method32030(",", -2090607187);
	}

	@OriginalMember(owner = "client!ve", name = "n", descriptor = "(S)I", line = 34)
	public int method32026(@OriginalArg(0) short arg0) {
	...
	public void method32027(@OriginalArg(0) Class93_Sub30 arg0, @OriginalArg(1) byte arg1) {
	...
	public boolean method32028(@OriginalArg(0) Object arg0) {
		if (arg0 == this) {
			return true;
		} else if (arg0 instanceof Class611) {
			return this.method32029((Class611) arg0, -1012593485);
		} else {
			return false;
		}
	}
	...
	@Override
	public int hashCode() {
		return this.method32026((short) 448);
	}

	@OriginalMember(owner = "client!ve", name = "m", descriptor = "(Lclient!ve;I)Z", line = 44)
	boolean method32029(@OriginalArg(0) Class611 arg0, @OriginalArg(1) int arg1) {
		return this.method32043(arg0.anInt5625 * -78984409, arg0.anInt5623 * 270611681, arg0.anInt5624 * -1994307635, 1608601108);
	}

	@OriginalMember(owner = "client!ve", name = "f", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 63)
	String method32030(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
	...
	public void method32031(@OriginalArg(0) Class93_Sub30 arg0) {
		this.anInt5625 = arg0.anInt1609 * 1839387951;
		this.anInt5623 = (arg0.anInt1610 * -427776677 >> 9) * 2122256161;
		this.anInt5624 = (arg0.anInt1612 * 671628745 >> 9) * -67830523;
	}
	...
	public boolean method32032(@OriginalArg(0) Object arg0) {
		if (arg0 == this) {
			...
			return this.method32029((Class611) arg0, -1523529240);
		} else {
			return false;
		}
	}
	...
	public boolean method32033(@OriginalArg(0) Object arg0) {
		if (arg0 == this) {
			...
			return this.method32029((Class611) arg0, -1376301893);
		} else {
			return false;
		}
	}
	...
	public String toString() {
		return this.method32030(",", -2089023050);
	}
	...
	public void method32037(@OriginalArg(0) Class93_Sub30 arg0) {
		this.anInt5625 = arg0.anInt1609 * 1839387951;
		this.anInt5623 = (arg0.anInt1610 * -427776677 >> 9) * 2122256161;
		this.anInt5624 = (arg0.anInt1612 * 671628745 >> 9) * -67830523;
	}
	...
	public boolean equals(@OriginalArg(0) Object arg0) {
		if (arg0 == this) {
			...
			return this.method32029((Class611) arg0, -1476282459);
		} else {
			return false;
		}
	}
	...
	public void method32038(@OriginalArg(0) Class93_Sub30 arg0) {
		this.anInt5625 = arg0.anInt1609 * 1839387951;
		this.anInt5623 = (arg0.anInt1610 * -427776677 >> 9) * 2122256161;
		this.anInt5624 = (arg0.anInt1612 * 671628745 >> 9) * -67830523;
	}
	...
	boolean method32042(@OriginalArg(0) Class611 arg0) {
		return this.method32043(arg0.anInt5625 * -78984409, arg0.anInt5623 * 270611681, arg0.anInt5624 * -1994307635, -1535209391);
	}

	@OriginalMember(owner = "client!ve", name = "k", descriptor = "(IIII)Z", line = 48)
	boolean method32043(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	boolean method32044(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg0 != this.anInt5625 * -78984409) {
			return false;
		} else if (this.anInt5623 * 270611681 == arg1) {
			return arg2 == this.anInt5624 * -1994307635;
	...
	static final void method32046(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		Class453.method28965(local11, local14, arg0, Class310.aClass310_2, (byte) 73);
	}

	@OriginalMember(owner = "client!ve", name = "kp", descriptor = "(Lclient!hf;I)V", line = 11880)
	static final void method32047(@OriginalArg(0) Class312 arg0, @OriginalArg(1) int arg1) {
		...
		arg0.anInt4038 = Class704.method36731(Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aString82, 304329139) * 1171936085;
		...
		arg0.anInt4023 = local54.method23554((byte) 28) * 600145537;
		arg0.aClass19_6.method23576(local54, 751447761);
	}

	@OriginalMember(owner = "client!ve", name = "zn", descriptor = "(Lclient!yf;S)V", line = 9397)
	static final void method32048(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
