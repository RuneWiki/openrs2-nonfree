...
public class Class486 {
	...
	Class486(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2) {
		this.anInt5145 = Class154.method14146(arg0, arg0.length) * 874050479;
		...
		if (arg2 != null) {
			...
			this.aByteArray93 = Class53_Sub1.method14953(arg0, 0, arg0.length);
		...
		this.method29804(arg0);
	}

	@OriginalMember(owner = "client!pl", name = "e", descriptor = "([BI)V", line = 49)
	void method29804(@OriginalArg(0) byte[] arg0) {
		@Pc(6) Class93_Sub41 local6 = new Class93_Sub41(Class506.method30222(arg0));
		@Pc(10) int local10 = local6.method22413();
		if (local10 < 5 || local10 > 7) {
			throw new RuntimeException();
		}
		if (local10 >= 6) {
			this.anInt5149 = local6.method22419() * -905480615;
		} else {
			this.anInt5149 = 0;
		}
		@Pc(38) int local38 = local6.method22413();
		...
		if (local10 >= 7) {
			this.anInt5146 = local6.method22435() * -94536123;
		} else {
			this.anInt5146 = local6.method22415() * -94536123;
		}
		@Pc(94) int local94 = 0;
		@Pc(96) int local96 = -1;
		...
		if (local10 >= 7) {
			for (local108 = 0; local108 < this.anInt5146 * -1801657203; local108++) {
				this.anIntArray456[local108] = local94 += local6.method22435();
			...
			for (local108 = 0; local108 < this.anInt5146 * -1801657203; local108++) {
				this.anIntArray456[local108] = local94 += local6.method22415();
				if (this.anIntArray456[local108] > local96) {
					local96 = this.anIntArray456[local108];
				}
			}
		...
		if (local47) {
			...
			for (local108 = 0; local108 < this.anInt5146 * -1801657203; local108++) {
				this.anIntArray454[this.anIntArray456[local108]] = local6.method22419();
			}
			this.aClass348_1 = new Class348(this.anIntArray454);
		}
		for (local108 = 0; local108 < this.anInt5146 * -1801657203; local108++) {
			this.anIntArray455[this.anIntArray456[local108]] = local6.method22419();
		}
		if (local74) {
			for (local108 = 0; local108 < this.anInt5146 * -1801657203; local108++) {
				this.anIntArray460[local108] = local6.method22419();
			}
		}
		if (local56) {
			for (local108 = 0; local108 < this.anInt5146 * -1801657203; local108++) {
				@Pc(334) byte[] local334 = new byte[64];
				local6.method22430(local334, 0, 64);
		...
		if (local65) {
			...
			for (local108 = 0; local108 < this.anInt5146 * -1801657203; local108++) {
				this.anIntArray457[this.anIntArray456[local108]] = local6.method22419();
				this.anIntArray453[this.anIntArray456[local108]] = local6.method22419();
			}
		}
		for (local108 = 0; local108 < this.anInt5146 * -1801657203; local108++) {
			this.anIntArray458[this.anIntArray456[local108]] = local6.method22419();
		}
		@Pc(457) int local457;
		@Pc(461) int local461;
		@Pc(469) int local469;
		...
		if (local10 >= 7) {
			for (local108 = 0; local108 < this.anInt5146 * -1801657203; local108++) {
				this.anIntArray459[this.anIntArray456[local108]] = local6.method22435();
			}
			for (local108 = 0; local108 < this.anInt5146 * -1801657203; local108++) {
				...
				for (local469 = 0; local469 < local457; local469++) {
					local487 = this.anIntArrayArray58[local452][local469] = local94 += local6.method22435();
			...
			for (local108 = 0; local108 < this.anInt5146 * -1801657203; local108++) {
				this.anIntArray459[this.anIntArray456[local108]] = local6.method22415();
			}
			for (local108 = 0; local108 < this.anInt5146 * -1801657203; local108++) {
				local452 = this.anIntArray456[local108];
				local457 = this.anIntArray459[local452];
				...
				this.anIntArrayArray58[local452] = new int[local457];
				for (local469 = 0; local469 < local457; local469++) {
					local487 = this.anIntArrayArray58[local452][local469] = local94 += local6.method22415();
					if (local487 > local461) {
						local461 = local487;
					}
				}
		...
		for (local108 = 0; local108 < this.anInt5146 * -1801657203; local108++) {
			...
			for (local461 = 0; local461 < local457; local461++) {
				...
				this.anIntArrayArray59[local452][local469] = local6.method22419();
			}
	...
	static void method29806(@OriginalArg(0) Class700 arg0) {
		Class490.aClass700_1 = arg0;
	}

	@OriginalMember(owner = "client!pl", name = "aho", descriptor = "(Lclient!yf;S)V", line = 10906)
	static final void method29805(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= -725861497;
		client.anInt3561 = arg0.anIntArray519[-1497248091 * arg0.anInt5891] * -2128488861;
		Class118_Sub1.aClass12_4 = Class266.method26228(arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1]);
		...
		@Pc(46) Class175 local46 = Class330.method27372();
		@Pc(52) Class93_Sub22 local52 = Class102.method2592(Class446.aClass446_75, local46.aClass24_2);
		local52.aClass93_Sub41_Sub2_1.method22510(client.anInt3561 * 2112576331);
		local52.aClass93_Sub41_Sub2_1.method22510(Class118_Sub1.aClass12_4.anInt25 * -1955231941);
		local52.aClass93_Sub41_Sub2_1.method22510(client.anInt3552 * -350691737);
		local46.method24351(local52);
	}
}
