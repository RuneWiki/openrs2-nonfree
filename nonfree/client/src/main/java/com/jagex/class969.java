...
public class class969 extends class532 {
	...
	public class969(class849 arg0, class836 arg1, class973 arg2, int[] arg3) {
		...
		this.field11276 = (float[][]) null;
		this.field11287 = (float[][]) null;
		this.field11285 = (float[][]) null;
	}
		...
		for (int var5 = this.field11277; var5 <= this.field11278; var5++) {
			for (int var6 = this.field11275; var6 <= this.field11272; var6++) {
				...
				if (var7 > -arg2 && var7 < arg2 && var8 > -arg2 && var8 < arg2 && arg3[arg2 + var7][arg2 + var8]) {
					...
					this.field11279.method15809(this.field11283, (class83) null, this.field11284, (class83) null);
