...
public abstract class Class102 {
	...
	public static final void method2588(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		if (arg0.equals("")) {
			return;
		}
		@Pc(7) Class175 local7 = Class330.method27372(-1580060079);
		@Pc(13) Class93_Sub22 local13 = method2592(Class446.aClass446_94, local7.aClass24_2, (byte) 29);
		local13.aClass93_Sub41_Sub2_1.method22510(Class46.method894(arg0, -1857161175), (byte) -28);
		local13.aClass93_Sub41_Sub2_1.method22402(arg0, 932008120);
		local7.method24351(local13, -2047560182);
	}

	@OriginalMember(owner = "client!cj", name = "afa", descriptor = "(Lclient!yf;I)V", line = 10514)
	static final void method2589(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method2590(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = client.anInt3433 * -914512487 == arg0.aClass132_Sub1_Sub1_Sub1_4.method20023(785257419) ? 1 : 0;
	}

	@OriginalMember(owner = "client!cj", name = "ud", descriptor = "(Lclient!yf;B)V", line = 8661)
	static final void method2591(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 2013134692);
	...
	public static Class93_Sub22 method2592(@OriginalArg(0) Class446 arg0, @OriginalArg(1) Class24 arg1, @OriginalArg(2) byte arg2) {
		@Pc(2) Class93_Sub22 local2 = Class527.method30391(1355424345);
		...
		local2.aClass93_Sub41_Sub2_1.method22672(arg1, (byte) -28);
		local2.aClass93_Sub41_Sub2_1.method22661(local2.aClass446_1.anInt4951 * -1222765451, -1213648128);
		local2.anInt1569 = 0;
		return local2;
	}
}
