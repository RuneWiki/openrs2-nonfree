...
public class Class594 implements Runnable {
	...
	public static final void method31740() {
	...
	void method31727(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
