...
public class Class594 implements Runnable {
	...
	boolean method31724(@OriginalArg(0) byte arg0) {
		if (!this.aBoolean820) {
			return false;
		}
		try {
	...
	void method31727(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) throws IOException {
	...
	void method31728(@OriginalArg(0) byte arg0) {
		synchronized (this) {
			this.aBoolean820 = true;
			this.notifyAll();
		}
	...
	void method31729(@OriginalArg(0) int arg0) {
	...
	public void method31731() {
		...
		} while (!this.method31724((byte) 54));
	}
	...
	public void method31732() {
		...
		} while (!this.method31724((byte) 64));
	}
	...
	void method31734(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
		if (arg2 < 0 || arg1 < 0 || arg1 + arg2 > arg0.length) {
			throw new IOException();
		}
		synchronized (this) {
	...
	void method31735(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
		if (arg2 < 0 || arg1 < 0 || arg1 + arg2 > arg0.length) {
			throw new IOException();
		}
		synchronized (this) {
	...
	public void method31737() {
		...
		} while (!this.method31724((byte) 33));
	}
	...
	public void run() {
		...
		} while (!this.method31724((byte) 74));
	}
	...
	public static final void method31740(@OriginalArg(0) int arg0) {
