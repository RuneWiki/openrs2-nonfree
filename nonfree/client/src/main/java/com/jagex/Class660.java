...
public class Class660 implements Interface75 {
	...
	public static void method32825(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1) {
		if (arg0) {
			Class685.anInt5905 += 1883407479;
			Class376.method28043();
		}
		if (arg1) {
			Class685.anInt5906 += -236883317;
			Class262.method26174();
		}
	}

	@OriginalMember(owner = "client!xi", name = "e", descriptor = "(I)[Lclient!xi;", line = 17)
	public static Class660[] method32818() {
	...
	public static Class660[] method32819() {
		return new Class660[] { aClass660_4, aClass660_5, aClass660_3, aClass660_6 };
	}
	...
	static void method32822() {
		if (Class51.aClass93_Sub36_1.aClass166_Sub47_1.method16556() == 1) {
			Class392.aClass541_1.method30908(new Class537(Class526.aClass526_7, null));
		} else {
	...
	static void method32821(@OriginalArg(0) Class132_Sub1_Sub1_Sub1_Sub1 arg0, @OriginalArg(1) boolean arg1) {
		...
		if (local8.anIntArray412 != null) {
			local8 = local8.method27423(Class624.aClass120_1, Class624.aClass120_1);
			if (local8 == null) {
				return;
			}
		...
		if (arg0.anInt2647 * 1464472043 != 0) {
			@Pc(49) String local49 = client.aClass702_4 == Class702.aClass702_5 ? Class74.aClass74_137.method1259(Class106.aClass717_8) : Class74.aClass74_135.method1259(Class106.aClass717_8);
			local11 = local11 + Class93_Sub31.method22014(arg0.anInt2647 * 1464472043, Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.anInt2804 * 1852619943) + Class430.aString203 + local49 + arg0.anInt2647 * 1464472043 + Class430.aString205;
		}
		if (client.aBoolean625 && !arg1) {
			@Pc(97) Class87 local97 = (Class87) (Class650.anInt5797 * -759562015 == -1 ? null : Class124.aClass32_Sub21_7.method18261(Class650.anInt5797 * -759562015));
			if ((Class253.anInt3851 * 735260021 & 0x2) != 0 && (local97 == null || local8.method27427(Class650.anInt5797 * -759562015, local97.anInt265 * 951920133) != local97.anInt265 * 951920133)) {
				Class280.method26458(client.aString145, client.aString142 + " " + Class430.aString206 + " " + Class306.method26823(16776960) + local11, Class271.anInt3885 * -308125347, 8, -1, (long) (-1688488127 * arg0.anInt2768), 0, 0, true, false, (long) (arg0.anInt2768 * -1688488127), false);
			}
		}
		if (arg1) {
			return;
		...
		if (client.aBoolean626) {
			local168 = Class166_Sub40.method16366(local168);
		}
		if (local168 == null) {
			return;
		}
		...
		for (local183 = local168.length - 1; local183 >= 0; local183--) {
			if (local168[local183] != null && (arg0.anInt2651 * -999636135 & 0x1 << local183) == 0) {
				...
				@Pc(213) int local213 = local8.method27439(local183);
				if (local213 != -1) {
					local208 = local213;
				}
				@Pc(227) boolean local227 = local168[local183].equalsIgnoreCase(Class74.aClass74_130.method1259(Class106.aClass717_8));
				@Pc(236) boolean local236 = local168[local183].equalsIgnoreCase(Class74.aClass74_129.method1259(Class106.aClass717_8));
				...
				Class280.method26458(local168[local183], Class306.method26823(16776960) + local11, local208, local204, -1, (long) (arg0.anInt2768 * -1688488127), 0, 0, true, false, (long) (arg0.anInt2768 * -1688488127), false);
			}
		}
		if (!local170) {
			return;
		...
		for (local183 = 0; local183 < local168.length; local183++) {
			if (local168[local183] != null && (arg0.anInt2651 * -999636135 & 0x1 << local183) == 0) {
				@Pc(334) boolean local334 = local168[local183].equalsIgnoreCase(Class74.aClass74_130.method1259(Class106.aClass717_8));
				@Pc(343) boolean local343 = local168[local183].equalsIgnoreCase(Class74.aClass74_129.method1259(Class106.aClass717_8));
				if (local334 || local343) {
					@Pc(351) short local351 = client.aShortArray84[local183];
					@Pc(355) int local355 = client.anInt3521 * 1255649659;
					@Pc(360) int local360 = local8.method27439(local183);
					if (local360 != -1) {
						local355 = local360;
					}
					...
					Class280.method26458(local168[local183], Class306.method26823(16776960) + local11, local355, local351, -1, (long) (-1688488127 * arg0.anInt2768), 0, 0, true, false, (long) (arg0.anInt2768 * -1688488127), false);
				}
			}
		}
	}
	...
	static final void method32824(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (Class383.method28145(arg0, null)) {
			Class485.method29802(Class166_Sub1.aClass320Array1[arg0].method27227(), -1, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg7 < 0);
		} else if (arg7 == -1) {
	...
	static final void method32823(@OriginalArg(0) Class681 arg0) {
