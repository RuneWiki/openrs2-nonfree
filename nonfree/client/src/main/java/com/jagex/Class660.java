...
public class Class660 implements Interface75 {
	...
	public static Class660[] method32818(@OriginalArg(0) int arg0) {
	...
	static void method32821(@OriginalArg(0) Class132_Sub1_Sub1_Sub1_Sub1 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2) {
		...
		if (local8.anIntArray412 != null) {
			local8 = local8.method27423(Class624.aClass120_1, Class624.aClass120_1, (short) 916);
			if (local8 == null) {
				return;
			}
		...
		if (arg0.anInt2647 * 1464472043 != 0) {
			...
			local11 = local11 + Class93_Sub31.method22014(arg0.anInt2647 * 1464472043, Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.anInt2804 * 1852619943, 1195437977) + Class430.aString203 + local49 + arg0.anInt2647 * 1464472043 + Class430.aString205;
		}
		if (client.aBoolean625 && !arg1) {
			...
			if ((Class253.anInt3851 * 735260021 & 0x2) != 0 && (local97 == null || local8.method27427(Class650.anInt5797 * -759562015, local97.anInt265 * 951920133, (byte) 29) != local97.anInt265 * 951920133)) {
				Class280.method26458(client.aString145, client.aString142 + " " + Class430.aString206 + " " + Class306.method26823(16776960, -1330056764) + local11, Class271.anInt3885 * -308125347, 8, -1, (long) (-1688488127 * arg0.anInt2768), 0, 0, true, false, (long) (arg0.anInt2768 * -1688488127), false, (byte) -51);
			}
		}
		if (arg1) {
			return;
		...
		if (client.aBoolean626) {
			local168 = Class166_Sub40.method16366(local168, -1044881814);
		}
		if (local168 == null) {
			return;
		}
		...
		for (local183 = local168.length - 1; local183 >= 0; local183--) {
			if (local168[local183] != null && (arg0.anInt2651 * -999636135 & 0x1 << local183) == 0) {
				...
				@Pc(213) int local213 = local8.method27439(local183, 946197927);
				if (local213 != -1) {
					local208 = local213;
				}
				...
				Class280.method26458(local168[local183], Class306.method26823(16776960, 103532381) + local11, local208, local204, -1, (long) (arg0.anInt2768 * -1688488127), 0, 0, true, false, (long) (arg0.anInt2768 * -1688488127), false, (byte) -35);
			}
		}
		if (!local170) {
			return;
		...
		for (local183 = 0; local183 < local168.length; local183++) {
			if (local168[local183] != null && (arg0.anInt2651 * -999636135 & 0x1 << local183) == 0) {
				...
				if (local334 || local343) {
					...
					@Pc(360) int local360 = local8.method27439(local183, 495554448);
					if (local360 != -1) {
						local355 = local360;
					}
					...
					Class280.method26458(local168[local183], Class306.method26823(16776960, 987277287) + local11, local355, local351, -1, (long) (-1688488127 * arg0.anInt2768), 0, 0, true, false, (long) (arg0.anInt2768 * -1688488127), false, (byte) -126);
				}
			}
		}
	}
	...
	static void method32822(@OriginalArg(0) byte arg0) {
		if (Class51.aClass93_Sub36_1.aClass166_Sub47_1.method16556((short) 512) == 1) {
			Class392.aClass541_1.method30908(new Class537(Class526.aClass526_7, (Class93_Sub41_Sub2) null), (byte) -13);
		} else {
			client.aClass532_1.method30469((byte) 0);
			Class360.method27801((short) -7152);
		}
	}

	@OriginalMember(owner = "client!xi", name = "aku", descriptor = "(Lclient!yf;B)V", line = 11623)
	static final void method32823(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method32824(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		if (Class383.method28145(arg0, (int[]) null, 1357712085)) {
	...
	public static void method32825(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2) {
		if (arg0) {
			Class685.anInt5905 += 1883407479;
			Class376.method28043(-379347127);
		}
		if (arg1) {
