...
public class Class348 {
	...
	static void method27620(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class676.method33217(-728564618);
	}
	...
	static final void method27621(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(16) Class312 local16 = Class659.method32805(local12, 838209713);
	...
	public static final Class93_Sub40 method27622(@OriginalArg(0) int arg0, @OriginalArg(1) Class93_Sub40 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) byte arg4) {
		...
		Class93_Sub31.method22012(arg1.anInt3172 * 1220811495, arg2, (byte) 31);
		@Pc(39) Class312 local39 = Class659.method32805(arg0, 823100477);
		if (local39 != null) {
			Class354.method27696(local39, -1174743804);
		}
		...
		if (local39 != null) {
			Class548.method31016(Class166_Sub1.aClass320Array1[local39.anInt3953 * -1549590237 >>> 16], local39, !arg3, 1750609449);
		}
		if (!arg3) {
			Class56.method18036(arg1.anInt3172 * 1220811495, arg2, -446023490);
		}
		if (!arg3 && -703563959 * client.anInt3526 != -1) {
			Class189.method24584(client.anInt3526 * -703563959, 1, 31301296);
		}
		return arg1;
	}

	@OriginalMember(owner = "client!is", name = "lq", descriptor = "(Lclient!hf;ILclient!yf;I)V", line = 7037)
	static final void method27623(@OriginalArg(0) Class312 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
