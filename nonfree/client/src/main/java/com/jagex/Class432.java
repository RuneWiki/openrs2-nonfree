...
public class Class432 {
	...
	static final void method28787(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	public static int method28788(@OriginalArg(0) short[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class365 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) throws IOException {
		@Pc(1) int local1 = 1;
		@Pc(3) int local3 = 0;
		for (@Pc(5) int local5 = 0; local5 < arg3; local5++) {
			@Pc(16) int local16 = arg2.method27905(arg0, local1 + arg1, 291964485);
			local1 <<= 0x1;
			local1 += local16;
	...
	static final void method28789(@OriginalArg(0) Class312[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		for (@Pc(1) int local1 = 0; local1 < arg0.length; local1++) {
			...
			if (local9 != null && local9.anInt3985 * 897022795 == arg1 && !client.method24971(local9)) {
				if (local9.anInt3971 * -158526639 == 0) {
					method28789(arg0, local9.anInt3953 * -1549590237, -1557523898);
					if (local9.aClass312Array1 != null) {
						method28789(local9.aClass312Array1, local9.anInt3953 * -1549590237, -1463521841);
					}
					@Pc(57) Class93_Sub40 local57 = (Class93_Sub40) client.aClass16_22.method215((long) (local9.anInt3953 * -1549590237));
					if (local57 != null) {
						Class19.method23634(local57.anInt3172 * 1220811495, 462245976);
					}
				}
				if (local9.anInt3971 * -158526639 == 6 && local9.anInt4023 * -1088634495 != -1) {
					if (local9.aClass19_6 == null) {
						local9.aClass19_6 = new Class19_Sub2();
						local9.aClass19_6.method23568(local9.anInt4023 * -1088634495, 1119331677);
					}
					if (local9.aClass19_6.method23573(client.anInt3480 * 1820654295, 7054795) && local9.aClass19_6.method23581(-1228609165)) {
						local9.aClass19_6.method23570(1509318012);
					}
				}
			}
		}
