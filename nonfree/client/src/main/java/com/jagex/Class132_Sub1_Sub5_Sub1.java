...
public class Class132_Sub1_Sub5_Sub1 extends Class132_Sub1_Sub5 {
	...
	void method24212(@OriginalArg(0) byte arg0) {
		...
		if (Class51.aClass93_Sub36_1.aClass166_Sub14_1.method15654(470258637) == 1) {
	...
	Class573 method24271(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(21) Class590 local21 = this.aClass585_23.method31467(this.aByte100, (int) local4.aFloat317 >> 9, (int) local4.aFloat319 >> 9, (byte) 2);
		@Pc(38) Class132_Sub1_Sub4 local38 = this.aClass585_23.method31496(this.aByte100, (int) local4.aFloat317 >> 9, (int) local4.aFloat319 >> 9, -968156135);
		@Pc(40) int local40 = 0;
		while (local21 != null) {
			if (local21.aClass132_Sub1_Sub1_1.aBoolean562 && local21.aClass132_Sub1_Sub1_1.method24289((byte) -117) < local40) {
				local40 = local21.aClass132_Sub1_Sub1_1.method24289((byte) -123);
			}
		...
		if (local40 != this.anInt3284 * -1357685201) {
			local4.aFloat318 += (float) (local40 - this.anInt3284 * -1357685201);
		...
		if (this.anInt3284 * -1357685201 == 0) {
			...
			@Pc(155) int local155 = local122.method2480(local136 + (int) local4.aFloat317, (int) local4.aFloat319 + local141, 1359339948);
			@Pc(159) int local159 = local129 / 2;
			@Pc(164) int local164 = -local129 / 2;
			@Pc(178) int local178 = local122.method2480(local159 + (int) local4.aFloat317, local164 + (int) local4.aFloat319, 419502255);
			@Pc(183) int local183 = -local129 / 2;
			@Pc(187) int local187 = local129 / 2;
			@Pc(201) int local201 = local122.method2480(local183 + (int) local4.aFloat317, local187 + (int) local4.aFloat319, 1475156301);
			@Pc(205) int local205 = local129 / 2;
			@Pc(209) int local209 = local129 / 2;
			@Pc(223) int local223 = local122.method2480((int) local4.aFloat317 + local205, (int) local4.aFloat319 + local209, 1999730054);
		...
		if (this.anInt3281 * 836911837 != -1) {
			local398 = ((Class47) Class277.aClass32_Sub12_1.method18261(this.anInt3281 * 836911837, 1170264031)).method912(arg0, 526336, this.anInt3289 * 1614376089, (Class658) null, (Class19) null, this.anInt3287 * 1725763053, this.anInt3288 * -157393365, this.anInt3282 * 532661283, this.anInt3283 * 874921059, -705264709);
			if (local398 != null) {
		...
		if (this.anInt3278 * -272885985 != -1) {
			local398 = ((Class47) Class277.aClass32_Sub12_1.method18261(-272885985 * this.anInt3278, 396324217)).method912(arg0, 526336, this.anInt3280 * 804455733, (Class658) null, (Class19) null, this.anInt3287 * 1725763053, this.anInt3288 * -157393365, this.anInt3282 * 532661283, this.anInt3283 * 874921059, -705616565);
			if (local398 != null) {
		...
		local398 = ((Class47) Class277.aClass32_Sub12_1.method18261(this.anInt3286 * 1294558559, -136926747)).method912(arg0, 526336, this.anInt3279 * -1221246831, (Class658) null, (Class19) null, this.anInt3287 * 1725763053, this.anInt3288 * -157393365, this.anInt3282 * 532661283, this.anInt3283 * 874921059, -1238190017);
		if (local398 != null) {
	...
	void method24213() {
		...
		this.anInt3288 = ((int) (Math.random() * 2.0D) + 3) * -1127649149;
		this.anInt3282 = ((int) (Math.random() * 3.0D) + 16) * 1718684555;
		if (Class51.aClass93_Sub36_1.aClass166_Sub14_1.method15654(440735077) == 1) {
			this.anInt3283 = (int) (Math.random() * 10.0D) * 1162224971;
		} else {
			this.anInt3283 = (int) (Math.random() * 20.0D) * 1162224971;
		}
	...
	boolean method24259(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		...
		@Pc(34) Class109 local34 = ((Class47) Class277.aClass32_Sub12_1.method18261(this.anInt3286 * 1294558559, 2116876011)).method912(arg0, 131072, this.anInt3279 * -1221246831, (Class658) null, (Class19) null, 0, 0, 0, 0, 2124484040);
		if (local34 != null) {
			if (this.aClass470_45 == null) {
				aClass470_47.method29448();
			} else {
		...
		if (this.anInt3278 * -272885985 != -1) {
			local34 = ((Class47) Class277.aClass32_Sub12_1.method18261(-272885985 * this.anInt3278, 1816374062)).method912(arg0, 131072, this.anInt3280 * 804455733, (Class658) null, (Class19) null, 0, 0, 0, 0, -58235352);
			if (local34 != null) {
				if (this.aClass470_44 == null) {
					aClass470_47.method29448();
				} else {
		...
		if (this.anInt3281 * 836911837 != -1) {
			local34 = ((Class47) Class277.aClass32_Sub12_1.method18261(this.anInt3281 * 836911837, -1599497737)).method912(arg0, 131072, this.anInt3289 * 1614376089, (Class658) null, (Class19) null, 0, 0, 0, 0, 906819999);
			if (local34 != null) {
				if (this.aClass470_46 == null) {
					aClass470_47.method29448();
				} else {
	...
	public int method24287() {
		return this.anInt3284 * -1357685201 - this.method24289((byte) -81);
	}
	...
	public int method24275(@OriginalArg(0) int arg0) {
		return this.anInt3284 * -1357685201 - this.method24289((byte) -62);
	}
	...
	Class573 method24266(@OriginalArg(0) Class104 arg0) {
		...
		@Pc(40) int local40 = 0;
		while (local21 != null) {
			if (local21.aClass132_Sub1_Sub1_1.aBoolean562 && local21.aClass132_Sub1_Sub1_1.method24289((byte) -42) < local40) {
				local40 = local21.aClass132_Sub1_Sub1_1.method24289((byte) 12);
			}
			local21 = local21.aClass590_2;
		}
		if (local38 != null && local38.aShort97 > -local40) {
		...
		if (this.anInt3284 * -1357685201 == 0) {
			...
			@Pc(136) int local136 = -local129 / 2;
			@Pc(141) int local141 = -local129 / 2;
			@Pc(155) int local155 = local122.method2480(local136 + (int) local4.aFloat317, (int) local4.aFloat319 + local141, 632133410);
			@Pc(159) int local159 = local129 / 2;
			@Pc(164) int local164 = -local129 / 2;
			@Pc(178) int local178 = local122.method2480(local159 + (int) local4.aFloat317, local164 + (int) local4.aFloat319, 1692238824);
			@Pc(183) int local183 = -local129 / 2;
			@Pc(187) int local187 = local129 / 2;
			@Pc(201) int local201 = local122.method2480(local183 + (int) local4.aFloat317, local187 + (int) local4.aFloat319, 1119021722);
			@Pc(205) int local205 = local129 / 2;
			@Pc(209) int local209 = local129 / 2;
			@Pc(223) int local223 = local122.method2480((int) local4.aFloat317 + local205, (int) local4.aFloat319 + local209, 550638860);
			@Pc(230) int local230 = local155 < local178 ? local155 : local178;
			@Pc(237) int local237 = local201 < local223 ? local201 : local223;
			@Pc(244) int local244 = local178 < local223 ? local178 : local223;
			@Pc(251) int local251 = local155 < local201 ? local155 : local201;
		...
		@Pc(398) Class109 local398;
		if (this.anInt3281 * 836911837 != -1) {
			local398 = ((Class47) Class277.aClass32_Sub12_1.method18261(this.anInt3281 * 836911837, -366192300)).method912(arg0, 526336, this.anInt3289 * 1614376089, (Class658) null, (Class19) null, this.anInt3287 * 1725763053, this.anInt3288 * -157393365, this.anInt3282 * 532661283, this.anInt3283 * 874921059, 1448288678);
			if (local398 != null) {
				if (this.aClass470_46 == null) {
					aClass470_47.method29448();
				} else {
		...
		if (this.anInt3278 * -272885985 != -1) {
			local398 = ((Class47) Class277.aClass32_Sub12_1.method18261(-272885985 * this.anInt3278, 55101588)).method912(arg0, 526336, this.anInt3280 * 804455733, (Class658) null, (Class19) null, this.anInt3287 * 1725763053, this.anInt3288 * -157393365, this.anInt3282 * 532661283, this.anInt3283 * 874921059, -651245221);
			if (local398 != null) {
				if (this.aClass470_44 == null) {
					aClass470_47.method29448();
				} else {
		...
		local398 = ((Class47) Class277.aClass32_Sub12_1.method18261(this.anInt3286 * 1294558559, 1397968311)).method912(arg0, 526336, this.anInt3279 * -1221246831, (Class658) null, (Class19) null, this.anInt3287 * 1725763053, this.anInt3288 * -157393365, this.anInt3282 * 532661283, this.anInt3283 * 874921059, 926424440);
		if (local398 != null) {
			if (this.aClass470_45 == null) {
				aClass470_47.method29448();
			} else {
	...
	boolean method24290(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		local2.method29365(this.method24229());
		local2.method29387(0.0F, -10.0F, 0.0F);
		@Pc(34) Class109 local34 = ((Class47) Class277.aClass32_Sub12_1.method18261(this.anInt3286 * 1294558559, 1196393061)).method912(arg0, 131072, this.anInt3279 * -1221246831, (Class658) null, (Class19) null, 0, 0, 0, 0, 993779833);
		if (local34 != null) {
			if (this.aClass470_45 == null) {
				aClass470_47.method29448();
			} else {
		...
		if (this.anInt3278 * -272885985 != -1) {
			local34 = ((Class47) Class277.aClass32_Sub12_1.method18261(this.anInt3278 * -272885985, 1570227724)).method912(arg0, 131072, this.anInt3280 * 804455733, (Class658) null, (Class19) null, 0, 0, 0, 0, 1345385762);
			if (local34 != null) {
				if (this.aClass470_44 == null) {
					aClass470_47.method29448();
				} else {
		...
		if (this.anInt3281 * 836911837 != -1) {
			local34 = ((Class47) Class277.aClass32_Sub12_1.method18261(this.anInt3281 * 836911837, -448973897)).method912(arg0, 131072, this.anInt3289 * 1614376089, (Class658) null, (Class19) null, 0, 0, 0, 0, 563628761);
			if (local34 != null) {
				if (this.aClass470_46 == null) {
					aClass470_47.method29448();
				} else {
	...
	public int method24285() {
		return this.anInt3284 * -1357685201 - this.method24289((byte) -13);
	}

	@OriginalMember(owner = "client!aut", name = "cs", descriptor = "()I", line = 227)
	@Override
	public int method24286() {
		return this.anInt3284 * -1357685201 - this.method24289((byte) 6);
	}
