...
public class Class707 implements Interface75 {
	...
	public int method36750() {
		return this.aByte176 + 1;
	}

	@OriginalMember(owner = "client!zj", name = "e", descriptor = "(ZB)V", line = 56)
	public static void method36752(@OriginalArg(0) boolean arg0) {
	...
	public static void method36751(@OriginalArg(0) int arg0, @OriginalArg(1) TwitchEvent arg1) {
		@Pc(5) Class93_Sub1_Sub13 local5 = Class623.method32150(Class155.aClass155_66, arg0, -1);
		if (local5 == null) {
			return;
		}
	...
	static final void method36747(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
		...
		arg0.anObjectArray22 = Class499.method30148(local13, arg2);
