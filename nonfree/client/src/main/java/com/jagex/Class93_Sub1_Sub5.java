...
public class Class93_Sub1_Sub5 extends Class93_Sub1 {
	...
	void method21539(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		this.anInt3002 = arg0.method22415(-1434290800) * -1452663667;
		this.anInt3000 = arg0.method22415(-1434290800) * 458944011;
		this.anInt3003 = arg0.method22413((short) 16384) * -412893821;
		@Pc(24) int local24 = arg0.method22415(-1434290800);
		...
		for (@Pc(34) int local34 = 0; local34 < local24; local34++) {
			@Pc(43) Class233 local43 = Class129_Sub2_Sub1.method21481(arg0.method22413((short) 16384), (short) 166);
			@Pc(47) int local47 = arg0.method22431(-358186793);
			@Pc(53) Class211 local53 = Class581.method31399(arg0.method22413((short) 16384), 1241791091);
			@Pc(57) Class230 local57 = new Class230();
			local57.method25647(arg0, arg1, 1143974006);
			@Pc(67) int local67 = local43.method25727(-907590386);
			if (this.aClass230ArrayArray1[local47] == null) {
				this.aClass230ArrayArray1[local47] = new Class230[local67];
			}
			this.aClass230ArrayArray1[local47][local53.method25422(759266314)] = local57;
	...
	public int method21544(@OriginalArg(0) int arg0) {
		return this.method21543((byte) 1) - this.method21542((short) -27825);
	}
	...
	public boolean method21547(@OriginalArg(0) int arg0) {
	...
	void method21552(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(34) int local34 = 0; local34 < local24; local34++) {
			@Pc(43) Class233 local43 = Class129_Sub2_Sub1.method21481(arg0.method22413((short) 16384), (short) 166);
			@Pc(47) int local47 = arg0.method22431(-358186793);
			@Pc(53) Class211 local53 = Class581.method31399(arg0.method22413((short) 16384), -2045176106);
			@Pc(57) Class230 local57 = new Class230();
			local57.method25647(arg0, arg1, 35254018);
			@Pc(67) int local67 = local43.method25727(-907590386);
			if (this.aClass230ArrayArray1[local47] == null) {
				this.aClass230ArrayArray1[local47] = new Class230[local67];
			}
	...
	public boolean method21555(@OriginalArg(0) int arg0) {
		...
		if (this.aByteArray56 == null) {
			...
			synchronized (Class614.aClass497_134) {
				this.aByteArray56 = Class614.aClass497_134.method30059(this.anInt3001 * 1796814813, (byte) 50);
				if (this.aByteArray56 == null) {
					return false;
				}
			}
		...
		@Pc(49) int local49 = local45.method22413((short) 16384);
		@Pc(53) int local53 = local45.method22415(-1434290800);
		@Pc(56) Class497 local56 = Class722.aClass497_144;
		synchronized (Class722.aClass497_144) {
			local39 &= Class722.aClass497_144.method30054(local53, -512225963);
		}
		if (!local39) {
			return false;
		}
		...
		synchronized (Class614.aClass497_134) {
			this.aClass93_Sub25_1 = new Class93_Sub25(local53, Class722.aClass497_144.method30059(local53, (byte) 37));
			this.method21539(local45, local49, (byte) -25);
	...
	public int method21560() {
		return this.method21543((byte) 1) - this.method21542((short) 12914);
	}
	...
	void method21564(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(34) int local34 = 0; local34 < local24; local34++) {
			@Pc(43) Class233 local43 = Class129_Sub2_Sub1.method21481(arg0.method22413((short) 16384), (short) 166);
			@Pc(47) int local47 = arg0.method22431(-358186793);
			@Pc(53) Class211 local53 = Class581.method31399(arg0.method22413((short) 16384), -1522079753);
			@Pc(57) Class230 local57 = new Class230();
			local57.method25647(arg0, arg1, 726335222);
			@Pc(67) int local67 = local43.method25727(-907590386);
			if (this.aClass230ArrayArray1[local47] == null) {
				this.aClass230ArrayArray1[local47] = new Class230[local67];
			}
	...
	public boolean method21566(@OriginalArg(0) int arg0) {
