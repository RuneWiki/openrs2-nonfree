...
public abstract class Class132_Sub1 extends Class132 {
	...
	abstract void method24257();

	@OriginalMember(owner = "client!alh", name = "gw", descriptor = "()Z")
	abstract boolean method24258();

	@OriginalMember(owner = "client!alh", name = "fa", descriptor = "(Lclient!dh;IIB)Z")
	abstract boolean method24259(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3);

	@OriginalMember(owner = "client!alh", name = "gi", descriptor = "(Lclient!uq;IIILclient!do;)V", line = 72)
	static void method24260(@OriginalArg(0) Class600 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Class109 arg4) {
		if (arg4 != null) {
			arg0.method31843(arg1, arg2, arg3, arg4.method6861(), arg4.method6863(), arg4.method6864(), arg4.method6882(), arg4.method6829(), arg4.method6867(), arg4.method6928());
		}
	}

	@OriginalMember(owner = "client!alh", name = "fp", descriptor = "(I)Z")
	abstract boolean method24261(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!alh", name = "bu", descriptor = "(B)Z")
	abstract boolean method24262(@OriginalArg(0) byte arg0);

	@OriginalMember(owner = "client!alh", name = "bw", descriptor = "(S)Z")
	abstract boolean method24263(@OriginalArg(0) short arg0);

	@OriginalMember(owner = "client!alh", name = "gv", descriptor = "([Lclient!akf;)I")
	abstract int method24264(@OriginalArg(0) Class93_Sub16[] arg0);

	@OriginalMember(owner = "client!alh", name = "ff", descriptor = "(B)V")
	abstract void method24265(@OriginalArg(0) byte arg0);

	@OriginalMember(owner = "client!alh", name = "fo", descriptor = "(Lclient!dh;)Lclient!tl;")
	abstract Class573 method24266(@OriginalArg(0) Class104 arg0);

	@OriginalMember(owner = "client!alh", name = "fw", descriptor = "(Lclient!dh;I)V")
	abstract void method24267(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1);
	...
	abstract void method24269(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class132_Sub1 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) byte arg6);

	@OriginalMember(owner = "client!alh", name = "ga", descriptor = "(Lclient!dh;S)Z")
	abstract boolean method24270(@OriginalArg(0) Class104 arg0, @OriginalArg(1) short arg1);

	@OriginalMember(owner = "client!alh", name = "fc", descriptor = "(Lclient!dh;I)Lclient!tl;")
	abstract Class573 method24271(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1);

	@OriginalMember(owner = "client!alh", name = "fh", descriptor = "()Z")
	abstract boolean method24272();
	...
	int method24274(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class93_Sub16[] arg2, @OriginalArg(3) int arg3) {
	...
	public int method24275(@OriginalArg(0) int arg0) {
		return -this.method24289((byte) -3);
	}

	@OriginalMember(owner = "client!alh", name = "gg", descriptor = "(II)V", line = 81)
	void method24276(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public abstract int method24289(@OriginalArg(0) byte arg0);
	...
	abstract boolean method24290(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!alh", name = "hb", descriptor = "(I)V", line = 81)
	void method24291(@OriginalArg(0) int arg0) {
		this.aClass241Array21 = new Class241[arg0];
		for (@Pc(5) int local5 = 0; local5 < this.aClass241Array21.length; local5++) {
			this.aClass241Array21[local5] = new Class241();
		}
	...
	abstract void method24293(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class132_Sub1 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!alh", name = "fy", descriptor = "(Lclient!dh;)V")
	abstract void method24294(@OriginalArg(0) Class104 arg0);

	@OriginalMember(owner = "client!alh", name = "gl", descriptor = "(Lclient!dh;Lclient!alh;IIIZ)V")
	abstract void method24295(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class132_Sub1 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!alh", name = "gq", descriptor = "(Lclient!dh;Lclient!alh;IIIZ)V")
	abstract void method24296(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class132_Sub1 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!alh", name = "gk", descriptor = "()V")
	abstract void method24297();

	@OriginalMember(owner = "client!alh", name = "fv", descriptor = "(Lclient!dh;B)Lclient!uq;")
	public abstract Class600 method24298(@OriginalArg(0) Class104 arg0, @OriginalArg(1) byte arg1);
	...
	abstract int method24302(@OriginalArg(0) Class93_Sub16[] arg0);

	@OriginalMember(owner = "client!alh", name = "fe", descriptor = "(Lclient!dh;)V")
	abstract void method24303(@OriginalArg(0) Class104 arg0);

	@OriginalMember(owner = "client!alh", name = "gj", descriptor = "(Lclient!dh;)Z")
	abstract boolean method24304(@OriginalArg(0) Class104 arg0);
	...
	int method24306(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class93_Sub16[] arg2) {
		@Pc(10) long local10 = this.aClass585_23.aLongArrayArrayArray1[this.aByte100][arg0][arg1];
		@Pc(12) long local12 = 0L;
		@Pc(14) int local14 = 0;
		@Pc(26) int local26;
	...
	int method24307(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class93_Sub16[] arg2) {
		@Pc(10) long local10 = this.aClass585_23.aLongArrayArrayArray1[this.aByte100][arg0][arg1];
		@Pc(12) long local12 = 0L;
		@Pc(14) int local14 = 0;
		@Pc(26) int local26;
	...
	static Class600 method24308(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class109 arg3) {
	...
	abstract int method24309(@OriginalArg(0) Class93_Sub16[] arg0, @OriginalArg(1) short arg1);

	@OriginalMember(owner = "client!alh", name = "hm", descriptor = "(Lclient!uq;IIILclient!do;)V", line = 72)
	static void method24310(@OriginalArg(0) Class600 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Class109 arg4) {
		if (arg4 != null) {
			arg0.method31843(arg1, arg2, arg3, arg4.method6861(), arg4.method6863(), arg4.method6864(), arg4.method6882(), arg4.method6829(), arg4.method6867(), arg4.method6928());
		}
	}
	...
	static void method24311(@OriginalArg(0) Class600 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Class109 arg4) {
		if (arg4 != null) {
			arg0.method31843(arg1, arg2, arg3, arg4.method6861(), arg4.method6863(), arg4.method6864(), arg4.method6882(), arg4.method6829(), arg4.method6867(), arg4.method6928());
		}
	}
	...
	void method24312(@OriginalArg(0) int arg0) {
		this.aClass241Array21 = new Class241[arg0];
		for (@Pc(5) int local5 = 0; local5 < this.aClass241Array21.length; local5++) {
			this.aClass241Array21[local5] = new Class241();
		}
	...
	void method24313(@OriginalArg(0) int arg0) {
		this.aClass241Array21 = new Class241[arg0];
		for (@Pc(5) int local5 = 0; local5 < this.aClass241Array21.length; local5++) {
			this.aClass241Array21[local5] = new Class241();
		}
	...
	void method24315(@OriginalArg(0) int arg0) {
		this.aClass241Array21 = new Class241[arg0];
		for (@Pc(5) int local5 = 0; local5 < this.aClass241Array21.length; local5++) {
			this.aClass241Array21[local5] = new Class241();
		}
	...
	void method24316(@OriginalArg(0) int arg0) {
		this.aClass241Array21 = new Class241[arg0];
		for (@Pc(5) int local5 = 0; local5 < this.aClass241Array21.length; local5++) {
			this.aClass241Array21[local5] = new Class241();
		}
