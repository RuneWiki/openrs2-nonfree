...
public class Class562 {
	...
	void method31153(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(2) Class470 local2 = arg0.method20517();
		@Pc(6) Class470 local6 = new Class470();
		local6.method29385(0.0F, 0.0F, 0.0F);
		local6.method29379(0.0F, -1.0F, 0.0F, Class464.method29282(-arg2 & 0x3FFF));
		local6.method29379(-1.0F, 0.0F, 0.0F, Class464.method29282(-arg1 & 0x3FFF));
		local6.method29379(0.0F, 0.0F, -1.0F, Class464.method29282(-arg3 & 0x3FFF));
		arg0.method20516(local6);
		@Pc(48) Class470 local48 = new Class470();
		if (this.anInt5350 * 775061697 != arg4) {
			this.aClass109_6.method6881((byte) arg4, this.aByteArray99);
			this.anInt5350 = arg4 * -1239281855;
		}
		this.aClass109_6.method6947(local48, (Class241) null, 0);
		arg0.method20516(local2);
	}

	@OriginalMember(owner = "client!sv", name = "z", descriptor = "(Lclient!dh;I)V", line = 161)
	void method31154(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		try {
			@Pc(7) boolean local7 = Class280.aClass497_100.method30092(this.anInt5345 * -1118213259, 1404366259);
			if (local7) {
				arg0.method20522(16777215, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F);
				@Pc(25) Class231 local25 = Class231.method25655(Class280.aClass497_100, this.anInt5345 * -1118213259, 0);
				this.aClass109_6 = arg0.method20510(local25, 1099776, 0, 255, 1);
				@Pc(38) byte[] local38 = this.aClass109_6.method6875();
				if (local38 == null) {
	...
	public void method31155(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) boolean arg10, @OriginalArg(11) boolean arg11) {
		...
		if (this.aClass562_1 == null) {
			if (this.anInt5339 * 138588167 == -1) {
				arg0.method20653(arg2, arg3, arg4, arg5, arg9 | 0xFF000000, 0);
			}
			this.method31163(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, local1, -45831260);
			return;
		}
		...
		local15.method31163(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, local1, -1668040909);
		local18.method31163(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, false, arg11, 255 - local1, 767712563);
	}

	@OriginalMember(owner = "client!sv", name = "ag", descriptor = "(Lclient!dh;)V", line = 161)
	void method31156(@OriginalArg(0) Class104 arg0) {
		try {
			@Pc(7) boolean local7 = Class280.aClass497_100.method30092(this.anInt5345 * -1118213259, -310545360);
			if (local7) {
				arg0.method20522(16777215, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F);
				@Pc(25) Class231 local25 = Class231.method25655(Class280.aClass497_100, this.anInt5345 * -1118213259, 0);
				this.aClass109_6 = arg0.method20510(local25, 1099776, 0, 255, 1);
	...
	public Class562 method31158(@OriginalArg(0) int arg0) {
		return this.aClass562_1;
	}

	@OriginalMember(owner = "client!sv", name = "ah", descriptor = "(Lclient!dh;IIIIIIIII)V", line = 184)
	public void method31159(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		this.method31162(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, 0, arg9, true, false, -2137165835);
	}

	@OriginalMember(owner = "client!sv", name = "u", descriptor = "(Lclient!dh;III)Z", line = 114)
	public boolean method31160(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg1 != this.anInt5338 * 1512928933) {
			this.anInt5338 = arg1 * 2080735533;
			@Pc(14) int local14 = Class278.method26365(arg1, 423254006);
			if (local14 > 512) {
				local14 = 512;
			}
			if (local14 <= 0) {
			...
			if (this.aClass563Array2 != null) {
				...
				for (@Pc(51) int local51 = 0; local51 < this.aClass563Array2.length; local51++) {
					...
					if (local61.method31214(this.anInt5342 * -331387849, this.anInt5343 * -366741299, this.anInt5344 * 777917533, this.anInt5338 * 1512928933)) {
						local49[this.anInt5341 * -1069112057] = local61.anInt5365;
						this.aClass563Array1[(this.anInt5341 += 1413855415) * -1069112057 - 1] = local61;
					}
				}
				Class350.method27634(local49, this.aClass563Array1, 0, this.anInt5341 * -1069112057 - 1, 1597934566);
			}
		...
		if (this.aBoolean810) {
			...
			for (@Pc(135) int local135 = this.anInt5341 * -1069112057 - 1; local135 >= 0; local135--) {
				@Pc(146) boolean local146 = this.aClass563Array1[local135].method31196(arg0, this.aClass563_1);
				this.aBoolean810 |= !local146;
				local122 |= local146;
			}
		}
		if (arg2 == 0 || !arg0.method20426()) {
			this.aClass109_6 = null;
		} else if (this.aClass109_6 == null && this.anInt5345 * -1118213259 >= 0) {
			this.method31154(arg0, -2106744281);
		}
		if (this.aClass562_1 != null && this.aClass562_1 != this) {
			this.aClass562_1.method31174(2116530090);
			local122 |= this.aClass562_1.method31160(arg0, arg1, arg2, 1974574634);
		}
		return local122;
	}

	@OriginalMember(owner = "client!sv", name = "p", descriptor = "(Lclient!dh;IIIIIIIIII)V", line = 184)
	public void method31161(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10) {
		this.method31162(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, 0, arg9, true, false, -2056367908);
	}

	@OriginalMember(owner = "client!sv", name = "d", descriptor = "(Lclient!dh;IIIIIIIIIZZI)V", line = 188)
	public void method31162(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) boolean arg10, @OriginalArg(11) boolean arg11, @OriginalArg(12) int arg12) {
		@Pc(1) int local1 = 0;
		if (this.aBoolean811) {
			local1 = this.anInt5349 * -1292446037;
		}
		if (this.aClass562_1 == null) {
			...
			this.method31163(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, local1, -766352119);
			return;
		}
		@Pc(15) Class562 local15 = this;
		@Pc(18) Class562 local18 = this.aClass562_1;
	...
	void method31163(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) boolean arg10, @OriginalArg(11) boolean arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13) {
		...
		if (this.aClass109_6 == null) {
			...
			if (this.anInt5339 * 138588167 == -1 || this.anInt5340 * -773000899 == 0) {
				arg0.method20653(arg2, arg3, arg4, arg5, local3 << 24 | arg9, arg10 ? 0 : 1);
			} else {
				...
				if (this.aClass100_46 == null && Class319.anInterface24_8.method6765(Class616.aClass616_2, local40.anInt3788 * -1747960127, -1, Class618.aClass618_3 == local40.aClass618_2 ? Class609.aClass609_2 : Class609.aClass609_1, 0.7F, this.anInt5340 * -773000899, this.anInt5340 * -773000899, false, -1630596103)) {
					...
					this.aClass100_46 = arg0.method20498(local112, 0, local40.anInt3806 * -923926085, local40.anInt3806 * -923926085, local40.anInt3806 * -923926085, 438797212);
				}
				@Pc(161) int local161 = local3 == 255 ? (Class618.aClass618_3 == local40.aClass618_2 ? 1 : 0) : 1;
				if (local161 == 1 && arg10) {
					arg0.method20653(arg2, arg3, arg4, arg5, arg9, 0);
				}
				if (this.aClass100_46 != null) {
					...
					if (this.aClass604_1 == Class604.aClass604_3) {
						for (local218 = local195 - arg5; local218 < arg4; local218 += arg5) {
							this.aClass100_46.method18176(arg2 + local218, arg3 + local183, arg5, arg5, 0, local3 << 24 | 0xFFFFFF, local161);
						}
						if ((this.anInt5346 * 2144985761 & 0xFF000000) != 0) {
							arg0.method20600(0, 0, arg4, arg3 + local183 + 1, this.anInt5346 * 2144985761, (byte) 15);
						}
						if ((this.anInt5347 * -1094429489 & 0xFF000000) != 0) {
							arg0.method20600(0, local183 + arg3 + arg5, arg4, arg5 - (arg5 + local183 + arg3), this.anInt5347 * -1094429489, (byte) 46);
						}
					} else {
						while (local183 > arg5) {
							local183 -= arg5;
						...
						for (local218 = local195 - arg5; local218 < arg4; local218 += arg5) {
							for (@Pc(321) int local321 = local183 - arg5; local321 < arg5; local321 += arg5) {
								this.aClass100_46.method18176(arg2 + local218, local321 + arg3, arg5, arg5, 0, local3 << 24 | 0xFFFFFF, local161);
							}
						}
					}
				}
			...
			@Pc(375) Class489 local375 = arg0.method20654();
			@Pc(378) Class489 local378 = arg0.method20654();
			...
			arg0.method20519(local375);
			this.method31164(arg0, arg6, arg7, arg8, arg12, 755766171);
			arg0.method20519(local378);
		} else {
			if (arg10) {
				arg0.method20774(3, arg9);
			}
			this.method31164(arg0, arg6, arg7, arg8, arg12, 802733869);
		}
		for (@Pc(446) int local446 = this.anInt5341 * -1069112057 - 1; local446 >= 0; local446--) {
			this.aClass563Array1[local446].method31197(arg0, arg2, arg3, arg4, arg5, arg6, arg7, this.anInt5342 * -331387849, this.anInt5343 * -366741299, this.anInt5344 * 777917533, local3);
		}
		arg0.method20774(2, 0);
		arg0.method20503();
	}
	...
	void method31164(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(2) Class470 local2 = arg0.method20517();
		@Pc(6) Class470 local6 = new Class470();
		local6.method29385(0.0F, 0.0F, 0.0F);
		local6.method29379(0.0F, -1.0F, 0.0F, Class464.method29282(-arg2 & 0x3FFF));
	...
	public static void method31165(@OriginalArg(0) Class497 arg0, @OriginalArg(1) Class225 arg1, @OriginalArg(2) Interface24 arg2) {
	...
	public static void method31166() {
		Class563.method31195();
	}

	@OriginalMember(owner = "client!sv", name = "s", descriptor = "()V", line = 58)
	public static void method31167() {
		Class563.method31195();
	}

	@OriginalMember(owner = "client!sv", name = "q", descriptor = "(II)V", line = 80)
	public void method31168(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (!this.aBoolean811) {
		}
		this.anInt5349 = ((arg1 - this.anInt5351 * 1477186659) * arg0 / 255 + this.anInt5351 * 1477186659) * 562197507;
	}
	...
	public void method31171(@OriginalArg(0) Class562 arg0) {
		if (this.aBoolean811) {
			this.anInt5351 = this.anInt5349 * 1474073369;
		} else if (arg0 != null && arg0.aBoolean811) {
			this.anInt5351 = 152976821 - arg0.anInt5349 * 1474073369;
	...
	public boolean method31173() {
		return this.aBoolean811;
	}

	@OriginalMember(owner = "client!sv", name = "f", descriptor = "(I)V", line = 100)
	public void method31174(@OriginalArg(0) int arg0) {
		this.aBoolean811 = false;
		this.aClass562_1 = null;
		this.anInt5349 = 0;
	}
	...
	public boolean method31175() {
		return this.aBoolean811;
	}

	@OriginalMember(owner = "client!sv", name = "w", descriptor = "(B)Z", line = 106)
	public boolean method31176(@OriginalArg(0) byte arg0) {
		return this.aBoolean811;
	}

	@OriginalMember(owner = "client!sv", name = "ae", descriptor = "(Lclient!dh;II)Z", line = 114)
	public boolean method31177(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg1 != this.anInt5338 * 1512928933) {
			this.anInt5338 = arg1 * 2080735533;
			@Pc(14) int local14 = Class278.method26365(arg1, 423254006);
			if (local14 > 512) {
			...
			if (this.aClass563Array2 != null) {
				...
				Class350.method27634(local49, this.aClass563Array1, 0, this.anInt5341 * -1069112057 - 1, 1596871668);
			}
			this.aBoolean810 = true;
		}
		@Pc(122) boolean local122 = false;
		...
		if (arg2 == 0 || !arg0.method20426()) {
			...
			this.method31154(arg0, -2042885960);
		}
		if (this.aClass562_1 != null && this.aClass562_1 != this) {
			this.aClass562_1.method31174(1164072402);
			local122 |= this.aClass562_1.method31160(arg0, arg1, arg2, 129379937);
		}
		return local122;
	}

	@OriginalMember(owner = "client!sv", name = "k", descriptor = "(Lclient!sv;I)V", line = 85)
	public void method31178(@OriginalArg(0) Class562 arg0, @OriginalArg(1) int arg1) {
		if (this.aBoolean811) {
			this.anInt5351 = this.anInt5349 * 1474073369;
		} else if (arg0 != null && arg0.aBoolean811) {
			this.anInt5351 = 152976821 - arg0.anInt5349 * 1474073369;
	...
	void method31179(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) boolean arg10, @OriginalArg(11) boolean arg11, @OriginalArg(12) int arg12) {
		...
		if (this.aClass109_6 == null) {
			...
			if (this.anInt5339 * 138588167 == -1 || this.anInt5340 * -773000899 == 0) {
				...
				if (this.aClass100_46 != null) {
					...
					if (this.aClass604_1 == Class604.aClass604_3) {
						...
						if ((this.anInt5346 * 2144985761 & 0xFF000000) != 0) {
							arg0.method20600(0, 0, arg4, arg3 + local183 + 1, this.anInt5346 * 2144985761, (byte) 63);
						}
						if ((this.anInt5347 * -1094429489 & 0xFF000000) != 0) {
							arg0.method20600(0, local183 + arg3 + arg5, arg4, arg5 - (arg5 + local183 + arg3), this.anInt5347 * -1094429489, (byte) 110);
						}
					} else {
						while (local183 > arg5) {
							local183 -= arg5;
			...
			local375.aFloatArray116[14] = local375.aFloatArray116[15];
			arg0.method20519(local375);
			this.method31164(arg0, arg6, arg7, arg8, arg12, 1059574030);
			arg0.method20519(local378);
		} else {
			if (arg10) {
				arg0.method20774(3, arg9);
			}
			this.method31164(arg0, arg6, arg7, arg8, arg12, 1804757812);
		}
		for (@Pc(446) int local446 = this.anInt5341 * -1069112057 - 1; local446 >= 0; local446--) {
			this.aClass563Array1[local446].method31197(arg0, arg2, arg3, arg4, arg5, arg6, arg7, this.anInt5342 * -331387849, this.anInt5343 * -366741299, this.anInt5344 * 777917533, local3);
		}
	...
	public void method31180(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) boolean arg10, @OriginalArg(11) boolean arg11) {
		@Pc(1) int local1 = 0;
		if (this.aBoolean811) {
			local1 = this.anInt5349 * -1292446037;
		}
		if (this.aClass562_1 == null) {
			...
			this.method31163(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, local1, 2071582048);
			return;
		}
		@Pc(15) Class562 local15 = this;
		@Pc(18) Class562 local18 = this.aClass562_1;
		...
		local15.method31163(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, local1, -1879839639);
		local18.method31163(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, false, arg11, 255 - local1, 1087065941);
	}

	@OriginalMember(owner = "client!sv", name = "t", descriptor = "()Lclient!sv;", line = 110)
	public Class562 method31181() {
		return this.aClass562_1;
	}
	...
	void method31182(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) boolean arg10, @OriginalArg(11) boolean arg11, @OriginalArg(12) int arg12) {
		...
		if (this.aClass109_6 == null) {
			...
			if (this.anInt5339 * 138588167 == -1 || this.anInt5340 * -773000899 == 0) {
				...
				if (this.aClass100_46 != null) {
					...
					if (this.aClass604_1 == Class604.aClass604_3) {
						...
						if ((this.anInt5346 * 2144985761 & 0xFF000000) != 0) {
							arg0.method20600(0, 0, arg4, arg3 + local183 + 1, this.anInt5346 * 2144985761, (byte) 77);
						}
						if ((this.anInt5347 * -1094429489 & 0xFF000000) != 0) {
							arg0.method20600(0, local183 + arg3 + arg5, arg4, arg5 - (arg5 + local183 + arg3), this.anInt5347 * -1094429489, (byte) 3);
						}
					} else {
						while (local183 > arg5) {
							local183 -= arg5;
			...
			local375.aFloatArray116[14] = local375.aFloatArray116[15];
			arg0.method20519(local375);
			this.method31164(arg0, arg6, arg7, arg8, arg12, 1240139022);
			arg0.method20519(local378);
		} else {
			if (arg10) {
				arg0.method20774(3, arg9);
			}
			this.method31164(arg0, arg6, arg7, arg8, arg12, 1508206001);
		}
		for (@Pc(446) int local446 = this.anInt5341 * -1069112057 - 1; local446 >= 0; local446--) {
			this.aClass563Array1[local446].method31197(arg0, arg2, arg3, arg4, arg5, arg6, arg7, this.anInt5342 * -331387849, this.anInt5343 * -366741299, this.anInt5344 * 777917533, local3);
		}
	...
	public boolean method31183() {
		return this.aBoolean811;
	}

	@OriginalMember(owner = "client!sv", name = "as", descriptor = "(Lclient!dh;IIIIIIIIIZZI)V", line = 210)
	void method31184(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) boolean arg10, @OriginalArg(11) boolean arg11, @OriginalArg(12) int arg12) {
		@Pc(3) int local3 = 255 - arg12;
		arg0.method20501();
		arg0.method20502();
		if (this.aClass109_6 == null) {
			...
			if (this.anInt5339 * 138588167 == -1 || this.anInt5340 * -773000899 == 0) {
				...
				if (this.aClass100_46 != null) {
					...
					if (this.aClass604_1 == Class604.aClass604_3) {
						...
						if ((this.anInt5346 * 2144985761 & 0xFF000000) != 0) {
							arg0.method20600(0, 0, arg4, arg3 + local183 + 1, this.anInt5346 * 2144985761, (byte) 18);
						}
						if ((this.anInt5347 * -1094429489 & 0xFF000000) != 0) {
							arg0.method20600(0, local183 + arg3 + arg5, arg4, arg5 - (arg5 + local183 + arg3), this.anInt5347 * -1094429489, (byte) 63);
						}
					} else {
						while (local183 > arg5) {
							local183 -= arg5;
			...
			local375.aFloatArray116[14] = local375.aFloatArray116[15];
			arg0.method20519(local375);
			this.method31164(arg0, arg6, arg7, arg8, arg12, 1333300451);
			arg0.method20519(local378);
		} else {
			if (arg10) {
				arg0.method20774(3, arg9);
			}
			this.method31164(arg0, arg6, arg7, arg8, arg12, 1999729007);
		}
		for (@Pc(446) int local446 = this.anInt5341 * -1069112057 - 1; local446 >= 0; local446--) {
			this.aClass563Array1[local446].method31197(arg0, arg2, arg3, arg4, arg5, arg6, arg7, this.anInt5342 * -331387849, this.anInt5343 * -366741299, this.anInt5344 * 777917533, local3);
		}
	...
	void method31185(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(2) Class470 local2 = arg0.method20517();
		@Pc(6) Class470 local6 = new Class470();
		local6.method29385(0.0F, 0.0F, 0.0F);
		local6.method29379(0.0F, -1.0F, 0.0F, Class464.method29282(-arg2 & 0x3FFF));
	...
	public static void method31187() {
		Class563.method31195();
	}
	...
	static final void method31190(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
		throw new RuntimeException("");
	}

	@OriginalMember(owner = "client!sv", name = "akb", descriptor = "(Lclient!yf;I)V", line = 11764)
	static final void method31191(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
	...
	static final void method31192(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class557.aClass297_1.method26671(-1639881512) ? 1 : 0;
	}
}
