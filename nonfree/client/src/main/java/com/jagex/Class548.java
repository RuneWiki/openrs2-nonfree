...
public class Class548 {
	...
	static final void method31010(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method31011(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
	...
	static void method31013(@OriginalArg(0) byte arg0) {
	...
	public static int method31014(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(1) int local1 = 0;
	...
	public static final void method31015(@OriginalArg(0) byte arg0) {
		@Pc(2) Class175 local2 = Class330.method27372(-1858814111);
		@Pc(8) Class93_Sub22 local8 = Class102.method2592(Class446.aClass446_94, local2.aClass24_2, (byte) 45);
		local8.aClass93_Sub41_Sub2_1.method22510(0, (byte) -42);
		local2.method24351(local8, -1509960398);
	}

	@OriginalMember(owner = "client!sf", name = "jx", descriptor = "(Lclient!hq;Lclient!hf;ZI)V", line = 10879)
	public static void method31016(@OriginalArg(0) Class320 arg0, @OriginalArg(1) Class312 arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3) {
