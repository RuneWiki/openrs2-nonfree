...
public final class Class104_Sub2_Sub2 extends Class104_Sub2 {
	...
	public final synchronized void method20419(@OriginalArg(0) int arg0) {
		...
		if (this.method20819() > 100663296 && Class305.method26796(1498939757) > this.aLong133 + 60000L) {
			System.gc();
			this.aLong133 = Class305.method26796(1859202917);
		}
	...
	Class104_Sub2_Sub2(@OriginalArg(0) OpenGL arg0, @OriginalArg(1) Canvas arg1, @OriginalArg(2) long arg2, @OriginalArg(3) Class225 arg3, @OriginalArg(4) Interface24 arg4, @OriginalArg(5) Interface48 arg5, @OriginalArg(6) Interface46 arg6, @OriginalArg(7) Interface47 arg7, @OriginalArg(8) Class497 arg8, @OriginalArg(9) int arg9) {
		...
		try {
			...
			@Pc(149) String[] local149 = client.method25402(local141.replace('.', ' '), ' ', 1726146343);
			...
			if (this.aString87.indexOf("radeon") != -1 || this.aString88.indexOf("intel") != -1) {
				...
				@Pc(395) String[] local395 = client.method25402(this.aString87.replace('/', ' '), ' ', 1593575963);
			...
			this.method20437(arg1, new Class112_Sub2_Sub1_Sub2(this, arg1, arg2), (byte) 0);
			this.method20439(arg1, (byte) 14);
			this.method20915(32768, false);
			this.method20915(32768, false);
		} catch (@Pc(561) Throwable local561) {
			local561.printStackTrace();
			this.method20877(33210355);
	...
	public void method20462(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		this.method20441(this.aClass112_Sub1_3, (byte) 1);
		...
		this.method20442(this.aClass112_Sub1_3, -1497248091);
	...
	void method21190() {
		...
		for (local8 = 0; local8 < this.anInt2934; local8++) {
			...
			this.aFloatArray65[0] = (float) local17.method13520(-347658368);
			this.aFloatArray65[1] = (float) local17.method13521(1655674161);
			this.aFloatArray65[2] = (float) local17.method13522(602941408);
	...
	public long method20457(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.method21302(arg0, arg1, (int[]) null, (int[]) null);
	}
	...
	public void method20593() {
		...
		this.method21020((Interface43) null);
		this.method20919(1);
		this.method20982(0);
	...
	void method20953() {
		...
		for (local8 = 0; local8 < this.anInt2934; local8++) {
			...
			this.aFloatArray65[0] = (float) local17.method13520(-2046646798);
			this.aFloatArray65[1] = (float) local17.method13521(1655674161);
			this.aFloatArray65[2] = (float) local17.method13522(107285319);
			this.aFloatArray65[3] = 1.0F;
			OpenGL.glLightfv(local25, 4611, this.aFloatArray65, 0);
			this.aFloatArray65[0] = (float) (local21 >> 16 & 0xFF) * local31;
			this.aFloatArray65[1] = (float) (local21 >> 8 & 0xFF) * local31;
	...
	void method20968() {
		...
		for (local8 = 0; local8 < this.anInt2934; local8++) {
			...
			this.aFloatArray65[0] = (float) local17.method13520(2128309524);
			this.aFloatArray65[1] = (float) local17.method13521(1655674161);
			this.aFloatArray65[2] = (float) local17.method13522(-137733248);
			this.aFloatArray65[3] = 1.0F;
			OpenGL.glLightfv(local25, 4611, this.aFloatArray65, 0);
			this.aFloatArray65[0] = (float) (local21 >> 16 & 0xFF) * local31;
			this.aFloatArray65[1] = (float) (local21 >> 8 & 0xFF) * local31;
	...
	public final synchronized void method20561(@OriginalArg(0) int arg0) {
		...
		if (this.method20819() > 100663296 && Class305.method26796(1318639114) > this.aLong133 + 60000L) {
			System.gc();
			this.aLong133 = Class305.method26796(744599574);
		}
		super.method20419(local10);
	}
