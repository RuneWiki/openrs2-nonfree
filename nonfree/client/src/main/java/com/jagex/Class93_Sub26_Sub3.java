...
public class Class93_Sub26_Sub3 extends Class93_Sub26 {
	...
	void method21991(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
		if (arg0.method22413((short) 16384) != 255) {
			arg0.anInt3070 -= -1445626955;
			this.aLong138 = arg0.method22423(-1704112608) * 2340805484773300139L;
		}
		this.aString93 = arg0.method22426((byte) 5);
		this.anInt2998 = arg0.method22415(-1434290800) * -208430505;
	}
	...
	void method21992(@OriginalArg(0) Class386 arg0, @OriginalArg(1) int arg1) {
		arg0.method28171(this.aLong138 * 6917164260611681027L, this.aString93, this.anInt2998 * -828903065, (byte) -119);
	}
	...
	void method21993(@OriginalArg(0) Class93_Sub41 arg0) {
		if (arg0.method22413((short) 16384) != 255) {
			arg0.anInt3070 -= -1445626955;
			this.aLong138 = arg0.method22423(965331828) * 2340805484773300139L;
		}
		this.aString93 = arg0.method22426((byte) 22);
		this.anInt2998 = arg0.method22415(-1434290800) * -208430505;
	}
	...
	void method21994(@OriginalArg(0) Class386 arg0) {
		arg0.method28171(this.aLong138 * 6917164260611681027L, this.aString93, this.anInt2998 * -828903065, (byte) -18);
	}

	@OriginalMember(owner = "client!arc", name = "f", descriptor = "(Lclient!kr;)V", line = 107)
	@Override
	void method21990(@OriginalArg(0) Class386 arg0) {
		arg0.method28171(this.aLong138 * 6917164260611681027L, this.aString93, this.anInt2998 * -828903065, (byte) -67);
	}

	@OriginalMember(owner = "client!arc", name = "w", descriptor = "(Lclient!kr;)V", line = 107)
	@Override
	void method21995(@OriginalArg(0) Class386 arg0) {
		arg0.method28171(this.aLong138 * 6917164260611681027L, this.aString93, this.anInt2998 * -828903065, (byte) -90);
	}
}
