...
public class Class614 {
	...
	public static Interface67 method32066(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		if (Class623.aClass623_2 == local5) {
			return Class632.method32295(arg0, -1105609638);
	...
	public static Interface67 method32067(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(5) Class623 local5 = Class351.method27642(arg0.method22413((short) 16384), 1962594255);
		if (Class623.aClass623_2 == local5) {
			return Class632.method32295(arg0, 132834097);
		} else if (local5 == Class623.aClass623_1) {
	...
	static final void method32068(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static int method32069(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) float arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) byte arg7) {
		...
		if (arg1 == 0) {
			...
			@Pc(225) int local225 = method32069(local190, arg1 - 1, arg2, false, arg4, false, local213, (byte) -88);
			if (local225 == -1) {
				return 0;
			}
