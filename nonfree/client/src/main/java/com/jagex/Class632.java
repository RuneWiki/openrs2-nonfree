...
public class Class632 {
	...
	static void method32285(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(3) int local3 = arg0.method22632((byte) -40);
		aClass648Array1 = new Class648[local3];
		@Pc(8) int local8;
		for (local8 = 0; local8 < local3; local8++) {
			aClass648Array1[local8] = new Class648();
			aClass648Array1[local8].anInt5794 = arg0.method22632((byte) -43) * -58277581;
			aClass648Array1[local8].aString237 = arg0.method22428(324854193);
		}
		Class607.anInt5560 = arg0.method22632((byte) -40) * -174531729;
		Class361.anInt4571 = arg0.method22632((byte) -40) * -1231507063;
		Class606.anInt5557 = arg0.method22632((byte) -51) * 470817221;
		...
		for (local8 = 0; local8 < Class606.anInt5557 * 2035023117; local8++) {
			@Pc(75) int local75 = arg0.method22632((byte) -15);
			@Pc(83) Class154_Sub1 local83 = aClass154_Sub1Array2[local75] = new Class154_Sub1();
			local83.anInt1651 = arg0.method22413((short) 16384) * 88439695;
			local83.anInt1650 = arg0.method22419(-118643075) * 445350423;
			local83.anInt1653 = arg0.method22632((byte) -106) * -875570153;
			if (local83.anInt1653 * -2080957529 != 0) {
				local83.aString48 = arg0.method22428(69764640);
			}
			local83.anInt1654 = (Class607.anInt5560 * 1855382415 + local75) * 142830605;
			local83.aString47 = arg0.method22428(1497851355);
			local83.aString46 = arg0.method22428(2100853963);
		}
		anInt5720 = arg0.method22419(-118643075) * -537572227;
		aBoolean851 = true;
	}
	...
	static void method32287(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(3) int local3 = arg0.method22632((byte) -101);
		aClass648Array1 = new Class648[local3];
		@Pc(8) int local8;
		for (local8 = 0; local8 < local3; local8++) {
			aClass648Array1[local8] = new Class648();
			aClass648Array1[local8].anInt5794 = arg0.method22632((byte) -113) * -58277581;
			aClass648Array1[local8].aString237 = arg0.method22428(672129942);
		}
		Class607.anInt5560 = arg0.method22632((byte) -6) * -174531729;
		Class361.anInt4571 = arg0.method22632((byte) -116) * -1231507063;
		Class606.anInt5557 = arg0.method22632((byte) -29) * 470817221;
		aClass154_Sub1Array2 = new Class154_Sub1[Class361.anInt4571 * 977343673 - Class607.anInt5560 * 1855382415 + 1];
		for (local8 = 0; local8 < Class606.anInt5557 * 2035023117; local8++) {
			@Pc(75) int local75 = arg0.method22632((byte) -103);
			@Pc(83) Class154_Sub1 local83 = aClass154_Sub1Array2[local75] = new Class154_Sub1();
			local83.anInt1651 = arg0.method22413((short) 16384) * 88439695;
			local83.anInt1650 = arg0.method22419(-118643075) * 445350423;
			local83.anInt1653 = arg0.method22632((byte) -98) * -875570153;
			if (local83.anInt1653 * -2080957529 != 0) {
				local83.aString48 = arg0.method22428(-1489389891);
			}
			local83.anInt1654 = (Class607.anInt5560 * 1855382415 + local75) * 142830605;
			local83.aString47 = arg0.method22428(-220419951);
			local83.aString46 = arg0.method22428(1596169629);
		}
		anInt5720 = arg0.method22419(-118643075) * -537572227;
		aBoolean851 = true;
	}
	...
	public static boolean method32288(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(22) boolean local22 = local4.method22413((short) 16384) == 1;
		if (local22) {
			Class698.method36702(local4, -2132183101);
		}
	...
	public static boolean method32289(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(22) boolean local22 = local4.method22413((short) 16384) == 1;
		if (local22) {
			Class698.method36702(local4, -2114229297);
		}
	...
	public static boolean method32290(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(22) boolean local22 = local4.method22413((short) 16384) == 1;
		if (local22) {
			Class698.method36702(local4, -2133446003);
		}
	...
	public static Class154_Sub1 method32291(@OriginalArg(0) int arg0) {
		return aBoolean851 && arg0 >= Class607.anInt5560 * 1855382415 && arg0 <= Class361.anInt4571 * 977343673 ? aClass154_Sub1Array2[arg0 - Class607.anInt5560 * 1855382415] : null;
	}

	@OriginalMember(owner = "client!wb", name = "p", descriptor = "([B)Z", line = 27)
	public static boolean method32292(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class93_Sub41 local4 = new Class93_Sub41(arg0);
		@Pc(8) int local8 = local4.method22413((short) 16384);
		if (local8 != 2) {
			return false;
		...
		@Pc(22) boolean local22 = local4.method22413((short) 16384) == 1;
		if (local22) {
			Class698.method36702(local4, -2094712024);
		}
	...
	static void method32293(@OriginalArg(0) Class93_Sub41 arg0) {
		for (@Pc(1) int local1 = 0; local1 < Class606.anInt5557 * 2035023117; local1++) {
			@Pc(10) int local10 = arg0.method22632((byte) -88);
			@Pc(14) int local14 = arg0.method22415(-1434290800);
			if (local14 == 65535) {
				local14 = -1;
			}
	...
	static void method32294(@OriginalArg(0) Class93_Sub41 arg0) {
		for (@Pc(1) int local1 = 0; local1 < Class606.anInt5557 * 2035023117; local1++) {
			@Pc(10) int local10 = arg0.method22632((byte) -91);
			@Pc(14) int local14 = arg0.method22415(-1434290800);
			if (local14 == 65535) {
				local14 = -1;
			}
	...
	static final void method32297(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		Class274.aClass258_1.method26091(local13, (byte) -66);
	}

	@OriginalMember(owner = "client!wb", name = "g", descriptor = "(Lclient!arm;I)V", line = 835)
	static void method32298(@OriginalArg(0) Class93_Sub1_Sub7 arg0, @OriginalArg(1) int arg1) {
		...
		if (!arg0.aBoolean504) {
			...
			if (local22 != null && local22.method21718(arg0, (short) 20504)) {
				Class420.method28743(local22, -215944052);
			}
			return;
		}
		for (@Pc(54) Class93_Sub1_Sub8 local54 = (Class93_Sub1_Sub8) Class454.aClass18_16.method246(234556549); local54 != null; local54 = (Class93_Sub1_Sub8) Class454.aClass18_16.method253(-1926138044)) {
			if (local54.aString101.equals(arg0.aString100)) {
				...
				for (@Pc(70) Class93_Sub1_Sub7 local70 = (Class93_Sub1_Sub7) local54.aClass18_10.method246(391108234); local70 != null; local70 = (Class93_Sub1_Sub7) local54.aClass18_10.method253(-161207983)) {
					if (arg0 == local70) {
						if (local54.method21718(arg0, (short) 31749)) {
							Class420.method28743(local54, 908565838);
						}
						local64 = true;
						break;
					}
