...
public class Class632 {
	...
	static void method32285(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		for (local8 = 0; local8 < local3; local8++) {
			...
			aClass648Array1[local8].anInt5794 = arg0.method22632() * -58277581;
			aClass648Array1[local8].aString237 = arg0.method22428();
		}
		Class607.anInt5560 = arg0.method22632() * -174531729;
		Class361.anInt4571 = arg0.method22632() * -1231507063;
		Class606.anInt5557 = arg0.method22632() * 470817221;
		...
		for (local8 = 0; local8 < Class606.anInt5557 * 2035023117; local8++) {
			@Pc(75) int local75 = arg0.method22632();
			@Pc(83) Class154_Sub1 local83 = aClass154_Sub1Array2[local75] = new Class154_Sub1();
			local83.anInt1651 = arg0.method22413() * 88439695;
			local83.anInt1650 = arg0.method22419() * 445350423;
			local83.anInt1653 = arg0.method22632() * -875570153;
			if (local83.anInt1653 * -2080957529 != 0) {
				local83.aString48 = arg0.method22428();
			}
			local83.anInt1654 = (Class607.anInt5560 * 1855382415 + local75) * 142830605;
			local83.aString47 = arg0.method22428();
			local83.aString46 = arg0.method22428();
		}
		anInt5720 = arg0.method22419() * -537572227;
		aBoolean851 = true;
	}
	...
	static Class624 method32295(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(3) int local3 = arg0.method22413();
		@Pc(7) int local7 = arg0.method22413();
		@Pc(11) int local11 = arg0.method22413();
		@Pc(14) int[] local14 = new int[local11];
		for (@Pc(16) int local16 = 0; local16 < local11; local16++) {
			local14[local16] = arg0.method22413();
		}
	...
	static void method32298(@OriginalArg(0) Class93_Sub1_Sub7 arg0) {
		...
		if (!arg0.aBoolean504) {
			...
			for (local22 = (Class93_Sub1_Sub8) Class454.aClass16_34.method215(local17); local22 != null && !local22.aString101.equals(arg0.aString100); local22 = (Class93_Sub1_Sub8) Class454.aClass16_34.method216()) {
			}
			if (local22 != null && local22.method21718(arg0)) {
				Class420.method28743(local22);
			}
			return;
		}
		for (@Pc(54) Class93_Sub1_Sub8 local54 = (Class93_Sub1_Sub8) Class454.aClass18_16.method246(); local54 != null; local54 = (Class93_Sub1_Sub8) Class454.aClass18_16.method253()) {
			if (local54.aString101.equals(arg0.aString100)) {
				@Pc(64) boolean local64 = false;
				for (@Pc(70) Class93_Sub1_Sub7 local70 = (Class93_Sub1_Sub7) local54.aClass18_10.method246(); local70 != null; local70 = (Class93_Sub1_Sub7) local54.aClass18_10.method253()) {
					if (arg0 == local70) {
						if (local54.method21718(arg0)) {
							Class420.method28743(local54);
						}
						local64 = true;
						break;
					}
	...
	static final void method32297(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= 1189701933;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		Class274.aClass258_1.method26091(local13);
	}

	@OriginalMember(owner = "client!wb", name = "ayk", descriptor = "(Lclient!yf;B)V", line = 14023)
	static final void method32296(@OriginalArg(0) Class681 arg0) {
