...
public class Class329 {
	...
	public static int method27328(@OriginalArg(0) int arg0) {
	...
	public static void method27329(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1) {
		Class227.method25614(arg0, 0, "", "", "", arg1, (Class443) null, -1890944498);
	}
	...
	public static Class93_Sub1_Sub15 method27331(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(5) Class339 local5 = (Class339) aMap21.get(arg0);
		return local5.method27473(arg1, -611780419);
	}
	...
	public static void method27332(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1) {
		Class227.method25614(arg0, 0, "", "", "", arg1, (Class443) null, -1949370923);
	}

	@OriginalMember(owner = "client!hz", name = "o", descriptor = "()I", line = 22)
	static int method27333() {
		return (anInt4145 += 975062165) * -1643878723 - 1;
	}
	...
	public static void method27334(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2, @OriginalArg(3) String arg3, @OriginalArg(4) String arg4, @OriginalArg(5) String arg5, @OriginalArg(6) Class443 arg6) {
		Class60.method1123(arg0, arg1, arg2, arg3, arg4, arg5, (String) null, -1, arg6, 1346198176);
	}
	...
	public static Class93_Sub1_Sub15 method27336(@OriginalArg(0) int arg0) {
	...
	public static int method27340(@OriginalArg(0) int arg0) {
		@Pc(5) Class339 local5 = (Class339) aMap21.get(arg0);
		return local5 == null ? 0 : local5.method27482((byte) 7);
	}
	...
	public static int method27345(@OriginalArg(0) int arg0) {
		@Pc(5) Class93_Sub1_Sub15 local5 = (Class93_Sub1_Sub15) aClass16_29.method215((long) arg0);
		if (local5 == null) {
			return -1;
		} else if (local5.aClass93_Sub1_68 == aClass18_15.aClass93_Sub1_4) {
	...
	public static void method27346(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1) {
		Class227.method25614(arg0, 0, "", "", "", arg1, (Class443) null, -1890460263);
	}

	@OriginalMember(owner = "client!hz", name = "jg", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;I)V", line = 6709)
	static final void method27347(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
	...
	static final void method27348(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static void method27349(@OriginalArg(0) int arg0) {
		if (client.anInt3435 * -849002901 == 19) {
			Class634.method32321(813052467);
		}
		client.aClass175_1.method24355((byte) 126);
		...
		if (client.anInt3526 * -703563959 != -1) {
			Class535.method30753(client.anInt3526 * -703563959, 1574420063);
		}
		...
		client.aClass532_1.method30532((byte) -54).method33003(-1404774556);
		...
		Class51.aClass93_Sub36_1.method14357(Class51.aClass93_Sub36_1.aClass166_Sub15_2, Class51.aClass93_Sub36_1.aClass166_Sub15_1.method15673(1772258488), (byte) 103);
		client.anInt3455 = 0;
		Class380.method28120((byte) 114);
	...
	public static int method27350(@OriginalArg(0) CharSequence arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		return Class618.method32103(arg0, arg1, true, 1956687461);
	}
}
