...
public class Class166_Sub43 extends Class166 {
	...
	int method16543(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return Class136.method10214(this.aClass93_Sub36_49.aClass166_Sub4_2.method15424((byte) 77), -1912701350) ? 1 : 3;
	}
	...
	public void method16422(@OriginalArg(0) int arg0) {
		if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 3) {
			this.anInt2379 = this.method16542((byte) -90) * -88839937;
		}
	}

	@OriginalMember(owner = "client!anu", name = "s", descriptor = "(I)I", line = 38)
	public int method16423(@OriginalArg(0) int arg0) {
	...
	int method16549(@OriginalArg(0) int arg0) {
		return Class136.method10214(this.aClass93_Sub36_49.aClass166_Sub4_2.method15424((byte) 82), -657508631) ? 1 : 3;
	}

	@OriginalMember(owner = "client!anu", name = "p", descriptor = "(I)I", line = 29)
	@Override
	int method16540(@OriginalArg(0) int arg0) {
		return Class136.method10214(this.aClass93_Sub36_49.aClass166_Sub4_2.method15424((byte) 110), 1739485463) ? 1 : 3;
	}
	...
	static void method16427(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class589.method31683((short) -17562);
	}
}
