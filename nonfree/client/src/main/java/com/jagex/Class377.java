...
public class Class377 implements Runnable {
	...
	Class376 method28050(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.aClass376Array1 == null || arg0 < 0 || arg0 >= this.aClass376Array1.length ? null : this.aClass376Array1[arg0];
	}
	...
	boolean method28054(@OriginalArg(0) byte arg0) {
		if (this.aBoolean739) {
			return true;
		}
	...
	static final void method28059(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class78.method1316(Class51.aClass93_Sub36_1.aClass166_Sub4_2.method15424((byte) 109), 200, 1323350560);
	}
