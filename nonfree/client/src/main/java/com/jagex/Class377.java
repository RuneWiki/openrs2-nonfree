...
public class Class377 implements Runnable {
	...
	public void method28049() {
		try {
			@Pc(8) int local8 = Class54.method14855(Class280.aClass693_1, Class703.aClass703_3, Class50.aClass28_3.anInt101 * 2142901097);
	...
	static final void method28060(@OriginalArg(0) Class681 arg0) {
		@Pc(13) String local13 = (String) arg0.anObjectArray45[(arg0.anInt5888 -= 957530791) * 587908375];
		Class367.method27960(local13);
	}

	@OriginalMember(owner = "client!kf", name = "aul", descriptor = "(Lclient!yf;B)V", line = 13401)
	static final void method28059(@OriginalArg(0) Class681 arg0) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class78.method1316(Class51.aClass93_Sub36_1.aClass166_Sub4_2.method15424(), 200);
	}
}
