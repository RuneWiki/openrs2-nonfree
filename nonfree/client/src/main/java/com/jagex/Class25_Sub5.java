...
public class Class25_Sub5 extends Class25 {
	...
	public void method23126(@OriginalArg(0) Class368 arg0, @OriginalArg(1) Class470 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float arg4) {
		@Pc(5) Class472 local5 = Class472.method29530(this.aClass123_16.method8957(-1719464790));
		local5.aFloat317 -= (float) arg2;
		local5.aFloat319 -= (float) arg3;
		local5.aFloat318 *= -1.0F;
		@Pc(29) Class472 local29 = this.method23120(-1393426412);
		local29.aFloat317 -= (float) arg2;
		local29.aFloat319 -= (float) arg3;
		local29.aFloat318 *= -1.0F;
		arg1.method29368((double) local5.aFloat317, (double) local5.aFloat318, (double) local5.aFloat319, (double) local29.aFloat317, (double) local29.aFloat318, (double) local29.aFloat319, 0.0F, 1.0F, 0.0F);
		local5.method29532();
		local29.method29532();
	}
	...
	public void method23128(@OriginalArg(0) float arg0) {
		if (this.anInterface29_2 != null) {
			this.aClass472_51.method29538(this.anInterface29_2.method19938((byte) 35).method13870(-401610637));
	...
	public void method16472(@OriginalArg(0) int arg0) {
		if (this.anInterface29_2 != null) {
			this.anInterface29_2 = this.aClass123_16.method8940(-1543105430).method36705(this.anInterface29_2.method19946(65280), this.anInterface29_2.method19941(230905611), (byte) 32);
		}
	}

	@OriginalMember(owner = "client!anw", name = "e", descriptor = "(FB)V", line = 37)
	@Override
	public void method23118(@OriginalArg(0) float arg0, @OriginalArg(1) byte arg1) {
		if (this.anInterface29_2 != null) {
			this.aClass472_51.method29538(this.anInterface29_2.method19938((byte) 45).method13870(-1418517391));
	...
	@Override
	public boolean method23132(@OriginalArg(0) int arg0) {
	...
	@Override
	public void method23123(@OriginalArg(0) Class368 arg0, @OriginalArg(1) Class470 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float arg4, @OriginalArg(5) byte arg5) {
		@Pc(5) Class472 local5 = Class472.method29530(this.aClass123_16.method8957(-446994613));
		local5.aFloat317 -= (float) arg2;
		local5.aFloat319 -= (float) arg3;
		local5.aFloat318 *= -1.0F;
		@Pc(29) Class472 local29 = this.method23120(-290218276);
		local29.aFloat317 -= (float) arg2;
		local29.aFloat319 -= (float) arg3;
		local29.aFloat318 *= -1.0F;
		arg1.method29368((double) local5.aFloat317, (double) local5.aFloat318, (double) local5.aFloat319, (double) local29.aFloat317, (double) local29.aFloat318, (double) local29.aFloat319, 0.0F, 1.0F, 0.0F);
	...
	@Override
	public Class472 method23120(@OriginalArg(0) int arg0) {
		@Pc(3) Class472 local3 = Class472.method29530(this.aClass472_53);
		@Pc(7) Class472 local7 = Class472.method29530(this.aClass472_52);
		if (this.aBoolean367) {
			local7.method29572(this.anInterface29_2.method19939(65535));
		}
		local3.method29543(local7);
		local7.method29532();
		return local3;
	}
	...
	@Override
	public Class472 method23122(@OriginalArg(0) int arg0) {
		@Pc(3) Class472 local3 = Class472.method29530(this.aClass472_51);
		@Pc(7) Class472 local7 = Class472.method29530(this.aClass472_52);
		if (this.aBoolean367) {
			local7.method29572(this.anInterface29_2.method19939(65535));
		}
	...
	public void method16473(@OriginalArg(0) Interface29 arg0, @OriginalArg(1) Class472 arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3) {
		this.anInterface29_2 = arg0;
		this.aClass472_52.method29538(arg1);
	...
	@Override
	public void method23119(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		@Pc(5) Class363 local5 = Class90.method1601(arg0.method22413((short) 16384), -2127878358);
		@Pc(9) int local9 = arg0.method22415(-1434290800);
		this.anInterface29_2 = this.aClass123_16.method8940(-1921359625).method36705(local5, local9, (byte) 32);
		this.aClass472_52.method29536(arg0);
	...
	public void method23124(@OriginalArg(0) float arg0) {
		if (this.anInterface29_2 != null) {
			this.aClass472_51.method29538(this.anInterface29_2.method19938((byte) 24).method13870(553862716));
	...
	public void method23130(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(5) Class363 local5 = Class90.method1601(arg0.method22413((short) 16384), -2046023789);
		@Pc(9) int local9 = arg0.method22415(-1434290800);
		this.anInterface29_2 = this.aClass123_16.method8940(-1636717958).method36705(local5, local9, (byte) 32);
		this.aClass472_52.method29536(arg0);
		if (arg0.method22413((short) 16384) == 1) {
			this.aBoolean367 = true;
		} else {
	...
	public void method23121(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(5) Class363 local5 = Class90.method1601(arg0.method22413((short) 16384), -2004967171);
		@Pc(9) int local9 = arg0.method22415(-1434290800);
		this.anInterface29_2 = this.aClass123_16.method8940(-1606557995).method36705(local5, local9, (byte) 32);
		this.aClass472_52.method29536(arg0);
		if (arg0.method22413((short) 16384) == 1) {
			this.aBoolean367 = true;
		} else {
	...
	public void method16475() {
		if (this.anInterface29_2 != null) {
			this.anInterface29_2 = this.aClass123_16.method8940(-1692104186).method36705(this.anInterface29_2.method19946(65280), this.anInterface29_2.method19941(230905611), (byte) 32);
		}
	}
	...
	public void method23129(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(5) Class363 local5 = Class90.method1601(arg0.method22413((short) 16384), -2065185880);
		@Pc(9) int local9 = arg0.method22415(-1434290800);
		this.anInterface29_2 = this.aClass123_16.method8940(-1608360168).method36705(local5, local9, (byte) 32);
		this.aClass472_52.method29536(arg0);
		if (arg0.method22413((short) 16384) == 1) {
			this.aBoolean367 = true;
		} else {
	...
	public Class472 method16476(@OriginalArg(0) int arg0) {
		return this.aClass472_53;
	}
	...
	public void method23131(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(5) Class363 local5 = Class90.method1601(arg0.method22413((short) 16384), -2019436694);
		@Pc(9) int local9 = arg0.method22415(-1434290800);
		this.anInterface29_2 = this.aClass123_16.method8940(-1782321774).method36705(local5, local9, (byte) 32);
		this.aClass472_52.method29536(arg0);
		if (arg0.method22413((short) 16384) == 1) {
			this.aBoolean367 = true;
		} else {
	...
	public Class472 method16477() {
		return this.aClass472_53;
	}

	@OriginalMember(owner = "client!anw", name = "h", descriptor = "(Lclient!jn;Lclient!ox;Z)V", line = 24)
	public void method16478(@OriginalArg(0) Interface29 arg0, @OriginalArg(1) Class472 arg1, @OriginalArg(2) boolean arg2) {
		this.anInterface29_2 = arg0;
		this.aClass472_52.method29538(arg1);
		this.aBoolean367 = arg2;
	...
	public void method16479(@OriginalArg(0) Interface29 arg0, @OriginalArg(1) Class472 arg1, @OriginalArg(2) boolean arg2) {
		this.anInterface29_2 = arg0;
		this.aClass472_52.method29538(arg1);
		this.aBoolean367 = arg2;
	...
	public void method16480(@OriginalArg(0) Interface29 arg0, @OriginalArg(1) Class472 arg1, @OriginalArg(2) boolean arg2) {
		this.anInterface29_2 = arg0;
		this.aClass472_52.method29538(arg1);
		this.aBoolean367 = arg2;
	...
	public void method16481() {
		if (this.anInterface29_2 != null) {
			this.anInterface29_2 = this.aClass123_16.method8940(-1844885721).method36705(this.anInterface29_2.method19946(65280), this.anInterface29_2.method19941(230905611), (byte) 32);
		}
	}
	...
	public void method16482() {
		if (this.anInterface29_2 != null) {
			this.anInterface29_2 = this.aClass123_16.method8940(-1707053059).method36705(this.anInterface29_2.method19946(65280), this.anInterface29_2.method19941(230905611), (byte) 32);
		}
	}
	...
	public void method16483() {
		if (this.anInterface29_2 != null) {
			this.anInterface29_2 = this.aClass123_16.method8940(-1789369804).method36705(this.anInterface29_2.method19946(65280), this.anInterface29_2.method19941(230905611), (byte) 32);
		}
	}

	@OriginalMember(owner = "client!anw", name = "i", descriptor = "(Lclient!jn;Lclient!ox;Z)V", line = 24)
	public void method16484(@OriginalArg(0) Interface29 arg0, @OriginalArg(1) Class472 arg1, @OriginalArg(2) boolean arg2) {
		this.anInterface29_2 = arg0;
		this.aClass472_52.method29538(arg1);
		this.aBoolean367 = arg2;
	...
	public void method16486() {
		if (this.anInterface29_2 != null) {
			this.anInterface29_2 = this.aClass123_16.method8940(-2045939413).method36705(this.anInterface29_2.method19946(65280), this.anInterface29_2.method19941(230905611), (byte) 32);
		}
	}
	...
	static final void method16488(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub24_1.method15862((byte) 27) ? 1 : 0;
	}
}
