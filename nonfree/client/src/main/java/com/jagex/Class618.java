...
public class Class618 implements Interface75 {
	...
	static int method32103(@OriginalArg(0) CharSequence arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		if (arg1 < 2 || arg1 > 36) {
	...
	static final String method32104(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2) {
	...
	public static Class721 method32099() {
	...
	public static void method32100() {
	...
	static final void method32098(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class332.method27393(local16, local22, arg0);
	}

	@OriginalMember(owner = "client!vn", name = "jc", descriptor = "(ZI)V", line = 10859)
	static final void method32101(@OriginalArg(0) boolean arg0) {
		Class568.method31297(client.anInt3526 * -703563959, client.anInt3408 * -1378711501, client.anInt3416 * 2091353777, arg0);
	}

	@OriginalMember(owner = "client!vn", name = "ahu", descriptor = "(Lclient!yf;B)V", line = 10862)
	static final void method32102(@OriginalArg(0) Class681 arg0) {
		...
		if (local29.method1508()) {
			arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = ((Class93_Sub1_Sub1) Class649.aClass55_Sub1_1.method18261(local13)).method1754(local23, local29.aString11);
		} else {
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = ((Class93_Sub1_Sub1) Class649.aClass55_Sub1_1.method18261(local13)).method1753(local23, local29.anInt265 * 951920133);
		}
	}
}
