...
public class Class514 {
	...
	public Class93_Sub1_Sub14 method30266(@OriginalArg(0) int arg0) {
		@Pc(6) Class93_Sub1_Sub14 local6 = (Class93_Sub1_Sub14) this.aClass240_89.method25839((long) arg0);
		if (local6 != null) {
			return local6;
		}
		@Pc(22) byte[] local22;
		if (arg0 >= 32768) {
			local22 = this.aClass497_126.method30044(0, arg0 & 0x7FFF, (byte) 0);
		} else {
			local22 = this.aClass497_127.method30044(0, arg0, (byte) 0);
		}
		local6 = new Class93_Sub1_Sub14();
		if (local22 != null) {
			local6.method22360(new Class93_Sub41(local22), 304505924);
		}
		if (arg0 >= 32768) {
			local6.method22363(685493737);
		}
		this.aClass240_89.method25830(local6, (long) arg0);
		return local6;
	}
	...
	public Class93_Sub1_Sub14 method30267(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		...
		local6 = new Class93_Sub1_Sub14();
		if (local22 != null) {
			local6.method22360(new Class93_Sub41(local22), -999951845);
		}
		if (arg0 >= 32768) {
			local6.method22363(-2021337560);
		}
		this.aClass240_89.method25830(local6, (long) arg0);
		return local6;
	}
	...
	public Class514(@OriginalArg(0) Class717 arg0, @OriginalArg(1) Class497 arg1, @OriginalArg(2) Class497 arg2) {
		...
		if (this.aClass497_127 != null) {
			this.aClass497_127.method30062(0, 146628982);
		}
		if (this.aClass497_126 != null) {
			this.aClass497_126.method30062(0, 950007617);
		}
	}
	...
	public Class93_Sub1_Sub14 method30268(@OriginalArg(0) int arg0) {
		...
		local6 = new Class93_Sub1_Sub14();
		if (local22 != null) {
			local6.method22360(new Class93_Sub41(local22), 110736450);
		}
		if (arg0 >= 32768) {
			local6.method22363(801520252);
		}
		this.aClass240_89.method25830(local6, (long) arg0);
		return local6;
	}
	...
	public Class93_Sub1_Sub14 method30269(@OriginalArg(0) int arg0) {
		...
		local6 = new Class93_Sub1_Sub14();
		if (local22 != null) {
			local6.method22360(new Class93_Sub41(local22), -396632467);
		}
		if (arg0 >= 32768) {
			local6.method22363(1250336655);
		}
		this.aClass240_89.method25830(local6, (long) arg0);
		return local6;
	}
