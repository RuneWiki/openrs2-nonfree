...
public class Class514 {
	...
	public Class514(@OriginalArg(0) Class717 arg0, @OriginalArg(1) Class497 arg1, @OriginalArg(2) Class497 arg2) {
		...
		if (this.aClass497_127 != null) {
			this.aClass497_127.method30062(0);
		}
		if (this.aClass497_126 != null) {
			this.aClass497_126.method30062(0);
		}
	}
	...
	public Class93_Sub1_Sub14 method30266(@OriginalArg(0) int arg0) {
		...
		@Pc(22) byte[] local22;
		if (arg0 >= 32768) {
			local22 = this.aClass497_126.method30044(0, arg0 & 0x7FFF);
		} else {
			local22 = this.aClass497_127.method30044(0, arg0);
		}
		local6 = new Class93_Sub1_Sub14();
		if (local22 != null) {
			local6.method22360(new Class93_Sub41(local22));
		}
		if (arg0 >= 32768) {
			local6.method22363();
		}
	...
	public Class93_Sub1_Sub14 method30267(@OriginalArg(0) int arg0) {
		@Pc(6) Class93_Sub1_Sub14 local6 = (Class93_Sub1_Sub14) this.aClass240_89.method25839((long) arg0);
		if (local6 != null) {
			return local6;
		}
