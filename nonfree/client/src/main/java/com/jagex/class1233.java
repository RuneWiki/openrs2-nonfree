...
public class class1233 extends class1199 {
	...
	public class552 method17372(class133 arg0) {
		...
		if (this.field12578 != var5) {
			var2.field4311 += (float) (var5 - this.field12578);
		...
		if (this.field12573 != -1) {
			class116 var35 = ((class738) Statics.field1842.method962(this.field12573)).method14644(arg0, 526336, this.field12583, (class639) null, (class721) null, this.field12581, this.field12582, this.field12574, this.field12575);
			if (var35 != null) {
		...
		if (this.field12569 != -1) {
			class116 var36 = ((class738) Statics.field1842.method962(this.field12569)).method14644(arg0, 526336, this.field12572, (class639) null, (class721) null, this.field12581, this.field12582, this.field12574, this.field12575);
			if (var36 != null) {
		...
		class116 var37 = ((class738) Statics.field1842.method962(this.field12580)).method14644(arg0, 526336, this.field12570, (class639) null, (class721) null, this.field12581, this.field12582, this.field12574, this.field12575);
		if (var37 != null) {
	...
	public boolean method17375(class133 arg0, int arg1, int arg2) {
		...
		class116 var5 = ((class738) Statics.field1842.method962(this.field12580)).method14644(arg0, 131072, this.field12570, (class639) null, (class721) null, 0, 0, 0, 0);
		if (var5 != null) {
			if (this.field12571 == null) {
				field12584.method6376();
			} else {
		...
		if (this.field12569 != -1) {
			class116 var6 = ((class738) Statics.field1842.method962(this.field12569)).method14644(arg0, 131072, this.field12572, (class639) null, (class721) null, 0, 0, 0, 0);
			if (var6 != null) {
				if (this.field12568 == null) {
					field12584.method6376();
				} else {
		...
		if (this.field12573 != -1) {
			class116 var7 = ((class738) Statics.field1842.method962(this.field12573)).method14644(arg0, 131072, this.field12583, (class639) null, (class721) null, 0, 0, 0, 0);
			if (var7 != null) {
				if (this.field12577 == null) {
					field12584.method6376();
				} else {
