...
public class Class475 implements Interface7 {
	...
	public int method30020(@OriginalArg(0) int arg0) {
		...
		try {
			return Class125_Sub1.aClass586_1.method31626(this.aString213, this.aBoolean778, 484684735);
		} catch (@Pc(13) Exception_Sub5 local13) {
			Class166_Sub6.method15481(Class72.aClass72_1, local13.aString65, local13.anInt2491 * 1562390493, local13.getCause(), 1352442392);
	...
	void method29675(@OriginalArg(0) byte arg0) {
		this.aBoolean779 = true;
	}
	...
	public int method30026() {
		...
		try {
			return Class125_Sub1.aClass586_1.method31626(this.aString213, this.aBoolean778, -2059312980);
		} catch (@Pc(13) Exception_Sub5 local13) {
			Class166_Sub6.method15481(Class72.aClass72_1, local13.aString65, local13.anInt2491 * 1562390493, local13.getCause(), -1505586098);
			this.aBoolean779 = true;
			return 100;
		}
	}
	...
	public int method30023() {
		...
		try {
			return Class125_Sub1.aClass586_1.method31626(this.aString213, this.aBoolean778, -9442516);
		} catch (@Pc(13) Exception_Sub5 local13) {
			Class166_Sub6.method15481(Class72.aClass72_1, local13.aString65, local13.anInt2491 * 1562390493, local13.getCause(), 491178534);
			this.aBoolean779 = true;
			return 100;
		}
	}
