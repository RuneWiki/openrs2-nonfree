...
public class Class237 {
	...
	static final void method25770(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class644.method32600(local11, local14, arg0, -470583970);
	}

	@OriginalMember(owner = "client!dy", name = "dh", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;S)V", line = 5637)
	static final void method25771(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) short arg3) {
	...
	public static final void method25772(@OriginalArg(0) Class109 arg0, @OriginalArg(1) Class19 arg1, @OriginalArg(2) Class19 arg2, @OriginalArg(3) int arg3) {
		if (!arg1.method23578((byte) -27) || !arg2.method23578((byte) -54)) {
			return;
		}
		@Pc(10) Class263 local10 = arg1.aClass263_5;
		@Pc(13) Class263 local13 = arg2.aClass263_5;
		if (local10.anIntArray364 == null) {
			if (local10.method26188(-2138096571)) {
				...
				} else if (local13.method26188(-2139118976)) {
		...
		} else if (local13.method26188(-2135334395)) {
	...
	static final void method25773(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub38_1.method16321(1120721770);
	}

	@OriginalMember(owner = "client!dy", name = "aky", descriptor = "(Lclient!yf;I)V", line = 11683)
	static final void method25774(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(31) boolean local31 = local15.method23180(local12 >> 14 & 0x3FFF, local12 & 0x3FFF, Class687.anIntArray525, 2066377425);
		if (local31) {
	...
	static final void method25775(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub31_1.method16109(17402244) ? 1 : 0;
	}

	@OriginalMember(owner = "client!dy", name = "jg", descriptor = "(Lclient!hq;Lclient!hf;B)V", line = 10863)
	public static void method25776(@OriginalArg(0) Class320 arg0, @OriginalArg(1) Class312 arg1, @OriginalArg(2) byte arg2) {
		@Pc(4) Class312 local4 = Class431.method28779(arg0, arg1, 1851288469);
		@Pc(11) int local11;
		@Pc(15) int local15;
		if (local4 == null) {
		...
		Class550.method31031(arg1, local11, local15, false, (byte) 30);
	...
	static final void method25777(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		if (client.aClass532_1.method30459(-1152217372) == null) {
			Class694.aClass104_14.method20600(arg0, arg1, arg2, arg3, -16777216, (byte) 115);
			return;
		}
		...
		if (client.anInt3463 * 1819062465 == 3) {
			if ((int) local16.aFloat317 < 0 || (int) local16.aFloat317 >= client.aClass532_1.method30444(1593640891) * 512 || (int) local16.aFloat319 < 0 || (int) local16.aFloat319 >= client.aClass532_1.method30474((short) 128) * 512) {
				local18 = true;
			}
			if (Class429.anInt4781 * -1453926679 == 3 && !Class65.aClass123_Sub1_2.method8987((byte) 37)) {
				local18 = true;
			}
		...
		if (local18) {
			Class694.aClass104_14.method20600(arg0, arg1, arg2, arg3, -16777216, (byte) 9);
			return;
		}
		client.anInt3495 += -1386163559;
		if (Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3 != null && (int) local16.aFloat317 - (Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.method19997(-274822650) - 1) * 256 >> 9 == Class172.anInt3179 * -820036969 && (int) local16.aFloat319 - (Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.method19997(564816095) - 1) * 256 >> 9 == Class172.anInt3174 * -1293607373) {
			Class172.anInt3179 = -2004084007;
			Class172.anInt3174 = 246739717;
			Class723.method36943(832556703);
		}
		Class559.method31129(-811294177);
		if (!arg4) {
			Class387.method28245(-1392345673);
		}
		Class293.method26589(2141592615);
		@Pc(135) int local135;
		for (local135 = 0; local135 < client.aClass567Array1.length; local135++) {
			if (client.aClass567Array1[local135] != null && !client.aClass567Array1[local135].method31265(-89462490) && client.aClass567Array1[local135].method31266(Class694.aClass104_14, -1895227578)) {
				client.aClass567Array1[local135].method31270(client.aClass532_1.method30459(-1671370685), (byte) 23);
			}
		}
		...
		Class497.method30132(local177, local181, (byte) -47);
		@Pc(240) int local240;
		if (Class429.anInt4781 * -1453926679 == 2) {
			...
			Class716.method36876(Class72.anInt241 * -1022856553, Class305.method26801((int) local16.aFloat317, (int) local16.aFloat319, Class512.anInt5209 * 1177442423, (byte) -13) - client.anInt3484 * 1974760385, Class441.anInt4886 * -953396699, local135, local240, (local135 >> 3) * 3 + 600 << 2, local189, (byte) -40);
			...
			Class716.method36876(Class72.anInt241 * -1022856553, Class305.method26801(client.anInt3481 * -1195894597, client.anInt3482 * 1196621895, Class512.anInt5209 * 1177442423, (byte) -53) - client.anInt3484 * 1974760385, Class441.anInt4886 * -953396699, local135, local240, (local135 >> 3) * 3 + 600 << 2, local189, (byte) -83);
		} else if (Class429.anInt4781 * -1453926679 == 1) {
			Class688.method36521(local189, -1103134376);
		}
		...
		if (Class163.anInt2002 * -1331168249 > (client.aClass532_1.method30459(-1960289076).anInt5443 * -200159665 << 9) - 1) {
			Class163.anInt2002 = ((client.aClass532_1.method30459(-930676881).anInt5443 * -200159665 << 9) - 1) * 1636217271;
		}
		if (Class270.anInt3884 * 466086187 < 0) {
			Class270.anInt3884 = 0;
		}
		if (Class270.anInt3884 * 466086187 > (client.aClass532_1.method30459(-1514757946).anInt5444 * -1943751559 << 9) - 1) {
			Class270.anInt3884 = ((client.aClass532_1.method30459(-1830968116).anInt5444 * -1943751559 << 9) - 1) * -967471741;
		}
		...
		@Pc(606) Class672 local606 = client.aClass532_1.method30532((byte) -101).method32966(65536);
		local427 = local606.method33057((short) -5746);
		@Pc(614) Class368 local614 = new Class368();
		@Pc(618) Class611 local618 = client.aClass532_1.method30443(1897755705);
		if (Class253.method25995((byte) 11)) {
			Class1.aClass123_Sub1_1.method8950(local614, client.aClass470_51, client.aClass489_95, local618.anInt5623 * 270611681 << 9, local618.anInt5624 * -1994307635 << 9, (byte) 6);
		} else if (Class429.anInt4781 * -1453926679 == 3) {
			Class65.aClass123_Sub1_2.method8950(local614, client.aClass470_51, client.aClass489_95, local618.anInt5623 * 270611681 << 9, local618.anInt5624 * -1994307635 << 9, (byte) 6);
		} else {
		...
		@Pc(785) int local785;
		if (local606.method33058(-1252342804) == null) {
			...
			if (Class429.anInt4781 * -1453926679 == 3) {
				...
				local606.method33058(1328177676).method31162(Class694.aClass104_14, Class121.anInt1003 * 353504223 << 3, local177, local181, local185, local189, local777, local785, 0, local427, true, false, -2051121824);
			} else {
				local606.method33058(-1832214775).method31162(Class694.aClass104_14, Class121.anInt1003 * 353504223 << 3, local177, local181, local185, local189, Class620.anInt5644 * 607613741, Class24.anInt82 * -20667523, Class348.anInt4199 * -602770317, local427, true, false, -2113800467);
			}
		...
		client.aClass532_1.method30532((byte) -48).method32987(client.aClass532_1, (byte) 3);
		...
		if (Class253.method25995((byte) 84) || Class429.anInt4781 * -1453926679 == 3) {
			client.aClass532_1.method30459(-1085439687).method31574(client.anInt3485, local614.anInt4586 * -1774271657, local614.anInt4587 * -754001767, local614.anInt4588 * 1179660263, client.aClass532_1.method30458((byte) 2), client.anIntArray327, client.anIntArray312, client.anIntArray313, client.anIntArray314, client.anIntArray302, Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aByte100 + 1, local869, (int) local16.aFloat317 >> 9, (int) local16.aFloat319 >> 9, Class51.aClass93_Sub36_1.aClass166_Sub25_1.method15887(-988861719) == 0, true, 0, true);
		} else {
			client.aClass532_1.method30459(-1151880557).method31574(client.anInt3485, Class163.anInt2002 * -1331168249, Class130_Sub2.anInt1117 * 1055108289, Class270.anInt3884 * 466086187, client.aClass532_1.method30458((byte) -44), client.anIntArray327, client.anIntArray312, client.anIntArray313, client.anIntArray314, client.anIntArray302, Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aByte100 + 1, local869, (int) local16.aFloat317 >> 9, (int) local16.aFloat319 >> 9, Class51.aClass93_Sub36_1.aClass166_Sub25_1.method15887(-988861719) == 0, true, 0, true);
		}
		client.anInt3494 += -22139677;
		if (!Class694.aClass104_14.method20533() && client.anInt3435 * -849002901 == 18) {
			Class558.method31109(local177, local181, local185, local189, 1351367408);
		}
		client.aClass532_1.method30459(-1188192890).method31452(-698845241);
		...
		if (client.aBoolean630 && Class520.aClass144_3.method11155(2087464072) == 0) {
			client.aBoolean630 = false;
		}
		if (client.aBoolean630) {
			Class694.aClass104_14.method20600(local177, local181, local185, local189, -16777216, (byte) 34);
		...
		Class694.aClass104_14.method20519(client.aClass489_95);
		Class663.method32870(client.aClass489_95, (byte) 55);
	}

	@OriginalMember(owner = "client!dy", name = "m", descriptor = "(Ljava/lang/String;II)V", line = 64)
	public static void method25778(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		Class50.aClass28_2.anInt100 = Class250.method25956(Class280.aClass693_1, Class703.aClass703_2, Class50.aClass28_2.anInt101 * 2142901097, -1850088124) * -1138615973;
		Class50.aClass28_2.anInt99 = Class654.method32719(Class280.aClass693_1, Class703.aClass703_2, Class50.aClass28_2.anInt101 * 2142901097, -1904685960) * 702279345;
	}
}
