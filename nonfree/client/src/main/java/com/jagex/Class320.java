...
public class Class320 {
	...
	public Class312 method27228(@OriginalArg(0) int arg0) {
	...
	public Class312 method27230(@OriginalArg(0) int arg0) {
		if (arg0 >>> 16 != this.aClass312Array3[0].anInt3953 * -1549590237 >>> 16) {
			throw new IllegalArgumentException();
		}
		return this.aClass312Array3[arg0 & 0xFFFF];
	...
	public static void method27238(@OriginalArg(0) boolean arg0) {
	}

	@OriginalMember(owner = "client!hq", name = "ts", descriptor = "(Lclient!yf;I)V", line = 8471)
	static final void method27239(@OriginalArg(0) Class681 arg0) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		Class229.method25620(local11, arg0);
	}

	@OriginalMember(owner = "client!hq", name = "anc", descriptor = "(Lclient!yf;Lclient!ahm;I)V", line = 12350)
	static final void method27240(@OriginalArg(0) Class681 arg0, @OriginalArg(1) Class132_Sub1_Sub1_Sub1 arg1) {
		...
		if (Class65.aClass123_Sub1_2.method8986() != Class338.aClass338_4) {
			throw new RuntimeException();
		}
		@Pc(62) Class25_Sub5 local62 = (Class25_Sub5) Class65.aClass123_Sub1_2.method9040();
		if (arg1 != null) {
			local62.method16473(arg1, new Class472((float) local13, (float) local23, (float) local33), local48);
		}
