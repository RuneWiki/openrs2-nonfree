...
public class Class320 {
	...
	public Class312 method27228(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	static final void method27239(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		Class229.method25620(local11, arg0, (byte) 27);
	}
	...
	static final void method27240(@OriginalArg(0) Class681 arg0, @OriginalArg(1) Class132_Sub1_Sub1_Sub1 arg1, @OriginalArg(2) int arg2) {
		...
		if (arg1 != null) {
			local62.method16473(arg1, new Class472((float) local13, (float) local23, (float) local33), local48, 2095475210);
		}
