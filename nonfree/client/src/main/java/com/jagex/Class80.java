...
public class Class80 {
	...
	public static void method1364(@OriginalArg(0) int arg0) {
		if (Class362.aClass370Array1 == null) {
			Class362.aClass370Array1 = Class370.method27993(-1497761840);
			Class146.aClass370_3 = Class362.aClass370Array1[0];
			Class661.aLong302 = Class305.method26796(1585924226) * -5556977673772728225L;
		}
		if (Class653.aClass357_1 == null) {
			Class393.method28317((byte) 90);
		}
		...
		if (Class146.aClass370_3 == local19) {
			...
			if (Class362.aBoolean730) {
				...
				Class114.method7634(Class7.aString2, Class490.aString217, "", false, (byte) 119);
			}
		} else {
			...
			if (Class146.aClass370_3.aBoolean737 || local19.aBoolean737) {
				Class661.aLong302 = Class305.method26796(136817521) * -5556977673772728225L;
			}
		}
		if (Class653.aClass357_1 == null) {
			return;
		}
		Class653.aClass357_1.method27735(Class661.aLong302 * 3693219987677404063L, Class362.aString187, Class531.aString225, Class66.anInt237 * 1453631867, Class146.aClass370_3, (short) 174);
		...
		for (@Pc(162) int local162 = Class362.anInt4573 * 815014065 + 1; local162 < Class362.anInterface30Array1.length; local162++) {
			if (Class362.anInterface30Array1[local162].method27932(-1143727088) >= 100 && local162 - 1 == Class362.anInt4573 * 815014065 && client.anInt3435 * -849002901 != 5 && Class653.aClass357_1.method27743((byte) 29)) {
				try {
				...
				Class653.aClass357_1.method27765(Class362.anInterface30Array1[local162], (short) -5560);
				...
				if (Class362.anInt4573 * 815014065 >= Class362.anInterface30Array1.length - 1 && Class362.anInterface30Array1.length > 1) {
					Class362.anInt4573 = (Class363.aClass81_1.method1374(-1392221523) ? 0 : -1) * 770058321;
				}
			}
		}
	}
	...
	static String method1365(@OriginalArg(0) Class93_Sub1_Sub8 arg0, @OriginalArg(1) byte arg1) {
		return arg0.aString101 + Class306.method26823(16777215, 1364993091) + " >";
	}
}
