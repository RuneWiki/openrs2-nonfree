...
public class Class14 {
	...
	public static String method192(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		return arg1 == 3 ? Class474.method29666(arg0, arg1, (byte) -115) : Integer.toString(local5 / 10) + local5 % 10 + "-" + Class69.aStringArrayArray1[arg1][local9] + "-" + local13;
	}
	...
	static final void method194(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		if (!Class65.aClass123_Sub1_2.method8986((byte) -80).method27463((byte) 1)) {
