...
public class Class14 {
	...
	public static String method192(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1) {
		...
		return arg1 == 3 ? Class474.method29666(arg0, arg1) : Integer.toString(local5 / 10) + local5 % 10 + "-" + Class69.aStringArrayArray1[arg1][local9] + "-" + local13;
	}

	@OriginalMember(owner = "client!aal", name = "n", descriptor = "(IIZI)I", line = 37)
	public static int method193(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
	...
	static final void method195(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = ((Class47) Class277.aClass32_Sub12_1.method18261(local12)).anInt139 * 415441565;
	}

	@OriginalMember(owner = "client!aal", name = "aow", descriptor = "(Lclient!yf;I)V", line = 12427)
	static final void method194(@OriginalArg(0) Class681 arg0) {
		if (!Class65.aClass123_Sub1_2.method8986().method27463()) {
			throw new RuntimeException();
		}
		@Pc(14) Class25_Sub4 local14 = (Class25_Sub4) Class65.aClass123_Sub1_2.method9040();
		local14.method23138(Class382.aClass479_2, -1, 0.0F);
