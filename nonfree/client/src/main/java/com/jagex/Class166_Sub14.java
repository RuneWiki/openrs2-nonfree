...
public class Class166_Sub14 extends Class166 {
	...
	public void method15651(@OriginalArg(0) byte arg0) {
		...
		if (this.aClass93_Sub36_49.method14365(102373484).method146(1460961200)) {
			...
			this.anInt2379 = this.method16542((byte) -71) * -88839937;
		}
	}
	...
	public boolean method15653(@OriginalArg(0) byte arg0) {
	...
	public int method15654(@OriginalArg(0) int arg0) {
	...
	public int method16543(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.aClass93_Sub36_49.method14359((byte) 77) == Class702.aClass702_6) {
			return arg0 == 0 || this.aClass93_Sub36_49.aClass166_Sub46_1.method16529(-474829767) == 1 ? 1 : 2;
		} else {
			return 3;
		}
	}
	...
	public int method16540(@OriginalArg(0) int arg0) {
		if (this.aClass93_Sub36_49.method14359((byte) 43) == Class702.aClass702_6) {
			return arg0 == 0 || this.aClass93_Sub36_49.aClass166_Sub46_1.method16529(-1053561098) == 1 ? 1 : 2;
		} else {
			return 3;
		}
	}
	...
	public void method15655() {
		...
		if (this.aClass93_Sub36_49.method14365(-2000870640).method146(961805517)) {
			if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 2) {
				this.anInt2379 = this.method16542((byte) -59) * -88839937;
			}
		} else if (this.anInt2379 * 960141055 != 0 && this.anInt2379 * 960141055 != 1) {
			this.anInt2379 = this.method16542((byte) -89) * -88839937;
		}
	}
	...
	public void method15656() {
		...
		if (this.aClass93_Sub36_49.method14365(1899037249).method146(-1743622065)) {
			if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 2) {
				this.anInt2379 = this.method16542((byte) -9) * -88839937;
			}
		} else if (this.anInt2379 * 960141055 != 0 && this.anInt2379 * 960141055 != 1) {
			this.anInt2379 = this.method16542((byte) 49) * -88839937;
		}
	}
	...
	public int method16549(@OriginalArg(0) int arg0) {
		if (this.aClass93_Sub36_49.method14359((byte) 121) == Class702.aClass702_6) {
			return arg0 == 0 || this.aClass93_Sub36_49.aClass166_Sub46_1.method16529(359449275) == 1 ? 1 : 2;
		} else {
			return 3;
		}
	}
	...
	public static int method15657(@OriginalArg(0) Class93_Sub1_Sub7 arg0, @OriginalArg(1) int arg1) {
		if (Class454.aBoolean773) {
			...
			if (Class702.method36720(local13, (byte) -106)) {
				return 1;
