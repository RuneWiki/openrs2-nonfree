...
public class Class702 {
	...
	public static Class702 method36718(@OriginalArg(0) int arg0) {
		@Pc(2) Class702[] local2 = Class520.method30343((byte) 32);
	...
	public static Class702 method36719(@OriginalArg(0) int arg0) {
		@Pc(2) Class702[] local2 = Class520.method30343((byte) 94);
		for (@Pc(4) int local4 = 0; local4 < local2.length; local4++) {
			@Pc(12) Class702 local12 = local2[local4];
			if (arg0 == local12.anInt5953 * -1111983921) {
				return local12;
	...
	static boolean method36720(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		return arg0 == 57 || arg0 == 58 || arg0 == 1007 || arg0 == 25 || arg0 == 30;
	}

	@OriginalMember(owner = "client!zd", name = "sk", descriptor = "(Lclient!yf;B)V", line = 8200)
	static final void method36721(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	public static short[] method36722(@OriginalArg(0) short[] arg0, @OriginalArg(1) int arg1) {
		if (arg0 == null) {
			return null;
		} else {
