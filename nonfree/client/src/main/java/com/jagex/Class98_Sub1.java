...
public class Class98_Sub1 extends Class98 implements Interface16 {
	...
	@Override
	public void method2565(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int arg1) {
		this.method2750(arg0, arg1);
	}

	@OriginalMember(owner = "client!aec", name = "m", descriptor = "(I[BI)V", line = 22)
	@Override
	public void method2561(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int arg1) {
		this.method2750(arg0, arg1);
	}

	@OriginalMember(owner = "client!aec", name = "z", descriptor = "(I[BI)V", line = 22)
	@Override
	public void method2560(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int arg1) {
		this.method2750(arg0, arg1);
	}

	@OriginalMember(owner = "client!aec", name = "p", descriptor = "(I[BI)V", line = 22)
	@Override
	public void method2566(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int arg1) {
		this.method2750(arg0, arg1);
	}
}
