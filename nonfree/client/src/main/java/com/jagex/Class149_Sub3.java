...
public class Class149_Sub3 extends Class149 {
	...
	public void method12311(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(3) int local3 = 0;
		for (@Pc(9) Class149_Sub1 local9 = (Class149_Sub1) this.aClass21_2.method390(); local9 != null; local9 = (Class149_Sub1) this.aClass21_2.method377()) {
			local3++;
			if (local9.anInt1399 * 356694381 == arg0) {
				local9.method11773(arg0, arg1, arg2, arg3);
				return;
			}
			if (local9.anInt1399 * 356694381 <= arg0) {
				local1 = local9;
		...
		if (local1 != null) {
			Class94.method1799(new Class149_Sub1(arg0, arg1, arg2, arg3), local1);
			if (local3 >= Class93_Sub26.aClass645_15.anInt5761 * 129922025) {
				this.aClass21_2.method390().method23766();
			}
		} else if (local3 < Class93_Sub26.aClass645_15.anInt5761 * 129922025) {
			this.aClass21_2.method380(new Class149_Sub1(arg0, arg1, arg2, arg3));
		}
	}

	@OriginalMember(owner = "client!aji", name = "n", descriptor = "(IIIIB)V", line = 17)
	public void method12312(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(1) Class149_Sub1 local1 = null;
		@Pc(3) int local3 = 0;
		for (@Pc(9) Class149_Sub1 local9 = (Class149_Sub1) this.aClass21_2.method390(); local9 != null; local9 = (Class149_Sub1) this.aClass21_2.method377()) {
			local3++;
	...
	public Class149_Sub1 method12313(@OriginalArg(0) int arg0) {
		@Pc(5) Class149_Sub1 local5 = (Class149_Sub1) this.aClass21_2.method390();
		if (local5 == null || local5.anInt1399 * 356694381 > arg0) {
			return null;
		}
		for (@Pc(21) Class149_Sub1 local21 = (Class149_Sub1) this.aClass21_2.method377(); local21 != null && local21.anInt1399 * 356694381 <= arg0; local21 = (Class149_Sub1) this.aClass21_2.method377()) {
			local5.method23766();
			local5 = local21;
		}
	...
	public boolean method12314() {
		return this.aClass21_2.method384();
	}
	...
	public boolean method12317() {
		return this.aClass21_2.method384();
	}

	@OriginalMember(owner = "client!aji", name = "d", descriptor = "(ILjava/lang/String;ZS)V", line = 189)
	public static void method12319(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) boolean arg2) {
