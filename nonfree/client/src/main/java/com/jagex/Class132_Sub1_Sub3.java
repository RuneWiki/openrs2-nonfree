...
public abstract class Class132_Sub1_Sub3 extends Class132_Sub1 {
	...
	int method24302(@OriginalArg(0) Class93_Sub16[] arg0) {
		if (this.aBoolean560) {
			...
			this.anInt1441 = this.method24274((int) local6.aFloat317 >> this.aClass585_23.anInt5438 * -358186793, (int) local6.aFloat319 >> this.aClass585_23.anInt5438 * -358186793, this.aClass93_Sub16Array10, 1640818693) * -1538873379;
	...
	boolean method24270(@OriginalArg(0) Class104 arg0, @OriginalArg(1) short arg1) {
		...
		return this.aClass585_23.aClass598_2.method31818(this.aByte99, (int) local3.aFloat317 >> this.aClass585_23.anInt5438 * -358186793, (int) local3.aFloat319 >> this.aClass585_23.anInt5438 * -358186793, this.method24289((byte) 7));
	}
	...
	int method24309(@OriginalArg(0) Class93_Sub16[] arg0, @OriginalArg(1) short arg1) {
		if (this.aBoolean560) {
			@Pc(6) Class472 local6 = this.method24229().aClass472_61;
			this.anInt1441 = this.method24274((int) local6.aFloat317 >> this.aClass585_23.anInt5438 * -358186793, (int) local6.aFloat319 >> this.aClass585_23.anInt5438 * -358186793, this.aClass93_Sub16Array10, 2072930422) * -1538873379;
			this.aBoolean560 = false;
		}
		for (@Pc(38) int local38 = 0; local38 < this.anInt1441 * 186247285; local38++) {
			arg0[local38] = this.aClass93_Sub16Array10[local38];
	...
	int method24264(@OriginalArg(0) Class93_Sub16[] arg0) {
		if (this.aBoolean560) {
			@Pc(6) Class472 local6 = this.method24229().aClass472_61;
			this.anInt1441 = this.method24274((int) local6.aFloat317 >> this.aClass585_23.anInt5438 * -358186793, (int) local6.aFloat319 >> this.aClass585_23.anInt5438 * -358186793, this.aClass93_Sub16Array10, 2024191788) * -1538873379;
			this.aBoolean560 = false;
		}
		for (@Pc(38) int local38 = 0; local38 < this.anInt1441 * 186247285; local38++) {
			arg0[local38] = this.aClass93_Sub16Array10[local38];
	...
	boolean method24304(@OriginalArg(0) Class104 arg0) {
		@Pc(3) Class472 local3 = this.method24229().aClass472_61;
		return this.aClass585_23.aClass598_2.method31818(this.aByte99, (int) local3.aFloat317 >> this.aClass585_23.anInt5438 * -358186793, (int) local3.aFloat319 >> this.aClass585_23.anInt5438 * -358186793, this.method24289((byte) -124));
	}
