...
public class Class201 {
	...
	Class88_Sub2 method24631(@OriginalArg(0) Class235 arg0) {
		return this.method24633(arg0, arg0.anInt3806 * -923926085);
	}

	@OriginalMember(owner = "client!ca", name = "w", descriptor = "(Lclient!dv;)Lclient!adt;", line = 21)
	Class88_Sub2 method24635(@OriginalArg(0) Class235 arg0) {
		return this.method24633(arg0, arg0.anInt3806 * -923926085);
	}

	@OriginalMember(owner = "client!ca", name = "l", descriptor = "(Lclient!dv;)Lclient!adt;", line = 21)
	Class88_Sub2 method24636(@OriginalArg(0) Class235 arg0) {
		return this.method24633(arg0, arg0.anInt3806 * -923926085);
	}

	@OriginalMember(owner = "client!ca", name = "e", descriptor = "(Lclient!dv;)Lclient!adt;", line = 21)
	Class88_Sub2 method24639(@OriginalArg(0) Class235 arg0) {
		return this.method24633(arg0, arg0.anInt3806 * -923926085);
	}

	@OriginalMember(owner = "client!ca", name = "n", descriptor = "(Lclient!dv;I)Lclient!adt;", line = 25)
	Class88_Sub2 method24633(@OriginalArg(0) Class235 arg0, @OriginalArg(1) int arg1) {
		@Pc(9) Class88_Sub2 local9 = (Class88_Sub2) this.aClass240_65.method25839((long) (arg0.anInt3787 * 595186169));
		if (local9 != null) {
			return local9;
		} else if (this.method24632(Class616.aClass616_2, arg0, arg1)) {
			if (arg1 == -1) {
				arg1 = arg0.anInt3806 * -923926085;
			}
			@Pc(93) Class88_Sub2 local93;
			if (arg0.aBoolean655 && this.aClass104_Sub1_44.method20541()) {
				@Pc(112) float[] local112 = this.anInterface24_7.method6766(Class616.aClass616_2, arg0.anInt3788 * -1747960127, arg0.anInt3769 * -764718997, 0.7F, arg1, arg1);
				...
				if (arg0.aClass618_2 == Class618.aClass618_5 && Class588.method31649(arg0.aByte114)) {
					local59 = this.anInterface24_7.method6764(Class616.aClass616_2, arg0.anInt3788 * -1747960127, 0.7F, arg1, arg1);
				} else {
					local59 = this.anInterface24_7.method6780(Class616.aClass616_2, arg0.anInt3788 * -1747960127, 0.7F, arg1, arg1);
				}
				local93 = new Class88_Sub2(this.aClass104_Sub1_44, 3553, arg1, arg1, arg0.aByte119 != 0, local59, 0, 0, false);
			}
			local93.method18080(arg0.aByte113 == 1, arg0.aByte120 == 1);
			this.aClass240_65.method25831(local93, (long) (arg0.anInt3787 * 595186169), arg1 * arg1);
			return local93;
		} else {
			return null;
		}
	...
	Class88_Sub2 method24638(@OriginalArg(0) Class235 arg0, @OriginalArg(1) int arg1) {
		@Pc(9) Class88_Sub2 local9 = (Class88_Sub2) this.aClass240_65.method25839((long) (arg0.anInt3787 * 595186169));
		if (local9 != null) {
			return local9;
		} else if (this.method24632(Class616.aClass616_2, arg0, arg1)) {
	...
	boolean method24630(@OriginalArg(0) Class616 arg0, @OriginalArg(1) Class235 arg1, @OriginalArg(2) int arg2) {
		if (arg2 == -1) {
			arg2 = arg1.anInt3806 * -923926085;
		}
		if (arg1.aBoolean655 && this.aClass104_Sub1_44.method20541()) {
			return this.anInterface24_7.method6765(arg0, arg1.anInt3788 * -1747960127, arg1.anInt3769 * -764718997, Class609.aClass609_3, 0.7F, arg2, arg2);
		} else if (arg1.aClass618_2 == Class618.aClass618_5 && Class588.method31649(arg1.aByte114)) {
			return this.anInterface24_7.method6765(arg0, arg1.anInt3788 * -1747960127, -1, Class609.aClass609_1, 0.7F, arg2, arg2);
		} else {
			return this.anInterface24_7.method6765(arg0, arg1.anInt3788 * -1747960127, -1, Class609.aClass609_2, 0.7F, arg2, arg2);
		}
	}

	@OriginalMember(owner = "client!ca", name = "m", descriptor = "(Lclient!vk;Lclient!dv;I)Z", line = 50)
	boolean method24632(@OriginalArg(0) Class616 arg0, @OriginalArg(1) Class235 arg1, @OriginalArg(2) int arg2) {
		if (arg2 == -1) {
			arg2 = arg1.anInt3806 * -923926085;
		}
		if (arg1.aBoolean655 && this.aClass104_Sub1_44.method20541()) {
	...
	boolean method24640(@OriginalArg(0) Class616 arg0, @OriginalArg(1) Class235 arg1, @OriginalArg(2) int arg2) {
		if (arg2 == -1) {
			arg2 = arg1.anInt3806 * -923926085;
		}
		if (arg1.aBoolean655 && this.aClass104_Sub1_44.method20541()) {
	...
	void method24637() {
		this.aClass240_65.method25832(5);
	}
