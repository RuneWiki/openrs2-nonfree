...
public class Class29 {
	...
	static final boolean method604(@OriginalArg(0) Class32_Sub14 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		return local5.method31978(arg2, (byte) -74);
	}

	@OriginalMember(owner = "client!abb", name = "gr", descriptor = "(IIIIIB)V", line = 3741)
	public static final void method605(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) byte arg5) {
		...
		if (Class429.anInt4781 * -1453926679 == 3) {
			Class593.method31722((short) 6634);
		}
		if (Class174.anInt3297 * -283420141 >= 100) {
			...
			@Pc(55) int local55 = Class305.method26801(local37, local43, Class512.anInt5209 * 1177442423, (byte) -49) - Class290.anInt3911 * -1980774829;
