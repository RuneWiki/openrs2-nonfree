...
public class Class263 implements Interface13 {
	...
	void method26186(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		@Pc(6) int local6;
		@Pc(12) int local12;
		if (arg1 == 1) {
			...
			for (local12 = 0; local12 < local6; local12++) {
				this.anIntArray369[local12] = arg0.method22415();
			}
			this.anIntArray364 = new int[local6];
			for (local12 = 0; local12 < local6; local12++) {
				this.anIntArray364[local12] = arg0.method22415();
			}
			for (local12 = 0; local12 < local6; local12++) {
				this.anIntArray364[local12] += arg0.method22415() << 16;
			}
		} else if (arg1 == 2) {
			this.anInt3872 = arg0.method22415() * -1161582777;
		} else if (arg1 == 5) {
			this.anInt3873 = arg0.method22413() * -1347406549;
		} else if (arg1 == 6) {
			this.anInt3874 = arg0.method22415() * -7880353;
		} else if (arg1 == 7) {
			this.anInt3875 = arg0.method22415() * 881615215;
		} else if (arg1 == 8) {
			this.anInt3870 = arg0.method22413() * -1497687351;
		} else if (arg1 == 9) {
			this.anInt3867 = arg0.method22413() * 2085860811;
		} else if (arg1 == 10) {
			this.anInt3876 = arg0.method22413() * 156802381;
		} else if (arg1 == 11) {
			this.anInt3868 = arg0.method22413() * -1406573031;
			...
			for (local12 = 0; local12 < local6; local12++) {
				this.anIntArray365[local12] = arg0.method22415();
			}
			for (local12 = 0; local12 < local6; local12++) {
				this.anIntArray365[local12] += arg0.method22415() << 16;
			}
		} else {
			@Pc(249) int local249;
			if (arg1 == 13) {
				...
				for (local12 = 0; local12 < local6; local12++) {
					@Pc(230) int local230 = arg0.method22413();
					if (local230 > 0) {
						this.anIntArrayArray47[local12] = new int[local230];
						this.anIntArrayArray47[local12][0] = arg0.method22417();
						for (local249 = 1; local249 < local230; local249++) {
							this.anIntArrayArray47[local12][local249] = arg0.method22415();
						}
					}
				}
			} else if (arg1 == 14) {
				...
				if (arg1 == 19 || arg1 == 119) {
					...
					this.anIntArray366[local6] = arg0.method22413();
					...
					this.anIntArray367[local6] = arg0.method22415();
					this.anIntArray368[local6] = arg0.method22415();
				} else if (arg1 == 22) {
					this.anInt3877 = arg0.method22413() * -1199931741;
				} else if (arg1 == 23) {
					arg0.method22415();
				} else if (arg1 == 24) {
					this.anInt3879 = arg0.method22415() * -1103879291;
					if (this.aClass117_1 != null) {
						this.aClass268_1 = (Class268) this.aClass117_1.anInterface11_4.method18261(this.anInt3879 * -421372595);
					}
				} else if (arg1 == 25) {
					this.anInt3878 = arg0.method22415() * 2036536913;
				} else if (arg1 == 249) {
					local6 = arg0.method22413();
					...
					for (local12 = 0; local12 < local6; local12++) {
						@Pc(498) boolean local498 = arg0.method22413() == 1;
						local249 = arg0.method22417();
						@Pc(511) Class93 local511;
						if (local498) {
							local511 = new Class93_Sub15(arg0.method22427());
						} else {
							local511 = new Class93_Sub14(arg0.method22419());
						}
	...
	static Class218 method26198(@OriginalArg(0) int arg0) {
	...
	public boolean method26185() {
		...
		if (this.anIntArray364 != null) {
			...
			for (@Pc(21) int local21 = 0; local21 < local19.length; local21++) {
				...
				if (this.aClass117_1.method8378(local29 >>> 16) == null) {
					local13 = false;
				}
			}
		} else if (this.aClass117_1.method8368(this.anInt3878 * -153750863) == null) {
			local13 = false;
		}
		return local13;
	}
	...
	public int method26184(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.aClass16_26 == null) {
			return arg1;
		} else {
	...
	public String method26192(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1) {
		if (this.aClass16_26 == null) {
			return arg1;
		} else {
			@Pc(12) Class93_Sub15 local12 = (Class93_Sub15) this.aClass16_26.method215((long) arg0);
