...
public class Class106_Sub2 extends Class106 {
	...
	Class106_Sub2(@OriginalArg(0) Class104_Sub3 arg0, @OriginalArg(1) Class5 arg1, @OriginalArg(2) Class105_Sub1 arg2) {
		...
		for (local20 = 0; local20 < 256; local20++) {
			local28 = this.aClass5_10.method62(local20);
			@Pc(96) int local96 = this.aClass5_10.method33(local20);
			@Pc(102) short[] local102 = this.aClass5_10.method65(local20);
			...
			this.aClass100Array2[local20] = this.aClass104_Sub3_4.method20487(local115, 0, local28, local28, local96, false);
			this.aClass100Array3[local20] = this.aClass104_Sub3_4.method20487(local168, 0, local28, local28, local96, false);
		}
	}
	...
	void method7549(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		...
		@Pc(13) int local13 = arg2 + this.aClass5_10.method64(arg0);
		if (arg4) {
			this.aClass100Array3[arg0].method18173(arg1, local13, 1, arg3, 1);
		} else {
			this.aClass100Array2[arg0].method18173(arg1, local13, 1, arg3, 1);
		}
	}
