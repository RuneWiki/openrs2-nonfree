...
public class Class138 implements Interface75 {
	...
	public Object method11521(@OriginalArg(0) Class108 arg0, @OriginalArg(1) byte arg1) {
		return arg0.aBoolean173 ? this.method11522(arg0, 27720345) : arg0.aClass519_6.method30317(657683700);
	}
	...
	Object method11522(@OriginalArg(0) Class108 arg0, @OriginalArg(1) int arg1) {
		return arg0.aClass519_6.method30317(657683700);
	}
	...
	static final void method11534(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class681 arg1, @OriginalArg(2) byte arg2) {
		@Pc(12) int local12 = arg1.anIntArray519[(arg1.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 829506846);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		if (arg0) {
			Class240.method25871(local22, local16, (short) -15699);
		} else {
			Class337.method27460(local22, local16, 2136484877);
		}
	}

	@OriginalMember(owner = "client!qe", name = "aoa", descriptor = "(Lclient!yf;I)V", line = 12587)
	static final void method11535(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) throws Exception_Sub3 {
	...
	static final void method11536(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5891 -= -1915563430;
	...
	public static void method11537(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		if (arg0) {
			if (client.anInt3526 * -703563959 != -1) {
				Class535.method30753(client.anInt3526 * -703563959, 2123689163);
			}
			...
			Class361.method27802((byte) -46);
			client.anInt3526 = Class93_Sub26.aClass645_15.anInt5766 * 1630912889;
			if (client.anInt3526 * -703563959 != -1) {
				Class618.method32101(false, -1814616275);
				Class635.method32441((short) 255);
				Class56.method18036(client.anInt3526 * -703563959, (int[]) null, -311790733);
			}
		}
		Class692.method36598((byte) -40);
		Class65.aClass123_Sub1_2.method8923(true, (byte) -25);
		Class411.aBoolean752 = false;
		Class548.method31013((byte) 1);
		client.anInt3520 = 410366683;
		Class696.method36650(client.anInt3555 * 225035861, 785682939);
		Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3 = new Class132_Sub1_Sub1_Sub1_Sub2((Class585) null);
		client.aMap18.clear();
		Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.method24231((float) (client.aClass532_1.method30444(750691944) * 512 / 2), 0.0F, (float) (client.aClass532_1.method30474((short) 128) * 512 / 2));
		Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.anIntArray240[0] = client.aClass532_1.method30444(668145533) / 2;
		Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.anIntArray239[0] = client.aClass532_1.method30474((short) 128) / 2;
		...
		if (Class429.anInt4781 * -1453926679 == 5) {
			...
			Class631.method32283(1251129319);
		}
		client.aClass532_1.method30532((byte) 16).method33003(1086101290);
	}
	...
	static final void method11539(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		Class373.method28022(1643192011);
	}
}
