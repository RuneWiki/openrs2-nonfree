...
public class class836 extends class104 {
	...
	public void method1555() {
		...
		if ((this.field9481 & 0x2) == 0) {
			this.field9451 = (int[][][]) null;
			this.field9464 = (int[][][]) null;
			this.field9462 = (int[][][]) null;
		}
		this.field9467 = (int[][][]) null;
		this.field9463 = (int[][][]) null;
		this.field9473 = (int[][][]) null;
		this.field9461 = (class970[][][]) null;
		this.field9479 = (byte[][]) null;
		this.field9483 = null;
		this.field9482 = (float[][]) null;
		this.field9458 = (float[][]) null;
		this.field9469 = (float[][]) null;
	}
	...
	public void method15409(int arg0, int arg1, int arg2, boolean[][] arg3, boolean arg4, int arg5) {
		...
		if (!this.field9470.method14164()) {
			...
			this.field9453.method15777((class70) null);
		...
		this.field9453.method15809(this.field9456, (class83) null, (class83) null, this.field9476);
