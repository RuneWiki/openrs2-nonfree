...
public class Class93_Sub31_Sub4 extends Class93_Sub31 {
	...
	@Override
	void method22011(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		arg0.method22413((short) 16384);
		this.anInt3044 = arg0.method22415(-1434290800) * 630853483;
		this.aByte86 = arg0.method22414(467007568);
		this.anInt3043 = arg0.method22415(-1434290800) * -838446601;
		arg0.method22423(-1283499375);
		this.aString104 = arg0.method22427(-6221050);
		arg0.method22413((short) 16384);
	}

	@OriginalMember(owner = "client!arv", name = "n", descriptor = "(Lclient!akr;S)V", line = 142)
	@Override
	void method22007(@OriginalArg(0) Class93_Sub28 arg0, @OriginalArg(1) short arg1) {
	...
	void method22006(@OriginalArg(0) Class93_Sub41 arg0) {
		arg0.method22413((short) 16384);
		this.anInt3044 = arg0.method22415(-1434290800) * 630853483;
		this.aByte86 = arg0.method22414(1345582618);
		this.anInt3043 = arg0.method22415(-1434290800) * -838446601;
		arg0.method22423(-86909010);
		this.aString104 = arg0.method22427(-228056302);
		arg0.method22413((short) 16384);
	}
	...
	public static void method21950(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) String arg4, @OriginalArg(5) int arg5) {
		...
		local11.aClass93_Sub41_Sub2_1.method22454(0, 2127138865);
		@Pc(22) int local22 = local11.aClass93_Sub41_Sub2_1.anInt3070 * 212851357;
		local11.aClass93_Sub41_Sub2_1.method22402(arg0, -1779450730);
		local11.aClass93_Sub41_Sub2_1.method22402(arg1, 119662850);
		local11.aClass93_Sub41_Sub2_1.method22510(arg2, (byte) -95);
		local11.aClass93_Sub41_Sub2_1.method22510(arg3 ? 1 : 0, (byte) -72);
		local11.aClass93_Sub41_Sub2_1.method22402(arg4, 947002394);
		local11.aClass93_Sub41_Sub2_1.anInt3070 += -1529454093;
		local11.aClass93_Sub41_Sub2_1.method22441(Class676.anIntArray516, local22, local11.aClass93_Sub41_Sub2_1.anInt3070 * 212851357, (byte) -51);
		local11.aClass93_Sub41_Sub2_1.method22407(local11.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local22, -1971347959);
		client.aClass175_1.method24351(local11, -1906063728);
		if (arg2 < 13) {
