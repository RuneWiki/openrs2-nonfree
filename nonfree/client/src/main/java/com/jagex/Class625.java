...
public class Class625 {
	...
	static void method32161() {
		if (aClass100_51 != null && aClass100_51.method18189() == aTwitchWebcamFrameData1.width && aClass100_51.method18165() == aTwitchWebcamFrameData1.height) {
			aClass100_51.method18199(0, 0, aTwitchWebcamFrameData1.width, aTwitchWebcamFrameData1.height, aTwitchWebcamFrameData1.buffer, 0, aTwitchWebcamFrameData1.width);
		} else {
			aClass100_51 = Class694.aClass104_14.method20487(aTwitchWebcamFrameData1.buffer, 0, aTwitchWebcamFrameData1.width, aTwitchWebcamFrameData1.width, aTwitchWebcamFrameData1.height, false);
		}
	}
	...
	public static void method32163(@OriginalArg(0) boolean arg0) {
	}
	...
	public static void method32166() {
		anInt5697 = 2118100395;
	}

	@OriginalMember(owner = "client!vv", name = "af", descriptor = "()I", line = 81)
	public static int method32167() {
	...
	public static int method32171(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
	...
	public static void method32172(@OriginalArg(0) boolean arg0) {
	}

	@OriginalMember(owner = "client!vv", name = "bs", descriptor = "()V", line = 240)
	static void method32173() {
		aBoolean849 = false;
	...
	public static int method32175(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		if (arg0 != 0 && (arg0 < 50 || arg0 > 100)) {
			arg0 = 0;
		}
		if (arg1 != 0 && (arg1 < 50 || arg1 > 100)) {
	...
	static int method32176() {
		...
		try {
			for (local1 = 0; local1 < aStringArray33.length; local1++) {
				if (aStringArray33[local1] != null && aBooleanArray33[local1]) {
					Class376.method28046(672839876).method31617(aStringArray33[local1], (byte) -14);
				}
			}
		...
		if (local1 == 0) {
			...
			Class646.method32610(10 + Class430.aString204 + local1, new RuntimeException(), 1781592432);
		}
		return 2;
	}
	...
	static int method32177() {
		...
		try {
			for (local1 = 0; local1 < aStringArray33.length; local1++) {
				if (aStringArray33[local1] != null && aBooleanArray33[local1]) {
					Class376.method28046(672839876).method31617(aStringArray33[local1], (byte) -39);
				}
			}
		} catch (@Pc(25) Exception_Sub1 local25) {
			return 3;
		...
		if (local1 == 0) {
			...
			Class646.method32610(10 + Class430.aString204 + local1, new RuntimeException(), 772298247);
		}
		return 2;
	}

	@OriginalMember(owner = "client!vv", name = "bb", descriptor = "()I", line = 198)
	public static int method32178() {
		if (aBoolean848) {
	...
	public static int method32179(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1) {
		if (aBoolean848) {
			return Class330.method27372(-1844262649) == client.aClass175_2 ? Class166_Sub13.aTwitchTV1.Login(arg0, arg1) : 42;
		} else {
			return 12;
		}
	}
	...
	public static int method32182() {
		return Class361.method27803(862937808) ? anInt5694 * 749355381 : 0;
	}

	@OriginalMember(owner = "client!vv", name = "bj", descriptor = "(Lclient!dh;)I", line = 235)
	public static int method32183(@OriginalArg(0) Class104 arg0) {
		Class312.method26922(279615937);
	...
	static int method32189() {
		@Pc(1) int local1;
		try {
			for (local1 = 0; local1 < aStringArray33.length; local1++) {
				if (aStringArray33[local1] != null && aBooleanArray33[local1]) {
					Class376.method28046(672839876).method31617(aStringArray33[local1], (byte) 10);
				}
			}
		} catch (@Pc(25) Exception_Sub1 local25) {
			return 3;
		...
		if (local1 == 0) {
			...
			Class646.method32610(10 + Class430.aString204 + local1, new RuntimeException(), 992044427);
		}
		return 2;
	}
	...
	public static boolean method32191() {
	...
	public static int method32192(@OriginalArg(0) Class104 arg0) {
		Class312.method26922(-977516771);
		return Class166_Sub13.aTwitchTV1.StopStreaming();
	}
	...
	public static int method32193(@OriginalArg(0) Class104 arg0) {
		Class312.method26922(-170639724);
		return Class166_Sub13.aTwitchTV1.StopStreaming();
	}

	@OriginalMember(owner = "client!vv", name = "bm", descriptor = "()I", line = 194)
	public static int method32194() {
		return Class166_Sub13.aTwitchTV1.GetLoginState();
	}

	@OriginalMember(owner = "client!vv", name = "cy", descriptor = "(Lclient!dh;JII)V", line = 337)
	public static void method32195(@OriginalArg(0) Class104 arg0, @OriginalArg(1) long arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(9) int local9;
		if (arg0.method20659() && arg0.method20801() > -1) {
			...
			if (local11 != null && local11.anInt5701 * -471012383 == local9) {
				...
				if (local11.aLinkedList8.isEmpty() && arg0.method20452()) {
					...
					local64 = Class166_Sub13.aTwitchTV1.SubmitFrame(local55, arg0.method20603(), aBoolean850, arg2, arg3);
					...
					Class347.method27610(Class364.anIntArray427, local11.aLinkedList8, local11.anInt5703 * 2135765083, local11.anInt5702 * 430444085, local11.aFloat338, 1174492281);
		...
		if (arg0.method20659()) {
			...
			arg0.method20502();
			arg0.method20459(Class314.anInt4063 * 1161430833, Class17.anInt60 * -1559495963, Class364.anIntArray427, Class183.anIntArray293);
			Class347.method27610(Class364.anIntArray427, aLinkedList7, arg0.anInt2899 * 1081362515, arg0.anInt2903 * -779214253, arg0.aFloat199, 808916729);
	...
	public static void method32198(@OriginalArg(0) boolean arg0) {
		if (arg0 != aBoolean850) {
			Class312.method26922(-732782839);
			aBoolean850 = arg0;
		}
	}
	...
	public static void method32200(@OriginalArg(0) Class104 arg0, @OriginalArg(1) long arg1) {
		...
		if (anInt5696 * 908241389 == 1) {
			...
			for (local29 = 0; local29 < aStringArray33.length; local29++) {
				if (aStringArray33[local29] == null) {
					...
					try {
						local27 += Class125_Sub1.aClass586_1.method31626(aStringArray33[local29], false, -570057832);
					} catch (@Pc(49) Exception_Sub5 local49) {
						Class166_Sub6.method15481(Class72.aClass72_1, local49.aString65, local49.anInt2491 * 1562390493, local49.getCause(), 1009876518);
			...
			anInt5696 = Class535.method30754(-709694321) * 756685797;
		...
		if (local93 != null) {
			for (local29 = 0; local29 < local93.length; local29++) {
				...
				if (local106 != null && Class490.method29978(local106, arg1)) {
	...
	public static int method32201(@OriginalArg(0) String arg0) {
		return Class166_Sub13.aTwitchTV1.SetStreamTitle(arg0, client.aClass702_4.aString242);
	}

	@OriginalMember(owner = "client!vv", name = "cr", descriptor = "(Lclient!dh;J)V", line = 282)
	public static void method32202(@OriginalArg(0) Class104 arg0, @OriginalArg(1) long arg1) {
		if (anInt5696 * 908241389 == 3 || anInt5696 * 908241389 == 0) {
			return;
		}
		@Pc(29) int local29;
		if (anInt5696 * 908241389 == 1) {
			...
			for (local29 = 0; local29 < aStringArray33.length; local29++) {
				if (aStringArray33[local29] == null) {
					...
					try {
						local27 += Class125_Sub1.aClass586_1.method31626(aStringArray33[local29], false, -2078688690);
					} catch (@Pc(49) Exception_Sub5 local49) {
						Class166_Sub6.method15481(Class72.aClass72_1, local49.aString65, local49.anInt2491 * 1562390493, local49.getCause(), 1267932758);
						anInt5696 = -2024909905;
						return;
					}
				}
	...
	public static int method32205(@OriginalArg(0) String arg0) {
		return Class166_Sub13.aTwitchTV1.ChatSendMessage(arg0);
	}
	...
	static boolean method32207(@OriginalArg(0) TwitchEvent arg0, @OriginalArg(1) long arg1) {
		if (!aBoolean846) {
		...
		if (arg0.eventType != 33) {
			if (arg0.eventType == 30) {
				...
				if (local18 == 0 || local18 == 1) {
					Class387.method28242((short) -6171);
				} else if (local18 == 2) {
					aLong291 = arg1 * 273097735325007225L;
				}
			}
			if (arg0.eventType == 34) {
				...
				Class670.method32959(34, 0, (byte) 29);
			}
			return true;
			...
			if (local23 == 0) {
				...
				Class491.method29979((byte) 119);
				aLong291 = arg1 * 273097735325007225L;
				Class670.method32959(33, 0, (byte) 82);
			} else {
				aClass100_51 = null;
			}
			return false;
		...
		if (anInt5696 * 908241389 == 1) {
			...
			for (local29 = 0; local29 < aStringArray33.length; local29++) {
				if (aStringArray33[local29] == null) {
					...
					try {
						local27 += Class125_Sub1.aClass586_1.method31626(aStringArray33[local29], false, 432382625);
					} catch (@Pc(49) Exception_Sub5 local49) {
						Class166_Sub6.method15481(Class72.aClass72_1, local49.aString65, local49.anInt2491 * 1562390493, local49.getCause(), 1487786762);
						anInt5696 = -2024909905;
						return;
					}
				}
		...
		if (anInt5696 * 908241389 == 1) {
			...
			for (local29 = 0; local29 < aStringArray33.length; local29++) {
				if (aStringArray33[local29] == null) {
					...
					try {
						local27 += Class125_Sub1.aClass586_1.method31626(aStringArray33[local29], false, -1325315785);
					} catch (@Pc(49) Exception_Sub5 local49) {
						Class166_Sub6.method15481(Class72.aClass72_1, local49.aString65, local49.anInt2491 * 1562390493, local49.getCause(), -507667428);
						anInt5696 = -2024909905;
						return;
					}
				}
	...
	public static void method32213(@OriginalArg(0) Class104 arg0, @OriginalArg(1) long arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		if (arg0.method20659() && arg0.method20801() > -1) {
			...
			if (local11 != null && local11.anInt5701 * -471012383 == local9) {
				...
				if (local11.aLinkedList8.isEmpty() && arg0.method20452()) {
					...
					arg0.method20459(Class314.anInt4063 * 1161430833, Class17.anInt60 * -1559495963, Class364.anIntArray427, Class183.anIntArray293);
					Class347.method27610(Class364.anIntArray427, local11.aLinkedList8, local11.anInt5703 * 2135765083, local11.anInt5702 * 430444085, local11.aFloat338, -231076932);
					local64 = Class166_Sub13.aTwitchTV1.SubmitFrameRaw(Class364.anIntArray427, aBoolean850, arg2, arg3);
				}
				arg0.method20503();
				if (local64 == 2072) {
		...
		if (arg0.method20659()) {
			...
			arg0.method20502();
			arg0.method20459(Class314.anInt4063 * 1161430833, Class17.anInt60 * -1559495963, Class364.anIntArray427, Class183.anIntArray293);
			Class347.method27610(Class364.anIntArray427, aLinkedList7, arg0.anInt2899 * 1081362515, arg0.anInt2903 * -779214253, arg0.aFloat199, 2128073043);
			local9 = Class166_Sub13.aTwitchTV1.SubmitFrameRaw(Class364.anIntArray427, aBoolean850, arg2, arg3);
			arg0.method20503();
			aLinkedList7.clear();
			if (local9 == 2072) {
	...
	public static void method32214(@OriginalArg(0) Class104 arg0, @OriginalArg(1) long arg1) {
		if (anInt5696 * 908241389 == 3 || anInt5696 * 908241389 == 0) {
			return;
		}
		@Pc(29) int local29;
		if (anInt5696 * 908241389 == 1) {
			...
			for (local29 = 0; local29 < aStringArray33.length; local29++) {
				if (aStringArray33[local29] == null) {
					...
					try {
						local27 += Class125_Sub1.aClass586_1.method31626(aStringArray33[local29], false, -1214811439);
					} catch (@Pc(49) Exception_Sub5 local49) {
						Class166_Sub6.method15481(Class72.aClass72_1, local49.aString65, local49.anInt2491 * 1562390493, local49.getCause(), 121675884);
						anInt5696 = -2024909905;
						return;
					}
				}
	...
	public static void method32215(@OriginalArg(0) Class104 arg0, @OriginalArg(1) long arg1) {
		arg0.method20425();
		aLinkedList7.clear();
		aLinkedList6.clear();
	...
	public static int method32218(@OriginalArg(0) String arg0) {
		return Class166_Sub13.aTwitchTV1.SetStreamTitle(arg0, client.aClass702_4.aString242);
	}
	...
	public static boolean method32221() {
		return Class166_Sub13.aTwitchTV1 != null && Class166_Sub13.aTwitchTV1.IsStreaming();
	}
	...
	static boolean method32222(@OriginalArg(0) TwitchEvent arg0, @OriginalArg(1) long arg1) {
		...
		if (arg0.eventType != 33) {
			if (arg0.eventType == 30) {
				local18 = ((TwitchEventResult) arg0).result;
				if (local18 == 0 || local18 == 1) {
					Class387.method28242((short) -21770);
				} else if (local18 == 2) {
					aLong291 = arg1 * 273097735325007225L;
				}
			}
			if (arg0.eventType == 34) {
				Class522.aTwitchEventLiveStreams1 = (TwitchEventLiveStreams) arg0;
				Class670.method32959(34, 0, (byte) 114);
			}
			return true;
		} else if (aTwitchWebcamFrameData1 == null) {
			return false;
			...
			if (local23 == 0) {
				...
				Class491.method29979((byte) 113);
				aLong291 = arg1 * 273097735325007225L;
				Class670.method32959(33, 0, (byte) 25);
			} else {
				aClass100_51 = null;
			}
			return false;
	...
	static boolean method32223(@OriginalArg(0) TwitchEvent arg0, @OriginalArg(1) long arg1) {
		...
		if (arg0.eventType != 33) {
			if (arg0.eventType == 30) {
				local18 = ((TwitchEventResult) arg0).result;
				if (local18 == 0 || local18 == 1) {
					Class387.method28242((short) -5946);
				} else if (local18 == 2) {
					aLong291 = arg1 * 273097735325007225L;
				}
			}
			if (arg0.eventType == 34) {
				Class522.aTwitchEventLiveStreams1 = (TwitchEventLiveStreams) arg0;
				Class670.method32959(34, 0, (byte) 111);
			}
			return true;
		} else if (aTwitchWebcamFrameData1 == null) {
			return false;
			...
			if (local23 == 0) {
				...
				Class491.method29979((byte) 100);
				aLong291 = arg1 * 273097735325007225L;
				Class670.method32959(33, 0, (byte) 15);
			} else {
				aClass100_51 = null;
			}
			return false;
	...
	public static Class100 method32224() {
		return aClass100_51;
	}

	@OriginalMember(owner = "client!vv", name = "bh", descriptor = "()I", line = 94)
	public static int method32225() {
	...
	public static int method32226(@OriginalArg(0) int arg0) {
	...
	public static void method32227(@OriginalArg(0) Class104 arg0, @OriginalArg(1) long arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(9) int local9;
		if (arg0.method20659() && arg0.method20801() > -1) {
			local9 = arg0.method20801();
			@Pc(11) Class626 local11 = null;
			...
			if (local11 != null && local11.anInt5701 * -471012383 == local9) {
				...
				if (local11.aLinkedList8.isEmpty() && arg0.method20452()) {
					...
					arg0.method20459(Class314.anInt4063 * 1161430833, Class17.anInt60 * -1559495963, Class364.anIntArray427, Class183.anIntArray293);
					Class347.method27610(Class364.anIntArray427, local11.aLinkedList8, local11.anInt5703 * 2135765083, local11.anInt5702 * 430444085, local11.aFloat338, 20290992);
					local64 = Class166_Sub13.aTwitchTV1.SubmitFrameRaw(Class364.anIntArray427, aBoolean850, arg2, arg3);
				}
				arg0.method20503();
				if (local64 == 2072) {
		...
		if (arg0.method20659()) {
			...
			arg0.method20502();
			arg0.method20459(Class314.anInt4063 * 1161430833, Class17.anInt60 * -1559495963, Class364.anIntArray427, Class183.anIntArray293);
			Class347.method27610(Class364.anIntArray427, aLinkedList7, arg0.anInt2899 * 1081362515, arg0.anInt2903 * -779214253, arg0.aFloat199, 397757142);
			local9 = Class166_Sub13.aTwitchTV1.SubmitFrameRaw(Class364.anIntArray427, aBoolean850, arg2, arg3);
			arg0.method20503();
			aLinkedList7.clear();
			if (local9 == 2072) {
	...
	static final void method32237(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1358812496);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class281.method26462(local16, local22, arg0, 1982931620);
	}

	@OriginalMember(owner = "client!vv", name = "ka", descriptor = "(Lclient!yf;B)V", line = 6813)
	static final void method32238(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final int method32240(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		if (arg0 < 4) {
			return 0;
		} else if (arg0 < 10) {
			return arg0 - 3;
	...
	public static final void method32241(@OriginalArg(0) String arg0, @OriginalArg(1) byte arg1) {
		if (arg0 == null) {
			return;
		}
		...
		for (@Pc(12) int local12 = 0; local12 < client.anInt3444 * 862418793; local12++) {
			...
			if (Class32_Sub10.method17005(arg0, local7, local24, local29, 1889339199)) {
				...
				@Pc(64) Class175 local64 = Class330.method27372(-1534093073);
				@Pc(70) Class93_Sub22 local70 = Class102.method2592(Class446.aClass446_37, local64.aClass24_2, (byte) 5);
				local70.aClass93_Sub41_Sub2_1.method22510(Class46.method894(arg0, -1997823666), (byte) -105);
				local70.aClass93_Sub41_Sub2_1.method22402(arg0, -1783139557);
				local64.method24351(local70, -1947881956);
				break;
			}
		}
	}
	...
	static final void method32242(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
