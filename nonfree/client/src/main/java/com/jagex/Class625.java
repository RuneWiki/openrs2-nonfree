...
public class Class625 {
	...
	static final int method32240(@OriginalArg(0) int arg0) {
		if (arg0 < 4) {
			return 0;
		} else if (arg0 < 10) {
			return arg0 - 3;
	...
	public static void method32172() {
	}
	...
	static int method32176() {
		...
		try {
			for (local1 = 0; local1 < aStringArray33.length; local1++) {
				if (aStringArray33[local1] != null && aBooleanArray33[local1]) {
					Class376.method28046().method31617(aStringArray33[local1]);
				}
			}
		...
		local1 = Class166_Sub13.aTwitchTV1.InitialiseTTV(Class646.method32609());
		if (local1 == 0) {
			aBoolean848 = true;
		} else {
			Class646.method32610(10 + Class430.aString204 + local1, new RuntimeException());
		}
		return 2;
	}
	...
	public static int method32179(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1) {
		if (aBoolean848) {
			return Class330.method27372() == client.aClass175_2 ? Class166_Sub13.aTwitchTV1.Login(arg0, arg1) : 42;
		} else {
			return 12;
		}
	}
	...
	public static int method32178() {
		if (aBoolean848) {
			Class572.method31333(Class694.aClass104_14);
	...
	public static int method32171(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		...
		Class314.method26939("Stream - Input: " + Class553.anInt3408 * -1378711501 + "x" + Class553.anInt3416 * 2091353777 + " (" + local60 + "kbps)" + " => " + "Output: " + local50 + "x" + local54 + " [" + (arg0 == 0 ? "auto" : arg0 + "%") + "] (" + local58 + "kbps [" + (arg1 == 0 ? "auto" : arg1 + "%") + "])");
	...
	public static int method32182() {
		return Class361.method27803() ? anInt5694 * 749355381 : 0;
	}
		...
		if (anInt5696 * 908241389 == 1) {
			...
			for (local29 = 0; local29 < aStringArray33.length; local29++) {
				if (aStringArray33[local29] == null) {
					...
					try {
						local27 += Class125_Sub1.aClass586_1.method31626(aStringArray33[local29], false);
					} catch (@Pc(49) Exception_Sub5 local49) {
						Class166_Sub6.method15481(Class72.aClass72_1, local49.aString65, local49.anInt2491 * 1562390493, local49.getCause());
						anInt5696 = -2024909905;
						return;
					}
				}
			...
			anInt5696 = Class535.method30754() * 756685797;
		...
		if (local93 != null) {
			for (local29 = 0; local29 < local93.length; local29++) {
				...
				if (local106 != null && Class490.method29978(local106, arg1)) {
					...
					if (local116 != null) {
						Class707.method36751(local116.method36920(), local106);
					}
				}
			}
		}
	...
	public static void method32195(@OriginalArg(0) Class104 arg0, @OriginalArg(1) long arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		if (arg0.method20659()) {
			...
			arg0.method20502();
			arg0.method20459(Class314.anInt4063 * 1161430833, Class17.anInt60 * -1559495963, Class364.anIntArray427, Class183.anIntArray293);
			Class347.method27610(Class364.anIntArray427, aLinkedList7, arg0.anInt2899 * 1081362515, arg0.anInt2903 * -779214253, arg0.aFloat199);
	...
	public static final void method32241(@OriginalArg(0) String arg0) {
		if (arg0 == null) {
			return;
		}
		@Pc(7) String local7 = Class82.method1385(arg0, client.aClass83_10);
		if (local7 == null) {
			return;
		}
		for (@Pc(12) int local12 = 0; local12 < client.anInt3444 * 862418793; local12++) {
			...
			@Pc(29) String local29 = Class82.method1385(local24, client.aClass83_10);
			if (Class32_Sub10.method17005(arg0, local7, local24, local29)) {
				...
				@Pc(64) Class175 local64 = Class330.method27372();
				@Pc(70) Class93_Sub22 local70 = Class102.method2592(Class446.aClass446_37, local64.aClass24_2);
				local70.aClass93_Sub41_Sub2_1.method22510(Class46.method894(arg0));
				local70.aClass93_Sub41_Sub2_1.method22402(arg0);
				local64.method24351(local70);
				break;
			}
		}
	}
