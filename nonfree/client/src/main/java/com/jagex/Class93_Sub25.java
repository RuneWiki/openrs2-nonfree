...
public class Class93_Sub25 extends Class93 {
	...
	Class93_Sub25(@OriginalArg(0) int arg0, @OriginalArg(1) byte[] arg1) {
		...
		this.anInt1590 = local11.method22415() * 460052471;
		...
		for (local48 = 0; local48 < this.anInt1590 * 1418467783; local48++) {
			this.anIntArray180[local48] = local11.method22413();
			if (this.anIntArray180[local48] == 6) {
				this.anIntArray180[local48] = 2;
			}
		}
		for (local48 = 0; local48 < this.anInt1590 * 1418467783; local48++) {
			this.aBooleanArray9[local48] = local11.method22413() == 1;
		}
		for (local48 = 0; local48 < this.anInt1590 * 1418467783; local48++) {
			this.anIntArray181[local48] = local11.method22415();
		}
		for (local48 = 0; local48 < this.anInt1590 * 1418467783; local48++) {
			this.anIntArrayArray41[local48] = new int[local11.method22632()];
		}
		@Pc(141) int local141;
		for (local48 = 0; local48 < this.anInt1590 * 1418467783; local48++) {
			for (local141 = 0; local141 < this.anIntArrayArray41[local48].length; local141++) {
				this.anIntArrayArray41[local48][local141] = local11.method22632();
			}
		}
		local48 = local11.method22415();
		this.aClass212Array1 = new Class212[local48];
		local141 = local11.method22413();
		@Pc(175) int local175;
		for (local175 = 0; local175 < local48; local175++) {
			this.aClass212Array1[local175] = new Class212(local141, local11, false);
		}
		local175 = local11.method22482();
		this.anIntArray179 = new int[local175];
		for (@Pc(200) int local200 = 0; local200 < this.anIntArray179.length; local200++) {
			this.anIntArray179[local200] = local11.method22482();
		}
		this.method13788();
	}
