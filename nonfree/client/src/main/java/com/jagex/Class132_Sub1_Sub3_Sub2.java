...
public class Class132_Sub1_Sub3_Sub2 extends Class132_Sub1_Sub3 implements Interface61 {
	...
	public Class132_Sub1_Sub3_Sub2(@OriginalArg(0) Class585 arg0, @OriginalArg(1) Class104 arg1, @OriginalArg(2) Class32_Sub14 arg2, @OriginalArg(3) Class610 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) boolean arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) Class458 arg14) {
		...
		this.aBoolean296 = arg1.method20424() && arg3.aBoolean828 && !this.aBoolean294 && Class51.aClass93_Sub36_1.aClass166_Sub8_1.method15528() != 0;
		this.anInt1442 = arg7 * 1100065999;
		@Pc(69) int local69 = 2048;
		if (arg3.aBoolean842) {
			local69 |= 0x80000;
		}
		@Pc(84) Class34 local84 = this.method12581(arg1, local69, this.aBoolean296);
		if (local84 != null) {
			...
			if (arg3.aBoolean842) {
				...
				if (arg3.aBoolean842) {
					@Pc(115) Class528 local115 = client.aClass532_1.method30438();
	...
	Class109 method12578(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		if (this.aClass109_2 != null && arg0.method20693(this.aClass109_2.method6825(), arg1) == 0) {
			return this.aClass109_2;
		} else {
			@Pc(20) Class34 local20 = this.method12581(arg0, arg1, false);
	...
	Class34 method12579(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		@Pc(9) Class610 local9 = (Class610) this.aClass32_Sub14_3.method18261(this.anInt1443 * 182683471);
		...
		return local9.method31980(arg0, arg1, this.aByte38, this.aByte39, local19, local25, (int) local53.aFloat317, this.anInt1442 * 362273327, (int) local53.aFloat319, arg2, null);
	}

	@OriginalMember(owner = "client!ajk", name = "bv", descriptor = "(Lclient!dh;IZI)Lclient!abg;", line = 85)
	Class34 method12581(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		@Pc(9) Class610 local9 = (Class610) this.aClass32_Sub14_3.method18261(this.anInt1443 * 182683471);
		@Pc(19) Class99 local19;
		@Pc(25) Class99 local25;
		if (this.aBoolean294) {
	...
	public Class600 method24298(@OriginalArg(0) Class104 arg0) {
		...
		if (this.aClass600_4 == null) {
			this.aClass600_4 = Class62.method1154((int) local3.aFloat317, (int) local3.aFloat318, (int) local3.aFloat319, this.method12578(arg0, 0));
		}
	...
	Class573 method24271(@OriginalArg(0) Class104 arg0) {
		...
		@Pc(26) Class573 local26 = Class125_Sub1.method9214(this.aBoolean295);
		@Pc(37) Class463 local37 = ((Class610) this.aClass32_Sub14_3.method18261(this.anInt1443 * 182683471)).aClass463_2;
		if (local37 == null) {
	...
	boolean method24290(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(10) Class463 local10 = ((Class610) this.aClass32_Sub14_3.method18261(this.anInt1443 * 182683471)).aClass463_2;
		if (local10 != null) {
			return arg0.method20490(arg1, arg2, this.method24226(), local10);
		}
		@Pc(27) Class109 local27 = this.method12578(arg0, 131072);
		if (local27 == null) {
			return false;
		} else {
	...
	public void method13421(@OriginalArg(0) Class104 arg0) {
		...
		if (this.aClass93_Sub1_Sub4_2 == null && this.aBoolean296) {
			@Pc(14) Class34 local14 = this.method12581(arg0, 262144, true);
			local23 = (Class93_Sub1_Sub4) (local14 == null ? null : local14.anObject2);
		} else {
			local23 = this.aClass93_Sub1_Sub4_2;
	...
	public void method13422(@OriginalArg(0) Class104 arg0) {
		...
		if (this.aClass93_Sub1_Sub4_2 == null && this.aBoolean296) {
			@Pc(15) Class34 local15 = this.method12581(arg0, 262144, true);
			local24 = (Class93_Sub1_Sub4) (local15 == null ? null : local15.anObject2);
		} else {
			local24 = this.aClass93_Sub1_Sub4_2;
			this.aClass93_Sub1_Sub4_2 = null;
		}
		@Pc(35) Class472 local35 = this.method24229().aClass472_61;
		if (local24 != null) {
			this.aClass585_23.method31543(local24, this.aByte99, (int) local35.aFloat317, (int) local35.aFloat319, null);
		}
	}
	...
	static final void method12585(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
		...
		arg0.anObjectArray7 = Class499.method30148(local13, arg2);
