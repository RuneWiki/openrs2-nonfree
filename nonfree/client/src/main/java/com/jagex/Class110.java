...
public abstract class Class110 {
	...
	static Class110 method20137(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		@Pc(7) Class89 local7 = Class271.method26306(local3, (byte) 10);
	...
	public abstract void method20138(@OriginalArg(0) int arg0);
	...
	Class110(@OriginalArg(0) Class93_Sub41 arg0) {
		this.anInt2820 = arg0.method22415(-1434290800) * -488460739;
	}
	...
	static void method20145(@OriginalArg(0) Class132_Sub1_Sub1_Sub1 arg0, @OriginalArg(1) byte arg1) {
		if (arg0 instanceof Class132_Sub1_Sub1_Sub1_Sub1) {
			...
			if (local5.aClass336_1 != null) {
				Class660.method32821(local5, local5.aByte100 != Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aByte100, 1025965340);
			}
	...
	public static boolean method20146(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2, @OriginalArg(3) short arg3) {
		if (arg1 == 0) {
			try {
	...
	static final void method20147(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class557.aClass297_1.method26620((byte) 61);
	}

	@OriginalMember(owner = "client!ew", name = "hs", descriptor = "(I)V", line = 4672)
	static final void method20148(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = 0;
		@Pc(5) Class585 local5 = client.aClass532_1.method30459(-1073906249);
		for (@Pc(7) int local7 = 0; local7 < client.aClass532_1.method30444(365725241); local7++) {
			for (@Pc(14) int local14 = 0; local14 < client.aClass532_1.method30474((short) 128); local14++) {
	...
	public static final void method20149(@OriginalArg(0) byte arg0) {
		Class115.anImage3 = null;
		Class68.aFont1 = null;
	}

	@OriginalMember(owner = "client!ew", name = "atj", descriptor = "(Lclient!yf;I)V", line = 13321)
	static final void method20150(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
