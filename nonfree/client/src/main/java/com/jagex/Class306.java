...
public class Class306 {
	...
	Class306(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		if (arg0 != null && arg0.aByteArray58 != null) {
			@Pc(16) int local16 = arg0.method22413((short) 16384);
			if (local16 > 0 && local16 <= 1) {
				@Pc(26) int local26 = arg0.method22413((short) 16384);
				for (@Pc(28) int local28 = 0; local28 < local26; local28++) {
					@Pc(35) long local35 = arg0.method22423(-177308755);
					@Pc(39) int local39 = arg0.method22419(-118643075);
	...
	void method26805(@OriginalArg(0) byte arg0) {
		...
		label88: {
			try {
				...
				this.method26807(local15, (byte) 2);
	...
	void method26807(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
		arg0.method22510(1, (byte) -73);
		arg0.method22510(this.aLinkedHashMap1.size(), (byte) -112);
		...
		while (local14.hasNext()) {
			...
			arg0.method22395((Integer) local21.getValue(), (byte) 33);
		}
	}
	...
	void method26809(@OriginalArg(0) Class93_Sub41 arg0) {
		arg0.method22510(1, (byte) -13);
		arg0.method22510(this.aLinkedHashMap1.size(), (byte) -19);
		@Pc(14) Iterator local14 = this.aLinkedHashMap1.entrySet().iterator();
		while (local14.hasNext()) {
			@Pc(21) Entry local21 = (Entry) local14.next();
			arg0.method22399((Long) local21.getKey());
			arg0.method22395((Integer) local21.getValue(), (byte) -17);
		}
	}
	...
	void method26817(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (this.aLinkedHashMap1.size() >= 10 && !this.aLinkedHashMap1.containsKey(arg0)) {
			@Pc(15) Iterator local15 = this.aLinkedHashMap1.entrySet().iterator();
			local15.next();
			local15.remove();
	...
	public static void method26820(@OriginalArg(0) Class104 arg0, @OriginalArg(1) long arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte arg4) {
		@Pc(9) int local9;
		if (arg0.method20659() && arg0.method20801() > -1) {
			...
			if (local11 != null && local11.anInt5701 * -471012383 == local9) {
				...
				if (local11.aLinkedList8.isEmpty() && arg0.method20452()) {
					...
					Class347.method27610(Class364.anIntArray427, local11.aLinkedList8, local11.anInt5703 * 2135765083, local11.anInt5702 * 430444085, local11.aFloat338, 1744135677);
		...
		if (arg0.method20659()) {
			...
			arg0.method20502();
			arg0.method20459(Class314.anInt4063 * 1161430833, Class17.anInt60 * -1559495963, Class364.anIntArray427, Class183.anIntArray293);
			Class347.method27610(Class364.anIntArray427, Class625.aLinkedList7, arg0.anInt2899 * 1081362515, arg0.anInt2903 * -779214253, arg0.aFloat199, 1708086096);
	...
	static final void method26821(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(14) Class312 local14 = Class659.method32805(arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091], -234056249);
	...
	static final void method26822(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		local3.method32027((Class93_Sub30) arg0.anObjectArray45[(arg0.anInt5888 -= 957530791) * 587908375], (byte) 89);
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = local3.method32026((short) 448);
	}

	@OriginalMember(owner = "client!h", name = "n", descriptor = "(II)Ljava/lang/String;", line = 22)
	public static String method26823(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
