...
public abstract class Class147 {
	...
	static final void method12703(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 1;
	}

	@OriginalMember(owner = "client!sr", name = "io", descriptor = "(B)V", line = 5579)
	static final void method12704(@OriginalArg(0) byte arg0) {
		...
		while (local2.hasNext()) {
			...
			if (local12.method24094(943040433)) {
				local9.method23969(-889254931);
				local12.method24096((byte) 106);
			}
		}
	}

	@OriginalMember(owner = "client!sr", name = "afu", descriptor = "(Lclient!yf;I)V", line = 10593)
	static final void method12705(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class498.method30136((char) local12, (byte) 1) ? 1 : 0;
	}
}
