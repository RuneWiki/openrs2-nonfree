...
public class Class151 {
	...
	static void method13981() {
		Class93_Sub1_Sub11.aClass16_17.method219();
		Class93_Sub1_Sub11.aClass18_12.method245();
		Class93_Sub1_Sub11.aClass18_11.method245();
	}

	@OriginalMember(owner = "client!al", name = "m", descriptor = "(IB)Lclient!db;", line = 153)
	static Class222 method13978(@OriginalArg(0) int arg0) {
		@Pc(6) Class222 local6 = (Class222) Class107.method18119(Class596.method31765(), arg0);
		if (local6 == null) {
	...
	static void method13979(@OriginalArg(0) byte[] arg0) {
	...
	static void method13980(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class96 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class100 arg6) {
