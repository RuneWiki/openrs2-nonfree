...
public class Class110_Sub8 extends Class110 {
	...
	Class110_Sub8(@OriginalArg(0) Class93_Sub41 arg0) {
		super(arg0);
		this.anInt912 = arg0.method22415() * 1961320037;
		this.anInt915 = arg0.method22415() * -1795509975;
		this.anInt913 = arg0.method22415() * 567576759;
		this.anInt914 = arg0.method22415() * 34801743;
		this.anInt911 = arg0.method22415() * 2109223857;
		this.anInt916 = arg0.method22415() * -243407281;
	}

	@OriginalMember(owner = "client!age", name = "n", descriptor = "(I)V", line = 26)
	@Override
	public void method20138() {
		Class249.aClass255Array1[this.anInt912 * -378461331].method26003(0);
		Class249.aClass255Array1[this.anInt915 * 200702745].method26003(1);
		client.anInt3486 = 0;
	...
	static final void method7959(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
