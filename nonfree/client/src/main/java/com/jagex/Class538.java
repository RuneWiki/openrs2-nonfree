...
public class Class538 {
	...
	public void method30781(@OriginalArg(0) OutputStream arg0) throws IOException {
		this.method30764();
		this.anOutputStream1 = arg0;
	}

	@OriginalMember(owner = "client!ru", name = "m", descriptor = "(B)V", line = 25)
	public void method30764() throws IOException {
		this.method30779();
	...
	public void method30765(@OriginalArg(0) boolean arg0) {
		if (!arg0) {
			this.anInt5279 = 0;
			this.anInt5278 = 0;
		}
	...
	public void method30779() throws IOException {
		@Pc(9) int local9 = this.anInt5278 * 798090307 - this.anInt5279 * -498353225;
		if (local9 == 0) {
			return;
		}
	...
	public void method30767(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) throws IOException {
	...
	public byte method30762(@OriginalArg(0) int arg0) {
		@Pc(8) int local8 = this.anInt5278 * 798090307 - arg0 - 1;
		if (local8 < 0) {
			local8 += this.anInt5280 * -623853417;
		}
	...
	static final void method30782(@OriginalArg(0) Class681 arg0) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class222.method25582(local11, local14, arg0);
	}

	@OriginalMember(owner = "client!ru", name = "wf", descriptor = "(Lclient!yf;S)V", line = 9038)
	static final void method30783(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class23.method503(local13, local23, false);
	}

	@OriginalMember(owner = "client!ru", name = "adx", descriptor = "(Lclient!yf;I)V", line = 10188)
	static final void method30784(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		@Pc(31) int local31 = client.aClass531ArrayArray1[local23][local13].method30426();
