...
public class Class538 {
	...
	public byte method30762(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public void method30763(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public void method30764(@OriginalArg(0) byte arg0) throws IOException {
		this.method30779((byte) -99);
		this.anOutputStream1 = null;
	}

	@OriginalMember(owner = "client!ru", name = "k", descriptor = "(ZI)V", line = 30)
	public void method30765(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		if (!arg0) {
			this.anInt5279 = 0;
			this.anInt5278 = 0;
		}
	...
	public void method30766(@OriginalArg(0) boolean arg0) {
		if (!arg0) {
			this.anInt5279 = 0;
			this.anInt5278 = 0;
		}
	...
	public void method30767(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) throws IOException {
		@Pc(8) int local8 = this.anInt5278 * 798090307 - arg0 - 1;
		if (local8 < 0) {
			local8 += this.anInt5280 * -623853417;
		}
	...
	public void method30768(@OriginalArg(0) byte arg0, @OriginalArg(1) byte arg1) throws IOException {
		this.aByteArray97[(this.anInt5278 += -1793685397) * 798090307 - 1] = arg0;
		if (this.anInt5278 * 798090307 >= this.anInt5280 * -623853417) {
			this.method30779((byte) -68);
		}
	}

	@OriginalMember(owner = "client!ru", name = "b", descriptor = "(I)B", line = 60)
	public byte method30769(@OriginalArg(0) int arg0) {
		@Pc(8) int local8 = this.anInt5278 * 798090307 - arg0 - 1;
		if (local8 < 0) {
			local8 += this.anInt5280 * -623853417;
		}
	...
	public void method30770(@OriginalArg(0) int arg0) {
		if (this.aByteArray97 == null || arg0 != this.anInt5280 * -623853417) {
			this.aByteArray97 = new byte[arg0];
		}
		this.anInt5280 = arg0 * -1211187417;
	...
	public void method30771(@OriginalArg(0) int arg0) {
		if (this.aByteArray97 == null || arg0 != this.anInt5280 * -623853417) {
			this.aByteArray97 = new byte[arg0];
		}
		this.anInt5280 = arg0 * -1211187417;
	...
	public void method30772(@OriginalArg(0) int arg0) {
		if (this.aByteArray97 == null || arg0 != this.anInt5280 * -623853417) {
			this.aByteArray97 = new byte[arg0];
		}
		this.anInt5280 = arg0 * -1211187417;
	...
	public void method30773(@OriginalArg(0) OutputStream arg0) throws IOException {
		this.method30764((byte) -23);
		this.anOutputStream1 = arg0;
	}

	@OriginalMember(owner = "client!ru", name = "r", descriptor = "()V", line = 25)
	public void method30774() throws IOException {
		this.method30779((byte) -8);
		this.anOutputStream1 = null;
	}

	@OriginalMember(owner = "client!ru", name = "q", descriptor = "(I)B", line = 60)
	public byte method30775(@OriginalArg(0) int arg0) {
		@Pc(8) int local8 = this.anInt5278 * 798090307 - arg0 - 1;
		if (local8 < 0) {
			local8 += this.anInt5280 * -623853417;
		}
	...
	public void method30776() throws IOException {
	...
	public void method30777(@OriginalArg(0) byte arg0) throws IOException {
		this.aByteArray97[(this.anInt5278 += -1793685397) * 798090307 - 1] = arg0;
		if (this.anInt5278 * 798090307 >= this.anInt5280 * -623853417) {
			this.method30779((byte) -46);
		}
	}
	...
	public void method30779(@OriginalArg(0) byte arg0) throws IOException {
		@Pc(9) int local9 = this.anInt5278 * 798090307 - this.anInt5279 * -498353225;
		if (local9 == 0) {
			return;
		}
	...
	public void method30781(@OriginalArg(0) OutputStream arg0, @OriginalArg(1) short arg1) throws IOException {
		this.method30764((byte) -101);
		this.anOutputStream1 = arg0;
	}
	...
	static final void method30783(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
		...
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class23.method503(local13, local23, false, -2013899817);
	}
	...
	static final void method30784(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		@Pc(31) int local31 = client.aClass531ArrayArray1[local23][local13].method30426(-729568038);
