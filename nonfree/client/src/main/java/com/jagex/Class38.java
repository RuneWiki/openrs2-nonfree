...
public final class Class38 {
	...
	public final void method722(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
	...
	public final void method732() throws IOException {
		this.method724(false);
	}

	@OriginalMember(owner = "client!abl", name = "k", descriptor = "(ZI)V", line = 46)
	final void method724(@OriginalArg(0) boolean arg0) throws IOException {
	...
	public final long method735() throws IOException {
		return this.aRandomAccessFile1.length();
	}
	...
	public final int method726(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
		@Pc(6) int local6 = this.aRandomAccessFile1.read(arg0, arg1, arg2);
		if (local6 > 0) {
			this.aLong2 += (long) local6 * 652475383648725799L;
		}
