...
public final class Class38 {
	...
	public final int method720(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
	...
	public final void method721() throws IOException {
		this.method724(false, -968138374);
	}

	@OriginalMember(owner = "client!abl", name = "n", descriptor = "([BIII)V", line = 32)
	public final void method722(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) throws IOException {
	...
	final void method724(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) throws IOException {
	...
	final void method725(@OriginalArg(0) long arg0) throws IOException {
		this.aRandomAccessFile1.seek(arg0);
		this.aLong2 = arg0 * 652475383648725799L;
	}

	@OriginalMember(owner = "client!abl", name = "w", descriptor = "([BIIB)I", line = 63)
	public final int method726(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) throws IOException {
		@Pc(6) int local6 = this.aRandomAccessFile1.read(arg0, arg1, arg2);
		if (local6 > 0) {
			this.aLong2 += (long) local6 * 652475383648725799L;
		}
	...
	final void method727(@OriginalArg(0) long arg0) throws IOException {
		this.aRandomAccessFile1.seek(arg0);
		this.aLong2 = arg0 * 652475383648725799L;
	}

	@OriginalMember(owner = "client!abl", name = "l", descriptor = "(J)V", line = 27)
	final void method728(@OriginalArg(0) long arg0) throws IOException {
		this.aRandomAccessFile1.seek(arg0);
		this.aLong2 = arg0 * 652475383648725799L;
	}
	...
	final void method730(@OriginalArg(0) long arg0) throws IOException {
		this.aRandomAccessFile1.seek(arg0);
		this.aLong2 = arg0 * 652475383648725799L;
	}

	@OriginalMember(owner = "client!abl", name = "d", descriptor = "([BII)V", line = 32)
	public final void method731(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
		if (this.aLong2 * -1533135506001161065L + (long) arg2 > this.aLong3 * -4840109512671702321L) {
			this.aRandomAccessFile1.seek(this.aLong3 * -4840109512671702321L);
			this.aRandomAccessFile1.write(1);
			throw new EOFException();
	...
	public final void method732(@OriginalArg(0) int arg0) throws IOException {
		this.method724(false, -968138374);
	}

	@OriginalMember(owner = "client!abl", name = "r", descriptor = "()J", line = 59)
	public final long method733() throws IOException {
		return this.aRandomAccessFile1.length();
	}

	@OriginalMember(owner = "client!abl", name = "v", descriptor = "()J", line = 59)
	public final long method734() throws IOException {
		return this.aRandomAccessFile1.length();
	}

	@OriginalMember(owner = "client!abl", name = "f", descriptor = "(I)J", line = 59)
	public final long method735(@OriginalArg(0) int arg0) throws IOException {
		return this.aRandomAccessFile1.length();
	}
}
