...
public class Class546 {
	...
	void method30962() {
		Class294.method26596(this.aShortArray131, -1710573301);
	...
	void method30964(@OriginalArg(0) byte arg0) {
		Class294.method26596(this.aShortArray131, 1731722242);
		for (@Pc(5) int local5 = 0; local5 < this.anInt5290 * -309545431; local5++) {
	...
	int method30965(@OriginalArg(0) Class365 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) throws IOException {
		if (arg0.method27905(this.aShortArray131, 0, 291964485) == 0) {
			return this.aClass360Array2[arg1].method27794(arg0, (byte) -4);
		}
		@Pc(16) byte local16 = 8;
		@Pc(33) int local33;
		if (arg0.method27905(this.aShortArray131, 1, 291964485) == 0) {
	...
	void method30966() {
		Class294.method26596(this.aShortArray131, -605926504);
		for (@Pc(5) int local5 = 0; local5 < this.anInt5290 * -309545431; local5++) {
	...
	void method30967() {
		Class294.method26596(this.aShortArray131, -380559692);
		for (@Pc(5) int local5 = 0; local5 < this.anInt5290 * -309545431; local5++) {
	...
	void method30968() {
		Class294.method26596(this.aShortArray131, -564759683);
		for (@Pc(5) int local5 = 0; local5 < this.anInt5290 * -309545431; local5++) {
	...
	public static void method30969(@OriginalArg(0) short arg0) {
		@Pc(2) Class240 local2 = Class658.aClass240_91;
		synchronized (Class658.aClass240_91) {
			Class658.aClass240_91.method25837(1161602830);
		}
		local2 = Class658.aClass240_92;
		synchronized (Class658.aClass240_92) {
			Class658.aClass240_92.method25837(1161602830);
		}
	}
	...
	static final void method30971(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		local33.aClass93_Sub41_Sub2_1.method22454(Class46.method894(local13, -1746842495) + Class46.method894(local27, -1698473232), 2145656670);
		local33.aClass93_Sub41_Sub2_1.method22402(local13, 588125156);
		local33.aClass93_Sub41_Sub2_1.method22402(local27, 1144919468);
		client.aClass175_1.method24351(local33, -1898577141);
	}

	@OriginalMember(owner = "client!sc", name = "ayp", descriptor = "(Lclient!yf;B)V", line = 13984)
	static final void method30972(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static int method30973(@OriginalArg(0) Class497 arg0, @OriginalArg(1) Class667 arg1, @OriginalArg(2) byte arg2) {
		if (arg0 == null) {
			return 0;
		} else if (arg1.method32906(-24379334) > 1) {
			@Pc(13) int local13 = arg0.method30063((byte) -51) - 1;
			return local13 * arg1.method32906(-183996470) + arg0.method30062(local13, 1566891594);
		} else {
			return arg0.method30062(arg1.anInt5849 * -1772702343, 1061627796);
		}
	}

	@OriginalMember(owner = "client!sc", name = "ayl", descriptor = "(Lclient!yf;I)V", line = 14078)
	static final void method30974(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method30975(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1296492219);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class293.method26592(local16, local22, arg0, -376853165);
	}
}
