...
public class Class112_Sub2_Sub1_Sub1 extends Class112_Sub2_Sub1 implements Interface53 {
	...
	public void method10400() {
		if (this.aLong39 == 0L) {
			...
			} else if (Class104_Sub2_Sub1.method19539(this.aClass104_Sub2_Sub1_5.anInt2731, this.aClass104_Sub2_Sub1_5.anInt2730, this.aClass104_Sub2_Sub1_5.aLong117, this.aClass104_Sub2_Sub1_5.anInt2951, this.aClass104_Sub2_Sub1_5.aD3DDISPLAYMODE1, this.aD3DPRESENT_PARAMETERS1)) {
			...
			this.aClass104_Sub2_Sub1_5.method19518(this);
		}
		if (this.aBoolean213) {
			this.method23739();
		}
	...
	boolean method23749() {
		...
		return e.method27716(IDirect3DDevice.SetDepthStencilSurface(this.aClass104_Sub2_Sub1_5.aLong121, 0L));
	}
	...
	@Override
	public int method23754(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return IDirect3DSwapChain.Present(this.aLong39, 0);
	}

	@OriginalMember(owner = "client!aic", name = "ag", descriptor = "(II)I", line = 85)
	@Override
	public int method23760(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return IDirect3DSwapChain.Present(this.aLong39, 0);
	}
	...
	void method23756(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		this.anInt1193 = arg1;
		if (this.aBoolean214) {
			this.aClass104_Sub2_Sub1_5.method19542(this.anInt1192, this.anInt1193);
		}
		this.method10400();
		super.method23757(arg0, arg1);
	}
	...
	public void method23738() {
		...
		this.aClass104_Sub2_Sub1_5.method19523(this);
	}
