...
public class Class93_Sub28 extends Class93 {
	...
	void method13827(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(21) int local21 = 2;
		if ((local3 & 0x4) != 0) {
			local21 = arg0.method22413((short) 16384);
		}
		this.aLong232 = arg0.method22423(1716787865) * -284080703297520027L;
		this.aLong89 = arg0.method22423(-1617892798) * -8713487650679722559L;
		this.aString44 = arg0.method22427(929635250);
		arg0.method22413((short) 16384);
		this.aByte56 = arg0.method22414(725992699);
		this.aByte55 = arg0.method22414(1940838573);
		this.anInt1602 = arg0.method22415(-1434290800) * -1125174335;
		if (this.anInt1602 * -1052058559 <= 0) {
			return;
		}
		...
		for (@Pc(84) int local84 = 0; local84 < this.anInt1602 * -1052058559; local84++) {
			...
			if (this.aBoolean339) {
				arg0.method22423(1050717539);
			}
			if (this.aBoolean338) {
				local94.aString191 = arg0.method22427(1071713046);
			}
			local94.aByte150 = arg0.method22414(1454895866);
			local94.anInt4597 = arg0.method22415(-1434290800) * -1542465575;
			if (local21 >= 3) {
				arg0.method22413((short) 16384);
			}
	...
	void method13834(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		this.aLong232 = arg0.method22423(-1632333873) * -284080703297520027L;
		this.aLong89 = arg0.method22423(-1460949801) * -8713487650679722559L;
		this.aString44 = arg0.method22427(811166998);
		arg0.method22413((short) 16384);
		this.aByte56 = arg0.method22414(1277799625);
		this.aByte55 = arg0.method22414(1265793076);
		this.anInt1602 = arg0.method22415(-1434290800) * -1125174335;
		if (this.anInt1602 * -1052058559 <= 0) {
			return;
		}
		...
		for (@Pc(84) int local84 = 0; local84 < this.anInt1602 * -1052058559; local84++) {
			@Pc(94) Class373 local94 = new Class373();
			if (this.aBoolean339) {
				arg0.method22423(733980518);
			}
			if (this.aBoolean338) {
				local94.aString191 = arg0.method22427(724735356);
			}
			local94.aByte150 = arg0.method22414(1711724058);
			local94.anInt4597 = arg0.method22415(-1434290800) * -1542465575;
			if (local21 >= 3) {
				arg0.method22413((short) 16384);
			}
	...
	void method13837(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		this.aLong232 = arg0.method22423(1312585054) * -284080703297520027L;
		this.aLong89 = arg0.method22423(1572409146) * -8713487650679722559L;
		this.aString44 = arg0.method22427(1763467286);
		arg0.method22413((short) 16384);
		this.aByte56 = arg0.method22414(1944505585);
		this.aByte55 = arg0.method22414(719939242);
		this.anInt1602 = arg0.method22415(-1434290800) * -1125174335;
		if (this.anInt1602 * -1052058559 <= 0) {
			return;
		}
		...
		for (@Pc(84) int local84 = 0; local84 < this.anInt1602 * -1052058559; local84++) {
			@Pc(94) Class373 local94 = new Class373();
			if (this.aBoolean339) {
				arg0.method22423(-496143310);
			}
			if (this.aBoolean338) {
				local94.aString191 = arg0.method22427(1005898774);
			}
			local94.aByte150 = arg0.method22414(906235362);
			local94.anInt4597 = arg0.method22415(-1434290800) * -1542465575;
			if (local21 >= 3) {
				arg0.method22413((short) 16384);
			}
	...
	void method13839(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		this.aLong232 = arg0.method22423(-147223289) * -284080703297520027L;
		this.aLong89 = arg0.method22423(-152749174) * -8713487650679722559L;
		this.aString44 = arg0.method22427(1298401702);
		arg0.method22413((short) 16384);
		this.aByte56 = arg0.method22414(564534713);
		this.aByte55 = arg0.method22414(658939030);
		this.anInt1602 = arg0.method22415(-1434290800) * -1125174335;
		if (this.anInt1602 * -1052058559 <= 0) {
			return;
		}
		...
		for (@Pc(84) int local84 = 0; local84 < this.anInt1602 * -1052058559; local84++) {
			@Pc(94) Class373 local94 = new Class373();
			if (this.aBoolean339) {
				arg0.method22423(1401016987);
			}
			if (this.aBoolean338) {
				local94.aString191 = arg0.method22427(1285384266);
			}
			local94.aByte150 = arg0.method22414(1278357445);
			local94.anInt4597 = arg0.method22415(-1434290800) * -1542465575;
			if (local21 >= 3) {
				arg0.method22413((short) 16384);
			}
	...
	static final void method13840(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(16) Class312 local16 = Class659.method32805(local12, 862080406);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class453.method28965(local16, local22, arg0, Class121.aClass93_Sub28_2 == arg0.aClass93_Sub28_4 ? Class310.aClass310_5 : Class310.aClass310_1, (byte) -102);
	}
	...
	static final void method13841(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = ((Class132_Sub1) arg0.anInterface61_1).method24275(899866876);
	}
}
