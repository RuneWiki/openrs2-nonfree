...
public class Class384 implements Interface33 {
	...
	static final void method28154(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static int method28155(@OriginalArg(0) Iterable arg0, @OriginalArg(1) int arg1) {
		@Pc(1) int local1 = -1;
	...
	public static Class497 method28156(@OriginalArg(0) Class31 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		...
		Class569.aClass143_Sub1Array2[local16] = Class275.aClass496_1.method30033(local16, local12, Class239.aClass593_4, arg0.method630(16777215), (byte) 45);
		if (arg4) {
	...
	public static int method28157(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
