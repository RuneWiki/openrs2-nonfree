...
public class Class393 {
	...
	@OriginalMember(owner = "client!pl", name = "p", descriptor = "Ljava/awt/Robot;")
	Robot aRobot1 = new Robot();

	@OriginalMember(owner = "client!pl", name = "<init>", descriptor = "()V", line = 12)
	public Class393() throws Exception {
	}

	@OriginalMember(owner = "client!pl", name = "movemouse", descriptor = "(II)V", line = 18)
	public void movemouse(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aRobot1.mouseMove(arg0, arg1);
	}

	@OriginalMember(owner = "client!pl", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V", line = 23)
