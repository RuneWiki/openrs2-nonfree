...
public class Class544 {
	...
	void method30949(@OriginalArg(0) int arg0) {
		Class294.method26596(this.aShortArray130, 746816514);
	}

	@OriginalMember(owner = "client!sa", name = "f", descriptor = "()V", line = 234)
	void method30950() {
		Class294.method26596(this.aShortArray130, 366752208);
	}

	@OriginalMember(owner = "client!sa", name = "m", descriptor = "(Lclient!jp;BI)B", line = 246)
	byte method30951(@OriginalArg(0) Class365 arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2) throws IOException {
		@Pc(1) int local1 = 1;
		do {
			@Pc(7) int local7 = arg1 >> 7 & 0x1;
			arg1 = (byte) (arg1 << 1);
			@Pc(25) int local25 = arg0.method27905(this.aShortArray130, local1 + (local7 + 1 << 8), 291964485);
			local1 = local1 << 1 | local25;
			if (local25 != local7) {
				while (local1 < 256) {
					local1 = local1 << 1 | arg0.method27905(this.aShortArray130, local1, 291964485);
				}
				return (byte) local1;
			}
		} while (local1 < 256);
	...
	void method30952() {
		Class294.method26596(this.aShortArray130, 1765870969);
	}
	...
	static final void method30957(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub35_1.method16223(1931997619);
	}
	...
	static Class604[] method30959(@OriginalArg(0) int arg0) {
