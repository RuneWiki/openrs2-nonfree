...
public class Class365 {
	...
	public final void method27901(@OriginalArg(0) InputStream arg0, @OriginalArg(1) byte arg1) {
		this.anInputStream1 = arg0;
	}

	@OriginalMember(owner = "client!jp", name = "z", descriptor = "(I)I", line = 29)
	public final int method27902(@OriginalArg(0) int arg0) throws IOException {
		@Pc(1) int local1 = 0;
	...
	public final void method27903(@OriginalArg(0) int arg0) throws IOException {
		this.anInt4581 = 0;
	...
	public final int method27904(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) throws IOException {
		@Pc(1) int local1 = 0;
		for (@Pc(3) int local3 = arg0; local3 != 0; local3--) {
			this.anInt4580 = (-1329977601 * this.anInt4580 >>> 1) * -430647041;
			@Pc(28) int local28 = this.anInt4581 * 314866317 - this.anInt4580 * -1329977601 >>> 31;
	...
	public int method27905(@OriginalArg(0) short[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
	...
	public final int method27906(@OriginalArg(0) int arg0) throws IOException {
		@Pc(1) int local1 = 0;
		for (@Pc(3) int local3 = arg0; local3 != 0; local3--) {
			this.anInt4580 = (-1329977601 * this.anInt4580 >>> 1) * -430647041;
			@Pc(28) int local28 = this.anInt4581 * 314866317 - this.anInt4580 * -1329977601 >>> 31;
	...
	public final void method27907(@OriginalArg(0) byte arg0) {
		this.anInputStream1 = null;
	}

	@OriginalMember(owner = "client!jp", name = "r", descriptor = "([SI)I", line = 44)
	public int method27908(@OriginalArg(0) short[] arg0, @OriginalArg(1) int arg1) throws IOException {
		@Pc(3) short local3 = arg0[arg1];
		@Pc(12) int local12 = (this.anInt4580 * -1329977601 >>> 11) * local3;
		if ((this.anInt4581 * 314866317 ^ Integer.MIN_VALUE) < (local12 ^ Integer.MIN_VALUE)) {
			this.anInt4580 = local12 * -430647041;
	...
	public int method27911(@OriginalArg(0) short[] arg0, @OriginalArg(1) int arg1) throws IOException {
		@Pc(3) short local3 = arg0[arg1];
		@Pc(12) int local12 = (this.anInt4580 * -1329977601 >>> 11) * local3;
		if ((this.anInt4581 * 314866317 ^ Integer.MIN_VALUE) < (local12 ^ Integer.MIN_VALUE)) {
			this.anInt4580 = local12 * -430647041;
	...
	public final void method27912(@OriginalArg(0) InputStream arg0) {
		this.anInputStream1 = arg0;
	}
	...
	public static void method27915(@OriginalArg(0) short[] arg0) {
	...
	static final void method27916(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
	...
	static final void method27917(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!jp", name = "bag", descriptor = "(Lclient!yf;B)V", line = 14253)
	static final void method27918(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub3_1.method16543(local12, 1927192604);
	}
	...
	static final void method27919(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		if (client.aBoolean632) {
			Class447.aClass447_6.method28904(-2022949626);
		}
	}

	@OriginalMember(owner = "client!jp", name = "e", descriptor = "(IB)Lclient!ie;", line = 13)
	public static Class335 method27920(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	...
	public static Class109 method27921(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class109 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) Class19 arg11, @OriginalArg(12) byte arg12) {
		...
		synchronized (Class330.aClass240_79) {
			local48 = (Class109) Class330.aClass240_79.method25839(local39);
		}
		@Pc(79) int local79;
		if (local48 == null || arg0.method20693(local48.method6825(), local6) != 0) {
			...
			local48 = arg0.method20510(local113, local6, Class330.anInt4146 * -1710939251, 64, 768);
			@Pc(363) Class240 local363 = Class330.aClass240_79;
			synchronized (Class330.aClass240_79) {
				Class330.aClass240_79.method25830(local48, local39);
			}
		}
		...
		if (arg11 == null) {
			...
			arg11.method23567(local48, (byte) 32);
		}
		if (arg2 != 0) {
