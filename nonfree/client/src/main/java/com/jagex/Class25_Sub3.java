...
public class Class25_Sub3 extends Class25 {
	...
	public boolean method23132(@OriginalArg(0) int arg0) {
		return this.aClass479_1 != null && this.aClass124_Sub3_1 != null && this.aClass124_Sub3_1.method21401(-1723495343);
	}
	...
	public Class472 method23120(@OriginalArg(0) int arg0) {
		...
		@Pc(9) double[] local9 = this.aClass479_1.method29716(this.aClass124_Sub3_1.method21445(111433901));
	...
	public Class472 method23133() {
		return this.method23120(-1781091315);
	}

	@OriginalMember(owner = "client!ani", name = "b", descriptor = "()[D", line = 36)
	double[] method16162() {
		return this.aClass479_1.method29716(this.aClass124_Sub3_1.method21445(1787945406));
	}
	...
	public Class472 method23117() {
		return this.method23120(-1733073084);
	}

	@OriginalMember(owner = "client!ani", name = "z", descriptor = "()Z", line = 23)
	@Override
	public boolean method23125() {
		return this.aClass479_1 != null && this.aClass124_Sub3_1 != null && this.aClass124_Sub3_1.method21401(-1556766059);
	}

	@OriginalMember(owner = "client!ani", name = "x", descriptor = "()[D", line = 36)
	double[] method16163() {
		return this.aClass479_1.method29716(this.aClass124_Sub3_1.method21445(1857679914));
	}
	...
	public Class472 method23127() {
		@Pc(1) Class472 local1 = Class472.method29528();
		@Pc(9) double[] local9 = this.aClass479_1.method29716(this.aClass124_Sub3_1.method21445(899452506));
		local1.aFloat317 = (float) local9[0];
		local1.aFloat318 = (float) local9[1];
		local1.aFloat319 = (float) local9[2];
		return local1;
