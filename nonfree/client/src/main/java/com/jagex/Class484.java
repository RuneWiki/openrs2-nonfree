...
public class Class484 implements Interface75 {
	...
	static final void method29786(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		Class670.method32958(local14, local25, 1750421324);
	}
	...
	static final void method29788(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method29789(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!pj", name = "avh", descriptor = "(Lclient!yf;I)V", line = 13465)
	static final void method29790(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!pj", name = "jt", descriptor = "(Lclient!akl;IIII)V", line = 10302)
	static void method29791(@OriginalArg(0) Class93_Sub22 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		arg0.aClass93_Sub41_Sub2_1.method22456(arg3, (short) 255);
		arg0.aClass93_Sub41_Sub2_1.method22458(arg2, -1871503550);
		arg0.aClass93_Sub41_Sub2_1.method22395(arg1, (byte) -9);
	}

	@OriginalMember(owner = "client!pj", name = "e", descriptor = "(I)[Lclient!dt;", line = 23)
	static Class233[] method29792(@OriginalArg(0) int arg0) {
