...
public class Class484 implements Interface75 {
	...
	static final void method29786(@OriginalArg(0) Class681 arg0) {
		...
		Class670.method32958(local14, local25);
	}

	@OriginalMember(owner = "client!pj", name = "abi", descriptor = "(Lclient!yf;I)V", line = 9837)
	static final void method29787(@OriginalArg(0) Class681 arg0) {
	...
	static void method29791(@OriginalArg(0) Class93_Sub22 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		arg0.aClass93_Sub41_Sub2_1.method22456(arg3);
		arg0.aClass93_Sub41_Sub2_1.method22458(arg2);
		arg0.aClass93_Sub41_Sub2_1.method22395(arg1);
	}

	@OriginalMember(owner = "client!pj", name = "anb", descriptor = "(Lclient!yf;B)V", line = 12364)
	static final void method29788(@OriginalArg(0) Class681 arg0) {
		Class320.method27240(arg0, Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3);
	}

	@OriginalMember(owner = "client!pj", name = "avh", descriptor = "(Lclient!yf;I)V", line = 13465)
	static final void method29790(@OriginalArg(0) Class681 arg0) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!pj", name = "ava", descriptor = "(Lclient!yf;I)V", line = 13473)
	static final void method29789(@OriginalArg(0) Class681 arg0) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}
}
