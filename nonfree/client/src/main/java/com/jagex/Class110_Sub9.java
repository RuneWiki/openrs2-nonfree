...
public class Class110_Sub9 extends Class110 {
	...
	Class110_Sub9(@OriginalArg(0) Class93_Sub41 arg0) {
		super(arg0);
		this.anInt919 = arg0.method22415(-1434290800) * 1095782231;
		@Pc(13) int local13 = arg0.method22419(-118643075);
		this.anInt920 = (local13 >>> 16) * -643042539;
		this.anInt921 = (local13 & 0xFFFF) * -1307325291;
		this.anInt922 = arg0.method22413((short) 16384) * -398280083;
		this.anInt923 = arg0.method22413((short) 16384) * 1652587663;
	}
	...
	static final void method7974(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(16) Class312 local16 = Class659.method32805(local12, 85319042);
	...
	static final void method7975(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		Class533.method30605(arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1], 1713133178);
	}
}
