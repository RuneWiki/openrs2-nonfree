...
public class Class107_Sub2_Sub1 extends Class107_Sub2 {
	...
	boolean method17755(@OriginalArg(0) Class88_Sub1 arg0, @OriginalArg(1) Class88_Sub1 arg1, @OriginalArg(2) float arg2) {
		@Pc(1) boolean local1 = true;
		@Pc(5) Class112_Sub1_Sub2 local5 = this.aClass104_Sub1_31.aClass112_Sub1_Sub2_1;
		this.aClass104_Sub1_31.method20470(anIntArray206);
		this.aClass104_Sub1_31.method20466();
		this.aClass104_Sub1_31.method20625(anIntArray205);
		...
		this.aClass104_Sub1_31.method20441(local5, (byte) 1);
		for (@Pc(100) int local100 = 0; local100 < 6; local100++) {
			@Pc(107) int local107 = local100 + 34069;
			local5.method23434(0, this.aClass88_Sub1_1.method1592(local107, 0));
			local5.method18014(0);
			if (!local5.method23441()) {
				local1 = false;
				break;
			}
			OpenGL.glBegin(7);
		...
		local5.method23434(0, (Interface18) null);
		this.aClass104_Sub1_31.method20442(local5, -1497248091);
		this.aClass104_Sub1_31.method3803(1);
		this.aClass104_Sub1_31.method3804((Class88) null);
		this.aClass104_Sub1_31.method3837(8448, 8448);
		this.aClass104_Sub1_31.method3803(0);
		this.aClass104_Sub1_31.method3804((Class88) null);
		this.aClass104_Sub1_31.method20467(anIntArray206[0], anIntArray206[1], anIntArray206[2], anIntArray206[3]);
		this.aClass104_Sub1_31.method20463(anIntArray205[0], anIntArray205[1], anIntArray205[2], anIntArray205[3]);
		if (local1 && !this.aClass104_Sub1_31.aBoolean107) {
			this.aClass88_Sub1_1.method18043();
		}
		return local1;
	}

	@OriginalMember(owner = "client!apf", name = "k", descriptor = "(Lclient!adq;Lclient!adq;F)Z", line = 27)
	boolean method17756(@OriginalArg(0) Class88_Sub1 arg0, @OriginalArg(1) Class88_Sub1 arg1, @OriginalArg(2) float arg2) {
		@Pc(1) boolean local1 = true;
		@Pc(5) Class112_Sub1_Sub2 local5 = this.aClass104_Sub1_31.aClass112_Sub1_Sub2_1;
		this.aClass104_Sub1_31.method20470(anIntArray206);
		this.aClass104_Sub1_31.method20466();
