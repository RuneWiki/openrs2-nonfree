...
public class Class499 implements Runnable {
	...
	static final Object[] method30148(@OriginalArg(0) String arg0, @OriginalArg(1) Class681 arg1, @OriginalArg(2) int arg2) {
	...
	static final void method30149(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method30150(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method30151(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1745511088);
	...
	static final void method30152(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		if (local15 != null) {
			@Pc(35) boolean local35 = local15.method23169(local12 >> 28 & 0x3, local12 >> 14 & 0x3FFF, local12 & 0x3FFF, Class687.anIntArray525, -237230590);
			if (local35) {
				Class110_Sub5.method7657(Class687.anIntArray525[1], Class687.anIntArray525[2], 2114545008);
			}
		}
	}

	@OriginalMember(owner = "client!q", name = "at", descriptor = "(II)I", line = 479)
	public static int method30153(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
