...
public class Class93_Sub1_Sub2 extends Class93_Sub1 implements Interface13, Interface5 {
	...
	void method1784(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 2) {
			this.anInt316 = arg0.method22415() * -21466175;
		} else if (arg1 == 4) {
			this.anInt317 = arg0.method22413() * 1466249681;
			...
			for (@Pc(36) int local36 = 0; local36 < this.anInt317 * 795395889; local36++) {
				this.anIntArray25[local36] = arg0.method22415();
				this.anIntArray24[local36] = arg0.method22415();
			}
		}
	}
	...
	public static String method1787(@OriginalArg(0) CharSequence arg0) {
		@Pc(4) String local4 = Class607.method31922(Class685.method33453(arg0));
		if (local4 == null) {
			local4 = "";
		}
		return local4;
