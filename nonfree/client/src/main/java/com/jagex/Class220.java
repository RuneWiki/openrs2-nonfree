...
final class Class220 implements Interface27 {
	...
	public static Class93_Sub1_Sub15 method25541(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public static Class562 method25542(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Interface11 arg4, @OriginalArg(5) Interface11 arg5, @OriginalArg(6) int arg6) {
	...
	public static void method25543(@OriginalArg(0) byte arg0) {
	...
	static final void method25544(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		arg0.anObjectArray25 = Class499.method30148(local13, arg2, 1818310325);
		arg0.aBoolean680 = true;
	}

	@OriginalMember(owner = "client!d", name = "pf", descriptor = "(Lclient!yf;I)V", line = 7839)
	static final void method25545(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class32_Sub19.method17404(local11, local14, arg0, -270386490);
	}

	@OriginalMember(owner = "client!d", name = "bal", descriptor = "(Lclient!yf;B)V", line = 14310)
	static final void method25546(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub24_1.method16543(local12, 1638952250);
	}

	@OriginalMember(owner = "client!d", name = "fo", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;B)V", line = 5992)
	static final void method25547(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) byte arg3) {
	...
	static final void method25548(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		if (local9.anIntArray412 != null) {
			local9 = local9.method27423(Class624.aClass120_1, Class624.aClass120_1, (short) 20208);
			if (local9 == null) {
				local6 = "";
			} else {
	...
	public static int method25549(@OriginalArg(0) int arg0) {
		Class53_Sub1.method14955(-1593140386);
