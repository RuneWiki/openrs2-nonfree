...
final class Class220 implements Interface27 {
	...
	public static void method25543() {
		if (Class670.aClass146_6 != null) {
			Class670.aClass146_6.method11683();
		}
	}

	@OriginalMember(owner = "client!d", name = "n", descriptor = "(I)I", line = 43)
	public static int method25549() {
	...
	public static Class562 method25542(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Interface11 arg4, @OriginalArg(5) Interface11 arg5) {
		@Pc(1) Class563[] local1 = null;
		@Pc(7) Class603 local7 = (Class603) arg4.method18261(arg0);
		if (local7.anIntArray486 != null) {
			...
			for (@Pc(18) int local18 = 0; local18 < local1.length; local18++) {
				@Pc(31) Class353 local31 = (Class353) arg5.method18261(local7.anIntArray486[local18]);
	...
	public static Class93_Sub1_Sub15 method25541(@OriginalArg(0) int arg0) {
	...
	@Override
	public Class79_Sub1 method25539() {
	...
	@Override
	public Class79_Sub1 method25528() {
	...
	@Override
	public Class32_Sub16 method25530() {
		return Class30.aClass32_Sub16_1;
	}
	...
	static final void method25547(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
	...
	static final void method25544(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
		...
		arg0.anObjectArray25 = Class499.method30148(local13, arg2);
		arg0.aBoolean680 = true;
	}

	@OriginalMember(owner = "client!d", name = "pf", descriptor = "(Lclient!yf;I)V", line = 7839)
	static final void method25545(@OriginalArg(0) Class681 arg0) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class32_Sub19.method17404(local11, local14, arg0);
	}

	@OriginalMember(owner = "client!d", name = "bal", descriptor = "(Lclient!yf;B)V", line = 14310)
	static final void method25546(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub24_1.method16543(local12);
	}

	@OriginalMember(owner = "client!d", name = "bbn", descriptor = "(Lclient!yf;B)V", line = 14431)
	static final void method25548(@OriginalArg(0) Class681 arg0) {
		...
		if (local9.anIntArray412 != null) {
			local9 = local9.method27423(Class624.aClass120_1, Class624.aClass120_1);
			if (local9 == null) {
				local6 = "";
			} else {
