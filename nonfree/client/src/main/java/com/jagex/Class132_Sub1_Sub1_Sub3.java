...
public class Class132_Sub1_Sub1_Sub3 extends Class132_Sub1_Sub1 implements Interface61 {
	...
	public static Class351 method13301(@OriginalArg(0) int arg0) {
	...
	public Class132_Sub1_Sub1_Sub3(@OriginalArg(0) Class585 arg0, @OriginalArg(1) Class104 arg1, @OriginalArg(2) Class32_Sub14 arg2, @OriginalArg(3) Class610 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) boolean arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) boolean arg18, @OriginalArg(19) Class458 arg19) {
		super(arg0, arg4, arg5, arg6, arg7, arg8, arg10, arg11, arg12, arg13, arg3.anInt5610 * -927091685 == 1, Class478.method29709(arg14, arg15), arg19);
	...
	public int method24282() {
		return this.aClass558_4.method31096();
	}
	...
	public int method24275() {
		return this.aClass558_4.method31070();
	}
	...
	Class573 method24271(@OriginalArg(0) Class104 arg0) {
		@Pc(8) Class109 local8 = this.aClass558_4.method31072(arg0, 2048, false, true);
		if (local8 == null) {
			return null;
		}
		@Pc(16) Class470 local16 = this.method24226();
		@Pc(21) Class573 local21 = Class125_Sub1.method9214(this.aBoolean326);
		this.aClass558_4.method31073(arg0, local8, local16, this.aShort129, this.aShort130, this.aShort128, this.aShort127, true);
		@Pc(42) Class610 local42 = this.aClass558_4.method31071();
		...
		if (this.aClass600_7 == null) {
			this.aClass600_7 = Class62.method1154((int) local97.aClass472_61.aFloat317, (int) local97.aClass472_61.aFloat318, (int) local97.aClass472_61.aFloat319, local8);
		} else {
			Class554.method31050(this.aClass600_7, (int) local97.aClass472_61.aFloat317, (int) local97.aClass472_61.aFloat318, (int) local97.aClass472_61.aFloat319, local8);
		}
		return local21;
	}
	...
	void method24294(@OriginalArg(0) Class104 arg0) {
		@Pc(8) Class109 local8 = this.aClass558_4.method31072(arg0, 262144, true, true);
		if (local8 != null) {
			this.aClass558_4.method31073(arg0, local8, this.method24226(), this.aShort129, this.aShort130, this.aShort128, this.aShort127, false);
		}
	}
	...
	public void method13295(@OriginalArg(0) Class620 arg0) {
		this.aClass558_4.method31099(arg0);
	}
	...
	boolean method24290(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(4) Class610 local4 = this.aClass558_4.method31071();
		if (local4.aClass463_2 == null) {
			@Pc(26) Class109 local26 = this.aClass558_4.method31072(arg0, 131072, false, false);
	...
	public boolean method13406() {
		return this.aClass558_4.method31074();
	}
	...
	public void method13418(@OriginalArg(0) Class104 arg0) {
		this.aClass558_4.method31075(arg0);
	}
	...
	public void method13402(@OriginalArg(0) Class104 arg0) {
		this.aClass558_4.method31076(arg0);
	}
