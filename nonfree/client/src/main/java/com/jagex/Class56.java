...
public abstract class Class56 implements Interface4 {
	...
	void method18022(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	...
	void method18024(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class240 local3 = this.aClass240_63;
		synchronized (this.aClass240_63) {
			this.aClass240_63.method25832(arg0, (byte) -21);
		}
	}
	...
	void method18025(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_63;
		synchronized (this.aClass240_63) {
			this.aClass240_63.method25833((byte) -8);
		}
	}
	...
	void method18028(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_63;
		synchronized (this.aClass240_63) {
			this.aClass240_63.method25837(1161602830);
		}
	}
	...
	void method18029() {
		@Pc(3) Class240 local3 = this.aClass240_63;
		synchronized (this.aClass240_63) {
			this.aClass240_63.method25833((byte) -123);
		}
	}
	...
	void method18030() {
		@Pc(3) Class240 local3 = this.aClass240_63;
		synchronized (this.aClass240_63) {
			this.aClass240_63.method25833((byte) -42);
		}
	}
	...
	static final void method18033(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	public static boolean method18034(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	static void method18035(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class96 arg1, @OriginalArg(2) Class312 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) byte arg8) {
		...
		if (local5 != null && local5.anIntArray398 != null && local5.method27258(Class624.aClass120_1, Class624.aClass120_1, -1579107494)) {
			local5 = local5.method27252(Class624.aClass120_1, Class624.aClass120_1, (short) 565);
		}
		if (local5 == null || !local5.aBoolean710 || !local5.method27258(Class624.aClass120_1, Class624.aClass120_1, -1929091443)) {
			return;
		}
		@Pc(45) int local45;
		if (local5.anIntArray399 != null) {
			...
			@Pc(219) Class327 local219 = arg2.method26878(arg0, (byte) 24);
			if (local219 != null) {
		...
		if (local5.anInt4126 * -498063801 != -1) {
			local677 = local5.method27253(arg0, false, 2142970087);
			if (local677 != null) {
		...
		Class285.method26519(arg2, arg1, arg3, arg4, arg5, arg6, local45, local5.aString174, local736, local738, local5.anInt4099 * 2016508123, 866499998);
	}

	@OriginalMember(owner = "client!ace", name = "k", descriptor = "(I[II)V", line = 221)
	public static void method18036(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2) {
		if (-1 != arg0 && Class383.method28145(arg0, arg1, -23207145)) {
	...
	static final void method18037(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(18) Class5 local18 = Class157.aClass462_2.method29241(client.anInterface50_1, local12, -1034275569);
	...
	static Class328[] method18038(@OriginalArg(0) int arg0) {
	...
	static final void method18039(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) throws Exception_Sub7 {
		...
		try {
			...
			Class361.method27804(arg0, Class560.aClass560_5, local51, "VO", 433817837);
		}
	}
}
