...
class Class274 implements Interface22 {
	...
	public void method26330(@OriginalArg(0) Object arg0) {
		this.method26334((Interface70) arg0, -949777433);
	}
	...
	public void method26331(@OriginalArg(0) Object arg0, @OriginalArg(1) int arg1) {
		this.method26334((Interface70) arg0, -272365851);
	}

	@OriginalMember(owner = "client!fs", name = "f", descriptor = "(Lclient!wr;I)V", line = 269)
	void method26334(@OriginalArg(0) Interface70 arg0, @OriginalArg(1) int arg1) {
		@Pc(5) Iterator local5 = this.this$0.method26033(495448070).iterator();
		while (local5.hasNext()) {
			@Pc(12) Class539 local12 = (Class539) local5.next();
			if (local12.method30797(-1740415374) == arg0) {
				local12.method30788(-2132718265);
				local5.remove();
			}
		}
	}
	...
	public void method26332(@OriginalArg(0) Object arg0) {
		this.method26334((Interface70) arg0, 1186633252);
	}
	...
	public void method26333(@OriginalArg(0) Object arg0) {
		this.method26334((Interface70) arg0, -2006535156);
	}

	@OriginalMember(owner = "client!fs", name = "w", descriptor = "(Lclient!wr;)V", line = 269)
	void method26335(@OriginalArg(0) Interface70 arg0) {
		@Pc(5) Iterator local5 = this.this$0.method26033(1800908213).iterator();
		while (local5.hasNext()) {
			@Pc(12) Class539 local12 = (Class539) local5.next();
			if (local12.method30797(1526012801) == arg0) {
				local12.method30788(-2132718265);
				local5.remove();
			}
		}
	...
	static final void method26336(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method26337(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static void method26339(@OriginalArg(0) Class149_Sub5 arg0, @OriginalArg(1) int arg1) {
	...
	public static void method26340(@OriginalArg(0) byte arg0) {
		...
		if (Class694.aClass104_14 == null || Class694.aClass104_14.method20423()) {
			Class495.method30029((byte) -61);
		} else {
			client.anInt3413 = local6 * -1386467717;
			Class504.anInt5201 = local10 * -1294184635;
		}
		client.aLong244 = (Class305.method26796(1582354690) + 500L) * -3239649073383352057L;
