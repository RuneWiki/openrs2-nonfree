...
class Class274 implements Interface22 {
	...
	static void method26339(@OriginalArg(0) Class149_Sub5 arg0) {
		arg0.aClass132_Sub1_Sub1_Sub1_1 = null;
		if (Class149_Sub5.anInt1448 * 829391975 < 20) {
			Class149_Sub5.aClass21_3.method379(arg0);
	...
	void method26334(@OriginalArg(0) Interface70 arg0) {
		@Pc(5) Iterator local5 = this.this$0.method26033().iterator();
		while (local5.hasNext()) {
			@Pc(12) Class539 local12 = (Class539) local5.next();
			if (local12.method30797() == arg0) {
				local12.method30788();
				local5.remove();
			}
		}
	...
	public void method26330(@OriginalArg(0) Object arg0) {
		this.method26334((Interface70) arg0);
	}

	@OriginalMember(owner = "client!fs", name = "e", descriptor = "(Ljava/lang/Object;I)V", line = 280)
	@Override
	public void method26331(@OriginalArg(0) Object arg0) {
		this.method26334((Interface70) arg0);
	}
	...
	public static void method26340() {
		@Pc(2) Container local2 = Class504.method30196();
	...
	static final void method26337(@OriginalArg(0) Class681 arg0) {
	...
	static final void method26338(@OriginalArg(0) Class681 arg0) {
