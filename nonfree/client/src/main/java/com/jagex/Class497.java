...
public final class Class497 {
	...
	public byte[] method30044(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		return this.method30079(arg0, arg1, (int[]) null, (byte) -105);
	}

	@OriginalMember(owner = "client!py", name = "ac", descriptor = "(Ljava/lang/String;I)I", line = 432)
	public int method30045(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		if (this.method30111((byte) -1)) {
			@Pc(8) String local8 = arg0.toLowerCase();
			@Pc(17) int local17 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) -10840);
			return this.method30057(local17, -1926038478);
		} else {
			return 0;
		}
	}
	...
	public int method30046(@OriginalArg(0) short arg0) {
		if (!this.method30111((byte) -1)) {
	...
	synchronized boolean method30047(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		if (!this.method30111((byte) -1)) {
			return false;
	...
	public synchronized boolean method30048(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		if (!this.method30111((byte) -1)) {
			return false;
	...
	synchronized boolean method30049(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2) {
		if (!this.method30047(arg0, (byte) 1)) {
			return false;
			...
			if (arg2 == null || arg2[0] == 0 && arg2[1] == 0 && arg2[2] == 0 && arg2[3] == 0) {
				local104 = Class331.method27386(this.anObjectArray43[arg0], false, 1069378239);
			} else {
				local104 = Class331.method27386(this.anObjectArray43[arg0], true, 1158267595);
				@Pc(109) Class93_Sub41 local109 = new Class93_Sub41(local104);
				local113 = local109.method22413((short) 16384);
				local117 = local109.method22419(-118643075);
				@Pc(127) int local127 = (local113 == Class484.aClass484_5.method36920() ? 5 : 9) + local117;
				local109.method22442(arg2, 5, local127, -1984067408);
			}
			@Pc(146) byte[] local146;
			try {
				local146 = Class506.method30222(local104, (byte) -100);
			} catch (@Pc(148) RuntimeException local148) {
				throw RuntimeException_Sub2.method23530(local148, (arg2 != null) + " " + arg0 + " " + local104.length + " " + Class154.method14146(local104, local104.length, -275987287) + " " + Class154.method14146(local104, local104.length - 2, -206037027) + " " + this.aClass486_2.anIntArray455[arg0] + " " + this.aClass486_2.anInt5145 * 391791439);
			}
			if (this.aBoolean784) {
				...
				if (this.anInt5174 * -2037379935 == 2) {
					...
					for (local259 = 0; local259 < local117; local259++) {
						...
						for (local316 = 0; local316 < local19; local316++) {
							local261 += local244.method22419(-118643075);
							if (local25 == null) {
								local318 = local316;
							} else {
					...
					for (local316 = 0; local316 < local117; local316++) {
						...
						for (@Pc(489) int local489 = 0; local489 < local19; local489++) {
							local318 += local244.method22419(-118643075);
							@Pc(503) int local503;
							if (local25 == null) {
								local503 = local489;
							} else {
					...
					for (local254 = 0; local254 < local117; local254++) {
						...
						for (local261 = 0; local261 < local19; local261++) {
							local259 += local244.method22419(-118643075);
					...
					for (local261 = 0; local261 < local117; local261++) {
						...
						for (local318 = 0; local318 < local19; local318++) {
							local316 += local244.method22419(-118643075);
	...
	public void method30050(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public boolean method30051(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		if (this.method30111((byte) -1)) {
			@Pc(8) String local8 = arg0.toLowerCase();
			@Pc(17) int local17 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) 977);
			return this.method30092(local17, 432156995);
		} else {
			return false;
		}
	}
	...
	public synchronized boolean method30053(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (!this.method30048(arg0, arg1, (byte) 55)) {
			return false;
		} else if (this.anObjectArrayArray3[arg0] != null && this.anObjectArrayArray3[arg0][arg1] != null) {
			return true;
		} else if (this.anObjectArray43[arg0] == null) {
			this.method30122(arg0, -1199031414);
	...
	public synchronized boolean method30054(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (!this.method30111((byte) -1)) {
			return false;
		} else if (this.aClass486_2.anIntArray461.length == 1) {
			return this.method30053(0, arg0, 1341243327);
		} else if (!this.method30047(arg0, (byte) 1)) {
			return false;
		} else if (this.aClass486_2.anIntArray461[arg0] == 1) {
			return this.method30053(arg0, 0, -860819669);
		} else {
	...
	public synchronized boolean method30055(@OriginalArg(0) int arg0) {
		if (!this.method30111((byte) -1)) {
			...
			return this.method30053(0, arg0, -2022086031);
		} else if (!this.method30047(arg0, (byte) 1)) {
			return false;
		} else if (this.aClass486_2.anIntArray461[arg0] == 1) {
			return this.method30053(arg0, 0, 290447685);
		} else {
			throw new RuntimeException();
		}
	}
	...
	public int method30056(@OriginalArg(0) String arg0) {
		if (this.method30111((byte) -1)) {
			@Pc(8) String local8 = arg0.toLowerCase();
			@Pc(17) int local17 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) 3967);
			return this.method30047(local17, (byte) 1) ? local17 : -1;
		} else {
			return -1;
		}
	}
	...
	public synchronized int method30057(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.method30047(arg0, (byte) 1)) {
	...
	public synchronized int method30058(@OriginalArg(0) int arg0) {
		if (!this.method30111((byte) -1)) {
			return 0;
		}
		@Pc(7) int local7 = 0;
		...
		for (@Pc(11) int local11 = 0; local11 < this.anObjectArray43.length; local11++) {
			if (this.aClass486_2.anIntArray459[local11] > 0) {
				local7 += 100;
				local9 += this.method30057(local11, -1194790573);
			}
		}
		if (local7 == 0) {
			return 100;
	...
	public synchronized byte[] method30059(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		if (!this.method30111((byte) -1)) {
			return null;
		} else if (this.aClass486_2.anIntArray461.length == 1) {
			return this.method30044(0, arg0, (byte) 0);
		} else if (!this.method30047(arg0, (byte) 1)) {
			return null;
		} else if (this.aClass486_2.anIntArray461[arg0] == 1) {
			return this.method30044(arg0, 0, (byte) 0);
		} else {
			throw new RuntimeException();
		}
	}
	...
	public synchronized int[] method30060(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		if (!this.method30047(arg0, (byte) 1)) {
			return null;
		}
	...
	public synchronized boolean method30061(@OriginalArg(0) int arg0) {
		if (!this.method30111((byte) -1)) {
			return false;
		}
		...
		for (@Pc(9) int local9 = 0; local9 < this.aClass486_2.anIntArray456.length; local9++) {
			...
			if (this.anObjectArray43[local21] == null) {
				this.method30122(local21, -1199031414);
				if (this.anObjectArray43[local21] == null) {
					local7 = false;
				}
			}
	...
	public int method30062(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.method30047(arg0, (byte) 1) ? this.aClass486_2.anIntArray461[arg0] : 0;
	}

	@OriginalMember(owner = "client!py", name = "x", descriptor = "(B)I", line = 207)
	public int method30063(@OriginalArg(0) byte arg0) {
		return this.method30111((byte) -1) ? this.aClass486_2.anIntArray461.length : -1;
	}

	@OriginalMember(owner = "client!py", name = "b", descriptor = "(II)V", line = 212)
	public synchronized void method30064(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.method30047(arg0, (byte) 1) && this.anObjectArrayArray3 != null) {
			this.anObjectArrayArray3[arg0] = null;
		}
	}

	@OriginalMember(owner = "client!py", name = "h", descriptor = "(ZZB)V", line = 217)
	public void method30065(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) byte arg2) {
		if (!this.method30111((byte) -1)) {
			return;
		}
		if (arg0) {
		...
		if (arg1) {
			this.aClass486_2.anIntArrayArray59 = (int[][]) null;
			this.aClass486_2.aClass348Array1 = null;
		}
	}

	@OriginalMember(owner = "client!py", name = "a", descriptor = "(II[IB)Z", line = 229)
	synchronized boolean method30066(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) byte arg3) {
		if (!this.method30047(arg0, (byte) 1)) {
			return false;
		} else if (this.anObjectArray43[arg0] == null) {
			return false;
			...
			@Pc(104) byte[] local104;
			if (arg2 == null || arg2[0] == 0 && arg2[1] == 0 && arg2[2] == 0 && arg2[3] == 0) {
				local104 = Class331.method27386(this.anObjectArray43[arg0], false, 2090245629);
			} else {
				local104 = Class331.method27386(this.anObjectArray43[arg0], true, -1275986446);
				@Pc(109) Class93_Sub41 local109 = new Class93_Sub41(local104);
				local113 = local109.method22413((short) 16384);
				local117 = local109.method22419(-118643075);
				@Pc(127) int local127 = (local113 == Class484.aClass484_5.method36920() ? 5 : 9) + local117;
				local109.method22442(arg2, 5, local127, -2092552953);
			}
			@Pc(146) byte[] local146;
			try {
				local146 = Class506.method30222(local104, (byte) -25);
			} catch (@Pc(148) RuntimeException local148) {
				throw RuntimeException_Sub2.method23530(local148, (arg2 != null) + " " + arg0 + " " + local104.length + " " + Class154.method14146(local104, local104.length, -1503200612) + " " + Class154.method14146(local104, local104.length - 2, 539963248) + " " + this.aClass486_2.anIntArray455[arg0] + " " + this.aClass486_2.anInt5145 * 391791439);
			}
			if (this.aBoolean784) {
				this.anObjectArray43[arg0] = null;
			}
	...
	public int method30067(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		if (this.method30111((byte) -1)) {
			@Pc(8) String local8 = arg0.toLowerCase();
			@Pc(17) int local17 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) -13268);
			return this.method30047(local17, (byte) 1) ? local17 : -1;
		} else {
			return -1;
		}
	...
	public int method30068(@OriginalArg(0) int arg0, @OriginalArg(1) short arg1) {
		if (this.method30111((byte) -1)) {
			@Pc(12) int local12 = this.aClass486_2.aClass348_1.method27619(arg0, (short) 11239);
			return this.method30047(local12, (byte) 1) ? local12 : -1;
		} else {
			return -1;
		}
	}
	...
	public boolean method30069(@OriginalArg(0) String arg0, @OriginalArg(1) byte arg1) {
		if (this.method30111((byte) -1)) {
			@Pc(8) String local8 = arg0.toLowerCase();
			@Pc(17) int local17 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) -7029);
			return local17 >= 0;
		} else {
			return false;
		}
	...
	public boolean method30070(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		if (!this.method30111((byte) -1)) {
			return false;
		}
		@Pc(8) String local8 = arg0.toLowerCase();
		@Pc(11) String local11 = arg1.toLowerCase();
		@Pc(20) int local20 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) 20222);
		if (local20 < 0) {
			return false;
		} else {
			@Pc(35) int local35 = this.aClass486_2.aClass348Array1[local20].method27619(Class295.method26602(local11, (byte) 35), (short) -5856);
			return local35 >= 0;
		}
	}

	@OriginalMember(owner = "client!py", name = "ae", descriptor = "(Ljava/lang/String;Ljava/lang/String;I)[B", line = 399)
	public synchronized byte[] method30071(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		if (!this.method30111((byte) -1)) {
			return null;
		}
		@Pc(8) String local8 = arg0.toLowerCase();
		@Pc(11) String local11 = arg1.toLowerCase();
		@Pc(20) int local20 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) -23586);
		if (this.method30047(local20, (byte) 1)) {
			@Pc(38) int local38 = this.aClass486_2.aClass348Array1[local20].method27619(Class295.method26602(local11, (byte) 35), (short) -2947);
			return this.method30044(local20, local38, (byte) 0);
		} else {
			return null;
		}
	}
	...
	public boolean method30073(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		@Pc(4) int local4 = this.method30067("", -1497248091);
		return local4 == -1 ? this.method30103(arg0, "", 936770656) : this.method30103("", arg0, 936770656);
	}
	...
	public byte[] method30074(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.method30079(arg0, arg1, (int[]) null, (byte) -7);
	}
	...
	public synchronized int method30075() {
		...
		for (@Pc(11) int local11 = 0; local11 < this.anObjectArray43.length; local11++) {
			if (this.aClass486_2.anIntArray459[local11] > 0) {
				local7 += 100;
				local9 += this.method30057(local11, -168945733);
			}
		}
		if (local7 == 0) {
			return 100;
	...
	public synchronized byte[] method30079(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) byte arg3) {
		if (!this.method30048(arg0, arg1, (byte) 23)) {
			return null;
		}
		@Pc(9) byte[] local9 = null;
		if (this.anObjectArrayArray3[arg0] == null || this.anObjectArrayArray3[arg0][arg1] == null) {
			@Pc(30) boolean local30 = this.method30066(arg0, arg1, arg2, (byte) 0);
			if (!local30) {
				this.method30122(arg0, -1199031414);
				local30 = this.method30066(arg0, arg1, arg2, (byte) 0);
				if (!local30) {
					return null;
				}
			}
		...
		if (this.anObjectArrayArray3[arg0][arg1] != null) {
			local9 = Class331.method27386(this.anObjectArrayArray3[arg0][arg1], false, 1811130136);
			if (local9 == null) {
				throw new RuntimeException("");
			}
		}
	...
	public synchronized byte[] method30085(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1) {
		...
		@Pc(8) String local8 = arg0.toLowerCase();
		@Pc(11) String local11 = arg1.toLowerCase();
		@Pc(20) int local20 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) -16460);
		if (this.method30047(local20, (byte) 1)) {
			@Pc(38) int local38 = this.aClass486_2.aClass348Array1[local20].method27619(Class295.method26602(local11, (byte) 35), (short) 10258);
			return this.method30044(local20, local38, (byte) 0);
		} else {
			return null;
		}
	...
	boolean method30086(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1) {
		...
		@Pc(8) String local8 = arg0.toLowerCase();
		@Pc(11) String local11 = arg1.toLowerCase();
		@Pc(20) int local20 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) 16202);
		if (this.method30047(local20, (byte) 1)) {
			@Pc(38) int local38 = this.aClass486_2.aClass348Array1[local20].method27619(Class295.method26602(local11, (byte) 35), (short) 22640);
			return this.method30053(local20, local38, 1893428520);
		} else {
			return false;
		}
	}
	...
	public byte[] method30089(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.method30079(arg0, arg1, (int[]) null, (byte) -36);
	}
	...
	public synchronized byte[] method30091(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2) {
		if (!this.method30048(arg0, arg1, (byte) -16)) {
			return null;
		}
		@Pc(9) byte[] local9 = null;
		if (this.anObjectArrayArray3[arg0] == null || this.anObjectArrayArray3[arg0][arg1] == null) {
		...
		if (this.anObjectArrayArray3[arg0][arg1] != null) {
			local9 = Class331.method27386(this.anObjectArrayArray3[arg0][arg1], false, 1598481614);
			if (local9 == null) {
				throw new RuntimeException("");
			}
		}
	...
	public synchronized boolean method30092(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (!this.method30047(arg0, (byte) 1)) {
			return false;
		} else if (this.anObjectArray43[arg0] == null) {
			this.method30122(arg0, -1199031414);
	...
	public boolean method30094(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (!this.method30111((byte) -1)) {
			return false;
		} else if (this.aClass486_2.anIntArray461.length == 1) {
			return this.method30048(0, arg0, (byte) -94);
		} else if (!this.method30047(arg0, (byte) 1)) {
			return false;
		} else if (this.aClass486_2.anIntArray461[arg0] == 1) {
			return this.method30048(arg0, 0, (byte) -30);
		} else {
			throw new RuntimeException();
		}
	}
	...
	public boolean method30097(@OriginalArg(0) int arg0) {
		if (!this.method30111((byte) -1)) {
			...
			return this.method30048(0, arg0, (byte) -40);
		} else if (!this.method30047(arg0, (byte) 1)) {
			return false;
		} else if (this.aClass486_2.anIntArray461[arg0] == 1) {
			return this.method30048(arg0, 0, (byte) 43);
		} else {
			throw new RuntimeException();
		}
	}
	...
	synchronized boolean method30102(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2) {
		if (!this.method30047(arg0, (byte) 1)) {
			...
			@Pc(104) byte[] local104;
			if (arg2 == null || arg2[0] == 0 && arg2[1] == 0 && arg2[2] == 0 && arg2[3] == 0) {
				local104 = Class331.method27386(this.anObjectArray43[arg0], false, -1250177665);
			} else {
				local104 = Class331.method27386(this.anObjectArray43[arg0], true, -274475759);
				@Pc(109) Class93_Sub41 local109 = new Class93_Sub41(local104);
				local113 = local109.method22413((short) 16384);
				local117 = local109.method22419(-118643075);
				@Pc(127) int local127 = (local113 == Class484.aClass484_5.method36920() ? 5 : 9) + local117;
				local109.method22442(arg2, 5, local127, -2044400234);
			}
			@Pc(146) byte[] local146;
			try {
				local146 = Class506.method30222(local104, (byte) -25);
			} catch (@Pc(148) RuntimeException local148) {
				throw RuntimeException_Sub2.method23530(local148, (arg2 != null) + " " + arg0 + " " + local104.length + " " + Class154.method14146(local104, local104.length, 492838196) + " " + Class154.method14146(local104, local104.length - 2, -768794211) + " " + this.aClass486_2.anIntArray455[arg0] + " " + this.aClass486_2.anInt5145 * 391791439);
			}
			if (this.aBoolean784) {
				this.anObjectArray43[arg0] = null;
			}
	...
	boolean method30103(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		if (!this.method30111((byte) -1)) {
			return false;
		}
		@Pc(8) String local8 = arg0.toLowerCase();
		@Pc(11) String local11 = arg1.toLowerCase();
		@Pc(20) int local20 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) -18017);
		if (this.method30047(local20, (byte) 1)) {
			@Pc(38) int local38 = this.aClass486_2.aClass348Array1[local20].method27619(Class295.method26602(local11, (byte) 35), (short) -8187);
			return this.method30053(local20, local38, 1679883659);
		} else {
			return false;
		}
	}
	...
	synchronized boolean method30108(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2) {
		if (!this.method30047(arg0, (byte) 1)) {
			...
			@Pc(104) byte[] local104;
			if (arg2 == null || arg2[0] == 0 && arg2[1] == 0 && arg2[2] == 0 && arg2[3] == 0) {
				local104 = Class331.method27386(this.anObjectArray43[arg0], false, 1976260878);
			} else {
				local104 = Class331.method27386(this.anObjectArray43[arg0], true, -1072843845);
				@Pc(109) Class93_Sub41 local109 = new Class93_Sub41(local104);
				local113 = local109.method22413((short) 16384);
				local117 = local109.method22419(-118643075);
				@Pc(127) int local127 = (local113 == Class484.aClass484_5.method36920() ? 5 : 9) + local117;
				local109.method22442(arg2, 5, local127, -2083254910);
			}
			@Pc(146) byte[] local146;
			try {
				local146 = Class506.method30222(local104, (byte) -38);
			} catch (@Pc(148) RuntimeException local148) {
				throw RuntimeException_Sub2.method23530(local148, (arg2 != null) + " " + arg0 + " " + local104.length + " " + Class154.method14146(local104, local104.length, -540062567) + " " + Class154.method14146(local104, local104.length - 2, 493735020) + " " + this.aClass486_2.anIntArray455[arg0] + " " + this.aClass486_2.anInt5145 * 391791439);
			}
			if (this.aBoolean784) {
				this.anObjectArray43[arg0] = null;
			}
	...
	public boolean method30110(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1) {
		...
		@Pc(8) String local8 = arg0.toLowerCase();
		@Pc(11) String local11 = arg1.toLowerCase();
		@Pc(20) int local20 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) -2119);
		if (local20 < 0) {
			return false;
		} else {
			@Pc(35) int local35 = this.aClass486_2.aClass348Array1[local20].method27619(Class295.method26602(local11, (byte) 35), (short) -3548);
			return local35 >= 0;
		}
	}

	@OriginalMember(owner = "client!py", name = "e", descriptor = "(B)Z", line = 32)
	synchronized boolean method30111(@OriginalArg(0) byte arg0) {
		if (this.aClass486_2 == null) {
	...
	public int method30112(@OriginalArg(0) String arg0) {
		if (this.method30111((byte) -1)) {
			@Pc(8) String local8 = arg0.toLowerCase();
			@Pc(17) int local17 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) 311);
			return this.method30047(local17, (byte) 1) ? local17 : -1;
		} else {
			return -1;
		}
	...
	public int method30113(@OriginalArg(0) String arg0) {
		if (this.method30111((byte) -1)) {
			@Pc(8) String local8 = arg0.toLowerCase();
			@Pc(17) int local17 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) 21475);
			return this.method30047(local17, (byte) 1) ? local17 : -1;
		} else {
			return -1;
		}
	...
	boolean method30114(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1) {
		...
		@Pc(8) String local8 = arg0.toLowerCase();
		@Pc(11) String local11 = arg1.toLowerCase();
		@Pc(20) int local20 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) 12984);
		if (this.method30047(local20, (byte) 1)) {
			@Pc(38) int local38 = this.aClass486_2.aClass348Array1[local20].method27619(Class295.method26602(local11, (byte) 35), (short) 817);
			return this.method30053(local20, local38, -1657674875);
		} else {
			return false;
		}
	}
	...
	public boolean method30115(@OriginalArg(0) String arg0) {
		if (this.method30111((byte) -1)) {
			@Pc(8) String local8 = arg0.toLowerCase();
			@Pc(17) int local17 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) -22057);
			return local17 >= 0;
		} else {
			return false;
		}
	...
	public synchronized boolean method30116(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (!this.method30048(arg0, arg1, (byte) 25)) {
			return false;
		} else if (this.anObjectArrayArray3[arg0] != null && this.anObjectArrayArray3[arg0][arg1] != null) {
			return true;
		} else if (this.anObjectArray43[arg0] == null) {
	...
	public boolean method30117(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1) {
		...
		@Pc(8) String local8 = arg0.toLowerCase();
		@Pc(11) String local11 = arg1.toLowerCase();
		@Pc(20) int local20 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) 20494);
		if (local20 < 0) {
			return false;
		} else {
			@Pc(35) int local35 = this.aClass486_2.aClass348Array1[local20].method27619(Class295.method26602(local11, (byte) 35), (short) 21344);
			return local35 >= 0;
		}
	}
	...
	public boolean method30118(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1) {
		...
		@Pc(8) String local8 = arg0.toLowerCase();
		@Pc(11) String local11 = arg1.toLowerCase();
		@Pc(20) int local20 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) 3745);
		if (local20 < 0) {
			return false;
		} else {
			@Pc(35) int local35 = this.aClass486_2.aClass348Array1[local20].method27619(Class295.method26602(local11, (byte) 35), (short) 24345);
			return local35 >= 0;
		}
	}
	...
	public boolean method30119(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1) {
		...
		@Pc(8) String local8 = arg0.toLowerCase();
		@Pc(11) String local11 = arg1.toLowerCase();
		@Pc(20) int local20 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) -19201);
		if (local20 < 0) {
			return false;
		} else {
			@Pc(35) int local35 = this.aClass486_2.aClass348Array1[local20].method27619(Class295.method26602(local11, (byte) 35), (short) 13273);
			return local35 >= 0;
		}
	}
	...
	public synchronized byte[] method30120(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1) {
		...
		@Pc(8) String local8 = arg0.toLowerCase();
		@Pc(11) String local11 = arg1.toLowerCase();
		@Pc(20) int local20 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) 16314);
		if (this.method30047(local20, (byte) 1)) {
			@Pc(38) int local38 = this.aClass486_2.aClass348Array1[local20].method27619(Class295.method26602(local11, (byte) 35), (short) -16555);
			return this.method30044(local20, local38, (byte) 0);
		} else {
			return null;
		}
	...
	synchronized boolean method30121(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2) {
		if (!this.method30047(arg0, (byte) 1)) {
			...
			@Pc(104) byte[] local104;
			if (arg2 == null || arg2[0] == 0 && arg2[1] == 0 && arg2[2] == 0 && arg2[3] == 0) {
				local104 = Class331.method27386(this.anObjectArray43[arg0], false, -1154106022);
			} else {
				local104 = Class331.method27386(this.anObjectArray43[arg0], true, 1964402896);
				@Pc(109) Class93_Sub41 local109 = new Class93_Sub41(local104);
				local113 = local109.method22413((short) 16384);
				local117 = local109.method22419(-118643075);
				@Pc(127) int local127 = (local113 == Class484.aClass484_5.method36920() ? 5 : 9) + local117;
				local109.method22442(arg2, 5, local127, -2089227421);
			}
			@Pc(146) byte[] local146;
			try {
				local146 = Class506.method30222(local104, (byte) -22);
			} catch (@Pc(148) RuntimeException local148) {
				throw RuntimeException_Sub2.method23530(local148, (arg2 != null) + " " + arg0 + " " + local104.length + " " + Class154.method14146(local104, local104.length, -203750692) + " " + Class154.method14146(local104, local104.length - 2, -1952842100) + " " + this.aClass486_2.anIntArray455[arg0] + " " + this.aClass486_2.anInt5145 * 391791439);
			}
			if (this.aBoolean784) {
				this.anObjectArray43[arg0] = null;
			}
	...
	synchronized void method30122(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.aBoolean784) {
			this.anObjectArray43[arg0] = this.aClass143_1.method11051(arg0, -644651081);
		} else {
			this.anObjectArray43[arg0] = Class113.method7411(this.aClass143_1.method11051(arg0, -644651081), false, 1215292027);
	...
	public int method30128(@OriginalArg(0) String arg0) {
		if (this.method30111((byte) -1)) {
			@Pc(8) String local8 = arg0.toLowerCase();
			@Pc(17) int local17 = this.aClass486_2.aClass348_1.method27619(Class295.method26602(local8, (byte) 35), (short) 23428);
			return this.method30057(local17, -527415343);
		} else {
			return 0;
		}
	}
	...
	static long method30129(@OriginalArg(0) Interface61 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(1) long local1 = 4194304L;
		@Pc(3) long local3 = Long.MIN_VALUE;
		@Pc(13) Class610 local13 = (Class610) client.aClass532_1.method30466(1877474569).method18261(arg0.method13423(-1037211373), 1104549899);
	...
	static final void method30130(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		Class51.aClass93_Sub36_1.method14357(Class51.aClass93_Sub36_1.aClass166_Sub41_1, arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091] == 0 ? 0 : 1, (byte) 65);
		Class106_Sub1.method5148(452662493);
	}

	@OriginalMember(owner = "client!py", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 269)
	public static int method30131(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		return Class166_Sub13.aTwitchTV1.ChatSendMessage(arg0);
	}

	@OriginalMember(owner = "client!py", name = "ai", descriptor = "(IIB)V", line = 938)
	static void method30132(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
	...
	static final void method30133(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
