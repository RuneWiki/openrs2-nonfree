...
public class Class254 {
	...
	public static Class321 method26002(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		@Pc(18) int local18 = arg0.method22419();
		@Pc(21) Object[] local21 = new Object[local3];
		for (@Pc(23) int local23 = 0; local23 < local3; local23++) {
			@Pc(30) int local30 = arg0.method22413();
			if (local30 == 0) {
				local21[local23] = Class500.method30157(Integer.class).method30272(arg0);
			} else if (local30 == 1) {
				local21[local23] = Class500.method30157(String.class).method30272(arg0);
			} else {
	...
	void method25996(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		this.anInt3852 = arg0.method22482() * 1655674161;
		this.aFloat281 = arg0.method22425();
		this.aFloat282 = arg0.method22425();
		this.aFloat283 = arg0.method22425();
		this.aFloat284 = arg0.method22425();
		this.aFloat280 = arg0.method22425();
	}

	@OriginalMember(owner = "client!ey", name = "n", descriptor = "(Lclient!alw;I)V", line = 17)
	void method25997(@OriginalArg(0) Class93_Sub41 arg0) {
		this.anInt3852 = arg0.method22482() * 1655674161;
		this.aFloat281 = arg0.method22425();
		this.aFloat282 = arg0.method22425();
		this.aFloat283 = arg0.method22425();
	...
	static void method26001(@OriginalArg(0) int arg0) {
		@Pc(4) byte local4;
		if (arg0 == 0) {
			local4 = 0;
		} else if (arg0 == 1) {
	...
	static final void method25999(@OriginalArg(0) Class681 arg0) {
	...
	static final void method26000(@OriginalArg(0) Class681 arg0) {
		...
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class293.method26590(local13);
	}
}
