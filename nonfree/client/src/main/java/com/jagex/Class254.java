...
public class Class254 {
	...
	void method25996(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt3852 = arg0.method22482((byte) -97) * 1655674161;
		this.aFloat281 = arg0.method22425(-58104609);
		this.aFloat282 = arg0.method22425(1068792815);
		this.aFloat283 = arg0.method22425(-805718494);
		this.aFloat284 = arg0.method22425(48844432);
		this.aFloat280 = arg0.method22425(1350052354);
	}
	...
	void method25997(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		this.anInt3852 = arg0.method22482((byte) -11) * 1655674161;
		this.aFloat281 = arg0.method22425(521915274);
		this.aFloat282 = arg0.method22425(1270832534);
		this.aFloat283 = arg0.method22425(-1173402327);
		this.aFloat284 = arg0.method22425(-813941282);
		this.aFloat280 = arg0.method22425(1986596422);
	}

	@OriginalMember(owner = "client!ey", name = "e", descriptor = "(B)[Lclient!vs;", line = 11)
	static Class623[] method25998(@OriginalArg(0) byte arg0) {
	...
	static final void method25999(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method26000(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(13) String local13 = (String) arg0.anObjectArray45[(arg0.anInt5888 -= 957530791) * 587908375];
		if (local13.startsWith(Class346.method27570(0, -1614681388)) || local13.startsWith(Class346.method27570(1, -1614681388))) {
			local13 = local13.substring(7);
		}
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class293.method26590(local13, 1534163482);
	}

	@OriginalMember(owner = "client!ey", name = "eo", descriptor = "(II)V", line = 635)
	static void method26001(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(4) byte local4;
		if (arg0 == 0) {
			local4 = 0;
		} else if (arg0 == 1) {
	...
	public static Class321 method26002(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(18) int local18 = arg0.method22419(-118643075);
		@Pc(21) Object[] local21 = new Object[local3];
		for (@Pc(23) int local23 = 0; local23 < local3; local23++) {
			@Pc(30) int local30 = arg0.method22413((short) 16384);
			if (local30 == 0) {
				local21[local23] = Class500.method30157(Integer.class, -47609621).method30272(arg0, -1187347627);
			} else if (local30 == 1) {
				local21[local23] = Class500.method30157(String.class, -47609621).method30272(arg0, -1187347627);
			} else {
