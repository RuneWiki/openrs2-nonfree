...
public class Class589 implements Runnable {
	...
	public static String method31682(@OriginalArg(0) Object[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg2 == 0) {
			return "";
		} else if (arg2 == 1) {
	...
	int method31658() throws IOException {
		synchronized (this) {
			@Pc(22) int local22;
			if (this.anInt5473 * -307665657 <= this.anInt5474 * -1004754881) {
	...
	int method31663(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
		if (arg2 < 0 || arg1 < 0 || arg1 + arg2 > arg0.length) {
			throw new IOException();
		}
		synchronized (this) {
