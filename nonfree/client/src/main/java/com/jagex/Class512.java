...
final class Class512 implements Interface9 {
	...
	public Object method30271(@OriginalArg(0) Class93_Sub41 arg0) {
		return Class254.method26002(arg0, 315165959);
	}
	...
	public Object method30270(@OriginalArg(0) Class93_Sub41 arg0) {
		return Class254.method26002(arg0, 622103345);
	}
	...
	public Object method30272(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		return Class254.method26002(arg0, -1654754142);
	}

	@OriginalMember(owner = "client!qo", name = "f", descriptor = "(II)V", line = 99)
	public static void method30256(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		Class567.anInt5388 = arg0 * 655720961;
	}

	@OriginalMember(owner = "client!qo", name = "l", descriptor = "(III)Lclient!asg;", line = 54)
	public static Class93_Sub1_Sub15 method30257(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	static final void method30258(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method30259(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = arg0.aClass132_Sub1_Sub5_Sub1_1.method24275(899866876);
	}

	@OriginalMember(owner = "client!qo", name = "k", descriptor = "(Lclient!dn;FZI)F", line = 135)
	static float method30260(@OriginalArg(0) Class230 arg0, @OriginalArg(1) float arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3) {
	...
	static final void method30261(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		Class274.aClass258_1.method26074(Class275.aClass275_9, local13, local23, local35, Class280.aClass280_7.method26450(-707353186), Class278.aClass278_2, 0.0F, 0.0F, (Class472) null, 0, local37, local33, 462200463);
	}

	@OriginalMember(owner = "client!qo", name = "apw", descriptor = "(Lclient!yf;I)V", line = 12648)
	static final void method30262(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) throws Exception_Sub3 {
		...
		Class65.aClass123_Sub1_2.method8942(Class472.method29529(local14, local25, local36), local49, 1189701933);
	}
}
