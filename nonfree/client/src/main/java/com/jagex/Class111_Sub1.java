...
public class Class111_Sub1 extends Class111 {
	...
	public boolean method6770(@OriginalArg(0) Class616 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class609 arg3, @OriginalArg(4) float arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean arg7) {
		...
		if (Class616.aClass616_2 == arg0) {
			if (arg2 > -1 && this.aClass497_20.method30094(arg2, -1170599515)) {
				local1 = this.aClass497_20.method30054(arg2, -512225963);
			}
			return local1 & this.aClass497_20.method30054(arg1, -512225963);
		} else if (Class616.aClass616_1 == arg0) {
			return this.aClass497_20.method30054(arg1, -512225963);
		} else if (arg0 == Class616.aClass616_3) {
			return this.aClass497_20.method30054(arg2, -512225963);
		} else {
			return false;
		}
	}
	...
	byte[] method6784(@OriginalArg(0) Class616 arg0, @OriginalArg(1) int arg1) {
		return this.aClass497_20.method30094(arg1, -1170599515) ? this.aClass497_20.method30059(arg1, (byte) 23) : null;
	}
	...
	byte[] method6794(@OriginalArg(0) Class616 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		return this.aClass497_20.method30094(arg1, -1170599515) ? this.aClass497_20.method30059(arg1, (byte) 103) : null;
	}
	...
	byte[] method6785(@OriginalArg(0) Class616 arg0, @OriginalArg(1) int arg1) {
		return this.aClass497_20.method30094(arg1, -1170599515) ? this.aClass497_20.method30059(arg1, (byte) 94) : null;
	}
}
