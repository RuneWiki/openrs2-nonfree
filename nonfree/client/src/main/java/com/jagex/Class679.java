...
public class Class679 {
	...
	public Class132_Sub1_Sub5_Sub1 method33234(@OriginalArg(0) int arg0) {
		...
		@Pc(34) Class611 local34 = client.aClass532_1.method30443(1738778102);
		...
		if (local45 >= 0 && local56 >= 0 && local45 < client.aClass532_1.method30444(-655527418) && local56 < client.aClass532_1.method30474((short) 128) && client.aClass532_1.method30459(-1937321968) != null) {
			for (@Pc(80) Class93_Sub3 local80 = (Class93_Sub3) local25.aClass22_17.method445((byte) 87); local80 != null; local80 = (Class93_Sub3) local25.aClass22_17.method415(1312498463)) {
				if (local80.anInt1405 * -308533965 == this.anInt5887 * -1840455417) {
					return (Class132_Sub1_Sub5_Sub1) client.aClass532_1.method30459(-1911750433).method31465(this.aClass611_3.anInt5625 * -78984409, local45, local56, (byte) -81);
				}
			}
		}
		return null;
	...
	public Class132_Sub1_Sub5_Sub1 method33235() {
		...
		@Pc(34) Class611 local34 = client.aClass532_1.method30443(1717907315);
		@Pc(45) int local45 = this.aClass611_3.anInt5623 * 270611681 - local34.anInt5623 * 270611681;
		@Pc(56) int local56 = this.aClass611_3.anInt5624 * -1994307635 - local34.anInt5624 * -1994307635;
		if (local45 >= 0 && local56 >= 0 && local45 < client.aClass532_1.method30444(213030222) && local56 < client.aClass532_1.method30474((short) 128) && client.aClass532_1.method30459(-1968482691) != null) {
			for (@Pc(80) Class93_Sub3 local80 = (Class93_Sub3) local25.aClass22_17.method445((byte) 101); local80 != null; local80 = (Class93_Sub3) local25.aClass22_17.method415(1246770939)) {
				if (local80.anInt1405 * -308533965 == this.anInt5887 * -1840455417) {
					return (Class132_Sub1_Sub5_Sub1) client.aClass532_1.method30459(-1112053277).method31465(this.aClass611_3.anInt5625 * -78984409, local45, local56, (byte) -52);
				}
			}
		}
		return null;
	...
	static final void method33236(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(43) Class304 local43 = Class557.aClass297_1.method26622(local13, 161193133);
		if (local43.method26761(-2096859585) == null) {
			local43.method26760(client.anInterface27_1, (byte) 96);
		}
		if (!local28) {
			@Pc(144) Class379 local144 = (Class379) Class30.aClass32_Sub16_1.method18261(local38, 1343530537);
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = local144.method28080(local43.method26761(-2067389413).method781(local144.aClass108_1.anInt867 * -1284841473, -1267242705), 1071523002);
			return;
		}
		...
		switch(local59.aClass519_6.aClass500_7.anInt5196 * -1217885029) {
			case 2:
				arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = local43.method26761(-2128181752).method781(local59.anInt867 * -1284841473, -1267242705);
				break;
			case 4:
				arg0.aLongArray27[(arg0.anInt5894 += -1364417339) * -2000995827 - 1] = local43.method26761(-2048218209).method779(local59.anInt867 * -1284841473, 1355171314);
				break;
			default:
				arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = local43.method26761(-2104431627).method775(local59.anInt867 * -1284841473, -1328918181);
		}
	}

	@OriginalMember(owner = "client!yd", name = "k", descriptor = "(Lclient!alw;I)Lclient!kp;", line = 16)
	public static Class125 method33237(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
	...
	static boolean method33238(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
