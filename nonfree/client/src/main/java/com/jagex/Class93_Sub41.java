...
public class Class93_Sub41 extends Class93 {
	...
	public int method22387() {
		...
		return local9 < 128 ? this.method22413((short) 16384) - 64 : this.method22415(-1434290800) - 49152;
	}
	...
	public void method22388(@OriginalArg(0) int[] arg0) {
		...
		for (@Pc(11) int local11 = 0; local11 < local6; local11++) {
			@Pc(18) int local18 = this.method22419(-118643075);
			@Pc(22) int local22 = this.method22419(-118643075);
			...
			this.method22395(local18, (byte) 3);
			this.method22395(local22, (byte) 21);
		}
	}

	@OriginalMember(owner = "client!alw", name = "bv", descriptor = "(I)B", line = 585)
	public byte method22389(@OriginalArg(0) int arg0) {
	...
	public int method22390(@OriginalArg(0) int arg0) {
	...
	public void method22393(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public void method22395(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	...
	public void method22396(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) arg0;
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 8);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 16);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 24);
	...
	public void method22397(@OriginalArg(0) long arg0) {
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (int) (arg0 >> 32);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (int) (arg0 >> 24);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (int) (arg0 >> 16);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (int) (arg0 >> 8);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (int) arg0;
	}

	@OriginalMember(owner = "client!alw", name = "d", descriptor = "(J)V", line = 119)
	public void method22398(@OriginalArg(0) long arg0) {
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (int) (arg0 >> 40);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (int) (arg0 >> 32);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (int) (arg0 >> 24);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (int) (arg0 >> 16);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (int) (arg0 >> 8);
	...
	public void method22399(@OriginalArg(0) long arg0) {
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (int) (arg0 >> 56);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (int) (arg0 >> 48);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (int) (arg0 >> 40);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (int) (arg0 >> 32);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (int) (arg0 >> 24);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (int) (arg0 >> 16);
	...
	public void method22401(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		this.method22510(arg0 ? 1 : 0, (byte) -24);
	}

	@OriginalMember(owner = "client!alw", name = "x", descriptor = "(Ljava/lang/String;I)V", line = 159)
	public void method22402(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		@Pc(3) int local3 = arg0.indexOf(0);
		if (local3 >= 0) {
			throw new IllegalArgumentException("");
		}
		this.anInt3070 += Class444.method28883(arg0, 0, arg0.length(), this.aByteArray58, this.anInt3070 * 212851357, -1245289712) * -1445626955;
	...
	public void method22403(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		@Pc(3) int local3 = arg0.indexOf(0);
		if (local3 >= 0) {
			throw new IllegalArgumentException("");
		}
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = 0;
		this.anInt3070 += Class444.method28883(arg0, 0, arg0.length(), this.aByteArray58, this.anInt3070 * 212851357, -950731040) * -1445626955;
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = 0;
	}

	@OriginalMember(owner = "client!alw", name = "g", descriptor = "(Ljava/lang/CharSequence;I)V", line = 178)
	public void method22404(@OriginalArg(0) CharSequence arg0, @OriginalArg(1) int arg1) {
		@Pc(3) int local3 = Class587.method31643(arg0, -74374927);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = 0;
		this.method22412(local3, 534011993);
	...
	public void method22405(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	public void method22407(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public int method22408(@OriginalArg(0) int arg0) {
		this.anInt3070 += -41913569;
	...
	public void method22411(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 < -1) {
			throw new IllegalArgumentException();
		} else if (arg0 == -1) {
			this.method22454(32767, 2134029885);
		} else if (arg0 < 32767) {
			this.method22454(arg0, 2138745190);
		} else {
			this.method22395(arg0, (byte) -53);
	...
	void method22412(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if ((arg0 & 0xFFFFFF80) != 0) {
			if ((arg0 & 0xFFFFC000) != 0) {
				if ((arg0 & 0xFFE00000) != 0) {
					if ((arg0 & 0xF0000000) != 0) {
						this.method22510(arg0 >>> 28 | 0x80, (byte) -26);
					}
					this.method22510(arg0 >>> 21 | 0x80, (byte) -76);
				}
				this.method22510(arg0 >>> 14 | 0x80, (byte) -11);
			}
			this.method22510(arg0 >>> 7 | 0x80, (byte) -69);
		}
		this.method22510(arg0 & 0x7F, (byte) -74);
	}

	@OriginalMember(owner = "client!alw", name = "ai", descriptor = "(S)I", line = 265)
	public int method22413(@OriginalArg(0) short arg0) {
	...
	public byte method22414(@OriginalArg(0) int arg0) {
	...
	public int method22415(@OriginalArg(0) int arg0) {
		this.anInt3070 += 1403713386;
	...
	public void method22416(@OriginalArg(0) BigInteger arg0, @OriginalArg(1) BigInteger arg1, @OriginalArg(2) byte arg2) {
		@Pc(4) int local4 = this.anInt3070 * 212851357;
		this.anInt3070 = 0;
		@Pc(10) byte[] local10 = new byte[local4];
		this.method22430(local10, 0, local4, (short) 18161);
		...
		this.anInt3070 = 0;
		this.method22454(local29.length, 2129263681);
		this.method22405(local29, 0, local29.length, 2026842986);
	}

	@OriginalMember(owner = "client!alw", name = "ad", descriptor = "(S)I", line = 285)
	public int method22417(@OriginalArg(0) short arg0) {
		this.anInt3070 += -41913569;
	...
	public int method22419(@OriginalArg(0) int arg0) {
		this.anInt3070 += -1487540524;
	...
	public int method22420(@OriginalArg(0) byte arg0) {
		this.anInt3070 += -1487540524;
	...
	public void method22421(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(13) int local13 = local0 * 8; local13 >= 0; local13 -= 8) {
			this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (int) (arg0 >> local13);
		}
	}

	@OriginalMember(owner = "client!alw", name = "aq", descriptor = "(I)J", line = 313)
	public long method22422(@OriginalArg(0) int arg0) {
		@Pc(6) long local6 = (long) this.method22415(-1434290800) & 0xFFFFFFFFL;
		@Pc(13) long local13 = (long) this.method22419(-118643075) & 0xFFFFFFFFL;
		return (local6 << 32) + local13;
	}

	@OriginalMember(owner = "client!alw", name = "ax", descriptor = "(I)J", line = 319)
	public long method22423(@OriginalArg(0) int arg0) {
		@Pc(6) long local6 = (long) this.method22419(-118643075) & 0xFFFFFFFFL;
		@Pc(13) long local13 = (long) this.method22419(-118643075) & 0xFFFFFFFFL;
		return (local6 << 32) + local13;
	}

	@OriginalMember(owner = "client!alw", name = "av", descriptor = "(II)J", line = 325)
	public long method22424(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(0) int local0 = arg0 - 1;
		if (local0 < 0 || local0 > 7) {
			throw new IllegalArgumentException();
		}
	...
	public String method22428(@OriginalArg(0) int arg0) {
		...
		return local51 == 0 ? "" : Class155.method15308(this.aByteArray58, local26, local51, (byte) -47);
	}

	@OriginalMember(owner = "client!alw", name = "az", descriptor = "(I)Ljava/lang/String;", line = 369)
	public String method22429(@OriginalArg(0) int arg0) {
		@Pc(14) byte local14 = this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1];
		if (local14 != 0) {
			throw new IllegalStateException("");
		}
		@Pc(26) int local26 = this.method22437(1110966645);
	...
	public void method22430(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) short arg3) {
	...
	public int method22431(@OriginalArg(0) int arg0) {
		@Pc(9) int local9 = this.aByteArray58[this.anInt3070 * 212851357] & 0xFF;
		return local9 < 128 ? this.method22413((short) 16384) - 64 : this.method22415(-1434290800) - 49152;
	}
	...
	public int method22432() {
		if (this.aByteArray58[this.anInt3070 * 212851357] < 0) {
			return this.method22419(-118643075) & Integer.MAX_VALUE;
		} else {
			@Pc(17) int local17 = this.method22415(-1434290800);
			return local17 == 32767 ? -1 : local17;
		}
	}

	@OriginalMember(owner = "client!alw", name = "an", descriptor = "(B)I", line = 395)
	public int method22433(@OriginalArg(0) byte arg0) {
		@Pc(9) int local9 = this.aByteArray58[this.anInt3070 * 212851357] & 0xFF;
		return local9 < 128 ? this.method22413((short) 16384) - 1 : this.method22415(-1434290800) - 32769;
	}
	...
	public int method22435(@OriginalArg(0) int arg0) {
		return this.aByteArray58[this.anInt3070 * 212851357] < 0 ? this.method22419(-118643075) & Integer.MAX_VALUE : this.method22415(-1434290800);
	}

	@OriginalMember(owner = "client!alw", name = "bk", descriptor = "(I)I", line = 417)
	public int method22436(@OriginalArg(0) int arg0) {
		if (this.aByteArray58[this.anInt3070 * 212851357] < 0) {
			return this.method22419(-118643075) & Integer.MAX_VALUE;
		} else {
			@Pc(17) int local17 = this.method22415(-1434290800);
	...
	int method22437(@OriginalArg(0) int arg0) {
		@Pc(14) byte local14 = this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1];
		@Pc(16) int local16 = 0;
		while (local14 < 0) {
	...
	public void method22438(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		for (@Pc(17) int local17 = 0; local17 < local15; local17++) {
			@Pc(24) int local24 = this.method22419(-118643075);
			@Pc(28) int local28 = this.method22419(-118643075);
			...
			this.anInt3070 -= 1319886248;
			this.method22395(local24, (byte) -23);
			this.method22395(local28, (byte) -52);
		}
	...
	public void method22440(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1) {
		@Pc(6) int local6 = this.anInt3070 * 212851357 / 8;
		this.anInt3070 = 0;
		for (@Pc(11) int local11 = 0; local11 < local6; local11++) {
			@Pc(18) int local18 = this.method22419(-118643075);
			...
			this.anInt3070 -= 1319886248;
			this.method22395(local18, (byte) 14);
			this.method22395(local22, (byte) 4);
		}
	}

	@OriginalMember(owner = "client!alw", name = "bi", descriptor = "([IIIB)V", line = 486)
	public void method22441(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		@Pc(4) int local4 = this.anInt3070 * 212851357;
		this.anInt3070 = arg1 * -1445626955;
		@Pc(15) int local15 = (arg2 - arg1) / 8;
		for (@Pc(17) int local17 = 0; local17 < local15; local17++) {
			...
			this.anInt3070 -= 1319886248;
			this.method22395(local24, (byte) -31);
			this.method22395(local28, (byte) -53);
		}
		this.anInt3070 = local4 * -1445626955;
	}

	@OriginalMember(owner = "client!alw", name = "bn", descriptor = "([IIII)V", line = 508)
	public void method22442(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(4) int local4 = this.anInt3070 * 212851357;
		this.anInt3070 = arg1 * -1445626955;
		@Pc(15) int local15 = (arg2 - arg1) / 8;
		for (@Pc(17) int local17 = 0; local17 < local15; local17++) {
			...
			this.anInt3070 -= 1319886248;
			this.method22395(local24, (byte) -33);
			this.method22395(local28, (byte) -14);
		}
		this.anInt3070 = local4 * -1445626955;
	}

	@OriginalMember(owner = "client!alw", name = "bs", descriptor = "(I)I", line = 613)
	public int method22443(@OriginalArg(0) int arg0) {
		this.anInt3070 += 1403713386;
		return ((this.aByteArray58[this.anInt3070 * 212851357 - 2] & 0xFF) << 8) + (this.aByteArray58[this.anInt3070 * 212851357 - 1] - 128 & 0xFF);
	}

	@OriginalMember(owner = "client!alw", name = "ci", descriptor = "(IB)V", line = 643)
	public void method22444(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 8);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 16);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) arg0;
	}
	...
	public void method22446(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public void method22447(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) -arg0;
	}

	@OriginalMember(owner = "client!alw", name = "by", descriptor = "(IB)V", line = 565)
	public void method22448(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	...
	public int method22449(@OriginalArg(0) int arg0) {
	...
	public Class93_Sub41(@OriginalArg(0) int arg0) {
		this.aByteArray58 = Class723.method36934(arg0, 1818285080);
		this.anInt3070 = 0;
	}

	@OriginalMember(owner = "client!alw", name = "bz", descriptor = "(B)B", line = 581)
	public byte method22451(@OriginalArg(0) byte arg0) {
		return (byte) (this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] - 128);
	}
	...
	public void method22454(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 8);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) arg0;
	}
	...
	public long method22455() {
		@Pc(6) long local6 = (long) this.method22413((short) 16384) & 0xFFFFFFFFL;
		@Pc(13) long local13 = (long) this.method22419(-118643075) & 0xFFFFFFFFL;
		return (local6 << 32) + local13;
	}

	@OriginalMember(owner = "client!alw", name = "bp", descriptor = "(IS)V", line = 603)
	public void method22456(@OriginalArg(0) int arg0, @OriginalArg(1) short arg1) {
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 + 128);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 8);
	}

	@OriginalMember(owner = "client!alw", name = "bj", descriptor = "(I)I", line = 608)
	public int method22457(@OriginalArg(0) int arg0) {
		this.anInt3070 += 1403713386;
	...
	public void method22458(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 8);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 + 128);
	}

	@OriginalMember(owner = "client!alw", name = "cl", descriptor = "(I)I", line = 618)
	public int method22459(@OriginalArg(0) int arg0) {
		this.anInt3070 += 1403713386;
	...
	public int method22460(@OriginalArg(0) int arg0) {
		this.anInt3070 += 1403713386;
	...
	public boolean method22463() {
		...
		@Pc(19) int local19 = this.method22419(-118643075);
		return local19 == local15;
	}

	@OriginalMember(owner = "client!alw", name = "bf", descriptor = "(I)I", line = 401)
	public int method22464(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = 0;
		@Pc(5) int local5;
		for (local5 = this.method22632((byte) -66); local5 == 32767; local5 = this.method22632((byte) -120)) {
			local1 += 32767;
		}
	...
	public void method22465(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) arg0;
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 8);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 16);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 24);
	...
	public void method22466(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 8);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) arg0;
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 24);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 16);
	...
	public void method22467(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 16);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 24);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) arg0;
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 8);
	...
	public int method22468(@OriginalArg(0) int arg0) {
		this.anInt3070 += -1487540524;
		return (this.aByteArray58[this.anInt3070 * 212851357 - 4] & 0xFF) + ((this.aByteArray58[this.anInt3070 * 212851357 - 2] & 0xFF) << 16) + ((this.aByteArray58[this.anInt3070 * 212851357 - 1] & 0xFF) << 24) + ((this.aByteArray58[this.anInt3070 * 212851357 - 3] & 0xFF) << 8);
	}
	...
	public void method22471(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		for (@Pc(5) int local5 = arg1 + arg2 - 1; local5 >= arg1; local5--) {
			arg0[local5] = this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1];
		}
	}
	...
	public void method22475(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1) {
		@Pc(6) int local6 = this.anInt3070 * 212851357 / 8;
		this.anInt3070 = 0;
		for (@Pc(11) int local11 = 0; local11 < local6; local11++) {
			@Pc(18) int local18 = this.method22419(-118643075);
			...
			this.anInt3070 -= 1319886248;
			this.method22395(local18, (byte) -24);
			this.method22395(local22, (byte) 31);
		}
	}

	@OriginalMember(owner = "client!alw", name = "cn", descriptor = "(S)I", line = 649)
	public int method22476(@OriginalArg(0) short arg0) {
		this.anInt3070 += -41913569;
		return (this.aByteArray58[this.anInt3070 * 212851357 - 1] & 0xFF) + ((this.aByteArray58[this.anInt3070 * 212851357 - 3] & 0xFF) << 8) + ((this.aByteArray58[this.anInt3070 * 212851357 - 2] & 0xFF) << 16);
	}
	...
	public int method22482(@OriginalArg(0) byte arg0) {
		this.anInt3070 += 1403713386;
	...
	public void method22492(@OriginalArg(0) String arg0) {
		...
		this.anInt3070 += Class444.method28883(arg0, 0, arg0.length(), this.aByteArray58, this.anInt3070 * 212851357, -1347752484) * -1445626955;
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = 0;
	}
	...
	public int method22493(@OriginalArg(0) int arg0) {
		...
		this.method22395(local9, (byte) 105);
		return local9;
	}
	...
	public int method22497(@OriginalArg(0) int arg0) {
		return -this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] & 0xFF;
	}
	...
	public int method22499(@OriginalArg(0) int arg0) {
	...
	public byte method22503(@OriginalArg(0) int arg0) {
	...
	public void method22504(@OriginalArg(0) String arg0) {
		...
		this.anInt3070 += Class444.method28883(arg0, 0, arg0.length(), this.aByteArray58, this.anInt3070 * 212851357, -1111686651) * -1445626955;
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = 0;
	}
	...
	public int method22506(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(9) int local9 = Class124_Sub1.method9189(this.aByteArray58, arg0, this.anInt3070 * 212851357, (byte) 16);
		this.method22395(local9, (byte) -33);
		return local9;
	}
	...
	public void method22507(@OriginalArg(0) String arg0) {
		...
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = 0;
		this.anInt3070 += Class444.method28883(arg0, 0, arg0.length(), this.aByteArray58, this.anInt3070 * 212851357, -1177063576) * -1445626955;
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = 0;
	}

	@OriginalMember(owner = "client!alw", name = "cw", descriptor = "(I)I", line = 680)
	public int method22508(@OriginalArg(0) int arg0) {
		this.anInt3070 += -1487540524;
		return (this.aByteArray58[this.anInt3070 * 212851357 - 3] & 0xFF) + ((this.aByteArray58[this.anInt3070 * 212851357 - 4] & 0xFF) << 8) + ((this.aByteArray58[this.anInt3070 * 212851357 - 1] & 0xFF) << 16) + ((this.aByteArray58[this.anInt3070 * 212851357 - 2] & 0xFF) << 24);
	}
	...
	public void method22510(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) arg0;
	}
	...
	public void method22512(@OriginalArg(0) Class93_Sub41 arg0) {
		this.method22405(arg0.aByteArray58, 0, arg0.anInt3070 * 212851357, 2026842986);
	}
	...
	public int method22514() {
		...
		@Pc(7) int local7;
		do {
			local7 = this.method22413((short) 16384);
	...
	public void method22518(@OriginalArg(0) int arg0) {
		if (arg0 < 64 && arg0 >= -64) {
			this.method22510(arg0 + 64, (byte) -55);
		} else if (arg0 < 16384 && arg0 >= -16384) {
			this.method22454(arg0 + 49152, 2133904630);
		} else {
			throw new IllegalArgumentException();
		}
	}
	...
	public void method22519(@OriginalArg(0) int arg0) {
		if (arg0 >= 0 && arg0 < 128) {
			this.method22510(arg0, (byte) -127);
		} else if (arg0 >= 0 && arg0 < 32768) {
			this.method22454(arg0 + 32768, 2132466219);
		} else {
			throw new IllegalArgumentException();
		}
	}
	...
	public void method22520(@OriginalArg(0) int arg0) {
		if (arg0 >= 0 && arg0 < 128) {
			this.method22510(arg0, (byte) -100);
		} else if (arg0 >= 0 && arg0 < 32768) {
			this.method22454(arg0 + 32768, 2126287037);
		} else {
			throw new IllegalArgumentException();
		}
	}
	...
	public void method22521(@OriginalArg(0) int arg0) {
		if (arg0 < -1) {
			...
			this.method22454(32767, 2144617404);
		} else if (arg0 < 32767) {
			this.method22454(arg0, 2133706291);
		} else {
			this.method22395(arg0, (byte) -45);
			this.aByteArray58[this.anInt3070 * 212851357 - 4] = (byte) (this.aByteArray58[this.anInt3070 * 212851357 - 4] | 0x80);
		}
	}
	...
	public void method22522(@OriginalArg(0) int arg0) {
		if (arg0 < -1) {
			...
			this.method22454(32767, 2133712815);
		} else if (arg0 < 32767) {
			this.method22454(arg0, 2124853497);
		} else {
			this.method22395(arg0, (byte) 85);
			this.aByteArray58[this.anInt3070 * 212851357 - 4] = (byte) (this.aByteArray58[this.anInt3070 * 212851357 - 4] | 0x80);
		}
	}
	...
	public void method22523(@OriginalArg(0) int arg0) {
		if (arg0 < -1) {
			...
			this.method22454(32767, 2141635239);
		} else if (arg0 < 32767) {
			this.method22454(arg0, 2142417570);
		} else {
			this.method22395(arg0, (byte) -76);
			this.aByteArray58[this.anInt3070 * 212851357 - 4] = (byte) (this.aByteArray58[this.anInt3070 * 212851357 - 4] | 0x80);
		}
	}
	...
	void method22524(@OriginalArg(0) int arg0) {
		if ((arg0 & 0xFFFFFF80) != 0) {
			if ((arg0 & 0xFFFFC000) != 0) {
				if ((arg0 & 0xFFE00000) != 0) {
					if ((arg0 & 0xF0000000) != 0) {
						this.method22510(arg0 >>> 28 | 0x80, (byte) -65);
					}
					this.method22510(arg0 >>> 21 | 0x80, (byte) -18);
				}
				this.method22510(arg0 >>> 14 | 0x80, (byte) -95);
			}
			this.method22510(arg0 >>> 7 | 0x80, (byte) -21);
		}
		this.method22510(arg0 & 0x7F, (byte) -128);
	}
	...
	void method22525(@OriginalArg(0) int arg0) {
		if ((arg0 & 0xFFFFFF80) != 0) {
			if ((arg0 & 0xFFFFC000) != 0) {
				if ((arg0 & 0xFFE00000) != 0) {
					if ((arg0 & 0xF0000000) != 0) {
						this.method22510(arg0 >>> 28 | 0x80, (byte) -70);
					}
					this.method22510(arg0 >>> 21 | 0x80, (byte) -31);
				}
				this.method22510(arg0 >>> 14 | 0x80, (byte) -65);
			}
			this.method22510(arg0 >>> 7 | 0x80, (byte) -84);
		}
		this.method22510(arg0 & 0x7F, (byte) -86);
	}
	...
	void method22526(@OriginalArg(0) int arg0) {
		if ((arg0 & 0xFFFFFF80) != 0) {
			if ((arg0 & 0xFFFFC000) != 0) {
				if ((arg0 & 0xFFE00000) != 0) {
					if ((arg0 & 0xF0000000) != 0) {
						this.method22510(arg0 >>> 28 | 0x80, (byte) -10);
					}
					this.method22510(arg0 >>> 21 | 0x80, (byte) -11);
				}
				this.method22510(arg0 >>> 14 | 0x80, (byte) -108);
			}
			this.method22510(arg0 >>> 7 | 0x80, (byte) -60);
		}
		this.method22510(arg0 & 0x7F, (byte) -82);
	}
	...
	public void method22531(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		for (@Pc(1) int local1 = arg1; local1 < arg2 + arg1; local1++) {
	...
	public int method22536(@OriginalArg(0) int arg0) {
		@Pc(9) int local9 = Class124_Sub1.method9189(this.aByteArray58, arg0, this.anInt3070 * 212851357, (byte) 16);
		this.method22395(local9, (byte) -6);
		return local9;
	}

	@OriginalMember(owner = "client!alw", name = "ae", descriptor = "(IB)V", line = 201)
	public void method22537(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		if (arg0 < 0 || arg0 > 255) {
			throw new IllegalArgumentException();
		}
		this.aByteArray58[this.anInt3070 * 212851357 - arg0 - 1] = (byte) arg0;
	...
	public int method22543() {
		@Pc(1) int local1 = 0;
		@Pc(5) int local5;
		for (local5 = this.method22632((byte) -15); local5 == 32767; local5 = this.method22632((byte) -58)) {
			local1 += 32767;
		}
		return local1 + local5;
	}
	...
	public void method22549(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(0) int local0 = arg1 - 1;
		if (local0 < 0 || local0 > 7) {
			throw new IllegalArgumentException();
		}
	...
	public void method22550(@OriginalArg(0) CharSequence arg0) {
		@Pc(3) int local3 = Class587.method31643(arg0, -74374927);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = 0;
		this.method22412(local3, 207899987);
	...
	public void method22551(@OriginalArg(0) BigInteger arg0, @OriginalArg(1) BigInteger arg1) {
		...
		this.anInt3070 = 0;
		@Pc(10) byte[] local10 = new byte[local4];
		this.method22430(local10, 0, local4, (short) 13668);
		@Pc(21) BigInteger local21 = new BigInteger(local10);
		@Pc(26) BigInteger local26 = local21.modPow(arg0, arg1);
		@Pc(29) byte[] local29 = local26.toByteArray();
		this.anInt3070 = 0;
		this.method22454(local29.length, 2139327467);
		this.method22405(local29, 0, local29.length, 2026842986);
	}
	...
	public String method22556() {
		if (this.aByteArray58[this.anInt3070 * 212851357] == 0) {
			...
			return this.method22427(1958183285);
		}
	}
	...
	public String method22557() {
		...
		@Pc(29) int local29 = this.anInt3070 * 212851357 - local4 - 1;
		return local29 == 0 ? "" : Class155.method15308(this.aByteArray58, local4, local29, (byte) -12);
	}
	...
	public String method22558() {
		...
		@Pc(29) int local29 = this.anInt3070 * 212851357 - local4 - 1;
		return local29 == 0 ? "" : Class155.method15308(this.aByteArray58, local4, local29, (byte) -81);
	}
	...
	public String method22559() {
		...
		@Pc(51) int local51 = this.anInt3070 * 212851357 - local26 - 1;
		return local51 == 0 ? "" : Class155.method15308(this.aByteArray58, local26, local51, (byte) -16);
	}
	...
	public String method22561() {
		...
		@Pc(26) int local26 = this.method22437(118016209);
		if (local26 + this.anInt3070 * 212851357 > this.aByteArray58.length) {
			throw new IllegalStateException("");
		}
	...
	public String method22562() {
		...
		@Pc(26) int local26 = this.method22437(-1663109557);
		if (local26 + this.anInt3070 * 212851357 > this.aByteArray58.length) {
			throw new IllegalStateException("");
		}
	...
	public int method22568() {
		@Pc(9) int local9 = this.aByteArray58[this.anInt3070 * 212851357] & 0xFF;
		return local9 < 128 ? this.method22413((short) 16384) : this.method22415(-1434290800) - 32768;
	}
	...
	public void method22574(@OriginalArg(0) boolean arg0) {
		this.method22510(arg0 ? 1 : 0, (byte) -18);
	}
	...
	public void method22575(@OriginalArg(0) int[] arg0) {
		...
		for (@Pc(11) int local11 = 0; local11 < local6; local11++) {
			...
			this.anInt3070 -= 1319886248;
			this.method22395(local18, (byte) -62);
			this.method22395(local22, (byte) -8);
		}
	}
	...
	public int method22576() {
		@Pc(1) int local1 = 0;
		@Pc(5) int local5;
		for (local5 = this.method22632((byte) -51); local5 == 32767; local5 = this.method22632((byte) -68)) {
			local1 += 32767;
		}
		return local1 + local5;
	}
	...
	public int method22577() {
		@Pc(1) int local1 = 0;
		@Pc(5) int local5;
		for (local5 = this.method22632((byte) -91); local5 == 32767; local5 = this.method22632((byte) -91)) {
			local1 += 32767;
		}
		return local1 + local5;
	}
	...
	public void method22585(@OriginalArg(0) int[] arg0) {
		...
		for (@Pc(11) int local11 = 0; local11 < local6; local11++) {
			...
			this.anInt3070 -= 1319886248;
			this.method22395(local18, (byte) -13);
			this.method22395(local22, (byte) -75);
		}
	}
	...
	public void method22587(@OriginalArg(0) int[] arg0) {
		...
		for (@Pc(11) int local11 = 0; local11 < local6; local11++) {
			...
			this.anInt3070 -= 1319886248;
			this.method22395(local18, (byte) 17);
			this.method22395(local22, (byte) -18);
		}
	}
	...
	public void method22588(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		for (@Pc(17) int local17 = 0; local17 < local15; local17++) {
			...
			this.anInt3070 -= 1319886248;
			this.method22395(local24, (byte) -37);
			this.method22395(local28, (byte) 76);
		}
		this.anInt3070 = local4 * -1445626955;
	}
	...
	public void method22589(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		for (@Pc(17) int local17 = 0; local17 < local15; local17++) {
			...
			this.anInt3070 -= 1319886248;
			this.method22395(local24, (byte) 20);
			this.method22395(local28, (byte) 42);
		}
		this.anInt3070 = local4 * -1445626955;
	}

	@OriginalMember(owner = "client!alw", name = "bg", descriptor = "(IB)V", line = 593)
	public void method22590(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) arg0;
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 8);
	}
	...
	public void method22592(@OriginalArg(0) String arg0) {
		...
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = 0;
		this.anInt3070 += Class444.method28883(arg0, 0, arg0.length(), this.aByteArray58, this.anInt3070 * 212851357, -1341752963) * -1445626955;
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = 0;
	}
	...
	public void method22593(@OriginalArg(0) BigInteger arg0, @OriginalArg(1) BigInteger arg1) {
		...
		this.anInt3070 = 0;
		@Pc(10) byte[] local10 = new byte[local4];
		this.method22430(local10, 0, local4, (short) 8798);
		@Pc(21) BigInteger local21 = new BigInteger(local10);
		@Pc(26) BigInteger local26 = local21.modPow(arg0, arg1);
		@Pc(29) byte[] local29 = local26.toByteArray();
		this.anInt3070 = 0;
		this.method22454(local29.length, 2133152219);
		this.method22405(local29, 0, local29.length, 2026842986);
	}
	...
	public int method22595(@OriginalArg(0) int arg0) {
		@Pc(9) int local9 = Class124_Sub1.method9189(this.aByteArray58, arg0, this.anInt3070 * 212851357, (byte) 16);
		this.method22395(local9, (byte) 82);
		return local9;
	}

	@OriginalMember(owner = "client!alw", name = "bx", descriptor = "(S)I", line = 435)
	public int method22596(@OriginalArg(0) short arg0) {
		@Pc(1) int local1 = 0;
		@Pc(3) int local3 = 0;
		@Pc(7) int local7;
		do {
	...
	public int method22597(@OriginalArg(0) int arg0) {
		@Pc(9) int local9 = Class124_Sub1.method9189(this.aByteArray58, arg0, this.anInt3070 * 212851357, (byte) 16);
		this.method22395(local9, (byte) -109);
		return local9;
	}
	...
	public long method22609(@OriginalArg(0) int arg0) {
		@Pc(6) long local6 = (long) this.method22413((short) 16384) & 0xFFFFFFFFL;
		@Pc(13) long local13 = (long) this.method22419(-118643075) & 0xFFFFFFFFL;
		return (local6 << 32) + local13;
	}
	...
	public void method22620(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
		this.method22405(arg0.aByteArray58, 0, arg0.anInt3070 * 212851357, 2026842986);
	}
	...
	public int method22628() {
		@Pc(1) int local1 = 0;
		@Pc(5) int local5;
		for (local5 = this.method22632((byte) -105); local5 == 32767; local5 = this.method22632((byte) -82)) {
			local1 += 32767;
		}
		return local1 + local5;
	}
	...
	public void method22631(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 16);
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) arg0;
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 >> 8);
	}
	...
	public int method22632(@OriginalArg(0) byte arg0) {
		@Pc(9) int local9 = this.aByteArray58[this.anInt3070 * 212851357] & 0xFF;
		return local9 < 128 ? this.method22413((short) 16384) : this.method22415(-1434290800) - 32768;
	}
	...
	public void method22639(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		if (arg0 >= 0 && arg0 < 128) {
			this.method22510(arg0, (byte) -8);
		} else if (arg0 >= 0 && arg0 < 32768) {
			this.method22454(arg0 + 32768, 2130864696);
		} else {
			throw new IllegalArgumentException();
		}
	}
	...
	public void method22643(@OriginalArg(0) BigInteger arg0, @OriginalArg(1) BigInteger arg1) {
		...
		this.anInt3070 = 0;
		@Pc(10) byte[] local10 = new byte[local4];
		this.method22430(local10, 0, local4, (short) 22223);
		@Pc(21) BigInteger local21 = new BigInteger(local10);
		@Pc(26) BigInteger local26 = local21.modPow(arg0, arg1);
		@Pc(29) byte[] local29 = local26.toByteArray();
		this.anInt3070 = 0;
		this.method22454(local29.length, 2137448457);
		this.method22405(local29, 0, local29.length, 2026842986);
	}
	...
	public void method22651(@OriginalArg(0) byte arg0) {
		if (this.aByteArray58 != null) {
			Class723.method36938(this.aByteArray58, (byte) 19);
		}
		this.aByteArray58 = null;
	}

	@OriginalMember(owner = "client!alw", name = "ag", descriptor = "(II)V", line = 208)
	public void method22652(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 < 64 && arg0 >= -64) {
			this.method22510(arg0 + 64, (byte) 0);
		} else if (arg0 < 16384 && arg0 >= -16384) {
			this.method22454(arg0 + 49152, 2125389251);
		} else {
			throw new IllegalArgumentException();
		}
	}
	...
	public boolean method22657(@OriginalArg(0) int arg0) {
		this.anInt3070 -= -1487540524;
		@Pc(15) int local15 = Class124_Sub1.method9189(this.aByteArray58, 0, this.anInt3070 * 212851357, (byte) 16);
		@Pc(19) int local19 = this.method22419(-118643075);
		return local19 == local15;
