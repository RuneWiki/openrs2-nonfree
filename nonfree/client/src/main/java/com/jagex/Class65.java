...
public class Class65 implements Interface13 {
	...
	void method1178(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt232 = arg0.method22436() * 626349445;
		} else if (arg1 == 2) {
			this.anInt233 = arg0.method22417() * -637469593;
		} else if (arg1 == 3) {
	...
	void method1183(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt232 = arg0.method22436() * 626349445;
		} else if (arg1 == 2) {
			this.anInt233 = arg0.method22417() * -637469593;
	...
	public Class100 method1174(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		@Pc(22) long local22 = (long) (this.anInt232 * -1612489907 | arg1 << 16 | (arg2 ? 262144 : 0) | arg0.anInt2888 * 658538839 << 19);
		@Pc(29) Class100 local29 = (Class100) this.aClass56_1.aClass240_63.method25839(local22);
		if (local29 == null) {
			this.method1176(arg0, arg1, arg2, local22);
	...
	public int[] method1175(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		if (this.anIntArray17 == null) {
			@Pc(28) long local28 = (long) (this.anInt232 * -1612489907 | arg1 << 16 | (arg2 ? 262144 : 0) | arg0.anInt2888 * 658538839 << 19);
			this.method1176(arg0, arg1, arg2, local28);
			return this.anIntArray17;
	...
	void method1176(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) long arg3) {
		if (!this.aClass56_1.aClass497_85.method30054(this.anInt232 * -1612489907)) {
			return;
		}
	...
	public boolean method1177() {
		return this.aClass56_1.aClass497_85.method30054(this.anInt232 * -1612489907);
	}
	...
	static final void method1188(@OriginalArg(0) Class132_Sub1_Sub1_Sub1 arg0, @OriginalArg(1) boolean arg1) {
		...
		if (arg0.aClass19_3.method23552() && !arg0.aClass19_3.method23561()) {
			@Pc(34) Class263 local34 = arg0.aClass19_3.method23553();
		...
		for (@Pc(85) int local85 = 0; local85 < arg0.aClass554Array3.length; local85++) {
			if (arg0.aClass554Array3[local85].anInt5319 * 601549465 != -1 && arg0.aClass554Array3[local85].aClass19_7.method23561()) {
				@Pc(119) Class697 local119 = (Class697) Class501.aClass32_Sub18_1.method18261(arg0.aClass554Array3[local85].anInt5319 * 601549465);
				if (local119.aBoolean881 && local119.anInt5949 * 1477426425 != -1) {
					@Pc(137) Class263 local137 = (Class263) Class32.aClass32_Sub17_23.method18261(local119.anInt5949 * 1477426425);
		...
		@Pc(219) int local219 = arg0.anIntArray240[arg0.anInt2763 * -846948133 - 1] * 512 + arg0.method19997() * 256;
		@Pc(237) int local237 = arg0.anIntArray239[arg0.anInt2763 * -846948133 - 1] * 512 + arg0.method19997() * 256;
		if (local197 < local219) {
			if (local201 < local237) {
				arg0.method19951(10240);
			} else if (local201 > local237) {
				arg0.method19951(14336);
			} else {
				arg0.method19951(12288);
			}
		} else if (local197 > local219) {
			if (local201 < local237) {
				arg0.method19951(6144);
			} else if (local201 > local237) {
				arg0.method19951(2048);
			} else {
				arg0.method19951(4096);
			}
		} else if (local201 < local237) {
			arg0.method19951(8192);
		} else if (local201 > local237) {
			arg0.method19951(0);
		}
		...
		if (!arg1 && (local219 - local197 > 1024 || local219 - local197 < -1024 || local237 - local201 > 1024 || local237 - local201 < -1024)) {
			...
			arg0.method19952(arg0.anInt2771 * -1921859025, false);
	...
	static final void method1187(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class498.method30134(local16, local22, arg0);
	}
}
