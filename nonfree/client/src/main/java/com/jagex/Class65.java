...
public class Class65 implements Interface13 {
	...
	public Class100 method1173(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		...
		@Pc(29) Class100 local29 = (Class100) this.aClass56_1.aClass240_63.method25839(local22);
		if (local29 == null) {
			this.method1176(arg0, arg1, arg2, local22);
			return (Class100) this.aClass56_1.aClass240_63.method25839(local22);
		} else {
			return local29;
		}
	}
	...
	void method1176(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) long arg3) {
		if (!this.aClass56_1.aClass497_85.method30054(this.anInt232 * -1612489907, -512225963)) {
			return;
		}
		@Pc(20) Class105 local20 = Class203.method24652(this.aClass56_1.aClass497_85, this.anInt232 * -1612489907, 0);
		if (local20 != null) {
			local20.method7162();
			if (arg2) {
				local20.method7169();
		...
		@Pc(196) Class100 local196 = arg0.method20499(local20, true);
		if (local196 != null) {
			this.aClass56_1.aClass240_63.method25830(local196, arg3);
		}
	}

	@OriginalMember(owner = "client!aco", name = "c", descriptor = "(I)Z", line = 88)
	public boolean method1177(@OriginalArg(0) int arg0) {
		return this.aClass56_1.aClass497_85.method30054(this.anInt232 * -1612489907, -512225963);
	}
	...
	void method1178(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt232 = arg0.method22436(-1570042732) * 626349445;
		} else if (arg1 == 2) {
			this.anInt233 = arg0.method22417((short) -215) * -637469593;
		} else if (arg1 == 3) {
	...
	void method1179(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt232 = arg0.method22436(-626459236) * 626349445;
		} else if (arg1 == 2) {
			this.anInt233 = arg0.method22417((short) -11489) * -637469593;
		} else if (arg1 == 3) {
			this.aBoolean30 = true;
		} else if (arg1 == 4) {
			this.anInt232 = -626349445;
	...
	void method1180(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			this.anInt232 = arg0.method22436(-300264608) * 626349445;
		} else if (arg1 == 2) {
			this.anInt233 = arg0.method22417((short) -1811) * -637469593;
		} else if (arg1 == 3) {
			this.aBoolean30 = true;
		} else if (arg1 == 4) {
			this.anInt232 = -626349445;
	...
	void method1183(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		if (arg1 == 1) {
			this.anInt232 = arg0.method22436(-269066044) * 626349445;
		} else if (arg1 == 2) {
			this.anInt233 = arg0.method22417((short) -6815) * -637469593;
		} else if (arg1 == 3) {
			this.aBoolean30 = true;
		} else if (arg1 == 4) {
			this.anInt232 = -626349445;
	...
	static final void method1187(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1218019240);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class498.method30134(local16, local22, arg0, (byte) 61);
	}

	@OriginalMember(owner = "client!aco", name = "gz", descriptor = "(Lclient!ahm;ZI)V", line = 3922)
	static final void method1188(@OriginalArg(0) Class132_Sub1_Sub1_Sub1 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2) {
		@Pc(3) Class622 local3 = arg0.method19966(1204621913);
		...
		if (arg0.aClass19_3.method23552(-1815863422) && !arg0.aClass19_3.method23561((byte) 0)) {
			@Pc(34) Class263 local34 = arg0.aClass19_3.method23553(-386337976);
		...
		for (@Pc(85) int local85 = 0; local85 < arg0.aClass554Array3.length; local85++) {
			if (arg0.aClass554Array3[local85].anInt5319 * 601549465 != -1 && arg0.aClass554Array3[local85].aClass19_7.method23561((byte) 0)) {
		...
		@Pc(193) Class472 local193 = Class472.method29530(arg0.method24229().aClass472_61);
		@Pc(197) int local197 = (int) local193.aFloat317;
		@Pc(201) int local201 = (int) local193.aFloat319;
		@Pc(219) int local219 = arg0.anIntArray240[arg0.anInt2763 * -846948133 - 1] * 512 + arg0.method19997(-377394071) * 256;
		@Pc(237) int local237 = arg0.anIntArray239[arg0.anInt2763 * -846948133 - 1] * 512 + arg0.method19997(1600788225) * 256;
		...
		if (!arg1 && (local219 - local197 > 1024 || local219 - local197 < -1024 || local237 - local201 > 1024 || local237 - local201 < -1024)) {
			arg0.method24231((float) local219, local193.aFloat318, (float) local237);
			arg0.method19952(arg0.anInt2771 * -1921859025, false, 1414376484);
