...
public class Class438 implements Interface46 {
	...
	@Override
	public synchronized Class439 method28821(@OriginalArg(0) int arg0) {
		@Pc(6) Class439 local6 = (Class439) this.aClass240_82.method25839((long) arg0);
		if (local6 != null) {
			return local6;
		}
		@Pc(17) byte[] local17 = this.aClass497_114.method30044(0, arg0);
		local6 = new Class439();
		if (local17 != null) {
			local6.method28831(new Class93_Sub41(local17));
		}
		local6.method28836();
	...
	public static int method28829(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(1) int local1 = 0;
		while (arg1 > 0) {
	...
	static void method28828(@OriginalArg(0) Class681 arg0) {
		@Pc(14) int local14 = Class499.method30153(arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091]);
