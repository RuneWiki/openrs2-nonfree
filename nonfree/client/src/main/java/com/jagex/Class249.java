...
public class Class249 {
	...
	public static void method25932(@OriginalArg(0) boolean arg0) {
		...
		if (!arg0) {
			if (aClass110Array1 != null) {
				...
				for (@Pc(18) int local18 = 0; local18 < local16.length; local18++) {
					...
					local26.method20144(-1894331367);
				}
			}
			if (anInt3842 * -1535788867 != -1) {
				Class274.aClass258_1.method26118(anInt3842 * -1535788867, 255, (byte) 0);
			}
		}
		...
		local68.aClass93_Sub41_Sub2_1.method22510(arg0 ? 1 : 0, (byte) -29);
		client.aClass175_2.method24351(local68, -2085194401);
	}
	...
	public static boolean method25934(@OriginalArg(0) int arg0) {
		...
		if (Class244.aClass244_2 == Class136.aClass244_1) {
			...
			local84 = local33.method22632((byte) -78);
			...
			local106 = local33.method22632((byte) 0);
			...
			local127 = local33.method22632((byte) -48);
		...
		if (Class136.aClass244_1 == Class244.aClass244_3) {
			...
			for (local40 = 0; local40 < local168.length; local40++) {
				...
				if (!local178.method25808(-1271539073)) {
					local166 = false;
				}
			}
			...
			for (local40 = 0; local40 < local188.length; local40++) {
				...
				if (!local198.method20139(-1981078987)) {
					local166 = false;
				}
			}
			...
			for (local40 = 0; local40 < local208.length; local40++) {
				...
				if (!local218.method25883(-1461419039)) {
					local166 = false;
				}
			}
			if (!local166) {
	...
	static void method25935(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			...
			switch(local3) {
				case 0:
					anInt3841 = arg0.method22415(-1434290800) * -1784392859;
					anInt3839 = arg0.method22415(-1434290800) * -1584427833;
					break;
				case 255:
					return;
			}
	...
	public static void method25936(@OriginalArg(0) boolean arg0) {
		...
		if (!arg0) {
			if (aClass110Array1 != null) {
				...
				for (@Pc(18) int local18 = 0; local18 < local16.length; local18++) {
					@Pc(26) Class110 local26 = local16[local18];
					local26.method20144(-2044593641);
				}
			}
			if (anInt3842 * -1535788867 != -1) {
				Class274.aClass258_1.method26118(anInt3842 * -1535788867, 255, (byte) 0);
		...
		local68.aClass93_Sub41_Sub2_1.method22510(arg0 ? 1 : 0, (byte) -49);
		client.aClass175_2.method24351(local68, -1911437675);
	}
	...
	public static void method25939() {
		...
		aBoolean664 = true;
		anInt3842 = Class274.aClass258_1.method26053(-784246097) * -1512963435;
	...
	public static void method25940() {
		...
		aShort164 = client.aShort156;
		aBoolean664 = true;
		anInt3842 = Class274.aClass258_1.method26053(-799354773) * -1512963435;
		if (anInt3839 * 279147767 != 0 && anInt3841 * 2018616941 != 0) {
			client.aShort155 = 334;
			client.aShort156 = 334;
			client.aShort151 = client.aShort150 = (short) (anInt3839 * 1189735936 / (anInt3841 * 2018616941));
	...
	public static void method25941(@OriginalArg(0) boolean arg0) {
		...
		if (!arg0) {
			if (aClass110Array1 != null) {
				...
				for (@Pc(18) int local18 = 0; local18 < local16.length; local18++) {
					@Pc(26) Class110 local26 = local16[local18];
					local26.method20144(-2069197363);
				}
			}
			if (anInt3842 * -1535788867 != -1) {
				Class274.aClass258_1.method26118(anInt3842 * -1535788867, 255, (byte) 0);
		...
		local68.aClass93_Sub41_Sub2_1.method22510(arg0 ? 1 : 0, (byte) -125);
		client.aClass175_2.method24351(local68, -1913188448);
	}
	...
	public static boolean method25942(@OriginalArg(0) int arg0) {
		...
		@Pc(40) int local40;
		if (Class244.aClass244_2 == Class136.aClass244_1) {
			@Pc(23) byte[] local23 = Class446.aClass497_117.method30059(arg0, (byte) 94);
			if (local23 == null) {
				return false;
			}
			@Pc(33) Class93_Sub41 local33 = new Class93_Sub41(local23);
			Class437.method28819(local33, 1415888156);
			local40 = local33.method22413((short) 16384);
			@Pc(42) int local42;
			for (local42 = 0; local42 < local40; local42++) {
				aClass22_51.method407(new Class93_Sub27(local33), 204396591);
			}
			local42 = local33.method22632((byte) -96);
			aClass255Array1 = new Class255[local42];
			@Pc(63) int local63;
			for (local63 = 0; local63 < local42; local63++) {
				aClass255Array1[local63] = new Class255(local33);
			}
			local63 = local33.method22632((byte) -114);
			aClass239Array1 = new Class239[local63];
			@Pc(84) int local84;
			for (local84 = 0; local84 < local63; local84++) {
				aClass239Array1[local84] = new Class239(local33, local84);
			}
			local84 = local33.method22632((byte) -17);
			Class152.aClass243Array2 = new Class243[local84];
			@Pc(106) int local106;
			for (local106 = 0; local106 < local84; local106++) {
				Class152.aClass243Array2[local106] = new Class243(local33);
			}
			local106 = local33.method22632((byte) -48);
			Class716.aClass250Array1 = new Class250[local106];
			@Pc(127) int local127;
			for (local127 = 0; local127 < local106; local127++) {
				Class716.aClass250Array1[local127] = new Class250(local33);
			}
			local127 = local33.method22632((byte) -128);
			aClass110Array1 = new Class110[local127];
			for (@Pc(148) int local148 = 0; local148 < local127; local148++) {
		...
		if (Class136.aClass244_1 == Class244.aClass244_3) {
			...
			for (local40 = 0; local40 < local168.length; local40++) {
				@Pc(178) Class239 local178 = local168[local40];
				if (!local178.method25808(-1241166023)) {
					local166 = false;
				}
			}
			@Pc(188) Class110[] local188 = aClass110Array1;
			for (local40 = 0; local40 < local188.length; local40++) {
				@Pc(198) Class110 local198 = local188[local40];
				if (!local198.method20139(-2126372563)) {
					local166 = false;
				}
			}
			@Pc(208) Class243[] local208 = Class152.aClass243Array2;
			for (local40 = 0; local40 < local208.length; local40++) {
				@Pc(218) Class243 local218 = local208[local40];
				if (!local218.method25883(-1770910812)) {
					local166 = false;
				}
			}
			if (!local166) {
	...
	static final void method25943(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) throws Exception_Sub3 {
		Class65.aClass123_Sub1_2.method8999(1629290341);
	}

	@OriginalMember(owner = "client!eq", name = "w", descriptor = "(Lclient!ajt;ZI)V", line = 150)
	static final void method25944(@OriginalArg(0) Class93_Sub8 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2) {
		if (arg0.aBoolean309) {
			if (arg0.anInt1463 * -1082823603 < 0 || Class29.method604(client.aClass532_1.method30466(1160563437), arg0.anInt1463 * -1082823603, arg0.anInt1467 * -750234735, 1526889607)) {
				if (arg1) {
		...
		} else if (arg0.aBoolean308 && arg0.anInt1462 * -1824529811 >= 1 && arg0.anInt1464 * 275343381 >= 1 && arg0.anInt1462 * -1824529811 <= client.aClass532_1.method30444(497944052) - 2 && arg0.anInt1464 * 275343381 <= client.aClass532_1.method30474((short) 128) - 2 && (arg0.anInt1468 * -1430483277 < 0 || Class29.method604(client.aClass532_1.method30466(2040388510), arg0.anInt1468 * -1430483277, arg0.anInt1470 * -770791277, -1734264319))) {
			if (arg1) {
	...
	static final void method25945(@OriginalArg(0) byte arg0, @OriginalArg(1) int arg1) {
		@Pc(3) byte[][][] local3 = client.aClass532_1.method30458((byte) -35);
		if (local3 == null) {
			local3 = new byte[4][client.aClass532_1.method30444(-999432476)][client.aClass532_1.method30474((short) 128)];
			client.aClass532_1.method30491(local3, 1388606318);
		}
		for (@Pc(21) int local21 = 0; local21 < 4; local21++) {
			for (@Pc(26) int local26 = 0; local26 < client.aClass532_1.method30444(60067612); local26++) {
				for (@Pc(33) int local33 = 0; local33 < client.aClass532_1.method30474((short) 128); local33++) {
	...
	public static Class407 method25946(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
		@Pc(3) String local3 = arg0.method22427(2121553575);
		@Pc(10) Class390 local10 = Class708.method36756(947855738)[arg0.method22413((short) 16384)];
		@Pc(17) Class392 local17 = Class252.method25978(-1668995175)[arg0.method22413((short) 16384)];
		@Pc(21) int local21 = arg0.method22482((byte) -7);
		@Pc(25) int local25 = arg0.method22482((byte) -99);
		@Pc(29) int local29 = arg0.method22413((short) 16384);
		@Pc(33) int local33 = arg0.method22413((short) 16384);
		@Pc(37) int local37 = arg0.method22413((short) 16384);
		@Pc(41) int local41 = arg0.method22415(-1434290800);
		@Pc(45) int local45 = arg0.method22415(-1434290800);
		@Pc(49) int local49 = arg0.method22436(-1658985675);
		@Pc(53) int local53 = arg0.method22419(-118643075);
		@Pc(57) int local57 = arg0.method22419(-118643075);
