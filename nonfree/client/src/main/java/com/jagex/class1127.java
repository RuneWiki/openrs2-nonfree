...
public final class class1127 extends class850 {
	...
	public void method2150() {
		...
		this.method16092((class356) null);
		this.method15991(1);
		this.method16054(0);
	...
	public long method2158(int arg0, int arg1) {
		return this.method19070(arg0, arg1, (int[]) null, (int[]) null);
	}
	...
	public void method16025() {
		...
		for (var1 = 0; var1 < this.field10127; var1++) {
			...
			this.field12030[0] = (float) var2.method17605();
			this.field12030[1] = (float) var2.method17606();
			this.field12030[2] = (float) var2.method17607();
			this.field12030[3] = 1.0F;
