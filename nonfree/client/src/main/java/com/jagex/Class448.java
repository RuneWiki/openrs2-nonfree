...
public class Class448 {
	...
	static void method28919(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
	...
	public static Class628 method28920(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(8) int local8 = 0; local8 < local3; local8++) {
			local6[local8] = arg0.method22413((short) 16384);
		}
		return new Class628(local6);
	}

	@OriginalMember(owner = "client!nt", name = "e", descriptor = "(Lclient!yf;I)V", line = 13)
	static void method28921(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method28922(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	public static boolean method28923(@OriginalArg(0) byte arg0) {
