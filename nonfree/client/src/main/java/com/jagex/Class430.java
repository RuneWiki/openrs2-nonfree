...
public class Class430 {
	...
	static void method28765(@OriginalArg(0) Class681 arg0) {
	...
	static final void method28761(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
		@Pc(14) int local14 = arg2.anIntArray519[(arg2.anInt5891 -= 1189701933) * -1497248091] - 1;
		if (local14 >= 0 && local14 <= 9) {
			arg0.method26855(local14, (String) arg2.anObjectArray45[(arg2.anInt5888 -= 957530791) * 587908375]);
		} else {
	...
	static final void method28762(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class681 arg1) {
		...
		Class513.method30263(arg0, local15, local25, local35, arg1);
	}

	@OriginalMember(owner = "client!n", name = "adl", descriptor = "(Lclient!yf;I)V", line = 10074)
	static final void method28763(@OriginalArg(0) Class681 arg0) {
	...
	public static Class82 method28764(@OriginalArg(0) int arg0) {
		@Pc(5) Class82 local5 = (Class82) client.aClass240_67.method25839((long) arg0);
		if (local5 == null) {
			local5 = new Class82(Class621.aClass497_135, Class174.method24344(arg0), Class57.method1089(arg0));
