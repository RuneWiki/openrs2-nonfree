...
public class Class197 {
	...
	boolean method24623(@OriginalArg(0) int arg0) {
		return this.aClass97Array1[arg0].method2790();
	}

	@OriginalMember(owner = "client!bw", name = "f", descriptor = "(I)Z", line = 33)
	boolean method24624(@OriginalArg(0) int arg0) {
		return this.aClass97Array1[arg0].method2790();
	}

	@OriginalMember(owner = "client!bw", name = "n", descriptor = "(IIIZZ)V", line = 37)
	void method24621(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) boolean arg4) {
	...
	boolean method24619(@OriginalArg(0) Class88 arg0, @OriginalArg(1) int arg1) {
		if (this.anInt3367 == 0) {
			return false;
		} else {
