...
public class Class588 {
	...
	public static boolean method31649(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		return arg0 != 1 && arg0 != 7;
	}

	@OriginalMember(owner = "client!u", name = "ah", descriptor = "(Lclient!yf;I)V", line = 228)
	static void method31650(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		if (Class683.aBoolean876) {
			...
			Class585.method31611(arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 2] != 0, -2027415738);
		}
	}

	@OriginalMember(owner = "client!u", name = "lw", descriptor = "(Lclient!yf;I)V", line = 7096)
	static final void method31651(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method31653(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!u", name = "e", descriptor = "(Lclient!yf;B)V", line = 17)
	static void method31654(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
