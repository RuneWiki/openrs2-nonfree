...
public class Class122_Sub1 extends Class122 {
	...
	public void method28280(@OriginalArg(0) int arg0) {
		...
		this.aClass100_31 = Class219.method25509(this.aClass497_90, local6.anInt2987 * -312428519, (byte) 100);
		this.aClass100_28 = Class219.method25509(this.aClass497_90, local6.anInt2988 * 813929059, (byte) 66);
		this.aClass100_27 = Class219.method25509(this.aClass497_90, local6.anInt2990 * -2031575365, (byte) 78);
		this.aClass100_30 = Class219.method25509(this.aClass497_90, local6.anInt2991 * 79921115, (byte) 3);
		this.aClass100_29 = Class219.method25509(this.aClass497_90, local6.anInt2989 * -143127169, (byte) 67);
		this.aClass100_32 = Class219.method25509(this.aClass497_90, local6.anInt2992 * 247837873, (byte) 77);
	}

	@OriginalMember(owner = "client!ahb", name = "s", descriptor = "(IIIII)V", line = 70)
	void method20221(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		this.aClass100_31.method18178(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!ahb", name = "z", descriptor = "(ZIIS)V", line = 33)
	@Override
	void method20211(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) short arg3) {
		if (!arg0) {
			return;
		}
	...
	@Override
	void method20212(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(51) int local51 = this.method20213((byte) -32) * local39 / 10000;
		...
		this.method20221(local5, local23, local39, local43, -1455227064);
	...
	public void method28283() {
		super.method28280(851032478);
		@Pc(6) Class125_Sub2 local6 = (Class125_Sub2) this.aClass125_5;
		this.aClass100_31 = Class219.method25509(this.aClass497_90, local6.anInt2987 * -312428519, (byte) 28);
		this.aClass100_28 = Class219.method25509(this.aClass497_90, local6.anInt2988 * 813929059, (byte) 66);
		this.aClass100_27 = Class219.method25509(this.aClass497_90, local6.anInt2990 * -2031575365, (byte) 112);
		this.aClass100_30 = Class219.method25509(this.aClass497_90, local6.anInt2991 * 79921115, (byte) 53);
		this.aClass100_29 = Class219.method25509(this.aClass497_90, local6.anInt2989 * -143127169, (byte) 101);
		this.aClass100_32 = Class219.method25509(this.aClass497_90, local6.anInt2992 * 247837873, (byte) 74);
	}
	...
	public boolean method28278() {
		...
		if (!this.aClass497_90.method30054(local9.anInt2987 * -312428519, -512225963)) {
			return false;
		} else if (!this.aClass497_90.method30054(local9.anInt2988 * 813929059, -512225963)) {
			return false;
		} else if (!this.aClass497_90.method30054(local9.anInt2990 * -2031575365, -512225963)) {
			return false;
		} else if (!this.aClass497_90.method30054(local9.anInt2991 * 79921115, -512225963)) {
			return false;
		} else if (this.aClass497_90.method30054(local9.anInt2989 * -143127169, -512225963)) {
			return this.aClass497_90.method30054(local9.anInt2992 * 247837873, -512225963);
		} else {
			return false;
		}
	}
	...
	@Override
	void method20216(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(5) int local5 = arg1 + this.aClass100_27.method18160();
		@Pc(17) int local17 = arg1 + this.aClass125_5.anInt2983 * 1135283731 - this.aClass100_30.method18160();
		@Pc(23) int local23 = arg2 + this.aClass100_29.method18166();
		@Pc(35) int local35 = this.aClass125_5.anInt2980 * -1017655207 + arg2 - this.aClass100_32.method18166();
		@Pc(39) int local39 = local17 - local5;
		@Pc(43) int local43 = local35 - local23;
		@Pc(51) int local51 = this.method20213((byte) -22) * local39 / 10000;
		@Pc(54) int[] local54 = new int[4];
		Class694.aClass104_14.method20470(local54);
		Class694.aClass104_14.method20467(local5, local23, local5 + local51, local35);
		this.method20221(local5, local23, local39, local43, 2115892083);
		Class694.aClass104_14.method20467(local51 + local5, local23, local17, local35);
		this.aClass100_28.method18178(local5, local23, local39, local43);
		Class694.aClass104_14.method20467(local54[0], local54[1], local54[2], local54[3]);
	}
	...
	@Override
	void method20217(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(5) int local5 = arg1 + this.aClass100_27.method18160();
		@Pc(17) int local17 = arg1 + this.aClass125_5.anInt2983 * 1135283731 - this.aClass100_30.method18160();
		@Pc(23) int local23 = arg2 + this.aClass100_29.method18166();
		@Pc(35) int local35 = this.aClass125_5.anInt2980 * -1017655207 + arg2 - this.aClass100_32.method18166();
		...
		Class694.aClass104_14.method20470(local54);
		Class694.aClass104_14.method20467(local5, local23, local5 + local51, local35);
		this.method20221(local5, local23, local39, local43, 308350029);
		Class694.aClass104_14.method20467(local51 + local5, local23, local17, local35);
		this.aClass100_28.method18178(local5, local23, local39, local43);
		Class694.aClass104_14.method20467(local54[0], local54[1], local54[2], local54[3]);
	}
	...
	public void method28284() {
		super.method28280(851032478);
		@Pc(6) Class125_Sub2 local6 = (Class125_Sub2) this.aClass125_5;
		this.aClass100_31 = Class219.method25509(this.aClass497_90, local6.anInt2987 * -312428519, (byte) 120);
		this.aClass100_28 = Class219.method25509(this.aClass497_90, local6.anInt2988 * 813929059, (byte) 61);
		this.aClass100_27 = Class219.method25509(this.aClass497_90, local6.anInt2990 * -2031575365, (byte) 18);
		this.aClass100_30 = Class219.method25509(this.aClass497_90, local6.anInt2991 * 79921115, (byte) 57);
		this.aClass100_29 = Class219.method25509(this.aClass497_90, local6.anInt2989 * -143127169, (byte) 83);
		this.aClass100_32 = Class219.method25509(this.aClass497_90, local6.anInt2992 * 247837873, (byte) 106);
	}
	...
	static final void method20225(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class557.aClass297_1.method26620((byte) 31) == local12 ? 1 : 0;
	}

	@OriginalMember(owner = "client!ahb", name = "k", descriptor = "(IB)I", line = 35)
	static final int method20226(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		return arg0 >> 11 & 0x7F;
	}
	...
	static final void method20227(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		Class274.aClass258_1.method26118(arg0.anIntArray519[arg0.anInt5891 * -1497248091], arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1], (byte) 0);
	}
