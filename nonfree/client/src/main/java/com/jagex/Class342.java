...
public class Class342 {
	...
	public boolean method27505(@OriginalArg(0) int arg0) {
		return this.aBoolean723;
	}
	...
	static final void method27508(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class149_Sub3.method12318((short) 255);
	}

	@OriginalMember(owner = "client!im", name = "u", descriptor = "(Ljava/lang/Float;Ljava/lang/Float;B)V", line = 307)
	static void method27509(@OriginalArg(0) Float arg0, @OriginalArg(1) Float arg1, @OriginalArg(2) byte arg2) {
		arg1 = 1.0F - arg1;
		if (arg0 < 0.0F) {
			arg0 = 0.0F;
		}
		...
		if (arg0 > 1.0F || arg1 > 1.0F) {
			...
			if (Class221.aFloat261 + local56 > 0.0F) {
				Class248.method25931(arg0, arg1, 1472772350);
			}
		}
	...
	public static int method27510(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) short arg2) {
		...
		@Pc(116) String[] local116 = (String[]) (String[]) local14.toArray(new String[Class657.anIntArray509.length]);
		Class118.method8414(local116, Class657.anIntArray509, 5665102);
		return local10.size();
	}

	@OriginalMember(owner = "client!im", name = "d", descriptor = "(Lclient!arn;IB)V", line = 436)
	static void method27511(@OriginalArg(0) Class93_Sub1_Sub8 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		...
		for (@Pc(13) Class93_Sub1_Sub7 local13 = (Class93_Sub1_Sub7) arg0.aClass18_10.method246(1550983515); local13 != null; local13 = (Class93_Sub1_Sub7) arg0.aClass18_10.method253(1024498697)) {
			local21 = Class338.method27471(local13, local5, 948224087);
			if (local21 > local7) {
				local7 = local21;
			}
		}
