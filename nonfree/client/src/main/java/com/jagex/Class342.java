...
public class Class342 {
	...
	public static Class342 method27506(@OriginalArg(0) int arg0) {
		if (aClass342_4.anInt4188 * -1676947525 == arg0) {
			return aClass342_4;
		} else if (aClass342_3.anInt4188 * -1676947525 == arg0) {
			return aClass342_3;
	...
	public static Class342 method27507(@OriginalArg(0) int arg0) {
		if (aClass342_4.anInt4188 * -1676947525 == arg0) {
			return aClass342_4;
		} else if (aClass342_3.anInt4188 * -1676947525 == arg0) {
			return aClass342_3;
	...
	static void method27511(@OriginalArg(0) Class93_Sub1_Sub8 arg0, @OriginalArg(1) int arg1) {
		if (!Class454.aBoolean773) {
			return;
		}
		@Pc(5) Class5 local5 = Class142_Sub1.method10990();
		@Pc(7) int local7 = 0;
		@Pc(21) int local21;
		for (@Pc(13) Class93_Sub1_Sub7 local13 = (Class93_Sub1_Sub7) arg0.aClass18_10.method246(); local13 != null; local13 = (Class93_Sub1_Sub7) arg0.aClass18_10.method253()) {
			local21 = Class338.method27471(local13, local5);
			if (local21 > local7) {
				local7 = local21;
			}
		}
	...
	static final void method27508(@OriginalArg(0) Class681 arg0) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class149_Sub3.method12318();
	}

	@OriginalMember(owner = "client!im", name = "ld", descriptor = "(Ljava/lang/String;ZS)I", line = 12326)
	public static int method27510(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) {
		...
		for (local16 = 0; local16 < Class277.aClass32_Sub12_1.anInt2487 * -152478627; local16++) {
			@Pc(28) Class47 local28 = (Class47) Class277.aClass32_Sub12_1.method18261(local16);
		...
		Class118.method8414(local116, Class657.anIntArray509);
		return local10.size();
	}
}
