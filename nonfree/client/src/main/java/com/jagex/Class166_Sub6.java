...
public class Class166_Sub6 extends Class166 {
	...
	public void method15472(@OriginalArg(0) int arg0) {
		...
		if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 2) {
			this.anInt2379 = this.method16542((byte) -75) * -88839937;
		}
	}
	...
	public boolean method15473(@OriginalArg(0) short arg0) {
	...
	public void method15474() {
		...
		if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 2) {
			this.anInt2379 = this.method16542((byte) -91) * -88839937;
		}
	}
	...
	public int method15475(@OriginalArg(0) int arg0) {
	...
	public void method15476() {
		...
		if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 2) {
			this.anInt2379 = this.method16542((byte) 33) * -88839937;
		}
	}
	...
	public int method15480() {
		return this.anInt2379 * 960141055;
	}

	@OriginalMember(owner = "client!amf", name = "f", descriptor = "(Lclient!acw;Ljava/lang/String;ILjava/lang/Throwable;I)V", line = 36)
	public static void method15481(@OriginalArg(0) Class72 arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Throwable arg3, @OriginalArg(4) int arg4) {
		Class370.method27995(new Class601(arg0, arg1, arg2, arg3), -818774123);
	}

	@OriginalMember(owner = "client!amf", name = "p", descriptor = "(I)Lclient!zb;", line = 127)
	public static Class700 method15482(@OriginalArg(0) int arg0) {
	...
	static void method15483(@OriginalArg(0) byte arg0) {
	...
	public static byte[][][] method15484(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method15485(@OriginalArg(0) byte arg0) {
		...
		@Pc(23) int local23 = Class305.method26801(local5, local11, Class512.anInt5209 * 1177442423, (byte) -63) - Class165.anInt2068 * -1400777707;
		if (Class256.anInt3853 * 1151351583 >= 100) {
			...
			Class130_Sub2.anInt1117 = (Class305.method26801(Class163.anInt2002 * -1331168249, Class270.anInt3884 * 466086187, Class512.anInt5209 * 1177442423, (byte) -19) - Class165.anInt2068 * -1400777707) * 1820517185;
		} else {
		...
		local23 = Class305.method26801(local5, local11, Class512.anInt5209 * 1177442423, (byte) -44) - Class290.anInt3911 * -1980774829;
