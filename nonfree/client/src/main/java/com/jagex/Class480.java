...
public class Class480 implements Runnable {
	...
	void method29730(@OriginalArg(0) Class93_Sub1_Sub16_Sub2 arg0, @OriginalArg(1) int arg1) {
	...
	Class93_Sub1_Sub16_Sub2 method29731(@OriginalArg(0) int arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) Class593 arg2, @OriginalArg(3) int arg3) {
		...
		this.method29730(local3, -1639857845);
		return local3;
	}
	...
	Class93_Sub1_Sub16_Sub2 method29732(@OriginalArg(0) int arg0, @OriginalArg(1) Class593 arg1) {
		...
		local3.aByteArray60 = arg1.method31707(arg0, -1338893645);
		local3.aBoolean546 = false;
	...
	Class93_Sub1_Sub16_Sub2 method29733(@OriginalArg(0) int arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) Class593 arg2) {
		...
		local3.aClass593_3 = arg2;
		local3.aBoolean544 = false;
		this.method29730(local3, -2070014084);
		return local3;
	}
		...
		while (!this.aBoolean780) {
			...
			try {
				if (local13.anInt3193 * -1998878079 == 2) {
					local13.aClass593_3.method31708((int) (local13.aLong233 * -5980455722457358841L), local13.aByteArray60, local13.aByteArray60.length, -1778918765);
				} else if (local13.anInt3193 * -1998878079 == 3) {
					local13.aByteArray60 = local13.aClass593_3.method31707((int) (local13.aLong233 * -5980455722457358841L), -1338893645);
				}
			} catch (@Pc(79) Exception local79) {
				Class646.method32610((String) null, local79, 1413979620);
			}
	...
	public int method29734(@OriginalArg(0) int arg0) {
		@Pc(3) Class18 local3 = this.aClass18_17;
		synchronized (this.aClass18_17) {
	...
	public void method29735(@OriginalArg(0) int arg0) {
	...
	public void method29736() {
		while (!this.aBoolean780) {
			...
			try {
				if (local13.anInt3193 * -1998878079 == 2) {
					local13.aClass593_3.method31708((int) (local13.aLong233 * -5980455722457358841L), local13.aByteArray60, local13.aByteArray60.length, 599322661);
				} else if (local13.anInt3193 * -1998878079 == 3) {
					local13.aByteArray60 = local13.aClass593_3.method31707((int) (local13.aLong233 * -5980455722457358841L), -1338893645);
				}
			} catch (@Pc(79) Exception local79) {
				Class646.method32610((String) null, local79, 604727425);
			}
			local13.aBoolean546 = false;
		}
	}
	...
	public void method29737() {
		while (!this.aBoolean780) {
			...
			try {
				if (local13.anInt3193 * -1998878079 == 2) {
					local13.aClass593_3.method31708((int) (local13.aLong233 * -5980455722457358841L), local13.aByteArray60, local13.aByteArray60.length, -1103051181);
				} else if (local13.anInt3193 * -1998878079 == 3) {
					local13.aByteArray60 = local13.aClass593_3.method31707((int) (local13.aLong233 * -5980455722457358841L), -1338893645);
				}
			} catch (@Pc(79) Exception local79) {
				Class646.method32610((String) null, local79, 1316275568);
			}
			local13.aBoolean546 = false;
		}
	}
	...
	public void method29738() {
		while (!this.aBoolean780) {
			...
			try {
				if (local13.anInt3193 * -1998878079 == 2) {
					local13.aClass593_3.method31708((int) (local13.aLong233 * -5980455722457358841L), local13.aByteArray60, local13.aByteArray60.length, -1813610025);
				} else if (local13.anInt3193 * -1998878079 == 3) {
					local13.aByteArray60 = local13.aClass593_3.method31707((int) (local13.aLong233 * -5980455722457358841L), -1338893645);
				}
			} catch (@Pc(79) Exception local79) {
				Class646.method32610((String) null, local79, 430998760);
			}
			local13.aBoolean546 = false;
		}
	}
	...
	Class93_Sub1_Sub16_Sub2 method29739(@OriginalArg(0) int arg0, @OriginalArg(1) Class593 arg1, @OriginalArg(2) byte arg2) {
		@Pc(3) Class93_Sub1_Sub16_Sub2 local3 = new Class93_Sub1_Sub16_Sub2();
		local3.anInt3193 = -363323261;
		local3.aLong233 = (long) arg0 * -5463674641158180937L;
		local3.aClass593_3 = arg1;
		local3.aBoolean544 = false;
		this.method29730(local3, -1392062291);
		return local3;
	}

	@OriginalMember(owner = "client!pf", name = "e", descriptor = "(ILclient!uf;S)Lclient!atf;", line = 21)
	Class93_Sub1_Sub16_Sub2 method29740(@OriginalArg(0) int arg0, @OriginalArg(1) Class593 arg1, @OriginalArg(2) short arg2) {
		@Pc(3) Class93_Sub1_Sub16_Sub2 local3 = new Class93_Sub1_Sub16_Sub2();
		local3.anInt3193 = -1552763519;
		@Pc(10) Class18 local10 = this.aClass18_17;
		synchronized (this.aClass18_17) {
	...
	Class93_Sub1_Sub16_Sub2 method29742(@OriginalArg(0) int arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) Class593 arg2) {
		...
		local3.aClass593_3 = arg2;
		local3.aBoolean544 = false;
		this.method29730(local3, -1002638385);
		return local3;
	}
	...
	public void method29747() {
		while (!this.aBoolean780) {
			...
			try {
				if (local13.anInt3193 * -1998878079 == 2) {
					local13.aClass593_3.method31708((int) (local13.aLong233 * -5980455722457358841L), local13.aByteArray60, local13.aByteArray60.length, 1643072900);
				} else if (local13.anInt3193 * -1998878079 == 3) {
					local13.aByteArray60 = local13.aClass593_3.method31707((int) (local13.aLong233 * -5980455722457358841L), -1338893645);
				}
			} catch (@Pc(79) Exception local79) {
				Class646.method32610((String) null, local79, 209088102);
			}
			local13.aBoolean546 = false;
		}
	}
	...
	static void method29748(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		@Pc(2) Class175 local2 = Class330.method27372(-1981318146);
		if (local2.method24356((byte) 27) == null) {
			return;
		}
		@Pc(12) Class93_Sub22 local12 = Class102.method2592(Class446.aClass446_27, local2.aClass24_2, (byte) 124);
		local12.aClass93_Sub41_Sub2_1.method22454(Class46.method894(arg0, -1553492743) + Class46.method894(arg1, -2061658131) + Class46.method894(arg2, -1984974626) + 1, 2126703870);
		local12.aClass93_Sub41_Sub2_1.method22402(arg0, -1212929370);
		local12.aClass93_Sub41_Sub2_1.method22402(arg1, 107167147);
		local12.aClass93_Sub41_Sub2_1.method22402(arg2, -2062750704);
		@Pc(46) int local46 = 0;
		if (arg3) {
			local46 |= 0x1;
		}
		...
		local12.aClass93_Sub41_Sub2_1.method22510(local46, (byte) -46);
		local2.method24351(local12, -1817238704);
	}

	@OriginalMember(owner = "client!pf", name = "jc", descriptor = "(Lclient!yf;S)V", line = 6705)
	static final void method29749(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
		arg0.anInt5891 -= 1189701933;
	}

	@OriginalMember(owner = "client!pf", name = "l", descriptor = "(IZS)I", line = 94)
	public static int method29750(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) short arg2) {
		if (arg1) {
			return 0;
		}
		@Pc(8) Class93_Sub6 local8 = Class557.method31065(arg0, arg1, (short) 255);
		if (local8 == null) {
	...
	static void method29751(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) short arg5) {
		...
		Class169.method18343(arg0, local219, 0, 0, (byte) -4);
		...
		Class159_Sub1.aClass240_33.method25832(5, (byte) -30);
	}

	@OriginalMember(owner = "client!pf", name = "bv", descriptor = "(FFFFFFII)F", line = 1925)
	static float method29752(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		@Pc(23) Class585 local23 = client.aClass532_1.method30459(-1170801764);
		while (local1 < 1.1F) {
			...
			if (local50 > 0 && local55 > 0 && local50 < client.aClass532_1.method30444(1448389296) && local55 < client.aClass532_1.method30474((short) 128)) {
				@Pc(72) int local72 = Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.aByte100;
				if (local72 < 3 && (client.aClass532_1.method30509(2096861293).aByteArrayArrayArray12[1][local50][local55] & 0x2) != 0) {
					local72++;
				}
				...
				if ((float) local100 < local39) {
					if (arg6 >= 2) {
						return local1 - 0.1F + method29752(local15, local17, local19, local33, local39, local45, arg6 - 1, -874705229) * 0.1F;
					}
					return local1;
				}
			}
