...
public class Class199 {
	...
	Class199(@OriginalArg(0) Class104_Sub1 arg0) {
		...
		method24626(arg0);
		if (this.aBoolean577) {
			@Pc(103) byte[] local103 = Class331.method27386(anObject11, false, 479524276);
			...
			@Pc(121) byte[] local121 = Class331.method27386(anObject10, false, -207172829);
			...
			if (local137.method25406()) {
				local103 = Class331.method27386(anObject12, false, -1609051994);
			...
			for (local31 = 0; local31 < 16; local31++) {
				local42 = Class441.method28856(anObject11, local31 * 32768, 32768, 1048575);
			...
			for (local31 = 0; local31 < 16; local31++) {
				local42 = Class441.method28856(anObject10, local31 * 32768, 32768, 1048575);
