...
public class Class199 {
	...
	static void method24626(@OriginalArg(0) Class104_Sub1 arg0) {
		...
		if (anObject11 == null) {
			...
			anObject11 = Class113.method7411(local11, false);
		}
		if (anObject10 == null) {
			@Pc(22) Class140_Sub2_Sub1 local22 = new Class140_Sub2_Sub1();
			local11 = local22.method20291(128, 128, 16);
			anObject10 = Class113.method7411(local11, false);
		}
		@Pc(36) Class209 local36 = arg0.aClass209_1;
		if (local36.method25406() && anObject12 == null) {
			local11 = Class571.method31324(128, 128, 16, 8, new Class161_Sub1(419684), 4.0F, 4.0F, 16.0F, 0.5F, 0.6F);
			anObject12 = Class113.method7411(local11, false);
		}
	}
	...
	Class199(@OriginalArg(0) Class104_Sub1 arg0) {
		...
		method24626(arg0);
		if (this.aBoolean577) {
			@Pc(103) byte[] local103 = Class331.method27386(anObject11, false);
			...
			@Pc(121) byte[] local121 = Class331.method27386(anObject10, false);
			...
			if (local137.method25406()) {
				local103 = Class331.method27386(anObject12, false);
				...
				if (local137.method25405(this.aClass88_Sub3_1, local168, 2.0F)) {
					this.aClass88_Sub3_1.method18043();
				} else {
					this.aClass88_Sub3_1.method18046();
					this.aClass88_Sub3_1 = null;
				}
				local168.method18046();
			}
		} else {
			...
			for (local31 = 0; local31 < 16; local31++) {
				local42 = Class441.method28856(anObject11, local31 * 32768, 32768);
			...
			for (local31 = 0; local31 < 16; local31++) {
				local42 = Class441.method28856(anObject10, local31 * 32768, 32768);
