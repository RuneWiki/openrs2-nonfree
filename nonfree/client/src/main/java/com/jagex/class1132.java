...
public class class1132 extends class895 {
	...
	public void method4987(Graphics arg0) {
		...
		int var4 = this.field10470.getWidth((ImageObserver) null);
		int var5 = this.field10470.getHeight((ImageObserver) null);
		...
		var6.drawImage(this.field10470, (AffineTransform) null, (ImageObserver) null);
