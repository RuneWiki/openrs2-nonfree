...
public abstract class Class118 implements Interface4 {
	...
	public static void method8414(@OriginalArg(0) String[] arg0, @OriginalArg(1) int[] arg1) {
	...
	public static Interface67 method8415(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(5) Class623 local5 = Class351.method27642(arg0.method22413());
		if (Class623.aClass623_2 == local5) {
			return Class632.method32295(arg0);
		} else if (local5 == Class623.aClass623_1) {
			return Class280.method26454(arg0);
		} else if (Class623.aClass623_3 == local5) {
			return Class448.method28920(arg0);
		} else {
			return null;
		}
	}
	...
	static void method8407(@OriginalArg(0) Class681 arg0) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class269.method26272();
	}
	...
	static boolean method8413(@OriginalArg(0) int arg0) {
	...
	static final void method8408(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= -1915563430;
	}

	@OriginalMember(owner = "client!hh", name = "aig", descriptor = "(Lclient!yf;B)V", line = 11262)
	static final void method8409(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class449.aClass514_1.method30267(local13).anIntArray261[local23];
	}

	@OriginalMember(owner = "client!hh", name = "aus", descriptor = "(Lclient!yf;B)V", line = 13369)
	static final void method8410(@OriginalArg(0) Class681 arg0) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub28_1.method16037() == 1 ? 1 : 0;
	}

	@OriginalMember(owner = "client!hh", name = "awg", descriptor = "(Lclient!yf;I)V", line = 13788)
	static final void method8411(@OriginalArg(0) Class681 arg0) {
