...
public class Class175 {
	...
	public final void method24350(@OriginalArg(0) byte arg0) throws IOException {
		...
		while (true) {
			...
			this.aClass93_Sub41_14.method22405(local17.aClass93_Sub41_Sub2_1.aByteArray58, 0, local17.anInt1569 * -1609174005, 2026842986);
			this.anInt3299 -= local17.anInt1569 * -337674397;
			local17.method23969(-1674819412);
			local17.aClass93_Sub41_Sub2_1.method22651((byte) 1);
			local17.method13712(-915434420);
		}
	}

	@OriginalMember(owner = "client!ax", name = "m", descriptor = "(Lclient!akl;I)V", line = 68)
	public final void method24351(@OriginalArg(0) Class93_Sub22 arg0, @OriginalArg(1) int arg1) {
	...
	final void method24352() {
		this.aClass22_44.method406(-2037259486);
		this.anInt3299 = 0;
	}

	@OriginalMember(owner = "client!ax", name = "f", descriptor = "(Lclient!uz;Ljava/lang/String;I)V", line = 84)
	void method24353(@OriginalArg(0) Class160 arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		this.aClass160_3 = arg0;
		this.aClass238_1.method25780(arg1, 1786592897);
	}

	@OriginalMember(owner = "client!ax", name = "s", descriptor = "(Lclient!akl;)V", line = 68)
	public final void method24354(@OriginalArg(0) Class93_Sub22 arg0) {
	...
	final void method24357() {
		this.aClass22_44.method406(-2037259486);
		this.anInt3299 = 0;
	}

	@OriginalMember(owner = "client!ax", name = "l", descriptor = "(B)V", line = 97)
	void method24358(@OriginalArg(0) byte arg0) {
		this.aClass160_3 = null;
		this.aClass238_1.method25780((String) null, 1316327137);
	}

	@OriginalMember(owner = "client!ax", name = "c", descriptor = "()V", line = 49)
	public final void method24359() throws IOException {
		if (this.aClass160_3 == null || this.anInt3299 * 195575097 <= 0) {
			return;
		}
		this.aClass93_Sub41_14.anInt3070 = 0;
	...
	public final void method24360() throws IOException {
		if (this.aClass160_3 == null || this.anInt3299 * 195575097 <= 0) {
			return;
		}
		this.aClass93_Sub41_14.anInt3070 = 0;
	...
	public final void method24361() throws IOException {
		if (this.aClass160_3 == null || this.anInt3299 * 195575097 <= 0) {
			return;
		}
		this.aClass93_Sub41_14.anInt3070 = 0;
	...
	public final void method24362(@OriginalArg(0) Class93_Sub22 arg0) {
	...
	void method24363(@OriginalArg(0) int arg0) {
		if (client.anInt3485 % 50 == 0) {
			this.anInt3302 = this.anInt3303 * -1435834729;
			this.anInt3303 = 0;
			this.anInt3305 = this.anInt3304 * -1325632603;
	...
	void method24364(@OriginalArg(0) Class160 arg0, @OriginalArg(1) String arg1) {
		this.aClass160_3 = arg0;
		this.aClass238_1.method25780(arg1, -55849145);
	}
	...
	void method24368(@OriginalArg(0) Class160 arg0, @OriginalArg(1) String arg1) {
		this.aClass160_3 = arg0;
		this.aClass238_1.method25780(arg1, 1921861521);
	}

	@OriginalMember(owner = "client!ax", name = "e", descriptor = "(I)V", line = 44)
	final void method24369(@OriginalArg(0) int arg0) {
		this.aClass22_44.method406(-2037259486);
		this.anInt3299 = 0;
	}
	...
	void method24370() {
		this.aClass160_3 = null;
		this.aClass238_1.method25780((String) null, 341825435);
	}

	@OriginalMember(owner = "client!ax", name = "i", descriptor = "()V", line = 97)
	void method24371() {
		this.aClass160_3 = null;
		this.aClass238_1.method25780((String) null, 73996478);
	}

	@OriginalMember(owner = "client!ax", name = "j", descriptor = "()V", line = 97)
	void method24372() {
		this.aClass160_3 = null;
		this.aClass238_1.method25780((String) null, 1436018187);
	}
	...
	static final void method24376(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class129.method21476(local11, local14, arg0, (byte) 126);
	}
	...
	public static boolean method24378(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		...
		if (arg1 == -1 && local33.anInt3971 * -158526639 == 0) {
			for (local46 = (Class93_Sub1_Sub7) Class454.aClass22_55.method445((byte) 82); local46 != null; local46 = (Class93_Sub1_Sub7) Class454.aClass22_55.method415(129192974)) {
				if (local46.anInt3012 * -92627949 == 58 || local46.anInt3012 * -92627949 == 1007 || local46.anInt3012 * -92627949 == 25 || local46.anInt3012 * -92627949 == 57 || local46.anInt3012 * -92627949 == 30) {
					for (@Pc(147) Class312 local147 = Class659.method32805(local46.anInt3009 * -1970204471, 1113430832); local147 != null; local147 = Class431.method28779(Class166_Sub1.aClass320Array1[local147.anInt3953 * -1549590237 >> 16], local147, -1843399743)) {
