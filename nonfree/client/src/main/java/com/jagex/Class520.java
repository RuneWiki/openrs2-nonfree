...
public class Class520 {
	...
	public void method30326(@OriginalArg(0) int arg0) {
	...
	public boolean method30327(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	public boolean method30328(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if ((this.aByteArrayArrayArray12[0][arg2][arg3] & 0x2) != 0) {
			...
			return this.method30336(arg1, arg2, arg3, (byte) 0) == arg0;
		} else {
			return false;
		}
	}
	...
	public boolean method30329(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte arg4) {
		if ((this.aByteArrayArrayArray12[0][arg2][arg3] & 0x2) != 0) {
			return true;
		} else if ((this.aByteArrayArrayArray12[arg1][arg2][arg3] & 0x10) == 0) {
			return this.method30336(arg1, arg2, arg3, (byte) 0) == arg0;
	...
	int method30336(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		if ((this.aByteArrayArrayArray12[arg0][arg1][arg2] & 0x8) == 0) {
			return arg0 <= 0 || (this.aByteArrayArrayArray12[1][arg1][arg2] & 0x2) == 0 ? arg0 : arg0 - 1;
		} else {
			return 0;
	...
	public static void method30339(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		Class707.aClass106_13 = (Class106) Class157.aClass462_2.method29264(client.anInterface50_1, Class393.anInt4654 * -414755309, true, true, -920650126);
		Class584.aClass5_15 = Class157.aClass462_2.method29241(client.anInterface50_1, Class393.anInt4654 * -414755309, 373300371);
		Class82.aClass106_1 = (Class106) Class157.aClass462_2.method29264(client.anInterface50_1, Class393.anInt4653 * 545040483, true, true, -1182236181);
		Class348.aClass5_14 = Class157.aClass462_2.method29241(client.anInterface50_1, Class393.anInt4653 * 545040483, -1243403341);
		Class118_Sub1.aClass106_3 = (Class106) Class157.aClass462_2.method29264(client.anInterface50_1, Class393.anInt4657 * -1023914731, true, true, 1828171144);
		Class110_Sub3.aClass5_7 = Class157.aClass462_2.method29241(client.anInterface50_1, Class393.anInt4657 * -1023914731, 613405039);
	}

	@OriginalMember(owner = "client!qx", name = "afo", descriptor = "(Lclient!yf;I)V", line = 10486)
	static final void method30340(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = local13 + Class107.method18120(local26, true, -449951645);
	}
	...
	static final void method30342(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		Class659.method32805(local13, 1766568141);
		Class380.method28117(Class166_Sub1.aClass320Array1[local13 >>> 16], local13 & 0xFFFF, local23, local33, arg0.aBoolean875, arg0, -1292091849);
	}

	@OriginalMember(owner = "client!qx", name = "e", descriptor = "(B)[Lclient!zd;", line = 18)
	static Class702[] method30343(@OriginalArg(0) byte arg0) {
