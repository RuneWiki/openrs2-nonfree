...
public class Class675 {
	...
	public void method33134(@OriginalArg(0) int arg0) {
		...
		this.method33142(-1615006608);
	}

	@OriginalMember(owner = "client!xz", name = "f", descriptor = "(Lclient!zu;B)I", line = 45)
	public int method33135(@OriginalArg(0) Class718 arg0, @OriginalArg(1) byte arg1) {
		if (Class718.aClass718_2 == arg0 && this.aClass640_1.method32470((byte) 0) && this.aClass640_1.method32487(-1884782942)) {
			@Pc(17) int local17 = this.aClass640_1.method32472(-580352577);
	...
	public void method33137(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.anInt5881 = arg0 * -1771862889;
		if (this.anInt5881 * -1812448473 < 0) {
			this.anInt5881 = 0;
		} else if (this.aBoolean874 && this.anInt5881 * -1812448473 > 2000000000) {
		...
		this.method33142(-2140533208);
	}

	@OriginalMember(owner = "client!xz", name = "k", descriptor = "(I)I", line = 41)
	public int method33138(@OriginalArg(0) int arg0) {
		return this.anInt5880 * -165594905;
	}
	...
	void method33139() {
		if (this.aBoolean874) {
			this.anInt5880 = this.aClass640_1.method32468(this.anInt5881 * -1812448473, (byte) 7) * -2010621225;
		} else {
			this.anInt5880 = this.aClass640_1.method32474(this.anInt5881 * -1812448473, (byte) 122) * -2010621225;
		}
	}

	@OriginalMember(owner = "client!xz", name = "n", descriptor = "(Lclient!zu;B)I", line = 24)
	public int method33140(@OriginalArg(0) Class718 arg0, @OriginalArg(1) byte arg1) {
		if (Class718.aClass718_2 == arg0 && this.aClass640_1.method32470((byte) 0) && this.aClass640_1.method32487(-1884782942)) {
			@Pc(17) int local17 = this.aClass640_1.method32471(531513888);
			if (!this.aBoolean874) {
				local17 /= 10;
			}
	...
	public void method33141(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.anInt5882 = arg0 * 1180966377;
	}

	@OriginalMember(owner = "client!xz", name = "u", descriptor = "(I)V", line = 61)
	void method33142(@OriginalArg(0) int arg0) {
		if (this.aBoolean874) {
			this.anInt5880 = this.aClass640_1.method32468(this.anInt5881 * -1812448473, (byte) 7) * -2010621225;
		} else {
			this.anInt5880 = this.aClass640_1.method32474(this.anInt5881 * -1812448473, (byte) 118) * -2010621225;
		}
	}
	...
	public int method33145(@OriginalArg(0) Class718 arg0) {
		if (Class718.aClass718_2 == arg0 && this.aClass640_1.method32470((byte) 0) && this.aClass640_1.method32487(-1884782942)) {
			@Pc(17) int local17 = this.aClass640_1.method32471(-1325345248);
			if (!this.aBoolean874) {
				local17 /= 10;
			}
			if (this.anInt5881 * -1812448473 > local17) {
	...
	public int method33146(@OriginalArg(0) byte arg0) {
	...
	public int method33147(@OriginalArg(0) Class718 arg0) {
		if (Class718.aClass718_2 == arg0 && this.aClass640_1.method32470((byte) 0) && this.aClass640_1.method32487(-1884782942)) {
			@Pc(17) int local17 = this.aClass640_1.method32471(-62226593);
			if (!this.aBoolean874) {
				local17 /= 10;
			}
			if (this.anInt5881 * -1812448473 > local17) {
	...
	public int method33148(@OriginalArg(0) Class718 arg0) {
		if (Class718.aClass718_2 == arg0 && this.aClass640_1.method32470((byte) 0) && this.aClass640_1.method32487(-1884782942)) {
			@Pc(17) int local17 = this.aClass640_1.method32471(1687860030);
			if (!this.aBoolean874) {
				local17 /= 10;
			}
			if (this.anInt5881 * -1812448473 > local17) {
	...
	void method33149() {
		if (this.aBoolean874) {
			...
			this.anInt5880 = this.aClass640_1.method32474(this.anInt5881 * -1812448473, (byte) 81) * -2010621225;
		}
	}
	...
	public int method33152(@OriginalArg(0) int arg0) {
		return this.anInt5881 * -1812448473;
	}
	...
	public int method33154(@OriginalArg(0) Class718 arg0) {
		if (Class718.aClass718_2 == arg0 && this.aClass640_1.method32470((byte) 0) && this.aClass640_1.method32487(-1884782942)) {
			@Pc(17) int local17 = this.aClass640_1.method32472(-1789895001);
			if (this.anInt5880 * -165594905 > local17) {
				return local17;
			}
		}
	...
	public int method33157(@OriginalArg(0) Class718 arg0) {
		if (Class718.aClass718_2 == arg0 && this.aClass640_1.method32470((byte) 0) && this.aClass640_1.method32487(-1884782942)) {
			@Pc(17) int local17 = this.aClass640_1.method32472(-1446213663);
			if (this.anInt5880 * -165594905 > local17) {
				return local17;
			}
		}
	...
	public int method33158(@OriginalArg(0) Class718 arg0) {
		if (Class718.aClass718_2 == arg0 && this.aClass640_1.method32470((byte) 0) && this.aClass640_1.method32487(-1884782942)) {
			@Pc(17) int local17 = this.aClass640_1.method32472(-1526243363);
			if (this.anInt5880 * -165594905 > local17) {
				return local17;
			}
		}
	...
	void method33163() {
		if (this.aBoolean874) {
			...
			this.anInt5880 = this.aClass640_1.method32474(this.anInt5881 * -1812448473, (byte) 39) * -2010621225;
		}
	}
	...
	void method33165() {
		if (this.aBoolean874) {
			...
			this.anInt5880 = this.aClass640_1.method32474(this.anInt5881 * -1812448473, (byte) 16) * -2010621225;
		}
	}
