...
public abstract class Class93_Sub23 extends Class93 {
	...
	public abstract void method22871();

	@OriginalMember(owner = "client!akm", name = "r", descriptor = "()I")
	public abstract int method22872();

	@OriginalMember(owner = "client!akm", name = "n", descriptor = "(I)I")
	public abstract int method22873(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!akm", name = "m", descriptor = "(B)I")
	public abstract int method22874(@OriginalArg(0) byte arg0);
	...
	public abstract long method22876(@OriginalArg(0) byte arg0);

	@OriginalMember(owner = "client!akm", name = "l", descriptor = "(B)V")
	public abstract void method22877(@OriginalArg(0) byte arg0);

	@OriginalMember(owner = "client!akm", name = "u", descriptor = "()I")
	public abstract int method22878();

	@OriginalMember(owner = "client!akm", name = "z", descriptor = "()I")
	public abstract int method22879();
	...
	public abstract long method22883();
	...
	public abstract int method22890(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!akm", name = "r", descriptor = "(IIIB)I", line = 240)
	public static final int method22891(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		if (arg2 > 243) {
			arg1 >>= 0x4;
		} else if (arg2 > 217) {
			arg1 >>= 0x3;
