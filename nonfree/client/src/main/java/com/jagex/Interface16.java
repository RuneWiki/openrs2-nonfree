...
public interface Interface16 {
	...
	void method2560(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int arg1);

	@OriginalMember(owner = "client!cf", name = "m", descriptor = "(I[BI)V")
	void method2561(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int arg1);
	...
	void method2565(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int arg1);

	@OriginalMember(owner = "client!cf", name = "p", descriptor = "(I[BI)V")
	void method2566(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int arg1);
