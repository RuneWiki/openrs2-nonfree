...
public class Class281 {
	...
	public static boolean method26460(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	static void method26461(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method26462(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
	...
	public static void method26463(@OriginalArg(0) Iterable arg0, @OriginalArg(1) Class93_Sub41 arg1, @OriginalArg(2) int arg2) {
		@Pc(3) int local3 = Class384.method28155(arg0, 1759950388);
		arg1.method22639(local3, (byte) -58);
		if (local3 == 0) {
			return;
		}
