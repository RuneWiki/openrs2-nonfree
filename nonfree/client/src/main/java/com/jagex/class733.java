...
public class class733 {
	...
	public static class733 method1593(class442 arg0, int arg1, int arg2) {
		return method6068(arg0, arg1, arg2, (class731) null);
	}
	...
	public class733(byte[] arg0, class731 arg1) {
		...
		for (int var8 = 0; var8 < 256; var8++) {
			this.field8573[var8][2] = (short) this.field8574[var8];
			this.field8573[var8][3] = (short) this.field8564[var8];
		}
		if (var5) {
	...
	public int method14532(String arg0) {
		return this.method14533(arg0, (class732[]) null);
	}
	...
	public String method14534(String arg0, int arg1, class732[] arg2) {
		...
		int var4 = arg1 - this.method14533("...", (class732[]) null);
		int var5 = -1;
		int var6 = -1;
		int var7 = 0;
