...
public class Class292 implements Interface26 {
	...
	public void method26714(@OriginalArg(0) Class297 arg0) {
		if (-423742175 * this.anInt3913 != -1) {
			try {
				arg0.method26624(583161273).method33469((Class379) this.this$0.anInterface27_2.method25530(1191202635).method18261(this.anInt3913 * -423742175, -992668554), this.anInt3912 * 1735945331, -283552376);
	...
	public void method26715(@OriginalArg(0) Class297 arg0, @OriginalArg(1) byte arg1) {
		if (-423742175 * this.anInt3913 != -1) {
			try {
				arg0.method26624(-652552122).method33469((Class379) this.this$0.anInterface27_2.method25530(-247809848).method18261(this.anInt3913 * -423742175, 1089121099), this.anInt3912 * 1735945331, 2067586462);
			} catch (@Pc(28) Exception_Sub7 local28) {
			}
		}
	}
	...
	Class292(@OriginalArg(0) Class303 arg0, @OriginalArg(1) Class93_Sub41 arg1) {
		this.this$0 = arg0;
		@Pc(8) int local8 = arg1.method22415(-1434290800);
		if (local8 == 65535) {
			this.anInt3913 = -1526435553;
			this.anInt3912 = 0;
		} else {
			this.anInt3913 = local8 * 1526435553;
			this.anInt3912 = arg1.method22419(-118643075) * -768993093;
		}
	}
	...
	public void method26713(@OriginalArg(0) Class297 arg0) {
		if (-423742175 * this.anInt3913 != -1) {
			try {
				arg0.method26624(1992846787).method33469((Class379) this.this$0.anInterface27_2.method25530(877498787).method18261(this.anInt3913 * -423742175, 926467896), this.anInt3912 * 1735945331, 1025843417);
			} catch (@Pc(28) Exception_Sub7 local28) {
			}
		}
	}
	...
	static void method26579(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class106 arg6, @OriginalArg(7) Class5 arg7, @OriginalArg(8) String arg8, @OriginalArg(9) int arg9) {
	...
	public static void method26580(@OriginalArg(0) Class645 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method26581(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		Class314.method26937(local11, arg0, -1328830745);
	}
