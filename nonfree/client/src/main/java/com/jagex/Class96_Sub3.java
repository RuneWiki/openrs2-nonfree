...
public class Class96_Sub3 extends Class96 {
	...
	public static int method2329(@OriginalArg(0) Class497 arg0, @OriginalArg(1) int arg1) {
		@Pc(1) int local1 = 0;
		if (arg0.method30054(Class393.anInt4655 * -862282487, -512225963)) {
			local1++;
		}
		if (arg0.method30054(Class393.anInt4660 * 1530987473, -512225963)) {
			local1++;
		}
		if (arg0.method30054(Class393.anInt4656 * 1048499503, -512225963)) {
			local1++;
		}
		if (arg0.method30054(Class81.anInt248 * -49354807, -512225963)) {
			local1++;
		}
		if (arg0.method30054(Class393.anInt4652 * -512546131, -512225963)) {
			local1++;
		}
		if (arg0.method30054(Class393.anInt4658 * 1492309703, -512225963)) {
			local1++;
		}
		...
		if (arg0.method30054(Class393.anInt4659 * -71569053, -512225963)) {
			local1++;
		}
	...
	static final void method2330(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1650617873);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class168.method17627(local16, local22, arg0, (byte) -46);
	}
	...
	static void method2331(@OriginalArg(0) String[] arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(5) int local5 = 0; local5 < arg0.length; local5++) {
			if (arg0[local5].startsWith("pause")) {
				...
				Class168.aLong111 = (Class305.method26796(1979182407) + (long) (local17 * 1000)) * 9101462360260179041L;
				return;
			}
