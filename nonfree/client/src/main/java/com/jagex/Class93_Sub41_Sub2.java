...
public class Class93_Sub41_Sub2 extends Class93_Sub41 {
	...
	public void method22665(@OriginalArg(0) Class24 arg0) {
		this.aClass24_1 = arg0;
	}

	@OriginalMember(owner = "client!ase", name = "jg", descriptor = "(Lclient!aav;B)V", line = 15)
	public void method22672(@OriginalArg(0) Class24 arg0) {
		this.aClass24_1 = arg0;
	}

	@OriginalMember(owner = "client!ase", name = "jx", descriptor = "(II)V", line = 19)
	public void method22661(@OriginalArg(0) int arg0) {
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 + this.aClass24_1.method505());
	}

	@OriginalMember(owner = "client!ase", name = "kf", descriptor = "(I)V", line = 19)
	public void method22673(@OriginalArg(0) int arg0) {
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 + this.aClass24_1.method505());
	}

	@OriginalMember(owner = "client!ase", name = "ko", descriptor = "(I)V", line = 19)
	public void method22686(@OriginalArg(0) int arg0) {
		this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] = (byte) (arg0 + this.aClass24_1.method505());
	}

	@OriginalMember(owner = "client!ase", name = "kl", descriptor = "()I", line = 23)
	public int method22662() {
		return this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] - this.aClass24_1.method505() & 0xFF;
	}

	@OriginalMember(owner = "client!ase", name = "jh", descriptor = "(I)I", line = 23)
	public int method22664() {
		return this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] - this.aClass24_1.method505() & 0xFF;
	}
	...
	public boolean method22679() {
		@Pc(14) int local14 = this.aByteArray58[this.anInt3070 * 212851357] - this.aClass24_1.method506() & 0xFF;
		return local14 >= 128;
	}

	@OriginalMember(owner = "client!ase", name = "kb", descriptor = "()Z", line = 27)
	public boolean method22680() {
		@Pc(14) int local14 = this.aByteArray58[this.anInt3070 * 212851357] - this.aClass24_1.method506() & 0xFF;
		return local14 >= 128;
	}

	@OriginalMember(owner = "client!ase", name = "kr", descriptor = "()Z", line = 27)
	public boolean method22681() {
		@Pc(14) int local14 = this.aByteArray58[this.anInt3070 * 212851357] - this.aClass24_1.method506() & 0xFF;
		return local14 >= 128;
	}

	@OriginalMember(owner = "client!ase", name = "kc", descriptor = "()I", line = 33)
	public int method22663() {
		@Pc(21) int local21 = this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] - this.aClass24_1.method505() & 0xFF;
		return local21 < 128 ? local21 : (local21 - 128 << 8) + (this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] - this.aClass24_1.method505() & 0xFF);
	}
	...
	public void method22667(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		for (@Pc(1) int local1 = 0; local1 < arg2; local1++) {
			arg0[arg1 + local1] = (byte) (this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] - this.aClass24_1.method505());
		}
	}

	@OriginalMember(owner = "client!ase", name = "kj", descriptor = "([BII)V", line = 39)
	public void method22684(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		for (@Pc(1) int local1 = 0; local1 < arg2; local1++) {
			arg0[arg1 + local1] = (byte) (this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] - this.aClass24_1.method505());
		}
	}
	...
	public void method22685(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		for (@Pc(1) int local1 = 0; local1 < arg2; local1++) {
			arg0[arg1 + local1] = (byte) (this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] - this.aClass24_1.method505());
		}
	}
	...
	public int method22688(@OriginalArg(0) int arg0) {
		@Pc(6) int local6 = this.anInt3073 * 1626146007 >> 3;
		@Pc(15) int local15 = 8 - (this.anInt3073 * 1626146007 & 0x7);
		@Pc(17) int local17 = 0;
		this.anInt3073 += arg0 * 1552821991;
	...
	public int method22689(@OriginalArg(0) int arg0) {
		@Pc(6) int local6 = this.anInt3073 * 1626146007 >> 3;
		@Pc(15) int local15 = 8 - (this.anInt3073 * 1626146007 & 0x7);
		@Pc(17) int local17 = 0;
		this.anInt3073 += arg0 * 1552821991;
	...
	public void method22691() {
		this.anInt3070 = (this.anInt3073 * 1626146007 + 7) / 8 * -1445626955;
	}

	@OriginalMember(owner = "client!ase", name = "kg", descriptor = "(II)I", line = 66)
	public int method22671(@OriginalArg(0) int arg0) {
