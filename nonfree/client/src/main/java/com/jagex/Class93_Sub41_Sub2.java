...
public class Class93_Sub41_Sub2 extends Class93_Sub41 {
	...
	public void method22661(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public int method22664(@OriginalArg(0) int arg0) {
		return this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] - this.aClass24_1.method505(565430542) & 0xFF;
	}
	...
	public int method22666(@OriginalArg(0) int arg0) {
		@Pc(21) int local21 = this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] - this.aClass24_1.method505(565430542) & 0xFF;
		return local21 < 128 ? local21 : (local21 - 128 << 8) + (this.aByteArray58[(this.anInt3070 += -1445626955) * 212851357 - 1] - this.aClass24_1.method505(565430542) & 0xFF);
	}

	@OriginalMember(owner = "client!ase", name = "kw", descriptor = "([BIII)V", line = 39)
	public void method22667(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	public void method22668(@OriginalArg(0) byte arg0) {
	...
	public void method22670(@OriginalArg(0) int arg0) {
		this.anInt3070 = (this.anInt3073 * 1626146007 + 7) / 8 * -1445626955;
	}

	@OriginalMember(owner = "client!ase", name = "kg", descriptor = "(II)I", line = 66)
	public int method22671(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg0 * 8 - this.anInt3073 * 1626146007;
	}

	@OriginalMember(owner = "client!ase", name = "jg", descriptor = "(Lclient!aav;B)V", line = 15)
	public void method22672(@OriginalArg(0) Class24 arg0, @OriginalArg(1) byte arg1) {
		this.aClass24_1 = arg0;
	}
	...
	public boolean method22679(@OriginalArg(0) int arg0) {
	...
	public int method22689(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(6) int local6 = this.anInt3073 * 1626146007 >> 3;
		@Pc(15) int local15 = 8 - (this.anInt3073 * 1626146007 & 0x7);
		@Pc(17) int local17 = 0;
		this.anInt3073 += arg0 * 1552821991;
