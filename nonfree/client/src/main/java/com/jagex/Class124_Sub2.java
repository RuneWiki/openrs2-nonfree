...
public class Class124_Sub2 extends Class124 {
	...
	public double[] method21403() {
		...
		@Pc(6) Class472 local6 = this.method21402((byte) 23);
	...
	public void method9297(@OriginalArg(0) Class93_Sub30 arg0, @OriginalArg(1) int arg1) {
		this.aClass472_22.aFloat317 = (float) (arg0.anInt1610 * -427776677);
		this.aClass472_22.aFloat318 = (float) (arg0.anInt1611 * 1802884841);
		this.aClass472_22.aFloat319 = (float) (arg0.anInt1612 * 671628745);
	...
	public double[] method21413(@OriginalArg(0) int arg0) {
		@Pc(2) double[] local2 = new double[3];
		@Pc(6) Class472 local6 = this.method21402((byte) 127);
		local2[0] = (double) local6.aFloat317;
		local2[1] = (double) local6.aFloat318;
		local2[2] = (double) local6.aFloat319;
		return local2;
	...
	void method9299(@OriginalArg(0) int[][][] arg0, @OriginalArg(1) Class520 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (!this.method21401(-1492062449) || !this.aClass123_13.method8973(1743437705) && !this.aClass123_13.method8974(-1449786703) || !this.aClass123_13.method8974(2066620468) || arg0 == null) {
			return;
		}
		...
		if (local183 > 0.0F) {
			this.aClass472_22.aFloat318 = (float) -local175;
		}
	}
	...
	void method9301(@OriginalArg(0) int[][][] arg0, @OriginalArg(1) Class520 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (!this.method21401(361774651) || !this.aClass123_13.method8973(1047558235) && !this.aClass123_13.method8974(-1593318430) || !this.aClass123_13.method8974(1362337109) || arg0 == null) {
			return;
		}
		@Pc(30) int local30 = (int) this.aClass472_22.aFloat317 - arg2 >> 9;
		@Pc(39) int local39 = (int) this.aClass472_22.aFloat319 - arg3 >> 9;
	...
	void method9304(@OriginalArg(0) int[][][] arg0, @OriginalArg(1) Class520 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (!this.method21401(1602116512) || !this.aClass123_13.method8973(-598471876) && !this.aClass123_13.method8974(598316568) || !this.aClass123_13.method8974(463733395) || arg0 == null) {
			return;
		}
		@Pc(30) int local30 = (int) this.aClass472_22.aFloat317 - arg2 >> 9;
		@Pc(39) int local39 = (int) this.aClass472_22.aFloat319 - arg3 >> 9;
	...
	void method9306(@OriginalArg(0) int[][][] arg0, @OriginalArg(1) Class520 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (!this.method21401(-1242879324) || !this.aClass123_13.method8973(1170933435) && !this.aClass123_13.method8974(-438519739) || !this.aClass123_13.method8974(-2054566806) || arg0 == null) {
			return;
		}
		@Pc(30) int local30 = (int) this.aClass472_22.aFloat317 - arg2 >> 9;
		@Pc(39) int local39 = (int) this.aClass472_22.aFloat319 - arg3 >> 9;
	...
	void method9307(@OriginalArg(0) int[][][] arg0, @OriginalArg(1) Class520 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (!this.method21401(1595139226) || !this.aClass123_13.method8973(-1479832563) && !this.aClass123_13.method8974(-763041710) || !this.aClass123_13.method8974(-2111273278) || arg0 == null) {
			return;
		}
		@Pc(30) int local30 = (int) this.aClass472_22.aFloat317 - arg2 >> 9;
		@Pc(39) int local39 = (int) this.aClass472_22.aFloat319 - arg3 >> 9;
	...
	public static Class312 method9308(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		@Pc(3) Class312 local3 = Class659.method32805(arg0, 1886061981);
		if (arg1 == -1) {
			return local3;
