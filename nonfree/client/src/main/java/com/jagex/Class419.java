...
public class Class419 {
	...
	Class419(@OriginalArg(0) Class104_Sub2 arg0, @OriginalArg(1) int arg1) {
		this.this$0 = arg0;
		this.method28707();
		this.method28711(arg1, this.anInt4770);
	}

	@OriginalMember(owner = "client!mi", name = "e", descriptor = "()V", line = 1885)
	void method28707() {
		this.anInterface37_24 = this.this$0.method21013(true);
		this.this$0.method20993(new Class400[] { new Class400(new Class399[] { Class399.aClass399_9, Class399.aClass399_10 }) });
		this.this$0.method20993(new Class400[] { new Class400(new Class399[] { Class399.aClass399_9, Class399.aClass399_10 }) });
		this.this$0.method20993(new Class400[] { new Class400(new Class399[] { Class399.aClass399_9, Class399.aClass399_10 }) });
		this.anInt4770 = 16;
	}
	...
	void method28708(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	void method28711(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (!this.anInterface37_24.method29315(arg0, arg1)) {
			System.out.println("PrimitiveVertexBuffer:ensureSize: failed vertexBuffer.allocate !");
		}
	}
