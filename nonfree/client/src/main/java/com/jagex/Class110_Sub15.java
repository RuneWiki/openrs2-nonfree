...
public abstract class Class110_Sub15 extends Class110 {
	...
	Class110_Sub15(@OriginalArg(0) Class93_Sub41 arg0) {
		super(arg0);
		this.anInt2821 = arg0.method22415(-1434290800) * -1182122795;
		this.anInt2822 = arg0.method22415(-1434290800) * -34475289;
		this.anInt2823 = arg0.method22413((short) 16384) * 1877251199;
	}
	...
	boolean method20142() {
		...
		@Pc(12) boolean local12 = local8.method36665((byte) 8);
		@Pc(21) Class263 local21 = (Class263) Class32.aClass32_Sub17_23.method18261(local8.anInt5949 * 1477426425, 1642330214);
		return local12 & local21.method26194((byte) -99);
	}

	@OriginalMember(owner = "client!agm", name = "u", descriptor = "(II)V", line = 272)
	static void method20151(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		Class172.anInt3176 = 0;
		@Pc(5) int local5 = client.aClass532_1.method30444(2067319058);
		@Pc(9) int local9 = client.aClass532_1.method30474((short) 128);
		@Pc(13) Class520 local13 = client.aClass532_1.method30509(-218524362);
		@Pc(17) Class585 local17 = client.aClass532_1.method30459(-1736355724);
		@Pc(21) Class32_Sub14 local21 = client.aClass532_1.method30466(959323443);
		...
		for (@Pc(63) int local63 = 0; local63 < local5; local63++) {
			for (@Pc(68) int local68 = 0; local68 < local9; local68++) {
				for (@Pc(73) int local73 = local23; local73 <= arg0 + 1 && local73 <= 3; local73++) {
					if ((local73 < arg0 || local13.method30329(arg0, local73, local63, local68, (byte) -62)) && !Class393.method28313((Interface61) local17.method31496(local73, local63, local68, -968156135), local21, local63, local68, -1787817682) && !Class393.method28313((Interface61) local17.method31585(local73, local63, local68, client.anInterface62_1, (byte) 3), local21, local63, local68, -1944175185) && !Class393.method28313((Interface61) local17.method31440(local73, local63, local68, -1309876799), local21, local63, local68, -1724839160) && Class393.method28313((Interface61) local17.method31464(local73, local63, local68, -2076759954), local21, local63, local68, -2055902105)) {
					}
				}
			}
		}
	...
	public static float method20152(@OriginalArg(0) Class471 arg0, @OriginalArg(1) byte arg1) {
