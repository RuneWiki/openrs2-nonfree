...
public class Class110_Sub14 extends Class110 {
	...
	Class110_Sub14(@OriginalArg(0) Class93_Sub41 arg0) {
		super(arg0);
		this.anInt955 = arg0.method22415(-1434290800) * -1039422713;
		this.anIntArray83 = new int[4];
		this.anInt953 = arg0.method22436(-1410250426) * 519064321;
		Arrays.fill(this.anIntArray83, 0, this.anIntArray83.length, this.anInt953 * -1542933247);
		this.anInt954 = arg0.method22419(-118643075) * -1990374291;
	}
	...
	boolean method20141() {
		...
		return local8.method26194((byte) -37);
	}
	...
	boolean method20139(@OriginalArg(0) int arg0) {
		...
		return local8.method26194((byte) -119);
	}

	@OriginalMember(owner = "client!agk", name = "f", descriptor = "()V", line = 26)
	@Override
	public void method20140() {
		@Pc(8) Class132_Sub1_Sub1_Sub1 local8 = Class249.aClass239Array1[this.anInt955 * 1568395959].method25807(-2058124491);
		if (this.anInt954 * -1738891931 == 0) {
			Class623.method32148(local8, this.anIntArray83, 0, false, 1736878199);
		} else {
	...
	public void method20138(@OriginalArg(0) int arg0) {
		@Pc(8) Class132_Sub1_Sub1_Sub1 local8 = Class249.aClass239Array1[this.anInt955 * 1568395959].method25807(-1100475246);
		if (this.anInt954 * -1738891931 == 0) {
			Class623.method32148(local8, this.anIntArray83, 0, false, 382834664);
		} else {
	...
	boolean method20142() {
		...
		return local8.method26194((byte) -87);
	}
	...
	static final void method8051(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(16) Class312 local16 = Class659.method32805(local12, 612605750);
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = client.method25238(local16).method13620((short) 1426);
	}
}
