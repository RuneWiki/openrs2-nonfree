...
public abstract class Class160 {
	...
	public static Class160 method14715(@OriginalArg(0) Socket arg0, @OriginalArg(1) int arg1) throws IOException {
		return Class117.method8383(arg0, arg1, arg1);
	}
	...
	static int method14731(@OriginalArg(0) int arg0) {
		if (arg0 == 9 || arg0 == 10) {
			return 1;
		} else if (arg0 == 11) {
			return 8;
	...
	static final void method14732(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
		...
		arg0.anObjectArray9 = Class499.method30148(local13, arg2);
		arg0.aBoolean680 = true;
	}

	@OriginalMember(owner = "client!uz", name = "bab", descriptor = "(Lclient!yf;I)V", line = 14237)
	static final void method14730(@OriginalArg(0) Class681 arg0) {
	...
	public abstract int method14711(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException;

	@OriginalMember(owner = "client!uz", name = "w", descriptor = "([BIII)V")
	public abstract void method14712(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException;

	@OriginalMember(owner = "client!uz", name = "l", descriptor = "(I)V")
	public abstract void method14713();

	@OriginalMember(owner = "client!uz", name = "u", descriptor = "(I)V")
	public abstract void method14714();
	...
	public abstract boolean method14720(@OriginalArg(0) int arg0) throws IOException;
