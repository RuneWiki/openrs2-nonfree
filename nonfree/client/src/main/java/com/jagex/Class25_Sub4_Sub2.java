...
public class Class25_Sub4_Sub2 extends Class25_Sub4 {
	...
	float method23141(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) int arg3) {
		@Pc(12) float local12 = this.aFloat229 / (float) this.aClass479Array8[this.anInt3156 * 937231037].method29712();
	...
	void method23140(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2) {
		this.aFloat229 += arg0;
		if (this.aFloat229 > (float) this.aClass479Array8[this.anInt3156 * 937231037].method29712()) {
			this.aFloat229 = (float) this.aClass479Array8[this.anInt3156 * 937231037].method29712();
		}
	}
	...
	public Class472 method23120(@OriginalArg(0) int arg0) {
		...
		@Pc(12) double[] local12 = this.aClass479Array8[this.anInt3156 * 937231037].method29716(this.aFloat229);
	...
	void method23149(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(12) int local12 = 0; local12 < arg1; local12++) {
			this.aFloatArray74[local12] = arg0.method22425(30311528);
			this.aFloatArray73[local12] = arg0.method22425(1922227266);
		}
	}
	...
	void method23147(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		this.anInt3156 = 0;
		for (@Pc(12) int local12 = 0; local12 < arg1; local12++) {
			this.aFloatArray74[local12] = arg0.method22425(1537135703);
			this.aFloatArray73[local12] = arg0.method22425(-1386678195);
		}
	}
	...
	void method23145(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		...
		this.anInt3156 = 0;
		for (@Pc(12) int local12 = 0; local12 < arg1; local12++) {
			this.aFloatArray74[local12] = arg0.method22425(1233811034);
			this.aFloatArray73[local12] = arg0.method22425(683278535);
		}
	}
	...
	public Class472 method23133() {
		return this.method23120(1910760167);
	}
	...
	public Class472 method23117() {
		return this.method23120(-930873016);
	}
