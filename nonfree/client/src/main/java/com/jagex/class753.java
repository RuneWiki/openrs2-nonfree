		...
		try {
			...
			if (arg2 > this.field8765.length) {
				...
				while (arg2 > 0) {
					...
					this.field8774 += (long) var9;
					this.field8771 += (long) var9;
					arg1 += var9;
					arg2 -= var9;
				}
			} else if (arg2 > 0) {
