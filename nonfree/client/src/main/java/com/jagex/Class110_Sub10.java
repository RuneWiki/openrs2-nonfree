...
public class Class110_Sub10 extends Class110 {
	...
	public void method20138(@OriginalArg(0) int arg0) {
		Class249.aClass239Array1[this.anInt926 * 1708975647].method25807(1176044649).method19968(this.aString29, this.anInt927 * 1158231167, 0, this.anInt925 * 20284623, 1240454780);
	}

	@OriginalMember(owner = "client!agg", name = "f", descriptor = "()V", line = 20)
	@Override
	public void method20140() {
		Class249.aClass239Array1[this.anInt926 * 1708975647].method25807(354328266).method19968(this.aString29, this.anInt927 * 1158231167, 0, this.anInt925 * 20284623, 1283680156);
	}
	...
	Class110_Sub10(@OriginalArg(0) Class93_Sub41 arg0) {
		super(arg0);
		this.anInt926 = arg0.method22415(-1434290800) * -2048059937;
		this.aString29 = arg0.method22427(1285423375);
		this.anInt927 = arg0.method22419(-118643075) * -267220097;
		this.anInt925 = arg0.method22415(-1434290800) * 812450351;
	}
