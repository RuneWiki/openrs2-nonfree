...
public class Class166_Sub2 extends Class166 {
	...
	public int method16543(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 != 0 && this.aClass93_Sub36_49.aClass166_Sub26_1.method15908((byte) 24) == 2) {
			return 3;
		} else if (arg0 == 0 || this.aClass93_Sub36_49.aClass166_Sub46_1.method16529(961864208) == 1) {
			return 1;
		} else {
			return 2;
		}
	...
	public void method15372(@OriginalArg(0) int arg0) {
		if (this.anInt2379 * 960141055 != 0 && this.aClass93_Sub36_49.aClass166_Sub46_1.method16529(-7152280) != 1) {
			this.anInt2379 = 0;
		}
		if (this.anInt2379 * 960141055 != 0 && this.aClass93_Sub36_49.aClass166_Sub26_1.method15908((byte) 67) == 2) {
			this.anInt2379 = 0;
		}
		if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 1) {
			this.anInt2379 = this.method16542((byte) -48) * -88839937;
		}
	}
	...
	public boolean method15373(@OriginalArg(0) byte arg0) {
		return true;
	}
	...
	public int method16540(@OriginalArg(0) int arg0) {
		if (arg0 != 0 && this.aClass93_Sub36_49.aClass166_Sub26_1.method15908((byte) 40) == 2) {
			return 3;
		} else if (arg0 == 0 || this.aClass93_Sub36_49.aClass166_Sub46_1.method16529(-394611339) == 1) {
			return 1;
		} else {
			return 2;
		}
	...
	public int method16549(@OriginalArg(0) int arg0) {
		if (arg0 != 0 && this.aClass93_Sub36_49.aClass166_Sub26_1.method15908((byte) 29) == 2) {
			return 3;
		} else if (arg0 == 0 || this.aClass93_Sub36_49.aClass166_Sub46_1.method16529(1818972977) == 1) {
			return 1;
		} else {
			return 2;
		}
	...
	public int method15376(@OriginalArg(0) int arg0) {
		return this.anInt2379 * 960141055;
	}
	...
	public void method15377() {
		if (this.anInt2379 * 960141055 != 0 && this.aClass93_Sub36_49.aClass166_Sub46_1.method16529(250347349) != 1) {
			this.anInt2379 = 0;
		}
		if (this.anInt2379 * 960141055 != 0 && this.aClass93_Sub36_49.aClass166_Sub26_1.method15908((byte) 27) == 2) {
			this.anInt2379 = 0;
		}
		if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 1) {
			this.anInt2379 = this.method16542((byte) -106) * -88839937;
		}
	}

	@OriginalMember(owner = "client!amb", name = "x", descriptor = "()V", line = 19)
	public void method15378() {
		if (this.anInt2379 * 960141055 != 0 && this.aClass93_Sub36_49.aClass166_Sub46_1.method16529(-1433222603) != 1) {
			this.anInt2379 = 0;
		}
		if (this.anInt2379 * 960141055 != 0 && this.aClass93_Sub36_49.aClass166_Sub26_1.method15908((byte) 86) == 2) {
			this.anInt2379 = 0;
		}
		if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 1) {
			this.anInt2379 = this.method16542((byte) -126) * -88839937;
		}
	}

	@OriginalMember(owner = "client!amb", name = "b", descriptor = "()V", line = 19)
	public void method15379() {
		if (this.anInt2379 * 960141055 != 0 && this.aClass93_Sub36_49.aClass166_Sub46_1.method16529(1038039268) != 1) {
			this.anInt2379 = 0;
		}
		if (this.anInt2379 * 960141055 != 0 && this.aClass93_Sub36_49.aClass166_Sub26_1.method15908((byte) 34) == 2) {
			this.anInt2379 = 0;
		}
		if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 1) {
			this.anInt2379 = this.method16542((byte) -98) * -88839937;
		}
	}
	...
	static final void method15385(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
