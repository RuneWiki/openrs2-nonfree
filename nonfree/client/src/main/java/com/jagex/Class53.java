...
public abstract class Class53 {
	...
	static String method14943(@OriginalArg(0) long arg0) {
		return Class285.method26512(new Date(arg0), "EEE dd-MMM-yyyy HH:mm:ss zzz", 1649412825);
	}
	...
	static final void method14944(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
		...
		Class348.method27622(local13, new Class93_Sub40(local23, 3), (int[]) null, true, (byte) 0);
	}
	...
	static final void method14945(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		if (Class4.aBoolean2) {
			@Pc(4) Class14[] local4 = Class124_Sub3.method21453(16711935);
	...
	static Class449[] method14946(@OriginalArg(0) int arg0) {
