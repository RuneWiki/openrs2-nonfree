...
public abstract class Class53 {
	...
	static final void method14944(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		Class348.method27622(local13, new Class93_Sub40(local23, 3), null, true);
	}

	@OriginalMember(owner = "client!acb", name = "all", descriptor = "(Lclient!yf;I)V", line = 11851)
	static final void method14945(@OriginalArg(0) Class681 arg0) {
		if (Class4.aBoolean2) {
			@Pc(4) Class14[] local4 = Class124_Sub3.method21453();
	...
	static String method14943(@OriginalArg(0) long arg0) {
		return Class285.method26512(new Date(arg0), "EEE dd-MMM-yyyy HH:mm:ss zzz");
	}
}
