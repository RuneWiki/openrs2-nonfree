...
public class Class170 {
	...
	static final void method21484(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
	...
	static final void method21482(@OriginalArg(0) Class681 arg0) {
	...
	static final void method21485(@OriginalArg(0) Class681 arg0) throws Exception_Sub3 {
		...
		Class65.aClass123_Sub1_2.method8933(local51);
		Class65.aClass123_Sub1_2.method8955((float) local43 / 1000.0F);
		local51.method29532();
	}

	@OriginalMember(owner = "client!ar", name = "awh", descriptor = "(Lclient!yf;B)V", line = 13678)
	static final void method21483(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(26) String local26 = (String) arg0.anObjectArray45[(arg0.anInt5888 -= 957530791) * 587908375];
		@Pc(32) int local32 = Class250.method25956(Class280.aClass693_1, Class703.aClass703_3, local12);
		@Pc(38) int local38 = Class654.method32719(Class280.aClass693_1, Class703.aClass703_3, local12);
		if (client.anInt3435 * -849002901 == 13 && !Class251.method25973()) {
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class624.method32158(local12, local26, local32, local38) ? 1 : 0;
		} else {
	...
	static final void method21486(@OriginalArg(0) Class681 arg0) {
