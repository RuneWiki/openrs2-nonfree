...
public class Class170 {
	...
	static final void method21482(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1949471565);
	...
	static final void method21483(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(26) String local26 = (String) arg0.anObjectArray45[(arg0.anInt5888 -= 957530791) * 587908375];
		@Pc(32) int local32 = Class250.method25956(Class280.aClass693_1, Class703.aClass703_3, local12, 893842351);
		@Pc(38) int local38 = Class654.method32719(Class280.aClass693_1, Class703.aClass703_3, local12, 153396189);
		if (client.anInt3435 * -849002901 == 13 && !Class251.method25973(-473748555)) {
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class624.method32158(local12, local26, local32, local38, -1351470887) ? 1 : 0;
		} else {
	...
	static final void method21484(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) byte arg3) {
		...
		Class499.method30148(local13, arg2, -565857644);
	}

	@OriginalMember(owner = "client!ar", name = "aor", descriptor = "(Lclient!yf;I)V", line = 12481)
	static final void method21485(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) throws Exception_Sub3 {
		...
		@Pc(51) Class472 local51 = Class472.method29529((float) local13, (float) local23, (float) local33);
