...
public abstract class Class25_Sub4 extends Class25 {
	...
	public void method23123(@OriginalArg(0) Class368 arg0, @OriginalArg(1) Class470 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float arg4, @OriginalArg(5) byte arg5) {
		...
		local4[0] -= (double) arg2;
		local4[2] -= (double) arg3;
		@Pc(24) double[] local24 = this.method23143(1311462755);
		local24[0] -= (double) arg2;
		local24[2] -= (double) arg3;
		local4[1] *= -1.0D;
		local24[1] *= -1.0D;
	...
	abstract float method23141(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) int arg3);

	@OriginalMember(owner = "client!ano", name = "h", descriptor = "(I)V")
	abstract void method23142(@OriginalArg(0) int arg0);
	...
	public void method23118(@OriginalArg(0) float arg0, @OriginalArg(1) byte arg1) {
		...
		while (arg0 > 0.0F) {
			...
			while (arg0 > 0.0F && this.aFloat229 < local70) {
				this.aFloat228 = this.method23141(local70, this.aFloat228, Math.min(arg0, local63), -110588198);
				arg0 -= local63;
	...
	public Class472 method23122(@OriginalArg(0) int arg0) {
		return this.method23120(-1555544944);
	}
	...
	abstract void method23145(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2);
	...
	public void method23119(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(22) int local22 = 0; local22 < local12; local22++) {
			...
			this.aFloatArray75[local22] = arg0.method22425(-272556746);
		}
		this.method23145(arg0, local12, (byte) -41);
	}
	...
	public void method23128(@OriginalArg(0) float arg0) {
		...
		while (arg0 > 0.0F) {
			...
			while (arg0 > 0.0F && this.aFloat229 < local70) {
				this.aFloat228 = this.method23141(local70, this.aFloat228, Math.min(arg0, local63), -789688681);
				arg0 -= local63;
	...
	public void method23124(@OriginalArg(0) float arg0) {
		...
		while (arg0 > 0.0F) {
			...
			while (arg0 > 0.0F && this.aFloat229 < local70) {
				this.aFloat228 = this.method23141(local70, this.aFloat228, Math.min(arg0, local63), -1000844591);
				arg0 -= local63;
	...
	public void method23121(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		for (@Pc(22) int local22 = 0; local22 < local12; local22++) {
			this.aClass479Array8[local22] = new Class479(arg0);
			this.aFloatArray75[local22] = arg0.method22425(-579811592);
		}
		this.method23145(arg0, local12, (byte) -66);
	}
	...
	public void method23129(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		for (@Pc(22) int local22 = 0; local22 < local12; local22++) {
			this.aClass479Array8[local22] = new Class479(arg0);
			this.aFloatArray75[local22] = arg0.method22425(1360730707);
		}
		this.method23145(arg0, local12, (byte) -13);
	}
	...
	public void method23130(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		for (@Pc(22) int local22 = 0; local22 < local12; local22++) {
			this.aClass479Array8[local22] = new Class479(arg0);
			this.aFloatArray75[local22] = arg0.method22425(-1965586151);
		}
		this.method23145(arg0, local12, (byte) -91);
	}
	...
	public void method23131(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		for (@Pc(22) int local22 = 0; local22 < local12; local22++) {
			this.aClass479Array8[local22] = new Class479(arg0);
			this.aFloatArray75[local22] = arg0.method22425(850641713);
		}
		this.method23145(arg0, local12, (byte) 45);
	}

	@OriginalMember(owner = "client!ano", name = "s", descriptor = "()Lclient!ox;", line = 114)
	@Override
	public Class472 method23117() {
		return this.method23120(1202176632);
	}
	...
	public Class472 method23133() {
		return this.method23120(-262267390);
	}
