...
public class Class110_Sub1 extends Class110 {
	...
	public void method20138(@OriginalArg(0) int arg0) {
		Class501.method30172(true, 754600721);
	}
	...
	public void method20140() {
		Class501.method30172(true, -743587555);
	}

	@OriginalMember(owner = "client!afj", name = "gv", descriptor = "(I)V", line = 3828)
	static final void method6370(@OriginalArg(0) int arg0) {
		for (@Pc(1) int local1 = 0; local1 < client.anInt3540 * 568731113; local1++) {
			...
			if (local16 != null) {
				...
				Class233.method25732(local23, false, (byte) -30);
			}
		}
	}
	...
	public static void method6371(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(3) Interface39 arg3, @OriginalArg(4) int arg4) {
		if (Class670.aClass146_6 != null) {
			Class670.aClass146_6.method11689(1827484005).method28657(arg0, arg1, arg2, arg3, 692940800);
		}
	}
