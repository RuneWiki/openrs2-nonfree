...
public class Class301 implements Interface75 {
	...
	public static void method26732(@OriginalArg(0) Class108 arg0) {
	...
	public static final void method26730() {
		...
		if (Class20.method376() == 3) {
			@Pc(28) Class611 local28 = client.aClass532_1.method30443();
			@Pc(35) int local35 = local28.anInt5623 * 270611681 << 9;
			@Pc(42) int local42 = local28.anInt5624 * -1994307635 << 9;
			@Pc(47) int local47 = 1000 / Class451.method28948();
			Class65.aClass123_Sub1_2.method8924((float) local47 / 1000.0F, client.aClass532_1.method30460().anIntArrayArrayArray14, client.aClass532_1.method30509(), local35, local42);
		}
	...
	static final void method26733(@OriginalArg(0) Class681 arg0) {
	...
	static final void method26729(@OriginalArg(0) Class681 arg0) {
	...
	static final void method26731(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class132_Sub1_Sub1_Sub1_Sub1 local16 = (Class132_Sub1_Sub1_Sub1_Sub1) arg0.aClass132_Sub1_Sub1_Sub1_4;
		@Pc(21) int local21 = local16.method18596(local12);
		@Pc(26) int local26 = local16.method18597(local12);
