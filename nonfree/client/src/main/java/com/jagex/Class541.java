...
public class Class541 implements Runnable {
	...
	public void method30902(@OriginalArg(0) Class32_Sub14 arg0, @OriginalArg(1) int arg1) {
		this.aClass532_2.method30449(arg0, 2087680265);
	}
	...
	void method30907(@OriginalArg(0) Class537 arg0) {
		if (arg0.aClass526_11 == Class526.aClass526_7) {
			this.aClass532_2.method30469((byte) 0);
		} else {
			this.aClass532_2.method30465(arg0, 439366062);
		}
		for (@Pc(18) boolean local18 = this.aClass532_2.method30439((byte) 57); !local18; local18 = this.aClass532_2.method30439((byte) 119)) {
		}
		this.aClass532_2.method30445(1213218812);
		client.aClass532_1.method30445(1213218812);
	}

	@OriginalMember(owner = "client!ry", name = "n", descriptor = "(Lclient!rt;B)V", line = 17)
	public void method30908(@OriginalArg(0) Class537 arg0, @OriginalArg(1) byte arg1) {
		@Pc(3) LinkedList local3 = this.aLinkedList3;
		synchronized (this.aLinkedList3) {
			this.aLinkedList3.add(arg0);
			this.aLinkedList3.notify();
	...
	void method30916(@OriginalArg(0) int arg0) {
		...
		try {
			if (local1 != null) {
				...
				this.method30917(local1, -246378460);
			}
	...
	void method30917(@OriginalArg(0) Class537 arg0, @OriginalArg(1) int arg1) {
		if (arg0.aClass526_11 == Class526.aClass526_7) {
			this.aClass532_2.method30469((byte) 0);
		} else {
			this.aClass532_2.method30465(arg0, -1635529773);
		}
		for (@Pc(18) boolean local18 = this.aClass532_2.method30439((byte) 58); !local18; local18 = this.aClass532_2.method30439((byte) 71)) {
		}
		this.aClass532_2.method30445(1213218812);
		client.aClass532_1.method30445(1213218812);
	}
	...
	void method30926(@OriginalArg(0) Class537 arg0) {
		if (arg0.aClass526_11 == Class526.aClass526_7) {
			...
			this.aClass532_2.method30465(arg0, 938984196);
		}
		for (@Pc(18) boolean local18 = this.aClass532_2.method30439((byte) 86); !local18; local18 = this.aClass532_2.method30439((byte) 86)) {
		}
		this.aClass532_2.method30445(1213218812);
		client.aClass532_1.method30445(1213218812);
	}
	...
	void method30927(@OriginalArg(0) Class537 arg0) {
		if (arg0.aClass526_11 == Class526.aClass526_7) {
			...
			this.aClass532_2.method30465(arg0, 1001637900);
		}
		for (@Pc(18) boolean local18 = this.aClass532_2.method30439((byte) 27); !local18; local18 = this.aClass532_2.method30439((byte) 106)) {
		}
		this.aClass532_2.method30445(1213218812);
		client.aClass532_1.method30445(1213218812);
	}
	...
	static final void method30929(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		Class583.method31424(local11, local14, arg0, 1860815549);
	}
