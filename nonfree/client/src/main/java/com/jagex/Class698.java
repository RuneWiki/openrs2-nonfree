...
public class Class698 implements Runnable {
	...
	public void method36681(@OriginalArg(0) int arg0) {
		if (this.aThread12 == null) {
			return;
		}
		this.method36684(this.anObject27, 1189646962);
		try {
			this.aThread12.join();
	...
	void method36682(@OriginalArg(0) Object arg0) {
	...
	void method36684(@OriginalArg(0) Object arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Queue local3 = this.aQueue4;
		synchronized (this.aQueue4) {
			this.aQueue4.add(arg0);
			this.aQueue4.notify();
	...
	public Class678 method36686(@OriginalArg(0) String arg0) {
		if (this.aThread12 == null) {
			...
			this.method36684(local19, 1236131769);
			return local19;
		}
	}
	...
	public Class678 method36689(@OriginalArg(0) String arg0) {
		if (this.aThread12 == null) {
			throw new IllegalStateException("");
		} else if (arg0 == null) {
			throw new IllegalArgumentException("");
			...
			@Pc(19) Class678 local19 = new Class678(arg0);
			this.method36684(local19, 1959341179);
			return local19;
		}
	}

	@OriginalMember(owner = "client!yz", name = "q", descriptor = "(Ljava/lang/Object;)V", line = 37)
	void method36690(@OriginalArg(0) Object arg0) {
		@Pc(3) Queue local3 = this.aQueue4;
		synchronized (this.aQueue4) {
			this.aQueue4.add(arg0);
			this.aQueue4.notify();
	...
	public void method36691() {
		if (this.aThread12 == null) {
			return;
		}
		this.method36684(this.anObject27, 1911229661);
		try {
			this.aThread12.join();
		} catch (@Pc(14) InterruptedException local14) {
		}
	...
	public void method36692() {
		if (this.aThread12 == null) {
			return;
		}
		this.method36684(this.anObject27, 1223502905);
		try {
			this.aThread12.join();
		} catch (@Pc(14) InterruptedException local14) {
		}
	...
	public void method36693() {
		if (this.aThread12 == null) {
			return;
		}
		this.method36684(this.anObject27, 1690927532);
		try {
			this.aThread12.join();
		} catch (@Pc(14) InterruptedException local14) {
		}
	...
	void method36695(@OriginalArg(0) Object arg0) {
		@Pc(3) Queue local3 = this.aQueue4;
		synchronized (this.aQueue4) {
			this.aQueue4.add(arg0);
			this.aQueue4.notify();
	...
	public Class678 method36696(@OriginalArg(0) String arg0) {
		if (this.aThread12 == null) {
			throw new IllegalStateException("");
		} else if (arg0 == null) {
			throw new IllegalArgumentException("");
			...
			@Pc(19) Class678 local19 = new Class678(arg0);
			this.method36684(local19, 1926002660);
			return local19;
		}
	}

	@OriginalMember(owner = "client!yz", name = "y", descriptor = "(Ljava/lang/Object;)V", line = 37)
	void method36697(@OriginalArg(0) Object arg0) {
		@Pc(3) Queue local3 = this.aQueue4;
		synchronized (this.aQueue4) {
			this.aQueue4.add(arg0);
			this.aQueue4.notify();
	...
	public Class678 method36698(@OriginalArg(0) String arg0, @OriginalArg(1) byte arg1) {
		if (this.aThread12 == null) {
			throw new IllegalStateException("");
		} else if (arg0 == null) {
			throw new IllegalArgumentException("");
			...
			@Pc(19) Class678 local19 = new Class678(arg0);
			this.method36684(local19, 1842308744);
			return local19;
		}
	}

	@OriginalMember(owner = "client!yz", name = "bej", descriptor = "(Lclient!yf;I)V", line = 14853)
	static final void method36699(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5891 -= -725861497;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		@Pc(33) int local33 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 2];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = client.aClass270_1.method26278(local13, -1956499376).method26387(local23, local33, (byte) -73) == null ? 0 : 1;
	}

	@OriginalMember(owner = "client!yz", name = "bfk", descriptor = "(Lclient!yf;I)V", line = 15107)
	static final void method36700(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5891 -= 1189701933;
	}

	@OriginalMember(owner = "client!yz", name = "je", descriptor = "(Lclient!hf;IIB)V", line = 10131)
	public static void method36701(@OriginalArg(0) Class312 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		if (arg0 == null) {
			return;
		}
	...
	static void method36702(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		@Pc(3) int local3 = arg0.method22632((byte) -82);
		...
		for (local8 = 0; local8 < local3; local8++) {
			...
			Class632.aClass648Array1[local8].anInt5794 = arg0.method22632((byte) -22) * -58277581;
			Class632.aClass648Array1[local8].aString237 = arg0.method22428(98739723);
		}
		Class607.anInt5560 = arg0.method22632((byte) -37) * -174531729;
		Class361.anInt4571 = arg0.method22632((byte) -127) * -1231507063;
		Class606.anInt5557 = arg0.method22632((byte) -121) * 470817221;
		...
		for (local8 = 0; local8 < Class606.anInt5557 * 2035023117; local8++) {
			@Pc(75) int local75 = arg0.method22632((byte) -71);
			...
			local83.anInt1653 = arg0.method22632((byte) -35) * -875570153;
			if (local83.anInt1653 * -2080957529 != 0) {
				local83.aString48 = arg0.method22428(-218643179);
			}
			local83.anInt1654 = (Class607.anInt5560 * 1855382415 + local75) * 142830605;
			local83.aString47 = arg0.method22428(-39955437);
			local83.aString46 = arg0.method22428(885791896);
		}
		Class632.anInt5720 = arg0.method22419(-118643075) * -537572227;
