...
public class Class698 implements Runnable {
	...
	public Class678 method36698(@OriginalArg(0) String arg0) {
		if (this.aThread12 == null) {
			throw new IllegalStateException("");
		} else if (arg0 == null) {
			throw new IllegalArgumentException("");
	...
	public void method36681() {
		if (this.aThread12 == null) {
			return;
		}
		this.method36684(this.anObject27);
		try {
			this.aThread12.join();
	...
	void method36684(@OriginalArg(0) Object arg0) {
		@Pc(3) Queue local3 = this.aQueue4;
		synchronized (this.aQueue4) {
			this.aQueue4.add(arg0);
			this.aQueue4.notify();
	...
	static void method36702(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		for (local8 = 0; local8 < local3; local8++) {
			...
			Class632.aClass648Array1[local8].anInt5794 = arg0.method22632() * -58277581;
			Class632.aClass648Array1[local8].aString237 = arg0.method22428();
		}
		...
		Class632.anInt5720 = arg0.method22419() * -537572227;
	...
	public static void method36701(@OriginalArg(0) Class312 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg0 == null) {
			return;
		}
	...
	static final void method36699(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= -725861497;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		@Pc(33) int local33 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 2];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = client.aClass270_1.method26278(local13).method26387(local23, local33) == null ? 0 : 1;
	}

	@OriginalMember(owner = "client!yz", name = "bfk", descriptor = "(Lclient!yf;I)V", line = 15107)
	static final void method36700(@OriginalArg(0) Class681 arg0) {
