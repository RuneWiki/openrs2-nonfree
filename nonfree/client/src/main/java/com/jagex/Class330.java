...
public class Class330 {
	...
	public static Class109 method27351(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Class109 arg5, @OriginalArg(6) short arg6, @OriginalArg(7) byte arg7, @OriginalArg(8) Class19 arg8) {
		if (arg5 == null) {
			return null;
		}
		@Pc(5) int local5 = 2055;
		if (arg8 != null) {
			local5 |= arg8.method23564(-1784991960);
			local5 &= 0xFFFFFDFF;
		}
		...
		if (local35 == null || arg0.method20693(local35.method6825(), local5) != 0) {
			...
			local66.method25690(0, 1, 2, (byte) 1, (byte) 0, (short) 0, arg7, arg6);
			local66.method25690(0, 2, 3, (byte) 1, (byte) 0, (short) 0, arg7, arg6);
		...
		if (arg8 == null) {
			...
			arg8.method23567(local35, (byte) 32);
		}
		if (arg2 != 0) {
	...
	public static Class109 method27353(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class109 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) Class19 arg11) {
		...
		if (arg11 == null) {
			...
			arg11.method23567(local48, (byte) 39);
		}
		if (arg2 != 0) {
	...
	public static Class109 method27354(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Class109 arg5, @OriginalArg(6) short arg6, @OriginalArg(7) byte arg7, @OriginalArg(8) Class19 arg8) {
		...
		@Pc(5) int local5 = 2055;
		if (arg8 != null) {
			local5 |= arg8.method23564(-1827282471);
			local5 &= 0xFFFFFDFF;
		}
		@Pc(26) long local26 = (long) ((arg6 & 0xFFFF) << 8 | arg7);
		@Pc(29) Class240 local29 = aClass240_79;
		...
		if (arg8 == null) {
			...
			local35.method6833(local173 - local170 >> 1, 128, local179 - local176 >> 1);
			local35.method6939(local173 + local170 >> 1, 0, local176 + local179 >> 1);
			arg8.method23567(local35, (byte) 51);
		}
		if (arg2 != 0) {
			local35.method6986(arg2);
		}
	...
	public static Class109 method27355(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Class109 arg5, @OriginalArg(6) short arg6, @OriginalArg(7) byte arg7, @OriginalArg(8) Class19 arg8) {
		...
		@Pc(5) int local5 = 2055;
		if (arg8 != null) {
			local5 |= arg8.method23564(-1789729562);
			local5 &= 0xFFFFFDFF;
		}
		@Pc(26) long local26 = (long) ((arg6 & 0xFFFF) << 8 | arg7);
		@Pc(29) Class240 local29 = aClass240_79;
		...
		if (arg8 == null) {
			...
			local35.method6833(local173 - local170 >> 1, 128, local179 - local176 >> 1);
			local35.method6939(local173 + local170 >> 1, 0, local176 + local179 >> 1);
			arg8.method23567(local35, (byte) 52);
		}
		if (arg2 != 0) {
			local35.method6986(arg2);
		}
	...
	public static void method27356() {
		@Pc(2) Class240 local2 = aClass240_79;
		synchronized (aClass240_79) {
			aClass240_79.method25833((byte) -102);
		}
	}
	...
	public static Class109 method27357(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Class109 arg5, @OriginalArg(6) short arg6, @OriginalArg(7) byte arg7, @OriginalArg(8) Class19 arg8) {
		...
		@Pc(5) int local5 = 2055;
		if (arg8 != null) {
			local5 |= arg8.method23564(-2037708508);
			local5 &= 0xFFFFFDFF;
		}
		@Pc(26) long local26 = (long) ((arg6 & 0xFFFF) << 8 | arg7);
		@Pc(29) Class240 local29 = aClass240_79;
		...
		if (arg8 == null) {
			...
			local35.method6833(local173 - local170 >> 1, 128, local179 - local176 >> 1);
			local35.method6939(local173 + local170 >> 1, 0, local176 + local179 >> 1);
			arg8.method23567(local35, (byte) 87);
		}
		if (arg2 != 0) {
			local35.method6986(arg2);
		}
	...
	public static Class109 method27358(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Class109 arg5, @OriginalArg(6) short arg6, @OriginalArg(7) byte arg7, @OriginalArg(8) Class19 arg8) {
		...
		@Pc(5) int local5 = 2055;
		if (arg8 != null) {
			local5 |= arg8.method23564(-2025875207);
			local5 &= 0xFFFFFDFF;
		}
		@Pc(26) long local26 = (long) ((arg6 & 0xFFFF) << 8 | arg7);
		@Pc(29) Class240 local29 = aClass240_79;
		...
		if (arg8 == null) {
			...
			local35.method6833(local173 - local170 >> 1, 128, local179 - local176 >> 1);
			local35.method6939(local173 + local170 >> 1, 0, local176 + local179 >> 1);
			arg8.method23567(local35, (byte) 21);
		}
		if (arg2 != 0) {
			local35.method6986(arg2);
		}
	...
	static void method27359() {
		@Pc(2) Class240 local2 = aClass240_79;
		synchronized (aClass240_79) {
			aClass240_79.method25837(1161602830);
		}
	}
	...
	static void method27360(@OriginalArg(0) int arg0) {
		...
		synchronized (aClass240_79) {
			aClass240_79.method25833((byte) -70);
		}
	}

	@OriginalMember(owner = "client!i", name = "p", descriptor = "(Lclient!dh;IIIILclient!do;SBLclient!aaq;)Lclient!do;", line = 89)
	public static Class109 method27361(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Class109 arg5, @OriginalArg(6) short arg6, @OriginalArg(7) byte arg7, @OriginalArg(8) Class19 arg8) {
		if (arg5 == null) {
			return null;
		}
		@Pc(5) int local5 = 2055;
		if (arg8 != null) {
			local5 |= arg8.method23564(-2075444081);
			local5 &= 0xFFFFFDFF;
		}
		@Pc(26) long local26 = (long) ((arg6 & 0xFFFF) << 8 | arg7);
		@Pc(29) Class240 local29 = aClass240_79;
		...
		if (arg8 == null) {
			...
			local35.method6833(local173 - local170 >> 1, 128, local179 - local176 >> 1);
			local35.method6939(local173 + local170 >> 1, 0, local176 + local179 >> 1);
			arg8.method23567(local35, (byte) 105);
		}
		if (arg2 != 0) {
			local35.method6986(arg2);
		}
	...
	static void method27364(@OriginalArg(0) int arg0) {
		@Pc(2) Class240 local2 = aClass240_79;
		synchronized (aClass240_79) {
			aClass240_79.method25832(arg0, (byte) -66);
		}
	}
	...
	static void method27365(@OriginalArg(0) int arg0) {
		@Pc(2) Class240 local2 = aClass240_79;
		synchronized (aClass240_79) {
			aClass240_79.method25832(arg0, (byte) -54);
		}
	}
	...
	static void method27366(@OriginalArg(0) int arg0) {
		...
		@Pc(6) Class240 local6 = aClass240_79;
		synchronized (aClass240_79) {
			aClass240_79.method25833((byte) -99);
		}
	}
	...
	static void method27371(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2, @OriginalArg(3) byte arg3) {
		...
		local7.aClass93_Sub41_Sub2_1.method22454(Class582.method31414(arg1, 275898717) + 1 + Class582.method31414(arg2, -580076764), 2145636263);
		local7.aClass93_Sub41_Sub2_1.method22403(arg1, 1516871641);
		local7.aClass93_Sub41_Sub2_1.method22447(arg0, -1311286727);
		local7.aClass93_Sub41_Sub2_1.method22403(arg2, 1516871641);
		client.aClass175_2.method24351(local7, -2111524569);
	}

	@OriginalMember(owner = "client!i", name = "ef", descriptor = "(I)Lclient!ax;", line = 2010)
	public static Class175 method27372(@OriginalArg(0) int arg0) {
		return Class56.method18034(client.anInt3435 * -849002901, -1497248091) || client.anInt3435 * -849002901 == 0 ? client.aClass175_1 : client.aClass175_2;
	}

	@OriginalMember(owner = "client!i", name = "tn", descriptor = "(Lclient!yf;I)V", line = 8419)
	static final void method27373(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		Class202.method24645(local11, arg0, 863770656);
	}
}
