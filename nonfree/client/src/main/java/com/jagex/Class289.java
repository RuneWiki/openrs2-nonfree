...
public class Class289 {
	...
	void method26551(@OriginalArg(0) Class315 arg0) {
		...
		this.anInt3909 = this.aClass315_1.method27136(16);
		this.anInt3907 = this.aClass315_1.method27136(24);
		this.anInt3906 = this.aClass315_1.method27136(24);
		this.anInt3905 = this.aClass315_1.method27136(24) + 1;
		this.anInt3908 = this.aClass315_1.method27136(6) + 1;
		this.anInt3904 = this.aClass315_1.method27136(8);
		...
		for (local58 = 0; local58 < this.anInt3908; local58++) {
			@Pc(64) int local64 = 0;
			@Pc(69) int local69 = this.aClass315_1.method27136(3);
			@Pc(77) boolean local77 = this.aClass315_1.method27130() != 0;
			if (local77) {
				local64 = this.aClass315_1.method27136(5);
			}
		...
		for (local58 = 0; local58 < this.anInt3908 * 8; local58++) {
			this.anIntArray371[local58] = (this.anIntArray372[local58 >> 3] & 0x1 << (local58 & 0x7)) == 0 ? -1 : this.aClass315_1.method27136(8);
		}
	}

	@OriginalMember(owner = "client!gi", name = "k", descriptor = "(Lclient!hk;)V", line = 23)
	void method26554(@OriginalArg(0) Class315 arg0) {
		this.aClass315_1 = arg0;
		this.anInt3909 = this.aClass315_1.method27136(16);
		this.anInt3907 = this.aClass315_1.method27136(24);
		this.anInt3906 = this.aClass315_1.method27136(24);
	...
	void method26552(@OriginalArg(0) int[] arg0) {
		if (arg0 != null) {
	...
	void method26555(@OriginalArg(0) int[] arg0) {
		if (arg0 != null) {
			for (@Pc(4) int local4 = 0; local4 < arg0.length; local4++) {
				arg0[local4] = 0;
			}
	...
	Class308[] method26553(@OriginalArg(0) Class308[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean[] arg2) {
		...
		if (this.anIntArrayArray48 != null && this.anIntArrayArray48.length == local2 && this.anIntArrayArray48[0].length == local46) {
			for (local69 = 0; local69 < local2; local69++) {
				this.method26552(this.anIntArrayArray48[local69]);
			}
		} else {
			...
			while (local87 < local46) {
				...
				if (local69 == 0) {
					for (local94 = 0; local94 < local2; local94++) {
						if (!arg2[local94]) {
							local111 = this.aClass315_1.aClass324Array2[this.anInt3904].method27284(this.aClass315_1);
							...
							if (local173 >= 0) {
								...
								if (this.anInt3909 == 0) {
									...
									for (@Pc(200) int local200 = 0; local200 < local198; local200++) {
										@Pc(208) float[] local208 = local189.method27285(this.aClass315_1);
									...
									while (local198 < this.anInt3905) {
										@Pc(256) float[] local256 = local189.method27285(this.aClass315_1);
