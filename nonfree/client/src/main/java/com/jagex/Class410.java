...
public class Class410 {
	...
	Class410(@OriginalArg(0) Class104_Sub2 arg0, @OriginalArg(1) Class397 arg1, @OriginalArg(2) Class99_Sub3 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		if (local25 > 0) {
			...
			this.anInterface40_8 = this.aClass104_Sub2_39.method20995(false);
	...
	void method28590(@OriginalArg(0) Class131 arg0) {
		this.method28591(arg0, this.anInterface40_8, 0, this.anInt4710);
	}
	...
	void method28594(@OriginalArg(0) Class131 arg0) {
		this.method28591(arg0, this.anInterface40_8, 0, this.anInt4710);
	}

	@OriginalMember(owner = "client!ly", name = "n", descriptor = "(Lclient!jj;Lclient!ml;II)V", line = 76)
	void method28591(@OriginalArg(0) Class131 arg0, @OriginalArg(1) Interface40 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg3 <= 0) {
			return;
		}
		this.method28593();
		this.aClass104_Sub2_39.method21030(arg1);
	...
	void method28595(@OriginalArg(0) Class131 arg0, @OriginalArg(1) Interface40 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg3 <= 0) {
			return;
		}
		this.method28593();
	...
	void method28593() {
		...
		@Pc(102) int local102;
		@Pc(116) int local116;
		if (!this.aClass104_Sub2_39.method20954(Class206.aClass206_19, Class226.aClass226_22)) {
			...
			if (this.anInterface38_25 == null) {
				this.anInterface38_25 = this.aClass104_Sub2_39.method21133(128, 128, false, this.anIntArray440);
		...
		if (this.anInterface38_25 == null) {
			this.anInterface38_25 = this.aClass104_Sub2_39.method20956(Class206.aClass206_19, 128, 128, false, this.aByteArray91);
			this.anInterface38_25.method11344(false, false);
		} else {
