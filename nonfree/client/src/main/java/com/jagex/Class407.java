...
public class Class407 implements Interface32 {
	...
	public static boolean method28580(@OriginalArg(0) int arg0) {
	...
	static final void method28581(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	public static Class420 method28582(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return Class670.aClass146_6 == null ? null : Class670.aClass146_6.method11689(-1946415060).method28660(arg0, (byte) 103);
	}

	@OriginalMember(owner = "client!lv", name = "n", descriptor = "(II)Lclient!asc;", line = 22)
	static Class93_Sub1_Sub13 method28583(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		Class695.aClass253_1.method25985(local5, (long) arg0);
		return local5;
	}

	@OriginalMember(owner = "client!lv", name = "x", descriptor = "(I)V", line = 713)
	public static void method28584(@OriginalArg(0) int arg0) {
		Class312.aClass240_74.method25833((byte) -10);
		Class312.aClass240_77.method25833((byte) -33);
		Class312.aClass240_75.method25833((byte) -107);
		Class312.aClass240_76.method25833((byte) -62);
	}
}
