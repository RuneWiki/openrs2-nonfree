...
public class Class686 implements Interface20 {
	...
	public int method33459(@OriginalArg(0) Class108 arg0) {
		@Pc(15) Integer local15 = this.aClass386_4.method28227(client.aClass702_4.anInt5953 * -1111983921 << 16 | arg0.anInt867 * -1284841473, 1899238502);
	...
	public int method33462(@OriginalArg(0) Class379 arg0) {
		return arg0.method28080(this.method33455(arg0.aClass108_1, -1488307348), 2063640239);
	}
	...
	public long method33465(@OriginalArg(0) Class108 arg0, @OriginalArg(1) int arg1) {
		@Pc(15) Long local15 = this.aClass386_4.method28168(client.aClass702_4.anInt5953 * -1111983921 << 16 | arg0.anInt867 * -1284841473, -771674756);
	...
	public Object method33467(@OriginalArg(0) Class108 arg0, @OriginalArg(1) byte arg1) {
		...
		return this.aClass386_4.method28169(client.aClass702_4.anInt5953 * -1111983921 << 16 | arg0.anInt867 * -1284841473, -1270432674);
	}
	...
	public Object method33481(@OriginalArg(0) Class108 arg0) {
		...
		return this.aClass386_4.method28169(client.aClass702_4.anInt5953 * -1111983921 << 16 | arg0.anInt867 * -1284841473, -1019955817);
	}
	...
	public int method33454(@OriginalArg(0) Class379 arg0, @OriginalArg(1) int arg1) {
		return arg0.method28080(this.method33455(arg0.aClass108_1, 65798137), 1112565512);
	}
	...
	public int method33461(@OriginalArg(0) Class379 arg0) {
		return arg0.method28080(this.method33455(arg0.aClass108_1, 117559001), 436890401);
	}
	...
	public int method33460(@OriginalArg(0) Class379 arg0) {
		return arg0.method28080(this.method33455(arg0.aClass108_1, -480987308), 641150009);
	}
	...
	public Object method33471(@OriginalArg(0) Class108 arg0) {
		...
		return this.aClass386_4.method28169(client.aClass702_4.anInt5953 * -1111983921 << 16 | arg0.anInt867 * -1284841473, -570202534);
	}
	...
	public Object method33482(@OriginalArg(0) Class108 arg0) {
		...
		return this.aClass386_4.method28169(client.aClass702_4.anInt5953 * -1111983921 << 16 | arg0.anInt867 * -1284841473, -668984648);
	}
	...
	public Object method33480(@OriginalArg(0) Class108 arg0) {
		...
		return this.aClass386_4.method28169(client.aClass702_4.anInt5953 * -1111983921 << 16 | arg0.anInt867 * -1284841473, -866978723);
	}
	...
	static final void method33484(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		if (arg0.anInt4023 * -1088634495 != local12) {
			if (local12 == -1) {
				...
				arg0.aClass19_6.method23568(local12, 1626977132);
			}
			arg0.anInt4023 = local12 * 600145537;
			Class354.method27696(arg0, -1174743804);
		}
		if (arg0.anInt3970 * 532402067 == -1 && !arg1.aBoolean708) {
			Class682.method33278(arg0.anInt3953 * -1549590237, (byte) 119);
		}
	}

	@OriginalMember(owner = "client!yl", name = "ath", descriptor = "(Lclient!yf;I)V", line = 13277)
	static final void method33485(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5891 -= 1189701933;
	}

	@OriginalMember(owner = "client!yl", name = "k", descriptor = "(Lclient!alw;IB)V", line = 125)
	public static void method33486(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		...
		for (@Pc(61) int local61 = 0; local61 < local3.anInt1959 * -1741642847; local61++) {
			try {
				...
				if (local71 == 0 || local71 == 1 || local71 == 2) {
					local84 = arg0.method22427(-95152599);
					local88 = arg0.method22427(151347099);
					local90 = 0;
					if (local71 == 1) {
					...
					local84 = arg0.method22427(1923778267);
					local88 = arg0.method22427(1959147366);
					...
					for (@Pc(149) int local149 = 0; local149 < local90; local149++) {
						local147[local149] = arg0.method22427(1304990363);
					}
					@Pc(164) String local164 = arg0.method22427(-79688576);
					...
					if (local71 == 3) {
						for (@Pc(172) int local172 = 0; local172 < local90; local172++) {
							...
							arg0.method22430(local167[local172], 0, local179, (short) 27757);
						}
					}
					local3.anIntArray194[local61] = local71;
	...
	static final void method33487(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1296865465);
