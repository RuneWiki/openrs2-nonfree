...
public class Class328 implements Interface75 {
	...
	static final void method27324(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		if (Class625.anInt5696 * 908241389 == 1) {
			...
			for (local29 = 0; local29 < Class625.aStringArray33.length; local29++) {
				if (Class625.aStringArray33[local29] == null) {
					...
					try {
						local27 += Class125_Sub1.aClass586_1.method31626(Class625.aStringArray33[local29], false, 1460409597);
					} catch (@Pc(49) Exception_Sub5 local49) {
						Class166_Sub6.method15481(Class72.aClass72_1, local49.aString65, local49.anInt2491 * 1562390493, local49.getCause(), 1053905725);
			...
			Class625.anInt5696 = Class535.method30754(-709694321) * 756685797;
