...
public class Class295 implements Interface25 {
	...
	public void method26713(@OriginalArg(0) Class297 arg0) {
		arg0.method26681(this.aClass282_1, (short) 255);
	}
	...
	static final void method26601(@OriginalArg(0) Class681 arg0, @OriginalArg(1) Class132_Sub1_Sub1_Sub1 arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(145) Class611 local145 = client.aClass532_1.method30443(1719093004);
		@Pc(152) int local152 = local145.anInt5623 * 270611681 << 9;
		@Pc(159) int local159 = local145.anInt5624 * -1994307635 << 9;
		if (arg1 != null) {
			local92.method9158(arg1, new Class472((float) local13, (float) local23, (float) local33), local96, local68, local78, client.aClass532_1.method30460(-310507201).anIntArrayArrayArray14, client.aClass532_1.method30509(-875952590), local152, local159, 2039271547);
		}
		client.aBoolean619 = true;
	}

	@OriginalMember(owner = "client!go", name = "p", descriptor = "(Ljava/lang/CharSequence;B)I", line = 140)
	public static int method26602(@OriginalArg(0) CharSequence arg0, @OriginalArg(1) byte arg1) {
