...
public class Class110_Sub15_Sub1 extends Class110_Sub15 {
	...
	Class110_Sub15_Sub1(@OriginalArg(0) Class93_Sub41 arg0) {
		super(arg0);
		this.anInt2817 = arg0.method22415() * -411027197;
		this.anInt2818 = arg0.method22413() * -1021406375;
		this.anInt2819 = arg0.method22415() * -1724177145;
	}

	@OriginalMember(owner = "client!aqm", name = "n", descriptor = "(I)V", line = 18)
	@Override
	public void method20138() {
		Class249.aClass239Array1[this.anInt2817 * -2036139605].method25807().method20010(this.anInt2821 * 1307909245, this.anInt2823 * -1630065793 << 16, this.anInt2822 * 187367639, this.anInt2819 * 61421751, false, this.anInt2818 * 578979049);
	}
