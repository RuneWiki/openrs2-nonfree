...
public abstract class Class109 {
	...
	void method6835(@OriginalArg(0) Class99 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		@Pc(25) int local25 = arg0.method2481(arg1 + local10, arg3 + local15);
		@Pc(29) int local29 = arg4 / 2;
		@Pc(34) int local34 = -arg5 / 2;
		@Pc(44) int local44 = arg0.method2481(arg1 + local29, arg3 + local34);
		@Pc(49) int local49 = -arg4 / 2;
		@Pc(53) int local53 = arg5 / 2;
		@Pc(63) int local63 = arg0.method2481(arg1 + local49, arg3 + local53);
		@Pc(67) int local67 = arg4 / 2;
		@Pc(71) int local71 = arg5 / 2;
		@Pc(81) int local81 = arg0.method2481(arg1 + local67, arg3 + local71);
	...
	public final void method6816(@OriginalArg(0) Class93_Sub1_Sub5 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class93_Sub1_Sub5 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean[] arg4, @OriginalArg(5) boolean arg5) {
		...
		@Pc(32) int local32 = arg1 % (arg0.method21544() + 1);
		...
		@Pc(64) int local64 = arg3 % (arg2.method21544() + 1);
	...
	public final void method6844(@OriginalArg(0) Class93_Sub1_Sub10 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class93_Sub1_Sub10 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class93_Sub1_Sub5 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean[] arg8, @OriginalArg(9) boolean arg9) {
		...
		@Pc(83) int local83 = arg7 % (arg6.method21544() + 1);
		...
		for (@Pc(5) int local5 = 0; local5 < arg0.anInt1590 * 1418467783; local5++) {
			if (arg5 == null || arg5[local5] == arg6 || arg0.anIntArray180[local5] == 0) {
				if (arg0.anIntArray180[local5] == 0) {
					...
					this.method6890(0, local1, arg1.method21541(), arg0.anIntArrayArray41[local5], 0.0F, 0.0F, 0.0F, arg3, arg4, arg7 & arg0.anIntArray181[local5], null);
					...
					if (local1 == null) {
						...
						local131 = new float[] { local1.method25438(arg1.method21541()).aFloatArray116[12], local1.method25438(arg1.method21541()).aFloatArray116[13], local1.method25438(arg1.method21541()).aFloatArray116[14] };
						local139 = local1.method25432(arg1.method21541()).method29835();
					}
					...
					for (@Pc(227) int local227 = 0; local227 < arg1.aClass230ArrayArray1[local5].length; local227++) {
						...
						if (local241 != null && (local225 != 7 || local227 < 0 || local227 >= 3)) {
							@Pc(258) float local258 = local241.method25628(arg2);
							switch(local227) {
								case 0:
									local82 = local258;
									break;
					...
					this.method6890(local225, local1, arg1.method21541(), arg0.anIntArrayArray41[local5], local82, local84, local86, arg3, arg4, arg7 & arg0.anIntArray181[local5], arg8);
				}
			}
		}
	}
	...
	void method6877(@OriginalArg(0) int arg0, @OriginalArg(1) Class212 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int[] arg10) {
		...
		if (arg0 == 0) {
			...
			local2 = (int) arg1.method25433(arg2).aFloatArray116[12];
			local5 = (int) -arg1.method25433(arg2).aFloatArray116[13];
			local8 = (int) -arg1.method25433(arg2).aFloatArray116[14];
		} else {
			@Pc(64) float[] local64;
			if (arg0 == 1) {
				if (arg1 == null) {
				...
				arg1.method25432(arg2).method29847(arg4, arg5, arg6, local52);
				local64 = new float[3];
				arg1.method25433(arg2).method29849(local52[0], local52[1], local52[2], local64);
				...
				if (arg1.aClass212_1 != null) {
					local109.method29953(arg1.aClass212_1.method25433(arg2));
				}
				local109.method29844();
				local109.method29953(arg1.method25433(arg2));
