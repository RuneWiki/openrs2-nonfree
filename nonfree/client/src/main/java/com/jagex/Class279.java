...
public class Class279 {
	...
	public int method26366(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	...
	public void method26370(@OriginalArg(0) int arg0) {
		this.method26385(arg0, -525952582);
		@Pc(5) int local5 = arg0;
		for (@Pc(7) int local7 = arg0; local7 < this.aList10.size(); local7++) {
			if (!this.method26376(local7, 1147325028)) {
				if (local7 != local5) {
					this.method26381(local7, local5, -1931481788);
				}
				local5 = local7 + 1;
			}
		}
	...
	public int method26371(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.aList12.indexOf(arg0);
	}

	@OriginalMember(owner = "client!fy", name = "w", descriptor = "(II)I", line = 45)
	public int method26372(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public void method26374(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2) {
		this.aList11.set(arg0, arg1 ? arg0 : anInteger1);
	}
	...
	public boolean method26376(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return !((Integer) this.aList11.get(arg0)).equals(anInteger1);
	}

	@OriginalMember(owner = "client!fy", name = "d", descriptor = "(III)I", line = 65)
	public int method26377(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (this.aList12.size() == 8) {
			throw new RuntimeException("");
		} else if (this.method26371(arg0, 867457263) == -1) {
			if (arg1 == -1) {
	...
	public int method26379(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.method26382(arg0, -1, 1217577618);
	}
	...
	void method26381(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	public int method26382(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (this.aList10.size() == 40) {
			throw new RuntimeException("");
		} else if (this.method26439(arg0, -1113809210) == -1) {
			if (arg1 == -1) {
				arg1 = this.aList10.size();
			}
			this.method26383(arg0, arg1, (byte) -9);
			for (@Pc(36) int local36 = arg1 + 1; local36 < this.aList10.size(); local36++) {
				...
				if (!local47.equals(anInteger1) && local47 < local36) {
					this.method26381(local36, local36 - 1, -1931481788);
				}
			}
			return this.method26439(arg0, -1113809210);
		} else {
			throw new RuntimeException("");
		}
	}
	...
	void method26383(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		...
		for (@Pc(16) int local16 = 0; local16 < this.aList12.size(); local16++) {
			local14.add((Object) null);
		}
		this.aList13.add(arg1, local14);
	}

	@OriginalMember(owner = "client!fy", name = "q", descriptor = "(II)V", line = 131)
	public void method26384(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.method26385(arg0, 820726769);
		@Pc(5) int local5 = arg0;
		for (@Pc(7) int local7 = arg0; local7 < this.aList10.size(); local7++) {
			if (!this.method26376(local7, -1180704314)) {
				if (local7 != local5) {
					this.method26381(local7, local5, -1931481788);
				}
				local5 = local7 + 1;
	...
	void method26385(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aList10.remove(arg0);
		this.aList11.remove(arg0);
		this.aList13.remove(arg0);
	}
	...
	public Object method26387(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
	...
	public void method26388(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Object arg2, @OriginalArg(3) int arg3) {
	...
	public int method26390(@OriginalArg(0) int arg0) {
		return this.method26377(arg0, -1, -1470029567);
	}
	...
	public int method26392(@OriginalArg(0) int arg0) {
		return this.aList10.size();
	}
	...
	public int method26394(@OriginalArg(0) int arg0) {
		return this.method26377(arg0, -1, -302036450);
	}
	...
	public void method26400(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.aList11.set(arg0, arg1);
	}

	@OriginalMember(owner = "client!fy", name = "l", descriptor = "(IB)I", line = 49)
	public int method26401(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		return this.method26377(arg0, -1, -1883426330);
	}
	...
	public void method26403(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		this.aList12.remove(arg0);
		@Pc(8) Iterator local8 = this.aList13.iterator();
		while (local8.hasNext()) {
			@Pc(15) List local15 = (List) local8.next();
	...
	public int method26404(@OriginalArg(0) int arg0) {
		return this.method26377(arg0, -1, -1572244076);
	}

	@OriginalMember(owner = "client!fy", name = "ar", descriptor = "(I)I", line = 49)
	public int method26405(@OriginalArg(0) int arg0) {
		return this.method26377(arg0, -1, -407489213);
	}

	@OriginalMember(owner = "client!fy", name = "v", descriptor = "(IIB)V", line = 93)
	public void method26406(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		this.method26381(arg0, arg1, -1931481788);
	...
	public void method26419(@OriginalArg(0) int arg0) {
		this.method26385(arg0, 1350824717);
		@Pc(5) int local5 = arg0;
		for (@Pc(7) int local7 = arg0; local7 < this.aList10.size(); local7++) {
			if (!this.method26376(local7, -1960117609)) {
				if (local7 != local5) {
					this.method26381(local7, local5, -1931481788);
				}
				local5 = local7 + 1;
	...
	public int method26428(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.aList10.size() == 40) {
			...
			this.method26383(arg0, arg1, (byte) -118);
			for (@Pc(36) int local36 = arg1 + 1; local36 < this.aList10.size(); local36++) {
				@Pc(47) Integer local47 = (Integer) this.aList11.get(local36);
				if (!local47.equals(anInteger1) && local47 < local36) {
					this.method26381(local36, local36 - 1, -1931481788);
	...
	public void method26432(@OriginalArg(0) int arg0) {
		this.method26385(arg0, -1265046712);
		@Pc(5) int local5 = arg0;
		for (@Pc(7) int local7 = arg0; local7 < this.aList10.size(); local7++) {
			if (!this.method26376(local7, 1739973156)) {
				if (local7 != local5) {
					this.method26381(local7, local5, -1931481788);
				}
				local5 = local7 + 1;
	...
	public int method26439(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.aList10.indexOf(arg0);
	}
	...
	static final void method26446(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!fy", name = "ic", descriptor = "(IB)V", line = 9614)
	static final void method26447(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		@Pc(2) Class93_Sub41_Sub2 local2 = client.aClass175_2.aClass93_Sub41_Sub2_2;
		while (local2.method22671(client.aClass175_2.anInt3301 * 2010044839, 1313572448) >= 15) {
			@Pc(17) int local17 = local2.method22689(15, 1227115599);
			if (local17 == 32767) {
				break;
			}
			...
			if (local29 == null) {
				local38 = new Class132_Sub1_Sub1_Sub1_Sub1(client.aClass532_1.method30459(-2038432393));
			...
			if (local38.aClass336_1 != null && local38.aClass336_1.method27432((short) 12466)) {
				Class665.method32895(local38, 846198857);
			}
			@Pc(105) int local105 = local2.method22689(2, -833157368);
			@Pc(110) int local110 = local2.method22689(arg0, -833088547);
			if (local110 > (0x1 << arg0 - 1) - 1) {
				local110 -= 0x1 << arg0;
			}
			@Pc(130) int local130 = local2.method22689(1, 311787348);
			if (local130 == 1) {
				client.anIntArray306[(client.anInt3472 += -170330519) * 146012633 - 1] = local17;
			}
			local38.method18589((Class336) Class162.aClass32_Sub3_2.method18261(local2.method22689(15, -1414174684), 1358140749), 484412968);
			@Pc(161) int local161 = local2.method22689(1, -1125559557);
			@Pc(172) int local172 = local2.method22689(3, 1297161788) + 4 << 11 & 0x3FFF;
			@Pc(177) int local177 = local2.method22689(arg0, 59162484);
			if (local177 > (0x1 << arg0 - 1) - 1) {
				local177 -= 0x1 << arg0;
			}
			local38.method19961(local38.aClass336_1.anInt4154 * 447008399, -2142170693);
			local38.anInt2788 = (local38.aClass336_1.anInt4165 * 295553787 << 3) * 723489705;
			if (local23) {
				local38.method19952(local172, true, 1006106775);
			}
			local38.method18592(local105, Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.anIntArray240[0] + local177, Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.anIntArray239[0] + local110, local161 == 1, local38.method19997(-1066476941), (byte) -95);
			if (local38.aClass336_1.method27432((short) -2741)) {
				Class643.method32583(local38.aByte100, local38.anIntArray240[0], local38.anIntArray239[0], 0, (Class610) null, local38, (Class132_Sub1_Sub1_Sub1_Sub2) null, 694869299);
			}
			if (local23) {
				local38.method18588((byte) 0);
			}
		}
		local2.method22670(-1653671445);
	}
	...
	public static Class104 method26448(@OriginalArg(0) Canvas arg0, @OriginalArg(1) Class225 arg1, @OriginalArg(2) Interface24 arg2, @OriginalArg(3) Interface48 arg3, @OriginalArg(4) Interface46 arg4, @OriginalArg(5) Interface47 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) byte arg8) {
	...
	public static void method26449(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
