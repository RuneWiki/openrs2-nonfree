...
public class Class412 {
	...
	public Class420 method28657(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(3) Interface39 arg3, @OriginalArg(4) int arg4) {
		if (this.method28660(arg0, (byte) 78) != null) {
			return null;
		}
		@Pc(8) Class420 local8 = null;
		if (arg1 != -1) {
			local8 = this.method28660(arg1, (byte) 114);
		}
	...
	public void method28658(@OriginalArg(0) int arg0) {
		...
		while (local4.hasNext()) {
			...
			local11.method28719(-1676533101);
		}
	}
	...
	public void method28659() {
		...
		while (local4.hasNext()) {
			@Pc(11) Class420 local11 = (Class420) local4.next();
			local11.method28719(-879778635);
		}
	}

	@OriginalMember(owner = "client!mb", name = "m", descriptor = "(IB)Lclient!mj;", line = 34)
	public Class420 method28660(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	...
	public Class420 method28661(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(3) Interface39 arg3) {
		if (this.method28660(arg0, (byte) 68) != null) {
			return null;
		}
		@Pc(8) Class420 local8 = null;
		if (arg1 != -1) {
			local8 = this.method28660(arg1, (byte) 93);
		}
	...
	public Class420 method28662(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(3) Interface39 arg3) {
		if (this.method28660(arg0, (byte) 85) != null) {
			return null;
		}
		@Pc(8) Class420 local8 = null;
		if (arg1 != -1) {
			local8 = this.method28660(arg1, (byte) 107);
		}
	...
	public void method28663() {
		...
		while (local4.hasNext()) {
			@Pc(11) Class420 local11 = (Class420) local4.next();
			local11.method28719(-1468121467);
		}
	}

	@OriginalMember(owner = "client!mb", name = "l", descriptor = "(IIFLclient!ma;)Lclient!mj;", line = 22)
	public Class420 method28664(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2, @OriginalArg(3) Interface39 arg3) {
		if (this.method28660(arg0, (byte) 81) != null) {
			return null;
		}
		@Pc(8) Class420 local8 = null;
		if (arg1 != -1) {
			local8 = this.method28660(arg1, (byte) 91);
		}
