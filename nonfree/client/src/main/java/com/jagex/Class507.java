...
public class Class507 implements Interface75 {
	...
	static boolean method30228(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) String arg2, @OriginalArg(3) String arg3, @OriginalArg(4) long arg4) {
		...
		if (!Class411.aBoolean750 && (Class411.aString200.equals("") || Class411.aString201.equals(""))) {
			...
			Class680.method33243(-658529605);
			return false;
		}
	...
	static void method30229(@OriginalArg(0) int arg0) {
		if (Class694.aClass104_14 == null) {
			return;
		}
		client.aClass532_1.method30463((byte) 59);
		Class360.method27801((short) -5760);
		Class389.method28266((byte) 34);
		Class54.method14857((short) 2003);
		Class106.method7582((byte) 1);
		client.aClass532_1.method30453(true, -1425513161);
		Class542.method30936(-1497248091);
		Class165.method15319(-248208143);
		Class700.method36716(false, (byte) -31);
		Class286.method26532(1204150188);
		...
		Class694.aClass104_14.method20877(-1550720229);
		Class694.aClass104_14 = null;
	}

	@OriginalMember(owner = "client!qj", name = "api", descriptor = "(Lclient!yf;B)V", line = 12644)
	static final void method30230(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) throws Exception_Sub3 {
		Class65.aClass123_Sub1_2.method9009((float) arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091] / 1000.0F, 614785474);
	}

	@OriginalMember(owner = "client!qj", name = "l", descriptor = "(II)I", line = 55)
	static final int method30231(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
