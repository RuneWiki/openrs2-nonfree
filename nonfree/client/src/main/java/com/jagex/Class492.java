...
public class Class492 {
	...
	public static void method29982(@OriginalArg(0) Class472 arg0, @OriginalArg(1) Class472 arg1, @OriginalArg(2) Class472 arg2, @OriginalArg(3) float arg3, @OriginalArg(4) Class472[] arg4) {
		@Pc(3) Class472 local3 = Class472.method29574(arg0, arg2);
		@Pc(11) float local11 = Class472.method29549(local3, local3) - arg3 * arg3;
		@Pc(15) float local15 = Class472.method29549(arg1, local3);
		...
		if (local21 < 0.0F) {
			...
			arg4[0] = Class472.method29528();
			arg4[0].method29538(arg0);
			arg4[0].method29543(Class472.method29558(Class472.method29530(arg1), -local15 - local45));
			arg4[1] = Class472.method29528();
			arg4[1].method29538(arg0);
			arg4[1].method29543(Class472.method29558(Class472.method29530(arg1), -local15 + local45));
		} else {
			arg4[0] = Class472.method29528();
			arg4[0].method29538(arg0);
			arg4[0].method29543(Class472.method29558(Class472.method29530(arg1), -local15));
			arg4[1] = null;
		}
	}
