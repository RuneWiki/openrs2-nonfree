...
public class Class102_Sub2 extends Class102 {
	...
	Class102_Sub2(@OriginalArg(0) Class104_Sub2 arg0, @OriginalArg(1) int[] arg1) {
		...
		if (this.aClass104_Sub2_3.aBoolean471) {
			...
			this.anInterface43_1 = this.aClass104_Sub2_3.method21126(Class206.aClass206_22, 16, 16, 16, false, local12);
		} else {
			this.anInterface43_1 = this.aClass104_Sub2_3.method21133(256, 16, false, arg1);
		}
	}
