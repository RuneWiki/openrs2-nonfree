...
public class Class490 {
	...
	byte[] method29972(@OriginalArg(0) int arg0) {
		return this.aByteArray94;
	}
	...
	Class490(@OriginalArg(0) Class493 arg0, @OriginalArg(1) InputStream arg1, @OriginalArg(2) Class93_Sub1_Sub16_Sub1 arg2, @OriginalArg(3) URL arg3) {
		...
		if (arg1 != null) {
			...
			@Pc(19) int local19 = 0;
			@Pc(23) byte[] local23 = Class723.method36934(1024, 1617702923);
			@Pc(53) int local53;
			while (local19 >= 0) {
				try {
				...
				if (local19 > 0) {
					if (local19 + local17.anInt3070 * 212851357 >= local17.aByteArray58.length) {
						...
						@Pc(58) byte[] local58 = Class723.method36935(local53, true, -369210105);
						System.arraycopy(local17.aByteArray58, 0, local58, 0, local17.anInt3070 * 212851357);
						Class723.method36938(local17.aByteArray58, (byte) 19);
						local17.aByteArray58 = local58;
					}
					local17.method22405(local23, 0, local19, 2026842986);
				}
			}
			for (local53 = 0; local53 < arg2.anInt3187 * 493721639; local53++) {
				local17.method22510(0, (byte) -100);
			}
			...
			local17.method22651((byte) 1);
			local17 = null;
			Class723.method36938(local23, (byte) 19);
	...
	static final void method29975(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1883831207);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class453.method28965(local16, local22, arg0, Class310.aClass310_6, (byte) 110);
	}

	@OriginalMember(owner = "client!pr", name = "f", descriptor = "(Z[BI)V", line = 76)
	public static void method29976(@OriginalArg(0) boolean arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2) {
		if (Class607.aClass93_Sub41_17 == null) {
			Class607.aClass93_Sub41_17 = new Class93_Sub41(20000);
		}
		Class607.aClass93_Sub41_17.method22405(arg1, 0, arg1.length, 2026842986);
		if (!arg0) {
			return;
		}
		Class653.method32713(Class607.aClass93_Sub41_17.aByteArray58, -1365603373);
		...
		for (@Pc(32) int local32 = Class607.anInt5560 * 1855382415; local32 <= Class361.anInt4571 * 977343673; local32++) {
			@Pc(41) Class154_Sub1 local41 = Class367.method27961(local32, (byte) 71);
			if (local41 != null) {
				Class50.aClass154_Sub1Array1[local28++] = local41;
			}
		}
		Class50.aBoolean26 = false;
		Class333.aLong260 = Class305.method26796(1286018654) * 7977095113539552245L;
	...
	static void method29977(@OriginalArg(0) byte arg0) {
		Class411.aClass175_3.method24369(1222194881);
		...
		client.anInt3453 = 0;
		Class380.method28120((byte) 66);
		Class287.method26542((byte) 62);
		@Pc(32) int local32;
		...
		Class245.method25900((byte) -123);
		Class322.method27274(Class20.method376(1197191252), -1621738124);
		Class481.method29756(18, 1823202236);
		for (local32 = 0; local32 < 114; local32++) {
			client.aBooleanArray22[local32] = true;
		}
		Class339.method27487(Class411.aClass175_3, (byte) 23);
		Class653.aClass678_2 = null;
		Class442.aLong276 = 0L;
		Class285.method26517(2125922980);
		...
		if (arg0.eventType != 33) {
			if (arg0.eventType == 30) {
				...
				if (local18 == 0 || local18 == 1) {
					Class387.method28242((short) -3313);
				} else if (local18 == 2) {
			...
			if (arg0.eventType == 34) {
				...
				Class670.method32959(34, 0, (byte) 25);
			}
			return true;
			...
			if (local23 == 0) {
				...
				Class491.method29979((byte) 74);
				Class625.aLong291 = arg1 * 273097735325007225L;
				Class670.method32959(33, 0, (byte) 70);
			} else {
