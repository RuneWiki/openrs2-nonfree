...
public class Class119_Sub1 extends Class119 {
	...
	static final void method8606(@OriginalArg(0) Class132_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		Class77.method1300(arg0, arg1, false, arg2);
	}

	@OriginalMember(owner = "client!agy", name = "sj", descriptor = "(Lclient!hf;Lclient!yf;I)V", line = 8318)
	static final void method8607(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class681 arg1) {
		if (arg1.anInt5892 * -1243304745 >= 10) {
			...
			client.aClass22_47.method407(local18);
		}
	}

	@OriginalMember(owner = "client!agy", name = "up", descriptor = "(Lclient!yf;I)V", line = 8655)
	static final void method8608(@OriginalArg(0) Class681 arg0) {
