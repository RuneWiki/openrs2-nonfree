...
public class Class153_Sub1 extends Class153 implements MouseListener, MouseMotionListener, MouseWheelListener {
	...
	void method14113(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(8) Class93_Sub23_Sub1 local8 = Class149.method23771(arg0, arg1, arg2, Class305.method26796(), arg3);
		this.aClass22_24.method407(local8);
	}
	...
	void method14102(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (this.aBoolean341) {
			this.method14113(-1, arg0, arg1, 0);
		}
	}

	@OriginalMember(owner = "client!alb", name = "ab", descriptor = "(III)V", line = 60)
	void method14103(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.anInt1636 = arg0 * -180288159;
		this.anInt1637 = arg1 * -1857652815;
		if (this.aBoolean341) {
			this.method14113(-1, arg0, arg1, 0);
	...
	@Override
	public Class93_Sub23 method14065() {
		return (Class93_Sub23) this.aClass22_23.method408();
	}
	...
	public synchronized void method14081() {
		...
		this.aClass22_24.method406();
	}

	@OriginalMember(owner = "client!alb", name = "m", descriptor = "(I)V", line = 72)
	@Override
	public synchronized void method14059() {
		this.anInt1632 = this.anInt1636 * -1717877313;
		this.anInt1633 = this.anInt1637 * -1952789955;
		this.anInt1635 = this.anInt1638 * -103875021;
		@Pc(20) Class22 local20 = this.aClass22_23;
	...
	public static void method14115(@OriginalArg(0) String arg0) {
		if (client.anInt3435 * -849002901 != 0) {
			return;
		}
		@Pc(11) Class93_Sub22 local11 = Class102.method2592(Class446.aClass446_13, client.aClass175_1.aClass24_2);
		local11.aClass93_Sub41_Sub2_1.method22510(0);
		...
		local11.aClass93_Sub41_Sub2_1.method22537(local11.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local22);
	...
	public synchronized void mouseEntered(@OriginalArg(0) MouseEvent arg0) {
		this.method14103(arg0.getX(), arg0.getY());
	}
	...
	int method14104(@OriginalArg(0) MouseEvent arg0) {
		if (arg0.getButton() == 1) {
	...
	public synchronized void mousePressed(@OriginalArg(0) MouseEvent arg0) {
		@Pc(4) int local4 = this.method14104(arg0);
		if (local4 == 1) {
			this.method14113(0, arg0.getX(), arg0.getY(), arg0.getClickCount());
		} else if (local4 == 4) {
			this.method14113(2, arg0.getX(), arg0.getY(), arg0.getClickCount());
		} else if (local4 == 2) {
			this.method14113(1, arg0.getX(), arg0.getY(), arg0.getClickCount());
		}
	...
	public synchronized void mouseReleased(@OriginalArg(0) MouseEvent arg0) {
		...
		if ((local4 & 0x1) != 0) {
			this.method14113(3, arg0.getX(), arg0.getY(), arg0.getClickCount());
		}
		if ((local4 & 0x4) != 0) {
			this.method14113(5, arg0.getX(), arg0.getY(), arg0.getClickCount());
		}
		if ((local4 & 0x2) != 0) {
			this.method14113(4, arg0.getX(), arg0.getY(), arg0.getClickCount());
		}
		this.anInt1638 = (-2099788627 * this.anInt1638 & ~local4) * -1236123867;
		if (arg0.isPopupTrigger()) {
			arg0.consume();
