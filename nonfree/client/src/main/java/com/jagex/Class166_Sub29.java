...
public class Class166_Sub29 extends Class166 {
	...
	public boolean method16057(@OriginalArg(0) int arg0) {
		return Class136.method10214(this.aClass93_Sub36_49.aClass166_Sub4_2.method15424((byte) 30), 1894706074);
	}
	...
	public int method16543(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return Class136.method10214(this.aClass93_Sub36_49.aClass166_Sub4_2.method15424((byte) 125), 54425272) ? 1 : 3;
	}
	...
	public int method16058(@OriginalArg(0) int arg0) {
	...
	public void method16059(@OriginalArg(0) int arg0) {
		if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 1) {
			this.anInt2379 = this.method16542((byte) -60) * -88839937;
		}
	}
	...
	public int method16540(@OriginalArg(0) int arg0) {
		return Class136.method10214(this.aClass93_Sub36_49.aClass166_Sub4_2.method15424((byte) 47), 895813589) ? 1 : 3;
	}

	@OriginalMember(owner = "client!ane", name = "z", descriptor = "(I)I", line = 33)
	@Override
	public int method16549(@OriginalArg(0) int arg0) {
		return Class136.method10214(this.aClass93_Sub36_49.aClass166_Sub4_2.method15424((byte) 37), -314662094) ? 1 : 3;
	}

	@OriginalMember(owner = "client!ane", name = "x", descriptor = "()V", line = 20)
	public void method16060() {
		if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 1) {
			this.anInt2379 = this.method16542((byte) -6) * -88839937;
		}
	}
	...
	public void method16061() {
		if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 1) {
			this.anInt2379 = this.method16542((byte) -102) * -88839937;
		}
	}
	...
	public boolean method16063() {
		return Class136.method10214(this.aClass93_Sub36_49.aClass166_Sub4_2.method15424((byte) 66), -383574561);
	}

	@OriginalMember(owner = "client!ane", name = "a", descriptor = "()Z", line = 28)
	public boolean method16064() {
		return Class136.method10214(this.aClass93_Sub36_49.aClass166_Sub4_2.method15424((byte) 95), 216465914);
	}
	...
	static final void method16067(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub12_1.method15611((byte) 56);
	}
	...
	public static Class306 method16069(@OriginalArg(0) int arg0) {
	...
	static final void method16070(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(13) int local13 = -1;
		@Pc(15) int local15 = -1;
		@Pc(20) Class327 local20 = local11.method26878(Class694.aClass104_14, (byte) 24);
		if (local20 != null) {
