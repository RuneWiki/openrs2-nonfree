...
public class Class146_Sub2 extends Class146 {
	...
	public void method11685(@OriginalArg(0) Object arg0) {
		...
		synchronized (local8.aClass580_1) {
			local8.aClass580_1.method31379(local8, 16711935);
		}
	}
	...
	public void method11683(@OriginalArg(0) int arg0) {
		if (this.aClass412_2 != null) {
			this.aClass412_2.method28658(-518382564);
		}
		...
		while (true) {
			...
			do {
				...
				local26 = (Class535[]) (Class535[]) this.aHashMap3.get(local19);
				if (!local19.aBoolean786) {
					@Pc(31) boolean local31 = false;
					for (@Pc(33) int local33 = 0; local33 < local26.length; local33++) {
						local26[local33].method30752((byte) 0);
						local31 |= local26[local33].method30739((byte) 0);
					}
					if (local31) {
				...
				while (!local64) {
					@Pc(78) float local78 = local26[local69].method30682(1024936252);
					@Pc(84) Class511 local84 = local26[local69].method30701(-1948578726);
					if (local78 >= 0.0F) {
						local64 = true;
					} else if (Class511.aClass511_6 == local84 || Class511.aClass511_4 == local84 || local84 == Class511.aClass511_5) {
						local26[local69].method30640(-1992610674);
					}
					local69--;
					if (local69 < 0) {
						local64 = true;
			...
			while (local69 >= local26.length - local62) {
				@Pc(129) Class511 local129 = local26[local69].method30701(-1825807183);
				if (local129 == Class511.aClass511_6) {
					local26[local69].method30640(-469731981);
				}
				local69--;
			}
		}
	...
	public int method11680(@OriginalArg(0) Object arg0) {
		...
		synchronized (local7.aClass580_1) {
			return local7.method31316(-1828041961);
		}
	}
	...
	public Object method11670(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class433 arg2, @OriginalArg(3) Class426 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5, @OriginalArg(6) byte arg6) {
		...
		synchronized (local43.aClass580_1) {
			local43.aClass580_1.method31378(local43, (byte) -18);
			return local43;
		}
	}
	...
	public Class535 method11674(@OriginalArg(0) Class508 arg0, @OriginalArg(1) byte arg1) {
		...
		synchronized (this.aHashMap3) {
			@Pc(11) Class535[] local11 = (Class535[]) (Class535[]) this.aHashMap3.get(arg0);
			if (local11 == null) {
				return null;
			}
			for (@Pc(20) int local20 = 0; local20 < local11.length; local20++) {
				@Pc(28) Class535 local28 = local11[local20];
				@Pc(32) Class511 local32 = local28.method30701(-2131879427);
				if (local32 == Class511.aClass511_2) {
					local28.method30743(-611526946);
					return local28;
				}
			}
			return null;
	...
	public Class146_Sub2(@OriginalArg(0) Class657 arg0) {
		...
		while (local37.hasNext()) {
			local44 = (Class508) local37.next();
			@Pc(76) Class535[] local76 = (Class535[]) (Class535[]) this.aHashMap3.get(local44);
	...
	public void method11677(@OriginalArg(0) byte arg0) {
		...
		synchronized (local3) {
			...
			while (local11.hasNext()) {
				...
				@Pc(24) Class535[] local24 = (Class535[]) (Class535[]) local3.get(local18);
				for (@Pc(26) int local26 = 0; local26 < local24.length; local26++) {
					if (local24[local26].method30701(-2065072298) != Class511.aClass511_2) {
						local24[local26].method30640(-1608723843);
						local24[local26].method30635((byte) 8);
					}
				}
			}
		}
		...
		while (!local60) {
			...
			synchronized (local3) {
				...
				while (local72.hasNext()) {
					...
					@Pc(85) Class535[] local85 = (Class535[]) (Class535[]) local3.get(local79);
					for (@Pc(87) int local87 = 0; local87 < local85.length; local87++) {
						if (local85[local87].method30701(-1722668355) != Class511.aClass511_2) {
							local85[local87].method30752((byte) 0);
							local60 = false;
						}
					}
				}
	...
	public void method11679() {
		if (this.aClass412_2 != null) {
			this.aClass412_2.method28658(942570782);
		}
		@Pc(12) Iterator local12 = this.aHashMap3.keySet().iterator();
		while (true) {
			@Pc(26) Class535[] local26;
			...
			do {
				...
				local69 = local26.length - 1;
				while (!local64) {
					@Pc(78) float local78 = local26[local69].method30682(-1447385467);
					@Pc(84) Class511 local84 = local26[local69].method30701(-1871691167);
					if (local78 >= 0.0F) {
						local64 = true;
					} else if (Class511.aClass511_6 == local84 || Class511.aClass511_4 == local84 || local84 == Class511.aClass511_5) {
						local26[local69].method30640(98642903);
					}
					local69--;
					if (local69 < 0) {
						local64 = true;
			...
			while (local69 >= local26.length - local62) {
				@Pc(129) Class511 local129 = local26[local69].method30701(-1767473130);
				if (local129 == Class511.aClass511_6) {
					local26[local69].method30640(-1770944668);
				}
				local69--;
			}
		}
	...
	public int method11698(@OriginalArg(0) Object arg0) {
		...
		@Pc(11) Class580 local11 = local7.aClass580_1;
		synchronized (local7.aClass580_1) {
			return local7.method31316(1744685557);
		}
	}
	...
	public Object method11681(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class433 arg2, @OriginalArg(3) Class426 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5) {
		...
		@Pc(47) Class580 local47 = local43.aClass580_1;
		synchronized (local43.aClass580_1) {
			local43.aClass580_1.method31378(local43, (byte) -107);
			return local43;
		}
	}
	...
	public Object method11686(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class433 arg2, @OriginalArg(3) Class426 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5) {
		...
		@Pc(47) Class580 local47 = local43.aClass580_1;
		synchronized (local43.aClass580_1) {
			local43.aClass580_1.method31378(local43, (byte) -108);
			return local43;
		}
	}
	...
	public Class535 method11690(@OriginalArg(0) Class508 arg0) {
		...
		synchronized (this.aHashMap3) {
			...
			for (@Pc(20) int local20 = 0; local20 < local11.length; local20++) {
				@Pc(28) Class535 local28 = local11[local20];
				@Pc(32) Class511 local32 = local28.method30701(-2102709917);
				if (local32 == Class511.aClass511_2) {
					local28.method30743(-1378687437);
					return local28;
				}
			}
			return null;
	...
	public void method11676(@OriginalArg(0) Object arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(12) Class580 local12 = local8.aClass580_1;
		synchronized (local8.aClass580_1) {
			local8.method31314(arg1, arg2, arg3, (byte) -48);
		}
	}
	...
	public void method11687(@OriginalArg(0) Object arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(12) Class580 local12 = local8.aClass580_1;
		synchronized (local8.aClass580_1) {
			local8.method31314(arg1, arg2, arg3, (byte) -68);
		}
	}
	...
	public void method11688(@OriginalArg(0) Object arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(12) Class580 local12 = local8.aClass580_1;
		synchronized (local8.aClass580_1) {
			local8.method31314(arg1, arg2, arg3, (byte) 55);
		}
	}
	...
	public Class535 method11694(@OriginalArg(0) Class508 arg0) {
		...
		synchronized (this.aHashMap3) {
			...
			for (@Pc(20) int local20 = 0; local20 < local11.length; local20++) {
				@Pc(28) Class535 local28 = local11[local20];
				@Pc(32) Class511 local32 = local28.method30701(-2109288180);
				if (local32 == Class511.aClass511_2) {
					local28.method30743(-151316445);
					return local28;
				}
			}
			return null;
	...
	public Class535 method11691(@OriginalArg(0) Class508 arg0) {
		...
		synchronized (this.aHashMap3) {
			...
			for (@Pc(20) int local20 = 0; local20 < local11.length; local20++) {
				@Pc(28) Class535 local28 = local11[local20];
				@Pc(32) Class511 local32 = local28.method30701(-1747193348);
				if (local32 == Class511.aClass511_2) {
					local28.method30743(1629821061);
					return local28;
				}
			}
			return null;
	...
	public void method11684(@OriginalArg(0) Object arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		@Pc(12) Class580 local12 = local8.aClass580_1;
		synchronized (local8.aClass580_1) {
			local8.method31314(arg1, arg2, arg3, (byte) -46);
		}
	}
	...
	public void method11700() {
		...
		synchronized (local3) {
			...
			while (local11.hasNext()) {
				...
				@Pc(24) Class535[] local24 = (Class535[]) (Class535[]) local3.get(local18);
				for (@Pc(26) int local26 = 0; local26 < local24.length; local26++) {
					if (local24[local26].method30701(-1968506143) != Class511.aClass511_2) {
						local24[local26].method30640(-709296256);
						local24[local26].method30635((byte) 8);
					}
				}
			}
		...
		while (!local60) {
			...
			synchronized (local3) {
				...
				while (local72.hasNext()) {
					...
					@Pc(85) Class535[] local85 = (Class535[]) (Class535[]) local3.get(local79);
					for (@Pc(87) int local87 = 0; local87 < local85.length; local87++) {
						if (local85[local87].method30701(-1828112506) != Class511.aClass511_2) {
							local85[local87].method30752((byte) 0);
							local60 = false;
						}
					}
	...
	public void method11699() {
		...
		synchronized (local3) {
			...
			while (local11.hasNext()) {
				...
				@Pc(24) Class535[] local24 = (Class535[]) (Class535[]) local3.get(local18);
				for (@Pc(26) int local26 = 0; local26 < local24.length; local26++) {
					if (local24[local26].method30701(-1719785692) != Class511.aClass511_2) {
						local24[local26].method30640(-1255413680);
						local24[local26].method30635((byte) 8);
					}
				}
			}
		...
		while (!local60) {
			...
			synchronized (local3) {
				...
				while (local72.hasNext()) {
					...
					@Pc(85) Class535[] local85 = (Class535[]) (Class535[]) local3.get(local79);
					for (@Pc(87) int local87 = 0; local87 < local85.length; local87++) {
						if (local85[local87].method30701(-1789484277) != Class511.aClass511_2) {
							local85[local87].method30752((byte) 0);
							local60 = false;
						}
					}
	...
	public int method11673(@OriginalArg(0) Object arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(11) Class580 local11 = local7.aClass580_1;
		synchronized (local7.aClass580_1) {
			return local7.method31316(-449229318);
		}
	}
	...
	public Object method11682(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class433 arg2, @OriginalArg(3) Class426 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5) {
		...
		@Pc(47) Class580 local47 = local43.aClass580_1;
		synchronized (local43.aClass580_1) {
			local43.aClass580_1.method31378(local43, (byte) -56);
			return local43;
		}
	}
	...
	static boolean method11709(@OriginalArg(0) int arg0) {
		if (client.anInt3435 * -849002901 == 4) {
			return !Class251.method25973(1619801325) && !Class631.method32282(-1890347983);
		} else {
			return false;
		}
	}
