...
public class Class663 {
	...
	static void method32870(@OriginalArg(0) Class489 arg0) {
		Class454.aClass489_98.method29837(arg0);
	}

	@OriginalMember(owner = "client!xl", name = "fk", descriptor = "(B)V", line = 3154)
	static final void method32869() {
		for (@Pc(5) int local5 = Class624.aClass120_1.aClass647_1.method32641(true); local5 != -1; local5 = Class624.aClass120_1.aClass647_1.method32641(false)) {
			Class166_Sub34.method16205(local5);
			client.anIntArray319[(client.anInt3539 += -245152335) * 1497097041 - 1 & 0x3F] = local5;
		}
		for (@Pc(35) Class93_Sub1_Sub11 local35 = Class379.method28106(); local35 != null; local35 = Class379.method28106()) {
			@Pc(41) int local41 = local35.method21808();
			@Pc(45) long local45 = local35.method21803();
			@Pc(55) Class108 local55;
			if (local41 == 1) {
				local55 = (Class108) Class72.aClass79_Sub1_Sub2_2.method18261((int) local45);
				Class596.aClass113_Sub1_1.method33464(local55, local35.anInt3020 * -222984563);
				client.anIntArray322[(client.anInt3543 += -417848381) * -491428629 - 1 & 0x3F] = (int) local45;
			} else if (local41 == 2) {
				local55 = (Class108) Class72.aClass79_Sub1_Sub2_2.method18261((int) local45);
				Class596.aClass113_Sub1_1.method33468(local55, local35.aString103);
				client.anIntArray321[(client.anInt3544 += 238378227) * 1821580347 - 1 & 0x3F] = (int) local45;
			} else {
				@Pc(119) Class312 local119;
				if (local41 == 3) {
					local119 = Class659.method32805((int) local45);
					if (!local35.aString103.equals(local119.aString164)) {
						local119.aString164 = local35.aString103;
						Class354.method27696(local119);
					}
				} else if (local41 == 23) {
					local119 = Class659.method32805((int) local45);
					...
					if (local41 == 4) {
						...
						if (local119.anInt4023 * -1088634495 != local35.anInt3020 * -222984563) {
							if (-222984563 * local35.anInt3020 == -1) {
								...
								local119.aClass19_6.method23568(local35.anInt3020 * -222984563);
							}
						...
						@Pc(326) Class312 local326 = Class659.method32805((int) local45);
						if (local326.anInt3993 * 969124391 != local321) {
							local326.anInt3993 = local321 * -999742057;
							Class354.method27696(local326);
						}
					} else if (local41 == 7) {
						local119 = Class659.method32805((int) local45);
						...
						local119.method26872(local181, (short) (local35.anInt3020 * -222984563), (short) (local35.anInt3025 * -371058729));
					} else if (local41 == 20) {
						local119 = Class659.method32805((int) local45);
						local181 = (int) (local45 >> 32);
						local119.method26901(local181, (short) (local35.anInt3020 * -222984563), (short) (local35.anInt3025 * -371058729));
					}
				}
			}
		}
	...
	static final void method32867(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class624.aClass120_1.method8665(local12);
	}

	@OriginalMember(owner = "client!xl", name = "lr", descriptor = "(II)V", line = 12082)
	public static final void method32868(@OriginalArg(0) int arg0) {
		...
		@Pc(24) Class175 local24 = Class330.method27372();
		@Pc(30) Class93_Sub22 local30 = Class102.method2592(Class446.aClass446_67, local24.aClass24_2);
		local30.aClass93_Sub41_Sub2_1.method22510(Class46.method894(local16.aString191) + 2);
		local30.aClass93_Sub41_Sub2_1.method22454(arg0);
		local30.aClass93_Sub41_Sub2_1.method22402(local16.aString191);
		local24.method24351(local30);
	}
}
