...
public class Class663 {
	...
	public static void method32852(@OriginalArg(0) int arg0) {
		if (arg0 < 0 || arg0 > 2) {
			arg0 = 0;
		}
	...
	static int method32854(@OriginalArg(0) int arg0) {
		@Pc(5) Class93_Sub14 local5 = (Class93_Sub14) aClass16_38.method215((long) arg0);
		if (local5 == null) {
			@Pc(13) Class431 local13 = Class110_Sub15_Sub2.anInterface47_1.method28875(arg0, -657045947);
			if (local13 == null || local13.anInt4792 * -1789015339 != 2) {
	...
	public static void method32855(@OriginalArg(0) Interface46 arg0, @OriginalArg(1) Interface47 arg1) {
		anInt5830 = 0;
		anInt5834 = 0;
	...
	public static void method32857(@OriginalArg(0) Class104 arg0, @OriginalArg(1) long arg1) {
		anInt5836 = anInt5829 * -1517636377;
		anInt5829 = 0;
		Class305.method26796(1385019767);
		@Pc(11) Iterator local11 = Class701.aList26.iterator();
		while (local11.hasNext()) {
			@Pc(18) Class674 local18 = (Class674) local11.next();
			@Pc(23) boolean local23 = local18.method33096(arg0, arg1);
	...
	public static void method32864(@OriginalArg(0) Class585 arg0, @OriginalArg(1) Class104 arg1) {
		@Pc(2) Iterator local2 = Class701.aList26.iterator();
		while (local2.hasNext()) {
			@Pc(9) Class674 local9 = (Class674) local2.next();
			if (local9.aBoolean871) {
	...
	static final void method32867(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class624.aClass120_1.method8665(local12, (byte) 35);
	}

	@OriginalMember(owner = "client!xl", name = "lr", descriptor = "(II)V", line = 12082)
	public static final void method32868(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(24) Class175 local24 = Class330.method27372(-1591794019);
		@Pc(30) Class93_Sub22 local30 = Class102.method2592(Class446.aClass446_67, local24.aClass24_2, (byte) 125);
		local30.aClass93_Sub41_Sub2_1.method22510(Class46.method894(local16.aString191, -2097123155) + 2, (byte) -85);
		local30.aClass93_Sub41_Sub2_1.method22454(arg0, 2138344338);
		local30.aClass93_Sub41_Sub2_1.method22402(local16.aString191, -2003140695);
		local24.method24351(local30, -1777179793);
	}

	@OriginalMember(owner = "client!xl", name = "fk", descriptor = "(B)V", line = 3154)
	static final void method32869(@OriginalArg(0) byte arg0) {
		for (@Pc(5) int local5 = Class624.aClass120_1.aClass647_1.method32641(true, 1236194973); local5 != -1; local5 = Class624.aClass120_1.aClass647_1.method32641(false, 1844575074)) {
			Class166_Sub34.method16205(local5, 575191378);
			client.anIntArray319[(client.anInt3539 += -245152335) * 1497097041 - 1 & 0x3F] = local5;
		}
		for (@Pc(35) Class93_Sub1_Sub11 local35 = Class379.method28106((byte) -112); local35 != null; local35 = Class379.method28106((byte) -73)) {
			@Pc(41) int local41 = local35.method21808(1232297652);
			@Pc(45) long local45 = local35.method21803(668145154);
			...
			if (local41 == 1) {
				...
				if (local41 == 3) {
					local119 = Class659.method32805((int) local45, 414985263);
					if (!local35.aString103.equals(local119.aString164)) {
						local119.aString164 = local35.aString103;
						Class354.method27696(local119, -1174743804);
					}
				} else if (local41 == 23) {
					local119 = Class659.method32805((int) local45, 1373384509);
					...
					@Pc(191) int local191;
					if (local41 == 4) {
						local119 = Class659.method32805((int) local45, -562696572);
						...
						local119 = Class659.method32805((int) local45, 1227522623);
						if (local119.anInt4023 * -1088634495 != local35.anInt3020 * -222984563) {
							if (-222984563 * local35.anInt3020 == -1) {
								...
								local119.aClass19_6.method23568(local35.anInt3020 * -222984563, -67984982);
							}
						...
						@Pc(326) Class312 local326 = Class659.method32805((int) local45, -584669151);
						if (local326.anInt3993 * 969124391 != local321) {
							local326.anInt3993 = local321 * -999742057;
							Class354.method27696(local326, -1174743804);
						}
					} else if (local41 == 7) {
						local119 = Class659.method32805((int) local45, 1220209065);
						...
						local119 = Class659.method32805((int) local45, 1749407565);
						...
						local119 = Class659.method32805((int) local45, 1404543799);
						...
						local119 = Class659.method32805((int) local45, 1952374909);
						...
						local119 = Class659.method32805((int) local45, 1784370960);
						local119.aByte126 = 0;
						...
						local119 = Class659.method32805((int) local45, 1724037930);
						local181 = local35.anInt3020 * -222984563;
						...
						local119 = Class659.method32805((int) local45, -225014660);
						...
						local119 = Class659.method32805((int) local45, 1000465252);
						local119.anInt4035 = local35.anInt3020 * 1602008339;
					} else if (local41 == 21) {
						local119 = Class659.method32805((int) local45, 978593478);
						local119.aBoolean697 = local35.anInt3020 * -222984563 == 1;
					} else if (local41 == 22) {
						local119 = Class659.method32805((int) local45, 1142374947);
						local119.aBoolean691 = local35.anInt3020 * -222984563 == 1;
					} else if (local41 == 17) {
						local119 = Class659.method32805((int) local45, 1393391603);
						local181 = (int) (local45 >> 32);
						local119.method26872(local181, (short) (local35.anInt3020 * -222984563), (short) (local35.anInt3025 * -371058729), 156948969);
					} else if (local41 == 20) {
						local119 = Class659.method32805((int) local45, 2101990543);
						local181 = (int) (local45 >> 32);
						local119.method26901(local181, (short) (local35.anInt3020 * -222984563), (short) (local35.anInt3025 * -371058729), -2110074);
					}
				}
			}
		}
	...
	static void method32870(@OriginalArg(0) Class489 arg0, @OriginalArg(1) byte arg1) {
		Class454.aClass489_98.method29837(arg0);
	}
}
