...
public class Class203 {
	...
	public static Class105[] method24648(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(16) int local16 = local4.method22415();
		...
		if (local20 == 0) {
			...
			local31 = local4.method22415();
			@Pc(62) int local62 = local4.method22415();
			local70 = (local4.method22413() & 0xFF) + 1;
			for (local72 = 0; local72 < local24; local72++) {
				local29[local72].anInt842 = local4.method22415();
			}
			for (local72 = 0; local72 < local24; local72++) {
				local29[local72].anInt844 = local4.method22415();
			}
			for (local72 = 0; local72 < local24; local72++) {
				local29[local72].anInt840 = local4.method22415();
			}
			for (local72 = 0; local72 < local24; local72++) {
				local29[local72].anInt841 = local4.method22415();
			}
			for (local72 = 0; local72 < local24; local72++) {
			...
			for (local178 = 1; local178 < local70; local178++) {
				local176[local178] = local4.method22417();
			...
			for (local178 = 0; local178 < local24; local178++) {
				...
				@Pc(235) int local235 = local4.method22413();
				@Pc(266) int local266;
				if ((local235 & 0x2) == 0) {
					@Pc(245) int local245;
					if ((local235 & 0x1) == 0) {
						for (local245 = 0; local245 < local227; local245++) {
							local221.aByteArray25[local245] = local4.method22414();
						}
					} else {
						for (local245 = 0; local245 < local221.anInt840; local245++) {
							for (local266 = 0; local266 < local221.anInt841; local266++) {
								local221.aByteArray25[local245 + local266 * local221.anInt840] = local4.method22414();
							}
						}
					}
				} else {
					...
					if ((local235 & 0x1) == 0) {
						for (local266 = 0; local266 < local227; local266++) {
							local221.aByteArray25[local266] = local4.method22414();
						}
						for (local266 = 0; local266 < local227; local266++) {
							@Pc(325) byte local325 = local221.aByteArray26[local266] = local4.method22414();
							local289 |= local325 != -1;
						}
					} else {
						@Pc(345) int local345;
						for (local266 = 0; local266 < local221.anInt840; local266++) {
							for (local345 = 0; local345 < local221.anInt841; local345++) {
								local221.aByteArray25[local266 + local345 * local221.anInt840] = local4.method22414();
							}
						}
						for (local266 = 0; local266 < local221.anInt840; local266++) {
							for (local345 = 0; local345 < local221.anInt841; local345++) {
								@Pc(391) byte local391 = local221.aByteArray26[local266 + local345 * local221.anInt840] = local4.method22414();
								local289 |= local391 != -1;
							}
						}
					}
			...
			local4.anInt3070 = 0;
			local31 = local4.method22413();
			if (local31 == 0) {
				@Pc(434) boolean local434 = local4.method22413() == 1;
				local70 = local4.method22415();
				local72 = local4.method22415();
				for (local178 = 0; local178 < local24; local178++) {
					@Pc(452) int[] local452 = new int[local70 * local72];
					for (local227 = 0; local227 < local70 * local72; local227++) {
						local452[local227] = local4.method22417() | 0xFF000000;
					...
					if (local434) {
						for (local227 = 0; local227 < local70 * local72; local227++) {
							...
							local452[local227] |= local4.method22413() << 24;
						}
					}
