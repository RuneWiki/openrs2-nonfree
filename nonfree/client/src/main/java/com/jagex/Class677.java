...
public class Class677 {
	...
	boolean method33225(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(4) Class312 local4 = Class124_Sub2.method9308(arg0, arg1, (byte) -14);
		if (local4 == null) {
			this.method33226(527430007);
			return false;
		} else {
			this.aClass320_4 = Class166_Sub1.aClass320Array1[arg0 >> 16];
			this.aClass312_13 = local4;
	...
	void method33226(@OriginalArg(0) int arg0) {
	...
	Class312 method33227() {
		return this.aClass320_4.method27228(this.aClass312_13.anInt3953 * -1549590237, -406199529);
	}

	@OriginalMember(owner = "client!ya", name = "e", descriptor = "(I)Lclient!hf;", line = 13)
	Class312 method33228(@OriginalArg(0) int arg0) {
		return this.aClass320_4.method27228(this.aClass312_13.anInt3953 * -1549590237, -188544182);
	}

	@OriginalMember(owner = "client!ya", name = "f", descriptor = "()Lclient!hf;", line = 13)
	Class312 method33229() {
		return this.aClass320_4.method27228(this.aClass312_13.anInt3953 * -1549590237, -550013923);
	}
