...
public class Class132_Sub1_Sub4_Sub1 extends Class132_Sub1_Sub4 implements Interface61 {
	...
	void method24303(@OriginalArg(0) Class104 arg0) {
		@Pc(8) Class109 local8 = this.aClass558_3.method31072(arg0, 262144, true, true, -2001466560);
		if (local8 != null) {
			...
			this.aClass558_3.method31073(arg0, local8, this.method24226(), local20, local20, local26, local26, false, (byte) 85);
		}
	}
	...
	boolean method24259(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		@Pc(4) Class610 local4 = this.aClass558_3.method31071((short) -7598);
		if (local4.aClass463_2 == null) {
			@Pc(27) Class109 local27 = this.aClass558_3.method31072(arg0, 131072, false, false, -1306946242);
			return local27 == null ? false : local27.method6859(arg1, arg2, this.method24226(), false, 0);
		} else {
			return arg0.method20490(arg1, arg2, this.method24226(), local4.aClass463_2, -1196618528);
		}
	}
	...
	public void method12961(@OriginalArg(0) Class620 arg0, @OriginalArg(1) int arg1) {
		this.aClass558_3.method31099(arg0, 1741540188);
	}
	...
	public boolean method13406(@OriginalArg(0) int arg0) {
		return this.aClass558_3.method31074((byte) 18);
	}
	...
	public void method13409(@OriginalArg(0) Class104 arg0, @OriginalArg(1) byte arg1) {
		this.aClass558_3.method31076(arg0, (byte) 100);
	}
	...
	public boolean method13415() {
		return this.aClass558_3.method31074((byte) -77);
	}
	...
	void method24294(@OriginalArg(0) Class104 arg0) {
		@Pc(8) Class109 local8 = this.aClass558_3.method31072(arg0, 262144, true, true, -1444145702);
		if (local8 != null) {
			@Pc(14) Class472 local14 = this.method24229().aClass472_61;
			@Pc(20) int local20 = (int) local14.aFloat317 >> 9;
			@Pc(26) int local26 = (int) local14.aFloat319 >> 9;
			this.aClass558_3.method31073(arg0, local8, this.method24226(), local20, local20, local26, local26, false, (byte) 97);
		}
	}
	...
	public void method13402(@OriginalArg(0) Class104 arg0) {
		this.aClass558_3.method31076(arg0, (byte) 12);
	}
	...
	void method24267(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class109 local8 = this.aClass558_3.method31072(arg0, 262144, true, true, -1104209393);
		if (local8 != null) {
			@Pc(14) Class472 local14 = this.method24229().aClass472_61;
			@Pc(20) int local20 = (int) local14.aFloat317 >> 9;
			@Pc(26) int local26 = (int) local14.aFloat319 >> 9;
			this.aClass558_3.method31073(arg0, local8, this.method24226(), local20, local20, local26, local26, false, (byte) 68);
		}
	}
	...
	public int method24282() {
		return this.aClass558_3.method31096(1349082800);
	}
	...
	public int method24285() {
		return this.aClass558_3.method31070(-306056706);
	}
	...
	Class573 method24271(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class109 local8 = this.aClass558_3.method31072(arg0, 2048, false, true, -1951434659);
		if (local8 == null) {
			return null;
		}
		@Pc(15) Class470 local15 = this.method24226();
		@Pc(18) Class458 local18 = this.method24229();
		@Pc(23) Class573 local23 = Class125_Sub1.method9214(this.aBoolean306, 373147274);
		@Pc(30) int local30 = (int) local18.aClass472_61.aFloat317 >> 9;
		@Pc(37) int local37 = (int) local18.aClass472_61.aFloat319 >> 9;
		this.aClass558_3.method31073(arg0, local8, local15, local30, local30, local37, local37, true, (byte) 66);
		@Pc(54) Class610 local54 = this.aClass558_3.method31071((short) 91);
		...
		if (this.aClass600_5 == null) {
			this.aClass600_5 = Class62.method1154((int) local18.aClass472_61.aFloat317, (int) local18.aClass472_61.aFloat318, (int) local18.aClass472_61.aFloat319, local8, 2131966572);
		} else {
	...
	Class573 method24266(@OriginalArg(0) Class104 arg0) {
		@Pc(8) Class109 local8 = this.aClass558_3.method31072(arg0, 2048, false, true, -1543190719);
		if (local8 == null) {
			return null;
		}
		@Pc(15) Class470 local15 = this.method24226();
		...
		@Pc(30) int local30 = (int) local18.aClass472_61.aFloat317 >> 9;
		@Pc(37) int local37 = (int) local18.aClass472_61.aFloat319 >> 9;
		this.aClass558_3.method31073(arg0, local8, local15, local30, local30, local37, local37, true, (byte) 116);
		@Pc(54) Class610 local54 = this.aClass558_3.method31071((short) 12320);
		if (local54.aClass463_2 == null) {
			local8.method6947(local15, this.aClass241Array21[0], 0);
		} else {
			local8.method6947(local15, (Class241) null, 0);
		...
		this.aBoolean307 = local8.method6865() || this.aClass558_3.aClass674_7 != null;
		if (this.aClass600_5 == null) {
			this.aClass600_5 = Class62.method1154((int) local18.aClass472_61.aFloat317, (int) local18.aClass472_61.aFloat318, (int) local18.aClass472_61.aFloat319, local8, 1754284810);
		} else {
	...
	public int method24289(@OriginalArg(0) byte arg0) {
		return this.aClass558_3.method31096(1982749337);
	}
	...
	boolean method24290(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(4) Class610 local4 = this.aClass558_3.method31071((short) 16678);
		if (local4.aClass463_2 == null) {
			@Pc(27) Class109 local27 = this.aClass558_3.method31072(arg0, 131072, false, false, 38817342);
			return local27 == null ? false : local27.method6859(arg1, arg2, this.method24226(), false, 0);
		} else {
			return arg0.method20490(arg1, arg2, this.method24226(), local4.aClass463_2, 2065111732);
		}
	}
	...
	public void method13424(@OriginalArg(0) Class104 arg0) {
		this.aClass558_3.method31076(arg0, (byte) -36);
	}
	...
	public void method12962(@OriginalArg(0) Class620 arg0) {
		this.aClass558_3.method31099(arg0, -1946385325);
	}
