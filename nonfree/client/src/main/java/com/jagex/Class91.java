...
public class Class91 {
	...
	public byte[] method1704(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(16) int local16 = local4.method22420((byte) -94);
	...
	public byte[] method1705(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class93_Sub41 local4 = new Class93_Sub41(arg0);
		local4.anInt3070 = (arg0.length - 4) * -1445626955;
		@Pc(16) int local16 = local4.method22420((byte) -125);
		@Pc(19) byte[] local19 = new byte[local16];
		local4.anInt3070 = 0;
		this.method1703(local4, local19, (short) 1043);
		return local19;
	...
	static void method1706(@OriginalArg(0) Class93_Sub1_Sub13 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		if (Class557.aClass297_1 != null) {
			arg2.aMap26.put(Class138.aClass138_70, Class557.aClass297_1.method26624(-1808813098));
		}
		boolean var9 = false;
		label130: {
			try {
				...
				Class361.method27804(arg2, local23, local190, "S", 433817837);
				var9 = false;
			} finally {
				if (var9) {
					Class624.method32156((byte) -49);
				}
			}
			Class624.method32156((byte) -40);
			return;
		}
		Class624.method32156((byte) -87);
	}
	...
	static final void method1708(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(2) int local2 = Class314.method26942(1054716290);
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = (Class166_Sub12.anInt2143 = Class51.aClass93_Sub36_1.aClass166_Sub4_2.method15424((byte) 87) * 1038066943) * -2067309825;
