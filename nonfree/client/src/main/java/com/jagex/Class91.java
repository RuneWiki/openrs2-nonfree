...
public class Class91 {
	...
	public byte[] method1704(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(16) int local16 = local4.method22420();
		@Pc(19) byte[] local19 = new byte[local16];
		local4.anInt3070 = 0;
		this.method1703(local4, local19);
		return local19;
	}
	...
	public void method1703(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte[] arg1) {
	...
	public static int method1710(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
	...
	static void method1706(@OriginalArg(0) Class93_Sub1_Sub13 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class681 arg2) {
		arg2.anInt5891 = 0;
		arg2.anInt5888 = 0;
		...
		if (arg2.aClass386_3 != null) {
			arg2.aMap26.put(Class138.aClass138_68, Class27.method589(arg2.aClass386_3));
		}
		...
		if (Class557.aClass297_1 != null) {
			arg2.aMap26.put(Class138.aClass138_70, Class557.aClass297_1.method26624());
		}
		try {
			...
			while (true) {
				...
				Class696.method36643(local23, arg2);
			}
		} catch (@Pc(190) Exception local190) {
			Class361.method27804(arg2, local23, local190, "S");
		} finally {
	...
	static final void method1708(@OriginalArg(0) Class681 arg0) {
		@Pc(2) int local2 = Class314.method26942();
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = (Class166_Sub12.anInt2143 = Class51.aClass93_Sub36_1.aClass166_Sub4_2.method15424() * 1038066943) * -2067309825;
