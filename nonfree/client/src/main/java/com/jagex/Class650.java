...
public class Class650 {
	...
	public Class650(@OriginalArg(0) Class497 arg0) {
		@Pc(9) byte[] local9 = arg0.method30059(Class649.aClass649_6.anInt5795 * -51136173, (byte) 19);
		if (local9 != null) {
	...
	static final void method32667(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static byte[] method32669(@OriginalArg(0) Class497 arg0, @OriginalArg(1) Class667 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg1.method32906(-557665170) > 1 ? arg0.method30044(arg1.method32907(arg2, 126261900), arg1.method32908(arg2, -2013658697), (byte) 0) : arg0.method30044(arg1.anInt5849 * -1772702343, arg2, (byte) 0);
	}
}
