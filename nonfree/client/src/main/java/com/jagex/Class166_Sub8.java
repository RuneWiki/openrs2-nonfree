...
public class Class166_Sub8 extends Class166 {
	...
	public void method15526(@OriginalArg(0) short arg0) {
		if (this.aClass93_Sub36_49.aClass166_Sub14_1.method15654(-544365892) == 0) {
			this.anInt2379 = 0;
		}
		if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 2) {
			this.anInt2379 = this.method16542((byte) 16) * -88839937;
		}
	}
	...
	public int method16543(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.aClass93_Sub36_49.aClass166_Sub14_1.method15654(-420657998) == 0 ? 3 : 1;
	}

	@OriginalMember(owner = "client!amh", name = "s", descriptor = "(I)Z", line = 29)
	public boolean method15527(@OriginalArg(0) int arg0) {
		return this.aClass93_Sub36_49.aClass166_Sub14_1.method15654(-899678357) != 0;
	}

	@OriginalMember(owner = "client!amh", name = "y", descriptor = "(S)I", line = 43)
	public int method15528(@OriginalArg(0) short arg0) {
	...
	public int method16540(@OriginalArg(0) int arg0) {
		return this.aClass93_Sub36_49.aClass166_Sub14_1.method15654(-172945371) == 0 ? 3 : 1;
	}
	...
	public int method16549(@OriginalArg(0) int arg0) {
		return this.aClass93_Sub36_49.aClass166_Sub14_1.method15654(-1168729040) == 0 ? 3 : 1;
	}
	...
	public void method15530() {
		if (this.aClass93_Sub36_49.aClass166_Sub14_1.method15654(-868413519) == 0) {
			this.anInt2379 = 0;
		}
		if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 2) {
			this.anInt2379 = this.method16542((byte) -25) * -88839937;
		}
	}

	@OriginalMember(owner = "client!amh", name = "x", descriptor = "()V", line = 20)
	public void method15531() {
		if (this.aClass93_Sub36_49.aClass166_Sub14_1.method15654(1837511243) == 0) {
			this.anInt2379 = 0;
		}
		if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 2) {
	...
	public boolean method15532() {
		return this.aClass93_Sub36_49.aClass166_Sub14_1.method15654(-1883443322) != 0;
	}
