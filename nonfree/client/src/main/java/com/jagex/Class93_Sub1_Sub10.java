...
public class Class93_Sub1_Sub10 extends Class93_Sub1 {
	...
	public boolean method21775(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.aClass236Array1[arg0].aBoolean660;
	}

	@OriginalMember(owner = "client!arr", name = "n", descriptor = "(I)Z", line = 25)
	public boolean method21776(@OriginalArg(0) int arg0) {
		...
		if (this.aByteArrayArray13 == null) {
			...
			synchronized (aClass497_94) {
				if (!aClass497_94.method30092(this.anInt3016 * 2053791993, 1017926793)) {
					return false;
				}
				@Pc(32) int[] local32 = aClass497_94.method30060(this.anInt3016 * 2053791993, (byte) 6);
				this.aByteArrayArray13 = new byte[local32.length][];
				for (@Pc(39) int local39 = 0; local39 < local32.length; local39++) {
					this.aByteArrayArray13[local39] = aClass497_94.method30044(this.anInt3016 * 2053791993, local32[local39], (byte) 0);
				}
			}
		}
		...
		for (@Pc(71) int local71 = 0; local71 < this.aByteArrayArray13.length; local71++) {
			...
			local93 = local86.method22415(-1434290800);
			@Pc(96) Class497 local96 = aClass497_95;
			synchronized (aClass497_95) {
				local69 &= aClass497_95.method30054(local93, -512225963);
			}
		}
		if (!local69) {
			return false;
		...
		@Pc(146) int[] local146;
		synchronized (aClass497_94) {
			local93 = aClass497_94.method30062(this.anInt3016 * 2053791993, 1723838491);
			this.aClass236Array1 = new Class236[local93];
			local146 = aClass497_94.method30060(this.anInt3016 * 2053791993, (byte) 25);
		}
		for (@Pc(156) int local156 = 0; local156 < local146.length; local156++) {
			...
			@Pc(177) int local177 = local170.method22415(-1434290800);
	...
	public static void method21780(@OriginalArg(0) Class497 arg0, @OriginalArg(1) Class497 arg1, @OriginalArg(2) int arg2) {
		aClass497_94 = arg0;
		aClass497_95 = arg1;
	}

	@OriginalMember(owner = "client!arr", name = "l", descriptor = "(Lclient!py;Lclient!py;I)V", line = 16)
	public static void method21781(@OriginalArg(0) Class497 arg0, @OriginalArg(1) Class497 arg1, @OriginalArg(2) int arg2) {
		aClass497_94 = arg0;
		aClass497_95 = arg1;
	}
	...
	public boolean method21782() {
		...
		if (this.aByteArrayArray13 == null) {
			@Pc(11) Class497 local11 = aClass497_94;
			synchronized (aClass497_94) {
				if (!aClass497_94.method30092(this.anInt3016 * 2053791993, -849220141)) {
					return false;
				}
				@Pc(32) int[] local32 = aClass497_94.method30060(this.anInt3016 * 2053791993, (byte) 118);
				this.aByteArrayArray13 = new byte[local32.length][];
				for (@Pc(39) int local39 = 0; local39 < local32.length; local39++) {
					this.aByteArrayArray13[local39] = aClass497_94.method30044(this.anInt3016 * 2053791993, local32[local39], (byte) 0);
				}
		...
		@Pc(146) int[] local146;
		synchronized (aClass497_94) {
			local93 = aClass497_94.method30062(this.anInt3016 * 2053791993, -54099617);
			this.aClass236Array1 = new Class236[local93];
			local146 = aClass497_94.method30060(this.anInt3016 * 2053791993, (byte) 64);
		}
		for (@Pc(156) int local156 = 0; local156 < local146.length; local156++) {
			@Pc(165) byte[] local165 = this.aByteArrayArray13[local156];
			@Pc(170) Class93_Sub41 local170 = new Class93_Sub41(local165);
			...
			if (local179 == null) {
				@Pc(208) Class497 local208 = aClass497_95;
				synchronized (aClass497_95) {
					local179 = new Class93_Sub25(local177, aClass497_95.method30059(local177, (byte) 59));
				}
