...
public abstract class Class108 implements Interface12 {
	...
	boolean method7437(@OriginalArg(0) byte arg0) {
	...
	public void method36654(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
		while (true) {
			...
			@Pc(14) Class252 local14 = (Class252) Class107.method18119(Class112_Sub2.method23761(-1497248091), local3, -1915563430);
			if (local14 == null) {
				...
				switch(local14.anInt3846 * -272738995) {
					case 0:
						...
						break;
					case 1:
						@Pc(50) int local50 = arg0.method22413((short) 16384);
						this.aClass519_6 = (Class519) Class107.method18119(Class519.method30312(2041400837), local50, -1915563430);
						if (this.aClass519_6 != null) {
							break;
						}
						throw new IllegalStateException("");
					case 2:
						arg0.method22428(67383654);
						break;
					case 3:
						Class107.method18119(Class420.method28744(804770315), arg0.method22413((short) 16384), -1915563430);
						break;
					case 4:
					default:
						throw new IllegalStateException("");
					case 5:
						break;
					case 6:
						this.aClass507_3 = (Class507) Class107.method18119(Class174.method24346((byte) 84), arg0.method22413((short) 16384), -1915563430);
				}
			}
		}
	}
		...
		while (true) {
			...
			if (local14 == null) {
				...
				switch(local14.anInt3846 * -272738995) {
					...
					case 1:
						@Pc(50) int local50 = arg0.method22413((short) 16384);
						this.aClass519_6 = (Class519) Class107.method18119(Class519.method30312(1623296093), local50, -1915563430);
						if (this.aClass519_6 != null) {
							break;
						}
						throw new IllegalStateException("");
					case 2:
						arg0.method22428(1136815077);
						break;
					case 3:
						Class107.method18119(Class420.method28744(2022493064), arg0.method22413((short) 16384), -1915563430);
						break;
					case 4:
					default:
						throw new IllegalStateException("");
					case 5:
						break;
					case 6:
						this.aClass507_3 = (Class507) Class107.method18119(Class174.method24346((byte) 49), arg0.method22413((short) 16384), -1915563430);
				}
			}
		}
	}
		...
		while (true) {
			...
			if (local14 == null) {
				...
				switch(local14.anInt3846 * -272738995) {
					...
					case 1:
						@Pc(50) int local50 = arg0.method22413((short) 16384);
						this.aClass519_6 = (Class519) Class107.method18119(Class519.method30312(1533022602), local50, -1915563430);
						if (this.aClass519_6 != null) {
							break;
						}
						throw new IllegalStateException("");
					case 2:
						arg0.method22428(887597660);
						break;
					case 3:
						Class107.method18119(Class420.method28744(241420107), arg0.method22413((short) 16384), -1915563430);
						break;
					case 4:
					default:
						throw new IllegalStateException("");
					case 5:
						break;
					case 6:
						this.aClass507_3 = (Class507) Class107.method18119(Class174.method24346((byte) 66), arg0.method22413((short) 16384), -1915563430);
				}
			}
		}
	}
	...
	public Object method7438(@OriginalArg(0) byte arg0) {
		...
		while (true) {
			...
			if (local14 == null) {
				...
				switch(local14.anInt3846 * -272738995) {
					...
					case 1:
						@Pc(50) int local50 = arg0.method22413((short) 16384);
						this.aClass519_6 = (Class519) Class107.method18119(Class519.method30312(1403388839), local50, -1915563430);
						if (this.aClass519_6 != null) {
							break;
						}
						throw new IllegalStateException("");
					case 2:
						arg0.method22428(-1074649851);
						break;
					case 3:
						Class107.method18119(Class420.method28744(1244045918), arg0.method22413((short) 16384), -1915563430);
						break;
					case 4:
					default:
						throw new IllegalStateException("");
					case 5:
						break;
					case 6:
						this.aClass507_3 = (Class507) Class107.method18119(Class174.method24346((byte) 10), arg0.method22413((short) 16384), -1915563430);
				}
			}
		}
	}
		...
		while (true) {
			...
			if (local14 == null) {
				...
				switch(local14.anInt3846 * -272738995) {
					...
					case 1:
						@Pc(50) int local50 = arg0.method22413((short) 16384);
						this.aClass519_6 = (Class519) Class107.method18119(Class519.method30312(1223585481), local50, -1915563430);
						if (this.aClass519_6 != null) {
							break;
						}
						throw new IllegalStateException("");
					case 2:
						arg0.method22428(-771464017);
						break;
					case 3:
						Class107.method18119(Class420.method28744(1624563297), arg0.method22413((short) 16384), -1915563430);
						break;
					case 4:
					default:
						throw new IllegalStateException("");
					case 5:
						break;
					case 6:
						this.aClass507_3 = (Class507) Class107.method18119(Class174.method24346((byte) 79), arg0.method22413((short) 16384), -1915563430);
				}
			}
		}
	}
	...
	static final void method7448(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		Class51.aClass93_Sub36_1.method14357(Class51.aClass93_Sub36_1.aClass166_Sub36_1, arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091], (byte) 69);
		Class106_Sub1.method5148(-2005793118);
		client.aBoolean601 = false;
	}

	@OriginalMember(owner = "client!ec", name = "avw", descriptor = "(Lclient!yf;I)V", line = 13505)
	static final void method7449(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method7451(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
