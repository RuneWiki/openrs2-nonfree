...
public class Class93_Sub42 extends Class93 {
			...
			try {
				...
				if (local443 != null && local443.length % 5 == 0) {
					...
					if (local524 != null) {
						...
						local531.method22396(local524.anInt119 * 1396359751);
						local531.method22396(local524.anInt122 * -762512765);
						local531.method22396(local524.anInt121 * -407508469);
						local531.anInt3070 = 0;
						this.aString55 = local531.method22427();
					}
					...
					for (local493 = -2147483646; local493 <= -2147483644; local493++) {
						...
						if (local636 != null) {
							local625.method22396(local636.anInt118 * 233985593);
							local625.method22396(local636.anInt119 * 1396359751);
							local625.method22396(local636.anInt121 * -407508469);
							local625.method22396(local636.anInt122 * -762512765);
						}
					}
					local625.anInt3070 = 0;
					this.aString56 = local625.method22427();
				}
	...
	public void method15296(@OriginalArg(0) Class93_Sub41 arg0) {
		arg0.method22510(8);
		arg0.method22510(this.anInt2058 * 2065137227);
		arg0.method22510(this.aBoolean362 ? 1 : 0);
		arg0.method22454(this.anInt2041 * -2131463025);
		arg0.method22510(this.anInt2047 * -1974110959);
		arg0.method22510(this.anInt2045 * -2102924425);
		arg0.method22510(this.anInt2049 * 1127818643);
		arg0.method22510(this.anInt2036 * -1691907005);
		arg0.method22510(this.aBoolean363 ? 1 : 0);
		arg0.method22454(this.anInt2023 * -1954378101);
		arg0.method22510(this.anInt2053 * -1871990631);
		arg0.method22394(this.anInt2055 * 714183489);
		arg0.method22454(this.anInt2056 * 1094433601);
		arg0.method22403(this.aString52);
		arg0.method22403(this.aString57);
		arg0.method22403(this.aString53);
		arg0.method22403(this.aString54);
		arg0.method22510(this.anInt2060 * -1138260491);
		arg0.method22454(this.anInt2059 * 856968677);
		arg0.method22403(this.aString55);
		arg0.method22403(this.aString56);
		arg0.method22510(this.anInt2033 * -66714701);
		arg0.method22510(this.anInt2062 * 1212306539);
		for (@Pc(151) int local151 = 0; local151 < this.anIntArray199.length; local151++) {
			arg0.method22395(this.anIntArray199[local151]);
		}
		arg0.method22395(this.anInt2063 * 728684047);
		arg0.method22403(this.aString51);
	}

	@OriginalMember(owner = "client!aly", name = "n", descriptor = "(Lclient!alw;I)V", line = 262)
	public void method15298(@OriginalArg(0) Class93_Sub41 arg0) {
		arg0.method22510(8);
		arg0.method22510(this.anInt2058 * 2065137227);
		arg0.method22510(this.aBoolean362 ? 1 : 0);
		arg0.method22454(this.anInt2041 * -2131463025);
	...
	public int method15299() {
		@Pc(1) byte local1 = 39;
		@Pc(8) int local8 = local1 + Class582.method31414(this.aString52);
		@Pc(15) int local15 = local8 + Class582.method31414(this.aString57);
		@Pc(22) int local22 = local15 + Class582.method31414(this.aString53);
		@Pc(29) int local29 = local22 + Class582.method31414(this.aString54);
		@Pc(36) int local36 = local29 + Class582.method31414(this.aString55);
		@Pc(43) int local43 = local36 + Class582.method31414(this.aString56);
		return local43 + Class582.method31414(this.aString51);
	}
}
