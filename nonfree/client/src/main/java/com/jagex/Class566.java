...
public class Class566 {
	...
	public static int method31256() {
		...
		@Pc(22) long local22 = Class305.method26796(1743154666);
		@Pc(24) int local24;
		for (local24 = 0; local24 < 10000; local24++) {
			local19.method20851(5, 10, 100.0F, 75, 50, 100.0F, 15, 90, 100.0F, -65536, -65536, -65536, 1);
		}
		local24 = (int) (Class305.method26796(912745247) - local22);
		local19.method20600(0, 0, 100, 100, -16777216, (byte) 81);
		local19.method20877(-574234102);
		return local24;
	}
	...
	static final void method31257(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
	...
	static int method31258(@OriginalArg(0) Class132_Sub1_Sub1_Sub1_Sub1 arg0, @OriginalArg(1) int arg1) {
		@Pc(2) Class336 local2 = arg0.aClass336_1;
		if (local2.anIntArray412 != null) {
			local2 = local2.method27423(Class624.aClass120_1, Class624.aClass120_1, (short) 18848);
			if (local2 == null) {
				return -1;
			}
		}
		@Pc(22) int local22 = local2.anInt4172 * -374268759;
		@Pc(26) Class622 local26 = arg0.method19966(1585179025);
