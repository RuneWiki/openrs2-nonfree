...
public class Class642 implements Interface75 {
	...
	static final void method32518(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
		...
		arg0.anObjectArray11 = Class499.method30148(local13, arg2, 1638720166);
		arg0.aBoolean680 = true;
	}

	@OriginalMember(owner = "client!wo", name = "ako", descriptor = "(Lclient!yf;B)V", line = 11515)
	static final void method32519(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method32520(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		if (local12 != Class51.aClass93_Sub36_1.aClass166_Sub31_1.method16108((short) 8834)) {
	...
	public static void method32521(@OriginalArg(0) byte arg0) {
		...
		Class51.aClass93_Sub36_1.method14357(Class51.aClass93_Sub36_1.aClass166_Sub12_1, Class332.aClass332_6.anInt4147 * 595334117, (byte) 73);
		...
		Class610.method32021(-1918309609);
		client.aClass532_1.method30532((byte) 33).method33003(1628233714);
		client.aBoolean609 = true;
	}

	@OriginalMember(owner = "client!wo", name = "fp", descriptor = "(ZS)V", line = 2557)
	public static final void method32522(@OriginalArg(0) boolean arg0, @OriginalArg(1) short arg1) {
		...
		for (@Pc(3) int local3 = 0; local3 < local1.length; local3++) {
			...
			try {
				local11.method24350((byte) 95);
			} catch (@Pc(16) IOException local16) {
			}
			local11.method24355((byte) 123);
		}
		Class594.method31740(1244534845);
		Class12.method187(-1516713678);
		Class700.method36716(false, (byte) 5);
		client.aClass532_1.method30463((byte) 66);
		client.aClass532_1.method30462((byte) -91);
		client.aClass532_1.method30446(-1602017739);
		Class47.method957((byte) -101);
		Class310.method26831(-1797323310);
		Class707.method36752(true, (byte) 1);
		Class431.method28782((byte) 72);
		Class634.method32321(8457347);
	...
	public static boolean method32523(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2) {
