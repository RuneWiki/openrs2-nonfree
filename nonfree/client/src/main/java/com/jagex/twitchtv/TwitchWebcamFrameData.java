...
public class TwitchWebcamFrameData {
	...
	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchWebcamFrameData", name = "p", descriptor = "()V", line = 33)
	public void p() {
		for (@Pc(4) int local4 = this.height - 1; local4 >= 0; local4--) {
			@Pc(11) int local11 = this.width * local4;
			@Pc(18) int local18 = this.width * (local4 + 1);
	...
	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchWebcamFrameData", name = "v", descriptor = "()V", line = 33)
	public void v() {
		for (@Pc(4) int local4 = this.height - 1; local4 >= 0; local4--) {
			@Pc(11) int local11 = this.width * local4;
			@Pc(18) int local18 = this.width * (local4 + 1);
	...
	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchWebcamFrameData", name = "c", descriptor = "()V", line = 48)
	public void c() {
	...
	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchWebcamFrameData", name = "l", descriptor = "()V", line = 48)
	public void l() {
		for (@Pc(6) int local6 = (this.height >> 1) - 1; local6 >= 0; local6--) {
			@Pc(13) int local13 = this.width * local6;
			@Pc(23) int local23 = (this.height - local6 - 1) * this.width;
