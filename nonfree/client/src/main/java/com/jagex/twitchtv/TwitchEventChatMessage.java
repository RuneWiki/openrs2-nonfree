...
public class TwitchEventChatMessage extends TwitchEvent {
	...
	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchEventChatMessage", name = "y", descriptor = "([I[J[Ljava/lang/Object;)V", line = 40)
	@Override
	...
	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchEventChatMessage", name = "w", descriptor = "([I[J[Ljava/lang/Object;)V", line = 40)
	@Override
	...
	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchEventChatMessage", name = "t", descriptor = "([I[J[Ljava/lang/Object;)V", line = 40)
	@Override
	...
	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchEventChatMessage", name = "c", descriptor = "()Lclient!uy;", line = 45)
	@Override
	public Class587 c() {
		return Class587.aClass587_4;
	}

	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchEventChatMessage", name = "v", descriptor = "()Lclient!uy;", line = 45)
	@Override
	public Class587 v() {
		return Class587.aClass587_4;
	}

	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchEventChatMessage", name = "l", descriptor = "()Lclient!uy;", line = 45)
	@Override
	public Class587 l() {
		return Class587.aClass587_4;
	}
