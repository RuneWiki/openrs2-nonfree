...
public class TwitchEventChatUserInfo extends TwitchEvent {
	...
	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchEventChatUserInfo", name = "c", descriptor = "()Lclient!uy;", line = 40)
	@Override
	public Class587 c() {
		return null;
	}

	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchEventChatUserInfo", name = "v", descriptor = "()Lclient!uy;", line = 40)
	@Override
	public Class587 v() {
		return null;
	}

	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchEventChatUserInfo", name = "l", descriptor = "()Lclient!uy;", line = 40)
	@Override
	public Class587 l() {
		return null;
	}
	...
	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchEventChatUserInfo", name = "y", descriptor = "([I[J[Ljava/lang/Object;)V", line = 43)
	@Override
	public void y(@OriginalArg(0) int[] arg0, @OriginalArg(1) long[] arg1, @OriginalArg(2) Object[] arg2) {
	}

	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchEventChatUserInfo", name = "w", descriptor = "([I[J[Ljava/lang/Object;)V", line = 43)
	@Override
	public void w(@OriginalArg(0) int[] arg0, @OriginalArg(1) long[] arg1, @OriginalArg(2) Object[] arg2) {
	}

	@OriginalMember(owner = "client!com/jagex/twitchtv/TwitchEventChatUserInfo", name = "t", descriptor = "([I[J[Ljava/lang/Object;)V", line = 43)
	@Override
