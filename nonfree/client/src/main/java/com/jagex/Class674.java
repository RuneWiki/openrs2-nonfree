...
public class Class674 {
	...
	Class674(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		this.method33091(arg0, arg1);
	}

	@OriginalMember(owner = "client!xy", name = "n", descriptor = "(IZ)V", line = 44)
	void method33091(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		Class701.aList26.add(this);
		this.aLong305 = (long) arg0;
		this.aLong306 = (long) arg0;
		this.aBoolean873 = true;
		this.aBoolean871 = arg1;
	}

	@OriginalMember(owner = "client!xy", name = "m", descriptor = "()V", line = 52)
	public void method33092() {
		this.aBoolean873 = true;
	}

	@OriginalMember(owner = "client!xy", name = "ap", descriptor = "(IIIII)V", line = 217)
	public void method33093(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		this.anInt5878 = arg0;
	}

	@OriginalMember(owner = "client!xy", name = "f", descriptor = "()V", line = 77)
	public void method33094() {
	...
	boolean method33096(@OriginalArg(0) Class104 arg0, @OriginalArg(1) long arg1) {
		...
		if (this.aBoolean873) {
			...
			while (local34.hasNext()) {
				...
				for (@Pc(43) int local43 = 0; local43 < local41.aClass439_1.anInt4825 * 1691524467; local43++) {
					local41.method32873(arg0, arg1, 1, !this.aBoolean872, 1394883906);
				}
			}
		...
		while (local34.hasNext()) {
			local41 = (Class664) local34.next();
			local41.method32873(arg0, arg1, local27, !this.aBoolean872, 1535924329);
		}
		this.aLong306 = arg1;
		return true;
	}
	...
	public void method33097(@OriginalArg(0) long arg0) {
		this.aLong305 = arg0;
	}

	@OriginalMember(owner = "client!xy", name = "z", descriptor = "(Lclient!dh;J[Lclient!du;[Lclient!cq;Z)V", line = 118)
	public void method33098(@OriginalArg(0) Class104 arg0, @OriginalArg(1) long arg1, @OriginalArg(2) Class234[] arg2, @OriginalArg(3) Class210[] arg3, @OriginalArg(4) boolean arg4) {
		if (!this.aBoolean870) {
			this.method33099(arg0, arg2, arg4);
			this.method33100(arg3, arg4);
			this.aLong305 = arg1;
		}
	}

	@OriginalMember(owner = "client!xy", name = "p", descriptor = "(Lclient!dh;[Lclient!du;Z)V", line = 125)
	void method33099(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class234[] arg1, @OriginalArg(2) boolean arg2) {
	...
	void method33100(@OriginalArg(0) Class210[] arg0, @OriginalArg(1) boolean arg1) {
		@Pc(1) int local1;
			...
			if (arg0 != null) {
				for (local1 = 0; local1 < arg0.length && local1 != 16 && this.anInt5876 != 16; local1++) {
					if (!aBooleanArray35[local1]) {
						local21 = null;
						if (arg0[local1].method25411(Class110_Sub15_Sub2.anInterface47_1, (byte) 69).anInt4792 * -1789015339 == 1 && Class663.anInt5833 * 91031243 < 32) {
							local21 = new Class93_Sub12(arg0[local1], this);
							Class663.aClass16_39.method221(local21, (long) (arg0[local1].anInt3595 * -1159348331));
							Class663.anInt5833 += 1165995747;
						}
						if (local21 == null) {
							local21 = new Class93_Sub12(arg0[local1], this);
	...
	boolean method33102(@OriginalArg(0) Class104 arg0, @OriginalArg(1) long arg1) {
		if (this.aLong305 == this.aLong306) {
			this.method33108();
		} else {
			this.method33094();
		...
		if (this.aBoolean873) {
			...
			while (local34.hasNext()) {
				local41 = (Class664) local34.next();
				for (@Pc(43) int local43 = 0; local43 < local41.aClass439_1.anInt4825 * 1691524467; local43++) {
					local41.method32873(arg0, arg1, 1, !this.aBoolean872, -477057954);
				}
			}
			this.aBoolean873 = false;
		}
		...
		while (local34.hasNext()) {
			local41 = (Class664) local34.next();
			local41.method32873(arg0, arg1, local27, !this.aBoolean872, -938332926);
		}
		this.aLong306 = arg1;
		return true;
	}
	...
	void method33103(@OriginalArg(0) Class585 arg0, @OriginalArg(1) Class104 arg1) {
		...
		while (local8.hasNext()) {
			...
			local15.method32874(arg0, arg1, this.aLong306);
		}
	}

	@OriginalMember(owner = "client!xy", name = "a", descriptor = "()V", line = 52)
	public void method33104() {
		this.aBoolean873 = true;
	}

	@OriginalMember(owner = "client!xy", name = "s", descriptor = "(IZ)Lclient!xy;", line = 29)
	public static Class674 method33105(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		if (Class663.anInt5831 * 779180177 == Class663.anInt5832 * -1097527665) {
			...
			local12.method33091(arg0, arg1);
			return local12;
		}
	}

	@OriginalMember(owner = "client!xy", name = "y", descriptor = "(IZ)V", line = 44)
	void method33106(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		Class701.aList26.add(this);
		this.aLong305 = (long) arg0;
		this.aLong306 = (long) arg0;
		this.aBoolean873 = true;
	...
	void method33107(@OriginalArg(0) Class210[] arg0, @OriginalArg(1) boolean arg1) {
		@Pc(1) int local1;
		for (local1 = 0; local1 < 16; local1++) {
			aBooleanArray35[local1] = false;
		}
		...
		while (true) {
			...
			if (arg0 != null) {
				for (local1 = 0; local1 < arg0.length && local1 != 16 && this.anInt5876 != 16; local1++) {
					if (!aBooleanArray35[local1]) {
						local21 = null;
						if (arg0[local1].method25411(Class110_Sub15_Sub2.anInterface47_1, (byte) 29).anInt4792 * -1789015339 == 1 && Class663.anInt5833 * 91031243 < 32) {
							local21 = new Class93_Sub12(arg0[local1], this);
							Class663.aClass16_39.method221(local21, (long) (arg0[local1].anInt3595 * -1159348331));
							Class663.anInt5833 += 1165995747;
						}
	...
	void method33112() {
		...
		for (@Pc(26) int local26 = 0; local26 < this.aClass149_Sub4_Sub1_Sub1Array2.length; local26++) {
			if (this.aClass149_Sub4_Sub1_Sub1Array2[local26] != null) {
				this.aClass149_Sub4_Sub1_Sub1Array2[local26].method23780();
	...
	public void method33114(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		this.anInt5878 = arg0;
	}

	@OriginalMember(owner = "client!xy", name = "t", descriptor = "(Lclient!dh;J)Z", line = 85)
	boolean method33115(@OriginalArg(0) Class104 arg0, @OriginalArg(1) long arg1) {
		if (this.aLong305 == this.aLong306) {
			this.method33108();
		} else {
			this.method33094();
		...
		if (this.aBoolean873) {
			...
			while (local34.hasNext()) {
				local41 = (Class664) local34.next();
				for (@Pc(43) int local43 = 0; local43 < local41.aClass439_1.anInt4825 * 1691524467; local43++) {
					local41.method32873(arg0, arg1, 1, !this.aBoolean872, -376740478);
				}
			}
			this.aBoolean873 = false;
		}
		...
		while (local34.hasNext()) {
			local41 = (Class664) local34.next();
			local41.method32873(arg0, arg1, local27, !this.aBoolean872, -146471139);
		}
		this.aLong306 = arg1;
		return true;
	}
	...
	boolean method33116(@OriginalArg(0) Class104 arg0, @OriginalArg(1) long arg1) {
		if (this.aLong305 == this.aLong306) {
			this.method33108();
		} else {
			this.method33094();
		...
		if (this.aBoolean873) {
			...
			while (local34.hasNext()) {
				local41 = (Class664) local34.next();
				for (@Pc(43) int local43 = 0; local43 < local41.aClass439_1.anInt4825 * 1691524467; local43++) {
					local41.method32873(arg0, arg1, 1, !this.aBoolean872, 1323820608);
				}
			}
			this.aBoolean873 = false;
		}
		...
		while (local34.hasNext()) {
			local41 = (Class664) local34.next();
			local41.method32873(arg0, arg1, local27, !this.aBoolean872, -1842272594);
		}
		this.aLong306 = arg1;
		return true;
	}
	...
	boolean method33117(@OriginalArg(0) Class104 arg0, @OriginalArg(1) long arg1) {
		if (this.aLong305 == this.aLong306) {
			this.method33108();
		} else {
			this.method33094();
		...
		if (this.aBoolean873) {
			...
			while (local34.hasNext()) {
				local41 = (Class664) local34.next();
				for (@Pc(43) int local43 = 0; local43 < local41.aClass439_1.anInt4825 * 1691524467; local43++) {
					local41.method32873(arg0, arg1, 1, !this.aBoolean872, -1207838644);
				}
			}
			this.aBoolean873 = false;
		}
		...
		while (local34.hasNext()) {
			local41 = (Class664) local34.next();
			local41.method32873(arg0, arg1, local27, !this.aBoolean872, -707383505);
		}
		this.aLong306 = arg1;
		return true;
	}
	...
	public void method33118(@OriginalArg(0) long arg0) {
		this.aLong305 = arg0;
	}

	@OriginalMember(owner = "client!xy", name = "al", descriptor = "(J)V", line = 114)
	public void method33119(@OriginalArg(0) long arg0) {
		this.aLong305 = arg0;
	}

	@OriginalMember(owner = "client!xy", name = "ac", descriptor = "(Lclient!dh;J[Lclient!du;[Lclient!cq;Z)V", line = 118)
	public void method33120(@OriginalArg(0) Class104 arg0, @OriginalArg(1) long arg1, @OriginalArg(2) Class234[] arg2, @OriginalArg(3) Class210[] arg3, @OriginalArg(4) boolean arg4) {
		if (!this.aBoolean870) {
			this.method33099(arg0, arg2, arg4);
			this.method33100(arg3, arg4);
			this.aLong305 = arg1;
	...
	void method33121(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class234[] arg1, @OriginalArg(2) boolean arg2) {
		for (@Pc(1) int local1 = 0; local1 < 64; local1++) {
			aBooleanArray34[local1] = false;
		}
		@Pc(14) Iterator local14 = this.aList25.iterator();
		...
		while (true) {
			...
			if (arg0 != null) {
				for (local1 = 0; local1 < arg0.length && local1 != 16 && this.anInt5876 != 16; local1++) {
					if (!aBooleanArray35[local1]) {
						local21 = null;
						if (arg0[local1].method25411(Class110_Sub15_Sub2.anInterface47_1, (byte) 4).anInt4792 * -1789015339 == 1 && Class663.anInt5833 * 91031243 < 32) {
							local21 = new Class93_Sub12(arg0[local1], this);
							Class663.aClass16_39.method221(local21, (long) (arg0[local1].anInt3595 * -1159348331));
							Class663.anInt5833 += 1165995747;
						}
	...
	void method33123(@OriginalArg(0) Class210[] arg0, @OriginalArg(1) boolean arg1) {
		@Pc(1) int local1;
		for (local1 = 0; local1 < 16; local1++) {
			aBooleanArray35[local1] = false;
		}
		...
		while (true) {
			...
			if (arg0 != null) {
				for (local1 = 0; local1 < arg0.length && local1 != 16 && this.anInt5876 != 16; local1++) {
					if (!aBooleanArray35[local1]) {
						local21 = null;
						if (arg0[local1].method25411(Class110_Sub15_Sub2.anInterface47_1, (byte) 59).anInt4792 * -1789015339 == 1 && Class663.anInt5833 * 91031243 < 32) {
							local21 = new Class93_Sub12(arg0[local1], this);
							Class663.aClass16_39.method221(local21, (long) (arg0[local1].anInt3595 * -1159348331));
							Class663.anInt5833 += 1165995747;
						}
	...
	public static Class674 method33124(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		if (Class663.anInt5831 * 779180177 == Class663.anInt5832 * -1097527665) {
			return new Class674(arg0, arg1);
		} else {
			@Pc(12) Class674 local12 = Class296.aClass674Array1[Class663.anInt5832 * -1097527665];
	...
	void method33126(@OriginalArg(0) Class210[] arg0, @OriginalArg(1) boolean arg1) {
		@Pc(1) int local1;
		for (local1 = 0; local1 < 16; local1++) {
			aBooleanArray35[local1] = false;
		}
		...
		while (true) {
			...
			if (arg0 != null) {
				for (local1 = 0; local1 < arg0.length && local1 != 16 && this.anInt5876 != 16; local1++) {
					if (!aBooleanArray35[local1]) {
						local21 = null;
						if (arg0[local1].method25411(Class110_Sub15_Sub2.anInterface47_1, (byte) 105).anInt4792 * -1789015339 == 1 && Class663.anInt5833 * 91031243 < 32) {
							local21 = new Class93_Sub12(arg0[local1], this);
							Class663.aClass16_39.method221(local21, (long) (arg0[local1].anInt3595 * -1159348331));
							Class663.anInt5833 += 1165995747;
						}
	...
	void method33129(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		Class701.aList26.add(this);
		this.aLong305 = (long) arg0;
		this.aLong306 = (long) arg0;
		this.aBoolean873 = true;
	...
	void method33131(@OriginalArg(0) Class585 arg0, @OriginalArg(1) Class104 arg1) {
	...
	void method33133(@OriginalArg(0) Class210[] arg0, @OriginalArg(1) boolean arg1) {
		@Pc(1) int local1;
		for (local1 = 0; local1 < 16; local1++) {
			aBooleanArray35[local1] = false;
		}
		...
		while (true) {
			...
			if (arg0 != null) {
				for (local1 = 0; local1 < arg0.length && local1 != 16 && this.anInt5876 != 16; local1++) {
					if (!aBooleanArray35[local1]) {
						local21 = null;
						if (arg0[local1].method25411(Class110_Sub15_Sub2.anInterface47_1, (byte) -33).anInt4792 * -1789015339 == 1 && Class663.anInt5833 * 91031243 < 32) {
							local21 = new Class93_Sub12(arg0[local1], this);
							Class663.aClass16_39.method221(local21, (long) (arg0[local1].anInt3595 * -1159348331));
							Class663.anInt5833 += 1165995747;
						}
