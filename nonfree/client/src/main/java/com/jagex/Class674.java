...
public class Class674 {
	...
	boolean method33096(@OriginalArg(0) Class104 arg0, @OriginalArg(1) long arg1) {
		...
		if (this.aBoolean873) {
			...
			while (local34.hasNext()) {
				...
				for (@Pc(43) int local43 = 0; local43 < local41.aClass439_1.anInt4825 * 1691524467; local43++) {
					local41.method32873(arg0, arg1, 1, !this.aBoolean872);
				}
			}
		...
		while (local34.hasNext()) {
			local41 = (Class664) local34.next();
			local41.method32873(arg0, arg1, local27, !this.aBoolean872);
		}
		this.aLong306 = arg1;
		return true;
	}
			...
			if (arg0 != null) {
				for (local1 = 0; local1 < arg0.length && local1 != 16 && this.anInt5876 != 16; local1++) {
					if (!aBooleanArray35[local1]) {
						local21 = null;
						if (arg0[local1].method25411(Class110_Sub15_Sub2.anInterface47_1).anInt4792 * -1789015339 == 1 && Class663.anInt5833 * 91031243 < 32) {
	...
	public Class229 method33101() {
		this.aClass229_1.aClass8_1.method134();
		for (@Pc(6) int local6 = 0; local6 < this.aClass149_Sub4_Sub1_Sub1Array2.length; local6++) {
			if (this.aClass149_Sub4_Sub1_Sub1Array2[local6] != null && this.aClass149_Sub4_Sub1_Sub1Array2[local6].aClass664_1 != null) {
				this.aClass229_1.aClass8_1.method125(this.aClass149_Sub4_Sub1_Sub1Array2[local6]);
			}
		}
	...
	public void method33093(@OriginalArg(0) int arg0) {
		this.anInt5878 = arg0;
	}

	@OriginalMember(owner = "client!xy", name = "aq", descriptor = "(IIIII)V", line = 217)
	public void method33114(@OriginalArg(0) int arg0) {
		this.anInt5878 = arg0;
	}
	...
	public void method33128(@OriginalArg(0) int arg0) {
		this.anInt5878 = arg0;
	}
