...
public class Class120 implements Interface23, Interface21, Interface71 {
	...
	public int method8655(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		return this.aClass675Array1[arg0].method33140(client.aBoolean620 ? Class718.aClass718_1 : Class718.aClass718_2, (byte) 11);
	}
	...
	public int method8654(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.aClass675Array1[arg0].method33135(client.aBoolean620 ? Class718.aClass718_1 : Class718.aClass718_2, (byte) 72);
	}
	...
	public int method8665(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		return this.aClass675Array1[arg0].method33138(1140995892);
	}
	...
	public int method8666(@OriginalArg(0) int arg0) {
		return this.aClass675Array1[arg0].method33152(-688939384);
	}

	@OriginalMember(owner = "client!ah", name = "y", descriptor = "(I)I", line = 37)
	@Override
	public int method8653(@OriginalArg(0) int arg0) {
		return this.aClass675Array1[arg0].method33135(client.aBoolean620 ? Class718.aClass718_1 : Class718.aClass718_2, (byte) 57);
	}
	...
	public int method8667(@OriginalArg(0) int arg0) {
		return this.aClass675Array1[arg0].method33138(-115349822);
	}

	@OriginalMember(owner = "client!ah", name = "g", descriptor = "(I)I", line = 45)
	public int method8668(@OriginalArg(0) int arg0) {
		return this.aClass675Array1[arg0].method33138(1429391622);
	}
	...
	public int method8669(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.aClass675Array1[arg0].method33146((byte) 125);
	}

	@OriginalMember(owner = "client!ah", name = "h", descriptor = "(I)I", line = 45)
	public int method8670(@OriginalArg(0) int arg0) {
		return this.aClass675Array1[arg0].method33138(780545188);
	}
	...
	static final void method8672(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		Class447.aClass447_1.method28904(-2137156690);
	}
	...
	static final void method8673(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		if (local13 == 99) {
			...
			Class227.method25614(local13, local23, "", "", "", local37, (Class443) null, -1862603888);
		}
	}
}
