...
class Class61 implements Iterator {
	...
	public static void method1130(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		...
		Class312.aClass240_77.method25833((byte) -68);
	}

	@OriginalMember(owner = "client!ack", name = "uq", descriptor = "(Lclient!yf;I)V", line = 8569)
	static final void method1131(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1743635460);
	...
	static void method1132(@OriginalArg(0) int arg0) {
		...
		try {
			...
			if (Class588.aClass588_1 == Class588.aClass588_3) {
				client.aClass175_1.method24353(Class516.method30289(Class50.aClass28_2.method599((byte) 1), 40000, (short) -5827), Class50.aClass28_2.aString4, 2126602668);
				client.aClass175_1.method24369(1778124812);
				@Pc(43) Class93_Sub22 local43 = Class720.method36918((byte) 31);
				local43.aClass93_Sub41_Sub2_1.method22510(Class449.aClass449_6.anInt4980 * 1690737369, (byte) -94);
				local43.aClass93_Sub41_Sub2_1.method22454(0, 2129088042);
				local62 = local43.aClass93_Sub41_Sub2_1.anInt3070 * 212851357;
				local43.aClass93_Sub41_Sub2_1.method22454(910, 2124806922);
				local43.aClass93_Sub41_Sub2_1.method22454(1, 2141744574);
				Class676.anIntArray516 = Class367.method27959(local43, (byte) 117);
				@Pc(82) int local82 = local43.aClass93_Sub41_Sub2_1.anInt3070 * 212851357;
				local43.aClass93_Sub41_Sub2_1.method22402(client.aString139, 802881230);
				local43.aClass93_Sub41_Sub2_1.method22454(client.anInt3426 * -1765120027, 2143561161);
				local43.aClass93_Sub41_Sub2_1.method22395(client.anInt3429 * 1672118199, (byte) 61);
				local43.aClass93_Sub41_Sub2_1.method22395(client.anInt3428 * -1830493323, (byte) 109);
				local43.aClass93_Sub41_Sub2_1.method22402(Class454.aString210, -569118241);
				local43.aClass93_Sub41_Sub2_1.method22510(Class106.aClass717_8.method36920(), (byte) -97);
				local43.aClass93_Sub41_Sub2_1.method22510(client.aClass702_4.anInt5953 * -1111983921, (byte) -80);
				Class314.method26940(local43.aClass93_Sub41_Sub2_1, 1822213152);
				@Pc(133) String local133 = client.aString138;
				local43.aClass93_Sub41_Sub2_1.method22510(local133 == null ? 0 : 1, (byte) -103);
				if (local133 != null) {
					local43.aClass93_Sub41_Sub2_1.method22402(local133, 1575484636);
				}
				Class125_Sub3.aClass93_Sub42_1.method15298(local43.aClass93_Sub41_Sub2_1, 1797123567);
				local43.aClass93_Sub41_Sub2_1.anInt3070 += -1529454093;
				local43.aClass93_Sub41_Sub2_1.method22441(Class676.anIntArray516, local82, local43.aClass93_Sub41_Sub2_1.anInt3070 * 212851357, (byte) -117);
				local43.aClass93_Sub41_Sub2_1.method22407(local43.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local62, 1251011626);
				client.aClass175_1.method24351(local43, -1683542800);
				client.aClass175_1.method24350((byte) 15);
			...
			if (Class588.aClass588_2 == Class588.aClass588_3) {
				...
				if (!client.aClass175_1.method24356((byte) 41).method14720(1, 30631038)) {
					return;
				}
				client.aClass175_1.method24356((byte) 3).method14711(client.aClass175_1.aClass93_Sub41_Sub2_2.aByteArray58, 0, 1, (byte) -80);
				Class676.aClass709_1 = (Class709) Class107.method18119(Class124_Sub3.method21455(-1406618035), client.aClass175_1.aClass93_Sub41_Sub2_2.aByteArray58[0] & 0xFF, -1915563430);
				if (Class709.aClass709_7 == Class676.aClass709_1) {
					...
					client.aClass175_1.aClass93_Sub41_Sub2_2.method22672(client.aClass175_1.aClass24_3, (byte) -60);
					Class481.method29756(0, 1823202236);
					client.aClass175_1.method24369(-62093601);
					...
					Class624.aClass120_1.aClass647_1.method32642((byte) 119);
					Class151.method13981(-2015714483);
				} else {
					client.aClass175_1.method24355((byte) 34);
				}
