...
public class Class232 {
	...
	static void method25697(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6) {
		@Pc(2) int[] local2 = new int[4];
		arg0.method20470(local2);
		if (arg5 != null && local2[3] - local2[1] != arg5.length) {
			throw new IllegalStateException();
		}
		method25701();
		method25702(arg1, arg2, arg3);
		method25719(local2[1]);
		while (true) {
			@Pc(37) int local37;
			@Pc(39) int local39;
			@Pc(41) int local41;
			do {
				if (!method25704(local2[3])) {
					return;
				}
				local37 = anInt3749;
				local39 = anInt3746;
			...
			arg0.method20732(local37, local41, local39 - local37, arg4, 1);
		}
	}
	...
	public static void method25698(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2) {
		method25700(arg0, arg1, 0, arg1.length, arg2, (int[]) null, (int[]) null);
	}

	@OriginalMember(owner = "client!ds", name = "n", descriptor = "(Lclient!dh;[II[I[I)V", line = 24)
	public static void method25699(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4) {
		method25700(arg0, arg1, 0, arg1.length, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!ds", name = "m", descriptor = "(Lclient!dh;[IIII[I[I)V", line = 28)
	static void method25700(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6) {
		@Pc(2) int[] local2 = new int[4];
		arg0.method20470(local2);
		if (arg5 != null && local2[3] - local2[1] != arg5.length) {
			throw new IllegalStateException();
	...
	static void method25701() {
		anInt3748 = 0;
	}

	@OriginalMember(owner = "client!ds", name = "f", descriptor = "([III)V", line = 53)
	static void method25702(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	static void method25703(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		while (true) {
			if (arg1 >= arg0 + 8) {
	...
	static boolean method25704(@OriginalArg(0) int arg0) {
	...
	static void method25705(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg1 <= arg0 + 4) {
			return;
		}
		...
		method25705(arg0, local7);
		method25705(local7 + 4, arg1);
	}

	@OriginalMember(owner = "client!ds", name = "g", descriptor = "(II)V", line = 159)
	static void method25706(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg1 <= arg0 + 4) {
			return;
		}
		@Pc(7) int local7 = arg0;
	...
	public static void method25707(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2) {
		method25700(arg0, arg1, 0, arg1.length, arg2, (int[]) null, (int[]) null);
	}
	...
	public static void method25708(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2) {
		method25700(arg0, arg1, 0, arg1.length, arg2, (int[]) null, (int[]) null);
	}

	@OriginalMember(owner = "client!ds", name = "r", descriptor = "(Lclient!dh;[II[I[I)V", line = 24)
	public static void method25709(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4) {
		method25700(arg0, arg1, 0, arg1.length, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!ds", name = "y", descriptor = "()V", line = 49)
	static void method25710() {
		anInt3748 = 0;
	}

	@OriginalMember(owner = "client!ds", name = "o", descriptor = "()V", line = 49)
	static void method25711() {
		anInt3748 = 0;
	}

	@OriginalMember(owner = "client!ds", name = "s", descriptor = "()V", line = 49)
	static void method25712() {
		anInt3748 = 0;
	}

	@OriginalMember(owner = "client!ds", name = "z", descriptor = "(II)V", line = 188)
	static void method25713(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		while (true) {
			if (arg1 >= arg0 + 8) {
				@Pc(6) boolean local6 = true;
				for (@Pc(10) int local10 = arg0 + 4; local10 < arg1; local10 += 4) {
	...
	static void method25714() {
		anInt3748 = 0;
	}

	@OriginalMember(owner = "client!ds", name = "x", descriptor = "([III)V", line = 53)
	static void method25715(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(5) int local5 = anInt3748 + (arg2 << 1);
		@Pc(16) int local16;
		if (anIntArray350 == null || anIntArray350.length < local5) {
			@Pc(14) int[] local14 = new int[local5];
	...
	static void method25716(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		while (true) {
			if (arg1 >= arg0 + 8) {
				@Pc(6) boolean local6 = true;
				for (@Pc(10) int local10 = arg0 + 4; local10 < arg1; local10 += 4) {
	...
	static void method25717(@OriginalArg(0) int arg0) {
		if (anInt3748 < 0) {
			anInt3751 = 0;
			anInt3750 = 0;
			anInt3745 = 0;
	...
	static void method25718(@OriginalArg(0) int arg0) {
		if (anInt3748 < 0) {
			anInt3751 = 0;
			anInt3750 = 0;
			anInt3745 = 0;
	...
	static void method25719(@OriginalArg(0) int arg0) {
		if (anInt3748 < 0) {
			anInt3751 = 0;
			anInt3750 = 0;
			anInt3745 = 0;
	...
	static void method25721(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(5) int local5 = anInt3748 + (arg2 << 1);
		@Pc(16) int local16;
		if (anIntArray350 == null || anIntArray350.length < local5) {
			@Pc(14) int[] local14 = new int[local5];
	...
	public static void method25723(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2) {
		method25700(arg0, arg1, 0, arg1.length, arg2, (int[]) null, (int[]) null);
	}
}
