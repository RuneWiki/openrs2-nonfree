...
public class Class361 {
	...
	public static void method27802(@OriginalArg(0) byte arg0) {
		Class166_Sub1.aClass320Array1 = new Class320[Class589.aClass497_132.method30063((byte) -32)];
		Class9.aBooleanArray1 = new boolean[Class589.aClass497_132.method30063((byte) -60)];
	}

	@OriginalMember(owner = "client!jh", name = "ag", descriptor = "(I)Z", line = 404)
	public static boolean method27803(@OriginalArg(0) int arg0) {
	...
	static void method27804(@OriginalArg(0) Class681 arg0, @OriginalArg(1) Class560 arg1, @OriginalArg(2) Exception arg2, @OriginalArg(3) String arg3, @OriginalArg(4) int arg4) {
		...
		Class646.method32610(local4.toString(), arg2, 429105350);
	}

	@OriginalMember(owner = "client!jh", name = "ww", descriptor = "(Lclient!yf;B)V", line = 9085)
	static final void method27805(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anInt5891 -= -725861497;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		@Pc(33) int local33 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 2];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class89.method1599(local13, local23, local33, false, (byte) -4);
	}

	@OriginalMember(owner = "client!jh", name = "axa", descriptor = "(Lclient!yf;I)V", line = 13837)
	static final void method27806(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static void method27808(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(4) Class93_Sub1_Sub11 local4 = Class371.method28006(12, (long) arg0);
		local4.method21801(-1447393963);
