...
public class Class32_Sub12 extends Class32 {
	...
	public void method17819(@OriginalArg(0) int arg0) {
		super.method17808(arg0, -1506441320);
		((Class44) this.anInterface4_25).method17420(arg0, (byte) 79);
	}
	...
	public Class100 method17069(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class658 arg6, @OriginalArg(7) int arg7) {
		return ((Class44) this.anInterface4_25).method17412(arg0, arg1, arg2, arg3, arg4, arg5, arg6, -1994596950);
	}
	...
	public void method17808(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		super.method17808(arg0, -1747344071);
		((Class44) this.anInterface4_25).method17420(arg0, (byte) 16);
	}

	@OriginalMember(owner = "client!aon", name = "ai", descriptor = "(ZI)V", line = 31)
	public void method17070(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		((Class44) this.anInterface4_25).method17414(arg0, (byte) 1);
		super.method17807(420243345);
	}

	@OriginalMember(owner = "client!aon", name = "aw", descriptor = "(II)V", line = 36)
	public void method17071(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		((Class44) this.anInterface4_25).method17415(arg0, -1977861886);
	}

	@OriginalMember(owner = "client!aon", name = "b", descriptor = "()V", line = 40)
	@Override
	public void method17806() {
		super.method17807(-177156337);
		((Class44) this.anInterface4_25).method17419(-1160906052);
	}

	@OriginalMember(owner = "client!aon", name = "as", descriptor = "(I)V", line = 45)
	public void method17072(@OriginalArg(0) int arg0) {
		((Class44) this.anInterface4_25).method17417(1162764107);
	}

	@OriginalMember(owner = "client!aon", name = "s", descriptor = "()V", line = 40)
	@Override
	public void method17810() {
		super.method17807(-1997868214);
	...
	public void method17811(@OriginalArg(0) int arg0) {
		super.method17811(1724311617);
		((Class44) this.anInterface4_25).method17418(-616875112);
	}
	...
	public void method17080() {
		((Class44) this.anInterface4_25).method17417(1675430498);
	}
}
