...
public class Class195 {
	...
	void method24598() {
		...
		if (this.aClass88_Sub2_5 == null) {
			...
			this.aClass88_Sub2_5.method18080(false, false);
			this.aClass88_Sub2_5.method18041(true);
		} else {
			this.aClass88_Sub2_5.method18099(0, 0, 128, 128, this.aClass104_Sub1_41.aByteArray17, Class206.aClass206_19, 0, 0, false);
		}
	}
	...
	void method24606(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
	...
	void method24607(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		this.aClass101_Sub1_2.method2561(5123, arg0, arg1 * 2);
		this.method24605(this.aClass101_Sub1_2, arg1);
	}

	@OriginalMember(owner = "client!bt", name = "p", descriptor = "(Lclient!cf;I)V", line = 78)
	void method24608(@OriginalArg(0) Interface16 arg0, @OriginalArg(1) int arg1) {
		if (arg1 != 0) {
			this.method24601();
			this.aClass104_Sub1_41.method3804(this.aClass88_Sub2_5);
			this.aClass104_Sub1_41.method3948(arg0, 4, 0, arg1);
	...
	void method24609(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		this.aClass101_Sub1_2.method2561(5123, arg0, arg1 * 2);
		this.method24605(this.aClass101_Sub1_2, arg1);
	}
	...
	void method24611(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		this.aClass101_Sub1_2.method2561(5123, arg0, arg1 * 2);
		this.method24605(this.aClass101_Sub1_2, arg1);
	}
	...
	Class195(@OriginalArg(0) Class104_Sub1 arg0, @OriginalArg(1) Class205 arg1, @OriginalArg(2) Class99_Sub2 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		if (local25 > 0) {
			...
			if (this.aClass104_Sub1_41.aBoolean106) {
					...
					for (local105 = 0; local105 < local23; local105++) {
						...
						if (local114 != null) {
							for (local118 = 0; local118 < local114.length; local118++) {
								local83.method22454(local114[local118] & 0xFFFF, 2130950967);
							}
						}
					}
				}
				...
				for (local49 = 0; local49 < local23; local49++) {
					...
					for (local105 = 0; local105 < local23; local105++) {
						...
						if (local114 != null) {
							for (local118 = 0; local118 < local114.length; local118++) {
								local83.method22393(local114[local118] & 0xFFFF, -198370378);
							}
						}
					}
				}
			...
			this.aClass101_Sub1_2 = new Class101_Sub1(this.aClass104_Sub1_41, 5123, (byte[]) null, 1);
		} else {
