...
public class Class266 implements Interface26 {
	...
	public void method26714(@OriginalArg(0) Class297 arg0) {
		@Pc(7) Class304 local7 = arg0.method26622(this.anInt3881 * -1290684941, 1151263163);
		local7.method26756(-1942433304);
		local7.method26745(1689751145);
		arg0.method26660(this.anInt3881 * -1290684941, -332433333);
	}
	...
	public void method26715(@OriginalArg(0) Class297 arg0, @OriginalArg(1) byte arg1) {
		@Pc(7) Class304 local7 = arg0.method26622(this.anInt3881 * -1290684941, 607100108);
		local7.method26756(-1942433304);
		local7.method26745(1689751145);
		arg0.method26660(this.anInt3881 * -1290684941, 36518985);
	}
	...
	public void method26713(@OriginalArg(0) Class297 arg0) {
		@Pc(7) Class304 local7 = arg0.method26622(this.anInt3881 * -1290684941, -1894103119);
		local7.method26756(-1942433304);
		local7.method26745(1689751145);
		arg0.method26660(this.anInt3881 * -1290684941, -1007852185);
	}
	...
	Class266(@OriginalArg(0) Class303 arg0, @OriginalArg(1) Class93_Sub41 arg1) {
		this.this$0 = arg0;
		this.anInt3881 = arg1.method22415(-1434290800) * 331868987;
	}

	@OriginalMember(owner = "client!fk", name = "fh", descriptor = "(Lclient!yf;B)V", line = 6020)
	static final void method26226(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, -336893798);
	...
	static final void method26227(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class681 arg1, @OriginalArg(2) byte arg2) {
		...
		Class561.method31152(arg0, local15, local25, arg1, -2049935470);
	}

	@OriginalMember(owner = "client!fk", name = "n", descriptor = "(IB)Lclient!aaj;", line = 20)
	public static Class12 method26228(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		@Pc(2) Class12[] local2 = Class352.method27670(-1399000489);
