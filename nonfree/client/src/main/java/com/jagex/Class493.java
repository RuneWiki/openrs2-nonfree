...
public class Class493 {
	...
	Class93_Sub1_Sub16_Sub1 method29986(@OriginalArg(0) int arg0) {
		return this.method30005(255, 255, (byte) 0, true, 0, 0, -1468262263);
	}
	...
	void method29988(@OriginalArg(0) int arg0) {
	...
	void method29990(@OriginalArg(0) boolean arg0, @OriginalArg(1) byte arg1) {
		this.aBoolean781 = arg0;
	}
	...
	Class93_Sub1_Sub16_Sub1 method29992() {
		return this.method30005(255, 255, (byte) 0, true, 0, 0, -2032913404);
	}
	...
	Class93_Sub1_Sub16_Sub1 method29993(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		if (arg0 < 0 || arg1 < 0) {
			...
			if (!this.aBoolean781 && !local33) {
				return null;
			} else if (this.aLong282 * 5663573980390976855L + 10000L >= Class305.method26796(1203305809)) {
				return null;
			} else {
				@Pc(54) URL local54 = null;
				@Pc(66) String local66;
				if (local33) {
					local66 = "&cb=" + Class305.method26796(786716826);
				} else {
	...
	Class93_Sub1_Sub16_Sub1 method29994() {
		return this.method30005(255, 255, (byte) 0, true, 0, 0, 87403681);
	}
	...
	Class93_Sub1_Sub16_Sub1 method29995(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		if (arg0 < 0 || arg1 < 0) {
			...
			if (!this.aBoolean781 && !local33) {
				return null;
			} else if (this.aLong282 * 5663573980390976855L + 10000L >= Class305.method26796(1062012316)) {
				return null;
			} else {
				@Pc(54) URL local54 = null;
				@Pc(66) String local66;
				if (local33) {
					local66 = "&cb=" + Class305.method26796(854659925);
				} else {
					local66 = "&c=" + arg4 + "&v=" + arg5;
				}
				try {
	...
	Class93_Sub1_Sub16_Sub1 method29997(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		if (arg0 < 0 || arg1 < 0) {
			...
			if (!this.aBoolean781 && !local33) {
				return null;
			} else if (this.aLong282 * 5663573980390976855L + 10000L >= Class305.method26796(719279151)) {
				return null;
			} else {
				@Pc(54) URL local54 = null;
				@Pc(66) String local66;
				if (local33) {
					local66 = "&cb=" + Class305.method26796(-107660977);
				} else {
					local66 = "&c=" + arg4 + "&v=" + arg5;
				}
				try {
	...
	public void method30000(@OriginalArg(0) int arg0) {
		this.anExecutorService2.shutdown();
	}
	...
	Class93_Sub1_Sub16_Sub1 method30005(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		if (arg0 < 0 || arg1 < 0) {
			throw new RuntimeException(arg0 + "," + arg1);
			...
			if (!this.aBoolean781 && !local33) {
				return null;
			} else if (this.aLong282 * 5663573980390976855L + 10000L >= Class305.method26796(1673511386)) {
				return null;
			} else {
				@Pc(54) URL local54 = null;
				@Pc(66) String local66;
				if (local33) {
					local66 = "&cb=" + Class305.method26796(1889312857);
				} else {
					local66 = "&c=" + arg4 + "&v=" + arg5;
				}
				try {
	...
	static final void method30007(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		@Pc(36) Class500 local36 = local9.aClass519_6.method30311((byte) 36);
	...
	static final void method30008(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class681 arg1, @OriginalArg(2) int arg2) {
		@Pc(5) Class5 local5 = arg0.method26851(Class157.aClass462_2, client.anInterface50_1, -1288620069);
		...
		@Pc(48) int local48 = local5.method46(arg0.aString164, arg0.anInt3981 * 1215292027, arg0.anInt4005 * -889720761, local31, local18, Class110_Sub14.aClass100Array4, 1460375930);
	...
	static final void method30009(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method30010(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		if (local12 < 0 || local12 > 5 || local12 == 2) {
			local12 = 3;
		}
		Class543.method30948(local12, false, 1945646779);
	}

	@OriginalMember(owner = "client!pu", name = "axu", descriptor = "(Lclient!yf;B)V", line = 13953)
	static final void method30011(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		if (local29.method1508(1429228259)) {
			arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = ((Class322) Class542.aClass32_Sub2_3.method18261(local13, -1665928163)).method27257(local23, local29.aString11, 838634018);
		} else {
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = ((Class322) Class542.aClass32_Sub2_3.method18261(local13, -1456178808)).method27256(local23, local29.anInt265 * 951920133, 1022196745);
		}
	}

	@OriginalMember(owner = "client!pu", name = "arq", descriptor = "(Lclient!yf;I)V", line = 12992)
	static final void method30012(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
	...
	public static int method30014(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4) {
		...
		for (@Pc(12) int local12 = 0; local12 < local4.anIntArray173.length; local12++) {
			if (local4.anIntArray173[local12] >= 0 && local4.anIntArray173[local12] < Class277.aClass32_Sub12_1.anInt2487 * -152478627) {
				...
				@Pc(53) int local53 = local40.method945(arg1, ((Class87) Class124.aClass32_Sub21_7.method18261(arg1, -811281460)).anInt265 * 951920133, 1100080431);
				if (arg2) {
	...
	public static Class93_Sub30 method30015(@OriginalArg(0) Class93_Sub30 arg0, @OriginalArg(1) int arg1) {
		...
		synchronized (Class93_Sub30.aClass93_Sub30Array1) {
			if (Class509.anInt5206 * 672498035 == 0) {
				...
				Class93_Sub30.aClass93_Sub30Array1[(Class509.anInt5206 -= -1799648325) * 672498035].method13885(arg0, -17532584);
