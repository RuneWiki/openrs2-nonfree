...
public class Class568 {
	...
	static final void method31295(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method31296(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = Class218.method25508((long) local29, 0, local16, Class106.aClass717_8, -433742498);
	}

	@OriginalMember(owner = "client!tb", name = "jp", descriptor = "(IIIZB)V", line = 10905)
	static final void method31297(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) byte arg4) {
		if (Class383.method28145(arg0, (int[]) null, 218090042)) {
	...
	public static boolean method31298(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
