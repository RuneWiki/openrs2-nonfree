...
public class Class568 {
	...
	static int method31292(@OriginalArg(0) int arg0) {
		if (arg0 == 9 || arg0 == 10) {
			return 1;
		} else if (arg0 == 11) {
			return 8;
	...
	public static byte[][][] method31286(@OriginalArg(0) int arg0) {
	...
	public static boolean method31298(@OriginalArg(0) int arg0) {
		for (@Pc(4) Class93_Sub1_Sub7 local4 = (Class93_Sub1_Sub7) Class454.aClass22_55.method445(); local4 != null; local4 = (Class93_Sub1_Sub7) Class454.aClass22_55.method415()) {
			if (Class110_Sub6.method7672(local4.anInt3012 * -92627949) && local4.aLong154 * 3050087486000948885L == (long) arg0) {
				return true;
			}
		}
		return false;
	...
	static final void method31295(@OriginalArg(0) Class681 arg0) {
	...
	static final void method31296(@OriginalArg(0) Class681 arg0) {
		...
		arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = Class218.method25508((long) local29, 0, local16, Class106.aClass717_8);
	}

	@OriginalMember(owner = "client!tb", name = "jp", descriptor = "(IIIZB)V", line = 10905)
	static final void method31297(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		if (Class383.method28145(arg0, null)) {
			Class206.method24700(Class166_Sub1.aClass320Array1[arg0].aClass312Array3, -1, arg1, arg2, arg3);
		}
	}
}
