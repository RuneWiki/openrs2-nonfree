...
class Class63 implements Iterator {
	...
	public Object next() {
		...
		return this.this$0.method17821(local11, -1686549206);
	}
	...
	public Object method1158() {
		...
		return this.this$0.method17821(local11, -1611897795);
	}
	...
	public Object method1159() {
		...
		return this.this$0.method17821(local11, -254623897);
	}
	...
	static void method1162(@OriginalArg(0) byte arg0) {
		Class411.aClass175_3.method24369(-1146389155);
		...
		for (@Pc(42) int local42 = 0; local42 < Class624.aClass120_1.aClass675Array1.length; local42++) {
			...
			local56.method33137(0, 584874206);
			local56.method33141(0, 479175137);
			Class624.aClass120_1.aClass675Array1[local42] = local56;
		}
		Class624.aClass120_1.aClass647_1.method32642((byte) -51);
		Class151.method13981(-64820407);
		Class339.method27487(Class411.aClass175_3, (byte) 38);
	}
}
