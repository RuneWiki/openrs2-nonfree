...
public class Class252 implements Interface75 {
	...
	public static Class392[] method25978(@OriginalArg(0) int arg0) {
	...
	static final void method25979(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method25980(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		Class274.aClass258_1.method26074(Class275.aClass275_9, local13, local23, local43, Class280.aClass280_7.method26450(-219534880), Class278.aClass278_2, 0.0F, 0.0F, (Class472) null, 0, local45, local33, 1555618476);
	}
	...
	public static void method25982(@OriginalArg(0) int arg0) {
		...
		while (true) {
			while (Class50.anInt195 * -1020006083 < Class361.anInt4571 * 977343673) {
				@Pc(27) Class154_Sub1 local27 = Class367.method27961(Class50.anInt195 * -1020006083, (byte) 94);
				if (local27 != null && local27.anInt1655 * 1280583823 == -1) {
					if (Class50.aClass678_1 == null) {
						Class50.aClass678_1 = client.aClass698_1.method36698(local27.aString46, (byte) 1);
					}
