...
public abstract class Class79_Sub1 extends Class79 implements Interface51 {
	...
	public int method1461(@OriginalArg(0) Class466 arg0, @OriginalArg(1) byte arg1) {
		@Pc(1) byte local1 = 2;
		@Pc(6) int local6;
		if (arg0.anObject19 instanceof Integer) {
			...
			local6 = local1 + Class582.method31414((String) arg0.anObject19, 1732748241);
	...
	public void method1462(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) Class466 arg1, @OriginalArg(2) int arg2) {
		arg0.method22454(arg1.anInt5092 * -1181855333, 2135795818);
		if (arg1.anObject19 instanceof Integer) {
			arg0.method22395((Integer) arg1.anObject19, (byte) -49);
		} else if (arg1.anObject19 instanceof Long) {
			arg0.method22399((Long) arg1.anObject19);
		} else if (arg1.anObject19 instanceof String) {
			arg0.method22403((String) arg1.anObject19, 1516871641);
	...
	public Class466 method1463(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) byte arg1) {
		...
		@Pc(29) Class local29 = local9.aClass519_6.method30311((byte) 36).aClass2;
		if (local29 == Integer.class) {
			local23.anObject19 = arg0.method22419(-118643075);
		} else if (Long.class == local29) {
			local23.anObject19 = arg0.method22423(526348717);
		} else if (String.class == local29) {
			local23.anObject19 = arg0.method22428(158598774);
	...
	public Class466 method1464(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) Class500 arg1, @OriginalArg(2) byte arg2) {
		@Pc(3) int local3 = arg0.method22415(-1434290800);
		@Pc(8) Class466 local8 = new Class466(local3);
		@Pc(11) Class local11 = arg1.aClass2;
		if (Integer.class == local11) {
			local8.anObject19 = arg0.method22419(-118643075);
		} else if (Long.class == local11) {
			local8.anObject19 = arg0.method22423(-1724840463);
		} else if (local11 == String.class) {
			local8.anObject19 = arg0.method22428(1558569498);
		...
		return local70.method7437((byte) -30) && local70.aClass519_6.method30311((byte) 36) == arg1 ? local8 : null;
	}
	...
	public int method1465(@OriginalArg(0) Class466 arg0) {
		...
		if (arg0.anObject19 instanceof Integer) {
			...
			local6 = local1 + Class582.method31414((String) arg0.anObject19, 333037137);
		} else if (arg0.anObject19 instanceof Interface6) {
	...
	public int method1467(@OriginalArg(0) Class466 arg0) {
		...
		if (arg0.anObject19 instanceof Integer) {
			...
			local6 = local1 + Class582.method31414((String) arg0.anObject19, 826935043);
		} else if (arg0.anObject19 instanceof Interface6) {
	...
	public void method1468(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) Class466 arg1) {
		arg0.method22454(arg1.anInt5092 * -1181855333, 2134803626);
		if (arg1.anObject19 instanceof Integer) {
			arg0.method22395((Integer) arg1.anObject19, (byte) -80);
		} else if (arg1.anObject19 instanceof Long) {
			arg0.method22399((Long) arg1.anObject19);
		} else if (arg1.anObject19 instanceof String) {
			arg0.method22403((String) arg1.anObject19, 1516871641);
	...
	public void method1469(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) Class466 arg1) {
		arg0.method22454(arg1.anInt5092 * -1181855333, 2136311086);
		if (arg1.anObject19 instanceof Integer) {
			arg0.method22395((Integer) arg1.anObject19, (byte) -44);
		} else if (arg1.anObject19 instanceof Long) {
			arg0.method22399((Long) arg1.anObject19);
		} else if (arg1.anObject19 instanceof String) {
			arg0.method22403((String) arg1.anObject19, 1516871641);
	...
	public Class466 method1470(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		if (local29 == Integer.class) {
			...
			local23.anObject19 = arg0.method22423(752691255);
		} else if (String.class == local29) {
			local23.anObject19 = arg0.method22428(1537930131);
		} else if (Interface6.class.isAssignableFrom(local29)) {
			try {
				@Pc(66) Interface6 local66 = (Interface6) local29.getDeclaredConstructor().newInstance();
	...
	public Class466 method1471(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) Class500 arg1) {
		...
		if (Integer.class == local11) {
			...
			local8.anObject19 = arg0.method22423(-617457273);
		} else if (local11 == String.class) {
			local8.anObject19 = arg0.method22428(-153120367);
		} else if (Interface6.class.isAssignableFrom(local11)) {
			try {
				@Pc(48) Interface6 local48 = (Interface6) local11.getDeclaredConstructor().newInstance();
		...
		return local70.method7437((byte) -5) && local70.aClass519_6.method30311((byte) 36) == arg1 ? local8 : null;
	}
	...
	public Class466 method1472(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) Class500 arg1) {
		...
		if (Integer.class == local11) {
			...
			local8.anObject19 = arg0.method22423(-1567631637);
		} else if (local11 == String.class) {
			local8.anObject19 = arg0.method22428(-429090498);
		} else if (Interface6.class.isAssignableFrom(local11)) {
			try {
				@Pc(48) Interface6 local48 = (Interface6) local11.getDeclaredConstructor().newInstance();
		...
		return local70.method7437((byte) -48) && local70.aClass519_6.method30311((byte) 36) == arg1 ? local8 : null;
	}
	...
	public Class466 method1473(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) Class500 arg1) {
		...
		if (Integer.class == local11) {
			...
			local8.anObject19 = arg0.method22423(-783449995);
		} else if (local11 == String.class) {
			local8.anObject19 = arg0.method22428(-50914556);
		} else if (Interface6.class.isAssignableFrom(local11)) {
			try {
				@Pc(48) Interface6 local48 = (Interface6) local11.getDeclaredConstructor().newInstance();
		...
		return local70.method7437((byte) -97) && local70.aClass519_6.method30311((byte) 36) == arg1 ? local8 : null;
	}
}
