...
public final class Class115_Sub1 extends Class115 {
	...
	public boolean method8203(@OriginalArg(0) Class116 arg0) {
		if (this.aClass116_Sub2_1 == arg0) {
			...
			this.anInt971 = this.method8241(arg0) * 571593063;
			if (this.anInt971 * 1454094935 == -1) {
				throw new IllegalArgumentException();
			}
			if (this.aBoolean174) {
				this.aClass104_Sub2_Sub1_1.method19555(this.aClass116_Sub2_1.aLong30);
				this.aClass104_Sub2_Sub1_1.method19521(this.aClass116_Sub2_1.aLong29);
	...
	public void method8237() {
		this.aClass104_Sub2_Sub1_1.method19555(0L);
		this.aClass104_Sub2_Sub1_1.method19521(0L);
		this.aBoolean174 = false;
		this.aClass104_Sub2_Sub1_1.aClass116_Sub2_2 = null;
		this.aClass104_Sub2_Sub1_1.method20966(1);
		this.aClass104_Sub2_Sub1_1.method21020(null);
		this.aClass104_Sub2_Sub1_1.method20966(0);
		this.aClass104_Sub2_Sub1_1.method21020(null);
	}
