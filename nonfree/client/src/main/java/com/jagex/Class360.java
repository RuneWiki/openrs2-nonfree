...
public class Class360 {
	...
	public void method27793(@OriginalArg(0) byte arg0) {
		Class294.method26596(this.aShortArray122, -291489944);
	}
	...
	public int method27794(@OriginalArg(0) Class365 arg0, @OriginalArg(1) byte arg1) throws IOException {
		...
		for (@Pc(6) int local6 = this.anInt4569 * 1447085883; local6 != 0; local6--) {
			local1 = (local1 << 1) + arg0.method27905(this.aShortArray122, local1, 291964485);
		}
	...
	public int method27795(@OriginalArg(0) Class365 arg0) throws IOException {
		...
		for (@Pc(5) int local5 = 0; local5 < this.anInt4569 * 1447085883; local5++) {
			@Pc(18) int local18 = arg0.method27905(this.aShortArray122, local1, 291964485);
			local1 <<= 0x1;
			local1 += local18;
	...
	static final void method27799(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 603863381);
	...
	static final void method27800(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	public static void method27801(@OriginalArg(0) short arg0) {
