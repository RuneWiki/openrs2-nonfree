...
public class Class360 {
	...
	public void method27793() {
		Class294.method26596(this.aShortArray122);
	}

	@OriginalMember(owner = "client!jg", name = "n", descriptor = "(Lclient!jp;B)I", line = 17)
	public int method27794(@OriginalArg(0) Class365 arg0) throws IOException {
		@Pc(1) int local1 = 1;
		for (@Pc(6) int local6 = this.anInt4569 * 1447085883; local6 != 0; local6--) {
			local1 = (local1 << 1) + arg0.method27905(this.aShortArray122, local1);
		}
	...
	public int method27795(@OriginalArg(0) Class365 arg0) throws IOException {
		...
		for (@Pc(5) int local5 = 0; local5 < this.anInt4569 * 1447085883; local5++) {
			@Pc(18) int local18 = arg0.method27905(this.aShortArray122, local1);
			local1 <<= 0x1;
			local1 += local18;
	...
	public int method27797(@OriginalArg(0) Class365 arg0) throws IOException {
		@Pc(1) int local1 = 1;
		@Pc(3) int local3 = 0;
		for (@Pc(5) int local5 = 0; local5 < this.anInt4569 * 1447085883; local5++) {
			@Pc(18) int local18 = arg0.method27905(this.aShortArray122, local1);
	...
	public static void method27801() {
	...
	static final void method27799(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class138_Sub4.method11516(local16, local22, arg0);
	}

	@OriginalMember(owner = "client!jg", name = "aur", descriptor = "(Lclient!yf;B)V", line = 13357)
	static final void method27800(@OriginalArg(0) Class681 arg0) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class574.method31347();
	}
}
