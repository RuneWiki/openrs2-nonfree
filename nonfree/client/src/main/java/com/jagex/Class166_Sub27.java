...
public class Class166_Sub27 extends Class166 {
	...
	public void method15931(@OriginalArg(0) int arg0) {
		if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 4) {
			this.anInt2379 = this.method16542((byte) -32) * -88839937;
		}
	}
	...
	public int method15932(@OriginalArg(0) short arg0) {
	...
	public void method15936() {
		if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 4) {
			this.anInt2379 = this.method16542((byte) 24) * -88839937;
		}
	}
	...
	public void method15937() {
		if (this.anInt2379 * 960141055 < 0 || this.anInt2379 * 960141055 > 4) {
			this.anInt2379 = this.method16542((byte) -30) * -88839937;
		}
	}
	...
	public static void method15938(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		local4.method21865(2145731156);
	}

	@OriginalMember(owner = "client!ana", name = "awl", descriptor = "(Lclient!yf;I)V", line = 13613)
	static final void method15939(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		if (client.anInt3435 * -849002901 != 13 && client.anInt3435 * -849002901 != 18 || Class251.method25973(-961904827)) {
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 1;
		} else if (Class50.aBoolean26) {
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
		} else if (Class333.aLong260 * -7110566573125480355L > Class305.method26796(1631621016) - 1000L) {
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 1;
		} else {
			Class50.aBoolean26 = true;
			@Pc(76) Class175 local76 = Class330.method27372(-2084952673);
			@Pc(82) Class93_Sub22 local82 = Class102.method2592(Class446.aClass446_79, local76.aClass24_2, (byte) 95);
			local82.aClass93_Sub41_Sub2_1.method22395(Class632.anInt5720 * 1926204629, (byte) 45);
			local76.method24351(local82, -1598204780);
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
		}
	}

	@OriginalMember(owner = "client!ana", name = "ep", descriptor = "(Lclient!yf;B)V", line = 5746)
	static final void method15940(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class275.method26342(local11, local14, arg0, -1908690040);
	}
}
