...
public class Class79_Sub1_Sub2 extends Class79_Sub1 implements Interface11 {
	...
	Class108_Sub2 method1474(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		@Pc(12) byte[] local12 = this.aClass497_14.method30044(this.aClass138_3.method11528((byte) 106).anInt5849 * -1772702343, arg0, (byte) 0);
	...
	public void method1475() {
		@Pc(3) Class240 local3 = this.aClass240_6;
		synchronized (this.aClass240_6) {
			this.aClass240_6.method25837(1161602830);
		}
	}
	...
	public Class79_Sub1_Sub2(@OriginalArg(0) Class702 arg0, @OriginalArg(1) Class138 arg1, @OriginalArg(2) Class717 arg2, @OriginalArg(3) Class497 arg3) {
		super(arg0, arg1, arg2, arg3 == null ? 0 : arg3.method30062(arg1.method11528((byte) 31).anInt5849 * -1772702343, 942596941));
	...
	public void method1477() {
		@Pc(3) Class240 local3 = this.aClass240_6;
		synchronized (this.aClass240_6) {
			this.aClass240_6.method25833((byte) -23);
		}
	}
	...
	Class108_Sub2 method1478(@OriginalArg(0) int arg0) {
		@Pc(12) byte[] local12 = this.aClass497_14.method30044(this.aClass138_3.method11528((byte) 35).anInt5849 * -1772702343, arg0, (byte) 0);
		@Pc(19) Class108_Sub2 local19 = new Class108_Sub2(this.aClass138_3, arg0);
		if (local12 != null) {
			local19.method36654(new Class93_Sub41(local12), (byte) -10);
		}
	...
	public void method1482(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class240 local3 = this.aClass240_6;
		synchronized (this.aClass240_6) {
			this.aClass240_6.method25832(arg0, (byte) 30);
		}
	}

	@OriginalMember(owner = "client!adm", name = "q", descriptor = "(I)Lclient!afv;", line = 35)
	Class108_Sub2 method1483(@OriginalArg(0) int arg0) {
		@Pc(12) byte[] local12 = this.aClass497_14.method30044(this.aClass138_3.method11528((byte) 108).anInt5849 * -1772702343, arg0, (byte) 0);
		@Pc(19) Class108_Sub2 local19 = new Class108_Sub2(this.aClass138_3, arg0);
		if (local12 != null) {
	...
	Class108_Sub2 method1484(@OriginalArg(0) int arg0) {
		@Pc(12) byte[] local12 = this.aClass497_14.method30044(this.aClass138_3.method11528((byte) 68).anInt5849 * -1772702343, arg0, (byte) 0);
		@Pc(19) Class108_Sub2 local19 = new Class108_Sub2(this.aClass138_3, arg0);
		if (local12 != null) {
	...
	public void method1485(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_6;
		synchronized (this.aClass240_6) {
			this.aClass240_6.method25833((byte) -70);
		}
	}
	...
	public void method1486(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_6;
		synchronized (this.aClass240_6) {
			this.aClass240_6.method25832(arg0, (byte) 12);
		}
	}
