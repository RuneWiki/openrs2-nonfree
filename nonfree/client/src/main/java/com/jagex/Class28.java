...
public class Class28 {
	...
	public Socket method596() throws IOException {
		return this.aBoolean14 ? Class429.method28754(this.aString4, this.aBoolean15 ? this.anInt99 * -1815897519 : this.anInt100 * 721448659, -19069192).method16599(1875748059) : new Socket(InetAddress.getByName(this.aString4), this.aBoolean15 ? this.anInt99 * -1815897519 : this.anInt100 * 721448659);
	}
	...
	public Socket method599(@OriginalArg(0) byte arg0) throws IOException {
		return this.aBoolean14 ? Class429.method28754(this.aString4, this.aBoolean15 ? this.anInt99 * -1815897519 : this.anInt100 * 721448659, -80518013).method16599(1312515116) : new Socket(InetAddress.getByName(this.aString4), this.aBoolean15 ? this.anInt99 * -1815897519 : this.anInt100 * 721448659);
	}
	...
	static final void method603(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) byte arg3) {
		...
		arg0.anObjectArray32 = Class499.method30148(local13, arg2, 672449356);
