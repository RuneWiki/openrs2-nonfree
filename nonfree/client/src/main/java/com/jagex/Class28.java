...
public class Class28 {
	...
	public Socket method596() throws IOException {
		return this.aBoolean14 ? Class429.method28754(this.aString4, this.aBoolean15 ? this.anInt99 * -1815897519 : this.anInt100 * 721448659).method16599() : new Socket(InetAddress.getByName(this.aString4), this.aBoolean15 ? this.anInt99 * -1815897519 : this.anInt100 * 721448659);
	}

	@OriginalMember(owner = "client!aba", name = "e", descriptor = "(B)Ljava/net/Socket;", line = 19)
	public Socket method599() throws IOException {
		return this.aBoolean14 ? Class429.method28754(this.aString4, this.aBoolean15 ? this.anInt99 * -1815897519 : this.anInt100 * 721448659).method16599() : new Socket(InetAddress.getByName(this.aString4), this.aBoolean15 ? this.anInt99 * -1815897519 : this.anInt100 * 721448659);
	}
	...
	public boolean method592(@OriginalArg(0) Class28 arg0) {
		if (arg0 == null) {
			return false;
		} else {
	...
	static boolean method601() {
		return Class90.method1602(Class288.aClass636_1.aClass628_3);
	}

	@OriginalMember(owner = "client!aba", name = "ks", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;B)V", line = 6802)
	static final void method602(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
	...
	static final void method603(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
		...
		arg0.anObjectArray32 = Class499.method30148(local13, arg2);
