...
public class Class87 implements Interface13, Interface5 {
	...
	void method1506(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			@Pc(8) char local8 = Class615.method32089(arg0.method22414());
			this.aClass519_3 = Class519.method30319(local8);
		} else if (arg1 == 2) {
			this.anInt265 = arg0.method22419() * -2008172851;
		} else if (arg1 == 4) {
			this.aBoolean32 = false;
		} else if (arg1 == 5) {
			this.aString11 = arg0.method22427();
		} else if (arg1 == 101) {
			this.aClass519_3 = (Class519) Class107.method18119(Class519.method30312(), arg0.method22632());
		}
	}

	@OriginalMember(owner = "client!adp", name = "u", descriptor = "(Lclient!alw;II)V", line = 28)
	void method1507(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			@Pc(8) char local8 = Class615.method32089(arg0.method22414());
			this.aClass519_3 = Class519.method30319(local8);
		} else if (arg1 == 2) {
	...
	static final void method1513(@OriginalArg(0) Class681 arg0) {
