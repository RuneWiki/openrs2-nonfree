...
public class Class87 implements Interface13, Interface5 {
	...
	void method1506(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			@Pc(8) char local8 = Class615.method32089(arg0.method22414(1220074706), (short) 150);
			this.aClass519_3 = Class519.method30319(local8, (byte) 8);
		} else if (arg1 == 2) {
			this.anInt265 = arg0.method22419(-118643075) * -2008172851;
		} else if (arg1 == 4) {
			this.aBoolean32 = false;
		} else if (arg1 == 5) {
			this.aString11 = arg0.method22427(1948836307);
		} else if (arg1 == 101) {
			this.aClass519_3 = (Class519) Class107.method18119(Class519.method30312(1432836651), arg0.method22632((byte) -127), -1915563430);
		}
	}
	...
	void method1507(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg1 == 1) {
			@Pc(8) char local8 = Class615.method32089(arg0.method22414(1065706590), (short) 150);
			this.aClass519_3 = Class519.method30319(local8, (byte) 8);
		} else if (arg1 == 2) {
			this.anInt265 = arg0.method22419(-118643075) * -2008172851;
		} else if (arg1 == 4) {
			...
			this.aString11 = arg0.method22427(2147401139);
		} else if (arg1 == 101) {
			this.aClass519_3 = (Class519) Class107.method18119(Class519.method30312(1992894062), arg0.method22632((byte) -67), -1915563430);
		}
	}
	...
	void method1509(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			@Pc(8) char local8 = Class615.method32089(arg0.method22414(1528387687), (short) 150);
			this.aClass519_3 = Class519.method30319(local8, (byte) 8);
		} else if (arg1 == 2) {
			this.anInt265 = arg0.method22419(-118643075) * -2008172851;
		} else if (arg1 == 4) {
			...
			this.aString11 = arg0.method22427(1933586620);
		} else if (arg1 == 101) {
			this.aClass519_3 = (Class519) Class107.method18119(Class519.method30312(1999805024), arg0.method22632((byte) -108), -1915563430);
		}
	}
	...
	void method1510(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			@Pc(8) char local8 = Class615.method32089(arg0.method22414(1255886065), (short) 150);
			this.aClass519_3 = Class519.method30319(local8, (byte) 8);
		} else if (arg1 == 2) {
			this.anInt265 = arg0.method22419(-118643075) * -2008172851;
		} else if (arg1 == 4) {
			...
			this.aString11 = arg0.method22427(2093566124);
		} else if (arg1 == 101) {
			this.aClass519_3 = (Class519) Class107.method18119(Class519.method30312(1366069052), arg0.method22632((byte) -101), -1915563430);
		}
	}
	...
	void method1511(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			@Pc(8) char local8 = Class615.method32089(arg0.method22414(2060430853), (short) 150);
			this.aClass519_3 = Class519.method30319(local8, (byte) 8);
		} else if (arg1 == 2) {
			this.anInt265 = arg0.method22419(-118643075) * -2008172851;
		} else if (arg1 == 4) {
			...
			this.aString11 = arg0.method22427(-180913270);
		} else if (arg1 == 101) {
			this.aClass519_3 = (Class519) Class107.method18119(Class519.method30312(1718461465), arg0.method22632((byte) -19), -1915563430);
		}
	}
