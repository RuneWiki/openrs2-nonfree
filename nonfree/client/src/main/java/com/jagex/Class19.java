...
public class Class19 {
	...
	public final void method23556(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.method23559(arg0, arg1, 0, false, (short) 11934);
	}

	@OriginalMember(owner = "client!aaq", name = "u", descriptor = "(IZI)V", line = 72)
	public final void method23557(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2) {
		this.method23559(arg0, 0, 0, arg1, (short) -16875);
	}

	@OriginalMember(owner = "client!aaq", name = "z", descriptor = "(IZZB)V", line = 76)
	public final void method23558(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) byte arg3) {
		this.method23560(arg0, 0, 0, arg1, arg2, -218902843);
	}

	@OriginalMember(owner = "client!aaq", name = "p", descriptor = "(IIIZS)V", line = 80)
	public final void method23559(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) short arg4) {
		this.method23560(arg0, arg1, arg2, arg3, false, 972074963);
	}

	@OriginalMember(owner = "client!aaq", name = "d", descriptor = "(IIIZZI)V", line = 84)
	final void method23560(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		if (arg0 == this.method23554((byte) 44)) {
			return;
		}
		if (arg0 == -1) {
			...
			if (this.aClass263_5 == null || arg0 != this.aClass263_5.anInt3869 * 1707631335) {
				...
				if (this.aClass263_5 == null || this.aClass263_5.anIntArray364 == null && !this.aClass263_5.method26188(-2082957909)) {
					this.aClass263_5 = null;
					return;
				}
			...
			if (this.aClass263_5.method26188(-2123042485)) {
				if (arg3) {
					this.anInt3216 = 594453757;
				} else {
					this.anInt3216 = 0;
				}
				this.method23619(this.aClass263_5, this.anInt3216 * 1550739371, 2060653921);
			} else {
				if (arg3) {
				...
				if (this.anInt3217 * 234452907 == 0) {
					this.method23613(this.aClass263_5, this.anInt3223 * -1046590071, 1766017112);
				}
			}
			this.aBoolean532 = false;
		}
		this.method23579(-809190853);
	}

	@OriginalMember(owner = "client!aaq", name = "c", descriptor = "(B)Z", line = 130)
	public final boolean method23561(@OriginalArg(0) byte arg0) {
		return this.anInt3217 * 234452907 != 0;
	}

	@OriginalMember(owner = "client!aaq", name = "t", descriptor = "(IB)Z", line = 317)
	boolean method23562(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		...
		if (this.anInt3216 * 1550739371 < 0) {
			this.anInt3216 = (local5.method21542((short) 5180) + (int) (Math.random() * (double) local5.method21544(-1721376394))) * -594453757;
		}
		@Pc(34) int local34 = this.method23604((short) -6568);
		if (local34 > 0) {
			if (local34 > arg0) {
				this.method23563(local34 - arg0, (byte) 2);
				return false;
			}
			arg0 -= local34;
			this.method23563(0, (byte) 2);
		}
		local1 = arg0 != 0;
		for (@Pc(63) int local63 = 0; local63 < arg0; local63++) {
			this.method23619(this.aClass263_5, this.anInt3216 * 1550739371, -1423813924);
			this.anInt3216 += -594453757;
			if (this.anInt3216 * 1550739371 >= local5.method21543((byte) 1)) {
				if (this.aClass263_5.anInt3872 * 1979961975 == -1 || this.anInt3221 * 916351469 == 2) {
					this.aBoolean532 = true;
				} else {
					@Pc(112) int local112 = local5.method21544(-1883707840) - this.aClass263_5.anInt3872 * 1979961975;
	...
	public final void method23563(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		this.anInt3217 = arg0 * 1368247043;
	}

	@OriginalMember(owner = "client!aaq", name = "o", descriptor = "(I)I", line = 142)
	public final int method23564(@OriginalArg(0) int arg0) {
		if (!this.method23578((byte) -106)) {
			return 0;
		}
		@Pc(5) int local5 = 0;
		if (this.method23578((byte) -38)) {
			if (this.aClass263_5.method26188(-2143900241)) {
	...
	public final void method23565(@OriginalArg(0) Class109 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (this.aClass263_5 == null) {
			return;
		}
		if (this.aClass263_5.anIntArray364 == null) {
			if (this.aClass263_5.method26188(-2125842634) && this.method23578((byte) -32)) {
				arg0.method6839(this.aClass17_5.aClass93_Sub1_Sub5_1, this.anInt3216 * 1550739371, arg1, this.aClass263_5.aBoolean671);
			}
		} else if (this.method23578((byte) -45)) {
	...
	public final void method23566(@OriginalArg(0) Class109 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		if (this.aClass263_5.anIntArray364 != null && this.method23578((byte) -71)) {
			arg0.method6840(this.aClass23_10.aClass93_Sub1_Sub10_2, this.aClass23_10.anInt72 * -1424564205, this.aClass23_10.aClass93_Sub1_Sub10_1, this.aClass23_10.anInt73 * -278335347, this.anInt3216 * 1550739371, this.aClass263_5.anIntArray369[this.anInt3223 * -1046590071], arg1, arg2, this.aClass263_5.aBoolean671, (int[]) null);
			if (this.aBoolean530 && this.aClass263_5.anIntArray365 != null && this.aClass23_9.aBoolean11) {
				arg0.method6840(this.aClass23_9.aClass93_Sub1_Sub10_2, this.aClass23_9.anInt72 * -1424564205, this.aClass23_9.aClass93_Sub1_Sub10_1, this.aClass23_9.anInt73 * -278335347, this.anInt3216 * 1550739371, this.aClass263_5.anIntArray369[this.anInt3223 * -1046590071], arg1, arg2, this.aClass263_5.aBoolean671, (int[]) null);
			}
		}
	}

	@OriginalMember(owner = "client!aaq", name = "q", descriptor = "(Lclient!do;B)V", line = 183)
	public final void method23567(@OriginalArg(0) Class109 arg0, @OriginalArg(1) byte arg1) {
		if (this.aClass263_5.anIntArray364 != null && this.method23578((byte) -115)) {
	...
	public final void method23568(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.method23559(arg0, 0, 0, false, (short) -5933);
	}
	...
	public final void method23569(@OriginalArg(0) Class109 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (this.aClass263_5.anIntArray364 != null && this.method23578((byte) -51)) {
			arg0.method6840(this.aClass23_10.aClass93_Sub1_Sub10_2, this.aClass23_10.anInt72 * -1424564205, this.aClass23_10.aClass93_Sub1_Sub10_1, this.aClass23_10.anInt73 * -278335347, this.anInt3216 * 1550739371, this.aClass263_5.anIntArray369[this.anInt3223 * -1046590071], arg1, arg2, this.aClass263_5.aBoolean671, (int[]) null);
			if (this.aBoolean530 && this.aClass263_5.anIntArray365 != null && this.aClass23_9.aBoolean11) {
				arg0.method6840(this.aClass23_9.aClass93_Sub1_Sub10_2, this.aClass23_9.anInt72 * -1424564205, this.aClass23_9.aClass93_Sub1_Sub10_1, this.aClass23_9.anInt73 * -278335347, this.anInt3216 * 1550739371, this.aClass263_5.anIntArray369[this.anInt3223 * -1046590071], arg1, arg2, this.aClass263_5.aBoolean671, (int[]) null);
			}
	...
	public final void method23570(@OriginalArg(0) int arg0) {
		this.method23595(0, (byte) -119);
	}

	@OriginalMember(owner = "client!aaq", name = "bz", descriptor = "()V", line = 223)
	public final void method23571() {
		this.method23595(0, (byte) -34);
	}

	@OriginalMember(owner = "client!aaq", name = "i", descriptor = "(II)V", line = 245)
	final void method23572(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aBoolean532 = false;
		this.anInt3217 = arg0 * 1368247043;
		this.anInt3218 = 0;
		this.anInt3216 = 0;
		if (this.aClass263_5 != null) {
			this.method23619(this.aClass263_5, this.anInt3216 * 1550739371, -1926814088);
		}
	}

	@OriginalMember(owner = "client!aaq", name = "j", descriptor = "(II)Z", line = 255)
	public final boolean method23573(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.aClass263_5 == null || arg0 == 0) {
			return false;
		} else if (this.aClass263_5.method26188(-2131877054)) {
			return this.method23562(arg0, (byte) 2);
		} else {
			if (this.anInt3217 * 234452907 > 0) {
				...
				this.anInt3217 = 0;
				this.method23613(this.aClass263_5, this.anInt3223 * -1046590071, 1913814018);
			}
			...
			while (arg0 > this.aClass263_5.anIntArray369[this.anInt3223 * -1046590071]) {
				...
				this.method23613(this.aClass263_5, this.anInt3223 * -1046590071, 1978211342);
				this.anInt3219 = this.anInt3223 * 753020423 + -1138701553;
				if (this.anInt3219 * -907361297 >= this.aClass263_5.anIntArray364.length) {
					if (this.aClass263_5.anInt3872 * 1979961975 == -1 && this.aBoolean531) {
						this.anInt3219 = 0;
	...
	final boolean method23574() {
		...
		if (this.aClass263_5.method26188(-2116920923)) {
	...
	public final boolean method23575(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(14) int local14;
		if (this.aClass263_5 == null | (local14 = arg0 - this.anInt3217 * 234452907) <= 0) {
			return false;
		} else if (this.aClass263_5.method26188(-2136200087)) {
			return true;
		} else {
	...
	public final void method23576(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1) {
	...
	final boolean method23578(@OriginalArg(0) byte arg0) {
		if (this.aClass263_5 == null) {
			return false;
		}
		@Pc(4) boolean local4 = false;
		if (this.aClass263_5.method26188(-2115125701)) {
	...
	final void method23579(@OriginalArg(0) int arg0) {
		if (this.aClass263_5 == null || this.aClass263_5.method26188(-2136628892)) {
	...
	public final boolean method23581(@OriginalArg(0) int arg0) {
	...
	final void method23582(@OriginalArg(0) int arg0) {
		...
		this.anInt3216 = 0;
		if (this.aClass263_5 != null) {
			this.method23619(this.aClass263_5, this.anInt3216 * 1550739371, -2070210134);
		}
	}
	...
	final void method23584(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) boolean arg4) {
		if (arg0 == this.method23554((byte) 112)) {
			return;
		}
		if (arg0 == -1) {
			this.aClass263_5 = null;
			...
			if (this.aClass263_5 == null || arg0 != this.aClass263_5.anInt3869 * 1707631335) {
				...
				if (this.aClass263_5 == null || this.aClass263_5.anIntArray364 == null && !this.aClass263_5.method26188(-2144736921)) {
					this.aClass263_5 = null;
					return;
				}
			} else if (this.aClass263_5.anInt3868 * 23893545 == 0) {
			...
			this.anInt3221 = arg2 * -2102109211;
			this.aBoolean531 = arg4;
			if (this.aClass263_5.method26188(-2104635092)) {
				if (arg3) {
					this.anInt3216 = 594453757;
				} else {
					this.anInt3216 = 0;
				}
				this.method23619(this.aClass263_5, this.anInt3216 * 1550739371, 1655088272);
			} else {
				if (arg3) {
					this.anInt3223 = (int) (Math.random() * (double) this.aClass263_5.anIntArray364.length) * 1904490681;
					this.anInt3216 = (int) (Math.random() * (double) this.aClass263_5.anIntArray369[this.anInt3223 * -1046590071]) * -594453757;
				...
				if (this.anInt3217 * 234452907 == 0) {
					this.method23613(this.aClass263_5, this.anInt3223 * -1046590071, 1947399853);
				}
			}
			this.aBoolean532 = false;
		}
	...
	public final void method23591(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) boolean arg2) {
		this.method23560(arg0, 0, 0, arg1, arg2, 656404241);
	}
	...
	public final void method23592(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) boolean arg2) {
		this.method23560(arg0, 0, 0, arg1, arg2, -1688189428);
	}
	...
	public final void method23593(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		this.method23560(arg0, arg1, arg2, arg3, false, 105300946);
	}
	...
	public final void method23595(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		if (this.aClass263_5.method26188(-2108131533)) {
			this.method23572(arg0, 1537481365);
			return;
		}
		this.anInt3223 = 0;
		...
		if (this.aClass263_5 != null & this.aClass263_5.anIntArray364 != null) {
			this.method23613(this.aClass263_5, this.anInt3223 * -1046590071, 1452416524);
			this.method23579(-809190853);
		}
	}
	...
	final void method23596(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) boolean arg4) {
		if (arg0 == this.method23554((byte) 119)) {
			return;
		}
		if (arg0 == -1) {
			this.aClass263_5 = null;
			...
			if (this.aClass263_5 == null || arg0 != this.aClass263_5.anInt3869 * 1707631335) {
				...
				if (this.aClass263_5 == null || this.aClass263_5.anIntArray364 == null && !this.aClass263_5.method26188(-2143677955)) {
					this.aClass263_5 = null;
					return;
				}
			} else if (this.aClass263_5.anInt3868 * 23893545 == 0) {
			...
			this.anInt3221 = arg2 * -2102109211;
			this.aBoolean531 = arg4;
			if (this.aClass263_5.method26188(-2130157773)) {
				if (arg3) {
					this.anInt3216 = 594453757;
				} else {
					this.anInt3216 = 0;
				}
				this.method23619(this.aClass263_5, this.anInt3216 * 1550739371, 807580237);
			} else {
				if (arg3) {
					this.anInt3223 = (int) (Math.random() * (double) this.aClass263_5.anIntArray364.length) * 1904490681;
					this.anInt3216 = (int) (Math.random() * (double) this.aClass263_5.anIntArray369[this.anInt3223 * -1046590071]) * -594453757;
				...
				if (this.anInt3217 * 234452907 == 0) {
					this.method23613(this.aClass263_5, this.anInt3223 * -1046590071, 1582404393);
				}
			}
			this.aBoolean532 = false;
		}
	...
	final void method23598(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) boolean arg4) {
		if (arg0 == this.method23554((byte) 48)) {
			return;
		}
		if (arg0 == -1) {
			this.aClass263_5 = null;
			...
			if (this.aClass263_5 == null || arg0 != this.aClass263_5.anInt3869 * 1707631335) {
				...
				if (this.aClass263_5 == null || this.aClass263_5.anIntArray364 == null && !this.aClass263_5.method26188(-2130580654)) {
					this.aClass263_5 = null;
					return;
				}
			} else if (this.aClass263_5.anInt3868 * 23893545 == 0) {
			...
			this.anInt3221 = arg2 * -2102109211;
			this.aBoolean531 = arg4;
			if (this.aClass263_5.method26188(-2096144966)) {
				if (arg3) {
					this.anInt3216 = 594453757;
				} else {
					this.anInt3216 = 0;
				}
				this.method23619(this.aClass263_5, this.anInt3216 * 1550739371, 1982537217);
			} else {
				if (arg3) {
					this.anInt3223 = (int) (Math.random() * (double) this.aClass263_5.anIntArray364.length) * 1904490681;
					this.anInt3216 = (int) (Math.random() * (double) this.aClass263_5.anIntArray369[this.anInt3223 * -1046590071]) * -594453757;
				...
				if (this.anInt3217 * 234452907 == 0) {
					this.method23613(this.aClass263_5, this.anInt3223 * -1046590071, 1973688423);
				}
			}
			this.aBoolean532 = false;
		}
	...
	public final int method23601() {
		if (!this.method23578((byte) -117)) {
			return 0;
		}
		@Pc(5) int local5 = 0;
		if (this.method23578((byte) -119)) {
			if (this.aClass263_5.method26188(-2123239582)) {
				local5 |= this.aClass17_5.anInt59 * 1170162993;
			} else {
				local5 |= this.aClass23_10.anInt71 * 2023242135;
				if (this.aBoolean530 && this.aClass263_5.anIntArray365 != null) {
	...
	public final void method23602(@OriginalArg(0) Class109 arg0, @OriginalArg(1) int arg1) {
		...
		if (this.aClass263_5.anIntArray364 == null) {
			if (this.aClass263_5.method26188(-2095615592) && this.method23578((byte) -73)) {
				arg0.method6839(this.aClass17_5.aClass93_Sub1_Sub5_1, this.anInt3216 * 1550739371, arg1, this.aClass263_5.aBoolean671);
			}
		} else if (this.method23578((byte) -127)) {
			arg0.method6838(this.aClass23_10.aClass93_Sub1_Sub10_2, this.aClass23_10.anInt72 * -1424564205, this.aClass23_10.aClass93_Sub1_Sub10_1, this.aClass23_10.anInt73 * -278335347, this.anInt3216 * 1550739371, this.aClass263_5.anIntArray369[this.anInt3223 * -1046590071], arg1, this.aClass263_5.aBoolean671);
			if (this.aBoolean530 && this.aClass263_5.anIntArray365 != null && this.aClass23_9.aBoolean11) {
				arg0.method6838(this.aClass23_9.aClass93_Sub1_Sub10_2, this.aClass23_9.anInt72 * -1424564205, this.aClass23_9.aClass93_Sub1_Sub10_1, this.aClass23_9.anInt73 * -278335347, this.anInt3216 * 1550739371, this.aClass263_5.anIntArray369[this.anInt3223 * -1046590071], arg1, this.aClass263_5.aBoolean671);
			}
	...
	public final void method23603(@OriginalArg(0) Class109 arg0, @OriginalArg(1) int arg1) {
		...
		if (this.aClass263_5.anIntArray364 == null) {
			if (this.aClass263_5.method26188(-2082974407) && this.method23578((byte) -53)) {
				arg0.method6839(this.aClass17_5.aClass93_Sub1_Sub5_1, this.anInt3216 * 1550739371, arg1, this.aClass263_5.aBoolean671);
			}
		} else if (this.method23578((byte) -17)) {
			arg0.method6838(this.aClass23_10.aClass93_Sub1_Sub10_2, this.aClass23_10.anInt72 * -1424564205, this.aClass23_10.aClass93_Sub1_Sub10_1, this.aClass23_10.anInt73 * -278335347, this.anInt3216 * 1550739371, this.aClass263_5.anIntArray369[this.anInt3223 * -1046590071], arg1, this.aClass263_5.aBoolean671);
			if (this.aBoolean530 && this.aClass263_5.anIntArray365 != null && this.aClass23_9.aBoolean11) {
				arg0.method6838(this.aClass23_9.aClass93_Sub1_Sub10_2, this.aClass23_9.anInt72 * -1424564205, this.aClass23_9.aClass93_Sub1_Sub10_1, this.aClass23_9.anInt73 * -278335347, this.anInt3216 * 1550739371, this.aClass263_5.anIntArray369[this.anInt3223 * -1046590071], arg1, this.aClass263_5.aBoolean671);
			}
	...
	public final int method23604(@OriginalArg(0) short arg0) {
		return this.anInt3217 * 234452907;
	}
	...
	public final void method23605(@OriginalArg(0) Class109 arg0) {
		if (this.aClass263_5.anIntArray364 != null && this.method23578((byte) -68)) {
			arg0.method7012(this.aClass23_10.aClass93_Sub1_Sub10_2, this.aClass23_10.anInt72 * -1424564205);
			if (this.aBoolean530 && this.aClass263_5.anIntArray365 != null && this.aClass23_9.aBoolean11) {
				arg0.method7012(this.aClass23_9.aClass93_Sub1_Sub10_2, this.aClass23_9.anInt72 * -1424564205);
			}
	...
	public final void method23606(@OriginalArg(0) Class109 arg0) {
		if (this.aClass263_5.anIntArray364 != null && this.method23578((byte) -31)) {
			arg0.method7012(this.aClass23_10.aClass93_Sub1_Sub10_2, this.aClass23_10.anInt72 * -1424564205);
			if (this.aBoolean530 && this.aClass263_5.anIntArray365 != null && this.aClass23_9.aBoolean11) {
				arg0.method7012(this.aClass23_9.aClass93_Sub1_Sub10_2, this.aClass23_9.anInt72 * -1424564205);
			}
	...
	public final void method23607(@OriginalArg(0) Class109 arg0) {
		if (this.aClass263_5.anIntArray364 != null && this.method23578((byte) -56)) {
			arg0.method7012(this.aClass23_10.aClass93_Sub1_Sub10_2, this.aClass23_10.anInt72 * -1424564205);
			if (this.aBoolean530 && this.aClass263_5.anIntArray365 != null && this.aClass23_9.aBoolean11) {
				arg0.method7012(this.aClass23_9.aClass93_Sub1_Sub10_2, this.aClass23_9.anInt72 * -1424564205);
			}
	...
	public static final void method23608(@OriginalArg(0) Class109 arg0, @OriginalArg(1) Class19 arg1, @OriginalArg(2) Class19 arg2) {
		...
		if (local10.anIntArray364 == null) {
			if (local10.method26188(-2126347932)) {
				...
				} else if (local13.method26188(-2130261004)) {
		...
		} else if (local13.method26188(-2086704513)) {
	...
	public static final void method23609(@OriginalArg(0) Class109 arg0, @OriginalArg(1) Class19 arg1, @OriginalArg(2) Class19 arg2) {
		if (!arg1.method23578((byte) -92) || !arg2.method23578((byte) -17)) {
			return;
		}
		@Pc(10) Class263 local10 = arg1.aClass263_5;
		@Pc(13) Class263 local13 = arg2.aClass263_5;
		if (local10.anIntArray364 == null) {
			if (local10.method26188(-2084790977)) {
				if (local13.anIntArray364 != null) {
					arg0.method6843(arg1.aClass17_5.aClass93_Sub1_Sub5_1, arg1.anInt3216 * 1550739371, arg2.aClass23_10.aClass93_Sub1_Sub10_2, arg2.aClass23_10.anInt72 * -1424564205, arg2.aClass23_10.aClass93_Sub1_Sub10_1, arg2.aClass23_10.anInt73 * -278335347, arg2.anInt3216 * 1550739371, local13.anIntArray369[arg2.anInt3223 * -1046590071], local10.aClass268_1 == null ? null : local10.aClass268_1.aBooleanArray23, local10.aBoolean671 | local13.aBoolean671);
				} else if (local13.method26188(-2140529663)) {
					arg0.method6816(arg1.aClass17_5.aClass93_Sub1_Sub5_1, arg1.anInt3216 * 1550739371, arg2.aClass17_5.aClass93_Sub1_Sub5_1, arg2.anInt3216 * 1550739371, local10.aClass268_1 == null ? null : local10.aClass268_1.aBooleanArray23, local10.aBoolean671);
				}
			}
		} else if (local13.anIntArray364 != null) {
			arg0.method6831(arg1.aClass23_10.aClass93_Sub1_Sub10_2, arg1.aClass23_10.anInt72 * -1424564205, arg1.aClass23_10.aClass93_Sub1_Sub10_1, arg1.aClass23_10.anInt73 * -278335347, arg1.anInt3216 * 1550739371, local10.anIntArray369[arg1.anInt3223 * -1046590071], arg2.aClass23_10.aClass93_Sub1_Sub10_2, arg2.aClass23_10.anInt72 * -1424564205, arg2.aClass23_10.aClass93_Sub1_Sub10_1, arg2.aClass23_10.anInt73 * -278335347, arg2.anInt3216 * 1550739371, local13.anIntArray369[arg2.anInt3223 * -1046590071], local10.aClass268_1 == null ? null : local10.aClass268_1.aBooleanArray23, local10.aBoolean671 | local13.aBoolean671);
		} else if (local13.method26188(-2129244954)) {
			arg0.method6844(arg1.aClass23_10.aClass93_Sub1_Sub10_2, arg1.aClass23_10.anInt72 * -1424564205, arg1.aClass23_10.aClass93_Sub1_Sub10_1, arg1.aClass23_10.anInt73 * -278335347, arg1.anInt3216 * 1550739371, local10.anIntArray369[arg1.anInt3223 * -1046590071], arg2.aClass17_5.aClass93_Sub1_Sub5_1, arg2.anInt3216 * 1550739371, local10.aClass268_1 == null ? null : local10.aClass268_1.aBooleanArray23, local10.aBoolean671 | local13.aBoolean671);
		}
	}
	...
	void method23613(@OriginalArg(0) Class263 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	}
	...
	boolean method23614(@OriginalArg(0) int arg0) {
		...
		if (this.anInt3216 * 1550739371 < 0) {
			this.anInt3216 = (local5.method21542((short) 5959) + (int) (Math.random() * (double) local5.method21544(-285154569))) * -594453757;
		}
		@Pc(34) int local34 = this.method23604((short) -25572);
		if (local34 > 0) {
			if (local34 > arg0) {
				this.method23563(local34 - arg0, (byte) 2);
				return false;
		...
		local1 = arg0 != 0;
		for (@Pc(63) int local63 = 0; local63 < arg0; local63++) {
			this.method23619(this.aClass263_5, this.anInt3216 * 1550739371, -1797166944);
			this.anInt3216 += -594453757;
			if (this.anInt3216 * 1550739371 >= local5.method21543((byte) 1)) {
				if (this.aClass263_5.anInt3872 * 1979961975 == -1 || this.anInt3221 * 916351469 == 2) {
					this.aBoolean532 = true;
				} else {
					@Pc(112) int local112 = local5.method21544(-1470756514) - this.aClass263_5.anInt3872 * 1979961975;
					this.anInt3216 = local112 * -594453757;
					if (this.anInt3221 * 916351469 == 0) {
						this.anInt3218 += 254052143;
					}
	...
	public final boolean method23618(@OriginalArg(0) int arg0) {
		...
		if (this.aClass263_5 == null | (local14 = arg0 - this.anInt3217 * 234452907) <= 0) {
			return false;
		} else if (this.aClass263_5.method26188(-2114286250)) {
			return true;
		} else {
			return this.aClass263_5.aBoolean669 | this.anInt3216 * 1550739371 + local14 > this.aClass263_5.anIntArray369[this.anInt3223 * -1046590071];
		}
	...
	void method23619(@OriginalArg(0) Class263 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.method23613(arg0, arg1, 1666909746);
	}

	@OriginalMember(owner = "client!aaq", name = "br", descriptor = "(I)V", line = 227)
	public final void method23620(@OriginalArg(0) int arg0) {
		if (this.aClass263_5.method26188(-2117731599)) {
			this.method23572(arg0, 1328005056);
			return;
		}
		this.anInt3223 = 0;
		this.anInt3219 = (this.aClass263_5.anIntArray364.length > 1 ? 1 : -1) * -1138701553;
		...
		this.anInt3218 = 0;
		if (this.aClass263_5 != null & this.aClass263_5.anIntArray364 != null) {
			this.method23613(this.aClass263_5, this.anInt3223 * -1046590071, 1547032144);
			this.method23579(-809190853);
		}
	}
	...
	public final void method23621(@OriginalArg(0) int arg0) {
		if (this.aClass263_5.method26188(-2138183654)) {
			this.method23572(arg0, 1712662339);
			return;
		}
		this.anInt3223 = 0;
		this.anInt3219 = (this.aClass263_5.anIntArray364.length > 1 ? 1 : -1) * -1138701553;
		...
		this.anInt3218 = 0;
		if (this.aClass263_5 != null & this.aClass263_5.anIntArray364 != null) {
			this.method23613(this.aClass263_5, this.anInt3223 * -1046590071, 1970032513);
			this.method23579(-809190853);
		}
	}
	...
	public final void method23622(@OriginalArg(0) int arg0) {
		if (this.aClass263_5.method26188(-2134932087)) {
			this.method23572(arg0, 1314588444);
			return;
		}
		this.anInt3223 = 0;
		this.anInt3219 = (this.aClass263_5.anIntArray364.length > 1 ? 1 : -1) * -1138701553;
		...
		this.anInt3218 = 0;
		if (this.aClass263_5 != null & this.aClass263_5.anIntArray364 != null) {
			this.method23613(this.aClass263_5, this.anInt3223 * -1046590071, 2070177952);
			this.method23579(-809190853);
		}
	}
	...
	final void method23624(@OriginalArg(0) int arg0) {
		...
		this.anInt3216 = 0;
		if (this.aClass263_5 != null) {
			this.method23619(this.aClass263_5, this.anInt3216 * 1550739371, -1914850827);
		}
	}
	...
	public final boolean method23625(@OriginalArg(0) int arg0) {
		if (this.aClass263_5 == null || arg0 == 0) {
			return false;
		} else if (this.aClass263_5.method26188(-2105731325)) {
			return this.method23562(arg0, (byte) 2);
		} else {
			if (this.anInt3217 * 234452907 > 0) {
				if (this.anInt3217 * 234452907 > arg0) {
				...
				arg0 -= this.anInt3217 * 234452907;
				this.anInt3217 = 0;
				this.method23613(this.aClass263_5, this.anInt3223 * -1046590071, 1416471258);
			}
			arg0 += this.anInt3216 * 1550739371;
			@Pc(69) boolean local69 = this.aClass263_5.aBoolean669 | Class263.aBoolean670;
			if (arg0 > 100 && this.aClass263_5.anInt3872 * 1979961975 > 0) {
			...
			while (arg0 > this.aClass263_5.anIntArray369[this.anInt3223 * -1046590071]) {
				...
				this.method23613(this.aClass263_5, this.anInt3223 * -1046590071, 1758171334);
				this.anInt3219 = this.anInt3223 * 753020423 + -1138701553;
				if (this.anInt3219 * -907361297 >= this.aClass263_5.anIntArray364.length) {
					if (this.aClass263_5.anInt3872 * 1979961975 == -1 && this.aBoolean531) {
						this.anInt3219 = 0;
	...
	boolean method23627(@OriginalArg(0) int arg0) {
		...
		if (this.anInt3216 * 1550739371 < 0) {
			this.anInt3216 = (local5.method21542((short) 10284) + (int) (Math.random() * (double) local5.method21544(-813882426))) * -594453757;
		}
		@Pc(34) int local34 = this.method23604((short) -18107);
		if (local34 > 0) {
			if (local34 > arg0) {
				this.method23563(local34 - arg0, (byte) 2);
				return false;
		...
		local1 = arg0 != 0;
		for (@Pc(63) int local63 = 0; local63 < arg0; local63++) {
			this.method23619(this.aClass263_5, this.anInt3216 * 1550739371, 743882760);
			this.anInt3216 += -594453757;
			if (this.anInt3216 * 1550739371 >= local5.method21543((byte) 1)) {
				if (this.aClass263_5.anInt3872 * 1979961975 == -1 || this.anInt3221 * 916351469 == 2) {
					this.aBoolean532 = true;
				} else {
					@Pc(112) int local112 = local5.method21544(3740565) - this.aClass263_5.anInt3872 * 1979961975;
					this.anInt3216 = local112 * -594453757;
					if (this.anInt3221 * 916351469 == 0) {
						this.anInt3218 += 254052143;
					}
	...
	public final void method23628(@OriginalArg(0) short arg0) {
		this.anInt3218 = 0;
	}
	...
	void method23629(@OriginalArg(0) Class263 arg0, @OriginalArg(1) int arg1) {
		this.method23613(arg0, arg1, 1629236191);
	}
	...
	final boolean method23630() {
		...
		@Pc(4) boolean local4 = false;
		if (this.aClass263_5.method26188(-2097770817)) {
	...
	final void method23632() {
		if (this.aClass263_5 == null || this.aClass263_5.method26188(-2144110903)) {
	...
	final void method23633() {
		if (this.aClass263_5 == null || this.aClass263_5.method26188(-2125459299)) {
	...
	static final void method23634(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (Class383.method28145(arg0, (int[]) null, 1623541034)) {
			Class432.method28789(Class166_Sub1.aClass320Array1[arg0].aClass312Array3, -1, -1849424515);
		}
	}

	@OriginalMember(owner = "client!aaq", name = "n", descriptor = "(I)Lclient!ajq;", line = 19)
	static Class149_Sub5 method23635(@OriginalArg(0) int arg0) {
