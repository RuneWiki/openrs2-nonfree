...
public class Class671 {
	...
	void method32961() {
		this.aClass104_13.method20542(this.aClass672_1.aFloat352, this.aClass672_1.aFloat345, this.aClass672_1.aFloat348, -1786220465);
	}
	...
	public void method32962(@OriginalArg(0) Class532 arg0) {
		@Pc(4) Class672 local4 = this.method33033(arg0, -3659365);
		if (this.aClass684_1 == null) {
			this.method32991(local4, anInt5856 * -1834375703, 2146172716);
		} else {
			this.aClass672_4.method33067(local4, (byte) -24);
			this.aClass672_4.method33047(this, this.aClass684_1, 1795184873);
			this.method32991(this.aClass672_4, this.aClass684_1.method33359(1204992034), 2146172716);
		}
		this.method32974(1689635280);
		this.method32992(1902274160);
		this.method32981(28630617);
	}

	@OriginalMember(owner = "client!xu", name = "n", descriptor = "(Lclient!rl;B)V", line = 83)
	public void method32963(@OriginalArg(0) Class532 arg0, @OriginalArg(1) byte arg1) {
		@Pc(4) Class672 local4 = this.method33033(arg0, 1099924204);
		if (this.aClass684_1 == null) {
			this.method32991(local4, anInt5856 * -1834375703, 2146172716);
		} else {
			this.aClass672_4.method33067(local4, (byte) 14);
			this.aClass672_4.method33047(this, this.aClass684_1, 1795184873);
			this.method32991(this.aClass672_4, this.aClass684_1.method33359(1009613677), 2146172716);
		}
		this.method32974(1598372657);
		this.method33038(-799862065);
		this.method33021(-1930484933);
		this.method32985((byte) -71);
	}

	@OriginalMember(owner = "client!xu", name = "m", descriptor = "(Lclient!rl;Lclient!yj;II)V", line = 97)
	public void method32964(@OriginalArg(0) Class532 arg0, @OriginalArg(1) Class684 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.aClass684_1 = arg1;
		@Pc(7) Class672 local7 = this.method33033(arg0, -1634058228);
		if (this.aClass684_1 == null) {
			this.method32991(local7, arg2, 2146172716);
		...
		this.aClass672_4.method33067(local7, (byte) -67);
		this.aClass672_4.method33047(this, this.aClass684_1, 1795184873);
		this.method32991(this.aClass672_4, arg2, 2146172716);
	}

	@OriginalMember(owner = "client!xu", name = "k", descriptor = "(I)Lclient!yj;", line = 112)
	public Class684 method32965(@OriginalArg(0) int arg0) {
		return this.aClass684_1;
	}

	@OriginalMember(owner = "client!xu", name = "f", descriptor = "(I)Lclient!xv;", line = 116)
	public Class672 method32966(@OriginalArg(0) int arg0) {
		return this.aClass672_1;
	}

	@OriginalMember(owner = "client!xu", name = "t", descriptor = "(I)V", line = 326)
	public void method32967(@OriginalArg(0) int arg0) {
		this.aClass104_13.method20521(((float) Class51.aClass93_Sub36_1.aClass166_Sub7_1.method15502((byte) -125) * 0.1F + 0.7F + client.aClass532_1.method30448(-1769209909)) * 1.1523438F);
	...
	public void method32968(@OriginalArg(0) int arg0) {
		this.aClass240_93.method25833((byte) 0);
		this.aClass240_94.method25833((byte) -48);
		this.aClass240_95.method25833((byte) -109);
	}

	@OriginalMember(owner = "client!xu", name = "u", descriptor = "(II)Lclient!dz;", line = 135)
	Class107 method32969(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	Class562 method32970(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (local31 == null) {
			local31 = Class220.method25542(arg0, arg1, arg2, arg3, Class123.aClass32_Sub11_2, Class51.aClass32_Sub9_1, 212851357);
	...
	Class102 method32971(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	...
	void method32974(@OriginalArg(0) int arg0) {
		if (this.anInt5858 * 2008775727 < 0) {
			return;
		}
		@Pc(7) long local7 = Class305.method26796(585591057);
		this.anInt5858 = (int) ((long) this.anInt5858 - (local7 - this.aLong304 * 5957186404395821059L) * 1162824399L);
		if (this.anInt5858 * 2008775727 > 0) {
			this.aClass672_1.method33078(this.aClass104_13, this.aClass672_2, this.aClass672_3, (float) (this.anInt5857 * -4832943 - this.anInt5858 * 2008775727) / (float) (this.anInt5857 * -4832943), 2130343103);
		} else {
			this.aClass672_1.method33067(this.aClass672_3, (byte) 83);
			if (this.aClass672_1.aClass562_3 != null) {
				this.aClass672_1.aClass562_3.method31174(1796102726);
			}
	...
	public void method32975(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(6) Class672 local6 = this.aClass672ArrayArray1[arg0][arg1];
		if (local6 != null) {
			this.aClass472_64.method29538(local6.aClass472_65);
		}
		this.method32992(1194687224);
	}

	@OriginalMember(owner = "client!xu", name = "w", descriptor = "(Lclient!xu;I)V", line = 120)
	public void method32976(@OriginalArg(0) Class671 arg0, @OriginalArg(1) int arg1) {
		this.aClass672_1.method33067(arg0.aClass672_1, (byte) 78);
		this.aClass672_2.method33067(arg0.aClass672_2, (byte) 90);
		this.aClass672_3.method33067(arg0.aClass672_3, (byte) -40);
	...
	void method32977() {
		...
		if (!this.aBoolean867) {
			if (this.aClass672_1.anIntArray515[0] > -1) {
				local6 = this.method32971(this.aClass672_1.anIntArray515[0], (byte) 92);
			}
			if (this.aClass672_1.anIntArray515[1] > -1) {
				local8 = this.method32971(this.aClass672_1.anIntArray515[1], (byte) 64);
			}
			if (this.aClass672_1.anIntArray515[2] > -1) {
				local10 = this.method32971(this.aClass672_1.anIntArray515[2], (byte) 7);
			}
		...
		if (this.anIntArray514[0] > -1) {
			local6 = this.method32971(this.anIntArray514[0], (byte) 6);
		}
		if (this.anIntArray514[1] > -1) {
			local8 = this.method32971(this.anIntArray514[1], (byte) 33);
		}
		if (this.anIntArray514[2] > -1) {
			local10 = this.method32971(this.anIntArray514[2], (byte) 76);
		}
	...
	void method32979() {
		this.aClass104_13.method20521(((float) Class51.aClass93_Sub36_1.aClass166_Sub7_1.method15502((byte) -25) * 0.1F + 0.7F + client.aClass532_1.method30448(-1772387017)) * this.aClass672_1.aFloat349);
	...
	public void method32980(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		this.aClass104_13.method20521(((float) Class51.aClass93_Sub36_1.aClass166_Sub7_1.method15502((byte) -34) * 0.1F + 0.7F + client.aClass532_1.method30448(-374350000)) * arg0);
		this.aClass104_13.method20522(arg3, arg1, arg2, (float) (arg4 << 2), (float) (arg5 << 2), (float) (arg6 << 2));
		this.aClass104_13.method20815(this.method32969(arg7, 1094578849));
	}

	@OriginalMember(owner = "client!xu", name = "b", descriptor = "(I)V", line = 268)
	public void method32981(@OriginalArg(0) int arg0) {
		@Pc(1) byte local1 = 0;
		@Pc(13) int local13 = (this.aClass672_1.anInt5861 * -2139322713 + 256 << 2) + local1;
		this.aClass104_13.method20871(this.aClass672_1.anInt5860 * -2016142599, Class51.aClass93_Sub36_1.aClass166_Sub2_1.method15376(-1722659830) == 1 ? local13 : -1, 0);
	}

	@OriginalMember(owner = "client!xu", name = "c", descriptor = "(B)V", line = 176)
	public void method32982(@OriginalArg(0) byte arg0) {
	...
	public void method32983(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class672 arg2, @OriginalArg(3) int arg3) {
		this.aClass672ArrayArray1[arg0][arg1] = arg2;
	}

	@OriginalMember(owner = "client!xu", name = "g", descriptor = "(B)V", line = 284)
	void method32984(@OriginalArg(0) byte arg0) {
		this.aBoolean868 = false;
		this.aFloat340 = 1.0F;
		this.aFloat341 = 0.0F;
		this.aFloat342 = 1.0F;
	...
	void method32985(@OriginalArg(0) byte arg0) {
		if (!this.aClass104_13.method20537()) {
			return;
		}
		@Pc(6) Class102 local6 = null;
		...
		if (!this.aBoolean867) {
			if (this.aClass672_1.anIntArray515[0] > -1) {
				local6 = this.method32971(this.aClass672_1.anIntArray515[0], (byte) 100);
			}
			if (this.aClass672_1.anIntArray515[1] > -1) {
				local8 = this.method32971(this.aClass672_1.anIntArray515[1], (byte) 13);
			}
			if (this.aClass672_1.anIntArray515[2] > -1) {
				local10 = this.method32971(this.aClass672_1.anIntArray515[2], (byte) 82);
			}
			this.aClass104_13.method20538(local6, this.aClass672_1.aFloatArray121[0], local8, this.aClass672_1.aFloatArray121[1], local10, this.aClass672_1.aFloatArray121[2]);
			return;
		}
		if (this.anIntArray514[0] > -1) {
			local6 = this.method32971(this.anIntArray514[0], (byte) 58);
		}
		if (this.anIntArray514[1] > -1) {
			local8 = this.method32971(this.anIntArray514[1], (byte) 93);
		}
		if (this.anIntArray514[2] > -1) {
			local10 = this.method32971(this.anIntArray514[2], (byte) 25);
		}
		this.aClass104_13.method20538(local6, this.aFloatArray120[0], local8, this.aFloatArray120[1], local10, this.aFloatArray120[2]);
	}
	...
	public void method32987(@OriginalArg(0) Class532 arg0, @OriginalArg(1) byte arg1) {
		@Pc(4) Class672 local4 = this.method33033(arg0, 838237152);
		if (this.aClass684_1 == null) {
			this.method32991(local4, anInt5856 * -1834375703, 2146172716);
		} else {
			this.aClass672_4.method33067(local4, (byte) 57);
			this.aClass672_4.method33047(this, this.aClass684_1, 1795184873);
			this.method32991(this.aClass672_4, this.aClass684_1.method33359(1274431884), 2146172716);
		}
		this.method32974(-199616452);
		this.method32992(-197090970);
		this.method32981(1413467815);
	}
	...
	public void method32988(@OriginalArg(0) Class532 arg0) {
		@Pc(4) Class672 local4 = this.method33033(arg0, 727720267);
		if (this.aClass684_1 == null) {
			this.method32991(local4, anInt5856 * -1834375703, 2146172716);
		} else {
			this.aClass672_4.method33067(local4, (byte) 3);
			this.aClass672_4.method33047(this, this.aClass684_1, 1795184873);
			this.method32991(this.aClass672_4, this.aClass684_1.method33359(1414241571), 2146172716);
		}
		this.method32974(1169680442);
		this.method32992(104147);
		this.method32981(958851152);
	}
	...
	public void method32989(@OriginalArg(0) Class532 arg0) {
		@Pc(4) Class672 local4 = this.method33033(arg0, -567998592);
		if (this.aClass684_1 == null) {
			this.method32991(local4, anInt5856 * -1834375703, 2146172716);
		} else {
			this.aClass672_4.method33067(local4, (byte) 60);
			this.aClass672_4.method33047(this, this.aClass684_1, 1795184873);
			this.method32991(this.aClass672_4, this.aClass684_1.method33359(-1171360745), 2146172716);
		}
		this.method32974(482247636);
		this.method32992(-2135758414);
		this.method32981(-885111609);
	}
	...
	public void method32990(@OriginalArg(0) Class532 arg0) {
		@Pc(4) Class672 local4 = this.method33033(arg0, -1981936495);
		if (this.aClass684_1 == null) {
			this.method32991(local4, anInt5856 * -1834375703, 2146172716);
		} else {
			this.aClass672_4.method33067(local4, (byte) 48);
			this.aClass672_4.method33047(this, this.aClass684_1, 1795184873);
			this.method32991(this.aClass672_4, this.aClass684_1.method33359(1164572716), 2146172716);
		}
		this.method32974(-1126187412);
		this.method32992(1215882651);
		this.method32981(-865399071);
	}

	@OriginalMember(owner = "client!xu", name = "o", descriptor = "(Lclient!xv;II)V", line = 213)
	void method32991(@OriginalArg(0) Class672 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (this.aBoolean866) {
			this.aBoolean866 = false;
			arg1 = 0;
		}
		if (this.aClass672_3.method33055(arg0, 60034890)) {
			return;
		}
		this.aClass672_3.method33067(arg0, (byte) 30);
		this.aLong304 = Class305.method26796(1773033538) * 3202058925841662635L;
		this.anInt5857 = (this.anInt5858 = arg1 * 1162824399) * 1573029247;
		if (this.anInt5857 * -4832943 == 0) {
			return;
		}
		this.aClass672_2.method33067(this.aClass672_1, (byte) 1);
		if (this.aClass672_1.aClass562_3 == null) {
			return;
		}
		if (this.aClass672_1.aClass562_3.method31176((byte) 39)) {
			this.aClass672_1.aClass562_3 = this.aClass672_2.aClass562_3 = this.aClass672_1.aClass562_3.method31158(-1722669835);
		}
		if (this.aClass672_1.aClass562_3 != null && this.aClass672_3.aClass562_3 != this.aClass672_1.aClass562_3) {
			this.aClass672_1.aClass562_3.method31178(this.aClass672_3.aClass562_3, 1867099837);
		}
	}

	@OriginalMember(owner = "client!xu", name = "q", descriptor = "(I)V", line = 256)
	void method32992(@OriginalArg(0) int arg0) {
		this.aClass104_13.method20521(((float) Class51.aClass93_Sub36_1.aClass166_Sub7_1.method15502((byte) -49) * 0.1F + 0.7F + client.aClass532_1.method30448(-676345909)) * this.aClass672_1.aFloat349);
		this.aClass104_13.method20522(this.aClass672_1.anInt5862 * 1540075243, this.aClass672_1.aFloat344, this.aClass672_1.aFloat346, (float) ((int) this.aClass472_64.aFloat317 << 2), (float) ((int) this.aClass472_64.aFloat318 << 2), (float) ((int) this.aClass472_64.aFloat319 << 2));
		this.aClass104_13.method20815(this.aClass672_1.aClass107_2);
	}
	...
	public void method32993(@OriginalArg(0) Class532 arg0, @OriginalArg(1) Class684 arg1, @OriginalArg(2) int arg2) {
		this.aClass684_1 = arg1;
		@Pc(7) Class672 local7 = this.method33033(arg0, -704688771);
		if (this.aClass684_1 == null) {
			this.method32991(local7, arg2, 2146172716);
			this.aClass672_4 = null;
			return;
		...
		this.aClass672_4.method33067(local7, (byte) -28);
		this.aClass672_4.method33047(this, this.aClass684_1, 1795184873);
		this.method32991(this.aClass672_4, arg2, 2146172716);
	}
	...
	public void method32994(@OriginalArg(0) Class532 arg0, @OriginalArg(1) Class684 arg1, @OriginalArg(2) int arg2) {
		this.aClass684_1 = arg1;
		@Pc(7) Class672 local7 = this.method33033(arg0, -758829604);
		if (this.aClass684_1 == null) {
			this.method32991(local7, arg2, 2146172716);
			this.aClass672_4 = null;
			return;
		...
		this.aClass672_4.method33067(local7, (byte) -1);
		this.aClass672_4.method33047(this, this.aClass684_1, 1795184873);
		this.method32991(this.aClass672_4, arg2, 2146172716);
	}
	...
	public void method32999() {
		this.aClass104_13.method20521(((float) Class51.aClass93_Sub36_1.aClass166_Sub7_1.method15502((byte) -1) * 0.1F + 0.7F + client.aClass532_1.method30448(715014192)) * 1.1523438F);
		this.aClass104_13.method20522(16777215, 0.69921875F, 1.2F, -200.0F, -240.0F, -200.0F);
		this.aClass104_13.method20871(13156520, -1, 0);
		this.aClass104_13.method20815(aClass107_1);
	}
	...
	public Class671(@OriginalArg(0) Class104 arg0, @OriginalArg(1) Class497 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		if (anInt5859 * 933128323 != -1) {
			aClass107_1 = this.method32969(anInt5859 * 933128323, 1519682227);
		}
		aClass562_2 = null;
		...
		this.method33003(-2082959795);
		this.method32986(1378705770);
		this.method32984((byte) 86);
	}
	...
	Class672 method33000(@OriginalArg(0) Class532 arg0) {
		...
		@Pc(3) int local3 = -1;
		@Pc(5) int local5 = -1;
		if (Class1.method15(client.anInt3435 * -849002901, -1212653237) || Class56.method18034(client.anInt3435 * -849002901, -1497248091)) {
			...
			if (local3 < 0 || local3 >= arg0.method30444(-485462668) >> 3 || local5 < 0 || local5 >= arg0.method30474((short) 128) >> 3) {
				local3 = arg0.method30444(-295129019) >> 4;
				local5 = arg0.method30474((short) 128) >> 4;
			}
		}
	...
	public void method33001() {
		this.aClass240_93.method25833((byte) -49);
		this.aClass240_94.method25833((byte) -80);
		this.aClass240_95.method25833((byte) -2);
	}

	@OriginalMember(owner = "client!xu", name = "ax", descriptor = "()V", line = 129)
	public void method33002() {
		this.aClass240_93.method25833((byte) -27);
		this.aClass240_94.method25833((byte) -127);
		this.aClass240_95.method25833((byte) -86);
	}

	@OriginalMember(owner = "client!xu", name = "y", descriptor = "(I)V", line = 252)
	public void method33003(@OriginalArg(0) int arg0) {
	...
	public void method33007(@OriginalArg(0) Class532 arg0) {
		@Pc(4) Class672 local4 = this.method33033(arg0, -1660041769);
		if (this.aClass684_1 == null) {
			this.method32991(local4, anInt5856 * -1834375703, 2146172716);
		} else {
			this.aClass672_4.method33067(local4, (byte) -13);
			this.aClass672_4.method33047(this, this.aClass684_1, 1795184873);
			this.method32991(this.aClass672_4, this.aClass684_1.method33359(-1490668367), 2146172716);
		}
		this.method32974(1840264631);
		this.method33038(-1308516055);
		this.method33021(-893392277);
		this.method32985((byte) 25);
	}
	...
	Class672 method33017(@OriginalArg(0) Class532 arg0) {
		...
		@Pc(3) int local3 = -1;
		@Pc(5) int local5 = -1;
		if (Class1.method15(client.anInt3435 * -849002901, 992364855) || Class56.method18034(client.anInt3435 * -849002901, -1497248091)) {
			local3 = Class163.anInt2002 * -1331168249 >> 12;
			local5 = Class270.anInt3884 * 466086187 >> 12;
		} else {
			if (Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3 != null) {
			...
			if (local3 < 0 || local3 >= arg0.method30444(1771391415) >> 3 || local5 < 0 || local5 >= arg0.method30474((short) 128) >> 3) {
				local3 = arg0.method30444(-559947505) >> 4;
				local5 = arg0.method30474((short) 128) >> 4;
			}
		}
		local1 = this.aClass672ArrayArray1[local3][local5];
	...
	Class672 method33018(@OriginalArg(0) Class532 arg0) {
		...
		@Pc(3) int local3 = -1;
		@Pc(5) int local5 = -1;
		if (Class1.method15(client.anInt3435 * -849002901, -341826344) || Class56.method18034(client.anInt3435 * -849002901, -1497248091)) {
			local3 = Class163.anInt2002 * -1331168249 >> 12;
			local5 = Class270.anInt3884 * 466086187 >> 12;
		} else {
			if (Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3 != null) {
			...
			if (local3 < 0 || local3 >= arg0.method30444(-576694170) >> 3 || local5 < 0 || local5 >= arg0.method30474((short) 128) >> 3) {
				local3 = arg0.method30444(684151797) >> 4;
				local5 = arg0.method30474((short) 128) >> 4;
			}
		}
		local1 = this.aClass672ArrayArray1[local3][local5];
	...
	Class672 method33019(@OriginalArg(0) Class532 arg0) {
		...
		@Pc(3) int local3 = -1;
		@Pc(5) int local5 = -1;
		if (Class1.method15(client.anInt3435 * -849002901, -98792332) || Class56.method18034(client.anInt3435 * -849002901, -1497248091)) {
			local3 = Class163.anInt2002 * -1331168249 >> 12;
			local5 = Class270.anInt3884 * 466086187 >> 12;
		} else {
			if (Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3 != null) {
			...
			if (local3 < 0 || local3 >= arg0.method30444(99088898) >> 3 || local5 < 0 || local5 >= arg0.method30474((short) 128) >> 3) {
				local3 = arg0.method30444(48735057) >> 4;
				local5 = arg0.method30474((short) 128) >> 4;
			}
		}
		local1 = this.aClass672ArrayArray1[local3][local5];
	...
	Class672 method33020(@OriginalArg(0) Class532 arg0) {
		...
		@Pc(3) int local3 = -1;
		@Pc(5) int local5 = -1;
		if (Class1.method15(client.anInt3435 * -849002901, 461592936) || Class56.method18034(client.anInt3435 * -849002901, -1497248091)) {
			local3 = Class163.anInt2002 * -1331168249 >> 12;
			local5 = Class270.anInt3884 * 466086187 >> 12;
		} else {
			if (Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3 != null) {
			...
			if (local3 < 0 || local3 >= arg0.method30444(1264651395) >> 3 || local5 < 0 || local5 >= arg0.method30474((short) 128) >> 3) {
				local3 = arg0.method30444(-1057908191) >> 4;
				local5 = arg0.method30474((short) 128) >> 4;
			}
		}
		local1 = this.aClass672ArrayArray1[local3][local5];
	...
	void method33021(@OriginalArg(0) int arg0) {
	...
	void method33022(@OriginalArg(0) Class672 arg0, @OriginalArg(1) int arg1) {
		...
		if (this.aClass672_3.method33055(arg0, 214172442)) {
			return;
		}
		this.aClass672_3.method33067(arg0, (byte) 16);
		this.aLong304 = Class305.method26796(1459124914) * 3202058925841662635L;
		this.anInt5857 = (this.anInt5858 = arg1 * 1162824399) * 1573029247;
		if (this.anInt5857 * -4832943 == 0) {
			return;
		}
		this.aClass672_2.method33067(this.aClass672_1, (byte) -30);
		if (this.aClass672_1.aClass562_3 == null) {
			return;
		}
		if (this.aClass672_1.aClass562_3.method31176((byte) -115)) {
			this.aClass672_1.aClass562_3 = this.aClass672_2.aClass562_3 = this.aClass672_1.aClass562_3.method31158(-1094091058);
		}
		if (this.aClass672_1.aClass562_3 != null && this.aClass672_3.aClass562_3 != this.aClass672_1.aClass562_3) {
			this.aClass672_1.aClass562_3.method31178(this.aClass672_3.aClass562_3, 1571712364);
		}
	}
	...
	void method33023() {
		...
		@Pc(7) long local7 = Class305.method26796(-130808910);
		this.anInt5858 = (int) ((long) this.anInt5858 - (local7 - this.aLong304 * 5957186404395821059L) * 1162824399L);
		if (this.anInt5858 * 2008775727 > 0) {
			this.aClass672_1.method33078(this.aClass104_13, this.aClass672_2, this.aClass672_3, (float) (this.anInt5857 * -4832943 - this.anInt5858 * 2008775727) / (float) (this.anInt5857 * -4832943), 1672591171);
		} else {
			this.aClass672_1.method33067(this.aClass672_3, (byte) -66);
			if (this.aClass672_1.aClass562_3 != null) {
				this.aClass672_1.aClass562_3.method31174(1958909974);
			}
			this.anInt5858 = -1162824399;
		}
		this.aLong304 = local7 * 3202058925841662635L;
	...
	void method33024(@OriginalArg(0) Class672 arg0, @OriginalArg(1) int arg1) {
		...
		if (this.aClass672_3.method33055(arg0, 2120079549)) {
			return;
		}
		this.aClass672_3.method33067(arg0, (byte) -94);
		this.aLong304 = Class305.method26796(1280896867) * 3202058925841662635L;
		this.anInt5857 = (this.anInt5858 = arg1 * 1162824399) * 1573029247;
		if (this.anInt5857 * -4832943 == 0) {
			return;
		}
		this.aClass672_2.method33067(this.aClass672_1, (byte) 55);
		if (this.aClass672_1.aClass562_3 == null) {
			return;
		}
		if (this.aClass672_1.aClass562_3.method31176((byte) 0)) {
			this.aClass672_1.aClass562_3 = this.aClass672_2.aClass562_3 = this.aClass672_1.aClass562_3.method31158(1028605865);
		}
		if (this.aClass672_1.aClass562_3 != null && this.aClass672_3.aClass562_3 != this.aClass672_1.aClass562_3) {
			this.aClass672_1.aClass562_3.method31178(this.aClass672_3.aClass562_3, 2009070702);
		}
	}

	@OriginalMember(owner = "client!xu", name = "bb", descriptor = "()V", line = 256)
	void method33025() {
		this.aClass104_13.method20521(((float) Class51.aClass93_Sub36_1.aClass166_Sub7_1.method15502((byte) -106) * 0.1F + 0.7F + client.aClass532_1.method30448(-1764688948)) * this.aClass672_1.aFloat349);
		this.aClass104_13.method20522(this.aClass672_1.anInt5862 * 1540075243, this.aClass672_1.aFloat344, this.aClass672_1.aFloat346, (float) ((int) this.aClass472_64.aFloat317 << 2), (float) ((int) this.aClass472_64.aFloat318 << 2), (float) ((int) this.aClass472_64.aFloat319 << 2));
		this.aClass104_13.method20815(this.aClass672_1.aClass107_2);
	}
	...
	public void method33026(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		this.aClass104_13.method20521(((float) Class51.aClass93_Sub36_1.aClass166_Sub7_1.method15502((byte) -66) * 0.1F + 0.7F + client.aClass532_1.method30448(365784513)) * arg0);
		this.aClass104_13.method20522(arg3, arg1, arg2, (float) (arg4 << 2), (float) (arg5 << 2), (float) (arg6 << 2));
		this.aClass104_13.method20815(this.method32969(arg7, 2126752395));
	}
	...
	public void method33027() {
		@Pc(1) byte local1 = 0;
		@Pc(13) int local13 = (this.aClass672_1.anInt5861 * -2139322713 + 256 << 2) + local1;
		this.aClass104_13.method20871(this.aClass672_1.anInt5860 * -2016142599, Class51.aClass93_Sub36_1.aClass166_Sub2_1.method15376(-1522894148) == 1 ? local13 : -1, 0);
	}

	@OriginalMember(owner = "client!xu", name = "bu", descriptor = "()V", line = 274)
	void method33028() {
		this.aClass104_13.method20542(this.aClass672_1.aFloat352, this.aClass672_1.aFloat345, this.aClass672_1.aFloat348, -1956409172);
	}

	@OriginalMember(owner = "client!xu", name = "bz", descriptor = "()V", line = 274)
	void method33029() {
		this.aClass104_13.method20542(this.aClass672_1.aFloat352, this.aClass672_1.aFloat345, this.aClass672_1.aFloat348, 1422197806);
	}

	@OriginalMember(owner = "client!xu", name = "bo", descriptor = "()V", line = 274)
	void method33030() {
		this.aClass104_13.method20542(this.aClass672_1.aFloat352, this.aClass672_1.aFloat345, this.aClass672_1.aFloat348, 1505562315);
	}
	...
	Class672 method33033(@OriginalArg(0) Class532 arg0, @OriginalArg(1) int arg1) {
		@Pc(1) Class672 local1 = null;
		@Pc(3) int local3 = -1;
		@Pc(5) int local5 = -1;
		if (Class1.method15(client.anInt3435 * -849002901, 494650525) || Class56.method18034(client.anInt3435 * -849002901, -1497248091)) {
			local3 = Class163.anInt2002 * -1331168249 >> 12;
			local5 = Class270.anInt3884 * 466086187 >> 12;
		} else {
			if (Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3 != null) {
			...
			if (local3 < 0 || local3 >= arg0.method30444(-797578492) >> 3 || local5 < 0 || local5 >= arg0.method30474((short) 128) >> 3) {
				local3 = arg0.method30444(-1767243829) >> 4;
				local5 = arg0.method30474((short) 128) >> 4;
			}
		}
		local1 = this.aClass672ArrayArray1[local3][local5];
	...
	public void method33034(@OriginalArg(0) Class671 arg0) {
		this.aClass672_1.method33067(arg0.aClass672_1, (byte) -2);
		this.aClass672_2.method33067(arg0.aClass672_2, (byte) -47);
		this.aClass672_3.method33067(arg0.aClass672_3, (byte) -46);
		this.aLong304 = arg0.aLong304;
		this.anInt5857 = arg0.anInt5857;
		this.anInt5858 = arg0.anInt5858;
	}
	...
	void method33037() {
		...
		if (!this.aBoolean867) {
			if (this.aClass672_1.anIntArray515[0] > -1) {
				local6 = this.method32971(this.aClass672_1.anIntArray515[0], (byte) 52);
			}
			if (this.aClass672_1.anIntArray515[1] > -1) {
				local8 = this.method32971(this.aClass672_1.anIntArray515[1], (byte) 56);
			}
			if (this.aClass672_1.anIntArray515[2] > -1) {
				local10 = this.method32971(this.aClass672_1.anIntArray515[2], (byte) 78);
			}
			this.aClass104_13.method20538(local6, this.aClass672_1.aFloatArray121[0], local8, this.aClass672_1.aFloatArray121[1], local10, this.aClass672_1.aFloatArray121[2]);
			return;
		}
		if (this.anIntArray514[0] > -1) {
			local6 = this.method32971(this.anIntArray514[0], (byte) 34);
		}
		if (this.anIntArray514[1] > -1) {
			local8 = this.method32971(this.anIntArray514[1], (byte) 102);
		}
		if (this.anIntArray514[2] > -1) {
			local10 = this.method32971(this.anIntArray514[2], (byte) 120);
		}
		this.aClass104_13.method20538(local6, this.aFloatArray120[0], local8, this.aFloatArray120[1], local10, this.aFloatArray120[2]);
	}
	...
	void method33038(@OriginalArg(0) int arg0) {
		this.aClass104_13.method20542(this.aClass672_1.aFloat352, this.aClass672_1.aFloat345, this.aClass672_1.aFloat348, 1068596690);
	}
	...
	public void method33041(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		this.method32992(-88771964);
	}

	@OriginalMember(owner = "client!xu", name = "cu", descriptor = "()V", line = 326)
	public void method33042() {
		this.aClass104_13.method20521(((float) Class51.aClass93_Sub36_1.aClass166_Sub7_1.method15502((byte) -127) * 0.1F + 0.7F + client.aClass532_1.method30448(648195851)) * 1.1523438F);
		this.aClass104_13.method20522(16777215, 0.69921875F, 1.2F, -200.0F, -240.0F, -200.0F);
		this.aClass104_13.method20871(13156520, -1, 0);
		this.aClass104_13.method20815(aClass107_1);
	}
	...
	static final void method33043(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class379.method28105(local11, local14, arg0, (byte) 33);
	}
	...
	static void method33045(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class272.method26321(-192563376);
	}
}
