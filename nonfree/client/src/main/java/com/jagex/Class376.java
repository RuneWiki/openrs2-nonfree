...
public class Class376 {
	...
	static void method28043(@OriginalArg(0) int arg0) {
	...
	static final void method28044(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 384562811);
	...
	public static Interface57 method28046(@OriginalArg(0) int arg0) {
	...
	static void method28047(@OriginalArg(0) String arg0, @OriginalArg(1) byte arg1) {
		...
		if (Class343.method27518((byte) 95) == Class555.aClass555_3) {
			return;
		}
		try {
			...
			if (arg0.length() == 0) {
				...
				local31 = local31 + "; Expires=" + Class53.method14943(Class305.method26796(1748071629) + 94608000000L) + "; Max-Age=" + 94608000L;
			}
