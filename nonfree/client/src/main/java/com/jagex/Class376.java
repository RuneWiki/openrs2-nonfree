...
public class Class376 {
	...
	public static Interface57 method28046() {
	...
	static void method28047(@OriginalArg(0) String arg0) {
		...
		try {
			...
			if (arg0.length() == 0) {
				...
				local31 = local31 + "; Expires=" + Class53.method14943(Class305.method26796() + 94608000000L) + "; Max-Age=" + 94608000L;
			}
			Class70.method1231(Class32_Sub10.anApplet2, "document.cookie=\"" + local31 + "\"");
