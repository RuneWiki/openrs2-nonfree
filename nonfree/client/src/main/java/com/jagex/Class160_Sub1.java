...
public class Class160_Sub1 extends Class160 {
	...
	public void method14710(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
		this.aClass594_1.method31727(arg0, arg1, arg2, (byte) -19);
	}
	...
	public boolean method14720(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) throws IOException {
		return this.aClass589_1.method31666(arg0, -1593034678);
	}

	@OriginalMember(owner = "client!all", name = "u", descriptor = "(I)V", line = 48)
	@Override
	public void method14714(@OriginalArg(0) int arg0) {
		this.aClass589_1.method31674(1863702203);
		this.aClass594_1.method31729(1025532681);
	}
	...
	public int method14719(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
		return this.aClass589_1.method31663(arg0, arg1, arg2, -991468413);
	}
	...
	public int method14711(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) throws IOException {
		return this.aClass589_1.method31663(arg0, arg1, arg2, -290440176);
	}
	...
	public void method14722() {
		this.aClass589_1.method31674(1977555894);
		this.aClass594_1.method31729(599193165);
	}

	@OriginalMember(owner = "client!all", name = "y", descriptor = "()V", line = 48)
	@Override
	public void method14723() {
		this.aClass589_1.method31674(1488531699);
		this.aClass594_1.method31729(-1088302040);
	}
