...
public class Class569 {
	...
	public void method31299() {
		...
		while (local3.hasNext()) {
			...
			local3.remove();
			Class305.method26798(local10, (byte) 0);
		}
	}
		...
		if (this.aBoolean814) {
			...
			while (local37.hasNext()) {
				...
				if (local2 == local44.aClass132_Sub1_25) {
					local37.remove();
					Class305.method26798(local44, (byte) 0);
				}
			}
		}
	...
	static final void method31304(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5891 -= 1189701933;
	}

	@OriginalMember(owner = "client!tg", name = "xg", descriptor = "(Lclient!yf;B)V", line = 9141)
	static final void method31305(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.method19988(353018298);
	}

	@OriginalMember(owner = "client!tg", name = "axl", descriptor = "(Lclient!yf;B)V", line = 13962)
	static final void method31306(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method31307(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = client.aClass270_1.method26278(local13, 1999645105).method26366(local23, (byte) 68);
	}

	@OriginalMember(owner = "client!tg", name = "wz", descriptor = "(Lclient!yf;B)V", line = 8955)
	static final void method31308(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		Class274.aClass258_1.method26074(Class275.aClass275_9, local13, local23, local43, Class280.aClass280_7.method26450(-1006787270), Class278.aClass278_2, 0.0F, 0.0F, (Class472) null, 0, local45, local33, 574439781);
	}

	@OriginalMember(owner = "client!tg", name = "bck", descriptor = "(Lclient!yf;I)V", line = 14667)
	static final void method31309(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = 0;
	}

	@OriginalMember(owner = "client!tg", name = "hd", descriptor = "(Lclient!yf;I)V", line = 6290)
	static final void method31310(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 225700157);
	...
	public static long method31311(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
	...
	static final void method31312(@OriginalArg(0) Class681 arg0, @OriginalArg(1) short arg1) {
		arg0.anInt5891 -= -1915563430;
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class32.method17826(local13, local23, false, -1942720199);
	}
}
