...
public class Class157_Sub1 extends Class157 implements Interface4 {
	...
	byte[] method14250(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		synchronized (this.aClass497_50) {
			return this.aClass497_50.method30044(arg0, 0, (byte) 0);
		}
	}
	...
	boolean method14245(@OriginalArg(0) int arg0, @OriginalArg(1) short arg1) {
		@Pc(3) Class497 local3 = this.aClass497_50;
		synchronized (this.aClass497_50) {
			return this.aClass497_50.method30053(arg0, 0, -897178899);
		}
	}
	...
	boolean method14248(@OriginalArg(0) int arg0) {
		@Pc(3) Class497 local3 = this.aClass497_50;
		synchronized (this.aClass497_50) {
			return this.aClass497_50.method30053(arg0, 0, -1035862151);
		}
	}
	...
	boolean method14249(@OriginalArg(0) int arg0) {
		@Pc(3) Class497 local3 = this.aClass497_50;
		synchronized (this.aClass497_50) {
			return this.aClass497_50.method30053(arg0, 0, -57468234);
		}
	}
	...
	static final void method14277(@OriginalArg(0) long arg0) {
		...
		if (client.anInt3526 * -703563959 != -1) {
			Class19.method23634(client.anInt3526 * -703563959, 2103577804);
		}
		@Pc(39) int local39;
		...
		Class497.method30132(-1, -1, (byte) 50);
		if (client.anInt3526 * -703563959 != -1) {
			client.anInt3562 = 0;
		...
		local39 = Class168.method17628(-608440267);
		if (local39 == -1) {
		...
		Class696.method36650(local39, 456633732);
		@Pc(104) int local104 = Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3.method19997(-1568045286) << 8;
