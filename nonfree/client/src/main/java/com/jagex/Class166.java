...
public abstract class Class166 {
	...
	abstract int method16542(@OriginalArg(0) byte arg0);

	@OriginalMember(owner = "client!zf", name = "n", descriptor = "(II)I")
	abstract int method16543(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1);

	@OriginalMember(owner = "client!zf", name = "m", descriptor = "(IB)V", line = 24)
	void method16544(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		if (this.method16543(arg0, 2052181945) != 3) {
			this.method16545(arg0, -990334654);
		}
	}

	@OriginalMember(owner = "client!zf", name = "k", descriptor = "(II)V")
	abstract void method16545(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1);
	...
	void method16552(@OriginalArg(0) int arg0) {
		if (this.method16543(arg0, -960655971) != 3) {
			this.method16545(arg0, -1894117595);
		}
	}

	@OriginalMember(owner = "client!zf", name = "v", descriptor = "(I)V", line = 24)
	void method16553(@OriginalArg(0) int arg0) {
		if (this.method16543(arg0, 2087909472) != 3) {
			this.method16545(arg0, -1711150005);
		}
	}
}
