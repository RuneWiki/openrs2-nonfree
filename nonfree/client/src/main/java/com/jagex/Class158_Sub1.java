...
public final class Class158_Sub1 extends Class158 implements KeyListener, FocusListener {
	...
	void method14315() {
		...
		this.aClass22_25.method406();
		this.aClass22_26.method406();
	}
	...
	void method14316(@OriginalArg(0) int arg0, @OriginalArg(1) char arg1, @OriginalArg(2) int arg2) {
		@Pc(3) Class93_Sub21 local3 = new Class93_Sub21();
		local3.anInt1567 = arg0 * -977824477;
		local3.aChar11 = arg1;
		local3.anInt1566 = arg2 * -1326775711;
		local3.aLong81 = Class305.method26796() * -2066611411765807963L;
		this.aClass22_26.method407(local3);
	}
	...
	@Override
	public Interface66 method14303() {
		return (Interface66) this.aClass22_25.method408();
	}
	...
	@Override
	public synchronized void method14297() {
		this.aClass22_25.method406();
		for (@Pc(9) Class93_Sub21 local9 = (Class93_Sub21) this.aClass22_26.method408(); local9 != null; local9 = (Class93_Sub21) this.aClass22_26.method408()) {
			local9.anInt1568 = this.method14318() * -781713471;
			if (local9.anInt1567 * 1729446539 == 0) {
				...
				for (@Pc(117) int local117 = 0; local117 < 112; local117++) {
					if (this.aBooleanArray10[local117]) {
						...
						this.aClass22_25.method407(local129);
	...
	void method14322(@OriginalArg(0) KeyEvent arg0, @OriginalArg(1) int arg1) {
		...
		if (local2 != 0) {
			this.method14316(arg1, (char) 65535, local2);
			arg0.consume();
		}
	}
	...
	public synchronized void keyTyped(@OriginalArg(0) KeyEvent arg0) {
		...
		if (local2 != 65535 && Class630.method32274(local2)) {
			this.method14316(3, local2, -1);
			arg0.consume();
		}
	}
