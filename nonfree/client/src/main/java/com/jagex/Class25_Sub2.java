...
public class Class25_Sub2 extends Class25 {
	...
	public static String method16021(@OriginalArg(0) CharSequence arg0) {
		...
		for (@Pc(9) int local9 = 0; local9 < local2; local9++) {
			...
			if (local16 >= 'a' && local16 <= 'z' || !(local16 < 'A' || local16 > 'Z') || local16 >= '0' && local16 <= '9' || local16 == '.' || local16 == '-' || local16 == '*' || local16 == '_') {
				...
				@Pc(63) byte local63 = Class138_Sub3.method11406(local16);
				local7.append('%');
	...
	public void method16018(@OriginalArg(0) Class93_Sub30 arg0) {
	...
	public void method23128(@OriginalArg(0) float arg0) {
		this.aClass123_16.method9050(false, arg0, this.aClass472_48, this.aClass123_16.method8964(), this.aClass472_49, this.aClass472_50);
	}
