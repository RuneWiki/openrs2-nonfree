...
public class Class603 implements Interface13, Interface5 {
	...
	void method31879(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		if (arg1 == 1) {
			this.anInt5550 = arg0.method22415(-1434290800) * 1895173889;
		} else if (arg1 == 2) {
			this.anIntArray486 = new int[arg0.method22413((short) 16384)];
			for (@Pc(21) int local21 = 0; local21 < this.anIntArray486.length; local21++) {
				this.anIntArray486[local21] = arg0.method22415(-1434290800);
			}
		} else if (arg1 == 3) {
			this.anInt5551 = arg0.method22413((short) 16384) * -1308423683;
		} else if (arg1 == 4) {
			this.aClass604_2 = (Class604) Class107.method18119(Class544.method30959(1742201210), arg0.method22413((short) 16384), -1915563430);
		} else if (arg1 == 5) {
			this.anInt5552 = arg0.method22436(-394123065) * -670946389;
		} else if (arg1 == 6) {
			arg0.method22436(-954810828);
		}
	}
	...
	static final void method31882(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		local18.aClass93_Sub41_Sub2_1.method22454(local12, 2143066079);
		client.aClass175_2.method24351(local18, -1476942798);
	}
