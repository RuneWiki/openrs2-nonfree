...
public class Class136 {
	...
	public static boolean method10214(@OriginalArg(0) int arg0) {
		return arg0 == 1 || arg0 == 3 || arg0 == 5;
	}

	@OriginalMember(owner = "client!ai", name = "p", descriptor = "(Ljava/lang/String;I)V", line = 239)
	public static void method10213(@OriginalArg(0) String arg0) {
	...
	static final void method10215(@OriginalArg(0) Class681 arg0) {
		@Pc(2) Class93_Sub1_Sub7 local2 = Class370.method27997();
		if (Class166_Sub14.method15657(local2) == 7) {
			@Pc(12) int local12 = (int) local2.method21701();
