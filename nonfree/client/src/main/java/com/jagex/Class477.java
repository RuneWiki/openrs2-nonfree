...
public class Class477 {
	...
	Class477(@OriginalArg(0) Class93_Sub41 arg0) {
		this.aClass484_1 = (Class484) Class107.method18119(Class484.method29784((short) 28722), arg0.method22413((short) 16384), -1915563430);
		this.anInt5128 = arg0.method22419(-118643075) * -1602366477;
		if (this.aClass484_1 == Class484.aClass484_5) {
			this.anInt5127 = this.anInt5128 * 1031860883;
		} else {
			this.anInt5127 = arg0.method22419(-118643075) * -82023799;
		}
	}
	...
	static final void method29703(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method29704(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method29705(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub46_1.method16543(local12, -122175387);
	}

	@OriginalMember(owner = "client!pc", name = "ab", descriptor = "(Lclient!arm;I)[I", line = 1151)
	static int[] method29706(@OriginalArg(0) Class93_Sub1_Sub7 arg0, @OriginalArg(1) int arg1) {
		...
		if (Class664.method32883(arg0.anInt3012 * -92627949, 1527912881)) {
			...
			if (local54 != null) {
				...
				if (local64.anIntArray412 != null) {
					local64 = local64.method27423(Class624.aClass120_1, Class624.aClass120_1, (short) 15584);
				}
				if (local64 != null) {
			...
			@Pc(104) Class610 local104 = (Class610) client.aClass532_1.method30466(1685828747).method18261((int) (arg0.aLong154 * 3050087486000948885L >>> 32 & 0x7FFFFFFFL), -552016599);
			if (local104.anIntArray492 != null) {
				local104 = local104.method31982(Class624.aClass120_1, Class624.aClass120_1, 1070158816);
			}
			if (local104 != null) {
