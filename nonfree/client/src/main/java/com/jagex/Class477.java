...
public class Class477 {
	...
	Class477(@OriginalArg(0) Class93_Sub41 arg0) {
		this.aClass484_1 = (Class484) Class107.method18119(Class484.method29784(), arg0.method22413());
		this.anInt5128 = arg0.method22419() * -1602366477;
		if (this.aClass484_1 == Class484.aClass484_5) {
			this.anInt5127 = this.anInt5128 * 1031860883;
		} else {
			this.anInt5127 = arg0.method22419() * -82023799;
		}
	}
	...
	public static int method29702(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	static int[] method29706(@OriginalArg(0) Class93_Sub1_Sub7 arg0) {
		@Pc(1) int[] local1 = null;
		if (Class664.method32883(arg0.anInt3012 * -92627949)) {
			local1 = ((Class47) Class277.aClass32_Sub12_1.method18261((int) (arg0.aLong154 * 3050087486000948885L))).anIntArray11;
		} else if (arg0.anInt3010 * 1303344433 != -1) {
			local1 = ((Class47) Class277.aClass32_Sub12_1.method18261(arg0.anInt3010 * 1303344433)).anIntArray11;
		} else if (Class110_Sub6.method7672(arg0.anInt3012 * -92627949)) {
			...
			if (local54 != null) {
				...
				if (local64.anIntArray412 != null) {
					local64 = local64.method27423(Class624.aClass120_1, Class624.aClass120_1);
				}
				if (local64 != null) {
					local1 = local64.anIntArray415;
				}
			}
		} else if (Class118.method8413(arg0.anInt3012 * -92627949)) {
			@Pc(104) Class610 local104 = (Class610) client.aClass532_1.method30466().method18261((int) (arg0.aLong154 * 3050087486000948885L >>> 32 & 0x7FFFFFFFL));
			if (local104.anIntArray492 != null) {
				local104 = local104.method31982(Class624.aClass120_1, Class624.aClass120_1);
			}
			if (local104 != null) {
	...
	static final void method29703(@OriginalArg(0) Class681 arg0) {
	...
	static final void method29704(@OriginalArg(0) Class681 arg0) {
		@Pc(13) String local13 = (String) arg0.anObjectArray45[(arg0.anInt5888 -= 957530791) * 587908375];
		Class153_Sub1.method14115(local13);
	}

	@OriginalMember(owner = "client!pc", name = "bap", descriptor = "(Lclient!yf;B)V", line = 14300)
	static final void method29705(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub46_1.method16543(local12);
	}
}
