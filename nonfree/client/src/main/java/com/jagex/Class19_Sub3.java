...
public class Class19_Sub3 extends Class19 {
	...
	void method23623(@OriginalArg(0) Class263 arg0, @OriginalArg(1) int arg1) {
		if (!this.aBoolean379 || !this.aClass132_Sub1_Sub1_Sub1_2.aClass19_3.method23552() || this.aClass132_Sub1_Sub1_Sub1_2.aClass19_3.method23561()) {
			Class274.aClass258_1.method26063(arg0, arg1, this.aClass132_Sub1_Sub1_Sub1_2);
		}
	}
	...
	static boolean method17555(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg1 >= 1000 && arg0 < 1000) {
			return true;
		} else if (arg1 >= 1000 || arg0 >= 1000) {
			return arg1 >= 1000 && arg0 >= 1000;
		} else if (Class528.method30392(arg0)) {
			return true;
		} else {
			return !Class528.method30392(arg1);
		}
	}
}
