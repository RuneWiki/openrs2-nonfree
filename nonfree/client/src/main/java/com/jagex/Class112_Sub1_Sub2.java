...
public class Class112_Sub1_Sub2 extends Class112_Sub1 {
	...
	void method18009() throws Throwable {
		super.finalize();
		this.method23738();
	}
	...
	@Override
	public void method23436(@OriginalArg(0) Interface19 arg0) {
		...
		if (arg0 == null) {
			...
			if ((this.anInt2534 | 0x10) == 16) {
				...
				if (this.aClass104_Sub1_33.method20434((byte) -49) == this) {
		...
		if (this.aClass104_Sub1_33.method20434((byte) -87) == this) {
			this.method18013();
		} else {
			this.anInt2532 |= 0x10;
		}
	...
	void method18010(@OriginalArg(0) int arg0) {
	...
	@Override
	public void method23434(@OriginalArg(0) int arg0, @OriginalArg(1) Interface18 arg1) {
		...
		if (arg1 == null) {
			...
			if ((this.anInt2534 | local3) == local3) {
				...
				if (this.aClass104_Sub1_33.method20434((byte) -112) == this) {
					this.aClass104_Sub1_33.method3784();
				}
		...
		if (this.aClass104_Sub1_33.method20434((byte) -60) == this) {
			this.method18010(arg0);
		} else {
	...
	void method18012(@OriginalArg(0) int arg0) {
	...
	public void method23438(@OriginalArg(0) int arg0, @OriginalArg(1) Interface18 arg1) {
		...
		if (arg1 == null) {
			...
			if ((this.anInt2534 | local3) == local3) {
				this.anInt2530 = local6.method30888();
				this.anInt2533 = local6.method30890();
				if (this.aClass104_Sub1_33.method20434((byte) -40) == this) {
					this.aClass104_Sub1_33.method3784();
				}
			} else if (this.anInt2533 != local6.method30890() || this.anInt2530 != local6.method30888()) {
				throw new RuntimeException();
		...
		if (this.aClass104_Sub1_33.method20434((byte) -105) == this) {
			this.method18010(arg0);
		} else {
			this.anInt2532 |= local3;
		}
	...
	@Override
	public void method23440(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6, @OriginalArg(7) boolean arg7) {
		if (!(arg6 | arg7)) {
			return;
		}
		@Pc(6) int local6 = this.anInt2530;
		@Pc(12) int local12 = this.aClass104_Sub1_33.method20434((byte) -83).method23737();
		@Pc(14) int local14 = 0;
		if (arg7) {
			local14 |= 0x100;
		}
	...
	@Override
	public void method23432(@OriginalArg(0) int arg0, @OriginalArg(1) Interface18 arg1) {
		@Pc(3) int local3 = 0x1 << arg0;
		@Pc(6) Interface15 local6 = (Interface15) arg1;
		if (arg1 == null) {
			this.anInt2534 &= ~local3;
			...
			if ((this.anInt2534 | local3) == local3) {
				this.anInt2530 = local6.method30888();
				this.anInt2533 = local6.method30890();
				if (this.aClass104_Sub1_33.method20434((byte) -48) == this) {
					this.aClass104_Sub1_33.method3784();
				}
			} else if (this.anInt2533 != local6.method30890() || this.anInt2530 != local6.method30888()) {
				throw new RuntimeException();
		...
		if (this.aClass104_Sub1_33.method20434((byte) 2) == this) {
			this.method18010(arg0);
		} else {
			this.anInt2532 |= local3;
		}
	...
	@Override
	public void method23433(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6, @OriginalArg(7) boolean arg7) {
		if (!(arg6 | arg7)) {
			return;
		}
		@Pc(6) int local6 = this.anInt2530;
		@Pc(12) int local12 = this.aClass104_Sub1_33.method20434((byte) -14).method23737();
		@Pc(14) int local14 = 0;
		if (arg7) {
			local14 |= 0x100;
		}
	...
	@Override
	public void method23437(@OriginalArg(0) int arg0, @OriginalArg(1) Interface18 arg1) {
		@Pc(3) int local3 = 0x1 << arg0;
		@Pc(6) Interface15 local6 = (Interface15) arg1;
		if (arg1 == null) {
			this.anInt2534 &= ~local3;
			...
			if ((this.anInt2534 | local3) == local3) {
				this.anInt2530 = local6.method30888();
				this.anInt2533 = local6.method30890();
				if (this.aClass104_Sub1_33.method20434((byte) -84) == this) {
					this.aClass104_Sub1_33.method3784();
				}
			} else if (this.anInt2533 != local6.method30890() || this.anInt2530 != local6.method30888()) {
				throw new RuntimeException();
		...
		if (this.aClass104_Sub1_33.method20434((byte) -75) == this) {
			this.method18010(arg0);
		} else {
			this.anInt2532 |= local3;
		}
	...
	@Override
	public void method23439(@OriginalArg(0) Interface19 arg0) {
		@Pc(2) Interface15 local2 = (Interface15) arg0;
		if (arg0 == null) {
			this.anInt2534 &= 0xFFFFFFEF;
			this.anInterface15_1 = null;
			...
			if ((this.anInt2534 | 0x10) == 16) {
				this.anInt2530 = local2.method30888();
				this.anInt2533 = local2.method30890();
				if (this.aClass104_Sub1_33.method20434((byte) -44) == this) {
					this.aClass104_Sub1_33.method3784();
				}
			} else if (this.anInt2533 != local2.method30890() || this.anInt2530 != local2.method30888()) {
				throw new RuntimeException();
		...
		if (this.aClass104_Sub1_33.method20434((byte) -81) == this) {
			this.method18013();
		} else {
			this.anInt2532 |= 0x10;
		}
	...
	@Override
	public void method23435(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6, @OriginalArg(7) boolean arg7) {
		if (!(arg6 | arg7)) {
			return;
		}
		@Pc(6) int local6 = this.anInt2530;
		@Pc(12) int local12 = this.aClass104_Sub1_33.method20434((byte) -35).method23737();
		@Pc(14) int local14 = 0;
		if (arg7) {
			local14 |= 0x100;
		}
