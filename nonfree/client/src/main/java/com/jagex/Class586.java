...
public class Class586 implements Interface57 {
	...
	public int method31626(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws Exception_Sub5 {
		...
		if (arg1) {
			...
			local16 = Class443.method28871(arg0);
			if (local16 == null) {
				throw new Exception_Sub5(1, arg0);
			}
			if (local8 == null) {
				local8 = this.aString229 + local16;
				if (this.aClass497_131 == null || !this.aClass497_131.method30070(local8, "")) {
					throw new Exception_Sub5(2, arg0);
				}
			}
		}
		if (!this.aClass497_131.method30051(local8)) {
			return this.aClass497_131.method30045(local8);
		}
		@Pc(77) byte[] local77 = this.aClass497_131.method30071(local8, "");
		if (local77 == null) {
			throw new Exception_Sub5(3, arg0);
		}
		@Pc(92) File local92;
		try {
			local92 = Class19_Sub2.method17371(local16);
		...
		@Pc(115) byte[] local115 = Class300.method26720(local92);
		...
		if (!local111) {
			try {
				@Pc(151) FileOutputStream local151 = new FileOutputStream(local92);
	...
	void method31627(@OriginalArg(0) String arg0, @OriginalArg(1) File arg1) {
		this.aHashtable10.put(arg0, arg1);
	}
	...
	@Override
	public boolean method31615(@OriginalArg(0) String arg0) {
		return this.aHashtable10.containsKey(arg0);
	}

	@OriginalMember(owner = "client!ty", name = "e", descriptor = "(Ljava/lang/String;B)V", line = 108)
	@Override
	public void method31617(@OriginalArg(0) String arg0) throws Exception_Sub1 {
		this.method31629(arg0, Class574.class);
	}
	...
	void method31629(@OriginalArg(0) String arg0, @OriginalArg(1) Class arg1) throws Exception_Sub1 {
		@Pc(5) Class local5 = (Class) this.aHashtable11.get(arg0);
		if (local5 != null && local5.getClassLoader() != arg1.getClassLoader()) {
			throw new Exception_Sub1(1, arg0);
		}
	...
	public static void method31641() {
	...
	static final void method31635(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
	...
	static final void method31640(@OriginalArg(0) Class681 arg0) {
		arg0.anInt5891 -= 1189701933;
	}

	@OriginalMember(owner = "client!ty", name = "no", descriptor = "(Lclient!yf;I)V", line = 7365)
	static final void method31636(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class370.method27999(local16, local22, arg0);
	}

	@OriginalMember(owner = "client!ty", name = "my", descriptor = "(IIIIIILjava/lang/String;I)V", line = 12443)
	public static void method31638(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) String arg6) {
		...
		client.aClass21_6.method379(local3);
	}

	@OriginalMember(owner = "client!ty", name = "avp", descriptor = "(Lclient!yf;I)V", line = 13513)
	static final void method31639(@OriginalArg(0) Class681 arg0) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub31_1.method16108();
	}

	@OriginalMember(owner = "client!ty", name = "bci", descriptor = "(Lclient!yf;B)V", line = 14515)
	static final void method31637(@OriginalArg(0) Class681 arg0) {
		Class5.method78(arg0.aClass132_Sub1_Sub5_Sub1_1, arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091], true);
