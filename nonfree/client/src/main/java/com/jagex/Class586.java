...
public class Class586 implements Interface57 {
	...
	void method31625(@OriginalArg(0) String arg0, @OriginalArg(1) File arg1) {
		this.aHashtable10.put(arg0, arg1);
	}

	@OriginalMember(owner = "client!ty", name = "r", descriptor = "(Ljava/lang/String;ZI)I", line = 40)
	public int method31626(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2) throws Exception_Sub5 {
		...
		if (arg1) {
			...
			local10 = Class443.method28871(arg0, 2116595808);
			if (local10 == null) {
				throw new Exception_Sub5(1, arg0);
			}
			if (local8 == null) {
				local8 = this.aString229 + local10;
				if (this.aClass497_131 == null || !this.aClass497_131.method30070(local8, "", -1005399904)) {
					throw new Exception_Sub5(2, arg0);
				}
			}
		}
		if (!this.aClass497_131.method30051(local8, -691329216)) {
			return this.aClass497_131.method30045(local8, 810509320);
		}
		@Pc(77) byte[] local77 = this.aClass497_131.method30071(local8, "", 1200487767);
		if (local77 == null) {
		...
		@Pc(115) byte[] local115 = Class300.method26720(local88, 1302919758);
		...
		this.method31627(arg0, local88, 220456577);
		return 100;
	}

	@OriginalMember(owner = "client!ty", name = "v", descriptor = "(Ljava/lang/String;Ljava/io/File;I)V", line = 100)
	void method31627(@OriginalArg(0) String arg0, @OriginalArg(1) File arg1, @OriginalArg(2) int arg2) {
		this.aHashtable10.put(arg0, arg1);
	}

	@OriginalMember(owner = "client!ty", name = "b", descriptor = "(Ljava/lang/String;Ljava/lang/Class;)V", line = 112)
	void method31628(@OriginalArg(0) String arg0, @OriginalArg(1) Class arg1) throws Exception_Sub1 {
	...
	public void method31617(@OriginalArg(0) String arg0, @OriginalArg(1) byte arg1) throws Exception_Sub1 {
		this.method31629(arg0, Class574.class, 1288516954);
	}

	@OriginalMember(owner = "client!ty", name = "o", descriptor = "(Ljava/lang/String;Ljava/lang/Class;I)V", line = 112)
	void method31629(@OriginalArg(0) String arg0, @OriginalArg(1) Class arg1, @OriginalArg(2) int arg2) throws Exception_Sub1 {
		@Pc(5) Class local5 = (Class) this.aHashtable11.get(arg0);
		if (local5 != null && local5.getClassLoader() != arg1.getClassLoader()) {
			throw new Exception_Sub1(1, arg0);
		}
	...
	public void method31621(@OriginalArg(0) String arg0) throws Exception_Sub1 {
		this.method31629(arg0, Class574.class, 100645638);
	}

	@OriginalMember(owner = "client!ty", name = "s", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 33)
	static String method31630(@OriginalArg(0) String arg0) {
	...
	public void method31619(@OriginalArg(0) String arg0) throws Exception_Sub1 {
		this.method31629(arg0, Class574.class, -1322671205);
	}
	...
	void method31631(@OriginalArg(0) String arg0, @OriginalArg(1) File arg1) {
		this.aHashtable10.put(arg0, arg1);
	}

	@OriginalMember(owner = "client!ty", name = "x", descriptor = "(Ljava/lang/String;Ljava/lang/Class;)V", line = 112)
	void method31632(@OriginalArg(0) String arg0, @OriginalArg(1) Class arg1) throws Exception_Sub1 {
		@Pc(5) Class local5 = (Class) this.aHashtable11.get(arg0);
		if (local5 != null && local5.getClassLoader() != arg1.getClassLoader()) {
			throw new Exception_Sub1(1, arg0);
		}
	...
	public void method31618(@OriginalArg(0) String arg0) throws Exception_Sub1 {
		this.method31629(arg0, Class574.class, -1215009295);
	}
	...
	static final void method31635(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) byte arg3) {
	...
	static final void method31636(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1085021496);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class370.method27999(local16, local22, arg0, (byte) -12);
	}

	@OriginalMember(owner = "client!ty", name = "bci", descriptor = "(Lclient!yf;B)V", line = 14515)
	static final void method31637(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		Class5.method78(arg0.aClass132_Sub1_Sub5_Sub1_1, arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091], true, 1808448679);
	...
	public static void method31638(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) String arg6, @OriginalArg(7) int arg7) {
	...
	static final void method31639(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub31_1.method16108((short) 23967);
	}

	@OriginalMember(owner = "client!ty", name = "jo", descriptor = "(Lclient!yf;I)V", line = 6697)
	static final void method31640(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anInt5891 -= 1189701933;
	}

	@OriginalMember(owner = "client!ty", name = "u", descriptor = "(B)V", line = 283)
	public static void method31641(@OriginalArg(0) byte arg0) {
		...
		Class51.aClass93_Sub36_1.method14357(Class51.aClass93_Sub36_1.aClass166_Sub12_1, Class332.aClass332_6.anInt4147 * 595334117, (byte) 71);
		...
		Class610.method32021(-584004913);
		client.aClass532_1.method30532((byte) -12).method33003(467828911);
		client.aBoolean609 = true;
	}

	@OriginalMember(owner = "client!ty", name = "e", descriptor = "(B)I", line = 22)
	static int method31642(@OriginalArg(0) byte arg0) {
