...
public class Class93_Sub40_Sub2 extends Class93_Sub40 {
	...
	public boolean method23193(@OriginalArg(0) byte arg0) {
		@Pc(4) Class132_Sub1_Sub5_Sub1 local4 = this.aClass679_1.method33234(-2072112600);
		if (local4 == null) {
			return false;
		} else {
			Class593.method31715(Class155.aClass155_47, this.anInt3172 * 1220811495, -1, this.aClass679_1, local4, -815177908);
			return true;
		}
	}
	...
	public boolean method23192() {
		@Pc(4) Class132_Sub1_Sub5_Sub1 local4 = this.aClass679_1.method33234(-2004809038);
		if (local4 == null) {
			return false;
		} else {
			Class593.method31715(Class155.aClass155_47, this.anInt3172 * 1220811495, -1, this.aClass679_1, local4, -1538693267);
			return true;
		}
	}
	...
	public boolean method23194() {
		@Pc(4) Class132_Sub1_Sub5_Sub1 local4 = this.aClass679_1.method33234(-1846085677);
		if (local4 == null) {
			return false;
		} else {
			Class593.method31715(Class155.aClass155_47, this.anInt3172 * 1220811495, -1, this.aClass679_1, local4, 348420724);
			return true;
		}
	}
	...
	public boolean method23195() {
		@Pc(4) Class132_Sub1_Sub5_Sub1 local4 = this.aClass679_1.method33234(-1831012150);
		if (local4 == null) {
			return false;
		} else {
			Class593.method31715(Class155.aClass155_47, this.anInt3172 * 1220811495, -1, this.aClass679_1, local4, 1228424317);
			return true;
		}
	}
}
