...
public class Class315 implements Interface45 {
	...
	AtomicReference anAtomicReference1 = new AtomicReference((Object) null);
	...
	boolean method27052(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) AtomicReference arg3) {
		if (arg0 == null) {
			throw new RuntimeException("");
		} else if (arg1 + arg2 > arg0.length) {
			return false;
		} else {
			this.method27075(arg0, arg1);
			@Pc(21) int local21 = this.method27130();
			if (local21 != 0) {
				this.method27078(arg0, arg1);
				return false;
			} else if (this.method27011()) {
				@Pc(46) int local46 = this.method27136(this.method27079(this.anIntArray384.length - 1));
				...
				if (local51) {
					local61 = this.method27130() != 0;
					local63 = this.method27130() != 0;
				}
				...
				for (local188 = 0; local188 < this.anInt4064; local188++) {
					...
					this.aBooleanArray28[local188] = !this.aClass317Array1[local209].method27177(local188);
				...
				for (local188 = 0; local188 < local167.anInt4092; local188++) {
					...
					if (local333.anInt3909 == 2) {
						@Pc(347) Class308[] local347 = this.method27074(1, this.anInt4064 * local59);
						local349 = 0;
						while (true) {
							@Pc(354) int local354;
							if (local349 >= local59) {
								local347 = local333.method26553(local347, local59 >> 1, this.aBooleanArray26);
						...
						local335 = local333.method26553(this.aClass308Array2, local59 >> 1, this.aBooleanArray26);
					}
					if (local167.anIntArray387 == null) {
						if (this.aClass308Array2 != local335) {
							this.method27064(this.aClass308Array2);
						}
				...
				for (local188 = 0; local188 < this.anInt4064; local188++) {
					if (!this.aBooleanArray28[local188]) {
						local202 = local167.anIntArray387 == null ? 0 : local167.anIntArray387[local188];
						local209 = local167.anIntArray390[local202];
						this.aClass317Array1[local209].method27178(local188);
						this.aClass317Array1[local209].method27179(this.aClass308Array2[local188], local59 >> 1, local188);
					}
				}
				for (local188 = 0; local188 < this.anInt4064; local188++) {
					if (this.aBooleanArray28[local188]) {
						...
						local768 = Class548.method31014(local59 - 1, 395872928);
				...
				if (this.anInt4068 > 0) {
					...
					local1816 = this.method27074(this.anInt4064, local202);
					for (local297 = 0; local297 < this.anInt4064; local297++) {
	...
	public void method27012(@OriginalArg(0) boolean arg0) {
		if (!arg0) {
			...
			this.method27126(Class413.aClass413_3);
		}
	}
	...
	public int method27005() {
		...
		return this.method27134() < this.anInt4075 ? this.anInt4075 : this.method27134();
	}

	@OriginalMember(owner = "client!hk", name = "s", descriptor = "(ILclient!nd;Lclient!mw;)Z", line = 199)
	boolean method27053(@OriginalArg(0) int arg0, @OriginalArg(1) Class433 arg1, @OriginalArg(2) Class426 arg2) {
	...
	void method27055() {
		if (this.method27041() == Class413.aClass413_2 || (this.method27041() == Class413.aClass413_5 || this.aBoolean704 && (float) (this.anInt4087 / this.method27056()) > this.aFloat285)) {
			return;
		}
		if (!this.method27068()) {
			...
			if (local41 == null) {
				if (!this.aBoolean702) {
					this.method27126(Class413.aClass413_5);
	...
	public void method27001(@OriginalArg(0) Class93_Sub41 arg0) {
		if (this.method27041() == Class413.aClass413_6 || this.method27041() == Class413.aClass413_7) {
			...
			if (this.aList16.isEmpty()) {
				if (!local33) {
					this.method27076();
					this.method27126(Class413.aClass413_7);
				}
			} else if (!local33) {
				this.method27076();
				this.method27126(Class413.aClass413_6);
			}
			if (local33) {
				this.method27065(true);
			}
		} else {
			this.method27082(arg0);
		}
	}
	...
	public void method27028() {
		if (this.method27041() == Class413.aClass413_2 || this.method27041() == Class413.aClass413_8 || this.method27041() == Class413.aClass413_3) {
			this.method27126(Class413.aClass413_4);
			this.method27066();
		}
	}
	...
	int method27058(@OriginalArg(0) float arg0) {
	...
	Class93_Sub41 method27059(@OriginalArg(0) int arg0) {
		@Pc(5) Class93_Sub41 local5 = this.method27097(this.method27006(arg0));
		...
		synchronized (this.aList16) {
			while (!this.aList16.isEmpty()) {
				...
				local5.method22405(local22.aByteArray58, 0, local53, 2026842986);
				local7 -= this.method27050(local53);
				@Pc(73) int local73 = local22.anInt3070 * 212851357 - local53;
				if (local73 == 0) {
					local22.method22651((byte) 1);
				} else {
	...
	public void method27051() {
		if (this.method27041() == Class413.aClass413_4) {
			...
			this.method27126(Class413.aClass413_2);
		} else {
			this.method27065(false);
			this.method27126(Class413.aClass413_8);
		}
	}

	@OriginalMember(owner = "client!hk", name = "dr", descriptor = "([Lclient!hb;)V", line = 300)
	void method27060(@OriginalArg(0) Class308[] arg0) {
		if (arg0 != null) {
			for (@Pc(4) int local4 = 0; local4 < arg0.length; local4++) {
				this.method27063(arg0[local4]);
			}
		}
	}

	@OriginalMember(owner = "client!hk", name = "b", descriptor = "(Z)V", line = 225)
	synchronized void method27061(@OriginalArg(0) boolean arg0) {
	...
	void method27062(@OriginalArg(0) Class308[] arg0) {
		if (arg0 != null) {
			for (@Pc(4) int local4 = 0; local4 < arg0.length; local4++) {
				this.method27063(arg0[local4]);
			}
	...
	void method27063(@OriginalArg(0) Class308 arg0) {
		if (arg0 != null) {
	...
	void method27064(@OriginalArg(0) Class308[] arg0) {
		if (arg0 != null) {
			for (@Pc(4) int local4 = 0; local4 < arg0.length; local4++) {
				this.method27063(arg0[local4]);
			}
	...
	synchronized void method27065(@OriginalArg(0) boolean arg0) {
		if (!arg0) {
			...
			this.method27064(this.aClass308Array3);
			this.aClass308Array3 = null;
			this.method27064(this.aClass308Array1);
			...
			this.method27063(this.aClass308_2);
			this.method27063(this.aClass308_3);
			this.method27063(this.aClass308_4);
			this.method27063(this.aClass308_5);
			this.method27063(this.aClass308_6);
			this.method27063(this.aClass308_1);
		...
		if (this.aClass93_Sub41_15 != null) {
			...
			synchronized (this.aClass93_Sub41_15) {
				this.aClass93_Sub41_15.method22651((byte) 1);
	...
	boolean method27069(@OriginalArg(0) Class93_Sub41 arg0) {
		return arg0.method22413((short) 16384) == 79 && arg0.method22413((short) 16384) == 103 && arg0.method22413((short) 16384) == 103 && arg0.method22413((short) 16384) == 83;
	}

	@OriginalMember(owner = "client!hk", name = "al", descriptor = "([BII)Z", line = 424)
	boolean method27070(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg0[arg1] == arg2) {
	...
	float method27071(@OriginalArg(0) int arg0) {
	...
	Class308[] method27074(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(2) Class308[] local2 = new Class308[arg0];
		for (@Pc(4) int local4 = 0; local4 < local2.length; local4++) {
			local2[local4] = this.method27122(arg1);
		}
		return local2;
	}

	@OriginalMember(owner = "client!hk", name = "as", descriptor = "([BI)V", line = 450)
	void method27075(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
	...
	void method27077() {
		@Pc(5) int local5 = this.method27136(8) + 1;
		...
		do {
			if (!local8.hasNext()) {
				...
				for (@Pc(69) int local69 = 0; local69 < local5; local69++) {
					...
					this.aClass324Array2[local69].method27283(this);
				}
		...
		for (@Pc(48) int local48 = 0; local48 < this.aClass324Array2.length; local48++) {
			this.aClass324Array2[local48].method27280(this);
		}
	}

	@OriginalMember(owner = "client!hk", name = "ar", descriptor = "([BI)V", line = 516)
	void method27078(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		this.anInt4085 = 0;
		if (this.method27011()) {
			return;
		}
		...
		if (this.method27070(arg0, arg1, 1)) {
			local15 = 1;
		} else if (this.method27070(arg0, arg1, 3)) {
			local15 = 3;
		} else if (this.method27070(arg0, arg1, 5)) {
			local15 = 5;
		} else {
		...
		@Pc(112) int local112;
		if (local15 == 1) {
			this.method27075(arg0, arg1 + 7);
			local67 = this.method27136(32);
			this.anInt4064 = this.method27136(8);
			this.anInt4073 = this.method27136(32);
			this.anInt4065 = this.method27136(32);
			this.anInt4069 = this.method27136(32);
			this.anInt4066 = this.method27136(32);
			this.anInt4071 = 0x1 << this.method27136(4);
			this.anInt4067 = 0x1 << this.method27136(4);
			local112 = 0x1 << this.method27136(1);
			...
			if (!this.method27070(arg0, arg1, 5)) {
				throw new RuntimeException("");
			}
			this.method27075(arg0, arg1 + 7);
			...
			this.aClass308Array2 = this.method27074(this.anInt4064, this.anInt4067);
			@Pc(190) int local190;
			@Pc(194) int local194;
			@Pc(198) int local198;
			for (local67 = 0; local67 < 2; local67++) {
				...
				local194 = local112 >> 2;
				local198 = local112 >> 3;
				@Pc(202) Class308 local202 = this.method27122(local190);
				...
				@Pc(250) Class308 local250 = this.method27122(local190);
				...
				@Pc(305) Class308 local305 = this.method27122(local194);
				...
				@Pc(362) int local362 = Class548.method31014(local198 - 1, -1225483021);
				for (@Pc(364) int local364 = 0; local364 < local198; local364++) {
					local356[local364] = Class438.method28829(local364, local362, 2073155620);
				}
				if (local67 == 0) {
			...
			for (local112 = 0; local112 < local67; local112++) {
				...
				this.aClass317Array1[local112].method27171(this, this.anInt4064);
			}
			local112 = this.method27136(6) + 1;
			...
			for (local194 = 0; local194 < local190; local194++) {
				...
				this.aClass316Array1[local194].method27160(this);
			}
			local194 = this.method27136(6) + 1;
			this.aBooleanArray25 = new boolean[local194];
			this.anIntArray384 = new int[local194];
			for (local198 = 0; local198 < local194; local198++) {
				this.aBooleanArray25[local198] = this.method27130() != 0;
				this.method27136(16);
				this.method27136(16);
				this.anIntArray384[local198] = this.method27136(8);
			}
			this.method27061(true);
		}
	}

	@OriginalMember(owner = "client!hk", name = "ap", descriptor = "(I)I", line = 645)
	int method27079(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = 0;
		while (arg0 > 0) {
			local1++;
			arg0 >>= 0x1;
	...
	Class308[] method27080(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(2) Class308[] local2 = new Class308[arg0];
		for (@Pc(4) int local4 = 0; local4 < local2.length; local4++) {
			local2[local4] = this.method27122(arg1);
		}
	...
	synchronized void method27082(@OriginalArg(0) Class93_Sub41 arg0) {
		this.aList14.add(arg0);
		this.method27126(Class413.aClass413_3);
	}

	@OriginalMember(owner = "client!hk", name = "bn", descriptor = "(Lclient!mc;)V", line = 117)
	void method27083(@OriginalArg(0) Class413 arg0) {
	...
	int method27084(@OriginalArg(0) float arg0) {
	...
	void method27085(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		this.anInt4085 = 0;
		if (this.method27011()) {
			return;
		}
		...
		if (local15 == 1) {
			...
			for (local67 = 0; local67 < 2; local67++) {
				...
				@Pc(356) int[] local356 = new int[local198];
				@Pc(362) int local362 = Class548.method31014(local198 - 1, -616261194);
				for (@Pc(364) int local364 = 0; local364 < local198; local364++) {
					local356[local364] = Class438.method28829(local364, local362, 2073155620);
				}
				if (local67 == 0) {
	...
	int method27086(@OriginalArg(0) float arg0) {
	...
	Class93_Sub41 method27087(@OriginalArg(0) int arg0) {
		@Pc(5) Class93_Sub41 local5 = this.method27097(this.method27006(arg0));
		@Pc(7) int local7 = arg0;
		@Pc(11) List local11 = this.aList16;
		synchronized (this.aList16) {
	...
	void method27088(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		this.anInt4085 = 0;
		if (this.method27011()) {
			return;
		}
		...
		if (local15 == 1) {
			...
			for (local67 = 0; local67 < 2; local67++) {
				...
				@Pc(356) int[] local356 = new int[local198];
				@Pc(362) int local362 = Class548.method31014(local198 - 1, -1207039547);
				for (@Pc(364) int local364 = 0; local364 < local198; local364++) {
					local356[local364] = Class438.method28829(local364, local362, 2073155620);
				}
				if (local67 == 0) {
	...
	public void method26999(@OriginalArg(0) int arg0, @OriginalArg(1) Class433 arg1, @OriginalArg(2) Class426 arg2, @OriginalArg(3) int arg3) {
		this.anInt4075 = arg3;
		if (!this.method27053(arg0, arg1, arg2)) {
			throw new RuntimeException("");
		}
	...
	boolean method27089(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) AtomicReference arg3) {
		if (arg0 == null) {
			throw new RuntimeException("");
		} else if (arg1 + arg2 > arg0.length) {
			return false;
			...
			if (local21 != 0) {
				...
				for (local188 = 0; local188 < this.anInt4064; local188++) {
					if (this.aBooleanArray28[local188]) {
						...
						local768 = Class548.method31014(local59 - 1, -1748959743);
						@Pc(1002) int local1002;
						@Pc(1013) int local1013;
						@Pc(1017) int local1017;
						@Pc(1019) int local1019;
	...
	Class93_Sub41 method27093(@OriginalArg(0) int arg0) {
		@Pc(5) Class93_Sub41 local5 = this.method27097(this.method27006(arg0));
		@Pc(7) int local7 = arg0;
		@Pc(11) List local11 = this.aList16;
		synchronized (this.aList16) {
	...
	Class93_Sub41 method27097(@OriginalArg(0) int arg0) {
		return new Class93_Sub41(arg0, true);
	}

	@OriginalMember(owner = "client!hk", name = "do", descriptor = "(Z)V", line = 307)
	synchronized void method27098(@OriginalArg(0) boolean arg0) {
		if (!arg0) {
			this.anInt4071 = 0;
			this.anInt4067 = 0;
			this.aBooleanArray25 = null;
	...
	boolean method27100(@OriginalArg(0) int arg0, @OriginalArg(1) Class433 arg1, @OriginalArg(2) Class426 arg2) {
		if (arg1 == Class433.aClass433_3) {
			return true;
		} else if (arg1 == Class433.aClass433_4) {
			return true;
	...
	void method27104(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		this.aByteArray79 = arg0;
		this.anInt4089 = arg1;
		this.anInt4091 = 0;
	}
	...
	synchronized void method27105(@OriginalArg(0) boolean arg0) {
		this.aBoolean704 = arg0;
	}

	@OriginalMember(owner = "client!hk", name = "ch", descriptor = "(Z)V", line = 225)
	synchronized void method27106(@OriginalArg(0) boolean arg0) {
		this.aBoolean704 = arg0;
	}

	@OriginalMember(owner = "client!hk", name = "cb", descriptor = "(Z)V", line = 225)
	synchronized void method27107(@OriginalArg(0) boolean arg0) {
		this.aBoolean704 = arg0;
	}
	...
	synchronized void method27108(@OriginalArg(0) boolean arg0) {
		this.aBoolean704 = arg0;
	}
	...
	Class308[] method27110(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(2) Class308[] local2 = new Class308[arg0];
		for (@Pc(4) int local4 = 0; local4 < local2.length; local4++) {
			local2[local4] = this.method27122(arg1);
		}
	...
	Class308 method27111(@OriginalArg(0) int arg0) {
		@Pc(2) Class240 local2 = aClass240_78;
		synchronized (aClass240_78) {
			@Pc(5) Class308 local5 = null;
			local5 = (Class308) aClass240_78.method25859(1893897135);
			...
			while (local5 != null) {
				...
				local5 = (Class308) aClass240_78.method25846(-1178677118);
			}
			if (local5 == null) {
				local5 = local12;
			}
			...
			if (local5 == null) {
				...
				while (!local67 && local65 < 1000) {
					if (aClass240_78.method25839((long) local65) == null) {
						local67 = true;
					} else {
						local65++;
					}
				...
				if (aClass240_78.method25835((byte) 122) < arg0 * 4) {
				}
				aClass240_78.method25831(local5, (long) local5.anInt3948, local88.length * 4, 45463102);
			} else {
	...
	Class308 method27112(@OriginalArg(0) int arg0) {
		@Pc(2) Class240 local2 = aClass240_78;
		synchronized (aClass240_78) {
			@Pc(5) Class308 local5 = null;
			local5 = (Class308) aClass240_78.method25859(1967836458);
			@Pc(12) Class308 local12 = null;
			@Pc(14) int local14 = arg0;
			while (local5 != null) {
				if (local5.aFloatArray103.length > arg0 && !local5.aBoolean679 && (local12 == null || local5.aFloatArray103.length < local14)) {
				...
				local5 = (Class308) aClass240_78.method25846(-1241931400);
			}
			if (local5 == null) {
				local5 = local12;
			}
			...
			if (local5 == null) {
				...
				local5.aBoolean679 = true;
				local5.anInt3947 = arg0;
				if (aClass240_78.method25835((byte) 121) < arg0 * 4) {
				}
				aClass240_78.method25831(local5, (long) local5.anInt3948, local88.length * 4, 91683900);
			} else {
				for (local65 = 0; local65 < local5.aFloatArray103.length; local65++) {
					local5.aFloatArray103[local65] = 0.0F;
				}
	...
	void method27113(@OriginalArg(0) Class308 arg0) {
		if (arg0 != null) {
			@Pc(5) Class240 local5 = aClass240_78;
			synchronized (aClass240_78) {
				arg0.aBoolean679 = false;
	...
	void method27114(@OriginalArg(0) Class308[] arg0) {
		if (arg0 != null) {
			for (@Pc(4) int local4 = 0; local4 < arg0.length; local4++) {
				this.method27063(arg0[local4]);
			}
	...
	void method27115(@OriginalArg(0) Class308[] arg0) {
		if (arg0 != null) {
			for (@Pc(4) int local4 = 0; local4 < arg0.length; local4++) {
				this.method27063(arg0[local4]);
			}
	...
	boolean method27116(@OriginalArg(0) int arg0, @OriginalArg(1) Class433 arg1, @OriginalArg(2) Class426 arg2) {
		if (arg1 == Class433.aClass433_3) {
			return true;
		} else if (arg1 == Class433.aClass433_4) {
			return true;
	...
	synchronized void method27117(@OriginalArg(0) boolean arg0) {
		if (!arg0) {
			this.anInt4071 = 0;
			this.anInt4067 = 0;
			this.aBooleanArray25 = null;
	...
	void method27118(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		this.anInt4085 = 0;
		if (this.method27011()) {
			return;
		}
		...
		if (local15 == 1) {
			...
			for (local67 = 0; local67 < 2; local67++) {
				...
				@Pc(356) int[] local356 = new int[local198];
				@Pc(362) int local362 = Class548.method31014(local198 - 1, -912053816);
				for (@Pc(364) int local364 = 0; local364 < local198; local364++) {
					local356[local364] = Class438.method28829(local364, local362, 2073155620);
				}
				if (local67 == 0) {
	...
	void method27120(@OriginalArg(0) Class93_Sub41 arg0) {
	...
	Class308 method27122(@OriginalArg(0) int arg0) {
		@Pc(2) Class240 local2 = aClass240_78;
		synchronized (aClass240_78) {
			@Pc(5) Class308 local5 = null;
			local5 = (Class308) aClass240_78.method25859(1851879417);
			@Pc(12) Class308 local12 = null;
			@Pc(14) int local14 = arg0;
			while (local5 != null) {
				if (local5.aFloatArray103.length > arg0 && !local5.aBoolean679 && (local12 == null || local5.aFloatArray103.length < local14)) {
				...
				local5 = (Class308) aClass240_78.method25846(-1142619747);
			}
			if (local5 == null) {
				local5 = local12;
			}
			...
			if (local5 == null) {
				...
				local5.aBoolean679 = true;
				local5.anInt3947 = arg0;
				if (aClass240_78.method25835((byte) 120) < arg0 * 4) {
				}
				aClass240_78.method25831(local5, (long) local5.anInt3948, local88.length * 4, 386990751);
			} else {
				for (local65 = 0; local65 < local5.aFloatArray103.length; local65++) {
					local5.aFloatArray103[local65] = 0.0F;
				}
	...
	boolean method27124(@OriginalArg(0) Class93_Sub41 arg0) {
		return arg0.method22413((short) 16384) == 79 && arg0.method22413((short) 16384) == 103 && arg0.method22413((short) 16384) == 103 && arg0.method22413((short) 16384) == 83;
	}

	@OriginalMember(owner = "client!hk", name = "ds", descriptor = "([BII)Z", line = 424)
	boolean method27125(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg0[arg1] == arg2) {
			return arg0[arg1 + 1] == 118 && arg0[arg1 + 2] == 111 && arg0[arg1 + 3] == 114 && arg0[arg1 + 4] == 98 && arg0[arg1 + 5] == 105 && arg0[arg1 + 6] == 115;
		} else {
			return false;
	...
	void method27126(@OriginalArg(0) Class413 arg0) {
		this.aClass413_1 = arg0;
	}

	@OriginalMember(owner = "client!hk", name = "cs", descriptor = "(Z)V", line = 225)
	synchronized void method27127(@OriginalArg(0) boolean arg0) {
		this.aBoolean704 = arg0;
	}

	@OriginalMember(owner = "client!hk", name = "ao", descriptor = "()V", line = 1005)
	synchronized void method27128() {
		...
		if (this.aClass93_Sub41_15 == null) {
			this.aClass93_Sub41_15 = this.method27097(local12);
			this.anInt4076 = 0;
			local10 = 0;
		} else if (this.aClass93_Sub41_15.aByteArray58.length - this.aClass93_Sub41_15.anInt3070 * 212851357 < local12) {
			@Pc(53) Class93_Sub41 local53 = this.method27097(local12 + this.anInt4076);
			local53.method22405(this.aClass93_Sub41_15.aByteArray58, this.aClass93_Sub41_15.anInt3070 * 212851357 - this.anInt4078, this.anInt4076, 2026842986);
			this.aClass93_Sub41_15.method22651((byte) 1);
		...
		while (local16.hasNext()) {
			local23 = (Class93_Sub41) local16.next();
			this.aClass93_Sub41_15.method22405(local23.aByteArray58, 0, local23.anInt3070 * 212851357, 2026842986);
			this.anInt4076 += local23.anInt3070 * 212851357;
			local23.method22651((byte) 1);
		}
		...
		label286: while (true) {
			if (this.aBoolean705) {
				if (this.aClass93_Sub41_15.anInt3070 * 212851357 < this.aClass93_Sub41_15.aByteArray58.length) {
					if (this.aBoolean704 && (float) (this.anInt4087 / this.method27056()) > this.aFloat285) {
						return;
					}
					if (this.aClass93_Sub41_15 != null && this.anInt4076 >= 27) {
						...
						if (!this.method27069(this.aClass93_Sub41_15)) {
							return;
						}
						this.anInt4082++;
						if (this.anInt4081 < 0) {
						...
						this.aList18.clear();
						this.aList19.clear();
						this.aClass93_Sub41_15.method22413((short) 16384);
						@Pc(246) int local246 = this.aClass93_Sub41_15.method22413((short) 16384);
						@Pc(278) int local278 = this.aClass93_Sub41_15.method22413((short) 16384) & 0xFF | (this.aClass93_Sub41_15.method22413((short) 16384) & 0xFF) << 8 | (this.aClass93_Sub41_15.method22413((short) 16384) & 0xFF) << 16 | this.aClass93_Sub41_15.method22413((short) 16384) << 24;
						@Pc(282) int local282 = local278 - local207;
						this.aClass93_Sub41_15.anInt3070 += -1655194800;
						@Pc(294) int local294 = this.aClass93_Sub41_15.method22413((short) 16384);
						...
						while (true) {
							while (local420.hasNext()) {
								...
								if (this.method27011() && this.aBoolean706 && this.anInt4082 < this.anInt4080 && local352 < this.anInt4081) {
									...
									this.anAtomicReference1.set((Object) null);
									@Pc(486) boolean local486 = this.method27089(this.aClass93_Sub41_15.aByteArray58, local436, local440, this.anAtomicReference1);
									@Pc(492) Class308[] local492 = (Class308[]) (Class308[]) this.anAtomicReference1.get();
									if (!local486 || this.aBoolean706 && this.anInt4082 < this.anInt4080 && local352 < this.anInt4081) {
										if (this.method27011()) {
											...
											if (this.aClass308Array1 == null || this.aClass308Array1 != null && (this.aClass308Array1.length != this.anInt4064 || this.aClass308Array1[0].anInt3947 != this.anInt4067)) {
												...
												this.aClass308Array1 = this.method27074(this.anInt4064, this.anInt4067);
											}
										}
										...
										if (this.method27134() < this.method27005()) {
											@Pc(666) int local666 = this.method27005() - this.method27134();
											local567 += local567 / this.method27134() * local666;
										}
										@Pc(679) Class93_Sub41 local679 = this.method27097(local567);
											...
											if (local687 && (this.anInt4079 < this.anInt4090 || this.anInt4079 > this.anInt4070)) {
												...
												for (@Pc(766) int local766 = 0; local766 < local578; local766++) {
													...
													if (local766 < local492.length) {
														...
														local780 = local492[local766 % this.method27134()].aFloatArray103[local681];
													}
													@Pc(799) int local799;
													if (this.aClass433_1 == Class433.aClass433_3) {
														local799 = this.method27157(local780);
														if (this.aClass426_1 == Class426.aClass426_3) {
															local679.method22393(local799, -780121020);
														} else {
															local679.method22454(local799, 2130664763);
														}
													} else if (this.aClass433_1 == Class433.aClass433_2) {
														local799 = this.method27084(local780);
														if (this.aClass426_1 == Class426.aClass426_3) {
															local679.method22393(local799, -1047882561);
														} else {
															local679.method22454(local799, 2128695869);
														}
													} else if (this.aClass433_1 == Class433.aClass433_4) {
														local799 = this.method27154(local780);
														local679.method22510(local799, (byte) -5);
													} else if (this.aClass433_1 == Class433.aClass433_5) {
														local799 = this.method27086(local780);
														local679.method22510(local799, (byte) -108);
													}
												}
												this.anInt4079++;
												local209++;
	...
	int method27133(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = 0;
		@Pc(3) int local3 = 0;
		@Pc(14) int local14;
		while (arg0 >= 8 - this.anInt4091) {
	...
	void method27135(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		this.anInt4085 = 0;
		if (this.method27011()) {
			return;
		}
		...
		if (local15 == 1) {
			...
			for (local67 = 0; local67 < 2; local67++) {
				...
				@Pc(356) int[] local356 = new int[local198];
				@Pc(362) int local362 = Class548.method31014(local198 - 1, -1846707322);
				for (@Pc(364) int local364 = 0; local364 < local198; local364++) {
					local356[local364] = Class438.method28829(local364, local362, 2073155620);
				}
				if (local67 == 0) {
	...
	int method27136(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = 0;
		@Pc(3) int local3 = 0;
		@Pc(14) int local14;
		while (arg0 >= 8 - this.anInt4091) {
	...
	int method27137(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = 0;
		while (arg0 > 0) {
			local1++;
			arg0 >>= 0x1;
	...
	int method27138(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = 0;
		while (arg0 > 0) {
			local1++;
			arg0 >>= 0x1;
	...
	int method27139(@OriginalArg(0) float arg0) {
		@Pc(6) int local6 = (int) (arg0 * 32767.0F + 32768.0F);
		if (local6 > 65535) {
			return 65535;
		} else if (local6 < 0) {
	...
	int method27140(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = 0;
		while (arg0 > 0) {
			local1++;
			arg0 >>= 0x1;
	...
	boolean method27141(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) AtomicReference arg3) {
		if (arg0 == null) {
			throw new RuntimeException("");
		} else if (arg1 + arg2 > arg0.length) {
			return false;
			...
			if (local21 != 0) {
				...
				for (local188 = 0; local188 < this.anInt4064; local188++) {
					if (this.aBooleanArray28[local188]) {
						...
						local768 = Class548.method31014(local59 - 1, -444506734);
						@Pc(1002) int local1002;
						@Pc(1013) int local1013;
						@Pc(1017) int local1017;
						@Pc(1019) int local1019;
	...
	boolean method27142(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) AtomicReference arg3) {
		if (arg0 == null) {
			throw new RuntimeException("");
		} else if (arg1 + arg2 > arg0.length) {
			return false;
			...
			if (local21 != 0) {
				...
				for (local188 = 0; local188 < this.anInt4064; local188++) {
					if (this.aBooleanArray28[local188]) {
						...
						local768 = Class548.method31014(local59 - 1, -3269982);
						@Pc(1002) int local1002;
						@Pc(1013) int local1013;
						@Pc(1017) int local1017;
						@Pc(1019) int local1019;
	...
	boolean method27143(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) AtomicReference arg3) {
		if (arg0 == null) {
			throw new RuntimeException("");
		} else if (arg1 + arg2 > arg0.length) {
			return false;
			...
			if (local21 != 0) {
				...
				for (local188 = 0; local188 < this.anInt4064; local188++) {
					if (this.aBooleanArray28[local188]) {
						...
						local768 = Class548.method31014(local59 - 1, -582350680);
						@Pc(1002) int local1002;
						@Pc(1013) int local1013;
						@Pc(1017) int local1017;
						@Pc(1019) int local1019;
	...
	synchronized void method27144(@OriginalArg(0) boolean arg0) {
		if (!arg0) {
			this.anInt4071 = 0;
			this.anInt4067 = 0;
			this.aBooleanArray25 = null;
	...
	boolean method27145(@OriginalArg(0) int arg0, @OriginalArg(1) Class433 arg1, @OriginalArg(2) Class426 arg2) {
		if (arg1 == Class433.aClass433_3) {
			return true;
		} else if (arg1 == Class433.aClass433_4) {
			return true;
	...
	synchronized void method27146(@OriginalArg(0) Class93_Sub41 arg0) {
		this.aList14.add(arg0);
		this.method27126(Class413.aClass413_3);
	}

	@OriginalMember(owner = "client!hk", name = "eh", descriptor = "()V", line = 1005)
	synchronized void method27147() {
		@Pc(10) int local10 = this.aClass93_Sub41_15 == null ? 0 : this.aClass93_Sub41_15.anInt3070 * 212851357;
		@Pc(12) int local12 = 0;
		@Pc(16) Iterator local16 = this.aList17.iterator();
		@Pc(23) Class93_Sub41 local23;
											...
											if (local687 && (this.anInt4079 < this.anInt4090 || this.anInt4079 > this.anInt4070)) {
												...
												for (@Pc(766) int local766 = 0; local766 < local578; local766++) {
													...
													if (this.aClass433_1 == Class433.aClass433_3) {
														local799 = this.method27157(local780);
														if (this.aClass426_1 == Class426.aClass426_3) {
															local679.method22393(local799, -673462710);
														} else {
															local679.method22454(local799, 2129349536);
														}
													} else if (this.aClass433_1 == Class433.aClass433_2) {
														local799 = this.method27084(local780);
														if (this.aClass426_1 == Class426.aClass426_3) {
															local679.method22393(local799, -2063974716);
														} else {
															local679.method22454(local799, 2144521847);
														}
													} else if (this.aClass433_1 == Class433.aClass433_4) {
														local799 = this.method27154(local780);
														local679.method22510(local799, (byte) -24);
													} else if (this.aClass433_1 == Class433.aClass433_5) {
														local799 = this.method27086(local780);
														local679.method22510(local799, (byte) -128);
													}
												}
												this.anInt4079++;
												local209++;
											...
											if (local687 && (this.anInt4079 < this.anInt4090 || this.anInt4079 > this.anInt4070)) {
												...
												for (@Pc(766) int local766 = 0; local766 < local578; local766++) {
													...
													if (this.aClass433_1 == Class433.aClass433_3) {
														local799 = this.method27157(local780);
														if (this.aClass426_1 == Class426.aClass426_3) {
															local679.method22393(local799, -1318826549);
														} else {
															local679.method22454(local799, 2128322208);
														}
													} else if (this.aClass433_1 == Class433.aClass433_2) {
														local799 = this.method27084(local780);
														if (this.aClass426_1 == Class426.aClass426_3) {
															local679.method22393(local799, -1599476284);
														} else {
															local679.method22454(local799, 2135066686);
														}
													} else if (this.aClass433_1 == Class433.aClass433_4) {
														local799 = this.method27154(local780);
														local679.method22510(local799, (byte) -79);
													} else if (this.aClass433_1 == Class433.aClass433_5) {
														local799 = this.method27086(local780);
														local679.method22510(local799, (byte) -120);
													}
												}
												this.anInt4079++;
												local209++;
	...
	void method27150(@OriginalArg(0) Class93_Sub41 arg0) {
		this.aList17.add(arg0);
	}
	...
	void method27153(@OriginalArg(0) Class93_Sub41 arg0) {
		this.aList17.add(arg0);
	}

	@OriginalMember(owner = "client!hk", name = "ab", descriptor = "(F)I", line = 1266)
	int method27154(@OriginalArg(0) float arg0) {
		@Pc(4) int local4 = (int) (arg0 * 127.0F);
		if (local4 > 127) {
			return 127;
		} else if (local4 < -128) {
	...
	float method27155(@OriginalArg(0) int arg0) {
		@Pc(3) int local3 = arg0 & 0x1FFFFF;
		@Pc(7) int local7 = arg0 & Integer.MIN_VALUE;
		@Pc(13) int local13 = arg0 >> 21 & 0x3FF;
		if (local7 != 0) {
	...
	int method27157(@OriginalArg(0) float arg0) {
		@Pc(4) int local4 = (int) (arg0 * 32767.0F);
		if (local4 > 32767) {
			return 32767;
		} else if (local4 < -32768) {
