...
public class Class315 implements Interface45 {
	...
	boolean method27100(@OriginalArg(1) Class433 arg0, @OriginalArg(2) Class426 arg1) {
		if (arg0 == Class433.aClass433_3) {
			return true;
		} else if (arg0 == Class433.aClass433_4) {
			return true;
		} else if (arg0 == Class433.aClass433_2) {
			return true;
		} else {
			return arg0 == Class433.aClass433_5;
		}
	}

	@OriginalMember(owner = "client!hk", name = "cv", descriptor = "(ILclient!nd;Lclient!mw;)Z", line = 199)
	boolean method27116(@OriginalArg(1) Class433 arg0, @OriginalArg(2) Class426 arg1) {
		if (arg0 == Class433.aClass433_3) {
			return true;
		} else if (arg0 == Class433.aClass433_4) {
			return true;
	...
	boolean method27145(@OriginalArg(1) Class433 arg0, @OriginalArg(2) Class426 arg1) {
		if (arg0 == Class433.aClass433_3) {
			return true;
		} else if (arg0 == Class433.aClass433_4) {
			return true;
	...
	Class308 method27111(@OriginalArg(0) int arg0) {
		...
		synchronized (aClass240_78) {
			@Pc(10) Class308 local10 = (Class308) aClass240_78.method25859();
			@Pc(12) Class308 local12 = null;
			@Pc(14) int local14 = arg0;
			while (local10 != null) {
				if (local10.aFloatArray103.length > arg0 && !local10.aBoolean679 && (local12 == null || local10.aFloatArray103.length < local14)) {
					local12 = local10;
					local14 = local10.aFloatArray103.length;
				}
				if (local10.aFloatArray103.length == arg0 && !local10.aBoolean679) {
					break;
				}
				local10 = (Class308) aClass240_78.method25846();
			}
			if (local10 == null) {
				local10 = local12;
			}
			...
			if (local10 == null) {
				...
				local10.anInt3948 = local65;
				@Pc(88) float[] local88 = new float[arg0];
				local10.aFloatArray103 = local88;
				local10.aBoolean679 = true;
				local10.anInt3947 = arg0;
				if (aClass240_78.method25835() < arg0 * 4) {
				}
				aClass240_78.method25831(local10, (long) local10.anInt3948, local88.length * 4);
			} else {
				for (local65 = 0; local65 < local10.aFloatArray103.length; local65++) {
					local10.aFloatArray103[local65] = 0.0F;
				}
				local10.anInt3947 = arg0;
			}
			local10.aBoolean679 = true;
	...
	synchronized void method27065(@OriginalArg(0) boolean arg0) {
		...
		if (this.aClass93_Sub41_15 != null) {
			...
			synchronized (this.aClass93_Sub41_15) {
				this.aClass93_Sub41_15.method22651();
	...
	boolean method27069(@OriginalArg(0) Class93_Sub41 arg0) {
		return arg0.method22413() == 79 && arg0.method22413() == 103 && arg0.method22413() == 103 && arg0.method22413() == 83;
	}
	...
	void method27078(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		...
		if (local15 == 1) {
			...
			for (local67 = 0; local67 < 2; local67++) {
				...
				@Pc(362) int local362 = Class548.method31014(local198 - 1);
				for (@Pc(364) int local364 = 0; local364 < local198; local364++) {
					local356[local364] = Class438.method28829(local364, local362);
				}
				if (local67 == 0) {
			...
			if (local21 != 0) {
					...
					if (local333.anInt3909 == 2) {
						...
						while (true) {
							...
							if (local349 >= local59) {
								...
								local396 = this.aClass308Array2;
								for (local349 = 0; local349 < local59; local349++) {
									for (local354 = 0; local354 < this.anInt4064; local354++) {
										try {
											local396[local354].aFloatArray103[local349] = local347[0].aFloatArray103[this.anInt4064 * local349 + local354];
						...
						local396 = local333.method26553(this.aClass308Array2, local59 >> 1, this.aBooleanArray26);
					}
					if (local167.anIntArray387 == null) {
						if (this.aClass308Array2 != local396) {
							this.method27064(this.aClass308Array2);
						}
						this.aClass308Array2 = local396;
					} else {
						local202 = 0;
						for (local455 = 0; local455 < this.anInt4064; local455++) {
							local349 = local167.anIntArray387[local455];
							if (local349 == local188) {
								this.aClass308Array2[local455] = local396[local202++];
							}
						}
					}
				}
				...
				for (local188 = 0; local188 < this.anInt4064; local188++) {
					if (this.aBooleanArray28[local188]) {
						...
						local768 = Class548.method31014(local59 - 1);
		...
		if (!this.method27068()) {
			...
			if (local41 == null) {
				if (!this.aBoolean702) {
					...
					this.anInterface41_1.method30622();
	...
	synchronized void method27128() {
		...
		if (this.aClass93_Sub41_15 == null) {
			...
			local53.method22405(this.aClass93_Sub41_15.aByteArray58, this.aClass93_Sub41_15.anInt3070 * 212851357 - this.anInt4078, this.anInt4076);
			this.aClass93_Sub41_15.method22651();
		...
		while (local16.hasNext()) {
			local23 = (Class93_Sub41) local16.next();
			this.aClass93_Sub41_15.method22405(local23.aByteArray58, 0, local23.anInt3070 * 212851357);
			...
			if (this.aBoolean705) {
				if (this.aClass93_Sub41_15.anInt3070 * 212851357 < this.aClass93_Sub41_15.aByteArray58.length) {
					...
					if (this.aClass93_Sub41_15 != null && this.anInt4076 >= 27) {
						...
						this.aList18.clear();
						this.aList19.clear();
						this.aClass93_Sub41_15.method22413();
						@Pc(246) int local246 = this.aClass93_Sub41_15.method22413();
						@Pc(278) int local278 = this.aClass93_Sub41_15.method22413() & 0xFF | (this.aClass93_Sub41_15.method22413() & 0xFF) << 8 | (this.aClass93_Sub41_15.method22413() & 0xFF) << 16 | this.aClass93_Sub41_15.method22413() << 24;
						@Pc(282) int local282 = local278 - local207;
						this.aClass93_Sub41_15.anInt3070 += -1655194800;
						@Pc(294) int local294 = this.aClass93_Sub41_15.method22413();
												...
												for (@Pc(766) int local766 = 0; local766 < local578; local766++) {
													...
													if (this.aClass433_1 == Class433.aClass433_3) {
														...
														if (this.aClass426_1 == Class426.aClass426_3) {
															local679.method22393(local799);
														} else {
															local679.method22454(local799);
														}
	...
	Class93_Sub41 method27059(@OriginalArg(0) int arg0) {
		...
		synchronized (this.aList16) {
			while (!this.aList16.isEmpty()) {
				...
				local5.method22405(local22.aByteArray58, 0, local53);
