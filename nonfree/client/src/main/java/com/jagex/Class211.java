...
public class Class211 implements Interface75 {
	...
	static final Class211 aClass211_12 = new Class211(0, 0, (String) null, -1, -1);

	@OriginalMember(owner = "client!cr", name = "n", descriptor = "Lclient!cr;")
	static final Class211 aClass211_6 = new Class211(1, 1, (String) null, 0, 2);

	@OriginalMember(owner = "client!cr", name = "m", descriptor = "Lclient!cr;")
	static final Class211 aClass211_3 = new Class211(2, 2, (String) null, 1, 2);

	@OriginalMember(owner = "client!cr", name = "k", descriptor = "Lclient!cr;")
	static final Class211 aClass211_4 = new Class211(3, 3, (String) null, 2, 2);

	@OriginalMember(owner = "client!cr", name = "f", descriptor = "Lclient!cr;")
	static final Class211 aClass211_5 = new Class211(4, 4, (String) null, 0, 1);

	@OriginalMember(owner = "client!cr", name = "w", descriptor = "Lclient!cr;")
	static final Class211 aClass211_10 = new Class211(5, 5, (String) null, 1, 1);

	@OriginalMember(owner = "client!cr", name = "l", descriptor = "Lclient!cr;")
	static final Class211 aClass211_1 = new Class211(6, 6, (String) null, 2, 1);

	@OriginalMember(owner = "client!cr", name = "u", descriptor = "Lclient!cr;")
	static final Class211 aClass211_8 = new Class211(7, 7, (String) null, 0, 3);

	@OriginalMember(owner = "client!cr", name = "z", descriptor = "Lclient!cr;")
	static final Class211 aClass211_9 = new Class211(8, 8, (String) null, 1, 3);

	@OriginalMember(owner = "client!cr", name = "p", descriptor = "Lclient!cr;")
	static final Class211 aClass211_15 = new Class211(9, 9, (String) null, 2, 3);

	@OriginalMember(owner = "client!cr", name = "d", descriptor = "Lclient!cr;")
	static final Class211 aClass211_7 = new Class211(10, 10, (String) null, 0, 7);

	@OriginalMember(owner = "client!cr", name = "c", descriptor = "Lclient!cr;")
	static final Class211 aClass211_11 = new Class211(11, 11, (String) null, 1, 7);

	@OriginalMember(owner = "client!cr", name = "r", descriptor = "Lclient!cr;")
	static final Class211 aClass211_13 = new Class211(12, 12, (String) null, 2, 7);

	@OriginalMember(owner = "client!cr", name = "v", descriptor = "Lclient!cr;")
	static final Class211 aClass211_14 = new Class211(13, 13, (String) null, 3, 7);

	@OriginalMember(owner = "client!cr", name = "o", descriptor = "Lclient!cr;")
	static final Class211 aClass211_2 = new Class211(14, 14, (String) null, 4, 7);

	@OriginalMember(owner = "client!cr", name = "s", descriptor = "Lclient!cr;")
	static final Class211 aClass211_16 = new Class211(15, 15, (String) null, 5, 7);

	@OriginalMember(owner = "client!cr", name = "y", descriptor = "Lclient!cr;")
	static final Class211 aClass211_17 = new Class211(16, 16, (String) null, 0, 5);
	...
	int method25422(@OriginalArg(0) int arg0) {
		return this.anInt3599 * -1903657371;
	}
	...
	static Class211 method25426(@OriginalArg(0) int arg0) {
		@Pc(6) Class211 local6 = (Class211) Class107.method18119(Class430.method28760(-406593969), arg0, -1915563430);
		if (local6 == null) {
			local6 = aClass211_12;
		}
		return local6;
	...
	public static void method25428(@OriginalArg(0) int arg0) {
	...
	static final void method25430(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		Class339.method27488(local17, -575951673);
	}
}
