...
final class Class543 implements Interface62 {
	...
	static void method30942(@OriginalArg(0) Class104 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class312 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		for (@Pc(1) int local1 = 7; local1 >= 0; local1--) {
			for (@Pc(5) int local5 = 127; local5 >= 0; local5--) {
				...
				Class660.method32825(false, true, 1887928092);
	...
	static void method30943(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
	}

	@OriginalMember(owner = "client!s", name = "amw", descriptor = "(Lclient!yf;I)V", line = 12119)
	static final void method30944(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(47) Class611 local47 = client.aClass532_1.method30443(1876677413);
		Class29.method605((local13 >> 14 & 0x3FFF) - local47.anInt5623 * 270611681, (local13 & 0x3FFF) - local47.anInt5624 * -1994307635, local23 << 2, local33, local43, (byte) 26);
		client.aBoolean619 = true;
	}

	@OriginalMember(owner = "client!s", name = "atb", descriptor = "(Lclient!yf;I)V", line = 13333)
	static final void method30945(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub2_1.method15376(-1817165002) == 1 ? 1 : 0;
	}
	...
	public static void method30948(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2) {
		Class704.method36732(arg0, Class74.aClass74_99.method1259(Class106.aClass717_8, (byte) 12), arg1, (byte) -27);
	}
}
