...
public final class Class113_Sub1 extends Class113 {
	...
	public void method7413(@OriginalArg(0) int arg0) {
		if (Class305.method26796(593627234) < this.aLong27 * 1159186737028678961L) {
			return;
		}
		@Pc(35) int local35;
		...
		@Pc(73) Class175 local73 = Class330.method27372(-1979308137);
		...
		local86.aClass93_Sub41_Sub2_1.method22454(0, 2138201948);
		...
		local86.aClass93_Sub41_Sub2_1.method22407(local86.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local35, 810164877);
		...
		local73.method24351(local86, -1435756525);
		this.aLong27 = (Class305.method26796(1428123275) + 1000L) * -1570658587136822319L;
	}
	...
	public void method7416() {
		if (Class305.method26796(952254604) < this.aLong27 * 1159186737028678961L) {
			return;
		}
		@Pc(35) int local35;
		if (this.aClass466Array1 == null) {
		...
		@Pc(73) Class175 local73 = Class330.method27372(-1511587473);
		if (local73.anInt3299 * 195575097 > 1200) {
			return;
		}
		@Pc(86) Class93_Sub22 local86 = Class102.method2592(Class446.aClass446_53, local73.aClass24_2, (byte) 52);
		local86.aClass93_Sub41_Sub2_1.method22454(0, 2136273513);
		local35 = local86.aClass93_Sub41_Sub2_1.anInt3070 * 212851357;
		local86.aClass93_Sub41_Sub2_1.anInt3070 += -1445626955;
		while (this.anInt865 * -866505885 < this.aClass466Array1.length) {
			@Pc(120) Class466 local120 = this.aClass466Array1[this.anInt865 * -866505885];
		...
		local86.aClass93_Sub41_Sub2_1.method22407(local86.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local35, 1212927647);
		if (this.anInt865 * -866505885 >= this.aClass466Array1.length) {
			local86.aClass93_Sub41_Sub2_1.aByteArray58[local35] = 1;
		} else {
			local86.aClass93_Sub41_Sub2_1.aByteArray58[local35] = 0;
		}
		local73.method24351(local86, -1784685613);
		this.aLong27 = (Class305.method26796(-336313948) + 1000L) * -1570658587136822319L;
	}
	...
	public void method7417(@OriginalArg(0) Class38 arg0, @OriginalArg(1) byte arg1) {
		...
		label109: {
			label108: {
				try {
					...
					local37.method22510(1, (byte) -51);
					local37.method22454(local5, 2129287945);
		...
		this.aLong26 = Class305.method26796(-212452098) * -2265688048181101683L;
					...
					label256: {
						label257: {
							try {
								...
								@Pc(58) int local58 = local38.method22413((short) 16384);
								if (local58 < 0) {
									var20 = false;
									break label255;
								}
								...
								@Pc(89) int local89 = local38.method22415(-1434290800);
								...
								while (true) {
									...
									if (this.aClass507Array1[local117.anInt5092 * -1181855333] == Class507.aClass507_4 && ((Class108) Class72.aClass79_Sub1_Sub2_2.method18261(local117.anInt5092 * -1181855333, -2028069293)).aClass519_6.method30311((byte) 36).aClass2.isAssignableFrom(local117.anObject19.getClass())) {
						...
						label257: {
							try {
								...
								while (true) {
									...
									if (this.aClass507Array1[local117.anInt5092 * -1181855333] == Class507.aClass507_4 && ((Class108) Class72.aClass79_Sub1_Sub2_2.method18261(local117.anInt5092 * -1181855333, -2073808347)).aClass519_6.method30311((byte) 36).aClass2.isAssignableFrom(local117.anObject19.getClass())) {
	...
	public void method7422(@OriginalArg(0) Class38 arg0) {
		...
		label109: {
			label108: {
				try {
					...
					@Pc(37) Class93_Sub41 local37 = new Class93_Sub41(local3);
					local37.method22510(1, (byte) -93);
					local37.method22454(local5, 2141211611);
					@Pc(49) Iterator local49 = this.anInterface3_2.iterator();
					while (local49.hasNext()) {
						@Pc(56) Class466 local56 = (Class466) local49.next();
						if (Class507.aClass507_4 == this.aClass507Array1[local56.anInt5092 * -1181855333]) {
		...
		this.aLong26 = Class305.method26796(-150741539) * -2265688048181101683L;
		this.aBoolean171 = false;
	}
	...
	public void method7423(@OriginalArg(0) Class38 arg0) {
		...
		label109: {
			label108: {
				try {
					...
					@Pc(37) Class93_Sub41 local37 = new Class93_Sub41(local3);
					local37.method22510(1, (byte) -89);
					local37.method22454(local5, 2133865078);
					@Pc(49) Iterator local49 = this.anInterface3_2.iterator();
					while (local49.hasNext()) {
						@Pc(56) Class466 local56 = (Class466) local49.next();
						if (Class507.aClass507_4 == this.aClass507Array1[local56.anInt5092 * -1181855333]) {
		...
		this.aLong26 = Class305.method26796(1016503932) * -2265688048181101683L;
		this.aBoolean171 = false;
	}

	@OriginalMember(owner = "client!afu", name = "ax", descriptor = "()V", line = 158)
	public void method7424() {
		if (Class305.method26796(-154550489) < this.aLong27 * 1159186737028678961L) {
			return;
		}
		@Pc(35) int local35;
		if (this.aClass466Array1 == null) {
		...
		@Pc(73) Class175 local73 = Class330.method27372(-1687992933);
		if (local73.anInt3299 * 195575097 > 1200) {
			return;
		}
		@Pc(86) Class93_Sub22 local86 = Class102.method2592(Class446.aClass446_53, local73.aClass24_2, (byte) 33);
		local86.aClass93_Sub41_Sub2_1.method22454(0, 2135477586);
		local35 = local86.aClass93_Sub41_Sub2_1.anInt3070 * 212851357;
		local86.aClass93_Sub41_Sub2_1.anInt3070 += -1445626955;
		while (this.anInt865 * -866505885 < this.aClass466Array1.length) {
			@Pc(120) Class466 local120 = this.aClass466Array1[this.anInt865 * -866505885];
		...
		local86.aClass93_Sub41_Sub2_1.method22407(local86.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local35, -1536370504);
		if (this.anInt865 * -866505885 >= this.aClass466Array1.length) {
			local86.aClass93_Sub41_Sub2_1.aByteArray58[local35] = 1;
		} else {
			local86.aClass93_Sub41_Sub2_1.aByteArray58[local35] = 0;
		}
		local73.method24351(local86, -2102565645);
		this.aLong27 = (Class305.method26796(1556519612) + 1000L) * -1570658587136822319L;
	}

	@OriginalMember(owner = "client!afu", name = "av", descriptor = "()V", line = 158)
	public void method7425() {
		if (Class305.method26796(140476184) < this.aLong27 * 1159186737028678961L) {
			return;
		}
		@Pc(35) int local35;
		if (this.aClass466Array1 == null) {
		...
		@Pc(73) Class175 local73 = Class330.method27372(-1517696522);
		if (local73.anInt3299 * 195575097 > 1200) {
			return;
		}
		@Pc(86) Class93_Sub22 local86 = Class102.method2592(Class446.aClass446_53, local73.aClass24_2, (byte) 125);
		local86.aClass93_Sub41_Sub2_1.method22454(0, 2125731311);
		local35 = local86.aClass93_Sub41_Sub2_1.anInt3070 * 212851357;
		local86.aClass93_Sub41_Sub2_1.anInt3070 += -1445626955;
		while (this.anInt865 * -866505885 < this.aClass466Array1.length) {
			@Pc(120) Class466 local120 = this.aClass466Array1[this.anInt865 * -866505885];
		...
		local86.aClass93_Sub41_Sub2_1.method22407(local86.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local35, 1251982343);
		if (this.anInt865 * -866505885 >= this.aClass466Array1.length) {
			local86.aClass93_Sub41_Sub2_1.aByteArray58[local35] = 1;
		} else {
			local86.aClass93_Sub41_Sub2_1.aByteArray58[local35] = 0;
		}
		local73.method24351(local86, -2068777433);
		this.aLong27 = (Class305.method26796(1109693824) + 1000L) * -1570658587136822319L;
	}
	...
	public static void method7427(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (client.anInt3435 * -849002901 == 0) {
			...
			local10.aClass93_Sub41_Sub2_1.method22510(arg0, (byte) -78);
			client.aClass175_1.method24351(local10, -2112472349);
		}
	}
}
