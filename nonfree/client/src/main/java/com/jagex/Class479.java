...
public class Class479 {
	...
	public float method29711(@OriginalArg(0) float arg0) {
		return this.method29718(this.method29720(arg0));
	}

	@OriginalMember(owner = "client!pe", name = "n", descriptor = "()I", line = 28)
	public int method29712() {
	...
	public float method29713() {
		...
		for (@Pc(3) int local3 = 0; local3 < this.aClass482Array1.length; local3++) {
			local1 += this.aClass482Array1[local3].method29762();
		}
		return local1;
	}

	@OriginalMember(owner = "client!pe", name = "k", descriptor = "(F)[D", line = 40)
	public double[] method29714(@OriginalArg(0) float arg0) {
		@Pc(1) float local1 = 0.0F;
		@Pc(3) float local3 = 0.0F;
		for (@Pc(5) int local5 = 0; local5 < this.aClass482Array1.length; local5++) {
			local3 += this.aClass482Array1[local5].method29762();
			if (arg0 < local3) {
				@Pc(31) float local31 = this.aClass482Array1[local5].method29763(arg0 - local1);
				return this.aClass482Array1[local5].method29774(local31);
			}
			local1 = local3;
		}
		return this.aClass482Array1[this.aClass482Array1.length - 1].method29774(1.0F);
	}

	@OriginalMember(owner = "client!pe", name = "s", descriptor = "(F)[D", line = 65)
	public double[] method29715(@OriginalArg(0) float arg0) {
		@Pc(2) int local2 = (int) arg0;
		return local2 < this.aClass482Array1.length ? this.aClass482Array1[local2].method29774(arg0 - (float) local2) : this.aClass482Array1[this.aClass482Array1.length - 1].method29774(1.0F);
	}

	@OriginalMember(owner = "client!pe", name = "w", descriptor = "(F)[D", line = 65)
	public double[] method29716(@OriginalArg(0) float arg0) {
		@Pc(2) int local2 = (int) arg0;
		return local2 < this.aClass482Array1.length ? this.aClass482Array1[local2].method29774(arg0 - (float) local2) : this.aClass482Array1[this.aClass482Array1.length - 1].method29774(1.0F);
	}

	@OriginalMember(owner = "client!pe", name = "r", descriptor = "(F)[D", line = 40)
	public double[] method29717(@OriginalArg(0) float arg0) {
		@Pc(1) float local1 = 0.0F;
		@Pc(3) float local3 = 0.0F;
		for (@Pc(5) int local5 = 0; local5 < this.aClass482Array1.length; local5++) {
			local3 += this.aClass482Array1[local5].method29762();
	...
	public float method29718(@OriginalArg(0) float arg0) {
		@Pc(2) int local2 = (int) arg0;
	...
	public Class479(@OriginalArg(0) Class93_Sub41 arg0) {
		@Pc(13) int local13 = arg0.method22632((byte) -12);
		this.aClass482Array1[0] = new Class482();
		this.aClass482Array1[0].method29759(0, Class472.method29531(arg0));
		this.aClass482Array1[0].method29759(1, Class472.method29531(arg0));
		this.aFloatArray114[0] = arg0.method22425(1887624564);
		@Pc(46) Class472 local46 = Class472.method29531(arg0);
		@Pc(49) Class472 local49 = Class472.method29531(arg0);
		@Pc(53) Class472 local53 = Class472.method29574(local46, local49);
		local49.method29532();
		local53.method29543(local46);
		this.aClass482Array1[0].method29759(3, local46);
		this.aClass482Array1[0].method29759(2, local53);
		this.aFloatArray114[1] = arg0.method22425(-2041242817);
		for (@Pc(83) int local83 = 2; local83 < local13; local83++) {
			@Pc(89) Class472 local89 = Class472.method29531(arg0);
			@Pc(92) Class472 local92 = Class472.method29531(arg0);
			@Pc(96) Class472 local96 = Class472.method29574(local89, local92);
			local92.method29532();
			local96.method29543(local89);
			this.method29723(local89, local96, arg0.method22425(1704471531));
		}
	}

	@OriginalMember(owner = "client!pe", name = "p", descriptor = "(Lclient!ox;Lclient!ox;F)V", line = 10)
	void method29719(@OriginalArg(0) Class472 arg0, @OriginalArg(1) Class472 arg1, @OriginalArg(2) float arg2) {
		...
		local19.method29759(0, local28.method29767(3));
		@Pc(42) Class472 local42 = Class472.method29574(local28.method29767(3), local28.method29767(2));
		local19.method29759(1, Class472.method29545(local28.method29767(3), local42));
		local19.method29759(3, arg0);
		local19.method29759(2, arg1);
	...
	public float method29720(@OriginalArg(0) float arg0) {
		@Pc(1) float local1 = 0.0F;
		@Pc(3) float local3 = 0.0F;
		for (@Pc(5) int local5 = 0; local5 < this.aClass482Array1.length; local5++) {
			local3 += this.aClass482Array1[local5].method29762();
			if (arg0 < local3) {
				return this.aClass482Array1[local5].method29763(arg0 - local1) + (float) local5;
			}
			local1 = local3;
		}
	...
	void method29723(@OriginalArg(0) Class472 arg0, @OriginalArg(1) Class472 arg1, @OriginalArg(2) float arg2) {
		@Pc(6) Class482[] local6 = new Class482[this.aClass482Array1.length + 1];
		System.arraycopy(this.aClass482Array1, 0, local6, 0, this.aClass482Array1.length);
		@Pc(19) Class482 local19 = new Class482();
		@Pc(28) Class482 local28 = this.aClass482Array1[this.aClass482Array1.length - 1];
	...
	void method29726(@OriginalArg(0) Class472 arg0, @OriginalArg(1) Class472 arg1, @OriginalArg(2) float arg2) {
		@Pc(6) Class482[] local6 = new Class482[this.aClass482Array1.length + 1];
		System.arraycopy(this.aClass482Array1, 0, local6, 0, this.aClass482Array1.length);
		@Pc(19) Class482 local19 = new Class482();
		@Pc(28) Class482 local28 = this.aClass482Array1[this.aClass482Array1.length - 1];
	...
	public double[] method29727(@OriginalArg(0) float arg0) {
		@Pc(2) int local2 = (int) arg0;
		return local2 < this.aClass482Array1.length ? this.aClass482Array1[local2].method29774(arg0 - (float) local2) : this.aClass482Array1[this.aClass482Array1.length - 1].method29774(1.0F);
	}

	@OriginalMember(owner = "client!pe", name = "q", descriptor = "(F)[D", line = 65)
	public double[] method29728(@OriginalArg(0) float arg0) {
		@Pc(2) int local2 = (int) arg0;
		return local2 < this.aClass482Array1.length ? this.aClass482Array1[local2].method29774(arg0 - (float) local2) : this.aClass482Array1[this.aClass482Array1.length - 1].method29774(1.0F);
	}
