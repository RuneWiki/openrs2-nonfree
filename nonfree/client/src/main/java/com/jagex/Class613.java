...
public class Class613 implements Interface75 {
	...
	static final void method32059(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 891652010);
	...
	static final void method32060(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		...
		if (local29.method1508(1429228259)) {
			arg0.anObjectArray45[(arg0.anInt5888 += 957530791) * 587908375 - 1] = ((Class610) client.aClass532_1.method30466(1139320094).method18261(local13, -1722652423)).method31984(local23, local29.aString11, (byte) 79);
		} else {
			arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = ((Class610) client.aClass532_1.method30466(2034848841).method18261(local13, 334707401)).method31986(local23, local29.anInt265 * 951920133, 1072417041);
		}
	}
	...
	static final void method32061(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = Class51.aClass93_Sub36_1.aClass166_Sub4_1.method15426((byte) 0) ? 1 : 0;
	}
	...
	static final void method32062(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(13) int local13 = arg0.anIntArray519[arg0.anInt5891 * -1497248091];
		@Pc(23) int local23 = arg0.anIntArray519[arg0.anInt5891 * -1497248091 + 1];
		arg0.anIntArray519[(arg0.anInt5891 += 1189701933) * -1497248091 - 1] = client.aClass270_1.method26278(local13, 1570649000).method26372(local23, 1443246446);
	}

	@OriginalMember(owner = "client!vg", name = "bcr", descriptor = "(Lclient!yf;I)V", line = 14663)
	static final void method32063(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static void method32065(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		@Pc(2) Class240 local2 = Class330.aClass240_79;
		synchronized (Class330.aClass240_79) {
			Class330.aClass240_79.method25832(arg0, (byte) 40);
		}
	}
}
