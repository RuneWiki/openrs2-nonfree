...
public class Class369 implements Interface13 {
	...
	void method27976(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(20) int local20;
		if (arg1 == 2) {
			local14 = arg0.method22413((short) 16384);
			this.anIntArray428 = new int[local14];
			for (local20 = 0; local20 < local14; local20++) {
				this.anIntArray428[local20] = arg0.method22436(-124266605);
			}
		} else if (arg1 != 3) {
			if (arg1 == 40) {
				local14 = arg0.method22413((short) 16384);
				...
				for (local20 = 0; local20 < local14; local20++) {
					this.aShortArray123[local20] = (short) arg0.method22415(-1434290800);
					this.aShortArray125[local20] = (short) arg0.method22415(-1434290800);
				}
			} else if (arg1 == 41) {
				local14 = arg0.method22413((short) 16384);
				...
				for (local20 = 0; local20 < local14; local20++) {
					this.aShortArray126[local20] = (short) arg0.method22415(-1434290800);
					this.aShortArray124[local20] = (short) arg0.method22415(-1434290800);
				}
			} else {
				@Pc(126) int local126;
				@Pc(142) int local142;
				...
				if (arg1 == 44) {
					local14 = arg0.method22415(-1434290800);
					local20 = 0;
					...
					this.anIntArray430[arg1 - 60] = arg0.method22436(-1268950914);
				}
			}
		}
	}
	...
	void method27977(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		if (arg1 == 2) {
			...
			this.anIntArray428 = new int[local14];
			for (local20 = 0; local20 < local14; local20++) {
				this.anIntArray428[local20] = arg0.method22436(-1875909795);
			}
		} else if (arg1 != 3) {
			if (arg1 == 40) {
				local14 = arg0.method22413((short) 16384);
				...
				if (arg1 == 44) {
					...
					this.anIntArray430[arg1 - 60] = arg0.method22436(-141543606);
				}
			}
		}
	}
	...
	public boolean method27978(@OriginalArg(0) byte arg0) {
		...
		synchronized (this.aClass497_106) {
			for (@Pc(13) int local13 = 0; local13 < this.anIntArray428.length; local13++) {
				if (!this.aClass497_106.method30053(this.anIntArray428[local13], 0, -893821147)) {
					local6 = false;
				}
			}
			return local6;
	...
	public Class231 method27979(@OriginalArg(0) int arg0) {
		if (this.anIntArray428 == null) {
			return null;
		}
		...
		if (this.aShortArray123 != null) {
			for (local16 = 0; local16 < this.aShortArray123.length; local16++) {
				local70.method25667(this.aShortArray123[local16], this.aShortArray125[local16]);
			}
		}
		if (this.aShortArray126 != null) {
			for (local16 = 0; local16 < this.aShortArray126.length; local16++) {
				local70.method25661(this.aShortArray126[local16], this.aShortArray124[local16]);
			}
		}
		return local70;
	}
	...
	public boolean method27980(@OriginalArg(0) int arg0) {
		@Pc(1) boolean local1 = true;
		@Pc(5) Class497 local5 = this.aClass497_106;
		synchronized (this.aClass497_106) {
			for (@Pc(8) int local8 = 0; local8 < 5; local8++) {
				if (this.anIntArray430[local8] != -1 && !this.aClass497_106.method30053(this.anIntArray430[local8], 0, 137847594)) {
					local1 = false;
				}
			}
			return local1;
	...
	public Class231 method27981(@OriginalArg(0) int arg0) {
		...
		for (@Pc(44) int local44 = 0; local44 < 5; local44++) {
			if (local2[local44] != null && local2[local44].anInt3738 < 13) {
				local2[local44].method25671(2);
			}
		}
		@Pc(71) Class231 local71 = new Class231(local2, local4);
		if (this.aShortArray123 != null) {
			for (local11 = 0; local11 < this.aShortArray123.length; local11++) {
				local71.method25667(this.aShortArray123[local11], this.aShortArray125[local11]);
			}
		}
		if (this.aShortArray126 != null) {
			for (local11 = 0; local11 < this.aShortArray126.length; local11++) {
				local71.method25661(this.aShortArray126[local11], this.aShortArray124[local11]);
			}
		}
		return local71;
	}
	...
	void method27983(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			arg0.method22413((short) 16384);
			return;
		}
		...
		if (arg1 == 2) {
			...
			this.anIntArray428 = new int[local14];
			for (local20 = 0; local20 < local14; local20++) {
				this.anIntArray428[local20] = arg0.method22436(-383246284);
			}
		} else if (arg1 != 3) {
			if (arg1 == 40) {
				local14 = arg0.method22413((short) 16384);
				...
				if (arg1 == 44) {
					...
					this.anIntArray430[arg1 - 60] = arg0.method22436(-1974216404);
				}
			}
		}
	}
	...
	public boolean method27984() {
		...
		synchronized (this.aClass497_106) {
			for (@Pc(13) int local13 = 0; local13 < this.anIntArray428.length; local13++) {
				if (!this.aClass497_106.method30053(this.anIntArray428[local13], 0, -771330286)) {
					local6 = false;
				}
			}
			return local6;
	...
	void method27986(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			arg0.method22413((short) 16384);
			return;
		}
		...
		if (arg1 == 2) {
			...
			this.anIntArray428 = new int[local14];
			for (local20 = 0; local20 < local14; local20++) {
				this.anIntArray428[local20] = arg0.method22436(-161455000);
			}
		} else if (arg1 != 3) {
			if (arg1 == 40) {
				local14 = arg0.method22413((short) 16384);
				...
				if (arg1 == 44) {
					...
					this.anIntArray430[arg1 - 60] = arg0.method22436(-2083057637);
				}
			}
		}
	}
	...
	public boolean method27987() {
		@Pc(1) boolean local1 = true;
		@Pc(5) Class497 local5 = this.aClass497_106;
		synchronized (this.aClass497_106) {
			for (@Pc(8) int local8 = 0; local8 < 5; local8++) {
				if (this.anIntArray430[local8] != -1 && !this.aClass497_106.method30053(this.anIntArray430[local8], 0, -6464779)) {
					local1 = false;
				}
			}
			return local1;
	...
	static final void method27990(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(16) Class312 local16 = Class659.method32805(local12, 150840534);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class593.method31716(local16, local22, arg0, 1853295968);
	}
	...
	static final void method27991(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12, 1046488611);
