...
public class Class369 implements Interface13 {
	...
	void method27976(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 == 1) {
			arg0.method22413();
			return;
		}
		...
		if (arg1 == 2) {
			...
			if (arg1 == 40) {
				...
				for (local20 = 0; local20 < local14; local20++) {
					this.aShortArray123[local20] = (short) arg0.method22415();
					this.aShortArray125[local20] = (short) arg0.method22415();
				}
			} else if (arg1 == 41) {
				local14 = arg0.method22413();
				...
				for (local20 = 0; local20 < local14; local20++) {
					this.aShortArray126[local20] = (short) arg0.method22415();
					this.aShortArray124[local20] = (short) arg0.method22415();
				}
			} else {
				@Pc(126) int local126;
				@Pc(142) int local142;
				...
				if (arg1 == 44) {
					...
					this.anIntArray430[arg1 - 60] = arg0.method22436();
				}
			}
		}
	}
	...
	public boolean method27978() {
		...
		synchronized (this.aClass497_106) {
			for (@Pc(13) int local13 = 0; local13 < this.anIntArray428.length; local13++) {
				if (!this.aClass497_106.method30053(this.anIntArray428[local13], 0)) {
					local6 = false;
				}
			}
			return local6;
	...
	public boolean method27980() {
		@Pc(1) boolean local1 = true;
		@Pc(5) Class497 local5 = this.aClass497_106;
		synchronized (this.aClass497_106) {
			for (@Pc(8) int local8 = 0; local8 < 5; local8++) {
				if (this.anIntArray430[local8] != -1 && !this.aClass497_106.method30053(this.anIntArray430[local8], 0)) {
					local1 = false;
				}
			}
			return local1;
	...
	static final void method27990(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12);
		@Pc(22) Class320 local22 = Class166_Sub1.aClass320Array1[local12 >> 16];
		Class593.method31716(local16, local22, arg0);
	}

	@OriginalMember(owner = "client!jv", name = "ug", descriptor = "(Lclient!yf;I)V", line = 8607)
	static final void method27991(@OriginalArg(0) Class681 arg0) {
		@Pc(12) int local12 = arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091];
		@Pc(16) Class312 local16 = Class659.method32805(local12);
