...
public class Class653 implements Runnable {
	...
	public void run() {
		while (!this.aBoolean860) {
			try {
				...
				Class646.method32610((String) null, local64, 1547574338);
			}
		}
	}
	...
	public void method32701() {
		while (!this.aBoolean860) {
			try {
				...
				Class646.method32610((String) null, local64, 1669925069);
			}
		}
	}

	@OriginalMember(owner = "client!x", name = "n", descriptor = "(B)V", line = 67)
	void method32702(@OriginalArg(0) byte arg0) {
	...
	public void method32703() {
		while (!this.aBoolean860) {
			try {
				...
				Class646.method32610((String) null, local64, 1297345594);
			}
		}
	}
	...
	public void method32704() {
		while (!this.aBoolean860) {
			try {
				...
				Class646.method32610((String) null, local64, 1812380156);
			}
		}
	}
	...
	public void method32705() {
		while (!this.aBoolean860) {
			try {
				...
				Class646.method32610((String) null, local64, 1466230030);
			}
		}
	}
	...
	public static boolean method32713(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		...
		if (local22) {
			Class698.method36702(local4, -2141126366);
		}
	...
	static final void method32714(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) throws Exception_Sub3 {
	...
	static final void method32715(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method32717(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(16) Class312 local16 = Class659.method32805(local12, -514099359);
