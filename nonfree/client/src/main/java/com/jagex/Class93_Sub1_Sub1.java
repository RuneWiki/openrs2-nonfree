...
public class Class93_Sub1_Sub1 extends Class93_Sub1 implements Interface13, Interface5 {
	...
	void method1752(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		if (arg1 != 249) {
			return;
		}
		...
		if (this.aClass16_3 == null) {
			local14 = Class134_Sub2.method10212(local6);
			this.aClass16_3 = new Class16(local14);
		}
		for (local14 = 0; local14 < local6; local14++) {
			@Pc(34) boolean local34 = arg0.method22413() == 1;
			@Pc(38) int local38 = arg0.method22417();
			@Pc(47) Class93 local47;
			if (local34) {
				local47 = new Class93_Sub15(arg0.method22427());
			} else {
				local47 = new Class93_Sub14(arg0.method22419());
			}
	...
	public int method1753(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.aClass16_3 == null) {
			return arg1;
		} else {
	...
	public String method1754(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1) {
		if (this.aClass16_3 == null) {
			return arg1;
		} else {
