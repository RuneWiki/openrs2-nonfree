...
public class Class93_Sub1_Sub1 extends Class93_Sub1 implements Interface13, Interface5 {
	...
	void method1752(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) short arg2) {
		...
		for (local14 = 0; local14 < local6; local14++) {
			@Pc(34) boolean local34 = arg0.method22413((short) 16384) == 1;
			@Pc(38) int local38 = arg0.method22417((short) 1139);
			@Pc(47) Class93 local47;
			if (local34) {
				local47 = new Class93_Sub15(arg0.method22427(1930457749));
			} else {
				local47 = new Class93_Sub14(arg0.method22419(-118643075));
			}
	...
	void method1756(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		for (local14 = 0; local14 < local6; local14++) {
			@Pc(34) boolean local34 = arg0.method22413((short) 16384) == 1;
			@Pc(38) int local38 = arg0.method22417((short) 16098);
			@Pc(47) Class93 local47;
			if (local34) {
				local47 = new Class93_Sub15(arg0.method22427(1239019579));
			} else {
				local47 = new Class93_Sub14(arg0.method22419(-118643075));
			}
			this.aClass16_3.method221(local47, (long) local38);
	...
	void method1757(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		for (local14 = 0; local14 < local6; local14++) {
			@Pc(34) boolean local34 = arg0.method22413((short) 16384) == 1;
			@Pc(38) int local38 = arg0.method22417((short) 23020);
			@Pc(47) Class93 local47;
			if (local34) {
				local47 = new Class93_Sub15(arg0.method22427(384517872));
			} else {
				local47 = new Class93_Sub14(arg0.method22419(-118643075));
			}
			this.aClass16_3.method221(local47, (long) local38);
	...
	void method1758(@OriginalArg(0) Class93_Sub41 arg0, @OriginalArg(1) int arg1) {
		...
		for (local14 = 0; local14 < local6; local14++) {
			@Pc(34) boolean local34 = arg0.method22413((short) 16384) == 1;
			@Pc(38) int local38 = arg0.method22417((short) 21711);
			@Pc(47) Class93 local47;
			if (local34) {
				local47 = new Class93_Sub15(arg0.method22427(1153649975));
			} else {
				local47 = new Class93_Sub14(arg0.method22419(-118643075));
			}
			this.aClass16_3.method221(local47, (long) local38);
