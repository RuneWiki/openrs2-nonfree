...
public class Class206 {
	...
	static final void method24698(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method24699(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		Class51.aClass93_Sub36_1.method14357(Class51.aClass93_Sub36_1.aClass166_Sub2_1, arg0.anIntArray519[(arg0.anInt5891 -= 1189701933) * -1497248091] == 1 ? 1 : 0, (byte) 93);
	...
	public static void method24700(@OriginalArg(0) Class312[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		for (@Pc(1) int local1 = 0; local1 < arg0.length; local1++) {
			...
			if (local9 != null && local9.anInt3985 * 897022795 == arg1) {
				Class550.method31031(local9, arg2, arg3, arg4, (byte) 37);
	...
	static int method24701(@OriginalArg(0) Class93_Sub41_Sub2 arg0, @OriginalArg(1) int arg1) {
		@Pc(4) int local4 = arg0.method22689(2, 655342518);
		@Pc(8) int local8;
		if (local4 == 0) {
			local8 = 0;
		} else if (local4 == 1) {
			local8 = arg0.method22689(5, 602694899);
		} else if (local4 == 2) {
			local8 = arg0.method22689(8, -736876662);
		} else {
			local8 = arg0.method22689(11, -60431463);
		}
		return local8;
	}
}
