...
public class Class288 implements Interface26 {
	...
	public void method26715(@OriginalArg(0) Class297 arg0, @OriginalArg(1) byte arg1) {
		arg0.method26630(this.anInt3903 * 559872199, this.anInt3902 * -1707762947, -554393298);
		arg0.method26622(this.anInt3903 * 559872199, -1893240721).method26756(-1942433304);
	}
	...
	Class288(@OriginalArg(0) Class303 arg0, @OriginalArg(1) Class93_Sub41 arg1) {
		this.this$0 = arg0;
		this.anInt3903 = arg1.method22415(-1434290800) * 1131038967;
		this.anInt3902 = arg1.method22415(-1434290800) * 877711957;
	}
	...
	public void method26714(@OriginalArg(0) Class297 arg0) {
		arg0.method26630(this.anInt3903 * 559872199, this.anInt3902 * -1707762947, -1783370834);
		arg0.method26622(this.anInt3903 * 559872199, -1267069017).method26756(-1942433304);
	}
	...
	public void method26713(@OriginalArg(0) Class297 arg0) {
		arg0.method26630(this.anInt3903 * 559872199, this.anInt3902 * -1707762947, -373864220);
		arg0.method26622(this.anInt3903 * 559872199, 902008669).method26756(-1942433304);
	}

	@OriginalMember(owner = "client!gh", name = "bem", descriptor = "(Lclient!yf;I)V", line = 15066)
	static final void method26547(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static int method26548(@OriginalArg(0) Class154_Sub1 arg0, @OriginalArg(1) Class154_Sub1 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) int arg6) {
		@Pc(6) int local6 = Class243.method25890(arg0, arg1, arg2, arg3, (byte) -18);
		if (local6 != 0) {
			return arg3 ? -local6 : local6;
		} else if (arg4 == -1) {
			return 0;
		} else {
			@Pc(28) int local28 = Class243.method25890(arg0, arg1, arg4, arg5, (byte) -38);
	...
	static Class100 method26550(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		if (arg0 == null) {
