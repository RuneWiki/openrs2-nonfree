...
public final class Class593 {
	...
	public boolean method31706(@OriginalArg(0) int arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2) {
		...
		synchronized (this.aClass42_7) {
			...
			@Pc(43) boolean local43 = this.method31709(arg0, arg1, arg2, true, (byte) 63);
			if (!local43) {
				local43 = this.method31709(arg0, arg1, arg2, false, (byte) -2);
			}
			return local43;
		}
	}
	...
	public byte[] method31707(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class42 local3 = this.aClass42_7;
		synchronized (this.aClass42_7) {
			...
			try {
				...
				this.aClass42_8.method823(aByteArray106, 0, 6, -1876228298);
				...
				if (local78 > 0 && (long) local78 <= this.aClass42_7.method821((byte) 1) / 520L) {
					...
					while (local111 < local56) {
						...
						if (arg0 > 65535) {
							...
							local143 = 10;
							this.aClass42_7.method823(aByteArray106, 0, local133 + local143, -2008457232);
							...
							local143 = 8;
							this.aClass42_7.method823(aByteArray106, 0, local143 + local133, -2113246486);
	...
	public boolean method31708(@OriginalArg(0) int arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(3) Class42 local3 = this.aClass42_7;
		synchronized (this.aClass42_7) {
			if (arg2 < 0 || arg2 > this.anInt5478 * -81593631) {
				throw new IllegalArgumentException("" + this.anInt5477 * 808596509 + ',' + arg0 + ',' + arg2);
			...
			@Pc(43) boolean local43 = this.method31709(arg0, arg1, arg2, true, (byte) -63);
			if (!local43) {
				local43 = this.method31709(arg0, arg1, arg2, false, (byte) 5);
			}
			return local43;
		}
	}
	...
	boolean method31709(@OriginalArg(0) int arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) byte arg4) {
		@Pc(3) Class42 local3 = this.aClass42_7;
		synchronized (this.aClass42_7) {
			try {
				@Pc(58) int local58;
				...
				if (arg3) {
					...
					this.aClass42_8.method820((long) (arg0 * 6));
					this.aClass42_8.method823(aByteArray106, 0, 6, -1706000372);
				...
				this.aClass42_8.method820((long) (arg0 * 6));
				this.aClass42_8.method824(aByteArray106, 0, 6, -1255011063);
					...
					if (local142 < arg2) {
						label154: {
							...
							if (arg3) {
								...
								if (arg0 > 65535) {
									try {
										this.aClass42_7.method823(aByteArray106, 0, 10, -2046024180);
									...
									try {
										this.aClass42_7.method823(aByteArray106, 0, 8, -1985620964);
							...
							if (arg0 > 65535) {
								...
								this.aClass42_7.method820((long) local58 * 520L);
								this.aClass42_7.method824(aByteArray106, 0, 10, 837031173);
								...
								this.aClass42_7.method820((long) local58 * 520L);
								this.aClass42_7.method824(aByteArray106, 0, 8, 207929483);
								local201 = arg2 - local142;
								if (local201 > 512) {
									local201 = 512;
								}
	...
	public byte[] method31711(@OriginalArg(0) int arg0) {
		...
		synchronized (this.aClass42_7) {
			...
			try {
				...
				this.aClass42_8.method820((long) (arg0 * 6));
				this.aClass42_8.method823(aByteArray106, 0, 6, -2091416186);
				@Pc(56) int local56 = ((aByteArray106[0] & 0xFF) << 16) + ((aByteArray106[1] & 0xFF) << 8) + (aByteArray106[2] & 0xFF);
				@Pc(78) int local78 = ((aByteArray106[3] & 0xFF) << 16) + ((aByteArray106[4] & 0xFF) << 8) + (aByteArray106[5] & 0xFF);
				if (local56 < 0 || local56 > this.anInt5478 * -81593631) {
					local17 = null;
				...
				if (local78 > 0 && (long) local78 <= this.aClass42_7.method821((byte) 1) / 520L) {
					...
					while (local111 < local56) {
						...
						if (arg0 > 65535) {
							...
							local143 = 10;
							this.aClass42_7.method823(aByteArray106, 0, local133 + local143, -1804410476);
							local182 = (aByteArray106[3] & 0xFF) + ((aByteArray106[1] & 0xFF) << 16) + ((aByteArray106[0] & 0xFF) << 24) + ((aByteArray106[2] & 0xFF) << 8);
							local196 = (aByteArray106[5] & 0xFF) + ((aByteArray106[4] & 0xFF) << 8);
							local218 = ((aByteArray106[7] & 0xFF) << 8) + ((aByteArray106[6] & 0xFF) << 16) + (aByteArray106[8] & 0xFF);
							local224 = aByteArray106[9] & 0xFF;
							...
							local143 = 8;
							this.aClass42_7.method823(aByteArray106, 0, local143 + local133, -1621864904);
							local182 = ((aByteArray106[0] & 0xFF) << 8) + (aByteArray106[1] & 0xFF);
							local196 = (aByteArray106[3] & 0xFF) + ((aByteArray106[2] & 0xFF) << 8);
							local218 = ((aByteArray106[4] & 0xFF) << 16) + ((aByteArray106[5] & 0xFF) << 8) + (aByteArray106[6] & 0xFF);
							local224 = aByteArray106[7] & 0xFF;
	...
	public byte[] method31712(@OriginalArg(0) int arg0) {
		...
		synchronized (this.aClass42_7) {
			...
			try {
				...
				this.aClass42_8.method820((long) (arg0 * 6));
				this.aClass42_8.method823(aByteArray106, 0, 6, -1870948179);
				@Pc(56) int local56 = ((aByteArray106[0] & 0xFF) << 16) + ((aByteArray106[1] & 0xFF) << 8) + (aByteArray106[2] & 0xFF);
				@Pc(78) int local78 = ((aByteArray106[3] & 0xFF) << 16) + ((aByteArray106[4] & 0xFF) << 8) + (aByteArray106[5] & 0xFF);
				if (local56 < 0 || local56 > this.anInt5478 * -81593631) {
					local17 = null;
				...
				if (local78 > 0 && (long) local78 <= this.aClass42_7.method821((byte) 1) / 520L) {
					...
					while (local111 < local56) {
						...
						if (arg0 > 65535) {
							...
							local143 = 10;
							this.aClass42_7.method823(aByteArray106, 0, local133 + local143, -1851928214);
							local182 = (aByteArray106[3] & 0xFF) + ((aByteArray106[1] & 0xFF) << 16) + ((aByteArray106[0] & 0xFF) << 24) + ((aByteArray106[2] & 0xFF) << 8);
							local196 = (aByteArray106[5] & 0xFF) + ((aByteArray106[4] & 0xFF) << 8);
							local218 = ((aByteArray106[7] & 0xFF) << 8) + ((aByteArray106[6] & 0xFF) << 16) + (aByteArray106[8] & 0xFF);
							local224 = aByteArray106[9] & 0xFF;
							...
							local143 = 8;
							this.aClass42_7.method823(aByteArray106, 0, local143 + local133, -1778671221);
							local182 = ((aByteArray106[0] & 0xFF) << 8) + (aByteArray106[1] & 0xFF);
							local196 = (aByteArray106[3] & 0xFF) + ((aByteArray106[2] & 0xFF) << 8);
							local218 = ((aByteArray106[4] & 0xFF) << 16) + ((aByteArray106[5] & 0xFF) << 8) + (aByteArray106[6] & 0xFF);
							local224 = aByteArray106[7] & 0xFF;
	...
	public byte[] method31713(@OriginalArg(0) int arg0) {
		...
		synchronized (this.aClass42_7) {
			...
			try {
				...
				this.aClass42_8.method820((long) (arg0 * 6));
				this.aClass42_8.method823(aByteArray106, 0, 6, -1768263334);
				@Pc(56) int local56 = ((aByteArray106[0] & 0xFF) << 16) + ((aByteArray106[1] & 0xFF) << 8) + (aByteArray106[2] & 0xFF);
				@Pc(78) int local78 = ((aByteArray106[3] & 0xFF) << 16) + ((aByteArray106[4] & 0xFF) << 8) + (aByteArray106[5] & 0xFF);
				if (local56 < 0 || local56 > this.anInt5478 * -81593631) {
					local17 = null;
				...
				if (local78 > 0 && (long) local78 <= this.aClass42_7.method821((byte) 1) / 520L) {
					...
					while (local111 < local56) {
						...
						if (arg0 > 65535) {
							...
							local143 = 10;
							this.aClass42_7.method823(aByteArray106, 0, local133 + local143, -2053465901);
							local182 = (aByteArray106[3] & 0xFF) + ((aByteArray106[1] & 0xFF) << 16) + ((aByteArray106[0] & 0xFF) << 24) + ((aByteArray106[2] & 0xFF) << 8);
							local196 = (aByteArray106[5] & 0xFF) + ((aByteArray106[4] & 0xFF) << 8);
							local218 = ((aByteArray106[7] & 0xFF) << 8) + ((aByteArray106[6] & 0xFF) << 16) + (aByteArray106[8] & 0xFF);
							local224 = aByteArray106[9] & 0xFF;
							...
							local143 = 8;
							this.aClass42_7.method823(aByteArray106, 0, local143 + local133, -2099615183);
							local182 = ((aByteArray106[0] & 0xFF) << 8) + (aByteArray106[1] & 0xFF);
							local196 = (aByteArray106[3] & 0xFF) + ((aByteArray106[2] & 0xFF) << 8);
							local218 = ((aByteArray106[4] & 0xFF) << 16) + ((aByteArray106[5] & 0xFF) << 8) + (aByteArray106[6] & 0xFF);
							local224 = aByteArray106[7] & 0xFF;
		...
		synchronized (this.aClass42_7) {
			try {
				...
				if (arg3) {
					...
					this.aClass42_8.method820((long) (arg0 * 6));
					this.aClass42_8.method823(aByteArray106, 0, 6, -1920632128);
					local58 = ((aByteArray106[3] & 0xFF) << 16) + ((aByteArray106[4] & 0xFF) << 8) + (aByteArray106[5] & 0xFF);
					if (local58 <= 0 || (long) local58 > this.aClass42_7.method821((byte) 1) / 520L) {
						local19 = false;
						return local19;
				...
				aByteArray106[5] = (byte) local58;
				this.aClass42_8.method820((long) (arg0 * 6));
				this.aClass42_8.method824(aByteArray106, 0, 6, 918066956);
				@Pc(142) int local142 = 0;
				@Pc(144) int local144 = 0;
				while (true) {
					if (local142 < arg2) {
						label154: {
							...
							if (arg3) {
								...
								if (arg0 > 65535) {
									try {
										this.aClass42_7.method823(aByteArray106, 0, 10, -2077898766);
									} catch (@Pc(170) EOFException local170) {
										break label154;
									}
									local201 = ((aByteArray106[2] & 0xFF) << 8) + ((aByteArray106[0] & 0xFF) << 24) + ((aByteArray106[1] & 0xFF) << 16) + (aByteArray106[3] & 0xFF);
									...
									try {
										this.aClass42_7.method823(aByteArray106, 0, 8, -1898916366);
									} catch (@Pc(253) EOFException local253) {
										break label154;
									}
									local201 = (aByteArray106[1] & 0xFF) + ((aByteArray106[0] & 0xFF) << 8);
							...
							if (arg0 > 65535) {
								...
								aByteArray106[9] = (byte) (this.anInt5477 * 808596509);
								this.aClass42_7.method820((long) local58 * 520L);
								this.aClass42_7.method824(aByteArray106, 0, 10, -652066129);
								local201 = arg2 - local142;
								if (local201 > 510) {
									local201 = 510;
								}
								...
								aByteArray106[7] = (byte) (this.anInt5477 * 808596509);
								this.aClass42_7.method820((long) local58 * 520L);
								this.aClass42_7.method824(aByteArray106, 0, 8, 1230742328);
								local201 = arg2 - local142;
								if (local201 > 512) {
									local201 = 512;
								}
	...
	public static void method31715(@OriginalArg(0) Class155 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class679 arg3, @OriginalArg(4) Class132_Sub1_Sub5_Sub1 arg4, @OriginalArg(5) int arg5) {
		@Pc(2) Class681 local2 = Class96.method2324(700958403);
		local2.aClass132_Sub1_Sub5_Sub1_1 = arg4;
		Class346.method27565(arg0, arg1, arg2, local2, 1677070776);
	...
	static final void method31716(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) int arg3) {
	...
	static final void method31717(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class286.method26537(local11, local14, arg0, (byte) 0);
	}

	@OriginalMember(owner = "client!uf", name = "mv", descriptor = "(Lclient!hf;Lclient!hq;Lclient!yf;S)V", line = 7188)
	static final void method31718(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2, @OriginalArg(3) short arg3) {
		...
		arg0.anObjectArray16 = Class499.method30148(local13, arg2, 31469190);
		arg0.aBoolean680 = true;
	}

	@OriginalMember(owner = "client!uf", name = "yl", descriptor = "(Lclient!yf;I)V", line = 9323)
	static final void method31719(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method31720(@OriginalArg(0) Class93_Sub8 arg0, @OriginalArg(1) byte arg1) {
		@Pc(3) Class585 local3 = client.aClass532_1.method30459(-1276251391);
		if (local3 == null) {
			return;
		}
		...
		if (arg0.anInt1465 * -408185941 == 1) {
			local9 = (Interface61) local3.method31464(arg0.anInt1471 * -960255437, arg0.anInt1462 * -1824529811, arg0.anInt1464 * 275343381, -2121498180);
		}
	...
	static final void method31721(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method31722(@OriginalArg(0) short arg0) {
		@Pc(3) Class611 local3 = client.aClass532_1.method30443(2040681733);
		...
		Class620.anInt5644 = ((int) ((double) Class65.aClass123_Sub1_2.method8961((byte) 72) * 2607.5945876176133D) & 0x3FFF) * -1151839067;
	...
	static void method31723(@OriginalArg(0) byte arg0) {
		...
		if (Class454.anInt5042 * -1838307953 > 1) {
			if (Class527.method30386((byte) 2) && Class454.anInt5042 * -1838307953 > 2) {
		...
		if (local165 == null) {
			...
			local176 = local165.method22874((byte) -101);
		}
		@Pc(615) boolean local615;
		if (!Class454.aBoolean773) {
			local615 = Class296.method26607(Class288.aClass636_1.anInterface67_4, local165, -1964346619);
			@Pc(846) boolean local846 = Class296.method26607(Class288.aClass636_1.anInterface67_1, local165, 618321372);
			@Pc(852) boolean local852 = Class296.method26607(Class288.aClass636_1.anInterface67_3, local165, -1339762076);
			if ((local615 || local846) && (client.anInt3519 * -169503325 == 1 && Class454.anInt5042 * -1838307953 > 2 || Class491.method29981((byte) -31))) {
				local852 = true;
			}
			if (local852 && Class454.anInt5042 * -1838307953 > 0) {
				...
				if (Class272.aClass93_Sub1_Sub7_5 != null) {
					Class169.method18338(Class272.aClass93_Sub1_Sub7_5, local61, local176, false, 1927370838);
				}
			} else if (local615) {
				if (Class112_Sub1_Sub1.aClass93_Sub1_Sub7_4 != null) {
					...
					if (local918) {
						...
						Class169.method18338(Class112_Sub1_Sub1.aClass93_Sub1_Sub7_4, local61, local176, false, 1967053711);
					}
		...
		@Pc(227) int local227;
		@Pc(254) int local254;
		if (!Class296.method26607(Class288.aClass636_1.anInterface67_2, local165, 3064134)) {
			local615 = false;
						...
						for (@Pc(810) Class93_Sub1_Sub8 local810 = (Class93_Sub1_Sub8) local805.method169(-1452517832); local810 != null; local810 = (Class93_Sub1_Sub8) local805.next()) {
							if (local227 == local708) {
								if (local810.anInt3013 * -2109043087 > 1) {
									Class342.method27511(local810, local254, (byte) -59);
								}
								break;
							}
							local708++;
			...
			if (local225 != -1) {
				...
				for (local317 = (Class93_Sub1_Sub7) local312.method169(-873034851); local317 != null; local317 = (Class93_Sub1_Sub7) local312.next()) {
					if (local225 == local227) {
						Class169.method18338(local317, local61, local176, true, 1771726998);
						break;
					}
					local227++;
				}
			...
			if (Class454.aBoolean772) {
				...
				if (local225 != -1) {
					...
					for (@Pc(588) Class93_Sub1_Sub8 local588 = (Class93_Sub1_Sub8) local312.method169(-1219241938); local588 != null; local588 = (Class93_Sub1_Sub8) local312.next()) {
						if (local227 == local225) {
							Class169.method18338((Class93_Sub1_Sub7) local588.aClass18_10.aClass93_Sub1_4.aClass93_Sub1_68, local61, local176, true, 1404994115);
							Class436.method28811(-916881791);
							break;
						}
						local227++;
				...
				if (local225 != -1) {
					...
					for (local317 = (Class93_Sub1_Sub7) local468.method372(699749822); local317 != null; local317 = (Class93_Sub1_Sub7) local468.next()) {
						if (local227 == local225) {
							Class169.method18338(local317, local61, local176, true, 1417218142);
							break;
						}
						local227++;
					}
