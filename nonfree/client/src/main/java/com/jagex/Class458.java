...
public class Class458 {
	...
	void method29168(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		if ((local3 & 0x1) != 0) {
			local5 = (float) arg0.method22482((byte) -22) / 32768.0F;
			local7 = (float) arg0.method22482((byte) -94) / 32768.0F;
			local9 = (float) arg0.method22482((byte) -95) / 32768.0F;
			local11 = (float) arg0.method22482((byte) -108) / 32768.0F;
		}
		...
		if ((local3 & 0x2) != 0) {
			local54 = (float) arg0.method22482((byte) -105);
		}
		if ((local3 & 0x4) != 0) {
			local56 = (float) arg0.method22482((byte) -55);
		}
		if ((local3 & 0x8) != 0) {
			local58 = (float) arg0.method22482((byte) -95);
		}
		...
		if ((local3 & 0x10) == 0) {
			if ((local3 & 0x20) != 0) {
				local95 = (float) arg0.method22482((byte) -38) / 128.0F;
			}
			if ((local3 & 0x40) != 0) {
				local97 = (float) arg0.method22482((byte) -92) / 128.0F;
			}
			if ((local3 & 0x80) != 0) {
				local99 = (float) arg0.method22482((byte) -9) / 128.0F;
			}
		} else {
			@Pc(110) float local110 = (float) arg0.method22482((byte) -20) / 128.0F;
			local99 = local110;
			local97 = local110;
			local95 = local110;
		}
	...
	void method29170(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		@Pc(11) float local11 = 1.0F;
		if ((local3 & 0x1) != 0) {
			local5 = (float) arg0.method22482((byte) -49) / 32768.0F;
			local7 = (float) arg0.method22482((byte) -35) / 32768.0F;
			local9 = (float) arg0.method22482((byte) -105) / 32768.0F;
			local11 = (float) arg0.method22482((byte) -25) / 32768.0F;
		}
		this.aClass471_5 = new Class471(local5, local7, local9, local11);
		@Pc(54) float local54 = 0.0F;
		@Pc(56) float local56 = 0.0F;
		@Pc(58) float local58 = 0.0F;
		if ((local3 & 0x2) != 0) {
			local54 = (float) arg0.method22482((byte) -54);
		}
		if ((local3 & 0x4) != 0) {
			local56 = (float) arg0.method22482((byte) -127);
		}
		if ((local3 & 0x8) != 0) {
			local58 = (float) arg0.method22482((byte) -39);
		}
		this.aClass472_61 = new Class472(local54, local56, local58);
		@Pc(95) float local95 = 1.0F;
		@Pc(97) float local97 = 1.0F;
		...
		if ((local3 & 0x10) == 0) {
			if ((local3 & 0x20) != 0) {
				local95 = (float) arg0.method22482((byte) -103) / 128.0F;
			}
			if ((local3 & 0x40) != 0) {
				local97 = (float) arg0.method22482((byte) -68) / 128.0F;
			}
			if ((local3 & 0x80) != 0) {
				local99 = (float) arg0.method22482((byte) -27) / 128.0F;
			}
		} else {
			@Pc(110) float local110 = (float) arg0.method22482((byte) -119) / 128.0F;
			local99 = local110;
			local97 = local110;
			local95 = local110;
		}
	...
	void method29173(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		@Pc(11) float local11 = 1.0F;
		if ((local3 & 0x1) != 0) {
			local5 = (float) arg0.method22482((byte) -91) / 32768.0F;
			local7 = (float) arg0.method22482((byte) -125) / 32768.0F;
			local9 = (float) arg0.method22482((byte) -19) / 32768.0F;
			local11 = (float) arg0.method22482((byte) -77) / 32768.0F;
		}
		this.aClass471_5 = new Class471(local5, local7, local9, local11);
		@Pc(54) float local54 = 0.0F;
		@Pc(56) float local56 = 0.0F;
		@Pc(58) float local58 = 0.0F;
		if ((local3 & 0x2) != 0) {
			local54 = (float) arg0.method22482((byte) -53);
		}
		if ((local3 & 0x4) != 0) {
			local56 = (float) arg0.method22482((byte) -86);
		}
		if ((local3 & 0x8) != 0) {
			local58 = (float) arg0.method22482((byte) -117);
		}
		this.aClass472_61 = new Class472(local54, local56, local58);
		@Pc(95) float local95 = 1.0F;
		@Pc(97) float local97 = 1.0F;
		...
		if ((local3 & 0x10) == 0) {
			if ((local3 & 0x20) != 0) {
				local95 = (float) arg0.method22482((byte) -70) / 128.0F;
			}
			if ((local3 & 0x40) != 0) {
				local97 = (float) arg0.method22482((byte) -54) / 128.0F;
			}
			if ((local3 & 0x80) != 0) {
				local99 = (float) arg0.method22482((byte) -104) / 128.0F;
			}
		} else {
			@Pc(110) float local110 = (float) arg0.method22482((byte) -57) / 128.0F;
			local99 = local110;
			local97 = local110;
			local95 = local110;
		}
	...
	void method29174(@OriginalArg(0) Class93_Sub41 arg0) {
		...
		@Pc(11) float local11 = 1.0F;
		if ((local3 & 0x1) != 0) {
			local5 = (float) arg0.method22482((byte) -74) / 32768.0F;
			local7 = (float) arg0.method22482((byte) -78) / 32768.0F;
			local9 = (float) arg0.method22482((byte) -44) / 32768.0F;
			local11 = (float) arg0.method22482((byte) -101) / 32768.0F;
		}
		this.aClass471_5 = new Class471(local5, local7, local9, local11);
		@Pc(54) float local54 = 0.0F;
		@Pc(56) float local56 = 0.0F;
		@Pc(58) float local58 = 0.0F;
		if ((local3 & 0x2) != 0) {
			local54 = (float) arg0.method22482((byte) -46);
		}
		if ((local3 & 0x4) != 0) {
			local56 = (float) arg0.method22482((byte) -107);
		}
		if ((local3 & 0x8) != 0) {
			local58 = (float) arg0.method22482((byte) -116);
		}
		this.aClass472_61 = new Class472(local54, local56, local58);
		@Pc(95) float local95 = 1.0F;
		@Pc(97) float local97 = 1.0F;
		...
		if ((local3 & 0x10) == 0) {
			...
			if ((local3 & 0x40) != 0) {
				local97 = (float) arg0.method22482((byte) -10) / 128.0F;
			}
			if ((local3 & 0x80) != 0) {
				local99 = (float) arg0.method22482((byte) -21) / 128.0F;
			}
		} else {
			@Pc(110) float local110 = (float) arg0.method22482((byte) -85) / 128.0F;
			local99 = local110;
			local97 = local110;
			local95 = local110;
		}
