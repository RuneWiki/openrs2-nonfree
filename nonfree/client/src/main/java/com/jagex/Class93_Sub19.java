...
public final class Class93_Sub19 extends Class93 {
	...
	public final boolean method13622(@OriginalArg(0) int arg0) {
		return (this.anInt1550 * -622772683 >> 21 & 0x1) != 0;
	}
	...
	public final int method13634() {
		return Class122_Sub1.method20226(this.anInt1550 * -622772683, (byte) -71);
	}
	...
	public final int method13636() {
		return Class122_Sub1.method20226(this.anInt1550 * -622772683, (byte) -51);
	}

	@OriginalMember(owner = "client!aki", name = "l", descriptor = "(I)Z", line = 47)
	public final boolean method13637(@OriginalArg(0) int arg0) {
		return (this.anInt1550 * -622772683 >> 22 & 0x1) != 0;
	}

	@OriginalMember(owner = "client!aki", name = "ae", descriptor = "(I)I", line = 35)
	static final int method13638(@OriginalArg(0) int arg0) {
		return arg0 >> 11 & 0x7F;
	}

	@OriginalMember(owner = "client!aki", name = "f", descriptor = "(I)I", line = 39)
	public final int method13639(@OriginalArg(0) int arg0) {
		return this.anInt1550 * -622772683 >> 18 & 0x7;
	}

	@OriginalMember(owner = "client!aki", name = "ah", descriptor = "()I", line = 39)
	public final int method13640() {
		return this.anInt1550 * -622772683 >> 18 & 0x7;
	}

	@OriginalMember(owner = "client!aki", name = "al", descriptor = "()I", line = 39)
	public final int method13641() {
		return this.anInt1550 * -622772683 >> 18 & 0x7;
	}
	...
	public final int method13645() {
		return Class122_Sub1.method20226(this.anInt1550 * -622772683, (byte) -68);
	}
	...
	public final int method13648() {
		return Class122_Sub1.method20226(this.anInt1550 * -622772683, (byte) -50);
	}
