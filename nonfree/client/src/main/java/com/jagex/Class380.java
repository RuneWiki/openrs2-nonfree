...
public class Class380 implements Interface33 {
	...
	public boolean method28279(@OriginalArg(0) int arg0) {
		...
		if (!this.aClass497_110.method30054(this.aClass407_1.anInt4696 * 1186513455, -512225963)) {
			local1 = false;
		}
		if (!this.aClass497_109.method30054(this.aClass407_1.anInt4696 * 1186513455, -512225963)) {
			local1 = false;
		}
		return local1;
	}
	...
	public void method28285(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
		if (arg0) {
			@Pc(21) int local21 = this.aClass407_1.aClass390_14.method28273(this.aClass407_1.anInt4694 * -1489497161, client.anInt3511 * 2040043391, 1166433294) + this.aClass407_1.anInt4690 * -1430649519;
			@Pc(41) int local41 = this.aClass407_1.aClass392_14.method28290(this.aClass407_1.anInt4692 * -1599928051, client.anInt3512 * -817449061, (short) 255) + this.aClass407_1.anInt4691 * 1380832809;
			this.aClass106_12.method7563(this.aClass407_1.aString198, local21, local41, this.aClass407_1.anInt4694 * -1489497161, this.aClass407_1.anInt4692 * -1599928051, this.aClass407_1.anInt4697 * 603161807, this.aClass407_1.anInt4698 * -1071278391, this.aClass407_1.anInt4695 * -1283910243, this.aClass407_1.anInt4693 * -142218921, this.aClass407_1.anInt4689 * -689304573, (Class100[]) null, (int[]) null, (Class96) null, 0, 0, (short) 657);
		}
	}
	...
	public void method28280(@OriginalArg(0) int arg0) {
		@Pc(10) Class5 local10 = Class691.method36594(this.aClass497_109, this.aClass407_1.anInt4696 * 1186513455, Class157.aClass462_2, -238173970);
	...
	public void method28282(@OriginalArg(0) boolean arg0) {
		if (arg0) {
			@Pc(21) int local21 = this.aClass407_1.aClass390_14.method28273(this.aClass407_1.anInt4694 * -1489497161, client.anInt3511 * 2040043391, 754302417) + this.aClass407_1.anInt4690 * -1430649519;
			@Pc(41) int local41 = this.aClass407_1.aClass392_14.method28290(this.aClass407_1.anInt4692 * -1599928051, client.anInt3512 * -817449061, (short) 255) + this.aClass407_1.anInt4691 * 1380832809;
			this.aClass106_12.method7563(this.aClass407_1.aString198, local21, local41, this.aClass407_1.anInt4694 * -1489497161, this.aClass407_1.anInt4692 * -1599928051, this.aClass407_1.anInt4697 * 603161807, this.aClass407_1.anInt4698 * -1071278391, this.aClass407_1.anInt4695 * -1283910243, this.aClass407_1.anInt4693 * -142218921, this.aClass407_1.anInt4689 * -689304573, (Class100[]) null, (int[]) null, (Class96) null, 0, 0, (short) 657);
		}
	}
	...
	public void method28283() {
		@Pc(10) Class5 local10 = Class691.method36594(this.aClass497_109, this.aClass407_1.anInt4696 * 1186513455, Class157.aClass462_2, 964448075);
		this.aClass106_12 = Class694.aClass104_14.method20506(local10, Class203.method24650(this.aClass497_110, this.aClass407_1.anInt4696 * 1186513455), true);
	}
	...
	public void method28284() {
		@Pc(10) Class5 local10 = Class691.method36594(this.aClass497_109, this.aClass407_1.anInt4696 * 1186513455, Class157.aClass462_2, -439602759);
		this.aClass106_12 = Class694.aClass104_14.method20506(local10, Class203.method24650(this.aClass497_110, this.aClass407_1.anInt4696 * 1186513455), true);
	}
	...
	public void method28281(@OriginalArg(0) boolean arg0) {
		if (arg0) {
			@Pc(21) int local21 = this.aClass407_1.aClass390_14.method28273(this.aClass407_1.anInt4694 * -1489497161, client.anInt3511 * 2040043391, 1860493955) + this.aClass407_1.anInt4690 * -1430649519;
			@Pc(41) int local41 = this.aClass407_1.aClass392_14.method28290(this.aClass407_1.anInt4692 * -1599928051, client.anInt3512 * -817449061, (short) 255) + this.aClass407_1.anInt4691 * 1380832809;
			this.aClass106_12.method7563(this.aClass407_1.aString198, local21, local41, this.aClass407_1.anInt4694 * -1489497161, this.aClass407_1.anInt4692 * -1599928051, this.aClass407_1.anInt4697 * 603161807, this.aClass407_1.anInt4698 * -1071278391, this.aClass407_1.anInt4695 * -1283910243, this.aClass407_1.anInt4693 * -142218921, this.aClass407_1.anInt4689 * -689304573, (Class100[]) null, (int[]) null, (Class96) null, 0, 0, (short) 657);
		}
	}
	...
	static final int method28116(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
	...
	static void method28117(@OriginalArg(0) Class320 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class681 arg5, @OriginalArg(6) int arg6) {
		if (arg2 == 0) {
		...
		Class354.method27696(local10, -1174743804);
	}

	@OriginalMember(owner = "client!ki", name = "agq", descriptor = "(Lclient!yf;I)V", line = 10752)
	static final void method28118(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method28119(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(654) Class175 local654 = Class330.method27372(-1833824436);
		@Pc(660) Class93_Sub22 local660 = Class102.method2592(Class446.aClass446_97, local654.aClass24_2, (byte) 85);
		local660.aClass93_Sub41_Sub2_1.method22510(0, (byte) -7);
		@Pc(671) int local671 = local660.aClass93_Sub41_Sub2_1.anInt3070 * 212851357;
		local660.aClass93_Sub41_Sub2_1.method22510(local30, (byte) -60);
		local660.aClass93_Sub41_Sub2_1.method22510(local469, (byte) -106);
		Class284.method26484(local660.aClass93_Sub41_Sub2_1, local13, -1497248091);
		local660.aClass93_Sub41_Sub2_1.method22537(local660.aClass93_Sub41_Sub2_1.anInt3070 * 212851357 - local671, (byte) 77);
		local654.method24351(local660, -1650727993);
	}

	@OriginalMember(owner = "client!ki", name = "ah", descriptor = "(B)V", line = 905)
	public static void method28120(@OriginalArg(0) byte arg0) {
