...
public class Class110_Sub5 extends Class110 {
	...
	Class110_Sub5(@OriginalArg(0) Class93_Sub41 arg0) {
		super(arg0);
		this.aString25 = arg0.method22427(65766886);
		this.anInt893 = arg0.method22415(-1434290800) * 1312003631;
	}
	...
	public void method20138(@OriginalArg(0) int arg0) {
		if (client.anInt3462 * 1756332913 != -1) {
			Class359.method27791(client.anInt3462 * 1756332913, this.aString25, this.anInt893 * 377188559, 1775744429);
		}
	}
	...
	public void method20140() {
		if (client.anInt3462 * 1756332913 != -1) {
			Class359.method27791(client.anInt3462 * 1756332913, this.aString25, this.anInt893 * 377188559, 1031300906);
		}
	}
	...
	static final void method7654(@OriginalArg(0) Class93_Sub41_Sub2 arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(19) Class132_Sub1_Sub1_Sub1_Sub2 local19 = Class520.aClass132_Sub1_Sub1_Sub1_Sub2_3 = client.aClass132_Sub1_Sub1_Sub1_Sub2Array1[local6] = new Class132_Sub1_Sub1_Sub1_Sub2(client.aClass532_1.method30459(-1946144137));
		local19.anInt2768 = local6 * 171759809;
		@Pc(29) int local29 = arg0.method22689(30, 1245006124);
		@Pc(34) byte local34 = (byte) (local29 >> 28);
		@Pc(40) int local40 = local29 >> 14 & 0x3FFF;
		@Pc(44) int local44 = local29 & 0x3FFF;
		@Pc(48) Class611 local48 = client.aClass532_1.method30443(1806933485);
		local19.anIntArray240[0] = local40 - local48.anInt5623 * 270611681;
		local19.anIntArray239[0] = local44 - local48.anInt5624 * -1994307635;
		local19.method24231((float) ((local19.anIntArray240[0] << 9) + (local19.method19997(-79999018) << 8)), local19.method24218().aClass472_61.aFloat318, (float) ((local19.anIntArray239[0] << 9) + (local19.method19997(1449782044) << 8)));
		Class512.anInt5209 = (local19.aByte100 = local19.aByte99 = local34) * -69533369;
		if (client.aClass532_1.method30509(148494815).method30330(local19.anIntArray240[0], local19.anIntArray239[0], -662808309)) {
			local19.aByte99++;
		}
		if (Class174.aClass93_Sub41Array2[local6] != null) {
			local19.method20066(Class174.aClass93_Sub41Array2[local6], 1924398161);
		}
		if (Class174.aClass93_Sub41Array1[local6] != null) {
			local19.method20048(Class174.aClass93_Sub41Array1[local6], -1253037716);
		}
		...
		for (@Pc(174) int local174 = 1; local174 < 2048; local174++) {
			if (local6 != local174) {
				@Pc(186) int local186 = arg0.method22689(18, 1558012437);
		...
		if (Class338.aClass338_4 == local275) {
			...
			local283.method16472(-998402664);
		}
	}
	...
	static final void method7656(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class247.method25916(local11, local14, arg0, 1764379247);
	}
