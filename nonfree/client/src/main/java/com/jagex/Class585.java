...
public class Class585 {
	...
	public static void method31611(@OriginalArg(0) boolean arg0) {
	}

	@OriginalMember(owner = "client!tx", name = "i", descriptor = "(Lclient!yf;B)V", line = 118)
	static void method31612(@OriginalArg(0) Class681 arg0) {
		arg0.anIntArray519[arg0.anInt5891 * -1497248091 - 1] = ((Class347) Class288.aClass55_Sub2_1.method18261(arg0.anIntArray519[arg0.anInt5891 * -1497248091 - 1])).method27584(Class624.aClass120_1) ? 1 : 0;
	}

	@OriginalMember(owner = "client!tx", name = "e", descriptor = "(IB)V", line = 133)
	public void method31430(@OriginalArg(0) int arg0) {
	}

	@OriginalMember(owner = "client!tx", name = "bi", descriptor = "(I)V", line = 133)
	public void method31468() {
	}

	@OriginalMember(owner = "client!tx", name = "bn", descriptor = "(I)V", line = 133)
	public void method31491() {
	}

	@OriginalMember(owner = "client!tx", name = "n", descriptor = "(Lclient!eu;B)V", line = 134)
	public void method31466(@OriginalArg(0) Class106 arg0) {
	}
	...
	public void method31432(@OriginalArg(0) boolean arg0) {
		if (arg0) {
			this.aClass572ArrayArrayArray3 = this.aClass572ArrayArrayArray2;
			this.aClass99Array1 = this.aClass99Array3;
		} else {
	...
	public void method31434(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	Class572 method31435(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (this.aClass572ArrayArrayArray3[arg0][arg1][arg2] == null) {
			...
			this.method31580(arg0, arg1, arg2);
		}
	...
	Class572 method31436(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		return this.method31435(arg0, Math.min(this.anInt5443 * -200159665 - 1, Math.max(0, arg1)), Math.min(this.anInt5444 * -1943751559 - 1, Math.max(0, arg2)));
	}
	...
	public void method31580(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(24) boolean local24 = this.aClass572ArrayArrayArray3[0][arg1][arg2] != null && this.aClass572ArrayArrayArray3[0][arg1][arg2].aClass572_1 != null;
		for (@Pc(26) int local26 = arg0; local26 >= 0; local26--) {
			if (this.aClass572ArrayArrayArray3[local26][arg1][arg2] == null) {
				@Pc(52) Class572 local52 = this.aClass572ArrayArrayArray3[local26][arg1][arg2] = new Class572(local26);
	...
	public void method31438(@OriginalArg(0) int arg0, @OriginalArg(1) Class99 arg1) {
	...
	public int method31439(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public int method31458(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public int method31519(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.aByteArrayArray24 == null ? 0 : this.aByteArrayArray24[arg0][arg1] & 0xFF;
	}

	@OriginalMember(owner = "client!tx", name = "r", descriptor = "(IIS)I", line = 220)
	public int method31442(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public int method31489(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public int method31444(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public void method31445(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
	...
	public void method31446(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class132_Sub1_Sub4 arg3) {
		@Pc(6) Class572 local6 = this.method31435(arg0, arg1, arg2);
		if (local6 == null) {
			return;
		}
	...
	public void method31447(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Class132_Sub1_Sub5 arg4) {
		@Pc(6) Class572 local6 = this.method31435(arg0, arg1, arg2);
		if (local6 == null) {
			return;
		}
	...
	public void method31448(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class132_Sub1_Sub2 arg3, @OriginalArg(4) Class132_Sub1_Sub2 arg4) {
		@Pc(6) Class572 local6 = this.method31435(arg0, arg1, arg2);
		if (local6 == null) {
			return;
		}
	...
	public void method31481(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class132_Sub1_Sub3 arg3, @OriginalArg(4) Class132_Sub1_Sub3 arg4) {
		@Pc(6) Class572 local6 = this.method31435(arg0, arg1, arg2);
		if (local6 == null) {
			return;
		}
	...
	public boolean method31497(@OriginalArg(0) Class132_Sub1_Sub1 arg0, @OriginalArg(1) boolean arg1) {
		...
		for (local69 = local31; local69 <= local43; local69++) {
			for (local74 = local55; local74 <= local67; local74++) {
				@Pc(85) Class572 local85 = this.method31436(arg0.aByte100, local69, local74);
				if (local85 != null) {
					@Pc(91) Class590 local91 = Class355.method27699(arg0);
	...
	public void method31494(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	public Class132_Sub1_Sub2 method31453(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(8) Class572 local8 = this.aClass572ArrayArrayArray3[arg0][arg1][arg2];
		if (local8 != null) {
			this.method31461(local8.aClass132_Sub1_Sub2_1);
	...
	public Class132_Sub1_Sub2 method31433(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(8) Class572 local8 = this.aClass572ArrayArrayArray3[arg0][arg1][arg2];
		if (local8 != null) {
			this.method31461(local8.aClass132_Sub1_Sub2_2);
	...
	public Class132_Sub1_Sub2 method31610(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(8) Class572 local8 = this.aClass572ArrayArrayArray3[arg0][arg1][arg2];
		if (local8 != null) {
			this.method31461(local8.aClass132_Sub1_Sub2_2);
			if (local8.aClass132_Sub1_Sub2_2 != null) {
	...
	public Class132_Sub1_Sub3 method31455(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(8) Class572 local8 = this.aClass572ArrayArrayArray3[arg0][arg1][arg2];
		if (local8 != null) {
			this.method31461(local8.aClass132_Sub1_Sub3_1);
	...
	public Class132_Sub1_Sub3 method31456(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(8) Class572 local8 = this.aClass572ArrayArrayArray3[arg0][arg1][arg2];
		if (local8 != null) {
			this.method31461(local8.aClass132_Sub1_Sub3_2);
	...
	public Class132_Sub1_Sub4 method31457(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(8) Class572 local8 = this.aClass572ArrayArrayArray3[arg0][arg1][arg2];
		if (local8 == null) {
			return null;
		}
		this.method31461(local8.aClass132_Sub1_Sub4_1);
	...
	public Class132_Sub1_Sub5 method31471(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(8) Class572 local8 = this.aClass572ArrayArrayArray3[arg0][arg1][arg2];
		if (local8 == null) {
			return null;
		} else {
	...
	public Class132_Sub1_Sub1 method31441(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Interface62 arg3) {
		@Pc(8) Class572 local8 = this.aClass572ArrayArrayArray3[arg0][arg1][arg2];
		if (local8 == null) {
			return null;
		}
		for (@Pc(16) Class590 local16 = local8.aClass590_1; local16 != null; local16 = local16.aClass590_2) {
			...
			if ((arg3 == null || arg3.method31367(local22)) && local22.aShort129 == arg1 && arg2 == local22.aShort128) {
				this.method31437(local22, false);
				return local22;
			}
		}
		return null;
	...
	void method31437(@OriginalArg(0) Class132_Sub1_Sub1 arg0, @OriginalArg(1) boolean arg1) {
	...
	void method31461(@OriginalArg(0) Class132_Sub1 arg0) {
		if (arg0 == null) {
			return;
		}
		arg0.method24230();
	...
	public Class132_Sub1_Sub2 method31440(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(8) Class572 local8 = this.aClass572ArrayArrayArray3[arg0][arg1][arg2];
	...
	public Class132_Sub1_Sub2 method31609(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(8) Class572 local8 = this.aClass572ArrayArrayArray3[arg0][arg1][arg2];
		return local8 == null ? null : local8.aClass132_Sub1_Sub2_2;
	}

	@OriginalMember(owner = "client!tx", name = "at", descriptor = "(IIII)Lclient!asm;", line = 619)
	public Class132_Sub1_Sub3 method31464(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(8) Class572 local8 = this.aClass572ArrayArrayArray3[arg0][arg1][arg2];
	...
	public Class132_Sub1_Sub5 method31465(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(8) Class572 local8 = this.aClass572ArrayArrayArray3[arg0][arg1][arg2];
	...
	public Class132_Sub1_Sub1 method31490(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Interface62 arg3) {
		...
		for (@Pc(16) Class590 local16 = local8.aClass590_1; local16 != null; local16 = local16.aClass590_2) {
			...
			if ((arg3 == null || arg3.method31367(local21)) && arg1 == local21.aShort129 && local21.aShort128 == arg2) {
				return local21;
			}
		}
		return null;
	...
	public Class132_Sub1_Sub1 method31585(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Interface62 arg3) {
		@Pc(8) Class572 local8 = this.aClass572ArrayArrayArray3[arg0][arg1][arg2];
		if (local8 == null) {
			return null;
		}
	...
	public Class590 method31467(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(8) Class572 local8 = this.aClass572ArrayArrayArray3[arg0][arg1][arg2];
		return local8 == null ? null : local8.aClass590_1;
	}
	...
	public Class132_Sub1_Sub4 method31496(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(8) Class572 local8 = this.aClass572ArrayArrayArray3[arg0][arg1][arg2];
			...
			for (@Pc(9) int local9 = 0; local9 < this.anInt5443 * -200159665; local9++) {
				for (@Pc(17) int local17 = 0; local17 < this.anInt5444 * -1943751559; local17++) {
					...
					if (local32 != null) {
						...
						if (local37 != null && local37.method24261()) {
							this.method31571(local37, local1, local9, local17, 1, 1);
							if (local40 != null && local40.method24261()) {
								this.method31571(local40, local1, local9, local17, 1, 1);
								local40.method24269(this.aClass104_11, local37, 0, 0, 0, false);
								local40.method24265();
							}
							local37.method24265();
						}
						for (@Pc(89) Class590 local89 = local32.aClass590_1; local89 != null; local89 = local89.aClass590_2) {
							...
							if (local94 != null && local94.method24261()) {
						...
						if (local130 != null && local130.method24261()) {
							this.method31470(local130, local1, local9, local17);
							local130.method24265();
						}
					}
				}
			}
	...
	void method31470(@OriginalArg(0) Class132_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(16) Class572 local16;
		@Pc(126) int local126;
		if (arg2 < this.anInt5443 * -200159665) {
			local16 = this.aClass572ArrayArrayArray3[arg1][arg2 + 1][arg3];
			if (local16 != null && local16.aClass132_Sub1_Sub4_1 != null && local16.aClass132_Sub1_Sub4_1.method24261()) {
				local126 = (this.aClass99Array1[arg1].method2482(arg2 + 1, arg3) + this.aClass99Array1[arg1].method2482(arg2 + 1 + 1, arg3) + this.aClass99Array1[arg1].method2482(arg2 + 1, arg3 + 1) + this.aClass99Array1[arg1].method2482(1 + 1 + arg2, arg3 + 1)) / 4 - (this.aClass99Array1[arg1].method2482(arg2, arg3) + this.aClass99Array1[arg1].method2482(arg2 + 1, arg3) + this.aClass99Array1[arg1].method2482(arg2, arg3 + 1) + this.aClass99Array1[arg1].method2482(arg2 + 1, arg3 + 1)) / 4;
				arg0.method24269(this.aClass104_11, local16.aClass132_Sub1_Sub4_1, this.anInt5439 * -77997759, local126, 0, true);
			}
		}
		if (arg3 < this.anInt5443 * -200159665) {
			local16 = this.aClass572ArrayArrayArray3[arg1][arg2][arg3 + 1];
			if (local16 != null && local16.aClass132_Sub1_Sub4_1 != null && local16.aClass132_Sub1_Sub4_1.method24261()) {
				local126 = (this.aClass99Array1[arg1].method2482(arg2, arg3) + this.aClass99Array1[arg1].method2482(arg2 + 1, arg3 + 1) + this.aClass99Array1[arg1].method2482(arg2, arg3 + 1 + 1) + this.aClass99Array1[arg1].method2482(arg2 + 1, 1 + 1 + arg3)) / 4 - (this.aClass99Array1[arg1].method2482(arg2, arg3) + this.aClass99Array1[arg1].method2482(arg2 + 1, arg3) + this.aClass99Array1[arg1].method2482(arg2, arg3 + 1) + this.aClass99Array1[arg1].method2482(arg2 + 1, arg3 + 1)) / 4;
				arg0.method24269(this.aClass104_11, local16.aClass132_Sub1_Sub4_1, 0, local126, this.anInt5439 * -77997759, true);
			}
		}
		if (arg2 < this.anInt5443 * -200159665 && arg3 < this.anInt5444 * -1943751559) {
			local16 = this.aClass572ArrayArrayArray3[arg1][arg2 + 1][arg3 + 1];
			if (local16 != null && local16.aClass132_Sub1_Sub4_1 != null && local16.aClass132_Sub1_Sub4_1.method24261()) {
				local126 = (this.aClass99Array1[arg1].method2482(arg2 + 1, arg3 + 1) + this.aClass99Array1[arg1].method2482(arg2 + 1 + 1, arg3 + 1) + this.aClass99Array1[arg1].method2482(arg2 + 1, arg3 + 1 + 1) + this.aClass99Array1[arg1].method2482(1 + 1 + arg2, 1 + 1 + arg3)) / 4 - (this.aClass99Array1[arg1].method2482(arg2, arg3) + this.aClass99Array1[arg1].method2482(arg2 + 1, arg3) + this.aClass99Array1[arg1].method2482(arg2, arg3 + 1) + this.aClass99Array1[arg1].method2482(arg2 + 1, arg3 + 1)) / 4;
				arg0.method24269(this.aClass104_11, local16.aClass132_Sub1_Sub4_1, this.anInt5439 * -77997759, local126, this.anInt5439 * -77997759, true);
			}
		}
		...
		local16 = this.aClass572ArrayArrayArray3[arg1][arg2 + 1][arg3 - 1];
		if (local16 != null && local16.aClass132_Sub1_Sub4_1 != null && local16.aClass132_Sub1_Sub4_1.method24261()) {
			local126 = (this.aClass99Array1[arg1].method2482(arg2 + 1, arg3 - 1) + this.aClass99Array1[arg1].method2482(arg2 + 1 + 1, arg3 - 1) + this.aClass99Array1[arg1].method2482(arg2 + 1, arg3 + 1 - 1) + this.aClass99Array1[arg1].method2482(1 + 1 + arg2, arg3 + 1 - 1)) / 4 - (this.aClass99Array1[arg1].method2482(arg2, arg3) + this.aClass99Array1[arg1].method2482(arg2 + 1, arg3) + this.aClass99Array1[arg1].method2482(arg2, arg3 + 1) + this.aClass99Array1[arg1].method2482(arg2 + 1, arg3 + 1)) / 4;
			arg0.method24269(this.aClass104_11, local16.aClass132_Sub1_Sub4_1, this.anInt5439 * -77997759, local126, -(this.anInt5439 * -77997759), true);
		}
	}
					...
					if (local31 >= 0 && local31 < this.anInt5443 * -200159665) {
						for (@Pc(45) int local45 = local11; local45 <= local15; local45++) {
							if (local45 >= 0 && local45 < this.anInt5444 * -1943751559 && (!local1 || local31 >= local7 || local45 >= local15 || local45 < arg3 && arg2 != local31)) {
								...
								if (local81 != null) {
									@Pc(176) int local176 = (this.aClass99Array1[local17].method2482(local31, local45) + this.aClass99Array1[local17].method2482(local31 + 1, local45) + this.aClass99Array1[local17].method2482(local31, local45 + 1) + this.aClass99Array1[local17].method2482(local31 + 1, local45 + 1)) / 4 - (this.aClass99Array1[arg1].method2482(arg2, arg3) + this.aClass99Array1[arg1].method2482(arg2 + 1, arg3) + this.aClass99Array1[arg1].method2482(arg2, arg3 + 1) + this.aClass99Array1[arg1].method2482(arg2 + 1, arg3 + 1)) / 4;
									...
									if (local179 != null && local179.method24261()) {
										arg0.method24269(this.aClass104_11, local179, this.anInt5439 * -77997759 * (local31 - arg2) + (1 - arg4) * -996240773 * this.anInt5447, local176, this.anInt5439 * -77997759 * (local45 - arg3) + this.anInt5447 * -996240773 * (1 - arg5), local1);
									}
									if (local182 != null && local182.method24261()) {
										arg0.method24269(this.aClass104_11, local182, (local31 - arg2) * this.anInt5439 * -77997759 + (1 - arg4) * this.anInt5447 * -996240773, local176, this.anInt5447 * -996240773 * (1 - arg5) + (local45 - arg3) * this.anInt5439 * -77997759, local1);
									}
									for (@Pc(283) Class590 local283 = local81.aClass590_1; local283 != null; local283 = local283.aClass590_2) {
										...
										if (local288 != null && local288.method24261() && (local288.aShort129 == local31 || local3 == local31) && (local45 == local288.aShort128 || local11 == local45)) {
											@Pc(318) int local318 = local288.aShort130 - local288.aShort129 + 1;
											@Pc(326) int local326 = local288.aShort127 - local288.aShort128 + 1;
											arg0.method24269(this.aClass104_11, local288, (local288.aShort129 - arg2) * -77997759 * this.anInt5439 + (local318 - arg4) * this.anInt5447 * -996240773, local176, (local288.aShort128 - arg3) * this.anInt5439 * -77997759 + (local326 - arg5) * -996240773 * this.anInt5447, local1);
										}
									}
								}
							}
	...
	public void method31510(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte[][][] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) byte arg11, @OriginalArg(14) boolean arg12, @OriginalArg(15) boolean arg13, @OriginalArg(16) int arg14, @OriginalArg(17) boolean arg15) {
		this.aClass598_2.aBoolean823 = true;
		this.aBoolean819 = arg13;
			...
			for (local164 = 0; local164 < this.anInt5455 * -93916925 + 2 + this.anInt5455 * -93916925; local164++) {
				...
				for (@Pc(183) int local183 = 0; local183 < this.anInt5455 * -93916925 + 2 + this.anInt5455 * -93916925; local183++) {
					...
					if (local220 >= 0 && local232 >= 0 && local220 < this.anInt5443 * -200159665 && local232 < this.anInt5444 * -1943751559) {
						...
						@Pc(284) int local284 = this.aClass99Array2[this.aClass99Array2.length - 1].method2482(local220, local232) - (0x3E8 << this.anInt5438 * -358186793 - 7);
						@Pc(325) int local325 = (this.aClass99Array3 == null ? this.aClass99Array2[0].method2482(local220, local232) + this.anInt5439 * -77997759 : this.aClass99Array3[0].method2482(local220, local232) + this.anInt5439 * -77997759) + (0x3E8 << this.anInt5438 * -358186793 - 7);
		...
		Class574.method31346(this, this.aClass104_11);
	...
	public void method31574(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte[][][] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) byte arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) boolean arg14, @OriginalArg(15) boolean arg15, @OriginalArg(16) int arg16, @OriginalArg(17) boolean arg17) {
		...
		if (this.aBoolean817) {
			for (local164 = 0; local164 < this.anInt5464 * 809266399; local164++) {
				this.aClass597Array1[local164].method31766(arg0, arg14);
			}
		}
		if (this.aClass572ArrayArrayArray2 != null) {
			this.method31432(true);
	...
	void method31473(@OriginalArg(0) boolean arg0, @OriginalArg(1) byte[][][] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3, @OriginalArg(4) int arg4) {
		...
		if ((arg4 & 0x1) == 0) {
			...
			if (!arg0) {
				for (local184 = 0; local184 < this.anInt5465 * -1409302901; local184++) {
					this.method31474(this.aClass132_Sub1_Sub1Array1[local184]);
					if (this.aClass132_Sub1_Sub1Array1[local184].anInt3290 * 1998180051 != -1 && !this.method31477(this.aClass132_Sub1_Sub1Array1[local184], arg0, arg1, arg2, arg3)) {
						if (this.aClass132_Sub1_Sub1Array1[local184].method24263()) {
		...
		if (this.aBoolean817) {
			this.aClass104_11.method20790(0, null);
		}
		if ((arg4 & 0x2) == 0) {
	...
	void method31474(@OriginalArg(0) Class132_Sub1 arg0) {
		@Pc(3) Class472 local3 = arg0.method24229().aClass472_61;
		this.aClass104_11.method20824((float) local3.aFloat317, (float) ((int) local3.aFloat318 + (arg0.method24289() >> 1)), (float) local3.aFloat319, this.aFloatArray118);
	...
	boolean method31477(@OriginalArg(0) Class132_Sub1 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) byte[][][] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte arg4) {
		if (!this.aBoolean819) {
			...
			for (@Pc(25) int local25 = local19; local25 <= local11; local25++) {
				for (@Pc(30) int local30 = local23; local30 <= local15; local30++) {
					if (arg0.aByte99 < this.anInt5442 * -882426473 && local25 >= this.anInt5461 * 890109843 && local25 < this.anInt5458 * -891147229 && local30 >= this.anInt5446 * 1220619219 && local30 < this.anInt5460 * 150058823) {
						if ((arg2 == null || arg0.aByte100 < arg3 || arg2[arg0.aByte100][local25][local30] != arg4) && arg0.method24273() && !arg0.method24270(this.aClass104_11)) {
							return false;
						}
						if (!arg1 && local25 >= this.anInt5440 * 1602382659 - 16 && local25 <= this.anInt5440 * 1602382659 + 16 && local30 >= this.anInt5459 * 1547517939 - 16 && local30 <= this.anInt5459 * 1547517939 + 16) {
							arg0.method24267(this.aClass104_11);
						}
						return true;
					}
				}
			...
			if (arg0.aByte99 >= this.anInt5442 * -882426473 || local153 < this.anInt5461 * 890109843 || local153 >= this.anInt5458 * -891147229 || local162 < this.anInt5446 * 1220619219 || local162 >= this.anInt5460 * 150058823) {
				return true;
			} else if ((arg2 == null || arg0.aByte100 < arg3 || arg2[arg0.aByte100][local153][local162] != arg4) && arg0.method24273() && !arg0.method24270(this.aClass104_11)) {
				return false;
			} else {
	...
	void method31460(@OriginalArg(0) Class132_Sub1 arg0, @OriginalArg(1) Class93_Sub16[] arg1) {
		...
		if (this.aClass99Array3 == this.aClass99Array1) {
			...
			local81.anInt3817 = this.method31458(local7, local36) * -938620053;
			local81.anInt3815 = this.method31439(local7, local36) * -192371369;
			local81.anInt3819 = this.method31519(local7, local36) * -316775901;
			local81.anInt3818 = this.method31442(local7, local36) * -699093173;
			local81.anInt3820 = this.method31489(local7, local36) * -913672293;
			local81.anInt3821 = this.method31444(local7, local36) * 152514549;
			this.aClass104_11.method20545(this.aClass99Array2[0].method2480((int) local25.aFloat317, (int) local25.aFloat319), local81);
		}
		@Pc(157) Class573 local157 = arg0.method24271(this.aClass104_11);
		if (local157 == null) {
			return;
		}
		if (local157.aBoolean815) {
			local157.aClass132_Sub1_25 = arg0;
			this.aClass569_2.method31303(local157);
		} else {
			Class305.method26798(local157);
		}
	}
	...
	public boolean method31479(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean[] arg4) {
		@Pc(1) boolean local1 = false;
		if (this.aClass99Array3 != this.aClass99Array1) {
			@Pc(15) int local15 = this.aClass99Array2[arg1].method2480(arg2, arg3);
			for (@Pc(17) int local17 = 0; local17 <= arg1; local17++) {
				@Pc(25) Class99 local25 = this.aClass99Array2[local17];
				if (local25 != null) {
					@Pc(37) int local37 = local15 - local25.method2480(arg2, arg3);
					if (arg4 != null) {
						arg4[local17] = local25.method2488(arg0, arg2, local37, arg3);
						if (!arg4[local17]) {
							continue;
						}
					}
					local25.method2485(arg0, arg2, local37, arg3);
					local1 = true;
				}
			}
		}
	...
	public void method31543(@OriginalArg(0) Class93_Sub1_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean[] arg4) {
		if (this.aClass99Array1 == this.aClass99Array3) {
			return;
		}
		@Pc(13) int local13 = this.aClass99Array2[arg1].method2480(arg2, arg3);
		for (@Pc(15) int local15 = 0; local15 <= arg1; local15++) {
			if (arg4 == null || arg4[local15]) {
				@Pc(30) Class99 local30 = this.aClass99Array2[local15];
				if (local30 != null) {
					local30.method2496(arg0, arg2, local13 - local30.method2480(arg2, arg3), arg3);
				}
			}
		}
	}
	...
	void method31599(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
					...
					for (@Pc(24) int local24 = 0; local24 < this.anInt5443 * -200159665; local24++) {
						...
						if (local1 != null) {
							...
							for (@Pc(57) int local57 = local3 - 1; local57 >= 0; local57--) {
								...
								if (local64 != null) {
									@Pc(79) int local79 = local11.method2482(local24, local16) - local64.method2482(local24, local16);
									@Pc(95) int local95 = local11.method2482(local24 + 1, local16) - local64.method2482(local24 + 1, local16);
									@Pc(115) int local115 = local11.method2482(local24 + 1, local16 + 1) - local64.method2482(local24 + 1, local16 + 1);
									@Pc(131) int local131 = local11.method2482(local24, local16 + 1) - local64.method2482(local24, local16 + 1);
									local64.method2485(local1, local46, (local79 + local95 + local115 + local131) / 4, local53);
								}
							}
						}
					}
	...
	public void method31482() {
		this.method31599(1, this.anInt5442 * -882426473);
	}
	...
	public void method31483(@OriginalArg(0) Class597 arg0) {
		...
		for (@Pc(58) int local58 = local36; local58 <= local46; local58++) {
			@Pc(63) int local63 = 0;
			@Pc(81) int local81 = local9.method13522() - local9.method13523() + this.anInt5447 * -996240773 >> this.anInt5438 * -358186793;
			if (local81 < 0) {
				local63 -= local81;
				local81 = 0;
			}
			@Pc(107) int local107 = local9.method13522() + local9.method13523() - this.anInt5447 * -996240773 >> this.anInt5438 * -358186793;
			...
			for (@Pc(122) int local122 = local81; local122 <= local107; local122++) {
				...
				@Pc(153) int local153 = (local9.method13520() - local9.method13523() + this.anInt5447 * -996240773 >> this.anInt5438 * -358186793) + (local131 >>> 8);
		...
		if (local337 != null) {
			arg0.aClass93_Sub16_3.method13533(local337.method13539());
			arg0.aClass93_Sub16_3.method13535(local337.method13571(), local337.method13530());
			arg0.aClass93_Sub16_3.method13551(local337.method13567());
			arg0.aClass93_Sub16_3.method13536(local337.method13544(), local337.method13532());
		}
	}
	...
	public void method31484() {
		for (@Pc(1) int local1 = 0; local1 < this.anInt5464 * 809266399; local1++) {
			if (!this.aBooleanArray32[local1]) {
				...
				@Pc(34) int local34 = local20.method13523() - this.anInt5447 * -996240773;
				@Pc(45) int local45 = (local34 * 2 >> this.anInt5438 * -358186793) + 1;
				@Pc(47) int local47 = 0;
				@Pc(52) int[] local52 = new int[local45 * local45];
				@Pc(63) int local63 = local20.method13520() - local34 >> this.anInt5438 * -358186793;
				@Pc(74) int local74 = local20.method13522() - local34 >> this.anInt5438 * -358186793;
				@Pc(85) int local85 = local20.method13522() + local34 >> this.anInt5438 * -358186793;
				if (local74 < 0) {
					local47 -= local74;
					local74 = 0;
				}
				...
				for (@Pc(108) int local108 = local74; local108 <= local85; local108++) {
					...
					for (@Pc(163) int local163 = local132; local163 <= local140; local163++) {
						...
						@Pc(176) Class132_Sub1_Sub1 local176 = this.method31585(local25, local163, local108, null);
	...
	public void method31485(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		while (local12.hasNext()) {
			...
			local19.aClass93_Sub16_3.method13535(arg1, arg2);
		}
	}

	@OriginalMember(owner = "client!tx", name = "bx", descriptor = "(IIIB)V", line = 1323)
	public void method31486(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(6) List local6 = (List) this.aHashMap11.get(arg0);
		if (local6 == null) {
			return;
		}
	...
	public void method31488(@OriginalArg(0) HashMap arg0) {
	...
	static final void method31613(@OriginalArg(0) Class312 arg0, @OriginalArg(1) Class320 arg1, @OriginalArg(2) Class681 arg2) {
		...
		if (arg0.anInt3970 * 532402067 == -1 && !arg1.aBoolean708) {
			Class124_Sub3_Sub1.method19766(arg0.anInt3953 * -1549590237);
		}
	}
}
