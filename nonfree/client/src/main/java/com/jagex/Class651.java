...
public class Class651 {
	...
	public Class651(@OriginalArg(0) Class497 arg0) {
		@Pc(15) byte[] local15 = arg0.method30059(Class649.aClass649_11.anInt5795 * -51136173);
		this.method32670(new Class93_Sub41(local15));
	}

	@OriginalMember(owner = "client!wy", name = "e", descriptor = "(Lclient!alw;B)V", line = 23)
	void method32670(@OriginalArg(0) Class93_Sub41 arg0) {
		while (true) {
			...
			if (local3 == 1) {
				...
				for (@Pc(19) int local19 = 0; local19 < this.anIntArray506.length; local19++) {
					this.anIntArray506[local19] = arg0.method22413();
					if (this.anIntArray506[local19] != 0 && this.anIntArray506[local19] == 2) {
					}
				}
			} else if (local3 == 3) {
				this.anInt5798 = arg0.method22413() * 39892529;
			} else if (local3 == 4) {
				this.anInt5802 = arg0.method22413() * -1558287369;
			} else if (local3 == 5) {
				this.anIntArray508 = new int[arg0.method22413()];
				for (local13 = 0; local13 < this.anIntArray508.length; local13++) {
					this.anIntArray508[local13] = arg0.method22413();
				}
			} else if (local3 == 6) {
				this.anIntArray507 = new int[arg0.method22413()];
				for (local13 = 0; local13 < this.anIntArray507.length; local13++) {
					this.anIntArray507[local13] = arg0.method22413();
				}
			}
		}
	}
	...
	static final void method32673(@OriginalArg(0) Class681 arg0) {
		@Pc(8) Class677 local8 = arg0.aBoolean875 ? arg0.aClass677_2 : arg0.aClass677_1;
		@Pc(11) Class312 local11 = local8.aClass312_13;
		@Pc(14) Class320 local14 = local8.aClass320_4;
		Class665.method32892(local11, local14, arg0);
	}

	@OriginalMember(owner = "client!wy", name = "alj", descriptor = "(Lclient!yf;I)V", line = 11845)
	static final void method32674(@OriginalArg(0) Class681 arg0) {
