...
public class Class651 {
		...
		while (true) {
			...
			if (local3 == 1) {
				...
				for (@Pc(19) int local19 = 0; local19 < this.anIntArray506.length; local19++) {
					this.anIntArray506[local19] = arg0.method22413((short) 16384);
					if (this.anIntArray506[local19] != 0 && this.anIntArray506[local19] == 2) {
					}
				}
			} else if (local3 == 3) {
				this.anInt5798 = arg0.method22413((short) 16384) * 39892529;
			} else if (local3 == 4) {
				this.anInt5802 = arg0.method22413((short) 16384) * -1558287369;
			} else if (local3 == 5) {
				this.anIntArray508 = new int[arg0.method22413((short) 16384)];
				for (local13 = 0; local13 < this.anIntArray508.length; local13++) {
					this.anIntArray508[local13] = arg0.method22413((short) 16384);
				}
			} else if (local3 == 6) {
				this.anIntArray507 = new int[arg0.method22413((short) 16384)];
				for (local13 = 0; local13 < this.anIntArray507.length; local13++) {
					this.anIntArray507[local13] = arg0.method22413((short) 16384);
				}
			}
		}
	}
	...
	public Class651(@OriginalArg(0) Class497 arg0) {
		@Pc(15) byte[] local15 = arg0.method30059(Class649.aClass649_11.anInt5795 * -51136173, (byte) 97);
	...
	static final void method32673(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		...
		Class665.method32892(local11, local14, arg0, 168030255);
	}
