...
public abstract class Class117 implements Interface4 {
	...
	static Class160 method8383(@OriginalArg(0) Socket arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
		return new Class160_Sub1(arg0, arg1, arg2);
	}

	@OriginalMember(owner = "client!fu", name = "i", descriptor = "(II)V", line = 162)
	public static void method8384(@OriginalArg(0) int arg0) {
	...
	Class117(@OriginalArg(0) Interface11 arg0, @OriginalArg(1) Class497 arg1, @OriginalArg(2) Class497 arg2, @OriginalArg(3) Class497 arg3) {
		...
		Class626.method32244(arg1, arg3);
		Class629.method32265(arg2, arg3);
	}
	...
	Class93_Sub1_Sub10 method8371(@OriginalArg(0) int arg0) {
		...
		synchronized (this.aClass240_11) {
			...
			return local11.method21776() ? local11 : null;
		}
	}

	@OriginalMember(owner = "client!fu", name = "e", descriptor = "(IB)Lclient!arr;", line = 220)
	Class93_Sub1_Sub10 method8378(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_11;
		synchronized (this.aClass240_11) {
			@Pc(11) Class93_Sub1_Sub10 local11 = (Class93_Sub1_Sub10) this.aClass240_11.method25839((long) arg0);
			if (local11 == null) {
	...
	Class93_Sub1_Sub5 method8367(@OriginalArg(0) int arg0) {
		...
		synchronized (this.aClass240_12) {
			...
			return local11.method21555() ? local11 : null;
		}
	}

	@OriginalMember(owner = "client!fu", name = "n", descriptor = "(IB)Lclient!ard;", line = 233)
	Class93_Sub1_Sub5 method8368(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_12;
		synchronized (this.aClass240_12) {
			@Pc(11) Class93_Sub1_Sub5 local11 = (Class93_Sub1_Sub5) this.aClass240_12.method25839((long) arg0);
			if (local11 == null) {
	...
	void method8366(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_11;
		synchronized (this.aClass240_11) {
			this.aClass240_11.method25832(arg0);
		}
	}

	@OriginalMember(owner = "client!fu", name = "k", descriptor = "(II)V", line = 251)
	void method8370(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_11;
		synchronized (this.aClass240_11) {
			this.aClass240_11.method25832(arg0);
		}
	...
	static final void method8379(@OriginalArg(0) Class681 arg0) {
	...
	static final void method8381(@OriginalArg(0) Class681 arg0) {
		...
		Class114.method7634(local14, local25, local36, local54);
	}

	@OriginalMember(owner = "client!fu", name = "ben", descriptor = "(Lclient!yf;I)V", line = 14886)
	static final void method8380(@OriginalArg(0) Class681 arg0) {
		if (Class146.aClass344_3.method27538() > 0) {
			@Pc(17) String local17 = (String) arg0.anObjectArray45[(arg0.anInt5888 -= 957530791) * 587908375];
			@Pc(22) String local22 = Class146.aClass344_3.method27524(local17);
	...
	static final void method8382(@OriginalArg(0) Class681 arg0) {
		...
		@Pc(39) Class30 local39 = (Class30) Class74.aClass32_1.method18261(local13);
		@Pc(45) Class77 local45 = (Class77) Class276.aClass32_2.method18261(local29);
		@Pc(50) Class519[] local50 = local45.aClass519ArrayArray2[local33];
		@Pc(55) Object[] local55 = local39.method620(local33);
