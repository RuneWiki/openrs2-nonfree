...
public abstract class Class117 implements Interface4 {
	...
	void method8366(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_11;
		synchronized (this.aClass240_11) {
			this.aClass240_11.method25832(arg0, (byte) 7);
		}
	}

	@OriginalMember(owner = "client!fu", name = "z", descriptor = "(I)Lclient!ard;", line = 233)
	Class93_Sub1_Sub5 method8367(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_12;
		synchronized (this.aClass240_12) {
			@Pc(11) Class93_Sub1_Sub5 local11 = (Class93_Sub1_Sub5) this.aClass240_12.method25839((long) arg0);
			if (local11 == null) {
				local11 = new Class93_Sub1_Sub5(arg0);
				this.aClass240_12.method25830(local11, (long) arg0);
			}
			return local11.method21555(1109357338) ? local11 : null;
		}
	}

	@OriginalMember(owner = "client!fu", name = "n", descriptor = "(IB)Lclient!ard;", line = 233)
	Class93_Sub1_Sub5 method8368(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		@Pc(3) Class240 local3 = this.aClass240_12;
		synchronized (this.aClass240_12) {
			@Pc(11) Class93_Sub1_Sub5 local11 = (Class93_Sub1_Sub5) this.aClass240_12.method25839((long) arg0);
			if (local11 == null) {
			...
			return local11.method21555(1629026729) ? local11 : null;
		}
	}

	@OriginalMember(owner = "client!fu", name = "m", descriptor = "(I)V", line = 245)
	void method8369(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_11;
		synchronized (this.aClass240_11) {
			this.aClass240_11.method25833((byte) -19);
		}
	}

	@OriginalMember(owner = "client!fu", name = "k", descriptor = "(II)V", line = 251)
	void method8370(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(3) Class240 local3 = this.aClass240_11;
		synchronized (this.aClass240_11) {
			this.aClass240_11.method25832(arg0, (byte) 40);
		}
	}
	...
	Class117(@OriginalArg(0) Interface11 arg0, @OriginalArg(1) Class497 arg1, @OriginalArg(2) Class497 arg2, @OriginalArg(3) Class497 arg3) {
		...
		Class626.method32244(arg1, arg3, 2, -1246432472);
		Class629.method32265(arg2, arg3, (byte) -26);
	}

	@OriginalMember(owner = "client!fu", name = "w", descriptor = "(I)Lclient!arr;", line = 220)
	Class93_Sub1_Sub10 method8371(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_11;
		synchronized (this.aClass240_11) {
			@Pc(11) Class93_Sub1_Sub10 local11 = (Class93_Sub1_Sub10) this.aClass240_11.method25839((long) arg0);
			if (local11 == null) {
				local11 = new Class93_Sub1_Sub10(arg0);
				this.aClass240_11.method25830(local11, (long) arg0);
			}
			return local11.method21776(-1289947964) ? local11 : null;
		}
	}
	...
	Class93_Sub1_Sub5 method8372(@OriginalArg(0) int arg0) {
		...
		synchronized (this.aClass240_12) {
			...
			return local11.method21555(1953167056) ? local11 : null;
		}
	}
	...
	Class93_Sub1_Sub5 method8373(@OriginalArg(0) int arg0) {
		...
		synchronized (this.aClass240_12) {
			...
			return local11.method21555(1812626461) ? local11 : null;
		}
	}
	...
	void method8374() {
		@Pc(3) Class240 local3 = this.aClass240_11;
		synchronized (this.aClass240_11) {
			this.aClass240_11.method25837(1161602830);
		}
	}
	...
	void method8375() {
		@Pc(3) Class240 local3 = this.aClass240_11;
		synchronized (this.aClass240_11) {
			this.aClass240_11.method25833((byte) -32);
		}
	}
	...
	void method8377(@OriginalArg(0) int arg0) {
		@Pc(3) Class240 local3 = this.aClass240_11;
		synchronized (this.aClass240_11) {
			this.aClass240_11.method25837(1161602830);
		}
	...
	Class93_Sub1_Sub10 method8378(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		@Pc(3) Class240 local3 = this.aClass240_11;
		synchronized (this.aClass240_11) {
			@Pc(11) Class93_Sub1_Sub10 local11 = (Class93_Sub1_Sub10) this.aClass240_11.method25839((long) arg0);
			if (local11 == null) {
			...
			return local11.method21776(-1126248190) ? local11 : null;
		}
	}

	@OriginalMember(owner = "client!fu", name = "rt", descriptor = "(Lclient!yf;I)V", line = 8120)
	static final void method8379(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
	...
	static final void method8380(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
		if (Class146.aClass344_3.method27538(-1829778453) > 0) {
			@Pc(17) String local17 = (String) arg0.anObjectArray45[(arg0.anInt5888 -= 957530791) * 587908375];
			@Pc(22) String local22 = Class146.aClass344_3.method27524(local17, -1422298918);
	...
	static final void method8381(@OriginalArg(0) Class681 arg0, @OriginalArg(1) byte arg1) {
	...
	static final void method8382(@OriginalArg(0) Class681 arg0, @OriginalArg(1) int arg1) {
