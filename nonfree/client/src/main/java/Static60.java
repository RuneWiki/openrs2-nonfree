...
public final class Static60 {
	...
	public static Js5Index aClass20_33;
	...
	public static JagString aClass22_467 = method1113("scape main");

	@OriginalMember(owner = "client!kd", name = "w", descriptor = "Lclient!ec;")
	private static JagString aClass22_468 = method1113("Loading fonts )2 ");
	...
	public static JagString aClass22_469 = aClass22_468;
	...
	public static Object method1111(@OriginalArg(1) byte[] arg0) {
		...
		if (arg0.length > 136 && !Static96.aBoolean222) {
			try {
				@Pc(28) ByteArrayCopier local28 = (ByteArrayCopier) Class.forName("ByteBufferNode").getDeclaredConstructor().newInstance();
	...
	public static JagString method1113(@OriginalArg(0) String arg0) {
	...
	public static int method1117(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		@Pc(6) ClientInvCache local6 = (ClientInvCache) Static30.aClass81_4.method2010((long) arg1);
		if (local6 == null) {
			return -1;
