...
public final class Class3_Sub51 extends Class3 {
	...
	public Class3_Sub51(@OriginalArg(0) byte[] arg0) {
		this.method7711(arg0);
	}

	@OriginalMember(owner = "client!tea", name = "a", descriptor = "(I)[F")
	private float[] method7704(@OriginalArg(0) int arg0) {
		Static570.method7710(this.aByteArrayArray22[arg0]);
		Static570.method7701();
		@Pc(15) int local15 = Static570.method7706(Static289.method7950(Static570.anIntArray592.length - 1));
		@Pc(19) boolean local19 = Static570.aBooleanArray26[local15];
		@Pc(25) int local25 = local19 ? Static570.anInt9076 : Static570.anInt9078;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static570.method7701() != 0;
			local29 = Static570.method7701() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static570.anInt9078 >> 2);
			local67 = (local25 >> 2) + (Static570.anInt9078 >> 2);
			local71 = Static570.anInt9078 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static570.anInt9078 >> 2);
			local104 = local25 + (Static570.anInt9078 >> 2) - (local25 >> 2);
			local108 = Static570.anInt9078 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class177 local123 = Static570.aClass177Array1[Static570.anIntArray592[local15]];
		@Pc(126) int local126 = local123.anInt4726;
		@Pc(131) int local131 = local123.anIntArray311[local126];
		@Pc(140) boolean local140 = !Static570.aClass318Array1[local131].method7445();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt4727; local144++) {
			@Pc(152) Class141 local152 = Static570.aClass141Array1[local123.anIntArray312[local144]];
			local154 = Static570.aFloatArray70;
			local152.method3079(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt4726;
			local176 = local123.anIntArray311[local171];
			Static570.aClass318Array1[local176].method7446(Static570.aFloatArray70, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static570.aFloatArray70[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static570.aFloatArray70;
			...
			@Pc(252) float[] local252 = local19 ? Static570.aFloatArray71 : Static570.aFloatArray74;
			@Pc(258) float[] local258 = local19 ? Static570.aFloatArray73 : Static570.aFloatArray72;
			@Pc(264) float[] local264 = local19 ? Static570.aFloatArray69 : Static570.aFloatArray68;
			@Pc(270) int[] local270 = local19 ? Static570.anIntArray591 : Static570.anIntArray590;
			...
			@Pc(486) int local486 = Static289.method7950(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static570.aFloatArray70[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static570.aFloatArray70[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt9085 > 0) {
			local176 = this.anInt9085 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean674) {
				for (local212 = 0; local212 < this.anInt9082; local212++) {
					local1254 = (this.anInt9085 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static570.aFloatArray70[local212];
				}
			}
		}
		local154 = this.aFloatArray67;
		this.aFloatArray67 = Static570.aFloatArray70;
		Static570.aFloatArray70 = local154;
		this.anInt9085 = local25;
		this.anInt9082 = local104 - (local25 >> 1);
		this.aBoolean674 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!tea", name = "a", descriptor = "([I)Lclient!rea;")
	public Class3_Sub12_Sub1 method7708(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray100 == null) {
			this.anInt9085 = 0;
			this.aFloatArray67 = new float[Static570.anInt9076];
			this.aByteArray100 = new byte[this.anInt9084];
			this.anInt9086 = 0;
			this.anInt9087 = 0;
		}
		while (this.anInt9087 < this.aByteArrayArray22.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method7704(this.anInt9087);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt9086;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt9084 - local47) {
					local50 = this.anInt9084 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray100[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt9086;
				}
				this.anInt9086 = local47;
			}
			this.anInt9087++;
		}
		this.aFloatArray67 = null;
		@Pc(129) byte[] local129 = this.aByteArray100;
		this.aByteArray100 = null;
		return new Class3_Sub12_Sub1(this.anInt9079, local129, this.anInt9077, this.anInt9081, this.aBoolean673);
	}

	@OriginalMember(owner = "client!tea", name = "b", descriptor = "([B)V")
	private void method7711(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class3_Sub17 local4 = new Class3_Sub17(arg0);
		this.anInt9079 = local4.method4868();
		this.anInt9084 = local4.method4868();
		this.anInt9077 = local4.method4868();
		this.anInt9081 = local4.method4868();
		if (this.anInt9081 < 0) {
			this.anInt9081 = ~this.anInt9081;
			this.aBoolean673 = true;
		}
		@Pc(40) int local40 = local4.method4868();
		this.aByteArrayArray22 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method4888();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method4832(local64, 0, local49);
