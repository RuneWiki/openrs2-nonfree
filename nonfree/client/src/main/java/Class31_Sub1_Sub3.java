...
public final class Class31_Sub1_Sub3 extends Class31_Sub1 {

	@OriginalMember(owner = "client!wj", name = "H", descriptor = "[I")
	public final int[] anIntArray733;

	@OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(Lclient!aha;II)V")
	public Class31_Sub1_Sub3(@OriginalArg(0) Class13_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		super(arg0, arg1, arg2);
		this.anIntArray733 = new int[arg1 * arg2];
	}

	@OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(Lclient!aha;[IIIIIZ)V")
	public Class31_Sub1_Sub3(@OriginalArg(0) Class13_Sub1 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6) {
		super(arg0, arg4, arg5);
		if (arg6) {
			this.anIntArray733 = new int[arg4 * arg5];
		} else {
			this.anIntArray733 = arg1;
		}
		@Pc(21) int local21 = arg3 - super.anInt10364;
		@Pc(23) int local23 = 0;
		for (@Pc(25) int local25 = 0; local25 < arg5; local25++) {
			for (@Pc(28) int local28 = 0; local28 < arg4; local28++) {
				@Pc(34) int local34 = arg1[arg2++];
				if (local34 >>> 24 == 255) {
					this.anIntArray733[local23++] = (local34 & 0xFFFFFF) == 0 ? -16777215 : local34;
				} else {
					this.anIntArray733[local23++] = 0;
				}
			}
			arg2 += local21;
		}
	...
	@OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(Lclient!aha;[III)V")
	public Class31_Sub1_Sub3(@OriginalArg(0) Class13_Sub1 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
			...
			if (arg6 != 0) {
				...
				if (arg6 == 1) {
					if (arg4 == 1) {
						...
						for (local262 = -arg3; local262 < 0; local262++) {
							...
							for (local273 = -arg2; local273 < 0; local273++) {
								local330 = this.anIntArray733[(local14 >> 16) + local270];
								if (local330 == 0) {
									local64++;
								} else {
						...
						if ((arg5 & 0xFFFFFF) == 16777215) {
							...
							for (local273 = -arg3; local273 < 0; local273++) {
								local330 = (local16 >> 16) * super.anInt10364;
								for (local338 = -arg2; local338 < 0; local338++) {
									local341 = this.anIntArray733[(local14 >> 16) + local330];
									if (local341 == 0) {
										local64++;
									} else {
							...
							for (local341 = -arg3; local341 < 0; local341++) {
								local351 = (local16 >> 16) * super.anInt10364;
								for (local359 = -arg2; local359 < 0; local359++) {
									local367 = this.anIntArray733[(local14 >> 16) + local351];
									if (local367 == 0) {
										local64++;
						...
						for (local338 = -arg3; local338 < 0; local338++) {
							local341 = (local16 >> 16) * super.anInt10364;
							for (local351 = -arg2; local351 < 0; local351++) {
								local359 = this.anIntArray733[(local14 >> 16) + local341];
								if (local359 == 0) {
									local64++;
								} else {
					...
					for (local330 = -arg3; local330 < 0; local330++) {
						local338 = (local16 >> 16) * super.anInt10364;
						for (local341 = -arg2; local341 < 0; local341++) {
							local351 = this.anIntArray733[(local14 >> 16) + local338];
							if (local351 == 0) {
								local64++;
							} else {
				...
				for (local262 = -arg3; local262 < 0; local262++) {
					local270 = (local16 >> 16) * super.anInt10364;
					for (local273 = -arg2; local273 < 0; local273++) {
						local252[local64++] = this.anIntArray733[(local14 >> 16) + local270];
						local14 += local44;
					}
					local16 += local50;
					local14 = local259;
	...
	public void method8802(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		for (@Pc(5) int local5 = 0; local5 < arg3; local5++) {
			@Pc(15) int local15 = (arg1 + local5) * super.anInt10364 + arg0;
			@Pc(25) int local25 = (arg5 + local5) * super.aClass13_Sub1_12.anInt254 + arg4;
			for (@Pc(27) int local27 = 0; local27 < arg2; local27++) {
				this.anIntArray733[local15 + local27] = local3[local25 + local27];
			}
		}
	}
		...
		if (Static483.anInt10346 == 0) {
			if (Static483.anInt10360 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local27 >= 0 && local25 - (super.anInt10364 << 12) < 0 && local27 - (super.anInt10343 << 12) < 0) {
							...
							while (local29 < 0) {
								local111 = this.anIntArray733[(local27 >> 12) * super.anInt10364 + (local25 >> 12)];
								if (local111 == 0) {
									local23++;
								} else {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt10364 << 12) < 0) {
							@Pc(174) int local174;
							if ((local174 = local27 - (super.anInt10343 << 12)) >= 0) {
								local181 = (Static483.anInt10360 - local174) / Static483.anInt10360;
								local29 += local181;
								local27 += Static483.anInt10360 * local181;
								local23 += local181;
							}
							@Pc(202) int local202;
							if ((local202 = (local27 - Static483.anInt10360) / Static483.anInt10360) > local29) {
								local29 = local202;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt10364 << 12) < 0) {
							if (local27 < 0) {
								local181 = (Static483.anInt10360 - local27 - 1) / Static483.anInt10360;
								local29 += local181;
								local27 += Static483.anInt10360 * local181;
								local23 += local181;
							}
							@Pc(369) int local369;
							if ((local369 = (local27 + 1 - (super.anInt10343 << 12) - Static483.anInt10360) / Static483.anInt10360) > local29) {
								local29 = local369;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
			...
			if (Static483.anInt10360 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local27 >= 0 && local27 - (super.anInt10343 << 12) < 0) {
							@Pc(510) int local510;
							if ((local510 = local25 - (super.anInt10364 << 12)) >= 0) {
								local181 = (Static483.anInt10346 - local510) / Static483.anInt10346;
								local29 += local181;
								local25 += Static483.anInt10346 * local181;
								local23 += local181;
							}
							@Pc(538) int local538;
							if ((local538 = (local25 - Static483.anInt10346) / Static483.anInt10346) > local29) {
								local29 = local538;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static483.anInt10352;
						@Pc(670) int local670;
						if ((local670 = local25 - (super.anInt10364 << 12)) >= 0) {
							local181 = (Static483.anInt10346 - local670) / Static483.anInt10346;
							local29 += local181;
							local25 += Static483.anInt10346 * local181;
							local27 += Static483.anInt10360 * local181;
							local23 += local181;
						...
						@Pc(704) int local704;
						if ((local704 = (local25 - Static483.anInt10346) / Static483.anInt10346) > local29) {
							local29 = local704;
						}
						@Pc(716) int local716;
						if ((local716 = local27 - (super.anInt10343 << 12)) >= 0) {
							local181 = (Static483.anInt10360 - local716) / Static483.anInt10360;
							local29 += local181;
							local25 += Static483.anInt10346 * local181;
							local27 += Static483.anInt10360 * local181;
							local23 += local181;
						...
						@Pc(750) int local750;
						if ((local750 = (local27 - Static483.anInt10360) / Static483.anInt10360) > local29) {
							local29 = local750;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static483.anInt10352;
						@Pc(888) int local888;
						if ((local888 = local25 - (super.anInt10364 << 12)) >= 0) {
							local181 = (Static483.anInt10346 - local888) / Static483.anInt10346;
							local29 += local181;
							local25 += Static483.anInt10346 * local181;
							local27 += Static483.anInt10360 * local181;
							local23 += local181;
						...
						@Pc(922) int local922;
						if ((local922 = (local25 - Static483.anInt10346) / Static483.anInt10346) > local29) {
							local29 = local922;
						}
						if (local27 < 0) {
							local181 = (Static483.anInt10360 - local27 - 1) / Static483.anInt10360;
						...
						@Pc(970) int local970;
						if ((local970 = (local27 + 1 - (super.anInt10343 << 12) - Static483.anInt10360) / Static483.anInt10360) > local29) {
							local29 = local970;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if (local27 >= 0 && local27 - (super.anInt10343 << 12) < 0) {
						if (local25 < 0) {
							local181 = (Static483.anInt10346 - local25 - 1) / Static483.anInt10346;
							local29 += local181;
							local25 += Static483.anInt10346 * local181;
							local23 += local181;
						}
						@Pc(1147) int local1147;
						if ((local1147 = (local25 + 1 - (super.anInt10364 << 12) - Static483.anInt10346) / Static483.anInt10346) > local29) {
							local29 = local1147;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1319 = (local25 + 1 - (super.anInt10364 << 12) - Static483.anInt10346) / Static483.anInt10346) > local29) {
						local29 = local1319;
					}
					@Pc(1331) int local1331;
					if ((local1331 = local27 - (super.anInt10343 << 12)) >= 0) {
						local181 = (Static483.anInt10360 - local1331) / Static483.anInt10360;
						local29 += local181;
						local25 += Static483.anInt10346 * local181;
						local27 += Static483.anInt10360 * local181;
						local23 += local181;
					...
					if ((local1365 = (local27 - Static483.anInt10360) / Static483.anInt10360) > local29) {
						local29 = local1365;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1539 = (local25 + 1 - (super.anInt10364 << 12) - Static483.anInt10346) / Static483.anInt10346) > local29) {
						local29 = local1539;
					}
					if (local27 < 0) {
						local181 = (Static483.anInt10360 - local27 - 1) / Static483.anInt10360;
					...
					if ((local1587 = (local27 + 1 - (super.anInt10343 << 12) - Static483.anInt10360) / Static483.anInt10360) > local29) {
						local29 = local1587;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
	...
	public void method8796(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (arg4 != 0) {
			...
			if (arg4 == 1) {
				if (arg2 == 1) {
					for (local168 = -local32; local168 < 0; local168++) {
						...
						while (local27 < local175) {
							local259 = this.anIntArray733[local29++];
							if (local259 == 0) {
								local27++;
							} else {
					...
					if ((arg3 & 0xFFFFFF) == 16777215) {
						...
						for (local259 = -local32; local259 < 0; local259++) {
							for (local262 = -local35; local262 < 0; local262++) {
								local266 = this.anIntArray733[local29++];
								if (local266 == 0) {
									local27++;
								} else {
						...
						for (local273 = -local32; local273 < 0; local273++) {
							for (local281 = -local35; local281 < 0; local281++) {
								local289 = this.anIntArray733[local29++];
								if (local289 == 0) {
									local27++;
					...
					for (local266 = -local32; local266 < 0; local266++) {
						for (local273 = -local35; local273 < 0; local273++) {
							local281 = this.anIntArray733[local29++];
							if (local281 == 0) {
								local27++;
							} else {
				...
				for (local262 = -local32; local262 < 0; local262++) {
					for (local266 = -local35; local266 < 0; local266++) {
						local273 = this.anIntArray733[local29++];
						if (local273 == 0) {
							local27++;
						} else {
			...
			for (local168 = -local32; local168 < 0; local168++) {
				local175 = local27 + local35 - 3;
				while (local27 < local175) {
					local160[local27++] = this.anIntArray733[local29++];
					local160[local27++] = this.anIntArray733[local29++];
					local160[local27++] = this.anIntArray733[local29++];
					local160[local27++] = this.anIntArray733[local29++];
				}
		...
		if (arg7 != 0) {
			...
			if (arg7 == 1) {
				if (arg5 == 1) {
					...
					for (local260 = -arg4; local260 < 0; local260++) {
						...
						for (local271 = -arg3; local271 < 0; local271++) {
							if ((float) arg2 < local246[local52]) {
								local340 = this.anIntArray733[(local6 >> 16) + local268];
								if (local340 != 0) {
					...
					if ((arg6 & 0xFFFFFF) == 16777215) {
						...
						for (local271 = -arg4; local271 < 0; local271++) {
							local340 = (local8 >> 16) * super.anInt10364;
							for (local348 = -arg3; local348 < 0; local348++) {
								if ((float) arg2 < local246[local52]) {
									local351 = this.anIntArray733[(local6 >> 16) + local340];
									if (local351 != 0) {
						...
						for (local351 = -arg4; local351 < 0; local351++) {
							local368 = (local8 >> 16) * super.anInt10364;
							for (local376 = -arg3; local376 < 0; local376++) {
								if ((float) arg2 < local246[local52]) {
									local384 = this.anIntArray733[(local6 >> 16) + local368];
									if (local384 != 0) {
										if (local340 == 255) {
					...
					for (local348 = -arg4; local348 < 0; local348++) {
						local351 = (local8 >> 16) * super.anInt10364;
						for (local368 = -arg3; local368 < 0; local368++) {
							if ((float) arg2 < local246[local52]) {
								local376 = this.anIntArray733[(local6 >> 16) + local351];
								if (local376 != 0) {
				...
				for (local340 = -arg4; local340 < 0; local340++) {
					local348 = (local8 >> 16) * super.anInt10364;
					for (local351 = -arg3; local351 < 0; local351++) {
						if ((float) arg2 < local246[local52]) {
							local368 = this.anIntArray733[(local6 >> 16) + local348];
							if (local368 != 0) {
			...
			for (local260 = -arg4; local260 < 0; local260++) {
				...
				for (local271 = -arg3; local271 < 0; local271++) {
					if ((float) arg2 < local246[local52]) {
						local250[local52] = this.anIntArray733[(local6 >> 16) + local268];
						local246[local52] = (float) arg2;
					}
					local6 += local32;
					local52++;
	...
	protected void method8814(@OriginalArg(0) int arg0) {
		...
		if (Static483.anInt10346 == 0) {
			if (Static483.anInt10360 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local16 >= 0 && local14 - (super.anInt10364 << 12) < 0 && local16 - (super.anInt10343 << 12) < 0) {
						while (local18 < 0) {
							...
							local51 = local12++;
							if (arg0 == 1) {
								local209 = this.anIntArray733[local48];
								if (local209 != 0) {
								...
								if (local209 != 0) {
									if ((Static483.anInt10354 & 0xFFFFFF) == 16777215) {
										local234 = Static483.anInt10354 >>> 24;
										...
										local234 = (local209 & 0xFF0000) * Static483.anInt10337 & 0xFF000000;
										local238 = (local209 & 0xFF00) * Static483.anInt10366 & 0xFF0000;
										local242 = (local209 & 0xFF) * Static483.anInt10367 & 0xFF00;
										...
										local3[local51] = ((local209 & 0xFF00FF) * Static483.anInt10356 + (local314 & 0xFF00FF) * Static483.anInt10341 & 0xFF00FF00) + ((local209 & 0xFF00) * Static483.anInt10356 + (local314 & 0xFF00) * Static483.anInt10341 & 0xFF0000) >> 8;
									}
								}
							} else if (arg0 == 3) {
								local209 = this.anIntArray733[local48];
								local234 = Static483.anInt10354;
								...
								if (local209 == 0 && Static483.anInt10356 != 255) {
									local209 = local314;
									local314 = local3[local51];
									local314 = ((local209 & 0xFF00FF) * Static483.anInt10356 + (local314 & 0xFF00FF) * Static483.anInt10341 & 0xFF00FF00) + ((local209 & 0xFF00) * Static483.anInt10356 + (local314 & 0xFF00) * Static483.anInt10341 & 0xFF0000) >> 8;
								}
								local3[local51] = local314;
							} else if (arg0 == 2) {
								local209 = this.anIntArray733[local48];
								if (local209 != 0) {
									local234 = (local209 & 0xFF00FF) * Static483.anInt10356 & 0xFF00FF00;
									local238 = (local209 & 0xFF00) * Static483.anInt10356 & 0xFF0000;
									local3[local51++] = ((local234 | local238) >>> 8) + Static483.anInt10345;
								}
							} else {
								throw new IllegalArgumentException();
							}
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt10364 << 12) < 0) {
						@Pc(845) int local845;
						if ((local845 = local16 - (super.anInt10343 << 12)) >= 0) {
							local852 = (Static483.anInt10360 - local845) / Static483.anInt10360;
							local18 += local852;
							local16 += Static483.anInt10360 * local852;
							local12 += local852;
						}
						@Pc(873) int local873;
						if ((local873 = (local16 - Static483.anInt10360) / Static483.anInt10360) > local18) {
							local18 = local873;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt10364 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt10364 << 12) < 0) {
						if (local16 < 0) {
							local852 = (Static483.anInt10360 - local16 - 1) / Static483.anInt10360;
							local18 += local852;
							local16 += Static483.anInt10360 * local852;
							local12 += local852;
						}
						@Pc(1722) int local1722;
						if ((local1722 = (local16 + 1 - (super.anInt10343 << 12) - Static483.anInt10360) / Static483.anInt10360) > local18) {
							local18 = local1722;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt10364 + (local14 >> 12);
			...
			if (Static483.anInt10360 == 0) {
				...
				while (local9 < 0) {
					...
					if (local16 >= 0 && local16 - (super.anInt10343 << 12) < 0) {
						...
						if ((local2545 = local14 - (super.anInt10364 << 12)) >= 0) {
							local852 = (Static483.anInt10346 - local2545) / Static483.anInt10346;
							local18 += local852;
							local14 += Static483.anInt10346 * local852;
							local12 += local852;
						}
						@Pc(2573) int local2573;
						if ((local2573 = (local14 - Static483.anInt10346) / Static483.anInt10346) > local18) {
							local18 = local2573;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt10364 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local3387 = local14 - (super.anInt10364 << 12)) >= 0) {
						local852 = (Static483.anInt10346 - local3387) / Static483.anInt10346;
						local18 += local852;
						local14 += Static483.anInt10346 * local852;
						local16 += Static483.anInt10360 * local852;
						local12 += local852;
					...
					if ((local3421 = (local14 - Static483.anInt10346) / Static483.anInt10346) > local18) {
						local18 = local3421;
					}
					@Pc(3433) int local3433;
					if ((local3433 = local16 - (super.anInt10343 << 12)) >= 0) {
						local852 = (Static483.anInt10360 - local3433) / Static483.anInt10360;
						local18 += local852;
						local14 += Static483.anInt10346 * local852;
						local16 += Static483.anInt10360 * local852;
						local12 += local852;
					...
					if ((local3467 = (local16 - Static483.anInt10360) / Static483.anInt10360) > local18) {
						local18 = local3467;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt10364 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local4287 = local14 - (super.anInt10364 << 12)) >= 0) {
						local852 = (Static483.anInt10346 - local4287) / Static483.anInt10346;
						local18 += local852;
						local14 += Static483.anInt10346 * local852;
						local16 += Static483.anInt10360 * local852;
						local12 += local852;
					...
					if ((local4321 = (local14 - Static483.anInt10346) / Static483.anInt10346) > local18) {
						local18 = local4321;
					}
					if (local16 < 0) {
						local852 = (Static483.anInt10360 - local16 - 1) / Static483.anInt10360;
					...
					if ((local4369 = (local16 + 1 - (super.anInt10343 << 12) - Static483.anInt10360) / Static483.anInt10360) > local18) {
						local18 = local4369;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt10364 + (local14 >> 12);
			...
			while (local9 < 0) {
				...
				if (local16 >= 0 && local16 - (super.anInt10343 << 12) < 0) {
					if (local14 < 0) {
						local852 = (Static483.anInt10346 - local14 - 1) / Static483.anInt10346;
						local18 += local852;
						local14 += Static483.anInt10346 * local852;
						local12 += local852;
					}
					@Pc(5228) int local5228;
					if ((local5228 = (local14 + 1 - (super.anInt10364 << 12) - Static483.anInt10346) / Static483.anInt10346) > local18) {
						local18 = local5228;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt10364 + (local14 >> 12);
			...
			for (local9 = Static483.anInt10357; local9 < 0; local9++) {
				...
				if ((local6082 = (local14 + 1 - (super.anInt10364 << 12) - Static483.anInt10346) / Static483.anInt10346) > local18) {
					local18 = local6082;
				}
				@Pc(6094) int local6094;
				if ((local6094 = local16 - (super.anInt10343 << 12)) >= 0) {
					local852 = (Static483.anInt10360 - local6094) / Static483.anInt10360;
					local18 += local852;
					local14 += Static483.anInt10346 * local852;
					local16 += Static483.anInt10360 * local852;
					local12 += local852;
				...
				if ((local6128 = (local16 - Static483.anInt10360) / Static483.anInt10360) > local18) {
					local18 = local6128;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt10364 + (local14 >> 12);
			...
			for (local9 = Static483.anInt10357; local9 < 0; local9++) {
				...
				if ((local6984 = (local14 + 1 - (super.anInt10364 << 12) - Static483.anInt10346) / Static483.anInt10346) > local18) {
					local18 = local6984;
				}
				if (local16 < 0) {
					local852 = (Static483.anInt10360 - local16 - 1) / Static483.anInt10360;
				...
				if ((local7032 = (local16 + 1 - (super.anInt10343 << 12) - Static483.anInt10360) / Static483.anInt10360) > local18) {
					local18 = local7032;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt10364 + (local14 >> 12);
	...
	@OriginalMember(owner = "client!wj", name = "a", descriptor = "(IILclient!aa;II)V")
	@Override
	public void method8805(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class1 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		for (@Pc(212) int local212 = local171; local212 < local210; local212++) {
			...
			for (@Pc(304) int local304 = -local227; local304 < 0; local304++) {
				@Pc(311) int local311 = this.anIntArray733[local19++];
				if (local311 == 0) {
					local41++;
				} else {
