...
public final class Class8 {
	...
	public static synchronized void method208() {
		try {
			...
			signlink.reporterror("89678, " + -31717 + ", " + local20.toString());
	...
	public static synchronized void method209() {
		try {
			...
			signlink.reporterror("9859, " + 65 + ", " + local11.toString());
			throw new RuntimeException();
		}
	}
	...
	public static synchronized Class1_Sub3_Sub3 method210() {
		try {
			...
			signlink.reporterror("67521, " + -809 + ", " + local20.toString());
			throw new RuntimeException();
		}
	}
	...
	public static synchronized Class1_Sub3_Sub3 method211() {
		try {
			...
			signlink.reporterror("12569, " + 854 + ", " + local23.toString());
			throw new RuntimeException();
		}
	}
	...
	public static synchronized void method213(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		try {
			...
			signlink.reporterror("20421, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + 4 + ", " + local64.toString());
			throw new RuntimeException();
		}
	}
	...
	public static synchronized void method214(@OriginalArg(0) int arg0) {
		try {
			...
			signlink.reporterror("77824, " + arg0 + ", " + 0 + ", " + local45.toString());
			throw new RuntimeException();
		}
	}
	...
	public static synchronized void method215(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		try {
			if (aBoolean81 && (arg1 >= 0 && arg1 < 789 && arg0 >= 0 && arg0 < 532)) {
				...
				if (local17 - aLong12 >= 50L) {
					...
					if (arg1 - anInt353 < 8 && arg1 - anInt353 >= -8 && arg0 - anInt354 < 8 && arg0 - anInt354 >= -8) {
						...
						aClass1_Sub3_Sub3_7.method381(arg1 + (arg0 - anInt354 + 8 << 4) + 8 - anInt353);
						...
						aClass1_Sub3_Sub3_7.method381((int) local39);
						aClass1_Sub3_Sub3_7.method381(arg1 + 128 - anInt353);
						aClass1_Sub3_Sub3_7.method381(arg0 + 128 - anInt354);
					} else {
						method212(anInt351, 5);
						aClass1_Sub3_Sub3_7.method381(7);
						aClass1_Sub3_Sub3_7.method381((int) local39);
						aClass1_Sub3_Sub3_7.method384(arg1 + (arg0 << 10));
					}
					anInt353 = arg1;
					anInt354 = arg0;
				}
			...
			signlink.reporterror("20655, " + arg0 + ", " + true + ", " + arg1 + ", " + local163.toString());
			throw new RuntimeException();
		}
	}
	...
	public static synchronized void method216(@OriginalArg(0) int arg0) {
		try {
			...
			signlink.reporterror("93007, " + arg0 + ", " + true + ", " + local70.toString());
			throw new RuntimeException();
		}
	}
	...
	public static synchronized void method217(@OriginalArg(0) int arg0) {
		try {
			...
			signlink.reporterror("36408, " + arg0 + ", " + 1 + ", " + local64.toString());
			throw new RuntimeException();
		}
	}
	...
	public static synchronized void method218() {
		try {
			...
			signlink.reporterror("23406, " + -936 + ", " + local37.toString());
			throw new RuntimeException();
		}
	}
	...
	public static synchronized void method219() {
		try {
			...
			signlink.reporterror("80777, " + 0 + ", " + local42.toString());
			throw new RuntimeException();
		}
	}
	...
	public static synchronized void method220() {
		try {
			...
			signlink.reporterror("47039, " + -657 + ", " + local39.toString());
			throw new RuntimeException();
		}
	}
	...
	public static synchronized void method221() {
		try {
			...
			signlink.reporterror("76997, " + false + ", " + local37.toString());
			throw new RuntimeException();
		}
	}
}
