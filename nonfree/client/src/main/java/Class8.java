...
public abstract class Class8 {
	...
	public abstract Class8 method8175();

	@OriginalMember(owner = "client!q", name = "a", descriptor = "(III[I)V")
	public abstract void method8176(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3);
	...
	public abstract void la(@OriginalArg(0) Class8 arg0);
}
