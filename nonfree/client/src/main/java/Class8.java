...
public abstract class Class8 {
	...
	public abstract void M(@OriginalArg(0) Class8 arg0);
	...
	public abstract void method6811(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3);

	@OriginalMember(owner = "client!q", name = "a", descriptor = "()Lclient!q;")
	public abstract Class8 method6812();
