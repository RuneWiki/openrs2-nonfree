...
public final class Class14_Sub1 extends Class14 {
	...
	@OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(ILclient!rd;)V")
	public Class14_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub41 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(Lclient!rd;)V")
	public Class14_Sub1(@OriginalArg(0) Class3_Sub41 arg0) {
		super(arg0);
	}
