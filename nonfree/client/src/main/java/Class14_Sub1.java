...
public final class Class14_Sub1 extends Class14 {
	...
	@OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(Lclient!dh;)V")
	public Class14_Sub1(@OriginalArg(0) Class2_Sub13 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(ILclient!dh;)V")
	public Class14_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub13 arg1) {
		super(arg0, arg1);
	}
