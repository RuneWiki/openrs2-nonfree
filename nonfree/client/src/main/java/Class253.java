...
public final class Class253 {
	...
	public Class253() {
		Static40.method758(24);
		this.anInt7461 = Static40.method758(16);
		this.anInt7462 = Static40.method758(24);
		this.anIntArray706 = new int[this.anInt7462];
		@Pc(23) boolean local23 = Static40.method762() != 0;
		@Pc(27) int local27;
		@Pc(32) int local32;
		@Pc(43) int local43;
		if (local23) {
			local27 = 0;
			local32 = Static40.method758(5) + 1;
			while (local27 < this.anInt7462) {
				@Pc(41) int local41 = Static40.method758(Static256.method1622(this.anInt7462 - local27));
			...
			@Pc(66) boolean local66 = Static40.method762() != 0;
			for (local32 = 0; local32 < this.anInt7462; local32++) {
				if (local66 && Static40.method762() == 0) {
					this.anIntArray706[local32] = 0;
				} else {
					this.anIntArray706[local32] = Static40.method758(5) + 1;
				}
			}
		}
		this.method5686();
		local27 = Static40.method758(4);
		if (local27 > 0) {
			@Pc(103) float local103 = Static40.method755(Static40.method758(32));
			@Pc(107) float local107 = Static40.method755(Static40.method758(32));
			local43 = Static40.method758(4) + 1;
			@Pc(118) boolean local118 = Static40.method762() != 0;
			@Pc(127) int local127;
			if (local27 == 1) {
				local127 = Static467.method5688(this.anInt7462, this.anInt7461);
			} else {
				local127 = this.anInt7462 * this.anInt7461;
			}
			this.anIntArray707 = new int[local127];
			for (@Pc(140) int local140 = 0; local140 < local127; local140++) {
				this.anIntArray707[local140] = Static40.method758(local43);
			}
			this.aFloatArrayArray9 = new float[this.anInt7462][this.anInt7461];
			@Pc(163) int local163;
			@Pc(166) float local166;
			@Pc(168) int local168;
			@Pc(170) int local170;
			if (local27 == 1) {
				for (local163 = 0; local163 < this.anInt7462; local163++) {
					local166 = 0.0F;
					local168 = 1;
					for (local170 = 0; local170 < this.anInt7461; local170++) {
			...
			for (local163 = 0; local163 < this.anInt7462; local163++) {
				local166 = 0.0F;
				local168 = local163 * this.anInt7461;
				for (local170 = 0; local170 < this.anInt7461; local170++) {
	...
	public float[] method5685() {
		return this.aFloatArrayArray9[this.method5687()];
	}

	@OriginalMember(owner = "client!uu", name = "b", descriptor = "()V")
	private void method5686() {
		@Pc(3) int[] local3 = new int[this.anInt7462];
		...
		@Pc(54) int local54;
		@Pc(63) int local63;
		for (@Pc(8) int local8 = 0; local8 < this.anInt7462; local8++) {
		...
		local14 = 0;
		for (local22 = 0; local22 < this.anInt7462; local22++) {
	...
	public int method5687() {
		@Pc(1) int local1;
		for (local1 = 0; this.anIntArray708[local1] >= 0; local1 = Static40.method762() == 0 ? local1 + 1 : this.anIntArray708[local1]) {
		}
