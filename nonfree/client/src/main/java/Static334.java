...
public final class Static334 {
	...
	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(III)Lclient!gv;")
	public static Class4_Sub4 method4742(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(7) Class113 local7 = Static176.aClass113ArrayArrayArray3[arg0][arg1][arg2];
		return local7 == null ? null : local7.aClass4_Sub4_2;
	}
}
