...
public abstract class Class58 {
	...
	private void method7658(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg4 == 0) {
			return;
		}
	...
	public final void method7659(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class86 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		if (arg4 == 0) {
			return;
		}
		@Pc(9) double local9 = (double) (arg5 & 0xFFFF) * 9.587379924285257E-5D;
	...
	protected abstract void method7660(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) Class86 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8);

	@OriginalMember(owner = "client!xa", name = "b", descriptor = "(IIII)V")
	public final void method7661(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	public final void method7663(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Class86 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		this.method7659(arg0, arg1, (float) this.AA() / 2.0F, (float) this.a() / 2.0F, 4096, arg2, arg3, arg4, arg5);
	}

	@OriginalMember(owner = "client!xa", name = "a", descriptor = "(FFIIIII)V")
	public final void method7664(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4) {
		this.method7658(arg0, arg1, (float) this.AA() / 2.0F, (float) this.a() / 2.0F, arg2, arg3, 0, arg4);
	}

	@OriginalMember(owner = "client!xa", name = "a", descriptor = "(FFII)V")
	public final void method7665(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.method7658(arg0, arg1, (float) this.AA() / 2.0F, (float) this.a() / 2.0F, arg2, arg3, 1, 0);
	}
	...
	public final void method7666(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
