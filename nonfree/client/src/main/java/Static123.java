...
public final class Static123 {
	...
	public static Js5Provider aClass20_Sub1_81;
	...
	public static JagString aClass22_951 = Static60.method1113("welle2:");

	@OriginalMember(owner = "client!v", name = "p", descriptor = "I")
	public static int anInt3084 = 0;

	@OriginalMember(owner = "client!v", name = "a", descriptor = "(II)Lclient!j;")
	public static ObjType method2000(@OriginalArg(0) int arg0) {
		@Pc(10) ObjType local10 = (ObjType) Static68.aClass33_8.method998((long) arg0);
		if (local10 != null) {
			return local10;
		}
		...
		if (local25 != null) {
			local10.method988(new Packet(local25));
		}
		local10.method985();
	...
	public static void method2001(@OriginalArg(0) Packet arg0) {
