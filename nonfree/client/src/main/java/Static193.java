...
public final class Static193 {
	...
	public static int method3489(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) byte[] arg2) {
		@Pc(5) int local5 = -1;
		for (@Pc(7) int local7 = arg0; local7 < arg1; local7++) {
			local5 = Class252.anIntArray560[(local5 ^ arg2[local7]) & 0xFF] ^ local5 >>> 8;
		}
		return ~local5;
	}

	@OriginalMember(owner = "client!jp", name = "a", descriptor = "(IB)Lclient!jq;")
	public static Class1_Sub2 method3490(@OriginalArg(0) int arg0) {
		if (arg0 == 0) {
