...
public final class Class87 {
	...
	public Class87() throws Exception {
	...
	private void exit() {
		...
		this.method2906(37, null);
	}

	@OriginalMember(owner = "client!ep", name = "a", descriptor = "(ILjava/awt/Frame;)V")
	private void method2906(@OriginalArg(0) int arg0, @OriginalArg(1) Frame arg1) {
	...
	private void enter(@OriginalArg(0) Frame arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (arg4 == 0) {
			...
			for (@Pc(39) int local39 = 0; local39 < local35.length; local39++) {
				if (local35[local39].getWidth() == arg1 && local35[local39].getHeight() == arg2 && local35[local39].getBitDepth() == arg3) {
