...
public final class Static29 {
	...
	@OriginalMember(owner = "client!cd", name = "I", descriptor = "Lclient!im;")
	public static Class1_Sub16 aClass1_Sub16_1 = new Class1_Sub16(10000);

	@OriginalMember(owner = "client!cd", name = "Z", descriptor = "Lclient!cd;")
	public static Class25_Sub2_Sub1 aClass25_Sub2_Sub1_1 = new Class25_Sub2_Sub1();

	@OriginalMember(owner = "client!cd", name = "hb", descriptor = "Lclient!cd;")
	public static Class25_Sub2_Sub1 aClass25_Sub2_Sub1_2 = new Class25_Sub2_Sub1();

	@OriginalMember(owner = "client!cd", name = "ib", descriptor = "Lclient!cd;")
	public static Class25_Sub2_Sub1 aClass25_Sub2_Sub1_3 = new Class25_Sub2_Sub1();

	@OriginalMember(owner = "client!cd", name = "jb", descriptor = "Lclient!cd;")
	public static Class25_Sub2_Sub1 aClass25_Sub2_Sub1_4 = new Class25_Sub2_Sub1();

	@OriginalMember(owner = "client!cd", name = "kb", descriptor = "Lclient!cd;")
	public static Class25_Sub2_Sub1 aClass25_Sub2_Sub1_5 = new Class25_Sub2_Sub1();

	@OriginalMember(owner = "client!cd", name = "lb", descriptor = "Lclient!cd;")
	public static Class25_Sub2_Sub1 aClass25_Sub2_Sub1_6 = new Class25_Sub2_Sub1();
	...
	public static int[] anIntArray87 = new int[1];

	@OriginalMember(owner = "client!cd", name = "a", descriptor = "(ISIB)I")
	public static int method624(@OriginalArg(0) int arg0, @OriginalArg(1) short arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		@Pc(5) int local5 = Static151.anIntArray324[Static195.method3494(arg0, arg2)];
		if (arg1 != -1) {
			@Pc(15) int local15 = Static151.anInterface2_1.method4417(arg1 & 0xFFFF);
			@Pc(21) int local21;
			@Pc(44) int local44;
			if (local15 != 0) {
				if (arg2 < 0) {
			...
			local21 = Static151.anInterface2_1.method4415(arg1 & 0xFFFF);
			if (local21 != 0) {
				local21 += 256;
	...
	public static float[] method628(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) float[] local2 = new float[arg1];
		Static302.method1376(arg0, 0, local2, 0, arg1);
		return local2;
	}

	@OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIIIII[FFIF)V")
	public static void method632(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) float arg7, @OriginalArg(8) int arg8, @OriginalArg(9) float arg9) {
	...
	@OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIIIII[FIF)V")
	public static void method633(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) int arg7, @OriginalArg(8) float arg8) {
		@Pc(3) int local3 = arg0 - arg3;
		@Pc(7) int local7 = arg1 - arg4;
		@Pc(11) int local11 = arg2 - arg5;
		@Pc(32) float local32 = (float) local3 * arg6[0] + (float) local7 * arg6[1] + (float) local11 * arg6[2];
	...
	@OriginalMember(owner = "client!cd", name = "q", descriptor = "()V")
	public static void method635() {
		aClass25_Sub2_Sub1_1 = new Class25_Sub2_Sub1();
		aClass25_Sub2_Sub1_2 = new Class25_Sub2_Sub1();
		aClass25_Sub2_Sub1_3 = new Class25_Sub2_Sub1();
		aClass25_Sub2_Sub1_4 = new Class25_Sub2_Sub1();
		aClass25_Sub2_Sub1_5 = new Class25_Sub2_Sub1();
		aClass25_Sub2_Sub1_6 = new Class25_Sub2_Sub1();
	}

	@OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIIIFFF)[F")
	public static float[] method636(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6) {
	...
	@OriginalMember(owner = "client!cd", name = "a", descriptor = "([SI)[S")
	public static short[] method654(@OriginalArg(0) short[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) short[] local2 = new short[arg1];
		Static302.method1378(arg0, 0, local2, 0, arg1);
		return local2;
	}

	@OriginalMember(owner = "client!cd", name = "a", descriptor = "(FFF)I")
	public static int method655(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
