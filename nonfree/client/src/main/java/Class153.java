...
public final class Class153 implements Interface2 {

	@OriginalMember(owner = "client!sb", name = "b", descriptor = "I")
	private int anInt4795 = -1;
	...
	public Class153() {
		if (this.anInt4795 < 0 && (Static60.aBoolean103 && Static60.anInt1332 >= 2)) {
			@Pc(19) int[] local19 = new int[1];
			@Pc(21) GL local21 = Static60.aGL1;
			local21.glGenProgramsARB(1, local19, 0);
			this.anInt4794 = local19[0];
			@Pc(42) int[][] local42 = Static265.method4424(0.4F);
			@Pc(53) int[][] local53 = Static265.method4424(0.4F);
			@Pc(58) Class2_Sub26 local58 = new Class2_Sub26(262144);
			for (@Pc(60) int local60 = 0; local60 < 256; local60++) {
				...
				for (@Pc(73) int local73 = 0; local73 < 64; local73++) {
					if (Static60.aBoolean114) {
						local58.method4266((float) local67[local73] / 4096.0F);
						local58.method4266((float) local71[local73] / 4096.0F);
						local58.method4266(1.0F);
						local58.method4266(1.0F);
					} else {
						local58.method4244((float) local67[local73] / 4096.0F);
						local58.method4244((float) local71[local73] / 4096.0F);
						local58.method4244(1.0F);
						local58.method4244(1.0F);
					}
				}
			}
			@Pc(141) ByteBuffer local141 = ByteBuffer.allocateDirect(local58.anInt5328).order(ByteOrder.nativeOrder());
			local141.put(local58.aByteArray72, 0, local58.anInt5328);
			local141.flip();
	...
	public void method4852(@OriginalArg(0) int arg0) {
		...
		if ((arg0 & 0x80) == 0) {
			local5.glEnable(Static132.aBoolean216 ? 32879 : 3553);
		} else {
			local5.glDisable(Static132.aBoolean216 ? 32879 : 3553);
		}
		local5.glActiveTexture(33984);
		if ((arg0 & 0x40) == 0) {
			local5.glGetFloatv(2899, Static235.aFloatArray29, 0);
			local5.glProgramLocalParameter4fvARB(34336, 66, Static235.aFloatArray29, 0);
		} else {
	...
	public void method4853() {
		if (this.anInt4795 >= 0) {
			@Pc(5) GL local5 = Static60.aGL1;
			local5.glCallList(this.anInt4795 + 1);
		}
	}
	...
	private void method3905() {
		...
		this.anInt4795 = local1.glGenLists(2);
		local1.glNewList(this.anInt4795, 4864);
		...
		local1.glBindProgramARB(34336, this.anInt4794);
		local1.glEnable(34336);
		local1.glEndList();
		local1.glNewList(this.anInt4795 + 1, 4864);
		local1.glActiveTexture(33985);
		...
		local1.glDisable(Static132.aBoolean216 ? 32879 : 3553);
		local1.glActiveTexture(33984);
	...
	private void method3906() {
		...
		local4.glBindProgramARB(34336, this.anInt4794);
	...
	public void method4855() {
		...
		@Pc(5) GL local5 = Static60.aGL1;
		local5.glCallList(this.anInt4795);
		local5.glActiveTexture(33985);
		local5.glMatrixMode(5890);
		local5.glTranslatef((float) Static260.anInt5406, (float) Static56.anInt1271, (float) Static217.anInt4546);
		local5.glRotatef(-((float) Static75.anInt1615 * 360.0F) / 2048.0F, 0.0F, 1.0F, 0.0F);
		local5.glRotatef(-((float) Static266.anInt5529 * 360.0F) / 2048.0F, 1.0F, 0.0F, 0.0F);
		local5.glRotatef(-180.0F, 1.0F, 0.0F, 0.0F);
		local5.glMatrixMode(5888);
		if (!Static132.aBoolean216) {
			local5.glBindTexture(3553, Static132.anIntArray201[(int) ((float) (Static60.anInt1340 * 64) * 0.005F) % 64]);
		}
		local5.glActiveTexture(33984);
		if (this.anInt4796 == Static60.anInt1340) {
			return;
		}
		@Pc(85) int local85 = (Static60.anInt1340 & 0xFF) * 256;
		...
		if (Static132.aBoolean216) {
			local5.glProgramLocalParameter4fARB(34336, 65, (float) Static60.anInt1340 * 0.005F, 0.0F, 0.0F, 1.0F);
		} else {
			local5.glProgramLocalParameter4fARB(34336, 65, 0.0F, 0.0F, 0.0F, 1.0F);
		}
		this.anInt4796 = Static60.anInt1340;
	}
}
