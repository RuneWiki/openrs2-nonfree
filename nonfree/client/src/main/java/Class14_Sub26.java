...
public final class Class14_Sub26 extends Class14 {
	...
	public Class14_Sub26(@OriginalArg(0) byte[] arg0) {
		this.method4570(arg0);
	}

	@OriginalMember(owner = "client!qq", name = "a", descriptor = "([B)V")
	private void method4570(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class14_Sub4 local4 = new Class14_Sub4(arg0);
		this.anInt5114 = local4.method2510();
		this.anInt5107 = local4.method2510();
		this.anInt5108 = local4.method2510();
		this.anInt5111 = local4.method2510();
		if (this.anInt5111 < 0) {
			this.anInt5111 = ~this.anInt5111;
			this.aBoolean343 = true;
		}
		@Pc(40) int local40 = local4.method2510();
		this.aByteArrayArray22 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method2548();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method2518(local64, local49);
			this.aByteArrayArray22[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!qq", name = "a", descriptor = "([I)Lclient!kr;")
	public Class14_Sub11_Sub1 method4571(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray156 == null) {
			this.anInt5110 = 0;
			this.aFloatArray16 = new float[Static268.anInt5112];
			this.aByteArray156 = new byte[this.anInt5107];
			this.anInt5117 = 0;
			this.anInt5116 = 0;
		}
		while (this.anInt5116 < this.aByteArrayArray22.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method4575(this.anInt5116);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt5117;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt5107 - local47) {
					local50 = this.anInt5107 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray156[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt5117;
				}
				this.anInt5117 = local47;
			}
			this.anInt5116++;
		}
		this.aFloatArray16 = null;
		@Pc(129) byte[] local129 = this.aByteArray156;
		this.aByteArray156 = null;
		return new Class14_Sub11_Sub1(this.anInt5114, local129, this.anInt5108, this.anInt5111, this.aBoolean343);
	}

	@OriginalMember(owner = "client!qq", name = "e", descriptor = "(I)[F")
	private float[] method4575(@OriginalArg(0) int arg0) {
		Static268.method4569(this.aByteArrayArray22[arg0]);
		Static268.method4578();
		@Pc(15) int local15 = Static268.method4574(Static18.method431(Static268.anIntArray465.length - 1));
		@Pc(19) boolean local19 = Static268.aBooleanArray23[local15];
		@Pc(25) int local25 = local19 ? Static268.anInt5112 : Static268.anInt5113;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static268.method4578() != 0;
			local29 = Static268.method4578() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static268.anInt5113 >> 2);
			local67 = (local25 >> 2) + (Static268.anInt5113 >> 2);
			local71 = Static268.anInt5113 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static268.anInt5113 >> 2);
			local104 = local25 + (Static268.anInt5113 >> 2) - (local25 >> 2);
			local108 = Static268.anInt5113 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class50 local123 = Static268.aClass50Array1[Static268.anIntArray465[local15]];
		@Pc(126) int local126 = local123.anInt1694;
		@Pc(131) int local131 = local123.anIntArray125[local126];
		@Pc(140) boolean local140 = !Static268.aClass42Array1[local131].method1265();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt1693; local144++) {
			@Pc(152) Class40 local152 = Static268.aClass40Array1[local123.anIntArray124[local144]];
			local154 = Static268.aFloatArray17;
			local152.method1259(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt1694;
			local176 = local123.anIntArray125[local171];
			Static268.aClass42Array1[local176].method1263(Static268.aFloatArray17, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static268.aFloatArray17[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static268.aFloatArray17;
			...
			@Pc(252) float[] local252 = local19 ? Static268.aFloatArray18 : Static268.aFloatArray14;
			@Pc(258) float[] local258 = local19 ? Static268.aFloatArray13 : Static268.aFloatArray15;
			@Pc(264) float[] local264 = local19 ? Static268.aFloatArray19 : Static268.aFloatArray20;
			@Pc(270) int[] local270 = local19 ? Static268.anIntArray463 : Static268.anIntArray464;
			...
			@Pc(486) int local486 = Static18.method431(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static268.aFloatArray17[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static268.aFloatArray17[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt5110 > 0) {
			local176 = this.anInt5110 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean342) {
				for (local212 = 0; local212 < this.anInt5106; local212++) {
					local1254 = (this.anInt5110 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static268.aFloatArray17[local212];
				}
			}
		}
		local154 = this.aFloatArray16;
		this.aFloatArray16 = Static268.aFloatArray17;
		Static268.aFloatArray17 = local154;
		this.anInt5110 = local25;
		this.anInt5106 = local104 - (local25 >> 1);
		this.aBoolean342 = local140;
		return local1228;
	}
}
