...
public final class a implements Interface3 {
	...
	private native void O(@OriginalArg(0) long arg0, @OriginalArg(1) Class57 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) short[] arg5, @OriginalArg(6) int arg6);
	...
	public void method1(@OriginalArg(0) Class22 arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) int arg4, @OriginalArg(8) boolean[][] arg5) {
		this.ta(this.nativeid, ((t) arg0).nativeid, 0, 0, 1024, arg1, arg2, arg3, arg4, arg5);
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;[ILclient!qq;)V")
	public void method2(@OriginalArg(0) Class164 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class203 arg2) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!qq;[III)V")
	public void method3(@OriginalArg(0) Class164 arg0, @OriginalArg(1) Class203 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
	...
	public void method4(@OriginalArg(0) Class22 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	public void method6(@OriginalArg(0) Class57 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
	...
	public Class164 method7(@OriginalArg(0) i arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) i local8;
		@Pc(5) i local5;
		if (arg1 == 1) {
			local5 = this.anI1;
		...
		local8.aClass189Array2 = arg0.aClass189Array2;
		local8.aClass161Array2 = arg0.aClass161Array2;
		return local8;
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!ka;IIIZ)V")
	public void method8(@OriginalArg(0) Class164 arg0, @OriginalArg(1) Class164 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!qq;[II)V")
	public void method10(@OriginalArg(0) Class164 arg0, @OriginalArg(1) Class203 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3) {
	...
	public void method12(@OriginalArg(0) Class22 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.Z(this.nativeid, ((t) arg0).nativeid, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!a", name = "HA", descriptor = "(JLclient!ha;II)V")
	private native void HA(@OriginalArg(0) long arg0, @OriginalArg(1) Class57 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3);
	...
	public void method14(@OriginalArg(0) Class57 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5) {
		this.O(this.nativeid, arg0, arg1, arg2, arg3, arg4, arg5);
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;IILclient!qq;ZI)Z")
	public boolean method15(@OriginalArg(0) Class164 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class203 arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
	...
	private native void na(@OriginalArg(0) long arg0, @OriginalArg(1) Class57 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8);

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;IILclient!qq;Z)Z")
	public boolean method16(@OriginalArg(0) Class164 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class203 arg3, @OriginalArg(4) boolean arg4) {
