...
public final class a implements Interface10 {
	...
	public void method2(@OriginalArg(0) Class245 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	public Class92 method3(@OriginalArg(0) i arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) i local8;
		@Pc(5) i local5;
		if (arg1 == 1) {
			local5 = this.anI7;
		...
		local8.aClass103Array2 = arg0.aClass103Array2;
		local8.aClass49Array2 = arg0.aClass49Array2;
		return local8;
	}
	...
	public void method4(@OriginalArg(0) Class5 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
	...
	public void method6(@OriginalArg(0) Class92 arg0, @OriginalArg(1) Class92 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
	...
	public void method8(@OriginalArg(0) Class5 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;[ILclient!hba;)V")
	public void method9(@OriginalArg(0) Class92 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class115 arg2) {
	...
	public void method11(@OriginalArg(0) Class245 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!hba;[III)V")
	public void method12(@OriginalArg(0) Class92 arg0, @OriginalArg(1) Class115 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;IILclient!hba;ZI)Z")
	public boolean method13(@OriginalArg(0) Class92 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class115 arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
	...
	public void method14(@OriginalArg(0) Class245 arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) int arg4, @OriginalArg(8) boolean[][] arg5) {
		this.ta(this.nativeid, ((t) arg0).nativeid, 0, 0, 1024, arg1, arg2, arg3, arg4, arg5);
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!hba;[II)V")
	public void method15(@OriginalArg(0) Class92 arg0, @OriginalArg(1) Class115 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3) {
		this.UA(this.nativeid, ((i) arg0).nativeid, ((ja) arg1).nativeid, arg2, arg3);
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;IILclient!hba;Z)Z")
	public boolean method16(@OriginalArg(0) Class92 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class115 arg3, @OriginalArg(4) boolean arg4) {
