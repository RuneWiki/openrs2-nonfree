...
public final class a implements Interface12 {
	...
	public void method1(@OriginalArg(0) Class54 arg0, @OriginalArg(1) Class54 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
	...
	public void method2(@OriginalArg(0) Class75 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5) {
	...
	public void method3(@OriginalArg(0) Class96 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.Z(this.nativeid, ((t) arg0).nativeid, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;IILclient!qa;Z)Z")
	public boolean method4(@OriginalArg(0) Class54 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class109 arg3, @OriginalArg(4) boolean arg4) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!qa;[III)V")
	public void method5(@OriginalArg(0) Class54 arg0, @OriginalArg(1) Class109 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
	...
	public Class54 method7(@OriginalArg(0) i arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) i local8;
		@Pc(5) i local5;
		if (arg1 == 1) {
			local5 = this.anI6;
		...
		local8.aClass216Array2 = arg0.aClass216Array2;
		local8.aClass173Array2 = arg0.aClass173Array2;
		return local8;
	}
	...
	public void method9(@OriginalArg(0) Class96 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.H(this.nativeid, ((t) arg0).nativeid, arg1, arg2);
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;IILclient!qa;ZI)Z")
	public boolean method10(@OriginalArg(0) Class54 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class109 arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		return this.n(this.nativeid, ((i) arg0).nativeid, arg1, arg2, ((ja) arg3).nativeid, arg4, arg5);
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;[ILclient!qa;)V")
	public void method11(@OriginalArg(0) Class54 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class109 arg2) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!qa;[II)V")
	public void method12(@OriginalArg(0) Class54 arg0, @OriginalArg(1) Class109 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3) {
	...
	private native void O(@OriginalArg(0) long arg0, @OriginalArg(1) Class75 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) short[] arg5, @OriginalArg(6) int arg6);

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ha;IIIIIII)V")
	public void method15(@OriginalArg(0) Class75 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
	...
	private native void HA(@OriginalArg(0) long arg0, @OriginalArg(1) Class75 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3);

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!s;IIIIIII[[Z)V")
	public void method16(@OriginalArg(0) Class96 arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) int arg4, @OriginalArg(8) boolean[][] arg5) {
	...
	private native void na(@OriginalArg(0) long arg0, @OriginalArg(1) Class75 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8);
}
