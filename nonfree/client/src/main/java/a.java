...
public final class a implements Interface5 {
	...
	@OriginalMember(owner = "client!a", name = "l", descriptor = "Lclient!oa;")
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!eh;[II)V")
	public void method1(@OriginalArg(0) Class114 arg0, @OriginalArg(1) Class56 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3) {
	...
	public void method2(@OriginalArg(0) Class143 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
	...
	public void method4(@OriginalArg(0) Class88 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	public void method6(@OriginalArg(0) Class88 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	public Class114 method8(@OriginalArg(0) i arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) i local8;
		@Pc(5) i local5;
		if (arg1 == 1) {
			local5 = this.anI4;
		...
		local8.aClass244Array4 = arg0.aClass244Array4;
		local8.aClass303Array4 = arg0.aClass303Array4;
		return local8;
	}
	...
	private native void HA(@OriginalArg(0) long arg0, @OriginalArg(1) Class143 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3);

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!ka;IIIZ)V")
	public void method9(@OriginalArg(0) Class114 arg0, @OriginalArg(1) Class114 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
	...
	private native void O(@OriginalArg(0) long arg0, @OriginalArg(1) Class143 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) short[] arg5, @OriginalArg(6) int arg6);

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;IILclient!eh;Z)Z")
	public boolean method10(@OriginalArg(0) Class114 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class56 arg3, @OriginalArg(4) boolean arg4) {
		return this.R(this.nativeid, ((i) arg0).nativeid, arg1, arg2, ((ja) arg3).nativeid, arg4);
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!eh;[III)V")
	public void method11(@OriginalArg(0) Class114 arg0, @OriginalArg(1) Class56 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;IILclient!eh;ZI)Z")
	public boolean method12(@OriginalArg(0) Class114 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class56 arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
	...
	public void method13(@OriginalArg(0) Class88 arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) int arg4, @OriginalArg(8) boolean[][] arg5) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;[ILclient!eh;)V")
	public void method14(@OriginalArg(0) Class114 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class56 arg2) {
	...
	private native void na(@OriginalArg(0) long arg0, @OriginalArg(1) Class143 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8);

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ha;[I[I[I[SI)V")
	public void method15(@OriginalArg(0) Class143 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5) {
