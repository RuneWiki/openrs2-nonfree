...
public final class a implements Interface7 {
	...
	public void method1(@OriginalArg(0) Class95 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5) {
		this.O(this.nativeid, arg0, arg1, arg2, arg3, arg4, arg5);
	}

	@OriginalMember(owner = "client!a", name = "HA", descriptor = "(JLclient!ha;II)V")
	private native void HA(@OriginalArg(0) long arg0, @OriginalArg(1) Class95 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3);
	...
	public void method2(@OriginalArg(0) Class76 arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) int arg4, @OriginalArg(8) boolean[][] arg5) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;IILclient!uha;Z)Z")
	public boolean method4(@OriginalArg(0) Class182 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class177 arg3, @OriginalArg(4) boolean arg4) {
	...
	private native void O(@OriginalArg(0) long arg0, @OriginalArg(1) Class95 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) short[] arg5, @OriginalArg(6) int arg6);

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;IILclient!uha;ZI)Z")
	public boolean method5(@OriginalArg(0) Class182 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class177 arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
	...
	public Class182 method6(@OriginalArg(0) i arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) i local8;
		@Pc(5) i local5;
		if (arg1 == 1) {
			local5 = this.anI3;
		...
		local8.aClass143Array1 = arg0.aClass143Array1;
		local8.aClass255Array1 = arg0.aClass255Array1;
		return local8;
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!ka;IIIZ)V")
	public void method7(@OriginalArg(0) Class182 arg0, @OriginalArg(1) Class182 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!uha;[II)V")
	public void method9(@OriginalArg(0) Class182 arg0, @OriginalArg(1) Class177 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!uha;[III)V")
	public void method11(@OriginalArg(0) Class182 arg0, @OriginalArg(1) Class177 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
	...
	public void method12(@OriginalArg(0) Class76 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;[ILclient!uha;)V")
	public void method13(@OriginalArg(0) Class182 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class177 arg2) {
	...
	public void method14(@OriginalArg(0) Class76 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	public void method16(@OriginalArg(0) Class95 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
	...
	private native void na(@OriginalArg(0) long arg0, @OriginalArg(1) Class95 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8);
}
