...
public final class a implements Interface4 {
	...
	private native void na(@OriginalArg(0) long arg0, @OriginalArg(1) Class67 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8);
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;[ILclient!iu;)V")
	public void method1(@OriginalArg(0) Class157 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class181 arg2) {
		this.e(this.nativeid, ((i) arg0).nativeid, arg1, ((ja) arg2).nativeid);
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!s;II)V")
	public void method2(@OriginalArg(0) Class313 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	public void method5(@OriginalArg(0) Class157 arg0, @OriginalArg(1) Class157 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
	...
	private native void O(@OriginalArg(0) long arg0, @OriginalArg(1) Class67 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) short[] arg5, @OriginalArg(6) int arg6);
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;IILclient!iu;ZI)Z")
	public boolean method7(@OriginalArg(0) Class157 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class181 arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
	...
	public void method8(@OriginalArg(0) Class313 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	public void method10(@OriginalArg(0) Class313 arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) int arg4, @OriginalArg(8) boolean[][] arg5) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!iu;[II)V")
	public void method11(@OriginalArg(0) Class157 arg0, @OriginalArg(1) Class181 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3) {
	...
	public void method12(@OriginalArg(0) Class67 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5) {
		this.O(this.nativeid, arg0, arg1, arg2, arg3, arg4, arg5);
	}

	@OriginalMember(owner = "client!a", name = "HA", descriptor = "(JLclient!ha;II)V")
	private native void HA(@OriginalArg(0) long arg0, @OriginalArg(1) Class67 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3);
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!iu;[III)V")
	public void method13(@OriginalArg(0) Class157 arg0, @OriginalArg(1) Class181 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
	...
	public void method14(@OriginalArg(0) Class67 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
	...
	public Class157 method15(@OriginalArg(0) i arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		...
		local20.aClass156Array2 = arg0.aClass156Array2;
		local20.aClass348Array2 = arg0.aClass348Array2;
		return local20;
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;IILclient!iu;Z)Z")
	public boolean method16(@OriginalArg(0) Class157 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class181 arg3, @OriginalArg(4) boolean arg4) {
