...
public final class a implements Interface5 {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;IILclient!gw;ZI)Z")
	public boolean method1(@OriginalArg(0) Class45 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class86 arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
	...
	public Class45 method3(@OriginalArg(0) i arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		...
		local20.aClass364Array3 = arg0.aClass364Array3;
		local20.aClass363Array3 = arg0.aClass363Array3;
		return local20;
	}
	...
	public void method4(@OriginalArg(0) Class133 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.Z(this.nativeid, ((t) arg0).nativeid, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ha;IIIIIII)V")
	public void method5(@OriginalArg(0) Class145 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
	...
	public void method7(@OriginalArg(0) Class133 arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) int arg4, @OriginalArg(8) boolean[][] arg5) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;[ILclient!gw;)V")
	public void method8(@OriginalArg(0) Class45 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class86 arg2) {
		this.e(this.nativeid, ((i) arg0).nativeid, arg1, ((ja) arg2).nativeid);
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!gw;[II)V")
	public void method9(@OriginalArg(0) Class45 arg0, @OriginalArg(1) Class86 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3) {
	...
	private native void O(@OriginalArg(0) long arg0, @OriginalArg(1) Class145 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) short[] arg5, @OriginalArg(6) int arg6);
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!gw;[III)V")
	public void method10(@OriginalArg(0) Class45 arg0, @OriginalArg(1) Class86 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
	...
	private native void na(@OriginalArg(0) long arg0, @OriginalArg(1) Class145 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8);

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ha;[I[I[I[SI)V")
	public void method12(@OriginalArg(0) Class145 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5) {
	...
	public void method13(@OriginalArg(0) Class45 arg0, @OriginalArg(1) Class45 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
	...
	private native void HA(@OriginalArg(0) long arg0, @OriginalArg(1) Class145 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3);
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;IILclient!gw;Z)Z")
	public boolean method15(@OriginalArg(0) Class45 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class86 arg3, @OriginalArg(4) boolean arg4) {
	...
	public void method16(@OriginalArg(0) Class133 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
