...
public final class a implements Interface7 {
	...
	public void method1(@OriginalArg(0) Class274 arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) int arg4, @OriginalArg(8) boolean[][] arg5) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!wc;[II)V")
	public void method2(@OriginalArg(0) Class128 arg0, @OriginalArg(1) Class47 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3) {
	...
	public Class128 method3(@OriginalArg(0) i arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) i local8;
		@Pc(5) i local5;
		if (arg1 == 1) {
			local5 = this.anI4;
		...
		local8.aClass18Array3 = arg0.aClass18Array3;
		local8.aClass215Array3 = arg0.aClass215Array3;
		return local8;
	}
	...
	public void method5(@OriginalArg(0) Class274 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	public void method6(@OriginalArg(0) Class33 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;[ILclient!wc;)V")
	public void method8(@OriginalArg(0) Class128 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class47 arg2) {
	...
	public void method9(@OriginalArg(0) Class33 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;IILclient!wc;Z)Z")
	public boolean method11(@OriginalArg(0) Class128 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class47 arg3, @OriginalArg(4) boolean arg4) {
	...
	public void method12(@OriginalArg(0) Class128 arg0, @OriginalArg(1) Class128 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
	...
	public void method14(@OriginalArg(0) Class274 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;IILclient!wc;ZI)Z")
	public boolean method15(@OriginalArg(0) Class128 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class47 arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!wc;[III)V")
	public void method16(@OriginalArg(0) Class128 arg0, @OriginalArg(1) Class47 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
