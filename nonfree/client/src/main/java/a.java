...
public final class a implements Interface7 {
	...
	private native void na(@OriginalArg(0) long arg0, @OriginalArg(1) Class65 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8);

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!s;II)V")
	public void method1(@OriginalArg(0) Class109 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!oha;[III)V")
	public void method3(@OriginalArg(0) Class153 arg0, @OriginalArg(1) Class254 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
	...
	public void method4(@OriginalArg(0) Class65 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.na(this.nativeid, arg0, arg1, arg2, arg3, arg4, arg5, arg6, 0);
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;IILclient!oha;ZI)Z")
	public boolean method5(@OriginalArg(0) Class153 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class254 arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
	...
	public void method6(@OriginalArg(0) Class109 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.Z(this.nativeid, ((t) arg0).nativeid, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;Lclient!oha;[II)V")
	public void method7(@OriginalArg(0) Class153 arg0, @OriginalArg(1) Class254 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3) {
		this.UA(this.nativeid, ((i) arg0).nativeid, ((ja) arg1).nativeid, arg2, arg3);
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;[ILclient!oha;)V")
	public void method8(@OriginalArg(0) Class153 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class254 arg2) {
	...
	public void method9(@OriginalArg(0) Class153 arg0, @OriginalArg(1) Class153 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
	...
	public Class153 method10(@OriginalArg(0) i arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) i local8;
		@Pc(5) i local5;
		if (arg1 == 1) {
			local5 = this.anI5;
		...
		local8.aClass313Array2 = arg0.aClass313Array2;
		local8.aClass209Array2 = arg0.aClass209Array2;
		return local8;
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ha;[I[I[I[SI)V")
	public void method11(@OriginalArg(0) Class65 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5) {
	...
	private native void O(@OriginalArg(0) long arg0, @OriginalArg(1) Class65 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) short[] arg5, @OriginalArg(6) int arg6);
	...
	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!ka;IILclient!oha;Z)Z")
	public boolean method15(@OriginalArg(0) Class153 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class254 arg3, @OriginalArg(4) boolean arg4) {
	...
	private native void HA(@OriginalArg(0) long arg0, @OriginalArg(1) Class65 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3);

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(Lclient!s;IIIIIII[[Z)V")
	public void method16(@OriginalArg(0) Class109 arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) int arg4, @OriginalArg(8) boolean[][] arg5) {
