...
public final class Class6_Sub1_Sub2 extends Class6_Sub1 {
	...
	private final byte[] aByteArray22 = new byte[512];
	...
	public Class6_Sub1_Sub2() throws Exception {
		super(22050);
	}
	...
	protected void method1574() {
		for (@Pc(1) int local1 = 0; local1 < 256; local1++) {
			@Pc(8) int local8 = Static104.anIntArray360[local1];
			if ((local8 + 8388608 & 0xFF000000) != 0) {
				local8 = local8 >> 31 ^ 0x7FFFFF;
			}
			this.aByteArray22[local1 * 2] = (byte) (local8 >> 8);
			this.aByteArray22[local1 * 2 + 1] = (byte) (local8 >> 16);
		}
		this.aSourceDataLine1.write(this.aByteArray22, 0, 512);
	}

	@OriginalMember(owner = "client!ta", name = "b", descriptor = "(I)V")
	@Override
	protected void method1573(@OriginalArg(0) int arg0) throws LineUnavailableException {
		try {
