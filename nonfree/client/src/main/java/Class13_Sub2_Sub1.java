...
public final class Class13_Sub2_Sub1 extends Class13_Sub2 {
	...
	@OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lclient!ms;[B[III)V")
	public Class13_Sub2_Sub1(@OriginalArg(0) Class163_Sub1 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
			...
			if (arg6 != 0) {
				...
				if (arg6 == 1) {
					if (arg4 == 1) {
						...
						for (local262 = -arg3; local262 < 0; local262++) {
							...
							for (local273 = -arg2; local273 < 0; local273++) {
								...
								if (local446 == 0) {
									...
									local252[local64++] = this.anIntArray238[local446 & 0xFF];
								}
								local14 += local44;
							}
							local16 += local50;
						...
						if (arg4 == 0) {
							...
							for (local273 = -arg3; local273 < 0; local273++) {
								...
								for (local343 = -arg2; local343 < 0; local343++) {
									local735 = this.aByteArray28[(local14 >> 16) + local335];
									local361 = local735 > 0 ? this.anIntArray238[local735] : 0;
					...
					for (local262 = -arg3; local262 < 0; local262++) {
						...
						for (local273 = -arg2; local273 < 0; local273++) {
							...
							if (local446 == 0) {
								...
								local343 = this.anIntArray238[local446 & 0xFF];
					...
					for (local262 = -arg3; local262 < 0; local262++) {
						...
						for (local273 = -arg2; local273 < 0; local273++) {
							local446 = this.aByteArray28[(local14 >> 16) + local270];
							local343 = local446 > 0 ? this.anIntArray238[local446] : 0;
				...
				for (local262 = -arg3; local262 < 0; local262++) {
					local270 = (local16 >> 16) * super.anInt7212;
					for (local273 = -arg2; local273 < 0; local273++) {
						local252[local64++] = this.anIntArray238[this.aByteArray28[(local14 >> 16) + local270] & 0xFF];
						local14 += local44;
					}
					local16 += local50;
					local14 = local259;
				...
				for (local335 = -arg3; local335 < 0; local335++) {
					local343 = (local16 >> 16) * super.anInt7212;
					for (local346 = -arg2; local346 < 0; local346++) {
						local361 = this.anIntArray238[this.aByteArray28[(local14 >> 16) + local343] & 0xFF];
				...
				for (local343 = -arg3; local343 < 0; local343++) {
					local346 = (local16 >> 16) * super.anInt7212;
					for (local361 = -arg2; local361 < 0; local361++) {
						local369 = this.anIntArray238[this.aByteArray28[(local14 >> 16) + local346] & 0xFF];
		...
		if (arg2 == 1) {
			for (local532 = -local32; local532 < 0; local532++) {
				...
				while (local27 < local539) {
					local546 = this.aByteArray28[local29++];
					if (local546 == 0) {
						local27++;
					} else {
						local160[local27++] = this.anIntArray238[local546 & 0xFF];
					}
					local546 = this.aByteArray28[local29++];
					if (local546 == 0) {
						local27++;
		...
		if (arg2 != 0) {
			...
			if (arg2 == 3) {
				...
				for (local678 = -local32; local678 < 0; local678++) {
					for (local682 = -local35; local682 < 0; local682++) {
						local689 = this.aByteArray28[local29++];
						local698 = local689 > 0 ? this.anIntArray238[local689] : 0;
				...
				for (local776 = -local32; local776 < 0; local776++) {
					for (local698 = -local35; local698 < 0; local698++) {
						@Pc(1098) byte local1098 = this.aByteArray28[local29++];
						if (local1098 == 0) {
							local27++;
						} else {
							local970 = this.anIntArray238[local1098 & 0xFF];
			...
			for (local678 = -local32; local678 < 0; local678++) {
				for (local682 = -local35; local682 < 0; local682++) {
					...
					if (local689 == 0) {
						...
						local698 = this.anIntArray238[local689 & 0xFF];
			...
			for (local698 = -local32; local698 < 0; local698++) {
				for (local702 = -local35; local702 < 0; local702++) {
					@Pc(790) byte local790 = this.aByteArray28[local29++];
					if (local790 == 0) {
						local27++;
					} else {
						local799 = this.anIntArray238[local790 & 0xFF];
						@Pc(810) int local810;
						@Pc(818) int local818;
						@Pc(826) int local826;
						if (local682 == 255) {
	...
	protected void method5673(@OriginalArg(0) int arg0) {
		...
		if (Static213.anInt7236 == 0) {
			if (Static213.anInt7239 == 0) {
					...
					if (local14 >= 0 && local16 >= 0 && local14 - (super.anInt7212 << 12) < 0 && local16 - (super.anInt7221 << 12) < 0) {
						while (local18 < 0) {
							...
							if (arg0 == 1) {
								...
								if (local227 != 0) {
									local3[local51] = this.anIntArray238[local227 & 0xFF];
								}
							} else if (arg0 == 0) {
								local227 = this.aByteArray28[local48];
								if (local227 != 0) {
									local255 = this.anIntArray238[local227 & 0xFF];
									if ((Static213.anInt7238 & 0xFFFFFF) == 16777215) {
										local264 = Static213.anInt7238 >>> 24;
										...
										local264 = (local255 & 0xFF0000) * Static213.anInt7226 & 0xFF000000;
										local268 = (local255 & 0xFF00) * Static213.anInt7223 & 0xFF0000;
										local272 = (local255 & 0xFF) * Static213.anInt7231 & 0xFF00;
										...
										local3[local51] = ((local255 & 0xFF00FF) * Static213.anInt7210 + (local344 & 0xFF00FF) * Static213.anInt7237 & 0xFF00FF00) + ((local255 & 0xFF00) * Static213.anInt7210 + (local344 & 0xFF00) * Static213.anInt7237 & 0xFF0000) >> 8;
									}
								}
							} else if (arg0 == 3) {
								local227 = this.aByteArray28[local48];
								local255 = local227 > 0 ? this.anIntArray238[local227] : 0;
								local264 = Static213.anInt7238;
								...
								if (local255 == 0 && Static213.anInt7210 != 255) {
									local255 = local344;
									local344 = local3[local51];
									local344 = ((local255 & 0xFF00FF) * Static213.anInt7210 + (local344 & 0xFF00FF) * Static213.anInt7237 & 0xFF00FF00) + ((local255 & 0xFF00) * Static213.anInt7210 + (local344 & 0xFF00) * Static213.anInt7237 & 0xFF0000) >> 8;
								}
								...
								if (local227 != 0) {
									local255 = this.anIntArray238[local227 & 0xFF];
									local264 = (local255 & 0xFF00FF) * Static213.anInt7210 & 0xFF00FF00;
									local268 = (local255 & 0xFF00) * Static213.anInt7210 & 0xFF0000;
									local3[local51++] = ((local264 | local268) >>> 8) + Static213.anInt7235;
								}
							} else {
								throw new IllegalArgumentException();
							}
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt7212 << 12) < 0) {
						@Pc(928) int local928;
						if ((local928 = local16 - (super.anInt7221 << 12)) >= 0) {
							local935 = (Static213.anInt7239 - local928) / Static213.anInt7239;
							local18 += local935;
							local16 += Static213.anInt7239 * local935;
							local12 += local935;
						}
						@Pc(956) int local956;
						if ((local956 = (local16 - Static213.anInt7239) / Static213.anInt7239) > local18) {
							local18 = local956;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt7212 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt7212 << 12) < 0) {
						if (local16 < 0) {
							local935 = (Static213.anInt7239 - local16 - 1) / Static213.anInt7239;
							local18 += local935;
							local16 += Static213.anInt7239 * local935;
							local12 += local935;
						}
						@Pc(1888) int local1888;
						if ((local1888 = (local16 + 1 - (super.anInt7221 << 12) - Static213.anInt7239) / Static213.anInt7239) > local18) {
							local18 = local1888;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt7212 + (local14 >> 12);
			...
			if (Static213.anInt7239 == 0) {
				...
				while (local9 < 0) {
					...
					if (local16 >= 0 && local16 - (super.anInt7221 << 12) < 0) {
						...
						if ((local2794 = local14 - (super.anInt7212 << 12)) >= 0) {
							local935 = (Static213.anInt7236 - local2794) / Static213.anInt7236;
							local18 += local935;
							local14 += Static213.anInt7236 * local935;
							local12 += local935;
						}
						@Pc(2822) int local2822;
						if ((local2822 = (local14 - Static213.anInt7236) / Static213.anInt7236) > local18) {
							local18 = local2822;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt7212 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local3719 = local14 - (super.anInt7212 << 12)) >= 0) {
						local935 = (Static213.anInt7236 - local3719) / Static213.anInt7236;
						local18 += local935;
						local14 += Static213.anInt7236 * local935;
						local16 += Static213.anInt7239 * local935;
						local12 += local935;
					...
					if ((local3753 = (local14 - Static213.anInt7236) / Static213.anInt7236) > local18) {
						local18 = local3753;
					}
					@Pc(3765) int local3765;
					if ((local3765 = local16 - (super.anInt7221 << 12)) >= 0) {
						local935 = (Static213.anInt7239 - local3765) / Static213.anInt7239;
						local18 += local935;
						local14 += Static213.anInt7236 * local935;
						local16 += Static213.anInt7239 * local935;
						local12 += local935;
					...
					if ((local3799 = (local16 - Static213.anInt7239) / Static213.anInt7239) > local18) {
						local18 = local3799;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt7212 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local4702 = local14 - (super.anInt7212 << 12)) >= 0) {
						local935 = (Static213.anInt7236 - local4702) / Static213.anInt7236;
						local18 += local935;
						local14 += Static213.anInt7236 * local935;
						local16 += Static213.anInt7239 * local935;
						local12 += local935;
					...
					if ((local4736 = (local14 - Static213.anInt7236) / Static213.anInt7236) > local18) {
						local18 = local4736;
					}
					if (local16 < 0) {
						local935 = (Static213.anInt7239 - local16 - 1) / Static213.anInt7239;
					...
					if ((local4784 = (local16 + 1 - (super.anInt7221 << 12) - Static213.anInt7239) / Static213.anInt7239) > local18) {
						local18 = local4784;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt7212 + (local14 >> 12);
			...
			while (local9 < 0) {
				...
				if (local16 >= 0 && local16 - (super.anInt7221 << 12) < 0) {
					if (local14 < 0) {
						local935 = (Static213.anInt7236 - local14 - 1) / Static213.anInt7236;
						local18 += local935;
						local14 += Static213.anInt7236 * local935;
						local12 += local935;
					}
					@Pc(5726) int local5726;
					if ((local5726 = (local14 + 1 - (super.anInt7212 << 12) - Static213.anInt7236) / Static213.anInt7236) > local18) {
						local18 = local5726;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt7212 + (local14 >> 12);
			...
			for (local9 = Static213.anInt7225; local9 < 0; local9++) {
				...
				if ((local6663 = (local14 + 1 - (super.anInt7212 << 12) - Static213.anInt7236) / Static213.anInt7236) > local18) {
					local18 = local6663;
				}
				@Pc(6675) int local6675;
				if ((local6675 = local16 - (super.anInt7221 << 12)) >= 0) {
					local935 = (Static213.anInt7239 - local6675) / Static213.anInt7239;
					local18 += local935;
					local14 += Static213.anInt7236 * local935;
					local16 += Static213.anInt7239 * local935;
					local12 += local935;
				...
				if ((local6709 = (local16 - Static213.anInt7239) / Static213.anInt7239) > local18) {
					local18 = local6709;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt7212 + (local14 >> 12);
			...
			for (local9 = Static213.anInt7225; local9 < 0; local9++) {
				...
				if ((local7648 = (local14 + 1 - (super.anInt7212 << 12) - Static213.anInt7236) / Static213.anInt7236) > local18) {
					local18 = local7648;
				}
				if (local16 < 0) {
					local935 = (Static213.anInt7239 - local16 - 1) / Static213.anInt7239;
				...
				if ((local7696 = (local16 + 1 - (super.anInt7221 << 12) - Static213.anInt7239) / Static213.anInt7239) > local18) {
					local18 = local7696;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt7212 + (local14 >> 12);
	...
	@OriginalMember(owner = "client!il", name = "a", descriptor = "(IILclient!ta;II)V")
	@Override
		...
		for (@Pc(212) int local212 = local171; local212 < local210; local212++) {
			...
			for (@Pc(304) int local304 = -local227; local304 < 0; local304++) {
				...
				if (local311 == 0) {
					...
					local169[local41++] = this.anIntArray238[local311 & 0xFF];
				}
			}
		...
		if (Static213.anInt7236 == 0) {
			if (Static213.anInt7239 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local27 >= 0 && local25 - (super.anInt7212 << 12) < 0 && local27 - (super.anInt7221 << 12) < 0) {
							...
							while (local29 < 0) {
								local111 = this.aByteArray28[(local27 >> 12) * super.anInt7212 + (local25 >> 12)];
								if (local111 == 0) {
									local23++;
								} else {
									local3[local23++] = this.anIntArray238[local111 & 0xFF];
								}
								local29++;
							}
						}
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt7212 << 12) < 0) {
							@Pc(179) int local179;
							if ((local179 = local27 - (super.anInt7221 << 12)) >= 0) {
								local186 = (Static213.anInt7239 - local179) / Static213.anInt7239;
								local29 += local186;
								local27 += Static213.anInt7239 * local186;
								local23 += local186;
							}
							@Pc(207) int local207;
							if ((local207 = (local27 - Static213.anInt7239) / Static213.anInt7239) > local29) {
								local29 = local207;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt7212 << 12) < 0) {
							if (local27 < 0) {
								local186 = (Static213.anInt7239 - local27 - 1) / Static213.anInt7239;
								local29 += local186;
								local27 += Static213.anInt7239 * local186;
								local23 += local186;
							}
							@Pc(379) int local379;
							if ((local379 = (local27 + 1 - (super.anInt7221 << 12) - Static213.anInt7239) / Static213.anInt7239) > local29) {
								local29 = local379;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
			...
			if (Static213.anInt7239 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local27 >= 0 && local27 - (super.anInt7221 << 12) < 0) {
							@Pc(525) int local525;
							if ((local525 = local25 - (super.anInt7212 << 12)) >= 0) {
								local186 = (Static213.anInt7236 - local525) / Static213.anInt7236;
								local29 += local186;
								local25 += Static213.anInt7236 * local186;
								local23 += local186;
							}
							@Pc(553) int local553;
							if ((local553 = (local25 - Static213.anInt7236) / Static213.anInt7236) > local29) {
								local29 = local553;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static213.anInt7214;
						@Pc(690) int local690;
						if ((local690 = local25 - (super.anInt7212 << 12)) >= 0) {
							local186 = (Static213.anInt7236 - local690) / Static213.anInt7236;
							local29 += local186;
							local25 += Static213.anInt7236 * local186;
							local27 += Static213.anInt7239 * local186;
							local23 += local186;
						...
						@Pc(724) int local724;
						if ((local724 = (local25 - Static213.anInt7236) / Static213.anInt7236) > local29) {
							local29 = local724;
						}
						@Pc(736) int local736;
						if ((local736 = local27 - (super.anInt7221 << 12)) >= 0) {
							local186 = (Static213.anInt7239 - local736) / Static213.anInt7239;
							local29 += local186;
							local25 += Static213.anInt7236 * local186;
							local27 += Static213.anInt7239 * local186;
							local23 += local186;
						...
						@Pc(770) int local770;
						if ((local770 = (local27 - Static213.anInt7239) / Static213.anInt7239) > local29) {
							local29 = local770;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static213.anInt7214;
						@Pc(913) int local913;
						if ((local913 = local25 - (super.anInt7212 << 12)) >= 0) {
							local186 = (Static213.anInt7236 - local913) / Static213.anInt7236;
							local29 += local186;
							local25 += Static213.anInt7236 * local186;
							local27 += Static213.anInt7239 * local186;
							local23 += local186;
						...
						@Pc(947) int local947;
						if ((local947 = (local25 - Static213.anInt7236) / Static213.anInt7236) > local29) {
							local29 = local947;
						}
						if (local27 < 0) {
							local186 = (Static213.anInt7239 - local27 - 1) / Static213.anInt7239;
						...
						@Pc(995) int local995;
						if ((local995 = (local27 + 1 - (super.anInt7221 << 12) - Static213.anInt7239) / Static213.anInt7239) > local29) {
							local29 = local995;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if (local27 >= 0 && local27 - (super.anInt7221 << 12) < 0) {
						if (local25 < 0) {
							local186 = (Static213.anInt7236 - local25 - 1) / Static213.anInt7236;
							local29 += local186;
							local25 += Static213.anInt7236 * local186;
							local23 += local186;
						}
						@Pc(1177) int local1177;
						if ((local1177 = (local25 + 1 - (super.anInt7212 << 12) - Static213.anInt7236) / Static213.anInt7236) > local29) {
							local29 = local1177;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1354 = (local25 + 1 - (super.anInt7212 << 12) - Static213.anInt7236) / Static213.anInt7236) > local29) {
						local29 = local1354;
					}
					@Pc(1366) int local1366;
					if ((local1366 = local27 - (super.anInt7221 << 12)) >= 0) {
						local186 = (Static213.anInt7239 - local1366) / Static213.anInt7239;
						local29 += local186;
						local25 += Static213.anInt7236 * local186;
						local27 += Static213.anInt7239 * local186;
						local23 += local186;
					...
					if ((local1400 = (local27 - Static213.anInt7239) / Static213.anInt7239) > local29) {
						local29 = local1400;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1579 = (local25 + 1 - (super.anInt7212 << 12) - Static213.anInt7236) / Static213.anInt7236) > local29) {
						local29 = local1579;
					}
					if (local27 < 0) {
						local186 = (Static213.anInt7239 - local27 - 1) / Static213.anInt7239;
					...
					if ((local1627 = (local27 + 1 - (super.anInt7221 << 12) - Static213.anInt7239) / Static213.anInt7239) > local29) {
						local29 = local1627;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
