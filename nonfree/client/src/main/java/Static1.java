...
public final class Static1 {
	...
	@OriginalMember(owner = "client!aa", name = "d", descriptor = "Lclient!ca;")
	public static Class40 aClass40_6;

	@OriginalMember(owner = "client!aa", name = "e", descriptor = "I")
	public static int anInt7049;

	@OriginalMember(owner = "client!aa", name = "b", descriptor = "Lclient!lga;")
	public static final Class185 aClass185_74 = new Class185(46, 8);
