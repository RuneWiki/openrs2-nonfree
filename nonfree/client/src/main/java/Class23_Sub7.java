...
public final class Class23_Sub7 extends Class23 {
	...
	@OriginalMember(owner = "client!fia", name = "<init>", descriptor = "(Lclient!ts;)V")
	public Class23_Sub7(@OriginalArg(0) Class3_Sub48 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!fia", name = "<init>", descriptor = "(ILclient!ts;)V")
	public Class23_Sub7(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub48 arg1) {
		super(arg0, arg1);
	}
