...
public final class Class43 {
	...
	@OriginalMember(owner = "client!tb", name = "a", descriptor = "I")
	private final int anInt937 = 4096;

	@OriginalMember(owner = "client!tb", name = "b", descriptor = "I")
	private final int anInt938 = 16;

	@OriginalMember(owner = "client!tb", name = "c", descriptor = "I")
	private final int anInt939 = 258;

	@OriginalMember(owner = "client!tb", name = "d", descriptor = "I")
	private final int anInt940 = 23;

	@OriginalMember(owner = "client!tb", name = "e", descriptor = "I")
	private final int anInt941 = 1;

	@OriginalMember(owner = "client!tb", name = "f", descriptor = "I")
	private final int anInt942 = 6;

	@OriginalMember(owner = "client!tb", name = "g", descriptor = "I")
	private final int anInt943 = 50;

	@OriginalMember(owner = "client!tb", name = "h", descriptor = "I")
	private final int anInt944 = 4;

	@OriginalMember(owner = "client!tb", name = "i", descriptor = "I")
	private final int anInt945 = 18002;

	@OriginalMember(owner = "client!tb", name = "D", descriptor = "[I")
	public int[] anIntArray252 = new int[256];

	@OriginalMember(owner = "client!tb", name = "F", descriptor = "[I")
	public int[] anIntArray253 = new int[257];

	@OriginalMember(owner = "client!tb", name = "G", descriptor = "[I")
	private int[] anIntArray254 = new int[257];
	...
	@OriginalMember(owner = "client!tb", name = "N", descriptor = "[I")
	public int[] anIntArray256 = new int[16];
	...
	@OriginalMember(owner = "client!tb", name = "U", descriptor = "[I")
	public int[] anIntArray257 = new int[6];
}
