...
public final class Class43 {
	...
	public Class43(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			...
			signlink.reporterror("89440, " + arg0 + ", " + arg1 + ", " + local42.toString());
	...
	public Class1 method632(@OriginalArg(0) long arg0) {
		@Pc(11) Class1 local11 = this.aClass1Array1[(int) (arg0 & (long) (this.anInt962 - 1))];
	...
	public void method633(@OriginalArg(1) long arg0, @OriginalArg(2) Class1 arg1) {
		try {
			if (arg1.aClass1_42 != null) {
				arg1.method673();
			}
			@Pc(18) Class1 local18 = this.aClass1Array1[(int) (arg0 & (long) (this.anInt962 - 1))];
			...
			signlink.reporterror("40537, " + true + ", " + arg0 + ", " + arg1 + ", " + local49.toString());
			throw new RuntimeException();
		}
	}
}
