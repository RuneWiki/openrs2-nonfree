...
public final class Static542 {
	...
	@OriginalMember(owner = "client!sca", name = "Kb", descriptor = "Lclient!eo;")
	public static final Class108 aClass108_11 = new Class108(5, 1);

	@OriginalMember(owner = "client!sca", name = "a", descriptor = "(Ljava/lang/String;I)[B")
	public static byte[] method6953(@OriginalArg(0) String arg0) {
