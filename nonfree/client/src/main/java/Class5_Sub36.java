...
public final class Class5_Sub36 extends Class5 {
	...
	private void method4891(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class5_Sub12 local4 = new Class5_Sub12(arg0);
		this.anInt5544 = local4.method5067();
		this.anInt5546 = local4.method5067();
		this.anInt5540 = local4.method5067();
		this.anInt5542 = local4.method5067();
		if (this.anInt5542 < 0) {
			this.anInt5542 = ~this.anInt5542;
			this.aBoolean454 = true;
		}
		@Pc(40) int local40 = local4.method5067();
		this.aByteArrayArray19 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method5115();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method5058(local49, local64);
			this.aByteArrayArray19[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!rm", name = "a", descriptor = "([I)Lclient!dg;")
	public Class5_Sub10_Sub1 method4894(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray86 == null) {
			this.anInt5541 = 0;
			this.aFloatArray22 = new float[Static281.anInt5538];
			this.aByteArray86 = new byte[this.anInt5546];
			this.anInt5549 = 0;
			this.anInt5548 = 0;
		}
		while (this.anInt5548 < this.aByteArrayArray19.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method4895(this.anInt5548);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt5549;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt5546 - local47) {
					local50 = this.anInt5546 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray86[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt5549;
				}
				this.anInt5549 = local47;
			}
			this.anInt5548++;
		}
		this.aFloatArray22 = null;
		@Pc(129) byte[] local129 = this.aByteArray86;
		this.aByteArray86 = null;
		return new Class5_Sub10_Sub1(this.anInt5544, local129, this.anInt5540, this.anInt5542, this.aBoolean454);
	}

	@OriginalMember(owner = "client!rm", name = "d", descriptor = "(I)[F")
	private float[] method4895(@OriginalArg(0) int arg0) {
		Static281.method4890(this.aByteArrayArray19[arg0]);
		Static281.method4889();
		@Pc(15) int local15 = Static281.method4896(Static241.method4295(Static281.anIntArray536.length - 1));
		@Pc(19) boolean local19 = Static281.aBooleanArray20[local15];
		@Pc(25) int local25 = local19 ? Static281.anInt5538 : Static281.anInt5539;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static281.method4889() != 0;
			local29 = Static281.method4889() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static281.anInt5539 >> 2);
			local67 = (local25 >> 2) + (Static281.anInt5539 >> 2);
			local71 = Static281.anInt5539 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static281.anInt5539 >> 2);
			local104 = local25 + (Static281.anInt5539 >> 2) - (local25 >> 2);
			local108 = Static281.anInt5539 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class116 local123 = Static281.aClass116Array1[Static281.anIntArray536[local15]];
		@Pc(126) int local126 = local123.anInt3381;
		@Pc(131) int local131 = local123.anIntArray351[local126];
		@Pc(140) boolean local140 = !Static281.aClass186Array1[local131].method5045();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt3380; local144++) {
			@Pc(152) Class185 local152 = Static281.aClass185Array1[local123.anIntArray352[local144]];
			local154 = Static281.aFloatArray19;
			local152.method5038(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt3381;
			local176 = local123.anIntArray351[local171];
			Static281.aClass186Array1[local176].method5040(Static281.aFloatArray19, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static281.aFloatArray19[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static281.aFloatArray19;
			...
			@Pc(252) float[] local252 = local19 ? Static281.aFloatArray24 : Static281.aFloatArray21;
			@Pc(258) float[] local258 = local19 ? Static281.aFloatArray20 : Static281.aFloatArray25;
			@Pc(264) float[] local264 = local19 ? Static281.aFloatArray26 : Static281.aFloatArray23;
			@Pc(270) int[] local270 = local19 ? Static281.anIntArray535 : Static281.anIntArray534;
			...
			@Pc(486) int local486 = Static241.method4295(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static281.aFloatArray19[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static281.aFloatArray19[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt5541 > 0) {
			local176 = this.anInt5541 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean456) {
				for (local212 = 0; local212 < this.anInt5543; local212++) {
					local1254 = (this.anInt5541 >> 1) + local212;
					local1228[local212] += this.aFloatArray22[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static281.aFloatArray19[local212];
				}
			}
		}
		local154 = this.aFloatArray22;
		this.aFloatArray22 = Static281.aFloatArray19;
		Static281.aFloatArray19 = local154;
		this.anInt5541 = local25;
		this.anInt5543 = local104 - (local25 >> 1);
		this.aBoolean456 = local140;
		return local1228;
	}
}
