...
public final class Static303 {
	...
	public static void method5683(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		@Pc(7) int local7 = 0;
		...
		Static94.method2165(arg2 + arg0, Static332.anIntArrayArray58[arg1], arg3, arg0 - arg2);
		while (local9 > 0) {
			if (local38 < 0) {
				while (local38 < 0) {
					local38 += local63;
			...
			Static94.method2165(local178, Static332.anIntArrayArray58[local170], arg3, local183);
			Static94.method2165(local178, Static332.anIntArrayArray58[local174], arg3, local183);
		}
	}
}
