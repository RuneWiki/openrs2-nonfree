...
public abstract class Class71 {
	...
	private void method7767(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg4 == 0) {
			return;
		}
	...
	public final void method7768(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.method7767(arg0, arg1, (float) this.AA() / 2.0F, (float) this.a() / 2.0F, arg2, arg3, 1, 0);
	}
	...
	public final void method7770(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4) {
		this.method7767(arg0, arg1, (float) this.AA() / 2.0F, (float) this.a() / 2.0F, arg2, arg3, 0, arg4);
	}

	@OriginalMember(owner = "client!xa", name = "a", descriptor = "(FFFFFFLclient!fa;II)V")
	protected abstract void method7771(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) Class17 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8);

	@OriginalMember(owner = "client!xa", name = "a", descriptor = "(FFIILclient!fa;II)V")
	public final void method7772(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Class17 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		this.method7773(arg0, arg1, (float) this.AA() / 2.0F, (float) this.a() / 2.0F, 4096, arg2, arg3, arg4, arg5);
	}
	...
	public final void method7773(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class17 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		if (arg4 == 0) {
			return;
		}
		@Pc(9) double local9 = (double) (arg5 & 0xFFFF) * 9.587379924285257E-5D;
		...
		@Pc(102) float local102 = (-arg2 * local23 + ((float) this.a() - arg3) * local16) / 4096.0F + arg0;
		@Pc(118) float local118 = (arg2 * local16 + ((float) this.a() - arg3) * local23) / 4096.0F + arg1;
		this.method7771(local37, local50, local67, local85, local102, local118, arg6, arg7, arg8);
	}

	@OriginalMember(owner = "client!xa", name = "a", descriptor = "(IIII)V")
	public final void method7774(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	public final void method7775(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public final void method7776(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
