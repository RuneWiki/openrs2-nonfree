...
public final class Class14_Sub53 extends Class14 {
	...
	private int anInt10770;

	@OriginalMember(owner = "client!vt", name = "R", descriptor = "I")
	private int anInt10772;

	@OriginalMember(owner = "client!vt", name = "x", descriptor = "[[B")
	...
	public Class14_Sub53(@OriginalArg(0) byte[] arg0) {
		this.method9192(arg0);
	}

	@OriginalMember(owner = "client!vt", name = "d", descriptor = "(I)[F")
	private float[] method9190(@OriginalArg(0) int arg0) {
		Static659.method9194(this.aByteArrayArray31[arg0]);
		Static659.method9189();
		@Pc(15) int local15 = Static659.method9193(Static220.method3803(Static659.anIntArray577.length - 1));
		@Pc(19) boolean local19 = Static659.aBooleanArray28[local15];
		@Pc(25) int local25 = local19 ? Static659.anInt10771 : Static659.anInt10776;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static659.method9189() != 0;
			local29 = Static659.method9189() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static659.anInt10776 >> 2);
			local67 = (local25 >> 2) + (Static659.anInt10776 >> 2);
			local71 = Static659.anInt10776 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static659.anInt10776 >> 2);
			local104 = local25 + (Static659.anInt10776 >> 2) - (local25 >> 2);
			local108 = Static659.anInt10776 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class91 local123 = Static659.aClass91Array1[Static659.anIntArray577[local15]];
		@Pc(126) int local126 = local123.anInt1940;
		@Pc(131) int local131 = local123.anIntArray110[local126];
		@Pc(140) boolean local140 = !Static659.aClass41Array1[local131].method776();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt1941; local144++) {
			@Pc(152) Class271 local152 = Static659.aClass271Array1[local123.anIntArray111[local144]];
			local154 = Static659.aFloatArray77;
			local152.method6497(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt1940;
			local176 = local123.anIntArray110[local171];
			Static659.aClass41Array1[local176].method777(Static659.aFloatArray77, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static659.aFloatArray77[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static659.aFloatArray77;
			...
			@Pc(252) float[] local252 = local19 ? Static659.aFloatArray73 : Static659.aFloatArray79;
			@Pc(258) float[] local258 = local19 ? Static659.aFloatArray76 : Static659.aFloatArray74;
			@Pc(264) float[] local264 = local19 ? Static659.aFloatArray75 : Static659.aFloatArray78;
			@Pc(270) int[] local270 = local19 ? Static659.anIntArray576 : Static659.anIntArray578;
			...
			@Pc(486) int local486 = Static220.method3803(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static659.aFloatArray77[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static659.aFloatArray77[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt10770 > 0) {
			local176 = this.anInt10770 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean744) {
				for (local212 = 0; local212 < this.anInt10768; local212++) {
					local1254 = (this.anInt10770 >> 1) + local212;
					local1228[local212] += this.aFloatArray80[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static659.aFloatArray77[local212];
				}
			}
		}
		local154 = this.aFloatArray80;
		this.aFloatArray80 = Static659.aFloatArray77;
		Static659.aFloatArray77 = local154;
		this.anInt10770 = local25;
		this.anInt10768 = local104 - (local25 >> 1);
		this.aBoolean744 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!vt", name = "b", descriptor = "([B)V")
	private void method9192(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class14_Sub21 local4 = new Class14_Sub21(arg0);
		this.anInt10773 = local4.method7748();
		this.anInt10772 = local4.method7748();
		this.anInt10767 = local4.method7748();
		this.anInt10774 = local4.method7748();
		if (this.anInt10774 < 0) {
			this.anInt10774 = ~this.anInt10774;
			this.aBoolean746 = true;
		}
		@Pc(40) int local40 = local4.method7748();
		this.aByteArrayArray31 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method7695(99);
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method7750(local49, 0, local64);
			this.aByteArrayArray31[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!vt", name = "a", descriptor = "([I)Lclient!pd;")
	public Class14_Sub19_Sub1 method9197(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray109 == null) {
			this.anInt10770 = 0;
			this.aFloatArray80 = new float[Static659.anInt10771];
			this.aByteArray109 = new byte[this.anInt10772];
			this.anInt10778 = 0;
			this.anInt10777 = 0;
		}
		while (this.anInt10777 < this.aByteArrayArray31.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method9190(this.anInt10777);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt10778;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt10772 - local47) {
					local50 = this.anInt10772 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray109[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt10778;
				}
				this.anInt10778 = local47;
			}
			this.anInt10777++;
		}
		this.aFloatArray80 = null;
		@Pc(129) byte[] local129 = this.aByteArray109;
		this.aByteArray109 = null;
		return new Class14_Sub19_Sub1(this.anInt10773, local129, this.anInt10767, this.anInt10774, this.aBoolean746);
	}
}
