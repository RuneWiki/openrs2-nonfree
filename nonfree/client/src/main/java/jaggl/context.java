...
public final class context {
	...
	@OriginalMember(owner = "client!jaggl/context", name = "getCurrentContext", descriptor = "()Lclient!jaggl/context;", line = 8)
	...
	public boolean isExtensionAvailable(@OriginalArg(0) String arg0) {
		if (this.c == null) {
			@Pc(17) String local17 = this.a.glGetString(7939) + " " + this.getExtensionsString();
	...
	@OriginalMember(owner = "client!jaggl/context", name = "getGL", descriptor = "()Lclient!jaggl/opengl;", line = 86)
	public opengl getGL() {
		return this.a;
	}
