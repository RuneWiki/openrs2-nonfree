...
public final class opengl {
	...
	private static int getIndirectBufferByteOffset(@OriginalArg(0) Buffer arg0) {
		...
		@Pc(8) int local8 = arg0.position();
		if (arg0 instanceof ByteBuffer) {
			return ((ByteBuffer) arg0).arrayOffset() + local8;
		} else if (arg0 instanceof FloatBuffer) {
			return (((FloatBuffer) arg0).arrayOffset() + local8) * 4;
		} else if (arg0 instanceof IntBuffer) {
			return (((IntBuffer) arg0).arrayOffset() + local8) * 4;
		} else if (arg0 instanceof ShortBuffer) {
			return (((ShortBuffer) arg0).arrayOffset() + local8) * 2;
		} else if (arg0 instanceof DoubleBuffer) {
			return (((DoubleBuffer) arg0).arrayOffset() + local8) * 8;
		} else if (arg0 instanceof LongBuffer) {
			return (((LongBuffer) arg0).arrayOffset() + local8) * 8;
		} else if (arg0 instanceof CharBuffer) {
			return (((CharBuffer) arg0).arrayOffset() + local8) * 2;
		} else {
	...
	public native void glTexCoord3f(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2);
	...
	private native void glUniform1i(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1);
	...
	public native void glUniform4fARB(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4);
	...
	private native void glUniform1f(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1);
	...
	public native void glClientActiveTexture(@OriginalArg(0) int arg0);
	...
	private native void glUniform3f(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3);
	...
	public native void glUniform2fARB(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2);
	...
	public native void glUniform1fARB(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1);
