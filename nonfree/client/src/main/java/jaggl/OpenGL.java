...
public final class OpenGL {
	...
	@OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Lclient!jaggl/OpenGL;")
	...
	private static native void glTexSubImage2Df(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) float[] arg8, @OriginalArg(9) int arg9);
	...
	public static native void glBufferSubDataARB(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte[] arg3, @OriginalArg(4) int arg4);
	...
	private static native void glPointSize(@OriginalArg(0) float arg0);
	...
	public boolean isExtensionAvailable(@OriginalArg(0) String arg0) {
		if (this.b == null) {
			...
			while (true) {
				...
				if (local17 == -1) {
					@Pc(49) String local49 = local10.substring(local12).trim();
					if (local49.length() != 0) {
						this.b.put(local49, local49);
					}
					break;
				}
				@Pc(27) String local27 = local10.substring(local12, local17).trim();
				if (local27.length() != 0) {
					this.b.put(local27, local27);
				}
				local12 = local17 + 1;
			}
		}
		return this.b.containsKey(arg0);
	}
	...
	public synchronized boolean attach() {
		...
		@Pc(10) OpenGL local10 = (OpenGL) c.put(local1, this);
		if (local10 != null) {
			local10.a = null;
		}
		this.a = local1;
