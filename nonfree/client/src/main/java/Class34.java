...
public final class Class34 {
	...
	public static int method499(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(5) Class36 local5 = new Class36();
		local5.aByteArray9 = arg2;
		local5.anInt713 = arg4;
		local5.aByteArray10 = arg0;
		local5.anInt717 = 0;
		local5.anInt714 = arg3;
		local5.anInt718 = arg1;
		local5.anInt723 = 0;
		local5.anInt722 = 0;
		local5.anInt715 = 0;
		local5.anInt716 = 0;
		...
		local5.anInt725 = 0;
		method501(local5);
		return arg1 - local5.anInt718;
	}

	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lclient!sb;)V")
	private static void method500(@OriginalArg(0) Class36 arg0) {
		@Pc(4) byte local4 = arg0.aByte42;
		@Pc(7) int local7 = arg0.anInt721;
		@Pc(10) int local10 = arg0.anInt729;
		@Pc(13) int local13 = arg0.anInt728;
		@Pc(15) int[] local15 = Class36.anIntArray216;
		@Pc(18) int local18 = arg0.anInt727;
		@Pc(21) byte[] local21 = arg0.aByteArray10;
		@Pc(24) int local24 = arg0.anInt717;
		@Pc(27) int local27 = arg0.anInt718;
		@Pc(29) int local29 = local27;
		@Pc(34) int local34 = arg0.anInt731 + 1;
		label67: while (true) {
			if (local7 > 0) {
				while (true) {
					if (local27 == 0) {
		...
		@Pc(224) int local224 = arg0.anInt719;
		arg0.anInt719 += local29 - local27;
		if (arg0.anInt719 < local224) {
			arg0.anInt720++;
		}
		arg0.aByte42 = local4;
		arg0.anInt721 = local7;
		arg0.anInt729 = local10;
		arg0.anInt728 = local13;
		Class36.anIntArray216 = local15;
		arg0.anInt727 = local18;
		arg0.aByteArray10 = local21;
		arg0.anInt717 = local24;
		arg0.anInt718 = local27;
	}

	@OriginalMember(owner = "client!rb", name = "b", descriptor = "(Lclient!sb;)V")
	private static void method501(@OriginalArg(0) Class36 arg0) {
		arg0.anInt724 = 1;
		if (Class36.anIntArray216 == null) {
			Class36.anIntArray216 = new int[arg0.anInt724 * 100000];
		}
		@Pc(60) boolean local60 = true;
		while (true) {
			while (local60) {
				@Pc(64) byte local64 = method502(arg0);
				if (local64 == 23) {
					return;
				}
				local64 = method502(arg0);
				local64 = method502(arg0);
				local64 = method502(arg0);
				local64 = method502(arg0);
				local64 = method502(arg0);
				...
				arg0.anInt726 = 0;
				local64 = method502(arg0);
				arg0.anInt726 = arg0.anInt726 << 8 | local64 & 0xFF;
				local64 = method502(arg0);
				arg0.anInt726 = arg0.anInt726 << 8 | local64 & 0xFF;
				local64 = method502(arg0);
				arg0.anInt726 = arg0.anInt726 << 8 | local64 & 0xFF;
				...
				method505(arg0);
				@Pc(244) int local244 = arg0.anInt730 + 2;
				@Pc(248) int local248 = method504(3, arg0);
				@Pc(252) int local252 = method504(15, arg0);
				...
				for (local340 = 0; local340 < local248; local340++) {
					@Pc(346) int local346 = method504(5, arg0);
				...
				for (local340 = 0; local340 < local248; local340++) {
					...
					method506(arg0.anIntArrayArray20[local340], arg0.anIntArrayArray21[local340], arg0.anIntArrayArray22[local340], arg0.aByteArrayArray4[local340], local388, local390, local244);
					arg0.anIntArray218[local340] = local388;
				}
				@Pc(462) int local462 = arg0.anInt730 + 1;
				@Pc(467) int local467 = arg0.anInt724 * 100000;
				...
				for (local557 = method504(local535, arg0); local557 > local540[local553]; local557 = local557 << 1 | local566) {
					local553++;
					local566 = method503(arg0);
				}
				...
				while (true) {
					while (local582 != local462) {
						if (local582 == 0 || local582 == 1) {
							...
							local592++;
							local64 = arg0.aByteArray11[arg0.aByteArray12[arg0.anIntArray217[0]] & 0xFF];
							arg0.anIntArray213[local64 & 0xFF] += local592;
							while (local592 > 0) {
								Class36.anIntArray216[local520] = local64 & 0xFF;
								local520++;
								local592--;
							}
						} else {
							...
							if (local724 < 16) {
								...
								while (local825 > 0) {
									...
									arg0.aByteArray12[arg0.anIntArray217[local825]] = arg0.aByteArray12[arg0.anIntArray217[local825 - 1] + 16 - 1];
									local825--;
								}
								local865 = arg0.anIntArray217[0]--;
								arg0.aByteArray12[arg0.anIntArray217[0]] = local64;
								if (arg0.anIntArray217[0] == 0) {
									...
									for (@Pc(926) int local926 = 15; local926 >= 0; local926--) {
										for (@Pc(930) int local930 = 15; local930 >= 0; local930--) {
											arg0.aByteArray12[local924] = arg0.aByteArray12[arg0.anIntArray217[local926] + local930];
											local924--;
										}
							...
							arg0.anIntArray213[arg0.aByteArray11[local64 & 0xFF] & 0xFF]++;
							Class36.anIntArray216[local520] = arg0.aByteArray11[local64 & 0xFF] & 0xFF;
							local520++;
							if (local551 == 0) {
								local523++;
								local551 = 50;
					...
					for (local164 = 0; local164 < local520; local164++) {
						local64 = (byte) (Class36.anIntArray216[local164] & 0xFF);
						Class36.anIntArray216[arg0.anIntArray214[local64 & 0xFF]] |= local164 << 8;
						arg0.anIntArray214[local64 & 0xFF]++;
					}
					arg0.anInt727 = Class36.anIntArray216[arg0.anInt726] >> 8;
					arg0.anInt729 = 0;
					arg0.anInt727 = Class36.anIntArray216[arg0.anInt727];
					arg0.anInt728 = (byte) (arg0.anInt727 & 0xFF);
					arg0.anInt727 >>= 0x8;
					arg0.anInt729++;
					arg0.anInt731 = local520;
					method500(arg0);
					if (arg0.anInt729 == arg0.anInt731 + 1 && arg0.anInt721 == 0) {
						local60 = true;
						break;
					}
					local60 = false;
	...
	private static byte method502(@OriginalArg(0) Class36 arg0) {
		return (byte) method504(8, arg0);
	}

	@OriginalMember(owner = "client!rb", name = "d", descriptor = "(Lclient!sb;)B")
	private static byte method503(@OriginalArg(0) Class36 arg0) {
		return (byte) method504(1, arg0);
	}

	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILclient!sb;)I")
	private static int method504(@OriginalArg(0) int arg0, @OriginalArg(1) Class36 arg1) {
		while (arg1.anInt723 < arg0) {
			arg1.anInt722 = arg1.anInt722 << 8 | arg1.aByteArray9[arg1.anInt713] & 0xFF;
			arg1.anInt723 += 8;
			arg1.anInt713++;
			arg1.anInt714--;
			arg1.anInt715++;
		...
		@Pc(17) int local17 = arg1.anInt722 >> arg1.anInt723 - arg0 & (0x1 << arg0) - 1;
		arg1.anInt723 -= arg0;
		return local17;
	}

	@OriginalMember(owner = "client!rb", name = "e", descriptor = "(Lclient!sb;)V")
	private static void method505(@OriginalArg(0) Class36 arg0) {
		arg0.anInt730 = 0;
		for (@Pc(4) int local4 = 0; local4 < 256; local4++) {
			if (arg0.aBooleanArray5[local4]) {
				arg0.aByteArray11[arg0.anInt730] = (byte) local4;
				arg0.anInt730++;
			}
		}
	}
	...
	private static void method506(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) byte[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(3) int local3 = 0;
		@Pc(5) int local5;
