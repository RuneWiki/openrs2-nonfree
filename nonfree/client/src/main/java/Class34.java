...
public final class Class34 {
	...
	public static int method511(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(3) Class36 local3 = aClass36_1;
		synchronized (aClass36_1) {
			aClass36_1.aByteArray8 = arg2;
			aClass36_1.anInt723 = arg4;
			aClass36_1.aByteArray9 = arg0;
			aClass36_1.anInt727 = 0;
			aClass36_1.anInt724 = arg3;
			aClass36_1.anInt728 = arg1;
			aClass36_1.anInt733 = 0;
			aClass36_1.anInt732 = 0;
			aClass36_1.anInt725 = 0;
			aClass36_1.anInt726 = 0;
			aClass36_1.anInt729 = 0;
			aClass36_1.anInt730 = 0;
			aClass36_1.anInt735 = 0;
			method513(aClass36_1);
			return arg1 - aClass36_1.anInt728;
		}
	}

	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lclient!sb;)V")
	private static void method512(@OriginalArg(0) Class36 arg0) {
		@Pc(4) byte local4 = arg0.aByte58;
		@Pc(7) int local7 = arg0.anInt731;
		@Pc(10) int local10 = arg0.anInt739;
		@Pc(13) int local13 = arg0.anInt738;
		@Pc(15) int[] local15 = Class36.anIntArray216;
		@Pc(18) int local18 = arg0.anInt737;
		@Pc(21) byte[] local21 = arg0.aByteArray9;
		@Pc(24) int local24 = arg0.anInt727;
		@Pc(27) int local27 = arg0.anInt728;
		@Pc(29) int local29 = local27;
		@Pc(34) int local34 = arg0.anInt741 + 1;
		label67: while (true) {
			if (local7 > 0) {
				while (true) {
					if (local27 == 0) {
		...
		@Pc(224) int local224 = arg0.anInt729;
		arg0.anInt729 += local29 - local27;
		if (arg0.anInt729 < local224) {
			arg0.anInt730++;
		}
		arg0.aByte58 = local4;
		arg0.anInt731 = local7;
		arg0.anInt739 = local10;
		arg0.anInt738 = local13;
		Class36.anIntArray216 = local15;
		arg0.anInt737 = local18;
		arg0.aByteArray9 = local21;
		arg0.anInt727 = local24;
		arg0.anInt728 = local27;
	}

	@OriginalMember(owner = "client!rb", name = "b", descriptor = "(Lclient!sb;)V")
	private static void method513(@OriginalArg(0) Class36 arg0) {
		arg0.anInt734 = 1;
		if (Class36.anIntArray216 == null) {
			Class36.anIntArray216 = new int[arg0.anInt734 * 100000];
		}
		@Pc(60) boolean local60 = true;
		while (true) {
			while (local60) {
				@Pc(64) byte local64 = method514(arg0);
				if (local64 == 23) {
					return;
				}
				local64 = method514(arg0);
				local64 = method514(arg0);
				local64 = method514(arg0);
				local64 = method514(arg0);
				local64 = method514(arg0);
				...
				arg0.anInt736 = 0;
				local64 = method514(arg0);
				arg0.anInt736 = arg0.anInt736 << 8 | local64 & 0xFF;
				local64 = method514(arg0);
				arg0.anInt736 = arg0.anInt736 << 8 | local64 & 0xFF;
				local64 = method514(arg0);
				arg0.anInt736 = arg0.anInt736 << 8 | local64 & 0xFF;
				...
				method517(arg0);
				@Pc(244) int local244 = arg0.anInt740 + 2;
				@Pc(248) int local248 = method516(3, arg0);
				@Pc(252) int local252 = method516(15, arg0);
				...
				for (local340 = 0; local340 < local248; local340++) {
					@Pc(346) int local346 = method516(5, arg0);
				...
				for (local340 = 0; local340 < local248; local340++) {
					...
					method518(arg0.anIntArrayArray20[local340], arg0.anIntArrayArray21[local340], arg0.anIntArrayArray22[local340], arg0.aByteArrayArray4[local340], local388, local390, local244);
					arg0.anIntArray218[local340] = local388;
				}
				@Pc(462) int local462 = arg0.anInt740 + 1;
				@Pc(467) int local467 = arg0.anInt734 * 100000;
				...
				for (local557 = method516(local535, arg0); local557 > local540[local553]; local557 = local557 << 1 | local566) {
					local553++;
					local566 = method515(arg0);
				}
				...
				while (true) {
					while (local582 != local462) {
						if (local582 == 0 || local582 == 1) {
							...
							Class36.anIntArray216[local520] = arg0.aByteArray10[local64 & 0xFF] & 0xFF;
							local520++;
							if (local551 == 0) {
								local523++;
								local551 = 50;
					...
					arg0.anInt737 = Class36.anIntArray216[arg0.anInt736] >> 8;
					arg0.anInt739 = 0;
					arg0.anInt737 = Class36.anIntArray216[arg0.anInt737];
					arg0.anInt738 = (byte) (arg0.anInt737 & 0xFF);
					arg0.anInt737 >>= 0x8;
					arg0.anInt739++;
					arg0.anInt741 = local520;
					method512(arg0);
					if (arg0.anInt739 == arg0.anInt741 + 1 && arg0.anInt731 == 0) {
						local60 = true;
						break;
					}
					local60 = false;
	...
	private static byte method514(@OriginalArg(0) Class36 arg0) {
		return (byte) method516(8, arg0);
	}

	@OriginalMember(owner = "client!rb", name = "d", descriptor = "(Lclient!sb;)B")
	private static byte method515(@OriginalArg(0) Class36 arg0) {
		return (byte) method516(1, arg0);
	}

	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILclient!sb;)I")
	private static int method516(@OriginalArg(0) int arg0, @OriginalArg(1) Class36 arg1) {
		while (arg1.anInt733 < arg0) {
			arg1.anInt732 = arg1.anInt732 << 8 | arg1.aByteArray8[arg1.anInt723] & 0xFF;
			arg1.anInt733 += 8;
			arg1.anInt723++;
			arg1.anInt724--;
			arg1.anInt725++;
		...
		@Pc(17) int local17 = arg1.anInt732 >> arg1.anInt733 - arg0 & (0x1 << arg0) - 1;
		arg1.anInt733 -= arg0;
		return local17;
	}

	@OriginalMember(owner = "client!rb", name = "e", descriptor = "(Lclient!sb;)V")
	private static void method517(@OriginalArg(0) Class36 arg0) {
		arg0.anInt740 = 0;
		for (@Pc(4) int local4 = 0; local4 < 256; local4++) {
			if (arg0.aBooleanArray5[local4]) {
				arg0.aByteArray10[arg0.anInt740] = (byte) local4;
				arg0.anInt740++;
			}
		}
	}
	...
	private static void method518(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) byte[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(3) int local3 = 0;
		@Pc(5) int local5;
