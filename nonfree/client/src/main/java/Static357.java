...
public final class Static357 {
	...
	@OriginalMember(owner = "client!ei", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!ei;II)I")
	public static int method1497(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub6_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1569 -= arg10.anInt1574 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt1569 += arg10.anInt1574 * local63;
		arg10.anInt1567 = arg4;
		arg10.anInt1575 = arg5;
		arg10.anInt1566 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lclient!eg;II)Lclient!ei;")
	public static Class1_Sub6_Sub3 method1498(@OriginalArg(0) Class1_Sub12_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray22 == null || arg0.aByteArray22.length == 0 ? null : new Class1_Sub6_Sub3(arg0, (int) ((long) arg0.anInt1553 * 256L * (long) 100 / (long) (Static184.anInt3834 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!ei", name = "a", descriptor = "(II[B[IIIIIIIILclient!ei;II)I")
	public static int method1502(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub6_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1567 -= arg8.anInt1568 * arg3;
		arg8.anInt1575 -= arg8.anInt1571 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ei", name = "b", descriptor = "(II[B[IIIIIIIILclient!ei;II)I")
	public static int method1506(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub6_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1567 -= arg8.anInt1568 * arg3;
		arg8.anInt1575 -= arg8.anInt1571 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ei", name = "a", descriptor = "([B[IIIIIIIILclient!ei;)I")
	public static int method1507(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub6_Sub3 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt1567 += arg8.anInt1568 * (local22 - arg3);
		arg8.anInt1575 += arg8.anInt1571 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt1569 = arg4 >> 2;
		arg8.anInt1566 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ei", name = "a", descriptor = "(I[B[IIIIIIIILclient!ei;)I")
	public static int method1508(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub6_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
	...
	@OriginalMember(owner = "client!ei", name = "a", descriptor = "([B[IIIIIIILclient!ei;)I")
	public static int method1509(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub6_Sub3 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt1566 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ei", name = "b", descriptor = "(II)I")
	public static int method1510(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ei", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!ei;)I")
	public static int method1511(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub6_Sub3 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt1569 += arg10.anInt1574 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt1567 = arg4 >> 2;
		arg10.anInt1575 = arg5 >> 2;
		arg10.anInt1566 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!ei", name = "a", descriptor = "(II[B[IIIIIIILclient!ei;II)I")
	public static int method1515(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub6_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	public static int method1517(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ei", name = "c", descriptor = "(II[B[IIIIIIIILclient!ei;II)I")
	public static int method1522(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub6_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ei", name = "b", descriptor = "([B[IIIIIIILclient!ei;)I")
	public static int method1525(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub6_Sub3 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!ei", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!ei;II)I")
	public static int method1527(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub6_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1569 -= arg10.anInt1574 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!ei", name = "b", descriptor = "(II[B[IIIIIIILclient!ei;II)I")
	public static int method1529(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub6_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lclient!eg;III)Lclient!ei;")
	public static Class1_Sub6_Sub3 method1530(@OriginalArg(0) Class1_Sub12_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray22 == null || arg0.aByteArray22.length == 0 ? null : new Class1_Sub6_Sub3(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!ei", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!ei;)I")
	public static int method1531(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub6_Sub3 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt1569 += arg10.anInt1574 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!ei", name = "d", descriptor = "(II[B[IIIIIIIILclient!ei;II)I")
	public static int method1532(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub6_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ei", name = "b", descriptor = "([B[IIIIIIIILclient!ei;)I")
	public static int method1533(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub6_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1567 += arg8.anInt1568 * (local24 - arg3);
		arg8.anInt1575 += arg8.anInt1571 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!ei", name = "b", descriptor = "(I[B[IIIIIIIILclient!ei;)I")
	public static int method1536(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub6_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
