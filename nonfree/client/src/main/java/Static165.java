...
public final class Static165 {
	...
	public static int method2674(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = -1;
		for (@Pc(3) int local3 = 0; local3 < Static535.anInt9236 - 1; local3++) {
			if (arg0 < Static133.anIntArray213[local3] + Static230.anIntArray334[local3]) {
				local1 = local3;
				break;
			}
		}
		if (local1 == -1) {
			local1 = Static535.anInt9236 - 1;
		}
		return local1;
	}
}
