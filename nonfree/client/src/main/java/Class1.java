...
public final class Class1 implements Interface1 {
	...
	public Class1() {
		if (this.anInt2 < 0 && (Static283.aBoolean400 && Static283.anInt5683 >= 2)) {
			@Pc(19) int[] local19 = new int[1];
			@Pc(21) GL local21 = Static283.aGL1;
			local21.glGenProgramsARB(1, local19, 0);
			this.anInt1 = local19[0];
			@Pc(42) int[][] local42 = Static254.method4304(0.4F);
			@Pc(53) int[][] local53 = Static254.method4304(0.4F);
			@Pc(58) Class3_Sub26 local58 = new Class3_Sub26(262144);
			for (@Pc(60) int local60 = 0; local60 < 256; local60++) {
				...
				for (@Pc(73) int local73 = 0; local73 < 64; local73++) {
					if (Static283.aBoolean403) {
						local58.method3933((float) local67[local73] / 4096.0F);
						local58.method3933((float) local71[local73] / 4096.0F);
						local58.method3933(1.0F);
						local58.method3933(1.0F);
					} else {
						local58.method3934((float) local67[local73] / 4096.0F);
						local58.method3934((float) local71[local73] / 4096.0F);
						local58.method3934(1.0F);
						local58.method3934(1.0F);
					}
				}
			}
			@Pc(141) ByteBuffer local141 = ByteBuffer.allocateDirect(local58.anInt4615).order(ByteOrder.nativeOrder());
			local141.put(local58.aByteArray64, 0, local58.anInt4615);
			local141.flip();
	...
	public void method3984() {
		if (this.anInt2 >= 0) {
			...
			local5.glCallList(this.anInt2 + 1);
		}
	}
	...
	public void method3983() {
		...
		@Pc(5) GL local5 = Static283.aGL1;
		local5.glCallList(this.anInt2);
		local5.glActiveTexture(33985);
		local5.glMatrixMode(5890);
		local5.glTranslatef((float) Static136.anInt2621, (float) Static246.anInt4983, (float) Static313.anInt6125);
		...
		if (!Static8.aBoolean15) {
			local5.glBindTexture(3553, Static8.anIntArray13[(int) ((float) (Static283.anInt5687 * 64) * 0.005F) % 64]);
		}
		local5.glActiveTexture(33984);
		if (this.anInt3 == Static283.anInt5687) {
			return;
		}
		@Pc(85) int local85 = (Static283.anInt5687 & 0xFF) * 256;
		...
		if (Static8.aBoolean15) {
			local5.glProgramLocalParameter4fARB(34336, 65, (float) Static283.anInt5687 * 0.005F, 0.0F, 0.0F, 1.0F);
		} else {
			local5.glProgramLocalParameter4fARB(34336, 65, 0.0F, 0.0F, 0.0F, 1.0F);
		}
		this.anInt3 = Static283.anInt5687;
	}
	...
	public void method3985(@OriginalArg(0) int arg0) {
		...
		local5.glActiveTexture(33985);
		if ((arg0 & 0x80) == 0) {
			local5.glEnable(Static8.aBoolean15 ? 32879 : 3553);
		} else {
			local5.glDisable(Static8.aBoolean15 ? 32879 : 3553);
		}
		local5.glActiveTexture(33984);
		if ((arg0 & 0x40) == 0) {
			local5.glGetFloatv(2899, Static1.aFloatArray1, 0);
			local5.glProgramLocalParameter4fvARB(34336, 66, Static1.aFloatArray1, 0);
		} else {
	...
	private void method10() {
		...
		this.anInt2 = local1.glGenLists(2);
		local1.glNewList(this.anInt2, 4864);
		...
		local1.glBindProgramARB(34336, this.anInt1);
		local1.glEnable(34336);
		local1.glEndList();
		local1.glNewList(this.anInt2 + 1, 4864);
		local1.glActiveTexture(33985);
		...
		local1.glDisable(Static8.aBoolean15 ? 32879 : 3553);
		local1.glActiveTexture(33984);
	...
	private void method11() {
		...
		local4.glBindProgramARB(34336, this.anInt1);
