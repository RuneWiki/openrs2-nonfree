...
public final class Static402 {
	...
	@OriginalMember(owner = "client!lr", name = "a", descriptor = "([B[IIIIIIIILclient!lr;)I")
	public static int method3391(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub2_Sub2 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt3719 += arg8.anInt3707 * (local22 - arg3);
		arg8.anInt3710 += arg8.anInt3718 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt3720 = arg4 >> 2;
		arg8.anInt3717 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!lr", name = "a", descriptor = "(II[B[IIIIIIIILclient!lr;II)I")
	public static int method3392(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub2_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lclient!qq;III)Lclient!lr;")
	public static Class2_Sub2_Sub2 method3394(@OriginalArg(0) Class2_Sub15_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray99 == null || arg0.aByteArray99.length == 0 ? null : new Class2_Sub2_Sub2(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!lr", name = "b", descriptor = "(II[B[IIIIIIIILclient!lr;II)I")
	public static int method3395(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub2_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt3719 -= arg8.anInt3707 * arg3;
		arg8.anInt3710 -= arg8.anInt3718 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!lr", name = "a", descriptor = "(II[B[IIIIIIILclient!lr;II)I")
	public static int method3401(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub2_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!lr", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!lr;)I")
	public static int method3402(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub2_Sub2 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt3720 += arg10.anInt3709 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt3719 = arg4 >> 2;
		arg10.anInt3710 = arg5 >> 2;
		arg10.anInt3717 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!lr", name = "a", descriptor = "(I[B[IIIIIIIILclient!lr;)I")
	public static int method3408(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub2_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
	...
	public static int method3409(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!lr", name = "a", descriptor = "([B[IIIIIIILclient!lr;)I")
	public static int method3411(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub2_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt3717 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!lr", name = "c", descriptor = "(II[B[IIIIIIIILclient!lr;II)I")
	public static int method3413(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub2_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!lr", name = "b", descriptor = "(II[B[IIIIIIILclient!lr;II)I")
	public static int method3416(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub2_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!lr", name = "b", descriptor = "([B[IIIIIIIILclient!lr;)I")
	public static int method3417(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub2_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt3719 += arg8.anInt3707 * (local24 - arg3);
		arg8.anInt3710 += arg8.anInt3718 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lclient!qq;II)Lclient!lr;")
	public static Class2_Sub2_Sub2 method3420(@OriginalArg(0) Class2_Sub15_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray99 == null || arg0.aByteArray99.length == 0 ? null : new Class2_Sub2_Sub2(arg0, (int) ((long) arg0.anInt4953 * 256L * (long) 100 / (long) (Static42.anInt4820 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!lr", name = "b", descriptor = "(I[B[IIIIIIIILclient!lr;)I")
	public static int method3422(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub2_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!lr", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!lr;)I")
	public static int method3423(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub2_Sub2 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt3720 += arg10.anInt3709 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!lr", name = "d", descriptor = "(II[B[IIIIIIIILclient!lr;II)I")
	public static int method3424(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub2_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt3719 -= arg8.anInt3707 * arg3;
		arg8.anInt3710 -= arg8.anInt3718 * arg3;
		@Pc(32) int local32;
	...
	public static int method3425(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub2_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		...
		local63 = arg3 >> 1;
		arg10.anInt3720 += arg10.anInt3709 * local63;
		arg10.anInt3719 = arg4;
		arg10.anInt3710 = arg5;
		arg10.anInt3717 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!lr", name = "b", descriptor = "([B[IIIIIIILclient!lr;)I")
	public static int method3426(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub2_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!lr", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!lr;II)I")
	public static int method3428(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub2_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt3720 -= arg10.anInt3709 * arg3;
		@Pc(23) int local23;
