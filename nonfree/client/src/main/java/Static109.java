...
public final class Static109 {
	...
	public static Pix32[] aClass4_Sub1_Sub2_Sub2Array4;

	@OriginalMember(owner = "client!sf", name = "b", descriptor = "Lclient!ec;")
	public static JagString aClass22_70 = null;

	@OriginalMember(owner = "client!sf", name = "c", descriptor = "Lclient!ec;")
	public static JagString aClass22_71 = Static60.method1113("Hidden)2use");

	@OriginalMember(owner = "client!sf", name = "d", descriptor = "Lclient!ec;")
	public static JagString aClass22_72 = Static60.method1113("mn");

	@OriginalMember(owner = "client!sf", name = "j", descriptor = "Lclient!ec;")
	private static JagString aClass22_75 = Static60.method1113("Please wait)3)3)3");

	@OriginalMember(owner = "client!sf", name = "g", descriptor = "Lclient!ec;")
	public static JagString aClass22_73 = aClass22_75;

	@OriginalMember(owner = "client!sf", name = "h", descriptor = "Lclient!ec;")
	public static JagString aClass22_74 = Static60.method1113("Bitte benutzen Sie eine andere Welt)3");

	@OriginalMember(owner = "client!sf", name = "a", descriptor = "(IIIILclient!h;Z)V")
	public static void method149(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Pix32 arg4) {
		...
		@Pc(45) int local45 = Pix3D.anIntArray12[local41];
		@Pc(53) int local53 = local45 * 256 / (Static25.anInt574 + 256);
		@Pc(57) int local57 = Pix3D.anIntArray9[local41];
	...
	public static int method151(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3) {
		@Pc(15) int local15 = 65536 - Pix3D.anIntArray12[arg1 * 1024 / arg0] >> 1;
