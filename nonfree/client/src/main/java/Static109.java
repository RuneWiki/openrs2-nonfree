...
public final class Static109 {
	...
	private static final short[][] aShortArrayArray5 = new short[][] { new short[0], new short[0], new short[0], new short[0], new short[0] };
	...
	public static final short[][][] aShortArrayArrayArray2 = new short[][][] { aShortArrayArray6, aShortArrayArray5, aShortArrayArray4 };

	@OriginalMember(owner = "client!dka", name = "bb", descriptor = "[I")
	public static final int[] anIntArray169 = new int[25];
}
