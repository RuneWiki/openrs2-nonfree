...
public final class Class101 {
	...
	public Class101() throws Exception {
	...
	private void enter(@OriginalArg(0) Frame arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (arg4 == 0) {
			...
			for (@Pc(36) int local36 = 0; local36 < local32.length; local36++) {
				if (arg1 == local32[local36].getWidth() && arg2 == local32[local36].getHeight() && arg3 == local32[local36].getBitDepth()) {
					@Pc(68) int local68 = local32[local36].getRefreshRate();
					if (!local34 || Math.abs(local68 - local28) < Math.abs(arg4 - local28)) {
						arg4 = local68;
						local34 = true;
					}
				}
	...
	private void method2115(@OriginalArg(0) byte arg0, @OriginalArg(1) Frame arg1) {
