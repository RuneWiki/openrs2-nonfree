...
public final class Static155 {
	...
	@OriginalMember(owner = "client!eo", name = "h", descriptor = "Lclient!vn;")
	public static Class3_Sub22_Sub4 aClass3_Sub22_Sub4_1;

	@OriginalMember(owner = "client!eo", name = "n", descriptor = "Lclient!bt;")
	public static Class38 aClass38_3;

	@OriginalMember(owner = "client!eo", name = "q", descriptor = "Lclient!rj;")
	public static final Class320 aClass320_4 = new Class320();

	@OriginalMember(owner = "client!eo", name = "g", descriptor = "[I")
	public static final int[] anIntArray137 = new int[] { 1, 0, -1, 0 };

	@OriginalMember(owner = "client!eo", name = "f", descriptor = "[I")
	public static final int[] anIntArray138 = new int[1];

	@OriginalMember(owner = "client!eo", name = "a", descriptor = "(II)Lclient!wf;")
	public static Class3_Sub2 method2464(@OriginalArg(1) int arg0) {
		if (arg0 == 0) {
