...
public final class Static309 {
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(I[B[IIIIIIIILclient!t;)I")
	public static int method3711(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class8_Sub8_Sub4 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt4954 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!t", name = "a", descriptor = "(II)I")
	public static int method3712(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!t", name = "a", descriptor = "(II[B[IIIIIIIILclient!t;II)I")
	public static int method3714(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class8_Sub8_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "([B[IIIIIIIILclient!t;)I")
	public static int method3720(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class8_Sub8_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt4944 += arg8.anInt4943 * (local22 - arg3);
		arg8.anInt4942 += arg8.anInt4955 * (local22 - arg3);
		local22 -= 3;
		@Pc(54) int local54;
		while (arg3 < local22) {
			local54 = arg3++;
		...
		arg8.anInt4951 = arg4 >> 2;
		arg8.anInt4954 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!t", name = "b", descriptor = "(II)I")
	public static int method3722(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!t", name = "b", descriptor = "(II[B[IIIIIIIILclient!t;II)I")
	public static int method3723(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class8_Sub8_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "([B[IIIIIIILclient!t;)I")
	public static int method3724(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class8_Sub8_Sub4 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt4954 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!t", name = "c", descriptor = "(II[B[IIIIIIIILclient!t;II)I")
	public static int method3726(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class8_Sub8_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt4944 -= arg8.anInt4943 * arg3;
		arg8.anInt4942 -= arg8.anInt4955 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!rk;II)Lclient!t;")
	public static Class8_Sub8_Sub4 method3729(@OriginalArg(0) Class8_Sub20_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray47 == null || arg0.aByteArray47.length == 0 ? null : new Class8_Sub8_Sub4(arg0, (int) ((long) arg0.anInt4698 * 256L * (long) 100 / (long) (Static264.anInt5577 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!t", name = "b", descriptor = "([B[IIIIIIIILclient!t;)I")
	public static int method3733(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class8_Sub8_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt4944 += arg8.anInt4943 * (local24 - arg3);
		arg8.anInt4942 += arg8.anInt4955 * (local24 - arg3);
		local24 -= 3;
		@Pc(56) int local56;
		while (arg3 < local24) {
			local56 = arg3++;
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!t;)I")
	public static int method3735(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class8_Sub8_Sub4 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt4951 += arg10.anInt4952 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(64) byte local64;
		...
		arg10.anInt4944 = arg4 >> 2;
		arg10.anInt4942 = arg5 >> 2;
		arg10.anInt4954 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!t", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!t;)I")
	public static int method3736(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class8_Sub8_Sub4 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt4951 += arg10.anInt4952 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!rk;III)Lclient!t;")
	public static Class8_Sub8_Sub4 method3740(@OriginalArg(0) Class8_Sub20_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray47 == null || arg0.aByteArray47.length == 0 ? null : new Class8_Sub8_Sub4(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!t", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!t;II)I")
	public static int method3741(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class8_Sub8_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt4951 -= arg10.anInt4952 * arg3;
		@Pc(23) int local23;
		...
		local65 = arg3 >> 1;
		arg10.anInt4951 += arg10.anInt4952 * local65;
		arg10.anInt4944 = arg4;
		arg10.anInt4942 = arg5;
		arg10.anInt4954 = arg2;
		return local65;
	}

	@OriginalMember(owner = "client!t", name = "b", descriptor = "(I[B[IIIIIIIILclient!t;)I")
	public static int method3742(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class8_Sub8_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(II[B[IIIIIIILclient!t;II)I")
	public static int method3743(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class8_Sub8_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!t", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!t;II)I")
	public static int method3744(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class8_Sub8_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt4951 -= arg10.anInt4952 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!t", name = "b", descriptor = "(II[B[IIIIIIILclient!t;II)I")
	public static int method3745(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class8_Sub8_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!t", name = "d", descriptor = "(II[B[IIIIIIIILclient!t;II)I")
	public static int method3747(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class8_Sub8_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt4944 -= arg8.anInt4943 * arg3;
		arg8.anInt4942 -= arg8.anInt4955 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!t", name = "b", descriptor = "([B[IIIIIIILclient!t;)I")
	public static int method3749(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class8_Sub8_Sub4 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
