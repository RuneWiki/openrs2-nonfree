...
public final class Static647 {
	...
	@OriginalMember(owner = "client!iq", name = "a", descriptor = "([B[IIIIIIILclient!iq;)I")
	public static int method4039(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub7_Sub3 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt4588 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!iq", name = "a", descriptor = "(II[B[IIIIIIIILclient!iq;II)I")
	public static int method4041(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub7_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt4586 -= arg8.anInt4590 * arg3;
		arg8.anInt4597 -= arg8.anInt4593 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!iq", name = "a", descriptor = "(I[B[IIIIIIIILclient!iq;)I")
	public static int method4042(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub7_Sub3 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt4588 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!iq", name = "a", descriptor = "([B[IIIIIIIILclient!iq;)I")
	public static int method4046(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub7_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt4586 += arg8.anInt4590 * (local22 - arg3);
		arg8.anInt4597 += arg8.anInt4593 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt4589 = arg4 >> 2;
		arg8.anInt4588 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!iq", name = "b", descriptor = "(I[B[IIIIIIIILclient!iq;)I")
	public static int method4049(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub7_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!iq", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!iq;)I")
	public static int method4051(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub7_Sub3 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt4589 += arg10.anInt4584 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt4586 = arg4 >> 2;
		arg10.anInt4597 = arg5 >> 2;
		arg10.anInt4588 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!iq", name = "a", descriptor = "(II[B[IIIIIIILclient!iq;II)I")
	public static int method4052(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub7_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!iq", name = "b", descriptor = "([B[IIIIIIIILclient!iq;)I")
	public static int method4054(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub7_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt4586 += arg8.anInt4590 * (local24 - arg3);
		arg8.anInt4597 += arg8.anInt4593 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	public static int method4057(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lclient!jda;III)Lclient!iq;")
	public static Class3_Sub7_Sub3 method4058(@OriginalArg(0) Class3_Sub30_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray55 == null || arg0.aByteArray55.length == 0 ? null : new Class3_Sub7_Sub3(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!iq", name = "b", descriptor = "(II[B[IIIIIIIILclient!iq;II)I")
	public static int method4059(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub7_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt4586 -= arg8.anInt4590 * arg3;
		arg8.anInt4597 -= arg8.anInt4593 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!iq", name = "b", descriptor = "(II[B[IIIIIIILclient!iq;II)I")
	public static int method4060(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub7_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!iq", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!iq;)I")
	public static int method4062(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub7_Sub3 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt4589 += arg10.anInt4584 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!iq", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!iq;II)I")
	public static int method4066(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub7_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt4589 -= arg10.anInt4584 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt4589 += arg10.anInt4584 * local63;
		arg10.anInt4586 = arg4;
		arg10.anInt4597 = arg5;
		arg10.anInt4588 = arg2;
		return local63;
	}
	...
	@OriginalMember(owner = "client!iq", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!iq;II)I")
	public static int method4071(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub7_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt4589 -= arg10.anInt4584 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!iq", name = "b", descriptor = "([B[IIIIIIILclient!iq;)I")
	public static int method4075(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub7_Sub3 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!iq", name = "c", descriptor = "(II[B[IIIIIIIILclient!iq;II)I")
	public static int method4076(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub7_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!iq", name = "d", descriptor = "(II[B[IIIIIIIILclient!iq;II)I")
	public static int method4078(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub7_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
