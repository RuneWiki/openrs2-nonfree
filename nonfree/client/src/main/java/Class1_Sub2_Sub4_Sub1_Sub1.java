...
public final class Class1_Sub2_Sub4_Sub1_Sub1 extends Class1_Sub2_Sub4_Sub1 {

	@OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(II)V")
	public Class1_Sub2_Sub4_Sub1_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(IIIIII[I)V")
	public Class1_Sub2_Sub4_Sub1_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int[] arg6) {
		...
		try {
			...
			for (@Pc(71) int local71 = 0; local71 < arg3; local71++) {
				...
				for (@Pc(97) int local97 = -arg9[local71]; local97 < 0; local97++) {
					@Pc(112) int local112 = super.anIntArray94[(local86 >> 16) + (local92 >> 16) * super.anInt1292];
					@Pc(116) int local116 = Static189.anIntArray319[local80];
					@Pc(120) int local120 = local112 >>> 24;
					@Pc(124) int local124 = 256 - local120;
					Static189.anIntArray319[local80++] = ((local112 & 0xFF00FF) * local120 + (local116 & 0xFF00FF) * local124 & 0xFF00FF00) + ((local112 & 0xFF00) * local120 + (local116 & 0xFF00) * local124 & 0xFF0000) >>> 8;
					local86 += local39;
					local92 -= local33;
				}
				local51 += local33;
		...
		if (local338 != 0) {
			...
			if (local338 < 0) {
				if (local329 == 0) {
					...
					while (local380 < 0) {
						...
						if (local374 >= 0 && local374 - (super.anInt1291 << 12) < 0) {
							@Pc(810) int local810;
							if ((local810 = local789 - (super.anInt1292 << 12)) >= 0) {
							...
							while (local389 < 0) {
								local422 = super.anIntArray94[(local374 >> 12) * super.anInt1292 + (local789 >> 12)];
								local426 = Static189.anIntArray319[local383];
								local430 = local422 >>> 24;
								local434 = 256 - local430;
								Static189.anIntArray319[local383++] = ((local422 & 0xFF00FF) * local430 + (local426 & 0xFF00FF) * local434 & 0xFF00FF00) + ((local422 & 0xFF00) * local430 + (local426 & 0xFF00) * local434 & 0xFF0000) >>> 8;
								local789 += local338;
								local389++;
							}
						}
					...
					while (local380 < 0) {
						...
						local389 = local162;
						@Pc(954) int local954;
						if ((local954 = local789 - (super.anInt1292 << 12)) >= 0) {
						...
						if ((local1000 = local495 - (super.anInt1291 << 12)) >= 0) {
						...
						while (local389 < 0) {
							local422 = super.anIntArray94[(local495 >> 12) * super.anInt1292 + (local789 >> 12)];
							local426 = Static189.anIntArray319[local383];
							local430 = local422 >>> 24;
							local434 = 256 - local430;
							Static189.anIntArray319[local383++] = ((local422 & 0xFF00FF) * local430 + (local426 & 0xFF00FF) * local434 & 0xFF00FF00) + ((local422 & 0xFF00) * local430 + (local426 & 0xFF00) * local434 & 0xFF0000) >>> 8;
					...
					while (local380 < 0) {
						...
						if ((local1156 = local789 - (super.anInt1292 << 12)) >= 0) {
						...
						if ((local1238 = (local495 + 1 - (super.anInt1291 << 12) - local329) / local329) > local389) {
							local389 = local1238;
						}
						while (local389 < 0) {
							local422 = super.anIntArray94[(local495 >> 12) * super.anInt1292 + (local789 >> 12)];
				...
				while (local380 < 0) {
					...
					if (local374 >= 0 && local374 - (super.anInt1291 << 12) < 0) {
						...
						if ((local1395 = (local789 + 1 - (super.anInt1292 << 12) - local338) / local338) > local389) {
							local389 = local1395;
						}
						while (local389 < 0) {
							local422 = super.anIntArray94[(local374 >> 12) * super.anInt1292 + (local789 >> 12)];
				...
				while (local380 < 0) {
					...
					if ((local1547 = (local789 + 1 - (super.anInt1292 << 12) - local338) / local338) > local389) {
						local389 = local1547;
					}
					@Pc(1559) int local1559;
					if ((local1559 = local495 - (super.anInt1291 << 12)) >= 0) {
				...
				while (local380 < 0) {
					...
					if ((local1751 = (local789 + 1 - (super.anInt1292 << 12) - local338) / local338) > local389) {
						local389 = local1751;
					}
					if (local495 < 0) {
						local521 = (local329 - local495 - 1) / local329;
					...
					if ((local1799 = (local495 + 1 - (super.anInt1291 << 12) - local329) / local329) > local389) {
						local389 = local1799;
					}
					while (local389 < 0) {
						local422 = super.anIntArray94[(local495 >> 12) * super.anInt1292 + (local789 >> 12)];
			...
			while (local380 < 0) {
				...
				if (local364 >= 0 && local374 >= 0 && local364 - (super.anInt1292 << 12) < 0 && local374 - (super.anInt1291 << 12) < 0) {
					while (local389 < 0) {
						local422 = super.anIntArray94[(local374 >> 12) * super.anInt1292 + (local364 >> 12)];
						local426 = Static189.anIntArray319[local383];
						local430 = local422 >>> 24;
						local434 = 256 - local430;
						Static189.anIntArray319[local383++] = ((local422 & 0xFF00FF) * local430 + (local426 & 0xFF00FF) * local434 & 0xFF00FF00) + ((local422 & 0xFF00) * local430 + (local426 & 0xFF00) * local434 & 0xFF0000) >>> 8;
			...
			while (local380 < 0) {
				...
				if (local364 >= 0 && local364 - (super.anInt1292 << 12) < 0) {
					@Pc(514) int local514;
					if ((local514 = local495 - (super.anInt1291 << 12)) >= 0) {
					...
					while (local389 < 0) {
						local422 = super.anIntArray94[(local495 >> 12) * super.anInt1292 + (local364 >> 12)];
						local426 = Static189.anIntArray319[local383];
						local430 = local422 >>> 24;
						local434 = 256 - local430;
						Static189.anIntArray319[local383++] = ((local422 & 0xFF00FF) * local430 + (local426 & 0xFF00FF) * local434 & 0xFF00FF00) + ((local422 & 0xFF00) * local430 + (local426 & 0xFF00) * local434 & 0xFF0000) >>> 8;
			...
			while (local380 < 0) {
				...
				if (local364 >= 0 && local364 - (super.anInt1292 << 12) < 0) {
					...
					@Pc(689) int local689;
					if ((local689 = (local495 + 1 - (super.anInt1291 << 12) - local329) / local329) > local389) {
						local389 = local689;
					}
					while (local389 < 0) {
						local422 = super.anIntArray94[(local495 >> 12) * super.anInt1292 + (local364 >> 12)];
		...
		try {
			...
			for (@Pc(65) int local65 = 0; local65 < 20; local65++) {
				...
				for (@Pc(75) int local75 = -20; local75 < 0; local75++) {
					@Pc(90) int local90 = super.anIntArray94[(local70 >> 16) + (local72 >> 16) * super.anInt1292];
					@Pc(94) int local94 = Static189.anIntArray319[local68];
					@Pc(98) int local98 = local90 >>> 24;
					@Pc(102) int local102 = 256 - local98;
					Static189.anIntArray319[local68++] = ((local90 & 0xFF00FF) * local98 + (local94 & 0xFF00FF) * local102 & 0xFF00FF00) + ((local90 & 0xFF00) * local98 + (local94 & 0xFF00) * local102 & 0xFF0000) >>> 8;
					local70 += local33;
					local72 -= local27;
				}
				local45 += local27;
	...
	public void method887(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		Static268.method918(Static189.anIntArray319, super.anIntArray94, local12, local14, local46, local130, arg2, arg3, local26, local32, local7);
	}
	...
	public void method888(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (local23 > 0 && local20 > 0) {
			Static268.method916(Static189.anIntArray319, super.anIntArray94, local17, local15, local23, local20, local27, local29);
		}
	}
	...
	public void method894(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		Static268.method917(Static189.anIntArray319, super.anIntArray94, local12, local14, local46, local130, arg2, arg3, local26, local32, local7, arg4);
	}
	...
	public void method889(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if (local23 > 0 && local20 > 0) {
			Static268.method919(Static189.anIntArray319, super.anIntArray94, local17, local15, local23, local20, local27, local29, arg2);
		}
	}
	...
	public void method884(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (local32 > 0 && local29 > 0) {
			Static268.method915(Static189.anIntArray319, super.anIntArray94, local26, local21, local32, local29, local36, local40);
		}
	}
}
