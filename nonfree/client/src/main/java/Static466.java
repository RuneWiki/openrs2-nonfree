...
public final class Static466 {
	...
	@OriginalMember(owner = "client!rd", name = "a", descriptor = "([B[IIIIIIILclient!rd;)I")
	public static int method4639(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub6_Sub3 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt5902 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lclient!jj;III)Lclient!rd;")
	public static Class1_Sub6_Sub3 method4640(@OriginalArg(0) Class1_Sub25_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray37 == null || arg0.aByteArray37.length == 0 ? null : new Class1_Sub6_Sub3(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!rd", name = "a", descriptor = "(II[B[IIIIIIIILclient!rd;II)I")
	public static int method4646(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub6_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt5910 -= arg8.anInt5903 * arg3;
		arg8.anInt5904 -= arg8.anInt5907 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!rd", name = "b", descriptor = "([B[IIIIIIILclient!rd;)I")
	public static int method4647(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub6_Sub3 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!rd", name = "a", descriptor = "(I[B[IIIIIIIILclient!rd;)I")
	public static int method4648(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub6_Sub3 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt5902 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!rd", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!rd;II)I")
	public static int method4651(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub6_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt5908 -= arg10.anInt5901 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt5908 += arg10.anInt5901 * local63;
		arg10.anInt5910 = arg4;
		arg10.anInt5904 = arg5;
		arg10.anInt5902 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!rd", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!rd;II)I")
	public static int method4652(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub6_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt5908 -= arg10.anInt5901 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!rd", name = "b", descriptor = "(II[B[IIIIIIIILclient!rd;II)I")
	public static int method4655(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub6_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!rd", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!rd;)I")
	public static int method4656(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub6_Sub3 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt5908 += arg10.anInt5901 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt5910 = arg4 >> 2;
		arg10.anInt5904 = arg5 >> 2;
		arg10.anInt5902 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!rd", name = "a", descriptor = "([B[IIIIIIIILclient!rd;)I")
	public static int method4658(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub6_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt5910 += arg8.anInt5903 * (local24 - arg3);
		arg8.anInt5904 += arg8.anInt5907 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt5908 = arg4 >> 2;
		arg8.anInt5902 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!rd", name = "c", descriptor = "(II)I")
	public static int method4659(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lclient!jj;II)Lclient!rd;")
	public static Class1_Sub6_Sub3 method4661(@OriginalArg(0) Class1_Sub25_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray37 == null || arg0.aByteArray37.length == 0 ? null : new Class1_Sub6_Sub3(arg0, (int) ((long) arg0.anInt3338 * 256L * (long) 100 / (long) (Static228.anInt4846 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!rd", name = "b", descriptor = "(I[B[IIIIIIIILclient!rd;)I")
	public static int method4662(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub6_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!rd", name = "c", descriptor = "(II[B[IIIIIIIILclient!rd;II)I")
	public static int method4663(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub6_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!rd", name = "a", descriptor = "(II[B[IIIIIIILclient!rd;II)I")
	public static int method4665(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub6_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	public static int method4668(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!rd", name = "b", descriptor = "([B[IIIIIIIILclient!rd;)I")
	public static int method4670(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub6_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt5910 += arg8.anInt5903 * (local22 - arg3);
		arg8.anInt5904 += arg8.anInt5907 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!rd", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!rd;)I")
	public static int method4671(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub6_Sub3 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt5908 += arg10.anInt5901 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!rd", name = "d", descriptor = "(II[B[IIIIIIIILclient!rd;II)I")
	public static int method4672(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub6_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt5910 -= arg8.anInt5903 * arg3;
		arg8.anInt5904 -= arg8.anInt5907 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!rd", name = "b", descriptor = "(II[B[IIIIIIILclient!rd;II)I")
	public static int method4676(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub6_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
