...
public final class Static466 {
	...
	@OriginalMember(owner = "client!si", name = "a", descriptor = "(II[B[IIIIIIIILclient!si;II)I")
	public static int method4790(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub14_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!si", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!si;II)I")
	public static int method4792(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class4_Sub14_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt6007 -= arg10.anInt6004 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt6007 += arg10.anInt6004 * local63;
		arg10.anInt6005 = arg4;
		arg10.anInt5999 = arg5;
		arg10.anInt6008 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!si", name = "a", descriptor = "([B[IIIIIIIILclient!si;)I")
	public static int method4794(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class4_Sub14_Sub4 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt6005 += arg8.anInt5997 * (local22 - arg3);
		arg8.anInt5999 += arg8.anInt6009 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt6007 = arg4 >> 2;
		arg8.anInt6008 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!si", name = "a", descriptor = "(I[B[IIIIIIIILclient!si;)I")
	public static int method4795(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class4_Sub14_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
	...
	public static int method4799(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!si", name = "b", descriptor = "(I[B[IIIIIIIILclient!si;)I")
	public static int method4800(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class4_Sub14_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!si", name = "a", descriptor = "(II[B[IIIIIIILclient!si;II)I")
	public static int method4803(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class4_Sub14_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!si", name = "b", descriptor = "(II[B[IIIIIIIILclient!si;II)I")
	public static int method4804(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub14_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!si", name = "b", descriptor = "(II[B[IIIIIIILclient!si;II)I")
	public static int method4807(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class4_Sub14_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!si", name = "a", descriptor = "(Lclient!jc;III)Lclient!si;")
	public static Class4_Sub14_Sub4 method4811(@OriginalArg(0) Class4_Sub15_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray34 == null || arg0.aByteArray34.length == 0 ? null : new Class4_Sub14_Sub4(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!si", name = "a", descriptor = "(Lclient!jc;II)Lclient!si;")
	public static Class4_Sub14_Sub4 method4814(@OriginalArg(0) Class4_Sub15_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray34 == null || arg0.aByteArray34.length == 0 ? null : new Class4_Sub14_Sub4(arg0, (int) ((long) arg0.anInt3298 * 256L * (long) 100 / (long) (Static145.anInt2577 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!si", name = "a", descriptor = "([B[IIIIIIILclient!si;)I")
	public static int method4815(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class4_Sub14_Sub4 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt6008 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!si", name = "c", descriptor = "(II[B[IIIIIIIILclient!si;II)I")
	public static int method4816(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub14_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt6005 -= arg8.anInt5997 * arg3;
		arg8.anInt5999 -= arg8.anInt6009 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!si", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!si;)I")
	public static int method4820(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class4_Sub14_Sub4 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt6007 += arg10.anInt6004 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt6005 = arg4 >> 2;
		arg10.anInt5999 = arg5 >> 2;
		arg10.anInt6008 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!si", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!si;II)I")
	public static int method4821(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class4_Sub14_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt6007 -= arg10.anInt6004 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!si", name = "b", descriptor = "([B[IIIIIIIILclient!si;)I")
	public static int method4822(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class4_Sub14_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt6005 += arg8.anInt5997 * (local24 - arg3);
		arg8.anInt5999 += arg8.anInt6009 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!si", name = "b", descriptor = "([B[IIIIIIILclient!si;)I")
	public static int method4825(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class4_Sub14_Sub4 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!si", name = "d", descriptor = "(II[B[IIIIIIIILclient!si;II)I")
	public static int method4827(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub14_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt6005 -= arg8.anInt5997 * arg3;
		arg8.anInt5999 -= arg8.anInt6009 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!si", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!si;)I")
	public static int method4829(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class4_Sub14_Sub4 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt6007 += arg10.anInt6004 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
