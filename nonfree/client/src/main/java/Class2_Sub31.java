...
public final class Class2_Sub31 extends Class2 {
	...
	private void method3511(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub13 local4 = new Class2_Sub13(arg0);
		this.anInt4287 = local4.method3574();
		this.anInt4291 = local4.method3574();
		this.anInt4286 = local4.method3574();
		this.anInt4284 = local4.method3574();
		if (this.anInt4284 < 0) {
			this.anInt4284 = ~this.anInt4284;
			this.aBoolean307 = true;
		}
		@Pc(40) int local40 = local4.method3574();
		this.aByteArrayArray37 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method3580();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method3598(local64, local49);
			this.aByteArrayArray37[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!na", name = "a", descriptor = "([I)Lclient!he;")
	public Class2_Sub22_Sub1 method3512(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray50 == null) {
			this.anInt4283 = 0;
			this.aFloatArray16 = new float[Static262.anInt4285];
			this.aByteArray50 = new byte[this.anInt4291];
			this.anInt4294 = 0;
			this.anInt4293 = 0;
		}
		while (this.anInt4293 < this.aByteArrayArray37.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method3513(this.anInt4293);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt4294;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt4291 - local47) {
					local50 = this.anInt4291 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray50[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt4294;
				}
				this.anInt4294 = local47;
			}
			this.anInt4293++;
		}
		this.aFloatArray16 = null;
		@Pc(129) byte[] local129 = this.aByteArray50;
		this.aByteArray50 = null;
		return new Class2_Sub22_Sub1(this.anInt4287, local129, this.anInt4286, this.anInt4284, this.aBoolean307);
	}

	@OriginalMember(owner = "client!na", name = "b", descriptor = "(I)[F")
	private float[] method3513(@OriginalArg(0) int arg0) {
		Static262.method3509(this.aByteArrayArray37[arg0]);
		Static262.method3517();
		@Pc(15) int local15 = Static262.method3516(Static43.method647(Static262.anIntArray366.length - 1));
		@Pc(19) boolean local19 = Static262.aBooleanArray17[local15];
		@Pc(25) int local25 = local19 ? Static262.anInt4285 : Static262.anInt4288;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static262.method3517() != 0;
			local29 = Static262.method3517() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static262.anInt4288 >> 2);
			local67 = (local25 >> 2) + (Static262.anInt4288 >> 2);
			local71 = Static262.anInt4288 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static262.anInt4288 >> 2);
			local104 = local25 + (Static262.anInt4288 >> 2) - (local25 >> 2);
			local108 = Static262.anInt4288 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class262 local123 = Static262.aClass262Array1[Static262.anIntArray366[local15]];
		@Pc(126) int local126 = local123.anInt7079;
		@Pc(131) int local131 = local123.anIntArray628[local126];
		@Pc(140) boolean local140 = !Static262.aClass130Array1[local131].method2656();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt7078; local144++) {
			@Pc(152) Class28 local152 = Static262.aClass28Array1[local123.anIntArray629[local144]];
			local154 = Static262.aFloatArray22;
			local152.method625(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt7079;
			local176 = local123.anIntArray628[local171];
			Static262.aClass130Array1[local176].method2662(Static262.aFloatArray22, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static262.aFloatArray22[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static262.aFloatArray22;
			...
			@Pc(252) float[] local252 = local19 ? Static262.aFloatArray17 : Static262.aFloatArray20;
			@Pc(258) float[] local258 = local19 ? Static262.aFloatArray18 : Static262.aFloatArray21;
			@Pc(264) float[] local264 = local19 ? Static262.aFloatArray19 : Static262.aFloatArray23;
			@Pc(270) int[] local270 = local19 ? Static262.anIntArray365 : Static262.anIntArray367;
			...
			@Pc(486) int local486 = Static43.method647(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static262.aFloatArray22[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static262.aFloatArray22[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt4283 > 0) {
			local176 = this.anInt4283 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean308) {
				for (local212 = 0; local212 < this.anInt4290; local212++) {
					local1254 = (this.anInt4283 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static262.aFloatArray22[local212];
				}
			}
		}
		local154 = this.aFloatArray16;
		this.aFloatArray16 = Static262.aFloatArray22;
		Static262.aFloatArray22 = local154;
		this.anInt4283 = local25;
		this.anInt4290 = local104 - (local25 >> 1);
		this.aBoolean308 = local140;
		return local1228;
	}
}
