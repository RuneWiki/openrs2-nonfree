...
public final class Static126 {
	...
	public static Js5NetRequest aClass4_Sub1_Sub11_1;
	...
	private static JagString aClass22_933 = Static60.method1113("Your account is already logged in)3");

	@OriginalMember(owner = "client!vc", name = "K", descriptor = "Lclient!ec;")
	public static JagString aClass22_932 = aClass22_933;

	@OriginalMember(owner = "client!vc", name = "U", descriptor = "Lclient!ec;")
	public static JagString aClass22_934 = Static60.method1113("jlv");
	...
	public static void method1912(@OriginalArg(0) int arg0, @OriginalArg(2) JagString arg1) {
		@Pc(7) JagString local7 = arg1.method453().method473();
		@Pc(13) boolean local13 = false;
		for (@Pc(19) int local19 = 0; local19 < Static51.anInt1461; local19++) {
			@Pc(27) PlayerEntity local27 = Static44.aClass4_Sub1_Sub3_Sub2_Sub1Array1[Static115.anIntArray310[local19]];
		...
		if (!local13) {
			Static65.method1153(Static44.method856(new JagString[] { Static79.aClass22_622, local7 }), 0, Static64.aClass22_485);
		}
	}
