...
public final class Class4_Sub1_Sub9 extends DoublyLinkable {
	...
	public void method1019(@OriginalArg(1) Packet arg0) {
		while (true) {
	...
	public Model method1022() {
		if (this.anIntArray156 == null) {
			return null;
		}
		@Pc(20) Model[] local20 = new Model[this.anIntArray156.length];
		...
		if (local20.length == 1) {
			...
			local48 = new Model(local20, local20.length);
		}
		@Pc(62) int local62;
	...
	private void method1023(@OriginalArg(0) int arg0, @OriginalArg(1) Packet arg1) {
		if (arg0 == 1) {
	...
	public Model method1024() {
		...
		@Pc(42) Model local42 = new Model(local4, local10);
		@Pc(47) int local47;
		if (this.aShortArray13 != null) {
