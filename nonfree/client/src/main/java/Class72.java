...
public abstract class Class72 {
	...
	static {
		new Class21("Adventurer", "Abenteurer", "Aventurier", "Aventureiro");
	}
	...
	public abstract void ya(@OriginalArg(0) Class72 arg0);
	...
	public abstract Class72 method3307();
	...
	public abstract void method3308(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3);
