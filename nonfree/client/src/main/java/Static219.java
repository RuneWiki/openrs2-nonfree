...
public final class Static219 {
	...
	public static int method1318(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!hg", name = "b", descriptor = "(II)I")
	public static int method1321(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!hg", name = "a", descriptor = "(II[B[IIIIIIIILclient!hg;II)I")
	public static int method1322(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub9_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!hg", name = "a", descriptor = "([B[IIIIIIILclient!hg;)I")
	public static int method1323(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub9_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt1666 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!hg", name = "a", descriptor = "(II[B[IIIIIIILclient!hg;II)I")
	public static int method1324(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub9_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lclient!cb;II)Lclient!hg;")
	public static Class2_Sub9_Sub2 method1329(@OriginalArg(0) Class2_Sub6_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray5 == null || arg0.aByteArray5.length == 0 ? null : new Class2_Sub9_Sub2(arg0, (int) ((long) arg0.anInt610 * 256L * (long) 100 / (long) (Static68.anInt1622 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!hg", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!hg;II)I")
	public static int method1331(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub9_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1668 -= arg10.anInt1659 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt1668 += arg10.anInt1659 * local63;
		arg10.anInt1660 = arg4;
		arg10.anInt1664 = arg5;
		arg10.anInt1666 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lclient!cb;III)Lclient!hg;")
	public static Class2_Sub9_Sub2 method1333(@OriginalArg(0) Class2_Sub6_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray5 == null || arg0.aByteArray5.length == 0 ? null : new Class2_Sub9_Sub2(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!hg", name = "a", descriptor = "([B[IIIIIIIILclient!hg;)I")
	public static int method1334(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub9_Sub2 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt1660 += arg8.anInt1661 * (local24 - arg3);
		arg8.anInt1664 += arg8.anInt1667 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt1668 = arg4 >> 2;
		arg8.anInt1666 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!hg", name = "b", descriptor = "(II[B[IIIIIIIILclient!hg;II)I")
	public static int method1338(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub9_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1660 -= arg8.anInt1661 * arg3;
		arg8.anInt1664 -= arg8.anInt1667 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!hg", name = "b", descriptor = "(II[B[IIIIIIILclient!hg;II)I")
	public static int method1339(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub9_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!hg", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!hg;)I")
	public static int method1340(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub9_Sub2 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt1668 += arg10.anInt1659 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt1660 = arg4 >> 2;
		arg10.anInt1664 = arg5 >> 2;
		arg10.anInt1666 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!hg", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!hg;)I")
	public static int method1343(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub9_Sub2 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt1668 += arg10.anInt1659 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!hg", name = "a", descriptor = "(I[B[IIIIIIIILclient!hg;)I")
	public static int method1347(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub9_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!hg", name = "c", descriptor = "(II[B[IIIIIIIILclient!hg;II)I")
	public static int method1349(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub9_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1660 -= arg8.anInt1661 * arg3;
		arg8.anInt1664 -= arg8.anInt1667 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!hg", name = "b", descriptor = "([B[IIIIIIIILclient!hg;)I")
	public static int method1350(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub9_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1660 += arg8.anInt1661 * (local22 - arg3);
		arg8.anInt1664 += arg8.anInt1667 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!hg", name = "b", descriptor = "([B[IIIIIIILclient!hg;)I")
	public static int method1351(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub9_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!hg", name = "d", descriptor = "(II[B[IIIIIIIILclient!hg;II)I")
	public static int method1352(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub9_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!hg", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!hg;II)I")
	public static int method1355(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub9_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1668 -= arg10.anInt1659 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!hg", name = "b", descriptor = "(I[B[IIIIIIIILclient!hg;)I")
	public static int method1356(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub9_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
