...
public class Class15 {
	...
	private PcmStream aClass4_Sub4_6;
	...
	private final PcmStream[] aClass4_Sub4Array5 = new PcmStream[8];
	...
	private final PcmStream[] aClass4_Sub4Array6 = new PcmStream[8];
	...
	private void method1190(@OriginalArg(0) int[] arg0) {
		...
		if (this.aClass4_Sub4_6 != null && this.anInt1948 <= 0) {
			...
			label103: while (local47 != 0) {
				...
				for (@Pc(72) int local72 = local47 >>> local56 & 0x11111111; local72 != 0; local72 >>>= 0x4) {
					if ((local72 & 0x1) != 0) {
						...
						@Pc(93) PcmStream local93 = this.aClass4_Sub4Array5[local56];
						label97: while (true) {
							while (true) {
								if (local93 == null) {
									break label97;
								}
								@Pc(97) Sound local97 = local93.aClass4_Sub13_5;
								if (local97 == null || local97.anInt1364 <= local61) {
									...
									@Pc(140) PcmStream local140 = local93.method1640();
									if (local140 != null) {
									...
									@Pc(164) PcmStream local164 = local93.aClass4_Sub4_8;
			...
			for (local56 = 0; local56 < 8; local56++) {
				@Pc(207) PcmStream local207 = this.aClass4_Sub4Array5[local56];
				this.aClass4_Sub4Array5[local56] = this.aClass4_Sub4Array6[local56] = null;
				while (local207 != null) {
					@Pc(221) PcmStream local221 = local207.aClass4_Sub4_8;
	...
	public final synchronized void method1191(@OriginalArg(0) PcmStream arg0) {
	...
	private void method1204(@OriginalArg(1) PcmStream arg0, @OriginalArg(2) int arg1) {
		@Pc(12) int local12 = arg1 >> 5;
		@Pc(17) PcmStream local17 = this.aClass4_Sub4Array6[local12];
		if (local17 == null) {
