...
public final class Static87 {
	...
	public static Js5Index aClass20_44;

	@OriginalMember(owner = "client!pa", name = "a", descriptor = "Lclient!ec;")
	private static JagString aClass22_651 = Static60.method1113("Connecting to server)3)3)3");

	@OriginalMember(owner = "client!pa", name = "b", descriptor = "[Lclient!qf;")
	public static CollisionMap[] aClass60Array1 = new CollisionMap[4];

	@OriginalMember(owner = "client!pa", name = "c", descriptor = "Lclient!ec;")
	private static JagString aClass22_652 = Static60.method1113("Loaded update list");

	@OriginalMember(owner = "client!pa", name = "q", descriptor = "Lclient!ec;")
	private static JagString aClass22_661 = Static60.method1113("Members only world");

	@OriginalMember(owner = "client!pa", name = "d", descriptor = "Lclient!ec;")
	public static JagString aClass22_653 = aClass22_661;

	@OriginalMember(owner = "client!pa", name = "e", descriptor = "Lclient!ec;")
	public static JagString aClass22_654 = aClass22_652;

	@OriginalMember(owner = "client!pa", name = "f", descriptor = "Lclient!ec;")
	private static JagString aClass22_655 = Static60.method1113("button near the top of that page)3");

	@OriginalMember(owner = "client!pa", name = "g", descriptor = "Lclient!ec;")
	public static JagString aClass22_656 = aClass22_651;

	@OriginalMember(owner = "client!pa", name = "i", descriptor = "Lclient!ec;")
	public static JagString aClass22_657 = aClass22_655;

	@OriginalMember(owner = "client!pa", name = "r", descriptor = "Lclient!ec;")
	private static JagString aClass22_662 = Static60.method1113("Existing User");

	@OriginalMember(owner = "client!pa", name = "l", descriptor = "Lclient!ec;")
	public static JagString aClass22_658 = aClass22_662;

	@OriginalMember(owner = "client!pa", name = "m", descriptor = "Lclient!ec;")
	public static JagString aClass22_659 = Static60.method1113("Lade Schrifts-=tze )2 ");

	@OriginalMember(owner = "client!pa", name = "p", descriptor = "Lclient!ec;")
	public static JagString aClass22_660 = Static60.method1113(":duelreq:");

	@OriginalMember(owner = "client!pa", name = "t", descriptor = "Lclient!ec;")
	public static JagString aClass22_663 = Static60.method1113("title_mute");
	...
	public static void method1540() {
		...
		@Pc(11) IfType local11 = Static108.method1767(Static123.anInt3082, Static37.anInt903);
