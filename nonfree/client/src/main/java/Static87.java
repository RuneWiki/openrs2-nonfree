...
public final class Static87 {
	...
	public static final int[] anIntArray661 = new int[1];

	@OriginalMember(owner = "client!et", name = "a", descriptor = "(I)I")
	public static int method4733(@OriginalArg(0) int arg0) {
	...
	@OriginalMember(owner = "client!et", name = "a", descriptor = "(Lclient!jaggl/opengl;IIIII[B)V")
	public static void method4736(@OriginalArg(0) opengl arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) byte[] arg6) {
		if (arg3 > 0 && !Static100.method1790(arg3)) {
			throw new IllegalArgumentException("");
		} else if (arg4 <= 0 || Static100.method1790(arg4)) {
			@Pc(24) int local24 = method4738(arg5);
			@Pc(26) int local26 = 0;
			...
			while (true) {
				arg0.glTexImage2D(arg1, local26, arg2, arg3, arg4, 0, arg5, 5121, ByteBuffer.wrap(local43));
				if (local33 <= 1) {
					return;
				}
	...
	@OriginalMember(owner = "client!et", name = "a", descriptor = "(Lclient!jaggl/opengl;IIIIII[I)V")
	public static void method4737(@OriginalArg(0) opengl arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int[] arg6) {
		if (arg3 > 0 && !Static100.method1790(arg3)) {
			throw new IllegalArgumentException("");
		} else if (arg4 <= 0 || Static100.method1790(arg4)) {
			@Pc(31) int local31 = 0;
			...
			while (true) {
				arg0.glTexImage2D(arg1, local31, arg2, arg3, arg4, 0, 32993, arg5, IntBuffer.wrap(local48));
				if (local38 <= 1) {
					return;
				}
				@Pc(70) int local70 = 0;
	...
	public static int method4738(@OriginalArg(0) int arg0) {
		if (arg0 == 6406) {
			return 1;
		} else if (arg0 == 6409) {
			return 1;
	...
	@OriginalMember(owner = "client!et", name = "a", descriptor = "(Lclient!jaggl/opengl;IIIII[F)V")
	public static void method4740(@OriginalArg(0) opengl arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6) {
		if (arg3 > 0 && !Static100.method1790(arg3)) {
			throw new IllegalArgumentException("");
		} else if (arg4 <= 0 || Static100.method1790(arg4)) {
			@Pc(24) int local24 = method4738(6408);
			@Pc(26) int local26 = 0;
			@Pc(33) int local33 = arg3 < arg4 ? arg3 : arg4;
			@Pc(37) int local37 = arg3 >> 1;
			@Pc(41) int local41 = arg4 >> 1;
			...
			while (true) {
				arg0.glTexImage2D(3553, local26, 34842, arg3, arg4, 0, 6408, 5126, FloatBuffer.wrap(local43));
				if (local33 <= 1) {
					return;
				}
				@Pc(69) int local69 = arg3 * local24;
