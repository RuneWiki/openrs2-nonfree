...
public final class VarBitType extends DoublyLinkable {
	...
	public void method36(@OriginalArg(0) Packet arg0) {
		while (true) {
	...
	private void method37(@OriginalArg(1) int arg0, @OriginalArg(2) Packet arg1) {
		if (arg0 == 1) {
