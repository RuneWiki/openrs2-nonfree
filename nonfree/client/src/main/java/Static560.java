...
public final class Static560 {
	...
	@OriginalMember(owner = "client!vn", name = "a", descriptor = "(I[B[IIIIIIIILclient!vn;)I")
	public static int method7679(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class12_Sub13_Sub4 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt9314 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!vn", name = "a", descriptor = "([B[IIIIIIILclient!vn;)I")
	public static int method7685(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class12_Sub13_Sub4 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt9314 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!vn", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!vn;)I")
	public static int method7687(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class12_Sub13_Sub4 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt9316 += arg10.anInt9322 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt9318 = arg4 >> 2;
		arg10.anInt9312 = arg5 >> 2;
		arg10.anInt9314 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!vn", name = "b", descriptor = "(I[B[IIIIIIIILclient!vn;)I")
	public static int method7690(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class12_Sub13_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!vn", name = "a", descriptor = "(II[B[IIIIIIILclient!vn;II)I")
	public static int method7692(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class12_Sub13_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!vn", name = "b", descriptor = "(II[B[IIIIIIILclient!vn;II)I")
	public static int method7695(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class12_Sub13_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!vn", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!vn;II)I")
	public static int method7696(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class12_Sub13_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt9316 -= arg10.anInt9322 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt9316 += arg10.anInt9322 * local63;
		arg10.anInt9318 = arg4;
		arg10.anInt9312 = arg5;
		arg10.anInt9314 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lclient!ke;III)Lclient!vn;")
	public static Class12_Sub13_Sub4 method7698(@OriginalArg(0) Class12_Sub29_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray59 == null || arg0.aByteArray59.length == 0 ? null : new Class12_Sub13_Sub4(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!vn", name = "c", descriptor = "(II)I")
	public static int method7699(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!vn", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!vn;)I")
	public static int method7700(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class12_Sub13_Sub4 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt9316 += arg10.anInt9322 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lclient!ke;II)Lclient!vn;")
	public static Class12_Sub13_Sub4 method7701(@OriginalArg(0) Class12_Sub29_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray59 == null || arg0.aByteArray59.length == 0 ? null : new Class12_Sub13_Sub4(arg0, (int) ((long) arg0.anInt5186 * 256L * (long) 100 / (long) (Static426.anInt6103 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!vn", name = "b", descriptor = "([B[IIIIIIILclient!vn;)I")
	public static int method7702(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class12_Sub13_Sub4 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!vn", name = "a", descriptor = "([B[IIIIIIIILclient!vn;)I")
	public static int method7704(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class12_Sub13_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt9318 += arg8.anInt9317 * (local24 - arg3);
		arg8.anInt9312 += arg8.anInt9313 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt9316 = arg4 >> 2;
		arg8.anInt9314 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!vn", name = "a", descriptor = "(II[B[IIIIIIIILclient!vn;II)I")
	public static int method7706(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class12_Sub13_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	public static int method7707(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!vn", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!vn;II)I")
	public static int method7708(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class12_Sub13_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt9316 -= arg10.anInt9322 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!vn", name = "b", descriptor = "(II[B[IIIIIIIILclient!vn;II)I")
	public static int method7713(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class12_Sub13_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!vn", name = "c", descriptor = "(II[B[IIIIIIIILclient!vn;II)I")
	public static int method7714(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class12_Sub13_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt9318 -= arg8.anInt9317 * arg3;
		arg8.anInt9312 -= arg8.anInt9313 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!vn", name = "d", descriptor = "(II[B[IIIIIIIILclient!vn;II)I")
	public static int method7715(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class12_Sub13_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt9318 -= arg8.anInt9317 * arg3;
		arg8.anInt9312 -= arg8.anInt9313 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!vn", name = "b", descriptor = "([B[IIIIIIIILclient!vn;)I")
	public static int method7716(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class12_Sub13_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt9318 += arg8.anInt9317 * (local22 - arg3);
		arg8.anInt9312 += arg8.anInt9313 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
