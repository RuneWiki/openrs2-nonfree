...
public final class Class51 {
	...
	@OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(Lclient!dn;ILclient!r;)V", line = 112)
	public Class51(@OriginalArg(0) Class50 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class197 arg2) {
		this.aClass197_15 = arg2;
		this.aClass197_15.method5082(5);
	}

	@OriginalMember(owner = "client!dp", name = "a", descriptor = "(II)Lclient!hl;", line = 38)
	public Class2_Sub2_Sub8 method1708(@OriginalArg(0) int arg0) {
		@Pc(6) Class98 local6 = this.aClass98_6;
		@Pc(16) Class2_Sub2_Sub8 local16;
		synchronized (this.aClass98_6) {
			local16 = (Class2_Sub2_Sub8) this.aClass98_6.method2614((long) arg0);
		}
		if (local16 != null) {
			return local16;
		}
		@Pc(38) byte[] local38 = this.aClass197_15.method5090(arg0, 5);
		local16 = new Class2_Sub2_Sub8();
		if (local38 != null) {
			local16.method2503(new Class2_Sub4(local38));
		}
		@Pc(54) Class98 local54 = this.aClass98_6;
		synchronized (this.aClass98_6) {
			this.aClass98_6.method2626((long) arg0, local16);
			return local16;
		}
	}
}
