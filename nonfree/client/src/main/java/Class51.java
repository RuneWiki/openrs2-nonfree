...
public final class Class51 {
	...
	public Class51(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18) {
		...
		this.anInt2250 = arg0;
		this.anInt2253 = arg1;
		this.anInt2252 = arg17;
		this.anInt2251 = arg18;
		...
		this.anIntArray230 = new int[local51];
		...
		for (@Pc(79) int local79 = 0; local79 < local51; local79++) {
			...
			this.anIntArray237[local79] = local140;
			this.anIntArray238[local79] = local144;
			this.anIntArray230[local79] = local142;
		...
		this.anIntArray228 = new int[local140];
		this.anIntArray231 = new int[local140];
		this.anIntArray241 = new int[local140];
		this.anIntArray234 = new int[local140];
		this.anIntArray236 = new int[local140];
		this.anIntArray235 = new int[local140];
		if (arg2 != -1) {
			this.anIntArray240 = new int[local140];
		}
		local142 = 0;
		for (local144 = 0; local144 < local140; local144++) {
			...
			this.anIntArray228[local144] = local148;
			this.anIntArray231[local144] = local591;
			this.anIntArray241[local144] = local597;
			if (local146 == 0) {
				this.anIntArray234[local144] = local66[local148];
				this.anIntArray236[local144] = local66[local591];
				this.anIntArray235[local144] = local66[local597];
				if (this.anIntArray240 != null) {
					this.anIntArray240[local144] = -1;
				}
			} else {
				this.anIntArray234[local144] = local69[local148];
				this.anIntArray236[local144] = local69[local591];
				this.anIntArray235[local144] = local69[local597];
				if (this.anIntArray240 != null) {
					this.anIntArray240[local144] = arg2;
				}
			}
		}
		local146 = arg5;
