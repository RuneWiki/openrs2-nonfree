...
public final class b extends Class106 implements Interface3 {

	@OriginalMember(owner = "client!b", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!b", name = "i", descriptor = "Lclient!wl;")
	private final Class265 aClass265_1 = new Class265();

	@OriginalMember(owner = "client!b", name = "j", descriptor = "Lclient!h;")
	private final h aH1;
	...
	public void method5482(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aH1.method2122().ka(this, arg0, arg1);
	}
	...
	public void method5484(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aH1.method2122().J(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
	...
	@OriginalMember(owner = "client!b", name = "a", descriptor = "(Lclient!or;[I)V")
	@Override
	public void method5480(@OriginalArg(0) Class2_Sub7 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass265_1.method5999(arg0);
		this.j(arg0.hashCode(), arg0.method2991(), arg0.method2996(), arg0.method2997(), arg0.method2992(), arg0.method2993(), arg1);
	}

	@OriginalMember(owner = "client!b", name = "SA", descriptor = "(Lclient!j;IIIIZ)V")
	public native void SA(@OriginalArg(0) Class2_Sub2_Sub9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!b", name = "O", descriptor = "(IILclient!j;)Lclient!j;")
	public native Class2_Sub2_Sub9 O(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class2_Sub2_Sub9 arg2);
	...
	public void method5479(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass265_1.method6002()];
		for (@Pc(13) Class2_Sub7 local13 = (Class2_Sub7) this.aClass265_1.method6005(); local13 != null; local13 = (Class2_Sub7) this.aClass265_1.method6001()) {
			local7[local1++] = local13.method2994();
		}
		this.oa(local7);
	}

	@OriginalMember(owner = "client!b", name = "U", descriptor = "(Lclient!j;IIIIZ)V")
	public native void U(@OriginalArg(0) Class2_Sub2_Sub9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
