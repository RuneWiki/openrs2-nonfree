...
public final class b extends Class163 implements Interface4 {

	@OriginalMember(owner = "client!b", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!b", name = "j", descriptor = "Lclient!vp;")
	private final Class254 aClass254_2 = new Class254();

	@OriginalMember(owner = "client!b", name = "k", descriptor = "Lclient!h;")
	private final h aH1;
	...
	public native Class1_Sub3_Sub10 O(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class1_Sub3_Sub10 arg2);

	@OriginalMember(owner = "client!b", name = "a", descriptor = "(II)V")
	@Override
	public void method4517(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aH1.method2082().ka(this, arg0, arg1);
	}

	@OriginalMember(owner = "client!b", name = "a", descriptor = "(Lclient!kt;[I)V")
	@Override
	public void method4515(@OriginalArg(0) Class1_Sub24 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass254_2.method5430(arg0);
		this.j(arg0.hashCode(), arg0.method4367(), arg0.method4376(), arg0.method4369(), arg0.method4374(), arg0.method4373(), arg1);
	}
	...
	public void method4518(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass254_2.method5431()];
		for (@Pc(13) Class1_Sub24 local13 = (Class1_Sub24) this.aClass254_2.method5437(); local13 != null; local13 = (Class1_Sub24) this.aClass254_2.method5433()) {
			local7[local1++] = local13.method4371();
		}
		this.oa(local7);
	}
	...
	public native void U(@OriginalArg(0) Class1_Sub3_Sub10 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method4516(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aH1.method2082().J(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!b", name = "SA", descriptor = "(Lclient!j;IIIIZ)V")
	public native void SA(@OriginalArg(0) Class1_Sub3_Sub10 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
