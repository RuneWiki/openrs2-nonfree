...
public final class b extends Class159 implements Interface2 {

	@OriginalMember(owner = "client!b", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!b", name = "j", descriptor = "Lclient!ug;")
	private final Class243 aClass243_2 = new Class243();
	...
	public void method4833(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass243_2.method5201()];
		for (@Pc(13) Class3_Sub8 local13 = (Class3_Sub8) this.aClass243_2.method5208(); local13 != null; local13 = (Class3_Sub8) this.aClass243_2.method5203()) {
			local7[local1++] = local13.method4399();
		}
		this.oa(local7);
	}
	...
	public native void U(@OriginalArg(0) Class3_Sub4_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method4828(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aH1.method2354().ka(this, arg0, arg1);
	}
	...
	@OriginalMember(owner = "client!b", name = "a", descriptor = "(Lclient!fk;[I)V")
	@Override
	public void method4835(@OriginalArg(0) Class3_Sub8 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass243_2.method5198(arg0);
		this.j(arg0.hashCode(), arg0.method4404(), arg0.method4397(), arg0.method4395(), arg0.method4400(), arg0.method4402(), arg1);
	}
	...
	public native void SA(@OriginalArg(0) Class3_Sub4_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public native Class3_Sub4_Sub4 O(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class3_Sub4_Sub4 arg2);
	...
	public void method4832(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aH1.method2354().J(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
