...
public final class b extends Class18 implements Interface12 {

	@OriginalMember(owner = "client!b", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lclient!c;Lclient!k;Lclient!ju;[Lclient!mn;[Lclient!aa;)V")
	public b(@OriginalArg(0) c arg0, @OriginalArg(1) k arg1, @OriginalArg(2) Class124 arg2, @OriginalArg(3) Class154[] arg3, @OriginalArg(4) Class2[] arg4) {
		super(arg0, arg2);
	...
	private native void w(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class14 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
