...
public final class b extends Class5 implements Interface9 {
	...
	private void method663(@OriginalArg(0) Exception arg0) {
		if (!Static25.aBoolean17) {
			Static25.aLong27 = Static105.method2132();
			Static25.aBoolean17 = true;
		} else if (Static105.method2132() - Static25.aLong27 < 30000L) {
	...
	public void method664(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas1.getTreeLock()) {
