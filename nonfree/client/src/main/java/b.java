...
public final class b extends Class1 implements Interface12 {
	...
	public void method322() {
		try {
			synchronized (this.aCanvas1.getTreeLock()) {
				this.ya();
				Static23.aBoolean46 = false;
			}
		} catch (@Pc(16) Exception local16) {
			this.method324(local16);
		}
	}
	...
	private void method324(@OriginalArg(0) Exception arg0) {
		if (!Static23.aBoolean46) {
			Static23.aLong16 = Static27.method359();
			Static23.aBoolean46 = true;
		} else if (Static27.method359() - Static23.aLong16 < 30000L) {
	...
	public void method325(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas1.getTreeLock()) {
