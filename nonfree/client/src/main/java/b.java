...
public final class b extends Class136 implements Interface5 {

	@OriginalMember(owner = "client!b", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!b", name = "m", descriptor = "Lclient!wo;")
	private final Class266 aClass266_6 = new Class266();

	@OriginalMember(owner = "client!b", name = "n", descriptor = "Lclient!h;")
	private final h aH1;
	...
	public native void SA(@OriginalArg(0) Class1_Sub2_Sub11 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!b", name = "O", descriptor = "(IILclient!j;)Lclient!j;")
	public native Class1_Sub2_Sub11 O(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class1_Sub2_Sub11 arg2);

	@OriginalMember(owner = "client!b", name = "ya", descriptor = "()V")
	public native void ya();

	@OriginalMember(owner = "client!b", name = "a", descriptor = "(Lclient!pe;[I)V")
	@Override
	public void method5979(@OriginalArg(0) Class1_Sub5 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass266_6.method5998(arg0);
		this.j(arg0.hashCode(), arg0.method3333(), arg0.method3326(), arg0.method3325(), arg0.method3327(), arg0.method3331(), arg1);
	}

	@OriginalMember(owner = "client!b", name = "U", descriptor = "(Lclient!j;IIIIZ)V")
	public native void U(@OriginalArg(0) Class1_Sub2_Sub11 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method5975(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aH1.method2129().ka(this, arg0, arg1);
	}
	...
	public void method5977(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass266_6.method5992()];
		for (@Pc(13) Class1_Sub5 local13 = (Class1_Sub5) this.aClass266_6.method6000(); local13 != null; local13 = (Class1_Sub5) this.aClass266_6.method5994()) {
			local7[local1++] = local13.method3328();
		}
		this.oa(local7);
	}
	...
	public void method5976(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aH1.method2129().J(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
