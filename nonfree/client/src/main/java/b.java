...
public final class b extends Class12 implements Interface12 {
	...
	public void method540(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas1.getTreeLock()) {
				...
				Static27.aBoolean18 = false;
			}
		} catch (@Pc(41) Exception local41) {
			this.method542(local41);
		}
	}
	...
	private void method542(@OriginalArg(0) Exception arg0) {
		if (!Static27.aBoolean18) {
			Static27.aLong14 = Static76.method1679();
			Static27.aBoolean18 = true;
		} else if (Static76.method1679() - Static27.aLong14 < 30000L) {
