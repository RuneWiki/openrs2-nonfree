...
public final class b extends Class92 implements Interface9 {

	@OriginalMember(owner = "client!b", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lclient!da;Lclient!a;Lclient!ub;[Lclient!iba;[Lclient!xa;)V")
	public b(@OriginalArg(0) da arg0, @OriginalArg(1) a arg1, @OriginalArg(2) Class327 arg2, @OriginalArg(3) Class140[] arg3, @OriginalArg(4) Class58[] arg4) {
		super(arg0, arg2);
	...
	private native void T(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class86 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
