...
public final class b extends Class70 implements Interface4 {

	@OriginalMember(owner = "client!b", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!b", name = "h", descriptor = "Lclient!ko;")
	private final Class142 aClass142_5 = new Class142();

	@OriginalMember(owner = "client!b", name = "i", descriptor = "Lclient!h;")
	private final h aH1;
	...
	public void method4267(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aH1.method2252().J(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!b", name = "SA", descriptor = "(Lclient!j;IIIIZ)V")
	public native void SA(@OriginalArg(0) Class1_Sub1_Sub3 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public native void U(@OriginalArg(0) Class1_Sub1_Sub3 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!b", name = "O", descriptor = "(IILclient!j;)Lclient!j;")
	public native Class1_Sub1_Sub3 O(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class1_Sub1_Sub3 arg2);
	...
	public void method4263(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aH1.method2252().ka(this, arg0, arg1);
	}
	...
	public void method4266(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass142_5.method3208()];
		for (@Pc(13) Class1_Sub12 local13 = (Class1_Sub12) this.aClass142_5.method3199(); local13 != null; local13 = (Class1_Sub12) this.aClass142_5.method3198()) {
			local7[local1++] = local13.method3183();
		}
		this.oa(local7);
	}
	...
	@OriginalMember(owner = "client!b", name = "a", descriptor = "(Lclient!tj;[I)V")
	@Override
	public void method4265(@OriginalArg(0) Class1_Sub12 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass142_5.method3212(arg0);
		this.j(arg0.hashCode(), arg0.method3182(), arg0.method3186(), arg0.method3181(), arg0.method3180(), arg0.method3184(), arg1);
	}
