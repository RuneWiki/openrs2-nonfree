...
public final class b extends Class64 implements Interface3 {

	@OriginalMember(owner = "client!b", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!b", name = "h", descriptor = "Lclient!tu;")
	...
	public native void U(@OriginalArg(0) Class3_Sub3_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public native void SA(@OriginalArg(0) Class3_Sub3_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method5444(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aH1.method2648().J(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
	...
	@OriginalMember(owner = "client!b", name = "a", descriptor = "(Lclient!ve;[I)V")
	@Override
	public void method5442(@OriginalArg(0) Class3_Sub23 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass229_5.method5321(arg0);
		this.j(arg0.hashCode(), arg0.method3679(), arg0.method3675(), arg0.method3678(), arg0.method3670(), arg0.method3674(), arg1);
	}

	@OriginalMember(owner = "client!b", name = "a", descriptor = "(II)V")
	@Override
	public void method5445(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aH1.method2648().ka(this, arg0, arg1);
	}

	@OriginalMember(owner = "client!b", name = "O", descriptor = "(IILclient!j;)Lclient!j;")
	public native Class3_Sub3_Sub4 O(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class3_Sub3_Sub4 arg2);
	...
	public void method5441(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass229_5.method5324()];
		for (@Pc(13) Class3_Sub23 local13 = (Class3_Sub23) this.aClass229_5.method5328(); local13 != null; local13 = (Class3_Sub23) this.aClass229_5.method5325()) {
			local7[local1++] = local13.method3677();
		}
		this.oa(local7);
	}
}
