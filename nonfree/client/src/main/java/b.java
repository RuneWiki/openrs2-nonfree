...
public final class b extends Class1 implements Interface1 {
	...
	public b(@OriginalArg(0) w arg0, @OriginalArg(1) Canvas arg1) {
		...
		this.FA(arg0, this.aCanvas4, local7.width, local7.height);
	}
	...
	private void method482(@OriginalArg(0) Exception arg0) {
		if (!Static22.aBoolean20) {
			Static22.aLong16 = Static250.method3737();
			Static22.aBoolean20 = true;
		} else if (Static250.method3737() - Static22.aLong16 < 30000L) {
	...
	public void method483(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas4.getTreeLock()) {
