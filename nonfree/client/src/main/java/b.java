...
public final class b extends Class1 implements Interface14 {
	...
	public b(@OriginalArg(0) a arg0, @OriginalArg(1) Canvas arg1) {
		...
		this.BA(arg0, this.aCanvas3, local7.width, local7.height);
	}
	...
	public void method741(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas3.getTreeLock()) {
	...
	private void method742(@OriginalArg(0) Exception arg0) {
		if (!Static24.aBoolean57) {
			Static24.aLong17 = Static110.method2222();
			Static24.aBoolean57 = true;
		} else if (Static110.method2222() - Static24.aLong17 < 30000L) {
