...
public final class Class104 {
	...
	@OriginalMember(owner = "client!fj", name = "lb", descriptor = "Lclient!fj;")
	public static final Class104 lb;

	@OriginalMember(owner = "client!fj", name = "b", descriptor = "[Ljava/lang/String;")
	private final String[] aStringArray12;

	static {
		new Class104("Player ", "Spieler ", "Joueur ", "Jogador ");
		...
		new Class104("Select", "Auswählen", "Sélectionner", "Selecionar");
		...
		new Class104(null, "der Spieler ist momentan nicht verfügbar.", null, null);
		...
		new Class104("You do not have permission to kick users in this channel.", "Du darfst keine Benutzer aus diesem Chatraum rauswerfen.", "Vous n'êtes pas autorisé à expulser des utilisateurs de ce canal.", "Você não tem permissão para expulsar usuários neste canal.");
		new Class104("You do not have permission to kick this user.", "Du darfst diesen Benutzer nicht rauswerfen.", "Vous n'êtes pas autorisé à expulser cet utilisateur.", "Você não tem permissão para expulsar este usuário.");
		...
		lb = new Class104("Loading additional fonts - ", "Lade Zusatzschriftarten - ", "Chargement de polices secondaires - ", "Carregando fontes principais - ");
		...
		new Class104(null, "bevor du die Option 'Regelverstoß melden' benutzt.", null, null);
		...
		new Class104("Changes will take effect on your clan in the next 60 seconds.", "Die Änderungen am Chatraum werden innerhalb von 60 Sekunden gültig.", "Les modifications seront apportées à votre clan dans les prochaines 60 secondes.", "As alterações passarão a valer no seu clã nos próximos 60 segundos.");
	}
	...
	public Class104(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2, @OriginalArg(3) String arg3) {
	...
	public String method2145(@OriginalArg(0) int arg0) {
