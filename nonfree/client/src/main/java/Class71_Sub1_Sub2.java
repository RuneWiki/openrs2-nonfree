...
public final class Class71_Sub1_Sub2 extends Class71_Sub1 {
	...
	@OriginalMember(owner = "client!dv", name = "<init>", descriptor = "(Lclient!rp;[B[III)V")
	public Class71_Sub1_Sub2(@OriginalArg(0) Class101_Sub3 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
	...
	@Override
	protected void method6398(@OriginalArg(0) int arg0) {
		@Pc(3) int[] local3 = super.aClass101_Sub3_10.anIntArray471;
		@Pc(935) int local935;
		@Pc(9) int local9;
		@Pc(12) int local12;
		@Pc(14) int local14;
		...
		@Pc(272) int local272;
		@Pc(344) int local344;
		if (Static492.anInt7138 == 0) {
			if (Static492.anInt7146 == 0) {
				local9 = Static492.anInt7127;
				while (local9 < 0) {
					local12 = Static492.anInt7150;
					local14 = Static492.anInt7130;
					local16 = Static492.anInt7148;
					local18 = Static492.anInt7143;
					if (local14 >= 0 && local16 >= 0 && local14 - (super.anInt7152 << 12) < 0 && local16 - (super.anInt7132 << 12) < 0) {
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt7152 + (local14 >> 12);
							local51 = local12++;
							if (arg0 == 1) {
								local227 = this.aByteArray28[local48];
								if (local227 != 0) {
									local3[local51] = this.anIntArray120[local227 & 0xFF];
								}
							} else if (arg0 == 0) {
								local227 = this.aByteArray28[local48];
								if (local227 != 0) {
									local255 = this.anIntArray120[local227 & 0xFF];
									if ((Static492.anInt7128 & 0xFFFFFF) == 16777215) {
										local264 = Static492.anInt7128 >>> 24;
									...
									} else if (Static492.anInt7153 == 255) {
										local264 = (local255 & 0xFF0000) * Static492.anInt7123 & 0xFF000000;
										local268 = (local255 & 0xFF00) * Static492.anInt7135 & 0xFF0000;
										local272 = (local255 & 0xFF) * Static492.anInt7129 & 0xFF00;
										...
										local3[local51] = ((local255 & 0xFF00FF) * Static492.anInt7153 + (local344 & 0xFF00FF) * Static492.anInt7124 & 0xFF00FF00) + ((local255 & 0xFF00) * Static492.anInt7153 + (local344 & 0xFF00) * Static492.anInt7124 & 0xFF0000) >> 8;
									}
								}
							} else if (arg0 == 3) {
								local227 = this.aByteArray28[local48];
								local255 = local227 > 0 ? this.anIntArray120[local227] : 0;
								local264 = Static492.anInt7128;
								...
								if (local255 == 0 && Static492.anInt7153 != 255) {
									local255 = local344;
									local344 = local3[local51];
									local344 = ((local255 & 0xFF00FF) * Static492.anInt7153 + (local344 & 0xFF00FF) * Static492.anInt7124 & 0xFF00FF00) + ((local255 & 0xFF00) * Static492.anInt7153 + (local344 & 0xFF00) * Static492.anInt7124 & 0xFF0000) >> 8;
								}
								...
								if (local227 != 0) {
									local255 = this.anIntArray120[local227 & 0xFF];
									local264 = (local255 & 0xFF00FF) * Static492.anInt7153 & 0xFF00FF00;
									local268 = (local255 & 0xFF00) * Static492.anInt7153 & 0xFF0000;
									local3[local51++] = ((local264 | local268) >>> 8) + Static492.anInt7125;
								}
							} else {
					...
					local9++;
					Static492.anInt7150 += Static492.anInt7141;
				}
			} else if (Static492.anInt7146 < 0) {
				local9 = Static492.anInt7127;
				while (local9 < 0) {
					local12 = Static492.anInt7150;
					local14 = Static492.anInt7130;
					local16 = Static492.anInt7148 + Static492.anInt7149;
					local18 = Static492.anInt7143;
					if (local14 >= 0 && local14 - (super.anInt7152 << 12) < 0) {
						@Pc(928) int local928;
						if ((local928 = local16 - (super.anInt7132 << 12)) >= 0) {
							local935 = (Static492.anInt7146 - local928) / Static492.anInt7146;
							local18 += local935;
							local16 += Static492.anInt7146 * local935;
							local12 += local935;
						}
						@Pc(956) int local956;
						if ((local956 = (local16 - Static492.anInt7146) / Static492.anInt7146) > local18) {
							local18 = local956;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt7152 + (local14 >> 12);
							...
							local16 += Static492.anInt7146;
							local18++;
						}
					}
					local9++;
					Static492.anInt7130 += Static492.anInt7134;
					Static492.anInt7150 += Static492.anInt7141;
				}
			} else {
				local9 = Static492.anInt7127;
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt7152 << 12) < 0) {
						if (local16 < 0) {
							local935 = (Static492.anInt7146 - local16 - 1) / Static492.anInt7146;
							local18 += local935;
							local16 += Static492.anInt7146 * local935;
							local12 += local935;
						}
						@Pc(1888) int local1888;
						if ((local1888 = (local16 + 1 - (super.anInt7132 << 12) - Static492.anInt7146) / Static492.anInt7146) > local18) {
							local18 = local1888;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt7152 + (local14 >> 12);
		...
		} else if (Static492.anInt7138 < 0) {
			if (Static492.anInt7146 == 0) {
				local9 = Static492.anInt7127;
				while (local9 < 0) {
					local12 = Static492.anInt7150;
					local14 = Static492.anInt7130 + Static492.anInt7145;
					local16 = Static492.anInt7148;
					local18 = Static492.anInt7143;
					if (local16 >= 0 && local16 - (super.anInt7132 << 12) < 0) {
						@Pc(2794) int local2794;
						if ((local2794 = local14 - (super.anInt7152 << 12)) >= 0) {
							local935 = (Static492.anInt7138 - local2794) / Static492.anInt7138;
							local18 += local935;
							local14 += Static492.anInt7138 * local935;
							local12 += local935;
						}
						@Pc(2822) int local2822;
						if ((local2822 = (local14 - Static492.anInt7138) / Static492.anInt7138) > local18) {
							local18 = local2822;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt7152 + (local14 >> 12);
							...
							local14 += Static492.anInt7138;
							local18++;
						}
					}
					local9++;
					Static492.anInt7148 += Static492.anInt7126;
					Static492.anInt7150 += Static492.anInt7141;
				}
			} else if (Static492.anInt7146 < 0) {
				local9 = Static492.anInt7127;
				while (local9 < 0) {
					...
					if ((local3719 = local14 - (super.anInt7152 << 12)) >= 0) {
						local935 = (Static492.anInt7138 - local3719) / Static492.anInt7138;
						local18 += local935;
						local14 += Static492.anInt7138 * local935;
						local16 += Static492.anInt7146 * local935;
						local12 += local935;
					...
					if ((local3753 = (local14 - Static492.anInt7138) / Static492.anInt7138) > local18) {
						local18 = local3753;
					}
					@Pc(3765) int local3765;
					if ((local3765 = local16 - (super.anInt7132 << 12)) >= 0) {
						local935 = (Static492.anInt7146 - local3765) / Static492.anInt7146;
						local18 += local935;
						local14 += Static492.anInt7138 * local935;
						local16 += Static492.anInt7146 * local935;
						local12 += local935;
					...
					if ((local3799 = (local16 - Static492.anInt7146) / Static492.anInt7146) > local18) {
						local18 = local3799;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt7152 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local4702 = local14 - (super.anInt7152 << 12)) >= 0) {
						local935 = (Static492.anInt7138 - local4702) / Static492.anInt7138;
						local18 += local935;
						local14 += Static492.anInt7138 * local935;
						local16 += Static492.anInt7146 * local935;
						local12 += local935;
					...
					if ((local4736 = (local14 - Static492.anInt7138) / Static492.anInt7138) > local18) {
						local18 = local4736;
					}
					if (local16 < 0) {
						local935 = (Static492.anInt7146 - local16 - 1) / Static492.anInt7146;
					...
					if ((local4784 = (local16 + 1 - (super.anInt7132 << 12) - Static492.anInt7146) / Static492.anInt7146) > local18) {
						local18 = local4784;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt7152 + (local14 >> 12);
			...
			while (local9 < 0) {
				...
				if (local16 >= 0 && local16 - (super.anInt7132 << 12) < 0) {
					if (local14 < 0) {
						local935 = (Static492.anInt7138 - local14 - 1) / Static492.anInt7138;
						local18 += local935;
						local14 += Static492.anInt7138 * local935;
						local12 += local935;
					}
					@Pc(5726) int local5726;
					if ((local5726 = (local14 + 1 - (super.anInt7152 << 12) - Static492.anInt7138) / Static492.anInt7138) > local18) {
						local18 = local5726;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt7152 + (local14 >> 12);
			...
			for (local9 = Static492.anInt7127; local9 < 0; local9++) {
				local12 = Static492.anInt7150;
				local14 = Static492.anInt7130 + Static492.anInt7145;
				local16 = Static492.anInt7148 + Static492.anInt7149;
				local18 = Static492.anInt7143;
				...
				if ((local6663 = (local14 + 1 - (super.anInt7152 << 12) - Static492.anInt7138) / Static492.anInt7138) > local18) {
					local18 = local6663;
				}
				@Pc(6675) int local6675;
				if ((local6675 = local16 - (super.anInt7132 << 12)) >= 0) {
					local935 = (Static492.anInt7146 - local6675) / Static492.anInt7146;
					local18 += local935;
					local14 += Static492.anInt7138 * local935;
					local16 += Static492.anInt7146 * local935;
					local12 += local935;
				...
				if ((local6709 = (local16 - Static492.anInt7146) / Static492.anInt7146) > local18) {
					local18 = local6709;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt7152 + (local14 >> 12);
			...
			for (local9 = Static492.anInt7127; local9 < 0; local9++) {
				...
				if ((local7648 = (local14 + 1 - (super.anInt7152 << 12) - Static492.anInt7138) / Static492.anInt7138) > local18) {
					local18 = local7648;
				}
				if (local16 < 0) {
					local935 = (Static492.anInt7146 - local16 - 1) / Static492.anInt7146;
				...
				if ((local7696 = (local16 + 1 - (super.anInt7132 << 12) - Static492.anInt7146) / Static492.anInt7146) > local18) {
					local18 = local7696;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt7152 + (local14 >> 12);
	...
	@Override
	protected void method6400(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(3) int[] local3 = super.aClass101_Sub3_10.anIntArray471;
		@Pc(186) int local186;
		@Pc(9) int local9;
		@Pc(14) int local14;
		...
		if (Static492.anInt7138 == 0) {
			if (Static492.anInt7146 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local23 = Static492.anInt7150;
						local25 = Static492.anInt7130;
						local27 = Static492.anInt7148;
						local29 = Static492.anInt7143;
						if (local25 >= 0 && local27 >= 0 && local25 - (super.anInt7152 << 12) < 0 && local27 - (super.anInt7132 << 12) < 0) {
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
							local64 = local53 + Static492.anInt7150 - local23;
							if (local64 > 0) {
								local23 += local64;
								local29 += local64;
								local25 += Static492.anInt7138 * local64;
								local27 += Static492.anInt7146 * local64;
							} else {
								local58 -= local64;
							}
							if (local29 < local58) {
							...
							while (local29 < 0) {
								local111 = this.aByteArray28[(local27 >> 12) * super.anInt7152 + (local25 >> 12)];
								if (local111 == 0) {
									local23++;
								} else {
									local3[local23++] = this.anIntArray120[local111 & 0xFF];
								}
								local29++;
							}
						}
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local23 = Static492.anInt7150;
						local25 = Static492.anInt7130;
						local27 = Static492.anInt7148 + Static492.anInt7149;
						local29 = Static492.anInt7143;
						if (local25 >= 0 && local25 - (super.anInt7152 << 12) < 0) {
							@Pc(179) int local179;
							if ((local179 = local27 - (super.anInt7132 << 12)) >= 0) {
								local186 = (Static492.anInt7146 - local179) / Static492.anInt7146;
								local29 += local186;
								local27 += Static492.anInt7146 * local186;
								local23 += local186;
							}
							@Pc(207) int local207;
							if ((local207 = (local27 - Static492.anInt7146) / Static492.anInt7146) > local29) {
								local29 = local207;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt7152 << 12) < 0) {
							if (local27 < 0) {
								local186 = (Static492.anInt7146 - local27 - 1) / Static492.anInt7146;
								local29 += local186;
								local27 += Static492.anInt7146 * local186;
								local23 += local186;
							}
							@Pc(379) int local379;
							if ((local379 = (local27 + 1 - (super.anInt7132 << 12) - Static492.anInt7146) / Static492.anInt7146) > local29) {
								local29 = local379;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
			...
			if (Static492.anInt7146 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local23 = Static492.anInt7150;
						local25 = Static492.anInt7130 + Static492.anInt7145;
						local27 = Static492.anInt7148;
						local29 = Static492.anInt7143;
						if (local27 >= 0 && local27 - (super.anInt7132 << 12) < 0) {
							@Pc(525) int local525;
							if ((local525 = local25 - (super.anInt7152 << 12)) >= 0) {
								local186 = (Static492.anInt7138 - local525) / Static492.anInt7138;
								local29 += local186;
								local25 += Static492.anInt7138 * local186;
								local23 += local186;
							}
							@Pc(553) int local553;
							if ((local553 = (local25 - Static492.anInt7138) / Static492.anInt7138) > local29) {
								local29 = local553;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static492.anInt7143;
						@Pc(690) int local690;
						if ((local690 = local25 - (super.anInt7152 << 12)) >= 0) {
							local186 = (Static492.anInt7138 - local690) / Static492.anInt7138;
							local29 += local186;
							local25 += Static492.anInt7138 * local186;
							local27 += Static492.anInt7146 * local186;
							local23 += local186;
						...
						@Pc(724) int local724;
						if ((local724 = (local25 - Static492.anInt7138) / Static492.anInt7138) > local29) {
							local29 = local724;
						}
						@Pc(736) int local736;
						if ((local736 = local27 - (super.anInt7132 << 12)) >= 0) {
							local186 = (Static492.anInt7146 - local736) / Static492.anInt7146;
							local29 += local186;
							local25 += Static492.anInt7138 * local186;
							local27 += Static492.anInt7146 * local186;
							local23 += local186;
						...
						@Pc(770) int local770;
						if ((local770 = (local27 - Static492.anInt7146) / Static492.anInt7146) > local29) {
							local29 = local770;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static492.anInt7143;
						@Pc(913) int local913;
						if ((local913 = local25 - (super.anInt7152 << 12)) >= 0) {
							local186 = (Static492.anInt7138 - local913) / Static492.anInt7138;
							local29 += local186;
							local25 += Static492.anInt7138 * local186;
							local27 += Static492.anInt7146 * local186;
							local23 += local186;
						...
						@Pc(947) int local947;
						if ((local947 = (local25 - Static492.anInt7138) / Static492.anInt7138) > local29) {
							local29 = local947;
						}
						if (local27 < 0) {
							local186 = (Static492.anInt7146 - local27 - 1) / Static492.anInt7146;
						...
						@Pc(995) int local995;
						if ((local995 = (local27 + 1 - (super.anInt7132 << 12) - Static492.anInt7146) / Static492.anInt7146) > local29) {
							local29 = local995;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if (local27 >= 0 && local27 - (super.anInt7132 << 12) < 0) {
						if (local25 < 0) {
							local186 = (Static492.anInt7138 - local25 - 1) / Static492.anInt7138;
							local29 += local186;
							local25 += Static492.anInt7138 * local186;
							local23 += local186;
						}
						@Pc(1177) int local1177;
						if ((local1177 = (local25 + 1 - (super.anInt7152 << 12) - Static492.anInt7138) / Static492.anInt7138) > local29) {
							local29 = local1177;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1354 = (local25 + 1 - (super.anInt7152 << 12) - Static492.anInt7138) / Static492.anInt7138) > local29) {
						local29 = local1354;
					}
					@Pc(1366) int local1366;
					if ((local1366 = local27 - (super.anInt7132 << 12)) >= 0) {
						local186 = (Static492.anInt7146 - local1366) / Static492.anInt7146;
						local29 += local186;
						local25 += Static492.anInt7138 * local186;
						local27 += Static492.anInt7146 * local186;
						local23 += local186;
					...
					if ((local1400 = (local27 - Static492.anInt7146) / Static492.anInt7146) > local29) {
						local29 = local1400;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1579 = (local25 + 1 - (super.anInt7152 << 12) - Static492.anInt7138) / Static492.anInt7138) > local29) {
						local29 = local1579;
					}
					if (local27 < 0) {
						local186 = (Static492.anInt7146 - local27 - 1) / Static492.anInt7146;
					...
					if ((local1627 = (local27 + 1 - (super.anInt7132 << 12) - Static492.anInt7146) / Static492.anInt7146) > local29) {
						local29 = local1627;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
	...
	@OriginalMember(owner = "client!dv", name = "a", descriptor = "(IILclient!aa;II)V")
	@Override
	public void method7708(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class1 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (super.aClass101_Sub3_10.method8161()) {
			throw new IllegalStateException();
		}
		arg0 += super.anInt7144;
		arg1 += super.anInt7133;
		@Pc(19) int local19 = 0;
		@Pc(23) int local23 = super.aClass101_Sub3_10.anInt9242;
		@Pc(26) int local26 = super.anInt7152;
		@Pc(29) int local29 = super.anInt7132;
		@Pc(33) int local33 = local23 - local26;
		@Pc(35) int local35 = 0;
		@Pc(41) int local41 = arg0 + arg1 * local23;
		@Pc(52) int local52;
		if (arg1 < super.aClass101_Sub3_10.anInt9238) {
			local52 = super.aClass101_Sub3_10.anInt9238 - arg1;
			local29 -= local52;
			arg1 = super.aClass101_Sub3_10.anInt9238;
			local19 = local52 * local26;
			local41 += local52 * local23;
		}
		if (arg1 + local29 > super.aClass101_Sub3_10.anInt9232) {
			local29 -= arg1 + local29 - super.aClass101_Sub3_10.anInt9232;
		}
		if (arg0 < super.aClass101_Sub3_10.anInt9244) {
			local52 = super.aClass101_Sub3_10.anInt9244 - arg0;
			local26 -= local52;
			arg0 = super.aClass101_Sub3_10.anInt9244;
			local19 += local52;
			local41 += local52;
			local35 = local52;
			local33 += local52;
		}
		if (arg0 + local26 > super.aClass101_Sub3_10.anInt9254) {
			local52 = arg0 + local26 - super.aClass101_Sub3_10.anInt9254;
			local26 -= local52;
			local35 += local52;
			local33 += local52;
		}
		...
		@Pc(162) int[] local162 = local159.anIntArray220;
		@Pc(165) int[] local165 = local159.anIntArray221;
		@Pc(169) int[] local169 = super.aClass101_Sub3_10.anIntArray471;
		@Pc(171) int local171 = arg1;
		if (arg4 > arg1) {
			local171 = arg4;
			local41 += (arg4 - arg1) * local23;
			local19 += (arg4 - arg1) * super.anInt7152;
		}
		...
		for (@Pc(212) int local212 = local171; local212 < local210; local212++) {
			...
			for (@Pc(304) int local304 = -local227; local304 < 0; local304++) {
				@Pc(311) byte local311 = this.aByteArray28[local19++];
				if (local311 == 0) {
					local41++;
				} else {
					local169[local41++] = this.anIntArray120[local311 & 0xFF];
				}
			}
	...
	protected void method7694(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		if (super.aClass101_Sub3_10.method8161()) {
			...
			@Pc(14) int local14 = 0;
			@Pc(16) int local16 = 0;
			@Pc(20) int local20 = super.aClass101_Sub3_10.anInt9242;
			@Pc(29) int local29 = super.anInt7144 + super.anInt7152 + super.anInt7142;
			@Pc(38) int local38 = super.anInt7133 + super.anInt7132 + super.anInt7147;
			@Pc(44) int local44 = (local29 << 16) / arg2;
			@Pc(50) int local50 = (local38 << 16) / arg3;
			@Pc(64) int local64;
			if (super.anInt7144 > 0) {
				local64 = ((super.anInt7144 << 16) + local44 - 1) / local44;
				arg0 += local64;
				local14 = local64 * local44 - (super.anInt7144 << 16);
			}
			if (super.anInt7133 > 0) {
				local64 = ((super.anInt7133 << 16) + local50 - 1) / local50;
				arg1 += local64;
				local16 = local64 * local50 - (super.anInt7133 << 16);
			}
			if (super.anInt7152 < local29) {
				arg2 = ((super.anInt7152 << 16) + local44 - local14 - 1) / local44;
			}
			if (super.anInt7132 < local38) {
				arg3 = ((super.anInt7132 << 16) + local50 - local16 - 1) / local50;
			}
			local64 = arg0 + arg1 * local20;
			@Pc(152) int local152 = local20 - arg2;
			if (arg1 + arg3 > super.aClass101_Sub3_10.anInt9232) {
				arg3 -= arg1 + arg3 - super.aClass101_Sub3_10.anInt9232;
			}
			@Pc(180) int local180;
			if (arg1 < super.aClass101_Sub3_10.anInt9238) {
				local180 = super.aClass101_Sub3_10.anInt9238 - arg1;
				arg3 -= local180;
				local64 += local180 * local20;
				local16 += local50 * local180;
			}
			if (arg0 + arg2 > super.aClass101_Sub3_10.anInt9254) {
				local180 = arg0 + arg2 - super.aClass101_Sub3_10.anInt9254;
				arg2 -= local180;
				local152 += local180;
			}
			if (arg0 < super.aClass101_Sub3_10.anInt9244) {
				local180 = super.aClass101_Sub3_10.anInt9244 - arg0;
				arg2 -= local180;
				local64 += local180;
				local14 += local44 * local180;
				local152 += local180;
			}
			@Pc(252) int[] local252 = super.aClass101_Sub3_10.anIntArray471;
			@Pc(259) int local259;
			@Pc(262) int local262;
			@Pc(270) int local270;
			@Pc(273) int local273;
			...
			if (arg6 != 0) {
				...
				if (arg6 == 1) {
					if (arg4 == 1) {
						...
						for (local262 = -arg3; local262 < 0; local262++) {
							local270 = (local16 >> 16) * super.anInt7152;
							for (local273 = -arg2; local273 < 0; local273++) {
								local446 = this.aByteArray28[(local14 >> 16) + local270];
								if (local446 == 0) {
									local64++;
								} else {
									local252[local64++] = this.anIntArray120[local446 & 0xFF];
								}
								local14 += local44;
							}
							local16 += local50;
						...
						if (arg4 == 0) {
							...
							if ((arg5 & 0xFFFFFF) == 16777215) {
								...
								for (local273 = -arg3; local273 < 0; local273++) {
									local335 = (local16 >> 16) * super.anInt7152;
									for (local343 = -arg2; local343 < 0; local343++) {
										local735 = this.aByteArray28[(local14 >> 16) + local335];
										if (local735 == 0) {
											local64++;
										} else {
											local361 = this.anIntArray120[local735 & 0xFF];
								...
								for (local346 = -arg3; local346 < 0; local346++) {
									local361 = (local16 >> 16) * super.anInt7152;
									for (local369 = -arg2; local369 < 0; local369++) {
										@Pc(852) byte local852 = this.aByteArray28[(local14 >> 16) + local361];
										if (local852 == 0) {
											local64++;
										} else {
											local385 = this.anIntArray120[local852 & 0xFF];
											if (local335 == 255) {
							...
							for (local273 = -arg3; local273 < 0; local273++) {
								...
								for (local343 = -arg2; local343 < 0; local343++) {
									local735 = this.aByteArray28[(local14 >> 16) + local335];
									local361 = local735 > 0 ? this.anIntArray120[local735] : 0;
							...
							for (local343 = -arg3; local343 < 0; local343++) {
								local346 = (local16 >> 16) * super.anInt7152;
								for (local361 = -arg2; local361 < 0; local361++) {
									local1196 = this.aByteArray28[(local14 >> 16) + local346];
									if (local1196 == 0) {
										local64++;
									} else {
										local377 = this.anIntArray120[local1196 & 0xFF];
					...
					for (local262 = -arg3; local262 < 0; local262++) {
						...
						for (local273 = -arg2; local273 < 0; local273++) {
							...
							if (local446 == 0) {
								...
								local343 = this.anIntArray120[local446 & 0xFF];
					...
					for (local335 = -arg3; local335 < 0; local335++) {
						local343 = (local16 >> 16) * super.anInt7152;
						for (local346 = -arg2; local346 < 0; local346++) {
							@Pc(1406) byte local1406 = this.aByteArray28[(local14 >> 16) + local343];
							if (local1406 == 0) {
								local64++;
							} else {
								local369 = this.anIntArray120[local1406 & 0xFF];
					...
					for (local262 = -arg3; local262 < 0; local262++) {
						...
						for (local273 = -arg2; local273 < 0; local273++) {
							local446 = this.aByteArray28[(local14 >> 16) + local270];
							local343 = local446 > 0 ? this.anIntArray120[local446] : 0;
				...
				for (local262 = -arg3; local262 < 0; local262++) {
					local270 = (local16 >> 16) * super.anInt7152;
					for (local273 = -arg2; local273 < 0; local273++) {
						local252[local64++] = this.anIntArray120[this.aByteArray28[(local14 >> 16) + local270] & 0xFF];
						local14 += local44;
					}
					local16 += local50;
					local14 = local259;
				...
				for (local335 = -arg3; local335 < 0; local335++) {
					local343 = (local16 >> 16) * super.anInt7152;
					for (local346 = -arg2; local346 < 0; local346++) {
						local361 = this.anIntArray120[this.aByteArray28[(local14 >> 16) + local343] & 0xFF];
				...
				for (local343 = -arg3; local343 < 0; local343++) {
					local346 = (local16 >> 16) * super.anInt7152;
					for (local361 = -arg2; local361 < 0; local361++) {
						local369 = this.anIntArray120[this.aByteArray28[(local14 >> 16) + local346] & 0xFF];
	...
	@Override
	public void method6401(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg3 <= 0 || arg4 <= 0) {
			return;
		}
		@Pc(6) int local6 = 0;
		@Pc(8) int local8 = 0;
		@Pc(17) int local17 = super.anInt7144 + super.anInt7152 + super.anInt7142;
		@Pc(26) int local26 = super.anInt7133 + super.anInt7132 + super.anInt7147;
		@Pc(32) int local32 = (local17 << 16) / arg3;
		@Pc(38) int local38 = (local26 << 16) / arg4;
		@Pc(52) int local52;
		if (super.anInt7144 > 0) {
			local52 = ((super.anInt7144 << 16) + local32 - 1) / local32;
			arg0 += local52;
			local6 = local52 * local32 - (super.anInt7144 << 16);
		}
		if (super.anInt7133 > 0) {
			local52 = ((super.anInt7133 << 16) + local38 - 1) / local38;
			arg1 += local52;
			local8 = local52 * local38 - (super.anInt7133 << 16);
		}
		if (super.anInt7152 < local17) {
			arg3 = ((super.anInt7152 << 16) + local32 - local6 - 1) / local32;
		}
		if (super.anInt7132 < local26) {
			arg4 = ((super.anInt7132 << 16) + local38 - local8 - 1) / local38;
		}
		local52 = arg0 + arg1 * super.aClass101_Sub3_10.anInt9242;
		@Pc(144) int local144 = super.aClass101_Sub3_10.anInt9242 - arg3;
		if (arg1 + arg4 > super.aClass101_Sub3_10.anInt9232) {
			arg4 -= arg1 + arg4 - super.aClass101_Sub3_10.anInt9232;
		}
		@Pc(172) int local172;
		if (arg1 < super.aClass101_Sub3_10.anInt9238) {
			local172 = super.aClass101_Sub3_10.anInt9238 - arg1;
			arg4 -= local172;
			local52 += local172 * super.aClass101_Sub3_10.anInt9242;
			local8 += local38 * local172;
		}
		if (arg0 + arg3 > super.aClass101_Sub3_10.anInt9254) {
			local172 = arg0 + arg3 - super.aClass101_Sub3_10.anInt9254;
			arg3 -= local172;
			local144 += local172;
		}
		if (arg0 < super.aClass101_Sub3_10.anInt9244) {
			local172 = super.aClass101_Sub3_10.anInt9244 - arg0;
			arg3 -= local172;
			local52 += local172;
			local6 += local32 * local172;
			local144 += local172;
		}
		@Pc(246) float[] local246 = super.aClass101_Sub3_10.aFloatArray58;
		@Pc(250) int[] local250 = super.aClass101_Sub3_10.anIntArray471;
		@Pc(257) int local257;
		@Pc(260) int local260;
		@Pc(268) int local268;
		@Pc(271) int local271;
		...
		if (arg7 != 0) {
			...
			if (arg7 == 1) {
				if (arg5 == 1) {
					...
					for (local260 = -arg4; local260 < 0; local260++) {
						local268 = (local8 >> 16) * super.anInt7152;
						for (local271 = -arg3; local271 < 0; local271++) {
							if ((float) arg2 < local246[local52]) {
								local475 = this.aByteArray28[(local6 >> 16) + local268];
								if (local475 != 0) {
									local250[local52] = this.anIntArray120[local475 & 0xFF];
					...
					if (arg5 == 0) {
						...
						if ((arg6 & 0xFFFFFF) == 16777215) {
							...
							for (local271 = -arg4; local271 < 0; local271++) {
								local345 = (local8 >> 16) * super.anInt7152;
								for (local353 = -arg3; local353 < 0; local353++) {
									if ((float) arg2 < local246[local52]) {
										local798 = this.aByteArray28[(local6 >> 16) + local345];
										if (local798 != 0) {
											local378 = this.anIntArray120[local798 & 0xFF];
							...
							for (local356 = -arg4; local356 < 0; local356++) {
								local378 = (local8 >> 16) * super.anInt7152;
								for (local386 = -arg3; local386 < 0; local386++) {
									if ((float) arg2 < local246[local52]) {
										@Pc(925) byte local925 = this.aByteArray28[(local6 >> 16) + local378];
										if (local925 != 0) {
											local402 = this.anIntArray120[local925 & 0xFF];
											if (local345 == 255) {
						...
						for (local271 = -arg4; local271 < 0; local271++) {
							...
							for (local353 = -arg3; local353 < 0; local353++) {
								if ((float) arg2 < local246[local52]) {
									local798 = this.aByteArray28[(local6 >> 16) + local345];
									local378 = local798 > 0 ? this.anIntArray120[local798] : 0;
						...
						for (local353 = -arg4; local353 < 0; local353++) {
							local356 = (local8 >> 16) * super.anInt7152;
							for (local378 = -arg3; local378 < 0; local378++) {
								if ((float) arg2 < local246[local52]) {
									local1295 = this.aByteArray28[(local6 >> 16) + local356];
									if (local1295 != 0) {
										local394 = this.anIntArray120[local1295 & 0xFF];
				...
				for (local260 = -arg4; local260 < 0; local260++) {
					...
					for (local271 = -arg3; local271 < 0; local271++) {
						if ((float) arg2 < local246[local52]) {
							local475 = this.aByteArray28[(local6 >> 16) + local268];
							if (local475 != 0) {
								local353 = this.anIntArray120[local475 & 0xFF];
				...
				for (local345 = -arg4; local345 < 0; local345++) {
					local353 = (local8 >> 16) * super.anInt7152;
					for (local356 = -arg3; local356 < 0; local356++) {
						if ((float) arg2 < local246[local52]) {
							@Pc(1525) byte local1525 = this.aByteArray28[(local6 >> 16) + local353];
							if (local1525 != 0) {
								local386 = this.anIntArray120[local1525 & 0xFF];
				...
				for (local260 = -arg4; local260 < 0; local260++) {
					...
					for (local271 = -arg3; local271 < 0; local271++) {
						if ((float) arg2 < local246[local52]) {
							local475 = this.aByteArray28[(local6 >> 16) + local268];
							local353 = local475 > 0 ? this.anIntArray120[local475] : 0;
			...
			for (local260 = -arg4; local260 < 0; local260++) {
				...
				for (local271 = -arg3; local271 < 0; local271++) {
					if ((float) arg2 < local246[local52]) {
						local250[local52] = this.anIntArray120[this.aByteArray28[(local6 >> 16) + local268] & 0xFF];
						local246[local52] = (float) arg2;
					}
					local6 += local32;
					local52++;
			...
			for (local345 = -arg4; local345 < 0; local345++) {
				...
				for (local356 = -arg3; local356 < 0; local356++) {
					if ((float) arg2 < local246[local52]) {
						local378 = this.anIntArray120[this.aByteArray28[(local6 >> 16) + local353] & 0xFF];
			...
			for (local353 = -arg4; local353 < 0; local353++) {
				...
				for (local378 = -arg3; local378 < 0; local378++) {
					if ((float) arg2 < local246[local52]) {
						local386 = this.anIntArray120[this.aByteArray28[(local6 >> 16) + local356] & 0xFF];
	...
	public void method7697(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		@Pc(11) int local11 = super.aClass101_Sub3_10.anInt9242;
		arg0 += super.anInt7144;
		arg1 += super.anInt7133;
		@Pc(27) int local27 = arg1 * local11 + arg0;
		@Pc(29) int local29 = 0;
		@Pc(32) int local32 = super.anInt7132;
		@Pc(35) int local35 = super.anInt7152;
		...
		if (arg1 + local32 > super.aClass101_Sub3_10.anInt9232) {
			local32 -= arg1 + local32 - super.aClass101_Sub3_10.anInt9232;
		}
		if (arg0 < super.aClass101_Sub3_10.anInt9244) {
			local52 = super.aClass101_Sub3_10.anInt9244 - arg0;
			local35 -= local52;
		...
		if (arg0 + local35 > super.aClass101_Sub3_10.anInt9254) {
			local52 = arg0 + local35 - super.aClass101_Sub3_10.anInt9254;
			local35 -= local52;
			local41 += local52;
			local39 += local52;
		}
		...
		@Pc(160) int[] local160 = super.aClass101_Sub3_10.anIntArray471;
		@Pc(168) int local168;
		@Pc(175) int local175;
		@Pc(284) int local284;
		@Pc(287) int local287;
		...
		if (arg4 != 0) {
			...
			if (arg4 == 1) {
				if (arg2 == 1) {
					for (local168 = -local32; local168 < 0; local168++) {
						for (local175 = -local35; local175 < 0; local175++) {
							local543 = this.aByteArray28[local29++];
							if (local543 == 0) {
								local27++;
							} else {
								local287 = this.anIntArray120[local543 & 0xFF] | 0xFF000000;
					...
					if (arg2 == 0) {
						if ((arg3 & 0xFFFFFF) == 16777215) {
							...
							for (local284 = -local32; local284 < 0; local284++) {
								for (local287 = -local35; local287 < 0; local287++) {
									local645 = this.aByteArray28[local29++];
									if (local645 == 0) {
										local27++;
									} else {
										local303 = this.anIntArray120[local645 & 0xFF];
										local311 = local160[local27];
							...
							for (local303 = -local32; local303 < 0; local303++) {
								for (local311 = -local35; local311 < 0; local311++) {
									@Pc(746) byte local746 = this.aByteArray28[local29++];
									if (local746 == 0) {
										local27++;
									} else {
										local327 = this.anIntArray120[local746 & 0xFF];
										if (local287 == 255) {
						...
						for (local284 = -local32; local284 < 0; local284++) {
							for (local287 = -local35; local287 < 0; local287++) {
								local645 = this.aByteArray28[local29++];
								local303 = local645 > 0 ? this.anIntArray120[local645] : 0;
						...
						for (local291 = -local32; local291 < 0; local291++) {
							for (local303 = -local35; local303 < 0; local303++) {
								local1054 = this.aByteArray28[local29++];
								if (local1054 == 0) {
									local27++;
								} else {
									local319 = this.anIntArray120[local1054 & 0xFF];
				...
				for (local168 = -local32; local168 < 0; local168++) {
					for (local175 = -local35; local175 < 0; local175++) {
						...
						if (local543 == 0) {
							...
							local287 = this.anIntArray120[local543 & 0xFF];
				...
				for (local287 = -local32; local287 < 0; local287++) {
					for (local291 = -local35; local291 < 0; local291++) {
						@Pc(1228) byte local1228 = this.aByteArray28[local29++];
						if (local1228 == 0) {
							local27++;
						} else {
							local311 = this.anIntArray120[local1228 & 0xFF];
				...
				for (local168 = -local32; local168 < 0; local168++) {
					for (local175 = -local35; local175 < 0; local175++) {
						local543 = this.aByteArray28[local29++];
						local287 = local543 > 0 ? this.anIntArray120[local543] : 0;
			...
			for (local168 = -local32; local168 < 0; local168++) {
				...
				while (local27 < local175) {
					local160[local27++] = this.anIntArray120[this.aByteArray28[local29++] & 0xFF];
					local160[local27++] = this.anIntArray120[this.aByteArray28[local29++] & 0xFF];
					local160[local27++] = this.anIntArray120[this.aByteArray28[local29++] & 0xFF];
					local160[local27++] = this.anIntArray120[this.aByteArray28[local29++] & 0xFF];
				}
			...
			for (local287 = -local32; local287 < 0; local287++) {
				for (local291 = -local35; local291 < 0; local291++) {
					local303 = this.anIntArray120[this.aByteArray28[local29++] & 0xFF];
			...
			for (local168 = -local32; local168 < 0; local168++) {
				for (local175 = -local35; local175 < 0; local175++) {
					local284 = this.anIntArray120[this.aByteArray28[local29++] & 0xFF];
			...
			for (local291 = -local32; local291 < 0; local291++) {
				for (local303 = -local35; local303 < 0; local303++) {
					local311 = this.anIntArray120[this.aByteArray28[local29++] & 0xFF];
