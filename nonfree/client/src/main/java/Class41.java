...
public final class Class41 {
	...
	private float method1265(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2) {
	...
	private float method1266(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2) {
		...
		return Static73.method1264(local34);
	}

	@OriginalMember(owner = "client!jb", name = "a", descriptor = "(IF)I")
	public int method1267(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1) {
		@Pc(20) float local20;
		if (arg0 == 0) {
			local20 = (float) this.anIntArray178[0] + (float) (this.anIntArray178[1] - this.anIntArray178[0]) * arg1;
			@Pc(24) float local24 = local20 * 0.0030517578F;
			Static73.aFloat2 = (float) Math.pow(0.1D, (double) (local24 / 20.0F));
			Static73.anInt1644 = (int) (Static73.aFloat2 * 65536.0F);
		}
		if (this.anIntArray179[arg0] == 0) {
			return 0;
		}
		local20 = this.method1265(arg0, 0, arg1);
		Static73.aFloatArrayArray2[arg0][0] = -2.0F * local20 * (float) Math.cos((double) this.method1266(arg0, 0, arg1));
		Static73.aFloatArrayArray2[arg0][1] = local20 * local20;
		for (@Pc(77) int local77 = 1; local77 < this.anIntArray179[arg0]; local77++) {
			local20 = this.method1265(arg0, local77, arg1);
			@Pc(97) float local97 = -2.0F * local20 * (float) Math.cos((double) this.method1266(arg0, local77, arg1));
		...
		if (arg0 == 0) {
			for (local226 = 0; local226 < this.anIntArray179[0] * 2; local226++) {
				Static73.aFloatArrayArray2[0][local226] *= Static73.aFloat2;
			}
		}
		for (local226 = 0; local226 < this.anIntArray179[arg0] * 2; local226++) {
			Static73.anIntArrayArray12[arg0][local226] = (int) (Static73.aFloatArrayArray2[arg0][local226] * 65536.0F);
		}
		return this.anIntArray179[arg0] * 2;
	}

	@OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lclient!ff;Lclient!uc;)V")
	public void method1268(@OriginalArg(0) Class3_Sub12 arg0, @OriginalArg(1) Class79 arg1) {
		@Pc(3) int local3 = arg0.method1354();
		...
		this.anIntArray178[0] = arg0.method1359();
		this.anIntArray178[1] = arg0.method1359();
		@Pc(37) int local37 = arg0.method1354();
		@Pc(42) int local42;
		for (@Pc(39) int local39 = 0; local39 < 2; local39++) {
			for (local42 = 0; local42 < this.anIntArray179[local39]; local42++) {
				this.anIntArrayArrayArray6[local39][0][local42] = arg0.method1359();
				this.anIntArrayArrayArray7[local39][0][local42] = arg0.method1359();
			}
		}
		for (local42 = 0; local42 < 2; local42++) {
			for (@Pc(81) int local81 = 0; local81 < this.anIntArray179[local42]; local81++) {
				if ((local37 & 0x1 << local42 * 4 << local81) == 0) {
					...
					this.anIntArrayArrayArray6[local42][1][local81] = arg0.method1359();
					this.anIntArrayArrayArray7[local42][1][local81] = arg0.method1359();
				}
			}
		}
		if (local37 != 0 || this.anIntArray178[1] != this.anIntArray178[0]) {
			arg1.method2569(arg0);
		}
	}
}
