...
public abstract class Class41 {
	...
	public final void method6083(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4) {
		this.method6088(arg0, arg1, (float) this.RA() / 2.0F, (float) this.Q() / 2.0F, arg2, arg3, 0, arg4);
	}
	...
	public final void method6084(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.method6088(arg0, arg1, (float) this.RA() / 2.0F, (float) this.Q() / 2.0F, arg2, arg3, 1, 0);
	}

	@OriginalMember(owner = "client!o", name = "a", descriptor = "(IIII)V")
	public final void method6085(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	public final void method6086(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class102 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		if (arg4 == 0) {
			return;
		}
		...
		this.method6091(local37, local50, local67, local85, local102, local118, arg6, arg7, arg8);
	}

	@OriginalMember(owner = "client!o", name = "a", descriptor = "(FFIILclient!ta;II)V")
	public final void method6087(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Class102 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		this.method6086(arg0, arg1, (float) this.RA() / 2.0F, (float) this.Q() / 2.0F, 4096, arg2, arg3, arg4, arg5);
	}
	...
	private void method6088(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg4 == 0) {
			return;
		}
		@Pc(9) double local9 = (double) (arg5 & 0xFFFF) * 9.587379924285257E-5D;
	...
	public final void method6089(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	public final void method6090(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.W(arg0, arg1, 1, 0, 1);
	}

	@OriginalMember(owner = "client!o", name = "a", descriptor = "(FFFFFFLclient!ta;II)V")
	protected abstract void method6091(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) Class102 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8);
}
