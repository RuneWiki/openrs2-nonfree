...
public final class Static136 {
	...
	@OriginalMember(owner = "client!kb", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!kb;II)I")
	public static int method965(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class8_Sub11_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1625 -= arg10.anInt1627 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt1625 += arg10.anInt1627 * local63;
		arg10.anInt1623 = arg4;
		arg10.anInt1619 = arg5;
		arg10.anInt1620 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!kb", name = "a", descriptor = "(I[B[IIIIIIIILclient!kb;)I")
	public static int method966(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class8_Sub11_Sub2 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt1620 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!kb", name = "b", descriptor = "(II)I")
	public static int method973(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!kb", name = "a", descriptor = "([B[IIIIIIILclient!kb;)I")
	public static int method974(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class8_Sub11_Sub2 arg7) {
		arg2 >>= 0x8;
	...
	@OriginalMember(owner = "client!kb", name = "b", descriptor = "(I[B[IIIIIIIILclient!kb;)I")
	public static int method978(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class8_Sub11_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!kb", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!kb;)I")
	public static int method981(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class8_Sub11_Sub2 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt1625 += arg10.anInt1627 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt1623 = arg4 >> 2;
		arg10.anInt1619 = arg5 >> 2;
		arg10.anInt1620 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!kb", name = "a", descriptor = "([B[IIIIIIIILclient!kb;)I")
	public static int method986(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class8_Sub11_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1623 += arg8.anInt1628 * (local22 - arg3);
		arg8.anInt1619 += arg8.anInt1617 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt1625 = arg4 >> 2;
		arg8.anInt1620 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lclient!p;III)Lclient!kb;")
	public static Class8_Sub11_Sub2 method988(@OriginalArg(0) Class8_Sub9_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray37 == null || arg0.aByteArray37.length == 0 ? null : new Class8_Sub11_Sub2(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!kb", name = "a", descriptor = "(II[B[IIIIIIILclient!kb;II)I")
	public static int method989(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class8_Sub11_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lclient!p;II)Lclient!kb;")
	public static Class8_Sub11_Sub2 method990(@OriginalArg(0) Class8_Sub9_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray37 == null || arg0.aByteArray37.length == 0 ? null : new Class8_Sub11_Sub2(arg0, (int) ((long) arg0.anInt2236 * 256L * (long) 100 / (long) (Static23.anInt713 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!kb", name = "b", descriptor = "([B[IIIIIIILclient!kb;)I")
	public static int method991(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class8_Sub11_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!kb", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!kb;II)I")
	public static int method992(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class8_Sub11_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1625 -= arg10.anInt1627 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!kb", name = "a", descriptor = "(II[B[IIIIIIIILclient!kb;II)I")
	public static int method994(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class8_Sub11_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!kb", name = "b", descriptor = "(II[B[IIIIIIIILclient!kb;II)I")
	public static int method995(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class8_Sub11_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1623 -= arg8.anInt1628 * arg3;
		arg8.anInt1619 -= arg8.anInt1617 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!kb", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!kb;)I")
	public static int method996(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class8_Sub11_Sub2 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt1625 += arg10.anInt1627 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!kb", name = "b", descriptor = "([B[IIIIIIIILclient!kb;)I")
	public static int method997(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class8_Sub11_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1623 += arg8.anInt1628 * (local24 - arg3);
		arg8.anInt1619 += arg8.anInt1617 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!kb", name = "c", descriptor = "(II[B[IIIIIIIILclient!kb;II)I")
	public static int method1002(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class8_Sub11_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!kb", name = "b", descriptor = "(II[B[IIIIIIILclient!kb;II)I")
	public static int method1003(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class8_Sub11_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!kb", name = "d", descriptor = "(II[B[IIIIIIIILclient!kb;II)I")
