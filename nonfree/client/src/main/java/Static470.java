...
public final class Static470 {
	...
	@OriginalMember(owner = "client!cg", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!cg;II)I")
	public static int method959(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class4_Sub7_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1036 -= arg10.anInt1024 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt1036 += arg10.anInt1024 * local63;
		arg10.anInt1025 = arg4;
		arg10.anInt1035 = arg5;
		arg10.anInt1033 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!cg", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!cg;)I")
	public static int method964(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class4_Sub7_Sub1 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt1036 += arg10.anInt1024 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt1025 = arg4 >> 2;
		arg10.anInt1035 = arg5 >> 2;
		arg10.anInt1033 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!cg", name = "a", descriptor = "(I[B[IIIIIIIILclient!cg;)I")
	public static int method965(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class4_Sub7_Sub1 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt1033 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!cg", name = "a", descriptor = "(II[B[IIIIIIILclient!cg;II)I")
	public static int method966(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class4_Sub7_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!cg", name = "a", descriptor = "(II[B[IIIIIIIILclient!cg;II)I")
	public static int method967(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub7_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	public static int method969(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lclient!cv;III)Lclient!cg;")
	public static Class4_Sub7_Sub1 method971(@OriginalArg(0) Class4_Sub9_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray18 == null || arg0.aByteArray18.length == 0 ? null : new Class4_Sub7_Sub1(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!cg", name = "a", descriptor = "([B[IIIIIIILclient!cg;)I")
	public static int method976(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class4_Sub7_Sub1 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt1033 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lclient!cv;II)Lclient!cg;")
	public static Class4_Sub7_Sub1 method977(@OriginalArg(0) Class4_Sub9_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray18 == null || arg0.aByteArray18.length == 0 ? null : new Class4_Sub7_Sub1(arg0, (int) ((long) arg0.anInt1419 * 256L * (long) 100 / (long) (Static88.anInt6642 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!cg", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!cg;II)I")
	public static int method982(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class4_Sub7_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1036 -= arg10.anInt1024 * arg3;
		@Pc(23) int local23;
	...
	public static int method983(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!cg", name = "b", descriptor = "([B[IIIIIIILclient!cg;)I")
	public static int method984(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class4_Sub7_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!cg", name = "b", descriptor = "(II[B[IIIIIIILclient!cg;II)I")
	public static int method986(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class4_Sub7_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!cg", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!cg;)I")
	public static int method987(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class4_Sub7_Sub1 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt1036 += arg10.anInt1024 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!cg", name = "b", descriptor = "(II[B[IIIIIIIILclient!cg;II)I")
	public static int method990(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub7_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!cg", name = "b", descriptor = "(I[B[IIIIIIIILclient!cg;)I")
	public static int method992(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class4_Sub7_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!cg", name = "c", descriptor = "(II[B[IIIIIIIILclient!cg;II)I")
	public static int method994(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub7_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1025 -= arg8.anInt1030 * arg3;
		arg8.anInt1035 -= arg8.anInt1034 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!cg", name = "a", descriptor = "([B[IIIIIIIILclient!cg;)I")
	public static int method995(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class4_Sub7_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1025 += arg8.anInt1030 * (local22 - arg3);
		arg8.anInt1035 += arg8.anInt1034 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt1036 = arg4 >> 2;
		arg8.anInt1033 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!cg", name = "d", descriptor = "(II[B[IIIIIIIILclient!cg;II)I")
	public static int method997(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub7_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1025 -= arg8.anInt1030 * arg3;
		arg8.anInt1035 -= arg8.anInt1034 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!cg", name = "b", descriptor = "([B[IIIIIIIILclient!cg;)I")
	public static int method998(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class4_Sub7_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1025 += arg8.anInt1030 * (local24 - arg3);
		arg8.anInt1035 += arg8.anInt1034 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
