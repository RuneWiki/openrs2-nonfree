...
public final class Static240 {
	...
	public static int anInt6704;

	@OriginalMember(owner = "client!os", name = "a", descriptor = "(IIIIIII)V", line = 244)
	public static void method6017(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5) {
		Static230.method4150(arg2);
		@Pc(12) int local12 = 0;
		...
		@Pc(78) int local78;
		@Pc(86) int local86;
		if (arg1 >= Class2_Sub40.anInt6819 && arg1 <= Class2_Sub20.anInt2951) {
			@Pc(52) int[] local52 = Static332.anIntArrayArray58[arg1];
			local61 = Static24.method861(Class25_Sub1.anInt675, arg5 - arg2, Class61.anInt1835);
			local70 = Static24.method861(Class25_Sub1.anInt675, arg5 + arg2, Class61.anInt1835);
			local78 = Static24.method861(Class25_Sub1.anInt675, arg5 - local16, Class61.anInt1835);
			local86 = Static24.method861(Class25_Sub1.anInt675, local16 + arg5, Class61.anInt1835);
			Static94.method2165(local78, local52, arg0, local61);
			Static94.method2165(local86, local52, arg3, local78);
			Static94.method2165(local70, local52, arg0, local86);
		}
		while (local22 > local12) {
			...
			if (local34 >= 0 && local31 >= 1) {
				local31--;
				local34 -= local31 << 1;
				Static282.anIntArray386[local31] = local12;
			}
			local12++;
			@Pc(203) int local203;
			@Pc(212) int local212;
			...
			if (local29 >= 0) {
				...
				if (local61 >= Class2_Sub40.anInt6819 && Class2_Sub20.anInt2951 >= local152) {
					if (local16 > local22) {
						local70 = Static282.anIntArray386[local22];
						local78 = Static24.method861(Class25_Sub1.anInt675, arg5 + local12, Class61.anInt1835);
						local86 = Static24.method861(Class25_Sub1.anInt675, arg5 - local12, Class61.anInt1835);
						local203 = Static24.method861(Class25_Sub1.anInt675, arg5 + local70, Class61.anInt1835);
						local212 = Static24.method861(Class25_Sub1.anInt675, arg5 - local70, Class61.anInt1835);
						if (local61 <= Class2_Sub20.anInt2951) {
							local223 = Static332.anIntArrayArray58[local61];
							Static94.method2165(local212, local223, arg0, local86);
							Static94.method2165(local203, local223, arg3, local212);
							Static94.method2165(local78, local223, arg0, local203);
						}
						if (Class2_Sub40.anInt6819 <= local152) {
							local223 = Static332.anIntArrayArray58[local152];
							Static94.method2165(local212, local223, arg0, local86);
							Static94.method2165(local203, local223, arg3, local212);
							Static94.method2165(local78, local223, arg0, local203);
						}
					} else {
						local70 = Static24.method861(Class25_Sub1.anInt675, local12 + arg5, Class61.anInt1835);
						local78 = Static24.method861(Class25_Sub1.anInt675, arg5 - local12, Class61.anInt1835);
						if (local61 <= Class2_Sub20.anInt2951) {
							Static94.method2165(local70, Static332.anIntArrayArray58[local61], arg0, local78);
						}
						if (Class2_Sub40.anInt6819 <= local152) {
							Static94.method2165(local70, Static332.anIntArrayArray58[local152], arg0, local78);
						}
					}
				}
			}
			...
			if (Class2_Sub40.anInt6819 <= local61 && Class2_Sub20.anInt2951 >= local152) {
				local70 = arg5 + local22;
				local78 = arg5 - local22;
				if (local70 >= Class25_Sub1.anInt675 && Class61.anInt1835 >= local78) {
					local70 = Static24.method861(Class25_Sub1.anInt675, local70, Class61.anInt1835);
					local78 = Static24.method861(Class25_Sub1.anInt675, local78, Class61.anInt1835);
					if (local12 >= local16) {
						if (local61 <= Class2_Sub20.anInt2951) {
							Static94.method2165(local70, Static332.anIntArrayArray58[local61], arg0, local78);
						}
						if (local152 >= Class2_Sub40.anInt6819) {
							Static94.method2165(local70, Static332.anIntArrayArray58[local152], arg0, local78);
						}
					} else {
						local86 = local31 >= local12 ? local31 : Static282.anIntArray386[local12];
						local203 = Static24.method861(Class25_Sub1.anInt675, arg5 + local86, Class61.anInt1835);
						local212 = Static24.method861(Class25_Sub1.anInt675, arg5 - local86, Class61.anInt1835);
						if (local61 <= Class2_Sub20.anInt2951) {
							local223 = Static332.anIntArrayArray58[local61];
							Static94.method2165(local212, local223, arg0, local78);
							Static94.method2165(local203, local223, arg3, local212);
							Static94.method2165(local70, local223, arg0, local203);
						}
						if (Class2_Sub40.anInt6819 <= local152) {
							local223 = Static332.anIntArrayArray58[local152];
							Static94.method2165(local212, local223, arg0, local78);
	...
	public static byte[][][] method6019(@OriginalArg(0) int arg0) {
