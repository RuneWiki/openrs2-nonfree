...
public final class Class6_Sub32 extends Class6 {
	...
	public Class6_Sub32(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) boolean arg3) {
		this.anInt5980 = arg0;
		this.anInt5979 = arg1;
		this.anIntArray440 = arg2;
		if (arg3) {
			@Pc(16) int[] local16 = new int[this.anInt5979];
			@Pc(20) int[] local20 = new int[this.anInt5979];
			@Pc(24) int[] local24 = new int[this.anInt5979];
			if (Static327.anIntArray439 == null || Static327.anIntArray439.length < this.anIntArray440.length) {
				Static327.anIntArray439 = new int[this.anIntArray440.length];
			}
			@Pc(40) int local40 = this.anInt5979;
			@Pc(43) int local43 = this.anInt5979;
			...
			for (@Pc(116) int local116 = local51; local116 >= 0; local116--) {
				...
				for (local64 = local47; local64 >= 0; local64--) {
					...
					local114--;
					Static327.anIntArray439[local114] = local165 << 16 | local169 << 8 | local173;
			...
			this.anIntArray440 = Static327.anIntArray439;
			Static327.anIntArray439 = local306;
		}
	}

	@OriginalMember(owner = "client!na", name = "a", descriptor = "(II)V")
	public void method5137(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 == 0 && arg1 == 0) {
			return;
		}
		if (Static327.anIntArray439 == null || Static327.anIntArray439.length != this.anIntArray440.length) {
		...
		@Pc(28) int local28 = this.anInt5979 - 1;
		@Pc(33) int local33 = this.anInt5979 * arg1;
		@Pc(37) int local37 = local21 - 1;
		for (@Pc(39) int local39 = 0; local39 < local21; local39 += this.anInt5979) {
			@Pc(46) int local46 = local39 + local33 & local37;
			for (@Pc(48) int local48 = 0; local48 < this.anInt5979; local48++) {
				@Pc(53) int local53 = local39 + local48;
				@Pc(61) int local61 = local46 + (local48 + arg0 & local28);
				Static327.anIntArray439[local53] = this.anIntArray440[local61];
			}
		}
		@Pc(84) int[] local84 = this.anIntArray440;
		this.anIntArray440 = Static327.anIntArray439;
		Static327.anIntArray439 = local84;
	}
