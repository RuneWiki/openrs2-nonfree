...
public final class Static333 {
	...
	@OriginalMember(owner = "client!nu", name = "a", descriptor = "Lclient!qp;")
	public static final Class239 aClass239_127 = new Class239(1, 10);
	...
	public static char method5306(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1) {
		if (arg0 >= 'À' && arg0 <= 'ÿ') {
			if (arg0 >= 'À' && arg0 <= 'Æ') {
				return 'A';
			}
