...
public final class Class4_Sub7 extends Class4 {
	...
	@OriginalMember(owner = "client!bj", name = "a", descriptor = "([I)Lclient!ri;")
	public Class4_Sub5_Sub1 method539(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray10 == null) {
			this.anInt536 = 0;
			this.aFloatArray4 = new float[Static24.anInt533];
			this.aByteArray10 = new byte[this.anInt528];
			this.anInt537 = 0;
			this.anInt538 = 0;
		}
		while (this.anInt538 < this.aByteArrayArray4.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(47) float[] local47 = this.method541(this.anInt538);
			if (local47 != null) {
				@Pc(52) int local52 = this.anInt537;
				@Pc(55) int local55 = local47.length;
				if (local55 > this.anInt528 - local52) {
					local55 = this.anInt528 - local52;
				}
				for (@Pc(68) int local68 = 0; local68 < local55; local68++) {
					...
					this.aByteArray10[local52++] = (byte) (local80 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local52 - this.anInt537;
				}
				this.anInt537 = local52;
			}
			this.anInt538++;
		}
		this.aFloatArray4 = null;
		@Pc(129) byte[] local129 = this.aByteArray10;
		this.aByteArray10 = null;
		return new Class4_Sub5_Sub1(this.anInt529, local129, this.anInt532, this.anInt531, this.aBoolean38);
	}

	@OriginalMember(owner = "client!bj", name = "d", descriptor = "(I)[F")
	private float[] method541(@OriginalArg(0) int arg0) {
		Static24.method542(this.aByteArrayArray4[arg0]);
		Static24.method540();
		@Pc(15) int local15 = Static24.method544(Static48.method945(Static24.anIntArray69.length - 1));
		@Pc(19) boolean local19 = Static24.aBooleanArray9[local15];
		@Pc(25) int local25 = local19 ? Static24.anInt533 : Static24.anInt530;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static24.method540() != 0;
			local29 = Static24.method540() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static24.anInt530 >> 2);
			local67 = (local25 >> 2) + (Static24.anInt530 >> 2);
			local71 = Static24.anInt530 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static24.anInt530 >> 2);
			local104 = local25 + (Static24.anInt530 >> 2) - (local25 >> 2);
			local108 = Static24.anInt530 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class94 local123 = Static24.aClass94Array1[Static24.anIntArray69[local15]];
		@Pc(126) int local126 = local123.anInt2916;
		@Pc(131) int local131 = local123.anIntArray240[local126];
		@Pc(140) boolean local140 = !Static24.aClass53Array1[local131].method1409();
		for (@Pc(144) int local144 = 0; local144 < local123.anInt2917; local144++) {
			@Pc(155) Class106 local155 = Static24.aClass106Array1[local123.anIntArray239[local144]];
			@Pc(157) float[] local157 = Static24.aFloatArray1;
			local155.method2631(local157, local25 >> 1, local140);
		}
		@Pc(176) int local176;
		if (!local140) {
			local131 = local123.anInt2916;
			local176 = local123.anIntArray240[local131];
			Static24.aClass53Array1[local176].method1404(Static24.aFloatArray1, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local131 = local25 >> 1; local131 < local25; local131++) {
				Static24.aFloatArray1[local131] = 0.0F;
			}
		} else {
			local131 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static24.aFloatArray1;
			@Pc(216) int local216;
			...
			@Pc(252) float[] local252 = local19 ? Static24.aFloatArray3 : Static24.aFloatArray2;
			@Pc(258) float[] local258 = local19 ? Static24.aFloatArray6 : Static24.aFloatArray8;
			@Pc(264) float[] local264 = local19 ? Static24.aFloatArray5 : Static24.aFloatArray7;
			@Pc(270) int[] local270 = local19 ? Static24.anIntArray67 : Static24.anIntArray68;
			@Pc(272) int local272;
			...
			local272 = Static48.method945(local25 - 1);
			@Pc(488) int local488;
			@Pc(499) int local499;
			@Pc(503) int local503;
			@Pc(505) int local505;
			...
			for (local488 = local59; local488 < local67; local488++) {
				...
				Static24.aFloatArray1[local488] *= (float) Math.sin((double) local309 * 1.5707963267948966D * (double) local309);
			}
		...
		if (this.anInt536 > 0) {
			local176 = this.anInt536 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1257) int local1257;
			if (!this.aBoolean40) {
				for (local212 = 0; local212 < this.anInt527; local212++) {
					local1257 = (this.anInt536 >> 1) + local212;
					local1228[local212] += this.aFloatArray4[local1257];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1257 = local1228.length + local212 - (local25 >> 1);
					local1228[local1257] += Static24.aFloatArray1[local212];
				}
			}
		}
		@Pc(1301) float[] local1301 = this.aFloatArray4;
		this.aFloatArray4 = Static24.aFloatArray1;
		Static24.aFloatArray1 = local1301;
		this.anInt536 = local25;
		this.anInt527 = local104 - (local25 >> 1);
		this.aBoolean40 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!bj", name = "b", descriptor = "([B)V")
	private void method543(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class4_Sub24 local4 = new Class4_Sub24(arg0);
		this.anInt529 = local4.method3084();
		this.anInt528 = local4.method3084();
		this.anInt532 = local4.method3084();
		this.anInt531 = local4.method3084();
		if (this.anInt531 < 0) {
			this.anInt531 = ~this.anInt531;
			this.aBoolean38 = true;
		}
		@Pc(40) int local40 = local4.method3084();
		this.aByteArrayArray4 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(51) int local51 = 0;
			@Pc(55) int local55;
			do {
				local55 = local4.method3110();
				local51 += local55;
			} while (local55 >= 255);
			@Pc(67) byte[] local67 = new byte[local51];
			local4.method3088(local51, local67);
			this.aByteArrayArray4[local46] = local67;
		}
	}
}
