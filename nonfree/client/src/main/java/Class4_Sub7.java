...
public final class Class4_Sub7 extends Class4 {
	...
	@OriginalMember(owner = "client!ega", name = "<init>", descriptor = "(ILclient!w;)V")
	public Class4_Sub7(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub54 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!ega", name = "<init>", descriptor = "(Lclient!w;)V")
	public Class4_Sub7(@OriginalArg(0) Class2_Sub54 arg0) {
		super(arg0);
	}
