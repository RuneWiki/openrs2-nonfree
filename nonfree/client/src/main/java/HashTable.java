...
public final class HashTable {
	...
	public HashTable(@OriginalArg(0) int arg0) {
		...
		for (@Pc(13) int local13 = 0; local13 < arg0; local13++) {
			@Pc(23) Linkable local23 = this.aClass4Array1[local13] = new Linkable();
	...
	public Linkable method2010(@OriginalArg(0) long arg0) {
		this.aLong100 = arg0;
		@Pc(24) Linkable local24 = this.aClass4Array1[(int) (arg0 & (long) (this.anInt3112 - 1))];
		for (this.aClass4_125 = local24.aClass4_124; this.aClass4_125 != local24; this.aClass4_125 = this.aClass4_125.aClass4_124) {
			if (arg0 == this.aClass4_125.aLong99) {
				@Pc(38) Linkable local38 = this.aClass4_125;
	...
	public void method2015(@OriginalArg(1) long arg0, @OriginalArg(2) Linkable arg1) {
		if (arg1.aClass4_123 != null) {
			arg1.method1999();
		}
		@Pc(17) Linkable local17 = this.aClass4Array1[(int) ((long) (this.anInt3112 - 1) & arg0)];
	...
	public Linkable method2016() {
		if (this.aClass4_125 == null) {
			return null;
		}
		@Pc(26) Linkable local26 = this.aClass4Array1[(int) ((long) (this.anInt3112 - 1) & this.aLong100)];
		while (this.aClass4_125 != local26) {
			if (this.aClass4_125.aLong99 == this.aLong100) {
				@Pc(37) Linkable local37 = this.aClass4_125;
				this.aClass4_125 = this.aClass4_125.aClass4_124;
				return local37;
			}
			this.aClass4_125 = this.aClass4_125.aClass4_124;
