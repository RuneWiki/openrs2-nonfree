...
public final class Static44 {
	...
	@OriginalMember(owner = "client!dc", name = "D", descriptor = "Lclient!lf;")
	public static Class1_Sub14 aClass1_Sub14_3 = new Class1_Sub14(10000);

	@OriginalMember(owner = "client!dc", name = "R", descriptor = "Lclient!dc;")
	public static Class15_Sub2_Sub1 aClass15_Sub2_Sub1_1 = new Class15_Sub2_Sub1();

	@OriginalMember(owner = "client!dc", name = "eb", descriptor = "Lclient!dc;")
	public static Class15_Sub2_Sub1 aClass15_Sub2_Sub1_2 = new Class15_Sub2_Sub1();

	@OriginalMember(owner = "client!dc", name = "fb", descriptor = "Lclient!dc;")
	public static Class15_Sub2_Sub1 aClass15_Sub2_Sub1_3 = new Class15_Sub2_Sub1();

	@OriginalMember(owner = "client!dc", name = "hb", descriptor = "Lclient!dc;")
	public static Class15_Sub2_Sub1 aClass15_Sub2_Sub1_4 = new Class15_Sub2_Sub1();

	@OriginalMember(owner = "client!dc", name = "ib", descriptor = "Lclient!dc;")
	public static Class15_Sub2_Sub1 aClass15_Sub2_Sub1_5 = new Class15_Sub2_Sub1();

	@OriginalMember(owner = "client!dc", name = "jb", descriptor = "Lclient!dc;")
	public static Class15_Sub2_Sub1 aClass15_Sub2_Sub1_6 = new Class15_Sub2_Sub1();
	...
	public static int[] anIntArray56 = new int[1];

	@OriginalMember(owner = "client!dc", name = "a", descriptor = "([FI)[F")
	public static float[] method851(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) float[] local2 = new float[arg1];
		Static319.method1764(arg0, 0, local2, 0, arg1);
		return local2;
	}

	@OriginalMember(owner = "client!dc", name = "a", descriptor = "(FFF)I")
	public static int method857(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
	...
	@OriginalMember(owner = "client!dc", name = "a", descriptor = "(IIIIII[FFIF)V")
	public static void method861(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) float arg7, @OriginalArg(8) int arg8, @OriginalArg(9) float arg9) {
	...
	@OriginalMember(owner = "client!dc", name = "a", descriptor = "([SI)[S")
	public static short[] method867(@OriginalArg(0) short[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) short[] local2 = new short[arg1];
		Static319.method1768(arg0, 0, local2, 0, arg1);
		return local2;
	}

	@OriginalMember(owner = "client!dc", name = "u", descriptor = "()V")
	public static void method868() {
		aClass15_Sub2_Sub1_1 = new Class15_Sub2_Sub1();
		aClass15_Sub2_Sub1_2 = new Class15_Sub2_Sub1();
		aClass15_Sub2_Sub1_3 = new Class15_Sub2_Sub1();
		aClass15_Sub2_Sub1_4 = new Class15_Sub2_Sub1();
		aClass15_Sub2_Sub1_5 = new Class15_Sub2_Sub1();
		aClass15_Sub2_Sub1_6 = new Class15_Sub2_Sub1();
	}

	@OriginalMember(owner = "client!dc", name = "a", descriptor = "(IIIIII[FIF)V")
	public static void method874(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) int arg7, @OriginalArg(8) float arg8) {
		@Pc(3) int local3 = arg0 - arg3;
		@Pc(7) int local7 = arg1 - arg4;
		@Pc(11) int local11 = arg2 - arg5;
		@Pc(32) float local32 = (float) local3 * arg6[0] + (float) local7 * arg6[1] + (float) local11 * arg6[2];
	...
	@OriginalMember(owner = "client!dc", name = "a", descriptor = "(ISIB)I")
	public static int method879(@OriginalArg(0) int arg0, @OriginalArg(1) short arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		@Pc(5) int local5 = Static215.anIntArray340[Static58.method1051(arg0, arg2)];
		if (arg1 != -1) {
			@Pc(15) int local15 = Static215.anInterface5_1.method778(arg1 & 0xFFFF);
			@Pc(21) int local21;
			@Pc(44) int local44;
			if (local15 != 0) {
				if (arg2 < 0) {
			...
			local21 = Static215.anInterface5_1.method784(arg1 & 0xFFFF);
			if (local21 != 0) {
				local21 += 256;
	...
	@OriginalMember(owner = "client!dc", name = "a", descriptor = "(IIIIFFF)[F")
	public static float[] method882(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6) {
