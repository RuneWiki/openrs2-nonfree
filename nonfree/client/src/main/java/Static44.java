...
public final class Static44 {
	...
	public static JagString aClass22_297 = Static60.method1113("Ihre Ignorieren)2Liste ist voll)1 Sie k-Onnen nur 100 Spieler darauf eintragen)3");

	@OriginalMember(owner = "client!hc", name = "c", descriptor = "Lclient!ec;")
	private static JagString aClass22_298 = Static60.method1113("Login server offline)3");

	@OriginalMember(owner = "client!hc", name = "d", descriptor = "[Lclient!ka;")
	public static PlayerEntity[] aClass4_Sub1_Sub3_Sub2_Sub1Array1 = new PlayerEntity[2048];

	@OriginalMember(owner = "client!hc", name = "e", descriptor = "Lclient!ec;")
	public static JagString aClass22_299 = aClass22_298;

	@OriginalMember(owner = "client!hc", name = "f", descriptor = "I")
	public static int anInt1212 = 0;

	@OriginalMember(owner = "client!hc", name = "g", descriptor = "Lclient!ec;")
	public static JagString aClass22_300 = Static60.method1113("cross");

	@OriginalMember(owner = "client!hc", name = "h", descriptor = "Lclient!ec;")
	public static JagString aClass22_301 = Static60.method1113("Wir vermuten)1 dass jemand Ihr Passwort kennt)3");

	@OriginalMember(owner = "client!hc", name = "j", descriptor = "Lclient!ec;")
	private static JagString aClass22_302 = Static60.method1113("Loaded title screen");

	@OriginalMember(owner = "client!hc", name = "k", descriptor = "Lclient!ec;")
	public static JagString aClass22_303 = aClass22_302;

	@OriginalMember(owner = "client!hc", name = "a", descriptor = "([Lclient!ec;B)Lclient!ec;")
	public static JagString method856(@OriginalArg(0) JagString[] arg0) {
		if (arg0.length < 2) {
	...
	public static void method857(@OriginalArg(0) Component arg0) {
		@Pc(9) Method local9 = SignLink.aMethod1;
		if (local9 != null) {
			try {
	...
	public static void method859(@OriginalArg(0) int arg0, @OriginalArg(1) Js5Provider arg1) {
	...
	public static int method860(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		@Pc(6) ClientInvCache local6 = (ClientInvCache) Static30.aClass81_4.method2010((long) arg0);
		if (local6 == null) {
			return 0;
	...
	public static Pix8 method862(@OriginalArg(1) Js5Index arg0, @OriginalArg(2) int arg1) {
	...
	public static void method863(@OriginalArg(1) Js5Index arg0) {
