...
public final class Class82 implements Interface2 {
	...
	public Class82() {
		if (Static94.aBoolean128 && Static94.anInt2081 >= 2) {
			this.method1785();
			@Pc(19) GL local19 = Static94.aGL1;
			local19.glBindTexture(34067, this.anIntArray186[0]);
			...
			local19.glBindTexture(34067, this.anIntArray186[1]);
			local19.glTexParameteri(34067, 10241, 9729);
			local19.glTexParameteri(34067, 10240, 9729);
			local19.glTexParameteri(34067, 32882, 33071);
			local19.glTexParameteri(34067, 10242, 33071);
			local19.glTexParameteri(34067, 10243, 33071);
			local19.glBindTexture(34067, this.anIntArray186[2]);
			local19.glTexParameteri(34067, 10241, 9729);
			local19.glTexParameteri(34067, 10240, 9729);
			local19.glTexParameteri(34067, 32882, 33071);
			local19.glTexParameteri(34067, 10242, 33071);
			local19.glTexParameteri(34067, 10243, 33071);
			this.aBoolean150 = Static94.anInt2081 < 3;
		}
		this.method1784();
	}
	...
	public void method3523(@OriginalArg(0) int arg0) {
		@Pc(1) GL local1 = Static94.aGL1;
		if (Static56.aBoolean66 && this.anIntArray186 != null) {
			local1.glActiveTexture(33985);
			local1.glBindTexture(34067, this.anIntArray186[arg0 - 1]);
	...
	private void method1784() {
		...
		local1.glNewList(this.anInt2236, 4864);
		if (this.anIntArray186 == null) {
			...
			if (this.aBoolean150) {
				...
				local1.glTexEnvi(8960, 34162, 7681);
				local1.glTexEnvi(8960, 34184, 34167);
				local1.glBindTexture(3553, Static94.anInt2075);
				local1.glEnable(3553);
			}
			local1.glActiveTexture(33984);
		}
		local1.glEndList();
		local1.glNewList(this.anInt2236 + 1, 4864);
		if (this.anIntArray186 == null) {
			local1.glTexEnvi(8960, 34184, 5890);
		} else {
			local1.glActiveTexture(33985);
