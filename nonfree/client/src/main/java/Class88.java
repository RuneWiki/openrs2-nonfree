...
public abstract class Class88 {
	...
	private void method8040(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg4 == 0) {
			return;
		}
		...
		this.method8042(local37, local50, local67, local85, local102, local118, arg6, arg7);
	}

	@OriginalMember(owner = "client!f", name = "a", descriptor = "(FFIILclient!ua;II)V")
	public final void method8041(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Class67 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		this.method8052(arg0, arg1, (float) this.A() / 2.0F, (float) this.ca() / 2.0F, 4096, arg2, arg3, arg4, arg5);
	}

	@OriginalMember(owner = "client!f", name = "a", descriptor = "(FFFFFFIII)V")
	private void method8042(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		this.qa(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, 1, 1);
	}

	@OriginalMember(owner = "client!f", name = "a", descriptor = "(IIII)V")
	public final void method8043(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.DA(arg0, arg1, arg2, arg3, 1, 0, 1);
	}

	@OriginalMember(owner = "client!f", name = "a", descriptor = "(FFIIIII)V")
	public final void method8044(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4) {
		this.method8040(arg0, arg1, (float) this.A() / 2.0F, (float) this.ca() / 2.0F, arg2, arg3, 0, arg4);
	}
	...
	public final void method8046(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.YA(arg0, arg1, arg2, arg3, 1, 0, 1, 1);
	}

	@OriginalMember(owner = "client!f", name = "a", descriptor = "(FFFFFFLclient!ua;II)V")
	private void method8047(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) Class67 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		this.method8048(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
	}

	@OriginalMember(owner = "client!f", name = "a", descriptor = "(FFFFFFILclient!ua;II)V")
	protected abstract void method8048(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(7) Class67 arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8);

	@OriginalMember(owner = "client!f", name = "a", descriptor = "(IIIIIII)V")
	public final void method8049(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
	...
	public final void method8050(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.method8040(arg0, arg1, (float) this.A() / 2.0F, (float) this.ca() / 2.0F, arg2, arg3, 1, 0);
	}
	...
	public final void method8051(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public final void method8052(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class67 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		if (arg4 == 0) {
			return;
		}
		@Pc(9) double local9 = (double) (arg5 & 0xFFFF) * 9.587379924285257E-5D;
		...
		@Pc(102) float local102 = (-arg2 * local23 + ((float) this.ca() - arg3) * local16) / 4096.0F + arg0;
		@Pc(118) float local118 = (arg2 * local16 + ((float) this.ca() - arg3) * local23) / 4096.0F + arg1;
		this.method8047(local37, local50, local67, local85, local102, local118, arg6, arg7, arg8);
	}
