...
public final class Class3_Sub13_Sub2 extends Class3_Sub13 {

	@OriginalMember(owner = "client!mj", name = "<init>", descriptor = "(IIIIIF)V")
	public Class3_Sub13_Sub2(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5) {
