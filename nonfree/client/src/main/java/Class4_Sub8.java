...
public final class Class4_Sub8 extends Class4 {
	...
	@OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(Lclient!ai;)V")
	public Class4_Sub8(@OriginalArg(0) Class13_Sub1 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!pf", name = "a", descriptor = "(IBLclient!bm;)V")
	@Override
