...
public final class Class4_Sub8 extends Class4 {
	...
	@OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(Lclient!w;)V")
	public Class4_Sub8(@OriginalArg(0) Class2_Sub54 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(ILclient!w;)V")
	public Class4_Sub8(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub54 arg1) {
		super(arg0, arg1);
	}
	...
	public int method9223(@OriginalArg(0) int arg0) {
		if (super.aClass2_Sub54_31.method9551()) {
			...
			if (arg0 == 0) {
				if (super.aClass2_Sub54_31.aClass4_Sub3_1.method498() == 1) {
					return 2;
				}
				if (super.aClass2_Sub54_31.aClass4_Sub21_1.method6610() == 1) {
					return 2;
				}
				if (super.aClass2_Sub54_31.aClass4_Sub24_1.method7684() > 0) {
					return 2;
				}
			}
			return 1;
