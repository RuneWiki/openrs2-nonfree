...
public final class Class162 implements Interface5 {

	@OriginalMember(owner = "client!ua", name = "b", descriptor = "[I")
	private int[] anIntArray458 = null;

	@OriginalMember(owner = "client!ua", name = "a", descriptor = "Z")
	private boolean aBoolean440 = false;

	@OriginalMember(owner = "client!ua", name = "c", descriptor = "I")
	private int anInt5258 = -1;

	@OriginalMember(owner = "client!ua", name = "<init>", descriptor = "()V")
	public Class162() {
		if (Static116.aBoolean199 && Static116.anInt2370 >= 2) {
			this.method3986();
			@Pc(19) GL local19 = Static116.aGL1;
			local19.glBindTexture(34067, this.anIntArray458[0]);
			...
			local19.glBindTexture(34067, this.anIntArray458[1]);
			local19.glTexParameteri(34067, 10241, 9729);
			local19.glTexParameteri(34067, 10240, 9729);
			local19.glTexParameteri(34067, 32882, 33071);
			local19.glTexParameteri(34067, 10242, 33071);
			local19.glTexParameteri(34067, 10243, 33071);
			local19.glBindTexture(34067, this.anIntArray458[2]);
			local19.glTexParameteri(34067, 10241, 9729);
			local19.glTexParameteri(34067, 10240, 9729);
			local19.glTexParameteri(34067, 32882, 33071);
			local19.glTexParameteri(34067, 10242, 33071);
			local19.glTexParameteri(34067, 10243, 33071);
			this.aBoolean440 = Static116.anInt2370 < 3;
		}
		this.method3985();
	}
	...
	public void method4313() {
		...
		if (Static76.aBoolean117) {
			local1.glCallList(this.anInt5258);
		} else {
	...
	public void method4314(@OriginalArg(0) int arg0) {
		@Pc(1) GL local1 = Static116.aGL1;
		if (Static76.aBoolean117 && this.anIntArray458 != null) {
			local1.glActiveTexture(33985);
			local1.glBindTexture(34067, this.anIntArray458[arg0 - 1]);
	...
	public void method4315() {
		@Pc(1) GL local1 = Static116.aGL1;
		if (Static76.aBoolean117) {
			local1.glCallList(this.anInt5258 + 1);
		} else {
	...
	private void method3985() {
		@Pc(1) GL local1 = Static116.aGL1;
		this.anInt5258 = local1.glGenLists(2);
		local1.glNewList(this.anInt5258, 4864);
		if (this.anIntArray458 == null) {
			...
			if (this.aBoolean440) {
				...
				local1.glTexEnvi(8960, 34162, 7681);
				local1.glTexEnvi(8960, 34184, 34167);
				local1.glBindTexture(3553, Static116.anInt2378);
				local1.glEnable(3553);
			}
			local1.glActiveTexture(33984);
		}
		local1.glEndList();
		local1.glNewList(this.anInt5258 + 1, 4864);
		if (this.anIntArray458 == null) {
			local1.glTexEnvi(8960, 34184, 5890);
		} else {
			local1.glActiveTexture(33985);
	...
	private void method3986() {
		@Pc(1) GL local1 = Static116.aGL1;
		if (this.anIntArray458 == null) {
			this.anIntArray458 = new int[3];
			local1.glGenTextures(3, this.anIntArray458, 0);
		}
