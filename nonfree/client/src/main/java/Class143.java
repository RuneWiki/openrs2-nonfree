...
public final class Class143 {
	...
	@OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lclient!bf;)V", line = 3)
	private void method3687(@OriginalArg(0) Class19_Sub1 arg0) {
		arg0.method817(true);
		if (arg0.aFloat3 != Static191.aFloat43) {
			arg0.method2840(Static191.aFloat43);
		}
		this.anOpengl2.glEnable(16384);
		this.anOpengl2.glEnable(16385);
	}

	@OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lclient!bf;I)V", line = 13)
	private void method3688(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1) {
		this.anOpengl2.glGetFloatv(2982, this.aFloatArray17, 0);
		...
		this.aClass2_Sub4_Sub1_2.anInt5289 = 0;
		@Pc(83) int local83;
		@Pc(98) int local98;
		@Pc(104) int local104;
			...
			for (local83 = arg1 - 1; local83 >= 0; local83--) {
				...
				if (local98 > 0) {
					for (local104 = local98 - 1; local104 >= 0; local104--) {
						...
						local116 = local113.anInt4462;
						local121 = (byte) (local116 >> 16);
						local126 = (byte) (local116 >> 8);
						local129 = (byte) local116;
						local134 = (byte) (local116 >>> 24);
						local140 = local113.anInt4458 >> Class80.anInt2251;
						local146 = local113.anInt4463 >> Class80.anInt2251;
						local152 = local113.anInt4460 >> Class80.anInt2251;
						local157 = local113.anInt4465 >> Class80.anInt2251;
						this.aClass2_Sub4_Sub1_2.method3060(0.0F);
						this.aClass2_Sub4_Sub1_2.method3060(0.0F);
						this.aClass2_Sub4_Sub1_2.method3060(local140 + local40 * (float) -local157);
						this.aClass2_Sub4_Sub1_2.method3060(local146 + local44 * (float) -local157);
						this.aClass2_Sub4_Sub1_2.method3060(local152 + local48 * (float) -local157);
						this.aClass2_Sub4_Sub1_2.method4843(local121);
						this.aClass2_Sub4_Sub1_2.method4843(local126);
						this.aClass2_Sub4_Sub1_2.method4843(local129);
						this.aClass2_Sub4_Sub1_2.method4843(local134);
						this.aClass2_Sub4_Sub1_2.method3060(1.0F);
						this.aClass2_Sub4_Sub1_2.method3060(0.0F);
						this.aClass2_Sub4_Sub1_2.method3060(local140 + local52 * (float) local157);
						this.aClass2_Sub4_Sub1_2.method3060(local146 + local56 * (float) local157);
						this.aClass2_Sub4_Sub1_2.method3060(local152 + local60 * (float) local157);
						this.aClass2_Sub4_Sub1_2.method4843(local121);
						this.aClass2_Sub4_Sub1_2.method4843(local126);
						this.aClass2_Sub4_Sub1_2.method4843(local129);
						this.aClass2_Sub4_Sub1_2.method4843(local134);
						...
						this.aClass2_Sub4_Sub1_2.method3060(0.0F);
						this.aClass2_Sub4_Sub1_2.method3060(1.0F);
						this.aClass2_Sub4_Sub1_2.method3060(local140 + local64 * (float) local157);
						this.aClass2_Sub4_Sub1_2.method3060(local146 + local68 * (float) local157);
						this.aClass2_Sub4_Sub1_2.method3060(local152 + local72 * (float) local157);
						this.aClass2_Sub4_Sub1_2.method4843(local121);
						this.aClass2_Sub4_Sub1_2.method4843(local126);
						this.aClass2_Sub4_Sub1_2.method4843(local129);
						this.aClass2_Sub4_Sub1_2.method4843(local134);
					...
					if (this.anIntArray223[local83] > 64) {
						...
						for (local424 = this.anIntArray222[local104] - 1; local424 >= 0; local424--) {
							...
							local436 = local433.anInt4462;
							local126 = (byte) (local436 >> 16);
							local129 = (byte) (local436 >> 8);
							local134 = (byte) local436;
							local454 = (byte) (local436 >>> 24);
							local146 = local433.anInt4458 >> Class80.anInt2251;
							local152 = local433.anInt4463 >> Class80.anInt2251;
							local472 = local433.anInt4460 >> Class80.anInt2251;
							local477 = local433.anInt4465 >> Class80.anInt2251;
							this.aClass2_Sub4_Sub1_2.method3060(0.0F);
							this.aClass2_Sub4_Sub1_2.method3060(0.0F);
							this.aClass2_Sub4_Sub1_2.method3060(local146 + local40 * (float) -local477);
							this.aClass2_Sub4_Sub1_2.method3060(local152 + local44 * (float) -local477);
							this.aClass2_Sub4_Sub1_2.method3060(local472 + local48 * (float) -local477);
							this.aClass2_Sub4_Sub1_2.method4843(local126);
							this.aClass2_Sub4_Sub1_2.method4843(local129);
							this.aClass2_Sub4_Sub1_2.method4843(local134);
							this.aClass2_Sub4_Sub1_2.method4843(local454);
							this.aClass2_Sub4_Sub1_2.method3060(1.0F);
							this.aClass2_Sub4_Sub1_2.method3060(0.0F);
							this.aClass2_Sub4_Sub1_2.method3060(local146 + local52 * (float) local477);
							this.aClass2_Sub4_Sub1_2.method3060(local152 + local56 * (float) local477);
							this.aClass2_Sub4_Sub1_2.method3060(local472 + local60 * (float) local477);
							this.aClass2_Sub4_Sub1_2.method4843(local126);
							this.aClass2_Sub4_Sub1_2.method4843(local129);
							this.aClass2_Sub4_Sub1_2.method4843(local134);
							this.aClass2_Sub4_Sub1_2.method4843(local454);
							...
							this.aClass2_Sub4_Sub1_2.method3060(0.0F);
							this.aClass2_Sub4_Sub1_2.method3060(1.0F);
							this.aClass2_Sub4_Sub1_2.method3060(local146 + local64 * (float) local477);
							this.aClass2_Sub4_Sub1_2.method3060(local152 + local68 * (float) local477);
							this.aClass2_Sub4_Sub1_2.method3060(local472 + local72 * (float) local477);
							this.aClass2_Sub4_Sub1_2.method4843(local126);
							this.aClass2_Sub4_Sub1_2.method4843(local129);
							this.aClass2_Sub4_Sub1_2.method4843(local134);
							this.aClass2_Sub4_Sub1_2.method4843(local454);
		...
		if (this.aClass2_Sub4_Sub1_2.anInt5289 != 0) {
			this.anInterface5_5.method4603(24, this.aClass2_Sub4_Sub1_2.aByteArray73, this.aClass2_Sub4_Sub1_2.anInt5289);
			arg0.method790(this.aClass126_9, null, this.aClass126_7, this.aClass126_8);
			arg0.method835(this.aClass2_Sub4_Sub1_2.anInt5289 / 24);
		}
	}

	@OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lclient!bf;Lclient!tp;)V", line = 361)
	public void method3689(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) Class224 arg1) {
		this.anOpengl2 = arg0.anOpengl1;
		if (arg0.aClass14_Sub2_2 == null) {
			return;
		}
		this.method3690(arg0);
		@Pc(14) float local14 = arg0.aClass14_Sub2_2.aFloat51;
		@Pc(18) float local18 = arg0.aClass14_Sub2_2.aFloat58;
		@Pc(22) float local22 = arg0.aClass14_Sub2_2.aFloat54;
		@Pc(26) float local26 = arg0.aClass14_Sub2_2.aFloat59;
		try {
			@Pc(31) int local31;
			@Pc(75) int local75;
			if (arg1.aBoolean429) {
				local31 = arg1.anInt6359 - arg1.anInt6357;
				if (local31 > 1600) {
					local31 = 1600;
				}
				...
				while (local323 != local320) {
					...
					while (local323 != local320) {
						...
						if (local329) {
							local325 = local365.anInt4467;
							local327 = local365.aBoolean307;
							local329 = false;
						} else if (local325 != local365.anInt4467 || local327 != local365.aBoolean307) {
							local329 = true;
							break;
						}
						@Pc(417) int local417 = (int) (local14 * (float) (local365.anInt4458 >> Class80.anInt2251) + local18 * (float) (local365.anInt4463 >> Class80.anInt2251) + local22 * (float) (local365.anInt4460 >> Class80.anInt2251) + local26) - arg1.anInt6357;
						if (local417 < 1600) {
							if (this.anIntArray223[local417] < 64) {
								...
								label129: {
									if (this.anIntArray223[local417] == 64) {
										if (this.anInt3725 == 64) {
											break label129;
										}
										this.anIntArray223[local417] += this.anInt3725++ + 1;
									}
					...
					if (local325 >= 0) {
						arg0.method848(arg0.aClass56_1.method1790(local325));
					} else {
						arg0.method848(null);
					}
					if (local327 && arg0.aFloat3 != Static191.aFloat43) {
						arg0.method2840(Static191.aFloat43);
					} else if (arg0.aFloat3 != 1.0F) {
						arg0.method2840(1.0F);
					}
					this.method3688(arg0, local31);
				}
			} else {
				local31 = 0;
				...
				for (local42 = local39.aClass12_Sub1_5; local42 != local39; local42 = local42.aClass12_Sub1_5) {
					...
					local75 = (int) (local14 * (float) (local48.anInt4458 >> Class80.anInt2251) + local18 * (float) (local48.anInt4463 >> Class80.anInt2251) + local22 * (float) (local48.anInt4460 >> Class80.anInt2251) + local26);
					if (local75 > local35) {
						local35 = local75;
					}
					if (local75 < local33) {
				...
				while (local42 != local39) {
					...
					while (local42 != local39) {
						...
						if (local115) {
							local75 = local151.anInt4467;
							local113 = local151.aBoolean307;
							local115 = false;
						}
						if (local31 > 0 && (local75 != local151.anInt4467 || local113 != local151.aBoolean307)) {
							local115 = true;
							break;
						}
							...
							if (this.anIntArray223[local182] < 64) {
								...
								label173: {
									if (this.anIntArray223[local182] == 64) {
										...
										this.anIntArray223[local182] += this.anInt3725++ + 1;
									}
					...
					if (local75 >= 0) {
						arg0.method848(arg0.aClass56_1.method1790(local75));
					} else {
						arg0.method848(null);
					}
					if (local113 && arg0.aFloat3 != Static191.aFloat43) {
						arg0.method2840(Static191.aFloat43);
					} else if (arg0.aFloat3 != 1.0F) {
						arg0.method2840(1.0F);
					}
					this.method3688(arg0, local99);
				}
			}
		} catch (@Pc(541) Exception local541) {
		}
		this.method3687(arg0);
	}

	@OriginalMember(owner = "client!lu", name = "b", descriptor = "(Lclient!bf;)V", line = 626)
	private void method3690(@OriginalArg(0) Class19_Sub1 arg0) {
		Static191.aFloat43 = arg0.aFloat3;
		arg0.method849();
	...
	@OriginalMember(owner = "client!lu", name = "c", descriptor = "(Lclient!bf;)V", line = 646)
	public void method3691(@OriginalArg(0) Class19_Sub1 arg0) {
