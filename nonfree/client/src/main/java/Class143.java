...
public final class Class143 implements Interface4 {
	...
	private int[] anIntArray450 = null;
	...
	public Class143() {
		if (Static294.aBoolean375 && Static294.anInt5869 >= 2) {
			this.method3655();
			@Pc(19) GL local19 = Static294.aGL1;
			local19.glBindTexture(34067, this.anIntArray450[0]);
			...
			local19.glBindTexture(34067, this.anIntArray450[1]);
			local19.glTexParameteri(34067, 10241, 9729);
			local19.glTexParameteri(34067, 10240, 9729);
			local19.glTexParameteri(34067, 32882, 33071);
			local19.glTexParameteri(34067, 10242, 33071);
			local19.glTexParameteri(34067, 10243, 33071);
			local19.glBindTexture(34067, this.anIntArray450[2]);
			local19.glTexParameteri(34067, 10241, 9729);
			local19.glTexParameteri(34067, 10240, 9729);
			local19.glTexParameteri(34067, 32882, 33071);
			local19.glTexParameteri(34067, 10242, 33071);
			local19.glTexParameteri(34067, 10243, 33071);
			this.aBoolean295 = Static294.anInt5869 < 3;
		}
		this.method3656();
	}
	...
	private void method3655() {
		...
		if (this.anIntArray450 == null) {
			this.anIntArray450 = new int[3];
			local1.glGenTextures(3, this.anIntArray450, 0);
		}
	...
	private void method3656() {
		@Pc(1) GL local1 = Static294.aGL1;
		this.anInt4854 = local1.glGenLists(2);
		local1.glNewList(this.anInt4854, 4864);
		if (this.anIntArray450 == null) {
			...
			if (this.aBoolean295) {
				...
				local1.glTexEnvi(8960, 34162, 7681);
				local1.glTexEnvi(8960, 34184, 34167);
				local1.glBindTexture(3553, Static294.anInt5881);
				local1.glEnable(3553);
			}
			local1.glActiveTexture(33984);
		}
		local1.glEndList();
		local1.glNewList(this.anInt4854 + 1, 4864);
		if (this.anIntArray450 == null) {
	...
	public void method3791() {
		...
		if (Static65.aBoolean96) {
			local1.glCallList(this.anInt4854 + 1);
		} else {
			local1.glTexEnvi(8960, 34184, 5890);
		}
	}
	...
	public void method3794() {
		...
		if (Static65.aBoolean96) {
			local1.glCallList(this.anInt4854);
		} else {
			local1.glTexEnvi(8960, 34184, 34167);
		}
	}
	...
	public void method3792(@OriginalArg(0) int arg0) {
		@Pc(1) GL local1 = Static294.aGL1;
		if (Static65.aBoolean96 && this.anIntArray450 != null) {
			local1.glActiveTexture(33985);
			local1.glBindTexture(34067, this.anIntArray450[arg0 - 1]);
			local1.glActiveTexture(33984);
		}
	}
}
