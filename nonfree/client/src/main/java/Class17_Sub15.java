...
public final class Class17_Sub15 extends Class17 {

	@OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Lclient!es;)V")
	public Class17_Sub15(@OriginalArg(0) Class5_Sub19 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(ILclient!es;)V")
	public Class17_Sub15(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub19 arg1) {
		super(arg0, arg1);
	}
	...
	public void method9168() {
		if (super.anInt10866 < 0 && super.anInt10866 > 127) {
