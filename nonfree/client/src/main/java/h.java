...
public final class h extends Class25 implements Interface7 {

	@OriginalMember(owner = "client!h", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!tba;[Lclient!be;[Lclient!ac;)V")
	public h(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class315 arg2, @OriginalArg(3) Class28[] arg3, @OriginalArg(4) Class5[] arg4) {
		super(arg0, arg2);
