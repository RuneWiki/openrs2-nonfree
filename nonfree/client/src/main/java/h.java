...
public final class h extends Class6 implements Interface10 {

	@OriginalMember(owner = "client!h", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!rc;[Lclient!jn;[Lclient!hu;)V")
	public h(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class298 arg2, @OriginalArg(3) Class176[] arg3, @OriginalArg(4) Class44[] arg4) {
		super(arg0, arg2);
