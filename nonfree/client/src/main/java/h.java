...
public final class h extends Class68 implements Interface5 {

	@OriginalMember(owner = "client!h", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!pga;[Lclient!tia;[Lclient!ug;)V")
	public h(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class289 arg2, @OriginalArg(3) Class355[] arg3, @OriginalArg(4) Class43[] arg4) {
		super(arg0, arg2);
