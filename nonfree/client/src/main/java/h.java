...
public final class h extends Class19 implements Interface7 {

	@OriginalMember(owner = "client!h", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!hw;[Lclient!fm;[Lclient!ho;)V")
	public h(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class151 arg2, @OriginalArg(3) Class112[] arg3, @OriginalArg(4) Class9[] arg4) {
		super(arg0, arg2);
