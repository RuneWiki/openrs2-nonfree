...
public final class h extends Class64 implements Interface8 {

	@OriginalMember(owner = "client!h", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!fp;[Lclient!fw;[Lclient!kr;)V")
	public h(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class114 arg2, @OriginalArg(3) Class120[] arg3, @OriginalArg(4) Class20[] arg4) {
		super(arg0, arg2);
