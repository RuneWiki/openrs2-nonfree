...
public final class h extends Class55 implements Interface4 {

	@OriginalMember(owner = "client!h", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!pia;[Lclient!gu;[Lclient!it;)V")
	public h(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class272 arg2, @OriginalArg(3) Class131[] arg3, @OriginalArg(4) Class28[] arg4) {
		super(arg0, arg2);
