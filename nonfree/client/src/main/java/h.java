...
public final class h extends Class63 implements Interface8 {

	@OriginalMember(owner = "client!h", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!ej;[Lclient!oia;[Lclient!fd;)V")
	public h(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class93 arg2, @OriginalArg(3) Class251[] arg3, @OriginalArg(4) Class103[] arg4) {
		super(arg0, arg2);
