...
public final class h extends Class18 implements Interface10 {

	@OriginalMember(owner = "client!h", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lclient!c;Lclient!k;Lclient!gg;[Lclient!ho;[Lclient!aa;)V")
	public h(@OriginalArg(0) c arg0, @OriginalArg(1) k arg1, @OriginalArg(2) Class84 arg2, @OriginalArg(3) Class98[] arg3, @OriginalArg(4) Class2[] arg4) {
		super(arg0, arg2);
		...
		this.U(arg0, arg1, local7, arg3[0].anIntArray260, local11, local15, local19, local23);
	}
	...
	private native void ma(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class74 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
