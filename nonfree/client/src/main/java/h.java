...
public final class h extends Class56 implements Interface10 {

	@OriginalMember(owner = "client!h", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!bq;[Lclient!cr;[Lclient!tf;)V")
	public h(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class31 arg2, @OriginalArg(3) Class51[] arg3, @OriginalArg(4) Class17[] arg4) {
		super(arg0, arg2);
