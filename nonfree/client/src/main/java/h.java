...
public final class h extends Class57 implements Interface6 {

	@OriginalMember(owner = "client!h", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!hw;[Lclient!tm;[Lclient!kw;)V")
	public h(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class169 arg2, @OriginalArg(3) Class361[] arg3, @OriginalArg(4) Class178[] arg4) {
		super(arg0, arg2);
