...
public final class h extends Class72 implements Interface5 {

	@OriginalMember(owner = "client!h", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!kf;[Lclient!re;[Lclient!qda;)V")
	public h(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class198 arg2, @OriginalArg(3) Class301[] arg3, @OriginalArg(4) Class59[] arg4) {
		super(arg0, arg2);
