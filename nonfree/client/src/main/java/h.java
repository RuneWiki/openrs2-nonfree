...
public final class h extends Class69 implements Interface6 {

	@OriginalMember(owner = "client!h", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!kc;[Lclient!gs;[Lclient!nf;)V")
	public h(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class202 arg2, @OriginalArg(3) Class150[] arg3, @OriginalArg(4) Class102[] arg4) {
		super(arg0, arg2);
