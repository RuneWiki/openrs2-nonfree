...
public final class h extends Class80 implements Interface3 {

	@OriginalMember(owner = "client!h", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!lq;[Lclient!iga;[Lclient!fs;)V")
	public h(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class224 arg2, @OriginalArg(3) Class173[] arg3, @OriginalArg(4) Class134[] arg4) {
		super(arg0, arg2);
