...
public final class h extends Class67 implements Interface12 {

	@OriginalMember(owner = "client!h", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!cd;[Lclient!cu;[Lclient!tb;)V")
	public h(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class53 arg2, @OriginalArg(3) Class64[] arg3, @OriginalArg(4) Class49[] arg4) {
		super(arg0, arg2);
