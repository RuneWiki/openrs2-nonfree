...
public final class h extends Class73 implements Interface7 {

	@OriginalMember(owner = "client!h", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!ne;[Lclient!vi;[Lclient!pu;)V")
	public h(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class247 arg2, @OriginalArg(3) Class369[] arg3, @OriginalArg(4) Class50[] arg4) {
		super(arg0, arg2);
