...
public final class h extends Class37 implements Interface3 {

	@OriginalMember(owner = "client!h", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!jl;[Lclient!hb;[Lclient!iea;)V")
	public h(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class183 arg2, @OriginalArg(3) Class139[] arg3, @OriginalArg(4) Class31[] arg4) {
		super(arg0, arg2);
