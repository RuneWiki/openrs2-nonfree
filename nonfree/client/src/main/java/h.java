...
public final class h extends Class68 implements Interface8 {

	@OriginalMember(owner = "client!h", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!oea;[Lclient!rh;[Lclient!mi;)V")
	public h(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class239 arg2, @OriginalArg(3) Class296[] arg3, @OriginalArg(4) Class46[] arg4) {
		super(arg0, arg2);
