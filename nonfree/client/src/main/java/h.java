...
public final class h extends Class70 implements Interface11 {

	@OriginalMember(owner = "client!h", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!kaa;[Lclient!uh;[Lclient!hk;)V")
	public h(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class196 arg2, @OriginalArg(3) Class362[] arg3, @OriginalArg(4) Class155[] arg4) {
		super(arg0, arg2);
