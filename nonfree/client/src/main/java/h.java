...
public final class h extends Class44 implements Interface4 {

	@OriginalMember(owner = "client!h", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!saa;[Lclient!jr;[Lclient!bka;)V")
	public h(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class330 arg2, @OriginalArg(3) Class194[] arg3, @OriginalArg(4) Class9[] arg4) {
		super(arg0, arg2);
