...
public final class Class11_Sub25 extends Class11 {
	...
	@OriginalMember(owner = "client!tba", name = "<init>", descriptor = "(Lclient!up;)V")
	public Class11_Sub25(@OriginalArg(0) Class5_Sub46 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!tba", name = "<init>", descriptor = "(ILclient!up;)V")
	public Class11_Sub25(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub46 arg1) {
		super(arg0, arg1);
	}
	...
	public int method8533(@OriginalArg(1) int arg0) {
		if (super.aClass5_Sub46_30.method8187()) {
			...
			if (arg0 == 0) {
				if (super.aClass5_Sub46_30.aClass11_Sub28_1.method8173() == 1) {
					return 2;
				}
				if (super.aClass5_Sub46_30.aClass11_Sub29_1.method8541() == 1) {
					return 2;
				}
				if (super.aClass5_Sub46_30.aClass11_Sub23_1.method7462() > 0) {
					return 2;
				}
			}
			return 1;
