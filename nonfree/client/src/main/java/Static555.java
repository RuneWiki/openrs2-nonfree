...
public final class Static555 {
	...
	@OriginalMember(owner = "client!or", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!or;II)I")
	public static int method5561(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub12_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt6513 -= arg10.anInt6510 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt6513 += arg10.anInt6510 * local63;
		arg10.anInt6505 = arg4;
		arg10.anInt6515 = arg5;
		arg10.anInt6504 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!or", name = "a", descriptor = "(II[B[IIIIIIIILclient!or;II)I")
	public static int method5562(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub12_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt6505 -= arg8.anInt6511 * arg3;
		arg8.anInt6515 -= arg8.anInt6512 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!or", name = "a", descriptor = "([B[IIIIIIIILclient!or;)I")
	public static int method5564(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub12_Sub3 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt6505 += arg8.anInt6511 * (local24 - arg3);
		arg8.anInt6515 += arg8.anInt6512 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt6513 = arg4 >> 2;
		arg8.anInt6504 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!or", name = "a", descriptor = "(I[B[IIIIIIIILclient!or;)I")
	public static int method5566(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub12_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
	...
	@OriginalMember(owner = "client!or", name = "a", descriptor = "(Lclient!mca;II)Lclient!or;")
	public static Class2_Sub12_Sub3 method5570(@OriginalArg(0) Class2_Sub31_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray91 == null || arg0.aByteArray91.length == 0 ? null : new Class2_Sub12_Sub3(arg0, (int) ((long) arg0.anInt5384 * 256L * (long) 100 / (long) (Static302.anInt5530 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!or", name = "a", descriptor = "([B[IIIIIIILclient!or;)I")
	public static int method5571(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub12_Sub3 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt6504 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!or", name = "a", descriptor = "(II[B[IIIIIIILclient!or;II)I")
	public static int method5576(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub12_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!or", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!or;II)I")
	public static int method5577(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub12_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt6513 -= arg10.anInt6510 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!or", name = "b", descriptor = "(II[B[IIIIIIIILclient!or;II)I")
	...
	@OriginalMember(owner = "client!or", name = "a", descriptor = "(Lclient!mca;III)Lclient!or;")
	public static Class2_Sub12_Sub3 method5580(@OriginalArg(0) Class2_Sub31_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray91 == null || arg0.aByteArray91.length == 0 ? null : new Class2_Sub12_Sub3(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!or", name = "b", descriptor = "(II)I")
	public static int method5584(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!or", name = "c", descriptor = "(II[B[IIIIIIIILclient!or;II)I")
	public static int method5585(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub12_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt6505 -= arg8.anInt6511 * arg3;
		arg8.anInt6515 -= arg8.anInt6512 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!or", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!or;)I")
	public static int method5586(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub12_Sub3 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt6513 += arg10.anInt6510 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt6505 = arg4 >> 2;
		arg10.anInt6515 = arg5 >> 2;
		arg10.anInt6504 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!or", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!or;)I")
	public static int method5588(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub12_Sub3 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt6513 += arg10.anInt6510 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!or", name = "b", descriptor = "(I[B[IIIIIIIILclient!or;)I")
	public static int method5590(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub12_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!or", name = "b", descriptor = "([B[IIIIIIIILclient!or;)I")
	public static int method5591(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub12_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt6505 += arg8.anInt6511 * (local22 - arg3);
		arg8.anInt6515 += arg8.anInt6512 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!or", name = "b", descriptor = "([B[IIIIIIILclient!or;)I")
	public static int method5594(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub12_Sub3 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	public static int method5597(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!or", name = "b", descriptor = "(II[B[IIIIIIILclient!or;II)I")
	public static int method5598(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub12_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!or", name = "d", descriptor = "(II[B[IIIIIIIILclient!or;II)I")
	public static int method5599(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub12_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
