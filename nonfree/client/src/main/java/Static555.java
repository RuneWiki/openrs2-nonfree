...
public final class Static555 {
	...
	@OriginalMember(owner = "client!ju", name = "a", descriptor = "([B[IIIIIIIILclient!ju;)I")
	public static int method4080(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub16_Sub2 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt4758 += arg8.anInt4760 * (local22 - arg3);
		arg8.anInt4757 += arg8.anInt4764 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt4751 = arg4 >> 2;
		arg8.anInt4759 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lclient!ti;III)Lclient!ju;")
	public static Class1_Sub16_Sub2 method4082(@OriginalArg(0) Class1_Sub37_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray111 == null || arg0.aByteArray111.length == 0 ? null : new Class1_Sub16_Sub2(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!ju", name = "a", descriptor = "(II[B[IIIIIIILclient!ju;II)I")
	public static int method4086(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub16_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lclient!ti;II)Lclient!ju;")
	public static Class1_Sub16_Sub2 method4088(@OriginalArg(0) Class1_Sub37_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray111 == null || arg0.aByteArray111.length == 0 ? null : new Class1_Sub16_Sub2(arg0, (int) ((long) arg0.anInt7861 * 256L * (long) 100 / (long) (Static477.anInt7971 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!ju", name = "a", descriptor = "(II)I")
	public static int method4089(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ju", name = "b", descriptor = "(II)I")
	public static int method4090(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ju", name = "a", descriptor = "([B[IIIIIIILclient!ju;)I")
	public static int method4091(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub16_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt4759 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ju", name = "a", descriptor = "(II[B[IIIIIIIILclient!ju;II)I")
	public static int method4092(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub16_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt4758 -= arg8.anInt4760 * arg3;
		arg8.anInt4757 -= arg8.anInt4764 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ju", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!ju;)I")
	public static int method4093(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub16_Sub2 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt4751 += arg10.anInt4756 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt4758 = arg4 >> 2;
		arg10.anInt4757 = arg5 >> 2;
		arg10.anInt4759 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!ju", name = "b", descriptor = "([B[IIIIIIILclient!ju;)I")
	public static int method4095(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub16_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!ju", name = "b", descriptor = "(II[B[IIIIIIIILclient!ju;II)I")
	public static int method4096(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub16_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ju", name = "b", descriptor = "([B[IIIIIIIILclient!ju;)I")
	public static int method4104(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub16_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt4758 += arg8.anInt4760 * (local24 - arg3);
		arg8.anInt4757 += arg8.anInt4764 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!ju", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!ju;II)I")
	public static int method4106(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub16_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt4751 -= arg10.anInt4756 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt4751 += arg10.anInt4756 * local63;
		arg10.anInt4758 = arg4;
		arg10.anInt4757 = arg5;
		arg10.anInt4759 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!ju", name = "c", descriptor = "(II[B[IIIIIIIILclient!ju;II)I")
	...
	@OriginalMember(owner = "client!ju", name = "a", descriptor = "(I[B[IIIIIIIILclient!ju;)I")
	public static int method4111(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub16_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!ju", name = "b", descriptor = "(II[B[IIIIIIILclient!ju;II)I")
	public static int method4113(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub16_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ju", name = "d", descriptor = "(II[B[IIIIIIIILclient!ju;II)I")
	public static int method4114(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub16_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt4758 -= arg8.anInt4760 * arg3;
		arg8.anInt4757 -= arg8.anInt4764 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ju", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!ju;)I")
	public static int method4116(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub16_Sub2 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt4751 += arg10.anInt4756 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!ju", name = "b", descriptor = "(I[B[IIIIIIIILclient!ju;)I")
	public static int method4117(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub16_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!ju", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!ju;II)I")
	public static int method4119(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub16_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt4751 -= arg10.anInt4756 * arg3;
		@Pc(23) int local23;
