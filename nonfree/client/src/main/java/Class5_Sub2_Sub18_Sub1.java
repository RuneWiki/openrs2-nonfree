...
public final class Class5_Sub2_Sub18_Sub1 extends Class5_Sub2_Sub18 {
	...
	public int[][] method5806(@OriginalArg(0) int arg0) {
		...
		if (super.aClass154_41.aBoolean336 && this.method2972()) {
			...
			@Pc(47) int local47 = arg0 % super.anInt3209 * super.anInt3209;
			for (@Pc(49) int local49 = 0; local49 < Static15.anInt493; local49++) {
				@Pc(61) int local61 = super.anIntArray220[local49 % super.anInt3204 + local47];
