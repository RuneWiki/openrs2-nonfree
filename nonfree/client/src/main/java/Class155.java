...
public final class Class155 {
	...
	public Class155() throws Exception {
	...
	private void exit() {
		...
		this.method3401((Frame) null, (byte) 34);
	}

	@OriginalMember(owner = "client!hda", name = "a", descriptor = "(Ljava/awt/Frame;B)V")
	private void method3401(@OriginalArg(0) Frame arg0, @OriginalArg(1) byte arg1) {
