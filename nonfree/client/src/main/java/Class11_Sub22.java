...
public final class Class11_Sub22 extends Class11 {
	...
	@OriginalMember(owner = "client!mia", name = "<init>", descriptor = "(Lclient!gl;)V")
	public Class11_Sub22(@OriginalArg(0) Class2_Sub30 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!mia", name = "<init>", descriptor = "(ILclient!gl;)V")
	public Class11_Sub22(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub30 arg1) {
		super(arg0, arg1);
	}
	...
	@OriginalMember(owner = "client!mia", name = "a", descriptor = "(IB)I")
	@Override
