...
public final class Class17_Sub23 extends Class17 {

	@OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(Lclient!eka;)V")
	public Class17_Sub23(@OriginalArg(0) Class3_Sub15 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(ILclient!eka;)V")
	public Class17_Sub23(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub15 arg1) {
		super(arg0, arg1);
	}
