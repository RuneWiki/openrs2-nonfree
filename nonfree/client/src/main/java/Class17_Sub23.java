...
public final class Class17_Sub23 extends Class17 {
	...
	@OriginalMember(owner = "client!te", name = "<init>", descriptor = "(ILclient!es;)V")
	public Class17_Sub23(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub19 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!te", name = "<init>", descriptor = "(Lclient!es;)V")
	public Class17_Sub23(@OriginalArg(0) Class5_Sub19 arg0) {
		super(arg0);
	}
