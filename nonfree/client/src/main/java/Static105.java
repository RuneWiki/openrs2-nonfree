...
public final class Static105 {
	...
	public static DoublyLinkList aClass78_2 = new DoublyLinkList();

	@OriginalMember(owner = "client!sa", name = "h", descriptor = "Lclient!ja;")
	public static LruCache aClass33_30 = new LruCache(50);

	@OriginalMember(owner = "client!sa", name = "i", descriptor = "[I")
	public static int[] anIntArray296 = new int[50];

	@OriginalMember(owner = "client!sa", name = "j", descriptor = "Lclient!ec;")
	public static JagString aClass22_780 = null;

	@OriginalMember(owner = "client!sa", name = "m", descriptor = "Lclient!ec;")
	public static JagString aClass22_781 = Static60.method1113("huffman");

	@OriginalMember(owner = "client!sa", name = "p", descriptor = "I")
	public static int anInt2642 = -1;

	@OriginalMember(owner = "client!sa", name = "a", descriptor = "(ZBBIILclient!ga;I)V")
	public static void method1729(@OriginalArg(0) boolean arg0, @OriginalArg(2) byte arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) Js5Provider arg4, @OriginalArg(6) int arg5) {
		@Pc(6) long local6 = (long) (arg2 + (arg3 << 16));
		@Pc(16) Js5NetRequest local16 = (Js5NetRequest) Static79.aClass81_10.method2010(local6);
		if (local16 != null) {
			return;
		}
		local16 = (Js5NetRequest) Static93.aClass81_13.method2010(local6);
		if (local16 != null) {
			return;
		}
		local16 = (Js5NetRequest) Static110.aClass81_14.method2010(local6);
		if (local16 == null) {
			if (!arg0) {
				local16 = (Js5NetRequest) Static27.aClass81_3.method2010(local6);
				if (local16 != null) {
					return;
				}
			}
