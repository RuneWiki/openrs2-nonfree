...
public final class Static186 {
	...
	@OriginalMember(owner = "client!ta", name = "a", descriptor = "([B[IIIIIIILclient!ta;)I")
	public static int method2312(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub5_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt3252 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ta", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!ta;)I")
	public static int method2314(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub5_Sub2 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt3253 += arg10.anInt3254 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt3261 = arg4 >> 2;
		arg10.anInt3260 = arg5 >> 2;
		arg10.anInt3252 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!ta", name = "a", descriptor = "(I[B[IIIIIIIILclient!ta;)I")
	public static int method2315(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub5_Sub2 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt3252 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!ta", name = "b", descriptor = "(I[B[IIIIIIIILclient!ta;)I")
	public static int method2319(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub5_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!ta", name = "a", descriptor = "([B[IIIIIIIILclient!ta;)I")
	public static int method2323(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub5_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt3261 += arg8.anInt3251 * (local22 - arg3);
		arg8.anInt3260 += arg8.anInt3259 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt3253 = arg4 >> 2;
		arg8.anInt3252 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ta", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!ta;II)I")
	public static int method2325(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub5_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt3253 -= arg10.anInt3254 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt3253 += arg10.anInt3254 * local63;
		arg10.anInt3261 = arg4;
		arg10.anInt3260 = arg5;
		arg10.anInt3252 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lclient!jc;II)Lclient!ta;")
	public static Class2_Sub5_Sub2 method2326(@OriginalArg(0) Class2_Sub10_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray21 == null || arg0.aByteArray21.length == 0 ? null : new Class2_Sub5_Sub2(arg0, (int) ((long) arg0.anInt1799 * 256L * (long) 100 / (long) (Static45.anInt1131 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!ta", name = "a", descriptor = "(II[B[IIIIIIIILclient!ta;II)I")
	public static int method2327(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub5_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt3261 -= arg8.anInt3251 * arg3;
		arg8.anInt3260 -= arg8.anInt3259 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ta", name = "a", descriptor = "(II[B[IIIIIIILclient!ta;II)I")
	public static int method2328(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub5_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ta", name = "b", descriptor = "([B[IIIIIIIILclient!ta;)I")
	public static int method2331(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub5_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt3261 += arg8.anInt3251 * (local24 - arg3);
		arg8.anInt3260 += arg8.anInt3259 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!ta", name = "b", descriptor = "(II[B[IIIIIIIILclient!ta;II)I")
	public static int method2334(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub5_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	public static int method2336(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ta", name = "c", descriptor = "(II[B[IIIIIIIILclient!ta;II)I")
	public static int method2337(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub5_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt3261 -= arg8.anInt3251 * arg3;
		arg8.anInt3260 -= arg8.anInt3259 * arg3;
		@Pc(32) int local32;
	...
	public static int method2339(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ta", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!ta;II)I")
	public static int method2343(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub5_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt3253 -= arg10.anInt3254 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!ta", name = "b", descriptor = "(II[B[IIIIIIILclient!ta;II)I")
	public static int method2344(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub5_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lclient!jc;III)Lclient!ta;")
	public static Class2_Sub5_Sub2 method2347(@OriginalArg(0) Class2_Sub10_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray21 == null || arg0.aByteArray21.length == 0 ? null : new Class2_Sub5_Sub2(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!ta", name = "b", descriptor = "([B[IIIIIIILclient!ta;)I")
	public static int method2349(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub5_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!ta", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!ta;)I")
	public static int method2350(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub5_Sub2 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt3253 += arg10.anInt3254 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!ta", name = "d", descriptor = "(II[B[IIIIIIIILclient!ta;II)I")
	public static int method2351(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub5_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
