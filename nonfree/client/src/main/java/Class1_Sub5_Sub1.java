...
public final class Class1_Sub5_Sub1 extends Class1_Sub5 implements Interface12 {

	@OriginalMember(owner = "client!lc", name = "B", descriptor = "Lclient!nm;")
	public Class1_Sub5 aClass1_Sub5_1;

	@OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(IIIIILclient!nm;)V")
	public Class1_Sub5_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Class1_Sub5 arg5) {
		super(arg2, arg3, arg4, Static404.method5459(arg1, arg0));
		this.aClass1_Sub5_1 = arg5;
	}

	@OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lclient!qa;B)V")
	@Override
	...
	@OriginalMember(owner = "client!lc", name = "a", descriptor = "(BLclient!rn;ZIILclient!qa;I)V")
	@Override
	...
	@OriginalMember(owner = "client!lc", name = "b", descriptor = "(Lclient!qa;B)Lclient!vs;")
	@Override
	...
	@OriginalMember(owner = "client!lc", name = "a", descriptor = "(IZILclient!qa;)Z")
	@Override
	...
	@OriginalMember(owner = "client!lc", name = "a", descriptor = "(BLclient!qa;)V")
	@Override
