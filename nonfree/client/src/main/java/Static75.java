...
public final class Static75 {
	...
	public static Js5Index aClass20_36;

	@OriginalMember(owner = "client!na", name = "n", descriptor = "Lclient!bf;")
	public static Huffman aClass10_1;

	@OriginalMember(owner = "client!na", name = "e", descriptor = "[[I")
	public static int[][] anIntArrayArray18 = new int[5][5000];

	@OriginalMember(owner = "client!na", name = "x", descriptor = "Lclient!ec;")
	private static JagString aClass22_557 = Static60.method1113("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789(Q(R+R(T(U^(V(Z(X(Y)2_=)0[*U]*W;:(W@(S*X)1<)3>)4?*6*V ");

	@OriginalMember(owner = "client!na", name = "i", descriptor = "Lclient!ec;")
	public static JagString aClass22_550 = aClass22_557;

	@OriginalMember(owner = "client!na", name = "k", descriptor = "Lclient!ec;")
	private static JagString aClass22_551 = Static60.method1113("Players");

	@OriginalMember(owner = "client!na", name = "m", descriptor = "Lclient!ec;")
	public static JagString aClass22_552 = Static60.method1113(" )2> <col=00ffff>");

	@OriginalMember(owner = "client!na", name = "o", descriptor = "Lclient!ec;")
	public static JagString aClass22_553 = Static60.method1113(" loggt sich aus)3");

	@OriginalMember(owner = "client!na", name = "p", descriptor = "Lclient!ec;")
	public static JagString aClass22_554 = Static60.method1113("Null");

	@OriginalMember(owner = "client!na", name = "r", descriptor = "Lclient!ec;")
	public static JagString aClass22_555 = aClass22_551;

	@OriginalMember(owner = "client!na", name = "s", descriptor = "Lclient!ec;")
	public static JagString aClass22_556 = Static60.method1113(" zuerst von Ihrer Ignorieren)2Liste(Q");

	@OriginalMember(owner = "client!na", name = "t", descriptor = "[I")
	public static int[] anIntArray199 = new int[200];

	@OriginalMember(owner = "client!na", name = "A", descriptor = "Lclient!ec;")
	public static JagString aClass22_558 = Static60.method1113("null");
	...
	public static void method1267(@OriginalArg(1) long arg0) {
		...
		@Pc(33) JagString local33 = Static8.method1575(arg0).method473();
		for (@Pc(35) int local35 = 0; local35 < Static2.anInt9; local35++) {
			if (Static29.aLongArray1[local35] == arg0) {
				Static65.method1153(Static44.method856(new JagString[] { local33, Static111.aClass22_839 }), 0, Static64.aClass22_485);
				return;
			}
		}
		for (@Pc(74) int local74 = 0; local74 < Static88.anInt2348; local74++) {
			if (Static85.aLongArray5[local74] == arg0) {
				Static65.method1153(Static44.method856(new JagString[] { Static5.aClass22_43, local33, Static129.aClass22_947 }), 0, Static64.aClass22_485);
				return;
			}
		}
	...
	public static void method1268(@OriginalArg(0) PathingEntity arg0, @OriginalArg(1) int arg1) {
	...
	public static void method1269() {
		for (@Pc(6) LocSpawned local6 = (LocSpawned) Static39.aClass82_4.method2025(); local6 != null; local6 = (LocSpawned) Static39.aClass82_4.method2023()) {
	...
	public static InvType method1272(@OriginalArg(0) int arg0) {
		@Pc(12) InvType local12 = (InvType) Static18.aClass33_9.method998((long) arg0);
		if (local12 != null) {
			return local12;
		}
		...
		local12 = new InvType();
		if (local27 != null) {
			local12.method1839(new Packet(local27));
		}
	...
	public static void method1273(@OriginalArg(0) JagString arg0) {
	...
	public static void method1274() {
		...
		for (@Pc(19) int local19 = 0; local19 < Static84.anInt2252; local19++) {
			...
			if (Static44.aClass4_Sub1_Sub3_Sub2_Sub1Array1[local25].anInt2475 != Client.anInt2877) {
