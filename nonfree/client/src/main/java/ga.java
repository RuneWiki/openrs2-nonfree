...
public final class ga extends Class20 implements Interface1 {

	@OriginalMember(owner = "client!ga", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Lclient!w;Lclient!g;Lclient!qm;[Lclient!wh;[Lclient!o;)V")
	public ga(@OriginalArg(0) w arg0, @OriginalArg(1) g arg1, @OriginalArg(2) Class209 arg2, @OriginalArg(3) Class266[] arg3, @OriginalArg(4) Class137[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			...
			local11[local25] = arg3[local25].anInt7823;
			local15[local25] = arg3[local25].anInt7824;
			local19[local25] = arg3[local25].anInt7825;
			local23[local25] = arg3[local25].anInt7826;
		}
		this.X(arg0, arg1, local7, arg3[0].anIntArray742, local11, local15, local19, local23);
	}
	...
	private native void v(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class24 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
