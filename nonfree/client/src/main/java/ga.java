...
public final class ga extends Class14 implements Interface13 {

	@OriginalMember(owner = "client!ga", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Lclient!w;Lclient!g;Lclient!aq;[Lclient!ok;[Lclient!o;)V")
	public ga(@OriginalArg(0) w arg0, @OriginalArg(1) g arg1, @OriginalArg(2) Class15 arg2, @OriginalArg(3) Class190[] arg3, @OriginalArg(4) Class41[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			...
			local11[local25] = arg3[local25].anInt5312;
			local15[local25] = arg3[local25].anInt5313;
			local19[local25] = arg3[local25].anInt5311;
			local23[local25] = arg3[local25].anInt5315;
		}
		this.X(arg0, arg1, local7, arg3[0].anIntArray453, local11, local15, local19, local23);
	}
	...
	private native void v(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class102 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
