...
public final class ga extends Class23 implements Interface11 {

	@OriginalMember(owner = "client!ga", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(Lclient!w;Lclient!g;Lclient!ap;[Lclient!rr;[Lclient!o;)V")
	public ga(@OriginalArg(0) w arg0, @OriginalArg(1) g arg1, @OriginalArg(2) Class14 arg2, @OriginalArg(3) Class214[] arg3, @OriginalArg(4) Class49[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray75;
			local11[local25] = arg3[local25].anInt5882;
			local15[local25] = arg3[local25].anInt5885;
			local19[local25] = arg3[local25].anInt5884;
			local23[local25] = arg3[local25].anInt5881;
		}
		this.X(arg0, arg1, local7, arg3[0].anIntArray419, local11, local15, local19, local23);
	}
	...
	private native void v(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class97 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
}
