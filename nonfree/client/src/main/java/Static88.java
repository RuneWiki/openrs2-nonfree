...
public final class Static88 {
	...
	public static Packet aClass4_Sub11_2;

	@OriginalMember(owner = "client!pb", name = "T", descriptor = "Lclient!ec;")
	public static JagString aClass22_670 = Static60.method1113("(Y<)4col>");

	@OriginalMember(owner = "client!pb", name = "W", descriptor = "I")
	public static int anInt2348 = 0;

	@OriginalMember(owner = "client!pb", name = "Y", descriptor = "Lclient!ec;")
	private static JagString aClass22_671 = Static60.method1113("shake:");
	...
	private static JagString aClass22_672 = Static60.method1113("slide:");

	@OriginalMember(owner = "client!pb", name = "pb", descriptor = "Lclient!ec;")
	public static JagString aClass22_673 = aClass22_672;

	@OriginalMember(owner = "client!pb", name = "qb", descriptor = "Lclient!ec;")
	public static JagString aClass22_674 = aClass22_671;

	@OriginalMember(owner = "client!pb", name = "rb", descriptor = "Lclient!ec;")
	public static JagString aClass22_675 = Static60.method1113("null");

	@OriginalMember(owner = "client!pb", name = "tb", descriptor = "Lclient!ec;")
	public static JagString aClass22_676 = aClass22_672;

	@OriginalMember(owner = "client!pb", name = "wb", descriptor = "Lclient!ec;")
	public static JagString aClass22_677 = Static60.method1113("Keine Antwort vom Anmelde)2Server)3");

	@OriginalMember(owner = "client!pb", name = "xb", descriptor = "Lclient!ec;")
	public static JagString aClass22_678 = aClass22_671;

	@OriginalMember(owner = "client!pb", name = "a", descriptor = "(I[Lclient!f;I)V")
	public static void method1557(@OriginalArg(0) int arg0, @OriginalArg(1) IfType[] arg1) {
		for (@Pc(12) int local12 = 0; local12 < arg1.length; local12++) {
			@Pc(18) IfType local18 = arg1[local12];
			if (local18 != null && local18.anInt802 == arg0 && (!local18.aBoolean79 || !Static98.method1667(local18))) {
				if (local18.anInt743 == 0) {
					...
					@Pc(69) ComponentPointer local69 = (ComponentPointer) Static90.aClass81_11.method2010((long) local18.anInt738);
					if (local69 != null) {
				...
				if (local18.anInt743 == 6) {
					...
					if (local18.anInt749 != -1 || local18.anInt760 != -1) {
						...
						if (local100 != -1) {
							@Pc(113) SeqType local113 = Static79.method1437(local100);
	...
	public static void method1558() {
		if (Static33.aClass57_1 != null) {
			@Pc(7) JavaMouseProvider local7 = Static33.aClass57_1;
