...
public final class Class3_Sub50 extends Class3 {
	...
	@OriginalMember(owner = "client!wda", name = "Q", descriptor = "I")
	private int anInt9338;

	@OriginalMember(owner = "client!wda", name = "<init>", descriptor = "([B)V")
	public Class3_Sub50(@OriginalArg(0) byte[] arg0) {
		this.method7755(arg0);
	}

	@OriginalMember(owner = "client!wda", name = "a", descriptor = "([I)Lclient!ug;")
	public Class3_Sub48_Sub1 method7746(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray101 == null) {
			this.anInt9333 = 0;
			this.aFloatArray112 = new float[Static577.anInt9328];
			this.aByteArray101 = new byte[this.anInt9329];
			this.anInt9338 = 0;
			this.anInt9337 = 0;
		}
		while (this.anInt9337 < this.aByteArrayArray24.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method7748(this.anInt9337);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt9338;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt9329 - local47) {
					local50 = this.anInt9329 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray101[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt9338;
				}
				this.anInt9338 = local47;
			}
			this.anInt9337++;
		}
		this.aFloatArray112 = null;
		@Pc(129) byte[] local129 = this.aByteArray101;
		this.aByteArray101 = null;
		return new Class3_Sub48_Sub1(this.anInt9335, local129, this.anInt9334, this.anInt9331, this.aBoolean726);
	}

	@OriginalMember(owner = "client!wda", name = "a", descriptor = "(I)[F")
	private float[] method7748(@OriginalArg(0) int arg0) {
		Static577.method7753(this.aByteArrayArray24[arg0]);
		Static577.method7749();
		@Pc(15) int local15 = Static577.method7751(Static565.method7622(Static577.anIntArray604.length - 1));
		@Pc(19) boolean local19 = Static577.aBooleanArray28[local15];
		@Pc(25) int local25 = local19 ? Static577.anInt9328 : Static577.anInt9332;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static577.method7749() != 0;
			local29 = Static577.method7749() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static577.anInt9332 >> 2);
			local67 = (local25 >> 2) + (Static577.anInt9332 >> 2);
			local71 = Static577.anInt9332 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static577.anInt9332 >> 2);
			local104 = local25 + (Static577.anInt9332 >> 2) - (local25 >> 2);
			local108 = Static577.anInt9332 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class64 local123 = Static577.aClass64Array1[Static577.anIntArray604[local15]];
		@Pc(126) int local126 = local123.anInt1873;
		@Pc(131) int local131 = local123.anIntArray87[local126];
		@Pc(140) boolean local140 = !Static577.aClass333Array1[local131].method6994();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt1874; local144++) {
			@Pc(152) Class316 local152 = Static577.aClass316Array1[local123.anIntArray88[local144]];
			local154 = Static577.aFloatArray111;
			local152.method6710(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt1873;
			local176 = local123.anIntArray87[local171];
			Static577.aClass333Array1[local176].method6993(Static577.aFloatArray111, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static577.aFloatArray111[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static577.aFloatArray111;
			...
			@Pc(252) float[] local252 = local19 ? Static577.aFloatArray107 : Static577.aFloatArray106;
			@Pc(258) float[] local258 = local19 ? Static577.aFloatArray108 : Static577.aFloatArray110;
			@Pc(264) float[] local264 = local19 ? Static577.aFloatArray105 : Static577.aFloatArray109;
			@Pc(270) int[] local270 = local19 ? Static577.anIntArray602 : Static577.anIntArray603;
			...
			@Pc(486) int local486 = Static565.method7622(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static577.aFloatArray111[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static577.aFloatArray111[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt9333 > 0) {
			local176 = this.anInt9333 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean727) {
				for (local212 = 0; local212 < this.anInt9327; local212++) {
					local1254 = (this.anInt9333 >> 1) + local212;
					local1228[local212] += this.aFloatArray112[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static577.aFloatArray111[local212];
				}
			}
		}
		local154 = this.aFloatArray112;
		this.aFloatArray112 = Static577.aFloatArray111;
		Static577.aFloatArray111 = local154;
		this.anInt9333 = local25;
		this.anInt9327 = local104 - (local25 >> 1);
		this.aBoolean727 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!wda", name = "b", descriptor = "([B)V")
	private void method7755(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class3_Sub11 local4 = new Class3_Sub11(arg0);
		this.anInt9335 = local4.method5186();
		this.anInt9329 = local4.method5186();
		this.anInt9334 = local4.method5186();
		this.anInt9331 = local4.method5186();
		if (this.anInt9331 < 0) {
			this.anInt9331 = ~this.anInt9331;
			this.aBoolean726 = true;
		}
		@Pc(40) int local40 = local4.method5186();
		this.aByteArrayArray24 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method5175();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method5183(local49, local64);
