...
public final class Class12_Sub35 extends Class12 {
	...
	public Class12_Sub35(@OriginalArg(0) byte[] arg0) {
		this.method5006(arg0);
	}

	@OriginalMember(owner = "client!mq", name = "a", descriptor = "([B)V")
	private void method5006(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class12_Sub8 local4 = new Class12_Sub8(arg0);
		this.anInt5993 = local4.method5225();
		this.anInt5997 = local4.method5225();
		this.anInt5998 = local4.method5225();
		this.anInt5992 = local4.method5225();
		if (this.anInt5992 < 0) {
			this.anInt5992 = ~this.anInt5992;
			this.aBoolean454 = true;
		}
		@Pc(40) int local40 = local4.method5225();
		this.aByteArrayArray11 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method5216();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method5181(local49, local64);
			this.aByteArrayArray11[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!mq", name = "a", descriptor = "([I)Lclient!ke;")
	public Class12_Sub29_Sub1 method5013(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray80 == null) {
			this.anInt5991 = 0;
			this.aFloatArray46 = new float[Static311.anInt5996];
			this.aByteArray80 = new byte[this.anInt5997];
			this.anInt6000 = 0;
			this.anInt6001 = 0;
		}
		while (this.anInt6001 < this.aByteArrayArray11.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method5014(this.anInt6001);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt6000;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt5997 - local47) {
					local50 = this.anInt5997 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray80[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt6000;
				}
				this.anInt6000 = local47;
			}
			this.anInt6001++;
		}
		this.aFloatArray46 = null;
		@Pc(129) byte[] local129 = this.aByteArray80;
		this.aByteArray80 = null;
		return new Class12_Sub29_Sub1(this.anInt5993, local129, this.anInt5998, this.anInt5992, this.aBoolean454);
	}

	@OriginalMember(owner = "client!mq", name = "c", descriptor = "(I)[F")
	private float[] method5014(@OriginalArg(0) int arg0) {
		Static311.method5004(this.aByteArrayArray11[arg0]);
		Static311.method5015();
		@Pc(15) int local15 = Static311.method5011(Static483.method7240(Static311.anIntArray417.length - 1));
		@Pc(19) boolean local19 = Static311.aBooleanArray38[local15];
		@Pc(25) int local25 = local19 ? Static311.anInt5996 : Static311.anInt5999;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static311.method5015() != 0;
			local29 = Static311.method5015() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static311.anInt5999 >> 2);
			local67 = (local25 >> 2) + (Static311.anInt5999 >> 2);
			local71 = Static311.anInt5999 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static311.anInt5999 >> 2);
			local104 = local25 + (Static311.anInt5999 >> 2) - (local25 >> 2);
			local108 = Static311.anInt5999 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class275 local123 = Static311.aClass275Array1[Static311.anIntArray417[local15]];
		@Pc(126) int local126 = local123.anInt8261;
		@Pc(131) int local131 = local123.anIntArray616[local126];
		@Pc(140) boolean local140 = !Static311.aClass48Array1[local131].method1427();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt8260; local144++) {
			@Pc(152) Class291 local152 = Static311.aClass291Array1[local123.anIntArray617[local144]];
			local154 = Static311.aFloatArray44;
			local152.method7209(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt8261;
			local176 = local123.anIntArray616[local171];
			Static311.aClass48Array1[local176].method1425(Static311.aFloatArray44, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static311.aFloatArray44[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static311.aFloatArray44;
			...
			@Pc(252) float[] local252 = local19 ? Static311.aFloatArray48 : Static311.aFloatArray42;
			@Pc(258) float[] local258 = local19 ? Static311.aFloatArray45 : Static311.aFloatArray43;
			@Pc(264) float[] local264 = local19 ? Static311.aFloatArray47 : Static311.aFloatArray49;
			@Pc(270) int[] local270 = local19 ? Static311.anIntArray419 : Static311.anIntArray418;
			...
			@Pc(486) int local486 = Static483.method7240(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static311.aFloatArray44[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static311.aFloatArray44[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt5991 > 0) {
			local176 = this.anInt5991 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean455) {
				for (local212 = 0; local212 < this.anInt5994; local212++) {
					local1254 = (this.anInt5991 >> 1) + local212;
					local1228[local212] += this.aFloatArray46[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static311.aFloatArray44[local212];
				}
			}
		}
		local154 = this.aFloatArray46;
		this.aFloatArray46 = Static311.aFloatArray44;
		Static311.aFloatArray44 = local154;
		this.anInt5991 = local25;
		this.anInt5994 = local104 - (local25 >> 1);
		this.aBoolean455 = local140;
		return local1228;
	}
}
