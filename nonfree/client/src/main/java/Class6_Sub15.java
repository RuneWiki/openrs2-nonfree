...
public final class Class6_Sub15 extends Class6 {
	...
	@OriginalMember(owner = "client!kga", name = "<init>", descriptor = "(Lclient!hs;)V")
	public Class6_Sub15(@OriginalArg(0) Class5_Sub25 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!kga", name = "<init>", descriptor = "(ILclient!hs;)V")
	public Class6_Sub15(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub25 arg1) {
		super(arg0, arg1);
	}
	...
	protected int method8535() {
		return super.aClass5_Sub25_32.method3681().method7218() > 1 ? 4 : 2;
	}
}
