...
public final class Class5_Sub19_Sub1 extends Class5_Sub19 {

	@OriginalMember(owner = "client!im", name = "<init>", descriptor = "(IIIIIF)V")
	public Class5_Sub19_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5) {
