...
public final class Static655 {
	...
	@OriginalMember(owner = "client!kca", name = "a", descriptor = "(Lclient!wo;III)Lclient!kca;")
	public static Class3_Sub3_Sub5 method4686(@OriginalArg(0) Class3_Sub18_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray106 == null || arg0.aByteArray106.length == 0 ? null : new Class3_Sub3_Sub5(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!kca", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!kca;II)I")
	public static int method4689(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub3_Sub5 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt5510 -= arg10.anInt5518 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt5510 += arg10.anInt5518 * local63;
		arg10.anInt5520 = arg4;
		arg10.anInt5513 = arg5;
		arg10.anInt5521 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!kca", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!kca;II)I")
	public static int method4690(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub3_Sub5 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt5510 -= arg10.anInt5518 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!kca", name = "a", descriptor = "(I[B[IIIIIIIILclient!kca;)I")
	public static int method4691(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub3_Sub5 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt5521 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!kca", name = "a", descriptor = "(II[B[IIIIIIILclient!kca;II)I")
	public static int method4692(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub3_Sub5 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!kca", name = "a", descriptor = "([B[IIIIIIIILclient!kca;)I")
	public static int method4695(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub3_Sub5 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt5520 += arg8.anInt5517 * (local24 - arg3);
		arg8.anInt5513 += arg8.anInt5512 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt5510 = arg4 >> 2;
		arg8.anInt5521 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!kca", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!kca;)I")
	public static int method4697(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub3_Sub5 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt5510 += arg10.anInt5518 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt5520 = arg4 >> 2;
		arg10.anInt5513 = arg5 >> 2;
		arg10.anInt5521 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!kca", name = "b", descriptor = "([B[IIIIIIIILclient!kca;)I")
	public static int method4699(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub3_Sub5 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt5520 += arg8.anInt5517 * (local22 - arg3);
		arg8.anInt5513 += arg8.anInt5512 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!kca", name = "a", descriptor = "(II[B[IIIIIIIILclient!kca;II)I")
	public static int method4700(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub3_Sub5 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt5520 -= arg8.anInt5517 * arg3;
		arg8.anInt5513 -= arg8.anInt5512 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!kca", name = "b", descriptor = "(II[B[IIIIIIIILclient!kca;II)I")
	public static int method4701(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub3_Sub5 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	public static int method4707(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!kca", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!kca;)I")
	public static int method4709(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub3_Sub5 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt5510 += arg10.anInt5518 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!kca", name = "b", descriptor = "(II[B[IIIIIIILclient!kca;II)I")
	public static int method4713(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub3_Sub5 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!kca", name = "a", descriptor = "([B[IIIIIIILclient!kca;)I")
	public static int method4715(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub3_Sub5 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt5521 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!kca", name = "c", descriptor = "(II[B[IIIIIIIILclient!kca;II)I")
	public static int method4717(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub3_Sub5 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt5520 -= arg8.anInt5517 * arg3;
		arg8.anInt5513 -= arg8.anInt5512 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!kca", name = "d", descriptor = "(II[B[IIIIIIIILclient!kca;II)I")
	public static int method4718(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub3_Sub5 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!kca", name = "b", descriptor = "([B[IIIIIIILclient!kca;)I")
	public static int method4719(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub3_Sub5 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	public static int method4720(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!kca", name = "b", descriptor = "(I[B[IIIIIIIILclient!kca;)I")
	public static int method4721(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub3_Sub5 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
