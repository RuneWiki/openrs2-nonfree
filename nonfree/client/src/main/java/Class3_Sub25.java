...
public final class Class3_Sub25 extends Class3 {
	...
	@OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(II[IZ)V")
	public Class3_Sub25(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) boolean arg3) {
		this.anInt3358 = arg0;
		this.anInt3359 = arg1;
		this.anIntArray234 = arg2;
		if (arg3) {
			@Pc(16) int[] local16 = new int[this.anInt3359];
			@Pc(20) int[] local20 = new int[this.anInt3359];
			@Pc(24) int[] local24 = new int[this.anInt3359];
			@Pc(28) int[] local28 = new int[this.anInt3359];
			if (Static201.anIntArray233 == null || Static201.anIntArray233.length != this.anIntArray234.length) {
				Static201.anIntArray233 = new int[this.anIntArray234.length];
			}
			@Pc(44) int local44 = this.anInt3359;
			@Pc(47) int local47 = this.anInt3359;
			...
			for (@Pc(65) int local65 = 2; local65 >= 0; local65--) {
				for (local68 = local51; local68 >= 0; local68--) {
					local62--;
					@Pc(75) int local75 = this.anIntArray234[local62];
			...
			for (@Pc(131) int local131 = local55; local131 >= 0; local131--) {
				...
				for (local68 = local51; local68 >= 0; local68--) {
					...
					local129--;
					Static201.anIntArray233[local129] = local188 << 24 | local192 << 16 | local196 << 8 | local200;
				...
				for (local68 = local51; local68 >= 0; local68--) {
					local62--;
					@Pc(277) int local277 = this.anIntArray234[local62];
					local63--;
					@Pc(283) int local283 = this.anIntArray234[local63];
			...
			@Pc(364) int[] local364 = this.anIntArray234;
			this.anIntArray234 = Static201.anIntArray233;
			Static201.anIntArray233 = local364;
		}
	}

	@OriginalMember(owner = "client!ge", name = "a", descriptor = "(II)V")
	public void method3066(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 == 0 && arg1 == 0) {
			return;
		}
		if (Static201.anIntArray233 == null || Static201.anIntArray233.length != this.anIntArray234.length) {
		...
		@Pc(21) int local21 = this.anIntArray234.length;
		@Pc(28) int local28 = this.anInt3359 - 1;
		@Pc(33) int local33 = this.anInt3359 * arg1;
		@Pc(37) int local37 = local21 - 1;
		for (@Pc(39) int local39 = 0; local39 < local21; local39 += this.anInt3359) {
			@Pc(46) int local46 = local39 + local33 & local37;
			for (@Pc(48) int local48 = 0; local48 < this.anInt3359; local48++) {
				@Pc(53) int local53 = local39 + local48;
				@Pc(61) int local61 = local46 + (local48 + arg0 & local28);
				Static201.anIntArray233[local53] = this.anIntArray234[local61];
			}
		}
		@Pc(84) int[] local84 = this.anIntArray234;
		this.anIntArray234 = Static201.anIntArray233;
		Static201.anIntArray233 = local84;
	}
