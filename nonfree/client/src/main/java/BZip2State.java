...
public final class BZip2State {
	...
	public final int[][] anIntArrayArray16 = new int[6][258];

	@OriginalMember(owner = "client!m", name = "d", descriptor = "[[I")
	public final int[][] anIntArrayArray15 = new int[6][258];

	@OriginalMember(owner = "client!m", name = "s", descriptor = "[I")
	public final int[] anIntArray191 = new int[257];

	@OriginalMember(owner = "client!m", name = "z", descriptor = "[B")
	public final byte[] aByteArray23 = new byte[18002];
	...
	public final byte[] aByteArray20 = new byte[4096];

	@OriginalMember(owner = "client!m", name = "K", descriptor = "[I")
	public final int[] anIntArray193 = new int[16];

	@OriginalMember(owner = "client!m", name = "H", descriptor = "[[I")
	public final int[][] anIntArrayArray17 = new int[6][258];

	@OriginalMember(owner = "client!m", name = "M", descriptor = "[I")
	public final int[] anIntArray194 = new int[6];
	...
	@OriginalMember(owner = "client!m", name = "Q", descriptor = "[I")
	public final int[] anIntArray195 = new int[256];
}
