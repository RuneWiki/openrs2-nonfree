...
public final class Class1_Sub29 extends Class1 {
	...
	private void method3125(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub28 local4 = new Class1_Sub28(arg0);
		this.anInt3809 = local4.method5355();
		this.anInt3807 = local4.method5355();
		this.anInt3808 = local4.method5355();
		this.anInt3806 = local4.method5355();
		if (this.anInt3806 < 0) {
			this.anInt3806 = ~this.anInt3806;
			this.aBoolean425 = true;
		}
		@Pc(40) int local40 = local4.method5355();
		this.aByteArrayArray14 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method5337();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method5344(local64, local49);
			this.aByteArrayArray14[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!kl", name = "c", descriptor = "(I)[F")
	private float[] method3126(@OriginalArg(0) int arg0) {
		Static212.method3131(this.aByteArrayArray14[arg0]);
		Static212.method3136();
		@Pc(15) int local15 = Static212.method3129(Static428.method5666(Static212.anIntArray232.length - 1));
		@Pc(19) boolean local19 = Static212.aBooleanArray12[local15];
		@Pc(25) int local25 = local19 ? Static212.anInt3810 : Static212.anInt3803;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static212.method3136() != 0;
			local29 = Static212.method3136() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static212.anInt3803 >> 2);
			local67 = (local25 >> 2) + (Static212.anInt3803 >> 2);
			local71 = Static212.anInt3803 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static212.anInt3803 >> 2);
			local104 = local25 + (Static212.anInt3803 >> 2) - (local25 >> 2);
			local108 = Static212.anInt3803 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class49 local123 = Static212.aClass49Array1[Static212.anIntArray232[local15]];
		@Pc(126) int local126 = local123.anInt1232;
		@Pc(131) int local131 = local123.anIntArray57[local126];
		@Pc(140) boolean local140 = !Static212.aClass243Array1[local131].method5256();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt1231; local144++) {
			@Pc(152) Class237 local152 = Static212.aClass237Array1[local123.anIntArray58[local144]];
			local154 = Static212.aFloatArray14;
			local152.method5099(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt1232;
			local176 = local123.anIntArray57[local171];
			Static212.aClass243Array1[local176].method5257(Static212.aFloatArray14, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static212.aFloatArray14[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static212.aFloatArray14;
			...
			@Pc(252) float[] local252 = local19 ? Static212.aFloatArray13 : Static212.aFloatArray16;
			@Pc(258) float[] local258 = local19 ? Static212.aFloatArray18 : Static212.aFloatArray15;
			@Pc(264) float[] local264 = local19 ? Static212.aFloatArray17 : Static212.aFloatArray12;
			@Pc(270) int[] local270 = local19 ? Static212.anIntArray230 : Static212.anIntArray231;
			...
			@Pc(486) int local486 = Static428.method5666(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static212.aFloatArray14[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static212.aFloatArray14[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt3804 > 0) {
			local176 = this.anInt3804 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean427) {
				for (local212 = 0; local212 < this.anInt3801; local212++) {
					local1254 = (this.anInt3804 >> 1) + local212;
					local1228[local212] += this.aFloatArray11[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static212.aFloatArray14[local212];
				}
			}
		}
		local154 = this.aFloatArray11;
		this.aFloatArray11 = Static212.aFloatArray14;
		Static212.aFloatArray14 = local154;
		this.anInt3804 = local25;
		this.anInt3801 = local104 - (local25 >> 1);
		this.aBoolean427 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!kl", name = "a", descriptor = "([I)Lclient!jj;")
	public Class1_Sub25_Sub1 method3135(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray47 == null) {
			this.anInt3804 = 0;
			this.aFloatArray11 = new float[Static212.anInt3810];
			this.aByteArray47 = new byte[this.anInt3807];
			this.anInt3811 = 0;
			this.anInt3812 = 0;
		}
		while (this.anInt3812 < this.aByteArrayArray14.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method3126(this.anInt3812);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt3811;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt3807 - local47) {
					local50 = this.anInt3807 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray47[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt3811;
				}
				this.anInt3811 = local47;
			}
			this.anInt3812++;
		}
		this.aFloatArray11 = null;
		@Pc(129) byte[] local129 = this.aByteArray47;
		this.aByteArray47 = null;
		return new Class1_Sub25_Sub1(this.anInt3809, local129, this.anInt3808, this.anInt3806, this.aBoolean425);
	}
}
