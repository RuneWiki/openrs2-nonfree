...
public final class signlink implements Runnable {
	...
	public static int anInt1094 = 32;
	...
	public static void startpriv(@OriginalArg(0) InetAddress arg0) {
		anInt1095 = (int) (Math.random() * 9.9999999E7D);
		if (active) {
			try {
				Thread.sleep(500L);
	...
	private static String findcachedir() {
		...
		if (anInt1094 < 32 || anInt1094 > 34) {
			anInt1094 = 32;
		}
		@Pc(74) String local74 = ".file_store_" + anInt1094;
	...
	public static synchronized boolean wavesave(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		if (arg1 > 2000000) {
			...
			anInt1100 = (anInt1100 + 1) % 5;
			anInt1096 = arg1;
			savebuf = arg0;
			aBoolean262 = true;
			savereq = "sound" + anInt1100 + ".wav";
			return true;
		} else {
			return false;
		}
	...
	public static synchronized void midisave(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		...
		anInt1097 = (anInt1097 + 1) % 5;
		anInt1096 = arg1;
		savebuf = arg0;
		aBoolean261 = true;
		savereq = "jingle" + anInt1097 + ".mid";
	}
	...
	public static void reporterror(@OriginalArg(0) String arg0) {
		...
		try {
			...
			@Pc(51) DataInputStream local51 = openurl("reporterror" + 359 + ".cgi?error=" + errorname + " " + local34);
			local51.readLine();
			local51.close();
	...
	public void run() {
		...
		@Pc(72) int local72 = anInt1095;
		while (anInt1095 == local72) {
			if (socketreq != 0) {
				try {
				...
				if (savebuf != null) {
					try {
						...
						local135.write(savebuf, 0, anInt1096);
						local135.close();
