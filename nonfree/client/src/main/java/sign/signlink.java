...
public final class signlink implements Runnable {
	...
	public static int anInt1067 = 32;
	...
	private static String aString31 = null;
	...
	public static void startpriv(@OriginalArg(0) InetAddress arg0) {
		anInt1068 = (int) (Math.random() * 9.9999999E7D);
		if (active) {
			try {
				Thread.sleep(500L);
	...
	private static String findcachedir() {
		...
		if (anInt1067 < 32 || anInt1067 > 34) {
			anInt1067 = 32;
		}
		@Pc(74) String local74 = ".file_store_" + anInt1067;
	...
	public static synchronized boolean wavesave(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		if (arg1 > 2000000) {
			...
			anInt1073 = (anInt1073 + 1) % 5;
			anInt1069 = arg1;
			savebuf = arg0;
			aBoolean278 = true;
			savereq = "sound" + anInt1073 + ".wav";
			return true;
		} else {
			return false;
		}
	...
	public static synchronized void midisave(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		...
		anInt1070 = (anInt1070 + 1) % 5;
		anInt1069 = arg1;
		savebuf = arg0;
		aBoolean277 = true;
		savereq = "jingle" + anInt1070 + ".mid";
	}
	...
	public static void reporterror(@OriginalArg(0) String arg0) {
		...
		try {
			...
			@Pc(51) DataInputStream local51 = openurl("reporterror" + 346 + ".cgi?error=" + errorname + " " + local34);
			local51.readLine();
			local51.close();
	...
	public void run() {
		...
		@Pc(72) int local72 = anInt1068;
		while (anInt1068 == local72) {
			if (socketreq != 0) {
				try {
				...
				if (savebuf != null) {
					try {
						...
						local135.write(savebuf, 0, anInt1069);
						local135.close();
					} catch (@Pc(144) Exception local144) {
					}
				}
				if (aBoolean278) {
					aString31 = local3 + savereq;
					aBoolean278 = false;
				}
				if (aBoolean277) {
					midi = local3 + savereq;
