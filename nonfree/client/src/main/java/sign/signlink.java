...
public final class signlink implements Runnable {
	...
	public static boolean aBoolean284;
	...
	public static int anInt1082 = 32;
	...
	public static void startpriv(@OriginalArg(0) InetAddress arg0) {
		anInt1083 = (int) (Math.random() * 9.9999999E7D);
		if (active) {
			try {
				Thread.sleep(500L);
	...
	private static String findcachedir() {
		...
		if (anInt1082 < 32 || anInt1082 > 34) {
			anInt1082 = 32;
		}
		@Pc(74) String local74 = ".file_store_" + anInt1082;
	...
	public static synchronized boolean wavesave(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		if (arg1 > 2000000) {
			...
			anInt1088 = (anInt1088 + 1) % 5;
			anInt1084 = arg1;
			savebuf = arg0;
			aBoolean285 = true;
			savereq = "sound" + anInt1088 + ".wav";
			return true;
		} else {
			return false;
		}
	...
	public static synchronized void midisave(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		...
		anInt1085 = (anInt1085 + 1) % 5;
		anInt1084 = arg1;
		savebuf = arg0;
		aBoolean284 = true;
		savereq = "jingle" + anInt1085 + ".mid";
	}
	...
	public static void reporterror(@OriginalArg(0) String arg0) {
		...
		try {
			...
			@Pc(51) DataInputStream local51 = openurl("reporterror" + 358 + ".cgi?error=" + errorname + " " + local34);
			local51.readLine();
			local51.close();
	...
	public void run() {
		...
		@Pc(72) int local72 = anInt1083;
		while (anInt1083 == local72) {
			if (socketreq != 0) {
				try {
				...
				if (savebuf != null) {
					try {
						...
						local135.write(savebuf, 0, anInt1084);
						local135.close();
