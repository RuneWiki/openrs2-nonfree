...
public final class signlink implements Runnable {
	...
	public static int anInt1080 = 32;
	...
	public static void startpriv(@OriginalArg(0) InetAddress arg0) {
		anInt1081 = (int) (Math.random() * 9.9999999E7D);
		if (active) {
			try {
				Thread.sleep(500L);
	...
	private static String findcachedir() {
		...
		if (anInt1080 < 32 || anInt1080 > 34) {
			anInt1080 = 32;
		}
		@Pc(74) String local74 = ".file_store_" + anInt1080;
	...
	public static synchronized boolean wavesave(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		if (arg1 > 2000000) {
			...
			anInt1086 = (anInt1086 + 1) % 5;
			anInt1082 = arg1;
			savebuf = arg0;
			aBoolean244 = true;
			savereq = "sound" + anInt1086 + ".wav";
			return true;
		} else {
			return false;
		}
	...
	public static synchronized void midisave(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		...
		anInt1083 = (anInt1083 + 1) % 5;
		anInt1082 = arg1;
		savebuf = arg0;
		aBoolean243 = true;
		savereq = "jingle" + anInt1083 + ".mid";
	}
	...
	public static void reporterror(@OriginalArg(0) String arg0) {
		...
		try {
			...
			@Pc(51) DataInputStream local51 = openurl("reporterror" + 321 + ".cgi?error=" + errorname + " " + local34);
			local51.readLine();
			local51.close();
	...
	public void run() {
		...
		@Pc(72) int local72 = anInt1081;
		while (anInt1081 == local72) {
			if (socketreq != 0) {
				try {
				...
				if (savebuf != null) {
					try {
						...
						local135.write(savebuf, 0, anInt1082);
						local135.close();
