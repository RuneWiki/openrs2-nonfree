...
public final class signlink implements Runnable {
	...
	public static void startpriv(@OriginalArg(0) InetAddress arg0) {
		anInt941 = (int) (Math.random() * 9.9999999E7D);
		if (active) {
			try {
				Thread.sleep(500L);
	...
	private static String findcachedir() {
		...
		if (anInt940 < 32 || anInt940 > 34) {
			anInt940 = 32;
		}
		@Pc(74) String local74 = ".file_store_" + anInt940;
	...
	public static synchronized boolean wavesave(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		if (arg1 > 2000000) {
			...
			anInt946 = (anInt946 + 1) % 5;
			anInt942 = arg1;
			savebuf = arg0;
			aBoolean226 = true;
			savereq = "sound" + anInt946 + ".wav";
			return true;
		} else {
			return false;
		}
	...
	public static synchronized void midisave(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		...
		anInt943 = (anInt943 + 1) % 5;
		anInt942 = arg1;
		savebuf = arg0;
		aBoolean225 = true;
		savereq = "jingle" + anInt943 + ".mid";
	}
	...
	public void run() {
		...
		@Pc(72) int local72 = anInt941;
		while (anInt941 == local72) {
			if (socketreq != 0) {
				try {
				...
				if (savebuf != null) {
					try {
						...
						local135.write(savebuf, 0, anInt942);
						local135.close();
