...
public final class signlink implements Runnable {
	...
	public static int anInt1099 = 32;
	...
	public static void startpriv(@OriginalArg(0) InetAddress arg0) {
		anInt1100 = (int) (Math.random() * 9.9999999E7D);
		if (active) {
			try {
				Thread.sleep(500L);
	...
	private static String findcachedir() {
		...
		if (anInt1099 < 32 || anInt1099 > 34) {
			anInt1099 = 32;
		}
		@Pc(74) String local74 = ".file_store_" + anInt1099;
	...
	public static synchronized boolean wavesave(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		if (arg1 > 2000000) {
			...
			anInt1105 = (anInt1105 + 1) % 5;
			anInt1101 = arg1;
			savebuf = arg0;
			aBoolean276 = true;
			savereq = "sound" + anInt1105 + ".wav";
			return true;
		} else {
			return false;
		}
	...
	public static synchronized void midisave(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		...
		anInt1102 = (anInt1102 + 1) % 5;
		anInt1101 = arg1;
		savebuf = arg0;
		aBoolean275 = true;
		savereq = "jingle" + anInt1102 + ".mid";
	}
	...
	public static void reporterror(@OriginalArg(0) String arg0) {
		...
		try {
			...
			@Pc(51) DataInputStream local51 = openurl("reporterror" + 357 + ".cgi?error=" + errorname + " " + local34);
			local51.readLine();
			local51.close();
	...
	public void run() {
		...
		@Pc(72) int local72 = anInt1100;
		while (anInt1100 == local72) {
			if (socketreq != 0) {
				try {
				...
				if (savebuf != null) {
					try {
						...
						local135.write(savebuf, 0, anInt1101);
						local135.close();
