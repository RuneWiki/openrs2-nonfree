...
public final class signlink implements Runnable {
	...
	private static String findcachedir() {
		...
		@Pc(74) String local74 = ".file_store_" + anInt1059;
	...
	public static void reporterror(@OriginalArg(0) String arg0) {
		...
		try {
			...
			@Pc(51) DataInputStream local51 = openurl("reporterror" + 377 + ".cgi?error=" + errorname + " " + local34);
			local51.readLine();
			local51.close();
