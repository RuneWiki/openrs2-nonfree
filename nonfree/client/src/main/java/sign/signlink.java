...
public final class signlink implements Runnable {
	...
	private static boolean aBoolean255;
	...
	public static int anInt1060 = 32;
	...
	public static void startpriv(@OriginalArg(0) InetAddress arg0) {
		anInt1061 = (int) (Math.random() * 9.9999999E7D);
		if (active) {
			try {
				Thread.sleep(500L);
	...
	private static String findcachedir() {
		...
		if (anInt1060 < 32 || anInt1060 > 34) {
			anInt1060 = 32;
		}
		@Pc(74) String local74 = ".file_store_" + anInt1060;
	...
	public static synchronized boolean wavesave(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		if (arg1 > 2000000) {
			...
			anInt1066 = (anInt1066 + 1) % 5;
			anInt1062 = arg1;
			savebuf = arg0;
			aBoolean255 = true;
			savereq = "sound" + anInt1066 + ".wav";
			return true;
		} else {
			return false;
		}
	...
	public static synchronized void midisave(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		...
		anInt1063 = (anInt1063 + 1) % 5;
		anInt1062 = arg1;
		savebuf = arg0;
		aBoolean254 = true;
		savereq = "jingle" + anInt1063 + ".mid";
	}
	...
	public static void reporterror(@OriginalArg(0) String arg0) {
		...
		try {
			...
			@Pc(51) DataInputStream local51 = openurl("reporterror" + 374 + ".cgi?error=" + errorname + " " + local34);
			local51.readLine();
			local51.close();
	...
	public void run() {
		...
		@Pc(72) int local72 = anInt1061;
		while (anInt1061 == local72) {
			if (socketreq != 0) {
				try {
				...
				if (savebuf != null) {
					try {
						...
						local135.write(savebuf, 0, anInt1062);
						local135.close();
