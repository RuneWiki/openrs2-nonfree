...
public final class signlink implements Runnable {
	...
	public static void startpriv(@OriginalArg(0) InetAddress arg0) {
		anInt914 = (int) (Math.random() * 9.9999999E7D);
		if (active) {
			try {
				Thread.sleep(500L);
	...
	private static String findcachedir() {
		...
		if (anInt913 < 32 || anInt913 > 34) {
			anInt913 = 32;
		}
		@Pc(74) String local74 = ".file_store_" + anInt913;
	...
	public static synchronized boolean wavesave(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		if (arg1 > 2000000) {
			...
			anInt919 = (anInt919 + 1) % 5;
			anInt915 = arg1;
			savebuf = arg0;
			aBoolean243 = true;
			savereq = "sound" + anInt919 + ".wav";
			return true;
		} else {
			return false;
		}
	...
	public static synchronized void midisave(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		...
		anInt916 = (anInt916 + 1) % 5;
		anInt915 = arg1;
		savebuf = arg0;
		aBoolean242 = true;
		savereq = "jingle" + anInt916 + ".mid";
	}
	...
	public static void reporterror(@OriginalArg(0) String arg0) {
		...
		try {
			...
			@Pc(51) DataInputStream local51 = openurl("reporterror" + 270 + ".cgi?error=" + errorname + " " + local34);
			local51.readLine();
			local51.close();
	...
	public void run() {
		...
		@Pc(72) int local72 = anInt914;
		while (anInt914 == local72) {
			if (socketreq != 0) {
				try {
				...
				if (savebuf != null) {
					try {
						...
						local135.write(savebuf, 0, anInt915);
						local135.close();
