...
public final class signlink implements Runnable {
	...
	public static void startpriv(@OriginalArg(0) InetAddress arg0) {
		anInt937 = (int) (Math.random() * 9.9999999E7D);
		if (active) {
			try {
				Thread.sleep(500L);
	...
	private static String findcachedir() {
		...
		if (anInt936 < 32 || anInt936 > 34) {
			anInt936 = 32;
		}
		@Pc(74) String local74 = ".file_store_" + anInt936;
	...
	public static synchronized boolean wavesave(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		if (arg1 > 2000000) {
			...
			anInt942 = (anInt942 + 1) % 5;
			anInt938 = arg1;
			savebuf = arg0;
			aBoolean224 = true;
			savereq = "sound" + anInt942 + ".wav";
			return true;
		} else {
			return false;
		}
	...
	public static synchronized void midisave(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		...
		anInt939 = (anInt939 + 1) % 5;
		anInt938 = arg1;
		savebuf = arg0;
		aBoolean223 = true;
		savereq = "jingle" + anInt939 + ".mid";
	}
	...
	public static void reporterror(@OriginalArg(0) String arg0) {
		...
		try {
			...
			@Pc(51) DataInputStream local51 = openurl("reporterror" + 274 + ".cgi?error=" + errorname + " " + local34);
			local51.readLine();
			local51.close();
	...
	public void run() {
		...
		@Pc(72) int local72 = anInt937;
		while (anInt937 == local72) {
			if (socketreq != 0) {
				try {
				...
				if (savebuf != null) {
					try {
						...
						local135.write(savebuf, 0, anInt938);
						local135.close();
