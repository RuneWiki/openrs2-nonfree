...
public final class Canvas_Sub1 extends Canvas {
	...
	@OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
	public Canvas_Sub1(@OriginalArg(0) Component arg0) {
		this.aComponent1 = arg0;
	}

	@OriginalMember(owner = "client!kb", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
	@Override
	public void paint(@OriginalArg(0) Graphics arg0) {
		this.aComponent1.paint(arg0);
	}

	@OriginalMember(owner = "client!kb", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
	@Override
