...
public final class Static32 {
	...
	public static MixerPcmStream aClass4_Sub4_Sub4_1;
	...
	public static JagString aClass22_211 = Static60.method1113("Anmelde)2Zeitlimit -Uberschritten)3");

	@OriginalMember(owner = "client!fa", name = "t", descriptor = "Lclient!ec;")
	private static JagString aClass22_212 = Static60.method1113("Password: ");

	@OriginalMember(owner = "client!fa", name = "u", descriptor = "I")
	public static int anInt819 = 0;

	@OriginalMember(owner = "client!fa", name = "x", descriptor = "Lclient!ec;")
	private static JagString aClass22_213 = Static60.method1113("Please enter your username)3");
	...
	public static LruCache aClass33_11 = new LruCache(64);
	...
	public static JagString aClass22_215 = aClass22_212;

	@OriginalMember(owner = "client!fa", name = "G", descriptor = "I")
	public static int anInt824 = -1;

	@OriginalMember(owner = "client!fa", name = "I", descriptor = "Lclient!ec;")
	public static JagString aClass22_216 = aClass22_213;

	@OriginalMember(owner = "client!fa", name = "O", descriptor = "Lclient!ec;")
	private static JagString aClass22_219 = Static60.method1113("Login");

	@OriginalMember(owner = "client!fa", name = "J", descriptor = "Lclient!ec;")
	public static JagString aClass22_217 = aClass22_219;

	@OriginalMember(owner = "client!fa", name = "M", descriptor = "Lclient!ec;")
	public static JagString aClass22_218 = Static60.method1113("Benutzername: ");
	...
	public static MouseWheelProvider method542() {
		try {
			return (MouseWheelProvider) Class.forName("JavaMouseWheelProvider").getDeclaredConstructor().newInstance();
