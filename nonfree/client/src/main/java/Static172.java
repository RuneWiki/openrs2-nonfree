...
public final class Static172 {
	...
	public static void method2011(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(1) int local1 = 0;
		if (arg0 < anInt2831) {
			arg2 -= anInt2831 - arg0;
			arg0 = anInt2831;
		...
		if (anInt2833 > 0) {
			local1 = anInt2833 * 2849;
			arg3 = 23 - anInt2833;
			arg1 = anInt2833;
		}
		if (arg0 + arg2 > anInt2830) {
			arg2 = anInt2830 - arg0;
		}
		if (arg1 + arg3 > anInt2828) {
			arg3 = anInt2828 - arg1;
		}
		@Pc(57) int local57 = anInt2832 - arg2;
		@Pc(63) int local63 = arg0 + arg1 * anInt2832;
	...
	private static void method2012(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg0 < anInt2831 || arg0 >= anInt2830) {
			return;
		}
		if (arg1 < anInt2833) {
			arg2 -= anInt2833 - arg1;
		...
		@Pc(58) int local58 = arg0 + arg1 * anInt2832;
	...
	public static void method2013(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		method2021(arg0, arg1, arg2, arg4, arg5);
		method2021(arg0, arg1 + arg3 - 1, arg2, arg4, arg5);
		if (arg3 >= 3) {
			method2012(arg0, arg1 + 1, arg3 - 2, arg4, arg5);
			method2012(arg0 + arg2 - 1, arg1 + 1, arg3 - 2, arg4, arg5);
		}
	}
	...
	public static void method2014() {
		@Pc(1) int local1 = 0;
		@Pc(7) int local7 = anInt2832 * anInt2829 - 7;
		while (local1 < local7) {
	...
	public static void method2015(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		arg2 -= arg0;
		arg3 -= arg1;
		if (arg3 == 0) {
			if (arg2 >= 0) {
				method2029(arg0, arg1, arg2 + 1, arg4);
			} else {
				method2029(arg0 + arg2, arg1, 1 - arg2, arg4);
			}
		} else if (arg2 != 0) {
			if (arg2 + arg3 < 0) {
				arg0 += arg2;
			...
			if (arg2 > arg3) {
				...
				while (arg0 <= arg2) {
					local125 = arg1 >> 16;
					if (local125 >= anInt2833 && local125 < anInt2828) {
						anIntArray298[arg0 + local125 * anInt2832] = arg4;
					}
					arg1 += local96;
					arg0++;
				}
				...
				while (arg1 <= arg3) {
					local125 = arg0 >> 16;
					if (local125 >= anInt2831 && local125 < anInt2830) {
						anIntArray298[local125 + arg1 * anInt2832] = arg4;
					}
					arg0 += local96;
					arg1++;
				}
			...
			method2028(arg0, arg1, arg3 + 1, arg4);
		} else {
			method2028(arg0, arg1 + arg3, -arg3 + 1, arg4);
		}
	}

	@OriginalMember(owner = "client!vh", name = "c", descriptor = "(IIIIII)V")
	public static void method2016(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		if (arg0 < anInt2831) {
			arg2 -= anInt2831 - arg0;
			arg0 = anInt2831;
		}
		...
		@Pc(67) int local67 = anInt2832 - arg2;
		@Pc(73) int local73 = arg0 + arg1 * anInt2832;
	...
	public static void method2018(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		method2029(arg0, arg1, arg2, arg4);
		method2029(arg0, arg1 + arg3 - 1, arg2, arg4);
		method2028(arg0, arg1, arg3, arg4);
		method2028(arg0 + arg2 - 1, arg1, arg3, arg4);
	}

	@OriginalMember(owner = "client!vh", name = "a", descriptor = "([III)V")
	public static void method2019(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		anIntArray298 = arg0;
		anInt2832 = arg1;
		anInt2829 = arg2;
		method2023(0, 0, arg1, arg2);
	}

	@OriginalMember(owner = "client!vh", name = "a", descriptor = "(III[I[I)V")
	public static void method2020(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int[] arg2, @OriginalArg(4) int[] arg3) {
		@Pc(5) int local5 = arg0 + arg1 * anInt2832;
	...
	private static void method2021(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg1 < anInt2833 || arg1 >= anInt2828) {
			return;
		}
		if (arg0 < anInt2831) {
			arg2 -= anInt2831 - arg0;
	...
	public static void method2024(@OriginalArg(0) int[] arg0) {
		anInt2831 = arg0[0];
		anInt2833 = arg0[1];
		anInt2830 = arg0[2];
		anInt2828 = arg0[3];
	...
	public static void method2026(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg0 < anInt2831) {
			arg2 -= anInt2831 - arg0;
			arg0 = anInt2831;
		}
		...
		@Pc(43) int local43 = anInt2832 - arg2;
		@Pc(49) int local49 = arg0 + arg1 * anInt2832;
	...
	public static void method2027(@OriginalArg(0) int[] arg0) {
		arg0[0] = anInt2831;
		arg0[1] = anInt2833;
		arg0[2] = anInt2830;
		arg0[3] = anInt2828;
	...
	public static void method2028(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg0 < anInt2831 || arg0 >= anInt2830) {
			return;
		}
		if (arg1 < anInt2833) {
		...
		@Pc(32) int local32 = arg0 + arg1 * anInt2832;
		for (@Pc(34) int local34 = 0; local34 < arg2; local34++) {
			anIntArray298[local32 + local34 * anInt2832] = arg3;
		}
	}
