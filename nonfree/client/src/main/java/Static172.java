	...
	public static void method2258(@OriginalArg(1) String arg0) {
		...
		try {
			...
			if (arg0.length() == 0) {
				...
				local35 = local35 + "; Expires=" + Static514.method6638(Static362.method5133() + 94608000000L) + "; Max-Age=" + 94608000L;
			}
			Static597.method3393(Static195.anApplet4, "document.cookie=\"" + local35 + "\"");
		} catch (@Pc(86) Throwable local86) {
		}
	}

	@OriginalMember(owner = "client!gh", name = "a", descriptor = "(IIB)Z")
	public static boolean method2259(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return (arg0 & 0x21) != 0;
	}

	@OriginalMember(owner = "client!gh", name = "b", descriptor = "(IIB)V")
	public static void method2261(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (Static476.aFloat197 < Static476.aFloat196) {
			Static476.aFloat197 = (float) ((double) Static476.aFloat197 + (double) Static476.aFloat197 / 30.0D);
			if (Static476.aFloat197 > Static476.aFloat196) {
				Static476.aFloat197 = Static476.aFloat196;
			}
		...
		} else if (Static476.aFloat196 < Static476.aFloat197) {
			Static476.aFloat197 = (float) ((double) Static476.aFloat197 - (double) Static476.aFloat197 / 30.0D);
			if (Static476.aFloat196 > Static476.aFloat197) {
				Static476.aFloat197 = Static476.aFloat196;
			}
			Static170.method2217();
			Static476.anInt7574 = (int) Static476.aFloat197 >> 1;
		...
		if (Static317.anInt5332 != -1 && Static187.anInt8961 != -1) {
			@Pc(79) int local79 = Static317.anInt5332 - Static26.anInt449;
			if (local79 < 2 || local79 > 2) {
				local79 /= 8;
			}
			@Pc(96) int local96 = Static187.anInt8961 - Static366.anInt6166;
			Static26.anInt449 += local79;
			if (local96 < 2 || local96 > 2) {
				local96 /= 8;
			}
			Static366.anInt6166 += local96;
		...
		if (!Static79.aBoolean662 || Static177.aClass70_9 == null) {
			return;
		}
		for (@Pc(163) Class2_Sub38 local163 = (Class2_Sub38) Static177.aClass70_9.method1264(); local163 != null; local163 = (Class2_Sub38) Static177.aClass70_9.method1261()) {
			@Pc(172) Class142 local172 = Static476.aClass360_4.method7576(local163.aClass2_Sub20_1.anInt2970);
			if (local163.method5620(arg0, arg1)) {
				if (local172.aStringArray19 != null) {
					if (local172.aStringArray19[4] != null) {
						Static438.method5750(local172.aStringArray19[4], 0, 1011, (long) local163.aClass2_Sub20_1.anInt2970, local172.anInt2962, local172.aString41, false, -1, -1, true);
					}
					if (local172.aStringArray19[3] != null) {
						Static438.method5750(local172.aStringArray19[3], 0, 1004, (long) local163.aClass2_Sub20_1.anInt2970, local172.anInt2962, local172.aString41, false, -1, -1, true);
					}
					if (local172.aStringArray19[2] != null) {
						Static438.method5750(local172.aStringArray19[2], 0, 1009, (long) local163.aClass2_Sub20_1.anInt2970, local172.anInt2962, local172.aString41, false, -1, -1, true);
					}
					if (local172.aStringArray19[1] != null) {
						Static438.method5750(local172.aStringArray19[1], 0, 1012, (long) local163.aClass2_Sub20_1.anInt2970, local172.anInt2962, local172.aString41, false, -1, -1, true);
					}
					if (local172.aStringArray19[0] != null) {
						Static438.method5750(local172.aStringArray19[0], 0, 1002, (long) local163.aClass2_Sub20_1.anInt2970, local172.anInt2962, local172.aString41, false, -1, -1, true);
					}
				}
				if (!local163.aClass2_Sub20_1.aBoolean213) {
					local163.aClass2_Sub20_1.aBoolean213 = true;
					Static566.method7391(Static447.aClass222_13, local163.aClass2_Sub20_1.anInt2970, local172.anInt2962);
				}
				if (local163.aClass2_Sub20_1.aBoolean213) {
					Static566.method7391(Static253.aClass222_6, local163.aClass2_Sub20_1.anInt2970, local172.anInt2962);
				}
			} else if (local163.aClass2_Sub20_1.aBoolean213) {
				local163.aClass2_Sub20_1.aBoolean213 = false;
				Static566.method7391(Static170.aClass222_3, local163.aClass2_Sub20_1.anInt2970, local172.anInt2962);
			}
		}
	}
}
