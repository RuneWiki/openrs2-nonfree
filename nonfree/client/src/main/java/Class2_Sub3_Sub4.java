...
public final class Class2_Sub3_Sub4 extends Class2_Sub3 {
	...
	public int[] method6486(@OriginalArg(1) int arg0) {
		...
		if (super.aClass158_41.aBoolean265) {
			...
			for (@Pc(57) int local57 = arg0 - this.anInt371; local57 <= arg0 + this.anInt371; local57++) {
				@Pc(67) int[] local67 = this.method6474(0, Static139.anInt2715 & local57);
				@Pc(70) int[] local70 = new int[Static211.anInt4031];
				local72 = 0;
				for (@Pc(76) int local76 = -this.anInt369; local76 <= this.anInt369; local76++) {
					local72 += local67[Static69.anInt1719 & local76];
				}
				@Pc(93) int local93 = 0;
				while (local93 < Static211.anInt4031) {
					local70[local93] = local72 * local48 >> 16;
					local72 -= local67[local93 - this.anInt369 & Static69.anInt1719];
					local93++;
					local72 += local67[Static69.anInt1719 & local93 + this.anInt369];
				}
				local51[local57 + this.anInt371 - arg0] = local70;
			}
			for (@Pc(154) int local154 = 0; local154 < Static211.anInt4031; local154++) {
	...
	@OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILclient!bt;I)V", line = 216)
	@Override
	public void method6485(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub4 arg1) {
		if (arg0 == 0) {
			this.anInt369 = arg1.method4816();
		} else if (arg0 == 1) {
			this.anInt371 = arg1.method4816();
		} else if (arg0 == 2) {
	...
	public int[][] method6480(@OriginalArg(0) int arg0) {
		@Pc(19) int[][] local19 = super.aClass243_41.method6278(arg0);
		if (super.aClass243_41.aBoolean478) {
			...
			for (@Pc(55) int local55 = arg0 - this.anInt371; local55 <= this.anInt371 + arg0; local55++) {
				@Pc(65) int[][] local65 = this.method6484(0, local55 & Static139.anInt2715);
				@Pc(69) int[][] local69 = new int[3][Static211.anInt4031];
				@Pc(71) int local71 = 0;
				local73 = 0;
				local75 = 0;
				...
				for (@Pc(91) int local91 = -this.anInt369; local91 <= this.anInt369; local91++) {
					@Pc(97) int local97 = local91 & Static69.anInt1719;
			...
			for (local73 = 0; local73 < Static211.anInt4031; local73++) {
				local75 = 0;
