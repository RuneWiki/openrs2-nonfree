...
public final class Class3_Sub44 extends Class3 {
	...
	public Class3_Sub44(@OriginalArg(0) byte[] arg0) {
		this.method6587(arg0);
	}

	@OriginalMember(owner = "client!rw", name = "e", descriptor = "(I)[F")
	private float[] method6584(@OriginalArg(0) int arg0) {
		Static433.method6591(this.aByteArrayArray23[arg0]);
		Static433.method6582();
		@Pc(15) int local15 = Static433.method6585(Static192.method3681(Static433.anIntArray677.length - 1));
		@Pc(19) boolean local19 = Static433.aBooleanArray39[local15];
		@Pc(25) int local25 = local19 ? Static433.anInt7959 : Static433.anInt7961;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static433.method6582() != 0;
			local29 = Static433.method6582() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static433.anInt7961 >> 2);
			local67 = (local25 >> 2) + (Static433.anInt7961 >> 2);
			local71 = Static433.anInt7961 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static433.anInt7961 >> 2);
			local104 = local25 + (Static433.anInt7961 >> 2) - (local25 >> 2);
			local108 = Static433.anInt7961 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class297 local123 = Static433.aClass297Array1[Static433.anIntArray677[local15]];
		@Pc(126) int local126 = local123.anInt8749;
		@Pc(131) int local131 = local123.anIntArray745[local126];
		@Pc(140) boolean local140 = !Static433.aClass271Array1[local131].method6817();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt8748; local144++) {
			@Pc(152) Class300 local152 = Static433.aClass300Array1[local123.anIntArray744[local144]];
			local154 = Static433.aFloatArray58;
			local152.method7196(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt8749;
			local176 = local123.anIntArray745[local171];
			Static433.aClass271Array1[local176].method6813(Static433.aFloatArray58, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static433.aFloatArray58[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static433.aFloatArray58;
			...
			@Pc(252) float[] local252 = local19 ? Static433.aFloatArray64 : Static433.aFloatArray60;
			@Pc(258) float[] local258 = local19 ? Static433.aFloatArray59 : Static433.aFloatArray62;
			@Pc(264) float[] local264 = local19 ? Static433.aFloatArray63 : Static433.aFloatArray57;
			@Pc(270) int[] local270 = local19 ? Static433.anIntArray676 : Static433.anIntArray678;
			...
			@Pc(486) int local486 = Static192.method3681(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static433.aFloatArray58[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static433.aFloatArray58[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt7956 > 0) {
			local176 = this.anInt7956 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean565) {
				for (local212 = 0; local212 < this.anInt7954; local212++) {
					local1254 = (this.anInt7956 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static433.aFloatArray58[local212];
				}
			}
		}
		local154 = this.aFloatArray61;
		this.aFloatArray61 = Static433.aFloatArray58;
		Static433.aFloatArray58 = local154;
		this.anInt7956 = local25;
		this.anInt7954 = local104 - (local25 >> 1);
		this.aBoolean565 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!rw", name = "a", descriptor = "([B)V")
	private void method6587(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class3_Sub27 local4 = new Class3_Sub27(arg0);
		this.anInt7953 = local4.method7549();
		this.anInt7960 = local4.method7549();
		this.anInt7958 = local4.method7549();
		this.anInt7955 = local4.method7549();
		if (this.anInt7955 < 0) {
			this.anInt7955 = ~this.anInt7955;
			this.aBoolean566 = true;
		}
		@Pc(40) int local40 = local4.method7549();
		this.aByteArrayArray23 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method7548();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method7571(local64, local49);
			this.aByteArrayArray23[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!rw", name = "a", descriptor = "([I)Lclient!te;")
	public Class3_Sub42_Sub1 method6589(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray94 == null) {
			this.anInt7956 = 0;
			this.aFloatArray61 = new float[Static433.anInt7959];
			this.aByteArray94 = new byte[this.anInt7960];
			this.anInt7963 = 0;
			this.anInt7964 = 0;
		}
		while (this.anInt7964 < this.aByteArrayArray23.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method6584(this.anInt7964);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt7963;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt7960 - local47) {
					local50 = this.anInt7960 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt7963;
				}
				this.anInt7963 = local47;
			}
			this.anInt7964++;
		}
		...
		return new Class3_Sub42_Sub1(this.anInt7953, local129, this.anInt7958, this.anInt7955, this.aBoolean566);
	}
}
