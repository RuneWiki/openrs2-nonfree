...
public final class ja extends Class51 implements Interface3 {
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "()Lclient!pda;")
	@Override
	public Class51 method6712() {
		@Pc(3) ja local3 = new ja();
		local3.method6704(this);
		return local3;
	}

	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!pda;)V")
	@Override
