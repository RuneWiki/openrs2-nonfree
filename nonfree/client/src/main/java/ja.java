...
public final class ja extends Class154 implements Interface7 {
	...
	@OriginalMember(owner = "client!ja", name = "b", descriptor = "()Lclient!ql;")
	@Override
	public Class154 method6574() {
		@Pc(3) ja local3 = new ja();
		local3.method6563(this);
		return local3;
	}
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!ql;)V")
	@Override
