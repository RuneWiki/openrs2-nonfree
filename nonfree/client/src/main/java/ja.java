...
public final class ja extends Class86 implements Interface5 {
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!gw;)V")
	@Override
	...
	@OriginalMember(owner = "client!ja", name = "b", descriptor = "()Lclient!gw;")
	@Override
	public Class86 method7018() {
		@Pc(3) ja local3 = new ja();
		local3.method7032(this);
		return local3;
	}
}
