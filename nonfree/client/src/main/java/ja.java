...
public final class ja extends Class26 implements Interface6 {
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "()Lclient!qja;")
	@Override
	public Class26 method6452() {
		@Pc(3) ja local3 = new ja();
		local3.method6447(this);
		return local3;
	}
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!qja;)V")
	@Override
