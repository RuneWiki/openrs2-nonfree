...
public final class ja extends Class54 implements Interface3 {
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!dfa;)V")
	@Override
	public void method5137(@OriginalArg(0) Class54 arg0) {
		this.l(this.nativeid, ((ja) arg0).nativeid);
	}

	@OriginalMember(owner = "client!ja", name = "a", descriptor = "()Lclient!dfa;")
	@Override
	public Class54 method5133() {
		@Pc(3) ja local3 = new ja();
		local3.method5137(this);
		return local3;
	}
