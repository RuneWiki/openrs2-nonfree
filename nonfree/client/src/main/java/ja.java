...
public final class ja extends Class115 implements Interface10 {
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!hba;)V")
	@Override
	...
	@OriginalMember(owner = "client!ja", name = "b", descriptor = "()Lclient!hba;")
	@Override
	public Class115 method6292() {
		@Pc(3) ja local3 = new ja();
		local3.method6282(this);
		return local3;
	}
