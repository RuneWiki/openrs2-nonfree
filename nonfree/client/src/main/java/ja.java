...
public final class ja extends Class92 implements Interface10 {
	...
	@OriginalMember(owner = "client!ja", name = "b", descriptor = "()Lclient!nh;")
	@Override
	public Class92 method3857() {
		@Pc(3) ja local3 = new ja();
		local3.method3865(this);
		return local3;
	}
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!nh;)V")
	@Override
