...
public final class ja extends Class47 implements Interface7 {
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "()Lclient!wc;")
	@Override
	public Class47 method7867() {
		@Pc(3) ja local3 = new ja();
		local3.method7877(this);
		return local3;
	}
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!wc;)V")
	@Override
