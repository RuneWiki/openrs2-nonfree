...
public final class ja extends Class113 implements Interface4 {
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "()Lclient!tc;")
	@Override
	public Class113 method8446() {
		@Pc(3) ja local3 = new ja();
		local3.method8456(this);
		return local3;
	}
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!tc;)V")
	@Override
