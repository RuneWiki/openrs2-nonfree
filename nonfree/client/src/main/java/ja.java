...
public final class ja extends Class13 implements Interface9 {
	...
	@OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Lclient!a;Lclient!c;Lclient!rl;[Lclient!fba;[Lclient!ha;)V")
	public ja(@OriginalArg(0) a arg0, @OriginalArg(1) c arg1, @OriginalArg(2) Class256 arg2, @OriginalArg(3) Class96[] arg3, @OriginalArg(4) Class25[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			...
			local11[local25] = arg3[local25].anInt2722;
			local15[local25] = arg3[local25].anInt2718;
			local19[local25] = arg3[local25].anInt2719;
			local23[local25] = arg3[local25].anInt2720;
		}
		this.da(arg0, arg1, local7, arg3[0].anIntArray229, local11, local15, local19, local23);
	}
	...
	private native void DA(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class87 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
