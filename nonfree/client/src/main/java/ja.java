...
public final class ja extends Class117 implements Interface10 {
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "()Lclient!ofa;")
	@Override
	public Class117 method7248() {
		@Pc(3) ja local3 = new ja();
		local3.method7253(this);
		return local3;
	}
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!ofa;)V")
	@Override
