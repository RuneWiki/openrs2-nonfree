...
public final class ja extends Class56 implements Interface5 {
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!eh;)V")
	@Override
	public void method8393(@OriginalArg(0) Class56 arg0) {
		this.l(this.nativeid, ((ja) arg0).nativeid);
	}

	@OriginalMember(owner = "client!ja", name = "a", descriptor = "()Lclient!eh;")
	@Override
	public Class56 method8394() {
		@Pc(3) ja local3 = new ja();
		local3.method8393(this);
		return local3;
	}
