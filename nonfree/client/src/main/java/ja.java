...
public final class ja extends Class129 implements Interface5 {

	@OriginalMember(owner = "client!ja", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Lclient!h;Lclient!ba;Lclient!gv;[Lclient!mp;[Lclient!f;)V")
	public ja(@OriginalArg(0) h arg0, @OriginalArg(1) ba arg1, @OriginalArg(2) Class101 arg2, @OriginalArg(3) Class159[] arg3, @OriginalArg(4) Class80[] arg4) {
		super(arg0, arg2);
		...
		this.j(arg0, arg1, local7, arg3[0].anIntArray369, local11, local15, local19, local23);
	}
	...
	private native void S(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class62 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
