...
public final class ja extends Class76 implements Interface4 {
	...
	@OriginalMember(owner = "client!ja", name = "b", descriptor = "()Lclient!dm;")
	@Override
	public Class76 method9643() {
		@Pc(3) ja local3 = new ja();
		local3.method9629(this);
		return local3;
	}
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!dm;)V")
	@Override
