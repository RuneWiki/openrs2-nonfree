...
public final class ja extends Class27 implements Interface13 {

	@OriginalMember(owner = "client!ja", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Lclient!a;Lclient!c;Lclient!lg;[Lclient!qm;[Lclient!ha;)V")
	public ja(@OriginalArg(0) a arg0, @OriginalArg(1) c arg1, @OriginalArg(2) Class177 arg2, @OriginalArg(3) Class242[] arg3, @OriginalArg(4) Class12[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray83;
			local11[local25] = arg3[local25].anInt6863;
			local15[local25] = arg3[local25].anInt6866;
			local19[local25] = arg3[local25].anInt6862;
			local23[local25] = arg3[local25].anInt6865;
		}
		this.da(arg0, arg1, local7, arg3[0].anIntArray518, local11, local15, local19, local23);
	}
	...
	private native void DA(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class23 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
