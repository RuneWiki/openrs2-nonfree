...
public final class ja extends Class80 implements Interface12 {

	@OriginalMember(owner = "client!ja", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Lclient!a;Lclient!c;Lclient!pu;[Lclient!bt;[Lclient!ha;)V")
	public ja(@OriginalArg(0) a arg0, @OriginalArg(1) c arg1, @OriginalArg(2) Class244 arg2, @OriginalArg(3) Class40[] arg3, @OriginalArg(4) Class84[] arg4) {
		super(arg0, arg2);
		...
		this.da(arg0, arg1, local7, arg3[0].anIntArray124, local11, local15, local19, local23);
	}
	...
	private native void DA(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class145 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
