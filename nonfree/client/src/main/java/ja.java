...
public final class ja extends Class10 implements Interface11 {
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!sj;)V")
	@Override
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "()Lclient!sj;")
	@Override
	public Class10 method4222() {
		@Pc(3) ja local3 = new ja();
		local3.method4212(this);
		return local3;
	}
