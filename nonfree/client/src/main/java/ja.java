...
public final class ja extends Class31 implements Interface8 {
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!ih;)V")
	@Override
	...
	@OriginalMember(owner = "client!ja", name = "b", descriptor = "()Lclient!ih;")
	@Override
	public Class31 method7931() {
		@Pc(3) ja local3 = new ja();
		local3.method7934(this);
		return local3;
	}
