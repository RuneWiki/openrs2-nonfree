...
public final class ja extends Class30 implements Interface8 {
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!bca;)V")
	@Override
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "()Lclient!bca;")
	@Override
	public Class30 method4662() {
		@Pc(3) ja local3 = new ja();
		local3.method4653(this);
		return local3;
	}
