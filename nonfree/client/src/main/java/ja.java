...
public final class ja extends Class58 implements Interface6 {
	...
	@OriginalMember(owner = "client!ja", name = "b", descriptor = "()Lclient!cl;")
	@Override
	public Class58 method9522() {
		@Pc(3) ja local3 = new ja();
		local3.method9516(this);
		return local3;
	}
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!cl;)V")
	@Override
