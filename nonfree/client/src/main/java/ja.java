...
public final class ja extends Class47 implements Interface14 {

	@OriginalMember(owner = "client!ja", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Lclient!a;Lclient!c;Lclient!dd;[Lclient!qr;[Lclient!ha;)V")
	public ja(@OriginalArg(0) a arg0, @OriginalArg(1) c arg1, @OriginalArg(2) Class52 arg2, @OriginalArg(3) Class241[] arg3, @OriginalArg(4) Class35[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray102;
			local11[local25] = arg3[local25].anInt7606;
			local15[local25] = arg3[local25].anInt7604;
			local19[local25] = arg3[local25].anInt7603;
			local23[local25] = arg3[local25].anInt7605;
		}
		this.da(arg0, arg1, local7, arg3[0].anIntArray589, local11, local15, local19, local23);
	}
	...
	private native void DA(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class209 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
