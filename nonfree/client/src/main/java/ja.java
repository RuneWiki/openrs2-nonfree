...
public final class ja extends Class177 implements Interface7 {
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "()Lclient!uha;")
	@Override
	public Class177 method7868() {
		@Pc(3) ja local3 = new ja();
		local3.method7879(this);
		return local3;
	}
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!uha;)V")
	@Override
