...
public final class ja extends Class203 implements Interface3 {
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!qq;)V")
	@Override
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "()Lclient!qq;")
	@Override
	public Class203 method8323() {
		@Pc(3) ja local3 = new ja();
		local3.method8336(this);
		return local3;
	}
