...
public final class ja extends Class6 implements Interface8 {
	...
	@OriginalMember(owner = "client!ja", name = "b", descriptor = "()Lclient!kd;")
	@Override
	public Class6 method6709() {
		@Pc(3) ja local3 = new ja();
		local3.method6695(this);
		return local3;
	}
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!kd;)V")
	@Override
