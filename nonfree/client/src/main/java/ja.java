...
public final class ja extends Class239 implements Interface6 {
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "()Lclient!uu;")
	@Override
	public Class239 method9235() {
		@Pc(3) ja local3 = new ja();
		local3.method9247(this);
		return local3;
	}
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!uu;)V")
	@Override
