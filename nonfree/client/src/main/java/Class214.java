...
public final class Class214 {
	...
	@OriginalMember(owner = "client!kp", name = "b", descriptor = "Ljava/awt/Component;")
	private Component aComponent3;

	@OriginalMember(owner = "client!kp", name = "a", descriptor = "Ljava/awt/Robot;")
	private final Robot aRobot1 = new Robot();

	@OriginalMember(owner = "client!kp", name = "<init>", descriptor = "()V")
	private Class214() throws Exception {
	}

	@OriginalMember(owner = "client!kp", name = "movemouse", descriptor = "(II)V")
	private void movemouse(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aRobot1.mouseMove(arg0, arg1);
	}

	@OriginalMember(owner = "client!kp", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
	private void setcustomcursor(@OriginalArg(0) Component arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Point arg4) {
		if (arg1 == null) {
			...
			@Pc(14) BufferedImage local14 = new BufferedImage(arg2, arg3, 2);
			local14.setRGB(0, 0, arg2, arg3, arg1, 0, arg2);
			arg0.setCursor(arg0.getToolkit().createCustomCursor(local14, arg4, (String) null));
		}
	}

	@OriginalMember(owner = "client!kp", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
