...
public final class Static205 {
	...
	@OriginalMember(owner = "client!pl", name = "A", descriptor = "Lclient!aj;")
	public static Class8_Sub2 aClass8_Sub2_2 = new Class8_Sub2(10000);

	@OriginalMember(owner = "client!pl", name = "eb", descriptor = "Lclient!pl;")
	public static Class36_Sub2_Sub1 aClass36_Sub2_Sub1_1 = new Class36_Sub2_Sub1();

	@OriginalMember(owner = "client!pl", name = "hb", descriptor = "Lclient!pl;")
	public static Class36_Sub2_Sub1 aClass36_Sub2_Sub1_2 = new Class36_Sub2_Sub1();

	@OriginalMember(owner = "client!pl", name = "ib", descriptor = "Lclient!pl;")
	public static Class36_Sub2_Sub1 aClass36_Sub2_Sub1_3 = new Class36_Sub2_Sub1();

	@OriginalMember(owner = "client!pl", name = "jb", descriptor = "Lclient!pl;")
	public static Class36_Sub2_Sub1 aClass36_Sub2_Sub1_4 = new Class36_Sub2_Sub1();

	@OriginalMember(owner = "client!pl", name = "kb", descriptor = "Lclient!pl;")
	public static Class36_Sub2_Sub1 aClass36_Sub2_Sub1_5 = new Class36_Sub2_Sub1();

	@OriginalMember(owner = "client!pl", name = "lb", descriptor = "Lclient!pl;")
	public static Class36_Sub2_Sub1 aClass36_Sub2_Sub1_6 = new Class36_Sub2_Sub1();

	@OriginalMember(owner = "client!pl", name = "ob", descriptor = "[I")
	public static int[] anIntArray326 = new int[1];

	@OriginalMember(owner = "client!pl", name = "pb", descriptor = "[I")
	public static int[] anIntArray327 = new int[1];

	@OriginalMember(owner = "client!pl", name = "qb", descriptor = "Z")
	public static boolean aBoolean346 = false;

	@OriginalMember(owner = "client!pl", name = "a", descriptor = "(IIIIII[FIF)V")
	public static void method3237(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) int arg7, @OriginalArg(8) float arg8) {
	...
	@OriginalMember(owner = "client!pl", name = "a", descriptor = "([SI)[S")
	public static short[] method3239(@OriginalArg(0) short[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) short[] local2 = new short[arg1];
		Static301.method499(arg0, 0, local2, 0, arg1);
		return local2;
	}

	@OriginalMember(owner = "client!pl", name = "a", descriptor = "([FI)[F")
	public static float[] method3241(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) float[] local2 = new float[arg1];
		Static301.method497(arg0, 0, local2, 0, arg1);
		return local2;
	}

	@OriginalMember(owner = "client!pl", name = "a", descriptor = "(IIIIFFF)[F")
	public static float[] method3242(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6) {
	...
	@OriginalMember(owner = "client!pl", name = "s", descriptor = "()V")
	public static void method3252() {
		aClass36_Sub2_Sub1_1 = new Class36_Sub2_Sub1();
		aClass36_Sub2_Sub1_2 = new Class36_Sub2_Sub1();
		aClass36_Sub2_Sub1_3 = new Class36_Sub2_Sub1();
		aClass36_Sub2_Sub1_4 = new Class36_Sub2_Sub1();
		aClass36_Sub2_Sub1_5 = new Class36_Sub2_Sub1();
		aClass36_Sub2_Sub1_6 = new Class36_Sub2_Sub1();
	}

	@OriginalMember(owner = "client!pl", name = "a", descriptor = "(IIIIII[FFIF)V")
	public static void method3259(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) float arg7, @OriginalArg(8) int arg8, @OriginalArg(9) float arg9) {
		@Pc(3) int local3 = arg0 - arg3;
		@Pc(7) int local7 = arg1 - arg4;
		@Pc(11) int local11 = arg2 - arg5;
		@Pc(32) float local32 = (float) local3 * arg6[0] + (float) local7 * arg6[1] + (float) local11 * arg6[2];
	...
	@OriginalMember(owner = "client!pl", name = "a", descriptor = "(ISIB)I")
	public static int method3262(@OriginalArg(0) int arg0, @OriginalArg(1) short arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		@Pc(5) int local5 = Static96.anIntArray135[Static262.method3966(arg0, arg2)];
		if (arg1 != -1) {
			@Pc(15) int local15 = Static96.anInterface4_1.method1258(arg1 & 0xFFFF);
			@Pc(21) int local21;
			@Pc(44) int local44;
			if (local15 != 0) {
				if (arg2 < 0) {
			...
			local21 = Static96.anInterface4_1.method1261(arg1 & 0xFFFF);
			if (local21 != 0) {
				local21 += 256;
	...
	@OriginalMember(owner = "client!pl", name = "a", descriptor = "(FFF)I")
	public static int method3266(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
