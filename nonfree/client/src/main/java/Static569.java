...
public final class Static569 {
	...
	@OriginalMember(owner = "client!ufa", name = "o", descriptor = "Lclient!vm;")
	public static Class122 aClass122_3;

	@OriginalMember(owner = "client!ufa", name = "k", descriptor = "Lclient!mq;")
	public static final Class218 aClass218_133 = new Class218(65, 6);

	@OriginalMember(owner = "client!ufa", name = "p", descriptor = "I")
	public static int anInt9670 = 0;

	@OriginalMember(owner = "client!ufa", name = "a", descriptor = "(II)Lclient!uu;")
	public static Class3_Sub2 method7992(@OriginalArg(1) int arg0) {
		if (arg0 == 0) {
			...
			return new Class3_Sub2_Sub12_Sub1();
		} else if (arg0 == 19) {
