...
public final class Static78 {
	...
	public static StringBuffer aStringBuffer2 = new StringBuffer(100);
	...
	public static int anInt2514 = 256;
	...
	public static int method1933(@OriginalArg(0) byte[][] arg0, @OriginalArg(1) byte[][] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
	...
	public static String method1939(@OriginalArg(0) String arg0) {
		@Pc(2) int local2 = arg0.length();
		@Pc(4) int local4 = 0;
		for (@Pc(6) int local6 = 0; local6 < local2; local6++) {
			@Pc(11) char local11 = arg0.charAt(local6);
			if (local11 == '<' || local11 == '>') {
				local4 += 3;
			}
		}
