...
public final class ya extends Class62 implements Interface4 {

	@OriginalMember(owner = "client!ya", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ya", name = "l", descriptor = "Lclient!mfa;")
	private final Class211 aClass211_74 = new Class211();

	@OriginalMember(owner = "client!ya", name = "m", descriptor = "Lclient!da;")
	...
	public native Class6_Sub4_Sub2 c(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class6_Sub4_Sub2 arg2);
	...
	public void method8208(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass211_74.method5174()];
		for (@Pc(13) Class6_Sub29 local13 = (Class6_Sub29) this.aClass211_74.method5183(); local13 != null; local13 = (Class6_Sub29) this.aClass211_74.method5177()) {
			local7[local1++] = local13.method6158();
		}
		this.RA(local7);
	}
	...
	public void method8205(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aDa3.method1799().J(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!ya", name = "FA", descriptor = "(Lclient!w;IIIIZ)V")
	public native void FA(@OriginalArg(0) Class6_Sub4_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public native void aa(@OriginalArg(0) Class6_Sub4_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method8204(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aDa3.method1799().ma(this, arg0, arg1);
	}

	@OriginalMember(owner = "client!ya", name = "JA", descriptor = "(II)I")
	public native int JA(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1);

	@OriginalMember(owner = "client!ya", name = "a", descriptor = "(Lclient!od;[I)V")
	@Override
	public void method8203(@OriginalArg(0) Class6_Sub29 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass211_74.method5173(arg0);
		this.T(arg0.hashCode(), arg0.method6164(), arg0.method6161(), arg0.method6165(), arg0.method6160(), arg0.method6157(), arg1);
	}
}
