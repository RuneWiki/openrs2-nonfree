...
public final class ya extends Class59 implements Interface9 {

	@OriginalMember(owner = "client!ya", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ya", name = "g", descriptor = "Lclient!ws;")
	private final Class361 aClass361_71 = new Class361();

	@OriginalMember(owner = "client!ya", name = "f", descriptor = "Lclient!da;")
	...
	public native Class6_Sub2_Sub14 c(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class6_Sub2_Sub14 arg2);
	...
	public native void aa(@OriginalArg(0) Class6_Sub2_Sub14 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method7862(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aDa3.method1595().ma(this, arg0, arg1);
	}
	...
	public void method7864(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aDa3.method1595().J(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public void method7860(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass361_71.method7841()];
		for (@Pc(13) Class6_Sub7 local13 = (Class6_Sub7) this.aClass361_71.method7838(); local13 != null; local13 = (Class6_Sub7) this.aClass361_71.method7845()) {
			local7[local1++] = local13.method4284();
		}
		this.RA(local7);
	}

	@OriginalMember(owner = "client!ya", name = "FA", descriptor = "(Lclient!w;IIIIZ)V")
	public native void FA(@OriginalArg(0) Class6_Sub2_Sub14 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!ya", name = "a", descriptor = "(Lclient!bj;[I)V")
	@Override
	public void method7866(@OriginalArg(0) Class6_Sub7 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass361_71.method7833(arg0);
		this.T(arg0.hashCode(), arg0.method4292(), arg0.method4291(), arg0.method4286(), arg0.method4283(), arg0.method4288(), arg1);
	}
