...
public final class ya extends Class4 implements Interface5 {

	@OriginalMember(owner = "client!ya", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ya", name = "i", descriptor = "Lclient!ki;")
	private final Class183 aClass183_65 = new Class183();
	...
	public void method8442(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aDa3.method1869().ma(this, arg0, arg1);
	}
	...
	public native Class3_Sub4_Sub2 c(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class3_Sub4_Sub2 arg2);
	...
	public void method8443(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass183_65.method4799()];
		for (@Pc(13) Class3_Sub28 local13 = (Class3_Sub28) this.aClass183_65.method4795(); local13 != null; local13 = (Class3_Sub28) this.aClass183_65.method4793()) {
			local7[local1++] = local13.method8159();
		}
		this.RA(local7);
	}
	...
	public void method8446(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aDa3.method1869().J(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!ya", name = "aa", descriptor = "(Lclient!w;IIIIZ)V")
	public native void aa(@OriginalArg(0) Class3_Sub4_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	@OriginalMember(owner = "client!ya", name = "a", descriptor = "(Lclient!pn;[I)V")
	@Override
	public void method8448(@OriginalArg(0) Class3_Sub28 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass183_65.method4792(arg0);
		this.T(arg0.hashCode(), arg0.method8156(), arg0.method8155(), arg0.method8158(), arg0.method8154(), arg0.method8153(), arg1);
	}

	@OriginalMember(owner = "client!ya", name = "FA", descriptor = "(Lclient!w;IIIIZ)V")
	public native void FA(@OriginalArg(0) Class3_Sub4_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
