...
public final class ya extends Class16 implements Interface9 {

	@OriginalMember(owner = "client!ya", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ya", name = "k", descriptor = "Lclient!gj;")
	private final Class124 aClass124_68 = new Class124();

	@OriginalMember(owner = "client!ya", name = "l", descriptor = "Lclient!da;")
	...
	public void method8039(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aDa3.method1577().J(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public native Class4_Sub7_Sub3 c(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class4_Sub7_Sub3 arg2);
	...
	public native void FA(@OriginalArg(0) Class4_Sub7_Sub3 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method8041(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass124_68.method3271()];
		for (@Pc(13) Class4_Sub32 local13 = (Class4_Sub32) this.aClass124_68.method3267(); local13 != null; local13 = (Class4_Sub32) this.aClass124_68.method3273()) {
			local7[local1++] = local13.method6618();
		}
		this.RA(local7);
	}
	...
	@OriginalMember(owner = "client!ya", name = "a", descriptor = "(Lclient!pv;[I)V")
	@Override
	public void method8042(@OriginalArg(0) Class4_Sub32 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass124_68.method3275(arg0);
		this.T(arg0.hashCode(), arg0.method6614(), arg0.method6615(-18736), arg0.method6617(), arg0.method6621(), arg0.method6613(108), arg1);
	}
	...
	public native void aa(@OriginalArg(0) Class4_Sub7_Sub3 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method8044(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aDa3.method1577().ma(this, arg0, arg1);
	}
}
