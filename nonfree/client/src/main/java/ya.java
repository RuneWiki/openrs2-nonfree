...
public final class ya extends Class52 implements Interface8 {

	@OriginalMember(owner = "client!ya", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ya", name = "k", descriptor = "Lclient!eea;")
	private final Class71 aClass71_69 = new Class71();
	...
	public native Class3_Sub10_Sub18 c(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class3_Sub10_Sub18 arg2);
	...
	public void method7830(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aDa3.method1542().ma(this, arg0, arg1);
	}
	...
	public native void aa(@OriginalArg(0) Class3_Sub10_Sub18 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!ya", name = "ba", descriptor = "()V")
	public native void ba();

	@OriginalMember(owner = "client!ya", name = "a", descriptor = "(Lclient!oj;[I)V")
	@Override
	public void method7832(@OriginalArg(0) Class3_Sub30 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass71_69.method2076(arg0);
		this.T(arg0.hashCode(), arg0.method5386(), arg0.method5390(), arg0.method5388(), arg0.method5387(), arg0.method5391(), arg1);
	}
	...
	public void method7826(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aDa3.method1542().J(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!ya", name = "FA", descriptor = "(Lclient!w;IIIIZ)V")
	public native void FA(@OriginalArg(0) Class3_Sub10_Sub18 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method7828(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass71_69.method2077()];
		for (@Pc(13) Class3_Sub30 local13 = (Class3_Sub30) this.aClass71_69.method2089(); local13 != null; local13 = (Class3_Sub30) this.aClass71_69.method2086()) {
			local7[local1++] = local13.method5382();
		}
		this.RA(local7);
	}
