...
public final class ya extends Class46 implements Interface4 {

	@OriginalMember(owner = "client!ya", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ya", name = "m", descriptor = "Lclient!su;")
	private final Class298 aClass298_208 = new Class298();

	@OriginalMember(owner = "client!ya", name = "n", descriptor = "Lclient!da;")
	...
	public void method7967(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass298_208.method6815()];
		for (@Pc(13) Class6_Sub25 local13 = (Class6_Sub25) this.aClass298_208.method6809(); local13 != null; local13 = (Class6_Sub25) this.aClass298_208.method6821()) {
			local7[local1++] = local13.method6407();
		}
		this.RA(local7);
	}
	...
	public void method7964(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aDa3.method1349().J(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public native void aa(@OriginalArg(0) Class6_Sub5_Sub10 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!ya", name = "FA", descriptor = "(Lclient!w;IIIIZ)V")
	public native void FA(@OriginalArg(0) Class6_Sub5_Sub10 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method7970(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aDa3.method1349().ma(this, arg0, arg1);
	}

	@OriginalMember(owner = "client!ya", name = "c", descriptor = "(IILclient!w;)Lclient!w;")
	public native Class6_Sub5_Sub10 c(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class6_Sub5_Sub10 arg2);

	@OriginalMember(owner = "client!ya", name = "a", descriptor = "(Lclient!ld;[I)V")
	@Override
	public void method7965(@OriginalArg(0) Class6_Sub25 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass298_208.method6812(arg0);
		this.T(arg0.hashCode(), arg0.method6405(), arg0.method6402(), arg0.method6400(), arg0.method6398(), arg0.method6409(true), arg1);
	}
}
