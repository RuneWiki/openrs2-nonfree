...
public final class Static108 {
	...
	public static PcmResampler aClass23_1;

	@OriginalMember(owner = "client!se", name = "O", descriptor = "Lclient!jd;")
	public static Packet aClass4_Sub11_5 = new Packet(new byte[5000]);

	@OriginalMember(owner = "client!se", name = "T", descriptor = "Lclient!ec;")
	private static JagString aClass22_804 = Static60.method1113("purple:");

	@OriginalMember(owner = "client!se", name = "S", descriptor = "Lclient!ec;")
	public static JagString aClass22_803 = aClass22_804;

	@OriginalMember(owner = "client!se", name = "V", descriptor = "Lclient!ec;")
	public static JagString aClass22_805 = Static60.method1113("<col=ffffff>");

	@OriginalMember(owner = "client!se", name = "W", descriptor = "Lclient!ec;")
	public static JagString aClass22_806 = Static60.method1113("RuneScape wurde aktualisiert(Q");

	@OriginalMember(owner = "client!se", name = "Y", descriptor = "Lclient!ec;")
	public static JagString aClass22_807 = aClass22_804;
	...
	private static JagString aClass22_810 = Static60.method1113("as it was used to break our rules)3");

	@OriginalMember(owner = "client!se", name = "bb", descriptor = "Lclient!ec;")
	public static JagString aClass22_808 = aClass22_810;
	...
	public static JagString aClass22_809 = Static60.method1113("Ausw-=hlen");

	@OriginalMember(owner = "client!se", name = "a", descriptor = "(IIB)Lclient!f;")
	public static IfType method1767(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(17) IfType local17 = Static106.method1749(arg1);
		if (arg0 == -1) {
			return local17;
	...
	public static void method1769(@OriginalArg(0) int arg0, @OriginalArg(2) FileStream arg1, @OriginalArg(3) Js5Provider arg2) {
		@Pc(7) Js5NetProviderRequest local7 = new Js5NetProviderRequest();
		local7.aLong99 = arg0;
		local7.aClass20_Sub1_74 = arg2;
		local7.anInt2897 = 1;
		local7.aClass71_4 = arg1;
		@Pc(22) LinkList local22 = Static2.aClass82_1;
