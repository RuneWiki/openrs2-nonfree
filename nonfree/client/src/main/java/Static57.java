...
public final class Static57 {
	...
	public static Pix32[] aClass4_Sub1_Sub2_Sub2Array10;

	@OriginalMember(owner = "client!ka", name = "Mc", descriptor = "Lclient!ec;")
	private static JagString aClass22_442 = Static60.method1113("Connecting to update server");

	@OriginalMember(owner = "client!ka", name = "Ec", descriptor = "Lclient!ec;")
	public static JagString aClass22_441 = aClass22_442;
	...
	private static JagString aClass22_445 = Static60.method1113("Close");

	@OriginalMember(owner = "client!ka", name = "id", descriptor = "Lclient!ec;")
	public static JagString aClass22_443 = aClass22_445;
	...
	public static int method1093(@OriginalArg(1) int arg0) {
		@Pc(3) VarBitType local3 = Static66.method1161(arg0);
		@Pc(6) int local6 = local3.anInt79;
		@Pc(14) int local14 = local3.anInt76;
		@Pc(21) int local21 = local3.anInt81;
		@Pc(27) int local27 = CollisionMap.anIntArray282[local21 - local14];
