...
public final class Class1_Sub23 extends Class1 {
	...
	private void method2752(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub17 local4 = new Class1_Sub17(arg0);
		this.anInt3419 = local4.method2140();
		this.anInt3421 = local4.method2140();
		this.anInt3412 = local4.method2140();
		this.anInt3420 = local4.method2140();
		if (this.anInt3420 < 0) {
			this.anInt3420 = ~this.anInt3420;
		...
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			...
			@Pc(53) int local53;
			do {
				local53 = local4.method2142();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method2148(local49, local64);
			this.aByteArrayArray10[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!pi", name = "d", descriptor = "(I)[F")
	private float[] method2755(@OriginalArg(0) int arg0) {
		Static167.method2761(this.aByteArrayArray10[arg0]);
		Static167.method2754();
		@Pc(15) int local15 = Static167.method2751(Static198.method3179(Static167.anIntArray366.length - 1));
		@Pc(19) boolean local19 = Static167.aBooleanArray20[local15];
		@Pc(25) int local25 = local19 ? Static167.anInt3413 : Static167.anInt3417;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static167.method2754() != 0;
			local29 = Static167.method2754() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static167.anInt3417 >> 2);
			local67 = (local25 >> 2) + (Static167.anInt3417 >> 2);
			local71 = Static167.anInt3417 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static167.anInt3417 >> 2);
			local104 = local25 + (Static167.anInt3417 >> 2) - (local25 >> 2);
			local108 = Static167.anInt3417 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class7 local123 = Static167.aClass7Array1[Static167.anIntArray366[local15]];
		@Pc(126) int local126 = local123.anInt197;
		@Pc(131) int local131 = local123.anIntArray22[local126];
		@Pc(140) boolean local140 = !Static167.aClass72Array1[local131].method2034();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt198; local144++) {
			@Pc(152) Class115 local152 = Static167.aClass115Array1[local123.anIntArray23[local144]];
			local154 = Static167.aFloatArray9;
			local152.method3266(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt197;
			local176 = local123.anIntArray22[local171];
			Static167.aClass72Array1[local176].method2031(Static167.aFloatArray9, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static167.aFloatArray9[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static167.aFloatArray9;
			...
			@Pc(252) float[] local252 = local19 ? Static167.aFloatArray6 : Static167.aFloatArray4;
			@Pc(258) float[] local258 = local19 ? Static167.aFloatArray2 : Static167.aFloatArray3;
			@Pc(264) float[] local264 = local19 ? Static167.aFloatArray5 : Static167.aFloatArray8;
			@Pc(270) int[] local270 = local19 ? Static167.anIntArray365 : Static167.anIntArray367;
			...
			@Pc(486) int local486 = Static198.method3179(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static167.aFloatArray9[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static167.aFloatArray9[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt3414 > 0) {
			local176 = this.anInt3414 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean145) {
				for (local212 = 0; local212 < this.anInt3416; local212++) {
					local1254 = (this.anInt3414 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static167.aFloatArray9[local212];
				}
			}
		}
		local154 = this.aFloatArray7;
		this.aFloatArray7 = Static167.aFloatArray9;
		Static167.aFloatArray9 = local154;
		this.anInt3414 = local25;
		this.anInt3416 = local104 - (local25 >> 1);
		this.aBoolean145 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!pi", name = "a", descriptor = "([I)Lclient!qa;")
	public Class1_Sub15_Sub1 method2756(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray47 == null) {
			this.anInt3414 = 0;
			this.aFloatArray7 = new float[Static167.anInt3413];
			this.aByteArray47 = new byte[this.anInt3421];
			this.anInt3423 = 0;
			this.anInt3422 = 0;
		}
		while (this.anInt3422 < this.aByteArrayArray10.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method2755(this.anInt3422);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt3423;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt3421 - local47) {
					local50 = this.anInt3421 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt3423;
				}
				this.anInt3423 = local47;
			}
			this.anInt3422++;
		}
		...
		return new Class1_Sub15_Sub1(this.anInt3419, local129, this.anInt3412, this.anInt3420, this.aBoolean144);
	}
}
