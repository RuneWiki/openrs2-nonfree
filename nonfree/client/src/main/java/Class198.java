...
public final class Class198 {
	...
	private void method4557(@OriginalArg(0) byte arg0, @OriginalArg(1) Frame arg1) {
	...
	private void enter(@OriginalArg(0) Frame arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (arg4 == 0) {
			...
			for (@Pc(38) int local38 = 0; local38 < local34.length; local38++) {
				if (arg1 == local34[local38].getWidth() && arg2 == local34[local38].getHeight() && local34[local38].getBitDepth() == arg3) {
	...
	private void exit() {
		...
		this.method4557((byte) 29, (Frame) null);
	}
}
