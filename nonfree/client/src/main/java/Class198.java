...
public final class Class198 {
	...
	@OriginalMember(owner = "client!kt", name = "lb", descriptor = "Lclient!kt;")
	public static final Class198 lb;

	@OriginalMember(owner = "client!kt", name = "g", descriptor = "[Ljava/lang/String;")
	private final String[] aStringArray88;
	...
	static {
		...
		lb = new Class198("flash3:", "blinken3:", "clignotant3:", "brilho3:");
	}

	@OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V")
	public Class198(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2, @OriginalArg(3) String arg3) {
		this.aStringArray88 = new String[] { arg0, arg1, arg2, arg3 };
	}

	@OriginalMember(owner = "client!kt", name = "a", descriptor = "(BI)Ljava/lang/String;")
	public String method4365(@OriginalArg(1) int arg0) {
		return this.aStringArray88[arg0];
	}
