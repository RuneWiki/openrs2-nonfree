...
public final class Class6_Sub46 extends Class6 {
	...
	public Class6_Sub46(@OriginalArg(0) byte[] arg0) {
		this.method7151(arg0);
	}

	@OriginalMember(owner = "client!qw", name = "b", descriptor = "(I)[F")
	private float[] method7147(@OriginalArg(0) int arg0) {
		Static495.method7148(this.aByteArrayArray26[arg0]);
		Static495.method7146();
		@Pc(15) int local15 = Static495.method7149(Static503.method6621(Static495.anIntArray544.length - 1));
		@Pc(19) boolean local19 = Static495.aBooleanArray23[local15];
		@Pc(25) int local25 = local19 ? Static495.anInt8414 : Static495.anInt8410;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static495.method7146() != 0;
			local29 = Static495.method7146() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static495.anInt8410 >> 2);
			local67 = (local25 >> 2) + (Static495.anInt8410 >> 2);
			local71 = Static495.anInt8410 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static495.anInt8410 >> 2);
			local104 = local25 + (Static495.anInt8410 >> 2) - (local25 >> 2);
			local108 = Static495.anInt8410 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class66 local123 = Static495.aClass66Array1[Static495.anIntArray544[local15]];
		@Pc(126) int local126 = local123.anInt1889;
		@Pc(131) int local131 = local123.anIntArray106[local126];
		@Pc(140) boolean local140 = !Static495.aClass369Array1[local131].method8696();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt1888; local144++) {
			@Pc(152) Class82 local152 = Static495.aClass82Array1[local123.anIntArray105[local144]];
			local154 = Static495.aFloatArray54;
			local152.method1961(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt1889;
			local176 = local123.anIntArray106[local171];
			Static495.aClass369Array1[local176].method8694(Static495.aFloatArray54, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static495.aFloatArray54[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static495.aFloatArray54;
			...
			@Pc(252) float[] local252 = local19 ? Static495.aFloatArray55 : Static495.aFloatArray56;
			@Pc(258) float[] local258 = local19 ? Static495.aFloatArray51 : Static495.aFloatArray53;
			@Pc(264) float[] local264 = local19 ? Static495.aFloatArray49 : Static495.aFloatArray52;
			@Pc(270) int[] local270 = local19 ? Static495.anIntArray542 : Static495.anIntArray543;
			...
			@Pc(486) int local486 = Static503.method6621(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static495.aFloatArray54[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static495.aFloatArray54[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt8409 > 0) {
			local176 = this.anInt8409 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean583) {
				for (local212 = 0; local212 < this.anInt8411; local212++) {
					local1254 = (this.anInt8409 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static495.aFloatArray54[local212];
				}
			}
		}
		local154 = this.aFloatArray50;
		this.aFloatArray50 = Static495.aFloatArray54;
		Static495.aFloatArray54 = local154;
		this.anInt8409 = local25;
		this.anInt8411 = local104 - (local25 >> 1);
		this.aBoolean583 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!qw", name = "a", descriptor = "([B)V")
	private void method7151(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class6_Sub23 local4 = new Class6_Sub23(arg0);
		this.anInt8405 = local4.method8369();
		this.anInt8404 = local4.method8369();
		this.anInt8407 = local4.method8369();
		this.anInt8408 = local4.method8369();
		if (this.anInt8408 < 0) {
			this.anInt8408 = ~this.anInt8408;
			this.aBoolean581 = true;
		}
		@Pc(40) int local40 = local4.method8369();
		this.aByteArrayArray26 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method8374();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method8375(local49, local64, 0);
			this.aByteArrayArray26[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!qw", name = "a", descriptor = "([I)Lclient!fk;")
	public Class6_Sub21_Sub1 method7154(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray90 == null) {
			this.anInt8409 = 0;
			this.aFloatArray50 = new float[Static495.anInt8414];
			this.aByteArray90 = new byte[this.anInt8404];
			this.anInt8412 = 0;
			this.anInt8413 = 0;
		}
		while (this.anInt8413 < this.aByteArrayArray26.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method7147(this.anInt8413);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt8412;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt8404 - local47) {
					local50 = this.anInt8404 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt8412;
				}
				this.anInt8412 = local47;
			}
			this.anInt8413++;
		}
		...
		return new Class6_Sub21_Sub1(this.anInt8405, local129, this.anInt8407, this.anInt8408, this.aBoolean581);
	}
}
