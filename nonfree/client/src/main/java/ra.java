...
public final class ra extends Class23 implements Interface11 {

	@OriginalMember(owner = "client!ra", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Lclient!w;Lclient!g;Lclient!ap;[Lclient!rr;[Lclient!o;)V")
	public ra(@OriginalArg(0) w arg0, @OriginalArg(1) g arg1, @OriginalArg(2) Class14 arg2, @OriginalArg(3) Class214[] arg3, @OriginalArg(4) Class49[] arg4) {
		super(arg0, arg2);
	...
	private native void OA(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class97 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
