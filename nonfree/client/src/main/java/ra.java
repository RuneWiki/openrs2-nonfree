...
public final class ra extends Class137 implements Interface5 {

	@OriginalMember(owner = "client!ra", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Lclient!w;Lclient!g;Lclient!ul;[Lclient!dd;[Lclient!o;)V")
	public ra(@OriginalArg(0) w arg0, @OriginalArg(1) g arg1, @OriginalArg(2) Class252 arg2, @OriginalArg(3) Class52[] arg3, @OriginalArg(4) Class85[] arg4) {
		super(arg0, arg2);
	...
	private native void OA(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class73 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
