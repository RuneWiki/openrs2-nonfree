...
public final class Static97 {
	...
	@OriginalMember(owner = "client!gk", name = "F", descriptor = "Lclient!ug;")
	public static Class3_Sub26 aClass3_Sub26_2 = new Class3_Sub26(10000);

	@OriginalMember(owner = "client!gk", name = "fb", descriptor = "Lclient!gk;")
	public static Class10_Sub4_Sub1 aClass10_Sub4_Sub1_1 = new Class10_Sub4_Sub1();

	@OriginalMember(owner = "client!gk", name = "nb", descriptor = "Lclient!gk;")
	public static Class10_Sub4_Sub1 aClass10_Sub4_Sub1_2 = new Class10_Sub4_Sub1();

	@OriginalMember(owner = "client!gk", name = "ob", descriptor = "Lclient!gk;")
	public static Class10_Sub4_Sub1 aClass10_Sub4_Sub1_3 = new Class10_Sub4_Sub1();

	@OriginalMember(owner = "client!gk", name = "pb", descriptor = "Lclient!gk;")
	public static Class10_Sub4_Sub1 aClass10_Sub4_Sub1_4 = new Class10_Sub4_Sub1();

	@OriginalMember(owner = "client!gk", name = "qb", descriptor = "Lclient!gk;")
	public static Class10_Sub4_Sub1 aClass10_Sub4_Sub1_5 = new Class10_Sub4_Sub1();

	@OriginalMember(owner = "client!gk", name = "rb", descriptor = "Lclient!gk;")
	public static Class10_Sub4_Sub1 aClass10_Sub4_Sub1_6 = new Class10_Sub4_Sub1();

	@OriginalMember(owner = "client!gk", name = "vb", descriptor = "[I")
	public static int[] anIntArray178 = new int[1];
	...
	@OriginalMember(owner = "client!gk", name = "a", descriptor = "(IIIIFFF)[F")
	public static float[] method1526(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6) {
	...
	@OriginalMember(owner = "client!gk", name = "q", descriptor = "()V")
	public static void method1539() {
		aClass10_Sub4_Sub1_1 = new Class10_Sub4_Sub1();
		aClass10_Sub4_Sub1_2 = new Class10_Sub4_Sub1();
		aClass10_Sub4_Sub1_3 = new Class10_Sub4_Sub1();
		aClass10_Sub4_Sub1_4 = new Class10_Sub4_Sub1();
		aClass10_Sub4_Sub1_5 = new Class10_Sub4_Sub1();
		aClass10_Sub4_Sub1_6 = new Class10_Sub4_Sub1();
	}

	@OriginalMember(owner = "client!gk", name = "a", descriptor = "(IIIIII[FFIF)V")
	public static void method1545(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) float arg7, @OriginalArg(8) int arg8, @OriginalArg(9) float arg9) {
	...
	@OriginalMember(owner = "client!gk", name = "a", descriptor = "(ISIB)I")
	public static int method1546(@OriginalArg(0) int arg0, @OriginalArg(1) short arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		@Pc(5) int local5 = Static16.anIntArray25[Static119.method1972(arg0, arg2)];
		if (arg1 != -1) {
			@Pc(15) int local15 = Static16.anInterface4_1.method2898(arg1 & 0xFFFF);
			@Pc(21) int local21;
			@Pc(44) int local44;
			if (local15 != 0) {
				if (arg2 < 0) {
			...
			local21 = Static16.anInterface4_1.method2908(arg1 & 0xFFFF);
			if (local21 != 0) {
				local21 += 256;
	...
	@OriginalMember(owner = "client!gk", name = "a", descriptor = "(FFF)I")
	public static int method1547(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
	...
	public static float[] method1553(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) float[] local2 = new float[arg1];
		Static326.method4265(arg0, 0, local2, 0, arg1);
		return local2;
	}

	@OriginalMember(owner = "client!gk", name = "a", descriptor = "(IIIIII[FIF)V")
	public static void method1556(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) int arg7, @OriginalArg(8) float arg8) {
		@Pc(3) int local3 = arg0 - arg3;
		@Pc(7) int local7 = arg1 - arg4;
		@Pc(11) int local11 = arg2 - arg5;
		@Pc(32) float local32 = (float) local3 * arg6[0] + (float) local7 * arg6[1] + (float) local11 * arg6[2];
	...
	@OriginalMember(owner = "client!gk", name = "a", descriptor = "([SI)[S")
	public static short[] method1557(@OriginalArg(0) short[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) short[] local2 = new short[arg1];
		Static326.method4271(arg0, 0, local2, 0, arg1);
		return local2;
	}
}
