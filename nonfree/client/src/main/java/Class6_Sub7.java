...
public final class Class6_Sub7 extends Class6 {
	...
	@OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(ILclient!fca;)V")
	public Class6_Sub7(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub22 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Lclient!fca;)V")
	public Class6_Sub7(@OriginalArg(0) Class3_Sub22 arg0) {
		super(arg0);
	}
	...
	protected int method8962() {
		return super.aClass3_Sub22_31.method2838().method185() ? 3 : 2;
	}

	@OriginalMember(owner = "client!gg", name = "a", descriptor = "(Z)V")
	@Override
	public void method8964() {
		if (super.anInt10233 < 1 || super.anInt10233 > 3) {
