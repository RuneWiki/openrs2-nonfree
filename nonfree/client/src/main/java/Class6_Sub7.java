...
public final class Class6_Sub7 extends Class6 {
	...
	public Class6_Sub7(@OriginalArg(0) byte[] arg0) {
		this.method1138(arg0);
	}

	@OriginalMember(owner = "client!cba", name = "a", descriptor = "(I)[F")
	private float[] method1136(@OriginalArg(0) int arg0) {
		Static63.method1140(this.aByteArrayArray22[arg0]);
		Static63.method1137();
		@Pc(15) int local15 = Static63.method1144(Static88.method1511(Static63.anIntArray98.length - 1));
		@Pc(19) boolean local19 = Static63.aBooleanArray10[local15];
		@Pc(25) int local25 = local19 ? Static63.anInt1353 : Static63.anInt1354;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static63.method1137() != 0;
			local29 = Static63.method1137() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static63.anInt1354 >> 2);
			local67 = (local25 >> 2) + (Static63.anInt1354 >> 2);
			local71 = Static63.anInt1354 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static63.anInt1354 >> 2);
			local104 = local25 + (Static63.anInt1354 >> 2) - (local25 >> 2);
			local108 = Static63.anInt1354 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class18 local123 = Static63.aClass18Array1[Static63.anIntArray98[local15]];
		@Pc(126) int local126 = local123.anInt330;
		@Pc(131) int local131 = local123.anIntArray13[local126];
		@Pc(140) boolean local140 = !Static63.aClass99Array1[local131].method2445();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt329; local144++) {
			@Pc(152) Class342 local152 = Static63.aClass342Array1[local123.anIntArray14[local144]];
			local154 = Static63.aFloatArray4;
			local152.method8170(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt330;
			local176 = local123.anIntArray13[local171];
			Static63.aClass99Array1[local176].method2441(Static63.aFloatArray4, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static63.aFloatArray4[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static63.aFloatArray4;
			...
			@Pc(252) float[] local252 = local19 ? Static63.aFloatArray5 : Static63.aFloatArray3;
			@Pc(258) float[] local258 = local19 ? Static63.aFloatArray8 : Static63.aFloatArray10;
			@Pc(264) float[] local264 = local19 ? Static63.aFloatArray9 : Static63.aFloatArray7;
			@Pc(270) int[] local270 = local19 ? Static63.anIntArray97 : Static63.anIntArray96;
			...
			@Pc(486) int local486 = Static88.method1511(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static63.aFloatArray4[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static63.aFloatArray4[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt1351 > 0) {
			local176 = this.anInt1351 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean87) {
				for (local212 = 0; local212 < this.anInt1352; local212++) {
					local1254 = (this.anInt1351 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static63.aFloatArray4[local212];
				}
			}
		}
		local154 = this.aFloatArray6;
		this.aFloatArray6 = Static63.aFloatArray4;
		Static63.aFloatArray4 = local154;
		this.anInt1351 = local25;
		this.anInt1352 = local104 - (local25 >> 1);
		this.aBoolean87 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!cba", name = "b", descriptor = "([B)V")
	private void method1138(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class6_Sub40 local4 = new Class6_Sub40(arg0);
		this.anInt1356 = local4.method8579();
		this.anInt1359 = local4.method8579();
		this.anInt1355 = local4.method8579();
		this.anInt1358 = local4.method8579();
		if (this.anInt1358 < 0) {
			this.anInt1358 = ~this.anInt1358;
			this.aBoolean86 = true;
		}
		@Pc(40) int local40 = local4.method8579();
		this.aByteArrayArray22 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method8604();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method8595(local64, local49, 0);
			this.aByteArrayArray22[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!cba", name = "a", descriptor = "([I)Lclient!ut;")
	public Class6_Sub37_Sub1 method1142(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray23 == null) {
			this.anInt1351 = 0;
			this.aFloatArray6 = new float[Static63.anInt1353];
			this.aByteArray23 = new byte[this.anInt1359];
			this.anInt1361 = 0;
			this.anInt1362 = 0;
		}
		while (this.anInt1362 < this.aByteArrayArray22.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1136(this.anInt1362);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt1361;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt1359 - local47) {
					local50 = this.anInt1359 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray23[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt1361;
				}
				this.anInt1361 = local47;
			}
			this.anInt1362++;
		}
		...
		return new Class6_Sub37_Sub1(this.anInt1356, local129, this.anInt1355, this.anInt1358, this.aBoolean86);
	}
}
