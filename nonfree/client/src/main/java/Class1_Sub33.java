...
public final class Class1_Sub33 extends Class1 {
	...
	private byte[][] aByteArrayArray93;
	...
	private float[] method3801(@OriginalArg(0) int arg0) {
		Static287.method3807(this.aByteArrayArray93[arg0]);
		Static287.method3805();
		@Pc(15) int local15 = Static287.method3803(Static357.method4688(Static287.anIntArray362.length - 1));
		@Pc(19) boolean local19 = Static287.aBooleanArray109[local15];
		@Pc(25) int local25 = local19 ? Static287.anInt4805 : Static287.anInt4807;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static287.method3805() != 0;
			local29 = Static287.method3805() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static287.anInt4807 >> 2);
			local67 = (local25 >> 2) + (Static287.anInt4807 >> 2);
			local71 = Static287.anInt4807 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static287.anInt4807 >> 2);
			local104 = local25 + (Static287.anInt4807 >> 2) - (local25 >> 2);
			local108 = Static287.anInt4807 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class116 local123 = Static287.aClass116Array1[Static287.anIntArray362[local15]];
		@Pc(126) int local126 = local123.anInt2876;
		@Pc(131) int local131 = local123.anIntArray225[local126];
		@Pc(140) boolean local140 = !Static287.aClass161Array1[local131].method3643();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt2875; local144++) {
			@Pc(152) Class152 local152 = Static287.aClass152Array1[local123.anIntArray226[local144]];
			local154 = Static287.aFloatArray27;
			local152.method3522(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt2876;
			local176 = local123.anIntArray225[local171];
			Static287.aClass161Array1[local176].method3646(Static287.aFloatArray27, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static287.aFloatArray27[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static287.aFloatArray27;
			...
			@Pc(252) float[] local252 = local19 ? Static287.aFloatArray30 : Static287.aFloatArray26;
			@Pc(258) float[] local258 = local19 ? Static287.aFloatArray25 : Static287.aFloatArray23;
			@Pc(264) float[] local264 = local19 ? Static287.aFloatArray28 : Static287.aFloatArray29;
			@Pc(270) int[] local270 = local19 ? Static287.anIntArray360 : Static287.anIntArray361;
			...
			@Pc(486) int local486 = Static357.method4688(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static287.aFloatArray27[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static287.aFloatArray27[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt4809 > 0) {
			local176 = this.anInt4809 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean438) {
				for (local212 = 0; local212 < this.anInt4810; local212++) {
					local1254 = (this.anInt4809 >> 1) + local212;
					local1228[local212] += this.aFloatArray24[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static287.aFloatArray27[local212];
				}
			}
		}
		local154 = this.aFloatArray24;
		this.aFloatArray24 = Static287.aFloatArray27;
		Static287.aFloatArray27 = local154;
		this.anInt4809 = local25;
		this.anInt4810 = local104 - (local25 >> 1);
		this.aBoolean438 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!nr", name = "a", descriptor = "([I)Lclient!cj;")
	public Class1_Sub8_Sub1 method3802(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray72 == null) {
			this.anInt4809 = 0;
			this.aFloatArray24 = new float[Static287.anInt4805];
			this.aByteArray72 = new byte[this.anInt4806];
			this.anInt4813 = 0;
			this.anInt4812 = 0;
		}
		while (this.anInt4812 < this.aByteArrayArray93.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method3801(this.anInt4812);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt4813;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt4806 - local47) {
					local50 = this.anInt4806 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray72[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt4813;
				}
				this.anInt4813 = local47;
			}
			this.anInt4812++;
		}
		this.aFloatArray24 = null;
		@Pc(129) byte[] local129 = this.aByteArray72;
		this.aByteArray72 = null;
		return new Class1_Sub8_Sub1(this.anInt4811, local129, this.anInt4808, this.anInt4803, this.aBoolean439);
	}

	@OriginalMember(owner = "client!nr", name = "b", descriptor = "([B)V")
	private void method3804(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub19 local4 = new Class1_Sub19(arg0);
		this.anInt4811 = local4.method2877();
		this.anInt4806 = local4.method2877();
		this.anInt4808 = local4.method2877();
		this.anInt4803 = local4.method2877();
		if (this.anInt4803 < 0) {
			this.anInt4803 = ~this.anInt4803;
			this.aBoolean439 = true;
		}
		@Pc(40) int local40 = local4.method2877();
		this.aByteArrayArray93 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method2915();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method2937(local49, local64);
			this.aByteArrayArray93[local46] = local64;
		}
	}
}
