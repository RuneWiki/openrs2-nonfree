...
public final class qa implements Interface18 {
	...
	@OriginalMember(owner = "client!qa", name = "j", descriptor = "Lclient!l;")
	private final l aL1;
	...
	public native void s(@OriginalArg(0) Class65 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class81 arg2);

	@OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lclient!v;BIZ)Lclient!da;")
	public Class65 method6245(@OriginalArg(0) v arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) v local8;
		@Pc(5) v local5;
		if (arg1 == 1) {
			local5 = this.aV8;
		...
		local8.aClass190Array4 = arg0.aClass190Array4;
		local8.aClass52Array5 = arg0.aClass52Array5;
		return local8;
	}

	@OriginalMember(owner = "client!qa", name = "XA", descriptor = "(Lclient!da;IILclient!q;Z)Z")
	public native boolean XA(@OriginalArg(0) Class65 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class81 arg3, @OriginalArg(4) boolean arg4);

	@OriginalMember(owner = "client!qa", name = "DA", descriptor = "(Lclient!r;II)V")
	private native void DA(@OriginalArg(0) Class7 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
	...
	public native void ZA(@OriginalArg(0) Class115 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
	...
	public native void i(@OriginalArg(0) Class65 arg0, @OriginalArg(1) Class65 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!qa", name = "LA", descriptor = "(Lclient!da;Lclient!q;[II)V")
	public native void LA(@OriginalArg(0) Class65 arg0, @OriginalArg(1) Class81 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3);
	...
	public native void HA(@OriginalArg(0) Class7 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5);

	@OriginalMember(owner = "client!qa", name = "la", descriptor = "(Lclient!i;IIIIIII[[Z)V")
	public native void la(@OriginalArg(0) Class115 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean[][] arg8);

	@OriginalMember(owner = "client!qa", name = "G", descriptor = "(Lclient!r;IIIIIII)V")
	public native void G(@OriginalArg(0) Class7 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
	...
	public native void J(@OriginalArg(0) Class65 arg0, @OriginalArg(1) Class81 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4);
}
