...
public final class qa implements Interface15 {
	...
	public native void ZA(@OriginalArg(0) Class47 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!qa", name = "s", descriptor = "(Lclient!da;[ILclient!q;)V")
	public native void s(@OriginalArg(0) Class63 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class113 arg2);
	...
	public Class63 method5732(@OriginalArg(0) v arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) v local8;
		@Pc(5) v local5;
		if (arg1 == 1) {
			local5 = this.aV3;
		...
		local8.aClass206Array5 = arg0.aClass206Array5;
		local8.aClass158Array5 = arg0.aClass158Array5;
		return local8;
	}
	...
	public native void G(@OriginalArg(0) Class134 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);

	@OriginalMember(owner = "client!qa", name = "HA", descriptor = "(Lclient!r;[I[I[I[SI)V")
	public native void HA(@OriginalArg(0) Class134 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5);

	@OriginalMember(owner = "client!qa", name = "LA", descriptor = "(Lclient!da;Lclient!q;[II)V")
	public native void LA(@OriginalArg(0) Class63 arg0, @OriginalArg(1) Class113 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3);

	@OriginalMember(owner = "client!qa", name = "XA", descriptor = "(Lclient!da;IILclient!q;Z)Z")
	public native boolean XA(@OriginalArg(0) Class63 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class113 arg3, @OriginalArg(4) boolean arg4);

	@OriginalMember(owner = "client!qa", name = "la", descriptor = "(Lclient!i;IIIIIII[[Z)V")
	public native void la(@OriginalArg(0) Class47 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean[][] arg8);

	@OriginalMember(owner = "client!qa", name = "J", descriptor = "(Lclient!da;Lclient!q;[III)V")
	public native void J(@OriginalArg(0) Class63 arg0, @OriginalArg(1) Class113 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4);
	...
	public native void i(@OriginalArg(0) Class63 arg0, @OriginalArg(1) Class63 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!qa", name = "DA", descriptor = "(Lclient!r;II)V")
	private native void DA(@OriginalArg(0) Class134 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
