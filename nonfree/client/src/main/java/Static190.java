...
public final class Static190 {
	...
	@OriginalMember(owner = "client!jj", name = "a", descriptor = "(Lclient!kr;I)V")
	public static void method579(@OriginalArg(0) Class147 arg0) {
		Static132.aClass147_1 = arg0;
	}

	@OriginalMember(owner = "client!jj", name = "c", descriptor = "(II)I")
	public static int method580(@OriginalArg(1) int arg0) {
		if (arg0 < 96) {
			return 0;
		} else if (arg0 < 128) {
			return 2;
