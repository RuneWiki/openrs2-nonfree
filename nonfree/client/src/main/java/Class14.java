...
public final class Class14 {
	...
	public final int anInt451;

	@OriginalMember(owner = "client!cd", name = "b", descriptor = "I")
	public final int anInt448;

	@OriginalMember(owner = "client!cd", name = "g", descriptor = "I")
	public final int anInt449;

	@OriginalMember(owner = "client!cd", name = "l", descriptor = "I")
	public final int anInt450;
	...
	@OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
	public Class14(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18) {
		...
		@Pc(48) int[] local48 = Static17.anIntArrayArray4[arg0];
		@Pc(51) int local51 = local48.length;
		this.anIntArray94 = new int[local51];
		this.anIntArray86 = new int[local51];
		...
		for (@Pc(79) int local79 = 0; local79 < local51; local79++) {
			...
			this.anIntArray94[local79] = local140;
			this.anIntArray86[local79] = local144;
			this.anIntArray83[local79] = local142;
			local66[local79] = local146;
			local69[local79] = local148;
		}
		@Pc(534) int[] local534 = Static17.anIntArrayArray3[arg0];
		local140 = local534.length / 4;
		this.anIntArray93 = new int[local140];
		this.anIntArray96 = new int[local140];
		this.anIntArray92 = new int[local140];
		this.anIntArray95 = new int[local140];
		this.anIntArray91 = new int[local140];
		this.anIntArray85 = new int[local140];
		if (arg2 != -1) {
			this.anIntArray88 = new int[local140];
		}
		local142 = 0;
		for (local144 = 0; local144 < local140; local144++) {
			...
			this.anIntArray93[local144] = local148;
			this.anIntArray96[local144] = local591;
			this.anIntArray92[local144] = local597;
			if (local146 == 0) {
				this.anIntArray95[local144] = local66[local148];
				this.anIntArray91[local144] = local66[local591];
				this.anIntArray85[local144] = local66[local597];
				if (this.anIntArray88 != null) {
					this.anIntArray88[local144] = -1;
				}
			} else {
				this.anIntArray95[local144] = local69[local148];
				this.anIntArray91[local144] = local69[local591];
				this.anIntArray85[local144] = local69[local597];
				if (this.anIntArray88 != null) {
					this.anIntArray88[local144] = arg2;
				}
			}
		}
		local146 = arg5;
