...
public final class Class14 {
	...
	@OriginalMember(owner = "client!d", name = "<init>", descriptor = "(Lclient!dc;II)V")
	...
	public void method348(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) throws IOException {
		try {
			...
			if (this.aLong26 != -1L && this.aLong25 + (long) arg1 > (long) this.aByteArray5.length + this.aLong26) {
				...
				arg1 -= local92;
				Static110.method993(arg0, arg2, this.aByteArray5, (int) (this.aLong25 - this.aLong26), local92);
				arg2 += local92;
			...
			if (arg1 > this.aByteArray5.length) {
				...
				if (local164 > -1L && local164 < local155) {
					...
					Static110.method993(arg0, (int) (local164 + (long) arg2 - this.aLong25), this.aByteArray4, (int) (local164 - this.aLong27), local325);
				}
				this.aLong25 += arg1;
			} else if (arg1 > 0) {
				if (this.aLong26 == -1L) {
				...
				Static110.method993(arg0, arg2, this.aByteArray5, (int) (this.aLong25 - this.aLong26), arg1);
				this.aLong25 += arg1;
	...
	@OriginalMember(owner = "client!d", name = "a", descriptor = "(III[B)V")
	public void method350(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) byte[] arg2) throws IOException {
		try {
			...
			if (this.aLong26 != -1L && this.aLong25 >= this.aLong26 && (long) arg1 + this.aLong25 <= (long) this.anInt414 + this.aLong26) {
				Static110.method993(this.aByteArray5, (int) (this.aLong25 - this.aLong26), arg2, 0, arg1);
				this.aLong25 += arg1;
				return;
			}
			...
			if (this.aLong25 >= this.aLong27 && this.aLong25 < (long) this.anInt417 + this.aLong27) {
				...
				arg1 -= local124;
				Static110.method993(this.aByteArray4, (int) (this.aLong25 - this.aLong27), arg2, 0, local124);
			...
			if (this.aByteArray4.length < arg1) {
				...
				arg1 -= local124;
				Static110.method993(this.aByteArray4, 0, arg2, arg0, local124);
				this.aLong25 += local124;
				arg0 += local124;
			}
			if (this.aLong26 != -1L) {
				...
				if (local312 > -1L && local312 < local314) {
					...
					Static110.method993(this.aByteArray5, (int) (local312 - this.aLong26), arg2, (int) (local312 - local86), local435);
	...
	@OriginalMember(owner = "client!d", name = "a", descriptor = "(I)J")
	...
	private void method352() throws IOException {
		...
		if (local49 > -1L && local47 > local49) {
			...
			Static110.method993(this.aByteArray5, (int) (local49 - this.aLong26), this.aByteArray4, (int) (local49 - this.aLong27), local195);
		}
		this.anInt414 = 0;
		this.aLong26 = -1L;
	}
