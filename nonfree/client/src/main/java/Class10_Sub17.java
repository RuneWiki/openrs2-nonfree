...
public final class Class10_Sub17 extends Class10 {
	...
	public Class10_Sub17(@OriginalArg(0) byte[] arg0) {
		this.method1963(arg0);
	}

	@OriginalMember(owner = "client!fh", name = "a", descriptor = "([I)Lclient!wq;")
	public Class10_Sub25_Sub1 method1960(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray22 == null) {
			this.anInt2261 = 0;
			this.aFloatArray21 = new float[Static112.anInt2256];
			this.aByteArray22 = new byte[this.anInt2258];
			this.anInt2264 = 0;
			this.anInt2263 = 0;
		}
		while (this.anInt2263 < this.aByteArrayArray16.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1966(this.anInt2263);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2264;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt2258 - local47) {
					local50 = this.anInt2258 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray22[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2264;
				}
				this.anInt2264 = local47;
			}
			this.anInt2263++;
		}
		this.aFloatArray21 = null;
		@Pc(129) byte[] local129 = this.aByteArray22;
		this.aByteArray22 = null;
		return new Class10_Sub25_Sub1(this.anInt2253, local129, this.anInt2262, this.anInt2254, this.aBoolean140);
	}

	@OriginalMember(owner = "client!fh", name = "b", descriptor = "([B)V")
	private void method1963(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class10_Sub8 local4 = new Class10_Sub8(arg0);
		this.anInt2253 = local4.method2459();
		this.anInt2258 = local4.method2459();
		this.anInt2262 = local4.method2459();
		this.anInt2254 = local4.method2459();
		if (this.anInt2254 < 0) {
			this.anInt2254 = ~this.anInt2254;
			this.aBoolean140 = true;
		}
		@Pc(40) int local40 = local4.method2459();
		this.aByteArrayArray16 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method2502();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method2493(local49, local64);
			this.aByteArrayArray16[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!fh", name = "a", descriptor = "(I)[F")
	private float[] method1966(@OriginalArg(0) int arg0) {
		Static112.method1964(this.aByteArrayArray16[arg0]);
		Static112.method1965();
		@Pc(15) int local15 = Static112.method1970(Static365.method2559(Static112.anIntArray202.length - 1));
		@Pc(19) boolean local19 = Static112.aBooleanArray4[local15];
		@Pc(25) int local25 = local19 ? Static112.anInt2256 : Static112.anInt2260;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static112.method1965() != 0;
			local29 = Static112.method1965() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static112.anInt2260 >> 2);
			local67 = (local25 >> 2) + (Static112.anInt2260 >> 2);
			local71 = Static112.anInt2260 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static112.anInt2260 >> 2);
			local104 = local25 + (Static112.anInt2260 >> 2) - (local25 >> 2);
			local108 = Static112.anInt2260 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class140 local123 = Static112.aClass140Array1[Static112.anIntArray202[local15]];
		@Pc(126) int local126 = local123.anInt4089;
		@Pc(131) int local131 = local123.anIntArray408[local126];
		@Pc(140) boolean local140 = !Static112.aClass72Array1[local131].method1797();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt4088; local144++) {
			@Pc(152) Class152 local152 = Static112.aClass152Array1[local123.anIntArray407[local144]];
			local154 = Static112.aFloatArray19;
			local152.method3381(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt4089;
			local176 = local123.anIntArray408[local171];
			Static112.aClass72Array1[local176].method1795(Static112.aFloatArray19, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static112.aFloatArray19[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static112.aFloatArray19;
			...
			@Pc(252) float[] local252 = local19 ? Static112.aFloatArray20 : Static112.aFloatArray17;
			@Pc(258) float[] local258 = local19 ? Static112.aFloatArray14 : Static112.aFloatArray15;
			@Pc(264) float[] local264 = local19 ? Static112.aFloatArray16 : Static112.aFloatArray18;
			@Pc(270) int[] local270 = local19 ? Static112.anIntArray200 : Static112.anIntArray201;
			...
			@Pc(486) int local486 = Static365.method2559(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static112.aFloatArray19[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static112.aFloatArray19[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt2261 > 0) {
			local176 = this.anInt2261 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean141) {
				for (local212 = 0; local212 < this.anInt2259; local212++) {
					local1254 = (this.anInt2261 >> 1) + local212;
					local1228[local212] += this.aFloatArray21[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static112.aFloatArray19[local212];
				}
			}
		}
		local154 = this.aFloatArray21;
		this.aFloatArray21 = Static112.aFloatArray19;
		Static112.aFloatArray19 = local154;
		this.anInt2261 = local25;
		this.anInt2259 = local104 - (local25 >> 1);
		this.aBoolean141 = local140;
		return local1228;
	}
}
