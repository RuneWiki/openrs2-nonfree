...
public final class Static26 {
	...
	private static Class106 aClass106_1 = new Class106();

	@OriginalMember(owner = "client!bm", name = "a", descriptor = "(Lclient!kf;)V")
	private static void method348(@OriginalArg(0) Class106 arg0) {
		arg0.anInt2843 = 0;
	...
	private static byte method349(@OriginalArg(0) Class106 arg0) {
		return (byte) method350(8, arg0);
	}

	@OriginalMember(owner = "client!bm", name = "a", descriptor = "(ILclient!kf;)I")
	private static int method350(@OriginalArg(0) int arg0, @OriginalArg(1) Class106 arg1) {
	...
	public static int method351(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3) {
		@Pc(2) Class106 local2 = aClass106_1;
		synchronized (aClass106_1) {
			aClass106_1.aByteArray23 = arg2;
			aClass106_1.anInt2847 = 9;
			aClass106_1.aByteArray26 = arg0;
			aClass106_1.anInt2851 = 0;
			aClass106_1.anInt2846 = arg1;
			aClass106_1.anInt2852 = 0;
			aClass106_1.anInt2834 = 0;
			aClass106_1.anInt2845 = 0;
			aClass106_1.anInt2833 = 0;
			method354(aClass106_1);
			@Pc(37) int local37 = arg1 - aClass106_1.anInt2846;
			aClass106_1.aByteArray23 = null;
			aClass106_1.aByteArray26 = null;
			return local37;
		}
	}

	@OriginalMember(owner = "client!bm", name = "c", descriptor = "(Lclient!kf;)B")
	private static byte method352(@OriginalArg(0) Class106 arg0) {
		return (byte) method350(1, arg0);
	}

	@OriginalMember(owner = "client!bm", name = "d", descriptor = "(Lclient!kf;)V")
	private static void method354(@OriginalArg(0) Class106 arg0) {
		arg0.anInt2840 = 1;
		if (Static149.anIntArray265 == null) {
			Static149.anIntArray265 = new int[arg0.anInt2840 * 100000];
		}
		...
		while (true) {
			while (local56) {
				...
				local61 = method349(arg0);
				local61 = method349(arg0);
				local61 = method352(arg0);
				if (local61 != 0) {
				}
				arg0.anInt2836 = 0;
				local61 = method349(arg0);
				arg0.anInt2836 = arg0.anInt2836 << 8 | local61 & 0xFF;
				local61 = method349(arg0);
				arg0.anInt2836 = arg0.anInt2836 << 8 | local61 & 0xFF;
				local61 = method349(arg0);
				arg0.anInt2836 = arg0.anInt2836 << 8 | local61 & 0xFF;
				...
				for (local141 = 0; local141 < 256; local141++) {
					arg0.aBooleanArray15[local141] = false;
				}
				@Pc(187) int local187;
				for (local141 = 0; local141 < 16; local141++) {
					if (arg0.aBooleanArray14[local141]) {
						for (local187 = 0; local187 < 16; local187++) {
							local61 = method352(arg0);
							if (local61 == 1) {
								arg0.aBooleanArray15[local141 * 16 + local187] = true;
							}
						}
					}
				}
				...
				for (local141 = 0; local141 < local224; local141++) {
					...
					while (true) {
						local61 = method352(arg0);
						if (local61 == 0) {
							arg0.aByteArray24[local141] = (byte) local187;
							break;
						}
						local187++;
					}
				...
				for (local141 = 0; local141 < local224; local141++) {
					local252 = arg0.aByteArray24[local141];
				...
				for (local308 = 0; local308 < local220; local308++) {
					...
					for (local141 = 0; local141 < local216; local141++) {
						while (true) {
							local61 = method352(arg0);
							if (local61 == 0) {
								arg0.aByteArrayArray19[local308][local141] = (byte) local315;
								break;
							}
							local61 = method352(arg0);
							if (local61 == 0) {
				...
				for (local308 = 0; local308 < local220; local308++) {
					...
					for (local141 = 0; local141 < local216; local141++) {
						if (arg0.aByteArrayArray19[local308][local141] > local356) {
							local356 = arg0.aByteArrayArray19[local308][local141];
						}
						if (arg0.aByteArrayArray19[local308][local141] < local354) {
							local354 = arg0.aByteArrayArray19[local308][local141];
						}
					}
					method356(arg0.anIntArrayArray22[local308], arg0.anIntArrayArray21[local308], arg0.anIntArrayArray23[local308], arg0.aByteArrayArray19[local308], local354, local356, local216);
					arg0.anIntArray254[local308] = local354;
				}
				@Pc(425) int local425 = arg0.anInt2843 + 1;
				@Pc(427) byte local427 = -1;
				for (local141 = 0; local141 <= 255; local141++) {
					arg0.anIntArray255[local141] = 0;
				}
				...
				while (true) {
						...
						if (local537 == 0 || local537 == 1) {
							...
							do {
								...
								if (local506 == 0) {
									...
									local490 = arg0.anIntArray254[local485];
									local495 = arg0.anIntArrayArray22[local485];
									local500 = arg0.anIntArrayArray23[local485];
									local505 = arg0.anIntArrayArray21[local485];
								}
								local506--;
								local508 = local490;
								for (local512 = method350(local490, arg0); local512 > local495[local508]; local512 = local512 << 1 | local522) {
							...
							local548++;
							local61 = arg0.aByteArray27[arg0.aByteArray25[arg0.anIntArray252[0]] & 0xFF];
							arg0.anIntArray255[local61 & 0xFF] += local548;
							while (local548 > 0) {
								Static149.anIntArray265[local475] = local61 & 0xFF;
								local475++;
								local548--;
							}
						} else {
							...
							if (local678 < 16) {
								...
								local686 = arg0.anIntArray252[local776] + local780;
								local61 = arg0.aByteArray25[local686];
								while (local686 > arg0.anIntArray252[local776]) {
									arg0.aByteArray25[local686] = arg0.aByteArray25[local686 - 1];
									local686--;
								}
								@Pc(815) int local815 = arg0.anIntArray252[local776]++;
								while (local776 > 0) {
									local815 = arg0.anIntArray252[local776]--;
									arg0.aByteArray25[arg0.anIntArray252[local776]] = arg0.aByteArray25[arg0.anIntArray252[local776 - 1] + 16 - 1];
									local776--;
								}
								local815 = arg0.anIntArray252[0]--;
								arg0.aByteArray25[arg0.anIntArray252[0]] = local61;
								if (arg0.anIntArray252[0] == 0) {
									local443 = 4095;
									for (local445 = 15; local445 >= 0; local445--) {
										for (local449 = 15; local449 >= 0; local449--) {
											arg0.aByteArray25[local443] = arg0.aByteArray25[arg0.anIntArray252[local445] + local449];
											local443--;
										}
										arg0.anIntArray252[local445] = local443 + 1;
									}
							...
							arg0.anIntArray255[arg0.aByteArray27[local61 & 0xFF] & 0xFF]++;
							Static149.anIntArray265[local475] = arg0.aByteArray27[local61 & 0xFF] & 0xFF;
							local475++;
							if (local506 == 0) {
								local478++;
								local506 = 50;
					...
					for (local141 = 1; local141 <= 256; local141++) {
						arg0.anIntArray253[local141] = arg0.anIntArray255[local141 - 1];
					}
					for (local141 = 1; local141 <= 256; local141++) {
						arg0.anIntArray253[local141] += arg0.anIntArray253[local141 - 1];
					}
					for (local141 = 0; local141 < local475; local141++) {
						local61 = (byte) (Static149.anIntArray265[local141] & 0xFF);
						Static149.anIntArray265[arg0.anIntArray253[local61 & 0xFF]] |= local141 << 8;
						arg0.anIntArray253[local61 & 0xFF]++;
					}
					arg0.anInt2838 = Static149.anIntArray265[arg0.anInt2836] >> 8;
					arg0.anInt2848 = 0;
					arg0.anInt2838 = Static149.anIntArray265[arg0.anInt2838];
	...
	private static void method355(@OriginalArg(0) Class106 arg0) {
		...
		Static149.anIntArray265 = local13;
