...
public final class Class36_Sub18 extends Class36 {

	@OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(ILclient!gn;)V")
	public Class36_Sub18(@OriginalArg(0) int arg0, @OriginalArg(1) Class8_Sub25 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(Lclient!gn;)V")
	public Class36_Sub18(@OriginalArg(0) Class8_Sub25 arg0) {
		super(arg0);
	}
