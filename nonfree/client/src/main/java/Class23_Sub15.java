...
public final class Class23_Sub15 extends Class23 {

	@OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(ILclient!ts;)V")
	public Class23_Sub15(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub48 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Lclient!ts;)V")
	public Class23_Sub15(@OriginalArg(0) Class3_Sub48 arg0) {
		super(arg0);
	}
