...
public final class Class1_Sub14 extends Class1 {
	...
	private float[] method977(@OriginalArg(0) int arg0) {
		Static55.method985(this.aByteArrayArray2[arg0]);
		Static55.method986();
		@Pc(15) int local15 = Static55.method976(Static136.method2283(Static55.anIntArray112.length - 1));
		@Pc(19) boolean local19 = Static55.aBooleanArray6[local15];
		@Pc(25) int local25 = local19 ? Static55.anInt1317 : Static55.anInt1313;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static55.method986() != 0;
			local29 = Static55.method986() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static55.anInt1313 >> 2);
			local67 = (local25 >> 2) + (Static55.anInt1313 >> 2);
			local71 = Static55.anInt1313 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static55.anInt1313 >> 2);
			local104 = local25 + (Static55.anInt1313 >> 2) - (local25 >> 2);
			local108 = Static55.anInt1313 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class86 local123 = Static55.aClass86Array1[Static55.anIntArray112[local15]];
		@Pc(126) int local126 = local123.anInt4003;
		@Pc(131) int local131 = local123.anIntArray421[local126];
		@Pc(140) boolean local140 = !Static55.aClass17Array1[local131].method768();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt4004; local144++) {
			@Pc(152) Class74 local152 = Static55.aClass74Array1[local123.anIntArray422[local144]];
			local154 = Static55.aFloatArray9;
			local152.method2370(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt4003;
			local176 = local123.anIntArray421[local171];
			Static55.aClass17Array1[local176].method773(Static55.aFloatArray9, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static55.aFloatArray9[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static55.aFloatArray9;
			...
			@Pc(252) float[] local252 = local19 ? Static55.aFloatArray3 : Static55.aFloatArray7;
			@Pc(258) float[] local258 = local19 ? Static55.aFloatArray2 : Static55.aFloatArray5;
			@Pc(264) float[] local264 = local19 ? Static55.aFloatArray4 : Static55.aFloatArray8;
			@Pc(270) int[] local270 = local19 ? Static55.anIntArray111 : Static55.anIntArray113;
			...
			@Pc(486) int local486 = Static136.method2283(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static55.aFloatArray9[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static55.aFloatArray9[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt1314 > 0) {
			local176 = this.anInt1314 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean54) {
				for (local212 = 0; local212 < this.anInt1312; local212++) {
					local1254 = (this.anInt1314 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static55.aFloatArray9[local212];
				}
			}
		}
		local154 = this.aFloatArray6;
		this.aFloatArray6 = Static55.aFloatArray9;
		Static55.aFloatArray9 = local154;
		this.anInt1314 = local25;
		this.anInt1312 = local104 - (local25 >> 1);
		this.aBoolean54 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!ga", name = "a", descriptor = "([I)Lclient!dc;")
	public Class1_Sub11_Sub1 method978(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray6 == null) {
			this.anInt1314 = 0;
			this.aFloatArray6 = new float[Static55.anInt1317];
			this.aByteArray6 = new byte[this.anInt1315];
			this.anInt1323 = 0;
			this.anInt1322 = 0;
		}
		while (this.anInt1322 < this.aByteArrayArray2.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method977(this.anInt1322);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt1323;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt1315 - local47) {
					local50 = this.anInt1315 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray6[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt1323;
				}
				this.anInt1323 = local47;
			}
			this.anInt1322++;
		}
		this.aFloatArray6 = null;
		@Pc(129) byte[] local129 = this.aByteArray6;
		this.aByteArray6 = null;
		return new Class1_Sub11_Sub1(this.anInt1320, local129, this.anInt1318, this.anInt1316, this.aBoolean55);
	}

	@OriginalMember(owner = "client!ga", name = "b", descriptor = "([B)V")
	private void method984(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub8 local4 = new Class1_Sub8(arg0);
		this.anInt1320 = local4.method347();
		this.anInt1315 = local4.method347();
		this.anInt1318 = local4.method347();
		this.anInt1316 = local4.method347();
		if (this.anInt1316 < 0) {
			this.anInt1316 = ~this.anInt1316;
			this.aBoolean55 = true;
		}
		@Pc(40) int local40 = local4.method347();
		this.aByteArrayArray2 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method336();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method319(local49, local64);
