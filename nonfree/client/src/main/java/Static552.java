...
public final class Static552 {
	...
	@OriginalMember(owner = "client!fc", name = "a", descriptor = "(II[B[IIIIIIIILclient!fc;II)I")
	public static int method2457(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class5_Sub15_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt2741 -= arg8.anInt2738 * arg3;
		arg8.anInt2735 -= arg8.anInt2740 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!fc", name = "a", descriptor = "(I[B[IIIIIIIILclient!fc;)I")
	public static int method2458(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class5_Sub15_Sub1 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt2744 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!fc", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!fc;)I")
	public static int method2461(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class5_Sub15_Sub1 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt2734 += arg10.anInt2742 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt2741 = arg4 >> 2;
		arg10.anInt2735 = arg5 >> 2;
		arg10.anInt2744 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!fc", name = "a", descriptor = "([B[IIIIIIIILclient!fc;)I")
	public static int method2462(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class5_Sub15_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt2741 += arg8.anInt2738 * (local22 - arg3);
		arg8.anInt2735 += arg8.anInt2740 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt2734 = arg4 >> 2;
		arg8.anInt2744 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!fc", name = "a", descriptor = "([B[IIIIIIILclient!fc;)I")
	public static int method2464(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class5_Sub15_Sub1 arg7) {
		arg2 >>= 0x8;
	...
	@OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lclient!ar;III)Lclient!fc;")
	public static Class5_Sub15_Sub1 method2466(@OriginalArg(0) Class5_Sub5_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray6 == null || arg0.aByteArray6.length == 0 ? null : new Class5_Sub15_Sub1(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!fc", name = "b", descriptor = "([B[IIIIIIIILclient!fc;)I")
	public static int method2468(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class5_Sub15_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt2741 += arg8.anInt2738 * (local24 - arg3);
		arg8.anInt2735 += arg8.anInt2740 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!fc", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!fc;)I")
	public static int method2471(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class5_Sub15_Sub1 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt2734 += arg10.anInt2742 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	public static int method2473(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!fc", name = "a", descriptor = "(II[B[IIIIIIILclient!fc;II)I")
	public static int method2474(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class5_Sub15_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!fc", name = "b", descriptor = "(II[B[IIIIIIIILclient!fc;II)I")
	...
	@OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lclient!ar;II)Lclient!fc;")
	public static Class5_Sub15_Sub1 method2476(@OriginalArg(0) Class5_Sub5_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray6 == null || arg0.aByteArray6.length == 0 ? null : new Class5_Sub15_Sub1(arg0, (int) ((long) arg0.anInt484 * 256L * (long) 100 / (long) (Static527.anInt8915 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!fc", name = "c", descriptor = "(II[B[IIIIIIIILclient!fc;II)I")
	public static int method2479(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class5_Sub15_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!fc", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!fc;II)I")
	public static int method2482(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class5_Sub15_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt2734 -= arg10.anInt2742 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt2734 += arg10.anInt2742 * local63;
		arg10.anInt2741 = arg4;
		arg10.anInt2735 = arg5;
		arg10.anInt2744 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!fc", name = "b", descriptor = "(I[B[IIIIIIIILclient!fc;)I")
	public static int method2483(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class5_Sub15_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!fc", name = "b", descriptor = "([B[IIIIIIILclient!fc;)I")
	public static int method2485(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class5_Sub15_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!fc", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!fc;II)I")
	public static int method2488(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class5_Sub15_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt2734 -= arg10.anInt2742 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!fc", name = "b", descriptor = "(II[B[IIIIIIILclient!fc;II)I")
	public static int method2493(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class5_Sub15_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!fc", name = "d", descriptor = "(II[B[IIIIIIIILclient!fc;II)I")
	public static int method2494(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class5_Sub15_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt2741 -= arg8.anInt2738 * arg3;
		arg8.anInt2735 -= arg8.anInt2740 * arg3;
		@Pc(32) int local32;
