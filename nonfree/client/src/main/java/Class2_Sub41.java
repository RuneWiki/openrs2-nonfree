...
public final class Class2_Sub41 extends Class2 {
	...
	@OriginalMember(owner = "client!u", name = "a", descriptor = "([I)Lclient!lf;")
	public Class2_Sub14_Sub1 method5631(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray86 == null) {
			this.anInt7025 = 0;
			this.aFloatArray24 = new float[Static403.anInt7023];
			this.aByteArray86 = new byte[this.anInt7028];
			this.anInt7032 = 0;
			this.anInt7031 = 0;
		}
		while (this.anInt7031 < this.aByteArrayArray20.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method5637(this.anInt7031);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt7032;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt7028 - local47) {
					local50 = this.anInt7028 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt7032;
				}
				this.anInt7032 = local47;
			}
			this.anInt7031++;
		}
		...
		return new Class2_Sub14_Sub1(this.anInt7022, local129, this.anInt7030, this.anInt7024, this.aBoolean466);
	}

	@OriginalMember(owner = "client!u", name = "b", descriptor = "([B)V")
	private void method5634(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub17 local4 = new Class2_Sub17(arg0);
		this.anInt7022 = local4.method6129();
		this.anInt7028 = local4.method6129();
		this.anInt7030 = local4.method6129();
		this.anInt7024 = local4.method6129();
		if (this.anInt7024 < 0) {
			this.anInt7024 = ~this.anInt7024;
			this.aBoolean466 = true;
		}
		@Pc(40) int local40 = local4.method6129();
		this.aByteArrayArray20 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method6138();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method6164(local49, local64);
			this.aByteArrayArray20[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!u", name = "a", descriptor = "(I)[F")
	private float[] method5637(@OriginalArg(0) int arg0) {
		Static403.method5642(this.aByteArrayArray20[arg0]);
		Static403.method5639();
		@Pc(15) int local15 = Static403.method5641(Static109.method1799(Static403.anIntArray574.length - 1));
		@Pc(19) boolean local19 = Static403.aBooleanArray23[local15];
		@Pc(25) int local25 = local19 ? Static403.anInt7023 : Static403.anInt7029;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static403.method5639() != 0;
			local29 = Static403.method5639() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static403.anInt7029 >> 2);
			local67 = (local25 >> 2) + (Static403.anInt7029 >> 2);
			local71 = Static403.anInt7029 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static403.anInt7029 >> 2);
			local104 = local25 + (Static403.anInt7029 >> 2) - (local25 >> 2);
			local108 = Static403.anInt7029 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class74 local123 = Static403.aClass74Array1[Static403.anIntArray574[local15]];
		@Pc(126) int local126 = local123.anInt1710;
		@Pc(131) int local131 = local123.anIntArray122[local126];
		@Pc(140) boolean local140 = !Static403.aClass269Array1[local131].method6096();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt1711; local144++) {
			@Pc(152) Class32 local152 = Static403.aClass32Array1[local123.anIntArray121[local144]];
			local154 = Static403.aFloatArray22;
			local152.method611(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt1710;
			local176 = local123.anIntArray122[local171];
			Static403.aClass269Array1[local176].method6097(Static403.aFloatArray22, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static403.aFloatArray22[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static403.aFloatArray22;
			...
			@Pc(252) float[] local252 = local19 ? Static403.aFloatArray27 : Static403.aFloatArray21;
			@Pc(258) float[] local258 = local19 ? Static403.aFloatArray26 : Static403.aFloatArray28;
			@Pc(264) float[] local264 = local19 ? Static403.aFloatArray25 : Static403.aFloatArray23;
			@Pc(270) int[] local270 = local19 ? Static403.anIntArray573 : Static403.anIntArray572;
			...
			@Pc(486) int local486 = Static109.method1799(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static403.aFloatArray22[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static403.aFloatArray22[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt7025 > 0) {
			local176 = this.anInt7025 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean464) {
				for (local212 = 0; local212 < this.anInt7026; local212++) {
					local1254 = (this.anInt7025 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static403.aFloatArray22[local212];
				}
			}
		}
		local154 = this.aFloatArray24;
		this.aFloatArray24 = Static403.aFloatArray22;
		Static403.aFloatArray22 = local154;
		this.anInt7025 = local25;
		this.anInt7026 = local104 - (local25 >> 1);
		this.aBoolean464 = local140;
		return local1228;
	}
}
