...
public final class Class155_Sub2 extends Class155 {
	...
	public void method5151(@OriginalArg(0) Canvas arg0) {
		...
		this.anInt5642 = this.aCanvas5.getSize().width;
		this.anInt5646 = this.aCanvas5.getSize().height;
		this.anIntArray385 = new int[this.anInt5642 * this.anInt5646];
		...
		@Pc(62) WritableRaster local62 = Raster.createWritableRaster(local52.createCompatibleSampleModel(this.anInt5642, this.anInt5646), local44, null);
