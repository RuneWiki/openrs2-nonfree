...
public final class Static274 {
	...
	public static void method4646() {
		Static141.method2180(Static279.anInt5583);
	}

	@OriginalMember(owner = "client!rn", name = "a", descriptor = "(IBII)V")
	public static void method4647(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		Static83.anInt1515 = arg2;
		Static37.anInt694 = arg0;
		Static215.anInt4404 = arg1;
	}

	@OriginalMember(owner = "client!rn", name = "a", descriptor = "(IC)C")
	public static char method4648(@OriginalArg(1) char arg0) {
