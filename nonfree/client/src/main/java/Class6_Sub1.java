...
public final class Class6_Sub1 extends Class6 {
	...
	private static int[] anIntArray9 = new int[1];

	@OriginalMember(owner = "client!ah", name = "Q", descriptor = "[F")
	private static final float[] aFloatArray1 = new float[16];

	@OriginalMember(owner = "client!ah", name = "E", descriptor = "[I")
	private static int[] anIntArray10 = new int[1];

	@OriginalMember(owner = "client!ah", name = "T", descriptor = "[I")
	private static int[] anIntArray11 = new int[1];
	...
	@OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lclient!bf;IIII[[I[[II)V", line = 914)
	public Class6_Sub1(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int[][] arg6, @OriginalArg(7) int arg7) {
		...
		this.aFloatArrayArray1 = new float[this.anInt6308 + 1][this.anInt6307 + 1];
		this.aFloatArrayArray3 = new float[this.anInt6308 + 1][this.anInt6307 + 1];
		this.aFloatArrayArray2 = new float[this.anInt6308 + 1][this.anInt6307 + 1];
		for (@Pc(122) int local122 = 1; local122 < this.anInt6307; local122++) {
			for (@Pc(128) int local128 = 1; local128 < this.anInt6308; local128++) {
	...
	public void method5718(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int[] arg10, @OriginalArg(11) int[] arg11, @OriginalArg(12) int[] arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15) {
		...
		this.method5728(arg0, arg1, local7, local41, local12, local50, local17, local22, local27, local32, arg13, arg14, arg15, false);
	}
	...
	public void method5728(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) int[] arg8, @OriginalArg(9) int[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) boolean arg13) {
		if (arg5 != null && this.anIntArrayArrayArray2 == null) {
			this.anIntArrayArrayArray2 = new int[this.anInt6308][this.anInt6307][];
		}
		if (arg3 != null && this.anIntArrayArrayArray5 == null) {
			this.anIntArrayArrayArray5 = new int[this.anInt6308][this.anInt6307][];
		}
		...
		for (@Pc(84) int local84 = 0; local84 < arg6.length; local84++) {
			...
			for (local121 = this.aClass4_7.method90(local115); local121 != null; local121 = this.aClass4_7.method82()) {
				...
				if (local126.anInt6083 == arg8[local84] && local126.aFloat74 == (float) arg9[local84] && local126.anInt6085 == arg10 && local126.anInt6084 == arg11 && local126.anInt6086 == arg12) {
					break;
				}
			}
			if (local121 == null) {
	...
	@OriginalMember(owner = "client!ah", name = "c", descriptor = "(Lclient!kb;IIIIZ)Z", line = 150)
	@Override
	public boolean method5732(@OriginalArg(0) Class2_Sub2_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (this.aClass100_1 == null || arg0 == null) {
			...
			return this.aClass100_1.method2687(local30, arg0, local18);
		}
	}
	...
	@OriginalMember(owner = "client!ah", name = "b", descriptor = "(Lclient!kb;IIIIZ)V", line = 165)
	@Override
	public void method5726(@OriginalArg(0) Class2_Sub2_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (this.aClass100_1 != null && arg0 != null) {
			...
			this.aClass100_1.method2684(arg0, local33, local19);
		}
	}
	...
	public void method5730(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		...
		@Pc(6) float local6 = this.aClass19_Sub1_1.aFloat19;
		@Pc(10) float local10 = this.aClass19_Sub1_1.aFloat12;
		@Pc(16) int local16 = arg2 + arg2 + 1;
		@Pc(20) int local20 = local16 * local16;
		if (anIntArray10.length < local20) {
			anIntArray10 = new int[local20];
		}
		if (aClass2_Sub4_1.aByteArray73.length < this.anInt180 * 2) {
			aClass2_Sub4_1 = new Class2_Sub4(this.anInt180 * 2);
		}
		...
		if (local67 > this.anInt6308 - 1) {
			local67 = this.anInt6308 - 1;
		}
		@Pc(82) int local82 = arg1 + arg2;
		if (local82 > this.anInt6307 - 1) {
			local82 = this.anInt6307 - 1;
		}
		Static8.anInt184 = 0;
		@Pc(97) int local97;
		for (local97 = local47; local97 <= local67; local97++) {
			...
			for (@Pc(108) int local108 = local57; local108 <= local82; local108++) {
				if (local106[local108 - local59]) {
					anIntArray10[Static8.anInt184++] = local108 * this.anInt6308 + local97;
				}
			}
		}
		...
		for (local97 = 0; local97 < this.aClass2_Sub36Array1.length; local97++) {
			this.aClass2_Sub36Array1[local97].method5570(anIntArray10, Static8.anInt184);
		}
		if (!this.aClass135_3.method3551()) {
			local97 = this.aClass19_Sub1_1.anInt613;
			@Pc(180) int local180 = this.aClass19_Sub1_1.anInt601;
			this.aClass19_Sub1_1.method2881(0, local180);
			this.aClass19_Sub1_1.method2825(local10, local6 - 4.0F);
			...
			for (@Pc(236) Class2 local236 = this.aClass135_3.method3552(); local236 != null; local236 = this.aClass135_3.method3553()) {
				@Pc(241) Class2_Sub23 local241 = (Class2_Sub23) local236;
				local241.method3527(arg2, arg0, arg3, arg1);
			}
			this.aClass19_Sub1_1.method793(0, 5890, 768);
			this.aClass19_Sub1_1.method833(0, 5890);
			this.aClass19_Sub1_1.method848(null);
			this.aClass19_Sub1_1.method2881(local97, local180);
		}
		if (this.aClass100_1 != null) {
			this.aClass19_Sub1_1.method2825(local10, local6 - 8.0F);
			this.aClass19_Sub1_1.method849();
			this.aClass19_Sub1_1.method790(this.aClass126_1, null, null, this.aClass126_2);
			this.aClass100_1.method2690(arg3, arg2, arg4, arg1, arg0);
		}
		this.aClass19_Sub1_1.method2825(local10, local6);
	}

	@OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lclient!cs;II)V", line = 310)
	private void method185(@OriginalArg(0) Class2_Sub2_Sub4_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if (anIntArray11.length < local16) {
			anIntArray11 = new int[local16];
			anIntArray9 = new int[local16];
		}
		@Pc(28) int local28;
		for (local28 = 0; local28 < local16; local28++) {
			anIntArray11[local28] = (local6[local28] & 0xFF) >> this.aClass19_Sub1_1.anInt583;
			anIntArray9[local28] = (local13[local28] & 0xFF) >> this.aClass19_Sub1_1.anInt583;
		}
		local28 = 0;
		while (local28 < local16) {
			@Pc(66) int local66 = anIntArray11[local28];
			@Pc(71) int local71 = anIntArray9[local28++];
			@Pc(75) int local75 = anIntArray11[local28];
			@Pc(80) int local80 = anIntArray9[local28++];
			@Pc(84) int local84 = anIntArray11[local28];
			@Pc(89) int local89 = anIntArray9[local28++];
			if ((local66 - local75) * (local80 - local89) - (local80 - local71) * (local84 - local75) > 0) {
				arg0.method1515(local66, local80, local84, local89, local71, local75);
			}
		}
	}
	...
	public int method5729(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (local4 < 0 || local9 < 0 || local4 > this.anInt6308 - 1 || local9 > this.anInt6307 - 1) {
			return 0;
		}
	...
	public void method5719() {
		if (this.anInt185 > 0) {
			@Pc(12) byte[][] local12 = new byte[this.anInt6308 + 1][this.anInt6307 + 1];
			@Pc(14) int local14;
			for (local14 = 1; local14 < this.anInt6308; local14++) {
				for (@Pc(20) int local20 = 1; local20 < this.anInt6307; local20++) {
			...
			for (local14 = 0; local14 < this.aClass2_Sub36Array1.length; local14++) {
				this.aClass2_Sub36Array1[local14].method5566(this.anInt185);
			}
			local14 = 24;
			if (this.anIntArrayArrayArray2 != null) {
				local14 += 4;
			...
			@Pc(149) Class4 local149 = new Class4(Static326.method5856(this.anInt185));
			@Pc(153) Class2_Sub36[] local153 = new Class2_Sub36[this.anInt186];
			@Pc(155) int local155;
			@Pc(161) int local161;
			for (local155 = 0; local155 < this.anInt6308; local155++) {
				for (local161 = 0; local161 < this.anInt6307; local161++) {
					if (this.anIntArrayArrayArray1[local155][local161] != null) {
						...
						@Pc(430) short[] local430 = this.aShortArrayArray1[local161 * this.anInt6308 + local155] = new short[local208.length];
						for (@Pc(432) int local432 = 0; local432 < local208.length; local432++) {
							...
							if (local458 != -1) {
								...
								local500 = Static55.anIntArray107[local458 & 0xFF80 | local702];
								if ((this.anInt181 & 0x7) == 0) {
									...
									local502 = this.aClass19_Sub1_1.aFloat3 + local502 * (local502 > 0.0F ? this.aClass19_Sub1_1.aFloat7 : this.aClass19_Sub1_1.aFloat15);
								}
							}
							...
							if (local773 == null) {
								if (local462 == local458) {
									...
									local805 = Static55.anIntArray107[local462 & 0xFF80 | local786];
									if ((this.anInt181 & 0x7) == 0) {
										...
										local600 = this.aClass19_Sub1_1.aFloat3 + local502 * (local502 > 0.0F ? this.aClass19_Sub1_1.aFloat7 : this.aClass19_Sub1_1.aFloat15);
								...
								local137.putFloat((float) (this.method5729(local445, local454) + local470));
							...
							for (local805 = 0; local805 < local386; local805++) {
								local153[local805].method5565(local502, local516, local500, local398);
							}
							this.anInt180++;
						}
					}
			...
			for (local155 = 0; local155 < this.anInt179; local155++) {
				...
				if (local1115 != null) {
					local1115.method5569(local155);
				}
			}
			for (local155 = 0; local155 < this.anInt6308; local155++) {
				for (local161 = 0; local161 < this.anInt6307; local161++) {
					@Pc(1145) short[] local1145 = this.aShortArrayArray1[local161 * this.anInt6308 + local155];
					if (local1145 != null) {
						...
						while (local1151 < local1145.length) {
							...
							if (local1180 != null) {
								local1180.method5568(local1149, local155, local161);
								local1190 = local1180;
							}
							if (local1184 != null) {
								local1184.method5568(local1149, local155, local161);
								if (local1190 == null || local1184.aLong232 < local1190.aLong232) {
									local1190 = local1184;
								}
							}
							if (local1188 != null) {
								local1188.method5568(local1149, local155, local161);
							...
							if (local1190 != null) {
								if (local1180 != null) {
									local1190.method5569(local1162);
								}
								if (local1184 != null) {
									local1190.method5569(local1169);
								}
								if (local1188 != null) {
									local1190.method5569(local1176);
								}
								local1190.method5568(local1149, local155, local161);
							}
							local1149++;
						}
					}
			...
			for (@Pc(1359) int local1359 = 0; local1359 < this.aClass2_Sub36Array1.length; local1359++) {
				...
				local1369.method5567(this.anInt179);
			}
			Static342.method6145(this.aClass2_Sub36Array1, local1357);
			if (this.aClass100_1 != null) {
				this.aClass100_1.method2683();
			}
		} else {
	...
	@OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lclient!of;[I)V", line = 907)
	@Override
	public void method5722(@OriginalArg(0) Class2_Sub26 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass135_3.method3541(new Class2_Sub23(this.aClass19_Sub1_1, this, arg0, arg1));
	}

	@OriginalMember(owner = "client!ah", name = "a", descriptor = "(IILclient!kb;)Lclient!kb;", line = 976)
	@Override
	public Class2_Sub2_Sub4 method5731(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class2_Sub2_Sub4 arg2) {
		...
		if (local20 != null && local20.method1516(local17, local17)) {
			local30 = local20;
			local20.method1517();
		} else {
			local30 = new Class2_Sub2_Sub4_Sub1(this.aClass19_Sub1_1, local17, local17);
		}
		local30.method1513(local17, 0, local17, 0);
	...
	public void method5723(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		...
		this.aClass19_Sub1_1.method784();
		this.aClass19_Sub1_1.method848(null);
		aFloatArray1[0] = (float) 1024 / ((float) this.anInt182 * 128.0F * (float) this.aClass19_Sub1_1.anInt582);
		aFloatArray1[1] = 0.0F;
		aFloatArray1[2] = 0.0F;
		aFloatArray1[3] = 0.0F;
		aFloatArray1[4] = 0.0F;
		aFloatArray1[5] = (float) 1024 / ((float) this.anInt182 * 128.0F * (float) this.aClass19_Sub1_1.anInt587);
		aFloatArray1[6] = 0.0F;
		aFloatArray1[7] = 0.0F;
		aFloatArray1[8] = 0.0F;
		aFloatArray1[9] = 0.0F;
		aFloatArray1[10] = 0.0F;
		aFloatArray1[11] = 0.0F;
		aFloatArray1[12] = -1.0F - ((float) (arg0 * 1024) / 128.0F - (float) 0) / (float) this.aClass19_Sub1_1.anInt582;
		aFloatArray1[13] = 1.0F - ((float) 0 + (float) (arg3 * 1024) / 128.0F) / (float) this.aClass19_Sub1_1.anInt587;
		aFloatArray1[14] = 0.0F;
		aFloatArray1[15] = 1.0F;
		local7.glMatrixMode(5889);
		local7.glLoadMatrixf(aFloatArray1, 0);
		aFloatArray1[0] = 1.0F;
		aFloatArray1[1] = 0.0F;
		aFloatArray1[2] = 0.0F;
		aFloatArray1[3] = 0.0F;
		...
		aFloatArray1[10] = 0.0F;
		aFloatArray1[11] = 0.0F;
		aFloatArray1[12] = 0.0F;
		aFloatArray1[13] = 0.0F;
		aFloatArray1[14] = 0.0F;
		aFloatArray1[15] = 1.0F;
		...
		if (this.aClass19_Sub1_1.aBoolean53) {
			for (local294 = arg1; local294 < arg3; local294++) {
				local304 = local294 * this.anInt6308 + arg0;
					...
					if (arg4[local306 - arg0][local294 - arg1]) {
						...
						if (local324 != null) {
							for (local328 = 0; local328 < local324.length; local328++) {
								aClass2_Sub4_1.method4844(local324[local328] & 0xFFFF);
								local288++;
							}
						}
					}
			...
			for (local294 = arg1; local294 < arg3; local294++) {
				...
				for (local306 = arg0; local306 < arg2; local306++) {
					if (arg4[local306 - arg0][local294 - arg1]) {
						...
						if (local324 != null) {
							for (local328 = 0; local328 < local324.length; local328++) {
								aClass2_Sub4_1.method4846(local324[local328] & 0xFFFF);
								local288++;
							}
						}
					}
		...
		if (local288 > 0) {
			@Pc(418) Class180_Sub2 local418 = new Class180_Sub2(this.aClass19_Sub1_1, 5123, aClass2_Sub4_1.aByteArray73, aClass2_Sub4_1.anInt5289);
			this.aClass19_Sub1_1.method811(local418, 0, local288);
		}
	}

	@OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lclient!kb;IIIIZ)V", line = 1168)
	@Override
	public void method5725(@OriginalArg(0) Class2_Sub2_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (this.aClass100_1 != null && arg0 != null) {
			@Pc(19) int local19 = arg1 - (arg2 * this.aClass19_Sub1_1.anInt591 >> 8) >> this.aClass19_Sub1_1.anInt583;
			@Pc(33) int local33 = arg3 - (arg2 * this.aClass19_Sub1_1.anInt599 >> 8) >> this.aClass19_Sub1_1.anInt583;
			this.aClass100_1.method2689(local33, arg0, local19);
		}
	}
}
