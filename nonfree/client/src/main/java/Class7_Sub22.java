...
public final class Class7_Sub22 extends Class7 {
	...
	public Class7_Sub22(@OriginalArg(0) byte[] arg0) {
		this.method3321(arg0);
	}

	@OriginalMember(owner = "client!la", name = "a", descriptor = "([B)V")
	private void method3321(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class7_Sub3 local4 = new Class7_Sub3(arg0);
		this.anInt3677 = local4.method2767();
		this.anInt3679 = local4.method2767();
		this.anInt3680 = local4.method2767();
		this.anInt3681 = local4.method2767();
		if (this.anInt3681 < 0) {
			this.anInt3681 = ~this.anInt3681;
			this.aBoolean280 = true;
		}
		@Pc(40) int local40 = local4.method2767();
		this.aByteArrayArray10 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method2772();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method2793(local49, local64);
			this.aByteArrayArray10[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!la", name = "a", descriptor = "([I)Lclient!kf;")
	public Class7_Sub20_Sub1 method3327(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray54 == null) {
			this.anInt3682 = 0;
			this.aFloatArray18 = new float[Static181.anInt3675];
			this.aByteArray54 = new byte[this.anInt3679];
			this.anInt3686 = 0;
			this.anInt3685 = 0;
		}
		while (this.anInt3685 < this.aByteArrayArray10.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method3329(this.anInt3685);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt3686;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt3679 - local47) {
					local50 = this.anInt3679 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt3686;
				}
				this.anInt3686 = local47;
			}
			this.anInt3685++;
		}
		...
		return new Class7_Sub20_Sub1(this.anInt3677, local129, this.anInt3680, this.anInt3681, this.aBoolean280);
	}

	@OriginalMember(owner = "client!la", name = "e", descriptor = "(I)[F")
	private float[] method3329(@OriginalArg(0) int arg0) {
		Static181.method3322(this.aByteArrayArray10[arg0]);
		Static181.method3320();
		@Pc(15) int local15 = Static181.method3325(Static296.method5035(Static181.anIntArray500.length - 1));
		@Pc(19) boolean local19 = Static181.aBooleanArray19[local15];
		@Pc(25) int local25 = local19 ? Static181.anInt3675 : Static181.anInt3684;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static181.method3320() != 0;
			local29 = Static181.method3320() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static181.anInt3684 >> 2);
			local67 = (local25 >> 2) + (Static181.anInt3684 >> 2);
			local71 = Static181.anInt3684 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static181.anInt3684 >> 2);
			local104 = local25 + (Static181.anInt3684 >> 2) - (local25 >> 2);
			local108 = Static181.anInt3684 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class185 local123 = Static181.aClass185Array1[Static181.anIntArray500[local15]];
		@Pc(126) int local126 = local123.anInt5673;
		@Pc(131) int local131 = local123.anIntArray721[local126];
		@Pc(140) boolean local140 = !Static181.aClass105Array1[local131].method2726();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt5672; local144++) {
			@Pc(152) Class32 local152 = Static181.aClass32Array1[local123.anIntArray720[local144]];
			local154 = Static181.aFloatArray19;
			local152.method641(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt5673;
			local176 = local123.anIntArray721[local171];
			Static181.aClass105Array1[local176].method2721(Static181.aFloatArray19, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static181.aFloatArray19[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static181.aFloatArray19;
			...
			@Pc(252) float[] local252 = local19 ? Static181.aFloatArray21 : Static181.aFloatArray23;
			@Pc(258) float[] local258 = local19 ? Static181.aFloatArray22 : Static181.aFloatArray20;
			@Pc(264) float[] local264 = local19 ? Static181.aFloatArray24 : Static181.aFloatArray17;
			@Pc(270) int[] local270 = local19 ? Static181.anIntArray499 : Static181.anIntArray498;
			...
			@Pc(486) int local486 = Static296.method5035(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static181.aFloatArray19[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static181.aFloatArray19[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt3682 > 0) {
			local176 = this.anInt3682 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean279) {
				for (local212 = 0; local212 < this.anInt3678; local212++) {
					local1254 = (this.anInt3682 >> 1) + local212;
					local1228[local212] += this.aFloatArray18[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static181.aFloatArray19[local212];
				}
			}
		}
		local154 = this.aFloatArray18;
		this.aFloatArray18 = Static181.aFloatArray19;
		Static181.aFloatArray19 = local154;
		this.anInt3682 = local25;
		this.anInt3678 = local104 - (local25 >> 1);
		this.aBoolean279 = local140;
		return local1228;
	}
}
