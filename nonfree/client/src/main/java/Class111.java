...
public final class Class111 implements Interface1 {
	...
	private int anInt2988 = -1;

	@OriginalMember(owner = "client!mb", name = "<init>", descriptor = "()V")
	public Class111() {
		if (Static240.anInt4958 >= 2) {
			...
			@Pc(40) GL local40 = Static240.aGL1;
			...
			this.anInt2988 = local17[0];
			Static161.aBoolean225 = Static240.anInt4958 > 2 && Static240.aBoolean375;
			this.method2488();
		}
	}
	...
	private void method2488() {
		...
		this.anInt2987 = local1.glGenLists(2);
		local1.glNewList(this.anInt2987, 4864);
		local1.glActiveTexture(33985);
		if (Static161.aBoolean225) {
		...
		local1.glBindTexture(3552, this.anInt2988);
		...
		local1.glEndList();
		local1.glNewList(this.anInt2987 + 1, 4864);
		local1.glActiveTexture(33985);
		if (Static161.aBoolean225) {
	...
	public void method4327() {
		@Pc(1) GL local1 = Static240.aGL1;
		local1.glCallList(this.anInt2987);
	}
	...
	public void method4328() {
		@Pc(1) GL local1 = Static240.aGL1;
		local1.glCallList(this.anInt2987 + 1);
	}
	...
	public void method4329(@OriginalArg(0) int arg0) {
		@Pc(1) GL local1 = Static240.aGL1;
		local1.glActiveTexture(33985);
		if (Static161.aBoolean225 || arg0 >= 0) {
			local1.glPushMatrix();
			local1.glLoadIdentity();
			local1.glRotatef(180.0F, 1.0F, 0.0F, 0.0F);
			local1.glRotatef((float) Static147.anInt2715 * 360.0F / 2048.0F, 1.0F, 0.0F, 0.0F);
			local1.glRotatef((float) Static28.anInt602 * 360.0F / 2048.0F, 0.0F, 1.0F, 0.0F);
			local1.glTranslatef((float) -Static110.anInt2060, (float) -Static234.anInt4890, (float) -Static124.anInt2374);
			if (Static161.aBoolean225) {
				this.aFloatArray24[0] = 0.001F;
				this.aFloatArray24[1] = 9.0E-4F;
				...
				this.aFloatArray24[1] = 9.0E-4F;
				this.aFloatArray24[2] = 0.001F;
				this.aFloatArray24[3] = 0.0F;
				local1.glTexGenfv(8193, 9474, this.aFloatArray24, 0);
				this.aFloatArray24[0] = 0.0F;
				this.aFloatArray24[1] = 0.0F;
				this.aFloatArray24[2] = 0.0F;
				this.aFloatArray24[3] = (float) Static240.anInt4950 * 0.005F;
				local1.glTexGenfv(8194, 9474, this.aFloatArray24, 0);
				local1.glActiveTexture(33986);
			}
			local1.glTexEnvfv(8960, 8705, Static173.method2619(), 0);
			if (arg0 >= 0) {
				this.aFloatArray24[0] = 0.0F;
				this.aFloatArray24[1] = 1.0F / (float) Static93.anInt1771;
				this.aFloatArray24[2] = 0.0F;
				this.aFloatArray24[3] = (float) arg0 * 1.0F / (float) Static93.anInt1771;
				local1.glTexGenfv(8192, 9474, this.aFloatArray24, 0);
				local1.glEnable(3168);
			} else {
				local1.glDisable(3168);
