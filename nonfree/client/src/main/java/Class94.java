...
public final class Class94 implements Interface1 {

	@OriginalMember(owner = "client!kg", name = "b", descriptor = "I")
	private int anInt2630 = -1;

	@OriginalMember(owner = "client!kg", name = "a", descriptor = "I")
	private int anInt2629 = -1;
	...
	public Class94() {
		if (this.anInt2630 < 0 && (Static240.aBoolean373 && Static240.anInt4958 >= 2)) {
			@Pc(19) int[] local19 = new int[1];
			@Pc(21) GL local21 = Static240.aGL1;
			local21.glGenProgramsARB(1, local19, 0);
			this.anInt2631 = local19[0];
			@Pc(42) int[][] local42 = Static137.method3046(0.4F);
			@Pc(53) int[][] local53 = Static137.method3046(0.4F);
			@Pc(58) Class1_Sub18 local58 = new Class1_Sub18(262144);
			for (@Pc(60) int local60 = 0; local60 < 256; local60++) {
				...
				for (@Pc(73) int local73 = 0; local73 < 64; local73++) {
					if (Static240.aBoolean379) {
						local58.method3066((float) local67[local73] / 4096.0F);
						local58.method3066((float) local71[local73] / 4096.0F);
						local58.method3066(1.0F);
						local58.method3066(1.0F);
					} else {
						local58.method3088((float) local67[local73] / 4096.0F);
						local58.method3088((float) local71[local73] / 4096.0F);
						local58.method3088(1.0F);
						local58.method3088(1.0F);
					}
				}
			}
			@Pc(141) ByteBuffer local141 = ByteBuffer.allocateDirect(local58.anInt3911).order(ByteOrder.nativeOrder());
			local141.put(local58.aByteArray71, 0, local58.anInt3911);
			local141.flip();
	...
	public void method4329(@OriginalArg(0) int arg0) {
		...
		if ((arg0 & 0x80) == 0) {
			local5.glEnable(Static42.aBoolean83 ? 32879 : 3553);
		} else {
			local5.glDisable(Static42.aBoolean83 ? 32879 : 3553);
		}
		local5.glActiveTexture(33984);
		if ((arg0 & 0x40) == 0) {
			local5.glGetFloatv(2899, Static141.aFloatArray21, 0);
			local5.glProgramLocalParameter4fvARB(34336, 66, Static141.aFloatArray21, 0);
		} else {
	...
	public void method4327() {
		...
		@Pc(5) GL local5 = Static240.aGL1;
		local5.glCallList(this.anInt2630);
		local5.glActiveTexture(33985);
		local5.glMatrixMode(5890);
		local5.glTranslatef((float) Static110.anInt2060, (float) Static234.anInt4890, (float) Static124.anInt2374);
		...
		if (!Static42.aBoolean83) {
			local5.glBindTexture(3553, Static42.anIntArray125[(int) ((float) (Static240.anInt4950 * 64) * 0.005F) % 64]);
		}
		local5.glActiveTexture(33984);
		if (this.anInt2629 == Static240.anInt4950) {
			return;
		}
		@Pc(85) int local85 = (Static240.anInt4950 & 0xFF) * 256;
		...
		if (Static42.aBoolean83) {
			local5.glProgramLocalParameter4fARB(34336, 65, (float) Static240.anInt4950 * 0.005F, 0.0F, 0.0F, 1.0F);
		} else {
			local5.glProgramLocalParameter4fARB(34336, 65, 0.0F, 0.0F, 0.0F, 1.0F);
		}
		this.anInt2629 = Static240.anInt4950;
	}
	...
	public void method4328() {
		if (this.anInt2630 >= 0) {
			@Pc(5) GL local5 = Static240.aGL1;
			local5.glCallList(this.anInt2630 + 1);
		}
	}
	...
	private void method2210() {
		...
		local4.glBindProgramARB(34336, this.anInt2631);
	...
	private void method2211() {
		...
		this.anInt2630 = local1.glGenLists(2);
		local1.glNewList(this.anInt2630, 4864);
		...
		local1.glBindProgramARB(34336, this.anInt2631);
		local1.glEnable(34336);
		local1.glEndList();
		local1.glNewList(this.anInt2630 + 1, 4864);
		local1.glActiveTexture(33985);
		...
		local1.glDisable(Static42.aBoolean83 ? 32879 : 3553);
		local1.glActiveTexture(33984);
