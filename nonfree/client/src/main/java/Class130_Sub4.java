...
public final class Class130_Sub4 extends Class130 {
	...
	@OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(Lclient!j;Lclient!vi;[Lclient!dk;[I[I)V", line = 342)
	public Class130_Sub4(@OriginalArg(0) Class19_Sub2 arg0, @OriginalArg(1) Class239 arg1, @OriginalArg(2) Class48[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4) {
		...
		for (@Pc(29) int local29 = 0; local29 < arg2.length; local29++) {
			...
			this.anIntArray453[local29] = arg2[local29].anInt1528;
			this.anIntArray454[local29] = arg2[local29].anInt1533;
		}
	}
	...
	protected void method5893(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		...
		@Pc(27) int local27 = this.aClass19_Sub2_10.anInt2860;
		@Pc(33) int local33 = arg1 + arg2 * local27;
		@Pc(37) int local37 = local27 - local18;
		@Pc(39) int local39 = 0;
		@Pc(41) int local41 = 0;
		@Pc(52) int local52;
		if (arg2 < this.aClass19_Sub2_10.anInt2854) {
			local52 = this.aClass19_Sub2_10.anInt2854 - arg2;
			local23 -= local52;
			arg2 = this.aClass19_Sub2_10.anInt2854;
			local41 = local52 * local18;
			local33 += local52 * local27;
		}
		if (arg2 + local23 > this.aClass19_Sub2_10.anInt2856) {
			local23 -= arg2 + local23 - this.aClass19_Sub2_10.anInt2856;
		}
		if (arg1 < this.aClass19_Sub2_10.anInt2865) {
			local52 = this.aClass19_Sub2_10.anInt2865 - arg1;
			local18 -= local52;
			arg1 = this.aClass19_Sub2_10.anInt2865;
			local41 += local52;
			local33 += local52;
			local39 = local52;
			local37 += local52;
		}
		if (arg1 + local18 > this.aClass19_Sub2_10.anInt2851) {
			local52 = arg1 + local18 - this.aClass19_Sub2_10.anInt2851;
			local18 -= local52;
			local39 += local52;
			local37 += local52;
		}
		...
		if ((arg3 & -16777216) == -16777216) {
			this.method5909(this.aByteArrayArray21[arg0], this.aClass19_Sub2_10.anIntArray179, arg3, local41, local33, local18, local23, local37, local39);
		} else if ((arg3 & 0xFF000000) != 0) {
			this.method5907(this.aByteArrayArray21[arg0], this.aClass19_Sub2_10.anIntArray179, arg3, local41, local33, local18, local23, local37, local39);
		}
	}

	@OriginalMember(owner = "client!uj", name = "a", descriptor = "([B[IIIIIIII)V", line = 68)
	private void method5907(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
	...
	@OriginalMember(owner = "client!uj", name = "a", descriptor = "([B[IIIIIIIIIIILclient!kf;II)V", line = 103)
	private void method5908(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) Class78 arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14) {
		...
		if (arg14 > arg10) {
			local10 = arg14;
			arg4 += (arg14 - arg10) * this.aClass19_Sub2_10.anInt2860;
	...
	private void method5909(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
	...
	@OriginalMember(owner = "client!uj", name = "b", descriptor = "([B[IIIIIIIIIIILclient!kf;II)V", line = 245)
	private void method5910(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) Class78 arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14) {
		@Pc(2) Class78_Sub1 local2 = (Class78_Sub1) arg12;
		@Pc(5) int[] local5 = local2.anIntArray139;
		@Pc(8) int[] local8 = local2.anIntArray140;
		@Pc(14) int local14 = arg9 - this.aClass19_Sub2_10.anInt2865;
	...
	@OriginalMember(owner = "client!uj", name = "a", descriptor = "(CIIIZLclient!kf;II)V", line = 364)
	@Override
	protected void method5903(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class78 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		@Pc(37) int local37 = this.aClass19_Sub2_10.anInt2860;
		...
		@Pc(62) int local62;
		if (arg2 < this.aClass19_Sub2_10.anInt2854) {
			local62 = this.aClass19_Sub2_10.anInt2854 - arg2;
			local33 -= local62;
			arg2 = this.aClass19_Sub2_10.anInt2854;
			local51 = local62 * local28;
			local43 += local62 * local37;
		}
		if (arg2 + local33 > this.aClass19_Sub2_10.anInt2856) {
			local33 -= arg2 + local33 - this.aClass19_Sub2_10.anInt2856;
		}
		if (arg1 < this.aClass19_Sub2_10.anInt2865) {
			local62 = this.aClass19_Sub2_10.anInt2865 - arg1;
			local28 -= local62;
			arg1 = this.aClass19_Sub2_10.anInt2865;
			local51 += local62;
			local43 += local62;
		...
		if (arg1 + local28 > this.aClass19_Sub2_10.anInt2851) {
			local62 = arg1 + local28 - this.aClass19_Sub2_10.anInt2851;
			local28 -= local62;
			local49 += local62;
			local47 += local62;
		}
		...
		if ((arg3 & -16777216) == -16777216) {
			this.method5908(this.aByteArrayArray21[arg0], this.aClass19_Sub2_10.anIntArray179, arg3, local51, local43, local28, local33, local47, local49, arg1, arg2, this.anIntArray452[arg0], arg5, arg6, arg7);
		} else {
			this.method5910(this.aByteArrayArray21[arg0], this.aClass19_Sub2_10.anIntArray179, arg3, local51, local43, local28, local33, local47, local49, arg1, arg2, this.anIntArray452[arg0], arg5, arg6, arg7);
		}
	}
}
