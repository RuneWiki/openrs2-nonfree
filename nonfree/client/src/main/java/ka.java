...
public final class ka extends Class71 implements Interface2 {

	@OriginalMember(owner = "client!ka", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ka", name = "<init>", descriptor = "(Lclient!qa;Lclient!na;Lclient!lm;[Lclient!di;[Lclient!l;)V")
	public ka(@OriginalArg(0) qa arg0, @OriginalArg(1) na arg1, @OriginalArg(2) Class151 arg2, @OriginalArg(3) Class51[] arg3, @OriginalArg(4) Class143[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray42;
			local11[local25] = arg3[local25].anInt1635;
			local15[local25] = arg3[local25].anInt1638;
			local19[local25] = arg3[local25].anInt1636;
			local23[local25] = arg3[local25].anInt1639;
		}
		this.ta(arg0, arg1, local7, arg3[0].anIntArray123, local11, local15, local19, local23);
	}
	...
	private native void ya(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class133 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
