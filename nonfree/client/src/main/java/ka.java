...
public final class ka extends Class63 implements Interface3 {

	@OriginalMember(owner = "client!ka", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ka", name = "<init>", descriptor = "(Lclient!qa;Lclient!na;Lclient!du;[Lclient!ul;[Lclient!l;)V")
	public ka(@OriginalArg(0) qa arg0, @OriginalArg(1) na arg1, @OriginalArg(2) Class57 arg2, @OriginalArg(3) Class246[] arg3, @OriginalArg(4) Class11[] arg4) {
		super(arg0, arg2);
		...
		this.ta(arg0, arg1, local7, arg3[0].anIntArray578, local11, local15, local19, local23);
	}
	...
	private native void ya(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class119 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
