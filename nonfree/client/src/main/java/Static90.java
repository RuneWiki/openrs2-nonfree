...
public final class Static90 {
	...
	private static JagString aClass22_692 = Static60.method1113("Connection timed out)3");

	@OriginalMember(owner = "client!pe", name = "h", descriptor = "Lclient!ec;")
	public static JagString aClass22_689 = aClass22_692;

	@OriginalMember(owner = "client!pe", name = "m", descriptor = "Lclient!ec;")
	private static JagString aClass22_690 = Static60.method1113("Loaded input handler");

	@OriginalMember(owner = "client!pe", name = "o", descriptor = "Lclient!ec;")
	public static JagString aClass22_691 = Static60.method1113(": ");

	@OriginalMember(owner = "client!pe", name = "q", descriptor = "Lclient!ec;")
	private static JagString aClass22_693 = Static60.method1113("Unexpected server response");

	@OriginalMember(owner = "client!pe", name = "r", descriptor = "I")
	public static final int anInt2394 = 3353893;

	@OriginalMember(owner = "client!pe", name = "s", descriptor = "Lclient!ec;")
	public static JagString aClass22_694 = Static60.method1113("welle:");

	@OriginalMember(owner = "client!pe", name = "t", descriptor = "Lclient!ec;")
	public static JagString aClass22_695 = aClass22_690;

	@OriginalMember(owner = "client!pe", name = "u", descriptor = "I")
	public static int anInt2395 = 0;

	@OriginalMember(owner = "client!pe", name = "v", descriptor = "Lclient!ec;")
	public static JagString aClass22_696 = aClass22_693;

	@OriginalMember(owner = "client!pe", name = "w", descriptor = "Lclient!wc;")
	public static HashTable aClass81_11 = new HashTable(8);

	@OriginalMember(owner = "client!pe", name = "y", descriptor = "Lclient!ec;")
	public static JagString aClass22_697 = Static60.method1113("W-=hlen Sie eine Option");

	@OriginalMember(owner = "client!pe", name = "z", descriptor = "Lclient!ec;")
	public static JagString aClass22_698 = Static60.method1113("Unerwartete Antwort vom Anmelde)2Server");

	@OriginalMember(owner = "client!pe", name = "A", descriptor = "[Lclient!ec;")
	public static JagString[] aClass22Array18 = new JagString[500];
	...
	public static void method1577(@OriginalArg(0) World3D arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) CollisionMap arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		@Pc(54) LocType local54 = Static5.method45(arg3);
		@Pc(76) int local76;
		@Pc(79) int local79;
		if (arg4 == 1 || arg4 == 3) {
		...
		if (arg2 != 22) {
			...
			if (arg2 == 10 || arg2 == 11) {
				if (local54.anInt1259 == -1 && local54.anIntArray137 == null) {
					...
					local277 = new LocEntity(arg3, 10, arg4, arg6, arg7, arg1, local54.anInt1259, true, null);
				}
				if (local277 != null && arg0.method1955(arg6, arg7, arg1, local211, local76, local79, local277, arg2 == 11 ? 256 : 0, local175, local217) && local54.aBoolean120) {
					local380 = 15;
					if (local277 instanceof SoftwareModel) {
						local380 = ((SoftwareModel) local277).method1486() / 4;
						if (local380 > 30) {
							local380 = 30;
						}
					}
				...
				if (local54.anInt1259 == -1 && local54.anIntArray137 == null) {
					...
					local277 = new LocEntity(arg3, arg2, arg4, arg6, arg7, arg1, local54.anInt1259, true, null);
				}
				...
				if (local54.anInt1259 == -1 && local54.anIntArray137 == null) {
					...
					local277 = new LocEntity(arg3, 0, arg4, arg6, arg7, arg1, local54.anInt1259, true, null);
				}
				...
				if (local54.anInt1259 == -1 && local54.anIntArray137 == null) {
					...
					local277 = new LocEntity(arg3, 1, arg4, arg6, arg7, arg1, local54.anInt1259, true, null);
				}
				...
				@Pc(981) int local981;
				@Pc(1019) Entity local1019;
				if (arg2 == 2) {
					local981 = arg4 + 1 & 0x3;
					@Pc(1005) Entity local1005;
					if (local54.anInt1259 == -1 && local54.anIntArray137 == null) {
						...
						local1005 = new LocEntity(arg3, 2, arg4 + 4, arg6, arg7, arg1, local54.anInt1259, true, null);
						local1019 = new LocEntity(arg3, 2, local981, arg6, arg7, arg1, local54.anInt1259, true, null);
					}
					...
					if (local54.anInt1259 == -1 && local54.anIntArray137 == null) {
						...
						local277 = new LocEntity(arg3, 3, arg4, arg6, arg7, arg1, local54.anInt1259, true, null);
					}
					arg0.method1921(arg6, arg7, arg1, local211, local277, null, Static101.anIntArray291[arg4], 0, local175, local217);
					if (local54.aBoolean120) {
						if (arg4 == 0) {
					...
					if (local54.anInt1259 == -1 && local54.anIntArray137 == null) {
						...
						local277 = new LocEntity(arg3, 4, arg4, arg6, arg7, arg1, local54.anInt1259, true, null);
					}
					...
					if (local54.anInt1259 == -1 && local54.anIntArray137 == null) {
						...
						local1019 = new LocEntity(arg3, 4, arg4, arg6, arg7, arg1, local54.anInt1259, true, null);
					}
					...
					if (local54.anInt1259 == -1 && local54.anIntArray137 == null) {
						...
						local1019 = new LocEntity(arg3, 4, arg4 + 4, arg6, arg7, arg1, local54.anInt1259, true, null);
					}
					...
					if (local54.anInt1259 == -1 && local54.anIntArray137 == null) {
						...
						local277 = new LocEntity(arg3, 4, local380 + 4, arg6, arg7, arg1, local54.anInt1259, true, null);
					}
					...
					@Pc(1814) Entity local1814;
					if (local54.anInt1259 == -1 && local54.anIntArray137 == null) {
						local1019 = local54.method884(local163, local211, arg4 + 4, local147, local155, 4);
						local1814 = local54.method884(local163, local211, local1783 + 4, local147, local155, 4);
					} else {
						local1019 = new LocEntity(arg3, 4, arg4 + 4, arg6, arg7, arg1, local54.anInt1259, true, null);
						local1814 = new LocEntity(arg3, 4, local1783 + 4, arg6, arg7, arg1, local54.anInt1259, true, null);
					}
			...
			if (local54.anInt1259 == -1 && local54.anIntArray137 == null) {
				...
				local277 = new LocEntity(arg3, 22, arg4, arg6, arg7, arg1, local54.anInt1259, true, null);
			}
