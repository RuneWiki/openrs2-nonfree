...
public final class Static144 {
	...
	private static int anInt3247;

	@OriginalMember(owner = "client!fj", name = "c", descriptor = "I")
	private static int anInt3248;

	@OriginalMember(owner = "client!fj", name = "d", descriptor = "I")
	private static int anInt3249;

	@OriginalMember(owner = "client!fj", name = "e", descriptor = "I")
	private static int anInt3250;

	@OriginalMember(owner = "client!fj", name = "f", descriptor = "I")
	private static int anInt3251;

	@OriginalMember(owner = "client!fj", name = "g", descriptor = "[I")
	private static int[] anIntArray303;

	@OriginalMember(owner = "client!fj", name = "h", descriptor = "I")
	private static int anInt3252;

	@OriginalMember(owner = "client!fj", name = "a", descriptor = "(I)Z")
	private static boolean method2978(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = anInt3249;
		@Pc(3) int local3 = anInt3246;
		@Pc(5) int local5 = anInt3251;
		while (local3 >= local1) {
			local5++;
			anInt3251 = local5;
			if (local5 >= arg0) {
			...
			@Pc(16) int local16 = anInt3250;
			@Pc(23) int local23;
			@Pc(30) int local30;
			while (local1 < anInt3248) {
			...
			if (local16 == anInt3248) {
				anInt3248 = 0;
				return false;
			}
			method2986(local16, local1);
			anInt3250 = local16;
			anInt3249 = local1;
			local3 = local16;
		}
		anInt3252 = anIntArray303[local3] >> 16;
		anInt3247 = anIntArray303[local3 + 4] >> 16;
	...
	@OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lclient!oa;[II[I[I)V")
	public static void method2979(@OriginalArg(0) Class66 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4) {
		method2980(arg0, arg1, arg1.length, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lclient!oa;[IIII[I[I)V")
	private static void method2980(@OriginalArg(0) Class66 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int[] arg4, @OriginalArg(6) int[] arg5) {
	...
	private static void method2981(@OriginalArg(0) int arg0) {
		if (anInt3248 < 0) {
			anInt3246 = 0;
			anInt3249 = 0;
			anInt3250 = 0;
			anInt3251 = 2147483646;
			return;
		}
		method2984(0, anInt3248);
		@Pc(17) int local17 = anIntArray303[1];
		if (local17 < arg0) {
			local17 = arg0;
		}
		@Pc(26) int local26;
		for (local26 = 0; local26 < anInt3248; local26 += 4) {
	...
	private static void method2982(@OriginalArg(0) int[] arg0, @OriginalArg(2) int arg1) {
		@Pc(5) int local5 = anInt3248 + (arg1 << 1);
		@Pc(16) int local16;
		if (anIntArray303 == null || anIntArray303.length < local5) {
			@Pc(14) int[] local14 = new int[local5];
			for (local16 = 0; local16 < anInt3248; local16++) {
		...
		for (local16 = 0; local16 < local33; local16 += 2) {
			...
			if (local46 < local52) {
				anIntArray303[anInt3248++] = arg0[local37];
				anIntArray303[anInt3248++] = local46;
				anIntArray303[anInt3248++] = arg0[local16];
				anIntArray303[anInt3248++] = local52;
	...
	@OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lclient!oa;[II)V")
	public static void method2983(@OriginalArg(0) Class66 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2) {
		method2980(arg0, arg1, arg1.length, arg2, null, null);
	}

	@OriginalMember(owner = "client!fj", name = "a", descriptor = "(II)V")
	private static void method2984(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg1 <= arg0 + 4) {
			return;
		}
		...
		method2984(arg0, local7);
		method2984(local7 + 4, arg1);
	}

	@OriginalMember(owner = "client!fj", name = "b", descriptor = "()V")
	private static void method2985() {
		anInt3248 = 0;
	}

	@OriginalMember(owner = "client!fj", name = "b", descriptor = "(II)V")
	private static void method2986(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		while (true) {
			if (arg1 >= arg0 + 8) {
