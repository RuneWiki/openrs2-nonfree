...
public final class Class4_Sub1_Sub14 extends DoublyLinkable {
	...
	public void method1786(@OriginalArg(1) Packet arg0) {
		while (true) {
	...
	private void method1788(@OriginalArg(1) int arg0, @OriginalArg(2) Packet arg1) {
		if (arg0 == 1) {
	...
	public SoftwareModel method1790(@OriginalArg(1) int arg0) {
		@Pc(21) SoftwareModel local21 = (SoftwareModel) Static41.aClass33_17.method998((long) this.anInt2761);
		if (local21 == null) {
			@Pc(29) Model local29 = Static86.method1524(Static133.aClass20_62, this.anInt2752);
			if (local29 == null) {
				return null;
			}
			@Pc(38) int local38;
