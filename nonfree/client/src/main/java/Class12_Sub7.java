...
public final class Class12_Sub7 extends Class12 {
	...
	@OriginalMember(owner = "client!dka", name = "<init>", descriptor = "(ILclient!sf;)V")
	public Class12_Sub7(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub50 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!dka", name = "<init>", descriptor = "(Lclient!sf;)V")
	public Class12_Sub7(@OriginalArg(0) Class5_Sub50 arg0) {
		super(arg0);
	}
	...
	public void method8472() {
		if (super.anInt10229 < 0 && super.anInt10229 > 127) {
