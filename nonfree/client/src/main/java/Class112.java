...
public final class Class112 {
	...
	private final boolean aBoolean292 = false;
	...
	public final int[] anIntArray218 = new int[4096];
	...
	@OriginalMember(owner = "client!gba", name = "I", descriptor = "I")
	private final int anInt4088 = -1;

	@OriginalMember(owner = "client!gba", name = "e", descriptor = "Lclient!lr;")
	private final Class16_Sub2 aClass16_Sub2_4;

	@OriginalMember(owner = "client!gba", name = "k", descriptor = "Lclient!ij;")
	...
	@OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(Lclient!lr;Lclient!ij;)V")
	public Class112(@OriginalArg(0) Class16_Sub2 arg0, @OriginalArg(1) Class146 arg1) {
		this.aClass16_Sub2_4 = arg0;
		this.aClass146_1 = arg1;
		this.anInt4075 = this.aClass16_Sub2_4.anInt6490;
		this.anIntArray217 = this.aClass16_Sub2_4.anIntArray367;
		this.aFloatArray40 = this.aClass16_Sub2_4.aFloatArray58;
	}

	@OriginalMember(owner = "client!gba", name = "a", descriptor = "(FFFFFFFFFFFF)V")
	public void method3312(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) float arg9, @OriginalArg(10) float arg10, @OriginalArg(11) float arg11) {
		if (this.aBoolean295) {
			this.aClass16_Sub2_4.method6105((int) arg3, (int) arg1, (int) arg0, Static491.anIntArray491[(int) arg9], (int) arg4);
			this.aClass16_Sub2_4.method6105((int) arg4, (int) arg2, (int) arg1, Static491.anIntArray491[(int) arg9], (int) arg5);
			this.aClass16_Sub2_4.method6105((int) arg5, (int) arg0, (int) arg2, Static491.anIntArray491[(int) arg9], (int) arg3);
			return;
		}
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (!(arg0 >= (float) this.anInt4076)) {
				if (arg1 > (float) this.anInt4076) {
					arg1 = this.anInt4076;
				}
				if (arg2 > (float) this.anInt4076) {
					arg2 = this.anInt4076;
				}
				...
				if (arg1 < arg2) {
					...
					if ((arg0 == arg1 || !(local117 < local106)) && (arg0 != arg1 || !(local117 > local95))) {
						arg2 -= arg1;
						arg1 -= arg0;
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method3323(this.anIntArray217, this.aFloatArray40, (int) arg0, (int) arg3, (int) arg5, arg9, local143, arg6, local163);
							arg5 += local117;
							arg3 += local106;
							arg9 += local153;
							arg6 += local173;
						...
						while (--arg2 >= 0.0F) {
							this.method3323(this.anIntArray217, this.aFloatArray40, (int) arg0, (int) arg4, (int) arg5, arg9, local143, arg6, local163);
							arg5 += local117;
							arg4 += local95;
							arg9 += local153;
							arg6 += local173;
						...
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method3323(this.anIntArray217, this.aFloatArray40, (int) arg0, (int) arg5, (int) arg3, arg9, local143, arg6, local163);
							arg5 += local117;
							arg3 += local106;
							arg9 += local153;
							arg6 += local173;
						...
						while (--arg2 >= 0.0F) {
							this.method3323(this.anIntArray217, this.aFloatArray40, (int) arg0, (int) arg5, (int) arg4, arg9, local143, arg6, local163);
							arg5 += local117;
							arg4 += local95;
							arg9 += local153;
							arg6 += local173;
					...
					if (arg0 != arg2 && local117 < local106 || arg0 == arg2 && local95 > local106) {
						...
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method3323(this.anIntArray217, this.aFloatArray40, (int) arg0, (int) arg4, (int) arg3, arg9, local143, arg6, local163);
							arg4 += local117;
							arg3 += local106;
							arg9 += local153;
							arg6 += local173;
						...
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method3323(this.anIntArray217, this.aFloatArray40, (int) arg0, (int) arg3, (int) arg4, arg9, local143, arg6, local163);
							arg4 += local117;
							arg3 += local106;
							arg9 += local153;
							arg6 += local173;
			...
			if (!(arg1 >= (float) this.anInt4076)) {
				...
				if (arg2 < arg0) {
					...
					if ((arg1 == arg2 || !(local106 < local95)) && (arg1 != arg2 || !(local106 > local117))) {
						arg0 -= arg2;
						arg2 -= arg1;
						arg1 = this.anIntArray218[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method3323(this.anIntArray217, this.aFloatArray40, (int) arg1, (int) arg4, (int) arg3, arg10, local143, arg7, local163);
							arg3 += local106;
							arg4 += local95;
							arg10 += local153;
							arg7 += local173;
						...
						while (--arg0 >= 0.0F) {
							this.method3323(this.anIntArray217, this.aFloatArray40, (int) arg1, (int) arg5, (int) arg3, arg10, local143, arg7, local163);
							arg3 += local106;
							arg5 += local117;
							arg10 += local153;
							arg7 += local173;
						...
						arg1 = this.anIntArray218[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method3323(this.anIntArray217, this.aFloatArray40, (int) arg1, (int) arg3, (int) arg4, arg10, local143, arg7, local163);
							arg3 += local106;
							arg4 += local95;
							arg10 += local153;
							arg7 += local173;
						...
						while (--arg0 >= 0.0F) {
							this.method3323(this.anIntArray217, this.aFloatArray40, (int) arg1, (int) arg3, (int) arg5, arg10, local143, arg7, local163);
							arg3 += local106;
							arg5 += local117;
							arg10 += local153;
							arg7 += local173;
					...
					if (local106 < local95) {
						...
						arg1 = this.anIntArray218[(int) arg1];
						while (--arg0 >= 0.0F) {
							this.method3323(this.anIntArray217, this.aFloatArray40, (int) arg1, (int) arg5, (int) arg4, arg10, local143, arg7, local163);
							arg5 += local106;
							arg4 += local95;
							arg10 += local153;
							arg7 += local173;
						...
						arg1 = this.anIntArray218[(int) arg1];
						while (--arg0 >= 0.0F) {
							this.method3323(this.anIntArray217, this.aFloatArray40, (int) arg1, (int) arg4, (int) arg5, arg10, local143, arg7, local163);
							arg5 += local106;
							arg4 += local95;
							arg10 += local153;
							arg7 += local173;
		...
		} else if (!(arg2 >= (float) this.anInt4076)) {
			if (arg0 > (float) this.anInt4076) {
				arg0 = this.anInt4076;
			}
			if (arg1 > (float) this.anInt4076) {
			...
			if (arg0 < arg1) {
				...
				if (local95 < local117) {
					arg1 -= arg0;
					arg0 -= arg2;
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method3323(this.anIntArray217, this.aFloatArray40, (int) arg2, (int) arg4, (int) arg5, arg11, local143, arg8, local163);
						arg4 += local95;
						arg5 += local117;
						arg11 += local153;
						arg8 += local173;
					...
					while (--arg1 >= 0.0F) {
						this.method3323(this.anIntArray217, this.aFloatArray40, (int) arg2, (int) arg4, (int) arg3, arg11, local143, arg8, local163);
						arg4 += local95;
						arg3 += local106;
						arg11 += local153;
						arg8 += local173;
					...
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method3323(this.anIntArray217, this.aFloatArray40, (int) arg2, (int) arg5, (int) arg4, arg11, local143, arg8, local163);
						arg4 += local95;
						arg5 += local117;
						arg11 += local153;
						arg8 += local173;
					...
					while (--arg1 >= 0.0F) {
						this.method3323(this.anIntArray217, this.aFloatArray40, (int) arg2, (int) arg3, (int) arg4, arg11, local143, arg8, local163);
						arg4 += local95;
						arg3 += local106;
						arg11 += local153;
						arg8 += local173;
				...
				if (local95 < local117) {
					...
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method3323(this.anIntArray217, this.aFloatArray40, (int) arg2, (int) arg3, (int) arg5, arg11, local143, arg8, local163);
						arg3 += local95;
						arg5 += local117;
						arg11 += local153;
						arg8 += local173;
					...
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method3323(this.anIntArray217, this.aFloatArray40, (int) arg2, (int) arg5, (int) arg3, arg11, local143, arg8, local163);
						arg3 += local95;
						arg5 += local117;
						arg11 += local153;
						arg8 += local173;
	...
	public void method3314(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) int arg9) {
		if (this.aBoolean295) {
			this.aClass16_Sub2_4.method6105((int) arg3, (int) arg1, (int) arg0, arg9, (int) arg4);
			this.aClass16_Sub2_4.method6105((int) arg4, (int) arg2, (int) arg1, arg9, (int) arg5);
			this.aClass16_Sub2_4.method6105((int) arg5, (int) arg0, (int) arg2, arg9, (int) arg3);
			return;
		}
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (!(arg0 >= (float) this.anInt4076)) {
				...
				if (arg1 < arg2) {
					...
					if (arg0 != arg1 && local96 < local68 || arg0 == arg1 && local96 > local82) {
						...
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method3319(this.anIntArray217, this.aFloatArray40, (int) arg0, arg9, (int) arg5, (int) arg3, arg6, local131);
							arg5 += local96;
							arg3 += local68;
							arg6 += local141;
							arg0 += this.anInt4075;
						...
						while (--arg2 >= 0.0F) {
							this.method3319(this.anIntArray217, this.aFloatArray40, (int) arg0, arg9, (int) arg5, (int) arg4, arg6, local131);
							arg5 += local96;
							arg4 += local82;
							arg6 += local141;
							arg0 += this.anInt4075;
						...
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method3319(this.anIntArray217, this.aFloatArray40, (int) arg0, arg9, (int) arg3, (int) arg5, arg6, local131);
							arg5 += local96;
							arg3 += local68;
							arg6 += local141;
							arg0 += this.anInt4075;
						...
						while (--arg2 >= 0.0F) {
							this.method3319(this.anIntArray217, this.aFloatArray40, (int) arg0, arg9, (int) arg4, (int) arg5, arg6, local131);
							arg5 += local96;
							arg4 += local82;
							arg6 += local141;
							arg0 += this.anInt4075;
					...
					if ((arg0 == arg2 || !(local96 < local68)) && (arg0 != arg2 || !(local82 > local68))) {
						...
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method3319(this.anIntArray217, this.aFloatArray40, (int) arg0, arg9, (int) arg3, (int) arg4, arg6, local131);
							arg4 += local96;
							arg3 += local68;
							arg6 += local141;
							arg0 += this.anInt4075;
						...
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method3319(this.anIntArray217, this.aFloatArray40, (int) arg0, arg9, (int) arg4, (int) arg3, arg6, local131);
							arg4 += local96;
							arg3 += local68;
							arg6 += local141;
							arg0 += this.anInt4075;
			...
			if (!(arg1 >= (float) this.anInt4076)) {
				...
				if (arg2 < arg0) {
					...
					if (arg1 != arg2 && local68 < local82 || arg1 == arg2 && local68 > local96) {
						...
						arg1 = this.anIntArray218[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method3319(this.anIntArray217, this.aFloatArray40, (int) arg1, arg9, (int) arg3, (int) arg4, arg7, local131);
							arg3 += local68;
							arg4 += local82;
							arg7 += local141;
							arg1 += this.anInt4075;
						...
						while (--arg0 >= 0.0F) {
							this.method3319(this.anIntArray217, this.aFloatArray40, (int) arg1, arg9, (int) arg3, (int) arg5, arg7, local131);
							arg3 += local68;
							arg5 += local96;
							arg7 += local141;
							arg1 += this.anInt4075;
						...
						arg1 = this.anIntArray218[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method3319(this.anIntArray217, this.aFloatArray40, (int) arg1, arg9, (int) arg4, (int) arg3, arg7, local131);
							arg3 += local68;
							arg4 += local82;
							arg7 += local141;
							arg1 += this.anInt4075;
						...
						while (--arg0 >= 0.0F) {
							this.method3319(this.anIntArray217, this.aFloatArray40, (int) arg1, arg9, (int) arg5, (int) arg3, arg7, local131);
							arg3 += local68;
							arg5 += local96;
							arg7 += local141;
							arg1 += this.anInt4075;
					...
					if (local68 < local82) {
						...
						arg1 = this.anIntArray218[(int) arg1];
						while (--arg0 >= 0.0F) {
							this.method3319(this.anIntArray217, this.aFloatArray40, (int) arg1, arg9, (int) arg5, (int) arg4, arg7, local131);
							arg5 += local68;
							arg4 += local82;
							arg7 += local141;
							arg1 += this.anInt4075;
						...
						arg1 = this.anIntArray218[(int) arg1];
						while (--arg0 >= 0.0F) {
							this.method3319(this.anIntArray217, this.aFloatArray40, (int) arg1, arg9, (int) arg4, (int) arg5, arg7, local131);
							arg5 += local68;
							arg4 += local82;
							arg7 += local141;
							arg1 += this.anInt4075;
			...
			if (arg0 < arg1) {
				...
				if (local82 < local96) {
					...
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method3319(this.anIntArray217, this.aFloatArray40, (int) arg2, arg9, (int) arg4, (int) arg5, arg8, local131);
						arg4 += local82;
						arg5 += local96;
						arg8 += local141;
						arg2 += this.anInt4075;
					...
					while (--arg1 >= 0.0F) {
						this.method3319(this.anIntArray217, this.aFloatArray40, (int) arg2, arg9, (int) arg4, (int) arg3, arg8, local131);
						arg4 += local82;
						arg3 += local68;
						arg8 += local141;
						arg2 += this.anInt4075;
					...
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method3319(this.anIntArray217, this.aFloatArray40, (int) arg2, arg9, (int) arg5, (int) arg4, arg8, local131);
						arg4 += local82;
						arg5 += local96;
						arg8 += local141;
						arg2 += this.anInt4075;
					...
					while (--arg1 >= 0.0F) {
						this.method3319(this.anIntArray217, this.aFloatArray40, (int) arg2, arg9, (int) arg3, (int) arg4, arg8, local131);
						arg4 += local82;
						arg3 += local68;
						arg8 += local141;
						arg2 += this.anInt4075;
				...
				if (local82 < local96) {
					...
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method3319(this.anIntArray217, this.aFloatArray40, (int) arg2, arg9, (int) arg3, (int) arg5, arg8, local131);
						arg3 += local82;
						arg5 += local96;
						arg8 += local141;
						arg2 += this.anInt4075;
					...
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method3319(this.anIntArray217, this.aFloatArray40, (int) arg2, arg9, (int) arg5, (int) arg3, arg8, local131);
						arg3 += local82;
						arg5 += local96;
						arg8 += local141;
						arg2 += this.anInt4075;
	...
	public void method3315(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) float arg9, @OriginalArg(10) float arg10, @OriginalArg(11) float arg11, @OriginalArg(12) float arg12, @OriginalArg(13) float arg13, @OriginalArg(14) float arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18, @OriginalArg(19) int arg19, @OriginalArg(20) int arg20, @OriginalArg(21) int arg21, @OriginalArg(22) int arg22, @OriginalArg(23) float arg23, @OriginalArg(24) int arg24, @OriginalArg(25) float arg25, @OriginalArg(26) int arg26, @OriginalArg(27) float arg27) {
		if (arg22 != this.anInt4088) {
			this.anIntArray219 = this.aClass16_Sub2_4.method5329(arg22);
			if (this.anIntArray219 == null) {
				this.method3321((float) arg0, (float) arg1, (float) arg2, (float) arg3, (float) arg4, (float) arg5, (float) arg6, (float) arg7, (float) arg8, Static268.method4645(arg18 | arg19 << 24, arg15), Static268.method4645(arg18 | arg20 << 24, arg16), Static268.method4645(arg18 | arg21 << 24, arg17));
				return;
			}
			this.anInt4085 = this.aClass16_Sub2_4.method5331(arg22) ? 64 : this.aClass16_Sub2_4.anInt6469;
			this.anInt4079 = this.anInt4085 - 1;
			this.anInt4087 = this.aClass16_Sub2_4.method5320(arg22);
		}
		this.aFloat79 = arg23;
		if (arg24 != this.anInt4084) {
			this.anIntArray220 = this.aClass16_Sub2_4.method5329(arg24);
			if (this.anIntArray220 == null) {
				this.method3321((float) arg0, (float) arg1, (float) arg2, (float) arg3, (float) arg4, (float) arg5, (float) arg6, (float) arg7, (float) arg8, Static268.method4645(arg18 | arg19 << 24, arg15), Static268.method4645(arg18 | arg20 << 24, arg16), Static268.method4645(arg18 | arg21 << 24, arg17));
				return;
			}
			this.anInt4083 = this.aClass16_Sub2_4.method5331(arg24) ? 64 : this.aClass16_Sub2_4.anInt6469;
			this.anInt4078 = this.anInt4083 - 1;
		}
		this.aFloat77 = arg25;
		if (arg26 != this.anInt4086) {
			this.anIntArray221 = this.aClass16_Sub2_4.method5329(arg26);
			if (this.anIntArray221 == null) {
				this.method3321((float) arg0, (float) arg1, (float) arg2, (float) arg3, (float) arg4, (float) arg5, (float) arg6, (float) arg7, (float) arg8, Static268.method4645(arg18 | arg19 << 24, arg15), Static268.method4645(arg18 | arg20 << 24, arg16), Static268.method4645(arg18 | arg21 << 24, arg17));
				return;
			}
			this.anInt4081 = this.aClass16_Sub2_4.method5331(arg26) ? 64 : this.aClass16_Sub2_4.anInt6469;
			this.anInt4082 = this.anInt4081 - 1;
		}
		this.aFloat78 = arg27;
		this.anInt4080 = arg18;
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (!(arg0 >= (float) this.anInt4076)) {
				...
				if (arg1 < arg2) {
					...
					if (arg0 != arg1 && local525 < local400 || arg0 == arg1 && local525 > local428) {
						...
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method3317(this.anIntArray217, this.anIntArray219, (int) arg0, (int) arg5, (int) arg3, arg8, arg6, arg11, arg9, arg14, arg12, (float) arg21, (float) arg19, local293, local279, local314, local300, local335, local321, local350, local340, local392, local388, local398, local394);
							arg3 += local400;
							arg5 += local525;
							arg6 += local402;
							arg8 += local596;
						...
						while (--arg2 >= 0.0F) {
							this.method3317(this.anIntArray217, this.anIntArray219, (int) arg0, (int) arg5, (int) arg4, arg8, arg7, arg11, arg10, arg14, arg13, (float) arg21, (float) arg20, local293, local286, local314, local307, local335, local328, local350, local345, local392, local390, local398, local396);
							arg4 += local428;
							arg5 += local525;
							arg7 += local499;
							arg8 += local596;
						...
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method3317(this.anIntArray217, this.anIntArray219, (int) arg0, (int) arg3, (int) arg5, arg6, arg8, arg9, arg11, arg12, arg14, (float) arg19, (float) arg21, local279, local293, local300, local314, local321, local335, local340, local350, local388, local392, local394, local398);
							arg3 += local400;
							arg5 += local525;
							arg6 += local402;
							arg8 += local596;
						...
						while (--arg2 >= 0.0F) {
							this.method3317(this.anIntArray217, this.anIntArray219, (int) arg0, (int) arg4, (int) arg5, arg7, arg8, arg10, arg11, arg13, arg14, (float) arg20, (float) arg21, local286, local293, local307, local314, local328, local335, local345, local350, local390, local392, local396, local398);
							arg4 += local428;
							arg5 += local525;
							arg7 += local499;
							arg8 += local596;
					...
					if (arg0 != arg2 && local525 < local400 || arg0 == arg2 && local428 > local400) {
						...
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method3317(this.anIntArray217, this.anIntArray219, (int) arg0, (int) arg4, (int) arg3, arg7, arg6, arg10, arg9, arg13, arg12, (float) arg20, (float) arg19, local286, local279, local307, local300, local328, local321, local345, local340, local390, local388, local396, local394);
							arg3 += local400;
							arg4 += local525;
							arg6 += local402;
							arg7 += local596;
						...
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method3317(this.anIntArray217, this.anIntArray219, (int) arg0, (int) arg3, (int) arg4, arg6, arg7, arg9, arg10, arg12, arg13, (float) arg19, (float) arg20, local279, local286, local300, local307, local321, local328, local340, local345, local388, local390, local394, local396);
							arg4 += local525;
							arg3 += local400;
							arg7 += local596;
							arg6 += local402;
			...
			if (!(arg1 >= (float) this.anInt4076)) {
				...
				if (arg2 < arg0) {
					...
					if (arg1 != arg2 && local400 < local428 || arg1 == arg2 && local400 > local525) {
						...
						arg1 = this.anIntArray218[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method3317(this.anIntArray217, this.anIntArray219, (int) arg1, (int) arg3, (int) arg4, arg6, arg7, arg9, arg10, arg12, arg13, (float) arg19, (float) arg20, local279, local286, local300, local307, local321, local328, local340, local345, local388, local390, local394, local396);
							arg3 += local400;
							arg4 += local428;
							arg6 += local402;
							arg7 += local499;
						...
						while (--arg0 >= 0.0F) {
							this.method3317(this.anIntArray217, this.anIntArray219, (int) arg1, (int) arg3, (int) arg5, arg6, arg8, arg9, arg11, arg12, arg14, (float) arg19, (float) arg21, local279, local293, local300, local314, local321, local335, local340, local350, local388, local392, local394, local398);
							arg3 += local400;
							arg5 += local525;
							arg6 += local402;
							arg8 += local596;
						...
						arg1 = this.anIntArray218[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method3317(this.anIntArray217, this.anIntArray219, (int) arg1, (int) arg4, (int) arg3, arg7, arg6, arg10, arg9, arg13, arg12, (float) arg20, (float) arg19, local286, local279, local307, local300, local328, local321, local345, local340, local390, local388, local396, local394);
							arg4 += local428;
							arg3 += local400;
							arg7 += local499;
							arg6 += local402;
						...
						while (--arg0 >= 0.0F) {
							this.method3317(this.anIntArray217, this.anIntArray219, (int) arg1, (int) arg5, (int) arg3, arg8, arg6, arg11, arg9, arg14, arg12, (float) arg21, (float) arg19, local293, local279, local314, local300, local335, local321, local350, local340, local392, local388, local398, local394);
							arg5 += local525;
							arg3 += local400;
							arg8 += local596;
							arg6 += local402;
					...
					if (local400 < local428) {
						while (--arg0 >= 0.0F) {
							this.method3317(this.anIntArray217, this.anIntArray219, (int) arg1, (int) arg5, (int) arg4, arg8, arg7, arg11, arg10, arg14, arg13, (float) arg21, (float) arg20, local293, local286, local314, local307, local335, local328, local350, local345, local392, local390, local398, local396);
							arg5 += local400;
							arg4 += local428;
							arg8 += local402;
							arg7 += local499;
						...
						while (--arg0 >= 0.0F) {
							this.method3317(this.anIntArray217, this.anIntArray219, (int) arg1, (int) arg4, (int) arg5, arg7, arg8, arg10, arg11, arg13, arg14, (float) arg20, (float) arg21, local286, local293, local307, local314, local328, local335, local345, local350, local390, local392, local396, local398);
							arg4 += local428;
							arg5 += local400;
							arg7 += local499;
							arg8 += local402;
			...
			if (arg0 < arg1) {
				...
				if (local428 < local525) {
					...
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method3317(this.anIntArray217, this.anIntArray219, (int) arg2, (int) arg4, (int) arg5, arg7, arg8, arg10, arg11, arg13, arg14, (float) arg20, (float) arg21, local286, local293, local307, local314, local328, local335, local345, local350, local390, local392, local396, local398);
						arg4 += local428;
						arg5 += local525;
						arg7 += local499;
						arg8 += local596;
					...
					while (--arg1 >= 0.0F) {
						this.method3317(this.anIntArray217, this.anIntArray219, (int) arg2, (int) arg4, (int) arg3, arg7, arg6, arg10, arg9, arg13, arg12, (float) arg20, (float) arg19, local286, local279, local307, local300, local328, local321, local345, local340, local390, local388, local396, local394);
						arg4 += local428;
						arg3 += local400;
						arg7 += local499;
						arg6 += local402;
					...
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method3317(this.anIntArray217, this.anIntArray219, (int) arg2, (int) arg5, (int) arg4, arg8, arg7, arg11, arg10, arg14, arg13, (float) arg21, (float) arg20, local293, local286, local314, local307, local335, local328, local350, local345, local392, local390, local398, local396);
						arg5 += local525;
						arg4 += local428;
						arg8 += local596;
						arg7 += local499;
					...
					while (--arg1 >= 0.0F) {
						this.method3317(this.anIntArray217, this.anIntArray219, (int) arg2, (int) arg3, (int) arg4, arg6, arg7, arg9, arg10, arg12, arg13, (float) arg19, (float) arg20, local279, local286, local300, local307, local321, local328, local340, local345, local388, local390, local394, local396);
						arg3 += local400;
						arg4 += local428;
						arg6 += local402;
						arg7 += local499;
				...
				if (local428 < local525) {
					...
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method3317(this.anIntArray217, this.anIntArray219, (int) arg2, (int) arg3, (int) arg5, arg6, arg8, arg9, arg11, arg12, arg14, (float) arg19, (float) arg21, local279, local293, local300, local314, local321, local335, local340, local350, local388, local392, local394, local398);
						arg3 += local428;
						arg5 += local525;
						arg6 += local499;
						arg8 += local596;
					...
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method3317(this.anIntArray217, this.anIntArray219, (int) arg2, (int) arg5, (int) arg3, arg8, arg6, arg11, arg9, arg14, arg12, (float) arg21, (float) arg19, local293, local279, local314, local300, local335, local321, local350, local340, local392, local388, local398, local394);
						arg5 += local525;
						arg3 += local428;
						arg8 += local596;
						arg6 += local499;
	...
	private void method3317(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) float arg9, @OriginalArg(10) float arg10, @OriginalArg(11) float arg11, @OriginalArg(12) float arg12, @OriginalArg(13) float arg13, @OriginalArg(14) float arg14, @OriginalArg(15) float arg15, @OriginalArg(16) float arg16, @OriginalArg(17) float arg17, @OriginalArg(18) float arg18, @OriginalArg(19) float arg19, @OriginalArg(20) float arg20, @OriginalArg(21) float arg21, @OriginalArg(22) float arg22, @OriginalArg(23) float arg23, @OriginalArg(24) float arg24) {
		...
		while (local3-- > 0) {
			...
			if (local156 < this.aFloatArray40[local151]) {
				@Pc(167) float local167 = arg7 * local156;
				@Pc(171) float local171 = arg9 * local156;
				@Pc(184) int local184 = (int) (local167 * (float) this.anInt4085 * this.aFloat79) & this.anInt4079;
				@Pc(197) int local197 = (int) (local171 * (float) this.anInt4085 * this.aFloat79) & this.anInt4079;
				@Pc(207) int local207 = this.anIntArray219[local197 * this.anInt4085 + local184];
				@Pc(220) int local220 = (int) (local167 * (float) this.anInt4083 * this.aFloat77) & this.anInt4078;
				@Pc(233) int local233 = (int) (local171 * (float) this.anInt4083 * this.aFloat77) & this.anInt4078;
				@Pc(243) int local243 = this.anIntArray220[local233 * this.anInt4083 + local220];
				@Pc(256) int local256 = (int) (local167 * (float) this.anInt4081 * this.aFloat78) & this.anInt4082;
				@Pc(269) int local269 = (int) (local171 * (float) this.anInt4081 * this.aFloat78) & this.anInt4082;
				@Pc(279) int local279 = this.anIntArray221[local269 * this.anInt4081 + local256];
				...
				if (arg11 != 0.0F) {
					...
					@Pc(462) int local462 = ((this.anInt4080 & 0xFF00FF) * (int) arg11 & 0xFF00FF00 | (this.anInt4080 & 0xFF00) * (int) arg11 & 0xFF0000) >>> 8;
					local431 = (((local431 & 0xFF00FF) * local440 & 0xFF00FF00 | (local431 & 0xFF00) * local440 & 0xFF0000) >>> 8) + local462;
				}
				arg0[local151] = local431;
				this.aFloatArray40[local151] = local156;
			}
			local151++;
			arg5 += local14;
			arg7 += local20;
	...
	public void method3318(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) float arg9, @OriginalArg(10) float arg10, @OriginalArg(11) float arg11, @OriginalArg(12) float arg12, @OriginalArg(13) float arg13, @OriginalArg(14) float arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18, @OriginalArg(19) int arg19, @OriginalArg(20) int arg20, @OriginalArg(21) int arg21, @OriginalArg(22) int arg22) {
		if (arg22 != this.anInt4088) {
			this.anIntArray219 = this.aClass16_Sub2_4.method5327(arg22);
			if (this.anIntArray219 == null) {
				this.method3321((float) arg0, (float) arg1, (float) arg2, (float) arg3, (float) arg4, (float) arg5, (float) arg6, (float) arg7, (float) arg8, Static268.method4645(arg18 | arg19 << 24, arg15), Static268.method4645(arg18 | arg20 << 24, arg16), Static268.method4645(arg18 | arg21 << 24, arg17));
				return;
			}
			...
			this.anInt4079 = this.anInt4085 - 1;
			this.anInt4087 = this.aClass16_Sub2_4.method5320(arg22);
			this.aBoolean297 = this.aClass16_Sub2_4.method5322(arg22);
		}
		this.anInt4080 = arg18;
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (!(arg0 >= (float) this.anInt4076)) {
				...
				if (arg1 < arg2) {
					...
					if (arg0 != arg1 && local320 < local215 || arg0 == arg1 && local320 > local239) {
						...
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method3320(this.anIntArray217, this.anIntArray219, (int) arg0, (int) arg5, (int) arg3, arg8, arg6, arg11, arg9, arg14, arg12, (float) arg21, (float) arg19, local120, local106, local141, local127, local162, local148, local177, local167);
							arg3 += local215;
							arg5 += local320;
							arg6 += local217;
							arg8 += local379;
						...
						while (--arg2 >= 0.0F) {
							this.method3320(this.anIntArray217, this.anIntArray219, (int) arg0, (int) arg5, (int) arg4, arg8, arg7, arg11, arg10, arg14, arg13, (float) arg21, (float) arg20, local120, local113, local141, local134, local162, local155, local177, local172);
							arg4 += local239;
							arg5 += local320;
							arg7 += local298;
							arg8 += local379;
						...
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method3320(this.anIntArray217, this.anIntArray219, (int) arg0, (int) arg3, (int) arg5, arg6, arg8, arg9, arg11, arg12, arg14, (float) arg19, (float) arg21, local106, local120, local127, local141, local148, local162, local167, local177);
							arg3 += local215;
							arg5 += local320;
							arg6 += local217;
							arg8 += local379;
						...
						while (--arg2 >= 0.0F) {
							this.method3320(this.anIntArray217, this.anIntArray219, (int) arg0, (int) arg4, (int) arg5, arg7, arg8, arg10, arg11, arg13, arg14, (float) arg20, (float) arg21, local113, local120, local134, local141, local155, local162, local172, local177);
							arg4 += local239;
							arg5 += local320;
							arg7 += local298;
							arg8 += local379;
					...
					if (arg0 != arg2 && local320 < local215 || arg0 == arg2 && local239 > local215) {
						...
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method3320(this.anIntArray217, this.anIntArray219, (int) arg0, (int) arg4, (int) arg3, arg7, arg6, arg10, arg9, arg13, arg12, (float) arg20, (float) arg19, local113, local106, local134, local127, local155, local148, local172, local167);
							arg3 += local215;
							arg4 += local320;
							arg6 += local217;
							arg7 += local379;
						...
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method3320(this.anIntArray217, this.anIntArray219, (int) arg0, (int) arg3, (int) arg4, arg6, arg7, arg9, arg10, arg12, arg13, (float) arg19, (float) arg20, local106, local113, local127, local134, local148, local155, local167, local172);
							arg4 += local320;
							arg3 += local215;
							arg7 += local379;
							arg6 += local217;
			...
			if (!(arg1 >= (float) this.anInt4076)) {
				...
				if (arg2 < arg0) {
					...
					if ((arg1 == arg2 || !(local215 < local239)) && (arg1 != arg2 || !(local215 > local320))) {
						...
						arg1 = this.anIntArray218[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method3320(this.anIntArray217, this.anIntArray219, (int) arg1, (int) arg4, (int) arg3, arg7, arg6, arg10, arg9, arg13, arg12, (float) arg20, (float) arg19, local113, local106, local134, local127, local155, local148, local172, local167);
							arg4 += local239;
							arg3 += local215;
							arg7 += local298;
							arg6 += local217;
						...
						while (--arg0 >= 0.0F) {
							this.method3320(this.anIntArray217, this.anIntArray219, (int) arg1, (int) arg5, (int) arg3, arg8, arg6, arg11, arg9, arg14, arg12, (float) arg21, (float) arg19, local120, local106, local141, local127, local162, local148, local177, local167);
							arg5 += local320;
							arg3 += local215;
							arg8 += local379;
							arg6 += local217;
						...
						arg1 = this.anIntArray218[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method3320(this.anIntArray217, this.anIntArray219, (int) arg1, (int) arg3, (int) arg4, arg6, arg7, arg9, arg10, arg12, arg13, (float) arg19, (float) arg20, local106, local113, local127, local134, local148, local155, local167, local172);
							arg3 += local215;
							arg4 += local239;
							arg6 += local217;
							arg7 += local298;
						...
						while (--arg0 >= 0.0F) {
							this.method3320(this.anIntArray217, this.anIntArray219, (int) arg1, (int) arg3, (int) arg5, arg6, arg8, arg9, arg11, arg12, arg14, (float) arg19, (float) arg21, local106, local120, local127, local141, local148, local162, local167, local177);
							arg3 += local215;
							arg5 += local320;
							arg6 += local217;
							arg8 += local379;
					...
					if (local215 < local239) {
						while (--arg0 >= 0.0F) {
							this.method3320(this.anIntArray217, this.anIntArray219, (int) arg1, (int) arg5, (int) arg4, arg8, arg7, arg11, arg10, arg14, arg13, (float) arg21, (float) arg20, local120, local113, local141, local134, local162, local155, local177, local172);
							arg5 += local215;
							arg4 += local239;
							arg8 += local217;
							arg7 += local298;
						...
						while (--arg0 >= 0.0F) {
							this.method3320(this.anIntArray217, this.anIntArray219, (int) arg1, (int) arg4, (int) arg5, arg7, arg8, arg10, arg11, arg13, arg14, (float) arg20, (float) arg21, local113, local120, local134, local141, local155, local162, local172, local177);
							arg4 += local239;
							arg5 += local215;
							arg7 += local298;
							arg8 += local217;
			...
			if (arg0 < arg1) {
				...
				if (local239 < local320) {
					...
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method3320(this.anIntArray217, this.anIntArray219, (int) arg2, (int) arg4, (int) arg5, arg7, arg8, arg10, arg11, arg13, arg14, (float) arg20, (float) arg21, local113, local120, local134, local141, local155, local162, local172, local177);
						arg4 += local239;
						arg5 += local320;
						arg7 += local298;
						arg8 += local379;
					...
					while (--arg1 >= 0.0F) {
						this.method3320(this.anIntArray217, this.anIntArray219, (int) arg2, (int) arg4, (int) arg3, arg7, arg6, arg10, arg9, arg13, arg12, (float) arg20, (float) arg19, local113, local106, local134, local127, local155, local148, local172, local167);
						arg4 += local239;
						arg3 += local215;
						arg7 += local298;
						arg6 += local217;
					...
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method3320(this.anIntArray217, this.anIntArray219, (int) arg2, (int) arg5, (int) arg4, arg8, arg7, arg11, arg10, arg14, arg13, (float) arg21, (float) arg20, local120, local113, local141, local134, local162, local155, local177, local172);
						arg5 += local320;
						arg4 += local239;
						arg8 += local379;
						arg7 += local298;
					...
					while (--arg1 >= 0.0F) {
						this.method3320(this.anIntArray217, this.anIntArray219, (int) arg2, (int) arg3, (int) arg4, arg6, arg7, arg9, arg10, arg12, arg13, (float) arg19, (float) arg20, local106, local113, local127, local134, local148, local155, local167, local172);
						arg3 += local215;
						arg4 += local239;
						arg6 += local217;
						arg7 += local298;
				...
				if (local239 < local320) {
					...
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method3320(this.anIntArray217, this.anIntArray219, (int) arg2, (int) arg3, (int) arg5, arg6, arg8, arg9, arg11, arg12, arg14, (float) arg19, (float) arg21, local106, local120, local127, local141, local148, local162, local167, local177);
						arg3 += local239;
						arg5 += local320;
						arg6 += local298;
						arg8 += local379;
					...
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method3320(this.anIntArray217, this.anIntArray219, (int) arg2, (int) arg5, (int) arg3, arg8, arg6, arg11, arg9, arg14, arg12, (float) arg21, (float) arg19, local120, local106, local141, local127, local162, local148, local177, local167);
						arg5 += local320;
						arg3 += local239;
						arg8 += local379;
						arg6 += local298;
	...
	private void method3319(@OriginalArg(0) int[] arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) float arg6, @OriginalArg(8) float arg7) {
		if (this.aBoolean293) {
			if (arg5 > this.anInt4073) {
				arg5 = this.anInt4073;
			}
			if (arg4 < 0) {
				arg4 = 0;
		...
		@Pc(303) int local303;
		@Pc(63) float local63;
		if (this.aClass146_1.aBoolean390) {
			if (this.anInt4074 == 0) {
				while (true) {
					local29--;
					if (local29 < 0) {
			...
			} else if (this.anInt4074 != 254) {
				local278 = this.anInt4074;
				local283 = 256 - this.anInt4074;
			...
			} else if (arg4 != 0 && arg5 <= this.anInt4073 - 1) {
				while (true) {
					local29--;
					if (local29 < 0) {
						local29 = arg5 - arg4 & 0x3;
	...
	private void method3320(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) float arg9, @OriginalArg(10) float arg10, @OriginalArg(11) float arg11, @OriginalArg(12) float arg12, @OriginalArg(13) float arg13, @OriginalArg(14) float arg14, @OriginalArg(15) float arg15, @OriginalArg(16) float arg16, @OriginalArg(17) float arg17, @OriginalArg(18) float arg18, @OriginalArg(19) float arg19, @OriginalArg(20) float arg20) {
		@Pc(3) int local3 = arg4 - arg3;
		@Pc(8) float local8 = 1.0F / (float) local3;
		@Pc(14) float local14 = (arg6 - arg5) * local8;
		@Pc(20) float local20 = (arg8 - arg7) * local8;
		...
		while (local3-- > 0) {
			...
			if (local143 < this.aFloatArray40[local138]) {
				@Pc(159) int local159 = (int) (arg7 * local143 * (float) this.anInt4085);
				if (this.aBoolean297) {
					local159 &= this.anInt4079;
				} else if (local159 < 0) {
					local159 = 0;
				} else if (local159 > this.anInt4079) {
					local159 = this.anInt4079;
				}
				@Pc(189) int local189 = (int) (arg9 * local143 * (float) this.anInt4085);
				if (this.aBoolean297) {
					local189 &= this.anInt4079;
				} else if (local189 < 0) {
					local189 = 0;
				} else if (local189 > this.anInt4079) {
					local189 = this.anInt4079;
				}
				@Pc(220) int local220 = this.anIntArray219[local189 * this.anInt4085 + local159];
				@Pc(232) int local232;
				if (this.anInt4087 == 2) {
					local232 = local220 >> 24 & 0xFF;
				} else if (this.anInt4087 == 1) {
				...
				if (local232 != 0) {
					...
					if (local232 == 255) {
						...
						if (arg11 != 0.0F) {
							...
							local321 = ((this.anInt4080 & 0xFF00FF) * (int) arg11 & 0xFF00FF00 | (this.anInt4080 & 0xFF00) * (int) arg11 & 0xFF0000) >>> 8;
							local290 = (((local290 & 0xFF00FF) * local299 & 0xFF00FF00 | (local290 & 0xFF00) * local299 & 0xFF0000) >>> 8) + local321;
						}
						arg0[local138] = local290;
						this.aFloatArray40[local138] = local143;
					} else {
						local290 = ((int) (arg15 * (float) (local220 >> 16 & 0xFF)) & 0xFF00 | 0xFF0000) << 8 | (int) (arg17 * (float) (local220 >> 8 & 0xFF)) & 0xFF00 | (int) (arg19 * (float) (local220 & 0xFF)) >> 8;
						if (arg11 != 0.0F) {
							local299 = (int) (255.0F - arg11);
	...
	public void method3321(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11) {
		if (this.aBoolean295) {
			this.aClass16_Sub2_4.method6105((int) arg3, (int) arg1, (int) arg0, arg9 | 0xFF000000, (int) arg4);
			this.aClass16_Sub2_4.method6105((int) arg4, (int) arg2, (int) arg1, arg9 | 0xFF000000, (int) arg5);
			this.aClass16_Sub2_4.method6105((int) arg5, (int) arg0, (int) arg2, arg9 | 0xFF000000, (int) arg3);
			return;
		}
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (!(arg0 >= (float) this.anInt4076)) {
				...
				if (arg1 < arg2) {
					...
					if ((arg0 == arg1 || !(local160 < local149)) && (arg0 != arg1 || !(local160 > local138))) {
						...
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method3322(this.anIntArray217, this.aFloatArray40, (int) arg0, (int) arg3, (int) arg5, arg6, local186, local310, local206, local321, local226, local332, local246);
							arg5 += local160;
							arg3 += local149;
							arg6 += local196;
							local310 += local216;
						...
						while (--arg2 >= 0.0F) {
							this.method3322(this.anIntArray217, this.aFloatArray40, (int) arg0, (int) arg4, (int) arg5, arg6, local186, local310, local206, local321, local226, local332, local246);
							arg5 += local160;
							arg4 += local138;
							arg6 += local196;
							local310 += local216;
						...
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method3322(this.anIntArray217, this.aFloatArray40, (int) arg0, (int) arg5, (int) arg3, arg6, local186, local310, local206, local321, local226, local332, local246);
							arg5 += local160;
							arg3 += local149;
							arg6 += local196;
							local310 += local216;
						...
						while (--arg2 >= 0.0F) {
							this.method3322(this.anIntArray217, this.aFloatArray40, (int) arg0, (int) arg5, (int) arg4, arg6, local186, local310, local206, local321, local226, local332, local246);
							arg5 += local160;
							arg4 += local138;
							arg6 += local196;
							local310 += local216;
					...
					if (arg0 != arg2 && local160 < local149 || arg0 == arg2 && local138 > local149) {
						...
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method3322(this.anIntArray217, this.aFloatArray40, (int) arg0, (int) arg4, (int) arg3, arg6, local186, local310, local206, local321, local226, local332, local246);
							arg4 += local160;
							arg3 += local149;
							arg6 += local196;
							local310 += local216;
						...
						arg0 = this.anIntArray218[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method3322(this.anIntArray217, this.aFloatArray40, (int) arg0, (int) arg3, (int) arg4, arg6, local186, local310, local206, local321, local226, local332, local246);
							arg4 += local160;
							arg3 += local149;
							arg6 += local196;
							local310 += local216;
			...
			if (!(arg1 >= (float) this.anInt4076)) {
				...
				if (arg2 < arg0) {
					...
					if ((arg1 == arg2 || !(local149 < local138)) && (arg1 != arg2 || !(local149 > local160))) {
						...
						arg1 = this.anIntArray218[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method3322(this.anIntArray217, this.aFloatArray40, (int) arg1, (int) arg4, (int) arg3, arg7, local186, local310, local206, local321, local226, local332, local246);
							arg3 += local149;
							arg4 += local138;
							arg7 += local196;
							local310 += local216;
						...
						while (--arg0 >= 0.0F) {
							this.method3322(this.anIntArray217, this.aFloatArray40, (int) arg1, (int) arg5, (int) arg3, arg7, local186, local310, local206, local321, local226, local332, local246);
							arg3 += local149;
							arg5 += local160;
							arg7 += local196;
							local310 += local216;
						...
						arg1 = this.anIntArray218[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method3322(this.anIntArray217, this.aFloatArray40, (int) arg1, (int) arg3, (int) arg4, arg7, local186, local310, local206, local321, local226, local332, local246);
							arg3 += local149;
							arg4 += local138;
							arg7 += local196;
							local310 += local216;
						...
						while (--arg0 >= 0.0F) {
							this.method3322(this.anIntArray217, this.aFloatArray40, (int) arg1, (int) arg3, (int) arg5, arg7, local186, local310, local206, local321, local226, local332, local246);
							arg3 += local149;
							arg5 += local160;
							arg7 += local196;
							local310 += local216;
					...
					if (local149 < local138) {
						...
						arg1 = this.anIntArray218[(int) arg1];
						while (--arg0 >= 0.0F) {
							this.method3322(this.anIntArray217, this.aFloatArray40, (int) arg1, (int) arg5, (int) arg4, arg7, local186, local310, local206, local321, local226, local332, local246);
							arg5 += local149;
							arg4 += local138;
							arg7 += local196;
							local310 += local216;
						...
						arg1 = this.anIntArray218[(int) arg1];
						while (--arg0 >= 0.0F) {
							this.method3322(this.anIntArray217, this.aFloatArray40, (int) arg1, (int) arg4, (int) arg5, arg7, local186, local310, local206, local321, local226, local332, local246);
							arg5 += local149;
							arg4 += local138;
							arg7 += local196;
							local310 += local216;
			...
			if (arg0 < arg1) {
				...
				if (local138 < local160) {
					...
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method3322(this.anIntArray217, this.aFloatArray40, (int) arg2, (int) arg4, (int) arg5, arg8, local186, local310, local206, local321, local226, local332, local246);
						arg4 += local138;
						arg5 += local160;
						arg8 += local196;
						local310 += local216;
					...
					while (--arg1 >= 0.0F) {
						this.method3322(this.anIntArray217, this.aFloatArray40, (int) arg2, (int) arg4, (int) arg3, arg8, local186, local310, local206, local321, local226, local332, local246);
						arg4 += local138;
						arg3 += local149;
						arg8 += local196;
						local310 += local216;
					...
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method3322(this.anIntArray217, this.aFloatArray40, (int) arg2, (int) arg5, (int) arg4, arg8, local186, local310, local206, local321, local226, local332, local246);
						arg4 += local138;
						arg5 += local160;
						arg8 += local196;
						local310 += local216;
					...
					while (--arg1 >= 0.0F) {
						this.method3322(this.anIntArray217, this.aFloatArray40, (int) arg2, (int) arg3, (int) arg4, arg8, local186, local310, local206, local321, local226, local332, local246);
						arg4 += local138;
						arg3 += local149;
						arg8 += local196;
						local310 += local216;
				...
				if (local138 < local160) {
					...
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method3322(this.anIntArray217, this.aFloatArray40, (int) arg2, (int) arg3, (int) arg5, arg8, local186, local310, local206, local321, local226, local332, local246);
						arg3 += local138;
						arg5 += local160;
						arg8 += local196;
						local310 += local216;
					...
					arg2 = this.anIntArray218[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method3322(this.anIntArray217, this.aFloatArray40, (int) arg2, (int) arg5, (int) arg3, arg8, local186, local310, local206, local321, local226, local332, local246);
						arg3 += local138;
						arg5 += local160;
						arg8 += local196;
						local310 += local216;
		...
		if (this.aBoolean292) {
			...
			if (this.aBoolean296) {
				...
				if (this.anInt4074 == 0) {
					...
					local163 = this.anInt4074;
					local168 = 256 - this.anInt4074;
					if (local54 > 0) {
						do {
							local88 = (int) arg7 & 0xFF0000 | 0xFF000000 | (int) arg9 & 0xFF00 | (int) arg11 & 0xFF;
							arg7 += local58;
	...
	private void method3323(@OriginalArg(0) int[] arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) float arg5, @OriginalArg(8) float arg6, @OriginalArg(9) float arg7, @OriginalArg(10) float arg8) {
		if (this.aBoolean293) {
			if (arg4 > this.anInt4073) {
				arg4 = this.anInt4073;
			}
		...
		if (this.aClass146_1.aBoolean390) {
			if (this.aBoolean296) {
				...
				if (this.anInt4074 == 0) {
					if (local50 > 0) {
						do {
							local64 = Static491.anIntArray491[(int) arg5];
							arg5 += local54;
							local71 = arg2 + 1;
					...
					local186 = this.anInt4074;
					local191 = 256 - this.anInt4074;
					if (local50 > 0) {
						do {
							local64 = Static491.anIntArray491[(int) arg5];
							arg5 += local54;
				...
				if (this.anInt4074 == 0) {
					do {
						arg2++;
						if (arg7 < arg1[arg2]) {
							arg0[arg2] = Static491.anIntArray491[(int) arg5];
							arg1[arg2] = arg7;
						}
						arg7 += arg8;
						arg5 += arg6;
