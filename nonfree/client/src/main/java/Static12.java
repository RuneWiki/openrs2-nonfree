...
public final class Static12 {
	...
	@OriginalMember(owner = "client!al", name = "a", descriptor = "(II)Lclient!qk;")
	public static Class2_Sub1 method216(@OriginalArg(0) int arg0) {
		if (arg0 == 0) {
			...
			return new Class2_Sub1_Sub6_Sub1();
		} else if (arg0 == 19) {
