...
public final class Static3 {
	...
	@OriginalMember(owner = "client!passwordapp_de", name = "PROTOCOL_VERSION", descriptor = "I")
	private static final int anInt7 = 2;

	@OriginalMember(owner = "client!passwordapp_de", name = "TYPE_CHANGEQUESTIONS", descriptor = "I")
	private static final int anInt8 = 2;

	@OriginalMember(owner = "client!passwordapp_de", name = "TYPE_DEBUG", descriptor = "I")
	private static final int anInt9 = 4;

	@OriginalMember(owner = "client!passwordapp_de", name = "tidyrecoveryanswer", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 345)
	public static String method54(@OriginalArg(0) String arg0) {
	...
	@OriginalMember(owner = "client!passwordapp_de", name = "urlencode", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 360)
	public static String method55(@OriginalArg(0) String arg0) {
	...
	@OriginalMember(owner = "client!passwordapp_de", name = "findcachedir", descriptor = "()Ljava/lang/String;", line = 742)
	public static String method56() {
	...
	@OriginalMember(owner = "client!passwordapp_de", name = "getuid", descriptor = "(Ljava/lang/String;)I", line = 762)
	public static int method57(@OriginalArg(0) String arg0) {
		try {
