...
public final class Static128 {
	...
	@OriginalMember(owner = "client!jd", name = "a", descriptor = "([Lclient!ha;)Lclient!jd;")
	public static Class82 method2227(@OriginalArg(0) Class62[] arg0) {
		for (@Pc(1) int local1 = 0; local1 < arg0.length; local1++) {
			if (arg0[local1] == null || arg0[local1].anInt2009 <= 0) {
				return null;
			}
		}
		...
		for (local25 = 0; local25 < arg0.length; local25++) {
			local20.glAttachObjectARB(local23, arg0[local25].anInt2009);
		}
		...
		if (anIntArray222[0] == 0) {
			...
			if (anIntArray222[0] == 0) {
				for (local25 = 0; local25 < arg0.length; local25++) {
					local20.glDetachObjectARB(local23, arg0[local25].anInt2009);
				}
				local20.glDeleteObjectARB(local23);
				return null;
			}
		}
		return new Class82(local23, arg0);
	}
}
