...
public final class Class148 implements Interface4 {
	...
	public Class148() {
		if (Static294.anInt5869 >= 2) {
			...
			@Pc(40) GL local40 = Static294.aGL1;
			...
			this.anInt4990 = local17[0];
			Static239.aBoolean313 = Static294.anInt5869 > 2 && Static294.aBoolean372;
			this.method3769();
		}
	}
	...
	public void method3792(@OriginalArg(0) int arg0) {
		...
		if (Static239.aBoolean313 || arg0 >= 0) {
			local1.glPushMatrix();
			...
			local1.glTranslatef((float) -Static264.anInt5303, (float) -Static159.anInt3532, (float) -Static120.anInt6261);
			if (Static239.aBoolean313) {
				this.aFloatArray22[0] = 0.001F;
				this.aFloatArray22[1] = 9.0E-4F;
				...
				this.aFloatArray22[1] = 9.0E-4F;
				this.aFloatArray22[2] = 0.001F;
				this.aFloatArray22[3] = 0.0F;
				local1.glTexGenfv(8193, 9474, this.aFloatArray22, 0);
				this.aFloatArray22[0] = 0.0F;
				this.aFloatArray22[1] = 0.0F;
				this.aFloatArray22[2] = 0.0F;
				this.aFloatArray22[3] = (float) Static294.anInt5871 * 0.005F;
				local1.glTexGenfv(8194, 9474, this.aFloatArray22, 0);
				local1.glActiveTexture(33986);
			}
			local1.glTexEnvfv(8960, 8705, Static111.method1808(), 0);
			if (arg0 >= 0) {
				this.aFloatArray22[0] = 0.0F;
				this.aFloatArray22[1] = 1.0F / (float) Static8.anInt226;
				this.aFloatArray22[2] = 0.0F;
				this.aFloatArray22[3] = (float) arg0 * 1.0F / (float) Static8.anInt226;
				local1.glTexGenfv(8192, 9474, this.aFloatArray22, 0);
	...
	public void method3794() {
		@Pc(1) GL local1 = Static294.aGL1;
		local1.glCallList(this.anInt4991);
	}
	...
	private void method3769() {
		@Pc(1) GL local1 = Static294.aGL1;
		this.anInt4991 = local1.glGenLists(2);
		local1.glNewList(this.anInt4991, 4864);
		local1.glActiveTexture(33985);
		if (Static239.aBoolean313) {
		...
		local1.glBindTexture(3552, this.anInt4990);
		...
		local1.glActiveTexture(33984);
		local1.glEndList();
		local1.glNewList(this.anInt4991 + 1, 4864);
		local1.glActiveTexture(33985);
		if (Static239.aBoolean313) {
	...
	public void method3791() {
		@Pc(1) GL local1 = Static294.aGL1;
		local1.glCallList(this.anInt4991 + 1);
	}
}
