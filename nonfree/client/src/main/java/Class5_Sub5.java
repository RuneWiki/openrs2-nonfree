...
public final class Class5_Sub5 extends Class5 {
	...
	public Class5_Sub5(@OriginalArg(0) byte[] arg0) {
		this.method315(arg0);
	}

	@OriginalMember(owner = "client!bj", name = "c", descriptor = "(I)[F")
	private float[] method309(@OriginalArg(0) int arg0) {
		Static20.method307(this.aByteArrayArray1[arg0]);
		Static20.method316();
		@Pc(15) int local15 = Static20.method314(Static204.method3021(Static20.anIntArray25.length - 1));
		@Pc(19) boolean local19 = Static20.aBooleanArray7[local15];
		@Pc(25) int local25 = local19 ? Static20.anInt361 : Static20.anInt364;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static20.method316() != 0;
			local29 = Static20.method316() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static20.anInt364 >> 2);
			local67 = (local25 >> 2) + (Static20.anInt364 >> 2);
			local71 = Static20.anInt364 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static20.anInt364 >> 2);
			local104 = local25 + (Static20.anInt364 >> 2) - (local25 >> 2);
			local108 = Static20.anInt364 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class28 local123 = Static20.aClass28Array1[Static20.anIntArray25[local15]];
		@Pc(126) int local126 = local123.anInt1039;
		@Pc(131) int local131 = local123.anIntArray97[local126];
		@Pc(140) boolean local140 = !Static20.aClass103Array1[local131].method3094();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt1038; local144++) {
			@Pc(152) Class42 local152 = Static20.aClass42Array1[local123.anIntArray96[local144]];
			local154 = Static20.aFloatArray5;
			local152.method1234(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt1039;
			local176 = local123.anIntArray97[local171];
			Static20.aClass103Array1[local176].method3098(Static20.aFloatArray5, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static20.aFloatArray5[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static20.aFloatArray5;
			...
			@Pc(252) float[] local252 = local19 ? Static20.aFloatArray8 : Static20.aFloatArray4;
			@Pc(258) float[] local258 = local19 ? Static20.aFloatArray6 : Static20.aFloatArray7;
			@Pc(264) float[] local264 = local19 ? Static20.aFloatArray3 : Static20.aFloatArray2;
			@Pc(270) int[] local270 = local19 ? Static20.anIntArray26 : Static20.anIntArray27;
			...
			@Pc(486) int local486 = Static204.method3021(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static20.aFloatArray5[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static20.aFloatArray5[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt368 > 0) {
			local176 = this.anInt368 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean19) {
				for (local212 = 0; local212 < this.anInt369; local212++) {
					local1254 = (this.anInt368 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static20.aFloatArray5[local212];
				}
			}
		}
		local154 = this.aFloatArray1;
		this.aFloatArray1 = Static20.aFloatArray5;
		Static20.aFloatArray5 = local154;
		this.anInt368 = local25;
		this.anInt369 = local104 - (local25 >> 1);
		this.aBoolean19 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!bj", name = "a", descriptor = "([I)Lclient!ne;")
	public Class5_Sub7_Sub1 method311(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray6 == null) {
			this.anInt368 = 0;
			this.aFloatArray1 = new float[Static20.anInt361];
			this.aByteArray6 = new byte[this.anInt365];
			this.anInt371 = 0;
			this.anInt372 = 0;
		}
		while (this.anInt372 < this.aByteArrayArray1.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method309(this.anInt372);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt371;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt365 - local47) {
					local50 = this.anInt365 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt371;
				}
				this.anInt371 = local47;
			}
			this.anInt372++;
		}
		...
		return new Class5_Sub7_Sub1(this.anInt362, local129, this.anInt370, this.anInt366, this.aBoolean21);
	}

	@OriginalMember(owner = "client!bj", name = "b", descriptor = "([B)V")
	private void method315(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class5_Sub6 local4 = new Class5_Sub6(arg0);
		this.anInt362 = local4.method3073();
		this.anInt365 = local4.method3073();
		this.anInt370 = local4.method3073();
		this.anInt366 = local4.method3073();
		if (this.anInt366 < 0) {
			this.anInt366 = ~this.anInt366;
			this.aBoolean21 = true;
		}
		@Pc(40) int local40 = local4.method3073();
		this.aByteArrayArray1 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method3062();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method3051(local49, local64);
