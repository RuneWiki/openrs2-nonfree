...
public final class Static50 {
	...
	public static JagString aClass22_348 = Static60.method1113("Passwort: ");

	@OriginalMember(owner = "client!ie", name = "O", descriptor = "I")
	public static int anInt1405 = 0;

	@OriginalMember(owner = "client!ie", name = "Q", descriptor = "Lclient!jd;")
	public static Packet aClass4_Sub11_1 = new Packet(8);
	...
	public static PlayerModel aClass21_1 = new PlayerModel();

	@OriginalMember(owner = "client!ie", name = "Y", descriptor = "Lclient!ec;")
	private static JagString aClass22_349 = Static60.method1113("Select");

	@OriginalMember(owner = "client!ie", name = "Z", descriptor = "Lclient!ec;")
	private static JagString aClass22_350 = Static60.method1113("RuneScape has been updated(Q");

	@OriginalMember(owner = "client!ie", name = "ab", descriptor = "Lclient!ec;")
	public static JagString aClass22_351 = aClass22_350;

	@OriginalMember(owner = "client!ie", name = "bb", descriptor = "Lclient!ec;")
	public static JagString aClass22_352 = aClass22_349;

	@OriginalMember(owner = "client!ie", name = "a", descriptor = "(BLclient!f;)Lclient!ec;")
	public static JagString method963(@OriginalArg(1) IfType arg0) {
	...
	public static void method966() {
		...
		Static26.anInt924 = Client.anInt2877;
		Static28.anInt671 = -1;
		if (Static11.anInt2982 != -1) {
	...
	public static void method968(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) PlayerEntity arg2, @OriginalArg(4) int arg3) {
		if (Static16.aClass4_Sub1_Sub3_Sub2_Sub1_1 == arg2 || Static99.anInt2589 >= 400) {
			return;
		}
		@Pc(64) JagString local64;
		if (arg2.anInt1746 == 0) {
			local64 = Static44.method856(new JagString[] { arg2.aClass22_444, Static23.method391(arg2.anInt1732, Static16.aClass4_Sub1_Sub3_Sub2_Sub1_1.anInt1732), Static35.aClass22_244, Static51.aClass22_364, Static134.method2042(arg2.anInt1732), Static19.aClass22_150 });
		} else {
			local64 = Static44.method856(new JagString[] { arg2.aClass22_444, Static35.aClass22_244, Static97.aClass22_751, Static134.method2042(arg2.anInt1746), Static19.aClass22_150 });
		}
		@Pc(104) int local104;
		if (Static104.anInt2636 == 1) {
			Static48.method905(arg0, Static35.aClass22_246, arg1, 5, Static44.method856(new JagString[] { Static43.aClass22_290, Static112.aClass22_864, local64 }), arg3);
			...
			for (local104 = 7; local104 >= 0; local104--) {
				if (Static33.aClass22Array6[local104] != null) {
					...
					Static48.method905(arg0, Static33.aClass22Array6[local104], arg1, local169, Static44.method856(new JagString[] { Static108.aClass22_805, local64 }), arg3);
				}
			}
		} else if ((Static73.anInt1961 & 0x8) == 8) {
			Static48.method905(arg0, Static124.aClass22_927, arg1, 22, Static44.method856(new JagString[] { Static12.aClass22_80, Static112.aClass22_864, local64 }), arg3);
		}
		for (local104 = 0; local104 < Static99.anInt2589; local104++) {
			if (Static38.anIntArray111[local104] == 3) {
				Static48.aClass22Array9[local104] = Static44.method856(new JagString[] { Static108.aClass22_805, local64 });
				return;
			}
		}
	}
	...
	public static void method970() {
		while (true) {
			...
			@Pc(16) Js5NetProviderRequest local16;
			synchronized (Static2.aClass82_1) {
				local16 = (Js5NetProviderRequest) Static134.aClass82_15.method2029();
			}
			if (local16 == null) {
				return;
			}
