...
public final class Class6_Sub37 extends Class6 {
	...
	public Class6_Sub37(@OriginalArg(0) byte[] arg0) {
		this.method5864(arg0);
	}

	@OriginalMember(owner = "client!ofa", name = "b", descriptor = "([B)V")
	private void method5864(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class6_Sub26 local4 = new Class6_Sub26(arg0);
		this.anInt6956 = local4.method5000();
		this.anInt6962 = local4.method5000();
		this.anInt6954 = local4.method5000();
		this.anInt6958 = local4.method5000();
		if (this.anInt6958 < 0) {
			this.anInt6958 = ~this.anInt6958;
			this.aBoolean520 = true;
		}
		@Pc(40) int local40 = local4.method5000();
		this.aByteArrayArray22 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method4966();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method4977(local49, local64);
			this.aByteArrayArray22[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!ofa", name = "c", descriptor = "(I)[F")
	private float[] method5868(@OriginalArg(0) int arg0) {
		Static368.method5867(this.aByteArrayArray22[arg0]);
		Static368.method5859();
		@Pc(15) int local15 = Static368.method5866(Static330.method5267(Static368.anIntArray493.length - 1));
		@Pc(19) boolean local19 = Static368.aBooleanArray25[local15];
		@Pc(25) int local25 = local19 ? Static368.anInt6959 : Static368.anInt6961;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static368.method5859() != 0;
			local29 = Static368.method5859() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static368.anInt6961 >> 2);
			local67 = (local25 >> 2) + (Static368.anInt6961 >> 2);
			local71 = Static368.anInt6961 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static368.anInt6961 >> 2);
			local104 = local25 + (Static368.anInt6961 >> 2) - (local25 >> 2);
			local108 = Static368.anInt6961 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class186 local123 = Static368.aClass186Array1[Static368.anIntArray493[local15]];
		@Pc(126) int local126 = local123.anInt5354;
		@Pc(131) int local131 = local123.anIntArray400[local126];
		@Pc(140) boolean local140 = !Static368.aClass283Array1[local131].method7126();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt5355; local144++) {
			@Pc(152) Class261 local152 = Static368.aClass261Array1[local123.anIntArray399[local144]];
			local154 = Static368.aFloatArray51;
			local152.method6470(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt5354;
			local176 = local123.anIntArray400[local171];
			Static368.aClass283Array1[local176].method7123(Static368.aFloatArray51, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static368.aFloatArray51[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static368.aFloatArray51;
			...
			@Pc(252) float[] local252 = local19 ? Static368.aFloatArray47 : Static368.aFloatArray49;
			@Pc(258) float[] local258 = local19 ? Static368.aFloatArray50 : Static368.aFloatArray48;
			@Pc(264) float[] local264 = local19 ? Static368.aFloatArray53 : Static368.aFloatArray54;
			@Pc(270) int[] local270 = local19 ? Static368.anIntArray494 : Static368.anIntArray495;
			...
			@Pc(486) int local486 = Static330.method5267(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static368.aFloatArray51[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static368.aFloatArray51[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt6953 > 0) {
			local176 = this.anInt6953 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean519) {
				for (local212 = 0; local212 < this.anInt6960; local212++) {
					local1254 = (this.anInt6953 >> 1) + local212;
					local1228[local212] += this.aFloatArray52[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static368.aFloatArray51[local212];
				}
			}
		}
		local154 = this.aFloatArray52;
		this.aFloatArray52 = Static368.aFloatArray51;
		Static368.aFloatArray51 = local154;
		this.anInt6953 = local25;
		this.anInt6960 = local104 - (local25 >> 1);
		this.aBoolean519 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!ofa", name = "a", descriptor = "([I)Lclient!wb;")
	public Class6_Sub12_Sub1 method5870(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray78 == null) {
			this.anInt6953 = 0;
			this.aFloatArray52 = new float[Static368.anInt6959];
			this.aByteArray78 = new byte[this.anInt6962];
			this.anInt6964 = 0;
			this.anInt6963 = 0;
		}
		while (this.anInt6963 < this.aByteArrayArray22.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method5868(this.anInt6963);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt6964;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt6962 - local47) {
					local50 = this.anInt6962 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt6964;
				}
				this.anInt6964 = local47;
			}
			this.anInt6963++;
		}
		...
		return new Class6_Sub12_Sub1(this.anInt6956, local129, this.anInt6954, this.anInt6958, this.aBoolean520);
	}
}
