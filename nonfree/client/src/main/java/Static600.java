...
public final class Static600 {
	...
	@OriginalMember(owner = "client!pp", name = "a", descriptor = "(I[B[IIIIIIIILclient!pp;)I")
	public static int method6406(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class4_Sub7_Sub4 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt7730 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!pp", name = "a", descriptor = "([B[IIIIIIIILclient!pp;)I")
	public static int method6409(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class4_Sub7_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt7724 += arg8.anInt7725 * (local24 - arg3);
		arg8.anInt7731 += arg8.anInt7721 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt7723 = arg4 >> 2;
		arg8.anInt7730 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!pp", name = "a", descriptor = "([B[IIIIIIILclient!pp;)I")
	public static int method6415(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class4_Sub7_Sub4 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt7730 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!pp", name = "b", descriptor = "([B[IIIIIIILclient!pp;)I")
	public static int method6418(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class4_Sub7_Sub4 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!pp", name = "a", descriptor = "(II[B[IIIIIIIILclient!pp;II)I")
	public static int method6420(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub7_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!pp", name = "a", descriptor = "(II[B[IIIIIIILclient!pp;II)I")
	public static int method6421(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class4_Sub7_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!pp", name = "b", descriptor = "([B[IIIIIIIILclient!pp;)I")
	public static int method6423(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class4_Sub7_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt7724 += arg8.anInt7725 * (local22 - arg3);
		arg8.anInt7731 += arg8.anInt7721 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!pp", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!pp;II)I")
	public static int method6424(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class4_Sub7_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt7723 -= arg10.anInt7728 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt7723 += arg10.anInt7728 * local63;
		arg10.anInt7724 = arg4;
		arg10.anInt7731 = arg5;
		arg10.anInt7730 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!pp", name = "b", descriptor = "(I[B[IIIIIIIILclient!pp;)I")
	public static int method6425(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class4_Sub7_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!pp", name = "b", descriptor = "(II[B[IIIIIIIILclient!pp;II)I")
	public static int method6428(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub7_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt7724 -= arg8.anInt7725 * arg3;
		arg8.anInt7731 -= arg8.anInt7721 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!pp", name = "b", descriptor = "(II[B[IIIIIIILclient!pp;II)I")
	public static int method6429(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class4_Sub7_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!pp", name = "a", descriptor = "(Lclient!ep;III)Lclient!pp;")
	public static Class4_Sub7_Sub4 method6430(@OriginalArg(0) Class4_Sub16_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray27 == null || arg0.aByteArray27.length == 0 ? null : new Class4_Sub7_Sub4(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!pp", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!pp;)I")
	public static int method6433(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class4_Sub7_Sub4 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt7723 += arg10.anInt7728 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt7724 = arg4 >> 2;
		arg10.anInt7731 = arg5 >> 2;
		arg10.anInt7730 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!pp", name = "d", descriptor = "(II)I")
	public static int method6436(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!pp", name = "c", descriptor = "(II[B[IIIIIIIILclient!pp;II)I")
	public static int method6437(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub7_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!pp", name = "d", descriptor = "(II[B[IIIIIIIILclient!pp;II)I")
	public static int method6440(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub7_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt7724 -= arg8.anInt7725 * arg3;
		arg8.anInt7731 -= arg8.anInt7721 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!pp", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!pp;)I")
	public static int method6441(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class4_Sub7_Sub4 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt7723 += arg10.anInt7728 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!pp", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!pp;II)I")
	public static int method6442(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class4_Sub7_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt7723 -= arg10.anInt7728 * arg3;
		@Pc(23) int local23;
