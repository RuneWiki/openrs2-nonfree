...
public final class Static600 {
	...
	@OriginalMember(owner = "client!hw", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!hw;)I")
	public static int method3367(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub10_Sub4 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt4051 += arg10.anInt4055 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt4062 = arg4 >> 2;
		arg10.anInt4057 = arg5 >> 2;
		arg10.anInt4060 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!hw", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!hw;II)I")
	public static int method3368(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub10_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt4051 -= arg10.anInt4055 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt4051 += arg10.anInt4055 * local63;
		arg10.anInt4062 = arg4;
		arg10.anInt4057 = arg5;
		arg10.anInt4060 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!hw", name = "a", descriptor = "(II[B[IIIIIIILclient!hw;II)I")
	public static int method3369(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub10_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!hw", name = "a", descriptor = "([B[IIIIIIIILclient!hw;)I")
	public static int method3370(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub10_Sub4 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt4062 += arg8.anInt4058 * (local22 - arg3);
		arg8.anInt4057 += arg8.anInt4059 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt4051 = arg4 >> 2;
		arg8.anInt4060 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!hw", name = "a", descriptor = "(II[B[IIIIIIIILclient!hw;II)I")
	public static int method3371(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub10_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!hw", name = "a", descriptor = "(Lclient!oaa;II)Lclient!hw;")
	public static Class2_Sub10_Sub4 method3373(@OriginalArg(0) Class2_Sub7_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray68 == null || arg0.aByteArray68.length == 0 ? null : new Class2_Sub10_Sub4(arg0, (int) ((long) arg0.anInt6608 * 256L * (long) 100 / (long) (Static162.anInt3474 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!hw", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!hw;II)I")
	public static int method3374(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub10_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt4051 -= arg10.anInt4055 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!hw", name = "b", descriptor = "(II[B[IIIIIIILclient!hw;II)I")
	public static int method3377(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub10_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	public static int method3380(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!hw", name = "a", descriptor = "([B[IIIIIIILclient!hw;)I")
	public static int method3381(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub10_Sub4 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt4060 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!hw", name = "c", descriptor = "(II)I")
	public static int method3391(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!hw", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!hw;)I")
	public static int method3393(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub10_Sub4 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt4051 += arg10.anInt4055 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!hw", name = "b", descriptor = "([B[IIIIIIILclient!hw;)I")
	public static int method3394(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub10_Sub4 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!hw", name = "b", descriptor = "([B[IIIIIIIILclient!hw;)I")
	public static int method3395(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub10_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt4062 += arg8.anInt4058 * (local24 - arg3);
		arg8.anInt4057 += arg8.anInt4059 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!hw", name = "b", descriptor = "(II[B[IIIIIIIILclient!hw;II)I")
	public static int method3396(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub10_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt4062 -= arg8.anInt4058 * arg3;
		arg8.anInt4057 -= arg8.anInt4059 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!hw", name = "a", descriptor = "(I[B[IIIIIIIILclient!hw;)I")
	public static int method3397(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub10_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!hw", name = "a", descriptor = "(Lclient!oaa;III)Lclient!hw;")
	public static Class2_Sub10_Sub4 method3398(@OriginalArg(0) Class2_Sub7_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray68 == null || arg0.aByteArray68.length == 0 ? null : new Class2_Sub10_Sub4(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!hw", name = "c", descriptor = "(II[B[IIIIIIIILclient!hw;II)I")
	public static int method3401(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub10_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!hw", name = "b", descriptor = "(I[B[IIIIIIIILclient!hw;)I")
	public static int method3402(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub10_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!hw", name = "d", descriptor = "(II[B[IIIIIIIILclient!hw;II)I")
