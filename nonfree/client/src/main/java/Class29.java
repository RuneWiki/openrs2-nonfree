...
public final class Class29 {
	...
	@OriginalMember(owner = "client!je", name = "a", descriptor = "(Lclient!eb;)V")
	...
	public int[] method844(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		for (@Pc(1) int local1 = 0; local1 < arg0; local1++) {
			Static50.anIntArray248[local1] = 0;
		}
		if (arg1 < 10) {
			return Static50.anIntArray248;
		}
		...
		for (@Pc(109) int local109 = 0; local109 < 5; local109++) {
			if (this.anIntArray249[local109] != 0) {
				Static50.anIntArray252[local109] = 0;
				Static50.anIntArray253[local109] = (int) ((double) this.anIntArray245[local109] * local23);
				Static50.anIntArray250[local109] = (this.anIntArray249[local109] << 14) / 100;
				Static50.anIntArray251[local109] = (int) ((double) (this.aClass26_5.anInt1084 - this.aClass26_5.anInt1086) * 32.768D * Math.pow(1.0057929410678534D, (double) this.anIntArray255[local109]) / local23);
				Static50.anIntArray254[local109] = (int) ((double) this.aClass26_5.anInt1086 * 32.768D / local23);
			}
		}
		@Pc(189) int local189;
		@Pc(194) int local194;
		...
		for (@Pc(183) int local183 = 0; local183 < arg0; local183++) {
			...
			for (local202 = 0; local202 < 5; local202++) {
				if (this.anIntArray249[local202] != 0) {
					local207 = local183 + Static50.anIntArray253[local202];
					if (local207 < arg0) {
						Static50.anIntArray248[local207] += this.method841(Static50.anIntArray252[local202], local194 * Static50.anIntArray250[local202] >> 15, this.aClass26_5.anInt1085);
						Static50.anIntArray252[local202] += (local189 * Static50.anIntArray251[local202] >> 16) + Static50.anIntArray254[local202];
					}
				}
			}
		}
		...
		if (this.aClass26_7 != null) {
			...
			for (local207 = 0; local207 < arg0; local207++) {
				...
				if (local346) {
					Static50.anIntArray248[local207] = 0;
				}
			}
		}
		if (this.anInt1150 > 0 && this.anInt1148 > 0) {
			...
			for (local194 = local189; local194 < arg0; local194++) {
				Static50.anIntArray248[local194] += Static50.anIntArray248[local194 - local189] * this.anInt1148 / 100;
			}
		}
		if (this.aClass36_1.anIntArray335[0] > 0 || this.aClass36_1.anIntArray335[1] > 0) {
			...
			if (arg0 >= local194 + local202) {
				...
				while (local207 < local354) {
					local359 = (int) ((long) Static50.anIntArray248[local207 + local194] * (long) Static64.anInt1619 >> 16);
					for (local526 = 0; local526 < local194; local526++) {
						local359 += (int) ((long) Static50.anIntArray248[local207 + local194 - local526 - 1] * (long) Static64.anIntArrayArray12[0][local526] >> 16);
					}
					for (local556 = 0; local556 < local207; local556++) {
						local359 -= (int) ((long) Static50.anIntArray248[local207 - local556 - 1] * (long) Static64.anIntArrayArray12[1][local556] >> 16);
					}
					Static50.anIntArray248[local207] = local359;
					local189 = this.aClass26_6.method800(arg0 + 1);
					local207++;
				}
				local354 = 128;
		...
		for (local189 = 0; local189 < arg0; local189++) {
			if (Static50.anIntArray248[local189] < -32768) {
				Static50.anIntArray248[local189] = -32768;
			}
			if (Static50.anIntArray248[local189] > 32767) {
				Static50.anIntArray248[local189] = 32767;
			}
		}
		return Static50.anIntArray248;
	}
