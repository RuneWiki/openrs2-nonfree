...
public final class Class21_Sub21 extends Class21 {
	...
	@OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(Lclient!eha;)V")
	public Class21_Sub21(@OriginalArg(0) Class3_Sub22 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!nu", name = "<init>", descriptor = "(ILclient!eha;)V")
	public Class21_Sub21(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub22 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!nu", name = "d", descriptor = "(II)V")
	@Override
	...
	public void method9235() {
		if (super.aClass3_Sub22_34.aClass21_Sub10_1.method4500() && super.anInt10876 == 2) {
			super.anInt10876 = 1;
		}
