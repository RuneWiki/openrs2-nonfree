...
public final class Class3_Sub28 extends Class3 {
	...
	public Class3_Sub28(@OriginalArg(0) byte[] arg0) {
		this.method4667(arg0);
	}

	@OriginalMember(owner = "client!kba", name = "a", descriptor = "(I)[F")
	private float[] method4663(@OriginalArg(0) int arg0) {
		Static288.method4670(this.aByteArrayArray12[arg0]);
		Static288.method4666();
		@Pc(15) int local15 = Static288.method4671(Static613.method8376(Static288.anIntArray301.length - 1));
		@Pc(19) boolean local19 = Static288.aBooleanArray15[local15];
		@Pc(25) int local25 = local19 ? Static288.anInt5497 : Static288.anInt5499;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static288.method4666() != 0;
			local29 = Static288.method4666() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static288.anInt5499 >> 2);
			local67 = (local25 >> 2) + (Static288.anInt5499 >> 2);
			local71 = Static288.anInt5499 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static288.anInt5499 >> 2);
			local104 = local25 + (Static288.anInt5499 >> 2) - (local25 >> 2);
			local108 = Static288.anInt5499 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class30 local123 = Static288.aClass30Array1[Static288.anIntArray301[local15]];
		@Pc(126) int local126 = local123.anInt555;
		@Pc(131) int local131 = local123.anIntArray44[local126];
		@Pc(140) boolean local140 = !Static288.aClass230Array1[local131].method5842();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt554; local144++) {
			@Pc(152) Class65 local152 = Static288.aClass65Array1[local123.anIntArray43[local144]];
			local154 = Static288.aFloatArray46;
			local152.method1487(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt555;
			local176 = local123.anIntArray44[local171];
			Static288.aClass230Array1[local176].method5848(Static288.aFloatArray46, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static288.aFloatArray46[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static288.aFloatArray46;
			...
			@Pc(252) float[] local252 = local19 ? Static288.aFloatArray51 : Static288.aFloatArray52;
			@Pc(258) float[] local258 = local19 ? Static288.aFloatArray53 : Static288.aFloatArray48;
			@Pc(264) float[] local264 = local19 ? Static288.aFloatArray47 : Static288.aFloatArray50;
			@Pc(270) int[] local270 = local19 ? Static288.anIntArray300 : Static288.anIntArray299;
			...
			@Pc(486) int local486 = Static613.method8376(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static288.aFloatArray46[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static288.aFloatArray46[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt5494 > 0) {
			local176 = this.anInt5494 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean398) {
				for (local212 = 0; local212 < this.anInt5493; local212++) {
					local1254 = (this.anInt5494 >> 1) + local212;
					local1228[local212] += this.aFloatArray49[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static288.aFloatArray46[local212];
				}
			}
		}
		local154 = this.aFloatArray49;
		this.aFloatArray49 = Static288.aFloatArray46;
		Static288.aFloatArray46 = local154;
		this.anInt5494 = local25;
		this.anInt5493 = local104 - (local25 >> 1);
		this.aBoolean398 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!kba", name = "a", descriptor = "([B)V")
	private void method4667(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class3_Sub9 local4 = new Class3_Sub9(arg0);
		this.anInt5501 = local4.method5585();
		this.anInt5498 = local4.method5585();
		this.anInt5500 = local4.method5585();
		this.anInt5495 = local4.method5585();
		if (this.anInt5495 < 0) {
			this.anInt5495 = ~this.anInt5495;
			this.aBoolean397 = true;
		}
		@Pc(40) int local40 = local4.method5585();
		this.aByteArrayArray12 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method5633();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method5577(0, local49, local64);
			this.aByteArrayArray12[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!kba", name = "a", descriptor = "([I)Lclient!wo;")
	public Class3_Sub18_Sub1 method4672(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray46 == null) {
			this.anInt5494 = 0;
			this.aFloatArray49 = new float[Static288.anInt5497];
			this.aByteArray46 = new byte[this.anInt5498];
			this.anInt5503 = 0;
			this.anInt5504 = 0;
		}
		while (this.anInt5504 < this.aByteArrayArray12.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method4663(this.anInt5504);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt5503;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt5498 - local47) {
					local50 = this.anInt5498 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray46[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt5503;
				}
				this.anInt5503 = local47;
			}
			this.anInt5504++;
		}
		this.aFloatArray49 = null;
		@Pc(129) byte[] local129 = this.aByteArray46;
		this.aByteArray46 = null;
		return new Class3_Sub18_Sub1(this.anInt5501, local129, this.anInt5500, this.anInt5495, this.aBoolean397);
	}
}
