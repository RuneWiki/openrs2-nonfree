...
public abstract class Class20 {
	...
	@OriginalMember(owner = "client!ba", name = "a", descriptor = "(ILclient!mn;)Lclient!mn;")
	public abstract Class1_Sub6_Sub2 method3212(@OriginalArg(1) Class1_Sub6_Sub2 arg0);
}
