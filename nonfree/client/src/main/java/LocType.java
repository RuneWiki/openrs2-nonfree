...
public final class LocType extends DoublyLinkable {
	...
	public SoftwareModel method875(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int[][] arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		@Pc(19) long local19;
		...
		@Pc(39) SoftwareModel local39 = (SoftwareModel) Static115.aClass33_31.method998(local19);
		if (local39 == null) {
			@Pc(47) Model local47 = this.method876(arg4, arg1);
			if (local47 == null) {
				return null;
			}
	...
	private Model method876(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		...
		if (this.anIntArray134 == null) {
			...
			for (local46 = 0; local46 < local14; local46++) {
				...
				local7 = (Model) Static96.aClass33_28.method998((long) local134);
				if (local7 == null) {
			...
			if (local14 > 1) {
				local7 = new Model(Static115.aClass4_Sub1_Sub3_Sub4Array1, local14);
			}
		} else {
			@Pc(12) int local12 = -1;
			...
			local7 = (Model) Static96.aClass33_28.method998((long) local46);
			if (local7 == null) {
		...
		@Pc(263) Model local263 = new Model(local7, arg0 == 0 && !local108 && !local232, this.aShortArray6 == null, this.aShortArray7 == null, true);
		if (arg1 == 4 && arg0 > 3) {
			local263.method1535();
	...
	public SoftwareModel method878(@OriginalArg(1) SeqType arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int[][] arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7) {
		...
		@Pc(37) SoftwareModel local37 = (SoftwareModel) Static115.aClass33_31.method998(local13);
		if (local37 == null) {
			@Pc(45) Model local45 = this.method876(arg7, arg2);
			if (local45 == null) {
				return null;
			}
	...
	public Entity method884(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int[][] arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		@Pc(21) long local21;
		if (this.anIntArray134 == null) {
		...
		@Pc(42) Entity local42 = (Entity) Static29.aClass33_10.method998(local21);
		if (local42 == null) {
			@Pc(50) Model local50 = this.method876(arg2, arg5);
			if (local50 == null) {
				return null;
			}
			if (this.aBoolean115) {
		...
		if (this.aBoolean115) {
			local42 = ((Model) local42).method1516();
		}
		if (this.anInt1276 >= 0) {
			if (local42 instanceof SoftwareModel) {
				local42 = ((SoftwareModel) local42).method1478(arg3, arg4, arg1, arg0, true, this.anInt1276);
			} else if (local42 instanceof Model) {
				local42 = ((Model) local42).method1520(arg3, arg4, arg1, arg0, this.anInt1276);
			}
		}
		return local42;
	}
