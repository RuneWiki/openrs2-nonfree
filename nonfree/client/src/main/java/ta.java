...
public final class ta extends Class2 implements Interface18 {
	...
	public ta(@OriginalArg(0) l arg0, @OriginalArg(1) Canvas arg1) {
		...
		this.da(arg0, this.aCanvas11, local7.width, local7.height);
	}

	@OriginalMember(owner = "client!ta", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V")
	public void method6489(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas11.getTreeLock()) {
				...
				Static500.aBoolean674 = false;
			}
		} catch (@Pc(41) Exception local41) {
			this.method6491(local41);
		}
	}
	...
	private void method6491(@OriginalArg(0) Exception arg0) {
		if (!Static500.aBoolean674) {
			Static500.aLong232 = Static362.method5133();
			Static500.aBoolean674 = true;
		} else if (Static362.method5133() - Static500.aLong232 < 30000L) {
