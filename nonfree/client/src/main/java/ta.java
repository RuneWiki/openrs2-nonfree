...
public final class ta extends Class2 implements Interface21 {
	...
	private void method6967(@OriginalArg(0) Exception arg0) {
		if (!Static498.aBoolean651) {
			Static498.aLong230 = Static548.method7437();
			Static498.aBoolean651 = true;
		} else if (Static548.method7437() - Static498.aLong230 < 30000L) {
	...
	public void method6968(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas13.getTreeLock()) {
				...
				Static498.aBoolean651 = false;
			}
		} catch (@Pc(41) Exception local41) {
			this.method6967(local41);
		}
	}
