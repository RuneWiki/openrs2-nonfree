...
public final class ta extends Class3 implements Interface16 {
	...
	public void method6731() {
		try {
			synchronized (this.aCanvas10.getTreeLock()) {
				this.H();
				Static499.aBoolean624 = false;
			}
		} catch (@Pc(16) Exception local16) {
			this.method6732(local16);
		}
	}

	@OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/Exception;)V")
	private void method6732(@OriginalArg(0) Exception arg0) {
		if (!Static499.aBoolean624) {
			Static499.aLong236 = Static158.method2936();
			Static499.aBoolean624 = true;
		} else if (Static158.method2936() - Static499.aLong236 < 30000L) {
	...
	public void method6734(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas10.getTreeLock()) {
