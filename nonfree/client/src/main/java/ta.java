...
public final class ta extends Class1 implements Interface19 {
	...
	public void method6946(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas12.getTreeLock()) {
				...
				Static497.aBoolean606 = false;
			}
		} catch (@Pc(41) Exception local41) {
			this.method6948(local41);
		}
	}
	...
	public void method6947() {
		try {
			...
			this.method6948(local16);
		}
	}

	@OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/Exception;)V")
	private void method6948(@OriginalArg(0) Exception arg0) {
		if (!Static497.aBoolean606) {
			Static497.aLong367 = Static255.method4035();
			Static497.aBoolean606 = true;
		} else if (Static255.method4035() - Static497.aLong367 < 30000L) {
