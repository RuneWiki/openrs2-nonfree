...
public final class ta extends Class3 implements Interface17 {
	...
	public void method6748(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas10.getTreeLock()) {
				...
				Static502.aBoolean583 = false;
			}
		} catch (@Pc(41) Exception local41) {
			this.method6751(local41);
		}
	}
	...
	public void method6750() {
		try {
			...
			this.method6751(local16);
		}
	}

	@OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/Exception;)V")
	private void method6751(@OriginalArg(0) Exception arg0) {
		if (!Static502.aBoolean583) {
			Static502.aLong230 = Static96.method2000();
			Static502.aBoolean583 = true;
		} else if (Static96.method2000() - Static502.aLong230 < 30000L) {
