...
public final class ta extends Class1 implements Interface19 {
	...
	public void method6762(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas10.getTreeLock()) {
				...
				Static493.aBoolean621 = false;
			}
		} catch (@Pc(41) Exception local41) {
			this.method6763(local41);
		}
	}
	...
	private void method6763(@OriginalArg(0) Exception arg0) {
		if (!Static493.aBoolean621) {
			Static493.aLong228 = Static480.method6650();
			Static493.aBoolean621 = true;
		} else if (Static480.method6650() - Static493.aLong228 < 30000L) {
