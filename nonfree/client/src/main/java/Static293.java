...
public final class Static293 {
	...
	public static int anInt5275 = 256;

	@OriginalMember(owner = "client!wh", name = "J", descriptor = "I")
	public static int anInt5276 = 256;
	...
	public static int anInt5280 = -1;

	@OriginalMember(owner = "client!wh", name = "O", descriptor = "I")
	public static int anInt5281 = 0;

	@OriginalMember(owner = "client!wh", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/String;")
	public static String method4172(@OriginalArg(0) String arg0) {
	...
	@OriginalMember(owner = "client!wh", name = "a", descriptor = "([[B[[B[I[I[III)I")
	public static int method4193(@OriginalArg(0) byte[][] arg0, @OriginalArg(1) byte[][] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
