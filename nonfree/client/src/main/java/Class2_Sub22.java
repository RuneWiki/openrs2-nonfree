...
public final class Class2_Sub22 extends Class2 {
	...
	private void method4246(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub11 local4 = new Class2_Sub11(arg0);
		this.anInt4924 = local4.method8381();
		this.anInt4926 = local4.method8381();
		this.anInt4929 = local4.method8381();
		this.anInt4927 = local4.method8381();
		if (this.anInt4927 < 0) {
			this.anInt4927 = ~this.anInt4927;
			this.aBoolean369 = true;
		}
		@Pc(40) int local40 = local4.method8381();
		this.aByteArrayArray12 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method8383();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method8385(0, local49, local64);
			this.aByteArrayArray12[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!hp", name = "a", descriptor = "([I)Lclient!ob;")
	public Class2_Sub29_Sub1 method4250(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray62 == null) {
			this.anInt4933 = 0;
			this.aFloatArray42 = new float[Static220.anInt4928];
			this.aByteArray62 = new byte[this.anInt4926];
			this.anInt4935 = 0;
			this.anInt4934 = 0;
		}
		while (this.anInt4934 < this.aByteArrayArray12.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method4253(this.anInt4934);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt4935;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt4926 - local47) {
					local50 = this.anInt4926 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray62[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt4935;
				}
				this.anInt4935 = local47;
			}
			this.anInt4934++;
		}
		this.aFloatArray42 = null;
		@Pc(129) byte[] local129 = this.aByteArray62;
		this.aByteArray62 = null;
		return new Class2_Sub29_Sub1(this.anInt4924, local129, this.anInt4929, this.anInt4927, this.aBoolean369);
	}

	@OriginalMember(owner = "client!hp", name = "d", descriptor = "(I)[F")
	private float[] method4253(@OriginalArg(0) int arg0) {
		Static220.method4243(this.aByteArrayArray12[arg0]);
		Static220.method4247();
		@Pc(15) int local15 = Static220.method4248(Static627.method7088(Static220.anIntArray249.length - 1));
		@Pc(19) boolean local19 = Static220.aBooleanArray12[local15];
		@Pc(25) int local25 = local19 ? Static220.anInt4928 : Static220.anInt4930;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static220.method4247() != 0;
			local29 = Static220.method4247() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static220.anInt4930 >> 2);
			local67 = (local25 >> 2) + (Static220.anInt4930 >> 2);
			local71 = Static220.anInt4930 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static220.anInt4930 >> 2);
			local104 = local25 + (Static220.anInt4930 >> 2) - (local25 >> 2);
			local108 = Static220.anInt4930 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class353 local123 = Static220.aClass353Array1[Static220.anIntArray249[local15]];
		@Pc(126) int local126 = local123.anInt10442;
		@Pc(131) int local131 = local123.anIntArray674[local126];
		@Pc(140) boolean local140 = !Static220.aClass299Array1[local131].method7640();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt10441; local144++) {
			@Pc(152) Class88 local152 = Static220.aClass88Array1[local123.anIntArray673[local144]];
			local154 = Static220.aFloatArray43;
			local152.method2930(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt10442;
			local176 = local123.anIntArray674[local171];
			Static220.aClass299Array1[local176].method7636(Static220.aFloatArray43, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static220.aFloatArray43[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static220.aFloatArray43;
			...
			@Pc(252) float[] local252 = local19 ? Static220.aFloatArray45 : Static220.aFloatArray47;
			@Pc(258) float[] local258 = local19 ? Static220.aFloatArray48 : Static220.aFloatArray46;
			@Pc(264) float[] local264 = local19 ? Static220.aFloatArray41 : Static220.aFloatArray44;
			@Pc(270) int[] local270 = local19 ? Static220.anIntArray248 : Static220.anIntArray250;
			...
			@Pc(486) int local486 = Static627.method7088(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static220.aFloatArray43[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static220.aFloatArray43[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt4933 > 0) {
			local176 = this.anInt4933 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean367) {
				for (local212 = 0; local212 < this.anInt4931; local212++) {
					local1254 = (this.anInt4933 >> 1) + local212;
					local1228[local212] += this.aFloatArray42[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static220.aFloatArray43[local212];
				}
			}
		}
		local154 = this.aFloatArray42;
		this.aFloatArray42 = Static220.aFloatArray43;
		Static220.aFloatArray43 = local154;
		this.anInt4933 = local25;
		this.anInt4931 = local104 - (local25 >> 1);
