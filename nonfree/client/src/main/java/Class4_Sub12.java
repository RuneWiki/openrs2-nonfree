...
public final class Class4_Sub12 extends Class4 {
	...
	@OriginalMember(owner = "client!ee", name = "a", descriptor = "([I)Lclient!tk;")
	public Class4_Sub42_Sub1 method2116(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray19 == null) {
			this.anInt2640 = 0;
			this.aFloatArray33 = new float[Static116.anInt2646];
			this.aByteArray19 = new byte[this.anInt2641];
			this.anInt2651 = 0;
			this.anInt2650 = 0;
		}
		while (this.anInt2650 < this.aByteArrayArray11.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method2121(this.anInt2650);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2651;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt2641 - local47) {
					local50 = this.anInt2641 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray19[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2651;
				}
				this.anInt2651 = local47;
			}
			this.anInt2650++;
		}
		this.aFloatArray33 = null;
		@Pc(129) byte[] local129 = this.aByteArray19;
		this.aByteArray19 = null;
		return new Class4_Sub42_Sub1(this.anInt2644, local129, this.anInt2645, this.anInt2647, this.aBoolean206);
	}

	@OriginalMember(owner = "client!ee", name = "a", descriptor = "([B)V")
	private void method2117(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class4_Sub13 local4 = new Class4_Sub13(arg0);
		this.anInt2644 = local4.method6990();
		this.anInt2641 = local4.method6990();
		this.anInt2645 = local4.method6990();
		this.anInt2647 = local4.method6990();
		if (this.anInt2647 < 0) {
			this.anInt2647 = ~this.anInt2647;
			this.aBoolean206 = true;
		}
		@Pc(40) int local40 = local4.method6990();
		this.aByteArrayArray11 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method7004();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method7049(local64, local49);
			this.aByteArrayArray11[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!ee", name = "c", descriptor = "(I)[F")
	private float[] method2121(@OriginalArg(0) int arg0) {
		Static116.method2119(this.aByteArrayArray11[arg0]);
		Static116.method2125();
		@Pc(15) int local15 = Static116.method2115(Static507.method7317(Static116.anIntArray122.length - 1));
		@Pc(19) boolean local19 = Static116.aBooleanArray4[local15];
		@Pc(25) int local25 = local19 ? Static116.anInt2646 : Static116.anInt2649;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static116.method2125() != 0;
			local29 = Static116.method2125() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static116.anInt2649 >> 2);
			local67 = (local25 >> 2) + (Static116.anInt2649 >> 2);
			local71 = Static116.anInt2649 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static116.anInt2649 >> 2);
			local104 = local25 + (Static116.anInt2649 >> 2) - (local25 >> 2);
			local108 = Static116.anInt2649 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class313 local123 = Static116.aClass313Array1[Static116.anIntArray122[local15]];
		@Pc(126) int local126 = local123.anInt9415;
		@Pc(131) int local131 = local123.anIntArray536[local126];
		@Pc(140) boolean local140 = !Static116.aClass147Array1[local131].method3442();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt9414; local144++) {
			@Pc(152) Class355 local152 = Static116.aClass355Array1[local123.anIntArray537[local144]];
			local154 = Static116.aFloatArray31;
			local152.method8110(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt9415;
			local176 = local123.anIntArray536[local171];
			Static116.aClass147Array1[local176].method3443(Static116.aFloatArray31, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static116.aFloatArray31[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static116.aFloatArray31;
			...
			@Pc(252) float[] local252 = local19 ? Static116.aFloatArray32 : Static116.aFloatArray29;
			@Pc(258) float[] local258 = local19 ? Static116.aFloatArray34 : Static116.aFloatArray28;
			@Pc(264) float[] local264 = local19 ? Static116.aFloatArray30 : Static116.aFloatArray27;
			@Pc(270) int[] local270 = local19 ? Static116.anIntArray124 : Static116.anIntArray123;
			...
			@Pc(486) int local486 = Static507.method7317(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static116.aFloatArray31[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static116.aFloatArray31[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt2640 > 0) {
			local176 = this.anInt2640 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean204) {
				for (local212 = 0; local212 < this.anInt2648; local212++) {
					local1254 = (this.anInt2640 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static116.aFloatArray31[local212];
				}
			}
		}
		local154 = this.aFloatArray33;
		this.aFloatArray33 = Static116.aFloatArray31;
		Static116.aFloatArray31 = local154;
		this.anInt2640 = local25;
		this.anInt2648 = local104 - (local25 >> 1);
		this.aBoolean204 = local140;
		return local1228;
	}
}
