...
public final class Class14_Sub25 extends Class14 {
	...
	@OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(ILclient!dh;)V")
	public Class14_Sub25(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub13 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(Lclient!dh;)V")
	public Class14_Sub25(@OriginalArg(0) Class2_Sub13 arg0) {
		super(arg0);
	}
	...
	public int method9033(@OriginalArg(1) int arg0) {
		if (super.aClass2_Sub13_31.method2603()) {
			return 3;
		} else if (arg0 == 0 || super.aClass2_Sub13_31.aClass14_Sub17_1.method5998() == 1) {
			return 1;
		} else {
			return 2;
		}
