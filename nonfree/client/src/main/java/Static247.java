...
public final class Static247 {
	...
	public static int[] anIntArray508 = new int[1];
	...
	public static short[] method3897(@OriginalArg(0) short[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) short[] local2 = new short[arg1];
		Static316.method78(arg0, 0, local2, 0, arg1);
		return local2;
	}

	@OriginalMember(owner = "client!s", name = "a", descriptor = "(ISIB)I")
	public static int method3900(@OriginalArg(0) int arg0, @OriginalArg(1) short arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		@Pc(5) int local5 = Static158.anIntArray295[Static180.method2925(arg0, arg2)];
		if (arg1 != -1) {
			@Pc(15) int local15 = Static158.anInterface5_1.method450(arg1 & 0xFFFF);
			@Pc(21) int local21;
			@Pc(44) int local44;
			if (local15 != 0) {
				if (arg2 < 0) {
			...
			local21 = Static158.anInterface5_1.method447(arg1 & 0xFFFF);
			if (local21 != 0) {
				local21 += 256;
	...
	public static float[] method3901(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6) {
	...
	public static void method3908(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) float arg7, @OriginalArg(8) int arg8, @OriginalArg(9) float arg9) {
		@Pc(3) int local3 = arg0 - arg3;
		@Pc(7) int local7 = arg1 - arg4;
		@Pc(11) int local11 = arg2 - arg5;
	...
	public static void method3911(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) int arg7, @OriginalArg(8) float arg8) {
		@Pc(3) int local3 = arg0 - arg3;
		@Pc(7) int local7 = arg1 - arg4;
		@Pc(11) int local11 = arg2 - arg5;
		@Pc(32) float local32 = (float) local3 * arg6[0] + (float) local7 * arg6[1] + (float) local11 * arg6[2];
	...
	public static float[] method3912(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) float[] local2 = new float[arg1];
		Static316.method77(arg0, 0, local2, 0, arg1);
		return local2;
	}

	@OriginalMember(owner = "client!s", name = "y", descriptor = "()V")
	public static void method3913() {
		aClass53_Sub4_Sub2_1 = new Class53_Sub4_Sub2();
		aClass53_Sub4_Sub2_2 = new Class53_Sub4_Sub2();
		aClass53_Sub4_Sub2_3 = new Class53_Sub4_Sub2();
		aClass53_Sub4_Sub2_4 = new Class53_Sub4_Sub2();
		aClass53_Sub4_Sub2_5 = new Class53_Sub4_Sub2();
		aClass53_Sub4_Sub2_6 = new Class53_Sub4_Sub2();
	}

	@OriginalMember(owner = "client!s", name = "a", descriptor = "(FFF)I")
	public static int method3914(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
