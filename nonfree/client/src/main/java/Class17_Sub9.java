...
public final class Class17_Sub9 extends Class17 {
	...
	@OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lclient!es;)V")
	public Class17_Sub9(@OriginalArg(0) Class5_Sub19 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(ILclient!es;)V")
	public Class17_Sub9(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub19 arg1) {
		super(arg0, arg1);
	}
	...
	protected int method9173() {
		return super.aClass5_Sub19_31.method2551() ? 1 : 0;
	}
