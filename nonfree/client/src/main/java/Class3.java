...
public final class Class3 {
	...
	public Class3(@OriginalArg(0) int arg0, @OriginalArg(1) RandomAccessFile arg1, @OriginalArg(2) int arg2, @OriginalArg(3) RandomAccessFile arg3, @OriginalArg(4) boolean arg4) {
		try {
			this.anInt9 = arg2;
			...
			signlink.reporterror("52705, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + arg4 + ", " + local30.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!BCXJTIWC", name = "a", descriptor = "(IB)[B")
	public synchronized byte[] method15(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		try {
			@Pc(6) boolean local6 = false;
			try {
				this.method18(arg0 * 6, this.aRandomAccessFile2);
				@Pc(21) int local21;
				@Pc(32) int local32;
				...
				if (local32 < 0 || local32 > this.anInt10) {
					return null;
					...
					while (local114 < local32) {
						...
						this.method18(local88 * 520, this.aRandomAccessFile1);
						local21 = 0;
						...
						if (local154 == arg0 && local196 == local116 && local224 == this.anInt9) {
			...
			signlink.reporterror("92134, " + arg0 + ", " + arg1 + ", " + local278.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!BCXJTIWC", name = "a", descriptor = "([BIII)Z")
	public synchronized boolean method16(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
		try {
			@Pc(7) boolean local7 = this.method17(arg2, arg1, arg0, true);
			if (!local7) {
				local7 = this.method17(arg2, arg1, arg0, false);
			}
			return local7;
		} catch (@Pc(30) RuntimeException local30) {
			signlink.reporterror("4582, " + arg0 + ", " + arg1 + ", " + 6 + ", " + arg2 + ", " + local30.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!BCXJTIWC", name = "a", descriptor = "(IZI[BZ)Z")
	private synchronized boolean method17(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) byte[] arg2, @OriginalArg(4) boolean arg3) {
		try {
			try {
				@Pc(68) int local68;
				@Pc(23) int local23;
				@Pc(34) int local34;
				if (arg3) {
					this.method18(arg1 * 6, this.aRandomAccessFile2);
				...
				aByteArray2[0] = (byte) (arg0 >> 16);
				aByteArray2[1] = (byte) (arg0 >> 8);
				aByteArray2[2] = (byte) arg0;
				...
				while (local23 < arg0) {
					...
					@Pc(166) int local166;
					if (arg3) {
						this.method18(local68 * 520, this.aRandomAccessFile1);
						@Pc(177) int local177;
						...
						if (local166 == 8) {
							...
							if (local177 != arg1 || local218 != local34 || local246 != this.anInt9) {
								return false;
							}
					...
					aByteArray2[0] = (byte) (arg1 >> 8);
					aByteArray2[1] = (byte) arg1;
					...
					aByteArray2[7] = (byte) this.anInt9;
					this.method18(local68 * 520, this.aRandomAccessFile1);
			...
			signlink.reporterror("66203, " + arg0 + ", " + true + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + local392.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!BCXJTIWC", name = "a", descriptor = "(ILjava/io/RandomAccessFile;B)V")
	private synchronized void method18(@OriginalArg(0) int arg0, @OriginalArg(1) RandomAccessFile arg1) throws IOException {
		try {
			...
			signlink.reporterror("55103, " + arg0 + ", " + arg1 + ", " + 58 + ", " + local42.toString());
			throw new RuntimeException();
		}
	}
}
