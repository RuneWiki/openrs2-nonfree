...
public final class Class3 {
	...
	public static void method30(@OriginalArg(0) Class39 arg0) {
		aClass1_Sub3_Sub3_2 = new Class1_Sub3_Sub3(363, arg0.method536("npc.dat", null));
		@Pc(21) Class1_Sub3_Sub3 local21 = new Class1_Sub3_Sub3(363, arg0.method536("npc.idx", null));
	...
	public static void method31() {
		try {
			...
			signlink.reporterror("32991, " + true + ", " + local18.toString());
	...
	private void method33(@OriginalArg(1) Class1_Sub3_Sub3 arg0) {
		try {
			while (true) {
			...
			signlink.reporterror("30732, " + false + ", " + arg0 + ", " + local277.toString());
			throw new RuntimeException();
		}
	}
	...
	public Class1_Sub3_Sub1 method34(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2) {
		...
		if (local9 == null) {
			...
			aClass35_3.method528(this.aLong5, local9);
		}
	...
	public Class1_Sub3_Sub1 method35() {
		try {
			...
			signlink.reporterror("86097, " + false + ", " + local82.toString());
			throw new RuntimeException();
		}
	}
}
