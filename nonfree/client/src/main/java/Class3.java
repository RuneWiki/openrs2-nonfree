...
public final class Class3 {
	...
	private void exit() {
		...
		this.method24((Frame) null);
	}

	@OriginalMember(owner = "client!ab", name = "a", descriptor = "(ILjava/awt/Frame;)V")
	private void method24(@OriginalArg(1) Frame arg0) {
	...
	private void enter(@OriginalArg(0) Frame arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (arg4 == 0) {
			...
			for (@Pc(35) int local35 = 0; local35 < local31.length; local35++) {
				if (local31[local35].getWidth() == arg1 && local31[local35].getHeight() == arg2 && arg3 == local31[local35].getBitDepth()) {
					@Pc(62) int local62 = local31[local35].getRefreshRate();
					if (!local33 || Math.abs(local62 - local27) < Math.abs(arg4 - local27)) {
						arg4 = local62;
						local33 = true;
					}
				}
