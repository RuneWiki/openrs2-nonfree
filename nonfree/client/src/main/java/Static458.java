...
public final class Static458 {
	...
	@OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lclient!bq;II)Lclient!gn;")
	public static Class3_Sub5_Sub2 method2085(@OriginalArg(0) Class3_Sub6_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray16 == null || arg0.aByteArray16.length == 0 ? null : new Class3_Sub5_Sub2(arg0, (int) ((long) arg0.anInt1042 * 256L * (long) 100 / (long) (Static232.anInt4442 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!gn", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!gn;)I")
	public static int method2086(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub5_Sub2 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt2807 += arg10.anInt2810 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt2812 = arg4 >> 2;
		arg10.anInt2802 = arg5 >> 2;
		arg10.anInt2813 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!gn", name = "a", descriptor = "(I[B[IIIIIIIILclient!gn;)I")
	public static int method2087(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub5_Sub2 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt2813 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!gn", name = "a", descriptor = "(II[B[IIIIIIIILclient!gn;II)I")
	public static int method2089(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub5_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!gn", name = "b", descriptor = "(I[B[IIIIIIIILclient!gn;)I")
	public static int method2091(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub5_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!gn", name = "a", descriptor = "([B[IIIIIIIILclient!gn;)I")
	public static int method2093(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub5_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt2812 += arg8.anInt2805 * (local24 - arg3);
		arg8.anInt2802 += arg8.anInt2804 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt2807 = arg4 >> 2;
		arg8.anInt2813 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!gn", name = "a", descriptor = "(II[B[IIIIIIILclient!gn;II)I")
	public static int method2094(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub5_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!gn", name = "b", descriptor = "([B[IIIIIIIILclient!gn;)I")
	public static int method2099(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub5_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt2812 += arg8.anInt2805 * (local22 - arg3);
		arg8.anInt2802 += arg8.anInt2804 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!gn", name = "a", descriptor = "(Lclient!bq;III)Lclient!gn;")
	public static Class3_Sub5_Sub2 method2104(@OriginalArg(0) Class3_Sub6_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray16 == null || arg0.aByteArray16.length == 0 ? null : new Class3_Sub5_Sub2(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!gn", name = "b", descriptor = "(II[B[IIIIIIIILclient!gn;II)I")
	public static int method2105(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub5_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt2812 -= arg8.anInt2805 * arg3;
		arg8.anInt2802 -= arg8.anInt2804 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!gn", name = "a", descriptor = "([B[IIIIIIILclient!gn;)I")
	public static int method2106(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub5_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt2813 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!gn", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!gn;II)I")
	public static int method2108(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub5_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt2807 -= arg10.anInt2810 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt2807 += arg10.anInt2810 * local63;
		arg10.anInt2812 = arg4;
		arg10.anInt2802 = arg5;
		arg10.anInt2813 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!gn", name = "b", descriptor = "(II)I")
	public static int method2110(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!gn", name = "b", descriptor = "([B[IIIIIIILclient!gn;)I")
	public static int method2111(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub5_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	public static int method2116(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!gn", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!gn;II)I")
	public static int method2118(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub5_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt2807 -= arg10.anInt2810 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!gn", name = "b", descriptor = "(II[B[IIIIIIILclient!gn;II)I")
	public static int method2120(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub5_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!gn", name = "c", descriptor = "(II[B[IIIIIIIILclient!gn;II)I")
	public static int method2122(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub5_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt2812 -= arg8.anInt2805 * arg3;
		arg8.anInt2802 -= arg8.anInt2804 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!gn", name = "d", descriptor = "(II[B[IIIIIIIILclient!gn;II)I")
	public static int method2123(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub5_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!gn", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!gn;)I")
	public static int method2124(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub5_Sub2 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt2807 += arg10.anInt2810 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
