...
public final class Static269 {
	...
	public static int method1385(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub4_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		...
		local63 = arg3 >> 1;
		arg10.anInt1943 += arg10.anInt1954 * local63;
		arg10.anInt1949 = arg4;
		arg10.anInt1955 = arg5;
		arg10.anInt1947 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!fi", name = "a", descriptor = "(II[B[IIIIIIILclient!fi;II)I")
	public static int method1388(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub4_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!fi", name = "a", descriptor = "(I[B[IIIIIIIILclient!fi;)I")
	public static int method1390(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub4_Sub3 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt1947 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!fi", name = "a", descriptor = "(II[B[IIIIIIIILclient!fi;II)I")
	public static int method1394(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub4_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1949 -= arg8.anInt1953 * arg3;
		arg8.anInt1955 -= arg8.anInt1944 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!fi", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!fi;)I")
	public static int method1395(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub4_Sub3 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt1943 += arg10.anInt1954 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt1949 = arg4 >> 2;
		arg10.anInt1955 = arg5 >> 2;
		arg10.anInt1947 = arg2 << 8;
		return arg3 >> 1;
	}
	...
	@OriginalMember(owner = "client!fi", name = "a", descriptor = "([B[IIIIIIILclient!fi;)I")
	public static int method1397(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub4_Sub3 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt1947 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!fi", name = "a", descriptor = "([B[IIIIIIIILclient!fi;)I")
	public static int method1398(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub4_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1949 += arg8.anInt1953 * (local22 - arg3);
		arg8.anInt1955 += arg8.anInt1944 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt1943 = arg4 >> 2;
		arg8.anInt1947 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!fi", name = "b", descriptor = "([B[IIIIIIIILclient!fi;)I")
	public static int method1399(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub4_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1949 += arg8.anInt1953 * (local24 - arg3);
		arg8.anInt1955 += arg8.anInt1944 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!fi", name = "b", descriptor = "(II[B[IIIIIIIILclient!fi;II)I")
	public static int method1403(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub4_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1949 -= arg8.anInt1953 * arg3;
		arg8.anInt1955 -= arg8.anInt1944 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!fi", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!fi;)I")
	public static int method1404(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub4_Sub3 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt1943 += arg10.anInt1954 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!fi", name = "c", descriptor = "(II[B[IIIIIIIILclient!fi;II)I")
	public static int method1405(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub4_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!fi", name = "b", descriptor = "([B[IIIIIIILclient!fi;)I")
	public static int method1407(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub4_Sub3 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lclient!ec;II)Lclient!fi;")
	public static Class1_Sub4_Sub3 method1408(@OriginalArg(0) Class1_Sub7_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray21 == null || arg0.aByteArray21.length == 0 ? null : new Class1_Sub4_Sub3(arg0, (int) ((long) arg0.anInt1534 * 256L * (long) 100 / (long) (Static107.anInt2862 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!fi", name = "d", descriptor = "(II[B[IIIIIIIILclient!fi;II)I")
	public static int method1415(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub4_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!fi", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!fi;II)I")
	public static int method1416(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub4_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1943 -= arg10.anInt1954 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!fi", name = "b", descriptor = "(I[B[IIIIIIIILclient!fi;)I")
	public static int method1417(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub4_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lclient!ec;III)Lclient!fi;")
	public static Class1_Sub4_Sub3 method1420(@OriginalArg(0) Class1_Sub7_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray21 == null || arg0.aByteArray21.length == 0 ? null : new Class1_Sub4_Sub3(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!fi", name = "b", descriptor = "(II[B[IIIIIIILclient!fi;II)I")
	public static int method1424(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub4_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
