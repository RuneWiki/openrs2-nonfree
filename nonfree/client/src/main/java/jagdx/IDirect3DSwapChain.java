...
public final class IDirect3DSwapChain extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "b", descriptor = "Lclient!jaclib/peer/er;")
	private final er b;

	@OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "<init>", descriptor = "(Lclient!jaclib/peer/er;)V")
	public IDirect3DSwapChain(@OriginalArg(0) er arg0) {
		super(arg0);
		this.b = arg0;
	}
	...
	public IDirect3DSurface a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (wd.a(local11, (byte) 78)) {
			throw new tha(String.valueOf(local11));
		}
		return local5;
	}
}
