...
public final class IDirect3DSwapChain extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "b", descriptor = "Lclient!jaclib/peer/io;")
	private final io b;

	@OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "<init>", descriptor = "(Lclient!jaclib/peer/io;)V")
	public IDirect3DSwapChain(@OriginalArg(0) io arg0) {
		super(arg0);
		this.b = arg0;
	}
	...
	public IDirect3DSurface a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (ck.b(local11, -2005530585)) {
			throw new wea(String.valueOf(local11));
		}
		return local5;
	}
