...
public final class IDirect3DSwapChain extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "b", descriptor = "Lclient!jaclib/peer/ca;")
	private final ca b;

	@OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "<init>", descriptor = "(Lclient!jaclib/peer/ca;)V")
	public IDirect3DSwapChain(@OriginalArg(0) ca arg0) {
		super(arg0);
		this.b = arg0;
	}
