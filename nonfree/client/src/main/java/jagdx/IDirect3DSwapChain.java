...
public final class IDirect3DSwapChain extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "b", descriptor = "Lclient!jaclib/peer/bea;")
	private final bea b;

	@OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "<init>", descriptor = "(Lclient!jaclib/peer/bea;)V")
	public IDirect3DSwapChain(@OriginalArg(0) bea arg0) {
		super(arg0);
		this.b = arg0;
	}
	...
	public IDirect3DSurface a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (nba.a(local11, (int) -120)) {
			throw new sh(String.valueOf(local11));
		}
		return local5;
	}
}
