...
public final class IDirect3DSwapChain extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "b", descriptor = "Lclient!jaclib/peer/cv;")
	private final cv b;

	@OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "<init>", descriptor = "(Lclient!jaclib/peer/cv;)V")
	public IDirect3DSwapChain(@OriginalArg(0) cv arg0) {
		super(arg0);
		this.b = arg0;
	}
	...
	public IDirect3DSurface a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (qc.a(local11, -2005530517)) {
			throw new kh(String.valueOf(local11));
		}
		return local5;
	}
