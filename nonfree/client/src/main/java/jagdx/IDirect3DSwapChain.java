...
public final class IDirect3DSwapChain extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "b", descriptor = "Lclient!jaclib/peer/aaa;")
	private final aaa b;

	@OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "<init>", descriptor = "(Lclient!jaclib/peer/aaa;)V")
	public IDirect3DSwapChain(@OriginalArg(0) aaa arg0) {
		super(arg0);
		this.b = arg0;
	}
	...
	public IDirect3DSurface a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (sw.a((int) local11, -92)) {
			throw new pea(String.valueOf(local11));
		}
		return local5;
	}
}
