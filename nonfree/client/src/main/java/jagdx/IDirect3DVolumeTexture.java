...
public final class IDirect3DVolumeTexture extends IDirect3DBaseTexture {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DVolumeTexture", name = "<init>", descriptor = "(Lclient!jaclib/peer/hb;)V")
	public IDirect3DVolumeTexture(@OriginalArg(0) hb arg0) {
		super(arg0);
	}
