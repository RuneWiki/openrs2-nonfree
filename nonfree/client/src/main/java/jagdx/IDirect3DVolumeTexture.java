...
public final class IDirect3DVolumeTexture extends IDirect3DBaseTexture {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DVolumeTexture", name = "<init>", descriptor = "(Lclient!jaclib/peer/hk;)V")
	public IDirect3DVolumeTexture(@OriginalArg(0) hk arg0) {
		super(arg0);
	}
