...
public final class IDirect3DVolumeTexture extends IDirect3DBaseTexture {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DVolumeTexture", name = "<init>", descriptor = "(Lclient!jaclib/peer/hr;)V")
	public IDirect3DVolumeTexture(@OriginalArg(0) hr arg0) {
		super(arg0);
	}
