...
public final class IDirect3DVertexBuffer extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/bd;)V")
	public IDirect3DVertexBuffer(@OriginalArg(0) bd arg0) {
		super(arg0);
	}
