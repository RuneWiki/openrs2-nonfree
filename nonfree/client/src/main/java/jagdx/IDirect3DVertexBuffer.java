...
public final class IDirect3DVertexBuffer extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/pb;)V")
	public IDirect3DVertexBuffer(@OriginalArg(0) pb arg0) {
		super(arg0);
	}
