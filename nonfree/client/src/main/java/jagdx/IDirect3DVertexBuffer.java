...
public final class IDirect3DVertexBuffer extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/dba;)V")
	public IDirect3DVertexBuffer(@OriginalArg(0) dba arg0) {
		super(arg0);
	}
