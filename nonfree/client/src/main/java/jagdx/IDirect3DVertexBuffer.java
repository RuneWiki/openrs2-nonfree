...
public final class IDirect3DVertexBuffer extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/ik;)V")
	public IDirect3DVertexBuffer(@OriginalArg(0) ik arg0) {
		super(arg0);
	}
