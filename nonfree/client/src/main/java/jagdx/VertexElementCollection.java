...
public final class VertexElementCollection extends tk {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/cv;)V")
	public VertexElementCollection(@OriginalArg(0) cv arg0) {
		super(arg0);
		this.init();
	}
