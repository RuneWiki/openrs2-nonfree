...
public final class VertexElementCollection extends ma {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/qd;)V")
	public VertexElementCollection(@OriginalArg(0) qd arg0) {
		super(arg0);
		this.init();
	}
