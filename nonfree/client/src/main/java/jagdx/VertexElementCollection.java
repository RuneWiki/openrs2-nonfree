...
public final class VertexElementCollection extends eb {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/ow;)V")
	public VertexElementCollection(@OriginalArg(0) ow arg0) {
		super(arg0);
		this.init();
	}
