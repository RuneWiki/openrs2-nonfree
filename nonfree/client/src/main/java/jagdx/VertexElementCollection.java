...
public final class VertexElementCollection extends jl {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/qr;)V")
	public VertexElementCollection(@OriginalArg(0) qr arg0) {
		super(arg0);
		this.init();
	}
