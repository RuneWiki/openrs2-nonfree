...
public final class VertexElementCollection extends pr {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/uca;)V")
	public VertexElementCollection(@OriginalArg(0) uca arg0) {
		super(arg0);
		this.init();
	}
