...
public final class VertexElementCollection extends rn {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/pba;)V")
	public VertexElementCollection(@OriginalArg(0) pba arg0) {
		super(arg0);
		this.init();
	}
