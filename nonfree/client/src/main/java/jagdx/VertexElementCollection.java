...
public final class VertexElementCollection extends jj {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/in;)V")
	public VertexElementCollection(@OriginalArg(0) in arg0) {
		super(arg0);
		this.init();
	}
