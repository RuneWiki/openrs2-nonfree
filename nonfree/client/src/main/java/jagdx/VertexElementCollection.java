...
public final class VertexElementCollection extends mf {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/io;)V")
	public VertexElementCollection(@OriginalArg(0) io arg0) {
		super(arg0);
		this.init();
	}
