...
public final class VertexElementCollection extends qu {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/naa;)V")
	public VertexElementCollection(@OriginalArg(0) naa arg0) {
		super(arg0);
		this.init();
	}
