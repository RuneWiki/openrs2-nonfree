...
public final class VertexElementCollection extends dh {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/hk;)V")
	public VertexElementCollection(@OriginalArg(0) hk arg0) {
		super(arg0);
		this.init();
	}
