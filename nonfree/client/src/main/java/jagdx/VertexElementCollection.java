...
public final class VertexElementCollection extends jc {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/jd;)V")
	public VertexElementCollection(@OriginalArg(0) jd arg0) {
		super(arg0);
		this.init();
	}
