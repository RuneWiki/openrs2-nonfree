...
public final class VertexElementCollection extends uo {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/ep;)V")
	public VertexElementCollection(@OriginalArg(0) ep arg0) {
		super(arg0);
		this.init();
	}
