...
public final class VertexElementCollection extends pn {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/k;)V")
	public VertexElementCollection(@OriginalArg(0) k arg0) {
		super(arg0);
		this.init();
	}
