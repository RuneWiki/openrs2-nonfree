...
public final class VertexElementCollection extends qp {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/pi;)V")
	public VertexElementCollection(@OriginalArg(0) pi arg0) {
		super(arg0);
		this.init();
	}
