...
public final class VertexElementCollection extends nn {
	...
	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/dq;)V")
	public VertexElementCollection(@OriginalArg(0) dq arg0) {
		super(arg0);
		this.init();
	}
