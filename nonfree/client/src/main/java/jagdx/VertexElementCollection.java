...
public final class VertexElementCollection extends ih {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/er;)V")
	public VertexElementCollection(@OriginalArg(0) er arg0) {
		super(arg0);
		this.init();
	}
