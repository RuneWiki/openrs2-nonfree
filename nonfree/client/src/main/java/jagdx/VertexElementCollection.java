...
public final class VertexElementCollection extends fe {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/ca;)V")
	public VertexElementCollection(@OriginalArg(0) ca arg0) {
		super(arg0);
		this.init();
	}
