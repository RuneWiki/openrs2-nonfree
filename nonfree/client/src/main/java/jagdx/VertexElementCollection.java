...
public final class VertexElementCollection extends cha {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/vv;)V")
	public VertexElementCollection(@OriginalArg(0) vv arg0) {
		super(arg0);
		this.init();
	}
