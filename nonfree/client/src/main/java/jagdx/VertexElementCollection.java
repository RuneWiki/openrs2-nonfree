...
public final class VertexElementCollection extends nn {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/iw;)V")
	public VertexElementCollection(@OriginalArg(0) iw arg0) {
		super(arg0);
		this.init();
	}
