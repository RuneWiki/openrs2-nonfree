...
public final class VertexElementCollection extends ni {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/ik;)V")
	public VertexElementCollection(@OriginalArg(0) ik arg0) {
		super(arg0);
		this.init();
	}
