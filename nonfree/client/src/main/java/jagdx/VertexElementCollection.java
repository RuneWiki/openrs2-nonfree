...
public final class VertexElementCollection extends gga {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/ku;)V")
	public VertexElementCollection(@OriginalArg(0) ku arg0) {
		super(arg0);
		this.init();
	}
