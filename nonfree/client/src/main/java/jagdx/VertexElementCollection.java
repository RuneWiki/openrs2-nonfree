...
public final class VertexElementCollection extends qla {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/bu;)V")
	public VertexElementCollection(@OriginalArg(0) bu arg0) {
		super(arg0);
		this.init();
	}
