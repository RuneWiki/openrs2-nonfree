...
public final class VertexElementCollection extends jfa {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/vo;)V")
	public VertexElementCollection(@OriginalArg(0) vo arg0) {
		super(arg0);
		this.init();
	}
