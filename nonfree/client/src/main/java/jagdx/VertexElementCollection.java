...
public final class VertexElementCollection extends uda {
	...
	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/hb;)V")
	public VertexElementCollection(@OriginalArg(0) hb arg0) {
		super(arg0);
		this.init();
	}
