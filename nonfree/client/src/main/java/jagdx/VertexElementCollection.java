...
public final class VertexElementCollection extends ab {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/tc;)V")
	public VertexElementCollection(@OriginalArg(0) tc arg0) {
		super(arg0);
		this.init();
	}
