...
public final class VertexElementCollection extends dea {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/aaa;)V")
	public VertexElementCollection(@OriginalArg(0) aaa arg0) {
		super(arg0);
		this.init();
	}
