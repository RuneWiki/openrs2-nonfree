...
public final class VertexElementCollection extends md {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/mba;)V")
	public VertexElementCollection(@OriginalArg(0) mba arg0) {
		super(arg0);
		this.init();
	}
