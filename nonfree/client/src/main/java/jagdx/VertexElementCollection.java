...
public final class VertexElementCollection extends ik {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/jv;)V")
	public VertexElementCollection(@OriginalArg(0) jv arg0) {
		super(arg0);
		this.init();
	}
