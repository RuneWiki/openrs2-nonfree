...
public final class VertexElementCollection extends gd {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/dj;)V")
	public VertexElementCollection(@OriginalArg(0) dj arg0) {
		super(arg0);
		this.init();
	}
