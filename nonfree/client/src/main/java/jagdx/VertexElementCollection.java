...
public final class VertexElementCollection extends mh {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/rh;)V")
	public VertexElementCollection(@OriginalArg(0) rh arg0) {
		super(arg0);
		this.init();
	}
