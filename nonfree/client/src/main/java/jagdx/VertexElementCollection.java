...
public final class VertexElementCollection extends mfa {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/jaa;)V")
	public VertexElementCollection(@OriginalArg(0) jaa arg0) {
		super(arg0);
		this.init();
	}
