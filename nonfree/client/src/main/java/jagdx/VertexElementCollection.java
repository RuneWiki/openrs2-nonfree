...
public final class VertexElementCollection extends qs {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/gca;)V")
	public VertexElementCollection(@OriginalArg(0) gca arg0) {
		super(arg0);
		this.init();
	}
