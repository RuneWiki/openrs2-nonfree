...
public final class VertexElementCollection extends gs {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/pe;)V")
	public VertexElementCollection(@OriginalArg(0) pe arg0) {
		super(arg0);
		this.init();
	}
