...
public final class VertexElementCollection extends mw {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/bea;)V")
	public VertexElementCollection(@OriginalArg(0) bea arg0) {
		super(arg0);
		this.init();
	}
