...
public final class VertexElementCollection extends ad {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/hea;)V")
	public VertexElementCollection(@OriginalArg(0) hea arg0) {
		super(arg0);
		this.init();
	}
