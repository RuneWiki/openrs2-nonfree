...
public final class VertexElementCollection extends uca {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/wf;)V")
	public VertexElementCollection(@OriginalArg(0) wf arg0) {
		super(arg0);
		this.init();
	}
