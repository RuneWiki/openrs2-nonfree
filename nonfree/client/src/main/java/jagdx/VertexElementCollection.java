...
public final class VertexElementCollection extends ii {

	@OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Lclient!jaclib/peer/of;)V")
	public VertexElementCollection(@OriginalArg(0) of arg0) {
		super(arg0);
		this.init();
	}
