...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Lclient!jaclib/peer/tc;")
	private final tc b;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/tc;)V")
	public IDirect3DDevice(@OriginalArg(0) tc arg0) {
		super(arg0);
		this.b = arg0;
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (qi.a((int) local21, 0)) {
			throw new hba(String.valueOf(local21));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DVertexShader a(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(9) IDirect3DVertexShader local9 = new IDirect3DVertexShader(this.b);
		@Pc(14) int local14 = this._CreateVertexShader(arg0, local9);
		if (qi.a((int) local14, 0)) {
			throw new hba(String.valueOf(local14));
		}
		return local9;
	}
	...
	public IDirect3DSurface b() {
		...
		if (qi.a((int) local9, 0)) {
			throw new hba(String.valueOf(local9));
		}
		return local5;
	}
	...
	public IDirect3DSwapChain c(@OriginalArg(0) int arg0) {
		...
		if (qi.a((int) local10, 0)) {
			throw new hba(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DIndexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DIndexBuffer arg4) {
		...
		if (qi.a((int) local20, 0)) {
			throw new hba(String.valueOf(local20));
		}
		return arg4;
	}
	...
	public IDirect3DTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		if (qi.a((int) local15, 0)) {
			throw new hba(String.valueOf(local15));
		}
		return local5;
	}
	...
	public IDirect3DPixelShader b(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(11) IDirect3DPixelShader local11 = new IDirect3DPixelShader(this.b);
		@Pc(16) int local16 = this._CreatePixelShader(arg0, local11);
		if (qi.a((int) local16, 0)) {
			throw new hba(String.valueOf(local16));
		}
		return local11;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (qi.a((int) local18, 0)) {
			throw new hba(String.valueOf(local18));
		}
		return arg1;
	}
	...
	public IDirect3DEventQuery c() {
		...
		if (qi.a((byte) 35, this._CreateEventQuery(local5))) {
			return local5.a(28436) ? local5 : null;
		} else {
			return null;
		}
	}
