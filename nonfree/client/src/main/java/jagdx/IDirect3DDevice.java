...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Lclient!jaclib/peer/wf;")
	private final wf c;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/wf;)V")
	public IDirect3DDevice(@OriginalArg(0) wf arg0) {
		super(arg0);
		this.c = arg0;
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (op.a((byte) -114, local21)) {
			throw new ln(String.valueOf(local21));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DVolumeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (op.a((byte) -120, local16)) {
			throw new ln(String.valueOf(local16));
		}
		return local5;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (op.a((byte) -90, local18)) {
			throw new ln(String.valueOf(local18));
		}
		return arg1;
	}
	...
	public IDirect3DCubeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (op.a((byte) -111, local14)) {
			throw new ln(String.valueOf(local14));
		}
		return local5;
	}
	...
	public IDirect3DSurface c(@OriginalArg(0) int arg0) {
		...
		if (op.a((byte) -99, local10)) {
			throw new ln(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DSurface b() {
		...
		if (op.a((byte) -59, local9)) {
			throw new ln(String.valueOf(local9));
		}
		return local5;
	}
	...
	public IDirect3DSurface a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		...
		if (op.a((byte) -63, local15)) {
			throw new ln(String.valueOf(local15));
		}
		return local5;
	}
	...
	public IDirect3DEventQuery c() {
		...
		if (op.a(this._CreateEventQuery(local5), (byte) -101)) {
			return local5.a(32422) ? local5 : null;
		} else {
			return null;
		}
	}
