...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Lclient!jaclib/peer/pe;")
	private final pe c;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/pe;)V")
	public IDirect3DDevice(@OriginalArg(0) pe arg0) {
		super(arg0);
		this.c = arg0;
	}
	...
	public IDirect3DEventQuery c() {
		...
		if (dt.a(this._CreateEventQuery(local5), -2005530590)) {
			return local5.a(20969) ? local5 : null;
		} else {
			return null;
		}
	}
