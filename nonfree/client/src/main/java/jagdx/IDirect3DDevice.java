...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Lclient!jaclib/peer/vo;")
	private final vo b;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/vo;)V")
	public IDirect3DDevice(@OriginalArg(0) vo arg0) {
		super(arg0);
		this.b = arg0;
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (te.a((byte) 112, local21)) {
			throw new gh(String.valueOf(local21));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DSurface b() {
		...
		if (te.a((byte) 112, local9)) {
			throw new gh(String.valueOf(local9));
		}
		return local5;
	}
	...
	public IDirect3DSurface a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		...
		if (te.a((byte) 112, local15)) {
			throw new gh(String.valueOf(local15));
		}
		return local5;
	}
	...
	public IDirect3DSwapChain b(@OriginalArg(0) int arg0) {
		...
		if (te.a((byte) 112, local10)) {
			throw new gh(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (te.a((byte) 112, local17)) {
			throw new gh(String.valueOf(local17));
		}
		return arg1;
	}
	...
	public IDirect3DCubeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (te.a((byte) 112, local14)) {
			throw new gh(String.valueOf(local14));
		}
		return local5;
	}
	...
	public IDirect3DEventQuery c() {
		...
		if (te.a(2005530599, this._CreateEventQuery(local5))) {
			return local5.a(4211) ? local5 : null;
		} else {
			return null;
		}
	}
	...
	public IDirect3DVertexShader a(@OriginalArg(0) byte[] arg0) {
		...
		if (te.a((byte) 112, local16)) {
			throw new gh(String.valueOf(local16));
		}
		return local11;
	}
	...
	public IDirect3DIndexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DIndexBuffer arg4) {
		...
		if (te.a((byte) 112, local20)) {
			throw new gh(String.valueOf(local20));
		}
		return arg4;
	}
