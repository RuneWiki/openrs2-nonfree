...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Lclient!jaclib/peer/jv;")
	private final jv b;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/jv;)V")
	public IDirect3DDevice(@OriginalArg(0) jv arg0) {
		super(arg0);
		this.b = arg0;
	}
	...
	public IDirect3DVertexShader a(@OriginalArg(0) byte[] arg0) {
		...
		if (bea.b(local15, -24)) {
			throw new pq(String.valueOf(local15));
		}
		return local10;
	}
	...
	public IDirect3DSurface b(@OriginalArg(0) int arg0) {
		...
		if (bea.b(local10, -123)) {
			throw new pq(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DCubeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (bea.b(local14, -67)) {
			throw new pq(String.valueOf(local14));
		}
		return local5;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (bea.b(local17, -125)) {
			throw new pq(String.valueOf(local17));
		}
		return arg1;
	}
	...
	public IDirect3DSurface b() {
		...
		if (bea.b(local9, -50)) {
			throw new pq(String.valueOf(local9));
		}
		return local5;
	}
	...
	public IDirect3DIndexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DIndexBuffer arg4) {
		...
		if (bea.b(local21, -33)) {
			throw new pq(String.valueOf(local21));
		}
		return arg4;
	}
	...
	public IDirect3DEventQuery c() {
		...
		if (bea.a(-87, this._CreateEventQuery(local5))) {
			return local5.a(-16960) ? local5 : null;
		} else {
			return null;
		}
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (bea.b(local20, -31)) {
			throw new pq(String.valueOf(local20));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DVolumeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (bea.b(local16, -20)) {
			throw new pq(String.valueOf(local16));
		}
		return local5;
	}
