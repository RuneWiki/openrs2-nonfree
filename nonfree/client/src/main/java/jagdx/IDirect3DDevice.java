...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Lclient!jaclib/peer/bea;")
	private final bea c;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/bea;)V")
	public IDirect3DDevice(@OriginalArg(0) bea arg0) {
		super(arg0);
		this.c = arg0;
	}
	...
	public IDirect3DSurface b() {
		...
		if (nba.a(local9, (int) 110)) {
			throw new sh(String.valueOf(local9));
		}
		return local5;
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (nba.a(local21, (int) -79)) {
			throw new sh(String.valueOf(local21));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DVolumeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (nba.a(local16, (int) 120)) {
			throw new sh(String.valueOf(local16));
		}
		return local5;
	}
	...
	public IDirect3DSurface a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		...
		if (nba.a(local15, (int) -82)) {
			throw new sh(String.valueOf(local15));
		}
		return local5;
	}
	...
	public IDirect3DSwapChain c(@OriginalArg(0) int arg0) {
		...
		if (nba.a(local10, (int) 70)) {
			throw new sh(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (nba.a(local18, (int) 83)) {
			throw new sh(String.valueOf(local18));
		}
		return arg1;
	}
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "d", descriptor = "(I)Lclient!jagdx/IDirect3DSurface;")
	public IDirect3DSurface d(@OriginalArg(0) int arg0) {
		@Pc(5) IDirect3DSurface local5 = new IDirect3DSurface(this.c);
		@Pc(10) int local10 = this._GetRenderTarget(arg0, local5);
		if (nba.a(local10, (int) 82)) {
			throw new sh(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DCubeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (nba.a(local14, (int) 84)) {
			throw new sh(String.valueOf(local14));
		}
		return local5;
	}
	...
	public IDirect3DEventQuery c() {
		...
		if (nba.a(this._CreateEventQuery(local5), (byte) -105)) {
			return local5.a(-90) ? local5 : null;
		} else {
			return null;
		}
	}
