...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Lclient!jaclib/peer/bu;")
	private final bu b;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/bu;)V")
	public IDirect3DDevice(@OriginalArg(0) bu arg0) {
		super(arg0);
		this.b = arg0;
	}
	...
	public IDirect3DIndexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DIndexBuffer arg4) {
		...
		if (fma.a(local20, (int) 0)) {
			throw new oia(String.valueOf(local20));
		}
		return arg4;
	}
	...
	public IDirect3DSurface b() {
		...
		if (fma.a(local9, (int) 0)) {
			throw new oia(String.valueOf(local9));
		}
		return local5;
	}
	...
	public IDirect3DSwapChain c(@OriginalArg(0) int arg0) {
		...
		if (fma.a(local10, (int) 0)) {
			throw new oia(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DEventQuery c() {
		...
		if (fma.a(this._CreateEventQuery(local5), (byte) 125)) {
			return local5.a(-23073) ? local5 : null;
		} else {
			return null;
		}
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (fma.a(local17, (int) 0)) {
			throw new oia(String.valueOf(local17));
		}
		return arg1;
	}
	...
	public IDirect3DTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		if (fma.a(local15, (int) 0)) {
			throw new oia(String.valueOf(local15));
		}
		return local5;
	}
	...
	public IDirect3DVertexShader b(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(12) IDirect3DVertexShader local12 = new IDirect3DVertexShader(this.b);
		@Pc(17) int local17 = this._CreateVertexShader(arg0, local12);
		if (fma.a(local17, (int) 0)) {
			throw new oia(String.valueOf(local17));
		}
		return local12;
	...
	public IDirect3DCubeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (fma.a(local14, (int) 0)) {
			throw new oia(String.valueOf(local14));
		}
		return local5;
	}
	...
	public IDirect3DVolumeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (fma.a(local16, (int) 0)) {
			throw new oia(String.valueOf(local16));
		}
		return local5;
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (fma.a(local22, (int) 0)) {
			throw new oia(String.valueOf(local22));
		}
		arg4.b = arg0;
		return arg4;
	}
