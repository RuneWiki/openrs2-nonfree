...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "p", descriptor = "(JIF)I", line = 139)
	public static int method27700(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2) {
		return SetRenderStatef(arg0, arg1, arg2);
	}

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "v", descriptor = "(JIF)I", line = 139)
	public static int method27701(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2) {
		return SetRenderStatef(arg0, arg1, arg2);
	}

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "l", descriptor = "(JIF)I", line = 139)
	public static int method27702(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2) {
		return SetRenderStatef(arg0, arg1, arg2);
	}

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "y", descriptor = "(JIF)I", line = 139)
	public static int method27703(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2) {
		return SetRenderStatef(arg0, arg1, arg2);
	}

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "(JIZ)I", line = 143)
	public static int method27704(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		return SetRenderStateb(arg0, arg1, arg2);
	}

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "w", descriptor = "(JIZ)I", line = 143)
	public static int method27705(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		return SetRenderStateb(arg0, arg1, arg2);
	}

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "t", descriptor = "(JIZ)I", line = 143)
	public static int method27706(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		return SetRenderStateb(arg0, arg1, arg2);
	}
