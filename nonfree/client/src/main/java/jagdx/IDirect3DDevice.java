...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Lclient!jaclib/peer/wl;")
	private final wl c;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/wl;)V")
	public IDirect3DDevice(@OriginalArg(0) wl arg0) {
		super(arg0);
		this.c = arg0;
	}
	...
	public IDirect3DVolumeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (gfa.a(local16, (byte) 54)) {
			throw new dga(String.valueOf(local16));
		}
		return local5;
	}
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I)Lclient!jagdx/IDirect3DSwapChain;")
	public IDirect3DSwapChain a(@OriginalArg(0) int arg0) {
		@Pc(5) IDirect3DSwapChain local5 = new IDirect3DSwapChain(this.c);
		@Pc(10) int local10 = this._GetSwapChain(arg0, local5);
		if (gfa.a(local10, (byte) 50)) {
			throw new dga(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DVertexShader a(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(9) IDirect3DVertexShader local9 = new IDirect3DVertexShader(this.c);
		@Pc(14) int local14 = this._CreateVertexShader(arg0, local9);
		if (gfa.a(local14, (byte) 126)) {
			throw new dga(String.valueOf(local14));
		}
		return local9;
	}
	...
	public IDirect3DSurface a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		...
		if (gfa.a(local15, (byte) 122)) {
			throw new dga(String.valueOf(local15));
		}
		return local5;
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		@Pc(20) int local20 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
		if (gfa.a(local20, (byte) 70)) {
			throw new dga(String.valueOf(local20));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DEventQuery b() {
		...
		if (gfa.a(this._CreateEventQuery(local5), (int) 10067)) {
			return local5.a((byte) 51) ? local5 : null;
		} else {
			return null;
		}
	}
	...
	public IDirect3DSurface c() {
		...
		if (gfa.a(local9, (byte) 33)) {
			throw new dga(String.valueOf(local9));
		}
		return local5;
	}
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(I)Lclient!jagdx/IDirect3DSurface;")
	public IDirect3DSurface b(@OriginalArg(0) int arg0) {
		@Pc(5) IDirect3DSurface local5 = new IDirect3DSurface(this.c);
		@Pc(10) int local10 = this._GetRenderTarget(arg0, local5);
		if (gfa.a(local10, (byte) 55)) {
			throw new dga(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		@Pc(18) int local18 = this._CreateVertexDeclaration(arg0, arg1);
		if (gfa.a(local18, (byte) 77)) {
			throw new dga(String.valueOf(local18));
		}
		return arg1;
	}
