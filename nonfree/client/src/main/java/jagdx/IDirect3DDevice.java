...
public final class IDirect3DDevice extends IUnknown {
	...
	public static int method27712(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2) {
		return SetRenderStatef(arg0, arg1, arg2);
	}

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "n", descriptor = "(JIZ)I", line = 143)
	public static int method27710(@OriginalArg(0) long arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
