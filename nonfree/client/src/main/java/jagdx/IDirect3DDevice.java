...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Lclient!jaclib/peer/ep;")
	private final ep c;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/ep;)V")
	public IDirect3DDevice(@OriginalArg(0) ep arg0) {
		super(arg0);
		this.c = arg0;
	}
	...
	public IDirect3DVolumeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (vq.a(local16, -2420)) {
			throw new mm(String.valueOf(local16));
		}
		return local5;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (vq.a(local18, -2420)) {
			throw new mm(String.valueOf(local18));
		}
		return arg1;
	}
	...
	public IDirect3DPixelShader a(@OriginalArg(0) byte[] arg0) {
		...
		if (vq.a(local14, -2420)) {
			throw new mm(String.valueOf(local14));
		}
		return local9;
	}
	...
	public IDirect3DSurface a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		...
		if (vq.a(local15, -2420)) {
			throw new mm(String.valueOf(local15));
		}
		return local5;
	}
	...
	public IDirect3DSurface b(@OriginalArg(0) int arg0) {
		...
		if (vq.a(local10, -2420)) {
			throw new mm(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DIndexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DIndexBuffer arg4) {
		...
		if (vq.a(local20, -2420)) {
			throw new mm(String.valueOf(local20));
		}
		return arg4;
	}
	...
	public IDirect3DEventQuery b() {
		...
		if (vq.b(-2005530516, this._CreateEventQuery(local5))) {
			return local5.a(-27169) ? local5 : null;
		} else {
			return null;
		}
	}
	...
	public IDirect3DSurface c() {
		...
		if (vq.a(local9, -2420)) {
			throw new mm(String.valueOf(local9));
		}
		return local5;
	}
