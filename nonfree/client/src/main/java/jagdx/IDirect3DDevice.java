...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Lclient!jaclib/peer/ge;")
	private final ge b;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/ge;)V")
	public IDirect3DDevice(@OriginalArg(0) ge arg0) {
		super(arg0);
		this.b = arg0;
	}
	...
	public IDirect3DEventQuery b() {
		...
		if (ud.a(0, (int) this._CreateEventQuery(local5))) {
			return local5.a((byte) -91) ? local5 : null;
		} else {
			return null;
		}
	}
	...
	public IDirect3DVolumeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (ud.a(local16, (byte) -100)) {
			throw new hl(String.valueOf(local16));
		}
		return local5;
	}
	...
	public IDirect3DPixelShader a(@OriginalArg(0) byte[] arg0) {
		...
		if (ud.a(local15, (byte) -100)) {
			throw new hl(String.valueOf(local15));
		}
		return local10;
	}
	...
	public IDirect3DCubeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (ud.a(local14, (byte) -100)) {
			throw new hl(String.valueOf(local14));
		}
		return local5;
	}
	...
	public IDirect3DSurface a(@OriginalArg(0) int arg0) {
		...
		if (ud.a(local10, (byte) -100)) {
			throw new hl(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (ud.a(local17, (byte) -100)) {
			throw new hl(String.valueOf(local17));
		}
		return arg1;
	}
	...
	public IDirect3DSurface c() {
		...
		if (ud.a(local9, (byte) -100)) {
			throw new hl(String.valueOf(local9));
		}
		return local5;
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (ud.a(local20, (byte) -100)) {
			throw new hl(String.valueOf(local20));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DIndexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DIndexBuffer arg4) {
		...
		if (ud.a(local21, (byte) -100)) {
			throw new hl(String.valueOf(local21));
		}
		return arg4;
	}
