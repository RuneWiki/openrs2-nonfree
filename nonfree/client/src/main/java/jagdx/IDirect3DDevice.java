...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Lclient!jaclib/peer/dq;")
	private final dq b;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/dq;)V")
	public IDirect3DDevice(@OriginalArg(0) dq arg0) {
		super(arg0);
		this.b = arg0;
	}
	...
	public IDirect3DSwapChain b(@OriginalArg(0) int arg0) {
		...
		if (uo.a(local10, (byte) 121)) {
			throw new ct(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DSurface c() {
		...
		if (uo.a(local9, (byte) 118)) {
			throw new ct(String.valueOf(local9));
		}
		return local5;
	}
	...
	public IDirect3DVertexShader a(@OriginalArg(0) byte[] arg0) {
		...
		if (uo.a(local15, (byte) 119)) {
			throw new ct(String.valueOf(local15));
		}
		return local10;
	}
	...
	public IDirect3DEventQuery b() {
		...
		if (uo.a(this._CreateEventQuery(local5), true)) {
			return local5.a((byte) -121) ? local5 : null;
		} else {
			return null;
		}
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (uo.a(local22, (byte) 126)) {
			throw new ct(String.valueOf(local22));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DIndexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DIndexBuffer arg4) {
		...
		if (uo.a(local21, (byte) 126)) {
			throw new ct(String.valueOf(local21));
		}
		return arg4;
	}
	...
	public IDirect3DCubeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (uo.a(local14, (byte) 127)) {
			throw new ct(String.valueOf(local14));
		}
		return local5;
	}
	...
	public IDirect3DVolumeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (uo.a(local16, (byte) 124)) {
			throw new ct(String.valueOf(local16));
		}
		return local5;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (uo.a(local17, (byte) 122)) {
			throw new ct(String.valueOf(local17));
		}
		return arg1;
	}
