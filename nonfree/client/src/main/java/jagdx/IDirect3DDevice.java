...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Lclient!jaclib/peer/ks;")
	private final ks b;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/ks;)V")
	public IDirect3DDevice(@OriginalArg(0) ks arg0) {
		super(arg0);
		this.b = arg0;
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (hia.a(local22, (int) -91)) {
			throw new efa(String.valueOf(local22));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DSwapChain c(@OriginalArg(0) int arg0) {
		...
		if (hia.a(local10, (int) 33)) {
			throw new efa(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (hia.a(local17, (int) 40)) {
			throw new efa(String.valueOf(local17));
		}
		return arg1;
	}
	...
	public IDirect3DEventQuery b() {
		...
		if (hia.a(this._CreateEventQuery(local5), (byte) -123)) {
			return local5.a(21164) ? local5 : null;
		} else {
			return null;
		}
	}
	...
	public IDirect3DVertexShader a(@OriginalArg(0) byte[] arg0) {
		...
		if (hia.a(local16, (int) 44)) {
			throw new efa(String.valueOf(local16));
		}
		return local11;
	}
	...
	public IDirect3DCubeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (hia.a(local14, (int) 73)) {
			throw new efa(String.valueOf(local14));
		}
		return local5;
	}
	...
	public IDirect3DIndexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DIndexBuffer arg4) {
		...
		if (hia.a(local20, (int) 36)) {
			throw new efa(String.valueOf(local20));
		}
		return arg4;
	}
	...
	public IDirect3DTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		if (hia.a(local15, (int) 44)) {
			throw new efa(String.valueOf(local15));
		}
		return local5;
	}
	...
	public IDirect3DPixelShader b(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(12) IDirect3DPixelShader local12 = new IDirect3DPixelShader(this.b);
		@Pc(17) int local17 = this._CreatePixelShader(arg0, local12);
		if (hia.a(local17, (int) 63)) {
			throw new efa(String.valueOf(local17));
		}
		return local12;
	}
	...
	public IDirect3DSurface c() {
		...
		if (hia.a(local9, (int) -91)) {
			throw new efa(String.valueOf(local9));
		}
		return local5;
	}
