...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Lclient!jaclib/peer/jd;")
	private final jd b;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/jd;)V")
	public IDirect3DDevice(@OriginalArg(0) jd arg0) {
		super(arg0);
		this.b = arg0;
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (eo.b(local20, -1)) {
			throw new eea(String.valueOf(local20));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (eo.b(local18, -1)) {
			throw new eea(String.valueOf(local18));
		}
		return arg1;
	}
	...
	public IDirect3DPixelShader a(@OriginalArg(0) byte[] arg0) {
		...
		if (eo.b(local15, -1)) {
			throw new eea(String.valueOf(local15));
		}
		return local10;
	}
	...
	public IDirect3DEventQuery b() {
		...
		if (eo.a(96, this._CreateEventQuery(local5))) {
			return local5.a((byte) 35) ? local5 : null;
		} else {
			return null;
		}
	}
	...
	public IDirect3DSwapChain a(@OriginalArg(0) int arg0) {
		...
		if (eo.b(local10, -1)) {
			throw new eea(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DVolumeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (eo.b(local16, -1)) {
			throw new eea(String.valueOf(local16));
		}
		return local5;
	}
	...
	public IDirect3DSurface c() {
		...
		if (eo.b(local9, -1)) {
			throw new eea(String.valueOf(local9));
		}
		return local5;
	}
	...
	public IDirect3DCubeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (eo.b(local14, -1)) {
			throw new eea(String.valueOf(local14));
		}
		return local5;
	}
