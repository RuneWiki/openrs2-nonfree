...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Lclient!jaclib/peer/ca;")
	private final ca b;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/ca;)V")
	public IDirect3DDevice(@OriginalArg(0) ca arg0) {
		super(arg0);
		this.b = arg0;
	}
	...
	public IDirect3DEventQuery c() {
		...
		if (vba.a(-1, (int) this._CreateEventQuery(local5))) {
			return local5.a(-89) ? local5 : null;
		} else {
			return null;
		}
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (vba.a(local17, (byte) -90)) {
			throw new iba(String.valueOf(local17));
		}
		return arg1;
	}
