...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Lclient!jaclib/peer/dba;")
	private final dba c;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/dba;)V")
	public IDirect3DDevice(@OriginalArg(0) dba arg0) {
		super(arg0);
		this.c = arg0;
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (saa.a(local21, (byte) 84)) {
			throw new mc(String.valueOf(local21));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DSwapChain b(@OriginalArg(0) int arg0) {
		...
		if (saa.a(local10, (byte) 84)) {
			throw new mc(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DSurface a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		...
		if (saa.a(local15, (byte) 84)) {
			throw new mc(String.valueOf(local15));
		}
		return local5;
	}
	...
	public IDirect3DCubeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (saa.a(local14, (byte) 84)) {
			throw new mc(String.valueOf(local14));
		}
		return local5;
	}
	...
	public IDirect3DVolumeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (saa.a(local16, (byte) 84)) {
			throw new mc(String.valueOf(local16));
		}
		return local5;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (saa.a(local18, (byte) 84)) {
			throw new mc(String.valueOf(local18));
		}
		return arg1;
	}
	...
	public IDirect3DSurface b() {
		...
		if (saa.a(local9, (byte) 84)) {
			throw new mc(String.valueOf(local9));
		}
		return local5;
	}
	...
	public IDirect3DEventQuery c() {
		...
		if (saa.b(this._CreateEventQuery(local5), (byte) 116)) {
			return local5.a(false) ? local5 : null;
		} else {
			return null;
		}
	}
