...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Lclient!jaclib/peer/pi;")
	private final pi b;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/pi;)V")
	public IDirect3DDevice(@OriginalArg(0) pi arg0) {
		super(arg0);
		this.b = arg0;
	}
	...
	public IDirect3DIndexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DIndexBuffer arg4) {
		...
		if (js.a(local21, 0)) {
			throw new lg(String.valueOf(local21));
		}
		return arg4;
	}
	...
	public IDirect3DTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		if (js.a(local15, 0)) {
			throw new lg(String.valueOf(local15));
		}
		return local5;
	}
	...
	public IDirect3DCubeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (js.a(local14, 0)) {
			throw new lg(String.valueOf(local14));
		}
		return local5;
	}
	...
	public IDirect3DSurface b() {
		...
		if (js.a(local9, 0)) {
			throw new lg(String.valueOf(local9));
		}
		return local5;
	}
	...
	public IDirect3DSurface b(@OriginalArg(0) int arg0) {
		...
		if (js.a(local10, 0)) {
			throw new lg(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DVertexShader b(@OriginalArg(0) byte[] arg0) {
		...
		if (js.a(local16, 0)) {
			throw new lg(String.valueOf(local16));
		}
		return local11;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (js.a(local18, 0)) {
			throw new lg(String.valueOf(local18));
		}
		return arg1;
	}
	...
	public IDirect3DEventQuery c() {
		...
		if (js.b(this._CreateEventQuery(local5), 141953135)) {
			return local5.a(-8954) ? local5 : null;
		} else {
			return null;
		}
	}
