...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Lclient!jaclib/peer/bw;")
	private final bw c;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/bw;)V")
	public IDirect3DDevice(@OriginalArg(0) bw arg0) {
		super(arg0);
		this.c = arg0;
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (hc.a((byte) 121, local20)) {
			throw new jia(String.valueOf(local20));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (hc.a((byte) -85, local17)) {
			throw new jia(String.valueOf(local17));
		}
		return arg1;
	}
	...
	public IDirect3DEventQuery b() {
		...
		if (hc.a(this._CreateEventQuery(local5), true)) {
			return local5.a(true) ? local5 : null;
		} else {
			return null;
		}
	}
	...
	public IDirect3DSurface c(@OriginalArg(0) int arg0) {
		...
		if (hc.a((byte) -36, local10)) {
			throw new jia(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DSurface c() {
		...
		if (hc.a((byte) -89, local9)) {
			throw new jia(String.valueOf(local9));
		}
		return local5;
	}
	...
	public IDirect3DSurface a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		...
		if (hc.a((byte) -98, local15)) {
			throw new jia(String.valueOf(local15));
		}
		return local5;
	}
	...
	public IDirect3DPixelShader b(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(11) IDirect3DPixelShader local11 = new IDirect3DPixelShader(this.c);
		@Pc(16) int local16 = this._CreatePixelShader(arg0, local11);
		if (hc.a((byte) 110, local16)) {
			throw new jia(String.valueOf(local16));
		}
		return local11;
	}
	...
	public IDirect3DCubeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (hc.a((byte) 103, local14)) {
			throw new jia(String.valueOf(local14));
		}
		return local5;
	}
