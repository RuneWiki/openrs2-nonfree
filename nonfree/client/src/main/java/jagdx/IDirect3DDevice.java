...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Lclient!jaclib/peer/rh;")
	private final rh c;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/rh;)V")
	public IDirect3DDevice(@OriginalArg(0) rh arg0) {
		super(arg0);
		this.c = arg0;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (ec.b(local18, -15560)) {
			throw new rl(String.valueOf(local18));
		}
		return arg1;
	}
	...
	public IDirect3DSurface a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		...
		if (ec.b(local15, -15560)) {
			throw new rl(String.valueOf(local15));
		}
		return local5;
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (ec.b(local20, -15560)) {
			throw new rl(String.valueOf(local20));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DEventQuery b() {
		...
		if (ec.a(this._CreateEventQuery(local5), 2005530520)) {
			return local5.a((byte) -124) ? local5 : null;
		} else {
			return null;
		}
	}
	...
	public IDirect3DVolumeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (ec.b(local16, -15560)) {
			throw new rl(String.valueOf(local16));
		}
		return local5;
	}
	...
	public IDirect3DSurface b(@OriginalArg(0) int arg0) {
		...
		if (ec.b(local10, -15560)) {
			throw new rl(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DSurface c() {
		...
		if (ec.b(local9, -15560)) {
			throw new rl(String.valueOf(local9));
		}
		return local5;
	}
	...
	public IDirect3DPixelShader b(@OriginalArg(0) byte[] arg0) {
		...
		if (ec.b(local14, -15560)) {
			throw new rl(String.valueOf(local14));
		}
		return local9;
	}
