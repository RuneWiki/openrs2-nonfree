...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Lclient!jaclib/peer/jaa;")
	private final jaa b;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/jaa;)V")
	public IDirect3DDevice(@OriginalArg(0) jaa arg0) {
		super(arg0);
		this.b = arg0;
	}
	...
	public IDirect3DSurface b() {
		...
		if (kg.b(-7175, local9)) {
			throw new jc(String.valueOf(local9));
		}
		return local5;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (kg.b(-7175, local17)) {
			throw new jc(String.valueOf(local17));
		}
		return arg1;
	}
	...
	public IDirect3DEventQuery c() {
		...
		if (kg.a(-21593, this._CreateEventQuery(local5))) {
			return local5.a(25759) ? local5 : null;
		} else {
			return null;
		}
	}
	...
	public IDirect3DCubeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (kg.b(-7175, local14)) {
			throw new jc(String.valueOf(local14));
		}
		return local5;
	}
	...
	public IDirect3DVertexShader a(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(10) IDirect3DVertexShader local10 = new IDirect3DVertexShader(this.b);
		@Pc(15) int local15 = this._CreateVertexShader(arg0, local10);
		if (kg.b(-7175, local15)) {
			throw new jc(String.valueOf(local15));
		}
		return local10;
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (kg.b(-7175, local21)) {
			throw new jc(String.valueOf(local21));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DVolumeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (kg.b(-7175, local16)) {
			throw new jc(String.valueOf(local16));
		}
		return local5;
	}
	...
	public IDirect3DSwapChain c(@OriginalArg(0) int arg0) {
		...
		if (kg.b(-7175, local10)) {
			throw new jc(String.valueOf(local10));
		}
		return local5;
	}
