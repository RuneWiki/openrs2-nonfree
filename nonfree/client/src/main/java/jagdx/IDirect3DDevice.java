...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Lclient!jaclib/peer/mk;")
	private final mk c;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/mk;)V")
	public IDirect3DDevice(@OriginalArg(0) mk arg0) {
		super(arg0);
		this.c = arg0;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (pia.a((byte) -110, local17)) {
			throw new fha(String.valueOf(local17));
		}
		return arg1;
	}
	...
	public IDirect3DVolumeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (pia.a((byte) -110, local16)) {
			throw new fha(String.valueOf(local16));
		}
		return local5;
	}
	...
	public IDirect3DVertexShader a(@OriginalArg(0) byte[] arg0) {
		...
		if (pia.a((byte) -110, local15)) {
			throw new fha(String.valueOf(local15));
		}
		return local10;
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (pia.a((byte) -110, local20)) {
			throw new fha(String.valueOf(local20));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DSurface b(@OriginalArg(0) int arg0) {
		...
		if (pia.a((byte) -110, local10)) {
			throw new fha(String.valueOf(local10));
		}
		return local5;
	}
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "(I)Lclient!jagdx/IDirect3DSwapChain;")
	public IDirect3DSwapChain c(@OriginalArg(0) int arg0) {
	...
	public IDirect3DEventQuery b() {
		...
		if (pia.a(-2005530600, this._CreateEventQuery(local5))) {
			return local5.a((byte) -42) ? local5 : null;
		} else {
			return null;
		}
	}
	...
	public IDirect3DCubeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (pia.a((byte) -110, local14)) {
			throw new fha(String.valueOf(local14));
		}
		return local5;
	}
	...
	public IDirect3DPixelShader b(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(10) IDirect3DPixelShader local10 = new IDirect3DPixelShader(this.c);
	...
	public IDirect3DIndexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DIndexBuffer arg4) {
		...
		@Pc(21) int local21 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
		if (pia.a((byte) -110, local21)) {
			throw new fha(String.valueOf(local21));
		}
		return arg4;
	}
	...
	public IDirect3DSurface c() {
		...
		if (pia.a((byte) -110, local9)) {
			throw new fha(String.valueOf(local9));
		}
		return local5;
	}
