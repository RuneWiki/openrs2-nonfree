...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Lclient!jaclib/peer/k;")
	private final k c;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/k;)V")
	public IDirect3DDevice(@OriginalArg(0) k arg0) {
		super(arg0);
		this.c = arg0;
	}
	...
	public IDirect3DSurface a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		...
		if (rj.b(local15, 4456)) {
			throw new ow(String.valueOf(local15));
		}
		return local5;
	}
	...
	public IDirect3DSurface a(@OriginalArg(0) int arg0) {
		...
		if (rj.b(local10, 4456)) {
			throw new ow(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (rj.b(local20, 4456)) {
			throw new ow(String.valueOf(local20));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DPixelShader a(@OriginalArg(0) byte[] arg0) {
		...
		if (rj.b(local14, 4456)) {
			throw new ow(String.valueOf(local14));
		}
		return local9;
	}
	...
	public IDirect3DEventQuery b() {
		...
		if (rj.a(-124, this._CreateEventQuery(local5))) {
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (rj.b(local17, 4456)) {
			throw new ow(String.valueOf(local17));
		}
		return arg1;
	}
	...
	public IDirect3DVolumeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (rj.b(local16, 4456)) {
			throw new ow(String.valueOf(local16));
		}
		return local5;
	}
	...
	public IDirect3DSurface c() {
		...
		if (rj.b(local9, 4456)) {
			throw new ow(String.valueOf(local9));
		}
		return local5;
	}
