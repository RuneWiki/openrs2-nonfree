...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Lclient!jaclib/peer/gca;")
	private final gca c;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/gca;)V")
	public IDirect3DDevice(@OriginalArg(0) gca arg0) {
		super(arg0);
		this.c = arg0;
	}
	...
	public IDirect3DTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(5) IDirect3DTexture local5 = new IDirect3DTexture(this.c);
		@Pc(15) int local15 = this._CreateTexture(arg0, arg1, arg2, arg3, arg4, arg5, local5);
		if (lg.a(-2005530522, local15)) {
			throw new rw(String.valueOf(local15));
		}
		return local5;
	}
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "([B)Lclient!jagdx/IDirect3DVertexShader;")
	public IDirect3DVertexShader a(@OriginalArg(0) byte[] arg0) {
		if (arg0 == null) {
			return null;
		}
		@Pc(10) IDirect3DVertexShader local10 = new IDirect3DVertexShader(this.c);
		@Pc(15) int local15 = this._CreateVertexShader(arg0, local10);
		if (lg.a(-2005530522, local15)) {
			throw new rw(String.valueOf(local15));
		}
		return local10;
	...
	public int a(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4) {
		...
		b[0] = arg1;
		b[3] = arg4;
		return this.SetVertexShaderConstantF(arg0, b, 1);
	}
	...
	public int b(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4) {
		...
		b[3] = arg4;
		b[1] = arg2;
		return this.SetPixelShaderConstantF(arg0, b, 1);
	}
	...
	public IDirect3DVolumeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(5) IDirect3DVolumeTexture local5 = new IDirect3DVolumeTexture(this.c);
		@Pc(16) int local16 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, local5);
		if (lg.a(-2005530522, local16)) {
			throw new rw(String.valueOf(local16));
		}
		return local5;
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		if (arg4 == null) {
			arg4 = new IDirect3DVertexBuffer(this.c);
		} else {
			arg4.b((byte) -36);
		}
		@Pc(21) int local21 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
		if (lg.a(-2005530522, local21)) {
			throw new rw(String.valueOf(local21));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "()Lclient!jagdx/IDirect3DSurface;")
	public IDirect3DSurface b() {
		@Pc(5) IDirect3DSurface local5 = new IDirect3DSurface(this.c);
		@Pc(9) int local9 = this._GetDepthStencilSurface(local5);
		if (lg.a(-2005530522, local9)) {
			throw new rw(String.valueOf(local9));
		}
		return local5;
	}
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I)Lclient!jagdx/IDirect3DSurface;")
	public IDirect3DSurface a(@OriginalArg(0) int arg0) {
		@Pc(5) IDirect3DSurface local5 = new IDirect3DSurface(this.c);
		@Pc(10) int local10 = this._GetRenderTarget(arg0, local5);
		if (lg.a(-2005530522, local10)) {
			throw new rw(String.valueOf(local10));
		}
		return local5;
	}
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "()Lclient!jagdx/IDirect3DEventQuery;")
	public IDirect3DEventQuery c() {
		@Pc(5) IDirect3DEventQuery local5 = new IDirect3DEventQuery(this.c);
		if (lg.b(this._CreateEventQuery(local5), 25499)) {
			return local5.a((byte) -90) ? local5 : null;
		} else {
			return null;
		}
	}
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "([B)Lclient!jagdx/IDirect3DPixelShader;")
	public IDirect3DPixelShader b(@OriginalArg(0) byte[] arg0) {
		if (arg0 == null) {
			return null;
		}
		@Pc(9) IDirect3DPixelShader local9 = new IDirect3DPixelShader(this.c);
		@Pc(14) int local14 = this._CreatePixelShader(arg0, local9);
		if (lg.a(-2005530522, local14)) {
			throw new rw(String.valueOf(local14));
		}
		return local9;
	}
	...
	public IDirect3DIndexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DIndexBuffer arg4) {
		if (arg4 == null) {
			arg4 = new IDirect3DIndexBuffer(this.c);
		} else {
			arg4.b((byte) -36);
		}
		@Pc(20) int local20 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
		if (lg.a(-2005530522, local20)) {
			throw new rw(String.valueOf(local20));
		}
		return arg4;
	}
	...
	public IDirect3DCubeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(5) IDirect3DCubeTexture local5 = new IDirect3DCubeTexture(this.c);
	...
	public IDirect3DSwapChain b(@OriginalArg(0) int arg0) {
		@Pc(5) IDirect3DSwapChain local5 = new IDirect3DSwapChain(this.c);
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		if (arg1 == null) {
			arg1 = new IDirect3DVertexDeclaration(this.c);
		} else {
			arg1.b((byte) -36);
		}
		@Pc(17) int local17 = this._CreateVertexDeclaration(arg0, arg1);
		if (lg.a(-2005530522, local17)) {
			throw new rw(String.valueOf(local17));
		}
		return arg1;
	}
