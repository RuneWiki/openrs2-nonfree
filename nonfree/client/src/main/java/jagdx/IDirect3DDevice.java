...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Lclient!jaclib/peer/uca;")
	private final uca c;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/uca;)V")
	public IDirect3DDevice(@OriginalArg(0) uca arg0) {
		super(arg0);
		this.c = arg0;
	}
	...
	public IDirect3DSurface b() {
		...
		if (raa.a(local9, (int) -43)) {
			throw new iba(String.valueOf(local9));
		}
		return local5;
	}
	...
	public IDirect3DTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		if (raa.a(local15, (int) -73)) {
			throw new iba(String.valueOf(local15));
		}
		return local5;
	}
	...
	public IDirect3DIndexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DIndexBuffer arg4) {
		...
		if (raa.a(local21, (int) -118)) {
			throw new iba(String.valueOf(local21));
		}
		return arg4;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (raa.a(local18, (int) -90)) {
			throw new iba(String.valueOf(local18));
		}
		return arg1;
	}
	...
	public IDirect3DPixelShader a(@OriginalArg(0) byte[] arg0) {
		...
		if (raa.a(local14, (int) -121)) {
			throw new iba(String.valueOf(local14));
		}
		return local9;
	}
	...
	public IDirect3DEventQuery c() {
		...
		if (raa.a(this._CreateEventQuery(local5), (byte) 109)) {
			return local5.a(-118) ? local5 : null;
		} else {
			return null;
		}
	}
	...
	public IDirect3DVolumeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (raa.a(local16, (int) -107)) {
			throw new iba(String.valueOf(local16));
		}
		return local5;
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (raa.a(local20, (int) -124)) {
			throw new iba(String.valueOf(local20));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DSwapChain b(@OriginalArg(0) int arg0) {
		...
		if (raa.a(local10, (int) -90)) {
			throw new iba(String.valueOf(local10));
		}
		return local5;
	}
