...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Lclient!jaclib/peer/hea;")
	private final hea b;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/hea;)V")
	public IDirect3DDevice(@OriginalArg(0) hea arg0) {
		super(arg0);
		this.b = arg0;
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (em.a(local21, (byte) -63)) {
			throw new en(String.valueOf(local21));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DVertexShader a(@OriginalArg(0) byte[] arg0) {
		...
		if (em.a(local14, (byte) -16)) {
			throw new en(String.valueOf(local14));
		}
		return local9;
	}
	...
	public IDirect3DSurface c(@OriginalArg(0) int arg0) {
		...
		if (em.a(local10, (byte) 115)) {
			throw new en(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (em.a(local17, (byte) -37)) {
			throw new en(String.valueOf(local17));
		}
		return arg1;
	}
	...
	public IDirect3DSurface b() {
		...
		if (em.a(local9, (byte) 124)) {
			throw new en(String.valueOf(local9));
		}
		return local5;
	}
	...
	public IDirect3DPixelShader b(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(9) IDirect3DPixelShader local9 = new IDirect3DPixelShader(this.b);
		@Pc(14) int local14 = this._CreatePixelShader(arg0, local9);
		if (em.a(local14, (byte) -115)) {
			throw new en(String.valueOf(local14));
		}
		return local9;
	}
	...
	public IDirect3DSurface a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
		...
		if (em.a(local15, (byte) 124)) {
			throw new en(String.valueOf(local15));
		}
		return local5;
	}
	...
	public IDirect3DEventQuery c() {
		...
		if (em.a(this._CreateEventQuery(local5), (int) -1)) {
			return local5.a(119) ? local5 : null;
		} else {
			return null;
		}
	}
	...
	public IDirect3DVolumeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (em.a(local16, (byte) 114)) {
			throw new en(String.valueOf(local16));
		}
		return local5;
	}
