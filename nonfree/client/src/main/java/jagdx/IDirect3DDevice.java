...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Lclient!jaclib/peer/er;")
	private final er c;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/er;)V")
	public IDirect3DDevice(@OriginalArg(0) er arg0) {
		super(arg0);
		this.c = arg0;
	}
	...
	public IDirect3DPixelShader a(@OriginalArg(0) byte[] arg0) {
		...
		if (wd.a(local15, (byte) 81)) {
			throw new tha(String.valueOf(local15));
		}
		return local10;
	}
	...
	public IDirect3DEventQuery b() {
		...
		if (wd.a(74, (int) this._CreateEventQuery(local5))) {
			return local5.a(-14296) ? local5 : null;
		} else {
			return null;
		}
	}
	...
	public IDirect3DSurface c() {
		...
		if (wd.a(local9, (byte) -66)) {
			throw new tha(String.valueOf(local9));
		}
		return local5;
	}
	...
	public IDirect3DIndexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DIndexBuffer arg4) {
		...
		if (wd.a(local20, (byte) 91)) {
			throw new tha(String.valueOf(local20));
		}
		return arg4;
	}
	...
	public IDirect3DVolumeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (wd.a(local16, (byte) -100)) {
			throw new tha(String.valueOf(local16));
		}
		return local5;
	}
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (wd.a(local21, (byte) 79)) {
			throw new tha(String.valueOf(local21));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DSurface b(@OriginalArg(0) int arg0) {
		...
		if (wd.a(local10, (byte) 115)) {
			throw new tha(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DCubeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (wd.a(local14, (byte) -14)) {
			throw new tha(String.valueOf(local14));
		}
		return local5;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (wd.a(local18, (byte) 119)) {
			throw new tha(String.valueOf(local18));
		}
		return arg1;
	}
