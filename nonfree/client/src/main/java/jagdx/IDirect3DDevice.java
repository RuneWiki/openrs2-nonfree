...
public final class IDirect3DDevice extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Lclient!jaclib/peer/am;")
	private final am c;

	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Lclient!jaclib/peer/am;)V")
	public IDirect3DDevice(@OriginalArg(0) am arg0) {
		super(arg0);
		this.c = arg0;
	}
	...
	public IDirect3DSurface b() {
		...
		if (qr.a(true, local9)) {
			throw new bs(String.valueOf(local9));
		}
		return local5;
	}
	...
	public IDirect3DVolumeTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (qr.a(true, local16)) {
			throw new bs(String.valueOf(local16));
		}
		return local5;
	}
	...
	public IDirect3DVertexDeclaration a(@OriginalArg(0) VertexElementCollection arg0, @OriginalArg(1) IDirect3DVertexDeclaration arg1) {
		...
		if (qr.a(true, local17)) {
			throw new bs(String.valueOf(local17));
		}
		return arg1;
	}
	...
	public IDirect3DSurface c(@OriginalArg(0) int arg0) {
		...
		if (qr.a(true, local10)) {
			throw new bs(String.valueOf(local10));
		}
		return local5;
	}
	...
	public IDirect3DVertexShader a(@OriginalArg(0) byte[] arg0) {
		...
		if (qr.a(true, local14)) {
			throw new bs(String.valueOf(local14));
		}
		return local9;
	}
	...
	public IDirect3DTexture a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		if (qr.a(true, local15)) {
			throw new bs(String.valueOf(local15));
		}
		return local5;
	}
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "d", descriptor = "(I)Lclient!jagdx/IDirect3DSwapChain;")
	public IDirect3DSwapChain d(@OriginalArg(0) int arg0) {
	...
	public IDirect3DVertexBuffer a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) IDirect3DVertexBuffer arg4) {
		...
		if (qr.a(true, local20)) {
			throw new bs(String.valueOf(local20));
		}
		arg4.b = arg0;
		return arg4;
	}
	...
	public IDirect3DEventQuery c() {
		...
		if (qr.a(this._CreateEventQuery(local5), -2005530519)) {
			return local5.a(8108) ? local5 : null;
		} else {
			return null;
		}
	}
