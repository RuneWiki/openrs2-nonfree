...
public final class D3DLIGHT extends fb {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/hr;)V")
	public D3DLIGHT(@OriginalArg(0) hr arg0) {
		super(arg0);
		this.Init();
	}
