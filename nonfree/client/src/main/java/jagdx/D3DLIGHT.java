...
public final class D3DLIGHT extends mfa {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/jaa;)V")
	public D3DLIGHT(@OriginalArg(0) jaa arg0) {
		super(arg0);
		this.Init();
	}
