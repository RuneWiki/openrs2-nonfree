...
public final class D3DLIGHT extends qla {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/bu;)V")
	public D3DLIGHT(@OriginalArg(0) bu arg0) {
		super(arg0);
		this.Init();
	}
