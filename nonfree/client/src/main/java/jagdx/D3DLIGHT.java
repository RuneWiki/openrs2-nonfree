...
public final class D3DLIGHT extends fe {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/ca;)V")
	public D3DLIGHT(@OriginalArg(0) ca arg0) {
		super(arg0);
		this.Init();
	}
