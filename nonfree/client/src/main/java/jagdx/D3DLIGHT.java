...
public final class D3DLIGHT extends mw {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/bea;)V")
	public D3DLIGHT(@OriginalArg(0) bea arg0) {
		super(arg0);
		this.Init();
	}
