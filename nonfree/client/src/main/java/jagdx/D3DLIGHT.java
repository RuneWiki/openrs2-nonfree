...
public final class D3DLIGHT extends um {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/mk;)V")
	public D3DLIGHT(@OriginalArg(0) mk arg0) {
		super(arg0);
		this.Init();
	}
