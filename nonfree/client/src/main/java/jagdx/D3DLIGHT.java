...
public final class D3DLIGHT extends uca {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/wf;)V")
	public D3DLIGHT(@OriginalArg(0) wf arg0) {
		super(arg0);
		this.Init();
	}
