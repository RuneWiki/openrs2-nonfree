...
public final class D3DLIGHT extends jj {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/in;)V")
	public D3DLIGHT(@OriginalArg(0) in arg0) {
		super(arg0);
		this.Init();
	}
