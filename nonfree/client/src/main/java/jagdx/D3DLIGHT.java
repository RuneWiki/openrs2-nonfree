...
public final class D3DLIGHT extends cha {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/vv;)V")
	public D3DLIGHT(@OriginalArg(0) vv arg0) {
		super(arg0);
		this.Init();
	}
