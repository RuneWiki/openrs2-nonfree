...
public final class D3DLIGHT extends qp {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/pi;)V")
	public D3DLIGHT(@OriginalArg(0) pi arg0) {
		super(arg0);
		this.Init();
	}
