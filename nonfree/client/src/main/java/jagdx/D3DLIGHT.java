...
public final class D3DLIGHT extends pa {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/am;)V")
	public D3DLIGHT(@OriginalArg(0) am arg0) {
		super(arg0);
		this.Init();
	}
