...
public final class D3DLIGHT extends hm {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/bd;)V")
	public D3DLIGHT(@OriginalArg(0) bd arg0) {
		super(arg0);
		this.Init();
	}
