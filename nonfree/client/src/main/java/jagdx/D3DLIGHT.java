...
public final class D3DLIGHT extends je {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/dba;)V")
	public D3DLIGHT(@OriginalArg(0) dba arg0) {
		super(arg0);
		this.Init();
	}
