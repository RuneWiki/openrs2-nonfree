...
public final class D3DLIGHT extends jl {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/qr;)V")
	public D3DLIGHT(@OriginalArg(0) qr arg0) {
		super(arg0);
		this.Init();
	}
