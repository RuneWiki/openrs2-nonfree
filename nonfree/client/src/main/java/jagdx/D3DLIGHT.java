...
public final class D3DLIGHT extends tja {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/bw;)V")
	public D3DLIGHT(@OriginalArg(0) bw arg0) {
		super(arg0);
		this.Init();
	}
