...
public final class D3DLIGHT extends tk {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/cv;)V")
	public D3DLIGHT(@OriginalArg(0) cv arg0) {
		super(arg0);
		this.Init();
	}
