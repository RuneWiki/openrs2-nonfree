...
public final class D3DLIGHT extends rn {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/pba;)V")
	public D3DLIGHT(@OriginalArg(0) pba arg0) {
		super(arg0);
		this.Init();
	}
