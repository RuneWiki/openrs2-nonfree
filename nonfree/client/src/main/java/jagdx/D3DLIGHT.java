...
public final class D3DLIGHT extends gs {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/pe;)V")
	public D3DLIGHT(@OriginalArg(0) pe arg0) {
		super(arg0);
		this.Init();
	}
