...
public final class D3DLIGHT extends ab {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/tc;)V")
	public D3DLIGHT(@OriginalArg(0) tc arg0) {
		super(arg0);
		this.Init();
	}
