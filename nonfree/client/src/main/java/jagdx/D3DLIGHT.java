...
public final class D3DLIGHT extends md {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/mba;)V")
	public D3DLIGHT(@OriginalArg(0) mba arg0) {
		super(arg0);
		this.Init();
	}
