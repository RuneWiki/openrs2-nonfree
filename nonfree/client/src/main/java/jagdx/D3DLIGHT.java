...
public final class D3DLIGHT extends uo {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/ep;)V")
	public D3DLIGHT(@OriginalArg(0) ep arg0) {
		super(arg0);
		this.Init();
	}
