...
public final class D3DLIGHT extends pn {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/k;)V")
	public D3DLIGHT(@OriginalArg(0) k arg0) {
		super(arg0);
		this.Init();
	}
