...
public final class D3DLIGHT extends l {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/fk;)V")
	public D3DLIGHT(@OriginalArg(0) fk arg0) {
		super(arg0);
		this.Init();
	}
