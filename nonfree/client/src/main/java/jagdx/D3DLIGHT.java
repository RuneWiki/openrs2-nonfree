...
public final class D3DLIGHT extends gd {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/dj;)V")
	public D3DLIGHT(@OriginalArg(0) dj arg0) {
		super(arg0);
		this.Init();
	}
