...
public final class D3DLIGHT extends dh {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/hk;)V")
	public D3DLIGHT(@OriginalArg(0) hk arg0) {
		super(arg0);
		this.Init();
	}
