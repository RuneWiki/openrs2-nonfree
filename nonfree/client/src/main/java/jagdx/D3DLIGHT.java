...
public final class D3DLIGHT extends od {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/bda;)V")
	public D3DLIGHT(@OriginalArg(0) bda arg0) {
		super(arg0);
		this.Init();
	}
