...
public final class D3DLIGHT extends pr {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/uca;)V")
	public D3DLIGHT(@OriginalArg(0) uca arg0) {
		super(arg0);
		this.Init();
	}
