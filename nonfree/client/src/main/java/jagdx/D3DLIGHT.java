...
public final class D3DLIGHT extends pd {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/wn;)V")
	public D3DLIGHT(@OriginalArg(0) wn arg0) {
		super(arg0);
		this.Init();
	}
