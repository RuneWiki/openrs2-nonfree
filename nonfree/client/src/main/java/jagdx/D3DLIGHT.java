...
public final class D3DLIGHT extends mh {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/rh;)V")
	public D3DLIGHT(@OriginalArg(0) rh arg0) {
		super(arg0);
		this.Init();
	}
