...
public final class D3DLIGHT extends bb {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/pb;)V")
	public D3DLIGHT(@OriginalArg(0) pb arg0) {
		super(arg0);
		this.Init();
	}
