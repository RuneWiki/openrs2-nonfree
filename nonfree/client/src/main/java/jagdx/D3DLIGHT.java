...
public final class D3DLIGHT extends ii {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/of;)V")
	public D3DLIGHT(@OriginalArg(0) of arg0) {
		super(arg0);
		this.Init();
	}
