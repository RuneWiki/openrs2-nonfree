...
public final class D3DLIGHT extends eb {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/ow;)V")
	public D3DLIGHT(@OriginalArg(0) ow arg0) {
		super(arg0);
		this.Init();
	}
