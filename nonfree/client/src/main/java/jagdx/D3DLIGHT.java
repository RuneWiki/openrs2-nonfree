...
public final class D3DLIGHT extends jd {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/ks;)V")
	public D3DLIGHT(@OriginalArg(0) ks arg0) {
		super(arg0);
		this.Init();
	}
