...
public final class D3DLIGHT extends qs {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/gca;)V")
	public D3DLIGHT(@OriginalArg(0) gca arg0) {
		super(arg0);
		this.Init();
	}
