...
public final class D3DLIGHT extends nn {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/dq;)V")
	public D3DLIGHT(@OriginalArg(0) dq arg0) {
		super(arg0);
		this.Init();
	}
