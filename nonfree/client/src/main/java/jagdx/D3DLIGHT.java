...
public final class D3DLIGHT extends ih {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/er;)V")
	public D3DLIGHT(@OriginalArg(0) er arg0) {
		super(arg0);
		this.Init();
	}
