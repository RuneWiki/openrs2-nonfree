...
public final class D3DLIGHT extends ik {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/jv;)V")
	public D3DLIGHT(@OriginalArg(0) jv arg0) {
		super(arg0);
		this.Init();
	}
