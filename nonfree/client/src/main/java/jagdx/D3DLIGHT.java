...
public final class D3DLIGHT extends jfa {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/vo;)V")
	public D3DLIGHT(@OriginalArg(0) vo arg0) {
		super(arg0);
		this.Init();
	}
