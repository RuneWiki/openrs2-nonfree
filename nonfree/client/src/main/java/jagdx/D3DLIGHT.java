...
public final class D3DLIGHT extends vl {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/wl;)V")
	public D3DLIGHT(@OriginalArg(0) wl arg0) {
		super(arg0);
		this.Init();
	}
