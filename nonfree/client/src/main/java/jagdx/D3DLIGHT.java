...
public final class D3DLIGHT extends gga {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/ku;)V")
	public D3DLIGHT(@OriginalArg(0) ku arg0) {
		super(arg0);
		this.Init();
	}
