...
public final class D3DLIGHT extends bi {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/ge;)V")
	public D3DLIGHT(@OriginalArg(0) ge arg0) {
		super(arg0);
		this.Init();
	}
