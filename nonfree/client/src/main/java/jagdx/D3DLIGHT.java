...
public final class D3DLIGHT extends ni {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/ik;)V")
	public D3DLIGHT(@OriginalArg(0) ik arg0) {
		super(arg0);
		this.Init();
	}
