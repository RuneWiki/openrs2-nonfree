...
public final class D3DLIGHT extends qu {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/naa;)V")
	public D3DLIGHT(@OriginalArg(0) naa arg0) {
		super(arg0);
		this.Init();
	}
