...
public final class D3DLIGHT extends mf {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/io;)V")
	public D3DLIGHT(@OriginalArg(0) io arg0) {
		super(arg0);
		this.Init();
	}
