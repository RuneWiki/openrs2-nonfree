...
public final class D3DLIGHT extends jc {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/jd;)V")
	public D3DLIGHT(@OriginalArg(0) jd arg0) {
		super(arg0);
		this.Init();
	}
