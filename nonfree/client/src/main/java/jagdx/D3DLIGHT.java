...
public final class D3DLIGHT extends ma {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/qd;)V")
	public D3DLIGHT(@OriginalArg(0) qd arg0) {
		super(arg0);
		this.Init();
	}
