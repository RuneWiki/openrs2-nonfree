...
public final class D3DLIGHT extends dea {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/aaa;)V")
	public D3DLIGHT(@OriginalArg(0) aaa arg0) {
		super(arg0);
		this.Init();
	}
