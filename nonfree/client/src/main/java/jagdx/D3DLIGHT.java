...
public final class D3DLIGHT extends ad {

	@OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Lclient!jaclib/peer/hea;)V")
	public D3DLIGHT(@OriginalArg(0) hea arg0) {
		super(arg0);
		this.Init();
	}
