...
public final class IDirect3D extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "Lclient!jaclib/peer/pe;")
	private final pe b;
	...
	@OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILclient!jaclib/peer/pe;)Lclient!jagdx/IDirect3D;")
	public static IDirect3D a(@OriginalArg(0) int arg0, @OriginalArg(1) pe arg1) {
		@Pc(4) IDirect3D local4 = new IDirect3D(arg1);
		@Pc(8) int local8 = _Direct3DCreate(arg0, local4);
		if (dt.a((byte) 11, local8)) {
			throw new td("");
		}
		return local4;
	}

	@OriginalMember(owner = "client!jagdx/IDirect3D", name = "<init>", descriptor = "(Lclient!jaclib/peer/pe;)V")
	private IDirect3D(@OriginalArg(0) pe arg0) {
		super(arg0);
		this.b = arg0;
	}
	...
	public IDirect3DDevice a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Canvas arg2, @OriginalArg(3) int arg3, @OriginalArg(4) D3DPRESENT_PARAMETERS arg4) {
		...
		if (dt.a((byte) 101, local14)) {
			throw new td("");
		}
		return local5;
	}

	@OriginalMember(owner = "client!jagdx/IDirect3D", name = "c", descriptor = "(I)Lclient!jagdx/D3DDISPLAYMODE;")
	public D3DDISPLAYMODE c(@OriginalArg(0) int arg0) {
		@Pc(3) D3DDISPLAYMODE local3 = new D3DDISPLAYMODE();
		@Pc(8) int local8 = this._GetAdapterDisplayMode(arg0, local3);
		if (dt.a((byte) 53, local8)) {
			throw new td("");
		}
		return local3;
	}
