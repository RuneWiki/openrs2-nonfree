...
public final class IDirect3D extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "Lclient!jaclib/peer/hr;")
	private final hr b;

	@OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILclient!jaclib/peer/hr;)Lclient!jagdx/IDirect3D;")
	public static IDirect3D a(@OriginalArg(0) int arg0, @OriginalArg(1) hr arg1) {
		@Pc(4) IDirect3D local4 = new IDirect3D(arg1);
		@Pc(8) int local8 = _Direct3DCreate(arg0, local4);
		if (hb.b(local8, (byte) 113)) {
			throw new oea(String.valueOf(local8));
		}
		return local4;
	}
	...
	@OriginalMember(owner = "client!jagdx/IDirect3D", name = "<init>", descriptor = "(Lclient!jaclib/peer/hr;)V")
	private IDirect3D(@OriginalArg(0) hr arg0) {
		super(arg0);
		this.b = arg0;
	}
