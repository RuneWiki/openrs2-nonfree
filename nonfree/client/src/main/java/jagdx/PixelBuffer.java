...
public final class PixelBuffer extends ad implements Buffer {

	@OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/hea;)V")
	public PixelBuffer(@OriginalArg(0) hea arg0) {
		super(arg0);
		this.init();
	}
	...
	public void a(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg0.length < arg3 + arg1 | arg1 < 0 | arg0 == null | arg2 < 0 || this.getSize() < arg3 + arg2) {
			throw new en();
		}
	...
	public void a(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg2 < 0 | arg0 == null | arg1 < 0 | arg0.length < arg1 + arg3 || this.getSize() < arg2 + arg3 * 4) {
			throw new en();
		}
