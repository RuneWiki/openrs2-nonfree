...
public final class PixelBuffer extends ab implements Buffer {

	@OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/tc;)V")
	public PixelBuffer(@OriginalArg(0) tc arg0) {
		super(arg0);
		this.init();
	}
