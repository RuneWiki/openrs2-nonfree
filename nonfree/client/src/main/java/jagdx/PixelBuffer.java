...
public final class PixelBuffer extends uca implements Buffer {

	@OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/wf;)V")
	public PixelBuffer(@OriginalArg(0) wf arg0) {
		super(arg0);
		this.init();
	}
	...
	public void a(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg0.length < arg3 + arg1 | arg0 == null | arg1 < 0 | arg2 < 0 || arg3 * 4 + arg2 > this.getSize()) {
			throw new ln();
		}
