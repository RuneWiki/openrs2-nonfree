...
public final class PixelBuffer extends uo implements Buffer {

	@OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/ep;)V")
	public PixelBuffer(@OriginalArg(0) ep arg0) {
		super(arg0);
		this.init();
	}
