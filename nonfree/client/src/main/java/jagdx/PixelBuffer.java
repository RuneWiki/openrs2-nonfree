...
public final class PixelBuffer extends jl implements Buffer {

	@OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/qr;)V")
	public PixelBuffer(@OriginalArg(0) qr arg0) {
		super(arg0);
		this.init();
	}
