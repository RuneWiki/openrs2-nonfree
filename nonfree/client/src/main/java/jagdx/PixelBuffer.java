...
public final class PixelBuffer extends fb implements Buffer {

	@OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/hr;)V")
	public PixelBuffer(@OriginalArg(0) hr arg0) {
		super(arg0);
		this.init();
	}
	...
	public void a(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg2 < 0 | arg0.length < arg3 + arg1 | arg1 < 0 | arg0 == null || this.getSize() < arg2 + arg3) {
			throw new oea();
		}
	...
	public void a(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg2 < 0 | arg3 + arg1 > arg0.length | arg0 == null | arg1 < 0 || arg3 * 4 + arg2 > this.getSize()) {
			throw new oea();
		}
	...
	public void b(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg1 < 0 | arg0 == null | arg3 + arg1 > arg0.length | arg2 < 0 || arg3 * 4 + arg2 > this.getSize()) {
			throw new oea();
		}
