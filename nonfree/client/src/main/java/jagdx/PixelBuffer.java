...
public final class PixelBuffer extends bi implements Buffer {

	@OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/ge;)V")
	public PixelBuffer(@OriginalArg(0) ge arg0) {
		super(arg0);
		this.init();
	}
	...
	public void a(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg0 == null | arg1 < 0 | arg1 + arg3 > arg0.length | arg2 < 0 || arg2 + arg3 * 4 > this.getSize()) {
			throw new hl();
		}
	...
	public void a(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg2 < 0 | arg1 < 0 | arg0 == null | arg0.length < arg1 + arg3 || arg3 + arg2 > this.getSize()) {
			throw new hl();
		}
