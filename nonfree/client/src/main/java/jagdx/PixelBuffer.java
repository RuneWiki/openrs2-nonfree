...
public final class PixelBuffer extends od implements Buffer {

	@OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/bda;)V")
	public PixelBuffer(@OriginalArg(0) bda arg0) {
		super(arg0);
		this.init();
	}
	...
	public void a(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg1 < 0 | arg0 == null | arg0.length < arg3 + arg1 | arg2 < 0 || this.getSize() < arg2 + arg3) {
			throw new lq();
		}
	...
	public void b(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg2 < 0 | arg3 + arg1 > arg0.length | arg1 < 0 | arg0 == null || arg3 * 4 + arg2 > this.getSize()) {
			throw new lq();
		}
