...
public final class PixelBuffer extends gs implements Buffer {

	@OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/pe;)V")
	public PixelBuffer(@OriginalArg(0) pe arg0) {
		super(arg0);
		this.init();
	}
	...
	public void a(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg2 < 0 | arg0 == null | arg1 < 0 | arg0.length < arg1 + arg3 || arg2 + arg3 * 4 > this.getSize()) {
			throw new td();
		}
