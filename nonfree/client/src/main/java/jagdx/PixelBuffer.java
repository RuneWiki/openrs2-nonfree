...
public final class PixelBuffer extends cha implements Buffer {

	@OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/vv;)V")
	public PixelBuffer(@OriginalArg(0) vv arg0) {
		super(arg0);
		this.init();
	}
