...
public final class PixelBuffer extends qs implements Buffer {

	@OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/gca;)V")
	public PixelBuffer(@OriginalArg(0) gca arg0) {
		super(arg0);
		this.init();
	}
	...
	public void b(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg2 < 0 | arg1 < 0 | arg0 == null | arg0.length < arg3 + arg1 || this.getSize() < arg3 * 4 + arg2) {
			throw new rw();
		}
