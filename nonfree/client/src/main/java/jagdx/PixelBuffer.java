...
public final class PixelBuffer extends eb implements Buffer {

	@OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/ow;)V")
	public PixelBuffer(@OriginalArg(0) ow arg0) {
		super(arg0);
		this.init();
	}
	...
	public void a(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg0 == null | arg1 < 0 | arg3 + arg1 > arg0.length | arg2 < 0 || this.getSize() < arg2 + arg3 * 4) {
			throw new rm();
		}
	...
	public void a(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg2 < 0 | arg3 + arg1 > arg0.length | arg0 == null | arg1 < 0 || arg2 + arg3 > this.getSize()) {
			throw new rm();
		}
