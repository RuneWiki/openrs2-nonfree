...
public final class PixelBuffer extends ik implements Buffer {

	@OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/jv;)V")
	public PixelBuffer(@OriginalArg(0) jv arg0) {
		super(arg0);
		this.init();
	}
