...
public final class PixelBuffer extends mfa implements Buffer {

	@OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/jaa;)V")
	public PixelBuffer(@OriginalArg(0) jaa arg0) {
		super(arg0);
		this.init();
	}
