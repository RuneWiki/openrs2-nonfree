...
import jaclib.peer.md;
import org.openrs2.deob.annotation.OriginalArg;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;

@OriginalClass("client!jagdx/PixelBuffer")
public final class PixelBuffer extends md implements Buffer {

	@OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/mba;)V")
	public PixelBuffer(@OriginalArg(0) mba arg0) {
		super(arg0);
		this.init();
	}
	...
	public void a(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg2 < 0 | arg0 == null | arg1 < 0 | arg0.length < arg1 + arg3 || arg3 + arg2 > this.getSize()) {
			throw new pl();
		}
	...
	public void a(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg0 == null | arg1 < 0 | arg3 + arg1 > arg0.length | arg2 < 0 || arg2 + arg3 * 4 > this.getSize()) {
			throw new pl();
		}
