...
public final class PixelBuffer extends pr implements Buffer {

	@OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/uca;)V")
	public PixelBuffer(@OriginalArg(0) uca arg0) {
		super(arg0);
		this.init();
	}
	...
	public void a(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg3 + arg1 > arg0.length | arg0 == null | arg1 < 0 | arg2 < 0 || this.getSize() < arg2 + arg3) {
			throw new iba();
		}
