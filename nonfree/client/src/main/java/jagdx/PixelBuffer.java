...
public final class PixelBuffer extends gga implements Buffer {

	@OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/ku;)V")
	public PixelBuffer(@OriginalArg(0) ku arg0) {
		super(arg0);
		this.init();
	}
