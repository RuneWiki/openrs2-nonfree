...
public final class PixelBuffer extends jd implements Buffer {

	@OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/fl;)V")
	public PixelBuffer(@OriginalArg(0) fl arg0) {
		super(arg0);
		this.init();
	}
