...
public final class PixelBuffer extends rn implements Buffer {

	@OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/pba;)V")
	public PixelBuffer(@OriginalArg(0) pba arg0) {
		super(arg0);
		this.init();
	}
	...
	public void a(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg0.length < arg3 + arg1 | arg1 < 0 | arg0 == null | arg2 < 0 || arg2 + arg3 > this.getSize()) {
			throw new jha();
		}
