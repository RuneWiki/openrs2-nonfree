...
public final class IDirect3DCubeTexture extends IDirect3DBaseTexture {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DCubeTexture", name = "<init>", descriptor = "(Lclient!jaclib/peer/jaa;)V")
	public IDirect3DCubeTexture(@OriginalArg(0) jaa arg0) {
		super(arg0);
	}
