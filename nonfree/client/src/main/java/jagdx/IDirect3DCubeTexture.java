...
public final class IDirect3DCubeTexture extends IDirect3DBaseTexture {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DCubeTexture", name = "<init>", descriptor = "(Lclient!jaclib/peer/uca;)V")
	public IDirect3DCubeTexture(@OriginalArg(0) uca arg0) {
		super(arg0);
	}
