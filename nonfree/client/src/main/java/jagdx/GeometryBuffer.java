...
public final class GeometryBuffer extends ik implements Buffer {

	@OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/jv;)V")
	public GeometryBuffer(@OriginalArg(0) jv arg0) {
		super(arg0);
		this.init();
	}
