...
public final class GeometryBuffer extends gd implements Buffer {

	@OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/dj;)V")
	public GeometryBuffer(@OriginalArg(0) dj arg0) {
		super(arg0);
		this.init();
	}
