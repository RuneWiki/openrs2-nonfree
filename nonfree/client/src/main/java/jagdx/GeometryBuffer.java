...
public final class GeometryBuffer extends md implements Buffer {

	@OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/mba;)V")
	public GeometryBuffer(@OriginalArg(0) mba arg0) {
		super(arg0);
		this.init();
	}
