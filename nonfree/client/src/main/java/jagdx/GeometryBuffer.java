...
public final class GeometryBuffer extends ad implements Buffer {

	@OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/hea;)V")
	public GeometryBuffer(@OriginalArg(0) hea arg0) {
		super(arg0);
		this.init();
	}
