...
public final class GeometryBuffer extends mf implements Buffer {

	@OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/io;)V")
	public GeometryBuffer(@OriginalArg(0) io arg0) {
		super(arg0);
		this.init();
	}
