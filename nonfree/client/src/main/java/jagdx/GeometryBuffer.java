...
public final class GeometryBuffer extends jfa implements Buffer {

	@OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/vo;)V")
	public GeometryBuffer(@OriginalArg(0) vo arg0) {
		super(arg0);
		this.init();
	}
