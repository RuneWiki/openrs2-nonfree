...
public final class GeometryBuffer extends dh implements Buffer {

	@OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/hk;)V")
	public GeometryBuffer(@OriginalArg(0) hk arg0) {
		super(arg0);
		this.init();
	}
