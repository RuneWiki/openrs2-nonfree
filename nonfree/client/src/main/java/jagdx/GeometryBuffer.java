...
public final class GeometryBuffer extends ii implements Buffer {

	@OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/of;)V")
	public GeometryBuffer(@OriginalArg(0) of arg0) {
		super(arg0);
		this.init();
	}
