...
public final class GeometryBuffer extends dea implements Buffer {

	@OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/aaa;)V")
	public GeometryBuffer(@OriginalArg(0) aaa arg0) {
		super(arg0);
		this.init();
	}
