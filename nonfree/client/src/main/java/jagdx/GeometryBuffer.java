...
public final class GeometryBuffer extends pr implements Buffer {

	@OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/uca;)V")
	public GeometryBuffer(@OriginalArg(0) uca arg0) {
		super(arg0);
		this.init();
	}
