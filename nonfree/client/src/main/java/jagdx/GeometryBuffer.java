...
public final class GeometryBuffer extends fe implements Buffer {

	@OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/ca;)V")
	public GeometryBuffer(@OriginalArg(0) ca arg0) {
		super(arg0);
		this.init();
	}
