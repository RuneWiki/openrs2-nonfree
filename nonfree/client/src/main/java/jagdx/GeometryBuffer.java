...
public final class GeometryBuffer extends jd implements Buffer {

	@OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/ks;)V")
	public GeometryBuffer(@OriginalArg(0) ks arg0) {
		super(arg0);
		this.init();
	}
