...
public final class GeometryBuffer extends pd implements Buffer {

	@OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/wn;)V")
	public GeometryBuffer(@OriginalArg(0) wn arg0) {
		super(arg0);
		this.init();
	}
	...
	public void a(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg0.length < arg3 + arg1 | arg0 == null | arg1 < 0 | arg2 < 0 || this.getSize() < arg3 + arg2) {
			throw new dk();
		}
