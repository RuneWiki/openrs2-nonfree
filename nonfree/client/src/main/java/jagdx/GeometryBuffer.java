...
public final class GeometryBuffer extends qu implements Buffer {

	@OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/naa;)V")
	public GeometryBuffer(@OriginalArg(0) naa arg0) {
		super(arg0);
		this.init();
	}
