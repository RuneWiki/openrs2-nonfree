...
public final class GeometryBuffer extends je implements Buffer {

	@OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/dba;)V")
	public GeometryBuffer(@OriginalArg(0) dba arg0) {
		super(arg0);
		this.init();
	}
