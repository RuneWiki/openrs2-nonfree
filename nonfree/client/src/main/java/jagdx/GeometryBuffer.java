...
public final class GeometryBuffer extends qp implements Buffer {

	@OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/pi;)V")
	public GeometryBuffer(@OriginalArg(0) pi arg0) {
		super(arg0);
		this.init();
	}
