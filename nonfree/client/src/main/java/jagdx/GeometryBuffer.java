...
public final class GeometryBuffer extends tk implements Buffer {

	@OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/cv;)V")
	public GeometryBuffer(@OriginalArg(0) cv arg0) {
		super(arg0);
		this.init();
	}
