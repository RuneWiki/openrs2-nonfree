...
public final class GeometryBuffer extends jj implements Buffer {

	@OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/in;)V")
	public GeometryBuffer(@OriginalArg(0) in arg0) {
		super(arg0);
		this.init();
	}
	...
	public void a(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg1 < 0 | arg0 == null | arg0.length < arg3 + arg1 | arg2 < 0 || arg3 + arg2 > this.getSize()) {
			throw new fn();
		}
