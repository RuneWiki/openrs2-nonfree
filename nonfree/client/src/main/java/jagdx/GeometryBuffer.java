...
public final class GeometryBuffer extends uca implements Buffer {

	@OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/wf;)V")
	public GeometryBuffer(@OriginalArg(0) wf arg0) {
		super(arg0);
		this.init();
	}
