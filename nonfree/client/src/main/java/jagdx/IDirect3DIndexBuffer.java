...
public final class IDirect3DIndexBuffer extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DIndexBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/pba;)V")
	public IDirect3DIndexBuffer(@OriginalArg(0) pba arg0) {
		super(arg0);
	}
