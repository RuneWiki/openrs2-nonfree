...
public final class IDirect3DIndexBuffer extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DIndexBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/mba;)V")
	public IDirect3DIndexBuffer(@OriginalArg(0) mba arg0) {
		super(arg0);
	}
