...
public final class IDirect3DIndexBuffer extends IUnknown {
	...
	@OriginalMember(owner = "client!jagdx/IDirect3DIndexBuffer", name = "<init>", descriptor = "(Lclient!jaclib/peer/naa;)V")
	public IDirect3DIndexBuffer(@OriginalArg(0) naa arg0) {
		super(arg0);
	}
