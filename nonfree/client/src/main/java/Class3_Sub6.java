...
public final class Class3_Sub6 extends Class3 {
	...
	private void method646(@OriginalArg(0) byte[] arg0) {
		...
		this.anInt687 = local4.method6014();
		this.anInt688 = local4.method6014();
		this.anInt685 = local4.method6014();
		this.anInt690 = local4.method6014();
		if (this.anInt690 < 0) {
			this.anInt690 = ~this.anInt690;
			this.aBoolean31 = true;
		}
		@Pc(40) int local40 = local4.method6014();
		this.aByteArrayArray1 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method6053();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method6032(local64, local49);
			this.aByteArrayArray1[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!bb", name = "a", descriptor = "([I)Lclient!eb;")
	public Class3_Sub13_Sub1 method651(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray6 == null) {
			this.anInt691 = 0;
			this.aFloatArray8 = new float[Static23.anInt683];
			this.aByteArray6 = new byte[this.anInt688];
			this.anInt693 = 0;
			this.anInt694 = 0;
		}
		while (this.anInt694 < this.aByteArrayArray1.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method654(this.anInt694);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt693;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt688 - local47) {
					local50 = this.anInt688 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt693;
				}
				this.anInt693 = local47;
			}
			this.anInt694++;
		}
		...
		return new Class3_Sub13_Sub1(this.anInt687, local129, this.anInt685, this.anInt690, this.aBoolean31);
	}

	@OriginalMember(owner = "client!bb", name = "e", descriptor = "(I)[F")
	private float[] method654(@OriginalArg(0) int arg0) {
		Static23.method656(this.aByteArrayArray1[arg0]);
		Static23.method653();
		@Pc(15) int local15 = Static23.method648(Static345.method4948(Static23.anIntArray53.length - 1));
		@Pc(19) boolean local19 = Static23.aBooleanArray4[local15];
		@Pc(25) int local25 = local19 ? Static23.anInt683 : Static23.anInt686;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static23.method653() != 0;
			local29 = Static23.method653() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static23.anInt686 >> 2);
			local67 = (local25 >> 2) + (Static23.anInt686 >> 2);
			local71 = Static23.anInt686 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static23.anInt686 >> 2);
			local104 = local25 + (Static23.anInt686 >> 2) - (local25 >> 2);
			local108 = Static23.anInt686 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class176 local123 = Static23.aClass176Array1[Static23.anIntArray53[local15]];
		@Pc(126) int local126 = local123.anInt5253;
		@Pc(131) int local131 = local123.anIntArray402[local126];
		@Pc(140) boolean local140 = !Static23.aClass268Array1[local131].method5980();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt5254; local144++) {
			@Pc(152) Class222 local152 = Static23.aClass222Array1[local123.anIntArray403[local144]];
			local154 = Static23.aFloatArray3;
			local152.method5275(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt5253;
			local176 = local123.anIntArray402[local171];
			Static23.aClass268Array1[local176].method5982(Static23.aFloatArray3, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static23.aFloatArray3[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static23.aFloatArray3;
			...
			@Pc(252) float[] local252 = local19 ? Static23.aFloatArray7 : Static23.aFloatArray9;
			@Pc(258) float[] local258 = local19 ? Static23.aFloatArray10 : Static23.aFloatArray6;
			@Pc(264) float[] local264 = local19 ? Static23.aFloatArray5 : Static23.aFloatArray4;
			@Pc(270) int[] local270 = local19 ? Static23.anIntArray51 : Static23.anIntArray52;
			...
			@Pc(486) int local486 = Static345.method4948(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static23.aFloatArray3[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static23.aFloatArray3[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt691 > 0) {
			local176 = this.anInt691 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean32) {
				for (local212 = 0; local212 < this.anInt689; local212++) {
					local1254 = (this.anInt691 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static23.aFloatArray3[local212];
				}
			}
		}
		local154 = this.aFloatArray8;
		this.aFloatArray8 = Static23.aFloatArray3;
		Static23.aFloatArray3 = local154;
		this.anInt691 = local25;
		this.anInt689 = local104 - (local25 >> 1);
