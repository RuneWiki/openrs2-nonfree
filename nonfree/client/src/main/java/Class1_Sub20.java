...
public final class Class1_Sub20 extends Class1 {
	...
	private void method2122(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub16 local4 = new Class1_Sub16(arg0);
		this.anInt2669 = local4.method3784();
		this.anInt2668 = local4.method3784();
		this.anInt2665 = local4.method3784();
		this.anInt2666 = local4.method3784();
		if (this.anInt2666 < 0) {
			this.anInt2666 = ~this.anInt2666;
			this.aBoolean106 = true;
		}
		@Pc(40) int local40 = local4.method3784();
		this.aByteArrayArray7 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method3793();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method3792(local64, local49);
			this.aByteArrayArray7[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!lj", name = "g", descriptor = "(I)[F")
	private float[] method2123(@OriginalArg(0) int arg0) {
		Static121.method2127(this.aByteArrayArray7[arg0]);
		Static121.method2124();
		@Pc(15) int local15 = Static121.method2120(Static7.method107(Static121.anIntArray159.length - 1));
		@Pc(19) boolean local19 = Static121.aBooleanArray17[local15];
		@Pc(25) int local25 = local19 ? Static121.anInt2671 : Static121.anInt2676;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static121.method2124() != 0;
			local29 = Static121.method2124() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static121.anInt2676 >> 2);
			local67 = (local25 >> 2) + (Static121.anInt2676 >> 2);
			local71 = Static121.anInt2676 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static121.anInt2676 >> 2);
			local104 = local25 + (Static121.anInt2676 >> 2) - (local25 >> 2);
			local108 = Static121.anInt2676 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class14 local123 = Static121.aClass14Array1[Static121.anIntArray159[local15]];
		@Pc(126) int local126 = local123.anInt428;
		@Pc(131) int local131 = local123.anIntArray20[local126];
		@Pc(140) boolean local140 = !Static121.aClass110Array1[local131].method3266();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt429; local144++) {
			@Pc(152) Class63 local152 = Static121.aClass63Array1[local123.anIntArray19[local144]];
			local154 = Static121.aFloatArray5;
			local152.method1840(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt428;
			local176 = local123.anIntArray20[local171];
			Static121.aClass110Array1[local176].method3268(Static121.aFloatArray5, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static121.aFloatArray5[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static121.aFloatArray5;
			...
			@Pc(252) float[] local252 = local19 ? Static121.aFloatArray8 : Static121.aFloatArray6;
			@Pc(258) float[] local258 = local19 ? Static121.aFloatArray7 : Static121.aFloatArray1;
			@Pc(264) float[] local264 = local19 ? Static121.aFloatArray3 : Static121.aFloatArray2;
			@Pc(270) int[] local270 = local19 ? Static121.anIntArray160 : Static121.anIntArray161;
			...
			@Pc(486) int local486 = Static7.method107(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static121.aFloatArray5[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static121.aFloatArray5[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt2670 > 0) {
			local176 = this.anInt2670 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean105) {
				for (local212 = 0; local212 < this.anInt2672; local212++) {
					local1254 = (this.anInt2670 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static121.aFloatArray5[local212];
				}
			}
		}
		local154 = this.aFloatArray4;
		this.aFloatArray4 = Static121.aFloatArray5;
		Static121.aFloatArray5 = local154;
		this.anInt2670 = local25;
		this.anInt2672 = local104 - (local25 >> 1);
		this.aBoolean105 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!lj", name = "a", descriptor = "([I)Lclient!oh;")
	public Class1_Sub6_Sub1 method2125(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray24 == null) {
			this.anInt2670 = 0;
			this.aFloatArray4 = new float[Static121.anInt2671];
			this.aByteArray24 = new byte[this.anInt2668];
			this.anInt2675 = 0;
			this.anInt2674 = 0;
		}
		while (this.anInt2674 < this.aByteArrayArray7.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method2123(this.anInt2674);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2675;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt2668 - local47) {
					local50 = this.anInt2668 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray24[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2675;
				}
				this.anInt2675 = local47;
			}
			this.anInt2674++;
		}
		this.aFloatArray4 = null;
		@Pc(129) byte[] local129 = this.aByteArray24;
		this.aByteArray24 = null;
		return new Class1_Sub6_Sub1(this.anInt2669, local129, this.anInt2665, this.anInt2666, this.aBoolean106);
	}
}
