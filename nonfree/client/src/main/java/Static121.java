...
public final class Static121 {
	...
	public static void method1967(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		if (arg0 < anInt2986) {
			arg2 -= anInt2986 - arg0;
			arg0 = anInt2986;
		}
		...
		if (arg0 + arg2 > anInt2985) {
			arg2 = anInt2985 - arg0;
		}
		if (arg1 + arg3 > anInt2987) {
			arg3 = anInt2987 - arg1;
		}
		...
		@Pc(69) int local69 = anInt2988 - arg2;
		@Pc(75) int local75 = arg0 + arg1 * anInt2988;
		for (@Pc(77) int local77 = 0; local77 < arg3; local77++) {
			for (@Pc(81) int local81 = -arg2; local81 < 0; local81++) {
				@Pc(92) int local92 = (anIntArray338[local75] >> 16 & 0xFF) * local43;
				@Pc(102) int local102 = (anIntArray338[local75] >> 8 & 0xFF) * local43;
				@Pc(110) int local110 = (anIntArray338[local75] & 0xFF) * local43;
				@Pc(132) int local132 = (local51 + local92 >> 8 << 16) + (local59 + local102 >> 8 << 8) + (local65 + local110 >> 8);
				anIntArray338[local75++] = local132;
			}
			local75 += local69;
		}
	}
	...
	public static void method1968(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg0 < anInt2986 || arg0 >= anInt2985) {
			return;
		}
		if (arg1 < anInt2989) {
			arg2 -= anInt2989 - arg1;
		...
		if (arg1 + arg2 > anInt2987) {
			arg2 = anInt2987 - arg1;
		}
		@Pc(32) int local32 = arg0 + arg1 * anInt2988;
		for (@Pc(34) int local34 = 0; local34 < arg2; local34++) {
			anIntArray338[local32 + local34 * anInt2988] = arg3;
		}
	}

	@OriginalMember(owner = "client!wb", name = "b", descriptor = "(IIII)V")
	public static void method1969(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg0 < 0) {
			arg0 = 0;
		}
		if (arg1 < 0) {
	...
	public static void method1970() {
		@Pc(1) int local1 = 0;
		@Pc(7) int local7 = anInt2988 * anInt2984 - 7;
		while (local1 < local7) {
			anIntArray338[local1++] = 0;
			anIntArray338[local1++] = 0;
			anIntArray338[local1++] = 0;
			anIntArray338[local1++] = 0;
			anIntArray338[local1++] = 0;
	...
	private static void method1972(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg1 < anInt2989 || arg1 >= anInt2987) {
			return;
		}
		if (arg0 < anInt2986) {
			arg2 -= anInt2986 - arg0;
		...
		@Pc(58) int local58 = arg0 + arg1 * anInt2988;
		for (@Pc(60) int local60 = 0; local60 < arg2; local60++) {
			@Pc(71) int local71 = (anIntArray338[local58] >> 16 & 0xFF) * local30;
			@Pc(81) int local81 = (anIntArray338[local58] >> 8 & 0xFF) * local30;
			@Pc(89) int local89 = (anIntArray338[local58] & 0xFF) * local30;
			@Pc(111) int local111 = (local38 + local71 >> 8 << 16) + (local46 + local81 >> 8 << 8) + (local52 + local89 >> 8);
			anIntArray338[local58++] = local111;
		}
	}

	@OriginalMember(owner = "client!wb", name = "b", descriptor = "(IIIIII)V")
	public static void method1973(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		method1972(arg0, arg1, arg2, arg4, arg5);
		method1972(arg0, arg1 + arg3 - 1, arg2, arg4, arg5);
		if (arg3 >= 3) {
			method1980(arg0, arg1 + 1, arg3 - 2, arg4, arg5);
			method1980(arg0 + arg2 - 1, arg1 + 1, arg3 - 2, arg4, arg5);
		}
	}
	...
	public static void method1975(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(32) int local32 = arg0 + arg1 * anInt2988;
		for (@Pc(34) int local34 = 0; local34 < arg2; local34++) {
			anIntArray338[local32 + local34] = arg3;
		}
	}

	@OriginalMember(owner = "client!wb", name = "c", descriptor = "(IIIII)V")
	public static void method1976(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg0 < anInt2986) {
			arg2 -= anInt2986 - arg0;
			arg0 = anInt2986;
		}
		...
		@Pc(43) int local43 = anInt2988 - arg2;
		@Pc(49) int local49 = arg0 + arg1 * anInt2988;
		for (@Pc(52) int local52 = -arg3; local52 < 0; local52++) {
			for (@Pc(56) int local56 = -arg2; local56 < 0; local56++) {
				anIntArray338[local49++] = arg4;
			}
			local49 += local43;
		}
	}
	...
	public static void method1977(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		anIntArray338 = arg0;
		anInt2988 = arg1;
		anInt2984 = arg2;
		method1969(0, 0, arg1, arg2);
	}
	...
	public static void method1979(@OriginalArg(0) int[] arg0) {
		arg0[0] = anInt2986;
		arg0[1] = anInt2989;
		arg0[2] = anInt2985;
		arg0[3] = anInt2987;
	...
	private static void method1980(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg0 < anInt2986 || arg0 >= anInt2985) {
			return;
		}
		if (arg1 < anInt2989) {
	...
	public static void method1982(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		arg2 -= arg0;
		arg3 -= arg1;
		if (arg3 == 0) {
			if (arg2 >= 0) {
				method1975(arg0, arg1, arg2 + 1, arg4);
			} else {
				method1975(arg0 + arg2, arg1, 1 - arg2, arg4);
			}
		} else if (arg2 != 0) {
			if (arg2 + arg3 < 0) {
				arg0 += arg2;
			...
			if (arg2 > arg3) {
				...
				while (arg0 <= arg2) {
					local125 = arg1 >> 16;
					if (local125 >= anInt2989 && local125 < anInt2987) {
						anIntArray338[arg0 + local125 * anInt2988] = arg4;
					}
					arg1 += local96;
					arg0++;
				}
				...
				while (arg1 <= arg3) {
					local125 = arg0 >> 16;
					if (local125 >= anInt2986 && local125 < anInt2985) {
						anIntArray338[local125 + arg1 * anInt2988] = arg4;
					}
					arg0 += local96;
					arg1++;
				}
