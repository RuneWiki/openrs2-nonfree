...
public final class Class24_Sub12 extends Class24 {

	@OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(ILclient!hia;)V")
	public Class24_Sub12(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub20 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(Lclient!hia;)V")
	public Class24_Sub12(@OriginalArg(0) Class5_Sub20 arg0) {
		super(arg0);
	}
	...
	public void method8874() {
		if (super.anInt10335 < 0 && super.anInt10335 > 127) {
