...
public final class Class25_Sub1 extends Class25 {
	...
	@OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(ILclient!rq;Lclient!rq;Lclient!pp;Lclient!ro;IIZ)V", line = 794)
	public Class25_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) Class207 arg1, @OriginalArg(2) Class207 arg2, @OriginalArg(3) Class183 arg3, @OriginalArg(4) Class206 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean arg7) {
		...
		if (this.aClass207_2 != null) {
			this.aClass2_Sub2_Sub10_1 = this.aClass206_2.method5227(this.anInt668, this.aClass207_2);
		}
	}
	...
	public void method892() {
		...
		for (@Pc(24) Class2 local24 = this.aClass135_12.method3552(); local24 != null; local24 = this.aClass135_12.method3553()) {
			@Pc(30) int local30 = (int) local24.aLong232;
			if (local30 < 0 || local30 >= this.aClass198_1.anInt5580 || this.aClass198_1.anIntArray376[local30] == 0) {
				local24.method6469();
			} else {
	...
	public void method894() {
		if (this.aClass135_11 != null) {
			...
			if (this.aBoolean57) {
				local25 = true;
				for (local30 = this.aClass135_11.method3552(); local30 != null; local30 = this.aClass135_11.method3553()) {
				...
				while (this.anInt688 < this.aClass198_1.anIntArray376.length) {
					if (this.aClass198_1.anIntArray376[this.anInt688] == 0) {
						...
						if (this.aClass206_2.anInt5729 >= 250) {
							local25 = false;
							break;
						}
						...
						if (this.aByteArray5[this.anInt688] == 0) {
							...
							this.aClass135_11.method3541(local129);
							local25 = false;
						}
						this.anInt688++;
					}
				...
				while (this.anInt688 < this.aClass198_1.anIntArray376.length) {
					if (this.aClass198_1.anIntArray376[this.anInt688] == 0) {
						...
						if (this.aClass183_1.method4637()) {
							local25 = false;
							break;
						}
		...
		if (!this.aBoolean58 || Static190.method3686() < this.aLong21) {
			return;
		}
		...
		this.aLong21 = Static190.method3686() + 1000L;
	}

	@OriginalMember(owner = "client!bl", name = "c", descriptor = "(B)I", line = 238)
	public int method895() {
		return this.aClass198_1 == null ? 0 : this.aClass198_1.anInt5579;
	}

	@OriginalMember(owner = "client!bl", name = "b", descriptor = "(Z)I", line = 259)
	public int method896() {
		if (this.method884() == null) {
			return this.aClass2_Sub2_Sub10_1 == null ? 0 : this.aClass2_Sub2_Sub10_1.method5652();
		} else {
			return 100;
		}
	}
	...
	public byte[] method889(@OriginalArg(0) int arg0) {
		...
		if (local9 == null) {
			...
			@Pc(17) byte[] local17 = local9.method5649();
			local9.method6469();
			return local17;
		}
	}
	...
	public int method897() {
		if (this.aClass198_1 == null) {
			...
			@Pc(20) Class2 local20 = this.aClass135_11.method3552();
			return local20 == null ? 0 : (int) local20.aLong232;
		} else {
			return this.aClass198_1.anInt5579;
		}
	}
	...
	@OriginalMember(owner = "client!bl", name = "b", descriptor = "(III)Lclient!ut;", line = 421)
	private Class2_Sub2_Sub10 method901(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		...
		if (local13 == null) {
			if (arg1 == 0) {
				if (this.aClass207_3 == null || this.aByteArray5[arg0] == -1) {
					if (this.aClass183_1.method4645()) {
						return null;
					}
					local13 = this.aClass183_1.method4643(true, this.anInt668, (byte) 2, arg0);
				} else {
				...
				local13 = this.aClass206_2.method5228(arg0, this.aClass207_3);
			} else if (arg1 == 2) {
				if (this.aClass207_3 == null) {
					throw new RuntimeException();
				}
				...
				local13 = this.aClass183_1.method4643(false, this.anInt668, (byte) 2, arg0);
			} else {
				throw new RuntimeException();
			}
		...
		@Pc(162) byte[] local162 = local13.method5649();
		@Pc(189) int local189;
		...
		if (!(local13 instanceof Class2_Sub2_Sub10_Sub2)) {
			try {
				...
				Class2_Sub18.aCRC32_1.reset();
				Class2_Sub18.aCRC32_1.update(local162, 0, local162.length - 2);
				local189 = (int) Class2_Sub18.aCRC32_1.getValue();
				if (this.aClass198_1.anIntArray382[arg0] != local189) {
					throw new RuntimeException();
				}
				this.aClass183_1.anInt5053 = 0;
				this.aClass183_1.anInt5052 = 0;
			} catch (@Pc(350) RuntimeException local350) {
				this.aClass183_1.method4644();
				local13.method6469();
				if (local13.aBoolean418 && !this.aClass183_1.method4645()) {
					local292 = this.aClass183_1.method4643(true, this.anInt668, (byte) 2, arg0);
			...
			if (this.aClass207_3 != null) {
				this.aClass206_2.method5230(local162, arg0, this.aClass207_3);
				if (this.aByteArray5[arg0] != 1) {
					this.anInt685++;
	...
	public void method885(@OriginalArg(0) int arg0) {
		...
		for (@Pc(20) Class2 local20 = this.aClass135_12.method3552(); local20 != null; local20 = this.aClass135_12.method3553()) {
		...
		this.aClass135_12.method3541(local46);
	}
	...
	public int method887(@OriginalArg(0) int arg0) {
		...
		return local19 == null ? 0 : local19.method5652();
	}

	@OriginalMember(owner = "client!bl", name = "a", descriptor = "(Z)Lclient!ra;", line = 691)
	@Override
	public Class198 method884() {
		...
		if (this.aClass2_Sub2_Sub10_1 == null) {
			...
			this.aClass2_Sub2_Sub10_1 = this.aClass183_1.method4643(true, 255, (byte) 0, this.anInt668);
		}
		if (this.aClass2_Sub2_Sub10_1.aBoolean416) {
			return null;
		}
		@Pc(48) byte[] local48 = this.aClass2_Sub2_Sub10_1.method5649();
		if (this.aClass2_Sub2_Sub10_1 instanceof Class2_Sub2_Sub10_Sub2) {
			try {
				...
				if (this.anInt683 != this.aClass198_1.anInt5575) {
					throw new RuntimeException();
				}
			...
			if (this.aClass207_2 != null) {
				this.aClass206_2.method5230(local48, this.anInt668, this.aClass207_2);
			}
		}
		this.aClass2_Sub2_Sub10_1 = null;
		if (this.aClass207_3 != null) {
			this.anInt685 = 0;
			this.aByteArray5 = new byte[this.aClass198_1.anInt5580];
		}
		return this.aClass198_1;
	}
}
