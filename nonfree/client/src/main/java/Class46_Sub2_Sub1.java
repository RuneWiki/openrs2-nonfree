...
public final class Class46_Sub2_Sub1 extends Class46_Sub2 {
	...
	@OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Lclient!me;[IIIII)V")
	public Class46_Sub2_Sub1(@OriginalArg(0) Class37_Sub2 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		super(arg0, arg4, arg5);
		this.anIntArray238 = new int[arg4 * arg5];
		...
		for (@Pc(19) int local19 = 0; local19 < arg5; local19++) {
			for (@Pc(22) int local22 = 0; local22 < arg4; local22++) {
				this.anIntArray238[local17++] = arg1[arg2++];
			}
			arg2 += local15;
		}
	}

	@OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Lclient!me;[III)V")
	public Class46_Sub2_Sub1(@OriginalArg(0) Class37_Sub2 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		super(arg0, arg2, arg3);
		this.anIntArray238 = arg1;
	}

	@OriginalMember(owner = "client!ii", name = "a", descriptor = "(IILclient!or;II)V")
	@Override
	public void method5018(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class124 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		for (@Pc(212) int local212 = local171; local212 < local210; local212++) {
			...
			for (@Pc(304) int local304 = -local227; local304 < 0; local304++) {
				@Pc(311) int local311 = this.anIntArray238[local19++];
	...
	public void method5029(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		for (@Pc(5) int local5 = 0; local5 < arg3; local5++) {
			...
			for (@Pc(24) int local24 = 0; local24 < arg2; local24++) {
				this.anIntArray238[local14 + local24] = local3[local22 + local24] & 0xFFFFFF;
			}
		}
	}
		...
		if (Static169.anInt5927 == 0) {
			if (Static169.anInt5929 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local27 >= 0 && local25 - (super.anInt5944 << 12) < 0 && local27 - (super.anInt5934 << 12) < 0) {
							...
							while (local29 < 0) {
								local111 = this.anIntArray238[(local27 >> 12) * super.anInt5944 + (local25 >> 12)];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt5944 << 12) < 0) {
							@Pc(210) int local210;
							if ((local210 = local27 - (super.anInt5934 << 12)) >= 0) {
								local217 = (Static169.anInt5929 - local210) / Static169.anInt5929;
								local29 += local217;
								local27 += Static169.anInt5929 * local217;
								local23 += local217;
							}
							@Pc(238) int local238;
							if ((local238 = (local27 - Static169.anInt5929) / Static169.anInt5929) > local29) {
								local29 = local238;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt5944 << 12) < 0) {
							if (local27 < 0) {
								local217 = (Static169.anInt5929 - local27 - 1) / Static169.anInt5929;
								local29 += local217;
								local27 += Static169.anInt5929 * local217;
								local23 += local217;
							}
							@Pc(441) int local441;
							if ((local441 = (local27 + 1 - (super.anInt5934 << 12) - Static169.anInt5929) / Static169.anInt5929) > local29) {
								local29 = local441;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
			...
			if (Static169.anInt5929 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local27 >= 0 && local27 - (super.anInt5934 << 12) < 0) {
							@Pc(618) int local618;
							if ((local618 = local25 - (super.anInt5944 << 12)) >= 0) {
								local217 = (Static169.anInt5927 - local618) / Static169.anInt5927;
								local29 += local217;
								local25 += Static169.anInt5927 * local217;
								local23 += local217;
							}
							@Pc(646) int local646;
							if ((local646 = (local25 - Static169.anInt5927) / Static169.anInt5927) > local29) {
								local29 = local646;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static169.anInt5947;
						@Pc(814) int local814;
						if ((local814 = local25 - (super.anInt5944 << 12)) >= 0) {
							local217 = (Static169.anInt5927 - local814) / Static169.anInt5927;
							local29 += local217;
							local25 += Static169.anInt5927 * local217;
							local27 += Static169.anInt5929 * local217;
							local23 += local217;
						...
						@Pc(848) int local848;
						if ((local848 = (local25 - Static169.anInt5927) / Static169.anInt5927) > local29) {
							local29 = local848;
						}
						@Pc(860) int local860;
						if ((local860 = local27 - (super.anInt5934 << 12)) >= 0) {
							local217 = (Static169.anInt5929 - local860) / Static169.anInt5929;
							local29 += local217;
							local25 += Static169.anInt5927 * local217;
							local27 += Static169.anInt5929 * local217;
							local23 += local217;
						...
						@Pc(894) int local894;
						if ((local894 = (local27 - Static169.anInt5929) / Static169.anInt5929) > local29) {
							local29 = local894;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if ((local1068 = local25 - (super.anInt5944 << 12)) >= 0) {
							local217 = (Static169.anInt5927 - local1068) / Static169.anInt5927;
							local29 += local217;
							local25 += Static169.anInt5927 * local217;
							local27 += Static169.anInt5929 * local217;
							local23 += local217;
						...
						if ((local1102 = (local25 - Static169.anInt5927) / Static169.anInt5927) > local29) {
							local29 = local1102;
						}
						if (local27 < 0) {
							local217 = (Static169.anInt5929 - local27 - 1) / Static169.anInt5929;
						...
						if ((local1150 = (local27 + 1 - (super.anInt5934 << 12) - Static169.anInt5929) / Static169.anInt5929) > local29) {
							local29 = local1150;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if (local27 >= 0 && local27 - (super.anInt5934 << 12) < 0) {
						if (local25 < 0) {
							local217 = (Static169.anInt5927 - local25 - 1) / Static169.anInt5927;
							local29 += local217;
							local25 += Static169.anInt5927 * local217;
							local23 += local217;
						}
						@Pc(1363) int local1363;
						if ((local1363 = (local25 + 1 - (super.anInt5944 << 12) - Static169.anInt5927) / Static169.anInt5927) > local29) {
							local29 = local1363;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1571 = (local25 + 1 - (super.anInt5944 << 12) - Static169.anInt5927) / Static169.anInt5927) > local29) {
						local29 = local1571;
					}
					@Pc(1583) int local1583;
					if ((local1583 = local27 - (super.anInt5934 << 12)) >= 0) {
						local217 = (Static169.anInt5929 - local1583) / Static169.anInt5929;
						local29 += local217;
						local25 += Static169.anInt5927 * local217;
						local27 += Static169.anInt5929 * local217;
						local23 += local217;
					...
					if ((local1617 = (local27 - Static169.anInt5929) / Static169.anInt5929) > local29) {
						local29 = local1617;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1827 = (local25 + 1 - (super.anInt5944 << 12) - Static169.anInt5927) / Static169.anInt5927) > local29) {
						local29 = local1827;
					}
					if (local27 < 0) {
						local217 = (Static169.anInt5929 - local27 - 1) / Static169.anInt5929;
					...
					if ((local1875 = (local27 + 1 - (super.anInt5934 << 12) - Static169.anInt5929) / Static169.anInt5929) > local29) {
						local29 = local1875;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
	...
	protected void method5037(@OriginalArg(0) int arg0) {
		...
		if (Static169.anInt5927 == 0) {
			if (Static169.anInt5929 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local16 >= 0 && local14 - (super.anInt5944 << 12) < 0 && local16 - (super.anInt5934 << 12) < 0) {
						while (local18 < 0) {
							...
							local51 = local12++;
							if (arg0 == 0) {
								local162 = this.anIntArray238[local48];
								...
								local162 = this.anIntArray238[local48];
								local166 = (local162 >>> 24) * Static169.anInt5930 >> 8;
								local170 = 256 - local166;
								if ((Static169.anInt5942 & 0xFFFFFF) == 16777215) {
									local174 = local3[local51];
									local3[local51] = ((local162 & 0xFF00FF) * local166 + (local174 & 0xFF00FF) * local170 & 0xFF00FF00) + ((local162 & 0xFF00) * local166 + (local174 & 0xFF00) * local170 & 0xFF0000) >> 8;
								} else if (Static169.anInt5930 == 255) {
									local174 = (local162 & 0xFF0000) * Static169.anInt5939 & 0xFF000000;
									local288 = (local162 & 0xFF00) * Static169.anInt5935 & 0xFF0000;
									local296 = (local162 & 0xFF) * Static169.anInt5928 & 0xFF00;
								...
								local166 = local162 >>> 24;
								local170 = 256 - local166;
								local174 = (local162 & 0xFF00FF) * Static169.anInt5930 & 0xFF00FF00;
								local288 = (local162 & 0xFF00) * Static169.anInt5930 & 0xFF0000;
								local162 = ((local174 | local288) >>> 8) + Static169.anInt5941;
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt5944 << 12) < 0) {
						@Pc(703) int local703;
						if ((local703 = local16 - (super.anInt5934 << 12)) >= 0) {
							local710 = (Static169.anInt5929 - local703) / Static169.anInt5929;
							local18 += local710;
							local16 += Static169.anInt5929 * local710;
							local12 += local710;
						}
						@Pc(731) int local731;
						if ((local731 = (local16 - Static169.anInt5929) / Static169.anInt5929) > local18) {
							local18 = local731;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt5944 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt5944 << 12) < 0) {
						if (local16 < 0) {
							local710 = (Static169.anInt5929 - local16 - 1) / Static169.anInt5929;
							local18 += local710;
							local16 += Static169.anInt5929 * local710;
							local12 += local710;
						}
						@Pc(1438) int local1438;
						if ((local1438 = (local16 + 1 - (super.anInt5934 << 12) - Static169.anInt5929) / Static169.anInt5929) > local18) {
							local18 = local1438;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt5944 + (local14 >> 12);
			...
			if (Static169.anInt5929 == 0) {
				...
				while (local9 < 0) {
					...
					if (local16 >= 0 && local16 - (super.anInt5934 << 12) < 0) {
						...
						if ((local2119 = local14 - (super.anInt5944 << 12)) >= 0) {
							local710 = (Static169.anInt5927 - local2119) / Static169.anInt5927;
							local18 += local710;
							local14 += Static169.anInt5927 * local710;
							local12 += local710;
						}
						@Pc(2147) int local2147;
						if ((local2147 = (local14 - Static169.anInt5927) / Static169.anInt5927) > local18) {
							local18 = local2147;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt5944 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local2819 = local14 - (super.anInt5944 << 12)) >= 0) {
						local710 = (Static169.anInt5927 - local2819) / Static169.anInt5927;
						local18 += local710;
						local14 += Static169.anInt5927 * local710;
						local16 += Static169.anInt5929 * local710;
						local12 += local710;
					...
					if ((local2853 = (local14 - Static169.anInt5927) / Static169.anInt5927) > local18) {
						local18 = local2853;
					}
					@Pc(2865) int local2865;
					if ((local2865 = local16 - (super.anInt5934 << 12)) >= 0) {
						local710 = (Static169.anInt5929 - local2865) / Static169.anInt5929;
						local18 += local710;
						local14 += Static169.anInt5927 * local710;
						local16 += Static169.anInt5929 * local710;
						local12 += local710;
					...
					if ((local2899 = (local16 - Static169.anInt5929) / Static169.anInt5929) > local18) {
						local18 = local2899;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt5944 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local3577 = local14 - (super.anInt5944 << 12)) >= 0) {
						local710 = (Static169.anInt5927 - local3577) / Static169.anInt5927;
						local18 += local710;
						local14 += Static169.anInt5927 * local710;
						local16 += Static169.anInt5929 * local710;
						local12 += local710;
					...
					if ((local3611 = (local14 - Static169.anInt5927) / Static169.anInt5927) > local18) {
						local18 = local3611;
					}
					if (local16 < 0) {
						local710 = (Static169.anInt5929 - local16 - 1) / Static169.anInt5929;
					...
					if ((local3659 = (local16 + 1 - (super.anInt5934 << 12) - Static169.anInt5929) / Static169.anInt5929) > local18) {
						local18 = local3659;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt5944 + (local14 >> 12);
			...
			while (local9 < 0) {
				...
				if (local16 >= 0 && local16 - (super.anInt5934 << 12) < 0) {
					if (local14 < 0) {
						local710 = (Static169.anInt5927 - local14 - 1) / Static169.anInt5927;
						local18 += local710;
						local14 += Static169.anInt5927 * local710;
						local12 += local710;
					}
					@Pc(4376) int local4376;
					if ((local4376 = (local14 + 1 - (super.anInt5944 << 12) - Static169.anInt5927) / Static169.anInt5927) > local18) {
						local18 = local4376;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt5944 + (local14 >> 12);
			...
			for (local9 = Static169.anInt5950; local9 < 0; local9++) {
				...
				if ((local5088 = (local14 + 1 - (super.anInt5944 << 12) - Static169.anInt5927) / Static169.anInt5927) > local18) {
					local18 = local5088;
				}
				@Pc(5100) int local5100;
				if ((local5100 = local16 - (super.anInt5934 << 12)) >= 0) {
					local710 = (Static169.anInt5929 - local5100) / Static169.anInt5929;
					local18 += local710;
					local14 += Static169.anInt5927 * local710;
					local16 += Static169.anInt5929 * local710;
					local12 += local710;
				...
				if ((local5134 = (local16 - Static169.anInt5929) / Static169.anInt5929) > local18) {
					local18 = local5134;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt5944 + (local14 >> 12);
			...
			for (local9 = Static169.anInt5950; local9 < 0; local9++) {
				...
				if ((local5848 = (local14 + 1 - (super.anInt5944 << 12) - Static169.anInt5927) / Static169.anInt5927) > local18) {
					local18 = local5848;
				}
				if (local16 < 0) {
					local710 = (Static169.anInt5929 - local16 - 1) / Static169.anInt5929;
				...
				if ((local5896 = (local16 + 1 - (super.anInt5934 << 12) - Static169.anInt5929) / Static169.anInt5929) > local18) {
					local18 = local5896;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt5944 + (local14 >> 12);
		...
		if (super.aClass37_Sub2_8.method3754()) {
			...
			if (arg6 != 0) {
					...
					if (arg4 == 0) {
						...
						for (local261 = -arg3; local261 < 0; local261++) {
							...
							for (local272 = -arg2; local272 < 0; local272++) {
								local330 = this.anIntArray238[(local14 >> 16) + local269];
						...
						if ((arg5 & 0xFFFFFF) == 16777215) {
							...
							for (local330 = -arg3; local330 < 0; local330++) {
								...
								for (local341 = -arg2; local341 < 0; local341++) {
									local351 = this.anIntArray238[(local14 >> 16) + local338];
				...
				for (local261 = -arg3; local261 < 0; local261++) {
					local269 = (local16 >> 16) * super.anInt5944;
					for (local272 = -arg2; local272 < 0; local272++) {
						local252[local64++] = this.anIntArray238[(local14 >> 16) + local269];
						local14 += local44;
					}
					local16 += local50;
					local14 = local258;
	...
	public void method5024(@OriginalArg(2) int arg0) {
		...
		@Pc(25) int local25;
		if (arg0 == 0) {
			local5 = super.aClass37_Sub2_8.anIntArray323;
			for (local7 = 0; local7 < super.anInt5934; local7++) {
				local13 = local7 * super.anInt5944;
				local23 = local7 * super.aClass37_Sub2_8.lb;
				for (local25 = 0; local25 < super.anInt5944; local25++) {
					this.anIntArray238[local13 + local25] = this.anIntArray238[local13 + local25] & 0xFFFFFF | (local5[local23 + local25] & 0xFF0000) << 8;
				}
			}
		} else if (arg0 == 3) {
			local5 = super.aClass37_Sub2_8.anIntArray323;
			for (local7 = 0; local7 < super.anInt5934; local7++) {
				...
				local23 = local7 * super.aClass37_Sub2_8.lb;
				for (local25 = 0; local25 < super.anInt5944; local25++) {
					this.anIntArray238[local13 + local25] = this.anIntArray238[local13 + local25] & 0xFFFFFF | (local5[local23 + local25] == 0 ? 0 : -16777216);
				}
			}
		}
	}
		...
		if (arg2 == 0) {
			for (local424 = -local32; local424 < 0; local424++) {
				for (local428 = -local35; local428 < 0; local428++) {
					local435 = this.anIntArray238[local29++];
		...
		if (arg2 == 1) {
			if ((arg3 & 0xFFFFFF) == 16777215) {
				...
				for (local439 = -local32; local439 < 0; local439++) {
					for (local443 = -local35; local443 < 0; local443++) {
						local447 = this.anIntArray238[local29++];
			...
			for (local443 = -local32; local443 < 0; local443++) {
				for (local447 = -local35; local447 < 0; local447++) {
					local623 = this.anIntArray238[local29++];
