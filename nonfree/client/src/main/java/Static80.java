...
public final class Static80 {
	...
	public static Pix8 aClass4_Sub1_Sub2_Sub3_4;
	...
	public static Js5Provider aClass20_Sub1_55;

	@OriginalMember(owner = "client!oa", name = "U", descriptor = "[I")
	public static int[] anIntArray225;

	@OriginalMember(owner = "client!oa", name = "B", descriptor = "Lclient!ec;")
	private static JagString aClass22_626 = Static60.method1113("go back to the main RuneScape webpage");
	...
	public static JagString aClass22_627 = Static60.method1113("Wordpack geladen)3");

	@OriginalMember(owner = "client!oa", name = "Y", descriptor = "Lclient!ec;")
	public static JagString aClass22_628 = aClass22_626;

	@OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lclient!ea;I)V")
	public static void method1446(@OriginalArg(0) Js5Index arg0) {
	...
	public static JagException method1447(@OriginalArg(0) Throwable arg0, @OriginalArg(1) String arg1) {
		@Pc(9) JagException local9;
		if (arg0 instanceof JagException) {
			local9 = (JagException) arg0;
			local9.aString5 = local9.aString5 + ' ' + arg1;
		} else {
			local9 = new JagException(arg0, arg1);
		}
		return local9;
	}
