...
public final class Static305 {
	...
	public static int method1223(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lclient!om;II)Lclient!fe;")
	public static Class1_Sub8_Sub1 method1224(@OriginalArg(0) Class1_Sub22_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray70 == null || arg0.aByteArray70.length == 0 ? null : new Class1_Sub8_Sub1(arg0, (int) ((long) arg0.anInt3755 * 256L * (long) 100 / (long) (Static234.anInt4892 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!fe", name = "a", descriptor = "([B[IIIIIIILclient!fe;)I")
	public static int method1225(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub8_Sub1 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt1466 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!fe", name = "a", descriptor = "([B[IIIIIIIILclient!fe;)I")
	public static int method1227(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub8_Sub1 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt1472 += arg8.anInt1470 * (local24 - arg3);
		arg8.anInt1464 += arg8.anInt1462 * (local24 - arg3);
		local24 -= 3;
		@Pc(56) int local56;
		while (arg3 < local24) {
			local56 = arg3++;
		...
		arg8.anInt1461 = arg4 >> 2;
		arg8.anInt1466 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!fe", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!fe;)I")
	public static int method1229(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub8_Sub1 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt1461 += arg10.anInt1467 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(64) byte local64;
		...
		arg10.anInt1472 = arg4 >> 2;
		arg10.anInt1464 = arg5 >> 2;
		arg10.anInt1466 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!fe", name = "a", descriptor = "(II[B[IIIIIIILclient!fe;II)I")
	public static int method1230(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub8_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!fe", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!fe;II)I")
	public static int method1234(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub8_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1461 -= arg10.anInt1467 * arg3;
		@Pc(23) int local23;
		...
		local65 = arg3 >> 1;
		arg10.anInt1461 += arg10.anInt1467 * local65;
		arg10.anInt1472 = arg4;
		arg10.anInt1464 = arg5;
		arg10.anInt1466 = arg2;
		return local65;
	}

	@OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lclient!om;III)Lclient!fe;")
	public static Class1_Sub8_Sub1 method1236(@OriginalArg(0) Class1_Sub22_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray70 == null || arg0.aByteArray70.length == 0 ? null : new Class1_Sub8_Sub1(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!fe", name = "a", descriptor = "(II[B[IIIIIIIILclient!fe;II)I")
	public static int method1239(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub8_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1472 -= arg8.anInt1470 * arg3;
		arg8.anInt1464 -= arg8.anInt1462 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!fe", name = "a", descriptor = "(I[B[IIIIIIIILclient!fe;)I")
	public static int method1240(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub8_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!fe", name = "b", descriptor = "(II[B[IIIIIIIILclient!fe;II)I")
	public static int method1242(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub8_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!fe", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!fe;II)I")
	public static int method1243(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub8_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1461 -= arg10.anInt1467 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!fe", name = "c", descriptor = "(II[B[IIIIIIIILclient!fe;II)I")
	public static int method1244(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub8_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1472 -= arg8.anInt1470 * arg3;
		arg8.anInt1464 -= arg8.anInt1462 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!fe", name = "b", descriptor = "(I[B[IIIIIIIILclient!fe;)I")
	public static int method1245(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub8_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	public static int method1247(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!fe", name = "b", descriptor = "(II[B[IIIIIIILclient!fe;II)I")
	public static int method1248(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub8_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!fe", name = "d", descriptor = "(II[B[IIIIIIIILclient!fe;II)I")
	public static int method1253(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub8_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!fe", name = "b", descriptor = "([B[IIIIIIIILclient!fe;)I")
	public static int method1256(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub8_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1472 += arg8.anInt1470 * (local22 - arg3);
		arg8.anInt1464 += arg8.anInt1462 * (local22 - arg3);
		local22 -= 3;
		@Pc(54) int local54;
		while (arg3 < local22) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!fe", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!fe;)I")
	public static int method1258(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub8_Sub1 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt1461 += arg10.anInt1467 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!fe", name = "b", descriptor = "([B[IIIIIIILclient!fe;)I")
	public static int method1261(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub8_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
