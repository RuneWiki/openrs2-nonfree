...
public final class Static9 {
	...
	@OriginalMember(owner = "client!aea", name = "c", descriptor = "[Lclient!rk;")
	public static final Class290[] aClass290Array1 = new Class290[14];

	@OriginalMember(owner = "client!aea", name = "a", descriptor = "(ICI)C")
	public static char method100(@OriginalArg(1) char arg0, @OriginalArg(2) int arg1) {
		if (arg0 >= 'À' && arg0 <= 'ÿ') {
			if (arg0 >= 'À' && arg0 <= 'Æ') {
				return 'A';
			}
	...
	public static boolean method101(@OriginalArg(1) int arg0) {
