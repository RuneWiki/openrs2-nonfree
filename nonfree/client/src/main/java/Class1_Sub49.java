...
public final class Class1_Sub49 extends Class1 {
	...
	public Class1_Sub49(@OriginalArg(0) byte[] arg0) {
		this.method7601(arg0);
	}

	@OriginalMember(owner = "client!vp", name = "b", descriptor = "(I)[F")
	private float[] method7592(@OriginalArg(0) int arg0) {
		Static562.method7597(this.aByteArrayArray26[arg0]);
		Static562.method7591();
		@Pc(15) int local15 = Static562.method7598(Static77.method7407(Static562.anIntArray585.length - 1));
		@Pc(19) boolean local19 = Static562.aBooleanArray38[local15];
		@Pc(25) int local25 = local19 ? Static562.anInt9319 : Static562.anInt9311;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static562.method7591() != 0;
			local29 = Static562.method7591() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static562.anInt9311 >> 2);
			local67 = (local25 >> 2) + (Static562.anInt9311 >> 2);
			local71 = Static562.anInt9311 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static562.anInt9311 >> 2);
			local104 = local25 + (Static562.anInt9311 >> 2) - (local25 >> 2);
			local108 = Static562.anInt9311 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class163 local123 = Static562.aClass163Array1[Static562.anIntArray585[local15]];
		@Pc(126) int local126 = local123.anInt4284;
		@Pc(131) int local131 = local123.anIntArray217[local126];
		@Pc(140) boolean local140 = !Static562.aClass89Array1[local131].method2252();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt4283; local144++) {
			@Pc(152) Class224 local152 = Static562.aClass224Array1[local123.anIntArray216[local144]];
			local154 = Static562.aFloatArray82;
			local152.method4855(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt4284;
			local176 = local123.anIntArray217[local171];
			Static562.aClass89Array1[local176].method2258(Static562.aFloatArray82, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static562.aFloatArray82[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static562.aFloatArray82;
			...
			@Pc(252) float[] local252 = local19 ? Static562.aFloatArray87 : Static562.aFloatArray81;
			@Pc(258) float[] local258 = local19 ? Static562.aFloatArray88 : Static562.aFloatArray85;
			@Pc(264) float[] local264 = local19 ? Static562.aFloatArray83 : Static562.aFloatArray86;
			@Pc(270) int[] local270 = local19 ? Static562.anIntArray586 : Static562.anIntArray587;
			...
			@Pc(486) int local486 = Static77.method7407(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static562.aFloatArray82[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static562.aFloatArray82[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt9312 > 0) {
			local176 = this.anInt9312 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean694) {
				for (local212 = 0; local212 < this.anInt9320; local212++) {
					local1254 = (this.anInt9312 >> 1) + local212;
					local1228[local212] += this.aFloatArray84[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static562.aFloatArray82[local212];
				}
			}
		}
		local154 = this.aFloatArray84;
		this.aFloatArray84 = Static562.aFloatArray82;
		Static562.aFloatArray82 = local154;
		this.anInt9312 = local25;
		this.anInt9320 = local104 - (local25 >> 1);
		this.aBoolean694 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!vp", name = "a", descriptor = "([I)Lclient!bu;")
	public Class1_Sub13_Sub1 method7594(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray98 == null) {
			this.anInt9312 = 0;
			this.aFloatArray84 = new float[Static562.anInt9319];
			this.aByteArray98 = new byte[this.anInt9315];
			this.anInt9321 = 0;
			this.anInt9322 = 0;
		}
		while (this.anInt9322 < this.aByteArrayArray26.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method7592(this.anInt9322);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt9321;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt9315 - local47) {
					local50 = this.anInt9315 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray98[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt9321;
				}
				this.anInt9321 = local47;
			}
			this.anInt9322++;
		}
		this.aFloatArray84 = null;
		@Pc(129) byte[] local129 = this.aByteArray98;
		this.aByteArray98 = null;
		return new Class1_Sub13_Sub1(this.anInt9317, local129, this.anInt9316, this.anInt9314, this.aBoolean693);
	}

	@OriginalMember(owner = "client!vp", name = "b", descriptor = "([B)V")
	private void method7601(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub3 local4 = new Class1_Sub3(arg0);
		this.anInt9317 = local4.method7940();
		this.anInt9315 = local4.method7940();
		this.anInt9316 = local4.method7940();
		this.anInt9314 = local4.method7940();
		if (this.anInt9314 < 0) {
			this.anInt9314 = ~this.anInt9314;
			this.aBoolean693 = true;
		}
		@Pc(40) int local40 = local4.method7940();
		this.aByteArrayArray26 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method7974();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method7957(local64, local49);
			this.aByteArrayArray26[local46] = local64;
		}
	}
}
