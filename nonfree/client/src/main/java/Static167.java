...
public final class Static167 {
	...
	private static int anInt3468;

	@OriginalMember(owner = "client!kg", name = "b", descriptor = "[I")
	private static int[] anIntArray469;

	@OriginalMember(owner = "client!kg", name = "c", descriptor = "I")
	private static int anInt3469;

	@OriginalMember(owner = "client!kg", name = "d", descriptor = "I")
	private static int anInt3470;

	@OriginalMember(owner = "client!kg", name = "e", descriptor = "I")
	private static int anInt3471;

	@OriginalMember(owner = "client!kg", name = "f", descriptor = "I")
	private static int anInt3472;

	@OriginalMember(owner = "client!kg", name = "g", descriptor = "I")
	private static int anInt3473;

	@OriginalMember(owner = "client!kg", name = "h", descriptor = "I")
	private static int anInt3474;

	@OriginalMember(owner = "client!kg", name = "a", descriptor = "(II)V")
	private static void method3186(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg1 <= arg0 + 4) {
			return;
		}
		...
		method3186(arg0, local7);
		method3186(local7 + 4, arg1);
	}

	@OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lclient!pe;[II[I[I)V")
	public static void method3187(@OriginalArg(0) Class89 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4) {
		method3194(arg0, arg1, arg1.length, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!kg", name = "a", descriptor = "(I)Z")
	private static boolean method3188(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = anInt3474;
		@Pc(3) int local3 = anInt3470;
		@Pc(5) int local5 = anInt3473;
		while (local3 >= local1) {
			local5++;
			anInt3473 = local5;
			if (local5 >= arg0) {
			...
			@Pc(16) int local16 = anInt3468;
			@Pc(23) int local23;
			@Pc(30) int local30;
			while (local1 < anInt3471) {
			...
			if (local16 == anInt3471) {
				anInt3471 = 0;
				return false;
			}
			method3195(local16, local1);
			anInt3468 = local16;
			anInt3474 = local1;
			local3 = local16;
		}
		anInt3472 = anIntArray469[local3] >> 16;
		anInt3469 = anIntArray469[local3 + 4] >> 16;
	...
	private static void method3189(@OriginalArg(0) int arg0) {
		if (anInt3471 < 0) {
			anInt3470 = 0;
			anInt3474 = 0;
			anInt3468 = 0;
			anInt3473 = 2147483646;
			return;
		}
		method3186(0, anInt3471);
		@Pc(17) int local17 = anIntArray469[1];
		if (local17 < arg0) {
			local17 = arg0;
		}
		@Pc(26) int local26;
		for (local26 = 0; local26 < anInt3471; local26 += 4) {
	...
	@OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lclient!pe;[II)V")
	public static void method3191(@OriginalArg(0) Class89 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2) {
		method3194(arg0, arg1, arg1.length, arg2, null, null);
	}

	@OriginalMember(owner = "client!kg", name = "a", descriptor = "([III)V")
	private static void method3192(@OriginalArg(0) int[] arg0, @OriginalArg(2) int arg1) {
		@Pc(5) int local5 = anInt3471 + (arg1 << 1);
		@Pc(16) int local16;
		if (anIntArray469 == null || anIntArray469.length < local5) {
			@Pc(14) int[] local14 = new int[local5];
			for (local16 = 0; local16 < anInt3471; local16++) {
		...
		for (local16 = 0; local16 < local33; local16 += 2) {
			...
			if (local46 < local52) {
				anIntArray469[anInt3471++] = arg0[local37];
				anIntArray469[anInt3471++] = local46;
				anIntArray469[anInt3471++] = arg0[local16];
				anIntArray469[anInt3471++] = local52;
	...
	private static void method3193() {
		anInt3471 = 0;
	}

	@OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lclient!pe;[IIII[I[I)V")
	private static void method3194(@OriginalArg(0) Class89 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int[] arg4, @OriginalArg(6) int[] arg5) {
		@Pc(2) int[] local2 = new int[4];
		arg0.method5421(local2);
		if (arg4 != null && local2[3] - local2[1] != arg4.length) {
			throw new IllegalStateException();
		}
		method3193();
		method3192(arg1, arg2);
		method3189(local2[1]);
		while (true) {
			@Pc(33) int local33;
			@Pc(35) int local35;
			...
			arg0.method5408(local33, local37, local35 - local33, arg3, 1);
		}
	}

	@OriginalMember(owner = "client!kg", name = "b", descriptor = "(II)V")
	private static void method3195(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		while (true) {
			if (arg1 >= arg0 + 8) {
