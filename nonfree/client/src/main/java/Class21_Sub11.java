...
public final class Class21_Sub11 extends Class21 {
	...
	@OriginalMember(owner = "client!jha", name = "<init>", descriptor = "(ILclient!gp;)V")
	public Class21_Sub11(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub27 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!jha", name = "<init>", descriptor = "(Lclient!gp;)V")
	public Class21_Sub11(@OriginalArg(0) Class3_Sub27 arg0) {
		super(arg0);
	}
