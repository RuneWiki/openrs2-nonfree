...
public final class Class1_Sub34 extends Class1 {
	...
	private int anInt5035;

	@OriginalMember(owner = "client!ok", name = "H", descriptor = "I")
	private int anInt5036;

	@OriginalMember(owner = "client!ok", name = "M", descriptor = "I")
	private int anInt5038;
	...
	public Class1_Sub34(@OriginalArg(0) byte[] arg0) {
		this.method4184(arg0);
	}

	@OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)[F")
	private float[] method4178(@OriginalArg(0) int arg0) {
		Static288.method4179(this.aByteArrayArray16[arg0]);
		Static288.method4185();
		@Pc(15) int local15 = Static288.method4189(Static317.method4489(Static288.anIntArray440.length - 1));
		@Pc(19) boolean local19 = Static288.aBooleanArray37[local15];
		@Pc(25) int local25 = local19 ? Static288.anInt5031 : Static288.anInt5037;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static288.method4185() != 0;
			local29 = Static288.method4185() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static288.anInt5037 >> 2);
			local67 = (local25 >> 2) + (Static288.anInt5037 >> 2);
			local71 = Static288.anInt5037 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static288.anInt5037 >> 2);
			local104 = local25 + (Static288.anInt5037 >> 2) - (local25 >> 2);
			local108 = Static288.anInt5037 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class82 local123 = Static288.aClass82Array1[Static288.anIntArray440[local15]];
		@Pc(126) int local126 = local123.anInt2423;
		@Pc(131) int local131 = local123.anIntArray191[local126];
		@Pc(140) boolean local140 = !Static288.aClass50Array1[local131].method1441();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt2422; local144++) {
			@Pc(152) Class5 local152 = Static288.aClass5Array1[local123.anIntArray190[local144]];
			local154 = Static288.aFloatArray20;
			local152.method318(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt2423;
			local176 = local123.anIntArray191[local171];
			Static288.aClass50Array1[local176].method1439(Static288.aFloatArray20, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static288.aFloatArray20[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static288.aFloatArray20;
			...
			@Pc(252) float[] local252 = local19 ? Static288.aFloatArray16 : Static288.aFloatArray23;
			@Pc(258) float[] local258 = local19 ? Static288.aFloatArray18 : Static288.aFloatArray21;
			@Pc(264) float[] local264 = local19 ? Static288.aFloatArray19 : Static288.aFloatArray17;
			@Pc(270) int[] local270 = local19 ? Static288.anIntArray441 : Static288.anIntArray439;
			...
			@Pc(486) int local486 = Static317.method4489(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static288.aFloatArray20[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static288.aFloatArray20[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt5032 > 0) {
			local176 = this.anInt5032 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean344) {
				for (local212 = 0; local212 < this.anInt5036; local212++) {
					local1254 = (this.anInt5032 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static288.aFloatArray20[local212];
				}
			}
		}
		local154 = this.aFloatArray22;
		this.aFloatArray22 = Static288.aFloatArray20;
		Static288.aFloatArray20 = local154;
		this.anInt5032 = local25;
		this.anInt5036 = local104 - (local25 >> 1);
		this.aBoolean344 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!ok", name = "a", descriptor = "([I)Lclient!fv;")
	public Class1_Sub20_Sub1 method4180(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray71 == null) {
			this.anInt5032 = 0;
			this.aFloatArray22 = new float[Static288.anInt5031];
			this.aByteArray71 = new byte[this.anInt5035];
			this.anInt5040 = 0;
			this.anInt5039 = 0;
		}
		while (this.anInt5039 < this.aByteArrayArray16.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method4178(this.anInt5039);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt5040;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt5035 - local47) {
					local50 = this.anInt5035 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt5040;
				}
				this.anInt5040 = local47;
			}
			this.anInt5039++;
		}
		...
		return new Class1_Sub20_Sub1(this.anInt5030, local129, this.anInt5038, this.anInt5034, this.aBoolean343);
	}

	@OriginalMember(owner = "client!ok", name = "a", descriptor = "([B)V")
	private void method4184(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub5 local4 = new Class1_Sub5(arg0);
		this.anInt5030 = local4.method5407();
		this.anInt5035 = local4.method5407();
		this.anInt5038 = local4.method5407();
		this.anInt5034 = local4.method5407();
		if (this.anInt5034 < 0) {
			this.anInt5034 = ~this.anInt5034;
			this.aBoolean343 = true;
		}
		@Pc(40) int local40 = local4.method5407();
		this.aByteArrayArray16 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method5366();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method5391(local64, local49);
