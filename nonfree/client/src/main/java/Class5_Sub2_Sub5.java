...
public final class Class5_Sub2_Sub5 extends Class5_Sub2 {
	...
	public int[] method8820(@OriginalArg(1) int arg0) {
		...
		if (super.aClass246_41.aBoolean561) {
			@Pc(30) int[] local30 = this.method8821(arg0 - 1 & Static271.anInt4487, 0);
			@Pc(36) int[] local36 = this.method8821(arg0, 0);
			@Pc(46) int[] local46 = this.method8821(arg0 + 1 & Static271.anInt4487, 0);
			for (@Pc(48) int local48 = 0; local48 < Static314.anInt6320; local48++) {
				@Pc(62) int local62 = this.anInt1456 * (local46[local48] - local30[local48]);
				@Pc(82) int local82 = this.anInt1456 * (local36[Static550.anInt6610 & local48 + 1] - local36[local48 - 1 & Static550.anInt6610]);
	...
	@OriginalMember(owner = "client!dca", name = "a", descriptor = "(Lclient!ee;BI)V")
	@Override
	public void method8825(@OriginalArg(0) Class5_Sub12 arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 0) {
			this.anInt1456 = arg0.method8631();
		}
	}
}
