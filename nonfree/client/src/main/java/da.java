...
public final class da extends Class14 implements Interface10 {

	@OriginalMember(owner = "client!da", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!da", name = "k", descriptor = "Lclient!gw;")
	private final Class91 aClass91_11 = new Class91();

	@OriginalMember(owner = "client!da", name = "j", descriptor = "Lclient!c;")
	private final c aC1;
	...
	public native void H(@OriginalArg(0) Class4_Sub1_Sub6 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!da", name = "a", descriptor = "(Lclient!ni;[I)V")
	@Override
	public void method2555(@OriginalArg(0) Class4_Sub17 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass91_11.method2587(arg0);
		this.la(arg0.hashCode(), arg0.method6165(), arg0.method6162(), arg0.method6161(), arg0.method6160(), arg0.method6159(), arg1);
	}
	...
	public void method2549(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aC1.method893().ka(this, arg0, arg1);
	}
	...
	public void method2553(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass91_11.method2573()];
		for (@Pc(13) Class4_Sub17 local13 = (Class4_Sub17) this.aClass91_11.method2584(); local13 != null; local13 = (Class4_Sub17) this.aClass91_11.method2586()) {
	...
	public native Class4_Sub1_Sub6 q(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class4_Sub1_Sub6 arg2);
	...
	public native void ia(@OriginalArg(0) Class4_Sub1_Sub6 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method2551(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aC1.method893().S(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
}
