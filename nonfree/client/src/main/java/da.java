...
public final class da extends Class116 implements Interface1 {

	@OriginalMember(owner = "client!da", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!da", name = "p", descriptor = "Lclient!qa;")
	private final qa aQa1;

	@OriginalMember(owner = "client!da", name = "o", descriptor = "Lclient!na;")
	private final na aNa1;

	@OriginalMember(owner = "client!da", name = "m", descriptor = "[Lclient!ew;")
	public Class76[] aClass76Array1;

	@OriginalMember(owner = "client!da", name = "n", descriptor = "[Lclient!fs;")
	public Class88[] aClass88Array1;

	@OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lclient!qa;Lclient!na;Lclient!mb;IIII)V")
	public da(@OriginalArg(0) qa arg0, @OriginalArg(1) na arg1, @OriginalArg(2) Class166 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.aQa1 = arg0;
		this.aNa1 = arg1;
		this.aClass76Array1 = arg2.aClass76Array4;
		this.aClass88Array1 = arg2.aClass88Array4;
		@Pc(24) int local24 = arg2.aClass76Array4 == null ? 0 : arg2.aClass76Array4.length;
		@Pc(33) int local33 = arg2.aClass88Array4 == null ? 0 : arg2.aClass88Array4.length;
		@Pc(35) int local35 = 0;
		@Pc(42) int[] local42 = new int[local24 * 3 + local33];
		for (@Pc(44) int local44 = 0; local44 < local24; local44++) {
			local42[local35++] = this.aClass76Array1[local44].anInt1844;
			local42[local35++] = this.aClass76Array1[local44].anInt1845;
			local42[local35++] = this.aClass76Array1[local44].anInt1840;
		}
		for (@Pc(78) int local78 = 0; local78 < local33; local78++) {
			local42[local35++] = this.aClass88Array1[local78].anInt2132;
		}
		@Pc(101) int local101 = arg2.aClass254Array1 == null ? 0 : arg2.aClass254Array1.length;
		@Pc(106) int[] local106 = new int[local101 * 8];
		@Pc(108) int local108 = 0;
		for (@Pc(110) int local110 = 0; local110 < local101; local110++) {
			@Pc(116) Class254 local116 = arg2.aClass254Array1[local110];
			@Pc(121) Class108 local121 = Static177.method2489(local116.anInt7069);
			local106[local108++] = local116.anInt7065;
			local106[local108++] = local121.anInt2545;
			local106[local108++] = local121.anInt2548;
			local106[local108++] = local121.anInt2542;
			local106[local108++] = local121.anInt2543;
			local106[local108++] = local121.anInt2544;
			local106[local108++] = local121.aBoolean167 ? -1 : 0;
		}
		for (@Pc(173) int local173 = 0; local173 < local101; local173++) {
			@Pc(179) Class254 local179 = arg2.aClass254Array1[local173];
			local106[local108++] = local179.anInt7066;
		}
		this.q(this.aQa1, this.aNa1, arg2.anInt4011, arg2.anInt4013, arg2.anIntArray324, arg2.anIntArray326, arg2.anIntArray329, arg2.anIntArray332, arg2.aShortArray66, arg2.anInt4024, arg2.aShortArray69, arg2.aShortArray71, arg2.aShortArray73, arg2.aByteArray54, arg2.aByteArray52, arg2.aByteArray51, arg2.aByteArray50, arg2.aShortArray68, arg2.aShortArray74, arg2.anIntArray330, arg2.aByte71, arg2.aShortArray70, arg2.anInt4016, arg2.aByteArray48, arg2.aShortArray72, arg2.aShortArray75, arg2.aShortArray67, arg2.anIntArray325, arg2.anIntArray328, arg2.anIntArray327, arg2.aByteArray49, arg2.aByteArray53, arg2.anIntArray331, arg2.anIntArray335, arg2.anIntArray333, local42, local24, local33, arg3, arg4, arg5, arg6, local106);
	}
	...
	public native void h(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class41 arg2, @OriginalArg(3) Class41 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6);
	...
	public void method923(@OriginalArg(0) int arg0, @OriginalArg(1) Class35 arg1) {
		@Pc(1) int local1 = arg0;
		@Pc(6) int local6;
		if (this.aClass76Array1 != null) {
			for (local6 = 0; local6 < this.aClass76Array1.length; local6++) {
				@Pc(12) Class76 local12 = this.aClass76Array1[local6];
				local12.anInt1843 = Static319.anIntArray419[local1++];
				local12.anInt1850 = Static319.anIntArray419[local1++];
				local12.anInt1841 = Static319.anIntArray419[local1++];
				local12.anInt1835 = Static319.anIntArray419[local1++];
				local12.anInt1847 = Static319.anIntArray419[local1++];
				local12.anInt1839 = Static319.anIntArray419[local1++];
				local12.anInt1836 = Static319.anIntArray419[local1++];
				local12.anInt1848 = Static319.anIntArray419[local1++];
				local12.anInt1837 = Static319.anIntArray419[local1++];
			}
		}
		if (this.aClass88Array1 == null) {
			return;
		}
		for (local6 = 0; local6 < this.aClass88Array1.length; local6++) {
			@Pc(83) Class88 local83 = this.aClass88Array1[local6];
			@Pc(85) Class88 local85 = local83;
			if (local83.aClass88_1 != null) {
				local85 = local83.aClass88_1;
			}
			if (local83.aClass35_1 == null) {
				local83.aClass35_1 = arg1.method2897();
			} else {
				local83.aClass35_1.za(arg1);
			}
			local85.anInt2127 = Static319.anIntArray419[local1++];
			local85.anInt2133 = Static319.anIntArray419[local1++];
			local85.anInt2130 = Static319.anIntArray419[local1++];
		}
	}
	...
	public boolean method3107(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class35 arg2, @OriginalArg(3) boolean arg3) {
		return this.aQa1.method4224().B(this, arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!da", name = "a", descriptor = "(Lclient!c;Lclient!vs;II)V")
	@Override
	public void method3104(@OriginalArg(0) Class35 arg0, @OriginalArg(1) Class20_Sub8 arg1, @OriginalArg(2) int arg2) {
		if (arg1 == null) {
			this.aQa1.method4224().ta(this, arg0, null, arg2, 1);
			return;
		}
		Static319.anIntArray420[5] = 0;
		this.aQa1.method4224().ta(this, arg0, Static319.anIntArray420, arg2, 1);
		arg1.anInt7195 = Static319.anIntArray420[0];
		arg1.anInt7191 = Static319.anIntArray420[1];
		arg1.anInt7194 = Static319.anIntArray420[2];
		arg1.anInt7192 = Static319.anIntArray420[3];
		arg1.anInt7193 = Static319.anIntArray420[4];
		arg1.aBoolean508 = Static319.anIntArray420[5] != 0;
	}
	...
	@OriginalMember(owner = "client!da", name = "a", descriptor = "(Lclient!c;Lclient!vs;I)V")
	@Override
	public void method3117(@OriginalArg(0) Class35 arg0, @OriginalArg(1) Class20_Sub8 arg1, @OriginalArg(2) int arg2) {
		if (arg1 == null) {
			this.aQa1.method4224().ea(this, arg0, null, arg2);
			return;
		}
		Static319.anIntArray420[5] = 0;
		this.aQa1.method4224().ea(this, arg0, Static319.anIntArray420, arg2);
		arg1.anInt7195 = Static319.anIntArray420[0];
		arg1.anInt7191 = Static319.anIntArray420[1];
		arg1.anInt7194 = Static319.anIntArray420[2];
		arg1.anInt7192 = Static319.anIntArray420[3];
	...
	public Class116 method3123(@OriginalArg(0) byte arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		return this.aQa1.method4224().method3401(this, arg0, arg1, arg2);
	}
	...
	@OriginalMember(owner = "client!da", name = "c", descriptor = "()[Lclient!fs;")
	@Override
	public Class88[] method3115() {
		return this.aClass88Array1;
	}
	...
	public native Class4_Sub2_Sub3 fa(@OriginalArg(0) Class4_Sub2_Sub3 arg0);
	...
	public void method3118(@OriginalArg(0) Class116 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		this.aQa1.method4224().U(this, arg0, arg1, arg2, arg3, arg4);
	}
	...
	@OriginalMember(owner = "client!da", name = "b", descriptor = "()[Lclient!ew;")
	@Override
	public Class76[] method3111() {
		return this.aClass76Array1;
	}
