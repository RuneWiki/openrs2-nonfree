...
public final class Class2_Sub37 extends Class2 {
	...
	public Class2_Sub37(@OriginalArg(0) byte[] arg0) {
		this.method5529(arg0);
	}

	@OriginalMember(owner = "client!pda", name = "b", descriptor = "([B)V")
	private void method5529(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub7 local4 = new Class2_Sub7(arg0);
		this.anInt6664 = local4.method4509();
		this.anInt6671 = local4.method4509();
		this.anInt6668 = local4.method4509();
		this.anInt6662 = local4.method4509();
		if (this.anInt6662 < 0) {
			this.anInt6662 = ~this.anInt6662;
			this.aBoolean535 = true;
		}
		@Pc(40) int local40 = local4.method4509();
		this.aByteArrayArray16 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method4464();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method4504(local49, local64);
			this.aByteArrayArray16[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!pda", name = "d", descriptor = "(I)[F")
	private float[] method5534(@OriginalArg(0) int arg0) {
		Static406.method5526(this.aByteArrayArray16[arg0]);
		Static406.method5528();
		@Pc(15) int local15 = Static406.method5533(Static234.method3333(Static406.anIntArray427.length - 1));
		@Pc(19) boolean local19 = Static406.aBooleanArray23[local15];
		@Pc(25) int local25 = local19 ? Static406.anInt6669 : Static406.anInt6665;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static406.method5528() != 0;
			local29 = Static406.method5528() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static406.anInt6665 >> 2);
			local67 = (local25 >> 2) + (Static406.anInt6665 >> 2);
			local71 = Static406.anInt6665 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static406.anInt6665 >> 2);
			local104 = local25 + (Static406.anInt6665 >> 2) - (local25 >> 2);
			local108 = Static406.anInt6665 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class343 local123 = Static406.aClass343Array1[Static406.anIntArray427[local15]];
		@Pc(126) int local126 = local123.anInt8943;
		@Pc(131) int local131 = local123.anIntArray584[local126];
		@Pc(140) boolean local140 = !Static406.aClass30Array1[local131].method563();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt8944; local144++) {
			@Pc(152) Class260 local152 = Static406.aClass260Array1[local123.anIntArray583[local144]];
			local154 = Static406.aFloatArray55;
			local152.method5457(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt8943;
			local176 = local123.anIntArray584[local171];
			Static406.aClass30Array1[local176].method562(Static406.aFloatArray55, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static406.aFloatArray55[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static406.aFloatArray55;
			...
			@Pc(252) float[] local252 = local19 ? Static406.aFloatArray54 : Static406.aFloatArray60;
			@Pc(258) float[] local258 = local19 ? Static406.aFloatArray56 : Static406.aFloatArray57;
			@Pc(264) float[] local264 = local19 ? Static406.aFloatArray58 : Static406.aFloatArray61;
			@Pc(270) int[] local270 = local19 ? Static406.anIntArray426 : Static406.anIntArray425;
			...
			@Pc(486) int local486 = Static234.method3333(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static406.aFloatArray55[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static406.aFloatArray55[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt6670 > 0) {
			local176 = this.anInt6670 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean534) {
				for (local212 = 0; local212 < this.anInt6666; local212++) {
					local1254 = (this.anInt6670 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static406.aFloatArray55[local212];
				}
			}
		}
		local154 = this.aFloatArray59;
		this.aFloatArray59 = Static406.aFloatArray55;
		Static406.aFloatArray55 = local154;
		this.anInt6670 = local25;
		this.anInt6666 = local104 - (local25 >> 1);
		this.aBoolean534 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!pda", name = "a", descriptor = "([I)Lclient!wm;")
	public Class2_Sub13_Sub1 method5535(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray63 == null) {
			this.anInt6670 = 0;
			this.aFloatArray59 = new float[Static406.anInt6669];
			this.aByteArray63 = new byte[this.anInt6671];
			this.anInt6673 = 0;
			this.anInt6672 = 0;
		}
		while (this.anInt6672 < this.aByteArrayArray16.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method5534(this.anInt6672);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt6673;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt6671 - local47) {
					local50 = this.anInt6671 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt6673;
				}
				this.anInt6673 = local47;
			}
			this.anInt6672++;
		}
		...
		return new Class2_Sub13_Sub1(this.anInt6664, local129, this.anInt6668, this.anInt6662, this.aBoolean535);
	}
}
