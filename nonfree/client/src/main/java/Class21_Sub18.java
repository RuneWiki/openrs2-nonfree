...
public final class Class21_Sub18 extends Class21 {
	...
	@OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(Lclient!gp;)V")
	public Class21_Sub18(@OriginalArg(0) Class3_Sub27 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(ILclient!gp;)V")
	public Class21_Sub18(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub27 arg1) {
		super(arg0, arg1);
	}
