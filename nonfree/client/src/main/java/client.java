...
public final class client extends Applet_Sub1 {
	...
	private static void method88() {
		try {
			...
			signlink.reporterror("70501, " + true + ", " + local17.toString());
	...
	private static String method101(@OriginalArg(0) int arg0) {
		try {
			...
			signlink.reporterror("92962, " + arg0 + ", " + 0 + ", " + local95.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "b", descriptor = "(IZI)Ljava/lang/String;")
	private static String method133(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		try {
			...
			signlink.reporterror("26325, " + arg0 + ", " + false + ", " + arg1 + ", " + local50.toString());
			throw new RuntimeException();
		}
	}
	...
	private static void method167() {
		try {
			...
			signlink.reporterror("39707, " + 9 + ", " + local13.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(ZI)Ljava/lang/String;")
	private static String method169(@OriginalArg(1) int arg0) {
		try {
			if (arg0 < 100000) {
			...
			signlink.reporterror("32689, " + true + ", " + arg0 + ", " + local35.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method75(@OriginalArg(1) int arg0, @OriginalArg(2) String arg1, @OriginalArg(3) int arg2) {
		try {
			if (arg1 != null) {
			...
			signlink.reporterror("88096, " + false + ", " + arg0 + ", " + arg1 + ", " + arg2 + ", " + local29.toString());
			throw new RuntimeException();
		}
	}
			...
			for (@Pc(15) int local15 = -1; local15 < this.anInt205 + this.anInt248; local15++) {
				...
				if (local23 != null && local23.method571()) {
					if (local15 < this.anInt205) {
						...
						if (local66.anInt939 != 0) {
							this.method151(local23.anInt933 + 15, this.aBoolean45, local23);
							if (this.anInt287 > -1) {
								for (local84 = 0; local84 < 8; local84++) {
									if ((local66.anInt939 & 0x1 << local84) != 0) {
										this.aClass1_Sub3_Sub2_Sub2Array5[local84].method322(this.anInt288 - local63, this.anInt287 - 12);
										local63 -= 25;
									}
								}
							}
						...
						if (local15 >= 0 && this.anInt241 == 10 && this.anInt305 == this.anIntArray39[local15]) {
							this.method151(local23.anInt933 + 15, this.aBoolean45, local23);
							if (this.anInt287 > -1) {
								this.aClass1_Sub3_Sub2_Sub2Array5[7].method322(this.anInt288 - local63, this.anInt287 - 12);
							}
						}
					} else if (this.anInt241 == 1 && this.anInt190 == this.anIntArray58[local15 - this.anInt205] && anInt266 % 20 < 10) {
						this.method151(local23.anInt933 + 15, this.aBoolean45, local23);
						if (this.anInt287 > -1) {
							this.aClass1_Sub3_Sub2_Sub2Array5[2].method322(this.anInt288 - 28, this.anInt287 - 12);
						}
					}
					if (local23.aString29 != null && (local15 >= this.anInt205 || this.anInt273 == 0 || this.anInt273 == 3 || this.anInt273 == 1 && this.method199(((Class1_Sub1_Sub3_Sub2) local23).aString30))) {
						this.method151(local23.anInt933, this.aBoolean45, local23);
						if (this.anInt287 > -1 && this.anInt314 < this.anInt315) {
							this.anIntArray76[this.anInt314] = this.aClass1_Sub3_Sub2_Sub4_3.method364(local23.aString29) / 2;
							...
							this.anIntArray77[this.anInt314] = local23.anInt902;
							this.anIntArray78[this.anInt314] = local23.anInt903;
							this.anIntArray79[this.anInt314] = local23.anInt901;
							this.aStringArray8[this.anInt314++] = local23.aString29;
							if (this.anInt189 == 0 && local23.anInt903 == 1) {
								this.anIntArray75[this.anInt314] += 10;
								this.anIntArray74[this.anInt314] += 5;
							}
							if (this.anInt189 == 0 && local23.anInt903 == 2) {
								this.anIntArray76[this.anInt314] = 60;
							}
						}
					}
					if (local23.anInt906 > anInt266 + 100) {
						this.method151(local23.anInt933 + 15, this.aBoolean45, local23);
						if (this.anInt287 > -1) {
							local63 = local23.anInt907 * 30 / local23.anInt908;
							if (local63 > 30) {
								local63 = 30;
							}
							Class1_Sub3_Sub2.method358(this.anInt288 - 3, this.anInt287 - 15, 65280, local63, 5);
							Class1_Sub3_Sub2.method358(this.anInt288 - 3, this.anInt287 - 15 + local63, 16711680, 30 - local63, 5);
						}
					}
					if (local23.anInt906 > anInt266 + 330) {
						this.method151(local23.anInt933 / 2, this.aBoolean45, local23);
						if (this.anInt287 > -1) {
							this.aClass1_Sub3_Sub2_Sub2Array3[local23.anInt905].method322(this.anInt288 - 12, this.anInt287 - 12);
							this.aClass1_Sub3_Sub2_Sub4_1.method362(this.anInt288 + 4, 0, String.valueOf(local23.anInt904), this.anInt287);
							this.aClass1_Sub3_Sub2_Sub4_1.method362(this.anInt288 + 3, 16777215, String.valueOf(local23.anInt904), this.anInt287 - 1);
						}
					}
				}
			}
			for (@Pc(483) int local483 = 0; local483 < this.anInt314; local483++) {
				...
				if (this.anInt189 == 0) {
					...
					if (this.anIntArray78[local483] == 2) {
						...
						Class1_Sub3_Sub2.method356(334, 0, this.anInt287 + 50, this.anInt287 - 50);
	...
	private void method77() {
		try {
			this.aClass1_Sub3_Sub3_6.method380(231);
			if (this.anInt330 != -1) {
				this.anInt330 = -1;
			...
			signlink.reporterror("46537, " + -60 + ", " + local44.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method78() {
		try {
			...
			signlink.reporterror("44297, " + 0 + ", " + local9.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method79() {
		try {
			@Pc(10) int local10 = (this.aClass1_Sub1_Sub3_Sub2_1.anInt890 >> 7) + this.anInt169;
			@Pc(19) int local19 = (this.aClass1_Sub1_Sub3_Sub2_1.anInt891 >> 7) + this.anInt170;
			...
			signlink.reporterror("93797, " + 39734 + ", " + local264.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method80() {
		try {
			if (this.anInt210 != 0) {
				...
				for (@Pc(18) int local18 = 0; local18 < 100; local18++) {
					if (this.aStringArray7[local18] != null) {
						...
						@Pc(60) int local60;
						if ((local30 == 3 || local30 == 7) && (local30 == 7 || this.anInt164 == 0 || this.anInt164 == 1 && this.method199(this.aStringArray6[local18]))) {
			...
			signlink.reporterror("71214, " + 222 + ", " + local225.toString());
			throw new RuntimeException();
		}
	}
		...
		try {
			for (@Pc(1) int local1 = 0; local1 < this.anInt206; local1++) {
				...
				if ((local16 & 0x2) == 2) {
					...
					if (local24 == -1 || local13.anInt915 == -1 || Class19.aClass19Array1[local24].anInt545 > Class19.aClass19Array1[local13.anInt915].anInt545 || Class19.aClass19Array1[local13.anInt915].anInt545 == 0) {
				...
				if ((local16 & 0x10) == 16) {
					...
					local13.anInt906 = anInt266 + 400;
					local13.anInt907 = arg0.method391();
					local13.anInt908 = arg0.method391();
				}
				if ((local16 & 0x20) == 32) {
					local13.aClass3_1 = Class3.method32(arg0.method393());
					local13.anInt896 = local13.aClass3_1.anInt70;
					local13.anInt897 = local13.aClass3_1.anInt71;
					local13.anInt898 = local13.aClass3_1.anInt72;
					local13.anInt899 = local13.aClass3_1.anInt73;
					local13.anInt894 = local13.aClass3_1.anInt69;
				}
				if ((local16 & 0x40) == 64) {
					local13.anInt920 = arg0.method393();
					local24 = arg0.method396();
					local13.anInt924 = local24 >> 16;
					local13.anInt923 = anInt266 + (local24 & 0xFFFF);
					local13.anInt921 = 0;
					local13.anInt922 = 0;
					if (local13.anInt923 > anInt266) {
						local13.anInt921 = -1;
					}
	...
	private void method82(@OriginalArg(0) long arg0) {
		try {
			if (arg0 != 0L) {
				if (this.anInt186 >= 100) {
					this.method172(0, "Your ignore list is full. Max of 100 hit", "");
				} else {
					@Pc(23) String local23 = Class40.method542(Class40.method539(arg0));
					for (@Pc(25) int local25 = 0; local25 < this.anInt186; local25++) {
						if (this.aLongArray3[local25] == arg0) {
							this.method172(0, local23 + " is already on your ignore list", "");
							return;
						}
					}
					for (@Pc(55) int local55 = 0; local55 < this.anInt312; local55++) {
						if (this.aLongArray4[local55] == arg0) {
							this.method172(0, "Please remove " + local23 + " from your friend list first", "");
							return;
						}
					}
					this.aLongArray3[this.anInt186++] = arg0;
					this.aBoolean59 = true;
					this.aClass1_Sub3_Sub3_6.method380(79);
					this.aClass1_Sub3_Sub3_6.method387(arg0);
				}
			}
		} catch (@Pc(114) RuntimeException local114) {
			signlink.reporterror("96582, " + arg0 + ", " + 3 + ", " + local114.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(BLclient!kb;I)V")
	private void method83(@OriginalArg(1) Class1_Sub3_Sub3 arg0, @OriginalArg(2) int arg1) {
		try {
			@Pc(15) int local15;
			@Pc(24) int local24;
			@Pc(31) int local31;
			...
			if (arg1 == 59 || arg1 == 76) {
				...
				if (local24 >= 0 && local31 >= 0 && local24 < 104 && local31 < 104) {
					...
					for (@Pc(74) Class1_Sub4 local74 = (Class1_Sub4) this.aClass28_4.method456(); local74 != null; local74 = (Class1_Sub4) this.aClass28_4.method458()) {
					...
					if (local69 == null) {
						...
						if (local47 == 1) {
							local108 = this.aClass33_1.method495(this.anInt231, local31, local24);
						}
						if (local47 == 2) {
					...
					this.method160(local42, local24, local31, local47, local52, local38, this.anInt231);
				}
			} else if (arg1 == 42) {
				local15 = arg0.method391();
				local24 = this.anInt222 + (local15 >> 4 & 0x7);
				...
				if (local24 >= 0 && local31 >= 0 && local24 < 104 && local31 < 104) {
					...
					if (local42 == 1) {
						local52 = this.aClass33_1.method495(this.anInt231, local31, local24);
					}
					if (local42 == 2) {
					...
					if (local52 != 0) {
						@Pc(348) Class1_Sub6 local348 = new Class1_Sub6(false, local52 >> 14 & 0x7FFF, this.anInt231, 0, local42, Class19.aClass19Array1[local47], local31, local24);
				...
				if (arg1 == 223) {
					...
					if (local24 >= 0 && local31 >= 0 && local24 < 104 && local31 < 104) {
						...
						local395.anInt773 = local34;
						local395.anInt774 = local38;
					...
					if (local24 >= 0 && local31 >= 0 && local24 < 104 && local31 < 104) {
						...
						if (local485 != null) {
							for (local395 = (Class1_Sub7) local485.method456(); local395 != null; local395 = (Class1_Sub7) local485.method458()) {
								if (local395.anInt773 == (local34 & 0x7FFF)) {
									local395.method567();
									break;
								}
							}
					...
					if (arg1 == 69) {
						...
						if (local24 >= 0 && local31 >= 0 && local24 < 104 && local31 < 104 && local34 >= 0 && local38 >= 0 && local34 < 104 && local38 < 104) {
							...
							@Pc(657) Class1_Sub1_Sub1 local657 = new Class1_Sub1_Sub1(local572, local110, local31, local108 + anInt266, this.anInt231, local42, local575 + anInt266, local112, 0, this.method94(this.anInt231, local24, local31) - local52, local47, local24);
							local657.method19(this.method94(this.anInt231, local34, local38) - local572, local38, local34, local575 + anInt266);
						...
						if (local24 >= 0 && local31 >= 0 && local24 < 104 && local31 < 104) {
							local24 = local24 * 128 + 64;
							local31 = local31 * 128 + 64;
							@Pc(753) Class1_Sub1_Sub2 local753 = new Class1_Sub1_Sub2(local24, local34, false, local31, local42, this.method94(this.anInt231, local24, local31) - local38, this.anInt231, anInt266);
						...
						if (local24 >= 0 && local31 >= 0 && local24 < 104 && local31 < 104 && local42 != this.anInt152) {
							...
							local807.anInt773 = local34;
							local807.anInt774 = local38;
							if (this.aClass28ArrayArrayArray1[this.anInt231][local24][local31] == null) {
								this.aClass28ArrayArrayArray1[this.anInt231][local24][local31] = new Class28(0);
							}
						...
						if (arg1 == 23) {
							...
							if (local921 != null) {
								@Pc(946) Class1_Sub5 local946 = new Class1_Sub5(this.anInt231, local42, local31, local572 + anInt266, 2, local38, -1, local24, local47);
								this.aClass28_2.method453(local946);
								@Pc(966) Class1_Sub5 local966 = new Class1_Sub5(this.anInt231, local42, local31, local575 + anInt266, 2, local38, local52, local24, local47);
								...
								@Pc(1021) Class2 local1021 = Class2.method23(local52);
								local921.anInt942 = local572 + anInt266;
								local921.anInt943 = local575 + anInt266;
								...
								local921.anInt944 = local24 * 128 + local1045 * 64;
								local921.anInt946 = local31 * 128 + local1048 * 64;
								local921.anInt945 = this.method94(this.anInt231, local921.anInt944, local921.anInt946);
								...
								local921.anInt947 = local24 + local905;
								local921.anInt949 = local24 + local911;
								local921.anInt948 = local31 + local908;
								local921.anInt950 = local31 + local914;
							}
						}
						if (arg1 == 151) {
							local15 = arg0.method391();
							...
							if (local24 >= 0 && local31 >= 0 && local24 < 104 && local31 < 104) {
								...
								if (local1178 != null) {
									for (@Pc(1184) Class1_Sub7 local1184 = (Class1_Sub7) local1178.method456(); local1184 != null; local1184 = (Class1_Sub7) local1178.method458()) {
										if (local1184.anInt773 == (local34 & 0x7FFF) && local1184.anInt774 == local38) {
											local1184.anInt774 = local42;
											break;
										}
									}
									this.method184(local24, local31);
			...
			signlink.reporterror("90582, " + -45 + ", " + arg0 + ", " + arg1 + ", " + local1214.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "d", descriptor = "(B)I")
	private int method84() {
		try {
			@Pc(11) int local11 = 3;
			if (this.anInt325 < 310) {
				@Pc(20) int local20 = this.anInt322 >> 7;
				@Pc(25) int local25 = this.anInt324 >> 7;
				@Pc(31) int local31 = this.aClass1_Sub1_Sub3_Sub2_1.anInt890 >> 7;
				@Pc(37) int local37 = this.aClass1_Sub1_Sub3_Sub2_1.anInt891 >> 7;
			...
			if ((this.aByteArrayArrayArray7[this.anInt231][this.aClass1_Sub1_Sub3_Sub2_1.anInt890 >> 7][this.aClass1_Sub1_Sub3_Sub2_1.anInt891 >> 7] & 0x4) != 0) {
				local11 = this.anInt231;
			}
			return local11;
		} catch (@Pc(257) RuntimeException local257) {
			signlink.reporterror("50986, " + 106 + ", " + local257.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "h", descriptor = "(I)I")
	private int method85() {
		try {
			@Pc(9) int local9 = this.method94(this.anInt231, this.anInt322, this.anInt324);
			this.anInt178 += 0;
			...
			signlink.reporterror("97355, " + 0 + ", " + local45.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method86() {
		try {
			...
			if (!this.aBoolean61) {
				...
				this.method100(this.method94(this.anInt231, this.aClass1_Sub1_Sub3_Sub2_1.anInt890, this.aClass1_Sub1_Sub3_Sub2_1.anInt891) - 50, this.anInt243, local73, local34, this.anInt244, local34 * 3 + 600);
				anInt193++;
				if (anInt193 > 1802) {
					anInt193 = 0;
					this.aClass1_Sub3_Sub3_6.method380(146);
					...
					this.aClass1_Sub3_Sub3_6.method390(this.aClass1_Sub3_Sub3_6.anInt561 - local122);
				}
			}
			if (this.aBoolean61) {
				local34 = this.method85();
			} else {
				local34 = this.method84();
			}
			...
			local264 = Class1_Sub3_Sub2_Sub1.anInt434;
			...
			this.aClass33_1.method507(this.anInt326, this.anInt322, local34, this.anInt325, this.anInt323, this.anInt324);
			this.aClass33_1.method481();
			this.method76(this.anInt194);
			this.method194();
			this.method102(local264);
			this.method145();
			this.aClass32_27.method464(11, super.aGraphics2, 8);
			...
			signlink.reporterror("36672, " + 0 + ", " + local405.toString());
			throw new RuntimeException();
		}
	}
		...
		try {
			...
			while (this.aBoolean41) {
				...
				if (local19 != null) {
					...
					Class34.method519(local167, local69, local52, local25, 4);
					this.method113(local167, local69, true);
				}
			}
		} catch (@Pc(185) RuntimeException local185) {
			signlink.reporterror("94943, " + true + ", " + local185.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method89() {
		try {
			...
			if (this.anInt227 > 0) {
				for (local8 = 0; local8 < 256; local8++) {
					if (this.anInt227 > 768) {
						this.anIntArray50[local8] = this.method149(this.anIntArray51[local8], 1024 - this.anInt227, this.anIntArray52[local8]);
					} else if (this.anInt227 > 256) {
						this.anIntArray50[local8] = this.anIntArray52[local8];
					} else {
						this.anIntArray50[local8] = this.method149(this.anIntArray52[local8], 256 - this.anInt227, this.anIntArray51[local8]);
					}
				}
			} else if (this.anInt228 > 0) {
				for (local8 = 0; local8 < 256; local8++) {
					if (this.anInt228 > 768) {
						this.anIntArray50[local8] = this.method149(this.anIntArray51[local8], 1024 - this.anInt228, this.anIntArray53[local8]);
					} else if (this.anInt228 > 256) {
						this.anIntArray50[local8] = this.anIntArray53[local8];
					} else {
						this.anIntArray50[local8] = this.method149(this.anIntArray53[local8], 256 - this.anInt228, this.anIntArray51[local8]);
					}
				}
			} else {
				for (local8 = 0; local8 < 256; local8++) {
			...
			this.aClass32_19.method464(0, super.aGraphics2, 0);
			...
			this.aClass32_20.method464(0, super.aGraphics2, 661);
		} catch (@Pc(449) RuntimeException local449) {
			signlink.reporterror("82128, " + true + ", " + local449.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(IIILclient!hc;III)V")
	private void method90(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class15 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		try {
			if (arg3.anInt472 == 0 && arg3.anIntArray153 != null && !arg3.aBoolean106 && (arg1 >= arg4 && arg0 >= arg2 && arg1 <= arg4 + arg3.anInt475 && arg0 <= arg2 + arg3.anInt476)) {
				...
				for (@Pc(44) int local44 = 0; local44 < local34; local44++) {
					...
					@Pc(69) Class15 local69 = Class15.aClass15Array1[arg3.anIntArray153[local44]];
					...
					if (local69.anInt472 == 0) {
						this.method90(arg0, arg1, local79, local69, local74, local69.anInt481);
						if (local69.anInt480 > local69.anInt476) {
							this.method158(arg1, arg0, local69.anInt480, local69.anInt476, true, local74 + local69.anInt475, local79, local69);
						}
					} else {
						if (local69.anInt473 == 1 && arg1 >= local74 && arg0 >= local79 && arg1 < local74 + local69.anInt475 && arg0 < local79 + local69.anInt476) {
							...
							if (local69.anInt474 != 0) {
								local176 = this.method180(local69);
							}
							if (!local176) {
								...
								for (@Pc(494) int local494 = 0; local494 < local69.anInt475; local494++) {
									...
									if (arg1 >= local505 && arg0 >= local514 && arg1 < local505 + 32 && arg0 < local514 + 32) {
										...
										if (local69.anIntArray149[local488] > 0) {
											@Pc(567) Class5 local567 = Class5.method54(local69.anIntArray149[local488] - 1);
			...
			signlink.reporterror("35323, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + 5082 + ", " + arg4 + ", " + arg5 + ", " + local1130.toString());
			throw new RuntimeException();
		}
	}
		...
		try {
			...
			if (super.anInt137 == 1) {
				if (super.anInt138 >= 8 && super.anInt138 <= 108 && super.anInt139 >= 490 && super.anInt139 <= 522) {
					...
					this.aBoolean60 = true;
					this.aClass1_Sub3_Sub3_6.method380(244);
				...
				if (super.anInt138 >= 416 && super.anInt138 <= 516 && super.anInt139 >= 490 && super.anInt139 <= 522) {
					...
					for (@Pc(186) int local186 = 0; local186 < Class15.aClass15Array1.length; local186++) {
						if (Class15.aClass15Array1[local186] != null && Class15.aClass15Array1[local186].anInt474 == 600) {
							this.anInt240 = this.anInt271 = Class15.aClass15Array1[local186].anInt471;
							return;
						}
					}
					return;
			...
			signlink.reporterror("26269, " + 0 + ", " + local215.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "b", descriptor = "(III)V")
	private void method92(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		try {
			@Pc(1) int local1 = 0;
			for (@Pc(3) int local3 = 0; local3 < 100; local3++) {
				if (this.aStringArray7[local3] != null) {
					...
					if ((local15 == 1 || local15 == 2) && (local15 == 1 || this.anInt273 == 0 || this.anInt273 == 1 && this.method199(this.aStringArray6[local3]))) {
						if (arg0 > local26 - 14 && arg0 <= local26 && !this.aStringArray6[local3].equals(this.aClass1_Sub1_Sub3_Sub2_1.aString30)) {
							if (this.aBoolean65) {
					...
					if ((local15 == 3 || local15 == 7) && this.anInt210 == 0 && (local15 == 7 || this.anInt164 == 0 || this.anInt164 == 1 && this.method199(this.aStringArray6[local3]))) {
					...
					if (local15 == 4 && (this.anInt234 == 0 || this.anInt234 == 1 && this.method199(this.aStringArray6[local3]))) {
						if (arg0 > local26 - 14 && arg0 <= local26) {
					...
					if (local15 == 8 && (this.anInt234 == 0 || this.anInt234 == 1 && this.method199(this.aStringArray6[local3]))) {
						if (arg0 > local26 - 14 && arg0 <= local26) {
			...
			signlink.reporterror("24152, " + arg0 + ", " + 0 + ", " + arg1 + ", " + local412.toString());
			throw new RuntimeException();
		}
	}
		...
		try {
			...
			for (@Pc(22) int local22 = -1; local22 < this.anInt205; local22++) {
				...
				if (local30 != null && local30.method571()) {
					...
					if ((aBoolean53 && this.anInt205 > 50 || this.anInt205 > 200) && local22 != -1 && local30.anInt912 == local30.anInt894) {
						local30.aBoolean165 = true;
					}
					@Pc(87) int local87 = local30.anInt890 >> 7;
					@Pc(92) int local92 = local30.anInt891 >> 7;
					if (local87 >= 0 && local87 < 104 && local92 >= 0 && local92 < 104) {
						if (local30.aClass1_Sub3_Sub1_11 == null || anInt266 < local30.anInt942 || anInt266 >= local30.anInt943) {
							if ((local30.anInt890 & 0x7F) == 64 && (local30.anInt891 & 0x7F) == 64) {
								if (this.anIntArrayArray3[local87][local92] == this.anInt211) {
									continue;
								}
								this.anIntArrayArray3[local87][local92] = this.anInt211;
							}
							local30.anInt941 = this.method94(this.anInt231, local30.anInt890, local30.anInt891);
							this.aClass33_1.method478(local30.anInt891, 60, local30.anInt892, local30.anInt890, local35, local30.aBoolean162, null, local30, local30.anInt941, this.anInt231);
						} else {
							local30.aBoolean165 = false;
							local30.anInt941 = this.method94(this.anInt231, local30.anInt890, local30.anInt891);
							this.aClass33_1.method479(local30.anInt949, null, local30.anInt891, local30.anInt941, local35, local30.anInt892, local30.anInt948, local30.anInt947, local30, this.anInt231, local30.anInt950, local30.anInt890);
						}
					}
				}
			}
		} catch (@Pc(230) RuntimeException local230) {
			signlink.reporterror("13213, " + 284 + ", " + local230.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(IIBI)I")
	private int method94(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
		try {
			...
			signlink.reporterror("41583, " + arg0 + ", " + arg1 + ", " + 5 + ", " + arg2 + ", " + local114.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(Lclient!bc;IIII)V")
	private void method95(@OriginalArg(0) Class3 arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		try {
			if (this.anInt304 < 400) {
				@Pc(16) String local16 = arg0.aString2;
				if (arg0.anInt77 != 0) {
					local16 = local16 + method133(this.aClass1_Sub1_Sub3_Sub2_1.anInt940, arg0.anInt77) + " (level-" + arg0.anInt77 + ")";
				}
				if (this.anInt281 == 1) {
			...
			signlink.reporterror("93342, " + arg0 + ", " + -641 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + local430.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method96() {
		try {
				...
				if (this.anInt271 != -1 && this.anInt271 == this.anInt240) {
					...
					if (this.aBoolean47) {
						...
						if (local13 == 13 || local13 == 10) {
							...
							if (this.anInt168 == 1) {
								local153 = Class40.method538(this.aString5);
								this.method161(local153);
							}
							if (this.anInt168 == 2 && this.anInt312 > 0) {
								local153 = Class40.method538(this.aString5);
								this.method174(local153);
							}
							if (this.anInt168 == 3 && this.aString5.length() > 0) {
								this.aClass1_Sub3_Sub3_6.method380(148);
								this.aClass1_Sub3_Sub3_6.method381(0);
								local193 = this.aClass1_Sub3_Sub3_6.anInt561;
								this.aClass1_Sub3_Sub3_6.method387(this.aLong8);
								Class41.method546(this.aClass1_Sub3_Sub3_6, this.aString5);
								this.aClass1_Sub3_Sub3_6.method390(this.aClass1_Sub3_Sub3_6.anInt561 - local193);
								this.aString5 = Class40.method543(this.aString5);
								this.aString5 = Class25.method424(this.aString5);
								this.method172(6, this.aString5, Class40.method542(Class40.method539(this.aLong8)));
								if (this.anInt164 == 2) {
									this.anInt164 = 1;
									this.aBoolean56 = true;
									this.aClass1_Sub3_Sub3_6.method380(244);
							...
							if (this.anInt168 == 4 && this.anInt186 < 100) {
								local153 = Class40.method538(this.aString5);
								this.method82(local153);
							}
							if (this.anInt168 == 5 && this.anInt186 > 0) {
								local153 = Class40.method538(this.aString5);
								this.method191(local153);
							}
						}
						...
						if (local13 == 13 || local13 == 10) {
							if (this.aString7.length() > 0) {
								...
								this.aClass1_Sub3_Sub3_6.method380(237);
						...
						if ((local13 == 13 || local13 == 10) && this.aString18.length() > 0) {
							if (this.aString18.equals("::clientdrop") && (super.aFrame_Sub1_2 != null || this.method134().indexOf("192.168.1.") != -1)) {
								this.method182();
							} else if (this.aString18.startsWith("::")) {
								this.aClass1_Sub3_Sub3_6.method380(4);
								...
								this.aClass1_Sub3_Sub3_6.method380(158);
								this.aClass1_Sub3_Sub3_6.method381(0);
								...
								Class41.method546(this.aClass1_Sub3_Sub3_6, this.aString18);
								this.aClass1_Sub3_Sub3_6.method390(this.aClass1_Sub3_Sub3_6.anInt561 - local693);
								this.aString18 = Class40.method543(this.aString18);
								this.aString18 = Class25.method424(this.aString18);
								this.aClass1_Sub1_Sub3_Sub2_1.aString29 = this.aString18;
								this.aClass1_Sub1_Sub3_Sub2_1.anInt902 = local496;
								this.aClass1_Sub1_Sub3_Sub2_1.anInt903 = local654;
								this.aClass1_Sub1_Sub3_Sub2_1.anInt901 = 150;
								this.method172(2, this.aClass1_Sub1_Sub3_Sub2_1.aString29, this.aClass1_Sub1_Sub3_Sub2_1.aString30);
								if (this.anInt273 == 2) {
									this.anInt273 = 3;
									this.aBoolean56 = true;
									this.aClass1_Sub3_Sub3_6.method380(244);
			...
			signlink.reporterror("2927, " + 7 + ", " + local795.toString());
			throw new RuntimeException();
		}
	}
	...
	protected void method70() {
		try {
			...
			signlink.reporterror("57311, " + false + ", " + local33.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method97() {
		try {
			...
			signlink.reporterror("38328, " + -70 + ", " + local451.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;II)Lclient!ub;")
	private Class39 method98(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2, @OriginalArg(3) int arg3) {
		try {
			@Pc(3) int local3 = 5;
			...
			while (local6 == null) {
				this.method74("Requesting " + arg0, arg3);
				try {
					local20 = 0;
					...
					while (local84 < local82) {
						...
						if (local126 != local20) {
							this.method74("Loading " + arg0 + " - " + local126 + "%", arg3);
						}
						local20 = local126;
					}
					local60.close();
					...
					for (local20 = local3; local20 > 0; local20--) {
						this.method74("Error loading - Will retry in " + local20 + " secs.", arg3);
						try {
							Thread.sleep(1000L);
			...
			signlink.reporterror("37683, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + 0 + ", " + local216.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method99() {
		try {
			...
			signlink.reporterror("17778, " + true + ", " + local67.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(IIIIIII)V")
	private void method100(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		try {
			...
			signlink.reporterror("79526, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + 16418 + ", " + arg4 + ", " + arg5 + ", " + local110.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method102(@OriginalArg(0) int arg0) {
		try {
			...
			signlink.reporterror("14523, " + arg0 + ", " + true + ", " + local126.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method103() {
		try {
			...
			if (this.anInt344 > this.anIntArray41.length) {
				...
				this.method183(this.aClass1_Sub3_Sub2_Sub3Array2[local48]);
			}
			@Pc(173) int local173;
			...
			signlink.reporterror("55623, " + true + ", " + local307.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method104(@OriginalArg(0) byte arg0) {
		try {
			...
			@Pc(26) int local26 = this.aClass1_Sub1_Sub3_Sub2_1.anInt890 / 32 + 48;
			@Pc(34) int local34 = 464 - this.aClass1_Sub1_Sub3_Sub2_1.anInt891 / 32;
			this.aClass1_Sub3_Sub2_Sub2_6.method328(local18, 146, this.anIntArray83, 151, local34, this.anInt249 + 256, local26, 21, 9, this.anIntArray61);
			this.aClass1_Sub3_Sub2_Sub2_11.method328(this.anInt200, 33, this.anIntArray44, 33, 25, 256, 25, 0, 0, this.anIntArray81);
			for (@Pc(72) int local72 = 0; local72 < this.anInt246; local72++) {
				local26 = this.anIntArray54[local72] * 4 + 2 - this.aClass1_Sub1_Sub3_Sub2_1.anInt890 / 32;
				local34 = this.anIntArray55[local72] * 4 + 2 - this.aClass1_Sub1_Sub3_Sub2_1.anInt891 / 32;
				this.method148(local34, this.aClass1_Sub3_Sub2_Sub2Array4[local72], local26);
			}
			@Pc(124) int local124;
			for (@Pc(120) int local120 = 0; local120 < 104; local120++) {
				for (local124 = 0; local124 < 104; local124++) {
					...
					if (local136 != null) {
						local26 = local120 * 4 + 2 - this.aClass1_Sub1_Sub3_Sub2_1.anInt890 / 32;
						local34 = local124 * 4 + 2 - this.aClass1_Sub1_Sub3_Sub2_1.anInt891 / 32;
						this.method148(local34, this.aClass1_Sub3_Sub2_Sub2_7, local26);
					}
				}
			}
			for (local124 = 0; local124 < this.anInt248; local124++) {
				...
				if (local189 != null && local189.method571() && local189.aClass3_1.aBoolean20) {
					local26 = local189.anInt890 / 32 - this.aClass1_Sub1_Sub3_Sub2_1.anInt890 / 32;
					local34 = local189.anInt891 / 32 - this.aClass1_Sub1_Sub3_Sub2_1.anInt891 / 32;
					this.method148(local34, this.aClass1_Sub3_Sub2_Sub2_8, local26);
				}
			}
			for (@Pc(235) int local235 = 0; local235 < this.anInt205; local235++) {
				...
				if (local245 != null && local245.method571()) {
					local26 = local245.anInt890 / 32 - this.aClass1_Sub1_Sub3_Sub2_1.anInt890 / 32;
					local34 = local245.anInt891 / 32 - this.aClass1_Sub1_Sub3_Sub2_1.anInt891 / 32;
					@Pc(275) boolean local275 = false;
					@Pc(279) long local279 = Class40.method538(local245.aString30);
					...
					if (local275) {
						this.method148(local34, this.aClass1_Sub3_Sub2_Sub2_10, local26);
					} else {
						this.method148(local34, this.aClass1_Sub3_Sub2_Sub2_9, local26);
					}
				}
			}
			if (this.anInt296 != 0) {
				local26 = this.anInt296 * 4 + 2 - this.aClass1_Sub1_Sub3_Sub2_1.anInt890 / 32;
				local34 = this.anInt297 * 4 + 2 - this.aClass1_Sub1_Sub3_Sub2_1.anInt891 / 32;
				this.method148(local34, this.aClass1_Sub3_Sub2_Sub2_5, local26);
			}
			Class1_Sub3_Sub2.method358(82, 93, 16777215, 3, 3);
	...
	private void method105(@OriginalArg(0) int arg0) {
		try {
			...
			if (this.anInt307 == 2) {
				for (@Pc(12) Class1_Sub5 local12 = (Class1_Sub5) this.aClass28_2.method456(); local12 != null; local12 = (Class1_Sub5) this.aClass28_2.method458()) {
					if (anInt266 >= local12.anInt638) {
						this.method160(local12.anInt636, local12.anInt633, local12.anInt634, local12.anInt632, local12.anInt635, local12.anInt637, local12.anInt631);
						local12.method567();
					}
				}
				anInt319++;
				if (anInt319 > 85) {
					anInt319 = 0;
					this.aClass1_Sub3_Sub3_6.method380(85);
					return;
				}
			}
	...
	private void method106(@OriginalArg(0) int arg0) {
		try {
			...
			for (@Pc(25) int local25 = 1; local25 < 103; local25++) {
				...
				for (local39 = 1; local39 < 103; local39++) {
					if ((this.aByteArrayArrayArray7[arg0][local39][local25] & 0x18) == 0) {
						this.aClass33_1.method503(local5, local37, arg0, local39, local25);
					}
					if (arg0 < 3 && (this.aByteArrayArrayArray7[arg0 + 1][local39][local25] & 0x8) != 0) {
						this.aClass33_1.method503(local5, local37, arg0 + 1, local39, local25);
					}
					local37 += 4;
				}
			}
			...
			this.aClass1_Sub3_Sub2_Sub2_6.method318();
			@Pc(149) int local149;
			...
			for (local149 = 0; local149 < 104; local149++) {
				for (@Pc(217) int local217 = 0; local217 < 104; local217++) {
					...
					if (local227 != 0) {
						...
						@Pc(239) int local239 = Class2.method23(local227).anInt47;
						if (local239 >= 0) {
			...
			signlink.reporterror("23407, " + arg0 + ", " + -153 + ", " + local416.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method107(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		try {
			...
			if (local8 != 0) {
				...
				@Pc(451) Class2 local451 = Class2.method23(local30);
				@Pc(483) int local483;
			...
			if (local8 != 0) {
				...
				@Pc(615) Class2 local615 = Class2.method23(local18);
	...
	private void method108(@OriginalArg(0) Class1_Sub3_Sub3 arg0, @OriginalArg(1) int arg1) {
		try {
			this.anInt255 = 0;
			this.anInt206 = 0;
			this.method181(arg0, arg1);
			this.method141(arg0, arg1);
			...
			for (@Pc(29) int local29 = 0; local29 < this.anInt255; local29++) {
				...
				if (this.aClass1_Sub1_Sub3_Sub1Array1[local36].anInt932 != anInt266) {
			...
			signlink.reporterror("3750, " + arg0 + ", " + arg1 + ", " + false + ", " + local126.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method109() {
		try {
			...
			signlink.reporterror("57688, " + 0 + ", " + local359.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(ILclient!kb;I)V")
	private void method110(@OriginalArg(0) int arg0, @OriginalArg(1) Class1_Sub3_Sub3 arg1) {
		try {
			...
			signlink.reporterror("65167, " + arg0 + ", " + arg1 + ", " + 0 + ", " + local262.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method111(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		try {
			this.aClass1_Sub3_Sub2_Sub3_17.method350(arg2, arg1);
			this.aClass1_Sub3_Sub2_Sub3_18.method350(arg2 + arg5 - 16, arg1);
			Class1_Sub3_Sub2.method358(arg2 + 16, arg1, this.anInt295, 16, arg5 - 32);
			...
			Class1_Sub3_Sub2.method358(arg2 + local52 + 16, arg1, this.anInt345, 16, local35);
			Class1_Sub3_Sub2.method361(this.anInt278, this.anInt145, arg2 + local52 + 16, local35, arg1);
			Class1_Sub3_Sub2.method361(this.anInt278, this.anInt145, arg2 + local52 + 16, local35, arg1 + 1);
			Class1_Sub3_Sub2.method360(this.anInt278, arg2 + local52 + 16, 16, arg1);
			Class1_Sub3_Sub2.method360(this.anInt278, arg2 + local52 + 17, 16, arg1);
			Class1_Sub3_Sub2.method361(this.anInt275, this.anInt145, arg2 + local52 + 16, local35, arg1 + 15);
			Class1_Sub3_Sub2.method361(this.anInt275, this.anInt145, arg2 + local52 + 17, local35 - 1, arg1 + 14);
			Class1_Sub3_Sub2.method360(this.anInt275, arg2 + local52 + local35 + 15, 16, arg1);
			Class1_Sub3_Sub2.method360(this.anInt275, arg2 + local52 + local35 + 14, 15, arg1 + 1);
	...
	private void method112() {
		try {
			...
			for (@Pc(12) int local12 = 0; local12 < 7; local12++) {
				...
				for (@Pc(21) int local21 = 0; local21 < Class13.anInt437; local21++) {
					if (!Class13.aClass13Array1[local21].aBoolean101 && Class13.aClass13Array1[local21].anInt438 == local12 + (this.aBoolean43 ? 0 : 7)) {
			...
			signlink.reporterror("82165, " + -6 + ", " + local58.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "([BIIZ)V")
	private void method113(@OriginalArg(0) byte[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) boolean arg2) {
		try {
			signlink.anInt761 = arg2 ? 1 : 0;
			signlink.midisave(arg0, arg1);
		} catch (@Pc(20) RuntimeException local20) {
			signlink.reporterror("21924, " + arg0 + ", " + 625 + ", " + arg1 + ", " + arg2 + ", " + local20.toString());
			throw new RuntimeException();
		}
	}
			...
			for (@Pc(1) int local1 = 0; local1 < this.anInt248; local1++) {
				...
				if (local11 != null && local11.method571()) {
					...
					if (local31 >= 0 && local31 < 104 && local36 >= 0 && local36 < 104) {
						...
						this.aClass33_1.method478(local11.anInt891, (local11.anInt893 - 1) * 64 + 60, local11.anInt892, local11.anInt890, local20, local11.aBoolean162, null, local11, this.method94(this.anInt231, local11.anInt890, local11.anInt891), this.anInt231);
					}
				}
			}
		} catch (@Pc(126) RuntimeException local126) {
			signlink.reporterror("90018, " + false + ", " + local126.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(IIZ)V")
	private void method115(@OriginalArg(1) int arg0, @OriginalArg(2) boolean arg1) {
		try {
			signlink.anInt760 = arg0;
			this.anInt178 += 0;
			if (arg1) {
				signlink.midi = "voladjust";
			}
		} catch (@Pc(13) RuntimeException local13) {
			signlink.reporterror("59417, " + 0 + ", " + arg0 + ", " + arg1 + ", " + local13.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method116() {
		try {
			...
			if (this.anInt320 == 2) {
				...
				local44 += 15;
				this.aClass1_Sub3_Sub2_Sub4_3.method367(92, 105, "Password: " + Class40.method544(this.aString14) + (this.anInt272 == 1 & anInt266 % 40 < 20 ? "@yel@|" : ""), true, 16777215);
				local44 += 15;
			...
			this.aClass32_18.method464(186, super.aGraphics2, 214);
			if (this.aBoolean37) {
				this.aBoolean37 = false;
				this.aClass32_16.method464(0, super.aGraphics2, 128);
				this.aClass32_17.method464(386, super.aGraphics2, 214);
				this.aClass32_21.method464(265, super.aGraphics2, 0);
				this.aClass32_22.method464(265, super.aGraphics2, 574);
				this.aClass32_23.method464(186, super.aGraphics2, 128);
				this.aClass32_24.method464(186, super.aGraphics2, 574);
			}
		} catch (@Pc(475) RuntimeException local475) {
			signlink.reporterror("76487, " + 4 + ", " + local475.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method117() {
		try {
			if (this.aClass32_28 == null) {
				...
				Class1_Sub3_Sub2.method357(this.anInt336);
				this.aClass1_Sub3_Sub2_Sub3_10.method350(0, 0);
			...
			signlink.reporterror("20178, " + -7185 + ", " + local134.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(IILclient!kb;)V")
	private void method118(@OriginalArg(1) int arg0, @OriginalArg(2) Class1_Sub3_Sub3 arg1) {
		try {
			while (true) {
				if (arg1.anInt562 + 10 < arg0 * 8) {
					...
					if (local27 != 2047) {
						if (this.aClass1_Sub1_Sub3_Sub2Array1[local27] == null) {
							this.aClass1_Sub1_Sub3_Sub2Array1[local27] = new Class1_Sub1_Sub3_Sub2();
						...
						@Pc(73) Class1_Sub1_Sub3_Sub2 local73 = this.aClass1_Sub1_Sub3_Sub2Array1[local27];
						local73.anInt932 = anInt266;
			...
			signlink.reporterror("52149, " + 2 + ", " + arg0 + ", " + arg1 + ", " + local149.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method119() {
		try {
			...
			for (@Pc(41) int local41 = 0; local41 < 4; local41++) {
				this.aClass9Array1[local41].method249();
			}
			System.gc();
			this.method78();
			this.aString17 = null;
			...
			signlink.reporterror("36279, " + -780 + ", " + local65.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(IIILclient!hc;I)V")
	private void method120(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Class15 arg2, @OriginalArg(4) int arg3) {
		try {
			if (arg2.anInt472 == 0 && arg2.anIntArray153 != null && (!arg2.aBoolean106 || this.anInt300 == arg2.anInt470 || this.anInt256 == arg2.anInt470 || this.anInt221 == arg2.anInt470)) {
				@Pc(29) int local29 = Class1_Sub3_Sub2.anInt532;
				@Pc(31) int local31 = Class1_Sub3_Sub2.anInt530;
				@Pc(33) int local33 = Class1_Sub3_Sub2.anInt533;
				@Pc(35) int local35 = Class1_Sub3_Sub2.anInt531;
				Class1_Sub3_Sub2.method356(arg0 + arg2.anInt476, arg0, arg1 + arg2.anInt475, arg1);
				...
				for (@Pc(59) int local59 = 0; local59 < local57; local59++) {
					...
					if (local84.anInt472 == 0) {
						...
						this.method120(local94, local89, local84, local84.anInt481);
						...
						if (local84.anInt472 == 2) {
								...
								for (local171 = 0; local171 < local84.anInt475; local171++) {
									...
									if (local84.anIntArray149[local165] > 0) {
										...
										if (local182 >= -32 && local182 <= 512 && local191 >= -32 && local191 <= 334 || this.anInt216 != 0 && this.anInt215 == local165) {
											@Pc(251) Class1_Sub3_Sub2_Sub2 local251 = Class5.method59(local224, local84.anIntArray150[local165]);
											...
											if (local251.anInt465 == 33 || local84.anIntArray150[local165] != 1) {
												...
												this.aClass1_Sub3_Sub2_Sub4_1.method365(local182 + local215 + 1, local191 + 10 + local217, 0, method169(local351));
												this.aClass1_Sub3_Sub2_Sub4_1.method365(local182 + local215, local191 + 9 + local217, 16776960, method169(local351));
											}
										}
							...
							if (local84.anInt472 == 4) {
																...
																while (true) {
																	...
																	if (local215 == -1) {
																		while (true) {
																			...
																			local462 = local462.substring(0, local215) + this.method150(this.method187(local84, 4)) + local462.substring(local215 + 2);
																		}
																	}
																	local462 = local462.substring(0, local215) + this.method150(this.method187(local84, 3)) + local462.substring(local215 + 2);
																}
															}
															local462 = local462.substring(0, local215) + this.method150(this.method187(local84, 2)) + local462.substring(local215 + 2);
														}
													}
													local462 = local462.substring(0, local215) + this.method150(this.method187(local84, 1)) + local462.substring(local215 + 2);
												}
											}
											local462 = local462.substring(0, local215) + this.method150(this.method187(local84, 0)) + local462.substring(local215 + 2);
										}
									}
								...
								local165 = Class1_Sub3_Sub2_Sub1.anInt430;
								local167 = Class1_Sub3_Sub2_Sub1.anInt431;
								Class1_Sub3_Sub2_Sub1.anInt430 = local89 + local84.anInt475 / 2;
								Class1_Sub3_Sub2_Sub1.anInt431 = local94 + local84.anInt476 / 2;
								...
								@Pc(827) boolean local827 = this.method175(local84);
								if (local827) {
								...
								if (local215 == -1) {
									...
									@Pc(852) Class19 local852 = Class19.aClass19Array1[local215];
								...
								Class1_Sub3_Sub2_Sub1.anInt430 = local165;
								Class1_Sub3_Sub2_Sub1.anInt431 = local167;
								...
								for (local171 = 0; local171 < local84.anInt476; local171++) {
									for (local182 = 0; local182 < local84.anInt475; local182++) {
										if (local84.anIntArray149[local167] > 0) {
											@Pc(915) Class5 local915 = Class5.method54(local84.anIntArray149[local167] - 1);
											@Pc(918) String local918 = local915.aString3;
											if (local915.aBoolean31 || local84.anIntArray150[local167] != 1) {
												local918 = local918 + " x" + method101(local84.anIntArray150[local167]);
											}
							...
							Class1_Sub3_Sub2.method358(local94, local89, local84.anInt485, local84.anInt475, local84.anInt476);
						} else {
							Class1_Sub3_Sub2.method359(local89, local84.anInt485, local84.anInt476, local94, local84.anInt475);
						}
					}
				}
				Class1_Sub3_Sub2.method356(local35, local31, local33, local29);
			}
		} catch (@Pc(1014) RuntimeException local1014) {
			signlink.reporterror("44309, " + arg0 + ", " + arg1 + ", " + 38682 + ", " + arg2 + ", " + arg3 + ", " + local1014.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(ZILclient!kb;)V")
	private void method121(@OriginalArg(1) int arg0, @OriginalArg(2) Class1_Sub3_Sub3 arg1) {
		try {
			for (@Pc(1) int local1 = 0; local1 < this.anInt206; local1++) {
				@Pc(8) int local8 = this.anIntArray40[local1];
				...
				this.method200(local8, local16, arg1, local13);
			}
			this.aBoolean62 &= true;
		} catch (@Pc(48) RuntimeException local48) {
			signlink.reporterror("96435, " + true + ", " + arg0 + ", " + arg1 + ", " + local48.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method122(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			...
			@Pc(8) int local8 = Class23.aClass23Array1[arg0].anInt609;
			if (local8 != 0) {
				...
				if (local8 == 3) {
					...
					if (local16 == 0) {
						this.method115(0, this.aBoolean42);
						this.aBoolean42 = true;
					}
					if (local16 == 1) {
						this.method115(-400, this.aBoolean42);
						this.aBoolean42 = true;
					}
					if (local16 == 2) {
						this.method115(-800, this.aBoolean42);
						this.aBoolean42 = true;
					}
					if (local16 == 3) {
						this.method115(-1200, this.aBoolean42);
						this.aBoolean42 = true;
					}
					if (local16 == 4) {
					...
					if (this.aBoolean42 != local54) {
						if (this.aBoolean42) {
							this.method75(this.anInt321, this.aString17, this.anInt343);
						} else {
							this.method78();
						}
						this.anInt157 = 0;
	...
	private void method123() {
		try {
			...
			for (@Pc(7) int local7 = 0; local7 < this.anInt248; local7++) {
				...
				if (local19 != null) {
					this.method124(local19, local19.aClass3_1.aByte4);
				}
			}
		} catch (@Pc(35) RuntimeException local35) {
			signlink.reporterror("3061, " + true + ", " + local35.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(Lclient!x;BI)V")
	private void method124(@OriginalArg(0) Class1_Sub1_Sub3 arg0, @OriginalArg(2) int arg1) {
		try {
			...
			signlink.reporterror("58564, " + arg0 + ", " + -128 + ", " + arg1 + ", " + local161.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(Lclient!x;I)V")
	private void method125(@OriginalArg(0) Class1_Sub1_Sub3 arg0) {
		try {
			@Pc(4) int local4 = arg0.anInt929 - anInt266;
			@Pc(14) int local14 = arg0.anInt925 * 128 + arg0.anInt893 * 64;
			@Pc(24) int local24 = arg0.anInt927 * 128 + arg0.anInt893 * 64;
			arg0.anInt890 += (local14 - arg0.anInt890) / local4;
			arg0.anInt891 += (local24 - arg0.anInt891) / local4;
			arg0.anInt936 = 0;
			if (arg0.anInt931 == 0) {
				arg0.anInt934 = 1024;
			}
			...
			signlink.reporterror("13971, " + arg0 + ", " + -25115 + ", " + local86.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "b", descriptor = "(Lclient!x;I)V")
	private void method126(@OriginalArg(0) Class1_Sub1_Sub3 arg0) {
		try {
			this.anInt178 += 0;
			if (arg0.anInt930 == anInt266 || arg0.anInt915 == -1 || arg0.anInt918 != 0 || arg0.anInt917 + 1 > Class19.aClass19Array1[arg0.anInt915].anIntArray188[arg0.anInt916]) {
				@Pc(35) int local35 = arg0.anInt930 - arg0.anInt929;
				@Pc(40) int local40 = anInt266 - arg0.anInt929;
				@Pc(50) int local50 = arg0.anInt925 * 128 + arg0.anInt893 * 64;
				@Pc(60) int local60 = arg0.anInt927 * 128 + arg0.anInt893 * 64;
				@Pc(70) int local70 = arg0.anInt926 * 128 + arg0.anInt893 * 64;
				@Pc(80) int local80 = arg0.anInt928 * 128 + arg0.anInt893 * 64;
				arg0.anInt890 = (local50 * (local35 - local40) + local70 * local40) / local35;
				arg0.anInt891 = (local60 * (local35 - local40) + local80 * local40) / local35;
			}
			arg0.anInt936 = 0;
			if (arg0.anInt931 == 0) {
				arg0.anInt934 = 1024;
			...
			signlink.reporterror("86706, " + arg0 + ", " + 0 + ", " + local142.toString());
			throw new RuntimeException();
		}
	}
		...
		try {
			...
			if (arg1.anInt935 == 0) {
				...
				if (arg1.anInt915 != -1 && arg1.anInt918 == 0) {
					@Pc(28) Class19 local28 = Class19.aClass19Array1[arg1.anInt915];
					if (local28.anIntArray189 == null) {
						arg1.anInt936++;
						return;
					}
				}
				@Pc(41) int local41 = arg1.anInt890;
				@Pc(44) int local44 = arg1.anInt891;
				@Pc(59) int local59 = arg1.anIntArray232[arg1.anInt935 - 1] * 128 + arg1.anInt893 * 64;
				@Pc(74) int local74 = arg1.anIntArray233[arg1.anInt935 - 1] * 128 + arg1.anInt893 * 64;
				if (local59 - local41 <= 256 && local59 - local41 >= -256 && local74 - local44 <= 256 && local74 - local44 >= -256) {
					...
					@Pc(168) int local168 = arg1.anInt934 - arg1.anInt892 & 0x7FF;
					if (local168 > 1024) {
						local168 -= 2048;
					}
					@Pc(175) int local175 = arg1.anInt897;
					if (local168 >= -256 && local168 <= 256) {
						local175 = arg1.anInt896;
					} else if (local168 >= 256 && local168 < 768) {
						local175 = arg1.anInt899;
					} else if (local168 >= -768 && local168 <= -256) {
						local175 = arg1.anInt898;
					}
					if (local175 == -1) {
						local175 = arg1.anInt896;
					}
					arg1.anInt912 = local175;
					...
					if (local217 >= 8 && arg1.anInt912 == arg1.anInt896 && arg1.anInt900 != -1) {
						arg1.anInt912 = arg1.anInt900;
					}
					if (local41 < local59) {
						arg1.anInt890 += local217;
						if (arg1.anInt890 > local59) {
							arg1.anInt890 = local59;
						}
					} else if (local41 > local59) {
						arg1.anInt890 -= local217;
						if (arg1.anInt890 < local59) {
					...
					if (local44 < local74) {
						arg1.anInt891 += local217;
						if (arg1.anInt891 > local74) {
							arg1.anInt891 = local74;
						}
					} else if (local44 > local74) {
						arg1.anInt891 -= local217;
						if (arg1.anInt891 < local74) {
					...
					if (arg1.anInt890 == local59 && arg1.anInt891 == local74) {
						arg1.anInt935--;
					}
				} else {
					arg1.anInt890 = local59;
	...
	private void method128(@OriginalArg(0) Class1_Sub1_Sub3 arg0) {
		try {
			@Pc(30) int local30;
			@Pc(36) int local36;
			if (arg0.anInt909 != -1 && arg0.anInt909 < 32768) {
				@Pc(22) Class1_Sub1_Sub3_Sub1 local22 = this.aClass1_Sub1_Sub3_Sub1Array1[arg0.anInt909];
				if (local22 != null) {
					local30 = arg0.anInt890 - local22.anInt890;
					local36 = arg0.anInt891 - local22.anInt891;
					if (local30 != 0 || local36 != 0) {
						arg0.anInt934 = (int) (Math.atan2((double) local30, (double) local36) * 325.949D) & 0x7FF;
					}
				}
			}
			@Pc(61) int local61;
			if (arg0.anInt909 >= 32768) {
				local61 = arg0.anInt909 - 32768;
				...
				if (local73 != null) {
					local36 = arg0.anInt890 - local73.anInt890;
					@Pc(87) int local87 = arg0.anInt891 - local73.anInt891;
					if (local36 != 0 || local87 != 0) {
						arg0.anInt934 = (int) (Math.atan2((double) local36, (double) local87) * 325.949D) & 0x7FF;
					}
				}
			}
			if ((arg0.anInt910 != 0 || arg0.anInt911 != 0) && (arg0.anInt935 == 0 || arg0.anInt936 > 0)) {
				local61 = arg0.anInt890 - (arg0.anInt910 - this.anInt169 - this.anInt169) * 64;
				local30 = arg0.anInt891 - (arg0.anInt911 - this.anInt170 - this.anInt170) * 64;
				if (local61 != 0 || local30 != 0) {
					arg0.anInt934 = (int) (Math.atan2((double) local61, (double) local30) * 325.949D) & 0x7FF;
				}
				arg0.anInt910 = 0;
				arg0.anInt911 = 0;
			}
			local61 = arg0.anInt934 - arg0.anInt892 & 0x7FF;
			if (local61 != 0) {
			...
			signlink.reporterror("29025, " + arg0 + ", " + 117 + ", " + local235.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method129(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class1_Sub1_Sub3 arg1) {
		try {
			if (arg0) {
				...
				if (arg1.anInt912 != -1) {
					local16 = Class19.aClass19Array1[arg1.anInt912];
					arg1.anInt914++;
					if (arg1.anInt913 < local16.anInt543 && arg1.anInt914 > local16.anIntArray188[arg1.anInt913]) {
						arg1.anInt914 = 0;
						arg1.anInt913++;
					}
				...
				if (arg1.anInt915 != -1 && arg1.anInt918 == 0) {
					local16 = Class19.aClass19Array1[arg1.anInt915];
					arg1.anInt917++;
					while (arg1.anInt916 < local16.anInt543 && arg1.anInt917 > local16.anIntArray188[arg1.anInt916]) {
						arg1.anInt917 -= local16.anIntArray188[arg1.anInt916];
						arg1.anInt916++;
					}
					if (arg1.anInt916 >= local16.anInt543) {
						arg1.anInt916 -= local16.anInt544;
						arg1.anInt919++;
						if (arg1.anInt919 >= local16.anInt548) {
							arg1.anInt915 = -1;
						}
						if (arg1.anInt916 < 0 || arg1.anInt916 >= local16.anInt543) {
							arg1.anInt915 = -1;
						}
					}
					arg1.aBoolean162 = local16.aBoolean126;
				}
				if (arg1.anInt918 > 0) {
					arg1.anInt918--;
				}
				if (arg1.anInt920 != -1 && anInt266 >= arg1.anInt923) {
					...
					local16 = Class21.aClass21Array1[arg1.anInt920].aClass19_1;
					arg1.anInt922++;
					while (arg1.anInt921 < local16.anInt543 && arg1.anInt922 > local16.anIntArray188[arg1.anInt921]) {
						arg1.anInt922 -= local16.anIntArray188[arg1.anInt921];
						arg1.anInt921++;
					}
					if (arg1.anInt921 >= local16.anInt543) {
						if (arg1.anInt921 < 0 || arg1.anInt921 >= local16.anInt543) {
							arg1.anInt920 = -1;
						}
						return;
					}
	...
	private void method130() {
		try {
			if (this.aBoolean37) {
				this.aBoolean37 = false;
				this.aClass32_6.method464(11, super.aGraphics2, 0);
				this.aClass32_7.method464(375, super.aGraphics2, 0);
				this.aClass32_8.method464(5, super.aGraphics2, 729);
				this.aClass32_9.method464(231, super.aGraphics2, 752);
				this.aClass32_10.method464(0, super.aGraphics2, 0);
				this.aClass32_11.method464(0, super.aGraphics2, 561);
				this.aClass32_12.method464(11, super.aGraphics2, 520);
				this.aClass32_13.method464(231, super.aGraphics2, 520);
				this.aClass32_14.method464(375, super.aGraphics2, 501);
				this.aClass32_15.method464(345, super.aGraphics2, 0);
				this.aBoolean59 = true;
				this.aBoolean60 = true;
				this.aBoolean68 = true;
				this.aBoolean56 = true;
				if (this.anInt307 != 2) {
					this.aClass32_27.method464(11, super.aGraphics2, 8);
					this.aClass32_26.method464(5, super.aGraphics2, 561);
				}
			}
			if (this.anInt307 == 2) {
				this.method86();
			...
			if (this.anInt330 != -1) {
				local152 = this.method171(this.anInt330, this.anInt270);
				if (local152) {
					this.aBoolean59 = true;
				}
			}
			...
			if (this.anInt280 == -1) {
				...
				if (super.anInt135 > 453 && super.anInt135 < 565 && super.anInt136 > 350) {
					this.method158(super.anInt135 - 22, super.anInt136 - 375, this.anInt185, 77, false, 463, 0, this.aClass15_1);
				}
			...
			if (this.anInt280 != -1) {
				local152 = this.method171(this.anInt280, this.anInt270);
				if (local152) {
					this.aBoolean60 = true;
				}
			}
			...
			if (this.aBoolean68) {
				...
				this.aClass32_5.method464(165, super.aGraphics2, 520);
				this.aClass32_4.method463();
				this.aClass1_Sub3_Sub2_Sub3_7.method350(0, 0);
				if (this.anInt330 == -1) {
					if (this.anIntArray46[this.anInt166] != -1) {
						if (this.anInt166 == 7) {
							this.aClass1_Sub3_Sub2_Sub3_12.method350(0, 49);
						}
						if (this.anInt166 == 8) {
							this.aClass1_Sub3_Sub2_Sub3_13.method350(0, 81);
						}
						if (this.anInt166 == 9) {
							this.aClass1_Sub3_Sub2_Sub3_13.method350(0, 108);
						}
						if (this.anInt166 == 10) {
							this.aClass1_Sub3_Sub2_Sub3_14.method350(1, 136);
						}
						if (this.anInt166 == 11) {
							this.aClass1_Sub3_Sub2_Sub3_16.method350(0, 178);
						}
						if (this.anInt166 == 12) {
							this.aClass1_Sub3_Sub2_Sub3_16.method350(0, 205);
						}
						if (this.anInt166 == 13) {
							this.aClass1_Sub3_Sub2_Sub3_15.method350(0, 233);
						}
					}
				...
				this.aClass32_4.method464(492, super.aGraphics2, 501);
				this.aClass32_27.method463();
			}
			if (this.aBoolean56) {
				this.aBoolean56 = false;
				this.aClass32_3.method463();
				...
				this.aClass32_3.method464(471, super.aGraphics2, 0);
				this.aClass32_27.method463();
			}
			this.anInt270 = 0;
		} catch (@Pc(1061) RuntimeException local1061) {
			signlink.reporterror("48371, " + 29510 + ", " + local1061.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "e", descriptor = "(II)Z")
	private boolean method131(@OriginalArg(1) int arg0) {
		try {
			if (arg0 < 0) {
				return false;
			}
			...
			signlink.reporterror("6950, " + 145 + ", " + arg0 + ", " + local26.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method132(@OriginalArg(1) int arg0) {
		try {
			if (arg0 >= 0) {
				...
				if (local28 == 903 || local28 == 363) {
					...
					if (local52 != -1) {
						...
						local69 = Class40.method542(Class40.method539(Class40.method538(local48)));
						...
						for (local73 = 0; local73 < this.anInt205; local73++) {
							...
							if (local83 != null && local83.aString30 != null && local83.aString30.equalsIgnoreCase(local69)) {
								this.method168(this.aClass1_Sub1_Sub3_Sub2_1.anIntArray232[0], 1, false, local83.anIntArray232[0], this.aClass1_Sub1_Sub3_Sub2_1.anIntArray233[0], 2, 1, local83.anIntArray233[0], 0, 0, 0);
								if (local28 == 903) {
									this.aClass1_Sub3_Sub3_6.method380(206);
								}
								if (local28 == 363) {
									this.aClass1_Sub3_Sub3_6.method380(164);
								}
						...
						if (!local71) {
							this.method172(0, "Unable to find " + local69, "");
						}
					}
				}
				if (local28 == 450 && this.method153(75, local18, local23, local33)) {
				...
				if (local28 == 405 || local28 == 38 || local28 == 422 || local28 == 478 || local28 == 347) {
					if (local28 == 478) {
						...
						if (anInt143 >= 90) {
							this.aClass1_Sub3_Sub3_6.method380(220);
						}
						this.aClass1_Sub3_Sub3_6.method380(157);
					}
					if (local28 == 347) {
						this.aClass1_Sub3_Sub3_6.method380(211);
					}
					if (local28 == 422) {
						this.aClass1_Sub3_Sub3_6.method380(133);
					}
					if (local28 == 405) {
						anInt195 += local33;
						if (anInt195 >= 97) {
							this.aClass1_Sub3_Sub3_6.method380(30);
							this.aClass1_Sub3_Sub3_6.method384(14953816);
						}
						this.aClass1_Sub3_Sub3_6.method380(195);
					}
					if (local28 == 38) {
						this.aClass1_Sub3_Sub3_6.method380(71);
					}
					...
					this.anInt260 = 2;
					if (Class15.aClass15Array1[local23].anInt471 == this.anInt271) {
						this.anInt260 = 1;
					}
					if (Class15.aClass15Array1[local23].anInt471 == this.anInt280) {
						this.anInt260 = 3;
					}
				}
				...
				if (local28 == 728 || local28 == 542 || local28 == 6 || local28 == 963 || local28 == 245) {
					...
					if (local345 != null) {
						this.method168(this.aClass1_Sub1_Sub3_Sub2_1.anIntArray232[0], 1, false, local345.anIntArray232[0], this.aClass1_Sub1_Sub3_Sub2_1.anIntArray233[0], 2, 1, local345.anIntArray233[0], 0, 0, 0);
						this.anInt153 = super.anInt138;
						this.anInt154 = super.anInt139;
						this.anInt156 = 2;
						this.anInt155 = 0;
						if (local28 == 542) {
							this.aClass1_Sub3_Sub3_6.method380(8);
						}
						if (local28 == 6) {
							if ((local33 & 0x3) == 0) {
								anInt224++;
							...
							if (anInt224 >= 124) {
								this.aClass1_Sub3_Sub3_6.method380(88);
								this.aClass1_Sub3_Sub3_6.method385(0);
							}
							this.aClass1_Sub3_Sub3_6.method380(27);
						}
						if (local28 == 963) {
							this.aClass1_Sub3_Sub3_6.method380(113);
						}
						if (local28 == 728) {
							this.aClass1_Sub3_Sub3_6.method380(194);
						}
						if (local28 == 245) {
							if ((local33 & 0x3) == 0) {
								anInt188++;
							...
							if (anInt188 >= 85) {
								this.aClass1_Sub3_Sub3_6.method380(176);
								this.aClass1_Sub3_Sub3_6.method382(39596);
							}
							this.aClass1_Sub3_Sub3_6.method380(100);
						}
						this.aClass1_Sub3_Sub3_6.method382(local33);
					}
				}
				...
				if (local28 == 217) {
					local500 = this.method168(this.aClass1_Sub1_Sub3_Sub2_1.anIntArray232[0], 0, false, local18, this.aClass1_Sub1_Sub3_Sub2_1.anIntArray233[0], 2, 0, local23, 0, 0, 0);
					if (!local500) {
						this.method168(this.aClass1_Sub1_Sub3_Sub2_1.anIntArray232[0], 1, false, local18, this.aClass1_Sub1_Sub3_Sub2_1.anIntArray233[0], 2, 1, local23, 0, 0, 0);
					}
					this.anInt153 = super.anInt138;
					this.anInt154 = super.anInt139;
					this.anInt156 = 2;
					this.anInt155 = 0;
					this.aClass1_Sub3_Sub3_6.method380(239);
				...
				if (local28 == 1175) {
					...
					@Pc(589) Class2 local589 = Class2.method23(local586);
					if (local589.aByteArray1 == null) {
						local69 = "It's a " + local589.aString1 + ".";
					} else {
						local69 = new String(local589.aByteArray1);
					}
					this.method172(0, local69, "");
				}
				if (local28 == 285) {
					this.method153(245, local18, local23, local33);
				}
				if (local28 == 881) {
					this.aClass1_Sub3_Sub3_6.method380(130);
					this.aClass1_Sub3_Sub3_6.method382(local33);
					this.aClass1_Sub3_Sub3_6.method382(local18);
					this.aClass1_Sub3_Sub3_6.method382(local23);
					this.aClass1_Sub3_Sub3_6.method382(this.anInt284);
				...
				if (local28 == 391) {
					this.aClass1_Sub3_Sub3_6.method380(48);
					this.aClass1_Sub3_Sub3_6.method382(local33);
					this.aClass1_Sub3_Sub3_6.method382(local18);
					this.aClass1_Sub3_Sub3_6.method382(local23);
				...
				if (local28 == 660) {
					if (this.aBoolean50) {
						...
						this.aClass33_1.method506(super.anInt139 - 11, super.anInt138 - 8);
					}
				}
				if (local28 == 188) {
					this.anInt281 = 1;
					...
					this.aString10 = Class5.method54(local33).aString3;
					this.anInt291 = 0;
				} else {
					if (local28 == 44 && !this.aBoolean49) {
						this.aClass1_Sub3_Sub3_6.method380(235);
						this.aClass1_Sub3_Sub3_6.method382(local23);
					...
					if (local28 == 1773) {
						local830 = Class5.method54(local33);
						if (local23 >= 100000) {
					...
					if (local28 == 900) {
						...
						if (local345 != null) {
							...
							this.anInt156 = 2;
							this.anInt155 = 0;
							this.aClass1_Sub3_Sub3_6.method380(202);
							this.aClass1_Sub3_Sub3_6.method382(local33);
							this.aClass1_Sub3_Sub3_6.method382(this.anInt284);
							this.aClass1_Sub3_Sub3_6.method382(this.anInt282);
							this.aClass1_Sub3_Sub3_6.method382(this.anInt283);
					...
					if (local28 == 1373 || local28 == 1544 || local28 == 151 || local28 == 1101) {
						...
						if (local969 != null) {
							this.method168(this.aClass1_Sub1_Sub3_Sub2_1.anIntArray232[0], 1, false, local969.anIntArray232[0], this.aClass1_Sub1_Sub3_Sub2_1.anIntArray233[0], 2, 1, local969.anIntArray233[0], 0, 0, 0);
							this.anInt153 = super.anInt138;
							this.anInt154 = super.anInt139;
							this.anInt156 = 2;
							this.anInt155 = 0;
							...
							if (local28 == 151) {
								anInt237++;
								if (anInt237 >= 90) {
									this.aClass1_Sub3_Sub3_6.method380(2);
									this.aClass1_Sub3_Sub3_6.method382(31114);
								}
								this.aClass1_Sub3_Sub3_6.method380(53);
							}
							if (local28 == 1373) {
								this.aClass1_Sub3_Sub3_6.method380(206);
							}
							if (local28 == 1544) {
								this.aClass1_Sub3_Sub3_6.method380(185);
							}
							this.aClass1_Sub3_Sub3_6.method382(local33);
						}
					}
					if (local28 == 265) {
						...
						if (local345 != null) {
							...
							this.anInt156 = 2;
							this.anInt155 = 0;
							this.aClass1_Sub3_Sub3_6.method380(134);
							this.aClass1_Sub3_Sub3_6.method382(local33);
							this.aClass1_Sub3_Sub3_6.method382(this.anInt292);
						}
					}
					...
					if (local28 == 679) {
						...
						local52 = local48.indexOf("@whi@");
						if (local52 != -1) {
							local1156 = Class40.method538(local48.substring(local52 + 5).trim());
							local73 = -1;
					...
					if (local28 == 55 && this.method153(9, local18, local23, local33)) {
						this.aClass1_Sub3_Sub3_6.method382(this.anInt292);
					}
					if (local28 == 224 || local28 == 993 || local28 == 99 || local28 == 746 || local28 == 877) {
						...
						this.anInt155 = 0;
						if (local28 == 224) {
							this.aClass1_Sub3_Sub3_6.method380(140);
						}
						if (local28 == 746) {
							this.aClass1_Sub3_Sub3_6.method380(178);
						}
						if (local28 == 877) {
							this.aClass1_Sub3_Sub3_6.method380(247);
						}
						if (local28 == 99) {
							this.aClass1_Sub3_Sub3_6.method380(200);
						}
						if (local28 == 993) {
							this.aClass1_Sub3_Sub3_6.method380(40);
						}
						this.aClass1_Sub3_Sub3_6.method382(local18 + this.anInt169);
						this.aClass1_Sub3_Sub3_6.method382(local23 + this.anInt170);
						this.aClass1_Sub3_Sub3_6.method382(local33);
					...
					if (local28 == 504) {
						this.method153(172, local18, local23, local33);
					}
					@Pc(1429) Class15 local1429;
					if (local28 == 930) {
						local1429 = Class15.aClass15Array1[local23];
						this.anInt291 = 1;
						...
						if (local28 == 951) {
							...
							if (local1429.anInt474 > 0) {
								local1513 = this.method142(local1429);
							}
							if (local1513) {
								this.aClass1_Sub3_Sub3_6.method380(155);
								this.aClass1_Sub3_Sub3_6.method382(local23);
							}
						}
						if (local28 == 602 || local28 == 596 || local28 == 22 || local28 == 892 || local28 == 415) {
							if (local28 == 22) {
								this.aClass1_Sub3_Sub3_6.method380(212);
							}
							if (local28 == 415) {
								if ((local23 & 0x3) == 0) {
									anInt254++;
								...
								if (anInt254 >= 55) {
									this.aClass1_Sub3_Sub3_6.method380(17);
									this.aClass1_Sub3_Sub3_6.method385(0);
								}
								this.aClass1_Sub3_Sub3_6.method380(6);
							}
							if (local28 == 602) {
								this.aClass1_Sub3_Sub3_6.method380(31);
							}
							if (local28 == 892) {
								if ((local18 & 0x3) == 0) {
									anInt229++;
								...
								if (anInt229 >= 130) {
									this.aClass1_Sub3_Sub3_6.method380(238);
									this.aClass1_Sub3_Sub3_6.method381(177);
								}
								this.aClass1_Sub3_Sub3_6.method380(38);
							}
							if (local28 == 596) {
								this.aClass1_Sub3_Sub3_6.method380(59);
							}
							this.aClass1_Sub3_Sub3_6.method382(local33);
							this.aClass1_Sub3_Sub3_6.method382(local18);
							this.aClass1_Sub3_Sub3_6.method382(local23);
						...
						if (local28 == 581) {
							...
							if (anInt175 >= 99) {
								this.aClass1_Sub3_Sub3_6.method380(7);
								this.aClass1_Sub3_Sub3_6.method385(0);
							}
							this.method153(97, local18, local23, local33);
						}
						if (local28 == 965) {
							local500 = this.method168(this.aClass1_Sub1_Sub3_Sub2_1.anIntArray232[0], 0, false, local18, this.aClass1_Sub1_Sub3_Sub2_1.anIntArray233[0], 2, 0, local23, 0, 0, 0);
							if (!local500) {
							...
							this.anInt156 = 2;
							this.anInt155 = 0;
							this.aClass1_Sub3_Sub3_6.method380(138);
							this.aClass1_Sub3_Sub3_6.method382(local18 + this.anInt169);
							this.aClass1_Sub3_Sub3_6.method382(local23 + this.anInt170);
							this.aClass1_Sub3_Sub3_6.method382(local33);
							this.aClass1_Sub3_Sub3_6.method382(this.anInt292);
						...
						if (local28 == 1501) {
							...
							if (anInt220 >= 92) {
								this.aClass1_Sub3_Sub3_6.method380(66);
								this.aClass1_Sub3_Sub3_6.method385(0);
							}
							this.method153(116, local18, local23, local33);
						}
						if (local28 == 364) {
							this.method153(96, local18, local23, local33);
						}
						if (local28 == 1102) {
							local830 = Class5.method54(local33);
						...
						if (local28 == 34) {
							...
							if (local52 != -1) {
								...
								this.aBoolean51 = false;
								for (@Pc(1957) int local1957 = 0; local1957 < Class15.aClass15Array1.length; local1957++) {
									if (Class15.aClass15Array1[local1957] != null && Class15.aClass15Array1[local1957].anInt474 == 600) {
										this.anInt240 = this.anInt271 = Class15.aClass15Array1[local1957].anInt471;
										break;
									}
								}
							}
						...
						if (local28 == 367) {
							...
							if (local969 != null) {
								...
								this.anInt156 = 2;
								this.anInt155 = 0;
								this.aClass1_Sub3_Sub3_6.method380(248);
								this.aClass1_Sub3_Sub3_6.method382(local33);
								this.aClass1_Sub3_Sub3_6.method382(this.anInt284);
								this.aClass1_Sub3_Sub3_6.method382(this.anInt282);
								this.aClass1_Sub3_Sub3_6.method382(this.anInt283);
						...
						if (local28 == 406 || local28 == 436 || local28 == 557 || local28 == 556) {
							...
							if (local52 != -1) {
								local1156 = Class40.method538(local48.substring(local52 + 5).trim());
								if (local28 == 406) {
									this.method161(local1156);
								}
								if (local28 == 436) {
									this.method82(local1156);
								}
								if (local28 == 557) {
									this.method174(local1156);
								}
								if (local28 == 556) {
									this.method191(local1156);
								}
							}
						}
						if (local28 == 651) {
							...
							if (local969 != null) {
								...
								this.anInt156 = 2;
								this.anInt155 = 0;
								this.aClass1_Sub3_Sub3_6.method380(177);
								this.aClass1_Sub3_Sub3_6.method382(local33);
								this.aClass1_Sub3_Sub3_6.method382(this.anInt292);
							}
						}
			...
			signlink.reporterror("53215, " + 6412 + ", " + arg0 + ", " + local2259.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "s", descriptor = "(I)Ljava/lang/String;")
	private String method134() {
		try {
			if (signlink.mainapp == null) {
			...
			signlink.reporterror("57946, " + -7437 + ", " + local24.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method135() {
		try {
			...
			Class1_Sub3_Sub2.method358(local5, local2, 6116423, local8, local11);
			Class1_Sub3_Sub2.method358(local5 + 1, local2 + 1, 0, local8 - 2, 16);
			Class1_Sub3_Sub2.method359(local2 + 1, 0, local11 - 19, local5 + 18, local8 - 2);
			...
			signlink.reporterror("42520, " + -961 + ", " + local150.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "c", descriptor = "(III)V")
	private void method136(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		try {
			if (this.anInt210 != 0) {
				@Pc(5) int local5 = 0;
				if (this.anInt267 != 0) {
				...
				for (@Pc(12) int local12 = 0; local12 < 100; local12++) {
					if (this.aStringArray7[local12] != null) {
						...
						if ((local24 == 3 || local24 == 7) && (local24 == 7 || this.anInt164 == 0 || this.anInt164 == 1 && this.method199(this.aStringArray6[local12]))) {
			...
			signlink.reporterror("26899, " + arg0 + ", " + 27078 + ", " + arg1 + ", " + local197.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(ILclient!hc;)V")
	private void method137(@OriginalArg(1) Class15 arg0) {
		try {
			...
			if (local4 >= 1 && local4 <= 100) {
				...
				if (this.aBoolean39) {
					...
					for (@Pc(213) int local213 = 0; local213 < 7; local213++) {
						...
						if (local220 >= 0) {
							local209[local211++] = Class13.aClass13Array1[local220].method306();
						}
					}
					...
					local241.method230();
					local241.method231(Class19.aClass19Array1[this.aClass1_Sub1_Sub3_Sub2_1.anInt894].anIntArray186[0]);
					local241.method240(64, 850, -30, -50, -30, true);
					arg0.aClass1_Sub3_Sub1_2 = local241;
				}
			} else if (local4 == 324) {
			...
			signlink.reporterror("10984, " + 0 + ", " + arg0 + ", " + local623.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "([BII)Z")
	private boolean method138(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
		try {
			return arg0 == null ? true : signlink.wavesave(arg0, arg1);
		} catch (@Pc(13) RuntimeException local13) {
			signlink.reporterror("94307, " + arg0 + ", " + arg1 + ", " + 0 + ", " + local13.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method140(@OriginalArg(0) int arg0) {
		try {
			...
			signlink.reporterror("63786, " + arg0 + ", " + 0 + ", " + local8.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(ZLclient!kb;I)V")
	private void method141(@OriginalArg(1) Class1_Sub3_Sub3 arg0, @OriginalArg(2) int arg1) {
		try {
			while (true) {
				if (arg0.anInt562 + 21 < arg1 * 8) {
					...
					if (local16 != 8191) {
						...
						local36.anInt932 = anInt266;
						local36.aClass3_1 = Class3.method32(arg0.method402(11));
						local36.anInt893 = local36.aClass3_1.aByte4;
						local36.anInt896 = local36.aClass3_1.anInt70;
						local36.anInt897 = local36.aClass3_1.anInt71;
						local36.anInt898 = local36.aClass3_1.anInt72;
						local36.anInt899 = local36.aClass3_1.anInt73;
						local36.anInt894 = local36.aClass3_1.anInt69;
			...
			signlink.reporterror("14259, " + false + ", " + arg0 + ", " + arg1 + ", " + local150.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(ZLclient!hc;)Z")
	private boolean method142(@OriginalArg(1) Class15 arg0) {
		try {
			@Pc(4) int local4 = arg0.anInt474;
			if (local4 == 201) {
				this.aBoolean60 = true;
				...
				if (local121 != -1) {
					while (true) {
						if (local116 == 0) {
							local121--;
							if (local121 < 0) {
								local121 = Class13.anInt437 - 1;
							}
						}
						if (local116 == 1) {
							local121++;
							if (local121 >= Class13.anInt437) {
								local121 = 0;
							}
						}
						if (!Class13.aClass13Array1[local121].aBoolean101 && Class13.aClass13Array1[local121].anInt438 == local112 + (this.aBoolean43 ? 0 : 7)) {
			...
			if (local4 == 326) {
				this.aClass1_Sub3_Sub3_6.method380(52);
			...
			if (local4 >= 601 && local4 <= 612) {
				...
				if (this.aString9.length() > 0) {
					this.aClass1_Sub3_Sub3_6.method380(190);
					this.aClass1_Sub3_Sub3_6.method387(Class40.method538(this.aString9));
			...
			signlink.reporterror("80636, " + false + ", " + arg0 + ", " + local349.toString());
			throw new RuntimeException();
		}
	}
	...
	protected void method67() {
		...
		if (!aBoolean53) {
			...
			this.method73(this, 2);
			this.method75(12345678, "scape_main", 40000);
		}
		if (aBoolean69) {
		...
		@Pc(38) String local38 = this.method134();
		...
		try {
			...
			this.aClass39_1 = this.method98("title screen", this.anIntArray38[1], "title", 10);
			...
			this.method189();
			this.method109();
			@Pc(255) Class39 local255 = this.method98("config", this.anIntArray38[2], "config", 15);
			@Pc(266) Class39 local266 = this.method98("interface", this.anIntArray38[3], "interface", 20);
			@Pc(277) Class39 local277 = this.method98("2d graphics", this.anIntArray38[4], "media", 30);
			@Pc(288) Class39 local288 = this.method98("3d graphics", this.anIntArray38[5], "models", 40);
			@Pc(299) Class39 local299 = this.method98("textures", this.anIntArray38[6], "textures", 60);
			@Pc(310) Class39 local310 = this.method98("chat system", this.anIntArray38[7], "wordenc", 65);
			@Pc(321) Class39 local321 = this.method98("sound effects", this.anIntArray38[8], "sounds", 70);
			...
			for (@Pc(998) int local998 = 0; local998 < 50; local998++) {
				if (this.aClass1_Sub3_Sub2_Sub2Array7[local998] != null) {
					this.aClass1_Sub3_Sub2_Sub2Array7[local998].method319(local975 + local996, local982 + local996, local989 + local996);
				}
			...
			Class1_Sub3_Sub2_Sub1.method292(local299);
			Class1_Sub3_Sub2_Sub1.method296(0.8D);
			Class1_Sub3_Sub2_Sub1.method291();
			this.method74("Unpacking models", 83);
			Class1_Sub3_Sub1.method225(anInt268, local288);
			...
			Class11.method272(local255, 473);
			Class5.method52(local255);
			Class3.method30(local255);
			Class13.method304(local255, 473);
			Class21.method407(local255, 473);
			Class23.method411(local255, 473);
			...
			if (!aBoolean53) {
				...
				Class43.method561(local1119, 473);
			}
			...
			Class15.method331(local277, local1150, 30, local266);
			...
			Class1_Sub3_Sub2_Sub1.method289(96, 479);
			this.anIntArray30 = Class1_Sub3_Sub2_Sub1.anIntArray139;
			Class1_Sub3_Sub2_Sub1.method289(261, 190);
			this.anIntArray31 = Class1_Sub3_Sub2_Sub1.anIntArray139;
			Class1_Sub3_Sub2_Sub1.method289(334, 512);
			...
			Class33.method504(local1312, aByte13);
	...
	private void method143(@OriginalArg(0) int arg0) {
		try {
			if (this.anInt216 == 0) {
				...
				this.anInt304 = 1;
				this.method136(super.anInt135, super.anInt136);
				this.anInt225 = 0;
				...
				if (super.anInt135 > 8 && super.anInt136 > 11 && super.anInt135 < 520 && super.anInt136 < 345) {
					if (this.anInt271 == -1) {
						...
						this.method90(super.anInt136, super.anInt135, 11, Class15.aClass15Array1[this.anInt271], 8, 0);
					}
				}
				...
				if (super.anInt135 > 562 && super.anInt136 > 231 && super.anInt135 < 752 && super.anInt136 < 492) {
					if (this.anInt330 != -1) {
						this.method90(super.anInt136, super.anInt135, 231, Class15.aClass15Array1[this.anInt330], 562, 0);
					} else if (this.anIntArray46[this.anInt166] != -1) {
						this.method90(super.anInt136, super.anInt135, 231, Class15.aClass15Array1[this.anIntArray46[this.anInt166]], 562, 0);
					}
				}
				...
				if (super.anInt135 > 22 && super.anInt136 > 375 && super.anInt135 < 431 && super.anInt136 < 471) {
					if (this.anInt280 == -1) {
						this.method92(super.anInt136 - 375, super.anInt135 - 22);
					} else {
						this.method90(super.anInt136, super.anInt135, 375, Class15.aClass15Array1[this.anInt280], 22, 0);
					}
				}
	...
	private void method145() {
		try {
			...
			this.method80();
			if (this.anInt156 == 1) {
				this.aClass1_Sub3_Sub2_Sub2Array6[this.anInt155 / 100].method322(this.anInt154 - 8 - 11, this.anInt153 - 8 - 8);
			}
			if (this.anInt156 == 2) {
				this.aClass1_Sub3_Sub2_Sub2Array6[this.anInt155 / 100 + 4].method322(this.anInt154 - 8 - 11, this.anInt153 - 8 - 8);
			}
			if (this.anInt271 != -1) {
				this.method171(this.anInt271, this.anInt270);
				this.method120(0, 0, Class15.aClass15Array1[this.anInt271], 0);
			}
			this.method79();
			if (!this.aBoolean50) {
				this.method143(26);
			...
			signlink.reporterror("17204, " + 9 + ", " + local242.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method146() {
		try {
			@Pc(8) int local8 = this.aClass1_Sub1_Sub3_Sub2_1.anInt890 + this.anInt327;
			@Pc(15) int local15 = this.aClass1_Sub1_Sub3_Sub2_1.anInt891 + this.anInt331;
			...
			@Pc(223) int local223 = this.method94(this.anInt231, this.anInt243, this.anInt244);
			...
			signlink.reporterror("53255, " + 0 + ", " + local343.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method147() {
		try {
			for (@Pc(12) Class1_Sub1_Sub1 local12 = (Class1_Sub1_Sub1) this.aClass28_3.method456(); local12 != null; local12 = (Class1_Sub1_Sub1) this.aClass28_3.method458()) {
				if (local12.anInt24 != this.anInt231 || anInt266 > local12.anInt30) {
					...
					if (local12.anInt33 > 0) {
						...
						if (local42 != null) {
							local12.method19(this.method94(local12.anInt24, local42.anInt890, local42.anInt891) - local12.anInt28, local42.anInt891, local42.anInt890, anInt266);
						}
					}
					if (local12.anInt33 < 0) {
						...
						if (local80 != null) {
							local12.method19(this.method94(local12.anInt24, local80.anInt890, local80.anInt891) - local12.anInt28, local80.anInt891, local80.anInt890, anInt266);
						}
					}
					local12.method20(this.anInt270);
					this.aClass33_1.method478((int) local12.aDouble2, 60, local12.anInt34, (int) local12.aDouble1, -1, false, null, local12, (int) local12.aDouble3, this.anInt231);
				}
			}
		} catch (@Pc(147) RuntimeException local147) {
			signlink.reporterror("67909, " + -26 + ", " + local147.toString());
			throw new RuntimeException();
		}
	}
	...
	protected void method71() {
		try {
			...
			signlink.reporterror("92948, " + 3 + ", " + local13.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(IILclient!hb;I)V")
	private void method148(@OriginalArg(0) int arg0, @OriginalArg(2) Class1_Sub3_Sub2_Sub2 arg1, @OriginalArg(3) int arg2) {
		try {
			@Pc(7) int local7 = this.anInt200 + this.anInt308 & 0x7FF;
			@Pc(15) int local15 = arg2 * arg2 + arg0 * arg0;
			if (local15 <= 6400) {
				@Pc(34) int local34 = Class1_Sub3_Sub1.anIntArray124[local7];
				@Pc(38) int local38 = Class1_Sub3_Sub1.anIntArray125[local7];
				...
				if (local15 > 2500) {
					arg1.method329(this.aClass1_Sub3_Sub2_Sub3_10, 83 - local76 - arg1.anInt466 / 2, local66 + 94 - arg1.anInt465 / 2);
				} else {
					arg1.method322(83 - local76 - arg1.anInt466 / 2, local66 + 94 - arg1.anInt465 / 2);
				}
			}
		} catch (@Pc(122) RuntimeException local122) {
			signlink.reporterror("70875, " + arg0 + ", " + 4 + ", " + arg1 + ", " + arg2 + ", " + local122.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(IIII)I")
	private int method149(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		try {
			...
			signlink.reporterror("68501, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + 997 + ", " + local42.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "h", descriptor = "(II)Ljava/lang/String;")
	private String method150(@OriginalArg(0) int arg0) {
		try {
			return arg0 < 999999999 ? String.valueOf(arg0) : "*";
		} catch (@Pc(13) RuntimeException local13) {
			signlink.reporterror("83712, " + arg0 + ", " + -676 + ", " + local13.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method152(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			if (arg1 >= 128 && arg0 >= 128 && arg1 <= 13056 && arg0 <= 13056) {
				@Pc(28) int local28 = this.method94(this.anInt231, arg1, arg0) - arg3;
				@Pc(33) int local33 = arg1 - this.anInt322;
				@Pc(38) int local38 = local28 - this.anInt323;
				@Pc(43) int local43 = arg0 - this.anInt324;
				@Pc(48) int local48 = Class1_Sub3_Sub1.anIntArray124[this.anInt325];
				@Pc(53) int local53 = Class1_Sub3_Sub1.anIntArray125[this.anInt325];
				@Pc(58) int local58 = Class1_Sub3_Sub1.anIntArray124[this.anInt326];
				@Pc(63) int local63 = Class1_Sub3_Sub1.anIntArray125[this.anInt326];
				...
				if (local43 >= 50) {
					this.anInt287 = Class1_Sub3_Sub2_Sub1.anInt430 + (local33 << 9) / local43;
					this.anInt288 = Class1_Sub3_Sub2_Sub1.anInt431 + (local73 << 9) / local43;
				} else {
					this.anInt287 = -1;
					this.anInt288 = -1;
				}
	...
	private boolean method153(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			...
			if (local25 == 10 || local25 == 11 || local25 == 22) {
				...
				this.method168(this.aClass1_Sub1_Sub3_Sub2_1.anIntArray232[0], local51, false, arg1, this.aClass1_Sub1_Sub3_Sub2_1.anIntArray233[0], 2, local54, arg2, 0, 0, local65);
			} else {
				this.method168(this.aClass1_Sub1_Sub3_Sub2_1.anIntArray232[0], 0, false, arg1, this.aClass1_Sub1_Sub3_Sub2_1.anIntArray233[0], 2, 0, arg2, local31, local25 + 1, 0);
			}
			this.anInt153 = super.anInt138;
			this.anInt154 = super.anInt139;
			this.anInt156 = 2;
			...
			signlink.reporterror("35563, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + true + ", " + local175.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method154() {
		try {
			...
			signlink.reporterror("57560, " + -386 + ", " + local288.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method156() {
		try {
			...
			signlink.reporterror("86250, " + 99 + ", " + local175.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method157() {
		try {
			...
			signlink.reporterror("93519, " + -33833 + ", " + local72.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method158(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) boolean arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class15 arg7) {
		try {
			if (this.aBoolean71) {
				this.anInt342 = 32;
			} else {
			...
			signlink.reporterror("76637, " + arg0 + ", " + 0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + arg4 + ", " + arg5 + ", " + arg6 + ", " + arg7 + ", " + local162.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method159(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) boolean arg2) {
		...
		try {
			...
			this.aClass6_1 = new Class6(this, (byte) 2, this.method162(anInt236 + 43594));
			...
			this.aClass1_Sub3_Sub3_4.method389(this.aClass1_Sub3_Sub3_6.aByteArray7, this.aClass1_Sub3_Sub3_6.anInt561);
			...
			this.aClass6_1.method205(this.aClass1_Sub3_Sub3_4.aByteArray7, this.aClass1_Sub3_Sub3_4.anInt561);
	...
	private void method160(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6) {
		try {
			if (arg1 >= 1 && arg2 >= 1 && arg1 <= 102 && arg2 <= 102) {
				...
				@Pc(25) int local25 = 0;
				if (arg3 == 0) {
					local25 = this.aClass33_1.method494(arg6, arg1, arg2);
				}
				if (arg3 == 1) {
					local25 = this.aClass33_1.method495(arg6, arg2, arg1);
				}
				if (arg3 == 2) {
					local25 = this.aClass33_1.method496(arg6, arg1, arg2);
				}
				if (arg3 == 3) {
					local25 = this.aClass33_1.method497(arg6, arg1, arg2);
				}
				@Pc(81) int local81;
				if (local25 != 0) {
					local81 = this.aClass33_1.method498(arg6, arg1, arg2, local25);
					@Pc(87) int local87 = local25 >> 14 & 0x7FFF;
					@Pc(91) int local91 = local81 & 0x1F;
					@Pc(95) int local95 = local81 >> 6;
					@Pc(107) Class2 local107;
					if (arg3 == 0) {
						this.aClass33_1.method489(arg1, arg6, arg2);
						local107 = Class2.method23(local87);
						if (local107.aBoolean7) {
							this.aClass9Array1[arg6].method254(local107.aBoolean8, local95, arg1, arg2, 323, local91);
						}
					}
					if (arg3 == 1) {
						this.aClass33_1.method490(arg6, arg2, this.anInt306, arg1);
					}
					if (arg3 == 2) {
						this.aClass33_1.method491(arg1, arg2, arg6);
						local107 = Class2.method23(local87);
						if (arg1 + local107.anInt43 > 103 || arg2 + local107.anInt43 > 103 || arg1 + local107.anInt44 > 103 || arg2 + local107.anInt44 > 103) {
							return;
						}
						if (local107.aBoolean7) {
							this.aClass9Array1[arg6].method255(arg2, arg1, local95, local107.anInt43, local107.aBoolean8, local107.anInt44);
						}
					}
					if (arg3 == 3) {
						this.aClass33_1.method492(arg6, this.anInt290, arg1, arg2);
						local107 = Class2.method23(local87);
						if (local107.aBoolean7 && local107.aBoolean9) {
							this.aClass9Array1[arg6].method257(arg2, arg1);
						}
					}
				}
				if (arg4 >= 0) {
					...
					Class4.method50(arg1, this.aClass28_1, this.aClass9Array1[arg6], arg2, arg0, this.anIntArrayArrayArray3, arg6, arg4, arg5, this.aClass33_1, local81);
					return;
				}
			}
		} catch (@Pc(258) RuntimeException local258) {
			signlink.reporterror("53981, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + arg4 + ", " + arg5 + ", " + -27819 + ", " + arg6 + ", " + local258.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(JI)V")
	private void method161(@OriginalArg(0) long arg0) {
		try {
			if (arg0 != 0L) {
				if (this.anInt312 >= 100) {
					this.method172(0, "Your friends list is full. Max of 100 hit", "");
				} else {
					@Pc(23) String local23 = Class40.method542(Class40.method539(arg0));
					for (@Pc(25) int local25 = 0; local25 < this.anInt312; local25++) {
						if (this.aLongArray4[local25] == arg0) {
							this.method172(0, local23 + " is already on your friend list", "");
							return;
						}
					}
					for (@Pc(55) int local55 = 0; local55 < this.anInt186; local55++) {
						if (this.aLongArray3[local55] == arg0) {
							this.method172(0, "Please remove " + local23 + " from your ignore list first", "");
							return;
						}
					}
					if (!local23.equals(this.aClass1_Sub1_Sub3_Sub2_1.aString30)) {
						...
						this.anInt312++;
						this.aBoolean59 = true;
						this.aClass1_Sub3_Sub3_6.method380(118);
						this.aClass1_Sub3_Sub3_6.method387(arg0);
					}
				}
			}
		} catch (@Pc(137) RuntimeException local137) {
			signlink.reporterror("3645, " + arg0 + ", " + -460 + ", " + local137.toString());
			throw new RuntimeException();
		}
	}
	...
	protected void method69() {
		try {
			...
			signlink.reporterror("6631, " + -28 + ", " + local361.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method163(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Class1_Sub1_Sub3_Sub2 arg2, @OriginalArg(4) int arg3) {
		try {
			if (arg2 != this.aClass1_Sub1_Sub3_Sub2_1 && this.anInt304 < 400) {
				@Pc(41) String local41 = arg2.aString30 + method133(this.aClass1_Sub1_Sub3_Sub2_1.anInt940, arg2.anInt940) + " (level-" + arg2.anInt940 + ")";
				if (this.anInt281 == 1) {
					...
					if (this.anInt316 > 0) {
						...
						if (this.aClass1_Sub1_Sub3_Sub2_1.anInt940 >= arg2.anInt940) {
			...
			signlink.reporterror("4679, " + false + ", " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + local419.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method164() {
		try {
			...
			for (@Pc(22) int local22 = 0; local22 < 5 && this.method197(); local22++) {
			}
			if (this.aBoolean62) {
				@Pc(155) int local155;
				@Pc(207) int local207;
					...
					if (this.anIntArray45[local46] <= 0) {
						...
						try {
							if (this.anIntArray82[local46] != this.anInt184 || this.anIntArray37[local46] != this.anInt301) {
								@Pc(89) Class1_Sub3_Sub3 local89 = Class43.method562(this.anIntArray37[local46], this.anIntArray82[local46]);
								if (System.currentTimeMillis() + (long) (local89.anInt561 / 22) > this.aLong7 + (long) (this.anInt198 / 22)) {
									...
									if (this.method138(local89.aByteArray7, local89.anInt561)) {
				...
				@Pc(250) Class1_Sub3_Sub3 local250 = Class8.method210();
				if (local250 != null) {
					this.aClass1_Sub3_Sub3_6.method380(81);
					this.aClass1_Sub3_Sub3_6.method382(local250.anInt561);
					this.aClass1_Sub3_Sub3_6.method389(local250.aByteArray7, local250.anInt561);
					local250.method379();
				}
				this.anInt180++;
				...
				if ((super.anIntArray28[1] == 1 || super.anIntArray28[2] == 1 || super.anIntArray28[3] == 1 || super.anIntArray28[4] == 1) && this.anInt245++ > 5) {
					this.anInt245 = 0;
					this.aClass1_Sub3_Sub3_6.method380(189);
					...
					if (super.anInt134 == 0) {
						...
						if (this.aBoolean58 && this.anInt247 >= 5) {
							...
							if (this.anInt311 == this.anInt214 && this.anInt310 != this.anInt215) {
								@Pc(502) Class15 local502 = Class15.aClass15Array1[this.anInt214];
								...
								this.aClass1_Sub3_Sub3_6.method380(159);
						...
						} else if ((this.anInt196 == 1 || this.method131(this.anInt304 - 1)) && this.anInt304 > 2) {
							this.method154();
						} else if (this.anInt304 > 0) {
							this.method132(this.anInt304 - 1);
						}
						this.anInt257 = 10;
						super.anInt137 = 0;
					}
				...
				if (anInt279 > 127) {
					anInt279 = 0;
					this.aClass1_Sub3_Sub3_6.method380(215);
					this.aClass1_Sub3_Sub3_6.method384(4991788);
				}
				if (Class33.anInt714 != -1) {
					local155 = Class33.anInt714;
					local508 = Class33.anInt715;
					@Pc(653) boolean local653 = this.method168(this.aClass1_Sub1_Sub3_Sub2_1.anIntArray232[0], 0, true, local155, this.aClass1_Sub1_Sub3_Sub2_1.anIntArray233[0], 0, 0, local508, 0, 0, 0);
					Class33.anInt714 = -1;
					if (local653) {
						this.anInt153 = super.anInt138;
						this.anInt154 = super.anInt139;
				...
				if (super.anInt133 > 4500) {
					this.anInt182 = 250;
					super.anInt133 -= 500;
					this.aClass1_Sub3_Sub3_6.method380(70);
				}
				this.anInt183++;
				...
				if (anInt313 > 110) {
					anInt313 = 0;
					this.aClass1_Sub3_Sub3_6.method380(236);
					this.aClass1_Sub3_Sub3_6.method385(0);
				}
				this.anInt181++;
				if (this.anInt181 > 50) {
					this.aClass1_Sub3_Sub3_6.method380(108);
				}
				try {
					if (this.aClass6_1 != null && this.aClass1_Sub3_Sub3_6.anInt561 > 0) {
						this.aClass6_1.method205(this.aClass1_Sub3_Sub3_6.aByteArray7, this.aClass1_Sub3_Sub3_6.anInt561);
						this.aClass1_Sub3_Sub3_6.anInt561 = 0;
						this.anInt181 = 0;
					}
			...
			signlink.reporterror("43736, " + true + ", " + local1011.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method165() {
		try {
			if (this.anInt304 >= 2 || this.anInt281 != 0 || this.anInt291 != 0) {
				...
				this.aClass1_Sub3_Sub2_Sub4_3.method368(anInt266 / 1000, 15, 16777215, local31, 4);
			}
		} catch (@Pc(100) RuntimeException local100) {
			signlink.reporterror("32785, " + true + ", " + local100.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method166() {
		try {
			...
			for (@Pc(13) Class1_Sub1_Sub2 local13 = (Class1_Sub1_Sub2) this.aClass28_5.method456(); local13 != null; local13 = (Class1_Sub1_Sub2) this.aClass28_5.method458()) {
				if (local13.anInt61 != this.anInt231 || local13.aBoolean17) {
					...
					if (local13.aBoolean17) {
						...
						this.aClass33_1.method478(local13.anInt63, 60, 0, local13.anInt62, -1, false, null, local13, local13.anInt64, local13.anInt61);
					}
				}
			}
		} catch (@Pc(72) RuntimeException local72) {
			signlink.reporterror("59878, " + 106 + ", " + local72.toString());
			throw new RuntimeException();
		}
	}
	...
	private boolean method168(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9, @OriginalArg(11) int arg10) {
		try {
			@Pc(11) int local11;
			...
			while (local57 != local66) {
				...
				if (arg9 != 0) {
					if ((arg9 < 5 || arg9 == 10) && this.aClass9Array1[this.anInt231].method258(arg8, arg7, arg9 - 1, local39, arg3, local11)) {
						local70 = true;
						break;
					}
					if (arg9 < 10 && this.aClass9Array1[this.anInt231].method259(arg8, arg9 - 1, this.anInt294, local11, arg3, local39, arg7)) {
						local70 = true;
						break;
					}
				}
				if (arg1 != 0 && arg6 != 0 && this.aClass9Array1[this.anInt231].method260(local39, arg6, local11, arg3, arg10, arg7, arg1, 168)) {
					local70 = true;
					break;
				}
			...
			if (local57 > 0) {
				...
				if (arg5 == 0) {
					this.aClass1_Sub3_Sub3_6.method380(181);
					this.aClass1_Sub3_Sub3_6.method381(local74 + local74 + 3);
				}
				if (arg5 == 1) {
					this.aClass1_Sub3_Sub3_6.method380(165);
					this.aClass1_Sub3_Sub3_6.method381(local74 + local74 + 3 + 14);
				}
				if (arg5 == 2) {
					this.aClass1_Sub3_Sub3_6.method380(93);
					this.aClass1_Sub3_Sub3_6.method381(local74 + local74 + 3);
				}
			...
			signlink.reporterror("92875, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + arg4 + ", " + 0 + ", " + arg5 + ", " + arg6 + ", " + arg7 + ", " + arg8 + ", " + arg9 + ", " + arg10 + ", " + local1112.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "b", descriptor = "(Lclient!kb;II)V")
	private void method170(@OriginalArg(0) Class1_Sub3_Sub3 arg0, @OriginalArg(1) int arg1) {
		try {
			this.anInt255 = 0;
			this.anInt206 = 0;
			this.method195(arg1, arg0);
			this.method110(arg1, arg0);
			this.method118(arg1, arg0);
			this.method121(arg1, arg0);
			@Pc(36) int local36;
			for (@Pc(29) int local29 = 0; local29 < this.anInt255; local29++) {
				local36 = this.anIntArray60[local29];
				if (this.aClass1_Sub1_Sub3_Sub2Array1[local36].anInt932 != anInt266) {
			...
			signlink.reporterror("9307, " + arg0 + ", " + arg1 + ", " + 822 + ", " + local119.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "d", descriptor = "(III)Z")
	private boolean method171(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			@Pc(3) boolean local3 = false;
			...
			for (@Pc(9) int local9 = 0; local9 < local7.anIntArray153.length && local7.anIntArray153[local9] != -1; local9++) {
				...
				if (local24.anInt472 == 1) {
					local3 |= this.method171(local24.anInt470, arg1);
				}
				if (local24.anInt472 == 6 && (local24.anInt488 != -1 || local24.anInt489 != -1)) {
					@Pc(54) boolean local54 = this.method175(local24);
					@Pc(59) int local59;
					if (local54) {
			...
			signlink.reporterror("31675, " + arg0 + ", " + arg1 + ", " + 623 + ", " + local145.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(ILjava/lang/String;BLjava/lang/String;)V")
	private void method172(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(3) String arg2) {
		try {
			...
			signlink.reporterror("40788, " + arg0 + ", " + arg1 + ", " + 4 + ", " + arg2 + ", " + local83.toString());
			throw new RuntimeException();
		}
	}
		...
		try {
			...
			for (@Pc(5) int local5 = 0; local5 < local3.anIntArray153.length && local3.anIntArray153[local5] != -1; local5++) {
				...
				if (local20.anInt472 == 1) {
					this.method173(local20.anInt470);
				}
				local20.anInt468 = 0;
				local20.anInt469 = 0;
			}
		} catch (@Pc(48) RuntimeException local48) {
			signlink.reporterror("24441, " + -321 + ", " + arg0 + ", " + local48.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(IJ)V")
	private void method174(@OriginalArg(1) long arg0) {
		try {
			if (arg0 != 0L) {
				for (@Pc(18) int local18 = 0; local18 < this.anInt312; local18++) {
					if (this.aLongArray4[local18] == arg0) {
						...
						this.aClass1_Sub3_Sub3_6.method380(11);
						this.aClass1_Sub3_Sub3_6.method387(arg0);
						return;
					}
				}
	...
	private boolean method175(@OriginalArg(0) Class15 arg0) {
		try {
			...
			signlink.reporterror("59816, " + arg0 + ", " + 65 + ", " + local72.toString());
			throw new RuntimeException();
		}
	}
		...
		try {
			...
			if (super.anInt137 == 1) {
				...
				if (local17 >= 0 && local24 >= 0 && local17 < 146 && local24 < 151) {
					...
					@Pc(129) boolean local129 = this.method168(this.aClass1_Sub1_Sub3_Sub2_1.anIntArray232[0], 0, true, local98, this.aClass1_Sub1_Sub3_Sub2_1.anIntArray233[0], 1, 0, local106, 0, 0, 0);
					if (local129) {
			...
			signlink.reporterror("6474, " + 7 + ", " + local185.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method177() {
		try {
				...
				if (this.aBoolean50) {
					...
					if (local14 == 1 && this.anInt304 > 0) {
						...
						if (local45 == 602 || local45 == 596 || local45 == 22 || local45 == 892 || local45 == 415 || local45 == 405 || local45 == 38 || local45 == 422 || local45 == 478 || local45 == 347 || local45 == 188) {
							...
							@Pc(283) Class15 local283 = Class15.aClass15Array1[local124];
							if (local283.aBoolean108) {
								...
								if (Class15.aClass15Array1[local124].anInt471 == this.anInt271) {
									this.anInt216 = 1;
								}
								if (Class15.aClass15Array1[local124].anInt471 == this.anInt280) {
									this.anInt216 = 3;
								}
								return;
							}
					...
					if (local14 == 1 && (this.anInt196 == 1 || this.method131(this.anInt304 - 1)) && this.anInt304 > 2) {
						local14 = 2;
					}
					if (local14 == 1 && this.anInt304 > 0) {
						this.method132(this.anInt304 - 1);
			...
			signlink.reporterror("37713, " + 3 + ", " + local375.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method178(@OriginalArg(0) byte arg0) {
		try {
			...
			@Pc(26) int local26 = this.method94(this.anInt231, this.anInt146, this.anInt147) - this.anInt148;
			...
			local26 = this.method94(this.anInt231, this.anInt261, this.anInt262) - this.anInt263;
	...
	private void method179(@OriginalArg(0) int arg0) {
		try {
			...
			if (super.anInt137 == 1) {
				...
				if (anInt232 > 150) {
					anInt232 = 0;
					this.aClass1_Sub3_Sub3_6.method380(233);
	...
	private boolean method180(@OriginalArg(0) Class15 arg0) {
		try {
			...
			signlink.reporterror("87437, " + arg0 + ", " + 8 + ", " + local116.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "b", descriptor = "(ILclient!kb;I)V")
	private void method181(@OriginalArg(1) Class1_Sub3_Sub3 arg0, @OriginalArg(2) int arg1) {
		try {
			arg0.method401();
			...
			signlink.reporterror("55760, " + -542 + ", " + arg0 + ", " + arg1 + ", " + local261.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method182() {
		try {
			...
			signlink.reporterror("55264, " + false + ", " + local82.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(ILclient!ib;)V")
	private void method183(@OriginalArg(1) Class1_Sub3_Sub2_Sub3 arg0) {
		try {
			...
			signlink.reporterror("86499, " + 578 + ", " + arg0 + ", " + local182.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method184(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		for (local27 = (Class1_Sub7) local9.method456(); local27 != null; local27 = (Class1_Sub7) local9.method458()) {
			@Pc(32) Class5 local32 = Class5.method54(local27.anInt773);
			local35 = local32.anInt112;
			if (local32.aBoolean31) {
				local35 *= local27.anInt774 + 1;
			}
			if (local35 > local21) {
				local21 = local35;
				local23 = local27;
		...
		@Pc(71) int local71 = 0;
		for (local27 = (Class1_Sub7) local9.method456(); local27 != null; local27 = (Class1_Sub7) local9.method458()) {
			if (local27.anInt773 != local23.anInt773 && local65 == -1) {
				local65 = local27.anInt773;
				local69 = local27.anInt774;
			}
			if (local27.anInt773 != local23.anInt773 && local27.anInt773 != local65 && local35 == -1) {
				local35 = local27.anInt773;
				local71 = local27.anInt774;
			}
		}
		...
		@Pc(148) Class5 local148 = Class5.method54(local23.anInt773);
		this.aClass33_1.method474(local148.method58(local23.anInt774), local118, this.method94(this.anInt231, arg0 * 128 + 64, arg1 * 128 + 64), this.anInt231, local144, arg1, arg0, local128, 429);
	}
		...
		try {
			try {
				...
				for (@Pc(28) int local28 = 0; local28 < 4; local28++) {
					this.aClass9Array1[local28].method249();
				}
				System.gc();
				...
				if (Class4.aBoolean23) {
					this.aClass33_1.method468(this.anInt231);
				} else {
				...
				for (local73 = 0; local73 < local60; local73++) {
					...
					if (local148 != null) {
						...
						Class34.method519(local56, local157, local148, local148.length - 4, 4);
				...
				for (local80 = 0; local80 < local60; local80++) {
					...
					if (local216 != null) {
						...
						Class34.method519(local56, local225, local216, local216.length - 4, 4);
						local157 = (this.anIntArray56[local80] >> 8) * 64 - this.anInt169;
						@Pc(259) int local259 = (this.anIntArray56[local80] & 0xFF) * 64 - this.anInt170;
						local53.method38(local56, this.aClass33_1, this.aClass9Array1, this.aClass28_1, local259, local157);
					}
				}
				this.aClass1_Sub3_Sub3_6.method380(108);
				local53.method40(this.aClass33_1, this.aClass9Array1);
				this.aClass32_27.method463();
				this.aClass1_Sub3_Sub3_6.method380(108);
				for (@Pc(301) Class1_Sub6 local301 = (Class1_Sub6) this.aClass28_1.method456(); local301 != null; local301 = (Class1_Sub6) this.aClass28_1.method458()) {
				...
				for (@Pc(361) Class1_Sub4 local361 = (Class1_Sub4) this.aClass28_4.method456(); local361 != null; local361 = (Class1_Sub4) this.aClass28_4.method458()) {
					this.method160(local361.anInt598, local361.anInt595, local361.anInt596, local361.anInt594, local361.anInt597, local361.anInt599, local361.anInt593);
				}
			...
			signlink.reporterror("85866, " + 869 + ", " + local408.toString());
			throw new RuntimeException();
		}
	}
	...
	protected void method68() {
		try {
			...
			signlink.reporterror("41957, " + 437 + ", " + local28.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method186(@OriginalArg(0) byte arg0) {
		try {
			...
			for (@Pc(8) int local8 = -1; local8 < this.anInt205; local8++) {
				...
				if (local28 != null && local28.anInt901 > 0) {
					local28.anInt901--;
					if (local28.anInt901 == 0) {
						local28.aString29 = null;
					}
				}
			}
			for (local16 = 0; local16 < this.anInt248; local16++) {
				...
				if (local64 != null && local64.anInt901 > 0) {
					local64.anInt901--;
					if (local64.anInt901 == 0) {
						local64.aString29 = null;
					}
				}
			}
	...
	private int method187(@OriginalArg(0) Class15 arg0, @OriginalArg(2) int arg1) {
		try {
			...
			try {
				...
				while (true) {
					...
					@Pc(97) int local97;
					if (local35 == 4) {
						local88 = Class15.aClass15Array1[local26[local30++]];
					...
					if (local35 == 8) {
						local28 += this.aClass1_Sub1_Sub3_Sub2_1.anInt940;
					}
					@Pc(179) int local179;
					if (local35 == 9) {
			...
			signlink.reporterror("5084, " + arg0 + ", " + false + ", " + arg1 + ", " + local285.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method188() {
		try {
			...
			signlink.reporterror("19392, " + false + ", " + local178.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method189() {
		try {
			@Pc(8) byte[] local8 = this.aClass39_1.method536("title.dat", null);
			...
			signlink.reporterror("21255, " + 5 + ", " + local283.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method190(@OriginalArg(0) int arg0) {
		try {
			...
			for (@Pc(10) Class1_Sub6 local10 = (Class1_Sub6) this.aClass28_1.method456(); local10 != null; local10 = (Class1_Sub6) this.aClass28_1.method458()) {
				...
				if (local14) {
					...
					if (local10.anInt652 == 1) {
						local104 = this.aClass33_1.method495(local96, local102, local99);
					}
					...
					if (local104 != 0 && (local104 >> 14 & 0x7FFF) == local10.anInt655) {
						...
						@Pc(210) Class2 local210 = Class2.method23(local10.anInt655);
						...
						if (local10.anInt652 == 2) {
							...
							this.aClass33_1.method483(local99, local258, local96, local102);
							...
							if (local239 == 2) {
								...
								local258 = local210.method26(local239, local243, local171, local182, local195, local206, local212);
								this.aClass33_1.method487(local258, local102, local99, local96);
							}
							...
							this.aClass33_1.method486(local400, local102, local99, local96);
						}
					} else {
						local10.method567();
					}
	...
	private void method191(@OriginalArg(1) long arg0) {
		try {
			if (arg0 != 0L) {
				for (@Pc(14) int local14 = 0; local14 < this.anInt186; local14++) {
					if (this.aLongArray3[local14] == arg0) {
						...
						this.aClass1_Sub3_Sub3_6.method380(171);
						this.aClass1_Sub3_Sub3_6.method387(arg0);
						return;
					}
				}
			...
			signlink.reporterror("36301, " + 1 + ", " + arg0 + ", " + local69.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method192() {
		try {
			...
			@Pc(41) int local41 = -1;
			for (@Pc(52) int local52 = 0; local52 < Class1_Sub3_Sub1.anInt378; local52++) {
				@Pc(58) int local58 = Class1_Sub3_Sub1.anIntArray123[local52];
				...
				if (local58 != local41) {
					...
					if (local74 == 2 && this.aClass33_1.method498(this.anInt231, local62, local68, local58) >= 0) {
						@Pc(100) Class2 local100 = Class2.method23(local80);
						if (this.anInt281 == 1) {
					...
					if (local74 == 1) {
						...
						if (local366.aClass3_1.aByte4 == 1 && (local366.anInt890 & 0x7F) == 64 && (local366.anInt891 & 0x7F) == 64) {
							for (local218 = 0; local218 < this.anInt248; local218++) {
								local395 = this.aClass1_Sub1_Sub3_Sub1Array1[this.anIntArray58[local218]];
								if (local395 != null && local395 != local366 && local395.aClass3_1.aByte4 == 1 && local395.anInt890 == local366.anInt890 && local395.anInt891 == local366.anInt891) {
									this.method95(local395.aClass3_1, local68, local62, this.anIntArray58[local218]);
								}
							}
						}
						this.method95(local366.aClass3_1, local68, local62, local80);
					}
					if (local74 == 0) {
						@Pc(446) Class1_Sub1_Sub3_Sub2 local446 = this.aClass1_Sub1_Sub3_Sub2Array1[local80];
						if ((local446.anInt890 & 0x7F) == 64 && (local446.anInt891 & 0x7F) == 64) {
							for (local218 = 0; local218 < this.anInt248; local218++) {
								local395 = this.aClass1_Sub1_Sub3_Sub1Array1[this.anIntArray58[local218]];
								if (local395 != null && local395.aClass3_1.aByte4 == 1 && local395.anInt890 == local446.anInt890 && local395.anInt891 == local446.anInt891) {
									this.method95(local395.aClass3_1, local68, local62, this.anIntArray58[local218]);
								}
							}
							for (@Pc(505) int local505 = 0; local505 < this.anInt205; local505++) {
								...
								if (local515 != null && local515 != local446 && local515.anInt890 == local446.anInt890 && local515.anInt891 == local446.anInt891) {
									this.method163(local68, this.anIntArray39[local505], local515, local62);
								}
							}
						}
						this.method163(local68, local80, local446, local62);
					}
					if (local74 == 3) {
						@Pc(565) Class28 local565 = this.aClass28ArrayArrayArray1[this.anInt231][local62][local68];
						if (local565 != null) {
							for (@Pc(572) Class1_Sub7 local572 = (Class1_Sub7) local565.method457(); local572 != null; local572 = (Class1_Sub7) local565.method459()) {
								@Pc(578) Class5 local578 = Class5.method54(local572.anInt773);
								if (this.anInt281 == 1) {
									this.aStringArray5[this.anInt304] = "Use " + this.aString10 + " with @lre@" + local578.aString3;
									this.anIntArray86[this.anInt304] = 217;
									this.anIntArray87[this.anInt304] = local572.anInt773;
									this.anIntArray84[this.anInt304] = local62;
									this.anIntArray85[this.anInt304] = local68;
									this.anInt304++;
								} else if (this.anInt291 != 1) {
			...
			signlink.reporterror("47222, " + 2 + ", " + local902.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method193() {
		try {
			...
			for (@Pc(9) int local9 = -1; local9 < this.anInt205; local9++) {
				...
				if (local29 != null) {
					this.method124(local29, 1);
				}
			}
			anInt242++;
			if (anInt242 > 1406) {
				anInt242 = 0;
				this.aClass1_Sub3_Sub3_6.method380(219);
				this.aClass1_Sub3_Sub3_6.method381(0);
				...
				this.aClass1_Sub3_Sub3_6.method390(this.aClass1_Sub3_Sub3_6.anInt561 - local17);
			}
		} catch (@Pc(129) RuntimeException local129) {
			signlink.reporterror("87242, " + true + ", " + local129.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method194() {
		try {
			...
			signlink.reporterror("792, " + -11 + ", " + local68.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "b", descriptor = "(IILclient!kb;)V")
	private void method195(@OriginalArg(1) int arg0, @OriginalArg(2) Class1_Sub3_Sub3 arg1) {
		try {
			arg1.method401();
			...
			signlink.reporterror("31876, " + 11522 + ", " + arg0 + ", " + arg1 + ", " + local175.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method196() {
		try {
			...
			this.aClass1_Sub3_Sub2_Sub3_11.method350(0, 0);
			if (this.aBoolean47) {
				...
				this.method120(0, 0, Class15.aClass15Array1[this.anInt280], 0);
			} else if (this.anInt289 == -1) {
				@Pc(135) Class1_Sub3_Sub2_Sub4 local135 = this.aClass1_Sub3_Sub2_Sub4_2;
				@Pc(137) int local137 = 0;
				Class1_Sub3_Sub2.method356(77, 0, 463, 0);
				for (@Pc(145) int local145 = 0; local145 < 100; local145++) {
					if (this.aStringArray7[local145] != null) {
						...
						if (local157 == 2 && (this.anInt273 == 0 || this.anInt273 == 1 && this.method199(this.aStringArray6[local145]))) {
							if (local166 > 0 && local166 < 110) {
						...
						if ((local157 == 3 || local157 == 7) && this.anInt210 == 0 && (local157 == 7 || this.anInt164 == 0 || this.anInt164 == 1 && this.method199(this.aStringArray6[local145]))) {
							if (local166 > 0 && local166 < 110) {
						...
						if (local157 == 4 && (this.anInt234 == 0 || this.anInt234 == 1 && this.method199(this.aStringArray6[local145]))) {
							if (local166 > 0 && local166 < 110) {
						...
						if (local157 == 8 && (this.anInt234 == 0 || this.anInt234 == 1 && this.method199(this.aStringArray6[local145]))) {
							if (local166 > 0 && local166 < 110) {
				...
				local135.method365(4, 90, 0, Class40.method542(this.aString13) + ":");
				local135.method365(local135.method364(this.aString13 + ": ") + 6, 90, 255, this.aString18 + "*");
				Class1_Sub3_Sub2.method360(0, 77, 479, 0);
			} else {
				this.method120(0, 0, Class15.aClass15Array1[this.anInt289], 0);
			}
			if (this.aBoolean50 && this.anInt337 == 2) {
				this.method135();
			}
			this.aClass32_28.method464(375, super.aGraphics2, 22);
			this.aClass32_27.method463();
			Class1_Sub3_Sub2_Sub1.anIntArray139 = this.anIntArray32;
		} catch (@Pc(652) RuntimeException local652) {
			signlink.reporterror("15378, " + false + ", " + local652.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!client", name = "p", descriptor = "(Z)Z")
	private boolean method197() {
		try {
			if (this.aClass6_1 == null) {
				return false;
			}
			...
			try {
				...
				if (this.anInt179 == 152) {
					...
					@Pc(217) String local217 = Class40.method542(Class40.method539(local207));
					for (local219 = 0; local219 < this.anInt312; local219++) {
						if (local207 == this.aLongArray4[local219]) {
							if (this.anIntArray34[local219] != local211) {
								...
								this.aBoolean59 = true;
								if (local211 > 0) {
									this.method172(5, local217 + " has logged in.", "");
								}
								if (local211 == 0) {
									this.method172(5, local217 + " has logged out.", "");
								}
							}
							local217 = null;
							break;
				...
				if (this.anInt179 == 1) {
					this.method108(this.aClass1_Sub3_Sub3_5, this.anInt178);
					this.anInt179 = -1;
					return true;
				}
				@Pc(650) int local650;
				if (this.anInt179 == 237) {
					...
					this.aClass1_Sub3_Sub3_6.method380(150);
					this.aClass1_Sub3_Sub3_6.method381(0);
					local466 = 0;
					@Pc(662) int local662;
					...
					this.aClass1_Sub3_Sub3_6.method390(local466);
					...
					for (local354 = 0; local354 < 8192; local354++) {
						...
						if (local856 != null) {
							...
							local856.anInt890 -= local650 * 128;
							local856.anInt891 -= local321 * 128;
						}
					}
					for (local662 = 0; local662 < this.anInt203; local662++) {
						...
						if (local911 != null) {
							...
							local911.anInt890 -= local650 * 128;
							local911.anInt891 -= local321 * 128;
						}
					}
					...
					for (@Pc(1066) Class1_Sub4 local1066 = (Class1_Sub4) this.aClass28_4.method456(); local1066 != null; local1066 = (Class1_Sub4) this.aClass28_4.method458()) {
				...
				if (this.anInt179 == 197) {
					local159 = this.aClass1_Sub3_Sub3_5.method393();
					Class15.aClass15Array1[local159].aClass1_Sub3_Sub1_2 = this.aClass1_Sub1_Sub3_Sub2_1.method574();
					this.anInt179 = -1;
					return true;
				}
				if (this.anInt179 == 25) {
				...
				if (this.anInt179 == 54) {
					...
					if (!local1264.equals(this.aString17) && this.aBoolean42 && !aBoolean53) {
						this.method75(local462, local1264, local211);
					}
				...
				if (this.anInt179 == 151 || this.anInt179 == 23 || this.anInt179 == 50 || this.anInt179 == 191 || this.anInt179 == 69 || this.anInt179 == 49 || this.anInt179 == 223 || this.anInt179 == 42 || this.anInt179 == 76 || this.anInt179 == 59) {
					this.method83(this.aClass1_Sub3_Sub3_5, this.anInt179);
					this.anInt179 = -1;
					return true;
				}
				if (this.anInt179 == 28) {
				...
				if (this.anInt179 == 146) {
					local159 = this.aClass1_Sub3_Sub3_5.method393();
					local462 = this.aClass1_Sub3_Sub3_5.method393();
					Class15.aClass15Array1[local159].anInt488 = local462;
					this.anInt179 = -1;
					return true;
				}
				...
				if (this.anInt179 == 220) {
					...
					if (local219 != -1) {
						...
						this.aClass1_Sub3_Sub3_5.method400(this.anInt178 - 6, local211, this.aByteArrayArray2[local219]);
					}
					this.anInt179 = -1;
					return true;
				}
				if (this.anInt179 == 133) {
					@Pc(1701) Class1_Sub3_Sub3 local1701 = Class8.method211();
					if (local1701 != null) {
						this.aClass1_Sub3_Sub3_6.method380(81);
						this.aClass1_Sub3_Sub3_6.method382(local1701.anInt561);
						this.aClass1_Sub3_Sub3_6.method389(local1701.aByteArray7, local1701.anInt561);
						local1701.method379();
					}
					this.anInt179 = -1;
					return true;
				...
				if (this.anInt179 == 98) {
					this.aBoolean59 = true;
					local159 = this.aClass1_Sub3_Sub3_5.method393();
					local1745 = Class15.aClass15Array1[local159];
					local211 = this.aClass1_Sub3_Sub3_5.method391();
				...
				if (this.anInt179 == 140) {
					...
					if (this.anInt299 != 0 && this.anInt271 == -1) {
						signlink.dnslookup(Class40.method541(this.anInt299));
						this.method77();
						...
						this.aString9 = "";
						this.aBoolean51 = false;
						for (local462 = 0; local462 < Class15.aClass15Array1.length; local462++) {
							if (Class15.aClass15Array1[local462] != null && Class15.aClass15Array1[local462].anInt474 == local1915) {
								this.anInt271 = Class15.aClass15Array1[local462].anInt471;
								break;
							}
						}
					}
				...
				if (this.anInt179 == 212) {
					if (this.aBoolean42 && !aBoolean53) {
						...
						Class34.method519(local2018, local462, this.aClass1_Sub3_Sub3_5.aByteArray7, local211, this.aClass1_Sub3_Sub3_5.anInt561);
						this.method113(local2018, local462, false);
				...
				if (this.anInt179 == 12) {
					...
					if (this.aBoolean73 && !aBoolean53 && this.anInt286 < 50) {
						...
						this.anIntArray45[this.anInt286] = local211 + Class43.anIntArray231[local159];
						this.anInt286++;
					}
					this.anInt179 = -1;
					return true;
				...
				if (this.anInt179 == 204) {
					local159 = this.aClass1_Sub3_Sub3_5.method393();
					local462 = this.aClass1_Sub3_Sub3_5.method393();
					@Pc(2130) Class3 local2130 = Class3.method32(local462);
					Class15.aClass15Array1[local159].aClass1_Sub3_Sub1_2 = local2130.method35();
					this.anInt179 = -1;
					return true;
				}
				if (this.anInt179 == 7) {
				...
				if (this.anInt179 == 103) {
					...
					local462 = this.aClass1_Sub3_Sub3_5.method393();
					local211 = this.aClass1_Sub3_Sub3_5.method393();
					local2181 = Class15.aClass15Array1[local159];
				...
				if (this.anInt179 == 3) {
					...
					if (this.anInt150 >= 100) {
						...
						this.anInt323 = this.method94(this.anInt231, this.anInt146, this.anInt147) - this.anInt148;
					}
					this.anInt179 = -1;
					return true;
				}
				if (this.anInt179 == 135) {
					...
					for (@Pc(2487) Class1_Sub4 local2487 = (Class1_Sub4) this.aClass28_4.method456(); local2487 != null; local2487 = (Class1_Sub4) this.aClass28_4.method458()) {
						if (local2487.anInt595 >= this.anInt222 && local2487.anInt595 < this.anInt222 + 8 && local2487.anInt596 >= this.anInt223 && local2487.anInt596 < this.anInt223 + 8 && local2487.anInt593 == this.anInt231) {
							this.method160(local2487.anInt601, local2487.anInt595, local2487.anInt596, local2487.anInt594, local2487.anInt600, local2487.anInt602, local2487.anInt593);
							local2487.method567();
						}
					}
					this.anInt179 = -1;
				...
				if (this.anInt179 == 132) {
					...
					if (local219 != -1) {
						...
						this.aClass1_Sub3_Sub3_5.method400(this.anInt178 - 6, local211, this.aByteArrayArray1[local219]);
					}
					this.anInt179 = -1;
					return true;
				}
				...
				if (this.anInt179 == 41) {
					...
					if (!local2652 && this.anInt191 == 0) {
						try {
							...
							@Pc(2721) String local2721 = Class41.method545(this.aClass1_Sub3_Sub3_5, 118, this.anInt178 - 13);
							@Pc(2725) String local2725 = Class25.method424(local2721);
							if (local466 > 1) {
								this.method172(7, local2725, Class40.method542(Class40.method539(local207)));
							} else {
								this.method172(3, local2725, Class40.method542(Class40.method539(local207)));
							}
				...
				if (this.anInt179 == 87) {
					local159 = this.aClass1_Sub3_Sub3_5.method393();
					local462 = this.aClass1_Sub3_Sub3_5.method393();
					Class15.aClass15Array1[local159].aClass1_Sub3_Sub1_2 = new Class1_Sub3_Sub1(false, local462);
					this.anInt179 = -1;
					return true;
				}
				...
				if (this.anInt179 == 74) {
					...
					if (this.anInt265 >= 100) {
						...
						local211 = this.method94(this.anInt231, this.anInt261, this.anInt262) - this.anInt263;
				...
				if (this.anInt179 == 4) {
					...
					if (local1264.endsWith(":tradereq:")) {
						...
						local3043 = Class40.method538(local3040);
						local2652 = false;
						...
						if (!local2652 && this.anInt191 == 0) {
							this.method172(4, "wishes to trade with you.", local3040);
						}
						...
						if (!local2652 && this.anInt191 == 0) {
							this.method172(8, "wishes to duel with you.", local3040);
						}
					} else {
						this.method172(0, local1264, "");
					}
					this.anInt179 = -1;
					return true;
				}
				if (this.anInt179 == 46) {
					...
					local462 = this.aClass1_Sub3_Sub3_5.method393();
					local211 = this.aClass1_Sub3_Sub3_5.method393();
					@Pc(3157) Class5 local3157 = Class5.method54(local462);
					Class15.aClass15Array1[local159].aClass1_Sub3_Sub1_2 = local3157.method58(50);
					Class15.aClass15Array1[local159].anInt491 = local3157.anInt106;
					Class15.aClass15Array1[local159].anInt492 = local3157.anInt107;
					Class15.aClass15Array1[local159].anInt490 = local3157.anInt105 * 100 / local211;
					this.anInt179 = -1;
					return true;
				}
				...
				if (this.anInt179 == 2) {
					...
					Class15.aClass15Array1[local159].anInt485 = (local211 << 19) + (local466 << 11) + (local219 << 3);
					this.anInt179 = -1;
					return true;
				}
				if (this.anInt179 == 136) {
					for (local159 = 0; local159 < this.aClass1_Sub1_Sub3_Sub2Array1.length; local159++) {
						if (this.aClass1_Sub1_Sub3_Sub2Array1[local159] != null) {
							this.aClass1_Sub1_Sub3_Sub2Array1[local159].anInt915 = -1;
						}
					}
					for (local462 = 0; local462 < this.aClass1_Sub1_Sub3_Sub1Array1.length; local462++) {
						if (this.aClass1_Sub1_Sub3_Sub1Array1[local462] != null) {
							this.aClass1_Sub1_Sub3_Sub1Array1[local462].anInt915 = -1;
						}
					}
					this.anInt179 = -1;
					return true;
				...
				if (this.anInt179 == 26) {
					...
					Class15.aClass15Array1[local159].aBoolean106 = local3362;
					this.anInt179 = -1;
					return true;
				}
				if (this.anInt179 == 21) {
				...
				if (this.anInt179 == 201) {
					...
					Class15.aClass15Array1[local159].aString20 = local3040;
					if (Class15.aClass15Array1[local159].anInt471 == this.anIntArray46[this.anInt166]) {
						this.aBoolean59 = true;
					}
					this.anInt179 = -1;
					return true;
				...
				if (this.anInt179 == 162) {
					...
					while (this.aClass1_Sub3_Sub3_5.anInt561 < this.anInt178) {
						local159 = this.aClass1_Sub3_Sub3_5.method391();
						this.method83(this.aClass1_Sub3_Sub3_5, local159);
					}
					this.anInt179 = -1;
					return true;
				}
				...
				if (this.anInt179 == 184) {
					this.method170(this.aClass1_Sub3_Sub3_5, this.anInt178);
					if (this.anInt307 == 1) {
						this.anInt307 = 2;
			...
			signlink.reporterror("50315, " + false + ", " + local3950.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method198(@OriginalArg(0) byte arg0) {
		try {
			...
			this.aClass1_Sub3_Sub2_Sub3_9.method350(0, 0);
			if (this.anInt330 != -1) {
				this.method120(0, 0, Class15.aClass15Array1[this.anInt330], 0);
			} else if (this.anIntArray46[this.anInt166] != -1) {
				this.method120(0, 0, Class15.aClass15Array1[this.anIntArray46[this.anInt166]], 0);
			}
			if (this.aBoolean50 && this.anInt337 == 1) {
				this.method135();
			}
			this.aClass32_25.method464(231, super.aGraphics2, 562);
	...
	private boolean method199(@OriginalArg(1) String arg0) {
		try {
			if (arg0 == null) {
				return false;
			}
			...
			signlink.reporterror("64810, " + -20 + ", " + arg0 + ", " + local42.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method200(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Class1_Sub3_Sub3 arg2, @OriginalArg(4) Class1_Sub1_Sub3_Sub2 arg3) {
		try {
			@Pc(19) int local19;
			if ((arg1 & 0x1) == 1) {
			...
			if ((arg1 & 0x2) == 2) {
				...
				if (local19 == arg3.anInt915) {
					arg3.anInt919 = 0;
				}
				local66 = arg2.method391();
				if (local19 == -1 || arg3.anInt915 == -1 || Class19.aClass19Array1[local19].anInt545 > Class19.aClass19Array1[arg3.anInt915].anInt545 || Class19.aClass19Array1[arg3.anInt915].anInt545 == 0) {
					arg3.anInt915 = local19;
					arg3.anInt916 = 0;
					arg3.anInt917 = 0;
					arg3.anInt918 = local66;
					arg3.anInt919 = 0;
				}
			}
			if ((arg1 & 0x4) == 4) {
				arg3.anInt909 = arg2.method393();
				if (arg3.anInt909 == 65535) {
					arg3.anInt909 = -1;
				}
			}
			if ((arg1 & 0x8) == 8) {
				arg3.aString29 = arg2.method398();
				arg3.anInt902 = 0;
				arg3.anInt903 = 0;
				arg3.anInt901 = 150;
				this.method172(2, arg3.aString29, arg3.aString30);
			}
			if ((arg1 & 0x10) == 16) {
				arg3.anInt904 = arg2.method391();
				arg3.anInt905 = arg2.method391();
				arg3.anInt906 = anInt266 + 400;
				arg3.anInt907 = arg2.method391();
				arg3.anInt908 = arg2.method391();
			}
			if ((arg1 & 0x20) == 32) {
				arg3.anInt910 = arg2.method393();
				arg3.anInt911 = arg2.method393();
			}
			if ((arg1 & 0x40) == 64) {
				local19 = arg2.method393();
				local66 = arg2.method391();
				...
				if (arg3.aString30 != null) {
					@Pc(209) long local209 = Class40.method538(arg3.aString30);
					...
					if (!local211 && this.anInt191 == 0) {
						try {
							@Pc(244) String local244 = Class41.method545(arg2, 118, local199);
							@Pc(248) String local248 = Class25.method424(local244);
							arg3.aString29 = local248;
							arg3.anInt902 = local19 >> 8;
							arg3.anInt903 = local19 & 0xFF;
							arg3.anInt901 = 150;
							if (local66 > 1) {
								this.method172(1, local248, arg3.aString30);
							} else {
								this.method172(2, local248, arg3.aString30);
							}
			...
			if ((arg1 & 0x100) == 256) {
				arg3.anInt920 = arg2.method393();
				local19 = arg2.method396();
				arg3.anInt924 = local19 >> 16;
				arg3.anInt923 = anInt266 + (local19 & 0xFFFF);
				arg3.anInt921 = 0;
				arg3.anInt922 = 0;
				if (arg3.anInt923 > anInt266) {
					arg3.anInt921 = -1;
				}
				if (arg3.anInt920 == 65535) {
					arg3.anInt920 = -1;
				}
			}
			if ((arg1 & 0x200) == 512) {
				arg3.anInt925 = arg2.method391();
				arg3.anInt927 = arg2.method391();
				arg3.anInt926 = arg2.method391();
				arg3.anInt928 = arg2.method391();
				arg3.anInt929 = arg2.method393() + anInt266;
				arg3.anInt930 = arg2.method393() + anInt266;
				arg3.anInt931 = arg2.method391();
				arg3.anInt935 = 0;
				arg3.anIntArray232[0] = arg3.anInt926;
				arg3.anIntArray233[0] = arg3.anInt928;
			}
		} catch (@Pc(391) RuntimeException local391) {
			signlink.reporterror("94218, " + true + ", " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + local391.toString());
			throw new RuntimeException();
		}
	}
	...
	protected void method74(@OriginalArg(1) String arg0, @OriginalArg(2) int arg1) {
		try {
			...
			if (this.aClass39_1 == null) {
				...
				this.aBoolean62 &= true;
				Class1_Sub3_Sub2.method359(28, 9179409, 34, 62, 304);
				Class1_Sub3_Sub2.method359(29, 0, 32, 63, 302);
				Class1_Sub3_Sub2.method358(64, 30, 9179409, arg1 * 3, 30);
				Class1_Sub3_Sub2.method358(64, arg1 * 3 + 30, 0, 300 - arg1 * 3, 30);
			...
			signlink.reporterror("68527, " + true + ", " + arg0 + ", " + arg1 + ", " + local210.toString());
			throw new RuntimeException();
		}
	}
}
