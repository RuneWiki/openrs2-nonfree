...
public final class Class37_Sub2_Sub2 extends Class37_Sub2 {
	...
	@OriginalMember(owner = "client!paa", name = "<init>", descriptor = "(Lclient!ql;[B[III)V")
	public Class37_Sub2_Sub2(@OriginalArg(0) Class15_Sub1 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		super(arg0, arg3, arg4);
		this.aByteArray84 = arg1;
		this.anIntArray481 = arg2;
	}
		...
		if (Static246.anInt8050 == 0) {
			if (Static246.anInt8035 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local27 >= 0 && local25 - (super.anInt8031 << 12) < 0 && local27 - (super.anInt8021 << 12) < 0) {
							...
							while (local29 < 0) {
								local111 = this.aByteArray84[(local27 >> 12) * super.anInt8031 + (local25 >> 12)];
								if (local111 == 0) {
									local23++;
								} else {
									local3[local23++] = this.anIntArray481[local111 & 0xFF];
								}
								local29++;
							}
						}
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt8031 << 12) < 0) {
							@Pc(179) int local179;
							if ((local179 = local27 - (super.anInt8021 << 12)) >= 0) {
								local186 = (Static246.anInt8035 - local179) / Static246.anInt8035;
								local29 += local186;
								local27 += Static246.anInt8035 * local186;
								local23 += local186;
							}
							@Pc(207) int local207;
							if ((local207 = (local27 - Static246.anInt8035) / Static246.anInt8035) > local29) {
								local29 = local207;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt8031 << 12) < 0) {
							if (local27 < 0) {
								local186 = (Static246.anInt8035 - local27 - 1) / Static246.anInt8035;
								local29 += local186;
								local27 += Static246.anInt8035 * local186;
								local23 += local186;
							}
							@Pc(379) int local379;
							if ((local379 = (local27 + 1 - (super.anInt8021 << 12) - Static246.anInt8035) / Static246.anInt8035) > local29) {
								local29 = local379;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
			...
			if (Static246.anInt8035 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local27 >= 0 && local27 - (super.anInt8021 << 12) < 0) {
							@Pc(525) int local525;
							if ((local525 = local25 - (super.anInt8031 << 12)) >= 0) {
								local186 = (Static246.anInt8050 - local525) / Static246.anInt8050;
								local29 += local186;
								local25 += Static246.anInt8050 * local186;
								local23 += local186;
							}
							@Pc(553) int local553;
							if ((local553 = (local25 - Static246.anInt8050) / Static246.anInt8050) > local29) {
								local29 = local553;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static246.anInt8025;
						@Pc(690) int local690;
						if ((local690 = local25 - (super.anInt8031 << 12)) >= 0) {
							local186 = (Static246.anInt8050 - local690) / Static246.anInt8050;
							local29 += local186;
							local25 += Static246.anInt8050 * local186;
							local27 += Static246.anInt8035 * local186;
							local23 += local186;
						...
						@Pc(724) int local724;
						if ((local724 = (local25 - Static246.anInt8050) / Static246.anInt8050) > local29) {
							local29 = local724;
						}
						@Pc(736) int local736;
						if ((local736 = local27 - (super.anInt8021 << 12)) >= 0) {
							local186 = (Static246.anInt8035 - local736) / Static246.anInt8035;
							local29 += local186;
							local25 += Static246.anInt8050 * local186;
							local27 += Static246.anInt8035 * local186;
							local23 += local186;
						...
						@Pc(770) int local770;
						if ((local770 = (local27 - Static246.anInt8035) / Static246.anInt8035) > local29) {
							local29 = local770;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static246.anInt8025;
						@Pc(913) int local913;
						if ((local913 = local25 - (super.anInt8031 << 12)) >= 0) {
							local186 = (Static246.anInt8050 - local913) / Static246.anInt8050;
							local29 += local186;
							local25 += Static246.anInt8050 * local186;
							local27 += Static246.anInt8035 * local186;
							local23 += local186;
						...
						@Pc(947) int local947;
						if ((local947 = (local25 - Static246.anInt8050) / Static246.anInt8050) > local29) {
							local29 = local947;
						}
						if (local27 < 0) {
							local186 = (Static246.anInt8035 - local27 - 1) / Static246.anInt8035;
						...
						@Pc(995) int local995;
						if ((local995 = (local27 + 1 - (super.anInt8021 << 12) - Static246.anInt8035) / Static246.anInt8035) > local29) {
							local29 = local995;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if (local27 >= 0 && local27 - (super.anInt8021 << 12) < 0) {
						if (local25 < 0) {
							local186 = (Static246.anInt8050 - local25 - 1) / Static246.anInt8050;
							local29 += local186;
							local25 += Static246.anInt8050 * local186;
							local23 += local186;
						}
						@Pc(1177) int local1177;
						if ((local1177 = (local25 + 1 - (super.anInt8031 << 12) - Static246.anInt8050) / Static246.anInt8050) > local29) {
							local29 = local1177;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1354 = (local25 + 1 - (super.anInt8031 << 12) - Static246.anInt8050) / Static246.anInt8050) > local29) {
						local29 = local1354;
					}
					@Pc(1366) int local1366;
					if ((local1366 = local27 - (super.anInt8021 << 12)) >= 0) {
						local186 = (Static246.anInt8035 - local1366) / Static246.anInt8035;
						local29 += local186;
						local25 += Static246.anInt8050 * local186;
						local27 += Static246.anInt8035 * local186;
						local23 += local186;
					...
					if ((local1400 = (local27 - Static246.anInt8035) / Static246.anInt8035) > local29) {
						local29 = local1400;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1579 = (local25 + 1 - (super.anInt8031 << 12) - Static246.anInt8050) / Static246.anInt8050) > local29) {
						local29 = local1579;
					}
					if (local27 < 0) {
						local186 = (Static246.anInt8035 - local27 - 1) / Static246.anInt8035;
					...
					if ((local1627 = (local27 + 1 - (super.anInt8021 << 12) - Static246.anInt8035) / Static246.anInt8035) > local29) {
						local29 = local1627;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
	...
	@OriginalMember(owner = "client!paa", name = "a", descriptor = "(IILclient!fa;II)V")
	@Override
	public void method7077(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class93 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		for (@Pc(212) int local212 = local171; local212 < local210; local212++) {
			...
			for (@Pc(304) int local304 = -local227; local304 < 0; local304++) {
				@Pc(311) byte local311 = this.aByteArray84[local19++];
				if (local311 == 0) {
					local41++;
				} else {
					local169[local41++] = this.anIntArray481[local311 & 0xFF];
				}
			}
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local16 >= 0 && local14 - (super.anInt8031 << 12) < 0 && local16 - (super.anInt8021 << 12) < 0) {
						while (local18 < 0) {
							...
							local51 = local12++;
							if (arg0 == 1) {
								local227 = this.aByteArray84[local48];
								if (local227 != 0) {
									local3[local51] = this.anIntArray481[local227 & 0xFF];
								}
							} else if (arg0 == 0) {
								local227 = this.aByteArray84[local48];
								if (local227 != 0) {
									local255 = this.anIntArray481[local227 & 0xFF];
									if ((Static246.anInt8046 & 0xFFFFFF) == 16777215) {
										local264 = Static246.anInt8046 >>> 24;
										...
										local264 = (local255 & 0xFF0000) * Static246.anInt8040 & 0xFF000000;
										local268 = (local255 & 0xFF00) * Static246.anInt8034 & 0xFF0000;
										local272 = (local255 & 0xFF) * Static246.anInt8047 & 0xFF00;
										...
										local3[local51] = ((local255 & 0xFF00FF) * Static246.anInt8041 + (local344 & 0xFF00FF) * Static246.anInt8043 & 0xFF00FF00) + ((local255 & 0xFF00) * Static246.anInt8041 + (local344 & 0xFF00) * Static246.anInt8043 & 0xFF0000) >> 8;
									}
								}
							} else if (arg0 == 3) {
								local227 = this.aByteArray84[local48];
								local255 = local227 > 0 ? this.anIntArray481[local227] : 0;
								local264 = Static246.anInt8046;
								...
								if (local255 == 0 && Static246.anInt8041 != 255) {
									local255 = local344;
									local344 = local3[local51];
									local344 = ((local255 & 0xFF00FF) * Static246.anInt8041 + (local344 & 0xFF00FF) * Static246.anInt8043 & 0xFF00FF00) + ((local255 & 0xFF00) * Static246.anInt8041 + (local344 & 0xFF00) * Static246.anInt8043 & 0xFF0000) >> 8;
								}
								...
								if (local227 != 0) {
									local255 = this.anIntArray481[local227 & 0xFF];
									local264 = (local255 & 0xFF00FF) * Static246.anInt8041 & 0xFF00FF00;
									local268 = (local255 & 0xFF00) * Static246.anInt8041 & 0xFF0000;
									local3[local51++] = ((local264 | local268) >>> 8) + Static246.anInt8048;
								}
							} else {
			...
			if (arg6 != 0) {
				...
				if (arg6 == 1) {
					if (arg4 == 1) {
						...
						for (local262 = -arg3; local262 < 0; local262++) {
							...
							for (local273 = -arg2; local273 < 0; local273++) {
								local446 = this.aByteArray84[(local14 >> 16) + local270];
								if (local446 == 0) {
									local64++;
								} else {
									local252[local64++] = this.anIntArray481[local446 & 0xFF];
								}
								local14 += local44;
							}
							local16 += local50;
						...
						if (arg4 == 0) {
							...
							if ((arg5 & 0xFFFFFF) == 16777215) {
								...
								for (local273 = -arg3; local273 < 0; local273++) {
									local335 = (local16 >> 16) * super.anInt8031;
									for (local343 = -arg2; local343 < 0; local343++) {
										local735 = this.aByteArray84[(local14 >> 16) + local335];
										if (local735 == 0) {
											local64++;
										} else {
											local361 = this.anIntArray481[local735 & 0xFF];
								...
								for (local346 = -arg3; local346 < 0; local346++) {
									local361 = (local16 >> 16) * super.anInt8031;
									for (local369 = -arg2; local369 < 0; local369++) {
										@Pc(852) byte local852 = this.aByteArray84[(local14 >> 16) + local361];
										if (local852 == 0) {
											local64++;
										} else {
											local385 = this.anIntArray481[local852 & 0xFF];
											if (local335 == 255) {
							...
							for (local273 = -arg3; local273 < 0; local273++) {
								...
								for (local343 = -arg2; local343 < 0; local343++) {
									local735 = this.aByteArray84[(local14 >> 16) + local335];
									local361 = local735 > 0 ? this.anIntArray481[local735] : 0;
							...
							for (local343 = -arg3; local343 < 0; local343++) {
								local346 = (local16 >> 16) * super.anInt8031;
								for (local361 = -arg2; local361 < 0; local361++) {
									local1196 = this.aByteArray84[(local14 >> 16) + local346];
									if (local1196 == 0) {
										local64++;
									} else {
										local377 = this.anIntArray481[local1196 & 0xFF];
					...
					for (local262 = -arg3; local262 < 0; local262++) {
						...
						for (local273 = -arg2; local273 < 0; local273++) {
							...
							if (local446 == 0) {
								...
								local343 = this.anIntArray481[local446 & 0xFF];
					...
					for (local335 = -arg3; local335 < 0; local335++) {
						local343 = (local16 >> 16) * super.anInt8031;
						for (local346 = -arg2; local346 < 0; local346++) {
							@Pc(1406) byte local1406 = this.aByteArray84[(local14 >> 16) + local343];
							if (local1406 == 0) {
								local64++;
							} else {
								local369 = this.anIntArray481[local1406 & 0xFF];
					...
					for (local262 = -arg3; local262 < 0; local262++) {
						...
						for (local273 = -arg2; local273 < 0; local273++) {
							local446 = this.aByteArray84[(local14 >> 16) + local270];
							local343 = local446 > 0 ? this.anIntArray481[local446] : 0;
				...
				for (local262 = -arg3; local262 < 0; local262++) {
					local270 = (local16 >> 16) * super.anInt8031;
					for (local273 = -arg2; local273 < 0; local273++) {
						local252[local64++] = this.anIntArray481[this.aByteArray84[(local14 >> 16) + local270] & 0xFF];
						local14 += local44;
					}
					local16 += local50;
					local14 = local259;
				...
				for (local335 = -arg3; local335 < 0; local335++) {
					local343 = (local16 >> 16) * super.anInt8031;
					for (local346 = -arg2; local346 < 0; local346++) {
						local361 = this.anIntArray481[this.aByteArray84[(local14 >> 16) + local343] & 0xFF];
				...
				for (local343 = -arg3; local343 < 0; local343++) {
					local346 = (local16 >> 16) * super.anInt8031;
					for (local361 = -arg2; local361 < 0; local361++) {
						local369 = this.anIntArray481[this.aByteArray84[(local14 >> 16) + local346] & 0xFF];
		...
		if (arg2 == 1) {
			for (local532 = -local32; local532 < 0; local532++) {
				...
				while (local27 < local539) {
					local546 = this.aByteArray84[local29++];
					if (local546 == 0) {
						local27++;
					} else {
						local160[local27++] = this.anIntArray481[local546 & 0xFF];
					}
					local546 = this.aByteArray84[local29++];
					if (local546 == 0) {
						local27++;
		...
		if (arg2 != 0) {
			...
			if (arg2 == 3) {
				...
				for (local678 = -local32; local678 < 0; local678++) {
					for (local682 = -local35; local682 < 0; local682++) {
						local689 = this.aByteArray84[local29++];
						local698 = local689 > 0 ? this.anIntArray481[local689] : 0;
				...
				for (local776 = -local32; local776 < 0; local776++) {
					for (local698 = -local35; local698 < 0; local698++) {
						@Pc(1098) byte local1098 = this.aByteArray84[local29++];
						if (local1098 == 0) {
							local27++;
						} else {
							local970 = this.anIntArray481[local1098 & 0xFF];
			...
			for (local678 = -local32; local678 < 0; local678++) {
				for (local682 = -local35; local682 < 0; local682++) {
					...
					if (local689 == 0) {
						...
						local698 = this.anIntArray481[local689 & 0xFF];
			...
			for (local698 = -local32; local698 < 0; local698++) {
				for (local702 = -local35; local702 < 0; local702++) {
					@Pc(790) byte local790 = this.aByteArray84[local29++];
					if (local790 == 0) {
						local27++;
					} else {
						local799 = this.anIntArray481[local790 & 0xFF];
						@Pc(810) int local810;
						@Pc(818) int local818;
						@Pc(826) int local826;
						if (local682 == 255) {
