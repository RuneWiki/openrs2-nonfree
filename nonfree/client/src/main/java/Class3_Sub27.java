...
public final class Class3_Sub27 extends Class3 {
	...
	@OriginalMember(owner = "client!hb", name = "a", descriptor = "([I)Lclient!wha;")
	public Class3_Sub34_Sub1 method3362(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray38 == null) {
			this.anInt3729 = 0;
			this.aFloatArray23 = new float[Static230.anInt3726];
			this.aByteArray38 = new byte[this.anInt3724];
			this.anInt3732 = 0;
			this.anInt3734 = 0;
		}
		while (this.anInt3734 < this.aByteArrayArray6.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method3373(this.anInt3734);
			if (local42 != null) {
				...
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray38[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
		...
		@Pc(129) byte[] local129 = this.aByteArray38;
		this.aByteArray38 = null;
		return new Class3_Sub34_Sub1(this.anInt3731, local129, this.anInt3730, this.anInt3728, this.aBoolean227);
	}

	@OriginalMember(owner = "client!hb", name = "a", descriptor = "([B)V")
	private void method3364(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class3_Sub2 local4 = new Class3_Sub2(arg0);
		this.anInt3731 = local4.method2036();
		this.anInt3724 = local4.method2036();
		this.anInt3730 = local4.method2036();
		this.anInt3728 = local4.method2036();
		if (this.anInt3728 < 0) {
			this.anInt3728 = ~this.anInt3728;
			this.aBoolean227 = true;
		}
		@Pc(40) int local40 = local4.method2036();
		this.aByteArrayArray6 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method2048(255);
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method2064(local49, 0, local64);
			this.aByteArrayArray6[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!hb", name = "b", descriptor = "(I)[F")
	private float[] method3373(@OriginalArg(0) int arg0) {
		Static230.method3372(this.aByteArrayArray6[arg0]);
		Static230.method3368();
		@Pc(15) int local15 = Static230.method3367(Static462.method6277(Static230.anIntArray272.length - 1));
		@Pc(19) boolean local19 = Static230.aBooleanArray6[local15];
		@Pc(25) int local25 = local19 ? Static230.anInt3726 : Static230.anInt3727;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static230.method3368() != 0;
			local29 = Static230.method3368() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static230.anInt3727 >> 2);
			local67 = (local25 >> 2) + (Static230.anInt3727 >> 2);
			local71 = Static230.anInt3727 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static230.anInt3727 >> 2);
			local104 = local25 + (Static230.anInt3727 >> 2) - (local25 >> 2);
			local108 = Static230.anInt3727 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class185 local123 = Static230.aClass185Array1[Static230.anIntArray272[local15]];
		@Pc(126) int local126 = local123.anInt4441;
		@Pc(131) int local131 = local123.anIntArray338[local126];
		@Pc(140) boolean local140 = !Static230.aClass129Array1[local131].method3007();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt4442; local144++) {
			@Pc(152) Class373 local152 = Static230.aClass373Array1[local123.anIntArray339[local144]];
			local154 = Static230.aFloatArray26;
			local152.method8556(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt4441;
			local176 = local123.anIntArray338[local171];
			Static230.aClass129Array1[local176].method3010(Static230.aFloatArray26, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static230.aFloatArray26[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static230.aFloatArray26;
			...
			@Pc(252) float[] local252 = local19 ? Static230.aFloatArray24 : Static230.aFloatArray28;
			@Pc(258) float[] local258 = local19 ? Static230.aFloatArray27 : Static230.aFloatArray22;
			@Pc(264) float[] local264 = local19 ? Static230.aFloatArray21 : Static230.aFloatArray25;
			@Pc(270) int[] local270 = local19 ? Static230.anIntArray273 : Static230.anIntArray271;
			...
			@Pc(486) int local486 = Static462.method6277(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static230.aFloatArray26[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static230.aFloatArray26[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt3729 > 0) {
			local176 = this.anInt3729 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean228) {
				for (local212 = 0; local212 < this.anInt3725; local212++) {
					local1254 = (this.anInt3729 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static230.aFloatArray26[local212];
				}
			}
		}
		local154 = this.aFloatArray23;
		this.aFloatArray23 = Static230.aFloatArray26;
		Static230.aFloatArray26 = local154;
		this.anInt3729 = local25;
		this.anInt3725 = local104 - (local25 >> 1);
		this.aBoolean228 = local140;
		return local1228;
	}
}
