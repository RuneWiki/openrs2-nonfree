...
public final class Class4_Sub26 extends Class4 {
	...
	@OriginalMember(owner = "client!su", name = "<init>", descriptor = "(Lclient!w;)V")
	public Class4_Sub26(@OriginalArg(0) Class2_Sub54 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!su", name = "<init>", descriptor = "(ILclient!w;)V")
	public Class4_Sub26(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub54 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!su", name = "b", descriptor = "(I)I")
	public int method8523() {
	...
	protected int method9221() {
		return super.aClass2_Sub54_31.method9551() ? 1 : 0;
	}
