...
public final class Static366 {
	...
	@OriginalMember(owner = "client!od", name = "a", descriptor = "([B[IIIIIIILclient!od;)I")
	public static int method3887(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub31_Sub1 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt4497 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!od", name = "a", descriptor = "(Lclient!ig;II)Lclient!od;")
	public static Class1_Sub31_Sub1 method3889(@OriginalArg(0) Class1_Sub20_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray23 == null || arg0.aByteArray23.length == 0 ? null : new Class1_Sub31_Sub1(arg0, (int) ((long) arg0.anInt2542 * 256L * (long) 100 / (long) (Static348.anInt6162 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!od", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!od;)I")
	public static int method3891(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub31_Sub1 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt4494 += arg10.anInt4491 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt4489 = arg4 >> 2;
		arg10.anInt4495 = arg5 >> 2;
		arg10.anInt4497 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!od", name = "b", descriptor = "([B[IIIIIIILclient!od;)I")
	public static int method3893(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub31_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	public static int method3895(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!od", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!od;)I")
	public static int method3897(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub31_Sub1 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt4494 += arg10.anInt4491 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!od", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!od;II)I")
	public static int method3900(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub31_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt4494 -= arg10.anInt4491 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt4494 += arg10.anInt4491 * local63;
		arg10.anInt4489 = arg4;
		arg10.anInt4495 = arg5;
		arg10.anInt4497 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!od", name = "a", descriptor = "([B[IIIIIIIILclient!od;)I")
	public static int method3901(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub31_Sub1 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt4489 += arg8.anInt4488 * (local22 - arg3);
		arg8.anInt4495 += arg8.anInt4487 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt4494 = arg4 >> 2;
		arg8.anInt4497 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!od", name = "a", descriptor = "(II[B[IIIIIIIILclient!od;II)I")
	public static int method3903(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub31_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!od", name = "a", descriptor = "(II[B[IIIIIIILclient!od;II)I")
	public static int method3904(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub31_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!od", name = "a", descriptor = "(I[B[IIIIIIIILclient!od;)I")
	public static int method3909(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub31_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!od", name = "b", descriptor = "(II[B[IIIIIIIILclient!od;II)I")
	public static int method3912(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub31_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt4489 -= arg8.anInt4488 * arg3;
		arg8.anInt4495 -= arg8.anInt4487 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!od", name = "b", descriptor = "(II[B[IIIIIIILclient!od;II)I")
	public static int method3914(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub31_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!od", name = "b", descriptor = "([B[IIIIIIIILclient!od;)I")
	public static int method3915(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub31_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt4489 += arg8.anInt4488 * (local24 - arg3);
		arg8.anInt4495 += arg8.anInt4487 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!od", name = "c", descriptor = "(II[B[IIIIIIIILclient!od;II)I")
	public static int method3916(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub31_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!od", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!od;II)I")
	public static int method3918(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub31_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt4494 -= arg10.anInt4491 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!od", name = "a", descriptor = "(Lclient!ig;III)Lclient!od;")
	public static Class1_Sub31_Sub1 method3921(@OriginalArg(0) Class1_Sub20_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray23 == null || arg0.aByteArray23.length == 0 ? null : new Class1_Sub31_Sub1(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!od", name = "d", descriptor = "(II[B[IIIIIIIILclient!od;II)I")
	public static int method3922(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub31_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt4489 -= arg8.anInt4488 * arg3;
		arg8.anInt4495 -= arg8.anInt4487 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!od", name = "b", descriptor = "(I[B[IIIIIIIILclient!od;)I")
	public static int method3923(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub31_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	public static int method3924(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
