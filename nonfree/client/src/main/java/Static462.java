...
public final class Static462 {
	...
	@OriginalMember(owner = "client!bs", name = "a", descriptor = "(II[B[IIIIIIIILclient!bs;II)I")
	public static int method585(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class10_Sub7_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt669 -= arg8.anInt675 * arg3;
		arg8.anInt678 -= arg8.anInt677 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!bs", name = "a", descriptor = "([B[IIIIIIILclient!bs;)I")
	public static int method587(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class10_Sub7_Sub1 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt681 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!bs", name = "a", descriptor = "(II[B[IIIIIIILclient!bs;II)I")
	public static int method590(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class10_Sub7_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lclient!wq;III)Lclient!bs;")
	public static Class10_Sub7_Sub1 method591(@OriginalArg(0) Class10_Sub25_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray94 == null || arg0.aByteArray94.length == 0 ? null : new Class10_Sub7_Sub1(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!bs", name = "b", descriptor = "(II[B[IIIIIIIILclient!bs;II)I")
	public static int method593(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class10_Sub7_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt669 -= arg8.anInt675 * arg3;
		arg8.anInt678 -= arg8.anInt677 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!bs", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!bs;II)I")
	public static int method595(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class10_Sub7_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt682 -= arg10.anInt680 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt682 += arg10.anInt680 * local63;
		arg10.anInt669 = arg4;
		arg10.anInt678 = arg5;
		arg10.anInt681 = arg2;
		return local63;
	...
	@OriginalMember(owner = "client!bs", name = "b", descriptor = "([B[IIIIIIILclient!bs;)I")
	public static int method596(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class10_Sub7_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!bs", name = "a", descriptor = "(I[B[IIIIIIIILclient!bs;)I")
	public static int method599(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class10_Sub7_Sub1 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt681 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!bs", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!bs;II)I")
	public static int method601(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class10_Sub7_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt682 -= arg10.anInt680 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!bs", name = "b", descriptor = "(II[B[IIIIIIILclient!bs;II)I")
	public static int method602(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class10_Sub7_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!bs", name = "c", descriptor = "(II[B[IIIIIIIILclient!bs;II)I")
	public static int method603(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class10_Sub7_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lclient!wq;II)Lclient!bs;")
	public static Class10_Sub7_Sub1 method604(@OriginalArg(0) Class10_Sub25_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray94 == null || arg0.aByteArray94.length == 0 ? null : new Class10_Sub7_Sub1(arg0, (int) ((long) arg0.anInt7555 * 256L * (long) 100 / (long) (Static438.anInt7333 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!bs", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!bs;)I")
	public static int method606(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class10_Sub7_Sub1 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt682 += arg10.anInt680 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt669 = arg4 >> 2;
		arg10.anInt678 = arg5 >> 2;
		arg10.anInt681 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!bs", name = "d", descriptor = "(II[B[IIIIIIIILclient!bs;II)I")
	public static int method610(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class10_Sub7_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!bs", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!bs;)I")
	public static int method611(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class10_Sub7_Sub1 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt682 += arg10.anInt680 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!bs", name = "a", descriptor = "([B[IIIIIIIILclient!bs;)I")
	public static int method613(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class10_Sub7_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt669 += arg8.anInt675 * (local24 - arg3);
		arg8.anInt678 += arg8.anInt677 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt682 = arg4 >> 2;
		arg8.anInt681 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!bs", name = "b", descriptor = "([B[IIIIIIIILclient!bs;)I")
	public static int method617(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class10_Sub7_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt669 += arg8.anInt675 * (local22 - arg3);
		arg8.anInt678 += arg8.anInt677 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!bs", name = "b", descriptor = "(I[B[IIIIIIIILclient!bs;)I")
	public static int method619(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class10_Sub7_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	public static int method621(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!bs", name = "e", descriptor = "(II)I")
	public static int method622(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
