...
public final class Class79 implements Interface4 {
	...
	public Class79() {
		if (this.anInt2528 < 0 && (Static156.aBoolean197 && Static156.anInt3090 >= 2)) {
			@Pc(19) int[] local19 = new int[1];
			@Pc(21) GL local21 = Static156.aGL1;
			local21.glGenProgramsARB(1, local19, 0);
			this.anInt2527 = local19[0];
			@Pc(42) int[][] local42 = Static224.method3474(0.4F);
			@Pc(53) int[][] local53 = Static224.method3474(0.4F);
			...
			for (@Pc(60) int local60 = 0; local60 < 256; local60++) {
				...
				for (@Pc(73) int local73 = 0; local73 < 64; local73++) {
					if (Static156.aBoolean212) {
						local58.method1388((float) local67[local73] / 4096.0F);
						local58.method1388((float) local71[local73] / 4096.0F);
						local58.method1388(1.0F);
						local58.method1388(1.0F);
					} else {
						local58.method1395((float) local67[local73] / 4096.0F);
						local58.method1395((float) local71[local73] / 4096.0F);
						local58.method1395(1.0F);
						local58.method1395(1.0F);
					}
				}
			}
			@Pc(141) ByteBuffer local141 = ByteBuffer.allocateDirect(local58.anInt1480).order(ByteOrder.nativeOrder());
			local141.put(local58.aByteArray17, 0, local58.anInt1480);
			local141.flip();
	...
	public void method4405() {
		if (this.anInt2528 >= 0) {
			...
			local5.glCallList(this.anInt2528 + 1);
		}
	}
	...
	public void method4403() {
		...
		@Pc(5) GL local5 = Static156.aGL1;
		local5.glCallList(this.anInt2528);
		local5.glActiveTexture(33985);
		local5.glMatrixMode(5890);
		local5.glTranslatef((float) Static127.anInt2581, (float) Static315.anInt5220, (float) Static187.anInt3564);
		...
		if (!Static9.aBoolean5) {
			local5.glBindTexture(3553, Static9.anIntArray8[(int) ((float) (Static156.anInt3082 * 64) * 0.005F) % 64]);
		}
		local5.glActiveTexture(33984);
		if (this.anInt2526 == Static156.anInt3082) {
			return;
		}
		@Pc(85) int local85 = (Static156.anInt3082 & 0xFF) * 256;
		...
		if (Static9.aBoolean5) {
			local5.glProgramLocalParameter4fARB(34336, 65, (float) Static156.anInt3082 * 0.005F, 0.0F, 0.0F, 1.0F);
		} else {
			local5.glProgramLocalParameter4fARB(34336, 65, 0.0F, 0.0F, 0.0F, 1.0F);
		}
		this.anInt2526 = Static156.anInt3082;
	}

	@OriginalMember(owner = "client!im", name = "e", descriptor = "()V")
	private void method2167() {
		@Pc(1) GL local1 = Static156.aGL1;
		this.anInt2528 = local1.glGenLists(2);
		local1.glNewList(this.anInt2528, 4864);
		...
		local1.glBindProgramARB(34336, this.anInt2527);
		local1.glEnable(34336);
		local1.glEndList();
		local1.glNewList(this.anInt2528 + 1, 4864);
		local1.glActiveTexture(33985);
		...
		local1.glDisable(Static9.aBoolean5 ? 32879 : 3553);
		local1.glActiveTexture(33984);
	...
	public void method4406(@OriginalArg(0) int arg0) {
		...
		local5.glActiveTexture(33985);
		if ((arg0 & 0x80) == 0) {
			local5.glEnable(Static9.aBoolean5 ? 32879 : 3553);
		} else {
			local5.glDisable(Static9.aBoolean5 ? 32879 : 3553);
		}
		local5.glActiveTexture(33984);
		if ((arg0 & 0x40) == 0) {
			local5.glGetFloatv(2899, Static122.aFloatArray9, 0);
			local5.glProgramLocalParameter4fvARB(34336, 66, Static122.aFloatArray9, 0);
		} else {
	...
	@OriginalMember(owner = "client!im", name = "f", descriptor = "()V")
	private void method2168() {
		...
		local4.glBindProgramARB(34336, this.anInt2527);
