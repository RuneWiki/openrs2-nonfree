...
public final class Static135 {
	...
	@OriginalMember(owner = "client!oc", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!oc;)I")
	public static int method1540(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class4_Sub1_Sub4 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt2150 += arg10.anInt2151 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt2143 = arg4 >> 2;
		arg10.anInt2141 = arg5 >> 2;
		arg10.anInt2142 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!oc", name = "a", descriptor = "(II[B[IIIIIIILclient!oc;II)I")
	public static int method1541(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class4_Sub1_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!oc", name = "a", descriptor = "([B[IIIIIIIILclient!oc;)I")
	public static int method1544(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class4_Sub1_Sub4 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt2143 += arg8.anInt2149 * (local22 - arg3);
		arg8.anInt2141 += arg8.anInt2145 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt2150 = arg4 >> 2;
		arg8.anInt2142 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!oc", name = "a", descriptor = "([B[IIIIIIILclient!oc;)I")
	public static int method1545(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class4_Sub1_Sub4 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt2142 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!oc", name = "a", descriptor = "(Lclient!ke;III)Lclient!oc;")
	public static Class4_Sub1_Sub4 method1546(@OriginalArg(0) Class4_Sub6_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray13 == null || arg0.aByteArray13.length == 0 ? null : new Class4_Sub1_Sub4(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!oc", name = "a", descriptor = "(I[B[IIIIIIIILclient!oc;)I")
	public static int method1547(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class4_Sub1_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!oc", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!oc;II)I")
	public static int method1548(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class4_Sub1_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt2150 -= arg10.anInt2151 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt2150 += arg10.anInt2151 * local63;
		arg10.anInt2143 = arg4;
		arg10.anInt2141 = arg5;
		arg10.anInt2142 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!oc", name = "a", descriptor = "(II[B[IIIIIIIILclient!oc;II)I")
	public static int method1552(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub1_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt2143 -= arg8.anInt2149 * arg3;
		arg8.anInt2141 -= arg8.anInt2145 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!oc", name = "a", descriptor = "(Lclient!ke;II)Lclient!oc;")
	public static Class4_Sub1_Sub4 method1556(@OriginalArg(0) Class4_Sub6_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray13 == null || arg0.aByteArray13.length == 0 ? null : new Class4_Sub1_Sub4(arg0, (int) ((long) arg0.anInt1657 * 256L * (long) 100 / (long) (Static123.anInt3048 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!oc", name = "b", descriptor = "([B[IIIIIIIILclient!oc;)I")
	public static int method1557(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class4_Sub1_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt2143 += arg8.anInt2149 * (local24 - arg3);
		arg8.anInt2141 += arg8.anInt2145 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!oc", name = "b", descriptor = "(II[B[IIIIIIIILclient!oc;II)I")
	public static int method1559(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub1_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt2143 -= arg8.anInt2149 * arg3;
		arg8.anInt2141 -= arg8.anInt2145 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!oc", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!oc;)I")
	public static int method1561(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class4_Sub1_Sub4 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt2150 += arg10.anInt2151 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!oc", name = "c", descriptor = "(II[B[IIIIIIIILclient!oc;II)I")
	public static int method1565(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub1_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!oc", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!oc;II)I")
	public static int method1567(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class4_Sub1_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt2150 -= arg10.anInt2151 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!oc", name = "b", descriptor = "(I[B[IIIIIIIILclient!oc;)I")
	public static int method1568(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class4_Sub1_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!oc", name = "b", descriptor = "(II[B[IIIIIIILclient!oc;II)I")
	public static int method1570(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class4_Sub1_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!oc", name = "b", descriptor = "([B[IIIIIIILclient!oc;)I")
	public static int method1571(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class4_Sub1_Sub4 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	public static int method1572(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!oc", name = "f", descriptor = "(II)I")
	public static int method1573(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!oc", name = "d", descriptor = "(II[B[IIIIIIIILclient!oc;II)I")
	public static int method1574(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub1_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
