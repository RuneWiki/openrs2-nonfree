...
public final class Static135 {
	...
	@OriginalMember(owner = "client!ha", name = "a", descriptor = "(II[B[IIIIIIIILclient!ha;II)I")
	public static int method799(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class5_Sub5_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ha", name = "a", descriptor = "([B[IIIIIIIILclient!ha;)I")
	public static int method800(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class5_Sub5_Sub2 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt1168 += arg8.anInt1174 * (local22 - arg3);
		arg8.anInt1179 += arg8.anInt1178 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt1177 = arg4 >> 2;
		arg8.anInt1173 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ha", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!ha;)I")
	public static int method801(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class5_Sub5_Sub2 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt1177 += arg10.anInt1171 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt1168 = arg4 >> 2;
		arg10.anInt1179 = arg5 >> 2;
		arg10.anInt1173 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!ha", name = "b", descriptor = "(II[B[IIIIIIIILclient!ha;II)I")
	public static int method803(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class5_Sub5_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1168 -= arg8.anInt1174 * arg3;
		arg8.anInt1179 -= arg8.anInt1178 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ha", name = "a", descriptor = "([B[IIIIIIILclient!ha;)I")
	public static int method804(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class5_Sub5_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt1173 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ha", name = "c", descriptor = "(II[B[IIIIIIIILclient!ha;II)I")
	public static int method806(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class5_Sub5_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	public static int method809(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ha", name = "b", descriptor = "([B[IIIIIIILclient!ha;)I")
	public static int method811(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class5_Sub5_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	public static int method814(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ha", name = "a", descriptor = "(II[B[IIIIIIILclient!ha;II)I")
	public static int method816(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class5_Sub5_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ha", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!ha;II)I")
	public static int method819(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class5_Sub5_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1177 -= arg10.anInt1171 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt1177 += arg10.anInt1171 * local63;
		arg10.anInt1168 = arg4;
		arg10.anInt1179 = arg5;
		arg10.anInt1173 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!ha", name = "b", descriptor = "(II[B[IIIIIIILclient!ha;II)I")
	public static int method822(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class5_Sub5_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ha", name = "a", descriptor = "(I[B[IIIIIIIILclient!ha;)I")
	public static int method825(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class5_Sub5_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!ha", name = "b", descriptor = "(I[B[IIIIIIIILclient!ha;)I")
	public static int method826(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class5_Sub5_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!ha", name = "d", descriptor = "(II[B[IIIIIIIILclient!ha;II)I")
	public static int method827(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class5_Sub5_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1168 -= arg8.anInt1174 * arg3;
		arg8.anInt1179 -= arg8.anInt1178 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ha", name = "b", descriptor = "([B[IIIIIIIILclient!ha;)I")
	public static int method830(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class5_Sub5_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1168 += arg8.anInt1174 * (local24 - arg3);
		arg8.anInt1179 += arg8.anInt1178 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lclient!qf;II)Lclient!ha;")
	public static Class5_Sub5_Sub2 method832(@OriginalArg(0) Class5_Sub21_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray37 == null || arg0.aByteArray37.length == 0 ? null : new Class5_Sub5_Sub2(arg0, (int) ((long) arg0.anInt2647 * 256L * (long) 100 / (long) (Static78.anInt1981 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!ha", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!ha;II)I")
	public static int method834(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class5_Sub5_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1177 -= arg10.anInt1171 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lclient!qf;III)Lclient!ha;")
	public static Class5_Sub5_Sub2 method836(@OriginalArg(0) Class5_Sub21_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray37 == null || arg0.aByteArray37.length == 0 ? null : new Class5_Sub5_Sub2(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!ha", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!ha;)I")
	public static int method837(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class5_Sub5_Sub2 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt1177 += arg10.anInt1171 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
