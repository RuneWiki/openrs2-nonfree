...
public final class Static135 {
	...
	@OriginalMember(owner = "client!oe", name = "a", descriptor = "([B[IIIIIIIILclient!oe;)I")
	public static int method1473(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub3_Sub3 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt2012 += arg8.anInt2002 * (local24 - arg3);
		arg8.anInt2014 += arg8.anInt2003 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt2009 = arg4 >> 2;
		arg8.anInt2008 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!oe", name = "a", descriptor = "(I[B[IIIIIIIILclient!oe;)I")
	public static int method1475(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub3_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
	...
	@OriginalMember(owner = "client!oe", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!oe;II)I")
	public static int method1476(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub3_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt2009 -= arg10.anInt2006 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt2009 += arg10.anInt2006 * local63;
		arg10.anInt2012 = arg4;
		arg10.anInt2014 = arg5;
		arg10.anInt2008 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!oe", name = "a", descriptor = "(II[B[IIIIIIIILclient!oe;II)I")
	public static int method1477(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub3_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lclient!pa;III)Lclient!oe;")
	public static Class1_Sub3_Sub3 method1482(@OriginalArg(0) Class1_Sub14_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray21 == null || arg0.aByteArray21.length == 0 ? null : new Class1_Sub3_Sub3(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!oe", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!oe;II)I")
	public static int method1484(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub3_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt2009 -= arg10.anInt2006 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!oe", name = "b", descriptor = "([B[IIIIIIIILclient!oe;)I")
	public static int method1489(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub3_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt2012 += arg8.anInt2002 * (local22 - arg3);
		arg8.anInt2014 += arg8.anInt2003 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!oe", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!oe;)I")
	public static int method1490(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub3_Sub3 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt2009 += arg10.anInt2006 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt2012 = arg4 >> 2;
		arg10.anInt2014 = arg5 >> 2;
		arg10.anInt2008 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!oe", name = "b", descriptor = "(II[B[IIIIIIIILclient!oe;II)I")
	public static int method1492(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub3_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt2012 -= arg8.anInt2002 * arg3;
		arg8.anInt2014 -= arg8.anInt2003 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!oe", name = "c", descriptor = "(II[B[IIIIIIIILclient!oe;II)I")
	public static int method1493(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub3_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!oe", name = "a", descriptor = "(II[B[IIIIIIILclient!oe;II)I")
	public static int method1495(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub3_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!oe", name = "d", descriptor = "(II[B[IIIIIIIILclient!oe;II)I")
	public static int method1497(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub3_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt2012 -= arg8.anInt2002 * arg3;
		arg8.anInt2014 -= arg8.anInt2003 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!oe", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!oe;)I")
	public static int method1499(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub3_Sub3 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt2009 += arg10.anInt2006 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!oe", name = "d", descriptor = "(II)I")
	public static int method1501(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!oe", name = "a", descriptor = "([B[IIIIIIILclient!oe;)I")
	public static int method1502(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub3_Sub3 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt2008 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lclient!pa;II)Lclient!oe;")
	public static Class1_Sub3_Sub3 method1504(@OriginalArg(0) Class1_Sub14_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray21 == null || arg0.aByteArray21.length == 0 ? null : new Class1_Sub3_Sub3(arg0, (int) ((long) arg0.anInt2051 * 256L * (long) 100 / (long) (Static81.anInt1802 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!oe", name = "b", descriptor = "([B[IIIIIIILclient!oe;)I")
	public static int method1505(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub3_Sub3 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!oe", name = "b", descriptor = "(I[B[IIIIIIIILclient!oe;)I")
	public static int method1508(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub3_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!oe", name = "b", descriptor = "(II[B[IIIIIIILclient!oe;II)I")
	public static int method1509(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub3_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
