...
public final class Static358 {
	...
	@OriginalMember(owner = "client!ad", name = "a", descriptor = "(I[B[IIIIIIIILclient!ad;)I")
	public static int method78(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class4_Sub1_Sub1 arg8) {
		arg2 >>= 0x8;
	...
	@OriginalMember(owner = "client!ad", name = "a", descriptor = "(II[B[IIIIIIIILclient!ad;II)I")
	public static int method80(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub1_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ad", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!ad;II)I")
	public static int method81(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class4_Sub1_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt81 -= arg10.anInt82 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt81 += arg10.anInt82 * local63;
		arg10.anInt80 = arg4;
		arg10.anInt86 = arg5;
		arg10.anInt87 = arg2;
		return local63;
	...
	@OriginalMember(owner = "client!ad", name = "a", descriptor = "([B[IIIIIIILclient!ad;)I")
	public static int method82(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class4_Sub1_Sub1 arg7) {
		arg2 >>= 0x8;
	...
	@OriginalMember(owner = "client!ad", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!ad;II)I")
	public static int method83(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class4_Sub1_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt81 -= arg10.anInt82 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!ad", name = "b", descriptor = "([B[IIIIIIILclient!ad;)I")
	public static int method84(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class4_Sub1_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!ad", name = "a", descriptor = "([B[IIIIIIIILclient!ad;)I")
	public static int method85(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class4_Sub1_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt80 += arg8.anInt92 * (local22 - arg3);
		arg8.anInt86 += arg8.anInt88 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	public static int method86(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ad", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!ad;)I")
	public static int method87(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class4_Sub1_Sub1 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt81 += arg10.anInt82 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt80 = arg4 >> 2;
		arg10.anInt86 = arg5 >> 2;
		arg10.anInt87 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!ad", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!ad;)I")
	public static int method93(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class4_Sub1_Sub1 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt81 += arg10.anInt82 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lclient!bg;III)Lclient!ad;")
	public static Class4_Sub1_Sub1 method96(@OriginalArg(0) Class4_Sub7_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray5 == null || arg0.aByteArray5.length == 0 ? null : new Class4_Sub1_Sub1(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!ad", name = "a", descriptor = "(II[B[IIIIIIILclient!ad;II)I")
	public static int method97(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class4_Sub1_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ad", name = "b", descriptor = "(II[B[IIIIIIIILclient!ad;II)I")
	public static int method100(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub1_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt80 -= arg8.anInt92 * arg3;
		arg8.anInt86 -= arg8.anInt88 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ad", name = "c", descriptor = "(II[B[IIIIIIIILclient!ad;II)I")
	public static int method102(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub1_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt80 -= arg8.anInt92 * arg3;
		arg8.anInt86 -= arg8.anInt88 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ad", name = "b", descriptor = "([B[IIIIIIIILclient!ad;)I")
	public static int method104(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class4_Sub1_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt80 += arg8.anInt92 * (local24 - arg3);
		arg8.anInt86 += arg8.anInt88 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!ad", name = "b", descriptor = "(II[B[IIIIIIILclient!ad;II)I")
	public static int method109(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class4_Sub1_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lclient!bg;II)Lclient!ad;")
	public static Class4_Sub1_Sub1 method110(@OriginalArg(0) Class4_Sub7_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray5 == null || arg0.aByteArray5.length == 0 ? null : new Class4_Sub1_Sub1(arg0, (int) ((long) arg0.anInt482 * 256L * (long) 100 / (long) (Static251.anInt5134 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!ad", name = "b", descriptor = "(I[B[IIIIIIIILclient!ad;)I")
	public static int method111(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class4_Sub1_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!ad", name = "d", descriptor = "(II[B[IIIIIIIILclient!ad;II)I")
	public static int method112(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub1_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	public static int method115(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
