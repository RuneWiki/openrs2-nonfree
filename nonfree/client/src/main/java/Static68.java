...
public final class Static68 {
	...
	public static Js5Provider aClass20_Sub1_14;

	@OriginalMember(owner = "client!lf", name = "m", descriptor = "Lclient!ec;")
	public static JagString aClass22_143 = Static60.method1113("Geben Sie Ihren Benutzernamen");

	@OriginalMember(owner = "client!lf", name = "B", descriptor = "Lclient!ec;")
	public static JagString aClass22_144 = Static60.method1113("title)3jpg");

	@OriginalMember(owner = "client!lf", name = "D", descriptor = "I")
	public static int anInt492 = 0;

	@OriginalMember(owner = "client!lf", name = "J", descriptor = "Lclient!ja;")
	public static LruCache aClass33_8 = new LruCache(64);

	@OriginalMember(owner = "client!lf", name = "O", descriptor = "Lclient!ec;")
	private static JagString aClass22_146 = Static60.method1113("Please subscribe)1 or use a different world)3");

	@OriginalMember(owner = "client!lf", name = "L", descriptor = "Lclient!ec;")
	public static JagString aClass22_145 = aClass22_146;
	...
	public static void method345() {
		for (@Pc(15) ComponentPointer local15 = (ComponentPointer) Static90.aClass81_11.method2017(); local15 != null; local15 = (ComponentPointer) Static90.aClass81_11.method2013()) {
			@Pc(20) int local20 = local15.anInt2939;
			if (Static24.method396(local20)) {
				@Pc(26) boolean local26 = true;
				@Pc(30) IfType[] local30 = Static65.aClass4_Sub7ArrayArray1[local20];
				...
				if (!local26) {
					...
					@Pc(64) IfType local64 = Static106.method1749(local60);
					if (local64 != null) {
