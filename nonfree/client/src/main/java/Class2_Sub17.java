...
public final class Class2_Sub17 extends Class2 {
	...
	@OriginalMember(owner = "client!di", name = "t", descriptor = "[F")
	...
	private void method1661(@OriginalArg(0) byte[] arg0) {
		...
		this.anInt1929 = local4.method8555(-9372);
		this.anInt1923 = local4.method8555(-9372);
		this.anInt1931 = local4.method8555(-9372);
		this.anInt1927 = local4.method8555(-9372);
		if (this.anInt1927 < 0) {
			this.anInt1927 = ~this.anInt1927;
			this.aBoolean229 = true;
		}
		@Pc(40) int local40 = local4.method8555(-9372);
		this.aByteArrayArray2 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method8581(-17416);
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method8573(local49, 0, local64);
			this.aByteArrayArray2[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!di", name = "a", descriptor = "(I)[F")
	private float[] method1666(@OriginalArg(0) int arg0) {
		Static115.method1669(this.aByteArrayArray2[arg0]);
		Static115.method1670();
		@Pc(15) int local15 = Static115.method1668(Static496.method7088(Static115.anIntArray150.length - 1));
		@Pc(19) boolean local19 = Static115.aBooleanArray10[local15];
		@Pc(25) int local25 = local19 ? Static115.anInt1930 : Static115.anInt1926;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static115.method1670() != 0;
			local29 = Static115.method1670() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static115.anInt1926 >> 2);
			local67 = (local25 >> 2) + (Static115.anInt1926 >> 2);
			local71 = Static115.anInt1926 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static115.anInt1926 >> 2);
			local104 = local25 + (Static115.anInt1926 >> 2) - (local25 >> 2);
			local108 = Static115.anInt1926 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class128 local123 = Static115.aClass128Array1[Static115.anIntArray150[local15]];
		@Pc(126) int local126 = local123.anInt3052;
		@Pc(131) int local131 = local123.anIntArray239[local126];
		@Pc(140) boolean local140 = !Static115.aClass127Array1[local131].method2669();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt3053; local144++) {
			@Pc(152) Class189 local152 = Static115.aClass189Array1[local123.anIntArray238[local144]];
			local154 = Static115.aFloatArray12;
			local152.method4043(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt3052;
			local176 = local123.anIntArray239[local171];
			Static115.aClass127Array1[local176].method2668(Static115.aFloatArray12, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static115.aFloatArray12[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static115.aFloatArray12;
			...
			@Pc(252) float[] local252 = local19 ? Static115.aFloatArray9 : Static115.aFloatArray13;
			@Pc(258) float[] local258 = local19 ? Static115.aFloatArray11 : Static115.aFloatArray15;
			@Pc(264) float[] local264 = local19 ? Static115.aFloatArray10 : Static115.aFloatArray16;
			@Pc(270) int[] local270 = local19 ? Static115.anIntArray149 : Static115.anIntArray151;
			...
			@Pc(486) int local486 = Static496.method7088(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static115.aFloatArray12[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static115.aFloatArray12[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt1925 > 0) {
			local176 = this.anInt1925 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean228) {
				for (local212 = 0; local212 < this.anInt1932; local212++) {
					local1254 = (this.anInt1925 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static115.aFloatArray12[local212];
				}
			}
		}
		local154 = this.aFloatArray14;
		this.aFloatArray14 = Static115.aFloatArray12;
		Static115.aFloatArray12 = local154;
		this.anInt1925 = local25;
		this.anInt1932 = local104 - (local25 >> 1);
		this.aBoolean228 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!di", name = "a", descriptor = "([I)Lclient!rb;")
	public Class2_Sub4_Sub1 method1672(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray25 == null) {
			this.anInt1925 = 0;
			this.aFloatArray14 = new float[Static115.anInt1930];
			this.aByteArray25 = new byte[this.anInt1923];
			this.anInt1933 = 0;
			this.anInt1934 = 0;
		}
		while (this.anInt1934 < this.aByteArrayArray2.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1666(this.anInt1934);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt1933;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt1923 - local47) {
					local50 = this.anInt1923 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt1933;
				}
				this.anInt1933 = local47;
			}
			this.anInt1934++;
		}
		...
		return new Class2_Sub4_Sub1(this.anInt1929, local129, this.anInt1931, this.anInt1927, this.aBoolean229);
	}
}
