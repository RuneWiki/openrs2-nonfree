...
public final class Class2_Sub17 extends Class2 {
	...
	private float[] method1564(@OriginalArg(0) int arg0) {
		Static88.method1568(this.aByteArrayArray8[arg0]);
		Static88.method1563();
		@Pc(15) int local15 = Static88.method1567(Static102.method1744(Static88.anIntArray353.length - 1));
		@Pc(19) boolean local19 = Static88.aBooleanArray63[local15];
		@Pc(25) int local25 = local19 ? Static88.anInt1987 : Static88.anInt1991;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static88.method1563() != 0;
			local29 = Static88.method1563() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static88.anInt1991 >> 2);
			local67 = (local25 >> 2) + (Static88.anInt1991 >> 2);
			local71 = Static88.anInt1991 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static88.anInt1991 >> 2);
			local104 = local25 + (Static88.anInt1991 >> 2) - (local25 >> 2);
			local108 = Static88.anInt1991 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class22 local123 = Static88.aClass22Array1[Static88.anIntArray353[local15]];
		@Pc(126) int local126 = local123.anInt690;
		@Pc(131) int local131 = local123.anIntArray110[local126];
		@Pc(140) boolean local140 = !Static88.aClass67Array1[local131].method2459();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt691; local144++) {
			@Pc(152) Class113 local152 = Static88.aClass113Array1[local123.anIntArray109[local144]];
			local154 = Static88.aFloatArray8;
			local152.method3972(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			...
			Static88.aClass67Array1[local176].method2455(Static88.aFloatArray8, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static88.aFloatArray8[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static88.aFloatArray8;
			...
			@Pc(252) float[] local252 = local19 ? Static88.aFloatArray3 : Static88.aFloatArray5;
			@Pc(258) float[] local258 = local19 ? Static88.aFloatArray1 : Static88.aFloatArray4;
			@Pc(264) float[] local264 = local19 ? Static88.aFloatArray7 : Static88.aFloatArray6;
			@Pc(270) int[] local270 = local19 ? Static88.anIntArray352 : Static88.anIntArray354;
			...
			@Pc(486) int local486 = Static102.method1744(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static88.aFloatArray8[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static88.aFloatArray8[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt1989 > 0) {
			local176 = this.anInt1989 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean76) {
				for (local212 = 0; local212 < this.anInt1993; local212++) {
					local1254 = (this.anInt1989 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static88.aFloatArray8[local212];
				}
			}
		}
		local154 = this.aFloatArray2;
		this.aFloatArray2 = Static88.aFloatArray8;
		Static88.aFloatArray8 = local154;
		this.anInt1989 = local25;
		this.anInt1993 = local104 - (local25 >> 1);
		this.aBoolean76 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!i", name = "a", descriptor = "([I)Lclient!kh;")
	public Class2_Sub22_Sub1 method1566(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray31 == null) {
			this.anInt1989 = 0;
			this.aFloatArray2 = new float[Static88.anInt1987];
			this.aByteArray31 = new byte[this.anInt1986];
			this.anInt1995 = 0;
			this.anInt1996 = 0;
		}
		while (this.anInt1996 < this.aByteArrayArray8.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1564(this.anInt1996);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt1995;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt1986 - local47) {
					local50 = this.anInt1986 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt1995;
				}
				this.anInt1995 = local47;
			}
			this.anInt1996++;
		}
		...
		return new Class2_Sub22_Sub1(this.anInt1990, local129, this.anInt1994, this.anInt1985, this.aBoolean75);
	}

	@OriginalMember(owner = "client!i", name = "a", descriptor = "([B)V")
	private void method1569(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub23 local4 = new Class2_Sub23(arg0);
		this.anInt1990 = local4.method2133();
		this.anInt1986 = local4.method2133();
		this.anInt1994 = local4.method2133();
		this.anInt1985 = local4.method2133();
		if (this.anInt1985 < 0) {
			this.anInt1985 = ~this.anInt1985;
			this.aBoolean75 = true;
		}
		@Pc(40) int local40 = local4.method2133();
		this.aByteArrayArray8 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method2122();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method2118(local49, local64);
