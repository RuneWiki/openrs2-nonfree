...
public final class Static295 {
	...
	@OriginalMember(owner = "client!kv", name = "k", descriptor = "Lclient!ri;")
	public static Class284 aClass284_92;
	...
	public static boolean method4420(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		return (Static134.method2612(arg0, arg1) | Static216.method3595(arg1, arg0) | Static171.method3048(arg1, arg0)) & Static210.method7448(arg0, arg1);
	}
	...
	public static void method4425(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) String arg5) {
		Static12.method111(arg1, null, arg2, arg3, -1, arg0, arg5, arg4);
	}

	@OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIIIII)Lclient!dd;")
	public static Class47 method4426(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		@Pc(33) long local33 = (long) arg0 * 76724863L ^ (long) arg5 * 32147369L ^ (long) arg3 * 97549L ^ (long) arg1 * 67481L ^ (long) arg4 * 475427L ^ (long) arg2 * 986053L;
		@Pc(39) Class47 local39 = (Class47) Static590.aClass342_204.method7684(local33);
		if (local39 == null) {
			local39 = Static196.aClass31_8.method8083(arg1, arg3, arg4, arg2, arg5, arg0);
			Static590.aClass342_204.method7683(local39, local33);
			return local39;
		} else {
			return local39;
		}
