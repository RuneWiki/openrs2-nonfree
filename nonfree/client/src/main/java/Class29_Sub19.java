...
public final class Class29_Sub19 extends Class29 {
	...
	@OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(ILclient!fs;)V")
	public Class29_Sub19(@OriginalArg(0) int arg0, @OriginalArg(1) Class6_Sub22 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Lclient!fs;)V")
	public Class29_Sub19(@OriginalArg(0) Class6_Sub22 arg0) {
		super(arg0);
	}
