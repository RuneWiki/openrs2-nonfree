...
public final class Static94 {
	...
	public static LruCache aClass33_29 = new LruCache(64);

	@OriginalMember(owner = "client!qb", name = "b", descriptor = "Lclient!ec;")
	public static JagString aClass22_738 = Static60.method1113("gelb:");

	@OriginalMember(owner = "client!qb", name = "c", descriptor = "Lclient!ec;")
	public static JagString aClass22_739 = Static60.method1113("Verbinde mit Server)3)3)3");
	...
	public static JagString aClass22_740 = Static60.method1113("Spieler");

	@OriginalMember(owner = "client!qb", name = "j", descriptor = "Lclient!ec;")
	public static JagString aClass22_741 = Static60.method1113("T");
	...
	public static void method1628() {
		GameShell.aClass7_1.method1573();
		for (@Pc(6) int local6 = 0; local6 < 32; local6++) {
			GameShell.aLongArray2[local6] = 0L;
		}
		for (@Pc(24) int local24 = 0; local24 < 32; local24++) {
			GameShell.aLongArray6[local24] = 0L;
		}
		GameShell.anInt2315 = 0;
	}
