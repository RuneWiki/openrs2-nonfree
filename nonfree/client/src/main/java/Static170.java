...
public final class Static170 {
	...
	public static final int[] anIntArray478 = new int[] { 0, 2, 2, 2, 1, 1, 3, 3, 1, 3, 3, 4, 4 };
	...
	public static int method4308(@OriginalArg(0) String arg0) {
		@Pc(13) int local13 = arg0.length();
		@Pc(15) int local15 = 0;
		for (@Pc(17) int local17 = 0; local17 < local13; local17++) {
			local15 = (local15 << 5) + Static257.method3522(arg0.charAt(local17)) - local15;
		}
		return local15;
	}
}
