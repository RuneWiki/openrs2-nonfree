...
public final class va extends Class78 implements Interface18 {
	...
	private native void wa(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) Class6 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8);

	@OriginalMember(owner = "client!va", name = "A", descriptor = "()I")
	public native int A();

	@OriginalMember(owner = "client!va", name = "M", descriptor = "(IILclient!ua;II)V")
	private native void M(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class6 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4);
}
