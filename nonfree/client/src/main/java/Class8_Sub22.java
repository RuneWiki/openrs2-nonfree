...
public final class Class8_Sub22 extends Class8 {
	...
	@OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(Lclient!hd;)V")
	public Class8_Sub22(@OriginalArg(0) Class4_Sub20 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(ILclient!hd;)V")
	public Class8_Sub22(@OriginalArg(0) int arg0, @OriginalArg(1) Class4_Sub20 arg1) {
		super(arg0, arg1);
	}
	...
	public void method8386() {
		if (super.anInt9788 < 0 && super.anInt9788 > 127) {
