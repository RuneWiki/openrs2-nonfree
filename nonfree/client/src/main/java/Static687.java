...
public final class Static687 {
	...
	@OriginalMember(owner = "client!vca", name = "a", descriptor = "([B[IIIIIIILclient!vca;)I")
	public static int method8520(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub12_Sub4 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt10433 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!vca", name = "a", descriptor = "(I[B[IIIIIIIILclient!vca;)I")
	public static int method8521(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub12_Sub4 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt10433 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!vca", name = "a", descriptor = "(II[B[IIIIIIILclient!vca;II)I")
	public static int method8522(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub12_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
		...
		arg7.anInt10433 = arg2;
		return arg3;
	}

	@OriginalMember(owner = "client!vca", name = "a", descriptor = "(II[B[IIIIIIIILclient!vca;II)I")
	public static int method8523(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub12_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt10435 -= arg8.anInt10430 * arg3;
		arg8.anInt10431 -= arg8.anInt10429 * arg3;
		@Pc(32) int local32;
		...
		arg8.anInt10435 += arg8.anInt10430 * arg3;
		arg8.anInt10431 += arg8.anInt10429 * arg3;
		arg8.anInt10436 = arg4;
		arg8.anInt10433 = arg2;
		return arg3;
	}

	@OriginalMember(owner = "client!vca", name = "a", descriptor = "([B[IIIIIIIILclient!vca;)I")
	public static int method8529(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub12_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt10435 += arg8.anInt10430 * (local24 - arg3);
		arg8.anInt10431 += arg8.anInt10429 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt10436 = arg4 >> 2;
		arg8.anInt10433 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!vca", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!vca;II)I")
	public static int method8530(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub12_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt10436 -= arg10.anInt10434 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt10436 += arg10.anInt10434 * local63;
		arg10.anInt10435 = arg4;
		arg10.anInt10431 = arg5;
		arg10.anInt10433 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!vca", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!vca;)I")
	public static int method8533(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub12_Sub4 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt10436 += arg10.anInt10434 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt10435 = arg4 >> 2;
		arg10.anInt10431 = arg5 >> 2;
		arg10.anInt10433 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!vca", name = "a", descriptor = "(II)I")
	public static int method8534(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!vca", name = "b", descriptor = "([B[IIIIIIILclient!vca;)I")
	public static int method8537(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub12_Sub4 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!vca", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!vca;II)I")
	public static int method8538(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub12_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt10436 -= arg10.anInt10434 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!vca", name = "b", descriptor = "(I[B[IIIIIIIILclient!vca;)I")
	public static int method8539(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub12_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!vca", name = "a", descriptor = "(Lclient!pv;III)Lclient!vca;")
	public static Class3_Sub12_Sub4 method8546(@OriginalArg(0) Class3_Sub39_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray67 == null || arg0.aByteArray67.length == 0 ? null : new Class3_Sub12_Sub4(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!vca", name = "b", descriptor = "(II[B[IIIIIIIILclient!vca;II)I")
	public static int method8547(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub12_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	public static int method8548(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!vca", name = "c", descriptor = "(II[B[IIIIIIIILclient!vca;II)I")
	public static int method8549(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub12_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!vca", name = "b", descriptor = "(II[B[IIIIIIILclient!vca;II)I")
	public static int method8552(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub12_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!vca", name = "d", descriptor = "(II[B[IIIIIIIILclient!vca;II)I")
	public static int method8553(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub12_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt10435 -= arg8.anInt10430 * arg3;
		arg8.anInt10431 -= arg8.anInt10429 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!vca", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!vca;)I")
	public static int method8555(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub12_Sub4 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt10436 += arg10.anInt10434 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!vca", name = "b", descriptor = "([B[IIIIIIIILclient!vca;)I")
	public static int method8556(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub12_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt10435 += arg8.anInt10430 * (local22 - arg3);
		arg8.anInt10431 += arg8.anInt10429 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
