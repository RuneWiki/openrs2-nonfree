...
public final class Class8_Sub13 extends Class8 {
	...
	private void method2065(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class8_Sub8 local4 = new Class8_Sub8(arg0);
		this.anInt2439 = local4.method8540();
		this.anInt2441 = local4.method8540();
		this.anInt2444 = local4.method8540();
		this.anInt2440 = local4.method8540();
		if (this.anInt2440 < 0) {
			this.anInt2440 = ~this.anInt2440;
			this.aBoolean183 = true;
		}
		@Pc(40) int local40 = local4.method8540();
		this.aByteArrayArray34 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method8525();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method8563(0, local64, local49);
			this.aByteArrayArray34[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!cr", name = "a", descriptor = "(I)[F")
	private float[] method2067(@OriginalArg(0) int arg0) {
		Static79.method2069(this.aByteArrayArray34[arg0]);
		Static79.method2071();
		@Pc(15) int local15 = Static79.method2072(Static112.method2537(Static79.anIntArray99.length - 1));
		@Pc(19) boolean local19 = Static79.aBooleanArray2[local15];
		@Pc(25) int local25 = local19 ? Static79.anInt2437 : Static79.anInt2438;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static79.method2071() != 0;
			local29 = Static79.method2071() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static79.anInt2438 >> 2);
			local67 = (local25 >> 2) + (Static79.anInt2438 >> 2);
			local71 = Static79.anInt2438 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static79.anInt2438 >> 2);
			local104 = local25 + (Static79.anInt2438 >> 2) - (local25 >> 2);
			local108 = Static79.anInt2438 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class327 local123 = Static79.aClass327Array1[Static79.anIntArray99[local15]];
		@Pc(126) int local126 = local123.anInt9452;
		@Pc(131) int local131 = local123.anIntArray516[local126];
		@Pc(140) boolean local140 = !Static79.aClass290Array1[local131].method7145();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt9453; local144++) {
			@Pc(152) Class187 local152 = Static79.aClass187Array1[local123.anIntArray515[local144]];
			local154 = Static79.aFloatArray27;
			local152.method4903(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt9452;
			local176 = local123.anIntArray516[local171];
			Static79.aClass290Array1[local176].method7148(Static79.aFloatArray27, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static79.aFloatArray27[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static79.aFloatArray27;
			...
			@Pc(252) float[] local252 = local19 ? Static79.aFloatArray34 : Static79.aFloatArray29;
			@Pc(258) float[] local258 = local19 ? Static79.aFloatArray33 : Static79.aFloatArray32;
			@Pc(264) float[] local264 = local19 ? Static79.aFloatArray31 : Static79.aFloatArray28;
			@Pc(270) int[] local270 = local19 ? Static79.anIntArray98 : Static79.anIntArray97;
			...
			@Pc(486) int local486 = Static112.method2537(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static79.aFloatArray27[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static79.aFloatArray27[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt2436 > 0) {
			local176 = this.anInt2436 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean185) {
				for (local212 = 0; local212 < this.anInt2445; local212++) {
					local1254 = (this.anInt2436 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static79.aFloatArray27[local212];
				}
			}
		}
		local154 = this.aFloatArray30;
		this.aFloatArray30 = Static79.aFloatArray27;
		Static79.aFloatArray27 = local154;
		this.anInt2436 = local25;
		this.anInt2445 = local104 - (local25 >> 1);
		this.aBoolean185 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!cr", name = "a", descriptor = "([I)Lclient!cba;")
	public Class8_Sub9_Sub1 method2074(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray11 == null) {
			this.anInt2436 = 0;
			this.aFloatArray30 = new float[Static79.anInt2437];
			this.aByteArray11 = new byte[this.anInt2441];
			this.anInt2446 = 0;
			this.anInt2447 = 0;
		}
		while (this.anInt2447 < this.aByteArrayArray34.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method2067(this.anInt2447);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2446;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt2441 - local47) {
					local50 = this.anInt2441 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray11[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2446;
				}
				this.anInt2446 = local47;
			}
			this.anInt2447++;
		}
		this.aFloatArray30 = null;
		@Pc(129) byte[] local129 = this.aByteArray11;
		this.aByteArray11 = null;
		return new Class8_Sub9_Sub1(this.anInt2439, local129, this.anInt2444, this.anInt2440, this.aBoolean183);
	}
}
