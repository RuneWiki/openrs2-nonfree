...
public final class Static216 {
	...
	public static int method4064(@OriginalArg(1) int arg0) {
	...
	public static int method4070(@OriginalArg(0) String arg0, @OriginalArg(2) String arg1, @OriginalArg(3) int arg2) {
		...
		while (local8 > local13 - local22 || local15 - local24 < local11) {
			...
			local22 = Static365.method6456(local61);
			local24 = Static365.method6456(local74);
			local61 = Static126.method2538(arg2, local61);
			local74 = Static126.method2538(arg2, local74);
			if (local61 != local74 && Character.toUpperCase(local61) != Character.toUpperCase(local74)) {
				...
				if (local61 != local74) {
					return Static161.method3289(local61, arg2) - Static161.method3289(local74, arg2);
				}
			}
		}
		...
		for (@Pc(147) int local147 = 0; local147 < local145; local147++) {
			...
			if (local182 != local178 && Character.toUpperCase(local178) != Character.toUpperCase(local182)) {
				...
				if (local178 != local182) {
					return Static161.method3289(local178, arg2) - Static161.method3289(local182, arg2);
				}
			}
		}
		...
		for (@Pc(235) int local235 = 0; local235 < local145; local235++) {
			...
			if (local245 != local241) {
				return Static161.method3289(local241, arg2) - Static161.method3289(local245, arg2);
			}
		}
		return 0;
	}
