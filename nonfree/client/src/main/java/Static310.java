...
public final class Static310 {
	...
	@OriginalMember(owner = "client!bh", name = "a", descriptor = "([B[IIIIIIILclient!bh;)I")
	public static int method484(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class4_Sub6_Sub1 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt514 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!bh", name = "a", descriptor = "(II[B[IIIIIIIILclient!bh;II)I")
	public static int method485(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub6_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lclient!ri;II)Lclient!bh;")
	public static Class4_Sub6_Sub1 method486(@OriginalArg(0) Class4_Sub5_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray57 == null || arg0.aByteArray57.length == 0 ? null : new Class4_Sub6_Sub1(arg0, (int) ((long) arg0.anInt4737 * 256L * (long) 100 / (long) (Static75.anInt1523 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!bh", name = "a", descriptor = "(II[B[IIIIIIILclient!bh;II)I")
	public static int method489(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class4_Sub6_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!bh", name = "b", descriptor = "([B[IIIIIIILclient!bh;)I")
	public static int method490(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class4_Sub6_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!bh", name = "a", descriptor = "([B[IIIIIIIILclient!bh;)I")
	public static int method493(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class4_Sub6_Sub1 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt505 += arg8.anInt501 * (local24 - arg3);
		arg8.anInt513 += arg8.anInt512 * (local24 - arg3);
		local24 -= 3;
		@Pc(56) int local56;
		while (arg3 < local24) {
			local56 = arg3++;
		...
		arg8.anInt506 = arg4 >> 2;
		arg8.anInt514 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!bh", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!bh;)I")
	public static int method495(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class4_Sub6_Sub1 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt506 += arg10.anInt508 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(64) byte local64;
		...
		arg10.anInt505 = arg4 >> 2;
		arg10.anInt513 = arg5 >> 2;
		arg10.anInt514 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!bh", name = "b", descriptor = "(II)I")
	public static int method503(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!bh", name = "b", descriptor = "(II[B[IIIIIIIILclient!bh;II)I")
	public static int method505(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub6_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt505 -= arg8.anInt501 * arg3;
		arg8.anInt513 -= arg8.anInt512 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!bh", name = "b", descriptor = "(II[B[IIIIIIILclient!bh;II)I")
	public static int method506(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class4_Sub6_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!bh", name = "c", descriptor = "(II[B[IIIIIIIILclient!bh;II)I")
	public static int method507(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub6_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt505 -= arg8.anInt501 * arg3;
		arg8.anInt513 -= arg8.anInt512 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!bh", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!bh;II)I")
	public static int method509(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class4_Sub6_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt506 -= arg10.anInt508 * arg3;
		@Pc(23) int local23;
		...
		local65 = arg3 >> 1;
		arg10.anInt506 += arg10.anInt508 * local65;
		arg10.anInt505 = arg4;
		arg10.anInt513 = arg5;
		arg10.anInt514 = arg2;
		return local65;
	...
	public static int method510(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!bh", name = "b", descriptor = "([B[IIIIIIIILclient!bh;)I")
	public static int method511(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class4_Sub6_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt505 += arg8.anInt501 * (local22 - arg3);
		arg8.anInt513 += arg8.anInt512 * (local22 - arg3);
		local22 -= 3;
		@Pc(54) int local54;
		while (arg3 < local22) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!bh", name = "d", descriptor = "(II[B[IIIIIIIILclient!bh;II)I")
	public static int method515(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub6_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!bh", name = "a", descriptor = "(I[B[IIIIIIIILclient!bh;)I")
	public static int method519(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class4_Sub6_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lclient!ri;III)Lclient!bh;")
	public static Class4_Sub6_Sub1 method520(@OriginalArg(0) Class4_Sub5_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray57 == null || arg0.aByteArray57.length == 0 ? null : new Class4_Sub6_Sub1(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!bh", name = "b", descriptor = "(I[B[IIIIIIIILclient!bh;)I")
	public static int method521(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class4_Sub6_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!bh", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!bh;II)I")
	public static int method522(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class4_Sub6_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt506 -= arg10.anInt508 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!bh", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!bh;)I")
	public static int method523(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class4_Sub6_Sub1 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt506 += arg10.anInt508 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(62) byte local62;
