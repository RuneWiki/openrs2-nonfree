...
public class DecoderContext extends SimplePeer {
	...
	@OriginalMember(owner = "client!jagtheora/theora/DecoderContext", name = "<init>", descriptor = "(Lclient!jagtheora/theora/TheoraInfo;Lclient!jagtheora/theora/SetupInfo;)V", line = 11)
	...
	@OriginalMember(owner = "client!jagtheora/theora/DecoderContext", name = "h", descriptor = "()V")
	protected native void h();

	@OriginalMember(owner = "client!jagtheora/theora/DecoderContext", name = "x", descriptor = "()V")
