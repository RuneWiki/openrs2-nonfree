...
public class OggStreamState extends SimplePeer {
	...
	@OriginalMember(owner = "client!jagtheora/ogg/OggStreamState", name = "h", descriptor = "()V")
	protected native void h();

	@OriginalMember(owner = "client!jagtheora/ogg/OggStreamState", name = "x", descriptor = "()V")
