...
public class DSPState extends SimplePeer {
	...
	@OriginalMember(owner = "client!jagtheora/vorbis/DSPState", name = "<init>", descriptor = "(Lclient!jagtheora/vorbis/VorbisInfo;)V", line = 10)
	...
	@OriginalMember(owner = "client!jagtheora/vorbis/DSPState", name = "h", descriptor = "()V")
	protected native void h();

	@OriginalMember(owner = "client!jagtheora/vorbis/DSPState", name = "x", descriptor = "()V")
