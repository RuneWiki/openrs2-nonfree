...
public final class Class6_Sub8 extends Class6 {
	...
	@OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(ILclient!hs;)V")
	public Class6_Sub8(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub25 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(Lclient!hs;)V")
	public Class6_Sub8(@OriginalArg(0) Class5_Sub25 arg0) {
		super(arg0);
	}
	...
	public void method8537() {
		if (super.anInt9925 < 1 || super.anInt9925 > 3) {
	...
	protected int method8535() {
		return super.aClass5_Sub25_32.method3681().method7217() ? 3 : 2;
	}
}
