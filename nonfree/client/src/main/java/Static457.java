...
public final class Static457 {
	...
	@OriginalMember(owner = "client!ct", name = "a", descriptor = "([B[IIIIIIIILclient!ct;)I")
	public static int method908(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub9_Sub1 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt1080 += arg8.anInt1077 * (local22 - arg3);
		arg8.anInt1081 += arg8.anInt1073 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt1078 = arg4 >> 2;
		arg8.anInt1075 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ct", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!ct;II)I")
	public static int method909(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub9_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1078 -= arg10.anInt1082 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt1078 += arg10.anInt1082 * local63;
		arg10.anInt1080 = arg4;
		arg10.anInt1081 = arg5;
		arg10.anInt1075 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!ct", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!ct;)I")
	public static int method910(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub9_Sub1 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt1078 += arg10.anInt1082 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt1080 = arg4 >> 2;
		arg10.anInt1081 = arg5 >> 2;
		arg10.anInt1075 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lclient!nq;III)Lclient!ct;")
	public static Class1_Sub9_Sub1 method911(@OriginalArg(0) Class1_Sub28_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray48 == null || arg0.aByteArray48.length == 0 ? null : new Class1_Sub9_Sub1(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!ct", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!ct;)I")
	public static int method915(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub9_Sub1 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt1078 += arg10.anInt1082 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!ct", name = "a", descriptor = "(I[B[IIIIIIIILclient!ct;)I")
	public static int method920(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub9_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
	...
	@OriginalMember(owner = "client!ct", name = "a", descriptor = "(II[B[IIIIIIIILclient!ct;II)I")
	public static int method923(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub9_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ct", name = "b", descriptor = "(II[B[IIIIIIIILclient!ct;II)I")
	public static int method925(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub9_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ct", name = "a", descriptor = "([B[IIIIIIILclient!ct;)I")
	public static int method926(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub9_Sub1 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt1075 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ct", name = "c", descriptor = "(II[B[IIIIIIIILclient!ct;II)I")
	public static int method927(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub9_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1080 -= arg8.anInt1077 * arg3;
		arg8.anInt1081 -= arg8.anInt1073 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ct", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!ct;II)I")
	public static int method931(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub9_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1078 -= arg10.anInt1082 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!ct", name = "b", descriptor = "(I[B[IIIIIIIILclient!ct;)I")
	public static int method932(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub9_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	public static int method933(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ct", name = "d", descriptor = "(II)I")
	public static int method936(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ct", name = "b", descriptor = "([B[IIIIIIIILclient!ct;)I")
	public static int method937(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub9_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1080 += arg8.anInt1077 * (local24 - arg3);
		arg8.anInt1081 += arg8.anInt1073 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!ct", name = "b", descriptor = "([B[IIIIIIILclient!ct;)I")
	public static int method939(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub9_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!ct", name = "a", descriptor = "(II[B[IIIIIIILclient!ct;II)I")
	public static int method940(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub9_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lclient!nq;II)Lclient!ct;")
	public static Class1_Sub9_Sub1 method942(@OriginalArg(0) Class1_Sub28_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray48 == null || arg0.aByteArray48.length == 0 ? null : new Class1_Sub9_Sub1(arg0, (int) ((long) arg0.anInt4314 * 256L * (long) 100 / (long) (Static155.anInt2607 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!ct", name = "d", descriptor = "(II[B[IIIIIIIILclient!ct;II)I")
	public static int method945(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub9_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1080 -= arg8.anInt1077 * arg3;
		arg8.anInt1081 -= arg8.anInt1073 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ct", name = "b", descriptor = "(II[B[IIIIIIILclient!ct;II)I")
	public static int method946(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub9_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
