...
public final class Static654 {
	...
	public static int method8822(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!via", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!via;)I")
	public static int method8826(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub8_Sub5 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt10591 += arg10.anInt10588 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt10585 = arg4 >> 2;
		arg10.anInt10589 = arg5 >> 2;
		arg10.anInt10597 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!via", name = "a", descriptor = "(II[B[IIIIIIIILclient!via;II)I")
	public static int method8827(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub8_Sub5 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
		...
		arg8.anInt10597 = arg2;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!via", name = "a", descriptor = "(I[B[IIIIIIIILclient!via;)I")
	public static int method8830(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub8_Sub5 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt10597 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!via", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!via;II)I")
	public static int method8832(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub8_Sub5 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt10591 -= arg10.anInt10588 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt10591 += arg10.anInt10588 * local63;
		arg10.anInt10585 = arg4;
		arg10.anInt10589 = arg5;
		arg10.anInt10597 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!via", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!via;)I")
	public static int method8833(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub8_Sub5 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt10591 += arg10.anInt10588 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!via", name = "b", descriptor = "(II[B[IIIIIIIILclient!via;II)I")
	public static int method8836(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub8_Sub5 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt10585 -= arg8.anInt10586 * arg3;
		arg8.anInt10589 -= arg8.anInt10593 * arg3;
		@Pc(32) int local32;
		...
		arg8.anInt10585 += arg8.anInt10586 * arg3;
		arg8.anInt10589 += arg8.anInt10593 * arg3;
		arg8.anInt10591 = arg4;
		arg8.anInt10597 = arg2;
		return arg3;
	}

	@OriginalMember(owner = "client!via", name = "d", descriptor = "(II)I")
	public static int method8837(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!via", name = "a", descriptor = "([B[IIIIIIILclient!via;)I")
	public static int method8838(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub8_Sub5 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt10597 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!via", name = "a", descriptor = "(II[B[IIIIIIILclient!via;II)I")
	public static int method8840(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub8_Sub5 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
		...
		arg7.anInt10597 = arg2;
		return arg3;
	}

	@OriginalMember(owner = "client!via", name = "a", descriptor = "([B[IIIIIIIILclient!via;)I")
	public static int method8841(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub8_Sub5 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt10585 += arg8.anInt10586 * (local24 - arg3);
		arg8.anInt10589 += arg8.anInt10593 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt10591 = arg4 >> 2;
		arg8.anInt10597 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!via", name = "b", descriptor = "(I[B[IIIIIIIILclient!via;)I")
	public static int method8843(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub8_Sub5 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!via", name = "a", descriptor = "(Lclient!ob;III)Lclient!via;")
	public static Class2_Sub8_Sub5 method8844(@OriginalArg(0) Class2_Sub29_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray97 == null || arg0.aByteArray97.length == 0 ? null : new Class2_Sub8_Sub5(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!via", name = "c", descriptor = "(II[B[IIIIIIIILclient!via;II)I")
	public static int method8845(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub8_Sub5 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt10585 -= arg8.anInt10586 * arg3;
		arg8.anInt10589 -= arg8.anInt10593 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!via", name = "b", descriptor = "([B[IIIIIIIILclient!via;)I")
	public static int method8846(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub8_Sub5 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt10585 += arg8.anInt10586 * (local22 - arg3);
		arg8.anInt10589 += arg8.anInt10593 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!via", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!via;II)I")
	public static int method8853(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub8_Sub5 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt10591 -= arg10.anInt10588 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!via", name = "b", descriptor = "([B[IIIIIIILclient!via;)I")
	public static int method8854(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub8_Sub5 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!via", name = "d", descriptor = "(II[B[IIIIIIIILclient!via;II)I")
	public static int method8855(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub8_Sub5 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!via", name = "b", descriptor = "(II[B[IIIIIIILclient!via;II)I")
	public static int method8858(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub8_Sub5 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
