...
public final class s extends Class83 implements Interface18 {

	@OriginalMember(owner = "client!s", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!s", name = "q", descriptor = "Lclient!oe;")
	private final Class244 aClass244_55 = new Class244();

	@OriginalMember(owner = "client!s", name = "r", descriptor = "Lclient!l;")
	private final l aL2;
	...
	public s(@OriginalArg(0) l arg0, @OriginalArg(1) m arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.aL2 = arg0;
		this.SA(this.aL2, arg1, arg2, arg3, super.anIntArrayArray54, arg5, arg6, arg7, arg8);
	}
	...
	public void method7207(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aL2.method5047().la(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public void method7216(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass244_55.method5973()];
		for (@Pc(13) Class4_Sub24 local13 = (Class4_Sub24) this.aClass244_55.method5963(); local13 != null; local13 = (Class4_Sub24) this.aClass244_55.method5965()) {
			local7[local1++] = local13.method7144();
		}
		this.YA(local7);
		for (@Pc(34) int local34 = 0; local34 < arg2 + arg2; local34++) {
			for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
				if (arg3[local34][local37]) {
					...
					if (local50 >= 0 && local50 < super.anInt8829 && local56 >= 0 && local56 < super.anInt8830) {
						this.method7209(local50, local56);
					}
				}
			}
		}
	...
	public native void DA(@OriginalArg(0) Class4_Sub5_Sub6 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!s", name = "a", descriptor = "(Lclient!ul;[I)V")
	@Override
	public void method7211(@OriginalArg(0) Class4_Sub24 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass244_55.method5960(arg0);
		this.VA(arg0.hashCode(), arg0.method7145(), arg0.method7147(), arg0.method7142(), arg0.method7151(), arg0.method7149(), arg1);
	}
	...
	public native void E(@OriginalArg(0) Class4_Sub5_Sub6 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!s", name = "v", descriptor = "(IILclient!ha;)Lclient!ha;")
	public native Class4_Sub5_Sub6 v(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class4_Sub5_Sub6 arg2);
	...
	public void method7209(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aL2.method5047().ZA(this, arg0, arg1);
	}
}
