...
public final class s extends Class17 implements Interface19 {

	@OriginalMember(owner = "client!s", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!s", name = "l", descriptor = "Lclient!wo;")
	private final Class361 aClass361_89 = new Class361();
	...
	public s(@OriginalArg(0) l arg0, @OriginalArg(1) m arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.aL2 = arg0;
		this.SA(this.aL2, arg1, arg2, arg3, super.anIntArrayArray50, arg5, arg6, arg7, arg8);
	}
	...
	@OriginalMember(owner = "client!s", name = "a", descriptor = "(Lclient!qea;[I)V")
	@Override
	public void method6640(@OriginalArg(0) Class1_Sub5 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass361_89.method7855(arg0);
		this.VA(arg0.hashCode(), arg0.method4159(), arg0.method4163(), arg0.method4158(), arg0.method4162(), arg0.method4165(), arg1);
	}

	@OriginalMember(owner = "client!s", name = "E", descriptor = "(Lclient!ha;IIIIZ)V")
	public native void E(@OriginalArg(0) Class1_Sub3_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public native void DA(@OriginalArg(0) Class1_Sub3_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method6645(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aL2.method4536().la(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!s", name = "v", descriptor = "(IILclient!ha;)Lclient!ha;")
	public native Class1_Sub3_Sub4 v(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class1_Sub3_Sub4 arg2);
	...
	public void method6641(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass361_89.method7851()];
		for (@Pc(13) Class1_Sub5 local13 = (Class1_Sub5) this.aClass361_89.method7854(); local13 != null; local13 = (Class1_Sub5) this.aClass361_89.method7853()) {
			local7[local1++] = local13.method4160();
		}
		this.YA(local7);
		for (@Pc(34) int local34 = 0; local34 < arg2 + arg2; local34++) {
			for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
				if (arg3[local34][local37]) {
					...
					if (local50 >= 0 && local50 < super.anInt7983 && local56 >= 0 && local56 < super.anInt7984) {
						this.method6644(local50, local56);
					}
				}
			}
		}
	...
	public void method6644(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aL2.method4536().ZA(this, arg0, arg1);
	}
}
