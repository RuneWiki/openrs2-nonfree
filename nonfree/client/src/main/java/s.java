...
public final class s extends Class129 implements Interface19 {

	@OriginalMember(owner = "client!s", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!s", name = "k", descriptor = "Lclient!gca;")
	private final Class111 aClass111_53 = new Class111();

	@OriginalMember(owner = "client!s", name = "l", descriptor = "Lclient!l;")
	private final l aL2;
	...
	public s(@OriginalArg(0) l arg0, @OriginalArg(1) m arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.aL2 = arg0;
		this.SA(this.aL2, arg1, arg2, arg3, super.anIntArrayArray49, arg5, arg6, arg7, arg8);
	}
	...
	public native void DA(@OriginalArg(0) Class1_Sub8_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public native void E(@OriginalArg(0) Class1_Sub8_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	@OriginalMember(owner = "client!s", name = "a", descriptor = "(Lclient!tw;[I)V")
	@Override
	public void method6482(@OriginalArg(0) Class1_Sub24 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass111_53.method2552(arg0);
		this.VA(arg0.hashCode(), arg0.method7609(), arg0.method7612(), arg0.method7608(), arg0.method7610(), arg0.method7613(), arg1);
	}
	...
	public void method6478(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass111_53.method2545()];
		for (@Pc(13) Class1_Sub24 local13 = (Class1_Sub24) this.aClass111_53.method2547(); local13 != null; local13 = (Class1_Sub24) this.aClass111_53.method2554()) {
			local7[local1++] = local13.method7615();
		}
		this.YA(local7);
		for (@Pc(34) int local34 = 0; local34 < arg2 + arg2; local34++) {
			for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
				if (arg3[local34][local37]) {
					...
					if (local50 >= 0 && local50 < super.anInt8065 && local56 >= 0 && local56 < super.anInt8058) {
						this.method6475(local50, local56);
					}
				}
			}
		}
	...
	public void method6475(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aL2.method4280().ZA(this, arg0, arg1);
	}

	@OriginalMember(owner = "client!s", name = "v", descriptor = "(IILclient!ha;)Lclient!ha;")
	public native Class1_Sub8_Sub4 v(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class1_Sub8_Sub4 arg2);
	...
	public void method6476(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aL2.method4280().la(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
