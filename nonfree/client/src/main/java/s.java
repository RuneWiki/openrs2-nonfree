...
public final class s extends Class46 implements Interface4 {

	@OriginalMember(owner = "client!s", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!s", name = "<init>", descriptor = "(Lclient!qa;Lclient!na;Lclient!gt;[Lclient!bb;[Lclient!l;)V")
	public s(@OriginalArg(0) qa arg0, @OriginalArg(1) na arg1, @OriginalArg(2) Class89 arg2, @OriginalArg(3) Class18[] arg3, @OriginalArg(4) Class57[] arg4) {
		super(arg0, arg2);
