...
public final class s extends Class34 implements Interface16 {

	@OriginalMember(owner = "client!s", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!s", name = "n", descriptor = "Lclient!gk;")
	private final Class112 aClass112_57 = new Class112();
	...
	public s(@OriginalArg(0) l arg0, @OriginalArg(1) m arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.aL2 = arg0;
		this.SA(this.aL2, arg1, arg2, arg3, super.anIntArrayArray172, arg5, arg6, arg7, arg8);
	}
	...
	public native void E(@OriginalArg(0) Class3_Sub7_Sub13 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!s", name = "a", descriptor = "(II)V")
	@Override
	public void method6527(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aL2.method4358().ZA(this, arg0, arg1);
	}

	@OriginalMember(owner = "client!s", name = "a", descriptor = "(Lclient!eq;[I)V")
	@Override
	public void method6535(@OriginalArg(0) Class3_Sub10 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass112_57.method3079(arg0);
		this.VA(arg0.hashCode(), arg0.method6021(), arg0.method6011(), arg0.method6015(), arg0.method6018(), arg0.method6020(), arg1);
	}
	...
	public void method6526(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass112_57.method3083()];
		for (@Pc(13) Class3_Sub10 local13 = (Class3_Sub10) this.aClass112_57.method3088(); local13 != null; local13 = (Class3_Sub10) this.aClass112_57.method3084()) {
			local7[local1++] = local13.method6013();
		}
		this.YA(local7);
		for (@Pc(34) int local34 = 0; local34 < arg2 + arg2; local34++) {
			for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
				if (arg3[local34][local37]) {
					...
					if (local50 >= 0 && local50 < super.anInt7854 && local56 >= 0 && local56 < super.anInt7852) {
						this.method6527(local50, local56);
					}
				}
			}
		}
	...
	public native Class3_Sub7_Sub13 v(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class3_Sub7_Sub13 arg2);
	...
	public native void DA(@OriginalArg(0) Class3_Sub7_Sub13 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method6532(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aL2.method4358().la(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
