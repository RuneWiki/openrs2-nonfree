...
public final class s extends Class47 implements Interface15 {

	@OriginalMember(owner = "client!s", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!s", name = "o", descriptor = "Lclient!wba;")
	private final Class353 aClass353_57 = new Class353();

	@OriginalMember(owner = "client!s", name = "p", descriptor = "Lclient!l;")
	private final l aL2;
	...
	public s(@OriginalArg(0) l arg0, @OriginalArg(1) m arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.aL2 = arg0;
		this.SA(this.aL2, arg1, arg2, arg3, super.anIntArrayArray197, arg5, arg6, arg7, arg8);
	}

	@OriginalMember(owner = "client!s", name = "DA", descriptor = "(Lclient!ha;IIIIZ)V")
	public native void DA(@OriginalArg(0) Class1_Sub6_Sub5 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!s", name = "BA", descriptor = "()V")
	public native void BA();

	@OriginalMember(owner = "client!s", name = "a", descriptor = "(Lclient!rc;[I)V")
	@Override
	public void method7542(@OriginalArg(0) Class1_Sub18 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass353_57.method7679(arg0);
		this.VA(arg0.hashCode(), arg0.method4107(), arg0.method4101(), arg0.method4098(), arg0.method4104(), arg0.method4102(), arg1);
	}
	...
	public void method7548(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aL2.method4040().la(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public native Class1_Sub6_Sub5 v(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class1_Sub6_Sub5 arg2);
	...
	public void method7553(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass353_57.method7682()];
		for (@Pc(13) Class1_Sub18 local13 = (Class1_Sub18) this.aClass353_57.method7677(); local13 != null; local13 = (Class1_Sub18) this.aClass353_57.method7687()) {
			local7[local1++] = local13.method4099();
		}
		this.YA(local7);
		for (@Pc(34) int local34 = 0; local34 < arg2 + arg2; local34++) {
			for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
				if (arg3[local34][local37]) {
					...
					if (local50 >= 0 && local50 < super.anInt9209 && local56 >= 0 && local56 < super.anInt9210) {
						this.method7549(local50, local56);
					}
				}
			}
		}
	...
	public native void E(@OriginalArg(0) Class1_Sub6_Sub5 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!s", name = "a", descriptor = "(II)V")
	@Override
	public void method7549(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aL2.method4040().ZA(this, arg0, arg1);
	}
