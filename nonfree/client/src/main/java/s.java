...
public final class s extends Class67 implements Interface21 {

	@OriginalMember(owner = "client!s", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!s", name = "m", descriptor = "Lclient!ae;")
	private final Class8 aClass8_56 = new Class8();

	@OriginalMember(owner = "client!s", name = "n", descriptor = "Lclient!l;")
	private final l aL2;
	...
	public s(@OriginalArg(0) l arg0, @OriginalArg(1) m arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.aL2 = arg0;
		this.SA(this.aL2, arg1, arg2, arg3, super.anIntArrayArray57, arg5, arg6, arg7, arg8);
	}

	@OriginalMember(owner = "client!s", name = "DA", descriptor = "(Lclient!ha;IIIIZ)V")
	public native void DA(@OriginalArg(0) Class2_Sub3_Sub6 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method6715(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass8_56.method214()];
		for (@Pc(13) Class2_Sub14 local13 = (Class2_Sub14) this.aClass8_56.method210(); local13 != null; local13 = (Class2_Sub14) this.aClass8_56.method218()) {
			local7[local1++] = local13.method7689();
		}
		this.YA(local7);
		for (@Pc(34) int local34 = 0; local34 < arg2 + arg2; local34++) {
			for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
				if (arg3[local34][local37]) {
					...
					if (local50 >= 0 && local50 < super.anInt8111 && local56 >= 0 && local56 < super.anInt8110) {
						this.method6716(local50, local56);
					}
				}
			}
		}
	...
	public void method6713(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aL2.method4479().la(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public void method6716(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aL2.method4479().ZA(this, arg0, arg1);
	}
	...
	public native void E(@OriginalArg(0) Class2_Sub3_Sub6 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!s", name = "v", descriptor = "(IILclient!ha;)Lclient!ha;")
	public native Class2_Sub3_Sub6 v(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class2_Sub3_Sub6 arg2);
	...
	@OriginalMember(owner = "client!s", name = "a", descriptor = "(Lclient!gga;[I)V")
	@Override
	public void method6709(@OriginalArg(0) Class2_Sub14 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass8_56.method212(arg0);
		this.VA(arg0.hashCode(), arg0.method7694(), arg0.method7696(), arg0.method7693(), arg0.method7691(), arg0.method7687(), arg1);
	}
}
