...
public final class s extends Class115 implements Interface18 {

	@OriginalMember(owner = "client!s", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!s", name = "n", descriptor = "Lclient!au;")
	private final Class22 aClass22_57 = new Class22();
	...
	public s(@OriginalArg(0) l arg0, @OriginalArg(1) m arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.aL2 = arg0;
		this.SA(this.aL2, arg1, arg2, arg3, super.anIntArrayArray61, arg5, arg6, arg7, arg8);
	}

	@OriginalMember(owner = "client!s", name = "v", descriptor = "(IILclient!ha;)Lclient!ha;")
	public native Class4_Sub6_Sub7 v(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class4_Sub6_Sub7 arg2);

	@OriginalMember(owner = "client!s", name = "a", descriptor = "(Lclient!am;[I)V")
	@Override
	public void method8057(@OriginalArg(0) Class4_Sub3 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass22_57.method894(arg0);
		this.VA(arg0.hashCode(), arg0.method4954(), arg0.method4953(), arg0.method4949(), arg0.method4950(), arg0.method4952(), arg1);
	}
	...
	public native void DA(@OriginalArg(0) Class4_Sub6_Sub7 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method8059(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aL2.method4576().la(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public native void E(@OriginalArg(0) Class4_Sub6_Sub7 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method8053(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass22_57.method880()];
		for (@Pc(13) Class4_Sub3 local13 = (Class4_Sub3) this.aClass22_57.method895(); local13 != null; local13 = (Class4_Sub3) this.aClass22_57.method889()) {
			local7[local1++] = local13.method4955();
		}
		this.YA(local7);
		for (@Pc(34) int local34 = 0; local34 < arg2 + arg2; local34++) {
			for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
				if (arg3[local34][local37]) {
					...
					if (local50 >= 0 && local50 < super.anInt10330 && local56 >= 0 && local56 < super.anInt10327) {
						this.method8061(local50, local56);
					}
				}
			}
		}
	...
	public void method8061(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aL2.method4576().ZA(this, arg0, arg1);
	}
