...
public final class s extends Class131 implements Interface9 {

	@OriginalMember(owner = "client!s", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!s", name = "j", descriptor = "Lclient!fea;")
	private final Class99 aClass99_66 = new Class99();
	...
	public native void ya(@OriginalArg(0) Class5_Sub2_Sub13 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method7187(@OriginalArg(0) Class5_Sub10 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass99_66.method2513(arg0);
		this.L(arg0.hashCode(), arg0.method5189(), arg0.method5190(), arg0.method5183(), arg0.method5191(), arg0.method5185(), arg1);
	}
	...
	public void method7190(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass99_66.method2518()];
		for (@Pc(13) Class5_Sub10 local13 = (Class5_Sub10) this.aClass99_66.method2526(); local13 != null; local13 = (Class5_Sub10) this.aClass99_66.method2519()) {
			local7[local1++] = local13.method5184();
		}
		this.FA(local7);
	}
	...
	public native Class5_Sub2_Sub13 X(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class5_Sub2_Sub13 arg2);

	@OriginalMember(owner = "client!s", name = "F", descriptor = "(Lclient!k;IIIIZ)V")
	public native void F(@OriginalArg(0) Class5_Sub2_Sub13 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method7183(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.anA2.method161().k(this, arg0, arg1);
	}
	...
	public void method7182(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anA2.method161().Y(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
}
