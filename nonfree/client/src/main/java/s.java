...
public final class s extends Class71 implements Interface2 {

	@OriginalMember(owner = "client!s", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!s", name = "<init>", descriptor = "(Lclient!qa;Lclient!na;Lclient!lm;[Lclient!di;[Lclient!l;)V")
	public s(@OriginalArg(0) qa arg0, @OriginalArg(1) na arg1, @OriginalArg(2) Class151 arg2, @OriginalArg(3) Class51[] arg3, @OriginalArg(4) Class143[] arg4) {
		super(arg0, arg2);
	...
	@OriginalMember(owner = "client!s", name = "A", descriptor = "(CIIIZLclient!ma;II)V")
	private native void A(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class133 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
}
