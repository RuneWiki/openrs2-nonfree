...
public final class s extends Class7 implements Interface14 {

	@OriginalMember(owner = "client!s", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!s", name = "g", descriptor = "Lclient!ui;")
	private final Class295 aClass295_48 = new Class295();

	@OriginalMember(owner = "client!s", name = "h", descriptor = "Lclient!a;")
	...
	public native void ya(@OriginalArg(0) Class1_Sub2_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method8246(@OriginalArg(0) Class1_Sub5 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass295_48.method7533(arg0);
		this.L(arg0.hashCode(), arg0.method4306(), arg0.method4305(), arg0.method4314(), arg0.method4311(), arg0.method4313(), arg1);
	}
	...
	public native void F(@OriginalArg(0) Class1_Sub2_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method8249(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass295_48.method7548()];
		for (@Pc(13) Class1_Sub5 local13 = (Class1_Sub5) this.aClass295_48.method7543(); local13 != null; local13 = (Class1_Sub5) this.aClass295_48.method7540()) {
			local7[local1++] = local13.method4310();
		}
		this.FA(local7);
	}
	...
	public native Class1_Sub2_Sub2 X(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class1_Sub2_Sub2 arg2);
}
