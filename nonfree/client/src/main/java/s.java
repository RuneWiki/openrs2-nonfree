...
public final class s extends Class215 implements Interface12 {

	@OriginalMember(owner = "client!s", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!s", name = "i", descriptor = "Lclient!dm;")
	private final Class73 aClass73_67 = new Class73();
	...
	public native void F(@OriginalArg(0) Class12_Sub4_Sub10 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!s", name = "N", descriptor = "()V")
	public native void N();

	@OriginalMember(owner = "client!s", name = "a", descriptor = "(Lclient!rh;[I)V")
	@Override
	public void method7834(@OriginalArg(0) Class12_Sub7 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass73_67.method2012(arg0);
		this.L(arg0.hashCode(), arg0.method5124(), arg0.method5120(), arg0.method5117(), arg0.method5123(), arg0.method5118(), arg1);
	}
	...
	public void method7836(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anA2.method162().Y(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public native void ya(@OriginalArg(0) Class12_Sub4_Sub10 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method7837(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.anA2.method162().k(this, arg0, arg1);
	}

	@OriginalMember(owner = "client!s", name = "X", descriptor = "(IILclient!k;)Lclient!k;")
	public native Class12_Sub4_Sub10 X(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class12_Sub4_Sub10 arg2);
	...
	public void method7835(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass73_67.method2013()];
		for (@Pc(13) Class12_Sub7 local13 = (Class12_Sub7) this.aClass73_67.method2005(); local13 != null; local13 = (Class12_Sub7) this.aClass73_67.method2009()) {
			local7[local1++] = local13.method5125();
		}
		this.FA(local7);
	}
}
