...
public final class s extends Class151 implements Interface18 {
	...
	public s(@OriginalArg(0) l arg0, @OriginalArg(1) m arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.aL2 = arg0;
		this.SA(this.aL2, arg1, arg2, arg3, super.anIntArrayArray65, arg5, arg6, arg7, arg8);
	}
	...
	@OriginalMember(owner = "client!s", name = "a", descriptor = "(Lclient!tg;[I)V")
	@Override
	public void method7674(@OriginalArg(0) Class2_Sub11 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass70_48.method1269(arg0);
		this.VA(arg0.hashCode(), arg0.method7276(), arg0.method7270(), arg0.method7271(), arg0.method7277(), arg0.method7274(), arg1);
	}
	...
	public native Class2_Sub2_Sub8 v(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class2_Sub2_Sub8 arg2);
	...
	public void method7682(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aL2.method4237().ZA(this, arg0, arg1);
	}
	...
	public native void DA(@OriginalArg(0) Class2_Sub2_Sub8 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method7681(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass70_48.method1267()];
		for (@Pc(13) Class2_Sub11 local13 = (Class2_Sub11) this.aClass70_48.method1264(); local13 != null; local13 = (Class2_Sub11) this.aClass70_48.method1261()) {
			local7[local1++] = local13.method7280();
		}
		this.YA(local7);
		for (@Pc(34) int local34 = 0; local34 < arg2 + arg2; local34++) {
			for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
				if (arg3[local34][local37]) {
					...
					if (local50 >= 0 && local50 < super.anInt9572 && local56 >= 0 && local56 < super.anInt9574) {
						this.method7682(local50, local56);
					}
				}
			}
		}
	...
	public native void E(@OriginalArg(0) Class2_Sub2_Sub8 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method7677(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aL2.method4237().la(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
