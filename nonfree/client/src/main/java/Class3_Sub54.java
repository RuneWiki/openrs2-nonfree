...
public final class Class3_Sub54 extends Class3 {
	...
	public Class3_Sub54(@OriginalArg(0) byte[] arg0) {
		this.method8935(arg0);
	}

	@OriginalMember(owner = "client!wm", name = "a", descriptor = "([I)Lclient!pv;")
	public Class3_Sub39_Sub1 method8927(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray108 == null) {
			this.anInt10840 = 0;
			this.aFloatArray70 = new float[Static670.anInt10833];
			this.aByteArray108 = new byte[this.anInt10838];
			this.anInt10842 = 0;
			this.anInt10841 = 0;
		}
		while (this.anInt10841 < this.aByteArrayArray28.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method8934(this.anInt10841);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt10842;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt10838 - local47) {
					local50 = this.anInt10838 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray108[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt10842;
				}
				this.anInt10842 = local47;
			}
			this.anInt10841++;
		}
		this.aFloatArray70 = null;
		@Pc(129) byte[] local129 = this.aByteArray108;
		this.aByteArray108 = null;
		return new Class3_Sub39_Sub1(this.anInt10835, local129, this.anInt10834, this.anInt10831, this.aBoolean748);
	}

	@OriginalMember(owner = "client!wm", name = "b", descriptor = "(I)[F")
	private float[] method8934(@OriginalArg(0) int arg0) {
		Static670.method8926(this.aByteArrayArray28[arg0]);
		Static670.method8929();
		@Pc(15) int local15 = Static670.method8936(Static407.method5605(Static670.anIntArray626.length - 1));
		@Pc(19) boolean local19 = Static670.aBooleanArray31[local15];
		@Pc(25) int local25 = local19 ? Static670.anInt10833 : Static670.anInt10832;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static670.method8929() != 0;
			local29 = Static670.method8929() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static670.anInt10832 >> 2);
			local67 = (local25 >> 2) + (Static670.anInt10832 >> 2);
			local71 = Static670.anInt10832 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static670.anInt10832 >> 2);
			local104 = local25 + (Static670.anInt10832 >> 2) - (local25 >> 2);
			local108 = Static670.anInt10832 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class331 local123 = Static670.aClass331Array1[Static670.anIntArray626[local15]];
		@Pc(126) int local126 = local123.anInt9157;
		@Pc(131) int local131 = local123.anIntArray481[local126];
		@Pc(140) boolean local140 = !Static670.aClass374Array1[local131].method8673();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt9156; local144++) {
			@Pc(152) Class101 local152 = Static670.aClass101Array1[local123.anIntArray480[local144]];
			local154 = Static670.aFloatArray72;
			local152.method2313(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt9157;
			local176 = local123.anIntArray481[local171];
			Static670.aClass374Array1[local176].method8674(Static670.aFloatArray72, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static670.aFloatArray72[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static670.aFloatArray72;
			...
			@Pc(252) float[] local252 = local19 ? Static670.aFloatArray74 : Static670.aFloatArray73;
			@Pc(258) float[] local258 = local19 ? Static670.aFloatArray77 : Static670.aFloatArray76;
			@Pc(264) float[] local264 = local19 ? Static670.aFloatArray71 : Static670.aFloatArray75;
			@Pc(270) int[] local270 = local19 ? Static670.anIntArray627 : Static670.anIntArray625;
			...
			@Pc(486) int local486 = Static407.method5605(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static670.aFloatArray72[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static670.aFloatArray72[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt10840 > 0) {
			local176 = this.anInt10840 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean749) {
				for (local212 = 0; local212 < this.anInt10836; local212++) {
					local1254 = (this.anInt10840 >> 1) + local212;
					local1228[local212] += this.aFloatArray70[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static670.aFloatArray72[local212];
				}
			}
		}
		local154 = this.aFloatArray70;
		this.aFloatArray70 = Static670.aFloatArray72;
		Static670.aFloatArray72 = local154;
		this.anInt10840 = local25;
		this.anInt10836 = local104 - (local25 >> 1);
		this.aBoolean749 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!wm", name = "b", descriptor = "([B)V")
	private void method8935(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class3_Sub4 local4 = new Class3_Sub4(arg0);
		this.anInt10835 = local4.method7895();
		this.anInt10838 = local4.method7895();
		this.anInt10834 = local4.method7895();
		this.anInt10831 = local4.method7895();
		if (this.anInt10831 < 0) {
			this.anInt10831 = ~this.anInt10831;
			this.aBoolean748 = true;
		}
		@Pc(40) int local40 = local4.method7895();
		this.aByteArrayArray28 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method7954();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method7958(0, local64, local49);
