...
public final class Class38 {
	...
	public static int method575(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(3) Class41 local3 = aClass41_1;
		synchronized (aClass41_1) {
			aClass41_1.aByteArray11 = arg2;
			aClass41_1.anInt910 = arg4;
			aClass41_1.aByteArray12 = arg0;
			aClass41_1.anInt914 = 0;
			aClass41_1.anInt911 = arg3;
			aClass41_1.anInt915 = arg1;
			aClass41_1.anInt920 = 0;
			aClass41_1.anInt919 = 0;
			aClass41_1.anInt912 = 0;
			aClass41_1.anInt913 = 0;
			aClass41_1.anInt916 = 0;
			aClass41_1.anInt917 = 0;
			aClass41_1.anInt922 = 0;
			method577(aClass41_1);
			return arg1 - aClass41_1.anInt915;
		}
	}

	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lclient!sb;)V")
	private static void method576(@OriginalArg(0) Class41 arg0) {
		@Pc(4) byte local4 = arg0.aByte25;
		@Pc(7) int local7 = arg0.anInt918;
		@Pc(10) int local10 = arg0.anInt926;
		@Pc(13) int local13 = arg0.anInt925;
		@Pc(15) int[] local15 = Class41.anIntArray248;
		@Pc(18) int local18 = arg0.anInt924;
		@Pc(21) byte[] local21 = arg0.aByteArray12;
		@Pc(24) int local24 = arg0.anInt914;
		@Pc(27) int local27 = arg0.anInt915;
		@Pc(29) int local29 = local27;
		@Pc(34) int local34 = arg0.anInt928 + 1;
		label67: while (true) {
			if (local7 > 0) {
				while (true) {
					if (local27 == 0) {
		...
		@Pc(224) int local224 = arg0.anInt916;
		arg0.anInt916 += local29 - local27;
		if (arg0.anInt916 < local224) {
			arg0.anInt917++;
		}
		arg0.aByte25 = local4;
		arg0.anInt918 = local7;
		arg0.anInt926 = local10;
		arg0.anInt925 = local13;
		Class41.anIntArray248 = local15;
		arg0.anInt924 = local18;
		arg0.aByteArray12 = local21;
		arg0.anInt914 = local24;
		arg0.anInt915 = local27;
	}

	@OriginalMember(owner = "client!rb", name = "b", descriptor = "(Lclient!sb;)V")
	private static void method577(@OriginalArg(0) Class41 arg0) {
		arg0.anInt921 = 1;
		if (Class41.anIntArray248 == null) {
			Class41.anIntArray248 = new int[arg0.anInt921 * 100000];
		}
		@Pc(60) boolean local60 = true;
		while (true) {
			while (local60) {
				@Pc(64) byte local64 = method578(arg0);
				if (local64 == 23) {
					return;
				}
				local64 = method578(arg0);
				local64 = method578(arg0);
				local64 = method578(arg0);
				local64 = method578(arg0);
				local64 = method578(arg0);
				...
				local64 = method578(arg0);
				local64 = method578(arg0);
				local64 = method579(arg0);
				if (local64 == 0) {
					arg0.aBoolean226 = false;
				} else {
					arg0.aBoolean226 = true;
				}
				if (arg0.aBoolean226) {
				...
				arg0.anInt923 = 0;
				local64 = method578(arg0);
				arg0.anInt923 = arg0.anInt923 << 8 | local64 & 0xFF;
				local64 = method578(arg0);
				arg0.anInt923 = arg0.anInt923 << 8 | local64 & 0xFF;
				local64 = method578(arg0);
				arg0.anInt923 = arg0.anInt923 << 8 | local64 & 0xFF;
				...
				method581(arg0);
				@Pc(244) int local244 = arg0.anInt927 + 2;
				@Pc(248) int local248 = method580(3, arg0);
				@Pc(252) int local252 = method580(15, arg0);
				...
				for (local340 = 0; local340 < local248; local340++) {
					@Pc(346) int local346 = method580(5, arg0);
				...
				for (local340 = 0; local340 < local248; local340++) {
					...
					method582(arg0.anIntArrayArray21[local340], arg0.anIntArrayArray22[local340], arg0.anIntArrayArray23[local340], arg0.aByteArrayArray4[local340], local388, local390, local244);
					arg0.anIntArray250[local340] = local388;
				}
				@Pc(462) int local462 = arg0.anInt927 + 1;
				@Pc(467) int local467 = arg0.anInt921 * 100000;
				...
				for (local557 = method580(local535, arg0); local557 > local540[local553]; local557 = local557 << 1 | local566) {
					local553++;
					local566 = method579(arg0);
				}
				...
				while (true) {
					...
					arg0.anInt924 = Class41.anIntArray248[arg0.anInt923] >> 8;
					arg0.anInt926 = 0;
					arg0.anInt924 = Class41.anIntArray248[arg0.anInt924];
					arg0.anInt925 = (byte) (arg0.anInt924 & 0xFF);
					arg0.anInt924 >>= 0x8;
					arg0.anInt926++;
					arg0.anInt928 = local520;
					method576(arg0);
					if (arg0.anInt926 == arg0.anInt928 + 1 && arg0.anInt918 == 0) {
						local60 = true;
						break;
					}
					local60 = false;
	...
	private static byte method578(@OriginalArg(0) Class41 arg0) {
		return (byte) method580(8, arg0);
	}

	@OriginalMember(owner = "client!rb", name = "d", descriptor = "(Lclient!sb;)B")
	private static byte method579(@OriginalArg(0) Class41 arg0) {
		return (byte) method580(1, arg0);
	}

	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILclient!sb;)I")
	private static int method580(@OriginalArg(0) int arg0, @OriginalArg(1) Class41 arg1) {
		while (arg1.anInt920 < arg0) {
			arg1.anInt919 = arg1.anInt919 << 8 | arg1.aByteArray11[arg1.anInt910] & 0xFF;
			arg1.anInt920 += 8;
			arg1.anInt910++;
			arg1.anInt911--;
			arg1.anInt912++;
		...
		@Pc(17) int local17 = arg1.anInt919 >> arg1.anInt920 - arg0 & (0x1 << arg0) - 1;
		arg1.anInt920 -= arg0;
		return local17;
	}

	@OriginalMember(owner = "client!rb", name = "e", descriptor = "(Lclient!sb;)V")
	private static void method581(@OriginalArg(0) Class41 arg0) {
		arg0.anInt927 = 0;
		for (@Pc(4) int local4 = 0; local4 < 256; local4++) {
			if (arg0.aBooleanArray10[local4]) {
				arg0.aByteArray13[arg0.anInt927] = (byte) local4;
				arg0.anInt927++;
			}
		}
	}
	...
	private static void method582(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) byte[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(3) int local3 = 0;
		@Pc(5) int local5;
