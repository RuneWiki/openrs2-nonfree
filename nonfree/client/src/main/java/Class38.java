...
public final class Class38 {
	...
	public static int method573(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(1) Class41 local1 = aClass41_1;
		synchronized (aClass41_1) {
			aClass41_1.aByteArray11 = arg2;
			aClass41_1.anInt883 = arg4;
			aClass41_1.aByteArray12 = arg0;
			aClass41_1.anInt887 = 0;
			aClass41_1.anInt884 = arg3;
			aClass41_1.anInt888 = arg1;
			aClass41_1.anInt893 = 0;
			aClass41_1.anInt892 = 0;
			aClass41_1.anInt885 = 0;
			aClass41_1.anInt886 = 0;
			aClass41_1.anInt889 = 0;
			aClass41_1.anInt890 = 0;
			aClass41_1.anInt895 = 0;
			method575(aClass41_1);
			return arg1 - aClass41_1.anInt888;
		}
	}

	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lclient!sb;)V")
	private static void method574(@OriginalArg(0) Class41 arg0) {
		@Pc(4) byte local4 = arg0.aByte33;
		@Pc(7) int local7 = arg0.anInt891;
		@Pc(10) int local10 = arg0.anInt899;
		@Pc(13) int local13 = arg0.anInt898;
		@Pc(15) int[] local15 = Class41.anIntArray248;
		@Pc(18) int local18 = arg0.anInt897;
		@Pc(21) byte[] local21 = arg0.aByteArray12;
		@Pc(24) int local24 = arg0.anInt887;
		@Pc(27) int local27 = arg0.anInt888;
		@Pc(29) int local29 = local27;
		@Pc(34) int local34 = arg0.anInt901 + 1;
		label67: while (true) {
			if (local7 > 0) {
				while (true) {
					if (local27 == 0) {
		...
		@Pc(224) int local224 = arg0.anInt889;
		arg0.anInt889 += local29 - local27;
		if (arg0.anInt889 < local224) {
			arg0.anInt890++;
		}
		arg0.aByte33 = local4;
		arg0.anInt891 = local7;
		arg0.anInt899 = local10;
		arg0.anInt898 = local13;
		Class41.anIntArray248 = local15;
		arg0.anInt897 = local18;
		arg0.aByteArray12 = local21;
		arg0.anInt887 = local24;
		arg0.anInt888 = local27;
	}

	@OriginalMember(owner = "client!rb", name = "b", descriptor = "(Lclient!sb;)V")
	private static void method575(@OriginalArg(0) Class41 arg0) {
		arg0.anInt894 = 1;
		if (Class41.anIntArray248 == null) {
			Class41.anIntArray248 = new int[arg0.anInt894 * 100000];
		}
		@Pc(60) boolean local60 = true;
		while (true) {
			while (local60) {
				@Pc(64) byte local64 = method576(arg0);
				if (local64 == 23) {
					return;
				}
				local64 = method576(arg0);
				local64 = method576(arg0);
				local64 = method576(arg0);
				local64 = method576(arg0);
				local64 = method576(arg0);
				...
				local64 = method576(arg0);
				local64 = method576(arg0);
				local64 = method577(arg0);
				if (local64 == 0) {
					arg0.aBoolean237 = false;
				} else {
					arg0.aBoolean237 = true;
				}
				if (arg0.aBoolean237) {
				...
				arg0.anInt896 = 0;
				local64 = method576(arg0);
				arg0.anInt896 = arg0.anInt896 << 8 | local64 & 0xFF;
				local64 = method576(arg0);
				arg0.anInt896 = arg0.anInt896 << 8 | local64 & 0xFF;
				local64 = method576(arg0);
				arg0.anInt896 = arg0.anInt896 << 8 | local64 & 0xFF;
				...
				method579(arg0);
				@Pc(244) int local244 = arg0.anInt900 + 2;
				@Pc(248) int local248 = method578(3, arg0);
				@Pc(252) int local252 = method578(15, arg0);
				...
				for (local340 = 0; local340 < local248; local340++) {
					@Pc(346) int local346 = method578(5, arg0);
				...
				for (local340 = 0; local340 < local248; local340++) {
					...
					method580(arg0.anIntArrayArray21[local340], arg0.anIntArrayArray22[local340], arg0.anIntArrayArray23[local340], arg0.aByteArrayArray4[local340], local388, local390, local244);
					arg0.anIntArray250[local340] = local388;
				}
				@Pc(462) int local462 = arg0.anInt900 + 1;
				@Pc(467) int local467 = arg0.anInt894 * 100000;
				@Pc(469) byte local469 = -1;
				for (local164 = 0; local164 <= 255; local164++) {
					arg0.anIntArray245[local164] = 0;
				}
				...
				for (local557 = method578(local535, arg0); local557 > local540[local553]; local557 = local557 << 1 | local566) {
					local553++;
					local566 = method577(arg0);
				}
				...
				while (true) {
						...
						if (local582 == 0 || local582 == 1) {
							...
							do {
								...
								if (local551 == 0) {
									...
									local535 = arg0.anIntArray250[local530];
							...
							local592++;
							local64 = arg0.aByteArray13[arg0.aByteArray14[arg0.anIntArray249[0]] & 0xFF];
							arg0.anIntArray245[local64 & 0xFF] += local592;
							while (local592 > 0) {
								Class41.anIntArray248[local520] = local64 & 0xFF;
								local520++;
								local592--;
							}
						} else {
							...
							if (local724 < 16) {
								...
								local732 = arg0.anIntArray249[local825] + local829;
								local64 = arg0.aByteArray14[local732];
								while (local732 > arg0.anIntArray249[local825]) {
									arg0.aByteArray14[local732] = arg0.aByteArray14[local732 - 1];
									local732--;
								}
								@Pc(865) int local865 = arg0.anIntArray249[local825]++;
								while (local825 > 0) {
									local865 = arg0.anIntArray249[local825]--;
									arg0.aByteArray14[arg0.anIntArray249[local825]] = arg0.aByteArray14[arg0.anIntArray249[local825 - 1] + 16 - 1];
									local825--;
								}
								local865 = arg0.anIntArray249[0]--;
								arg0.aByteArray14[arg0.anIntArray249[0]] = local64;
								if (arg0.anIntArray249[0] == 0) {
									...
									for (@Pc(926) int local926 = 15; local926 >= 0; local926--) {
										for (@Pc(930) int local930 = 15; local930 >= 0; local930--) {
											arg0.aByteArray14[local924] = arg0.aByteArray14[arg0.anIntArray249[local926] + local930];
											local924--;
										}
										arg0.anIntArray249[local926] = local924 + 1;
									}
								}
							}
							arg0.anIntArray245[arg0.aByteArray13[local64 & 0xFF] & 0xFF]++;
							Class41.anIntArray248[local520] = arg0.aByteArray13[local64 & 0xFF] & 0xFF;
							local520++;
							if (local551 == 0) {
								local523++;
								local551 = 50;
					...
					for (local164 = 1; local164 <= 256; local164++) {
						arg0.anIntArray246[local164] = arg0.anIntArray245[local164 - 1];
					}
					for (local164 = 1; local164 <= 256; local164++) {
						arg0.anIntArray246[local164] += arg0.anIntArray246[local164 - 1];
					}
					for (local164 = 0; local164 < local520; local164++) {
						local64 = (byte) (Class41.anIntArray248[local164] & 0xFF);
						Class41.anIntArray248[arg0.anIntArray246[local64 & 0xFF]] |= local164 << 8;
						arg0.anIntArray246[local64 & 0xFF]++;
					}
					arg0.anInt897 = Class41.anIntArray248[arg0.anInt896] >> 8;
					arg0.anInt899 = 0;
					arg0.anInt897 = Class41.anIntArray248[arg0.anInt897];
					arg0.anInt898 = (byte) (arg0.anInt897 & 0xFF);
					arg0.anInt897 >>= 0x8;
					arg0.anInt899++;
					arg0.anInt901 = local520;
					method574(arg0);
					if (arg0.anInt899 == arg0.anInt901 + 1 && arg0.anInt891 == 0) {
						local60 = true;
						break;
					}
					local60 = false;
	...
	private static byte method576(@OriginalArg(0) Class41 arg0) {
		return (byte) method578(8, arg0);
	}

	@OriginalMember(owner = "client!rb", name = "d", descriptor = "(Lclient!sb;)B")
	private static byte method577(@OriginalArg(0) Class41 arg0) {
		return (byte) method578(1, arg0);
	}

	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILclient!sb;)I")
	private static int method578(@OriginalArg(0) int arg0, @OriginalArg(1) Class41 arg1) {
		while (arg1.anInt893 < arg0) {
			arg1.anInt892 = arg1.anInt892 << 8 | arg1.aByteArray11[arg1.anInt883] & 0xFF;
			arg1.anInt893 += 8;
			arg1.anInt883++;
			arg1.anInt884--;
			arg1.anInt885++;
		...
		@Pc(17) int local17 = arg1.anInt892 >> arg1.anInt893 - arg0 & (0x1 << arg0) - 1;
		arg1.anInt893 -= arg0;
		return local17;
	}

	@OriginalMember(owner = "client!rb", name = "e", descriptor = "(Lclient!sb;)V")
	private static void method579(@OriginalArg(0) Class41 arg0) {
		arg0.anInt900 = 0;
		for (@Pc(4) int local4 = 0; local4 < 256; local4++) {
			if (arg0.aBooleanArray10[local4]) {
				arg0.aByteArray13[arg0.anInt900] = (byte) local4;
				arg0.anInt900++;
			}
		}
	}
	...
	private static void method580(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) byte[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(3) int local3 = 0;
		@Pc(5) int local5;
