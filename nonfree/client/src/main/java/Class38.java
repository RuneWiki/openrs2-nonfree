...
public final class Class38 {
	...
	public static int method574(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(1) Class41 local1 = aClass41_1;
		synchronized (aClass41_1) {
			aClass41_1.aByteArray11 = arg2;
			aClass41_1.anInt907 = arg4;
			aClass41_1.aByteArray12 = arg0;
			aClass41_1.anInt911 = 0;
			aClass41_1.anInt908 = arg3;
			aClass41_1.anInt912 = arg1;
			...
			method576(aClass41_1);
			return arg1 - aClass41_1.anInt912;
		}
	}

	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lclient!sb;)V")
	private static void method575(@OriginalArg(0) Class41 arg0) {
		@Pc(4) byte local4 = arg0.aByte42;
		@Pc(7) int local7 = arg0.anInt915;
		@Pc(10) int local10 = arg0.anInt923;
		@Pc(13) int local13 = arg0.anInt922;
		@Pc(15) int[] local15 = Class41.anIntArray248;
		@Pc(18) int local18 = arg0.anInt921;
		@Pc(21) byte[] local21 = arg0.aByteArray12;
		@Pc(24) int local24 = arg0.anInt911;
		@Pc(27) int local27 = arg0.anInt912;
		@Pc(29) int local29 = local27;
		@Pc(34) int local34 = arg0.anInt925 + 1;
		label67: while (true) {
			if (local7 > 0) {
				while (true) {
					if (local27 == 0) {
		...
		@Pc(224) int local224 = arg0.anInt913;
		arg0.anInt913 += local29 - local27;
		if (arg0.anInt913 < local224) {
			arg0.anInt914++;
		}
		arg0.aByte42 = local4;
		arg0.anInt915 = local7;
		arg0.anInt923 = local10;
		arg0.anInt922 = local13;
		Class41.anIntArray248 = local15;
		arg0.anInt921 = local18;
		arg0.aByteArray12 = local21;
		arg0.anInt911 = local24;
		arg0.anInt912 = local27;
	}
	...
	private static void method576(@OriginalArg(0) Class41 arg0) {
		...
		if (Class41.anIntArray248 == null) {
			Class41.anIntArray248 = new int[arg0.anInt918 * 100000];
		}
		@Pc(60) boolean local60 = true;
		while (true) {
			while (local60) {
				@Pc(64) byte local64 = method577(arg0);
				if (local64 == 23) {
					return;
				}
				...
				arg0.anInt920 = 0;
				local64 = method577(arg0);
				arg0.anInt920 = arg0.anInt920 << 8 | local64 & 0xFF;
				local64 = method577(arg0);
				arg0.anInt920 = arg0.anInt920 << 8 | local64 & 0xFF;
				local64 = method577(arg0);
				arg0.anInt920 = arg0.anInt920 << 8 | local64 & 0xFF;
				...
				method580(arg0);
				@Pc(244) int local244 = arg0.anInt924 + 2;
				@Pc(248) int local248 = method579(3, arg0);
				@Pc(252) int local252 = method579(15, arg0);
				...
				for (local340 = 0; local340 < local248; local340++) {
					@Pc(346) int local346 = method579(5, arg0);
				...
				for (local340 = 0; local340 < local248; local340++) {
					...
					method581(arg0.anIntArrayArray21[local340], arg0.anIntArrayArray22[local340], arg0.anIntArrayArray23[local340], arg0.aByteArrayArray4[local340], local388, local390, local244);
					arg0.anIntArray250[local340] = local388;
				}
				@Pc(462) int local462 = arg0.anInt924 + 1;
				@Pc(467) int local467 = arg0.anInt918 * 100000;
				...
				for (local557 = method579(local535, arg0); local557 > local540[local553]; local557 = local557 << 1 | local566) {
					local553++;
					local566 = method578(arg0);
				}
				...
				while (true) {
					...
					arg0.anInt921 = Class41.anIntArray248[arg0.anInt920] >> 8;
					arg0.anInt923 = 0;
					arg0.anInt921 = Class41.anIntArray248[arg0.anInt921];
					arg0.anInt922 = (byte) (arg0.anInt921 & 0xFF);
					arg0.anInt921 >>= 0x8;
					arg0.anInt923++;
					arg0.anInt925 = local520;
					method575(arg0);
					if (arg0.anInt923 == arg0.anInt925 + 1 && arg0.anInt915 == 0) {
						local60 = true;
						break;
					}
					local60 = false;
	...
	private static int method579(@OriginalArg(0) int arg0, @OriginalArg(1) Class41 arg1) {
		while (arg1.anInt917 < arg0) {
			arg1.anInt916 = arg1.anInt916 << 8 | arg1.aByteArray11[arg1.anInt907] & 0xFF;
			arg1.anInt917 += 8;
			arg1.anInt907++;
			arg1.anInt908--;
			arg1.anInt909++;
		...
		@Pc(17) int local17 = arg1.anInt916 >> arg1.anInt917 - arg0 & (0x1 << arg0) - 1;
		arg1.anInt917 -= arg0;
		return local17;
	}

	@OriginalMember(owner = "client!rb", name = "e", descriptor = "(Lclient!sb;)V")
	private static void method580(@OriginalArg(0) Class41 arg0) {
		arg0.anInt924 = 0;
		for (@Pc(4) int local4 = 0; local4 < 256; local4++) {
			if (arg0.aBooleanArray10[local4]) {
				arg0.aByteArray13[arg0.anInt924] = (byte) local4;
				arg0.anInt924++;
			}
		}
	}
	...
	private static void method581(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) byte[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(3) int local3 = 0;
		@Pc(5) int local5;
