...
public final class Class38 {
	...
	public Class38(@OriginalArg(0) byte arg0, @OriginalArg(1) int[] arg1) {
		try {
			...
			signlink.reporterror("61395, " + arg0 + ", " + arg1 + ", " + local41.toString());
	...
	public int method512() {
		...
		return this.anIntArray219[this.anInt744];
	}

	@OriginalMember(owner = "client!tb", name = "b", descriptor = "()V")
	private void method513() {
		this.anInt746 += ++this.anInt747;
		for (@Pc(15) int local15 = 0; local15 < 256; local15++) {
			@Pc(22) int local22 = this.anIntArray220[local15];
			switch(local15 & 0x3) {
				case 0:
					this.anInt745 ^= this.anInt745 << 13;
					break;
				case 1:
					this.anInt745 ^= this.anInt745 >>> 6;
					break;
				case 2:
					this.anInt745 ^= this.anInt745 << 2;
					break;
				case 3:
					this.anInt745 ^= this.anInt745 >>> 16;
			}
			this.anInt745 += this.anIntArray220[local15 + 128 & 0xFF];
			@Pc(101) int local101;
			this.anIntArray220[local15] = local101 = this.anIntArray220[local22 >> 2 & 0xFF] + this.anInt745 + this.anInt746;
			this.anIntArray219[local15] = this.anInt746 = this.anIntArray220[local101 >> 8 >> 2 & 0xFF] + local22;
		}
	}
