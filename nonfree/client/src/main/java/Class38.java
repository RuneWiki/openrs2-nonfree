...
public abstract class Class38 {
	...
	public final void method7454(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Class84 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		this.method7458(arg0, arg1, (float) this.A() / 2.0F, (float) this.ca() / 2.0F, 4096, arg2, arg3, arg4, arg5);
	}
	...
	public final void method7455(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4) {
		this.method7462(arg0, arg1, (float) this.A() / 2.0F, (float) this.ca() / 2.0F, arg2, arg3, 0, arg4);
	}

	@OriginalMember(owner = "client!f", name = "a", descriptor = "(FFII)V")
	public final void method7456(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.method7462(arg0, arg1, (float) this.A() / 2.0F, (float) this.ca() / 2.0F, arg2, arg3, 1, 0);
	}

	@OriginalMember(owner = "client!f", name = "a", descriptor = "(IIII)V")
	public final void method7457(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	public final void method7458(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class84 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		if (arg4 == 0) {
			return;
		}
		...
		this.method7459(local37, local50, local67, local85, local102, local118, arg6, arg7, arg8);
	}

	@OriginalMember(owner = "client!f", name = "a", descriptor = "(FFFFFFLclient!ua;II)V")
	private void method7459(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) Class84 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		this.method7465(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
	}

	@OriginalMember(owner = "client!f", name = "a", descriptor = "(FFFFFFIII)V")
	private void method7460(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
	...
	private void method7462(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg4 == 0) {
			return;
		}
		@Pc(9) double local9 = (double) (arg5 & 0xFFFF) * 9.587379924285257E-5D;
		...
		@Pc(102) float local102 = (-arg2 * local23 + ((float) this.ca() - arg3) * local16) / 4096.0F + arg0;
		@Pc(118) float local118 = (arg2 * local16 + ((float) this.ca() - arg3) * local23) / 4096.0F + arg1;
		this.method7460(local37, local50, local67, local85, local102, local118, arg6, arg7);
	}
	...
	public final void method7463(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	protected abstract void method7465(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(7) Class84 arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8);

	@OriginalMember(owner = "client!f", name = "b", descriptor = "(IIII)V")
	public final void method7466(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
