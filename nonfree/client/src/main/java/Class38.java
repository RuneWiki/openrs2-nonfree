...
public final class Class38 {
	...
	public static int method581(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		synchronized (aClass41_1) {
			...
			aClass41_1.anInt925 = arg4;
			aClass41_1.aByteArray12 = arg0;
			aClass41_1.anInt929 = 0;
			aClass41_1.anInt926 = arg3;
			aClass41_1.anInt930 = arg1;
			aClass41_1.anInt935 = 0;
			aClass41_1.anInt934 = 0;
			aClass41_1.anInt927 = 0;
			aClass41_1.anInt928 = 0;
			aClass41_1.anInt931 = 0;
			aClass41_1.anInt932 = 0;
			aClass41_1.anInt937 = 0;
			method583(aClass41_1);
			return arg1 - aClass41_1.anInt930;
		}
	}

	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lclient!sb;)V")
	private static void method582(@OriginalArg(0) Class41 arg0) {
		@Pc(4) byte local4 = arg0.aByte54;
		@Pc(7) int local7 = arg0.anInt933;
		@Pc(10) int local10 = arg0.anInt941;
		@Pc(13) int local13 = arg0.anInt940;
		@Pc(15) int[] local15 = Class41.anIntArray251;
		@Pc(18) int local18 = arg0.anInt939;
		@Pc(21) byte[] local21 = arg0.aByteArray12;
		@Pc(24) int local24 = arg0.anInt929;
		@Pc(27) int local27 = arg0.anInt930;
		@Pc(29) int local29 = local27;
		@Pc(34) int local34 = arg0.anInt943 + 1;
		label67: while (true) {
			if (local7 > 0) {
				while (true) {
					if (local27 == 0) {
		...
		@Pc(224) int local224 = arg0.anInt931;
		arg0.anInt931 += local29 - local27;
		if (arg0.anInt931 < local224) {
			arg0.anInt932++;
		}
		arg0.aByte54 = local4;
		arg0.anInt933 = local7;
		arg0.anInt941 = local10;
		arg0.anInt940 = local13;
		Class41.anIntArray251 = local15;
		arg0.anInt939 = local18;
		arg0.aByteArray12 = local21;
		arg0.anInt929 = local24;
		arg0.anInt930 = local27;
	}
	...
	private static void method583(@OriginalArg(0) Class41 arg0) {
		...
		if (Class41.anIntArray251 == null) {
			Class41.anIntArray251 = new int[arg0.anInt936 * 100000];
		}
		...
		while (true) {
			while (local60) {
				...
				arg0.anInt938 = 0;
				local64 = method584(arg0);
				arg0.anInt938 = arg0.anInt938 << 8 | local64 & 0xFF;
				local64 = method584(arg0);
				arg0.anInt938 = arg0.anInt938 << 8 | local64 & 0xFF;
				local64 = method584(arg0);
				arg0.anInt938 = arg0.anInt938 << 8 | local64 & 0xFF;
				...
				method587(arg0);
				@Pc(244) int local244 = arg0.anInt942 + 2;
				...
				@Pc(462) int local462 = arg0.anInt942 + 1;
				@Pc(467) int local467 = arg0.anInt936 * 100000;
				...
				while (true) {
					...
					arg0.anInt939 = Class41.anIntArray251[arg0.anInt938] >> 8;
					arg0.anInt941 = 0;
					arg0.anInt939 = Class41.anIntArray251[arg0.anInt939];
					arg0.anInt940 = (byte) (arg0.anInt939 & 0xFF);
					arg0.anInt939 >>= 0x8;
					arg0.anInt941++;
					arg0.anInt943 = local520;
					method582(arg0);
					if (arg0.anInt941 == arg0.anInt943 + 1 && arg0.anInt933 == 0) {
						local60 = true;
						break;
					}
					local60 = false;
	...
	private static int method586(@OriginalArg(0) int arg0, @OriginalArg(1) Class41 arg1) {
		while (arg1.anInt935 < arg0) {
			arg1.anInt934 = arg1.anInt934 << 8 | arg1.aByteArray11[arg1.anInt925] & 0xFF;
			arg1.anInt935 += 8;
			arg1.anInt925++;
			arg1.anInt926--;
			arg1.anInt927++;
		...
		@Pc(17) int local17 = arg1.anInt934 >> arg1.anInt935 - arg0 & (0x1 << arg0) - 1;
		arg1.anInt935 -= arg0;
		return local17;
	}
	...
	private static void method587(@OriginalArg(0) Class41 arg0) {
		...
		for (@Pc(4) int local4 = 0; local4 < 256; local4++) {
			if (arg0.aBooleanArray10[local4]) {
				arg0.aByteArray13[arg0.anInt942] = (byte) local4;
				arg0.anInt942++;
			}
		}
	}
