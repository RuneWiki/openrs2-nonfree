...
public final class Class38 {
	...
	public Class38(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1) {
		try {
			...
			for (@Pc(14) int local14 = 0; local14 < arg0.length; local14++) {
				this.anIntArray219[local14] = arg0[local14];
			}
			...
			signlink.reporterror("21600, " + arg0 + ", " + arg1 + ", " + local40.toString());
	...
	public int method524() {
		...
		return this.anIntArray219[this.anInt752];
	}

	@OriginalMember(owner = "client!tb", name = "b", descriptor = "()V")
	private void method525() {
		this.anInt754 += ++this.anInt755;
		for (@Pc(15) int local15 = 0; local15 < 256; local15++) {
			@Pc(22) int local22 = this.anIntArray220[local15];
			switch(local15 & 0x3) {
				case 0:
					this.anInt753 ^= this.anInt753 << 13;
					break;
				case 1:
					this.anInt753 ^= this.anInt753 >>> 6;
					break;
				case 2:
					this.anInt753 ^= this.anInt753 << 2;
					break;
				case 3:
					this.anInt753 ^= this.anInt753 >>> 16;
			}
			this.anInt753 += this.anIntArray220[local15 + 128 & 0xFF];
			@Pc(101) int local101;
			this.anIntArray220[local15] = local101 = this.anIntArray220[local22 >> 2 & 0xFF] + this.anInt753 + this.anInt754;
			this.anIntArray219[local15] = this.anInt754 = this.anIntArray220[local101 >> 8 >> 2 & 0xFF] + local22;
		}
	}
