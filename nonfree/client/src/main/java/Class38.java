...
public final class Class38 {
	...
	public static int method600(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(3) Class40 local3 = aClass40_1;
		synchronized (aClass40_1) {
			aClass40_1.aByteArray11 = arg2;
			aClass40_1.anInt939 = arg4;
			aClass40_1.aByteArray12 = arg0;
			aClass40_1.anInt943 = 0;
			aClass40_1.anInt940 = arg3;
			aClass40_1.anInt944 = arg1;
			aClass40_1.anInt949 = 0;
			aClass40_1.anInt948 = 0;
			aClass40_1.anInt941 = 0;
			aClass40_1.anInt942 = 0;
			aClass40_1.anInt945 = 0;
			aClass40_1.anInt946 = 0;
			aClass40_1.anInt951 = 0;
			method602(aClass40_1);
			return arg1 - aClass40_1.anInt944;
		}
	}

	@OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lclient!tb;)V")
	private static void method601(@OriginalArg(0) Class40 arg0) {
		@Pc(4) byte local4 = arg0.aByte27;
		@Pc(7) int local7 = arg0.anInt947;
		@Pc(10) int local10 = arg0.anInt955;
		@Pc(13) int local13 = arg0.anInt954;
		@Pc(15) int[] local15 = Class40.anIntArray243;
		@Pc(18) int local18 = arg0.anInt953;
		@Pc(21) byte[] local21 = arg0.aByteArray12;
		@Pc(24) int local24 = arg0.anInt943;
		@Pc(27) int local27 = arg0.anInt944;
		@Pc(29) int local29 = local27;
		@Pc(34) int local34 = arg0.anInt957 + 1;
		label67: while (true) {
			if (local7 > 0) {
				while (true) {
					if (local27 == 0) {
		...
		@Pc(224) int local224 = arg0.anInt945;
		arg0.anInt945 += local29 - local27;
		if (arg0.anInt945 < local224) {
			arg0.anInt946++;
		}
		arg0.aByte27 = local4;
		arg0.anInt947 = local7;
		arg0.anInt955 = local10;
		arg0.anInt954 = local13;
		Class40.anIntArray243 = local15;
		arg0.anInt953 = local18;
		arg0.aByteArray12 = local21;
		arg0.anInt943 = local24;
		arg0.anInt944 = local27;
	}
	...
	private static void method602(@OriginalArg(0) Class40 arg0) {
		...
		if (Class40.anIntArray243 == null) {
			Class40.anIntArray243 = new int[arg0.anInt950 * 100000];
		}
		@Pc(60) boolean local60 = true;
		while (true) {
			while (local60) {
				@Pc(64) byte local64 = method603(arg0);
				if (local64 == 23) {
					return;
				}
				local64 = method603(arg0);
				local64 = method603(arg0);
				local64 = method603(arg0);
				local64 = method603(arg0);
				local64 = method603(arg0);
				...
				arg0.anInt952 = 0;
				local64 = method603(arg0);
				arg0.anInt952 = arg0.anInt952 << 8 | local64 & 0xFF;
				local64 = method603(arg0);
				arg0.anInt952 = arg0.anInt952 << 8 | local64 & 0xFF;
				local64 = method603(arg0);
				arg0.anInt952 = arg0.anInt952 << 8 | local64 & 0xFF;
				...
				method606(arg0);
				@Pc(244) int local244 = arg0.anInt956 + 2;
				@Pc(248) int local248 = method605(3, arg0);
				@Pc(252) int local252 = method605(15, arg0);
				...
				for (local340 = 0; local340 < local248; local340++) {
					@Pc(346) int local346 = method605(5, arg0);
				...
				for (local340 = 0; local340 < local248; local340++) {
					...
					method607(arg0.anIntArrayArray20[local340], arg0.anIntArrayArray21[local340], arg0.anIntArrayArray22[local340], arg0.aByteArrayArray4[local340], local388, local390, local244);
					arg0.anIntArray245[local340] = local388;
				}
				@Pc(462) int local462 = arg0.anInt956 + 1;
				@Pc(467) int local467 = arg0.anInt950 * 100000;
				...
				for (local557 = method605(local535, arg0); local557 > local540[local553]; local557 = local557 << 1 | local566) {
					local553++;
					local566 = method604(arg0);
				}
				...
				while (true) {
					...
					arg0.anInt953 = Class40.anIntArray243[arg0.anInt952] >> 8;
					arg0.anInt955 = 0;
					arg0.anInt953 = Class40.anIntArray243[arg0.anInt953];
					arg0.anInt954 = (byte) (arg0.anInt953 & 0xFF);
					arg0.anInt953 >>= 0x8;
					arg0.anInt955++;
					arg0.anInt957 = local520;
					method601(arg0);
					if (arg0.anInt955 == arg0.anInt957 + 1 && arg0.anInt947 == 0) {
						local60 = true;
						break;
					}
					local60 = false;
	...
	private static byte method603(@OriginalArg(0) Class40 arg0) {
		return (byte) method605(8, arg0);
	}

	@OriginalMember(owner = "client!sb", name = "d", descriptor = "(Lclient!tb;)B")
	private static byte method604(@OriginalArg(0) Class40 arg0) {
		return (byte) method605(1, arg0);
	}

	@OriginalMember(owner = "client!sb", name = "a", descriptor = "(ILclient!tb;)I")
	private static int method605(@OriginalArg(0) int arg0, @OriginalArg(1) Class40 arg1) {
		while (arg1.anInt949 < arg0) {
			arg1.anInt948 = arg1.anInt948 << 8 | arg1.aByteArray11[arg1.anInt939] & 0xFF;
			arg1.anInt949 += 8;
			arg1.anInt939++;
			arg1.anInt940--;
			arg1.anInt941++;
		...
		@Pc(17) int local17 = arg1.anInt948 >> arg1.anInt949 - arg0 & (0x1 << arg0) - 1;
		arg1.anInt949 -= arg0;
		return local17;
	}

	@OriginalMember(owner = "client!sb", name = "e", descriptor = "(Lclient!tb;)V")
	private static void method606(@OriginalArg(0) Class40 arg0) {
		arg0.anInt956 = 0;
		for (@Pc(4) int local4 = 0; local4 < 256; local4++) {
			if (arg0.aBooleanArray8[local4]) {
				arg0.aByteArray13[arg0.anInt956] = (byte) local4;
				arg0.anInt956++;
			}
		}
	}
	...
	private static void method607(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) byte[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(3) int local3 = 0;
		@Pc(5) int local5;
