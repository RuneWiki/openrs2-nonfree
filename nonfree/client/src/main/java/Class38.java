...
public final class Class38 {
	...
	public Class38(@OriginalArg(0) byte arg0, @OriginalArg(1) int[] arg1) {
		try {
			...
			for (@Pc(18) int local18 = 0; local18 < arg1.length; local18++) {
				this.anIntArray219[local18] = arg1[local18];
			}
			this.method534();
		} catch (@Pc(36) RuntimeException local36) {
			signlink.reporterror("26946, " + arg0 + ", " + arg1 + ", " + local36.toString());
	...
	public int method532() {
		...
		return this.anIntArray219[this.anInt759];
	}

	@OriginalMember(owner = "client!tb", name = "b", descriptor = "()V")
	private void method533() {
		this.anInt761 += ++this.anInt762;
		for (@Pc(15) int local15 = 0; local15 < 256; local15++) {
			@Pc(22) int local22 = this.anIntArray220[local15];
			switch(local15 & 0x3) {
				case 0:
					this.anInt760 ^= this.anInt760 << 13;
					break;
				case 1:
					this.anInt760 ^= this.anInt760 >>> 6;
					break;
				case 2:
					this.anInt760 ^= this.anInt760 << 2;
					break;
				case 3:
					this.anInt760 ^= this.anInt760 >>> 16;
			}
			this.anInt760 += this.anIntArray220[local15 + 128 & 0xFF];
			@Pc(101) int local101;
			this.anIntArray220[local15] = local101 = this.anIntArray220[local22 >> 2 & 0xFF] + this.anInt760 + this.anInt761;
			this.anIntArray219[local15] = this.anInt761 = this.anIntArray220[local101 >> 8 >> 2 & 0xFF] + local22;
		}
	}
