...
public final class Class2_Sub32 extends Class2 {
	...
	public Class2_Sub32(@OriginalArg(0) byte[] arg0) {
		this.method4622(arg0);
	}

	@OriginalMember(owner = "client!qd", name = "a", descriptor = "([B)V")
	private void method4622(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub12 local4 = new Class2_Sub12(arg0);
		this.anInt5469 = local4.method3135();
		this.anInt5467 = local4.method3135();
		this.anInt5473 = local4.method3135();
		this.anInt5471 = local4.method3135();
		if (this.anInt5471 < 0) {
			this.anInt5471 = ~this.anInt5471;
			this.aBoolean480 = true;
		}
		@Pc(40) int local40 = local4.method3135();
		this.aByteArrayArray16 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method3124();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method3137(local64, local49);
			this.aByteArrayArray16[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!qd", name = "c", descriptor = "(I)[F")
	private float[] method4626(@OriginalArg(0) int arg0) {
		Static262.method4625(this.aByteArrayArray16[arg0]);
		Static262.method4624();
		@Pc(15) int local15 = Static262.method4628(Static132.method2566(Static262.anIntArray427.length - 1));
		@Pc(19) boolean local19 = Static262.aBooleanArray21[local15];
		@Pc(25) int local25 = local19 ? Static262.anInt5468 : Static262.anInt5466;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static262.method4624() != 0;
			local29 = Static262.method4624() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static262.anInt5466 >> 2);
			local67 = (local25 >> 2) + (Static262.anInt5466 >> 2);
			local71 = Static262.anInt5466 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static262.anInt5466 >> 2);
			local104 = local25 + (Static262.anInt5466 >> 2) - (local25 >> 2);
			local108 = Static262.anInt5466 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class48 local123 = Static262.aClass48Array1[Static262.anIntArray427[local15]];
		@Pc(126) int local126 = local123.anInt880;
		@Pc(131) int local131 = local123.anIntArray75[local126];
		@Pc(140) boolean local140 = !Static262.aClass87Array1[local131].method2312();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt881; local144++) {
			@Pc(152) Class92 local152 = Static262.aClass92Array1[local123.anIntArray76[local144]];
			local154 = Static262.aFloatArray28;
			local152.method2447(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt880;
			local176 = local123.anIntArray75[local171];
			Static262.aClass87Array1[local176].method2313(Static262.aFloatArray28, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static262.aFloatArray28[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static262.aFloatArray28;
			...
			@Pc(252) float[] local252 = local19 ? Static262.aFloatArray24 : Static262.aFloatArray23;
			@Pc(258) float[] local258 = local19 ? Static262.aFloatArray25 : Static262.aFloatArray27;
			@Pc(264) float[] local264 = local19 ? Static262.aFloatArray26 : Static262.aFloatArray29;
			@Pc(270) int[] local270 = local19 ? Static262.anIntArray425 : Static262.anIntArray426;
			...
			@Pc(486) int local486 = Static132.method2566(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static262.aFloatArray28[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static262.aFloatArray28[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt5465 > 0) {
			local176 = this.anInt5465 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean478) {
				for (local212 = 0; local212 < this.anInt5464; local212++) {
					local1254 = (this.anInt5465 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static262.aFloatArray28[local212];
				}
			}
		}
		local154 = this.aFloatArray22;
		this.aFloatArray22 = Static262.aFloatArray28;
		Static262.aFloatArray28 = local154;
		this.anInt5465 = local25;
		this.anInt5464 = local104 - (local25 >> 1);
		this.aBoolean478 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!qd", name = "a", descriptor = "([I)Lclient!ar;")
	public Class2_Sub5_Sub1 method4629(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray77 == null) {
			this.anInt5465 = 0;
			this.aFloatArray22 = new float[Static262.anInt5468];
			this.aByteArray77 = new byte[this.anInt5467];
			this.anInt5475 = 0;
			this.anInt5474 = 0;
		}
		while (this.anInt5474 < this.aByteArrayArray16.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method4626(this.anInt5474);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt5475;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt5467 - local47) {
					local50 = this.anInt5467 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray77[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt5475;
				}
				this.anInt5475 = local47;
			}
			this.anInt5474++;
		}
		this.aFloatArray22 = null;
		@Pc(129) byte[] local129 = this.aByteArray77;
		this.aByteArray77 = null;
		return new Class2_Sub5_Sub1(this.anInt5469, local129, this.anInt5473, this.anInt5471, this.aBoolean480);
	}
}
