...
public final class Class6_Sub13 extends Class6 {
	...
	@OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(ILclient!fca;)V")
	public Class6_Sub13(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub22 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Lclient!fca;)V")
	public Class6_Sub13(@OriginalArg(0) Class3_Sub22 arg0) {
		super(arg0);
	}
