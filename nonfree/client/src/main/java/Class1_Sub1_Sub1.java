...
public class Class1_Sub1_Sub1 extends Class1_Sub1 {
	...
	public int anInt989 = 1000;

	@OriginalMember(owner = "client!x", name = "a", descriptor = "(IIIIIIIII)V")
	public void method669(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		@Pc(3) Class1_Sub1_Sub1_Sub5 local3 = this.method670();
		if (local3 != null) {
			this.anInt989 = local3.anInt989;
			local3.method669(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
		}
	}
	...
	protected Class1_Sub1_Sub1_Sub5 method670() {
		try {
			...
			signlink.reporterror("75984, " + false + ", " + local7.toString());
