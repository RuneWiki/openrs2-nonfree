...
public final class Class1_Sub1_Sub1 extends Class1_Sub1 {
	...
	public void method19(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3) {
		try {
			@Pc(8) double local8;
			if (!this.aBoolean5) {
			...
			signlink.reporterror("18544, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + -855 + ", " + arg3 + ", " + local131.toString());
			throw new RuntimeException();
		}
	}
	...
	public void method20(@OriginalArg(1) int arg0) {
		try {
			...
			signlink.reporterror("86911, " + -30 + ", " + arg0 + ", " + local139.toString());
			throw new RuntimeException();
		}
	}
	...
	public Class1_Sub3_Sub1 method568() {
		try {
			...
			if (this.aClass21_1.aClass19_1 != null) {
				local19.method230();
				local19.method231(this.aClass21_1.aClass19_1.anIntArray186[this.anInt36]);
				local19.anIntArrayArray7 = null;
				local19.anIntArrayArray6 = null;
			}
			if (this.aClass21_1.anInt571 != 128 || this.aClass21_1.anInt572 != 128) {
				local19.method239(this.aClass21_1.anInt571, this.aClass21_1.anInt572, this.aClass21_1.anInt571);
			}
			...
			signlink.reporterror("99718, " + true + ", " + local97.toString());
			throw new RuntimeException();
		}
	}
}
