...
public final class Class2_Sub7 extends Class2 {
	...
	@OriginalMember(owner = "client!fe", name = "a", descriptor = "([I)Lclient!k;")
	public Class2_Sub5_Sub1 method918(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray13 == null) {
			this.anInt1174 = 0;
			this.aFloatArray8 = new float[Static52.anInt1178];
			this.aByteArray13 = new byte[this.anInt1176];
			this.anInt1182 = 0;
			this.anInt1183 = 0;
		}
		while (this.anInt1183 < this.aByteArrayArray6.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method922(this.anInt1183);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt1182;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt1176 - local47) {
					local50 = this.anInt1176 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray13[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt1182;
				}
				this.anInt1182 = local47;
			}
			this.anInt1183++;
		}
		this.aFloatArray8 = null;
		@Pc(129) byte[] local129 = this.aByteArray13;
		this.aByteArray13 = null;
		return new Class2_Sub5_Sub1(this.anInt1173, local129, this.anInt1177, this.anInt1181, this.aBoolean45);
	}

	@OriginalMember(owner = "client!fe", name = "b", descriptor = "(I)[F")
	private float[] method922(@OriginalArg(0) int arg0) {
		Static52.method917(this.aByteArrayArray6[arg0]);
		Static52.method924();
		@Pc(15) int local15 = Static52.method915(Static54.method941(Static52.anIntArray107.length - 1));
		@Pc(19) boolean local19 = Static52.aBooleanArray5[local15];
		@Pc(25) int local25 = local19 ? Static52.anInt1178 : Static52.anInt1179;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static52.method924() != 0;
			local29 = Static52.method924() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static52.anInt1179 >> 2);
			local67 = (local25 >> 2) + (Static52.anInt1179 >> 2);
			local71 = Static52.anInt1179 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static52.anInt1179 >> 2);
			local104 = local25 + (Static52.anInt1179 >> 2) - (local25 >> 2);
			local108 = Static52.anInt1179 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class69 local123 = Static52.aClass69Array1[Static52.anIntArray107[local15]];
		@Pc(126) int local126 = local123.anInt2921;
		@Pc(131) int local131 = local123.anIntArray273[local126];
		@Pc(140) boolean local140 = !Static52.aClass31Array1[local131].method955();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt2922; local144++) {
			@Pc(152) Class62 local152 = Static52.aClass62Array1[local123.anIntArray272[local144]];
			local154 = Static52.aFloatArray1;
			local152.method1972(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt2921;
			local176 = local123.anIntArray273[local171];
			Static52.aClass31Array1[local176].method959(Static52.aFloatArray1, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static52.aFloatArray1[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static52.aFloatArray1;
			...
			@Pc(252) float[] local252 = local19 ? Static52.aFloatArray5 : Static52.aFloatArray7;
			@Pc(258) float[] local258 = local19 ? Static52.aFloatArray4 : Static52.aFloatArray6;
			@Pc(264) float[] local264 = local19 ? Static52.aFloatArray2 : Static52.aFloatArray3;
			@Pc(270) int[] local270 = local19 ? Static52.anIntArray109 : Static52.anIntArray108;
			...
			@Pc(486) int local486 = Static54.method941(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static52.aFloatArray1[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static52.aFloatArray1[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt1174 > 0) {
			local176 = this.anInt1174 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean46) {
				for (local212 = 0; local212 < this.anInt1175; local212++) {
					local1254 = (this.anInt1174 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static52.aFloatArray1[local212];
				}
			}
		}
		local154 = this.aFloatArray8;
		this.aFloatArray8 = Static52.aFloatArray1;
		Static52.aFloatArray1 = local154;
		this.anInt1174 = local25;
		this.anInt1175 = local104 - (local25 >> 1);
		this.aBoolean46 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!fe", name = "b", descriptor = "([B)V")
	private void method925(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub13 local4 = new Class2_Sub13(arg0);
		this.anInt1173 = local4.method2946();
		this.anInt1176 = local4.method2946();
		this.anInt1177 = local4.method2946();
		this.anInt1181 = local4.method2946();
		if (this.anInt1181 < 0) {
			this.anInt1181 = ~this.anInt1181;
			this.aBoolean45 = true;
		}
		@Pc(40) int local40 = local4.method2946();
		this.aByteArrayArray6 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method2962();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method2947(local64, local49);
