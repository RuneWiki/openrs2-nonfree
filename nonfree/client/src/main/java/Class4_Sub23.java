...
public final class Class4_Sub23 extends Class4 {
	...
	public Class4_Sub23(@OriginalArg(0) byte[] arg0) {
		this.method3177(arg0);
	}

	@OriginalMember(owner = "client!kh", name = "a", descriptor = "([I)Lclient!bg;")
	public Class4_Sub7_Sub1 method3176(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray54 == null) {
			this.anInt3486 = 0;
			this.aFloatArray24 = new float[Static163.anInt3487];
			this.aByteArray54 = new byte[this.anInt3484];
			this.anInt3492 = 0;
			this.anInt3493 = 0;
		}
		while (this.anInt3493 < this.aByteArrayArray14.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method3180(this.anInt3493);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt3492;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt3484 - local47) {
					local50 = this.anInt3484 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt3492;
				}
				this.anInt3492 = local47;
			}
			this.anInt3493++;
		}
		...
		return new Class4_Sub7_Sub1(this.anInt3491, local129, this.anInt3482, this.anInt3485, this.aBoolean277);
	}

	@OriginalMember(owner = "client!kh", name = "a", descriptor = "([B)V")
	private void method3177(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class4_Sub11 local4 = new Class4_Sub11(arg0);
		this.anInt3491 = local4.method3418();
		this.anInt3484 = local4.method3418();
		this.anInt3482 = local4.method3418();
		this.anInt3485 = local4.method3418();
		if (this.anInt3485 < 0) {
			this.anInt3485 = ~this.anInt3485;
			this.aBoolean277 = true;
		}
		@Pc(40) int local40 = local4.method3418();
		this.aByteArrayArray14 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method3440();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method3456(local49, local64);
			this.aByteArrayArray14[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!kh", name = "a", descriptor = "(I)[F")
	private float[] method3180(@OriginalArg(0) int arg0) {
		Static163.method3186(this.aByteArrayArray14[arg0]);
		Static163.method3179();
		@Pc(15) int local15 = Static163.method3185(Static238.method4560(Static163.anIntArray303.length - 1));
		@Pc(19) boolean local19 = Static163.aBooleanArray17[local15];
		@Pc(25) int local25 = local19 ? Static163.anInt3487 : Static163.anInt3490;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static163.method3179() != 0;
			local29 = Static163.method3179() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static163.anInt3490 >> 2);
			local67 = (local25 >> 2) + (Static163.anInt3490 >> 2);
			local71 = Static163.anInt3490 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static163.anInt3490 >> 2);
			local104 = local25 + (Static163.anInt3490 >> 2) - (local25 >> 2);
			local108 = Static163.anInt3490 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class191 local123 = Static163.aClass191Array1[Static163.anIntArray303[local15]];
		@Pc(126) int local126 = local123.anInt5780;
		@Pc(131) int local131 = local123.anIntArray464[local126];
		@Pc(140) boolean local140 = !Static163.aClass70Array1[local131].method2212();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt5781; local144++) {
			@Pc(152) Class168 local152 = Static163.aClass168Array1[local123.anIntArray463[local144]];
			local154 = Static163.aFloatArray21;
			local152.method4501(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt5780;
			local176 = local123.anIntArray464[local171];
			Static163.aClass70Array1[local176].method2218(Static163.aFloatArray21, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static163.aFloatArray21[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static163.aFloatArray21;
			...
			@Pc(252) float[] local252 = local19 ? Static163.aFloatArray19 : Static163.aFloatArray22;
			@Pc(258) float[] local258 = local19 ? Static163.aFloatArray23 : Static163.aFloatArray17;
			@Pc(264) float[] local264 = local19 ? Static163.aFloatArray18 : Static163.aFloatArray20;
			@Pc(270) int[] local270 = local19 ? Static163.anIntArray305 : Static163.anIntArray304;
			...
			@Pc(486) int local486 = Static238.method4560(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static163.aFloatArray21[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static163.aFloatArray21[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt3486 > 0) {
			local176 = this.anInt3486 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean278) {
				for (local212 = 0; local212 < this.anInt3489; local212++) {
					local1254 = (this.anInt3486 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static163.aFloatArray21[local212];
				}
			}
		}
		local154 = this.aFloatArray24;
		this.aFloatArray24 = Static163.aFloatArray21;
		Static163.aFloatArray21 = local154;
		this.anInt3486 = local25;
		this.anInt3489 = local104 - (local25 >> 1);
		this.aBoolean278 = local140;
		return local1228;
	}
}
