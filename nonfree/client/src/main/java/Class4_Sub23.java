...
public final class Class4_Sub23 extends Class4 {
	...
	@OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Lclient!w;)V")
	public Class4_Sub23(@OriginalArg(0) Class2_Sub54 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(ILclient!w;)V")
	public Class4_Sub23(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub54 arg1) {
		super(arg0, arg1);
	}
