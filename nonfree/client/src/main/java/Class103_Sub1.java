...
public final class Class103_Sub1 extends Class103 {
	...
	@Override
	public void method3012(@OriginalArg(0) int arg0) throws LineUnavailableException {
		try {
			@Pc(20) Info local20 = new Info(SourceDataLine.class, this.anAudioFormat1, arg0 << (Static138.aBoolean183 ? 2 : 1));
			this.aSourceDataLine1 = (SourceDataLine) AudioSystem.getLine(local20);
			this.aSourceDataLine1.open();
			this.aSourceDataLine1.start();
			this.anInt2805 = arg0;
		} catch (@Pc(36) LineUnavailableException local36) {
			if (Static30.method496(arg0) == 1) {
				this.aSourceDataLine1 = null;
				throw local36;
			} else {
				this.method3012(Static161.method2608(arg0));
			}
		}
	}
	...
	protected int method3015() {
		return this.anInt2805 - (this.aSourceDataLine1.available() >> (Static138.aBoolean183 ? 2 : 1));
	}

	@OriginalMember(owner = "client!kb", name = "d", descriptor = "()V")
	@Override
	protected void method3024() throws LineUnavailableException {
		...
		this.aSourceDataLine1.close();
		this.aSourceDataLine1 = null;
		@Pc(34) Info local34 = new Info(SourceDataLine.class, this.anAudioFormat1, this.anInt2805 << (Static138.aBoolean183 ? 2 : 1));
	...
	@Override
	public void method3019(@OriginalArg(0) Component arg0) {
		...
		this.anAudioFormat1 = new AudioFormat((float) Static288.anInt5395, 16, Static138.aBoolean183 ? 2 : 1, true, false);
		this.aByteArray20 = new byte[0x100 << (Static138.aBoolean183 ? 2 : 1)];
	}
