...
public final class Class80_Sub2_Sub2 extends Class80_Sub2 {
	...
	@OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Lclient!sr;[B[III)V")
	public Class80_Sub2_Sub2(@OriginalArg(0) Class50_Sub2 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		super(arg0, arg3, arg4);
		this.aByteArray62 = arg1;
		this.anIntArray508 = arg2;
	}
	...
	protected void method4543(@OriginalArg(0) int arg0) {
		...
		if (Static183.anInt5711 == 0) {
			if (Static183.anInt5694 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local16 >= 0 && local14 - (super.anInt5712 << 12) < 0 && local16 - (super.anInt5719 << 12) < 0) {
						while (local18 < 0) {
							...
							local51 = local12++;
							if (arg0 == 1) {
								local227 = this.aByteArray62[local48];
								if (local227 != 0) {
									local3[local51] = this.anIntArray508[local227 & 0xFF];
								}
							} else if (arg0 == 0) {
								local227 = this.aByteArray62[local48];
								if (local227 != 0) {
									local255 = this.anIntArray508[local227 & 0xFF];
									if ((Static183.anInt5692 & 0xFFFFFF) == 16777215) {
										local264 = Static183.anInt5692 >>> 24;
										...
										local264 = (local255 & 0xFF0000) * Static183.anInt5706 & 0xFF000000;
										local268 = (local255 & 0xFF00) * Static183.anInt5713 & 0xFF0000;
										local272 = (local255 & 0xFF) * Static183.anInt5699 & 0xFF00;
										...
										local3[local51] = ((local255 & 0xFF00FF) * Static183.anInt5701 + (local344 & 0xFF00FF) * Static183.anInt5720 & 0xFF00FF00) + ((local255 & 0xFF00) * Static183.anInt5701 + (local344 & 0xFF00) * Static183.anInt5720 & 0xFF0000) >> 8;
									}
								}
							} else if (arg0 == 3) {
								local227 = this.aByteArray62[local48];
								local255 = local227 > 0 ? this.anIntArray508[local227] : 0;
								local264 = Static183.anInt5692;
								...
								if (local255 == 0 && Static183.anInt5701 != 255) {
									local255 = local344;
									local344 = local3[local51];
									local344 = ((local255 & 0xFF00FF) * Static183.anInt5701 + (local344 & 0xFF00FF) * Static183.anInt5720 & 0xFF00FF00) + ((local255 & 0xFF00) * Static183.anInt5701 + (local344 & 0xFF00) * Static183.anInt5720 & 0xFF0000) >> 8;
								}
								...
								if (local227 != 0) {
									local255 = this.anIntArray508[local227 & 0xFF];
									local264 = (local255 & 0xFF00FF) * Static183.anInt5701 & 0xFF00FF00;
									local268 = (local255 & 0xFF00) * Static183.anInt5701 & 0xFF0000;
									local3[local51++] = ((local264 | local268) >>> 8) + Static183.anInt5690;
								}
							} else {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt5712 << 12) < 0) {
						@Pc(928) int local928;
						if ((local928 = local16 - (super.anInt5719 << 12)) >= 0) {
							local935 = (Static183.anInt5694 - local928) / Static183.anInt5694;
							local18 += local935;
							local16 += Static183.anInt5694 * local935;
							local12 += local935;
						}
						@Pc(956) int local956;
						if ((local956 = (local16 - Static183.anInt5694) / Static183.anInt5694) > local18) {
							local18 = local956;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt5712 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt5712 << 12) < 0) {
						if (local16 < 0) {
							local935 = (Static183.anInt5694 - local16 - 1) / Static183.anInt5694;
							local18 += local935;
							local16 += Static183.anInt5694 * local935;
							local12 += local935;
						}
						@Pc(1888) int local1888;
						if ((local1888 = (local16 + 1 - (super.anInt5719 << 12) - Static183.anInt5694) / Static183.anInt5694) > local18) {
							local18 = local1888;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt5712 + (local14 >> 12);
			...
			if (Static183.anInt5694 == 0) {
				...
				while (local9 < 0) {
					...
					if (local16 >= 0 && local16 - (super.anInt5719 << 12) < 0) {
						...
						if ((local2794 = local14 - (super.anInt5712 << 12)) >= 0) {
							local935 = (Static183.anInt5711 - local2794) / Static183.anInt5711;
							local18 += local935;
							local14 += Static183.anInt5711 * local935;
							local12 += local935;
						}
						@Pc(2822) int local2822;
						if ((local2822 = (local14 - Static183.anInt5711) / Static183.anInt5711) > local18) {
							local18 = local2822;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt5712 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local3719 = local14 - (super.anInt5712 << 12)) >= 0) {
						local935 = (Static183.anInt5711 - local3719) / Static183.anInt5711;
						local18 += local935;
						local14 += Static183.anInt5711 * local935;
						local16 += Static183.anInt5694 * local935;
						local12 += local935;
					...
					if ((local3753 = (local14 - Static183.anInt5711) / Static183.anInt5711) > local18) {
						local18 = local3753;
					}
					@Pc(3765) int local3765;
					if ((local3765 = local16 - (super.anInt5719 << 12)) >= 0) {
						local935 = (Static183.anInt5694 - local3765) / Static183.anInt5694;
						local18 += local935;
						local14 += Static183.anInt5711 * local935;
						local16 += Static183.anInt5694 * local935;
						local12 += local935;
					...
					if ((local3799 = (local16 - Static183.anInt5694) / Static183.anInt5694) > local18) {
						local18 = local3799;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt5712 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local4702 = local14 - (super.anInt5712 << 12)) >= 0) {
						local935 = (Static183.anInt5711 - local4702) / Static183.anInt5711;
						local18 += local935;
						local14 += Static183.anInt5711 * local935;
						local16 += Static183.anInt5694 * local935;
						local12 += local935;
					...
					if ((local4736 = (local14 - Static183.anInt5711) / Static183.anInt5711) > local18) {
						local18 = local4736;
					}
					if (local16 < 0) {
						local935 = (Static183.anInt5694 - local16 - 1) / Static183.anInt5694;
					...
					if ((local4784 = (local16 + 1 - (super.anInt5719 << 12) - Static183.anInt5694) / Static183.anInt5694) > local18) {
						local18 = local4784;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt5712 + (local14 >> 12);
			...
			while (local9 < 0) {
				...
				if (local16 >= 0 && local16 - (super.anInt5719 << 12) < 0) {
					if (local14 < 0) {
						local935 = (Static183.anInt5711 - local14 - 1) / Static183.anInt5711;
						local18 += local935;
						local14 += Static183.anInt5711 * local935;
						local12 += local935;
					}
					@Pc(5726) int local5726;
					if ((local5726 = (local14 + 1 - (super.anInt5712 << 12) - Static183.anInt5711) / Static183.anInt5711) > local18) {
						local18 = local5726;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt5712 + (local14 >> 12);
			...
			for (local9 = Static183.anInt5695; local9 < 0; local9++) {
				...
				if ((local6663 = (local14 + 1 - (super.anInt5712 << 12) - Static183.anInt5711) / Static183.anInt5711) > local18) {
					local18 = local6663;
				}
				@Pc(6675) int local6675;
				if ((local6675 = local16 - (super.anInt5719 << 12)) >= 0) {
					local935 = (Static183.anInt5694 - local6675) / Static183.anInt5694;
					local18 += local935;
					local14 += Static183.anInt5711 * local935;
					local16 += Static183.anInt5694 * local935;
					local12 += local935;
				...
				if ((local6709 = (local16 - Static183.anInt5694) / Static183.anInt5694) > local18) {
					local18 = local6709;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt5712 + (local14 >> 12);
			...
			for (local9 = Static183.anInt5695; local9 < 0; local9++) {
				...
				if ((local7648 = (local14 + 1 - (super.anInt5712 << 12) - Static183.anInt5711) / Static183.anInt5711) > local18) {
					local18 = local7648;
				}
				if (local16 < 0) {
					local935 = (Static183.anInt5694 - local16 - 1) / Static183.anInt5694;
				...
				if ((local7696 = (local16 + 1 - (super.anInt5719 << 12) - Static183.anInt5694) / Static183.anInt5694) > local18) {
					local18 = local7696;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt5712 + (local14 >> 12);
	...
	@OriginalMember(owner = "client!ov", name = "a", descriptor = "(IILclient!ta;II)V")
	@Override
	public void method5562(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class49 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		for (@Pc(212) int local212 = local171; local212 < local210; local212++) {
			...
			for (@Pc(304) int local304 = -local227; local304 < 0; local304++) {
				@Pc(311) byte local311 = this.aByteArray62[local19++];
				if (local311 == 0) {
					local41++;
				} else {
					local169[local41++] = this.anIntArray508[local311 & 0xFF];
				}
			}
			...
			if (arg6 != 0) {
				...
				if (arg6 == 1) {
					if (arg4 == 1) {
						...
						for (local262 = -arg3; local262 < 0; local262++) {
							...
							for (local273 = -arg2; local273 < 0; local273++) {
								local446 = this.aByteArray62[(local14 >> 16) + local270];
								if (local446 == 0) {
									local64++;
								} else {
									local252[local64++] = this.anIntArray508[local446 & 0xFF];
								}
								local14 += local44;
							}
							local16 += local50;
						...
						if (arg4 == 0) {
							...
							if ((arg5 & 0xFFFFFF) == 16777215) {
								...
								for (local273 = -arg3; local273 < 0; local273++) {
									local335 = (local16 >> 16) * super.anInt5712;
									for (local343 = -arg2; local343 < 0; local343++) {
										local735 = this.aByteArray62[(local14 >> 16) + local335];
										if (local735 == 0) {
											local64++;
										} else {
											local361 = this.anIntArray508[local735 & 0xFF];
								...
								for (local346 = -arg3; local346 < 0; local346++) {
									local361 = (local16 >> 16) * super.anInt5712;
									for (local369 = -arg2; local369 < 0; local369++) {
										@Pc(852) byte local852 = this.aByteArray62[(local14 >> 16) + local361];
										if (local852 == 0) {
											local64++;
										} else {
											local385 = this.anIntArray508[local852 & 0xFF];
											if (local335 == 255) {
							...
							for (local273 = -arg3; local273 < 0; local273++) {
								...
								for (local343 = -arg2; local343 < 0; local343++) {
									local735 = this.aByteArray62[(local14 >> 16) + local335];
									local361 = local735 > 0 ? this.anIntArray508[local735] : 0;
							...
							for (local343 = -arg3; local343 < 0; local343++) {
								local346 = (local16 >> 16) * super.anInt5712;
								for (local361 = -arg2; local361 < 0; local361++) {
									local1196 = this.aByteArray62[(local14 >> 16) + local346];
									if (local1196 == 0) {
										local64++;
									} else {
										local377 = this.anIntArray508[local1196 & 0xFF];
					...
					for (local262 = -arg3; local262 < 0; local262++) {
						...
						for (local273 = -arg2; local273 < 0; local273++) {
							...
							if (local446 == 0) {
								...
								local343 = this.anIntArray508[local446 & 0xFF];
					...
					for (local335 = -arg3; local335 < 0; local335++) {
						local343 = (local16 >> 16) * super.anInt5712;
						for (local346 = -arg2; local346 < 0; local346++) {
							@Pc(1406) byte local1406 = this.aByteArray62[(local14 >> 16) + local343];
							if (local1406 == 0) {
								local64++;
							} else {
								local369 = this.anIntArray508[local1406 & 0xFF];
					...
					for (local262 = -arg3; local262 < 0; local262++) {
						...
						for (local273 = -arg2; local273 < 0; local273++) {
							local446 = this.aByteArray62[(local14 >> 16) + local270];
							local343 = local446 > 0 ? this.anIntArray508[local446] : 0;
				...
				for (local262 = -arg3; local262 < 0; local262++) {
					local270 = (local16 >> 16) * super.anInt5712;
					for (local273 = -arg2; local273 < 0; local273++) {
						local252[local64++] = this.anIntArray508[this.aByteArray62[(local14 >> 16) + local270] & 0xFF];
						local14 += local44;
					}
					local16 += local50;
					local14 = local259;
				...
				for (local335 = -arg3; local335 < 0; local335++) {
					local343 = (local16 >> 16) * super.anInt5712;
					for (local346 = -arg2; local346 < 0; local346++) {
						local361 = this.anIntArray508[this.aByteArray62[(local14 >> 16) + local343] & 0xFF];
				...
				for (local343 = -arg3; local343 < 0; local343++) {
					local346 = (local16 >> 16) * super.anInt5712;
					for (local361 = -arg2; local361 < 0; local361++) {
						local369 = this.anIntArray508[this.aByteArray62[(local14 >> 16) + local346] & 0xFF];
		...
		if (Static183.anInt5711 == 0) {
			if (Static183.anInt5694 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local27 >= 0 && local25 - (super.anInt5712 << 12) < 0 && local27 - (super.anInt5719 << 12) < 0) {
							...
							while (local29 < 0) {
								local111 = this.aByteArray62[(local27 >> 12) * super.anInt5712 + (local25 >> 12)];
								if (local111 == 0) {
									local23++;
								} else {
									local3[local23++] = this.anIntArray508[local111 & 0xFF];
								}
								local29++;
							}
						}
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt5712 << 12) < 0) {
							@Pc(179) int local179;
							if ((local179 = local27 - (super.anInt5719 << 12)) >= 0) {
								local186 = (Static183.anInt5694 - local179) / Static183.anInt5694;
								local29 += local186;
								local27 += Static183.anInt5694 * local186;
								local23 += local186;
							}
							@Pc(207) int local207;
							if ((local207 = (local27 - Static183.anInt5694) / Static183.anInt5694) > local29) {
								local29 = local207;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt5712 << 12) < 0) {
							if (local27 < 0) {
								local186 = (Static183.anInt5694 - local27 - 1) / Static183.anInt5694;
								local29 += local186;
								local27 += Static183.anInt5694 * local186;
								local23 += local186;
							}
							@Pc(379) int local379;
							if ((local379 = (local27 + 1 - (super.anInt5719 << 12) - Static183.anInt5694) / Static183.anInt5694) > local29) {
								local29 = local379;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
			...
			if (Static183.anInt5694 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local27 >= 0 && local27 - (super.anInt5719 << 12) < 0) {
							@Pc(525) int local525;
							if ((local525 = local25 - (super.anInt5712 << 12)) >= 0) {
								local186 = (Static183.anInt5711 - local525) / Static183.anInt5711;
								local29 += local186;
								local25 += Static183.anInt5711 * local186;
								local23 += local186;
							}
							@Pc(553) int local553;
							if ((local553 = (local25 - Static183.anInt5711) / Static183.anInt5711) > local29) {
								local29 = local553;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static183.anInt5707;
						@Pc(690) int local690;
						if ((local690 = local25 - (super.anInt5712 << 12)) >= 0) {
							local186 = (Static183.anInt5711 - local690) / Static183.anInt5711;
							local29 += local186;
							local25 += Static183.anInt5711 * local186;
							local27 += Static183.anInt5694 * local186;
							local23 += local186;
						...
						@Pc(724) int local724;
						if ((local724 = (local25 - Static183.anInt5711) / Static183.anInt5711) > local29) {
							local29 = local724;
						}
						@Pc(736) int local736;
						if ((local736 = local27 - (super.anInt5719 << 12)) >= 0) {
							local186 = (Static183.anInt5694 - local736) / Static183.anInt5694;
							local29 += local186;
							local25 += Static183.anInt5711 * local186;
							local27 += Static183.anInt5694 * local186;
							local23 += local186;
						...
						@Pc(770) int local770;
						if ((local770 = (local27 - Static183.anInt5694) / Static183.anInt5694) > local29) {
							local29 = local770;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static183.anInt5707;
						@Pc(913) int local913;
						if ((local913 = local25 - (super.anInt5712 << 12)) >= 0) {
							local186 = (Static183.anInt5711 - local913) / Static183.anInt5711;
							local29 += local186;
							local25 += Static183.anInt5711 * local186;
							local27 += Static183.anInt5694 * local186;
							local23 += local186;
						...
						@Pc(947) int local947;
						if ((local947 = (local25 - Static183.anInt5711) / Static183.anInt5711) > local29) {
							local29 = local947;
						}
						if (local27 < 0) {
							local186 = (Static183.anInt5694 - local27 - 1) / Static183.anInt5694;
						...
						@Pc(995) int local995;
						if ((local995 = (local27 + 1 - (super.anInt5719 << 12) - Static183.anInt5694) / Static183.anInt5694) > local29) {
							local29 = local995;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if (local27 >= 0 && local27 - (super.anInt5719 << 12) < 0) {
						if (local25 < 0) {
							local186 = (Static183.anInt5711 - local25 - 1) / Static183.anInt5711;
							local29 += local186;
							local25 += Static183.anInt5711 * local186;
							local23 += local186;
						}
						@Pc(1177) int local1177;
						if ((local1177 = (local25 + 1 - (super.anInt5712 << 12) - Static183.anInt5711) / Static183.anInt5711) > local29) {
							local29 = local1177;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1354 = (local25 + 1 - (super.anInt5712 << 12) - Static183.anInt5711) / Static183.anInt5711) > local29) {
						local29 = local1354;
					}
					@Pc(1366) int local1366;
					if ((local1366 = local27 - (super.anInt5719 << 12)) >= 0) {
						local186 = (Static183.anInt5694 - local1366) / Static183.anInt5694;
						local29 += local186;
						local25 += Static183.anInt5711 * local186;
						local27 += Static183.anInt5694 * local186;
						local23 += local186;
					...
					if ((local1400 = (local27 - Static183.anInt5694) / Static183.anInt5694) > local29) {
						local29 = local1400;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1579 = (local25 + 1 - (super.anInt5712 << 12) - Static183.anInt5711) / Static183.anInt5711) > local29) {
						local29 = local1579;
					}
					if (local27 < 0) {
						local186 = (Static183.anInt5694 - local27 - 1) / Static183.anInt5694;
					...
					if ((local1627 = (local27 + 1 - (super.anInt5719 << 12) - Static183.anInt5694) / Static183.anInt5694) > local29) {
						local29 = local1627;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
		...
		if (arg2 == 1) {
			for (local532 = -local32; local532 < 0; local532++) {
				...
				while (local27 < local539) {
					local546 = this.aByteArray62[local29++];
					if (local546 == 0) {
						local27++;
					} else {
						local160[local27++] = this.anIntArray508[local546 & 0xFF];
					}
					local546 = this.aByteArray62[local29++];
					if (local546 == 0) {
						local27++;
		...
		if (arg2 != 0) {
			...
			if (arg2 == 3) {
				...
				for (local678 = -local32; local678 < 0; local678++) {
					for (local682 = -local35; local682 < 0; local682++) {
						local689 = this.aByteArray62[local29++];
						local698 = local689 > 0 ? this.anIntArray508[local689] : 0;
				...
				for (local776 = -local32; local776 < 0; local776++) {
					for (local698 = -local35; local698 < 0; local698++) {
						@Pc(1098) byte local1098 = this.aByteArray62[local29++];
						if (local1098 == 0) {
							local27++;
						} else {
							local970 = this.anIntArray508[local1098 & 0xFF];
			...
			for (local678 = -local32; local678 < 0; local678++) {
				for (local682 = -local35; local682 < 0; local682++) {
					...
					if (local689 == 0) {
						...
						local698 = this.anIntArray508[local689 & 0xFF];
			...
			for (local698 = -local32; local698 < 0; local698++) {
				for (local702 = -local35; local702 < 0; local702++) {
					@Pc(790) byte local790 = this.aByteArray62[local29++];
					if (local790 == 0) {
						local27++;
					} else {
						local799 = this.anIntArray508[local790 & 0xFF];
						@Pc(810) int local810;
						@Pc(818) int local818;
						@Pc(826) int local826;
						if (local682 == 255) {
