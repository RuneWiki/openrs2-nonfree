...
public final class Class9 {
	...
	public static void method287() {
		try {
			...
			signlink.reporterror("91067, " + 0 + ", " + local19.toString());
	...
	private void method290(@OriginalArg(0) Class1_Sub1_Sub3 arg0) {
		try {
			...
			signlink.reporterror("44886, " + arg0 + ", " + 8 + ", " + local529.toString());
			throw new RuntimeException();
		}
	}
		...
		try {
			if (this.anIntArray157 != null) {
				for (@Pc(54) int local54 = 0; local54 < this.anIntArray157.length; local54++) {
					if (this.anIntArray157[local54] == arg0) {
						return Class1_Sub1_Sub1_Sub5.method262(this.anIntArray156[local54] & 0xFFFF);
					}
				}
				return true;
				...
				for (@Pc(32) int local32 = 0; local32 < this.anIntArray156.length; local32++) {
					local30 &= Class1_Sub1_Sub1_Sub5.method262(this.anIntArray156[local32] & 0xFFFF);
				}
				return local30;
			} else {
				return true;
			...
			signlink.reporterror("63602, " + 3 + ", " + arg0 + ", " + local79.toString());
			throw new RuntimeException();
		}
	}
	...
	public boolean method292() {
		try {
			...
			for (@Pc(8) int local8 = 0; local8 < this.anIntArray156.length; local8++) {
				local6 &= Class1_Sub1_Sub1_Sub5.method262(this.anIntArray156[local8] & 0xFFFF);
			}
			return local6;
		} catch (@Pc(36) RuntimeException local36) {
			signlink.reporterror("10989, " + 2 + ", " + local36.toString());
			throw new RuntimeException();
		}
	}
		...
		try {
			if (this.anIntArray156 != null) {
				for (@Pc(7) int local7 = 0; local7 < this.anIntArray156.length; local7++) {
					arg1.method650(0, this.anIntArray156[local7] & 0xFFFF);
				}
				while (arg0 >= 0) {
	...
	public Class1_Sub1_Sub1_Sub5 method294(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(6) Class1_Sub1_Sub1_Sub5 local6 = this.method295(arg6, arg0, arg1);
		if (local6 == null) {
			return null;
		}
	...
	private Class1_Sub1_Sub1_Sub5 method295(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
		try {
			...
			if (this.anIntArray157 == null) {
				...
				local26 = (long) ((this.anInt512 << 6) + arg2) + ((long) (arg0 + 1) << 32);
				...
				local50 = this.aBoolean124 ^ arg2 > 3;
				...
				if (local54 > 1) {
					local3 = new Class1_Sub1_Sub1_Sub5(local54, -314, aClass1_Sub1_Sub1_Sub5Array1);
				}
			} else {
				...
				local26 = (long) ((this.anInt512 << 6) + (local121 << 3) + arg2) + ((long) (arg0 + 1) << 32);
				local170 = (Class1_Sub1_Sub1_Sub5) aClass40_5.method591(local26);
				if (local170 != null) {
					return local170;
				}
				local56 = this.anIntArray156[local121];
				@Pc(189) boolean local189 = this.aBoolean124 ^ arg2 > 3;
				if (local189) {
					local56 += 65536;
				}
			...
			local170 = new Class1_Sub1_Sub1_Sub5(Class12.method306(arg0), arg2 == 0 && arg0 == -1 && !local238 && !local50, this.anIntArray158 == null, local3, 0);
			if (arg0 != -1) {
				local170.method268();
			...
			if (local238) {
				local170.method277(this.anInt519, this.anInt521, this.anInt520);
			}
			if (local50) {
				local170.method274(this.anInt523, this.anInt524, this.anInt522);
			}
			local170.method278(this.aByte14 + 64, this.aByte15 * 5 + 768, -50, -10, -50, !this.aBoolean122);
			if (this.anInt526 == 1) {
				local170.anInt502 = local170.anInt986;
			}
			aClass40_5.method592(local26, local170);
			return local170;
		} catch (@Pc(396) RuntimeException local396) {
			signlink.reporterror("60674, " + arg0 + ", " + arg1 + ", " + true + ", " + arg2 + ", " + local396.toString());
			throw new RuntimeException();
		}
	}
	...
	public Class9 method296(@OriginalArg(0) byte arg0) {
		try {
			...
			if (this.anInt527 != -1) {
				@Pc(20) Class36 local20 = Class36.aClass36Array1[this.anInt527];
				...
				local1 = aClient2.anIntArray50[local23] >> local26 & local35;
			} else if (this.anInt528 != -1) {
				local1 = aClient2.anIntArray50[this.anInt528];
			}
