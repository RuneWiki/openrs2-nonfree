...
public final class Class12_Sub17 extends Class12 {

	@OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(ILclient!sf;)V")
	public Class12_Sub17(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub50 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(Lclient!sf;)V")
	public Class12_Sub17(@OriginalArg(0) Class5_Sub50 arg0) {
		super(arg0);
	}
