...
public final class Class44 {
	...
	public int[] method576(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (this.aClass42_3 != null) {
			...
			local36 = (int) ((double) (this.aClass42_3.anInt828 - this.aClass42_3.anInt827) * 32.768D / local26);
			local38 = (int) ((double) this.aClass42_3.anInt827 * 32.768D / local26);
		}
		@Pc(77) int local77 = 0;
		@Pc(79) int local79 = 0;
		@Pc(81) int local81 = 0;
		if (this.aClass42_5 != null) {
			...
			local77 = (int) ((double) (this.aClass42_5.anInt828 - this.aClass42_5.anInt827) * 32.768D / local26);
			local79 = (int) ((double) this.aClass42_5.anInt827 * 32.768D / local26);
		}
		for (@Pc(118) int local118 = 0; local118 < 5; local118++) {
			if (this.anIntArray236[local118] != 0) {
				...
				anIntArray245[local118] = (int) ((double) (this.aClass42_1.anInt828 - this.aClass42_1.anInt827) * 32.768D * Math.pow(1.0057929410678534D, (double) this.anIntArray237[local118]) / local26);
				anIntArray246[local118] = (int) ((double) this.aClass42_1.anInt827 * 32.768D / local26);
			}
		}
		@Pc(201) int local201;
		@Pc(207) int local207;
		...
		for (@Pc(193) int local193 = 0; local193 < arg0; local193++) {
			...
			if (this.aClass42_3 != null) {
				...
				local201 += this.method577(local222, local40, this.aClass42_3.anInt829) >> 1;
				local40 += (local216 * local36 >> 16) + local38;
			}
			if (this.aClass42_5 != null) {
				local216 = this.aClass42_5.method554(arg0);
				local222 = this.aClass42_6.method554(arg0);
				local207 = local207 * ((this.method577(local222, local81, this.aClass42_5.anInt829) >> 1) + 32768) >> 15;
			...
			for (local216 = 0; local216 < 5; local216++) {
				if (this.anIntArray236[local216] != 0) {
					...
					if (local222 < arg0) {
						anIntArray239[local222] += this.method577(local207 * anIntArray244[local216] >> 15, anIntArray242[local216], this.aClass42_1.anInt829);
		...
		if (this.aClass42_7 != null) {
			...
			for (local222 = 0; local222 < arg0; local222++) {
				...
				if (local369) {
					local207 = this.aClass42_7.anInt827 + ((this.aClass42_7.anInt828 - this.aClass42_7.anInt827) * local379 >> 8);
				} else {
					local207 = this.aClass42_7.anInt827 + ((this.aClass42_7.anInt828 - this.aClass42_7.anInt827) * local385 >> 8);
				}
				local201 += 256;
	...
	private int method577(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		try {
			if (this.anInt952 != -15143) {
				return 2;
			} else if (arg2 == 1) {
			...
			signlink.reporterror("41611, " + -15143 + ", " + arg0 + ", " + arg1 + ", " + arg2 + ", " + local60.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!zb", name = "a", descriptor = "(ZLclient!kb;)V")
	public void method578(@OriginalArg(1) Class1_Sub3_Sub3 arg0) {
		try {
			...
			signlink.reporterror("36876, " + false + ", " + arg0 + ", " + local173.toString());
			throw new RuntimeException();
		}
	}
}
