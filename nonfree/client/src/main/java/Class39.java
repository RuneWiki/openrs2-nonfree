...
public final class Class39 {
	...
	private void method535(@OriginalArg(1) byte[] arg0) {
		try {
			...
			this.anInt771 = local7.method393();
			...
			@Pc(82) int local82 = local7.anInt561 + this.anInt771 * 10;
			for (@Pc(84) int local84 = 0; local84 < this.anInt771; local84++) {
			...
			signlink.reporterror("40193, " + true + ", " + arg0 + ", " + local123.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!ub", name = "a", descriptor = "(Ljava/lang/String;[BB)[B")
	public byte[] method536(@OriginalArg(0) String arg0, @OriginalArg(1) byte[] arg1) {
		try {
			@Pc(3) int local3 = 0;
			...
			for (@Pc(27) int local27 = 0; local27 < this.anInt771; local27++) {
				if (this.anIntArray221[local27] == local3) {
					...
					if (this.aBoolean152) {
						...
						Class34.method519(arg1, this.anIntArray222[local27], this.aByteArray14, this.anIntArray223[local27], this.anIntArray224[local27]);
					}
					return arg1;
				}
			}
			...
			signlink.reporterror("98811, " + arg0 + ", " + arg1 + ", " + 2 + ", " + local106.toString());
			throw new RuntimeException();
		}
	}
}
