...
public final class Static117 {
	...
	@OriginalMember(owner = "client!va", name = "a", descriptor = "(Lclient!me;II)Lclient!va;")
	public static Class1_Sub12_Sub2 method1789(@OriginalArg(0) Class1_Sub10_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray20 == null || arg0.aByteArray20.length == 0 ? null : new Class1_Sub12_Sub2(arg0, (int) ((long) arg0.anInt1557 * 256L * (long) 100 / (long) (Static7.anInt234 * 100)), arg1);
	}

	@OriginalMember(owner = "client!va", name = "a", descriptor = "([B[IIIIIIIIILclient!va;)I")
	public static int method1790(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class1_Sub12_Sub2 arg9) {
		arg2 >>= 0x8;
		...
		arg9.anInt2654 = arg4 >> 8;
		arg9.anInt2658 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!va", name = "a", descriptor = "(II[B[IIIIIIIIILclient!va;II)I")
	public static int method1791(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) Class1_Sub12_Sub2 arg9, @OriginalArg(13) int arg10, @OriginalArg(14) int arg11) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!va", name = "a", descriptor = "(II[B[IIIIIIILclient!va;II)I")
	public static int method1792(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub12_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!va", name = "b", descriptor = "(II[B[IIIIIIILclient!va;II)I")
	public static int method1795(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub12_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!va", name = "a", descriptor = "([B[IIIIIIILclient!va;)I")
	public static int method1798(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub12_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt2658 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!va", name = "b", descriptor = "([B[IIIIIIIIILclient!va;)I")
	public static int method1799(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class1_Sub12_Sub2 arg9) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg8 >> 8;
		arg4 <<= 0x8;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!va", name = "b", descriptor = "([B[IIIIIIILclient!va;)I")
	public static int method1800(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub12_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 8;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!va", name = "b", descriptor = "(II[B[IIIIIIIIILclient!va;II)I")
	public static int method1801(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) Class1_Sub12_Sub2 arg9, @OriginalArg(13) int arg10, @OriginalArg(14) int arg11) {
		@Pc(14) int local14;
