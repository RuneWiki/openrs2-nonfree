		...
		try {
			...
			while (true) {
				...
				if (local31 == 4) {
					...
					if (local121 != -1 && (!Static105.method1669(local121).aBoolean66 || Static18.aBoolean37)) {
			...
			for (@Pc(47) int local47 = 0; local47 < local25; local47++) {
				if (Static51.aClass2_Sub2_Sub13ArrayArray1[arg0][local47] == null) {
					...
					if (local61 != null) {
						...
						Static51.aClass2_Sub2_Sub13ArrayArray1[arg0][local47].method1053(new Class2_Sub3(local61));
					}
				}
			}
			Static92.aBooleanArray31[arg0] = true;
