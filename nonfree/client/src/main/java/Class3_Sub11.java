...
public final class Class3_Sub11 extends Class3 {
	...
	private float[] method1444(@OriginalArg(0) int arg0) {
		Static87.method1443(this.aByteArrayArray6[arg0]);
		Static87.method1445();
		@Pc(15) int local15 = Static87.method1447(Static25.method311(Static87.anIntArray172.length - 1));
		@Pc(19) boolean local19 = Static87.aBooleanArray33[local15];
		@Pc(25) int local25 = local19 ? Static87.anInt1777 : Static87.anInt1775;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static87.method1445() != 0;
			local29 = Static87.method1445() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static87.anInt1775 >> 2);
			local67 = (local25 >> 2) + (Static87.anInt1775 >> 2);
			local71 = Static87.anInt1775 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static87.anInt1775 >> 2);
			local104 = local25 + (Static87.anInt1775 >> 2) - (local25 >> 2);
			local108 = Static87.anInt1775 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class201 local123 = Static87.aClass201Array1[Static87.anIntArray172[local15]];
		@Pc(126) int local126 = local123.anInt5081;
		@Pc(131) int local131 = local123.anIntArray565[local126];
		@Pc(140) boolean local140 = !Static87.aClass18Array1[local131].method214();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt5082; local144++) {
			@Pc(152) Class94 local152 = Static87.aClass94Array1[local123.anIntArray564[local144]];
			local154 = Static87.aFloatArray3;
			local152.method1919(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt5081;
			local176 = local123.anIntArray565[local171];
			Static87.aClass18Array1[local176].method211(Static87.aFloatArray3, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static87.aFloatArray3[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static87.aFloatArray3;
			...
			@Pc(252) float[] local252 = local19 ? Static87.aFloatArray6 : Static87.aFloatArray8;
			@Pc(258) float[] local258 = local19 ? Static87.aFloatArray9 : Static87.aFloatArray5;
			@Pc(264) float[] local264 = local19 ? Static87.aFloatArray4 : Static87.aFloatArray10;
			@Pc(270) int[] local270 = local19 ? Static87.anIntArray174 : Static87.anIntArray173;
			...
			@Pc(486) int local486 = Static25.method311(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static87.aFloatArray3[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static87.aFloatArray3[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt1778 > 0) {
			local176 = this.anInt1778 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean140) {
				for (local212 = 0; local212 < this.anInt1779; local212++) {
					local1254 = (this.anInt1778 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static87.aFloatArray3[local212];
				}
			}
		}
		local154 = this.aFloatArray7;
		this.aFloatArray7 = Static87.aFloatArray3;
		Static87.aFloatArray3 = local154;
		this.anInt1778 = local25;
		this.anInt1779 = local104 - (local25 >> 1);
		this.aBoolean140 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!el", name = "a", descriptor = "([I)Lclient!nd;")
	public Class3_Sub29_Sub1 method1449(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray32 == null) {
			this.anInt1778 = 0;
			this.aFloatArray7 = new float[Static87.anInt1777];
			this.aByteArray32 = new byte[this.anInt1784];
			this.anInt1785 = 0;
			this.anInt1786 = 0;
		}
		while (this.anInt1786 < this.aByteArrayArray6.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1444(this.anInt1786);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt1785;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt1784 - local47) {
					local50 = this.anInt1784 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray32[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt1785;
				}
				this.anInt1785 = local47;
			}
			this.anInt1786++;
		}
		this.aFloatArray7 = null;
		@Pc(129) byte[] local129 = this.aByteArray32;
		this.aByteArray32 = null;
		return new Class3_Sub29_Sub1(this.anInt1776, local129, this.anInt1783, this.anInt1782, this.aBoolean139);
	}

	@OriginalMember(owner = "client!el", name = "b", descriptor = "([B)V")
	private void method1452(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class3_Sub5 local4 = new Class3_Sub5(arg0);
		this.anInt1776 = local4.method2726();
		this.anInt1784 = local4.method2726();
		this.anInt1783 = local4.method2726();
		this.anInt1782 = local4.method2726();
		if (this.anInt1782 < 0) {
			this.anInt1782 = ~this.anInt1782;
			this.aBoolean139 = true;
		}
		@Pc(40) int local40 = local4.method2726();
		this.aByteArrayArray6 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method2739();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method2744(local64, local49);
