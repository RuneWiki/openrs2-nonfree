...
public final class Class2_Sub24 extends Class2 {
	...
	private void method2779(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub3 local4 = new Class2_Sub3(arg0);
		this.anInt4039 = local4.method185();
		this.anInt4042 = local4.method185();
		this.anInt4045 = local4.method185();
		this.anInt4043 = local4.method185();
		if (this.anInt4043 < 0) {
			this.anInt4043 = ~this.anInt4043;
			this.aBoolean249 = true;
		}
		@Pc(40) int local40 = local4.method185();
		this.aByteArrayArray10 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method209();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method169(local49, local64);
			this.aByteArrayArray10[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!rj", name = "a", descriptor = "([I)Lclient!tf;")
	public Class2_Sub9_Sub1 method2788(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray57 == null) {
			this.anInt4046 = 0;
			this.aFloatArray3 = new float[Static172.anInt4041];
			this.aByteArray57 = new byte[this.anInt4042];
			this.anInt4048 = 0;
			this.anInt4049 = 0;
		}
		while (this.anInt4049 < this.aByteArrayArray10.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method2789(this.anInt4049);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt4048;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt4042 - local47) {
					local50 = this.anInt4042 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt4048;
				}
				this.anInt4048 = local47;
			}
			this.anInt4049++;
		}
		...
		return new Class2_Sub9_Sub1(this.anInt4039, local129, this.anInt4045, this.anInt4043, this.aBoolean249);
	}

	@OriginalMember(owner = "client!rj", name = "d", descriptor = "(I)[F")
	private float[] method2789(@OriginalArg(0) int arg0) {
		Static172.method2783(this.aByteArrayArray10[arg0]);
		Static172.method2781();
		@Pc(15) int local15 = Static172.method2786(Static50.method1506(Static172.anIntArray423.length - 1));
		@Pc(19) boolean local19 = Static172.aBooleanArray20[local15];
		@Pc(25) int local25 = local19 ? Static172.anInt4041 : Static172.anInt4047;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static172.method2781() != 0;
			local29 = Static172.method2781() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static172.anInt4047 >> 2);
			local67 = (local25 >> 2) + (Static172.anInt4047 >> 2);
			local71 = Static172.anInt4047 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static172.anInt4047 >> 2);
			local104 = local25 + (Static172.anInt4047 >> 2) - (local25 >> 2);
			local108 = Static172.anInt4047 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class40 local123 = Static172.aClass40Array1[Static172.anIntArray423[local15]];
		@Pc(126) int local126 = local123.anInt1895;
		@Pc(131) int local131 = local123.anIntArray189[local126];
		@Pc(140) boolean local140 = !Static172.aClass48Array1[local131].method1544();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt1896; local144++) {
			@Pc(152) Class4 local152 = Static172.aClass4Array1[local123.anIntArray190[local144]];
			local154 = Static172.aFloatArray9;
			local152.method86(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt1895;
			local176 = local123.anIntArray189[local171];
			Static172.aClass48Array1[local176].method1539(Static172.aFloatArray9, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static172.aFloatArray9[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static172.aFloatArray9;
			...
			@Pc(252) float[] local252 = local19 ? Static172.aFloatArray6 : Static172.aFloatArray8;
			@Pc(258) float[] local258 = local19 ? Static172.aFloatArray4 : Static172.aFloatArray2;
			@Pc(264) float[] local264 = local19 ? Static172.aFloatArray7 : Static172.aFloatArray5;
			@Pc(270) int[] local270 = local19 ? Static172.anIntArray424 : Static172.anIntArray422;
			...
			@Pc(486) int local486 = Static50.method1506(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static172.aFloatArray9[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static172.aFloatArray9[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt4046 > 0) {
			local176 = this.anInt4046 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean250) {
				for (local212 = 0; local212 < this.anInt4044; local212++) {
					local1254 = (this.anInt4046 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static172.aFloatArray9[local212];
				}
			}
		}
		local154 = this.aFloatArray3;
		this.aFloatArray3 = Static172.aFloatArray9;
		Static172.aFloatArray9 = local154;
		this.anInt4046 = local25;
		this.anInt4044 = local104 - (local25 >> 1);
		this.aBoolean250 = local140;
		return local1228;
	}
}
