...
public final class Class6_Sub22 extends Class6 {
	...
	@OriginalMember(owner = "client!so", name = "<init>", descriptor = "(ILclient!ah;)V")
	public Class6_Sub22(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub5 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!so", name = "<init>", descriptor = "(Lclient!ah;)V")
	public Class6_Sub22(@OriginalArg(0) Class2_Sub5 arg0) {
		super(arg0);
	}
	...
	public void method8576() {
		if (super.anInt10283 < 0 && super.anInt10283 > 127) {
