...
public final class Class6_Sub22 extends Class6 {
	...
	public Class6_Sub22(@OriginalArg(0) byte[] arg0) {
		this.method3459(arg0);
	}

	@OriginalMember(owner = "client!hl", name = "a", descriptor = "([I)Lclient!ft;")
	public Class6_Sub19_Sub1 method3458(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray36 == null) {
			this.anInt3964 = 0;
			this.aFloatArray33 = new float[Static191.anInt3965];
			this.aByteArray36 = new byte[this.anInt3961];
			this.anInt3969 = 0;
			this.anInt3970 = 0;
		}
		while (this.anInt3970 < this.aByteArrayArray11.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method3464(this.anInt3970);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt3969;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt3961 - local47) {
					local50 = this.anInt3961 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray36[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt3969;
				}
				this.anInt3969 = local47;
			}
			this.anInt3970++;
		}
		this.aFloatArray33 = null;
		@Pc(129) byte[] local129 = this.aByteArray36;
		this.aByteArray36 = null;
		return new Class6_Sub19_Sub1(this.anInt3968, local129, this.anInt3966, this.anInt3967, this.aBoolean269);
	}

	@OriginalMember(owner = "client!hl", name = "b", descriptor = "([B)V")
	private void method3459(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class6_Sub21 local4 = new Class6_Sub21(arg0);
		this.anInt3968 = local4.method6036();
		this.anInt3961 = local4.method6036();
		this.anInt3966 = local4.method6036();
		this.anInt3967 = local4.method6036();
		if (this.anInt3967 < 0) {
			this.anInt3967 = ~this.anInt3967;
			this.aBoolean269 = true;
		}
		@Pc(40) int local40 = local4.method6036();
		this.aByteArrayArray11 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method6069();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method6053(local49, local64);
			this.aByteArrayArray11[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!hl", name = "b", descriptor = "(I)[F")
	private float[] method3464(@OriginalArg(0) int arg0) {
		Static191.method3468(this.aByteArrayArray11[arg0]);
		Static191.method3463();
		@Pc(15) int local15 = Static191.method3462(Static564.method7583(Static191.anIntArray245.length - 1));
		@Pc(19) boolean local19 = Static191.aBooleanArray16[local15];
		@Pc(25) int local25 = local19 ? Static191.anInt3965 : Static191.anInt3959;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static191.method3463() != 0;
			local29 = Static191.method3463() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static191.anInt3959 >> 2);
			local67 = (local25 >> 2) + (Static191.anInt3959 >> 2);
			local71 = Static191.anInt3959 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static191.anInt3959 >> 2);
			local104 = local25 + (Static191.anInt3959 >> 2) - (local25 >> 2);
			local108 = Static191.anInt3959 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class217 local123 = Static191.aClass217Array1[Static191.anIntArray245[local15]];
		@Pc(126) int local126 = local123.anInt6062;
		@Pc(131) int local131 = local123.anIntArray443[local126];
		@Pc(140) boolean local140 = !Static191.aClass48Array1[local131].method1289();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt6061; local144++) {
			@Pc(152) Class226 local152 = Static191.aClass226Array1[local123.anIntArray444[local144]];
			local154 = Static191.aFloatArray36;
			local152.method5329(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt6062;
			local176 = local123.anIntArray443[local171];
			Static191.aClass48Array1[local176].method1292(Static191.aFloatArray36, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static191.aFloatArray36[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static191.aFloatArray36;
			...
			@Pc(252) float[] local252 = local19 ? Static191.aFloatArray31 : Static191.aFloatArray30;
			@Pc(258) float[] local258 = local19 ? Static191.aFloatArray35 : Static191.aFloatArray34;
			@Pc(264) float[] local264 = local19 ? Static191.aFloatArray32 : Static191.aFloatArray37;
			@Pc(270) int[] local270 = local19 ? Static191.anIntArray247 : Static191.anIntArray246;
			...
			@Pc(486) int local486 = Static564.method7583(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static191.aFloatArray36[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static191.aFloatArray36[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt3964 > 0) {
			local176 = this.anInt3964 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean270) {
				for (local212 = 0; local212 < this.anInt3962; local212++) {
					local1254 = (this.anInt3964 >> 1) + local212;
					local1228[local212] += this.aFloatArray33[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static191.aFloatArray36[local212];
				}
			}
		}
		local154 = this.aFloatArray33;
		this.aFloatArray33 = Static191.aFloatArray36;
		Static191.aFloatArray36 = local154;
		this.anInt3964 = local25;
		this.anInt3962 = local104 - (local25 >> 1);
		this.aBoolean270 = local140;
		return local1228;
	}
}
