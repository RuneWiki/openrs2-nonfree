...
public final class Class1_Sub18 extends Class1 {
	...
	private float[] method2468(@OriginalArg(0) int arg0) {
		Static130.method2475(this.aByteArrayArray6[arg0]);
		Static130.method2478();
		@Pc(15) int local15 = Static130.method2477(Static67.method1314(Static130.anIntArray250.length - 1));
		@Pc(19) boolean local19 = Static130.aBooleanArray12[local15];
		@Pc(25) int local25 = local19 ? Static130.anInt3277 : Static130.anInt3271;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static130.method2478() != 0;
			local29 = Static130.method2478() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static130.anInt3271 >> 2);
			local67 = (local25 >> 2) + (Static130.anInt3271 >> 2);
			local71 = Static130.anInt3271 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static130.anInt3271 >> 2);
			local104 = local25 + (Static130.anInt3271 >> 2) - (local25 >> 2);
			local108 = Static130.anInt3271 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class106 local123 = Static130.aClass106Array1[Static130.anIntArray250[local15]];
		@Pc(126) int local126 = local123.anInt4173;
		@Pc(131) int local131 = local123.anIntArray310[local126];
		@Pc(140) boolean local140 = !Static130.aClass29Array1[local131].method731();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt4174; local144++) {
			@Pc(152) Class44 local152 = Static130.aClass44Array1[local123.anIntArray311[local144]];
			local154 = Static130.aFloatArray3;
			local152.method1445(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt4173;
			local176 = local123.anIntArray310[local171];
			Static130.aClass29Array1[local176].method735(Static130.aFloatArray3, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static130.aFloatArray3[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static130.aFloatArray3;
			...
			@Pc(252) float[] local252 = local19 ? Static130.aFloatArray6 : Static130.aFloatArray5;
			@Pc(258) float[] local258 = local19 ? Static130.aFloatArray4 : Static130.aFloatArray7;
			@Pc(264) float[] local264 = local19 ? Static130.aFloatArray2 : Static130.aFloatArray8;
			@Pc(270) int[] local270 = local19 ? Static130.anIntArray251 : Static130.anIntArray252;
			...
			@Pc(486) int local486 = Static67.method1314(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static130.aFloatArray3[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static130.aFloatArray3[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt3275 > 0) {
			local176 = this.anInt3275 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean172) {
				for (local212 = 0; local212 < this.anInt3280; local212++) {
					local1254 = (this.anInt3275 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static130.aFloatArray3[local212];
				}
			}
		}
		local154 = this.aFloatArray9;
		this.aFloatArray9 = Static130.aFloatArray3;
		Static130.aFloatArray3 = local154;
		this.anInt3275 = local25;
		this.anInt3280 = local104 - (local25 >> 1);
		this.aBoolean172 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!la", name = "a", descriptor = "([B)V")
	private void method2471(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub13 local4 = new Class1_Sub13(arg0);
		this.anInt3274 = local4.method1802();
		this.anInt3272 = local4.method1802();
		this.anInt3273 = local4.method1802();
		this.anInt3278 = local4.method1802();
		if (this.anInt3278 < 0) {
			this.anInt3278 = ~this.anInt3278;
			this.aBoolean174 = true;
		}
		@Pc(40) int local40 = local4.method1802();
		this.aByteArrayArray6 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method1772();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method1787(local49, local64);
			this.aByteArrayArray6[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!la", name = "a", descriptor = "([I)Lclient!ec;")
	public Class1_Sub7_Sub1 method2474(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray43 == null) {
			this.anInt3275 = 0;
			this.aFloatArray9 = new float[Static130.anInt3277];
			this.aByteArray43 = new byte[this.anInt3272];
			this.anInt3282 = 0;
			this.anInt3281 = 0;
		}
		while (this.anInt3281 < this.aByteArrayArray6.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method2468(this.anInt3281);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt3282;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt3272 - local47) {
					local50 = this.anInt3272 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt3282;
				}
				this.anInt3282 = local47;
			}
			this.anInt3281++;
		}
		...
		return new Class1_Sub7_Sub1(this.anInt3274, local129, this.anInt3273, this.anInt3278, this.aBoolean174);
	}
}
