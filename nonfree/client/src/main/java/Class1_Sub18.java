...
public final class Class1_Sub18 extends Class1 {
	...
	@OriginalMember(owner = "client!li", name = "a", descriptor = "([I)Lclient!mg;")
	public Class1_Sub19_Sub1 method2012(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray34 == null) {
			this.anInt2673 = 0;
			this.aFloatArray4 = new float[Static110.anInt2677];
			this.aByteArray34 = new byte[this.anInt2678];
			this.anInt2682 = 0;
			this.anInt2681 = 0;
		}
		while (this.anInt2681 < this.aByteArrayArray27.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method2017(this.anInt2681);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2682;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt2678 - local47) {
					local50 = this.anInt2678 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2682;
				}
				this.anInt2682 = local47;
			}
			this.anInt2681++;
		}
		...
		return new Class1_Sub19_Sub1(this.anInt2671, local129, this.anInt2679, this.anInt2674, this.aBoolean108);
	}

	@OriginalMember(owner = "client!li", name = "c", descriptor = "(I)[F")
	private float[] method2017(@OriginalArg(0) int arg0) {
		Static110.method2019(this.aByteArrayArray27[arg0]);
		Static110.method2018();
		@Pc(15) int local15 = Static110.method2016(Static131.method2505(Static110.anIntArray305.length - 1));
		@Pc(19) boolean local19 = Static110.aBooleanArray14[local15];
		@Pc(25) int local25 = local19 ? Static110.anInt2677 : Static110.anInt2676;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static110.method2018() != 0;
			local29 = Static110.method2018() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static110.anInt2676 >> 2);
			local67 = (local25 >> 2) + (Static110.anInt2676 >> 2);
			local71 = Static110.anInt2676 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static110.anInt2676 >> 2);
			local104 = local25 + (Static110.anInt2676 >> 2) - (local25 >> 2);
			local108 = Static110.anInt2676 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class61 local123 = Static110.aClass61Array1[Static110.anIntArray305[local15]];
		@Pc(126) int local126 = local123.anInt3080;
		@Pc(131) int local131 = local123.anIntArray357[local126];
		@Pc(140) boolean local140 = !Static110.aClass38Array1[local131].method1349();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt3081; local144++) {
			@Pc(152) Class24 local152 = Static110.aClass24Array1[local123.anIntArray358[local144]];
			local154 = Static110.aFloatArray8;
			local152.method763(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt3080;
			local176 = local123.anIntArray357[local171];
			Static110.aClass38Array1[local176].method1350(Static110.aFloatArray8, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static110.aFloatArray8[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static110.aFloatArray8;
			...
			@Pc(252) float[] local252 = local19 ? Static110.aFloatArray3 : Static110.aFloatArray9;
			@Pc(258) float[] local258 = local19 ? Static110.aFloatArray6 : Static110.aFloatArray2;
			@Pc(264) float[] local264 = local19 ? Static110.aFloatArray5 : Static110.aFloatArray7;
			@Pc(270) int[] local270 = local19 ? Static110.anIntArray303 : Static110.anIntArray304;
			...
			@Pc(486) int local486 = Static131.method2505(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static110.aFloatArray8[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static110.aFloatArray8[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt2673 > 0) {
			local176 = this.anInt2673 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean109) {
				for (local212 = 0; local212 < this.anInt2675; local212++) {
					local1254 = (this.anInt2673 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static110.aFloatArray8[local212];
				}
			}
		}
		local154 = this.aFloatArray4;
		this.aFloatArray4 = Static110.aFloatArray8;
		Static110.aFloatArray8 = local154;
		this.anInt2673 = local25;
		this.anInt2675 = local104 - (local25 >> 1);
		this.aBoolean109 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!li", name = "b", descriptor = "([B)V")
	private void method2020(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub14 local4 = new Class1_Sub14(arg0);
		this.anInt2671 = local4.method1700();
		this.anInt2678 = local4.method1700();
		this.anInt2679 = local4.method1700();
		this.anInt2674 = local4.method1700();
		if (this.anInt2674 < 0) {
			this.anInt2674 = ~this.anInt2674;
			this.aBoolean108 = true;
		}
		@Pc(40) int local40 = local4.method1700();
		this.aByteArrayArray27 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method1738();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method1719(local49, local64);
			this.aByteArrayArray27[local46] = local64;
		}
	}
}
