...
public final class Class169 {
	...
	public Class169(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18) {
		...
		@Pc(534) int[] local534 = Static274.anIntArrayArray44[arg0];
		local86 = local534.length / 4;
		this.anIntArray580 = new int[local86];
		this.anIntArray579 = new int[local86];
		this.anIntArray586 = new int[local86];
		this.anIntArray576 = new int[local86];
		this.anIntArray575 = new int[local86];
		this.anIntArray574 = new int[local86];
		if (arg2 != -1) {
			this.anIntArray572 = new int[local86];
		}
		local142 = 0;
		for (local144 = 0; local144 < local86; local144++) {
			...
			this.anIntArray580[local144] = local148;
			this.anIntArray579[local144] = local150;
			this.anIntArray586[local144] = local599;
			if (local146 == 0) {
				this.anIntArray576[local144] = local66[local148];
				this.anIntArray575[local144] = local66[local150];
				this.anIntArray574[local144] = local66[local599];
				if (this.anIntArray572 != null) {
					this.anIntArray572[local144] = -1;
				}
			} else {
				this.anIntArray576[local144] = local69[local148];
				this.anIntArray575[local144] = local69[local150];
				this.anIntArray574[local144] = local69[local599];
				if (this.anIntArray572 != null) {
					this.anIntArray572[local144] = arg2;
				}
			}
		}
		local144 = arg5;
