...
public final class ma implements Interface4 {
	...
	@OriginalMember(owner = "client!ma", name = "g", descriptor = "Lclient!h;")
	private final h aH2;
	...
	public native void J(@OriginalArg(0) Class70 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean[][] arg8);

	@OriginalMember(owner = "client!ma", name = "za", descriptor = "(Lclient!qa;[Lclient!c;Lclient!ia;[III)V")
	public native void za(@OriginalArg(0) Class121 arg0, @OriginalArg(1) Class37[] arg1, @OriginalArg(2) Class43 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5);
	...
	public native void sa(@OriginalArg(0) Class121 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);

	@OriginalMember(owner = "client!ma", name = "ka", descriptor = "(Lclient!na;II)V")
	public native void ka(@OriginalArg(0) Class70 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
	...
	public Class37 method3515(@OriginalArg(0) p arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) p local8;
		@Pc(5) p local5;
		if (arg1 == 1) {
			local5 = this.aP9;
		...
		local8.aClass203Array3 = arg0.aClass203Array3;
		local8.aClass265Array3 = arg0.aClass265Array3;
		return local8;
	}

	@OriginalMember(owner = "client!ma", name = "d", descriptor = "(Lclient!c;Lclient!ia;[III)V")
	public native void d(@OriginalArg(0) Class37 arg0, @OriginalArg(1) Class43 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4);

	@OriginalMember(owner = "client!ma", name = "fa", descriptor = "(Lclient!c;Lclient!ia;[II)V")
	public native void fa(@OriginalArg(0) Class37 arg0, @OriginalArg(1) Class43 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3);

	@OriginalMember(owner = "client!ma", name = "w", descriptor = "(Lclient!qa;II)V")
	private native void w(@OriginalArg(0) Class121 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!ma", name = "ua", descriptor = "(Lclient!c;IILclient!ia;Z)Z")
	public native boolean ua(@OriginalArg(0) Class37 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class43 arg3, @OriginalArg(4) boolean arg4);
}
