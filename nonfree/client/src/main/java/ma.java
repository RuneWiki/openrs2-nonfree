...
public final class ma extends Class82 implements Interface4 {

	@OriginalMember(owner = "client!ma", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ma", name = "<init>", descriptor = "(Lclient!da;Lclient!a;Lclient!mj;[Lclient!kq;[Lclient!xa;)V")
	public ma(@OriginalArg(0) da arg0, @OriginalArg(1) a arg1, @OriginalArg(2) Class202 arg2, @OriginalArg(3) Class177[] arg3, @OriginalArg(4) Class71[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			...
			local11[local25] = arg3[local25].anInt4887;
			local15[local25] = arg3[local25].anInt4884;
			local19[local25] = arg3[local25].anInt4886;
			local23[local25] = arg3[local25].anInt4885;
		}
		this.wa(arg0, arg1, local7, arg3[0].anIntArray399, local11, local15, local19, local23);
	}
	...
	private native void MA(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class17 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
