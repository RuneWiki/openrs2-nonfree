...
public final class ma implements Interface3 {
	...
	public native void ka(@OriginalArg(0) Class106 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
	...
	public native void fa(@OriginalArg(0) Class32 arg0, @OriginalArg(1) Class102 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3);
	...
	public native void d(@OriginalArg(0) Class32 arg0, @OriginalArg(1) Class102 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4);
	...
	public native void f(@OriginalArg(0) Class26 arg0, @OriginalArg(1) Class32 arg1, @OriginalArg(2) Class102 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);

	@OriginalMember(owner = "client!ma", name = "J", descriptor = "(Lclient!na;IIIIIII[[Z)V")
	public native void J(@OriginalArg(0) Class106 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean[][] arg8);

	@OriginalMember(owner = "client!ma", name = "sa", descriptor = "(Lclient!qa;IIIIIII)V")
	public native void sa(@OriginalArg(0) Class26 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);

	@OriginalMember(owner = "client!ma", name = "S", descriptor = "(Lclient!qa;[I[I[I[SI)V")
	public native void S(@OriginalArg(0) Class26 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5);

	@OriginalMember(owner = "client!ma", name = "I", descriptor = "(Lclient!c;Lclient!c;IIIZ)V")
	public native void I(@OriginalArg(0) Class32 arg0, @OriginalArg(1) Class32 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!ma", name = "w", descriptor = "(Lclient!qa;II)V")
	private native void w(@OriginalArg(0) Class26 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
	...
	public native void pa(@OriginalArg(0) Class26 arg0, @OriginalArg(1) Class32[] arg1, @OriginalArg(2) Class102 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);

	@OriginalMember(owner = "client!ma", name = "ua", descriptor = "(Lclient!c;IILclient!ia;Z)Z")
	public native boolean ua(@OriginalArg(0) Class32 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class102 arg3, @OriginalArg(4) boolean arg4);

	@OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lclient!p;BIZ)Lclient!c;")
	public Class32 method3578(@OriginalArg(0) p arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) p local8;
		@Pc(5) p local5;
		if (arg1 == 1) {
			local5 = this.aP4;
		...
		local8.aClass202Array2 = arg0.aClass202Array2;
		local8.aClass17Array2 = arg0.aClass17Array2;
		return local8;
	}

	@OriginalMember(owner = "client!ma", name = "za", descriptor = "(Lclient!qa;[Lclient!c;Lclient!ia;[III)V")
	public native void za(@OriginalArg(0) Class26 arg0, @OriginalArg(1) Class32[] arg1, @OriginalArg(2) Class102 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5);
