...
public final class ma implements Interface5 {
	...
	@OriginalMember(owner = "client!ma", name = "f", descriptor = "Lclient!h;")
	private final h aH2;
	...
	private native void w(@OriginalArg(0) Class30 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!ma", name = "ka", descriptor = "(Lclient!na;II)V")
	public native void ka(@OriginalArg(0) Class146 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!ma", name = "f", descriptor = "(Lclient!qa;Lclient!c;Lclient!ia;[II[I[I[I[S[BI[I)V")
	public native void f(@OriginalArg(0) Class30 arg0, @OriginalArg(1) Class7 arg1, @OriginalArg(2) Class116 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);

	@OriginalMember(owner = "client!ma", name = "I", descriptor = "(Lclient!c;Lclient!c;IIIZ)V")
	public native void I(@OriginalArg(0) Class7 arg0, @OriginalArg(1) Class7 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!ma", name = "sa", descriptor = "(Lclient!qa;IIIIIII)V")
	public native void sa(@OriginalArg(0) Class30 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);

	@OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lclient!p;BIZ)Lclient!c;")
	public Class7 method3319(@OriginalArg(0) p arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) p local8;
		@Pc(5) p local5;
		if (arg1 == 1) {
			local5 = this.aP4;
		...
		local8.aClass56Array3 = arg0.aClass56Array3;
		local8.aClass120Array3 = arg0.aClass120Array3;
		return local8;
	}

	@OriginalMember(owner = "client!ma", name = "pa", descriptor = "(Lclient!qa;[Lclient!c;Lclient!ia;[II[I[I[I[S[BI[I)V")
	public native void pa(@OriginalArg(0) Class30 arg0, @OriginalArg(1) Class7[] arg1, @OriginalArg(2) Class116 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);

	@OriginalMember(owner = "client!ma", name = "J", descriptor = "(Lclient!na;IIIIIII[[Z)V")
	public native void J(@OriginalArg(0) Class146 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean[][] arg8);

	@OriginalMember(owner = "client!ma", name = "za", descriptor = "(Lclient!qa;[Lclient!c;Lclient!ia;[III)V")
	public native void za(@OriginalArg(0) Class30 arg0, @OriginalArg(1) Class7[] arg1, @OriginalArg(2) Class116 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5);
	...
	public native void S(@OriginalArg(0) Class30 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5);
	...
	public native void d(@OriginalArg(0) Class7 arg0, @OriginalArg(1) Class116 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4);
	...
	public native void fa(@OriginalArg(0) Class7 arg0, @OriginalArg(1) Class116 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3);

	@OriginalMember(owner = "client!ma", name = "ua", descriptor = "(Lclient!c;IILclient!ia;Z)Z")
	public native boolean ua(@OriginalArg(0) Class7 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class116 arg3, @OriginalArg(4) boolean arg4);
