...
public final class ma extends Class59 implements Interface8 {

	@OriginalMember(owner = "client!ma", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ma", name = "<init>", descriptor = "(Lclient!da;Lclient!a;Lclient!cq;[Lclient!af;[Lclient!xa;)V")
	public ma(@OriginalArg(0) da arg0, @OriginalArg(1) a arg1, @OriginalArg(2) Class53 arg2, @OriginalArg(3) Class9[] arg3, @OriginalArg(4) Class119[] arg4) {
		super(arg0, arg2);
		...
		this.wa(arg0, arg1, local7, arg3[0].anIntArray90, local11, local15, local19, local23);
	}
	...
	private native void MA(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class10 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
