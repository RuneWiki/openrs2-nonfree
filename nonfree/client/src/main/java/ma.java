...
public final class ma extends Class111 implements Interface5 {

	@OriginalMember(owner = "client!ma", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ma", name = "<init>", descriptor = "(Lclient!da;Lclient!a;Lclient!sga;[Lclient!aw;[Lclient!xa;)V")
	public ma(@OriginalArg(0) da arg0, @OriginalArg(1) a arg1, @OriginalArg(2) Class297 arg2, @OriginalArg(3) Class20[] arg3, @OriginalArg(4) Class37[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray5;
			local11[local25] = arg3[local25].anInt707;
			local15[local25] = arg3[local25].anInt706;
			local19[local25] = arg3[local25].anInt705;
			local23[local25] = arg3[local25].anInt708;
		}
		this.wa(arg0, arg1, local7, arg3[0].anIntArray22, local11, local15, local19, local23);
	}
	...
	private native void MA(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class93 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
