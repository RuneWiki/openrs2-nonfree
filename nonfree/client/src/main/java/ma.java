...
public final class ma implements Interface4 {
	...
	@OriginalMember(owner = "client!ma", name = "b", descriptor = "Lclient!h;")
	private final h aH2;
	...
	public native void za(@OriginalArg(0) Class128 arg0, @OriginalArg(1) Class33[] arg1, @OriginalArg(2) Class40 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5);

	@OriginalMember(owner = "client!ma", name = "ka", descriptor = "(Lclient!na;II)V")
	public native void ka(@OriginalArg(0) Class163 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lclient!p;BIZ)Lclient!c;")
	public Class33 method3133(@OriginalArg(0) p arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) p local8;
		@Pc(5) p local5;
		if (arg1 == 1) {
			local5 = this.aP8;
		...
		local8.aClass239Array1 = arg0.aClass239Array1;
		local8.aClass15Array1 = arg0.aClass15Array1;
		return local8;
	}

	@OriginalMember(owner = "client!ma", name = "fa", descriptor = "(Lclient!c;Lclient!ia;[II)V")
	public native void fa(@OriginalArg(0) Class33 arg0, @OriginalArg(1) Class40 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3);

	@OriginalMember(owner = "client!ma", name = "w", descriptor = "(Lclient!qa;II)V")
	private native void w(@OriginalArg(0) Class128 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
	...
	public native void J(@OriginalArg(0) Class163 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean[][] arg8);
	...
	public native void pa(@OriginalArg(0) Class128 arg0, @OriginalArg(1) Class33[] arg1, @OriginalArg(2) Class40 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);
	...
	public native void S(@OriginalArg(0) Class128 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5);

	@OriginalMember(owner = "client!ma", name = "d", descriptor = "(Lclient!c;Lclient!ia;[III)V")
	public native void d(@OriginalArg(0) Class33 arg0, @OriginalArg(1) Class40 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4);

	@OriginalMember(owner = "client!ma", name = "sa", descriptor = "(Lclient!qa;IIIIIII)V")
	public native void sa(@OriginalArg(0) Class128 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
}
