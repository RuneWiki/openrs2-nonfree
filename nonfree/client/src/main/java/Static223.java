...
public final class Static223 {
	...
	@OriginalMember(owner = "client!ui", name = "a", descriptor = "(II[B[IIIIIIILclient!ui;II)I")
	public static int method2856(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub2_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ui", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!ui;)I")
	public static int method2861(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub2_Sub4 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt4101 += arg10.anInt4108 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt4110 = arg4 >> 2;
		arg10.anInt4106 = arg5 >> 2;
		arg10.anInt4100 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lclient!qc;II)Lclient!ui;")
	public static Class2_Sub2_Sub4 method2864(@OriginalArg(0) Class2_Sub20_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray35 == null || arg0.aByteArray35.length == 0 ? null : new Class2_Sub2_Sub4(arg0, (int) ((long) arg0.anInt3409 * 256L * (long) 100 / (long) (Static88.anInt1852 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!ui", name = "a", descriptor = "([B[IIIIIIILclient!ui;)I")
	public static int method2869(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub2_Sub4 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt4100 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ui", name = "c", descriptor = "(II)I")
	public static int method2870(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ui", name = "b", descriptor = "(II[B[IIIIIIILclient!ui;II)I")
	public static int method2871(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub2_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ui", name = "a", descriptor = "(I[B[IIIIIIIILclient!ui;)I")
	public static int method2873(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub2_Sub4 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt4100 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!ui", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!ui;II)I")
	public static int method2874(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub2_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt4101 -= arg10.anInt4108 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt4101 += arg10.anInt4108 * local63;
		arg10.anInt4110 = arg4;
		arg10.anInt4106 = arg5;
		arg10.anInt4100 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lclient!qc;III)Lclient!ui;")
	public static Class2_Sub2_Sub4 method2875(@OriginalArg(0) Class2_Sub20_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray35 == null || arg0.aByteArray35.length == 0 ? null : new Class2_Sub2_Sub4(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!ui", name = "a", descriptor = "(II[B[IIIIIIIILclient!ui;II)I")
	public static int method2876(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub2_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt4110 -= arg8.anInt4104 * arg3;
		arg8.anInt4106 -= arg8.anInt4112 * arg3;
		@Pc(32) int local32;
	...
	public static int method2877(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ui", name = "b", descriptor = "(II[B[IIIIIIIILclient!ui;II)I")
	public static int method2880(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub2_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ui", name = "b", descriptor = "(I[B[IIIIIIIILclient!ui;)I")
	public static int method2881(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub2_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!ui", name = "c", descriptor = "(II[B[IIIIIIIILclient!ui;II)I")
	public static int method2882(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub2_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ui", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!ui;II)I")
	public static int method2884(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub2_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt4101 -= arg10.anInt4108 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!ui", name = "a", descriptor = "([B[IIIIIIIILclient!ui;)I")
	public static int method2885(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub2_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt4110 += arg8.anInt4104 * (local24 - arg3);
		arg8.anInt4106 += arg8.anInt4112 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt4101 = arg4 >> 2;
		arg8.anInt4100 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ui", name = "d", descriptor = "(II[B[IIIIIIIILclient!ui;II)I")
	public static int method2886(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub2_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt4110 -= arg8.anInt4104 * arg3;
		arg8.anInt4106 -= arg8.anInt4112 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ui", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!ui;)I")
	public static int method2887(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub2_Sub4 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt4101 += arg10.anInt4108 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!ui", name = "b", descriptor = "([B[IIIIIIIILclient!ui;)I")
	public static int method2892(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub2_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt4110 += arg8.anInt4104 * (local22 - arg3);
		arg8.anInt4106 += arg8.anInt4112 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!ui", name = "b", descriptor = "([B[IIIIIIILclient!ui;)I")
	public static int method2893(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub2_Sub4 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
