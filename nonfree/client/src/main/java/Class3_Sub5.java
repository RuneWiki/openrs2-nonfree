...
public final class Class3_Sub5 extends Class3 {
	...
	private float[] method876(@OriginalArg(0) int arg0) {
		Static36.method881(this.aByteArrayArray28[arg0]);
		Static36.method875();
		@Pc(15) int local15 = Static36.method880(Static140.method2743(Static36.anIntArray196.length - 1));
		@Pc(19) boolean local19 = Static36.aBooleanArray6[local15];
		@Pc(25) int local25 = local19 ? Static36.anInt1067 : Static36.anInt1065;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static36.method875() != 0;
			local29 = Static36.method875() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static36.anInt1065 >> 2);
			local67 = (local25 >> 2) + (Static36.anInt1065 >> 2);
			local71 = Static36.anInt1065 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static36.anInt1065 >> 2);
			local104 = local25 + (Static36.anInt1065 >> 2) - (local25 >> 2);
			local108 = Static36.anInt1065 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class52 local123 = Static36.aClass52Array1[Static36.anIntArray196[local15]];
		@Pc(126) int local126 = local123.anInt2642;
		@Pc(131) int local131 = local123.anIntArray463[local126];
		@Pc(140) boolean local140 = !Static36.aClass72Array1[local131].method2776();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt2641; local144++) {
			@Pc(152) Class37 local152 = Static36.aClass37Array1[local123.anIntArray462[local144]];
			local154 = Static36.aFloatArray2;
			local152.method1245(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt2642;
			local176 = local123.anIntArray463[local171];
			Static36.aClass72Array1[local176].method2774(Static36.aFloatArray2, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static36.aFloatArray2[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static36.aFloatArray2;
			...
			@Pc(252) float[] local252 = local19 ? Static36.aFloatArray3 : Static36.aFloatArray8;
			@Pc(258) float[] local258 = local19 ? Static36.aFloatArray5 : Static36.aFloatArray6;
			@Pc(264) float[] local264 = local19 ? Static36.aFloatArray1 : Static36.aFloatArray7;
			@Pc(270) int[] local270 = local19 ? Static36.anIntArray195 : Static36.anIntArray197;
			...
			@Pc(486) int local486 = Static140.method2743(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static36.aFloatArray2[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static36.aFloatArray2[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt1063 > 0) {
			local176 = this.anInt1063 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean56) {
				for (local212 = 0; local212 < this.anInt1062; local212++) {
					local1254 = (this.anInt1063 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static36.aFloatArray2[local212];
				}
			}
		}
		local154 = this.aFloatArray4;
		this.aFloatArray4 = Static36.aFloatArray2;
		Static36.aFloatArray2 = local154;
		this.anInt1063 = local25;
		this.anInt1062 = local104 - (local25 >> 1);
		this.aBoolean56 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!ec", name = "b", descriptor = "([B)V")
	private void method882(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class3_Sub8 local4 = new Class3_Sub8(arg0);
		this.anInt1061 = local4.method1540();
		this.anInt1068 = local4.method1540();
		this.anInt1069 = local4.method1540();
		this.anInt1064 = local4.method1540();
		if (this.anInt1064 < 0) {
			this.anInt1064 = ~this.anInt1064;
			this.aBoolean55 = true;
		}
		@Pc(40) int local40 = local4.method1540();
		this.aByteArrayArray28 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method1545();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method1506(local49, local64);
			this.aByteArrayArray28[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!ec", name = "a", descriptor = "([I)Lclient!le;")
	public Class3_Sub13_Sub1 method884(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray14 == null) {
			this.anInt1063 = 0;
			this.aFloatArray4 = new float[Static36.anInt1067];
			this.aByteArray14 = new byte[this.anInt1068];
			this.anInt1072 = 0;
			this.anInt1071 = 0;
		}
		while (this.anInt1071 < this.aByteArrayArray28.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method876(this.anInt1071);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt1072;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt1068 - local47) {
					local50 = this.anInt1068 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray14[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt1072;
				}
				this.anInt1072 = local47;
			}
			this.anInt1071++;
		}
		this.aFloatArray4 = null;
		@Pc(129) byte[] local129 = this.aByteArray14;
		this.aByteArray14 = null;
		return new Class3_Sub13_Sub1(this.anInt1061, local129, this.anInt1069, this.anInt1064, this.aBoolean55);
	}
}
