...
public final class Class3_Sub5 extends Class3 {
	...
	public Class3_Sub5(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) boolean arg3) {
		this.anInt252 = arg0;
		this.anInt250 = arg1;
		this.anIntArray18 = arg2;
		if (arg3) {
			@Pc(16) int[] local16 = new int[this.anInt250];
			@Pc(20) int[] local20 = new int[this.anInt250];
			@Pc(24) int[] local24 = new int[this.anInt250];
			if (Static26.anIntArray17 == null || Static26.anIntArray17.length < this.anIntArray18.length) {
				Static26.anIntArray17 = new int[this.anIntArray18.length];
			}
			@Pc(40) int local40 = this.anInt250;
			@Pc(43) int local43 = this.anInt250;
			...
			for (@Pc(61) int local61 = 2; local61 >= 0; local61--) {
				for (local64 = local47; local64 >= 0; local64--) {
					local58--;
					@Pc(71) int local71 = this.anIntArray18[local58];
			...
			for (@Pc(116) int local116 = local51; local116 >= 0; local116--) {
				...
				for (local64 = local47; local64 >= 0; local64--) {
					...
					local114--;
					Static26.anIntArray17[local114] = local165 << 16 | local169 << 8 | local173;
				...
				for (local64 = local47; local64 >= 0; local64--) {
					local58--;
					@Pc(236) int local236 = this.anIntArray18[local58];
					local59--;
					@Pc(242) int local242 = this.anIntArray18[local59];
			...
			@Pc(306) int[] local306 = this.anIntArray18;
			this.anIntArray18 = Static26.anIntArray17;
			Static26.anIntArray17 = local306;
		}
	}

	@OriginalMember(owner = "client!av", name = "a", descriptor = "(II)V")
	public void method254(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 == 0 && arg1 == 0) {
			return;
		}
		if (Static26.anIntArray17 == null || Static26.anIntArray17.length != this.anIntArray18.length) {
		...
		@Pc(28) int local28 = this.anInt250 - 1;
		@Pc(33) int local33 = this.anInt250 * arg1;
		@Pc(37) int local37 = local21 - 1;
		for (@Pc(39) int local39 = 0; local39 < local21; local39 += this.anInt250) {
			@Pc(46) int local46 = local39 + local33 & local37;
			for (@Pc(48) int local48 = 0; local48 < this.anInt250; local48++) {
				@Pc(53) int local53 = local39 + local48;
				@Pc(61) int local61 = local46 + (local48 + arg0 & local28);
				Static26.anIntArray17[local53] = this.anIntArray18[local61];
			}
		}
		@Pc(84) int[] local84 = this.anIntArray18;
		this.anIntArray18 = Static26.anIntArray17;
		Static26.anIntArray17 = local84;
	}
