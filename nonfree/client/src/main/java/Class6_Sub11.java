...
public final class Class6_Sub11 extends Class6 {
	...
	@OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(Lclient!fca;)V")
	public Class6_Sub11(@OriginalArg(0) Class3_Sub22 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(ILclient!fca;)V")
	public Class6_Sub11(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub22 arg1) {
		super(arg0, arg1);
	}
