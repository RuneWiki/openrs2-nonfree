...
public final class Static684 {
	...
	@OriginalMember(owner = "client!qk", name = "a", descriptor = "(II[B[IIIIIIILclient!qk;II)I")
	public static int method7180(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class14_Sub5_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!qk", name = "a", descriptor = "(II[B[IIIIIIIILclient!qk;II)I")
	public static int method7181(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class14_Sub5_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt8714 -= arg8.anInt8708 * arg3;
		arg8.anInt8710 -= arg8.anInt8706 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!qk", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!qk;)I")
	public static int method7182(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class14_Sub5_Sub4 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt8704 += arg10.anInt8711 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt8714 = arg4 >> 2;
		arg10.anInt8710 = arg5 >> 2;
		arg10.anInt8703 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!qk", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!qk;)I")
	public static int method7184(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class14_Sub5_Sub4 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt8704 += arg10.anInt8711 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!qk", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!qk;II)I")
	public static int method7187(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class14_Sub5_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt8704 -= arg10.anInt8711 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt8704 += arg10.anInt8711 * local63;
		arg10.anInt8714 = arg4;
		arg10.anInt8710 = arg5;
		arg10.anInt8703 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!qk", name = "b", descriptor = "(II[B[IIIIIIIILclient!qk;II)I")
	public static int method7190(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class14_Sub5_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!qk", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!qk;II)I")
	public static int method7193(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class14_Sub5_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt8704 -= arg10.anInt8711 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!qk", name = "a", descriptor = "([B[IIIIIIIILclient!qk;)I")
	public static int method7194(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class14_Sub5_Sub4 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt8714 += arg8.anInt8708 * (local22 - arg3);
		arg8.anInt8710 += arg8.anInt8706 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt8704 = arg4 >> 2;
		arg8.anInt8703 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!qk", name = "c", descriptor = "(II)I")
	public static int method7195(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!qk", name = "a", descriptor = "([B[IIIIIIILclient!qk;)I")
	public static int method7197(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class14_Sub5_Sub4 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt8703 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!qk", name = "a", descriptor = "(I[B[IIIIIIIILclient!qk;)I")
	public static int method7199(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class14_Sub5_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!qk", name = "b", descriptor = "([B[IIIIIIIILclient!qk;)I")
	public static int method7201(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class14_Sub5_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt8714 += arg8.anInt8708 * (local24 - arg3);
		arg8.anInt8710 += arg8.anInt8706 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!qk", name = "b", descriptor = "(I[B[IIIIIIIILclient!qk;)I")
	public static int method7202(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class14_Sub5_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!qk", name = "a", descriptor = "(Lclient!dga;III)Lclient!qk;")
	public static Class14_Sub5_Sub4 method7205(@OriginalArg(0) Class14_Sub14_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray35 == null || arg0.aByteArray35.length == 0 ? null : new Class14_Sub5_Sub4(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!qk", name = "b", descriptor = "([B[IIIIIIILclient!qk;)I")
	public static int method7206(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class14_Sub5_Sub4 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	public static int method7209(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!qk", name = "c", descriptor = "(II[B[IIIIIIIILclient!qk;II)I")
	public static int method7213(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class14_Sub5_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt8714 -= arg8.anInt8708 * arg3;
		arg8.anInt8710 -= arg8.anInt8706 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!qk", name = "b", descriptor = "(II[B[IIIIIIILclient!qk;II)I")
	public static int method7215(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class14_Sub5_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!qk", name = "d", descriptor = "(II[B[IIIIIIIILclient!qk;II)I")
	public static int method7217(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class14_Sub5_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
