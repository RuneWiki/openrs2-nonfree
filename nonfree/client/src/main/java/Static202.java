...
public final class Static202 {
	...
	@OriginalMember(owner = "client!og", name = "a", descriptor = "(II[B[IIIIIIIILclient!og;II)I")
	public static int method1979(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub4_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!og", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!og;II)I")
	public static int method1983(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub4_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt2825 -= arg10.anInt2824 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt2825 += arg10.anInt2824 * local63;
		arg10.anInt2816 = arg4;
		arg10.anInt2823 = arg5;
		arg10.anInt2822 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!og", name = "a", descriptor = "(II[B[IIIIIIILclient!og;II)I")
	public static int method1984(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub4_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	public static int method1986(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!og", name = "a", descriptor = "([B[IIIIIIIILclient!og;)I")
	public static int method1989(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub4_Sub4 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt2816 += arg8.anInt2818 * (local22 - arg3);
		arg8.anInt2823 += arg8.anInt2828 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt2825 = arg4 >> 2;
		arg8.anInt2822 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!og", name = "a", descriptor = "(I[B[IIIIIIIILclient!og;)I")
	public static int method1990(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub4_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
	...
	@OriginalMember(owner = "client!og", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!og;II)I")
	public static int method1992(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub4_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt2825 -= arg10.anInt2824 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!og", name = "b", descriptor = "(II[B[IIIIIIIILclient!og;II)I")
	public static int method1993(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub4_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt2816 -= arg8.anInt2818 * arg3;
		arg8.anInt2823 -= arg8.anInt2828 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!og", name = "a", descriptor = "(Lclient!oc;III)Lclient!og;")
	public static Class3_Sub4_Sub4 method1996(@OriginalArg(0) Class3_Sub19_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray37 == null || arg0.aByteArray37.length == 0 ? null : new Class3_Sub4_Sub4(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!og", name = "c", descriptor = "(II[B[IIIIIIIILclient!og;II)I")
	public static int method1998(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub4_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt2816 -= arg8.anInt2818 * arg3;
		arg8.anInt2823 -= arg8.anInt2828 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!og", name = "a", descriptor = "([B[IIIIIIILclient!og;)I")
	public static int method1999(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub4_Sub4 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt2822 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!og", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!og;)I")
	public static int method2000(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub4_Sub4 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt2825 += arg10.anInt2824 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt2816 = arg4 >> 2;
		arg10.anInt2823 = arg5 >> 2;
		arg10.anInt2822 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!og", name = "d", descriptor = "(II[B[IIIIIIIILclient!og;II)I")
	public static int method2002(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub4_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!og", name = "b", descriptor = "(I[B[IIIIIIIILclient!og;)I")
	public static int method2003(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub4_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!og", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!og;)I")
	public static int method2004(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub4_Sub4 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt2825 += arg10.anInt2824 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!og", name = "a", descriptor = "(Lclient!oc;II)Lclient!og;")
	public static Class3_Sub4_Sub4 method2005(@OriginalArg(0) Class3_Sub19_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray37 == null || arg0.aByteArray37.length == 0 ? null : new Class3_Sub4_Sub4(arg0, (int) ((long) arg0.anInt2750 * 256L * (long) 100 / (long) (Static47.anInt1073 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!og", name = "b", descriptor = "(II[B[IIIIIIILclient!og;II)I")
	public static int method2006(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub4_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	public static int method2007(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!og", name = "b", descriptor = "([B[IIIIIIIILclient!og;)I")
	public static int method2009(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub4_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt2816 += arg8.anInt2818 * (local24 - arg3);
		arg8.anInt2823 += arg8.anInt2828 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!og", name = "b", descriptor = "([B[IIIIIIILclient!og;)I")
	public static int method2011(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub4_Sub4 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
