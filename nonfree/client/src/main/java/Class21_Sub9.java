...
public final class Class21_Sub9 extends Class21 {
	...
	@OriginalMember(owner = "client!iw", name = "<init>", descriptor = "(Lclient!eha;)V")
	public Class21_Sub9(@OriginalArg(0) Class3_Sub22 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!iw", name = "<init>", descriptor = "(ILclient!eha;)V")
	public Class21_Sub9(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub22 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!iw", name = "d", descriptor = "(II)V")
	@Override
	...
	@OriginalMember(owner = "client!iw", name = "c", descriptor = "(II)I")
	@Override
	public int method9238(@OriginalArg(1) int arg0) {
		return 1;
	}

	@OriginalMember(owner = "client!iw", name = "c", descriptor = "(I)I")
