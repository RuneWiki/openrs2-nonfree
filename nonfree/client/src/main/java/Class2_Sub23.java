...
public final class Class2_Sub23 extends Class2 {
	...
	private void method2864(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub13 local4 = new Class2_Sub13(arg0);
		this.anInt3141 = local4.method4239();
		this.anInt3143 = local4.method4239();
		this.anInt3145 = local4.method4239();
		this.anInt3142 = local4.method4239();
		if (this.anInt3142 < 0) {
			this.anInt3142 = ~this.anInt3142;
			this.aBoolean226 = true;
		}
		@Pc(40) int local40 = local4.method4239();
		this.aByteArrayArray11 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method4240();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method4244(local64, local49);
			this.aByteArrayArray11[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!k", name = "e", descriptor = "(I)[F")
	private float[] method2867(@OriginalArg(0) int arg0) {
		Static177.method2868(this.aByteArrayArray11[arg0]);
		Static177.method2865();
		@Pc(15) int local15 = Static177.method2862(Static170.method2760(Static177.anIntArray350.length - 1));
		@Pc(19) boolean local19 = Static177.aBooleanArray70[local15];
		@Pc(25) int local25 = local19 ? Static177.anInt3144 : Static177.anInt3146;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static177.method2865() != 0;
			local29 = Static177.method2865() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static177.anInt3146 >> 2);
			local67 = (local25 >> 2) + (Static177.anInt3146 >> 2);
			local71 = Static177.anInt3146 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static177.anInt3146 >> 2);
			local104 = local25 + (Static177.anInt3146 >> 2) - (local25 >> 2);
			local108 = Static177.anInt3146 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class110 local123 = Static177.aClass110Array1[Static177.anIntArray350[local15]];
		@Pc(126) int local126 = local123.anInt2660;
		@Pc(131) int local131 = local123.anIntArray304[local126];
		@Pc(140) boolean local140 = !Static177.aClass58Array1[local131].method1272();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt2659; local144++) {
			@Pc(152) Class200 local152 = Static177.aClass200Array1[local123.anIntArray303[local144]];
			local154 = Static177.aFloatArray9;
			local152.method4859(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt2660;
			local176 = local123.anIntArray304[local171];
			Static177.aClass58Array1[local176].method1268(Static177.aFloatArray9, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static177.aFloatArray9[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static177.aFloatArray9;
			...
			@Pc(252) float[] local252 = local19 ? Static177.aFloatArray12 : Static177.aFloatArray16;
			@Pc(258) float[] local258 = local19 ? Static177.aFloatArray11 : Static177.aFloatArray10;
			@Pc(264) float[] local264 = local19 ? Static177.aFloatArray13 : Static177.aFloatArray15;
			@Pc(270) int[] local270 = local19 ? Static177.anIntArray351 : Static177.anIntArray352;
			...
			@Pc(486) int local486 = Static170.method2760(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static177.aFloatArray9[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static177.aFloatArray9[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt3150 > 0) {
			local176 = this.anInt3150 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean227) {
				for (local212 = 0; local212 < this.anInt3149; local212++) {
					local1254 = (this.anInt3150 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static177.aFloatArray9[local212];
				}
			}
		}
		local154 = this.aFloatArray14;
		this.aFloatArray14 = Static177.aFloatArray9;
		Static177.aFloatArray9 = local154;
		this.anInt3150 = local25;
		this.anInt3149 = local104 - (local25 >> 1);
		this.aBoolean227 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!k", name = "a", descriptor = "([I)Lclient!cu;")
	public Class2_Sub4_Sub1 method2870(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray53 == null) {
			this.anInt3150 = 0;
			this.aFloatArray14 = new float[Static177.anInt3144];
			this.aByteArray53 = new byte[this.anInt3143];
			this.anInt3151 = 0;
			this.anInt3152 = 0;
		}
		while (this.anInt3152 < this.aByteArrayArray11.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method2867(this.anInt3152);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt3151;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt3143 - local47) {
					local50 = this.anInt3143 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt3151;
				}
				this.anInt3151 = local47;
			}
			this.anInt3152++;
		}
		...
		return new Class2_Sub4_Sub1(this.anInt3141, local129, this.anInt3145, this.anInt3142, this.aBoolean226);
	}
}
