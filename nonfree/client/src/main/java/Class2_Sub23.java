...
public final class Class2_Sub23 extends Class2 {
	...
	@OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lclient!bf;Lclient!ah;Lclient!of;[I)V", line = 258)
	public Class2_Sub23(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) Class6_Sub1 arg1, @OriginalArg(2) Class2_Sub26 arg2, @OriginalArg(3) int[] arg3) {
		...
		@Pc(20) int local20 = this.aClass2_Sub26_1.anInt4367 - (arg1.anInt182 >> 1);
		this.anInt3566 = this.aClass2_Sub26_1.anInt4363 - local20 >> arg1.anInt183;
		this.anInt3570 = local20 + this.aClass2_Sub26_1.anInt4363 >> arg1.anInt183;
		this.anInt3565 = this.aClass2_Sub26_1.anInt4364 - local20 >> arg1.anInt183;
		this.anInt3567 = local20 + this.aClass2_Sub26_1.anInt4364 >> arg1.anInt183;
		@Pc(71) int local71 = this.anInt3570 + 1 - this.anInt3566;
		@Pc(79) int local79 = this.anInt3567 + 1 - this.anInt3565;
		...
		for (local108 = 0; local108 <= local79; local108++) {
			local116 = local108 + this.anInt3565;
			if (local116 > 0 && this.aClass6_Sub1_2.anInt6307 - 1 > local116) {
				for (local131 = 0; local131 <= local71; local131++) {
					local144 = local131 + this.anInt3566;
					if (local144 > 0 && this.aClass6_Sub1_2.anInt6308 - 1 > local144) {
						local171 = arg1.method5720(local144 + 1, local116) - arg1.method5720(local144 - 1, local116);
						local185 = arg1.method5720(local144, local116 + 1) - arg1.method5720(local144, local116 - 1);
		...
		local108 = 0;
		local116 = 0;
		for (local131 = this.anInt3565; local131 <= this.anInt3567; local131++) {
			if (local131 >= 0 && local131 < arg1.anInt6307) {
				for (local144 = this.anInt3566; local144 <= this.anInt3570; local144++) {
					if (local144 >= 0 && local144 < arg1.anInt6308) {
				...
				local116 += this.anInt3570 - this.anInt3566;
			}
		}
		if (local108 > 0) {
			this.aClass2_Sub4_5 = new Class2_Sub4(local108 * 2);
			this.aClass2_Sub4_Sub1_1 = new Class2_Sub4_Sub1(local108 * 16);
			this.aClass4_78 = new Class4(Static152.method2978(local108));
			local131 = 0;
			local116 = 0;
			for (local144 = this.anInt3565; local144 <= this.anInt3567; local144++) {
				if (local144 >= 0 && local144 < arg1.anInt6307) {
					local171 = 0;
					for (local185 = this.anInt3566; local185 <= this.anInt3570; local185++) {
						if (local185 >= 0 && local185 < arg1.anInt6308) {
							...
							if (local411 != null && local404 != 0) {
								if (local404 == 1) {
									for (@Pc(567) int local567 = 0; local567 < local411.length; local567++) {
										this.method3528(local411[local567], local171, local144, local131, local185, local418[local567]);
									}
								} else if (local404 == 3) {
									this.method3528(0, local171, local144, local131, local185, 0);
									this.method3528(arg1.anInt182, local171, local144, local131, local185, 0);
									this.method3528(0, local171, local144, local131, local185, arg1.anInt182);
								} else if (local404 == 2) {
									this.method3528(arg1.anInt182, local171, local144, local131, local185, 0);
									this.method3528(arg1.anInt182, local171, local144, local131, local185, arg1.anInt182);
									this.method3528(0, local171, local144, local131, local185, 0);
								} else if (local404 == 5) {
									this.method3528(arg1.anInt182, local171, local144, local131, local185, arg1.anInt182);
									this.method3528(0, local171, local144, local131, local185, arg1.anInt182);
			...
			this.anInterface4_3 = this.aClass19_Sub1_20.method839(this.aClass2_Sub4_5.aByteArray73, this.aClass2_Sub4_5.anInt5289, false);
			this.anInterface5_4 = this.aClass19_Sub1_20.method816(16, this.aClass2_Sub4_Sub1_1.aByteArray73, this.aClass2_Sub4_Sub1_1.anInt5289, false);
	...
	private void method3526(@OriginalArg(0) short arg0) {
		if (this.aClass19_Sub1_20.aBoolean53) {
			this.aClass2_Sub4_5.method4844(arg0);
		} else {
			this.aClass2_Sub4_5.method4846(arg0);
		}
		this.anInt3568++;
	}

	@OriginalMember(owner = "client!lb", name = "a", descriptor = "(III[[ZI)V", line = 27)
	public void method3527(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) boolean[][] arg2, @OriginalArg(4) int arg3) {
		if (this.anInterface4_3 == null || (arg0 + arg1 < this.anInt3566 || (this.anInt3570 < arg1 - arg0 || (arg3 + arg0 < this.anInt3565 || arg3 - arg0 > this.anInt3567)))) {
			return;
		}
		for (@Pc(47) int local47 = this.anInt3565; local47 <= this.anInt3567; local47++) {
			for (@Pc(54) int local54 = this.anInt3566; local54 <= this.anInt3570; local54++) {
				...
				if (-arg0 < local63 && local63 < arg0 && -arg0 < local68 && arg0 > local68 && arg2[arg0 + local63][local68 + arg0]) {
					this.aClass19_Sub1_20.method780((int) (this.aClass2_Sub26_1.aFloat64 * 255.0F) << 24);
					this.aClass19_Sub1_20.method790(this.aClass126_5, null, this.aClass126_6, null);
					this.aClass19_Sub1_20.method811(this.anInterface4_3, 0, this.anInt3568);
					return;
				}
			}
		}
	...
	private void method3528(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		@Pc(1) long local1 = -1L;
		@Pc(9) int local9 = (arg4 << this.aClass6_Sub1_2.anInt183) + arg0;
		@Pc(17) int local17 = arg5 + (arg2 << this.aClass6_Sub1_2.anInt183);
		@Pc(23) int local23 = this.aClass6_Sub1_2.method5729(local9, local17);
		if ((arg0 & 0x7F) == 0 || (arg5 & 0x7F) == 0) {
			...
			if (local53 != null) {
				this.method3526(((Class2_Sub9) local53).aShort20);
				return;
			}
		}
		@Pc(73) short local73 = (short) this.anInt3569++;
		if (local1 != -1L) {
		...
		local175 = this.aClass2_Sub26_1.anInt4363 - local9;
		local183 = this.aClass2_Sub26_1.anInt4361 - local23;
		local190 = this.aClass2_Sub26_1.anInt4364 - local17;
		local197 = (float) Math.sqrt((double) (local190 * local190 + local175 * local175 + local183 * local183));
		local204 = 1.0F / local197;
		local183 *= local204;
		local190 *= local204;
		local175 *= local204;
		local213 = local197 / (float) this.aClass2_Sub26_1.anInt4367;
		...
		@Pc(555) int local555 = this.aClass2_Sub26_1.anInt4365;
		...
		if (this.aClass19_Sub1_20.aBoolean53) {
			this.aClass2_Sub4_Sub1_1.method3060((float) local9);
			this.aClass2_Sub4_Sub1_1.method3060((float) local23);
			this.aClass2_Sub4_Sub1_1.method3060((float) local17);
		} else {
		...
		this.aClass2_Sub4_Sub1_1.method4843(local565);
		this.aClass2_Sub4_Sub1_1.method4843(local580);
		this.aClass2_Sub4_Sub1_1.method4843(local596);
		this.aClass2_Sub4_Sub1_1.method4843(255);
		this.method3526(local73);
	}
}
