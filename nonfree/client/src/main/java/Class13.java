...
public abstract class Class13 {
	...
	protected abstract void method5663(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) Class35 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8);
	...
	public final void method5664(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class35 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		if (arg4 == 0) {
			return;
		}
		...
		this.method5663(local37, local50, local67, local85, local102, local118, arg6, arg7, arg8);
	}
	...
	public final void method5665(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	public final void method5668(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
	...
	public final void method5669(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4) {
		this.method5670(arg0, arg1, (float) this.RA() / 2.0F, (float) this.Q() / 2.0F, arg2, arg3, 0, arg4);
	}

	@OriginalMember(owner = "client!o", name = "a", descriptor = "(FFFFIIIII)V")
	private void method5670(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg4 == 0) {
			return;
		}
		@Pc(9) double local9 = (double) (arg5 & 0xFFFF) * 9.587379924285257E-5D;
	...
	public final void method5671(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Class35 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		this.method5664(arg0, arg1, (float) this.RA() / 2.0F, (float) this.Q() / 2.0F, 4096, arg2, arg3, arg4, arg5);
	}

	@OriginalMember(owner = "client!o", name = "a", descriptor = "(FFII)V")
	public final void method5672(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.method5670(arg0, arg1, (float) this.RA() / 2.0F, (float) this.Q() / 2.0F, arg2, arg3, 1, 0);
	}
