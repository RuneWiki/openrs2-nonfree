...
public final class Static316 {
	...
	@OriginalMember(owner = "client!cn", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!cn;II)I")
	public static int method816(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub7_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt994 -= arg10.anInt996 * arg3;
		@Pc(23) int local23;
		...
		local65 = arg3 >> 1;
		arg10.anInt994 += arg10.anInt996 * local65;
		arg10.anInt995 = arg4;
		arg10.anInt1002 = arg5;
		arg10.anInt1003 = arg2;
		return local65;
	}

	@OriginalMember(owner = "client!cn", name = "a", descriptor = "(Lclient!pc;II)Lclient!cn;")
	public static Class1_Sub7_Sub1 method817(@OriginalArg(0) Class1_Sub23_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray133 == null || arg0.aByteArray133.length == 0 ? null : new Class1_Sub7_Sub1(arg0, (int) ((long) arg0.anInt4002 * 256L * (long) 100 / (long) (Static69.anInt1498 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!cn", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!cn;)I")
	public static int method820(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub7_Sub1 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt994 += arg10.anInt996 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt995 = arg4 >> 2;
		arg10.anInt1002 = arg5 >> 2;
		arg10.anInt1003 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!cn", name = "a", descriptor = "([B[IIIIIIILclient!cn;)I")
	public static int method821(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub7_Sub1 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt1003 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!cn", name = "a", descriptor = "(II[B[IIIIIIILclient!cn;II)I")
	public static int method826(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub7_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!cn", name = "b", descriptor = "(II[B[IIIIIIILclient!cn;II)I")
	public static int method827(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub7_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!cn", name = "a", descriptor = "(II[B[IIIIIIIILclient!cn;II)I")
	public static int method828(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub7_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!cn", name = "a", descriptor = "([B[IIIIIIIILclient!cn;)I")
	public static int method829(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub7_Sub1 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt995 += arg8.anInt1004 * (local24 - arg3);
		arg8.anInt1002 += arg8.anInt999 * (local24 - arg3);
		local24 -= 3;
		@Pc(56) int local56;
		while (arg3 < local24) {
			local56 = arg3++;
		...
		arg8.anInt994 = arg4 >> 2;
		arg8.anInt1003 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!cn", name = "a", descriptor = "(II)I")
	public static int method830(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!cn", name = "a", descriptor = "(Lclient!pc;III)Lclient!cn;")
	public static Class1_Sub7_Sub1 method831(@OriginalArg(0) Class1_Sub23_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray133 == null || arg0.aByteArray133.length == 0 ? null : new Class1_Sub7_Sub1(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!cn", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!cn;II)I")
	public static int method832(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub7_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt994 -= arg10.anInt996 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!cn", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!cn;)I")
	public static int method833(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub7_Sub1 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt994 += arg10.anInt996 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(64) byte local64;
	...
	public static int method835(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!cn", name = "b", descriptor = "([B[IIIIIIIILclient!cn;)I")
	public static int method837(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub7_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt995 += arg8.anInt1004 * (local22 - arg3);
		arg8.anInt1002 += arg8.anInt999 * (local22 - arg3);
		local22 -= 3;
		@Pc(54) int local54;
		while (arg3 < local22) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!cn", name = "b", descriptor = "(II[B[IIIIIIIILclient!cn;II)I")
	public static int method839(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub7_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt995 -= arg8.anInt1004 * arg3;
		arg8.anInt1002 -= arg8.anInt999 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!cn", name = "b", descriptor = "([B[IIIIIIILclient!cn;)I")
	public static int method841(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub7_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!cn", name = "c", descriptor = "(II[B[IIIIIIIILclient!cn;II)I")
	public static int method843(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub7_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt995 -= arg8.anInt1004 * arg3;
		arg8.anInt1002 -= arg8.anInt999 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!cn", name = "a", descriptor = "(I[B[IIIIIIIILclient!cn;)I")
	public static int method845(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub7_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!cn", name = "d", descriptor = "(II[B[IIIIIIIILclient!cn;II)I")
	public static int method849(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub7_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!cn", name = "b", descriptor = "(I[B[IIIIIIIILclient!cn;)I")
	public static int method850(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub7_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
