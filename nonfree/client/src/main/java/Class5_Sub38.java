...
public final class Class5_Sub38 extends Class5 {
	...
	private float[] method5171(@OriginalArg(0) int arg0) {
		Static338.method5175(this.aByteArrayArray19[arg0]);
		Static338.method5169();
		@Pc(15) int local15 = Static338.method5170(Static139.method2419(Static338.anIntArray358.length - 1));
		@Pc(19) boolean local19 = Static338.aBooleanArray25[local15];
		@Pc(25) int local25 = local19 ? Static338.anInt6220 : Static338.anInt6218;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static338.method5169() != 0;
			local29 = Static338.method5169() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static338.anInt6218 >> 2);
			local67 = (local25 >> 2) + (Static338.anInt6218 >> 2);
			local71 = Static338.anInt6218 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static338.anInt6218 >> 2);
			local104 = local25 + (Static338.anInt6218 >> 2) - (local25 >> 2);
			local108 = Static338.anInt6218 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class36 local123 = Static338.aClass36Array1[Static338.anIntArray358[local15]];
		@Pc(126) int local126 = local123.anInt675;
		@Pc(131) int local131 = local123.anIntArray30[local126];
		@Pc(140) boolean local140 = !Static338.aClass117Array1[local131].method2901();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt676; local144++) {
			@Pc(152) Class318 local152 = Static338.aClass318Array1[local123.anIntArray29[local144]];
			local154 = Static338.aFloatArray54;
			local152.method7541(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt675;
			local176 = local123.anIntArray30[local171];
			Static338.aClass117Array1[local176].method2903(Static338.aFloatArray54, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static338.aFloatArray54[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static338.aFloatArray54;
			...
			@Pc(252) float[] local252 = local19 ? Static338.aFloatArray56 : Static338.aFloatArray61;
			@Pc(258) float[] local258 = local19 ? Static338.aFloatArray58 : Static338.aFloatArray59;
			@Pc(264) float[] local264 = local19 ? Static338.aFloatArray60 : Static338.aFloatArray55;
			@Pc(270) int[] local270 = local19 ? Static338.anIntArray360 : Static338.anIntArray359;
			...
			@Pc(486) int local486 = Static139.method2419(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static338.aFloatArray54[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static338.aFloatArray54[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt6216 > 0) {
			local176 = this.anInt6216 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean549) {
				for (local212 = 0; local212 < this.anInt6217; local212++) {
					local1254 = (this.anInt6216 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static338.aFloatArray54[local212];
				}
			}
		}
		local154 = this.aFloatArray57;
		this.aFloatArray57 = Static338.aFloatArray54;
		Static338.aFloatArray54 = local154;
		this.anInt6216 = local25;
		this.anInt6217 = local104 - (local25 >> 1);
		this.aBoolean549 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!lea", name = "b", descriptor = "([B)V")
	private void method5174(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class5_Sub41 local4 = new Class5_Sub41(arg0);
		this.anInt6214 = local4.method7804();
		this.anInt6222 = local4.method7804();
		this.anInt6221 = local4.method7804();
		this.anInt6219 = local4.method7804();
		if (this.anInt6219 < 0) {
			this.anInt6219 = ~this.anInt6219;
			this.aBoolean550 = true;
		}
		@Pc(40) int local40 = local4.method7804();
		this.aByteArrayArray19 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method7816();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method7802(local49, 0, local64);
			this.aByteArrayArray19[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!lea", name = "a", descriptor = "([I)Lclient!nga;")
	public Class5_Sub42_Sub1 method5176(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray54 == null) {
			this.anInt6216 = 0;
			this.aFloatArray57 = new float[Static338.anInt6220];
			this.aByteArray54 = new byte[this.anInt6222];
			this.anInt6223 = 0;
			this.anInt6224 = 0;
		}
		while (this.anInt6224 < this.aByteArrayArray19.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method5171(this.anInt6224);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt6223;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt6222 - local47) {
					local50 = this.anInt6222 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt6223;
				}
				this.anInt6223 = local47;
			}
			this.anInt6224++;
		}
		...
		return new Class5_Sub42_Sub1(this.anInt6214, local129, this.anInt6221, this.anInt6219, this.aBoolean550);
	}
}
