...
public final class Class21_Sub17 extends Class21 {
	...
	@OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Lclient!eha;)V")
	public Class21_Sub17(@OriginalArg(0) Class3_Sub22 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!me", name = "<init>", descriptor = "(ILclient!eha;)V")
	public Class21_Sub17(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub22 arg1) {
		super(arg0, arg1);
	}
