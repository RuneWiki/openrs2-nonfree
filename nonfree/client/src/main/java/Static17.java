...
public final class Static17 {
	...
	public static void method1669(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg1 < anInt2258 || arg1 >= anInt2259) {
			return;
		}
		if (arg0 < anInt2261) {
			arg2 -= anInt2261 - arg0;
		...
		@Pc(32) int local32 = arg0 + arg1 * anInt2257;
		for (@Pc(34) int local34 = 0; local34 < arg2; local34++) {
			anIntArray247[local32 + local34] = arg3;
		}
	}

	@OriginalMember(owner = "client!cd", name = "a", descriptor = "(IIIIII)V")
	public static void method1670(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		method1674(arg0, arg1, arg2, arg4, arg5);
		method1674(arg0, arg1 + arg3 - 1, arg2, arg4, arg5);
		if (arg3 >= 3) {
	...
	public static void method1671(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		arg2 -= arg0;
		arg3 -= arg1;
		if (arg3 == 0) {
			if (arg2 >= 0) {
				method1669(arg0, arg1, arg2 + 1, arg4);
			} else {
				method1669(arg0 + arg2, arg1, 1 - arg2, arg4);
			}
		} else if (arg2 != 0) {
			if (arg2 + arg3 < 0) {
				arg0 += arg2;
			...
			if (arg2 > arg3) {
				...
				while (arg0 <= arg2) {
					local125 = arg1 >> 16;
					if (local125 >= anInt2258 && local125 < anInt2259) {
						anIntArray247[arg0 + local125 * anInt2257] = arg4;
					}
					arg1 += local96;
					arg0++;
				}
				...
				while (arg1 <= arg3) {
					local125 = arg0 >> 16;
					if (local125 >= anInt2261 && local125 < anInt2256) {
						anIntArray247[local125 + arg1 * anInt2257] = arg4;
					}
					arg0 += local96;
					arg1++;
				}
			...
			method1673(arg0, arg1, arg3 + 1, arg4);
		} else {
			method1673(arg0, arg1 + arg3, -arg3 + 1, arg4);
		}
	}
	...
	public static void method1672() {
		@Pc(1) int local1 = 0;
		@Pc(7) int local7 = anInt2257 * anInt2260 - 7;
		while (local1 < local7) {
			anIntArray247[local1++] = 0;
			anIntArray247[local1++] = 0;
			anIntArray247[local1++] = 0;
			anIntArray247[local1++] = 0;
			anIntArray247[local1++] = 0;
	...
	public static void method1673(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg0 < anInt2261 || arg0 >= anInt2256) {
			return;
		}
		if (arg1 < anInt2258) {
			arg2 -= anInt2258 - arg1;
		...
		if (arg1 + arg2 > anInt2259) {
			arg2 = anInt2259 - arg1;
		}
		@Pc(32) int local32 = arg0 + arg1 * anInt2257;
		for (@Pc(34) int local34 = 0; local34 < arg2; local34++) {
			anIntArray247[local32 + local34 * anInt2257] = arg3;
		}
	}

	@OriginalMember(owner = "client!cd", name = "b", descriptor = "(IIIII)V")
	private static void method1674(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg1 < anInt2258 || arg1 >= anInt2259) {
			return;
		}
		if (arg0 < anInt2261) {
		...
		@Pc(58) int local58 = arg0 + arg1 * anInt2257;
		for (@Pc(60) int local60 = 0; local60 < arg2; local60++) {
			@Pc(71) int local71 = (anIntArray247[local58] >> 16 & 0xFF) * local30;
			@Pc(81) int local81 = (anIntArray247[local58] >> 8 & 0xFF) * local30;
			@Pc(89) int local89 = (anIntArray247[local58] & 0xFF) * local30;
			@Pc(111) int local111 = (local38 + local71 >> 8 << 16) + (local46 + local81 >> 8 << 8) + (local52 + local89 >> 8);
			anIntArray247[local58++] = local111;
		}
	}
	...
	public static void method1676(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		if (arg0 < anInt2261) {
			arg2 -= anInt2261 - arg0;
			arg0 = anInt2261;
		}
	...
	private static void method1677(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg0 < anInt2261 || arg0 >= anInt2256) {
			return;
		}
		if (arg1 < anInt2258) {
	...
	public static void method1678(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (anInt2261 < arg0) {
			anInt2261 = arg0;
		}
		if (anInt2258 < arg1) {
	...
	public static void method1682(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		@Pc(43) int local43 = anInt2257 - arg2;
		@Pc(49) int local49 = arg0 + arg1 * anInt2257;
		for (@Pc(52) int local52 = -arg3; local52 < 0; local52++) {
			for (@Pc(56) int local56 = -arg2; local56 < 0; local56++) {
				anIntArray247[local49++] = arg4;
			}
			local49 += local43;
		}
	}
	...
	public static void method1683(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		method1669(arg0, arg1, arg2, arg4);
		method1669(arg0, arg1 + arg3 - 1, arg2, arg4);
		method1673(arg0, arg1, arg3, arg4);
		method1673(arg0 + arg2 - 1, arg1, arg3, arg4);
	}
	...
	public static void method1684(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		@Pc(57) int local57 = anInt2257 - arg2;
		@Pc(63) int local63 = arg0 + arg1 * anInt2257;
		for (@Pc(66) int local66 = -arg3; local66 < 0; local66++) {
			...
			for (@Pc(110) int local110 = -arg2; local110 < 0; local110++) {
				anIntArray247[local63++] = local107;
			}
			local63 += local57;
			local1 += 2849;
		}
