...
public final class Static178 {
	...
	public static int anInt4077 = 256;

	@OriginalMember(owner = "client!nk", name = "W", descriptor = "I")
	public static int anInt4078 = -1;
	...
	public static int anInt4081 = 256;

	@OriginalMember(owner = "client!nk", name = "ab", descriptor = "I")
	public static int anInt4082 = -1;

	@OriginalMember(owner = "client!nk", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/String;")
	public static String method3305(@OriginalArg(0) String arg0) {
	...
	@OriginalMember(owner = "client!nk", name = "a", descriptor = "([[B[[B[I[I[III)I")
	public static int method3327(@OriginalArg(0) byte[][] arg0, @OriginalArg(1) byte[][] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
