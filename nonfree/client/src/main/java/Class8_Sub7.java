...
public final class Class8_Sub7 extends Class8 {
	...
	@OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(ILclient!hd;)V")
	public Class8_Sub7(@OriginalArg(0) int arg0, @OriginalArg(1) Class4_Sub20 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Lclient!hd;)V")
	public Class8_Sub7(@OriginalArg(0) Class4_Sub20 arg0) {
		super(arg0);
	}
	...
	protected int method8383() {
		return super.aClass4_Sub20_31.method3139() ? 1 : 0;
	}
}
