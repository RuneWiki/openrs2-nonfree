...
public final class Static67 {
	...
	public static WorldList aClass9_1;

	@OriginalMember(owner = "client!le", name = "l", descriptor = "I")
	public static int anInt1869 = 0;

	@OriginalMember(owner = "client!le", name = "t", descriptor = "Lclient!ec;")
	private static JagString aClass22_503 = Static60.method1113("Error connecting to server)3");

	@OriginalMember(owner = "client!le", name = "m", descriptor = "Lclient!ec;")
	public static JagString aClass22_500 = aClass22_503;

	@OriginalMember(owner = "client!le", name = "n", descriptor = "Lclient!ec;")
	public static JagString aClass22_501 = Static60.method1113("Fertigkeit)2");

	@OriginalMember(owner = "client!le", name = "o", descriptor = "Lclient!ec;")
	public static JagString aClass22_502 = Static60.method1113("Ihr Spielkonto wird bereits benutzt)3");
	...
	private static JagString aClass22_504 = Static60.method1113("You have only just left another world)3");
	...
	public static JagString aClass22_505 = aClass22_504;

	@OriginalMember(owner = "client!le", name = "G", descriptor = "Lclient!ec;")
	private static JagString aClass22_507 = Static60.method1113("Press (Wchange your password(W on front page)3");

	@OriginalMember(owner = "client!le", name = "F", descriptor = "Lclient!ec;")
	public static JagString aClass22_506 = aClass22_507;
	...
	public static Pix32 method1169() {
		@Pc(15) Pix32 local15 = new Pix32();
