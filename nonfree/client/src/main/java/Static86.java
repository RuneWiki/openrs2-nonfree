...
public final class Static86 {
	...
	public static void method1384(@OriginalArg(1) byte[] arg0) {
		...
		Static30.anInt727 = local10.method1704();
		...
		local10.anInt2546 = arg0.length - Static30.anInt727 * 8 - 7;
		Static44.anInt1079 = local10.method1704();
		Static104.anInt2513 = local10.method1704();
		@Pc(64) int local64 = (local10.method1708() & 0xFF) + 1;
		for (@Pc(66) int local66 = 0; local66 < Static30.anInt727; local66++) {
			Static83.anIntArray430[local66] = local10.method1704();
		}
		for (@Pc(80) int local80 = 0; local80 < Static30.anInt727; local80++) {
			Static97.anIntArray503[local80] = local10.method1704();
		}
		for (@Pc(98) int local98 = 0; local98 < Static30.anInt727; local98++) {
			Static66.anIntArray338[local98] = local10.method1704();
		}
		for (@Pc(116) int local116 = 0; local116 < Static30.anInt727; local116++) {
			Static19.anIntArray86[local116] = local10.method1704();
		}
		local10.anInt2546 = arg0.length - (local64 - 1) * 3 - Static30.anInt727 * 8 - 7;
	...
	public static void method1385() {
		...
		for (@Pc(21) int local21 = 0; local21 < 100; local21++) {
			if (Static63.aClass40Array30[local21] != null) {
				...
				if ((local31 == 3 || local31 == 7) && (local31 == 7 || Static104.anInt2515 == 0 || Static104.anInt2515 == 1 && Static38.method729(local35))) {
				...
				if ((local31 == 5 || local31 == 6) && Static104.anInt2515 < 2) {
					local15++;
					if (local15 >= 5) {
						return;
					}
	...
	public static void method1386() {
		...
		Static80.aClass2_Sub3_Sub1_4.method1703(local23);
		Static80.aClass2_Sub3_Sub1_4.method1703(local17);
		Static80.aClass2_Sub3_Sub1_4.method1694(Static67.anInt1669);
		Static80.aClass2_Sub3_Sub1_4.method1703(57);
		Static80.aClass2_Sub3_Sub1_4.method1703(Static84.anInt1978);
		Static80.aClass2_Sub3_Sub1_4.method1703(Static15.anInt1857);
		Static80.aClass2_Sub3_Sub1_4.method1703(89);
		Static80.aClass2_Sub3_Sub1_4.method1694(Static88.aClass2_Sub2_Sub12_Sub1_Sub1_1.anInt2275);
		Static80.aClass2_Sub3_Sub1_4.method1694(Static88.aClass2_Sub2_Sub12_Sub1_Sub1_1.anInt2284);
		Static80.aClass2_Sub3_Sub1_4.method1703(Static101.anInt2400);
		Static80.aClass2_Sub3_Sub1_4.method1703(63);
		return;
	}
}
