...
public final class Class8_Sub3 extends Class8 {
	...
	public Class8_Sub3(@OriginalArg(0) byte[] arg0) {
		this.method205(arg0);
	}

	@OriginalMember(owner = "client!bf", name = "b", descriptor = "([B)V")
	private void method205(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class8_Sub20 local4 = new Class8_Sub20(arg0);
		this.anInt315 = local4.method1853();
		this.anInt311 = local4.method1853();
		this.anInt308 = local4.method1853();
		this.anInt312 = local4.method1853();
		if (this.anInt312 < 0) {
			this.anInt312 = ~this.anInt312;
			this.aBoolean15 = true;
		}
		@Pc(40) int local40 = local4.method1853();
		this.aByteArrayArray10 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method1872();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method1846(local49, local64);
			this.aByteArrayArray10[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!bf", name = "c", descriptor = "(I)[F")
	private float[] method206(@OriginalArg(0) int arg0) {
		Static12.method210(this.aByteArrayArray10[arg0]);
		Static12.method202();
		@Pc(15) int local15 = Static12.method201(Static132.method1840(Static12.anIntArray42.length - 1));
		@Pc(19) boolean local19 = Static12.aBooleanArray1[local15];
		@Pc(25) int local25 = local19 ? Static12.anInt313 : Static12.anInt316;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static12.method202() != 0;
			local29 = Static12.method202() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static12.anInt316 >> 2);
			local67 = (local25 >> 2) + (Static12.anInt316 >> 2);
			local71 = Static12.anInt316 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static12.anInt316 >> 2);
			local104 = local25 + (Static12.anInt316 >> 2) - (local25 >> 2);
			local108 = Static12.anInt316 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class76 local123 = Static12.aClass76Array1[Static12.anIntArray42[local15]];
		@Pc(126) int local126 = local123.anInt2655;
		@Pc(131) int local131 = local123.anIntArray364[local126];
		@Pc(140) boolean local140 = !Static12.aClass22Array1[local131].method569();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt2654; local144++) {
			@Pc(152) Class39 local152 = Static12.aClass39Array1[local123.anIntArray365[local144]];
			local154 = Static12.aFloatArray2;
			local152.method942(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt2655;
			local176 = local123.anIntArray364[local171];
			Static12.aClass22Array1[local176].method563(Static12.aFloatArray2, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static12.aFloatArray2[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static12.aFloatArray2;
			...
			@Pc(252) float[] local252 = local19 ? Static12.aFloatArray1 : Static12.aFloatArray5;
			@Pc(258) float[] local258 = local19 ? Static12.aFloatArray7 : Static12.aFloatArray4;
			@Pc(264) float[] local264 = local19 ? Static12.aFloatArray8 : Static12.aFloatArray3;
			@Pc(270) int[] local270 = local19 ? Static12.anIntArray41 : Static12.anIntArray43;
			...
			@Pc(486) int local486 = Static132.method1840(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static12.aFloatArray2[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static12.aFloatArray2[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt314 > 0) {
			local176 = this.anInt314 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean17) {
				for (local212 = 0; local212 < this.anInt310; local212++) {
					local1254 = (this.anInt314 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static12.aFloatArray2[local212];
				}
			}
		}
		local154 = this.aFloatArray6;
		this.aFloatArray6 = Static12.aFloatArray2;
		Static12.aFloatArray2 = local154;
		this.anInt314 = local25;
		this.anInt310 = local104 - (local25 >> 1);
		this.aBoolean17 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!bf", name = "a", descriptor = "([I)Lclient!p;")
	public Class8_Sub9_Sub1 method207(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray2 == null) {
			this.anInt314 = 0;
			this.aFloatArray6 = new float[Static12.anInt313];
			this.aByteArray2 = new byte[this.anInt311];
			this.anInt318 = 0;
			this.anInt317 = 0;
		}
		while (this.anInt317 < this.aByteArrayArray10.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method206(this.anInt317);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt318;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt311 - local47) {
					local50 = this.anInt311 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt318;
				}
				this.anInt318 = local47;
			}
			this.anInt317++;
		}
		...
		return new Class8_Sub9_Sub1(this.anInt315, local129, this.anInt308, this.anInt312, this.aBoolean15);
	}
}
