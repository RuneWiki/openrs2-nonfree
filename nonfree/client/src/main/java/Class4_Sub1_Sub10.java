...
public final class Class4_Sub1_Sub10 extends Class4_Sub1 {
	...
	@OriginalMember(owner = "client!uja", name = "a", descriptor = "(ILclient!es;)V")
	@Override
	public void method8334(@OriginalArg(1) Class4_Sub11 arg0) {
		this.aString117 = arg0.method8853();
		arg0.method8850();
	}

	@OriginalMember(owner = "client!uja", name = "a", descriptor = "(Lclient!oga;I)V")
	@Override
	public void method8329(@OriginalArg(0) Class267 arg0) {
		arg0.aString81 = this.aString117;
	}
}
