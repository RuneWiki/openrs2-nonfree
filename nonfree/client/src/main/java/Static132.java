...
public final class Static132 {
	...
	@OriginalMember(owner = "client!jm", name = "J", descriptor = "Lclient!jj;")
	public static Class1_Sub18 aClass1_Sub18_3 = new Class1_Sub18(10000);

	@OriginalMember(owner = "client!jm", name = "Y", descriptor = "Lclient!jm;")
	public static Class6_Sub2_Sub2 aClass6_Sub2_Sub2_1 = new Class6_Sub2_Sub2();

	@OriginalMember(owner = "client!jm", name = "fb", descriptor = "Lclient!jm;")
	public static Class6_Sub2_Sub2 aClass6_Sub2_Sub2_2 = new Class6_Sub2_Sub2();

	@OriginalMember(owner = "client!jm", name = "gb", descriptor = "Lclient!jm;")
	public static Class6_Sub2_Sub2 aClass6_Sub2_Sub2_3 = new Class6_Sub2_Sub2();

	@OriginalMember(owner = "client!jm", name = "hb", descriptor = "Lclient!jm;")
	public static Class6_Sub2_Sub2 aClass6_Sub2_Sub2_4 = new Class6_Sub2_Sub2();

	@OriginalMember(owner = "client!jm", name = "ib", descriptor = "Lclient!jm;")
	public static Class6_Sub2_Sub2 aClass6_Sub2_Sub2_5 = new Class6_Sub2_Sub2();

	@OriginalMember(owner = "client!jm", name = "jb", descriptor = "Lclient!jm;")
	public static Class6_Sub2_Sub2 aClass6_Sub2_Sub2_6 = new Class6_Sub2_Sub2();
	...
	public static int[] anIntArray302 = new int[1];

	@OriginalMember(owner = "client!jm", name = "a", descriptor = "(ISIB)I")
	public static int method2101(@OriginalArg(0) int arg0, @OriginalArg(1) short arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		@Pc(5) int local5 = Static208.anIntArray476[Static31.method589(arg0, arg2)];
		if (arg1 != -1) {
			@Pc(15) int local15 = Static208.anInterface4_1.method994(arg1 & 0xFFFF);
			@Pc(21) int local21;
			@Pc(44) int local44;
			if (local15 != 0) {
				if (arg2 < 0) {
			...
			local21 = Static208.anInterface4_1.method993(arg1 & 0xFFFF);
			if (local21 != 0) {
				local21 += 256;
	...
	@OriginalMember(owner = "client!jm", name = "a", descriptor = "(IIIIII[FIF)V")
	public static void method2102(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) int arg7, @OriginalArg(8) float arg8) {
	...
	@OriginalMember(owner = "client!jm", name = "a", descriptor = "(FFF)I")
	public static int method2104(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
	...
	@OriginalMember(owner = "client!jm", name = "a", descriptor = "(IIIIII[FFIF)V")
	public static void method2105(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) float arg7, @OriginalArg(8) int arg8, @OriginalArg(9) float arg9) {
		@Pc(3) int local3 = arg0 - arg3;
		@Pc(7) int local7 = arg1 - arg4;
		@Pc(11) int local11 = arg2 - arg5;
		@Pc(32) float local32 = (float) local3 * arg6[0] + (float) local7 * arg6[1] + (float) local11 * arg6[2];
	...
	@OriginalMember(owner = "client!jm", name = "a", descriptor = "(IIIIFFF)[F")
	public static float[] method2112(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6) {
	...
	@OriginalMember(owner = "client!jm", name = "t", descriptor = "()V")
	public static void method2114() {
		aClass6_Sub2_Sub2_1 = new Class6_Sub2_Sub2();
		aClass6_Sub2_Sub2_2 = new Class6_Sub2_Sub2();
		aClass6_Sub2_Sub2_3 = new Class6_Sub2_Sub2();
		aClass6_Sub2_Sub2_4 = new Class6_Sub2_Sub2();
		aClass6_Sub2_Sub2_5 = new Class6_Sub2_Sub2();
		aClass6_Sub2_Sub2_6 = new Class6_Sub2_Sub2();
	}

	@OriginalMember(owner = "client!jm", name = "a", descriptor = "([FI)[F")
	public static float[] method2120(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) float[] local2 = new float[arg1];
		Static300.method483(arg0, 0, local2, 0, arg1);
		return local2;
	}

	@OriginalMember(owner = "client!jm", name = "a", descriptor = "([SI)[S")
	public static short[] method2124(@OriginalArg(0) short[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) short[] local2 = new short[arg1];
		Static300.method489(arg0, 0, local2, 0, arg1);
		return local2;
	}
}
