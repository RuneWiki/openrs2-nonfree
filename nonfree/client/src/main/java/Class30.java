...
public final class Class30 {
	...
	public Class30(@OriginalArg(0) int arg0) {
		try {
			...
			@Pc(23) int local23 = 33 / arg0;
		} catch (@Pc(25) RuntimeException local25) {
			signlink.reporterror("58941, " + arg0 + ", " + local25.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lclient!db;)V")
	public void method453(@OriginalArg(0) Class1_Sub3 arg0) {
