...
public final class Class30 {
	...
	@OriginalMember(owner = "client!hd", name = "b", descriptor = "()Lclient!qe;")
	public Class2_Sub16_Sub1 method861() {
		Static47.anInt1488 = 0;
		@Pc(5) byte[] local5 = new byte[this.anInt1482];
		@Pc(7) int local7 = 0;
		for (@Pc(9) int local9 = 0; local9 < this.aByteArrayArray5.length; local9++) {
			@Pc(14) float[] local14 = this.method867(local9);
			if (local14 != null) {
				@Pc(19) int local19 = local14.length;
				if (local19 > this.anInt1482 - local7) {
					local19 = this.anInt1482 - local7;
				}
		...
		return new Class2_Sub16_Sub1(this.anInt1487, local5, this.anInt1485, this.anInt1486, this.aBoolean94);
	}
	...
	private void method863(@OriginalArg(0) byte[] arg0) {
		...
		this.anInt1487 = local4.method1747();
		this.anInt1482 = local4.method1747();
		this.anInt1485 = local4.method1747();
		this.anInt1486 = local4.method1747();
		if (this.anInt1486 < 0) {
			this.anInt1486 = ~this.anInt1486;
			this.aBoolean94 = true;
		}
		@Pc(40) int local40 = local4.method1747();
		this.aByteArrayArray5 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method1780();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method1746(local49, local64);
			this.aByteArrayArray5[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!hd", name = "c", descriptor = "(I)[F")
	private float[] method867(@OriginalArg(0) int arg0) {
		Static47.method860(this.aByteArrayArray5[arg0]);
		Static47.method858();
		@Pc(15) int local15 = Static47.method864(Static59.method1046(Static47.anIntArray188.length - 1));
		@Pc(19) boolean local19 = Static47.aBooleanArray12[local15];
		@Pc(25) int local25 = local19 ? Static47.anInt1481 : Static47.anInt1483;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static47.method858() != 0;
			local29 = Static47.method858() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static47.anInt1483 >> 2);
			local67 = (local25 >> 2) + (Static47.anInt1483 >> 2);
			local71 = Static47.anInt1483 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static47.anInt1483 >> 2);
			local104 = local25 + (Static47.anInt1483 >> 2) - (local25 >> 2);
			local108 = Static47.anInt1483 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class5 local123 = Static47.aClass5Array1[Static47.anIntArray188[local15]];
		@Pc(126) int local126 = local123.anInt181;
		@Pc(131) int local131 = local123.anIntArray14[local126];
		@Pc(140) boolean local140 = !Static47.aClass46Array1[local131].method1123();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt180; local144++) {
			@Pc(152) Class35 local152 = Static47.aClass35Array1[local123.anIntArray15[local144]];
			local154 = Static47.aFloatArray6;
			local152.method896(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt181;
			local176 = local123.anIntArray14[local171];
			Static47.aClass46Array1[local176].method1126(Static47.aFloatArray6, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static47.aFloatArray6[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static47.aFloatArray6;
			...
			@Pc(252) float[] local252 = local19 ? Static47.aFloatArray2 : Static47.aFloatArray3;
			@Pc(258) float[] local258 = local19 ? Static47.aFloatArray4 : Static47.aFloatArray7;
			@Pc(264) float[] local264 = local19 ? Static47.aFloatArray8 : Static47.aFloatArray1;
			@Pc(270) int[] local270 = local19 ? Static47.anIntArray187 : Static47.anIntArray189;
			...
			@Pc(486) int local486 = Static59.method1046(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static47.aFloatArray6[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static47.aFloatArray6[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (Static47.anInt1488 > 0) {
			local176 = Static47.anInt1488 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1250) int local1250;
			if (!Static47.aBoolean95) {
				for (local212 = 0; local212 < Static47.anInt1489; local212++) {
					local1250 = (Static47.anInt1488 >> 1) + local212;
					local1228[local212] += Static47.aFloatArray5[local1250];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1250 = local1228.length + local212 - (local25 >> 1);
					local1228[local1250] += Static47.aFloatArray6[local212];
				}
			}
		}
		local154 = Static47.aFloatArray5;
		Static47.aFloatArray5 = Static47.aFloatArray6;
		Static47.aFloatArray6 = local154;
		Static47.anInt1488 = local25;
		Static47.anInt1489 = local104 - (local25 >> 1);
		Static47.aBoolean95 = local140;
		return local1228;
	}
}
