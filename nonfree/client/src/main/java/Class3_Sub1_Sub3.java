...
public final class Class3_Sub1_Sub3 extends Class3_Sub1 implements Interface10 {
	...
	@OriginalMember(owner = "client!tk", name = "q", descriptor = "Lclient!ab;")
	public Class3_Sub1 aClass3_Sub1_3;

	@OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(IIIIILclient!ab;)V")
	public Class3_Sub1_Sub3(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Class3_Sub1 arg5) {
		super(arg2, arg3, arg4, Static436.method5892(arg1, arg0));
		this.aClass3_Sub1_3 = arg5;
	}

	@OriginalMember(owner = "client!tk", name = "a", descriptor = "(ZLclient!qq;)V")
	@Override
	public void method5809(@OriginalArg(1) Class28 arg0) {
	}

	@OriginalMember(owner = "client!tk", name = "a", descriptor = "(BLclient!qq;)Lclient!km;")
	@Override
	public Class48_Sub6 method5790(@OriginalArg(1) Class28 arg0) {
		return null;
	}

	@OriginalMember(owner = "client!tk", name = "a", descriptor = "(ILclient!qq;Lclient!ps;ZZII)V")
	@Override
	...
	@OriginalMember(owner = "client!tk", name = "a", descriptor = "(Lclient!qq;BII)Z")
	@Override
	...
	@OriginalMember(owner = "client!tk", name = "a", descriptor = "(Lclient!qq;I)V")
	@Override
	public void method5813(@OriginalArg(0) Class28 arg0) {
	}

	@OriginalMember(owner = "client!tk", name = "b", descriptor = "(ZLclient!qq;)V")
	@Override
	...
	@OriginalMember(owner = "client!tk", name = "a", descriptor = "(Lclient!qq;ZI)Lclient!cd;")
	@Override
