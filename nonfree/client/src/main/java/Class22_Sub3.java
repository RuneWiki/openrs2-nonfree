...
public final class Class22_Sub3 extends Class22 {
	...
	@OriginalMember(owner = "client!ev", name = "<init>", descriptor = "(Lclient!kea;)V")
	public Class22_Sub3(@OriginalArg(0) Class14_Sub2 arg0) {
		super(arg0);
	}
	...
	@OriginalMember(owner = "client!ev", name = "a", descriptor = "(BILclient!gl;)V")
	@Override
