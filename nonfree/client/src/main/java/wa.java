...
public final class wa implements Interface16 {

	@OriginalMember(owner = "client!wa", name = "c", descriptor = "J")
	private long aLong269 = 0L;

	@OriginalMember(owner = "client!wa", name = "a", descriptor = "Lclient!j;")
	public final j aJ1;

	@OriginalMember(owner = "client!wa", name = "b", descriptor = "Lclient!xa;")
	...
	public void method8389(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(6) boolean arg4) {
		this.X(this.aLong269, this.aJ1.nativeid, this.aXa1.nativeid, arg0, arg1, arg2, arg3, 0, 0, arg4, true);
	}
	...
	public void method8388(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		this.Z(this.aLong269, this.aJ1.nativeid, this.aXa1.nativeid, arg0, arg1, arg2, arg3, arg4, arg5, true, true);
	}
}
