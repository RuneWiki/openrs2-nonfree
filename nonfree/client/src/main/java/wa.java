...
public final class wa implements Interface12 {
	...
	@OriginalMember(owner = "client!wa", name = "j", descriptor = "Lclient!c;")
	private final c aC3;

	@OriginalMember(owner = "client!wa", name = "d", descriptor = "Lclient!fa;")
	private final fa aFa3;

	@OriginalMember(owner = "client!wa", name = "i", descriptor = "Lclient!fa;")
	...
	private native void j(@OriginalArg(0) Class167 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
	...
	public native void ha(@OriginalArg(0) Class167 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5);

	@OriginalMember(owner = "client!wa", name = "K", descriptor = "(Lclient!ka;Lclient!ka;IIIZ)V")
	public native void K(@OriginalArg(0) Class108 arg0, @OriginalArg(1) Class108 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!wa", name = "ka", descriptor = "(Lclient!o;II)V")
	public native void ka(@OriginalArg(0) Class55 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!wa", name = "G", descriptor = "(Lclient!ka;IILclient!n;Z)Z")
	public native boolean G(@OriginalArg(0) Class108 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class11 arg3, @OriginalArg(4) boolean arg4);

	@OriginalMember(owner = "client!wa", name = "T", descriptor = "(Lclient!qa;[Lclient!ka;Lclient!n;[III)V")
	public native void T(@OriginalArg(0) Class167 arg0, @OriginalArg(1) Class108[] arg1, @OriginalArg(2) Class11 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5);

	@OriginalMember(owner = "client!wa", name = "S", descriptor = "(Lclient!o;IIIIIII[[Z)V")
	public native void S(@OriginalArg(0) Class55 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean[][] arg8);

	@OriginalMember(owner = "client!wa", name = "a", descriptor = "(Lclient!qa;[Lclient!ka;Lclient!n;[II[I[I[I[S[BI[I)V")
	public native void a(@OriginalArg(0) Class167 arg0, @OriginalArg(1) Class108[] arg1, @OriginalArg(2) Class11 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);

	@OriginalMember(owner = "client!wa", name = "a", descriptor = "(Lclient!fa;BIZ)Lclient!ka;")
	public Class108 method6079(@OriginalArg(0) fa arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) fa local8;
		@Pc(5) fa local5;
		if (arg1 == 1) {
			local5 = this.aFa6;
		...
		local8.aClass141Array1 = arg0.aClass141Array1;
		local8.aClass95Array1 = arg0.aClass95Array1;
		return local8;
	}

	@OriginalMember(owner = "client!wa", name = "U", descriptor = "(Lclient!qa;IIIIIII)V")
	public native void U(@OriginalArg(0) Class167 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);

	@OriginalMember(owner = "client!wa", name = "FA", descriptor = "(Lclient!qa;Lclient!ka;Lclient!n;[II[I[I[I[S[BI[I)V")
	public native void FA(@OriginalArg(0) Class167 arg0, @OriginalArg(1) Class108 arg1, @OriginalArg(2) Class11 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);
	...
	public native void k(@OriginalArg(0) Class108 arg0, @OriginalArg(1) Class11 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4);

	@OriginalMember(owner = "client!wa", name = "VA", descriptor = "(Lclient!ka;Lclient!n;[II)V")
	public native void VA(@OriginalArg(0) Class108 arg0, @OriginalArg(1) Class11 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3);
}
