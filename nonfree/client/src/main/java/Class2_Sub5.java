...
public final class Class2_Sub5 extends Class2 {
	...
	private void method400(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub3 local4 = new Class2_Sub3(arg0);
		this.anInt557 = local4.method248();
		this.anInt561 = local4.method248();
		this.anInt555 = local4.method248();
		this.anInt554 = local4.method248();
		if (this.anInt554 < 0) {
			this.anInt554 = ~this.anInt554;
			this.aBoolean30 = true;
		}
		@Pc(40) int local40 = local4.method248();
		this.aByteArrayArray1 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method260();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method271(local49, local64);
			this.aByteArrayArray1[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!bi", name = "c", descriptor = "(I)[F")
	private float[] method404(@OriginalArg(0) int arg0) {
		Static20.method398(this.aByteArrayArray1[arg0]);
		Static20.method403();
		@Pc(15) int local15 = Static20.method401(Static27.method1106(Static20.anIntArray31.length - 1));
		@Pc(19) boolean local19 = Static20.aBooleanArray1[local15];
		@Pc(25) int local25 = local19 ? Static20.anInt559 : Static20.anInt558;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static20.method403() != 0;
			local29 = Static20.method403() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static20.anInt558 >> 2);
			local67 = (local25 >> 2) + (Static20.anInt558 >> 2);
			local71 = Static20.anInt558 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static20.anInt558 >> 2);
			local104 = local25 + (Static20.anInt558 >> 2) - (local25 >> 2);
			local108 = Static20.anInt558 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class62 local123 = Static20.aClass62Array1[Static20.anIntArray31[local15]];
		@Pc(126) int local126 = local123.anInt2759;
		@Pc(131) int local131 = local123.anIntArray277[local126];
		@Pc(140) boolean local140 = !Static20.aClass93Array1[local131].method2762();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt2758; local144++) {
			@Pc(152) Class72 local152 = Static20.aClass72Array1[local123.anIntArray276[local144]];
			local154 = Static20.aFloatArray6;
			local152.method2235(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt2759;
			local176 = local123.anIntArray277[local171];
			Static20.aClass93Array1[local176].method2755(Static20.aFloatArray6, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static20.aFloatArray6[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static20.aFloatArray6;
			...
			@Pc(252) float[] local252 = local19 ? Static20.aFloatArray1 : Static20.aFloatArray4;
			@Pc(258) float[] local258 = local19 ? Static20.aFloatArray3 : Static20.aFloatArray8;
			@Pc(264) float[] local264 = local19 ? Static20.aFloatArray7 : Static20.aFloatArray2;
			@Pc(270) int[] local270 = local19 ? Static20.anIntArray32 : Static20.anIntArray33;
			...
			@Pc(486) int local486 = Static27.method1106(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static20.aFloatArray6[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static20.aFloatArray6[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt556 > 0) {
			local176 = this.anInt556 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean32) {
				for (local212 = 0; local212 < this.anInt552; local212++) {
					local1254 = (this.anInt556 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static20.aFloatArray6[local212];
				}
			}
		}
		local154 = this.aFloatArray5;
		this.aFloatArray5 = Static20.aFloatArray6;
		Static20.aFloatArray6 = local154;
		this.anInt556 = local25;
		this.anInt552 = local104 - (local25 >> 1);
		this.aBoolean32 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!bi", name = "a", descriptor = "([I)Lclient!cb;")
	public Class2_Sub6_Sub1 method406(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray4 == null) {
			this.anInt556 = 0;
			this.aFloatArray5 = new float[Static20.anInt559];
			this.aByteArray4 = new byte[this.anInt561];
			this.anInt563 = 0;
			this.anInt562 = 0;
		}
		while (this.anInt562 < this.aByteArrayArray1.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method404(this.anInt562);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt563;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt561 - local47) {
					local50 = this.anInt561 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt563;
				}
				this.anInt563 = local47;
			}
			this.anInt562++;
		}
		...
		return new Class2_Sub6_Sub1(this.anInt557, local129, this.anInt555, this.anInt554, this.aBoolean30);
	}
}
