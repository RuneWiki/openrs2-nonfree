...
public final class Static122 {
	...
	private static JagString aClass22_340 = Static60.method1113("Unable to connect)3");

	@OriginalMember(owner = "client!uf", name = "c", descriptor = "Lclient!ec;")
	public static JagString aClass22_339 = aClass22_340;
	...
	public static JagString aClass22_341 = aClass22_340;

	@OriginalMember(owner = "client!uf", name = "k", descriptor = "Lclient!ec;")
	public static JagString aClass22_342 = Static60.method1113("<img=1>");

	@OriginalMember(owner = "client!uf", name = "l", descriptor = "Lclient!ec;")
	public static JagString aClass22_343 = Static60.method1113(" Sekunde(Xn(Y -Ubertragen)3");

	@OriginalMember(owner = "client!uf", name = "n", descriptor = "Lclient!ec;")
	public static JagString aClass22_344 = Static60.method1113(":assist:");
	...
	public static void method946(@OriginalArg(0) PathingEntity arg0) {
		...
		if (arg0.anInt2474 != -1 && arg0.anInt2477 == 0) {
			@Pc(36) SeqType local36 = Static79.method1437(arg0.anInt2474);
		...
		if (arg0 instanceof NpcEntity) {
			local206 = ((NpcEntity) arg0).aClass4_Sub1_Sub10_1.aBoolean191;
		}
		if (local206) {
	...
	public static IfType method948(@OriginalArg(0) IfType arg0) {
		@Pc(7) IfType local7 = Static13.method225(arg0);
		if (local7 == null) {
	...
	public static boolean method950() {
		@Pc(5) JavaKeyboardProvider local5 = Static33.aClass44_1;
	...
	public static JagString method951(@OriginalArg(0) int arg0) {
