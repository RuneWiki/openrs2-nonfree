...
public final class Class1_Sub25 extends Class1 {
	...
	private float[] method2750(@OriginalArg(0) int arg0) {
		Static169.method2749(this.aByteArrayArray8[arg0]);
		Static169.method2758();
		@Pc(15) int local15 = Static169.method2754(Static28.method2156(Static169.anIntArray481.length - 1));
		@Pc(19) boolean local19 = Static169.aBooleanArray20[local15];
		@Pc(25) int local25 = local19 ? Static169.anInt3662 : Static169.anInt3663;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static169.method2758() != 0;
			local29 = Static169.method2758() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static169.anInt3663 >> 2);
			local67 = (local25 >> 2) + (Static169.anInt3663 >> 2);
			local71 = Static169.anInt3663 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static169.anInt3663 >> 2);
			local104 = local25 + (Static169.anInt3663 >> 2) - (local25 >> 2);
			local108 = Static169.anInt3663 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class83 local123 = Static169.aClass83Array1[Static169.anIntArray481[local15]];
		@Pc(126) int local126 = local123.anInt3605;
		@Pc(131) int local131 = local123.anIntArray475[local126];
		@Pc(140) boolean local140 = !Static169.aClass18Array1[local131].method607();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt3604; local144++) {
			@Pc(152) Class10 local152 = Static169.aClass10Array1[local123.anIntArray474[local144]];
			local154 = Static169.aFloatArray2;
			local152.method294(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt3605;
			local176 = local123.anIntArray475[local171];
			Static169.aClass18Array1[local176].method602(Static169.aFloatArray2, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static169.aFloatArray2[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static169.aFloatArray2;
			...
			@Pc(252) float[] local252 = local19 ? Static169.aFloatArray4 : Static169.aFloatArray7;
			@Pc(258) float[] local258 = local19 ? Static169.aFloatArray5 : Static169.aFloatArray8;
			@Pc(264) float[] local264 = local19 ? Static169.aFloatArray9 : Static169.aFloatArray6;
			@Pc(270) int[] local270 = local19 ? Static169.anIntArray480 : Static169.anIntArray482;
			...
			@Pc(486) int local486 = Static28.method2156(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static169.aFloatArray2[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static169.aFloatArray2[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt3665 > 0) {
			local176 = this.anInt3665 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean199) {
				for (local212 = 0; local212 < this.anInt3667; local212++) {
					local1254 = (this.anInt3665 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static169.aFloatArray2[local212];
				}
			}
		}
		local154 = this.aFloatArray3;
		this.aFloatArray3 = Static169.aFloatArray2;
		Static169.aFloatArray2 = local154;
		this.anInt3665 = local25;
		this.anInt3667 = local104 - (local25 >> 1);
		this.aBoolean199 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!rf", name = "a", descriptor = "([I)Lclient!pd;")
	public Class1_Sub19_Sub1 method2751(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray49 == null) {
			this.anInt3665 = 0;
			this.aFloatArray3 = new float[Static169.anInt3662];
			this.aByteArray49 = new byte[this.anInt3660];
			this.anInt3670 = 0;
			this.anInt3669 = 0;
		}
		while (this.anInt3669 < this.aByteArrayArray8.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method2750(this.anInt3669);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt3670;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt3660 - local47) {
					local50 = this.anInt3660 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray49[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt3670;
				}
				this.anInt3670 = local47;
			}
			this.anInt3669++;
		}
		...
		return new Class1_Sub19_Sub1(this.anInt3664, local129, this.anInt3666, this.anInt3668, this.aBoolean200);
	}

	@OriginalMember(owner = "client!rf", name = "b", descriptor = "([B)V")
	private void method2757(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub9 local4 = new Class1_Sub9(arg0);
		this.anInt3664 = local4.method915();
		this.anInt3660 = local4.method915();
		this.anInt3666 = local4.method915();
		this.anInt3668 = local4.method915();
		if (this.anInt3668 < 0) {
			this.anInt3668 = ~this.anInt3668;
			this.aBoolean200 = true;
		}
		@Pc(40) int local40 = local4.method915();
		this.aByteArrayArray8 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method895();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method919(local49, local64);
