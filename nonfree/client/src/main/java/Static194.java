...
public final class Static194 {
	...
	public static void method3093(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		method3115(arg0, arg1, arg2, arg4, arg5);
		method3115(arg0, arg1 + arg3 - 1, arg2, arg4, arg5);
		if (arg3 >= 3) {
			method3110(arg0, arg1 + 1, arg3 - 2, arg4, arg5);
			method3110(arg0 + arg2 - 1, arg1 + 1, arg3 - 2, arg4, arg5);
		}
	}
	...
	public static void method3094(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg1 < anInt4132 || arg1 >= anInt4133) {
			return;
		}
		if (arg0 < anInt4134) {
			arg2 -= anInt4134 - arg0;
		...
		if (arg0 + arg2 > anInt4130) {
			arg2 = anInt4130 - arg0;
		}
		@Pc(32) int local32 = arg0 + arg1 * anInt4131;
		for (@Pc(34) int local34 = 0; local34 < arg2; local34++) {
			anIntArray468[local32 + local34] = arg3;
		}
	}
	...
	public static void method3095(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		method3094(arg0, arg1, arg2, arg4);
		method3094(arg0, arg1 + arg3 - 1, arg2, arg4);
		method3113(arg0, arg1, arg3, arg4);
		method3113(arg0 + arg2 - 1, arg1, arg3, arg4);
	}
	...
	public static void method3096(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (arg1 + arg3 > anInt4133) {
			arg3 = anInt4133 - arg1;
		}
		@Pc(43) int local43 = anInt4131 - arg2;
		@Pc(49) int local49 = arg0 + arg1 * anInt4131;
		for (@Pc(52) int local52 = -arg3; local52 < 0; local52++) {
			for (@Pc(56) int local56 = -arg2; local56 < 0; local56++) {
				anIntArray468[local49++] = arg4;
			}
			local49 += local43;
		}
	}
	...
	public static void method3097(@OriginalArg(0) int[] arg0) {
		arg0[0] = anInt4134;
		arg0[1] = anInt4132;
		arg0[2] = anInt4130;
		arg0[3] = anInt4133;
	...
	public static void method3098(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int[] arg2, @OriginalArg(4) int[] arg3) {
		@Pc(5) int local5 = arg0 + arg1 * anInt4131;
		for (@Pc(7) int local7 = 0; local7 < arg2.length; local7++) {
			@Pc(14) int local14 = local5 + arg2[local7];
			for (@Pc(19) int local19 = -arg3[local7]; local19 < 0; local19++) {
				anIntArray468[local14++] = 0;
			}
			local5 += anInt4131;
		}
	}
	...
	public static void method3099(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		@Pc(85) int local85 = arg0 - Static56.method1034();
		@Pc(89) int local89 = arg1 - Static56.method1029();
		...
		Static56.method1020(local93, local97, local103);
		Static56.method1036(local113, local117, local123, local93, local97, local103, arg4);
		Static56.method1020(local93, local103, local109);
		Static56.method1036(local113, local123, local129, local93, local103, local109, arg4);
	}

	@OriginalMember(owner = "client!vc", name = "b", descriptor = "(IIII)V")
	public static void method3100(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (anInt4134 < arg0) {
			anInt4134 = arg0;
		}
		if (anInt4132 < arg1) {
	...
	public static void method3101(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		anIntArray468 = arg0;
		anInt4131 = arg1;
		anInt4129 = arg2;
		method3107(0, 0, arg1, arg2);
	}

	@OriginalMember(owner = "client!vc", name = "a", descriptor = "()V")
	public static void method3102() {
		@Pc(1) int local1 = 0;
		@Pc(7) int local7 = anInt4131 * anInt4129 - 7;
		while (local1 < local7) {
			anIntArray468[local1++] = 0;
			anIntArray468[local1++] = 0;
			anIntArray468[local1++] = 0;
			anIntArray468[local1++] = 0;
			anIntArray468[local1++] = 0;
	...
	private static void method3103(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg2 == 0) {
			method3111(arg0, arg1, arg3);
			return;
		}
		if (arg2 < 0) {
			arg2 = -arg2;
		...
		if (local15 < anInt4132) {
			local15 = anInt4132;
		}
		@Pc(26) int local26 = arg1 + arg2 + 1;
		if (local26 > anInt4133) {
			local26 = anInt4133;
		}
		...
		while (local33 < arg1) {
			...
			if (local82 < anInt4134) {
				local82 = anInt4134;
			}
			local91 = arg0 + local39;
			if (local91 > anInt4130) {
				local91 = anInt4130;
			}
			local102 = local82 + local33 * anInt4131;
			for (local104 = local82; local104 < local91; local104++) {
				anIntArray468[local102++] = arg3;
			}
			local33++;
	...
	public static void method3105(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		if (arg0 < anInt4134) {
			arg2 -= anInt4134 - arg0;
			arg0 = anInt4134;
		}
	...
	public static void method3109(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		@Pc(57) int local57 = anInt4131 - arg2;
		@Pc(63) int local63 = arg0 + arg1 * anInt4131;
		for (@Pc(66) int local66 = -arg3; local66 < 0; local66++) {
			...
			for (@Pc(110) int local110 = -arg2; local110 < 0; local110++) {
				anIntArray468[local63++] = local107;
			}
			local63 += local57;
			local1 += 2849;
		}
	...
	private static void method3110(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg0 < anInt4134 || arg0 >= anInt4130) {
			return;
		}
		if (arg1 < anInt4132) {
			arg2 -= anInt4132 - arg1;
		...
		@Pc(58) int local58 = arg0 + arg1 * anInt4131;
		for (@Pc(60) int local60 = 0; local60 < arg2; local60++) {
			@Pc(71) int local71 = (anIntArray468[local58] >> 16 & 0xFF) * local30;
			@Pc(81) int local81 = (anIntArray468[local58] >> 8 & 0xFF) * local30;
			@Pc(89) int local89 = (anIntArray468[local58] & 0xFF) * local30;
			@Pc(111) int local111 = (local38 + local71 >> 8 << 16) + (local46 + local81 >> 8 << 8) + (local52 + local89 >> 8);
			anIntArray468[local58] = local111;
			local58 += anInt4131;
		}
	}

	@OriginalMember(owner = "client!vc", name = "a", descriptor = "(III)V")
	private static void method3111(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg0 >= anInt4134 && arg1 >= anInt4132 && arg0 < anInt4130 && arg1 < anInt4133) {
			anIntArray468[arg0 + arg1 * anInt4131] = arg2;
		}
	}

	@OriginalMember(owner = "client!vc", name = "d", descriptor = "(IIIII)V")
	public static void method3112(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg4 == 256) {
			method3103(arg0, arg1, arg2, arg3);
			return;
		}
		...
		if (local46 < anInt4132) {
			local46 = anInt4132;
		}
		@Pc(57) int local57 = arg1 + arg2 + 1;
		if (local57 > anInt4133) {
			local57 = anInt4133;
		}
		...
		while (local64 < arg1) {
			...
			if (local113 < anInt4134) {
				local113 = anInt4134;
			}
			local122 = arg0 + local70;
			if (local122 > anInt4130) {
				local122 = anInt4130;
			}
			local133 = local113 + local64 * anInt4131;
			for (local135 = local113; local135 < local122; local135++) {
				local146 = (anIntArray468[local133] >> 16 & 0xFF) * local20;
				local156 = (anIntArray468[local133] >> 8 & 0xFF) * local20;
				local164 = (anIntArray468[local133] & 0xFF) * local20;
				local186 = (local28 + local146 >> 8 << 16) + (local36 + local156 >> 8 << 8) + (local42 + local164 >> 8);
				anIntArray468[local133++] = local186;
			}
			local64++;
		...
		while (local64 < local57) {
			...
			local122 = arg0 + local70;
			if (local122 > anInt4130 - 1) {
				local122 = anInt4130 - 1;
			}
			local133 = local113 + local64 * anInt4131;
			for (local135 = local113; local135 <= local122; local135++) {
				local146 = (anIntArray468[local133] >> 16 & 0xFF) * local20;
	...
	public static void method3113(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(32) int local32 = arg0 + arg1 * anInt4131;
		for (@Pc(34) int local34 = 0; local34 < arg2; local34++) {
			anIntArray468[local32 + local34 * anInt4131] = arg3;
		}
	}

	@OriginalMember(owner = "client!vc", name = "e", descriptor = "(IIIII)V")
	public static void method3114(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		arg2 -= arg0;
		arg3 -= arg1;
		if (arg3 == 0) {
			if (arg2 >= 0) {
				method3094(arg0, arg1, arg2 + 1, arg4);
			} else {
				method3094(arg0 + arg2, arg1, 1 - arg2, arg4);
			}
		} else if (arg2 != 0) {
			if (arg2 + arg3 < 0) {
				arg0 += arg2;
			...
			if (arg2 > arg3) {
				...
				while (arg0 <= arg2) {
					local125 = arg1 >> 16;
					if (local125 >= anInt4132 && local125 < anInt4133) {
						anIntArray468[arg0 + local125 * anInt4131] = arg4;
					}
					arg1 += local96;
					arg0++;
				}
				...
				while (arg1 <= arg3) {
					local125 = arg0 >> 16;
					if (local125 >= anInt4134 && local125 < anInt4130) {
						anIntArray468[local125 + arg1 * anInt4131] = arg4;
					}
					arg0 += local96;
					arg1++;
				}
			...
			method3113(arg0, arg1, arg3 + 1, arg4);
		} else {
			method3113(arg0, arg1 + arg3, -arg3 + 1, arg4);
		}
	}

	@OriginalMember(owner = "client!vc", name = "f", descriptor = "(IIIII)V")
	private static void method3115(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg1 < anInt4132 || arg1 >= anInt4133) {
			return;
		}
		if (arg0 < anInt4134) {
