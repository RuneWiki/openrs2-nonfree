...
public final class w extends Class105 implements Interface5 {

	@OriginalMember(owner = "client!w", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!w", name = "<init>", descriptor = "(Lclient!h;Lclient!ba;Lclient!se;[Lclient!rl;[Lclient!f;)V")
	public w(@OriginalArg(0) h arg0, @OriginalArg(1) ba arg1, @OriginalArg(2) Class215 arg2, @OriginalArg(3) Class205[] arg3, @OriginalArg(4) Class3[] arg4) {
		super(arg0, arg2);
	...
	private native void K(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class57 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
