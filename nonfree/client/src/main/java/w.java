...
public final class w extends Class13 implements Interface9 {

	@OriginalMember(owner = "client!w", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!w", name = "<init>", descriptor = "(Lclient!a;Lclient!c;Lclient!rl;[Lclient!fba;[Lclient!ha;)V")
	public w(@OriginalArg(0) a arg0, @OriginalArg(1) c arg1, @OriginalArg(2) Class256 arg2, @OriginalArg(3) Class96[] arg3, @OriginalArg(4) Class25[] arg4) {
		super(arg0, arg2);
	...
	@OriginalMember(owner = "client!w", name = "A", descriptor = "(CIIIZLclient!pa;II)V")
	private native void A(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class87 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
