...
public final class w extends Class36 implements Interface14 {

	@OriginalMember(owner = "client!w", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!w", name = "<init>", descriptor = "(Lclient!a;Lclient!c;Lclient!fc;[Lclient!dp;[Lclient!ha;)V")
	public w(@OriginalArg(0) a arg0, @OriginalArg(1) c arg1, @OriginalArg(2) Class96 arg2, @OriginalArg(3) Class70[] arg3, @OriginalArg(4) Class104[] arg4) {
		super(arg0, arg2);
	...
	private native void A(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class28 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
