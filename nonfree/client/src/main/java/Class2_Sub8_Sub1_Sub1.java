...
public class Class2_Sub8_Sub1_Sub1 extends Class2_Sub8_Sub1 {

	@OriginalMember(owner = "client!sc", name = "J", descriptor = "[I")
	public int[] anIntArray340;

	@OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(IIIIII[I)V")
	public Class2_Sub8_Sub1_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int[] arg6) {
		this.anInt5520 = arg0;
		this.anInt5516 = arg1;
		this.anInt5522 = arg2;
		this.anInt5519 = arg3;
		this.anInt5514 = arg4;
		this.anInt5517 = arg5;
		this.anIntArray340 = arg6;
	}

	@OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(II)V")
	public Class2_Sub8_Sub1_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.anIntArray340 = new int[arg0 * arg1];
		this.anInt5514 = this.anInt5520 = arg0;
		this.anInt5517 = this.anInt5516 = arg1;
		this.anInt5522 = this.anInt5519 = 0;
	}

	@OriginalMember(owner = "client!sc", name = "a", descriptor = "(IIIIIIII[I[I)V")
			...
			for (@Pc(71) int local71 = 0; local71 < arg3; local71++) {
				...
				for (@Pc(99) int local99 = -arg8[local71]; local99 < 0; local99++) {
					...
					if (local115 == 0) {
						...
						Static77.anIntArray163[local82++] = local115;
					}
					local88 += local39;
					local94 -= local33;
				}
	...
	public final void method2772(@OriginalArg(0) int arg0) {
		if (this.anInt5514 == this.anInt5520 && this.anInt5517 == this.anInt5516) {
			return;
		}
		@Pc(12) int local12 = arg0;
		if (arg0 > this.anInt5522) {
			local12 = this.anInt5522;
		}
		@Pc(21) int local21 = arg0;
		if (arg0 + this.anInt5522 + this.anInt5514 > this.anInt5520) {
			local21 = this.anInt5520 - this.anInt5522 - this.anInt5514;
		}
		@Pc(42) int local42 = arg0;
		if (arg0 > this.anInt5519) {
			local42 = this.anInt5519;
		}
		@Pc(51) int local51 = arg0;
		if (arg0 + this.anInt5519 + this.anInt5517 > this.anInt5516) {
			local51 = this.anInt5516 - this.anInt5519 - this.anInt5517;
		}
		@Pc(77) int local77 = this.anInt5514 + local12 + local21;
		@Pc(84) int local84 = this.anInt5517 + local42 + local51;
		@Pc(89) int[] local89 = new int[local77 * local84];
		for (@Pc(91) int local91 = 0; local91 < this.anInt5517; local91++) {
			for (@Pc(97) int local97 = 0; local97 < this.anInt5514; local97++) {
				local89[(local91 + local42) * local77 + local97 + local12] = this.anIntArray340[local91 * this.anInt5514 + local97];
			}
		}
		this.anIntArray340 = local89;
		this.anInt5514 = local77;
		this.anInt5517 = local84;
		this.anInt5522 -= local12;
		this.anInt5519 -= local42;
	}
	...
	public void method4362(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		Static324.method2783(Static77.anIntArray163, this.anIntArray340, local12, local14, local46, local130, arg2, arg3, local26, local32, local7, arg4);
	}
	...
	public void method4371(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (local32 > 0 && local29 > 0) {
			Static324.method2786(Static77.anIntArray163, this.anIntArray340, local26, local21, local32, local29, local36, local40);
		}
	}

	@OriginalMember(owner = "client!sc", name = "a", descriptor = "(IIIIIIDI)V")
			...
			for (@Pc(65) int local65 = 0; local65 < 20; local65++) {
				...
				for (@Pc(77) int local77 = -20; local77 < 0; local77++) {
					...
					if (local93 == 0) {
						...
						Static77.anIntArray163[local70++] = local93;
					}
					local72 += local33;
					local74 -= local27;
				}
	...
	@OriginalMember(owner = "client!sc", name = "a", descriptor = "(II[I[I)V")
	public final void method2774(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3) {
		if (Static77.anInt1893 - Static77.anInt1898 != arg2.length) {
			throw new IllegalStateException();
		}
		arg0 += this.anInt5522;
		arg1 += this.anInt5519;
		@Pc(21) int local21 = 0;
		@Pc(24) int local24 = this.anInt5517;
		@Pc(27) int local27 = this.anInt5514;
		@Pc(31) int local31 = Static77.anInt1897 - local27;
		@Pc(33) int local33 = 0;
		@Pc(39) int local39 = arg0 + arg1 * Static77.anInt1897;
		@Pc(46) int local46;
		if (arg1 < Static77.anInt1898) {
			local46 = Static77.anInt1898 - arg1;
			local24 -= local46;
			arg1 = Static77.anInt1898;
			local21 = local46 * local27;
			local39 += local46 * Static77.anInt1897;
		}
		if (arg1 + local24 > Static77.anInt1893) {
			local24 -= arg1 + local24 - Static77.anInt1893;
		}
		if (arg0 < Static77.anInt1894) {
			local46 = Static77.anInt1894 - arg0;
			local27 -= local46;
			arg0 = Static77.anInt1894;
			local21 += local46;
			local39 += local46;
		...
		if (arg0 + local27 > Static77.anInt1896) {
			local46 = arg0 + local27 - Static77.anInt1896;
			local27 -= local46;
			local33 += local46;
			local31 += local46;
		}
		...
		local46 = arg0 - Static77.anInt1894;
		@Pc(142) int local142 = arg1 - Static77.anInt1898;
		for (@Pc(144) int local144 = local142; local144 < local142 + local24; local144++) {
			...
			for (@Pc(234) int local234 = -local157; local234 < 0; local234++) {
				@Pc(242) int local242 = this.anIntArray340[local21++];
				if (local242 == 0) {
					local39++;
				} else {
					Static77.anIntArray163[local39++] = local242;
				}
			}
	...
	public void method4364(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (local23 > 0 && local20 > 0) {
			Static324.method2776(Static77.anIntArray163, this.anIntArray340, local17, local15, local23, local20, local27, local29);
		}
	}
	...
	public void method4365(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		Static324.method2775(Static77.anIntArray163, this.anIntArray340, local12, local14, local46, local130, arg2, arg3, local26, local32, local7);
	}
		...
		if (local342 != 0) {
			...
			if (local342 < 0) {
				if (local333 == 0) {
					...
					while (local384 < 0) {
						...
						if (local378 >= 0 && local378 - (this.anInt5517 << 12) < 0) {
							@Pc(717) int local717;
							if ((local717 = local694 - (this.anInt5514 << 12)) >= 0) {
							...
							while (local394 < 0) {
								local432 = this.anIntArray340[(local378 >> 12) * this.anInt5514 + (local694 >> 12)];
								if (local432 == 0) {
									local388++;
								} else {
									Static77.anIntArray163[local388++] = local432;
								}
								local694 += local342;
								local394++;
							}
					...
					while (local384 < 0) {
						...
						local394 = local166;
						@Pc(825) int local825;
						if ((local825 = local694 - (this.anInt5514 << 12)) >= 0) {
						...
						@Pc(871) int local871;
						if ((local871 = local468 - (this.anInt5517 << 12)) >= 0) {
						...
						while (local394 < 0) {
							local432 = this.anIntArray340[(local468 >> 12) * this.anInt5514 + (local694 >> 12)];
							if (local432 == 0) {
								local388++;
							} else {
								Static77.anIntArray163[local388++] = local432;
					...
					while (local384 < 0) {
						...
						local394 = local166;
						@Pc(991) int local991;
						if ((local991 = local694 - (this.anInt5514 << 12)) >= 0) {
						...
						if ((local1073 = (local468 + 1 - (this.anInt5517 << 12) - local333) / local333) > local394) {
							local394 = local1073;
						}
						while (local394 < 0) {
							local432 = this.anIntArray340[(local468 >> 12) * this.anInt5514 + (local694 >> 12)];
				...
				while (local384 < 0) {
					...
					if (local378 >= 0 && local378 - (this.anInt5517 << 12) < 0) {
						...
						if ((local1196 = (local694 + 1 - (this.anInt5514 << 12) - local342) / local342) > local394) {
							local394 = local1196;
						}
						while (local394 < 0) {
							local432 = this.anIntArray340[(local378 >> 12) * this.anInt5514 + (local694 >> 12)];
				...
				while (local384 < 0) {
					...
					if ((local1312 = (local694 + 1 - (this.anInt5514 << 12) - local342) / local342) > local394) {
						local394 = local1312;
					}
					@Pc(1324) int local1324;
					if ((local1324 = local468 - (this.anInt5517 << 12)) >= 0) {
				...
				while (local384 < 0) {
					...
					if ((local1480 = (local694 + 1 - (this.anInt5514 << 12) - local342) / local342) > local394) {
						local394 = local1480;
					}
					if (local468 < 0) {
						local496 = (local333 - local468 - 1) / local333;
					...
					if ((local1528 = (local468 + 1 - (this.anInt5517 << 12) - local333) / local333) > local394) {
						local394 = local1528;
					}
					while (local394 < 0) {
						local432 = this.anIntArray340[(local468 >> 12) * this.anInt5514 + (local694 >> 12)];
			...
			while (local384 < 0) {
				...
				if (local368 >= 0 && local368 - (this.anInt5514 << 12) < 0) {
					@Pc(489) int local489;
					if ((local489 = local468 - (this.anInt5517 << 12)) >= 0) {
					...
					while (local394 < 0) {
						local432 = this.anIntArray340[(local468 >> 12) * this.anInt5514 + (local368 >> 12)];
						if (local432 == 0) {
							local388++;
						} else {
							Static77.anIntArray163[local388++] = local432;
			...
			while (local384 < 0) {
				...
				if (local368 >= 0 && local368 - (this.anInt5514 << 12) < 0) {
					...
					@Pc(630) int local630;
					if ((local630 = (local468 + 1 - (this.anInt5517 << 12) - local333) / local333) > local394) {
						local394 = local630;
					}
					while (local394 < 0) {
						local432 = this.anIntArray340[(local468 >> 12) * this.anInt5514 + (local368 >> 12)];
	...
	public int[] method2778() {
		@Pc(6) int[] local6 = new int[this.anInt5520 * this.anInt5516];
		for (@Pc(8) int local8 = 0; local8 < this.anInt5517; local8++) {
			@Pc(17) int local17 = local8 * this.anInt5514;
			@Pc(28) int local28 = this.anInt5522 + (local8 + this.anInt5519) * this.anInt5520;
			for (@Pc(30) int local30 = 0; local30 < this.anInt5514; local30++) {
				@Pc(40) int local40 = this.anIntArray340[local17++];
	...
	public final void method2780() {
		@Pc(2) int[] local2 = this.anIntArray340;
		for (@Pc(7) int local7 = this.anInt5517 - 1; local7 >= 0; local7--) {
			@Pc(14) int local14 = local7 * this.anInt5514;
			@Pc(21) int local21 = (local7 + 1) * this.anInt5514;
		...
		this.anInt5522 = this.anInt5520 - this.anInt5514 - this.anInt5522;
	}

	@OriginalMember(owner = "client!sc", name = "g", descriptor = "(I)V")
	public final void method2781(@OriginalArg(0) int arg0) {
		for (@Pc(4) int local4 = this.anInt5517 - 1; local4 > 0; local4--) {
			@Pc(11) int local11 = local4 * this.anInt5514;
			for (@Pc(16) int local16 = this.anInt5514 - 1; local16 > 0; local16--) {
				if (this.anIntArray340[local16 + local11] == 0 && this.anIntArray340[local16 + local11 - this.anInt5514 - 1] != 0) {
					this.anIntArray340[local16 + local11] = arg0;
				}
			}
		}
	}
	...
	public void method4368(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (local23 > 0 && local20 > 0) {
			Static324.method2779(Static77.anIntArray163, this.anIntArray340, local17, local15, local23, local20, local27, local29);
		}
	}

	@OriginalMember(owner = "client!sc", name = "c", descriptor = "()V")
	public final void method2782() {
		@Pc(2) int[] local2 = this.anIntArray340;
		for (@Pc(9) int local9 = (this.anInt5517 >> 1) - 1; local9 >= 0; local9--) {
			@Pc(16) int local16 = local9 * this.anInt5514;
			@Pc(26) int local26 = (this.anInt5517 - local9 - 1) * this.anInt5514;
			for (@Pc(30) int local30 = -this.anInt5514; local30 < 0; local30++) {
		...
		this.anInt5519 = this.anInt5516 - this.anInt5517 - this.anInt5519;
	}
	...
	public void method4361(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if (local23 > 0 && local20 > 0) {
			Static324.method2777(Static77.anIntArray163, this.anIntArray340, local17, local15, local23, local20, local27, local29, arg2);
		}
	}
	...
	public final void method2784() {
		...
		@Pc(17) int[] local17 = new int[this.anInt5520 * this.anInt5516];
		for (@Pc(19) int local19 = 0; local19 < this.anInt5517; local19++) {
			for (@Pc(25) int local25 = 0; local25 < this.anInt5514; local25++) {
				local17[(local19 + this.anInt5519) * this.anInt5520 + local25 + this.anInt5522] = this.anIntArray340[local19 * this.anInt5514 + local25];
			}
		}
		this.anIntArray340 = local17;
		this.anInt5514 = this.anInt5520;
		this.anInt5517 = this.anInt5516;
		this.anInt5522 = 0;
		this.anInt5519 = 0;
	}

	@OriginalMember(owner = "client!sc", name = "b", descriptor = "(IIIIIIII[I[I)V")
		...
		try {
			...
			for (@Pc(71) int local71 = 0; local71 < arg3; local71++) {
				...
				for (@Pc(99) int local99 = -arg9[local71]; local99 < 0; local99++) {
					Static77.anIntArray163[local82++] = this.anIntArray340[(local88 >> 16) + (local94 >> 16) * this.anInt5514];
					local88 += local39;
					local94 -= local33;
				}
				local51 += local33;
	...
	public final void method2787() {
		Static77.method1460(this.anIntArray340, this.anInt5514, this.anInt5517);
	}

	@OriginalMember(owner = "client!sc", name = "h", descriptor = "(I)V")
	public final void method2788(@OriginalArg(0) int arg0) {
		@Pc(6) int[] local6 = new int[this.anInt5514 * this.anInt5517];
		@Pc(8) int local8 = 0;
		for (@Pc(10) int local10 = 0; local10 < this.anInt5517; local10++) {
			for (@Pc(16) int local16 = 0; local16 < this.anInt5514; local16++) {
				@Pc(25) int local25 = this.anIntArray340[local8];
				if (local25 == 0) {
					if (local16 > 0 && this.anIntArray340[local8 - 1] != 0) {
						local25 = arg0;
					} else if (local10 > 0 && this.anIntArray340[local8 - this.anInt5514] != 0) {
						local25 = arg0;
					} else if (local16 < this.anInt5514 - 1 && this.anIntArray340[local8 + 1] != 0) {
						local25 = arg0;
					} else if (local10 < this.anInt5517 - 1 && this.anIntArray340[local8 + this.anInt5514] != 0) {
						local25 = arg0;
					}
				}
