...
public final class Static199 {
	...
	public static String method3402(@OriginalArg(0) String arg0) {
		...
		for (@Pc(14) int local14 = 0; local14 < local12; local14++) {
			...
			if (local25 == '%' && local12 > local14 + 2) {
				...
				if (local74 != 0 && Static552.method8001((byte) local74)) {
					local9.append(Static103.method2211((byte) local74));
				}
				local14 += 2;
			} else if (local25 == '+') {
				local9.append(' ');
	...
	@OriginalMember(owner = "client!hs", name = "a", descriptor = "(Lclient!vda;BLclient!vda;)V")
	public static void method3403(@OriginalArg(0) Class4_Sub5 arg0, @OriginalArg(2) Class4_Sub5 arg1) {
		if (arg0.aClass4_Sub5_61 != null) {
			arg0.method8015();
		}
		arg0.aClass4_Sub5_61 = arg1;
		arg0.aClass4_Sub5_62 = arg1.aClass4_Sub5_62;
