...
public final class Class1_Sub1_Sub2_Sub1 extends Class1_Sub1_Sub2 {
	...
	public static void method371(@OriginalArg(0) int arg0) {
		try {
			anIntArray185 = new int[Class1_Sub1_Sub2.anInt739];
			@Pc(6) boolean local6 = false;
			for (@Pc(8) int local8 = 0; local8 < Class1_Sub1_Sub2.anInt739; local8++) {
				anIntArray185[local8] = Class1_Sub1_Sub2.anInt738 * local8;
			}
			anInt661 = Class1_Sub1_Sub2.anInt738 / 2;
			anInt662 = Class1_Sub1_Sub2.anInt739 / 2;
	...
	public static void method372(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		try {
			...
			signlink.reporterror("80573, " + arg0 + ", " + 0 + ", " + arg1 + ", " + local30.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method373() {
		try {
			...
			for (@Pc(15) int local15 = 0; local15 < 50; local15++) {
				anIntArrayArray13[local15] = null;
			}
		} catch (@Pc(27) RuntimeException local27) {
			signlink.reporterror("45137, " + 2 + ", " + local27.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method374() {
		try {
			...
			signlink.reporterror("79986, " + 0 + ", " + 20 + ", " + local34.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lclient!yb;Z)V")
	public static void method375(@OriginalArg(0) Class48 arg0) {
		try {
			anInt663 = 0;
			for (@Pc(14) int local14 = 0; local14 < 50; local14++) {
				try {
					...
					if (aBoolean158 && aClass1_Sub1_Sub2_Sub3Array5[local14].anInt719 == 128) {
			...
			signlink.reporterror("81653, " + arg0 + ", " + false + ", " + local59.toString());
			throw new RuntimeException();
		}
	}
	...
	public static int method376(@OriginalArg(1) int arg0) {
		try {
			...
			@Pc(19) int local19 = 0;
			@Pc(21) int local21 = 0;
			@Pc(26) int local26 = anIntArrayArray14[arg0].length;
			for (@Pc(28) int local28 = 0; local28 < local26; local28++) {
				local17 += anIntArrayArray14[arg0][local28] >> 16 & 0xFF;
				local19 += anIntArrayArray14[arg0][local28] >> 8 & 0xFF;
				local21 += anIntArrayArray14[arg0][local28] & 0xFF;
			}
			...
			anIntArray186[arg0] = local84;
			return local84;
		} catch (@Pc(99) RuntimeException local99) {
			signlink.reporterror("74559, " + 0 + ", " + arg0 + ", " + local99.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method377(@OriginalArg(1) int arg0) {
		try {
			if (anIntArrayArray13[arg0] != null) {
				anIntArrayArray12[anInt664++] = anIntArrayArray13[arg0];
				anIntArrayArray13[arg0] = null;
			}
		} catch (@Pc(24) RuntimeException local24) {
			signlink.reporterror("99950, " + 3 + ", " + arg0 + ", " + local24.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method381(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (arg0 < Class1_Sub1_Sub2.anInt741) {
				if (arg1 > Class1_Sub1_Sub2.anInt741) {
					arg1 = Class1_Sub1_Sub2.anInt741;
				}
				if (arg2 > Class1_Sub1_Sub2.anInt741) {
					arg2 = Class1_Sub1_Sub2.anInt741;
				}
				if (arg1 < arg2) {
					arg5 = arg3 <<= 0x10;
					arg8 = arg6 <<= 0xF;
			...
			if (arg1 < Class1_Sub1_Sub2.anInt741) {
				...
				if (arg0 > Class1_Sub1_Sub2.anInt741) {
					arg0 = Class1_Sub1_Sub2.anInt741;
				}
				if (arg2 < arg0) {
					arg3 = arg4 <<= 0x10;
					arg6 = arg7 <<= 0xF;
		...
		} else if (arg2 < Class1_Sub1_Sub2.anInt741) {
			if (arg0 > Class1_Sub1_Sub2.anInt741) {
				arg0 = Class1_Sub1_Sub2.anInt741;
			}
			if (arg1 > Class1_Sub1_Sub2.anInt741) {
	...
	private static void method382(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5) {
		...
		if (aBoolean161) {
			if (aBoolean159) {
				...
				if (arg3 > Class1_Sub1_Sub2.anInt744) {
					arg3 = Class1_Sub1_Sub2.anInt744;
				}
				if (arg2 < 0) {
					arg4 -= arg2 * local18;
					arg2 = 0;
	...
	private static void method384(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		if (aBoolean159) {
			if (arg4 > Class1_Sub1_Sub2.anInt744) {
				arg4 = Class1_Sub1_Sub2.anInt744;
			}
			if (arg3 < 0) {
				arg3 = 0;
			}
	...
	private static void method386(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14) {
		...
		if (aBoolean159) {
			...
			if (arg6 > Class1_Sub1_Sub2.anInt744) {
				arg6 = Class1_Sub1_Sub2.anInt744;
			}
			if (arg5 < 0) {
				arg7 -= arg5 * local15;
				arg5 = 0;
