...
public final class Class1_Sub1_Sub2_Sub1 extends Class1_Sub1_Sub2 {
	...
	private static int anInt587 = -593;
	...
	static {
		for (@Pc(19) int local19 = 1; local19 < 512; local19++) {
			anIntArray173[local19] = 32768 / local19;
		}
		for (@Pc(32) int local32 = 1; local32 < 2048; local32++) {
			anIntArray174[local32] = 65536 / local32;
		}
		for (@Pc(45) int local45 = 0; local45 < 2048; local45++) {
			anIntArray175[local45] = (int) (Math.sin((double) local45 * 0.0030679615D) * 65536.0D);
			anIntArray176[local45] = (int) (Math.cos((double) local45 * 0.0030679615D) * 65536.0D);
		}
	...
	public static void method339(@OriginalArg(0) byte arg0) {
		try {
			anIntArray173 = null;
			anIntArray173 = null;
			anIntArray175 = null;
			...
			signlink.reporterror("34284, " + arg0 + ", " + local43.toString());
	...
	public static void method340() {
		try {
			anIntArray177 = new int[Class1_Sub1_Sub2.anInt697];
			for (@Pc(8) int local8 = 0; local8 < Class1_Sub1_Sub2.anInt697; local8++) {
				anIntArray177[local8] = Class1_Sub1_Sub2.anInt696 * local8;
			}
			anInt589 = Class1_Sub1_Sub2.anInt696 / 2;
			anInt590 = Class1_Sub1_Sub2.anInt697 / 2;
		} catch (@Pc(30) RuntimeException local30) {
			signlink.reporterror("84100, " + false + ", " + local30.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!hb", name = "a", descriptor = "(III)V")
	public static void method341(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		try {
			...
			signlink.reporterror("96947, " + arg0 + ", " + 6487 + ", " + arg1 + ", " + local30.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method342() {
		try {
			...
			signlink.reporterror("36481, " + -18849 + ", " + local27.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method343() {
		try {
			if (anIntArrayArray13 == null) {
				anInt592 = 20;
				if (aBoolean146) {
					anIntArrayArray13 = new int[anInt592][16384];
				} else {
					anIntArrayArray13 = new int[anInt592][65536];
				}
				for (@Pc(29) int local29 = 0; local29 < 50; local29++) {
					anIntArrayArray14[local29] = null;
				}
			}
		} catch (@Pc(41) RuntimeException local41) {
			signlink.reporterror("46760, " + 20 + ", " + 2972 + ", " + local41.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lclient!xb;I)V")
	public static void method344(@OriginalArg(0) Class47 arg0) {
		try {
			anInt591 = 0;
			for (@Pc(8) int local8 = 0; local8 < 50; local8++) {
				try {
					aClass1_Sub1_Sub2_Sub3Array5[local8] = new Class1_Sub1_Sub2_Sub3(arg0, String.valueOf(local8), 0);
					if (aBoolean146 && aClass1_Sub1_Sub2_Sub3Array5[local8].anInt678 == 128) {
						aClass1_Sub1_Sub2_Sub3Array5[local8].method410((byte) 9);
					} else {
						aClass1_Sub1_Sub2_Sub3Array5[local8].method411();
					}
					anInt591++;
			...
			signlink.reporterror("80657, " + arg0 + ", " + 0 + ", " + local53.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!hb", name = "a", descriptor = "(ZI)I")
	public static int method345(@OriginalArg(1) int arg0) {
		try {
			...
			local84 = method349(local84, 1.4D);
			if (local84 == 0) {
				local84 = 1;
			}
			anIntArray178[arg0] = local84;
			return local84;
		} catch (@Pc(99) RuntimeException local99) {
			signlink.reporterror("22920, " + false + ", " + arg0 + ", " + local99.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method346(@OriginalArg(0) int arg0) {
		try {
			if (anIntArrayArray14[arg0] != null) {
				anIntArrayArray13[anInt592++] = anIntArrayArray14[arg0];
				anIntArrayArray14[arg0] = null;
			}
		} catch (@Pc(23) RuntimeException local23) {
			signlink.reporterror("26971, " + arg0 + ", " + true + ", " + local23.toString());
			throw new RuntimeException();
		}
	}
	...
	private static int[] method347(@OriginalArg(0) int arg0) {
		...
		@Pc(39) int local39;
		if (anInt592 > 0) {
			local27 = anIntArrayArray13[--anInt592];
			anIntArrayArray13[anInt592] = null;
		} else {
			@Pc(35) int local35 = 0;
			@Pc(37) int local37 = -1;
			for (local39 = 0; local39 < anInt591; local39++) {
	...
	public static void method348(@OriginalArg(1) double arg0) {
		try {
			@Pc(13) double local13 = arg0 + Math.random() * 0.03D - 0.015D;
			@Pc(15) int local15 = 0;
			for (@Pc(17) int local17 = 0; local17 < 512; local17++) {
				...
				for (@Pc(39) int local39 = 0; local39 < 128; local39++) {
					...
					@Pc(287) int local287 = method349(local283, local13);
					anIntArray180[local15++] = local287;
				}
			}
			for (@Pc(302) int local302 = 0; local302 < 50; local302++) {
				if (aClass1_Sub1_Sub2_Sub3Array5[local302] != null) {
					@Pc(313) int[] local313 = aClass1_Sub1_Sub2_Sub3Array5[local302].anIntArray209;
					anIntArrayArray15[local302] = new int[local313.length];
					for (@Pc(321) int local321 = 0; local321 < local313.length; local321++) {
						anIntArrayArray15[local302][local321] = method349(local313[local321], local13);
			...
			for (@Pc(360) int local360 = 0; local360 < 50; local360++) {
				method346(local360);
			}
		} catch (@Pc(371) RuntimeException local371) {
			signlink.reporterror("38973, " + -42222 + ", " + arg0 + ", " + local371.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method350(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (arg0 < Class1_Sub1_Sub2.anInt699) {
				...
				if (arg2 > Class1_Sub1_Sub2.anInt699) {
					arg2 = Class1_Sub1_Sub2.anInt699;
				}
				if (arg1 < arg2) {
					arg5 = arg3 <<= 0x10;
					arg8 = arg6 <<= 0xF;
						...
						while (true) {
							...
							if (arg1 < 0) {
								while (true) {
									...
									arg8 += local59;
									arg7 += local32;
									arg0 += Class1_Sub1_Sub2.anInt696;
								}
							}
						...
						while (true) {
							...
							if (arg2 < 0) {
								while (true) {
									...
									arg6 += local5;
									arg8 += local59;
									arg1 += Class1_Sub1_Sub2.anInt696;
								}
							}
		...
		} else if (arg2 < Class1_Sub1_Sub2.anInt699) {
			if (arg0 > Class1_Sub1_Sub2.anInt699) {
				arg0 = Class1_Sub1_Sub2.anInt699;
			}
			if (arg1 > Class1_Sub1_Sub2.anInt699) {
					...
					while (true) {
						...
						if (arg0 < 0) {
							while (true) {
								...
								arg7 += local32;
								arg6 += local5;
								arg2 += Class1_Sub1_Sub2.anInt696;
							}
						}
	...
	private static void method351(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5) {
		...
		if (aBoolean149) {
			if (aBoolean147) {
				...
				if (arg3 > Class1_Sub1_Sub2.anInt702) {
					arg3 = Class1_Sub1_Sub2.anInt702;
				}
				if (arg2 < 0) {
					arg4 -= arg2 * local18;
					arg2 = 0;
	...
	private static void method353(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		if (aBoolean147) {
			if (arg4 > Class1_Sub1_Sub2.anInt702) {
				arg4 = Class1_Sub1_Sub2.anInt702;
			}
			if (arg3 < 0) {
				arg3 = 0;
			}
		...
		@Pc(72) int local72 = anInt588;
		@Pc(76) int local76 = 256 - anInt588;
	...
	private static void method355(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14) {
		...
		if (aBoolean147) {
			...
			if (arg6 > Class1_Sub1_Sub2.anInt702) {
				arg6 = Class1_Sub1_Sub2.anInt702;
			}
			if (arg5 < 0) {
				arg7 -= arg5 * local15;
				arg5 = 0;
