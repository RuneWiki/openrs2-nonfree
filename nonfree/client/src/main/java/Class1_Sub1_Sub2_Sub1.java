...
public final class Class1_Sub1_Sub2_Sub1 extends Class1_Sub1_Sub2 {
	...
	private static int anInt604 = -31740;

	@OriginalMember(owner = "client!hb", name = "z", descriptor = "B")
	private static byte aByte36 = 59;
	...
	static {
		...
		for (@Pc(23) int local23 = 1; local23 < 512; local23++) {
			anIntArray176[local23] = 32768 / local23;
		}
		for (@Pc(36) int local36 = 1; local36 < 2048; local36++) {
			anIntArray177[local36] = 65536 / local36;
		}
		for (@Pc(49) int local49 = 0; local49 < 2048; local49++) {
			anIntArray178[local49] = (int) (Math.sin((double) local49 * 0.0030679615D) * 65536.0D);
			anIntArray179[local49] = (int) (Math.cos((double) local49 * 0.0030679615D) * 65536.0D);
		}
	...
	public static void method342(@OriginalArg(0) byte arg0) {
		try {
			...
			signlink.reporterror("98937, " + arg0 + ", " + local31.toString());
	...
	public static void method343() {
		try {
			anIntArray180 = new int[Class1_Sub1_Sub2.anInt713];
			for (@Pc(9) int local9 = 0; local9 < Class1_Sub1_Sub2.anInt713; local9++) {
				anIntArray180[local9] = Class1_Sub1_Sub2.anInt712 * local9;
			}
			anInt606 = Class1_Sub1_Sub2.anInt712 / 2;
			anInt607 = Class1_Sub1_Sub2.anInt713 / 2;
		} catch (@Pc(31) RuntimeException local31) {
			signlink.reporterror("31507, " + -34926 + ", " + local31.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method344(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			...
			signlink.reporterror("9326, " + arg0 + ", " + arg1 + ", " + false + ", " + local29.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method345() {
		try {
			...
			signlink.reporterror("90698, " + 14956 + ", " + local19.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!hb", name = "a", descriptor = "(BI)V")
	public static void method346(@OriginalArg(0) byte arg0) {
		try {
			if (arg0 == 7) {
			...
			signlink.reporterror("28904, " + arg0 + ", " + 20 + ", " + local39.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lclient!xb;Z)V")
	public static void method347(@OriginalArg(0) Class47 arg0, @OriginalArg(1) boolean arg1) {
		try {
			anInt608 = 0;
			for (@Pc(5) int local5 = 0; local5 < 50; local5++) {
				try {
					...
					if (aBoolean149 && aClass1_Sub1_Sub2_Sub3Array5[local5].anInt693 == 128) {
						aClass1_Sub1_Sub2_Sub3Array5[local5].method413((byte) 8);
					} else {
						aClass1_Sub1_Sub2_Sub3Array5[local5].method414(aBoolean148);
					}
					anInt608++;
			...
			signlink.reporterror("18110, " + arg0 + ", " + arg1 + ", " + local52.toString());
			throw new RuntimeException();
		}
	}
	...
	public static int method348(@OriginalArg(1) int arg0) {
		try {
			...
			for (@Pc(32) int local32 = 0; local32 < local20; local32++) {
				local11 += anIntArrayArray15[arg0][local32] >> 16 & 0xFF;
				local13 += anIntArrayArray15[arg0][local32] >> 8 & 0xFF;
				local15 += anIntArrayArray15[arg0][local32] & 0xFF;
			}
			...
			signlink.reporterror("81410, " + -333 + ", " + arg0 + ", " + local103.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method349(@OriginalArg(0) int arg0) {
		try {
			...
			signlink.reporterror("50702, " + arg0 + ", " + -850 + ", " + local26.toString());
			throw new RuntimeException();
		}
	}
		...
		try {
			...
			for (@Pc(16) int local16 = 0; local16 < 512; local16++) {
				...
				for (@Pc(38) int local38 = 0; local38 < 128; local38++) {
					...
					local282 = method352(local282, local9);
					if (local282 == 0) {
						local282 = 1;
					}
					anIntArray183[local11++] = local282;
				}
			}
			for (@Pc(305) int local305 = 0; local305 < 50; local305++) {
				if (aClass1_Sub1_Sub2_Sub3Array5[local305] != null) {
					...
					for (@Pc(324) int local324 = 0; local324 < local316.length; local324++) {
						anIntArrayArray15[local305][local324] = method352(local316[local324], local9);
			...
			signlink.reporterror("73356, " + true + ", " + arg0 + ", " + local374.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method353(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (arg0 < Class1_Sub1_Sub2.anInt715) {
				if (arg1 > Class1_Sub1_Sub2.anInt715) {
					arg1 = Class1_Sub1_Sub2.anInt715;
				}
				if (arg2 > Class1_Sub1_Sub2.anInt715) {
					arg2 = Class1_Sub1_Sub2.anInt715;
				}
				if (arg1 < arg2) {
					arg5 = arg3 <<= 0x10;
					arg8 = arg6 <<= 0xF;
						...
						while (true) {
							...
							if (arg1 < 0) {
								while (true) {
									...
									arg8 += local59;
									arg7 += local32;
									arg0 += Class1_Sub1_Sub2.anInt712;
								}
							}
			...
			if (arg1 < Class1_Sub1_Sub2.anInt715) {
				...
				if (arg0 > Class1_Sub1_Sub2.anInt715) {
					arg0 = Class1_Sub1_Sub2.anInt715;
				}
				if (arg2 < arg0) {
					arg3 = arg4 <<= 0x10;
					arg6 = arg7 <<= 0xF;
						...
						while (true) {
							...
							if (arg2 < 0) {
								while (true) {
									...
									arg6 += local5;
									arg8 += local59;
									arg1 += Class1_Sub1_Sub2.anInt712;
								}
							}
		...
		} else if (arg2 < Class1_Sub1_Sub2.anInt715) {
			if (arg0 > Class1_Sub1_Sub2.anInt715) {
				arg0 = Class1_Sub1_Sub2.anInt715;
			}
			if (arg1 > Class1_Sub1_Sub2.anInt715) {
					...
					while (true) {
						...
						if (arg0 < 0) {
							while (true) {
								...
								arg7 += local32;
								arg6 += local5;
								arg2 += Class1_Sub1_Sub2.anInt712;
							}
						}
	...
	private static void method354(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5) {
		...
		if (aBoolean152) {
			if (aBoolean150) {
				...
				if (arg3 > Class1_Sub1_Sub2.anInt718) {
					arg3 = Class1_Sub1_Sub2.anInt718;
				}
				if (arg2 < 0) {
					arg4 -= arg2 * local18;
					arg2 = 0;
	...
	private static void method356(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		if (aBoolean150) {
			if (arg4 > Class1_Sub1_Sub2.anInt718) {
				arg4 = Class1_Sub1_Sub2.anInt718;
			}
			if (arg3 < 0) {
				arg3 = 0;
			}
	...
	public static void method357(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18) {
		...
		aBoolean151 = !aBooleanArray8[arg18];
	...
	private static void method358(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14) {
		...
		if (aBoolean150) {
			...
			if (arg6 > Class1_Sub1_Sub2.anInt718) {
				arg6 = Class1_Sub1_Sub2.anInt718;
			}
			if (arg5 < 0) {
				arg7 -= arg5 * local15;
				arg5 = 0;
