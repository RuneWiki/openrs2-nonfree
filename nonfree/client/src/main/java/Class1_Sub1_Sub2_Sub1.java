...
public final class Class1_Sub1_Sub2_Sub1 extends Class1_Sub1_Sub2 {
	...
	private static int anInt604 = -148;
	...
	private static int[] anIntArray176 = new int[512];
	...
	public static void method342() {
		try {
			...
			signlink.reporterror("95594, " + 3 + ", " + local34.toString());
	...
	public static void method343() {
		try {
			anIntArray180 = new int[Class1_Sub1_Sub2.anInt708];
			for (@Pc(12) int local12 = 0; local12 < Class1_Sub1_Sub2.anInt708; local12++) {
				anIntArray180[local12] = Class1_Sub1_Sub2.anInt707 * local12;
			}
			anInt606 = Class1_Sub1_Sub2.anInt707 / 2;
			anInt607 = Class1_Sub1_Sub2.anInt708 / 2;
		} catch (@Pc(34) RuntimeException local34) {
			signlink.reporterror("15260, " + true + ", " + local34.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!hb", name = "a", descriptor = "(IBI)V")
	public static void method344(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2) {
		try {
			@Pc(6) boolean local6 = false;
			anIntArray180 = new int[arg0];
			for (@Pc(15) int local15 = 0; local15 < arg0; local15++) {
				anIntArray180[local15] = arg2 * local15;
			}
			anInt606 = arg2 / 2;
			anInt607 = arg0 / 2;
		} catch (@Pc(37) RuntimeException local37) {
			signlink.reporterror("25564, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + local37.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method345() {
		try {
			...
			signlink.reporterror("97080, " + 74 + ", " + local19.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method346() {
		try {
			if (anIntArrayArray13 == null) {
				anInt609 = 20;
				if (aBoolean156) {
					anIntArrayArray13 = new int[anInt609][16384];
				} else {
					anIntArrayArray13 = new int[anInt609][65536];
				}
			...
			signlink.reporterror("96491, " + false + ", " + 20 + ", " + local34.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lclient!xb;Z)V")
	public static void method347(@OriginalArg(0) Class47 arg0) {
		try {
			anInt608 = 0;
			for (@Pc(5) int local5 = 0; local5 < 50; local5++) {
				try {
					aClass1_Sub1_Sub2_Sub3Array5[local5] = new Class1_Sub1_Sub2_Sub3(arg0, String.valueOf(local5), 0);
					if (aBoolean156 && aClass1_Sub1_Sub2_Sub3Array5[local5].anInt692 == 128) {
						aClass1_Sub1_Sub2_Sub3Array5[local5].method413();
					} else {
						aClass1_Sub1_Sub2_Sub3Array5[local5].method414();
					}
					anInt608++;
			...
			signlink.reporterror("98151, " + arg0 + ", " + true + ", " + local52.toString());
			throw new RuntimeException();
		}
	}
	...
	public static int method348(@OriginalArg(1) int arg0) {
		try {
			...
			local80 = method352(local80, 1.4D);
			if (local80 == 0) {
				local80 = 1;
			}
			anIntArray181[arg0] = local80;
			return local80;
		} catch (@Pc(95) RuntimeException local95) {
			signlink.reporterror("53590, " + 0 + ", " + arg0 + ", " + local95.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method349(@OriginalArg(1) int arg0) {
		try {
			if (anIntArrayArray14[arg0] != null) {
				anIntArrayArray13[anInt609++] = anIntArrayArray14[arg0];
				anIntArrayArray14[arg0] = null;
			}
		} catch (@Pc(29) RuntimeException local29) {
			signlink.reporterror("75393, " + true + ", " + arg0 + ", " + local29.toString());
			throw new RuntimeException();
		}
	}
	...
	private static int[] method350(@OriginalArg(0) int arg0) {
		...
		@Pc(39) int local39;
		if (anInt609 > 0) {
			local27 = anIntArrayArray13[--anInt609];
			anIntArrayArray13[anInt609] = null;
		} else {
			@Pc(35) int local35 = 0;
			@Pc(37) int local37 = -1;
			for (local39 = 0; local39 < anInt608; local39++) {
		...
		try {
			...
			for (@Pc(13) int local13 = 0; local13 < 512; local13++) {
				...
				for (@Pc(35) int local35 = 0; local35 < 128; local35++) {
					...
					@Pc(283) int local283 = method352(local279, local9);
					anIntArray183[local11++] = local283;
				}
			}
			for (@Pc(298) int local298 = 0; local298 < 50; local298++) {
				if (aClass1_Sub1_Sub2_Sub3Array5[local298] != null) {
					@Pc(309) int[] local309 = aClass1_Sub1_Sub2_Sub3Array5[local298].anIntArray212;
					anIntArrayArray15[local298] = new int[local309.length];
					for (@Pc(317) int local317 = 0; local317 < local309.length; local317++) {
						anIntArrayArray15[local298][local317] = method352(local309[local317], local9);
						if ((anIntArrayArray15[local298][local317] & 0xF8F8FF) == 0 && local317 != 0) {
							anIntArrayArray15[local298][local317] = 1;
						}
					}
				}
			}
			...
			signlink.reporterror("47315, " + arg0 + ", " + false + ", " + local371.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method353(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (arg0 < Class1_Sub1_Sub2.anInt710) {
				if (arg1 > Class1_Sub1_Sub2.anInt710) {
					arg1 = Class1_Sub1_Sub2.anInt710;
				}
				if (arg2 > Class1_Sub1_Sub2.anInt710) {
					arg2 = Class1_Sub1_Sub2.anInt710;
				}
				if (arg1 < arg2) {
					arg5 = arg3 <<= 0x10;
					arg8 = arg6 <<= 0xF;
						...
						while (true) {
							...
							if (arg1 < 0) {
								while (true) {
									...
									arg8 += local59;
									arg7 += local32;
									arg0 += Class1_Sub1_Sub2.anInt707;
								}
							}
			...
			if (arg1 < Class1_Sub1_Sub2.anInt710) {
				...
				if (arg0 > Class1_Sub1_Sub2.anInt710) {
					arg0 = Class1_Sub1_Sub2.anInt710;
				}
				if (arg2 < arg0) {
					arg3 = arg4 <<= 0x10;
					arg6 = arg7 <<= 0xF;
						...
						while (true) {
							...
							if (arg2 < 0) {
								while (true) {
									...
									arg6 += local5;
									arg8 += local59;
									arg1 += Class1_Sub1_Sub2.anInt707;
								}
							}
		...
		} else if (arg2 < Class1_Sub1_Sub2.anInt710) {
			if (arg0 > Class1_Sub1_Sub2.anInt710) {
				arg0 = Class1_Sub1_Sub2.anInt710;
			}
			if (arg1 > Class1_Sub1_Sub2.anInt710) {
					...
					while (true) {
						...
						if (arg0 < 0) {
							while (true) {
								...
								arg7 += local32;
								arg6 += local5;
								arg2 += Class1_Sub1_Sub2.anInt707;
							}
						}
	...
	private static void method354(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5) {
		...
		if (aBoolean159) {
			if (aBoolean157) {
				...
				if (arg3 > Class1_Sub1_Sub2.anInt713) {
					arg3 = Class1_Sub1_Sub2.anInt713;
				}
				if (arg2 < 0) {
					arg4 -= arg2 * local18;
					arg2 = 0;
	...
	private static void method356(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		if (aBoolean157) {
			if (arg4 > Class1_Sub1_Sub2.anInt713) {
				arg4 = Class1_Sub1_Sub2.anInt713;
			}
			if (arg3 < 0) {
				arg3 = 0;
			}
		...
		@Pc(72) int local72 = anInt605;
		@Pc(76) int local76 = 256 - anInt605;
	...
	public static void method357(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18) {
		...
		aBoolean158 = !aBooleanArray8[arg18];
	...
	private static void method358(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14) {
		...
		if (aBoolean157) {
			...
			if (arg6 > Class1_Sub1_Sub2.anInt713) {
				arg6 = Class1_Sub1_Sub2.anInt713;
			}
			if (arg5 < 0) {
				arg7 -= arg5 * local15;
				arg5 = 0;
