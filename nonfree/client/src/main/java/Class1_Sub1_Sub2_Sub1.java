...
public final class Class1_Sub1_Sub2_Sub1 extends Class1_Sub1_Sub2 {
	...
	private static int anInt564 = 471;
	...
	public static void method342() {
		try {
			...
			signlink.reporterror("25123, " + false + ", " + local35.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!hb", name = "a", descriptor = "(B)V")
	public static void method343(@OriginalArg(0) byte arg0) {
		try {
			anIntArray180 = new int[Class1_Sub1_Sub2.anInt676];
			@Pc(9) boolean local9 = false;
			for (@Pc(19) int local19 = 0; local19 < Class1_Sub1_Sub2.anInt676; local19++) {
				anIntArray180[local19] = Class1_Sub1_Sub2.anInt675 * local19;
			}
			anInt566 = Class1_Sub1_Sub2.anInt675 / 2;
			anInt567 = Class1_Sub1_Sub2.anInt676 / 2;
		} catch (@Pc(41) RuntimeException local41) {
			signlink.reporterror("13618, " + arg0 + ", " + local41.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIB)V")
	public static void method344(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte arg2) {
		try {
			anIntArray180 = new int[arg0];
			@Pc(9) boolean local9 = false;
			for (@Pc(15) int local15 = 0; local15 < arg0; local15++) {
				anIntArray180[local15] = arg1 * local15;
			}
			anInt566 = arg1 / 2;
			anInt567 = arg0 / 2;
		} catch (@Pc(37) RuntimeException local37) {
			signlink.reporterror("61103, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + local37.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method345() {
		try {
			...
			signlink.reporterror("87216, " + -803 + ", " + local18.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method346(@OriginalArg(0) int arg0) {
		try {
			...
			if (anIntArrayArray13 == null) {
				anInt569 = 20;
				if (aBoolean158) {
					anIntArrayArray13 = new int[anInt569][16384];
				} else {
					anIntArrayArray13 = new int[anInt569][65536];
				}
			...
			signlink.reporterror("48980, " + arg0 + ", " + 20 + ", " + local35.toString());
			throw new RuntimeException();
		}
	}
		...
		try {
			...
			for (@Pc(5) int local5 = 0; local5 < 50; local5++) {
				try {
					...
					if (aBoolean158 && aClass1_Sub1_Sub2_Sub3Array5[local5].anInt657 == 128) {
			...
			signlink.reporterror("90422, " + arg0 + ", " + arg1 + ", " + local56.toString());
			throw new RuntimeException();
		}
	}
	...
	public static int method348(@OriginalArg(1) int arg0) {
		try {
			...
			signlink.reporterror("31306, " + 574 + ", " + arg0 + ", " + local95.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method349(@OriginalArg(1) int arg0) {
		try {
			if (anIntArrayArray14[arg0] != null) {
				anIntArrayArray13[anInt569++] = anIntArrayArray14[arg0];
				anIntArrayArray14[arg0] = null;
			}
		} catch (@Pc(24) RuntimeException local24) {
			signlink.reporterror("13497, " + -95 + ", " + arg0 + ", " + local24.toString());
			throw new RuntimeException();
		}
	}
	...
	private static int[] method350(@OriginalArg(0) int arg0) {
		...
		@Pc(39) int local39;
		if (anInt569 > 0) {
			local27 = anIntArrayArray13[--anInt569];
			anIntArrayArray13[anInt569] = null;
		} else {
			@Pc(35) int local35 = 0;
			@Pc(37) int local37 = -1;
			for (local39 = 0; local39 < anInt568; local39++) {
		...
		try {
			...
			for (@Pc(22) int local22 = 0; local22 < 512; local22++) {
				...
				for (@Pc(44) int local44 = 0; local44 < 128; local44++) {
					...
					local288 = method352(local288, local18);
					if (local288 == 0) {
						local288 = 1;
					}
					anIntArray183[local20++] = local288;
				}
			}
			for (@Pc(311) int local311 = 0; local311 < 50; local311++) {
				if (aClass1_Sub1_Sub2_Sub3Array5[local311] != null) {
					@Pc(322) int[] local322 = aClass1_Sub1_Sub2_Sub3Array5[local311].anIntArray212;
					anIntArrayArray15[local311] = new int[local322.length];
					for (@Pc(330) int local330 = 0; local330 < local322.length; local330++) {
						anIntArrayArray15[local311][local330] = method352(local322[local330], local18);
			...
			signlink.reporterror("41922, " + arg0 + ", " + false + ", " + local380.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method353(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (arg0 < Class1_Sub1_Sub2.anInt678) {
				if (arg1 > Class1_Sub1_Sub2.anInt678) {
					arg1 = Class1_Sub1_Sub2.anInt678;
				}
				if (arg2 > Class1_Sub1_Sub2.anInt678) {
					arg2 = Class1_Sub1_Sub2.anInt678;
				}
				if (arg1 < arg2) {
					arg5 = arg3 <<= 0x10;
					arg8 = arg6 <<= 0xF;
						...
						while (true) {
							...
							if (arg1 < 0) {
								while (true) {
									...
									arg8 += local59;
									arg7 += local32;
									arg0 += Class1_Sub1_Sub2.anInt675;
								}
							}
			...
			if (arg1 < Class1_Sub1_Sub2.anInt678) {
				...
				if (arg0 > Class1_Sub1_Sub2.anInt678) {
					arg0 = Class1_Sub1_Sub2.anInt678;
				}
				if (arg2 < arg0) {
					arg3 = arg4 <<= 0x10;
					arg6 = arg7 <<= 0xF;
						...
						while (true) {
							...
							if (arg2 < 0) {
								while (true) {
									...
									arg6 += local5;
									arg8 += local59;
									arg1 += Class1_Sub1_Sub2.anInt675;
								}
							}
		...
		} else if (arg2 < Class1_Sub1_Sub2.anInt678) {
			if (arg0 > Class1_Sub1_Sub2.anInt678) {
				arg0 = Class1_Sub1_Sub2.anInt678;
			}
			if (arg1 > Class1_Sub1_Sub2.anInt678) {
					...
					while (true) {
						...
						if (arg0 < 0) {
							while (true) {
								...
								arg7 += local32;
								arg6 += local5;
								arg2 += Class1_Sub1_Sub2.anInt675;
							}
						}
	...
	private static void method354(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5) {
		...
		if (aBoolean161) {
			if (aBoolean159) {
				...
				if (arg3 > Class1_Sub1_Sub2.anInt681) {
					arg3 = Class1_Sub1_Sub2.anInt681;
				}
				if (arg2 < 0) {
					arg4 -= arg2 * local18;
					arg2 = 0;
	...
	private static void method356(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		if (aBoolean159) {
			if (arg4 > Class1_Sub1_Sub2.anInt681) {
				arg4 = Class1_Sub1_Sub2.anInt681;
			}
			if (arg3 < 0) {
				arg3 = 0;
			}
		...
		@Pc(72) int local72 = anInt565;
		@Pc(76) int local76 = 256 - anInt565;
	...
	private static void method358(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14) {
		...
		if (aBoolean159) {
			...
			if (arg6 > Class1_Sub1_Sub2.anInt681) {
				arg6 = Class1_Sub1_Sub2.anInt681;
			}
			if (arg5 < 0) {
				arg7 -= arg5 * local15;
				arg5 = 0;
