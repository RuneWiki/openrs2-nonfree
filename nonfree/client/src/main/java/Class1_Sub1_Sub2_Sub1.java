...
public final class Class1_Sub1_Sub2_Sub1 extends Class1_Sub1_Sub2 {
	...
	static {
		for (@Pc(21) int local21 = 1; local21 < 512; local21++) {
			anIntArray181[local21] = 32768 / local21;
		}
		for (@Pc(34) int local34 = 1; local34 < 2048; local34++) {
			anIntArray182[local34] = 65536 / local34;
		}
		for (@Pc(47) int local47 = 0; local47 < 2048; local47++) {
			anIntArray183[local47] = (int) (Math.sin((double) local47 * 0.0030679615D) * 65536.0D);
			anIntArray184[local47] = (int) (Math.cos((double) local47 * 0.0030679615D) * 65536.0D);
		}
	...
	public static void method370() {
		try {
			...
			signlink.reporterror("70183, " + true + ", " + local35.toString());
	...
	public static void method371(@OriginalArg(0) int arg0) {
		try {
			label29: while (true) {
				...
				anIntArray185 = new int[Class1_Sub1_Sub2.anInt757];
				for (local5 = 0; local5 < Class1_Sub1_Sub2.anInt757; local5++) {
					anIntArray185[local5] = Class1_Sub1_Sub2.anInt756 * local5;
				}
				anInt674 = Class1_Sub1_Sub2.anInt756 / 2;
				anInt675 = Class1_Sub1_Sub2.anInt757 / 2;
				return;
			}
		} catch (@Pc(39) RuntimeException local39) {
			signlink.reporterror("45226, " + arg0 + ", " + local39.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method372(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			anIntArray185 = new int[arg1];
			for (@Pc(7) int local7 = 0; local7 < arg1; local7++) {
				anIntArray185[local7] = arg0 * local7;
			}
			anInt674 = arg0 / 2;
			anInt675 = arg1 / 2;
		} catch (@Pc(29) RuntimeException local29) {
			signlink.reporterror("78821, " + arg0 + ", " + arg1 + ", " + 869 + ", " + local29.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method373() {
		try {
			...
			for (@Pc(11) int local11 = 0; local11 < 50; local11++) {
				anIntArrayArray13[local11] = null;
			}
		} catch (@Pc(23) RuntimeException local23) {
			signlink.reporterror("70990, " + 0 + ", " + local23.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method374() {
		try {
			if (anIntArrayArray12 == null) {
				anInt677 = 20;
				if (aBoolean152) {
					anIntArrayArray12 = new int[anInt677][16384];
				} else {
					anIntArrayArray12 = new int[anInt677][65536];
				}
			...
			signlink.reporterror("59728, " + 0 + ", " + 20 + ", " + local34.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!ib", name = "a", descriptor = "(ZLclient!yb;)V")
	public static void method375(@OriginalArg(1) Class48 arg0) {
		try {
			anInt676 = 0;
			for (@Pc(14) int local14 = 0; local14 < 50; local14++) {
				try {
					aClass1_Sub1_Sub2_Sub3Array5[local14] = new Class1_Sub1_Sub2_Sub3(arg0, String.valueOf(local14), 0);
					if (aBoolean152 && aClass1_Sub1_Sub2_Sub3Array5[local14].anInt738 == 128) {
						aClass1_Sub1_Sub2_Sub3Array5[local14].method440();
					} else {
						aClass1_Sub1_Sub2_Sub3Array5[local14].method441();
					}
					anInt676++;
			...
			signlink.reporterror("86465, " + true + ", " + arg0 + ", " + local59.toString());
			throw new RuntimeException();
		}
	}
	...
	public static int method376(@OriginalArg(1) int arg0) {
		try {
			...
			@Pc(16) int local16 = 0;
			@Pc(18) int local18 = 0;
			@Pc(23) int local23 = anIntArrayArray14[arg0].length;
			for (@Pc(25) int local25 = 0; local25 < local23; local25++) {
				local14 += anIntArrayArray14[arg0][local25] >> 16 & 0xFF;
				local16 += anIntArrayArray14[arg0][local25] >> 8 & 0xFF;
				local18 += anIntArrayArray14[arg0][local25] & 0xFF;
			}
			@Pc(81) int local81 = (local14 / local23 << 16) + (local16 / local23 << 8) + local18 / local23;
			local81 = method380(local81, 1.4D);
			if (local81 == 0) {
				local81 = 1;
			}
			anIntArray186[arg0] = local81;
			return local81;
		} catch (@Pc(96) RuntimeException local96) {
			signlink.reporterror("83640, " + 12151 + ", " + arg0 + ", " + local96.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!ib", name = "a", descriptor = "(IB)V")
	public static void method377(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
		try {
			@Pc(4) boolean local4 = false;
			if (anIntArrayArray13[arg0] != null) {
				anIntArrayArray12[anInt677++] = anIntArrayArray13[arg0];
				anIntArrayArray13[arg0] = null;
			}
		} catch (@Pc(29) RuntimeException local29) {
			signlink.reporterror("35772, " + arg0 + ", " + arg1 + ", " + local29.toString());
			throw new RuntimeException();
		}
	}
	...
	private static int[] method378(@OriginalArg(0) int arg0) {
		...
		@Pc(39) int local39;
		if (anInt677 > 0) {
			local27 = anIntArrayArray12[--anInt677];
			anIntArrayArray12[anInt677] = null;
		} else {
			@Pc(35) int local35 = 0;
			@Pc(37) int local37 = -1;
			for (local39 = 0; local39 < anInt676; local39++) {
	...
	public static void method379(@OriginalArg(0) double arg0) {
		try {
			...
			for (@Pc(23) int local23 = 0; local23 < 512; local23++) {
				...
				for (@Pc(45) int local45 = 0; local45 < 128; local45++) {
					...
					@Pc(293) int local293 = method380(local289, local9);
					anIntArray188[local21++] = local293;
				}
			}
			for (@Pc(308) int local308 = 0; local308 < 50; local308++) {
				if (aClass1_Sub1_Sub2_Sub3Array5[local308] != null) {
					...
					anIntArrayArray14[local308] = new int[local319.length];
					for (@Pc(327) int local327 = 0; local327 < local319.length; local327++) {
						anIntArrayArray14[local308][local327] = method380(local319[local327], local9);
					}
				}
			}
			for (@Pc(350) int local350 = 0; local350 < 50; local350++) {
				method377(local350, (byte) 6);
			}
		} catch (@Pc(361) RuntimeException local361) {
			signlink.reporterror("13324, " + arg0 + ", " + 27381 + ", " + local361.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method381(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (arg0 < Class1_Sub1_Sub2.anInt759) {
				if (arg1 > Class1_Sub1_Sub2.anInt759) {
					arg1 = Class1_Sub1_Sub2.anInt759;
				}
				if (arg2 > Class1_Sub1_Sub2.anInt759) {
					arg2 = Class1_Sub1_Sub2.anInt759;
				}
				if (arg1 < arg2) {
					arg5 = arg3 <<= 0x10;
					arg8 = arg6 <<= 0xF;
						...
						while (true) {
							...
							if (arg1 < 0) {
								while (true) {
									...
									arg8 += local59;
									arg7 += local32;
									arg0 += Class1_Sub1_Sub2.anInt756;
								}
							}
			...
			if (arg1 < Class1_Sub1_Sub2.anInt759) {
				...
				if (arg0 > Class1_Sub1_Sub2.anInt759) {
					arg0 = Class1_Sub1_Sub2.anInt759;
				}
				if (arg2 < arg0) {
					arg3 = arg4 <<= 0x10;
					arg6 = arg7 <<= 0xF;
						...
						while (true) {
							...
							if (arg2 < 0) {
								while (true) {
									...
									arg6 += local5;
									arg8 += local59;
									arg1 += Class1_Sub1_Sub2.anInt756;
								}
							}
		...
		} else if (arg2 < Class1_Sub1_Sub2.anInt759) {
			if (arg0 > Class1_Sub1_Sub2.anInt759) {
				arg0 = Class1_Sub1_Sub2.anInt759;
			}
			if (arg1 > Class1_Sub1_Sub2.anInt759) {
					...
					while (true) {
						...
						if (arg0 < 0) {
							while (true) {
								...
								arg7 += local32;
								arg6 += local5;
								arg2 += Class1_Sub1_Sub2.anInt756;
							}
						}
	...
	private static void method382(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5) {
		...
		if (aBoolean155) {
			if (aBoolean153) {
				...
				if (arg3 > Class1_Sub1_Sub2.anInt762) {
					arg3 = Class1_Sub1_Sub2.anInt762;
				}
				if (arg2 < 0) {
					arg4 -= arg2 * local18;
					arg2 = 0;
	...
	private static void method384(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		if (aBoolean153) {
			if (arg4 > Class1_Sub1_Sub2.anInt762) {
				arg4 = Class1_Sub1_Sub2.anInt762;
			}
			if (arg3 < 0) {
				arg3 = 0;
			}
		...
		@Pc(72) int local72 = anInt673;
		@Pc(76) int local76 = 256 - anInt673;
	...
	public static void method385(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18) {
		...
		aBoolean154 = !aBooleanArray8[arg18];
	...
	private static void method386(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14) {
		...
		if (aBoolean153) {
			...
			if (arg6 > Class1_Sub1_Sub2.anInt762) {
				arg6 = Class1_Sub1_Sub2.anInt762;
			}
			if (arg5 < 0) {
				arg7 -= arg5 * local15;
				arg5 = 0;
