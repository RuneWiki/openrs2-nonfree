...
public final class Class1_Sub1_Sub2_Sub1 extends Class1_Sub1_Sub2 {
	...
	private static int anInt592 = -10467;

	@OriginalMember(owner = "client!hb", name = "w", descriptor = "I")
	private static int anInt593 = -927;

	@OriginalMember(owner = "client!hb", name = "y", descriptor = "I")
	private static int anInt595 = -825;
	...
	public static void method342() {
		try {
			...
			signlink.reporterror("16349, " + 0 + ", " + local38.toString());
	...
	public static void method343() {
		try {
			anIntArray180 = new int[Class1_Sub1_Sub2.anInt697];
			for (@Pc(8) int local8 = 0; local8 < Class1_Sub1_Sub2.anInt697; local8++) {
				anIntArray180[local8] = Class1_Sub1_Sub2.anInt696 * local8;
			}
			anInt597 = Class1_Sub1_Sub2.anInt696 / 2;
			anInt598 = Class1_Sub1_Sub2.anInt697 / 2;
		} catch (@Pc(30) RuntimeException local30) {
			signlink.reporterror("91604, " + -88 + ", " + local30.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method344(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			...
			for (@Pc(9) int local9 = 0; local9 < arg1; local9++) {
				anIntArray180[local9] = arg0 * local9;
			}
			anInt597 = arg0 / 2;
			anInt598 = arg1 / 2;
		} catch (@Pc(31) RuntimeException local31) {
			signlink.reporterror("85769, " + arg0 + ", " + arg1 + ", " + -108 + ", " + local31.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method345() {
		try {
			...
			signlink.reporterror("55404, " + true + ", " + local19.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method346() {
		try {
			if (anIntArrayArray13 == null) {
				anInt600 = 20;
				if (aBoolean151) {
					anIntArrayArray13 = new int[anInt600][16384];
				} else {
					anIntArrayArray13 = new int[anInt600][65536];
				}
				for (@Pc(26) int local26 = 0; local26 < 50; local26++) {
					anIntArrayArray14[local26] = null;
				}
			}
		} catch (@Pc(38) RuntimeException local38) {
			signlink.reporterror("87205, " + 8 + ", " + 20 + ", " + local38.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!hb", name = "a", descriptor = "(BLclient!xb;)V")
	public static void method347(@OriginalArg(1) Class47 arg0) {
		try {
			anInt599 = 0;
			for (@Pc(9) int local9 = 0; local9 < 50; local9++) {
				try {
					...
					if (aBoolean151 && aClass1_Sub1_Sub2_Sub3Array5[local9].anInt681 == 128) {
						aClass1_Sub1_Sub2_Sub3Array5[local9].method413();
					} else {
						aClass1_Sub1_Sub2_Sub3Array5[local9].method414(anInt593);
					}
					anInt599++;
			...
			signlink.reporterror("47460, " + 34 + ", " + arg0 + ", " + local54.toString());
			throw new RuntimeException();
		}
	}
	...
	public static int method348(@OriginalArg(1) int arg0) {
		try {
			...
			anIntArray181[arg0] = local78;
			return local78;
		} catch (@Pc(99) RuntimeException local99) {
			signlink.reporterror("75748, " + -84 + ", " + arg0 + ", " + local99.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method349(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			if (anIntArrayArray14[arg1] != null) {
				anIntArrayArray13[anInt600++] = anIntArrayArray14[arg1];
				if (arg0 == -10467) {
					anIntArrayArray14[arg1] = null;
				}
			}
		} catch (@Pc(24) RuntimeException local24) {
			signlink.reporterror("17989, " + arg0 + ", " + arg1 + ", " + local24.toString());
			throw new RuntimeException();
		}
	}
	...
	private static int[] method350(@OriginalArg(0) int arg0) {
		...
		@Pc(39) int local39;
		if (anInt600 > 0) {
			local27 = anIntArrayArray13[--anInt600];
			anIntArrayArray13[anInt600] = null;
		} else {
			@Pc(35) int local35 = 0;
			@Pc(37) int local37 = -1;
			for (local39 = 0; local39 < anInt599; local39++) {
	...
	public static void method351(@OriginalArg(1) double arg0) {
		try {
			...
			for (@Pc(363) int local363 = 0; local363 < 50; local363++) {
				method349(anInt592, local363);
			}
		} catch (@Pc(374) RuntimeException local374) {
			signlink.reporterror("99360, " + true + ", " + arg0 + ", " + local374.toString());
			throw new RuntimeException();
		}
	}
	...
	private static void method356(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		...
		@Pc(72) int local72 = anInt596;
		@Pc(76) int local76 = 256 - anInt596;
	...
	public static void method357(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18) {
		...
		aBoolean153 = !aBooleanArray8[arg18];
