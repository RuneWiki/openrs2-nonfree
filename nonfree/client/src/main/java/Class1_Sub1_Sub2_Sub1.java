...
public final class Class1_Sub1_Sub2_Sub1 extends Class1_Sub1_Sub2 {
	...
	@OriginalMember(owner = "client!ib", name = "N", descriptor = "[Lclient!kb;")
	...
	public static void method370() {
		try {
			...
			signlink.reporterror("48730, " + false + ", " + local29.toString());
	...
	public static void method371() {
		try {
			anIntArray185 = new int[Class1_Sub1_Sub2.anInt741];
			for (@Pc(13) int local13 = 0; local13 < Class1_Sub1_Sub2.anInt741; local13++) {
				anIntArray185[local13] = Class1_Sub1_Sub2.anInt740 * local13;
			}
			anInt663 = Class1_Sub1_Sub2.anInt740 / 2;
			anInt664 = Class1_Sub1_Sub2.anInt741 / 2;
		} catch (@Pc(35) RuntimeException local35) {
			signlink.reporterror("27863, " + 24380 + ", " + local35.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method372(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		try {
			...
			for (@Pc(8) int local8 = 0; local8 < arg0; local8++) {
				anIntArray185[local8] = arg2 * local8;
			}
			anInt663 = arg2 / 2;
			anInt664 = arg0 / 2;
		} catch (@Pc(30) RuntimeException local30) {
			signlink.reporterror("56844, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + local30.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method373() {
		try {
			...
			signlink.reporterror("31026, " + 41288 + ", " + local19.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method374() {
		try {
			if (anIntArrayArray12 == null) {
				anInt666 = 20;
				if (aBoolean171) {
					anIntArrayArray12 = new int[anInt666][16384];
				} else {
					anIntArrayArray12 = new int[anInt666][65536];
				}
			...
			signlink.reporterror("23519, " + 20 + ", " + 3 + ", " + local36.toString());
			throw new RuntimeException();
		}
	}
		...
		try {
			...
			for (@Pc(5) int local5 = 0; local5 < 50; local5++) {
				try {
					...
					if (aBoolean171 && aClass1_Sub1_Sub2_Sub3Array5[local5].anInt722 == 128) {
						aClass1_Sub1_Sub2_Sub3Array5[local5].method440();
					} else {
						aClass1_Sub1_Sub2_Sub3Array5[local5].method441();
					}
					anInt665++;
			...
			signlink.reporterror("11238, " + -984 + ", " + arg0 + ", " + local55.toString());
			throw new RuntimeException();
		}
	}
	...
	public static int method376(@OriginalArg(1) int arg0) {
		try {
			...
			local80 = method380(local80, 1.4D);
			if (local80 == 0) {
				local80 = 1;
			}
			anIntArray186[arg0] = local80;
			return local80;
		} catch (@Pc(95) RuntimeException local95) {
			signlink.reporterror("41231, " + 929 + ", " + arg0 + ", " + local95.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!ib", name = "b", descriptor = "(II)V")
	public static void method377(@OriginalArg(1) int arg0) {
		try {
			if (anIntArrayArray13[arg0] != null) {
				anIntArrayArray12[anInt666++] = anIntArrayArray13[arg0];
				anIntArrayArray13[arg0] = null;
			}
		} catch (@Pc(27) RuntimeException local27) {
			signlink.reporterror("13097, " + 2 + ", " + arg0 + ", " + local27.toString());
			throw new RuntimeException();
		}
	}
	...
	private static int[] method378(@OriginalArg(0) int arg0) {
		...
		@Pc(39) int local39;
		if (anInt666 > 0) {
			local27 = anIntArrayArray12[--anInt666];
			anIntArrayArray12[anInt666] = null;
		} else {
			@Pc(35) int local35 = 0;
			@Pc(37) int local37 = -1;
			for (local39 = 0; local39 < anInt665; local39++) {
		...
		try {
			...
			for (@Pc(13) int local13 = 0; local13 < 512; local13++) {
				...
				for (@Pc(35) int local35 = 0; local35 < 128; local35++) {
					...
					@Pc(283) int local283 = method380(local279, local9);
					anIntArray188[local11++] = local283;
				}
			}
			for (@Pc(298) int local298 = 0; local298 < 50; local298++) {
				if (aClass1_Sub1_Sub2_Sub3Array5[local298] != null) {
					...
					for (@Pc(317) int local317 = 0; local317 < local309.length; local317++) {
						anIntArrayArray14[local298][local317] = method380(local309[local317], local9);
					}
				}
			}
			...
			signlink.reporterror("74686, " + -208 + ", " + arg0 + ", " + local354.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method381(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (arg0 < Class1_Sub1_Sub2.anInt743) {
				if (arg1 > Class1_Sub1_Sub2.anInt743) {
					arg1 = Class1_Sub1_Sub2.anInt743;
				}
				if (arg2 > Class1_Sub1_Sub2.anInt743) {
		...
		} else if (arg2 < Class1_Sub1_Sub2.anInt743) {
			if (arg0 > Class1_Sub1_Sub2.anInt743) {
				arg0 = Class1_Sub1_Sub2.anInt743;
			}
			if (arg1 > Class1_Sub1_Sub2.anInt743) {
	...
	private static void method382(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5) {
		...
		if (aBoolean174) {
			if (aBoolean172) {
				...
				if (arg3 > Class1_Sub1_Sub2.anInt746) {
					arg3 = Class1_Sub1_Sub2.anInt746;
				}
				if (arg2 < 0) {
					arg4 -= arg2 * local18;
					arg2 = 0;
	...
	private static void method384(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		...
		@Pc(72) int local72 = anInt662;
		@Pc(76) int local76 = 256 - anInt662;
	...
	public static void method385(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18) {
		...
		aBoolean173 = !aBooleanArray9[arg18];
	...
	private static void method386(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14) {
		...
		if (aBoolean172) {
			...
			if (arg6 > Class1_Sub1_Sub2.anInt746) {
				arg6 = Class1_Sub1_Sub2.anInt746;
			}
			if (arg5 < 0) {
				arg7 -= arg5 * local15;
				arg5 = 0;
