...
public final class Class29_Sub7 extends Class29 {
	...
	@OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(Lclient!fs;)V")
	public Class29_Sub7(@OriginalArg(0) Class6_Sub22 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(ILclient!fs;)V")
	public Class29_Sub7(@OriginalArg(0) int arg0, @OriginalArg(1) Class6_Sub22 arg1) {
		super(arg0, arg1);
	}
