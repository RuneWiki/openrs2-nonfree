...
public final class Static4 {
	...
	@OriginalMember(owner = "client!ac", name = "C", descriptor = "Lclient!qm;")
	public static Class1_Sub14 aClass1_Sub14_1 = new Class1_Sub14(10000);

	@OriginalMember(owner = "client!ac", name = "V", descriptor = "Lclient!ac;")
	public static Class2_Sub1_Sub1 aClass2_Sub1_Sub1_1 = new Class2_Sub1_Sub1();

	@OriginalMember(owner = "client!ac", name = "db", descriptor = "Lclient!ac;")
	public static Class2_Sub1_Sub1 aClass2_Sub1_Sub1_2 = new Class2_Sub1_Sub1();

	@OriginalMember(owner = "client!ac", name = "eb", descriptor = "Lclient!ac;")
	public static Class2_Sub1_Sub1 aClass2_Sub1_Sub1_3 = new Class2_Sub1_Sub1();

	@OriginalMember(owner = "client!ac", name = "fb", descriptor = "Lclient!ac;")
	public static Class2_Sub1_Sub1 aClass2_Sub1_Sub1_4 = new Class2_Sub1_Sub1();

	@OriginalMember(owner = "client!ac", name = "gb", descriptor = "Lclient!ac;")
	public static Class2_Sub1_Sub1 aClass2_Sub1_Sub1_5 = new Class2_Sub1_Sub1();

	@OriginalMember(owner = "client!ac", name = "hb", descriptor = "Lclient!ac;")
	public static Class2_Sub1_Sub1 aClass2_Sub1_Sub1_6 = new Class2_Sub1_Sub1();

	@OriginalMember(owner = "client!ac", name = "nb", descriptor = "[I")
	public static int[] anIntArray10 = new int[1];
	...
	public static int[] anIntArray11 = new int[1];

	@OriginalMember(owner = "client!ac", name = "a", descriptor = "([FI)[F")
	public static float[] method132(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) float[] local2 = new float[arg1];
		Static319.method1424(arg0, 0, local2, 0, arg1);
		return local2;
	}

	@OriginalMember(owner = "client!ac", name = "a", descriptor = "(ISIB)I")
	public static int method135(@OriginalArg(0) int arg0, @OriginalArg(1) short arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		@Pc(5) int local5 = Static237.anIntArray462[Static26.method590(arg0, arg2)];
		if (arg1 != -1) {
			@Pc(15) int local15 = Static237.anInterface1_1.method4596(arg1 & 0xFFFF);
			@Pc(21) int local21;
			@Pc(44) int local44;
			if (local15 != 0) {
				if (arg2 < 0) {
			...
			local21 = Static237.anInterface1_1.method4600(arg1 & 0xFFFF);
			if (local21 != 0) {
				local21 += 256;
	...
	@OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIIIFFF)[F")
	public static float[] method137(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6) {
	...
	public static void method146() {
		aClass2_Sub1_Sub1_1 = new Class2_Sub1_Sub1();
		aClass2_Sub1_Sub1_2 = new Class2_Sub1_Sub1();
		aClass2_Sub1_Sub1_3 = new Class2_Sub1_Sub1();
		aClass2_Sub1_Sub1_4 = new Class2_Sub1_Sub1();
		aClass2_Sub1_Sub1_5 = new Class2_Sub1_Sub1();
		aClass2_Sub1_Sub1_6 = new Class2_Sub1_Sub1();
	}

	@OriginalMember(owner = "client!ac", name = "a", descriptor = "(FFF)I")
	public static int method148(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
	...
	@OriginalMember(owner = "client!ac", name = "a", descriptor = "([SI)[S")
	public static short[] method152(@OriginalArg(0) short[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) short[] local2 = new short[arg1];
		Static319.method1423(arg0, 0, local2, 0, arg1);
		return local2;
	}

	@OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIIIII[FIF)V")
	public static void method155(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) int arg7, @OriginalArg(8) float arg8) {
		@Pc(3) int local3 = arg0 - arg3;
		@Pc(7) int local7 = arg1 - arg4;
		@Pc(11) int local11 = arg2 - arg5;
	...
	@OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIIIII[FFIF)V")
	public static void method157(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) float arg7, @OriginalArg(8) int arg8, @OriginalArg(9) float arg9) {
		@Pc(3) int local3 = arg0 - arg3;
		@Pc(7) int local7 = arg1 - arg4;
		@Pc(11) int local11 = arg2 - arg5;
		@Pc(32) float local32 = (float) local3 * arg6[0] + (float) local7 * arg6[1] + (float) local11 * arg6[2];
