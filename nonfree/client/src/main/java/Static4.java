...
public final class Static4 {
	...
	public static void method72(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		if (arg0 == arg8 && arg5 == arg3 && arg4 == arg7 && arg1 == arg2) {
			Static358.method6417(arg2, arg7, arg8, arg5, arg6);
			return;
		}
		...
		for (@Pc(101) int local101 = 128; local101 <= 4096; local101 += 128) {
			...
			Static358.method6417(local159, local149, local27, local29, arg6);
			local29 = local159;
			local27 = local149;
		}
	}

	@OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIILclient!gq;Lclient!gq;)V", line = 82)
	...
	@OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZLclient!bt;)V", line = 118)
	public static void method76(@OriginalArg(1) Class2_Sub4 arg0) {
		for (@Pc(16) int local16 = 0; local16 < Static276.anInt5631; local16++) {
			@Pc(22) int local22 = arg0.method4818();
			@Pc(26) int local26 = arg0.method4830();
			if (local26 == 65535) {
				local26 = -1;
			}
			if (Static272.aClass3_Sub1Array1[local22] != null) {
				Static272.aClass3_Sub1Array1[local22].anInt78 = local26;
			}
		}
	}
	...
	public static void method77() {
		Class223.aClass135_37 = new Class135();
	}
}
