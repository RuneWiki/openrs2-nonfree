...
public final class Class365 {
	...
	public Class365() throws Exception {
	...
	private void enter(@OriginalArg(0) Frame arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (arg4 == 0) {
			...
			for (@Pc(35) int local35 = 0; local35 < local31.length; local35++) {
				if (arg1 == local31[local35].getWidth() && arg2 == local31[local35].getHeight() && arg3 == local31[local35].getBitDepth()) {
					@Pc(67) int local67 = local31[local35].getRefreshRate();
					if (!local33 || Math.abs(local67 - local27) < Math.abs(arg4 - local27)) {
						local33 = true;
						arg4 = local67;
					}
				}
	...
	private void exit() {
		...
		this.method7992(null, (byte) 121);
	}

	@OriginalMember(owner = "client!wv", name = "a", descriptor = "(Ljava/awt/Frame;B)V")
	private void method7992(@OriginalArg(0) Frame arg0, @OriginalArg(1) byte arg1) {
