...
public final class Static139 {
	...
	@OriginalMember(owner = "client!ma", name = "a", descriptor = "([B[IIIIIIIILclient!ma;)I")
	public static int method1187(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class4_Sub12_Sub3 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt1814 += arg8.anInt1808 * (local22 - arg3);
		arg8.anInt1809 += arg8.anInt1804 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt1807 = arg4 >> 2;
		arg8.anInt1803 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ma", name = "b", descriptor = "(II)I")
	public static int method1189(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ma", name = "a", descriptor = "(II[B[IIIIIIILclient!ma;II)I")
	public static int method1190(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class4_Sub12_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ma", name = "a", descriptor = "([B[IIIIIIILclient!ma;)I")
	public static int method1192(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class4_Sub12_Sub3 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt1803 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ma", name = "d", descriptor = "(II)I")
	public static int method1194(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ma", name = "b", descriptor = "([B[IIIIIIIILclient!ma;)I")
	public static int method1195(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class4_Sub12_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1814 += arg8.anInt1808 * (local24 - arg3);
		arg8.anInt1809 += arg8.anInt1804 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!ma", name = "b", descriptor = "([B[IIIIIIILclient!ma;)I")
	public static int method1199(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class4_Sub12_Sub3 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!ma", name = "b", descriptor = "(II[B[IIIIIIILclient!ma;II)I")
	public static int method1202(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class4_Sub12_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ma", name = "a", descriptor = "(II[B[IIIIIIIILclient!ma;II)I")
	public static int method1203(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub12_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1814 -= arg8.anInt1808 * arg3;
		arg8.anInt1809 -= arg8.anInt1804 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ma", name = "b", descriptor = "(II[B[IIIIIIIILclient!ma;II)I")
	public static int method1205(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub12_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ma", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!ma;)I")
	public static int method1206(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class4_Sub12_Sub3 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt1807 += arg10.anInt1813 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt1814 = arg4 >> 2;
		arg10.anInt1809 = arg5 >> 2;
		arg10.anInt1803 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lclient!pe;III)Lclient!ma;")
	public static Class4_Sub12_Sub3 method1207(@OriginalArg(0) Class4_Sub6_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray46 == null || arg0.aByteArray46.length == 0 ? null : new Class4_Sub12_Sub3(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!ma", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!ma;II)I")
	public static int method1210(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class4_Sub12_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1807 -= arg10.anInt1813 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt1807 += arg10.anInt1813 * local63;
		arg10.anInt1814 = arg4;
		arg10.anInt1809 = arg5;
		arg10.anInt1803 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!ma", name = "c", descriptor = "(II[B[IIIIIIIILclient!ma;II)I")
	public static int method1214(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub12_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lclient!pe;II)Lclient!ma;")
	public static Class4_Sub12_Sub3 method1215(@OriginalArg(0) Class4_Sub6_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray46 == null || arg0.aByteArray46.length == 0 ? null : new Class4_Sub12_Sub3(arg0, (int) ((long) arg0.anInt2133 * 256L * (long) 100 / (long) (Static106.anInt2355 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!ma", name = "a", descriptor = "(I[B[IIIIIIIILclient!ma;)I")
	public static int method1217(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class4_Sub12_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!ma", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!ma;)I")
	public static int method1218(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class4_Sub12_Sub3 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt1807 += arg10.anInt1813 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!ma", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!ma;II)I")
	public static int method1219(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class4_Sub12_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1807 -= arg10.anInt1813 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!ma", name = "b", descriptor = "(I[B[IIIIIIIILclient!ma;)I")
	public static int method1224(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class4_Sub12_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!ma", name = "d", descriptor = "(II[B[IIIIIIIILclient!ma;II)I")
	public static int method1225(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub12_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1814 -= arg8.anInt1808 * arg3;
		arg8.anInt1809 -= arg8.anInt1804 * arg3;
		@Pc(32) int local32;
