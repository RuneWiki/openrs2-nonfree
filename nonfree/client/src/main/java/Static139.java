...
public final class Static139 {
	...
	public static int method1814(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub3_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	public static int method1817(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub3_Sub3 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt2655 += arg10.anInt2646 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt2654 = arg4 >> 2;
		arg10.anInt2647 = arg5 >> 2;
		arg10.anInt2649 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!ra", name = "a", descriptor = "([B[IIIIIIIILclient!ra;)I")
	public static int method1818(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub3_Sub3 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt2654 += arg8.anInt2656 * (local24 - arg3);
		arg8.anInt2647 += arg8.anInt2651 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt2655 = arg4 >> 2;
		arg8.anInt2649 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ra", name = "a", descriptor = "(II)I")
	public static int method1819(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ra", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!ra;)I")
	public static int method1820(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub3_Sub3 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt2655 += arg10.anInt2646 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	public static int method1821(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub3_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		...
		local63 = arg3 >> 1;
		arg10.anInt2655 += arg10.anInt2646 * local63;
		arg10.anInt2654 = arg4;
		arg10.anInt2647 = arg5;
		arg10.anInt2649 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!ra", name = "a", descriptor = "([B[IIIIIIILclient!ra;)I")
	public static int method1824(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub3_Sub3 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt2649 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ra", name = "b", descriptor = "(II[B[IIIIIIIILclient!ra;II)I")
	public static int method1825(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub3_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lclient!nb;III)Lclient!ra;")
	public static Class3_Sub3_Sub3 method1826(@OriginalArg(0) Class3_Sub5_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray23 == null || arg0.aByteArray23.length == 0 ? null : new Class3_Sub3_Sub3(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!ra", name = "a", descriptor = "(II[B[IIIIIIILclient!ra;II)I")
	public static int method1827(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub3_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	public static int method1832(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub3_Sub3 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	public static int method1833(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub3_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt2654 += arg8.anInt2656 * (local22 - arg3);
		arg8.anInt2647 += arg8.anInt2651 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lclient!nb;II)Lclient!ra;")
	public static Class3_Sub3_Sub3 method1840(@OriginalArg(0) Class3_Sub5_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray23 == null || arg0.aByteArray23.length == 0 ? null : new Class3_Sub3_Sub3(arg0, (int) ((long) arg0.anInt2121 * 256L * (long) 100 / (long) (Static110.anInt2948 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!ra", name = "a", descriptor = "(I[B[IIIIIIIILclient!ra;)I")
	public static int method1841(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub3_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	public static int method1846(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub3_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	public static int method1847(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub3_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt2654 -= arg8.anInt2656 * arg3;
		arg8.anInt2647 -= arg8.anInt2651 * arg3;
		@Pc(32) int local32;
	...
	public static int method1848(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub3_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	public static int method1850(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub3_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt2654 -= arg8.anInt2656 * arg3;
		arg8.anInt2647 -= arg8.anInt2651 * arg3;
		@Pc(32) int local32;
	...
	public static int method1853(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub3_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt2655 -= arg10.anInt2646 * arg3;
		@Pc(23) int local23;
