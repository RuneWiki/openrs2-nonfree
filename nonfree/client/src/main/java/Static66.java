...
public final class Static66 {
	...
	public static ClientStream aClass6_3;

	@OriginalMember(owner = "client!ld", name = "p", descriptor = "Lclient!hb;")
	public static Pix8 aClass4_Sub1_Sub2_Sub3_3;

	@OriginalMember(owner = "client!ld", name = "b", descriptor = "Lclient!ec;")
	public static JagString aClass22_493 = Static60.method1113("Fallen lassen");

	@OriginalMember(owner = "client!ld", name = "c", descriptor = "Lclient!wd;")
	public static LinkList aClass82_6 = new LinkList();

	@OriginalMember(owner = "client!ld", name = "n", descriptor = "Lclient!ec;")
	private static JagString aClass22_494 = Static60.method1113("wishes to trade with you)3");

	@OriginalMember(owner = "client!ld", name = "r", descriptor = "Lclient!ec;")
	public static JagString aClass22_495 = aClass22_494;

	@OriginalMember(owner = "client!ld", name = "s", descriptor = "I")
	public static int anInt1863 = 0;

	@OriginalMember(owner = "client!ld", name = "t", descriptor = "Lclient!ec;")
	public static JagString aClass22_496 = Static60.method1113("zur-Uck auf die RuneScape)2Webseite gehen");
	...
	public static void method1156() {
		...
		if (Static72.anInt1915 == 164) {
			...
			if (local85 != null) {
				@Pc(95) LocType local95 = Static5.method45(local56);
				@Pc(109) int local109;
				@Pc(106) int local106;
				...
				@Pc(208) SoftwareModel local208 = local95.method875(local187, local30, local196, local151, local38, local179);
				if (local208 != null) {
					...
					local85.anInt1747 = Client.anInt2877 + local12;
					local85.anInt1735 = Client.anInt2877 + local22;
					if (local18 > local60) {
						local215 = local18;
						local18 = local60;
						local60 = local215;
		...
		@Pc(308) int local308;
		@Pc(345) ObjStackEntity local345;
		if (Static72.anInt1915 == 26) {
			...
			if (local22 >= 0 && local26 >= 0 && local22 < 104 && local26 < 104) {
				...
				if (Static19.aClass82ArrayArrayArray1[Static37.anInt895][local22][local26] == null) {
					Static19.aClass82ArrayArrayArray1[Static37.anInt895][local22][local26] = new LinkList();
				}
		...
		if (Static72.anInt1915 == 147) {
			...
			if (local38 >= 0 && local34 >= 0 && local38 < 103 && local34 < 103) {
				if (local26 == 0) {
					@Pc(452) Wall local452 = Static134.aClass77_1.method1927(Static37.anInt895, local38, local34);
					if (local452 != null) {
						local461 = local452.anInt26 >> 14 & 0x7FFF;
						if (local308 == 2) {
							local452.aClass4_Sub1_Sub3_1 = new LocEntity(local461, 2, local22 + 4, Static37.anInt895, local38, local34, local427, false, local452.aClass4_Sub1_Sub3_1);
							local452.aClass4_Sub1_Sub3_2 = new LocEntity(local461, 2, local22 + 1 & 0x3, Static37.anInt895, local38, local34, local427, false, local452.aClass4_Sub1_Sub3_2);
						} else {
							local452.aClass4_Sub1_Sub3_1 = new LocEntity(local461, local308, local22, Static37.anInt895, local38, local34, local427, false, local452.aClass4_Sub1_Sub3_1);
						}
					}
				}
				if (local26 == 1) {
					@Pc(528) Decor local528 = Static134.aClass77_1.method1954(Static37.anInt895, local38, local34);
					if (local528 != null) {
						local461 = local528.anInt2578 >> 14 & 0x7FFF;
						if (local308 == 4 || local308 == 5) {
							local528.aClass4_Sub1_Sub3_9 = new LocEntity(local461, 4, local22, Static37.anInt895, local38, local34, local427, false, local528.aClass4_Sub1_Sub3_9);
						} else if (local308 == 6) {
							local528.aClass4_Sub1_Sub3_9 = new LocEntity(local461, 4, local22 + 4, Static37.anInt895, local38, local34, local427, false, local528.aClass4_Sub1_Sub3_9);
						} else if (local308 == 7) {
							local528.aClass4_Sub1_Sub3_9 = new LocEntity(local461, 4, (local22 + 2 & 0x3) + 4, Static37.anInt895, local38, local34, local427, false, local528.aClass4_Sub1_Sub3_9);
						} else if (local308 == 8) {
							local528.aClass4_Sub1_Sub3_9 = new LocEntity(local461, 4, local22 + 4, Static37.anInt895, local38, local34, local427, false, local528.aClass4_Sub1_Sub3_9);
							local528.aClass4_Sub1_Sub3_8 = new LocEntity(local461, 4, (local22 + 2 & 0x3) + 4, Static37.anInt895, local38, local34, local427, false, local528.aClass4_Sub1_Sub3_8);
						}
					}
				}
				if (local26 == 2) {
					@Pc(658) Location local658 = Static134.aClass77_1.method1923(Static37.anInt895, local38, local34);
					if (local308 == 11) {
						local308 = 10;
					}
					if (local658 != null) {
						local658.aClass4_Sub1_Sub3_3 = new LocEntity(local658.anInt972 >> 14 & 0x7FFF, local308, local22, Static37.anInt895, local38, local34, local427, false, local658.aClass4_Sub1_Sub3_3);
					}
				}
				if (local26 == 3) {
					@Pc(694) GroundDecor local694 = Static134.aClass77_1.method1964(Static37.anInt895, local38, local34);
					if (local694 != null) {
						local694.aClass4_Sub1_Sub3_4 = new LocEntity(local694.anInt1809 >> 14 & 0x7FFF, 22, local22, Static37.anInt895, local38, local34, local427, false, local694.aClass4_Sub1_Sub3_4);
					}
				}
			}
			...
			if (local308 >= 0 && local22 >= 0 && local308 < 104 && local22 < 104) {
				@Pc(765) LinkList local765 = Static19.aClass82ArrayArrayArray1[Static37.anInt895][local308][local22];
				if (local765 != null) {
					for (local345 = (ObjStackEntity) local765.method2025(); local345 != null; local345 = (ObjStackEntity) local765.method2023()) {
			...
			if (local308 >= 0 && local22 >= 0 && local308 < 104 && local22 < 104) {
				@Pc(875) LinkList local875 = Static19.aClass82ArrayArrayArray1[Static37.anInt895][local308][local22];
				if (local875 != null) {
					for (@Pc(882) ObjStackEntity local882 = (ObjStackEntity) local875.method2025(); local882 != null; local882 = (ObjStackEntity) local875.method2023()) {
			...
			if (local308 >= 0 && local22 >= 0 && local308 < 104 && local22 < 104) {
				...
				@Pc(1062) SpotAnimEntity local1062 = new SpotAnimEntity(local26, Static37.anInt895, local308, local22, Static69.method1173(Static37.anInt895, local308, local22) - local30, local38, Client.anInt2877);
			...
			if (local26 >= 0 && local30 >= 0 && local26 < 104 && local30 < 104 && Static32.anInt824 != local308) {
				@Pc(1131) ObjStackEntity local1131 = new ObjStackEntity();
				...
				if (Static19.aClass82ArrayArrayArray1[Static37.anInt895][local26][local30] == null) {
					Static19.aClass82ArrayArrayArray1[Static37.anInt895][local26][local30] = new LinkList();
				}
			...
			if (Static72.anInt1915 == 82) {
				...
				if (local308 >= 0 && local22 >= 0 && local308 < 104 && local22 < 104 && local26 >= 0 && local30 >= 0 && local26 < 104 && local30 < 104 && local34 != 65535) {
					...
					@Pc(1550) ProjAnimEntity local1550 = new ProjAnimEntity(local34, Static37.anInt895, local308, local22, Static69.method1173(Static37.anInt895, local308, local22) - local427, Client.anInt2877 + local461, Client.anInt2877 + local56, local1467, local64, local38, local46);
					local26 = local26 * 128 + 64;
					local1550.method1752(local30, local26, local461 + Client.anInt2877, -local46 + Static69.method1173(Static37.anInt895, local26, local30));
	...
	public static void method1157(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		@Pc(8) IfType local8 = Static108.method1767(arg0, arg1);
		if (local8 != null && local8.anObjectArray20 != null) {
			@Pc(17) HookRequest local17 = new HookRequest();
	...
	public static ComponentPointer method1158(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(3) ComponentPointer local3 = new ComponentPointer();
		...
		@Pc(34) IfType local34 = Static106.method1749(arg2);
		if (local34 != null) {
	...
	public static void method1159(@OriginalArg(0) int arg0, @OriginalArg(1) World3D arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) CollisionMap[] arg3, @OriginalArg(5) int arg4) {
		@Pc(12) int local12 = -1;
		...
		while (true) {
			...
			while (true) {
				...
				if (local71 > 0 && local75 > 0 && local71 < 103 && local75 < 103) {
					...
					@Pc(108) CollisionMap local108 = null;
					if (local92 >= 0) {
	...
	public static VarBitType method1161(@OriginalArg(0) int arg0) {
		@Pc(10) VarBitType local10 = (VarBitType) Static51.aClass33_19.method998((long) arg0);
		if (local10 != null) {
			return local10;
		}
		...
		if (local28 != null) {
			local10.method36(new Packet(local28));
		}
