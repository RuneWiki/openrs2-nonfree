...
public final class Class2_Sub19 extends Class2 {
	...
	@OriginalMember(owner = "client!pf", name = "a", descriptor = "([I)Lclient!s;")
	public Class2_Sub4_Sub1 method1629(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray34 == null) {
			this.anInt2304 = 0;
			this.aFloatArray3 = new float[Static90.anInt2301];
			this.aByteArray34 = new byte[this.anInt2307];
			this.anInt2311 = 0;
			this.anInt2312 = 0;
		}
		while (this.anInt2312 < this.aByteArrayArray6.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1631(this.anInt2312);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2311;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt2307 - local47) {
					local50 = this.anInt2307 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2311;
				}
				this.anInt2311 = local47;
			}
			this.anInt2312++;
		}
		...
		return new Class2_Sub4_Sub1(this.anInt2309, local129, this.anInt2302, this.anInt2310, this.aBoolean180);
	}

	@OriginalMember(owner = "client!pf", name = "d", descriptor = "(I)[F")
	private float[] method1631(@OriginalArg(0) int arg0) {
		Static90.method1627(this.aByteArrayArray6[arg0]);
		Static90.method1626();
		@Pc(15) int local15 = Static90.method1628(Static19.method380(Static90.anIntArray250.length - 1));
		@Pc(19) boolean local19 = Static90.aBooleanArray23[local15];
		@Pc(25) int local25 = local19 ? Static90.anInt2301 : Static90.anInt2305;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static90.method1626() != 0;
			local29 = Static90.method1626() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static90.anInt2305 >> 2);
			local67 = (local25 >> 2) + (Static90.anInt2305 >> 2);
			local71 = Static90.anInt2305 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static90.anInt2305 >> 2);
			local104 = local25 + (Static90.anInt2305 >> 2) - (local25 >> 2);
			local108 = Static90.anInt2305 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class32 local123 = Static90.aClass32Array1[Static90.anIntArray250[local15]];
		@Pc(126) int local126 = local123.anInt1142;
		@Pc(131) int local131 = local123.anIntArray119[local126];
		@Pc(140) boolean local140 = !Static90.aClass83Array1[local131].method2200();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt1143; local144++) {
			@Pc(152) Class43 local152 = Static90.aClass43Array1[local123.anIntArray118[local144]];
			local154 = Static90.aFloatArray5;
			local152.method1018(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt1142;
			local176 = local123.anIntArray119[local171];
			Static90.aClass83Array1[local176].method2196(Static90.aFloatArray5, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static90.aFloatArray5[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static90.aFloatArray5;
			...
			@Pc(252) float[] local252 = local19 ? Static90.aFloatArray7 : Static90.aFloatArray1;
			@Pc(258) float[] local258 = local19 ? Static90.aFloatArray2 : Static90.aFloatArray6;
			@Pc(264) float[] local264 = local19 ? Static90.aFloatArray4 : Static90.aFloatArray8;
			@Pc(270) int[] local270 = local19 ? Static90.anIntArray251 : Static90.anIntArray252;
			...
			@Pc(486) int local486 = Static19.method380(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static90.aFloatArray5[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static90.aFloatArray5[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt2304 > 0) {
			local176 = this.anInt2304 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean178) {
				for (local212 = 0; local212 < this.anInt2306; local212++) {
					local1254 = (this.anInt2304 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static90.aFloatArray5[local212];
				}
			}
		}
		local154 = this.aFloatArray3;
		this.aFloatArray3 = Static90.aFloatArray5;
		Static90.aFloatArray5 = local154;
		this.anInt2304 = local25;
		this.anInt2306 = local104 - (local25 >> 1);
		this.aBoolean178 = local140;
		return local1228;
	}
	...
	private void method1635(@OriginalArg(0) byte[] arg0) {
		...
		this.anInt2309 = local4.method622();
		this.anInt2307 = local4.method622();
		this.anInt2302 = local4.method622();
		this.anInt2310 = local4.method622();
		if (this.anInt2310 < 0) {
			this.anInt2310 = ~this.anInt2310;
			this.aBoolean180 = true;
		}
		@Pc(40) int local40 = local4.method622();
		this.aByteArrayArray6 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method640();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method643(local64, local49);
