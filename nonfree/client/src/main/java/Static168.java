...
public final class Static168 {
	...
	public static int anInt4994 = 256;
	...
	public static int anInt4998 = -1;

	@OriginalMember(owner = "client!ml", name = "P", descriptor = "I")
	public static int anInt4999 = 256;
	...
	public static int anInt5003 = 0;

	@OriginalMember(owner = "client!ml", name = "c", descriptor = "(Ljava/lang/String;)Ljava/lang/String;")
	public static String method3970(@OriginalArg(0) String arg0) {
	...
	@OriginalMember(owner = "client!ml", name = "a", descriptor = "([[B[[B[I[I[III)I")
	public static int method3982(@OriginalArg(0) byte[][] arg0, @OriginalArg(1) byte[][] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
