...
public final class Class14_Sub11 extends Class14 {
	...
	@OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(Lclient!kda;)V")
	public Class14_Sub11(@OriginalArg(0) Class6_Sub33 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(ILclient!kda;)V")
	public Class14_Sub11(@OriginalArg(0) int arg0, @OriginalArg(1) Class6_Sub33 arg1) {
		super(arg0, arg1);
	}
