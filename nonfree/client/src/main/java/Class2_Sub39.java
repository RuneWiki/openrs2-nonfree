...
public final class Class2_Sub39 extends Class2 {
	...
	public Class2_Sub39(@OriginalArg(0) byte[] arg0) {
		this.method6419(arg0);
	}

	@OriginalMember(owner = "client!qv", name = "a", descriptor = "([B)V")
	private void method6419(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub22 local4 = new Class2_Sub22(arg0);
		this.anInt7616 = local4.method8542();
		this.anInt7615 = local4.method8542();
		this.anInt7621 = local4.method8542();
		this.anInt7620 = local4.method8542();
		if (this.anInt7620 < 0) {
			this.anInt7620 = ~this.anInt7620;
			this.aBoolean566 = true;
		}
		@Pc(40) int local40 = local4.method8542();
		this.aByteArrayArray25 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method8547();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method8502(local64, 0, local49);
			this.aByteArrayArray25[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!qv", name = "a", descriptor = "([I)Lclient!aaa;")
	public Class2_Sub1_Sub1 method6420(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray92 == null) {
			this.anInt7613 = 0;
			this.aFloatArray50 = new float[Static477.anInt7618];
			this.aByteArray92 = new byte[this.anInt7615];
			this.anInt7622 = 0;
			this.anInt7623 = 0;
		}
		while (this.anInt7623 < this.aByteArrayArray25.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method6423(this.anInt7623);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt7622;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt7615 - local47) {
					local50 = this.anInt7615 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt7622;
				}
				this.anInt7622 = local47;
			}
			this.anInt7623++;
		}
		...
		return new Class2_Sub1_Sub1(this.anInt7616, local129, this.anInt7621, this.anInt7620, this.aBoolean566);
	}

	@OriginalMember(owner = "client!qv", name = "b", descriptor = "(I)[F")
	private float[] method6423(@OriginalArg(0) int arg0) {
		Static477.method6428(this.aByteArrayArray25[arg0]);
		Static477.method6424();
		@Pc(15) int local15 = Static477.method6422(Static418.method5598(Static477.anIntArray552.length - 1));
		@Pc(19) boolean local19 = Static477.aBooleanArray135[local15];
		@Pc(25) int local25 = local19 ? Static477.anInt7618 : Static477.anInt7619;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static477.method6424() != 0;
			local29 = Static477.method6424() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static477.anInt7619 >> 2);
			local67 = (local25 >> 2) + (Static477.anInt7619 >> 2);
			local71 = Static477.anInt7619 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static477.anInt7619 >> 2);
			local104 = local25 + (Static477.anInt7619 >> 2) - (local25 >> 2);
			local108 = Static477.anInt7619 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class31 local123 = Static477.aClass31Array1[Static477.anIntArray552[local15]];
		@Pc(126) int local126 = local123.anInt785;
		@Pc(131) int local131 = local123.anIntArray71[local126];
		@Pc(140) boolean local140 = !Static477.aClass338Array1[local131].method7561();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt784; local144++) {
			@Pc(152) Class194 local152 = Static477.aClass194Array1[local123.anIntArray70[local144]];
			local154 = Static477.aFloatArray52;
			local152.method4099(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt785;
			local176 = local123.anIntArray71[local171];
			Static477.aClass338Array1[local176].method7564(Static477.aFloatArray52, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static477.aFloatArray52[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static477.aFloatArray52;
			...
			@Pc(252) float[] local252 = local19 ? Static477.aFloatArray49 : Static477.aFloatArray48;
			@Pc(258) float[] local258 = local19 ? Static477.aFloatArray47 : Static477.aFloatArray46;
			@Pc(264) float[] local264 = local19 ? Static477.aFloatArray45 : Static477.aFloatArray51;
			@Pc(270) int[] local270 = local19 ? Static477.anIntArray551 : Static477.anIntArray553;
			...
			@Pc(486) int local486 = Static418.method5598(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static477.aFloatArray52[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static477.aFloatArray52[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt7613 > 0) {
			local176 = this.anInt7613 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean564) {
				for (local212 = 0; local212 < this.anInt7612; local212++) {
					local1254 = (this.anInt7613 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static477.aFloatArray52[local212];
				}
			}
		}
		local154 = this.aFloatArray50;
		this.aFloatArray50 = Static477.aFloatArray52;
		Static477.aFloatArray52 = local154;
		this.anInt7613 = local25;
		this.anInt7612 = local104 - (local25 >> 1);
		this.aBoolean564 = local140;
		return local1228;
	}
}
