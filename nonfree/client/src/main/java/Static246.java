...
public final class Static246 {
	...
	@OriginalMember(owner = "client!iba", name = "a", descriptor = "Lclient!hu;")
	public static final Class155 aClass155_3 = new Class155();

	@OriginalMember(owner = "client!iba", name = "a", descriptor = "(IIIII)V")
	public static void method3847(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3) {
		if (arg3 >= arg1) {
			Static197.method3240(arg3, Static16.anIntArrayArray2[arg0], arg1, arg2);
		} else {
			Static197.method3240(arg1, Static16.anIntArrayArray2[arg0], arg3, arg2);
		}
	}

	@OriginalMember(owner = "client!iba", name = "a", descriptor = "(II)Lclient!qd;")
	public static Class5_Sub2 method3849(@OriginalArg(0) int arg0) {
		if (arg0 == 0) {
			...
			return new Class5_Sub2_Sub6_Sub1();
		} else if (arg0 == 19) {
