...
public final class sa extends Class18 implements Interface5 {
	...
	public native void ba(@OriginalArg(0) Class18 arg0);
	...
	@OriginalMember(owner = "client!sa", name = "b", descriptor = "()Lclient!ia;")
	@Override
