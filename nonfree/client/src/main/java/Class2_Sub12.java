...
public final class Class2_Sub12 extends Class2 {
	...
	@OriginalMember(owner = "client!of", name = "a", descriptor = "([I)Lclient!hb;")
	public Class2_Sub5_Sub1 method1376(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray26 == null) {
			this.anInt1829 = 0;
			this.aFloatArray6 = new float[Static85.anInt1827];
			this.aByteArray26 = new byte[this.anInt1828];
			this.anInt1837 = 0;
			this.anInt1836 = 0;
		}
		while (this.anInt1836 < this.aByteArrayArray7.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1378(this.anInt1836);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt1837;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt1828 - local47) {
					local50 = this.anInt1828 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray26[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt1837;
				}
				this.anInt1837 = local47;
			}
			this.anInt1836++;
		}
		this.aFloatArray6 = null;
		@Pc(129) byte[] local129 = this.aByteArray26;
		this.aByteArray26 = null;
		return new Class2_Sub5_Sub1(this.anInt1834, local129, this.anInt1830, this.anInt1831, this.aBoolean70);
	}

	@OriginalMember(owner = "client!of", name = "c", descriptor = "(I)[F")
	private float[] method1378(@OriginalArg(0) int arg0) {
		Static85.method1374(this.aByteArrayArray7[arg0]);
		Static85.method1381();
		@Pc(15) int local15 = Static85.method1379(Static104.method2060(Static85.anIntArray245.length - 1));
		@Pc(19) boolean local19 = Static85.aBooleanArray13[local15];
		@Pc(25) int local25 = local19 ? Static85.anInt1827 : Static85.anInt1835;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static85.method1381() != 0;
			local29 = Static85.method1381() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static85.anInt1835 >> 2);
			local67 = (local25 >> 2) + (Static85.anInt1835 >> 2);
			local71 = Static85.anInt1835 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static85.anInt1835 >> 2);
			local104 = local25 + (Static85.anInt1835 >> 2) - (local25 >> 2);
			local108 = Static85.anInt1835 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class26 local123 = Static85.aClass26Array1[Static85.anIntArray245[local15]];
		@Pc(126) int local126 = local123.anInt749;
		@Pc(131) int local131 = local123.anIntArray96[local126];
		@Pc(140) boolean local140 = !Static85.aClass73Array1[local131].method1751();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt750; local144++) {
			@Pc(152) Class36 local152 = Static85.aClass36Array1[local123.anIntArray95[local144]];
			local154 = Static85.aFloatArray7;
			local152.method743(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt749;
			local176 = local123.anIntArray96[local171];
			Static85.aClass73Array1[local176].method1753(Static85.aFloatArray7, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static85.aFloatArray7[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static85.aFloatArray7;
			...
			@Pc(252) float[] local252 = local19 ? Static85.aFloatArray8 : Static85.aFloatArray2;
			@Pc(258) float[] local258 = local19 ? Static85.aFloatArray4 : Static85.aFloatArray5;
			@Pc(264) float[] local264 = local19 ? Static85.aFloatArray3 : Static85.aFloatArray1;
			@Pc(270) int[] local270 = local19 ? Static85.anIntArray244 : Static85.anIntArray243;
			...
			@Pc(486) int local486 = Static104.method2060(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static85.aFloatArray7[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static85.aFloatArray7[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt1829 > 0) {
			local176 = this.anInt1829 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean71) {
				for (local212 = 0; local212 < this.anInt1832; local212++) {
					local1254 = (this.anInt1829 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static85.aFloatArray7[local212];
				}
			}
		}
		local154 = this.aFloatArray6;
		this.aFloatArray6 = Static85.aFloatArray7;
		Static85.aFloatArray7 = local154;
		this.anInt1829 = local25;
		this.anInt1832 = local104 - (local25 >> 1);
		this.aBoolean71 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!of", name = "b", descriptor = "([B)V")
	private void method1383(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub4 local4 = new Class2_Sub4(arg0);
		this.anInt1834 = local4.method903();
		this.anInt1828 = local4.method903();
		this.anInt1830 = local4.method903();
		this.anInt1831 = local4.method903();
		if (this.anInt1831 < 0) {
			this.anInt1831 = ~this.anInt1831;
			this.aBoolean70 = true;
		}
		@Pc(40) int local40 = local4.method903();
		this.aByteArrayArray7 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method933();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method910(local64, local49);
