...
public final class Static133 {
	...
	public static int method965(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub1_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		...
		local63 = arg3 >> 1;
		arg10.anInt1326 += arg10.anInt1329 * local63;
		arg10.anInt1332 = arg4;
		arg10.anInt1319 = arg5;
		arg10.anInt1324 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!ic", name = "a", descriptor = "(II[B[IIIIIIIILclient!ic;II)I")
	public static int method966(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub1_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1332 -= arg8.anInt1328 * arg3;
		arg8.anInt1319 -= arg8.anInt1331 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ic", name = "a", descriptor = "([B[IIIIIIILclient!ic;)I")
	public static int method969(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub1_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt1324 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ic", name = "b", descriptor = "([B[IIIIIIILclient!ic;)I")
	public static int method970(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub1_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	public static int method971(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ic", name = "a", descriptor = "([B[IIIIIIIILclient!ic;)I")
	public static int method972(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub1_Sub2 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt1332 += arg8.anInt1328 * (local22 - arg3);
		arg8.anInt1319 += arg8.anInt1331 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt1326 = arg4 >> 2;
		arg8.anInt1324 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ic", name = "a", descriptor = "(I[B[IIIIIIIILclient!ic;)I")
	public static int method974(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub1_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!ic", name = "b", descriptor = "(I[B[IIIIIIIILclient!ic;)I")
	public static int method979(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub1_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!ic", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!ic;)I")
	public static int method982(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub1_Sub2 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt1326 += arg10.anInt1329 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt1332 = arg4 >> 2;
		arg10.anInt1319 = arg5 >> 2;
		arg10.anInt1324 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!ic", name = "b", descriptor = "(II[B[IIIIIIIILclient!ic;II)I")
	public static int method984(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub1_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1332 -= arg8.anInt1328 * arg3;
		arg8.anInt1319 -= arg8.anInt1331 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ic", name = "a", descriptor = "(Lclient!vb;III)Lclient!ic;")
	public static Class1_Sub1_Sub2 method986(@OriginalArg(0) Class1_Sub9_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray39 == null || arg0.aByteArray39.length == 0 ? null : new Class1_Sub1_Sub2(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!ic", name = "a", descriptor = "(Lclient!vb;II)Lclient!ic;")
	public static Class1_Sub1_Sub2 method988(@OriginalArg(0) Class1_Sub9_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray39 == null || arg0.aByteArray39.length == 0 ? null : new Class1_Sub1_Sub2(arg0, (int) ((long) arg0.anInt3155 * 256L * (long) 100 / (long) (Static45.anInt2755 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!ic", name = "b", descriptor = "([B[IIIIIIIILclient!ic;)I")
	public static int method989(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub1_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1332 += arg8.anInt1328 * (local24 - arg3);
		arg8.anInt1319 += arg8.anInt1331 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!ic", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!ic;)I")
	public static int method991(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub1_Sub2 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt1326 += arg10.anInt1329 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!ic", name = "a", descriptor = "(II[B[IIIIIIILclient!ic;II)I")
	public static int method992(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub1_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	public static int method993(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ic", name = "c", descriptor = "(II[B[IIIIIIIILclient!ic;II)I")
	public static int method996(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub1_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ic", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!ic;II)I")
	public static int method997(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub1_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1326 -= arg10.anInt1329 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!ic", name = "d", descriptor = "(II[B[IIIIIIIILclient!ic;II)I")
	public static int method998(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub1_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ic", name = "b", descriptor = "(II[B[IIIIIIILclient!ic;II)I")
	public static int method1004(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub1_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
