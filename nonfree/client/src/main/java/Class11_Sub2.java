...
public final class Class11_Sub2 extends Class11 {
	...
	@OriginalMember(owner = "client!aja", name = "<init>", descriptor = "(Lclient!up;)V")
	public Class11_Sub2(@OriginalArg(0) Class5_Sub46 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!aja", name = "<init>", descriptor = "(ILclient!up;)V")
	public Class11_Sub2(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub46 arg1) {
		super(arg0, arg1);
	}
