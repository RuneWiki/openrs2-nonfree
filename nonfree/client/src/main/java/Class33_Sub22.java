...
public final class Class33_Sub22 extends Class33 {
	...
	@OriginalMember(owner = "client!sca", name = "<init>", descriptor = "(ILclient!cq;)V")
	public Class33_Sub22(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub13 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!sca", name = "<init>", descriptor = "(Lclient!cq;)V")
	public Class33_Sub22(@OriginalArg(0) Class2_Sub13 arg0) {
		super(arg0);
	}
	...
	protected int method8445() {
		return super.aClass2_Sub13_32.method1377().method3339() > 1 ? 4 : 2;
	}
	...
	public void method8441() {
		if (super.anInt10093 < 0 && super.anInt10093 > 4) {
