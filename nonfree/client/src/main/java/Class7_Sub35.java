...
public final class Class7_Sub35 extends Class7 {
	...
	public Class7_Sub35(@OriginalArg(0) byte[] arg0) {
		this.method4051(arg0);
	}

	@OriginalMember(owner = "client!pj", name = "a", descriptor = "([B)V")
	private void method4051(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class7_Sub14 local4 = new Class7_Sub14(arg0);
		this.anInt5130 = local4.method3938();
		this.anInt5133 = local4.method3938();
		this.anInt5135 = local4.method3938();
		this.anInt5129 = local4.method3938();
		if (this.anInt5129 < 0) {
			this.anInt5129 = ~this.anInt5129;
			this.aBoolean328 = true;
		}
		@Pc(40) int local40 = local4.method3938();
		this.aByteArrayArray21 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method3981();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method3932(local64, local49);
			this.aByteArrayArray21[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!pj", name = "a", descriptor = "(I)[F")
	private float[] method4053(@OriginalArg(0) int arg0) {
		Static306.method4058(this.aByteArrayArray21[arg0]);
		Static306.method4060();
		@Pc(15) int local15 = Static306.method4057(Static88.method1559(Static306.anIntArray461.length - 1));
		@Pc(19) boolean local19 = Static306.aBooleanArray27[local15];
		@Pc(25) int local25 = local19 ? Static306.anInt5132 : Static306.anInt5128;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static306.method4060() != 0;
			local29 = Static306.method4060() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static306.anInt5128 >> 2);
			local67 = (local25 >> 2) + (Static306.anInt5128 >> 2);
			local71 = Static306.anInt5128 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static306.anInt5128 >> 2);
			local104 = local25 + (Static306.anInt5128 >> 2) - (local25 >> 2);
			local108 = Static306.anInt5128 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class187 local123 = Static306.aClass187Array1[Static306.anIntArray461[local15]];
		@Pc(126) int local126 = local123.anInt5043;
		@Pc(131) int local131 = local123.anIntArray444[local126];
		@Pc(140) boolean local140 = !Static306.aClass76Array1[local131].method1857();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt5044; local144++) {
			@Pc(152) Class271 local152 = Static306.aClass271Array1[local123.anIntArray445[local144]];
			local154 = Static306.aFloatArray18;
			local152.method5796(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt5043;
			local176 = local123.anIntArray444[local171];
			Static306.aClass76Array1[local176].method1852(Static306.aFloatArray18, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static306.aFloatArray18[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static306.aFloatArray18;
			...
			@Pc(252) float[] local252 = local19 ? Static306.aFloatArray13 : Static306.aFloatArray19;
			@Pc(258) float[] local258 = local19 ? Static306.aFloatArray14 : Static306.aFloatArray15;
			@Pc(264) float[] local264 = local19 ? Static306.aFloatArray16 : Static306.aFloatArray12;
			@Pc(270) int[] local270 = local19 ? Static306.anIntArray459 : Static306.anIntArray460;
			...
			@Pc(486) int local486 = Static88.method1559(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static306.aFloatArray18[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static306.aFloatArray18[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt5131 > 0) {
			local176 = this.anInt5131 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean326) {
				for (local212 = 0; local212 < this.anInt5136; local212++) {
					local1254 = (this.anInt5131 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static306.aFloatArray18[local212];
				}
			}
		}
		local154 = this.aFloatArray17;
		this.aFloatArray17 = Static306.aFloatArray18;
		Static306.aFloatArray18 = local154;
		this.anInt5131 = local25;
		this.anInt5136 = local104 - (local25 >> 1);
		this.aBoolean326 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!pj", name = "a", descriptor = "([I)Lclient!lv;")
	public Class7_Sub31_Sub1 method4059(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray78 == null) {
			this.anInt5131 = 0;
			this.aFloatArray17 = new float[Static306.anInt5132];
			this.aByteArray78 = new byte[this.anInt5133];
			this.anInt5137 = 0;
			this.anInt5138 = 0;
		}
		while (this.anInt5138 < this.aByteArrayArray21.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method4053(this.anInt5138);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt5137;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt5133 - local47) {
					local50 = this.anInt5133 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray78[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt5137;
				}
				this.anInt5137 = local47;
			}
			this.anInt5138++;
		}
		this.aFloatArray17 = null;
		@Pc(129) byte[] local129 = this.aByteArray78;
		this.aByteArray78 = null;
		return new Class7_Sub31_Sub1(this.anInt5130, local129, this.anInt5135, this.anInt5129, this.aBoolean328);
	}
}
