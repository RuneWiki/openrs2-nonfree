...
public final class NpcType extends DoublyLinkable {
	...
	public Model method1429() {
		if (this.anIntArray221 != null) {
			...
			@Pc(57) Model[] local57 = new Model[this.anIntArray220.length];
			...
			if (local57.length == 1) {
				...
				local87 = new Model(local57, local57.length);
			}
			@Pc(106) int local106;
	...
	public void method1435(@OriginalArg(1) Packet arg0) {
		while (true) {
	...
	public SoftwareModel method1438(@OriginalArg(0) SeqType arg0, @OriginalArg(1) int arg1, @OriginalArg(2) SeqType arg2, @OriginalArg(4) int arg3) {
		...
		if (local40 == null) {
			...
			@Pc(78) Model[] local78 = new Model[this.anIntArray219.length];
			...
			if (local78.length == 1) {
				...
				local111 = new Model(local78, local78.length);
			}
			@Pc(122) int local122;
			if (this.aShortArray23 != null) {
	...
	private void method1440(@OriginalArg(1) Packet arg0, @OriginalArg(2) int arg1) {
		@Pc(8) int local8;
		@Pc(14) int local14;
		if (arg1 == 1) {
