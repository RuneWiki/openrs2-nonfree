...
public final class Class140 implements Interface1 {

	@OriginalMember(owner = "client!pn", name = "a", descriptor = "I")
	private int anInt4264 = -1;

	@OriginalMember(owner = "client!pn", name = "b", descriptor = "[I")
	private int[] anIntArray469 = null;
	...
	public Class140() {
		if (Static283.aBoolean389 && Static283.anInt5683 >= 2) {
			this.method3576();
			@Pc(19) GL local19 = Static283.aGL1;
			local19.glBindTexture(34067, this.anIntArray469[0]);
			...
			local19.glBindTexture(34067, this.anIntArray469[1]);
			local19.glTexParameteri(34067, 10241, 9729);
			local19.glTexParameteri(34067, 10240, 9729);
			local19.glTexParameteri(34067, 32882, 33071);
			local19.glTexParameteri(34067, 10242, 33071);
			local19.glTexParameteri(34067, 10243, 33071);
			local19.glBindTexture(34067, this.anIntArray469[2]);
			local19.glTexParameteri(34067, 10241, 9729);
			local19.glTexParameteri(34067, 10240, 9729);
			local19.glTexParameteri(34067, 32882, 33071);
			local19.glTexParameteri(34067, 10242, 33071);
			local19.glTexParameteri(34067, 10243, 33071);
			this.aBoolean304 = Static283.anInt5683 < 3;
		}
		this.method3577();
	}
	...
	public void method3984() {
		...
		if (Static67.aBoolean95) {
			local1.glCallList(this.anInt4264 + 1);
		} else {
			local1.glTexEnvi(8960, 34184, 5890);
		}
	}

	@OriginalMember(owner = "client!pn", name = "d", descriptor = "()V")
	private void method3576() {
		@Pc(1) GL local1 = Static283.aGL1;
		if (this.anIntArray469 == null) {
			this.anIntArray469 = new int[3];
			local1.glGenTextures(3, this.anIntArray469, 0);
		}
	...
	private void method3577() {
		@Pc(1) GL local1 = Static283.aGL1;
		this.anInt4264 = local1.glGenLists(2);
		local1.glNewList(this.anInt4264, 4864);
		if (this.anIntArray469 == null) {
			...
			if (this.aBoolean304) {
				...
				local1.glTexEnvi(8960, 34162, 7681);
				local1.glTexEnvi(8960, 34184, 34167);
				local1.glBindTexture(3553, Static283.anInt5686);
				local1.glEnable(3553);
			}
			local1.glActiveTexture(33984);
		}
		local1.glEndList();
		local1.glNewList(this.anInt4264 + 1, 4864);
		if (this.anIntArray469 == null) {
			local1.glTexEnvi(8960, 34184, 5890);
		} else {
			local1.glActiveTexture(33985);
	...
	public void method3983() {
		...
		if (Static67.aBoolean95) {
			local1.glCallList(this.anInt4264);
		} else {
			local1.glTexEnvi(8960, 34184, 34167);
		}
	}
	...
	public void method3985(@OriginalArg(0) int arg0) {
		@Pc(1) GL local1 = Static283.aGL1;
		if (Static67.aBoolean95 && this.anIntArray469 != null) {
			local1.glActiveTexture(33985);
			local1.glBindTexture(34067, this.anIntArray469[arg0 - 1]);
			local1.glActiveTexture(33984);
		}
	}
}
