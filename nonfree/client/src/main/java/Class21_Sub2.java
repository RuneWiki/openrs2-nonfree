...
public final class Class21_Sub2 extends Class21 {
	...
	@OriginalMember(owner = "client!be", name = "<init>", descriptor = "(Lclient!gn;)V")
	public Class21_Sub2(@OriginalArg(0) Class14_Sub22 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!be", name = "<init>", descriptor = "(ILclient!gn;)V")
	public Class21_Sub2(@OriginalArg(0) int arg0, @OriginalArg(1) Class14_Sub22 arg1) {
		super(arg0, arg1);
	}
