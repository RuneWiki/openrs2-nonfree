...
public final class Class40 {
	...
	public static int method595(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		synchronized (aClass43_1) {
			...
			aClass43_1.anInt945 = arg4;
			aClass43_1.aByteArray12 = arg0;
			aClass43_1.anInt949 = 0;
			aClass43_1.anInt946 = arg3;
			aClass43_1.anInt950 = arg1;
			aClass43_1.anInt955 = 0;
			aClass43_1.anInt954 = 0;
			aClass43_1.anInt947 = 0;
			aClass43_1.anInt948 = 0;
			aClass43_1.anInt951 = 0;
			aClass43_1.anInt952 = 0;
			aClass43_1.anInt957 = 0;
			method597(aClass43_1);
			return arg1 - aClass43_1.anInt950;
		}
	}

	@OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lclient!tb;)V")
	private static void method596(@OriginalArg(0) Class43 arg0) {
		@Pc(4) byte local4 = arg0.aByte39;
		@Pc(7) int local7 = arg0.anInt953;
		@Pc(10) int local10 = arg0.anInt961;
		@Pc(13) int local13 = arg0.anInt960;
		@Pc(15) int[] local15 = Class43.anIntArray255;
		@Pc(18) int local18 = arg0.anInt959;
		@Pc(21) byte[] local21 = arg0.aByteArray12;
		@Pc(24) int local24 = arg0.anInt949;
		@Pc(27) int local27 = arg0.anInt950;
		@Pc(29) int local29 = local27;
		@Pc(34) int local34 = arg0.anInt963 + 1;
		label67: while (true) {
			if (local7 > 0) {
				while (true) {
					if (local27 == 0) {
		...
		@Pc(224) int local224 = arg0.anInt951;
		arg0.anInt951 += local29 - local27;
		if (arg0.anInt951 < local224) {
			arg0.anInt952++;
		}
		arg0.aByte39 = local4;
		arg0.anInt953 = local7;
		arg0.anInt961 = local10;
		arg0.anInt960 = local13;
		Class43.anIntArray255 = local15;
		arg0.anInt959 = local18;
		arg0.aByteArray12 = local21;
		arg0.anInt949 = local24;
		arg0.anInt950 = local27;
	}
	...
	private static void method597(@OriginalArg(0) Class43 arg0) {
		...
		if (Class43.anIntArray255 == null) {
			Class43.anIntArray255 = new int[arg0.anInt956 * 100000];
		}
		...
		while (true) {
			while (local60) {
				...
				arg0.anInt958 = 0;
				local64 = method598(arg0);
				arg0.anInt958 = arg0.anInt958 << 8 | local64 & 0xFF;
				local64 = method598(arg0);
				arg0.anInt958 = arg0.anInt958 << 8 | local64 & 0xFF;
				local64 = method598(arg0);
				arg0.anInt958 = arg0.anInt958 << 8 | local64 & 0xFF;
				...
				method601(arg0);
				@Pc(244) int local244 = arg0.anInt962 + 2;
				...
				@Pc(462) int local462 = arg0.anInt962 + 1;
				@Pc(467) int local467 = arg0.anInt956 * 100000;
				...
				while (true) {
					...
					arg0.anInt959 = Class43.anIntArray255[arg0.anInt958] >> 8;
					arg0.anInt961 = 0;
					arg0.anInt959 = Class43.anIntArray255[arg0.anInt959];
					arg0.anInt960 = (byte) (arg0.anInt959 & 0xFF);
					arg0.anInt959 >>= 0x8;
					arg0.anInt961++;
					arg0.anInt963 = local520;
					method596(arg0);
					if (arg0.anInt961 == arg0.anInt963 + 1 && arg0.anInt953 == 0) {
						local60 = true;
						break;
					}
					local60 = false;
	...
	private static int method600(@OriginalArg(0) int arg0, @OriginalArg(1) Class43 arg1) {
		while (arg1.anInt955 < arg0) {
			arg1.anInt954 = arg1.anInt954 << 8 | arg1.aByteArray11[arg1.anInt945] & 0xFF;
			arg1.anInt955 += 8;
			arg1.anInt945++;
			arg1.anInt946--;
			arg1.anInt947++;
		...
		@Pc(17) int local17 = arg1.anInt954 >> arg1.anInt955 - arg0 & (0x1 << arg0) - 1;
		arg1.anInt955 -= arg0;
		return local17;
	}
	...
	private static void method601(@OriginalArg(0) Class43 arg0) {
		...
		for (@Pc(4) int local4 = 0; local4 < 256; local4++) {
			if (arg0.aBooleanArray11[local4]) {
				arg0.aByteArray13[arg0.anInt962] = (byte) local4;
				arg0.anInt962++;
			}
		}
	}
