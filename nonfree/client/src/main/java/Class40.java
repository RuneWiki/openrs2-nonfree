...
public final class Class40 {
	...
	@OriginalMember(owner = "client!tb", name = "a", descriptor = "I")
	private final int anInt932 = 4096;

	@OriginalMember(owner = "client!tb", name = "b", descriptor = "I")
	private final int anInt933 = 16;

	@OriginalMember(owner = "client!tb", name = "c", descriptor = "I")
	private final int anInt934 = 258;

	@OriginalMember(owner = "client!tb", name = "d", descriptor = "I")
	private final int anInt935 = 23;

	@OriginalMember(owner = "client!tb", name = "e", descriptor = "I")
	private final int anInt936 = 1;

	@OriginalMember(owner = "client!tb", name = "f", descriptor = "I")
	private final int anInt937 = 6;

	@OriginalMember(owner = "client!tb", name = "g", descriptor = "I")
	private final int anInt938 = 50;

	@OriginalMember(owner = "client!tb", name = "h", descriptor = "I")
	private final int anInt939 = 4;

	@OriginalMember(owner = "client!tb", name = "i", descriptor = "I")
	private final int anInt940 = 18002;

	@OriginalMember(owner = "client!tb", name = "D", descriptor = "[I")
	public int[] anIntArray240 = new int[256];

	@OriginalMember(owner = "client!tb", name = "F", descriptor = "[I")
	public int[] anIntArray241 = new int[257];

	@OriginalMember(owner = "client!tb", name = "G", descriptor = "[I")
	private int[] anIntArray242 = new int[257];
	...
	@OriginalMember(owner = "client!tb", name = "U", descriptor = "[I")
	public int[] anIntArray245 = new int[6];
}
