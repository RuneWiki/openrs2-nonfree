...
public final class Class40 implements Interface2 {
	...
	@OriginalMember(owner = "client!o", name = "a", descriptor = "(B)Lclient!o;")
	...
	@OriginalMember(owner = "client!o", name = "a", descriptor = "(Lclient!o;I)Z")
	...
	@OriginalMember(owner = "client!o", name = "e", descriptor = "(I)Lclient!o;")
	...
	@OriginalMember(owner = "client!o", name = "b", descriptor = "(B)Lclient!o;")
	...
	public Class40 method1180(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		...
		Static110.method993(this.aByteArray14, arg1, local7.aByteArray14, 0, local7.anInt1783);
		return local7;
	}

	@OriginalMember(owner = "client!o", name = "hashCode", descriptor = "()I")
	@Override
	public int hashCode() {
		return this.method1190();
	}

	@OriginalMember(owner = "client!o", name = "a", descriptor = "(BLjava/awt/FontMetrics;)I")
	...
	@OriginalMember(owner = "client!o", name = "d", descriptor = "(B)Lclient!o;")
	public Class40 method1183() {
		...
		if (this.anInt1783 != this.aByteArray14.length) {
			...
			Static110.method993(this.aByteArray14, 0, local27, 0, this.anInt1783);
			this.aByteArray14 = local27;
		}
		return this;
	}

	@OriginalMember(owner = "client!o", name = "a", descriptor = "(ILclient!o;)Z")
	...
	@OriginalMember(owner = "client!o", name = "c", descriptor = "(II)Lclient!o;")
	public Class40 method1185(@OriginalArg(1) int arg0) {
		return this.method1180(this.anInt1783, arg0);
	}

	@OriginalMember(owner = "client!o", name = "equals", descriptor = "(Ljava/lang/Object;)Z")
	@Override
	public boolean equals(@OriginalArg(0) Object arg0) {
		throw new RuntimeException();
	}

	@OriginalMember(owner = "client!o", name = "a", descriptor = "(IILclient!o;)I")
	...
	@OriginalMember(owner = "client!o", name = "b", descriptor = "(Z)[B")
	public byte[] method1189() {
		@Pc(13) byte[] local13 = new byte[this.anInt1783];
		Static110.method993(this.aByteArray14, 0, local13, 0, this.anInt1783);
		return local13;
	}

	@OriginalMember(owner = "client!o", name = "h", descriptor = "(I)I")
	...
	@OriginalMember(owner = "client!o", name = "a", descriptor = "([BIIII)I")
	public int method1191(@OriginalArg(0) byte[] arg0, @OriginalArg(3) int arg1, @OriginalArg(4) int arg2) {
		Static110.method993(this.aByteArray14, 0, arg0, arg2, arg1);
		return arg1;
	}

	@OriginalMember(owner = "client!o", name = "a", descriptor = "(BI)Lclient!o;")
	public Class40 method1192(@OriginalArg(1) int arg0) {
		...
		Static110.method993(this.aByteArray14, 0, local14.aByteArray14, 0, this.anInt1783);
		local14.aByteArray14[this.anInt1783] = (byte) arg0;
		return local14;
	}

	@OriginalMember(owner = "client!o", name = "a", descriptor = "(IILjava/awt/Graphics;I)V")
	...
	@OriginalMember(owner = "client!o", name = "a", descriptor = "(Lclient!o;Z)Z")
	...
	@OriginalMember(owner = "client!o", name = "f", descriptor = "(B)I")
	...
	@OriginalMember(owner = "client!o", name = "b", descriptor = "(Lclient!o;Z)Z")
	...
	@OriginalMember(owner = "client!o", name = "a", descriptor = "(Lclient!o;B)I")
