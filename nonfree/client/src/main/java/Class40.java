...
public final class Class40 {
	...
	public static int method595(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		synchronized (aClass43_1) {
			...
			aClass43_1.anInt976 = arg4;
			aClass43_1.aByteArray12 = arg0;
			aClass43_1.anInt980 = 0;
			aClass43_1.anInt977 = arg3;
			aClass43_1.anInt981 = arg1;
			aClass43_1.anInt986 = 0;
			aClass43_1.anInt985 = 0;
			aClass43_1.anInt978 = 0;
			aClass43_1.anInt979 = 0;
			aClass43_1.anInt982 = 0;
			aClass43_1.anInt983 = 0;
			aClass43_1.anInt988 = 0;
			method597(aClass43_1);
			return arg1 - aClass43_1.anInt981;
		}
	}

	@OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lclient!tb;)V")
	private static void method596(@OriginalArg(0) Class43 arg0) {
		@Pc(4) byte local4 = arg0.aByte64;
		@Pc(7) int local7 = arg0.anInt984;
		@Pc(10) int local10 = arg0.anInt992;
		@Pc(13) int local13 = arg0.anInt991;
		@Pc(15) int[] local15 = Class43.anIntArray255;
		@Pc(18) int local18 = arg0.anInt990;
		@Pc(21) byte[] local21 = arg0.aByteArray12;
		@Pc(24) int local24 = arg0.anInt980;
		@Pc(27) int local27 = arg0.anInt981;
		@Pc(29) int local29 = local27;
		@Pc(34) int local34 = arg0.anInt994 + 1;
		label67: while (true) {
			if (local7 > 0) {
				while (true) {
					if (local27 == 0) {
		...
		@Pc(224) int local224 = arg0.anInt982;
		arg0.anInt982 += local29 - local27;
		if (arg0.anInt982 < local224) {
			arg0.anInt983++;
		}
		arg0.aByte64 = local4;
		arg0.anInt984 = local7;
		arg0.anInt992 = local10;
		arg0.anInt991 = local13;
		Class43.anIntArray255 = local15;
		arg0.anInt990 = local18;
		arg0.aByteArray12 = local21;
		arg0.anInt980 = local24;
		arg0.anInt981 = local27;
	}
	...
	private static void method597(@OriginalArg(0) Class43 arg0) {
		...
		if (Class43.anIntArray255 == null) {
			Class43.anIntArray255 = new int[arg0.anInt987 * 100000];
		}
		...
		while (true) {
			while (local60) {
				...
				arg0.anInt989 = 0;
				local64 = method598(arg0);
				arg0.anInt989 = arg0.anInt989 << 8 | local64 & 0xFF;
				local64 = method598(arg0);
				arg0.anInt989 = arg0.anInt989 << 8 | local64 & 0xFF;
				local64 = method598(arg0);
				arg0.anInt989 = arg0.anInt989 << 8 | local64 & 0xFF;
				...
				method601(arg0);
				@Pc(244) int local244 = arg0.anInt993 + 2;
				...
				@Pc(462) int local462 = arg0.anInt993 + 1;
				@Pc(467) int local467 = arg0.anInt987 * 100000;
				...
				while (true) {
					...
					arg0.anInt990 = Class43.anIntArray255[arg0.anInt989] >> 8;
					arg0.anInt992 = 0;
					arg0.anInt990 = Class43.anIntArray255[arg0.anInt990];
					arg0.anInt991 = (byte) (arg0.anInt990 & 0xFF);
					arg0.anInt990 >>= 0x8;
					arg0.anInt992++;
					arg0.anInt994 = local520;
					method596(arg0);
					if (arg0.anInt992 == arg0.anInt994 + 1 && arg0.anInt984 == 0) {
						local60 = true;
						break;
					}
					local60 = false;
	...
	private static int method600(@OriginalArg(0) int arg0, @OriginalArg(1) Class43 arg1) {
		while (arg1.anInt986 < arg0) {
			arg1.anInt985 = arg1.anInt985 << 8 | arg1.aByteArray11[arg1.anInt976] & 0xFF;
			arg1.anInt986 += 8;
			arg1.anInt976++;
			arg1.anInt977--;
			arg1.anInt978++;
		...
		@Pc(17) int local17 = arg1.anInt985 >> arg1.anInt986 - arg0 & (0x1 << arg0) - 1;
		arg1.anInt986 -= arg0;
		return local17;
	}
	...
	private static void method601(@OriginalArg(0) Class43 arg0) {
		...
		for (@Pc(4) int local4 = 0; local4 < 256; local4++) {
			if (arg0.aBooleanArray10[local4]) {
				arg0.aByteArray13[arg0.anInt993] = (byte) local4;
				arg0.anInt993++;
			}
		}
	}
