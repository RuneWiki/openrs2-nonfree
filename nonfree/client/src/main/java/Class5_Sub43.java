...
public final class Class5_Sub43 extends Class5 {
	...
	public Class5_Sub43(@OriginalArg(0) byte[] arg0) {
		this.method5498(arg0);
	}

	@OriginalMember(owner = "client!uo", name = "b", descriptor = "(I)[F")
	private float[] method5489(@OriginalArg(0) int arg0) {
		Static416.method5499(this.aByteArrayArray20[arg0]);
		Static416.method5491();
		@Pc(15) int local15 = Static416.method5488(Static160.method2271(Static416.anIntArray474.length - 1));
		@Pc(19) boolean local19 = Static416.aBooleanArray25[local15];
		@Pc(25) int local25 = local19 ? Static416.anInt6948 : Static416.anInt6945;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static416.method5491() != 0;
			local29 = Static416.method5491() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static416.anInt6945 >> 2);
			local67 = (local25 >> 2) + (Static416.anInt6945 >> 2);
			local71 = Static416.anInt6945 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static416.anInt6945 >> 2);
			local104 = local25 + (Static416.anInt6945 >> 2) - (local25 >> 2);
			local108 = Static416.anInt6945 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class112 local123 = Static416.aClass112Array1[Static416.anIntArray474[local15]];
		@Pc(126) int local126 = local123.anInt2924;
		@Pc(131) int local131 = local123.anIntArray162[local126];
		@Pc(140) boolean local140 = !Static416.aClass271Array1[local131].method6045();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt2923; local144++) {
			@Pc(152) Class109 local152 = Static416.aClass109Array1[local123.anIntArray163[local144]];
			local154 = Static416.aFloatArray23;
			local152.method2337(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt2924;
			local176 = local123.anIntArray162[local171];
			Static416.aClass271Array1[local176].method6043(Static416.aFloatArray23, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static416.aFloatArray23[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static416.aFloatArray23;
			...
			@Pc(252) float[] local252 = local19 ? Static416.aFloatArray27 : Static416.aFloatArray25;
			@Pc(258) float[] local258 = local19 ? Static416.aFloatArray28 : Static416.aFloatArray21;
			@Pc(264) float[] local264 = local19 ? Static416.aFloatArray22 : Static416.aFloatArray26;
			@Pc(270) int[] local270 = local19 ? Static416.anIntArray473 : Static416.anIntArray472;
			...
			@Pc(486) int local486 = Static160.method2271(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static416.aFloatArray23[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static416.aFloatArray23[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt6942 > 0) {
			local176 = this.anInt6942 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean466) {
				for (local212 = 0; local212 < this.anInt6940; local212++) {
					local1254 = (this.anInt6942 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static416.aFloatArray23[local212];
				}
			}
		}
		local154 = this.aFloatArray24;
		this.aFloatArray24 = Static416.aFloatArray23;
		Static416.aFloatArray23 = local154;
		this.anInt6942 = local25;
		this.anInt6940 = local104 - (local25 >> 1);
		this.aBoolean466 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!uo", name = "a", descriptor = "([I)Lclient!rm;")
	public Class5_Sub5_Sub1 method5492(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray92 == null) {
			this.anInt6942 = 0;
			this.aFloatArray24 = new float[Static416.anInt6948];
			this.aByteArray92 = new byte[this.anInt6949];
			this.anInt6950 = 0;
			this.anInt6951 = 0;
		}
		while (this.anInt6951 < this.aByteArrayArray20.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method5489(this.anInt6951);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt6950;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt6949 - local47) {
					local50 = this.anInt6949 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray92[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt6950;
				}
				this.anInt6950 = local47;
			}
			this.anInt6951++;
		}
		this.aFloatArray24 = null;
		@Pc(129) byte[] local129 = this.aByteArray92;
		this.aByteArray92 = null;
		return new Class5_Sub5_Sub1(this.anInt6946, local129, this.anInt6944, this.anInt6941, this.aBoolean464);
	}

	@OriginalMember(owner = "client!uo", name = "b", descriptor = "([B)V")
	private void method5498(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class5_Sub15 local4 = new Class5_Sub15(arg0);
		this.anInt6946 = local4.method5603();
		this.anInt6949 = local4.method5603();
		this.anInt6944 = local4.method5603();
		this.anInt6941 = local4.method5603();
		if (this.anInt6941 < 0) {
			this.anInt6941 = ~this.anInt6941;
			this.aBoolean464 = true;
		}
		@Pc(40) int local40 = local4.method5603();
		this.aByteArrayArray20 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method5539();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method5540(local49, local64);
