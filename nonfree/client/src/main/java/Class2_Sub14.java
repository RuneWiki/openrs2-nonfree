...
public final class Class2_Sub14 extends Class2 {
	...
	private float[] method1535(@OriginalArg(0) int arg0) {
		Static83.method1539(this.aByteArrayArray4[arg0]);
		Static83.method1536();
		@Pc(15) int local15 = Static83.method1532(Static420.method6395(Static83.anIntArray159.length - 1));
		@Pc(19) boolean local19 = Static83.aBooleanArray16[local15];
		@Pc(25) int local25 = local19 ? Static83.anInt1758 : Static83.anInt1766;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static83.method1536() != 0;
			local29 = Static83.method1536() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static83.anInt1766 >> 2);
			local67 = (local25 >> 2) + (Static83.anInt1766 >> 2);
			local71 = Static83.anInt1766 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static83.anInt1766 >> 2);
			local104 = local25 + (Static83.anInt1766 >> 2) - (local25 >> 2);
			local108 = Static83.anInt1766 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class330 local123 = Static83.aClass330Array1[Static83.anIntArray159[local15]];
		@Pc(126) int local126 = local123.anInt9151;
		@Pc(131) int local131 = local123.anIntArray639[local126];
		@Pc(140) boolean local140 = !Static83.aClass27Array1[local131].method675();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt9150; local144++) {
			@Pc(152) Class218 local152 = Static83.aClass218Array1[local123.anIntArray638[local144]];
			local154 = Static83.aFloatArray11;
			local152.method5450(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt9151;
			local176 = local123.anIntArray639[local171];
			Static83.aClass27Array1[local176].method676(Static83.aFloatArray11, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static83.aFloatArray11[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static83.aFloatArray11;
			...
			@Pc(252) float[] local252 = local19 ? Static83.aFloatArray9 : Static83.aFloatArray12;
			@Pc(258) float[] local258 = local19 ? Static83.aFloatArray7 : Static83.aFloatArray6;
			@Pc(264) float[] local264 = local19 ? Static83.aFloatArray5 : Static83.aFloatArray10;
			@Pc(270) int[] local270 = local19 ? Static83.anIntArray160 : Static83.anIntArray158;
			...
			@Pc(486) int local486 = Static420.method6395(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static83.aFloatArray11[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static83.aFloatArray11[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt1760 > 0) {
			local176 = this.anInt1760 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean149) {
				for (local212 = 0; local212 < this.anInt1762; local212++) {
					local1254 = (this.anInt1760 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static83.aFloatArray11[local212];
				}
			}
		}
		local154 = this.aFloatArray8;
		this.aFloatArray8 = Static83.aFloatArray11;
		Static83.aFloatArray11 = local154;
		this.anInt1760 = local25;
		this.anInt1762 = local104 - (local25 >> 1);
		this.aBoolean149 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!dc", name = "a", descriptor = "([I)Lclient!cj;")
	public Class2_Sub12_Sub1 method1537(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray23 == null) {
			this.anInt1760 = 0;
			this.aFloatArray8 = new float[Static83.anInt1758];
			this.aByteArray23 = new byte[this.anInt1767];
			this.anInt1769 = 0;
			this.anInt1768 = 0;
		}
		while (this.anInt1768 < this.aByteArrayArray4.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1535(this.anInt1768);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt1769;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt1767 - local47) {
					local50 = this.anInt1767 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt1769;
				}
				this.anInt1769 = local47;
			}
			this.anInt1768++;
		}
		...
		return new Class2_Sub12_Sub1(this.anInt1759, local129, this.anInt1765, this.anInt1763, this.aBoolean150);
	}

	@OriginalMember(owner = "client!dc", name = "a", descriptor = "([B)V")
	private void method1538(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub34 local4 = new Class2_Sub34(arg0);
		this.anInt1759 = local4.method6865();
		this.anInt1767 = local4.method6865();
		this.anInt1765 = local4.method6865();
		this.anInt1763 = local4.method6865();
		if (this.anInt1763 < 0) {
			this.anInt1763 = ~this.anInt1763;
			this.aBoolean150 = true;
		}
		@Pc(40) int local40 = local4.method6865();
		this.aByteArrayArray4 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method6904();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method6891(local64, local49, 0);
