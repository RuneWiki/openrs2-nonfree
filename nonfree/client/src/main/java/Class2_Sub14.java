...
public final class Class2_Sub14 extends Class2 {
	...
	public Class2_Sub14(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) boolean arg3) {
		...
		if (arg3) {
			@Pc(16) int[] local16 = new int[this.anInt2232];
			@Pc(20) int[] local20 = new int[this.anInt2232];
			@Pc(24) int[] local24 = new int[this.anInt2232];
			if (Static101.anIntArray138 == null || Static101.anIntArray138.length < this.anIntArray137.length) {
				Static101.anIntArray138 = new int[this.anIntArray137.length];
			}
			@Pc(40) int local40 = this.anInt2232;
			@Pc(43) int local43 = this.anInt2232;
			...
			for (@Pc(116) int local116 = local51; local116 >= 0; local116--) {
				...
				for (local64 = local47; local64 >= 0; local64--) {
					...
					local114--;
					Static101.anIntArray138[local114] = local165 << 16 | local169 << 8 | local173;
			...
			this.anIntArray137 = Static101.anIntArray138;
			Static101.anIntArray138 = local306;
		}
	}

	@OriginalMember(owner = "client!ga", name = "a", descriptor = "(II)V", line = 8)
	public void method2253(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 == 0 && arg1 == 0) {
			return;
		}
		if (Static101.anIntArray138 == null || Static101.anIntArray138.length < this.anIntArray137.length) {
		...
		@Pc(28) int local28 = this.anInt2232 - 1;
		@Pc(33) int local33 = this.anInt2232 * arg1;
		@Pc(37) int local37 = local21 - 1;
		for (@Pc(39) int local39 = 0; local39 < local21; local39 += this.anInt2232) {
			@Pc(46) int local46 = local39 + local33 & local37;
			for (@Pc(48) int local48 = 0; local48 < this.anInt2232; local48++) {
				@Pc(53) int local53 = local39 + local48;
				@Pc(61) int local61 = local46 + (local48 + arg0 & local28);
				Static101.anIntArray138[local53] = this.anIntArray137[local61];
			}
		}
		@Pc(84) int[] local84 = this.anIntArray137;
		this.anIntArray137 = Static101.anIntArray138;
		Static101.anIntArray138 = local84;
	}
