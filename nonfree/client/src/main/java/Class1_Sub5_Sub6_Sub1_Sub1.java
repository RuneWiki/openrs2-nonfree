...
public final class Class1_Sub5_Sub6_Sub1_Sub1 extends Class1_Sub5_Sub6_Sub1 {

	@OriginalMember(owner = "client!f", name = "<init>", descriptor = "(IIIIII[I)V")
	public Class1_Sub5_Sub6_Sub1_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int[] arg6) {
		super(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
	}

	@OriginalMember(owner = "client!f", name = "<init>", descriptor = "(II)V")
	public Class1_Sub5_Sub6_Sub1_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!f", name = "b", descriptor = "(IIIIIIII[I[I)V")
	@Override
		...
		try {
			...
			for (@Pc(71) int local71 = 0; local71 < arg3; local71++) {
				...
				for (@Pc(99) int local99 = -arg8[local71]; local99 < 0; local99++) {
					...
					@Pc(119) int local119 = Static77.anIntArray131[local82];
					@Pc(123) int local123 = local115 >>> 24;
					@Pc(127) int local127 = 256 - local123;
					Static77.anIntArray131[local82++] = ((local115 & 0xFF00FF) * local123 + (local119 & 0xFF00FF) * local127 & 0xFF00FF00) + ((local115 & 0xFF00) * local123 + (local119 & 0xFF00) * local127 & 0xFF0000) >>> 8;
					local88 += local39;
					local94 -= local33;
				}
				local51 += local33;
	...
	@OriginalMember(owner = "client!f", name = "a", descriptor = "(IIIIIIII[I[I)V")
	@Override
	...
	@OriginalMember(owner = "client!f", name = "a", descriptor = "(IIIIIIDI)V")
	@Override
		...
		try {
			...
			for (@Pc(65) int local65 = 0; local65 < 20; local65++) {
				...
				for (@Pc(77) int local77 = -20; local77 < 0; local77++) {
					...
					@Pc(97) int local97 = Static77.anIntArray131[local70];
					@Pc(101) int local101 = local93 >>> 24;
					@Pc(105) int local105 = 256 - local101;
					Static77.anIntArray131[local70++] = ((local93 & 0xFF00FF) * local101 + (local97 & 0xFF00FF) * local105 & 0xFF00FF00) + ((local93 & 0xFF00) * local101 + (local97 & 0xFF00) * local105 & 0xFF0000) >>> 8;
					local72 += local33;
					local74 -= local27;
				}
				local45 += local27;
	...
	public void method3200(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		Static318.method1290(Static77.anIntArray131, this.anIntArray117, local12, local14, local46, local130, arg2, arg3, local26, local32, local7);
	}
	...
	public void method3195(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (local23 > 0 && local20 > 0) {
			Static318.method1293(Static77.anIntArray131, this.anIntArray117, local17, local15, local23, local20, local27, local29);
		}
	}
	...
	public void method3201(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if (local23 > 0 && local20 > 0) {
			Static318.method1291(Static77.anIntArray131, this.anIntArray117, local17, local15, local23, local20, local27, local29, arg2);
		}
	}
	...
	public void method3206(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (local32 > 0 && local29 > 0) {
			Static318.method1292(Static77.anIntArray131, this.anIntArray117, local26, local21, local32, local29, local36, local40);
		}
	}
	...
	public void method3205(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		Static318.method1289(Static77.anIntArray131, this.anIntArray117, local12, local14, local46, local130, arg2, arg3, local26, local32, local7, arg4);
	}
		...
		if (local342 != 0) {
			...
			if (local342 < 0) {
				if (local333 == 0) {
					...
					while (local384 < 0) {
						...
						if (local378 >= 0 && local378 - (this.anInt3625 << 12) < 0) {
							@Pc(825) int local825;
							if ((local825 = local802 - (this.anInt3617 << 12)) >= 0) {
							...
							while (local394 < 0) {
								local432 = this.anIntArray117[(local378 >> 12) * this.anInt3617 + (local802 >> 12)];
								local436 = Static77.anIntArray131[local388];
								local440 = local432 >>> 24;
								local444 = 256 - local440;
								Static77.anIntArray131[local388++] = ((local432 & 0xFF00FF) * local440 + (local436 & 0xFF00FF) * local444 & 0xFF00FF00) + ((local432 & 0xFF00) * local440 + (local436 & 0xFF00) * local444 & 0xFF0000) >>> 8;
								local802 += local342;
								local394++;
							}
						}
					...
					while (local384 < 0) {
						...
						local394 = local166;
						@Pc(969) int local969;
						if ((local969 = local802 - (this.anInt3617 << 12)) >= 0) {
						...
						if ((local1015 = local504 - (this.anInt3625 << 12)) >= 0) {
						...
						while (local394 < 0) {
							local432 = this.anIntArray117[(local504 >> 12) * this.anInt3617 + (local802 >> 12)];
							local436 = Static77.anIntArray131[local388];
							local440 = local432 >>> 24;
							local444 = 256 - local440;
							Static77.anIntArray131[local388++] = ((local432 & 0xFF00FF) * local440 + (local436 & 0xFF00FF) * local444 & 0xFF00FF00) + ((local432 & 0xFF00) * local440 + (local436 & 0xFF00) * local444 & 0xFF0000) >>> 8;
					...
					while (local384 < 0) {
						...
						if ((local1171 = local802 - (this.anInt3617 << 12)) >= 0) {
						...
						if ((local1253 = (local504 + 1 - (this.anInt3625 << 12) - local333) / local333) > local394) {
							local394 = local1253;
						}
						while (local394 < 0) {
							local432 = this.anIntArray117[(local504 >> 12) * this.anInt3617 + (local802 >> 12)];
				...
				while (local384 < 0) {
					...
					if (local378 >= 0 && local378 - (this.anInt3625 << 12) < 0) {
						...
						if ((local1412 = (local802 + 1 - (this.anInt3617 << 12) - local342) / local342) > local394) {
							local394 = local1412;
						}
						while (local394 < 0) {
							local432 = this.anIntArray117[(local378 >> 12) * this.anInt3617 + (local802 >> 12)];
				...
				while (local384 < 0) {
					...
					if ((local1564 = (local802 + 1 - (this.anInt3617 << 12) - local342) / local342) > local394) {
						local394 = local1564;
					}
					@Pc(1576) int local1576;
					if ((local1576 = local504 - (this.anInt3625 << 12)) >= 0) {
				...
				while (local384 < 0) {
					...
					if ((local1768 = (local802 + 1 - (this.anInt3617 << 12) - local342) / local342) > local394) {
						local394 = local1768;
					}
					if (local504 < 0) {
						local532 = (local333 - local504 - 1) / local333;
					...
					if ((local1816 = (local504 + 1 - (this.anInt3625 << 12) - local333) / local333) > local394) {
						local394 = local1816;
					}
					while (local394 < 0) {
						local432 = this.anIntArray117[(local504 >> 12) * this.anInt3617 + (local802 >> 12)];
			...
			while (local384 < 0) {
				...
				if (local368 >= 0 && local368 - (this.anInt3617 << 12) < 0) {
					@Pc(525) int local525;
					if ((local525 = local504 - (this.anInt3625 << 12)) >= 0) {
					...
					while (local394 < 0) {
						local432 = this.anIntArray117[(local504 >> 12) * this.anInt3617 + (local368 >> 12)];
						local436 = Static77.anIntArray131[local388];
						local440 = local432 >>> 24;
						local444 = 256 - local440;
						Static77.anIntArray131[local388++] = ((local432 & 0xFF00FF) * local440 + (local436 & 0xFF00FF) * local444 & 0xFF00FF00) + ((local432 & 0xFF00) * local440 + (local436 & 0xFF00) * local444 & 0xFF0000) >>> 8;
			...
			while (local384 < 0) {
				...
				if (local368 >= 0 && local368 - (this.anInt3617 << 12) < 0) {
					...
					@Pc(702) int local702;
					if ((local702 = (local504 + 1 - (this.anInt3625 << 12) - local333) / local333) > local394) {
						local394 = local702;
					}
					while (local394 < 0) {
						local432 = this.anIntArray117[(local504 >> 12) * this.anInt3617 + (local368 >> 12)];
