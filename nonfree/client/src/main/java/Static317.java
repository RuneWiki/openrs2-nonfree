...
public final class Static317 {
	...
	@OriginalMember(owner = "client!bd", name = "a", descriptor = "(II[B[IIIIIIIILclient!bd;II)I")
	public static int method243(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub4_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	public static int method246(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub4_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		...
		local65 = arg3 >> 1;
		arg10.anInt269 += arg10.anInt270 * local65;
		arg10.anInt275 = arg4;
		arg10.anInt272 = arg5;
		arg10.anInt277 = arg2;
		return local65;
	...
	@OriginalMember(owner = "client!bd", name = "a", descriptor = "([B[IIIIIIIILclient!bd;)I")
	public static int method249(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub4_Sub1 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt275 += arg8.anInt276 * (local22 - arg3);
		arg8.anInt272 += arg8.anInt265 * (local22 - arg3);
		local22 -= 3;
		@Pc(54) int local54;
		while (arg3 < local22) {
			local54 = arg3++;
		...
		arg8.anInt269 = arg4 >> 2;
		arg8.anInt277 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lclient!d;II)Lclient!bd;")
	public static Class1_Sub4_Sub1 method252(@OriginalArg(0) Class1_Sub7_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray5 == null || arg0.aByteArray5.length == 0 ? null : new Class1_Sub4_Sub1(arg0, (int) ((long) arg0.anInt808 * 256L * (long) 100 / (long) (Static152.anInt3130 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!bd", name = "a", descriptor = "([B[IIIIIIILclient!bd;)I")
	public static int method253(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub4_Sub1 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt277 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!bd", name = "a", descriptor = "(I[B[IIIIIIIILclient!bd;)I")
	public static int method257(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub4_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!bd", name = "b", descriptor = "(II[B[IIIIIIIILclient!bd;II)I")
	public static int method260(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub4_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt275 -= arg8.anInt276 * arg3;
		arg8.anInt272 -= arg8.anInt265 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!bd", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!bd;)I")
	public static int method261(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub4_Sub1 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt269 += arg10.anInt270 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(64) byte local64;
		...
		arg10.anInt275 = arg4 >> 2;
		arg10.anInt272 = arg5 >> 2;
		arg10.anInt277 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lclient!d;III)Lclient!bd;")
	public static Class1_Sub4_Sub1 method263(@OriginalArg(0) Class1_Sub7_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray5 == null || arg0.aByteArray5.length == 0 ? null : new Class1_Sub4_Sub1(arg0, arg1, arg2, arg3);
	}
	...
	@OriginalMember(owner = "client!bd", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!bd;II)I")
	public static int method266(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub4_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt269 -= arg10.anInt270 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!bd", name = "b", descriptor = "([B[IIIIIIILclient!bd;)I")
	public static int method268(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub4_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!bd", name = "a", descriptor = "(II[B[IIIIIIILclient!bd;II)I")
	public static int method270(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub4_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!bd", name = "c", descriptor = "(II[B[IIIIIIIILclient!bd;II)I")
	public static int method272(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub4_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt275 -= arg8.anInt276 * arg3;
		arg8.anInt272 -= arg8.anInt265 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!bd", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!bd;)I")
	public static int method274(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub4_Sub1 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt269 += arg10.anInt270 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!bd", name = "b", descriptor = "([B[IIIIIIIILclient!bd;)I")
	public static int method276(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub4_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt275 += arg8.anInt276 * (local24 - arg3);
		arg8.anInt272 += arg8.anInt265 * (local24 - arg3);
		local24 -= 3;
		@Pc(56) int local56;
		while (arg3 < local24) {
			local56 = arg3++;
	...
	@OriginalMember(owner = "client!bd", name = "b", descriptor = "(II[B[IIIIIIILclient!bd;II)I")
	public static int method277(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub4_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!bd", name = "b", descriptor = "(I[B[IIIIIIIILclient!bd;)I")
	public static int method279(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub4_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!bd", name = "d", descriptor = "(II[B[IIIIIIIILclient!bd;II)I")
	public static int method280(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub4_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
