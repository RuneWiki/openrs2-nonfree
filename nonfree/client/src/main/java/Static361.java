...
public final class Static361 {
	...
	@OriginalMember(owner = "client!gj", name = "a", descriptor = "([B[IIIIIIILclient!gj;)I")
	public static int method2092(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class5_Sub17_Sub1 arg7) {
		arg2 >>= 0x8;
	...
	@OriginalMember(owner = "client!gj", name = "a", descriptor = "(II[B[IIIIIIIILclient!gj;II)I")
	public static int method2096(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class5_Sub17_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!gj", name = "b", descriptor = "([B[IIIIIIILclient!gj;)I")
	public static int method2097(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class5_Sub17_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!gj", name = "a", descriptor = "([B[IIIIIIIILclient!gj;)I")
	public static int method2099(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class5_Sub17_Sub1 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt2280 += arg8.anInt2274 * (local24 - arg3);
		arg8.anInt2273 += arg8.anInt2284 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt2272 = arg4 >> 2;
		arg8.anInt2283 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!gj", name = "b", descriptor = "(II)I")
	public static int method2101(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!gj", name = "b", descriptor = "(II[B[IIIIIIIILclient!gj;II)I")
	public static int method2103(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class5_Sub17_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt2280 -= arg8.anInt2274 * arg3;
		arg8.anInt2273 -= arg8.anInt2284 * arg3;
		@Pc(32) int local32;
	...
	public static int method2104(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!gj", name = "a", descriptor = "(I[B[IIIIIIIILclient!gj;)I")
	public static int method2105(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class5_Sub17_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!gj", name = "b", descriptor = "(I[B[IIIIIIIILclient!gj;)I")
	public static int method2106(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class5_Sub17_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!gj", name = "c", descriptor = "(II[B[IIIIIIIILclient!gj;II)I")
	...
	@OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lclient!fp;III)Lclient!gj;")
	public static Class5_Sub17_Sub1 method2109(@OriginalArg(0) Class5_Sub15_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray19 == null || arg0.aByteArray19.length == 0 ? null : new Class5_Sub17_Sub1(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!gj", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!gj;II)I")
	public static int method2110(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class5_Sub17_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt2272 -= arg10.anInt2275 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt2272 += arg10.anInt2275 * local63;
		arg10.anInt2280 = arg4;
		arg10.anInt2273 = arg5;
		arg10.anInt2283 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!gj", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!gj;)I")
	public static int method2114(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class5_Sub17_Sub1 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt2272 += arg10.anInt2275 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt2280 = arg4 >> 2;
		arg10.anInt2273 = arg5 >> 2;
		arg10.anInt2283 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!gj", name = "a", descriptor = "(Lclient!fp;II)Lclient!gj;")
	public static Class5_Sub17_Sub1 method2115(@OriginalArg(0) Class5_Sub15_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray19 == null || arg0.aByteArray19.length == 0 ? null : new Class5_Sub17_Sub1(arg0, (int) ((long) arg0.anInt2152 * 256L * (long) 100 / (long) (Static344.anInt1063 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!gj", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!gj;)I")
	public static int method2118(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class5_Sub17_Sub1 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt2272 += arg10.anInt2275 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!gj", name = "a", descriptor = "(II[B[IIIIIIILclient!gj;II)I")
	public static int method2122(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class5_Sub17_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!gj", name = "b", descriptor = "(II[B[IIIIIIILclient!gj;II)I")
	public static int method2123(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class5_Sub17_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!gj", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!gj;II)I")
	public static int method2125(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class5_Sub17_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt2272 -= arg10.anInt2275 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!gj", name = "b", descriptor = "([B[IIIIIIIILclient!gj;)I")
	public static int method2127(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class5_Sub17_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt2280 += arg8.anInt2274 * (local22 - arg3);
		arg8.anInt2273 += arg8.anInt2284 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!gj", name = "d", descriptor = "(II[B[IIIIIIIILclient!gj;II)I")
