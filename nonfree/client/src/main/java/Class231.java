...
public final class Class231 {
	...
	public Class231() throws Exception {
	...
	private void method6219(@OriginalArg(0) int arg0, @OriginalArg(1) Frame arg1) {
	...
	private void enter(@OriginalArg(0) Frame arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (arg4 == 0) {
			...
			for (@Pc(37) int local37 = 0; local37 < local33.length; local37++) {
				if (arg1 == local33[local37].getWidth() && arg2 == local33[local37].getHeight() && arg3 == local33[local37].getBitDepth()) {
