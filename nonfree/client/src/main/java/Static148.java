...
public final class Static148 {
	...
	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lclient!wm;)V", line = 272)
	public static void method2925(@OriginalArg(0) Class19 arg0) {
		...
		for (@Pc(37) int local37 = 0; local37 <= 24; local37++) {
			...
			for (@Pc(54) int local54 = 1; local54 < 24; local54++) {
				...
				local8.method4666(local67, local83, -local75);
			}
			if (local37 > 0) {
				local61 = local37 * 23 + 2;
				local67 = local61 - 23;
				local8.method4660((short) 127, 0, (byte) 0, local67, (byte) 0, local61, (short) 0, (byte) 0);
				for (local75 = 1; local75 < 23; local75++) {
					local83 = local67 + 1;
					@Pc(130) int local130 = local61 + 1;
					local8.method4660((short) 127, local67, (byte) 0, local83, (byte) 0, local61, (short) 0, (byte) 0);
					local8.method4660((short) 127, local83, (byte) 0, local130, (byte) 0, local61, (short) 0, (byte) 0);
					local67 = local83;
					local61 = local130;
				}
				local8.method4660((short) 127, local61, (byte) 0, local67, (byte) 0, 1, (short) 0, (byte) 0);
			}
		}
		local8.anInt5077 = local8.anInt5065;
		local8.anIntArray357 = null;
		local8.anIntArray358 = null;
		local8.aByteArray61 = null;
		aClass31_4 = arg0.method2866(local8, 25600, 33, 64, 768);
	}

	@OriginalMember(owner = "client!ja", name = "b", descriptor = "(Lclient!wm;)V", line = 358)
	public static void method2927(@OriginalArg(0) Class19 arg0) {
		if (aClass13_9 != null) {
			return;
		}
		...
		aClass13_9 = arg0.method2886(local7, 128, 128, 128);
		aClass13_10 = arg0.method2886(local4, 128, 128, 128);
	}
}
