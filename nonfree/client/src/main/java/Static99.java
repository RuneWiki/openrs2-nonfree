...
public final class Static99 {
	...
	public static void method1671(@OriginalArg(1) GameShell arg0) {
		...
		if (Static8.anInt2382 >= 280 && Static8.anInt2382 <= 294 && Static55.anInt1118 >= 4 && Static55.anInt1118 <= 18) {
			Static73.method1208(0, 0);
			return;
		}
		if (Static8.anInt2382 >= 295 && Static8.anInt2382 <= 360 && Static55.anInt1118 >= 4 && Static55.anInt1118 <= 18) {
			Static73.method1208(1, 0);
			return;
		}
		if (Static8.anInt2382 >= 390 && Static8.anInt2382 <= 404 && Static55.anInt1118 >= 4 && Static55.anInt1118 <= 18) {
			Static73.method1208(0, 1);
			return;
		}
		if (Static8.anInt2382 >= 405 && Static8.anInt2382 <= 470 && Static55.anInt1118 >= 4 && Static55.anInt1118 <= 18) {
			Static73.method1208(1, 1);
			return;
		}
		if (Static8.anInt2382 >= 500 && Static8.anInt2382 <= 514 && Static55.anInt1118 >= 4 && Static55.anInt1118 <= 18) {
			Static73.method1208(0, 2);
			return;
		}
		if (Static8.anInt2382 >= 515 && Static8.anInt2382 <= 580 && Static55.anInt1118 >= 4 && Static55.anInt1118 <= 18) {
			Static73.method1208(1, 2);
			return;
		}
		if (Static8.anInt2382 >= 610 && Static8.anInt2382 <= 624 && Static55.anInt1118 >= 4 && Static55.anInt1118 <= 18) {
			Static73.method1208(0, 3);
			return;
		}
		if (Static8.anInt2382 >= 625 && Static8.anInt2382 <= 690 && Static55.anInt1118 >= 4 && Static55.anInt1118 <= 18) {
			Static73.method1208(1, 3);
			return;
		}
		if (Static8.anInt2382 >= 708 && Static55.anInt1118 >= 4 && Static8.anInt2382 <= 758 && Static55.anInt1118 <= 20) {
		...
		if (Static123.aBoolean277 == local267.aBoolean201) {
			...
			if (Static57.anInt1741 != 0) {
				...
				Static22.anInt2810 = 43594;
				Static57.anInt1741 = 0;
				Static11.anInt2984 = 443;
			}
			Static72.anInt1919 = local267.anInt2254;
			Static97.aBoolean228 = false;
			Static82.aClass4_Sub1_Sub2_Sub2_6.method808(0, 0);
			Static39.aClass4_Sub1_Sub2_Sub2_5.method808(382, 0);
			Static80.aClass4_Sub1_Sub2_Sub3_4.method853(382 - Static80.aClass4_Sub1_Sub2_Sub3_4.anInt1206 / 2, 18);
