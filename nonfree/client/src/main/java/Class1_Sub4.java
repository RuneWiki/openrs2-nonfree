...
public final class Class1_Sub4 extends Class1 {
	...
	@OriginalMember(owner = "client!cb", name = "a", descriptor = "([I)Lclient!ti;")
	public Class1_Sub9_Sub1 method493(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray9 == null) {
			this.anInt640 = 0;
			this.aFloatArray5 = new float[Static22.anInt649];
			this.aByteArray9 = new byte[this.anInt647];
			this.anInt648 = 0;
			this.anInt650 = 0;
		}
		while (this.anInt650 < this.aByteArrayArray1.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method496(this.anInt650);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt648;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt647 - local47) {
					local50 = this.anInt647 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt648;
				}
				this.anInt648 = local47;
			}
			this.anInt650++;
		}
		...
		return new Class1_Sub9_Sub1(this.anInt645, local129, this.anInt641, this.anInt639, this.aBoolean26);
	}

	@OriginalMember(owner = "client!cb", name = "a", descriptor = "([B)V")
	private void method494(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub7 local4 = new Class1_Sub7(arg0);
		this.anInt645 = local4.method2793();
		this.anInt647 = local4.method2793();
		this.anInt641 = local4.method2793();
		this.anInt639 = local4.method2793();
		if (this.anInt639 < 0) {
			this.anInt639 = ~this.anInt639;
			this.aBoolean26 = true;
		}
		@Pc(40) int local40 = local4.method2793();
		this.aByteArrayArray1 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method2771();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method2780(local49, local64);
			this.aByteArrayArray1[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!cb", name = "d", descriptor = "(I)[F")
	private float[] method496(@OriginalArg(0) int arg0) {
		Static22.method491(this.aByteArrayArray1[arg0]);
		Static22.method489();
		@Pc(15) int local15 = Static22.method492(Static54.method2991(Static22.anIntArray52.length - 1));
		@Pc(19) boolean local19 = Static22.aBooleanArray5[local15];
		@Pc(25) int local25 = local19 ? Static22.anInt649 : Static22.anInt642;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static22.method489() != 0;
			local29 = Static22.method489() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static22.anInt642 >> 2);
			local67 = (local25 >> 2) + (Static22.anInt642 >> 2);
			local71 = Static22.anInt642 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static22.anInt642 >> 2);
			local104 = local25 + (Static22.anInt642 >> 2) - (local25 >> 2);
			local108 = Static22.anInt642 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class67 local123 = Static22.aClass67Array1[Static22.anIntArray52[local15]];
		@Pc(126) int local126 = local123.anInt2771;
		@Pc(131) int local131 = local123.anIntArray221[local126];
		@Pc(140) boolean local140 = !Static22.aClass52Array1[local131].method1710();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt2772; local144++) {
			@Pc(152) Class20 local152 = Static22.aClass20Array1[local123.anIntArray220[local144]];
			local154 = Static22.aFloatArray1;
			local152.method617(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt2771;
			local176 = local123.anIntArray221[local171];
			Static22.aClass52Array1[local176].method1705(Static22.aFloatArray1, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static22.aFloatArray1[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static22.aFloatArray1;
			...
			@Pc(252) float[] local252 = local19 ? Static22.aFloatArray3 : Static22.aFloatArray2;
			@Pc(258) float[] local258 = local19 ? Static22.aFloatArray4 : Static22.aFloatArray6;
			@Pc(264) float[] local264 = local19 ? Static22.aFloatArray7 : Static22.aFloatArray8;
			@Pc(270) int[] local270 = local19 ? Static22.anIntArray53 : Static22.anIntArray51;
			...
			@Pc(486) int local486 = Static54.method2991(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static22.aFloatArray1[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static22.aFloatArray1[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt640 > 0) {
			local176 = this.anInt640 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean27) {
				for (local212 = 0; local212 < this.anInt644; local212++) {
					local1254 = (this.anInt640 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static22.aFloatArray1[local212];
				}
			}
		}
		local154 = this.aFloatArray5;
		this.aFloatArray5 = Static22.aFloatArray1;
		Static22.aFloatArray1 = local154;
		this.anInt640 = local25;
		this.anInt644 = local104 - (local25 >> 1);
		this.aBoolean27 = local140;
		return local1228;
	}
}
