...
public final class Static245 {
	...
	@OriginalMember(owner = "client!ri", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!ri;)I")
	public static int method3040(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub12_Sub4 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt3833 += arg10.anInt3834 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt3830 = arg4 >> 2;
		arg10.anInt3826 = arg5 >> 2;
		arg10.anInt3836 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!ri", name = "a", descriptor = "(I[B[IIIIIIIILclient!ri;)I")
	public static int method3042(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub12_Sub4 arg8) {
		arg2 >>= 0x8;
	...
	@OriginalMember(owner = "client!ri", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!ri;)I")
	public static int method3045(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub12_Sub4 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt3833 += arg10.anInt3834 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!ri", name = "a", descriptor = "([B[IIIIIIILclient!ri;)I")
	public static int method3047(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub12_Sub4 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt3836 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ri", name = "a", descriptor = "([B[IIIIIIIILclient!ri;)I")
	public static int method3048(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub12_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt3830 += arg8.anInt3832 * (local22 - arg3);
		arg8.anInt3826 += arg8.anInt3828 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt3833 = arg4 >> 2;
		arg8.anInt3836 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ri", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!ri;II)I")
	public static int method3050(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub12_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt3833 -= arg10.anInt3834 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt3833 += arg10.anInt3834 * local63;
		arg10.anInt3830 = arg4;
		arg10.anInt3826 = arg5;
		arg10.anInt3836 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!ri", name = "b", descriptor = "(II)I")
	public static int method3052(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ri", name = "b", descriptor = "([B[IIIIIIILclient!ri;)I")
	public static int method3053(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub12_Sub4 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lclient!qa;III)Lclient!ri;")
	public static Class1_Sub12_Sub4 method3056(@OriginalArg(0) Class1_Sub15_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray49 == null || arg0.aByteArray49.length == 0 ? null : new Class1_Sub12_Sub4(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!ri", name = "c", descriptor = "(II)I")
	public static int method3057(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ri", name = "b", descriptor = "(I[B[IIIIIIIILclient!ri;)I")
	public static int method3060(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub12_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!ri", name = "a", descriptor = "(II[B[IIIIIIILclient!ri;II)I")
	public static int method3061(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub12_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lclient!qa;II)Lclient!ri;")
	public static Class1_Sub12_Sub4 method3066(@OriginalArg(0) Class1_Sub15_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray49 == null || arg0.aByteArray49.length == 0 ? null : new Class1_Sub12_Sub4(arg0, (int) ((long) arg0.anInt3458 * 256L * (long) 100 / (long) (Static50.anInt1044 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!ri", name = "b", descriptor = "([B[IIIIIIIILclient!ri;)I")
	public static int method3069(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub12_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt3830 += arg8.anInt3832 * (local24 - arg3);
		arg8.anInt3826 += arg8.anInt3828 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!ri", name = "b", descriptor = "(II[B[IIIIIIILclient!ri;II)I")
	public static int method3070(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub12_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ri", name = "b", descriptor = "(II[B[IIIIIIIILclient!ri;II)I")
	public static int method3074(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub12_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ri", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!ri;II)I")
	public static int method3075(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub12_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt3833 -= arg10.anInt3834 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!ri", name = "c", descriptor = "(II[B[IIIIIIIILclient!ri;II)I")
	public static int method3076(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub12_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ri", name = "d", descriptor = "(II[B[IIIIIIIILclient!ri;II)I")
	public static int method3077(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub12_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt3830 -= arg8.anInt3832 * arg3;
		arg8.anInt3826 -= arg8.anInt3828 * arg3;
		@Pc(32) int local32;
