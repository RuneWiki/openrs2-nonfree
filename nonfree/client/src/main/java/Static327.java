...
public final class Static327 {
	...
	@OriginalMember(owner = "client!uk", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!uk;)I")
	public static int method4346(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub10_Sub4 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt5723 += arg10.anInt5721 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt5718 = arg4 >> 2;
		arg10.anInt5731 = arg5 >> 2;
		arg10.anInt5724 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!uk", name = "a", descriptor = "(II[B[IIIIIIIILclient!uk;II)I")
	public static int method4347(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub10_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	public static int method4349(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!uk", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!uk;II)I")
	public static int method4352(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub10_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt5723 -= arg10.anInt5721 * arg3;
		@Pc(23) int local23;
		...
		local65 = arg3 >> 1;
		arg10.anInt5723 += arg10.anInt5721 * local65;
		arg10.anInt5718 = arg4;
		arg10.anInt5731 = arg5;
		arg10.anInt5724 = arg2;
		return local65;
	}

	@OriginalMember(owner = "client!uk", name = "a", descriptor = "([B[IIIIIIILclient!uk;)I")
	public static int method4355(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub10_Sub4 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt5724 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!uk", name = "a", descriptor = "(I[B[IIIIIIIILclient!uk;)I")
	public static int method4356(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub10_Sub4 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt5724 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!uk", name = "b", descriptor = "(II[B[IIIIIIIILclient!uk;II)I")
	public static int method4358(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub10_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt5718 -= arg8.anInt5720 * arg3;
		arg8.anInt5731 -= arg8.anInt5726 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!uk", name = "a", descriptor = "([B[IIIIIIIILclient!uk;)I")
	public static int method4360(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub10_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt5718 += arg8.anInt5720 * (local24 - arg3);
		arg8.anInt5731 += arg8.anInt5726 * (local24 - arg3);
		local24 -= 3;
		@Pc(56) int local56;
		while (arg3 < local24) {
			local56 = arg3++;
		...
		arg8.anInt5723 = arg4 >> 2;
		arg8.anInt5724 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!uk", name = "c", descriptor = "(II[B[IIIIIIIILclient!uk;II)I")
	public static int method4363(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub10_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt5718 -= arg8.anInt5720 * arg3;
		arg8.anInt5731 -= arg8.anInt5726 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!uk", name = "d", descriptor = "(II[B[IIIIIIIILclient!uk;II)I")
	public static int method4365(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub10_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!uk", name = "a", descriptor = "(II[B[IIIIIIILclient!uk;II)I")
	public static int method4366(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub10_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!uk", name = "b", descriptor = "(I[B[IIIIIIIILclient!uk;)I")
	public static int method4368(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub10_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!uk", name = "b", descriptor = "([B[IIIIIIILclient!uk;)I")
	public static int method4371(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub10_Sub4 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!uk", name = "b", descriptor = "([B[IIIIIIIILclient!uk;)I")
	public static int method4373(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub10_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt5718 += arg8.anInt5720 * (local22 - arg3);
		arg8.anInt5731 += arg8.anInt5726 * (local22 - arg3);
		local22 -= 3;
		@Pc(54) int local54;
		while (arg3 < local22) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lclient!h;III)Lclient!uk;")
	public static Class1_Sub10_Sub4 method4374(@OriginalArg(0) Class1_Sub11_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray51 == null || arg0.aByteArray51.length == 0 ? null : new Class1_Sub10_Sub4(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lclient!h;II)Lclient!uk;")
	public static Class1_Sub10_Sub4 method4375(@OriginalArg(0) Class1_Sub11_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray51 == null || arg0.aByteArray51.length == 0 ? null : new Class1_Sub10_Sub4(arg0, (int) ((long) arg0.anInt2189 * 256L * (long) 100 / (long) (Static230.anInt3026 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!uk", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!uk;)I")
	public static int method4376(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub10_Sub4 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt5723 += arg10.anInt5721 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(64) byte local64;
	...
	@OriginalMember(owner = "client!uk", name = "d", descriptor = "(II)I")
	public static int method4377(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!uk", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!uk;II)I")
	public static int method4379(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub10_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt5723 -= arg10.anInt5721 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!uk", name = "b", descriptor = "(II[B[IIIIIIILclient!uk;II)I")
	public static int method4383(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub10_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
