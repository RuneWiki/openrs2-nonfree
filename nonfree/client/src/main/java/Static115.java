...
public final class Static115 {
	...
	@OriginalMember(owner = "client!uc", name = "a", descriptor = "(II[B[IIIIIIILclient!uc;II)I")
	public static int method1673(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub8_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!uc", name = "a", descriptor = "([B[IIIIIIIIILclient!uc;)I")
	public static int method1676(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class2_Sub8_Sub2 arg9) {
		arg2 >>= 0x8;
		...
		arg9.anInt2665 = arg4 >> 8;
		arg9.anInt2666 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!uc", name = "a", descriptor = "(II[B[IIIIIIIIILclient!uc;II)I")
	public static int method1677(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) Class2_Sub8_Sub2 arg9, @OriginalArg(13) int arg10, @OriginalArg(14) int arg11) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!uc", name = "a", descriptor = "(Lclient!ga;II)Lclient!uc;")
	public static Class2_Sub8_Sub2 method1678(@OriginalArg(0) Class2_Sub9_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray12 == null || arg0.aByteArray12.length == 0 ? null : new Class2_Sub8_Sub2(arg0, (int) ((long) arg0.anInt1216 * 256L * (long) 100 / (long) (Static27.anInt1162 * 100)), arg1);
	}

	@OriginalMember(owner = "client!uc", name = "a", descriptor = "([B[IIIIIIILclient!uc;)I")
	public static int method1679(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub8_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt2666 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!uc", name = "b", descriptor = "([B[IIIIIIIIILclient!uc;)I")
	public static int method1680(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class2_Sub8_Sub2 arg9) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg8 >> 8;
		arg4 <<= 0x8;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!uc", name = "b", descriptor = "([B[IIIIIIILclient!uc;)I")
	public static int method1682(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub8_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 8;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!uc", name = "b", descriptor = "(II[B[IIIIIIIIILclient!uc;II)I")
	public static int method1683(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) Class2_Sub8_Sub2 arg9, @OriginalArg(13) int arg10, @OriginalArg(14) int arg11) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!uc", name = "b", descriptor = "(II[B[IIIIIIILclient!uc;II)I")
	public static int method1684(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub8_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
