...
public final class Static102 {
	...
	public static long[] aLongArray44;
	...
	@OriginalMember(owner = "client!hi", name = "o", descriptor = "Lclient!sb;")
	public static Class1_Sub14 aClass1_Sub14_3 = new Class1_Sub14(10000);

	@OriginalMember(owner = "client!hi", name = "eb", descriptor = "Lclient!hi;")
	public static Class22_Sub4_Sub1 aClass22_Sub4_Sub1_1 = new Class22_Sub4_Sub1();

	@OriginalMember(owner = "client!hi", name = "fb", descriptor = "Lclient!hi;")
	public static Class22_Sub4_Sub1 aClass22_Sub4_Sub1_2 = new Class22_Sub4_Sub1();

	@OriginalMember(owner = "client!hi", name = "gb", descriptor = "Lclient!hi;")
	public static Class22_Sub4_Sub1 aClass22_Sub4_Sub1_3 = new Class22_Sub4_Sub1();

	@OriginalMember(owner = "client!hi", name = "hb", descriptor = "Lclient!hi;")
	public static Class22_Sub4_Sub1 aClass22_Sub4_Sub1_4 = new Class22_Sub4_Sub1();

	@OriginalMember(owner = "client!hi", name = "ib", descriptor = "Lclient!hi;")
	public static Class22_Sub4_Sub1 aClass22_Sub4_Sub1_5 = new Class22_Sub4_Sub1();

	@OriginalMember(owner = "client!hi", name = "jb", descriptor = "Lclient!hi;")
	public static Class22_Sub4_Sub1 aClass22_Sub4_Sub1_6 = new Class22_Sub4_Sub1();
	...
	public static int[] anIntArray176 = new int[1];

	@OriginalMember(owner = "client!hi", name = "ub", descriptor = "[I")
	public static int[] anIntArray177 = new int[1];

	@OriginalMember(owner = "client!hi", name = "a", descriptor = "([FI)[F")
	public static float[] method1572(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) float[] local2 = new float[arg1];
		Static319.method515(arg0, 0, local2, 0, arg1);
		return local2;
	}

	@OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIIIII[FIF)V")
	public static void method1573(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) int arg7, @OriginalArg(8) float arg8) {
	...
	@OriginalMember(owner = "client!hi", name = "o", descriptor = "()V")
	public static void method1574() {
		aClass22_Sub4_Sub1_1 = new Class22_Sub4_Sub1();
		aClass22_Sub4_Sub1_2 = new Class22_Sub4_Sub1();
		aClass22_Sub4_Sub1_3 = new Class22_Sub4_Sub1();
		aClass22_Sub4_Sub1_4 = new Class22_Sub4_Sub1();
		aClass22_Sub4_Sub1_5 = new Class22_Sub4_Sub1();
		aClass22_Sub4_Sub1_6 = new Class22_Sub4_Sub1();
	}

	@OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIIIIII[FIFFF)V")
	public static void method1578(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) float[] arg7, @OriginalArg(8) int arg8, @OriginalArg(9) float arg9, @OriginalArg(10) float arg10, @OriginalArg(11) float arg11) {
		@Pc(3) int local3 = arg0 - arg3;
		@Pc(7) int local7 = arg1 - arg4;
		@Pc(11) int local11 = arg2 - arg5;
	...
	@OriginalMember(owner = "client!hi", name = "a", descriptor = "([SI)[S")
	public static short[] method1584(@OriginalArg(0) short[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) short[] local2 = new short[arg1];
		Static319.method510(arg0, 0, local2, 0, arg1);
		return local2;
	}

	@OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIIIFFF)[F")
	public static float[] method1591(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6) {
	...
	@OriginalMember(owner = "client!hi", name = "a", descriptor = "(ISIB)I")
	public static int method1595(@OriginalArg(0) int arg0, @OriginalArg(1) short arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		@Pc(5) int local5 = Static18.anIntArray26[Static227.method3595(arg0, arg2)];
		if (arg1 != -1) {
			@Pc(15) int local15 = Static18.anInterface1_1.method1631(arg1 & 0xFFFF);
			@Pc(21) int local21;
			@Pc(44) int local44;
			if (local15 != 0) {
				if (arg2 < 0) {
			...
			local21 = Static18.anInterface1_1.method1635(arg1 & 0xFFFF);
			if (local21 != 0) {
				local21 += 256;
	...
	@OriginalMember(owner = "client!hi", name = "a", descriptor = "(FFF)I")
	public static int method1601(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
	...
	@OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIIIII[FFIF)V")
	public static void method1603(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) float arg7, @OriginalArg(8) int arg8, @OriginalArg(9) float arg9) {
		@Pc(3) int local3 = arg0 - arg3;
		@Pc(7) int local7 = arg1 - arg4;
		@Pc(11) int local11 = arg2 - arg5;
		@Pc(32) float local32 = (float) local3 * arg6[0] + (float) local7 * arg6[1] + (float) local11 * arg6[2];
