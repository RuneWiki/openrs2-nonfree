...
public final class Class2_Sub18 extends Class2 {
	...
	public Class2_Sub18(@OriginalArg(0) byte[] arg0) {
		this.method1943(arg0);
	}

	@OriginalMember(owner = "client!pb", name = "b", descriptor = "(I)[F")
	private float[] method1940(@OriginalArg(0) int arg0) {
		Static125.method1945(this.aByteArrayArray6[arg0]);
		Static125.method1942();
		@Pc(15) int local15 = Static125.method1948(Static46.method858(Static125.anIntArray252.length - 1));
		@Pc(19) boolean local19 = Static125.aBooleanArray10[local15];
		@Pc(25) int local25 = local19 ? Static125.anInt2900 : Static125.anInt2902;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static125.method1942() != 0;
			local29 = Static125.method1942() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static125.anInt2902 >> 2);
			local67 = (local25 >> 2) + (Static125.anInt2902 >> 2);
			local71 = Static125.anInt2902 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static125.anInt2902 >> 2);
			local104 = local25 + (Static125.anInt2902 >> 2) - (local25 >> 2);
			local108 = Static125.anInt2902 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class12 local123 = Static125.aClass12Array1[Static125.anIntArray252[local15]];
		@Pc(126) int local126 = local123.anInt469;
		@Pc(131) int local131 = local123.anIntArray27[local126];
		@Pc(140) boolean local140 = !Static125.aClass23Array1[local131].method852();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt468; local144++) {
			@Pc(152) Class72 local152 = Static125.aClass72Array1[local123.anIntArray26[local144]];
			local154 = Static125.aFloatArray4;
			local152.method2163(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt469;
			local176 = local123.anIntArray27[local171];
			Static125.aClass23Array1[local176].method849(Static125.aFloatArray4, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static125.aFloatArray4[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static125.aFloatArray4;
			...
			@Pc(252) float[] local252 = local19 ? Static125.aFloatArray8 : Static125.aFloatArray6;
			@Pc(258) float[] local258 = local19 ? Static125.aFloatArray7 : Static125.aFloatArray3;
			@Pc(264) float[] local264 = local19 ? Static125.aFloatArray2 : Static125.aFloatArray5;
			@Pc(270) int[] local270 = local19 ? Static125.anIntArray253 : Static125.anIntArray254;
			...
			@Pc(486) int local486 = Static46.method858(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static125.aFloatArray4[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static125.aFloatArray4[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt2901 > 0) {
			local176 = this.anInt2901 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean121) {
				for (local212 = 0; local212 < this.anInt2904; local212++) {
					local1254 = (this.anInt2901 >> 1) + local212;
					local1228[local212] += this.aFloatArray9[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static125.aFloatArray4[local212];
				}
			}
		}
		local154 = this.aFloatArray9;
		this.aFloatArray9 = Static125.aFloatArray4;
		Static125.aFloatArray4 = local154;
		this.anInt2901 = local25;
		this.anInt2904 = local104 - (local25 >> 1);
		this.aBoolean121 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!pb", name = "b", descriptor = "([B)V")
	private void method1943(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub13 local4 = new Class2_Sub13(arg0);
		this.anInt2907 = local4.method1396();
		this.anInt2908 = local4.method1396();
		this.anInt2905 = local4.method1396();
		this.anInt2906 = local4.method1396();
		if (this.anInt2906 < 0) {
			this.anInt2906 = ~this.anInt2906;
			this.aBoolean119 = true;
		}
		@Pc(40) int local40 = local4.method1396();
		this.aByteArrayArray6 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method1402();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method1411(local49, local64);
			this.aByteArrayArray6[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!pb", name = "a", descriptor = "([I)Lclient!qe;")
	public Class2_Sub19_Sub1 method1946(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray31 == null) {
			this.anInt2901 = 0;
			this.aFloatArray9 = new float[Static125.anInt2900];
			this.aByteArray31 = new byte[this.anInt2908];
			this.anInt2911 = 0;
			this.anInt2910 = 0;
		}
		while (this.anInt2910 < this.aByteArrayArray6.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1940(this.anInt2910);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2911;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt2908 - local47) {
					local50 = this.anInt2908 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray31[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2911;
				}
				this.anInt2911 = local47;
			}
			this.anInt2910++;
		}
		this.aFloatArray9 = null;
		@Pc(129) byte[] local129 = this.aByteArray31;
		this.aByteArray31 = null;
		return new Class2_Sub19_Sub1(this.anInt2907, local129, this.anInt2905, this.anInt2906, this.aBoolean119);
	}
}
