...
public final class Class1_Sub15 extends Class1 {
	...
	@OriginalMember(owner = "client!oc", name = "a", descriptor = "([I)Lclient!gf;")
	public Class1_Sub9_Sub1 method2067(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray29 == null) {
			this.anInt3055 = 0;
			this.aFloatArray3 = new float[Static117.anInt3056];
			this.aByteArray29 = new byte[this.anInt3051];
			this.anInt3061 = 0;
			this.anInt3060 = 0;
		}
		while (this.anInt3060 < this.aByteArrayArray8.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method2073(this.anInt3060);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt3061;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt3051 - local47) {
					local50 = this.anInt3051 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt3061;
				}
				this.anInt3061 = local47;
			}
			this.anInt3060++;
		}
		...
		return new Class1_Sub9_Sub1(this.anInt3057, local129, this.anInt3053, this.anInt3050, this.aBoolean159);
	}

	@OriginalMember(owner = "client!oc", name = "f", descriptor = "(I)[F")
	private float[] method2073(@OriginalArg(0) int arg0) {
		Static117.method2070(this.aByteArrayArray8[arg0]);
		Static117.method2074();
		@Pc(15) int local15 = Static117.method2068(Static81.method881(Static117.anIntArray407.length - 1));
		@Pc(19) boolean local19 = Static117.aBooleanArray17[local15];
		@Pc(25) int local25 = local19 ? Static117.anInt3056 : Static117.anInt3058;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static117.method2074() != 0;
			local29 = Static117.method2074() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static117.anInt3058 >> 2);
			local67 = (local25 >> 2) + (Static117.anInt3058 >> 2);
			local71 = Static117.anInt3058 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static117.anInt3058 >> 2);
			local104 = local25 + (Static117.anInt3058 >> 2) - (local25 >> 2);
			local108 = Static117.anInt3058 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class81 local123 = Static117.aClass81Array1[Static117.anIntArray407[local15]];
		@Pc(126) int local126 = local123.anInt3881;
		@Pc(131) int local131 = local123.anIntArray531[local126];
		@Pc(140) boolean local140 = !Static117.aClass86Array1[local131].method2982();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt3880; local144++) {
			@Pc(152) Class39 local152 = Static117.aClass39Array1[local123.anIntArray530[local144]];
			local154 = Static117.aFloatArray1;
			local152.method1139(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt3881;
			local176 = local123.anIntArray531[local171];
			Static117.aClass86Array1[local176].method2981(Static117.aFloatArray1, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static117.aFloatArray1[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static117.aFloatArray1;
			...
			@Pc(252) float[] local252 = local19 ? Static117.aFloatArray4 : Static117.aFloatArray8;
			@Pc(258) float[] local258 = local19 ? Static117.aFloatArray2 : Static117.aFloatArray6;
			@Pc(264) float[] local264 = local19 ? Static117.aFloatArray7 : Static117.aFloatArray5;
			@Pc(270) int[] local270 = local19 ? Static117.anIntArray408 : Static117.anIntArray409;
			...
			@Pc(486) int local486 = Static81.method881(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static117.aFloatArray1[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static117.aFloatArray1[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt3055 > 0) {
			local176 = this.anInt3055 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean157) {
				for (local212 = 0; local212 < this.anInt3052; local212++) {
					local1254 = (this.anInt3055 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static117.aFloatArray1[local212];
				}
			}
		}
		local154 = this.aFloatArray3;
		this.aFloatArray3 = Static117.aFloatArray1;
		Static117.aFloatArray1 = local154;
		this.anInt3055 = local25;
		this.anInt3052 = local104 - (local25 >> 1);
		this.aBoolean157 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!oc", name = "b", descriptor = "([B)V")
	private void method2076(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub8 local4 = new Class1_Sub8(arg0);
		this.anInt3057 = local4.method868();
		this.anInt3051 = local4.method868();
		this.anInt3053 = local4.method868();
		this.anInt3050 = local4.method868();
		if (this.anInt3050 < 0) {
			this.anInt3050 = ~this.anInt3050;
			this.aBoolean159 = true;
		}
		@Pc(40) int local40 = local4.method868();
		this.aByteArrayArray8 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method861();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method857(local49, local64);
