...
public final class Class1_Sub15 extends Class1 {
	...
	@OriginalMember(owner = "client!gq", name = "a", descriptor = "([I)Lclient!nv;")
	public Class1_Sub32_Sub1 method1938(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray35 == null) {
			this.anInt2326 = 0;
			this.aFloatArray10 = new float[Static137.anInt2328];
			this.aByteArray35 = new byte[this.anInt2332];
			this.anInt2333 = 0;
			this.anInt2334 = 0;
		}
		while (this.anInt2334 < this.aByteArrayArray48.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1945(this.anInt2334);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2333;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt2332 - local47) {
					local50 = this.anInt2332 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray35[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2333;
				}
				this.anInt2333 = local47;
			}
			this.anInt2334++;
		}
		this.aFloatArray10 = null;
		@Pc(129) byte[] local129 = this.aByteArray35;
		this.aByteArray35 = null;
		return new Class1_Sub32_Sub1(this.anInt2325, local129, this.anInt2331, this.anInt2324, this.aBoolean127);
	}

	@OriginalMember(owner = "client!gq", name = "a", descriptor = "([B)V")
	private void method1940(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub1 local4 = new Class1_Sub1(arg0);
		this.anInt2325 = local4.method4087();
		this.anInt2332 = local4.method4087();
		this.anInt2331 = local4.method4087();
		this.anInt2324 = local4.method4087();
		if (this.anInt2324 < 0) {
			this.anInt2324 = ~this.anInt2324;
			this.aBoolean127 = true;
		}
		@Pc(40) int local40 = local4.method4087();
		this.aByteArrayArray48 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method4130();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method4102(local64, local49);
			this.aByteArrayArray48[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!gq", name = "e", descriptor = "(I)[F")
	private float[] method1945(@OriginalArg(0) int arg0) {
		Static137.method1946(this.aByteArrayArray48[arg0]);
		Static137.method1937();
		@Pc(15) int local15 = Static137.method1944(Static159.method2403(Static137.anIntArray219.length - 1));
		@Pc(19) boolean local19 = Static137.aBooleanArray8[local15];
		@Pc(25) int local25 = local19 ? Static137.anInt2328 : Static137.anInt2323;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static137.method1937() != 0;
			local29 = Static137.method1937() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static137.anInt2323 >> 2);
			local67 = (local25 >> 2) + (Static137.anInt2323 >> 2);
			local71 = Static137.anInt2323 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static137.anInt2323 >> 2);
			local104 = local25 + (Static137.anInt2323 >> 2) - (local25 >> 2);
			local108 = Static137.anInt2323 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class230 local123 = Static137.aClass230Array1[Static137.anIntArray219[local15]];
		@Pc(126) int local126 = local123.anInt6827;
		@Pc(131) int local131 = local123.anIntArray566[local126];
		@Pc(140) boolean local140 = !Static137.aClass253Array1[local131].method5717();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt6826; local144++) {
			@Pc(152) Class165 local152 = Static137.aClass165Array1[local123.anIntArray567[local144]];
			local154 = Static137.aFloatArray11;
			local152.method3866(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt6827;
			local176 = local123.anIntArray566[local171];
			Static137.aClass253Array1[local176].method5713(Static137.aFloatArray11, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static137.aFloatArray11[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static137.aFloatArray11;
			...
			@Pc(252) float[] local252 = local19 ? Static137.aFloatArray15 : Static137.aFloatArray8;
			@Pc(258) float[] local258 = local19 ? Static137.aFloatArray12 : Static137.aFloatArray13;
			@Pc(264) float[] local264 = local19 ? Static137.aFloatArray9 : Static137.aFloatArray14;
			@Pc(270) int[] local270 = local19 ? Static137.anIntArray217 : Static137.anIntArray218;
			...
			@Pc(486) int local486 = Static159.method2403(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static137.aFloatArray11[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static137.aFloatArray11[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt2326 > 0) {
			local176 = this.anInt2326 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean126) {
				for (local212 = 0; local212 < this.anInt2329; local212++) {
					local1254 = (this.anInt2326 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static137.aFloatArray11[local212];
				}
			}
		}
		local154 = this.aFloatArray10;
		this.aFloatArray10 = Static137.aFloatArray11;
		Static137.aFloatArray11 = local154;
		this.anInt2326 = local25;
		this.anInt2329 = local104 - (local25 >> 1);
		this.aBoolean126 = local140;
		return local1228;
	}
}
