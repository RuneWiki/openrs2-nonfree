...
public final class Static183 {
	...
	@OriginalMember(owner = "client!ef", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!ef;)I")
	public static int method714(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub9_Sub1 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt954 += arg10.anInt946 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt943 = arg4 >> 2;
		arg10.anInt942 = arg5 >> 2;
		arg10.anInt953 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lclient!bb;III)Lclient!ef;")
	public static Class3_Sub9_Sub1 method715(@OriginalArg(0) Class3_Sub4_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray2 == null || arg0.aByteArray2.length == 0 ? null : new Class3_Sub9_Sub1(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!ef", name = "a", descriptor = "([B[IIIIIIILclient!ef;)I")
	public static int method719(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub9_Sub1 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt953 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ef", name = "a", descriptor = "([B[IIIIIIIILclient!ef;)I")
	public static int method720(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub9_Sub1 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt943 += arg8.anInt948 * (local24 - arg3);
		arg8.anInt942 += arg8.anInt947 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt954 = arg4 >> 2;
		arg8.anInt953 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ef", name = "a", descriptor = "(II[B[IIIIIIIILclient!ef;II)I")
	public static int method722(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub9_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	public static int method723(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ef", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!ef;II)I")
	public static int method725(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub9_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt954 -= arg10.anInt946 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt954 += arg10.anInt946 * local63;
		arg10.anInt943 = arg4;
		arg10.anInt942 = arg5;
		arg10.anInt953 = arg2;
		return local63;
	...
	@OriginalMember(owner = "client!ef", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!ef;II)I")
	public static int method726(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub9_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt954 -= arg10.anInt946 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!ef", name = "a", descriptor = "(I[B[IIIIIIIILclient!ef;)I")
	public static int method731(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub9_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!ef", name = "a", descriptor = "(II[B[IIIIIIILclient!ef;II)I")
	public static int method732(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub9_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ef", name = "b", descriptor = "(II[B[IIIIIIILclient!ef;II)I")
	public static int method737(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub9_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ef", name = "b", descriptor = "([B[IIIIIIILclient!ef;)I")
	public static int method739(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub9_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lclient!bb;II)Lclient!ef;")
	public static Class3_Sub9_Sub1 method740(@OriginalArg(0) Class3_Sub4_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray2 == null || arg0.aByteArray2.length == 0 ? null : new Class3_Sub9_Sub1(arg0, (int) ((long) arg0.anInt308 * 256L * (long) 100 / (long) (Static143.anInt3288 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!ef", name = "c", descriptor = "(II)I")
	public static int method742(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ef", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!ef;)I")
	public static int method744(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub9_Sub1 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt954 += arg10.anInt946 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!ef", name = "b", descriptor = "(I[B[IIIIIIIILclient!ef;)I")
	public static int method746(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub9_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!ef", name = "b", descriptor = "(II[B[IIIIIIIILclient!ef;II)I")
	public static int method749(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub9_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ef", name = "b", descriptor = "([B[IIIIIIIILclient!ef;)I")
	public static int method751(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub9_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt943 += arg8.anInt948 * (local22 - arg3);
		arg8.anInt942 += arg8.anInt947 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!ef", name = "c", descriptor = "(II[B[IIIIIIIILclient!ef;II)I")
	public static int method752(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub9_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt943 -= arg8.anInt948 * arg3;
		arg8.anInt942 -= arg8.anInt947 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ef", name = "d", descriptor = "(II[B[IIIIIIIILclient!ef;II)I")
	public static int method753(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub9_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt943 -= arg8.anInt948 * arg3;
		arg8.anInt942 -= arg8.anInt947 * arg3;
		@Pc(32) int local32;
