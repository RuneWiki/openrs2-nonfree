...
public final class Class21_Sub19 extends Class21 {
	...
	@OriginalMember(owner = "client!naa", name = "<init>", descriptor = "(ILclient!eha;)V")
	public Class21_Sub19(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub22 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!naa", name = "<init>", descriptor = "(Lclient!eha;)V")
	public Class21_Sub19(@OriginalArg(0) Class3_Sub22 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!naa", name = "e", descriptor = "(B)Z")
	...
	public void method9235() {
		if (super.aClass3_Sub22_34.aClass21_Sub28_2.method8618() && !Static168.method2721(-19015 - 3, super.aClass3_Sub22_34.aClass21_Sub28_2.method8620())) {
			super.anInt10876 = 0;
		}
