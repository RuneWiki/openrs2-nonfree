...
public final class Class1_Sub3_Sub2_Sub3 extends Class1_Sub3_Sub2 {
	...
	public void method346() {
		try {
			...
			signlink.reporterror("52279, " + 0 + ", " + local87.toString());
			throw new RuntimeException();
		}
	}
	...
	public void method347() {
		try {
			...
			signlink.reporterror("54445, " + -725 + ", " + local62.toString());
			throw new RuntimeException();
		}
	}
	...
	public void method348() {
		try {
			...
			signlink.reporterror("43769, " + -74 + ", " + local67.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIIZ)V")
	public void method349(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		try {
			...
			signlink.reporterror("93096, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + true + ", " + local105.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIZ)V")
	public void method350(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			arg1 += this.anInt515;
			arg0 += this.anInt516;
			@Pc(15) int local15 = arg1 + arg0 * Class1_Sub3_Sub2.anInt528;
			@Pc(17) int local17 = 0;
			...
			if (arg0 < Class1_Sub3_Sub2.anInt530) {
				local36 = Class1_Sub3_Sub2.anInt530 - arg0;
				local20 -= local36;
				arg0 = Class1_Sub3_Sub2.anInt530;
				local17 = local36 * local23 + 0;
				local15 += local36 * Class1_Sub3_Sub2.anInt528;
			}
			if (arg0 + local20 > Class1_Sub3_Sub2.anInt531) {
				local20 -= arg0 + local20 - Class1_Sub3_Sub2.anInt531;
			}
			if (arg1 < Class1_Sub3_Sub2.anInt532) {
				local36 = Class1_Sub3_Sub2.anInt532 - arg1;
				local23 -= local36;
			...
			if (arg1 + local23 > Class1_Sub3_Sub2.anInt533) {
				local36 = arg1 + local23 - Class1_Sub3_Sub2.anInt533;
				local23 -= local36;
				local29 += local36;
				local27 += local36;
			}
			if (local23 > 0 && local20 > 0) {
				this.method351(Class1_Sub3_Sub2.anIntArray178, local17, local29, this.aByteArray6, local20, local23, local15, local27, this.anIntArray177);
			}
		} catch (@Pc(142) RuntimeException local142) {
			signlink.reporterror("95229, " + arg0 + ", " + arg1 + ", " + false + ", " + local142.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!ib", name = "a", descriptor = "([III[BIIIII[I)V")
	private void method351(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte[] arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int[] arg8) {
		try {
			...
			signlink.reporterror("24366, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + arg4 + ", " + 0 + ", " + arg5 + ", " + arg6 + ", " + arg7 + ", " + arg8 + ", " + local141.toString());
			throw new RuntimeException();
		}
	}
}
