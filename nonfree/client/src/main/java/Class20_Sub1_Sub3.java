...
public final class Class20_Sub1_Sub3 extends Class20_Sub1 {
	...
	@OriginalMember(owner = "client!pea", name = "<init>", descriptor = "(Lclient!pm;[B[III)V")
	public Class20_Sub1_Sub3(@OriginalArg(0) Class137_Sub2 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		super(arg0, arg3, arg4);
		this.aByteArray91 = arg1;
		this.anIntArray597 = arg2;
	}
			...
			if (arg6 != 0) {
				...
				if (arg6 == 1) {
					if (arg4 == 1) {
						...
						for (local262 = -arg3; local262 < 0; local262++) {
							...
							for (local273 = -arg2; local273 < 0; local273++) {
								...
								if (local446 == 0) {
									...
									local252[local64++] = this.anIntArray597[local446 & 0xFF];
								}
								local14 += local44;
							}
							local16 += local50;
						...
						if (arg4 == 0) {
							...
							for (local273 = -arg3; local273 < 0; local273++) {
								...
								for (local343 = -arg2; local343 < 0; local343++) {
									local735 = this.aByteArray91[(local14 >> 16) + local335];
									local361 = local735 > 0 ? this.anIntArray597[local735] : 0;
					...
					for (local262 = -arg3; local262 < 0; local262++) {
						...
						for (local273 = -arg2; local273 < 0; local273++) {
							...
							if (local446 == 0) {
								...
								local343 = this.anIntArray597[local446 & 0xFF];
					...
					for (local262 = -arg3; local262 < 0; local262++) {
						...
						for (local273 = -arg2; local273 < 0; local273++) {
							local446 = this.aByteArray91[(local14 >> 16) + local270];
							local343 = local446 > 0 ? this.anIntArray597[local446] : 0;
				...
				for (local262 = -arg3; local262 < 0; local262++) {
					local270 = (local16 >> 16) * super.anInt7883;
					for (local273 = -arg2; local273 < 0; local273++) {
						local252[local64++] = this.anIntArray597[this.aByteArray91[(local14 >> 16) + local270] & 0xFF];
						local14 += local44;
					}
					local16 += local50;
					local14 = local259;
				...
				for (local335 = -arg3; local335 < 0; local335++) {
					local343 = (local16 >> 16) * super.anInt7883;
					for (local346 = -arg2; local346 < 0; local346++) {
						local361 = this.anIntArray597[this.aByteArray91[(local14 >> 16) + local343] & 0xFF];
				...
				for (local343 = -arg3; local343 < 0; local343++) {
					local346 = (local16 >> 16) * super.anInt7883;
					for (local361 = -arg2; local361 < 0; local361++) {
						local369 = this.anIntArray597[this.aByteArray91[(local14 >> 16) + local346] & 0xFF];
		...
		if (Static463.anInt7896 == 0) {
			if (Static463.anInt7893 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local27 >= 0 && local25 - (super.anInt7883 << 12) < 0 && local27 - (super.anInt7886 << 12) < 0) {
							...
							while (local29 < 0) {
								local111 = this.aByteArray91[(local27 >> 12) * super.anInt7883 + (local25 >> 12)];
								if (local111 == 0) {
									local23++;
								} else {
									local3[local23++] = this.anIntArray597[local111 & 0xFF];
								}
								local29++;
							}
						}
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt7883 << 12) < 0) {
							@Pc(179) int local179;
							if ((local179 = local27 - (super.anInt7886 << 12)) >= 0) {
								local186 = (Static463.anInt7893 - local179) / Static463.anInt7893;
								local29 += local186;
								local27 += Static463.anInt7893 * local186;
								local23 += local186;
							}
							@Pc(207) int local207;
							if ((local207 = (local27 - Static463.anInt7893) / Static463.anInt7893) > local29) {
								local29 = local207;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt7883 << 12) < 0) {
							if (local27 < 0) {
								local186 = (Static463.anInt7893 - local27 - 1) / Static463.anInt7893;
								local29 += local186;
								local27 += Static463.anInt7893 * local186;
								local23 += local186;
							}
							@Pc(379) int local379;
							if ((local379 = (local27 + 1 - (super.anInt7886 << 12) - Static463.anInt7893) / Static463.anInt7893) > local29) {
								local29 = local379;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
			...
			if (Static463.anInt7893 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local27 >= 0 && local27 - (super.anInt7886 << 12) < 0) {
							@Pc(525) int local525;
							if ((local525 = local25 - (super.anInt7883 << 12)) >= 0) {
								local186 = (Static463.anInt7896 - local525) / Static463.anInt7896;
								local29 += local186;
								local25 += Static463.anInt7896 * local186;
								local23 += local186;
							}
							@Pc(553) int local553;
							if ((local553 = (local25 - Static463.anInt7896) / Static463.anInt7896) > local29) {
								local29 = local553;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static463.anInt7909;
						@Pc(690) int local690;
						if ((local690 = local25 - (super.anInt7883 << 12)) >= 0) {
							local186 = (Static463.anInt7896 - local690) / Static463.anInt7896;
							local29 += local186;
							local25 += Static463.anInt7896 * local186;
							local27 += Static463.anInt7893 * local186;
							local23 += local186;
						...
						@Pc(724) int local724;
						if ((local724 = (local25 - Static463.anInt7896) / Static463.anInt7896) > local29) {
							local29 = local724;
						}
						@Pc(736) int local736;
						if ((local736 = local27 - (super.anInt7886 << 12)) >= 0) {
							local186 = (Static463.anInt7893 - local736) / Static463.anInt7893;
							local29 += local186;
							local25 += Static463.anInt7896 * local186;
							local27 += Static463.anInt7893 * local186;
							local23 += local186;
						...
						@Pc(770) int local770;
						if ((local770 = (local27 - Static463.anInt7893) / Static463.anInt7893) > local29) {
							local29 = local770;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static463.anInt7909;
						@Pc(913) int local913;
						if ((local913 = local25 - (super.anInt7883 << 12)) >= 0) {
							local186 = (Static463.anInt7896 - local913) / Static463.anInt7896;
							local29 += local186;
							local25 += Static463.anInt7896 * local186;
							local27 += Static463.anInt7893 * local186;
							local23 += local186;
						...
						@Pc(947) int local947;
						if ((local947 = (local25 - Static463.anInt7896) / Static463.anInt7896) > local29) {
							local29 = local947;
						}
						if (local27 < 0) {
							local186 = (Static463.anInt7893 - local27 - 1) / Static463.anInt7893;
						...
						@Pc(995) int local995;
						if ((local995 = (local27 + 1 - (super.anInt7886 << 12) - Static463.anInt7893) / Static463.anInt7893) > local29) {
							local29 = local995;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if (local27 >= 0 && local27 - (super.anInt7886 << 12) < 0) {
						if (local25 < 0) {
							local186 = (Static463.anInt7896 - local25 - 1) / Static463.anInt7896;
							local29 += local186;
							local25 += Static463.anInt7896 * local186;
							local23 += local186;
						}
						@Pc(1177) int local1177;
						if ((local1177 = (local25 + 1 - (super.anInt7883 << 12) - Static463.anInt7896) / Static463.anInt7896) > local29) {
							local29 = local1177;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1354 = (local25 + 1 - (super.anInt7883 << 12) - Static463.anInt7896) / Static463.anInt7896) > local29) {
						local29 = local1354;
					}
					@Pc(1366) int local1366;
					if ((local1366 = local27 - (super.anInt7886 << 12)) >= 0) {
						local186 = (Static463.anInt7893 - local1366) / Static463.anInt7893;
						local29 += local186;
						local25 += Static463.anInt7896 * local186;
						local27 += Static463.anInt7893 * local186;
						local23 += local186;
					...
					if ((local1400 = (local27 - Static463.anInt7893) / Static463.anInt7893) > local29) {
						local29 = local1400;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1579 = (local25 + 1 - (super.anInt7883 << 12) - Static463.anInt7896) / Static463.anInt7896) > local29) {
						local29 = local1579;
					}
					if (local27 < 0) {
						local186 = (Static463.anInt7893 - local27 - 1) / Static463.anInt7893;
					...
					if ((local1627 = (local27 + 1 - (super.anInt7886 << 12) - Static463.anInt7893) / Static463.anInt7893) > local29) {
						local29 = local1627;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
	...
	protected void method6541(@OriginalArg(0) int arg0) {
		...
		if (Static463.anInt7896 == 0) {
			if (Static463.anInt7893 == 0) {
					...
					if (local14 >= 0 && local16 >= 0 && local14 - (super.anInt7883 << 12) < 0 && local16 - (super.anInt7886 << 12) < 0) {
						while (local18 < 0) {
							...
							if (arg0 == 1) {
								...
								if (local227 != 0) {
									local3[local51] = this.anIntArray597[local227 & 0xFF];
								}
							} else if (arg0 == 0) {
								local227 = this.aByteArray91[local48];
								if (local227 != 0) {
									local255 = this.anIntArray597[local227 & 0xFF];
									if ((Static463.anInt7882 & 0xFFFFFF) == 16777215) {
										local264 = Static463.anInt7882 >>> 24;
										...
										local264 = (local255 & 0xFF0000) * Static463.anInt7910 & 0xFF000000;
										local268 = (local255 & 0xFF00) * Static463.anInt7904 & 0xFF0000;
										local272 = (local255 & 0xFF) * Static463.anInt7906 & 0xFF00;
										...
										local3[local51] = ((local255 & 0xFF00FF) * Static463.anInt7907 + (local344 & 0xFF00FF) * Static463.anInt7891 & 0xFF00FF00) + ((local255 & 0xFF00) * Static463.anInt7907 + (local344 & 0xFF00) * Static463.anInt7891 & 0xFF0000) >> 8;
									}
								}
							} else if (arg0 == 3) {
								local227 = this.aByteArray91[local48];
								local255 = local227 > 0 ? this.anIntArray597[local227] : 0;
								local264 = Static463.anInt7882;
								...
								if (local255 == 0 && Static463.anInt7907 != 255) {
									local255 = local344;
									local344 = local3[local51];
									local344 = ((local255 & 0xFF00FF) * Static463.anInt7907 + (local344 & 0xFF00FF) * Static463.anInt7891 & 0xFF00FF00) + ((local255 & 0xFF00) * Static463.anInt7907 + (local344 & 0xFF00) * Static463.anInt7891 & 0xFF0000) >> 8;
								}
								...
								if (local227 != 0) {
									local255 = this.anIntArray597[local227 & 0xFF];
									local264 = (local255 & 0xFF00FF) * Static463.anInt7907 & 0xFF00FF00;
									local268 = (local255 & 0xFF00) * Static463.anInt7907 & 0xFF0000;
									local3[local51++] = ((local264 | local268) >>> 8) + Static463.anInt7902;
								}
							} else {
								throw new IllegalArgumentException();
							}
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt7883 << 12) < 0) {
						@Pc(928) int local928;
						if ((local928 = local16 - (super.anInt7886 << 12)) >= 0) {
							local935 = (Static463.anInt7893 - local928) / Static463.anInt7893;
							local18 += local935;
							local16 += Static463.anInt7893 * local935;
							local12 += local935;
						}
						@Pc(956) int local956;
						if ((local956 = (local16 - Static463.anInt7893) / Static463.anInt7893) > local18) {
							local18 = local956;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt7883 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt7883 << 12) < 0) {
						if (local16 < 0) {
							local935 = (Static463.anInt7893 - local16 - 1) / Static463.anInt7893;
							local18 += local935;
							local16 += Static463.anInt7893 * local935;
							local12 += local935;
						}
						@Pc(1888) int local1888;
						if ((local1888 = (local16 + 1 - (super.anInt7886 << 12) - Static463.anInt7893) / Static463.anInt7893) > local18) {
							local18 = local1888;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt7883 + (local14 >> 12);
			...
			if (Static463.anInt7893 == 0) {
				...
				while (local9 < 0) {
					...
					if (local16 >= 0 && local16 - (super.anInt7886 << 12) < 0) {
						...
						if ((local2794 = local14 - (super.anInt7883 << 12)) >= 0) {
							local935 = (Static463.anInt7896 - local2794) / Static463.anInt7896;
							local18 += local935;
							local14 += Static463.anInt7896 * local935;
							local12 += local935;
						}
						@Pc(2822) int local2822;
						if ((local2822 = (local14 - Static463.anInt7896) / Static463.anInt7896) > local18) {
							local18 = local2822;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt7883 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local3719 = local14 - (super.anInt7883 << 12)) >= 0) {
						local935 = (Static463.anInt7896 - local3719) / Static463.anInt7896;
						local18 += local935;
						local14 += Static463.anInt7896 * local935;
						local16 += Static463.anInt7893 * local935;
						local12 += local935;
					...
					if ((local3753 = (local14 - Static463.anInt7896) / Static463.anInt7896) > local18) {
						local18 = local3753;
					}
					@Pc(3765) int local3765;
					if ((local3765 = local16 - (super.anInt7886 << 12)) >= 0) {
						local935 = (Static463.anInt7893 - local3765) / Static463.anInt7893;
						local18 += local935;
						local14 += Static463.anInt7896 * local935;
						local16 += Static463.anInt7893 * local935;
						local12 += local935;
					...
					if ((local3799 = (local16 - Static463.anInt7893) / Static463.anInt7893) > local18) {
						local18 = local3799;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt7883 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local4702 = local14 - (super.anInt7883 << 12)) >= 0) {
						local935 = (Static463.anInt7896 - local4702) / Static463.anInt7896;
						local18 += local935;
						local14 += Static463.anInt7896 * local935;
						local16 += Static463.anInt7893 * local935;
						local12 += local935;
					...
					if ((local4736 = (local14 - Static463.anInt7896) / Static463.anInt7896) > local18) {
						local18 = local4736;
					}
					if (local16 < 0) {
						local935 = (Static463.anInt7893 - local16 - 1) / Static463.anInt7893;
					...
					if ((local4784 = (local16 + 1 - (super.anInt7886 << 12) - Static463.anInt7893) / Static463.anInt7893) > local18) {
						local18 = local4784;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt7883 + (local14 >> 12);
			...
			while (local9 < 0) {
				...
				if (local16 >= 0 && local16 - (super.anInt7886 << 12) < 0) {
					if (local14 < 0) {
						local935 = (Static463.anInt7896 - local14 - 1) / Static463.anInt7896;
						local18 += local935;
						local14 += Static463.anInt7896 * local935;
						local12 += local935;
					}
					@Pc(5726) int local5726;
					if ((local5726 = (local14 + 1 - (super.anInt7883 << 12) - Static463.anInt7896) / Static463.anInt7896) > local18) {
						local18 = local5726;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt7883 + (local14 >> 12);
			...
			for (local9 = Static463.anInt7892; local9 < 0; local9++) {
				...
				if ((local6663 = (local14 + 1 - (super.anInt7883 << 12) - Static463.anInt7896) / Static463.anInt7896) > local18) {
					local18 = local6663;
				}
				@Pc(6675) int local6675;
				if ((local6675 = local16 - (super.anInt7886 << 12)) >= 0) {
					local935 = (Static463.anInt7893 - local6675) / Static463.anInt7893;
					local18 += local935;
					local14 += Static463.anInt7896 * local935;
					local16 += Static463.anInt7893 * local935;
					local12 += local935;
				...
				if ((local6709 = (local16 - Static463.anInt7893) / Static463.anInt7893) > local18) {
					local18 = local6709;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt7883 + (local14 >> 12);
			...
			for (local9 = Static463.anInt7892; local9 < 0; local9++) {
				...
				if ((local7648 = (local14 + 1 - (super.anInt7883 << 12) - Static463.anInt7896) / Static463.anInt7896) > local18) {
					local18 = local7648;
				}
				if (local16 < 0) {
					local935 = (Static463.anInt7893 - local16 - 1) / Static463.anInt7893;
				...
				if ((local7696 = (local16 + 1 - (super.anInt7886 << 12) - Static463.anInt7893) / Static463.anInt7893) > local18) {
					local18 = local7696;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt7883 + (local14 >> 12);
		...
		if (arg4 != 0) {
			...
			if (arg4 == 1) {
				if (arg2 == 1) {
					for (local168 = -local32; local168 < 0; local168++) {
						for (local175 = -local35; local175 < 0; local175++) {
							local543 = this.aByteArray91[local29++];
							if (local543 == 0) {
								local27++;
							} else {
								local287 = this.anIntArray597[local543 & 0xFF] | 0xFF000000;
					...
					if (arg2 == 0) {
						if ((arg3 & 0xFFFFFF) == 16777215) {
							...
							for (local284 = -local32; local284 < 0; local284++) {
								for (local287 = -local35; local287 < 0; local287++) {
									local645 = this.aByteArray91[local29++];
									if (local645 == 0) {
										local27++;
									} else {
										local303 = this.anIntArray597[local645 & 0xFF];
										local311 = local160[local27];
							...
							for (local303 = -local32; local303 < 0; local303++) {
								for (local311 = -local35; local311 < 0; local311++) {
									@Pc(746) byte local746 = this.aByteArray91[local29++];
									if (local746 == 0) {
										local27++;
									} else {
										local327 = this.anIntArray597[local746 & 0xFF];
										if (local287 == 255) {
						...
						for (local284 = -local32; local284 < 0; local284++) {
							for (local287 = -local35; local287 < 0; local287++) {
								local645 = this.aByteArray91[local29++];
								local303 = local645 > 0 ? this.anIntArray597[local645] : 0;
						...
						for (local291 = -local32; local291 < 0; local291++) {
							for (local303 = -local35; local303 < 0; local303++) {
								local1054 = this.aByteArray91[local29++];
								if (local1054 == 0) {
									local27++;
								} else {
									local319 = this.anIntArray597[local1054 & 0xFF];
				...
				for (local168 = -local32; local168 < 0; local168++) {
					for (local175 = -local35; local175 < 0; local175++) {
						...
						if (local543 == 0) {
							...
							local287 = this.anIntArray597[local543 & 0xFF];
				...
				for (local287 = -local32; local287 < 0; local287++) {
					for (local291 = -local35; local291 < 0; local291++) {
						@Pc(1228) byte local1228 = this.aByteArray91[local29++];
						if (local1228 == 0) {
							local27++;
						} else {
							local311 = this.anIntArray597[local1228 & 0xFF];
				...
				for (local168 = -local32; local168 < 0; local168++) {
					for (local175 = -local35; local175 < 0; local175++) {
						local543 = this.aByteArray91[local29++];
						local287 = local543 > 0 ? this.anIntArray597[local543] : 0;
			...
			for (local168 = -local32; local168 < 0; local168++) {
				...
				while (local27 < local175) {
					local160[local27++] = this.anIntArray597[this.aByteArray91[local29++] & 0xFF];
					local160[local27++] = this.anIntArray597[this.aByteArray91[local29++] & 0xFF];
					local160[local27++] = this.anIntArray597[this.aByteArray91[local29++] & 0xFF];
					local160[local27++] = this.anIntArray597[this.aByteArray91[local29++] & 0xFF];
				}
			...
			for (local287 = -local32; local287 < 0; local287++) {
				for (local291 = -local35; local291 < 0; local291++) {
					local303 = this.anIntArray597[this.aByteArray91[local29++] & 0xFF];
			...
			for (local168 = -local32; local168 < 0; local168++) {
				for (local175 = -local35; local175 < 0; local175++) {
					local284 = this.anIntArray597[this.aByteArray91[local29++] & 0xFF];
			...
			for (local291 = -local32; local291 < 0; local291++) {
				for (local303 = -local35; local303 < 0; local303++) {
					local311 = this.anIntArray597[this.aByteArray91[local29++] & 0xFF];
		...
		if (arg7 != 0) {
			...
			if (arg7 == 1) {
					...
					for (local260 = -arg4; local260 < 0; local260++) {
						...
						for (local271 = -arg3; local271 < 0; local271++) {
							if ((float) arg2 < local246[local52]) {
								local475 = this.aByteArray91[(local6 >> 16) + local268];
								if (local475 != 0) {
									local250[local52] = this.anIntArray597[local475 & 0xFF];
					...
					if (arg5 == 0) {
						...
						if ((arg6 & 0xFFFFFF) == 16777215) {
							...
							for (local271 = -arg4; local271 < 0; local271++) {
								local345 = (local8 >> 16) * super.anInt7883;
								for (local353 = -arg3; local353 < 0; local353++) {
									if ((float) arg2 < local246[local52]) {
										local798 = this.aByteArray91[(local6 >> 16) + local345];
										if (local798 != 0) {
											local378 = this.anIntArray597[local798 & 0xFF];
							...
							for (local356 = -arg4; local356 < 0; local356++) {
								local378 = (local8 >> 16) * super.anInt7883;
								for (local386 = -arg3; local386 < 0; local386++) {
									if ((float) arg2 < local246[local52]) {
										@Pc(925) byte local925 = this.aByteArray91[(local6 >> 16) + local378];
										if (local925 != 0) {
											local402 = this.anIntArray597[local925 & 0xFF];
											if (local345 == 255) {
						...
						for (local271 = -arg4; local271 < 0; local271++) {
							...
							for (local353 = -arg3; local353 < 0; local353++) {
								if ((float) arg2 < local246[local52]) {
									local798 = this.aByteArray91[(local6 >> 16) + local345];
									local378 = local798 > 0 ? this.anIntArray597[local798] : 0;
						...
						for (local353 = -arg4; local353 < 0; local353++) {
							local356 = (local8 >> 16) * super.anInt7883;
							for (local378 = -arg3; local378 < 0; local378++) {
								if ((float) arg2 < local246[local52]) {
									local1295 = this.aByteArray91[(local6 >> 16) + local356];
									if (local1295 != 0) {
										local394 = this.anIntArray597[local1295 & 0xFF];
				...
				for (local260 = -arg4; local260 < 0; local260++) {
					...
					for (local271 = -arg3; local271 < 0; local271++) {
						if ((float) arg2 < local246[local52]) {
							local475 = this.aByteArray91[(local6 >> 16) + local268];
							if (local475 != 0) {
								local353 = this.anIntArray597[local475 & 0xFF];
				...
				for (local345 = -arg4; local345 < 0; local345++) {
					local353 = (local8 >> 16) * super.anInt7883;
					for (local356 = -arg3; local356 < 0; local356++) {
						if ((float) arg2 < local246[local52]) {
							@Pc(1525) byte local1525 = this.aByteArray91[(local6 >> 16) + local353];
							if (local1525 != 0) {
								local386 = this.anIntArray597[local1525 & 0xFF];
				...
				for (local260 = -arg4; local260 < 0; local260++) {
					...
					for (local271 = -arg3; local271 < 0; local271++) {
						if ((float) arg2 < local246[local52]) {
							local475 = this.aByteArray91[(local6 >> 16) + local268];
							local353 = local475 > 0 ? this.anIntArray597[local475] : 0;
			...
			for (local260 = -arg4; local260 < 0; local260++) {
				...
				for (local271 = -arg3; local271 < 0; local271++) {
					if ((float) arg2 < local246[local52]) {
						local250[local52] = this.anIntArray597[this.aByteArray91[(local6 >> 16) + local268] & 0xFF];
						local246[local52] = (float) arg2;
					}
					local6 += local32;
					local52++;
			...
			for (local345 = -arg4; local345 < 0; local345++) {
				...
				for (local356 = -arg3; local356 < 0; local356++) {
					if ((float) arg2 < local246[local52]) {
						local378 = this.anIntArray597[this.aByteArray91[(local6 >> 16) + local353] & 0xFF];
			...
			for (local353 = -arg4; local353 < 0; local353++) {
				...
				for (local378 = -arg3; local378 < 0; local378++) {
					if ((float) arg2 < local246[local52]) {
						local386 = this.anIntArray597[this.aByteArray91[(local6 >> 16) + local356] & 0xFF];
	...
	@OriginalMember(owner = "client!pea", name = "a", descriptor = "(IILclient!aa;II)V")
	@Override
		...
		for (@Pc(212) int local212 = local171; local212 < local210; local212++) {
			...
			for (@Pc(304) int local304 = -local227; local304 < 0; local304++) {
				...
				if (local311 == 0) {
					...
					local169[local41++] = this.anIntArray597[local311 & 0xFF];
				}
			}
