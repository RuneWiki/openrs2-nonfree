...
public final class Static261 {
	...
	public static final int anInt4198 = 1403;
	...
	@OriginalMember(owner = "client!mm", name = "b", descriptor = "(II)Lclient!ub;")
	public static Class5_Sub1 method3343(@OriginalArg(1) int arg0) {
		if (arg0 == 0) {
