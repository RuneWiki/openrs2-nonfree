...
public final class Class182 {
	...
	@OriginalMember(owner = "client!ima", name = "a", descriptor = "Ljava/awt/Component;")
	private Component aComponent2;

	@OriginalMember(owner = "client!ima", name = "b", descriptor = "Ljava/awt/Robot;")
	private final Robot aRobot1 = new Robot();

	@OriginalMember(owner = "client!ima", name = "<init>", descriptor = "()V")
	private Class182() throws Exception {
	}

	@OriginalMember(owner = "client!ima", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
	...
	@OriginalMember(owner = "client!ima", name = "movemouse", descriptor = "(II)V")
	private void movemouse(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aRobot1.mouseMove(arg0, arg1);
	}

	@OriginalMember(owner = "client!ima", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
