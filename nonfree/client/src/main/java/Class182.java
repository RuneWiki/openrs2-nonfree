...
public final class Class182 {
	...
	@OriginalMember(owner = "client!va", name = "<init>", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
	public Class182(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18) {
		if (arg5 != arg6 || arg5 != arg7 || arg5 != arg8) {
			this.aBoolean380 = false;
		}
		this.anInt5697 = arg0;
		this.anInt5695 = arg1;
		this.anInt5698 = arg17;
		this.anInt5696 = arg18;
		@Pc(30) short local30 = 128;
		@Pc(34) int local34 = local30 / 2;
		@Pc(38) int local38 = local30 / 4;
		@Pc(44) int local44 = local30 * 3 / 4;
		@Pc(48) int[] local48 = Static292.anIntArrayArray40[arg0];
		@Pc(51) int local51 = local48.length;
		this.anIntArray543 = new int[local51];
		this.anIntArray547 = new int[local51];
		this.anIntArray555 = new int[local51];
		...
		for (@Pc(79) int local79 = 0; local79 < local51; local79++) {
			...
			this.anIntArray543[local79] = local142;
			this.anIntArray547[local79] = local146;
			this.anIntArray555[local79] = local144;
			local66[local79] = local148;
			local69[local79] = local150;
		}
		@Pc(534) int[] local534 = Static292.anIntArrayArray41[arg0];
		local86 = local534.length / 4;
		this.anIntArray549 = new int[local86];
		this.anIntArray556 = new int[local86];
		this.anIntArray554 = new int[local86];
		this.anIntArray553 = new int[local86];
		this.anIntArray542 = new int[local86];
		this.anIntArray544 = new int[local86];
		if (arg2 != -1) {
			this.anIntArray550 = new int[local86];
		}
		local142 = 0;
		for (local144 = 0; local144 < local86; local144++) {
			...
			this.anIntArray549[local144] = local148;
			this.anIntArray556[local144] = local150;
			this.anIntArray554[local144] = local599;
			if (local146 == 0) {
				this.anIntArray553[local144] = local66[local148];
				this.anIntArray542[local144] = local66[local150];
				this.anIntArray544[local144] = local66[local599];
				if (this.anIntArray550 != null) {
					this.anIntArray550[local144] = -1;
				}
			} else {
				this.anIntArray553[local144] = local69[local148];
				this.anIntArray542[local144] = local69[local150];
				this.anIntArray544[local144] = local69[local599];
				if (this.anIntArray550 != null) {
					this.anIntArray550[local144] = arg2;
				}
			}
		}
		local144 = arg5;
