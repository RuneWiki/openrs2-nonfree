...
public final class Class11_Sub20 extends Class11 {
	...
	public Class11_Sub20(@OriginalArg(0) byte[] arg0) {
		this.method1932(arg0);
	}

	@OriginalMember(owner = "client!ie", name = "c", descriptor = "(I)[F")
	private float[] method1931(@OriginalArg(0) int arg0) {
		Static127.method1936(this.aByteArrayArray19[arg0]);
		Static127.method1940();
		@Pc(15) int local15 = Static127.method1939(Static184.method3190(Static127.anIntArray167.length - 1));
		@Pc(19) boolean local19 = Static127.aBooleanArray11[local15];
		@Pc(25) int local25 = local19 ? Static127.anInt2317 : Static127.anInt2319;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static127.method1940() != 0;
			local29 = Static127.method1940() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static127.anInt2319 >> 2);
			local67 = (local25 >> 2) + (Static127.anInt2319 >> 2);
			local71 = Static127.anInt2319 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static127.anInt2319 >> 2);
			local104 = local25 + (Static127.anInt2319 >> 2) - (local25 >> 2);
			local108 = Static127.anInt2319 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class197 local123 = Static127.aClass197Array1[Static127.anIntArray167[local15]];
		@Pc(126) int local126 = local123.anInt6171;
		@Pc(131) int local131 = local123.anIntArray509[local126];
		@Pc(140) boolean local140 = !Static127.aClass128Array1[local131].method3226();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt6170; local144++) {
			@Pc(152) Class192 local152 = Static127.aClass192Array1[local123.anIntArray510[local144]];
			local154 = Static127.aFloatArray14;
			local152.method5160(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt6171;
			local176 = local123.anIntArray509[local171];
			Static127.aClass128Array1[local176].method3228(Static127.aFloatArray14, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static127.aFloatArray14[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static127.aFloatArray14;
			...
			@Pc(252) float[] local252 = local19 ? Static127.aFloatArray8 : Static127.aFloatArray11;
			@Pc(258) float[] local258 = local19 ? Static127.aFloatArray9 : Static127.aFloatArray10;
			@Pc(264) float[] local264 = local19 ? Static127.aFloatArray7 : Static127.aFloatArray12;
			@Pc(270) int[] local270 = local19 ? Static127.anIntArray168 : Static127.anIntArray169;
			...
			@Pc(486) int local486 = Static184.method3190(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static127.aFloatArray14[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static127.aFloatArray14[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt2316 > 0) {
			local176 = this.anInt2316 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean151) {
				for (local212 = 0; local212 < this.anInt2312; local212++) {
					local1254 = (this.anInt2316 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static127.aFloatArray14[local212];
				}
			}
		}
		local154 = this.aFloatArray13;
		this.aFloatArray13 = Static127.aFloatArray14;
		Static127.aFloatArray14 = local154;
		this.anInt2316 = local25;
		this.anInt2312 = local104 - (local25 >> 1);
		this.aBoolean151 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!ie", name = "a", descriptor = "([B)V")
	private void method1932(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class11_Sub25 local4 = new Class11_Sub25(arg0);
		this.anInt2314 = local4.method5198();
		this.anInt2321 = local4.method5198();
		this.anInt2313 = local4.method5198();
		this.anInt2318 = local4.method5198();
		if (this.anInt2318 < 0) {
			this.anInt2318 = ~this.anInt2318;
			this.aBoolean150 = true;
		}
		@Pc(40) int local40 = local4.method5198();
		this.aByteArrayArray19 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method5185();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method5209(local64, local49);
			this.aByteArrayArray19[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!ie", name = "a", descriptor = "([I)Lclient!vj;")
	public Class11_Sub15_Sub1 method1933(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray34 == null) {
			this.anInt2316 = 0;
			this.aFloatArray13 = new float[Static127.anInt2317];
			this.aByteArray34 = new byte[this.anInt2321];
			this.anInt2322 = 0;
			this.anInt2323 = 0;
		}
		while (this.anInt2323 < this.aByteArrayArray19.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1931(this.anInt2323);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2322;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt2321 - local47) {
					local50 = this.anInt2321 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2322;
				}
				this.anInt2322 = local47;
			}
			this.anInt2323++;
		}
		...
		return new Class11_Sub15_Sub1(this.anInt2314, local129, this.anInt2313, this.anInt2318, this.aBoolean150);
	}
}
