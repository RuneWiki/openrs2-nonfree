...
public final class Class36 {
	...
	private float method1065(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) float arg2) {
		...
		return Static64.method1067(local34);
	}

	@OriginalMember(owner = "client!md", name = "a", descriptor = "(Lclient!eb;Lclient!ie;)V")
	...
	public int method1069(@OriginalArg(0) int arg0, @OriginalArg(1) float arg1) {
		...
		if (arg0 == 0) {
			...
			Static64.anInt1619 = (int) (Static64.aFloat1 * 65536.0F);
		}
		if (this.anIntArray335[arg0] == 0) {
			return 0;
		}
		local20 = this.method1068(arg0, 0, arg1);
		Static64.aFloatArrayArray1[arg0][0] = -2.0F * local20 * (float) Math.cos((double) this.method1065(arg0, 0, arg1));
		...
		for (local226 = 0; local226 < this.anIntArray335[arg0] * 2; local226++) {
			Static64.anIntArrayArray12[arg0][local226] = (int) (Static64.aFloatArrayArray1[arg0][local226] * 65536.0F);
		}
