...
public final class LruCache {
	...
	private final DoublyLinkList aClass78_1 = new DoublyLinkList();
	...
	public LruCache(@OriginalArg(0) int arg0) {
		...
		this.aClass81_5 = new HashTable(local13);
	}

	@OriginalMember(owner = "client!ja", name = "a", descriptor = "(JBLclient!be;)V")
	public void method997(@OriginalArg(0) long arg0, @OriginalArg(2) DoublyLinkable arg1) {
		if (this.anInt1491 == 0) {
			@Pc(26) DoublyLinkable local26 = this.aClass78_1.method1977();
			local26.method1999();
			local26.method1906();
	...
	public DoublyLinkable method998(@OriginalArg(1) long arg0) {
		@Pc(10) DoublyLinkable local10 = (DoublyLinkable) this.aClass81_5.method2010(arg0);
		if (local10 != null) {
	...
	public void method999(@OriginalArg(0) long arg0) {
		@Pc(15) DoublyLinkable local15 = (DoublyLinkable) this.aClass81_5.method2010(arg0);
		if (local15 != null) {
			local15.method1999();
			local15.method1906();
			this.anInt1491++;
	...
	public void method1003() {
		while (true) {
			@Pc(10) DoublyLinkable local10 = this.aClass78_1.method1977();
			if (local10 == null) {
