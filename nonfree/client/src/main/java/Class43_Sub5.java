...
public final class Class43_Sub5 extends Class43 {
	...
	@OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(ILclient!lha;)V")
	public Class43_Sub5(@OriginalArg(0) int arg0, @OriginalArg(1) Class14_Sub26 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lclient!lha;)V")
	public Class43_Sub5(@OriginalArg(0) Class14_Sub26 arg0) {
		super(arg0);
	}
