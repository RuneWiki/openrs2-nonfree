...
public final class Class84 {
	...
	@OriginalMember(owner = "client!ef", name = "lb", descriptor = "Lclient!ef;")
	...
	static {
		...
		new Class84(null, "der Spieler ist momentan nicht verfügbar.", null, null);
		...
		new Class84(null, "indem du dich ins Spiel einloggst.", null, null);
		...
		new Class84("clan_chat", "clanchat", "conversation_clan", "clan_chat");
		...
		new Class84("Now talking in clan channel of player: ", "Clanchat dieses Spieler beigetreten: ", "Vous participez actuellement au canal de clan du joueur : ", "Falando no canal do clã do jogador: ");
		...
		new Class84("You do not have a high enough rank to join this clan channel.", "Dein Rang reicht nicht aus, um diesen Chatraum zu betreten.", "Votre rang n'est pas assez élevé pour rejoindre ce canal de clan.", "Sua posição não é alta o suficiente para você entrar nesse canal de clã.");
		new Class84("You are temporarily banned from this clan channel.", "Du wurdest temporär aus diesem Chatraum verbannt.", "Vous êtes temporairement exclu de ce canal de clan.", "Você está temporariamente vetado de entrar nesse canal de clã.");
		new Class84("You are not allowed to join this user's clan channel.", "Du darfst den Chatraum dieses Benutzers nicht betreten.", "Vous n'êtes pas autorisé à rejoindre le canal de clan de cet utilisateur.", "Você não tem permissão para entrar no canal de clã desse usuário.");
		...
		new Class84("Your clan channel has now been enabled!", "Dein Chatraum ist jetzt eingeschaltet.", "Votre canal de clan est activé !", "Seu canal de clã já está ativado!");
		...
		lb = new Class84("glow1:", "leuchten1:", "brillant1:", "brilho1:");
	}

	@OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V")
	...
	@OriginalMember(owner = "client!ef", name = "a", descriptor = "(II)Ljava/lang/String;")
	public String method2710(@OriginalArg(0) int arg0) {
