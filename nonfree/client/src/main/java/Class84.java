...
public final class Class84 implements Interface1 {
	...
	private int anInt3103 = -1;

	@OriginalMember(owner = "client!ke", name = "c", descriptor = "[I")
	private int[] anIntArray284 = null;

	@OriginalMember(owner = "client!ke", name = "<init>", descriptor = "()V")
	public Class84() {
		if (Static296.aBoolean345 && Static296.anInt6199 >= 2) {
			this.method2370();
			@Pc(19) GL local19 = Static296.aGL1;
			local19.glBindTexture(34067, this.anIntArray284[0]);
			...
			local19.glBindTexture(34067, this.anIntArray284[1]);
			local19.glTexParameteri(34067, 10241, 9729);
			local19.glTexParameteri(34067, 10240, 9729);
			local19.glTexParameteri(34067, 32882, 33071);
			local19.glTexParameteri(34067, 10242, 33071);
			local19.glTexParameteri(34067, 10243, 33071);
			local19.glBindTexture(34067, this.anIntArray284[2]);
			local19.glTexParameteri(34067, 10241, 9729);
			local19.glTexParameteri(34067, 10240, 9729);
			local19.glTexParameteri(34067, 32882, 33071);
			local19.glTexParameteri(34067, 10242, 33071);
			local19.glTexParameteri(34067, 10243, 33071);
			this.aBoolean161 = Static296.anInt6199 < 3;
		}
		this.method2369();
	}
	...
	public void method3557() {
		...
		if (Static10.aBoolean12) {
			local1.glCallList(this.anInt3103);
		} else {
	...
	private void method2369() {
		@Pc(1) GL local1 = Static296.aGL1;
		this.anInt3103 = local1.glGenLists(2);
		local1.glNewList(this.anInt3103, 4864);
		if (this.anIntArray284 == null) {
			...
			if (this.aBoolean161) {
				...
				local1.glTexEnvi(8960, 34162, 7681);
				local1.glTexEnvi(8960, 34184, 34167);
				local1.glBindTexture(3553, Static296.anInt6198);
				local1.glEnable(3553);
			}
			local1.glActiveTexture(33984);
		}
		local1.glEndList();
		local1.glNewList(this.anInt3103 + 1, 4864);
		if (this.anIntArray284 == null) {
	...
	private void method2370() {
		@Pc(1) GL local1 = Static296.aGL1;
		if (this.anIntArray284 == null) {
			this.anIntArray284 = new int[3];
			local1.glGenTextures(3, this.anIntArray284, 0);
		}
	...
	public void method3559() {
		@Pc(1) GL local1 = Static296.aGL1;
		if (Static10.aBoolean12) {
			local1.glCallList(this.anInt3103 + 1);
		} else {
			local1.glTexEnvi(8960, 34184, 5890);
		}
	}
	...
	public void method3556(@OriginalArg(0) int arg0) {
		@Pc(1) GL local1 = Static296.aGL1;
		if (Static10.aBoolean12 && this.anIntArray284 != null) {
			local1.glActiveTexture(33985);
			local1.glBindTexture(34067, this.anIntArray284[arg0 - 1]);
			local1.glActiveTexture(33984);
		}
	}
