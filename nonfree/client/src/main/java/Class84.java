...
public abstract class Class84 {
	...
	public final void method7485(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	public final void method7486(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class145 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		if (arg4 == 0) {
			return;
		}
		...
		this.method7493(local37, local50, local67, local85, local102, local118, arg6, arg7, arg8);
	}
	...
	public final void method7487(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.DA(arg0, arg1, 1, 0, 1);
	}

	@OriginalMember(owner = "client!ha", name = "a", descriptor = "(FFIIIII)V")
	public final void method7488(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4) {
		this.method7494(arg0, arg1, (float) this.EA() / 2.0F, (float) this.ma() / 2.0F, arg2, arg3, 0, arg4);
	}
	...
	public final void method7489(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	public final void method7491(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.method7494(arg0, arg1, (float) this.EA() / 2.0F, (float) this.ma() / 2.0F, arg2, arg3, 1, 0);
	}
	...
	public final void method7492(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Class145 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		this.method7486(arg0, arg1, (float) this.EA() / 2.0F, (float) this.ma() / 2.0F, 4096, arg2, arg3, arg4, arg5);
	}
	...
	protected abstract void method7493(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) Class145 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8);

	@OriginalMember(owner = "client!ha", name = "a", descriptor = "(FFFFIIIII)V")
	private void method7494(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg4 == 0) {
			return;
		}
		@Pc(9) double local9 = (double) (arg5 & 0xFFFF) * 9.587379924285257E-5D;
