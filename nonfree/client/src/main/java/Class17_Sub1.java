...
public final class Class17_Sub1 extends Class17 {
	...
	@OriginalMember(owner = "client!aka", name = "<init>", descriptor = "(Lclient!es;)V")
	public Class17_Sub1(@OriginalArg(0) Class5_Sub19 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!aka", name = "<init>", descriptor = "(ILclient!es;)V")
	public Class17_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub19 arg1) {
		super(arg0, arg1);
	}
