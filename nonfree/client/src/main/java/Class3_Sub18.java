...
public final class Class3_Sub18 extends Class3 {
	...
	private float[] method1774(@OriginalArg(0) int arg0) {
		Static115.method1773(this.aByteArrayArray7[arg0]);
		Static115.method1780();
		@Pc(15) int local15 = Static115.method1781(Static170.method2729(Static115.anIntArray331.length - 1));
		@Pc(19) boolean local19 = Static115.aBooleanArray15[local15];
		@Pc(25) int local25 = local19 ? Static115.anInt2591 : Static115.anInt2586;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static115.method1780() != 0;
			local29 = Static115.method1780() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static115.anInt2586 >> 2);
			local67 = (local25 >> 2) + (Static115.anInt2586 >> 2);
			local71 = Static115.anInt2586 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static115.anInt2586 >> 2);
			local104 = local25 + (Static115.anInt2586 >> 2) - (local25 >> 2);
			local108 = Static115.anInt2586 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class17 local123 = Static115.aClass17Array1[Static115.anIntArray331[local15]];
		@Pc(126) int local126 = local123.anInt744;
		@Pc(131) int local131 = local123.anIntArray93[local126];
		@Pc(140) boolean local140 = !Static115.aClass25Array1[local131].method705();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt743; local144++) {
			@Pc(152) Class56 local152 = Static115.aClass56Array1[local123.anIntArray92[local144]];
			local154 = Static115.aFloatArray3;
			local152.method1537(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt744;
			local176 = local123.anIntArray93[local171];
			Static115.aClass25Array1[local176].method704(Static115.aFloatArray3, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static115.aFloatArray3[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static115.aFloatArray3;
			...
			@Pc(252) float[] local252 = local19 ? Static115.aFloatArray2 : Static115.aFloatArray7;
			@Pc(258) float[] local258 = local19 ? Static115.aFloatArray8 : Static115.aFloatArray5;
			@Pc(264) float[] local264 = local19 ? Static115.aFloatArray9 : Static115.aFloatArray6;
			@Pc(270) int[] local270 = local19 ? Static115.anIntArray333 : Static115.anIntArray332;
			...
			@Pc(486) int local486 = Static170.method2729(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static115.aFloatArray3[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static115.aFloatArray3[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt2592 > 0) {
			local176 = this.anInt2592 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean99) {
				for (local212 = 0; local212 < this.anInt2585; local212++) {
					local1254 = (this.anInt2592 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static115.aFloatArray3[local212];
				}
			}
		}
		local154 = this.aFloatArray4;
		this.aFloatArray4 = Static115.aFloatArray3;
		Static115.aFloatArray3 = local154;
		this.anInt2592 = local25;
		this.anInt2585 = local104 - (local25 >> 1);
	...
	private void method1776(@OriginalArg(0) byte[] arg0) {
		...
		this.anInt2589 = local4.method2132();
		this.anInt2588 = local4.method2132();
		this.anInt2590 = local4.method2132();
		this.anInt2583 = local4.method2132();
		if (this.anInt2583 < 0) {
			this.anInt2583 = ~this.anInt2583;
			this.aBoolean101 = true;
		}
		@Pc(40) int local40 = local4.method2132();
		this.aByteArrayArray7 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method2107();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method2126(local64, local49);
			this.aByteArrayArray7[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!mi", name = "a", descriptor = "([I)Lclient!oc;")
	public Class3_Sub19_Sub1 method1777(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray24 == null) {
			this.anInt2592 = 0;
			this.aFloatArray4 = new float[Static115.anInt2591];
			this.aByteArray24 = new byte[this.anInt2588];
			this.anInt2593 = 0;
			this.anInt2594 = 0;
		}
		while (this.anInt2594 < this.aByteArrayArray7.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1774(this.anInt2594);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2593;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt2588 - local47) {
					local50 = this.anInt2588 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2593;
				}
				this.anInt2593 = local47;
			}
			this.anInt2594++;
		}
		...
		return new Class3_Sub19_Sub1(this.anInt2589, local129, this.anInt2590, this.anInt2583, this.aBoolean101);
	}
}
