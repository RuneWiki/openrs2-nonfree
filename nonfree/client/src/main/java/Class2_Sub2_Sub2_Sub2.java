...
public final class Class2_Sub2_Sub2_Sub2 extends Class2_Sub2_Sub2 {
	...
	public static Class40 aClass40_204 = Static12.method257("gr2");

	@OriginalMember(owner = "client!fc", name = "Z", descriptor = "Lclient!o;")
	public static Class40 aClass40_203 = Static12.method257("dre");

	@OriginalMember(owner = "client!fc", name = "W", descriptor = "Lclient!o;")
	public static Class40 aClass40_201 = Static12.method257("gre");

	@OriginalMember(owner = "client!fc", name = "X", descriptor = "Lclient!o;")
	public static Class40 aClass40_202 = Static12.method257("yel");

	@OriginalMember(owner = "client!fc", name = "V", descriptor = "Lclient!o;")
	public static Class40 aClass40_200 = Static12.method257("str");

	@OriginalMember(owner = "client!fc", name = "gb", descriptor = "Lclient!o;")
	public static Class40 aClass40_209 = Static12.method257("mag");

	@OriginalMember(owner = "client!fc", name = "bb", descriptor = "Lclient!o;")
	public static Class40 aClass40_205 = Static12.method257("or2");

	@OriginalMember(owner = "client!fc", name = "lb", descriptor = "Lclient!o;")
	public static Class40 aClass40_213 = Static12.method257("or1");

	@OriginalMember(owner = "client!fc", name = "ob", descriptor = "Lclient!o;")
	public static Class40 aClass40_214 = Static12.method257("bla");

	@OriginalMember(owner = "client!fc", name = "cb", descriptor = "Lclient!o;")
	public static Class40 aClass40_206 = Static12.method257("or3");

	@OriginalMember(owner = "client!fc", name = "fb", descriptor = "Lclient!o;")
	public static Class40 aClass40_208 = Static12.method257("red");

	@OriginalMember(owner = "client!fc", name = "db", descriptor = "Lclient!o;")
	public static Class40 aClass40_207 = Static12.method257("cya");

	@OriginalMember(owner = "client!fc", name = "kb", descriptor = "Lclient!o;")
	public static Class40 aClass40_212 = Static12.method257("lre");

	@OriginalMember(owner = "client!fc", name = "pb", descriptor = "Lclient!o;")
	public static Class40 aClass40_215 = Static12.method257("dbl");

	@OriginalMember(owner = "client!fc", name = "rb", descriptor = "Lclient!o;")
	public static Class40 aClass40_217 = Static12.method257("whi");

	@OriginalMember(owner = "client!fc", name = "jb", descriptor = "Lclient!o;")
	public static Class40 aClass40_211 = Static12.method257("blu");

	@OriginalMember(owner = "client!fc", name = "hb", descriptor = "Lclient!o;")
	public static Class40 aClass40_210 = Static12.method257("gr3");

	@OriginalMember(owner = "client!fc", name = "qb", descriptor = "Lclient!o;")
	public static Class40 aClass40_216 = Static12.method257("gr1");
	...
	@OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lclient!o;IIII)V", line = 4)
	...
	@OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lclient!o;)I", line = 117)
	...
	private void method569(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(5) int local5 = arg1 + arg2 * Static25.anInt2440;
		@Pc(9) int local9 = Static25.anInt2440 - arg3;
		@Pc(11) int local11 = 0;
		@Pc(13) int local13 = 0;
		@Pc(20) int local20;
		if (arg2 < Class2_Sub2_Sub2.anInt2439) {
			local20 = Class2_Sub2_Sub2.anInt2439 - arg2;
			arg4 -= local20;
			arg2 = Class2_Sub2_Sub2.anInt2439;
			local13 = local20 * arg3;
			local5 += local20 * Static25.anInt2440;
		}
		if (arg2 + arg4 > Class2_Sub2_Sub2.anInt2438) {
			arg4 -= arg2 + arg4 - Class2_Sub2_Sub2.anInt2438;
		}
		if (arg1 < Class2_Sub2_Sub2.anInt2437) {
			local20 = Class2_Sub2_Sub2.anInt2437 - arg1;
			arg3 -= local20;
		...
		if (arg1 + arg3 > Class2_Sub2_Sub2.anInt2436) {
			local20 = arg1 + arg3 - Class2_Sub2_Sub2.anInt2436;
			arg3 -= local20;
			local11 += local20;
			local9 += local20;
		}
		if (arg3 > 0 && arg4 > 0) {
			this.method565(Static25.anIntArray533, arg0, arg5, local13, local5, arg3, arg4, local9, local11);
		}
	}

	@OriginalMember(owner = "client!fc", name = "b", descriptor = "(Lclient!o;IIII)V", line = 183)
	...
	private void method573(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		...
		if (arg3 > 0 && arg4 > 0) {
			this.method567(Static25.anIntArray533, arg0, arg5, local13, local5, arg3, arg4, local9, local11, arg6);
		}
	}

	@OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lclient!o;IIIZ)V", line = 292)
	public void method574(@OriginalArg(0) Class40 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		...
		if (this.aBoolean53) {
			Static25.method1603(local4, local12 + (int) ((double) this.anInt715 * 0.7D), arg1 - local4, 8388608);
		}
	}
	...
	@OriginalMember(owner = "client!fc", name = "b", descriptor = "(Lclient!o;)I", line = 364)
	...
	@OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lclient!o;IIIII)V", line = 390)
	...
	@OriginalMember(owner = "client!fc", name = "b", descriptor = "(Lclient!o;IIIZ)V", line = 416)
	...
	private int method579(@OriginalArg(0) Class40 arg0) {
		if (arg0.method1184(aClass40_208)) {
			return 16711680;
		} else if (arg0.method1184(aClass40_201)) {
			return 65280;
		} else if (arg0.method1184(aClass40_211)) {
			return 255;
		} else if (arg0.method1184(aClass40_202)) {
			return 16776960;
		} else if (arg0.method1184(aClass40_207)) {
			return 65535;
		} else if (arg0.method1184(aClass40_209)) {
			return 16711935;
		} else if (arg0.method1184(aClass40_217)) {
			return 16777215;
		} else if (arg0.method1184(aClass40_214)) {
			return 0;
		} else if (arg0.method1184(aClass40_212)) {
			return 16748608;
		} else if (arg0.method1184(aClass40_203)) {
			return 8388608;
		} else if (arg0.method1184(aClass40_215)) {
			return 128;
		} else if (arg0.method1184(aClass40_213)) {
			return 16756736;
		} else if (arg0.method1184(aClass40_205)) {
			return 16740352;
		} else if (arg0.method1184(aClass40_206)) {
			return 16723968;
		} else if (arg0.method1184(aClass40_216)) {
			return 12648192;
		} else if (arg0.method1184(aClass40_204)) {
			return 8453888;
		} else if (arg0.method1184(aClass40_210)) {
			return 4259584;
		} else {
			if (arg0.method1184(aClass40_200)) {
