...
public final class Class33_Sub11 extends Class33 {
	...
	@OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(ILclient!cq;)V")
	public Class33_Sub11(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub13 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(Lclient!cq;)V")
	public Class33_Sub11(@OriginalArg(0) Class2_Sub13 arg0) {
		super(arg0);
	}
