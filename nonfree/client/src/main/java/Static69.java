...
public final class Static69 {
	...
	public static MidiPcmStream aClass4_Sub4_Sub1_2;

	@OriginalMember(owner = "client!m", name = "c", descriptor = "Lclient!ec;")
	public static JagString aClass22_508 = Static60.method1113("(U0a )2 via: ");

	@OriginalMember(owner = "client!m", name = "f", descriptor = "[I")
	public static int[] anIntArray190 = new int[] { 0, -1, 0, 1 };

	@OriginalMember(owner = "client!m", name = "j", descriptor = "Lclient!ec;")
	public static JagString aClass22_509 = Static60.method1113("Bitte warten Sie )2 es wird versucht)1 die Verbindung wiederherzustellen)3");

	@OriginalMember(owner = "client!m", name = "l", descriptor = "I")
	public static int anInt1882 = 0;

	@OriginalMember(owner = "client!m", name = "B", descriptor = "Lclient!ec;")
	private static JagString aClass22_511 = Static60.method1113("Prepared visibility map");

	@OriginalMember(owner = "client!m", name = "r", descriptor = "Lclient!ec;")
	public static JagString aClass22_510 = aClass22_511;
	...
	public static void method1170() {
		Static93.aClass82_9 = new LinkList();
	}
	...
	public static void method1172() {
		try {
			if (Static67.aClass9_1 == null) {
				Static67.aClass9_1 = new WorldList(GameShell.aClass17_4, Static44.method856(new JagString[] { Static38.aClass22_270, Static64.aClass22_484, Static119.aClass22_900 }).method487());
			} else {
				@Pc(36) byte[] local36 = Static67.aClass9_1.method155();
				if (local36 != null) {
					@Pc(43) Packet local43 = new Packet(local36);
					Static62.anInt1802 = local43.method718();
					Static79.aClass54Array1 = new WorldEntry[Static62.anInt1802];
					for (@Pc(52) int local52 = 0; local52 < Static62.anInt1802; local52++) {
						@Pc(62) WorldEntry local62 = Static79.aClass54Array1[local52] = new WorldEntry();
