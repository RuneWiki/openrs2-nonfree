...
public final class Class42 {
	...
	public final int[] anIntArray184;
	...
	public Class42(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18) {
		if (arg5 != arg6 || arg5 != arg7 || arg5 != arg8) {
			this.aBoolean79 = false;
		}
		this.anInt1896 = arg0;
		this.anInt1894 = arg1;
		this.anInt1895 = arg17;
		this.anInt1893 = arg18;
		@Pc(30) short local30 = 128;
		@Pc(34) int local34 = local30 / 2;
		@Pc(38) int local38 = local30 / 4;
		@Pc(44) int local44 = local30 * 3 / 4;
		@Pc(48) int[] local48 = Static75.anIntArrayArray15[arg0];
		@Pc(51) int local51 = local48.length;
		this.anIntArray181 = new int[local51];
		this.anIntArray183 = new int[local51];
		this.anIntArray182 = new int[local51];
		...
		for (@Pc(79) int local79 = 0; local79 < local51; local79++) {
			...
			this.anIntArray181[local79] = local140;
			this.anIntArray183[local79] = local144;
			this.anIntArray182[local79] = local142;
			local66[local79] = local146;
			local69[local79] = local148;
		}
		@Pc(534) int[] local534 = Static75.anIntArrayArray14[arg0];
		local140 = local534.length / 4;
		this.anIntArray176 = new int[local140];
		this.anIntArray180 = new int[local140];
		this.anIntArray186 = new int[local140];
		this.anIntArray178 = new int[local140];
		this.anIntArray184 = new int[local140];
		this.anIntArray179 = new int[local140];
		if (arg2 != -1) {
			this.anIntArray185 = new int[local140];
		}
		local142 = 0;
		for (local144 = 0; local144 < local140; local144++) {
			...
			this.anIntArray176[local144] = local148;
			this.anIntArray180[local144] = local591;
			this.anIntArray186[local144] = local597;
			if (local146 == 0) {
				this.anIntArray178[local144] = local66[local148];
				this.anIntArray184[local144] = local66[local591];
				this.anIntArray179[local144] = local66[local597];
				if (this.anIntArray185 != null) {
					this.anIntArray185[local144] = -1;
				}
			} else {
				this.anIntArray178[local144] = local69[local148];
				this.anIntArray184[local144] = local69[local591];
				this.anIntArray179[local144] = local69[local597];
				if (this.anIntArray185 != null) {
					this.anIntArray185[local144] = arg2;
				}
			}
		}
		local146 = arg5;
