...
public final class Class43_Sub25 extends Class43 {

	@OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(Lclient!lha;)V")
	public Class43_Sub25(@OriginalArg(0) Class14_Sub26 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(ILclient!lha;)V")
	public Class43_Sub25(@OriginalArg(0) int arg0, @OriginalArg(1) Class14_Sub26 arg1) {
		super(arg0, arg1);
	}
