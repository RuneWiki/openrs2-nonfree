...
public abstract class Js5Index {
	...
	private boolean method589(@OriginalArg(1) int arg0, @OriginalArg(2) int[] arg1) {
		...
		if (local24 > 1) {
			...
			@Pc(217) Packet local217 = new Packet(local114);
	...
	public final int method592(@OriginalArg(1) JagString arg0) {
		@Pc(12) JagString local12 = arg0.method479();
	...
	protected final void method600(@OriginalArg(0) byte[] arg0) {
		...
		@Pc(19) Packet local19 = new Packet(Static79.method1431(arg0));
	...
	public final boolean method601(@OriginalArg(0) JagString arg0, @OriginalArg(1) JagString arg1) {
		@Pc(3) JagString local3 = arg0.method479();
		@Pc(11) JagString local11 = arg1.method479();
	...
	public final void method603(@OriginalArg(1) JagString arg0) {
		@Pc(7) JagString local7 = arg0.method479();
	...
	public final int method606(@OriginalArg(0) JagString arg0, @OriginalArg(1) int arg1) {
		@Pc(16) JagString local16 = arg0.method479();
	...
	public final byte[] method610(@OriginalArg(0) JagString arg0, @OriginalArg(2) JagString arg1) {
		@Pc(7) JagString local7 = arg0.method479();
		@Pc(11) JagString local11 = arg1.method479();
