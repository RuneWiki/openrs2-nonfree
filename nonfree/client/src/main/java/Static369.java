...
public final class Static369 {
	...
	@OriginalMember(owner = "client!we", name = "a", descriptor = "(II[B[IIIIIIIILclient!we;II)I")
	public static int method5659(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class6_Sub12_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!we", name = "a", descriptor = "(Lclient!hk;III)Lclient!we;")
	public static Class6_Sub12_Sub4 method5661(@OriginalArg(0) Class6_Sub11_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray47 == null || arg0.aByteArray47.length == 0 ? null : new Class6_Sub12_Sub4(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!we", name = "b", descriptor = "(II[B[IIIIIIIILclient!we;II)I")
	public static int method5662(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class6_Sub12_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!we", name = "a", descriptor = "(II[B[IIIIIIILclient!we;II)I")
	public static int method5665(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class6_Sub12_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!we", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!we;II)I")
	public static int method5666(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class6_Sub12_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt6249 -= arg10.anInt6257 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt6249 += arg10.anInt6257 * local63;
		arg10.anInt6250 = arg4;
		arg10.anInt6256 = arg5;
		arg10.anInt6251 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!we", name = "c", descriptor = "(II)I")
	public static int method5667(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!we", name = "b", descriptor = "(II[B[IIIIIIILclient!we;II)I")
	public static int method5668(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class6_Sub12_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!we", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!we;)I")
	public static int method5669(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class6_Sub12_Sub4 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt6249 += arg10.anInt6257 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt6250 = arg4 >> 2;
		arg10.anInt6256 = arg5 >> 2;
		arg10.anInt6251 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!we", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!we;)I")
	public static int method5671(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class6_Sub12_Sub4 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt6249 += arg10.anInt6257 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!we", name = "c", descriptor = "(II[B[IIIIIIIILclient!we;II)I")
	public static int method5676(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class6_Sub12_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt6250 -= arg8.anInt6248 * arg3;
		arg8.anInt6256 -= arg8.anInt6252 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!we", name = "a", descriptor = "([B[IIIIIIILclient!we;)I")
	public static int method5678(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class6_Sub12_Sub4 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt6251 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!we", name = "d", descriptor = "(II[B[IIIIIIIILclient!we;II)I")
	...
	@OriginalMember(owner = "client!we", name = "a", descriptor = "([B[IIIIIIIILclient!we;)I")
	public static int method5681(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class6_Sub12_Sub4 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt6250 += arg8.anInt6248 * (local22 - arg3);
		arg8.anInt6256 += arg8.anInt6252 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt6249 = arg4 >> 2;
		arg8.anInt6251 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!we", name = "a", descriptor = "(I[B[IIIIIIIILclient!we;)I")
	public static int method5684(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class6_Sub12_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!we", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!we;II)I")
	public static int method5687(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class6_Sub12_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt6249 -= arg10.anInt6257 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!we", name = "b", descriptor = "([B[IIIIIIILclient!we;)I")
	public static int method5689(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class6_Sub12_Sub4 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!we", name = "a", descriptor = "(Lclient!hk;II)Lclient!we;")
	public static Class6_Sub12_Sub4 method5691(@OriginalArg(0) Class6_Sub11_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray47 == null || arg0.aByteArray47.length == 0 ? null : new Class6_Sub12_Sub4(arg0, (int) ((long) arg0.anInt2222 * 256L * (long) 100 / (long) (Static22.anInt358 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!we", name = "b", descriptor = "([B[IIIIIIIILclient!we;)I")
	public static int method5692(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class6_Sub12_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt6250 += arg8.anInt6248 * (local24 - arg3);
		arg8.anInt6256 += arg8.anInt6252 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	public static int method5694(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!we", name = "b", descriptor = "(I[B[IIIIIIIILclient!we;)I")
	public static int method5697(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class6_Sub12_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
