...
public final class Class21_Sub16 extends Class21 {
	...
	@OriginalMember(owner = "client!mda", name = "<init>", descriptor = "(ILclient!eha;)V")
	public Class21_Sub16(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub22 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!mda", name = "<init>", descriptor = "(Lclient!eha;)V")
	public Class21_Sub16(@OriginalArg(0) Class3_Sub22 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!mda", name = "d", descriptor = "(II)V")
	@Override
	...
	public void method9235() {
		if (super.anInt10876 < 0 && super.anInt10876 > 127) {
			super.anInt10876 = this.method9239();
		}
	}

	@OriginalMember(owner = "client!mda", name = "c", descriptor = "(II)I")
	@Override
