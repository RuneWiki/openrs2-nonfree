...
public final class Class2_Sub11 extends Class2 {
	...
	private float[] method1402(@OriginalArg(0) int arg0) {
		Static73.method1412(this.aByteArrayArray4[arg0]);
		Static73.method1406();
		@Pc(15) int local15 = Static73.method1408(Static129.method2201(Static73.anIntArray324.length - 1));
		@Pc(19) boolean local19 = Static73.aBooleanArray8[local15];
		@Pc(25) int local25 = local19 ? Static73.anInt1962 : Static73.anInt1963;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static73.method1406() != 0;
			local29 = Static73.method1406() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static73.anInt1963 >> 2);
			local67 = (local25 >> 2) + (Static73.anInt1963 >> 2);
			local71 = Static73.anInt1963 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static73.anInt1963 >> 2);
			local104 = local25 + (Static73.anInt1963 >> 2) - (local25 >> 2);
			local108 = Static73.anInt1963 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class83 local123 = Static73.aClass83Array1[Static73.anIntArray324[local15]];
		@Pc(126) int local126 = local123.anInt4011;
		@Pc(131) int local131 = local123.anIntArray579[local126];
		@Pc(140) boolean local140 = !Static73.aClass38Array1[local131].method1347();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt4012; local144++) {
			@Pc(152) Class71 local152 = Static73.aClass71Array1[local123.anIntArray578[local144]];
			local154 = Static73.aFloatArray6;
			local152.method2316(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt4011;
			local176 = local123.anIntArray579[local171];
			Static73.aClass38Array1[local176].method1352(Static73.aFloatArray6, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static73.aFloatArray6[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static73.aFloatArray6;
			...
			@Pc(252) float[] local252 = local19 ? Static73.aFloatArray8 : Static73.aFloatArray2;
			@Pc(258) float[] local258 = local19 ? Static73.aFloatArray4 : Static73.aFloatArray5;
			@Pc(264) float[] local264 = local19 ? Static73.aFloatArray9 : Static73.aFloatArray3;
			@Pc(270) int[] local270 = local19 ? Static73.anIntArray325 : Static73.anIntArray326;
			...
			@Pc(486) int local486 = Static129.method2201(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static73.aFloatArray6[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static73.aFloatArray6[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt1959 > 0) {
			local176 = this.anInt1959 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean87) {
				for (local212 = 0; local212 < this.anInt1954; local212++) {
					local1254 = (this.anInt1959 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static73.aFloatArray6[local212];
				}
			}
		}
		local154 = this.aFloatArray7;
		this.aFloatArray7 = Static73.aFloatArray6;
		Static73.aFloatArray6 = local154;
		this.anInt1959 = local25;
		this.anInt1954 = local104 - (local25 >> 1);
		this.aBoolean87 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!jc", name = "a", descriptor = "([B)V")
	private void method1403(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub18 local4 = new Class2_Sub18(arg0);
		this.anInt1955 = local4.method2382();
		this.anInt1957 = local4.method2382();
		this.anInt1958 = local4.method2382();
		this.anInt1960 = local4.method2382();
		if (this.anInt1960 < 0) {
			this.anInt1960 = ~this.anInt1960;
			this.aBoolean86 = true;
		}
		@Pc(40) int local40 = local4.method2382();
		this.aByteArrayArray4 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method2387();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method2354(local49, local64);
			this.aByteArrayArray4[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!jc", name = "a", descriptor = "([I)Lclient!jb;")
	public Class2_Sub5_Sub1 method1404(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray30 == null) {
			this.anInt1959 = 0;
			this.aFloatArray7 = new float[Static73.anInt1962];
			this.aByteArray30 = new byte[this.anInt1957];
			this.anInt1965 = 0;
			this.anInt1964 = 0;
		}
		while (this.anInt1964 < this.aByteArrayArray4.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1402(this.anInt1964);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt1965;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt1957 - local47) {
					local50 = this.anInt1957 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt1965;
				}
				this.anInt1965 = local47;
			}
			this.anInt1964++;
		}
		...
		return new Class2_Sub5_Sub1(this.anInt1955, local129, this.anInt1958, this.anInt1960, this.aBoolean86);
	}
}
