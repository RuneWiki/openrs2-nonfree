...
public final class Class7 {
	...
	private int anInt482 = 100;

	@OriginalMember(owner = "client!dc", name = "q", descriptor = "I")
	public int anInt483 = 500;
	...
	public int[] method244(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		this.aClass2_1.method44(447);
		this.aClass2_2.method44(447);
		@Pc(36) int local36 = 0;
		@Pc(38) int local38 = 0;
		@Pc(40) int local40 = 0;
		if (this.aClass2_3 != null) {
			this.aClass2_3.method44(447);
			this.aClass2_4.method44(447);
			local36 = (int) ((double) (this.aClass2_3.anInt144 - this.aClass2_3.anInt143) * 32.768D / local26);
			local38 = (int) ((double) this.aClass2_3.anInt143 * 32.768D / local26);
		}
		@Pc(77) int local77 = 0;
		@Pc(79) int local79 = 0;
		@Pc(81) int local81 = 0;
		if (this.aClass2_5 != null) {
			this.aClass2_5.method44(447);
			this.aClass2_6.method44(447);
			local77 = (int) ((double) (this.aClass2_5.anInt144 - this.aClass2_5.anInt143) * 32.768D / local26);
			local79 = (int) ((double) this.aClass2_5.anInt143 * 32.768D / local26);
		}
		for (@Pc(118) int local118 = 0; local118 < 5; local118++) {
			if (this.anIntArray103[local118] != 0) {
				...
				anIntArray112[local118] = (int) ((double) (this.aClass2_1.anInt144 - this.aClass2_1.anInt143) * 32.768D * Math.pow(1.0057929410678534D, (double) this.anIntArray104[local118]) / local26);
				anIntArray113[local118] = (int) ((double) this.aClass2_1.anInt143 * 32.768D / local26);
			}
		}
		@Pc(201) int local201;
		@Pc(207) int local207;
		...
		for (@Pc(193) int local193 = 0; local193 < arg0; local193++) {
			...
			if (this.aClass2_3 != null) {
				...
				local201 += this.method245((byte) 4, this.aClass2_3.anInt145, local222, local40) >> 1;
				local40 += (local216 * local36 >> 16) + local38;
			}
			if (this.aClass2_5 != null) {
				local216 = this.aClass2_5.method45(arg0);
				local222 = this.aClass2_6.method45(arg0);
				local207 = local207 * ((this.method245((byte) 4, this.aClass2_5.anInt145, local222, local81) >> 1) + 32768) >> 15;
			...
			for (local216 = 0; local216 < 5; local216++) {
				if (this.anIntArray103[local216] != 0) {
					...
					if (local222 < arg0) {
						anIntArray106[local222] += this.method245((byte) 4, this.aClass2_1.anInt145, local207 * anIntArray111[local216] >> 15, anIntArray109[local216]);
		...
		if (this.aClass2_7 != null) {
			this.aClass2_7.method44(447);
			this.aClass2_8.method44(447);
			local201 = 0;
			...
			for (local222 = 0; local222 < arg0; local222++) {
				...
				if (local369) {
					local207 = this.aClass2_7.anInt143 + ((this.aClass2_7.anInt144 - this.aClass2_7.anInt143) * local379 >> 8);
				} else {
					local207 = this.aClass2_7.anInt143 + ((this.aClass2_7.anInt144 - this.aClass2_7.anInt143) * local385 >> 8);
				}
				local201 += 256;
		...
		if (this.anInt481 > 0 && this.anInt482 > 0) {
			local201 = (int) ((double) this.anInt481 * local26);
			for (local207 = local201; local207 < arg0; local207++) {
				anIntArray106[local207] += anIntArray106[local207 - local201] * this.anInt482 / 100;
			}
		}
		if (this.aClass3_1.anIntArray18[0] > 0 || this.aClass3_1.anIntArray18[1] > 0) {
			this.aClass2_9.method44(447);
	...
	private int method245(@OriginalArg(0) byte arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			...
			signlink.reporterror("66727, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + local70.toString());
	...
	public void method246(@OriginalArg(0) Class1_Sub1_Sub3 arg0) {
		try {
			...
			this.anInt481 = arg0.method494();
			this.anInt482 = arg0.method494();
			this.anInt483 = arg0.method482();
			this.anInt484 = arg0.method482();
			...
			signlink.reporterror("48078, " + arg0 + ", " + false + ", " + local195.toString());
			throw new RuntimeException();
		}
	}
}
