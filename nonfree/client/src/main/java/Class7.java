...
public final class Class7 {
	...
	private int anInt479 = 100;

	@OriginalMember(owner = "client!dc", name = "p", descriptor = "I")
	public int anInt480 = 500;
	...
	public int[] method244(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (this.aClass2_3 != null) {
			...
			local36 = (int) ((double) (this.aClass2_3.anInt153 - this.aClass2_3.anInt152) * 32.768D / local26);
			local38 = (int) ((double) this.aClass2_3.anInt152 * 32.768D / local26);
		}
		@Pc(77) int local77 = 0;
		@Pc(79) int local79 = 0;
		@Pc(81) int local81 = 0;
		if (this.aClass2_5 != null) {
			...
			local77 = (int) ((double) (this.aClass2_5.anInt153 - this.aClass2_5.anInt152) * 32.768D / local26);
			local79 = (int) ((double) this.aClass2_5.anInt152 * 32.768D / local26);
		}
		for (@Pc(118) int local118 = 0; local118 < 5; local118++) {
			if (this.anIntArray103[local118] != 0) {
				...
				anIntArray112[local118] = (int) ((double) (this.aClass2_1.anInt153 - this.aClass2_1.anInt152) * 32.768D * Math.pow(1.0057929410678534D, (double) this.anIntArray104[local118]) / local26);
				anIntArray113[local118] = (int) ((double) this.aClass2_1.anInt152 * 32.768D / local26);
			}
		}
		@Pc(201) int local201;
		@Pc(207) int local207;
		...
		for (@Pc(193) int local193 = 0; local193 < arg0; local193++) {
			...
			if (this.aClass2_3 != null) {
				...
				local201 += this.method245(this.aClass2_3.anInt154, local40, local222) >> 1;
				local40 += (local216 * local36 >> 16) + local38;
			}
			if (this.aClass2_5 != null) {
				local216 = this.aClass2_5.method45(arg0);
				local222 = this.aClass2_6.method45(arg0);
				local207 = local207 * ((this.method245(this.aClass2_5.anInt154, local81, local222) >> 1) + 32768) >> 15;
			...
			for (local216 = 0; local216 < 5; local216++) {
				if (this.anIntArray103[local216] != 0) {
					...
					if (local222 < arg0) {
						anIntArray106[local222] += this.method245(this.aClass2_1.anInt154, anIntArray109[local216], local207 * anIntArray111[local216] >> 15);
		...
		if (this.aClass2_7 != null) {
			...
			for (local222 = 0; local222 < arg0; local222++) {
				...
				if (local369) {
					local207 = this.aClass2_7.anInt152 + ((this.aClass2_7.anInt153 - this.aClass2_7.anInt152) * local379 >> 8);
				} else {
					local207 = this.aClass2_7.anInt152 + ((this.aClass2_7.anInt153 - this.aClass2_7.anInt152) * local385 >> 8);
				}
				local201 += 256;
		...
		if (this.anInt478 > 0 && this.anInt479 > 0) {
			local201 = (int) ((double) this.anInt478 * local26);
			for (local207 = local201; local207 < arg0; local207++) {
				anIntArray106[local207] += anIntArray106[local207 - local201] * this.anInt479 / 100;
			}
		}
		if (this.aClass3_1.anIntArray18[0] > 0 || this.aClass3_1.anIntArray18[1] > 0) {
			...
			if (arg0 >= local207 + local216) {
				...
				while (local222 < local379) {
					local385 = (int) ((long) anIntArray106[local222 + local207] * (long) Class3.anInt177 >> 16);
				...
				while (true) {
					...
					@Pc(694) int local694;
					while (local222 < local379) {
						local559 = (int) ((long) anIntArray106[local222 + local207] * (long) Class3.anInt177 >> 16);
	...
	private int method245(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
		try {
			...
			signlink.reporterror("16814, " + arg0 + ", " + arg1 + ", " + false + ", " + arg2 + ", " + local63.toString());
	...
	public void method246(@OriginalArg(1) Class1_Sub1_Sub3 arg0) {
		try {
			...
			@Pc(34) int local34 = arg0.method480();
			if (local34 != 0) {
				arg0.anInt751--;
			...
			for (@Pc(126) int local126 = 0; local126 < 10; local126++) {
				@Pc(137) int local137 = arg0.method494();
				if (local137 == 0) {
					break;
				}
				this.anIntArray103[local126] = local137;
				this.anIntArray104[local126] = arg0.method493();
				this.anIntArray105[local126] = arg0.method494();
			}
			this.anInt478 = arg0.method494();
			this.anInt479 = arg0.method494();
			this.anInt480 = arg0.method482();
			this.anInt481 = arg0.method482();
			this.aClass3_1 = new Class3();
			this.aClass2_9 = new Class2();
			this.aClass3_1.method55(this.aClass2_9, arg0);
		} catch (@Pc(195) RuntimeException local195) {
			signlink.reporterror("34766, " + 8 + ", " + arg0 + ", " + local195.toString());
			throw new RuntimeException();
		}
	}
}
