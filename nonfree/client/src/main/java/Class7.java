...
public final class Class7 {
	...
	private int anInt491 = 100;

	@OriginalMember(owner = "client!dc", name = "n", descriptor = "I")
	public int anInt492 = 500;
	...
	public int[] method241(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (this.aClass3_3 != null) {
			...
			local36 = (int) ((double) (this.aClass3_3.anInt192 - this.aClass3_3.anInt191) * 32.768D / local26);
			local38 = (int) ((double) this.aClass3_3.anInt191 * 32.768D / local26);
		}
		@Pc(77) int local77 = 0;
		@Pc(79) int local79 = 0;
		@Pc(81) int local81 = 0;
		if (this.aClass3_5 != null) {
			...
			local77 = (int) ((double) (this.aClass3_5.anInt192 - this.aClass3_5.anInt191) * 32.768D / local26);
			local79 = (int) ((double) this.aClass3_5.anInt191 * 32.768D / local26);
		}
		for (@Pc(118) int local118 = 0; local118 < 5; local118++) {
			if (this.anIntArray105[local118] != 0) {
				...
				anIntArray114[local118] = (int) ((double) (this.aClass3_1.anInt192 - this.aClass3_1.anInt191) * 32.768D * Math.pow(1.0057929410678534D, (double) this.anIntArray106[local118]) / local26);
				anIntArray115[local118] = (int) ((double) this.aClass3_1.anInt191 * 32.768D / local26);
			}
		}
		@Pc(201) int local201;
		@Pc(207) int local207;
		...
		for (@Pc(193) int local193 = 0; local193 < arg0; local193++) {
			...
			if (this.aClass3_3 != null) {
				...
				local201 += this.method242(local40, this.aClass3_3.anInt193, local222) >> 1;
				local40 += (local216 * local36 >> 16) + local38;
			}
			if (this.aClass3_5 != null) {
				local216 = this.aClass3_5.method56(arg0);
				local222 = this.aClass3_6.method56(arg0);
				local207 = local207 * ((this.method242(local81, this.aClass3_5.anInt193, local222) >> 1) + 32768) >> 15;
			...
			for (local216 = 0; local216 < 5; local216++) {
				if (this.anIntArray105[local216] != 0) {
					...
					if (local222 < arg0) {
						anIntArray108[local222] += this.method242(anIntArray111[local216], this.aClass3_1.anInt193, local207 * anIntArray113[local216] >> 15);
		...
		if (this.aClass3_7 != null) {
			...
			for (local222 = 0; local222 < arg0; local222++) {
				...
				if (local369) {
					local207 = this.aClass3_7.anInt191 + ((this.aClass3_7.anInt192 - this.aClass3_7.anInt191) * local379 >> 8);
				} else {
					local207 = this.aClass3_7.anInt191 + ((this.aClass3_7.anInt192 - this.aClass3_7.anInt191) * local385 >> 8);
				}
				local201 += 256;
		...
		if (this.anInt490 > 0 && this.anInt491 > 0) {
			local201 = (int) ((double) this.anInt490 * local26);
			for (local207 = local201; local207 < arg0; local207++) {
				anIntArray108[local207] += anIntArray108[local207 - local201] * this.anInt491 / 100;
			}
		}
	...
	private int method242(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		try {
			if (arg1 == 1) {
				...
				return anIntArray110[arg0 & 0x7FFF] * arg2 >> 14;
			} else if (arg1 == 3) {
				return ((arg0 & 0x7FFF) * arg2 >> 14) - arg2;
			} else if (arg1 == 4) {
				return anIntArray109[arg0 / 2607 & 0x7FFF] * arg2;
			} else {
				return 0;
			}
		} catch (@Pc(67) RuntimeException local67) {
			signlink.reporterror("19768, " + arg0 + ", " + 3 + ", " + arg1 + ", " + arg2 + ", " + local67.toString());
	...
	public void method243(@OriginalArg(1) Class1_Sub1_Sub3 arg0) {
		try {
			...
			for (@Pc(131) int local131 = 0; local131 < 10; local131++) {
				@Pc(136) int local136 = arg0.method512();
				if (local136 == 0) {
					break;
				}
				this.anIntArray105[local131] = local136;
				this.anIntArray106[local131] = arg0.method511();
				this.anIntArray107[local131] = arg0.method512();
			}
			this.anInt490 = arg0.method512();
			this.anInt491 = arg0.method512();
			this.anInt492 = arg0.method500();
			this.anInt493 = arg0.method500();
		} catch (@Pc(177) RuntimeException local177) {
			signlink.reporterror("8660, " + 891 + ", " + arg0 + ", " + local177.toString());
			throw new RuntimeException();
		}
	}
}
