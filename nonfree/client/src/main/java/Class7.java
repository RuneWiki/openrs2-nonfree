	...
	public int[] method243(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(118) int local118 = 0; local118 < 5; local118++) {
			if (this.anIntArray102[local118] != 0) {
				...
				anIntArray111[local118] = (int) ((double) (this.aClass2_1.anInt146 - this.aClass2_1.anInt145) * 32.768D * Math.pow(1.0057929410678534D, (double) this.anIntArray103[local118]) / local26);
				anIntArray112[local118] = (int) ((double) this.aClass2_1.anInt145 * 32.768D / local26);
			}
		}
		@Pc(201) int local201;
		@Pc(207) int local207;
		...
		for (@Pc(193) int local193 = 0; local193 < arg0; local193++) {
			...
			if (this.aClass2_3 != null) {
				...
				local201 += this.method244(this.aClass2_3.anInt147, local40, local222) >> 1;
				local40 += (local216 * local36 >> 16) + local38;
			}
			if (this.aClass2_5 != null) {
				local216 = this.aClass2_5.method45(arg0);
				local222 = this.aClass2_6.method45(arg0);
				local207 = local207 * ((this.method244(this.aClass2_5.anInt147, local81, local222) >> 1) + 32768) >> 15;
			...
			for (local216 = 0; local216 < 5; local216++) {
				if (this.anIntArray102[local216] != 0) {
					...
					if (local222 < arg0) {
						anIntArray105[local222] += this.method244(this.aClass2_1.anInt147, anIntArray108[local216], local207 * anIntArray110[local216] >> 15);
		...
		if (this.anInt468 > 0 && this.anInt469 > 0) {
			local201 = (int) ((double) this.anInt468 * local26);
			for (local207 = local201; local207 < arg0; local207++) {
				anIntArray105[local207] += anIntArray105[local207 - local201] * this.anInt469 / 100;
			}
		}
		if (this.aClass3_1.anIntArray17[0] > 0 || this.aClass3_1.anIntArray17[1] > 0) {
			...
			local207 = this.aClass3_1.method53(0, (float) local201 / 65536.0F, (byte) 1);
			local216 = this.aClass3_1.method53(1, (float) local201 / 65536.0F, (byte) 1);
			if (arg0 >= local207 + local216) {
				...
				while (local222 < local379) {
					local385 = (int) ((long) anIntArray105[local222 + local207] * (long) Class3.anInt168 >> 16);
				...
				while (true) {
					...
					@Pc(694) int local694;
					while (local222 < local379) {
						local559 = (int) ((long) anIntArray105[local222 + local207] * (long) Class3.anInt168 >> 16);
	...
	private int method244(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		try {
			if (arg0 == 1) {
				...
				return anIntArray107[arg1 & 0x7FFF] * arg2 >> 14;
			} else if (arg0 == 3) {
				return ((arg1 & 0x7FFF) * arg2 >> 14) - arg2;
			} else if (arg0 == 4) {
				return anIntArray106[arg1 / 2607 & 0x7FFF] * arg2;
			} else {
				return 0;
			}
		} catch (@Pc(61) RuntimeException local61) {
			signlink.reporterror("122, " + -339 + ", " + arg0 + ", " + arg1 + ", " + arg2 + ", " + local61.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!dc", name = "a", descriptor = "(BLclient!lb;)V")
	public void method245(@OriginalArg(1) Class1_Sub1_Sub3 arg0) {
		try {
			this.aClass2_1 = new Class2();
			this.aClass2_1.method42((byte) 2, arg0);
			this.aClass2_2 = new Class2();
			this.aClass2_2.method42((byte) 2, arg0);
			@Pc(24) int local24 = arg0.method473();
			if (local24 != 0) {
				arg0.anInt743--;
				this.aClass2_3 = new Class2();
				this.aClass2_3.method42((byte) 2, arg0);
				this.aClass2_4 = new Class2();
				this.aClass2_4.method42((byte) 2, arg0);
			}
			local24 = arg0.method473();
			if (local24 != 0) {
				arg0.anInt743--;
				this.aClass2_5 = new Class2();
				this.aClass2_5.method42((byte) 2, arg0);
				this.aClass2_6 = new Class2();
				this.aClass2_6.method42((byte) 2, arg0);
			}
			local24 = arg0.method473();
			if (local24 != 0) {
				arg0.anInt743--;
				this.aClass2_7 = new Class2();
				this.aClass2_7.method42((byte) 2, arg0);
				this.aClass2_8 = new Class2();
				this.aClass2_8.method42((byte) 2, arg0);
			}
			for (@Pc(116) int local116 = 0; local116 < 10; local116++) {
				@Pc(127) int local127 = arg0.method487();
				if (local127 == 0) {
					break;
				}
				this.anIntArray102[local116] = local127;
				this.anIntArray103[local116] = arg0.method486();
				this.anIntArray104[local116] = arg0.method487();
			}
			this.anInt468 = arg0.method487();
			this.anInt469 = arg0.method487();
			this.anInt470 = arg0.method475();
			this.anInt471 = arg0.method475();
			this.aClass3_1 = new Class3();
			this.aClass2_9 = new Class2();
			this.aClass3_1.method54(arg0, this.aByte21, this.aClass2_9);
		} catch (@Pc(193) RuntimeException local193) {
			signlink.reporterror("19224, " + 2 + ", " + arg0 + ", " + local193.toString());
			throw new RuntimeException();
		}
	}
}
