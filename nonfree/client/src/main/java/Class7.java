...
public final class Class7 implements Runnable {
	...
	@OriginalMember(owner = "client!bb", name = "a", descriptor = "(B)Lclient!c;")
	public Interface1 method198() {
		return this.anInterface1_1;
	}

	@OriginalMember(owner = "client!bb", name = "a", descriptor = "(ZI)Lclient!qd;")
	public Class48 method199(@OriginalArg(1) int arg0) {
		return this.method200(arg0, 3, null);
	}

	@OriginalMember(owner = "client!bb", name = "a", descriptor = "(IBILjava/lang/Object;I)Lclient!qd;")
	...
	@OriginalMember(owner = "client!bb", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;I)Lclient!qd;")
	...
	@OriginalMember(owner = "client!bb", name = "a", descriptor = "(BI)Lclient!qd;")
	...
	@OriginalMember(owner = "client!bb", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/Class;)Lclient!qd;")
	...
	@OriginalMember(owner = "client!bb", name = "b", descriptor = "(B)Lclient!id;")
	public Interface3 method205() {
		return this.anInterface3_1;
	}

	@OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILjava/lang/String;B)V")
	...
	@OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILjava/lang/Runnable;B)Lclient!qd;")
	...
	@OriginalMember(owner = "client!bb", name = "a", descriptor = "(BLjava/net/URL;)Lclient!qd;")
