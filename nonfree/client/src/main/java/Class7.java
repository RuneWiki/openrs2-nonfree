...
public final class Class7 {
	...
	public int[] method241(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		for (@Pc(118) int local118 = 0; local118 < 5; local118++) {
			if (this.anIntArray105[local118] != 0) {
				...
				anIntArray114[local118] = (int) ((double) (this.aClass3_1.anInt194 - this.aClass3_1.anInt193) * 32.768D * Math.pow(1.0057929410678534D, (double) this.anIntArray106[local118]) / local26);
				anIntArray115[local118] = (int) ((double) this.aClass3_1.anInt193 * 32.768D / local26);
			}
		}
		@Pc(201) int local201;
		@Pc(207) int local207;
		...
		for (@Pc(193) int local193 = 0; local193 < arg0; local193++) {
			...
			if (this.aClass3_3 != null) {
				...
				local201 += this.method242(local40, local222, this.aClass3_3.anInt195) >> 1;
				local40 += (local216 * local36 >> 16) + local38;
			}
			if (this.aClass3_5 != null) {
				local216 = this.aClass3_5.method56(arg0);
				local222 = this.aClass3_6.method56(arg0);
				local207 = local207 * ((this.method242(local81, local222, this.aClass3_5.anInt195) >> 1) + 32768) >> 15;
			...
			for (local216 = 0; local216 < 5; local216++) {
				if (this.anIntArray105[local216] != 0) {
					...
					if (local222 < arg0) {
						anIntArray108[local222] += this.method242(anIntArray111[local216], local207 * anIntArray113[local216] >> 15, this.aClass3_1.anInt195);
		...
		if (this.anInt485 > 0 && this.anInt486 > 0) {
			...
			for (local207 = local201; local207 < arg0; local207++) {
				anIntArray108[local207] += anIntArray108[local207 - local201] * this.anInt486 / 100;
			}
		}
	...
	private int method242(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
		try {
			if (arg2 == 1) {
				return (arg0 & 0x7FFF) < 16384 ? arg1 : -arg1;
			} else if (arg2 == 2) {
				return anIntArray110[arg0 & 0x7FFF] * arg1 >> 14;
			} else if (arg2 == 3) {
			...
			signlink.reporterror("45252, " + arg0 + ", " + arg1 + ", " + 52 + ", " + arg2 + ", " + local64.toString());
	...
	public void method243(@OriginalArg(1) Class1_Sub1_Sub3 arg0) {
		try {
			...
			this.anInt485 = arg0.method512();
			this.anInt486 = arg0.method512();
			this.anInt487 = arg0.method500();
			this.anInt488 = arg0.method500();
		} catch (@Pc(173) RuntimeException local173) {
			signlink.reporterror("62456, " + 0 + ", " + arg0 + ", " + local173.toString());
			throw new RuntimeException();
		}
	}
}
