...
public final class Class7 {
		...
		if (this.aClass3_1.anIntArray18[0] > 0 || this.aClass3_1.anIntArray18[1] > 0) {
			...
			if (arg0 >= local207 + local216) {
				...
				while (local222 < local379) {
					local385 = (int) ((long) anIntArray106[local222 + local207] * (long) Class3.anInt169 >> 16);
				...
				while (true) {
					...
					@Pc(694) int local694;
					while (local222 < local379) {
						local559 = (int) ((long) anIntArray106[local222 + local207] * (long) Class3.anInt169 >> 16);
	...
	private int method245(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		try {
			if (arg0 == 1) {
			...
			signlink.reporterror("25434, " + arg0 + ", " + -377 + ", " + arg1 + ", " + arg2 + ", " + local61.toString());
	...
	public void method246(@OriginalArg(0) Class1_Sub1_Sub3 arg0) {
		try {
			...
			signlink.reporterror("84688, " + arg0 + ", " + 8 + ", " + local191.toString());
			throw new RuntimeException();
		}
	}
}
