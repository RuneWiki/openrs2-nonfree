...
public final class Class7 {
	...
	private int anInt477 = 100;

	@OriginalMember(owner = "client!dc", name = "r", descriptor = "I")
	public int anInt478 = 500;
	...
	public int[] method244(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		this.aClass2_1.method44(aByte14);
		this.aClass2_2.method44(aByte14);
		@Pc(36) int local36 = 0;
		@Pc(38) int local38 = 0;
		@Pc(40) int local40 = 0;
		if (this.aClass2_3 != null) {
			this.aClass2_3.method44(aByte14);
			this.aClass2_4.method44(aByte14);
			local36 = (int) ((double) (this.aClass2_3.anInt146 - this.aClass2_3.anInt145) * 32.768D / local26);
			local38 = (int) ((double) this.aClass2_3.anInt145 * 32.768D / local26);
		}
		@Pc(77) int local77 = 0;
		@Pc(79) int local79 = 0;
		@Pc(81) int local81 = 0;
		if (this.aClass2_5 != null) {
			this.aClass2_5.method44(aByte14);
			this.aClass2_6.method44(aByte14);
			local77 = (int) ((double) (this.aClass2_5.anInt146 - this.aClass2_5.anInt145) * 32.768D / local26);
			local79 = (int) ((double) this.aClass2_5.anInt145 * 32.768D / local26);
		}
		for (@Pc(118) int local118 = 0; local118 < 5; local118++) {
			if (this.anIntArray103[local118] != 0) {
				...
				anIntArray112[local118] = (int) ((double) (this.aClass2_1.anInt146 - this.aClass2_1.anInt145) * 32.768D * Math.pow(1.0057929410678534D, (double) this.anIntArray104[local118]) / local26);
				anIntArray113[local118] = (int) ((double) this.aClass2_1.anInt145 * 32.768D / local26);
			}
		}
		@Pc(201) int local201;
		@Pc(207) int local207;
		...
		for (@Pc(193) int local193 = 0; local193 < arg0; local193++) {
			local201 = this.aClass2_1.method45(arg0, 309);
			local207 = this.aClass2_2.method45(arg0, 309);
			if (this.aClass2_3 != null) {
				local216 = this.aClass2_3.method45(arg0, 309);
				local222 = this.aClass2_4.method45(arg0, 309);
				local201 += this.method245(this.aClass2_3.anInt147, local40, local222) >> 1;
				local40 += (local216 * local36 >> 16) + local38;
			}
			if (this.aClass2_5 != null) {
				local216 = this.aClass2_5.method45(arg0, 309);
				local222 = this.aClass2_6.method45(arg0, 309);
				local207 = local207 * ((this.method245(this.aClass2_5.anInt147, local81, local222) >> 1) + 32768) >> 15;
			...
			for (local216 = 0; local216 < 5; local216++) {
				if (this.anIntArray103[local216] != 0) {
					...
					if (local222 < arg0) {
						anIntArray106[local222] += this.method245(this.aClass2_1.anInt147, anIntArray109[local216], local207 * anIntArray111[local216] >> 15);
		...
		if (this.aClass2_7 != null) {
			this.aClass2_7.method44(aByte14);
			this.aClass2_8.method44(aByte14);
			local201 = 0;
			@Pc(369) boolean local369 = true;
			for (local222 = 0; local222 < arg0; local222++) {
				local379 = this.aClass2_7.method45(arg0, 309);
				local385 = this.aClass2_8.method45(arg0, 309);
				if (local369) {
					local207 = this.aClass2_7.anInt145 + ((this.aClass2_7.anInt146 - this.aClass2_7.anInt145) * local379 >> 8);
				} else {
					local207 = this.aClass2_7.anInt145 + ((this.aClass2_7.anInt146 - this.aClass2_7.anInt145) * local385 >> 8);
				}
				local201 += 256;
		...
		if (this.anInt476 > 0 && this.anInt477 > 0) {
			local201 = (int) ((double) this.anInt476 * local26);
			for (local207 = local201; local207 < arg0; local207++) {
				anIntArray106[local207] += anIntArray106[local207 - local201] * this.anInt477 / 100;
			}
		}
		if (this.aClass3_1.anIntArray18[0] > 0 || this.aClass3_1.anIntArray18[1] > 0) {
			this.aClass2_9.method44(aByte14);
			local201 = this.aClass2_9.method45(arg0 + 1, 309);
			...
			if (arg0 >= local207 + local216) {
				...
				while (local222 < local379) {
					local385 = (int) ((long) anIntArray106[local222 + local207] * (long) Class3.anInt168 >> 16);
				...
				while (true) {
					...
					@Pc(694) int local694;
					while (local222 < local379) {
						local559 = (int) ((long) anIntArray106[local222 + local207] * (long) Class3.anInt168 >> 16);
					...
					if (local222 >= arg0 - local207) {
						while (local222 < arg0) {
							...
							anIntArray106[local222] = local559;
							this.aClass2_9.method45(arg0 + 1, 309);
							local222++;
						}
						break;
					}
	...
	private int method245(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		try {
			if (arg0 == 1) {
			...
			signlink.reporterror("85309, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + false + ", " + local59.toString());
	...
	public void method246(@OriginalArg(0) Class1_Sub1_Sub3 arg0) {
		try {
			...
			this.aClass2_1.method42(arg0, 913);
			this.aClass2_2 = new Class2();
			this.aClass2_2.method42(arg0, 913);
			@Pc(24) int local24 = arg0.method480();
			if (local24 != 0) {
				arg0.anInt742--;
				this.aClass2_3 = new Class2();
				this.aClass2_3.method42(arg0, 913);
				this.aClass2_4 = new Class2();
				this.aClass2_4.method42(arg0, 913);
			}
			local24 = arg0.method480();
			if (local24 != 0) {
				arg0.anInt742--;
				this.aClass2_5 = new Class2();
				this.aClass2_5.method42(arg0, 913);
				this.aClass2_6 = new Class2();
				this.aClass2_6.method42(arg0, 913);
			}
			local24 = arg0.method480();
			if (local24 != 0) {
				arg0.anInt742--;
				this.aClass2_7 = new Class2();
				this.aClass2_7.method42(arg0, 913);
				this.aClass2_8 = new Class2();
				this.aClass2_8.method42(arg0, 913);
			}
			...
			this.anInt476 = arg0.method494();
			this.anInt477 = arg0.method494();
			this.anInt478 = arg0.method482();
			this.anInt479 = arg0.method482();
			...
			signlink.reporterror("15852, " + arg0 + ", " + 913 + ", " + local190.toString());
			throw new RuntimeException();
		}
	}
}
