...
public final class Class7 {
	...
	@OriginalMember(owner = "client!dc", name = "k", descriptor = "Lclient!ac;")
	private Class2 aClass2_8;

	@OriginalMember(owner = "client!dc", name = "o", descriptor = "I")
	private int anInt464;

	@OriginalMember(owner = "client!dc", name = "q", descriptor = "Lclient!bc;")
	private Class3 aClass3_1;

	@OriginalMember(owner = "client!dc", name = "r", descriptor = "Lclient!ac;")
	...
	@OriginalMember(owner = "client!dc", name = "b", descriptor = "I")
	private int anInt462 = 188;

	@OriginalMember(owner = "client!dc", name = "c", descriptor = "I")
	private int anInt463 = 810;
	...
	public int[] method243(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (this.aClass2_3 != null) {
			...
			local36 = (int) ((double) (this.aClass2_3.anInt140 - this.aClass2_3.anInt139) * 32.768D / local26);
			local38 = (int) ((double) this.aClass2_3.anInt139 * 32.768D / local26);
		}
		@Pc(77) int local77 = 0;
		@Pc(79) int local79 = 0;
		@Pc(81) int local81 = 0;
		if (this.aClass2_5 != null) {
			...
			local77 = (int) ((double) (this.aClass2_5.anInt140 - this.aClass2_5.anInt139) * 32.768D / local26);
			local79 = (int) ((double) this.aClass2_5.anInt139 * 32.768D / local26);
		}
		for (@Pc(118) int local118 = 0; local118 < 5; local118++) {
			if (this.anIntArray103[local118] != 0) {
				...
				anIntArray112[local118] = (int) ((double) (this.aClass2_1.anInt140 - this.aClass2_1.anInt139) * 32.768D * Math.pow(1.0057929410678534D, (double) this.anIntArray104[local118]) / local26);
				anIntArray113[local118] = (int) ((double) this.aClass2_1.anInt139 * 32.768D / local26);
			}
		}
		@Pc(201) int local201;
		@Pc(207) int local207;
		...
		for (@Pc(193) int local193 = 0; local193 < arg0; local193++) {
			...
			if (this.aClass2_3 != null) {
				...
				local201 += this.method244(local222, local40, this.aClass2_3.anInt141) >> 1;
				local40 += (local216 * local36 >> 16) + local38;
			}
			if (this.aClass2_5 != null) {
				local216 = this.aClass2_5.method45(arg0);
				local222 = this.aClass2_6.method45(arg0);
				local207 = local207 * ((this.method244(local222, local81, this.aClass2_5.anInt141) >> 1) + 32768) >> 15;
			...
			for (local216 = 0; local216 < 5; local216++) {
				if (this.anIntArray103[local216] != 0) {
					...
					if (local222 < arg0) {
						anIntArray106[local222] += this.method244(local207 * anIntArray111[local216] >> 15, anIntArray109[local216], this.aClass2_1.anInt141);
		...
		if (this.aClass2_7 != null) {
			...
			for (local222 = 0; local222 < arg0; local222++) {
				...
				if (local369) {
					local207 = this.aClass2_7.anInt139 + ((this.aClass2_7.anInt140 - this.aClass2_7.anInt139) * local379 >> 8);
				} else {
					local207 = this.aClass2_7.anInt139 + ((this.aClass2_7.anInt140 - this.aClass2_7.anInt139) * local385 >> 8);
				}
				local201 += 256;
		...
		if (this.anInt464 > 0 && this.anInt465 > 0) {
			local201 = (int) ((double) this.anInt464 * local26);
			for (local207 = local201; local207 < arg0; local207++) {
				anIntArray106[local207] += anIntArray106[local207 - local201] * this.anInt465 / 100;
			}
		}
		if (this.aClass3_1.anIntArray18[0] > 0 || this.aClass3_1.anIntArray18[1] > 0) {
			...
			if (arg0 >= local207 + local216) {
				...
				while (local222 < local379) {
					local385 = (int) ((long) anIntArray106[local222 + local207] * (long) Class3.anInt161 >> 16);
				...
				while (true) {
					...
					@Pc(694) int local694;
					while (local222 < local379) {
						local559 = (int) ((long) anIntArray106[local222 + local207] * (long) Class3.anInt161 >> 16);
	...
	private int method244(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		try {
			if (arg2 == 1) {
			...
			signlink.reporterror("32871, " + arg0 + ", " + 0 + ", " + arg1 + ", " + arg2 + ", " + local59.toString());
	...
	public void method245(@OriginalArg(1) Class1_Sub1_Sub3 arg0) {
		try {
			...
			@Pc(30) int local30 = arg0.method476();
			if (local30 != 0) {
				arg0.anInt734--;
			...
			for (@Pc(122) int local122 = 0; local122 < 10; local122++) {
				@Pc(133) int local133 = arg0.method490();
				if (local133 == 0) {
					break;
				}
				this.anIntArray103[local122] = local133;
				this.anIntArray104[local122] = arg0.method489();
				this.anIntArray105[local122] = arg0.method490();
			}
			this.anInt464 = arg0.method490();
			this.anInt465 = arg0.method490();
			this.anInt466 = arg0.method478();
			this.anInt467 = arg0.method478();
			this.aClass3_1 = new Class3();
			this.aClass2_9 = new Class2();
			this.aClass3_1.method54(this.anInt463, this.aClass2_9, arg0);
		} catch (@Pc(192) RuntimeException local192) {
			signlink.reporterror("77565, " + false + ", " + arg0 + ", " + local192.toString());
			throw new RuntimeException();
		}
	}
}
