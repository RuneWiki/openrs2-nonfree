...
public final class Class7 {
	...
	private int anInt454 = 100;

	@OriginalMember(owner = "client!dc", name = "r", descriptor = "I")
	public int anInt455 = 500;
	...
	public int[] method242(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (this.aClass2_3 != null) {
			...
			local36 = (int) ((double) (this.aClass2_3.anInt139 - this.aClass2_3.anInt138) * 32.768D / local26);
			local38 = (int) ((double) this.aClass2_3.anInt138 * 32.768D / local26);
		}
		@Pc(77) int local77 = 0;
		@Pc(79) int local79 = 0;
		@Pc(81) int local81 = 0;
		if (this.aClass2_5 != null) {
			...
			local77 = (int) ((double) (this.aClass2_5.anInt139 - this.aClass2_5.anInt138) * 32.768D / local26);
			local79 = (int) ((double) this.aClass2_5.anInt138 * 32.768D / local26);
		}
		for (@Pc(118) int local118 = 0; local118 < 5; local118++) {
			if (this.anIntArray102[local118] != 0) {
				...
				anIntArray111[local118] = (int) ((double) (this.aClass2_1.anInt139 - this.aClass2_1.anInt138) * 32.768D * Math.pow(1.0057929410678534D, (double) this.anIntArray103[local118]) / local26);
				anIntArray112[local118] = (int) ((double) this.aClass2_1.anInt138 * 32.768D / local26);
			}
		}
		@Pc(201) int local201;
		@Pc(207) int local207;
		...
		for (@Pc(193) int local193 = 0; local193 < arg0; local193++) {
			...
			if (this.aClass2_3 != null) {
				...
				local201 += this.method243(local222, local40, this.aClass2_3.anInt140) >> 1;
				local40 += (local216 * local36 >> 16) + local38;
			}
			if (this.aClass2_5 != null) {
				local216 = this.aClass2_5.method45(arg0);
				local222 = this.aClass2_6.method45(arg0);
				local207 = local207 * ((this.method243(local222, local81, this.aClass2_5.anInt140) >> 1) + 32768) >> 15;
			...
			for (local216 = 0; local216 < 5; local216++) {
				if (this.anIntArray102[local216] != 0) {
					...
					if (local222 < arg0) {
						anIntArray105[local222] += this.method243(local207 * anIntArray110[local216] >> 15, anIntArray108[local216], this.aClass2_1.anInt140);
		...
		if (this.aClass2_7 != null) {
			...
			for (local222 = 0; local222 < arg0; local222++) {
				...
				if (local369) {
					local207 = this.aClass2_7.anInt138 + ((this.aClass2_7.anInt139 - this.aClass2_7.anInt138) * local379 >> 8);
				} else {
					local207 = this.aClass2_7.anInt138 + ((this.aClass2_7.anInt139 - this.aClass2_7.anInt138) * local385 >> 8);
				}
				local201 += 256;
		...
		if (this.anInt453 > 0 && this.anInt454 > 0) {
			local201 = (int) ((double) this.anInt453 * local26);
			for (local207 = local201; local207 < arg0; local207++) {
				anIntArray105[local207] += anIntArray105[local207 - local201] * this.anInt454 / 100;
			}
		}
		if (this.aClass3_1.anIntArray17[0] > 0 || this.aClass3_1.anIntArray17[1] > 0) {
			...
			local207 = this.aClass3_1.method53((float) local201 / 65536.0F, 0);
			local216 = this.aClass3_1.method53((float) local201 / 65536.0F, 1);
			if (arg0 >= local207 + local216) {
				...
				while (local222 < local379) {
					local385 = (int) ((long) anIntArray105[local222 + local207] * (long) Class3.anInt159 >> 16);
				...
				while (true) {
					...
					@Pc(694) int local694;
					while (local222 < local379) {
						local559 = (int) ((long) anIntArray105[local222 + local207] * (long) Class3.anInt159 >> 16);
	...
	private int method243(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
		try {
			if (this.anInt451 != -27771) {
				return this.anInt452;
			} else if (arg2 == 1) {
				return (arg1 & 0x7FFF) < 16384 ? arg0 : -arg0;
			} else if (arg2 == 2) {
				return anIntArray107[arg1 & 0x7FFF] * arg0 >> 14;
			} else if (arg2 == 3) {
				return ((arg1 & 0x7FFF) * arg0 >> 14) - arg0;
			} else if (arg2 == 4) {
				return anIntArray106[arg1 / 2607 & 0x7FFF] * arg0;
			} else {
				return 0;
			}
		} catch (@Pc(61) RuntimeException local61) {
			signlink.reporterror("44162, " + arg0 + ", " + -27771 + ", " + arg1 + ", " + arg2 + ", " + local61.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!dc", name = "a", descriptor = "(Lclient!lb;I)V")
	public void method244(@OriginalArg(0) Class1_Sub1_Sub3 arg0) {
		try {
			this.aClass2_1 = new Class2();
			this.aClass2_1.method42(arg0);
			this.aClass2_2 = new Class2();
			this.aClass2_2.method42(arg0);
			@Pc(24) int local24 = arg0.method472();
			if (local24 != 0) {
				arg0.anInt715--;
			...
			for (@Pc(132) int local132 = 0; local132 < 10; local132++) {
				@Pc(137) int local137 = arg0.method486();
				if (local137 == 0) {
					break;
				}
				this.anIntArray102[local132] = local137;
				this.anIntArray103[local132] = arg0.method485();
				this.anIntArray104[local132] = arg0.method486();
			}
			this.anInt453 = arg0.method486();
			this.anInt454 = arg0.method486();
			this.anInt455 = arg0.method474();
			this.anInt456 = arg0.method474();
			...
			signlink.reporterror("58347, " + arg0 + ", " + -32477 + ", " + local195.toString());
			throw new RuntimeException();
		}
	}
}
