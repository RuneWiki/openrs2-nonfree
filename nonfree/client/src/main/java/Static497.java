...
public final class Static497 {
	...
	public static void method6706(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1) {
		if (arg0) {
			Static546.anInt8827++;
			Static277.method4433();
		}
		if (arg1) {
			Static317.anInt5752++;
			Static147.method2762();
		}
	}

	@OriginalMember(owner = "client!taa", name = "a", descriptor = "(II)Lclient!mfa;")
	public static Class3_Sub1 method6707(@OriginalArg(0) int arg0) {
		if (arg0 == 0) {
			...
			return new Class3_Sub1_Sub2_Sub1();
		} else if (arg0 == 19) {
	...
	@OriginalMember(owner = "client!taa", name = "a", descriptor = "(Lclient!om;B)V")
	public static void method6708(@OriginalArg(0) Class246 arg0) {
		Static154.aClass246_78 = arg0;
	}
}
