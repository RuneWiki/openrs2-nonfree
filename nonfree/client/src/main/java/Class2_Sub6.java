...
public final class Class2_Sub6 extends Class2 {
	...
	private float[] method607(@OriginalArg(0) int arg0) {
		Static27.method617(this.aByteArrayArray2[arg0]);
		Static27.method608();
		@Pc(15) int local15 = Static27.method614(Static451.method6881(Static27.anIntArray43.length - 1));
		@Pc(19) boolean local19 = Static27.aBooleanArray3[local15];
		@Pc(25) int local25 = local19 ? Static27.anInt519 : Static27.anInt517;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static27.method608() != 0;
			local29 = Static27.method608() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static27.anInt517 >> 2);
			local67 = (local25 >> 2) + (Static27.anInt517 >> 2);
			local71 = Static27.anInt517 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static27.anInt517 >> 2);
			local104 = local25 + (Static27.anInt517 >> 2) - (local25 >> 2);
			local108 = Static27.anInt517 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class222 local123 = Static27.aClass222Array1[Static27.anIntArray43[local15]];
		@Pc(126) int local126 = local123.anInt6949;
		@Pc(131) int local131 = local123.anIntArray564[local126];
		@Pc(140) boolean local140 = !Static27.aClass272Array1[local131].method6991();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt6950; local144++) {
			@Pc(152) Class268 local152 = Static27.aClass268Array1[local123.anIntArray565[local144]];
			local154 = Static27.aFloatArray10;
			local152.method6906(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt6949;
			local176 = local123.anIntArray564[local171];
			Static27.aClass272Array1[local176].method6992(Static27.aFloatArray10, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static27.aFloatArray10[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static27.aFloatArray10;
			...
			@Pc(252) float[] local252 = local19 ? Static27.aFloatArray5 : Static27.aFloatArray8;
			@Pc(258) float[] local258 = local19 ? Static27.aFloatArray9 : Static27.aFloatArray6;
			@Pc(264) float[] local264 = local19 ? Static27.aFloatArray7 : Static27.aFloatArray11;
			@Pc(270) int[] local270 = local19 ? Static27.anIntArray41 : Static27.anIntArray42;
			...
			@Pc(486) int local486 = Static451.method6881(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static27.aFloatArray10[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static27.aFloatArray10[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt521 > 0) {
			local176 = this.anInt521 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean35) {
				for (local212 = 0; local212 < this.anInt512; local212++) {
					local1254 = (this.anInt521 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static27.aFloatArray10[local212];
				}
			}
		}
		local154 = this.aFloatArray12;
		this.aFloatArray12 = Static27.aFloatArray10;
		Static27.aFloatArray10 = local154;
		this.anInt521 = local25;
		this.anInt512 = local104 - (local25 >> 1);
		this.aBoolean35 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!av", name = "a", descriptor = "([I)Lclient!mca;")
	public Class2_Sub31_Sub1 method613(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray19 == null) {
			this.anInt521 = 0;
			this.aFloatArray12 = new float[Static27.anInt519];
			this.aByteArray19 = new byte[this.anInt520];
			this.anInt523 = 0;
			this.anInt522 = 0;
		}
		while (this.anInt522 < this.aByteArrayArray2.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method607(this.anInt522);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt523;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt520 - local47) {
					local50 = this.anInt520 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt523;
				}
				this.anInt523 = local47;
			}
			this.anInt522++;
		}
		...
		return new Class2_Sub31_Sub1(this.anInt518, local129, this.anInt515, this.anInt516, this.aBoolean33);
	}
	...
	private void method615(@OriginalArg(0) byte[] arg0) {
		...
		this.anInt518 = local4.method5198();
		this.anInt520 = local4.method5198();
		this.anInt515 = local4.method5198();
		this.anInt516 = local4.method5198();
		if (this.anInt516 < 0) {
			this.anInt516 = ~this.anInt516;
		...
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			...
			@Pc(53) int local53;
			do {
				local53 = local4.method5170();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method5184(local49, local64);
