...
public final class c extends Class117 implements Interface18 {

	@OriginalMember(owner = "client!c", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!c", name = "<init>", descriptor = "(Lclient!l;Lclient!m;Lclient!daa;[Lclient!vw;[Lclient!f;)V")
	public c(@OriginalArg(0) l arg0, @OriginalArg(1) m arg1, @OriginalArg(2) Class58 arg2, @OriginalArg(3) Class355[] arg3, @OriginalArg(4) Class46[] arg4) {
		super(arg0, arg2);
	...
	private native void GA(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class146 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
