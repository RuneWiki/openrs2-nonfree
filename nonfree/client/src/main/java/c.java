...
public final class c extends Class37 implements Interface18 {

	@OriginalMember(owner = "client!c", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!c", name = "<init>", descriptor = "(Lclient!l;Lclient!m;Lclient!fo;[Lclient!ut;[Lclient!f;)V")
	public c(@OriginalArg(0) l arg0, @OriginalArg(1) m arg1, @OriginalArg(2) Class112 arg2, @OriginalArg(3) Class344[] arg3, @OriginalArg(4) Class38[] arg4) {
		super(arg0, arg2);
	...
	private native void GA(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class84 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
