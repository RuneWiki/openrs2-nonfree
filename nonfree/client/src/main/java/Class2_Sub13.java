...
public final class Class2_Sub13 extends Class2 {
	...
	private float[] method1868(@OriginalArg(0) int arg0) {
		Static105.method1877(this.aByteArrayArray9[arg0]);
		Static105.method1875();
		@Pc(15) int local15 = Static105.method1872(Static188.method3476(Static105.anIntArray193.length - 1));
		@Pc(19) boolean local19 = Static105.aBooleanArray12[local15];
		@Pc(25) int local25 = local19 ? Static105.anInt2322 : Static105.anInt2321;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static105.method1875() != 0;
			local29 = Static105.method1875() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static105.anInt2321 >> 2);
			local67 = (local25 >> 2) + (Static105.anInt2321 >> 2);
			local71 = Static105.anInt2321 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static105.anInt2321 >> 2);
			local104 = local25 + (Static105.anInt2321 >> 2) - (local25 >> 2);
			local108 = Static105.anInt2321 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class40 local123 = Static105.aClass40Array1[Static105.anIntArray193[local15]];
		@Pc(126) int local126 = local123.anInt1152;
		@Pc(131) int local131 = local123.anIntArray83[local126];
		@Pc(140) boolean local140 = !Static105.aClass17Array1[local131].method241();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt1151; local144++) {
			@Pc(152) Class224 local152 = Static105.aClass224Array1[local123.anIntArray82[local144]];
			local154 = Static105.aFloatArray5;
			local152.method5537(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt1152;
			local176 = local123.anIntArray83[local171];
			Static105.aClass17Array1[local176].method245(Static105.aFloatArray5, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static105.aFloatArray5[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static105.aFloatArray5;
			...
			@Pc(252) float[] local252 = local19 ? Static105.aFloatArray6 : Static105.aFloatArray9;
			@Pc(258) float[] local258 = local19 ? Static105.aFloatArray7 : Static105.aFloatArray11;
			@Pc(264) float[] local264 = local19 ? Static105.aFloatArray12 : Static105.aFloatArray10;
			@Pc(270) int[] local270 = local19 ? Static105.anIntArray192 : Static105.anIntArray194;
			...
			@Pc(486) int local486 = Static188.method3476(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static105.aFloatArray5[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static105.aFloatArray5[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt2320 > 0) {
			local176 = this.anInt2320 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean171) {
				for (local212 = 0; local212 < this.anInt2316; local212++) {
					local1254 = (this.anInt2320 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static105.aFloatArray5[local212];
				}
			}
		}
		local154 = this.aFloatArray8;
		this.aFloatArray8 = Static105.aFloatArray5;
		Static105.aFloatArray5 = local154;
		this.anInt2320 = local25;
		this.anInt2316 = local104 - (local25 >> 1);
		this.aBoolean171 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!fp", name = "a", descriptor = "([I)Lclient!jk;")
	public Class2_Sub20_Sub1 method1871(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray30 == null) {
			this.anInt2320 = 0;
			this.aFloatArray8 = new float[Static105.anInt2322];
			this.aByteArray30 = new byte[this.anInt2317];
			this.anInt2327 = 0;
			this.anInt2326 = 0;
		}
		while (this.anInt2326 < this.aByteArrayArray9.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1868(this.anInt2326);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2327;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt2317 - local47) {
					local50 = this.anInt2317 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray30[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2327;
				}
				this.anInt2327 = local47;
			}
			this.anInt2326++;
		}
		this.aFloatArray8 = null;
		@Pc(129) byte[] local129 = this.aByteArray30;
		this.aByteArray30 = null;
		return new Class2_Sub20_Sub1(this.anInt2325, local129, this.anInt2319, this.anInt2318, this.aBoolean170);
	}

	@OriginalMember(owner = "client!fp", name = "b", descriptor = "([B)V")
	private void method1878(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub24 local4 = new Class2_Sub24(arg0);
		this.anInt2325 = local4.method5776();
		this.anInt2317 = local4.method5776();
		this.anInt2319 = local4.method5776();
		this.anInt2318 = local4.method5776();
		if (this.anInt2318 < 0) {
			this.anInt2318 = ~this.anInt2318;
			this.aBoolean170 = true;
		}
		@Pc(40) int local40 = local4.method5776();
		this.aByteArrayArray9 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method5732();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method5756(local64, local49);
