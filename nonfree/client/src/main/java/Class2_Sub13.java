...
public final class Class2_Sub13 extends Class2 {
	...
	private float[] method1317(@OriginalArg(0) int arg0) {
		Static73.method1319(this.aByteArrayArray3[arg0]);
		Static73.method1327();
		@Pc(15) int local15 = Static73.method1326(Static184.method2920(Static73.anIntArray96.length - 1));
		@Pc(19) boolean local19 = Static73.aBooleanArray9[local15];
		@Pc(25) int local25 = local19 ? Static73.anInt1832 : Static73.anInt1835;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static73.method1327() != 0;
			local29 = Static73.method1327() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static73.anInt1835 >> 2);
			local67 = (local25 >> 2) + (Static73.anInt1835 >> 2);
			local71 = Static73.anInt1835 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static73.anInt1835 >> 2);
			local104 = local25 + (Static73.anInt1835 >> 2) - (local25 >> 2);
			local108 = Static73.anInt1835 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class118 local123 = Static73.aClass118Array1[Static73.anIntArray96[local15]];
		@Pc(126) int local126 = local123.anInt3264;
		@Pc(131) int local131 = local123.anIntArray217[local126];
		@Pc(140) boolean local140 = !Static73.aClass71Array1[local131].method1614();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt3263; local144++) {
			@Pc(152) Class187 local152 = Static73.aClass187Array1[local123.anIntArray216[local144]];
			local154 = Static73.aFloatArray9;
			local152.method4270(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt3264;
			local176 = local123.anIntArray217[local171];
			Static73.aClass71Array1[local176].method1610(Static73.aFloatArray9, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static73.aFloatArray9[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static73.aFloatArray9;
			...
			@Pc(252) float[] local252 = local19 ? Static73.aFloatArray10 : Static73.aFloatArray13;
			@Pc(258) float[] local258 = local19 ? Static73.aFloatArray6 : Static73.aFloatArray12;
			@Pc(264) float[] local264 = local19 ? Static73.aFloatArray11 : Static73.aFloatArray8;
			@Pc(270) int[] local270 = local19 ? Static73.anIntArray95 : Static73.anIntArray97;
			...
			@Pc(486) int local486 = Static184.method2920(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static73.aFloatArray9[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static73.aFloatArray9[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt1838 > 0) {
			local176 = this.anInt1838 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean163) {
				for (local212 = 0; local212 < this.anInt1837; local212++) {
					local1254 = (this.anInt1838 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static73.aFloatArray9[local212];
				}
			}
		}
		local154 = this.aFloatArray7;
		this.aFloatArray7 = Static73.aFloatArray9;
		Static73.aFloatArray9 = local154;
		this.anInt1838 = local25;
		this.anInt1837 = local104 - (local25 >> 1);
		this.aBoolean163 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!di", name = "a", descriptor = "([I)Lclient!uo;")
	public Class2_Sub41_Sub1 method1322(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray46 == null) {
			this.anInt1838 = 0;
			this.aFloatArray7 = new float[Static73.anInt1832];
			this.aByteArray46 = new byte[this.anInt1829];
			this.anInt1840 = 0;
			this.anInt1839 = 0;
		}
		while (this.anInt1839 < this.aByteArrayArray3.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1317(this.anInt1839);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt1840;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt1829 - local47) {
					local50 = this.anInt1829 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt1840;
				}
				this.anInt1840 = local47;
			}
			this.anInt1839++;
		}
		...
		return new Class2_Sub41_Sub1(this.anInt1833, local129, this.anInt1836, this.anInt1830, this.aBoolean164);
	}
	...
	private void method1325(@OriginalArg(0) byte[] arg0) {
		...
		this.anInt1833 = local4.method3731();
		this.anInt1829 = local4.method3731();
		this.anInt1836 = local4.method3731();
		this.anInt1830 = local4.method3731();
		if (this.anInt1830 < 0) {
			this.anInt1830 = ~this.anInt1830;
			this.aBoolean164 = true;
		}
		@Pc(40) int local40 = local4.method3731();
		this.aByteArrayArray3 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method3737();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method3690(local64, local49);
