...
public final class Class23_Sub11 extends Class23 {
	...
	@OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(ILclient!ts;)V")
	public Class23_Sub11(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub48 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(Lclient!ts;)V")
	public Class23_Sub11(@OriginalArg(0) Class3_Sub48 arg0) {
		super(arg0);
	}
	...
	protected int method8501() {
		return super.aClass3_Sub48_31.method7827().method8482() > 1 ? 4 : 2;
	}
