...
public final class Class5_Sub22 extends Class5 {
	...
	private void method3144(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class5_Sub36 local4 = new Class5_Sub36(arg0);
		this.anInt3414 = local4.method7268();
		this.anInt3408 = local4.method7268();
		this.anInt3411 = local4.method7268();
		this.anInt3409 = local4.method7268();
		if (this.anInt3409 < 0) {
			this.anInt3409 = ~this.anInt3409;
			this.aBoolean247 = true;
		}
		@Pc(40) int local40 = local4.method7268();
		this.aByteArrayArray9 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method7291();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method7297(local64, 0, local49);
			this.aByteArrayArray9[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!gga", name = "a", descriptor = "(I)[F")
	private float[] method3145(@OriginalArg(0) int arg0) {
		Static182.method3142(this.aByteArrayArray9[arg0]);
		Static182.method3150();
		@Pc(15) int local15 = Static182.method3151(Static281.method4513(Static182.anIntArray156.length - 1));
		@Pc(19) boolean local19 = Static182.aBooleanArray11[local15];
		@Pc(25) int local25 = local19 ? Static182.anInt3410 : Static182.anInt3413;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static182.method3150() != 0;
			local29 = Static182.method3150() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static182.anInt3413 >> 2);
			local67 = (local25 >> 2) + (Static182.anInt3413 >> 2);
			local71 = Static182.anInt3413 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static182.anInt3413 >> 2);
			local104 = local25 + (Static182.anInt3413 >> 2) - (local25 >> 2);
			local108 = Static182.anInt3413 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class170 local123 = Static182.aClass170Array1[Static182.anIntArray156[local15]];
		@Pc(126) int local126 = local123.anInt4300;
		@Pc(131) int local131 = local123.anIntArray217[local126];
		@Pc(140) boolean local140 = !Static182.aClass344Array1[local131].method7664();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt4299; local144++) {
			@Pc(152) Class163 local152 = Static182.aClass163Array1[local123.anIntArray216[local144]];
			local154 = Static182.aFloatArray35;
			local152.method3710(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt4300;
			local176 = local123.anIntArray217[local171];
			Static182.aClass344Array1[local176].method7662(Static182.aFloatArray35, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static182.aFloatArray35[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static182.aFloatArray35;
			...
			@Pc(252) float[] local252 = local19 ? Static182.aFloatArray33 : Static182.aFloatArray37;
			@Pc(258) float[] local258 = local19 ? Static182.aFloatArray31 : Static182.aFloatArray34;
			@Pc(264) float[] local264 = local19 ? Static182.aFloatArray32 : Static182.aFloatArray36;
			@Pc(270) int[] local270 = local19 ? Static182.anIntArray158 : Static182.anIntArray157;
			...
			@Pc(486) int local486 = Static281.method4513(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static182.aFloatArray35[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static182.aFloatArray35[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt3412 > 0) {
			local176 = this.anInt3412 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean246) {
				for (local212 = 0; local212 < this.anInt3417; local212++) {
					local1254 = (this.anInt3412 >> 1) + local212;
					local1228[local212] += this.aFloatArray30[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static182.aFloatArray35[local212];
				}
			}
		}
		local154 = this.aFloatArray30;
		this.aFloatArray30 = Static182.aFloatArray35;
		Static182.aFloatArray35 = local154;
		this.anInt3412 = local25;
		this.anInt3417 = local104 - (local25 >> 1);
		this.aBoolean246 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!gga", name = "a", descriptor = "([I)Lclient!jg;")
	public Class5_Sub27_Sub1 method3147(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray33 == null) {
			this.anInt3412 = 0;
			this.aFloatArray30 = new float[Static182.anInt3410];
			this.aByteArray33 = new byte[this.anInt3408];
			this.anInt3418 = 0;
			this.anInt3419 = 0;
		}
		while (this.anInt3419 < this.aByteArrayArray9.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method3145(this.anInt3419);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt3418;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt3408 - local47) {
					local50 = this.anInt3408 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray33[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt3418;
				}
				this.anInt3418 = local47;
			}
			this.anInt3419++;
		}
		this.aFloatArray30 = null;
		@Pc(129) byte[] local129 = this.aByteArray33;
		this.aByteArray33 = null;
		return new Class5_Sub27_Sub1(this.anInt3414, local129, this.anInt3411, this.anInt3409, this.aBoolean247);
	}
}
