...
public final class Static630 {
	...
	public static void method8717(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3) {
		...
		for (@Pc(60) int local60 = arg1; local60 < arg0; local60++) {
			if (arg3[local60] < local25 + (local60 & local58)) {
				@Pc(76) int local76 = arg3[local60];
				arg3[local60] = arg3[local21];
				arg3[local21] = local76;
				@Pc(90) int local90 = arg2[local60];
		...
		method8717(local21 - 1, arg1, arg2, arg3);
		method8717(arg0, local21 + 1, arg2, arg3);
	}
}
