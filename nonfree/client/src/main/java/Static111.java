...
public final class Static111 {
	...
	@OriginalMember(owner = "client!da", name = "a", descriptor = "([B[IIIIIIIIILclient!da;)I")
	public static int method407(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class3_Sub4_Sub1 arg9) {
		arg2 >>= 0x8;
		...
		arg9.anInt619 = arg4 >> 8;
		arg9.anInt613 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!da", name = "a", descriptor = "(II[B[IIIIIIILclient!da;II)I")
	public static int method408(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub4_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!da", name = "a", descriptor = "(Lclient!fd;II)Lclient!da;")
	public static Class3_Sub4_Sub1 method410(@OriginalArg(0) Class3_Sub5_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray7 == null || arg0.aByteArray7.length == 0 ? null : new Class3_Sub4_Sub1(arg0, (int) ((long) arg0.anInt856 * 256L * (long) 100 / (long) (Static14.anInt545 * 100)), arg1);
	}

	@OriginalMember(owner = "client!da", name = "a", descriptor = "([B[IIIIIIILclient!da;)I")
	public static int method411(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub4_Sub1 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt613 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!da", name = "a", descriptor = "(II[B[IIIIIIIIILclient!da;II)I")
	public static int method412(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) Class3_Sub4_Sub1 arg9, @OriginalArg(13) int arg10, @OriginalArg(14) int arg11) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!da", name = "b", descriptor = "([B[IIIIIIIIILclient!da;)I")
	public static int method414(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class3_Sub4_Sub1 arg9) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg8 >> 8;
		arg4 <<= 0x8;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!da", name = "b", descriptor = "(II[B[IIIIIIIIILclient!da;II)I")
	...
	@OriginalMember(owner = "client!da", name = "b", descriptor = "(II[B[IIIIIIILclient!da;II)I")
	public static int method417(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub4_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!da", name = "b", descriptor = "([B[IIIIIIILclient!da;)I")
	public static int method419(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub4_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 8;
		@Pc(18) int local18;
