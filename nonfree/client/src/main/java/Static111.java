...
public final class Static111 {
	...
	@OriginalMember(owner = "client!ba", name = "a", descriptor = "(Lclient!vb;II)Lclient!ba;")
	public static Class3_Sub1_Sub2 method146(@OriginalArg(0) Class3_Sub7_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray23 == null || arg0.aByteArray23.length == 0 ? null : new Class3_Sub1_Sub2(arg0, (int) ((long) arg0.anInt2690 * 256L * (long) 100 / (long) (Static80.anInt2188 * 100)), arg1);
	}

	@OriginalMember(owner = "client!ba", name = "a", descriptor = "([B[IIIIIIIIILclient!ba;)I")
	public static int method147(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class3_Sub1_Sub2 arg9) {
		arg2 >>= 0x8;
		...
		arg9.anInt170 = arg4 >> 8;
		arg9.anInt168 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ba", name = "a", descriptor = "([B[IIIIIIILclient!ba;)I")
	public static int method148(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub1_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt168 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ba", name = "b", descriptor = "([B[IIIIIIIIILclient!ba;)I")
	public static int method149(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class3_Sub1_Sub2 arg9) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg8 >> 8;
		arg4 <<= 0x8;
		@Pc(15) int local15 = arg6 << 8;
	...
	public static int method150(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub1_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	public static int method152(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub1_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 8;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!ba", name = "a", descriptor = "(II[B[IIIIIIIIILclient!ba;II)I")
	public static int method154(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) Class3_Sub1_Sub2 arg9, @OriginalArg(13) int arg10, @OriginalArg(14) int arg11) {
		@Pc(14) int local14;
	...
	public static int method156(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub1_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ba", name = "b", descriptor = "(II[B[IIIIIIIIILclient!ba;II)I")
	public static int method157(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) Class3_Sub1_Sub2 arg9, @OriginalArg(13) int arg10, @OriginalArg(14) int arg11) {
		@Pc(14) int local14;
