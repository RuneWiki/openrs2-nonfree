...
public final class Static111 {
	...
	public static int method473(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub4_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ea", name = "a", descriptor = "(Lclient!qa;II)Lclient!ea;")
	public static Class2_Sub4_Sub1 method474(@OriginalArg(0) Class2_Sub8_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray19 == null || arg0.aByteArray19.length == 0 ? null : new Class2_Sub4_Sub1(arg0, (int) ((long) arg0.anInt2289 * 256L * (long) 100 / (long) (Static57.anInt1657 * 100)), arg1);
	}

	@OriginalMember(owner = "client!ea", name = "a", descriptor = "([B[IIIIIIIIILclient!ea;)I")
	public static int method475(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class2_Sub4_Sub1 arg9) {
		arg2 >>= 0x8;
		...
		arg9.anInt650 = arg4 >> 8;
		arg9.anInt649 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ea", name = "a", descriptor = "([B[IIIIIIILclient!ea;)I")
	public static int method476(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub4_Sub1 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt649 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ea", name = "a", descriptor = "(II[B[IIIIIIIIILclient!ea;II)I")
	public static int method478(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) Class2_Sub4_Sub1 arg9, @OriginalArg(13) int arg10, @OriginalArg(14) int arg11) {
		@Pc(14) int local14;
	...
	public static int method479(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub4_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	public static int method481(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub4_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 8;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!ea", name = "b", descriptor = "(II[B[IIIIIIIIILclient!ea;II)I")
	...
	@OriginalMember(owner = "client!ea", name = "b", descriptor = "([B[IIIIIIIIILclient!ea;)I")
	public static int method483(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class2_Sub4_Sub1 arg9) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg8 >> 8;
		arg4 <<= 0x8;
		@Pc(18) int local18;
