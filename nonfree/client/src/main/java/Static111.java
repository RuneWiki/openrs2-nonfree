...
public final class Static111 {
	...
	private static void method1267(@OriginalArg(0) Class61 arg0) {
		...
		@Pc(13) int[] local13 = Static31.anIntArray158;
		...
		Static31.anIntArray158 = local13;
				...
				while (true) {
					while (local531 != local420) {
						if (local531 == 0 || local531 == 1) {
							...
							while (local541 > 0) {
								Static31.anIntArray158[local470] = local60 & 0xFF;
								local470++;
								local541--;
							}
						} else {
							...
							Static31.anIntArray158[local470] = arg0.aByteArray19[local60 & 0xFF] & 0xFF;
							local470++;
							if (local501 == 0) {
								local473++;
								local501 = 50;
					...
					for (local138 = 0; local138 < local470; local138++) {
						local60 = (byte) (Static31.anIntArray158[local138] & 0xFF);
						Static31.anIntArray158[arg0.anIntArray523[local60 & 0xFF]] |= local138 << 8;
						arg0.anIntArray523[local60 & 0xFF]++;
					}
					arg0.anInt2411 = Static31.anIntArray158[arg0.anInt2398] >> 8;
					arg0.anInt2414 = 0;
					arg0.anInt2411 = Static31.anIntArray158[arg0.anInt2411];
