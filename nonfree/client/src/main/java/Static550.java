...
public final class Static550 {
	...
	@OriginalMember(owner = "client!eg", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!eg;)I")
	public static int method2322(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub12_Sub1 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt2497 += arg10.anInt2505 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt2507 = arg4 >> 2;
		arg10.anInt2502 = arg5 >> 2;
		arg10.anInt2508 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!eg", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!eg;II)I")
	public static int method2323(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub12_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt2497 -= arg10.anInt2505 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt2497 += arg10.anInt2505 * local63;
		arg10.anInt2507 = arg4;
		arg10.anInt2502 = arg5;
		arg10.anInt2508 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!eg", name = "a", descriptor = "(II[B[IIIIIIIILclient!eg;II)I")
	public static int method2327(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub12_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!eg", name = "a", descriptor = "(I[B[IIIIIIIILclient!eg;)I")
	public static int method2330(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub12_Sub1 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt2508 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!eg", name = "b", descriptor = "(II[B[IIIIIIIILclient!eg;II)I")
	public static int method2331(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub12_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt2507 -= arg8.anInt2495 * arg3;
		arg8.anInt2502 -= arg8.anInt2503 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!eg", name = "b", descriptor = "(I[B[IIIIIIIILclient!eg;)I")
	public static int method2332(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub12_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!eg", name = "a", descriptor = "(II[B[IIIIIIILclient!eg;II)I")
	public static int method2333(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub12_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lclient!qk;III)Lclient!eg;")
	public static Class1_Sub12_Sub1 method2336(@OriginalArg(0) Class1_Sub32_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray81 == null || arg0.aByteArray81.length == 0 ? null : new Class1_Sub12_Sub1(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!eg", name = "a", descriptor = "([B[IIIIIIIILclient!eg;)I")
	public static int method2337(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub12_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt2507 += arg8.anInt2495 * (local24 - arg3);
		arg8.anInt2502 += arg8.anInt2503 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt2497 = arg4 >> 2;
		arg8.anInt2508 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!eg", name = "c", descriptor = "(II[B[IIIIIIIILclient!eg;II)I")
	public static int method2340(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub12_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!eg", name = "a", descriptor = "([B[IIIIIIILclient!eg;)I")
	public static int method2341(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub12_Sub1 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt2508 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!eg", name = "a", descriptor = "(Lclient!qk;II)Lclient!eg;")
	public static Class1_Sub12_Sub1 method2348(@OriginalArg(0) Class1_Sub32_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray81 == null || arg0.aByteArray81.length == 0 ? null : new Class1_Sub12_Sub1(arg0, (int) ((long) arg0.anInt6859 * 256L * (long) 100 / (long) (Static77.anInt2079 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!eg", name = "d", descriptor = "(II)I")
	public static int method2349(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!eg", name = "b", descriptor = "(II[B[IIIIIIILclient!eg;II)I")
	public static int method2353(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub12_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!eg", name = "d", descriptor = "(II[B[IIIIIIIILclient!eg;II)I")
	public static int method2354(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub12_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt2507 -= arg8.anInt2495 * arg3;
		arg8.anInt2502 -= arg8.anInt2503 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!eg", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!eg;II)I")
	public static int method2355(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub12_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt2497 -= arg10.anInt2505 * arg3;
		@Pc(23) int local23;
	...
	public static int method2356(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!eg", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!eg;)I")
	public static int method2357(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub12_Sub1 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt2497 += arg10.anInt2505 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!eg", name = "b", descriptor = "([B[IIIIIIILclient!eg;)I")
	public static int method2358(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub12_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!eg", name = "b", descriptor = "([B[IIIIIIIILclient!eg;)I")
	public static int method2359(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub12_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt2507 += arg8.anInt2495 * (local22 - arg3);
		arg8.anInt2502 += arg8.anInt2503 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
