...
public final class Static364 {
	...
	private static int anInt6805;

	@OriginalMember(owner = "client!ow", name = "b", descriptor = "I")
	private static int anInt6806;
	...
	private static int anInt6807;

	@OriginalMember(owner = "client!ow", name = "e", descriptor = "I")
	private static int anInt6808;

	@OriginalMember(owner = "client!ow", name = "f", descriptor = "I")
	private static int anInt6809;

	@OriginalMember(owner = "client!ow", name = "g", descriptor = "I")
	private static int anInt6810;

	@OriginalMember(owner = "client!ow", name = "h", descriptor = "I")
	private static int anInt6811;

	@OriginalMember(owner = "client!ow", name = "a", descriptor = "(Lclient!qa;[II[I[I)V")
	public static void method5687(@OriginalArg(0) Class42 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4) {
		method5694(arg0, arg1, arg1.length, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!ow", name = "a", descriptor = "(Lclient!qa;[II)V")
	public static void method5688(@OriginalArg(0) Class42 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2) {
		method5694(arg0, arg1, arg1.length, arg2, null, null);
	}

	@OriginalMember(owner = "client!ow", name = "a", descriptor = "([III)V")
	private static void method5689(@OriginalArg(0) int[] arg0, @OriginalArg(2) int arg1) {
		@Pc(5) int local5 = anInt6806 + (arg1 << 1);
		@Pc(16) int local16;
		if (anIntArray468 == null || anIntArray468.length < local5) {
			@Pc(14) int[] local14 = new int[local5];
			for (local16 = 0; local16 < anInt6806; local16++) {
		...
		for (local16 = 0; local16 < local33; local16 += 2) {
			...
			if (local46 < local52) {
				anIntArray468[anInt6806++] = arg0[local37];
				anIntArray468[anInt6806++] = local46;
				anIntArray468[anInt6806++] = arg0[local16];
				anIntArray468[anInt6806++] = local52;
	...
	private static void method5690(@OriginalArg(0) int arg0) {
		if (anInt6806 < 0) {
			anInt6810 = 0;
			anInt6809 = 0;
			anInt6811 = 0;
			anInt6807 = 2147483646;
			return;
		}
		method5693(0, anInt6806);
		@Pc(17) int local17 = anIntArray468[1];
		if (local17 < arg0) {
			local17 = arg0;
		}
		@Pc(26) int local26;
		for (local26 = 0; local26 < anInt6806; local26 += 4) {
	...
	private static boolean method5692(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = anInt6809;
		@Pc(3) int local3 = anInt6810;
		@Pc(5) int local5 = anInt6807;
		while (local3 >= local1) {
			local5++;
			anInt6807 = local5;
			if (local5 >= arg0) {
			...
			@Pc(16) int local16 = anInt6811;
			@Pc(23) int local23;
			@Pc(30) int local30;
			while (local1 < anInt6806) {
			...
			if (local16 == anInt6806) {
				anInt6806 = 0;
				return false;
			}
			method5696(local16, local1);
			anInt6811 = local16;
			anInt6809 = local1;
			local3 = local16;
		}
		anInt6805 = anIntArray468[local3] >> 16;
		anInt6808 = anIntArray468[local3 + 4] >> 16;
	...
	private static void method5693(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg1 <= arg0 + 4) {
			return;
		}
		...
		method5693(arg0, local7);
		method5693(local7 + 4, arg1);
	}

	@OriginalMember(owner = "client!ow", name = "a", descriptor = "(Lclient!qa;[IIII[I[I)V")
	private static void method5694(@OriginalArg(0) Class42 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int[] arg4, @OriginalArg(6) int[] arg5) {
	...
	private static void method5696(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		while (true) {
			if (arg1 >= arg0 + 8) {
