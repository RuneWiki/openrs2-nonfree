...
public final class Static10 {
	...
	public static void method1846() {
		@Pc(1) int local1 = 0;
		@Pc(7) int local7 = anInt2275 * anInt2272 - 7;
		while (local1 < local7) {
	...
	public static void method1847(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		anIntArray214 = arg0;
		anInt2275 = arg1;
		anInt2272 = arg2;
		method1856(0, 0, arg1, arg2);
	}
	...
	public static void method1848(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (arg3 == 0) {
			if (arg2 >= 0) {
				method1853(arg0, arg1, arg2 + 1, arg4);
			} else {
				method1853(arg0 + arg2, arg1, 1 - arg2, arg4);
			}
		} else if (arg2 != 0) {
			if (arg2 + arg3 < 0) {
				arg0 += arg2;
			...
			if (arg2 > arg3) {
				...
				while (arg0 <= arg2) {
					local125 = arg1 >> 16;
					if (local125 >= anInt2273 && local125 < anInt2277) {
						anIntArray214[arg0 + local125 * anInt2275] = arg4;
					}
					arg1 += local96;
					arg0++;
				}
				...
				while (arg1 <= arg3) {
					local125 = arg0 >> 16;
					if (local125 >= anInt2274 && local125 < anInt2276) {
						anIntArray214[local125 + arg1 * anInt2275] = arg4;
					}
					arg0 += local96;
					arg1++;
				}
			...
			method1855(arg0, arg1, arg3 + 1, arg4);
		} else {
			method1855(arg0, arg1 + arg3, -arg3 + 1, arg4);
		}
	}
	...
	public static void method1850(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		if (arg0 + arg2 > anInt2276) {
			arg2 = anInt2276 - arg0;
		}
		if (arg1 + arg3 > anInt2277) {
			arg3 = anInt2277 - arg1;
		}
		@Pc(59) int local59 = ((arg4 & 0xFF00FF) * arg5 >> 8 & 0xFF00FF) + ((arg4 & 0xFF00) * arg5 >> 8 & 0xFF00);
		@Pc(63) int local63 = 256 - arg5;
		@Pc(67) int local67 = anInt2275 - arg2;
		@Pc(73) int local73 = arg0 + arg1 * anInt2275;
	...
	public static void method1851(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		@Pc(1) int local1 = 0;
		if (arg0 < anInt2274) {
			arg2 -= anInt2274 - arg0;
			arg0 = anInt2274;
		...
		@Pc(57) int local57 = anInt2275 - arg2;
		@Pc(63) int local63 = arg0 + arg1 * anInt2275;
	...
	private static void method1852(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg1 < anInt2273 || arg1 >= anInt2277) {
			return;
		}
		if (arg0 < anInt2274) {
			arg2 -= anInt2274 - arg0;
		...
		@Pc(58) int local58 = arg0 + arg1 * anInt2275;
	...
	public static void method1853(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		@Pc(32) int local32 = arg0 + arg1 * anInt2275;
	...
	public static void method1854(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		method1853(arg0, arg1, arg2, arg4);
		method1853(arg0, arg1 + arg3 - 1, arg2, arg4);
	...
	public static void method1855(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg0 < anInt2274 || arg0 >= anInt2276) {
			return;
		}
		if (arg1 < anInt2273) {
			arg2 -= anInt2273 - arg1;
		...
		if (arg1 + arg2 > anInt2277) {
			arg2 = anInt2277 - arg1;
		}
		@Pc(32) int local32 = arg0 + arg1 * anInt2275;
		for (@Pc(34) int local34 = 0; local34 < arg2; local34++) {
			anIntArray214[local32 + local34 * anInt2275] = arg3;
		}
	}

	@OriginalMember(owner = "client!b", name = "c", descriptor = "(IIII)V")
	public static void method1856(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg0 < 0) {
			arg0 = 0;
		}
		if (arg1 < 0) {
	...
	public static void method1859(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (anInt2274 < arg0) {
			anInt2274 = arg0;
		}
		if (anInt2273 < arg1) {
	...
	public static void method1860(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		method1852(arg0, arg1, arg2, arg4, arg5);
		method1852(arg0, arg1 + arg3 - 1, arg2, arg4, arg5);
		if (arg3 >= 3) {
	...
	public static void method1861(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg0 < anInt2274) {
			arg2 -= anInt2274 - arg0;
			arg0 = anInt2274;
		}
		...
		@Pc(43) int local43 = anInt2275 - arg2;
		@Pc(49) int local49 = arg0 + arg1 * anInt2275;
	...
	public static void method1862(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int[] arg2, @OriginalArg(4) int[] arg3) {
		@Pc(5) int local5 = arg0 + arg1 * anInt2275;
