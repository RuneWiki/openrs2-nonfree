...
public final class Static24 {
	...
	public static int anInt4402 = 256;
	...
	public static int anInt4405 = 256;

	@OriginalMember(owner = "client!bi", name = "P", descriptor = "I")
	public static int anInt4407 = -1;
	...
	@OriginalMember(owner = "client!bi", name = "c", descriptor = "(Ljava/lang/String;)Ljava/lang/String;")
	public static String method3703(@OriginalArg(0) String arg0) {
	...
	@OriginalMember(owner = "client!bi", name = "a", descriptor = "([[B[[B[I[I[III)I")
	public static int method3707(@OriginalArg(0) byte[][] arg0, @OriginalArg(1) byte[][] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
