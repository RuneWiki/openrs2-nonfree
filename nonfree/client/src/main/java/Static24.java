...
public final class Static24 {
	...
	public static Pix32[] aClass4_Sub1_Sub2_Sub2Array5;

	@OriginalMember(owner = "client!df", name = "a", descriptor = "Lclient!ec;")
	private static JagString aClass22_162 = Static60.method1113("Please wait 1 minute and try again)3");

	@OriginalMember(owner = "client!df", name = "b", descriptor = "I")
	public static int anInt557 = 0;

	@OriginalMember(owner = "client!df", name = "i", descriptor = "Lclient!ec;")
	private static JagString aClass22_166 = Static60.method1113("Take");

	@OriginalMember(owner = "client!df", name = "c", descriptor = "Lclient!ec;")
	public static JagString aClass22_163 = aClass22_166;

	@OriginalMember(owner = "client!df", name = "d", descriptor = "Lclient!ec;")
	public static JagString aClass22_164 = aClass22_162;

	@OriginalMember(owner = "client!df", name = "e", descriptor = "Lclient!ec;")
	public static JagString aClass22_165 = aClass22_162;

	@OriginalMember(owner = "client!df", name = "h", descriptor = "[I")
	public static int[] anIntArray62 = new int[100];

	@OriginalMember(owner = "client!df", name = "l", descriptor = "Lclient!ec;")
	public static JagString aClass22_167 = Static60.method1113("leuchten3:");

	@OriginalMember(owner = "client!df", name = "a", descriptor = "(II)Lclient!ec;")
	public static JagString method395(@OriginalArg(1) int arg0) {
		return Static44.method856(new JagString[] { Static134.method2042(arg0 >> 24 & 0xFF), Static53.aClass22_373, Static134.method2042(arg0 >> 16 & 0xFF), Static53.aClass22_373, Static134.method2042(arg0 >> 8 & 0xFF), Static53.aClass22_373, Static134.method2042(arg0 & 0xFF) });
	}
	...
	public static boolean method396(@OriginalArg(0) int arg0) {
		if (Static76.aBooleanArray14[arg0]) {
			...
			if (Static65.aClass4_Sub7ArrayArray1[arg0] == null) {
				Static65.aClass4_Sub7ArrayArray1[arg0] = new IfType[local30];
			}
			for (@Pc(52) int local52 = 0; local52 < local30; local52++) {
				if (Static65.aClass4_Sub7ArrayArray1[arg0][local52] == null) {
					...
					if (local66 != null) {
						Static65.aClass4_Sub7ArrayArray1[arg0][local52] = new IfType();
						Static65.aClass4_Sub7ArrayArray1[arg0][local52].anInt738 = (arg0 << 16) + local52;
						if (local66[0] == -1) {
							Static65.aClass4_Sub7ArrayArray1[arg0][local52].method534(new Packet(local66));
						} else {
							Static65.aClass4_Sub7ArrayArray1[arg0][local52].method531(new Packet(local66));
						}
					}
				}
			}
	...
	public static boolean method397(@OriginalArg(0) int arg0, @OriginalArg(1) Js5Index arg1, @OriginalArg(3) int arg2) {
