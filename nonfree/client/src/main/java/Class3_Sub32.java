...
public final class Class3_Sub32 extends Class3 {
	...
	public Class3_Sub32(@OriginalArg(0) byte[] arg0) {
		this.method4247(arg0);
	}

	@OriginalMember(owner = "client!kg", name = "a", descriptor = "([I)Lclient!qr;")
	public Class3_Sub17_Sub1 method4239(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray128 == null) {
			this.anInt5310 = 0;
			this.aFloatArray47 = new float[Static281.anInt5308];
			this.aByteArray128 = new byte[this.anInt5309];
			this.anInt5313 = 0;
			this.anInt5314 = 0;
		}
		while (this.anInt5314 < this.aByteArrayArray29.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method4243(this.anInt5314);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt5313;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt5309 - local47) {
					local50 = this.anInt5309 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray128[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt5313;
				}
				this.anInt5313 = local47;
			}
			this.anInt5314++;
		}
		this.aFloatArray47 = null;
		@Pc(129) byte[] local129 = this.aByteArray128;
		this.aByteArray128 = null;
		return new Class3_Sub17_Sub1(this.anInt5312, local129, this.anInt5306, this.anInt5304, this.aBoolean362);
	}

	@OriginalMember(owner = "client!kg", name = "b", descriptor = "(I)[F")
	private float[] method4243(@OriginalArg(0) int arg0) {
		Static281.method4246(this.aByteArrayArray29[arg0]);
		Static281.method4237();
		@Pc(15) int local15 = Static281.method4245(Static402.method5690(Static281.anIntArray246.length - 1));
		@Pc(19) boolean local19 = Static281.aBooleanArray15[local15];
		@Pc(25) int local25 = local19 ? Static281.anInt5308 : Static281.anInt5305;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static281.method4237() != 0;
			local29 = Static281.method4237() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static281.anInt5305 >> 2);
			local67 = (local25 >> 2) + (Static281.anInt5305 >> 2);
			local71 = Static281.anInt5305 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static281.anInt5305 >> 2);
			local104 = local25 + (Static281.anInt5305 >> 2) - (local25 >> 2);
			local108 = Static281.anInt5305 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class351 local123 = Static281.aClass351Array1[Static281.anIntArray246[local15]];
		@Pc(126) int local126 = local123.anInt9903;
		@Pc(131) int local131 = local123.anIntArray572[local126];
		@Pc(140) boolean local140 = !Static281.aClass128Array1[local131].method3480();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt9902; local144++) {
			@Pc(152) Class282 local152 = Static281.aClass282Array1[local123.anIntArray571[local144]];
			local154 = Static281.aFloatArray44;
			local152.method6310(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt9903;
			local176 = local123.anIntArray572[local171];
			Static281.aClass128Array1[local176].method3483(Static281.aFloatArray44, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static281.aFloatArray44[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static281.aFloatArray44;
			...
			@Pc(252) float[] local252 = local19 ? Static281.aFloatArray43 : Static281.aFloatArray50;
			@Pc(258) float[] local258 = local19 ? Static281.aFloatArray49 : Static281.aFloatArray48;
			@Pc(264) float[] local264 = local19 ? Static281.aFloatArray45 : Static281.aFloatArray46;
			@Pc(270) int[] local270 = local19 ? Static281.anIntArray247 : Static281.anIntArray245;
			...
			@Pc(486) int local486 = Static402.method5690(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static281.aFloatArray44[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static281.aFloatArray44[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt5310 > 0) {
			local176 = this.anInt5310 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean361) {
				for (local212 = 0; local212 < this.anInt5307; local212++) {
					local1254 = (this.anInt5310 >> 1) + local212;
					local1228[local212] += this.aFloatArray47[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static281.aFloatArray44[local212];
				}
			}
		}
		local154 = this.aFloatArray47;
		this.aFloatArray47 = Static281.aFloatArray44;
		Static281.aFloatArray44 = local154;
		this.anInt5310 = local25;
		this.anInt5307 = local104 - (local25 >> 1);
		this.aBoolean361 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!kg", name = "b", descriptor = "([B)V")
	private void method4247(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class3_Sub26 local4 = new Class3_Sub26(arg0);
		this.anInt5312 = local4.method6816();
		this.anInt5309 = local4.method6816();
		this.anInt5306 = local4.method6816();
		this.anInt5304 = local4.method6816();
		if (this.anInt5304 < 0) {
			this.anInt5304 = ~this.anInt5304;
			this.aBoolean362 = true;
		}
		@Pc(40) int local40 = local4.method6816();
		this.aByteArrayArray29 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method6814();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method6794(local64, local49);
			this.aByteArrayArray29[local46] = local64;
		}
	}
}
