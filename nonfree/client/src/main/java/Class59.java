...
public final class Class59 {
	...
	@OriginalMember(owner = "client!ga", name = "<init>", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
	public Class59(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18) {
		if (arg5 != arg6 || arg5 != arg7 || arg5 != arg8) {
			this.aBoolean121 = false;
		}
		this.anInt1627 = arg0;
		this.anInt1628 = arg1;
		this.anInt1626 = arg17;
		this.anInt1625 = arg18;
		@Pc(30) short local30 = 128;
		@Pc(34) int local34 = local30 / 2;
		@Pc(38) int local38 = local30 / 4;
		@Pc(44) int local44 = local30 * 3 / 4;
		@Pc(48) int[] local48 = Static83.anIntArrayArray13[arg0];
		@Pc(51) int local51 = local48.length;
		this.anIntArray198 = new int[local51];
		this.anIntArray204 = new int[local51];
		this.anIntArray199 = new int[local51];
		...
		for (@Pc(79) int local79 = 0; local79 < local51; local79++) {
			...
			this.anIntArray198[local79] = local142;
			this.anIntArray204[local79] = local146;
			this.anIntArray199[local79] = local144;
			local66[local79] = local148;
			local69[local79] = local150;
		}
		@Pc(534) int[] local534 = Static83.anIntArrayArray12[arg0];
		local86 = local534.length / 4;
		this.anIntArray207 = new int[local86];
		this.anIntArray202 = new int[local86];
		this.anIntArray200 = new int[local86];
		this.anIntArray197 = new int[local86];
		this.anIntArray196 = new int[local86];
		this.anIntArray201 = new int[local86];
		if (arg2 != -1) {
			this.anIntArray193 = new int[local86];
		}
		local142 = 0;
		for (local144 = 0; local144 < local86; local144++) {
			...
			this.anIntArray207[local144] = local148;
			this.anIntArray202[local144] = local150;
			this.anIntArray200[local144] = local599;
			if (local146 == 0) {
				this.anIntArray197[local144] = local66[local148];
				this.anIntArray196[local144] = local66[local150];
				this.anIntArray201[local144] = local66[local599];
				if (this.anIntArray193 != null) {
					this.anIntArray193[local144] = -1;
				}
			} else {
				this.anIntArray197[local144] = local69[local148];
				this.anIntArray196[local144] = local69[local150];
				this.anIntArray201[local144] = local69[local599];
				if (this.anIntArray193 != null) {
					this.anIntArray193[local144] = arg2;
				}
			}
		}
		local144 = arg5;
