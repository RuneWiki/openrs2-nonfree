...
public abstract class Class33 {
	...
	@OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Lclient!bf;)V", line = 4)
	...
	public abstract void method5711(@OriginalArg(0) Class8 arg0);

	@OriginalMember(owner = "client!cd", name = "a", descriptor = "()Z")
	public abstract boolean method5712();

	@OriginalMember(owner = "client!cd", name = "a", descriptor = "(I)V")
	public abstract void method5713(@OriginalArg(0) int arg0);
