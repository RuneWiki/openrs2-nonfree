...
public final class Class33 {
	...
	public static Class40 aClass40_9 = new Class40(30, false);
	...
	public static void method521(@OriginalArg(0) int arg0, @OriginalArg(1) Class47 arg1) {
		try {
			@Pc(8) Class1_Sub1_Sub3 local8 = new Class1_Sub1_Sub3(false, arg1.method666("spotanim.dat", null));
			anInt839 = local8.method482();
			if (arg0 == 35102) {
				if (aClass33Array1 == null) {
					aClass33Array1 = new Class33[anInt839];
				}
				for (@Pc(22) int local22 = 0; local22 < anInt839; local22++) {
					if (aClass33Array1[local22] == null) {
						aClass33Array1[local22] = new Class33();
					}
					aClass33Array1[local22].anInt840 = local22;
					aClass33Array1[local22].method522(local8);
				}
			}
		} catch (@Pc(51) RuntimeException local51) {
			signlink.reporterror("27905, " + arg0 + ", " + arg1 + ", " + local51.toString());
	...
	private void method522(@OriginalArg(0) Class1_Sub1_Sub3 arg0) {
		try {
			...
			signlink.reporterror("99230, " + arg0 + ", " + false + ", " + local130.toString());
			throw new RuntimeException();
		}
	}
	...
	public Class1_Sub1_Sub1_Sub5 method523() {
		@Pc(6) Class1_Sub1_Sub1_Sub5 local6 = (Class1_Sub1_Sub1_Sub5) aClass40_9.method591((long) this.anInt840);
		if (local6 != null) {
			return local6;
		}
		local6 = Class1_Sub1_Sub1_Sub5.method261(this.anInt841);
		if (local6 == null) {
			return null;
		}
		...
		aClass40_9.method592(local6, (long) this.anInt840, this.aBoolean205);
		return local6;
	}
}
