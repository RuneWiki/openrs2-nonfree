...
public final class Static319 {
	...
	@OriginalMember(owner = "client!j", name = "a", descriptor = "([B[IIIIIIIILclient!j;)I")
	public static int method2110(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub15_Sub1 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt2392 += arg8.anInt2389 * (local24 - arg3);
		arg8.anInt2400 += arg8.anInt2394 * (local24 - arg3);
		local24 -= 3;
		@Pc(56) int local56;
		while (arg3 < local24) {
			local56 = arg3++;
		...
		arg8.anInt2390 = arg4 >> 2;
		arg8.anInt2396 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!j", name = "a", descriptor = "(II[B[IIIIIIILclient!j;II)I")
	public static int method2112(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub15_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!j", name = "a", descriptor = "(Lclient!qj;III)Lclient!j;")
	public static Class3_Sub15_Sub1 method2113(@OriginalArg(0) Class3_Sub11_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray59 == null || arg0.aByteArray59.length == 0 ? null : new Class3_Sub15_Sub1(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!j", name = "a", descriptor = "([B[IIIIIIILclient!j;)I")
	public static int method2114(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub15_Sub1 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt2396 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!j", name = "a", descriptor = "(II[B[IIIIIIIILclient!j;II)I")
	public static int method2119(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub15_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!j", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!j;)I")
	public static int method2121(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub15_Sub1 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt2390 += arg10.anInt2393 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt2392 = arg4 >> 2;
		arg10.anInt2400 = arg5 >> 2;
		arg10.anInt2396 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!j", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!j;II)I")
	public static int method2122(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub15_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt2390 -= arg10.anInt2393 * arg3;
		@Pc(23) int local23;
		...
		local65 = arg3 >> 1;
		arg10.anInt2390 += arg10.anInt2393 * local65;
		arg10.anInt2392 = arg4;
		arg10.anInt2400 = arg5;
		arg10.anInt2396 = arg2;
		return local65;
	}

	@OriginalMember(owner = "client!j", name = "b", descriptor = "([B[IIIIIIIILclient!j;)I")
	public static int method2123(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub15_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt2392 += arg8.anInt2389 * (local22 - arg3);
		arg8.anInt2400 += arg8.anInt2394 * (local22 - arg3);
		local22 -= 3;
		@Pc(54) int local54;
		while (arg3 < local22) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!j", name = "b", descriptor = "(II[B[IIIIIIIILclient!j;II)I")
	public static int method2128(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub15_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt2392 -= arg8.anInt2389 * arg3;
		arg8.anInt2400 -= arg8.anInt2394 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!j", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!j;)I")
	public static int method2130(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub15_Sub1 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt2390 += arg10.anInt2393 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(64) byte local64;
	...
	@OriginalMember(owner = "client!j", name = "c", descriptor = "(II[B[IIIIIIIILclient!j;II)I")
	public static int method2131(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub15_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt2392 -= arg8.anInt2389 * arg3;
		arg8.anInt2400 -= arg8.anInt2394 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!j", name = "a", descriptor = "(I[B[IIIIIIIILclient!j;)I")
	public static int method2135(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub15_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!j", name = "b", descriptor = "(I[B[IIIIIIIILclient!j;)I")
	public static int method2137(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub15_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	public static int method2140(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!j", name = "b", descriptor = "([B[IIIIIIILclient!j;)I")
	public static int method2141(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub15_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!j", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!j;II)I")
	public static int method2145(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub15_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt2390 -= arg10.anInt2393 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!j", name = "b", descriptor = "(II[B[IIIIIIILclient!j;II)I")
	public static int method2146(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub15_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!j", name = "e", descriptor = "(II)I")
	public static int method2147(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!j", name = "a", descriptor = "(Lclient!qj;II)Lclient!j;")
	public static Class3_Sub15_Sub1 method2148(@OriginalArg(0) Class3_Sub11_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray59 == null || arg0.aByteArray59.length == 0 ? null : new Class3_Sub15_Sub1(arg0, (int) ((long) arg0.anInt4384 * 256L * (long) 100 / (long) (Static155.anInt2915 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!j", name = "d", descriptor = "(II[B[IIIIIIIILclient!j;II)I")
	public static int method2149(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub15_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
