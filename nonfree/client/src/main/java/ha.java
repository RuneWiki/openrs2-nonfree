...
public final class ha extends Class149 implements Interface2 {

	@OriginalMember(owner = "client!ha", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ha", name = "l", descriptor = "Lclient!oe;")
	private final Class181 aClass181_24 = new Class181();

	@OriginalMember(owner = "client!ha", name = "k", descriptor = "Lclient!qa;")
	...
	public void method3564(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aQa2.method4571().v(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public void method3572(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aQa2.method4571().A(this, arg0, arg1);
	}
	...
	public void method3569(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass181_24.method4108()];
		for (@Pc(13) Class1_Sub31 local13 = (Class1_Sub31) this.aClass181_24.method4112(); local13 != null; local13 = (Class1_Sub31) this.aClass181_24.method4104()) {
			local7[local1++] = local13.method5905();
		}
		this.W(local7);
	}
	...
	public native Class1_Sub2_Sub1 k(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class1_Sub2_Sub1 arg2);
	...
	public native void b(@OriginalArg(0) Class1_Sub2_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public native void p(@OriginalArg(0) Class1_Sub2_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	@OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lclient!qp;[I)V")
	@Override
	public void method3571(@OriginalArg(0) Class1_Sub31 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass181_24.method4102(arg0);
		this.G(arg0.hashCode(), arg0.method5906(), arg0.method5902(), arg0.method5904(), arg0.method5910(), arg0.method5907(), arg1);
	}
}
