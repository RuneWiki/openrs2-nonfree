...
public final class ha extends Class165 implements Interface3 {

	@OriginalMember(owner = "client!ha", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ha", name = "j", descriptor = "Lclient!fr;")
	private final Class85 aClass85_14 = new Class85();
	...
	public native void b(@OriginalArg(0) Class7_Sub4_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method3581(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aQa2.method4205().A(this, arg0, arg1);
	}
	...
	public native void p(@OriginalArg(0) Class7_Sub4_Sub2 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method3575(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass85_14.method2013()];
		for (@Pc(13) Class7_Sub30 local13 = (Class7_Sub30) this.aClass85_14.method2010(); local13 != null; local13 = (Class7_Sub30) this.aClass85_14.method2000()) {
			local7[local1++] = local13.method5024();
		}
		this.W(local7);
	}

	@OriginalMember(owner = "client!ha", name = "k", descriptor = "(IILclient!ba;)Lclient!ba;")
	public native Class7_Sub4_Sub2 k(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class7_Sub4_Sub2 arg2);
	...
	public void method3579(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aQa2.method4205().v(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
	...
	@OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lclient!wr;[I)V")
	@Override
	public void method3577(@OriginalArg(0) Class7_Sub30 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass85_14.method2011(arg0);
		this.G(arg0.hashCode(), arg0.method5032(), arg0.method5029(), arg0.method5023(), arg0.method5031(), arg0.method5025(), arg1);
	}
