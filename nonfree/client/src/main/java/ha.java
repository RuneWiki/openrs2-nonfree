...
public final class ha extends Class41 implements Interface1 {

	@OriginalMember(owner = "client!ha", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ha", name = "j", descriptor = "Lclient!ub;")
	...
	@OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lclient!ku;[I)V")
	@Override
	public void method5561(@OriginalArg(0) Class4_Sub7 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass244_12.method5273(arg0);
		this.G(arg0.hashCode(), arg0.method4451(), arg0.method4448(), arg0.method4449(), arg0.method4446(), arg0.method4445(), arg1);
	}
	...
	public void method5565(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass244_12.method5266()];
		for (@Pc(13) Class4_Sub7 local13 = (Class4_Sub7) this.aClass244_12.method5263(); local13 != null; local13 = (Class4_Sub7) this.aClass244_12.method5271()) {
			local7[local1++] = local13.method4454();
		}
		this.W(local7);
	}
	...
	public native void p(@OriginalArg(0) Class4_Sub2_Sub3 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public native void b(@OriginalArg(0) Class4_Sub2_Sub3 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method5560(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aQa2.method4224().A(this, arg0, arg1);
	}
	...
	public void method5563(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aQa2.method4224().v(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public native Class4_Sub2_Sub3 k(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class4_Sub2_Sub3 arg2);
