...
public final class ha extends Class64 implements Interface2 {

	@OriginalMember(owner = "client!ha", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ha", name = "j", descriptor = "Lclient!ar;")
	...
	public native void b(@OriginalArg(0) Class2_Sub5_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method2356(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aQa2.method4488().v(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public void method2354(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aQa2.method4488().A(this, arg0, arg1);
	}

	@OriginalMember(owner = "client!ha", name = "k", descriptor = "(IILclient!ba;)Lclient!ba;")
	public native Class2_Sub5_Sub1 k(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class2_Sub5_Sub1 arg2);
	...
	public void method2355(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass14_27.method297()];
		for (@Pc(13) Class2_Sub20 local13 = (Class2_Sub20) this.aClass14_27.method309(); local13 != null; local13 = (Class2_Sub20) this.aClass14_27.method311()) {
			local7[local1++] = local13.method5737();
		}
		this.W(local7);
	}

	@OriginalMember(owner = "client!ha", name = "p", descriptor = "(Lclient!ba;IIIIZ)V")
	public native void p(@OriginalArg(0) Class2_Sub5_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lclient!jd;[I)V")
	@Override
	public void method2349(@OriginalArg(0) Class2_Sub20 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass14_27.method300(arg0);
		this.G(arg0.hashCode(), arg0.method5740(), arg0.method5739(), arg0.method5741(), arg0.method5743(), arg0.method5735(), arg1);
	}
