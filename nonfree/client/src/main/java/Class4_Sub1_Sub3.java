...
public final class Class4_Sub1_Sub3 extends Class4_Sub1 {
	...
	@OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Lclient!jf;[B[III)V")
	public Class4_Sub1_Sub3(@OriginalArg(0) Class5_Sub3 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
	...
	protected void method7708(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		if (super.aClass5_Sub3_10.method4747()) {
			throw new IllegalStateException();
		} else if (arg2 > 0 && arg3 > 0) {
			@Pc(14) int local14 = 0;
			@Pc(16) int local16 = 0;
			@Pc(20) int local20 = super.aClass5_Sub3_10.anInt5670;
			@Pc(29) int local29 = super.anInt9446 + super.anInt9435 + super.anInt9455;
			@Pc(38) int local38 = super.anInt9439 + super.anInt9454 + super.anInt9447;
			@Pc(44) int local44 = (local29 << 16) / arg2;
			@Pc(50) int local50 = (local38 << 16) / arg3;
			@Pc(64) int local64;
			if (super.anInt9446 > 0) {
				local64 = ((super.anInt9446 << 16) + local44 - 1) / local44;
				arg0 += local64;
				local14 = local64 * local44 - (super.anInt9446 << 16);
			}
			if (super.anInt9439 > 0) {
				local64 = ((super.anInt9439 << 16) + local50 - 1) / local50;
				arg1 += local64;
				local16 = local64 * local50 - (super.anInt9439 << 16);
			}
			if (super.anInt9435 < local29) {
				arg2 = ((super.anInt9435 << 16) + local44 - local14 - 1) / local44;
			}
			if (super.anInt9454 < local38) {
				arg3 = ((super.anInt9454 << 16) + local50 - local16 - 1) / local50;
			}
			local64 = arg0 + arg1 * local20;
			@Pc(152) int local152 = local20 - arg2;
			if (arg1 + arg3 > super.aClass5_Sub3_10.anInt5661) {
				arg3 -= arg1 + arg3 - super.aClass5_Sub3_10.anInt5661;
			}
			@Pc(180) int local180;
			if (arg1 < super.aClass5_Sub3_10.anInt5663) {
				local180 = super.aClass5_Sub3_10.anInt5663 - arg1;
				arg3 -= local180;
				local64 += local180 * local20;
				local16 += local50 * local180;
			}
			if (arg0 + arg2 > super.aClass5_Sub3_10.anInt5672) {
				local180 = arg0 + arg2 - super.aClass5_Sub3_10.anInt5672;
				arg2 -= local180;
				local152 += local180;
			}
			if (arg0 < super.aClass5_Sub3_10.anInt5674) {
				local180 = super.aClass5_Sub3_10.anInt5674 - arg0;
				arg2 -= local180;
				local64 += local180;
				local14 += local44 * local180;
				local152 += local180;
			}
			@Pc(252) int[] local252 = super.aClass5_Sub3_10.anIntArray235;
			@Pc(259) int local259;
			@Pc(262) int local262;
			@Pc(270) int local270;
			@Pc(273) int local273;
			...
			if (arg6 != 0) {
				...
				if (arg6 == 1) {
					if (arg4 == 1) {
						...
						for (local262 = -arg3; local262 < 0; local262++) {
							local270 = (local16 >> 16) * super.anInt9435;
							for (local273 = -arg2; local273 < 0; local273++) {
								local446 = this.aByteArray92[(local14 >> 16) + local270];
								if (local446 == 0) {
									local64++;
								} else {
									local252[local64++] = this.anIntArray501[local446 & 0xFF];
								}
								local14 += local44;
							}
							local16 += local50;
						...
						if (arg4 == 0) {
							...
							if ((arg5 & 0xFFFFFF) == 16777215) {
								...
								for (local273 = -arg3; local273 < 0; local273++) {
									local335 = (local16 >> 16) * super.anInt9435;
									for (local343 = -arg2; local343 < 0; local343++) {
										local735 = this.aByteArray92[(local14 >> 16) + local335];
										if (local735 == 0) {
											local64++;
										} else {
											local361 = this.anIntArray501[local735 & 0xFF];
								...
								for (local346 = -arg3; local346 < 0; local346++) {
									local361 = (local16 >> 16) * super.anInt9435;
									for (local369 = -arg2; local369 < 0; local369++) {
										@Pc(852) byte local852 = this.aByteArray92[(local14 >> 16) + local361];
										if (local852 == 0) {
											local64++;
										} else {
											local385 = this.anIntArray501[local852 & 0xFF];
											if (local335 == 255) {
							...
							for (local273 = -arg3; local273 < 0; local273++) {
								...
								for (local343 = -arg2; local343 < 0; local343++) {
									local735 = this.aByteArray92[(local14 >> 16) + local335];
									local361 = local735 > 0 ? this.anIntArray501[local735] : 0;
							...
							for (local343 = -arg3; local343 < 0; local343++) {
								local346 = (local16 >> 16) * super.anInt9435;
								for (local361 = -arg2; local361 < 0; local361++) {
									local1196 = this.aByteArray92[(local14 >> 16) + local346];
									if (local1196 == 0) {
										local64++;
									} else {
										local377 = this.anIntArray501[local1196 & 0xFF];
					...
					for (local262 = -arg3; local262 < 0; local262++) {
						...
						for (local273 = -arg2; local273 < 0; local273++) {
							...
							if (local446 == 0) {
								...
								local343 = this.anIntArray501[local446 & 0xFF];
					...
					for (local335 = -arg3; local335 < 0; local335++) {
						local343 = (local16 >> 16) * super.anInt9435;
						for (local346 = -arg2; local346 < 0; local346++) {
							@Pc(1406) byte local1406 = this.aByteArray92[(local14 >> 16) + local343];
							if (local1406 == 0) {
								local64++;
							} else {
								local369 = this.anIntArray501[local1406 & 0xFF];
					...
					for (local262 = -arg3; local262 < 0; local262++) {
						...
						for (local273 = -arg2; local273 < 0; local273++) {
							local446 = this.aByteArray92[(local14 >> 16) + local270];
							local343 = local446 > 0 ? this.anIntArray501[local446] : 0;
				...
				for (local262 = -arg3; local262 < 0; local262++) {
					local270 = (local16 >> 16) * super.anInt9435;
					for (local273 = -arg2; local273 < 0; local273++) {
						local252[local64++] = this.anIntArray501[this.aByteArray92[(local14 >> 16) + local270] & 0xFF];
						local14 += local44;
					}
					local16 += local50;
					local14 = local259;
				...
				for (local335 = -arg3; local335 < 0; local335++) {
					local343 = (local16 >> 16) * super.anInt9435;
					for (local346 = -arg2; local346 < 0; local346++) {
						local361 = this.anIntArray501[this.aByteArray92[(local14 >> 16) + local343] & 0xFF];
				...
				for (local343 = -arg3; local343 < 0; local343++) {
					local346 = (local16 >> 16) * super.anInt9435;
					for (local361 = -arg2; local361 < 0; local361++) {
						local369 = this.anIntArray501[this.aByteArray92[(local14 >> 16) + local346] & 0xFF];
	...
	@Override
	public void method7713(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg3 <= 0 || arg4 <= 0) {
			return;
		}
		@Pc(6) int local6 = 0;
		@Pc(8) int local8 = 0;
		@Pc(17) int local17 = super.anInt9446 + super.anInt9435 + super.anInt9455;
		@Pc(26) int local26 = super.anInt9439 + super.anInt9454 + super.anInt9447;
		@Pc(32) int local32 = (local17 << 16) / arg3;
		@Pc(38) int local38 = (local26 << 16) / arg4;
		@Pc(52) int local52;
		if (super.anInt9446 > 0) {
			local52 = ((super.anInt9446 << 16) + local32 - 1) / local32;
			arg0 += local52;
			local6 = local52 * local32 - (super.anInt9446 << 16);
		}
		if (super.anInt9439 > 0) {
			local52 = ((super.anInt9439 << 16) + local38 - 1) / local38;
			arg1 += local52;
			local8 = local52 * local38 - (super.anInt9439 << 16);
		}
		if (super.anInt9435 < local17) {
			arg3 = ((super.anInt9435 << 16) + local32 - local6 - 1) / local32;
		}
		if (super.anInt9454 < local26) {
			arg4 = ((super.anInt9454 << 16) + local38 - local8 - 1) / local38;
		}
		local52 = arg0 + arg1 * super.aClass5_Sub3_10.anInt5670;
		@Pc(144) int local144 = super.aClass5_Sub3_10.anInt5670 - arg3;
		if (arg1 + arg4 > super.aClass5_Sub3_10.anInt5661) {
			arg4 -= arg1 + arg4 - super.aClass5_Sub3_10.anInt5661;
		}
		@Pc(172) int local172;
		if (arg1 < super.aClass5_Sub3_10.anInt5663) {
			local172 = super.aClass5_Sub3_10.anInt5663 - arg1;
			arg4 -= local172;
			local52 += local172 * super.aClass5_Sub3_10.anInt5670;
			local8 += local38 * local172;
		}
		if (arg0 + arg3 > super.aClass5_Sub3_10.anInt5672) {
			local172 = arg0 + arg3 - super.aClass5_Sub3_10.anInt5672;
			arg3 -= local172;
			local144 += local172;
		}
		if (arg0 < super.aClass5_Sub3_10.anInt5674) {
			local172 = super.aClass5_Sub3_10.anInt5674 - arg0;
			arg3 -= local172;
			local52 += local172;
			local6 += local32 * local172;
			local144 += local172;
		}
		@Pc(246) float[] local246 = super.aClass5_Sub3_10.aFloatArray54;
		@Pc(250) int[] local250 = super.aClass5_Sub3_10.anIntArray235;
		@Pc(257) int local257;
		@Pc(260) int local260;
		@Pc(268) int local268;
		@Pc(271) int local271;
		...
		if (arg7 != 0) {
			...
			if (arg7 == 1) {
				if (arg5 == 1) {
					...
					for (local260 = -arg4; local260 < 0; local260++) {
						local268 = (local8 >> 16) * super.anInt9435;
						for (local271 = -arg3; local271 < 0; local271++) {
							if ((float) arg2 < local246[local52]) {
								local475 = this.aByteArray92[(local6 >> 16) + local268];
								if (local475 != 0) {
									local250[local52] = this.anIntArray501[local475 & 0xFF];
					...
					if (arg5 == 0) {
						...
						if ((arg6 & 0xFFFFFF) == 16777215) {
							...
							for (local271 = -arg4; local271 < 0; local271++) {
								local345 = (local8 >> 16) * super.anInt9435;
								for (local353 = -arg3; local353 < 0; local353++) {
									if ((float) arg2 < local246[local52]) {
										local798 = this.aByteArray92[(local6 >> 16) + local345];
										if (local798 != 0) {
											local378 = this.anIntArray501[local798 & 0xFF];
							...
							for (local356 = -arg4; local356 < 0; local356++) {
								local378 = (local8 >> 16) * super.anInt9435;
								for (local386 = -arg3; local386 < 0; local386++) {
									if ((float) arg2 < local246[local52]) {
										@Pc(925) byte local925 = this.aByteArray92[(local6 >> 16) + local378];
										if (local925 != 0) {
											local402 = this.anIntArray501[local925 & 0xFF];
											if (local345 == 255) {
						...
						for (local271 = -arg4; local271 < 0; local271++) {
							...
							for (local353 = -arg3; local353 < 0; local353++) {
								if ((float) arg2 < local246[local52]) {
									local798 = this.aByteArray92[(local6 >> 16) + local345];
									local378 = local798 > 0 ? this.anIntArray501[local798] : 0;
						...
						for (local353 = -arg4; local353 < 0; local353++) {
							local356 = (local8 >> 16) * super.anInt9435;
							for (local378 = -arg3; local378 < 0; local378++) {
								if ((float) arg2 < local246[local52]) {
									local1295 = this.aByteArray92[(local6 >> 16) + local356];
									if (local1295 != 0) {
										local394 = this.anIntArray501[local1295 & 0xFF];
				...
				for (local260 = -arg4; local260 < 0; local260++) {
					...
					for (local271 = -arg3; local271 < 0; local271++) {
						if ((float) arg2 < local246[local52]) {
							local475 = this.aByteArray92[(local6 >> 16) + local268];
							if (local475 != 0) {
								local353 = this.anIntArray501[local475 & 0xFF];
				...
				for (local345 = -arg4; local345 < 0; local345++) {
					local353 = (local8 >> 16) * super.anInt9435;
					for (local356 = -arg3; local356 < 0; local356++) {
						if ((float) arg2 < local246[local52]) {
							@Pc(1525) byte local1525 = this.aByteArray92[(local6 >> 16) + local353];
							if (local1525 != 0) {
								local386 = this.anIntArray501[local1525 & 0xFF];
				...
				for (local260 = -arg4; local260 < 0; local260++) {
					...
					for (local271 = -arg3; local271 < 0; local271++) {
						if ((float) arg2 < local246[local52]) {
							local475 = this.aByteArray92[(local6 >> 16) + local268];
							local353 = local475 > 0 ? this.anIntArray501[local475] : 0;
			...
			for (local260 = -arg4; local260 < 0; local260++) {
				...
				for (local271 = -arg3; local271 < 0; local271++) {
					if ((float) arg2 < local246[local52]) {
						local250[local52] = this.anIntArray501[this.aByteArray92[(local6 >> 16) + local268] & 0xFF];
						local246[local52] = (float) arg2;
					}
					local6 += local32;
					local52++;
			...
			for (local345 = -arg4; local345 < 0; local345++) {
				...
				for (local356 = -arg3; local356 < 0; local356++) {
					if ((float) arg2 < local246[local52]) {
						local378 = this.anIntArray501[this.aByteArray92[(local6 >> 16) + local353] & 0xFF];
			...
			for (local353 = -arg4; local353 < 0; local353++) {
				...
				for (local378 = -arg3; local378 < 0; local378++) {
					if ((float) arg2 < local246[local52]) {
						local386 = this.anIntArray501[this.aByteArray92[(local6 >> 16) + local356] & 0xFF];
	...
	@OriginalMember(owner = "client!ti", name = "a", descriptor = "(IILclient!aa;II)V")
	@Override
	public void method7692(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class1 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		arg0 += super.anInt9446;
		arg1 += super.anInt9439;
		@Pc(19) int local19 = 0;
		@Pc(23) int local23 = super.aClass5_Sub3_10.anInt5670;
		@Pc(26) int local26 = super.anInt9435;
		@Pc(29) int local29 = super.anInt9454;
		@Pc(33) int local33 = local23 - local26;
		@Pc(35) int local35 = 0;
		@Pc(41) int local41 = arg0 + arg1 * local23;
		@Pc(52) int local52;
		if (arg1 < super.aClass5_Sub3_10.anInt5663) {
			local52 = super.aClass5_Sub3_10.anInt5663 - arg1;
			local29 -= local52;
			arg1 = super.aClass5_Sub3_10.anInt5663;
			local19 = local52 * local26;
			local41 += local52 * local23;
		}
		if (arg1 + local29 > super.aClass5_Sub3_10.anInt5661) {
			local29 -= arg1 + local29 - super.aClass5_Sub3_10.anInt5661;
		}
		if (arg0 < super.aClass5_Sub3_10.anInt5674) {
			local52 = super.aClass5_Sub3_10.anInt5674 - arg0;
			local26 -= local52;
			arg0 = super.aClass5_Sub3_10.anInt5674;
			local19 += local52;
			local41 += local52;
			local35 = local52;
			local33 += local52;
		}
		if (arg0 + local26 > super.aClass5_Sub3_10.anInt5672) {
			local52 = arg0 + local26 - super.aClass5_Sub3_10.anInt5672;
			local26 -= local52;
			local35 += local52;
			local33 += local52;
		}
		...
		@Pc(162) int[] local162 = local159.anIntArray212;
		@Pc(165) int[] local165 = local159.anIntArray213;
		@Pc(169) int[] local169 = super.aClass5_Sub3_10.anIntArray235;
		@Pc(171) int local171 = arg1;
		if (arg4 > arg1) {
			local171 = arg4;
			local41 += (arg4 - arg1) * local23;
			local19 += (arg4 - arg1) * super.anInt9435;
		}
		...
		for (@Pc(212) int local212 = local171; local212 < local210; local212++) {
			...
			for (@Pc(304) int local304 = -local227; local304 < 0; local304++) {
				@Pc(311) byte local311 = this.aByteArray92[local19++];
				if (local311 == 0) {
					local41++;
				} else {
					local169[local41++] = this.anIntArray501[local311 & 0xFF];
				}
			}
	...
	@Override
	protected void method7715(@OriginalArg(0) int arg0) {
		@Pc(3) int[] local3 = super.aClass5_Sub3_10.anIntArray235;
		@Pc(935) int local935;
		@Pc(9) int local9;
		@Pc(12) int local12;
		@Pc(14) int local14;
		...
		@Pc(272) int local272;
		@Pc(344) int local344;
		if (Static488.anInt9444 == 0) {
			if (Static488.anInt9437 == 0) {
				local9 = Static488.anInt9433;
				while (local9 < 0) {
					local12 = Static488.anInt9451;
					local14 = Static488.anInt9450;
					local16 = Static488.anInt9443;
					local18 = Static488.anInt9448;
					if (local14 >= 0 && local16 >= 0 && local14 - (super.anInt9435 << 12) < 0 && local16 - (super.anInt9454 << 12) < 0) {
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt9435 + (local14 >> 12);
							local51 = local12++;
							if (arg0 == 1) {
								local227 = this.aByteArray92[local48];
								if (local227 != 0) {
									local3[local51] = this.anIntArray501[local227 & 0xFF];
								}
							} else if (arg0 == 0) {
								local227 = this.aByteArray92[local48];
								if (local227 != 0) {
									local255 = this.anIntArray501[local227 & 0xFF];
									if ((Static488.anInt9434 & 0xFFFFFF) == 16777215) {
										local264 = Static488.anInt9434 >>> 24;
									...
									} else if (Static488.anInt9449 == 255) {
										local264 = (local255 & 0xFF0000) * Static488.anInt9436 & 0xFF000000;
										local268 = (local255 & 0xFF00) * Static488.anInt9457 & 0xFF0000;
										local272 = (local255 & 0xFF) * Static488.anInt9429 & 0xFF00;
										...
										local3[local51] = ((local255 & 0xFF00FF) * Static488.anInt9449 + (local344 & 0xFF00FF) * Static488.anInt9442 & 0xFF00FF00) + ((local255 & 0xFF00) * Static488.anInt9449 + (local344 & 0xFF00) * Static488.anInt9442 & 0xFF0000) >> 8;
									}
								}
							} else if (arg0 == 3) {
								local227 = this.aByteArray92[local48];
								local255 = local227 > 0 ? this.anIntArray501[local227] : 0;
								local264 = Static488.anInt9434;
								...
								if (local255 == 0 && Static488.anInt9449 != 255) {
									local255 = local344;
									local344 = local3[local51];
									local344 = ((local255 & 0xFF00FF) * Static488.anInt9449 + (local344 & 0xFF00FF) * Static488.anInt9442 & 0xFF00FF00) + ((local255 & 0xFF00) * Static488.anInt9449 + (local344 & 0xFF00) * Static488.anInt9442 & 0xFF0000) >> 8;
								}
								...
								if (local227 != 0) {
									local255 = this.anIntArray501[local227 & 0xFF];
									local264 = (local255 & 0xFF00FF) * Static488.anInt9449 & 0xFF00FF00;
									local268 = (local255 & 0xFF00) * Static488.anInt9449 & 0xFF0000;
									local3[local51++] = ((local264 | local268) >>> 8) + Static488.anInt9440;
								}
							} else {
								throw new IllegalArgumentException();
							}
					...
					local9++;
					Static488.anInt9451 += Static488.anInt9438;
				}
			} else if (Static488.anInt9437 < 0) {
				local9 = Static488.anInt9433;
				while (local9 < 0) {
					local12 = Static488.anInt9451;
					local14 = Static488.anInt9450;
					local16 = Static488.anInt9443 + Static488.anInt9456;
					local18 = Static488.anInt9448;
					if (local14 >= 0 && local14 - (super.anInt9435 << 12) < 0) {
						@Pc(928) int local928;
						if ((local928 = local16 - (super.anInt9454 << 12)) >= 0) {
							local935 = (Static488.anInt9437 - local928) / Static488.anInt9437;
							local18 += local935;
							local16 += Static488.anInt9437 * local935;
							local12 += local935;
						}
						@Pc(956) int local956;
						if ((local956 = (local16 - Static488.anInt9437) / Static488.anInt9437) > local18) {
							local18 = local956;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt9435 + (local14 >> 12);
							...
							local16 += Static488.anInt9437;
							local18++;
						}
					}
					local9++;
					Static488.anInt9450 += Static488.anInt9441;
					Static488.anInt9451 += Static488.anInt9438;
				}
			} else {
				local9 = Static488.anInt9433;
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt9435 << 12) < 0) {
						if (local16 < 0) {
							local935 = (Static488.anInt9437 - local16 - 1) / Static488.anInt9437;
							local18 += local935;
							local16 += Static488.anInt9437 * local935;
							local12 += local935;
						}
						@Pc(1888) int local1888;
						if ((local1888 = (local16 + 1 - (super.anInt9454 << 12) - Static488.anInt9437) / Static488.anInt9437) > local18) {
							local18 = local1888;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt9435 + (local14 >> 12);
		...
		} else if (Static488.anInt9444 < 0) {
			if (Static488.anInt9437 == 0) {
				local9 = Static488.anInt9433;
				while (local9 < 0) {
					local12 = Static488.anInt9451;
					local14 = Static488.anInt9450 + Static488.anInt9427;
					local16 = Static488.anInt9443;
					local18 = Static488.anInt9448;
					if (local16 >= 0 && local16 - (super.anInt9454 << 12) < 0) {
						@Pc(2794) int local2794;
						if ((local2794 = local14 - (super.anInt9435 << 12)) >= 0) {
							local935 = (Static488.anInt9444 - local2794) / Static488.anInt9444;
							local18 += local935;
							local14 += Static488.anInt9444 * local935;
							local12 += local935;
						}
						@Pc(2822) int local2822;
						if ((local2822 = (local14 - Static488.anInt9444) / Static488.anInt9444) > local18) {
							local18 = local2822;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt9435 + (local14 >> 12);
							...
							local14 += Static488.anInt9444;
							local18++;
						}
					}
					local9++;
					Static488.anInt9443 += Static488.anInt9430;
					Static488.anInt9451 += Static488.anInt9438;
				}
			} else if (Static488.anInt9437 < 0) {
				local9 = Static488.anInt9433;
				while (local9 < 0) {
					...
					if ((local3719 = local14 - (super.anInt9435 << 12)) >= 0) {
						local935 = (Static488.anInt9444 - local3719) / Static488.anInt9444;
						local18 += local935;
						local14 += Static488.anInt9444 * local935;
						local16 += Static488.anInt9437 * local935;
						local12 += local935;
					...
					if ((local3753 = (local14 - Static488.anInt9444) / Static488.anInt9444) > local18) {
						local18 = local3753;
					}
					@Pc(3765) int local3765;
					if ((local3765 = local16 - (super.anInt9454 << 12)) >= 0) {
						local935 = (Static488.anInt9437 - local3765) / Static488.anInt9437;
						local18 += local935;
						local14 += Static488.anInt9444 * local935;
						local16 += Static488.anInt9437 * local935;
						local12 += local935;
					...
					if ((local3799 = (local16 - Static488.anInt9437) / Static488.anInt9437) > local18) {
						local18 = local3799;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt9435 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local4702 = local14 - (super.anInt9435 << 12)) >= 0) {
						local935 = (Static488.anInt9444 - local4702) / Static488.anInt9444;
						local18 += local935;
						local14 += Static488.anInt9444 * local935;
						local16 += Static488.anInt9437 * local935;
						local12 += local935;
					...
					if ((local4736 = (local14 - Static488.anInt9444) / Static488.anInt9444) > local18) {
						local18 = local4736;
					}
					if (local16 < 0) {
						local935 = (Static488.anInt9437 - local16 - 1) / Static488.anInt9437;
					...
					if ((local4784 = (local16 + 1 - (super.anInt9454 << 12) - Static488.anInt9437) / Static488.anInt9437) > local18) {
						local18 = local4784;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt9435 + (local14 >> 12);
			...
			while (local9 < 0) {
				...
				if (local16 >= 0 && local16 - (super.anInt9454 << 12) < 0) {
					if (local14 < 0) {
						local935 = (Static488.anInt9444 - local14 - 1) / Static488.anInt9444;
						local18 += local935;
						local14 += Static488.anInt9444 * local935;
						local12 += local935;
					}
					@Pc(5726) int local5726;
					if ((local5726 = (local14 + 1 - (super.anInt9435 << 12) - Static488.anInt9444) / Static488.anInt9444) > local18) {
						local18 = local5726;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt9435 + (local14 >> 12);
			...
			for (local9 = Static488.anInt9433; local9 < 0; local9++) {
				local12 = Static488.anInt9451;
				local14 = Static488.anInt9450 + Static488.anInt9427;
				local16 = Static488.anInt9443 + Static488.anInt9456;
				local18 = Static488.anInt9448;
				...
				if ((local6663 = (local14 + 1 - (super.anInt9435 << 12) - Static488.anInt9444) / Static488.anInt9444) > local18) {
					local18 = local6663;
				}
				@Pc(6675) int local6675;
				if ((local6675 = local16 - (super.anInt9454 << 12)) >= 0) {
					local935 = (Static488.anInt9437 - local6675) / Static488.anInt9437;
					local18 += local935;
					local14 += Static488.anInt9444 * local935;
					local16 += Static488.anInt9437 * local935;
					local12 += local935;
				...
				if ((local6709 = (local16 - Static488.anInt9437) / Static488.anInt9437) > local18) {
					local18 = local6709;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt9435 + (local14 >> 12);
			...
			for (local9 = Static488.anInt9433; local9 < 0; local9++) {
				...
				if ((local7648 = (local14 + 1 - (super.anInt9435 << 12) - Static488.anInt9444) / Static488.anInt9444) > local18) {
					local18 = local7648;
				}
				if (local16 < 0) {
					local935 = (Static488.anInt9437 - local16 - 1) / Static488.anInt9437;
				...
				if ((local7696 = (local16 + 1 - (super.anInt9454 << 12) - Static488.anInt9437) / Static488.anInt9437) > local18) {
					local18 = local7696;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt9435 + (local14 >> 12);
	...
	public void method7711(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		@Pc(11) int local11 = super.aClass5_Sub3_10.anInt5670;
		arg0 += super.anInt9446;
		arg1 += super.anInt9439;
		@Pc(27) int local27 = arg1 * local11 + arg0;
		@Pc(29) int local29 = 0;
		@Pc(32) int local32 = super.anInt9454;
		@Pc(35) int local35 = super.anInt9435;
		...
		if (arg1 + local32 > super.aClass5_Sub3_10.anInt5661) {
			local32 -= arg1 + local32 - super.aClass5_Sub3_10.anInt5661;
		}
		if (arg0 < super.aClass5_Sub3_10.anInt5674) {
			local52 = super.aClass5_Sub3_10.anInt5674 - arg0;
			local35 -= local52;
		...
		if (arg0 + local35 > super.aClass5_Sub3_10.anInt5672) {
			local52 = arg0 + local35 - super.aClass5_Sub3_10.anInt5672;
			local35 -= local52;
			local41 += local52;
			local39 += local52;
		}
		...
		@Pc(160) int[] local160 = super.aClass5_Sub3_10.anIntArray235;
		@Pc(168) int local168;
		@Pc(175) int local175;
		@Pc(284) int local284;
		@Pc(287) int local287;
		...
		if (arg4 != 0) {
			...
			if (arg4 == 1) {
				if (arg2 == 1) {
					for (local168 = -local32; local168 < 0; local168++) {
						for (local175 = -local35; local175 < 0; local175++) {
							local543 = this.aByteArray92[local29++];
							if (local543 == 0) {
								local27++;
							} else {
								local287 = this.anIntArray501[local543 & 0xFF] | 0xFF000000;
					...
					if (arg2 == 0) {
						if ((arg3 & 0xFFFFFF) == 16777215) {
							...
							for (local284 = -local32; local284 < 0; local284++) {
								for (local287 = -local35; local287 < 0; local287++) {
									local645 = this.aByteArray92[local29++];
									if (local645 == 0) {
										local27++;
									} else {
										local303 = this.anIntArray501[local645 & 0xFF];
										local311 = local160[local27];
							...
							for (local303 = -local32; local303 < 0; local303++) {
								for (local311 = -local35; local311 < 0; local311++) {
									@Pc(746) byte local746 = this.aByteArray92[local29++];
									if (local746 == 0) {
										local27++;
									} else {
										local327 = this.anIntArray501[local746 & 0xFF];
										if (local287 == 255) {
						...
						for (local284 = -local32; local284 < 0; local284++) {
							for (local287 = -local35; local287 < 0; local287++) {
								local645 = this.aByteArray92[local29++];
								local303 = local645 > 0 ? this.anIntArray501[local645] : 0;
						...
						for (local291 = -local32; local291 < 0; local291++) {
							for (local303 = -local35; local303 < 0; local303++) {
								local1054 = this.aByteArray92[local29++];
								if (local1054 == 0) {
									local27++;
								} else {
									local319 = this.anIntArray501[local1054 & 0xFF];
				...
				for (local168 = -local32; local168 < 0; local168++) {
					for (local175 = -local35; local175 < 0; local175++) {
						...
						if (local543 == 0) {
							...
							local287 = this.anIntArray501[local543 & 0xFF];
				...
				for (local287 = -local32; local287 < 0; local287++) {
					for (local291 = -local35; local291 < 0; local291++) {
						@Pc(1228) byte local1228 = this.aByteArray92[local29++];
						if (local1228 == 0) {
							local27++;
						} else {
							local311 = this.anIntArray501[local1228 & 0xFF];
				...
				for (local168 = -local32; local168 < 0; local168++) {
					for (local175 = -local35; local175 < 0; local175++) {
						local543 = this.aByteArray92[local29++];
						local287 = local543 > 0 ? this.anIntArray501[local543] : 0;
			...
			for (local168 = -local32; local168 < 0; local168++) {
				...
				while (local27 < local175) {
					local160[local27++] = this.anIntArray501[this.aByteArray92[local29++] & 0xFF];
					local160[local27++] = this.anIntArray501[this.aByteArray92[local29++] & 0xFF];
					local160[local27++] = this.anIntArray501[this.aByteArray92[local29++] & 0xFF];
					local160[local27++] = this.anIntArray501[this.aByteArray92[local29++] & 0xFF];
				}
			...
			for (local287 = -local32; local287 < 0; local287++) {
				for (local291 = -local35; local291 < 0; local291++) {
					local303 = this.anIntArray501[this.aByteArray92[local29++] & 0xFF];
			...
			for (local168 = -local32; local168 < 0; local168++) {
				for (local175 = -local35; local175 < 0; local175++) {
					local284 = this.anIntArray501[this.aByteArray92[local29++] & 0xFF];
			...
			for (local291 = -local32; local291 < 0; local291++) {
				for (local303 = -local35; local303 < 0; local303++) {
					local311 = this.anIntArray501[this.aByteArray92[local29++] & 0xFF];
	...
	@Override
	protected void method7714(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(3) int[] local3 = super.aClass5_Sub3_10.anIntArray235;
		@Pc(186) int local186;
		@Pc(9) int local9;
		@Pc(14) int local14;
		...
		if (Static488.anInt9444 == 0) {
			if (Static488.anInt9437 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local23 = Static488.anInt9451;
						local25 = Static488.anInt9450;
						local27 = Static488.anInt9443;
						local29 = Static488.anInt9448;
						if (local25 >= 0 && local27 >= 0 && local25 - (super.anInt9435 << 12) < 0 && local27 - (super.anInt9454 << 12) < 0) {
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
							local64 = local53 + Static488.anInt9451 - local23;
							if (local64 > 0) {
								local23 += local64;
								local29 += local64;
								local25 += Static488.anInt9444 * local64;
								local27 += Static488.anInt9437 * local64;
							} else {
								local58 -= local64;
							}
							if (local29 < local58) {
							...
							while (local29 < 0) {
								local111 = this.aByteArray92[(local27 >> 12) * super.anInt9435 + (local25 >> 12)];
								if (local111 == 0) {
									local23++;
								} else {
									local3[local23++] = this.anIntArray501[local111 & 0xFF];
								}
								local29++;
							}
						}
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local23 = Static488.anInt9451;
						local25 = Static488.anInt9450;
						local27 = Static488.anInt9443 + Static488.anInt9456;
						local29 = Static488.anInt9448;
						if (local25 >= 0 && local25 - (super.anInt9435 << 12) < 0) {
							@Pc(179) int local179;
							if ((local179 = local27 - (super.anInt9454 << 12)) >= 0) {
								local186 = (Static488.anInt9437 - local179) / Static488.anInt9437;
								local29 += local186;
								local27 += Static488.anInt9437 * local186;
								local23 += local186;
							}
							@Pc(207) int local207;
							if ((local207 = (local27 - Static488.anInt9437) / Static488.anInt9437) > local29) {
								local29 = local207;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt9435 << 12) < 0) {
							if (local27 < 0) {
								local186 = (Static488.anInt9437 - local27 - 1) / Static488.anInt9437;
								local29 += local186;
								local27 += Static488.anInt9437 * local186;
								local23 += local186;
							}
							@Pc(379) int local379;
							if ((local379 = (local27 + 1 - (super.anInt9454 << 12) - Static488.anInt9437) / Static488.anInt9437) > local29) {
								local29 = local379;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
			...
			if (Static488.anInt9437 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local23 = Static488.anInt9451;
						local25 = Static488.anInt9450 + Static488.anInt9427;
						local27 = Static488.anInt9443;
						local29 = Static488.anInt9448;
						if (local27 >= 0 && local27 - (super.anInt9454 << 12) < 0) {
							@Pc(525) int local525;
							if ((local525 = local25 - (super.anInt9435 << 12)) >= 0) {
								local186 = (Static488.anInt9444 - local525) / Static488.anInt9444;
								local29 += local186;
								local25 += Static488.anInt9444 * local186;
								local23 += local186;
							}
							@Pc(553) int local553;
							if ((local553 = (local25 - Static488.anInt9444) / Static488.anInt9444) > local29) {
								local29 = local553;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static488.anInt9448;
						@Pc(690) int local690;
						if ((local690 = local25 - (super.anInt9435 << 12)) >= 0) {
							local186 = (Static488.anInt9444 - local690) / Static488.anInt9444;
							local29 += local186;
							local25 += Static488.anInt9444 * local186;
							local27 += Static488.anInt9437 * local186;
							local23 += local186;
						...
						@Pc(724) int local724;
						if ((local724 = (local25 - Static488.anInt9444) / Static488.anInt9444) > local29) {
							local29 = local724;
						}
						@Pc(736) int local736;
						if ((local736 = local27 - (super.anInt9454 << 12)) >= 0) {
							local186 = (Static488.anInt9437 - local736) / Static488.anInt9437;
							local29 += local186;
							local25 += Static488.anInt9444 * local186;
							local27 += Static488.anInt9437 * local186;
							local23 += local186;
						...
						@Pc(770) int local770;
						if ((local770 = (local27 - Static488.anInt9437) / Static488.anInt9437) > local29) {
							local29 = local770;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static488.anInt9448;
						@Pc(913) int local913;
						if ((local913 = local25 - (super.anInt9435 << 12)) >= 0) {
							local186 = (Static488.anInt9444 - local913) / Static488.anInt9444;
							local29 += local186;
							local25 += Static488.anInt9444 * local186;
							local27 += Static488.anInt9437 * local186;
							local23 += local186;
						...
						@Pc(947) int local947;
						if ((local947 = (local25 - Static488.anInt9444) / Static488.anInt9444) > local29) {
							local29 = local947;
						}
						if (local27 < 0) {
							local186 = (Static488.anInt9437 - local27 - 1) / Static488.anInt9437;
						...
						@Pc(995) int local995;
						if ((local995 = (local27 + 1 - (super.anInt9454 << 12) - Static488.anInt9437) / Static488.anInt9437) > local29) {
							local29 = local995;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if (local27 >= 0 && local27 - (super.anInt9454 << 12) < 0) {
						if (local25 < 0) {
							local186 = (Static488.anInt9444 - local25 - 1) / Static488.anInt9444;
							local29 += local186;
							local25 += Static488.anInt9444 * local186;
							local23 += local186;
						}
						@Pc(1177) int local1177;
						if ((local1177 = (local25 + 1 - (super.anInt9435 << 12) - Static488.anInt9444) / Static488.anInt9444) > local29) {
							local29 = local1177;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1354 = (local25 + 1 - (super.anInt9435 << 12) - Static488.anInt9444) / Static488.anInt9444) > local29) {
						local29 = local1354;
					}
					@Pc(1366) int local1366;
					if ((local1366 = local27 - (super.anInt9454 << 12)) >= 0) {
						local186 = (Static488.anInt9437 - local1366) / Static488.anInt9437;
						local29 += local186;
						local25 += Static488.anInt9444 * local186;
						local27 += Static488.anInt9437 * local186;
						local23 += local186;
					...
					if ((local1400 = (local27 - Static488.anInt9437) / Static488.anInt9437) > local29) {
						local29 = local1400;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1579 = (local25 + 1 - (super.anInt9435 << 12) - Static488.anInt9444) / Static488.anInt9444) > local29) {
						local29 = local1579;
					}
					if (local27 < 0) {
						local186 = (Static488.anInt9437 - local27 - 1) / Static488.anInt9437;
					...
					if ((local1627 = (local27 + 1 - (super.anInt9454 << 12) - Static488.anInt9437) / Static488.anInt9437) > local29) {
						local29 = local1627;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
