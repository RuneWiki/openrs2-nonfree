...
public final class Static134 {
	...
	@OriginalMember(owner = "client!nb", name = "a", descriptor = "(II[B[IIIIIIILclient!nb;II)I")
	public static int method1165(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub16_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!nb", name = "a", descriptor = "([B[IIIIIIIILclient!nb;)I")
	public static int method1166(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub16_Sub1 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt1661 += arg8.anInt1655 * (local22 - arg3);
		arg8.anInt1660 += arg8.anInt1662 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt1653 = arg4 >> 2;
		arg8.anInt1663 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!nb", name = "a", descriptor = "(II[B[IIIIIIIILclient!nb;II)I")
	public static int method1167(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub16_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1661 -= arg8.anInt1655 * arg3;
		arg8.anInt1660 -= arg8.anInt1662 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!nb", name = "a", descriptor = "([B[IIIIIIILclient!nb;)I")
	public static int method1171(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub16_Sub1 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt1663 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!nb", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!nb;II)I")
	public static int method1176(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub16_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1653 -= arg10.anInt1664 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt1653 += arg10.anInt1664 * local63;
		arg10.anInt1661 = arg4;
		arg10.anInt1660 = arg5;
		arg10.anInt1663 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!nb", name = "b", descriptor = "(II[B[IIIIIIIILclient!nb;II)I")
	public static int method1177(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub16_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	public static int method1178(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!nb", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!nb;)I")
	public static int method1179(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub16_Sub1 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt1653 += arg10.anInt1664 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt1661 = arg4 >> 2;
		arg10.anInt1660 = arg5 >> 2;
		arg10.anInt1663 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!nb", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!nb;II)I")
	public static int method1180(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub16_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1653 -= arg10.anInt1664 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lclient!ke;III)Lclient!nb;")
	public static Class2_Sub16_Sub1 method1186(@OriginalArg(0) Class2_Sub14_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray11 == null || arg0.aByteArray11.length == 0 ? null : new Class2_Sub16_Sub1(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!nb", name = "b", descriptor = "(II[B[IIIIIIILclient!nb;II)I")
	public static int method1188(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub16_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lclient!ke;II)Lclient!nb;")
	public static Class2_Sub16_Sub1 method1190(@OriginalArg(0) Class2_Sub14_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray11 == null || arg0.aByteArray11.length == 0 ? null : new Class2_Sub16_Sub1(arg0, (int) ((long) arg0.anInt1408 * 256L * (long) 100 / (long) (Static119.anInt2551 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!nb", name = "b", descriptor = "([B[IIIIIIIILclient!nb;)I")
	public static int method1193(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub16_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1661 += arg8.anInt1655 * (local24 - arg3);
		arg8.anInt1660 += arg8.anInt1662 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!nb", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!nb;)I")
	public static int method1196(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub16_Sub1 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt1653 += arg10.anInt1664 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!nb", name = "b", descriptor = "([B[IIIIIIILclient!nb;)I")
	public static int method1197(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub16_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!nb", name = "c", descriptor = "(II[B[IIIIIIIILclient!nb;II)I")
	...
	@OriginalMember(owner = "client!nb", name = "d", descriptor = "(II[B[IIIIIIIILclient!nb;II)I")
	public static int method1199(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub16_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1661 -= arg8.anInt1655 * arg3;
		arg8.anInt1660 -= arg8.anInt1662 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!nb", name = "a", descriptor = "(I[B[IIIIIIIILclient!nb;)I")
	public static int method1201(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub16_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!nb", name = "b", descriptor = "(I[B[IIIIIIIILclient!nb;)I")
	public static int method1203(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub16_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
