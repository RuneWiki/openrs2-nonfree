...
public final class Static134 {
	...
	public static World3D aClass77_1;

	@OriginalMember(owner = "client!wf", name = "g", descriptor = "Lclient!wd;")
	public static LinkList aClass82_15 = new LinkList();

	@OriginalMember(owner = "client!wf", name = "h", descriptor = "Lclient!ec;")
	public static JagString aClass22_975 = Static60.method1113("Standort");

	@OriginalMember(owner = "client!wf", name = "i", descriptor = "Lclient!ec;")
	private static JagString aClass22_976 = Static60.method1113("Hidden");

	@OriginalMember(owner = "client!wf", name = "j", descriptor = "Lclient!ec;")
	public static JagString aClass22_977 = Static60.method1113("");
	...
	public static JagString aClass22_978 = aClass22_976;

	@OriginalMember(owner = "client!wf", name = "n", descriptor = "Lclient!ec;")
	public static JagString aClass22_979 = Static60.method1113("Regeln versto-8en hat)3");
	...
	public static void method2040(@OriginalArg(0) SoftwareFont arg0, @OriginalArg(2) SoftwareFont arg1) {
		...
		if (Static112.anInt2775 == 20) {
			...
			arg1.method1415(Static44.method856(new JagString[] { Static54.aClass22_387, Static81.method1393(Static61.aClass22_476) }), 272, 266, 16777215, 0);
			@Pc(153) int local153 = local133 + 15;
			arg1.method1415(Static44.method856(new JagString[] { Static32.aClass22_215, Static61.aClass22_470.method457() }), 274, 281, 16777215, 0);
		...
		if (Static112.anInt2775 == 10) {
			...
			if (Static9.anInt190 == 0) {
				...
				local116 += 15;
				local116 += 10;
				arg1.method1415(Static44.method856(new JagString[] { Static54.aClass22_387, Static81.method1393(Static61.aClass22_476), Static113.anInt2785 == 0 & Client.anInt2877 % 40 < 20 ? Static76.aClass22_560 : Static61.aClass22_474 }), 272, 266, 16777215, 0);
				local116 += 15;
				arg1.method1415(Static44.method856(new JagString[] { Static32.aClass22_215, Static61.aClass22_470.method457(), Client.anInt2877 % 40 < 20 & Static113.anInt2785 == 1 ? Static76.aClass22_560 : Static61.aClass22_474 }), 274, 281, 16777215, 0);
				local116 += 15;
		...
		if (Static112.anInt2775 > 5 && Static89.anInt2372 != 2 && Static16.anInt379 == 0) {
			if (Static131.aClass4_Sub1_Sub2_Sub3_5 == null) {
				...
				arg1.method1417(Static44.method856(new JagString[] { Static13.aClass22_88, Static64.aClass22_488, method2042(Static72.anInt1919) }), 55, 478, 16777215, 0);
		...
		try {
			@Pc(627) Graphics local627 = GameShell.aCanvas1.getGraphics();
			GameShell.drawArea.method578(local627);
	...
	public static void method2041(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		@Pc(7) VarBitType local7 = Static66.method1161(arg1);
		@Pc(10) int local10 = local7.anInt79;
		@Pc(17) int local17 = local7.anInt81;
		@Pc(20) int local20 = local7.anInt76;
		@Pc(26) int local26 = CollisionMap.anIntArray282[local17 - local20];
	...
	public static JagString method2042(@OriginalArg(0) int arg0) {
		return Static103.method1719(arg0, false);
	}

	@OriginalMember(owner = "client!wf", name = "a", descriptor = "(ZILclient!f;I)V")
	public static void method2043(@OriginalArg(1) int arg0, @OriginalArg(2) IfType arg1, @OriginalArg(3) int arg2) {
		if (arg1.anInt762 == 1) {
			Static48.method905(0, arg1.aClass22_204, arg1.anInt738, 26, Static64.aClass22_485, 0);
		}
		if (arg1.anInt762 == 2 && !Static128.aBoolean274) {
			@Pc(33) JagString local33 = Static50.method963(arg1);
			if (local33 != null) {
				Static48.method905(0, local33, arg1.anInt738, 8, Static44.method856(new JagString[] { Static112.aClass22_865, arg1.aClass22_208 }), -1);
			}
		}
		if (arg1.anInt762 == 3) {
				...
				for (local149 = 0; local149 < arg1.anInt773; local149++) {
					...
					if (local158 <= arg2 && local166 <= arg0 && local158 + 32 > arg2 && arg0 < local166 + 32) {
						...
						if (arg1.anIntArray89[local143] > 0) {
							@Pc(219) ObjType local219 = Static123.method2000(arg1.anIntArray89[local143] - 1);
							if (Static104.anInt2636 == 1 && Static85.method1500(Static124.method1890(arg1))) {
								if (Static38.anInt951 != arg1.anInt738 || Static35.anInt879 != local143) {
									Static48.method905(local219.anInt1456, Static35.aClass22_246, arg1.anInt738, 25, Static44.method856(new JagString[] { Static43.aClass22_290, Static42.aClass22_250, local219.aClass22_359 }), local143);
								}
							} else if (!Static128.aBoolean274 || !Static85.method1500(Static124.method1890(arg1))) {
								@Pc(245) JagString[] local245 = local219.aClass22Array12;
								...
								if (Static85.method1500(Static124.method1890(arg1))) {
									for (local259 = 4; local259 >= 3; local259--) {
										if (local245 != null && local245[local259] != null) {
											...
											Static48.method905(local219.anInt1456, local245[local259], arg1.anInt738, local276, Static44.method856(new JagString[] { Static33.aClass22_221, local219.aClass22_359 }), local143);
										} else if (local259 == 4) {
											Static48.method905(local219.anInt1456, Static96.aClass22_716, arg1.anInt738, 35, Static44.method856(new JagString[] { Static33.aClass22_221, local219.aClass22_359 }), local143);
										}
									}
								}
								if (Static132.method2024(Static124.method1890(arg1))) {
									Static48.method905(local219.anInt1456, Static35.aClass22_246, arg1.anInt738, 21, Static44.method856(new JagString[] { Static33.aClass22_221, local219.aClass22_359 }), local143);
								}
								...
								Static48.method905(local219.anInt1456, Static113.aClass22_870, arg1.anInt738, 1004, Static44.method856(new JagString[] { Static33.aClass22_221, local219.aClass22_359 }), local143);
							} else if ((Static73.anInt1961 & 0x10) == 16) {
								Static48.method905(local219.anInt1456, Static124.aClass22_927, arg1.anInt738, 43, Static44.method856(new JagString[] { Static12.aClass22_80, Static42.aClass22_250, local219.aClass22_359 }), local143);
							}
						}
					}
					local143++;
		...
		if (!Static128.aBoolean274) {
			...
			for (local149 = 4; local149 >= 0; local149--) {
				@Pc(715) JagString local715 = Static58.method1099(arg1, local149);
				if (local715 != null) {
			...
			Static48.method905(0, Static124.aClass22_927, arg1.anInt738, 42, Static44.method856(new JagString[] { Static12.aClass22_80, Static1.aClass22_1, arg1.aClass22_205 }), arg1.anInt784);
		}
	}
}
