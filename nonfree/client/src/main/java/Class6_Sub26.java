...
public final class Class6_Sub26 extends Class6 {
	...
	public Class6_Sub26(@OriginalArg(0) byte[] arg0) {
		this.method4178(arg0);
	}

	@OriginalMember(owner = "client!nu", name = "a", descriptor = "(I)[F")
	private float[] method4177(@OriginalArg(0) int arg0) {
		Static277.method4185(this.aByteArrayArray18[arg0]);
		Static277.method4184();
		@Pc(15) int local15 = Static277.method4187(Static12.method347(Static277.anIntArray333.length - 1));
		@Pc(19) boolean local19 = Static277.aBooleanArray18[local15];
		@Pc(25) int local25 = local19 ? Static277.anInt4976 : Static277.anInt4978;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static277.method4184() != 0;
			local29 = Static277.method4184() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static277.anInt4978 >> 2);
			local67 = (local25 >> 2) + (Static277.anInt4978 >> 2);
			local71 = Static277.anInt4978 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static277.anInt4978 >> 2);
			local104 = local25 + (Static277.anInt4978 >> 2) - (local25 >> 2);
			local108 = Static277.anInt4978 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class221 local123 = Static277.aClass221Array1[Static277.anIntArray333[local15]];
		@Pc(126) int local126 = local123.anInt6331;
		@Pc(131) int local131 = local123.anIntArray406[local126];
		@Pc(140) boolean local140 = !Static277.aClass96Array1[local131].method2424();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt6330; local144++) {
			@Pc(152) Class64 local152 = Static277.aClass64Array1[local123.anIntArray407[local144]];
			local154 = Static277.aFloatArray17;
			local152.method1670(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt6331;
			local176 = local123.anIntArray406[local171];
			Static277.aClass96Array1[local176].method2419(Static277.aFloatArray17, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static277.aFloatArray17[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static277.aFloatArray17;
			...
			@Pc(252) float[] local252 = local19 ? Static277.aFloatArray12 : Static277.aFloatArray16;
			@Pc(258) float[] local258 = local19 ? Static277.aFloatArray11 : Static277.aFloatArray14;
			@Pc(264) float[] local264 = local19 ? Static277.aFloatArray15 : Static277.aFloatArray10;
			@Pc(270) int[] local270 = local19 ? Static277.anIntArray331 : Static277.anIntArray332;
			...
			@Pc(486) int local486 = Static12.method347(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static277.aFloatArray17[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static277.aFloatArray17[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt4973 > 0) {
			local176 = this.anInt4973 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean306) {
				for (local212 = 0; local212 < this.anInt4980; local212++) {
					local1254 = (this.anInt4973 >> 1) + local212;
					local1228[local212] += this.aFloatArray13[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static277.aFloatArray17[local212];
				}
			}
		}
		local154 = this.aFloatArray13;
		this.aFloatArray13 = Static277.aFloatArray17;
		Static277.aFloatArray17 = local154;
		this.anInt4973 = local25;
		this.anInt4980 = local104 - (local25 >> 1);
		this.aBoolean306 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!nu", name = "a", descriptor = "([B)V")
	private void method4178(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class6_Sub1 local4 = new Class6_Sub1(arg0);
		this.anInt4971 = local4.method6442();
		this.anInt4974 = local4.method6442();
		this.anInt4979 = local4.method6442();
		this.anInt4977 = local4.method6442();
		if (this.anInt4977 < 0) {
			this.anInt4977 = ~this.anInt4977;
			this.aBoolean307 = true;
		}
		@Pc(40) int local40 = local4.method6442();
		this.aByteArrayArray18 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method6433();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method6434(local64, local49);
			this.aByteArrayArray18[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!nu", name = "a", descriptor = "([I)Lclient!hh;")
	public Class6_Sub17_Sub1 method4179(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray63 == null) {
			this.anInt4973 = 0;
			this.aFloatArray13 = new float[Static277.anInt4976];
			this.aByteArray63 = new byte[this.anInt4974];
			this.anInt4982 = 0;
			this.anInt4981 = 0;
		}
		while (this.anInt4981 < this.aByteArrayArray18.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method4177(this.anInt4981);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt4982;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt4974 - local47) {
					local50 = this.anInt4974 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt4982;
				}
				this.anInt4982 = local47;
			}
			this.anInt4981++;
		}
		...
		return new Class6_Sub17_Sub1(this.anInt4971, local129, this.anInt4979, this.anInt4977, this.aBoolean307);
	}
}
