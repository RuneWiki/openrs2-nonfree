...
public final class Class4_Sub1_Sub17 extends DoublyLinkable {
	...
	public void method1911(@OriginalArg(0) Packet arg0) {
		while (true) {
	...
	public SoftwareModel method1913(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) SoftwareModel arg2) {
		@Pc(6) int local6 = this.anIntArray330[arg1];
		@Pc(16) AnimFrameset local16 = Static72.method1186(local6 >> 16);
		@Pc(20) int local20 = local6 & 0xFFFF;
		if (local16 == null) {
			return arg2.method1469(true);
		}
		@Pc(30) int local30 = arg0 & 0x3;
		@Pc(41) SoftwareModel local41 = arg2.method1469(!local16.method1702(local20));
		if (local30 == 1) {
			local41.method1482();
		} else if (local30 == 2) {
			local41.method1473();
	...
	private void method1914(@OriginalArg(0) Packet arg0, @OriginalArg(1) int arg1) {
		@Pc(18) int local18;
		@Pc(24) int local24;
		@Pc(43) int local43;
		if (arg1 == 1) {
	...
	public SoftwareModel method1915(@OriginalArg(1) SoftwareModel arg0, @OriginalArg(2) int arg1) {
		...
		if (local14 == null) {
			...
			@Pc(46) SoftwareModel local46 = arg0.method1490(!local14.method1702(local18));
	...
	public SoftwareModel method1917(@OriginalArg(1) int arg0, @OriginalArg(2) SoftwareModel arg1) {
		...
		@Pc(32) AnimFrameset local32 = null;
		@Pc(34) int local34 = 0;
	...
	public SoftwareModel method1918(@OriginalArg(0) int arg0, @OriginalArg(1) Class4_Sub1_Sub17 arg1, @OriginalArg(2) SoftwareModel arg2, @OriginalArg(4) int arg3) {
		...
		@Pc(41) AnimFrameset local41 = Static72.method1186(local31 >> 16);
		@Pc(45) int local45 = local31 & 0xFFFF;
		@Pc(58) SoftwareModel local58;
		if (local41 == null) {
	...
	public SoftwareModel method1920(@OriginalArg(0) SoftwareModel arg0, @OriginalArg(1) int arg1) {
		@Pc(4) int local4 = this.anIntArray330[arg1];
		@Pc(14) AnimFrameset local14 = Static72.method1186(local4 >> 16);
		@Pc(23) int local23 = local4 & 0xFFFF;
		if (local14 == null) {
			return arg0.method1469(true);
		} else {
			@Pc(40) SoftwareModel local40 = arg0.method1469(!local14.method1702(local23));
