...
public final class Class28 {
	...
	public final int[] anIntArray89 = new int[4096];

	@OriginalMember(owner = "client!b", name = "l", descriptor = "I")
	public int anInt768 = 0;

	@OriginalMember(owner = "client!b", name = "m", descriptor = "Z")
	private final boolean aBoolean61 = false;
	...
	private final int anInt776 = -1;

	@OriginalMember(owner = "client!b", name = "G", descriptor = "I")
	private final int anInt779 = -1;

	@OriginalMember(owner = "client!b", name = "u", descriptor = "I")
	private final int anInt771 = -1;

	@OriginalMember(owner = "client!b", name = "a", descriptor = "Lclient!uj;")
	private final Class87_Sub3 aClass87_Sub3_4;

	@OriginalMember(owner = "client!b", name = "j", descriptor = "Lclient!w;")
	...
	private void method682(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) float arg9, @OriginalArg(10) float arg10, @OriginalArg(11) float arg11, @OriginalArg(12) float arg12, @OriginalArg(13) float arg13, @OriginalArg(14) float arg14, @OriginalArg(15) float arg15, @OriginalArg(16) float arg16, @OriginalArg(17) float arg17, @OriginalArg(18) float arg18, @OriginalArg(19) float arg19, @OriginalArg(20) float arg20) {
		...
		while (local3-- > 0) {
			...
			if (local143 < this.aFloatArray2[local138]) {
				@Pc(159) int local159 = (int) (arg7 * local143 * (float) this.anInt775);
				if (this.aBoolean64) {
					local159 &= this.anInt773;
				} else if (local159 < 0) {
					local159 = 0;
				} else if (local159 > this.anInt773) {
					local159 = this.anInt773;
				}
				@Pc(189) int local189 = (int) (arg9 * local143 * (float) this.anInt775);
				if (this.aBoolean64) {
					local189 &= this.anInt773;
				} else if (local189 < 0) {
					local189 = 0;
				} else if (local189 > this.anInt773) {
					local189 = this.anInt773;
				}
				@Pc(220) int local220 = this.anIntArray93[local189 * this.anInt775 + local159];
				@Pc(232) int local232;
				if (this.anInt778 == 2) {
					local232 = local220 >> 24 & 0xFF;
				} else if (this.anInt778 == 1) {
				...
				if (local232 != 0) {
					...
					if (local232 == 255) {
						...
						if (arg11 != 0.0F) {
							...
							local321 = ((this.anInt780 & 0xFF00FF) * (int) arg11 & 0xFF00FF00 | (this.anInt780 & 0xFF00) * (int) arg11 & 0xFF0000) >>> 8;
							local290 = (((local290 & 0xFF00FF) * local299 & 0xFF00FF00 | (local290 & 0xFF00) * local299 & 0xFF0000) >>> 8) + local321;
						}
						arg0[local138] = local290;
						this.aFloatArray2[local138] = local143;
					} else {
						local290 = ((int) (arg15 * (float) (local220 >> 16 & 0xFF)) & 0xFF00 | 0xFF0000) << 8 | (int) (arg17 * (float) (local220 >> 8 & 0xFF)) & 0xFF00 | (int) (arg19 * (float) (local220 & 0xFF)) >> 8;
						if (arg11 != 0.0F) {
							local299 = (int) (255.0F - arg11);
	...
	public void method683(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) int arg9) {
		if (this.aBoolean59) {
			this.aClass87_Sub3_4.method7964((int) arg1, (int) arg4, (int) arg3, arg9, (int) arg0);
			this.aClass87_Sub3_4.method7964((int) arg2, (int) arg5, (int) arg4, arg9, (int) arg1);
			this.aClass87_Sub3_4.method7964((int) arg0, (int) arg3, (int) arg5, arg9, (int) arg2);
			return;
		}
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (!(arg0 >= (float) this.anInt767)) {
				if (arg1 > (float) this.anInt767) {
					arg1 = this.anInt767;
				}
				if (arg2 > (float) this.anInt767) {
					arg2 = this.anInt767;
				}
				...
				if (arg1 < arg2) {
					...
					if (arg0 != arg1 && local96 < local68 || arg0 == arg1 && local96 > local82) {
						arg2 -= arg1;
						arg1 -= arg0;
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method692(this.anIntArray90, this.aFloatArray2, (int) arg0, arg9, (int) arg5, (int) arg3, arg6, local131);
							arg5 += local96;
							arg3 += local68;
							arg6 += local141;
							arg0 += this.anInt766;
						...
						while (--arg2 >= 0.0F) {
							this.method692(this.anIntArray90, this.aFloatArray2, (int) arg0, arg9, (int) arg5, (int) arg4, arg6, local131);
							arg5 += local96;
							arg4 += local82;
							arg6 += local141;
							arg0 += this.anInt766;
						...
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method692(this.anIntArray90, this.aFloatArray2, (int) arg0, arg9, (int) arg3, (int) arg5, arg6, local131);
							arg5 += local96;
							arg3 += local68;
							arg6 += local141;
							arg0 += this.anInt766;
						...
						while (--arg2 >= 0.0F) {
							this.method692(this.anIntArray90, this.aFloatArray2, (int) arg0, arg9, (int) arg4, (int) arg5, arg6, local131);
							arg5 += local96;
							arg4 += local82;
							arg6 += local141;
							arg0 += this.anInt766;
					...
					if ((arg0 == arg2 || !(local96 < local68)) && (arg0 != arg2 || !(local82 > local68))) {
						...
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method692(this.anIntArray90, this.aFloatArray2, (int) arg0, arg9, (int) arg3, (int) arg4, arg6, local131);
							arg4 += local96;
							arg3 += local68;
							arg6 += local141;
							arg0 += this.anInt766;
						...
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method692(this.anIntArray90, this.aFloatArray2, (int) arg0, arg9, (int) arg4, (int) arg3, arg6, local131);
							arg4 += local96;
							arg3 += local68;
							arg6 += local141;
							arg0 += this.anInt766;
			...
			if (!(arg1 >= (float) this.anInt767)) {
				...
				if (arg2 < arg0) {
					...
					if (arg1 != arg2 && local68 < local82 || arg1 == arg2 && local68 > local96) {
						arg0 -= arg2;
						arg2 -= arg1;
						arg1 = this.anIntArray89[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method692(this.anIntArray90, this.aFloatArray2, (int) arg1, arg9, (int) arg3, (int) arg4, arg7, local131);
							arg3 += local68;
							arg4 += local82;
							arg7 += local141;
							arg1 += this.anInt766;
						...
						while (--arg0 >= 0.0F) {
							this.method692(this.anIntArray90, this.aFloatArray2, (int) arg1, arg9, (int) arg3, (int) arg5, arg7, local131);
							arg3 += local68;
							arg5 += local96;
							arg7 += local141;
							arg1 += this.anInt766;
						...
						arg1 = this.anIntArray89[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method692(this.anIntArray90, this.aFloatArray2, (int) arg1, arg9, (int) arg4, (int) arg3, arg7, local131);
							arg3 += local68;
							arg4 += local82;
							arg7 += local141;
							arg1 += this.anInt766;
						...
						while (--arg0 >= 0.0F) {
							this.method692(this.anIntArray90, this.aFloatArray2, (int) arg1, arg9, (int) arg5, (int) arg3, arg7, local131);
							arg3 += local68;
							arg5 += local96;
							arg7 += local141;
							arg1 += this.anInt766;
					...
					if (local68 < local82) {
						...
						arg1 = this.anIntArray89[(int) arg1];
						while (--arg0 >= 0.0F) {
							this.method692(this.anIntArray90, this.aFloatArray2, (int) arg1, arg9, (int) arg5, (int) arg4, arg7, local131);
							arg5 += local68;
							arg4 += local82;
							arg7 += local141;
							arg1 += this.anInt766;
						...
						arg1 = this.anIntArray89[(int) arg1];
						while (--arg0 >= 0.0F) {
							this.method692(this.anIntArray90, this.aFloatArray2, (int) arg1, arg9, (int) arg4, (int) arg5, arg7, local131);
							arg5 += local68;
							arg4 += local82;
							arg7 += local141;
							arg1 += this.anInt766;
		...
		} else if (!(arg2 >= (float) this.anInt767)) {
			if (arg0 > (float) this.anInt767) {
				arg0 = this.anInt767;
			}
			if (arg1 > (float) this.anInt767) {
			...
			if (arg0 < arg1) {
				...
				if (local82 < local96) {
					arg1 -= arg0;
					arg0 -= arg2;
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method692(this.anIntArray90, this.aFloatArray2, (int) arg2, arg9, (int) arg4, (int) arg5, arg8, local131);
						arg4 += local82;
						arg5 += local96;
						arg8 += local141;
						arg2 += this.anInt766;
					...
					while (--arg1 >= 0.0F) {
						this.method692(this.anIntArray90, this.aFloatArray2, (int) arg2, arg9, (int) arg4, (int) arg3, arg8, local131);
						arg4 += local82;
						arg3 += local68;
						arg8 += local141;
						arg2 += this.anInt766;
					...
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method692(this.anIntArray90, this.aFloatArray2, (int) arg2, arg9, (int) arg5, (int) arg4, arg8, local131);
						arg4 += local82;
						arg5 += local96;
						arg8 += local141;
						arg2 += this.anInt766;
					...
					while (--arg1 >= 0.0F) {
						this.method692(this.anIntArray90, this.aFloatArray2, (int) arg2, arg9, (int) arg3, (int) arg4, arg8, local131);
						arg4 += local82;
						arg3 += local68;
						arg8 += local141;
						arg2 += this.anInt766;
				...
				if (local82 < local96) {
					...
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method692(this.anIntArray90, this.aFloatArray2, (int) arg2, arg9, (int) arg3, (int) arg5, arg8, local131);
						arg3 += local82;
						arg5 += local96;
						arg8 += local141;
						arg2 += this.anInt766;
					...
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method692(this.anIntArray90, this.aFloatArray2, (int) arg2, arg9, (int) arg5, (int) arg3, arg8, local131);
						arg3 += local82;
						arg5 += local96;
						arg8 += local141;
						arg2 += this.anInt766;
	...
	public void method684(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) float arg9, @OriginalArg(10) float arg10, @OriginalArg(11) float arg11) {
		if (this.aBoolean59) {
			this.aClass87_Sub3_4.method7964((int) arg1, (int) arg4, (int) arg3, Static562.anIntArray652[(int) arg9], (int) arg0);
			this.aClass87_Sub3_4.method7964((int) arg2, (int) arg5, (int) arg4, Static562.anIntArray652[(int) arg9], (int) arg1);
			this.aClass87_Sub3_4.method7964((int) arg0, (int) arg3, (int) arg5, Static562.anIntArray652[(int) arg9], (int) arg2);
			return;
		}
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (!(arg0 >= (float) this.anInt767)) {
				...
				if (arg1 < arg2) {
					...
					if ((arg0 == arg1 || !(local117 < local106)) && (arg0 != arg1 || !(local117 > local95))) {
						...
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method687(this.anIntArray90, this.aFloatArray2, (int) arg0, (int) arg3, (int) arg5, arg9, local143, arg6, local163);
							arg5 += local117;
							arg3 += local106;
							arg9 += local153;
							arg6 += local173;
						...
						while (--arg2 >= 0.0F) {
							this.method687(this.anIntArray90, this.aFloatArray2, (int) arg0, (int) arg4, (int) arg5, arg9, local143, arg6, local163);
							arg5 += local117;
							arg4 += local95;
							arg9 += local153;
							arg6 += local173;
						...
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method687(this.anIntArray90, this.aFloatArray2, (int) arg0, (int) arg5, (int) arg3, arg9, local143, arg6, local163);
							arg5 += local117;
							arg3 += local106;
							arg9 += local153;
							arg6 += local173;
						...
						while (--arg2 >= 0.0F) {
							this.method687(this.anIntArray90, this.aFloatArray2, (int) arg0, (int) arg5, (int) arg4, arg9, local143, arg6, local163);
							arg5 += local117;
							arg4 += local95;
							arg9 += local153;
							arg6 += local173;
					...
					if (arg0 != arg2 && local117 < local106 || arg0 == arg2 && local95 > local106) {
						...
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method687(this.anIntArray90, this.aFloatArray2, (int) arg0, (int) arg4, (int) arg3, arg9, local143, arg6, local163);
							arg4 += local117;
							arg3 += local106;
							arg9 += local153;
							arg6 += local173;
						...
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method687(this.anIntArray90, this.aFloatArray2, (int) arg0, (int) arg3, (int) arg4, arg9, local143, arg6, local163);
							arg4 += local117;
							arg3 += local106;
							arg9 += local153;
							arg6 += local173;
			...
			if (!(arg1 >= (float) this.anInt767)) {
				...
				if (arg2 < arg0) {
					...
					if ((arg1 == arg2 || !(local106 < local95)) && (arg1 != arg2 || !(local106 > local117))) {
						...
						arg1 = this.anIntArray89[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method687(this.anIntArray90, this.aFloatArray2, (int) arg1, (int) arg4, (int) arg3, arg10, local143, arg7, local163);
							arg3 += local106;
							arg4 += local95;
							arg10 += local153;
							arg7 += local173;
						...
						while (--arg0 >= 0.0F) {
							this.method687(this.anIntArray90, this.aFloatArray2, (int) arg1, (int) arg5, (int) arg3, arg10, local143, arg7, local163);
							arg3 += local106;
							arg5 += local117;
							arg10 += local153;
							arg7 += local173;
						...
						arg1 = this.anIntArray89[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method687(this.anIntArray90, this.aFloatArray2, (int) arg1, (int) arg3, (int) arg4, arg10, local143, arg7, local163);
							arg3 += local106;
							arg4 += local95;
							arg10 += local153;
							arg7 += local173;
						...
						while (--arg0 >= 0.0F) {
							this.method687(this.anIntArray90, this.aFloatArray2, (int) arg1, (int) arg3, (int) arg5, arg10, local143, arg7, local163);
							arg3 += local106;
							arg5 += local117;
							arg10 += local153;
							arg7 += local173;
					...
					if (local106 < local95) {
						...
						arg1 = this.anIntArray89[(int) arg1];
						while (--arg0 >= 0.0F) {
							this.method687(this.anIntArray90, this.aFloatArray2, (int) arg1, (int) arg5, (int) arg4, arg10, local143, arg7, local163);
							arg5 += local106;
							arg4 += local95;
							arg10 += local153;
							arg7 += local173;
						...
						arg1 = this.anIntArray89[(int) arg1];
						while (--arg0 >= 0.0F) {
							this.method687(this.anIntArray90, this.aFloatArray2, (int) arg1, (int) arg4, (int) arg5, arg10, local143, arg7, local163);
							arg5 += local106;
							arg4 += local95;
							arg10 += local153;
							arg7 += local173;
			...
			if (arg0 < arg1) {
				...
				if (local95 < local117) {
					...
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method687(this.anIntArray90, this.aFloatArray2, (int) arg2, (int) arg4, (int) arg5, arg11, local143, arg8, local163);
						arg4 += local95;
						arg5 += local117;
						arg11 += local153;
						arg8 += local173;
					...
					while (--arg1 >= 0.0F) {
						this.method687(this.anIntArray90, this.aFloatArray2, (int) arg2, (int) arg4, (int) arg3, arg11, local143, arg8, local163);
						arg4 += local95;
						arg3 += local106;
						arg11 += local153;
						arg8 += local173;
					...
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method687(this.anIntArray90, this.aFloatArray2, (int) arg2, (int) arg5, (int) arg4, arg11, local143, arg8, local163);
						arg4 += local95;
						arg5 += local117;
						arg11 += local153;
						arg8 += local173;
					...
					while (--arg1 >= 0.0F) {
						this.method687(this.anIntArray90, this.aFloatArray2, (int) arg2, (int) arg3, (int) arg4, arg11, local143, arg8, local163);
						arg4 += local95;
						arg3 += local106;
						arg11 += local153;
						arg8 += local173;
				...
				if (local95 < local117) {
					...
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method687(this.anIntArray90, this.aFloatArray2, (int) arg2, (int) arg3, (int) arg5, arg11, local143, arg8, local163);
						arg3 += local95;
						arg5 += local117;
						arg11 += local153;
						arg8 += local173;
					...
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method687(this.anIntArray90, this.aFloatArray2, (int) arg2, (int) arg5, (int) arg3, arg11, local143, arg8, local163);
						arg3 += local95;
						arg5 += local117;
						arg11 += local153;
						arg8 += local173;
	...
	public void method685(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11) {
		if (this.aBoolean59) {
			this.aClass87_Sub3_4.method7964((int) arg1, (int) arg4, (int) arg3, arg9 | 0xFF000000, (int) arg0);
			this.aClass87_Sub3_4.method7964((int) arg2, (int) arg5, (int) arg4, arg9 | 0xFF000000, (int) arg1);
			this.aClass87_Sub3_4.method7964((int) arg0, (int) arg3, (int) arg5, arg9 | 0xFF000000, (int) arg2);
			return;
		}
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (!(arg0 >= (float) this.anInt767)) {
				...
				if (arg1 < arg2) {
					...
					if ((arg0 == arg1 || !(local160 < local149)) && (arg0 != arg1 || !(local160 > local138))) {
						...
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method688(this.anIntArray90, this.aFloatArray2, (int) arg0, (int) arg3, (int) arg5, arg6, local186, local310, local206, local321, local226, local332, local246);
							arg5 += local160;
							arg3 += local149;
							arg6 += local196;
							local310 += local216;
						...
						while (--arg2 >= 0.0F) {
							this.method688(this.anIntArray90, this.aFloatArray2, (int) arg0, (int) arg4, (int) arg5, arg6, local186, local310, local206, local321, local226, local332, local246);
							arg5 += local160;
							arg4 += local138;
							arg6 += local196;
							local310 += local216;
						...
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method688(this.anIntArray90, this.aFloatArray2, (int) arg0, (int) arg5, (int) arg3, arg6, local186, local310, local206, local321, local226, local332, local246);
							arg5 += local160;
							arg3 += local149;
							arg6 += local196;
							local310 += local216;
						...
						while (--arg2 >= 0.0F) {
							this.method688(this.anIntArray90, this.aFloatArray2, (int) arg0, (int) arg5, (int) arg4, arg6, local186, local310, local206, local321, local226, local332, local246);
							arg5 += local160;
							arg4 += local138;
							arg6 += local196;
							local310 += local216;
					...
					if (arg0 != arg2 && local160 < local149 || arg0 == arg2 && local138 > local149) {
						...
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method688(this.anIntArray90, this.aFloatArray2, (int) arg0, (int) arg4, (int) arg3, arg6, local186, local310, local206, local321, local226, local332, local246);
							arg4 += local160;
							arg3 += local149;
							arg6 += local196;
							local310 += local216;
						...
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method688(this.anIntArray90, this.aFloatArray2, (int) arg0, (int) arg3, (int) arg4, arg6, local186, local310, local206, local321, local226, local332, local246);
							arg4 += local160;
							arg3 += local149;
							arg6 += local196;
							local310 += local216;
			...
			if (!(arg1 >= (float) this.anInt767)) {
				...
				if (arg2 < arg0) {
					...
					if ((arg1 == arg2 || !(local149 < local138)) && (arg1 != arg2 || !(local149 > local160))) {
						...
						arg1 = this.anIntArray89[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method688(this.anIntArray90, this.aFloatArray2, (int) arg1, (int) arg4, (int) arg3, arg7, local186, local310, local206, local321, local226, local332, local246);
							arg3 += local149;
							arg4 += local138;
							arg7 += local196;
							local310 += local216;
						...
						while (--arg0 >= 0.0F) {
							this.method688(this.anIntArray90, this.aFloatArray2, (int) arg1, (int) arg5, (int) arg3, arg7, local186, local310, local206, local321, local226, local332, local246);
							arg3 += local149;
							arg5 += local160;
							arg7 += local196;
							local310 += local216;
						...
						arg1 = this.anIntArray89[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method688(this.anIntArray90, this.aFloatArray2, (int) arg1, (int) arg3, (int) arg4, arg7, local186, local310, local206, local321, local226, local332, local246);
							arg3 += local149;
							arg4 += local138;
							arg7 += local196;
							local310 += local216;
						...
						while (--arg0 >= 0.0F) {
							this.method688(this.anIntArray90, this.aFloatArray2, (int) arg1, (int) arg3, (int) arg5, arg7, local186, local310, local206, local321, local226, local332, local246);
							arg3 += local149;
							arg5 += local160;
							arg7 += local196;
							local310 += local216;
					...
					if (local149 < local138) {
						...
						arg1 = this.anIntArray89[(int) arg1];
						while (--arg0 >= 0.0F) {
							this.method688(this.anIntArray90, this.aFloatArray2, (int) arg1, (int) arg5, (int) arg4, arg7, local186, local310, local206, local321, local226, local332, local246);
							arg5 += local149;
							arg4 += local138;
							arg7 += local196;
							local310 += local216;
						...
						arg1 = this.anIntArray89[(int) arg1];
						while (--arg0 >= 0.0F) {
							this.method688(this.anIntArray90, this.aFloatArray2, (int) arg1, (int) arg4, (int) arg5, arg7, local186, local310, local206, local321, local226, local332, local246);
							arg5 += local149;
							arg4 += local138;
							arg7 += local196;
							local310 += local216;
			...
			if (arg0 < arg1) {
				...
				if (local138 < local160) {
					...
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method688(this.anIntArray90, this.aFloatArray2, (int) arg2, (int) arg4, (int) arg5, arg8, local186, local310, local206, local321, local226, local332, local246);
						arg4 += local138;
						arg5 += local160;
						arg8 += local196;
						local310 += local216;
					...
					while (--arg1 >= 0.0F) {
						this.method688(this.anIntArray90, this.aFloatArray2, (int) arg2, (int) arg4, (int) arg3, arg8, local186, local310, local206, local321, local226, local332, local246);
						arg4 += local138;
						arg3 += local149;
						arg8 += local196;
						local310 += local216;
					...
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method688(this.anIntArray90, this.aFloatArray2, (int) arg2, (int) arg5, (int) arg4, arg8, local186, local310, local206, local321, local226, local332, local246);
						arg4 += local138;
						arg5 += local160;
						arg8 += local196;
						local310 += local216;
					...
					while (--arg1 >= 0.0F) {
						this.method688(this.anIntArray90, this.aFloatArray2, (int) arg2, (int) arg3, (int) arg4, arg8, local186, local310, local206, local321, local226, local332, local246);
						arg4 += local138;
						arg3 += local149;
						arg8 += local196;
						local310 += local216;
				...
				if (local138 < local160) {
					...
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method688(this.anIntArray90, this.aFloatArray2, (int) arg2, (int) arg3, (int) arg5, arg8, local186, local310, local206, local321, local226, local332, local246);
						arg3 += local138;
						arg5 += local160;
						arg8 += local196;
						local310 += local216;
					...
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method688(this.anIntArray90, this.aFloatArray2, (int) arg2, (int) arg5, (int) arg3, arg8, local186, local310, local206, local321, local226, local332, local246);
						arg3 += local138;
						arg5 += local160;
						arg8 += local196;
						local310 += local216;
	...
	public void method686(@OriginalArg(0) boolean arg0) {
		this.aBoolean59 = arg0;
	}

	@OriginalMember(owner = "client!b", name = "a", descriptor = "([I[FIIIIIFFFF)V")
	private void method687(@OriginalArg(0) int[] arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) float arg5, @OriginalArg(8) float arg6, @OriginalArg(9) float arg7, @OriginalArg(10) float arg8) {
		if (this.aBoolean60) {
			if (arg4 > this.anInt764) {
				arg4 = this.anInt764;
			}
		...
		@Pc(54) float local54;
		@Pc(87) float local87;
		if (this.aClass364_3.aBoolean739) {
			if (this.aBoolean63) {
				local50 = arg4 - arg3 >> 2;
				local54 = arg6 * 4.0F;
				if (this.anInt768 == 0) {
					if (local50 > 0) {
						do {
							local64 = Static562.anIntArray652[(int) arg5];
							arg5 += local54;
							local71 = arg2 + 1;
					...
					local186 = this.anInt768;
					local191 = 256 - this.anInt768;
					if (local50 > 0) {
						do {
							local64 = Static562.anIntArray652[(int) arg5];
							arg5 += local54;
				...
				if (this.anInt768 == 0) {
					do {
						arg2++;
						if (arg7 < arg1[arg2]) {
							arg0[arg2] = Static562.anIntArray652[(int) arg5];
							arg1[arg2] = arg7;
						}
						arg7 += arg8;
						arg5 += arg6;
		...
		if (this.aBoolean61) {
			...
			if (this.aBoolean63) {
				...
				if (this.anInt768 == 0) {
					...
					local163 = this.anInt768;
					local168 = 256 - this.anInt768;
					if (local54 > 0) {
						do {
							local88 = (int) arg7 & 0xFF0000 | 0xFF000000 | (int) arg9 & 0xFF00 | (int) arg11 & 0xFF;
							arg7 += local58;
	...
	private void method689(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) float arg9, @OriginalArg(10) float arg10, @OriginalArg(11) float arg11, @OriginalArg(12) float arg12, @OriginalArg(13) float arg13, @OriginalArg(14) float arg14, @OriginalArg(15) float arg15, @OriginalArg(16) float arg16, @OriginalArg(17) float arg17, @OriginalArg(18) float arg18, @OriginalArg(19) float arg19, @OriginalArg(20) float arg20, @OriginalArg(21) float arg21, @OriginalArg(22) float arg22, @OriginalArg(23) float arg23, @OriginalArg(24) float arg24) {
		...
		while (local3-- > 0) {
			...
			if (local156 < this.aFloatArray2[local151]) {
				@Pc(167) float local167 = arg7 * local156;
				@Pc(171) float local171 = arg9 * local156;
				@Pc(184) int local184 = (int) (local167 * (float) this.anInt775 * this.aFloat19) & this.anInt773;
				@Pc(197) int local197 = (int) (local171 * (float) this.anInt775 * this.aFloat19) & this.anInt773;
				@Pc(207) int local207 = this.anIntArray93[local197 * this.anInt775 + local184];
				@Pc(220) int local220 = (int) (local167 * (float) this.anInt770 * this.aFloat21) & this.anInt774;
				@Pc(233) int local233 = (int) (local171 * (float) this.anInt770 * this.aFloat21) & this.anInt774;
				@Pc(243) int local243 = this.anIntArray91[local233 * this.anInt770 + local220];
				@Pc(256) int local256 = (int) (local167 * (float) this.anInt772 * this.aFloat20) & this.anInt777;
				@Pc(269) int local269 = (int) (local171 * (float) this.anInt772 * this.aFloat20) & this.anInt777;
				@Pc(279) int local279 = this.anIntArray92[local269 * this.anInt772 + local256];
				...
				if (arg11 != 0.0F) {
					...
					@Pc(462) int local462 = ((this.anInt780 & 0xFF00FF) * (int) arg11 & 0xFF00FF00 | (this.anInt780 & 0xFF00) * (int) arg11 & 0xFF0000) >>> 8;
					local431 = (((local431 & 0xFF00FF) * local440 & 0xFF00FF00 | (local431 & 0xFF00) * local440 & 0xFF0000) >>> 8) + local462;
				}
				arg0[local151] = local431;
				this.aFloatArray2[local151] = local156;
			}
			local151++;
			arg5 += local14;
			arg7 += local20;
	...
	public void method691(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) float arg9, @OriginalArg(10) float arg10, @OriginalArg(11) float arg11, @OriginalArg(12) float arg12, @OriginalArg(13) float arg13, @OriginalArg(14) float arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18, @OriginalArg(19) int arg19, @OriginalArg(20) int arg20, @OriginalArg(21) int arg21, @OriginalArg(22) int arg22, @OriginalArg(23) float arg23, @OriginalArg(24) int arg24, @OriginalArg(25) float arg25, @OriginalArg(26) int arg26, @OriginalArg(27) float arg27) {
		if (arg22 != this.anInt776) {
			this.anIntArray93 = this.aClass87_Sub3_4.method7990(arg22);
			if (this.anIntArray93 == null) {
				this.method685((float) arg0, (float) arg1, (float) arg2, (float) arg3, (float) arg4, (float) arg5, (float) arg6, (float) arg7, (float) arg8, Static535.method7475(arg18 | arg19 << 24, arg15), Static535.method7475(arg18 | arg20 << 24, arg16), Static535.method7475(arg18 | arg21 << 24, arg17));
				return;
			}
			this.anInt775 = this.aClass87_Sub3_4.method7983(arg22) ? 64 : this.aClass87_Sub3_4.anInt9480;
			this.anInt773 = this.anInt775 - 1;
			this.anInt778 = this.aClass87_Sub3_4.method7988(arg22);
		}
		this.aFloat19 = arg23;
		if (arg24 != this.anInt779) {
			this.anIntArray91 = this.aClass87_Sub3_4.method7990(arg24);
			if (this.anIntArray91 == null) {
				this.method685((float) arg0, (float) arg1, (float) arg2, (float) arg3, (float) arg4, (float) arg5, (float) arg6, (float) arg7, (float) arg8, Static535.method7475(arg18 | arg19 << 24, arg15), Static535.method7475(arg18 | arg20 << 24, arg16), Static535.method7475(arg18 | arg21 << 24, arg17));
				return;
			}
			this.anInt770 = this.aClass87_Sub3_4.method7983(arg24) ? 64 : this.aClass87_Sub3_4.anInt9480;
			this.anInt774 = this.anInt770 - 1;
		}
		this.aFloat21 = arg25;
		if (arg26 != this.anInt771) {
			this.anIntArray92 = this.aClass87_Sub3_4.method7990(arg26);
			if (this.anIntArray92 == null) {
				this.method685((float) arg0, (float) arg1, (float) arg2, (float) arg3, (float) arg4, (float) arg5, (float) arg6, (float) arg7, (float) arg8, Static535.method7475(arg18 | arg19 << 24, arg15), Static535.method7475(arg18 | arg20 << 24, arg16), Static535.method7475(arg18 | arg21 << 24, arg17));
				return;
			}
			this.anInt772 = this.aClass87_Sub3_4.method7983(arg26) ? 64 : this.aClass87_Sub3_4.anInt9480;
			this.anInt777 = this.anInt772 - 1;
		}
		this.aFloat20 = arg27;
		this.anInt780 = arg18;
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (!(arg0 >= (float) this.anInt767)) {
				...
				if (arg1 < arg2) {
					...
					if (arg0 != arg1 && local525 < local400 || arg0 == arg1 && local525 > local428) {
						...
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method689(this.anIntArray90, this.anIntArray93, (int) arg0, (int) arg5, (int) arg3, arg8, arg6, arg11, arg9, arg14, arg12, (float) arg21, (float) arg19, local293, local279, local314, local300, local335, local321, local350, local340, local392, local388, local398, local394);
							arg3 += local400;
							arg5 += local525;
							arg6 += local402;
							arg8 += local596;
						...
						while (--arg2 >= 0.0F) {
							this.method689(this.anIntArray90, this.anIntArray93, (int) arg0, (int) arg5, (int) arg4, arg8, arg7, arg11, arg10, arg14, arg13, (float) arg21, (float) arg20, local293, local286, local314, local307, local335, local328, local350, local345, local392, local390, local398, local396);
							arg4 += local428;
							arg5 += local525;
							arg7 += local499;
							arg8 += local596;
						...
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method689(this.anIntArray90, this.anIntArray93, (int) arg0, (int) arg3, (int) arg5, arg6, arg8, arg9, arg11, arg12, arg14, (float) arg19, (float) arg21, local279, local293, local300, local314, local321, local335, local340, local350, local388, local392, local394, local398);
							arg3 += local400;
							arg5 += local525;
							arg6 += local402;
							arg8 += local596;
						...
						while (--arg2 >= 0.0F) {
							this.method689(this.anIntArray90, this.anIntArray93, (int) arg0, (int) arg4, (int) arg5, arg7, arg8, arg10, arg11, arg13, arg14, (float) arg20, (float) arg21, local286, local293, local307, local314, local328, local335, local345, local350, local390, local392, local396, local398);
							arg4 += local428;
							arg5 += local525;
							arg7 += local499;
							arg8 += local596;
					...
					if (arg0 != arg2 && local525 < local400 || arg0 == arg2 && local428 > local400) {
						...
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method689(this.anIntArray90, this.anIntArray93, (int) arg0, (int) arg4, (int) arg3, arg7, arg6, arg10, arg9, arg13, arg12, (float) arg20, (float) arg19, local286, local279, local307, local300, local328, local321, local345, local340, local390, local388, local396, local394);
							arg3 += local400;
							arg4 += local525;
							arg6 += local402;
							arg7 += local596;
						...
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method689(this.anIntArray90, this.anIntArray93, (int) arg0, (int) arg3, (int) arg4, arg6, arg7, arg9, arg10, arg12, arg13, (float) arg19, (float) arg20, local279, local286, local300, local307, local321, local328, local340, local345, local388, local390, local394, local396);
							arg4 += local525;
							arg3 += local400;
							arg7 += local596;
							arg6 += local402;
			...
			if (!(arg1 >= (float) this.anInt767)) {
				...
				if (arg2 < arg0) {
					...
					if (arg1 != arg2 && local400 < local428 || arg1 == arg2 && local400 > local525) {
						...
						arg1 = this.anIntArray89[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method689(this.anIntArray90, this.anIntArray93, (int) arg1, (int) arg3, (int) arg4, arg6, arg7, arg9, arg10, arg12, arg13, (float) arg19, (float) arg20, local279, local286, local300, local307, local321, local328, local340, local345, local388, local390, local394, local396);
							arg3 += local400;
							arg4 += local428;
							arg6 += local402;
							arg7 += local499;
						...
						while (--arg0 >= 0.0F) {
							this.method689(this.anIntArray90, this.anIntArray93, (int) arg1, (int) arg3, (int) arg5, arg6, arg8, arg9, arg11, arg12, arg14, (float) arg19, (float) arg21, local279, local293, local300, local314, local321, local335, local340, local350, local388, local392, local394, local398);
							arg3 += local400;
							arg5 += local525;
							arg6 += local402;
							arg8 += local596;
						...
						arg1 = this.anIntArray89[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method689(this.anIntArray90, this.anIntArray93, (int) arg1, (int) arg4, (int) arg3, arg7, arg6, arg10, arg9, arg13, arg12, (float) arg20, (float) arg19, local286, local279, local307, local300, local328, local321, local345, local340, local390, local388, local396, local394);
							arg4 += local428;
							arg3 += local400;
							arg7 += local499;
							arg6 += local402;
						...
						while (--arg0 >= 0.0F) {
							this.method689(this.anIntArray90, this.anIntArray93, (int) arg1, (int) arg5, (int) arg3, arg8, arg6, arg11, arg9, arg14, arg12, (float) arg21, (float) arg19, local293, local279, local314, local300, local335, local321, local350, local340, local392, local388, local398, local394);
							arg5 += local525;
							arg3 += local400;
							arg8 += local596;
							arg6 += local402;
					...
					if (local400 < local428) {
						while (--arg0 >= 0.0F) {
							this.method689(this.anIntArray90, this.anIntArray93, (int) arg1, (int) arg5, (int) arg4, arg8, arg7, arg11, arg10, arg14, arg13, (float) arg21, (float) arg20, local293, local286, local314, local307, local335, local328, local350, local345, local392, local390, local398, local396);
							arg5 += local400;
							arg4 += local428;
							arg8 += local402;
							arg7 += local499;
						...
						while (--arg0 >= 0.0F) {
							this.method689(this.anIntArray90, this.anIntArray93, (int) arg1, (int) arg4, (int) arg5, arg7, arg8, arg10, arg11, arg13, arg14, (float) arg20, (float) arg21, local286, local293, local307, local314, local328, local335, local345, local350, local390, local392, local396, local398);
							arg4 += local428;
							arg5 += local400;
							arg7 += local499;
							arg8 += local402;
			...
			if (arg0 < arg1) {
				...
				if (local428 < local525) {
					...
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method689(this.anIntArray90, this.anIntArray93, (int) arg2, (int) arg4, (int) arg5, arg7, arg8, arg10, arg11, arg13, arg14, (float) arg20, (float) arg21, local286, local293, local307, local314, local328, local335, local345, local350, local390, local392, local396, local398);
						arg4 += local428;
						arg5 += local525;
						arg7 += local499;
						arg8 += local596;
					...
					while (--arg1 >= 0.0F) {
						this.method689(this.anIntArray90, this.anIntArray93, (int) arg2, (int) arg4, (int) arg3, arg7, arg6, arg10, arg9, arg13, arg12, (float) arg20, (float) arg19, local286, local279, local307, local300, local328, local321, local345, local340, local390, local388, local396, local394);
						arg4 += local428;
						arg3 += local400;
						arg7 += local499;
						arg6 += local402;
					...
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method689(this.anIntArray90, this.anIntArray93, (int) arg2, (int) arg5, (int) arg4, arg8, arg7, arg11, arg10, arg14, arg13, (float) arg21, (float) arg20, local293, local286, local314, local307, local335, local328, local350, local345, local392, local390, local398, local396);
						arg5 += local525;
						arg4 += local428;
						arg8 += local596;
						arg7 += local499;
					...
					while (--arg1 >= 0.0F) {
						this.method689(this.anIntArray90, this.anIntArray93, (int) arg2, (int) arg3, (int) arg4, arg6, arg7, arg9, arg10, arg12, arg13, (float) arg19, (float) arg20, local279, local286, local300, local307, local321, local328, local340, local345, local388, local390, local394, local396);
						arg3 += local400;
						arg4 += local428;
						arg6 += local402;
						arg7 += local499;
				...
				if (local428 < local525) {
					...
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method689(this.anIntArray90, this.anIntArray93, (int) arg2, (int) arg3, (int) arg5, arg6, arg8, arg9, arg11, arg12, arg14, (float) arg19, (float) arg21, local279, local293, local300, local314, local321, local335, local340, local350, local388, local392, local394, local398);
						arg3 += local428;
						arg5 += local525;
						arg6 += local499;
						arg8 += local596;
					...
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method689(this.anIntArray90, this.anIntArray93, (int) arg2, (int) arg5, (int) arg3, arg8, arg6, arg11, arg9, arg14, arg12, (float) arg21, (float) arg19, local293, local279, local314, local300, local335, local321, local350, local340, local392, local388, local398, local394);
						arg5 += local525;
						arg3 += local428;
						arg8 += local596;
						arg6 += local499;
	...
	private void method692(@OriginalArg(0) int[] arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) float arg6, @OriginalArg(8) float arg7) {
		if (this.aBoolean60) {
			if (arg5 > this.anInt764) {
				arg5 = this.anInt764;
			}
			if (arg4 < 0) {
				arg4 = 0;
		...
		if (this.aClass364_3.aBoolean739) {
			...
			} else if (this.anInt768 != 254) {
				local278 = this.anInt768;
				local283 = 256 - this.anInt768;
			...
			} else if (arg4 != 0 && arg5 <= this.anInt764 - 1) {
				while (true) {
					local29--;
					if (local29 < 0) {
						local29 = arg5 - arg4 & 0x3;
	...
	public void method693(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) float arg9, @OriginalArg(10) float arg10, @OriginalArg(11) float arg11, @OriginalArg(12) float arg12, @OriginalArg(13) float arg13, @OriginalArg(14) float arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18, @OriginalArg(19) int arg19, @OriginalArg(20) int arg20, @OriginalArg(21) int arg21, @OriginalArg(22) int arg22) {
		if (arg22 != this.anInt776) {
			this.anIntArray93 = this.aClass87_Sub3_4.method7985(arg22);
			if (this.anIntArray93 == null) {
				this.method685((float) arg0, (float) arg1, (float) arg2, (float) arg3, (float) arg4, (float) arg5, (float) arg6, (float) arg7, (float) arg8, Static535.method7475(arg18 | arg19 << 24, arg15), Static535.method7475(arg18 | arg20 << 24, arg16), Static535.method7475(arg18 | arg21 << 24, arg17));
				return;
			}
			...
			this.anInt773 = this.anInt775 - 1;
			this.anInt778 = this.aClass87_Sub3_4.method7988(arg22);
			this.aBoolean64 = this.aClass87_Sub3_4.method7981(arg22);
		}
		this.anInt780 = arg18;
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (!(arg0 >= (float) this.anInt767)) {
				...
				if (arg1 < arg2) {
					...
					if (arg0 != arg1 && local320 < local215 || arg0 == arg1 && local320 > local239) {
						...
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method682(this.anIntArray90, this.anIntArray93, (int) arg0, (int) arg5, (int) arg3, arg8, arg6, arg11, arg9, arg14, arg12, (float) arg21, (float) arg19, local120, local106, local141, local127, local162, local148, local177, local167);
							arg3 += local215;
							arg5 += local320;
							arg6 += local217;
							arg8 += local379;
						...
						while (--arg2 >= 0.0F) {
							this.method682(this.anIntArray90, this.anIntArray93, (int) arg0, (int) arg5, (int) arg4, arg8, arg7, arg11, arg10, arg14, arg13, (float) arg21, (float) arg20, local120, local113, local141, local134, local162, local155, local177, local172);
							arg4 += local239;
							arg5 += local320;
							arg7 += local298;
							arg8 += local379;
						...
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method682(this.anIntArray90, this.anIntArray93, (int) arg0, (int) arg3, (int) arg5, arg6, arg8, arg9, arg11, arg12, arg14, (float) arg19, (float) arg21, local106, local120, local127, local141, local148, local162, local167, local177);
							arg3 += local215;
							arg5 += local320;
							arg6 += local217;
							arg8 += local379;
						...
						while (--arg2 >= 0.0F) {
							this.method682(this.anIntArray90, this.anIntArray93, (int) arg0, (int) arg4, (int) arg5, arg7, arg8, arg10, arg11, arg13, arg14, (float) arg20, (float) arg21, local113, local120, local134, local141, local155, local162, local172, local177);
							arg4 += local239;
							arg5 += local320;
							arg7 += local298;
							arg8 += local379;
					...
					if (arg0 != arg2 && local320 < local215 || arg0 == arg2 && local239 > local215) {
						...
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method682(this.anIntArray90, this.anIntArray93, (int) arg0, (int) arg4, (int) arg3, arg7, arg6, arg10, arg9, arg13, arg12, (float) arg20, (float) arg19, local113, local106, local134, local127, local155, local148, local172, local167);
							arg3 += local215;
							arg4 += local320;
							arg6 += local217;
							arg7 += local379;
						...
						arg0 = this.anIntArray89[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method682(this.anIntArray90, this.anIntArray93, (int) arg0, (int) arg3, (int) arg4, arg6, arg7, arg9, arg10, arg12, arg13, (float) arg19, (float) arg20, local106, local113, local127, local134, local148, local155, local167, local172);
							arg4 += local320;
							arg3 += local215;
							arg7 += local379;
							arg6 += local217;
			...
			if (!(arg1 >= (float) this.anInt767)) {
				...
				if (arg2 < arg0) {
					...
					if ((arg1 == arg2 || !(local215 < local239)) && (arg1 != arg2 || !(local215 > local320))) {
						...
						arg1 = this.anIntArray89[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method682(this.anIntArray90, this.anIntArray93, (int) arg1, (int) arg4, (int) arg3, arg7, arg6, arg10, arg9, arg13, arg12, (float) arg20, (float) arg19, local113, local106, local134, local127, local155, local148, local172, local167);
							arg4 += local239;
							arg3 += local215;
							arg7 += local298;
							arg6 += local217;
						...
						while (--arg0 >= 0.0F) {
							this.method682(this.anIntArray90, this.anIntArray93, (int) arg1, (int) arg5, (int) arg3, arg8, arg6, arg11, arg9, arg14, arg12, (float) arg21, (float) arg19, local120, local106, local141, local127, local162, local148, local177, local167);
							arg5 += local320;
							arg3 += local215;
							arg8 += local379;
							arg6 += local217;
						...
						arg1 = this.anIntArray89[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method682(this.anIntArray90, this.anIntArray93, (int) arg1, (int) arg3, (int) arg4, arg6, arg7, arg9, arg10, arg12, arg13, (float) arg19, (float) arg20, local106, local113, local127, local134, local148, local155, local167, local172);
							arg3 += local215;
							arg4 += local239;
							arg6 += local217;
							arg7 += local298;
						...
						while (--arg0 >= 0.0F) {
							this.method682(this.anIntArray90, this.anIntArray93, (int) arg1, (int) arg3, (int) arg5, arg6, arg8, arg9, arg11, arg12, arg14, (float) arg19, (float) arg21, local106, local120, local127, local141, local148, local162, local167, local177);
							arg3 += local215;
							arg5 += local320;
							arg6 += local217;
							arg8 += local379;
					...
					if (local215 < local239) {
						while (--arg0 >= 0.0F) {
							this.method682(this.anIntArray90, this.anIntArray93, (int) arg1, (int) arg5, (int) arg4, arg8, arg7, arg11, arg10, arg14, arg13, (float) arg21, (float) arg20, local120, local113, local141, local134, local162, local155, local177, local172);
							arg5 += local215;
							arg4 += local239;
							arg8 += local217;
							arg7 += local298;
						...
						while (--arg0 >= 0.0F) {
							this.method682(this.anIntArray90, this.anIntArray93, (int) arg1, (int) arg4, (int) arg5, arg7, arg8, arg10, arg11, arg13, arg14, (float) arg20, (float) arg21, local113, local120, local134, local141, local155, local162, local172, local177);
							arg4 += local239;
							arg5 += local215;
							arg7 += local298;
							arg8 += local217;
			...
			if (arg0 < arg1) {
				...
				if (local239 < local320) {
					...
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method682(this.anIntArray90, this.anIntArray93, (int) arg2, (int) arg4, (int) arg5, arg7, arg8, arg10, arg11, arg13, arg14, (float) arg20, (float) arg21, local113, local120, local134, local141, local155, local162, local172, local177);
						arg4 += local239;
						arg5 += local320;
						arg7 += local298;
						arg8 += local379;
					...
					while (--arg1 >= 0.0F) {
						this.method682(this.anIntArray90, this.anIntArray93, (int) arg2, (int) arg4, (int) arg3, arg7, arg6, arg10, arg9, arg13, arg12, (float) arg20, (float) arg19, local113, local106, local134, local127, local155, local148, local172, local167);
						arg4 += local239;
						arg3 += local215;
						arg7 += local298;
						arg6 += local217;
					...
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method682(this.anIntArray90, this.anIntArray93, (int) arg2, (int) arg5, (int) arg4, arg8, arg7, arg11, arg10, arg14, arg13, (float) arg21, (float) arg20, local120, local113, local141, local134, local162, local155, local177, local172);
						arg5 += local320;
						arg4 += local239;
						arg8 += local379;
						arg7 += local298;
					...
					while (--arg1 >= 0.0F) {
						this.method682(this.anIntArray90, this.anIntArray93, (int) arg2, (int) arg3, (int) arg4, arg6, arg7, arg9, arg10, arg12, arg13, (float) arg19, (float) arg20, local106, local113, local127, local134, local148, local155, local167, local172);
						arg3 += local215;
						arg4 += local239;
						arg6 += local217;
						arg7 += local298;
				...
				if (local239 < local320) {
					...
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method682(this.anIntArray90, this.anIntArray93, (int) arg2, (int) arg3, (int) arg5, arg6, arg8, arg9, arg11, arg12, arg14, (float) arg19, (float) arg21, local106, local120, local127, local141, local148, local162, local167, local177);
						arg3 += local239;
						arg5 += local320;
						arg6 += local298;
						arg8 += local379;
					...
					arg2 = this.anIntArray89[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method682(this.anIntArray90, this.anIntArray93, (int) arg2, (int) arg5, (int) arg3, arg8, arg6, arg11, arg9, arg14, arg12, (float) arg21, (float) arg19, local120, local106, local141, local127, local162, local148, local177, local167);
						arg5 += local320;
						arg3 += local239;
						arg8 += local379;
						arg6 += local298;
