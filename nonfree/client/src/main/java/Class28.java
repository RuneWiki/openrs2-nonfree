...
public final class Class28 {
	...
	public void method454(@OriginalArg(0) Class1 arg0) {
		try {
			if (arg0.aClass1_42 != null) {
				arg0.method567();
			}
			...
			signlink.reporterror("2399, " + arg0 + ", " + -26173 + ", " + local27.toString());
			throw new RuntimeException();
		}
	}
	...
	public Class1 method457() {
		try {
			...
			signlink.reporterror("37919, " + 2 + ", " + local26.toString());
			throw new RuntimeException();
		}
	}
	...
	public Class1 method458() {
		try {
			...
			signlink.reporterror("89761, " + 551 + ", " + local24.toString());
			throw new RuntimeException();
		}
	}
	...
	public Class1 method459() {
		try {
			...
			signlink.reporterror("58136, " + false + ", " + local27.toString());
			throw new RuntimeException();
		}
	}
