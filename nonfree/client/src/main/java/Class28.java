...
public final class Class28 {
	...
	public Class28(@OriginalArg(0) int arg0) {
		try {
			...
			signlink.reporterror("98786, " + arg0 + ", " + local33.toString());
	...
	public void method446(@OriginalArg(0) Class1 arg0) {
		try {
			...
			signlink.reporterror("87067, " + arg0 + ", " + 683 + ", " + local26.toString());
			throw new RuntimeException();
		}
	}
	...
	public Class1 method449(@OriginalArg(0) int arg0) {
		try {
			...
			signlink.reporterror("63888, " + arg0 + ", " + local25.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!ob", name = "b", descriptor = "(I)Lclient!u;")
	public Class1 method450() {
		try {
			...
			signlink.reporterror("29129, " + 0 + ", " + local24.toString());
			throw new RuntimeException();
		}
	}
	...
	public Class1 method451() {
		try {
			...
			if (local8 == this.aClass1_33) {
				...
				this.aClass1_34 = local8.aClass1_42;
				return local8;
			}
		} catch (@Pc(24) RuntimeException local24) {
			signlink.reporterror("11912, " + false + ", " + local24.toString());
			throw new RuntimeException();
		}
	}
