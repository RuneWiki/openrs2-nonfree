...
public abstract class Class109 {
	...
	public abstract void wa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3);
	...
	public abstract void method7095(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3);
	...
	public abstract void NA(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
	...
	@OriginalMember(owner = "client!q", name = "M", descriptor = "(Lclient!q;)V")
	public abstract void M(@OriginalArg(0) Class109 arg0);

	@OriginalMember(owner = "client!q", name = "a", descriptor = "()Lclient!q;")
	public abstract Class109 method7100();
}
