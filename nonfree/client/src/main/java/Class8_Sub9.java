...
public final class Class8_Sub9 extends Class8 {
	...
	@OriginalMember(owner = "client!it", name = "<init>", descriptor = "(Lclient!hd;)V")
	public Class8_Sub9(@OriginalArg(0) Class4_Sub20 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!it", name = "<init>", descriptor = "(ILclient!hd;)V")
	public Class8_Sub9(@OriginalArg(0) int arg0, @OriginalArg(1) Class4_Sub20 arg1) {
		super(arg0, arg1);
	}
