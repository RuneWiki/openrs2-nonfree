...
public final class Class73_Sub1_Sub2 extends Class73_Sub1 {
	...
	@OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lclient!wk;[III)V")
	public Class73_Sub1_Sub2(@OriginalArg(0) Class31_Sub3 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		super(arg0, arg2, arg3);
		this.anIntArray156 = arg1;
	}

	@OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lclient!wk;[IIIII)V")
	public Class73_Sub1_Sub2(@OriginalArg(0) Class31_Sub3 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		super(arg0, arg4, arg5);
		this.anIntArray156 = new int[arg4 * arg5];
		...
		for (@Pc(19) int local19 = 0; local19 < arg5; local19++) {
			for (@Pc(22) int local22 = 0; local22 < arg4; local22++) {
				this.anIntArray156[local17++] = arg1[arg2++];
			}
			arg2 += local15;
		}
	}

	@OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lclient!wk;II)V")
	public Class73_Sub1_Sub2(@OriginalArg(0) Class31_Sub3 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		super(arg0, arg1, arg2);
		this.anIntArray156 = new int[arg1 * arg2];
	}
		...
		if (super.aClass31_Sub3_8.method8096()) {
			...
			if (arg6 != 0) {
					...
					if (arg4 == 1) {
						...
						for (local262 = -arg3; local262 < 0; local262++) {
							...
							for (local273 = -arg2; local273 < 0; local273++) {
								local330 = this.anIntArray156[(local14 >> 16) + local270];
						...
						if ((arg5 & 0xFFFFFF) == 16777215) {
							...
							for (local330 = -arg3; local330 < 0; local330++) {
								...
								for (local341 = -arg2; local341 < 0; local341++) {
									local351 = this.anIntArray156[(local14 >> 16) + local338];
						...
						for (local338 = -arg3; local338 < 0; local338++) {
							...
							for (local351 = -arg2; local351 < 0; local351++) {
								local359 = this.anIntArray156[(local14 >> 16) + local341];
				...
				for (local262 = -arg3; local262 < 0; local262++) {
					local270 = (local16 >> 16) * super.anInt6867;
					for (local273 = -arg2; local273 < 0; local273++) {
						local252[local64++] = this.anIntArray156[(local14 >> 16) + local270];
						local14 += local44;
					}
					local16 += local50;
					local14 = local259;
	...
	@OriginalMember(owner = "client!gi", name = "a", descriptor = "(IILclient!ua;II)V")
	@Override
	public void method7952(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class53 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		for (@Pc(212) int local212 = local171; local212 < local210; local212++) {
			...
			for (@Pc(304) int local304 = -local227; local304 < 0; local304++) {
				@Pc(311) int local311 = this.anIntArray156[local19++];
		...
		if (arg4 != 0) {
				...
				if (arg2 == 1) {
					for (local168 = -local32; local168 < 0; local168++) {
						for (local175 = -local35; local175 < 0; local175++) {
							local259 = this.anIntArray156[local29++];
					...
					if ((arg3 & 0xFFFFFF) == 16777215) {
						...
						for (local262 = -local32; local262 < 0; local262++) {
							for (local266 = -local35; local266 < 0; local266++) {
								local273 = this.anIntArray156[local29++];
					...
					for (local266 = -local32; local266 < 0; local266++) {
						for (local273 = -local35; local273 < 0; local273++) {
							local281 = this.anIntArray156[local29++];
			...
			for (local168 = -local32; local168 < 0; local168++) {
				...
				while (local27 < local175) {
					local160[local27++] = this.anIntArray156[local29++];
					local160[local27++] = this.anIntArray156[local29++];
					local160[local27++] = this.anIntArray156[local29++];
					local160[local27++] = this.anIntArray156[local29++];
				}
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local16 >= 0 && local14 - (super.anInt6867 << 12) < 0 && local16 - (super.anInt6852 << 12) < 0) {
						while (local18 < 0) {
							...
							local51 = local12++;
							if (arg0 == 1) {
								local209 = this.anIntArray156[local48];
								...
								local209 = this.anIntArray156[local48];
								local213 = (local209 >>> 24) * Static380.anInt6859 >> 8;
								local217 = 256 - local213;
								if ((Static380.anInt6857 & 0xFFFFFF) == 16777215) {
									local221 = local3[local51];
									local3[local51] = ((local209 & 0xFF00FF) * local213 + (local221 & 0xFF00FF) * local217 & 0xFF00FF00) + ((local209 & 0xFF00) * local213 + (local221 & 0xFF00) * local217 & 0xFF0000) >> 8;
								} else if (local213 == 255) {
									local221 = (local209 & 0xFF0000) * Static380.anInt6841 & 0xFF000000;
									local334 = (local209 & 0xFF00) * Static380.anInt6864 & 0xFF0000;
									local342 = (local209 & 0xFF) * Static380.anInt6838 & 0xFF00;
								...
								local342 = (local209 >>> 24) * Static380.anInt6859 >> 8;
								...
								local213 = local209 >>> 24;
								local217 = 256 - local213;
								local221 = (local209 & 0xFF00FF) * Static380.anInt6859 & 0xFF00FF00;
								local334 = (local209 & 0xFF00) * Static380.anInt6859 & 0xFF0000;
								local209 = ((local221 | local334) >>> 8) + Static380.anInt6861;
	...
	public void xa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(25) int local25;
		if (arg2 == 0) {
			local5 = super.aClass31_Sub3_8.anIntArray596;
			for (local7 = 0; local7 < super.anInt6852; local7++) {
				local13 = local7 * super.anInt6867;
				local23 = (arg1 + local7) * super.aClass31_Sub3_8.anInt10243 + arg0;
				for (local25 = 0; local25 < super.anInt6867; local25++) {
					this.anIntArray156[local13 + local25] = this.anIntArray156[local13 + local25] & 0xFFFFFF | (local5[local23 + local25] & 0xFF0000) << 8;
				}
			}
		} else if (arg2 == 3) {
			local5 = super.aClass31_Sub3_8.anIntArray596;
			for (local7 = 0; local7 < super.anInt6852; local7++) {
				...
				local23 = (arg1 + local7) * super.aClass31_Sub3_8.anInt10243 + arg0;
				for (local25 = 0; local25 < super.anInt6867; local25++) {
					this.anIntArray156[local13 + local25] = this.anIntArray156[local13 + local25] & 0xFFFFFF | (local5[local23 + local25] == 0 ? 0 : -16777216);
				}
			}
		}
	}
		...
		if (Static380.anInt6853 == 0) {
			if (Static380.anInt6848 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local27 >= 0 && local25 - (super.anInt6867 << 12) < 0 && local27 - (super.anInt6852 << 12) < 0) {
							...
							while (local29 < 0) {
								local111 = this.anIntArray156[(local27 >> 12) * super.anInt6867 + (local25 >> 12)];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt6867 << 12) < 0) {
							@Pc(210) int local210;
							if ((local210 = local27 - (super.anInt6852 << 12)) >= 0) {
								local217 = (Static380.anInt6848 - local210) / Static380.anInt6848;
								local29 += local217;
								local27 += Static380.anInt6848 * local217;
								local23 += local217;
							}
							@Pc(238) int local238;
							if ((local238 = (local27 - Static380.anInt6848) / Static380.anInt6848) > local29) {
								local29 = local238;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt6867 << 12) < 0) {
							if (local27 < 0) {
								local217 = (Static380.anInt6848 - local27 - 1) / Static380.anInt6848;
								local29 += local217;
								local27 += Static380.anInt6848 * local217;
								local23 += local217;
							}
							@Pc(441) int local441;
							if ((local441 = (local27 + 1 - (super.anInt6852 << 12) - Static380.anInt6848) / Static380.anInt6848) > local29) {
								local29 = local441;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
			...
			if (Static380.anInt6848 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local27 >= 0 && local27 - (super.anInt6852 << 12) < 0) {
							@Pc(618) int local618;
							if ((local618 = local25 - (super.anInt6867 << 12)) >= 0) {
								local217 = (Static380.anInt6853 - local618) / Static380.anInt6853;
								local29 += local217;
								local25 += Static380.anInt6853 * local217;
								local23 += local217;
							}
							@Pc(646) int local646;
							if ((local646 = (local25 - Static380.anInt6853) / Static380.anInt6853) > local29) {
								local29 = local646;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static380.anInt6849;
						@Pc(814) int local814;
						if ((local814 = local25 - (super.anInt6867 << 12)) >= 0) {
							local217 = (Static380.anInt6853 - local814) / Static380.anInt6853;
							local29 += local217;
							local25 += Static380.anInt6853 * local217;
							local27 += Static380.anInt6848 * local217;
							local23 += local217;
						...
						@Pc(848) int local848;
						if ((local848 = (local25 - Static380.anInt6853) / Static380.anInt6853) > local29) {
							local29 = local848;
						}
						@Pc(860) int local860;
						if ((local860 = local27 - (super.anInt6852 << 12)) >= 0) {
							local217 = (Static380.anInt6848 - local860) / Static380.anInt6848;
							local29 += local217;
							local25 += Static380.anInt6853 * local217;
							local27 += Static380.anInt6848 * local217;
							local23 += local217;
						...
						@Pc(894) int local894;
						if ((local894 = (local27 - Static380.anInt6848) / Static380.anInt6848) > local29) {
							local29 = local894;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if ((local1068 = local25 - (super.anInt6867 << 12)) >= 0) {
							local217 = (Static380.anInt6853 - local1068) / Static380.anInt6853;
							local29 += local217;
							local25 += Static380.anInt6853 * local217;
							local27 += Static380.anInt6848 * local217;
							local23 += local217;
						...
						if ((local1102 = (local25 - Static380.anInt6853) / Static380.anInt6853) > local29) {
							local29 = local1102;
						}
						if (local27 < 0) {
							local217 = (Static380.anInt6848 - local27 - 1) / Static380.anInt6848;
						...
						if ((local1150 = (local27 + 1 - (super.anInt6852 << 12) - Static380.anInt6848) / Static380.anInt6848) > local29) {
							local29 = local1150;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if (local27 >= 0 && local27 - (super.anInt6852 << 12) < 0) {
						if (local25 < 0) {
							local217 = (Static380.anInt6853 - local25 - 1) / Static380.anInt6853;
							local29 += local217;
							local25 += Static380.anInt6853 * local217;
							local23 += local217;
						}
						@Pc(1363) int local1363;
						if ((local1363 = (local25 + 1 - (super.anInt6867 << 12) - Static380.anInt6853) / Static380.anInt6853) > local29) {
							local29 = local1363;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1571 = (local25 + 1 - (super.anInt6867 << 12) - Static380.anInt6853) / Static380.anInt6853) > local29) {
						local29 = local1571;
					}
					@Pc(1583) int local1583;
					if ((local1583 = local27 - (super.anInt6852 << 12)) >= 0) {
						local217 = (Static380.anInt6848 - local1583) / Static380.anInt6848;
						local29 += local217;
						local25 += Static380.anInt6853 * local217;
						local27 += Static380.anInt6848 * local217;
						local23 += local217;
					...
					if ((local1617 = (local27 - Static380.anInt6848) / Static380.anInt6848) > local29) {
						local29 = local1617;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1827 = (local25 + 1 - (super.anInt6867 << 12) - Static380.anInt6853) / Static380.anInt6853) > local29) {
						local29 = local1827;
					}
					if (local27 < 0) {
						local217 = (Static380.anInt6848 - local27 - 1) / Static380.anInt6848;
					...
					if ((local1875 = (local27 + 1 - (super.anInt6852 << 12) - Static380.anInt6848) / Static380.anInt6848) > local29) {
						local29 = local1875;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
	...
	public void method5473(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		...
		if (arg7 != 0) {
				...
				if (arg5 == 1) {
					...
					for (local264 = -arg4; local264 < 0; local264++) {
						...
						for (local275 = -arg3; local275 < 0; local275++) {
							if (local8 < local250[local56]) {
								local337 = this.anIntArray156[(local10 >> 16) + local272];
					...
					if ((arg6 & 0xFFFFFF) == 16777215) {
						...
						for (local337 = -arg4; local337 < 0; local337++) {
							...
							for (local348 = -arg3; local348 < 0; local348++) {
								if (local8 < local250[local56]) {
									local363 = this.anIntArray156[(local10 >> 16) + local345];
					...
					for (local345 = -arg4; local345 < 0; local345++) {
						...
						for (local363 = -arg3; local363 < 0; local363++) {
							if (local8 < local250[local56]) {
								local371 = this.anIntArray156[(local10 >> 16) + local348];
			...
			for (local264 = -arg4; local264 < 0; local264++) {
				...
				for (local275 = -arg3; local275 < 0; local275++) {
					if (local8 < local250[local56]) {
						local254[local56] = this.anIntArray156[(local10 >> 16) + local272];
					}
					local10 += local36;
					local56++;
				}
	...
	public void da(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		for (@Pc(5) int local5 = 0; local5 < arg3; local5++) {
			...
			for (@Pc(24) int local24 = 0; local24 < arg2; local24++) {
				this.anIntArray156[local14 + local24] = local3[local22 + local24] & 0xFFFFFF;
			}
		}
	}
}
