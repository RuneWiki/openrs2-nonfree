...
public final class Class2_Sub35 extends Class2 {
	...
	public Class2_Sub35(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) boolean arg3) {
		...
		if (arg3) {
			@Pc(16) int[] local16 = new int[this.anInt6941];
			@Pc(20) int[] local20 = new int[this.anInt6941];
			@Pc(24) int[] local24 = new int[this.anInt6941];
			@Pc(28) int[] local28 = new int[this.anInt6941];
			if (Static346.anIntArray433 == null || Static346.anIntArray433.length != this.anIntArray434.length) {
				Static346.anIntArray433 = new int[this.anIntArray434.length];
			}
			@Pc(44) int local44 = this.anInt6941;
			@Pc(47) int local47 = this.anInt6941;
			...
			for (@Pc(65) int local65 = 2; local65 >= 0; local65--) {
				for (local68 = local51; local68 >= 0; local68--) {
					local62--;
					@Pc(75) int local75 = this.anIntArray434[local62];
			...
			for (@Pc(131) int local131 = local55; local131 >= 0; local131--) {
				...
				for (local68 = local51; local68 >= 0; local68--) {
					...
					local129--;
					Static346.anIntArray433[local129] = local188 << 24 | local192 << 16 | local196 << 8 | local200;
				...
				for (local68 = local51; local68 >= 0; local68--) {
					local62--;
					@Pc(277) int local277 = this.anIntArray434[local62];
					local63--;
					@Pc(283) int local283 = this.anIntArray434[local63];
			...
			@Pc(364) int[] local364 = this.anIntArray434;
			this.anIntArray434 = Static346.anIntArray433;
			Static346.anIntArray433 = local364;
		}
	}

	@OriginalMember(owner = "client!mg", name = "c", descriptor = "(II)V")
	public void method5932(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 == 0 && arg1 == 0) {
			return;
		}
		if (Static346.anIntArray433 == null || Static346.anIntArray433.length != this.anIntArray434.length) {
		...
		@Pc(21) int local21 = this.anIntArray434.length;
		@Pc(28) int local28 = this.anInt6941 - 1;
		@Pc(33) int local33 = this.anInt6941 * arg1;
		@Pc(37) int local37 = local21 - 1;
		for (@Pc(39) int local39 = 0; local39 < local21; local39 += this.anInt6941) {
			@Pc(46) int local46 = local39 + local33 & local37;
			for (@Pc(48) int local48 = 0; local48 < this.anInt6941; local48++) {
				@Pc(53) int local53 = local39 + local48;
				@Pc(61) int local61 = local46 + (local48 + arg0 & local28);
				Static346.anIntArray433[local53] = this.anIntArray434[local61];
			}
		}
		@Pc(84) int[] local84 = this.anIntArray434;
		this.anIntArray434 = Static346.anIntArray433;
		Static346.anIntArray433 = local84;
	}
