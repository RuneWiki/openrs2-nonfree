...
public final class Static71 {
	...
	public static void method1179(@OriginalArg(0) Js5Index arg0, @OriginalArg(2) Js5Index arg1, @OriginalArg(3) Js5Index arg2, @OriginalArg(4) Js5Index arg3) {
		Static4.aClass20_5 = arg2;
		aClass20_35 = arg3;
		Static133.aClass20_63 = arg1;
		Static10.aClass20_8 = arg0;
		Static65.aClass4_Sub7ArrayArray1 = new IfType[aClass20_35.method595()][];
	...
	public static void method1180(@OriginalArg(0) IfType[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7) {
		for (@Pc(7) int local7 = 0; local7 < arg0.length; local7++) {
			@Pc(13) IfType local13 = arg0[local7];
				...
				if (!local13.aBoolean79 || local78 > local76 && local80 > local82) {
					if (local13.anInt793 == 1337) {
						...
						if (local13.anInt743 == 0) {
							...
							@Pc(307) ComponentPointer local307 = (ComponentPointer) Static90.aClass81_11.method2010((long) local13.anInt738);
							if (local307 != null) {
							...
							if (local13.aBoolean78) {
								...
								if (local13.anObjectArray3 != null) {
									for (local120 = 0; local120 < Static45.anInt1278; local120++) {
										@Pc(1118) HookRequest local1118 = new HookRequest();
	...
	public static boolean method1181() {
		...
		try {
			...
			if (Static72.anInt1915 == 89) {
				...
				@Pc(632) HookRequest local632 = new HookRequest();
			...
			if (Static72.anInt1915 == 238) {
				...
				if (local571.method475(Static95.aClass22_536)) {
					...
					if (!local667 && Static79.anInt2177 == 0) {
						@Pc(957) JagString local957 = local571.method450(local571.method476(Static129.aClass22_949) + 1, local571.method449() + -9);
			...
			if (Static72.anInt1915 == 184) {
				...
				@Pc(1002) JagString local1002 = Static8.method1575(local988).method473();
				for (local236 = 0; local236 < Static2.anInt9; local236++) {
					if (local988 == Static29.aLongArray1[local236]) {
						if (local414 != Static75.anIntArray199[local236]) {
							...
							if (local414 > 0) {
								Static65.method1153(Static44.method856(new JagString[] { local1002, Static35.aClass22_245 }), 5, Static64.aClass22_485);
							}
							if (local414 == 0) {
								Static65.method1153(Static44.method856(new JagString[] { local1002, Static79.aClass22_616 }), 5, Static64.aClass22_485);
							}
						}
				...
				while (local1111 > 0) {
					...
					for (local1118 = 0; local1118 < local1111; local1118++) {
						if (Static75.anIntArray199[local1118] != Static72.anInt1919 && Static75.anIntArray199[local1118 + 1] == Static72.anInt1919 || Static75.anIntArray199[local1118] == 0 && Static75.anIntArray199[local1118 + 1] != 0) {
							...
							@Pc(1176) JagString local1176 = Static12.aClass22Array1[local1118];
			...
			if (Static72.anInt1915 == 212) {
				local140 = Static133.aClass4_Sub11_Sub1_3.method696();
				Static76.aClass12_8 = GameShell.aClass17_4.method388(local140);
				Static72.anInt1915 = -1;
				return true;
			}
			...
			if (Static72.anInt1915 == 68) {
				...
				if (!local1280 && Static79.anInt2177 == 0) {
					...
					@Pc(1361) JagString local1361 = Static81.method1393(Static107.method1754(Static133.aClass4_Sub11_Sub1_3).method467());
					if (local1118 == 2 || local1118 == 3) {
						Static79.method1433(Static44.method856(new JagString[] { Static122.aClass22_342, Static8.method1575(local988).method473() }), 9, local1361, Static8.method1575(local673).method473());
					} else if (local1118 == 1) {
						Static79.method1433(Static44.method856(new JagString[] { Static120.aClass22_909, Static8.method1575(local988).method473() }), 9, local1361, Static8.method1575(local673).method473());
					} else {
			...
			@Pc(1470) ComponentPointer local1470;
			if (Static72.anInt1915 == 111) {
				...
				local1470 = (ComponentPointer) Static90.aClass81_11.method2010((long) local414);
				if (local1470 != null) {
			...
			if (Static72.anInt1915 == 171) {
				...
				@Pc(1911) IfType local1911 = Static106.method1749(local203);
			...
			if (Static72.anInt1915 == 213) {
				for (local140 = 0; local140 < Static50.anInt1412; local140++) {
					@Pc(1964) VarPlayerType local1964 = Static48.method903(local140);
			...
			if (Static72.anInt1915 == 208) {
				...
				for (local203 = 0; local203 < 98; local203++) {
					if (local150 >= Stats.anIntArray307[local203]) {
			...
			if (Static72.anInt1915 == 161) {
				...
				for (local230 = local150; local230 <= local203; local230++) {
					...
					@Pc(2232) Linkable local2232 = Static96.aClass81_12.method2010(local2227);
					if (local2232 != null) {
						local2232.method1999();
					}
					Static96.aClass81_12.method2015(local2227, new ServerKeyProperties(local414));
				}
				Static72.anInt1915 = -1;
				return true;
			}
			...
			if (Static72.anInt1915 == 39) {
				...
				for (@Pc(2333) LocSpawned local2333 = (LocSpawned) Static39.aClass82_4.method2025(); local2333 != null; local2333 = (LocSpawned) Static39.aClass82_4.method2023()) {
			...
			if (Static72.anInt1915 == 222) {
				...
				if (!local2414 && Static79.anInt2177 == 0) {
					...
					Static41.anInt1132 = (Static41.anInt1132 + 1) % 100;
					@Pc(2490) JagString local2490 = Static81.method1393(Static107.method1754(Static133.aClass4_Sub11_Sub1_3).method467());
					if (local251 == 2 || local251 == 3) {
						Static65.method1153(local2490, 7, Static44.method856(new JagString[] { Static122.aClass22_342, Static8.method1575(local988).method473() }));
					} else if (local251 == 1) {
						Static65.method1153(local2490, 7, Static44.method856(new JagString[] { Static120.aClass22_909, Static8.method1575(local988).method473() }));
					} else {
			...
			if (Static72.anInt1915 == 51) {
				Static92.method1616(Static96.anInt2463, Static133.aClass4_Sub11_Sub1_3, GameShell.aClass17_4);
				Static72.anInt1915 = -1;
				return true;
			}
			...
			if (Static72.anInt1915 == 224) {
				...
				while (local414-- > 0) {
					...
					local230 = Static133.aClass4_Sub11_Sub1_3.method718();
					local236 = Static133.aClass4_Sub11_Sub1_3.method719();
					@Pc(3268) ComponentPointer local3268 = (ComponentPointer) Static90.aClass81_11.method2010((long) local203);
				...
				for (local1470 = (ComponentPointer) Static90.aClass81_11.method2017(); local1470 != null; local1470 = (ComponentPointer) Static90.aClass81_11.method2013()) {
				...
				Static96.aClass81_12 = new HashTable(512);
				while (local140 > Static133.aClass4_Sub11_Sub1_3.anInt1099) {
					...
					for (local1118 = local236; local1118 <= local251; local1118++) {
						...
						Static96.aClass81_12.method2015(local1301, new ServerKeyProperties(local1111));
					}
				}
				Static72.anInt1915 = -1;
				return true;
			...
			if (Static72.anInt1915 == 4) {
				...
				@Pc(3448) ClanMember[] local3448 = new ClanMember[100];
				Static133.anInt3150 = local230;
				for (local251 = 0; local251 < Static133.anInt3150; local251++) {
					local3448[local251] = new ClanMember();
				...
				while (local1158 > 0) {
					...
					for (local2422 = 0; local2422 < local1158; local2422++) {
						if (local3448[local2422].aClass22_214.method447(local3448[local2422 + 1].aClass22_214) > 0) {
							local3516 = false;
							@Pc(3542) ClanMember local3542 = local3448[local2422];
			...
			if (Static72.anInt1915 == 237) {
				local140 = Static133.aClass4_Sub11_Sub1_3.method725();
				@Pc(3806) ComponentPointer local3806 = (ComponentPointer) Static90.aClass81_11.method2010((long) local140);
				if (local3806 != null) {
			...
			if (Static72.anInt1915 == 46) {
				...
				if (local667) {
					...
					@Pc(3902) ClanMember local3902 = new ClanMember();
					...
					if (Static133.anInt3150 == 0) {
						Static92.aClass4_Sub8Array1 = new ClanMember[100];
					}
			...
			if (Static72.anInt1915 == 5) {
				...
				@Pc(4183) IfType local4183 = Static106.method1749(local150);
			...
			JagException.report(null, "T1 - " + Static72.anInt1915 + "," + Static133.anInt3142 + "," + Static30.anInt713 + " - " + Static96.anInt2463);
			Static75.method1271();
			...
			JagException.report(local4271, local4312);
			Static75.method1271();
		}
		return true;
	}
