...
public final class Static118 {
	...
	@OriginalMember(owner = "client!ka", name = "a", descriptor = "(II[B[IIIIIIIIILclient!ka;II)I")
	public static int method1201(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) Class2_Sub2_Sub2 arg9, @OriginalArg(13) int arg10, @OriginalArg(14) int arg11) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ka", name = "b", descriptor = "(II[B[IIIIIIIIILclient!ka;II)I")
	public static int method1202(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) Class2_Sub2_Sub2 arg9, @OriginalArg(13) int arg10, @OriginalArg(14) int arg11) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ka", name = "a", descriptor = "(II[B[IIIIIIILclient!ka;II)I")
	public static int method1204(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub2_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ka", name = "a", descriptor = "([B[IIIIIIIIILclient!ka;)I")
	public static int method1205(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class2_Sub2_Sub2 arg9) {
		arg2 >>= 0x8;
		...
		arg9.anInt1746 = arg4 >> 8;
		arg9.anInt1748 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ka", name = "a", descriptor = "([B[IIIIIIILclient!ka;)I")
	public static int method1207(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub2_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt1748 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ka", name = "b", descriptor = "([B[IIIIIIIIILclient!ka;)I")
	public static int method1208(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class2_Sub2_Sub2 arg9) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg8 >> 8;
		arg4 <<= 0x8;
		@Pc(15) int local15 = arg6 << 8;
	...
	@OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lclient!wd;II)Lclient!ka;")
	public static Class2_Sub2_Sub2 method1210(@OriginalArg(0) Class2_Sub12_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray24 == null || arg0.aByteArray24.length == 0 ? null : new Class2_Sub2_Sub2(arg0, (int) ((long) arg0.anInt2819 * 256L * (long) 100 / (long) (Static5.anInt382 * 100)), arg1);
	}

	@OriginalMember(owner = "client!ka", name = "b", descriptor = "(II[B[IIIIIIILclient!ka;II)I")
	public static int method1211(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub2_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ka", name = "b", descriptor = "([B[IIIIIIILclient!ka;)I")
	public static int method1213(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub2_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 8;
		@Pc(18) int local18;
