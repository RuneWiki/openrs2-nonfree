...
public final class Class30_Sub3_Sub2 extends Class30_Sub3 implements Interface19 {

	@OriginalMember(owner = "client!gh", name = "y", descriptor = "Lclient!fa;")
	public Class30_Sub3 aClass30_Sub3_2;

	@OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(IIILclient!fa;)V")
	public Class30_Sub3_Sub2(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class30_Sub3 arg3) {
		super(arg0, arg1, arg2, arg3.aShort108, false, false);
		this.aClass30_Sub3_2 = arg3;
	}

	@OriginalMember(owner = "client!gh", name = "a", descriptor = "(ILclient!qa;)V")
	@Override
	...
	@OriginalMember(owner = "client!gh", name = "a", descriptor = "(BLclient!qa;I)Lclient!r;")
	@Override
	...
	@OriginalMember(owner = "client!gh", name = "a", descriptor = "(BLclient!qa;)V")
	@Override
	...
	@OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lclient!qa;B)V")
	@Override
	...
	@OriginalMember(owner = "client!gh", name = "a", descriptor = "(IZIILclient!jt;ILclient!qa;)V")
	@Override
	...
	@OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lclient!qa;III)Z")
	@Override
	public boolean method7907(@OriginalArg(0) Class42 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		return false;
	}

	@OriginalMember(owner = "client!gh", name = "a", descriptor = "(ZLclient!qa;)Lclient!nk;")
	@Override
	public Class218 method7906(@OriginalArg(1) Class42 arg0) {
		return this.aClass30_Sub3_2.method7906(arg0);
	}

	@OriginalMember(owner = "client!gh", name = "b", descriptor = "(ZLclient!qa;)Lclient!vw;")
	@Override
