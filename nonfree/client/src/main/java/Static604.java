...
public final class Static604 {
	...
	@OriginalMember(owner = "client!in", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!in;II)I")
	public static int method3902(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class4_Sub13_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt4630 -= arg10.anInt4636 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt4630 += arg10.anInt4636 * local63;
		arg10.anInt4632 = arg4;
		arg10.anInt4627 = arg5;
		arg10.anInt4628 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!in", name = "a", descriptor = "(II[B[IIIIIIIILclient!in;II)I")
	public static int method3904(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub13_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt4632 -= arg8.anInt4631 * arg3;
		arg8.anInt4627 -= arg8.anInt4625 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!in", name = "a", descriptor = "(Lclient!fc;II)Lclient!in;")
	public static Class4_Sub13_Sub2 method3905(@OriginalArg(0) Class4_Sub16_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray37 == null || arg0.aByteArray37.length == 0 ? null : new Class4_Sub13_Sub2(arg0, (int) ((long) arg0.anInt3115 * 256L * (long) 100 / (long) (Static379.anInt7010 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!in", name = "a", descriptor = "(I[B[IIIIIIIILclient!in;)I")
	public static int method3916(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class4_Sub13_Sub2 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt4628 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!in", name = "a", descriptor = "(II[B[IIIIIIILclient!in;II)I")
	public static int method3917(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class4_Sub13_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!in", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!in;)I")
	public static int method3920(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class4_Sub13_Sub2 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt4630 += arg10.anInt4636 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt4632 = arg4 >> 2;
		arg10.anInt4627 = arg5 >> 2;
		arg10.anInt4628 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!in", name = "a", descriptor = "(Lclient!fc;III)Lclient!in;")
	public static Class4_Sub13_Sub2 method3921(@OriginalArg(0) Class4_Sub16_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray37 == null || arg0.aByteArray37.length == 0 ? null : new Class4_Sub13_Sub2(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!in", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!in;)I")
	public static int method3922(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class4_Sub13_Sub2 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt4630 += arg10.anInt4636 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!in", name = "a", descriptor = "([B[IIIIIIILclient!in;)I")
	public static int method3923(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class4_Sub13_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt4628 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!in", name = "b", descriptor = "(II[B[IIIIIIIILclient!in;II)I")
	public static int method3924(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub13_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!in", name = "a", descriptor = "([B[IIIIIIIILclient!in;)I")
	public static int method3926(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class4_Sub13_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt4632 += arg8.anInt4631 * (local24 - arg3);
		arg8.anInt4627 += arg8.anInt4625 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt4630 = arg4 >> 2;
		arg8.anInt4628 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!in", name = "b", descriptor = "(II[B[IIIIIIILclient!in;II)I")
	public static int method3927(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class4_Sub13_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	public static int method3930(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!in", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!in;II)I")
	public static int method3933(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class4_Sub13_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt4630 -= arg10.anInt4636 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!in", name = "c", descriptor = "(II[B[IIIIIIIILclient!in;II)I")
	public static int method3936(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub13_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt4632 -= arg8.anInt4631 * arg3;
		arg8.anInt4627 -= arg8.anInt4625 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!in", name = "b", descriptor = "([B[IIIIIIIILclient!in;)I")
	public static int method3937(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class4_Sub13_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt4632 += arg8.anInt4631 * (local22 - arg3);
		arg8.anInt4627 += arg8.anInt4625 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!in", name = "d", descriptor = "(II[B[IIIIIIIILclient!in;II)I")
	public static int method3938(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub13_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!in", name = "b", descriptor = "([B[IIIIIIILclient!in;)I")
	public static int method3939(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class4_Sub13_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!in", name = "b", descriptor = "(I[B[IIIIIIIILclient!in;)I")
	public static int method3940(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class4_Sub13_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
