...
public final class Static587 {
	...
	public static int method3414(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!gg", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!gg;)I")
	public static int method3417(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class6_Sub10_Sub2 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt3855 += arg10.anInt3868 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt3858 = arg4 >> 2;
		arg10.anInt3863 = arg5 >> 2;
		arg10.anInt3864 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!gg", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!gg;II)I")
	public static int method3418(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class6_Sub10_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt3855 -= arg10.anInt3868 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt3855 += arg10.anInt3868 * local63;
		arg10.anInt3858 = arg4;
		arg10.anInt3863 = arg5;
		arg10.anInt3864 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!gg", name = "a", descriptor = "(Lclient!wb;II)Lclient!gg;")
	public static Class6_Sub10_Sub2 method3422(@OriginalArg(0) Class6_Sub12_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray124 == null || arg0.aByteArray124.length == 0 ? null : new Class6_Sub10_Sub2(arg0, (int) ((long) arg0.anInt9543 * 256L * (long) 100 / (long) (Static77.anInt1912 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!gg", name = "a", descriptor = "(II[B[IIIIIIILclient!gg;II)I")
	public static int method3425(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class6_Sub10_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!gg", name = "a", descriptor = "([B[IIIIIIIILclient!gg;)I")
	public static int method3426(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class6_Sub10_Sub2 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt3858 += arg8.anInt3867 * (local24 - arg3);
		arg8.anInt3863 += arg8.anInt3857 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt3864 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!gg", name = "a", descriptor = "(I[B[IIIIIIIILclient!gg;)I")
	public static int method3427(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class6_Sub10_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
	...
	@OriginalMember(owner = "client!gg", name = "b", descriptor = "(II[B[IIIIIIILclient!gg;II)I")
	public static int method3429(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class6_Sub10_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!gg", name = "a", descriptor = "(II[B[IIIIIIIILclient!gg;II)I")
	public static int method3431(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class6_Sub10_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt3858 -= arg8.anInt3867 * arg3;
		arg8.anInt3863 -= arg8.anInt3857 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!gg", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!gg;)I")
	public static int method3432(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class6_Sub10_Sub2 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt3855 += arg10.anInt3868 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!gg", name = "a", descriptor = "([B[IIIIIIILclient!gg;)I")
	public static int method3433(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class6_Sub10_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt3864 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!gg", name = "b", descriptor = "(II[B[IIIIIIIILclient!gg;II)I")
	public static int method3436(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class6_Sub10_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	public static int method3439(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!gg", name = "b", descriptor = "([B[IIIIIIIILclient!gg;)I")
	public static int method3442(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class6_Sub10_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt3858 += arg8.anInt3867 * (local22 - arg3);
		arg8.anInt3863 += arg8.anInt3857 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!gg", name = "c", descriptor = "(II[B[IIIIIIIILclient!gg;II)I")
	public static int method3443(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class6_Sub10_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!gg", name = "a", descriptor = "(Lclient!wb;III)Lclient!gg;")
	public static Class6_Sub10_Sub2 method3444(@OriginalArg(0) Class6_Sub12_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray124 == null || arg0.aByteArray124.length == 0 ? null : new Class6_Sub10_Sub2(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!gg", name = "b", descriptor = "([B[IIIIIIILclient!gg;)I")
	public static int method3445(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class6_Sub10_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!gg", name = "d", descriptor = "(II[B[IIIIIIIILclient!gg;II)I")
	public static int method3447(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class6_Sub10_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt3858 -= arg8.anInt3867 * arg3;
		arg8.anInt3863 -= arg8.anInt3857 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!gg", name = "b", descriptor = "(I[B[IIIIIIIILclient!gg;)I")
	public static int method3449(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class6_Sub10_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!gg", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!gg;II)I")
	public static int method3450(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class6_Sub10_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt3855 -= arg10.anInt3868 * arg3;
		@Pc(23) int local23;
