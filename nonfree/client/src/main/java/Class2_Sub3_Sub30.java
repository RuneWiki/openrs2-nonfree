...
public final class Class2_Sub3_Sub30 extends Class2_Sub3 {
	...
	public int[] method6486(@OriginalArg(1) int arg0) {
		...
		if (super.aClass158_41.aBoolean265) {
			...
			@Pc(32) int[] local32 = this.method6474(1, arg0);
			@Pc(35) int local35 = this.anInt5689;
			if (local35 == 1) {
				for (local35 = 0; local35 < Static211.anInt4031; local35++) {
	...
	public int[][] method6480(@OriginalArg(0) int arg0) {
		...
		if (super.aClass243_41.aBoolean478) {
			...
			@Pc(32) int[][] local32 = this.method6484(1, arg0);
			...
			@Pc(71) int local71 = this.anInt5689;
			if (local71 == 1) {
				for (local71 = 0; local71 < Static211.anInt4031; local71++) {
	...
	@OriginalMember(owner = "client!ri", name = "a", descriptor = "(ILclient!bt;I)V", line = 573)
	@Override
	public void method6485(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub4 arg1) {
		if (arg0 == 0) {
			this.anInt5689 = arg1.method4816();
		} else if (arg0 == 1) {
