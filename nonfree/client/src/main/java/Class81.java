...
public abstract class Class81 {
	...
	public abstract void M(@OriginalArg(0) Class81 arg0);

	@OriginalMember(owner = "client!q", name = "a", descriptor = "()Lclient!q;")
	public abstract Class81 method6585();
	...
	public abstract void method6591(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3);
}
