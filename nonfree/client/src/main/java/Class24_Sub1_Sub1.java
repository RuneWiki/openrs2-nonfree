...
public final class Class24_Sub1_Sub1 extends Class24_Sub1 {
	...
	public Class24_Sub1_Sub1() {
		super(12, 5, 16, 2, 2, 0.45F);
	}

	@OriginalMember(owner = "client!cn", name = "a", descriptor = "(III)[B")
	public byte[] method819() {
		this.aByteArray15 = new byte[524288];
		this.method3198();
		return this.aByteArray15;
	}

	@OriginalMember(owner = "client!cn", name = "b", descriptor = "(IB)V")
	@Override
