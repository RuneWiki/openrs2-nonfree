...
public final class Class123 {
	...
	public Class123() throws Exception {
	...
	private void enter(@OriginalArg(0) Frame arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (arg4 == 0) {
			...
			for (@Pc(41) int local41 = 0; local41 < local37.length; local41++) {
				if (local37[local41].getWidth() == arg1 && local37[local41].getHeight() == arg2 && arg3 == local37[local41].getBitDepth()) {
					@Pc(73) int local73 = local37[local41].getRefreshRate();
					if (!local39 || Math.abs(local73 - local33) < Math.abs(arg4 - local33)) {
						arg4 = local73;
						local39 = true;
					}
				}
	...
	private void exit() {
		...
		this.method3106(null, (byte) -90);
	}

	@OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Ljava/awt/Frame;B)V")
	private void method3106(@OriginalArg(0) Frame arg0, @OriginalArg(1) byte arg1) {
