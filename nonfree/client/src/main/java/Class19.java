...
public final class Class19 {
	...
	@OriginalMember(owner = "client!KBKOJYZV", name = "a", descriptor = "Lclient!ZKCBWIIJ;")
	private static Class49 aClass49_1 = new Class49();

	@OriginalMember(owner = "client!KBKOJYZV", name = "a", descriptor = "([BI[BII)I")
	public static int method236(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		@Pc(3) Class49 local3 = aClass49_1;
		synchronized (aClass49_1) {
			aClass49_1.aByteArray13 = arg2;
			aClass49_1.anInt737 = arg4;
			aClass49_1.aByteArray14 = arg0;
			aClass49_1.anInt741 = 0;
			aClass49_1.anInt738 = arg3;
			aClass49_1.anInt742 = arg1;
			aClass49_1.anInt747 = 0;
			aClass49_1.anInt746 = 0;
			aClass49_1.anInt739 = 0;
			aClass49_1.anInt740 = 0;
			aClass49_1.anInt743 = 0;
			aClass49_1.anInt744 = 0;
			aClass49_1.anInt749 = 0;
			method238(aClass49_1);
			return arg1 - aClass49_1.anInt742;
		}
	}

	@OriginalMember(owner = "client!KBKOJYZV", name = "a", descriptor = "(Lclient!ZKCBWIIJ;)V")
	private static void method237(@OriginalArg(0) Class49 arg0) {
		@Pc(4) byte local4 = arg0.aByte24;
		@Pc(7) int local7 = arg0.anInt745;
		@Pc(10) int local10 = arg0.anInt753;
		@Pc(13) int local13 = arg0.anInt752;
		@Pc(15) int[] local15 = Class49.anIntArray181;
	...
	@OriginalMember(owner = "client!KBKOJYZV", name = "b", descriptor = "(Lclient!ZKCBWIIJ;)V")
	private static void method238(@OriginalArg(0) Class49 arg0) {
		arg0.anInt748 = 1;
		if (Class49.anIntArray181 == null) {
			Class49.anIntArray181 = new int[arg0.anInt748 * 100000];
		}
		@Pc(60) boolean local60 = true;
		while (true) {
			while (local60) {
				@Pc(64) byte local64 = method239(arg0);
				if (local64 == 23) {
					return;
				}
				local64 = method239(arg0);
				local64 = method239(arg0);
				local64 = method239(arg0);
				local64 = method239(arg0);
				local64 = method239(arg0);
				...
				local64 = method239(arg0);
				local64 = method239(arg0);
				local64 = method240(arg0);
				if (local64 == 0) {
					arg0.aBoolean161 = false;
				} else {
					arg0.aBoolean161 = true;
				}
				if (arg0.aBoolean161) {
				...
				@Pc(248) int local248 = method241(3, arg0);
				@Pc(252) int local252 = method241(15, arg0);
				...
				for (local340 = 0; local340 < local248; local340++) {
					@Pc(346) int local346 = method241(5, arg0);
				...
				for (local340 = 0; local340 < local248; local340++) {
					...
					method243(arg0.anIntArrayArray17[local340], arg0.anIntArrayArray18[local340], arg0.anIntArrayArray19[local340], arg0.aByteArrayArray3[local340], local388, local390, local244);
					arg0.anIntArray183[local340] = local388;
				}
				...
				for (local557 = method241(local535, arg0); local557 > local540[local553]; local557 = local557 << 1 | local566) {
					local553++;
					local566 = method240(arg0);
				}
				...
				while (true) {
						...
						if (local582 == 0 || local582 == 1) {
							...
							do {
								...
								if (local551 == 0) {
									...
									local535 = arg0.anIntArray183[local530];
							...
							local592++;
							local64 = arg0.aByteArray15[arg0.aByteArray16[arg0.anIntArray182[0]] & 0xFF];
							arg0.anIntArray178[local64 & 0xFF] += local592;
							while (local592 > 0) {
								Class49.anIntArray181[local520] = local64 & 0xFF;
								local520++;
								local592--;
							}
						} else {
							...
							if (local724 < 16) {
								...
								local732 = arg0.anIntArray182[local825] + local829;
								local64 = arg0.aByteArray16[local732];
								while (local732 > arg0.anIntArray182[local825]) {
									arg0.aByteArray16[local732] = arg0.aByteArray16[local732 - 1];
									local732--;
								}
								@Pc(865) int local865 = arg0.anIntArray182[local825]++;
								while (local825 > 0) {
									local865 = arg0.anIntArray182[local825]--;
									arg0.aByteArray16[arg0.anIntArray182[local825]] = arg0.aByteArray16[arg0.anIntArray182[local825 - 1] + 16 - 1];
									local825--;
								}
								local865 = arg0.anIntArray182[0]--;
								arg0.aByteArray16[arg0.anIntArray182[0]] = local64;
								if (arg0.anIntArray182[0] == 0) {
									@Pc(924) int local924 = 4095;
									for (@Pc(926) int local926 = 15; local926 >= 0; local926--) {
										for (@Pc(930) int local930 = 15; local930 >= 0; local930--) {
											arg0.aByteArray16[local924] = arg0.aByteArray16[arg0.anIntArray182[local926] + local930];
											local924--;
										}
										arg0.anIntArray182[local926] = local924 + 1;
									}
								}
							}
							arg0.anIntArray178[arg0.aByteArray15[local64 & 0xFF] & 0xFF]++;
							Class49.anIntArray181[local520] = arg0.aByteArray15[local64 & 0xFF] & 0xFF;
							local520++;
							if (local551 == 0) {
								local523++;
								local551 = 50;
					...
					arg0.anInt745 = 0;
					arg0.aByte24 = 0;
					arg0.anIntArray179[0] = 0;
					for (local164 = 1; local164 <= 256; local164++) {
						arg0.anIntArray179[local164] = arg0.anIntArray178[local164 - 1];
					}
					for (local164 = 1; local164 <= 256; local164++) {
						arg0.anIntArray179[local164] += arg0.anIntArray179[local164 - 1];
					}
					for (local164 = 0; local164 < local520; local164++) {
						local64 = (byte) (Class49.anIntArray181[local164] & 0xFF);
						Class49.anIntArray181[arg0.anIntArray179[local64 & 0xFF]] |= local164 << 8;
						arg0.anIntArray179[local64 & 0xFF]++;
					}
					arg0.anInt751 = Class49.anIntArray181[arg0.anInt750] >> 8;
					arg0.anInt753 = 0;
					arg0.anInt751 = Class49.anIntArray181[arg0.anInt751];
	...
	@OriginalMember(owner = "client!KBKOJYZV", name = "c", descriptor = "(Lclient!ZKCBWIIJ;)B")
	private static byte method239(@OriginalArg(0) Class49 arg0) {
		return (byte) method241(8, arg0);
	}

	@OriginalMember(owner = "client!KBKOJYZV", name = "d", descriptor = "(Lclient!ZKCBWIIJ;)B")
	private static byte method240(@OriginalArg(0) Class49 arg0) {
		return (byte) method241(1, arg0);
	}

	@OriginalMember(owner = "client!KBKOJYZV", name = "a", descriptor = "(ILclient!ZKCBWIIJ;)I")
	private static int method241(@OriginalArg(0) int arg0, @OriginalArg(1) Class49 arg1) {
		while (arg1.anInt747 < arg0) {
			arg1.anInt746 = arg1.anInt746 << 8 | arg1.aByteArray13[arg1.anInt737] & 0xFF;
			arg1.anInt747 += 8;
			arg1.anInt737++;
			arg1.anInt738--;
			arg1.anInt739++;
	...
	@OriginalMember(owner = "client!KBKOJYZV", name = "e", descriptor = "(Lclient!ZKCBWIIJ;)V")
	private static void method242(@OriginalArg(0) Class49 arg0) {
		arg0.anInt754 = 0;
		for (@Pc(4) int local4 = 0; local4 < 256; local4++) {
			if (arg0.aBooleanArray9[local4]) {
				arg0.aByteArray15[arg0.anInt754] = (byte) local4;
				arg0.anInt754++;
			}
		}
	}
	...
	private static void method243(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) byte[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(3) int local3 = 0;
		@Pc(5) int local5;
