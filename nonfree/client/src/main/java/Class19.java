...
public final class Class19 implements Interface3 {
	...
	public Class19() {
		if (this.anInt566 < 0 && (Static71.aBoolean153 && Static71.anInt1541 >= 2)) {
			@Pc(19) int[] local19 = new int[1];
			@Pc(21) GL local21 = Static71.aGL1;
			local21.glGenProgramsARB(1, local19, 0);
			this.anInt564 = local19[0];
			@Pc(42) int[][] local42 = Static304.method4551(0.4F);
			@Pc(53) int[][] local53 = Static304.method4551(0.4F);
			@Pc(58) Class1_Sub13 local58 = new Class1_Sub13(262144);
			for (@Pc(60) int local60 = 0; local60 < 256; local60++) {
				...
				for (@Pc(73) int local73 = 0; local73 < 64; local73++) {
					if (Static71.aBoolean168) {
						local58.method1881((float) local67[local73] / 4096.0F);
						local58.method1881((float) local71[local73] / 4096.0F);
						local58.method1881(1.0F);
						local58.method1881(1.0F);
					} else {
						local58.method1848((float) local67[local73] / 4096.0F);
						local58.method1848((float) local71[local73] / 4096.0F);
						local58.method1848(1.0F);
						local58.method1848(1.0F);
					}
				}
			}
			@Pc(141) ByteBuffer local141 = ByteBuffer.allocateDirect(local58.anInt2018).order(ByteOrder.nativeOrder());
			local141.put(local58.aByteArray63, 0, local58.anInt2018);
			local141.flip();
	...
	private void method531() {
		...
		this.anInt566 = local1.glGenLists(2);
		local1.glNewList(this.anInt566, 4864);
		...
		local1.glBindProgramARB(34336, this.anInt564);
		local1.glEnable(34336);
		local1.glEndList();
		local1.glNewList(this.anInt566 + 1, 4864);
		local1.glActiveTexture(33985);
		...
		local1.glDisable(Static251.aBoolean429 ? 32879 : 3553);
		local1.glActiveTexture(33984);
	...
	public void method3931() {
		if (this.anInt566 >= 0) {
			...
			local5.glCallList(this.anInt566 + 1);
		}
	}
	...
	public void method3930(@OriginalArg(0) int arg0) {
		...
		if ((arg0 & 0x80) == 0) {
			local5.glEnable(Static251.aBoolean429 ? 32879 : 3553);
		} else {
			local5.glDisable(Static251.aBoolean429 ? 32879 : 3553);
		}
		local5.glActiveTexture(33984);
		if ((arg0 & 0x40) == 0) {
			local5.glGetFloatv(2899, Static30.aFloatArray3, 0);
			local5.glProgramLocalParameter4fvARB(34336, 66, Static30.aFloatArray3, 0);
		} else {
	...
	public void method3929() {
		...
		@Pc(5) GL local5 = Static71.aGL1;
		local5.glCallList(this.anInt566);
		local5.glActiveTexture(33985);
		local5.glMatrixMode(5890);
		local5.glTranslatef((float) Static37.anInt689, (float) Static253.anInt4655, (float) Static224.anInt4207);
		local5.glRotatef(-((float) Static175.anInt3414 * 360.0F) / 2048.0F, 0.0F, 1.0F, 0.0F);
		local5.glRotatef(-((float) Static284.anInt5165 * 360.0F) / 2048.0F, 1.0F, 0.0F, 0.0F);
		local5.glRotatef(-180.0F, 1.0F, 0.0F, 0.0F);
		local5.glMatrixMode(5888);
		if (!Static251.aBoolean429) {
			local5.glBindTexture(3553, Static251.anIntArray513[(int) ((float) (Static71.anInt1545 * 64) * 0.005F) % 64]);
		}
		local5.glActiveTexture(33984);
		if (this.anInt565 == Static71.anInt1545) {
			return;
		}
		@Pc(85) int local85 = (Static71.anInt1545 & 0xFF) * 256;
		...
		if (Static251.aBoolean429) {
			local5.glProgramLocalParameter4fARB(34336, 65, (float) Static71.anInt1545 * 0.005F, 0.0F, 0.0F, 1.0F);
		} else {
			local5.glProgramLocalParameter4fARB(34336, 65, 0.0F, 0.0F, 0.0F, 1.0F);
		}
		this.anInt565 = Static71.anInt1545;
	}

	@OriginalMember(owner = "client!bo", name = "f", descriptor = "()V")
	private void method532() {
		...
		local4.glBindProgramARB(34336, this.anInt564);
