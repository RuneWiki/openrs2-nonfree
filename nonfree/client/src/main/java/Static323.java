...
public final class Static323 {
	...
	@OriginalMember(owner = "client!rc", name = "a", descriptor = "([B[IIIIIIIILclient!rc;)I")
	public static int method3700(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub24_Sub2 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt4367 += arg8.anInt4362 * (local22 - arg3);
		arg8.anInt4371 += arg8.anInt4365 * (local22 - arg3);
		local22 -= 3;
		@Pc(54) int local54;
		while (arg3 < local22) {
			local54 = arg3++;
		...
		arg8.anInt4366 = arg4 >> 2;
		arg8.anInt4373 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!rc", name = "a", descriptor = "(II[B[IIIIIIIILclient!rc;II)I")
	public static int method3702(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub24_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt4367 -= arg8.anInt4362 * arg3;
		arg8.anInt4371 -= arg8.anInt4365 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!rc", name = "a", descriptor = "(I[B[IIIIIIIILclient!rc;)I")
	public static int method3703(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub24_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
	...
	@OriginalMember(owner = "client!rc", name = "b", descriptor = "(II[B[IIIIIIIILclient!rc;II)I")
	public static int method3711(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub24_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt4367 -= arg8.anInt4362 * arg3;
		arg8.anInt4371 -= arg8.anInt4365 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!rc", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!rc;)I")
	public static int method3713(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub24_Sub2 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt4366 += arg10.anInt4361 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(64) byte local64;
		...
		arg10.anInt4367 = arg4 >> 2;
		arg10.anInt4371 = arg5 >> 2;
		arg10.anInt4373 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!rc", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!rc;II)I")
	public static int method3715(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub24_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt4366 -= arg10.anInt4361 * arg3;
		@Pc(23) int local23;
		...
		local65 = arg3 >> 1;
		arg10.anInt4366 += arg10.anInt4361 * local65;
		arg10.anInt4367 = arg4;
		arg10.anInt4371 = arg5;
		arg10.anInt4373 = arg2;
		return local65;
	}

	@OriginalMember(owner = "client!rc", name = "a", descriptor = "([B[IIIIIIILclient!rc;)I")
	public static int method3716(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub24_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt4373 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!rc", name = "c", descriptor = "(II[B[IIIIIIIILclient!rc;II)I")
	public static int method3718(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub24_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!rc", name = "b", descriptor = "([B[IIIIIIILclient!rc;)I")
	public static int method3719(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub24_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!rc", name = "a", descriptor = "(II[B[IIIIIIILclient!rc;II)I")
	public static int method3720(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub24_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!rc", name = "b", descriptor = "(I[B[IIIIIIIILclient!rc;)I")
	public static int method3721(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub24_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lclient!fn;III)Lclient!rc;")
	public static Class1_Sub24_Sub2 method3724(@OriginalArg(0) Class1_Sub5_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray21 == null || arg0.aByteArray21.length == 0 ? null : new Class1_Sub24_Sub2(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!rc", name = "b", descriptor = "([B[IIIIIIIILclient!rc;)I")
	public static int method3728(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub24_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt4367 += arg8.anInt4362 * (local24 - arg3);
		arg8.anInt4371 += arg8.anInt4365 * (local24 - arg3);
		local24 -= 3;
		@Pc(56) int local56;
		while (arg3 < local24) {
			local56 = arg3++;
	...
	@OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lclient!fn;II)Lclient!rc;")
	public static Class1_Sub24_Sub2 method3729(@OriginalArg(0) Class1_Sub5_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray21 == null || arg0.aByteArray21.length == 0 ? null : new Class1_Sub24_Sub2(arg0, (int) ((long) arg0.anInt1672 * 256L * (long) 100 / (long) (Static303.anInt5383 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!rc", name = "b", descriptor = "(II[B[IIIIIIILclient!rc;II)I")
	public static int method3732(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub24_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!rc", name = "d", descriptor = "(II[B[IIIIIIIILclient!rc;II)I")
	public static int method3733(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub24_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!rc", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!rc;II)I")
	public static int method3734(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub24_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt4366 -= arg10.anInt4361 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!rc", name = "d", descriptor = "(II)I")
	public static int method3737(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!rc", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!rc;)I")
	public static int method3738(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub24_Sub2 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt4366 += arg10.anInt4361 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(62) byte local62;
