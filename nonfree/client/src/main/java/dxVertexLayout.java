...
public final class dxVertexLayout extends Class277 {
	...
	@OriginalMember(owner = "client!dxVertexLayout", name = "<init>", descriptor = "(Lclient!wu;[Lclient!mj;)V")
	public dxVertexLayout(@OriginalArg(0) Class145_Sub1_Sub2 arg0, @OriginalArg(1) Class243[] arg1) {
		@Pc(7) VertexElementCollection local7 = new VertexElementCollection(arg0.aDq1);
		@Pc(9) int local9 = 0;
		for (@Pc(11) int local11 = 0; local11 < arg1.length; local11++) {
			@Pc(21) int local21 = 0;
			@Pc(25) Class243 local25 = arg1[local11];
			for (@Pc(27) int local27 = 0; local25.method5863() > local27; local27++) {
				@Pc(41) Class115 local41 = local25.method5862(local27);
				if (Static169.aClass115_1 == local41) {
					local7.addElement(local11, 2, 0, 0, 0, local21);
				} else if (Static169.aClass115_2 == local41) {
					local7.addElement(local11, 2, 0, 3, 0, local21);
				} else if (Static169.aClass115_3 == local41) {
					local7.addElement(local11, 4, 0, 10, 0, local21);
				} else if (local41 == Static169.aClass115_4) {
					local7.addElement(local11, 0, 0, 5, local9++, local21);
				} else if (local41 == Static169.aClass115_5) {
					local7.addElement(local11, 1, 0, 5, local9++, local21);
				} else if (local41 == Static169.aClass115_6) {
					local7.addElement(local11, 2, 0, 5, local9++, local21);
				} else if (Static169.aClass115_7 == local41) {
