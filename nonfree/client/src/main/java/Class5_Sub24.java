...
public final class Class5_Sub24 extends Class5 {
	...
	private float[] method2665(@OriginalArg(0) int arg0) {
		Static143.method2662(this.aByteArrayArray8[arg0]);
		Static143.method2668();
		@Pc(15) int local15 = Static143.method2666(Static81.method1791(Static143.anIntArray178.length - 1));
		@Pc(19) boolean local19 = Static143.aBooleanArray11[local15];
		@Pc(25) int local25 = local19 ? Static143.anInt2832 : Static143.anInt2828;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static143.method2668() != 0;
			local29 = Static143.method2668() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static143.anInt2828 >> 2);
			local67 = (local25 >> 2) + (Static143.anInt2828 >> 2);
			local71 = Static143.anInt2828 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static143.anInt2828 >> 2);
			local104 = local25 + (Static143.anInt2828 >> 2) - (local25 >> 2);
			local108 = Static143.anInt2828 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class38 local123 = Static143.aClass38Array1[Static143.anIntArray178[local15]];
		@Pc(126) int local126 = local123.anInt1108;
		@Pc(131) int local131 = local123.anIntArray53[local126];
		@Pc(140) boolean local140 = !Static143.aClass56Array1[local131].method1556();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt1109; local144++) {
			@Pc(152) Class115 local152 = Static143.aClass115Array1[local123.anIntArray52[local144]];
			local154 = Static143.aFloatArray10;
			local152.method3166(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt1108;
			local176 = local123.anIntArray53[local171];
			Static143.aClass56Array1[local176].method1559(Static143.aFloatArray10, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static143.aFloatArray10[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static143.aFloatArray10;
			...
			@Pc(252) float[] local252 = local19 ? Static143.aFloatArray7 : Static143.aFloatArray11;
			@Pc(258) float[] local258 = local19 ? Static143.aFloatArray9 : Static143.aFloatArray12;
			@Pc(264) float[] local264 = local19 ? Static143.aFloatArray8 : Static143.aFloatArray6;
			@Pc(270) int[] local270 = local19 ? Static143.anIntArray177 : Static143.anIntArray176;
			...
			@Pc(486) int local486 = Static81.method1791(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static143.aFloatArray10[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static143.aFloatArray10[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt2829 > 0) {
			local176 = this.anInt2829 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean188) {
				for (local212 = 0; local212 < this.anInt2830; local212++) {
					local1254 = (this.anInt2829 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static143.aFloatArray10[local212];
				}
			}
		}
		local154 = this.aFloatArray13;
		this.aFloatArray13 = Static143.aFloatArray10;
		Static143.aFloatArray10 = local154;
		this.anInt2829 = local25;
		this.anInt2830 = local104 - (local25 >> 1);
		this.aBoolean188 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!jd", name = "b", descriptor = "([B)V")
	private void method2670(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class5_Sub1 local4 = new Class5_Sub1(arg0);
		this.anInt2836 = local4.method1826();
		this.anInt2833 = local4.method1826();
		this.anInt2835 = local4.method1826();
		this.anInt2831 = local4.method1826();
		if (this.anInt2831 < 0) {
			this.anInt2831 = ~this.anInt2831;
			this.aBoolean189 = true;
		}
		@Pc(40) int local40 = local4.method1826();
		this.aByteArrayArray8 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method1832();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method1860(local64, local49);
			this.aByteArrayArray8[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!jd", name = "a", descriptor = "([I)Lclient!fp;")
	public Class5_Sub15_Sub1 method2672(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray27 == null) {
			this.anInt2829 = 0;
			this.aFloatArray13 = new float[Static143.anInt2832];
			this.aByteArray27 = new byte[this.anInt2833];
			this.anInt2838 = 0;
			this.anInt2839 = 0;
		}
		while (this.anInt2839 < this.aByteArrayArray8.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method2665(this.anInt2839);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2838;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt2833 - local47) {
					local50 = this.anInt2833 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2838;
				}
				this.anInt2838 = local47;
			}
			this.anInt2839++;
		}
		...
		return new Class5_Sub15_Sub1(this.anInt2836, local129, this.anInt2835, this.anInt2831, this.aBoolean189);
	}
}
