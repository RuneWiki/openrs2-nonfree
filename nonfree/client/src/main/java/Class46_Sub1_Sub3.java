...
public final class Class46_Sub1_Sub3 extends Class46_Sub1 {
	...
	@OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Lclient!dda;[B[III)V")
	public Class46_Sub1_Sub3(@OriginalArg(0) Class43_Sub2 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		super(arg0, arg3, arg4);
		this.aByteArray39 = arg1;
		this.anIntArray329 = arg2;
	}
	...
	protected void YA(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (super.aClass43_Sub2_7.method1943()) {
			throw new IllegalStateException();
		} else if (arg2 > 0 && arg3 > 0) {
			@Pc(14) int local14 = 0;
			@Pc(16) int local16 = 0;
			@Pc(20) int local20 = super.aClass43_Sub2_7.anInt2139;
			@Pc(29) int local29 = super.anInt4157 + super.anInt4155 + super.anInt4139;
			@Pc(38) int local38 = super.anInt4161 + super.anInt4159 + super.anInt4142;
			@Pc(44) int local44 = (local29 << 16) / arg2;
			@Pc(50) int local50 = (local38 << 16) / arg3;
			@Pc(64) int local64;
			if (super.anInt4157 > 0) {
				local64 = ((super.anInt4157 << 16) + local44 - 1) / local44;
				arg0 += local64;
				local14 += local64 * local44 - (super.anInt4157 << 16);
			}
			if (super.anInt4161 > 0) {
				local64 = ((super.anInt4161 << 16) + local50 - 1) / local50;
				arg1 += local64;
				local16 += local64 * local50 - (super.anInt4161 << 16);
			}
			if (super.anInt4155 < local29) {
				arg2 = ((super.anInt4155 << 16) + local44 - local14 - 1) / local44;
			}
			if (super.anInt4159 < local38) {
				arg3 = ((super.anInt4159 << 16) + local50 - local16 - 1) / local50;
			}
			local64 = arg0 + arg1 * local20;
			@Pc(152) int local152 = local20 - arg2;
			if (arg1 + arg3 > super.aClass43_Sub2_7.anInt2131) {
				arg3 -= arg1 + arg3 - super.aClass43_Sub2_7.anInt2131;
			}
			@Pc(180) int local180;
			if (arg1 < super.aClass43_Sub2_7.anInt2133) {
				local180 = super.aClass43_Sub2_7.anInt2133 - arg1;
				arg3 -= local180;
				local64 += local180 * local20;
				local16 += local50 * local180;
			}
			if (arg0 + arg2 > super.aClass43_Sub2_7.anInt2145) {
				local180 = arg0 + arg2 - super.aClass43_Sub2_7.anInt2145;
				arg2 -= local180;
				local152 += local180;
			}
			if (arg0 < super.aClass43_Sub2_7.anInt2132) {
				local180 = super.aClass43_Sub2_7.anInt2132 - arg0;
				arg2 -= local180;
				local64 += local180;
				local14 += local44 * local180;
				local152 += local180;
			}
			@Pc(252) int[] local252 = super.aClass43_Sub2_7.anIntArray137;
			@Pc(259) int local259;
			@Pc(262) int local262;
			@Pc(270) int local270;
			@Pc(273) int local273;
			...
			if (arg6 != 0) {
				...
				if (arg6 == 1) {
					if (arg4 == 1) {
						...
						for (local262 = -arg3; local262 < 0; local262++) {
							local270 = (local16 >> 16) * super.anInt4155;
							for (local273 = -arg2; local273 < 0; local273++) {
								local446 = this.aByteArray39[(local14 >> 16) + local270];
								if (local446 == 0) {
									local64++;
								} else {
									local252[local64++] = this.anIntArray329[local446 & 0xFF];
								}
								local14 += local44;
							}
							local16 += local50;
						...
						if (arg4 == 0) {
							...
							for (local273 = -arg3; local273 < 0; local273++) {
								...
								for (local343 = -arg2; local343 < 0; local343++) {
									local735 = this.aByteArray39[(local14 >> 16) + local335];
									local361 = local735 > 0 ? this.anIntArray329[local735] : 0;
					...
					for (local262 = -arg3; local262 < 0; local262++) {
						...
						for (local273 = -arg2; local273 < 0; local273++) {
							...
							if (local446 == 0) {
								...
								local343 = this.anIntArray329[local446 & 0xFF];
					...
					for (local262 = -arg3; local262 < 0; local262++) {
						...
						for (local273 = -arg2; local273 < 0; local273++) {
							local446 = this.aByteArray39[(local14 >> 16) + local270];
							local343 = local446 > 0 ? this.anIntArray329[local446] : 0;
				...
				for (local262 = -arg3; local262 < 0; local262++) {
					local270 = (local16 >> 16) * super.anInt4155;
					for (local273 = -arg2; local273 < 0; local273++) {
						local252[local64++] = this.anIntArray329[this.aByteArray39[(local14 >> 16) + local270] & 0xFF];
						local14 += local44;
					}
					local16 += local50;
					local14 = local259;
				...
				for (local335 = -arg3; local335 < 0; local335++) {
					local343 = (local16 >> 16) * super.anInt4155;
					for (local346 = -arg2; local346 < 0; local346++) {
						local361 = this.anIntArray329[this.aByteArray39[(local14 >> 16) + local343] & 0xFF];
				...
				for (local343 = -arg3; local343 < 0; local343++) {
					local346 = (local16 >> 16) * super.anInt4155;
					for (local361 = -arg2; local361 < 0; local361++) {
						local369 = this.anIntArray329[this.aByteArray39[(local14 >> 16) + local346] & 0xFF];
	...
	@OriginalMember(owner = "client!hs", name = "a", descriptor = "(IILclient!ua;II)V")
	@Override
	public void method7610(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class146 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		arg0 += super.anInt4157;
		arg1 += super.anInt4161;
		@Pc(19) int local19 = 0;
		@Pc(23) int local23 = super.aClass43_Sub2_7.anInt2139;
		@Pc(26) int local26 = super.anInt4155;
		@Pc(29) int local29 = super.anInt4159;
		@Pc(33) int local33 = local23 - local26;
		@Pc(35) int local35 = 0;
		@Pc(41) int local41 = arg0 + arg1 * local23;
		@Pc(52) int local52;
		if (arg1 < super.aClass43_Sub2_7.anInt2133) {
			local52 = super.aClass43_Sub2_7.anInt2133 - arg1;
			local29 -= local52;
			arg1 = super.aClass43_Sub2_7.anInt2133;
			local19 = local52 * local26;
			local41 += local52 * local23;
		}
		if (arg1 + local29 > super.aClass43_Sub2_7.anInt2131) {
			local29 -= arg1 + local29 - super.aClass43_Sub2_7.anInt2131;
		}
		if (arg0 < super.aClass43_Sub2_7.anInt2132) {
			local52 = super.aClass43_Sub2_7.anInt2132 - arg0;
			local26 -= local52;
			arg0 = super.aClass43_Sub2_7.anInt2132;
			local19 += local52;
			local41 += local52;
			local35 = local52;
			local33 += local52;
		}
		if (arg0 + local26 > super.aClass43_Sub2_7.anInt2145) {
			local52 = arg0 + local26 - super.aClass43_Sub2_7.anInt2145;
			local26 -= local52;
			local35 += local52;
			local33 += local52;
		}
		...
		@Pc(159) Class146_Sub1 local159 = (Class146_Sub1) arg2;
		@Pc(162) int[] local162 = local159.anIntArray345;
		@Pc(165) int[] local165 = local159.anIntArray344;
		@Pc(169) int[] local169 = super.aClass43_Sub2_7.anIntArray137;
		@Pc(171) int local171 = arg1;
		if (arg4 > arg1) {
			local171 = arg4;
			local41 += (arg4 - arg1) * local23;
			local19 += (arg4 - arg1) * super.anInt4155;
		}
		...
		for (@Pc(212) int local212 = local171; local212 < local210; local212++) {
			...
			for (@Pc(304) int local304 = -local227; local304 < 0; local304++) {
				...
				if (local311 == 0) {
					...
					local169[local41++] = this.anIntArray329[local311 & 0xFF];
				}
			}
	...
	@Override
	protected void method3686(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(3) int[] local3 = super.aClass43_Sub2_7.anIntArray137;
		@Pc(186) int local186;
		@Pc(9) int local9;
		@Pc(14) int local14;
		@Pc(23) int local23;
		...
		if (Static256.anInt4148 == 0) {
			if (Static256.anInt4132 == 0) {
				local9 = Static256.anInt4147;
				while (local9 < 0) {
					local14 = local9 + arg3;
					if (local14 >= 0) {
						...
						local23 = Static256.anInt4150;
						local25 = Static256.anInt4144;
						local27 = Static256.anInt4140;
						local29 = Static256.anInt4146;
						if (local25 >= 0 && local27 >= 0 && local25 - (super.anInt4155 << 12) < 0 && local27 - (super.anInt4159 << 12) < 0) {
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
							local64 = local53 + Static256.anInt4150 - local23;
							if (local64 > 0) {
								local23 += local64;
								local29 += local64;
								local25 += Static256.anInt4148 * local64;
								local27 += Static256.anInt4132 * local64;
							} else {
								local58 -= local64;
							}
							if (local29 < local58) {
							...
							while (local29 < 0) {
								local111 = this.aByteArray39[(local27 >> 12) * super.anInt4155 + (local25 >> 12)];
								if (local111 == 0) {
									local23++;
								} else {
									local3[local23++] = this.anIntArray329[local111 & 0xFF];
								}
								local29++;
							}
						}
					...
					local9++;
					Static256.anInt4150 += Static256.anInt4153;
				}
			} else if (Static256.anInt4132 < 0) {
				local9 = Static256.anInt4147;
				while (local9 < 0) {
					local14 = local9 + arg3;
					if (local14 >= 0) {
						...
						local23 = Static256.anInt4150;
						local25 = Static256.anInt4144;
						local27 = Static256.anInt4140 + Static256.anInt4135;
						local29 = Static256.anInt4146;
						if (local25 >= 0 && local25 - (super.anInt4155 << 12) < 0) {
							@Pc(179) int local179;
							if ((local179 = local27 - (super.anInt4159 << 12)) >= 0) {
								local186 = (Static256.anInt4132 - local179) / Static256.anInt4132;
								local29 += local186;
								local27 += Static256.anInt4132 * local186;
								local23 += local186;
							}
							@Pc(207) int local207;
							if ((local207 = (local27 - Static256.anInt4132) / Static256.anInt4132) > local29) {
								local29 = local207;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
							...
							while (local29 < 0) {
								...
								local27 += Static256.anInt4132;
								local29++;
							}
						}
					}
					local9++;
					Static256.anInt4144 += Static256.anInt4158;
					Static256.anInt4150 += Static256.anInt4153;
				}
			} else {
				local9 = Static256.anInt4147;
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt4155 << 12) < 0) {
							if (local27 < 0) {
								local186 = (Static256.anInt4132 - local27 - 1) / Static256.anInt4132;
								local29 += local186;
								local27 += Static256.anInt4132 * local186;
								local23 += local186;
							}
							@Pc(379) int local379;
							if ((local379 = (local27 + 1 - (super.anInt4159 << 12) - Static256.anInt4132) / Static256.anInt4132) > local29) {
								local29 = local379;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
			...
			if (Static256.anInt4132 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local23 = Static256.anInt4150;
						local25 = Static256.anInt4144 + Static256.anInt4145;
						local27 = Static256.anInt4140;
						local29 = Static256.anInt4146;
						if (local27 >= 0 && local27 - (super.anInt4159 << 12) < 0) {
							@Pc(525) int local525;
							if ((local525 = local25 - (super.anInt4155 << 12)) >= 0) {
								local186 = (Static256.anInt4148 - local525) / Static256.anInt4148;
								local29 += local186;
								local25 += Static256.anInt4148 * local186;
								local23 += local186;
							}
							@Pc(553) int local553;
							if ((local553 = (local25 - Static256.anInt4148) / Static256.anInt4148) > local29) {
								local29 = local553;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
							...
							while (local29 < 0) {
								...
								local25 += Static256.anInt4148;
								local29++;
							}
						}
					}
					local9++;
					Static256.anInt4140 += Static256.anInt4151;
					Static256.anInt4150 += Static256.anInt4153;
				}
			} else if (Static256.anInt4132 < 0) {
				local9 = Static256.anInt4147;
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static256.anInt4146;
						@Pc(690) int local690;
						if ((local690 = local25 - (super.anInt4155 << 12)) >= 0) {
							local186 = (Static256.anInt4148 - local690) / Static256.anInt4148;
							local29 += local186;
							local25 += Static256.anInt4148 * local186;
							local27 += Static256.anInt4132 * local186;
							local23 += local186;
						...
						@Pc(724) int local724;
						if ((local724 = (local25 - Static256.anInt4148) / Static256.anInt4148) > local29) {
							local29 = local724;
						}
						@Pc(736) int local736;
						if ((local736 = local27 - (super.anInt4159 << 12)) >= 0) {
							local186 = (Static256.anInt4132 - local736) / Static256.anInt4132;
							local29 += local186;
							local25 += Static256.anInt4148 * local186;
							local27 += Static256.anInt4132 * local186;
							local23 += local186;
						...
						@Pc(770) int local770;
						if ((local770 = (local27 - Static256.anInt4132) / Static256.anInt4132) > local29) {
							local29 = local770;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static256.anInt4146;
						@Pc(913) int local913;
						if ((local913 = local25 - (super.anInt4155 << 12)) >= 0) {
							local186 = (Static256.anInt4148 - local913) / Static256.anInt4148;
							local29 += local186;
							local25 += Static256.anInt4148 * local186;
							local27 += Static256.anInt4132 * local186;
							local23 += local186;
						...
						@Pc(947) int local947;
						if ((local947 = (local25 - Static256.anInt4148) / Static256.anInt4148) > local29) {
							local29 = local947;
						}
						if (local27 < 0) {
							local186 = (Static256.anInt4132 - local27 - 1) / Static256.anInt4132;
						...
						@Pc(995) int local995;
						if ((local995 = (local27 + 1 - (super.anInt4159 << 12) - Static256.anInt4132) / Static256.anInt4132) > local29) {
							local29 = local995;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if (local27 >= 0 && local27 - (super.anInt4159 << 12) < 0) {
						if (local25 < 0) {
							local186 = (Static256.anInt4148 - local25 - 1) / Static256.anInt4148;
							local29 += local186;
							local25 += Static256.anInt4148 * local186;
							local23 += local186;
						}
						@Pc(1177) int local1177;
						if ((local1177 = (local25 + 1 - (super.anInt4155 << 12) - Static256.anInt4148) / Static256.anInt4148) > local29) {
							local29 = local1177;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1354 = (local25 + 1 - (super.anInt4155 << 12) - Static256.anInt4148) / Static256.anInt4148) > local29) {
						local29 = local1354;
					}
					@Pc(1366) int local1366;
					if ((local1366 = local27 - (super.anInt4159 << 12)) >= 0) {
						local186 = (Static256.anInt4132 - local1366) / Static256.anInt4132;
						local29 += local186;
						local25 += Static256.anInt4148 * local186;
						local27 += Static256.anInt4132 * local186;
						local23 += local186;
					...
					if ((local1400 = (local27 - Static256.anInt4132) / Static256.anInt4132) > local29) {
						local29 = local1400;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1579 = (local25 + 1 - (super.anInt4155 << 12) - Static256.anInt4148) / Static256.anInt4148) > local29) {
						local29 = local1579;
					}
					if (local27 < 0) {
						local186 = (Static256.anInt4132 - local27 - 1) / Static256.anInt4132;
					...
					if ((local1627 = (local27 + 1 - (super.anInt4159 << 12) - Static256.anInt4132) / Static256.anInt4132) > local29) {
						local29 = local1627;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
	...
	public void V(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		@Pc(11) int local11 = super.aClass43_Sub2_7.anInt2139;
		arg0 += super.anInt4157;
		arg1 += super.anInt4161;
		@Pc(27) int local27 = arg1 * local11 + arg0;
		@Pc(29) int local29 = 0;
		@Pc(32) int local32 = super.anInt4159;
		@Pc(35) int local35 = super.anInt4155;
		...
		if (arg1 + local32 > super.aClass43_Sub2_7.anInt2131) {
			local32 -= arg1 + local32 - super.aClass43_Sub2_7.anInt2131;
		}
		if (arg0 < super.aClass43_Sub2_7.anInt2132) {
			local52 = super.aClass43_Sub2_7.anInt2132 - arg0;
			local35 -= local52;
		...
		if (arg0 + local35 > super.aClass43_Sub2_7.anInt2145) {
			local52 = arg0 + local35 - super.aClass43_Sub2_7.anInt2145;
			local35 -= local52;
			local41 += local52;
			local39 += local52;
		}
		...
		@Pc(160) int[] local160 = super.aClass43_Sub2_7.anIntArray137;
		@Pc(168) int local168;
		@Pc(175) int local175;
		@Pc(284) int local284;
		@Pc(287) int local287;
		...
		if (arg4 != 0) {
			...
			if (arg4 == 1) {
				if (arg2 == 1) {
					for (local168 = -local32; local168 < 0; local168++) {
						for (local175 = -local35; local175 < 0; local175++) {
							...
							if (local543 == 0) {
								...
								local287 = this.anIntArray329[local543 & 0xFF] | 0xFF000000;
					...
					if (arg2 == 0) {
							...
							for (local284 = -local32; local284 < 0; local284++) {
								for (local287 = -local35; local287 < 0; local287++) {
									...
									if (local645 == 0) {
										...
										local303 = this.anIntArray329[local645 & 0xFF];
										local311 = local160[local27];
							...
							for (local303 = -local32; local303 < 0; local303++) {
								for (local311 = -local35; local311 < 0; local311++) {
									...
									if (local746 == 0) {
										...
										local327 = this.anIntArray329[local746 & 0xFF];
										if (local287 == 255) {
						...
						for (local284 = -local32; local284 < 0; local284++) {
							for (local287 = -local35; local287 < 0; local287++) {
								local645 = this.aByteArray39[local29++];
								local303 = local645 > 0 ? this.anIntArray329[local645] : 0;
						...
						for (local291 = -local32; local291 < 0; local291++) {
							for (local303 = -local35; local303 < 0; local303++) {
								...
								if (local1054 == 0) {
									...
									local319 = this.anIntArray329[local1054 & 0xFF];
				...
				for (local168 = -local32; local168 < 0; local168++) {
					for (local175 = -local35; local175 < 0; local175++) {
						...
						if (local543 == 0) {
							...
							local287 = this.anIntArray329[local543 & 0xFF];
				...
				for (local287 = -local32; local287 < 0; local287++) {
					for (local291 = -local35; local291 < 0; local291++) {
						...
						if (local1228 == 0) {
							...
							local311 = this.anIntArray329[local1228 & 0xFF];
				...
				for (local168 = -local32; local168 < 0; local168++) {
					for (local175 = -local35; local175 < 0; local175++) {
						local543 = this.aByteArray39[local29++];
						local287 = local543 > 0 ? this.anIntArray329[local543] : 0;
			...
			for (local168 = -local32; local168 < 0; local168++) {
				...
				while (local27 < local175) {
					local160[local27++] = this.anIntArray329[this.aByteArray39[local29++] & 0xFF];
					local160[local27++] = this.anIntArray329[this.aByteArray39[local29++] & 0xFF];
					local160[local27++] = this.anIntArray329[this.aByteArray39[local29++] & 0xFF];
					local160[local27++] = this.anIntArray329[this.aByteArray39[local29++] & 0xFF];
				}
			...
			for (local287 = -local32; local287 < 0; local287++) {
				for (local291 = -local35; local291 < 0; local291++) {
					local303 = this.anIntArray329[this.aByteArray39[local29++] & 0xFF];
			...
			for (local168 = -local32; local168 < 0; local168++) {
				for (local175 = -local35; local175 < 0; local175++) {
					local284 = this.anIntArray329[this.aByteArray39[local29++] & 0xFF];
			...
			for (local291 = -local32; local291 < 0; local291++) {
				for (local303 = -local35; local303 < 0; local303++) {
					local311 = this.anIntArray329[this.aByteArray39[local29++] & 0xFF];
	...
	@Override
	public void method3687(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg3 <= 0 || arg4 <= 0) {
			return;
		}
		...
		@Pc(10) int local10 = 0;
		@Pc(12) int local12 = 0;
		@Pc(21) int local21 = super.anInt4157 + super.anInt4155 + super.anInt4139;
		@Pc(30) int local30 = super.anInt4161 + super.anInt4159 + super.anInt4142;
		@Pc(36) int local36 = (local21 << 16) / arg3;
		@Pc(42) int local42 = (local30 << 16) / arg4;
		@Pc(56) int local56;
		if (super.anInt4157 > 0) {
			local56 = ((super.anInt4157 << 16) + local36 - 1) / local36;
			arg0 += local56;
			local10 = local56 * local36 - (super.anInt4157 << 16);
		}
		if (super.anInt4161 > 0) {
			local56 = ((super.anInt4161 << 16) + local42 - 1) / local42;
			arg1 += local56;
			local12 = local56 * local42 - (super.anInt4161 << 16);
		}
		if (super.anInt4155 < local21) {
			arg3 = ((super.anInt4155 << 16) + local36 - local10 - 1) / local36;
		}
		if (super.anInt4159 < local30) {
			arg4 = ((super.anInt4159 << 16) + local42 - local12 - 1) / local42;
		}
		local56 = arg0 + arg1 * super.aClass43_Sub2_7.anInt2139;
		@Pc(148) int local148 = super.aClass43_Sub2_7.anInt2139 - arg3;
		if (arg1 + arg4 > super.aClass43_Sub2_7.anInt2131) {
			arg4 -= arg1 + arg4 - super.aClass43_Sub2_7.anInt2131;
		}
		@Pc(176) int local176;
		if (arg1 < super.aClass43_Sub2_7.anInt2133) {
			local176 = super.aClass43_Sub2_7.anInt2133 - arg1;
			arg4 -= local176;
			local56 += local176 * super.aClass43_Sub2_7.anInt2139;
			local12 += local42 * local176;
		}
		if (arg0 + arg3 > super.aClass43_Sub2_7.anInt2145) {
			local176 = arg0 + arg3 - super.aClass43_Sub2_7.anInt2145;
			arg3 -= local176;
			local148 += local176;
		}
		if (arg0 < super.aClass43_Sub2_7.anInt2132) {
			local176 = super.aClass43_Sub2_7.anInt2132 - arg0;
			arg3 -= local176;
			local56 += local176;
			local10 += local36 * local176;
			local148 += local176;
		}
		@Pc(250) int[] local250 = super.aClass43_Sub2_7.anIntArray138;
		@Pc(254) int[] local254 = super.aClass43_Sub2_7.anIntArray137;
		@Pc(261) int local261;
		@Pc(264) int local264;
		@Pc(272) int local272;
		@Pc(275) int local275;
		...
		if (arg7 != 0) {
			...
			if (arg7 == 1) {
				if (arg5 == 1) {
					...
					for (local264 = -arg4; local264 < 0; local264++) {
						local272 = (local12 >> 16) * super.anInt4155;
						for (local275 = -arg3; local275 < 0; local275++) {
							if (local8 < local250[local56]) {
								local463 = this.aByteArray39[(local10 >> 16) + local272];
								if (local463 != 0) {
									local254[local56] = this.anIntArray329[local463 & 0xFF];
								}
							}
							local10 += local36;
							local56++;
					...
					if (arg5 == 0) {
						...
						if ((arg6 & 0xFFFFFF) == 16777215) {
							...
							for (local275 = -arg4; local275 < 0; local275++) {
								local342 = (local12 >> 16) * super.anInt4155;
								for (local350 = -arg3; local350 < 0; local350++) {
									if (local8 < local250[local56]) {
										local765 = this.aByteArray39[(local10 >> 16) + local342];
										if (local765 != 0) {
											local373 = this.anIntArray329[local765 & 0xFF];
							...
							for (local353 = -arg4; local353 < 0; local353++) {
								local373 = (local12 >> 16) * super.anInt4155;
								for (local381 = -arg3; local381 < 0; local381++) {
									if (local8 < local250[local56]) {
										@Pc(885) byte local885 = this.aByteArray39[(local10 >> 16) + local373];
										if (local885 != 0) {
											local397 = this.anIntArray329[local885 & 0xFF];
											if (local342 == 255) {
						...
						for (local275 = -arg4; local275 < 0; local275++) {
							...
							for (local350 = -arg3; local350 < 0; local350++) {
								if (local8 < local250[local56]) {
									local765 = this.aByteArray39[(local10 >> 16) + local342];
									local373 = local765 > 0 ? this.anIntArray329[local765] : 0;
						...
						for (local350 = -arg4; local350 < 0; local350++) {
							local353 = (local12 >> 16) * super.anInt4155;
							for (local373 = -arg3; local373 < 0; local373++) {
								if (local8 < local250[local56]) {
									local1236 = this.aByteArray39[(local10 >> 16) + local353];
									if (local1236 != 0) {
										local389 = this.anIntArray329[local1236 & 0xFF];
				...
				for (local264 = -arg4; local264 < 0; local264++) {
					...
					for (local275 = -arg3; local275 < 0; local275++) {
						if (local8 < local250[local56]) {
							local463 = this.aByteArray39[(local10 >> 16) + local272];
							if (local463 != 0) {
								local350 = this.anIntArray329[local463 & 0xFF];
				...
				for (local342 = -arg4; local342 < 0; local342++) {
					local350 = (local12 >> 16) * super.anInt4155;
					for (local353 = -arg3; local353 < 0; local353++) {
						if (local8 < local250[local56]) {
							@Pc(1452) byte local1452 = this.aByteArray39[(local10 >> 16) + local350];
							if (local1452 != 0) {
								local381 = this.anIntArray329[local1452 & 0xFF];
				...
				for (local264 = -arg4; local264 < 0; local264++) {
					...
					for (local275 = -arg3; local275 < 0; local275++) {
						if (local8 < local250[local56]) {
							local463 = this.aByteArray39[(local10 >> 16) + local272];
							local350 = local463 > 0 ? this.anIntArray329[local463] : 0;
			...
			for (local264 = -arg4; local264 < 0; local264++) {
				...
				for (local275 = -arg3; local275 < 0; local275++) {
					if (local8 < local250[local56]) {
						local254[local56] = this.anIntArray329[this.aByteArray39[(local10 >> 16) + local272] & 0xFF];
					}
					local10 += local36;
					local56++;
				}
			...
			for (local342 = -arg4; local342 < 0; local342++) {
				...
				for (local353 = -arg3; local353 < 0; local353++) {
					if (local8 < local250[local56]) {
						local373 = this.anIntArray329[this.aByteArray39[(local10 >> 16) + local350] & 0xFF];
			...
			for (local350 = -arg4; local350 < 0; local350++) {
				...
				for (local373 = -arg3; local373 < 0; local373++) {
					if (local8 < local250[local56]) {
						local381 = this.anIntArray329[this.aByteArray39[(local10 >> 16) + local353] & 0xFF];
	...
	@Override
	protected void method3684(@OriginalArg(0) int arg0) {
		@Pc(3) int[] local3 = super.aClass43_Sub2_7.anIntArray137;
		@Pc(935) int local935;
		@Pc(9) int local9;
		@Pc(12) int local12;
		...
		if (Static256.anInt4148 == 0) {
			if (Static256.anInt4132 == 0) {
				local9 = Static256.anInt4147;
				while (local9 < 0) {
					local12 = Static256.anInt4150;
					local14 = Static256.anInt4144;
					local16 = Static256.anInt4140;
					local18 = Static256.anInt4146;
					if (local14 >= 0 && local16 >= 0 && local14 - (super.anInt4155 << 12) < 0 && local16 - (super.anInt4159 << 12) < 0) {
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt4155 + (local14 >> 12);
							local51 = local12++;
							if (arg0 == 1) {
								local227 = this.aByteArray39[local48];
								if (local227 != 0) {
									local3[local51] = this.anIntArray329[local227 & 0xFF];
								}
							} else if (arg0 == 0) {
								local227 = this.aByteArray39[local48];
								if (local227 != 0) {
									local255 = this.anIntArray329[local227 & 0xFF];
									if ((Static256.anInt4133 & 0xFFFFFF) == 16777215) {
										local264 = Static256.anInt4133 >>> 24;
									...
									} else if (Static256.anInt4143 == 255) {
										local264 = (local255 & 0xFF0000) * Static256.anInt4136 & 0xFF000000;
										local268 = (local255 & 0xFF00) * Static256.anInt4149 & 0xFF0000;
										local272 = (local255 & 0xFF) * Static256.anInt4154 & 0xFF00;
										...
										local3[local51] = ((local255 & 0xFF00FF) * Static256.anInt4143 + (local344 & 0xFF00FF) * Static256.anInt4134 & 0xFF00FF00) + ((local255 & 0xFF00) * Static256.anInt4143 + (local344 & 0xFF00) * Static256.anInt4134 & 0xFF0000) >> 8;
									}
								}
							} else if (arg0 == 3) {
								local227 = this.aByteArray39[local48];
								local255 = local227 > 0 ? this.anIntArray329[local227] : 0;
								local264 = Static256.anInt4133;
								...
								if (local255 == 0 && Static256.anInt4143 != 255) {
									local255 = local344;
									local344 = local3[local51];
									local344 = ((local255 & 0xFF00FF) * Static256.anInt4143 + (local344 & 0xFF00FF) * Static256.anInt4134 & 0xFF00FF00) + ((local255 & 0xFF00) * Static256.anInt4143 + (local344 & 0xFF00) * Static256.anInt4134 & 0xFF0000) >> 8;
								}
								...
								if (local227 != 0) {
									local255 = this.anIntArray329[local227 & 0xFF];
									local264 = (local255 & 0xFF00FF) * Static256.anInt4143 & 0xFF00FF00;
									local268 = (local255 & 0xFF00) * Static256.anInt4143 & 0xFF0000;
									local3[local51++] = ((local264 | local268) >>> 8) + Static256.anInt4141;
								}
							} else {
								throw new IllegalArgumentException();
							}
				...
				while (local9 < 0) {
					local12 = Static256.anInt4150;
					local14 = Static256.anInt4144;
					local16 = Static256.anInt4140 + Static256.anInt4135;
					local18 = Static256.anInt4146;
					if (local14 >= 0 && local14 - (super.anInt4155 << 12) < 0) {
						@Pc(928) int local928;
						if ((local928 = local16 - (super.anInt4159 << 12)) >= 0) {
							local935 = (Static256.anInt4132 - local928) / Static256.anInt4132;
							local18 += local935;
							local16 += Static256.anInt4132 * local935;
							local12 += local935;
						}
						@Pc(956) int local956;
						if ((local956 = (local16 - Static256.anInt4132) / Static256.anInt4132) > local18) {
							local18 = local956;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt4155 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt4155 << 12) < 0) {
						if (local16 < 0) {
							local935 = (Static256.anInt4132 - local16 - 1) / Static256.anInt4132;
							local18 += local935;
							local16 += Static256.anInt4132 * local935;
							local12 += local935;
						}
						@Pc(1888) int local1888;
						if ((local1888 = (local16 + 1 - (super.anInt4159 << 12) - Static256.anInt4132) / Static256.anInt4132) > local18) {
							local18 = local1888;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt4155 + (local14 >> 12);
			...
			if (Static256.anInt4132 == 0) {
				...
				while (local9 < 0) {
					local12 = Static256.anInt4150;
					local14 = Static256.anInt4144 + Static256.anInt4145;
					local16 = Static256.anInt4140;
					local18 = Static256.anInt4146;
					if (local16 >= 0 && local16 - (super.anInt4159 << 12) < 0) {
						@Pc(2794) int local2794;
						if ((local2794 = local14 - (super.anInt4155 << 12)) >= 0) {
							local935 = (Static256.anInt4148 - local2794) / Static256.anInt4148;
							local18 += local935;
							local14 += Static256.anInt4148 * local935;
							local12 += local935;
						}
						@Pc(2822) int local2822;
						if ((local2822 = (local14 - Static256.anInt4148) / Static256.anInt4148) > local18) {
							local18 = local2822;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt4155 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local3719 = local14 - (super.anInt4155 << 12)) >= 0) {
						local935 = (Static256.anInt4148 - local3719) / Static256.anInt4148;
						local18 += local935;
						local14 += Static256.anInt4148 * local935;
						local16 += Static256.anInt4132 * local935;
						local12 += local935;
					...
					if ((local3753 = (local14 - Static256.anInt4148) / Static256.anInt4148) > local18) {
						local18 = local3753;
					}
					@Pc(3765) int local3765;
					if ((local3765 = local16 - (super.anInt4159 << 12)) >= 0) {
						local935 = (Static256.anInt4132 - local3765) / Static256.anInt4132;
						local18 += local935;
						local14 += Static256.anInt4148 * local935;
						local16 += Static256.anInt4132 * local935;
						local12 += local935;
					...
					if ((local3799 = (local16 - Static256.anInt4132) / Static256.anInt4132) > local18) {
						local18 = local3799;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt4155 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local4702 = local14 - (super.anInt4155 << 12)) >= 0) {
						local935 = (Static256.anInt4148 - local4702) / Static256.anInt4148;
						local18 += local935;
						local14 += Static256.anInt4148 * local935;
						local16 += Static256.anInt4132 * local935;
						local12 += local935;
					...
					if ((local4736 = (local14 - Static256.anInt4148) / Static256.anInt4148) > local18) {
						local18 = local4736;
					}
					if (local16 < 0) {
						local935 = (Static256.anInt4132 - local16 - 1) / Static256.anInt4132;
					...
					if ((local4784 = (local16 + 1 - (super.anInt4159 << 12) - Static256.anInt4132) / Static256.anInt4132) > local18) {
						local18 = local4784;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt4155 + (local14 >> 12);
			...
			while (local9 < 0) {
				...
				if (local16 >= 0 && local16 - (super.anInt4159 << 12) < 0) {
					if (local14 < 0) {
						local935 = (Static256.anInt4148 - local14 - 1) / Static256.anInt4148;
						local18 += local935;
						local14 += Static256.anInt4148 * local935;
						local12 += local935;
					}
					@Pc(5726) int local5726;
					if ((local5726 = (local14 + 1 - (super.anInt4155 << 12) - Static256.anInt4148) / Static256.anInt4148) > local18) {
						local18 = local5726;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt4155 + (local14 >> 12);
			...
			for (local9 = Static256.anInt4147; local9 < 0; local9++) {
				local12 = Static256.anInt4150;
				local14 = Static256.anInt4144 + Static256.anInt4145;
				local16 = Static256.anInt4140 + Static256.anInt4135;
				local18 = Static256.anInt4146;
				...
				if ((local6663 = (local14 + 1 - (super.anInt4155 << 12) - Static256.anInt4148) / Static256.anInt4148) > local18) {
					local18 = local6663;
				}
				@Pc(6675) int local6675;
				if ((local6675 = local16 - (super.anInt4159 << 12)) >= 0) {
					local935 = (Static256.anInt4132 - local6675) / Static256.anInt4132;
					local18 += local935;
					local14 += Static256.anInt4148 * local935;
					local16 += Static256.anInt4132 * local935;
					local12 += local935;
				...
				if ((local6709 = (local16 - Static256.anInt4132) / Static256.anInt4132) > local18) {
					local18 = local6709;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt4155 + (local14 >> 12);
			...
			for (local9 = Static256.anInt4147; local9 < 0; local9++) {
				...
				if ((local7648 = (local14 + 1 - (super.anInt4155 << 12) - Static256.anInt4148) / Static256.anInt4148) > local18) {
					local18 = local7648;
				}
				if (local16 < 0) {
					local935 = (Static256.anInt4132 - local16 - 1) / Static256.anInt4132;
				...
				if ((local7696 = (local16 + 1 - (super.anInt4159 << 12) - Static256.anInt4132) / Static256.anInt4132) > local18) {
					local18 = local7696;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt4155 + (local14 >> 12);
