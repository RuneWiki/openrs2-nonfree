...
public final class Class2_Sub33 extends Class2 {
	...
	public Class2_Sub33(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) boolean arg3) {
		this.anInt5569 = arg0;
		this.anInt5570 = arg1;
		this.anIntArray473 = arg2;
		if (arg3) {
			@Pc(16) int[] local16 = new int[this.anInt5570];
			@Pc(20) int[] local20 = new int[this.anInt5570];
			@Pc(24) int[] local24 = new int[this.anInt5570];
			if (Static298.anIntArray472 == null || Static298.anIntArray472.length < this.anIntArray473.length) {
				Static298.anIntArray472 = new int[this.anIntArray473.length];
			}
			@Pc(40) int local40 = this.anInt5570;
			@Pc(43) int local43 = this.anInt5570;
			...
			for (@Pc(61) int local61 = 2; local61 >= 0; local61--) {
				for (local64 = local47; local64 >= 0; local64--) {
					local58--;
					@Pc(71) int local71 = this.anIntArray473[local58];
			...
			for (@Pc(116) int local116 = local51; local116 >= 0; local116--) {
				...
				for (local64 = local47; local64 >= 0; local64--) {
					...
					local114--;
					Static298.anIntArray472[local114] = local165 << 16 | local169 << 8 | local173;
				...
				for (local64 = local47; local64 >= 0; local64--) {
					local58--;
					@Pc(236) int local236 = this.anIntArray473[local58];
					local59--;
					@Pc(242) int local242 = this.anIntArray473[local59];
			...
			@Pc(306) int[] local306 = this.anIntArray473;
			this.anIntArray473 = Static298.anIntArray472;
			Static298.anIntArray472 = local306;
		}
	}
	...
	public void method4893(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(21) int local21 = this.anIntArray473.length;
		@Pc(28) int local28 = this.anInt5570 - 1;
		@Pc(33) int local33 = this.anInt5570 * arg1;
		@Pc(37) int local37 = local21 - 1;
		for (@Pc(39) int local39 = 0; local39 < local21; local39 += this.anInt5570) {
			@Pc(46) int local46 = local39 + local33 & local37;
			for (@Pc(48) int local48 = 0; local48 < this.anInt5570; local48++) {
				@Pc(53) int local53 = local39 + local48;
				@Pc(61) int local61 = local46 + (local48 + arg0 & local28);
				Static298.anIntArray472[local53] = this.anIntArray473[local61];
			}
		}
		@Pc(84) int[] local84 = this.anIntArray473;
		this.anIntArray473 = Static298.anIntArray472;
		Static298.anIntArray472 = local84;
	}
