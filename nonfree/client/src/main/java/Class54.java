...
public final class Class54 {
	...
	private void method1698(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class3_Sub12 local4 = new Class3_Sub12(arg0);
		this.anInt2628 = local4.method1920();
		this.anInt2629 = local4.method1920();
		this.anInt2630 = local4.method1920();
		this.anInt2633 = local4.method1920();
		if (this.anInt2633 < 0) {
			this.anInt2633 = ~this.anInt2633;
			this.aBoolean95 = true;
		}
		@Pc(40) int local40 = local4.method1920();
		this.aByteArrayArray15 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method1936();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method1941(local64, local49);
			this.aByteArrayArray15[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!pd", name = "c", descriptor = "()Lclient!fc;")
	public Class3_Sub9_Sub1 method1702() {
		Static90.anInt2626 = 0;
		@Pc(5) byte[] local5 = new byte[this.anInt2629];
		@Pc(7) int local7 = 0;
		for (@Pc(9) int local9 = 0; local9 < this.aByteArrayArray15.length; local9++) {
			@Pc(14) float[] local14 = this.method1704(local9);
			if (local14 != null) {
				@Pc(19) int local19 = local14.length;
				if (local19 > this.anInt2629 - local7) {
					local19 = this.anInt2629 - local7;
				}
		...
		return new Class3_Sub9_Sub1(this.anInt2628, local5, this.anInt2630, this.anInt2633, this.aBoolean95);
	}

	@OriginalMember(owner = "client!pd", name = "c", descriptor = "(I)[F")
	private float[] method1704(@OriginalArg(0) int arg0) {
		Static90.method1701(this.aByteArrayArray15[arg0]);
		Static90.method1695();
		@Pc(15) int local15 = Static90.method1697(Static98.method1859(Static90.anIntArray282.length - 1));
		@Pc(19) boolean local19 = Static90.aBooleanArray57[local15];
		@Pc(25) int local25 = local19 ? Static90.anInt2632 : Static90.anInt2627;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static90.method1695() != 0;
			local29 = Static90.method1695() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static90.anInt2627 >> 2);
			local67 = (local25 >> 2) + (Static90.anInt2627 >> 2);
			local71 = Static90.anInt2627 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static90.anInt2627 >> 2);
			local104 = local25 + (Static90.anInt2627 >> 2) - (local25 >> 2);
			local108 = Static90.anInt2627 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class9 local123 = Static90.aClass9Array1[Static90.anIntArray282[local15]];
		@Pc(126) int local126 = local123.anInt249;
		@Pc(131) int local131 = local123.anIntArray31[local126];
		@Pc(140) boolean local140 = !Static90.aClass27Array1[local131].method979();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt248; local144++) {
			@Pc(152) Class78 local152 = Static90.aClass78Array1[local123.anIntArray32[local144]];
			local154 = Static90.aFloatArray4;
			local152.method2252(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt249;
			local176 = local123.anIntArray31[local171];
			Static90.aClass27Array1[local176].method983(Static90.aFloatArray4, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static90.aFloatArray4[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static90.aFloatArray4;
			...
			@Pc(252) float[] local252 = local19 ? Static90.aFloatArray7 : Static90.aFloatArray8;
			@Pc(258) float[] local258 = local19 ? Static90.aFloatArray5 : Static90.aFloatArray2;
			@Pc(264) float[] local264 = local19 ? Static90.aFloatArray6 : Static90.aFloatArray3;
			@Pc(270) int[] local270 = local19 ? Static90.anIntArray280 : Static90.anIntArray281;
			...
			@Pc(486) int local486 = Static98.method1859(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static90.aFloatArray4[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static90.aFloatArray4[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (Static90.anInt2626 > 0) {
			local176 = Static90.anInt2626 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1250) int local1250;
			if (!Static90.aBoolean96) {
				for (local212 = 0; local212 < Static90.anInt2625; local212++) {
					local1250 = (Static90.anInt2626 >> 1) + local212;
					local1228[local212] += Static90.aFloatArray9[local1250];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1250 = local1228.length + local212 - (local25 >> 1);
					local1228[local1250] += Static90.aFloatArray4[local212];
				}
			}
		}
		local154 = Static90.aFloatArray9;
		Static90.aFloatArray9 = Static90.aFloatArray4;
		Static90.aFloatArray4 = local154;
		Static90.anInt2626 = local25;
		Static90.anInt2625 = local104 - (local25 >> 1);
		Static90.aBoolean96 = local140;
		return local1228;
	}
}
