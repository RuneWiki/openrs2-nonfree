...
public final class Class355 {
	...
	private final boolean aBoolean835 = false;
	...
	public boolean aBoolean836 = true;
	...
	private final int[] anIntArray601;

	@OriginalMember(owner = "client!vga", name = "c", descriptor = "[F")
	private final float[] aFloatArray76;

	@OriginalMember(owner = "client!vga", name = "<init>", descriptor = "(Lclient!cg;Lclient!ev;)V")
	public Class355(@OriginalArg(0) Class33_Sub2 arg0, @OriginalArg(1) Class88 arg1) {
		this.aClass33_Sub2_12 = arg0;
		this.aClass88_3 = arg1;
		this.anInt9979 = this.aClass33_Sub2_12.anInt1343;
		this.anIntArray601 = this.aClass33_Sub2_12.anIntArray69;
		this.aFloatArray76 = this.aClass33_Sub2_12.aFloatArray13;
	}

	@OriginalMember(owner = "client!vga", name = "a", descriptor = "([I[FIIIIIFF)V")
	private void method8193(@OriginalArg(0) int[] arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) float arg6, @OriginalArg(8) float arg7) {
		if (this.aBoolean834) {
			if (arg5 > this.anInt9981) {
				arg5 = this.anInt9981;
			}
			if (arg4 < 0) {
				arg4 = 0;
		...
		@Pc(303) int local303;
		@Pc(63) float local63;
		if (this.aClass88_3.aBoolean292) {
			if (this.anInt9982 == 0) {
				while (true) {
					local29--;
					if (local29 < 0) {
			...
			} else if (this.anInt9982 != 254) {
				local278 = this.anInt9982;
				local283 = 256 - this.anInt9982;
			...
			} else if (arg4 != 0 && arg5 <= this.anInt9981 - 1) {
				while (true) {
					local29--;
					if (local29 < 0) {
						local29 = arg5 - arg4 & 0x3;
		...
		if (this.aBoolean835) {
			...
			if (this.aBoolean836) {
				...
				if (this.anInt9982 == 0) {
					...
					local163 = this.anInt9982;
					local168 = 256 - this.anInt9982;
					if (local54 > 0) {
						do {
							local88 = (int) arg7 & 0xFF0000 | 0xFF000000 | (int) arg9 & 0xFF00 | (int) arg11 & 0xFF;
							arg7 += local58;
	...
	private void method8196(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) float arg9, @OriginalArg(10) float arg10, @OriginalArg(11) float arg11, @OriginalArg(12) float arg12, @OriginalArg(13) float arg13, @OriginalArg(14) float arg14, @OriginalArg(15) float arg15, @OriginalArg(16) float arg16, @OriginalArg(17) float arg17, @OriginalArg(18) float arg18, @OriginalArg(19) float arg19, @OriginalArg(20) float arg20, @OriginalArg(21) float arg21, @OriginalArg(22) float arg22, @OriginalArg(23) float arg23, @OriginalArg(24) float arg24) {
		...
		while (local3-- > 0) {
			...
			if (local156 < this.aFloatArray76[local151]) {
				@Pc(167) float local167 = arg7 * local156;
				@Pc(171) float local171 = arg9 * local156;
				@Pc(184) int local184 = (int) (local167 * (float) this.anInt9990 * this.aFloat272) & this.anInt9989;
				@Pc(197) int local197 = (int) (local171 * (float) this.anInt9990 * this.aFloat272) & this.anInt9989;
				@Pc(207) int local207 = this.anIntArray604[local197 * this.anInt9990 + local184];
				@Pc(220) int local220 = (int) (local167 * (float) this.anInt9983 * this.aFloat274) & this.anInt9988;
				@Pc(233) int local233 = (int) (local171 * (float) this.anInt9983 * this.aFloat274) & this.anInt9988;
				@Pc(243) int local243 = this.anIntArray603[local233 * this.anInt9983 + local220];
				@Pc(256) int local256 = (int) (local167 * (float) this.anInt9984 * this.aFloat273) & this.anInt9987;
				@Pc(269) int local269 = (int) (local171 * (float) this.anInt9984 * this.aFloat273) & this.anInt9987;
				@Pc(279) int local279 = this.anIntArray605[local269 * this.anInt9984 + local256];
				...
				if (arg11 != 0.0F) {
					...
					@Pc(462) int local462 = ((this.anInt9991 & 0xFF00FF) * (int) arg11 & 0xFF00FF00 | (this.anInt9991 & 0xFF00) * (int) arg11 & 0xFF0000) >>> 8;
					local431 = (((local431 & 0xFF00FF) * local440 & 0xFF00FF00 | (local431 & 0xFF00) * local440 & 0xFF0000) >>> 8) + local462;
				}
				arg0[local151] = local431;
				this.aFloatArray76[local151] = local156;
			}
			local151++;
			arg5 += local14;
			arg7 += local20;
	...
	public void method8197(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11) {
		if (this.aBoolean837) {
			this.aClass33_Sub2_12.method6236((int) arg1, (int) arg4, (int) arg0, arg9 | 0xFF000000, (int) arg3);
			this.aClass33_Sub2_12.method6236((int) arg2, (int) arg5, (int) arg1, arg9 | 0xFF000000, (int) arg4);
			this.aClass33_Sub2_12.method6236((int) arg0, (int) arg3, (int) arg2, arg9 | 0xFF000000, (int) arg5);
			return;
		}
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (!(arg0 >= (float) this.anInt9977)) {
				if (arg1 > (float) this.anInt9977) {
					arg1 = this.anInt9977;
				}
				if (arg2 > (float) this.anInt9977) {
					arg2 = this.anInt9977;
				}
				...
				if (arg1 < arg2) {
					...
					if ((arg0 == arg1 || !(local160 < local149)) && (arg0 != arg1 || !(local160 > local138))) {
						arg2 -= arg1;
						arg1 -= arg0;
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method8194(this.anIntArray601, this.aFloatArray76, (int) arg0, (int) arg3, (int) arg5, arg6, local186, local310, local206, local321, local226, local332, local246);
							arg5 += local160;
							arg3 += local149;
							arg6 += local196;
							local310 += local216;
						...
						while (--arg2 >= 0.0F) {
							this.method8194(this.anIntArray601, this.aFloatArray76, (int) arg0, (int) arg4, (int) arg5, arg6, local186, local310, local206, local321, local226, local332, local246);
							arg5 += local160;
							arg4 += local138;
							arg6 += local196;
							local310 += local216;
						...
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method8194(this.anIntArray601, this.aFloatArray76, (int) arg0, (int) arg5, (int) arg3, arg6, local186, local310, local206, local321, local226, local332, local246);
							arg5 += local160;
							arg3 += local149;
							arg6 += local196;
							local310 += local216;
						...
						while (--arg2 >= 0.0F) {
							this.method8194(this.anIntArray601, this.aFloatArray76, (int) arg0, (int) arg5, (int) arg4, arg6, local186, local310, local206, local321, local226, local332, local246);
							arg5 += local160;
							arg4 += local138;
							arg6 += local196;
							local310 += local216;
					...
					if (arg0 != arg2 && local160 < local149 || arg0 == arg2 && local138 > local149) {
						...
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method8194(this.anIntArray601, this.aFloatArray76, (int) arg0, (int) arg4, (int) arg3, arg6, local186, local310, local206, local321, local226, local332, local246);
							arg4 += local160;
							arg3 += local149;
							arg6 += local196;
							local310 += local216;
						...
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method8194(this.anIntArray601, this.aFloatArray76, (int) arg0, (int) arg3, (int) arg4, arg6, local186, local310, local206, local321, local226, local332, local246);
							arg4 += local160;
							arg3 += local149;
							arg6 += local196;
							local310 += local216;
			...
			if (!(arg1 >= (float) this.anInt9977)) {
				...
				if (arg2 < arg0) {
					...
					if ((arg1 == arg2 || !(local149 < local138)) && (arg1 != arg2 || !(local149 > local160))) {
						arg0 -= arg2;
						arg2 -= arg1;
						arg1 = this.anIntArray602[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method8194(this.anIntArray601, this.aFloatArray76, (int) arg1, (int) arg4, (int) arg3, arg7, local186, local310, local206, local321, local226, local332, local246);
							arg3 += local149;
							arg4 += local138;
							arg7 += local196;
							local310 += local216;
						...
						while (--arg0 >= 0.0F) {
							this.method8194(this.anIntArray601, this.aFloatArray76, (int) arg1, (int) arg5, (int) arg3, arg7, local186, local310, local206, local321, local226, local332, local246);
							arg3 += local149;
							arg5 += local160;
							arg7 += local196;
							local310 += local216;
						...
						arg1 = this.anIntArray602[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method8194(this.anIntArray601, this.aFloatArray76, (int) arg1, (int) arg3, (int) arg4, arg7, local186, local310, local206, local321, local226, local332, local246);
							arg3 += local149;
							arg4 += local138;
							arg7 += local196;
							local310 += local216;
						...
						while (--arg0 >= 0.0F) {
							this.method8194(this.anIntArray601, this.aFloatArray76, (int) arg1, (int) arg3, (int) arg5, arg7, local186, local310, local206, local321, local226, local332, local246);
							arg3 += local149;
							arg5 += local160;
							arg7 += local196;
							local310 += local216;
					...
					if (local149 < local138) {
						...
						arg1 = this.anIntArray602[(int) arg1];
						while (--arg0 >= 0.0F) {
							this.method8194(this.anIntArray601, this.aFloatArray76, (int) arg1, (int) arg5, (int) arg4, arg7, local186, local310, local206, local321, local226, local332, local246);
							arg5 += local149;
							arg4 += local138;
							arg7 += local196;
							local310 += local216;
						...
						arg1 = this.anIntArray602[(int) arg1];
						while (--arg0 >= 0.0F) {
							this.method8194(this.anIntArray601, this.aFloatArray76, (int) arg1, (int) arg4, (int) arg5, arg7, local186, local310, local206, local321, local226, local332, local246);
							arg5 += local149;
							arg4 += local138;
							arg7 += local196;
							local310 += local216;
		...
		} else if (!(arg2 >= (float) this.anInt9977)) {
			if (arg0 > (float) this.anInt9977) {
				arg0 = this.anInt9977;
			}
			if (arg1 > (float) this.anInt9977) {
			...
			if (arg0 < arg1) {
				...
				if (local138 < local160) {
					arg1 -= arg0;
					arg0 -= arg2;
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method8194(this.anIntArray601, this.aFloatArray76, (int) arg2, (int) arg4, (int) arg5, arg8, local186, local310, local206, local321, local226, local332, local246);
						arg4 += local138;
						arg5 += local160;
						arg8 += local196;
						local310 += local216;
					...
					while (--arg1 >= 0.0F) {
						this.method8194(this.anIntArray601, this.aFloatArray76, (int) arg2, (int) arg4, (int) arg3, arg8, local186, local310, local206, local321, local226, local332, local246);
						arg4 += local138;
						arg3 += local149;
						arg8 += local196;
						local310 += local216;
					...
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method8194(this.anIntArray601, this.aFloatArray76, (int) arg2, (int) arg5, (int) arg4, arg8, local186, local310, local206, local321, local226, local332, local246);
						arg4 += local138;
						arg5 += local160;
						arg8 += local196;
						local310 += local216;
					...
					while (--arg1 >= 0.0F) {
						this.method8194(this.anIntArray601, this.aFloatArray76, (int) arg2, (int) arg3, (int) arg4, arg8, local186, local310, local206, local321, local226, local332, local246);
						arg4 += local138;
						arg3 += local149;
						arg8 += local196;
						local310 += local216;
				...
				if (local138 < local160) {
					...
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method8194(this.anIntArray601, this.aFloatArray76, (int) arg2, (int) arg3, (int) arg5, arg8, local186, local310, local206, local321, local226, local332, local246);
						arg3 += local138;
						arg5 += local160;
						arg8 += local196;
						local310 += local216;
					...
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method8194(this.anIntArray601, this.aFloatArray76, (int) arg2, (int) arg5, (int) arg3, arg8, local186, local310, local206, local321, local226, local332, local246);
						arg3 += local138;
						arg5 += local160;
						arg8 += local196;
						local310 += local216;
	...
	private void method8198(@OriginalArg(0) int[] arg0, @OriginalArg(1) float[] arg1, @OriginalArg(2) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) float arg5, @OriginalArg(8) float arg6, @OriginalArg(9) float arg7, @OriginalArg(10) float arg8) {
		if (this.aBoolean834) {
			if (arg4 > this.anInt9981) {
				arg4 = this.anInt9981;
			}
		...
		if (this.aClass88_3.aBoolean292) {
			if (this.aBoolean836) {
				...
				if (this.anInt9982 == 0) {
					if (local50 > 0) {
						do {
							local64 = Static474.anIntArray530[(int) arg5];
							arg5 += local54;
							local71 = arg2 + 1;
					...
					local186 = this.anInt9982;
					local191 = 256 - this.anInt9982;
					if (local50 > 0) {
						do {
							local64 = Static474.anIntArray530[(int) arg5];
							arg5 += local54;
				...
				if (this.anInt9982 == 0) {
					do {
						arg2++;
						if (arg7 < arg1[arg2]) {
							arg0[arg2] = Static474.anIntArray530[(int) arg5];
							arg1[arg2] = arg7;
						}
						arg7 += arg8;
						arg5 += arg6;
	...
	public void method8200(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) float arg9, @OriginalArg(10) float arg10, @OriginalArg(11) float arg11, @OriginalArg(12) float arg12, @OriginalArg(13) float arg13, @OriginalArg(14) float arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18, @OriginalArg(19) int arg19, @OriginalArg(20) int arg20, @OriginalArg(21) int arg21, @OriginalArg(22) int arg22, @OriginalArg(23) float arg23, @OriginalArg(24) int arg24, @OriginalArg(25) float arg25, @OriginalArg(26) int arg26, @OriginalArg(27) float arg27) {
		if (arg22 != this.anInt9992) {
			this.anIntArray604 = this.aClass33_Sub2_12.method1442(arg22);
			if (this.anIntArray604 == null) {
				this.method8197((float) arg0, (float) arg1, (float) arg2, (float) arg3, (float) arg4, (float) arg5, (float) arg6, (float) arg7, (float) arg8, Static187.method3362(arg15, arg18 | arg19 << 24), Static187.method3362(arg16, arg18 | arg20 << 24), Static187.method3362(arg17, arg18 | arg21 << 24));
				return;
			}
			this.anInt9990 = this.aClass33_Sub2_12.method1449(arg22) ? 64 : this.aClass33_Sub2_12.anInt1357;
			this.anInt9989 = this.anInt9990 - 1;
			this.anInt9986 = this.aClass33_Sub2_12.method1446(arg22);
		}
		this.aFloat272 = arg23;
		if (arg24 != this.anInt9985) {
			this.anIntArray603 = this.aClass33_Sub2_12.method1442(arg24);
			if (this.anIntArray603 == null) {
				this.method8197((float) arg0, (float) arg1, (float) arg2, (float) arg3, (float) arg4, (float) arg5, (float) arg6, (float) arg7, (float) arg8, Static187.method3362(arg15, arg18 | arg19 << 24), Static187.method3362(arg16, arg18 | arg20 << 24), Static187.method3362(arg17, arg18 | arg21 << 24));
				return;
			}
			this.anInt9983 = this.aClass33_Sub2_12.method1449(arg24) ? 64 : this.aClass33_Sub2_12.anInt1357;
			this.anInt9988 = this.anInt9983 - 1;
		}
		this.aFloat274 = arg25;
		if (arg26 != this.anInt9993) {
			this.anIntArray605 = this.aClass33_Sub2_12.method1442(arg26);
			if (this.anIntArray605 == null) {
				this.method8197((float) arg0, (float) arg1, (float) arg2, (float) arg3, (float) arg4, (float) arg5, (float) arg6, (float) arg7, (float) arg8, Static187.method3362(arg15, arg18 | arg19 << 24), Static187.method3362(arg16, arg18 | arg20 << 24), Static187.method3362(arg17, arg18 | arg21 << 24));
				return;
			}
			this.anInt9984 = this.aClass33_Sub2_12.method1449(arg26) ? 64 : this.aClass33_Sub2_12.anInt1357;
			this.anInt9987 = this.anInt9984 - 1;
		}
		this.aFloat273 = arg27;
		this.anInt9991 = arg18;
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (!(arg0 >= (float) this.anInt9977)) {
				...
				if (arg1 < arg2) {
					...
					if (arg0 != arg1 && local525 < local400 || arg0 == arg1 && local525 > local428) {
						...
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method8196(this.anIntArray601, this.anIntArray604, (int) arg0, (int) arg5, (int) arg3, arg8, arg6, arg11, arg9, arg14, arg12, (float) arg21, (float) arg19, local293, local279, local314, local300, local335, local321, local350, local340, local392, local388, local398, local394);
							arg3 += local400;
							arg5 += local525;
							arg6 += local402;
							arg8 += local596;
						...
						while (--arg2 >= 0.0F) {
							this.method8196(this.anIntArray601, this.anIntArray604, (int) arg0, (int) arg5, (int) arg4, arg8, arg7, arg11, arg10, arg14, arg13, (float) arg21, (float) arg20, local293, local286, local314, local307, local335, local328, local350, local345, local392, local390, local398, local396);
							arg4 += local428;
							arg5 += local525;
							arg7 += local499;
							arg8 += local596;
						...
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method8196(this.anIntArray601, this.anIntArray604, (int) arg0, (int) arg3, (int) arg5, arg6, arg8, arg9, arg11, arg12, arg14, (float) arg19, (float) arg21, local279, local293, local300, local314, local321, local335, local340, local350, local388, local392, local394, local398);
							arg3 += local400;
							arg5 += local525;
							arg6 += local402;
							arg8 += local596;
						...
						while (--arg2 >= 0.0F) {
							this.method8196(this.anIntArray601, this.anIntArray604, (int) arg0, (int) arg4, (int) arg5, arg7, arg8, arg10, arg11, arg13, arg14, (float) arg20, (float) arg21, local286, local293, local307, local314, local328, local335, local345, local350, local390, local392, local396, local398);
							arg4 += local428;
							arg5 += local525;
							arg7 += local499;
							arg8 += local596;
					...
					if (arg0 != arg2 && local525 < local400 || arg0 == arg2 && local428 > local400) {
						...
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method8196(this.anIntArray601, this.anIntArray604, (int) arg0, (int) arg4, (int) arg3, arg7, arg6, arg10, arg9, arg13, arg12, (float) arg20, (float) arg19, local286, local279, local307, local300, local328, local321, local345, local340, local390, local388, local396, local394);
							arg3 += local400;
							arg4 += local525;
							arg6 += local402;
							arg7 += local596;
						...
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method8196(this.anIntArray601, this.anIntArray604, (int) arg0, (int) arg3, (int) arg4, arg6, arg7, arg9, arg10, arg12, arg13, (float) arg19, (float) arg20, local279, local286, local300, local307, local321, local328, local340, local345, local388, local390, local394, local396);
							arg4 += local525;
							arg3 += local400;
							arg7 += local596;
							arg6 += local402;
			...
			if (!(arg1 >= (float) this.anInt9977)) {
				...
				if (arg2 < arg0) {
					...
					if (arg1 != arg2 && local400 < local428 || arg1 == arg2 && local400 > local525) {
						...
						arg1 = this.anIntArray602[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method8196(this.anIntArray601, this.anIntArray604, (int) arg1, (int) arg3, (int) arg4, arg6, arg7, arg9, arg10, arg12, arg13, (float) arg19, (float) arg20, local279, local286, local300, local307, local321, local328, local340, local345, local388, local390, local394, local396);
							arg3 += local400;
							arg4 += local428;
							arg6 += local402;
							arg7 += local499;
						...
						while (--arg0 >= 0.0F) {
							this.method8196(this.anIntArray601, this.anIntArray604, (int) arg1, (int) arg3, (int) arg5, arg6, arg8, arg9, arg11, arg12, arg14, (float) arg19, (float) arg21, local279, local293, local300, local314, local321, local335, local340, local350, local388, local392, local394, local398);
							arg3 += local400;
							arg5 += local525;
							arg6 += local402;
							arg8 += local596;
						...
						arg1 = this.anIntArray602[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method8196(this.anIntArray601, this.anIntArray604, (int) arg1, (int) arg4, (int) arg3, arg7, arg6, arg10, arg9, arg13, arg12, (float) arg20, (float) arg19, local286, local279, local307, local300, local328, local321, local345, local340, local390, local388, local396, local394);
							arg4 += local428;
							arg3 += local400;
							arg7 += local499;
							arg6 += local402;
						...
						while (--arg0 >= 0.0F) {
							this.method8196(this.anIntArray601, this.anIntArray604, (int) arg1, (int) arg5, (int) arg3, arg8, arg6, arg11, arg9, arg14, arg12, (float) arg21, (float) arg19, local293, local279, local314, local300, local335, local321, local350, local340, local392, local388, local398, local394);
							arg5 += local525;
							arg3 += local400;
							arg8 += local596;
							arg6 += local402;
					...
					if (local400 < local428) {
						while (--arg0 >= 0.0F) {
							this.method8196(this.anIntArray601, this.anIntArray604, (int) arg1, (int) arg5, (int) arg4, arg8, arg7, arg11, arg10, arg14, arg13, (float) arg21, (float) arg20, local293, local286, local314, local307, local335, local328, local350, local345, local392, local390, local398, local396);
							arg5 += local400;
							arg4 += local428;
							arg8 += local402;
							arg7 += local499;
						...
						while (--arg0 >= 0.0F) {
							this.method8196(this.anIntArray601, this.anIntArray604, (int) arg1, (int) arg4, (int) arg5, arg7, arg8, arg10, arg11, arg13, arg14, (float) arg20, (float) arg21, local286, local293, local307, local314, local328, local335, local345, local350, local390, local392, local396, local398);
							arg4 += local428;
							arg5 += local400;
							arg7 += local499;
							arg8 += local402;
			...
			if (arg0 < arg1) {
				...
				if (local428 < local525) {
					...
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method8196(this.anIntArray601, this.anIntArray604, (int) arg2, (int) arg4, (int) arg5, arg7, arg8, arg10, arg11, arg13, arg14, (float) arg20, (float) arg21, local286, local293, local307, local314, local328, local335, local345, local350, local390, local392, local396, local398);
						arg4 += local428;
						arg5 += local525;
						arg7 += local499;
						arg8 += local596;
					...
					while (--arg1 >= 0.0F) {
						this.method8196(this.anIntArray601, this.anIntArray604, (int) arg2, (int) arg4, (int) arg3, arg7, arg6, arg10, arg9, arg13, arg12, (float) arg20, (float) arg19, local286, local279, local307, local300, local328, local321, local345, local340, local390, local388, local396, local394);
						arg4 += local428;
						arg3 += local400;
						arg7 += local499;
						arg6 += local402;
					...
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method8196(this.anIntArray601, this.anIntArray604, (int) arg2, (int) arg5, (int) arg4, arg8, arg7, arg11, arg10, arg14, arg13, (float) arg21, (float) arg20, local293, local286, local314, local307, local335, local328, local350, local345, local392, local390, local398, local396);
						arg5 += local525;
						arg4 += local428;
						arg8 += local596;
						arg7 += local499;
					...
					while (--arg1 >= 0.0F) {
						this.method8196(this.anIntArray601, this.anIntArray604, (int) arg2, (int) arg3, (int) arg4, arg6, arg7, arg9, arg10, arg12, arg13, (float) arg19, (float) arg20, local279, local286, local300, local307, local321, local328, local340, local345, local388, local390, local394, local396);
						arg3 += local400;
						arg4 += local428;
						arg6 += local402;
						arg7 += local499;
				...
				if (local428 < local525) {
					...
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method8196(this.anIntArray601, this.anIntArray604, (int) arg2, (int) arg3, (int) arg5, arg6, arg8, arg9, arg11, arg12, arg14, (float) arg19, (float) arg21, local279, local293, local300, local314, local321, local335, local340, local350, local388, local392, local394, local398);
						arg3 += local428;
						arg5 += local525;
						arg6 += local499;
						arg8 += local596;
					...
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method8196(this.anIntArray601, this.anIntArray604, (int) arg2, (int) arg5, (int) arg3, arg8, arg6, arg11, arg9, arg14, arg12, (float) arg21, (float) arg19, local293, local279, local314, local300, local335, local321, local350, local340, local392, local388, local398, local394);
						arg5 += local525;
						arg3 += local428;
						arg8 += local596;
						arg6 += local499;
	...
	private void method8201(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) float arg9, @OriginalArg(10) float arg10, @OriginalArg(11) float arg11, @OriginalArg(12) float arg12, @OriginalArg(13) float arg13, @OriginalArg(14) float arg14, @OriginalArg(15) float arg15, @OriginalArg(16) float arg16, @OriginalArg(17) float arg17, @OriginalArg(18) float arg18, @OriginalArg(19) float arg19, @OriginalArg(20) float arg20) {
		@Pc(3) int local3 = arg4 - arg3;
		@Pc(8) float local8 = 1.0F / (float) local3;
		@Pc(14) float local14 = (arg6 - arg5) * local8;
		@Pc(20) float local20 = (arg8 - arg7) * local8;
		...
		while (local3-- > 0) {
			...
			if (local143 < this.aFloatArray76[local138]) {
				@Pc(159) int local159 = (int) (arg7 * local143 * (float) this.anInt9990);
				if (this.aBoolean838) {
					local159 &= this.anInt9989;
				} else if (local159 < 0) {
					local159 = 0;
				} else if (local159 > this.anInt9989) {
					local159 = this.anInt9989;
				}
				@Pc(189) int local189 = (int) (arg9 * local143 * (float) this.anInt9990);
				if (this.aBoolean838) {
					local189 &= this.anInt9989;
				} else if (local189 < 0) {
					local189 = 0;
				} else if (local189 > this.anInt9989) {
					local189 = this.anInt9989;
				}
				@Pc(220) int local220 = this.anIntArray604[local189 * this.anInt9990 + local159];
				@Pc(232) int local232;
				if (this.anInt9986 == 2) {
					local232 = local220 >> 24 & 0xFF;
				} else if (this.anInt9986 == 1) {
				...
				if (local232 != 0) {
					...
					if (local232 == 255) {
						...
						if (arg11 != 0.0F) {
							...
							local321 = ((this.anInt9991 & 0xFF00FF) * (int) arg11 & 0xFF00FF00 | (this.anInt9991 & 0xFF00) * (int) arg11 & 0xFF0000) >>> 8;
							local290 = (((local290 & 0xFF00FF) * local299 & 0xFF00FF00 | (local290 & 0xFF00) * local299 & 0xFF0000) >>> 8) + local321;
						}
						arg0[local138] = local290;
						this.aFloatArray76[local138] = local143;
					} else {
						local290 = ((int) (arg15 * (float) (local220 >> 16 & 0xFF)) & 0xFF00 | 0xFF0000) << 8 | (int) (arg17 * (float) (local220 >> 8 & 0xFF)) & 0xFF00 | (int) (arg19 * (float) (local220 & 0xFF)) >> 8;
						if (arg11 != 0.0F) {
							local299 = (int) (255.0F - arg11);
	...
	public void method8202(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) int arg9) {
		if (this.aBoolean837) {
			this.aClass33_Sub2_12.method6236((int) arg1, (int) arg4, (int) arg0, arg9, (int) arg3);
			this.aClass33_Sub2_12.method6236((int) arg2, (int) arg5, (int) arg1, arg9, (int) arg4);
			this.aClass33_Sub2_12.method6236((int) arg0, (int) arg3, (int) arg2, arg9, (int) arg5);
			return;
		}
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (!(arg0 >= (float) this.anInt9977)) {
				...
				if (arg1 < arg2) {
					...
					if (arg0 != arg1 && local96 < local68 || arg0 == arg1 && local96 > local82) {
						...
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method8193(this.anIntArray601, this.aFloatArray76, (int) arg0, arg9, (int) arg5, (int) arg3, arg6, local131);
							arg5 += local96;
							arg3 += local68;
							arg6 += local141;
							arg0 += this.anInt9979;
						...
						while (--arg2 >= 0.0F) {
							this.method8193(this.anIntArray601, this.aFloatArray76, (int) arg0, arg9, (int) arg5, (int) arg4, arg6, local131);
							arg5 += local96;
							arg4 += local82;
							arg6 += local141;
							arg0 += this.anInt9979;
						...
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method8193(this.anIntArray601, this.aFloatArray76, (int) arg0, arg9, (int) arg3, (int) arg5, arg6, local131);
							arg5 += local96;
							arg3 += local68;
							arg6 += local141;
							arg0 += this.anInt9979;
						...
						while (--arg2 >= 0.0F) {
							this.method8193(this.anIntArray601, this.aFloatArray76, (int) arg0, arg9, (int) arg4, (int) arg5, arg6, local131);
							arg5 += local96;
							arg4 += local82;
							arg6 += local141;
							arg0 += this.anInt9979;
					...
					if ((arg0 == arg2 || !(local96 < local68)) && (arg0 != arg2 || !(local82 > local68))) {
						...
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method8193(this.anIntArray601, this.aFloatArray76, (int) arg0, arg9, (int) arg3, (int) arg4, arg6, local131);
							arg4 += local96;
							arg3 += local68;
							arg6 += local141;
							arg0 += this.anInt9979;
						...
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method8193(this.anIntArray601, this.aFloatArray76, (int) arg0, arg9, (int) arg4, (int) arg3, arg6, local131);
							arg4 += local96;
							arg3 += local68;
							arg6 += local141;
							arg0 += this.anInt9979;
			...
			if (!(arg1 >= (float) this.anInt9977)) {
				...
				if (arg2 < arg0) {
					...
					if (arg1 != arg2 && local68 < local82 || arg1 == arg2 && local68 > local96) {
						...
						arg1 = this.anIntArray602[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method8193(this.anIntArray601, this.aFloatArray76, (int) arg1, arg9, (int) arg3, (int) arg4, arg7, local131);
							arg3 += local68;
							arg4 += local82;
							arg7 += local141;
							arg1 += this.anInt9979;
						...
						while (--arg0 >= 0.0F) {
							this.method8193(this.anIntArray601, this.aFloatArray76, (int) arg1, arg9, (int) arg3, (int) arg5, arg7, local131);
							arg3 += local68;
							arg5 += local96;
							arg7 += local141;
							arg1 += this.anInt9979;
						...
						arg1 = this.anIntArray602[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method8193(this.anIntArray601, this.aFloatArray76, (int) arg1, arg9, (int) arg4, (int) arg3, arg7, local131);
							arg3 += local68;
							arg4 += local82;
							arg7 += local141;
							arg1 += this.anInt9979;
						...
						while (--arg0 >= 0.0F) {
							this.method8193(this.anIntArray601, this.aFloatArray76, (int) arg1, arg9, (int) arg5, (int) arg3, arg7, local131);
							arg3 += local68;
							arg5 += local96;
							arg7 += local141;
							arg1 += this.anInt9979;
					...
					if (local68 < local82) {
						...
						arg1 = this.anIntArray602[(int) arg1];
						while (--arg0 >= 0.0F) {
							this.method8193(this.anIntArray601, this.aFloatArray76, (int) arg1, arg9, (int) arg5, (int) arg4, arg7, local131);
							arg5 += local68;
							arg4 += local82;
							arg7 += local141;
							arg1 += this.anInt9979;
						...
						arg1 = this.anIntArray602[(int) arg1];
						while (--arg0 >= 0.0F) {
							this.method8193(this.anIntArray601, this.aFloatArray76, (int) arg1, arg9, (int) arg4, (int) arg5, arg7, local131);
							arg5 += local68;
							arg4 += local82;
							arg7 += local141;
							arg1 += this.anInt9979;
			...
			if (arg0 < arg1) {
				...
				if (local82 < local96) {
					...
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method8193(this.anIntArray601, this.aFloatArray76, (int) arg2, arg9, (int) arg4, (int) arg5, arg8, local131);
						arg4 += local82;
						arg5 += local96;
						arg8 += local141;
						arg2 += this.anInt9979;
					...
					while (--arg1 >= 0.0F) {
						this.method8193(this.anIntArray601, this.aFloatArray76, (int) arg2, arg9, (int) arg4, (int) arg3, arg8, local131);
						arg4 += local82;
						arg3 += local68;
						arg8 += local141;
						arg2 += this.anInt9979;
					...
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method8193(this.anIntArray601, this.aFloatArray76, (int) arg2, arg9, (int) arg5, (int) arg4, arg8, local131);
						arg4 += local82;
						arg5 += local96;
						arg8 += local141;
						arg2 += this.anInt9979;
					...
					while (--arg1 >= 0.0F) {
						this.method8193(this.anIntArray601, this.aFloatArray76, (int) arg2, arg9, (int) arg3, (int) arg4, arg8, local131);
						arg4 += local82;
						arg3 += local68;
						arg8 += local141;
						arg2 += this.anInt9979;
				...
				if (local82 < local96) {
					...
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method8193(this.anIntArray601, this.aFloatArray76, (int) arg2, arg9, (int) arg3, (int) arg5, arg8, local131);
						arg3 += local82;
						arg5 += local96;
						arg8 += local141;
						arg2 += this.anInt9979;
					...
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method8193(this.anIntArray601, this.aFloatArray76, (int) arg2, arg9, (int) arg5, (int) arg3, arg8, local131);
						arg3 += local82;
						arg5 += local96;
						arg8 += local141;
						arg2 += this.anInt9979;
	...
	public void method8203(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) float arg9, @OriginalArg(10) float arg10, @OriginalArg(11) float arg11, @OriginalArg(12) float arg12, @OriginalArg(13) float arg13, @OriginalArg(14) float arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18, @OriginalArg(19) int arg19, @OriginalArg(20) int arg20, @OriginalArg(21) int arg21, @OriginalArg(22) int arg22) {
		if (arg22 != this.anInt9992) {
			this.anIntArray604 = this.aClass33_Sub2_12.method1451(arg22);
			if (this.anIntArray604 == null) {
				this.method8197((float) arg0, (float) arg1, (float) arg2, (float) arg3, (float) arg4, (float) arg5, (float) arg6, (float) arg7, (float) arg8, Static187.method3362(arg15, arg18 | arg19 << 24), Static187.method3362(arg16, arg18 | arg20 << 24), Static187.method3362(arg17, arg18 | arg21 << 24));
				return;
			}
			...
			this.anInt9989 = this.anInt9990 - 1;
			this.anInt9986 = this.aClass33_Sub2_12.method1446(arg22);
			this.aBoolean838 = this.aClass33_Sub2_12.method1437(arg22);
		}
		this.anInt9991 = arg18;
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (!(arg0 >= (float) this.anInt9977)) {
				...
				if (arg1 < arg2) {
					...
					if (arg0 != arg1 && local320 < local215 || arg0 == arg1 && local320 > local239) {
						...
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method8201(this.anIntArray601, this.anIntArray604, (int) arg0, (int) arg5, (int) arg3, arg8, arg6, arg11, arg9, arg14, arg12, (float) arg21, (float) arg19, local120, local106, local141, local127, local162, local148, local177, local167);
							arg3 += local215;
							arg5 += local320;
							arg6 += local217;
							arg8 += local379;
						...
						while (--arg2 >= 0.0F) {
							this.method8201(this.anIntArray601, this.anIntArray604, (int) arg0, (int) arg5, (int) arg4, arg8, arg7, arg11, arg10, arg14, arg13, (float) arg21, (float) arg20, local120, local113, local141, local134, local162, local155, local177, local172);
							arg4 += local239;
							arg5 += local320;
							arg7 += local298;
							arg8 += local379;
						...
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method8201(this.anIntArray601, this.anIntArray604, (int) arg0, (int) arg3, (int) arg5, arg6, arg8, arg9, arg11, arg12, arg14, (float) arg19, (float) arg21, local106, local120, local127, local141, local148, local162, local167, local177);
							arg3 += local215;
							arg5 += local320;
							arg6 += local217;
							arg8 += local379;
						...
						while (--arg2 >= 0.0F) {
							this.method8201(this.anIntArray601, this.anIntArray604, (int) arg0, (int) arg4, (int) arg5, arg7, arg8, arg10, arg11, arg13, arg14, (float) arg20, (float) arg21, local113, local120, local134, local141, local155, local162, local172, local177);
							arg4 += local239;
							arg5 += local320;
							arg7 += local298;
							arg8 += local379;
					...
					if (arg0 != arg2 && local320 < local215 || arg0 == arg2 && local239 > local215) {
						...
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method8201(this.anIntArray601, this.anIntArray604, (int) arg0, (int) arg4, (int) arg3, arg7, arg6, arg10, arg9, arg13, arg12, (float) arg20, (float) arg19, local113, local106, local134, local127, local155, local148, local172, local167);
							arg3 += local215;
							arg4 += local320;
							arg6 += local217;
							arg7 += local379;
						...
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method8201(this.anIntArray601, this.anIntArray604, (int) arg0, (int) arg3, (int) arg4, arg6, arg7, arg9, arg10, arg12, arg13, (float) arg19, (float) arg20, local106, local113, local127, local134, local148, local155, local167, local172);
							arg4 += local320;
							arg3 += local215;
							arg7 += local379;
							arg6 += local217;
			...
			if (!(arg1 >= (float) this.anInt9977)) {
				...
				if (arg2 < arg0) {
					...
					if ((arg1 == arg2 || !(local215 < local239)) && (arg1 != arg2 || !(local215 > local320))) {
						...
						arg1 = this.anIntArray602[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method8201(this.anIntArray601, this.anIntArray604, (int) arg1, (int) arg4, (int) arg3, arg7, arg6, arg10, arg9, arg13, arg12, (float) arg20, (float) arg19, local113, local106, local134, local127, local155, local148, local172, local167);
							arg4 += local239;
							arg3 += local215;
							arg7 += local298;
							arg6 += local217;
						...
						while (--arg0 >= 0.0F) {
							this.method8201(this.anIntArray601, this.anIntArray604, (int) arg1, (int) arg5, (int) arg3, arg8, arg6, arg11, arg9, arg14, arg12, (float) arg21, (float) arg19, local120, local106, local141, local127, local162, local148, local177, local167);
							arg5 += local320;
							arg3 += local215;
							arg8 += local379;
							arg6 += local217;
						...
						arg1 = this.anIntArray602[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method8201(this.anIntArray601, this.anIntArray604, (int) arg1, (int) arg3, (int) arg4, arg6, arg7, arg9, arg10, arg12, arg13, (float) arg19, (float) arg20, local106, local113, local127, local134, local148, local155, local167, local172);
							arg3 += local215;
							arg4 += local239;
							arg6 += local217;
							arg7 += local298;
						...
						while (--arg0 >= 0.0F) {
							this.method8201(this.anIntArray601, this.anIntArray604, (int) arg1, (int) arg3, (int) arg5, arg6, arg8, arg9, arg11, arg12, arg14, (float) arg19, (float) arg21, local106, local120, local127, local141, local148, local162, local167, local177);
							arg3 += local215;
							arg5 += local320;
							arg6 += local217;
							arg8 += local379;
					...
					if (local215 < local239) {
						while (--arg0 >= 0.0F) {
							this.method8201(this.anIntArray601, this.anIntArray604, (int) arg1, (int) arg5, (int) arg4, arg8, arg7, arg11, arg10, arg14, arg13, (float) arg21, (float) arg20, local120, local113, local141, local134, local162, local155, local177, local172);
							arg5 += local215;
							arg4 += local239;
							arg8 += local217;
							arg7 += local298;
						...
						while (--arg0 >= 0.0F) {
							this.method8201(this.anIntArray601, this.anIntArray604, (int) arg1, (int) arg4, (int) arg5, arg7, arg8, arg10, arg11, arg13, arg14, (float) arg20, (float) arg21, local113, local120, local134, local141, local155, local162, local172, local177);
							arg4 += local239;
							arg5 += local215;
							arg7 += local298;
							arg8 += local217;
			...
			if (arg0 < arg1) {
				...
				if (local239 < local320) {
					...
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method8201(this.anIntArray601, this.anIntArray604, (int) arg2, (int) arg4, (int) arg5, arg7, arg8, arg10, arg11, arg13, arg14, (float) arg20, (float) arg21, local113, local120, local134, local141, local155, local162, local172, local177);
						arg4 += local239;
						arg5 += local320;
						arg7 += local298;
						arg8 += local379;
					...
					while (--arg1 >= 0.0F) {
						this.method8201(this.anIntArray601, this.anIntArray604, (int) arg2, (int) arg4, (int) arg3, arg7, arg6, arg10, arg9, arg13, arg12, (float) arg20, (float) arg19, local113, local106, local134, local127, local155, local148, local172, local167);
						arg4 += local239;
						arg3 += local215;
						arg7 += local298;
						arg6 += local217;
					...
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method8201(this.anIntArray601, this.anIntArray604, (int) arg2, (int) arg5, (int) arg4, arg8, arg7, arg11, arg10, arg14, arg13, (float) arg21, (float) arg20, local120, local113, local141, local134, local162, local155, local177, local172);
						arg5 += local320;
						arg4 += local239;
						arg8 += local379;
						arg7 += local298;
					...
					while (--arg1 >= 0.0F) {
						this.method8201(this.anIntArray601, this.anIntArray604, (int) arg2, (int) arg3, (int) arg4, arg6, arg7, arg9, arg10, arg12, arg13, (float) arg19, (float) arg20, local106, local113, local127, local134, local148, local155, local167, local172);
						arg3 += local215;
						arg4 += local239;
						arg6 += local217;
						arg7 += local298;
				...
				if (local239 < local320) {
					...
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method8201(this.anIntArray601, this.anIntArray604, (int) arg2, (int) arg3, (int) arg5, arg6, arg8, arg9, arg11, arg12, arg14, (float) arg19, (float) arg21, local106, local120, local127, local141, local148, local162, local167, local177);
						arg3 += local239;
						arg5 += local320;
						arg6 += local298;
						arg8 += local379;
					...
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method8201(this.anIntArray601, this.anIntArray604, (int) arg2, (int) arg5, (int) arg3, arg8, arg6, arg11, arg9, arg14, arg12, (float) arg21, (float) arg19, local120, local106, local141, local127, local162, local148, local177, local167);
						arg5 += local320;
						arg3 += local239;
						arg8 += local379;
						arg6 += local298;
	...
	public void method8204(@OriginalArg(0) boolean arg0) {
		this.aBoolean837 = arg0;
	}

	@OriginalMember(owner = "client!vga", name = "a", descriptor = "(FFFFFFFFFFFF)V")
	public void method8205(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6, @OriginalArg(7) float arg7, @OriginalArg(8) float arg8, @OriginalArg(9) float arg9, @OriginalArg(10) float arg10, @OriginalArg(11) float arg11) {
		if (this.aBoolean837) {
			this.aClass33_Sub2_12.method6236((int) arg1, (int) arg4, (int) arg0, Static474.anIntArray530[(int) arg9], (int) arg3);
			this.aClass33_Sub2_12.method6236((int) arg2, (int) arg5, (int) arg1, Static474.anIntArray530[(int) arg9], (int) arg4);
			this.aClass33_Sub2_12.method6236((int) arg0, (int) arg3, (int) arg2, Static474.anIntArray530[(int) arg9], (int) arg5);
			return;
		}
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (!(arg0 >= (float) this.anInt9977)) {
				...
				if (arg1 < arg2) {
					...
					if ((arg0 == arg1 || !(local117 < local106)) && (arg0 != arg1 || !(local117 > local95))) {
						...
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method8198(this.anIntArray601, this.aFloatArray76, (int) arg0, (int) arg3, (int) arg5, arg9, local143, arg6, local163);
							arg5 += local117;
							arg3 += local106;
							arg9 += local153;
							arg6 += local173;
						...
						while (--arg2 >= 0.0F) {
							this.method8198(this.anIntArray601, this.aFloatArray76, (int) arg0, (int) arg4, (int) arg5, arg9, local143, arg6, local163);
							arg5 += local117;
							arg4 += local95;
							arg9 += local153;
							arg6 += local173;
						...
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg1 >= 0.0F) {
							this.method8198(this.anIntArray601, this.aFloatArray76, (int) arg0, (int) arg5, (int) arg3, arg9, local143, arg6, local163);
							arg5 += local117;
							arg3 += local106;
							arg9 += local153;
							arg6 += local173;
						...
						while (--arg2 >= 0.0F) {
							this.method8198(this.anIntArray601, this.aFloatArray76, (int) arg0, (int) arg5, (int) arg4, arg9, local143, arg6, local163);
							arg5 += local117;
							arg4 += local95;
							arg9 += local153;
							arg6 += local173;
					...
					if (arg0 != arg2 && local117 < local106 || arg0 == arg2 && local95 > local106) {
						...
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method8198(this.anIntArray601, this.aFloatArray76, (int) arg0, (int) arg4, (int) arg3, arg9, local143, arg6, local163);
							arg4 += local117;
							arg3 += local106;
							arg9 += local153;
							arg6 += local173;
						...
						arg0 = this.anIntArray602[(int) arg0];
						while (--arg2 >= 0.0F) {
							this.method8198(this.anIntArray601, this.aFloatArray76, (int) arg0, (int) arg3, (int) arg4, arg9, local143, arg6, local163);
							arg4 += local117;
							arg3 += local106;
							arg9 += local153;
							arg6 += local173;
			...
			if (!(arg1 >= (float) this.anInt9977)) {
				...
				if (arg2 < arg0) {
					...
					if ((arg1 == arg2 || !(local106 < local95)) && (arg1 != arg2 || !(local106 > local117))) {
						...
						arg1 = this.anIntArray602[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method8198(this.anIntArray601, this.aFloatArray76, (int) arg1, (int) arg4, (int) arg3, arg10, local143, arg7, local163);
							arg3 += local106;
							arg4 += local95;
							arg10 += local153;
							arg7 += local173;
						...
						while (--arg0 >= 0.0F) {
							this.method8198(this.anIntArray601, this.aFloatArray76, (int) arg1, (int) arg5, (int) arg3, arg10, local143, arg7, local163);
							arg3 += local106;
							arg5 += local117;
							arg10 += local153;
							arg7 += local173;
						...
						arg1 = this.anIntArray602[(int) arg1];
						while (--arg2 >= 0.0F) {
							this.method8198(this.anIntArray601, this.aFloatArray76, (int) arg1, (int) arg3, (int) arg4, arg10, local143, arg7, local163);
							arg3 += local106;
							arg4 += local95;
							arg10 += local153;
							arg7 += local173;
						...
						while (--arg0 >= 0.0F) {
							this.method8198(this.anIntArray601, this.aFloatArray76, (int) arg1, (int) arg3, (int) arg5, arg10, local143, arg7, local163);
							arg3 += local106;
							arg5 += local117;
							arg10 += local153;
							arg7 += local173;
					...
					if (local106 < local95) {
						...
						arg1 = this.anIntArray602[(int) arg1];
						while (--arg0 >= 0.0F) {
							this.method8198(this.anIntArray601, this.aFloatArray76, (int) arg1, (int) arg5, (int) arg4, arg10, local143, arg7, local163);
							arg5 += local106;
							arg4 += local95;
							arg10 += local153;
							arg7 += local173;
						...
						arg1 = this.anIntArray602[(int) arg1];
						while (--arg0 >= 0.0F) {
							this.method8198(this.anIntArray601, this.aFloatArray76, (int) arg1, (int) arg4, (int) arg5, arg10, local143, arg7, local163);
							arg5 += local106;
							arg4 += local95;
							arg10 += local153;
							arg7 += local173;
			...
			if (arg0 < arg1) {
				...
				if (local95 < local117) {
					...
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method8198(this.anIntArray601, this.aFloatArray76, (int) arg2, (int) arg4, (int) arg5, arg11, local143, arg8, local163);
						arg4 += local95;
						arg5 += local117;
						arg11 += local153;
						arg8 += local173;
					...
					while (--arg1 >= 0.0F) {
						this.method8198(this.anIntArray601, this.aFloatArray76, (int) arg2, (int) arg4, (int) arg3, arg11, local143, arg8, local163);
						arg4 += local95;
						arg3 += local106;
						arg11 += local153;
						arg8 += local173;
					...
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg0 >= 0.0F) {
						this.method8198(this.anIntArray601, this.aFloatArray76, (int) arg2, (int) arg5, (int) arg4, arg11, local143, arg8, local163);
						arg4 += local95;
						arg5 += local117;
						arg11 += local153;
						arg8 += local173;
					...
					while (--arg1 >= 0.0F) {
						this.method8198(this.anIntArray601, this.aFloatArray76, (int) arg2, (int) arg3, (int) arg4, arg11, local143, arg8, local163);
						arg4 += local95;
						arg3 += local106;
						arg11 += local153;
						arg8 += local173;
				...
				if (local95 < local117) {
					...
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method8198(this.anIntArray601, this.aFloatArray76, (int) arg2, (int) arg3, (int) arg5, arg11, local143, arg8, local163);
						arg3 += local95;
						arg5 += local117;
						arg11 += local153;
						arg8 += local173;
					...
					arg2 = this.anIntArray602[(int) arg2];
					while (--arg1 >= 0.0F) {
						this.method8198(this.anIntArray601, this.aFloatArray76, (int) arg2, (int) arg5, (int) arg3, arg11, local143, arg8, local163);
						arg3 += local95;
						arg5 += local117;
						arg11 += local153;
						arg8 += local173;
