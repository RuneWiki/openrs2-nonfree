...
public final class Class4_Sub34 extends Class4 {
	...
	public Class4_Sub34(@OriginalArg(0) byte[] arg0) {
		this.method4919(arg0);
	}

	@OriginalMember(owner = "client!ql", name = "c", descriptor = "(I)[F")
	private float[] method4917(@OriginalArg(0) int arg0) {
		Static333.method4916(this.aByteArrayArray17[arg0]);
		Static333.method4922();
		@Pc(15) int local15 = Static333.method4913(Static58.method1271(Static333.anIntArray482.length - 1));
		@Pc(19) boolean local19 = Static333.aBooleanArray118[local15];
		@Pc(25) int local25 = local19 ? Static333.anInt5934 : Static333.anInt5939;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static333.method4922() != 0;
			local29 = Static333.method4922() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static333.anInt5939 >> 2);
			local67 = (local25 >> 2) + (Static333.anInt5939 >> 2);
			local71 = Static333.anInt5939 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static333.anInt5939 >> 2);
			local104 = local25 + (Static333.anInt5939 >> 2) - (local25 >> 2);
			local108 = Static333.anInt5939 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class268 local123 = Static333.aClass268Array1[Static333.anIntArray482[local15]];
		@Pc(126) int local126 = local123.anInt7758;
		@Pc(131) int local131 = local123.anIntArray618[local126];
		@Pc(140) boolean local140 = !Static333.aClass200Array1[local131].method4770();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt7757; local144++) {
			@Pc(152) Class6 local152 = Static333.aClass6Array1[local123.anIntArray619[local144]];
			local154 = Static333.aFloatArray35;
			local152.method60(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt7758;
			local176 = local123.anIntArray618[local171];
			Static333.aClass200Array1[local176].method4771(Static333.aFloatArray35, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static333.aFloatArray35[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static333.aFloatArray35;
			...
			@Pc(252) float[] local252 = local19 ? Static333.aFloatArray30 : Static333.aFloatArray34;
			@Pc(258) float[] local258 = local19 ? Static333.aFloatArray33 : Static333.aFloatArray28;
			@Pc(264) float[] local264 = local19 ? Static333.aFloatArray29 : Static333.aFloatArray32;
			@Pc(270) int[] local270 = local19 ? Static333.anIntArray481 : Static333.anIntArray483;
			...
			@Pc(486) int local486 = Static58.method1271(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static333.aFloatArray35[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static333.aFloatArray35[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt5931 > 0) {
			local176 = this.anInt5931 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean444) {
				for (local212 = 0; local212 < this.anInt5936; local212++) {
					local1254 = (this.anInt5931 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static333.aFloatArray35[local212];
				}
			}
		}
		local154 = this.aFloatArray31;
		this.aFloatArray31 = Static333.aFloatArray35;
		Static333.aFloatArray35 = local154;
		this.anInt5931 = local25;
		this.anInt5936 = local104 - (local25 >> 1);
		this.aBoolean444 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!ql", name = "a", descriptor = "([I)Lclient!cv;")
	public Class4_Sub9_Sub1 method4918(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray84 == null) {
			this.anInt5931 = 0;
			this.aFloatArray31 = new float[Static333.anInt5934];
			this.aByteArray84 = new byte[this.anInt5933];
			this.anInt5940 = 0;
			this.anInt5938 = 0;
		}
		while (this.anInt5938 < this.aByteArrayArray17.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method4917(this.anInt5938);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt5940;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt5933 - local47) {
					local50 = this.anInt5933 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt5940;
				}
				this.anInt5940 = local47;
			}
			this.anInt5938++;
		}
		...
		return new Class4_Sub9_Sub1(this.anInt5935, local129, this.anInt5929, this.anInt5937, this.aBoolean442);
	}

	@OriginalMember(owner = "client!ql", name = "b", descriptor = "([B)V")
	private void method4919(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class4_Sub20 local4 = new Class4_Sub20(arg0);
		this.anInt5935 = local4.method4595();
		this.anInt5933 = local4.method4595();
		this.anInt5929 = local4.method4595();
		this.anInt5937 = local4.method4595();
		if (this.anInt5937 < 0) {
			this.anInt5937 = ~this.anInt5937;
		...
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			...
			@Pc(53) int local53;
			do {
				local53 = local4.method4614();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method4566(local49, local64);
