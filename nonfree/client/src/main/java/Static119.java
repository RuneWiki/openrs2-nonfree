...
public final class Static119 {
	...
	@OriginalMember(owner = "client!lb", name = "a", descriptor = "(II[B[IIIIIIILclient!lb;II)I")
	public static int method1135(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class6_Sub3_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!lb", name = "b", descriptor = "(II[B[IIIIIIILclient!lb;II)I")
	public static int method1136(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class6_Sub3_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!lb", name = "a", descriptor = "(II[B[IIIIIIIIILclient!lb;II)I")
	public static int method1137(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) Class6_Sub3_Sub1 arg9, @OriginalArg(13) int arg10, @OriginalArg(14) int arg11) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!lb", name = "a", descriptor = "([B[IIIIIIILclient!lb;)I")
	public static int method1140(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class6_Sub3_Sub1 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt1669 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lclient!da;II)Lclient!lb;")
	public static Class6_Sub3_Sub1 method1142(@OriginalArg(0) Class6_Sub4_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray5 == null || arg0.aByteArray5.length == 0 ? null : new Class6_Sub3_Sub1(arg0, (int) ((long) arg0.anInt912 * 256L * (long) 100 / (long) (Static59.anInt1823 * 100)), arg1);
	}

	@OriginalMember(owner = "client!lb", name = "b", descriptor = "(II[B[IIIIIIIIILclient!lb;II)I")
	...
	@OriginalMember(owner = "client!lb", name = "a", descriptor = "([B[IIIIIIIIILclient!lb;)I")
	public static int method1144(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class6_Sub3_Sub1 arg9) {
		arg2 >>= 0x8;
		...
		arg9.anInt1666 = arg4 >> 8;
		arg9.anInt1669 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!lb", name = "b", descriptor = "([B[IIIIIIILclient!lb;)I")
	public static int method1146(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class6_Sub3_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 8;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!lb", name = "b", descriptor = "([B[IIIIIIIIILclient!lb;)I")
	public static int method1147(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class6_Sub3_Sub1 arg9) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg8 >> 8;
		arg4 <<= 0x8;
		@Pc(15) int local15 = arg6 << 8;
