...
public final class Class31_Sub1 extends Class31 {
	...
	static {
		for (@Pc(6) int local6 = 1; local6 < 2048; local6++) {
			anIntArray45[local6] = 65536 / local6;
		}
	}

	@OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Lclient!j;)V", line = 5860)
	public Class31_Sub1(@OriginalArg(0) Class19_Sub2 arg0) {
		this.aClass19_Sub2_3 = arg0;
	}

	@OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Lclient!j;Lclient!pr;IIII)V", line = 5863)
	public Class31_Sub1(@OriginalArg(0) Class19_Sub2 arg0, @OriginalArg(1) Class185 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		this.anInt981 = arg3;
		this.anInt982 = arg4;
		this.anInt986 = arg1.anInt5065;
		this.anInt980 = arg1.anInt5077;
		this.anIntArray68 = arg1.anIntArray354;
		this.anIntArray56 = arg1.anIntArray355;
		this.anIntArray47 = arg1.anIntArray356;
		this.anInt985 = arg1.anInt5061;
		this.aShortArray9 = arg1.aShortArray96;
		this.aShortArray5 = arg1.aShortArray104;
		this.aShortArray6 = arg1.aShortArray101;
		...
		if (arg1.anIntArray358 != null && (this.anInt983 & 0x20) != 0) {
			this.anIntArrayArray10 = arg1.method4662();
		}
		if (arg1.anIntArray357 != null && (this.anInt983 & 0x180) != 0) {
			this.anIntArrayArray12 = arg1.method4654();
		}
		@Pc(156) int local156;
		if (arg1.aShortArray97 == null) {
			this.aShortArray10 = null;
		} else {
			this.aShortArray10 = new short[this.anInt985];
			@Pc(154) boolean local154 = false;
			for (local156 = 0; local156 < this.anInt985; local156++) {
				@Pc(162) short local162 = arg1.aShortArray97[local156];
				if (local162 == -1 || this.aClass19_Sub2_3.anInterface2_5.method2660(local162).aBoolean438) {
					this.aShortArray10[local156] = -1;
				} else {
					this.aShortArray10[local156] = local162;
					local154 = true;
				}
			}
			if (!local154) {
		...
		if (this.aShortArray10 != null && arg1.anInt5062 > 0 && arg1.aByteArray70 != null) {
			@Pc(213) int[] local213 = new int[arg1.anInt5062];
			for (local156 = 0; local156 < this.anInt985; local156++) {
			...
			this.anInt979 = 0;
			for (@Pc(244) int local244 = 0; local244 < arg1.anInt5062; local244++) {
				if (local213[local244] > 0 && arg1.aByteArray67[local244] == 0) {
					this.anInt979++;
				}
			}
			this.anIntArray43 = new int[this.anInt979];
			this.anIntArray46 = new int[this.anInt979];
			this.anIntArray62 = new int[this.anInt979];
			@Pc(282) int local282 = 0;
			for (@Pc(284) int local284 = 0; local284 < arg1.anInt5062; local284++) {
				if (local213[local284] > 0 && arg1.aByteArray67[local284] == 0) {
					this.anIntArray43[local282] = arg1.aShortArray103[local284] & 0xFFFF;
					this.anIntArray46[local282] = arg1.aShortArray105[local284] & 0xFFFF;
					this.anIntArray62[local282] = arg1.aShortArray100[local284] & 0xFFFF;
					local213[local284] = local282++;
				} else {
					local213[local284] = -1;
				}
			}
			this.aByteArray9 = new byte[this.anInt985];
			for (@Pc(346) int local346 = 0; local346 < this.anInt985; local346++) {
				if (arg1.aByteArray70[local346] == -1) {
					...
					if (this.aByteArray9[local346] == -1 && this.aShortArray10 != null) {
						this.aShortArray10[local346] = -1;
					}
				}
			}
		}
	...
	@OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Lclient!j;[Lclient!cb;)V", line = 5994)
	public Class31_Sub1(@OriginalArg(0) Class19_Sub2 arg0, @OriginalArg(1) Class31_Sub1[] arg1) {
		...
		for (@Pc(63) int local63 = 0; local63 < arg1.length; local63++) {
			...
			if (local68 != null) {
				...
				this.anInt985 += local68.anInt985;
				this.anInt979 += local68.anInt979;
				...
				local43 |= local68.aShortArray10 != null;
		...
		this.anIntArray68 = new int[this.anInt986];
		this.anIntArray56 = new int[this.anInt986];
		this.anIntArray47 = new int[this.anInt986];
		this.aShortArray9 = new short[this.anInt985];
		this.aShortArray5 = new short[this.anInt985];
		this.aShortArray6 = new short[this.anInt985];
		this.anIntArray76 = new int[this.anInt985];
		this.anIntArray74 = new int[this.anInt985];
		this.anIntArray52 = new int[this.anInt985];
		if (local39) {
			this.aByteArray8 = new byte[this.anInt985];
		}
		if (local41) {
			this.aByteArray11 = new byte[this.anInt985];
		}
		if (local43) {
			this.aShortArray10 = new short[this.anInt985];
		}
		...
		this.anInt986 = 0;
		@Pc(271) int local271 = this.anInt985;
		this.anInt985 = 0;
		this.anInt979 = 0;
		local58 = 0;
		local56 = 0;
		...
		for (@Pc(283) int local283 = 0; local283 < arg1.length; local283++) {
			...
			if (local288 != null) {
				...
				if (local288.aShortArray7 != null && this.aShortArray7 == null) {
					this.aShortArray7 = new short[local271];
				}
				for (local305 = 0; local305 < local288.anInt985; local305++) {
					this.aShortArray9[this.anInt985] = (short) (local288.aShortArray9[local305] + this.anInt986);
					this.aShortArray5[this.anInt985] = (short) (local288.aShortArray5[local305] + this.anInt986);
					this.aShortArray6[this.anInt985] = (short) (local288.aShortArray6[local305] + this.anInt986);
					this.anIntArray76[this.anInt985] = local288.anIntArray76[local305];
					this.anIntArray74[this.anInt985] = local288.anIntArray74[local305];
					this.anIntArray52[this.anInt985] = local288.anIntArray52[local305];
					if (local288.aShortArray7 != null) {
						this.aShortArray7[this.anInt985] = local288.aShortArray7[local305];
					}
					if (local39) {
						if (local288.aByteArray8 != null) {
							this.aByteArray8[this.anInt985] = local288.aByteArray8[local305];
						} else if (local288.aByte4 == -1) {
							this.aByteArray8[this.anInt985] = 10;
						} else {
							this.aByteArray8[this.anInt985] = local288.aByte4;
						}
					}
					if (local41 && local288.aByteArray11 != null) {
						this.aByteArray11[this.anInt985] = local288.aByteArray11[local305];
					}
					if (local43) {
						if (local288.aShortArray10 == null) {
							this.aShortArray10[this.anInt985] = -1;
						} else {
							this.aShortArray10[this.anInt985] = local288.aShortArray10[local305];
						}
					}
					if (local45) {
						this.aByteArray9[this.anInt985] = (byte) (local288.aByteArray9 == null || local288.aByteArray9[local305] == -1 ? -1 : local288.aByteArray9[local305] + this.anInt979);
					}
					this.anInt985++;
				}
				@Pc(494) int local494;
				if (local288.aClass114Array1 != null) {
					for (local494 = 0; local494 < local288.aClass114Array1.length; local494++) {
						...
						this.aClass114Array1[local56] = new Class114(local500, this.anInt986);
						local56++;
					}
				}
				if (local288.aClass163Array1 != null) {
					for (local494 = 0; local494 < local288.aClass163Array1.length; local494++) {
						...
						this.aClass163Array1[local58] = new Class163(local528, this.anInt986);
						local58++;
					}
				}
				for (local494 = 0; local494 < local288.anInt979; local494++) {
					if (local288.anIntArray43[local494] < local288.anInt980) {
						this.anIntArray43[this.anInt979] = local288.anIntArray43[local494] + this.anInt986;
					}
					if (local288.anIntArray46[local494] < local288.anInt980) {
						this.anIntArray46[this.anInt979] = local288.anIntArray46[local494] + this.anInt986;
					}
					if (local288.anIntArray62[local494] < local288.anInt980) {
						this.anIntArray62[this.anInt979] = local288.anIntArray62[local494] + this.anInt986;
					}
					this.anInt979++;
				}
				for (local618 = 0; local618 < local288.anInt980; local618++) {
					this.anIntArray68[this.anInt986] = local288.anIntArray68[local618];
					this.anIntArray56[this.anInt986] = local288.anIntArray56[local618];
					this.anIntArray47[this.anInt986] = local288.anIntArray47[local618];
					this.anInt986++;
				}
			}
		}
		...
		this.anInt980 = this.anInt986;
		for (local305 = 0; local305 < arg1.length; local305++) {
			@Pc(678) Class31_Sub1 local678 = arg1[local305];
			if (local678 != null) {
				for (local618 = 0; local618 < local678.anInt979; local618++) {
					if (local678.anIntArray43[local618] >= local678.anInt980) {
						this.anIntArray43[local667] = local678.anIntArray43[local618] + this.anInt986 - local678.anInt980;
					}
					if (local678.anIntArray46[local618] >= local678.anInt980) {
						this.anIntArray46[local667] = local678.anIntArray46[local618] + this.anInt986 - local678.anInt980;
					}
					if (local678.anIntArray62[local618] >= local678.anInt980) {
						this.anIntArray62[local667] = local678.anIntArray62[local618] + this.anInt986 - local678.anInt980;
					}
					local667++;
				}
				for (@Pc(755) int local755 = local678.anInt980; local755 < local678.anInt986; local755++) {
					this.anIntArray68[this.anInt986] = local678.anIntArray68[local755];
					this.anIntArray56[this.anInt986] = local678.anIntArray56[local755];
					this.anIntArray47[this.anInt986] = local678.anIntArray47[local755];
					this.anInt986++;
				}
			}
		}
	...
	private void method1237(@OriginalArg(0) int arg0) {
		@Pc(1) int local1 = 0;
		@Pc(5) int local5 = this.aClass19_Sub2_3.anInt2840;
		@Pc(10) short local10 = this.aShortArray9[arg0];
		...
		if (this.aByteArray11 == null) {
			this.aClass81_1.anInt2261 = 0;
		} else {
			this.aClass81_1.anInt2261 = this.aByteArray11[arg0] & 0xFF;
		}
		@Pc(88) int local88;
		@Pc(93) int local93;
		@Pc(100) int local100;
		...
		if (local25 >= local5) {
			...
			if (local35 >= local5) {
				local113 = (local5 - local25) * anIntArray45[local35 - local25];
				this.anIntArray72[0] = this.aClass250_2.anInt7210 + (local88 + ((this.anIntArray51[local20] - local88) * local113 >> 16)) * this.aClass19_Sub2_3.anInt2848 / local5;
				this.anIntArray66[0] = this.aClass250_2.anInt7211 + (local93 + ((this.anIntArray64[local20] - local93) * local113 >> 16)) * this.aClass19_Sub2_3.anInt2838 / local5;
				local1++;
				this.anIntArray73[0] = local100 + (((this.anIntArray52[arg0] & 0xFFFF) - local100) * local113 >> 16);
			}
			if (local30 >= local5) {
				local113 = (local5 - local25) * anIntArray45[local30 - local25];
				this.anIntArray72[local1] = this.aClass250_2.anInt7210 + (local88 + ((this.anIntArray51[local15] - local88) * local113 >> 16)) * this.aClass19_Sub2_3.anInt2848 / local5;
				this.anIntArray66[local1] = this.aClass250_2.anInt7211 + (local93 + ((this.anIntArray64[local15] - local93) * local113 >> 16)) * this.aClass19_Sub2_3.anInt2838 / local5;
		...
		if (local30 >= local5) {
			...
			if (local25 >= local5) {
				local113 = (local5 - local30) * anIntArray45[local25 - local30];
				this.anIntArray72[local1] = this.aClass250_2.anInt7210 + (local88 + ((this.anIntArray51[local10] - local88) * local113 >> 16)) * this.aClass19_Sub2_3.anInt2848 / local5;
				this.anIntArray66[local1] = this.aClass250_2.anInt7211 + (local93 + ((this.anIntArray64[local10] - local93) * local113 >> 16)) * this.aClass19_Sub2_3.anInt2838 / local5;
				this.anIntArray73[local1++] = local100 + (((this.anIntArray76[arg0] & 0xFFFF) - local100) * local113 >> 16);
			}
			if (local35 >= local5) {
				local113 = (local5 - local30) * anIntArray45[local35 - local30];
				this.anIntArray72[local1] = this.aClass250_2.anInt7210 + (local88 + ((this.anIntArray51[local20] - local88) * local113 >> 16)) * this.aClass19_Sub2_3.anInt2848 / local5;
				this.anIntArray66[local1] = this.aClass250_2.anInt7211 + (local93 + ((this.anIntArray64[local20] - local93) * local113 >> 16)) * this.aClass19_Sub2_3.anInt2838 / local5;
		...
		if (local35 >= local5) {
			...
			if (local30 >= local5) {
				local113 = (local5 - local35) * anIntArray45[local30 - local35];
				this.anIntArray72[local1] = this.aClass250_2.anInt7210 + (local88 + ((this.anIntArray51[local15] - local88) * local113 >> 16)) * this.aClass19_Sub2_3.anInt2848 / local5;
				this.anIntArray66[local1] = this.aClass250_2.anInt7211 + (local93 + ((this.anIntArray64[local15] - local93) * local113 >> 16)) * this.aClass19_Sub2_3.anInt2838 / local5;
				this.anIntArray73[local1++] = local100 + (((this.anIntArray74[arg0] & 0xFFFF) - local100) * local113 >> 16);
			}
			if (local25 >= local5) {
				local113 = (local5 - local35) * anIntArray45[local25 - local35];
				this.anIntArray72[local1] = this.aClass250_2.anInt7210 + (local88 + ((this.anIntArray51[local10] - local88) * local113 >> 16)) * this.aClass19_Sub2_3.anInt2848 / local5;
				this.anIntArray66[local1] = this.aClass250_2.anInt7211 + (local93 + ((this.anIntArray64[local10] - local93) * local113 >> 16)) * this.aClass19_Sub2_3.anInt2838 / local5;
				this.anIntArray73[local1++] = local100 + (((this.anIntArray76[arg0] & 0xFFFF) - local100) * local113 >> 16);
			}
		...
		this.aClass81_1.aBoolean169 = false;
		@Pc(838) int local838;
		@Pc(843) int local843;
		@Pc(848) int local848;
		@Pc(833) int local833;
		if (local1 == 3) {
			if (local88 < 0 || local93 < 0 || local100 < 0 || local88 > this.aClass250_2.anInt7209 || local93 > this.aClass250_2.anInt7209 || local100 > this.aClass250_2.anInt7209) {
				this.aClass81_1.aBoolean169 = true;
			}
			if (this.aShortArray10 != null && this.aShortArray10[arg0] != -1) {
				...
				if (this.anIntArray52[arg0] == -1) {
					this.aClass81_1.method2290(local113, local725, local730, local88, local93, local100, this.anIntArray76[arg0], this.anIntArray76[arg0], this.anIntArray76[arg0], this.anIntArray51[local838], this.anIntArray51[local843], this.anIntArray51[local848], this.anIntArray64[local838], this.anIntArray64[local843], this.anIntArray64[local848], this.anIntArray61[local838], this.anIntArray61[local843], this.anIntArray61[local848], this.aShortArray10[arg0]);
				} else {
					this.aClass81_1.method2290(local113, local725, local730, local88, local93, local100, this.anIntArray73[0], this.anIntArray73[1], this.anIntArray73[2], this.anIntArray51[local838], this.anIntArray51[local843], this.anIntArray51[local848], this.anIntArray64[local838], this.anIntArray64[local843], this.anIntArray64[local848], this.anIntArray61[local838], this.anIntArray61[local843], this.anIntArray61[local848], this.aShortArray10[arg0]);
				}
			} else if (this.anIntArray52[arg0] == -1) {
				this.aClass81_1.method2284(local113, local725, local730, local88, local93, local100, Static169.anIntArray204[this.anIntArray76[arg0] & 0xFFFF]);
			} else {
				this.aClass81_1.method2288(local113, local725, local730, local88, local93, local100, this.anIntArray73[0], this.anIntArray73[1], this.anIntArray73[2]);
			}
		}
		if (local1 != 4) {
			return;
		}
		if (local88 < 0 || local93 < 0 || local100 < 0 || local88 > this.aClass250_2.anInt7209 || local93 > this.aClass250_2.anInt7209 || local100 > this.aClass250_2.anInt7209 || this.anIntArray72[3] < 0 || this.anIntArray72[3] > this.aClass250_2.anInt7209) {
			this.aClass81_1.aBoolean169 = true;
		}
		if (this.aShortArray10 == null || this.aShortArray10[arg0] == -1) {
			if (this.anIntArray52[arg0] == -1) {
				local838 = Static169.anIntArray204[this.anIntArray76[arg0] & 0xFFFF];
				this.aClass81_1.method2284(local113, local725, local730, local88, local93, local100, local838);
				this.aClass81_1.method2284(local113, local730, this.anIntArray66[3], local88, local100, this.anIntArray72[3], local838);
				return;
			}
			this.aClass81_1.method2288(local113, local725, local730, local88, local93, local100, this.anIntArray73[0], this.anIntArray73[1], this.anIntArray73[2]);
			this.aClass81_1.method2288(local113, local730, this.anIntArray66[3], local88, local100, this.anIntArray72[3], this.anIntArray73[0], this.anIntArray73[2], this.anIntArray73[3]);
			return;
		}
		if (this.aByteArray9 == null || this.aByteArray9[arg0] == -1) {
			local838 = local10;
	...
	@OriginalMember(owner = "client!cb", name = "f", descriptor = "()[Lclient!jf;", line = 245)
	@Override
	...
	private void method1238(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4) {
		...
		@Pc(112) int local112;
		@Pc(152) int local152;
		for (@Pc(19) int local19 = 0; local19 < this.anInt985; local19++) {
			if (this.anIntArray52[local19] != -2) {
				@Pc(31) short local31 = this.aShortArray9[local19];
				...
				if (arg0 && (local46 == -5000 || local51 == -5000 || local56 == -5000)) {
					...
					if (local46 >= 0 && local51 >= 0 && local56 >= 0 && local46 <= this.aClass250_2.anInt7209 && local51 <= this.aClass250_2.anInt7209 && local56 <= this.aClass250_2.anInt7209) {
						...
						if (local422 > 0) {
							...
							for (local51 = 0; local51 < local458; local51++) {
								...
								if (local56 < 65536) {
									...
									this.aClass19_Sub2_3.method2910(local562, this.anIntArray78[local72], this.anIntArray48[local72], (local562.anInt4465 >> 2) / local82);
								}
							}
						}
						if (local422 > 64) {
			...
			if (arg1) {
				while (local87 == 0 && local51 > local422) {
					...
					if (local92 < 65536) {
						...
						this.aClass19_Sub2_3.method2910(local1619, this.anIntArray78[local97], this.anIntArray48[local97], (local1619.anInt4465 >> 2) / local107);
					}
				...
				if (arg1) {
					for (local102 = 0; local102 < local92; local102++) {
						...
						if (local107 < 65536) {
							...
							this.aClass19_Sub2_3.method2910(local2178, this.anIntArray78[local112], this.anIntArray48[local112], (local2178.anInt4465 >> 2) / local152);
						}
					}
				} else {
					for (local102 = 0; local102 < local92; local102++) {
	...
	public void method3815(@OriginalArg(0) int arg0) {
		if ((this.anInt983 & 0x8000) == 32768 && (arg0 & 0x8000) == 0) {
	...
	@OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lclient!on;Lclient!au;Lclient!tp;II)V", line = 1432)
	private void method1240(@OriginalArg(0) Class14 arg0, @OriginalArg(1) Class12_Sub2 arg1, @OriginalArg(2) Class224 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (local145 >= this.aClass19_Sub2_3.anInt2844 || local150 <= this.aClass19_Sub2_3.anInt2840) {
			return;
		}
		...
		if (local237 > local246) {
			local258 = (local246 - this.aShort5) * this.aClass19_Sub2_3.anInt2848;
			local267 = (local237 + this.aShort5) * this.aClass19_Sub2_3.anInt2848;
		} else {
			local258 = (local237 - this.aShort5) * this.aClass19_Sub2_3.anInt2848;
			local267 = (local246 + this.aShort5) * this.aClass19_Sub2_3.anInt2848;
		}
		if (local258 / local150 >= this.aClass19_Sub2_3.anInt2862 || local267 / local150 <= this.aClass19_Sub2_3.anInt2845) {
			return;
		}
		...
		if (local366 > local375) {
			local387 = (local375 - this.aShort5) * this.aClass19_Sub2_3.anInt2838;
			local396 = (local366 + this.aShort5) * this.aClass19_Sub2_3.anInt2838;
		} else {
			local387 = (local366 - this.aShort5) * this.aClass19_Sub2_3.anInt2838;
			local396 = (local375 + this.aShort5) * this.aClass19_Sub2_3.anInt2838;
		}
		if (local387 / local150 >= this.aClass19_Sub2_3.anInt2859 || local396 / local150 <= this.aClass19_Sub2_3.anInt2841) {
			return;
		}
		@Pc(436) int local436;
		@Pc(439) int local439;
		...
		if (this.aClass19_Sub2_3.anInt2843 > 1) {
			synchronized (this) {
		...
		@Pc(631) boolean local631 = local145 <= this.aClass19_Sub2_3.anInt2840;
		@Pc(646) boolean local646 = local631 || this.anInt979 > 0 || this.aClass114Array1 != null || this.aClass163Array1 != null;
		this.aClass250_2.anInt7209 = this.aClass81_1.anInt2262;
		this.aClass250_2.anInt7210 = this.aClass81_1.anInt2263;
		this.aClass250_2.anInt7211 = this.aClass81_1.anInt2260;
		@Pc(668) int local668 = this.aClass19_Sub2_3.anInt2848;
		@Pc(672) int local672 = this.aClass19_Sub2_3.anInt2838;
		@Pc(676) int local676 = this.aClass19_Sub2_3.anInt2840;
		@Pc(713) int local713;
		@Pc(729) int local729;
		@Pc(745) int local745;
		@Pc(687) int local687;
		...
		@Pc(681) int local681;
		if (arg3 == -1) {
			for (local681 = 0; local681 < this.anInt986; local681++) {
				...
				if (local745 >= local676) {
					this.anIntArray60[local681] = this.aClass250_2.anInt7210 + local713 * local668 / local745;
					this.anIntArray63[local681] = this.aClass250_2.anInt7211 + local729 * local672 / local745;
				} else {
			...
			for (local681 = 0; local681 < this.anInt986; local681++) {
				...
				this.anIntArray67[local681] = local745;
				if (local745 >= local676) {
					this.anIntArray60[local681] = this.aClass250_2.anInt7210 + local713 * local668 / arg3;
					this.anIntArray63[local681] = this.aClass250_2.anInt7211 + local729 * local672 / arg3;
				} else {
					this.anIntArray60[local681] = -5000;
					local622 = true;
				}
		...
		if (arg2 != null) {
			for (@Pc(1026) Class12_Sub1_Sub1 local1026 = (Class12_Sub1_Sub1) arg2.aClass191_1.method4891(); local1026 != null; local1026 = (Class12_Sub1_Sub1) arg2.aClass191_1.method4889()) {
				@Pc(1032) int local1032 = local1026.anInt4458 >> 12;
				local1037 = local1026.anInt4463 >> 12;
				local1042 = local1026.anInt4460 >> 12;
				...
				if (local745 >= local676) {
					this.anIntArray78[local681] = this.aClass19_Sub2_3.anInt2852 + local713 * local668 / local745;
					this.anIntArray48[local681] = this.aClass19_Sub2_3.anInt2857 + local729 * local672 / local745;
		...
		if (arg1 != null) {
			...
			if (local745 >= local676) {
				...
				arg1.anInt423 = this.aClass19_Sub2_3.anInt2852 + local713 * local668 / local1245;
				arg1.anInt424 = this.aClass19_Sub2_3.anInt2857 + local729 * local672 / local1245;
			} else {
				local1167 = true;
			}
			...
			if (local1330 >= local676) {
				...
				arg1.anInt425 = this.aClass19_Sub2_3.anInt2852 + local1245 * local668 / local1335;
				arg1.anInt426 = this.aClass19_Sub2_3.anInt2857 + local1314 * local672 / local1335;
			} else {
				local1167 = true;
			}
			if (local1167) {
				if (local745 < local676 && local1330 < local676) {
					...
					if (local745 < local676) {
						local1335 = (local1330 - this.aClass19_Sub2_3.anInt2840 << 16) / (local1330 - local745);
						...
						arg1.anInt423 = this.aClass19_Sub2_3.anInt2852 + local1401 * local668 / local1413;
						arg1.anInt424 = this.aClass19_Sub2_3.anInt2857 + local1411 * local672 / local1413;
			...
			if (local1169) {
				if (local745 > local1330) {
					...
					arg1.anInt427 = this.aClass19_Sub2_3.anInt2852 + (local713 + this.aShort5) * local668 / local1335 - arg1.anInt423;
				} else {
					local1335 = local1330;
					if (arg3 != -1) {
						local1335 = arg3;
					}
					arg1.anInt427 = this.aClass19_Sub2_3.anInt2852 + (local1245 + this.aShort5) * local668 / local1335 - arg1.anInt425;
				}
		...
		try {
			this.method1238(local622, this.aClass19_Sub2_3.aBoolean198 && local150 > this.aClass19_Sub2_3.anInt2864 || this.aClass19_Sub2_3.aBoolean199, local150 + 2 - local145, arg2 != null, local681);
	...
	@OriginalMember(owner = "client!cb", name = "q", descriptor = "()[Lclient!nm;", line = 1862)
	@Override
	...
	public void method3846(@OriginalArg(0) int arg0) {
		if ((this.anInt983 & 0xD) != 13) {
			...
			@Pc(57) int local57;
			for (@Pc(40) int local40 = 0; local40 < this.anInt980; local40++) {
			...
			if (this.aClass234Array1 != null) {
				for (local57 = 0; local57 < this.anInt985; local57++) {
					if (this.aClass234Array1[local57] != null) {
						local166 = this.aClass234Array1[local57].anInt6551 * local34 + this.aClass234Array1[local57].anInt6552 * local38 >> 15;
						this.aClass234Array1[local57].anInt6551 = this.aClass234Array1[local57].anInt6551 * local38 - this.aClass234Array1[local57].anInt6552 * local34 >> 15;
						this.aClass234Array1[local57].anInt6552 = local166;
					}
				}
			}
			for (local57 = this.anInt980; local57 < this.anInt986; local57++) {
	...
	@OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lclient!cb;Lclient!cb;IZZ)Lclient!gn;", line = 1983)
	private Class31 method1241(@OriginalArg(0) Class31_Sub1 arg0, @OriginalArg(1) Class31_Sub1 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) boolean arg4) {
		...
		if (local81 || local91 || local105) {
			if (local81) {
				if (arg1.anIntArray68 == null || arg1.anIntArray68.length < this.anInt986) {
					arg0.anIntArray68 = arg1.anIntArray68 = new int[this.anInt986];
				} else {
			...
			if (local91) {
				if (arg1.anIntArray56 == null || arg1.anIntArray56.length < this.anInt986) {
					arg0.anIntArray56 = arg1.anIntArray56 = new int[this.anInt986];
				} else {
			...
			if (local105) {
				if (arg1.anIntArray47 == null || arg1.anIntArray47.length < this.anInt986) {
					arg0.anIntArray47 = arg1.anIntArray47 = new int[this.anInt986];
				} else {
		...
		if ((arg2 & 0x80) == 0 && (arg2 & 0x2000) == 0) {
			...
			if (arg1.aShortArray7 == null || arg1.aShortArray7.length < this.anInt985) {
				local137 = this.anInt985;
				arg0.aShortArray7 = arg1.aShortArray7 = new short[local137];
			} else {
				arg0.aShortArray7 = arg1.aShortArray7;
			}
			for (local137 = 0; local137 < this.anInt985; local137++) {
				arg0.aShortArray7[local137] = this.aShortArray7[local137];
			}
		}
		if ((arg2 & 0xBA18) != 0) {
			arg0.anInt978 = 0;
			...
			arg0.anInt978 = this.anInt978;
		} else {
			if (arg4) {
				this.method1257(false);
			}
			if (this.anIntArray76 != null) {
				if (arg1.anIntArray76 == null || arg1.anIntArray76.length < this.anInt985) {
					local137 = this.anInt985;
		...
		if ((arg2 & 0x100) == 0) {
			...
			if (arg1.aByteArray11 == null || arg1.aByteArray11.length < this.anInt985) {
				local137 = this.anInt985;
		...
		if ((arg2 & 0x8) == 0 && (arg2 & 0x10) == 0) {
			...
			if (arg1.aClass26Array2 == null || arg1.aClass26Array2.length < this.anInt980) {
				local137 = this.anInt980;
			...
			if (this.aClass26Array2 == null) {
				...
				for (local137 = 0; local137 < this.anInt980; local137++) {
			...
			if (this.aClass234Array1 == null) {
				...
				if (arg1.aClass234Array1 == null || arg1.aClass234Array1.length < this.anInt985) {
					local137 = this.anInt985;
		...
		} else if (this.aShortArray10 == null) {
			arg0.aShortArray10 = null;
		} else {
			if (arg1.aShortArray10 == null || arg1.aShortArray10.length < this.anInt985) {
				local137 = this.anInt985;
				arg0.aShortArray10 = arg1.aShortArray10 = new short[local137];
			} else {
				arg0.aShortArray10 = arg1.aShortArray10;
			}
			for (local137 = 0; local137 < this.anInt985; local137++) {
				arg0.aShortArray10[local137] = this.aShortArray10[local137];
			}
		}
		if ((arg2 & 0x8000) == 0) {
			...
			if (arg1.aByteArray10 == null || arg1.aByteArray10.length < this.anInt985) {
				local137 = arg3 ? this.anInt985 + 100 : this.anInt985;
	...
	protected void method3822(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6) {
		...
		if (arg0 == 0) {
			...
			local16 = arg4 << 4;
			if (!this.aBoolean77) {
				for (local21 = 0; local21 < this.anInt986; local21++) {
			...
			for (local67 = 0; local67 < local2; local67++) {
				...
				if (local72 < this.anIntArrayArray10.length) {
					...
					for (local84 = 0; local84 < local82.length; local84++) {
						...
						this.anInt988 += this.anIntArray68[local89];
						this.anInt984 += this.anIntArray56[local89];
						this.anInt989 += this.anIntArray47[local89];
						local21++;
					}
				}
			}
			if (local21 > 0) {
				this.anInt988 = this.anInt988 / local21 + local8;
				this.anInt984 = this.anInt984 / local21 + local12;
				this.anInt989 = this.anInt989 / local21 + local16;
			} else {
				this.anInt988 = local8;
		...
		if (arg0 == 2) {
			for (local21 = 0; local21 < local2; local21++) {
				...
				if (local67 < this.anIntArrayArray10.length) {
					...
					if ((arg5 & 0x1) == 0) {
						for (local235 = 0; local235 < local233.length; local235++) {
							local84 = local233[local235];
							this.anIntArray68[local84] -= this.anInt988;
							this.anIntArray56[local84] -= this.anInt984;
							this.anIntArray47[local84] -= this.anInt989;
							if (arg4 != 0) {
			...
			for (local21 = 0; local21 < local2; local21++) {
				...
				if (local67 < this.anIntArrayArray12.length) {
					...
					for (local235 = 0; local235 < local233.length; local235++) {
						local84 = local233[local235];
						local89 = this.aShortArray7[local84] & 0xFFFF;
						...
						this.aShortArray7[local84] = (short) (local1016 << 10 | local360 << 7 | local1010);
					}
	...
	private void method1242(@OriginalArg(0) Thread arg0) {
		@Pc(4) Class250 local4 = this.aClass19_Sub2_3.method2907(arg0);
	...
	protected void method3835(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int[] arg7) {
		...
		if (arg0 == 0) {
			...
			for (local67 = 0; local67 < local2; local67++) {
				...
				if (local72 < this.anIntArrayArray10.length) {
					...
					for (local84 = 0; local84 < local82.length; local84++) {
						local89 = local82[local84];
						if (this.lb == null || (arg6 & this.lb[local89]) != 0) {
							this.anInt988 += this.anIntArray68[local89];
							this.anInt984 += this.anIntArray56[local89];
							this.anInt989 += this.anIntArray47[local89];
							local21++;
			...
			if (local21 > 0) {
				this.anInt988 = this.anInt988 / local21 + arg2;
				this.anInt984 = this.anInt984 / local21 + arg3;
				this.anInt989 = this.anInt989 / local21 + arg4;
			...
			for (local21 = 0; local21 < local2; local21++) {
				...
				if (local67 < this.anIntArrayArray10.length) {
					...
					for (local322 = 0; local322 < local320.length; local322++) {
						...
						if (this.lb == null || (arg6 & this.lb[local84]) != 0) {
		...
		if (arg0 == 2) {
			if (arg7 == null) {
				...
				local89 = arg7[14] << 4;
				if (this.aBoolean81) {
					local478 = arg7[0] * this.anInt988 + arg7[3] * this.anInt984 + arg7[6] * this.anInt989 + 16384 >> 15;
					local503 = arg7[1] * this.anInt988 + arg7[4] * this.anInt984 + arg7[7] * this.anInt989 + 16384 >> 15;
					local528 = arg7[2] * this.anInt988 + arg7[5] * this.anInt984 + arg7[8] * this.anInt989 + 16384 >> 15;
					local478 += local322;
					local503 += local84;
					local528 += local89;
					this.anInt988 = local478;
					this.anInt984 = local503;
					this.anInt989 = local528;
				...
				@Pc(726) int local726 = local555[0] * -this.anInt988 + local555[1] * -this.anInt984 + local555[2] * -this.anInt989 + 16384 >> 15;
				local754 = local555[3] * -this.anInt988 + local555[4] * -this.anInt984 + local555[5] * -this.anInt989 + 16384 >> 15;
				local782 = local555[6] * -this.anInt988 + local555[7] * -this.anInt984 + local555[8] * -this.anInt989 + 16384 >> 15;
				local787 = local726 + this.anInt988;
				@Pc(792) int local792 = local754 + this.anInt984;
				local797 = local782 + this.anInt989;
				...
				for (local1067 = 0; local1067 < local2; local1067++) {
					...
					if (local1072 < this.anIntArrayArray10.length) {
						...
						for (@Pc(1084) int local1084 = 0; local1084 < local1082.length; local1084++) {
							...
							if (this.lb == null || (arg6 & this.lb[local1089]) != 0) {
			...
			if (arg7 == null) {
				...
				local503 = arg3 << 15 >> 7;
				local528 = arg4 << 15 >> 7;
				local567 = local478 * -this.anInt988 + 16384 >> 15;
				local571 = local503 * -this.anInt984 + 16384 >> 15;
				local575 = local528 * -this.anInt989 + 16384 >> 15;
				local579 = local567 + this.anInt988;
				local587 = local571 + this.anInt984;
				local595 = local575 + this.anInt989;
				...
				for (local808 = 0; local808 < local2; local808++) {
					...
					if (local810 < this.anIntArrayArray10.length) {
						...
						for (local936 = 0; local936 < local934.length; local936++) {
							...
							if (this.lb == null || (arg6 & this.lb[local939]) != 0) {
			...
			if (this.anIntArrayArray12 != null && this.aByteArray11 != null) {
				for (local21 = 0; local21 < local2; local21++) {
					...
					if (local67 < this.anIntArrayArray12.length) {
						...
						for (local322 = 0; local322 < local320.length; local322++) {
							local84 = local320[local322];
							if (this.aShortArray8 == null || (arg6 & this.aShortArray8[local84]) != 0) {
								local89 = (this.aByteArray11[local84] & 0xFF) + arg2 * 8;
								if (local89 < 0) {
									local89 = 0;
								} else if (local89 > 255) {
				...
				if (local67 < this.anIntArrayArray12.length) {
					...
					for (local322 = 0; local322 < local320.length; local322++) {
						...
						if (this.aShortArray8 == null || (arg6 & this.aShortArray8[local84]) != 0) {
							...
							this.aShortArray7[local84] = (short) (local2461 << 10 | local503 << 7 | local528);
						}
					}
					this.aBoolean80 = true;
				}
	...
	private void method1248() {
		for (@Pc(1) int local1 = 0; local1 < this.anInt980; local1++) {
			this.anIntArray68[local1] = -this.anIntArray68[local1];
			this.anIntArray47[local1] = -this.anIntArray47[local1];
		...
		if (this.aClass234Array1 != null) {
			for (local57 = 0; local57 < this.anInt985; local57++) {
				if (this.aClass234Array1[local57] != null) {
					this.aClass234Array1[local57].anInt6552 = -this.aClass234Array1[local57].anInt6552;
					this.aClass234Array1[local57].anInt6551 = -this.aClass234Array1[local57].anInt6551;
				}
			}
		}
		for (local57 = this.anInt980; local57 < this.anInt986; local57++) {
	...
	public void method3834(@OriginalArg(0) int arg0) {
		if ((this.anInt983 & 0x5) != 5) {
			...
			for (@Pc(37) int local37 = 0; local37 < this.anInt986; local37++) {
	...
	public void method3814(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg0 != 0 && (this.anInt983 & 0x1) != 1) {
			throw new IllegalStateException();
		} else if (arg1 != 0 && (this.anInt983 & 0x2) != 2) {
			throw new IllegalStateException();
		} else if (arg2 == 0 || (this.anInt983 & 0x4) == 4) {
			for (@Pc(37) int local37 = 0; local37 < this.anInt986; local37++) {
	...
	protected void method3826(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		if (arg0 == 0) {
			...
			this.anInt984 = 0;
			this.anInt989 = 0;
			for (local14 = 0; local14 < this.anInt986; local14++) {
				this.anInt988 += this.anIntArray68[local14];
				this.anInt984 += this.anIntArray56[local14];
				this.anInt989 += this.anIntArray47[local14];
				local3++;
			}
			if (local3 > 0) {
				this.anInt988 = this.anInt988 / local3 + arg1;
				this.anInt984 = this.anInt984 / local3 + arg2;
				this.anInt989 = this.anInt989 / local3 + arg3;
			} else {
				this.anInt988 = arg1;
				this.anInt984 = arg2;
				this.anInt989 = arg3;
			...
			if (arg0 == 2) {
				for (local3 = 0; local3 < this.anInt986; local3++) {
					this.anIntArray68[local3] -= this.anInt988;
					this.anIntArray56[local3] -= this.anInt984;
					this.anIntArray47[local3] -= this.anInt989;
					if (arg3 != 0) {
				...
				for (local3 = 0; local3 < this.anInt985; local3++) {
				...
				for (local3 = 0; local3 < this.anInt985; local3++) {
					local14 = this.aShortArray7[local3] & 0xFFFF;
					...
					this.aShortArray7[local3] = (short) (local525 << 10 | local182 << 7 | local519);
				}
				this.aBoolean80 = true;
			}
		}
	...
	@OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lclient!gn;IIIZ)V", line = 4015)
	@Override
	public void method3804(@OriginalArg(0) Class31 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		...
		if ((this.anInt983 & 0x8000) != 32768) {
			throw new IllegalStateException("");
		} else if ((local2.anInt983 & 0x8000) == 32768) {
			this.method1242(Thread.currentThread());
			this.method1251();
			this.method1252();
			local2.method1251();
			...
			@Pc(47) int local47 = local2.anInt980;
			@Pc(65) int local65;
			for (@Pc(49) int local49 = 0; local49 < this.anInt980; local49++) {
								...
								for (@Pc(108) int local108 = 0; local108 < local47; local108++) {
									...
									if (local81 == local44[local108] && local97 == local2.anIntArray47[local108] && local65 == local2.anIntArray56[local108] && local114.anInt732 != 0) {
										if (this.aClass26Array1 == null) {
											this.aClass26Array1 = new Class26[this.anInt980];
										}
										...
										local41++;
										this.anIntArray57[local49] = anInt987;
										this.anIntArray53[local108] = anInt987;
									}
								}
							}
						}
			...
			if (local41 >= 3 && arg4) {
				for (@Pc(267) int local267 = 0; local267 < this.anInt985; local267++) {
					if (this.anIntArray57[this.aShortArray9[local267]] == anInt987 && this.anIntArray57[this.aShortArray5[local267]] == anInt987 && this.anIntArray57[this.aShortArray6[local267]] == anInt987) {
						if (this.aByteArray10 == null) {
							this.aByteArray10 = new byte[this.anInt985];
						}
						this.aByteArray10[local267] = 2;
					}
				}
				for (local65 = 0; local65 < local2.anInt985; local65++) {
					if (this.anIntArray53[local2.aShortArray9[local65]] == anInt987 && this.anIntArray53[local2.aShortArray5[local65]] == anInt987 && this.anIntArray53[local2.aShortArray6[local65]] == anInt987) {
						if (local2.aByteArray10 == null) {
							local2.aByteArray10 = new byte[local2.anInt985];
						}
	...
	@OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lclient!on;Lclient!au;Lclient!tp;I)V", line = 4142)
	...
	private void method1250(@OriginalArg(0) int arg0) {
		...
		@Pc(13) short local13 = this.aShortArray9[arg0];
		@Pc(18) short local18 = this.aShortArray5[arg0];
		@Pc(23) short local23 = this.aShortArray6[arg0];
		this.aClass81_1.aBoolean169 = this.aBooleanArray8[arg0];
		if (this.aByteArray11 == null) {
			this.aClass81_1.anInt2261 = 0;
		} else {
			this.aClass81_1.anInt2261 = this.aByteArray11[arg0] & 0xFF;
		...
		if (this.aShortArray10 != null && this.aShortArray10[arg0] != -1) {
			...
			if (this.anIntArray52[arg0] == -1) {
				this.aClass81_1.method2290(this.anIntArray63[local13], this.anIntArray63[local18], this.anIntArray63[local23], this.anIntArray60[local13], this.anIntArray60[local18], this.anIntArray60[local23], this.anIntArray76[arg0], this.anIntArray76[arg0], this.anIntArray76[arg0], this.anIntArray51[local165], this.anIntArray51[local170], this.anIntArray51[local175], this.anIntArray64[local165], this.anIntArray64[local170], this.anIntArray64[local175], this.anIntArray61[local165], this.anIntArray61[local170], this.anIntArray61[local175], this.aShortArray10[arg0]);
			} else {
				this.aClass81_1.method2290(this.anIntArray63[local13], this.anIntArray63[local18], this.anIntArray63[local23], this.anIntArray60[local13], this.anIntArray60[local18], this.anIntArray60[local23], this.anIntArray76[arg0], this.anIntArray74[arg0], this.anIntArray52[arg0], this.anIntArray51[local165], this.anIntArray51[local170], this.anIntArray51[local175], this.anIntArray64[local165], this.anIntArray64[local170], this.anIntArray64[local175], this.anIntArray61[local165], this.anIntArray61[local170], this.anIntArray61[local175], this.aShortArray10[arg0]);
			}
		} else if (this.anIntArray52[arg0] == -1) {
			this.aClass81_1.method2284(this.anIntArray63[local13], this.anIntArray63[local18], this.anIntArray63[local23], this.anIntArray60[local13], this.anIntArray60[local18], this.anIntArray60[local23], Static169.anIntArray204[this.anIntArray76[arg0] & 0xFFFF]);
		} else {
			this.aClass81_1.method2288(this.anIntArray63[local13], this.anIntArray63[local18], this.anIntArray63[local23], this.anIntArray60[local13], this.anIntArray60[local18], this.anIntArray60[local23], this.anIntArray76[arg0] & 0xFFFF, this.anIntArray74[arg0] & 0xFFFF, this.anIntArray52[arg0] & 0xFFFF);
		}
	}
	...
	private void method1251() {
		...
		for (@Pc(21) int local21 = 0; local21 < this.anInt980; local21++) {
	...
	public void method3843(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg0 != 128 && (this.anInt983 & 0x1) != 1) {
			throw new IllegalStateException();
		} else if (arg1 != 128 && (this.anInt983 & 0x2) != 2) {
			throw new IllegalStateException();
		} else if (arg2 == 128 || (this.anInt983 & 0x4) == 4) {
			for (@Pc(40) int local40 = 0; local40 < this.anInt986; local40++) {
	...
	@OriginalMember(owner = "client!cb", name = "a", descriptor = "(IILclient!tf;Lclient!tf;III)V", line = 4351)
	@Override
	public void method3820(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class6 arg2, @OriginalArg(3) Class6 arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		if (arg0 == 3) {
			if ((this.anInt983 & 0x7) != 7) {
				throw new IllegalStateException();
			}
		} else if ((this.anInt983 & 0x2) != 2) {
			throw new IllegalStateException();
		}
		if (!this.aBoolean79) {
			this.method1251();
		...
		if (arg0 != 4 && (local32 < 0 || local37 + 128 >> 7 >= arg2.anInt6308 || local42 < 0 || local47 + 128 >> 7 >= arg2.anInt6307)) {
			return;
		}
		...
		if (arg0 == 4 || arg0 == 5) {
			...
			if (local32 < 0 || local37 + 128 >> 7 >= arg3.anInt6308 || local42 < 0 || local47 + 128 >> 7 >= arg3.anInt6307) {
				return;
			}
		} else {
			local32 >>= 0x7;
		...
		@Pc(388) int local388;
		if (arg0 == 1) {
			for (local167 = 0; local167 < this.anInt980; local167++) {
			...
			for (local175 = this.anInt980; local175 < this.anInt986; local175++) {
			...
			if (arg0 == 2) {
				...
				for (local175 = this.anInt980; local175 < this.anInt986; local175++) {
					...
					if (local182 < arg1) {
						...
						local220 = local186 >> 7;
						local246 = local190 >> 7;
						if (local220 >= 0 && local220 < arg2.anInt6308 - 1 && local246 >= 0 && local246 < arg2.anInt6307 - 1) {
				...
				if (arg4 - (local167 >> 1) < 0 || arg4 + (local167 >> 1) + 128 >= arg2.anInt6308 || arg6 - (local175 >> 1) < 0 || arg6 + (local175 >> 1) + 128 >= arg2.anInt6307) {
					return;
				}
				this.method3849(local167, arg6, local175, arg5, arg2, arg4);
			} else if (arg0 == 4) {
				local167 = this.aShort6 - this.aShort2;
				for (local175 = 0; local175 < this.anInt980; local175++) {
					local182 = this.anIntArray68[local175] + arg4;
					local186 = this.anIntArray47[local175] + arg6;
					local190 = local182 & 0x7F;
					local194 = local186 & 0x7F;
				...
				for (local182 = this.anInt980; local182 < this.anInt986; local182++) {
					...
					local220 = local186 >> 7;
					local246 = local190 >> 7;
					if (local220 >= 0 && local220 < arg3.anInt6308 - 1 && local246 >= 0 && local246 < arg3.anInt6307 - 1) {
				...
				for (local182 = this.anInt980; local182 < this.anInt986; local182++) {
					...
					local220 = local186 >> 7;
					local246 = local190 >> 7;
					if (local220 >= 0 && local220 < arg2.anInt6308 - 1 && local220 < arg3.anInt6308 - 1 && local246 >= 0 && local246 < arg2.anInt6307 - 1 && local246 < arg3.anInt6307 - 1) {
						local258 = local75[local220][local246] * (128 - local194) + local75[local220 + 1][local246] * local194 >> 7;
						local388 = local75[local220][local246 + 1] * (128 - local194) + local75[local220 + 1][local246 + 1] * local194 >> 7;
						local671 = local258 * (128 - local198) + local388 * local198 >> 7;
						local258 = local77[local220][local246] * (128 - local194) + local77[local220 + 1][local246] * local194 >> 7;
	...
	@OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lclient!kb;)Lclient!kb;", line = 4702)
	@Override
	public Class2_Sub2_Sub4 method3840(@OriginalArg(0) Class2_Sub2_Sub4 arg0) {
		return null;
	}

	@OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lclient!on;Lclient!au;I)V", line = 4707)
	@Override
	...
	private void method1252() {
		if (this.anInt978 != 0 || this.aClass26Array2 != null) {
			return;
		}
		this.aClass26Array2 = new Class26[this.anInt980];
		for (@Pc(13) int local13 = 0; local13 < this.anInt980; local13++) {
			this.aClass26Array2[local13] = new Class26();
		}
		for (@Pc(28) int local28 = 0; local28 < this.anInt985; local28++) {
			@Pc(34) short local34 = this.aShortArray9[local28];
			...
			if (local201 == 0) {
				...
				if (this.aClass234Array1 == null) {
					this.aClass234Array1 = new Class234[this.anInt985];
				}
				@Pc(317) Class234 local317 = this.aClass234Array1[local28] = new Class234();
				local317.anInt6552 = local112;
				local317.anInt6550 = local120;
				local317.anInt6551 = local128;
			}
		}
	}

	@OriginalMember(owner = "client!cb", name = "a", descriptor = "(IILclient!on;Z)Z", line = 4812)
	@Override
	public boolean method3821(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class14 arg2, @OriginalArg(3) boolean arg3) {
		...
		@Pc(298) int local298 = this.aClass19_Sub2_3.anInt2852;
		@Pc(302) int local302 = this.aClass19_Sub2_3.anInt2857;
		@Pc(306) int local306 = this.aClass19_Sub2_3.anInt2848;
		@Pc(310) int local310 = this.aClass19_Sub2_3.anInt2838;
		...
		for (@Pc(472) int local472 = 0; local472 < 8; local472++) {
			...
			if (local536 >= this.aClass19_Sub2_3.anInt2840) {
		...
		if (local294 && arg0 > local312 && arg0 < local314 && arg1 > local316 && arg1 < local318) {
			...
			for (local549 = 0; local549 < this.anInt986; local549++) {
			...
			for (local557 = 0; local557 < this.anInt985; local557++) {
				if (this.anIntArray60[this.aShortArray9[local557]] != -999999 && this.anIntArray60[this.aShortArray5[local557]] != -999999 && this.anIntArray60[this.aShortArray6[local557]] != -999999 && this.method1243(arg0, arg1, this.anIntArray63[this.aShortArray9[local557]], this.anIntArray63[this.aShortArray5[local557]], this.anIntArray63[this.aShortArray6[local557]], this.anIntArray60[this.aShortArray9[local557]], this.anIntArray60[this.aShortArray5[local557]], this.anIntArray60[this.aShortArray6[local557]])) {
					return true;
				}
			}
		}
	...
	private void method1253(@OriginalArg(0) int arg0) {
		...
		@Pc(319) int local319;
		if (!this.aClass19_Sub2_3.aBoolean199) {
			local8 = this.aShortArray9[arg0];
			local13 = this.aShortArray5[arg0];
			local18 = this.aShortArray6[arg0];
			local27 = this.anIntArray67[local8] - this.aClass19_Sub2_3.anInt2864;
			if (local27 > 255) {
				local27 = 255;
			} else if (local27 < 0) {
				local27 = 0;
			}
			local46 = this.anIntArray67[local13] - this.aClass19_Sub2_3.anInt2864;
			if (local46 > 255) {
				local46 = 255;
			} else if (local46 < 0) {
				local46 = 0;
			}
			local65 = this.anIntArray67[local18] - this.aClass19_Sub2_3.anInt2864;
			if (local65 > 255) {
				local65 = 255;
			} else if (local65 < 0) {
				local65 = 0;
			...
			if (local81 != 765) {
				if (local81 == 0) {
					...
					if (this.aShortArray10 != null && this.aShortArray10[arg0] != -1) {
						...
						if (this.anIntArray52[arg0] == -1) {
							this.aClass81_1.method2282(this.anIntArray63[local8], this.anIntArray63[local13], this.anIntArray63[local18], this.anIntArray60[local8], this.anIntArray60[local13], this.anIntArray60[local18], this.aClass19_Sub2_3.anInt2850, local27, local46, local65, this.anIntArray76[arg0], this.anIntArray76[arg0], this.anIntArray76[arg0], this.anIntArray51[local309], this.anIntArray51[local314], this.anIntArray51[local319], this.anIntArray64[local309], this.anIntArray64[local314], this.anIntArray64[local319], this.anIntArray61[local309], this.anIntArray61[local314], this.anIntArray61[local319], this.aShortArray10[arg0]);
						} else {
							this.aClass81_1.method2282(this.anIntArray63[local8], this.anIntArray63[local13], this.anIntArray63[local18], this.anIntArray60[local8], this.anIntArray60[local13], this.anIntArray60[local18], this.aClass19_Sub2_3.anInt2850, local27, local46, local65, this.anIntArray76[arg0], this.anIntArray74[arg0], this.anIntArray52[arg0], this.anIntArray51[local309], this.anIntArray51[local314], this.anIntArray51[local319], this.anIntArray64[local309], this.anIntArray64[local314], this.anIntArray64[local319], this.anIntArray61[local309], this.anIntArray61[local314], this.anIntArray61[local319], this.aShortArray10[arg0]);
						}
					} else if (this.anIntArray52[arg0] == -1) {
						this.aClass81_1.method2291(this.anIntArray63[local8], this.anIntArray63[local13], this.anIntArray63[local18], this.anIntArray60[local8], this.anIntArray60[local13], this.anIntArray60[local18], Static214.method4025(Static169.anIntArray204[this.anIntArray76[arg0] & 0xFFFF], local27 << 24 | this.aClass19_Sub2_3.anInt2850), Static214.method4025(Static169.anIntArray204[this.anIntArray76[arg0] & 0xFFFF], local46 << 24 | this.aClass19_Sub2_3.anInt2850), Static214.method4025(Static169.anIntArray204[this.anIntArray76[arg0] & 0xFFFF], local65 << 24 | this.aClass19_Sub2_3.anInt2850));
					} else {
						this.aClass81_1.method2291(this.anIntArray63[local8], this.anIntArray63[local13], this.anIntArray63[local18], this.anIntArray60[local8], this.anIntArray60[local13], this.anIntArray60[local18], Static214.method4025(Static169.anIntArray204[this.anIntArray76[arg0] & 0xFFFF], local27 << 24 | this.aClass19_Sub2_3.anInt2850), Static214.method4025(Static169.anIntArray204[this.anIntArray74[arg0] & 0xFFFF], local46 << 24 | this.aClass19_Sub2_3.anInt2850), Static214.method4025(Static169.anIntArray204[this.anIntArray52[arg0] & 0xFFFF], local65 << 24 | this.aClass19_Sub2_3.anInt2850));
					}
				}
			}
			...
			local46 = 0;
			local65 = 0;
			if (this.anIntArray54[local8] > this.aClass19_Sub2_3.anInt2867) {
				local27 = 255;
			} else if (this.anIntArray54[local8] > this.aClass19_Sub2_3.anInt2863) {
				local27 = (this.aClass19_Sub2_3.anInt2863 - this.anIntArray54[local8]) * 255 / (this.aClass19_Sub2_3.anInt2863 - this.aClass19_Sub2_3.anInt2867);
			}
			if (this.anIntArray54[local13] > this.aClass19_Sub2_3.anInt2867) {
				local46 = 255;
			} else if (this.anIntArray54[local13] > this.aClass19_Sub2_3.anInt2863) {
				local46 = (this.aClass19_Sub2_3.anInt2863 - this.anIntArray54[local13]) * 255 / (this.aClass19_Sub2_3.anInt2863 - this.aClass19_Sub2_3.anInt2867);
			}
			if (this.anIntArray54[local18] > this.aClass19_Sub2_3.anInt2867) {
				local65 = 255;
			} else if (this.anIntArray54[local18] > this.aClass19_Sub2_3.anInt2863) {
				local65 = (this.aClass19_Sub2_3.anInt2863 - this.anIntArray54[local18]) * 255 / (this.aClass19_Sub2_3.anInt2863 - this.aClass19_Sub2_3.anInt2867);
			}
			if (this.aByteArray11 == null) {
				this.aClass81_1.anInt2261 = 0;
			} else {
			...
			if (this.aShortArray10 != null && this.aShortArray10[arg0] != -1) {
				...
				if (this.anIntArray52[arg0] == -1) {
					this.aClass81_1.method2282(this.anIntArray63[local8], this.anIntArray63[local13], this.anIntArray63[local18], this.anIntArray60[local8], this.anIntArray60[local13], this.anIntArray60[local18], this.aClass19_Sub2_3.anInt2850, local27, local46, local65, this.anIntArray76[arg0], this.anIntArray76[arg0], this.anIntArray76[arg0], this.anIntArray51[local81], this.anIntArray51[local309], this.anIntArray51[local314], this.anIntArray64[local81], this.anIntArray64[local309], this.anIntArray64[local314], this.anIntArray61[local81], this.anIntArray61[local309], this.anIntArray61[local314], this.aShortArray10[arg0]);
				} else {
					this.aClass81_1.method2282(this.anIntArray63[local8], this.anIntArray63[local13], this.anIntArray63[local18], this.anIntArray60[local8], this.anIntArray60[local13], this.anIntArray60[local18], this.aClass19_Sub2_3.anInt2850, local27, local46, local65, this.anIntArray76[arg0], this.anIntArray74[arg0], this.anIntArray52[arg0], this.anIntArray51[local81], this.anIntArray51[local309], this.anIntArray51[local314], this.anIntArray64[local81], this.anIntArray64[local309], this.anIntArray64[local314], this.anIntArray61[local81], this.anIntArray61[local309], this.anIntArray61[local314], this.aShortArray10[arg0]);
				}
			} else if (this.anIntArray52[arg0] == -1) {
				this.aClass81_1.method2291(this.anIntArray63[local8], this.anIntArray63[local13], this.anIntArray63[local18], this.anIntArray60[local8], this.anIntArray60[local13], this.anIntArray60[local18], Static214.method4025(Static169.anIntArray204[this.anIntArray76[arg0] & 0xFFFF], local27 << 24 | this.aClass19_Sub2_3.anInt2850), Static214.method4025(Static169.anIntArray204[this.anIntArray76[arg0] & 0xFFFF], local46 << 24 | this.aClass19_Sub2_3.anInt2850), Static214.method4025(Static169.anIntArray204[this.anIntArray76[arg0] & 0xFFFF], local65 << 24 | this.aClass19_Sub2_3.anInt2850));
			} else {
	...
	public void method3817(@OriginalArg(0) short arg0, @OriginalArg(1) short arg1) {
		...
		for (@Pc(5) int local5 = 0; local5 < this.anInt985; local5++) {
	...
	@OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lclient!ba;)V", line = 5189)
	private void method1254(@OriginalArg(0) Class14_Sub1 arg0) {
		...
		if (this.aClass114Array1 != null) {
			for (local4 = 0; local4 < this.aClass114Array1.length; local4++) {
				...
				local12.anInt2916 = arg0.anInt498 + (arg0.anInt505 * this.anIntArray68[local10.anInt2915] + arg0.anInt500 * this.anIntArray56[local10.anInt2915] + arg0.anInt497 * this.anIntArray47[local10.anInt2915] >> 15);
				local12.anInt2913 = arg0.anInt496 + (arg0.anInt507 * this.anIntArray68[local10.anInt2915] + arg0.anInt506 * this.anIntArray56[local10.anInt2915] + arg0.anInt499 * this.anIntArray47[local10.anInt2915] >> 15);
				local12.anInt2919 = arg0.anInt501 + (arg0.anInt504 * this.anIntArray68[local10.anInt2915] + arg0.anInt502 * this.anIntArray56[local10.anInt2915] + arg0.anInt503 * this.anIntArray47[local10.anInt2915] >> 15);
				local12.anInt2922 = arg0.anInt498 + (arg0.anInt505 * this.anIntArray68[local10.anInt2923] + arg0.anInt500 * this.anIntArray56[local10.anInt2923] + arg0.anInt497 * this.anIntArray47[local10.anInt2923] >> 15);
				local12.anInt2925 = arg0.anInt496 + (arg0.anInt507 * this.anIntArray68[local10.anInt2923] + arg0.anInt506 * this.anIntArray56[local10.anInt2923] + arg0.anInt499 * this.anIntArray47[local10.anInt2923] >> 15);
				local12.anInt2926 = arg0.anInt501 + (arg0.anInt504 * this.anIntArray68[local10.anInt2923] + arg0.anInt502 * this.anIntArray56[local10.anInt2923] + arg0.anInt503 * this.anIntArray47[local10.anInt2923] >> 15);
				local12.anInt2921 = arg0.anInt498 + (arg0.anInt505 * this.anIntArray68[local10.anInt2917] + arg0.anInt500 * this.anIntArray56[local10.anInt2917] + arg0.anInt497 * this.anIntArray47[local10.anInt2917] >> 15);
				local12.anInt2912 = arg0.anInt496 + (arg0.anInt507 * this.anIntArray68[local10.anInt2917] + arg0.anInt506 * this.anIntArray56[local10.anInt2917] + arg0.anInt499 * this.anIntArray47[local10.anInt2917] >> 15);
				local12.anInt2918 = arg0.anInt501 + (arg0.anInt504 * this.anIntArray68[local10.anInt2917] + arg0.anInt502 * this.anIntArray56[local10.anInt2917] + arg0.anInt503 * this.anIntArray47[local10.anInt2917] >> 15);
			}
		}
		...
		for (local4 = 0; local4 < this.aClass163Array1.length; local4++) {
			...
			if (local332.aClass14_5 == null) {
				...
				local332.aClass14_5.method3925(arg0);
			}
			local334.anInt4322 = arg0.anInt498 + (arg0.anInt505 * this.anIntArray68[local332.anInt4326] + arg0.anInt500 * this.anIntArray56[local332.anInt4326] + arg0.anInt497 * this.anIntArray47[local332.anInt4326] >> 15);
			local334.anInt4328 = arg0.anInt496 + (arg0.anInt507 * this.anIntArray68[local332.anInt4326] + arg0.anInt506 * this.anIntArray56[local332.anInt4326] + arg0.anInt499 * this.anIntArray47[local332.anInt4326] >> 15);
			local334.anInt4330 = arg0.anInt501 + (arg0.anInt504 * this.anIntArray68[local332.anInt4326] + arg0.anInt502 * this.anIntArray56[local332.anInt4326] + arg0.anInt503 * this.anIntArray47[local332.anInt4326] >> 15);
		}
	}
		...
		if (this.aClass234Array1 != null) {
			for (local7 = 0; local7 < this.anInt985; local7++) {
				if (this.aClass234Array1[local7] != null) {
					local71 = this.aClass234Array1[local7].anInt6552;
					this.aClass234Array1[local7].anInt6552 = this.aClass234Array1[local7].anInt6551;
					this.aClass234Array1[local7].anInt6551 = -local71;
				}
			}
		}
		for (local7 = this.anInt980; local7 < this.anInt986; local7++) {
	...
	@OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lclient!on;Lclient!au;II)V", line = 5305)
	@Override
	...
	private void method1256() {
		...
		if (this.aClass234Array1 != null) {
			for (local7 = 0; local7 < this.anInt985; local7++) {
				if (this.aClass234Array1[local7] != null) {
					local71 = this.aClass234Array1[local7].anInt6551;
					this.aClass234Array1[local7].anInt6551 = this.aClass234Array1[local7].anInt6552;
					this.aClass234Array1[local7].anInt6552 = -local71;
				}
			}
		}
		for (local7 = this.anInt980; local7 < this.anInt986; local7++) {
	...
	private void method1257(@OriginalArg(0) boolean arg0) {
		synchronized (this) {
			if (this.anInt978 == 1) {
				...
				this.method1252();
				@Pc(38) int local38 = this.aClass19_Sub2_3.anInt2842;
				@Pc(42) int local42 = this.aClass19_Sub2_3.anInt2837;
				@Pc(46) int local46 = this.aClass19_Sub2_3.anInt2847;
				@Pc(52) int local52 = this.aClass19_Sub2_3.anInt2849 >> 8;
				@Pc(61) int local61 = this.aClass19_Sub2_3.anInt2855 * 768 / this.anInt982;
				@Pc(70) int local70 = this.aClass19_Sub2_3.anInt2839 * 768 / this.anInt982;
				if (this.anIntArray76 == null) {
					this.anIntArray76 = new int[this.anInt985];
					this.anIntArray74 = new int[this.anInt985];
					this.anIntArray52 = new int[this.anInt985];
				}
				for (@Pc(90) int local90 = 0; local90 < this.anInt985; local90++) {
					@Pc(96) byte local96;
					if (this.aByteArray10 == null) {
						local96 = 0;
					} else {
					...
					if (this.aShortArray10 == null) {
						...
						local118 = this.aShortArray10[local90];
					}
					if (local107 == -2) {
						local96 = 3;
					}
					...
					if (local118 == -1) {
						...
						if (local96 == 0) {
							local146 = this.aShortArray7[local90] & 0xFFFF;
							local155 = (local146 & 0x7F) * this.anInt981 >> 7;
							local163 = Static25.method863(local146 & 0xFFFFFF80 | local155);
							@Pc(182) Class26 local182;
							if (this.aClass26Array1 == null || this.aClass26Array1[this.aShortArray9[local90]] == null) {
								local182 = this.aClass26Array2[this.aShortArray9[local90]];
							} else {
								local182 = this.aClass26Array1[this.aShortArray9[local90]];
							}
							...
							this.anIntArray76[local90] = local228 << 17 | Static233.method4369(local163, local228);
							...
							local218 = local211 > 256 ? local61 : local70;
							local228 = (local52 >> 1) + (local218 * local211 >> 17);
							this.anIntArray74[local90] = local228 << 17 | Static233.method4369(local163, local228);
							...
							local218 = local211 > 256 ? local61 : local70;
							local228 = (local52 >> 1) + (local218 * local211 >> 17);
							this.anIntArray52[local90] = local228 << 17 | Static233.method4369(local163, local228);
						} else if (local96 == 1) {
							local146 = this.aShortArray7[local90] & 0xFFFF;
							local155 = (local146 & 0x7F) * this.anInt981 >> 7;
							local163 = Static25.method863(local146 & 0xFFFFFF80 | local155);
							@Pc(427) Class234 local427 = this.aClass234Array1[local90];
							local228 = local38 * local427.anInt6552 + local42 * local427.anInt6550 + local46 * local427.anInt6551 >> 16;
							local211 = local228 > 256 ? local61 : local70;
							local218 = (local52 >> 1) + (local211 * local228 >> 17);
							this.anIntArray76[local90] = local218 << 17 | Static233.method4369(local163, local218);
						...
						if (local96 == 0) {
							...
							if (this.aClass26Array1 == null || this.aClass26Array1[this.aShortArray9[local90]] == null) {
								local520 = this.aClass26Array2[this.aShortArray9[local90]];
							} else {
								local520 = this.aClass26Array1[this.aShortArray9[local90]];
							}
							...
							local155 = local38 * local726.anInt6552 + local42 * local726.anInt6550 + local46 * local726.anInt6551 >> 16;
	...
	@OriginalMember(owner = "client!cb", name = "a", descriptor = "(BIZ)Lclient!gn;", line = 5617)
	@Override
	...
	public boolean method3802() {
		...
		for (@Pc(6) int local6 = 0; local6 < this.aShortArray10.length; local6++) {
			if (this.aShortArray10[local6] != -1 && !this.aClass19_Sub2_3.method2908(this.aShortArray10[local6])) {
				return false;
			}
		}
		return true;
	...
	private void method1260() {
		...
		for (@Pc(8) int local8 = 0; local8 < this.anInt985; local8++) {
			@Pc(19) short local19 = this.aShortArray10 == null ? -1 : this.aShortArray10[local8];
			if (local19 == -1) {
				@Pc(29) int local29 = this.aShortArray7[local8] & 0xFFFF;
				@Pc(38) int local38 = (local29 & 0x7F) * this.anInt981 >> 7;
				@Pc(46) short local46 = Static25.method863(local29 & 0xFFFFFF80 | local38);
				@Pc(59) int local59;
				if (this.anIntArray52[local8] == -1) {
					local59 = this.anIntArray76[local8] & 0xFFFE0000;
					this.anIntArray76[local8] = local59 | Static233.method4369(local46, local59 >> 17);
				} else if (this.anIntArray52[local8] != -2) {
					local59 = this.anIntArray76[local8] & 0xFFFE0000;
					this.anIntArray76[local8] = local59 | Static233.method4369(local46, local59 >> 17);
					local59 = this.anIntArray74[local8] & 0xFFFE0000;
					this.anIntArray74[local8] = local59 | Static233.method4369(local46, local59 >> 17);
					local59 = this.anIntArray52[local8] & 0xFFFE0000;
					this.anIntArray52[local8] = local59 | Static233.method4369(local46, local59 >> 17);
				}
			}
		}
		this.anInt978 = 2;
	...
	protected void method3837() {
		if (this.aBoolean77) {
			for (@Pc(4) int local4 = 0; local4 < this.anInt986; local4++) {
	...
	public void method3838() {
		if ((this.anInt983 & 0x10) != 16) {
			throw new IllegalStateException();
		}
		for (@Pc(11) int local11 = 0; local11 < this.anInt986; local11++) {
			this.anIntArray47[local11] = -this.anIntArray47[local11];
		}
		@Pc(31) int local31;
		if (this.aClass26Array2 != null) {
			for (local31 = 0; local31 < this.anInt980; local31++) {
		...
		if (this.aClass234Array1 != null) {
			for (local31 = 0; local31 < this.anInt985; local31++) {
				if (this.aClass234Array1[local31] != null) {
					this.aClass234Array1[local31].anInt6551 = -this.aClass234Array1[local31].anInt6551;
				}
			}
		}
		@Pc(110) short[] local110 = this.aShortArray9;
		this.aShortArray9 = this.aShortArray6;
