...
public final class Class32 {
	...
	public Class32(@OriginalArg(0) int arg0) {
		try {
			...
			signlink.reporterror("32770, " + arg0 + ", " + local27.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lclient!w;)V")
	public void method512(@OriginalArg(0) Class1_Sub1 arg0) {
	...
	public Class1_Sub1 method515() {
		try {
			...
			signlink.reporterror("43753, " + false + ", " + local24.toString());
			throw new RuntimeException();
		}
	}
