...
public final class Class32 implements ImageProducer, ImageObserver {
	...
	public void method463() {
		try {
			Class1_Sub3_Sub2.method354(this.anInt686, this.anIntArray197, this.anInt687);
		} catch (@Pc(15) RuntimeException local15) {
			signlink.reporterror("2756, " + 62 + ", " + local15.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!qb", name = "a", descriptor = "(ILjava/awt/Graphics;II)V")
	public void method464(@OriginalArg(0) int arg0, @OriginalArg(1) Graphics arg1, @OriginalArg(2) int arg2) {
		try {
			this.method465();
			arg1.drawImage(this.anImage1, arg2, arg0, this);
		} catch (@Pc(15) RuntimeException local15) {
			signlink.reporterror("13203, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + 5193 + ", " + local15.toString());
			throw new RuntimeException();
		}
	}
