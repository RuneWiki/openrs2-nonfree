...
public final class Class32 {
	...
	public Class32(@OriginalArg(0) int arg0) {
		try {
			...
			signlink.reporterror("956, " + arg0 + ", " + local27.toString());
	...
	public Class1_Sub1 method519() {
		try {
			@Pc(11) Class1_Sub1 local11 = this.aClass1_Sub1_34;
			if (local11 == this.aClass1_Sub1_33) {
				this.aClass1_Sub1_34 = null;
				return null;
			} else {
				this.aClass1_Sub1_34 = local11.aClass1_Sub1_36;
				return local11;
			}
		} catch (@Pc(27) RuntimeException local27) {
			signlink.reporterror("85154, " + true + ", " + local27.toString());
			throw new RuntimeException();
		}
	}
