...
public final class Static233 {
	...
	public static final int[] anIntArray284 = new int[4096];

	@OriginalMember(owner = "client!im", name = "a", descriptor = "(I[Ljava/lang/Object;I[II)V")
	public static void method3327(@OriginalArg(0) int arg0, @OriginalArg(1) Object[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3) {
		if (arg2 <= arg0) {
			return;
		}
		...
		for (@Pc(62) int local62 = arg0; local62 < arg2; local62++) {
			if (local29 + (local60 & local62) > arg3[local62]) {
				...
				@Pc(95) Object local95 = arg1[local62];
		...
		method3327(arg0, arg1, local25 - 1, arg3);
		method3327(local25 + 1, arg1, arg2, arg3);
	}
}
