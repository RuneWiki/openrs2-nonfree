...
public final class Class1_Sub3_Sub2_Sub1 extends Class1_Sub3_Sub2 {
	...
	public static void method287() {
		try {
			...
			signlink.reporterror("90248, " + true + ", " + local35.toString());
	...
	public static void method288(@OriginalArg(0) int arg0) {
		try {
			label29: while (true) {
				...
				for (local5 = 0; local5 < Class1_Sub3_Sub2.anInt529; local5++) {
					anIntArray139[local5] = Class1_Sub3_Sub2.anInt528 * local5;
				}
	...
	public static void method289(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			...
			signlink.reporterror("74604, " + arg0 + ", " + arg1 + ", " + 0 + ", " + local34.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method290() {
		try {
			...
			signlink.reporterror("98638, " + false + ", " + local18.toString());
			throw new RuntimeException();
		}
	}
		...
		try {
			if (anIntArrayArray12 == null) {
				...
				for (@Pc(30) int local30 = 0; local30 < 50; local30++) {
					anIntArrayArray13[local30] = null;
				}
			}
		} catch (@Pc(42) RuntimeException local42) {
			signlink.reporterror("75782, " + 20 + ", " + -20 + ", " + local42.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!gb", name = "a", descriptor = "(BLclient!ub;)V")
	public static void method292(@OriginalArg(1) Class39 arg0) {
		try {
			anInt432 = 0;
			for (@Pc(9) int local9 = 0; local9 < 50; local9++) {
				try {
					aClass1_Sub3_Sub2_Sub3Array4[local9] = new Class1_Sub3_Sub2_Sub3(arg0, String.valueOf(local9), 0);
					if (aBoolean96 && aClass1_Sub3_Sub2_Sub3Array4[local9].anInt517 == 128) {
						aClass1_Sub3_Sub2_Sub3Array4[local9].method345(aBoolean94);
					} else {
						aClass1_Sub3_Sub2_Sub3Array4[local9].method346();
					}
					anInt432++;
			...
			signlink.reporterror("24488, " + 2 + ", " + arg0 + ", " + local54.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method296(@OriginalArg(1) double arg0) {
		try {
			...
			signlink.reporterror("9701, " + true + ", " + arg0 + ", " + local355.toString());
			throw new RuntimeException();
		}
	}
	...
	private static void method299(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5) {
		...
		if (aBoolean99) {
			if (aBoolean97) {
				...
				if (arg3 > Class1_Sub3_Sub2.anInt534) {
					arg3 = Class1_Sub3_Sub2.anInt534;
				}
				if (arg2 < 0) {
					arg4 -= arg2 * local18;
					arg2 = 0;
	...
	private static void method301(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		if (aBoolean97) {
			if (arg4 > Class1_Sub3_Sub2.anInt534) {
				arg4 = Class1_Sub3_Sub2.anInt534;
			}
			if (arg3 < 0) {
				arg3 = 0;
			}
