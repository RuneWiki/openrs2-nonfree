...
public final class Class1_Sub3_Sub2_Sub1 extends Class1_Sub3_Sub2 {
	...
	@OriginalMember(owner = "client!gb", name = "O", descriptor = "[Lclient!ib;")
	...
	public static void method274(@OriginalArg(0) boolean arg0) {
		try {
			...
			signlink.reporterror("94036, " + arg0 + ", " + local31.toString());
	...
	public static void method275() {
		try {
			anIntArray139 = new int[Class1_Sub3_Sub2.anInt508];
			for (@Pc(15) int local15 = 0; local15 < Class1_Sub3_Sub2.anInt508; local15++) {
				anIntArray139[local15] = Class1_Sub3_Sub2.anInt507 * local15;
			}
			anInt409 = Class1_Sub3_Sub2.anInt507 / 2;
			anInt410 = Class1_Sub3_Sub2.anInt508 / 2;
		} catch (@Pc(37) RuntimeException local37) {
			signlink.reporterror("54322, " + 796 + ", " + local37.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!gb", name = "a", descriptor = "(ZII)V")
	public static void method276(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		try {
			anIntArray139 = new int[arg1];
			for (@Pc(8) int local8 = 0; local8 < arg1; local8++) {
				anIntArray139[local8] = arg0 * local8;
			}
			anInt409 = arg0 / 2;
			anInt410 = arg1 / 2;
		} catch (@Pc(30) RuntimeException local30) {
			signlink.reporterror("52408, " + true + ", " + arg0 + ", " + arg1 + ", " + local30.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method277() {
		try {
			...
			signlink.reporterror("17562, " + false + ", " + local26.toString());
			throw new RuntimeException();
		}
	}
	...
	public static void method278() {
		try {
			if (anIntArrayArray12 == null) {
				anInt412 = 20;
				if (aBoolean107) {
					anIntArrayArray12 = new int[anInt412][16384];
				} else {
					anIntArrayArray12 = new int[anInt412][65536];
				}
				for (@Pc(27) int local27 = 0; local27 < 50; local27++) {
					anIntArrayArray13[local27] = null;
				}
			}
		} catch (@Pc(39) RuntimeException local39) {
			signlink.reporterror("99834, " + 20 + ", " + ", " + local39.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!gb", name = "a", descriptor = "(ILclient!ub;)V")
	public static void method279(@OriginalArg(1) Class39 arg0) {
		try {
			anInt411 = 0;
			for (@Pc(5) int local5 = 0; local5 < 50; local5++) {
				try {
					...
					if (aBoolean107 && aClass1_Sub3_Sub2_Sub3Array4[local5].anInt496 == 128) {
						aClass1_Sub3_Sub2_Sub3Array4[local5].method331();
					} else {
						aClass1_Sub3_Sub2_Sub3Array4[local5].method332();
					}
					anInt411++;
			...
			signlink.reporterror("7944, " + ", " + arg0 + ", " + local58.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!gb", name = "a", descriptor = "(ZI)I")
	public static int method280(@OriginalArg(1) int arg0) {
		try {
			...
			local76 = method284(local76, 1.4D);
			if (local76 == 0) {
				local76 = 1;
			}
			...
			signlink.reporterror("15039, " + true + ", " + arg0 + ", " + local95.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!gb", name = "b", descriptor = "(ZI)V")
	public static void method281(@OriginalArg(1) int arg0) {
		try {
			if (anIntArrayArray13[arg0] != null) {
				anIntArrayArray12[anInt412++] = anIntArrayArray13[arg0];
				anIntArrayArray13[arg0] = null;
			}
		} catch (@Pc(23) RuntimeException local23) {
			signlink.reporterror("98328, " + true + ", " + arg0 + ", " + local23.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!gb", name = "b", descriptor = "(I)[I")
	private static int[] method282(@OriginalArg(0) int arg0) {
		anIntArray141[arg0] = anInt413++;
		if (anIntArrayArray13[arg0] != null) {
		...
		@Pc(39) int local39;
		if (anInt412 > 0) {
			local27 = anIntArrayArray12[--anInt412];
			anIntArrayArray12[anInt412] = null;
		} else {
			@Pc(35) int local35 = 0;
			@Pc(37) int local37 = -1;
			for (local39 = 0; local39 < anInt411; local39++) {
	...
	public static void method283(@OriginalArg(0) double arg0) {
		try {
			@Pc(3) int local3 = 0;
			for (@Pc(5) int local5 = 0; local5 < 512; local5++) {
				@Pc(16) double local16 = (double) (local5 / 8) / 64.0D + 0.0078125D;
				@Pc(25) double local25 = (double) (local5 & 0x7) / 8.0D + 0.0625D;
				for (@Pc(27) int local27 = 0; local27 < 128; local27++) {
					@Pc(34) double local34 = (double) local27 / 128.0D;
					@Pc(36) double local36 = local34;
					@Pc(38) double local38 = local34;
					@Pc(40) double local40 = local34;
					if (local25 != 0.0D) {
						@Pc(54) double local54;
						if (local34 < 0.5D) {
							local54 = local34 * (local25 + 1.0D);
						} else {
							local54 = local34 + local25 - local34 * local25;
						}
						@Pc(70) double local70 = local34 * 2.0D - local54;
						@Pc(74) double local74 = local16 + 0.3333333333333333D;
						if (local74 > 1.0D) {
							local74--;
						}
						@Pc(88) double local88 = local16 - 0.3333333333333333D;
						if (local88 < 0.0D) {
							local88++;
						}
						if (local74 * 6.0D < 1.0D) {
							local36 = local70 + (local54 - local70) * 6.0D * local74;
						} else if (local74 * 2.0D < 1.0D) {
							local36 = local54;
						} else if (local74 * 3.0D < 2.0D) {
							local36 = local70 + (local54 - local70) * (0.6666666666666666D - local74) * 6.0D;
						} else {
							local36 = local70;
						}
						if (local16 * 6.0D < 1.0D) {
							local38 = local70 + (local54 - local70) * 6.0D * local16;
						} else if (local16 * 2.0D < 1.0D) {
							local38 = local54;
						} else if (local16 * 3.0D < 2.0D) {
							local38 = local70 + (local54 - local70) * (0.6666666666666666D - local16) * 6.0D;
						} else {
							local38 = local70;
						}
						if (local88 * 6.0D < 1.0D) {
							local40 = local70 + (local54 - local70) * 6.0D * local88;
						} else if (local88 * 2.0D < 1.0D) {
							local40 = local54;
						} else if (local88 * 3.0D < 2.0D) {
							local40 = local70 + (local54 - local70) * (0.6666666666666666D - local88) * 6.0D;
						} else {
							local40 = local70;
						}
					}
					@Pc(251) int local251 = (int) (local36 * 256.0D);
					@Pc(256) int local256 = (int) (local38 * 256.0D);
					@Pc(261) int local261 = (int) (local40 * 256.0D);
					@Pc(271) int local271 = (local251 << 16) + (local256 << 8) + local261;
					@Pc(275) int local275 = method284(local271, arg0);
					anIntArray142[local3++] = local275;
				}
			}
			for (@Pc(293) int local293 = 0; local293 < 50; local293++) {
				if (aClass1_Sub3_Sub2_Sub3Array4[local293] != null) {
					@Pc(304) int[] local304 = aClass1_Sub3_Sub2_Sub3Array4[local293].anIntArray177;
					anIntArrayArray14[local293] = new int[local304.length];
					for (@Pc(312) int local312 = 0; local312 < local304.length; local312++) {
						anIntArrayArray14[local293][local312] = method284(local304[local312], arg0);
					}
				}
			}
			for (@Pc(335) int local335 = 0; local335 < 50; local335++) {
				method281(local335);
			}
		} catch (@Pc(346) RuntimeException local346) {
			signlink.reporterror("84354, " + arg0 + ", " + ", " + local346.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!gb", name = "a", descriptor = "(ID)I")
	private static int method284(@OriginalArg(0) int arg0, @OriginalArg(1) double arg1) {
	...
	public static void method285(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		@Pc(3) int local3 = 0;
		@Pc(5) int local5 = 0;
		if (arg1 != arg0) {
		...
		if (arg0 <= arg1 && arg0 <= arg2) {
			if (arg0 < Class1_Sub3_Sub2.anInt510) {
				if (arg1 > Class1_Sub3_Sub2.anInt510) {
					arg1 = Class1_Sub3_Sub2.anInt510;
				}
				if (arg2 > Class1_Sub3_Sub2.anInt510) {
					arg2 = Class1_Sub3_Sub2.anInt510;
				}
				if (arg1 < arg2) {
					arg5 = arg3 <<= 0x10;
					arg8 = arg6 <<= 0xF;
						...
						while (true) {
							...
							if (arg1 < 0) {
								while (true) {
									...
									method286(Class1_Sub3_Sub2.anIntArray178, arg0, arg5 >> 16, arg4 >> 16, arg8 >> 7, arg7 >> 7);
									arg5 += local57;
									arg4 += local30;
									arg8 += local59;
									arg7 += local32;
									arg0 += Class1_Sub3_Sub2.anInt507;
								}
							}
							method286(Class1_Sub3_Sub2.anIntArray178, arg0, arg5 >> 16, arg3 >> 16, arg8 >> 7, arg6 >> 7);
							arg5 += local57;
							arg3 += local3;
							arg8 += local59;
							arg6 += local5;
						...
						while (true) {
							...
							if (arg1 < 0) {
								while (true) {
									...
									method286(Class1_Sub3_Sub2.anIntArray178, arg0, arg4 >> 16, arg5 >> 16, arg7 >> 7, arg8 >> 7);
									arg5 += local57;
									arg4 += local30;
									arg8 += local59;
									arg7 += local32;
							...
							method286(Class1_Sub3_Sub2.anIntArray178, arg0, arg3 >> 16, arg5 >> 16, arg6 >> 7, arg8 >> 7);
							arg5 += local57;
							arg3 += local3;
							arg8 += local59;
							arg6 += local5;
					...
					if (arg0 != arg2 && local57 < local3 || arg0 == arg2 && local30 > local3) {
						...
						while (true) {
							...
							method286(Class1_Sub3_Sub2.anIntArray178, arg0, arg4 >> 16, arg3 >> 16, arg7 >> 7, arg6 >> 7);
							arg4 += local57;
							arg3 += local3;
							arg7 += local59;
							arg6 += local5;
						...
						while (true) {
							...
							method286(Class1_Sub3_Sub2.anIntArray178, arg0, arg3 >> 16, arg4 >> 16, arg6 >> 7, arg7 >> 7);
							arg4 += local57;
							arg3 += local3;
							arg7 += local59;
							arg6 += local5;
			...
			if (arg1 < Class1_Sub3_Sub2.anInt510) {
				...
				if (arg0 > Class1_Sub3_Sub2.anInt510) {
					arg0 = Class1_Sub3_Sub2.anInt510;
				}
				if (arg2 < arg0) {
					arg3 = arg4 <<= 0x10;
					arg6 = arg7 <<= 0xF;
						...
						while (true) {
							...
							if (arg2 < 0) {
								while (true) {
									...
									method286(Class1_Sub3_Sub2.anIntArray178, arg1, arg3 >> 16, arg5 >> 16, arg6 >> 7, arg8 >> 7);
									arg3 += local3;
									arg5 += local57;
									arg6 += local5;
									arg8 += local59;
									arg1 += Class1_Sub3_Sub2.anInt507;
								}
							}
							method286(Class1_Sub3_Sub2.anIntArray178, arg1, arg3 >> 16, arg4 >> 16, arg6 >> 7, arg7 >> 7);
							arg3 += local3;
							arg4 += local30;
							arg6 += local5;
							arg7 += local32;
						...
						while (true) {
							...
							if (arg2 < 0) {
								while (true) {
									...
									method286(Class1_Sub3_Sub2.anIntArray178, arg1, arg5 >> 16, arg3 >> 16, arg8 >> 7, arg6 >> 7);
									arg3 += local3;
									arg5 += local57;
									arg6 += local5;
									arg8 += local59;
							...
							method286(Class1_Sub3_Sub2.anIntArray178, arg1, arg4 >> 16, arg3 >> 16, arg7 >> 7, arg6 >> 7);
							arg3 += local3;
							arg4 += local30;
							arg6 += local5;
							arg7 += local32;
					...
					if (local3 < local30) {
						...
						while (true) {
							...
							method286(Class1_Sub3_Sub2.anIntArray178, arg1, arg5 >> 16, arg4 >> 16, arg8 >> 7, arg7 >> 7);
							arg5 += local3;
							arg4 += local30;
							arg8 += local5;
							arg7 += local32;
						...
						while (true) {
							...
							method286(Class1_Sub3_Sub2.anIntArray178, arg1, arg4 >> 16, arg5 >> 16, arg7 >> 7, arg8 >> 7);
							arg5 += local3;
							arg4 += local30;
							arg8 += local5;
							arg7 += local32;
		...
		} else if (arg2 < Class1_Sub3_Sub2.anInt510) {
			if (arg0 > Class1_Sub3_Sub2.anInt510) {
				arg0 = Class1_Sub3_Sub2.anInt510;
			}
			if (arg1 > Class1_Sub3_Sub2.anInt510) {
			...
			if (arg0 < arg1) {
					...
					while (true) {
						...
						if (arg0 < 0) {
							while (true) {
								...
								method286(Class1_Sub3_Sub2.anIntArray178, arg2, arg4 >> 16, arg3 >> 16, arg7 >> 7, arg6 >> 7);
								arg4 += local30;
								arg3 += local3;
								arg7 += local32;
								arg6 += local5;
								arg2 += Class1_Sub3_Sub2.anInt507;
							}
						}
						method286(Class1_Sub3_Sub2.anIntArray178, arg2, arg4 >> 16, arg5 >> 16, arg7 >> 7, arg8 >> 7);
						arg4 += local30;
						arg5 += local57;
						arg7 += local32;
						arg8 += local59;
					...
					while (true) {
						...
						if (arg0 < 0) {
							while (true) {
								...
								method286(Class1_Sub3_Sub2.anIntArray178, arg2, arg3 >> 16, arg4 >> 16, arg6 >> 7, arg7 >> 7);
								arg4 += local30;
								arg3 += local3;
								arg7 += local32;
								arg6 += local5;
						...
						method286(Class1_Sub3_Sub2.anIntArray178, arg2, arg5 >> 16, arg4 >> 16, arg8 >> 7, arg7 >> 7);
						arg4 += local30;
						arg5 += local57;
						arg7 += local32;
						arg8 += local59;
				...
				if (local30 < local57) {
					...
					while (true) {
						...
						method286(Class1_Sub3_Sub2.anIntArray178, arg2, arg3 >> 16, arg5 >> 16, arg6 >> 7, arg8 >> 7);
						arg3 += local30;
						arg5 += local57;
						arg6 += local32;
						arg8 += local59;
					...
					while (true) {
						...
						method286(Class1_Sub3_Sub2.anIntArray178, arg2, arg5 >> 16, arg3 >> 16, arg8 >> 7, arg6 >> 7);
						arg3 += local30;
						arg5 += local57;
						arg6 += local32;
						arg8 += local59;
	...
	private static void method286(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5) {
		@Pc(18) int local18;
		@Pc(149) int local149;
		@Pc(153) int local153;
		@Pc(51) int local51;
		...
		if (aBoolean110) {
			if (aBoolean108) {
				...
				if (arg3 > Class1_Sub3_Sub2.anInt513) {
					arg3 = Class1_Sub3_Sub2.anInt513;
				}
				if (arg2 < 0) {
					arg4 -= arg2 * local18;
					arg2 = 0;
	...
	public static void method287(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(3) int local3 = 0;
		if (arg1 != arg0) {
			local3 = (arg4 - arg3 << 16) / (arg1 - arg0);
		}
				...
				if (arg1 < arg2) {
						...
						while (true) {
							...
							if (arg1 < 0) {
								while (true) {
									...
									method288(Class1_Sub3_Sub2.anIntArray178, arg0, arg6, arg5 >> 16, arg4 >> 16);
									arg5 += local33;
									arg4 += local18;
									arg0 += Class1_Sub3_Sub2.anInt507;
								}
							}
							method288(Class1_Sub3_Sub2.anIntArray178, arg0, arg6, arg5 >> 16, arg3 >> 16);
							arg5 += local33;
							arg3 += local3;
							arg0 += Class1_Sub3_Sub2.anInt507;
						}
						...
						while (true) {
							...
							if (arg1 < 0) {
								while (true) {
									...
									method288(Class1_Sub3_Sub2.anIntArray178, arg0, arg6, arg4 >> 16, arg5 >> 16);
									arg5 += local33;
									arg4 += local18;
									arg0 += Class1_Sub3_Sub2.anInt507;
								}
							}
							method288(Class1_Sub3_Sub2.anIntArray178, arg0, arg6, arg3 >> 16, arg5 >> 16);
							arg5 += local33;
							arg3 += local3;
							arg0 += Class1_Sub3_Sub2.anInt507;
						}
					...
					if (arg0 != arg2 && local33 < local3 || arg0 == arg2 && local18 > local3) {
						...
						while (true) {
							...
							method288(Class1_Sub3_Sub2.anIntArray178, arg0, arg6, arg4 >> 16, arg3 >> 16);
							arg4 += local33;
							arg3 += local3;
							arg0 += Class1_Sub3_Sub2.anInt507;
						}
						...
						while (true) {
							...
							method288(Class1_Sub3_Sub2.anIntArray178, arg0, arg6, arg3 >> 16, arg4 >> 16);
							arg4 += local33;
							arg3 += local3;
							arg0 += Class1_Sub3_Sub2.anInt507;
						}
				...
				if (arg2 < arg0) {
						...
						while (true) {
							...
							if (arg2 < 0) {
								while (true) {
									...
									method288(Class1_Sub3_Sub2.anIntArray178, arg1, arg6, arg3 >> 16, arg5 >> 16);
									arg3 += local3;
									arg5 += local33;
									arg1 += Class1_Sub3_Sub2.anInt507;
								}
							}
							method288(Class1_Sub3_Sub2.anIntArray178, arg1, arg6, arg3 >> 16, arg4 >> 16);
							arg3 += local3;
							arg4 += local18;
							arg1 += Class1_Sub3_Sub2.anInt507;
						}
						...
						while (true) {
							...
							if (arg2 < 0) {
								while (true) {
									...
									method288(Class1_Sub3_Sub2.anIntArray178, arg1, arg6, arg5 >> 16, arg3 >> 16);
									arg3 += local3;
									arg5 += local33;
									arg1 += Class1_Sub3_Sub2.anInt507;
								}
							}
							method288(Class1_Sub3_Sub2.anIntArray178, arg1, arg6, arg4 >> 16, arg3 >> 16);
							arg3 += local3;
							arg4 += local18;
							arg1 += Class1_Sub3_Sub2.anInt507;
						}
					...
					if (local3 < local18) {
						...
						while (true) {
							...
							method288(Class1_Sub3_Sub2.anIntArray178, arg1, arg6, arg5 >> 16, arg4 >> 16);
							arg5 += local3;
							arg4 += local18;
							arg1 += Class1_Sub3_Sub2.anInt507;
						}
						...
						while (true) {
							...
							method288(Class1_Sub3_Sub2.anIntArray178, arg1, arg6, arg4 >> 16, arg5 >> 16);
							arg5 += local3;
							arg4 += local18;
							arg1 += Class1_Sub3_Sub2.anInt507;
						}
			...
			if (arg0 < arg1) {
					...
					while (true) {
						...
						if (arg0 < 0) {
							while (true) {
								...
								method288(Class1_Sub3_Sub2.anIntArray178, arg2, arg6, arg4 >> 16, arg3 >> 16);
								arg4 += local18;
								arg3 += local3;
								arg2 += Class1_Sub3_Sub2.anInt507;
							}
						}
						method288(Class1_Sub3_Sub2.anIntArray178, arg2, arg6, arg4 >> 16, arg5 >> 16);
						arg4 += local18;
						arg5 += local33;
						arg2 += Class1_Sub3_Sub2.anInt507;
					}
					...
					while (true) {
						...
						if (arg0 < 0) {
							while (true) {
								...
								method288(Class1_Sub3_Sub2.anIntArray178, arg2, arg6, arg3 >> 16, arg4 >> 16);
								arg4 += local18;
								arg3 += local3;
								arg2 += Class1_Sub3_Sub2.anInt507;
							}
						}
						method288(Class1_Sub3_Sub2.anIntArray178, arg2, arg6, arg5 >> 16, arg4 >> 16);
						arg4 += local18;
						arg5 += local33;
						arg2 += Class1_Sub3_Sub2.anInt507;
					}
				...
				if (local18 < local33) {
					...
					while (true) {
						...
						method288(Class1_Sub3_Sub2.anIntArray178, arg2, arg6, arg3 >> 16, arg5 >> 16);
						arg3 += local18;
						arg5 += local33;
						arg2 += Class1_Sub3_Sub2.anInt507;
					}
					...
					while (true) {
						...
						method288(Class1_Sub3_Sub2.anIntArray178, arg2, arg6, arg5 >> 16, arg3 >> 16);
						arg3 += local18;
						arg5 += local33;
						arg2 += Class1_Sub3_Sub2.anInt507;
					}
	...
	private static void method288(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		if (aBoolean108) {
			if (arg4 > Class1_Sub3_Sub2.anInt513) {
				arg4 = Class1_Sub3_Sub2.anInt513;
			}
			if (arg3 < 0) {
				arg3 = 0;
			}
		...
		@Pc(72) int local72 = anInt408;
		@Pc(76) int local76 = 256 - anInt408;
	...
	public static void method289(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18) {
		@Pc(4) int[] local4 = method282(arg18);
		aBoolean109 = !aBooleanArray4[arg18];
				...
				if (arg1 < arg2) {
						...
						while (true) {
							...
							if (arg1 < 0) {
								while (true) {
									...
									method290(Class1_Sub3_Sub2.anIntArray178, local4, 0, 0, arg0, arg5 >> 16, arg4 >> 16, arg8 >> 8, arg7 >> 8, local46, local76, local106, local56, local86, local116);
									arg5 += local182;
									arg4 += local155;
									arg8 += local184;
									arg7 += local157;
							...
							method290(Class1_Sub3_Sub2.anIntArray178, local4, 0, 0, arg0, arg5 >> 16, arg3 >> 16, arg8 >> 8, arg6 >> 8, local46, local76, local106, local56, local86, local116);
							arg5 += local182;
							arg3 += local128;
							arg8 += local184;
							arg6 += local130;
						...
						while (true) {
							...
							if (arg1 < 0) {
								while (true) {
									...
									method290(Class1_Sub3_Sub2.anIntArray178, local4, 0, 0, arg0, arg4 >> 16, arg5 >> 16, arg7 >> 8, arg8 >> 8, local46, local76, local106, local56, local86, local116);
									arg5 += local182;
									arg4 += local155;
									arg8 += local184;
									arg7 += local157;
							...
							method290(Class1_Sub3_Sub2.anIntArray178, local4, 0, 0, arg0, arg3 >> 16, arg5 >> 16, arg6 >> 8, arg8 >> 8, local46, local76, local106, local56, local86, local116);
							arg5 += local182;
							arg3 += local128;
							arg8 += local184;
							arg6 += local130;
					...
					if ((arg0 == arg2 || local182 >= local128) && (arg0 != arg2 || local155 <= local128)) {
						...
						while (true) {
							...
							method290(Class1_Sub3_Sub2.anIntArray178, local4, 0, 0, arg0, arg3 >> 16, arg4 >> 16, arg6 >> 8, arg7 >> 8, local46, local76, local106, local56, local86, local116);
							arg4 += local182;
							arg3 += local128;
							arg7 += local184;
							arg6 += local130;
						...
						while (true) {
							...
							method290(Class1_Sub3_Sub2.anIntArray178, local4, 0, 0, arg0, arg4 >> 16, arg3 >> 16, arg7 >> 8, arg6 >> 8, local46, local76, local106, local56, local86, local116);
							arg4 += local182;
							arg3 += local128;
							arg7 += local184;
							arg6 += local130;
				...
				if (arg2 < arg0) {
						...
						while (true) {
							...
							if (arg2 < 0) {
								while (true) {
									...
									method290(Class1_Sub3_Sub2.anIntArray178, local4, 0, 0, arg1, arg3 >> 16, arg5 >> 16, arg6 >> 8, arg8 >> 8, local46, local76, local106, local56, local86, local116);
									arg3 += local128;
									arg5 += local182;
									arg6 += local130;
									arg8 += local184;
							...
							method290(Class1_Sub3_Sub2.anIntArray178, local4, 0, 0, arg1, arg3 >> 16, arg4 >> 16, arg6 >> 8, arg7 >> 8, local46, local76, local106, local56, local86, local116);
							arg3 += local128;
							arg4 += local155;
							arg6 += local130;
							arg7 += local157;
						...
						while (true) {
							...
							if (arg2 < 0) {
								while (true) {
									...
									method290(Class1_Sub3_Sub2.anIntArray178, local4, 0, 0, arg1, arg5 >> 16, arg3 >> 16, arg8 >> 8, arg6 >> 8, local46, local76, local106, local56, local86, local116);
									arg3 += local128;
									arg5 += local182;
									arg6 += local130;
									arg8 += local184;
							...
							method290(Class1_Sub3_Sub2.anIntArray178, local4, 0, 0, arg1, arg4 >> 16, arg3 >> 16, arg7 >> 8, arg6 >> 8, local46, local76, local106, local56, local86, local116);
							arg3 += local128;
							arg4 += local155;
							arg6 += local130;
							arg7 += local157;
					...
					if (local128 < local155) {
						...
						while (true) {
							...
							method290(Class1_Sub3_Sub2.anIntArray178, local4, 0, 0, arg1, arg5 >> 16, arg4 >> 16, arg8 >> 8, arg7 >> 8, local46, local76, local106, local56, local86, local116);
							arg5 += local128;
							arg4 += local155;
							arg8 += local130;
							arg7 += local157;
						...
						while (true) {
							...
							method290(Class1_Sub3_Sub2.anIntArray178, local4, 0, 0, arg1, arg4 >> 16, arg5 >> 16, arg7 >> 8, arg8 >> 8, local46, local76, local106, local56, local86, local116);
							arg5 += local128;
							arg4 += local155;
							arg8 += local130;
							arg7 += local157;
			...
			if (arg0 < arg1) {
					...
					while (true) {
						...
						if (arg0 < 0) {
							while (true) {
								...
								method290(Class1_Sub3_Sub2.anIntArray178, local4, 0, 0, arg2, arg4 >> 16, arg3 >> 16, arg7 >> 8, arg6 >> 8, local46, local76, local106, local56, local86, local116);
								arg4 += local155;
								arg3 += local128;
								arg7 += local157;
								arg6 += local130;
						...
						method290(Class1_Sub3_Sub2.anIntArray178, local4, 0, 0, arg2, arg4 >> 16, arg5 >> 16, arg7 >> 8, arg8 >> 8, local46, local76, local106, local56, local86, local116);
						arg4 += local155;
						arg5 += local182;
						arg7 += local157;
						arg8 += local184;
					...
					while (true) {
						...
						if (arg0 < 0) {
							while (true) {
								...
								method290(Class1_Sub3_Sub2.anIntArray178, local4, 0, 0, arg2, arg3 >> 16, arg4 >> 16, arg6 >> 8, arg7 >> 8, local46, local76, local106, local56, local86, local116);
								arg4 += local155;
								arg3 += local128;
								arg7 += local157;
								arg6 += local130;
						...
						method290(Class1_Sub3_Sub2.anIntArray178, local4, 0, 0, arg2, arg5 >> 16, arg4 >> 16, arg8 >> 8, arg7 >> 8, local46, local76, local106, local56, local86, local116);
						arg4 += local155;
						arg5 += local182;
						arg7 += local157;
						arg8 += local184;
				...
				if (local155 < local182) {
					...
					while (true) {
						...
						method290(Class1_Sub3_Sub2.anIntArray178, local4, 0, 0, arg2, arg3 >> 16, arg5 >> 16, arg6 >> 8, arg8 >> 8, local46, local76, local106, local56, local86, local116);
						arg3 += local155;
						arg5 += local182;
						arg6 += local157;
						arg8 += local184;
					...
					while (true) {
						...
						method290(Class1_Sub3_Sub2.anIntArray178, local4, 0, 0, arg2, arg5 >> 16, arg3 >> 16, arg8 >> 8, arg6 >> 8, local46, local76, local106, local56, local86, local116);
						arg3 += local155;
						arg5 += local182;
						arg6 += local157;
						arg8 += local184;
	...
	private static void method290(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14) {
		if (arg5 >= arg6) {
			return;
		}
		@Pc(15) int local15;
		...
		if (aBoolean108) {
			...
			if (arg6 > Class1_Sub3_Sub2.anInt513) {
				arg6 = Class1_Sub3_Sub2.anInt513;
			}
			if (arg5 < 0) {
				arg7 -= arg5 * local15;
				arg5 = 0;
