...
public final class Static392 {
	...
	@OriginalMember(owner = "client!qn", name = "a", descriptor = "(I[B[IIIIIIIILclient!qn;)I", line = 9)
	public static int method4981(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub12_Sub4 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt5478 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!qn", name = "a", descriptor = "(II[B[IIIIIIILclient!qn;II)I", line = 68)
	public static int method4984(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub12_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!qn", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!qn;)I", line = 108)
	public static int method4988(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub12_Sub4 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt5476 += arg10.anInt5468 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt5469 = arg4 >> 2;
		arg10.anInt5470 = arg5 >> 2;
		arg10.anInt5478 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!qn", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!qn;II)I", line = 305)
	public static int method4993(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub12_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt5476 -= arg10.anInt5468 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt5476 += arg10.anInt5468 * local63;
		arg10.anInt5469 = arg4;
		arg10.anInt5470 = arg5;
		arg10.anInt5478 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!qn", name = "a", descriptor = "([B[IIIIIIILclient!qn;)I", line = 348)
	public static int method4994(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub12_Sub4 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt5478 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!qn", name = "b", descriptor = "([B[IIIIIIILclient!qn;)I", line = 711)
	public static int method4997(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub12_Sub4 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lclient!jn;III)Lclient!qn;", line = 739)
	public static Class2_Sub12_Sub4 method4999(@OriginalArg(0) Class2_Sub21_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray31 == null || arg0.aByteArray31.length == 0 ? null : new Class2_Sub12_Sub4(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!qn", name = "a", descriptor = "(II[B[IIIIIIIILclient!qn;II)I", line = 745)
	public static int method5000(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub12_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt5469 -= arg8.anInt5472 * arg3;
		arg8.anInt5470 -= arg8.anInt5473 * arg3;
		@Pc(32) int local32;
	...
	public static int method5001(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!qn", name = "b", descriptor = "(II[B[IIIIIIIILclient!qn;II)I", line = 787)
	...
	@OriginalMember(owner = "client!qn", name = "c", descriptor = "(II[B[IIIIIIIILclient!qn;II)I", line = 821)
	public static int method5004(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub12_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!qn", name = "a", descriptor = "([B[IIIIIIIILclient!qn;)I", line = 860)
	public static int method5006(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub12_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt5469 += arg8.anInt5472 * (local24 - arg3);
		arg8.anInt5470 += arg8.anInt5473 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt5476 = arg4 >> 2;
		arg8.anInt5478 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!qn", name = "a", descriptor = "(Lclient!jn;II)Lclient!qn;", line = 894)
	public static Class2_Sub12_Sub4 method5007(@OriginalArg(0) Class2_Sub21_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray31 == null || arg0.aByteArray31.length == 0 ? null : new Class2_Sub12_Sub4(arg0, (int) ((long) arg0.anInt3172 * 256L * (long) 100 / (long) (Static331.anInt6630 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!qn", name = "b", descriptor = "(II[B[IIIIIIILclient!qn;II)I", line = 1130)
	public static int method5009(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub12_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!qn", name = "b", descriptor = "([B[IIIIIIIILclient!qn;)I", line = 1157)
	public static int method5010(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub12_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt5469 += arg8.anInt5472 * (local22 - arg3);
		arg8.anInt5470 += arg8.anInt5473 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!qn", name = "d", descriptor = "(II[B[IIIIIIIILclient!qn;II)I", line = 1197)
	public static int method5012(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub12_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt5469 -= arg8.anInt5472 * arg3;
		arg8.anInt5470 -= arg8.anInt5473 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!qn", name = "b", descriptor = "(I[B[IIIIIIIILclient!qn;)I", line = 1243)
	public static int method5013(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub12_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!qn", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!qn;II)I", line = 1284)
	public static int method5014(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub12_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt5476 -= arg10.anInt5468 * arg3;
		@Pc(23) int local23;
	...
	public static int method5017(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!qn", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!qn;)I", line = 1399)
	public static int method5018(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub12_Sub4 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt5476 += arg10.anInt5468 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
