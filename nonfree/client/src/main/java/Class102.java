...
public abstract class Class102 {
	...
	public abstract void method4926(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3);
	...
	public abstract void E(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3);

	@OriginalMember(owner = "client!ia", name = "ZA", descriptor = "(III)V")
	public abstract void ZA(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!ia", name = "Q", descriptor = "(IIIIII)V")
	public abstract void Q(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5);
	...
	@OriginalMember(owner = "client!ia", name = "ba", descriptor = "(Lclient!ia;)V")
	public abstract void ba(@OriginalArg(0) Class102 arg0);

	@OriginalMember(owner = "client!ia", name = "a", descriptor = "()Lclient!ia;")
	public abstract Class102 method4931();
}
