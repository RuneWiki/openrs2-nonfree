...
public final class Class2_Sub3_Sub20 extends Class2_Sub3 {
	...
	public int[][] method6480(@OriginalArg(0) int arg0) {
		...
		if (super.aClass243_41.aBoolean478) {
			@Pc(29) int[] local29 = this.method6474(0, arg0);
			@Pc(33) int[] local33 = local19[0];
			@Pc(37) int[] local37 = local19[1];
			@Pc(41) int[] local41 = local19[2];
			for (@Pc(43) int local43 = 0; local43 < Static211.anInt4031; local43++) {
	...
	@OriginalMember(owner = "client!kt", name = "a", descriptor = "(ILclient!bt;I)V", line = 90)
	@Override
	public void method6485(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub4 arg1) {
		if (arg0 != 0) {
			return;
		}
		@Pc(10) int local10 = arg1.method4816();
		if (local10 != 0) {
			this.method3504(local10);
			return;
		}
		this.anIntArrayArray26 = new int[arg1.method4816()][4];
		for (@Pc(21) int local21 = 0; local21 < this.anIntArrayArray26.length; local21++) {
			this.anIntArrayArray26[local21][0] = arg1.method4830();
			this.anIntArrayArray26[local21][1] = arg1.method4816() << 4;
			this.anIntArrayArray26[local21][2] = arg1.method4816() << 4;
			this.anIntArrayArray26[local21][3] = arg1.method4816() << 4;
		}
	}

	@OriginalMember(owner = "client!kt", name = "c", descriptor = "(IB)V", line = 165)
	private void method3504(@OriginalArg(0) int arg0) {
		if (arg0 == 0) {
			return;
		}
		if (arg0 == 1) {
