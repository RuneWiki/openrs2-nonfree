...
public final class Class3_Sub22 extends Class3 {
	...
	public Class3_Sub22(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) boolean arg3) {
		this.anInt3464 = arg0;
		this.anInt3463 = arg1;
		this.anIntArray178 = arg2;
		if (arg3) {
			@Pc(16) int[] local16 = new int[this.anInt3463];
			@Pc(20) int[] local20 = new int[this.anInt3463];
			@Pc(24) int[] local24 = new int[this.anInt3463];
			if (Static178.anIntArray177 == null || Static178.anIntArray177.length < this.anIntArray178.length) {
				Static178.anIntArray177 = new int[this.anIntArray178.length];
			}
			@Pc(40) int local40 = this.anInt3463;
			@Pc(43) int local43 = this.anInt3463;
			...
			for (@Pc(61) int local61 = 2; local61 >= 0; local61--) {
				for (local64 = local47; local64 >= 0; local64--) {
					local58--;
					@Pc(71) int local71 = this.anIntArray178[local58];
			...
			for (@Pc(116) int local116 = local51; local116 >= 0; local116--) {
				...
				for (local64 = local47; local64 >= 0; local64--) {
					...
					local114--;
					Static178.anIntArray177[local114] = local165 << 16 | local169 << 8 | local173;
				...
				for (local64 = local47; local64 >= 0; local64--) {
					local58--;
					@Pc(236) int local236 = this.anIntArray178[local58];
					local59--;
					@Pc(242) int local242 = this.anIntArray178[local59];
			...
			@Pc(306) int[] local306 = this.anIntArray178;
			this.anIntArray178 = Static178.anIntArray177;
			Static178.anIntArray177 = local306;
		}
	}
	...
	public void method3103(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 == 0 && arg1 == 0) {
			return;
		}
		if (Static178.anIntArray177 == null || Static178.anIntArray177.length != this.anIntArray178.length) {
		...
		@Pc(28) int local28 = this.anInt3463 - 1;
		@Pc(33) int local33 = this.anInt3463 * arg1;
		@Pc(37) int local37 = local21 - 1;
		for (@Pc(39) int local39 = 0; local39 < local21; local39 += this.anInt3463) {
			@Pc(46) int local46 = local39 + local33 & local37;
			for (@Pc(48) int local48 = 0; local48 < this.anInt3463; local48++) {
				@Pc(53) int local53 = local39 + local48;
				@Pc(61) int local61 = local46 + (local48 + arg0 & local28);
				Static178.anIntArray177[local53] = this.anIntArray178[local61];
			}
		}
		@Pc(84) int[] local84 = this.anIntArray178;
		this.anIntArray178 = Static178.anIntArray177;
		Static178.anIntArray177 = local84;
	}
}
