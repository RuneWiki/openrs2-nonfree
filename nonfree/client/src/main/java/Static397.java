...
public final class Static397 {
	...
	@OriginalMember(owner = "client!jr", name = "a", descriptor = "([B[IIIIIIILclient!jr;)I")
	public static int method2982(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub11_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt3479 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!jr", name = "a", descriptor = "(I[B[IIIIIIIILclient!jr;)I")
	public static int method2986(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub11_Sub2 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt3479 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!jr", name = "b", descriptor = "(II)I")
	public static int method2988(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!jr", name = "a", descriptor = "(Lclient!jk;III)Lclient!jr;")
	public static Class2_Sub11_Sub2 method2992(@OriginalArg(0) Class2_Sub20_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray40 == null || arg0.aByteArray40.length == 0 ? null : new Class2_Sub11_Sub2(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!jr", name = "a", descriptor = "(II[B[IIIIIIIILclient!jr;II)I")
	public static int method2994(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub11_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt3477 -= arg8.anInt3483 * arg3;
		arg8.anInt3474 -= arg8.anInt3476 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!jr", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!jr;II)I")
	public static int method2995(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub11_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt3478 -= arg10.anInt3482 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt3478 += arg10.anInt3482 * local63;
		arg10.anInt3477 = arg4;
		arg10.anInt3474 = arg5;
		arg10.anInt3479 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!jr", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!jr;)I")
	public static int method2996(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub11_Sub2 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt3478 += arg10.anInt3482 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt3477 = arg4 >> 2;
		arg10.anInt3474 = arg5 >> 2;
		arg10.anInt3479 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!jr", name = "a", descriptor = "(Lclient!jk;II)Lclient!jr;")
	public static Class2_Sub11_Sub2 method2997(@OriginalArg(0) Class2_Sub20_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray40 == null || arg0.aByteArray40.length == 0 ? null : new Class2_Sub11_Sub2(arg0, (int) ((long) arg0.anInt3404 * 256L * (long) 100 / (long) (Static392.anInt7144 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!jr", name = "b", descriptor = "(I[B[IIIIIIIILclient!jr;)I")
	public static int method2999(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub11_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!jr", name = "a", descriptor = "(II[B[IIIIIIILclient!jr;II)I")
	public static int method3000(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub11_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!jr", name = "b", descriptor = "(II[B[IIIIIIIILclient!jr;II)I")
	public static int method3001(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub11_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt3477 -= arg8.anInt3483 * arg3;
		arg8.anInt3474 -= arg8.anInt3476 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!jr", name = "b", descriptor = "([B[IIIIIIILclient!jr;)I")
	public static int method3006(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub11_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!jr", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!jr;)I")
	public static int method3007(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub11_Sub2 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt3478 += arg10.anInt3482 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!jr", name = "c", descriptor = "(II[B[IIIIIIIILclient!jr;II)I")
	public static int method3009(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub11_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!jr", name = "b", descriptor = "(II[B[IIIIIIILclient!jr;II)I")
	public static int method3011(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub11_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!jr", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!jr;II)I")
	public static int method3012(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub11_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt3478 -= arg10.anInt3482 * arg3;
		@Pc(23) int local23;
	...
	public static int method3014(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!jr", name = "a", descriptor = "([B[IIIIIIIILclient!jr;)I")
	public static int method3015(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub11_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt3477 += arg8.anInt3483 * (local22 - arg3);
		arg8.anInt3474 += arg8.anInt3476 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt3478 = arg4 >> 2;
		arg8.anInt3479 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!jr", name = "d", descriptor = "(II[B[IIIIIIIILclient!jr;II)I")
	public static int method3017(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub11_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!jr", name = "b", descriptor = "([B[IIIIIIIILclient!jr;)I")
	public static int method3020(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub11_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt3477 += arg8.anInt3483 * (local24 - arg3);
		arg8.anInt3474 += arg8.anInt3476 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
