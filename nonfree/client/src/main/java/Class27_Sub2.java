...
public final class Class27_Sub2 extends Class27 implements ImageProducer, ImageObserver {

	@OriginalMember(owner = "client!qb", name = "z", descriptor = "Ljava/awt/image/ImageConsumer;")
	private ImageConsumer anImageConsumer1;

	@OriginalMember(owner = "client!qb", name = "I", descriptor = "Ljava/awt/image/ColorModel;")
	private ColorModel aColorModel1;

	@OriginalMember(owner = "client!qb", name = "a", descriptor = "(BILjava/awt/Graphics;I)V")
	@Override
	...
	@OriginalMember(owner = "client!qb", name = "a", descriptor = "(ILjava/awt/Component;ZI)V")
	@Override
	public void method1538(@OriginalArg(0) int arg0, @OriginalArg(1) Component arg1, @OriginalArg(3) int arg2) {
		super.anInt2212 = arg0;
		super.anIntArray299 = new int[arg2 * arg0 + 1];
		super.anInt2210 = arg2;
	...
	public synchronized void addConsumer(@OriginalArg(0) ImageConsumer arg0) {
		...
		arg0.setDimensions(super.anInt2210, super.anInt2212);
	...
	private synchronized void method1543() {
		if (this.anImageConsumer1 != null) {
			this.anImageConsumer1.setPixels(0, 0, super.anInt2210, super.anInt2212, this.aColorModel1, super.anIntArray299, 0, super.anInt2210);
