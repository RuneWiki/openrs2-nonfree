...
public final class Class6_Sub29 extends Class6 {
	...
	@OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(ILclient!ah;)V")
	public Class6_Sub29(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub5 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lclient!ah;)V")
	public Class6_Sub29(@OriginalArg(0) Class2_Sub5 arg0) {
		super(arg0);
	}
