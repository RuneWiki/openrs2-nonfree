...
public final class Static474 {
	...
	@OriginalMember(owner = "client!tc", name = "a", descriptor = "([B[IIIIIIIILclient!tc;)I")
	public static int method5019(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub9_Sub4 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt6258 += arg8.anInt6261 * (local24 - arg3);
		arg8.anInt6260 += arg8.anInt6266 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt6259 = arg4 >> 2;
		arg8.anInt6267 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!tc", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!tc;II)I")
	public static int method5020(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub9_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt6259 -= arg10.anInt6268 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt6259 += arg10.anInt6268 * local63;
		arg10.anInt6258 = arg4;
		arg10.anInt6260 = arg5;
		arg10.anInt6267 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!tc", name = "a", descriptor = "(II[B[IIIIIIIILclient!tc;II)I")
	public static int method5022(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub9_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt6258 -= arg8.anInt6261 * arg3;
		arg8.anInt6260 -= arg8.anInt6266 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!tc", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!tc;)I")
	public static int method5024(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub9_Sub4 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt6259 += arg10.anInt6268 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt6258 = arg4 >> 2;
		arg10.anInt6260 = arg5 >> 2;
		arg10.anInt6267 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!tc", name = "a", descriptor = "([B[IIIIIIILclient!tc;)I")
	public static int method5026(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub9_Sub4 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt6267 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!tc", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!tc;)I")
	public static int method5027(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub9_Sub4 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt6259 += arg10.anInt6268 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lclient!cj;III)Lclient!tc;")
	public static Class1_Sub9_Sub4 method5028(@OriginalArg(0) Class1_Sub8_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray12 == null || arg0.aByteArray12.length == 0 ? null : new Class1_Sub9_Sub4(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!tc", name = "b", descriptor = "([B[IIIIIIILclient!tc;)I")
	public static int method5032(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub9_Sub4 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!tc", name = "a", descriptor = "(I[B[IIIIIIIILclient!tc;)I")
	public static int method5036(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub9_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	public static int method5037(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!tc", name = "a", descriptor = "(II[B[IIIIIIILclient!tc;II)I")
	public static int method5041(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub9_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!tc", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!tc;II)I")
	public static int method5043(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub9_Sub4 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt6259 -= arg10.anInt6268 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!tc", name = "b", descriptor = "(II[B[IIIIIIIILclient!tc;II)I")
	public static int method5044(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub9_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!tc", name = "b", descriptor = "(I[B[IIIIIIIILclient!tc;)I")
	public static int method5046(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub9_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!tc", name = "b", descriptor = "(II[B[IIIIIIILclient!tc;II)I")
	public static int method5047(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub9_Sub4 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!tc", name = "c", descriptor = "(II[B[IIIIIIIILclient!tc;II)I")
	public static int method5049(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub9_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!tc", name = "b", descriptor = "([B[IIIIIIIILclient!tc;)I")
	public static int method5050(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub9_Sub4 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt6258 += arg8.anInt6261 * (local22 - arg3);
		arg8.anInt6260 += arg8.anInt6266 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!tc", name = "a", descriptor = "(Lclient!cj;II)Lclient!tc;")
	public static Class1_Sub9_Sub4 method5051(@OriginalArg(0) Class1_Sub8_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray12 == null || arg0.aByteArray12.length == 0 ? null : new Class1_Sub9_Sub4(arg0, (int) ((long) arg0.anInt755 * 256L * (long) 100 / (long) (Static234.anInt4244 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!tc", name = "d", descriptor = "(II[B[IIIIIIIILclient!tc;II)I")
	public static int method5055(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub9_Sub4 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt6258 -= arg8.anInt6261 * arg3;
		arg8.anInt6260 -= arg8.anInt6266 * arg3;
		@Pc(32) int local32;
