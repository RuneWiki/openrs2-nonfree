...
public final class Static76 {
	...
	private static void method1353(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg1 < anInt1847 || arg1 >= anInt1844) {
			return;
		}
		if (arg0 < anInt1843) {
			arg2 -= anInt1843 - arg0;
		...
		@Pc(58) int local58 = arg0 + arg1 * anInt1846;
		for (@Pc(60) int local60 = 0; local60 < arg2; local60++) {
			@Pc(71) int local71 = (anIntArray214[local58] >> 16 & 0xFF) * local30;
			@Pc(81) int local81 = (anIntArray214[local58] >> 8 & 0xFF) * local30;
			@Pc(89) int local89 = (anIntArray214[local58] & 0xFF) * local30;
			@Pc(111) int local111 = (local38 + local71 >> 8 << 16) + (local46 + local81 >> 8 << 8) + (local52 + local89 >> 8);
			anIntArray214[local58++] = local111;
		}
	}
	...
	public static void method1354() {
		@Pc(1) int local1 = 0;
		@Pc(7) int local7 = anInt1846 * anInt1848 - 7;
		while (local1 < local7) {
	...
	public static void method1355(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		arg2 -= arg0;
		arg3 -= arg1;
		if (arg3 == 0) {
			if (arg2 >= 0) {
				method1357(arg0, arg1, arg2 + 1, arg4);
			} else {
				method1357(arg0 + arg2, arg1, 1 - arg2, arg4);
			}
		} else if (arg2 != 0) {
			if (arg2 + arg3 < 0) {
				arg0 += arg2;
			...
			if (arg2 > arg3) {
				...
				while (arg0 <= arg2) {
					local125 = arg1 >> 16;
					if (local125 >= anInt1847 && local125 < anInt1844) {
						anIntArray214[arg0 + local125 * anInt1846] = arg4;
					}
					arg1 += local96;
					arg0++;
				}
				...
				while (arg1 <= arg3) {
					local125 = arg0 >> 16;
					if (local125 >= anInt1843 && local125 < anInt1845) {
						anIntArray214[local125 + arg1 * anInt1846] = arg4;
					}
					arg0 += local96;
					arg1++;
				}
			...
			method1365(arg0, arg1, arg3 + 1, arg4);
		} else {
			method1365(arg0, arg1 + arg3, -arg3 + 1, arg4);
		}
	}

	@OriginalMember(owner = "client!hf", name = "a", descriptor = "([I)V")
	public static void method1356(@OriginalArg(0) int[] arg0) {
		arg0[0] = anInt1843;
		arg0[1] = anInt1847;
		arg0[2] = anInt1845;
		arg0[3] = anInt1844;
	...
	public static void method1357(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg1 < anInt1847 || arg1 >= anInt1844) {
			return;
		}
		if (arg0 < anInt1843) {
		...
		@Pc(32) int local32 = arg0 + arg1 * anInt1846;
		for (@Pc(34) int local34 = 0; local34 < arg2; local34++) {
			anIntArray214[local32 + local34] = arg3;
		}
	}

	@OriginalMember(owner = "client!hf", name = "b", descriptor = "(IIII)V")
	public static void method1358(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (anInt1843 < arg0) {
			anInt1843 = arg0;
		}
		if (anInt1847 < arg1) {
	...
	public static void method1359(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		anIntArray214 = arg0;
		anInt1846 = arg1;
		anInt1848 = arg2;
		method1363(0, 0, arg1, arg2);
	}

	@OriginalMember(owner = "client!hf", name = "a", descriptor = "(IIIIII)V")
	public static void method1360(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		@Pc(85) int local85 = arg0 - Static81.method1436();
		@Pc(89) int local89 = arg1 - Static81.method1434();
		...
		Static81.method1444(local93, local97, local103);
		Static81.method1449(local113, local117, local123, local93, local97, local103, arg4);
		Static81.method1444(local93, local103, local109);
		Static81.method1449(local113, local123, local129, local93, local103, local109, arg4);
	}
	...
	public static void method1361(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		if (arg1 + arg3 > anInt1844) {
			arg3 = anInt1844 - arg1;
		}
		@Pc(57) int local57 = anInt1846 - arg2;
		@Pc(63) int local63 = arg0 + arg1 * anInt1846;
		for (@Pc(66) int local66 = -arg3; local66 < 0; local66++) {
			...
			for (@Pc(110) int local110 = -arg2; local110 < 0; local110++) {
				anIntArray214[local63++] = local107;
			}
			local63 += local57;
			local1 += 2849;
		}
	...
	public static void method1365(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg0 < anInt1843 || arg0 >= anInt1845) {
			return;
		}
		if (arg1 < anInt1847) {
			arg2 -= anInt1847 - arg1;
		...
		if (arg1 + arg2 > anInt1844) {
			arg2 = anInt1844 - arg1;
		}
		@Pc(32) int local32 = arg0 + arg1 * anInt1846;
		for (@Pc(34) int local34 = 0; local34 < arg2; local34++) {
			anIntArray214[local32 + local34 * anInt1846] = arg3;
		}
	}

	@OriginalMember(owner = "client!hf", name = "a", descriptor = "(III)V")
	private static void method1366(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		if (arg0 >= anInt1843 && arg1 >= anInt1847 && arg0 < anInt1845 && arg1 < anInt1844) {
			anIntArray214[arg0 + arg1 * anInt1846] = arg2;
		}
	}

	@OriginalMember(owner = "client!hf", name = "c", descriptor = "(IIIII)V")
	public static void method1367(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg0 < anInt1843) {
			arg2 -= anInt1843 - arg0;
			arg0 = anInt1843;
		}
		...
		@Pc(43) int local43 = anInt1846 - arg2;
		@Pc(49) int local49 = arg0 + arg1 * anInt1846;
		for (@Pc(52) int local52 = -arg3; local52 < 0; local52++) {
			for (@Pc(56) int local56 = -arg2; local56 < 0; local56++) {
				anIntArray214[local49++] = arg4;
			}
			local49 += local43;
		}
	}
	...
	public static void method1368(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		if (arg0 < anInt1843) {
			arg2 -= anInt1843 - arg0;
			arg0 = anInt1843;
		}
	...
	public static void method1369(@OriginalArg(0) int[] arg0) {
		anInt1843 = arg0[0];
		anInt1847 = arg0[1];
		anInt1845 = arg0[2];
		anInt1844 = arg0[3];
	...
	private static void method1370(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg0 < anInt1843 || arg0 >= anInt1845) {
			return;
		}
		if (arg1 < anInt1847) {
	...
	public static void method1371(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (arg4 == 256) {
			method1372(arg0, arg1, arg2, arg3);
			return;
		}
		...
		if (local46 < anInt1847) {
			local46 = anInt1847;
		}
		@Pc(57) int local57 = arg1 + arg2 + 1;
		if (local57 > anInt1844) {
			local57 = anInt1844;
		}
		...
		while (local64 < arg1) {
			...
			if (local113 < anInt1843) {
				local113 = anInt1843;
			}
			local122 = arg0 + local70;
			if (local122 > anInt1845) {
				local122 = anInt1845;
			}
			local133 = local113 + local64 * anInt1846;
			for (local135 = local113; local135 < local122; local135++) {
				local146 = (anIntArray214[local133] >> 16 & 0xFF) * local20;
				local156 = (anIntArray214[local133] >> 8 & 0xFF) * local20;
				local164 = (anIntArray214[local133] & 0xFF) * local20;
				local186 = (local28 + local146 >> 8 << 16) + (local36 + local156 >> 8 << 8) + (local42 + local164 >> 8);
				anIntArray214[local133++] = local186;
			}
			local64++;
		...
		while (local64 < local57) {
			...
			local122 = arg0 + local70;
			if (local122 > anInt1845 - 1) {
				local122 = anInt1845 - 1;
			}
			local133 = local113 + local64 * anInt1846;
			for (local135 = local113; local135 <= local122; local135++) {
				local146 = (anIntArray214[local133] >> 16 & 0xFF) * local20;
	...
	private static void method1372(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		if (arg2 == 0) {
			method1366(arg0, arg1, arg3);
			return;
		}
		if (arg2 < 0) {
			arg2 = -arg2;
		...
		if (local15 < anInt1847) {
			local15 = anInt1847;
		}
		@Pc(26) int local26 = arg1 + arg2 + 1;
		if (local26 > anInt1844) {
			local26 = anInt1844;
		}
		...
		while (local33 < arg1) {
			...
			if (local82 < anInt1843) {
				local82 = anInt1843;
			}
			local91 = arg0 + local39;
			if (local91 > anInt1845) {
				local91 = anInt1845;
			}
			local102 = local82 + local33 * anInt1846;
			for (local104 = local82; local104 < local91; local104++) {
				anIntArray214[local102++] = arg3;
			}
			local33++;
	...
	public static void method1373(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		method1353(arg0, arg1, arg2, arg4, arg5);
		method1353(arg0, arg1 + arg3 - 1, arg2, arg4, arg5);
		if (arg3 >= 3) {
	...
	public static void method1374(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		method1357(arg0, arg1, arg2, arg4);
		method1357(arg0, arg1 + arg3 - 1, arg2, arg4);
		method1365(arg0, arg1, arg3, arg4);
		method1365(arg0 + arg2 - 1, arg1, arg3, arg4);
	}

	@OriginalMember(owner = "client!hf", name = "a", descriptor = "(III[I[I)V")
	public static void method1375(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int[] arg2, @OriginalArg(4) int[] arg3) {
		@Pc(5) int local5 = arg0 + arg1 * anInt1846;
		for (@Pc(7) int local7 = 0; local7 < arg2.length; local7++) {
			@Pc(14) int local14 = local5 + arg2[local7];
			for (@Pc(19) int local19 = -arg3[local7]; local19 < 0; local19++) {
				anIntArray214[local14++] = 0;
			}
			local5 += anInt1846;
		}
	}
