...
public final class Class5_Sub54 extends Class5 {
	...
	public Class5_Sub54(@OriginalArg(0) byte[] arg0) {
		this.method8456(arg0);
	}

	@OriginalMember(owner = "client!vp", name = "a", descriptor = "([B)V")
	private void method8456(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class5_Sub15 local4 = new Class5_Sub15(arg0);
		this.anInt10147 = local4.method3671();
		this.anInt10153 = local4.method3671();
		this.anInt10152 = local4.method3671();
		this.anInt10148 = local4.method3671();
		if (this.anInt10148 < 0) {
			this.anInt10148 = ~this.anInt10148;
			this.aBoolean737 = true;
		}
		@Pc(40) int local40 = local4.method3671();
		this.aByteArrayArray24 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method3642();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method3650(0, local49, local64);
			this.aByteArrayArray24[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!vp", name = "a", descriptor = "(I)[F")
	private float[] method8458(@OriginalArg(0) int arg0) {
		Static638.method8454(this.aByteArrayArray24[arg0]);
		Static638.method8455();
		@Pc(15) int local15 = Static638.method8459(Static187.method2726(Static638.anIntArray583.length - 1));
		@Pc(19) boolean local19 = Static638.aBooleanArray27[local15];
		@Pc(25) int local25 = local19 ? Static638.anInt10151 : Static638.anInt10146;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static638.method8455() != 0;
			local29 = Static638.method8455() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static638.anInt10146 >> 2);
			local67 = (local25 >> 2) + (Static638.anInt10146 >> 2);
			local71 = Static638.anInt10146 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static638.anInt10146 >> 2);
			local104 = local25 + (Static638.anInt10146 >> 2) - (local25 >> 2);
			local108 = Static638.anInt10146 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class181 local123 = Static638.aClass181Array1[Static638.anIntArray583[local15]];
		@Pc(126) int local126 = local123.anInt4319;
		@Pc(131) int local131 = local123.anIntArray261[local126];
		@Pc(140) boolean local140 = !Static638.aClass351Array1[local131].method8033();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt4318; local144++) {
			@Pc(152) Class78 local152 = Static638.aClass78Array1[local123.anIntArray262[local144]];
			local154 = Static638.aFloatArray71;
			local152.method1695(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt4319;
			local176 = local123.anIntArray261[local171];
			Static638.aClass351Array1[local176].method8036(Static638.aFloatArray71, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static638.aFloatArray71[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static638.aFloatArray71;
			...
			@Pc(252) float[] local252 = local19 ? Static638.aFloatArray72 : Static638.aFloatArray76;
			@Pc(258) float[] local258 = local19 ? Static638.aFloatArray70 : Static638.aFloatArray74;
			@Pc(264) float[] local264 = local19 ? Static638.aFloatArray75 : Static638.aFloatArray77;
			@Pc(270) int[] local270 = local19 ? Static638.anIntArray585 : Static638.anIntArray584;
			...
			@Pc(486) int local486 = Static187.method2726(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static638.aFloatArray71[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static638.aFloatArray71[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt10145 > 0) {
			local176 = this.anInt10145 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean738) {
				for (local212 = 0; local212 < this.anInt10150; local212++) {
					local1254 = (this.anInt10145 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static638.aFloatArray71[local212];
				}
			}
		}
		local154 = this.aFloatArray73;
		this.aFloatArray73 = Static638.aFloatArray71;
		Static638.aFloatArray71 = local154;
		this.anInt10145 = local25;
		this.anInt10150 = local104 - (local25 >> 1);
		this.aBoolean738 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!vp", name = "a", descriptor = "([I)Lclient!bc;")
	public Class5_Sub9_Sub1 method8463(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray104 == null) {
			this.anInt10145 = 0;
			this.aFloatArray73 = new float[Static638.anInt10151];
			this.aByteArray104 = new byte[this.anInt10153];
			this.anInt10155 = 0;
			this.anInt10156 = 0;
		}
		while (this.anInt10156 < this.aByteArrayArray24.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method8458(this.anInt10156);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt10155;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt10153 - local47) {
					local50 = this.anInt10153 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray104[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt10155;
				}
				this.anInt10155 = local47;
			}
			this.anInt10156++;
		}
		this.aFloatArray73 = null;
		@Pc(129) byte[] local129 = this.aByteArray104;
		this.aByteArray104 = null;
		return new Class5_Sub9_Sub1(this.anInt10147, local129, this.anInt10152, this.anInt10148, this.aBoolean737);
	}
}
