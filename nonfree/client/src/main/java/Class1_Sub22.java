...
public final class Class1_Sub22 extends Class1 {
	...
	public Class1_Sub22(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) boolean arg3) {
		this.anInt4062 = arg0;
		this.anInt4061 = arg1;
		this.anIntArray320 = arg2;
		if (arg3) {
			@Pc(16) int[] local16 = new int[this.anInt4061];
			@Pc(20) int[] local20 = new int[this.anInt4061];
			@Pc(24) int[] local24 = new int[this.anInt4061];
			if (Static203.anIntArray319 == null || Static203.anIntArray319.length < this.anIntArray320.length) {
				Static203.anIntArray319 = new int[this.anIntArray320.length];
			}
			@Pc(40) int local40 = this.anInt4061;
			@Pc(43) int local43 = this.anInt4061;
			...
			for (@Pc(61) int local61 = 2; local61 >= 0; local61--) {
				for (local64 = local47; local64 >= 0; local64--) {
					local58--;
					@Pc(71) int local71 = this.anIntArray320[local58];
			...
			for (@Pc(116) int local116 = local51; local116 >= 0; local116--) {
				...
				for (local64 = local47; local64 >= 0; local64--) {
					...
					local114--;
					Static203.anIntArray319[local114] = local165 << 16 | local169 << 8 | local173;
				...
				for (local64 = local47; local64 >= 0; local64--) {
					local58--;
					@Pc(236) int local236 = this.anIntArray320[local58];
					local59--;
					@Pc(242) int local242 = this.anIntArray320[local59];
			...
			@Pc(306) int[] local306 = this.anIntArray320;
			this.anIntArray320 = Static203.anIntArray319;
			Static203.anIntArray319 = local306;
		}
	}

	@OriginalMember(owner = "client!ik", name = "b", descriptor = "()[I")
	public int[] method3803() {
		return this.anIntArray320;
	}

	@OriginalMember(owner = "client!ik", name = "b", descriptor = "(II)V")
	public void method3804(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 == 0 && arg1 == 0) {
			return;
		}
		if (Static203.anIntArray319 == null || Static203.anIntArray319.length < this.anIntArray320.length) {
		...
		@Pc(21) int local21 = this.anIntArray320.length;
		@Pc(28) int local28 = this.anInt4061 - 1;
		@Pc(33) int local33 = this.anInt4061 * arg1;
		@Pc(37) int local37 = local21 - 1;
		for (@Pc(39) int local39 = 0; local39 < local21; local39 += this.anInt4061) {
			@Pc(46) int local46 = local39 + local33 & local37;
			for (@Pc(48) int local48 = 0; local48 < this.anInt4061; local48++) {
				@Pc(53) int local53 = local39 + local48;
				@Pc(61) int local61 = local46 + (local48 + arg0 & local28);
				Static203.anIntArray319[local53] = this.anIntArray320[local61];
			}
		}
		@Pc(84) int[] local84 = this.anIntArray320;
		this.anIntArray320 = Static203.anIntArray319;
		Static203.anIntArray319 = local84;
	}
}
