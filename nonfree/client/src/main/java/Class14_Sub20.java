...
public final class Class14_Sub20 extends Class14 {
	...
	@OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(ILclient!dh;)V")
	public Class14_Sub20(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub13 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(Lclient!dh;)V")
	public Class14_Sub20(@OriginalArg(0) Class2_Sub13 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!ph", name = "d", descriptor = "(I)I")
	public int method6845() {
	...
	public void method9035() {
		if (super.aClass2_Sub13_31.method2600() == Static557.aClass316_6) {
			super.anInt10835 = 2;
		}
