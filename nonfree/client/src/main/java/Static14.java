...
public final class Static14 {
	...
	public static JagString aClass22_115 = Static60.method1113("Suche nach Updates )2 ");

	@OriginalMember(owner = "client!cb", name = "ab", descriptor = "Lclient!ec;")
	public static JagString aClass22_116 = Static60.method1113("Untersuchen");

	@OriginalMember(owner = "client!cb", name = "cb", descriptor = "Lclient!ec;")
	public static JagString aClass22_117 = Static60.method1113("Stufe)2");
	...
	public static JagString aClass22_118 = Static60.method1113("Die Adresse dieses Computers wurde gesperrt)1");

	@OriginalMember(owner = "client!cb", name = "kb", descriptor = "Lclient!ec;")
	public static JagString aClass22_119 = Static60.method1113(":chalreq:");
	...
	public static void method276(@OriginalArg(1) IfType arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2) {
	...
	public static void method278(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		...
		Static101.aClass4_Sub1_Sub2_Sub4_Sub1_4.method1400(Static44.method856(new JagString[] { Static65.aClass22_491, Static134.method2042(GameShell.anInt2200) }), local50, local54, 16776960, -1);
		...
		Static101.aClass4_Sub1_Sub2_Sub4_Sub1_4.method1400(Static44.method856(new JagString[] { Static11.aClass22_931, Static134.method2042(local88), Static93.aClass22_734 }), local50, local79, local56, -1);
		local54 = local79 + 15;
	}

	@OriginalMember(owner = "client!cb", name = "b", descriptor = "(II)Lclient!o;")
	public static NpcType method279(@OriginalArg(1) int arg0) {
		@Pc(6) NpcType local6 = (NpcType) Static8.aClass33_27.method998((long) arg0);
		if (local6 != null) {
			return local6;
		}
		...
		if (local25 != null) {
			local6.method1435(new Packet(local25));
		}
		local6.method1439();
