...
public class Class180 {
	...
	@OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(Lclient!bf;[BI)V", line = 18)
	...
	@OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(Lclient!bf;Ljava/nio/ByteBuffer;)V", line = 28)
	...
	protected final void method6065(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1) {
