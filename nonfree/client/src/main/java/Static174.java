...
public final class Static174 {
	...
	@OriginalMember(owner = "client!l", name = "i", descriptor = "Lclient!oq;")
	...
	@OriginalMember(owner = "client!l", name = "a", descriptor = "(BI)Lclient!gb;")
	public static Class68 method3400(@OriginalArg(1) int arg0) {
		@Pc(10) Class68 local10 = (Class68) Static368.aClass21_182.method854((long) arg0);
		if (local10 != null) {
			return local10;
		}
		@Pc(25) byte[] local25 = Static336.aClass30_96.method1161(arg0, 30);
		local10 = new Class68();
		if (local25 != null) {
			local10.method2093(new Class1_Sub7(local25), arg0);
		}
		Static368.aClass21_182.method843(local10, (long) arg0);
		return local10;
	}

	@OriginalMember(owner = "client!l", name = "b", descriptor = "(I)V")
	public static void method3402() {
		Static48.aClass21_84.method857();
	}
}
