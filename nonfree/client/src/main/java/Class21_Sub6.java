...
public final class Class21_Sub6 extends Class21 {
	...
	@OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(Lclient!wr;)V")
	public Class21_Sub6(@OriginalArg(0) Class42_Sub1 arg0) {
		super(arg0);
	}
	...
	@OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lclient!baa;II)V")
	@Override
