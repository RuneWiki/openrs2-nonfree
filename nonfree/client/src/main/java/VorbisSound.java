...
public final class Class4_Sub17 extends Linkable {
	...
	private float[] method1288(@OriginalArg(0) int arg0) {
		...
		for (@Pc(144) int local144 = 0; local144 < local123.anInt3106; local144++) {
			@Pc(152) VorbisResidue local152 = Static77.aClass74Array1[local123.anIntArray341[local144]];
	...
	public PcmSound method1290(@OriginalArg(0) int[] arg0) {
		...
		return new PcmSound(this.anInt2033, local129, this.anInt2037, this.anInt2039, this.aBoolean176);
	}
}
