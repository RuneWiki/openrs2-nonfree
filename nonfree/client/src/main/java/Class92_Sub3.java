...
public final class Class92_Sub3 extends Class92 {
	...
	@OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Lclient!sv;)V")
	public Class92_Sub3(@OriginalArg(0) Class121_Sub2 arg0) {
		super(arg0);
	}
	...
	@OriginalMember(owner = "client!kc", name = "a", descriptor = "(IILclient!aw;)V")
	@Override
