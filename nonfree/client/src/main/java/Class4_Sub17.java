...
public final class Class4_Sub17 extends Class4 {
	...
	private void method1286(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class4_Sub11 local4 = new Class4_Sub11(arg0);
		this.anInt2033 = local4.method725();
		this.anInt2036 = local4.method725();
		this.anInt2037 = local4.method725();
		this.anInt2039 = local4.method725();
		if (this.anInt2039 < 0) {
			this.anInt2039 = ~this.anInt2039;
			this.aBoolean176 = true;
		}
		@Pc(40) int local40 = local4.method725();
		this.aByteArrayArray5 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method719();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method744(local49, local64);
			this.aByteArrayArray5[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!nc", name = "d", descriptor = "(I)[F")
	private float[] method1288(@OriginalArg(0) int arg0) {
		Static77.method1293(this.aByteArrayArray5[arg0]);
		Static77.method1289();
		@Pc(15) int local15 = Static77.method1296(Static124.method1889(Static77.anIntArray204.length - 1));
		@Pc(19) boolean local19 = Static77.aBooleanArray15[local15];
		@Pc(25) int local25 = local19 ? Static77.anInt2040 : Static77.anInt2042;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static77.method1289() != 0;
			local29 = Static77.method1289() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static77.anInt2042 >> 2);
			local67 = (local25 >> 2) + (Static77.anInt2042 >> 2);
			local71 = Static77.anInt2042 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static77.anInt2042 >> 2);
			local104 = local25 + (Static77.anInt2042 >> 2) - (local25 >> 2);
			local108 = Static77.anInt2042 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		...
		for (@Pc(144) int local144 = 0; local144 < local123.anInt3106; local144++) {
			@Pc(152) Class74 local152 = Static77.aClass74Array1[local123.anIntArray341[local144]];
			local154 = Static77.aFloatArray4;
			local152.method1829(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt3107;
			local176 = local123.anIntArray342[local171];
			Static77.aClass41Array1[local176].method1126(Static77.aFloatArray4, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static77.aFloatArray4[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static77.aFloatArray4;
			...
			@Pc(252) float[] local252 = local19 ? Static77.aFloatArray6 : Static77.aFloatArray2;
			@Pc(258) float[] local258 = local19 ? Static77.aFloatArray9 : Static77.aFloatArray5;
			@Pc(264) float[] local264 = local19 ? Static77.aFloatArray7 : Static77.aFloatArray8;
			@Pc(270) int[] local270 = local19 ? Static77.anIntArray202 : Static77.anIntArray203;
			...
			@Pc(486) int local486 = Static124.method1889(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static77.aFloatArray4[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static77.aFloatArray4[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt2035 > 0) {
			local176 = this.anInt2035 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean177) {
				for (local212 = 0; local212 < this.anInt2034; local212++) {
					local1254 = (this.anInt2035 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static77.aFloatArray4[local212];
				}
			}
		}
		local154 = this.aFloatArray3;
		this.aFloatArray3 = Static77.aFloatArray4;
		Static77.aFloatArray4 = local154;
		this.anInt2035 = local25;
		this.anInt2034 = local104 - (local25 >> 1);
		this.aBoolean177 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!nc", name = "a", descriptor = "([I)Lclient!ib;")
	public Class4_Sub13_Sub1 method1290(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray27 == null) {
			this.anInt2035 = 0;
			this.aFloatArray3 = new float[Static77.anInt2040];
			this.aByteArray27 = new byte[this.anInt2036];
			this.anInt2041 = 0;
			this.anInt2043 = 0;
		}
		while (this.anInt2043 < this.aByteArrayArray5.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1288(this.anInt2043);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2041;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt2036 - local47) {
					local50 = this.anInt2036 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2041;
				}
				this.anInt2041 = local47;
			}
			this.anInt2043++;
		}
		...
		return new Class4_Sub13_Sub1(this.anInt2033, local129, this.anInt2037, this.anInt2039, this.aBoolean176);
	}
}
