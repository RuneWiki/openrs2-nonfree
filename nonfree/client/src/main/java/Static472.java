...
public final class Static472 {
	...
	@OriginalMember(owner = "client!tp", name = "g", descriptor = "Lclient!uv;")
	public static final Class296 aClass296_343 = new Class296(46, 8);

	@OriginalMember(owner = "client!tp", name = "i", descriptor = "Z")
	public static boolean aBoolean562 = false;

	@OriginalMember(owner = "client!tp", name = "a", descriptor = "(II)Lclient!ar;")
	public static Class1_Sub3 method6572(@OriginalArg(0) int arg0) {
		if (arg0 == 0) {
			...
			return new Class1_Sub3_Sub11_Sub1();
		} else if (arg0 == 19) {
