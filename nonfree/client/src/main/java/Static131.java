...
public final class Static131 {
	...
	@OriginalMember(owner = "client!i", name = "a", descriptor = "(I[B[IIIIIIIILclient!i;)I")
	public static int method915(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub8_Sub1 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt1434 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!i", name = "a", descriptor = "([B[IIIIIIILclient!i;)I")
	public static int method916(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub8_Sub1 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt1434 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!i", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!i;II)I")
	public static int method917(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub8_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1433 -= arg10.anInt1438 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt1433 += arg10.anInt1438 * local63;
		arg10.anInt1429 = arg4;
		arg10.anInt1437 = arg5;
		arg10.anInt1434 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!i", name = "a", descriptor = "(II[B[IIIIIIIILclient!i;II)I")
	public static int method918(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub8_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1429 -= arg8.anInt1442 * arg3;
		arg8.anInt1437 -= arg8.anInt1431 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!i", name = "a", descriptor = "(II[B[IIIIIIILclient!i;II)I")
	public static int method919(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub8_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!i", name = "a", descriptor = "(Lclient!pd;III)Lclient!i;")
	public static Class1_Sub8_Sub1 method920(@OriginalArg(0) Class1_Sub16_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray72 == null || arg0.aByteArray72.length == 0 ? null : new Class1_Sub8_Sub1(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!i", name = "b", descriptor = "(II)I")
	public static int method924(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!i", name = "b", descriptor = "(II[B[IIIIIIILclient!i;II)I")
	public static int method926(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub8_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!i", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!i;II)I")
	public static int method927(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class1_Sub8_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1433 -= arg10.anInt1438 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!i", name = "b", descriptor = "(II[B[IIIIIIIILclient!i;II)I")
	public static int method928(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub8_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1429 -= arg8.anInt1442 * arg3;
		arg8.anInt1437 -= arg8.anInt1431 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!i", name = "a", descriptor = "([B[IIIIIIIILclient!i;)I")
	public static int method930(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub8_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1429 += arg8.anInt1442 * (local24 - arg3);
		arg8.anInt1437 += arg8.anInt1431 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt1433 = arg4 >> 2;
		arg8.anInt1434 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!i", name = "d", descriptor = "(II)I")
	public static int method931(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!i", name = "b", descriptor = "([B[IIIIIIILclient!i;)I")
	public static int method934(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub8_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!i", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!i;)I")
	public static int method935(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub8_Sub1 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt1433 += arg10.anInt1438 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt1429 = arg4 >> 2;
		arg10.anInt1437 = arg5 >> 2;
		arg10.anInt1434 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!i", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!i;)I")
	public static int method937(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class1_Sub8_Sub1 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt1433 += arg10.anInt1438 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!i", name = "c", descriptor = "(II[B[IIIIIIIILclient!i;II)I")
	public static int method941(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub8_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!i", name = "d", descriptor = "(II[B[IIIIIIIILclient!i;II)I")
	public static int method943(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class1_Sub8_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!i", name = "b", descriptor = "(I[B[IIIIIIIILclient!i;)I")
	public static int method944(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class1_Sub8_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!i", name = "b", descriptor = "([B[IIIIIIIILclient!i;)I")
	public static int method947(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class1_Sub8_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1429 += arg8.anInt1442 * (local22 - arg3);
		arg8.anInt1437 += arg8.anInt1431 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!i", name = "a", descriptor = "(Lclient!pd;II)Lclient!i;")
	public static Class1_Sub8_Sub1 method948(@OriginalArg(0) Class1_Sub16_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray72 == null || arg0.aByteArray72.length == 0 ? null : new Class1_Sub8_Sub1(arg0, (int) ((long) arg0.anInt2191 * 256L * (long) 100 / (long) (Static44.anInt1243 * 100)), arg1 << 6);
	}
}
