...
public final class Static131 {
	...
	@OriginalMember(owner = "client!ba", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!ba;)I")
	public static int method164(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub2_Sub1 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt237 += arg10.anInt241 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt236 = arg4 >> 2;
		arg10.anInt232 = arg5 >> 2;
		arg10.anInt235 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!ba", name = "a", descriptor = "([B[IIIIIIILclient!ba;)I")
	public static int method166(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub2_Sub1 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt235 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ba", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!ba;)I")
	public static int method169(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub2_Sub1 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt237 += arg10.anInt241 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!ba", name = "a", descriptor = "(Lclient!fc;II)Lclient!ba;")
	public static Class3_Sub2_Sub1 method170(@OriginalArg(0) Class3_Sub9_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray32 == null || arg0.aByteArray32.length == 0 ? null : new Class3_Sub2_Sub1(arg0, (int) ((long) arg0.anInt1103 * 256L * (long) 100 / (long) (Static68.anInt2134 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!ba", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!ba;II)I")
	public static int method173(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub2_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt237 -= arg10.anInt241 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt237 += arg10.anInt241 * local63;
		arg10.anInt236 = arg4;
		arg10.anInt232 = arg5;
		arg10.anInt235 = arg2;
		return local63;
	...
	@OriginalMember(owner = "client!ba", name = "a", descriptor = "(II[B[IIIIIIIILclient!ba;II)I")
	public static int method174(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub2_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ba", name = "a", descriptor = "([B[IIIIIIIILclient!ba;)I")
	public static int method175(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub2_Sub1 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt236 += arg8.anInt245 * (local24 - arg3);
		arg8.anInt232 += arg8.anInt238 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt237 = arg4 >> 2;
		arg8.anInt235 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ba", name = "a", descriptor = "(I[B[IIIIIIIILclient!ba;)I")
	public static int method178(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub2_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!ba", name = "b", descriptor = "([B[IIIIIIILclient!ba;)I")
	public static int method180(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub2_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!ba", name = "b", descriptor = "(II[B[IIIIIIIILclient!ba;II)I")
	public static int method183(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub2_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt236 -= arg8.anInt245 * arg3;
		arg8.anInt232 -= arg8.anInt238 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ba", name = "a", descriptor = "(Lclient!fc;III)Lclient!ba;")
	public static Class3_Sub2_Sub1 method185(@OriginalArg(0) Class3_Sub9_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray32 == null || arg0.aByteArray32.length == 0 ? null : new Class3_Sub2_Sub1(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!ba", name = "b", descriptor = "([B[IIIIIIIILclient!ba;)I")
	public static int method186(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub2_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt236 += arg8.anInt245 * (local22 - arg3);
		arg8.anInt232 += arg8.anInt238 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!ba", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!ba;II)I")
	public static int method187(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub2_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt237 -= arg10.anInt241 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!ba", name = "b", descriptor = "(I[B[IIIIIIIILclient!ba;)I")
	public static int method188(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub2_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!ba", name = "a", descriptor = "(II[B[IIIIIIILclient!ba;II)I")
	public static int method190(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub2_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ba", name = "c", descriptor = "(II[B[IIIIIIIILclient!ba;II)I")
	public static int method192(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub2_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ba", name = "d", descriptor = "(II[B[IIIIIIIILclient!ba;II)I")
	public static int method194(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub2_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt236 -= arg8.anInt245 * arg3;
		arg8.anInt232 -= arg8.anInt238 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ba", name = "b", descriptor = "(II[B[IIIIIIILclient!ba;II)I")
	public static int method197(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub2_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	public static int method198(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ba", name = "e", descriptor = "(II)I")
	public static int method200(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
