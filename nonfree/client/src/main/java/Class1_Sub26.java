...
public final class Class1_Sub26 extends Class1 {
	...
	public Class1_Sub26(@OriginalArg(0) byte[] arg0) {
		this.method4076(arg0);
	}

	@OriginalMember(owner = "client!jw", name = "a", descriptor = "([I)Lclient!qk;")
	public Class1_Sub32_Sub1 method4068(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray67 == null) {
			this.anInt4654 = 0;
			this.aFloatArray43 = new float[Static240.anInt4657];
			this.aByteArray67 = new byte[this.anInt4653];
			this.anInt4658 = 0;
			this.anInt4659 = 0;
		}
		while (this.anInt4659 < this.aByteArrayArray21.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method4070(this.anInt4659);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt4658;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt4653 - local47) {
					local50 = this.anInt4653 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray67[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt4658;
				}
				this.anInt4658 = local47;
			}
			this.anInt4659++;
		}
		this.aFloatArray43 = null;
		@Pc(129) byte[] local129 = this.aByteArray67;
		this.aByteArray67 = null;
		return new Class1_Sub32_Sub1(this.anInt4652, local129, this.anInt4648, this.anInt4656, this.aBoolean285);
	}

	@OriginalMember(owner = "client!jw", name = "b", descriptor = "(I)[F")
	private float[] method4070(@OriginalArg(0) int arg0) {
		Static240.method4074(this.aByteArrayArray21[arg0]);
		Static240.method4067();
		@Pc(15) int local15 = Static240.method4069(Static124.method4359(Static240.anIntArray341.length - 1));
		@Pc(19) boolean local19 = Static240.aBooleanArray19[local15];
		@Pc(25) int local25 = local19 ? Static240.anInt4657 : Static240.anInt4649;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static240.method4067() != 0;
			local29 = Static240.method4067() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static240.anInt4649 >> 2);
			local67 = (local25 >> 2) + (Static240.anInt4649 >> 2);
			local71 = Static240.anInt4649 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static240.anInt4649 >> 2);
			local104 = local25 + (Static240.anInt4649 >> 2) - (local25 >> 2);
			local108 = Static240.anInt4649 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class164 local123 = Static240.aClass164Array1[Static240.anIntArray341[local15]];
		@Pc(126) int local126 = local123.anInt4936;
		@Pc(131) int local131 = local123.anIntArray353[local126];
		@Pc(140) boolean local140 = !Static240.aClass209Array1[local131].method5378();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt4937; local144++) {
			@Pc(152) Class66 local152 = Static240.aClass66Array1[local123.anIntArray352[local144]];
			local154 = Static240.aFloatArray37;
			local152.method2186(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt4936;
			local176 = local123.anIntArray353[local171];
			Static240.aClass209Array1[local176].method5381(Static240.aFloatArray37, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static240.aFloatArray37[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static240.aFloatArray37;
			...
			@Pc(252) float[] local252 = local19 ? Static240.aFloatArray44 : Static240.aFloatArray42;
			@Pc(258) float[] local258 = local19 ? Static240.aFloatArray41 : Static240.aFloatArray38;
			@Pc(264) float[] local264 = local19 ? Static240.aFloatArray39 : Static240.aFloatArray40;
			@Pc(270) int[] local270 = local19 ? Static240.anIntArray339 : Static240.anIntArray340;
			...
			@Pc(486) int local486 = Static124.method4359(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static240.aFloatArray37[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static240.aFloatArray37[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt4654 > 0) {
			local176 = this.anInt4654 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean283) {
				for (local212 = 0; local212 < this.anInt4651; local212++) {
					local1254 = (this.anInt4654 >> 1) + local212;
					local1228[local212] += this.aFloatArray43[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static240.aFloatArray37[local212];
				}
			}
		}
		local154 = this.aFloatArray43;
		this.aFloatArray43 = Static240.aFloatArray37;
		Static240.aFloatArray37 = local154;
		this.anInt4654 = local25;
		this.anInt4651 = local104 - (local25 >> 1);
		this.aBoolean283 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!jw", name = "b", descriptor = "([B)V")
	private void method4076(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub13 local4 = new Class1_Sub13(arg0);
		this.anInt4652 = local4.method3037();
		this.anInt4653 = local4.method3037();
		this.anInt4648 = local4.method3037();
		this.anInt4656 = local4.method3037();
		if (this.anInt4656 < 0) {
			this.anInt4656 = ~this.anInt4656;
			this.aBoolean285 = true;
		}
		@Pc(40) int local40 = local4.method3037();
		this.aByteArrayArray21 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method3043();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method3071(local64, local49);
