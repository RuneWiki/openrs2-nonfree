...
public final class Class5 {
	...
	public static void method52(@OriginalArg(0) Class39 arg0) {
		aClass1_Sub3_Sub3_3 = new Class1_Sub3_Sub3(363, arg0.method536("obj.dat", null));
		@Pc(21) Class1_Sub3_Sub3 local21 = new Class1_Sub3_Sub3(363, arg0.method536("obj.idx", null));
	...
	public static void method53() {
		try {
			...
			signlink.reporterror("12851, " + true + ", " + local15.toString());
	...
	public static Class1_Sub3_Sub2_Sub2 method59(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1) {
		try {
			...
			local38 = Class1_Sub3_Sub2_Sub1.anInt430;
			local40 = Class1_Sub3_Sub2_Sub1.anInt431;
			@Pc(80) int[] local80 = Class1_Sub3_Sub2_Sub1.anIntArray139;
			@Pc(82) int[] local82 = Class1_Sub3_Sub2.anIntArray178;
			@Pc(84) int local84 = Class1_Sub3_Sub2.anInt528;
			@Pc(86) int local86 = Class1_Sub3_Sub2.anInt529;
			@Pc(88) int local88 = Class1_Sub3_Sub2.anInt532;
			@Pc(90) int local90 = Class1_Sub3_Sub2.anInt533;
			@Pc(92) int local92 = Class1_Sub3_Sub2.anInt530;
			@Pc(94) int local94 = Class1_Sub3_Sub2.anInt531;
			Class1_Sub3_Sub2_Sub1.aBoolean99 = false;
			Class1_Sub3_Sub2.method354(32, local7.anIntArray148, 32);
			Class1_Sub3_Sub2.method358(0, 0, 0, 32, 32);
			...
			if (local28.anInt124 != -1) {
				@Pc(348) Class1_Sub3_Sub2_Sub2 local348 = method59(local28.anInt123, 10);
				@Pc(351) int local351 = local348.anInt465;
				@Pc(354) int local354 = local348.anInt466;
				local348.anInt465 = 32;
				local348.anInt466 = 32;
				local348.method324(22, 5, 22, 5);
				local348.anInt465 = local351;
				local348.anInt466 = local354;
			}
			aClass35_5.method528((long) arg0, local7);
			Class1_Sub3_Sub2.method354(local84, local82, local86);
			Class1_Sub3_Sub2.method356(local94, local92, local90, local88);
			Class1_Sub3_Sub2_Sub1.anInt430 = local38;
			Class1_Sub3_Sub2_Sub1.anInt431 = local40;
			...
			signlink.reporterror("43278, " + arg0 + ", " + 24638 + ", " + arg1 + ", " + local415.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method56(@OriginalArg(1) Class1_Sub3_Sub3 arg0) {
		try {
			while (true) {
			...
			signlink.reporterror("9273, " + false + ", " + arg0 + ", " + local406.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method57() {
		try {
			@Pc(3) Class5 local3 = method54(this.anInt124);
			...
			@Pc(55) Class5 local55 = method54(this.anInt123);
			...
			signlink.reporterror("96838, " + -856 + ", " + local113.toString());
			throw new RuntimeException();
		}
	}
	...
	public Class1_Sub3_Sub1 method58(@OriginalArg(0) int arg0) {
		...
		@Pc(48) Class1_Sub3_Sub1 local48 = (Class1_Sub3_Sub1) aClass35_4.method527((long) this.anInt103);
		if (local48 != null) {
			return local48;
		}
		...
		aClass35_4.method528((long) this.anInt103, local48);
		return local48;
	}

	@OriginalMember(owner = "client!cc", name = "a", descriptor = "(BI)Lclient!eb;")
	public Class1_Sub3_Sub1 method60(@OriginalArg(1) int arg0) {
		try {
			...
			signlink.reporterror("95348, " + 6 + ", " + arg0 + ", " + local160.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!cc", name = "a", descriptor = "(II)Lclient!eb;")
	public Class1_Sub3_Sub1 method61(@OriginalArg(1) int arg0) {
		try {
			...
			signlink.reporterror("22260, " + -22246 + ", " + arg0 + ", " + local87.toString());
			throw new RuntimeException();
		}
	}
}
