...
public final class Class5 implements Interface1 {
	...
	public Class5() {
		if (this.anInt124 < 0 && (Static277.aBoolean413 && Static277.anInt5352 >= 2)) {
			@Pc(19) int[] local19 = new int[1];
			@Pc(21) GL local21 = Static277.aGL1;
			local21.glGenProgramsARB(1, local19, 0);
			this.anInt125 = local19[0];
			@Pc(42) int[][] local42 = Static273.method4166(0.4F);
			@Pc(53) int[][] local53 = Static273.method4166(0.4F);
			@Pc(58) Class1_Sub11 local58 = new Class1_Sub11(262144);
			for (@Pc(60) int local60 = 0; local60 < 256; local60++) {
				...
				for (@Pc(73) int local73 = 0; local73 < 64; local73++) {
					if (Static277.aBoolean418) {
						local58.method2684((float) local67[local73] / 4096.0F);
						local58.method2684((float) local71[local73] / 4096.0F);
						local58.method2684(1.0F);
						local58.method2684(1.0F);
					} else {
						local58.method2642((float) local67[local73] / 4096.0F);
						local58.method2642((float) local71[local73] / 4096.0F);
						local58.method2642(1.0F);
						local58.method2642(1.0F);
					}
				}
			}
			@Pc(141) ByteBuffer local141 = ByteBuffer.allocateDirect(local58.anInt3264).order(ByteOrder.nativeOrder());
			local141.put(local58.aByteArray47, 0, local58.anInt3264);
			local141.flip();
	...
	public void method4018() {
		...
		local5.glCallList(this.anInt124);
		local5.glActiveTexture(33985);
		local5.glMatrixMode(5890);
		local5.glTranslatef((float) Static104.anInt2460, (float) Static163.anInt3498, (float) Static91.anInt2044);
		local5.glRotatef(-((float) Static68.anInt1455 * 360.0F) / 2048.0F, 0.0F, 1.0F, 0.0F);
		local5.glRotatef(-((float) Static156.anInt1435 * 360.0F) / 2048.0F, 1.0F, 0.0F, 0.0F);
		local5.glRotatef(-180.0F, 1.0F, 0.0F, 0.0F);
		local5.glMatrixMode(5888);
		if (!Static27.aBoolean53) {
			local5.glBindTexture(3553, Static27.anIntArray73[(int) ((float) (Static277.anInt5361 * 64) * 0.005F) % 64]);
		}
		local5.glActiveTexture(33984);
		if (this.anInt126 == Static277.anInt5361) {
			return;
		}
		@Pc(85) int local85 = (Static277.anInt5361 & 0xFF) * 256;
		...
		if (Static27.aBoolean53) {
			local5.glProgramLocalParameter4fARB(34336, 65, (float) Static277.anInt5361 * 0.005F, 0.0F, 0.0F, 1.0F);
		} else {
			local5.glProgramLocalParameter4fARB(34336, 65, 0.0F, 0.0F, 0.0F, 1.0F);
		}
		this.anInt126 = Static277.anInt5361;
	}
	...
	private void method154() {
		...
		local4.glBindProgramARB(34336, this.anInt125);
	...
	private void method155() {
		...
		this.anInt124 = local1.glGenLists(2);
		local1.glNewList(this.anInt124, 4864);
		...
		local1.glBindProgramARB(34336, this.anInt125);
		local1.glEnable(34336);
		local1.glEndList();
		local1.glNewList(this.anInt124 + 1, 4864);
		local1.glActiveTexture(33985);
		...
		local1.glDisable(Static27.aBoolean53 ? 32879 : 3553);
		local1.glActiveTexture(33984);
	...
	public void method4017(@OriginalArg(0) int arg0) {
		...
		local5.glActiveTexture(33985);
		if ((arg0 & 0x80) == 0) {
			local5.glEnable(Static27.aBoolean53 ? 32879 : 3553);
		} else {
			local5.glDisable(Static27.aBoolean53 ? 32879 : 3553);
		}
		local5.glActiveTexture(33984);
		if ((arg0 & 0x40) == 0) {
			local5.glGetFloatv(2899, Static4.aFloatArray1, 0);
			local5.glProgramLocalParameter4fvARB(34336, 66, Static4.aFloatArray1, 0);
		} else {
	...
	public void method4019() {
		if (this.anInt124 >= 0) {
			@Pc(5) GL local5 = Static277.aGL1;
			local5.glCallList(this.anInt124 + 1);
		}
	}
}
