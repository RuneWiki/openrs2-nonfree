...
public final class Class2_Sub20 extends Class2 {
	...
	@OriginalMember(owner = "client!go", name = "a", descriptor = "([I)Lclient!oaa;")
	public Class2_Sub7_Sub1 method3065(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray40 == null) {
			this.anInt3728 = 0;
			this.aFloatArray31 = new float[Static178.anInt3730];
			this.aByteArray40 = new byte[this.anInt3724];
			this.anInt3732 = 0;
			this.anInt3733 = 0;
		}
		while (this.anInt3733 < this.aByteArrayArray15.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method3068(this.anInt3733);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt3732;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt3724 - local47) {
					local50 = this.anInt3724 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray40[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt3732;
				}
				this.anInt3732 = local47;
			}
			this.anInt3733++;
		}
		this.aFloatArray31 = null;
		@Pc(129) byte[] local129 = this.aByteArray40;
		this.aByteArray40 = null;
		return new Class2_Sub7_Sub1(this.anInt3726, local129, this.anInt3727, this.anInt3723, this.aBoolean306);
	}

	@OriginalMember(owner = "client!go", name = "b", descriptor = "(I)[F")
	private float[] method3068(@OriginalArg(0) int arg0) {
		Static178.method3064(this.aByteArrayArray15[arg0]);
		Static178.method3072();
		@Pc(15) int local15 = Static178.method3071(Static233.method3626(Static178.anIntArray210.length - 1));
		@Pc(19) boolean local19 = Static178.aBooleanArray17[local15];
		@Pc(25) int local25 = local19 ? Static178.anInt3730 : Static178.anInt3729;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static178.method3072() != 0;
			local29 = Static178.method3072() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static178.anInt3729 >> 2);
			local67 = (local25 >> 2) + (Static178.anInt3729 >> 2);
			local71 = Static178.anInt3729 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static178.anInt3729 >> 2);
			local104 = local25 + (Static178.anInt3729 >> 2) - (local25 >> 2);
			local108 = Static178.anInt3729 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class341 local123 = Static178.aClass341Array1[Static178.anIntArray210[local15]];
		@Pc(126) int local126 = local123.anInt9123;
		@Pc(131) int local131 = local123.anIntArray662[local126];
		@Pc(140) boolean local140 = !Static178.aClass168Array1[local131].method3716();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt9122; local144++) {
			@Pc(152) Class60 local152 = Static178.aClass60Array1[local123.anIntArray661[local144]];
			local154 = Static178.aFloatArray28;
			local152.method1166(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt9123;
			local176 = local123.anIntArray662[local171];
			Static178.aClass168Array1[local176].method3709(Static178.aFloatArray28, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static178.aFloatArray28[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static178.aFloatArray28;
			...
			@Pc(252) float[] local252 = local19 ? Static178.aFloatArray29 : Static178.aFloatArray30;
			@Pc(258) float[] local258 = local19 ? Static178.aFloatArray25 : Static178.aFloatArray26;
			@Pc(264) float[] local264 = local19 ? Static178.aFloatArray27 : Static178.aFloatArray32;
			@Pc(270) int[] local270 = local19 ? Static178.anIntArray208 : Static178.anIntArray209;
			...
			@Pc(486) int local486 = Static233.method3626(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static178.aFloatArray28[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static178.aFloatArray28[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt3728 > 0) {
			local176 = this.anInt3728 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean307) {
				for (local212 = 0; local212 < this.anInt3725; local212++) {
					local1254 = (this.anInt3728 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static178.aFloatArray28[local212];
				}
			}
		}
		local154 = this.aFloatArray31;
		this.aFloatArray31 = Static178.aFloatArray28;
		Static178.aFloatArray28 = local154;
		this.anInt3728 = local25;
		this.anInt3725 = local104 - (local25 >> 1);
		this.aBoolean307 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!go", name = "b", descriptor = "([B)V")
	private void method3069(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub15 local4 = new Class2_Sub15(arg0);
		this.anInt3726 = local4.method4307();
		this.anInt3724 = local4.method4307();
		this.anInt3727 = local4.method4307();
		this.anInt3723 = local4.method4307();
		if (this.anInt3723 < 0) {
			this.anInt3723 = ~this.anInt3723;
			this.aBoolean306 = true;
		}
		@Pc(40) int local40 = local4.method4307();
		this.aByteArrayArray15 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method4325();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method4346(local64, local49);
