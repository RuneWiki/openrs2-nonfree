...
public final class Class2_Sub20 extends Class2 {
	...
	@OriginalMember(owner = "client!rw", name = "<init>", descriptor = "(ILclient!mfa;)V")
	public Class2_Sub20(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub36 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!rw", name = "<init>", descriptor = "(Lclient!mfa;)V")
	public Class2_Sub20(@OriginalArg(0) Class5_Sub36 arg0) {
		super(arg0);
	}
