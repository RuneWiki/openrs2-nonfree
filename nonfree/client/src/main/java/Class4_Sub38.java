...
public final class Class4_Sub38 extends Class4 {
	...
	private float[] method5079(@OriginalArg(0) int arg0) {
		Static300.method5085(this.aByteArrayArray22[arg0]);
		Static300.method5084();
		@Pc(15) int local15 = Static300.method5083(Static244.method4232(Static300.anIntArray496.length - 1));
		@Pc(19) boolean local19 = Static300.aBooleanArray29[local15];
		@Pc(25) int local25 = local19 ? Static300.anInt6048 : Static300.anInt6047;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static300.method5084() != 0;
			local29 = Static300.method5084() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static300.anInt6047 >> 2);
			local67 = (local25 >> 2) + (Static300.anInt6047 >> 2);
			local71 = Static300.anInt6047 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static300.anInt6047 >> 2);
			local104 = local25 + (Static300.anInt6047 >> 2) - (local25 >> 2);
			local108 = Static300.anInt6047 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class157 local123 = Static300.aClass157Array1[Static300.anIntArray496[local15]];
		@Pc(126) int local126 = local123.anInt5144;
		@Pc(131) int local131 = local123.anIntArray420[local126];
		@Pc(140) boolean local140 = !Static300.aClass37Array1[local131].method805();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt5143; local144++) {
			@Pc(152) Class104 local152 = Static300.aClass104Array1[local123.anIntArray421[local144]];
			local154 = Static300.aFloatArray26;
			local152.method2871(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt5144;
			local176 = local123.anIntArray420[local171];
			Static300.aClass37Array1[local176].method803(Static300.aFloatArray26, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static300.aFloatArray26[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static300.aFloatArray26;
			...
			@Pc(252) float[] local252 = local19 ? Static300.aFloatArray22 : Static300.aFloatArray23;
			@Pc(258) float[] local258 = local19 ? Static300.aFloatArray20 : Static300.aFloatArray21;
			@Pc(264) float[] local264 = local19 ? Static300.aFloatArray25 : Static300.aFloatArray24;
			@Pc(270) int[] local270 = local19 ? Static300.anIntArray495 : Static300.anIntArray494;
			...
			@Pc(486) int local486 = Static244.method4232(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static300.aFloatArray26[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static300.aFloatArray26[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt6049 > 0) {
			local176 = this.anInt6049 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean529) {
				for (local212 = 0; local212 < this.anInt6052; local212++) {
					local1254 = (this.anInt6049 >> 1) + local212;
					local1228[local212] += this.aFloatArray19[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static300.aFloatArray26[local212];
				}
			}
		}
		local154 = this.aFloatArray19;
		this.aFloatArray19 = Static300.aFloatArray26;
		Static300.aFloatArray26 = local154;
		this.anInt6049 = local25;
		this.anInt6052 = local104 - (local25 >> 1);
		this.aBoolean529 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!tb", name = "a", descriptor = "([I)Lclient!wo;")
	public Class4_Sub5_Sub1 method5082(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray88 == null) {
			this.anInt6049 = 0;
			this.aFloatArray19 = new float[Static300.anInt6048];
			this.aByteArray88 = new byte[this.anInt6054];
			this.anInt6056 = 0;
			this.anInt6055 = 0;
		}
		while (this.anInt6055 < this.aByteArrayArray22.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method5079(this.anInt6055);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt6056;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt6054 - local47) {
					local50 = this.anInt6054 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray88[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt6056;
				}
				this.anInt6056 = local47;
			}
			this.anInt6055++;
		}
		this.aFloatArray19 = null;
		@Pc(129) byte[] local129 = this.aByteArray88;
		this.aByteArray88 = null;
		return new Class4_Sub5_Sub1(this.anInt6050, local129, this.anInt6045, this.anInt6046, this.aBoolean531);
	}

	@OriginalMember(owner = "client!tb", name = "b", descriptor = "([B)V")
	private void method5087(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class4_Sub7 local4 = new Class4_Sub7(arg0);
		this.anInt6050 = local4.method2389();
		this.anInt6054 = local4.method2389();
		this.anInt6045 = local4.method2389();
		this.anInt6046 = local4.method2389();
		if (this.anInt6046 < 0) {
			this.anInt6046 = ~this.anInt6046;
			this.aBoolean531 = true;
		}
		@Pc(40) int local40 = local4.method2389();
		this.aByteArrayArray22 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method2380();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method2381(local64, local49);
