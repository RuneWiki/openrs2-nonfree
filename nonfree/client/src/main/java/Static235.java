...
public final class Static235 {
	...
	@OriginalMember(owner = "client!jj", name = "a", descriptor = "(II)Lclient!vm;")
	public static Class6_Sub3 method3423(@OriginalArg(1) int arg0) {
		if (arg0 == 0) {
			...
			return new Class6_Sub3_Sub7_Sub1();
		} else if (arg0 == 19) {
