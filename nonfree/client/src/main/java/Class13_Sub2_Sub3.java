...
public final class Class13_Sub2_Sub3 extends Class13_Sub2 {

	@OriginalMember(owner = "client!wo", name = "H", descriptor = "[I")
	private final int[] anIntArray640;

	@OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lclient!ms;[IIIII)V")
	public Class13_Sub2_Sub3(@OriginalArg(0) Class163_Sub1 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		super(arg0, arg4, arg5);
		this.anIntArray640 = new int[arg4 * arg5];
		...
		for (@Pc(19) int local19 = 0; local19 < arg5; local19++) {
			for (@Pc(22) int local22 = 0; local22 < arg4; local22++) {
				this.anIntArray640[local17++] = arg1[arg2++];
			}
			arg2 += local15;
		}
	}

	@OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lclient!ms;[III)V")
	public Class13_Sub2_Sub3(@OriginalArg(0) Class163_Sub1 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		super(arg0, arg2, arg3);
		this.anIntArray640 = arg1;
	}
		...
		if (arg2 == 1) {
			for (local492 = -local32; local492 < 0; local492++) {
				for (local496 = -local35; local496 < 0; local496++) {
					local503 = this.anIntArray640[local29++];
		...
		if (arg2 == 0) {
			if ((arg3 & 0xFFFFFF) == 16777215) {
				...
				for (local507 = -local32; local507 < 0; local507++) {
					for (local511 = -local35; local511 < 0; local511++) {
						local515 = this.anIntArray640[local29++];
			...
			for (local511 = -local32; local511 < 0; local511++) {
				for (local515 = -local35; local515 < 0; local515++) {
					local690 = this.anIntArray640[local29++];
	...
	public void oa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(25) int local25;
		if (arg2 == 0) {
			local5 = super.aClass163_Sub1_11.anIntArray354;
			for (local7 = 0; local7 < super.anInt7221; local7++) {
				local13 = local7 * super.anInt7212;
				local23 = (arg1 + local7) * super.aClass163_Sub1_11.anInt4224 + arg0;
				for (local25 = 0; local25 < super.anInt7212; local25++) {
					this.anIntArray640[local13 + local25] = this.anIntArray640[local13 + local25] & 0xFFFFFF | (local5[local23 + local25] & 0xFF0000) << 8;
				}
			}
		} else if (arg2 == 3) {
			local5 = super.aClass163_Sub1_11.anIntArray354;
			for (local7 = 0; local7 < super.anInt7221; local7++) {
				...
				local23 = (arg1 + local7) * super.aClass163_Sub1_11.anInt4224 + arg0;
				for (local25 = 0; local25 < super.anInt7212; local25++) {
					this.anIntArray640[local13 + local25] = this.anIntArray640[local13 + local25] & 0xFFFFFF | (local5[local23 + local25] == 0 ? 0 : -16777216);
				}
			}
		}
	}
		...
		if (Static213.anInt7236 == 0) {
			if (Static213.anInt7239 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local27 >= 0 && local25 - (super.anInt7212 << 12) < 0 && local27 - (super.anInt7221 << 12) < 0) {
							...
							while (local29 < 0) {
								local111 = this.anIntArray640[(local27 >> 12) * super.anInt7212 + (local25 >> 12)];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt7212 << 12) < 0) {
							@Pc(210) int local210;
							if ((local210 = local27 - (super.anInt7221 << 12)) >= 0) {
								local217 = (Static213.anInt7239 - local210) / Static213.anInt7239;
								local29 += local217;
								local27 += Static213.anInt7239 * local217;
								local23 += local217;
							}
							@Pc(238) int local238;
							if ((local238 = (local27 - Static213.anInt7239) / Static213.anInt7239) > local29) {
								local29 = local238;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt7212 << 12) < 0) {
							if (local27 < 0) {
								local217 = (Static213.anInt7239 - local27 - 1) / Static213.anInt7239;
								local29 += local217;
								local27 += Static213.anInt7239 * local217;
								local23 += local217;
							}
							@Pc(441) int local441;
							if ((local441 = (local27 + 1 - (super.anInt7221 << 12) - Static213.anInt7239) / Static213.anInt7239) > local29) {
								local29 = local441;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
			...
			if (Static213.anInt7239 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local27 >= 0 && local27 - (super.anInt7221 << 12) < 0) {
							@Pc(618) int local618;
							if ((local618 = local25 - (super.anInt7212 << 12)) >= 0) {
								local217 = (Static213.anInt7236 - local618) / Static213.anInt7236;
								local29 += local217;
								local25 += Static213.anInt7236 * local217;
								local23 += local217;
							}
							@Pc(646) int local646;
							if ((local646 = (local25 - Static213.anInt7236) / Static213.anInt7236) > local29) {
								local29 = local646;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static213.anInt7214;
						@Pc(814) int local814;
						if ((local814 = local25 - (super.anInt7212 << 12)) >= 0) {
							local217 = (Static213.anInt7236 - local814) / Static213.anInt7236;
							local29 += local217;
							local25 += Static213.anInt7236 * local217;
							local27 += Static213.anInt7239 * local217;
							local23 += local217;
						...
						@Pc(848) int local848;
						if ((local848 = (local25 - Static213.anInt7236) / Static213.anInt7236) > local29) {
							local29 = local848;
						}
						@Pc(860) int local860;
						if ((local860 = local27 - (super.anInt7221 << 12)) >= 0) {
							local217 = (Static213.anInt7239 - local860) / Static213.anInt7239;
							local29 += local217;
							local25 += Static213.anInt7236 * local217;
							local27 += Static213.anInt7239 * local217;
							local23 += local217;
						...
						@Pc(894) int local894;
						if ((local894 = (local27 - Static213.anInt7239) / Static213.anInt7239) > local29) {
							local29 = local894;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if ((local1068 = local25 - (super.anInt7212 << 12)) >= 0) {
							local217 = (Static213.anInt7236 - local1068) / Static213.anInt7236;
							local29 += local217;
							local25 += Static213.anInt7236 * local217;
							local27 += Static213.anInt7239 * local217;
							local23 += local217;
						...
						if ((local1102 = (local25 - Static213.anInt7236) / Static213.anInt7236) > local29) {
							local29 = local1102;
						}
						if (local27 < 0) {
							local217 = (Static213.anInt7239 - local27 - 1) / Static213.anInt7239;
						...
						if ((local1150 = (local27 + 1 - (super.anInt7221 << 12) - Static213.anInt7239) / Static213.anInt7239) > local29) {
							local29 = local1150;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if (local27 >= 0 && local27 - (super.anInt7221 << 12) < 0) {
						if (local25 < 0) {
							local217 = (Static213.anInt7236 - local25 - 1) / Static213.anInt7236;
							local29 += local217;
							local25 += Static213.anInt7236 * local217;
							local23 += local217;
						}
						@Pc(1363) int local1363;
						if ((local1363 = (local25 + 1 - (super.anInt7212 << 12) - Static213.anInt7236) / Static213.anInt7236) > local29) {
							local29 = local1363;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1571 = (local25 + 1 - (super.anInt7212 << 12) - Static213.anInt7236) / Static213.anInt7236) > local29) {
						local29 = local1571;
					}
					@Pc(1583) int local1583;
					if ((local1583 = local27 - (super.anInt7221 << 12)) >= 0) {
						local217 = (Static213.anInt7239 - local1583) / Static213.anInt7239;
						local29 += local217;
						local25 += Static213.anInt7236 * local217;
						local27 += Static213.anInt7239 * local217;
						local23 += local217;
					...
					if ((local1617 = (local27 - Static213.anInt7239) / Static213.anInt7239) > local29) {
						local29 = local1617;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1827 = (local25 + 1 - (super.anInt7212 << 12) - Static213.anInt7236) / Static213.anInt7236) > local29) {
						local29 = local1827;
					}
					if (local27 < 0) {
						local217 = (Static213.anInt7239 - local27 - 1) / Static213.anInt7239;
					...
					if ((local1875 = (local27 + 1 - (super.anInt7221 << 12) - Static213.anInt7239) / Static213.anInt7239) > local29) {
						local29 = local1875;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
	...
	public void method5666(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class35 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		for (@Pc(212) int local212 = local171; local212 < local210; local212++) {
			...
			for (@Pc(304) int local304 = -local227; local304 < 0; local304++) {
				@Pc(311) int local311 = this.anIntArray640[local19++];
	...
	public void XA(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		for (@Pc(5) int local5 = 0; local5 < arg3; local5++) {
			...
			for (@Pc(24) int local24 = 0; local24 < arg2; local24++) {
				this.anIntArray640[local14 + local24] = local3[local22 + local24] & 0xFFFFFF;
			}
		}
	}
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local16 >= 0 && local14 - (super.anInt7212 << 12) < 0 && local16 - (super.anInt7221 << 12) < 0) {
						while (local18 < 0) {
							...
							local51 = local12++;
							if (arg0 == 1) {
								local209 = this.anIntArray640[local48];
								...
								local209 = this.anIntArray640[local48];
								local213 = (local209 >>> 24) * Static213.anInt7210 >> 8;
								local217 = 256 - local213;
								if ((Static213.anInt7238 & 0xFFFFFF) == 16777215) {
									local221 = local3[local51];
									local3[local51] = ((local209 & 0xFF00FF) * local213 + (local221 & 0xFF00FF) * local217 & 0xFF00FF00) + ((local209 & 0xFF00) * local213 + (local221 & 0xFF00) * local217 & 0xFF0000) >> 8;
								} else if (local213 == 255) {
									local221 = (local209 & 0xFF0000) * Static213.anInt7226 & 0xFF000000;
									local334 = (local209 & 0xFF00) * Static213.anInt7223 & 0xFF0000;
									local342 = (local209 & 0xFF) * Static213.anInt7231 & 0xFF00;
								...
								local342 = (local334 >>> 24) * Static213.anInt7210 >> 8;
								...
								local213 = local209 >>> 24;
								local217 = 256 - local213;
								local221 = (local209 & 0xFF00FF) * Static213.anInt7210 & 0xFF00FF00;
								local334 = (local209 & 0xFF00) * Static213.anInt7210 & 0xFF0000;
								local209 = ((local221 | local334) >>> 8) + Static213.anInt7235;
		...
		if (super.aClass163_Sub1_11.method3441()) {
			...
			if (arg6 != 0) {
					...
					if (arg4 == 1) {
						...
						for (local262 = -arg3; local262 < 0; local262++) {
							...
							for (local273 = -arg2; local273 < 0; local273++) {
								local330 = this.anIntArray640[(local14 >> 16) + local270];
						...
						if ((arg5 & 0xFFFFFF) == 16777215) {
							...
							for (local330 = -arg3; local330 < 0; local330++) {
								...
								for (local341 = -arg2; local341 < 0; local341++) {
									local351 = this.anIntArray640[(local14 >> 16) + local338];
						...
						for (local338 = -arg3; local338 < 0; local338++) {
							...
							for (local351 = -arg2; local351 < 0; local351++) {
								local359 = this.anIntArray640[(local14 >> 16) + local341];
				...
				for (local262 = -arg3; local262 < 0; local262++) {
					local270 = (local16 >> 16) * super.anInt7212;
					for (local273 = -arg2; local273 < 0; local273++) {
						local252[local64++] = this.anIntArray640[(local14 >> 16) + local270];
						local14 += local44;
					}
					local16 += local50;
					local14 = local259;
