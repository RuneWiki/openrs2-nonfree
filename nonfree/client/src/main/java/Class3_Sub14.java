...
public final class Class3_Sub14 extends Class3 {
	...
	@OriginalMember(owner = "client!jg", name = "C", descriptor = "[F")
	...
	public Class3_Sub14(@OriginalArg(0) byte[] arg0) {
		this.method1430(arg0);
	}

	@OriginalMember(owner = "client!jg", name = "a", descriptor = "([I)Lclient!tb;")
	public Class3_Sub24_Sub1 method1424(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray16 == null) {
			this.anInt2040 = 0;
			this.aFloatArray5 = new float[Static100.anInt2045];
			this.aByteArray16 = new byte[this.anInt2037];
			this.anInt2047 = 0;
			this.anInt2048 = 0;
		}
		while (this.anInt2048 < this.aByteArrayArray3.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1429(this.anInt2048);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2047;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt2037 - local47) {
					local50 = this.anInt2037 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2047;
				}
				this.anInt2047 = local47;
			}
			this.anInt2048++;
		}
		...
		return new Class3_Sub24_Sub1(this.anInt2039, local129, this.anInt2046, this.anInt2038, this.aBoolean108);
	}

	@OriginalMember(owner = "client!jg", name = "c", descriptor = "(I)[F")
	private float[] method1429(@OriginalArg(0) int arg0) {
		Static100.method1421(this.aByteArrayArray3[arg0]);
		Static100.method1422();
		@Pc(15) int local15 = Static100.method1425(Static135.method1922(Static100.anIntArray113.length - 1));
		@Pc(19) boolean local19 = Static100.aBooleanArray8[local15];
		@Pc(25) int local25 = local19 ? Static100.anInt2045 : Static100.anInt2044;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static100.method1422() != 0;
			local29 = Static100.method1422() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static100.anInt2044 >> 2);
			local67 = (local25 >> 2) + (Static100.anInt2044 >> 2);
			local71 = Static100.anInt2044 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static100.anInt2044 >> 2);
			local104 = local25 + (Static100.anInt2044 >> 2) - (local25 >> 2);
			local108 = Static100.anInt2044 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class73 local123 = Static100.aClass73Array1[Static100.anIntArray113[local15]];
		@Pc(126) int local126 = local123.anInt2967;
		@Pc(131) int local131 = local123.anIntArray208[local126];
		@Pc(140) boolean local140 = !Static100.aClass91Array1[local131].method3037();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt2968; local144++) {
			@Pc(152) Class95 local152 = Static100.aClass95Array1[local123.anIntArray209[local144]];
			local154 = Static100.aFloatArray7;
			local152.method3206(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt2967;
			local176 = local123.anIntArray208[local171];
			Static100.aClass91Array1[local176].method3036(Static100.aFloatArray7, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static100.aFloatArray7[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static100.aFloatArray7;
			...
			@Pc(252) float[] local252 = local19 ? Static100.aFloatArray4 : Static100.aFloatArray3;
			@Pc(258) float[] local258 = local19 ? Static100.aFloatArray6 : Static100.aFloatArray2;
			@Pc(264) float[] local264 = local19 ? Static100.aFloatArray1 : Static100.aFloatArray8;
			@Pc(270) int[] local270 = local19 ? Static100.anIntArray114 : Static100.anIntArray115;
			...
			@Pc(486) int local486 = Static135.method1922(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static100.aFloatArray7[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static100.aFloatArray7[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt2040 > 0) {
			local176 = this.anInt2040 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean106) {
				for (local212 = 0; local212 < this.anInt2043; local212++) {
					local1254 = (this.anInt2040 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static100.aFloatArray7[local212];
				}
			}
		}
		local154 = this.aFloatArray5;
		this.aFloatArray5 = Static100.aFloatArray7;
		Static100.aFloatArray7 = local154;
		this.anInt2040 = local25;
		this.anInt2043 = local104 - (local25 >> 1);
		this.aBoolean106 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!jg", name = "b", descriptor = "([B)V")
	private void method1430(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class3_Sub4 local4 = new Class3_Sub4(arg0);
		this.anInt2039 = local4.method1245();
		this.anInt2037 = local4.method1245();
		this.anInt2046 = local4.method1245();
		this.anInt2038 = local4.method1245();
		if (this.anInt2038 < 0) {
			this.anInt2038 = ~this.anInt2038;
			this.aBoolean108 = true;
		}
		@Pc(40) int local40 = local4.method1245();
		this.aByteArrayArray3 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method1278();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method1268(local64, local49);
