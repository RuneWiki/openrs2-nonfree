...
public final class Class3_Sub14 extends Class3 {
	...
	public Class3_Sub14(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) boolean arg3) {
		this.anInt1917 = arg0;
		this.anInt1916 = arg1;
		this.anIntArray165 = arg2;
		if (arg3) {
			@Pc(16) int[] local16 = new int[this.anInt1916];
			@Pc(20) int[] local20 = new int[this.anInt1916];
			@Pc(24) int[] local24 = new int[this.anInt1916];
			if (Static90.anIntArray166 == null || Static90.anIntArray166.length < this.anIntArray165.length) {
				Static90.anIntArray166 = new int[this.anIntArray165.length];
			}
			@Pc(40) int local40 = this.anInt1916;
			@Pc(43) int local43 = this.anInt1916;
			...
			for (@Pc(116) int local116 = local51; local116 >= 0; local116--) {
				...
				for (local64 = local47; local64 >= 0; local64--) {
					...
					local114--;
					Static90.anIntArray166[local114] = local165 << 16 | local169 << 8 | local173;
			...
			this.anIntArray165 = Static90.anIntArray166;
			Static90.anIntArray166 = local306;
		}
	}
	...
	public void method1552(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 == 0 && arg1 == 0) {
			return;
		}
		if (Static90.anIntArray166 == null || Static90.anIntArray166.length < this.anIntArray165.length) {
		...
		@Pc(28) int local28 = this.anInt1916 - 1;
		@Pc(33) int local33 = this.anInt1916 * arg1;
		@Pc(37) int local37 = local21 - 1;
		for (@Pc(39) int local39 = 0; local39 < local21; local39 += this.anInt1916) {
			...
			for (@Pc(48) int local48 = 0; local48 < this.anInt1916; local48++) {
				...
				Static90.anIntArray166[local53] = this.anIntArray165[local61];
			}
		}
		@Pc(84) int[] local84 = this.anIntArray165;
		this.anIntArray165 = Static90.anIntArray166;
		Static90.anIntArray166 = local84;
	}
}
