...
public final class Class250 {
	...
	@OriginalMember(owner = "client!wq", name = "l", descriptor = "Lclient!ba;")
	...
	@OriginalMember(owner = "client!wq", name = "P", descriptor = "[Lclient!at;")
	...
	@OriginalMember(owner = "client!wq", name = "n", descriptor = "Lclient!j;")
	...
	@OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(Lclient!j;)V", line = 565)
	...
	@OriginalMember(owner = "client!wq", name = "a", descriptor = "(ILjava/lang/Runnable;)V", line = 4)
	public void method6451(@OriginalArg(1) Runnable arg0) {
		this.aRunnable1 = arg0;
	}

	@OriginalMember(owner = "client!wq", name = "a", descriptor = "(I)V", line = 252)
