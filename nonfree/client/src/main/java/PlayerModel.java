...
public final class PlayerModel {
	...
	public void method431(@OriginalArg(0) Packet arg0) {
	...
	public Model method439() {
		...
		@Pc(87) Model[] local87 = new Model[12];
		@Pc(89) int local89 = 0;
		...
		@Pc(157) Model local157 = new Model(local87, local89);
		...
		if (arg2 == null) {
			...
			for (@Pc(12) int local12 = 0; local12 < 7; local12++) {
				for (@Pc(16) int local16 = 0; local16 < Static75.anInt1999; local16++) {
					@Pc(22) IdkType local22 = Static112.method1793(local16);
	...
	public SoftwareModel method442(@OriginalArg(0) SeqType arg0, @OriginalArg(1) int arg1, @OriginalArg(2) SeqType arg2, @OriginalArg(4) int arg3) {
		if (this.anInt611 != -1) {
		...
		@Pc(114) SoftwareModel local114 = (SoftwareModel) Static33.aClass33_12.method998(local31);
		if (local114 == null) {
			...
			if (local118) {
				if (this.aLong25 != -1L) {
					local114 = (SoftwareModel) Static33.aClass33_12.method998(this.aLong25);
				}
				if (local114 == null) {
					return null;
				}
			...
			if (local114 == null) {
				...
				@Pc(259) Model local259 = new Model(local194, local196);
