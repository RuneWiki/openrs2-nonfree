...
public final class Class35 implements ImageProducer, ImageObserver {
	...
	public Class35(@OriginalArg(0) Component arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			...
			signlink.reporterror("93232, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + local62.toString());
	...
	public void method524() {
		try {
			Class1_Sub1_Sub2.method434(this.anInt832, this.anInt831, this.anIntArray231, 97);
		} catch (@Pc(11) RuntimeException local11) {
			signlink.reporterror("98365, " + false + ", " + local11.toString());
			throw new RuntimeException();
		}
	}
	...
	public void method525(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) Graphics arg2) {
		try {
			...
			signlink.reporterror("47189, " + arg0 + ", " + true + ", " + arg1 + ", " + arg2 + ", " + local13.toString());
			throw new RuntimeException();
		}
	}
	...
	private synchronized void method526() {
		if (this.anImageConsumer1 != null) {
			this.anImageConsumer1.setPixels(0, 0, this.anInt831, this.anInt832, this.aColorModel1, this.anIntArray231, 0, this.anInt831);
