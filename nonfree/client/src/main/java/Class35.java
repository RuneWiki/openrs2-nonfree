...
public final class Class35 implements ImageProducer, ImageObserver {
	...
	public Class35(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Component arg2, @OriginalArg(3) boolean arg3) {
		try {
			this.anInt842 = arg1;
			this.anInt843 = arg0;
			this.anIntArray228 = new int[arg1 * arg0];
			...
			signlink.reporterror("70936, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + local69.toString());
	...
	public void method518(@OriginalArg(0) int arg0) {
		try {
			Class1_Sub1_Sub2.method431(this.anInt842, this.anInt843, this.anIntArray228);
			@Pc(11) boolean local11 = false;
		} catch (@Pc(13) RuntimeException local13) {
			signlink.reporterror("17664, " + arg0 + ", " + local13.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!qb", name = "a", descriptor = "(Ljava/awt/Graphics;III)V")
	public void method519(@OriginalArg(0) Graphics arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2) {
		try {
			this.method520();
			arg0.drawImage(this.anImage1, arg1, arg2, this);
		} catch (@Pc(21) RuntimeException local21) {
			signlink.reporterror("56291, " + arg0 + ", " + arg1 + ", " + 0 + ", " + arg2 + ", " + local21.toString());
			throw new RuntimeException();
		}
	}
	...
	public synchronized void addConsumer(@OriginalArg(0) ImageConsumer arg0) {
		...
		arg0.setDimensions(this.anInt842, this.anInt843);
	...
	private synchronized void method520() {
		if (this.anImageConsumer1 != null) {
			this.anImageConsumer1.setPixels(0, 0, this.anInt842, this.anInt843, this.aColorModel1, this.anIntArray228, 0, this.anInt842);
