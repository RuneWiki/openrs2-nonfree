...
public final class Class35 {
	...
	private final HashTable aClass81_6 = new HashTable(256);

	@OriginalMember(owner = "client!jf", name = "x", descriptor = "Lclient!wc;")
	private final HashTable aClass81_7 = new HashTable(256);

	@OriginalMember(owner = "client!jf", name = "q", descriptor = "Lclient!ea;")
	private final Js5Index aClass20_29;

	@OriginalMember(owner = "client!jf", name = "w", descriptor = "Lclient!ea;")
	private final Js5Index aClass20_30;

	@OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lclient!ea;Lclient!ea;)V")
	public Class35(@OriginalArg(0) Js5Index arg0, @OriginalArg(1) Js5Index arg1) {
		this.aClass20_29 = arg1;
		this.aClass20_30 = arg0;
	}

	@OriginalMember(owner = "client!jf", name = "a", descriptor = "(II[II)Lclient!ib;")
	private PcmSound method1032(@OriginalArg(1) int arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2) {
		@Pc(15) int local15 = ((arg2 & 0xA0000FFF) << 4 | arg2 >>> 12) ^ arg0;
		@Pc(21) int local21 = local15 | arg2 << 16;
		@Pc(24) long local24 = (long) local21;
		@Pc(31) PcmSound local31 = (PcmSound) this.aClass81_7.method2010(local24);
		if (local31 != null) {
			return local31;
		} else if (arg1 == null || arg1[0] > 0) {
			@Pc(57) Wave local57 = Static141.method1716(this.aClass20_30, arg2, arg0);
			if (local57 == null) {
				return null;
			}
	...
	public PcmSound method1034(@OriginalArg(0) int arg0, @OriginalArg(2) int[] arg1) {
	...
	public PcmSound method1035(@OriginalArg(0) int[] arg0, @OriginalArg(2) int arg1) {
	...
	private PcmSound method1038(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int[] arg2) {
		@Pc(15) int local15 = arg0 ^ (arg1 >>> 12 | arg1 << 4 & 0xFFFF);
		@Pc(21) int local21 = local15 | arg1 << 16;
		@Pc(26) long local26 = (long) local21 ^ 0x100000000L;
		@Pc(33) PcmSound local33 = (PcmSound) this.aClass81_7.method2010(local26);
		if (local33 != null) {
			return local33;
		} else if (arg2 == null || arg2[0] > 0) {
			@Pc(63) VorbisSound local63 = (VorbisSound) this.aClass81_6.method2010(local26);
			if (local63 == null) {
