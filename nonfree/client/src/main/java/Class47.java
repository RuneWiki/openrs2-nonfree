...
public final class Class47 {
	...
	public Class47(@OriginalArg(0) byte arg0, @OriginalArg(1) int[] arg1) {
		try {
			...
			signlink.reporterror("83868, " + arg0 + ", " + arg1 + ", " + local36.toString());
	...
	public int method674() {
		...
		return this.anIntArray265[this.anInt1024];
	}
	...
	private void method675() {
		...
		for (@Pc(15) int local15 = 0; local15 < 256; local15++) {
			...
			switch(local15 & 0x3) {
				case 0:
					this.anInt1025 ^= this.anInt1025 << 13;
					break;
				case 1:
					this.anInt1025 ^= this.anInt1025 >>> 6;
					break;
				case 2:
					this.anInt1025 ^= this.anInt1025 << 2;
					break;
				case 3:
					this.anInt1025 ^= this.anInt1025 >>> 16;
			}
			this.anInt1025 += this.anIntArray266[local15 + 128 & 0xFF];
			@Pc(101) int local101;
			this.anIntArray266[local15] = local101 = this.anIntArray266[local22 >> 2 & 0xFF] + this.anInt1025 + this.anInt1026;
			this.anIntArray265[local15] = this.anInt1026 = this.anIntArray266[local101 >> 8 >> 2 & 0xFF] + local22;
		}
	}
