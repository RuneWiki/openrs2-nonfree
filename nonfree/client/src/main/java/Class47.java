...
public final class Class47 {
	...
	private void method665(@OriginalArg(0) byte[] arg0) {
		try {
			...
			this.anInt983 = local7.method482();
			this.anIntArray265 = new int[this.anInt983];
			this.anIntArray266 = new int[this.anInt983];
			this.anIntArray267 = new int[this.anInt983];
			this.anIntArray268 = new int[this.anInt983];
			@Pc(89) int local89 = local7.anInt742 + this.anInt983 * 10;
			for (@Pc(91) int local91 = 0; local91 < this.anInt983; local91++) {
			...
			signlink.reporterror("57284, " + arg0 + ", " + -40537 + ", " + local130.toString());
			throw new RuntimeException();
		}
	}
	...
	public byte[] method666(@OriginalArg(0) String arg0, @OriginalArg(1) byte[] arg1) {
		...
		for (@Pc(27) int local27 = 0; local27 < this.anInt983; local27++) {
