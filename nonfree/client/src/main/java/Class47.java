...
public final class Class47 {
	...
	public Class47(@OriginalArg(0) byte arg0, @OriginalArg(1) int[] arg1) {
		try {
			...
			for (@Pc(18) int local18 = 0; local18 < arg1.length; local18++) {
				this.anIntArray265[local18] = arg1[local18];
			}
			this.method676();
		} catch (@Pc(36) RuntimeException local36) {
			signlink.reporterror("95494, " + arg0 + ", " + arg1 + ", " + local36.toString());
	...
	public int method674() {
		...
		return this.anIntArray265[this.anInt995];
	}

	@OriginalMember(owner = "client!xb", name = "b", descriptor = "()V")
	private void method675() {
		this.anInt997 += ++this.anInt998;
		for (@Pc(15) int local15 = 0; local15 < 256; local15++) {
			@Pc(22) int local22 = this.anIntArray266[local15];
			switch(local15 & 0x3) {
				case 0:
					this.anInt996 ^= this.anInt996 << 13;
					break;
				case 1:
					this.anInt996 ^= this.anInt996 >>> 6;
					break;
				case 2:
					this.anInt996 ^= this.anInt996 << 2;
					break;
				case 3:
					this.anInt996 ^= this.anInt996 >>> 16;
			}
			this.anInt996 += this.anIntArray266[local15 + 128 & 0xFF];
			@Pc(101) int local101;
			this.anIntArray266[local15] = local101 = this.anIntArray266[local22 >> 2 & 0xFF] + this.anInt996 + this.anInt997;
			this.anIntArray265[local15] = this.anInt997 = this.anIntArray266[local101 >> 8 >> 2 & 0xFF] + local22;
		}
	}
