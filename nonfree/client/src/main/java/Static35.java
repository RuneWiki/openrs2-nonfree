...
public final class Static35 {
	...
	public static int[] anIntArray125 = new int[] { 256, 128, 86, 64 };

	@OriginalMember(owner = "client!fa", name = "a", descriptor = "([II)I")
	public static int method562(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1) {
	...
	public static int method568(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1) {
		@Pc(3) int local3 = arg0[arg1];
		@Pc(5) int local5 = -1;
