...
public final class oa extends Class133 implements Interface4 {

	@OriginalMember(owner = "client!oa", name = "Q", descriptor = "Lclient!ya;")
	private ya aYa2;

	@OriginalMember(owner = "client!oa", name = "S", descriptor = "Lclient!tc;")
	...
	@OriginalMember(owner = "client!oa", name = "C", descriptor = "Lclient!tg;")
	private final Class330 aClass330_33 = new Class330();

	@OriginalMember(owner = "client!oa", name = "R", descriptor = "I")
	private int anInt6431 = 4096;

	@OriginalMember(owner = "client!oa", name = "W", descriptor = "I")
	private int anInt6432 = 4096;

	@OriginalMember(owner = "client!oa", name = "V", descriptor = "Lclient!pl;")
	private final Class273 aClass273_24 = new Class273(4);
	...
	public oa(@OriginalArg(0) Canvas arg0, @OriginalArg(1) Interface3 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		super(arg1);
		try {
			if (!Static82.method1382("sw3d")) {
				throw new RuntimeException("");
			}
			Static544.method7970();
			this.MA(super.anInterface3_12, 0, 0);
			Static627.method8869(true, false);
			this.aBoolean459 = true;
			this.aClass113_7 = new ja();
			this.method7269(new ja());
			this.method7265(1);
			this.method7278(0);
			if (arg0 != null) {
				this.method7273(arg0, arg2, arg3);
	...
	private boolean method5769(@OriginalArg(0) short arg0) {
		@Pc(2) Interface3 local2 = super.anInterface3_12;
		synchronized (super.anInterface3_12) {
			if (!super.anInterface3_12.method4654(arg0)) {
				return false;
			}
			@Pc(22) Class145 local22 = super.anInterface3_12.method4656(arg0);
			if (local22 == null) {
				return false;
			}
			@Pc(44) int[] local44;
			if (local22.anInt3988 == 2) {
				local44 = super.anInterface3_12.method4658(0.7F, 128, 128, arg0);
			} else {
				local44 = super.anInterface3_12.method4653(0.7F, 128, arg0, 128, true);
			}
			this.CA(arg0, local44, local22.aShort61, local22.anInt3988, local22.aByte68, local22.aByte64, local22.anInt3991, local22.aBoolean293, local22.aByte66, local22.aByte67, local22.aByte62, local22.aByte65, local22.aBoolean291, local22.aBoolean294, local22.aBoolean296, local22.aBoolean292, local22.aBoolean297, local22.aByte63, local22.aBoolean295, local22.aBoolean290, local22.anInt3990);
			return true;
		}
	}
	...
	public void method7252(@OriginalArg(0) int arg0) {
		Static544.method7967();
		this.d(arg0);
		for (@Pc(10) ya local10 = (ya) this.aClass330_33.method7908(); local10 != null; local10 = (ya) this.aClass330_33.method7914()) {
			local10.r();
		}
	}
	...
	@OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lclient!mp;)V")
	@Override
	public void method7308(@OriginalArg(0) Class235 arg0) {
		if (arg0.aClass287_1.method6811() != 0) {
			this.method5770(arg0);
			this.method5773().method14(this, Static388.anIntArray357, Static388.anIntArray356, Static388.anIntArray355, Static388.aShortArray99, arg0.aClass287_1.method6811());
		}
	}
	...
	@OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lclient!mp;Z)V")
	private void method5770(@OriginalArg(0) Class235 arg0) {
		@Pc(1) int local1 = 0;
		@Pc(3) int local3 = 0;
		@Pc(5) int local5 = 0;
		@Pc(7) int local7 = 0;
		for (@Pc(15) Class4_Sub1_Sub1 local15 = (Class4_Sub1_Sub1) arg0.aClass287_1.method6814(); local15 != null; local15 = (Class4_Sub1_Sub1) arg0.aClass287_1.method6812()) {
			Static388.anIntArray357[local1++] = local15.anInt45;
			Static388.anIntArray357[local1++] = local15.anInt52;
			Static388.anIntArray357[local1++] = local15.anInt46;
			Static388.anIntArray356[local3++] = local15.anInt51;
			Static388.aShortArray99[local7++] = (short) local15.anInt48;
			Static388.anIntArray355[local5++] = local15.anInt47;
		}
	}
	...
	@OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Lclient!vt;")
	@Override
	public Class5_Sub11 method7293(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5) {
		return new Class5_Sub11_Sub3(arg0, arg1, arg2, arg3, arg4, arg5);
	}
	...
	public void method7282(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) throws Exception_Sub1 {
		...
		this.aP1.method6352(arg0, arg1);
	}

	@OriginalMember(owner = "client!oa", name = "c", descriptor = "(S)Z")
	private boolean method5771(@OriginalArg(0) short arg0) {
		synchronized (this) {
			@Pc(9) Class145 local9 = super.anInterface3_12.method4656(arg0);
			if (local9 == null) {
				return false;
			} else {
				this.AA(arg0, local9.aShort61, local9.anInt3988, local9.aByte68, local9.aByte64, local9.anInt3991, local9.aBoolean293, local9.aByte66, local9.aByte67, local9.aByte62, local9.aByte65, local9.aBoolean291, local9.aBoolean294, local9.aBoolean296, local9.aBoolean292, local9.aBoolean297, local9.aByte63, local9.aBoolean295, local9.aBoolean290, local9.anInt3990);
				return true;
			}
		}
	}
	...
	@OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lclient!tc;)V")
	@Override
	public void method7269(@OriginalArg(0) Class113 arg0) {
		this.aClass113_6 = arg0;
	...
	public void method7267() {
		this.method7291(this.aP1.aCanvas17);
	}

	@OriginalMember(owner = "client!oa", name = "b", descriptor = "(II)Lclient!hu;")
	@Override
	public Interface7 method7271(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return this.method7290(arg0, arg1, false);
	}
	...
	public void method7248(@OriginalArg(0) int[] arg0) {
		@Pc(4) Dimension local4 = this.aP1.aCanvas17.getSize();
		arg0[0] = local4.width;
		arg0[1] = local4.height;
	}

	@OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Lclient!it;")
	@Override
	...
	@OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lclient!mp;I)V")
	@Override
	...
	@OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lclient!gu;Z)Lclient!it;")
	@Override
	public Class28 method7297(@OriginalArg(0) Class131 arg0, @OriginalArg(1) boolean arg1) {
		@Pc(17) j local17 = new j(this, arg0.anIntArray186, arg0.aByteArray29, arg0.aByteArray30, 0, arg0.anInt3344, arg0.anInt3344, arg0.anInt3345);
		local17.method4043(arg0.anInt3341, arg0.anInt3343, arg0.anInt3346, arg0.anInt3342);
		return local17;
	}
	...
	@OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Lclient!vt;)V")
	@Override
	public void method7286(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub11[] arg1) {
		@Pc(1) int local1 = 0;
		for (@Pc(3) int local3 = 0; local3 < arg0; local3++) {
			Static388.anIntArray359[local1++] = arg1[local3].method8103();
			Static388.anIntArray359[local1++] = arg1[local3].method8096();
			Static388.anIntArray359[local1++] = arg1[local3].method8098();
			Static388.anIntArray359[local1++] = arg1[local3].method8099();
			Static388.aFloatArray47[local3] = arg1[local3].method8101();
			Static388.anIntArray359[local1++] = arg1[local3].method8102();
		}
		this.N(arg0, Static388.anIntArray359, Static388.aFloatArray47);
	}
	...
	public a method5773() {
		for (@Pc(1) int local1 = 0; local1 < this.anInt6433; local1++) {
	...
	public void method7291(@OriginalArg(0) Canvas arg0) {
		if (arg0 == null) {
			...
			@Pc(10) p local10 = (p) this.aClass273_24.method6581((long) arg0.hashCode());
			this.aP1 = local10;
			this.t(local10);
		}
	}

	@OriginalMember(owner = "client!oa", name = "q", descriptor = "()Lclient!qm;")
	@Override
	public Class294 method7281() {
		return new Class294(0, "SSE", 1, "CPU", 0L);
	}

	@OriginalMember(owner = "client!oa", name = "g", descriptor = "(II)Lclient!wm;")
	@Override
	public Interface27 method7313(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return new xa(arg0, arg1);
	}

	@OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lclient!vm;Lclient!vm;FLclient!vm;)Lclient!vm;")
	@Override
	...
	public void method7239(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) throws Exception_Sub1 {
		...
		this.aP1.method6351(arg0, arg1, arg2, arg3);
	}
	...
	@OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lclient!b;IIII)Lclient!ka;")
	@Override
	...
	public void method7265(@OriginalArg(0) int arg0) {
		this.anInt6433 = arg0;
		this.anAArray1 = new a[this.anInt6433];
		for (@Pc(9) int local9 = 0; local9 < this.anInt6433; local9++) {
			this.anAArray1[local9] = new a(this, this.anInt6431, this.anInt6432);
		}
	}

	@OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Lclient!it;")
	@Override
	...
	public void method7276(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		@Pc(8) p local8 = (p) this.aClass273_24.method6581((long) arg0.hashCode());
		local8.method6349(arg0, arg1, arg2);
		if (arg0 != null && arg0 == this.aP1.aCanvas17) {
			this.method7291(arg0);
		}
	}
	...
	public void method7266() {
		this.anInt6431 = this.anInt6432 = 10000;
		if (this.anInt6433 > 1) {
			throw new IllegalStateException("No MT");
		}
		this.method7265(this.anInt6433);
		this.method7278(0);
	}
	...
	@OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lclient!pia;[Lclient!gu;Z)Lclient!da;")
	@Override
	public Class55 method7255(@OriginalArg(0) Class272 arg0, @OriginalArg(1) Class131[] arg1) {
		...
		for (@Pc(11) int local11 = 0; local11 < arg1.length; local11++) {
			local3[local11] = arg1[local11].anInt3344;
			local7[local11] = arg1[local11].anInt3345;
	...
	@OriginalMember(owner = "client!oa", name = "e", descriptor = "(IIIIII)Lclient!vm;")
	@Override
	...
	@OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lclient!vm;)V")
	@Override
	...
	public void method7273(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if (local8 == null) {
			...
			this.aClass273_24.method6585((long) arg0.hashCode(), local8);
		} else if (local8.anInt7190 != arg1 || local8.anInt7189 != arg2) {
			local8.method6349(arg0, arg1, arg2);
		}
	}
	...
	public void method7272(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		this.method5773().method11(this, arg0, arg1, arg2, arg3, arg4, arg5);
	}
	...
	public void method7303(@OriginalArg(0) Canvas arg0) {
		if (this.aP1.aCanvas17 == arg0) {
			this.method7291(null);
		}
		@Pc(16) p local16 = (p) this.aClass273_24.method6581((long) arg0.hashCode());
		if (local16 != null) {
			local16.method9047();
			local16.method6350();
		}
	...
	private native void va(@OriginalArg(0) Class5_Sub6 arg0);

	@OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lclient!hu;Lclient!wm;)Lclient!pea;")
	@Override
	...
	@OriginalMember(owner = "client!oa", name = "l", descriptor = "()Lclient!tc;")
	@Override
	public Class113 method7262() {
		return this.aClass113_7;
	}

	@OriginalMember(owner = "client!oa", name = "OA", descriptor = "()Ljava/lang/Object;")
	private Object method5774() {
		return new ba(this);
	}
	...
	public Class5_Sub6 method7300(@OriginalArg(0) int arg0) {
		...
		this.aClass330_33.method7917(local5);
		return local5;
	}
	...
	@OriginalMember(owner = "client!oa", name = "p", descriptor = "()Lclient!tc;")
	@Override
	...
	@OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZ)Lclient!it;")
	@Override
	...
	protected void method7236() {
		...
		this.aClass273_24.method6586();
		for (@Pc(25) ya local25 = (ya) this.aClass330_33.method7908(); local25 != null; local25 = (ya) this.aClass330_33.method7914()) {
			local25.ga();
		}
		this.aClass330_33.method7910();
		this.FA();
		if (this.aBoolean459) {
