...
public final class Class334 {
	...
	public Class334() throws Exception {
	...
	private void method7039(@OriginalArg(0) int arg0, @OriginalArg(1) Frame arg1) {
		...
		if (arg4 == 0) {
			...
			for (@Pc(38) int local38 = 0; local38 < local34.length; local38++) {
				if (local34[local38].getWidth() == arg1 && arg2 == local34[local38].getHeight() && arg3 == local34[local38].getBitDepth()) {
					...
					if (!local36 || Math.abs(local69 - local30) < Math.abs(arg4 - local30)) {
						arg4 = local69;
						local36 = true;
					}
				}
