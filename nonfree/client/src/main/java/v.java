...
public final class v extends Class6 implements Interface9 {
	...
	public v(@OriginalArg(0) da arg0, @OriginalArg(1) Canvas arg1) {
		...
		this.ya(arg0, this.aCanvas15, local7.width, local7.height);
	}
	...
	private void method7421(@OriginalArg(0) Exception arg0) {
		if (!Static548.aBoolean699) {
			Static548.aLong249 = Static8.method201();
			Static548.aBoolean699 = true;
		} else if (Static8.method201() - Static548.aLong249 < 30000L) {
	...
	public void method7422(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas15.getTreeLock()) {
