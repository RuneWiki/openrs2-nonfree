...
public final class v implements Interface9 {
	...
	private native void FA(@OriginalArg(0) Class62 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
	...
	public native void N(@OriginalArg(0) Class62 arg0, @OriginalArg(1) Class36[] arg1, @OriginalArg(2) Class78 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);

	@OriginalMember(owner = "client!v", name = "PA", descriptor = "(Lclient!r;Lclient!r;IIIZ)V")
	public native void PA(@OriginalArg(0) Class36 arg0, @OriginalArg(1) Class36 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!v", name = "O", descriptor = "(Lclient!qa;[I[I[I[SI)V")
	public native void O(@OriginalArg(0) Class62 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5);

	@OriginalMember(owner = "client!v", name = "G", descriptor = "(Lclient!qa;Lclient!r;Lclient!m;[II[I[I[I[S[BI[I)V")
	public native void G(@OriginalArg(0) Class62 arg0, @OriginalArg(1) Class36 arg1, @OriginalArg(2) Class78 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);

	@OriginalMember(owner = "client!v", name = "Y", descriptor = "(Lclient!sa;IIIIIII[[Z)V")
	public native void Y(@OriginalArg(0) Class131 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean[][] arg8);

	@OriginalMember(owner = "client!v", name = "a", descriptor = "(Lclient!ma;BIZ)Lclient!r;")
	public Class36 method6954(@OriginalArg(0) ma arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) ma local8;
		@Pc(5) ma local5;
		if (arg1 == 1) {
			local5 = this.aMa10;
		...
		local8.aClass223Array5 = arg0.aClass223Array5;
		local8.aClass280Array5 = arg0.aClass280Array5;
		return local8;
	}

	@OriginalMember(owner = "client!v", name = "k", descriptor = "(Lclient!sa;II)V")
	public native void k(@OriginalArg(0) Class131 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
	...
	public native void wa(@OriginalArg(0) Class62 arg0, @OriginalArg(1) Class36[] arg1, @OriginalArg(2) Class78 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5);
	...
	public native void da(@OriginalArg(0) Class62 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);

	@OriginalMember(owner = "client!v", name = "m", descriptor = "(Lclient!r;Lclient!m;[III)V")
	public native void m(@OriginalArg(0) Class36 arg0, @OriginalArg(1) Class78 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4);

	@OriginalMember(owner = "client!v", name = "RA", descriptor = "(Lclient!r;IILclient!m;Z)Z")
	public native boolean RA(@OriginalArg(0) Class36 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class78 arg3, @OriginalArg(4) boolean arg4);

	@OriginalMember(owner = "client!v", name = "ka", descriptor = "(Lclient!r;Lclient!m;[II)V")
	public native void ka(@OriginalArg(0) Class36 arg0, @OriginalArg(1) Class78 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3);
