...
public final class v extends Class6 implements Interface12 {
	...
	private native void HA(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) Class104 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8);
	...
	private native void c(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class104 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4);
