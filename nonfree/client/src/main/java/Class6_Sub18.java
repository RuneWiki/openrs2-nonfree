...
public final class Class6_Sub18 extends Class6 {
	...
	@OriginalMember(owner = "client!jj", name = "a", descriptor = "([I)Lclient!gu;")
	public Class6_Sub4_Sub1 method2888(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray46 == null) {
			this.anInt3223 = 0;
			this.aFloatArray17 = new float[Static184.anInt3216];
			this.aByteArray46 = new byte[this.anInt3214];
			this.anInt3225 = 0;
			this.anInt3224 = 0;
		}
		while (this.anInt3224 < this.aByteArrayArray22.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method2890(this.anInt3224);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt3225;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt3214 - local47) {
					local50 = this.anInt3214 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt3225;
				}
				this.anInt3225 = local47;
			}
			this.anInt3224++;
		}
		...
		return new Class6_Sub4_Sub1(this.anInt3220, local129, this.anInt3221, this.anInt3217, this.aBoolean228);
	}

	@OriginalMember(owner = "client!jj", name = "a", descriptor = "([B)V")
	private void method2889(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class6_Sub15 local4 = new Class6_Sub15(arg0);
		this.anInt3220 = local4.method3109();
		this.anInt3214 = local4.method3109();
		this.anInt3221 = local4.method3109();
		this.anInt3217 = local4.method3109();
		if (this.anInt3217 < 0) {
			this.anInt3217 = ~this.anInt3217;
			this.aBoolean228 = true;
		}
		@Pc(40) int local40 = local4.method3109();
		this.aByteArrayArray22 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method3111();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method3127(local64, local49);
			this.aByteArrayArray22[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!jj", name = "f", descriptor = "(I)[F")
	private float[] method2890(@OriginalArg(0) int arg0) {
		Static184.method2881(this.aByteArrayArray22[arg0]);
		Static184.method2883();
		@Pc(15) int local15 = Static184.method2882(Static278.method4208(Static184.anIntArray299.length - 1));
		@Pc(19) boolean local19 = Static184.aBooleanArray15[local15];
		@Pc(25) int local25 = local19 ? Static184.anInt3216 : Static184.anInt3219;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static184.method2883() != 0;
			local29 = Static184.method2883() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static184.anInt3219 >> 2);
			local67 = (local25 >> 2) + (Static184.anInt3219 >> 2);
			local71 = Static184.anInt3219 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static184.anInt3219 >> 2);
			local104 = local25 + (Static184.anInt3219 >> 2) - (local25 >> 2);
			local108 = Static184.anInt3219 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class261 local123 = Static184.aClass261Array1[Static184.anIntArray299[local15]];
		@Pc(126) int local126 = local123.anInt7197;
		@Pc(131) int local131 = local123.anIntArray619[local126];
		@Pc(140) boolean local140 = !Static184.aClass187Array1[local131].method4267();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt7196; local144++) {
			@Pc(152) Class226 local152 = Static184.aClass226Array1[local123.anIntArray620[local144]];
			local154 = Static184.aFloatArray16;
			local152.method5059(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt7197;
			local176 = local123.anIntArray619[local171];
			Static184.aClass187Array1[local176].method4271(Static184.aFloatArray16, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static184.aFloatArray16[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static184.aFloatArray16;
			...
			@Pc(252) float[] local252 = local19 ? Static184.aFloatArray19 : Static184.aFloatArray13;
			@Pc(258) float[] local258 = local19 ? Static184.aFloatArray14 : Static184.aFloatArray18;
			@Pc(264) float[] local264 = local19 ? Static184.aFloatArray12 : Static184.aFloatArray15;
			@Pc(270) int[] local270 = local19 ? Static184.anIntArray300 : Static184.anIntArray301;
			...
			@Pc(486) int local486 = Static278.method4208(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static184.aFloatArray16[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static184.aFloatArray16[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt3223 > 0) {
			local176 = this.anInt3223 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean227) {
				for (local212 = 0; local212 < this.anInt3222; local212++) {
					local1254 = (this.anInt3223 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static184.aFloatArray16[local212];
				}
			}
		}
		local154 = this.aFloatArray17;
		this.aFloatArray17 = Static184.aFloatArray16;
		Static184.aFloatArray16 = local154;
		this.anInt3223 = local25;
		this.anInt3222 = local104 - (local25 >> 1);
		this.aBoolean227 = local140;
		return local1228;
	}
}
