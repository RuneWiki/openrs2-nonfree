...
public final class Class12 {
	...
	private static int anInt549 = 19639;
	...
	public static void method303(@OriginalArg(0) byte[] arg0) {
		try {
			@Pc(7) Class1_Sub1_Sub3 local7 = new Class1_Sub1_Sub3(-49365, arg0);
			local7.anInt763 = arg0.length - 8;
			@Pc(26) int local26 = local7.method482();
			@Pc(29) int local29 = local7.method482();
			@Pc(32) int local32 = local7.method482();
			@Pc(35) int local35 = local7.method482();
			@Pc(43) Class1_Sub1_Sub3 local43 = new Class1_Sub1_Sub3(-49365, arg0);
			local43.anInt763 = 0;
			@Pc(52) int local52 = local26 + 0 + 2;
			@Pc(58) Class1_Sub1_Sub3 local58 = new Class1_Sub1_Sub3(-49365, arg0);
			local58.anInt763 = local52;
			@Pc(65) int local65 = local52 + local29;
			@Pc(71) Class1_Sub1_Sub3 local71 = new Class1_Sub1_Sub3(-49365, arg0);
			local71.anInt763 = local65;
			@Pc(78) int local78 = local65 + local32;
			@Pc(84) Class1_Sub1_Sub3 local84 = new Class1_Sub1_Sub3(-49365, arg0);
			local84.anInt763 = local78;
			@Pc(91) int local91 = local78 + local35;
			@Pc(97) Class1_Sub1_Sub3 local97 = new Class1_Sub1_Sub3(-49365, arg0);
			local97.anInt763 = local91;
			@Pc(106) Class10 local106 = new Class10(local97, 117);
			...
			for (@Pc(123) int local123 = 0; local123 < local109; local123++) {
				...
				local136.anInt550 = local84.method480();
			...
			signlink.reporterror("94148, " + arg0 + ", " + 107 + ", " + local335.toString());
	...
	public static void method304() {
		try {
			...
			signlink.reporterror("15614, " + true + ", " + local6.toString());
			throw new RuntimeException();
		}
	}
	...
	public static Class12 method305(@OriginalArg(1) int arg0) {
		try {
			...
			signlink.reporterror("74485, " + 0 + ", " + arg0 + ", " + local17.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!g", name = "a", descriptor = "(IZ)Z")
	public static boolean method306(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		try {
			if (!arg1) {
				anInt549 = -100;
			}
			...
			signlink.reporterror("81092, " + arg0 + ", " + arg1 + ", " + local11.toString());
			throw new RuntimeException();
		}
	}
