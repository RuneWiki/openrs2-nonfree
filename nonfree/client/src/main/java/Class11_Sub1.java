...
public final class Class11_Sub1 extends Class11 {
	...
	@OriginalMember(owner = "client!af", name = "<init>", descriptor = "(ILclient!up;)V")
	public Class11_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub46 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lclient!up;)V")
	public Class11_Sub1(@OriginalArg(0) Class5_Sub46 arg0) {
		super(arg0);
	}
	...
	public void method8534() {
		if (super.anInt10053 < 1 || super.anInt10053 > 3) {
	...
	protected int method8535() {
		return super.aClass5_Sub46_30.method8195().method2907() ? 3 : 2;
	}
