...
public final class Static137 {
	...
	@OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lclient!re;III)Lclient!jf;")
	public static Class4_Sub1_Sub2 method904(@OriginalArg(0) Class4_Sub6_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray36 == null || arg0.aByteArray36.length == 0 ? null : new Class4_Sub1_Sub2(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!jf", name = "a", descriptor = "(I[B[IIIIIIIILclient!jf;)I")
	public static int method905(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class4_Sub1_Sub2 arg8) {
		arg2 >>= 0x8;
	...
	@OriginalMember(owner = "client!jf", name = "a", descriptor = "([B[IIIIIIILclient!jf;)I")
	public static int method910(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class4_Sub1_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt1529 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!jf", name = "a", descriptor = "([B[IIIIIIIILclient!jf;)I")
	public static int method913(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class4_Sub1_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1524 += arg8.anInt1530 * (local22 - arg3);
		arg8.anInt1523 += arg8.anInt1532 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!jf", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!jf;)I")
	public static int method916(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class4_Sub1_Sub2 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt1526 += arg10.anInt1525 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt1524 = arg4 >> 2;
		arg10.anInt1523 = arg5 >> 2;
		arg10.anInt1529 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!jf", name = "a", descriptor = "(II[B[IIIIIIIILclient!jf;II)I")
	public static int method918(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub1_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!jf", name = "b", descriptor = "(II[B[IIIIIIIILclient!jf;II)I")
	public static int method919(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub1_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1524 -= arg8.anInt1530 * arg3;
		arg8.anInt1523 -= arg8.anInt1532 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!jf", name = "b", descriptor = "([B[IIIIIIILclient!jf;)I")
	public static int method920(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class4_Sub1_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!jf", name = "a", descriptor = "(II[B[IIIIIIILclient!jf;II)I")
	public static int method921(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class4_Sub1_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!jf", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!jf;II)I")
	public static int method922(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class4_Sub1_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1526 -= arg10.anInt1525 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt1526 += arg10.anInt1525 * local63;
		arg10.anInt1524 = arg4;
		arg10.anInt1523 = arg5;
		arg10.anInt1529 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!jf", name = "b", descriptor = "([B[IIIIIIIILclient!jf;)I")
	public static int method924(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class4_Sub1_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1524 += arg8.anInt1530 * (local24 - arg3);
		arg8.anInt1523 += arg8.anInt1532 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!jf", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!jf;)I")
	public static int method927(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class4_Sub1_Sub2 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt1526 += arg10.anInt1525 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!jf", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!jf;II)I")
	public static int method930(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class4_Sub1_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1526 -= arg10.anInt1525 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!jf", name = "c", descriptor = "(II[B[IIIIIIIILclient!jf;II)I")
	public static int method931(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub1_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!jf", name = "d", descriptor = "(II[B[IIIIIIIILclient!jf;II)I")
	public static int method932(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class4_Sub1_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1524 -= arg8.anInt1530 * arg3;
		arg8.anInt1523 -= arg8.anInt1532 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!jf", name = "b", descriptor = "(II[B[IIIIIIILclient!jf;II)I")
	public static int method934(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class4_Sub1_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!jf", name = "b", descriptor = "(I[B[IIIIIIIILclient!jf;)I")
	public static int method935(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class4_Sub1_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lclient!re;II)Lclient!jf;")
	public static Class4_Sub1_Sub2 method937(@OriginalArg(0) Class4_Sub6_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray36 == null || arg0.aByteArray36.length == 0 ? null : new Class4_Sub1_Sub2(arg0, (int) ((long) arg0.anInt2326 * 256L * (long) 100 / (long) (Static115.anInt2690 * 100)), arg1 << 6);
	}
}
