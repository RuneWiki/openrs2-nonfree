...
public final class Static137 {
	...
	@OriginalMember(owner = "client!nd", name = "a", descriptor = "([B[IIIIIIIILclient!nd;)I")
	public static int method1288(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub5_Sub2 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt1994 += arg8.anInt2000 * (local24 - arg3);
		arg8.anInt1998 += arg8.anInt2004 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	public static int method1289(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub5_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		...
		local63 = arg3 >> 1;
		arg10.anInt1993 += arg10.anInt2002 * local63;
		arg10.anInt1994 = arg4;
		arg10.anInt1998 = arg5;
		arg10.anInt1995 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!nd", name = "a", descriptor = "(II[B[IIIIIIIILclient!nd;II)I")
	public static int method1290(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub5_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1994 -= arg8.anInt2000 * arg3;
		arg8.anInt1998 -= arg8.anInt2004 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!nd", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!nd;)I")
	public static int method1291(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub5_Sub2 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt1993 += arg10.anInt2002 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt1994 = arg4 >> 2;
		arg10.anInt1998 = arg5 >> 2;
		arg10.anInt1995 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!nd", name = "a", descriptor = "(I[B[IIIIIIIILclient!nd;)I")
	public static int method1293(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub5_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
	...
	@OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lclient!s;III)Lclient!nd;")
	public static Class2_Sub5_Sub2 method1294(@OriginalArg(0) Class2_Sub4_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray35 == null || arg0.aByteArray35.length == 0 ? null : new Class2_Sub5_Sub2(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!nd", name = "a", descriptor = "([B[IIIIIIILclient!nd;)I")
	public static int method1295(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub5_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt1995 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!nd", name = "b", descriptor = "([B[IIIIIIIILclient!nd;)I")
	public static int method1297(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub5_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1994 += arg8.anInt2000 * (local22 - arg3);
		arg8.anInt1998 += arg8.anInt2004 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!nd", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!nd;)I")
	public static int method1302(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub5_Sub2 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt1993 += arg10.anInt2002 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!nd", name = "b", descriptor = "([B[IIIIIIILclient!nd;)I")
	public static int method1303(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub5_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!nd", name = "b", descriptor = "(II[B[IIIIIIIILclient!nd;II)I")
	public static int method1304(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub5_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1994 -= arg8.anInt2000 * arg3;
		arg8.anInt1998 -= arg8.anInt2004 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!nd", name = "a", descriptor = "(II[B[IIIIIIILclient!nd;II)I")
	public static int method1305(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub5_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!nd", name = "b", descriptor = "(II[B[IIIIIIILclient!nd;II)I")
	public static int method1312(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub5_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lclient!s;II)Lclient!nd;")
	public static Class2_Sub5_Sub2 method1313(@OriginalArg(0) Class2_Sub4_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray35 == null || arg0.aByteArray35.length == 0 ? null : new Class2_Sub5_Sub2(arg0, (int) ((long) arg0.anInt2500 * 256L * (long) 100 / (long) (Static68.anInt1863 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!nd", name = "b", descriptor = "(I[B[IIIIIIIILclient!nd;)I")
	public static int method1314(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub5_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!nd", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!nd;II)I")
	public static int method1317(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub5_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1993 -= arg10.anInt2002 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!nd", name = "c", descriptor = "(II[B[IIIIIIIILclient!nd;II)I")
	public static int method1318(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub5_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	public static int method1323(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!nd", name = "d", descriptor = "(II[B[IIIIIIIILclient!nd;II)I")
	public static int method1324(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub5_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
