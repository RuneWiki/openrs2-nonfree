...
public final class Class2_Sub16 extends Class2 {
	...
	private float[] method1769(@OriginalArg(0) int arg0) {
		Static112.method1770(this.aByteArrayArray8[arg0]);
		Static112.method1768();
		@Pc(15) int local15 = Static112.method1777(Static97.method1607(Static112.anIntArray263.length - 1));
		@Pc(19) boolean local19 = Static112.aBooleanArray12[local15];
		@Pc(25) int local25 = local19 ? Static112.anInt2532 : Static112.anInt2533;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static112.method1768() != 0;
			local29 = Static112.method1768() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static112.anInt2533 >> 2);
			local67 = (local25 >> 2) + (Static112.anInt2533 >> 2);
			local71 = Static112.anInt2533 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static112.anInt2533 >> 2);
			local104 = local25 + (Static112.anInt2533 >> 2) - (local25 >> 2);
			local108 = Static112.anInt2533 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class59 local123 = Static112.aClass59Array1[Static112.anIntArray263[local15]];
		@Pc(126) int local126 = local123.anInt2521;
		@Pc(131) int local131 = local123.anIntArray261[local126];
		@Pc(140) boolean local140 = !Static112.aClass77Array1[local131].method2378();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt2522; local144++) {
			@Pc(152) Class73 local152 = Static112.aClass73Array1[local123.anIntArray260[local144]];
			local154 = Static112.aFloatArray3;
			local152.method2266(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt2521;
			local176 = local123.anIntArray261[local171];
			Static112.aClass77Array1[local176].method2374(Static112.aFloatArray3, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static112.aFloatArray3[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static112.aFloatArray3;
			...
			@Pc(252) float[] local252 = local19 ? Static112.aFloatArray2 : Static112.aFloatArray1;
			@Pc(258) float[] local258 = local19 ? Static112.aFloatArray7 : Static112.aFloatArray5;
			@Pc(264) float[] local264 = local19 ? Static112.aFloatArray6 : Static112.aFloatArray8;
			@Pc(270) int[] local270 = local19 ? Static112.anIntArray262 : Static112.anIntArray264;
			...
			@Pc(486) int local486 = Static97.method1607(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static112.aFloatArray3[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static112.aFloatArray3[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt2530 > 0) {
			local176 = this.anInt2530 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean111) {
				for (local212 = 0; local212 < this.anInt2529; local212++) {
					local1254 = (this.anInt2530 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static112.aFloatArray3[local212];
				}
			}
		}
		local154 = this.aFloatArray4;
		this.aFloatArray4 = Static112.aFloatArray3;
		Static112.aFloatArray3 = local154;
		this.anInt2530 = local25;
		this.anInt2529 = local104 - (local25 >> 1);
		this.aBoolean111 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!oa", name = "a", descriptor = "([B)V")
	private void method1772(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class2_Sub11 local4 = new Class2_Sub11(arg0);
		this.anInt2528 = local4.method1449();
		this.anInt2531 = local4.method1449();
		this.anInt2534 = local4.method1449();
		this.anInt2535 = local4.method1449();
		if (this.anInt2535 < 0) {
			this.anInt2535 = ~this.anInt2535;
			this.aBoolean110 = true;
		}
		@Pc(40) int local40 = local4.method1449();
		this.aByteArrayArray8 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method1461();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method1473(local49, local64);
			this.aByteArrayArray8[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!oa", name = "a", descriptor = "([I)Lclient!jc;")
	public Class2_Sub10_Sub1 method1775(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray33 == null) {
			this.anInt2530 = 0;
			this.aFloatArray4 = new float[Static112.anInt2532];
			this.aByteArray33 = new byte[this.anInt2531];
			this.anInt2539 = 0;
			this.anInt2537 = 0;
		}
		while (this.anInt2537 < this.aByteArrayArray8.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1769(this.anInt2537);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2539;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt2531 - local47) {
					local50 = this.anInt2531 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2539;
				}
				this.anInt2539 = local47;
			}
			this.anInt2537++;
		}
		...
		return new Class2_Sub10_Sub1(this.anInt2528, local129, this.anInt2534, this.anInt2535, this.aBoolean110);
	}
}
