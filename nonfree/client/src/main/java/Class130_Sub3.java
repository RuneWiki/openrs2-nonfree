...
public final class Class130_Sub3 extends Class130 {
	...
	@OriginalMember(owner = "client!sf", name = "<init>", descriptor = "(Lclient!j;Lclient!vi;[Lclient!dk;[I[I)V", line = 370)
	public Class130_Sub3(@OriginalArg(0) Class19_Sub2 arg0, @OriginalArg(1) Class239 arg1, @OriginalArg(2) Class48[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4) {
		super(arg0, arg1);
		this.aClass19_Sub2_8 = arg0;
		this.aClass19_Sub2_8 = arg0;
		this.anIntArray395 = arg3;
		this.anIntArray391 = arg4;
		this.aByteArrayArray18 = new byte[arg2.length][];
		this.anIntArray392 = new int[arg2.length];
		this.anIntArray393 = new int[arg2.length];
		for (@Pc(32) int local32 = 0; local32 < arg2.length; local32++) {
			this.aByteArrayArray18[local32] = arg2[local32].aByteArray21;
			this.anIntArray392[local32] = arg2[local32].anInt1528;
			this.anIntArray393[local32] = arg2[local32].anInt1533;
		}
		this.anIntArray394 = arg2[0].anIntArray108;
	}

	@OriginalMember(owner = "client!sf", name = "a", descriptor = "(CIIIZLclient!kf;II)V", line = 8)
	@Override
	protected void method5903(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class78 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg5 == null) {
			this.method5893(arg0, arg1, arg2, arg3, arg4);
			return;
		}
		...
		@Pc(37) int local37 = this.aClass19_Sub2_8.anInt2860;
		@Pc(43) int local43 = arg1 + arg2 * local37;
		@Pc(47) int local47 = local37 - local28;
		@Pc(49) int local49 = 0;
		@Pc(51) int local51 = 0;
		@Pc(62) int local62;
		if (arg2 < this.aClass19_Sub2_8.anInt2854) {
			local62 = this.aClass19_Sub2_8.anInt2854 - arg2;
			local33 -= local62;
			arg2 = this.aClass19_Sub2_8.anInt2854;
			local51 = local62 * local28;
			local43 += local62 * local37;
		}
		if (arg2 + local33 > this.aClass19_Sub2_8.anInt2856) {
			local33 -= arg2 + local33 - this.aClass19_Sub2_8.anInt2856;
		}
		if (arg1 < this.aClass19_Sub2_8.anInt2865) {
			local62 = this.aClass19_Sub2_8.anInt2865 - arg1;
			local28 -= local62;
			arg1 = this.aClass19_Sub2_8.anInt2865;
			local51 += local62;
			local43 += local62;
			local49 = local62;
			local47 += local62;
		}
		if (arg1 + local28 > this.aClass19_Sub2_8.anInt2851) {
			local62 = arg1 + local28 - this.aClass19_Sub2_8.anInt2851;
			local28 -= local62;
			local49 += local62;
			local47 += local62;
		}
		...
		if (arg4) {
			this.method5405(this.aByteArrayArray18[arg0], this.aClass19_Sub2_8.anIntArray179, arg3, local51, local43, local28, local33, local47, local49, arg1, arg2, this.anIntArray395[arg0], arg5, arg6, arg7);
		} else {
			this.method5406(this.aByteArrayArray18[arg0], this.aClass19_Sub2_8.anIntArray179, this.anIntArray394, arg3, local51, local43, local28, local33, local47, local49, arg1, arg2, this.anIntArray395[arg0], arg5, arg6, arg7);
		}
	}

	@OriginalMember(owner = "client!sf", name = "a", descriptor = "([B[I[IIIIIII)V", line = 75)
	private void method5404(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
	...
	@OriginalMember(owner = "client!sf", name = "a", descriptor = "([B[IIIIIIIIIIILclient!kf;II)V", line = 133)
	private void method5405(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) Class78 arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14) {
		...
		@Pc(14) int local14 = arg9 - this.aClass19_Sub2_8.anInt2865;
		@Pc(16) int local16 = arg10;
		if (arg14 > arg10) {
			local16 = arg14;
			arg4 += (arg14 - arg10) * this.aClass19_Sub2_8.anInt2860;
	...
	@OriginalMember(owner = "client!sf", name = "a", descriptor = "([B[I[IIIIIIIIIIILclient!kf;II)V", line = 220)
	private void method5406(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) Class78 arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15) {
		...
		@Pc(5) int[] local5 = local2.anIntArray139;
		@Pc(8) int[] local8 = local2.anIntArray140;
		@Pc(14) int local14 = arg10 - this.aClass19_Sub2_8.anInt2865;
		@Pc(16) int local16 = arg11;
		if (arg15 > arg11) {
			local16 = arg15;
			arg5 += (arg15 - arg11) * this.aClass19_Sub2_8.anInt2860;
	...
	protected void method5893(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		...
		@Pc(27) int local27 = this.aClass19_Sub2_8.anInt2860;
		...
		@Pc(52) int local52;
		if (arg2 < this.aClass19_Sub2_8.anInt2854) {
			local52 = this.aClass19_Sub2_8.anInt2854 - arg2;
			local23 -= local52;
			arg2 = this.aClass19_Sub2_8.anInt2854;
			local41 = local52 * local18;
			local33 += local52 * local27;
		}
		if (arg2 + local23 > this.aClass19_Sub2_8.anInt2856) {
			local23 -= arg2 + local23 - this.aClass19_Sub2_8.anInt2856;
		}
		if (arg1 < this.aClass19_Sub2_8.anInt2865) {
			local52 = this.aClass19_Sub2_8.anInt2865 - arg1;
			local18 -= local52;
			arg1 = this.aClass19_Sub2_8.anInt2865;
			local41 += local52;
			local33 += local52;
		...
		if (arg1 + local18 > this.aClass19_Sub2_8.anInt2851) {
			local52 = arg1 + local18 - this.aClass19_Sub2_8.anInt2851;
			local18 -= local52;
			local39 += local52;
			local37 += local52;
		}
		...
		if (arg4) {
			this.method5407(this.aByteArrayArray18[arg0], this.aClass19_Sub2_8.anIntArray179, arg3, local41, local33, local18, local23, local37, local39);
		} else {
			this.method5404(this.aByteArrayArray18[arg0], this.aClass19_Sub2_8.anIntArray179, this.anIntArray394, local41, local33, local18, local23, local37, local39);
		}
	}

	@OriginalMember(owner = "client!sf", name = "a", descriptor = "([B[IIIIIIII)V", line = 393)
	private void method5407(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		@Pc(4) int local4 = -(arg5 >> 2);
		@Pc(9) int local9 = -(arg5 & 0x3);
