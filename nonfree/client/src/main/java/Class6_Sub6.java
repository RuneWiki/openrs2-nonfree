...
public final class Class6_Sub6 extends Class6 {
	...
	@OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Lclient!hs;)V")
	public Class6_Sub6(@OriginalArg(0) Class5_Sub25 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(ILclient!hs;)V")
	public Class6_Sub6(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub25 arg1) {
		super(arg0, arg1);
	}
	...
	protected int method8535() {
		return super.aClass5_Sub25_32.method3682() == Static550.aClass63_6 && super.aClass5_Sub25_32.method3685() ? 0 : 1;
	}
