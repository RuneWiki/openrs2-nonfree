...
public final class Static124 {
	...
	public static int anInt5134 = -1;

	@OriginalMember(owner = "client!jc", name = "N", descriptor = "I")
	public static int anInt5135 = 256;

	@OriginalMember(owner = "client!jc", name = "O", descriptor = "I")
	public static int anInt5136 = 256;
	...
	public static int anInt5140 = -1;

	@OriginalMember(owner = "client!jc", name = "T", descriptor = "I")
	public static int anInt5141 = -1;

	@OriginalMember(owner = "client!jc", name = "V", descriptor = "I")
	public static int anInt5142 = 0;

	@OriginalMember(owner = "client!jc", name = "a", descriptor = "([[B[[B[I[I[III)I")
	public static int method4091(@OriginalArg(0) byte[][] arg0, @OriginalArg(1) byte[][] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int[] arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
	...
	@OriginalMember(owner = "client!jc", name = "b", descriptor = "(Ljava/lang/String;)Ljava/lang/String;")
	public static String method4092(@OriginalArg(0) String arg0) {
