...
public class Applet_Sub1 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
	...
	protected final void method62() {
		try {
			...
			signlink.reporterror("32828, " + 532 + ", " + 789 + ", " + 0 + ", " + local48.toString());
	...
	protected final void method63() {
		try {
			...
			signlink.reporterror("68129, " + 532 + ", " + false + ", " + 789 + ", " + local37.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method64() {
		try {
			...
			signlink.reporterror("31182, " + -652 + ", " + local27.toString());
			throw new RuntimeException();
		}
	}
	...
	protected final void method65() {
		try {
			...
			signlink.reporterror("9789, " + 386 + ", " + 1 + ", " + local16.toString());
			throw new RuntimeException();
		}
	}
	...
	public final void mousePressed(@OriginalArg(0) MouseEvent arg0) {
		...
		if (Class8.aBoolean81) {
			Class8.method213(local2, arg0.isMetaDown() ? 1 : 0, local5);
		}
	}
	...
	public final void mouseDragged(@OriginalArg(0) MouseEvent arg0) {
		...
		if (Class8.aBoolean81) {
			Class8.method215(local5, local2);
		}
	}
	...
	protected final int method66() {
		try {
			...
			signlink.reporterror("3026, " + false + ", " + local27.toString());
			throw new RuntimeException();
		}
	}
	...
	protected void method74(@OriginalArg(1) String arg0, @OriginalArg(2) int arg1) {
		try {
			...
			signlink.reporterror("55533, " + true + ", " + arg0 + ", " + arg1 + ", " + local177.toString());
			throw new RuntimeException();
		}
	}
}
