...
public class Applet_Sub1 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
	...
	protected int anInt210;

	@OriginalMember(owner = "client!a", name = "C", descriptor = "I")
	protected int anInt211;
	...
	protected boolean aBoolean50 = true;
	...
	protected final void method84() {
		try {
			this.anInt201 = 765;
			this.anInt202 = 503;
			this.aFrame_Sub1_2 = new Frame_Sub1(this, 0, this.anInt202, this.anInt201);
			this.aGraphics2 = this.method94().getGraphics();
			this.aClass35_2 = new Class35(false, this.method94(), this.anInt201, this.anInt202);
			this.method95(this, 1);
		} catch (@Pc(52) RuntimeException local52) {
			signlink.reporterror("39894, " + 8 + ", " + 503 + ", " + 765 + ", " + local52.toString());
	...
	protected final void method85() {
		try {
			...
			signlink.reporterror("54855, " + -97 + ", " + 765 + ", " + 503 + ", " + local35.toString());
			throw new RuntimeException();
		}
	}
		...
		while (true) {
			...
			do {
				...
				if (this.aLongArray2[local37] == 0L) {
					...
					local39 = (int) ((long) (this.anInt198 * 2560) / (local60 - this.aLongArray2[local37]));
				}
				if (local39 < 25) {
					local39 = 25;
				}
				if (local39 > 256) {
					local39 = 256;
					local41 = (int) ((long) this.anInt198 - (local60 - this.aLongArray2[local37]) / 10L);
				}
				if (local41 > this.anInt198) {
					local41 = this.anInt198;
				}
				...
				if (local41 < this.anInt199) {
					local41 = this.anInt199;
				}
				try {
				...
				while (local43 < 256) {
					this.anInt210 = this.anInt207;
					this.anInt211 = this.anInt208;
					this.anInt212 = this.anInt209;
					this.aLong13 = this.aLong12;
					this.anInt207 = 0;
					this.method90();
					this.anInt213 = this.anInt214;
					local43 += local39;
				}
				local43 &= 0xFF;
				if (this.anInt198 > 0) {
					this.anInt200 = local39 * 1000 / (this.anInt198 * 256);
				}
				this.method92();
			...
			System.out.println("fps:" + this.anInt200 + " ratio:" + local39 + " count:" + local43);
			System.out.println("del:" + local41 + " deltime:" + this.anInt198 + " mindel:" + this.anInt199);
	...
	private void method86() {
		try {
			...
			signlink.reporterror("71047, " + 747 + ", " + local27.toString());
			throw new RuntimeException();
		}
	}
	...
	protected final void method87() {
		try {
			...
			signlink.reporterror("88751, " + 1 + ", " + 9 + ", " + local9.toString());
			throw new RuntimeException();
		}
	}
	...
	public final void stop() {
		if (this.anInt197 >= 0) {
			this.anInt197 = 4000 / this.anInt198;
		}
	}
	...
	public final void mouseDragged(@OriginalArg(0) MouseEvent arg0) {
		...
		this.anInt203 = 0;
		this.anInt205 = local2;
		this.anInt206 = local5;
	}
	...
	public final void keyPressed(@OriginalArg(0) KeyEvent arg0) {
		...
		if (local10 > 4) {
			this.anIntArray31[this.anInt214] = local10;
			this.anInt214 = this.anInt214 + 1 & 0x7F;
		}
	}
	...
	protected final int method88() {
		try {
			@Pc(7) int local7 = -1;
			if (this.anInt214 != this.anInt213) {
				local7 = this.anIntArray31[this.anInt213];
				this.anInt213 = this.anInt213 + 1 & 0x7F;
			}
			return local7;
		} catch (@Pc(29) RuntimeException local29) {
			signlink.reporterror("18819, " + -28882 + ", " + local29.toString());
			throw new RuntimeException();
		}
	}
	...
	protected Component method94() {
		try {
			...
			signlink.reporterror("68843, " + 7 + ", " + local15.toString());
			throw new RuntimeException();
		}
	}
	...
	protected void method96(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1) {
		try {
			...
			if (this.aBoolean49) {
				...
				this.aGraphics2.fillRect(0, 0, this.anInt201, this.anInt202);
				this.aBoolean49 = false;
			}
			@Pc(81) Color local81 = new Color(140, 17, 17);
			@Pc(88) int local88 = this.anInt202 / 2 - 18;
			this.aGraphics2.setColor(local81);
			this.aGraphics2.drawRect(this.anInt201 / 2 - 152, local88, 304, 34);
			this.aGraphics2.fillRect(this.anInt201 / 2 - 150, local88 + 2, arg1 * 3, 30);
			this.aGraphics2.setColor(Color.black);
			this.aGraphics2.fillRect(this.anInt201 / 2 + arg1 * 3 - 150, local88 + 2, 300 - arg1 * 3, 30);
			this.aGraphics2.setFont(local36);
			this.aGraphics2.setColor(Color.white);
			this.aGraphics2.drawString(arg0, (this.anInt201 - local42.stringWidth(arg0)) / 2, local88 + 22);
		} catch (@Pc(180) RuntimeException local180) {
			signlink.reporterror("94506, " + arg0 + ", " + arg1 + ", " + -427 + ", " + local180.toString());
			throw new RuntimeException();
		}
	}
}
