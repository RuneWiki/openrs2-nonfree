...
public class Applet_Sub1 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
	...
	@OriginalMember(owner = "client!a", name = "b", descriptor = "I")
	private int anInt184 = 9;

	@OriginalMember(owner = "client!a", name = "c", descriptor = "I")
	private int anInt185 = -747;
	...
	protected boolean aBoolean55 = false;
	...
	protected boolean aBoolean57 = true;
	...
	protected final void method83() {
		try {
			this.anInt190 = 765;
			this.anInt191 = 503;
			this.aFrame_Sub1_2 = new Frame_Sub1(this.anInt190, -284, this.anInt191, this);
			this.aGraphics2 = this.method93().getGraphics();
			this.aClass35_2 = new Class35(this.anInt191, this.anInt190, this.method93(), false);
			this.method94(this, 1);
		} catch (@Pc(44) RuntimeException local44) {
			signlink.reporterror("35743, " + 503 + ", " + 765 + ", " + 461 + ", " + local44.toString());
	...
	protected final void method84() {
		try {
			...
			signlink.reporterror("46589, " + 765 + ", " + 0 + ", " + 503 + ", " + local35.toString());
			throw new RuntimeException();
		}
	}
	...
	private void method85(@OriginalArg(0) boolean arg0) {
		try {
			if (!arg0) {
				this.anInt186 = -2;
			...
			signlink.reporterror("9886, " + arg0 + ", " + local21.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!a", name = "a", descriptor = "(IB)V")
	protected final void method86(@OriginalArg(1) byte arg0) {
		try {
			this.anInt187 = 1000;
			@Pc(9) boolean local9 = false;
		} catch (@Pc(15) RuntimeException local15) {
			signlink.reporterror("64650, " + 1 + ", " + arg0 + ", " + local15.toString());
			throw new RuntimeException();
		}
	}
	...
	public final void keyPressed(@OriginalArg(0) KeyEvent arg0) {
		...
		if (local10 > 4) {
			this.anIntArray30[this.anInt203] = local10;
	...
	protected final int method87() {
		try {
			...
			if (this.anInt203 != this.anInt202) {
				local1 = this.anIntArray30[this.anInt202];
				this.anInt202 = this.anInt202 + 1 & 0x7F;
			}
			return local1;
		} catch (@Pc(28) RuntimeException local28) {
			signlink.reporterror("9001, " + 11545 + ", " + local28.toString());
			throw new RuntimeException();
		}
	}
	...
	protected void method91(@OriginalArg(0) int arg0) {
		try {
			...
			signlink.reporterror("49485, " + arg0 + ", " + local5.toString());
			throw new RuntimeException();
		}
	}
	...
	protected Component method93() {
		try {
			...
			signlink.reporterror("67514, " + 37639 + ", " + local15.toString());
			throw new RuntimeException();
		}
	}
	...
	protected void method95(@OriginalArg(1) int arg0, @OriginalArg(2) String arg1) {
		try {
			...
			this.aGraphics2.setColor(Color.black);
			if (this.anInt184 <= 9 && this.anInt184 >= 9) {
			...
			signlink.reporterror("78919, " + 9 + ", " + arg0 + ", " + arg1 + ", " + local180.toString());
			throw new RuntimeException();
		}
	}
}
