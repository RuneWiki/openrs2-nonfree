...
public class Applet_Sub1 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
	...
	protected int anInt214;

	@OriginalMember(owner = "client!a", name = "E", descriptor = "I")
	protected int anInt215;
	...
	private int anInt197 = 8;

	@OriginalMember(owner = "client!a", name = "c", descriptor = "I")
	private int anInt198 = 15954;
	...
	private int anInt199 = 1;

	@OriginalMember(owner = "client!a", name = "h", descriptor = "I")
	private int anInt201 = 20;

	@OriginalMember(owner = "client!a", name = "i", descriptor = "I")
	protected int anInt202 = 1;
	...
	@OriginalMember(owner = "client!a", name = "q", descriptor = "[Lclient!ib;")
	...
	protected final void method84() {
		try {
			this.anInt204 = 765;
			this.anInt205 = 503;
			this.aFrame_Sub1_2 = new Frame_Sub1(this.anInt204, (byte) -80, this, this.anInt205);
			this.aGraphics2 = this.method94().getGraphics();
			this.aClass35_2 = new Class35(500, this.anInt204, this.method94(), this.anInt205);
			this.method95(this, 1);
		} catch (@Pc(52) RuntimeException local52) {
			signlink.reporterror("73840, " + -46694 + ", " + 765 + ", " + 503 + ", " + local52.toString());
	...
	protected final void method85() {
		try {
			...
			signlink.reporterror("26577, " + 765 + ", " + 503 + ", " + false + ", " + local33.toString());
			throw new RuntimeException();
		}
	}
		...
		while (true) {
			...
			do {
				...
				if (this.aLongArray2[local37] == 0L) {
					...
					local39 = (int) ((long) (this.anInt201 * 2560) / (local60 - this.aLongArray2[local37]));
				}
				if (local39 < 25) {
					local39 = 25;
				}
				if (local39 > 256) {
					local39 = 256;
					local41 = (int) ((long) this.anInt201 - (local60 - this.aLongArray2[local37]) / 10L);
				}
				if (local41 > this.anInt201) {
					local41 = this.anInt201;
				}
				...
				if (local41 < this.anInt202) {
					local41 = this.anInt202;
				}
				try {
				...
				while (local43 < 256) {
					this.anInt213 = this.anInt210;
					this.anInt214 = this.anInt211;
					this.anInt215 = this.anInt212;
					this.aLong13 = this.aLong12;
					this.anInt210 = 0;
					this.method90();
					this.anInt216 = this.anInt217;
					local43 += local39;
				}
				local43 &= 0xFF;
				if (this.anInt201 > 0) {
					this.anInt203 = local39 * 1000 / (this.anInt201 * 256);
				}
				this.method92((byte) 6);
			...
			System.out.println("fps:" + this.anInt203 + " ratio:" + local39 + " count:" + local43);
			System.out.println("del:" + local41 + " deltime:" + this.anInt201 + " mindel:" + this.anInt202);
	...
	private void method86() {
		try {
			...
			signlink.reporterror("19577, " + 41274 + ", " + local24.toString());
			throw new RuntimeException();
		}
	}
	...
	protected final void method87() {
		try {
			...
			signlink.reporterror("88831, " + -577 + ", " + 1 + ", " + local13.toString());
			throw new RuntimeException();
		}
	}
	...
	public final void stop() {
		if (this.anInt200 >= 0) {
			this.anInt200 = 4000 / this.anInt201;
		}
	}
	...
	public final void mousePressed(@OriginalArg(0) MouseEvent arg0) {
		...
		this.anInt206 = 0;
		this.anInt211 = local2;
		this.anInt212 = local5;
	...
	public final void mouseDragged(@OriginalArg(0) MouseEvent arg0) {
		...
		this.anInt206 = 0;
		this.anInt208 = local2;
		this.anInt209 = local5;
	}
	...
	public final void keyPressed(@OriginalArg(0) KeyEvent arg0) {
		...
		if (local10 > 4) {
			this.anIntArray31[this.anInt217] = local10;
			this.anInt217 = this.anInt217 + 1 & 0x7F;
		}
	}
	...
	protected final int method88() {
		try {
			...
			if (this.anInt217 != this.anInt216) {
				local12 = this.anIntArray31[this.anInt216];
				this.anInt216 = this.anInt216 + 1 & 0x7F;
			}
			return local12;
		} catch (@Pc(34) RuntimeException local34) {
			signlink.reporterror("81094, " + 28 + ", " + local34.toString());
			throw new RuntimeException();
		}
	}
	...
	protected Component method94() {
		try {
			...
			signlink.reporterror("17334, " + 19330 + ", " + local15.toString());
			throw new RuntimeException();
		}
	}
	...
	protected void method96(@OriginalArg(0) int arg0, @OriginalArg(2) String arg1) {
		try {
			...
			if (this.aBoolean45) {
				...
				this.aGraphics2.fillRect(0, 0, this.anInt204, this.anInt205);
				this.aBoolean45 = false;
			}
			@Pc(81) Color local81 = new Color(140, 17, 17);
			@Pc(88) int local88 = this.anInt205 / 2 - 18;
			this.aGraphics2.setColor(local81);
			this.aGraphics2.drawRect(this.anInt204 / 2 - 152, local88, 304, 34);
			this.aGraphics2.fillRect(this.anInt204 / 2 - 150, local88 + 2, arg0 * 3, 30);
			this.aGraphics2.setColor(Color.black);
			this.aGraphics2.fillRect(this.anInt204 / 2 + arg0 * 3 - 150, local88 + 2, 300 - arg0 * 3, 30);
			this.aGraphics2.setFont(local36);
			this.aGraphics2.setColor(Color.white);
			this.aGraphics2.drawString(arg1, (this.anInt204 - local42.stringWidth(arg1)) / 2, local88 + 22);
		} catch (@Pc(175) RuntimeException local175) {
			signlink.reporterror("23000, " + arg0 + ", " + -37 + ", " + arg1 + ", " + local175.toString());
			throw new RuntimeException();
		}
	}
}
