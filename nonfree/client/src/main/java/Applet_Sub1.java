...
public class Applet_Sub1 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
	...
	protected int anInt123;

	@OriginalMember(owner = "client!a", name = "r", descriptor = "I")
	protected int anInt124;

	@OriginalMember(owner = "client!a", name = "s", descriptor = "I")
	protected int anInt125;
	...
	private byte aByte16 = -71;

	@OriginalMember(owner = "client!a", name = "d", descriptor = "I")
	private int anInt116 = 3;

	@OriginalMember(owner = "client!a", name = "f", descriptor = "I")
	private int anInt118 = 20;

	@OriginalMember(owner = "client!a", name = "g", descriptor = "I")
	protected int anInt119 = 1;
	...
	protected final void method62() {
		try {
			this.anInt121 = 789;
			this.anInt122 = 532;
			this.aFrame_Sub1_2 = new Frame_Sub1(this.anInt121, this.anInt122, this, (byte) 8);
			this.aGraphics2 = this.method72().getGraphics();
			this.aClass32_2 = new Class32(this.anInt121, this.method72(), this.anInt122, 947);
			this.method73(this, 1);
		} catch (@Pc(51) RuntimeException local51) {
			signlink.reporterror("19856, " + 532 + ", " + 789 + ", " + 2 + ", " + local51.toString());
	...
	protected final void method63() {
		try {
			...
			signlink.reporterror("11742, " + false + ", " + 532 + ", " + 789 + ", " + local33.toString());
			throw new RuntimeException();
		}
	}
	...
	public void run() {
		...
		while (this.anInt117 >= 0) {
			if (this.anInt117 > 0) {
				this.anInt117--;
				if (this.anInt117 == 0) {
					this.method64(this.aByte16);
					return;
				}
			}
			@Pc(79) int local79 = local39;
			...
			if (this.aLongArray2[local37] == 0L) {
				...
				local39 = (int) ((long) (this.anInt118 * 2560) / (local58 - this.aLongArray2[local37]));
			}
			if (local39 < 25) {
				local39 = 25;
			}
			if (local39 > 256) {
				local39 = 256;
				local41 = (int) ((long) this.anInt118 - (local58 - this.aLongArray2[local37]) / 10L);
			}
			this.aLongArray2[local37] = local58;
			local37 = (local37 + 1) % 10;
			if (local41 > 1) {
				for (@Pc(161) int local161 = 0; local161 < 10; local161++) {
					if (this.aLongArray2[local161] != 0L) {
						this.aLongArray2[local161] += local41;
					}
				}
			}
			if (local41 < this.anInt119) {
				local41 = this.anInt119;
			}
			try {
			...
			while (local43 < 256) {
				this.method68();
				this.anInt127 = 0;
				this.anInt130 = this.anInt131;
				local43 += local39;
			}
			local43 &= 0xFF;
			if (this.anInt118 > 0) {
				this.anInt120 = local39 * 1000 / (this.anInt118 * 256);
			}
			this.method70();
		}
		if (this.anInt117 == -1) {
	...
	private void method64(@OriginalArg(0) byte arg0) {
		try {
			this.anInt117 = -2;
			this.method69();
			if (arg0 != -71) {
			...
			signlink.reporterror("36737, " + arg0 + ", " + local21.toString());
			throw new RuntimeException();
		}
	}
	...
	protected final void method65() {
		try {
			...
			signlink.reporterror("35486, " + true + ", " + 1 + ", " + local9.toString());
			throw new RuntimeException();
		}
	}
	...
	public final void stop() {
		if (this.anInt117 >= 0) {
			this.anInt117 = 4000 / this.anInt118;
		}
	}
	...
	public final void mousePressed(@OriginalArg(0) MouseEvent arg0) {
		...
		this.anInt123 = 0;
		this.anInt128 = local2;
		this.anInt129 = local5;
		if (arg0.isMetaDown()) {
			this.anInt127 = 2;
			this.anInt124 = 2;
		} else {
		...
		if (Class8.aBoolean84) {
			Class8.method212(local2, arg0.isMetaDown() ? 1 : 0, local5);
		}
	}
	...
	public final void mouseDragged(@OriginalArg(0) MouseEvent arg0) {
		...
		this.anInt123 = 0;
		this.anInt125 = local2;
		this.anInt126 = local5;
		if (Class8.aBoolean84) {
	...
	public final void keyPressed(@OriginalArg(0) KeyEvent arg0) {
		...
		if (local10 > 4) {
			this.anIntArray29[this.anInt131] = local10;
			this.anInt131 = this.anInt131 + 1 & 0x7F;
		}
		if (Class8.aBoolean84) {
	...
	protected final int method66() {
		try {
			@Pc(7) int local7 = -1;
			if (this.anInt131 != this.anInt130) {
				local7 = this.anIntArray29[this.anInt130];
				this.anInt130 = this.anInt130 + 1 & 0x7F;
			}
			return local7;
		} catch (@Pc(29) RuntimeException local29) {
			signlink.reporterror("80101, " + 9 + ", " + local29.toString());
			throw new RuntimeException();
		}
	}
	...
	protected Component method72() {
		try {
			...
			signlink.reporterror("26069, " + 16374 + ", " + local18.toString());
			throw new RuntimeException();
		}
	}
	...
	protected void method74(@OriginalArg(1) String arg0, @OriginalArg(2) int arg1) {
		try {
			...
			@Pc(41) FontMetrics local41 = this.method72().getFontMetrics(local35);
			@Pc(48) Font local48 = new Font("Helvetica", 0, 13);
			this.method72().getFontMetrics(local48);
			if (this.aBoolean39) {
				this.aGraphics2.setColor(Color.black);
				this.aGraphics2.fillRect(0, 0, this.anInt121, this.anInt122);
				this.aBoolean39 = false;
			}
			@Pc(80) Color local80 = new Color(140, 17, 17);
			@Pc(87) int local87 = this.anInt122 / 2 - 18;
			this.aGraphics2.setColor(local80);
			this.aGraphics2.drawRect(this.anInt121 / 2 - 152, local87, 304, 34);
			this.aGraphics2.fillRect(this.anInt121 / 2 - 150, local87 + 2, arg1 * 3, 30);
			this.aGraphics2.setColor(Color.black);
			this.aGraphics2.fillRect(this.anInt121 / 2 + arg1 * 3 - 150, local87 + 2, 300 - arg1 * 3, 30);
			this.aGraphics2.setFont(local35);
			this.aGraphics2.setColor(Color.white);
			this.aGraphics2.drawString(arg0, (this.anInt121 - local41.stringWidth(arg0)) / 2, local87 + 22);
		} catch (@Pc(174) RuntimeException local174) {
			signlink.reporterror("40340, " + 72 + ", " + arg0 + ", " + arg1 + ", " + local174.toString());
			throw new RuntimeException();
		}
	}
}
