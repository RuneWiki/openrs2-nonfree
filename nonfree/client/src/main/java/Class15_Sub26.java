...
public final class Class15_Sub26 extends Class15 {
	...
	@OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Lclient!vba;)V")
	public Class15_Sub26(@OriginalArg(0) Class3_Sub55 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(ILclient!vba;)V")
	public Class15_Sub26(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub55 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!vc", name = "c", descriptor = "(B)I")
	public int method8908() {
