...
public class Class8_Sub1 extends Class8 {
	...
	@OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lclient!bf;IIIIZ[FI)V", line = 6)
	public Class8_Sub1(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) int arg7) {
		...
		if (arg5 && this.anInt6869 != 34037) {
			Static381.method6154(local20, arg1, arg2, arg3, arg4, arg7, arg6);
			this.method6166(true);
		} else {
			local20.glTexImage2D(this.anInt6869, 0, this.anInt6870, this.anInt3680, this.anInt3681, 0, arg7, 5126, FloatBuffer.wrap(arg6));
			this.method6166(false);
		}
		this.method6161(true);
	}

	@OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lclient!bf;IIIIZ[IZ)V", line = 31)
	public Class8_Sub1(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) boolean arg7) {
		...
		this.aClass19_Sub1_40.method848(this);
		if (arg5 && this.anInt6869 != 34037) {
			Static381.method6165(local20, this.anInt6869, this.anInt6870, this.anInt3680, this.anInt3681, this.aClass19_Sub1_40.anInt592, arg6);
			this.method6166(true);
		} else {
			local20.glTexImage2D(this.anInt6869, 0, this.anInt6870, this.anInt3680, this.anInt3681, 0, 32993, this.aClass19_Sub1_40.anInt592, IntBuffer.wrap(arg6));
			this.method6166(false);
		}
		this.method6161(true);
	}

	@OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lclient!bf;IIII)V", line = 79)
	public Class8_Sub1(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		@Pc(20) opengl local20 = arg0.anOpengl1;
		this.aClass19_Sub1_40.method848(this);
		local20.glTexImage2D(this.anInt6869, 0, this.anInt6870, arg3, arg4, 0, Static381.method6156(this.anInt6870), 5121, null);
		this.method6161(true);
	}

	@OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lclient!bf;IIIIZ[BIZ)V", line = 140)
	public Class8_Sub1(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) byte[] arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean arg8) {
		...
		if (arg5 && this.anInt6869 != 34037) {
			Static381.method6158(local20, arg1, arg2, arg3, arg4, arg7, arg6);
			this.method6166(true);
		} else {
			local20.glTexImage2D(this.anInt6869, 0, this.anInt6870, this.anInt3680, this.anInt3681, 0, arg7, 5121, ByteBuffer.wrap(arg6));
			this.method6166(false);
		}
	...
	@OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lclient!bf;IIIII)V", line = 241)
	protected Class8_Sub1(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		this.anInt3681 = arg5;
		@Pc(20) opengl local20 = arg0.anOpengl1;
		@Pc(29) int local29 = this.aClass19_Sub1_40.method821().method5794() - arg3 - arg5;
		this.aClass19_Sub1_40.method848(this);
		local20.glCopyTexImage2D(this.anInt6869, 0, this.anInt6870, arg2, local29, arg4, arg5, 0);
		this.method6161(true);
	}

	@OriginalMember(owner = "client!al", name = "a", descriptor = "()V", line = 27)
	@Override
	public final void method6153() {
		this.aClass19_Sub1_40.anOpengl1.glFramebufferTexture2DEXT(36160, this.anInt3682, this.anInt6869, 0, 0);
		this.anInt3682 = -1;
	}

	@OriginalMember(owner = "client!al", name = "a", descriptor = "(IIII[BIIIZ)V", line = 90)
	public final void method3636(@OriginalArg(2) int arg0, @OriginalArg(3) int arg1, @OriginalArg(4) byte[] arg2, @OriginalArg(5) int arg3, @OriginalArg(8) boolean arg4) {
		@Pc(3) opengl local3 = this.aClass19_Sub1_40.anOpengl1;
		if (arg4) {
			@Pc(12) int local12 = Static381.method6164(6406);
		...
		local3.glTexSubImage2D(this.anInt6869, 0, 0, 0, arg0, arg1, 6406, 5121, ByteBuffer.wrap(arg2, 0, arg2.length));
		if (arg0 != arg0) {
	...
	public final void method3637(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(8) int local8 = this.aClass19_Sub1_40.method821().method5794() - arg3;
		this.aClass19_Sub1_40.method848(this);
		this.aClass19_Sub1_40.anOpengl1.glCopyTexSubImage2D(this.anInt6869, 0, arg0, this.anInt3681 - arg1 - arg3, 0, local8, arg2, arg3);
		this.aClass19_Sub1_40.anOpengl1.glFlush();
	}

	@OriginalMember(owner = "client!al", name = "a", descriptor = "(IIII[IIIZ)V", line = 198)
	protected final void method3638(@OriginalArg(2) int arg0, @OriginalArg(3) int arg1, @OriginalArg(4) int[] arg2) {
		@Pc(3) opengl local3 = this.aClass19_Sub1_40.anOpengl1;
		...
		local3.glTexSubImage2D(this.anInt6869, 0, 0, 0, arg0, arg1, 32993, this.aClass19_Sub1_40.anInt592, IntBuffer.wrap(local14, 0, local14.length));
		if (arg0 != arg0) {
			local3.glPixelStorei(3314, 0);
		}
	}
	...
	public final void method3639(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1) {
		@Pc(3) opengl local3 = this.aClass19_Sub1_40.anOpengl1;
		if (this.anInt6869 == 3553) {
			this.aClass19_Sub1_40.method848(this);
			local3.glTexParameteri(this.anInt6869, 10242, arg0 ? 10497 : 33071);
			local3.glTexParameteri(this.anInt6869, 10243, arg1 ? 10497 : 33071);
		}
	}

	@OriginalMember(owner = "client!al", name = "a", descriptor = "(II)V", line = 264)
	public final void method3640(@OriginalArg(0) int arg0) {
		this.aClass19_Sub1_40.anOpengl1.glFramebufferTexture2DEXT(36160, arg0, this.anInt6869, this.anInt6868, 0);
		this.anInt3682 = arg0;
	}
}
