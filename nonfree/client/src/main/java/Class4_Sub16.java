...
public final class Class4_Sub16 extends Class4 {
	...
	@OriginalMember(owner = "client!sc", name = "a", descriptor = "([I)Lclient!re;")
	public Class4_Sub6_Sub1 method1719(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray41 == null) {
			this.anInt2467 = 0;
			this.aFloatArray7 = new float[Static104.anInt2465];
			this.aByteArray41 = new byte[this.anInt2464];
			this.anInt2473 = 0;
			this.anInt2472 = 0;
		}
		while (this.anInt2472 < this.aByteArrayArray11.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1729(this.anInt2472);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2473;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt2464 - local47) {
					local50 = this.anInt2464 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2473;
				}
				this.anInt2473 = local47;
			}
			this.anInt2472++;
		}
		...
		return new Class4_Sub6_Sub1(this.anInt2469, local129, this.anInt2470, this.anInt2462, this.aBoolean103);
	}

	@OriginalMember(owner = "client!sc", name = "b", descriptor = "([B)V")
	private void method1727(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class4_Sub9 local4 = new Class4_Sub9(arg0);
		this.anInt2469 = local4.method780();
		this.anInt2464 = local4.method780();
		this.anInt2470 = local4.method780();
		this.anInt2462 = local4.method780();
		if (this.anInt2462 < 0) {
			this.anInt2462 = ~this.anInt2462;
			this.aBoolean103 = true;
		}
		@Pc(40) int local40 = local4.method780();
		this.aByteArrayArray11 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method773();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method794(local49, local64);
			this.aByteArrayArray11[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!sc", name = "f", descriptor = "(I)[F")
	private float[] method1729(@OriginalArg(0) int arg0) {
		Static104.method1724(this.aByteArrayArray11[arg0]);
		Static104.method1720();
		@Pc(15) int local15 = Static104.method1728(Static56.method887(Static104.anIntArray318.length - 1));
		@Pc(19) boolean local19 = Static104.aBooleanArray14[local15];
		@Pc(25) int local25 = local19 ? Static104.anInt2465 : Static104.anInt2471;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static104.method1720() != 0;
			local29 = Static104.method1720() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static104.anInt2471 >> 2);
			local67 = (local25 >> 2) + (Static104.anInt2471 >> 2);
			local71 = Static104.anInt2471 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static104.anInt2471 >> 2);
			local104 = local25 + (Static104.anInt2471 >> 2) - (local25 >> 2);
			local108 = Static104.anInt2471 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class39 local123 = Static104.aClass39Array1[Static104.anIntArray318[local15]];
		@Pc(126) int local126 = local123.anInt1501;
		@Pc(131) int local131 = local123.anIntArray149[local126];
		@Pc(140) boolean local140 = !Static104.aClass83Array1[local131].method2007();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt1500; local144++) {
			@Pc(152) Class13 local152 = Static104.aClass13Array1[local123.anIntArray148[local144]];
			local154 = Static104.aFloatArray8;
			local152.method291(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt1501;
			local176 = local123.anIntArray149[local171];
			Static104.aClass83Array1[local176].method2006(Static104.aFloatArray8, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static104.aFloatArray8[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static104.aFloatArray8;
			...
			@Pc(252) float[] local252 = local19 ? Static104.aFloatArray3 : Static104.aFloatArray4;
			@Pc(258) float[] local258 = local19 ? Static104.aFloatArray1 : Static104.aFloatArray5;
			@Pc(264) float[] local264 = local19 ? Static104.aFloatArray2 : Static104.aFloatArray6;
			@Pc(270) int[] local270 = local19 ? Static104.anIntArray319 : Static104.anIntArray320;
			...
			@Pc(486) int local486 = Static56.method887(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static104.aFloatArray8[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static104.aFloatArray8[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt2467 > 0) {
			local176 = this.anInt2467 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean104) {
				for (local212 = 0; local212 < this.anInt2463; local212++) {
					local1254 = (this.anInt2467 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static104.aFloatArray8[local212];
				}
			}
		}
		local154 = this.aFloatArray7;
		this.aFloatArray7 = Static104.aFloatArray8;
		Static104.aFloatArray8 = local154;
		this.anInt2467 = local25;
		this.anInt2463 = local104 - (local25 >> 1);
		this.aBoolean104 = local140;
		return local1228;
	}
}
