...
public final class Class4_Sub16 extends Class4 {
	...
	private float[] method1444(@OriginalArg(0) int arg0) {
		Static86.method1450(this.aByteArrayArray8[arg0]);
		Static86.method1447();
		@Pc(15) int local15 = Static86.method1454(Static39.method766(Static86.anIntArray286.length - 1));
		@Pc(19) boolean local19 = Static86.aBooleanArray12[local15];
		@Pc(25) int local25 = local19 ? Static86.anInt2072 : Static86.anInt2071;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static86.method1447() != 0;
			local29 = Static86.method1447() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static86.anInt2071 >> 2);
			local67 = (local25 >> 2) + (Static86.anInt2071 >> 2);
			local71 = Static86.anInt2071 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static86.anInt2071 >> 2);
			local104 = local25 + (Static86.anInt2071 >> 2) - (local25 >> 2);
			local108 = Static86.anInt2071 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class6 local123 = Static86.aClass6Array1[Static86.anIntArray286[local15]];
		@Pc(126) int local126 = local123.anInt169;
		@Pc(131) int local131 = local123.anIntArray24[local126];
		@Pc(140) boolean local140 = !Static86.aClass9Array1[local131].method145();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt168; local144++) {
			@Pc(152) Class67 local152 = Static86.aClass67Array1[local123.anIntArray23[local144]];
			local154 = Static86.aFloatArray7;
			local152.method1670(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt169;
			local176 = local123.anIntArray24[local171];
			Static86.aClass9Array1[local176].method147(Static86.aFloatArray7, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static86.aFloatArray7[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static86.aFloatArray7;
			...
			@Pc(252) float[] local252 = local19 ? Static86.aFloatArray6 : Static86.aFloatArray9;
			@Pc(258) float[] local258 = local19 ? Static86.aFloatArray4 : Static86.aFloatArray3;
			@Pc(264) float[] local264 = local19 ? Static86.aFloatArray8 : Static86.aFloatArray5;
			@Pc(270) int[] local270 = local19 ? Static86.anIntArray287 : Static86.anIntArray285;
			...
			@Pc(486) int local486 = Static39.method766(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static86.aFloatArray7[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static86.aFloatArray7[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt2067 > 0) {
			local176 = this.anInt2067 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean125) {
				for (local212 = 0; local212 < this.anInt2070; local212++) {
					local1254 = (this.anInt2067 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static86.aFloatArray7[local212];
				}
			}
		}
		local154 = this.aFloatArray2;
		this.aFloatArray2 = Static86.aFloatArray7;
		Static86.aFloatArray7 = local154;
		this.anInt2067 = local25;
		this.anInt2070 = local104 - (local25 >> 1);
		this.aBoolean125 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!oe", name = "b", descriptor = "([B)V")
	private void method1449(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class4_Sub10 local4 = new Class4_Sub10(arg0);
		this.anInt2068 = local4.method549();
		this.anInt2064 = local4.method549();
		this.anInt2065 = local4.method549();
		this.anInt2069 = local4.method549();
		if (this.anInt2069 < 0) {
			this.anInt2069 = ~this.anInt2069;
			this.aBoolean126 = true;
		}
		@Pc(40) int local40 = local4.method549();
		this.aByteArrayArray8 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method599();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method560(local64, local49);
			this.aByteArrayArray8[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!oe", name = "a", descriptor = "([I)Lclient!pe;")
	public Class4_Sub6_Sub1 method1451(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray44 == null) {
			this.anInt2067 = 0;
			this.aFloatArray2 = new float[Static86.anInt2072];
			this.aByteArray44 = new byte[this.anInt2064];
			this.anInt2073 = 0;
			this.anInt2074 = 0;
		}
		while (this.anInt2074 < this.aByteArrayArray8.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method1444(this.anInt2074);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt2073;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt2064 - local47) {
					local50 = this.anInt2064 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray44[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt2073;
				}
				this.anInt2073 = local47;
			}
			this.anInt2074++;
		}
		this.aFloatArray2 = null;
		@Pc(129) byte[] local129 = this.aByteArray44;
		this.aByteArray44 = null;
		return new Class4_Sub6_Sub1(this.anInt2068, local129, this.anInt2065, this.anInt2069, this.aBoolean126);
	}
}
