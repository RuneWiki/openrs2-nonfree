...
public final class Static153 {
	...
	@OriginalMember(owner = "client!fba", name = "h", descriptor = "Lclient!rt;")
	...
	@OriginalMember(owner = "client!fba", name = "a", descriptor = "(BII)Ljava/lang/String;")
	public static String method2229(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
