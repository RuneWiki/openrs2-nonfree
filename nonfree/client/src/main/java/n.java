...
public final class n extends Class38 implements Interface6 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!ie;[Lclient!us;[Lclient!jd;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class158 arg2, @OriginalArg(3) Class356[] arg3, @OriginalArg(4) Class20[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray127;
			local11[local25] = arg3[local25].anInt10341;
			local15[local25] = arg3[local25].anInt10343;
			local19[local25] = arg3[local25].anInt10340;
			local23[local25] = arg3[local25].anInt10342;
		}
		this.S(arg0, arg1, local7, arg3[0].anIntArray755, local11, local15, local19, local23);
	}
