...
public final class n extends Class55 implements Interface4 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!pia;[Lclient!gu;[Lclient!it;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class272 arg2, @OriginalArg(3) Class131[] arg3, @OriginalArg(4) Class28[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray29;
			local11[local25] = arg3[local25].anInt3344;
			local15[local25] = arg3[local25].anInt3345;
			local19[local25] = arg3[local25].anInt3341;
			local23[local25] = arg3[local25].anInt3343;
		}
		this.S(arg0, arg1, local7, arg3[0].anIntArray186, local11, local15, local19, local23);
	}
