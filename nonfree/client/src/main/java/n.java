...
public final class n extends Class73 implements Interface7 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!ne;[Lclient!vi;[Lclient!pu;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class247 arg2, @OriginalArg(3) Class369[] arg3, @OriginalArg(4) Class50[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			...
			local11[local25] = arg3[local25].anInt10309;
			local15[local25] = arg3[local25].anInt10307;
			local19[local25] = arg3[local25].anInt10308;
			local23[local25] = arg3[local25].anInt10306;
		}
		this.S(arg0, arg1, local7, arg3[0].anIntArray561, local11, local15, local19, local23);
	}
