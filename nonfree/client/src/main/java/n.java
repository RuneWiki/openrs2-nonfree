...
public final class n extends Class67 implements Interface12 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!cd;[Lclient!cu;[Lclient!tb;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class53 arg2, @OriginalArg(3) Class64[] arg3, @OriginalArg(4) Class49[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray12;
			local11[local25] = arg3[local25].anInt1300;
			local15[local25] = arg3[local25].anInt1297;
			local19[local25] = arg3[local25].anInt1302;
			local23[local25] = arg3[local25].anInt1301;
		}
		this.S(arg0, arg1, local7, arg3[0].anIntArray82, local11, local15, local19, local23);
	}
