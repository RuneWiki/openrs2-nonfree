...
public final class n extends Class27 implements Interface3 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!ur;[Lclient!g;[Lclient!hu;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class345 arg2, @OriginalArg(3) Class111[] arg3, @OriginalArg(4) Class21[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray27;
			local11[local25] = arg3[local25].anInt4054;
			local15[local25] = arg3[local25].anInt4053;
			local19[local25] = arg3[local25].anInt4055;
			local23[local25] = arg3[local25].anInt4050;
		}
		this.S(arg0, arg1, local7, arg3[0].anIntArray216, local11, local15, local19, local23);
	}
