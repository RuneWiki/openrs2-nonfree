...
public final class n extends Class64 implements Interface8 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!fp;[Lclient!fw;[Lclient!kr;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class114 arg2, @OriginalArg(3) Class120[] arg3, @OriginalArg(4) Class20[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray36;
			local11[local25] = arg3[local25].anInt3710;
			local15[local25] = arg3[local25].anInt3707;
			local19[local25] = arg3[local25].anInt3708;
			local23[local25] = arg3[local25].anInt3705;
		}
