...
public final class n extends Class59 implements Interface4 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!rt;[Lclient!de;[Lclient!mq;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class324 arg2, @OriginalArg(3) Class67[] arg3, @OriginalArg(4) Class71[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			...
			local11[local25] = arg3[local25].anInt1761;
			local15[local25] = arg3[local25].anInt1759;
			local19[local25] = arg3[local25].anInt1760;
			local23[local25] = arg3[local25].anInt1763;
		}
		this.S(arg0, arg1, local7, arg3[0].anIntArray91, local11, local15, local19, local23);
	}
