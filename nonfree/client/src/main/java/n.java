...
public final class n extends Class50 implements Interface7 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!hia;[Lclient!fg;[Lclient!pga;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class133 arg2, @OriginalArg(3) Class98[] arg3, @OriginalArg(4) Class32[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray45;
			local11[local25] = arg3[local25].anInt2796;
			local15[local25] = arg3[local25].anInt2799;
			local19[local25] = arg3[local25].anInt2797;
			local23[local25] = arg3[local25].anInt2798;
		}
		this.S(arg0, arg1, local7, arg3[0].anIntArray184, local11, local15, local19, local23);
	}
