...
public final class n extends Class63 implements Interface8 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!ej;[Lclient!oia;[Lclient!fd;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class93 arg2, @OriginalArg(3) Class251[] arg3, @OriginalArg(4) Class103[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray65;
			local11[local25] = arg3[local25].anInt7185;
			local15[local25] = arg3[local25].anInt7184;
			local19[local25] = arg3[local25].anInt7183;
			local23[local25] = arg3[local25].anInt7180;
		}
		this.S(arg0, arg1, local7, arg3[0].anIntArray430, local11, local15, local19, local23);
	}
