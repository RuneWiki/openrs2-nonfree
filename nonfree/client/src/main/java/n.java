...
public final class n extends Class44 implements Interface4 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!saa;[Lclient!jr;[Lclient!bka;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class330 arg2, @OriginalArg(3) Class194[] arg3, @OriginalArg(4) Class9[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray46;
			local11[local25] = arg3[local25].anInt5596;
			local15[local25] = arg3[local25].anInt5595;
			local19[local25] = arg3[local25].anInt5594;
			local23[local25] = arg3[local25].anInt5597;
		}
		this.S(arg0, arg1, local7, arg3[0].anIntArray319, local11, local15, local19, local23);
	}
