...
public final class n extends Class19 implements Interface7 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!hw;[Lclient!fm;[Lclient!ho;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class151 arg2, @OriginalArg(3) Class112[] arg3, @OriginalArg(4) Class9[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray31;
			local11[local25] = arg3[local25].anInt2743;
			local15[local25] = arg3[local25].anInt2740;
			local19[local25] = arg3[local25].anInt2745;
			local23[local25] = arg3[local25].anInt2741;
		}
		this.S(arg0, arg1, local7, arg3[0].anIntArray152, local11, local15, local19, local23);
	}
