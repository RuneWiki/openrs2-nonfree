...
public final class n extends Class68 implements Interface5 {
	...
	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!tja;[Lclient!oe;[Lclient!fia;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class350 arg2, @OriginalArg(3) Class266[] arg3, @OriginalArg(4) Class45[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray79;
			local11[local25] = arg3[local25].anInt7303;
			local15[local25] = arg3[local25].anInt7305;
			local19[local25] = arg3[local25].anInt7304;
			local23[local25] = arg3[local25].anInt7308;
		}
		this.S(arg0, arg1, local7, arg3[0].anIntArray386, local11, local15, local19, local23);
	}
