...
public final class n extends Class70 implements Interface11 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!kaa;[Lclient!uh;[Lclient!hk;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class196 arg2, @OriginalArg(3) Class362[] arg3, @OriginalArg(4) Class155[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray98;
			local11[local25] = arg3[local25].anInt9727;
			local15[local25] = arg3[local25].anInt9728;
			local19[local25] = arg3[local25].anInt9723;
			local23[local25] = arg3[local25].anInt9725;
		}
		this.S(arg0, arg1, local7, arg3[0].anIntArray541, local11, local15, local19, local23);
	}
