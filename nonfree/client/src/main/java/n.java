...
public final class n implements Interface4 {
	...
	@OriginalMember(owner = "client!n", name = "c", descriptor = "Lclient!qa;")
	...
	@OriginalMember(owner = "client!n", name = "l", descriptor = "Lclient!da;")
	...
	public native void ea(@OriginalArg(0) Class110 arg0, @OriginalArg(1) Class31 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3);

	@OriginalMember(owner = "client!n", name = "TA", descriptor = "(Lclient!ya;[Lclient!t;Lclient!c;[III)V")
	public native void TA(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class110[] arg1, @OriginalArg(2) Class31 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5);

	@OriginalMember(owner = "client!n", name = "B", descriptor = "(Lclient!t;IILclient!c;Z)Z")
	public native boolean B(@OriginalArg(0) Class110 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class31 arg3, @OriginalArg(4) boolean arg4);

	@OriginalMember(owner = "client!n", name = "U", descriptor = "(Lclient!t;Lclient!t;IIIZ)V")
	public native void U(@OriginalArg(0) Class110 arg0, @OriginalArg(1) Class110 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!n", name = "G", descriptor = "(Lclient!ya;[I[I[I[SI)V")
	public native void G(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5);
	...
	public native void ba(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class110 arg1, @OriginalArg(2) Class31 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);

	@OriginalMember(owner = "client!n", name = "v", descriptor = "(Lclient!ta;IIIIIII[[Z)V")
	public native void v(@OriginalArg(0) Class65 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean[][] arg8);

	@OriginalMember(owner = "client!n", name = "a", descriptor = "(Lclient!da;BIZ)Lclient!t;")
	public Class110 method3715(@OriginalArg(0) da arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) da local8;
		@Pc(5) da local5;
		if (arg1 == 1) {
			local5 = this.aDa1;
		...
		local8.aClass29Array1 = arg0.aClass29Array1;
		local8.aClass179Array1 = arg0.aClass179Array1;
		return local8;
	}
	...
	public native void va(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
	...
	public native void Y(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Class110[] arg1, @OriginalArg(2) Class31 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);
	...
	public native void ta(@OriginalArg(0) Class110 arg0, @OriginalArg(1) Class31 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4);

	@OriginalMember(owner = "client!n", name = "O", descriptor = "(Lclient!ya;II)V")
	private native void O(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!n", name = "c", descriptor = "()V")
	private native void c();

	@OriginalMember(owner = "client!n", name = "A", descriptor = "(Lclient!ta;II)V")
	public native void A(@OriginalArg(0) Class65 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
}
