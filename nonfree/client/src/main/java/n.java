...
public final class n extends Class62 implements Interface7 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!oq;[Lclient!tba;[Lclient!cw;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class256 arg2, @OriginalArg(3) Class329[] arg3, @OriginalArg(4) Class61[] arg4) {
		super(arg0, arg2);
		...
		this.S(arg0, arg1, local7, arg3[0].anIntArray597, local11, local15, local19, local23);
	}
