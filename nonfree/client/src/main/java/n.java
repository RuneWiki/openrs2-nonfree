...
public final class n extends Class25 implements Interface7 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!tba;[Lclient!be;[Lclient!ac;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class315 arg2, @OriginalArg(3) Class28[] arg3, @OriginalArg(4) Class5[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			...
			local11[local25] = arg3[local25].anInt618;
			local15[local25] = arg3[local25].anInt616;
			local19[local25] = arg3[local25].anInt617;
			local23[local25] = arg3[local25].anInt614;
		}
		this.S(arg0, arg1, local7, arg3[0].anIntArray36, local11, local15, local19, local23);
	}
