...
public final class n extends Class72 implements Interface5 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!kf;[Lclient!re;[Lclient!qda;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class198 arg2, @OriginalArg(3) Class301[] arg3, @OriginalArg(4) Class59[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray82;
			local11[local25] = arg3[local25].anInt8501;
			local15[local25] = arg3[local25].anInt8497;
			local19[local25] = arg3[local25].anInt8500;
			local23[local25] = arg3[local25].anInt8499;
		}
		this.S(arg0, arg1, local7, arg3[0].anIntArray462, local11, local15, local19, local23);
	}
