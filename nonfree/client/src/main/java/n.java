...
public final class n extends Class62 implements Interface9 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!qt;[Lclient!ffa;[Lclient!td;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class282 arg2, @OriginalArg(3) Class107[] arg3, @OriginalArg(4) Class24[] arg4) {
		super(arg0, arg2);
		...
		this.S(arg0, arg1, local7, arg3[0].anIntArray143, local11, local15, local19, local23);
	}
