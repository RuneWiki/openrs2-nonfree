...
public final class n extends Class37 implements Interface3 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!jl;[Lclient!hb;[Lclient!iea;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class183 arg2, @OriginalArg(3) Class139[] arg3, @OriginalArg(4) Class31[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			...
			local11[local25] = arg3[local25].anInt3984;
			local15[local25] = arg3[local25].anInt3983;
			local19[local25] = arg3[local25].anInt3981;
			local23[local25] = arg3[local25].anInt3980;
		}
		this.S(arg0, arg1, local7, arg3[0].anIntArray261, local11, local15, local19, local23);
	}
