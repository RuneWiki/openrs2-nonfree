...
public final class n extends Class6 implements Interface10 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!rc;[Lclient!jn;[Lclient!hu;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class298 arg2, @OriginalArg(3) Class176[] arg3, @OriginalArg(4) Class44[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray40;
			local11[local25] = arg3[local25].anInt4437;
			local15[local25] = arg3[local25].anInt4438;
			local19[local25] = arg3[local25].anInt4434;
			local23[local25] = arg3[local25].anInt4439;
		}
		this.S(arg0, arg1, local7, arg3[0].anIntArray360, local11, local15, local19, local23);
	}
