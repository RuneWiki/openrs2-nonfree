...
public final class n extends Class69 implements Interface6 {
	...
	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!eia;[Lclient!eu;[Lclient!vr;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class88 arg2, @OriginalArg(3) Class97[] arg3, @OriginalArg(4) Class33[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			...
			local11[local25] = arg3[local25].anInt2963;
			local15[local25] = arg3[local25].anInt2960;
			local19[local25] = arg3[local25].anInt2964;
			local23[local25] = arg3[local25].anInt2962;
		}
		this.S(arg0, arg1, local7, arg3[0].anIntArray260, local11, local15, local19, local23);
	}
