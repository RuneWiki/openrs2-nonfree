...
public final class n extends Class57 implements Interface6 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!hw;[Lclient!tm;[Lclient!kw;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class169 arg2, @OriginalArg(3) Class361[] arg3, @OriginalArg(4) Class178[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			...
			local11[local25] = arg3[local25].anInt9706;
			local15[local25] = arg3[local25].anInt9707;
			local19[local25] = arg3[local25].anInt9703;
			local23[local25] = arg3[local25].anInt9704;
		}
		this.S(arg0, arg1, local7, arg3[0].anIntArray701, local11, local15, local19, local23);
	}
