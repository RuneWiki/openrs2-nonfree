...
public final class n extends Class80 implements Interface3 {

	@OriginalMember(owner = "client!n", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lclient!oa;Lclient!ya;Lclient!lq;[Lclient!iga;[Lclient!fs;)V")
	public n(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) Class224 arg2, @OriginalArg(3) Class173[] arg3, @OriginalArg(4) Class134[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			...
			local11[local25] = arg3[local25].anInt4282;
			local15[local25] = arg3[local25].anInt4287;
			local19[local25] = arg3[local25].anInt4283;
			local23[local25] = arg3[local25].anInt4286;
		}
		this.S(arg0, arg1, local7, arg3[0].anIntArray244, local11, local15, local19, local23);
	}
