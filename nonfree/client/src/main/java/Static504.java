...
public final class Static504 {
	...
	@OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIILclient!gb;Lclient!gb;)V")
	public static void method7359(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class60_Sub1_Sub3 arg3, @OriginalArg(4) Class60_Sub1_Sub3 arg4) {
		@Pc(4) Class243 local4 = Static565.method7969(arg0, arg1, arg2);
		if (local4 == null) {
			return;
		}
		local4.aClass60_Sub1_Sub3_1 = arg3;
		local4.aClass60_Sub1_Sub3_2 = arg4;
