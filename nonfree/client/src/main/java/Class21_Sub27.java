...
public final class Class21_Sub27 extends Class21 {
	...
	@OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(ILclient!eha;)V")
	public Class21_Sub27(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub22 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Lclient!eha;)V")
	public Class21_Sub27(@OriginalArg(0) Class3_Sub22 arg0) {
		super(arg0);
	}
	...
	@OriginalMember(owner = "client!tp", name = "d", descriptor = "(II)V")
	@Override
	protected void method9240(@OriginalArg(1) int arg0) {
		super.anInt10876 = arg0;
	}

	@OriginalMember(owner = "client!tp", name = "c", descriptor = "(B)Z")
