...
public final class Class134_Sub1_Sub1 extends Class134_Sub1 {
	...
	@OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(Lclient!cba;[B[III)V")
	public Class134_Sub1_Sub1(@OriginalArg(0) Class57_Sub1 arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
	...
	@Override
	protected void method8580(@OriginalArg(0) int[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(3) int[] local3 = super.aClass57_Sub1_10.anIntArray52;
		@Pc(206) int local206;
		@Pc(11) int local11;
		@Pc(16) int local16;
		@Pc(28) int local28;
		...
		if (Static627.anInt9953 == 0) {
			if (Static627.anInt9952 == 0) {
				local11 = Static627.anInt9959;
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						local28 = Static627.anInt9963;
						local30 = Static627.anInt9958;
						local32 = Static627.anInt9957;
						local34 = Static627.anInt9960;
						if (local30 >= 0 && local32 >= 0 && local30 - (super.anInt9966 << 12) < 0 && local32 - (super.anInt9955 << 12) < 0) {
							local64 = arg0[local16] - arg2;
							local69 = -arg1[local16];
							local75 = local64 + Static627.anInt9963 - local28;
							if (local75 > 0) {
								local28 += local75;
								local34 += local75;
								local30 += Static627.anInt9953 * local75;
								local32 += Static627.anInt9952 * local75;
							} else {
								local69 -= local75;
							}
							if (local34 < local69) {
							...
							while (local34 < 0) {
								local122 = this.aByteArray54[(local32 >> 12) * super.anInt9966 + (local30 >> 12)];
								if (local122 == 0) {
									local28++;
								} else {
									local3[local28++] = this.anIntArray389[local122 & 0xFF];
								}
								local34++;
							}
						}
					...
					local11++;
					Static627.anInt9963 += Static627.anInt9962;
				}
			} else if (Static627.anInt9952 < 0) {
				local11 = Static627.anInt9959;
				while (local11 < 0) {
					local16 = local11 + arg3;
					if (local16 >= 0) {
						...
						local28 = Static627.anInt9963;
						local30 = Static627.anInt9958;
						local32 = Static627.anInt9957 + Static627.anInt9961;
						local34 = Static627.anInt9960;
						if (local30 >= 0 && local30 - (super.anInt9966 << 12) < 0) {
							@Pc(199) int local199;
							if ((local199 = local32 - (super.anInt9955 << 12)) >= 0) {
								local206 = (Static627.anInt9952 - local199) / Static627.anInt9952;
								local34 += local206;
								local32 += Static627.anInt9952 * local206;
								local28 += local206;
							}
							@Pc(227) int local227;
							if ((local227 = (local32 - Static627.anInt9952) / Static627.anInt9952) > local34) {
								local34 = local227;
							}
							local64 = arg0[local16] - arg2;
							local69 = -arg1[local16];
							...
							while (local34 < 0) {
								...
								local32 += Static627.anInt9952;
								local34++;
							}
						}
					}
					local11++;
					Static627.anInt9958 += Static627.anInt9965;
					Static627.anInt9963 += Static627.anInt9962;
				}
			} else {
				local11 = Static627.anInt9959;
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						if (local30 >= 0 && local30 - (super.anInt9966 << 12) < 0) {
							if (local32 < 0) {
								local206 = (Static627.anInt9952 - local32 - 1) / Static627.anInt9952;
								local34 += local206;
								local32 += Static627.anInt9952 * local206;
								local28 += local206;
							}
							@Pc(410) int local410;
							if ((local410 = (local32 + 1 - (super.anInt9955 << 12) - Static627.anInt9952) / Static627.anInt9952) > local34) {
								local34 = local410;
							}
							local64 = arg0[local16] - arg2;
							local69 = -arg1[local16];
			...
			if (Static627.anInt9952 == 0) {
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						local28 = Static627.anInt9963;
						local30 = Static627.anInt9958 + Static627.anInt9975;
						local32 = Static627.anInt9957;
						local34 = Static627.anInt9960;
						if (local32 >= 0 && local32 - (super.anInt9955 << 12) < 0) {
							@Pc(567) int local567;
							if ((local567 = local30 - (super.anInt9966 << 12)) >= 0) {
								local206 = (Static627.anInt9953 - local567) / Static627.anInt9953;
								local34 += local206;
								local30 += Static627.anInt9953 * local206;
								local28 += local206;
							}
							@Pc(595) int local595;
							if ((local595 = (local30 - Static627.anInt9953) / Static627.anInt9953) > local34) {
								local34 = local595;
							}
							local64 = arg0[local16] - arg2;
							local69 = -arg1[local16];
							...
							while (local34 < 0) {
								...
								local30 += Static627.anInt9953;
								local34++;
							}
						}
					}
					local11++;
					Static627.anInt9957 += Static627.anInt9970;
					Static627.anInt9963 += Static627.anInt9962;
				}
			} else if (Static627.anInt9952 < 0) {
				local11 = Static627.anInt9959;
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						local34 = Static627.anInt9960;
						@Pc(739) int local739;
						if ((local739 = local30 - (super.anInt9966 << 12)) >= 0) {
							local206 = (Static627.anInt9953 - local739) / Static627.anInt9953;
							local34 += local206;
							local30 += Static627.anInt9953 * local206;
							local32 += Static627.anInt9952 * local206;
							local28 += local206;
						...
						@Pc(773) int local773;
						if ((local773 = (local30 - Static627.anInt9953) / Static627.anInt9953) > local34) {
							local34 = local773;
						}
						@Pc(785) int local785;
						if ((local785 = local32 - (super.anInt9955 << 12)) >= 0) {
							local206 = (Static627.anInt9952 - local785) / Static627.anInt9952;
							local34 += local206;
							local30 += Static627.anInt9953 * local206;
							local32 += Static627.anInt9952 * local206;
							local28 += local206;
						...
						@Pc(819) int local819;
						if ((local819 = (local32 - Static627.anInt9952) / Static627.anInt9952) > local34) {
							local34 = local819;
						}
						local64 = arg0[local16] - arg2;
						local69 = -arg1[local16];
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						local34 = Static627.anInt9960;
						@Pc(969) int local969;
						if ((local969 = local30 - (super.anInt9966 << 12)) >= 0) {
							local206 = (Static627.anInt9953 - local969) / Static627.anInt9953;
							local34 += local206;
							local30 += Static627.anInt9953 * local206;
							local32 += Static627.anInt9952 * local206;
							local28 += local206;
						...
						if ((local1003 = (local30 - Static627.anInt9953) / Static627.anInt9953) > local34) {
							local34 = local1003;
						}
						if (local32 < 0) {
							local206 = (Static627.anInt9952 - local32 - 1) / Static627.anInt9952;
						...
						if ((local1051 = (local32 + 1 - (super.anInt9955 << 12) - Static627.anInt9952) / Static627.anInt9952) > local34) {
							local34 = local1051;
						}
						local64 = arg0[local16] - arg2;
						local69 = -arg1[local16];
			...
			while (local11 < 0) {
				...
				if (local16 >= 0) {
					...
					if (local32 >= 0 && local32 - (super.anInt9955 << 12) < 0) {
						if (local30 < 0) {
							local206 = (Static627.anInt9953 - local30 - 1) / Static627.anInt9953;
							local34 += local206;
							local30 += Static627.anInt9953 * local206;
							local28 += local206;
						}
						@Pc(1244) int local1244;
						if ((local1244 = (local30 + 1 - (super.anInt9966 << 12) - Static627.anInt9953) / Static627.anInt9953) > local34) {
							local34 = local1244;
						}
						local64 = arg0[local16] - arg2;
						local69 = -arg1[local16];
			...
			while (local11 < 0) {
				...
				if (local16 >= 0) {
					...
					if ((local1428 = (local30 + 1 - (super.anInt9966 << 12) - Static627.anInt9953) / Static627.anInt9953) > local34) {
						local34 = local1428;
					}
					@Pc(1440) int local1440;
					if ((local1440 = local32 - (super.anInt9955 << 12)) >= 0) {
						local206 = (Static627.anInt9952 - local1440) / Static627.anInt9952;
						local34 += local206;
						local30 += Static627.anInt9953 * local206;
						local32 += Static627.anInt9952 * local206;
						local28 += local206;
					...
					if ((local1474 = (local32 - Static627.anInt9952) / Static627.anInt9952) > local34) {
						local34 = local1474;
					}
					local64 = arg0[local16] - arg2;
					local69 = -arg1[local16];
			...
			while (local11 < 0) {
				...
				if (local16 >= 0) {
					...
					if ((local1660 = (local30 + 1 - (super.anInt9966 << 12) - Static627.anInt9953) / Static627.anInt9953) > local34) {
						local34 = local1660;
					}
					if (local32 < 0) {
						local206 = (Static627.anInt9952 - local32 - 1) / Static627.anInt9952;
					...
					if ((local1708 = (local32 + 1 - (super.anInt9955 << 12) - Static627.anInt9952) / Static627.anInt9952) > local34) {
						local34 = local1708;
					}
					local64 = arg0[local16] - arg2;
					local69 = -arg1[local16];
	...
	public void method9220(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class1 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if (super.aClass57_Sub1_10.method1067()) {
			throw new IllegalStateException();
		}
		arg0 += super.anInt9951;
		arg1 += super.anInt9950;
		@Pc(20) int local20 = 0;
		@Pc(24) int local24 = super.aClass57_Sub1_10.anInt1042;
		@Pc(27) int local27 = super.anInt9966;
		@Pc(30) int local30 = super.anInt9955;
		@Pc(34) int local34 = local24 - local27;
		@Pc(36) int local36 = 0;
		@Pc(42) int local42 = arg0 + arg1 * local24;
		@Pc(53) int local53;
		if (arg1 < super.aClass57_Sub1_10.anInt1033) {
			local53 = super.aClass57_Sub1_10.anInt1033 - arg1;
			local30 -= local53;
			arg1 = super.aClass57_Sub1_10.anInt1033;
			local20 = local53 * local27;
			local42 += local53 * local24;
		}
		if (arg1 + local30 > super.aClass57_Sub1_10.anInt1044) {
			local30 -= arg1 + local30 - super.aClass57_Sub1_10.anInt1044;
		}
		if (arg0 < super.aClass57_Sub1_10.anInt1052) {
			local53 = super.aClass57_Sub1_10.anInt1052 - arg0;
			local27 -= local53;
			arg0 = super.aClass57_Sub1_10.anInt1052;
			local20 += local53;
			local42 += local53;
			local36 = local53;
			local34 += local53;
		}
		if (arg0 + local27 > super.aClass57_Sub1_10.anInt1037) {
			local53 = arg0 + local27 - super.aClass57_Sub1_10.anInt1037;
			local27 -= local53;
			local36 += local53;
			local34 += local53;
		}
		...
		@Pc(166) int[] local166 = local163.anIntArray97;
		@Pc(169) int[] local169 = local163.anIntArray95;
		@Pc(173) int[] local173 = super.aClass57_Sub1_10.anIntArray52;
		@Pc(175) int local175 = arg1;
		if (arg4 > arg1) {
			local175 = arg4;
			local42 += (arg4 - arg1) * local24;
			local20 += (arg4 - arg1) * super.anInt9966;
		}
		...
		for (@Pc(217) int local217 = local175; local217 < local215; local217++) {
			...
			for (@Pc(309) int local309 = -local232; local309 < 0; local309++) {
				@Pc(316) byte local316 = this.aByteArray54[local20++];
				if (local316 == 0) {
					local42++;
				} else {
					local173[local42++] = this.anIntArray389[local316 & 0xFF];
				}
			}
	...
	protected void method9218(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		if (super.aClass57_Sub1_10.method1067()) {
			...
			@Pc(20) int local20 = 0;
			@Pc(24) int local24 = super.aClass57_Sub1_10.anInt1042;
			@Pc(33) int local33 = super.anInt9951 + super.anInt9966 + super.anInt9954;
			@Pc(42) int local42 = super.anInt9950 + super.anInt9955 + super.anInt9967;
			@Pc(48) int local48 = (local33 << 16) / arg2;
			@Pc(54) int local54 = (local42 << 16) / arg3;
			@Pc(68) int local68;
			if (super.anInt9951 > 0) {
				local68 = ((super.anInt9951 << 16) + local48 - 1) / local48;
				arg0 += local68;
				local18 = local68 * local48 - (super.anInt9951 << 16);
			}
			if (super.anInt9950 > 0) {
				local68 = ((super.anInt9950 << 16) + local54 - 1) / local54;
				arg1 += local68;
				local20 = local68 * local54 - (super.anInt9950 << 16);
			}
			if (super.anInt9966 < local33) {
				arg2 = ((super.anInt9966 << 16) + local48 - local18 - 1) / local48;
			}
			if (super.anInt9955 < local42) {
				arg3 = ((super.anInt9955 << 16) + local54 - local20 - 1) / local54;
			}
			local68 = arg0 + arg1 * local24;
			@Pc(156) int local156 = local24 - arg2;
			if (arg1 + arg3 > super.aClass57_Sub1_10.anInt1044) {
				arg3 -= arg1 + arg3 - super.aClass57_Sub1_10.anInt1044;
			}
			@Pc(184) int local184;
			if (arg1 < super.aClass57_Sub1_10.anInt1033) {
				local184 = super.aClass57_Sub1_10.anInt1033 - arg1;
				arg3 -= local184;
				local68 += local184 * local24;
				local20 += local54 * local184;
			}
			if (arg0 + arg2 > super.aClass57_Sub1_10.anInt1037) {
				local184 = arg0 + arg2 - super.aClass57_Sub1_10.anInt1037;
				arg2 -= local184;
				local156 += local184;
			}
			if (arg0 < super.aClass57_Sub1_10.anInt1052) {
				local184 = super.aClass57_Sub1_10.anInt1052 - arg0;
				arg2 -= local184;
				local68 += local184;
				local18 += local48 * local184;
				local156 += local184;
			}
			@Pc(256) int[] local256 = super.aClass57_Sub1_10.anIntArray52;
			@Pc(265) int local265;
			@Pc(268) int local268;
			@Pc(276) int local276;
			@Pc(279) int local279;
			...
			if (arg6 != 0) {
				...
				if (arg6 == 1) {
					if (arg4 == 1) {
						...
						for (local268 = -arg3; local268 < 0; local268++) {
							local276 = (local20 >> 16) * super.anInt9966;
							for (local279 = -arg2; local279 < 0; local279++) {
								local454 = this.aByteArray54[(local18 >> 16) + local276];
								if (local454 == 0) {
									local68++;
								} else {
									local256[local68++] = this.anIntArray389[local454 & 0xFF];
								}
								local18 += local48;
							}
							local20 += local54;
						...
						if (arg4 == 0) {
							...
							if ((arg5 & 0xFFFFFF) == 16777215) {
								...
								for (local279 = -arg3; local279 < 0; local279++) {
									local342 = (local20 >> 16) * super.anInt9966;
									for (local350 = -arg2; local350 < 0; local350++) {
										local750 = this.aByteArray54[(local18 >> 16) + local342];
										if (local750 == 0) {
											local68++;
										} else {
											local368 = this.anIntArray389[local750 & 0xFF];
								...
								for (local353 = -arg3; local353 < 0; local353++) {
									local368 = (local20 >> 16) * super.anInt9966;
									for (local376 = -arg2; local376 < 0; local376++) {
										@Pc(868) byte local868 = this.aByteArray54[(local18 >> 16) + local368];
										if (local868 == 0) {
											local68++;
										} else {
											local392 = this.anIntArray389[local868 & 0xFF];
											if (local342 == 255) {
							...
							for (local279 = -arg3; local279 < 0; local279++) {
								...
								for (local350 = -arg2; local350 < 0; local350++) {
									local750 = this.aByteArray54[(local18 >> 16) + local342];
									local368 = local750 > 0 ? this.anIntArray389[local750] : 0;
							...
							for (local350 = -arg3; local350 < 0; local350++) {
								local353 = (local20 >> 16) * super.anInt9966;
								for (local368 = -arg2; local368 < 0; local368++) {
									local1217 = this.aByteArray54[(local18 >> 16) + local353];
									if (local1217 == 0) {
										local68++;
									} else {
										local384 = this.anIntArray389[local1217 & 0xFF];
					...
					for (local268 = -arg3; local268 < 0; local268++) {
						...
						for (local279 = -arg2; local279 < 0; local279++) {
							...
							if (local454 == 0) {
								...
								local350 = this.anIntArray389[local454 & 0xFF];
					...
					for (local342 = -arg3; local342 < 0; local342++) {
						local350 = (local20 >> 16) * super.anInt9966;
						for (local353 = -arg2; local353 < 0; local353++) {
							@Pc(1431) byte local1431 = this.aByteArray54[(local18 >> 16) + local350];
							if (local1431 == 0) {
								local68++;
							} else {
								local376 = this.anIntArray389[local1431 & 0xFF];
					...
					for (local268 = -arg3; local268 < 0; local268++) {
						...
						for (local279 = -arg2; local279 < 0; local279++) {
							local454 = this.aByteArray54[(local18 >> 16) + local276];
							local350 = local454 > 0 ? this.anIntArray389[local454] : 0;
				...
				for (local268 = -arg3; local268 < 0; local268++) {
					local276 = (local20 >> 16) * super.anInt9966;
					for (local279 = -arg2; local279 < 0; local279++) {
						local256[local68++] = this.anIntArray389[this.aByteArray54[(local18 >> 16) + local276] & 0xFF];
						local18 += local48;
					}
					local20 += local54;
					local18 = local265;
				...
				for (local342 = -arg3; local342 < 0; local342++) {
					local350 = (local20 >> 16) * super.anInt9966;
					for (local353 = -arg2; local353 < 0; local353++) {
						local368 = this.anIntArray389[this.aByteArray54[(local18 >> 16) + local350] & 0xFF];
				...
				for (local350 = -arg3; local350 < 0; local350++) {
					local353 = (local20 >> 16) * super.anInt9966;
					for (local368 = -arg2; local368 < 0; local368++) {
						local376 = this.anIntArray389[this.aByteArray54[(local18 >> 16) + local353] & 0xFF];
	...
	@Override
	protected void method8581(@OriginalArg(0) int arg0) {
		@Pc(3) int[] local3 = super.aClass57_Sub1_10.anIntArray52;
		@Pc(963) int local963;
		@Pc(11) int local11;
		@Pc(14) int local14;
		...
		if (Static627.anInt9953 == 0) {
			if (Static627.anInt9952 == 0) {
				local11 = Static627.anInt9959;
				while (local11 < 0) {
					local14 = Static627.anInt9963;
					local16 = Static627.anInt9958;
					local18 = Static627.anInt9957;
					local20 = Static627.anInt9960;
					if (local16 >= 0 && local18 >= 0 && local16 - (super.anInt9966 << 12) < 0 && local18 - (super.anInt9955 << 12) < 0) {
						while (local20 < 0) {
							local57 = (local18 >> 12) * super.anInt9966 + (local16 >> 12);
							local60 = local14++;
							if (arg0 == 1) {
								local241 = this.aByteArray54[local57];
								if (local241 != 0) {
									local3[local60] = this.anIntArray389[local241 & 0xFF];
								}
							} else if (arg0 == 0) {
								local241 = this.aByteArray54[local57];
								if (local241 != 0) {
									local270 = this.anIntArray389[local241 & 0xFF];
									if ((Static627.anInt9974 & 0xFFFFFF) == 16777215) {
										local279 = Static627.anInt9974 >>> 24;
									...
									} else if (Static627.anInt9976 == 255) {
										local279 = (local270 & 0xFF0000) * Static627.anInt9977 & 0xFF000000;
										local283 = (local270 & 0xFF00) * Static627.anInt9949 & 0xFF0000;
										local287 = (local270 & 0xFF) * Static627.anInt9956 & 0xFF00;
										...
										local3[local60] = ((local270 & 0xFF00FF) * Static627.anInt9976 + (local359 & 0xFF00FF) * Static627.anInt9947 & 0xFF00FF00) + ((local270 & 0xFF00) * Static627.anInt9976 + (local359 & 0xFF00) * Static627.anInt9947 & 0xFF0000) >> 8;
									}
								}
							} else if (arg0 == 3) {
								local241 = this.aByteArray54[local57];
								local270 = local241 > 0 ? this.anIntArray389[local241] : 0;
								local279 = Static627.anInt9974;
								...
								if (local270 == 0 && Static627.anInt9976 != 255) {
									local270 = local359;
									local359 = local3[local60];
									local359 = ((local270 & 0xFF00FF) * Static627.anInt9976 + (local359 & 0xFF00FF) * Static627.anInt9947 & 0xFF00FF00) + ((local270 & 0xFF00) * Static627.anInt9976 + (local359 & 0xFF00) * Static627.anInt9947 & 0xFF0000) >> 8;
								}
								...
								if (local241 != 0) {
									local270 = this.anIntArray389[local241 & 0xFF];
									local279 = (local270 & 0xFF00FF) * Static627.anInt9976 & 0xFF00FF00;
									local283 = (local270 & 0xFF00) * Static627.anInt9976 & 0xFF0000;
									local3[local60++] = ((local279 | local283) >>> 8) + Static627.anInt9948;
								}
							} else {
								throw new IllegalArgumentException();
							}
				...
				while (local11 < 0) {
					local14 = Static627.anInt9963;
					local16 = Static627.anInt9958;
					local18 = Static627.anInt9957 + Static627.anInt9961;
					local20 = Static627.anInt9960;
					if (local16 >= 0 && local16 - (super.anInt9966 << 12) < 0) {
						@Pc(956) int local956;
						if ((local956 = local18 - (super.anInt9955 << 12)) >= 0) {
							local963 = (Static627.anInt9952 - local956) / Static627.anInt9952;
							local20 += local963;
							local18 += Static627.anInt9952 * local963;
							local14 += local963;
						}
						@Pc(984) int local984;
						if ((local984 = (local18 - Static627.anInt9952) / Static627.anInt9952) > local20) {
							local20 = local984;
						}
						while (local20 < 0) {
							local57 = (local18 >> 12) * super.anInt9966 + (local16 >> 12);
				...
				while (local11 < 0) {
					...
					if (local16 >= 0 && local16 - (super.anInt9966 << 12) < 0) {
						if (local18 < 0) {
							local963 = (Static627.anInt9952 - local18 - 1) / Static627.anInt9952;
							local20 += local963;
							local18 += Static627.anInt9952 * local963;
							local14 += local963;
						}
						@Pc(1937) int local1937;
						if ((local1937 = (local18 + 1 - (super.anInt9955 << 12) - Static627.anInt9952) / Static627.anInt9952) > local20) {
							local20 = local1937;
						}
						while (local20 < 0) {
							local57 = (local18 >> 12) * super.anInt9966 + (local16 >> 12);
			...
			if (Static627.anInt9952 == 0) {
				...
				while (local11 < 0) {
					local14 = Static627.anInt9963;
					local16 = Static627.anInt9958 + Static627.anInt9975;
					local18 = Static627.anInt9957;
					local20 = Static627.anInt9960;
					if (local18 >= 0 && local18 - (super.anInt9955 << 12) < 0) {
						@Pc(2864) int local2864;
						if ((local2864 = local16 - (super.anInt9966 << 12)) >= 0) {
							local963 = (Static627.anInt9953 - local2864) / Static627.anInt9953;
							local20 += local963;
							local16 += Static627.anInt9953 * local963;
							local14 += local963;
						}
						@Pc(2892) int local2892;
						if ((local2892 = (local16 - Static627.anInt9953) / Static627.anInt9953) > local20) {
							local20 = local2892;
						}
						while (local20 < 0) {
							local57 = (local18 >> 12) * super.anInt9966 + (local16 >> 12);
				...
				while (local11 < 0) {
					...
					if ((local3806 = local16 - (super.anInt9966 << 12)) >= 0) {
						local963 = (Static627.anInt9953 - local3806) / Static627.anInt9953;
						local20 += local963;
						local16 += Static627.anInt9953 * local963;
						local18 += Static627.anInt9952 * local963;
						local14 += local963;
					...
					if ((local3840 = (local16 - Static627.anInt9953) / Static627.anInt9953) > local20) {
						local20 = local3840;
					}
					@Pc(3852) int local3852;
					if ((local3852 = local18 - (super.anInt9955 << 12)) >= 0) {
						local963 = (Static627.anInt9952 - local3852) / Static627.anInt9952;
						local20 += local963;
						local16 += Static627.anInt9953 * local963;
						local18 += Static627.anInt9952 * local963;
						local14 += local963;
					...
					if ((local3886 = (local18 - Static627.anInt9952) / Static627.anInt9952) > local20) {
						local20 = local3886;
					}
					while (local20 < 0) {
						local57 = (local18 >> 12) * super.anInt9966 + (local16 >> 12);
				...
				while (local11 < 0) {
					...
					if ((local4806 = local16 - (super.anInt9966 << 12)) >= 0) {
						local963 = (Static627.anInt9953 - local4806) / Static627.anInt9953;
						local20 += local963;
						local16 += Static627.anInt9953 * local963;
						local18 += Static627.anInt9952 * local963;
						local14 += local963;
					...
					if ((local4840 = (local16 - Static627.anInt9953) / Static627.anInt9953) > local20) {
						local20 = local4840;
					}
					if (local18 < 0) {
						local963 = (Static627.anInt9952 - local18 - 1) / Static627.anInt9952;
					...
					if ((local4888 = (local18 + 1 - (super.anInt9955 << 12) - Static627.anInt9952) / Static627.anInt9952) > local20) {
						local20 = local4888;
					}
					while (local20 < 0) {
						local57 = (local18 >> 12) * super.anInt9966 + (local16 >> 12);
			...
			while (local11 < 0) {
				...
				if (local18 >= 0 && local18 - (super.anInt9955 << 12) < 0) {
					if (local16 < 0) {
						local963 = (Static627.anInt9953 - local16 - 1) / Static627.anInt9953;
						local20 += local963;
						local16 += Static627.anInt9953 * local963;
						local14 += local963;
					}
					@Pc(5851) int local5851;
					if ((local5851 = (local16 + 1 - (super.anInt9966 << 12) - Static627.anInt9953) / Static627.anInt9953) > local20) {
						local20 = local5851;
					}
					while (local20 < 0) {
						local57 = (local18 >> 12) * super.anInt9966 + (local16 >> 12);
			...
			for (local11 = Static627.anInt9959; local11 < 0; local11++) {
				local14 = Static627.anInt9963;
				local16 = Static627.anInt9958 + Static627.anInt9975;
				local18 = Static627.anInt9957 + Static627.anInt9961;
				local20 = Static627.anInt9960;
				...
				if ((local6805 = (local16 + 1 - (super.anInt9966 << 12) - Static627.anInt9953) / Static627.anInt9953) > local20) {
					local20 = local6805;
				}
				@Pc(6817) int local6817;
				if ((local6817 = local18 - (super.anInt9955 << 12)) >= 0) {
					local963 = (Static627.anInt9952 - local6817) / Static627.anInt9952;
					local20 += local963;
					local16 += Static627.anInt9953 * local963;
					local18 += Static627.anInt9952 * local963;
					local14 += local963;
				...
				if ((local6851 = (local18 - Static627.anInt9952) / Static627.anInt9952) > local20) {
					local20 = local6851;
				}
				while (local20 < 0) {
					local57 = (local18 >> 12) * super.anInt9966 + (local16 >> 12);
			...
			for (local11 = Static627.anInt9959; local11 < 0; local11++) {
				...
				if ((local7807 = (local16 + 1 - (super.anInt9966 << 12) - Static627.anInt9953) / Static627.anInt9953) > local20) {
					local20 = local7807;
				}
				if (local18 < 0) {
					local963 = (Static627.anInt9952 - local18 - 1) / Static627.anInt9952;
				...
				if ((local7855 = (local18 + 1 - (super.anInt9955 << 12) - Static627.anInt9952) / Static627.anInt9952) > local20) {
					local20 = local7855;
				}
				while (local20 < 0) {
					local57 = (local18 >> 12) * super.anInt9966 + (local16 >> 12);
	...
	@Override
	public void method8579(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg3 <= 0 || arg4 <= 0) {
			return;
		}
		@Pc(9) int local9 = 0;
		@Pc(11) int local11 = 0;
		@Pc(20) int local20 = super.anInt9951 + super.anInt9966 + super.anInt9954;
		@Pc(29) int local29 = super.anInt9950 + super.anInt9955 + super.anInt9967;
		@Pc(35) int local35 = (local20 << 16) / arg3;
		@Pc(41) int local41 = (local29 << 16) / arg4;
		@Pc(55) int local55;
		if (super.anInt9951 > 0) {
			local55 = ((super.anInt9951 << 16) + local35 - 1) / local35;
			arg0 += local55;
			local9 = local55 * local35 - (super.anInt9951 << 16);
		}
		if (super.anInt9950 > 0) {
			local55 = ((super.anInt9950 << 16) + local41 - 1) / local41;
			arg1 += local55;
			local11 = local55 * local41 - (super.anInt9950 << 16);
		}
		if (super.anInt9966 < local20) {
			arg3 = ((super.anInt9966 << 16) + local35 - local9 - 1) / local35;
		}
		if (super.anInt9955 < local29) {
			arg4 = ((super.anInt9955 << 16) + local41 - local11 - 1) / local41;
		}
		local55 = arg0 + arg1 * super.aClass57_Sub1_10.anInt1042;
		@Pc(147) int local147 = super.aClass57_Sub1_10.anInt1042 - arg3;
		if (arg1 + arg4 > super.aClass57_Sub1_10.anInt1044) {
			arg4 -= arg1 + arg4 - super.aClass57_Sub1_10.anInt1044;
		}
		@Pc(175) int local175;
		if (arg1 < super.aClass57_Sub1_10.anInt1033) {
			local175 = super.aClass57_Sub1_10.anInt1033 - arg1;
			arg4 -= local175;
			local55 += local175 * super.aClass57_Sub1_10.anInt1042;
			local11 += local41 * local175;
		}
		if (arg0 + arg3 > super.aClass57_Sub1_10.anInt1037) {
			local175 = arg0 + arg3 - super.aClass57_Sub1_10.anInt1037;
			arg3 -= local175;
			local147 += local175;
		}
		if (arg0 < super.aClass57_Sub1_10.anInt1052) {
			local175 = super.aClass57_Sub1_10.anInt1052 - arg0;
			arg3 -= local175;
			local55 += local175;
			local9 += local35 * local175;
			local147 += local175;
		}
		@Pc(249) float[] local249 = super.aClass57_Sub1_10.aFloatArray10;
		@Pc(253) int[] local253 = super.aClass57_Sub1_10.anIntArray52;
		@Pc(262) int local262;
		@Pc(265) int local265;
		@Pc(273) int local273;
		@Pc(276) int local276;
		...
		if (arg7 != 0) {
			...
			if (arg7 == 1) {
				if (arg5 == 1) {
					...
					for (local265 = -arg4; local265 < 0; local265++) {
						local273 = (local11 >> 16) * super.anInt9966;
						for (local276 = -arg3; local276 < 0; local276++) {
							if ((float) arg2 < local249[local55]) {
								local484 = this.aByteArray54[(local9 >> 16) + local273];
								if (local484 != 0) {
									local253[local55] = this.anIntArray389[local484 & 0xFF];
					...
					if (arg5 == 0) {
						...
						if ((arg6 & 0xFFFFFF) == 16777215) {
							...
							for (local276 = -arg4; local276 < 0; local276++) {
								local353 = (local11 >> 16) * super.anInt9966;
								for (local361 = -arg3; local361 < 0; local361++) {
									if ((float) arg2 < local249[local55]) {
										local815 = this.aByteArray54[(local9 >> 16) + local353];
										if (local815 != 0) {
											local386 = this.anIntArray389[local815 & 0xFF];
							...
							for (local364 = -arg4; local364 < 0; local364++) {
								local386 = (local11 >> 16) * super.anInt9966;
								for (local394 = -arg3; local394 < 0; local394++) {
									if ((float) arg2 < local249[local55]) {
										@Pc(943) byte local943 = this.aByteArray54[(local9 >> 16) + local386];
										if (local943 != 0) {
											local410 = this.anIntArray389[local943 & 0xFF];
											if (local353 == 255) {
						...
						for (local276 = -arg4; local276 < 0; local276++) {
							...
							for (local361 = -arg3; local361 < 0; local361++) {
								if ((float) arg2 < local249[local55]) {
									local815 = this.aByteArray54[(local9 >> 16) + local353];
									local386 = local815 > 0 ? this.anIntArray389[local815] : 0;
						...
						for (local361 = -arg4; local361 < 0; local361++) {
							local364 = (local11 >> 16) * super.anInt9966;
							for (local386 = -arg3; local386 < 0; local386++) {
								if ((float) arg2 < local249[local55]) {
									local1318 = this.aByteArray54[(local9 >> 16) + local364];
									if (local1318 != 0) {
										local402 = this.anIntArray389[local1318 & 0xFF];
				...
				for (local265 = -arg4; local265 < 0; local265++) {
					...
					for (local276 = -arg3; local276 < 0; local276++) {
						if ((float) arg2 < local249[local55]) {
							local484 = this.aByteArray54[(local9 >> 16) + local273];
							if (local484 != 0) {
								local361 = this.anIntArray389[local484 & 0xFF];
				...
				for (local353 = -arg4; local353 < 0; local353++) {
					local361 = (local11 >> 16) * super.anInt9966;
					for (local364 = -arg3; local364 < 0; local364++) {
						if ((float) arg2 < local249[local55]) {
							@Pc(1552) byte local1552 = this.aByteArray54[(local9 >> 16) + local361];
							if (local1552 != 0) {
								local394 = this.anIntArray389[local1552 & 0xFF];
				...
				for (local265 = -arg4; local265 < 0; local265++) {
					...
					for (local276 = -arg3; local276 < 0; local276++) {
						if ((float) arg2 < local249[local55]) {
							local484 = this.aByteArray54[(local9 >> 16) + local273];
							local361 = local484 > 0 ? this.anIntArray389[local484] : 0;
			...
			for (local265 = -arg4; local265 < 0; local265++) {
				...
				for (local276 = -arg3; local276 < 0; local276++) {
					if ((float) arg2 < local249[local55]) {
						local253[local55] = this.anIntArray389[this.aByteArray54[(local9 >> 16) + local273] & 0xFF];
						local249[local55] = (float) arg2;
					}
					local9 += local35;
					local55++;
			...
			for (local353 = -arg4; local353 < 0; local353++) {
				...
				for (local364 = -arg3; local364 < 0; local364++) {
					if ((float) arg2 < local249[local55]) {
						local386 = this.anIntArray389[this.aByteArray54[(local9 >> 16) + local361] & 0xFF];
			...
			for (local361 = -arg4; local361 < 0; local361++) {
				...
				for (local386 = -arg3; local386 < 0; local386++) {
					if ((float) arg2 < local249[local55]) {
						local394 = this.anIntArray389[this.aByteArray54[(local9 >> 16) + local364] & 0xFF];
	...
	public void method9230(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		@Pc(12) int local12 = super.aClass57_Sub1_10.anInt1042;
		arg0 += super.anInt9951;
		arg1 += super.anInt9950;
		@Pc(28) int local28 = arg1 * local12 + arg0;
		@Pc(30) int local30 = 0;
		@Pc(33) int local33 = super.anInt9955;
		@Pc(36) int local36 = super.anInt9966;
		...
		if (arg1 + local33 > super.aClass57_Sub1_10.anInt1044) {
			local33 -= arg1 + local33 - super.aClass57_Sub1_10.anInt1044;
		}
		if (arg0 < super.aClass57_Sub1_10.anInt1052) {
			local53 = super.aClass57_Sub1_10.anInt1052 - arg0;
			local36 -= local53;
		...
		if (arg0 + local36 > super.aClass57_Sub1_10.anInt1037) {
			local53 = arg0 + local36 - super.aClass57_Sub1_10.anInt1037;
			local36 -= local53;
			local42 += local53;
			local40 += local53;
		}
		...
		@Pc(164) int[] local164 = super.aClass57_Sub1_10.anIntArray52;
		@Pc(174) int local174;
		@Pc(181) int local181;
		@Pc(292) int local292;
		@Pc(295) int local295;
		...
		if (arg4 != 0) {
			...
			if (arg4 == 1) {
				if (arg2 == 1) {
					for (local174 = -local33; local174 < 0; local174++) {
						for (local181 = -local36; local181 < 0; local181++) {
							local556 = this.aByteArray54[local30++];
							if (local556 == 0) {
								local28++;
							} else {
								local295 = this.anIntArray389[local556 & 0xFF] | 0xFF000000;
					...
					if (arg2 == 0) {
						if ((arg3 & 0xFFFFFF) == 16777215) {
							...
							for (local292 = -local33; local292 < 0; local292++) {
								for (local295 = -local36; local295 < 0; local295++) {
									local661 = this.aByteArray54[local30++];
									if (local661 == 0) {
										local28++;
									} else {
										local311 = this.anIntArray389[local661 & 0xFF];
										local319 = local164[local28];
							...
							for (local311 = -local33; local311 < 0; local311++) {
								for (local319 = -local36; local319 < 0; local319++) {
									@Pc(763) byte local763 = this.aByteArray54[local30++];
									if (local763 == 0) {
										local28++;
									} else {
										local335 = this.anIntArray389[local763 & 0xFF];
										if (local295 == 255) {
						...
						for (local292 = -local33; local292 < 0; local292++) {
							for (local295 = -local36; local295 < 0; local295++) {
								local661 = this.aByteArray54[local30++];
								local311 = local661 > 0 ? this.anIntArray389[local661] : 0;
						...
						for (local299 = -local33; local299 < 0; local299++) {
							for (local311 = -local36; local311 < 0; local311++) {
								local1076 = this.aByteArray54[local30++];
								if (local1076 == 0) {
									local28++;
								} else {
									local327 = this.anIntArray389[local1076 & 0xFF];
				...
				for (local174 = -local33; local174 < 0; local174++) {
					for (local181 = -local36; local181 < 0; local181++) {
						...
						if (local556 == 0) {
							...
							local295 = this.anIntArray389[local556 & 0xFF];
				...
				for (local295 = -local33; local295 < 0; local295++) {
					for (local299 = -local36; local299 < 0; local299++) {
						@Pc(1254) byte local1254 = this.aByteArray54[local30++];
						if (local1254 == 0) {
							local28++;
						} else {
							local319 = this.anIntArray389[local1254 & 0xFF];
				...
				for (local174 = -local33; local174 < 0; local174++) {
					for (local181 = -local36; local181 < 0; local181++) {
						local556 = this.aByteArray54[local30++];
						local295 = local556 > 0 ? this.anIntArray389[local556] : 0;
			...
			for (local174 = -local33; local174 < 0; local174++) {
				...
				while (local28 < local181) {
					local164[local28++] = this.anIntArray389[this.aByteArray54[local30++] & 0xFF];
					local164[local28++] = this.anIntArray389[this.aByteArray54[local30++] & 0xFF];
					local164[local28++] = this.anIntArray389[this.aByteArray54[local30++] & 0xFF];
					local164[local28++] = this.anIntArray389[this.aByteArray54[local30++] & 0xFF];
				}
			...
			for (local295 = -local33; local295 < 0; local295++) {
				for (local299 = -local36; local299 < 0; local299++) {
					local311 = this.anIntArray389[this.aByteArray54[local30++] & 0xFF];
			...
			for (local174 = -local33; local174 < 0; local174++) {
				for (local181 = -local36; local181 < 0; local181++) {
					local292 = this.anIntArray389[this.aByteArray54[local30++] & 0xFF];
			...
			for (local299 = -local33; local299 < 0; local299++) {
				for (local311 = -local36; local311 < 0; local311++) {
					local319 = this.anIntArray389[this.aByteArray54[local30++] & 0xFF];
