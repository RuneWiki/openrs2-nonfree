...
public final class Class6_Sub20 extends Class6 {
	...
	public Class6_Sub20(@OriginalArg(0) byte[] arg0) {
		this.method3248(arg0);
	}

	@OriginalMember(owner = "client!fw", name = "a", descriptor = "([I)Lclient!ib;")
	public Class6_Sub27_Sub1 method3238(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray27 == null) {
			this.anInt3824 = 0;
			this.aFloatArray34 = new float[Static172.anInt3830];
			this.aByteArray27 = new byte[this.anInt3832];
			this.anInt3834 = 0;
			this.anInt3833 = 0;
		}
		while (this.anInt3833 < this.aByteArrayArray6.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method3241(this.anInt3833);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt3834;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt3832 - local47) {
					local50 = this.anInt3832 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray27[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt3834;
				}
				this.anInt3834 = local47;
			}
			this.anInt3833++;
		}
		...
		return new Class6_Sub27_Sub1(this.anInt3823, local129, this.anInt3828, this.anInt3829, this.aBoolean304);
	}

	@OriginalMember(owner = "client!fw", name = "a", descriptor = "(I)[F")
	private float[] method3241(@OriginalArg(0) int arg0) {
		Static172.method3247(this.aByteArrayArray6[arg0]);
		Static172.method3240();
		@Pc(15) int local15 = Static172.method3244(Static126.method2629(Static172.anIntArray173.length - 1));
		@Pc(19) boolean local19 = Static172.aBooleanArray8[local15];
		@Pc(25) int local25 = local19 ? Static172.anInt3830 : Static172.anInt3825;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static172.method3240() != 0;
			local29 = Static172.method3240() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static172.anInt3825 >> 2);
			local67 = (local25 >> 2) + (Static172.anInt3825 >> 2);
			local71 = Static172.anInt3825 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static172.anInt3825 >> 2);
			local104 = local25 + (Static172.anInt3825 >> 2) - (local25 >> 2);
			local108 = Static172.anInt3825 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class375 local123 = Static172.aClass375Array1[Static172.anIntArray173[local15]];
		@Pc(126) int local126 = local123.anInt10577;
		@Pc(131) int local131 = local123.anIntArray566[local126];
		@Pc(140) boolean local140 = !Static172.aClass70Array1[local131].method2486();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt10576; local144++) {
			@Pc(152) Class318 local152 = Static172.aClass318Array1[local123.anIntArray567[local144]];
			local154 = Static172.aFloatArray35;
			local152.method7641(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt10577;
			local176 = local123.anIntArray566[local171];
			Static172.aClass70Array1[local176].method2489(Static172.aFloatArray35, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static172.aFloatArray35[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static172.aFloatArray35;
			...
			@Pc(252) float[] local252 = local19 ? Static172.aFloatArray36 : Static172.aFloatArray37;
			@Pc(258) float[] local258 = local19 ? Static172.aFloatArray39 : Static172.aFloatArray40;
			@Pc(264) float[] local264 = local19 ? Static172.aFloatArray38 : Static172.aFloatArray41;
			@Pc(270) int[] local270 = local19 ? Static172.anIntArray171 : Static172.anIntArray172;
			...
			@Pc(486) int local486 = Static126.method2629(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static172.aFloatArray35[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static172.aFloatArray35[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt3824 > 0) {
			local176 = this.anInt3824 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean305) {
				for (local212 = 0; local212 < this.anInt3831; local212++) {
					local1254 = (this.anInt3824 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static172.aFloatArray35[local212];
				}
			}
		}
		local154 = this.aFloatArray34;
		this.aFloatArray34 = Static172.aFloatArray35;
		Static172.aFloatArray35 = local154;
		this.anInt3824 = local25;
		this.anInt3831 = local104 - (local25 >> 1);
		this.aBoolean305 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!fw", name = "a", descriptor = "([B)V")
	private void method3248(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class6_Sub8 local4 = new Class6_Sub8(arg0);
		this.anInt3823 = local4.method8236();
		this.anInt3832 = local4.method8236();
		this.anInt3828 = local4.method8236();
		this.anInt3829 = local4.method8236();
		if (this.anInt3829 < 0) {
			this.anInt3829 = ~this.anInt3829;
			this.aBoolean304 = true;
		}
		@Pc(40) int local40 = local4.method8236();
		this.aByteArrayArray6 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method8246();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method8207(local64, local49, 0);
			this.aByteArrayArray6[local46] = local64;
		}
	}
}
