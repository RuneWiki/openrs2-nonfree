...
public final class Class249 {
	...
	public Class249(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg1 != arg0) {
			@Pc(12) int local12 = Static272.method5100(arg1, arg0);
			@Pc(16) int local16 = arg1 / local12;
			@Pc(20) int local20 = arg0 / local12;
			this.anInt7196 = local20;
			this.anInt7197 = local16;
	...
	public int method6446(@OriginalArg(0) int arg0) {
		if (this.anIntArrayArray61 != null) {
			arg0 = (int) ((long) arg0 * (long) this.anInt7197 / (long) this.anInt7196);
		}
		return arg0;
	}

	@OriginalMember(owner = "client!wp", name = "a", descriptor = "(B[B)[B", line = 18)
	public byte[] method6447(@OriginalArg(1) byte[] arg0) {
		if (this.anIntArrayArray61 != null) {
			@Pc(28) int local28 = (int) ((long) arg0.length * (long) this.anInt7197 / (long) this.anInt7196) + 14;
			...
			for (@Pc(37) int local37 = 0; local37 < arg0.length; local37++) {
				...
				local35 += this.anInt7197;
				@Pc(81) int local81 = local35 / this.anInt7196;
				local33 += local81;
				local35 -= local81 * this.anInt7196;
			}
	...
	public int method6448(@OriginalArg(1) int arg0) {
		if (this.anIntArrayArray61 != null) {
			arg0 = (int) ((long) arg0 * (long) this.anInt7197 / (long) this.anInt7196) + 6;
		}
		return arg0;
	}
}
