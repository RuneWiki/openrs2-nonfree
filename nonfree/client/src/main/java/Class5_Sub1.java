...
public final class Class5_Sub1 extends Class5 {
	...
	protected void method56(@OriginalArg(0) int arg0) {
		Static99.method1661(this.anInt123, arg0);
	}
	...
	private int method88(@OriginalArg(0) int arg0) {
		if (super.aByteArrayArray2[arg0] == null) {
			return this.aBooleanArray1[arg0] ? 100 : Static30.method592(this.anInt123, arg0);
		} else {
			return 100;
		}
	}
	...
	public int method89() {
		if (this.aBoolean8) {
			...
			@Pc(25) int local25 = Static30.method592(255, this.anInt123);
			if (local25 >= 100) {
				local25 = 99;
			}
			return local25;
	...
	public void method91(@OriginalArg(0) byte[] arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3) {
		if (arg2) {
			...
			if (this.aClass11_1 != null) {
				Static75.method1355(arg0, this.anInt123, this.aClass11_1);
			}
			this.method66(arg0);
			this.method90();
			return;
		...
		if (this.aClass11_2 != null) {
			Static75.method1355(arg0, arg3, this.aClass11_2);
	...
	public void method95(@OriginalArg(0) Class11 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(4) boolean arg3) {
		...
		if (arg2 == null || arg2.length <= 2) {
			...
			if (this.aBoolean7 || arg3) {
				Static45.method1535(arg1, this, super.anIntArray16[arg1], (byte) 2, arg3, this.anInt123);
			}
			return;
		}
		Class49.aCRC32_1.reset();
