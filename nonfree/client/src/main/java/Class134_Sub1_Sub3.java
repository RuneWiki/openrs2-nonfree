...
public final class Class134_Sub1_Sub3 extends Class134_Sub1 {

	@OriginalMember(owner = "client!uba", name = "H", descriptor = "[I")
	public final int[] anIntArray550;

	@OriginalMember(owner = "client!uba", name = "<init>", descriptor = "(Lclient!cba;[IIIIIZ)V")
	public Class134_Sub1_Sub3(@OriginalArg(0) Class57_Sub1 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) boolean arg6) {
		super(arg0, arg4, arg5);
		if (arg6) {
			this.anIntArray550 = new int[arg4 * arg5];
		} else {
			this.anIntArray550 = arg1;
		}
		@Pc(21) int local21 = arg3 - super.anInt9966;
		@Pc(23) int local23 = 0;
		for (@Pc(25) int local25 = 0; local25 < arg5; local25++) {
			for (@Pc(28) int local28 = 0; local28 < arg4; local28++) {
				@Pc(34) int local34 = arg1[arg2++];
				if (local34 >>> 24 == 255) {
					this.anIntArray550[local23++] = (local34 & 0xFFFFFF) == 0 ? -16777215 : local34;
				} else {
					this.anIntArray550[local23++] = 0;
				}
			}
			arg2 += local21;
		}
	...
	@OriginalMember(owner = "client!uba", name = "<init>", descriptor = "(Lclient!cba;II)V")
	public Class134_Sub1_Sub3(@OriginalArg(0) Class57_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		super(arg0, arg1, arg2);
		this.anIntArray550 = new int[arg1 * arg2];
	}

	@OriginalMember(owner = "client!uba", name = "<init>", descriptor = "(Lclient!cba;[III)V")
	public Class134_Sub1_Sub3(@OriginalArg(0) Class57_Sub1 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	public void method9225(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		for (@Pc(5) int local5 = 0; local5 < arg3; local5++) {
			@Pc(15) int local15 = (arg1 + local5) * super.anInt9966 + arg0;
			@Pc(25) int local25 = (arg5 + local5) * super.aClass57_Sub1_10.anInt1042 + arg4;
			for (@Pc(27) int local27 = 0; local27 < arg2; local27++) {
				this.anIntArray550[local15 + local27] = local3[local25 + local27];
			}
		}
	}
		...
		if (Static627.anInt9953 == 0) {
			if (Static627.anInt9952 == 0) {
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						if (local30 >= 0 && local32 >= 0 && local30 - (super.anInt9966 << 12) < 0 && local32 - (super.anInt9955 << 12) < 0) {
							...
							while (local34 < 0) {
								local122 = this.anIntArray550[(local32 >> 12) * super.anInt9966 + (local30 >> 12)];
								if (local122 == 0) {
									local28++;
								} else {
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						if (local30 >= 0 && local30 - (super.anInt9966 << 12) < 0) {
							@Pc(194) int local194;
							if ((local194 = local32 - (super.anInt9955 << 12)) >= 0) {
								local201 = (Static627.anInt9952 - local194) / Static627.anInt9952;
								local34 += local201;
								local32 += Static627.anInt9952 * local201;
								local28 += local201;
							}
							@Pc(222) int local222;
							if ((local222 = (local32 - Static627.anInt9952) / Static627.anInt9952) > local34) {
								local34 = local222;
							}
							local64 = arg0[local16] - arg2;
							local69 = -arg1[local16];
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						if (local30 >= 0 && local30 - (super.anInt9966 << 12) < 0) {
							if (local32 < 0) {
								local201 = (Static627.anInt9952 - local32 - 1) / Static627.anInt9952;
								local34 += local201;
								local32 += Static627.anInt9952 * local201;
								local28 += local201;
							}
							@Pc(400) int local400;
							if ((local400 = (local32 + 1 - (super.anInt9955 << 12) - Static627.anInt9952) / Static627.anInt9952) > local34) {
								local34 = local400;
							}
							local64 = arg0[local16] - arg2;
							local69 = -arg1[local16];
			...
			if (Static627.anInt9952 == 0) {
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						if (local32 >= 0 && local32 - (super.anInt9955 << 12) < 0) {
							@Pc(552) int local552;
							if ((local552 = local30 - (super.anInt9966 << 12)) >= 0) {
								local201 = (Static627.anInt9953 - local552) / Static627.anInt9953;
								local34 += local201;
								local30 += Static627.anInt9953 * local201;
								local28 += local201;
							}
							@Pc(580) int local580;
							if ((local580 = (local30 - Static627.anInt9953) / Static627.anInt9953) > local34) {
								local34 = local580;
							}
							local64 = arg0[local16] - arg2;
							local69 = -arg1[local16];
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						local34 = Static627.anInt9960;
						@Pc(719) int local719;
						if ((local719 = local30 - (super.anInt9966 << 12)) >= 0) {
							local201 = (Static627.anInt9953 - local719) / Static627.anInt9953;
							local34 += local201;
							local30 += Static627.anInt9953 * local201;
							local32 += Static627.anInt9952 * local201;
							local28 += local201;
						...
						@Pc(753) int local753;
						if ((local753 = (local30 - Static627.anInt9953) / Static627.anInt9953) > local34) {
							local34 = local753;
						}
						@Pc(765) int local765;
						if ((local765 = local32 - (super.anInt9955 << 12)) >= 0) {
							local201 = (Static627.anInt9952 - local765) / Static627.anInt9952;
							local34 += local201;
							local30 += Static627.anInt9953 * local201;
							local32 += Static627.anInt9952 * local201;
							local28 += local201;
						...
						@Pc(799) int local799;
						if ((local799 = (local32 - Static627.anInt9952) / Static627.anInt9952) > local34) {
							local34 = local799;
						}
						local64 = arg0[local16] - arg2;
						local69 = -arg1[local16];
				...
				while (local11 < 0) {
					...
					if (local16 >= 0) {
						...
						local34 = Static627.anInt9960;
						@Pc(944) int local944;
						if ((local944 = local30 - (super.anInt9966 << 12)) >= 0) {
							local201 = (Static627.anInt9953 - local944) / Static627.anInt9953;
							local34 += local201;
							local30 += Static627.anInt9953 * local201;
							local32 += Static627.anInt9952 * local201;
							local28 += local201;
						...
						@Pc(978) int local978;
						if ((local978 = (local30 - Static627.anInt9953) / Static627.anInt9953) > local34) {
							local34 = local978;
						}
						if (local32 < 0) {
							local201 = (Static627.anInt9952 - local32 - 1) / Static627.anInt9952;
						...
						if ((local1026 = (local32 + 1 - (super.anInt9955 << 12) - Static627.anInt9952) / Static627.anInt9952) > local34) {
							local34 = local1026;
						}
						local64 = arg0[local16] - arg2;
						local69 = -arg1[local16];
			...
			while (local11 < 0) {
				...
				if (local16 >= 0) {
					...
					if (local32 >= 0 && local32 - (super.anInt9955 << 12) < 0) {
						if (local30 < 0) {
							local201 = (Static627.anInt9953 - local30 - 1) / Static627.anInt9953;
							local34 += local201;
							local30 += Static627.anInt9953 * local201;
							local28 += local201;
						}
						@Pc(1214) int local1214;
						if ((local1214 = (local30 + 1 - (super.anInt9966 << 12) - Static627.anInt9953) / Static627.anInt9953) > local34) {
							local34 = local1214;
						}
						local64 = arg0[local16] - arg2;
						local69 = -arg1[local16];
			...
			while (local11 < 0) {
				...
				if (local16 >= 0) {
					...
					if ((local1393 = (local30 + 1 - (super.anInt9966 << 12) - Static627.anInt9953) / Static627.anInt9953) > local34) {
						local34 = local1393;
					}
					@Pc(1405) int local1405;
					if ((local1405 = local32 - (super.anInt9955 << 12)) >= 0) {
						local201 = (Static627.anInt9952 - local1405) / Static627.anInt9952;
						local34 += local201;
						local30 += Static627.anInt9953 * local201;
						local32 += Static627.anInt9952 * local201;
						local28 += local201;
					...
					if ((local1439 = (local32 - Static627.anInt9952) / Static627.anInt9952) > local34) {
						local34 = local1439;
					}
					local64 = arg0[local16] - arg2;
					local69 = -arg1[local16];
			...
			while (local11 < 0) {
				...
				if (local16 >= 0) {
					...
					if ((local1620 = (local30 + 1 - (super.anInt9966 << 12) - Static627.anInt9953) / Static627.anInt9953) > local34) {
						local34 = local1620;
					}
					if (local32 < 0) {
						local201 = (Static627.anInt9952 - local32 - 1) / Static627.anInt9952;
					...
					if ((local1668 = (local32 + 1 - (super.anInt9955 << 12) - Static627.anInt9952) / Static627.anInt9952) > local34) {
						local34 = local1668;
					}
					local64 = arg0[local16] - arg2;
					local69 = -arg1[local16];
		...
		if (arg7 != 0) {
			...
			if (arg7 == 1) {
				if (arg5 == 1) {
					...
					for (local265 = -arg4; local265 < 0; local265++) {
						...
						for (local276 = -arg3; local276 < 0; local276++) {
							if ((float) arg2 < local249[local55]) {
								local348 = this.anIntArray550[(local9 >> 16) + local273];
								if (local348 != 0) {
					...
					if ((arg6 & 0xFFFFFF) == 16777215) {
						...
						for (local276 = -arg4; local276 < 0; local276++) {
							local348 = (local11 >> 16) * super.anInt9966;
							for (local356 = -arg3; local356 < 0; local356++) {
								if ((float) arg2 < local249[local55]) {
									local359 = this.anIntArray550[(local9 >> 16) + local348];
									if (local359 != 0) {
						...
						for (local359 = -arg4; local359 < 0; local359++) {
							local376 = (local11 >> 16) * super.anInt9966;
							for (local384 = -arg3; local384 < 0; local384++) {
								if ((float) arg2 < local249[local55]) {
									local392 = this.anIntArray550[(local9 >> 16) + local376];
									if (local392 != 0) {
										if (local348 == 255) {
					...
					for (local356 = -arg4; local356 < 0; local356++) {
						local359 = (local11 >> 16) * super.anInt9966;
						for (local376 = -arg3; local376 < 0; local376++) {
							if ((float) arg2 < local249[local55]) {
								local384 = this.anIntArray550[(local9 >> 16) + local359];
								if (local384 != 0) {
				...
				for (local348 = -arg4; local348 < 0; local348++) {
					local356 = (local11 >> 16) * super.anInt9966;
					for (local359 = -arg3; local359 < 0; local359++) {
						if ((float) arg2 < local249[local55]) {
							local376 = this.anIntArray550[(local9 >> 16) + local356];
							if (local376 != 0) {
			...
			for (local265 = -arg4; local265 < 0; local265++) {
				...
				for (local276 = -arg3; local276 < 0; local276++) {
					if ((float) arg2 < local249[local55]) {
						local253[local55] = this.anIntArray550[(local9 >> 16) + local273];
						local249[local55] = (float) arg2;
					}
					local9 += local35;
					local55++;
	...
	protected void method8581(@OriginalArg(0) int arg0) {
		...
		if (Static627.anInt9953 == 0) {
			if (Static627.anInt9952 == 0) {
				...
				while (local11 < 0) {
					...
					if (local16 >= 0 && local18 >= 0 && local16 - (super.anInt9966 << 12) < 0 && local18 - (super.anInt9955 << 12) < 0) {
						while (local20 < 0) {
							...
							local60 = local14++;
							if (arg0 == 1) {
								local223 = this.anIntArray550[local57];
								if (local223 != 0) {
								...
								if (local223 != 0) {
									if ((Static627.anInt9974 & 0xFFFFFF) == 16777215) {
										local251 = Static627.anInt9974 >>> 24;
										...
										local251 = (local223 & 0xFF0000) * Static627.anInt9977 & 0xFF000000;
										local255 = (local223 & 0xFF00) * Static627.anInt9949 & 0xFF0000;
										local259 = (local223 & 0xFF) * Static627.anInt9956 & 0xFF00;
										...
										local3[local60] = ((local223 & 0xFF00FF) * Static627.anInt9976 + (local331 & 0xFF00FF) * Static627.anInt9947 & 0xFF00FF00) + ((local223 & 0xFF00) * Static627.anInt9976 + (local331 & 0xFF00) * Static627.anInt9947 & 0xFF0000) >> 8;
									}
								}
							} else if (arg0 == 3) {
								local223 = this.anIntArray550[local57];
								local251 = Static627.anInt9974;
								...
								if (local223 == 0 && Static627.anInt9976 != 255) {
									local223 = local331;
									local331 = local3[local60];
									local331 = ((local223 & 0xFF00FF) * Static627.anInt9976 + (local331 & 0xFF00FF) * Static627.anInt9947 & 0xFF00FF00) + ((local223 & 0xFF00) * Static627.anInt9976 + (local331 & 0xFF00) * Static627.anInt9947 & 0xFF0000) >> 8;
								}
								local3[local60] = local331;
							} else if (arg0 == 2) {
								local223 = this.anIntArray550[local57];
								if (local223 != 0) {
									local251 = (local223 & 0xFF00FF) * Static627.anInt9976 & 0xFF00FF00;
									local255 = (local223 & 0xFF00) * Static627.anInt9976 & 0xFF0000;
									local3[local60++] = ((local251 | local255) >>> 8) + Static627.anInt9948;
								}
							} else {
								throw new IllegalArgumentException();
							}
				...
				while (local11 < 0) {
					...
					if (local16 >= 0 && local16 - (super.anInt9966 << 12) < 0) {
						@Pc(871) int local871;
						if ((local871 = local18 - (super.anInt9955 << 12)) >= 0) {
							local878 = (Static627.anInt9952 - local871) / Static627.anInt9952;
							local20 += local878;
							local18 += Static627.anInt9952 * local878;
							local14 += local878;
						}
						@Pc(899) int local899;
						if ((local899 = (local18 - Static627.anInt9952) / Static627.anInt9952) > local20) {
							local20 = local899;
						}
						while (local20 < 0) {
							local57 = (local18 >> 12) * super.anInt9966 + (local16 >> 12);
				...
				while (local11 < 0) {
					...
					if (local16 >= 0 && local16 - (super.anInt9966 << 12) < 0) {
						if (local18 < 0) {
							local878 = (Static627.anInt9952 - local18 - 1) / Static627.anInt9952;
							local20 += local878;
							local18 += Static627.anInt9952 * local878;
							local14 += local878;
						}
						@Pc(1767) int local1767;
						if ((local1767 = (local18 + 1 - (super.anInt9955 << 12) - Static627.anInt9952) / Static627.anInt9952) > local20) {
							local20 = local1767;
						}
						while (local20 < 0) {
							local57 = (local18 >> 12) * super.anInt9966 + (local16 >> 12);
			...
			if (Static627.anInt9952 == 0) {
				...
				while (local11 < 0) {
					...
					if (local18 >= 0 && local18 - (super.anInt9955 << 12) < 0) {
						...
						if ((local2609 = local16 - (super.anInt9966 << 12)) >= 0) {
							local878 = (Static627.anInt9953 - local2609) / Static627.anInt9953;
							local20 += local878;
							local16 += Static627.anInt9953 * local878;
							local14 += local878;
						}
						@Pc(2637) int local2637;
						if ((local2637 = (local16 - Static627.anInt9953) / Static627.anInt9953) > local20) {
							local20 = local2637;
						}
						while (local20 < 0) {
							local57 = (local18 >> 12) * super.anInt9966 + (local16 >> 12);
				...
				while (local11 < 0) {
					...
					if ((local3466 = local16 - (super.anInt9966 << 12)) >= 0) {
						local878 = (Static627.anInt9953 - local3466) / Static627.anInt9953;
						local20 += local878;
						local16 += Static627.anInt9953 * local878;
						local18 += Static627.anInt9952 * local878;
						local14 += local878;
					...
					if ((local3500 = (local16 - Static627.anInt9953) / Static627.anInt9953) > local20) {
						local20 = local3500;
					}
					@Pc(3512) int local3512;
					if ((local3512 = local18 - (super.anInt9955 << 12)) >= 0) {
						local878 = (Static627.anInt9952 - local3512) / Static627.anInt9952;
						local20 += local878;
						local16 += Static627.anInt9953 * local878;
						local18 += Static627.anInt9952 * local878;
						local14 += local878;
					...
					if ((local3546 = (local18 - Static627.anInt9952) / Static627.anInt9952) > local20) {
						local20 = local3546;
					}
					while (local20 < 0) {
						local57 = (local18 >> 12) * super.anInt9966 + (local16 >> 12);
				...
				while (local11 < 0) {
					...
					if ((local4381 = local16 - (super.anInt9966 << 12)) >= 0) {
						local878 = (Static627.anInt9953 - local4381) / Static627.anInt9953;
						local20 += local878;
						local16 += Static627.anInt9953 * local878;
						local18 += Static627.anInt9952 * local878;
						local14 += local878;
					...
					if ((local4415 = (local16 - Static627.anInt9953) / Static627.anInt9953) > local20) {
						local20 = local4415;
					}
					if (local18 < 0) {
						local878 = (Static627.anInt9952 - local18 - 1) / Static627.anInt9952;
					...
					if ((local4463 = (local18 + 1 - (super.anInt9955 << 12) - Static627.anInt9952) / Static627.anInt9952) > local20) {
						local20 = local4463;
					}
					while (local20 < 0) {
						local57 = (local18 >> 12) * super.anInt9966 + (local16 >> 12);
			...
			while (local11 < 0) {
				...
				if (local18 >= 0 && local18 - (super.anInt9955 << 12) < 0) {
					if (local16 < 0) {
						local878 = (Static627.anInt9953 - local16 - 1) / Static627.anInt9953;
						local20 += local878;
						local16 += Static627.anInt9953 * local878;
						local14 += local878;
					}
					@Pc(5341) int local5341;
					if ((local5341 = (local16 + 1 - (super.anInt9966 << 12) - Static627.anInt9953) / Static627.anInt9953) > local20) {
						local20 = local5341;
					}
					while (local20 < 0) {
						local57 = (local18 >> 12) * super.anInt9966 + (local16 >> 12);
			...
			for (local11 = Static627.anInt9959; local11 < 0; local11++) {
				...
				if ((local6210 = (local16 + 1 - (super.anInt9966 << 12) - Static627.anInt9953) / Static627.anInt9953) > local20) {
					local20 = local6210;
				}
				@Pc(6222) int local6222;
				if ((local6222 = local18 - (super.anInt9955 << 12)) >= 0) {
					local878 = (Static627.anInt9952 - local6222) / Static627.anInt9952;
					local20 += local878;
					local16 += Static627.anInt9953 * local878;
					local18 += Static627.anInt9952 * local878;
					local14 += local878;
				...
				if ((local6256 = (local18 - Static627.anInt9952) / Static627.anInt9952) > local20) {
					local20 = local6256;
				}
				while (local20 < 0) {
					local57 = (local18 >> 12) * super.anInt9966 + (local16 >> 12);
			...
			for (local11 = Static627.anInt9959; local11 < 0; local11++) {
				...
				if ((local7127 = (local16 + 1 - (super.anInt9966 << 12) - Static627.anInt9953) / Static627.anInt9953) > local20) {
					local20 = local7127;
				}
				if (local18 < 0) {
					local878 = (Static627.anInt9952 - local18 - 1) / Static627.anInt9952;
				...
				if ((local7175 = (local18 + 1 - (super.anInt9955 << 12) - Static627.anInt9952) / Static627.anInt9952) > local20) {
					local20 = local7175;
				}
				while (local20 < 0) {
					local57 = (local18 >> 12) * super.anInt9966 + (local16 >> 12);
	...
	public void method9230(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		if (arg4 != 0) {
			...
			if (arg4 == 1) {
				if (arg2 == 1) {
					for (local174 = -local33; local174 < 0; local174++) {
						...
						while (local28 < local181) {
							local267 = this.anIntArray550[local30++];
							if (local267 == 0) {
								local28++;
							} else {
					...
					if ((arg3 & 0xFFFFFF) == 16777215) {
						...
						for (local267 = -local33; local267 < 0; local267++) {
							for (local270 = -local36; local270 < 0; local270++) {
								local274 = this.anIntArray550[local30++];
								if (local274 == 0) {
									local28++;
								} else {
						...
						for (local281 = -local33; local281 < 0; local281++) {
							for (local289 = -local36; local289 < 0; local289++) {
								local297 = this.anIntArray550[local30++];
								if (local297 == 0) {
									local28++;
					...
					for (local274 = -local33; local274 < 0; local274++) {
						for (local281 = -local36; local281 < 0; local281++) {
							local289 = this.anIntArray550[local30++];
							if (local289 == 0) {
								local28++;
							} else {
				...
				for (local270 = -local33; local270 < 0; local270++) {
					for (local274 = -local36; local274 < 0; local274++) {
						local281 = this.anIntArray550[local30++];
						if (local281 == 0) {
							local28++;
						} else {
			...
			for (local174 = -local33; local174 < 0; local174++) {
				local181 = local28 + local36 - 3;
				while (local28 < local181) {
					local164[local28++] = this.anIntArray550[local30++];
					local164[local28++] = this.anIntArray550[local30++];
					local164[local28++] = this.anIntArray550[local30++];
					local164[local28++] = this.anIntArray550[local30++];
				}
			...
			if (arg6 != 0) {
				...
				if (arg6 == 1) {
					if (arg4 == 1) {
						...
						for (local268 = -arg3; local268 < 0; local268++) {
							...
							for (local279 = -arg2; local279 < 0; local279++) {
								local337 = this.anIntArray550[(local18 >> 16) + local276];
								if (local337 == 0) {
									local68++;
								} else {
						...
						if ((arg5 & 0xFFFFFF) == 16777215) {
							...
							for (local279 = -arg3; local279 < 0; local279++) {
								local337 = (local20 >> 16) * super.anInt9966;
								for (local345 = -arg2; local345 < 0; local345++) {
									local348 = this.anIntArray550[(local18 >> 16) + local337];
									if (local348 == 0) {
										local68++;
									} else {
							...
							for (local348 = -arg3; local348 < 0; local348++) {
								local358 = (local20 >> 16) * super.anInt9966;
								for (local366 = -arg2; local366 < 0; local366++) {
									local374 = this.anIntArray550[(local18 >> 16) + local358];
									if (local374 == 0) {
										local68++;
						...
						for (local345 = -arg3; local345 < 0; local345++) {
							local348 = (local20 >> 16) * super.anInt9966;
							for (local358 = -arg2; local358 < 0; local358++) {
								local366 = this.anIntArray550[(local18 >> 16) + local348];
								if (local366 == 0) {
									local68++;
								} else {
					...
					for (local337 = -arg3; local337 < 0; local337++) {
						local345 = (local20 >> 16) * super.anInt9966;
						for (local348 = -arg2; local348 < 0; local348++) {
							local358 = this.anIntArray550[(local18 >> 16) + local345];
							if (local358 == 0) {
								local68++;
							} else {
				...
				for (local268 = -arg3; local268 < 0; local268++) {
					local276 = (local20 >> 16) * super.anInt9966;
					for (local279 = -arg2; local279 < 0; local279++) {
						local256[local68++] = this.anIntArray550[(local18 >> 16) + local276];
						local18 += local48;
					}
					local20 += local54;
					local18 = local265;
	...
	public void method9220(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class1 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		for (@Pc(217) int local217 = local175; local217 < local215; local217++) {
			...
			for (@Pc(309) int local309 = -local232; local309 < 0; local309++) {
				@Pc(316) int local316 = this.anIntArray550[local20++];
				if (local316 == 0) {
					local42++;
				} else {
