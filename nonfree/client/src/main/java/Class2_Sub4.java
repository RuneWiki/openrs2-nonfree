...
public final class Class2_Sub4 extends Class2 {
	...
	private float[] method681(@OriginalArg(0) int arg0) {
		Static28.method685(this.aByteArrayArray1[arg0]);
		Static28.method687();
		@Pc(15) int local15 = Static28.method688(Static102.method2331(Static28.anIntArray89.length - 1));
		@Pc(19) boolean local19 = Static28.aBooleanArray2[local15];
		@Pc(25) int local25 = local19 ? Static28.anInt855 : Static28.anInt857;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static28.method687() != 0;
			local29 = Static28.method687() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static28.anInt857 >> 2);
			local67 = (local25 >> 2) + (Static28.anInt857 >> 2);
			local71 = Static28.anInt857 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static28.anInt857 >> 2);
			local104 = local25 + (Static28.anInt857 >> 2) - (local25 >> 2);
			local108 = Static28.anInt857 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class54 local123 = Static28.aClass54Array1[Static28.anIntArray89[local15]];
		@Pc(126) int local126 = local123.anInt3181;
		@Pc(131) int local131 = local123.anIntArray362[local126];
		@Pc(140) boolean local140 = !Static28.aClass24Array1[local131].method1160();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt3182; local144++) {
			@Pc(152) Class91 local152 = Static28.aClass91Array1[local123.anIntArray363[local144]];
			local154 = Static28.aFloatArray2;
			local152.method3489(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt3181;
			local176 = local123.anIntArray362[local171];
			Static28.aClass24Array1[local176].method1162(Static28.aFloatArray2, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static28.aFloatArray2[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static28.aFloatArray2;
			...
			@Pc(252) float[] local252 = local19 ? Static28.aFloatArray3 : Static28.aFloatArray7;
			@Pc(258) float[] local258 = local19 ? Static28.aFloatArray5 : Static28.aFloatArray4;
			@Pc(264) float[] local264 = local19 ? Static28.aFloatArray1 : Static28.aFloatArray8;
			@Pc(270) int[] local270 = local19 ? Static28.anIntArray90 : Static28.anIntArray91;
			...
			@Pc(486) int local486 = Static102.method2331(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static28.aFloatArray2[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static28.aFloatArray2[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt853 > 0) {
			local176 = this.anInt853 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean33) {
				for (local212 = 0; local212 < this.anInt848; local212++) {
					local1254 = (this.anInt853 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static28.aFloatArray2[local212];
				}
			}
		}
		local154 = this.aFloatArray6;
		this.aFloatArray6 = Static28.aFloatArray2;
		Static28.aFloatArray2 = local154;
		this.anInt853 = local25;
		this.anInt848 = local104 - (local25 >> 1);
		this.aBoolean33 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!cg", name = "a", descriptor = "([I)Lclient!oa;")
	public Class2_Sub16_Sub1 method684(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray16 == null) {
			this.anInt853 = 0;
			this.aFloatArray6 = new float[Static28.anInt855];
			this.aByteArray16 = new byte[this.anInt856];
			this.anInt858 = 0;
			this.anInt859 = 0;
		}
		while (this.anInt859 < this.aByteArrayArray1.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method681(this.anInt859);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt858;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt856 - local47) {
					local50 = this.anInt856 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt858;
				}
				this.anInt858 = local47;
			}
			this.anInt859++;
		}
		...
		return new Class2_Sub16_Sub1(this.anInt851, local129, this.anInt852, this.anInt849, this.aBoolean32);
	}
	...
	private void method690(@OriginalArg(0) byte[] arg0) {
		...
		this.anInt851 = local4.method206();
		this.anInt856 = local4.method206();
		this.anInt852 = local4.method206();
		this.anInt849 = local4.method206();
		if (this.anInt849 < 0) {
			this.anInt849 = ~this.anInt849;
			this.aBoolean32 = true;
		}
		@Pc(40) int local40 = local4.method206();
		this.aByteArrayArray1 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method218();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method228(local49, local64);
