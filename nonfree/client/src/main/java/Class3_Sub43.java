...
public final class Class3_Sub43 extends Class3 {
	...
	private int anInt7679;

	@OriginalMember(owner = "client!pd", name = "O", descriptor = "I")
	private int anInt7680;

	@OriginalMember(owner = "client!pd", name = "<init>", descriptor = "([B)V")
	public Class3_Sub43(@OriginalArg(0) byte[] arg0) {
		this.method6654(arg0);
	}

	@OriginalMember(owner = "client!pd", name = "b", descriptor = "([B)V")
	private void method6654(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class3_Sub3 local4 = new Class3_Sub3(arg0);
		this.anInt7677 = local4.method4207();
		this.anInt7672 = local4.method4207();
		this.anInt7674 = local4.method4207();
		this.anInt7676 = local4.method4207();
		if (this.anInt7676 < 0) {
			this.anInt7676 = ~this.anInt7676;
			this.aBoolean538 = true;
		}
		@Pc(40) int local40 = local4.method4207();
		this.aByteArrayArray28 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method4225();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method4206(local64, local49, 0);
			this.aByteArrayArray28[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!pd", name = "b", descriptor = "(I)[F")
	private float[] method6655(@OriginalArg(0) int arg0) {
		Static425.method6648(this.aByteArrayArray28[arg0]);
		Static425.method6653();
		@Pc(15) int local15 = Static425.method6651(Static636.method8709(Static425.anIntArray468.length - 1));
		@Pc(19) boolean local19 = Static425.aBooleanArray20[local15];
		@Pc(25) int local25 = local19 ? Static425.anInt7670 : Static425.anInt7669;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static425.method6653() != 0;
			local29 = Static425.method6653() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static425.anInt7669 >> 2);
			local67 = (local25 >> 2) + (Static425.anInt7669 >> 2);
			local71 = Static425.anInt7669 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static425.anInt7669 >> 2);
			local104 = local25 + (Static425.anInt7669 >> 2) - (local25 >> 2);
			local108 = Static425.anInt7669 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class181 local123 = Static425.aClass181Array1[Static425.anIntArray468[local15]];
		@Pc(126) int local126 = local123.anInt5125;
		@Pc(131) int local131 = local123.anIntArray276[local126];
		@Pc(140) boolean local140 = !Static425.aClass325Array1[local131].method7999();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt5124; local144++) {
			@Pc(152) Class126 local152 = Static425.aClass126Array1[local123.anIntArray275[local144]];
			local154 = Static425.aFloatArray67;
			local152.method3131(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt5125;
			local176 = local123.anIntArray276[local171];
			Static425.aClass325Array1[local176].method7997(Static425.aFloatArray67, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static425.aFloatArray67[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static425.aFloatArray67;
			...
			@Pc(252) float[] local252 = local19 ? Static425.aFloatArray62 : Static425.aFloatArray63;
			@Pc(258) float[] local258 = local19 ? Static425.aFloatArray64 : Static425.aFloatArray65;
			@Pc(264) float[] local264 = local19 ? Static425.aFloatArray60 : Static425.aFloatArray66;
			@Pc(270) int[] local270 = local19 ? Static425.anIntArray470 : Static425.anIntArray469;
			...
			@Pc(486) int local486 = Static636.method8709(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static425.aFloatArray67[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static425.aFloatArray67[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt7675 > 0) {
			local176 = this.anInt7675 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean540) {
				for (local212 = 0; local212 < this.anInt7671; local212++) {
					local1254 = (this.anInt7675 >> 1) + local212;
					local1228[local212] += this.aFloatArray61[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static425.aFloatArray67[local212];
				}
			}
		}
		local154 = this.aFloatArray61;
		this.aFloatArray61 = Static425.aFloatArray67;
		Static425.aFloatArray67 = local154;
		this.anInt7675 = local25;
		this.anInt7671 = local104 - (local25 >> 1);
		this.aBoolean540 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!pd", name = "a", descriptor = "([I)Lclient!jda;")
	public Class3_Sub30_Sub1 method6658(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray82 == null) {
			this.anInt7675 = 0;
			this.aFloatArray61 = new float[Static425.anInt7670];
			this.aByteArray82 = new byte[this.anInt7672];
			this.anInt7680 = 0;
			this.anInt7679 = 0;
		}
		while (this.anInt7679 < this.aByteArrayArray28.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method6655(this.anInt7679);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt7680;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt7672 - local47) {
					local50 = this.anInt7672 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray82[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt7680;
				}
				this.anInt7680 = local47;
			}
			this.anInt7679++;
		}
		this.aFloatArray61 = null;
		@Pc(129) byte[] local129 = this.aByteArray82;
		this.aByteArray82 = null;
		return new Class3_Sub30_Sub1(this.anInt7677, local129, this.anInt7674, this.anInt7676, this.aBoolean538);
	}
}
