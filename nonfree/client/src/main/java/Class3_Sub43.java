...
public final class Class3_Sub43 extends Class3 {
	...
	@OriginalMember(owner = "client!vi", name = "a", descriptor = "([I)Lclient!bq;")
	public Class3_Sub6_Sub1 method5461(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray90 == null) {
			this.anInt6955 = 0;
			this.aFloatArray20 = new float[Static427.anInt6953];
			this.aByteArray90 = new byte[this.anInt6951];
			this.anInt6959 = 0;
			this.anInt6958 = 0;
		}
		while (this.anInt6958 < this.aByteArrayArray23.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method5468(this.anInt6958);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt6959;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt6951 - local47) {
					local50 = this.anInt6951 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray90[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt6959;
				}
				this.anInt6959 = local47;
			}
			this.anInt6958++;
		}
		this.aFloatArray20 = null;
		@Pc(129) byte[] local129 = this.aByteArray90;
		this.aByteArray90 = null;
		return new Class3_Sub6_Sub1(this.anInt6957, local129, this.anInt6956, this.anInt6950, this.aBoolean595);
	}

	@OriginalMember(owner = "client!vi", name = "a", descriptor = "([B)V")
	private void method5462(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class3_Sub7 local4 = new Class3_Sub7(arg0);
		this.anInt6957 = local4.method2589();
		this.anInt6951 = local4.method2589();
		this.anInt6956 = local4.method2589();
		this.anInt6950 = local4.method2589();
		if (this.anInt6950 < 0) {
			this.anInt6950 = ~this.anInt6950;
			this.aBoolean595 = true;
		}
		@Pc(40) int local40 = local4.method2589();
		this.aByteArrayArray23 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method2582();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method2580(local49, local64);
			this.aByteArrayArray23[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!vi", name = "e", descriptor = "(I)[F")
	private float[] method5468(@OriginalArg(0) int arg0) {
		Static427.method5465(this.aByteArrayArray23[arg0]);
		Static427.method5459();
		@Pc(15) int local15 = Static427.method5467(Static63.method1284(Static427.anIntArray508.length - 1));
		@Pc(19) boolean local19 = Static427.aBooleanArray25[local15];
		@Pc(25) int local25 = local19 ? Static427.anInt6953 : Static427.anInt6948;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static427.method5459() != 0;
			local29 = Static427.method5459() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static427.anInt6948 >> 2);
			local67 = (local25 >> 2) + (Static427.anInt6948 >> 2);
			local71 = Static427.anInt6948 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static427.anInt6948 >> 2);
			local104 = local25 + (Static427.anInt6948 >> 2) - (local25 >> 2);
			local108 = Static427.anInt6948 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class150 local123 = Static427.aClass150Array1[Static427.anIntArray508[local15]];
		@Pc(126) int local126 = local123.anInt4699;
		@Pc(131) int local131 = local123.anIntArray302[local126];
		@Pc(140) boolean local140 = !Static427.aClass240Array1[local131].method5093();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt4700; local144++) {
			@Pc(152) Class192 local152 = Static427.aClass192Array1[local123.anIntArray301[local144]];
			local154 = Static427.aFloatArray18;
			local152.method4291(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt4699;
			local176 = local123.anIntArray302[local171];
			Static427.aClass240Array1[local176].method5087(Static427.aFloatArray18, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static427.aFloatArray18[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static427.aFloatArray18;
			...
			@Pc(252) float[] local252 = local19 ? Static427.aFloatArray24 : Static427.aFloatArray25;
			@Pc(258) float[] local258 = local19 ? Static427.aFloatArray23 : Static427.aFloatArray21;
			@Pc(264) float[] local264 = local19 ? Static427.aFloatArray19 : Static427.aFloatArray22;
			@Pc(270) int[] local270 = local19 ? Static427.anIntArray509 : Static427.anIntArray507;
			...
			@Pc(486) int local486 = Static63.method1284(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static427.aFloatArray18[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static427.aFloatArray18[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		...
		if (this.anInt6955 > 0) {
			...
			if (!this.aBoolean596) {
				for (local212 = 0; local212 < this.anInt6949; local212++) {
					local1254 = (this.anInt6955 >> 1) + local212;
					local1228[local212] += this.aFloatArray20[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static427.aFloatArray18[local212];
				}
			}
		}
		local154 = this.aFloatArray20;
		this.aFloatArray20 = Static427.aFloatArray18;
		Static427.aFloatArray18 = local154;
		this.anInt6955 = local25;
		this.anInt6949 = local104 - (local25 >> 1);
		this.aBoolean596 = local140;
		return local1228;
	}
}
