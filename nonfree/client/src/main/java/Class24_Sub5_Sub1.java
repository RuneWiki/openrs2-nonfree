...
public final class Class24_Sub5_Sub1 extends Class24_Sub5 implements Interface10 {

	@OriginalMember(owner = "client!rb", name = "O", descriptor = "Lclient!qh;")
	public Class24_Sub5 aClass24_Sub5_3;

	@OriginalMember(owner = "client!rb", name = "<init>", descriptor = "(IIIIILclient!qh;)V")
	public Class24_Sub5_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) Class24_Sub5 arg5) {
		super(arg2, arg3, arg4, Static396.method5259(arg1, arg0));
		this.aClass24_Sub5_3 = arg5;
	}
	...
	@OriginalMember(owner = "client!rb", name = "b", descriptor = "(Lclient!za;I)Lclient!nd;")
	@Override
	public Class40_Sub5 method5686(@OriginalArg(0) Class50 arg0) {
		return null;
	}

	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lclient!za;I)V")
	@Override
	...
	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(IBILclient!vs;Lclient!za;ZI)V")
	@Override
	...
	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(BLclient!za;)V")
	@Override
	public void method5685(@OriginalArg(1) Class50 arg0) {
	}

	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lclient!za;Z)V")
	@Override
	...
	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILclient!za;I)Lclient!e;")
	@Override
	...
	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(ZLclient!za;II)Z")
	@Override
