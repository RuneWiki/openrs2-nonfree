...
public final class Class80_Sub2_Sub3 extends Class80_Sub2 {
	...
	@OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(Lclient!sr;[III)V")
	public Class80_Sub2_Sub3(@OriginalArg(0) Class50_Sub2 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		super(arg0, arg2, arg3);
		this.anIntArray558 = arg1;
	}

	@OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(Lclient!sr;[IIIII)V")
	public Class80_Sub2_Sub3(@OriginalArg(0) Class50_Sub2 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		super(arg0, arg4, arg5);
		this.anIntArray558 = new int[arg4 * arg5];
		...
		for (@Pc(19) int local19 = 0; local19 < arg5; local19++) {
			for (@Pc(22) int local22 = 0; local22 < arg4; local22++) {
				this.anIntArray558[local17++] = arg1[arg2++];
			}
			arg2 += local15;
		}
	}
		...
		if (arg2 == 1) {
			for (local492 = -local32; local492 < 0; local492++) {
				for (local496 = -local35; local496 < 0; local496++) {
					local503 = this.anIntArray558[local29++];
		...
		if (arg2 == 0) {
			if ((arg3 & 0xFFFFFF) == 16777215) {
				...
				for (local507 = -local32; local507 < 0; local507++) {
					for (local511 = -local35; local511 < 0; local511++) {
						local515 = this.anIntArray558[local29++];
			...
			for (local511 = -local32; local511 < 0; local511++) {
				for (local515 = -local35; local515 < 0; local515++) {
					local690 = this.anIntArray558[local29++];
		...
		if (Static183.anInt5711 == 0) {
			if (Static183.anInt5694 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local27 >= 0 && local25 - (super.anInt5712 << 12) < 0 && local27 - (super.anInt5719 << 12) < 0) {
							...
							while (local29 < 0) {
								local111 = this.anIntArray558[(local27 >> 12) * super.anInt5712 + (local25 >> 12)];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt5712 << 12) < 0) {
							@Pc(210) int local210;
							if ((local210 = local27 - (super.anInt5719 << 12)) >= 0) {
								local217 = (Static183.anInt5694 - local210) / Static183.anInt5694;
								local29 += local217;
								local27 += Static183.anInt5694 * local217;
								local23 += local217;
							}
							@Pc(238) int local238;
							if ((local238 = (local27 - Static183.anInt5694) / Static183.anInt5694) > local29) {
								local29 = local238;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt5712 << 12) < 0) {
							if (local27 < 0) {
								local217 = (Static183.anInt5694 - local27 - 1) / Static183.anInt5694;
								local29 += local217;
								local27 += Static183.anInt5694 * local217;
								local23 += local217;
							}
							@Pc(441) int local441;
							if ((local441 = (local27 + 1 - (super.anInt5719 << 12) - Static183.anInt5694) / Static183.anInt5694) > local29) {
								local29 = local441;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
			...
			if (Static183.anInt5694 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local27 >= 0 && local27 - (super.anInt5719 << 12) < 0) {
							@Pc(618) int local618;
							if ((local618 = local25 - (super.anInt5712 << 12)) >= 0) {
								local217 = (Static183.anInt5711 - local618) / Static183.anInt5711;
								local29 += local217;
								local25 += Static183.anInt5711 * local217;
								local23 += local217;
							}
							@Pc(646) int local646;
							if ((local646 = (local25 - Static183.anInt5711) / Static183.anInt5711) > local29) {
								local29 = local646;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static183.anInt5707;
						@Pc(814) int local814;
						if ((local814 = local25 - (super.anInt5712 << 12)) >= 0) {
							local217 = (Static183.anInt5711 - local814) / Static183.anInt5711;
							local29 += local217;
							local25 += Static183.anInt5711 * local217;
							local27 += Static183.anInt5694 * local217;
							local23 += local217;
						...
						@Pc(848) int local848;
						if ((local848 = (local25 - Static183.anInt5711) / Static183.anInt5711) > local29) {
							local29 = local848;
						}
						@Pc(860) int local860;
						if ((local860 = local27 - (super.anInt5719 << 12)) >= 0) {
							local217 = (Static183.anInt5694 - local860) / Static183.anInt5694;
							local29 += local217;
							local25 += Static183.anInt5711 * local217;
							local27 += Static183.anInt5694 * local217;
							local23 += local217;
						...
						@Pc(894) int local894;
						if ((local894 = (local27 - Static183.anInt5694) / Static183.anInt5694) > local29) {
							local29 = local894;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if ((local1068 = local25 - (super.anInt5712 << 12)) >= 0) {
							local217 = (Static183.anInt5711 - local1068) / Static183.anInt5711;
							local29 += local217;
							local25 += Static183.anInt5711 * local217;
							local27 += Static183.anInt5694 * local217;
							local23 += local217;
						...
						if ((local1102 = (local25 - Static183.anInt5711) / Static183.anInt5711) > local29) {
							local29 = local1102;
						}
						if (local27 < 0) {
							local217 = (Static183.anInt5694 - local27 - 1) / Static183.anInt5694;
						...
						if ((local1150 = (local27 + 1 - (super.anInt5719 << 12) - Static183.anInt5694) / Static183.anInt5694) > local29) {
							local29 = local1150;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if (local27 >= 0 && local27 - (super.anInt5719 << 12) < 0) {
						if (local25 < 0) {
							local217 = (Static183.anInt5711 - local25 - 1) / Static183.anInt5711;
							local29 += local217;
							local25 += Static183.anInt5711 * local217;
							local23 += local217;
						}
						@Pc(1363) int local1363;
						if ((local1363 = (local25 + 1 - (super.anInt5712 << 12) - Static183.anInt5711) / Static183.anInt5711) > local29) {
							local29 = local1363;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1571 = (local25 + 1 - (super.anInt5712 << 12) - Static183.anInt5711) / Static183.anInt5711) > local29) {
						local29 = local1571;
					}
					@Pc(1583) int local1583;
					if ((local1583 = local27 - (super.anInt5719 << 12)) >= 0) {
						local217 = (Static183.anInt5694 - local1583) / Static183.anInt5694;
						local29 += local217;
						local25 += Static183.anInt5711 * local217;
						local27 += Static183.anInt5694 * local217;
						local23 += local217;
					...
					if ((local1617 = (local27 - Static183.anInt5694) / Static183.anInt5694) > local29) {
						local29 = local1617;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1827 = (local25 + 1 - (super.anInt5712 << 12) - Static183.anInt5711) / Static183.anInt5711) > local29) {
						local29 = local1827;
					}
					if (local27 < 0) {
						local217 = (Static183.anInt5694 - local27 - 1) / Static183.anInt5694;
					...
					if ((local1875 = (local27 + 1 - (super.anInt5719 << 12) - Static183.anInt5694) / Static183.anInt5694) > local29) {
						local29 = local1875;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local16 >= 0 && local14 - (super.anInt5712 << 12) < 0 && local16 - (super.anInt5719 << 12) < 0) {
						while (local18 < 0) {
							...
							local51 = local12++;
							if (arg0 == 1) {
								local209 = this.anIntArray558[local48];
								...
								local209 = this.anIntArray558[local48];
								local213 = (local209 >>> 24) * Static183.anInt5701 >> 8;
								local217 = 256 - local213;
								if ((Static183.anInt5692 & 0xFFFFFF) == 16777215) {
									local221 = local3[local51];
									local3[local51] = ((local209 & 0xFF00FF) * local213 + (local221 & 0xFF00FF) * local217 & 0xFF00FF00) + ((local209 & 0xFF00) * local213 + (local221 & 0xFF00) * local217 & 0xFF0000) >> 8;
								} else if (local213 == 255) {
									local221 = (local209 & 0xFF0000) * Static183.anInt5706 & 0xFF000000;
									local334 = (local209 & 0xFF00) * Static183.anInt5713 & 0xFF0000;
									local342 = (local209 & 0xFF) * Static183.anInt5699 & 0xFF00;
								...
								local342 = (local334 >>> 24) * Static183.anInt5701 >> 8;
								...
								local213 = local209 >>> 24;
								local217 = 256 - local213;
								local221 = (local209 & 0xFF00FF) * Static183.anInt5701 & 0xFF00FF00;
								local334 = (local209 & 0xFF00) * Static183.anInt5701 & 0xFF0000;
								local209 = ((local221 | local334) >>> 8) + Static183.anInt5690;
	...
	public void oa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(25) int local25;
		if (arg2 == 0) {
			local5 = super.aClass50_Sub2_8.anIntArray628;
			for (local7 = 0; local7 < super.anInt5719; local7++) {
				local13 = local7 * super.anInt5712;
				local23 = (arg1 + local7) * super.aClass50_Sub2_8.anInt6478 + arg0;
				for (local25 = 0; local25 < super.anInt5712; local25++) {
					this.anIntArray558[local13 + local25] = this.anIntArray558[local13 + local25] & 0xFFFFFF | (local5[local23 + local25] & 0xFF0000) << 8;
				}
			}
		} else if (arg2 == 3) {
			local5 = super.aClass50_Sub2_8.anIntArray628;
			for (local7 = 0; local7 < super.anInt5719; local7++) {
				...
				local23 = (arg1 + local7) * super.aClass50_Sub2_8.anInt6478 + arg0;
				for (local25 = 0; local25 < super.anInt5712; local25++) {
					this.anIntArray558[local13 + local25] = this.anIntArray558[local13 + local25] & 0xFFFFFF | (local5[local23 + local25] == 0 ? 0 : -16777216);
				}
			}
		}
	}

	@OriginalMember(owner = "client!qs", name = "a", descriptor = "(IILclient!ta;II)V")
	@Override
	public void method5562(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class49 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		for (@Pc(212) int local212 = local171; local212 < local210; local212++) {
			...
			for (@Pc(304) int local304 = -local227; local304 < 0; local304++) {
				@Pc(311) int local311 = this.anIntArray558[local19++];
		...
		if (super.aClass50_Sub2_8.method5087()) {
			...
			if (arg6 != 0) {
					...
					if (arg4 == 1) {
						...
						for (local262 = -arg3; local262 < 0; local262++) {
							...
							for (local273 = -arg2; local273 < 0; local273++) {
								local330 = this.anIntArray558[(local14 >> 16) + local270];
						...
						if ((arg5 & 0xFFFFFF) == 16777215) {
							...
							for (local330 = -arg3; local330 < 0; local330++) {
								...
								for (local341 = -arg2; local341 < 0; local341++) {
									local351 = this.anIntArray558[(local14 >> 16) + local338];
						...
						for (local338 = -arg3; local338 < 0; local338++) {
							...
							for (local351 = -arg2; local351 < 0; local351++) {
								local359 = this.anIntArray558[(local14 >> 16) + local341];
				...
				for (local262 = -arg3; local262 < 0; local262++) {
					local270 = (local16 >> 16) * super.anInt5712;
					for (local273 = -arg2; local273 < 0; local273++) {
						local252[local64++] = this.anIntArray558[(local14 >> 16) + local270];
						local14 += local44;
					}
					local16 += local50;
					local14 = local259;
	...
	public void XA(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		for (@Pc(5) int local5 = 0; local5 < arg3; local5++) {
			...
			for (@Pc(24) int local24 = 0; local24 < arg2; local24++) {
				this.anIntArray558[local14 + local24] = local3[local22 + local24] & 0xFFFFFF;
			}
		}
	}
}
