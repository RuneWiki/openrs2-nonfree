...
public final class Class33_Sub13 extends Class33 {
	...
	@OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(ILclient!cq;)V")
	public Class33_Sub13(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub13 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Lclient!cq;)V")
	public Class33_Sub13(@OriginalArg(0) Class2_Sub13 arg0) {
		super(arg0);
	}
	...
	public int method8443(@OriginalArg(0) int arg0) {
		return arg0 == 0 || super.aClass2_Sub13_32.aClass33_Sub18_1.method6344() == 1 ? 1 : 2;
	}

	@OriginalMember(owner = "client!kp", name = "a", descriptor = "(I)V")
	@Override
	public void method8441() {
		if (super.anInt10093 != 0 && super.aClass2_Sub13_32.aClass33_Sub18_1.method6344() != 1) {
			super.anInt10093 = 0;
		}
