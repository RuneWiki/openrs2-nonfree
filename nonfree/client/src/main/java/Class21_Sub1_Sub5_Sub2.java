...
public final class Class21_Sub1_Sub5_Sub2 extends Class21_Sub1_Sub5 implements Interface21 {

	@OriginalMember(owner = "client!ns", name = "U", descriptor = "Lclient!eh;")
	private Class93 aClass93_7;

	@OriginalMember(owner = "client!ns", name = "J", descriptor = "Z")
	private boolean aBoolean481 = false;

	@OriginalMember(owner = "client!ns", name = "H", descriptor = "Lclient!bba;")
	public final Class28 aClass28_3;

	@OriginalMember(owner = "client!ns", name = "W", descriptor = "Z")
	private final boolean aBoolean482;

	@OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lclient!r;Lclient!nf;IIIIIZII)V")
	public Class21_Sub1_Sub5_Sub2(@OriginalArg(0) Class7 arg0, @OriginalArg(1) Class233 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) boolean arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		super(arg4, arg5, arg6, arg2, arg3, arg1.anInt6683);
		this.aClass28_3 = new Class28(arg0, arg1, 22, arg8, arg2, arg3, this, arg7, arg9);
		this.aBoolean482 = arg1.anInt6681 != 0 && !arg7;
	}
	...
	@OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILclient!r;)V")
	@Override
	public void method7279(@OriginalArg(1) Class7 arg0) {
		this.aClass28_3.method968(arg0);
	}

	@OriginalMember(owner = "client!ns", name = "i", descriptor = "(I)I")
	@Override
	public int method8231() {
		return this.aClass28_3.method973();
	}
	...
	public int method7283() {
		return this.aClass28_3.anInt1125;
	}
	...
	public boolean method7282() {
		return this.aClass28_3.method967();
	}
	...
	@OriginalMember(owner = "client!ns", name = "b", descriptor = "(ILclient!r;)Lclient!eh;")
	@Override
	public Class93 method8223(@OriginalArg(1) Class7 arg0) {
		return this.aClass93_7;
	}

	@OriginalMember(owner = "client!ns", name = "a", descriptor = "(Z)I")
	@Override
	public int method7280() {
		return this.aClass28_3.anInt1144;
	}

	@OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lclient!r;I)Lclient!ej;")
	@Override
	public Class21_Sub4 method8228(@OriginalArg(0) Class7 arg0) {
		@Pc(14) Class65 local14 = this.aClass28_3.method964(2048, arg0, true, false);
		if (local14 == null) {
			return null;
		}
		...
		this.aClass28_3.method971(local55, true, arg0, local50, local50, local28, local55, local14);
		...
		if (this.aClass28_3.aClass21_Sub5_1 != null) {
			@Pc(105) Class276 local105 = this.aClass28_3.aClass21_Sub5_1.method3048();
			if (Static263.aBoolean371) {
		...
		this.aBoolean481 = local14.LA() || this.aClass28_3.aClass21_Sub5_1 != null;
		if (this.aClass93_7 == null) {
			this.aClass93_7 = Static369.method7616(super.anInt10551, super.anInt10554, super.anInt10550, local14);
		} else {
			Static496.method7173(local14, this.aClass93_7, super.anInt10550, super.anInt10554, super.anInt10551);
		}
		return local38;
	}

	@OriginalMember(owner = "client!ns", name = "a", descriptor = "(IILclient!r;B)Z")
	@Override
	public boolean method8222(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class7 arg2) {
		@Pc(12) Class65 local12 = this.aClass28_3.method964(131072, arg2, false, false);
		if (local12 == null) {
			return false;
		} else {
	...
	@OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lclient!r;B)V")
	@Override
	public void method7278(@OriginalArg(0) Class7 arg0) {
		this.aClass28_3.method972(arg0);
	}

	@OriginalMember(owner = "client!ns", name = "c", descriptor = "(ILclient!r;)V")
	@Override
	public void method8233(@OriginalArg(1) Class7 arg0) {
		@Pc(12) Class65 local12 = this.aClass28_3.method964(262144, arg0, true, true);
		if (local12 == null) {
			return;
		}
		...
		this.aClass28_3.method971(local28, false, arg0, local23, local23, local31, local28, local12);
	}
	...
	public int method8224(@OriginalArg(0) byte arg0) {
		if (arg0 > -102) {
			Static360.aShortArrayArrayArray3 = null;
		}
		return this.aClass28_3.method965((byte) 60);
	}

	@OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)I")
	@Override
	public int method7281() {
		return this.aClass28_3.anInt1119;
	}

	@OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lclient!vj;IZLclient!r;IIB)V")
	@Override
