...
public final class Class1_Sub6 extends Class1 {
	...
	private void method545(@OriginalArg(0) byte[] arg0) {
		...
		this.anInt582 = local4.method1860();
		this.anInt580 = local4.method1860();
		this.anInt585 = local4.method1860();
		this.anInt586 = local4.method1860();
		if (this.anInt586 < 0) {
			this.anInt586 = ~this.anInt586;
			this.aBoolean60 = true;
		}
		@Pc(40) int local40 = local4.method1860();
		this.aByteArrayArray2 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(51) int local51 = 0;
			@Pc(55) int local55;
			do {
				local55 = local4.method1853();
				local51 += local55;
			} while (local55 >= 255);
			@Pc(67) byte[] local67 = new byte[local51];
			local4.method1866(local67, local51);
			this.aByteArrayArray2[local46] = local67;
		}
	}

	@OriginalMember(owner = "client!ca", name = "a", descriptor = "([I)Lclient!pc;")
	public Class1_Sub23_Sub1 method549(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray25 == null) {
			this.anInt583 = 0;
			this.aFloatArray5 = new float[Static32.anInt584];
			this.aByteArray25 = new byte[this.anInt580];
			this.anInt589 = 0;
			this.anInt588 = 0;
		}
		while (this.anInt588 < this.aByteArrayArray2.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(47) float[] local47 = this.method551(this.anInt588);
			if (local47 != null) {
				@Pc(52) int local52 = this.anInt589;
				@Pc(55) int local55 = local47.length;
				if (local55 > this.anInt580 - local52) {
					local55 = this.anInt580 - local52;
				}
				for (@Pc(68) int local68 = 0; local68 < local55; local68++) {
					...
					this.aByteArray25[local52++] = (byte) (local80 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local52 - this.anInt589;
				}
				this.anInt589 = local52;
			}
			this.anInt588++;
		}
		...
		return new Class1_Sub23_Sub1(this.anInt582, local129, this.anInt585, this.anInt586, this.aBoolean60);
	}

	@OriginalMember(owner = "client!ca", name = "f", descriptor = "(I)[F")
	private float[] method551(@OriginalArg(0) int arg0) {
		Static32.method554(this.aByteArrayArray2[arg0]);
		Static32.method553();
		@Pc(15) int local15 = Static32.method544(Static136.method2354(Static32.anIntArray65.length - 1));
		@Pc(19) boolean local19 = Static32.aBooleanArray2[local15];
		@Pc(25) int local25 = local19 ? Static32.anInt584 : Static32.anInt581;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static32.method553() != 0;
			local29 = Static32.method553() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static32.anInt581 >> 2);
			local67 = (local25 >> 2) + (Static32.anInt581 >> 2);
			local71 = Static32.anInt581 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static32.anInt581 >> 2);
			local104 = local25 + (Static32.anInt581 >> 2) - (local25 >> 2);
			local108 = Static32.anInt581 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class56 local123 = Static32.aClass56Array1[Static32.anIntArray65[local15]];
		@Pc(126) int local126 = local123.anInt1719;
		@Pc(131) int local131 = local123.anIntArray135[local126];
		@Pc(140) boolean local140 = !Static32.aClass117Array1[local131].method3141();
		for (@Pc(144) int local144 = 0; local144 < local123.anInt1720; local144++) {
			@Pc(155) Class123 local155 = Static32.aClass123Array1[local123.anIntArray134[local144]];
			@Pc(157) float[] local157 = Static32.aFloatArray6;
			local155.method3299(local157, local25 >> 1, local140);
		}
		@Pc(176) int local176;
		if (!local140) {
			local131 = local123.anInt1719;
			local176 = local123.anIntArray135[local131];
			Static32.aClass117Array1[local176].method3137(Static32.aFloatArray6, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local131 = local25 >> 1; local131 < local25; local131++) {
				Static32.aFloatArray6[local131] = 0.0F;
			}
		} else {
			local131 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static32.aFloatArray6;
			@Pc(216) int local216;
			...
			@Pc(252) float[] local252 = local19 ? Static32.aFloatArray11 : Static32.aFloatArray7;
			@Pc(258) float[] local258 = local19 ? Static32.aFloatArray4 : Static32.aFloatArray10;
			@Pc(264) float[] local264 = local19 ? Static32.aFloatArray8 : Static32.aFloatArray9;
			@Pc(270) int[] local270 = local19 ? Static32.anIntArray66 : Static32.anIntArray64;
			@Pc(272) int local272;
			...
			local272 = Static136.method2354(local25 - 1);
			@Pc(488) int local488;
			@Pc(499) int local499;
			@Pc(503) int local503;
			@Pc(505) int local505;
			...
			for (local488 = local59; local488 < local67; local488++) {
				...
				Static32.aFloatArray6[local488] *= (float) Math.sin((double) local309 * 1.5707963267948966D * (double) local309);
			}
		...
		if (this.anInt583 > 0) {
			local176 = this.anInt583 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1257) int local1257;
			if (!this.aBoolean59) {
				for (local212 = 0; local212 < this.anInt587; local212++) {
					local1257 = (this.anInt583 >> 1) + local212;
					local1228[local212] += this.aFloatArray5[local1257];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1257 = local1228.length + local212 - (local25 >> 1);
					local1228[local1257] += Static32.aFloatArray6[local212];
				}
			}
		}
		@Pc(1301) float[] local1301 = this.aFloatArray5;
		this.aFloatArray5 = Static32.aFloatArray6;
		Static32.aFloatArray6 = local1301;
		this.anInt583 = local25;
		this.anInt587 = local104 - (local25 >> 1);
		this.aBoolean59 = local140;
		return local1228;
	}
}
