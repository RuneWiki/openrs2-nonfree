...
public final class Class1_Sub6 extends Class1 {
	...
	private void method486(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub9 local4 = new Class1_Sub9(arg0);
		this.anInt617 = local4.method1273();
		this.anInt612 = local4.method1273();
		this.anInt616 = local4.method1273();
		this.anInt619 = local4.method1273();
		if (this.anInt619 < 0) {
			this.anInt619 = ~this.anInt619;
			this.aBoolean24 = true;
		}
		@Pc(40) int local40 = local4.method1273();
		this.aByteArrayArray1 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method1234();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method1241(local64, local49);
			this.aByteArrayArray1[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!cc", name = "f", descriptor = "(I)[F")
	private float[] method488(@OriginalArg(0) int arg0) {
		Static23.method487(this.aByteArrayArray1[arg0]);
		Static23.method491();
		@Pc(15) int local15 = Static23.method483(Static121.method2476(Static23.anIntArray36.length - 1));
		@Pc(19) boolean local19 = Static23.aBooleanArray1[local15];
		@Pc(25) int local25 = local19 ? Static23.anInt613 : Static23.anInt611;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static23.method491() != 0;
			local29 = Static23.method491() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static23.anInt611 >> 2);
			local67 = (local25 >> 2) + (Static23.anInt611 >> 2);
			local71 = Static23.anInt611 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static23.anInt611 >> 2);
			local104 = local25 + (Static23.anInt611 >> 2) - (local25 >> 2);
			local108 = Static23.anInt611 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class69 local123 = Static23.aClass69Array1[Static23.anIntArray36[local15]];
		@Pc(126) int local126 = local123.anInt3822;
		@Pc(131) int local131 = local123.anIntArray361[local126];
		@Pc(140) boolean local140 = !Static23.aClass44Array1[local131].method2082();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt3823; local144++) {
			@Pc(152) Class31 local152 = Static23.aClass31Array1[local123.anIntArray360[local144]];
			local154 = Static23.aFloatArray2;
			local152.method1474(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt3822;
			local176 = local123.anIntArray361[local171];
			Static23.aClass44Array1[local176].method2080(Static23.aFloatArray2, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static23.aFloatArray2[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static23.aFloatArray2;
			...
			@Pc(252) float[] local252 = local19 ? Static23.aFloatArray1 : Static23.aFloatArray5;
			@Pc(258) float[] local258 = local19 ? Static23.aFloatArray3 : Static23.aFloatArray4;
			@Pc(264) float[] local264 = local19 ? Static23.aFloatArray8 : Static23.aFloatArray7;
			@Pc(270) int[] local270 = local19 ? Static23.anIntArray38 : Static23.anIntArray37;
			...
			@Pc(486) int local486 = Static121.method2476(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static23.aFloatArray2[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static23.aFloatArray2[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt620 > 0) {
			local176 = this.anInt620 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean23) {
				for (local212 = 0; local212 < this.anInt614; local212++) {
					local1254 = (this.anInt620 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static23.aFloatArray2[local212];
				}
			}
		}
		local154 = this.aFloatArray6;
		this.aFloatArray6 = Static23.aFloatArray2;
		Static23.aFloatArray2 = local154;
		this.anInt620 = local25;
		this.anInt614 = local104 - (local25 >> 1);
		this.aBoolean23 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!cc", name = "a", descriptor = "([I)Lclient!qe;")
	public Class1_Sub20_Sub1 method489(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray7 == null) {
			this.anInt620 = 0;
			this.aFloatArray6 = new float[Static23.anInt613];
			this.aByteArray7 = new byte[this.anInt612];
			this.anInt622 = 0;
			this.anInt621 = 0;
		}
		while (this.anInt621 < this.aByteArrayArray1.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method488(this.anInt621);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt622;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt612 - local47) {
					local50 = this.anInt612 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray7[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt622;
				}
				this.anInt622 = local47;
			}
			this.anInt621++;
		}
		this.aFloatArray6 = null;
		@Pc(129) byte[] local129 = this.aByteArray7;
		this.aByteArray7 = null;
		return new Class1_Sub20_Sub1(this.anInt617, local129, this.anInt616, this.anInt619, this.aBoolean24);
	}
}
