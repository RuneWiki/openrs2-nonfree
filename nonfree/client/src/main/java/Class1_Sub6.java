...
public final class Class1_Sub6 extends Class1 {
	...
	private void method754(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub3 local4 = new Class1_Sub3(arg0);
		this.anInt1029 = local4.method1188();
		this.anInt1036 = local4.method1188();
		this.anInt1034 = local4.method1188();
		this.anInt1035 = local4.method1188();
		if (this.anInt1035 < 0) {
			this.anInt1035 = ~this.anInt1035;
			this.aBoolean68 = true;
		}
		@Pc(40) int local40 = local4.method1188();
		this.aByteArrayArray4 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method1171();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method1173(local64, local49);
			this.aByteArrayArray4[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!bt", name = "d", descriptor = "(I)[F")
	private float[] method759(@OriginalArg(0) int arg0) {
		Static40.method764(this.aByteArrayArray4[arg0]);
		Static40.method762();
		@Pc(15) int local15 = Static40.method758(Static256.method1622(Static40.anIntArray104.length - 1));
		@Pc(19) boolean local19 = Static40.aBooleanArray4[local15];
		@Pc(25) int local25 = local19 ? Static40.anInt1033 : Static40.anInt1028;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static40.method762() != 0;
			local29 = Static40.method762() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static40.anInt1028 >> 2);
			local67 = (local25 >> 2) + (Static40.anInt1028 >> 2);
			local71 = Static40.anInt1028 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static40.anInt1028 >> 2);
			local104 = local25 + (Static40.anInt1028 >> 2) - (local25 >> 2);
			local108 = Static40.anInt1028 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class73 local123 = Static40.aClass73Array1[Static40.anIntArray104[local15]];
		@Pc(126) int local126 = local123.anInt2273;
		@Pc(131) int local131 = local123.anIntArray248[local126];
		@Pc(140) boolean local140 = !Static40.aClass166Array1[local131].method3654();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt2272; local144++) {
			@Pc(152) Class71 local152 = Static40.aClass71Array1[local123.anIntArray249[local144]];
			local154 = Static40.aFloatArray9;
			local152.method1631(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt2273;
			local176 = local123.anIntArray248[local171];
			Static40.aClass166Array1[local176].method3655(Static40.aFloatArray9, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static40.aFloatArray9[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static40.aFloatArray9;
			...
			@Pc(252) float[] local252 = local19 ? Static40.aFloatArray6 : Static40.aFloatArray4;
			@Pc(258) float[] local258 = local19 ? Static40.aFloatArray8 : Static40.aFloatArray5;
			@Pc(264) float[] local264 = local19 ? Static40.aFloatArray7 : Static40.aFloatArray10;
			@Pc(270) int[] local270 = local19 ? Static40.anIntArray103 : Static40.anIntArray105;
			...
			@Pc(486) int local486 = Static256.method1622(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static40.aFloatArray9[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static40.aFloatArray9[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt1032 > 0) {
			local176 = this.anInt1032 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean67) {
				for (local212 = 0; local212 < this.anInt1027; local212++) {
					local1254 = (this.anInt1032 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static40.aFloatArray9[local212];
				}
			}
		}
		local154 = this.aFloatArray11;
		this.aFloatArray11 = Static40.aFloatArray9;
		Static40.aFloatArray9 = local154;
		this.anInt1032 = local25;
		this.anInt1027 = local104 - (local25 >> 1);
		this.aBoolean67 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!bt", name = "a", descriptor = "([I)Lclient!mg;")
	public Class1_Sub12_Sub1 method760(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray12 == null) {
			this.anInt1032 = 0;
			this.aFloatArray11 = new float[Static40.anInt1033];
			this.aByteArray12 = new byte[this.anInt1036];
			this.anInt1037 = 0;
			this.anInt1038 = 0;
		}
		while (this.anInt1038 < this.aByteArrayArray4.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method759(this.anInt1038);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt1037;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt1036 - local47) {
					local50 = this.anInt1036 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray12[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt1037;
				}
				this.anInt1037 = local47;
			}
			this.anInt1038++;
		}
		this.aFloatArray11 = null;
		@Pc(129) byte[] local129 = this.aByteArray12;
		this.aByteArray12 = null;
		return new Class1_Sub12_Sub1(this.anInt1029, local129, this.anInt1034, this.anInt1035, this.aBoolean68);
	}
}
