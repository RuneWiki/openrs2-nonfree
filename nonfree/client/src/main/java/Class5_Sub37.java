...
public final class Class5_Sub37 extends Class5 {
	...
	public Class5_Sub37(@OriginalArg(0) byte[] arg0) {
		this.method5946(arg0);
	}

	@OriginalMember(owner = "client!nv", name = "a", descriptor = "([B)V")
	private void method5946(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class5_Sub23 local4 = new Class5_Sub23(arg0);
		this.anInt6952 = local4.method8527();
		this.anInt6946 = local4.method8527();
		this.anInt6950 = local4.method8527();
		this.anInt6947 = local4.method8527();
		if (this.anInt6947 < 0) {
			this.anInt6947 = ~this.anInt6947;
			this.aBoolean533 = true;
		}
		@Pc(40) int local40 = local4.method8527();
		this.aByteArrayArray20 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method8529();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method8487(local64, local49, 0);
			this.aByteArrayArray20[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!nv", name = "a", descriptor = "([I)Lclient!ps;")
	public Class5_Sub24_Sub1 method5949(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray63 == null) {
			this.anInt6955 = 0;
			this.aFloatArray72 = new float[Static406.anInt6953];
			this.aByteArray63 = new byte[this.anInt6946];
			this.anInt6956 = 0;
			this.anInt6957 = 0;
		}
		while (this.anInt6957 < this.aByteArrayArray20.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method5955(this.anInt6957);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt6956;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt6946 - local47) {
					local50 = this.anInt6946 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray63[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt6956;
				}
				this.anInt6956 = local47;
			}
			this.anInt6957++;
		}
		this.aFloatArray72 = null;
		@Pc(129) byte[] local129 = this.aByteArray63;
		this.aByteArray63 = null;
		return new Class5_Sub24_Sub1(this.anInt6952, local129, this.anInt6950, this.anInt6947, this.aBoolean533);
	}

	@OriginalMember(owner = "client!nv", name = "a", descriptor = "(I)[F")
	private float[] method5955(@OriginalArg(0) int arg0) {
		Static406.method5948(this.aByteArrayArray20[arg0]);
		Static406.method5956();
		@Pc(15) int local15 = Static406.method5947(Static197.method8882(Static406.anIntArray404.length - 1));
		@Pc(19) boolean local19 = Static406.aBooleanArray16[local15];
		@Pc(25) int local25 = local19 ? Static406.anInt6953 : Static406.anInt6948;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static406.method5956() != 0;
			local29 = Static406.method5956() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static406.anInt6948 >> 2);
			local67 = (local25 >> 2) + (Static406.anInt6948 >> 2);
			local71 = Static406.anInt6948 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static406.anInt6948 >> 2);
			local104 = local25 + (Static406.anInt6948 >> 2) - (local25 >> 2);
			local108 = Static406.anInt6948 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class212 local123 = Static406.aClass212Array1[Static406.anIntArray404[local15]];
		@Pc(126) int local126 = local123.anInt5952;
		@Pc(131) int local131 = local123.anIntArray330[local126];
		@Pc(140) boolean local140 = !Static406.aClass130Array1[local131].method2578();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt5953; local144++) {
			@Pc(152) Class298 local152 = Static406.aClass298Array1[local123.anIntArray329[local144]];
			local154 = Static406.aFloatArray68;
			local152.method7148(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt5952;
			local176 = local123.anIntArray330[local171];
			Static406.aClass130Array1[local176].method2581(Static406.aFloatArray68, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static406.aFloatArray68[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static406.aFloatArray68;
			...
			@Pc(252) float[] local252 = local19 ? Static406.aFloatArray65 : Static406.aFloatArray66;
			@Pc(258) float[] local258 = local19 ? Static406.aFloatArray67 : Static406.aFloatArray71;
			@Pc(264) float[] local264 = local19 ? Static406.aFloatArray70 : Static406.aFloatArray69;
			@Pc(270) int[] local270 = local19 ? Static406.anIntArray402 : Static406.anIntArray403;
			...
			@Pc(486) int local486 = Static197.method8882(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static406.aFloatArray68[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static406.aFloatArray68[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt6955 > 0) {
			local176 = this.anInt6955 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean535) {
				for (local212 = 0; local212 < this.anInt6951; local212++) {
					local1254 = (this.anInt6955 >> 1) + local212;
					local1228[local212] += this.aFloatArray72[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static406.aFloatArray68[local212];
				}
			}
		}
		local154 = this.aFloatArray72;
		this.aFloatArray72 = Static406.aFloatArray68;
		Static406.aFloatArray68 = local154;
		this.anInt6955 = local25;
		this.anInt6951 = local104 - (local25 >> 1);
		this.aBoolean535 = local140;
		return local1228;
	}
}
