...
public final class Class15_Sub1 extends Class15 {
	...
	@OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(ILclient!hb;)V")
	public Class15_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) Class6_Sub22 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(Lclient!hb;)V")
	public Class15_Sub1(@OriginalArg(0) Class6_Sub22 arg0) {
		super(arg0);
	}
