...
public final class Class21 {
	...
	private void method672(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub20 local4 = new Class1_Sub20(arg0);
		this.anInt947 = local4.method2094();
		this.anInt946 = local4.method2094();
		this.anInt948 = local4.method2094();
		this.anInt945 = local4.method2094();
		if (this.anInt945 < 0) {
			this.anInt945 = ~this.anInt945;
			this.aBoolean33 = true;
		}
		@Pc(40) int local40 = local4.method2094();
		this.aByteArrayArray4 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method2053();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method2077(local49, local64);
			this.aByteArrayArray4[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!f", name = "b", descriptor = "(I)[F")
	private float[] method673(@OriginalArg(0) int arg0) {
		Static35.method669(this.aByteArrayArray4[arg0]);
		Static35.method668();
		@Pc(15) int local15 = Static35.method675(Static28.method601(Static35.anIntArray162.length - 1));
		@Pc(19) boolean local19 = Static35.aBooleanArray13[local15];
		@Pc(25) int local25 = local19 ? Static35.anInt943 : Static35.anInt939;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static35.method668() != 0;
			local29 = Static35.method668() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static35.anInt939 >> 2);
			local67 = (local25 >> 2) + (Static35.anInt939 >> 2);
			local71 = Static35.anInt939 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static35.anInt939 >> 2);
			local104 = local25 + (Static35.anInt939 >> 2) - (local25 >> 2);
			local108 = Static35.anInt939 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class65 local123 = Static35.aClass65Array1[Static35.anIntArray162[local15]];
		@Pc(126) int local126 = local123.anInt2466;
		@Pc(131) int local131 = local123.anIntArray380[local126];
		@Pc(140) boolean local140 = !Static35.aClass44Array1[local131].method1199();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt2467; local144++) {
			@Pc(152) Class56 local152 = Static35.aClass56Array1[local123.anIntArray381[local144]];
			local154 = Static35.aFloatArray3;
			local152.method1582(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt2466;
			local176 = local123.anIntArray380[local171];
			Static35.aClass44Array1[local176].method1201(Static35.aFloatArray3, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static35.aFloatArray3[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static35.aFloatArray3;
			...
			@Pc(252) float[] local252 = local19 ? Static35.aFloatArray1 : Static35.aFloatArray5;
			@Pc(258) float[] local258 = local19 ? Static35.aFloatArray4 : Static35.aFloatArray8;
			@Pc(264) float[] local264 = local19 ? Static35.aFloatArray6 : Static35.aFloatArray7;
			@Pc(270) int[] local270 = local19 ? Static35.anIntArray161 : Static35.anIntArray163;
			...
			@Pc(486) int local486 = Static28.method601(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static35.aFloatArray3[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static35.aFloatArray3[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (Static35.anInt941 > 0) {
			local176 = Static35.anInt941 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1250) int local1250;
			if (!Static35.aBoolean32) {
				for (local212 = 0; local212 < Static35.anInt940; local212++) {
					local1250 = (Static35.anInt941 >> 1) + local212;
					local1228[local212] += Static35.aFloatArray2[local1250];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1250 = local1228.length + local212 - (local25 >> 1);
					local1228[local1250] += Static35.aFloatArray3[local212];
				}
			}
		}
		local154 = Static35.aFloatArray2;
		Static35.aFloatArray2 = Static35.aFloatArray3;
		Static35.aFloatArray3 = local154;
		Static35.anInt941 = local25;
		Static35.anInt940 = local104 - (local25 >> 1);
		Static35.aBoolean32 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!f", name = "c", descriptor = "()Lclient!vb;")
	public Class1_Sub9_Sub1 method678() {
		Static35.anInt941 = 0;
		@Pc(5) byte[] local5 = new byte[this.anInt946];
		@Pc(7) int local7 = 0;
		for (@Pc(9) int local9 = 0; local9 < this.aByteArrayArray4.length; local9++) {
			@Pc(14) float[] local14 = this.method673(local9);
			if (local14 != null) {
				@Pc(19) int local19 = local14.length;
				if (local19 > this.anInt946 - local7) {
					local19 = this.anInt946 - local7;
				}
		...
		return new Class1_Sub9_Sub1(this.anInt947, local5, this.anInt948, this.anInt945, this.aBoolean33);
	}
}
