...
public final class Class37 {
	...
	public Class37() {
		Static85.method1379(24);
		this.anInt1088 = Static85.method1379(16);
		this.anInt1089 = Static85.method1379(24);
		this.anIntArray127 = new int[this.anInt1089];
		@Pc(23) boolean local23 = Static85.method1381() != 0;
		@Pc(27) int local27;
		@Pc(32) int local32;
		@Pc(43) int local43;
		if (local23) {
			local27 = 0;
			local32 = Static85.method1379(5) + 1;
			while (local27 < this.anInt1089) {
				@Pc(41) int local41 = Static85.method1379(Static104.method2060(this.anInt1089 - local27));
			...
			@Pc(66) boolean local66 = Static85.method1381() != 0;
			for (local32 = 0; local32 < this.anInt1089; local32++) {
				if (local66 && Static85.method1381() == 0) {
					this.anIntArray127[local32] = 0;
				} else {
					this.anIntArray127[local32] = Static85.method1379(5) + 1;
				}
			}
		}
		this.method762();
		local27 = Static85.method1379(4);
		if (local27 > 0) {
			@Pc(103) float local103 = Static85.method1377(Static85.method1379(32));
			@Pc(107) float local107 = Static85.method1377(Static85.method1379(32));
			local43 = Static85.method1379(4) + 1;
			@Pc(118) boolean local118 = Static85.method1381() != 0;
			@Pc(127) int local127;
			if (local27 == 1) {
				local127 = Static138.method764(this.anInt1089, this.anInt1088);
			} else {
				local127 = this.anInt1089 * this.anInt1088;
			}
			this.anIntArray128 = new int[local127];
			for (@Pc(140) int local140 = 0; local140 < local127; local140++) {
				this.anIntArray128[local140] = Static85.method1379(local43);
			}
			this.aFloatArrayArray2 = new float[this.anInt1089][this.anInt1088];
			@Pc(163) int local163;
			@Pc(166) float local166;
			@Pc(168) int local168;
			@Pc(170) int local170;
			if (local27 == 1) {
				for (local163 = 0; local163 < this.anInt1089; local163++) {
					local166 = 0.0F;
					local168 = 1;
					for (local170 = 0; local170 < this.anInt1088; local170++) {
			...
			for (local163 = 0; local163 < this.anInt1089; local163++) {
				local166 = 0.0F;
				local168 = local163 * this.anInt1088;
				for (local170 = 0; local170 < this.anInt1088; local170++) {
	...
	private void method762() {
		@Pc(3) int[] local3 = new int[this.anInt1089];
		...
		local14 = 0;
		for (local22 = 0; local22 < this.anInt1089; local22++) {
	...
	public int method763() {
		@Pc(1) int local1;
		for (local1 = 0; this.anIntArray129[local1] >= 0; local1 = Static85.method1381() == 0 ? local1 + 1 : this.anIntArray129[local1]) {
		}
	...
	public float[] method765() {
		return this.aFloatArrayArray2[this.method763()];
	}
}
