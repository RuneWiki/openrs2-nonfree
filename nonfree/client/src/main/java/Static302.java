...
public final class Static302 {
	...
	@OriginalMember(owner = "client!pi", name = "a", descriptor = "(II)Lclient!vl;")
	public static Class2_Sub2 method4325(@OriginalArg(1) int arg0) {
		if (arg0 == 0) {
			...
			return new Class2_Sub2_Sub6_Sub1();
		} else if (arg0 == 19) {
	...
	public static String method4326(@OriginalArg(1) long arg0) {
		if (arg0 <= 0L || arg0 >= 6582952005840035281L) {
			...
			while (arg0 != 0L) {
				...
				arg0 /= 37L;
				local49.append(Static165.aCharArray4[(int) (local53 - arg0 * 37L)]);
			}
