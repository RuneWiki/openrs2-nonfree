...
public final class Class11_Sub18 extends Class11 {
	...
	@OriginalMember(owner = "client!oea", name = "<init>", descriptor = "(Lclient!up;)V")
	public Class11_Sub18(@OriginalArg(0) Class5_Sub46 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!oea", name = "<init>", descriptor = "(ILclient!up;)V")
	public Class11_Sub18(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub46 arg1) {
		super(arg0, arg1);
	}
	...
	public void method8534() {
		if (super.anInt10053 < 0 && super.anInt10053 > 4) {
	...
	protected int method8535() {
		return super.aClass5_Sub46_30.method8195().method2905() > 1 ? 4 : 2;
	}
