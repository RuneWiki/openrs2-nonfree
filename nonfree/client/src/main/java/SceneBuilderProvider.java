...
public final class Class75 implements Interface2 {
	...
	private final Js5Index aClass20_57;
	...
	public Class75(@OriginalArg(0) Js5Index arg0, @OriginalArg(1) Js5Index arg1, @OriginalArg(2) int arg2, @OriginalArg(3) double arg3, @OriginalArg(4) int arg4) {
		...
		this.aClass4_Sub22Array1 = new SceneTextureProvider[arg0.method591(0)];
		for (@Pc(50) int local50 = 0; local50 < local41; local50++) {
			@Pc(63) Packet local63 = new Packet(arg0.method597(0, local38[local50]));
			this.aClass4_Sub22Array1[local38[local50]] = new SceneTextureProvider(local63);
		}
	}
	...
	public void method1849(@OriginalArg(1) int arg0) {
		for (@Pc(3) int local3 = 0; local3 < this.aClass4_Sub22Array1.length; local3++) {
			@Pc(10) SceneTextureProvider local10 = this.aClass4_Sub22Array1[local3];
	...
	public int[] method1846(@OriginalArg(1) int arg0) {
		@Pc(13) SceneTextureProvider local13 = this.aClass4_Sub22Array1[arg0];
		if (local13 != null) {
			...
			if (local38) {
				if (this.anInt2884 == 0) {
					@Pc(49) SceneTextureProvider local49 = (SceneTextureProvider) this.aClass82_12.method2020();
					local49.method1898();
				} else {
					this.anInt2884--;
				}
