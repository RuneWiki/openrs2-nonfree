...
public final class VarPlayerType extends DoublyLinkable {

	@OriginalMember(owner = "client!ie", name = "N", descriptor = "I")
	public int anInt1404 = 0;

	@OriginalMember(owner = "client!ie", name = "b", descriptor = "(Lclient!jd;B)V")
	public void method964(@OriginalArg(0) Packet arg0) {
		while (true) {
	...
	private void method967(@OriginalArg(0) Packet arg0, @OriginalArg(2) int arg1) {
		if (arg1 == 5) {
