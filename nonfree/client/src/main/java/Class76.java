...
public final class Class76 {
	...
	@OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(Lclient!bf;)V", line = 53)
	public Class76(@OriginalArg(0) Class19_Sub1 arg0) {
		...
		if (this.aBoolean160) {
			...
			Static97.aByteBuffer1.get(local24);
			Static97.aByteBuffer1.position(0);
			this.aClass8_Sub4_2 = new Class8_Sub4(arg0, 6410, 128, 128, 16, local24, 6410);
			Static97.aByteBuffer2.get(local24);
			Static97.aByteBuffer2.position(0);
			...
			for (local30 = 0; local30 < 16; local30++) {
				Static97.aByteBuffer1.get(local24, 0, 32768);
			...
			for (local30 = 0; local30 < 16; local30++) {
				Static97.aByteBuffer2.get(local24, 0, 32768);
