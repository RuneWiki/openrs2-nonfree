...
public final class fa extends Class157 implements Interface12 {

	@OriginalMember(owner = "client!fa", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!fa", name = "m", descriptor = "Lclient!sr;")
	private final Class227 aClass227_10 = new Class227();

	@OriginalMember(owner = "client!fa", name = "n", descriptor = "Lclient!w;")
	private final w aW1;
	...
	public void method4945(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aW1.method5804().W(this, arg0, arg1);
	}
	...
	public native void H(@OriginalArg(0) Class1_Sub5_Sub10 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method4950(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aW1.method5804().aa(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public void method4944(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass227_10.method4975()];
		for (@Pc(13) Class1_Sub7 local13 = (Class1_Sub7) this.aClass227_10.method4967(); local13 != null; local13 = (Class1_Sub7) this.aClass227_10.method4973()) {
			local7[local1++] = local13.method5124();
		}
		this.G(local7);
	}
	...
	@OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lclient!bn;[I)V")
	@Override
	public void method4948(@OriginalArg(0) Class1_Sub7 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass227_10.method4972(arg0);
		this.a(arg0.hashCode(), arg0.method5113(), arg0.method5114(), arg0.method5117(), arg0.method5120(), arg0.method5122(), arg1);
	}

	@OriginalMember(owner = "client!fa", name = "ba", descriptor = "(Lclient!i;IIIIZ)V")
	public native void ba(@OriginalArg(0) Class1_Sub5_Sub10 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public native Class1_Sub5_Sub10 OA(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class1_Sub5_Sub10 arg2);
