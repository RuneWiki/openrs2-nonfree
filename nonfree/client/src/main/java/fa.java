...
public final class fa extends Class96 implements Interface1 {

	@OriginalMember(owner = "client!fa", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!fa", name = "k", descriptor = "Lclient!pu;")
	private final Class203 aClass203_12 = new Class203();
	...
	public void method4429(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass203_12.method4552()];
		for (@Pc(13) Class1_Sub4 local13 = (Class1_Sub4) this.aClass203_12.method4548(); local13 != null; local13 = (Class1_Sub4) this.aClass203_12.method4545()) {
			local7[local1++] = local13.method3811();
		}
		this.G(local7);
	}
	...
	public void method4431(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aW1.method5986().aa(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lclient!ja;[I)V")
	@Override
	public void method4430(@OriginalArg(0) Class1_Sub4 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass203_12.method4551(arg0);
		this.a(arg0.hashCode(), arg0.method3813(), arg0.method3810(), arg0.method3809(), arg0.method3805(), arg0.method3808(), arg1);
	}
	...
	public void method4432(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aW1.method5986().W(this, arg0, arg1);
	}
	...
	public native Class1_Sub1_Sub10 OA(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class1_Sub1_Sub10 arg2);
	...
	public native void H(@OriginalArg(0) Class1_Sub1_Sub10 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!fa", name = "ba", descriptor = "(Lclient!i;IIIIZ)V")
	public native void ba(@OriginalArg(0) Class1_Sub1_Sub10 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
}
