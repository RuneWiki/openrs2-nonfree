...
public final class fa extends Class125 implements Interface11 {

	@OriginalMember(owner = "client!fa", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!fa", name = "h", descriptor = "Lclient!nv;")
	private final Class177 aClass177_11 = new Class177();

	@OriginalMember(owner = "client!fa", name = "i", descriptor = "Lclient!w;")
	private final w aW1;
	...
	public native Class5_Sub2_Sub1 OA(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class5_Sub2_Sub1 arg2);
	...
	public void method4993(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aW1.method5892().W(this, arg0, arg1);
	}
	...
	public native void H(@OriginalArg(0) Class5_Sub2_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method4988(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aW1.method5892().aa(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public void method4992(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass177_11.method3620()];
		for (@Pc(13) Class5_Sub19 local13 = (Class5_Sub19) this.aClass177_11.method3618(); local13 != null; local13 = (Class5_Sub19) this.aClass177_11.method3619()) {
			local7[local1++] = local13.method4974();
		}
		this.G(local7);
	}
	...
	public native void ba(@OriginalArg(0) Class5_Sub2_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	@OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lclient!rd;[I)V")
	@Override
	public void method4987(@OriginalArg(0) Class5_Sub19 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass177_11.method3615(arg0);
		this.a(arg0.hashCode(), arg0.method4977(), arg0.method4981(), arg0.method4979(), arg0.method4982(), arg0.method4975(), arg1);
	}
