...
public final class fa extends Class22 implements Interface13 {

	@OriginalMember(owner = "client!fa", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!fa", name = "i", descriptor = "Lclient!nj;")
	private final Class181 aClass181_10 = new Class181();

	@OriginalMember(owner = "client!fa", name = "h", descriptor = "Lclient!w;")
	private final w aW1;
	...
	@OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lclient!as;[I)V")
	@Override
	public void method2321(@OriginalArg(0) Class2_Sub4 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass181_10.method3973(arg0);
		this.a(arg0.hashCode(), arg0.method4087(), arg0.method4081(), arg0.method4092(), arg0.method4089(), arg0.method4084(), arg1);
	}
	...
	public native Class2_Sub1_Sub5 OA(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class2_Sub1_Sub5 arg2);
	...
	public native void H(@OriginalArg(0) Class2_Sub1_Sub5 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method2325(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aW1.method6029().aa(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public void method2328(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass181_10.method3963()];
		for (@Pc(13) Class2_Sub4 local13 = (Class2_Sub4) this.aClass181_10.method3972(); local13 != null; local13 = (Class2_Sub4) this.aClass181_10.method3975()) {
			local7[local1++] = local13.method4085();
		}
		this.G(local7);
	}
	...
	public void method2327(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aW1.method6029().W(this, arg0, arg1);
	}
	...
	public native void ba(@OriginalArg(0) Class2_Sub1_Sub5 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
}
