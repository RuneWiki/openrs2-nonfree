...
public final class fa extends Class162 implements Interface8 {

	@OriginalMember(owner = "client!fa", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!fa", name = "i", descriptor = "Lclient!mg;")
	private final Class156 aClass156_11 = new Class156();

	@OriginalMember(owner = "client!fa", name = "j", descriptor = "Lclient!w;")
	private final w aW1;
	...
	public native void H(@OriginalArg(0) Class2_Sub5_Sub7 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public native Class2_Sub5_Sub7 OA(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class2_Sub5_Sub7 arg2);
	...
	public native void ba(@OriginalArg(0) Class2_Sub5_Sub7 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!fa", name = "ca", descriptor = "(II)I")
	public native int ca(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1);

	@OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lclient!sa;[I)V")
	@Override
	public void method3274(@OriginalArg(0) Class2_Sub29 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass156_11.method3157(arg0);
		this.a(arg0.hashCode(), arg0.method5687(), arg0.method5695(), arg0.method5693(), arg0.method5691(), arg0.method5692(), arg1);
	}
	...
	public void method3271(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aW1.method5570().W(this, arg0, arg1);
	}
	...
	public void method3278(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aW1.method5570().aa(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public void method3277(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass156_11.method3164()];
		for (@Pc(13) Class2_Sub29 local13 = (Class2_Sub29) this.aClass156_11.method3155(); local13 != null; local13 = (Class2_Sub29) this.aClass156_11.method3150()) {
			local7[local1++] = local13.method5694();
		}
		this.G(local7);
	}
