...
public final class fa extends Class154 implements Interface11 {

	@OriginalMember(owner = "client!fa", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!fa", name = "j", descriptor = "Lclient!mf;")
	private final Class163 aClass163_22 = new Class163();

	@OriginalMember(owner = "client!fa", name = "k", descriptor = "Lclient!w;")
	private final w aW1;
	...
	public native void ba(@OriginalArg(0) Class10_Sub1_Sub7 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method6078(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aW1.method5886().W(this, arg0, arg1);
	}
	...
	public void method6075(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.aW1.method5886().aa(this, 0, 0, 1024, arg0, arg1, arg2, arg3, arg4);
	}
	...
	@OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lclient!bk;[I)V")
	@Override
	public void method6079(@OriginalArg(0) Class10_Sub4 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass163_22.method3613(arg0);
		this.a(arg0.hashCode(), arg0.method5354(), arg0.method5365(), arg0.method5362(), arg0.method5355(), arg0.method5361(), arg1);
	}
	...
	public native Class10_Sub1_Sub7 OA(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class10_Sub1_Sub7 arg2);
	...
	public void method6076(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4) {
		@Pc(1) int local1 = 0;
		@Pc(7) float[] local7 = new float[this.aClass163_22.method3614()];
		for (@Pc(13) Class10_Sub4 local13 = (Class10_Sub4) this.aClass163_22.method3620(); local13 != null; local13 = (Class10_Sub4) this.aClass163_22.method3621()) {
			local7[local1++] = local13.method5359();
		}
		this.G(local7);
	}
	...
	public native void H(@OriginalArg(0) Class10_Sub1_Sub7 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
}
