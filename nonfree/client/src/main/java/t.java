...
public final class t extends Class21 implements Interface6 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "m", descriptor = "Lclient!tm;")
	private final Class338 aClass338_210 = new Class338();
	...
	public t(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.anOa3 = arg0;
		this.ga(this.anOa3, arg1, arg2, arg3, super.anIntArrayArray51, arg5, arg6, arg7, arg8);
	}
	...
	public native Class3_Sub11_Sub3 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class3_Sub11_Sub3 arg2);
	...
	public void method7978(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.anInt9130 = arg5;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass338_210.method8164()];
		for (@Pc(16) Class3_Sub15 local16 = (Class3_Sub15) this.aClass338_210.method8177(); local16 != null; local16 = (Class3_Sub15) this.aClass338_210.method8168()) {
			local10[local4++] = local16.method8381();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt9129 && local59 >= 0 && local59 < super.anInt9128) {
						this.method7979(local53, local59);
					}
				}
			}
		}
	...
	public native void wa(@OriginalArg(0) Class3_Sub11_Sub3 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!uca;[I)V")
	@Override
	public void method7975(@OriginalArg(0) Class3_Sub15 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass338_210.method8171(arg0);
		this.V(arg0.hashCode(), arg0.method8384(), arg0.method8380(), arg0.method8383(), arg0.method8378(), arg0.method8377(), arg1);
	}
	...
	public native void CA(@OriginalArg(0) Class3_Sub11_Sub3 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method7979(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt9130 < 0) {
			this.anOa3.method6053().method3(this, arg0, arg1);
		} else {
			this.anOa3.method6053().method14(this, arg0, arg1, this.anInt9130);
		}
	}
	...
	public void method7974(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6053().method2(this, arg0, arg1, arg2, arg3, arg4);
	}
