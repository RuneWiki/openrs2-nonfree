...
public final class t extends Class18 implements Interface4 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "l", descriptor = "Lclient!ow;")
	private final Class271 aClass271_61 = new Class271();
	...
	public void method8533(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt9744 < 0) {
			this.anOa3.method6870().method11(this, arg0, arg1);
		} else {
			this.anOa3.method6870().method4(this, arg0, arg1, this.anInt9744);
		}
	}

	@OriginalMember(owner = "client!t", name = "wa", descriptor = "(Lclient!r;IIIIZ)V")
	public native void wa(@OriginalArg(0) Class2_Sub1_Sub11 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method8535(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.anInt9744 = arg5;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass271_61.method7178()];
		for (@Pc(16) Class2_Sub13 local16 = (Class2_Sub13) this.aClass271_61.method7177(); local16 != null; local16 = (Class2_Sub13) this.aClass271_61.method7175()) {
			local10[local4++] = local16.method9404();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt9741 && local59 >= 0 && local59 < super.anInt9742) {
						this.method8533(local53, local59);
					}
				}
			}
		}
	...
	public native Class2_Sub1_Sub11 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class2_Sub1_Sub11 arg2);
	...
	public void method8534(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6870().method5(this, arg0, arg1, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!t", name = "CA", descriptor = "(Lclient!r;IIIIZ)V")
	public native void CA(@OriginalArg(0) Class2_Sub1_Sub11 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!mfa;[I)V")
	@Override
	public void method8543(@OriginalArg(0) Class2_Sub13 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass271_61.method7174(arg0);
		this.V(arg0.hashCode(), arg0.method9411(), arg0.method9410(), arg0.method9406(), arg0.method9407(), arg0.method9405(), arg1);
	}
}
