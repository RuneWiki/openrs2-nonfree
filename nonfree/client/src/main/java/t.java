...
public final class t extends Class91 implements Interface3 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "q", descriptor = "Lclient!fh;")
	private final Class114 aClass114_43 = new Class114();

	@OriginalMember(owner = "client!t", name = "s", descriptor = "I")
	private int anInt8651 = -1;

	@OriginalMember(owner = "client!t", name = "r", descriptor = "Lclient!oa;")
	...
	public t(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.anOa3 = arg0;
		this.ga(this.anOa3, arg1, arg2, arg3, super.anIntArrayArray104, arg5, arg6, arg7, arg8);
	}
	...
	public void method7448(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt8651 < 0) {
			this.anOa3.method5941().method14(this, arg0, arg1);
		} else {
			this.anOa3.method5941().method8(this, arg0, arg1, this.anInt8651);
		}
	}

	@OriginalMember(owner = "client!t", name = "CA", descriptor = "(Lclient!r;IIIIZ)V")
	public native void CA(@OriginalArg(0) Class2_Sub7_Sub17 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public native void wa(@OriginalArg(0) Class2_Sub7_Sub17 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method7451(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		this.anInt8651 = -1;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass114_43.method2766()];
		for (@Pc(16) Class2_Sub12 local16 = (Class2_Sub12) this.aClass114_43.method2772(); local16 != null; local16 = (Class2_Sub12) this.aClass114_43.method2762()) {
			local10[local4++] = local16.method7422();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt8650 && local59 >= 0 && local59 < super.anInt8645) {
						this.method7448(local53, local59);
					}
				}
			}
		}
	...
	public void method7456(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method5941().method4(this, arg0, arg1, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!laa;[I)V")
	@Override
	public void method7455(@OriginalArg(0) Class2_Sub12 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass114_43.method2771(arg0);
		this.V(arg0.hashCode(), arg0.method7415(), arg0.method7420(), arg0.method7421(), arg0.method7418(), arg0.method7417(), arg1);
	}

	@OriginalMember(owner = "client!t", name = "fa", descriptor = "(IILclient!r;)Lclient!r;")
	public native Class2_Sub7_Sub17 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class2_Sub7_Sub17 arg2);
