...
public final class t extends Class245 implements Interface10 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "k", descriptor = "Lclient!kba;")
	private final Class163 aClass163_55 = new Class163();

	@OriginalMember(owner = "client!t", name = "m", descriptor = "I")
	private int anInt9293 = -1;
	...
	public void method7585(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6192().method14(this, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public void method7579(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.anInt9293 = arg5;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass163_55.method4972()];
		for (@Pc(16) Class6_Sub10 local16 = (Class6_Sub10) this.aClass163_55.method4966(); local16 != null; local16 = (Class6_Sub10) this.aClass163_55.method4965()) {
			local10[local4++] = local16.method5314();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt9289 && local59 >= 0 && local59 < super.anInt9290) {
						this.method7588(local53, local59);
					}
				}
			}
		}
	...
	public native void wa(@OriginalArg(0) Class6_Sub5_Sub10 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!t", name = "fa", descriptor = "(IILclient!r;)Lclient!r;")
	public native Class6_Sub5_Sub10 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class6_Sub5_Sub10 arg2);
	...
	public void method7588(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt9293 < 0) {
			this.anOa3.method6192().method11(this, arg0, arg1);
		} else {
			this.anOa3.method6192().method2(this, arg0, arg1, this.anInt9293);
		}
	}
	...
	public native void CA(@OriginalArg(0) Class6_Sub5_Sub10 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!cba;[I)V")
	@Override
	public void method7584(@OriginalArg(0) Class6_Sub10 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass163_55.method4967(arg0);
		this.V(arg0.hashCode(), arg0.method5312(), arg0.method5321(), arg0.method5320(), arg0.method5316(), arg0.method5319(), arg1);
	}
