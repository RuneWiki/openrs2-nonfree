...
public final class t extends Class133 implements Interface5 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "k", descriptor = "Lclient!cga;")
	private final Class60 aClass60_193 = new Class60();

	@OriginalMember(owner = "client!t", name = "m", descriptor = "I")
	private int anInt9323 = -1;
	...
	public native Class2_Sub6_Sub9 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class2_Sub6_Sub9 arg2);
	...
	public native void CA(@OriginalArg(0) Class2_Sub6_Sub9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method8222(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.anInt9323 = arg5;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass60_193.method1230()];
		for (@Pc(16) Class2_Sub7 local16 = (Class2_Sub7) this.aClass60_193.method1226(7); local16 != null; local16 = (Class2_Sub7) this.aClass60_193.method1228()) {
			local10[local4++] = local16.method8169();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt9318 && local59 >= 0 && local59 < super.anInt9315) {
						this.method8223(local53, local59);
					}
				}
			}
		}
	...
	public void method8219(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6486().method7(this, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public native void wa(@OriginalArg(0) Class2_Sub6_Sub9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method8223(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt9323 < 0) {
			this.anOa3.method6486().method16(this, arg0, arg1);
		} else {
			this.anOa3.method6486().method4(this, arg0, arg1, this.anInt9323);
		}
	}
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!bba;[I)V")
	@Override
	public void method8215(@OriginalArg(0) Class2_Sub7 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass60_193.method1233(arg0);
		this.V(arg0.hashCode(), arg0.method8171(), arg0.method8174(), arg0.method8172(), arg0.method8173(), arg0.method8170(), arg1);
	}
