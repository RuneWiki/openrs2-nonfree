...
public final class t extends Class40 implements Interface10 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "m", descriptor = "Lclient!ro;")
	private final Class306 aClass306_56 = new Class306();

	@OriginalMember(owner = "client!t", name = "n", descriptor = "I")
	private int anInt8913 = -1;
	...
	public void method8439(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6083().method4(this, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public native void wa(@OriginalArg(0) Class5_Sub4_Sub10 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method8446(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		this.anInt8913 = -1;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass306_56.method7306()];
		for (@Pc(16) Class5_Sub27 local16 = (Class5_Sub27) this.aClass306_56.method7313(); local16 != null; local16 = (Class5_Sub27) this.aClass306_56.method7301()) {
			local10[local4++] = local16.method6331();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt9920 && local59 >= 0 && local59 < super.anInt9923) {
						this.method8445(local53, local59);
					}
				}
			}
		}
	...
	public void method8445(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt8913 < 0) {
			this.anOa3.method6083().method11(this, arg0, arg1);
		} else {
			this.anOa3.method6083().method14(this, arg0, arg1, this.anInt8913);
		}
	}
	...
	public native void CA(@OriginalArg(0) Class5_Sub4_Sub10 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!tn;[I)V")
	@Override
	public void method8438(@OriginalArg(0) Class5_Sub27 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass306_56.method7303(arg0);
		this.V(arg0.hashCode(), arg0.method6330(), arg0.method6334(), arg0.method6335(), arg0.method6338(), arg0.method6336(), arg1);
	}
	...
	public native Class5_Sub4_Sub10 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class5_Sub4_Sub10 arg2);
