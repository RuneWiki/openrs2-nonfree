...
public final class t implements Interface5 {
	...
	@OriginalMember(owner = "client!t", name = "g", descriptor = "Lclient!da;")
	private final da aDa2;

	@OriginalMember(owner = "client!t", name = "l", descriptor = "Lclient!j;")
	private final j aJ10;

	@OriginalMember(owner = "client!t", name = "h", descriptor = "Lclient!j;")
	private final j aJ6;
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "Lclient!j;")
	private final j aJ1;
	...
	public native void n(@OriginalArg(0) Class15 arg0, @OriginalArg(1) Class21[] arg1, @OriginalArg(2) Class255 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5);
	...
	public native void N(@OriginalArg(0) Class21 arg0, @OriginalArg(1) Class255 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4);
	...
	public native void ma(@OriginalArg(0) Class4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!t", name = "QA", descriptor = "(Lclient!oa;II)V")
	private native void QA(@OriginalArg(0) Class15 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
	...
	public native void J(@OriginalArg(0) Class4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean[][] arg8);

	@OriginalMember(owner = "client!t", name = "m", descriptor = "(Lclient!oa;Lclient!ba;Lclient!q;[II[I[I[I[S[BI[I)V")
	public native void m(@OriginalArg(0) Class15 arg0, @OriginalArg(1) Class21 arg1, @OriginalArg(2) Class255 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);

	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!j;BIZ)Lclient!ba;")
	public Class21 method7470(@OriginalArg(0) j arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) j local8;
		@Pc(5) j local5;
		if (arg1 == 1) {
			local5 = this.aJ5;
		...
		local8.aClass121Array3 = arg0.aClass121Array3;
		local8.aClass280Array3 = arg0.aClass280Array3;
		return local8;
	}

	@OriginalMember(owner = "client!t", name = "JA", descriptor = "(Lclient!ba;[ILclient!q;)V")
	public native void JA(@OriginalArg(0) Class21 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class255 arg2);

	@OriginalMember(owner = "client!t", name = "w", descriptor = "(Lclient!ba;Lclient!q;[II)V")
	public native void w(@OriginalArg(0) Class21 arg0, @OriginalArg(1) Class255 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3);
	...
	public native void v(@OriginalArg(0) Class15 arg0, @OriginalArg(1) Class21[] arg1, @OriginalArg(2) Class255 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);

	@OriginalMember(owner = "client!t", name = "WA", descriptor = "(Lclient!oa;[I[I[I[SI)V")
	public native void WA(@OriginalArg(0) Class15 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5);
	...
	public native void IA(@OriginalArg(0) Class15 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);

	@OriginalMember(owner = "client!t", name = "o", descriptor = "(Lclient!ba;Lclient!ba;IIIZ)V")
	public native void o(@OriginalArg(0) Class21 arg0, @OriginalArg(1) Class21 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!ba;IILclient!q;Z)Z")
	public native boolean a(@OriginalArg(0) Class21 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class255 arg3, @OriginalArg(4) boolean arg4);
