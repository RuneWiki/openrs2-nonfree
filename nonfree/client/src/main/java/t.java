...
public final class t implements Interface4 {
	...
	@OriginalMember(owner = "client!t", name = "e", descriptor = "Lclient!da;")
	...
	public native void WA(@OriginalArg(0) Class90 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5);

	@OriginalMember(owner = "client!t", name = "IA", descriptor = "(Lclient!oa;IIIIIII)V")
	public native void IA(@OriginalArg(0) Class90 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);

	@OriginalMember(owner = "client!t", name = "ma", descriptor = "(Lclient!d;II)V")
	public native void ma(@OriginalArg(0) Class46 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
	...
	public native void w(@OriginalArg(0) Class24 arg0, @OriginalArg(1) Class93 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3);
	...
	public native void v(@OriginalArg(0) Class90 arg0, @OriginalArg(1) Class24[] arg1, @OriginalArg(2) Class93 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);

	@OriginalMember(owner = "client!t", name = "JA", descriptor = "(Lclient!ba;[ILclient!q;)V")
	public native void JA(@OriginalArg(0) Class24 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class93 arg2);

	@OriginalMember(owner = "client!t", name = "o", descriptor = "(Lclient!ba;Lclient!ba;IIIZ)V")
	public native void o(@OriginalArg(0) Class24 arg0, @OriginalArg(1) Class24 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public Class24 method6848(@OriginalArg(0) j arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) j local8;
		@Pc(5) j local5;
		if (arg1 == 1) {
			local5 = this.aJ3;
		...
		local8.aClass33Array4 = arg0.aClass33Array4;
		local8.aClass335Array4 = arg0.aClass335Array4;
		return local8;
	}

	@OriginalMember(owner = "client!t", name = "J", descriptor = "(Lclient!d;IIIIIII[[Z)V")
	public native void J(@OriginalArg(0) Class46 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean[][] arg8);

	@OriginalMember(owner = "client!t", name = "QA", descriptor = "(Lclient!oa;II)V")
	private native void QA(@OriginalArg(0) Class90 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!ba;IILclient!q;Z)Z")
	public native boolean a(@OriginalArg(0) Class24 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class93 arg3, @OriginalArg(4) boolean arg4);

	@OriginalMember(owner = "client!t", name = "N", descriptor = "(Lclient!ba;Lclient!q;[III)V")
	public native void N(@OriginalArg(0) Class24 arg0, @OriginalArg(1) Class93 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4);
}
