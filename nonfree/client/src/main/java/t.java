...
public final class t extends Class51 implements Interface9 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "m", descriptor = "Lclient!mr;")
	private final Class223 aClass223_56 = new Class223();
	...
	public t(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.anOa3 = arg0;
		this.ga(this.anOa3, arg1, arg2, arg3, super.anIntArrayArray57, arg5, arg6, arg7, arg8);
	}
	...
	public void method7833(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		this.anInt9122 = -1;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass223_56.method5866()];
		for (@Pc(16) Class3_Sub16 local16 = (Class3_Sub16) this.aClass223_56.method5874(); local16 != null; local16 = (Class3_Sub16) this.aClass223_56.method5870()) {
			local10[local4++] = local16.method4785();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt9121 && local59 >= 0 && local59 < super.anInt9115) {
						this.method7830(local53, local59);
					}
				}
			}
		}
	...
	public native void CA(@OriginalArg(0) Class3_Sub4_Sub5 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method7840(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6324().method8(this, arg0, arg1, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!t", name = "wa", descriptor = "(Lclient!r;IIIIZ)V")
	public native void wa(@OriginalArg(0) Class3_Sub4_Sub5 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!t", name = "fa", descriptor = "(IILclient!r;)Lclient!r;")
	public native Class3_Sub4_Sub5 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class3_Sub4_Sub5 arg2);
	...
	public void method7830(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt9122 < 0) {
			this.anOa3.method6324().method4(this, arg0, arg1);
		} else {
			this.anOa3.method6324().method10(this, arg0, arg1, this.anInt9122);
		}
	}
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!wh;[I)V")
	@Override
	public void method7834(@OriginalArg(0) Class3_Sub16 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass223_56.method5868(arg0);
		this.V(arg0.hashCode(), arg0.method4778(), arg0.method4777(), arg0.method4783(), arg0.method4781(), arg0.method4776(), arg1);
	}
