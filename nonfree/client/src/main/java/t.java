...
public final class t extends Class35 implements Interface5 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "l", descriptor = "Lclient!qw;")
	private final Class302 aClass302_64 = new Class302();

	@OriginalMember(owner = "client!t", name = "m", descriptor = "I")
	private int anInt9155 = -1;

	@OriginalMember(owner = "client!t", name = "k", descriptor = "Lclient!oa;")
	...
	public t(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.anOa3 = arg0;
		this.ga(this.anOa3, arg1, arg2, arg3, super.anIntArrayArray54, arg5, arg6, arg7, arg8);
	}
	...
	public void method7456(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method5757().method9(this, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public native void CA(@OriginalArg(0) Class3_Sub5_Sub11 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!t", name = "wa", descriptor = "(Lclient!r;IIIIZ)V")
	public native void wa(@OriginalArg(0) Class3_Sub5_Sub11 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method7458(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		this.anInt9155 = -1;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass302_64.method6608()];
		for (@Pc(16) Class3_Sub13 local16 = (Class3_Sub13) this.aClass302_64.method6603(); local16 != null; local16 = (Class3_Sub13) this.aClass302_64.method6605()) {
			local10[local4++] = local16.method5961();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt9149 && local59 >= 0 && local59 < super.anInt9148) {
						this.method7454(local53, local59);
					}
				}
			}
		}
	...
	public void method7454(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt9155 < 0) {
			this.anOa3.method5757().method15(this, arg0, arg1);
		} else {
			this.anOa3.method5757().method16(this, arg0, arg1, this.anInt9155);
		}
	}
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!uaa;[I)V")
	@Override
	public void method7457(@OriginalArg(0) Class3_Sub13 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass302_64.method6613(arg0);
		this.V(arg0.hashCode(), arg0.method5958(), arg0.method5963(), arg0.method5960(), arg0.method5962(), arg0.method5957(), arg1);
	}

	@OriginalMember(owner = "client!t", name = "fa", descriptor = "(IILclient!r;)Lclient!r;")
	public native Class3_Sub5_Sub11 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class3_Sub5_Sub11 arg2);
