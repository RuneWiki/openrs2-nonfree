...
public final class t extends Class199 implements Interface7 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "r", descriptor = "Lclient!ada;")
	private final Class8 aClass8_62 = new Class8();

	@OriginalMember(owner = "client!t", name = "s", descriptor = "I")
	private int anInt9271 = -1;

	@OriginalMember(owner = "client!t", name = "q", descriptor = "Lclient!oa;")
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!raa;[I)V")
	@Override
	public void method8526(@OriginalArg(0) Class6_Sub1 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass8_62.method157(arg0);
		this.V(arg0.hashCode(), arg0.method8264(), arg0.method8267(), arg0.method8260(), arg0.method8268(), arg0.method8265(), arg1);
	}
	...
	public native Class6_Sub2_Sub16 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class6_Sub2_Sub16 arg2);
	...
	public void method8535(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.anInt9271 = arg5;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass8_62.method150()];
		for (@Pc(16) Class6_Sub1 local16 = (Class6_Sub1) this.aClass8_62.method149(); local16 != null; local16 = (Class6_Sub1) this.aClass8_62.method155()) {
			local10[local4++] = local16.method8266();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt10111 && local59 >= 0 && local59 < super.anInt10110) {
						this.method8528(local53, local59);
					}
				}
			}
		}
	...
	public native void wa(@OriginalArg(0) Class6_Sub2_Sub16 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method8529(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6328().method6(this, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public void method8528(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt9271 < 0) {
			this.anOa3.method6328().method4(this, arg0, arg1);
		} else {
			this.anOa3.method6328().method9(this, arg0, arg1, this.anInt9271);
		}
	}
	...
	public native void CA(@OriginalArg(0) Class6_Sub2_Sub16 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
