...
public final class t extends Class42 implements Interface10 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "m", descriptor = "Lclient!ifa;")
	private final Class163 aClass163_60 = new Class163();
	...
	public t(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.anOa3 = arg0;
		this.ga(this.anOa3, arg1, arg2, arg3, super.anIntArrayArray55, arg5, arg6, arg7, arg8);
	}
	...
	public native void wa(@OriginalArg(0) Class4_Sub5_Sub9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!kp;[I)V")
	@Override
	public void method7451(@OriginalArg(0) Class4_Sub29 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass163_60.method3646(arg0);
		this.V(arg0.hashCode(), arg0.method7627(), arg0.method7630(), arg0.method7628(), arg0.method7632(), arg0.method7633(), arg1);
	}
	...
	public native void CA(@OriginalArg(0) Class4_Sub5_Sub9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!t", name = "fa", descriptor = "(IILclient!r;)Lclient!r;")
	public native Class4_Sub5_Sub9 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class4_Sub5_Sub9 arg2);
	...
	public void method7456(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.anInt8640 = arg5;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass163_60.method3650()];
		for (@Pc(16) Class4_Sub29 local16 = (Class4_Sub29) this.aClass163_60.method3639(); local16 != null; local16 = (Class4_Sub29) this.aClass163_60.method3640()) {
			local10[local4++] = local16.method7626();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt8638 && local59 >= 0 && local59 < super.anInt8630) {
						this.method7449(local53, local59);
					}
				}
			}
		}
	...
	public void method7454(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method5860().method14(this, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public void method7449(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt8640 < 0) {
			this.anOa3.method5860().method13(this, arg0, arg1);
		} else {
			this.anOa3.method5860().method7(this, arg0, arg1, this.anInt8640);
		}
	}
