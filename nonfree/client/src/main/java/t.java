...
public final class t extends Class112 implements Interface8 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "l", descriptor = "Lclient!nt;")
	private final Class238 aClass238_62 = new Class238();

	@OriginalMember(owner = "client!t", name = "n", descriptor = "I")
	private int anInt8914 = -1;
	...
	public t(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.anOa3 = arg0;
		this.ga(this.anOa3, arg1, arg2, arg3, super.anIntArrayArray89, arg5, arg6, arg7, arg8);
	}
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!bh;[I)V")
	@Override
	public void method7820(@OriginalArg(0) Class2_Sub4 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass238_62.method5837(arg0);
		this.V(arg0.hashCode(), arg0.method8150(), arg0.method8158(), arg0.method8151(), arg0.method8154(), arg0.method8152(), arg1);
	}

	@OriginalMember(owner = "client!t", name = "fa", descriptor = "(IILclient!r;)Lclient!r;")
	public native Class2_Sub5_Sub12 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class2_Sub5_Sub12 arg2);

	@OriginalMember(owner = "client!t", name = "wa", descriptor = "(Lclient!r;IIIIZ)V")
	public native void wa(@OriginalArg(0) Class2_Sub5_Sub12 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method7823(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.anInt8914 = arg5;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass238_62.method5842()];
		for (@Pc(16) Class2_Sub4 local16 = (Class2_Sub4) this.aClass238_62.method5833(); local16 != null; local16 = (Class2_Sub4) this.aClass238_62.method5838()) {
			local10[local4++] = local16.method8156();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt9348 && local59 >= 0 && local59 < super.anInt9340) {
						this.method7815(local53, local59);
					}
				}
			}
		}
	...
	public void method7815(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt8914 < 0) {
			this.anOa3.method5964().method12(this, arg0, arg1);
		} else {
			this.anOa3.method5964().method7(this, arg0, arg1, this.anInt8914);
		}
	}
	...
	public void method7821(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method5964().method11(this, arg0, arg1, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!t", name = "CA", descriptor = "(Lclient!r;IIIIZ)V")
	public native void CA(@OriginalArg(0) Class2_Sub5_Sub12 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
