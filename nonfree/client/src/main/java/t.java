...
public final class t extends Class109 implements Interface7 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "n", descriptor = "Lclient!fca;")
	private final Class114 aClass114_60 = new Class114();

	@OriginalMember(owner = "client!t", name = "o", descriptor = "I")
	private int anInt9070 = -1;
	...
	public t(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.anOa3 = arg0;
		this.ga(this.anOa3, arg1, arg2, arg3, super.anIntArrayArray48, arg5, arg6, arg7, arg8);
	}
	...
	public native void wa(@OriginalArg(0) Class5_Sub3_Sub7 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method7698(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		this.anInt9070 = -1;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass114_60.method2811()];
		for (@Pc(16) Class5_Sub18 local16 = (Class5_Sub18) this.aClass114_60.method2805(); local16 != null; local16 = (Class5_Sub18) this.aClass114_60.method2814()) {
			local10[local4++] = local16.method8054();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt9061 && local59 >= 0 && local59 < super.anInt9065) {
						this.method7697(local53, local59);
					}
				}
			}
		}
	...
	public native Class5_Sub3_Sub7 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class5_Sub3_Sub7 arg2);
	...
	public native void CA(@OriginalArg(0) Class5_Sub3_Sub7 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!gu;[I)V")
	@Override
	public void method7694(@OriginalArg(0) Class5_Sub18 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass114_60.method2807(arg0);
		this.V(arg0.hashCode(), arg0.method8055(), arg0.method8051(), arg0.method8057(), arg0.method8056(), arg0.method8058(), arg1);
	}
	...
	public void method7697(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt9070 < 0) {
			this.anOa3.method6114().method1(this, arg0, arg1);
		} else {
			this.anOa3.method6114().method6(this, arg0, arg1, this.anInt9070);
		}
	}
	...
	public void method7700(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6114().method16(this, arg0, arg1, arg2, arg3, arg4);
	}
