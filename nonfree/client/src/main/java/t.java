...
public final class t extends Class84 implements Interface11 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "n", descriptor = "Lclient!at;")
	private final Class20 aClass20_48 = new Class20();

	@OriginalMember(owner = "client!t", name = "p", descriptor = "I")
	private int anInt8888 = -1;

	@OriginalMember(owner = "client!t", name = "o", descriptor = "Lclient!oa;")
	...
	public t(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.anOa3 = arg0;
		this.ga(this.anOa3, arg1, arg2, arg3, super.anIntArrayArray53, arg5, arg6, arg7, arg8);
	}

	@OriginalMember(owner = "client!t", name = "fa", descriptor = "(IILclient!r;)Lclient!r;")
	public native Class5_Sub1_Sub15 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class5_Sub1_Sub15 arg2);
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!ih;[I)V")
	@Override
	public void method7623(@OriginalArg(0) Class5_Sub12 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass20_48.method370(arg0);
		this.V(arg0.hashCode(), arg0.method4537(), arg0.method4533(), arg0.method4534(), arg0.method4531(), arg0.method4530(), arg1);
	}

	@OriginalMember(owner = "client!t", name = "CA", descriptor = "(Lclient!r;IIIIZ)V")
	public native void CA(@OriginalArg(0) Class5_Sub1_Sub15 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!t", name = "a", descriptor = "(II)V")
	@Override
	public void method7621(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt8888 < 0) {
			this.anOa3.method6058().method4(this, arg0, arg1);
		} else {
			this.anOa3.method6058().method13(this, arg0, arg1, this.anInt8888);
		}
	}
	...
	public void method7618(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		this.anInt8888 = -1;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass20_48.method372()];
		for (@Pc(16) Class5_Sub12 local16 = (Class5_Sub12) this.aClass20_48.method378(); local16 != null; local16 = (Class5_Sub12) this.aClass20_48.method366()) {
			local10[local4++] = local16.method4536();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt8883 && local59 >= 0 && local59 < super.anInt8878) {
						this.method7621(local53, local59);
					}
				}
			}
		}
	...
	public native void wa(@OriginalArg(0) Class5_Sub1_Sub15 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method7624(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6058().method8(this, arg0, arg1, arg2, arg3, arg4);
	}
