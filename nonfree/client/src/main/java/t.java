...
public final class t extends Class104 implements Interface6 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "j", descriptor = "Lclient!jia;")
	...
	public t(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.anOa3 = arg0;
		this.ga(this.anOa3, arg1, arg2, arg3, super.anIntArrayArray102, arg5, arg6, arg7, arg8);
	}

	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!bq;[I)V")
	@Override
	public void method8282(@OriginalArg(0) Class3_Sub7 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass193_60.method4462(arg0);
		this.V(arg0.hashCode(), arg0.method6348(), arg0.method6346(), arg0.method6343(), arg0.method6349(), arg0.method6351(), arg1);
	}
	...
	public native void CA(@OriginalArg(0) Class3_Sub6_Sub12 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method8285(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.anInt9046 = arg5;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass193_60.method4463()];
		for (@Pc(16) Class3_Sub7 local16 = (Class3_Sub7) this.aClass193_60.method4457(); local16 != null; local16 = (Class3_Sub7) this.aClass193_60.method4459()) {
			local10[local4++] = local16.method6352();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt9718 && local59 >= 0 && local59 < super.anInt9715) {
						this.method8284(local53, local59);
					}
				}
			}
		}
	...
	public void method8284(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt9046 < 0) {
			this.anOa3.method5926().method14(this, arg0, arg1);
		} else {
			this.anOa3.method5926().method16(this, arg0, arg1, this.anInt9046);
		}
	}

	@OriginalMember(owner = "client!t", name = "wa", descriptor = "(Lclient!r;IIIIZ)V")
	public native void wa(@OriginalArg(0) Class3_Sub6_Sub12 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method8281(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method5926().method3(this, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public native Class3_Sub6_Sub12 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class3_Sub6_Sub12 arg2);
