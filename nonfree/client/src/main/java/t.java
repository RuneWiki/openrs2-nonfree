...
public final class t extends Class86 implements Interface3 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "m", descriptor = "Lclient!bq;")
	private final Class43 aClass43_60 = new Class43();

	@OriginalMember(owner = "client!t", name = "o", descriptor = "I")
	private int anInt9166 = -1;

	@OriginalMember(owner = "client!t", name = "n", descriptor = "Lclient!oa;")
	...
	public t(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.anOa3 = arg0;
		this.ga(this.anOa3, arg1, arg2, arg3, super.anIntArrayArray60, arg5, arg6, arg7, arg8);
	}
	...
	public void method8079(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6139().method12(this, arg0, arg1, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!t", name = "wa", descriptor = "(Lclient!r;IIIIZ)V")
	public native void wa(@OriginalArg(0) Class8_Sub5_Sub11 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method8085(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.anInt9166 = arg5;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass43_60.method1430()];
		for (@Pc(16) Class8_Sub1 local16 = (Class8_Sub1) this.aClass43_60.method1422(); local16 != null; local16 = (Class8_Sub1) this.aClass43_60.method1426()) {
			local10[local4++] = local16.method5205();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt9955 && local59 >= 0 && local59 < super.anInt9953) {
						this.method8087(local53, local59);
					}
				}
			}
		}
	...
	public native void CA(@OriginalArg(0) Class8_Sub5_Sub11 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!ada;[I)V")
	@Override
	public void method8083(@OriginalArg(0) Class8_Sub1 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass43_60.method1424(arg0);
		this.V(arg0.hashCode(), arg0.method5206(), arg0.method5198(), arg0.method5207(), arg0.method5200(), arg0.method5203(), arg1);
	}
	...
	public void method8087(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt9166 < 0) {
			this.anOa3.method6139().method10(this, arg0, arg1);
		} else {
			this.anOa3.method6139().method1(this, arg0, arg1, this.anInt9166);
		}
	}
	...
	public native Class8_Sub5_Sub11 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class8_Sub5_Sub11 arg2);
