...
public final class t implements Interface9 {
	...
	@OriginalMember(owner = "client!t", name = "i", descriptor = "Lclient!da;")
	...
	public native void WA(@OriginalArg(0) Class66 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5);

	@OriginalMember(owner = "client!t", name = "o", descriptor = "(Lclient!ba;Lclient!ba;IIIZ)V")
	public native void o(@OriginalArg(0) Class9 arg0, @OriginalArg(1) Class9 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!t", name = "IA", descriptor = "(Lclient!oa;IIIIIII)V")
	public native void IA(@OriginalArg(0) Class66 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
	...
	private native void QA(@OriginalArg(0) Class66 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
	...
	public native void JA(@OriginalArg(0) Class9 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Class134 arg2);

	@OriginalMember(owner = "client!t", name = "ma", descriptor = "(Lclient!d;II)V")
	public native void ma(@OriginalArg(0) Class16 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!t", name = "n", descriptor = "(Lclient!oa;[Lclient!ba;Lclient!q;[III)V")
	public native void n(@OriginalArg(0) Class66 arg0, @OriginalArg(1) Class9[] arg1, @OriginalArg(2) Class134 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5);

	@OriginalMember(owner = "client!t", name = "w", descriptor = "(Lclient!ba;Lclient!q;[II)V")
	public native void w(@OriginalArg(0) Class9 arg0, @OriginalArg(1) Class134 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3);

	@OriginalMember(owner = "client!t", name = "J", descriptor = "(Lclient!d;IIIIIII[[Z)V")
	public native void J(@OriginalArg(0) Class16 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean[][] arg8);

	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!j;BIZ)Lclient!ba;")
	public Class9 method7062(@OriginalArg(0) j arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) j local8;
		@Pc(5) j local5;
		if (arg1 == 1) {
			local5 = this.aJ10;
		...
		local8.aClass181Array6 = arg0.aClass181Array6;
		local8.aClass89Array6 = arg0.aClass89Array6;
		return local8;
	}
	...
	public native void m(@OriginalArg(0) Class66 arg0, @OriginalArg(1) Class9 arg1, @OriginalArg(2) Class134 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);

	@OriginalMember(owner = "client!t", name = "N", descriptor = "(Lclient!ba;Lclient!q;[III)V")
	public native void N(@OriginalArg(0) Class9 arg0, @OriginalArg(1) Class134 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4);

	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!ba;IILclient!q;Z)Z")
	public native boolean a(@OriginalArg(0) Class9 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class134 arg3, @OriginalArg(4) boolean arg4);
	...
	public native void v(@OriginalArg(0) Class66 arg0, @OriginalArg(1) Class9[] arg1, @OriginalArg(2) Class134 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);
}
