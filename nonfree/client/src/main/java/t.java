...
public final class t extends Class159 implements Interface5 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "q", descriptor = "Lclient!bd;")
	private final Class32 aClass32_63 = new Class32();

	@OriginalMember(owner = "client!t", name = "o", descriptor = "I")
	private int anInt9509 = -1;
	...
	public void method8203(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.anInt9509 = arg5;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass32_63.method589()];
		for (@Pc(16) Class14_Sub18 local16 = (Class14_Sub18) this.aClass32_63.method584(); local16 != null; local16 = (Class14_Sub18) this.aClass32_63.method577()) {
			local10[local4++] = local16.method8339();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt9504 && local59 >= 0 && local59 < super.anInt9506) {
						this.method8204(local53, local59);
					}
				}
			}
		}
	...
	public native Class14_Sub2_Sub5 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class14_Sub2_Sub5 arg2);
	...
	public void method8205(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6390().method16(this, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public void method8204(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt9509 < 0) {
			this.anOa3.method6390().method11(this, arg0, arg1);
		} else {
			this.anOa3.method6390().method13(this, arg0, arg1, this.anInt9509);
		}
	}
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!rfa;[I)V")
	@Override
	public void method8208(@OriginalArg(0) Class14_Sub18 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass32_63.method582(arg0);
		this.V(arg0.hashCode(), arg0.method8342(), arg0.method8344(), arg0.method8341(), arg0.method8343(), arg0.method8345(), arg1);
	}
	...
	public native void wa(@OriginalArg(0) Class14_Sub2_Sub5 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!t", name = "CA", descriptor = "(Lclient!r;IIIIZ)V")
	public native void CA(@OriginalArg(0) Class14_Sub2_Sub5 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
}
