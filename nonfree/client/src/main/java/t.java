...
public final class t extends Class274 implements Interface7 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "m", descriptor = "Lclient!qia;")
	private final Class276 aClass276_55 = new Class276();
	...
	public t(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.anOa3 = arg0;
		this.ga(this.anOa3, arg1, arg2, arg3, super.anIntArrayArray99, arg5, arg6, arg7, arg8);
	}
	...
	public void method8036(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6238().method1(this, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public native Class3_Sub1_Sub6 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class3_Sub1_Sub6 arg2);

	@OriginalMember(owner = "client!t", name = "CA", descriptor = "(Lclient!r;IIIIZ)V")
	public native void CA(@OriginalArg(0) Class3_Sub1_Sub6 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method8037(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt9128 < 0) {
			this.anOa3.method6238().method14(this, arg0, arg1);
		} else {
			this.anOa3.method6238().method5(this, arg0, arg1, this.anInt9128);
		}
	}
	...
	public void method8044(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		this.anInt9128 = -1;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass276_55.method6918()];
		for (@Pc(16) Class3_Sub27 local16 = (Class3_Sub27) this.aClass276_55.method6907(); local16 != null; local16 = (Class3_Sub27) this.aClass276_55.method6912()) {
			local10[local4++] = local16.method5631();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt9726 && local59 >= 0 && local59 < super.anInt9723) {
						this.method8037(local53, local59);
					}
				}
			}
		}
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!pk;[I)V")
	@Override
	public void method8040(@OriginalArg(0) Class3_Sub27 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass276_55.method6906(arg0);
		this.V(arg0.hashCode(), arg0.method5627(), arg0.method5628(), arg0.method5630(), arg0.method5624(), arg0.method5626(), arg1);
	}
	...
	public native void wa(@OriginalArg(0) Class3_Sub1_Sub6 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
