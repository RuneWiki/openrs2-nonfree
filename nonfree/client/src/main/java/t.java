...
public final class t extends Class96 implements Interface12 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "o", descriptor = "Lclient!tf;")
	private final Class340 aClass340_70 = new Class340();

	@OriginalMember(owner = "client!t", name = "q", descriptor = "I")
	private int anInt9205 = -1;

	@OriginalMember(owner = "client!t", name = "p", descriptor = "Lclient!oa;")
	...
	public void method8071(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt9205 < 0) {
			this.anOa3.method6383().method9(this, arg0, arg1);
		} else {
			this.anOa3.method6383().method3(this, arg0, arg1, this.anInt9205);
		}
	}
	...
	public void method8079(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.anInt9205 = arg5;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass340_70.method8128()];
		for (@Pc(16) Class6_Sub10 local16 = (Class6_Sub10) this.aClass340_70.method8124(); local16 != null; local16 = (Class6_Sub10) this.aClass340_70.method8134()) {
			local10[local4++] = local16.method8334();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt9255 && local59 >= 0 && local59 < super.anInt9257) {
						this.method8071(local53, local59);
					}
				}
			}
		}
	...
	public native void wa(@OriginalArg(0) Class6_Sub2_Sub18 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public native Class6_Sub2_Sub18 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class6_Sub2_Sub18 arg2);
	...
	public void method8069(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6383().method16(this, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public native void CA(@OriginalArg(0) Class6_Sub2_Sub18 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!ta;[I)V")
	@Override
	public void method8075(@OriginalArg(0) Class6_Sub10 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass340_70.method8131(arg0);
		this.V(arg0.hashCode(), arg0.method8332(), arg0.method8327(), arg0.method8329(), arg0.method8331(), arg0.method8328(), arg1);
	}
}
