...
public final class t extends Class12 implements Interface7 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "n", descriptor = "Lclient!v;")
	private final Class362 aClass362_60 = new Class362();

	@OriginalMember(owner = "client!t", name = "o", descriptor = "I")
	private int anInt9315 = -1;
	...
	public native void CA(@OriginalArg(0) Class6_Sub4_Sub5 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method7858(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		this.anInt9315 = -1;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass362_60.method8533()];
		for (@Pc(16) Class6_Sub17 local16 = (Class6_Sub17) this.aClass362_60.method8538(); local16 != null; local16 = (Class6_Sub17) this.aClass362_60.method8530()) {
			local10[local4++] = local16.method8524();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt9314 && local59 >= 0 && local59 < super.anInt9313) {
						this.method7847(local53, local59);
					}
				}
			}
		}
	...
	public void method7847(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt9315 < 0) {
			this.anOa3.method5939().method16(this, arg0, arg1);
		} else {
			this.anOa3.method5939().method6(this, arg0, arg1, this.anInt9315);
		}
	}
	...
	public void method7848(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method5939().method11(this, arg0, arg1, arg2, arg3, arg4);
	}

	@OriginalMember(owner = "client!t", name = "fa", descriptor = "(IILclient!r;)Lclient!r;")
	public native Class6_Sub4_Sub5 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class6_Sub4_Sub5 arg2);
	...
	public native void wa(@OriginalArg(0) Class6_Sub4_Sub5 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!sca;[I)V")
	@Override
	public void method7856(@OriginalArg(0) Class6_Sub17 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass362_60.method8536(arg0);
		this.V(arg0.hashCode(), arg0.method8518(), arg0.method8522(), arg0.method8521(), arg0.method8520(), arg0.method8519(), arg1);
	}
}
