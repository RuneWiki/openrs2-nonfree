...
public final class t extends Class313 implements Interface4 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "o", descriptor = "Lclient!tj;")
	private final Class357 aClass357_56 = new Class357();

	@OriginalMember(owner = "client!t", name = "n", descriptor = "I")
	private int anInt9782 = -1;
	...
	public native Class3_Sub4_Sub13 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class3_Sub4_Sub13 arg2);

	@OriginalMember(owner = "client!t", name = "CA", descriptor = "(Lclient!r;IIIIZ)V")
	public native void CA(@OriginalArg(0) Class3_Sub4_Sub13 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method9087(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		this.anInt9782 = -1;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass357_56.method8397()];
		for (@Pc(16) Class3_Sub16 local16 = (Class3_Sub16) this.aClass357_56.method8391(); local16 != null; local16 = (Class3_Sub16) this.aClass357_56.method8392()) {
			local10[local4++] = local16.method6326();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt10875 && local59 >= 0 && local59 < super.anInt10872) {
						this.method9090(local53, local59);
					}
				}
			}
		}
	...
	public native void wa(@OriginalArg(0) Class3_Sub4_Sub13 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method9089(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6531().method10(this, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public void method9090(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt9782 < 0) {
			this.anOa3.method6531().method2(this, arg0, arg1);
		} else {
			this.anOa3.method6531().method8(this, arg0, arg1, this.anInt9782);
		}
	}
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!vj;[I)V")
	@Override
	public void method9097(@OriginalArg(0) Class3_Sub16 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass357_56.method8401(arg0);
		this.V(arg0.hashCode(), arg0.method6323(), arg0.method6322(), arg0.method6320(), arg0.method6324(), arg0.method6325(), arg1);
	}
