...
public final class t extends Class22 implements Interface3 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "l", descriptor = "Lclient!ef;")
	private final Class102 aClass102_67 = new Class102();

	@OriginalMember(owner = "client!t", name = "m", descriptor = "I")
	private int anInt9379 = -1;
	...
	public t(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.anOa3 = arg0;
		this.ga(this.anOa3, arg1, arg2, arg3, super.anIntArrayArray52, arg5, arg6, arg7, arg8);
	}
	...
	public void method8040(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		this.anInt9379 = -1;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass102_67.method1927()];
		for (@Pc(16) Class5_Sub43 local16 = (Class5_Sub43) this.aClass102_67.method1916(); local16 != null; local16 = (Class5_Sub43) this.aClass102_67.method1915()) {
			local10[local4++] = local16.method8250();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt9376 && local59 >= 0 && local59 < super.anInt9375) {
						this.method8033(local53, local59);
					}
				}
			}
		}
	...
	public native void CA(@OriginalArg(0) Class5_Sub5_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method8033(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt9379 < 0) {
			this.anOa3.method6108().method4(this, arg0, arg1);
		} else {
			this.anOa3.method6108().method12(this, arg0, arg1, this.anInt9379);
		}
	}
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!uf;[I)V")
	@Override
	public void method8043(@OriginalArg(0) Class5_Sub43 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass102_67.method1921(arg0);
		this.V(arg0.hashCode(), arg0.method8251(), arg0.method8257(), arg0.method8255(), arg0.method8254(), arg0.method8253(), arg1);
	}
	...
	public void method8035(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6108().method1(this, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public native void wa(@OriginalArg(0) Class5_Sub5_Sub4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public native Class5_Sub5_Sub4 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class5_Sub5_Sub4 arg2);
