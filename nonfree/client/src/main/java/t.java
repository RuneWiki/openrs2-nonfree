...
public final class t extends Class91 implements Interface8 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "l", descriptor = "Lclient!mba;")
	private final Class216 aClass216_63 = new Class216();
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!tj;[I)V")
	@Override
	public void method7722(@OriginalArg(0) Class3_Sub22 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass216_63.method5449(arg0);
		this.V(arg0.hashCode(), arg0.method8391(), arg0.method8383(), arg0.method8386(), arg0.method8382(), arg0.method8384(), arg1);
	}
	...
	public void method7719(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5) {
		this.anInt8990 = -1;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass216_63.method5460()];
		for (@Pc(16) Class3_Sub22 local16 = (Class3_Sub22) this.aClass216_63.method5457(); local16 != null; local16 = (Class3_Sub22) this.aClass216_63.method5458()) {
			local10[local4++] = local16.method8387();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt8983 && local59 >= 0 && local59 < super.anInt8985) {
						this.method7717(local53, local59);
					}
				}
			}
		}
	...
	public void method7721(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6184().method3(this, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public void method7717(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt8990 < 0) {
			this.anOa3.method6184().method12(this, arg0, arg1);
		} else {
			this.anOa3.method6184().method11(this, arg0, arg1, this.anInt8990);
		}
	}
