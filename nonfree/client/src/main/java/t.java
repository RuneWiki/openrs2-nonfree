...
public final class t extends Class88 implements Interface5 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "l", descriptor = "Lclient!ga;")
	private final Class124 aClass124_90 = new Class124();

	@OriginalMember(owner = "client!t", name = "n", descriptor = "I")
	private int anInt9061 = -1;
	...
	public t(@OriginalArg(0) oa arg0, @OriginalArg(1) ya arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int[][] arg4, @OriginalArg(5) int[][] arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		...
		this.anOa3 = arg0;
		this.ga(this.anOa3, arg1, arg2, arg3, super.anIntArrayArray92, arg5, arg6, arg7, arg8);
	}
	...
	public void method8752(@OriginalArg(0) Class5_Sub3 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass124_90.method2574(arg0);
		this.V(arg0.hashCode(), arg0.method8317(), arg0.method8313(), arg0.method8323(), arg0.method8319(), arg0.method8322(), arg1);
	}
	...
	public void method8751(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.anInt9061 = arg5;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass124_90.method2568()];
		for (@Pc(16) Class5_Sub3 local16 = (Class5_Sub3) this.aClass124_90.method2572(); local16 != null; local16 = (Class5_Sub3) this.aClass124_90.method2569()) {
			local10[local4++] = local16.method8314();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt10541 && local59 >= 0 && local59 < super.anInt10545) {
						this.method8750(local53, local59);
					}
				}
			}
		}
	...
	public native void wa(@OriginalArg(0) Class5_Sub2_Sub7 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public native Class5_Sub2_Sub7 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class5_Sub2_Sub7 arg2);

	@OriginalMember(owner = "client!t", name = "a", descriptor = "(II)V")
	@Override
	public void method8750(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt9061 < 0) {
			this.anOa3.method6064().method4(this, arg0, arg1);
		} else {
			this.anOa3.method6064().method6(this, arg0, arg1, this.anInt9061);
		}
	}

	@OriginalMember(owner = "client!t", name = "CA", descriptor = "(Lclient!r;IIIIZ)V")
	public native void CA(@OriginalArg(0) Class5_Sub2_Sub7 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public void method8745(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6064().method13(this, arg0, arg1, arg2, arg3, arg4);
	}
}
