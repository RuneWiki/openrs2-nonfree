...
public final class t extends Class51 implements Interface6 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "k", descriptor = "Lclient!ok;")
	private final Class262 aClass262_64 = new Class262();

	@OriginalMember(owner = "client!t", name = "m", descriptor = "I")
	private int anInt9513 = -1;
	...
	public native void CA(@OriginalArg(0) Class14_Sub3_Sub14 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!qm;[I)V")
	@Override
	public void method7859(@OriginalArg(0) Class14_Sub37 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass262_64.method6314(arg0);
		this.V(arg0.hashCode(), arg0.method7827(), arg0.method7823(), arg0.method7826(), arg0.method7819(), arg0.method7820(), arg1);
	}
	...
	public void method7865(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt9513 < 0) {
			this.anOa3.method6171().method14(this, arg0, arg1);
		} else {
			this.anOa3.method6171().method7(this, arg0, arg1, this.anInt9513);
		}
	}
	...
	public void method7863(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6171().method12(this, arg0, arg1, arg2, arg3, arg4);
	}
	...
	public void method7864(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.anInt9513 = arg5;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass262_64.method6322()];
		for (@Pc(16) Class14_Sub37 local16 = (Class14_Sub37) this.aClass262_64.method6318(); local16 != null; local16 = (Class14_Sub37) this.aClass262_64.method6311()) {
			local10[local4++] = local16.method7825();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt9511 && local59 >= 0 && local59 < super.anInt9512) {
						this.method7865(local53, local59);
					}
				}
			}
		}
	...
	public native Class14_Sub3_Sub14 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class14_Sub3_Sub14 arg2);
	...
	public native void wa(@OriginalArg(0) Class14_Sub3_Sub14 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
