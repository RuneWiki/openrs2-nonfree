...
public final class t extends Class65 implements Interface8 {

	@OriginalMember(owner = "client!t", name = "nativeid", descriptor = "J")
	public long nativeid;

	@OriginalMember(owner = "client!t", name = "k", descriptor = "Lclient!uh;")
	private final Class341 aClass341_63 = new Class341();

	@OriginalMember(owner = "client!t", name = "m", descriptor = "I")
	private int anInt9622 = -1;
	...
	public void method7997(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean[][] arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		this.anInt9622 = arg5;
		@Pc(4) int local4 = 0;
		@Pc(10) float[] local10 = new float[this.aClass341_63.method8527()];
		for (@Pc(16) Class2_Sub1 local16 = (Class2_Sub1) this.aClass341_63.method8524(); local16 != null; local16 = (Class2_Sub1) this.aClass341_63.method8519()) {
			local10[local4++] = local16.method3966();
		}
		this.q(local10);
		for (@Pc(37) int local37 = 0; local37 < arg2 + arg2; local37++) {
			for (@Pc(40) int local40 = 0; local40 < arg2 + arg2; local40++) {
				if (arg3[local37][local40]) {
					...
					if (local53 >= 0 && local53 < super.anInt9615 && local59 >= 0 && local59 < super.anInt9618) {
						this.method7992(local53, local59);
					}
				}
			}
		}
	...
	public native void wa(@OriginalArg(0) Class2_Sub6_Sub7 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);

	@OriginalMember(owner = "client!t", name = "a", descriptor = "(II)V")
	@Override
	public void method7992(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (this.anInt9622 < 0) {
			this.anOa3.method6405().method1(this, arg0, arg1);
		} else {
			this.anOa3.method6405().method6(this, arg0, arg1, this.anInt9622);
		}
	}
	...
	@OriginalMember(owner = "client!t", name = "a", descriptor = "(Lclient!ab;[I)V")
	@Override
	public void method7994(@OriginalArg(0) Class2_Sub1 arg0, @OriginalArg(1) int[] arg1) {
		this.aClass341_63.method8528(arg0);
		this.V(arg0.hashCode(), arg0.method3969(), arg0.method3967(), arg0.method3962(), arg0.method3968(), arg0.method3965(), arg1);
	}

	@OriginalMember(owner = "client!t", name = "CA", descriptor = "(Lclient!r;IIIIZ)V")
	public native void CA(@OriginalArg(0) Class2_Sub6_Sub7 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public native Class2_Sub6_Sub7 fa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Class2_Sub6_Sub7 arg2);
	...
	public void method8000(@OriginalArg(3) int arg0, @OriginalArg(4) int arg1, @OriginalArg(5) int arg2, @OriginalArg(6) int arg3, @OriginalArg(7) boolean[][] arg4) {
		this.anOa3.method6405().method7(this, arg0, arg1, arg2, arg3, arg4);
	}
}
