...
public final class Class73 {
	...
	public final int[] anIntArray296;
	...
	public Class73(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18) {
		...
		this.anInt3253 = arg0;
		this.anInt3251 = arg1;
		this.anInt3252 = arg17;
		this.anInt3250 = arg18;
		@Pc(30) short local30 = 128;
		@Pc(34) int local34 = local30 / 2;
		@Pc(38) int local38 = local30 / 4;
		@Pc(44) int local44 = local30 * 3 / 4;
		@Pc(48) int[] local48 = Static144.anIntArrayArray31[arg0];
		@Pc(51) int local51 = local48.length;
		this.anIntArray308 = new int[local51];
		this.anIntArray297 = new int[local51];
		this.anIntArray294 = new int[local51];
		...
		for (@Pc(79) int local79 = 0; local79 < local51; local79++) {
			...
			this.anIntArray308[local79] = local140;
			this.anIntArray297[local79] = local144;
			this.anIntArray294[local79] = local142;
			local66[local79] = local146;
			local69[local79] = local148;
		}
		@Pc(534) int[] local534 = Static144.anIntArrayArray30[arg0];
		local140 = local534.length / 4;
		this.anIntArray299 = new int[local140];
		this.anIntArray300 = new int[local140];
		this.anIntArray304 = new int[local140];
		this.anIntArray296 = new int[local140];
		this.anIntArray301 = new int[local140];
		this.anIntArray305 = new int[local140];
		if (arg2 != -1) {
			this.anIntArray306 = new int[local140];
		}
		local142 = 0;
		for (local144 = 0; local144 < local140; local144++) {
			...
			this.anIntArray299[local144] = local148;
			this.anIntArray300[local144] = local591;
			this.anIntArray304[local144] = local597;
			if (local146 == 0) {
				this.anIntArray296[local144] = local66[local148];
				this.anIntArray301[local144] = local66[local591];
				this.anIntArray305[local144] = local66[local597];
				if (this.anIntArray306 != null) {
					this.anIntArray306[local144] = -1;
				}
			} else {
				this.anIntArray296[local144] = local69[local148];
				this.anIntArray301[local144] = local69[local591];
				this.anIntArray305[local144] = local69[local597];
				if (this.anIntArray306 != null) {
					this.anIntArray306[local144] = arg2;
				}
			}
		}
		local146 = arg5;
