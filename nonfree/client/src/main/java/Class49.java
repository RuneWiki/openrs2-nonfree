...
public final class Class49 {
	...
	private static boolean aBoolean249 = true;

	@OriginalMember(owner = "client!zb", name = "b", descriptor = "I")
	private static int anInt1036 = -31809;
	...
	public static String method683(@OriginalArg(0) int arg0, @OriginalArg(1) Class1_Sub1_Sub3 arg1) {
		try {
			...
			signlink.reporterror("3424, " + arg0 + ", " + arg1 + ", " + 9 + ", " + local157.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!zb", name = "a", descriptor = "(Lclient!lb;Ljava/lang/String;Z)V")
	public static void method684(@OriginalArg(0) Class1_Sub1_Sub3 arg0, @OriginalArg(1) String arg1) {
		try {
			if (arg1.length() > 80) {
			...
			signlink.reporterror("30011, " + arg0 + ", " + arg1 + ", " + false + ", " + local108.toString());
			throw new RuntimeException();
		}
	}
	...
	public static String method685(@OriginalArg(1) String arg0) {
		try {
			...
			aClass1_Sub1_Sub3_8.anInt742 = 0;
			return method683(local11, aClass1_Sub1_Sub3_8);
		} catch (@Pc(33) RuntimeException local33) {
			signlink.reporterror("18253, " + -212 + ", " + arg0 + ", " + local33.toString());
			throw new RuntimeException();
		}
	}
}
