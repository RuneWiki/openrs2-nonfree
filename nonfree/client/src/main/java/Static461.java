...
public final class Static461 {
	...
	@OriginalMember(owner = "client!os", name = "a", descriptor = "(Lclient!eb;II)Lclient!os;")
	public static Class3_Sub5_Sub3 method4330(@OriginalArg(0) Class3_Sub13_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray24 == null || arg0.aByteArray24.length == 0 ? null : new Class3_Sub5_Sub3(arg0, (int) ((long) arg0.anInt1849 * 256L * (long) 100 / (long) (Static94.anInt2028 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!os", name = "a", descriptor = "([B[IIIIIIIILclient!os;)I")
	public static int method4333(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub5_Sub3 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt5409 += arg8.anInt5406 * (local24 - arg3);
		arg8.anInt5408 += arg8.anInt5400 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt5396 = arg4 >> 2;
		arg8.anInt5403 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!os", name = "a", descriptor = "([B[IIIIIIILclient!os;)I")
	public static int method4335(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub5_Sub3 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt5403 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!os", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!os;)I")
	public static int method4337(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub5_Sub3 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt5396 += arg10.anInt5404 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt5409 = arg4 >> 2;
		arg10.anInt5408 = arg5 >> 2;
		arg10.anInt5403 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!os", name = "a", descriptor = "(I[B[IIIIIIIILclient!os;)I")
	public static int method4338(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub5_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!os", name = "a", descriptor = "(Lclient!eb;III)Lclient!os;")
	public static Class3_Sub5_Sub3 method4339(@OriginalArg(0) Class3_Sub13_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray24 == null || arg0.aByteArray24.length == 0 ? null : new Class3_Sub5_Sub3(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!os", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!os;II)I")
	public static int method4343(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub5_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt5396 -= arg10.anInt5404 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt5396 += arg10.anInt5404 * local63;
		arg10.anInt5409 = arg4;
		arg10.anInt5408 = arg5;
		arg10.anInt5403 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!os", name = "b", descriptor = "([B[IIIIIIILclient!os;)I")
	public static int method4344(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub5_Sub3 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!os", name = "b", descriptor = "([B[IIIIIIIILclient!os;)I")
	public static int method4345(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub5_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt5409 += arg8.anInt5406 * (local22 - arg3);
		arg8.anInt5408 += arg8.anInt5400 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
	...
	@OriginalMember(owner = "client!os", name = "a", descriptor = "(II[B[IIIIIIIILclient!os;II)I")
	public static int method4347(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub5_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!os", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!os;)I")
	public static int method4351(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub5_Sub3 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt5396 += arg10.anInt5404 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!os", name = "b", descriptor = "(I[B[IIIIIIIILclient!os;)I")
	public static int method4352(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub5_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!os", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!os;II)I")
	public static int method4353(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub5_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt5396 -= arg10.anInt5404 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!os", name = "b", descriptor = "(II[B[IIIIIIIILclient!os;II)I")
	public static int method4355(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub5_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt5409 -= arg8.anInt5406 * arg3;
		arg8.anInt5408 -= arg8.anInt5400 * arg3;
		@Pc(32) int local32;
	...
	public static int method4357(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!os", name = "a", descriptor = "(II[B[IIIIIIILclient!os;II)I")
	public static int method4359(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub5_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!os", name = "b", descriptor = "(II[B[IIIIIIILclient!os;II)I")
	public static int method4361(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub5_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!os", name = "c", descriptor = "(II[B[IIIIIIIILclient!os;II)I")
	public static int method4363(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub5_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt5409 -= arg8.anInt5406 * arg3;
		arg8.anInt5408 -= arg8.anInt5400 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!os", name = "d", descriptor = "(II[B[IIIIIIIILclient!os;II)I")
	public static int method4365(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub5_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
