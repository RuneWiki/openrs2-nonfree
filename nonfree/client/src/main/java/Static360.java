...
public final class Static360 {
	...
	@OriginalMember(owner = "client!en", name = "a", descriptor = "(II[B[IIIIIIIILclient!en;II)I")
	public static int method1694(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub3_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1635 -= arg8.anInt1643 * arg3;
		arg8.anInt1647 -= arg8.anInt1648 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!en", name = "a", descriptor = "(II[B[IIIIIIILclient!en;II)I")
	public static int method1695(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub3_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!en", name = "a", descriptor = "(Lclient!vo;II)Lclient!en;")
	public static Class2_Sub3_Sub2 method1696(@OriginalArg(0) Class2_Sub12_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray90 == null || arg0.aByteArray90.length == 0 ? null : new Class2_Sub3_Sub2(arg0, (int) ((long) arg0.anInt6730 * 256L * (long) 100 / (long) (Static65.anInt1429 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!en", name = "a", descriptor = "(I[B[IIIIIIIILclient!en;)I")
	public static int method1702(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub3_Sub2 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt1636 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!en", name = "a", descriptor = "([B[IIIIIIIILclient!en;)I")
	public static int method1704(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub3_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1635 += arg8.anInt1643 * (local22 - arg3);
		arg8.anInt1647 += arg8.anInt1648 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt1640 = arg4 >> 2;
		arg8.anInt1636 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!en", name = "b", descriptor = "(I[B[IIIIIIIILclient!en;)I")
	public static int method1710(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub3_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!en", name = "a", descriptor = "([B[IIIIIIILclient!en;)I")
	public static int method1713(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub3_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt1636 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!en", name = "b", descriptor = "(II[B[IIIIIIIILclient!en;II)I")
	public static int method1714(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub3_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!en", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!en;)I")
	public static int method1715(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub3_Sub2 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt1640 += arg10.anInt1639 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt1635 = arg4 >> 2;
		arg10.anInt1647 = arg5 >> 2;
		arg10.anInt1636 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!en", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!en;II)I")
	public static int method1717(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub3_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1640 -= arg10.anInt1639 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt1640 += arg10.anInt1639 * local63;
		arg10.anInt1635 = arg4;
		arg10.anInt1647 = arg5;
		arg10.anInt1636 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!en", name = "b", descriptor = "([B[IIIIIIILclient!en;)I")
	public static int method1720(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub3_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!en", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!en;II)I")
	public static int method1721(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub3_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt1640 -= arg10.anInt1639 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!en", name = "b", descriptor = "(II[B[IIIIIIILclient!en;II)I")
	public static int method1722(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub3_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!en", name = "c", descriptor = "(II[B[IIIIIIIILclient!en;II)I")
	public static int method1724(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub3_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!en", name = "a", descriptor = "(Lclient!vo;III)Lclient!en;")
	public static Class2_Sub3_Sub2 method1725(@OriginalArg(0) Class2_Sub12_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray90 == null || arg0.aByteArray90.length == 0 ? null : new Class2_Sub3_Sub2(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!en", name = "d", descriptor = "(II[B[IIIIIIIILclient!en;II)I")
	public static int method1727(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub3_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt1635 -= arg8.anInt1643 * arg3;
		arg8.anInt1647 -= arg8.anInt1648 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!en", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!en;)I")
	public static int method1729(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub3_Sub2 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt1640 += arg10.anInt1639 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	public static int method1731(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!en", name = "b", descriptor = "([B[IIIIIIIILclient!en;)I")
	public static int method1732(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub3_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt1635 += arg8.anInt1643 * (local24 - arg3);
		arg8.anInt1647 += arg8.anInt1648 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
