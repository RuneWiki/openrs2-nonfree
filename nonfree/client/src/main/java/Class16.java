...
public final class Class16 {
	...
	@OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V")
	...
	@OriginalMember(owner = "client!dc", name = "a", descriptor = "(BII[B)V")
	...
	@OriginalMember(owner = "client!dc", name = "c", descriptor = "(I)Ljava/io/File;")
