...
public final class Class16 {
	...
	public Class16(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) byte arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18, @OriginalArg(19) int arg19) {
		try {
			if (arg13 != arg14 || arg13 != arg10 || arg13 != arg15) {
			...
			@Pc(50) int[] local50 = anIntArrayArray16[arg8];
			...
			@Pc(75) int local75 = arg2 * local32;
			...
			for (@Pc(81) int local81 = 0; local81 < local53; local81++) {
				...
				if ((local87 & 0x1) == 0 && local87 <= 8) {
					local87 = (local87 - arg4 - arg4 - 1 & 0x7) + 1;
				}
				if (local87 > 8 && local87 <= 12) {
					local87 = (local87 - arg4 - 9 & 0x3) + 9;
				}
				if (local87 > 12 && local87 <= 16) {
					local87 = (local87 - arg4 - 13 & 0x3) + 13;
				}
				if (local87 == 1) {
					local143 = local75;
					local145 = local79;
					...
					local147 = arg14 + arg10 >> 1;
					local149 = arg6 + arg12 >> 1;
					local151 = arg17 + arg9 >> 1;
				} else if (local87 == 5) {
					local143 = local75 + local32;
					...
					local143 = local75 + local36;
					local145 = local79 + local32;
					local147 = arg10 + arg15 >> 1;
					local149 = arg12 + arg3 >> 1;
					local151 = arg9 + arg16 >> 1;
				} else if (local87 == 7) {
					local143 = local75;
					local145 = local79 + local32;
					local147 = arg15;
					...
					local143 = local75;
					local145 = local79 + local36;
					local147 = arg15 + arg13 >> 1;
					local149 = arg3 + arg7 >> 1;
					local151 = arg16 + arg1 >> 1;
				} else if (local87 == 9) {
					local143 = local75 + local36;
			...
			@Pc(552) int[] local552 = anIntArrayArray17[arg8];
			...
			for (local147 = 0; local147 < local143; local147++) {
				...
				local145 += 4;
				if (local151 < 4) {
					local151 = local151 - arg4 & 0x3;
				}
				if (local617 < 4) {
					local617 = local617 - arg4 & 0x3;
				}
				if (local623 < 4) {
					local623 = local623 - arg4 & 0x3;
				}
				...
				if (local149 == 0) {
					...
					if (this.anIntArray167 != null) {
						this.anIntArray167[local147] = arg11;
					}
				}
			}
			local149 = arg13;
			...
			signlink.reporterror("39763, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + arg3 + ", " + arg4 + ", " + arg5 + ", " + arg6 + ", " + arg7 + ", " + arg8 + ", " + arg9 + ", " + arg10 + ", " + arg11 + ", " + arg12 + ", " + arg13 + ", " + arg14 + ", " + arg15 + ", " + arg16 + ", " + arg17 + ", " + arg18 + ", " + arg19 + ", " + local784.toString());
