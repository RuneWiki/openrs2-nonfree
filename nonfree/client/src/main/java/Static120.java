...
public final class Static120 {
	...
	public static int method933(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub4_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!j", name = "a", descriptor = "(II[B[IIIIIIIIILclient!j;II)I")
	public static int method935(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) Class1_Sub4_Sub2 arg9, @OriginalArg(13) int arg10, @OriginalArg(14) int arg11) {
		@Pc(14) int local14;
	...
	public static int method936(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class1_Sub4_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!j", name = "a", descriptor = "(Lclient!te;II)Lclient!j;")
	public static Class1_Sub4_Sub2 method938(@OriginalArg(0) Class1_Sub9_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray15 == null || arg0.aByteArray15.length == 0 ? null : new Class1_Sub4_Sub2(arg0, (int) ((long) arg0.anInt2570 * 256L * (long) 100 / (long) (Static109.anInt2826 * 100)), arg1);
	}

	@OriginalMember(owner = "client!j", name = "a", descriptor = "([B[IIIIIIIIILclient!j;)I")
	public static int method940(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class1_Sub4_Sub2 arg9) {
		arg2 >>= 0x8;
		...
		arg9.anInt1503 = arg4 >> 8;
		arg9.anInt1505 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!j", name = "a", descriptor = "([B[IIIIIIILclient!j;)I")
	public static int method941(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub4_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt1505 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!j", name = "b", descriptor = "([B[IIIIIIIIILclient!j;)I")
	public static int method942(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class1_Sub4_Sub2 arg9) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg8 >> 8;
		arg4 <<= 0x8;
		@Pc(15) int local15 = arg6 << 8;
	...
	public static int method943(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class1_Sub4_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 8;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!j", name = "b", descriptor = "(II[B[IIIIIIIIILclient!j;II)I")
	public static int method945(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) Class1_Sub4_Sub2 arg9, @OriginalArg(13) int arg10, @OriginalArg(14) int arg11) {
		@Pc(14) int local14;
