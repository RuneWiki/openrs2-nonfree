...
public final class Class66 implements Interface1 {

	@OriginalMember(owner = "client!ib", name = "a", descriptor = "Z")
	private boolean aBoolean173 = false;

	@OriginalMember(owner = "client!ib", name = "c", descriptor = "[I")
	private int[] anIntArray217 = null;

	@OriginalMember(owner = "client!ib", name = "b", descriptor = "I")
	private int anInt2476 = -1;

	@OriginalMember(owner = "client!ib", name = "<init>", descriptor = "()V")
	public Class66() {
		if (Static277.aBoolean407 && Static277.anInt5352 >= 2) {
			this.method1958();
			@Pc(19) GL local19 = Static277.aGL1;
			local19.glBindTexture(34067, this.anIntArray217[0]);
			...
			local19.glBindTexture(34067, this.anIntArray217[1]);
			local19.glTexParameteri(34067, 10241, 9729);
			local19.glTexParameteri(34067, 10240, 9729);
			local19.glTexParameteri(34067, 32882, 33071);
			local19.glTexParameteri(34067, 10242, 33071);
			local19.glTexParameteri(34067, 10243, 33071);
			local19.glBindTexture(34067, this.anIntArray217[2]);
			local19.glTexParameteri(34067, 10241, 9729);
			local19.glTexParameteri(34067, 10240, 9729);
			local19.glTexParameteri(34067, 32882, 33071);
			local19.glTexParameteri(34067, 10242, 33071);
			local19.glTexParameteri(34067, 10243, 33071);
			this.aBoolean173 = Static277.anInt5352 < 3;
		}
		this.method1957();
	}
	...
	private void method1957() {
		...
		this.anInt2476 = local1.glGenLists(2);
		local1.glNewList(this.anInt2476, 4864);
		if (this.anIntArray217 == null) {
			...
			if (this.aBoolean173) {
				...
				local1.glTexEnvi(8960, 34162, 7681);
				local1.glTexEnvi(8960, 34184, 34167);
				local1.glBindTexture(3553, Static277.anInt5350);
				local1.glEnable(3553);
			}
			local1.glActiveTexture(33984);
		}
		local1.glEndList();
		local1.glNewList(this.anInt2476 + 1, 4864);
		if (this.anIntArray217 == null) {
	...
	public void method4017(@OriginalArg(0) int arg0) {
		@Pc(1) GL local1 = Static277.aGL1;
		if (Static188.aBoolean295 && this.anIntArray217 != null) {
			local1.glActiveTexture(33985);
			local1.glBindTexture(34067, this.anIntArray217[arg0 - 1]);
			local1.glActiveTexture(33984);
		}
	}
	...
	public void method4018() {
		...
		if (Static188.aBoolean295) {
			local1.glCallList(this.anInt2476);
		} else {
			local1.glTexEnvi(8960, 34184, 34167);
		}
	}
	...
	public void method4019() {
		@Pc(1) GL local1 = Static277.aGL1;
		if (Static188.aBoolean295) {
			local1.glCallList(this.anInt2476 + 1);
		} else {
			local1.glTexEnvi(8960, 34184, 5890);
		}
	}
	...
	private void method1958() {
		@Pc(1) GL local1 = Static277.aGL1;
		if (this.anIntArray217 == null) {
			this.anIntArray217 = new int[3];
			local1.glGenTextures(3, this.anIntArray217, 0);
		}
