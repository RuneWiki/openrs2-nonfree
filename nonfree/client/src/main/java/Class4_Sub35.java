...
public final class Class4_Sub35 extends Class4 {
	...
	public Class4_Sub35(@OriginalArg(0) byte[] arg0) {
		this.method4100(arg0);
	}

	@OriginalMember(owner = "client!pu", name = "a", descriptor = "([I)Lclient!jc;")
	public Class4_Sub15_Sub1 method4095(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray67 == null) {
			this.anInt5109 = 0;
			this.aFloatArray21 = new float[Static316.anInt5108];
			this.aByteArray67 = new byte[this.anInt5111];
			this.anInt5116 = 0;
			this.anInt5117 = 0;
		}
		while (this.anInt5117 < this.aByteArrayArray12.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method4096(this.anInt5117);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt5116;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt5111 - local47) {
					local50 = this.anInt5111 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt5116;
				}
				this.anInt5116 = local47;
			}
			this.anInt5117++;
		}
		...
		return new Class4_Sub15_Sub1(this.anInt5115, local129, this.anInt5112, this.anInt5113, this.aBoolean366);
	}

	@OriginalMember(owner = "client!pu", name = "a", descriptor = "(I)[F")
	private float[] method4096(@OriginalArg(0) int arg0) {
		Static316.method4093(this.aByteArrayArray12[arg0]);
		Static316.method4097();
		@Pc(15) int local15 = Static316.method4101(Static281.method3698(Static316.anIntArray414.length - 1));
		@Pc(19) boolean local19 = Static316.aBooleanArray25[local15];
		@Pc(25) int local25 = local19 ? Static316.anInt5108 : Static316.anInt5114;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static316.method4097() != 0;
			local29 = Static316.method4097() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static316.anInt5114 >> 2);
			local67 = (local25 >> 2) + (Static316.anInt5114 >> 2);
			local71 = Static316.anInt5114 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static316.anInt5114 >> 2);
			local104 = local25 + (Static316.anInt5114 >> 2) - (local25 >> 2);
			local108 = Static316.anInt5114 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class18 local123 = Static316.aClass18Array1[Static316.anIntArray414[local15]];
		@Pc(126) int local126 = local123.anInt347;
		@Pc(131) int local131 = local123.anIntArray24[local126];
		@Pc(140) boolean local140 = !Static316.aClass91Array1[local131].method1741();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt348; local144++) {
			@Pc(152) Class29 local152 = Static316.aClass29Array1[local123.anIntArray23[local144]];
			local154 = Static316.aFloatArray16;
			local152.method499(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt347;
			local176 = local123.anIntArray24[local171];
			Static316.aClass91Array1[local176].method1737(Static316.aFloatArray16, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static316.aFloatArray16[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static316.aFloatArray16;
			...
			@Pc(252) float[] local252 = local19 ? Static316.aFloatArray23 : Static316.aFloatArray17;
			@Pc(258) float[] local258 = local19 ? Static316.aFloatArray18 : Static316.aFloatArray20;
			@Pc(264) float[] local264 = local19 ? Static316.aFloatArray19 : Static316.aFloatArray22;
			@Pc(270) int[] local270 = local19 ? Static316.anIntArray413 : Static316.anIntArray412;
			...
			@Pc(486) int local486 = Static281.method3698(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static316.aFloatArray16[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static316.aFloatArray16[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt5109 > 0) {
			local176 = this.anInt5109 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean367) {
				for (local212 = 0; local212 < this.anInt5107; local212++) {
					local1254 = (this.anInt5109 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static316.aFloatArray16[local212];
				}
			}
		}
		local154 = this.aFloatArray21;
		this.aFloatArray21 = Static316.aFloatArray16;
		Static316.aFloatArray16 = local154;
		this.anInt5109 = local25;
		this.anInt5107 = local104 - (local25 >> 1);
		this.aBoolean367 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!pu", name = "b", descriptor = "([B)V")
	private void method4100(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class4_Sub9 local4 = new Class4_Sub9(arg0);
		this.anInt5115 = local4.method4997();
		this.anInt5111 = local4.method4997();
		this.anInt5112 = local4.method4997();
		this.anInt5113 = local4.method4997();
		if (this.anInt5113 < 0) {
			this.anInt5113 = ~this.anInt5113;
			this.aBoolean366 = true;
		}
		@Pc(40) int local40 = local4.method4997();
		this.aByteArrayArray12 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method5007();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method5005(local64, local49);
