...
public final class Static20 {
	...
	@OriginalMember(owner = "client!be", name = "H", descriptor = "Lclient!fh;")
	public static Class1_Sub13 aClass1_Sub13_1 = new Class1_Sub13(10000);

	@OriginalMember(owner = "client!be", name = "Z", descriptor = "Lclient!be;")
	public static Class11_Sub1_Sub1 aClass11_Sub1_Sub1_1 = new Class11_Sub1_Sub1();

	@OriginalMember(owner = "client!be", name = "cb", descriptor = "Lclient!be;")
	public static Class11_Sub1_Sub1 aClass11_Sub1_Sub1_2 = new Class11_Sub1_Sub1();

	@OriginalMember(owner = "client!be", name = "db", descriptor = "Lclient!be;")
	public static Class11_Sub1_Sub1 aClass11_Sub1_Sub1_3 = new Class11_Sub1_Sub1();

	@OriginalMember(owner = "client!be", name = "eb", descriptor = "Lclient!be;")
	public static Class11_Sub1_Sub1 aClass11_Sub1_Sub1_4 = new Class11_Sub1_Sub1();

	@OriginalMember(owner = "client!be", name = "fb", descriptor = "Lclient!be;")
	public static Class11_Sub1_Sub1 aClass11_Sub1_Sub1_5 = new Class11_Sub1_Sub1();

	@OriginalMember(owner = "client!be", name = "gb", descriptor = "Lclient!be;")
	public static Class11_Sub1_Sub1 aClass11_Sub1_Sub1_6 = new Class11_Sub1_Sub1();
	...
	public static int[] anIntArray48 = new int[1];

	@OriginalMember(owner = "client!be", name = "a", descriptor = "(IIIIIII[FIFFF)V")
	...
	@OriginalMember(owner = "client!be", name = "a", descriptor = "(ISIB)I")
	public static int method409(@OriginalArg(0) int arg0, @OriginalArg(1) short arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		@Pc(5) int local5 = Static119.anIntArray174[Static169.method2937(arg0, arg2)];
		if (arg1 != -1) {
			@Pc(15) int local15 = Static119.anInterface5_1.method1482(arg1 & 0xFFFF);
			@Pc(21) int local21;
			@Pc(44) int local44;
			if (local15 != 0) {
				if (arg2 < 0) {
			...
			local21 = Static119.anInterface5_1.method1484(arg1 & 0xFFFF);
			if (local21 != 0) {
				local21 += 256;
	...
	@OriginalMember(owner = "client!be", name = "a", descriptor = "(FFF)I")
	public static int method410(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
	...
	@OriginalMember(owner = "client!be", name = "a", descriptor = "(IIIIII[FIF)V")
	public static void method414(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) int arg7, @OriginalArg(8) float arg8) {
		@Pc(3) int local3 = arg0 - arg3;
		@Pc(7) int local7 = arg1 - arg4;
		@Pc(11) int local11 = arg2 - arg5;
	...
	@OriginalMember(owner = "client!be", name = "t", descriptor = "()V")
	public static void method419() {
		aClass11_Sub1_Sub1_1 = new Class11_Sub1_Sub1();
		aClass11_Sub1_Sub1_2 = new Class11_Sub1_Sub1();
		aClass11_Sub1_Sub1_3 = new Class11_Sub1_Sub1();
		aClass11_Sub1_Sub1_4 = new Class11_Sub1_Sub1();
		aClass11_Sub1_Sub1_5 = new Class11_Sub1_Sub1();
		aClass11_Sub1_Sub1_6 = new Class11_Sub1_Sub1();
	}

	@OriginalMember(owner = "client!be", name = "a", descriptor = "([SI)[S")
	public static short[] method425(@OriginalArg(0) short[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) short[] local2 = new short[arg1];
		Static317.method1045(arg0, 0, local2, 0, arg1);
		return local2;
	}

	@OriginalMember(owner = "client!be", name = "a", descriptor = "(IIIIII[FFIF)V")
	public static void method431(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) float arg7, @OriginalArg(8) int arg8, @OriginalArg(9) float arg9) {
		@Pc(3) int local3 = arg0 - arg3;
		@Pc(7) int local7 = arg1 - arg4;
		@Pc(11) int local11 = arg2 - arg5;
		@Pc(32) float local32 = (float) local3 * arg6[0] + (float) local7 * arg6[1] + (float) local11 * arg6[2];
	...
	@OriginalMember(owner = "client!be", name = "a", descriptor = "(IIIIFFF)[F")
	public static float[] method433(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6) {
	...
	@OriginalMember(owner = "client!be", name = "a", descriptor = "([FI)[F")
	public static float[] method436(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) float[] local2 = new float[arg1];
		Static317.method1053(arg0, 0, local2, 0, arg1);
		return local2;
	}
}
