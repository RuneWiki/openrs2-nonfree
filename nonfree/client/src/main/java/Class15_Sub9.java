...
public final class Class15_Sub9 extends Class15 {
	...
	@OriginalMember(owner = "client!gha", name = "<init>", descriptor = "(Lclient!vba;)V")
	public Class15_Sub9(@OriginalArg(0) Class3_Sub55 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!gha", name = "<init>", descriptor = "(ILclient!vba;)V")
	public Class15_Sub9(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub55 arg1) {
		super(arg0, arg1);
	}
	...
	public void method9422() {
		if (super.aClass3_Sub55_32.method8894() == Static726.aClass169_12) {
			super.anInt11276 = 2;
		}
	...
	@OriginalMember(owner = "client!gha", name = "c", descriptor = "(B)I")
