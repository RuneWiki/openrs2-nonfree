...
public final class Class5_Sub13 extends Class5 {
	...
	public final int anInt1519;

	@OriginalMember(owner = "client!es", name = "t", descriptor = "I")
	private final int anInt1520;
	...
	public Class5_Sub13(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) boolean arg3) {
		this.anInt1519 = arg0;
		this.anInt1520 = arg1;
		this.anIntArray126 = arg2;
		if (arg3) {
			@Pc(16) int[] local16 = new int[this.anInt1520];
			@Pc(20) int[] local20 = new int[this.anInt1520];
			@Pc(24) int[] local24 = new int[this.anInt1520];
			if (Static81.anIntArray127 == null || Static81.anIntArray127.length < this.anIntArray126.length) {
				Static81.anIntArray127 = new int[this.anIntArray126.length];
			}
			@Pc(40) int local40 = this.anInt1520;
			@Pc(43) int local43 = this.anInt1520;
			...
			for (@Pc(61) int local61 = 2; local61 >= 0; local61--) {
				for (local64 = local47; local64 >= 0; local64--) {
					local58--;
					@Pc(71) int local71 = this.anIntArray126[local58];
			...
			for (@Pc(116) int local116 = local51; local116 >= 0; local116--) {
				...
				for (local64 = local47; local64 >= 0; local64--) {
					...
					local114--;
					Static81.anIntArray127[local114] = local165 << 16 | local169 << 8 | local173;
				...
				for (local64 = local47; local64 >= 0; local64--) {
					local58--;
					@Pc(236) int local236 = this.anIntArray126[local58];
					local59--;
					@Pc(242) int local242 = this.anIntArray126[local59];
			...
			@Pc(306) int[] local306 = this.anIntArray126;
			this.anIntArray126 = Static81.anIntArray127;
			Static81.anIntArray127 = local306;
		}
	}
	...
	public void method1450(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		@Pc(21) int local21 = this.anIntArray126.length;
		@Pc(28) int local28 = this.anInt1520 - 1;
		@Pc(33) int local33 = this.anInt1520 * arg1;
		@Pc(37) int local37 = local21 - 1;
		for (@Pc(39) int local39 = 0; local39 < local21; local39 += this.anInt1520) {
			@Pc(46) int local46 = local39 + local33 & local37;
			for (@Pc(48) int local48 = 0; local48 < this.anInt1520; local48++) {
				@Pc(53) int local53 = local39 + local48;
				@Pc(61) int local61 = local46 + (local48 + arg0 & local28);
				Static81.anIntArray127[local53] = this.anIntArray126[local61];
			}
		}
		@Pc(84) int[] local84 = this.anIntArray126;
		this.anIntArray126 = Static81.anIntArray127;
		Static81.anIntArray127 = local84;
	}

	@OriginalMember(owner = "client!es", name = "b", descriptor = "()[I")
	public int[] method1452() {
		return this.anIntArray126;
	}
}
