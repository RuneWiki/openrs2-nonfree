...
public final class Class46 {
	...
	public Class46(@OriginalArg(0) byte arg0, @OriginalArg(1) int[] arg1) {
		try {
			...
			for (@Pc(13) int local13 = 0; local13 < arg1.length; local13++) {
				this.anIntArray263[local13] = arg1[local13];
			}
			this.method664();
		} catch (@Pc(41) RuntimeException local41) {
			signlink.reporterror("47973, " + arg0 + ", " + arg1 + ", " + local41.toString());
	...
	public int method662() {
		...
		return this.anIntArray263[this.anInt990];
	}
	...
	private void method663() {
		...
		for (@Pc(15) int local15 = 0; local15 < 256; local15++) {
			...
			this.anInt991 += this.anIntArray264[local15 + 128 & 0xFF];
			@Pc(101) int local101;
			this.anIntArray264[local15] = local101 = this.anIntArray264[local22 >> 2 & 0xFF] + this.anInt991 + this.anInt992;
			this.anIntArray263[local15] = this.anInt992 = this.anIntArray264[local101 >> 8 >> 2 & 0xFF] + local22;
		}
	}
