...
public final class Class46 {
	...
	public Class46(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1) {
		try {
			...
			signlink.reporterror("95617, " + arg0 + ", " + arg1 + ", " + local34.toString());
	...
	public int method662() {
		...
		return this.anIntArray263[this.anInt952];
	}
	...
	private void method663() {
		...
		for (@Pc(15) int local15 = 0; local15 < 256; local15++) {
			...
			switch(local15 & 0x3) {
				case 0:
					this.anInt953 ^= this.anInt953 << 13;
					break;
				case 1:
					this.anInt953 ^= this.anInt953 >>> 6;
					break;
				case 2:
					this.anInt953 ^= this.anInt953 << 2;
					break;
				case 3:
					this.anInt953 ^= this.anInt953 >>> 16;
			}
			this.anInt953 += this.anIntArray264[local15 + 128 & 0xFF];
			@Pc(101) int local101;
			this.anIntArray264[local15] = local101 = this.anIntArray264[local22 >> 2 & 0xFF] + this.anInt953 + this.anInt954;
			this.anIntArray263[local15] = this.anInt954 = this.anIntArray264[local101 >> 8 >> 2 & 0xFF] + local22;
		}
	}
