...
public final class Class46 {
	...
	public Class46(@OriginalArg(0) boolean arg0, @OriginalArg(1) int[] arg1) {
		try {
			this.anIntArray261 = new int[256];
			this.anIntArray260 = new int[256];
			for (@Pc(17) int local17 = 0; local17 < arg1.length; local17++) {
				this.anIntArray260[local17] = arg1[local17];
			}
			this.method657();
		} catch (@Pc(35) RuntimeException local35) {
			signlink.reporterror("35465, " + arg0 + ", " + arg1 + ", " + local35.toString());
	...
	public int method655() {
		...
		return this.anIntArray260[this.anInt976];
	}
	...
	private void method656() {
		...
		for (@Pc(15) int local15 = 0; local15 < 256; local15++) {
			...
			switch(local15 & 0x3) {
				case 0:
					this.anInt977 ^= this.anInt977 << 13;
					break;
				case 1:
					this.anInt977 ^= this.anInt977 >>> 6;
					break;
				case 2:
					this.anInt977 ^= this.anInt977 << 2;
					break;
				case 3:
					this.anInt977 ^= this.anInt977 >>> 16;
			}
			this.anInt977 += this.anIntArray261[local15 + 128 & 0xFF];
			@Pc(101) int local101;
			this.anIntArray261[local15] = local101 = this.anIntArray261[local22 >> 2 & 0xFF] + this.anInt977 + this.anInt978;
			this.anIntArray260[local15] = this.anInt978 = this.anIntArray261[local101 >> 8 >> 2 & 0xFF] + local22;
		}
	}
