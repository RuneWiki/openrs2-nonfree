...
public final class Class46 {
	...
	public Class46(@OriginalArg(0) boolean arg0, @OriginalArg(1) int[] arg1) {
		try {
			...
			for (@Pc(17) int local17 = 0; local17 < arg1.length; local17++) {
				this.anIntArray263[local17] = arg1[local17];
			}
			this.method664();
		} catch (@Pc(35) RuntimeException local35) {
			signlink.reporterror("16109, " + arg0 + ", " + arg1 + ", " + local35.toString());
	...
	public int method662() {
		...
		return this.anIntArray263[this.anInt967];
	}
	...
	private void method663() {
		...
		for (@Pc(15) int local15 = 0; local15 < 256; local15++) {
			...
			this.anInt968 += this.anIntArray264[local15 + 128 & 0xFF];
			@Pc(101) int local101;
			this.anIntArray264[local15] = local101 = this.anIntArray264[local22 >> 2 & 0xFF] + this.anInt968 + this.anInt969;
			this.anIntArray263[local15] = this.anInt969 = this.anIntArray264[local101 >> 8 >> 2 & 0xFF] + local22;
		}
	}
