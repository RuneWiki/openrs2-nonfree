...
public final class Static652 {
	...
	@OriginalMember(owner = "client!lu", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!lu;)I")
	public static int method4433(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub13_Sub2 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt5250 += arg10.anInt5254 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt5249 = arg4 >> 2;
		arg10.anInt5244 = arg5 >> 2;
		arg10.anInt5255 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!lu", name = "a", descriptor = "(II[B[IIIIIIIILclient!lu;II)I")
	public static int method4434(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub13_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt5249 -= arg8.anInt5247 * arg3;
		arg8.anInt5244 -= arg8.anInt5243 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!lu", name = "a", descriptor = "(I[B[IIIIIIIILclient!lu;)I")
	public static int method4435(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub13_Sub2 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt5255 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!lu", name = "a", descriptor = "(II)I")
	public static int method4437(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!lu", name = "a", descriptor = "(II[B[IIIIIIILclient!lu;II)I")
	public static int method4438(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub13_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!lu", name = "b", descriptor = "(I[B[IIIIIIIILclient!lu;)I")
	public static int method4439(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub13_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!lu", name = "b", descriptor = "(II[B[IIIIIIIILclient!lu;II)I")
	public static int method4444(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub13_Sub2 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!lu", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!lu;II)I")
	public static int method4445(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub13_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt5250 -= arg10.anInt5254 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt5250 += arg10.anInt5254 * local63;
		arg10.anInt5249 = arg4;
		arg10.anInt5244 = arg5;
		arg10.anInt5255 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lclient!aaa;III)Lclient!lu;")
	public static Class2_Sub13_Sub2 method4446(@OriginalArg(0) Class2_Sub1_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray1 == null || arg0.aByteArray1.length == 0 ? null : new Class2_Sub13_Sub2(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!lu", name = "a", descriptor = "([B[IIIIIIIILclient!lu;)I")
	public static int method4447(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub13_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt5249 += arg8.anInt5247 * (local22 - arg3);
		arg8.anInt5244 += arg8.anInt5243 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt5250 = arg4 >> 2;
		arg8.anInt5255 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!lu", name = "c", descriptor = "(II)I")
	public static int method4450(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!lu", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!lu;)I")
	public static int method4451(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub13_Sub2 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt5250 += arg10.anInt5254 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!lu", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!lu;II)I")
	public static int method4456(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub13_Sub2 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt5250 -= arg10.anInt5254 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!lu", name = "a", descriptor = "([B[IIIIIIILclient!lu;)I")
	public static int method4459(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub13_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt5255 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!lu", name = "c", descriptor = "(II[B[IIIIIIIILclient!lu;II)I")
	...
	@OriginalMember(owner = "client!lu", name = "b", descriptor = "([B[IIIIIIILclient!lu;)I")
	public static int method4462(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub13_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!lu", name = "b", descriptor = "(II[B[IIIIIIILclient!lu;II)I")
	public static int method4467(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub13_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!lu", name = "b", descriptor = "([B[IIIIIIIILclient!lu;)I")
	public static int method4469(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub13_Sub2 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt5249 += arg8.anInt5247 * (local24 - arg3);
		arg8.anInt5244 += arg8.anInt5243 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!lu", name = "d", descriptor = "(II[B[IIIIIIIILclient!lu;II)I")
