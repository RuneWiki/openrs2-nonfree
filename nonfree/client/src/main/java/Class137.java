...
public abstract class Class137 {
	...
	public final void method5699(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Class24 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		this.method5706(arg0, arg1, (float) this.RA() / 2.0F, (float) this.Q() / 2.0F, 4096, arg2, arg3, arg4, arg5);
	}
	...
	public final void method5700(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.ya(arg0, arg1, arg2, arg3, 1, 0, 1);
	}

	@OriginalMember(owner = "client!o", name = "a", descriptor = "(FFII)V")
	public final void method5701(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.method5702(arg0, arg1, (float) this.RA() / 2.0F, (float) this.Q() / 2.0F, arg2, arg3, 1, 0);
	}
	...
	private void method5702(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		if (arg4 == 0) {
			return;
		}
	...
	protected abstract void method5704(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) Class24 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8);
	...
	public final void method5705(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4) {
		this.method5702(arg0, arg1, (float) this.RA() / 2.0F, (float) this.Q() / 2.0F, arg2, arg3, 0, arg4);
	}

	@OriginalMember(owner = "client!o", name = "a", descriptor = "(FFFFIILclient!ta;II)V")
	public final void method5706(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2, @OriginalArg(3) float arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Class24 arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		if (arg4 == 0) {
			return;
		}
		@Pc(9) double local9 = (double) (arg5 & 0xFFFF) * 9.587379924285257E-5D;
		...
		@Pc(102) float local102 = (-arg2 * local23 + ((float) this.Q() - arg3) * local16) / 4096.0F + arg0;
		@Pc(118) float local118 = (arg2 * local16 + ((float) this.Q() - arg3) * local23) / 4096.0F + arg1;
		this.method5704(local37, local50, local67, local85, local102, local118, arg6, arg7, arg8);
	}

	@OriginalMember(owner = "client!o", name = "b", descriptor = "(IIII)V")
	public final void method5707(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		this.la(arg0, arg1, arg2, arg3, 1, 0, 1);
	}

	@OriginalMember(owner = "client!o", name = "a", descriptor = "(II)V")
	public final void method5708(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
