...
public final class Class13_Sub1_Sub1 extends Class13_Sub1 {
	...
	@OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lclient!j;[IIIII)V", line = 2399)
	...
	@OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lclient!j;[III)V", line = 3762)
	...
	public void method6393(@OriginalArg(2) int arg0) {
		...
		if (arg0 == 0) {
			...
			for (local7 = 0; local7 < super.anInt1942; local7++) {
				local13 = local7 * super.anInt1934;
				local23 = local7 * super.aClass19_Sub2_5.anInt2860;
				for (local25 = 0; local25 < super.anInt1934; local25++) {
	...
	protected void method1993(@OriginalArg(0) int arg0) {
		...
		if (Static140.anInt1913 == 0) {
			if (Static140.anInt1926 == 0) {
					...
					if (local14 >= 0 && local16 >= 0 && local14 - (super.anInt1934 << 12) < 0 && local16 - (super.anInt1942 << 12) < 0) {
						while (local18 < 0) {
							...
							if (arg0 == 0) {
								...
								local162 = this.anIntArray22[local48];
								local166 = (local162 >>> 24) * Class13_Sub1.anInt1923 >> 8;
								local170 = 256 - local166;
								if ((Static140.anInt1918 & 0xFFFFFF) == 16777215) {
									local174 = local3[local51];
									local3[local51] = ((local162 & 0xFF00FF) * local166 + (local174 & 0xFF00FF) * local170 & 0xFF00FF00) + ((local162 & 0xFF00) * local166 + (local174 & 0xFF00) * local170 & 0xFF0000) >> 8;
								} else if (Class13_Sub1.anInt1923 == 255) {
									local174 = (local162 & 0xFF0000) * Class13_Sub1.anInt1921 & 0xFF000000;
									local288 = (local162 & 0xFF00) * Class13_Sub1.anInt1939 & 0xFF0000;
									local296 = (local162 & 0xFF) * Class13_Sub1.anInt1920 & 0xFF00;
								...
								local166 = local162 >>> 24;
								local170 = 256 - local166;
								local174 = (local162 & 0xFF00FF) * Class13_Sub1.anInt1923 & 0xFF00FF00;
								local288 = (local162 & 0xFF00) * Class13_Sub1.anInt1923 & 0xFF0000;
								local162 = ((local174 | local288) >>> 8) + Class13_Sub1.anInt1938;
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt1934 << 12) < 0) {
						@Pc(703) int local703;
						if ((local703 = local16 - (super.anInt1942 << 12)) >= 0) {
							local710 = (Static140.anInt1926 - local703) / Static140.anInt1926;
							local18 += local710;
							local16 += Static140.anInt1926 * local710;
							local12 += local710;
						}
						@Pc(731) int local731;
						if ((local731 = (local16 - Static140.anInt1926) / Static140.anInt1926) > local18) {
							local18 = local731;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt1934 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt1934 << 12) < 0) {
						if (local16 < 0) {
							local710 = (Static140.anInt1926 - local16 - 1) / Static140.anInt1926;
							local18 += local710;
							local16 += Static140.anInt1926 * local710;
							local12 += local710;
						}
						@Pc(1438) int local1438;
						if ((local1438 = (local16 + 1 - (super.anInt1942 << 12) - Static140.anInt1926) / Static140.anInt1926) > local18) {
							local18 = local1438;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt1934 + (local14 >> 12);
			...
			if (Static140.anInt1926 == 0) {
				...
				while (local9 < 0) {
					...
					if (local16 >= 0 && local16 - (super.anInt1942 << 12) < 0) {
						...
						if ((local2119 = local14 - (super.anInt1934 << 12)) >= 0) {
							local710 = (Static140.anInt1913 - local2119) / Static140.anInt1913;
							local18 += local710;
							local14 += Static140.anInt1913 * local710;
							local12 += local710;
						}
						@Pc(2147) int local2147;
						if ((local2147 = (local14 - Static140.anInt1913) / Static140.anInt1913) > local18) {
							local18 = local2147;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt1934 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local2819 = local14 - (super.anInt1934 << 12)) >= 0) {
						local710 = (Static140.anInt1913 - local2819) / Static140.anInt1913;
						local18 += local710;
						local14 += Static140.anInt1913 * local710;
						local16 += Static140.anInt1926 * local710;
						local12 += local710;
					...
					if ((local2853 = (local14 - Static140.anInt1913) / Static140.anInt1913) > local18) {
						local18 = local2853;
					}
					@Pc(2865) int local2865;
					if ((local2865 = local16 - (super.anInt1942 << 12)) >= 0) {
						local710 = (Static140.anInt1926 - local2865) / Static140.anInt1926;
						local18 += local710;
						local14 += Static140.anInt1913 * local710;
						local16 += Static140.anInt1926 * local710;
						local12 += local710;
					...
					if ((local2899 = (local16 - Static140.anInt1926) / Static140.anInt1926) > local18) {
						local18 = local2899;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt1934 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local3577 = local14 - (super.anInt1934 << 12)) >= 0) {
						local710 = (Static140.anInt1913 - local3577) / Static140.anInt1913;
						local18 += local710;
						local14 += Static140.anInt1913 * local710;
						local16 += Static140.anInt1926 * local710;
						local12 += local710;
					...
					if ((local3611 = (local14 - Static140.anInt1913) / Static140.anInt1913) > local18) {
						local18 = local3611;
					}
					if (local16 < 0) {
						local710 = (Static140.anInt1926 - local16 - 1) / Static140.anInt1926;
					...
					if ((local3659 = (local16 + 1 - (super.anInt1942 << 12) - Static140.anInt1926) / Static140.anInt1926) > local18) {
						local18 = local3659;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt1934 + (local14 >> 12);
			...
			while (local9 < 0) {
				...
				if (local16 >= 0 && local16 - (super.anInt1942 << 12) < 0) {
					if (local14 < 0) {
						local710 = (Static140.anInt1913 - local14 - 1) / Static140.anInt1913;
						local18 += local710;
						local14 += Static140.anInt1913 * local710;
						local12 += local710;
					}
					@Pc(4376) int local4376;
					if ((local4376 = (local14 + 1 - (super.anInt1934 << 12) - Static140.anInt1913) / Static140.anInt1913) > local18) {
						local18 = local4376;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt1934 + (local14 >> 12);
			...
			for (local9 = Static140.anInt1931; local9 < 0; local9++) {
				...
				if ((local5088 = (local14 + 1 - (super.anInt1934 << 12) - Static140.anInt1913) / Static140.anInt1913) > local18) {
					local18 = local5088;
				}
				@Pc(5100) int local5100;
				if ((local5100 = local16 - (super.anInt1942 << 12)) >= 0) {
					local710 = (Static140.anInt1926 - local5100) / Static140.anInt1926;
					local18 += local710;
					local14 += Static140.anInt1913 * local710;
					local16 += Static140.anInt1926 * local710;
					local12 += local710;
				...
				if ((local5134 = (local16 - Static140.anInt1926) / Static140.anInt1926) > local18) {
					local18 = local5134;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt1934 + (local14 >> 12);
			...
			for (local9 = Static140.anInt1931; local9 < 0; local9++) {
				...
				if ((local5848 = (local14 + 1 - (super.anInt1934 << 12) - Static140.anInt1913) / Static140.anInt1913) > local18) {
					local18 = local5848;
				}
				if (local16 < 0) {
					local710 = (Static140.anInt1926 - local16 - 1) / Static140.anInt1926;
				...
				if ((local5896 = (local16 + 1 - (super.anInt1942 << 12) - Static140.anInt1926) / Static140.anInt1926) > local18) {
					local18 = local5896;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt1934 + (local14 >> 12);
		...
		if (Static140.anInt1913 == 0) {
			if (Static140.anInt1926 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local27 >= 0 && local25 - (super.anInt1934 << 12) < 0 && local27 - (super.anInt1942 << 12) < 0) {
							...
							while (local29 < 0) {
								local111 = this.anIntArray22[(local27 >> 12) * super.anInt1934 + (local25 >> 12)];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt1934 << 12) < 0) {
							@Pc(210) int local210;
							if ((local210 = local27 - (super.anInt1942 << 12)) >= 0) {
								local217 = (Static140.anInt1926 - local210) / Static140.anInt1926;
								local29 += local217;
								local27 += Static140.anInt1926 * local217;
								local23 += local217;
							}
							@Pc(238) int local238;
							if ((local238 = (local27 - Static140.anInt1926) / Static140.anInt1926) > local29) {
								local29 = local238;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt1934 << 12) < 0) {
							if (local27 < 0) {
								local217 = (Static140.anInt1926 - local27 - 1) / Static140.anInt1926;
								local29 += local217;
								local27 += Static140.anInt1926 * local217;
								local23 += local217;
							}
							@Pc(441) int local441;
							if ((local441 = (local27 + 1 - (super.anInt1942 << 12) - Static140.anInt1926) / Static140.anInt1926) > local29) {
								local29 = local441;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
			...
			if (Static140.anInt1926 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local27 >= 0 && local27 - (super.anInt1942 << 12) < 0) {
							@Pc(618) int local618;
							if ((local618 = local25 - (super.anInt1934 << 12)) >= 0) {
								local217 = (Static140.anInt1913 - local618) / Static140.anInt1913;
								local29 += local217;
								local25 += Static140.anInt1913 * local217;
								local23 += local217;
							}
							@Pc(646) int local646;
							if ((local646 = (local25 - Static140.anInt1913) / Static140.anInt1913) > local29) {
								local29 = local646;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static140.anInt1935;
						@Pc(814) int local814;
						if ((local814 = local25 - (super.anInt1934 << 12)) >= 0) {
							local217 = (Static140.anInt1913 - local814) / Static140.anInt1913;
							local29 += local217;
							local25 += Static140.anInt1913 * local217;
							local27 += Static140.anInt1926 * local217;
							local23 += local217;
						...
						@Pc(848) int local848;
						if ((local848 = (local25 - Static140.anInt1913) / Static140.anInt1913) > local29) {
							local29 = local848;
						}
						@Pc(860) int local860;
						if ((local860 = local27 - (super.anInt1942 << 12)) >= 0) {
							local217 = (Static140.anInt1926 - local860) / Static140.anInt1926;
							local29 += local217;
							local25 += Static140.anInt1913 * local217;
							local27 += Static140.anInt1926 * local217;
							local23 += local217;
						...
						@Pc(894) int local894;
						if ((local894 = (local27 - Static140.anInt1926) / Static140.anInt1926) > local29) {
							local29 = local894;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if ((local1068 = local25 - (super.anInt1934 << 12)) >= 0) {
							local217 = (Static140.anInt1913 - local1068) / Static140.anInt1913;
							local29 += local217;
							local25 += Static140.anInt1913 * local217;
							local27 += Static140.anInt1926 * local217;
							local23 += local217;
						...
						if ((local1102 = (local25 - Static140.anInt1913) / Static140.anInt1913) > local29) {
							local29 = local1102;
						}
						if (local27 < 0) {
							local217 = (Static140.anInt1926 - local27 - 1) / Static140.anInt1926;
						...
						if ((local1150 = (local27 + 1 - (super.anInt1942 << 12) - Static140.anInt1926) / Static140.anInt1926) > local29) {
							local29 = local1150;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if (local27 >= 0 && local27 - (super.anInt1942 << 12) < 0) {
						if (local25 < 0) {
							local217 = (Static140.anInt1913 - local25 - 1) / Static140.anInt1913;
							local29 += local217;
							local25 += Static140.anInt1913 * local217;
							local23 += local217;
						}
						@Pc(1363) int local1363;
						if ((local1363 = (local25 + 1 - (super.anInt1934 << 12) - Static140.anInt1913) / Static140.anInt1913) > local29) {
							local29 = local1363;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1571 = (local25 + 1 - (super.anInt1934 << 12) - Static140.anInt1913) / Static140.anInt1913) > local29) {
						local29 = local1571;
					}
					@Pc(1583) int local1583;
					if ((local1583 = local27 - (super.anInt1942 << 12)) >= 0) {
						local217 = (Static140.anInt1926 - local1583) / Static140.anInt1926;
						local29 += local217;
						local25 += Static140.anInt1913 * local217;
						local27 += Static140.anInt1926 * local217;
						local23 += local217;
					...
					if ((local1617 = (local27 - Static140.anInt1926) / Static140.anInt1926) > local29) {
						local29 = local1617;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1827 = (local25 + 1 - (super.anInt1934 << 12) - Static140.anInt1913) / Static140.anInt1913) > local29) {
						local29 = local1827;
					}
					if (local27 < 0) {
						local217 = (Static140.anInt1926 - local27 - 1) / Static140.anInt1926;
					...
					if ((local1875 = (local27 + 1 - (super.anInt1942 << 12) - Static140.anInt1926) / Static140.anInt1926) > local29) {
						local29 = local1875;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
	...
	@OriginalMember(owner = "client!b", name = "a", descriptor = "(IILclient!kf;II)V", line = 4296)
	@Override
