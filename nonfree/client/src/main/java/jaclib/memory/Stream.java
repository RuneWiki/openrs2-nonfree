...
public final class Stream {
	...
	public void a(@OriginalArg(0) float arg0) {
		...
		this.b[this.a++] = (byte) (local16 >> 24);
		this.b[this.a++] = (byte) (local16 >> 16);
		this.b[this.a++] = (byte) (local16 >> 8);
		this.b[this.a++] = (byte) local16;
	}
	...
	public void b() {
		...
		this.c.a(this.b, 0, this.e, this.a);
		this.e += this.a;
		this.a = 0;
	}
	...
	public void b(@OriginalArg(0) float arg0) {
		...
		this.b[this.a++] = (byte) local12;
		this.b[this.a++] = (byte) (local12 >> 8);
		this.b[this.a++] = (byte) (local12 >> 16);
		this.b[this.a++] = (byte) (local12 >> 24);
	}
