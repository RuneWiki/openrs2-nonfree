...
public final class Stream {
	...
	public void b(@OriginalArg(0) int arg0) {
		if (this.e.length <= this.a + 3) {
			this.a();
		}
		this.e[this.a++] = (byte) arg0;
		this.e[this.a++] = (byte) (arg0 >> 8);
		this.e[this.a++] = (byte) (arg0 >> 16);
		this.e[this.a++] = (byte) (arg0 >> 24);
	}
	...
	public void a() {
		...
		this.d.a(this.e, 0, this.c, this.a);
		this.c += this.a;
		this.a = 0;
	}
	...
	public void a(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		this.e[this.a++] = (byte) arg0;
		this.e[this.a++] = (byte) arg1;
		this.e[this.a++] = (byte) arg2;
		this.e[this.a++] = (byte) arg3;
	}

	@OriginalMember(owner = "client!jaclib/memory/Stream", name = "a", descriptor = "(F)V")
	public void a(@OriginalArg(0) float arg0) {
		if (this.a + 3 >= this.e.length) {
			this.a();
		}
		@Pc(16) int local16 = floatToRawIntBits(arg0);
		this.e[this.a++] = (byte) (local16 >> 24);
		this.e[this.a++] = (byte) (local16 >> 16);
		this.e[this.a++] = (byte) (local16 >> 8);
		this.e[this.a++] = (byte) local16;
	}
	...
	public void b(@OriginalArg(0) float arg0) {
		...
		this.e[this.a++] = (byte) local12;
		this.e[this.a++] = (byte) (local12 >> 8);
		this.e[this.a++] = (byte) (local12 >> 16);
		this.e[this.a++] = (byte) (local12 >> 24);
	}
