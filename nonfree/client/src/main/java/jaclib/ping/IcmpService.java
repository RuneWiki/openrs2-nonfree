...
public abstract class IcmpService implements Runnable {
	...
	@OriginalMember(owner = "client!jaclib/ping/IcmpService", name = "g", descriptor = "()V")
	...
	@OriginalMember(owner = "client!jaclib/ping/IcmpService", name = "c", descriptor = "(I)V")
	protected abstract void c(@OriginalArg(0) int arg0);

	@OriginalMember(owner = "client!jaclib/ping/IcmpService", name = "v", descriptor = "(III)V")
	protected abstract void v(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
