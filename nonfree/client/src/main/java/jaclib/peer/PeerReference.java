...
public abstract class PeerReference extends WeakReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/Peer;Lclient!jaclib/peer/uca;)V")
	protected PeerReference(@OriginalArg(0) Peer arg0, @OriginalArg(1) uca arg1) {
		super(arg0, arg1.b);
		arg1.a((byte) 119, this);
	}
	...
	public final long a(@OriginalArg(0) int arg0) {
		...
		if (this.peer == 0L) {
			...
			local14 = this.releasePeer(this.peer);
			this.peer = 0L;
		}
		return local14;
	}
