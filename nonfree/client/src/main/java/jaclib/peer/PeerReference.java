...
public abstract class PeerReference extends WeakReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/Peer;Lclient!jaclib/peer/qd;)V")
	protected PeerReference(@OriginalArg(0) Peer arg0, @OriginalArg(1) qd arg1) {
		super(arg0, arg1.c);
		arg1.a(this, (byte) 30);
	}
