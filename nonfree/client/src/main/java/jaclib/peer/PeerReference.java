...
public abstract class PeerReference extends WeakReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/Peer;Lclient!jaclib/peer/rh;)V")
	protected PeerReference(@OriginalArg(0) Peer arg0, @OriginalArg(1) rh arg1) {
		super(arg0, arg1.a);
		arg1.b(this, (byte) -38);
	}
