...
public abstract class PeerReference extends WeakReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/Peer;Lclient!jaclib/peer/hr;)V")
	protected PeerReference(@OriginalArg(0) Peer arg0, @OriginalArg(1) hr arg1) {
		super(arg0, arg1.b);
		arg1.b((byte) 120, this);
	}
