...
public abstract class PeerReference extends WeakReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/Peer;Lclient!jaclib/peer/dj;)V")
	protected PeerReference(@OriginalArg(0) Peer arg0, @OriginalArg(1) dj arg1) {
		super(arg0, arg1.c);
		arg1.a(false, this);
	}
	...
	public final long a(@OriginalArg(0) int arg0) {
		...
		if (this.peer == 0L) {
			...
			local15 = this.releasePeer(this.peer);
			this.peer = 0L;
		}
		return local15;
	}
