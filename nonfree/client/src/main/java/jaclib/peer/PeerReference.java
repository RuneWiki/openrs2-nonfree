...
public abstract class PeerReference extends WeakReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/Peer;Lclient!jaclib/peer/ca;)V")
	protected PeerReference(@OriginalArg(0) Peer arg0, @OriginalArg(1) ca arg1) {
		super(arg0, arg1.c);
		arg1.b(this, 4220);
	}
