...
public abstract class PeerReference extends WeakReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/PeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/Peer;Lclient!jaclib/peer/io;)V")
	protected PeerReference(@OriginalArg(0) Peer arg0, @OriginalArg(1) io arg1) {
		super(arg0, arg1.a);
		arg1.a(this, -4755);
	}
