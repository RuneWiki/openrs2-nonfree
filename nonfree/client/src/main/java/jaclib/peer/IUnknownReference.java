...
public final class IUnknownReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/IUnknownReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/IUnknown;Lclient!jaclib/peer/bw;)V")
	public IUnknownReference(@OriginalArg(0) IUnknown arg0, @OriginalArg(1) bw arg1) {
		super(arg0, arg1);
	}
