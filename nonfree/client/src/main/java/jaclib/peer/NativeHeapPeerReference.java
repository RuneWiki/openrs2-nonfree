...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/ma;Lclient!jaclib/peer/qd;)V")
	public NativeHeapPeerReference(@OriginalArg(0) ma arg0, @OriginalArg(1) qd arg1) {
		super(arg0, arg1);
	}
