...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/vl;Lclient!jaclib/peer/wl;)V")
	public NativeHeapPeerReference(@OriginalArg(0) vl arg0, @OriginalArg(1) wl arg1) {
		super(arg0, arg1);
	}
