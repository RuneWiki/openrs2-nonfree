...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/jfa;Lclient!jaclib/peer/vo;)V")
	public NativeHeapPeerReference(@OriginalArg(0) jfa arg0, @OriginalArg(1) vo arg1) {
		super(arg0, arg1);
	}
