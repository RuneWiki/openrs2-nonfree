...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/qp;Lclient!jaclib/peer/pi;)V")
	public NativeHeapPeerReference(@OriginalArg(0) qp arg0, @OriginalArg(1) pi arg1) {
		super(arg0, arg1);
	}
