...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/rn;Lclient!jaclib/peer/pba;)V")
	public NativeHeapPeerReference(@OriginalArg(0) rn arg0, @OriginalArg(1) pba arg1) {
		super(arg0, arg1);
	}
