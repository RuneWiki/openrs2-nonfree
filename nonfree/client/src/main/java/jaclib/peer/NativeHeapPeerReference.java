...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/od;Lclient!jaclib/peer/bda;)V")
	public NativeHeapPeerReference(@OriginalArg(0) od arg0, @OriginalArg(1) bda arg1) {
		super(arg0, arg1);
	}
