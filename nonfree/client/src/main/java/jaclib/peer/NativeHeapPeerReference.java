...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/jl;Lclient!jaclib/peer/qr;)V")
	public NativeHeapPeerReference(@OriginalArg(0) jl arg0, @OriginalArg(1) qr arg1) {
		super(arg0, arg1);
	}
