...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/pd;Lclient!jaclib/peer/wn;)V")
	public NativeHeapPeerReference(@OriginalArg(0) pd arg0, @OriginalArg(1) wn arg1) {
		super(arg0, arg1);
	}
