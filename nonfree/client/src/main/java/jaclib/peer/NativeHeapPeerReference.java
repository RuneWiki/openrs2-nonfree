...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/tja;Lclient!jaclib/peer/bw;)V")
	public NativeHeapPeerReference(@OriginalArg(0) tja arg0, @OriginalArg(1) bw arg1) {
		super(arg0, arg1);
	}
