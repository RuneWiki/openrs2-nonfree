...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/eb;Lclient!jaclib/peer/ow;)V")
	public NativeHeapPeerReference(@OriginalArg(0) eb arg0, @OriginalArg(1) ow arg1) {
		super(arg0, arg1);
	}
