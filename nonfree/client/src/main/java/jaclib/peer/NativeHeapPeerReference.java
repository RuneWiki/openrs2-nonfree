...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/ad;Lclient!jaclib/peer/hea;)V")
	public NativeHeapPeerReference(@OriginalArg(0) ad arg0, @OriginalArg(1) hea arg1) {
		super(arg0, arg1);
	}
