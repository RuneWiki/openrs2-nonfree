...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/hm;Lclient!jaclib/peer/bd;)V")
	public NativeHeapPeerReference(@OriginalArg(0) hm arg0, @OriginalArg(1) bd arg1) {
		super(arg0, arg1);
	}
