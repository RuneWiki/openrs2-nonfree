...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/tk;Lclient!jaclib/peer/cv;)V")
	public NativeHeapPeerReference(@OriginalArg(0) tk arg0, @OriginalArg(1) cv arg1) {
		super(arg0, arg1);
	}
