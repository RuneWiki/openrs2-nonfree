...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/ih;Lclient!jaclib/peer/er;)V")
	public NativeHeapPeerReference(@OriginalArg(0) ih arg0, @OriginalArg(1) er arg1) {
		super(arg0, arg1);
	}
