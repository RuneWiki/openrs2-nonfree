...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/fb;Lclient!jaclib/peer/hr;)V")
	public NativeHeapPeerReference(@OriginalArg(0) fb arg0, @OriginalArg(1) hr arg1) {
		super(arg0, arg1);
	}
