...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/l;Lclient!jaclib/peer/fk;)V")
	public NativeHeapPeerReference(@OriginalArg(0) l arg0, @OriginalArg(1) fk arg1) {
		super(arg0, arg1);
	}
