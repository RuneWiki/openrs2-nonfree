...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/qla;Lclient!jaclib/peer/bu;)V")
	public NativeHeapPeerReference(@OriginalArg(0) qla arg0, @OriginalArg(1) bu arg1) {
		super(arg0, arg1);
	}
