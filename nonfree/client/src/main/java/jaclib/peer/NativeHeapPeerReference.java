...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/nn;Lclient!jaclib/peer/dq;)V")
	public NativeHeapPeerReference(@OriginalArg(0) nn arg0, @OriginalArg(1) dq arg1) {
		super(arg0, arg1);
	}
