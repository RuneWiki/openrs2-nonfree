...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/jj;Lclient!jaclib/peer/in;)V")
	public NativeHeapPeerReference(@OriginalArg(0) jj arg0, @OriginalArg(1) in arg1) {
		super(arg0, arg1);
	}
