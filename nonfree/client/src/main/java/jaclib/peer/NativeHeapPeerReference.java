...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/ni;Lclient!jaclib/peer/ik;)V")
	public NativeHeapPeerReference(@OriginalArg(0) ni arg0, @OriginalArg(1) ik arg1) {
		super(arg0, arg1);
	}
