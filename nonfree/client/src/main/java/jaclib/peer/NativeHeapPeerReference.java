...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/uo;Lclient!jaclib/peer/ep;)V")
	public NativeHeapPeerReference(@OriginalArg(0) uo arg0, @OriginalArg(1) ep arg1) {
		super(arg0, arg1);
	}
