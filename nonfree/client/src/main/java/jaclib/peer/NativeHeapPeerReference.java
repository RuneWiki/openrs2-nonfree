...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/fe;Lclient!jaclib/peer/ca;)V")
	public NativeHeapPeerReference(@OriginalArg(0) fe arg0, @OriginalArg(1) ca arg1) {
		super(arg0, arg1);
	}
