...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/uda;Lclient!jaclib/peer/hb;)V")
	public NativeHeapPeerReference(@OriginalArg(0) uda arg0, @OriginalArg(1) hb arg1) {
		super(arg0, arg1);
	}
