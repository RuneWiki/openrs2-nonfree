...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/pa;Lclient!jaclib/peer/am;)V")
	public NativeHeapPeerReference(@OriginalArg(0) pa arg0, @OriginalArg(1) am arg1) {
		super(arg0, arg1);
	}
