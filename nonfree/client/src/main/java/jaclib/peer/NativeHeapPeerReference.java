...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/dh;Lclient!jaclib/peer/hk;)V")
	public NativeHeapPeerReference(@OriginalArg(0) dh arg0, @OriginalArg(1) hk arg1) {
		super(arg0, arg1);
	}
