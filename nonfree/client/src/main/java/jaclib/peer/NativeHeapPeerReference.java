...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/qu;Lclient!jaclib/peer/naa;)V")
	public NativeHeapPeerReference(@OriginalArg(0) qu arg0, @OriginalArg(1) naa arg1) {
		super(arg0, arg1);
	}
