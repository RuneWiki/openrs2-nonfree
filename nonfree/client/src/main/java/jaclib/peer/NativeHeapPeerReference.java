...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/bi;Lclient!jaclib/peer/ge;)V")
	public NativeHeapPeerReference(@OriginalArg(0) bi arg0, @OriginalArg(1) ge arg1) {
		super(arg0, arg1);
	}
