...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/cha;Lclient!jaclib/peer/vv;)V")
	public NativeHeapPeerReference(@OriginalArg(0) cha arg0, @OriginalArg(1) vv arg1) {
		super(arg0, arg1);
	}
