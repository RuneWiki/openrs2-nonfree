...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/gs;Lclient!jaclib/peer/pe;)V")
	public NativeHeapPeerReference(@OriginalArg(0) gs arg0, @OriginalArg(1) pe arg1) {
		super(arg0, arg1);
	}
