...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/um;Lclient!jaclib/peer/mk;)V")
	public NativeHeapPeerReference(@OriginalArg(0) um arg0, @OriginalArg(1) mk arg1) {
		super(arg0, arg1);
	}
