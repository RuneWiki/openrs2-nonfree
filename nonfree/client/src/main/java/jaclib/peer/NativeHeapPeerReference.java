...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/mw;Lclient!jaclib/peer/bea;)V")
	public NativeHeapPeerReference(@OriginalArg(0) mw arg0, @OriginalArg(1) bea arg1) {
		super(arg0, arg1);
	}
