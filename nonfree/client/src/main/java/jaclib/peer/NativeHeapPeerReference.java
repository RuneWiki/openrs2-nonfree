...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/pn;Lclient!jaclib/peer/k;)V")
	public NativeHeapPeerReference(@OriginalArg(0) pn arg0, @OriginalArg(1) k arg1) {
		super(arg0, arg1);
	}
