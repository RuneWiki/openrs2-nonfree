...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/uca;Lclient!jaclib/peer/wf;)V")
	public NativeHeapPeerReference(@OriginalArg(0) uca arg0, @OriginalArg(1) wf arg1) {
		super(arg0, arg1);
	}
