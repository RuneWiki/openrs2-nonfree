...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/mfa;Lclient!jaclib/peer/jaa;)V")
	public NativeHeapPeerReference(@OriginalArg(0) mfa arg0, @OriginalArg(1) jaa arg1) {
		super(arg0, arg1);
	}
