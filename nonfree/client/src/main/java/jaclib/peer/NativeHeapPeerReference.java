...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/mh;Lclient!jaclib/peer/rh;)V")
	public NativeHeapPeerReference(@OriginalArg(0) mh arg0, @OriginalArg(1) rh arg1) {
		super(arg0, arg1);
	}
