...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/jc;Lclient!jaclib/peer/jd;)V")
	public NativeHeapPeerReference(@OriginalArg(0) jc arg0, @OriginalArg(1) jd arg1) {
		super(arg0, arg1);
	}
