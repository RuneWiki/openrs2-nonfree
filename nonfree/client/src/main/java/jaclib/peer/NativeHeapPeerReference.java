...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/bb;Lclient!jaclib/peer/pb;)V")
	public NativeHeapPeerReference(@OriginalArg(0) bb arg0, @OriginalArg(1) pb arg1) {
		super(arg0, arg1);
	}
