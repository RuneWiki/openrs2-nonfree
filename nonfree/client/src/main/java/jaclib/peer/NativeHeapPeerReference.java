...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/gga;Lclient!jaclib/peer/ku;)V")
	public NativeHeapPeerReference(@OriginalArg(0) gga arg0, @OriginalArg(1) ku arg1) {
		super(arg0, arg1);
	}
