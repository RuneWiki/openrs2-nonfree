...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/pr;Lclient!jaclib/peer/uca;)V")
	public NativeHeapPeerReference(@OriginalArg(0) pr arg0, @OriginalArg(1) uca arg1) {
		super(arg0, arg1);
	}
