...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/je;Lclient!jaclib/peer/dba;)V")
	public NativeHeapPeerReference(@OriginalArg(0) je arg0, @OriginalArg(1) dba arg1) {
		super(arg0, arg1);
	}
