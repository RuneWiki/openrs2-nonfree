...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/md;Lclient!jaclib/peer/mba;)V")
	public NativeHeapPeerReference(@OriginalArg(0) md arg0, @OriginalArg(1) mba arg1) {
		super(arg0, arg1);
	}
