...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/jd;Lclient!jaclib/peer/ks;)V")
	public NativeHeapPeerReference(@OriginalArg(0) jd arg0, @OriginalArg(1) ks arg1) {
		super(arg0, arg1);
	}
