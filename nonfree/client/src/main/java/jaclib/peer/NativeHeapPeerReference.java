...
public final class NativeHeapPeerReference extends PeerReference {
	...
	@OriginalMember(owner = "client!jaclib/peer/NativeHeapPeerReference", name = "<init>", descriptor = "(Lclient!jaclib/peer/mf;Lclient!jaclib/peer/io;)V")
	public NativeHeapPeerReference(@OriginalArg(0) mf arg0, @OriginalArg(1) io arg1) {
		super(arg0, arg1);
	}
