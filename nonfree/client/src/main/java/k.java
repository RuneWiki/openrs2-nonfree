...
public final class k implements Interface8 {
	...
	@OriginalMember(owner = "client!k", name = "b", descriptor = "Lclient!w;")
	private final w aW2;
	...
	public native void LA(@OriginalArg(0) Class59 arg0, @OriginalArg(1) Class31 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4);

	@OriginalMember(owner = "client!k", name = "aa", descriptor = "(Lclient!ya;IIIIIII[[Z)V")
	public native void aa(@OriginalArg(0) Class162 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean[][] arg8);

	@OriginalMember(owner = "client!k", name = "ya", descriptor = "(Lclient!za;II)V")
	private native void ya(@OriginalArg(0) Class163 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
	...
	public native void W(@OriginalArg(0) Class162 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!k", name = "J", descriptor = "(Lclient!za;[I[I[I[SI)V")
	public native void J(@OriginalArg(0) Class163 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5);

	@OriginalMember(owner = "client!k", name = "MA", descriptor = "(Lclient!e;Lclient!c;[II)V")
	public native void MA(@OriginalArg(0) Class59 arg0, @OriginalArg(1) Class31 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3);

	@OriginalMember(owner = "client!k", name = "a", descriptor = "(Lclient!xa;BIZ)Lclient!e;")
	public Class59 method2695(@OriginalArg(0) xa arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) xa local8;
		@Pc(5) xa local5;
		if (arg1 == 1) {
			local5 = this.aXa10;
		...
		local8.aClass155Array4 = arg0.aClass155Array4;
		local8.aClass199Array4 = arg0.aClass199Array4;
		return local8;
	}

	@OriginalMember(owner = "client!k", name = "va", descriptor = "(Lclient!za;[Lclient!e;Lclient!c;[III)V")
	public native void va(@OriginalArg(0) Class163 arg0, @OriginalArg(1) Class59[] arg1, @OriginalArg(2) Class31 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5);

	@OriginalMember(owner = "client!k", name = "ia", descriptor = "(Lclient!e;IILclient!c;Z)Z")
	public native boolean ia(@OriginalArg(0) Class59 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class31 arg3, @OriginalArg(4) boolean arg4);
	...
	public native void q(@OriginalArg(0) Class163 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
	...
	public native void D(@OriginalArg(0) Class163 arg0, @OriginalArg(1) Class59[] arg1, @OriginalArg(2) Class31 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);

	@OriginalMember(owner = "client!k", name = "FA", descriptor = "(Lclient!za;Lclient!e;Lclient!c;[II[I[I[I[S[BI[I)V")
	public native void FA(@OriginalArg(0) Class163 arg0, @OriginalArg(1) Class59 arg1, @OriginalArg(2) Class31 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);

	@OriginalMember(owner = "client!k", name = "s", descriptor = "(Lclient!e;Lclient!e;IIIZ)V")
	public native void s(@OriginalArg(0) Class59 arg0, @OriginalArg(1) Class59 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
}
