...
public final class k implements Interface12 {
	...
	public native void LA(@OriginalArg(0) Class57 arg0, @OriginalArg(1) Class32 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4);
	...
	public native void W(@OriginalArg(0) Class157 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!k", name = "a", descriptor = "(Lclient!xa;BIZ)Lclient!e;")
	public Class57 method2898(@OriginalArg(0) xa arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) xa local8;
		@Pc(5) xa local5;
		if (arg1 == 1) {
			local5 = this.aXa6;
		...
		local8.aClass229Array4 = arg0.aClass229Array4;
		local8.aClass181Array4 = arg0.aClass181Array4;
		return local8;
	}
	...
	private native void ya(@OriginalArg(0) Class34 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!k", name = "ia", descriptor = "(Lclient!e;IILclient!c;Z)Z")
	public native boolean ia(@OriginalArg(0) Class57 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class32 arg3, @OriginalArg(4) boolean arg4);

	@OriginalMember(owner = "client!k", name = "aa", descriptor = "(Lclient!ya;IIIIIII[[Z)V")
	public native void aa(@OriginalArg(0) Class157 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean[][] arg8);
	...
	public native void FA(@OriginalArg(0) Class34 arg0, @OriginalArg(1) Class57 arg1, @OriginalArg(2) Class32 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);

	@OriginalMember(owner = "client!k", name = "va", descriptor = "(Lclient!za;[Lclient!e;Lclient!c;[III)V")
	public native void va(@OriginalArg(0) Class34 arg0, @OriginalArg(1) Class57[] arg1, @OriginalArg(2) Class32 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5);

	@OriginalMember(owner = "client!k", name = "q", descriptor = "(Lclient!za;IIIIIII)V")
	public native void q(@OriginalArg(0) Class34 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
	...
	public native void MA(@OriginalArg(0) Class57 arg0, @OriginalArg(1) Class32 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3);

	@OriginalMember(owner = "client!k", name = "J", descriptor = "(Lclient!za;[I[I[I[SI)V")
	public native void J(@OriginalArg(0) Class34 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5);

	@OriginalMember(owner = "client!k", name = "D", descriptor = "(Lclient!za;[Lclient!e;Lclient!c;[II[I[I[I[S[BI[I)V")
	public native void D(@OriginalArg(0) Class34 arg0, @OriginalArg(1) Class57[] arg1, @OriginalArg(2) Class32 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);
}
