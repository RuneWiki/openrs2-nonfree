...
public final class k implements Interface13 {
	...
	@OriginalMember(owner = "client!k", name = "g", descriptor = "Lclient!w;")
	private final w aW2;
	...
	public native void W(@OriginalArg(0) Class22 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!k", name = "MA", descriptor = "(Lclient!e;Lclient!c;[II)V")
	public native void MA(@OriginalArg(0) Class63 arg0, @OriginalArg(1) Class6 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3);
	...
	public native void FA(@OriginalArg(0) Class75 arg0, @OriginalArg(1) Class63 arg1, @OriginalArg(2) Class6 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);

	@OriginalMember(owner = "client!k", name = "p", descriptor = "()V")
	public native void p();

	@OriginalMember(owner = "client!k", name = "ya", descriptor = "(Lclient!za;II)V")
	private native void ya(@OriginalArg(0) Class75 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!k", name = "q", descriptor = "(Lclient!za;IIIIIII)V")
	public native void q(@OriginalArg(0) Class75 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
	...
	public native void J(@OriginalArg(0) Class75 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5);

	@OriginalMember(owner = "client!k", name = "va", descriptor = "(Lclient!za;[Lclient!e;Lclient!c;[III)V")
	public native void va(@OriginalArg(0) Class75 arg0, @OriginalArg(1) Class63[] arg1, @OriginalArg(2) Class6 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5);

	@OriginalMember(owner = "client!k", name = "LA", descriptor = "(Lclient!e;Lclient!c;[III)V")
	public native void LA(@OriginalArg(0) Class63 arg0, @OriginalArg(1) Class6 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4);

	@OriginalMember(owner = "client!k", name = "aa", descriptor = "(Lclient!ya;IIIIIII[[Z)V")
	public native void aa(@OriginalArg(0) Class22 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean[][] arg8);
	...
	public Class63 method2919(@OriginalArg(0) xa arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) xa local8;
		@Pc(5) xa local5;
		if (arg1 == 1) {
			local5 = this.aXa5;
		...
		local8.aClass191Array4 = arg0.aClass191Array4;
		local8.aClass254Array4 = arg0.aClass254Array4;
		return local8;
	}
	...
	public native boolean ia(@OriginalArg(0) Class63 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class6 arg3, @OriginalArg(4) boolean arg4);

	@OriginalMember(owner = "client!k", name = "D", descriptor = "(Lclient!za;[Lclient!e;Lclient!c;[II[I[I[I[S[BI[I)V")
	public native void D(@OriginalArg(0) Class75 arg0, @OriginalArg(1) Class63[] arg1, @OriginalArg(2) Class6 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);
}
