...
public final class k implements Interface11 {
	...
	@OriginalMember(owner = "client!k", name = "e", descriptor = "Lclient!w;")
	private final w aW2;
	...
	public native void W(@OriginalArg(0) Class154 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);

	@OriginalMember(owner = "client!k", name = "q", descriptor = "(Lclient!za;IIIIIII)V")
	public native void q(@OriginalArg(0) Class50 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);

	@OriginalMember(owner = "client!k", name = "FA", descriptor = "(Lclient!za;Lclient!e;Lclient!c;[II[I[I[I[S[BI[I)V")
	public native void FA(@OriginalArg(0) Class50 arg0, @OriginalArg(1) Class63 arg1, @OriginalArg(2) Class34 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);

	@OriginalMember(owner = "client!k", name = "LA", descriptor = "(Lclient!e;Lclient!c;[III)V")
	public native void LA(@OriginalArg(0) Class63 arg0, @OriginalArg(1) Class34 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4);

	@OriginalMember(owner = "client!k", name = "J", descriptor = "(Lclient!za;[I[I[I[SI)V")
	public native void J(@OriginalArg(0) Class50 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) short[] arg4, @OriginalArg(5) int arg5);

	@OriginalMember(owner = "client!k", name = "aa", descriptor = "(Lclient!ya;IIIIIII[[Z)V")
	public native void aa(@OriginalArg(0) Class154 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) boolean[][] arg8);

	@OriginalMember(owner = "client!k", name = "s", descriptor = "(Lclient!e;Lclient!e;IIIZ)V")
	public native void s(@OriginalArg(0) Class63 arg0, @OriginalArg(1) Class63 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5);
	...
	public native boolean ia(@OriginalArg(0) Class63 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class34 arg3, @OriginalArg(4) boolean arg4);
	...
	public native void D(@OriginalArg(0) Class50 arg0, @OriginalArg(1) Class63[] arg1, @OriginalArg(2) Class34 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7, @OriginalArg(8) short[] arg8, @OriginalArg(9) byte[] arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int[] arg11);
	...
	public native void MA(@OriginalArg(0) Class63 arg0, @OriginalArg(1) Class34 arg1, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3);

	@OriginalMember(owner = "client!k", name = "a", descriptor = "(Lclient!xa;BIZ)Lclient!e;")
	public Class63 method3217(@OriginalArg(0) xa arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3) {
		@Pc(8) xa local8;
		@Pc(5) xa local5;
		if (arg1 == 1) {
			local5 = this.aXa3;
		...
		local8.aClass78Array4 = arg0.aClass78Array4;
		local8.aClass141Array4 = arg0.aClass141Array4;
		return local8;
	}
	...
	public native void va(@OriginalArg(0) Class50 arg0, @OriginalArg(1) Class63[] arg1, @OriginalArg(2) Class34 arg2, @OriginalArg(3) int[] arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5);
	...
	private native void ya(@OriginalArg(0) Class50 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2);
}
