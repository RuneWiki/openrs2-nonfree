...
public final class Static686 {
	...
	@OriginalMember(owner = "client!ws", name = "a", descriptor = "(I[B[IIIIIIIILclient!ws;)I")
	public static int method9762(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub26_Sub5 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt11403 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!ws", name = "a", descriptor = "(II[B[IIIIIIIILclient!ws;II)I")
	public static int method9766(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub26_Sub5 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
		...
		arg8.anInt11403 = arg2;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!ws", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!ws;II)I")
	public static int method9768(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub26_Sub5 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt11409 -= arg10.anInt11396 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt11409 += arg10.anInt11396 * local63;
		arg10.anInt11408 = arg4;
		arg10.anInt11401 = arg5;
		arg10.anInt11403 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!ws", name = "b", descriptor = "(II[B[IIIIIIIILclient!ws;II)I")
	public static int method9769(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub26_Sub5 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ws", name = "b", descriptor = "(I[B[IIIIIIIILclient!ws;)I")
	public static int method9771(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class2_Sub26_Sub5 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!ws", name = "a", descriptor = "(II[B[IIIIIIILclient!ws;II)I")
	public static int method9773(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub26_Sub5 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
		...
		arg7.anInt11403 = arg2;
		return arg3;
	}

	@OriginalMember(owner = "client!ws", name = "a", descriptor = "([B[IIIIIIIILclient!ws;)I")
	public static int method9774(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub26_Sub5 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt11408 += arg8.anInt11405 * (local22 - arg3);
		arg8.anInt11401 += arg8.anInt11399 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt11409 = arg4 >> 2;
		arg8.anInt11403 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ws", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!ws;)I")
	public static int method9775(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub26_Sub5 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt11409 += arg10.anInt11396 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt11408 = arg4 >> 2;
		arg10.anInt11401 = arg5 >> 2;
		arg10.anInt11403 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!ws", name = "b", descriptor = "(II[B[IIIIIIILclient!ws;II)I")
	public static int method9778(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub26_Sub5 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!ws", name = "c", descriptor = "(II[B[IIIIIIIILclient!ws;II)I")
	public static int method9779(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub26_Sub5 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt11408 -= arg8.anInt11405 * arg3;
		arg8.anInt11401 -= arg8.anInt11399 * arg3;
		@Pc(32) int local32;
		...
		arg8.anInt11408 += arg8.anInt11405 * arg3;
		arg8.anInt11401 += arg8.anInt11399 * arg3;
		arg8.anInt11409 = arg4;
		arg8.anInt11403 = arg2;
		return arg3;
	}

	@OriginalMember(owner = "client!ws", name = "b", descriptor = "(II)I")
	public static int method9780(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ws", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!ws;)I")
	public static int method9784(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class2_Sub26_Sub5 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt11409 += arg10.anInt11396 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!ws", name = "d", descriptor = "(II[B[IIIIIIIILclient!ws;II)I")
	public static int method9785(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class2_Sub26_Sub5 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt11408 -= arg8.anInt11405 * arg3;
		arg8.anInt11401 -= arg8.anInt11399 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!ws", name = "a", descriptor = "([B[IIIIIIILclient!ws;)I")
	public static int method9789(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub26_Sub5 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt11403 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!ws", name = "b", descriptor = "([B[IIIIIIIILclient!ws;)I")
	public static int method9790(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class2_Sub26_Sub5 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt11408 += arg8.anInt11405 * (local24 - arg3);
		arg8.anInt11401 += arg8.anInt11399 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!ws", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!ws;II)I")
	public static int method9794(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class2_Sub26_Sub5 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt11409 -= arg10.anInt11396 * arg3;
		@Pc(23) int local23;
	...
	public static int method9795(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lclient!ud;III)Lclient!ws;")
	public static Class2_Sub26_Sub5 method9797(@OriginalArg(0) Class2_Sub44_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray92 == null || arg0.aByteArray92.length == 0 ? null : new Class2_Sub26_Sub5(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!ws", name = "b", descriptor = "([B[IIIIIIILclient!ws;)I")
	public static int method9800(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub26_Sub5 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
