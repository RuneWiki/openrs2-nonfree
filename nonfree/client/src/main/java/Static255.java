...
public final class Static255 {
	...
	@OriginalMember(owner = "client!jg", name = "a", descriptor = "Lclient!we;")
	public static final Class373 aClass373_3 = new Class373();

	@OriginalMember(owner = "client!jg", name = "i", descriptor = "Z")
	public static boolean aBoolean329 = false;

	@OriginalMember(owner = "client!jg", name = "m", descriptor = "Lclient!we;")
	public static final Class373 aClass373_4 = new Class373();

	@OriginalMember(owner = "client!jg", name = "a", descriptor = "(IB)Lclient!fw;")
	public static Class5_Sub2 method4188(@OriginalArg(0) int arg0) {
		if (arg0 == 0) {
			...
			return new Class5_Sub2_Sub13_Sub1();
		} else if (arg0 == 19) {
