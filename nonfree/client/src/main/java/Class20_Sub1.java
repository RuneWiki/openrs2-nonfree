...
public final class Class20_Sub1 extends Class20 {
	...
	@OriginalMember(owner = "client!ca", name = "a", descriptor = "(I[B)V")
	@Override
	public void method445(@OriginalArg(1) byte[] arg0) {
		this.aByteBuffer1 = ByteBuffer.allocateDirect(arg0.length);
		this.aByteBuffer1.position(0);
		this.aByteBuffer1.put(arg0);
	}

	@OriginalMember(owner = "client!ca", name = "a", descriptor = "(B)[B")
	@Override
	public byte[] method444() {
