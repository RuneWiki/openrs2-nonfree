...
public final class Static113 {
	...
	@OriginalMember(owner = "client!mb", name = "a", descriptor = "(II[B[IIIIIIILclient!mb;II)I")
	public static int method882(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class10_Sub5_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!mb", name = "a", descriptor = "([B[IIIIIIILclient!mb;)I")
	public static int method883(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class10_Sub5_Sub2 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt1583 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!mb", name = "a", descriptor = "(II[B[IIIIIIIIILclient!mb;II)I")
	public static int method884(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) Class10_Sub5_Sub2 arg9, @OriginalArg(13) int arg10, @OriginalArg(14) int arg11) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!mb", name = "b", descriptor = "(II[B[IIIIIIIIILclient!mb;II)I")
	public static int method885(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) Class10_Sub5_Sub2 arg9, @OriginalArg(13) int arg10, @OriginalArg(14) int arg11) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!mb", name = "a", descriptor = "([B[IIIIIIIIILclient!mb;)I")
	public static int method886(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class10_Sub5_Sub2 arg9) {
		arg2 >>= 0x8;
		...
		arg9.anInt1584 = arg4 >> 8;
		arg9.anInt1583 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!mb", name = "b", descriptor = "(II[B[IIIIIIILclient!mb;II)I")
	public static int method887(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class10_Sub5_Sub2 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	public static Class10_Sub5_Sub2 method890(@OriginalArg(0) Class10_Sub9_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray6 == null || arg0.aByteArray6.length == 0 ? null : new Class10_Sub5_Sub2(arg0, (int) ((long) arg0.anInt1839 * 256L * (long) 100 / (long) (Static29.anInt894 * 100)), arg1);
	}

	@OriginalMember(owner = "client!mb", name = "b", descriptor = "([B[IIIIIIILclient!mb;)I")
	public static int method891(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class10_Sub5_Sub2 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 8;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!mb", name = "b", descriptor = "([B[IIIIIIIIILclient!mb;)I")
	public static int method893(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class10_Sub5_Sub2 arg9) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg8 >> 8;
		arg4 <<= 0x8;
		@Pc(18) int local18;
