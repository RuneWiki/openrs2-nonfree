...
public final class Static113 {
	...
	@OriginalMember(owner = "client!pa", name = "a", descriptor = "([B[IIIIIIILclient!pa;)I")
	public static int method1319(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub10_Sub1 arg7) {
		arg2 >>= 0x8;
	...
	@OriginalMember(owner = "client!pa", name = "a", descriptor = "(Lclient!nd;II)Lclient!pa;")
	public static Class2_Sub10_Sub1 method1321(@OriginalArg(0) Class2_Sub4_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray53 == null || arg0.aByteArray53.length == 0 ? null : new Class2_Sub10_Sub1(arg0, (int) ((long) arg0.anInt2061 * 256L * (long) 100 / (long) (Static42.anInt1353 * 100)), arg1);
	}

	@OriginalMember(owner = "client!pa", name = "a", descriptor = "([B[IIIIIIIIILclient!pa;)I")
	public static int method1322(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class2_Sub10_Sub1 arg9) {
		arg2 >>= 0x8;
		...
		arg9.anInt2233 = arg4 >> 8;
		arg9.anInt2234 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!pa", name = "a", descriptor = "(II[B[IIIIIIILclient!pa;II)I")
	public static int method1323(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub10_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!pa", name = "b", descriptor = "(II[B[IIIIIIILclient!pa;II)I")
	public static int method1324(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class2_Sub10_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!pa", name = "b", descriptor = "([B[IIIIIIIIILclient!pa;)I")
	public static int method1325(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) Class2_Sub10_Sub1 arg9) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg8 >> 8;
		arg4 <<= 0x8;
		@Pc(15) int local15 = arg6 << 8;
	...
	@OriginalMember(owner = "client!pa", name = "b", descriptor = "([B[IIIIIIILclient!pa;)I")
	public static int method1330(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class2_Sub10_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 8;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!pa", name = "b", descriptor = "(II[B[IIIIIIIIILclient!pa;II)I")
