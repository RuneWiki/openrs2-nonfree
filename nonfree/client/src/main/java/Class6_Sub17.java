...
public final class Class6_Sub17 extends Class6 {
	...
	@OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(ILclient!hs;)V")
	public Class6_Sub17(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub25 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lclient!hs;)V")
	public Class6_Sub17(@OriginalArg(0) Class5_Sub25 arg0) {
		super(arg0);
	}
