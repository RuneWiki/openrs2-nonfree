...
public final class Static597 {
	...
	@OriginalMember(owner = "client!am", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!am;II)I")
	public static int method273(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub4_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt343 -= arg10.anInt337 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt343 += arg10.anInt337 * local63;
		arg10.anInt339 = arg4;
		arg10.anInt341 = arg5;
		arg10.anInt342 = arg2;
		return local63;
	...
	@OriginalMember(owner = "client!am", name = "a", descriptor = "([B[IIIIIIIILclient!am;)I")
	public static int method276(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub4_Sub1 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt339 += arg8.anInt334 * (local24 - arg3);
		arg8.anInt341 += arg8.anInt332 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
		...
		arg8.anInt343 = arg4 >> 2;
		arg8.anInt342 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!am", name = "a", descriptor = "(Lclient!ug;III)Lclient!am;")
	public static Class3_Sub4_Sub1 method277(@OriginalArg(0) Class3_Sub48_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray91 == null || arg0.aByteArray91.length == 0 ? null : new Class3_Sub4_Sub1(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!am", name = "a", descriptor = "(II[B[IIIIIIILclient!am;II)I")
	public static int method278(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub4_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!am", name = "a", descriptor = "(II[B[IIIIIIIILclient!am;II)I")
	public static int method279(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub4_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!am", name = "a", descriptor = "(I[B[IIIIIIIILclient!am;)I")
	public static int method284(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub4_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
	...
	@OriginalMember(owner = "client!am", name = "b", descriptor = "(II[B[IIIIIIIILclient!am;II)I")
	public static int method285(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub4_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt339 -= arg8.anInt334 * arg3;
		arg8.anInt341 -= arg8.anInt332 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!am", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!am;)I")
	public static int method290(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub4_Sub1 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt343 += arg10.anInt337 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt339 = arg4 >> 2;
		arg10.anInt341 = arg5 >> 2;
		arg10.anInt342 = arg2 << 8;
		return arg3 >> 1;
	}
	...
	@OriginalMember(owner = "client!am", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!am;)I")
	public static int method295(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class3_Sub4_Sub1 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt343 += arg10.anInt337 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!am", name = "a", descriptor = "([B[IIIIIIILclient!am;)I")
	public static int method300(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub4_Sub1 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt342 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!am", name = "b", descriptor = "(I[B[IIIIIIIILclient!am;)I")
	public static int method302(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class3_Sub4_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!am", name = "b", descriptor = "(II[B[IIIIIIILclient!am;II)I")
	public static int method304(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class3_Sub4_Sub1 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!am", name = "b", descriptor = "([B[IIIIIIILclient!am;)I")
	public static int method305(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class3_Sub4_Sub1 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(18) int local18;
	...
	@OriginalMember(owner = "client!am", name = "c", descriptor = "(II[B[IIIIIIIILclient!am;II)I")
	public static int method307(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub4_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!am", name = "a", descriptor = "(Lclient!ug;II)Lclient!am;")
	public static Class3_Sub4_Sub1 method308(@OriginalArg(0) Class3_Sub48_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray91 == null || arg0.aByteArray91.length == 0 ? null : new Class3_Sub4_Sub1(arg0, (int) ((long) arg0.anInt8529 * 256L * (long) 100 / (long) (Static404.anInt6999 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!am", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!am;II)I")
	public static int method309(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class3_Sub4_Sub1 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt343 -= arg10.anInt337 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!am", name = "d", descriptor = "(II[B[IIIIIIIILclient!am;II)I")
	public static int method310(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class3_Sub4_Sub1 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt339 -= arg8.anInt334 * arg3;
		arg8.anInt341 -= arg8.anInt332 * arg3;
		@Pc(32) int local32;
	...
	public static int method311(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!am", name = "b", descriptor = "([B[IIIIIIIILclient!am;)I")
	public static int method312(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class3_Sub4_Sub1 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt339 += arg8.anInt334 * (local22 - arg3);
		arg8.anInt341 += arg8.anInt332 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
