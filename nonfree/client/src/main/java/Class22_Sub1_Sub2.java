...
public final class Class22_Sub1_Sub2 extends Class22_Sub1 {
	...
	private final byte[] aByteArray19 = new byte[512];
	...
	public Class22_Sub1_Sub2() throws Exception {
		super(22050);
	}

	@OriginalMember(owner = "client!lb", name = "b", descriptor = "(I)V")
	@Override
	protected void method999(@OriginalArg(0) int arg0) throws LineUnavailableException {
		try {
	...
	protected void method1000() {
		for (@Pc(1) int local1 = 0; local1 < 256; local1++) {
			@Pc(8) int local8 = Static105.anIntArray210[local1];
			if ((local8 + 8388608 & 0xFF000000) != 0) {
				local8 = local8 >> 31 ^ 0x7FFFFF;
			}
			this.aByteArray19[local1 * 2] = (byte) (local8 >> 8);
			this.aByteArray19[local1 * 2 + 1] = (byte) (local8 >> 16);
		}
		this.aSourceDataLine1.write(this.aByteArray19, 0, 512);
	}
