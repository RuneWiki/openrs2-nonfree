...
public final class Class3_Sub16 extends Class3 {
	...
	public Class3_Sub16(@OriginalArg(0) byte[] arg0) {
		this.method3141(arg0);
	}

	@OriginalMember(owner = "client!gw", name = "a", descriptor = "([I)Lclient!bp;")
	public Class3_Sub6_Sub1 method3134(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray53 == null) {
			this.anInt3581 = 0;
			this.aFloatArray23 = new float[Static176.anInt3582];
			this.aByteArray53 = new byte[this.anInt3573];
			this.anInt3584 = 0;
			this.anInt3583 = 0;
		}
		while (this.anInt3583 < this.aByteArrayArray15.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method3143(this.anInt3583);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt3584;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt3573 - local47) {
					local50 = this.anInt3573 - local47;
				}
				for (@Pc(63) int local63 = 0; local63 < local50; local63++) {
					...
					this.aByteArray53[local47++] = (byte) (local73 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt3584;
				}
				this.anInt3584 = local47;
			}
			this.anInt3583++;
		}
		this.aFloatArray23 = null;
		@Pc(129) byte[] local129 = this.aByteArray53;
		this.aByteArray53 = null;
		return new Class3_Sub6_Sub1(this.anInt3578, local129, this.anInt3580, this.anInt3577, this.aBoolean279);
	}

	@OriginalMember(owner = "client!gw", name = "b", descriptor = "([B)V")
	private void method3141(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class3_Sub7 local4 = new Class3_Sub7(arg0);
		this.anInt3578 = local4.method6497();
		this.anInt3573 = local4.method6497();
		this.anInt3580 = local4.method6497();
		this.anInt3577 = local4.method6497();
		if (this.anInt3577 < 0) {
			this.anInt3577 = ~this.anInt3577;
			this.aBoolean279 = true;
		}
		@Pc(40) int local40 = local4.method6497();
		this.aByteArrayArray15 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method6538();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method6540(local64, local49);
			this.aByteArrayArray15[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!gw", name = "b", descriptor = "(I)[F")
	private float[] method3143(@OriginalArg(0) int arg0) {
		Static176.method3138(this.aByteArrayArray15[arg0]);
		Static176.method3144();
		@Pc(15) int local15 = Static176.method3137(Static373.method6080(Static176.anIntArray236.length - 1));
		@Pc(19) boolean local19 = Static176.aBooleanArray11[local15];
		@Pc(25) int local25 = local19 ? Static176.anInt3582 : Static176.anInt3574;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static176.method3144() != 0;
			local29 = Static176.method3144() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static176.anInt3574 >> 2);
			local67 = (local25 >> 2) + (Static176.anInt3574 >> 2);
			local71 = Static176.anInt3574 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static176.anInt3574 >> 2);
			local104 = local25 + (Static176.anInt3574 >> 2) - (local25 >> 2);
			local108 = Static176.anInt3574 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class61 local123 = Static176.aClass61Array1[Static176.anIntArray236[local15]];
		@Pc(126) int local126 = local123.anInt2259;
		@Pc(131) int local131 = local123.anIntArray109[local126];
		@Pc(140) boolean local140 = !Static176.aClass119Array1[local131].method3050();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt2258; local144++) {
			@Pc(152) Class35 local152 = Static176.aClass35Array1[local123.anIntArray108[local144]];
			local154 = Static176.aFloatArray21;
			local152.method1172(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt2259;
			local176 = local123.anIntArray109[local171];
			Static176.aClass119Array1[local176].method3048(Static176.aFloatArray21, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static176.aFloatArray21[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static176.aFloatArray21;
			...
			@Pc(252) float[] local252 = local19 ? Static176.aFloatArray26 : Static176.aFloatArray24;
			@Pc(258) float[] local258 = local19 ? Static176.aFloatArray28 : Static176.aFloatArray27;
			@Pc(264) float[] local264 = local19 ? Static176.aFloatArray25 : Static176.aFloatArray22;
			@Pc(270) int[] local270 = local19 ? Static176.anIntArray235 : Static176.anIntArray234;
			...
			@Pc(486) int local486 = Static373.method6080(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static176.aFloatArray21[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static176.aFloatArray21[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt3581 > 0) {
			local176 = this.anInt3581 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean280) {
				for (local212 = 0; local212 < this.anInt3576; local212++) {
					local1254 = (this.anInt3581 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static176.aFloatArray21[local212];
				}
			}
		}
		local154 = this.aFloatArray23;
		this.aFloatArray23 = Static176.aFloatArray21;
		Static176.aFloatArray21 = local154;
		this.anInt3581 = local25;
		this.anInt3576 = local104 - (local25 >> 1);
		this.aBoolean280 = local140;
		return local1228;
	}
}
