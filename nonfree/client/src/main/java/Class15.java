...
public final class Class15 {
	...
	public static void method331(@OriginalArg(0) Class39 arg0, @OriginalArg(1) Class1_Sub3_Sub2_Sub4[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Class39 arg3) {
		try {
			...
			@Pc(27) Class1_Sub3_Sub3 local27 = new Class1_Sub3_Sub3(363, arg3.method536("data", null));
			@Pc(29) int local29 = -1;
				...
				do {
						...
						for (local155 = 0; local155 < 20; local155++) {
							...
							if (local160 == 1) {
								...
								if (arg0 != null && local352.length() > 0) {
									...
									local62.aClass1_Sub3_Sub2_Sub2Array8[local155] = method333(arg0, Integer.parseInt(local352.substring(local361 + 1)), local352.substring(0, local361));
								}
							}
						}
					...
					if (local62.anInt472 == 5) {
						...
						if (arg0 != null && local511.length() > 0) {
							...
							local62.aClass1_Sub3_Sub2_Sub2_12 = method333(arg0, Integer.parseInt(local511.substring(local160 + 1)), local511.substring(0, local160));
						}
						local511 = local27.method398();
						if (arg0 != null && local511.length() > 0) {
							local160 = local511.lastIndexOf(",");
							local62.aClass1_Sub3_Sub2_Sub2_13 = method333(arg0, Integer.parseInt(local511.substring(local160 + 1)), local511.substring(0, local160));
						}
					}
					if (local62.anInt472 == 6) {
						local45 = local27.method391();
						if (local45 != 0) {
							local62.aClass1_Sub3_Sub1_2 = method334((local45 - 1 << 8) + local27.method391());
						}
						local45 = local27.method391();
						if (local45 != 0) {
							local62.aClass1_Sub3_Sub1_3 = method334((local45 - 1 << 8) + local27.method391());
						}
						local45 = local27.method391();
						if (local45 == 0) {
							local62.anInt488 = -1;
	...
	private static Class1_Sub3_Sub2_Sub2 method333(@OriginalArg(0) Class39 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2) {
		try {
			@Pc(8) long local8 = (Class40.method540(arg2) << 8) + (long) arg1;
			...
			try {
				...
				aClass35_6.method528(local8, local13);
				return local13;
			} catch (@Pc(38) Exception local38) {
				return null;
			}
		} catch (@Pc(43) RuntimeException local43) {
			signlink.reporterror("51863, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + -36068 + ", " + local43.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!hc", name = "a", descriptor = "(II)Lclient!eb;")
	private static Class1_Sub3_Sub1 method334(@OriginalArg(1) int arg0) {
		try {
			@Pc(5) Class1_Sub3_Sub1 local5 = (Class1_Sub3_Sub1) aClass35_7.method527((long) arg0);
			if (local5 == null) {
				local5 = new Class1_Sub3_Sub1(false, arg0);
				aClass35_7.method528((long) arg0, local5);
				return local5;
			} else {
				return local5;
			}
		} catch (@Pc(33) RuntimeException local33) {
			signlink.reporterror("7272, " + 4 + ", " + arg0 + ", " + local33.toString());
			throw new RuntimeException();
		}
	}

	@OriginalMember(owner = "client!hc", name = "a", descriptor = "(IIZ)Lclient!eb;")
	public Class1_Sub3_Sub1 method332(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		@Pc(2) Class1_Sub3_Sub1 local2 = this.aClass1_Sub3_Sub1_2;
		if (arg2) {
		...
		if (local2 == null) {
			...
			@Pc(31) Class1_Sub3_Sub1 local31 = new Class1_Sub3_Sub1(local2, true, true, anInt467, false);
			if (arg0 != -1 || arg1 != -1) {
				local31.method230();
			}
			if (arg0 != -1) {
				local31.method231(arg0);
			}
			if (arg1 != -1) {
				local31.method231(arg1);
			}
