...
public final class Class3_Sub36 extends Class3 {
	...
	public Class3_Sub36(@OriginalArg(0) byte[] arg0) {
		this.method6554(arg0);
	}

	@OriginalMember(owner = "client!ob", name = "a", descriptor = "(I)[F")
	private float[] method6545(@OriginalArg(0) int arg0) {
		Static446.method6549(this.aByteArrayArray11[arg0]);
		Static446.method6548();
		@Pc(15) int local15 = Static446.method6556(Static700.method9156(Static446.anIntArray420.length - 1));
		@Pc(19) boolean local19 = Static446.aBooleanArray19[local15];
		@Pc(25) int local25 = local19 ? Static446.anInt7728 : Static446.anInt7729;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static446.method6548() != 0;
			local29 = Static446.method6548() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static446.anInt7729 >> 2);
			local67 = (local25 >> 2) + (Static446.anInt7729 >> 2);
			local71 = Static446.anInt7729 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static446.anInt7729 >> 2);
			local104 = local25 + (Static446.anInt7729 >> 2) - (local25 >> 2);
			local108 = Static446.anInt7729 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class315 local123 = Static446.aClass315Array1[Static446.anIntArray420[local15]];
		@Pc(126) int local126 = local123.anInt9113;
		@Pc(131) int local131 = local123.anIntArray500[local126];
		@Pc(140) boolean local140 = !Static446.aClass137Array1[local131].method3520();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt9114; local144++) {
			@Pc(152) Class398 local152 = Static446.aClass398Array1[local123.anIntArray501[local144]];
			local154 = Static446.aFloatArray84;
			local152.method9190(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt9113;
			local176 = local123.anIntArray500[local171];
			Static446.aClass137Array1[local176].method3519(Static446.aFloatArray84, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static446.aFloatArray84[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static446.aFloatArray84;
			...
			@Pc(252) float[] local252 = local19 ? Static446.aFloatArray78 : Static446.aFloatArray80;
			@Pc(258) float[] local258 = local19 ? Static446.aFloatArray79 : Static446.aFloatArray81;
			@Pc(264) float[] local264 = local19 ? Static446.aFloatArray77 : Static446.aFloatArray83;
			@Pc(270) int[] local270 = local19 ? Static446.anIntArray419 : Static446.anIntArray418;
			...
			@Pc(486) int local486 = Static700.method9156(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static446.aFloatArray84[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static446.aFloatArray84[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt7731 > 0) {
			local176 = this.anInt7731 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean587) {
				for (local212 = 0; local212 < this.anInt7732; local212++) {
					local1254 = (this.anInt7731 >> 1) + local212;
					local1228[local212] += this.aFloatArray82[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static446.aFloatArray84[local212];
				}
			}
		}
		local154 = this.aFloatArray82;
		this.aFloatArray82 = Static446.aFloatArray84;
		Static446.aFloatArray84 = local154;
		this.anInt7731 = local25;
		this.anInt7732 = local104 - (local25 >> 1);
		this.aBoolean587 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!ob", name = "a", descriptor = "([I)Lclient!mca;")
	public Class3_Sub33_Sub1 method6550(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray68 == null) {
			this.anInt7731 = 0;
			this.aFloatArray82 = new float[Static446.anInt7728];
			this.aByteArray68 = new byte[this.anInt7725];
			this.anInt7734 = 0;
			this.anInt7733 = 0;
		}
		while (this.anInt7733 < this.aByteArrayArray11.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method6545(this.anInt7733);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt7734;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt7725 - local47) {
					local50 = this.anInt7725 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt7734;
				}
				this.anInt7734 = local47;
			}
			this.anInt7733++;
		}
		this.aFloatArray82 = null;
		@Pc(129) byte[] local129 = this.aByteArray68;
		this.aByteArray68 = null;
		return new Class3_Sub33_Sub1(this.anInt7723, local129, this.anInt7724, this.anInt7730, this.aBoolean589);
	}

	@OriginalMember(owner = "client!ob", name = "b", descriptor = "([B)V")
	private void method6554(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class3_Sub28 local4 = new Class3_Sub28(arg0);
		this.anInt7723 = local4.method5312();
		this.anInt7725 = local4.method5312();
		this.anInt7724 = local4.method5312();
		this.anInt7730 = local4.method5312();
		if (this.anInt7730 < 0) {
			this.anInt7730 = ~this.anInt7730;
			this.aBoolean589 = true;
		}
		@Pc(40) int local40 = local4.method5312();
		this.aByteArrayArray11 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method5322(-42);
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method5271(local64, local49, 0);
