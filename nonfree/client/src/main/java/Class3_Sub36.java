...
public final class Class3_Sub36 extends Class3 {
	...
	public Class3_Sub36(@OriginalArg(0) byte[] arg0) {
		this.method5451(arg0);
	}

	@OriginalMember(owner = "client!nq", name = "a", descriptor = "([I)Lclient!ee;")
	public Class3_Sub20_Sub1 method5442(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray82 == null) {
			this.anInt6287 = 0;
			this.aFloatArray55 = new float[Static362.anInt6280];
			this.aByteArray82 = new byte[this.anInt6281];
			this.anInt6291 = 0;
			this.anInt6290 = 0;
		}
		while (this.anInt6290 < this.aByteArrayArray15.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method5446(this.anInt6290);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt6291;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt6281 - local47) {
					local50 = this.anInt6281 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt6291;
				}
				this.anInt6291 = local47;
			}
			this.anInt6290++;
		}
		...
		return new Class3_Sub20_Sub1(this.anInt6282, local129, this.anInt6289, this.anInt6285, this.aBoolean518);
	}

	@OriginalMember(owner = "client!nq", name = "a", descriptor = "(I)[F")
	private float[] method5446(@OriginalArg(0) int arg0) {
		Static362.method5445(this.aByteArrayArray15[arg0]);
		Static362.method5449();
		@Pc(15) int local15 = Static362.method5447(Static328.method5090(Static362.anIntArray494.length - 1));
		@Pc(19) boolean local19 = Static362.aBooleanArray26[local15];
		@Pc(25) int local25 = local19 ? Static362.anInt6280 : Static362.anInt6283;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static362.method5449() != 0;
			local29 = Static362.method5449() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static362.anInt6283 >> 2);
			local67 = (local25 >> 2) + (Static362.anInt6283 >> 2);
			local71 = Static362.anInt6283 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static362.anInt6283 >> 2);
			local104 = local25 + (Static362.anInt6283 >> 2) - (local25 >> 2);
			local108 = Static362.anInt6283 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class321 local123 = Static362.aClass321Array1[Static362.anIntArray494[local15]];
		@Pc(126) int local126 = local123.anInt8066;
		@Pc(131) int local131 = local123.anIntArray619[local126];
		@Pc(140) boolean local140 = !Static362.aClass208Array1[local131].method4891();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt8067; local144++) {
			@Pc(152) Class36 local152 = Static362.aClass36Array1[local123.anIntArray618[local144]];
			local154 = Static362.aFloatArray56;
			local152.method830(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt8066;
			local176 = local123.anIntArray619[local171];
			Static362.aClass208Array1[local176].method4893(Static362.aFloatArray56, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static362.aFloatArray56[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static362.aFloatArray56;
			...
			@Pc(252) float[] local252 = local19 ? Static362.aFloatArray59 : Static362.aFloatArray53;
			@Pc(258) float[] local258 = local19 ? Static362.aFloatArray57 : Static362.aFloatArray54;
			@Pc(264) float[] local264 = local19 ? Static362.aFloatArray58 : Static362.aFloatArray52;
			@Pc(270) int[] local270 = local19 ? Static362.anIntArray495 : Static362.anIntArray496;
			...
			@Pc(486) int local486 = Static328.method5090(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static362.aFloatArray56[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static362.aFloatArray56[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt6287 > 0) {
			local176 = this.anInt6287 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean519) {
				for (local212 = 0; local212 < this.anInt6288; local212++) {
					local1254 = (this.anInt6287 >> 1) + local212;
					local1228[local212] += this.aFloatArray55[local1254];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1254 = local1228.length + local212 - (local25 >> 1);
					local1228[local1254] += Static362.aFloatArray56[local212];
				}
			}
		}
		local154 = this.aFloatArray55;
		this.aFloatArray55 = Static362.aFloatArray56;
		Static362.aFloatArray56 = local154;
		this.anInt6287 = local25;
		this.anInt6288 = local104 - (local25 >> 1);
		this.aBoolean519 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!nq", name = "b", descriptor = "([B)V")
	private void method5451(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class3_Sub11 local4 = new Class3_Sub11(arg0);
		this.anInt6282 = local4.method3116();
		this.anInt6281 = local4.method3116();
		this.anInt6289 = local4.method3116();
		this.anInt6285 = local4.method3116();
		if (this.anInt6285 < 0) {
			this.anInt6285 = ~this.anInt6285;
			this.aBoolean518 = true;
		}
		@Pc(40) int local40 = local4.method3116();
		this.aByteArrayArray15 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method3118();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method3090(local49, local64);
