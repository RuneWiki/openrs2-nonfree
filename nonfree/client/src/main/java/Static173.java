...
public final class Static173 {
	...
	@OriginalMember(owner = "client!nd", name = "a", descriptor = "(IIIIII[I)V")
	public static void method2952(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int[] arg6) {
		if (arg2 == 0 || arg2 == Integer.MIN_VALUE || !Static220.method3472(arg2)) {
			throw new InvalidParameterException("width must be power of 2");
		} else if (arg3 == 0 || arg3 == Integer.MIN_VALUE || !Static220.method3472(arg3)) {
	...
	@OriginalMember(owner = "client!nd", name = "a", descriptor = "(IIIIII[F)V")
	public static void method2954(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6) {
		if (arg2 == 0 || arg2 == Integer.MIN_VALUE || !Static220.method3472(arg2)) {
			throw new InvalidParameterException("width must be power of 2");
		} else if (arg3 == 0 || arg3 == Integer.MIN_VALUE || !Static220.method3472(arg3)) {
			throw new InvalidParameterException("height must be power of 2");
			...
			@Pc(70) GL local70 = Static277.aGL1;
			@Pc(72) int local72 = 0;
