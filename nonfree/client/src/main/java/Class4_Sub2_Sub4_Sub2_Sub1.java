...
public final class Class4_Sub2_Sub4_Sub2_Sub1 extends Class4_Sub2_Sub4_Sub2 {

	@OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(II)V")
	public Class4_Sub2_Sub4_Sub2_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(IIIIII[I)V")
	public Class4_Sub2_Sub4_Sub2_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int[] arg6) {
		super(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
	}

	@OriginalMember(owner = "client!tk", name = "b", descriptor = "(IIIIIIII[I[I)V")
	@Override
		...
		try {
			...
			for (@Pc(71) int local71 = 0; local71 < arg3; local71++) {
				...
				for (@Pc(99) int local99 = -arg9[local71]; local99 < 0; local99++) {
					...
					@Pc(119) int local119 = Static258.anIntArray399[local82];
					@Pc(123) int local123 = local115 >>> 24;
					@Pc(127) int local127 = 256 - local123;
					Static258.anIntArray399[local82++] = ((local115 & 0xFF00FF) * local123 + (local119 & 0xFF00FF) * local127 & 0xFF00FF00) + ((local115 & 0xFF00) * local123 + (local119 & 0xFF00) * local127 & 0xFF0000) >>> 8;
					local88 += local39;
					local94 -= local33;
				}
				local51 += local33;
	...
	public void method4136(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		Static320.method4166(Static258.anIntArray399, this.anIntArray409, local12, local14, local46, local130, arg2, arg3, local26, local32, local7);
	}

	@OriginalMember(owner = "client!tk", name = "a", descriptor = "(IIIIIIII[I[I)V")
	@Override
	...
	public void method4143(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if (local23 > 0 && local20 > 0) {
			Static320.method4165(Static258.anIntArray399, this.anIntArray409, local17, local15, local23, local20, local27, local29, arg2);
		}
	}
		...
		if (local342 != 0) {
			...
			if (local342 < 0) {
				if (local333 == 0) {
					...
					while (local384 < 0) {
						...
						if (local378 >= 0 && local378 - (this.anInt5191 << 12) < 0) {
							@Pc(825) int local825;
							if ((local825 = local802 - (this.anInt5193 << 12)) >= 0) {
							...
							while (local394 < 0) {
								local432 = this.anIntArray409[(local378 >> 12) * this.anInt5193 + (local802 >> 12)];
								local436 = Static258.anIntArray399[local388];
								local440 = local432 >>> 24;
								local444 = 256 - local440;
								Static258.anIntArray399[local388++] = ((local432 & 0xFF00FF) * local440 + (local436 & 0xFF00FF) * local444 & 0xFF00FF00) + ((local432 & 0xFF00) * local440 + (local436 & 0xFF00) * local444 & 0xFF0000) >>> 8;
								local802 += local342;
								local394++;
							}
						}
					...
					while (local384 < 0) {
						...
						local394 = local166;
						@Pc(969) int local969;
						if ((local969 = local802 - (this.anInt5193 << 12)) >= 0) {
						...
						if ((local1015 = local504 - (this.anInt5191 << 12)) >= 0) {
						...
						while (local394 < 0) {
							local432 = this.anIntArray409[(local504 >> 12) * this.anInt5193 + (local802 >> 12)];
							local436 = Static258.anIntArray399[local388];
							local440 = local432 >>> 24;
							local444 = 256 - local440;
							Static258.anIntArray399[local388++] = ((local432 & 0xFF00FF) * local440 + (local436 & 0xFF00FF) * local444 & 0xFF00FF00) + ((local432 & 0xFF00) * local440 + (local436 & 0xFF00) * local444 & 0xFF0000) >>> 8;
					...
					while (local384 < 0) {
						...
						if ((local1171 = local802 - (this.anInt5193 << 12)) >= 0) {
						...
						if ((local1253 = (local504 + 1 - (this.anInt5191 << 12) - local333) / local333) > local394) {
							local394 = local1253;
						}
						while (local394 < 0) {
							local432 = this.anIntArray409[(local504 >> 12) * this.anInt5193 + (local802 >> 12)];
				...
				while (local384 < 0) {
					...
					if (local378 >= 0 && local378 - (this.anInt5191 << 12) < 0) {
						...
						if ((local1412 = (local802 + 1 - (this.anInt5193 << 12) - local342) / local342) > local394) {
							local394 = local1412;
						}
						while (local394 < 0) {
							local432 = this.anIntArray409[(local378 >> 12) * this.anInt5193 + (local802 >> 12)];
				...
				while (local384 < 0) {
					...
					if ((local1564 = (local802 + 1 - (this.anInt5193 << 12) - local342) / local342) > local394) {
						local394 = local1564;
					}
					@Pc(1576) int local1576;
					if ((local1576 = local504 - (this.anInt5191 << 12)) >= 0) {
				...
				while (local384 < 0) {
					...
					if ((local1768 = (local802 + 1 - (this.anInt5193 << 12) - local342) / local342) > local394) {
						local394 = local1768;
					}
					if (local504 < 0) {
						local532 = (local333 - local504 - 1) / local333;
					...
					if ((local1816 = (local504 + 1 - (this.anInt5191 << 12) - local333) / local333) > local394) {
						local394 = local1816;
					}
					while (local394 < 0) {
						local432 = this.anIntArray409[(local504 >> 12) * this.anInt5193 + (local802 >> 12)];
			...
			while (local384 < 0) {
				...
				if (local368 >= 0 && local368 - (this.anInt5193 << 12) < 0) {
					@Pc(525) int local525;
					if ((local525 = local504 - (this.anInt5191 << 12)) >= 0) {
					...
					while (local394 < 0) {
						local432 = this.anIntArray409[(local504 >> 12) * this.anInt5193 + (local368 >> 12)];
						local436 = Static258.anIntArray399[local388];
						local440 = local432 >>> 24;
						local444 = 256 - local440;
						Static258.anIntArray399[local388++] = ((local432 & 0xFF00FF) * local440 + (local436 & 0xFF00FF) * local444 & 0xFF00FF00) + ((local432 & 0xFF00) * local440 + (local436 & 0xFF00) * local444 & 0xFF0000) >>> 8;
			...
			while (local384 < 0) {
				...
				if (local368 >= 0 && local368 - (this.anInt5193 << 12) < 0) {
					...
					@Pc(702) int local702;
					if ((local702 = (local504 + 1 - (this.anInt5191 << 12) - local333) / local333) > local394) {
						local394 = local702;
					}
					while (local394 < 0) {
						local432 = this.anIntArray409[(local504 >> 12) * this.anInt5193 + (local368 >> 12)];
	...
	public void method4142(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (local23 > 0 && local20 > 0) {
			Static320.method4164(Static258.anIntArray399, this.anIntArray409, local17, local15, local23, local20, local27, local29);
		}
	}
	...
	public void method4139(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (local32 > 0 && local29 > 0) {
			Static320.method4163(Static258.anIntArray399, this.anIntArray409, local26, local21, local32, local29, local36, local40);
		}
	}

	@OriginalMember(owner = "client!tk", name = "a", descriptor = "(IIIIIIDI)V")
	@Override
		...
		try {
			...
			for (@Pc(65) int local65 = 0; local65 < 20; local65++) {
				...
				for (@Pc(77) int local77 = -20; local77 < 0; local77++) {
					...
					@Pc(97) int local97 = Static258.anIntArray399[local70];
					@Pc(101) int local101 = local93 >>> 24;
					@Pc(105) int local105 = 256 - local101;
					Static258.anIntArray399[local70++] = ((local93 & 0xFF00FF) * local101 + (local97 & 0xFF00FF) * local105 & 0xFF00FF00) + ((local93 & 0xFF00) * local101 + (local97 & 0xFF00) * local105 & 0xFF0000) >>> 8;
					local72 += local33;
					local74 -= local27;
				}
				local45 += local27;
	...
	public void method4141(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		...
		Static320.method4167(Static258.anIntArray399, this.anIntArray409, local12, local14, local46, local130, arg2, arg3, local26, local32, local7, arg4);
	}
}
