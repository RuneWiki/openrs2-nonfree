...
public final class Class1_Sub24 extends Class1 {
	...
	private float[] method3173(@OriginalArg(0) int arg0) {
		Static176.method3175(this.aByteArrayArray20[arg0]);
		Static176.method3177();
		@Pc(15) int local15 = Static176.method3179(Static141.method1501(Static176.anIntArray430.length - 1));
		@Pc(19) boolean local19 = Static176.aBooleanArray18[local15];
		@Pc(25) int local25 = local19 ? Static176.anInt4702 : Static176.anInt4703;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static176.method3177() != 0;
			local29 = Static176.method3177() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static176.anInt4703 >> 2);
			local67 = (local25 >> 2) + (Static176.anInt4703 >> 2);
			local71 = Static176.anInt4703 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static176.anInt4703 >> 2);
			local104 = local25 + (Static176.anInt4703 >> 2) - (local25 >> 2);
			local108 = Static176.anInt4703 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class49 local123 = Static176.aClass49Array1[Static176.anIntArray430[local15]];
		@Pc(126) int local126 = local123.anInt3069;
		@Pc(131) int local131 = local123.anIntArray272[local126];
		@Pc(140) boolean local140 = !Static176.aClass41Array1[local131].method1930();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt3070; local144++) {
			@Pc(152) Class30 local152 = Static176.aClass30Array1[local123.anIntArray271[local144]];
			local154 = Static176.aFloatArray5;
			local152.method1278(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt3069;
			local176 = local123.anIntArray272[local171];
			Static176.aClass41Array1[local176].method1937(Static176.aFloatArray5, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static176.aFloatArray5[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static176.aFloatArray5;
			...
			@Pc(252) float[] local252 = local19 ? Static176.aFloatArray6 : Static176.aFloatArray3;
			@Pc(258) float[] local258 = local19 ? Static176.aFloatArray7 : Static176.aFloatArray2;
			@Pc(264) float[] local264 = local19 ? Static176.aFloatArray4 : Static176.aFloatArray8;
			@Pc(270) int[] local270 = local19 ? Static176.anIntArray428 : Static176.anIntArray429;
			...
			@Pc(486) int local486 = Static141.method1501(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static176.aFloatArray5[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static176.aFloatArray5[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt4709 > 0) {
			local176 = this.anInt4709 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean209) {
				for (local212 = 0; local212 < this.anInt4710; local212++) {
					local1254 = (this.anInt4709 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static176.aFloatArray5[local212];
				}
			}
		}
		local154 = this.aFloatArray9;
		this.aFloatArray9 = Static176.aFloatArray5;
		Static176.aFloatArray5 = local154;
		this.anInt4709 = local25;
		this.anInt4710 = local104 - (local25 >> 1);
		this.aBoolean209 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!wd", name = "a", descriptor = "([I)Lclient!ih;")
	public Class1_Sub13_Sub1 method3174(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray48 == null) {
			this.anInt4709 = 0;
			this.aFloatArray9 = new float[Static176.anInt4702];
			this.aByteArray48 = new byte[this.anInt4708];
			this.anInt4712 = 0;
			this.anInt4713 = 0;
		}
		while (this.anInt4713 < this.aByteArrayArray20.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method3173(this.anInt4713);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt4712;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt4708 - local47) {
					local50 = this.anInt4708 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt4712;
				}
				this.anInt4712 = local47;
			}
			this.anInt4713++;
		}
		...
		return new Class1_Sub13_Sub1(this.anInt4704, local129, this.anInt4706, this.anInt4705, this.aBoolean208);
	}

	@OriginalMember(owner = "client!wd", name = "a", descriptor = "([B)V")
	private void method3176(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub6 local4 = new Class1_Sub6(arg0);
		this.anInt4704 = local4.method499();
		this.anInt4708 = local4.method499();
		this.anInt4706 = local4.method499();
		this.anInt4705 = local4.method499();
		if (this.anInt4705 < 0) {
			this.anInt4705 = ~this.anInt4705;
			this.aBoolean208 = true;
		}
		@Pc(40) int local40 = local4.method499();
		this.aByteArrayArray20 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method544();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method534(local49, local64);
