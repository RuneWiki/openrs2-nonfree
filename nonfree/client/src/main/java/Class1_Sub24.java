...
public final class Class1_Sub24 extends Class1 {
	...
	private float[] method2032(@OriginalArg(0) int arg0) {
		Static131.method2028(this.aByteArrayArray10[arg0]);
		Static131.method2030();
		@Pc(15) int local15 = Static131.method2029(Static120.method1909(Static131.anIntArray379.length - 1));
		@Pc(19) boolean local19 = Static131.aBooleanArray19[local15];
		@Pc(25) int local25 = local19 ? Static131.anInt3080 : Static131.anInt3083;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static131.method2030() != 0;
			local29 = Static131.method2030() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static131.anInt3083 >> 2);
			local67 = (local25 >> 2) + (Static131.anInt3083 >> 2);
			local71 = Static131.anInt3083 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static131.anInt3083 >> 2);
			local104 = local25 + (Static131.anInt3083 >> 2) - (local25 >> 2);
			local108 = Static131.anInt3083 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class77 local123 = Static131.aClass77Array1[Static131.anIntArray379[local15]];
		@Pc(126) int local126 = local123.anInt2925;
		@Pc(131) int local131 = local123.anIntArray361[local126];
		@Pc(140) boolean local140 = !Static131.aClass32Array1[local131].method947();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt2924; local144++) {
			@Pc(152) Class66 local152 = Static131.aClass66Array1[local123.anIntArray362[local144]];
			local154 = Static131.aFloatArray4;
			local152.method1687(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt2925;
			local176 = local123.anIntArray361[local171];
			Static131.aClass32Array1[local176].method941(Static131.aFloatArray4, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static131.aFloatArray4[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static131.aFloatArray4;
			...
			@Pc(252) float[] local252 = local19 ? Static131.aFloatArray3 : Static131.aFloatArray5;
			@Pc(258) float[] local258 = local19 ? Static131.aFloatArray8 : Static131.aFloatArray6;
			@Pc(264) float[] local264 = local19 ? Static131.aFloatArray7 : Static131.aFloatArray9;
			@Pc(270) int[] local270 = local19 ? Static131.anIntArray378 : Static131.anIntArray377;
			...
			@Pc(486) int local486 = Static120.method1909(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static131.aFloatArray4[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static131.aFloatArray4[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt3079 > 0) {
			local176 = this.anInt3079 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean185) {
				for (local212 = 0; local212 < this.anInt3081; local212++) {
					local1254 = (this.anInt3079 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static131.aFloatArray4[local212];
				}
			}
		}
		local154 = this.aFloatArray2;
		this.aFloatArray2 = Static131.aFloatArray4;
		Static131.aFloatArray4 = local154;
		this.anInt3079 = local25;
		this.anInt3081 = local104 - (local25 >> 1);
		this.aBoolean185 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!wc", name = "b", descriptor = "([B)V")
	private void method2033(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub19 local4 = new Class1_Sub19(arg0);
		this.anInt3082 = local4.method2046();
		this.anInt3078 = local4.method2046();
		this.anInt3075 = local4.method2046();
		this.anInt3074 = local4.method2046();
		if (this.anInt3074 < 0) {
			this.anInt3074 = ~this.anInt3074;
			this.aBoolean183 = true;
		}
		@Pc(40) int local40 = local4.method2046();
		this.aByteArrayArray10 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method2072();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method2068(local49, local64);
			this.aByteArrayArray10[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!wc", name = "a", descriptor = "([I)Lclient!m;")
	public Class1_Sub17_Sub1 method2035(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray41 == null) {
			this.anInt3079 = 0;
			this.aFloatArray2 = new float[Static131.anInt3080];
			this.aByteArray41 = new byte[this.anInt3078];
			this.anInt3085 = 0;
			this.anInt3084 = 0;
		}
		while (this.anInt3084 < this.aByteArrayArray10.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method2032(this.anInt3084);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt3085;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt3078 - local47) {
					local50 = this.anInt3078 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt3085;
				}
				this.anInt3085 = local47;
			}
			this.anInt3084++;
		}
		...
		return new Class1_Sub17_Sub1(this.anInt3082, local129, this.anInt3075, this.anInt3074, this.aBoolean183);
	}
}
