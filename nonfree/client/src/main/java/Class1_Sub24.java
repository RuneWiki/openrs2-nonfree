...
public final class Class1_Sub24 extends Class1 {
	...
	@OriginalMember(owner = "client!nm", name = "a", descriptor = "([I)Lclient!cc;")
	public Class1_Sub10_Sub1 method3049(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray52 == null) {
			this.anInt3800 = 0;
			this.aFloatArray14 = new float[Static182.anInt3801];
			this.aByteArray52 = new byte[this.anInt3803];
			this.anInt3810 = 0;
			this.anInt3809 = 0;
		}
		while (this.anInt3809 < this.aByteArrayArray10.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(47) float[] local47 = this.method3054(this.anInt3809);
			if (local47 != null) {
				@Pc(52) int local52 = this.anInt3810;
				@Pc(55) int local55 = local47.length;
				if (local55 > this.anInt3803 - local52) {
					local55 = this.anInt3803 - local52;
				}
				for (@Pc(68) int local68 = 0; local68 < local55; local68++) {
					...
					this.aByteArray52[local52++] = (byte) (local80 - 128);
				}
				if (arg0 != null) {
					arg0[0] -= local52 - this.anInt3810;
				}
				this.anInt3810 = local52;
			}
			this.anInt3809++;
		}
		this.aFloatArray14 = null;
		@Pc(129) byte[] local129 = this.aByteArray52;
		this.aByteArray52 = null;
		return new Class1_Sub10_Sub1(this.anInt3799, local129, this.anInt3805, this.anInt3808, this.aBoolean290);
	}

	@OriginalMember(owner = "client!nm", name = "b", descriptor = "(I)[F")
	private float[] method3054(@OriginalArg(0) int arg0) {
		Static182.method3056(this.aByteArrayArray10[arg0]);
		Static182.method3053();
		@Pc(15) int local15 = Static182.method3055(Static52.method1026(Static182.anIntArray343.length - 1));
		@Pc(19) boolean local19 = Static182.aBooleanArray36[local15];
		@Pc(25) int local25 = local19 ? Static182.anInt3801 : Static182.anInt3806;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static182.method3053() != 0;
			local29 = Static182.method3053() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static182.anInt3806 >> 2);
			local67 = (local25 >> 2) + (Static182.anInt3806 >> 2);
			local71 = Static182.anInt3806 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static182.anInt3806 >> 2);
			local104 = local25 + (Static182.anInt3806 >> 2) - (local25 >> 2);
			local108 = Static182.anInt3806 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class150 local123 = Static182.aClass150Array1[Static182.anIntArray343[local15]];
		@Pc(126) int local126 = local123.anInt4587;
		@Pc(131) int local131 = local123.anIntArray409[local126];
		@Pc(140) boolean local140 = !Static182.aClass8Array1[local131].method253();
		for (@Pc(144) int local144 = 0; local144 < local123.anInt4586; local144++) {
			@Pc(155) Class124 local155 = Static182.aClass124Array1[local123.anIntArray410[local144]];
			@Pc(157) float[] local157 = Static182.aFloatArray12;
			local155.method3161(local157, local25 >> 1, local140);
		}
		@Pc(176) int local176;
		if (!local140) {
			local131 = local123.anInt4587;
			local176 = local123.anIntArray409[local131];
			Static182.aClass8Array1[local176].method258(Static182.aFloatArray12, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local131 = local25 >> 1; local131 < local25; local131++) {
				Static182.aFloatArray12[local131] = 0.0F;
			}
		} else {
			local131 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static182.aFloatArray12;
			@Pc(216) int local216;
			...
			@Pc(252) float[] local252 = local19 ? Static182.aFloatArray16 : Static182.aFloatArray11;
			@Pc(258) float[] local258 = local19 ? Static182.aFloatArray15 : Static182.aFloatArray18;
			@Pc(264) float[] local264 = local19 ? Static182.aFloatArray13 : Static182.aFloatArray17;
			@Pc(270) int[] local270 = local19 ? Static182.anIntArray341 : Static182.anIntArray342;
			@Pc(272) int local272;
			...
			local272 = Static52.method1026(local25 - 1);
			@Pc(488) int local488;
			@Pc(499) int local499;
			@Pc(503) int local503;
			@Pc(505) int local505;
			...
			for (local488 = local59; local488 < local67; local488++) {
				...
				Static182.aFloatArray12[local488] *= (float) Math.sin((double) local309 * 1.5707963267948966D * (double) local309);
			}
		...
		if (this.anInt3800 > 0) {
			local176 = this.anInt3800 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1257) int local1257;
			if (!this.aBoolean289) {
				for (local212 = 0; local212 < this.anInt3802; local212++) {
					local1257 = (this.anInt3800 >> 1) + local212;
					local1228[local212] += this.aFloatArray14[local1257];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1257 = local1228.length + local212 - (local25 >> 1);
					local1228[local1257] += Static182.aFloatArray12[local212];
				}
			}
		}
		@Pc(1301) float[] local1301 = this.aFloatArray14;
		this.aFloatArray14 = Static182.aFloatArray12;
		Static182.aFloatArray12 = local1301;
		this.anInt3800 = local25;
		this.anInt3802 = local104 - (local25 >> 1);
		this.aBoolean289 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!nm", name = "a", descriptor = "([B)V")
	private void method3057(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub11 local4 = new Class1_Sub11(arg0);
		this.anInt3799 = local4.method2643();
		this.anInt3803 = local4.method2643();
		this.anInt3805 = local4.method2643();
		this.anInt3808 = local4.method2643();
		if (this.anInt3808 < 0) {
			this.anInt3808 = ~this.anInt3808;
			this.aBoolean290 = true;
		}
		@Pc(40) int local40 = local4.method2643();
		this.aByteArrayArray10 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(51) int local51 = 0;
			@Pc(55) int local55;
			do {
				local55 = local4.method2690();
				local51 += local55;
			} while (local55 >= 255);
			@Pc(67) byte[] local67 = new byte[local51];
			local4.method2678(local67, local51);
