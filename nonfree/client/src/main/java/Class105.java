...
public final class Class105 {
	...
	@OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
	public Class105(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12, @OriginalArg(13) int arg13, @OriginalArg(14) int arg14, @OriginalArg(15) int arg15, @OriginalArg(16) int arg16, @OriginalArg(17) int arg17, @OriginalArg(18) int arg18) {
		...
		for (@Pc(79) int local79 = 0; local79 < local51; local79++) {
			...
			this.anIntArray260[local79] = local142;
			this.anIntArray258[local79] = local146;
			this.anIntArray253[local79] = local144;
			local66[local79] = local148;
			local69[local79] = local150;
		}
		@Pc(534) int[] local534 = Static155.anIntArrayArray20[arg0];
		local86 = local534.length / 4;
		this.anIntArray256 = new int[local86];
		this.anIntArray261 = new int[local86];
		this.anIntArray255 = new int[local86];
		this.anIntArray266 = new int[local86];
		this.anIntArray257 = new int[local86];
		this.anIntArray267 = new int[local86];
		if (arg2 != -1) {
			this.anIntArray262 = new int[local86];
		}
		local142 = 0;
		for (local144 = 0; local144 < local86; local144++) {
			...
			this.anIntArray256[local144] = local148;
			this.anIntArray261[local144] = local150;
			this.anIntArray255[local144] = local599;
			if (local146 == 0) {
				this.anIntArray266[local144] = local66[local148];
				this.anIntArray257[local144] = local66[local150];
				this.anIntArray267[local144] = local66[local599];
				if (this.anIntArray262 != null) {
					this.anIntArray262[local144] = -1;
				}
			} else {
				this.anIntArray266[local144] = local69[local148];
				this.anIntArray257[local144] = local69[local150];
				this.anIntArray267[local144] = local69[local599];
				if (this.anIntArray262 != null) {
