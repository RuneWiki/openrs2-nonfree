...
public final class Class4_Sub43 extends Class4 {
	...
	public Class4_Sub43(@OriginalArg(0) byte[] arg0) {
	...
	private void method5546(@OriginalArg(0) byte[] arg0) {
		...
		this.anInt7194 = local4.method4872();
		this.anInt7190 = local4.method4872();
		this.anInt7189 = local4.method4872();
		this.anInt7191 = local4.method4872();
		if (this.anInt7191 < 0) {
			this.anInt7191 = ~this.anInt7191;
			this.aBoolean483 = true;
		}
		@Pc(40) int local40 = local4.method4872();
		this.aByteArrayArray19 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method4864();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method4863(local49, local64);
			this.aByteArrayArray19[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!vs", name = "a", descriptor = "([I)Lclient!uq;")
	public Class4_Sub35_Sub1 method5553(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray94 == null) {
			this.anInt7198 = 0;
			this.aFloatArray33 = new float[Static432.anInt7197];
			this.aByteArray94 = new byte[this.anInt7190];
			this.anInt7199 = 0;
			this.anInt7200 = 0;
		}
		while (this.anInt7200 < this.aByteArrayArray19.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method5555(this.anInt7200);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt7199;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt7190 - local47) {
					local50 = this.anInt7190 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt7199;
				}
				this.anInt7199 = local47;
			}
			this.anInt7200++;
		}
		...
		return new Class4_Sub35_Sub1(this.anInt7194, local129, this.anInt7189, this.anInt7191, this.aBoolean483);
	}

	@OriginalMember(owner = "client!vs", name = "d", descriptor = "(I)[F")
	private float[] method5555(@OriginalArg(0) int arg0) {
		Static432.method5551(this.aByteArrayArray19[arg0]);
		Static432.method5554();
		@Pc(15) int local15 = Static432.method5548(Static51.method1041(Static432.anIntArray637.length - 1));
		@Pc(19) boolean local19 = Static432.aBooleanArray28[local15];
		@Pc(25) int local25 = local19 ? Static432.anInt7197 : Static432.anInt7193;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static432.method5554() != 0;
			local29 = Static432.method5554() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static432.anInt7193 >> 2);
			local67 = (local25 >> 2) + (Static432.anInt7193 >> 2);
			local71 = Static432.anInt7193 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static432.anInt7193 >> 2);
			local104 = local25 + (Static432.anInt7193 >> 2) - (local25 >> 2);
			local108 = Static432.anInt7193 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class241 local123 = Static432.aClass241Array1[Static432.anIntArray637[local15]];
		@Pc(126) int local126 = local123.anInt6857;
		@Pc(131) int local131 = local123.anIntArray607[local126];
		@Pc(140) boolean local140 = !Static432.aClass151Array1[local131].method3295();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt6856; local144++) {
			@Pc(152) Class203 local152 = Static432.aClass203Array1[local123.anIntArray606[local144]];
			local154 = Static432.aFloatArray28;
			local152.method4619(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt6857;
			local176 = local123.anIntArray607[local171];
			Static432.aClass151Array1[local176].method3296(Static432.aFloatArray28, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static432.aFloatArray28[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static432.aFloatArray28;
			...
			@Pc(252) float[] local252 = local19 ? Static432.aFloatArray27 : Static432.aFloatArray31;
			@Pc(258) float[] local258 = local19 ? Static432.aFloatArray32 : Static432.aFloatArray29;
			@Pc(264) float[] local264 = local19 ? Static432.aFloatArray30 : Static432.aFloatArray34;
			@Pc(270) int[] local270 = local19 ? Static432.anIntArray635 : Static432.anIntArray636;
			...
			@Pc(486) int local486 = Static51.method1041(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static432.aFloatArray28[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static432.aFloatArray28[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt7198 > 0) {
			local176 = this.anInt7198 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean481) {
				for (local212 = 0; local212 < this.anInt7192; local212++) {
					local1254 = (this.anInt7198 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static432.aFloatArray28[local212];
				}
			}
		}
		local154 = this.aFloatArray33;
		this.aFloatArray33 = Static432.aFloatArray28;
		Static432.aFloatArray28 = local154;
		this.anInt7198 = local25;
		this.anInt7192 = local104 - (local25 >> 1);
		this.aBoolean481 = local140;
		return local1228;
	}
}
