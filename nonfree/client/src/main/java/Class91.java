...
public abstract class Class91 {
	...
	public abstract void method7049(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[] arg3);
	...
	public abstract void EA(@OriginalArg(0) Class91 arg0);

	@OriginalMember(owner = "client!m", name = "a", descriptor = "()Lclient!m;")
	public abstract Class91 method7050();
