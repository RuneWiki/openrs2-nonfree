...
public final class ca extends Class54 implements Interface16 {

	@OriginalMember(owner = "client!ca", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lclient!l;Lclient!m;Lclient!ho;[Lclient!qo;[Lclient!f;)V")
	public ca(@OriginalArg(0) l arg0, @OriginalArg(1) m arg1, @OriginalArg(2) Class134 arg2, @OriginalArg(3) Class279[] arg3, @OriginalArg(4) Class14[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray80;
			local11[local25] = arg3[local25].anInt7341;
			local15[local25] = arg3[local25].anInt7340;
			local19[local25] = arg3[local25].anInt7339;
			local23[local25] = arg3[local25].anInt7338;
		}
		this.l(arg0, arg1, local7, arg3[0].anIntArray456, local11, local15, local19, local23);
	}
	...
	private native void t(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class81 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
