...
public final class ca extends Class35 implements Interface19 {

	@OriginalMember(owner = "client!ca", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lclient!l;Lclient!m;Lclient!aga;[Lclient!tq;[Lclient!f;)V")
	public ca(@OriginalArg(0) l arg0, @OriginalArg(1) m arg1, @OriginalArg(2) Class13 arg2, @OriginalArg(3) Class318[] arg3, @OriginalArg(4) Class10[] arg4) {
		super(arg0, arg2);
		...
		this.l(arg0, arg1, local7, arg3[0].anIntArray587, local11, local15, local19, local23);
	}
	...
	private native void t(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class200 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
