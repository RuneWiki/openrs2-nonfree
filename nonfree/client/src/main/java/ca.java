...
public final class ca extends Class63 implements Interface17 {

	@OriginalMember(owner = "client!ca", name = "nativeid", descriptor = "J")
	private long nativeid;

	@OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lclient!l;Lclient!m;Lclient!ufa;[Lclient!wt;[Lclient!f;)V")
	public ca(@OriginalArg(0) l arg0, @OriginalArg(1) m arg1, @OriginalArg(2) Class328 arg2, @OriginalArg(3) Class365[] arg3, @OriginalArg(4) Class73[] arg4) {
		super(arg0, arg2);
		...
		for (@Pc(25) int local25 = 0; local25 < arg3.length; local25++) {
			local7[local25] = arg3[local25].aByteArray246;
			local11[local25] = arg3[local25].anInt10318;
			local15[local25] = arg3[local25].anInt10320;
			local19[local25] = arg3[local25].anInt10316;
			local23[local25] = arg3[local25].anInt10321;
		}
		this.l(arg0, arg1, local7, arg3[0].anIntArray601, local11, local15, local19, local23);
	}
	...
	private native void t(@OriginalArg(0) char arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) Class53 arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7);
