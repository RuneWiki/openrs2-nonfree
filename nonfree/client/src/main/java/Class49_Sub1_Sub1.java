...
public final class Class49_Sub1_Sub1 extends Class49_Sub1 {
	...
	@OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(Lclient!qf;[III)V")
	public Class49_Sub1_Sub1(@OriginalArg(0) Class200_Sub1 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		super(arg0, arg2, arg3);
		this.anIntArray67 = arg1;
	}

	@OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(Lclient!qf;[IIIII)V")
	public Class49_Sub1_Sub1(@OriginalArg(0) Class200_Sub1 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		for (@Pc(19) int local19 = 0; local19 < arg5; local19++) {
			for (@Pc(22) int local22 = 0; local22 < arg4; local22++) {
				this.anIntArray67[local17++] = arg1[arg2++];
			}
			arg2 += local15;
		}
	}
		...
		if (Static90.anInt7288 == 0) {
			if (Static90.anInt7295 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local27 >= 0 && local25 - (super.anInt7292 << 12) < 0 && local27 - (super.anInt7284 << 12) < 0) {
							...
							while (local29 < 0) {
								local111 = this.anIntArray67[(local27 >> 12) * super.anInt7292 + (local25 >> 12)];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt7292 << 12) < 0) {
							@Pc(210) int local210;
							if ((local210 = local27 - (super.anInt7284 << 12)) >= 0) {
								local217 = (Static90.anInt7295 - local210) / Static90.anInt7295;
								local29 += local217;
								local27 += Static90.anInt7295 * local217;
								local23 += local217;
							}
							@Pc(238) int local238;
							if ((local238 = (local27 - Static90.anInt7295) / Static90.anInt7295) > local29) {
								local29 = local238;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt7292 << 12) < 0) {
							if (local27 < 0) {
								local217 = (Static90.anInt7295 - local27 - 1) / Static90.anInt7295;
								local29 += local217;
								local27 += Static90.anInt7295 * local217;
								local23 += local217;
							}
							@Pc(441) int local441;
							if ((local441 = (local27 + 1 - (super.anInt7284 << 12) - Static90.anInt7295) / Static90.anInt7295) > local29) {
								local29 = local441;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
			...
			if (Static90.anInt7295 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local27 >= 0 && local27 - (super.anInt7284 << 12) < 0) {
							@Pc(618) int local618;
							if ((local618 = local25 - (super.anInt7292 << 12)) >= 0) {
								local217 = (Static90.anInt7288 - local618) / Static90.anInt7288;
								local29 += local217;
								local25 += Static90.anInt7288 * local217;
								local23 += local217;
							}
							@Pc(646) int local646;
							if ((local646 = (local25 - Static90.anInt7288) / Static90.anInt7288) > local29) {
								local29 = local646;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static90.anInt7282;
						@Pc(814) int local814;
						if ((local814 = local25 - (super.anInt7292 << 12)) >= 0) {
							local217 = (Static90.anInt7288 - local814) / Static90.anInt7288;
							local29 += local217;
							local25 += Static90.anInt7288 * local217;
							local27 += Static90.anInt7295 * local217;
							local23 += local217;
						...
						@Pc(848) int local848;
						if ((local848 = (local25 - Static90.anInt7288) / Static90.anInt7288) > local29) {
							local29 = local848;
						}
						@Pc(860) int local860;
						if ((local860 = local27 - (super.anInt7284 << 12)) >= 0) {
							local217 = (Static90.anInt7295 - local860) / Static90.anInt7295;
							local29 += local217;
							local25 += Static90.anInt7288 * local217;
							local27 += Static90.anInt7295 * local217;
							local23 += local217;
						...
						@Pc(894) int local894;
						if ((local894 = (local27 - Static90.anInt7295) / Static90.anInt7295) > local29) {
							local29 = local894;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if ((local1068 = local25 - (super.anInt7292 << 12)) >= 0) {
							local217 = (Static90.anInt7288 - local1068) / Static90.anInt7288;
							local29 += local217;
							local25 += Static90.anInt7288 * local217;
							local27 += Static90.anInt7295 * local217;
							local23 += local217;
						...
						if ((local1102 = (local25 - Static90.anInt7288) / Static90.anInt7288) > local29) {
							local29 = local1102;
						}
						if (local27 < 0) {
							local217 = (Static90.anInt7295 - local27 - 1) / Static90.anInt7295;
						...
						if ((local1150 = (local27 + 1 - (super.anInt7284 << 12) - Static90.anInt7295) / Static90.anInt7295) > local29) {
							local29 = local1150;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if (local27 >= 0 && local27 - (super.anInt7284 << 12) < 0) {
						if (local25 < 0) {
							local217 = (Static90.anInt7288 - local25 - 1) / Static90.anInt7288;
							local29 += local217;
							local25 += Static90.anInt7288 * local217;
							local23 += local217;
						}
						@Pc(1363) int local1363;
						if ((local1363 = (local25 + 1 - (super.anInt7292 << 12) - Static90.anInt7288) / Static90.anInt7288) > local29) {
							local29 = local1363;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1571 = (local25 + 1 - (super.anInt7292 << 12) - Static90.anInt7288) / Static90.anInt7288) > local29) {
						local29 = local1571;
					}
					@Pc(1583) int local1583;
					if ((local1583 = local27 - (super.anInt7284 << 12)) >= 0) {
						local217 = (Static90.anInt7295 - local1583) / Static90.anInt7295;
						local29 += local217;
						local25 += Static90.anInt7288 * local217;
						local27 += Static90.anInt7295 * local217;
						local23 += local217;
					...
					if ((local1617 = (local27 - Static90.anInt7295) / Static90.anInt7295) > local29) {
						local29 = local1617;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1827 = (local25 + 1 - (super.anInt7292 << 12) - Static90.anInt7288) / Static90.anInt7288) > local29) {
						local29 = local1827;
					}
					if (local27 < 0) {
						local217 = (Static90.anInt7295 - local27 - 1) / Static90.anInt7295;
					...
					if ((local1875 = (local27 + 1 - (super.anInt7284 << 12) - Static90.anInt7295) / Static90.anInt7295) > local29) {
						local29 = local1875;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
	...
	public void oa(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(25) int local25;
		if (arg2 == 0) {
			local5 = super.aClass200_Sub1_11.anIntArray388;
			for (local7 = 0; local7 < super.anInt7284; local7++) {
				local13 = local7 * super.anInt7292;
				local23 = (arg1 + local7) * super.aClass200_Sub1_11.anInt5426 + arg0;
				for (local25 = 0; local25 < super.anInt7292; local25++) {
					this.anIntArray67[local13 + local25] = this.anIntArray67[local13 + local25] & 0xFFFFFF | (local5[local23 + local25] & 0xFF0000) << 8;
				}
			}
		} else if (arg2 == 3) {
			local5 = super.aClass200_Sub1_11.anIntArray388;
			for (local7 = 0; local7 < super.anInt7284; local7++) {
				...
				local23 = (arg1 + local7) * super.aClass200_Sub1_11.anInt5426 + arg0;
				for (local25 = 0; local25 < super.anInt7292; local25++) {
					this.anIntArray67[local13 + local25] = this.anIntArray67[local13 + local25] & 0xFFFFFF | (local5[local23 + local25] == 0 ? 0 : -16777216);
				}
			}
		}
	}
		...
		if (arg2 == 1) {
			for (local492 = -local32; local492 < 0; local492++) {
				for (local496 = -local35; local496 < 0; local496++) {
					local503 = this.anIntArray67[local29++];
		...
		if (arg2 == 0) {
			if ((arg3 & 0xFFFFFF) == 16777215) {
				...
				for (local507 = -local32; local507 < 0; local507++) {
					for (local511 = -local35; local511 < 0; local511++) {
						local515 = this.anIntArray67[local29++];
			...
			for (local511 = -local32; local511 < 0; local511++) {
				for (local515 = -local35; local515 < 0; local515++) {
					local690 = this.anIntArray67[local29++];
					...
					if (local14 >= 0 && local16 >= 0 && local14 - (super.anInt7292 << 12) < 0 && local16 - (super.anInt7284 << 12) < 0) {
						while (local18 < 0) {
							...
							if (arg0 == 1) {
								...
								local209 = this.anIntArray67[local48];
								local213 = (local209 >>> 24) * Static90.anInt7289 >> 8;
								local217 = 256 - local213;
								if ((Static90.anInt7285 & 0xFFFFFF) == 16777215) {
									local221 = local3[local51];
									local3[local51] = ((local209 & 0xFF00FF) * local213 + (local221 & 0xFF00FF) * local217 & 0xFF00FF00) + ((local209 & 0xFF00) * local213 + (local221 & 0xFF00) * local217 & 0xFF0000) >> 8;
								} else if (local213 == 255) {
									local221 = (local209 & 0xFF0000) * Static90.anInt7309 & 0xFF000000;
									local334 = (local209 & 0xFF00) * Static90.anInt7298 & 0xFF0000;
									local342 = (local209 & 0xFF) * Static90.anInt7300 & 0xFF00;
								...
								local342 = (local334 >>> 24) * Static90.anInt7289 >> 8;
								...
								local213 = local209 >>> 24;
								local217 = 256 - local213;
								local221 = (local209 & 0xFF00FF) * Static90.anInt7289 & 0xFF00FF00;
								local334 = (local209 & 0xFF00) * Static90.anInt7289 & 0xFF0000;
								local209 = ((local221 | local334) >>> 8) + Static90.anInt7308;
	...
	@OriginalMember(owner = "client!dh", name = "a", descriptor = "(IILclient!ta;II)V")
	@Override
