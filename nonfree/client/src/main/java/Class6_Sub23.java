...
public final class Class6_Sub23 extends Class6 {
	...
	@OriginalMember(owner = "client!taa", name = "<init>", descriptor = "(Lclient!ah;)V")
	public Class6_Sub23(@OriginalArg(0) Class2_Sub5 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!taa", name = "<init>", descriptor = "(ILclient!ah;)V")
	public Class6_Sub23(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub5 arg1) {
		super(arg0, arg1);
	}
