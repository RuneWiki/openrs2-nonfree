...
public final class Class6_Sub23 extends Class6 {
	...
	public Class6_Sub23(@OriginalArg(0) byte[] arg0) {
		this.method3946(arg0);
	}

	@OriginalMember(owner = "client!ju", name = "a", descriptor = "(I)[F")
	private float[] method3943(@OriginalArg(0) int arg0) {
		Static254.method3952(this.aByteArrayArray9[arg0]);
		Static254.method3942();
		@Pc(15) int local15 = Static254.method3950(Static1.method54(Static254.anIntArray387.length - 1));
		@Pc(19) boolean local19 = Static254.aBooleanArray17[local15];
		@Pc(25) int local25 = local19 ? Static254.anInt4646 : Static254.anInt4641;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static254.method3942() != 0;
			local29 = Static254.method3942() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static254.anInt4641 >> 2);
			local67 = (local25 >> 2) + (Static254.anInt4641 >> 2);
			local71 = Static254.anInt4641 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static254.anInt4641 >> 2);
			local104 = local25 + (Static254.anInt4641 >> 2) - (local25 >> 2);
			local108 = Static254.anInt4641 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class149 local123 = Static254.aClass149Array1[Static254.anIntArray387[local15]];
		@Pc(126) int local126 = local123.anInt4197;
		@Pc(131) int local131 = local123.anIntArray352[local126];
		@Pc(140) boolean local140 = !Static254.aClass305Array1[local131].method6870();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt4198; local144++) {
			@Pc(152) Class290 local152 = Static254.aClass290Array1[local123.anIntArray353[local144]];
			local154 = Static254.aFloatArray36;
			local152.method6545(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt4197;
			local176 = local123.anIntArray352[local171];
			Static254.aClass305Array1[local176].method6866(Static254.aFloatArray36, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static254.aFloatArray36[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static254.aFloatArray36;
			...
			@Pc(252) float[] local252 = local19 ? Static254.aFloatArray39 : Static254.aFloatArray32;
			@Pc(258) float[] local258 = local19 ? Static254.aFloatArray38 : Static254.aFloatArray35;
			@Pc(264) float[] local264 = local19 ? Static254.aFloatArray33 : Static254.aFloatArray37;
			@Pc(270) int[] local270 = local19 ? Static254.anIntArray385 : Static254.anIntArray386;
			...
			@Pc(486) int local486 = Static1.method54(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static254.aFloatArray36[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static254.aFloatArray36[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (this.anInt4645 > 0) {
			local176 = this.anInt4645 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1254) int local1254;
			if (!this.aBoolean342) {
				for (local212 = 0; local212 < this.anInt4639; local212++) {
					local1254 = (this.anInt4645 >> 1) + local212;
			...
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					...
					local1228[local1254] += Static254.aFloatArray36[local212];
				}
			}
		}
		local154 = this.aFloatArray34;
		this.aFloatArray34 = Static254.aFloatArray36;
		Static254.aFloatArray36 = local154;
		this.anInt4645 = local25;
		this.anInt4639 = local104 - (local25 >> 1);
		this.aBoolean342 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!ju", name = "a", descriptor = "([I)Lclient!qr;")
	public Class6_Sub6_Sub1 method3945(@OriginalArg(0) int[] arg0) {
		if (arg0 != null && arg0[0] <= 0) {
			return null;
		}
		if (this.aByteArray63 == null) {
			this.anInt4645 = 0;
			this.aFloatArray34 = new float[Static254.anInt4646];
			this.aByteArray63 = new byte[this.anInt4647];
			this.anInt4648 = 0;
			this.anInt4649 = 0;
		}
		while (this.anInt4649 < this.aByteArrayArray9.length) {
			if (arg0 != null && arg0[0] <= 0) {
				return null;
			}
			@Pc(42) float[] local42 = this.method3943(this.anInt4649);
			if (local42 != null) {
				@Pc(47) int local47 = this.anInt4648;
				@Pc(50) int local50 = local42.length;
				if (local50 > this.anInt4647 - local47) {
					local50 = this.anInt4647 - local47;
				}
				...
				if (arg0 != null) {
					arg0[0] -= local47 - this.anInt4648;
				}
				this.anInt4648 = local47;
			}
			this.anInt4649++;
		}
		...
		return new Class6_Sub6_Sub1(this.anInt4638, local129, this.anInt4643, this.anInt4644, this.aBoolean344);
	}

	@OriginalMember(owner = "client!ju", name = "b", descriptor = "([B)V")
	private void method3946(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class6_Sub12 local4 = new Class6_Sub12(arg0);
		this.anInt4638 = local4.method6015();
		this.anInt4647 = local4.method6015();
		this.anInt4643 = local4.method6015();
		this.anInt4644 = local4.method6015();
		if (this.anInt4644 < 0) {
			this.anInt4644 = ~this.anInt4644;
			this.aBoolean344 = true;
		}
		@Pc(40) int local40 = local4.method6015();
		this.aByteArrayArray9 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method6019();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method6020(local64, local49);
