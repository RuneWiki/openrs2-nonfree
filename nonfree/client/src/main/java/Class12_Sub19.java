...
public final class Class12_Sub19 extends Class12 {
	...
	@OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lclient!sf;)V")
	public Class12_Sub19(@OriginalArg(0) Class5_Sub50 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(ILclient!sf;)V")
	public Class12_Sub19(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub50 arg1) {
		super(arg0, arg1);
	}
