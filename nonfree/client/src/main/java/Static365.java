...
public final class Static365 {
	...
	@OriginalMember(owner = "client!rr", name = "a", descriptor = "(II[B[IIIIIIIILclient!rr;II)I")
	public static int method4822(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class14_Sub19_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!rr", name = "a", descriptor = "(II[B[IIIIIIILclient!rr;II)I")
	public static int method4825(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class14_Sub19_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!rr", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!rr;II)I")
	public static int method4826(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class14_Sub19_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt5420 -= arg10.anInt5417 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt5420 += arg10.anInt5417 * local63;
		arg10.anInt5411 = arg4;
		arg10.anInt5412 = arg5;
		arg10.anInt5416 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!rr", name = "b", descriptor = "(II[B[IIIIIIIILclient!rr;II)I")
	public static int method4827(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class14_Sub19_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt5411 -= arg8.anInt5419 * arg3;
		arg8.anInt5412 -= arg8.anInt5415 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!rr", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!rr;)I")
	public static int method4832(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class14_Sub19_Sub3 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt5420 += arg10.anInt5417 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
		...
		arg10.anInt5411 = arg4 >> 2;
		arg10.anInt5412 = arg5 >> 2;
		arg10.anInt5416 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!rr", name = "a", descriptor = "([B[IIIIIIIILclient!rr;)I")
	public static int method4834(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class14_Sub19_Sub3 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt5411 += arg8.anInt5419 * (local22 - arg3);
		arg8.anInt5412 += arg8.anInt5415 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt5420 = arg4 >> 2;
		arg8.anInt5416 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!rr", name = "a", descriptor = "(Lclient!kr;III)Lclient!rr;")
	public static Class14_Sub19_Sub3 method4835(@OriginalArg(0) Class14_Sub11_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray98 == null || arg0.aByteArray98.length == 0 ? null : new Class14_Sub19_Sub3(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!rr", name = "a", descriptor = "(I[B[IIIIIIIILclient!rr;)I")
	public static int method4836(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class14_Sub19_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
	...
	@OriginalMember(owner = "client!rr", name = "c", descriptor = "(II[B[IIIIIIIILclient!rr;II)I")
	public static int method4837(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class14_Sub19_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt5411 -= arg8.anInt5419 * arg3;
		arg8.anInt5412 -= arg8.anInt5415 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!rr", name = "a", descriptor = "(Lclient!kr;II)Lclient!rr;")
	public static Class14_Sub19_Sub3 method4842(@OriginalArg(0) Class14_Sub11_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray98 == null || arg0.aByteArray98.length == 0 ? null : new Class14_Sub19_Sub3(arg0, (int) ((long) arg0.anInt3560 * 256L * (long) 100 / (long) (Static223.anInt5818 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!rr", name = "b", descriptor = "(II)I")
	public static int method4846(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!rr", name = "b", descriptor = "(II[B[IIIIIIILclient!rr;II)I")
	public static int method4847(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class14_Sub19_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!rr", name = "a", descriptor = "([B[IIIIIIILclient!rr;)I")
	public static int method4848(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class14_Sub19_Sub3 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt5416 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!rr", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!rr;)I")
	public static int method4849(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class14_Sub19_Sub3 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt5420 += arg10.anInt5417 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
	...
	@OriginalMember(owner = "client!rr", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!rr;II)I")
	public static int method4851(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class14_Sub19_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt5420 -= arg10.anInt5417 * arg3;
		@Pc(23) int local23;
	...
	@OriginalMember(owner = "client!rr", name = "b", descriptor = "([B[IIIIIIIILclient!rr;)I")
	public static int method4852(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class14_Sub19_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt5411 += arg8.anInt5419 * (local24 - arg3);
		arg8.anInt5412 += arg8.anInt5415 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!rr", name = "b", descriptor = "(I[B[IIIIIIIILclient!rr;)I")
	public static int method4854(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class14_Sub19_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!rr", name = "b", descriptor = "([B[IIIIIIILclient!rr;)I")
	public static int method4859(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class14_Sub19_Sub3 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!rr", name = "d", descriptor = "(II[B[IIIIIIIILclient!rr;II)I")
	public static int method4860(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class14_Sub19_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
