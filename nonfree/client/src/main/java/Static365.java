...
public final class Static365 {
	...
	@OriginalMember(owner = "client!qe", name = "a", descriptor = "([B[IIIIIIILclient!qe;)I")
	public static int method4563(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class5_Sub16_Sub3 arg7) {
		arg2 >>= 0x8;
		...
		arg7.anInt5121 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!qe", name = "a", descriptor = "(I[B[IIIIIIIILclient!qe;)I")
	public static int method4564(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class5_Sub16_Sub3 arg8) {
		arg2 >>= 0x8;
		...
		arg8.anInt5121 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!qe", name = "a", descriptor = "(II[B[IIIIIIIIIILclient!qe;II)I")
	public static int method4565(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class5_Sub16_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt5117 -= arg10.anInt5111 * arg3;
		@Pc(23) int local23;
		...
		local63 = arg3 >> 1;
		arg10.anInt5117 += arg10.anInt5111 * local63;
		arg10.anInt5113 = arg4;
		arg10.anInt5114 = arg5;
		arg10.anInt5121 = arg2;
		return local63;
	}

	@OriginalMember(owner = "client!qe", name = "b", descriptor = "([B[IIIIIIILclient!qe;)I")
	public static int method4566(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) Class5_Sub16_Sub3 arg7) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg6 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(20) int local20;
	...
	@OriginalMember(owner = "client!qe", name = "a", descriptor = "(II[B[IIIIIIIILclient!qe;II)I")
	public static int method4569(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class5_Sub16_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt5113 -= arg8.anInt5109 * arg3;
		arg8.anInt5114 -= arg8.anInt5122 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!qe", name = "b", descriptor = "(II[B[IIIIIIIILclient!qe;II)I")
	public static int method4571(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class5_Sub16_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		arg8.anInt5113 -= arg8.anInt5109 * arg3;
		arg8.anInt5114 -= arg8.anInt5122 * arg3;
		@Pc(32) int local32;
	...
	@OriginalMember(owner = "client!qe", name = "c", descriptor = "(II[B[IIIIIIIILclient!qe;II)I")
	public static int method4572(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class5_Sub16_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!qe", name = "a", descriptor = "(I[B[IIIIIIIIIILclient!qe;)I")
	public static int method4579(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class5_Sub16_Sub3 arg10) {
		arg2 >>= 0x8;
		...
		arg10.anInt5117 += arg10.anInt5111 * (local32 - arg3);
		arg3 <<= 0x1;
		local32 <<= 0x1;
		local32 -= 6;
		@Pc(62) byte local62;
		...
		arg10.anInt5113 = arg4 >> 2;
		arg10.anInt5114 = arg5 >> 2;
		arg10.anInt5121 = arg2 << 8;
		return arg3 >> 1;
	}

	@OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lclient!dg;III)Lclient!qe;")
	public static Class5_Sub16_Sub3 method4581(@OriginalArg(0) Class5_Sub10_Sub1 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		return arg0.aByteArray9 == null || arg0.aByteArray9.length == 0 ? null : new Class5_Sub16_Sub3(arg0, arg1, arg2, arg3);
	}

	@OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lclient!dg;II)Lclient!qe;")
	public static Class5_Sub16_Sub3 method4582(@OriginalArg(0) Class5_Sub10_Sub1 arg0, @OriginalArg(2) int arg1) {
		return arg0.aByteArray9 == null || arg0.aByteArray9.length == 0 ? null : new Class5_Sub16_Sub3(arg0, (int) ((long) arg0.anInt1039 * 256L * (long) 100 / (long) (Static226.anInt4449 * 100)), arg1 << 6);
	}

	@OriginalMember(owner = "client!qe", name = "b", descriptor = "(I[B[IIIIIIIILclient!qe;)I")
	public static int method4585(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(10) Class5_Sub16_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		@Pc(11) int local11 = arg4 << 2;
		@Pc(15) int local15 = arg5 << 2;
	...
	@OriginalMember(owner = "client!qe", name = "b", descriptor = "(I[B[IIIIIIIIIILclient!qe;)I")
	public static int method4589(@OriginalArg(1) byte[] arg0, @OriginalArg(2) int[] arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(10) int arg8, @OriginalArg(11) int arg9, @OriginalArg(12) Class5_Sub16_Sub3 arg10) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg9 >> 8;
		arg4 <<= 0x2;
		arg5 <<= 0x2;
		...
		arg10.anInt5117 += arg10.anInt5111 * (local30 - arg3);
		arg3 <<= 0x1;
		local30 <<= 0x1;
		local30 -= 6;
		@Pc(60) byte local60;
	...
	@OriginalMember(owner = "client!qe", name = "a", descriptor = "([B[IIIIIIIILclient!qe;)I")
	public static int method4591(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class5_Sub16_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt5113 += arg8.anInt5109 * (local22 - arg3);
		arg8.anInt5114 += arg8.anInt5122 * (local22 - arg3);
		local22 -= 3;
		@Pc(52) int local52;
		while (arg3 < local22) {
			local52 = arg3++;
		...
		arg8.anInt5117 = arg4 >> 2;
		arg8.anInt5121 = arg2 << 8;
		return arg3;
	}

	@OriginalMember(owner = "client!qe", name = "a", descriptor = "(II[B[IIIIIIILclient!qe;II)I")
	public static int method4593(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class5_Sub16_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	public static int method4595(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
	}

	@OriginalMember(owner = "client!qe", name = "b", descriptor = "([B[IIIIIIIILclient!qe;)I")
	public static int method4597(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) Class5_Sub16_Sub3 arg8) {
		arg2 >>= 0x8;
		@Pc(7) int local7 = arg7 >> 8;
		arg4 <<= 0x2;
		@Pc(15) int local15 = arg5 << 2;
		...
		arg8.anInt5113 += arg8.anInt5109 * (local24 - arg3);
		arg8.anInt5114 += arg8.anInt5122 * (local24 - arg3);
		local24 -= 3;
		@Pc(54) int local54;
		while (arg3 < local24) {
			local54 = arg3++;
	...
	@OriginalMember(owner = "client!qe", name = "d", descriptor = "(II[B[IIIIIIIILclient!qe;II)I")
	public static int method4599(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) int arg7, @OriginalArg(11) Class5_Sub16_Sub3 arg8, @OriginalArg(12) int arg9, @OriginalArg(13) int arg10) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!qe", name = "b", descriptor = "(II[B[IIIIIIILclient!qe;II)I")
	public static int method4600(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(8) int arg5, @OriginalArg(9) int arg6, @OriginalArg(10) Class5_Sub16_Sub3 arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9) {
		@Pc(14) int local14;
	...
	@OriginalMember(owner = "client!qe", name = "b", descriptor = "(II[B[IIIIIIIIIILclient!qe;II)I")
	public static int method4601(@OriginalArg(2) byte[] arg0, @OriginalArg(3) int[] arg1, @OriginalArg(4) int arg2, @OriginalArg(5) int arg3, @OriginalArg(6) int arg4, @OriginalArg(7) int arg5, @OriginalArg(8) int arg6, @OriginalArg(9) int arg7, @OriginalArg(11) int arg8, @OriginalArg(12) int arg9, @OriginalArg(13) Class5_Sub16_Sub3 arg10, @OriginalArg(14) int arg11, @OriginalArg(15) int arg12) {
		arg10.anInt5117 -= arg10.anInt5111 * arg3;
		@Pc(23) int local23;
