...
public final class p extends Class4 implements Interface10 {
	...
	private void method6143(@OriginalArg(0) Exception arg0) {
		if (!Static448.aBoolean539) {
			Static448.aLong207 = Static429.method5935();
			Static448.aBoolean539 = true;
		} else if (Static429.method5935() - Static448.aLong207 < 30000L) {
	...
	public void method6144(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			synchronized (this.aCanvas8.getTreeLock()) {
				...
				Static448.aBoolean539 = false;
			}
		} catch (@Pc(43) Exception local43) {
			this.method6143(local43);
		}
	}
	...
	public void method6145(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas8.getTreeLock()) {
	...
	public void method6147(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt6984 = arg1;
		this.anInt6983 = arg2;
