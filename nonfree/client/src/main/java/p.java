...
public final class p extends Class14 implements Interface5 {
	...
	private void method6707(@OriginalArg(0) Exception arg0) {
		if (!Static454.aBoolean532) {
			Static454.aLong208 = Static26.method382();
			Static454.aBoolean532 = true;
		} else if (Static26.method382() - Static454.aLong208 < 30000L) {
	...
	public void method6708(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt7578 = arg1;
		this.anInt7579 = arg2;
	...
	public void method6709(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			synchronized (this.aCanvas9.getTreeLock()) {
				...
				Static454.aBoolean532 = false;
			}
		} catch (@Pc(47) Exception local47) {
			this.method6707(local47);
		}
	}

	@OriginalMember(owner = "client!p", name = "a", descriptor = "(II)V")
	public void method6710(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas9.getTreeLock()) {
