...
public final class p extends Class3 implements Interface9 {
	...
	public void method6566(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas12.getTreeLock()) {
				...
				Static418.aBoolean536 = false;
			}
		} catch (@Pc(26) Exception local26) {
			this.method6570(local26);
		}
	}
	...
	public void method6567(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt7583 = arg1;
		this.anInt7582 = arg2;
	...
	public void method6568(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			synchronized (this.aCanvas12.getTreeLock()) {
	...
	private void method6570(@OriginalArg(0) Exception arg0) {
		if (!Static418.aBoolean536) {
			Static418.aLong201 = Static374.method6036();
			Static418.aBoolean536 = true;
		} else if (Static374.method6036() - Static418.aLong201 < 30000L) {
