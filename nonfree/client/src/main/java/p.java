...
public final class p extends Class5 implements Interface4 {
	...
	public p(@OriginalArg(0) oa arg0, @OriginalArg(1) Canvas arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		this.anInt7190 = arg2;
		this.anInt7189 = arg3;
		this.sa(arg0, this.aCanvas17, arg2, arg3);
	}
	...
	private void method6348(@OriginalArg(0) Exception arg0) {
		if (!Static414.aBoolean511) {
			Static414.aLong181 = Static95.method1587();
			Static414.aBoolean511 = true;
		} else if (Static95.method1587() - Static414.aLong181 < 30000L) {
	...
	public void method6349(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt7190 = arg1;
		this.anInt7189 = arg2;
	...
	public void method6351(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			synchronized (this.aCanvas17.getTreeLock()) {
				...
				Static414.aBoolean511 = false;
			}
		} catch (@Pc(43) Exception local43) {
			this.method6348(local43);
		}
	}

	@OriginalMember(owner = "client!p", name = "c", descriptor = "(II)V")
	public void method6352(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas17.getTreeLock()) {
				@Pc(9) Dimension local9 = this.aCanvas17.getSize();
				this.H(arg0, arg1, local9.width, local9.height);
				Static414.aBoolean511 = false;
			}
		} catch (@Pc(26) Exception local26) {
			this.method6348(local26);
		}
	}
