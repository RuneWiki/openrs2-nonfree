...
public final class p extends Class5 implements Interface11 {
	...
	public void method6347(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt7290 = arg1;
		this.anInt7291 = arg2;
	...
	public void method6348(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas9.getTreeLock()) {
				...
				Static441.aBoolean493 = false;
			}
		} catch (@Pc(26) Exception local26) {
			this.method6350(local26);
		}
	}
	...
	public void method6349(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			synchronized (this.aCanvas9.getTreeLock()) {
	...
	private void method6350(@OriginalArg(0) Exception arg0) {
		if (!Static441.aBoolean493) {
			Static441.aLong209 = Static480.method6763();
			Static441.aBoolean493 = true;
		} else if (Static480.method6763() - Static441.aLong209 < 30000L) {
