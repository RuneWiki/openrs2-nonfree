...
public final class p extends Class2 implements Interface3 {
	...
	private void method6173(@OriginalArg(0) Exception arg0) {
		if (!Static423.aBoolean502) {
			Static423.aLong187 = Static48.method1203();
			Static423.aBoolean502 = true;
		} else if (Static48.method1203() - Static423.aLong187 < 30000L) {
	...
	public void method6174(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			synchronized (this.aCanvas8.getTreeLock()) {
				...
				Static423.aBoolean502 = false;
			}
		} catch (@Pc(43) Exception local43) {
			this.method6173(local43);
		}
	}
	...
	public void method6175(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt7051 = arg1;
		this.anInt7052 = arg2;
	...
	public void method6176(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas8.getTreeLock()) {
