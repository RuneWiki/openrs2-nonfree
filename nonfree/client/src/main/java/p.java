...
public final class p extends Class3 implements Interface5 {
	...
	public void method6052(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			synchronized (this.aCanvas8.getTreeLock()) {
				...
				Static446.aBoolean513 = false;
			}
		} catch (@Pc(43) Exception local43) {
			this.method6053(local43);
		}
	}
	...
	private void method6053(@OriginalArg(0) Exception arg0) {
		if (!Static446.aBoolean513) {
			Static446.aLong198 = Static15.method380();
			Static446.aBoolean513 = true;
		} else if (Static15.method380() - Static446.aLong198 < 30000L) {
	...
	public void method6054(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas8.getTreeLock()) {
	...
	public void method6056(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt7201 = arg1;
		this.anInt7200 = arg2;
