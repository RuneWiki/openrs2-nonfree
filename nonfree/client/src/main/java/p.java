...
public final class p extends Class6 implements Interface12 {
	...
	public void method6891(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas12.getTreeLock()) {
				...
				Static445.aBoolean583 = false;
			}
		} catch (@Pc(26) Exception local26) {
			this.method6892(local26);
		}
	}
	...
	private void method6892(@OriginalArg(0) Exception arg0) {
		if (!Static445.aBoolean583) {
			Static445.aLong247 = Static549.method7758();
			Static445.aBoolean583 = true;
		} else if (Static549.method7758() - Static445.aLong247 < 30000L) {
	...
	public void method6893(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt7717 = arg1;
		this.anInt7716 = arg2;
	...
	public void method6894(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			synchronized (this.aCanvas12.getTreeLock()) {
