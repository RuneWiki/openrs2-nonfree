...
public final class p extends Class6 implements Interface10 {
	...
	public void method6529(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			synchronized (this.aCanvas11.getTreeLock()) {
				...
				Static419.aBoolean613 = false;
			}
		} catch (@Pc(43) Exception local43) {
			this.method6530(local43);
		}
	}
	...
	private void method6530(@OriginalArg(0) Exception arg0) {
		if (!Static419.aBoolean613) {
			Static419.aLong209 = Static582.method8056();
			Static419.aBoolean613 = true;
		} else if (Static582.method8056() - Static419.aLong209 < 30000L) {
	...
	public void method6531(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			...
			this.method6530(local26);
		}
	}

	@OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/awt/Canvas;II)V")
	public void method6532(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt7762 = arg1;
		this.anInt7763 = arg2;
