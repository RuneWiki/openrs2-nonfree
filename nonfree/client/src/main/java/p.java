...
public final class p extends Class5 implements Interface10 {
	...
	public void method6368(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			synchronized (this.aCanvas8.getTreeLock()) {
				...
				Static419.aBoolean599 = false;
			}
		} catch (@Pc(43) Exception local43) {
			this.method6369(local43);
		}
	}

	@OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/lang/Exception;)V")
	private void method6369(@OriginalArg(0) Exception arg0) {
		if (!Static419.aBoolean599) {
			Static419.aLong197 = Static205.method3179();
			Static419.aBoolean599 = true;
		} else if (Static205.method3179() - Static419.aLong197 < 30000L) {
	...
	public void method6371(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas8.getTreeLock()) {
	...
	public void method6372(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt7177 = arg1;
		this.anInt7176 = arg2;
