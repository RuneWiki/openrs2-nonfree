...
public final class p extends Class6 implements Interface7 {
	...
	private void method6435(@OriginalArg(0) Exception arg0) {
		if (!Static437.aBoolean500) {
			Static437.aLong216 = Static566.method7936();
			Static437.aBoolean500 = true;
		} else if (Static566.method7936() - Static437.aLong216 < 30000L) {
	...
	public void method6436(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			synchronized (this.aCanvas9.getTreeLock()) {
				...
				Static437.aBoolean500 = false;
			}
		} catch (@Pc(43) Exception local43) {
			this.method6435(local43);
		}
	}
	...
	public void method6438(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt7443 = arg1;
		this.anInt7442 = arg2;
	...
	public void method6439(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas9.getTreeLock()) {
