...
public final class p extends Class3 implements Interface4 {
	...
	private void method6974(@OriginalArg(0) Exception arg0) {
		if (!Static473.aBoolean629) {
			Static473.aLong273 = Static626.method8479();
			Static473.aBoolean629 = true;
		} else if (Static626.method8479() - Static473.aLong273 < 30000L) {
	...
	public void method6975(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt8303 = arg1;
		this.anInt8302 = arg2;
	...
	public void method6976(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas12.getTreeLock()) {
				...
				Static473.aBoolean629 = false;
			}
		} catch (@Pc(26) Exception local26) {
			this.method6974(local26);
		}
	}
	...
	public void method6978(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			synchronized (this.aCanvas12.getTreeLock()) {
