...
public final class p extends Class5 implements Interface5 {
	...
	public void method6562(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt7730 = arg1;
		this.anInt7729 = arg2;
	...
	public void method6563(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			synchronized (this.aCanvas12.getTreeLock()) {
				...
				Static438.aBoolean564 = false;
			}
		} catch (@Pc(43) Exception local43) {
			this.method6564(local43);
		}
	}

	@OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/lang/Exception;)V")
	private void method6564(@OriginalArg(0) Exception arg0) {
		if (!Static438.aBoolean564) {
			Static438.aLong232 = Static124.method1947();
			Static438.aBoolean564 = true;
		} else if (Static124.method1947() - Static438.aLong232 < 30000L) {
