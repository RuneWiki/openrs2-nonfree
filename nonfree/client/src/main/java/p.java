...
public final class p extends Class3 implements Interface7 {
	...
	private void method6536(@OriginalArg(0) Exception arg0) {
		if (!Static418.aBoolean665) {
			Static418.aLong190 = Static444.method6719();
			Static418.aBoolean665 = true;
		} else if (Static444.method6719() - Static418.aLong190 < 30000L) {
	...
	public void method6537(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			synchronized (this.aCanvas11.getTreeLock()) {
				...
				Static418.aBoolean665 = false;
			}
		} catch (@Pc(43) Exception local43) {
			this.method6536(local43);
		}
	}

	@OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/awt/Canvas;II)V")
	public void method6538(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt7806 = arg1;
		this.anInt7807 = arg2;
	...
	public void method6539(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas11.getTreeLock()) {
