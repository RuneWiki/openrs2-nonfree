...
public final class p extends Class5 implements Interface7 {
	...
	private void method6369(@OriginalArg(0) Exception arg0) {
		if (!Static434.aBoolean651) {
			Static434.aLong204 = Static547.method7619();
			Static434.aBoolean651 = true;
		} else if (Static547.method7619() - Static434.aLong204 < 30000L) {
	...
	public void method6371(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt7541 = arg1;
		this.anInt7542 = arg2;
	...
	public void method6372(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
	...
	public void method6373(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas12.getTreeLock()) {
