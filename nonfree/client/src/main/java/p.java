...
public final class p extends Class3 implements Interface6 {
	...
	public int anInt7552;

	@OriginalMember(owner = "client!p", name = "i", descriptor = "I")
	public int anInt7551;
	...
	public void method6523(@OriginalArg(0) Canvas arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		this.anInt7552 = arg1;
		this.anInt7551 = arg2;
	...
	public void method6524(@OriginalArg(0) Rectangle[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			synchronized (this.aCanvas7.getTreeLock()) {
				...
				Static483.aBoolean510 = false;
			}
		} catch (@Pc(47) Exception local47) {
			this.method6525(local47);
		}
	}
	...
	private void method6525(@OriginalArg(0) Exception arg0) {
		if (!Static483.aBoolean510) {
			Static483.aLong253 = Static517.method6965();
			Static483.aBoolean510 = true;
		} else if (Static517.method6965() - Static483.aLong253 < 30000L) {
	...
	public void method6526(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		try {
			synchronized (this.aCanvas7.getTreeLock()) {
