...
public final class Class7_Sub15 extends Class7 {
	...
	@OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(ILclient!qea;)V")
	public Class7_Sub15(@OriginalArg(0) int arg0, @OriginalArg(1) Class3_Sub41 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Lclient!qea;)V")
	public Class7_Sub15(@OriginalArg(0) Class3_Sub41 arg0) {
		super(arg0);
	}
	...
	public void method8575() {
		if (super.anInt10115 < 0 && super.anInt10115 > 127) {
