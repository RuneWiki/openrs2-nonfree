...
public final class Static46 {
	...
	@OriginalMember(owner = "client!dh", name = "r", descriptor = "Lclient!wm;")
	public static Class2_Sub26 aClass2_Sub26_1 = new Class2_Sub26(10000);

	@OriginalMember(owner = "client!dh", name = "U", descriptor = "Lclient!dh;")
	public static Class36_Sub2_Sub1 aClass36_Sub2_Sub1_1 = new Class36_Sub2_Sub1();

	@OriginalMember(owner = "client!dh", name = "gb", descriptor = "Lclient!dh;")
	public static Class36_Sub2_Sub1 aClass36_Sub2_Sub1_2 = new Class36_Sub2_Sub1();

	@OriginalMember(owner = "client!dh", name = "lb", descriptor = "Lclient!dh;")
	public static Class36_Sub2_Sub1 aClass36_Sub2_Sub1_3 = new Class36_Sub2_Sub1();

	@OriginalMember(owner = "client!dh", name = "mb", descriptor = "Lclient!dh;")
	public static Class36_Sub2_Sub1 aClass36_Sub2_Sub1_4 = new Class36_Sub2_Sub1();

	@OriginalMember(owner = "client!dh", name = "nb", descriptor = "Lclient!dh;")
	public static Class36_Sub2_Sub1 aClass36_Sub2_Sub1_5 = new Class36_Sub2_Sub1();

	@OriginalMember(owner = "client!dh", name = "ob", descriptor = "Lclient!dh;")
	...
	public static int[] anIntArray89 = new int[1];

	@OriginalMember(owner = "client!dh", name = "zb", descriptor = "[I")
	public static int[] anIntArray90 = new int[1];

	@OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIIIII[FIF)V")
	public static void method939(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) int arg7, @OriginalArg(8) float arg8) {
	...
	@OriginalMember(owner = "client!dh", name = "a", descriptor = "([SI)[S")
	public static short[] method942(@OriginalArg(0) short[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) short[] local2 = new short[arg1];
		Static301.method300(arg0, 0, local2, 0, arg1);
		return local2;
	}

	@OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIIIFFF)[F")
	public static float[] method944(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) float arg4, @OriginalArg(5) float arg5, @OriginalArg(6) float arg6) {
	...
	public static float[] method949(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1) {
		@Pc(2) float[] local2 = new float[arg1];
		Static301.method303(arg0, 0, local2, 0, arg1);
		return local2;
	}

	@OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIIIIII[FIFFF)V")
	public static void method952(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) float[] arg7, @OriginalArg(8) int arg8, @OriginalArg(9) float arg9, @OriginalArg(10) float arg10, @OriginalArg(11) float arg11) {
		@Pc(3) int local3 = arg0 - arg3;
		@Pc(7) int local7 = arg1 - arg4;
		@Pc(11) int local11 = arg2 - arg5;
	...
	@OriginalMember(owner = "client!dh", name = "s", descriptor = "()V")
	...
	@OriginalMember(owner = "client!dh", name = "a", descriptor = "(ISIB)I")
	public static int method964(@OriginalArg(0) int arg0, @OriginalArg(1) short arg1, @OriginalArg(2) int arg2, @OriginalArg(3) byte arg3) {
		@Pc(5) int local5 = Static93.anIntArray152[Static228.method3865(arg0, arg2)];
		if (arg1 != -1) {
			@Pc(15) int local15 = Static93.anInterface5_1.method3514(arg1 & 0xFFFF);
			@Pc(21) int local21;
			@Pc(44) int local44;
			if (local15 != 0) {
				if (arg2 < 0) {
			...
			local21 = Static93.anInterface5_1.method3511(arg1 & 0xFFFF);
			if (local21 != 0) {
				local21 += 256;
	...
	@OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIIIII[FFIF)V")
	public static void method965(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) float[] arg6, @OriginalArg(7) float arg7, @OriginalArg(8) int arg8, @OriginalArg(9) float arg9) {
		@Pc(3) int local3 = arg0 - arg3;
		@Pc(7) int local7 = arg1 - arg4;
		@Pc(11) int local11 = arg2 - arg5;
		@Pc(32) float local32 = (float) local3 * arg6[0] + (float) local7 * arg6[1] + (float) local11 * arg6[2];
	...
	@OriginalMember(owner = "client!dh", name = "a", descriptor = "(FFF)I")
	public static int method969(@OriginalArg(0) float arg0, @OriginalArg(1) float arg1, @OriginalArg(2) float arg2) {
