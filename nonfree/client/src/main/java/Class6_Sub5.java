...
public final class Class6_Sub5 extends Class6 {
	...
	@OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "(ILclient!hs;)V")
	public Class6_Sub5(@OriginalArg(0) int arg0, @OriginalArg(1) Class5_Sub25 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!cfa", name = "<init>", descriptor = "(Lclient!hs;)V")
	public Class6_Sub5(@OriginalArg(0) Class5_Sub25 arg0) {
		super(arg0);
	}
