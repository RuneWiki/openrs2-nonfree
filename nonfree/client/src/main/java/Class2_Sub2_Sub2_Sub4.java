...
public final class Class2_Sub2_Sub2_Sub4 extends Class2_Sub2_Sub2 {
		...
		try {
			...
			for (@Pc(71) int local71 = 0; local71 < arg3; local71++) {
				...
				for (@Pc(97) int local97 = -arg9[local71]; local97 < 0; local97++) {
					Static26.anIntArray533[local80++] = this.anIntArray534[(local86 >> 16) + (local92 >> 16) * this.anInt2446];
					local86 += local39;
					local92 -= local33;
				}
				local51 += local33;
	...
	public void method1618(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (local23 > 0 && local20 > 0) {
			Static115.method1626(Static26.anIntArray533, this.anIntArray534, local17, local15, local23, local20, local27, local29);
		}
	}
	...
	public void method1619(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (local23 > 0 && local20 > 0) {
			Static115.method1617(Static26.anIntArray533, this.anIntArray534, local17, local15, local23, local20, local27, local29);
		}
	}
	...
	public void method1622(@OriginalArg(0) Class2_Sub2_Sub2_Sub3 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if (local23 > 0 && local20 > 0) {
			Static115.method1625(Static26.anIntArray533, this.anIntArray534, local17, local15, local23, local20, local27, local29, arg0.aByteArray16);
		}
	}
	...
	public void method1624(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (local23 > 0 && local20 > 0) {
			Static115.method1627(Static26.anIntArray533, this.anIntArray534, local17, local15, local23, local20, local27, local29);
		}
	}

	@OriginalMember(owner = "client!vb", name = "e", descriptor = "()V")
	public void method1628() {
		Static26.method1604(this.anIntArray534, this.anInt2446, this.anInt2442);
	}
}
