...
public final class Class2_Sub25 extends Class2 {
	...
	public static final Class89 aClass89_163;
	...
	public Class2_Sub21_Sub1[] aClass2_Sub21_Sub1Array1;
	...
	static {
		...
		aClass89_163 = new Class89(102, 12);
	}
	...
	public Class2_Sub25(@OriginalArg(0) byte[] arg0) {
		...
		this.aClass2_Sub21_Sub1Array1 = new Class2_Sub21_Sub1[128];
		this.aByteArray47 = new byte[128];
		this.aClass17Array1 = new Class17[128];
		this.aByteArray45 = new byte[128];
		@Pc(36) Class2_Sub4 local36 = new Class2_Sub4(arg0);
		@Pc(38) int local38;
		for (local38 = 0; local36.aByteArray73[local36.anInt5289 + local38] != 0; local38++) {
		}
		@Pc(52) byte[] local52 = new byte[local38];
		for (@Pc(54) int local54 = 0; local54 < local38; local54++) {
			local52[local54] = local36.method4826();
		}
		local38++;
		local36.anInt5289++;
		@Pc(80) int local80 = local36.anInt5289;
		local36.anInt5289 += local38;
		@Pc(88) int local88;
		for (local88 = 0; local36.aByteArray73[local36.anInt5289 + local88] != 0; local88++) {
		}
		@Pc(102) byte[] local102 = new byte[local88];
		for (@Pc(104) int local104 = 0; local104 < local88; local104++) {
			local102[local104] = local36.method4826();
		}
		local88++;
		local36.anInt5289++;
		@Pc(130) int local130 = local36.anInt5289;
		local36.anInt5289 += local88;
		@Pc(138) int local138;
		for (local138 = 0; local36.aByteArray73[local138 + local36.anInt5289] != 0; local138++) {
		}
		@Pc(152) byte[] local152 = new byte[local138];
		for (@Pc(154) int local154 = 0; local154 < local138; local154++) {
			local152[local154] = local36.method4826();
		}
		local138++;
		local36.anInt5289++;
		...
		for (local189 = 0; local189 < local224.length; local189++) {
			...
			@Pc(240) int local240 = local36.method4816();
			if (local240 > 0) {
				local236.aByteArray3 = new byte[local240 * 2];
			}
			local240 = local36.method4816();
			if (local240 > 0) {
		...
		@Pc(312) int local312;
		for (local312 = 0; local36.aByteArray73[local312 + local36.anInt5289] != 0; local312++) {
		}
		@Pc(329) byte[] local329 = new byte[local312];
		for (@Pc(331) int local331 = 0; local331 < local312; local331++) {
			local329[local331] = local36.method4826();
		}
		local36.anInt5289++;
		local312++;
		@Pc(352) int local352 = 0;
		for (@Pc(354) int local354 = 0; local354 < 128; local354++) {
			local352 += local36.method4816();
			this.aShortArray89[local354] = (short) local352;
		}
		local352 = 0;
		for (@Pc(378) int local378 = 0; local378 < 128; local378++) {
			local352 += local36.method4816();
			this.aShortArray89[local378] = (short) (this.aShortArray89[local378] + (local352 << 8));
		}
		...
		for (@Pc(411) int local411 = 0; local411 < 128; local411++) {
			if (local405 == 0) {
				...
				local409 = local36.method4813();
			}
			this.aShortArray89[local411] = (short) (this.aShortArray89[local411] + ((local409 - 1 & 0x2) << 14));
		...
		for (@Pc(630) int local630 = 0; local630 < 128; local630++) {
			if (local405 == 0) {
				...
				if (this.anIntArray264[local630] > 0) {
					local628 = local36.method4816() + 1;
				}
			}
			local405--;
			this.aByteArray47[local630] = (byte) local628;
		}
		this.anInt4059 = local36.method4816() + 1;
		@Pc(689) int local689;
		for (@Pc(678) int local678 = 0; local678 < local187; local678++) {
			...
			if (local684.aByteArray3 != null) {
				for (local689 = 1; local689 < local684.aByteArray3.length; local689 += 2) {
					local684.aByteArray3[local689] = local36.method4826();
				}
			}
			if (local684.aByteArray4 != null) {
				for (local689 = 3; local689 < local684.aByteArray4.length - 2; local689 += 2) {
					local684.aByteArray4[local689] = local36.method4826();
				}
			}
		}
		@Pc(742) int local742;
		if (local294 != null) {
			for (local742 = 1; local742 < local294.length; local742 += 2) {
				local294[local742] = local36.method4826();
			}
		}
		if (local310 != null) {
			for (local742 = 1; local742 < local310.length; local742 += 2) {
				local310[local742] = local36.method4826();
			}
		}
		@Pc(791) int local791;
		...
		for (local689 = 0; local689 < local187; local689++) {
			...
			if (local833.aByteArray3 != null) {
				...
				for (local840 = 2; local840 < local833.aByteArray3.length; local840 += 2) {
					local352 = local352 + local36.method4816() + 1;
		...
		if (local294 != null) {
			...
			while (local294.length > local933) {
				...
				for (local961 = local904; local961 < local939; local961++) {
					local971 = Static205.method3877(local959, local939 - local904);
	...
	@OriginalMember(owner = "client!ne", name = "a", descriptor = "([BLclient!bk;I[I)Z", line = 509)
	public boolean method4019(@OriginalArg(0) byte[] arg0, @OriginalArg(1) Class24 arg1, @OriginalArg(3) int[] arg2) {
