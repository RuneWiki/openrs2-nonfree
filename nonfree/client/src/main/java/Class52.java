...
public final class Class52 {
	...
	private void method1402(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub18 local4 = new Class1_Sub18(arg0);
		this.anInt2001 = local4.method2185();
		this.anInt2002 = local4.method2185();
		this.anInt2009 = local4.method2185();
		this.anInt2003 = local4.method2185();
		if (this.anInt2003 < 0) {
			this.anInt2003 = ~this.anInt2003;
			this.aBoolean168 = true;
		}
		@Pc(40) int local40 = local4.method2185();
		this.aByteArrayArray9 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method2169();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method2167(local64, local49);
			this.aByteArrayArray9[local46] = local64;
		}
	}

	@OriginalMember(owner = "client!ne", name = "b", descriptor = "(I)[F")
	private float[] method1403(@OriginalArg(0) int arg0) {
		Static83.method1406(this.aByteArrayArray9[arg0]);
		Static83.method1404();
		@Pc(15) int local15 = Static83.method1399(Static47.method828(Static83.anIntArray310.length - 1));
		@Pc(19) boolean local19 = Static83.aBooleanArray11[local15];
		@Pc(25) int local25 = local19 ? Static83.anInt2006 : Static83.anInt2007;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static83.method1404() != 0;
			local29 = Static83.method1404() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static83.anInt2007 >> 2);
			local67 = (local25 >> 2) + (Static83.anInt2007 >> 2);
			local71 = Static83.anInt2007 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static83.anInt2007 >> 2);
			local104 = local25 + (Static83.anInt2007 >> 2) - (local25 >> 2);
			local108 = Static83.anInt2007 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class2 local123 = Static83.aClass2Array1[Static83.anIntArray310[local15]];
		@Pc(126) int local126 = local123.anInt157;
		@Pc(131) int local131 = local123.anIntArray25[local126];
		@Pc(140) boolean local140 = !Static83.aClass69Array1[local131].method1947();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt158; local144++) {
			@Pc(152) Class20 local152 = Static83.aClass20Array1[local123.anIntArray26[local144]];
			local154 = Static83.aFloatArray8;
			local152.method650(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt157;
			local176 = local123.anIntArray25[local171];
			Static83.aClass69Array1[local176].method1954(Static83.aFloatArray8, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static83.aFloatArray8[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static83.aFloatArray8;
			...
			@Pc(252) float[] local252 = local19 ? Static83.aFloatArray1 : Static83.aFloatArray5;
			@Pc(258) float[] local258 = local19 ? Static83.aFloatArray4 : Static83.aFloatArray7;
			@Pc(264) float[] local264 = local19 ? Static83.aFloatArray2 : Static83.aFloatArray6;
			@Pc(270) int[] local270 = local19 ? Static83.anIntArray311 : Static83.anIntArray312;
			...
			@Pc(486) int local486 = Static47.method828(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static83.aFloatArray8[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static83.aFloatArray8[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (Static83.anInt2010 > 0) {
			local176 = Static83.anInt2010 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1250) int local1250;
			if (!Static83.aBoolean167) {
				for (local212 = 0; local212 < Static83.anInt2004; local212++) {
					local1250 = (Static83.anInt2010 >> 1) + local212;
					local1228[local212] += Static83.aFloatArray3[local1250];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1250 = local1228.length + local212 - (local25 >> 1);
					local1228[local1250] += Static83.aFloatArray8[local212];
				}
			}
		}
		local154 = Static83.aFloatArray3;
		Static83.aFloatArray3 = Static83.aFloatArray8;
		Static83.aFloatArray8 = local154;
		Static83.anInt2010 = local25;
		Static83.anInt2004 = local104 - (local25 >> 1);
		Static83.aBoolean167 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!ne", name = "c", descriptor = "()Lclient!pd;")
	public Class1_Sub16_Sub1 method1409() {
		Static83.anInt2010 = 0;
		@Pc(5) byte[] local5 = new byte[this.anInt2002];
		@Pc(7) int local7 = 0;
		for (@Pc(9) int local9 = 0; local9 < this.aByteArrayArray9.length; local9++) {
			@Pc(14) float[] local14 = this.method1403(local9);
			if (local14 != null) {
				@Pc(19) int local19 = local14.length;
				if (local19 > this.anInt2002 - local7) {
					local19 = this.anInt2002 - local7;
				}
		...
		return new Class1_Sub16_Sub1(this.anInt2001, local5, this.anInt2009, this.anInt2003, this.aBoolean168);
	}
}
