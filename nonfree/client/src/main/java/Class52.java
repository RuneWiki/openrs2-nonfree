...
public final class Class52 {
	...
	@OriginalMember(owner = "client!mb", name = "a", descriptor = "(I)[F")
	private float[] method1204(@OriginalArg(0) int arg0) {
		Static73.method1202(this.aByteArrayArray6[arg0]);
		Static73.method1209();
		@Pc(15) int local15 = Static73.method1211(Static16.method383(Static73.anIntArray288.length - 1));
		@Pc(19) boolean local19 = Static73.aBooleanArray5[local15];
		@Pc(25) int local25 = local19 ? Static73.anInt1533 : Static73.anInt1528;
		@Pc(27) boolean local27 = false;
		@Pc(29) boolean local29 = false;
		if (local19) {
			local27 = Static73.method1209() != 0;
			local29 = Static73.method1209() != 0;
		}
		...
		@Pc(71) int local71;
		if (local19 && !local27) {
			local59 = (local25 >> 2) - (Static73.anInt1528 >> 2);
			local67 = (local25 >> 2) + (Static73.anInt1528 >> 2);
			local71 = Static73.anInt1528 >> 1;
		} else {
			local59 = 0;
			local67 = local47;
			local71 = local25 >> 1;
		...
		@Pc(108) int local108;
		if (local19 && !local29) {
			local94 = local25 - (local25 >> 2) - (Static73.anInt1528 >> 2);
			local104 = local25 + (Static73.anInt1528 >> 2) - (local25 >> 2);
			local108 = Static73.anInt1528 >> 1;
		} else {
			local94 = local47;
			local104 = local25;
			local108 = local25 >> 1;
		}
		@Pc(123) Class15 local123 = Static73.aClass15Array1[Static73.anIntArray288[local15]];
		@Pc(126) int local126 = local123.anInt453;
		@Pc(131) int local131 = local123.anIntArray98[local126];
		@Pc(140) boolean local140 = !Static73.aClass28Array1[local131].method902();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt452; local144++) {
			@Pc(152) Class78 local152 = Static73.aClass78Array1[local123.anIntArray99[local144]];
			local154 = Static73.aFloatArray8;
			local152.method1993(local154, local25 >> 1, local140);
		}
		@Pc(171) int local171;
		@Pc(176) int local176;
		if (!local140) {
			local171 = local123.anInt453;
			local176 = local123.anIntArray98[local171];
			Static73.aClass28Array1[local176].method903(Static73.aFloatArray8, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
			for (local171 = local25 >> 1; local171 < local25; local171++) {
				Static73.aFloatArray8[local171] = 0.0F;
			}
		} else {
			local171 = local25 >> 1;
			local176 = local25 >> 2;
			local212 = local25 >> 3;
			@Pc(214) float[] local214 = Static73.aFloatArray8;
			...
			@Pc(252) float[] local252 = local19 ? Static73.aFloatArray2 : Static73.aFloatArray9;
			@Pc(258) float[] local258 = local19 ? Static73.aFloatArray6 : Static73.aFloatArray5;
			@Pc(264) float[] local264 = local19 ? Static73.aFloatArray4 : Static73.aFloatArray3;
			@Pc(270) int[] local270 = local19 ? Static73.anIntArray286 : Static73.anIntArray287;
			...
			@Pc(486) int local486 = Static16.method383(local25 - 1);
			@Pc(520) int local520;
			@Pc(522) int local522;
			@Pc(527) int local527;
			...
			for (@Pc(1150) int local1150 = local59; local1150 < local67; local1150++) {
				...
				Static73.aFloatArray8[local1150] *= (float) Math.sin((double) local559 * 1.5707963267948966D * (double) local559);
			}
			for (@Pc(1188) int local1188 = local94; local1188 < local104; local1188++) {
				...
				Static73.aFloatArray8[local1188] *= (float) Math.sin((double) local585 * 1.5707963267948966D * (double) local585);
			}
		}
		@Pc(1228) float[] local1228 = null;
		if (Static73.anInt1526 > 0) {
			local176 = Static73.anInt1526 + local25 >> 2;
			local1228 = new float[local176];
			@Pc(1250) int local1250;
			if (!Static73.aBoolean58) {
				for (local212 = 0; local212 < Static73.anInt1525; local212++) {
					local1250 = (Static73.anInt1526 >> 1) + local212;
					local1228[local212] += Static73.aFloatArray7[local1250];
				}
			}
			if (!local140) {
				for (local212 = local59; local212 < local25 >> 1; local212++) {
					local1250 = local1228.length + local212 - (local25 >> 1);
					local1228[local1250] += Static73.aFloatArray8[local212];
				}
			}
		}
		local154 = Static73.aFloatArray7;
		Static73.aFloatArray7 = Static73.aFloatArray8;
		Static73.aFloatArray8 = local154;
		Static73.anInt1526 = local25;
		Static73.anInt1525 = local104 - (local25 >> 1);
		Static73.aBoolean58 = local140;
		return local1228;
	}

	@OriginalMember(owner = "client!mb", name = "b", descriptor = "()Lclient!pa;")
	public Class1_Sub14_Sub1 method1208() {
		Static73.anInt1526 = 0;
		@Pc(5) byte[] local5 = new byte[this.anInt1532];
		@Pc(7) int local7 = 0;
		for (@Pc(9) int local9 = 0; local9 < this.aByteArrayArray6.length; local9++) {
			@Pc(14) float[] local14 = this.method1204(local9);
			if (local14 != null) {
				@Pc(19) int local19 = local14.length;
				if (local19 > this.anInt1532 - local7) {
					local19 = this.anInt1532 - local7;
				}
		...
		return new Class1_Sub14_Sub1(this.anInt1534, local5, this.anInt1530, this.anInt1531, this.aBoolean56);
	}

	@OriginalMember(owner = "client!mb", name = "b", descriptor = "([B)V")
	private void method1210(@OriginalArg(0) byte[] arg0) {
		@Pc(4) Class1_Sub5 local4 = new Class1_Sub5(arg0);
		this.anInt1534 = local4.method663();
		this.anInt1532 = local4.method663();
		this.anInt1530 = local4.method663();
		this.anInt1531 = local4.method663();
		if (this.anInt1531 < 0) {
			this.anInt1531 = ~this.anInt1531;
			this.aBoolean56 = true;
		}
		@Pc(40) int local40 = local4.method663();
		this.aByteArrayArray6 = new byte[local40][];
		for (@Pc(46) int local46 = 0; local46 < local40; local46++) {
			@Pc(49) int local49 = 0;
			@Pc(53) int local53;
			do {
				local53 = local4.method672();
				local49 += local53;
			} while (local53 >= 255);
			@Pc(64) byte[] local64 = new byte[local49];
			local4.method655(local64, local49);
