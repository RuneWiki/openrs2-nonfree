...
public final class Class33_Sub1 extends Class33 {
	...
	@OriginalMember(owner = "client!bea", name = "<init>", descriptor = "(ILclient!wo;)V")
	public Class33_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub49 arg1) {
		super(arg0, arg1);
	}

	@OriginalMember(owner = "client!bea", name = "<init>", descriptor = "(Lclient!wo;)V")
	public Class33_Sub1(@OriginalArg(0) Class2_Sub49 arg0) {
		super(arg0);
	}
