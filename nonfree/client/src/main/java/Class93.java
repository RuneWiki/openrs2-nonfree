...
public final class Class93 {
	...
	@OriginalMember(owner = "client!eia", name = "a", descriptor = "Ljava/awt/DisplayMode;")
	private DisplayMode aDisplayMode1;

	@OriginalMember(owner = "client!eia", name = "b", descriptor = "Ljava/awt/GraphicsDevice;")
	private GraphicsDevice aGraphicsDevice1;

	@OriginalMember(owner = "client!eia", name = "<init>", descriptor = "()V")
	private Class93() throws Exception {
	...
	@OriginalMember(owner = "client!eia", name = "enter", descriptor = "(Ljava/awt/Frame;IIII)V")
		...
		if (arg4 == 0) {
			...
			for (@Pc(40) int local40 = 0; local40 < local36.length; local40++) {
				if (local36[local40].getWidth() == arg1 && arg2 == local36[local40].getHeight() && local36[local40].getBitDepth() == arg3) {
					@Pc(77) int local77 = local36[local40].getRefreshRate();
					if (!local38 || Math.abs(local77 - local32) < Math.abs(arg4 - local32)) {
						local38 = true;
						arg4 = local77;
					}
				}
	...
	@OriginalMember(owner = "client!eia", name = "listmodes", descriptor = "()[I")
	...
	@OriginalMember(owner = "client!eia", name = "exit", descriptor = "()V")
	private void exit() {
		if (this.aDisplayMode1 != null) {
		...
		this.method2401((Frame) null, 0);
	}

	@OriginalMember(owner = "client!eia", name = "a", descriptor = "(Ljava/awt/Frame;I)V")
	private void method2401(@OriginalArg(0) Frame arg0, @OriginalArg(1) int arg1) {
		...
		if (arg1 != 0) {
			this.aGraphicsDevice1 = (GraphicsDevice) null;
		}
	}
}
