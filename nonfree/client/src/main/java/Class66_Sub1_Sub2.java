...
public final class Class66_Sub1_Sub2 extends Class66_Sub1 {
	...
	@OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(Lclient!uq;[IIIII)V")
	public Class66_Sub1_Sub2(@OriginalArg(0) Class9_Sub1 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		super(arg0, arg4, arg5);
		this.anIntArray469 = new int[arg4 * arg5];
		@Pc(15) int local15 = arg3 - super.anInt9679;
		@Pc(17) int local17 = 0;
		for (@Pc(19) int local19 = 0; local19 < arg5; local19++) {
			for (@Pc(22) int local22 = 0; local22 < arg4; local22++) {
				@Pc(28) int local28 = arg1[arg2++];
				if (local28 >>> 24 == 255) {
					this.anIntArray469[local17++] = (local28 & 0xFFFFFF) == 0 ? -16777215 : local28;
				} else {
					this.anIntArray469[local17++] = 0;
				}
			}
			arg2 += local15;
		}
	...
	@OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(Lclient!uq;[III)V")
	public Class66_Sub1_Sub2(@OriginalArg(0) Class9_Sub1 arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		...
		if (arg2 == 1) {
			for (local492 = -local32; local492 < 0; local492++) {
				...
				while (local27 < local499) {
					local506 = this.anIntArray469[local29++];
					if (local506 == 0) {
						local27++;
					} else {
		...
		if (arg2 == 0) {
			if ((arg3 & 0xFFFFFF) == 16777215) {
				...
				for (local506 = -local32; local506 < 0; local506++) {
					for (local617 = -local35; local617 < 0; local617++) {
						local624 = this.anIntArray469[local29++];
						if (local624 == 0) {
							local27++;
						} else {
				...
				for (local630 = -local32; local630 < 0; local630++) {
					for (local711 = -local35; local711 < 0; local711++) {
						local718 = this.anIntArray469[local29++];
						if (local718 == 0) {
							local27++;
						} else {
							@Pc(731) int local731;
			...
			for (local624 = -local32; local624 < 0; local624++) {
				for (local630 = -local35; local630 < 0; local630++) {
					local711 = this.anIntArray469[local29++];
					if (local711 == 0) {
						local27++;
					} else {
			...
			if (arg6 != 0) {
				...
				if (arg6 == 1) {
					if (arg4 == 1) {
						...
						if ((arg5 & 0xFFFFFF) == 16777215) {
							...
							for (local273 = -arg3; local273 < 0; local273++) {
								local330 = (local16 >> 16) * super.anInt9679;
								for (local338 = -arg2; local338 < 0; local338++) {
									local341 = this.anIntArray469[(local14 >> 16) + local330];
									if (local341 == 0) {
										local64++;
									} else {
							...
							for (local341 = -arg3; local341 < 0; local341++) {
								local351 = (local16 >> 16) * super.anInt9679;
								for (local359 = -arg2; local359 < 0; local359++) {
									local367 = this.anIntArray469[(local14 >> 16) + local351];
									if (local367 == 0) {
										local64++;
						...
						for (local338 = -arg3; local338 < 0; local338++) {
							local341 = (local16 >> 16) * super.anInt9679;
					...
					for (local330 = -arg3; local330 < 0; local330++) {
						local338 = (local16 >> 16) * super.anInt9679;
	...
	@OriginalMember(owner = "client!nd", name = "a", descriptor = "(IILclient!fa;II)V")
	@Override
		...
		if (Static102.anInt9661 == 0) {
			if (Static102.anInt9663 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local27 >= 0 && local25 - (super.anInt9679 << 12) < 0 && local27 - (super.anInt9660 << 12) < 0) {
							...
							while (local29 < 0) {
								local111 = this.anIntArray469[(local27 >> 12) * super.anInt9679 + (local25 >> 12)];
								if (local111 == 0) {
									local23++;
								} else {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt9679 << 12) < 0) {
							@Pc(174) int local174;
							if ((local174 = local27 - (super.anInt9660 << 12)) >= 0) {
								local181 = (Static102.anInt9663 - local174) / Static102.anInt9663;
								local29 += local181;
								local27 += Static102.anInt9663 * local181;
								local23 += local181;
							}
							@Pc(202) int local202;
							if ((local202 = (local27 - Static102.anInt9663) / Static102.anInt9663) > local29) {
								local29 = local202;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local25 >= 0 && local25 - (super.anInt9679 << 12) < 0) {
							if (local27 < 0) {
								local181 = (Static102.anInt9663 - local27 - 1) / Static102.anInt9663;
								local29 += local181;
								local27 += Static102.anInt9663 * local181;
								local23 += local181;
							}
							@Pc(369) int local369;
							if ((local369 = (local27 + 1 - (super.anInt9660 << 12) - Static102.anInt9663) / Static102.anInt9663) > local29) {
								local29 = local369;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
			...
			if (Static102.anInt9663 == 0) {
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						if (local27 >= 0 && local27 - (super.anInt9660 << 12) < 0) {
							@Pc(510) int local510;
							if ((local510 = local25 - (super.anInt9679 << 12)) >= 0) {
								local181 = (Static102.anInt9661 - local510) / Static102.anInt9661;
								local29 += local181;
								local25 += Static102.anInt9661 * local181;
								local23 += local181;
							}
							@Pc(538) int local538;
							if ((local538 = (local25 - Static102.anInt9661) / Static102.anInt9661) > local29) {
								local29 = local538;
							}
							local53 = arg0[local14] - arg2;
							local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static102.anInt9675;
						@Pc(670) int local670;
						if ((local670 = local25 - (super.anInt9679 << 12)) >= 0) {
							local181 = (Static102.anInt9661 - local670) / Static102.anInt9661;
							local29 += local181;
							local25 += Static102.anInt9661 * local181;
							local27 += Static102.anInt9663 * local181;
							local23 += local181;
						...
						@Pc(704) int local704;
						if ((local704 = (local25 - Static102.anInt9661) / Static102.anInt9661) > local29) {
							local29 = local704;
						}
						@Pc(716) int local716;
						if ((local716 = local27 - (super.anInt9660 << 12)) >= 0) {
							local181 = (Static102.anInt9663 - local716) / Static102.anInt9663;
							local29 += local181;
							local25 += Static102.anInt9661 * local181;
							local27 += Static102.anInt9663 * local181;
							local23 += local181;
						...
						@Pc(750) int local750;
						if ((local750 = (local27 - Static102.anInt9663) / Static102.anInt9663) > local29) {
							local29 = local750;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
				...
				while (local9 < 0) {
					...
					if (local14 >= 0) {
						...
						local29 = Static102.anInt9675;
						@Pc(888) int local888;
						if ((local888 = local25 - (super.anInt9679 << 12)) >= 0) {
							local181 = (Static102.anInt9661 - local888) / Static102.anInt9661;
							local29 += local181;
							local25 += Static102.anInt9661 * local181;
							local27 += Static102.anInt9663 * local181;
							local23 += local181;
						...
						@Pc(922) int local922;
						if ((local922 = (local25 - Static102.anInt9661) / Static102.anInt9661) > local29) {
							local29 = local922;
						}
						if (local27 < 0) {
							local181 = (Static102.anInt9663 - local27 - 1) / Static102.anInt9663;
						...
						@Pc(970) int local970;
						if ((local970 = (local27 + 1 - (super.anInt9660 << 12) - Static102.anInt9663) / Static102.anInt9663) > local29) {
							local29 = local970;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if (local27 >= 0 && local27 - (super.anInt9660 << 12) < 0) {
						if (local25 < 0) {
							local181 = (Static102.anInt9661 - local25 - 1) / Static102.anInt9661;
							local29 += local181;
							local25 += Static102.anInt9661 * local181;
							local23 += local181;
						}
						@Pc(1147) int local1147;
						if ((local1147 = (local25 + 1 - (super.anInt9679 << 12) - Static102.anInt9661) / Static102.anInt9661) > local29) {
							local29 = local1147;
						}
						local53 = arg0[local14] - arg2;
						local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1319 = (local25 + 1 - (super.anInt9679 << 12) - Static102.anInt9661) / Static102.anInt9661) > local29) {
						local29 = local1319;
					}
					@Pc(1331) int local1331;
					if ((local1331 = local27 - (super.anInt9660 << 12)) >= 0) {
						local181 = (Static102.anInt9663 - local1331) / Static102.anInt9663;
						local29 += local181;
						local25 += Static102.anInt9661 * local181;
						local27 += Static102.anInt9663 * local181;
						local23 += local181;
					...
					if ((local1365 = (local27 - Static102.anInt9663) / Static102.anInt9663) > local29) {
						local29 = local1365;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
			...
			while (local9 < 0) {
				...
				if (local14 >= 0) {
					...
					if ((local1539 = (local25 + 1 - (super.anInt9679 << 12) - Static102.anInt9661) / Static102.anInt9661) > local29) {
						local29 = local1539;
					}
					if (local27 < 0) {
						local181 = (Static102.anInt9663 - local27 - 1) / Static102.anInt9663;
					...
					if ((local1587 = (local27 + 1 - (super.anInt9660 << 12) - Static102.anInt9663) / Static102.anInt9663) > local29) {
						local29 = local1587;
					}
					local53 = arg0[local14] - arg2;
					local58 = -arg1[local14];
	...
	protected void method8070(@OriginalArg(0) int arg0) {
		...
		if (Static102.anInt9661 == 0) {
			if (Static102.anInt9663 == 0) {
							...
							if (arg0 == 1) {
								...
								if (local209 != 0) {
									if ((Static102.anInt9681 & 0xFFFFFF) == 16777215) {
										local234 = Static102.anInt9681 >>> 24;
										...
										local234 = (local209 & 0xFF0000) * Static102.anInt9683 & 0xFF000000;
										local238 = (local209 & 0xFF00) * Static102.anInt9688 & 0xFF0000;
										local242 = (local209 & 0xFF) * Static102.anInt9689 & 0xFF00;
										...
										local3[local51] = ((local209 & 0xFF00FF) * Static102.anInt9669 + (local314 & 0xFF00FF) * Static102.anInt9671 & 0xFF00FF00) + ((local209 & 0xFF00) * Static102.anInt9669 + (local314 & 0xFF00) * Static102.anInt9671 & 0xFF0000) >> 8;
									}
								}
							} else if (arg0 == 3) {
								local209 = this.anIntArray469[local48];
								local234 = Static102.anInt9681;
								...
								if (local209 == 0 && Static102.anInt9669 != 255) {
									local209 = local314;
									local314 = local3[local51];
									local314 = ((local209 & 0xFF00FF) * Static102.anInt9669 + (local314 & 0xFF00FF) * Static102.anInt9671 & 0xFF00FF00) + ((local209 & 0xFF00) * Static102.anInt9669 + (local314 & 0xFF00) * Static102.anInt9671 & 0xFF0000) >> 8;
								}
								local3[local51] = local314;
							} else if (arg0 == 2) {
								local209 = this.anIntArray469[local48];
								if (local209 != 0) {
									local234 = (local209 & 0xFF00FF) * Static102.anInt9669 & 0xFF00FF00;
									local238 = (local209 & 0xFF00) * Static102.anInt9669 & 0xFF0000;
									local3[local51++] = ((local234 | local238) >>> 8) + Static102.anInt9665;
								}
							} else {
								throw new IllegalArgumentException();
							}
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt9679 << 12) < 0) {
						@Pc(845) int local845;
						if ((local845 = local16 - (super.anInt9660 << 12)) >= 0) {
							local852 = (Static102.anInt9663 - local845) / Static102.anInt9663;
							local18 += local852;
							local16 += Static102.anInt9663 * local852;
							local12 += local852;
						}
						@Pc(873) int local873;
						if ((local873 = (local16 - Static102.anInt9663) / Static102.anInt9663) > local18) {
							local18 = local873;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt9679 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if (local14 >= 0 && local14 - (super.anInt9679 << 12) < 0) {
						if (local16 < 0) {
							local852 = (Static102.anInt9663 - local16 - 1) / Static102.anInt9663;
							local18 += local852;
							local16 += Static102.anInt9663 * local852;
							local12 += local852;
						}
						@Pc(1722) int local1722;
						if ((local1722 = (local16 + 1 - (super.anInt9660 << 12) - Static102.anInt9663) / Static102.anInt9663) > local18) {
							local18 = local1722;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt9679 + (local14 >> 12);
			...
			if (Static102.anInt9663 == 0) {
				...
				while (local9 < 0) {
					...
					if (local16 >= 0 && local16 - (super.anInt9660 << 12) < 0) {
						...
						if ((local2545 = local14 - (super.anInt9679 << 12)) >= 0) {
							local852 = (Static102.anInt9661 - local2545) / Static102.anInt9661;
							local18 += local852;
							local14 += Static102.anInt9661 * local852;
							local12 += local852;
						}
						@Pc(2573) int local2573;
						if ((local2573 = (local14 - Static102.anInt9661) / Static102.anInt9661) > local18) {
							local18 = local2573;
						}
						while (local18 < 0) {
							local48 = (local16 >> 12) * super.anInt9679 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local3387 = local14 - (super.anInt9679 << 12)) >= 0) {
						local852 = (Static102.anInt9661 - local3387) / Static102.anInt9661;
						local18 += local852;
						local14 += Static102.anInt9661 * local852;
						local16 += Static102.anInt9663 * local852;
						local12 += local852;
					...
					if ((local3421 = (local14 - Static102.anInt9661) / Static102.anInt9661) > local18) {
						local18 = local3421;
					}
					@Pc(3433) int local3433;
					if ((local3433 = local16 - (super.anInt9660 << 12)) >= 0) {
						local852 = (Static102.anInt9663 - local3433) / Static102.anInt9663;
						local18 += local852;
						local14 += Static102.anInt9661 * local852;
						local16 += Static102.anInt9663 * local852;
						local12 += local852;
					...
					if ((local3467 = (local16 - Static102.anInt9663) / Static102.anInt9663) > local18) {
						local18 = local3467;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt9679 + (local14 >> 12);
				...
				while (local9 < 0) {
					...
					if ((local4287 = local14 - (super.anInt9679 << 12)) >= 0) {
						local852 = (Static102.anInt9661 - local4287) / Static102.anInt9661;
						local18 += local852;
						local14 += Static102.anInt9661 * local852;
						local16 += Static102.anInt9663 * local852;
						local12 += local852;
					...
					if ((local4321 = (local14 - Static102.anInt9661) / Static102.anInt9661) > local18) {
						local18 = local4321;
					}
					if (local16 < 0) {
						local852 = (Static102.anInt9663 - local16 - 1) / Static102.anInt9663;
					...
					if ((local4369 = (local16 + 1 - (super.anInt9660 << 12) - Static102.anInt9663) / Static102.anInt9663) > local18) {
						local18 = local4369;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt9679 + (local14 >> 12);
			...
			while (local9 < 0) {
				...
				if (local16 >= 0 && local16 - (super.anInt9660 << 12) < 0) {
					if (local14 < 0) {
						local852 = (Static102.anInt9661 - local14 - 1) / Static102.anInt9661;
						local18 += local852;
						local14 += Static102.anInt9661 * local852;
						local12 += local852;
					}
					@Pc(5228) int local5228;
					if ((local5228 = (local14 + 1 - (super.anInt9679 << 12) - Static102.anInt9661) / Static102.anInt9661) > local18) {
						local18 = local5228;
					}
					while (local18 < 0) {
						local48 = (local16 >> 12) * super.anInt9679 + (local14 >> 12);
			...
			for (local9 = Static102.anInt9680; local9 < 0; local9++) {
				...
				if ((local6082 = (local14 + 1 - (super.anInt9679 << 12) - Static102.anInt9661) / Static102.anInt9661) > local18) {
					local18 = local6082;
				}
				@Pc(6094) int local6094;
				if ((local6094 = local16 - (super.anInt9660 << 12)) >= 0) {
					local852 = (Static102.anInt9663 - local6094) / Static102.anInt9663;
					local18 += local852;
					local14 += Static102.anInt9661 * local852;
					local16 += Static102.anInt9663 * local852;
					local12 += local852;
				...
				if ((local6128 = (local16 - Static102.anInt9663) / Static102.anInt9663) > local18) {
					local18 = local6128;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt9679 + (local14 >> 12);
			...
			for (local9 = Static102.anInt9680; local9 < 0; local9++) {
				...
				if ((local6984 = (local14 + 1 - (super.anInt9679 << 12) - Static102.anInt9661) / Static102.anInt9661) > local18) {
					local18 = local6984;
				}
				if (local16 < 0) {
					local852 = (Static102.anInt9663 - local16 - 1) / Static102.anInt9663;
				...
				if ((local7032 = (local16 + 1 - (super.anInt9660 << 12) - Static102.anInt9663) / Static102.anInt9663) > local18) {
					local18 = local7032;
				}
				while (local18 < 0) {
					local48 = (local16 >> 12) * super.anInt9679 + (local14 >> 12);
	...
	public void GA(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		for (@Pc(5) int local5 = 0; local5 < arg3; local5++) {
			@Pc(15) int local15 = (arg1 + local5) * super.anInt9679 + arg0;
			@Pc(25) int local25 = (arg5 + local5) * super.aClass9_Sub1_17.anInt1832 + arg4;
			for (@Pc(27) int local27 = 0; local27 < arg2; local27++) {
				this.anIntArray469[local15 + local27] = local3[local25 + local27];
			}
		}
	}
