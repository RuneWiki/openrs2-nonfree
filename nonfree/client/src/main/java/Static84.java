...
public final class Static84 {
	...
	public static MouseWheelProvider aClass31_1;

	@OriginalMember(owner = "client!oe", name = "i", descriptor = "I")
	public static int anInt2252 = 0;

	@OriginalMember(owner = "client!oe", name = "l", descriptor = "Lclient!ec;")
	public static JagString aClass22_638 = Static60.method1113("<col=00ff80>");
	...
	public static void method1493(@OriginalArg(0) JagString arg0, @OriginalArg(1) Js5Index arg1, @OriginalArg(4) JagString arg2) {
	...
	public static void method1494() {
		...
		Static96.method1612();
		Static7.method132();
		((SceneBuilderProvider) Static6.anInterface2_1).method1850();
	...
	public static void method1497() {
		for (@Pc(13) SpotAnimEntity local13 = (SpotAnimEntity) Static132.aClass82_14.method2025(); local13 != null; local13 = (SpotAnimEntity) Static132.aClass82_14.method2023()) {
			if (local13.anInt2815 != Static37.anInt895 || local13.aBoolean251) {
				local13.method1999();
			} else if (local13.anInt2817 <= Client.anInt2877) {
