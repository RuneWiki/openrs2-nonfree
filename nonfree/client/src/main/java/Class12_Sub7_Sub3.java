...
public final class Class12_Sub7_Sub3 extends Class12_Sub7 {

	@OriginalMember(owner = "client!nf", name = "<init>", descriptor = "(IIIIIF)V")
	public Class12_Sub7_Sub3(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5) {
