...
public final class Static227 {
	...
	@OriginalMember(owner = "client!oc", name = "a", descriptor = "(IB)Lclient!jq;", line = 7)
	public static Class2_Sub3 method4249(@OriginalArg(0) int arg0) {
		if (arg0 == 0) {
	...
	public static boolean method4252(@OriginalArg(1) int arg0) {
