...
public final class Class14_Sub24 extends Class14 {
	...
	@OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Lclient!dh;)V")
	public Class14_Sub24(@OriginalArg(0) Class2_Sub13 arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(ILclient!dh;)V")
	public Class14_Sub24(@OriginalArg(0) int arg0, @OriginalArg(1) Class2_Sub13 arg1) {
		super(arg0, arg1);
	}
	...
	public void method9035() {
		if (super.anInt10835 < 0 && super.anInt10835 > 4) {
	...
	protected int method9029() {
		return super.aClass2_Sub13_31.method2606().method7490() > 1 ? 4 : 2;
	}
}
