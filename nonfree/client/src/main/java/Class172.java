...
public final class Class172 implements Interface1 {

	@OriginalMember(owner = "client!vi", name = "a", descriptor = "[I")
	private int[] anIntArray662 = null;

	@OriginalMember(owner = "client!vi", name = "b", descriptor = "I")
	private int anInt5631 = -1;
	...
	public Class172() {
		if (Static240.aBoolean380 && Static240.anInt4958 >= 2) {
			this.method4331();
			@Pc(19) GL local19 = Static240.aGL1;
			local19.glBindTexture(34067, this.anIntArray662[0]);
			...
			local19.glBindTexture(34067, this.anIntArray662[1]);
			local19.glTexParameteri(34067, 10241, 9729);
			local19.glTexParameteri(34067, 10240, 9729);
			local19.glTexParameteri(34067, 32882, 33071);
			local19.glTexParameteri(34067, 10242, 33071);
			local19.glTexParameteri(34067, 10243, 33071);
			local19.glBindTexture(34067, this.anIntArray662[2]);
			local19.glTexParameteri(34067, 10241, 9729);
			local19.glTexParameteri(34067, 10240, 9729);
			local19.glTexParameteri(34067, 32882, 33071);
			local19.glTexParameteri(34067, 10242, 33071);
			local19.glTexParameteri(34067, 10243, 33071);
			this.aBoolean428 = Static240.anInt4958 < 3;
		}
		this.method4332();
	}
	...
	public void method4329(@OriginalArg(0) int arg0) {
		...
		if (Static294.aBoolean445 && this.anIntArray662 != null) {
			local1.glActiveTexture(33985);
			local1.glBindTexture(34067, this.anIntArray662[arg0 - 1]);
	...
	private void method4331() {
		@Pc(1) GL local1 = Static240.aGL1;
		if (this.anIntArray662 == null) {
			this.anIntArray662 = new int[3];
			local1.glGenTextures(3, this.anIntArray662, 0);
		}
	...
	private void method4332() {
		@Pc(1) GL local1 = Static240.aGL1;
		this.anInt5631 = local1.glGenLists(2);
		local1.glNewList(this.anInt5631, 4864);
		if (this.anIntArray662 == null) {
			...
			if (this.aBoolean428) {
				...
				local1.glTexEnvi(8960, 34162, 7681);
				local1.glTexEnvi(8960, 34184, 34167);
				local1.glBindTexture(3553, Static240.anInt4943);
				local1.glEnable(3553);
			}
			local1.glActiveTexture(33984);
		}
		local1.glEndList();
		local1.glNewList(this.anInt5631 + 1, 4864);
		if (this.anIntArray662 == null) {
	...
	public void method4327() {
		...
		if (Static294.aBoolean445) {
			local1.glCallList(this.anInt5631);
		} else {
			local1.glTexEnvi(8960, 34184, 34167);
		}
	}
	...
	public void method4328() {
		@Pc(1) GL local1 = Static240.aGL1;
		if (Static294.aBoolean445) {
			local1.glCallList(this.anInt5631 + 1);
		} else {
			local1.glTexEnvi(8960, 34184, 5890);
		}
	}
