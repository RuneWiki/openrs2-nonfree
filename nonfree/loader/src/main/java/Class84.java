...
public class Class84 {
	...
	public Class84(@OriginalArg(0) byte[] arg0) throws IOException {
		...
		while (true) {
			...
			while (true) {
				...
				if (local54 == -1) {
					@Pc(69) byte[] local69 = local48.toByteArray();
					this.aHashtable2.put(local26, local69);
					break;
				}
	...
	public final byte[] method2048(@OriginalArg(0) String arg0) {
