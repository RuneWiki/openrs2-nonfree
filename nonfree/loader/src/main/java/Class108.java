...
public class Class108 {
	...
	public Class108(@OriginalArg(0) byte[] arg0) throws IOException {
		...
		while (true) {
			...
			while (true) {
				...
				if (local55 == -1) {
					@Pc(70) byte[] local70 = local49.toByteArray();
					this.aHashtable2.put(local27, local70);
					break;
				}
	...
	public final byte[] method3288(@OriginalArg(1) String arg0) {
