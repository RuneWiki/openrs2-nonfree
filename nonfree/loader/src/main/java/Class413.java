...
public final class Class413 {
	...
	public static void method9609(@OriginalArg(0) String arg0, @OriginalArg(2) int arg1) {
		aString145 = arg0;
		anInt11276 = arg1;
		try {
	...
	public static File method9610(@OriginalArg(0) String arg0) {
		return method9611(aString145, arg0, anInt11276);
	}

	@OriginalMember(owner = "loader!gd", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;IZ)Ljava/io/File;")
	private static File method9611(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		if (!aBoolean775) {
