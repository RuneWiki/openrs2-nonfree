	...
	static final String method36967(@OriginalArg(0) CharSequence arg0, @OriginalArg(1) byte arg1) {
		...
		while (local21 < local8) {
			label80: {
				...
				if (local28 >= 'a' && local28 <= 'z' || local28 >= 65 && local28 <= 90 || local28 >= '0' && local28 <= 57 || local28 == 46 || local28 == 45 || local28 == 42 || local28 == 95) {
				...
				@Pc(125) int var7;
				label41: {
					var6 = RuntimeException_Sub5.method36950(local28);
					local13.append('%');
					var7 = var6 >> 4 & 0xF;
					if (var7 >= 10) {
