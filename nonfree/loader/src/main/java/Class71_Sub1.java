...
public final class Class71_Sub1 extends Class71 {
	...
	private static byte[] method1984(@OriginalArg(0) byte[] arg0) throws IOException {
	...
	public Class71_Sub1(@OriginalArg(0) byte[] arg0) throws IOException {
		super(method1984(arg0));
	}
}
