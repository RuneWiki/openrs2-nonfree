...
public final class loader extends Applet implements Runnable {
	...
	private static int anInt11279 = 0;
	...
	private boolean aBoolean778 = false;

	@OriginalMember(owner = "loader!loader", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/awt/Image;")
	private Image method9617(@OriginalArg(0) String arg0) throws IOException {
		try {
	...
	public synchronized void destroy() {
		this.aBoolean781 = this.aBoolean780 = false;
	...
	private boolean method9618(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) String arg2) {
		if (this.canvas == null) {
			this.canvas = new Canvas();
			this.setLayout((LayoutManager) null);
			this.add(this.canvas);
			this.canvas.setSize(this.anInt11278, this.anInt11280);
		...
		try {
			if (this.anImage14 == null) {
				this.anImage14 = this.createImage(this.anInt11278, this.anInt11280);
			}
			...
			local57.drawImage(this.bodyLeft, this.method9626(local62) + this.lb.boxXOffset - this.lb.boxWidth / 2, this.method9624(local77) - -this.lb.boxYOffset, (ImageObserver) null);
			...
			for (local143 = local131; local143 <= local141; local143 += local72) {
				local57.drawImage(this.bodyFill, local143 + this.method9626(local62) + this.lb.boxXOffset, this.method9624(local87) + this.lb.boxYOffset, (ImageObserver) null);
			}
			local57.drawImage(this.bodyRight, this.method9626(local67) + this.lb.boxXOffset + this.lb.boxWidth / 2, this.method9624(local82) + this.lb.boxYOffset, (ImageObserver) null);
			...
			@Pc(270) int local270 = this.method9626(this.lb.width) + this.lb.xOffset;
			@Pc(281) int local281 = this.method9624(this.lb.height) + this.lb.yOffset;
	...
	private byte[] method9619(@OriginalArg(0) Class412 arg0, @OriginalArg(1) boolean arg1) {
		@Pc(5) byte[] local5 = new byte[arg0.anInt11275];
		@Pc(7) int local7 = 0;
		...
		try {
			...
			if (arg1) {
				...
				local37.write(17);
				local37.write(("JAGGRAB " + local23.getFile() + arg0.aString143 + "\n\n").getBytes());
				local60 = local31.getInputStream();
			} else {
				local60 = (new URL(this.getCodeBase(), arg0.aString143)).openStream();
			}
			@Pc(73) int local73 = -1;
			@Pc(75) int local75 = 0;
			@Pc(77) int local77 = 0;
			while (true) {
				if (local5.length > local75) {
					...
					if (local98 >= 0) {
						...
						if (local73 != local119 || local121 != local77) {
							try {
								if (this.method9627(local121, local119, arg0.aStringArray45[this.anInt11281])) {
									local73 = local119;
									local77 = local121;
								}
				...
				local60.close();
				if (arg0.anInt11275 != arg0.anInt11274) {
					@Pc(190) byte[] local190 = new byte[arg0.anInt11274];
		...
		return this.method9621(local5, arg0) ? local5 : null;
	}
	...
	private boolean method9620(@OriginalArg(1) int arg0, @OriginalArg(2) String arg1) {
		if (this.bf == null) {
			this.bf = new Font("Helvetica", 1, 13);
			this.bfm = this.getFontMetrics(this.bf);
			this.aColor3 = new Color(Class411.anIntArray802[anInt11279]);
			this.aColor2 = new Color(Class411.anIntArray803[anInt11279]);
			this.colourtext = new Color(Class411.anIntArray801[anInt11279]);
		}
		...
		try {
			...
			local78.fillRect(0, 0, this.anInt11278, this.anInt11280);
			local78.setColor(this.aColor3);
			local100 = this.anInt11278 / 2 - 152;
			local107 = this.anInt11280 / 2 - 18;
			...
			local78.drawString(local174, (this.anInt11278 - this.bfm.stringWidth(local174)) / 2, this.anInt11280 / 2 + 4);
			local55.drawImage(this.anImage14, 0, 0, (ImageObserver) null);
		} catch (@Pc(211) Exception local211) {
			local55.setColor(Color.black);
			local55.fillRect(0, 0, this.anInt11278, this.anInt11280);
			...
			local55.drawString(local174, (this.anInt11278 - this.bfm.stringWidth(local174)) / 2, this.anInt11280 / 2 + 4);
		}
		return true;
	}
	...
	private boolean method9621(@OriginalArg(1) byte[] arg0, @OriginalArg(2) Class412 arg1) {
		try {
			if (arg0 == null) {
				return false;
			}
			...
			for (@Pc(19) int local19 = 0; local19 < 20; local19++) {
				if (local17[local19] != arg1.anIntArray804[local19]) {
					return false;
				}
			}
			return true;
	...
	private byte[] method9622(@OriginalArg(1) Class412 arg0) {
		@Pc(12) File local12;
		try {
			local12 = Class413.method9610(arg0.aString144);
		} catch (@Pc(14) Exception local14) {
			this.method9628("nocache");
			return null;
		}
		@Pc(25) byte[] local25 = this.method9623(local12);
		if (!this.method9621(local25, arg0)) {
			local25 = this.method9619(arg0, false);
			if (local25 == null) {
				local25 = this.method9619(arg0, true);
			}
			if (local25 == null) {
				this.method9628("download");
				return null;
			}
			if (!this.method9629(local12, local25)) {
				return null;
			}
			local25 = this.method9623(local12);
			if (!this.method9621(local25, arg0)) {
				this.method9628("mismatch");
				return null;
			}
		}
		return local25;
	...
	public void run() {
		try {
			...
			if (local40 != null) {
				...
				if (local36 < 0 || local36 >= Class411.aStringArray44.length) {
					local36 = 0;
				}
			}
			@Pc(64) String local64 = this.getParameter("colourid");
			if (local64 != null) {
				anInt11279 = Integer.parseInt(local64);
				if (anInt11279 < 0 || anInt11279 >= Class411.anIntArray802.length) {
					anInt11279 = 0;
				}
			}
			this.lb = Class411.aClass410Array1[anInt11279];
			this.anInt11278 = this.getSize().width;
			this.anInt11280 = this.getSize().height;
			...
			try {
				...
				if (local111 != null) {
					this.anInt11281 = Integer.parseInt(local111);
				}
			} catch (@Pc(120) Exception local120) {
			}
			Class413.method9609(Class411.aStringArray44[local36], local96);
			if (this.lb != null) {
				try {
					this.bf = new Font(this.lb.aString134, 0, this.lb.anInt11273);
					this.bfm = this.getFontMetrics(this.bf);
					this.colourtext = new Color(this.lb.anInt11272);
					this.bar = this.method9617(this.lb.aString135);
					this.background = this.method9617(this.lb.aString141);
					this.left = this.method9617(this.lb.aString133);
					this.right = this.method9617(this.lb.aString142);
					this.top = this.method9617(this.lb.aString139);
					this.bottom = this.method9617(this.lb.aString140);
					this.bodyLeft = this.method9617(this.lb.aString138);
					this.bodyRight = this.method9617(this.lb.aString136);
					this.bodyFill = this.method9617(this.lb.aString137);
			...
			try {
				...
				local321 = this.method9622(Class411.aClass412_2);
				if (local321 == null) {
					return;
				}
			...
			if (local313 == null) {
				local321 = this.method9622(Class411.aClass412_1);
				if (local321 == null) {
					return;
				}
				...
				local352.method9608(local355.getName(), local355);
				@Pc(365) Class local365 = local352.loadClass("unpackclass");
				@Pc(370) byte[] local370 = this.method9622(Class411.aClass412_3);
				if (local370 == null) {
					return;
				}
			...
			local405.method9608(local408.getName(), local408);
			...
			RuntimeException_Sub2.anInt11277 = 667240655;
			if (local487 instanceof InvocationTargetException) {
				...
				RuntimeException_Sub2.method9613(local487.toString(), local503, this);
			} else {
				RuntimeException_Sub2.method9613((String) null, local487, this);
			}
			this.method9628("crash");
		}
	}
	...
	private byte[] method9623(@OriginalArg(1) File arg0) {
		try {
			if (!arg0.exists()) {
				return null;
			}
	...
	private int method9624(@OriginalArg(0) int arg0) {
		return this.lb.yMiddle ? (this.anInt11280 - arg0) / 2 : 0;
	}
	...
	private int method9626(@OriginalArg(0) int arg0) {
		return this.lb.xMiddle ? (this.anInt11278 - arg0) / 2 : 0;
	}

	@OriginalMember(owner = "loader!loader", name = "a", descriptor = "(IILjava/lang/String;B)Z")
	private boolean method9627(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2) {
		return Class411.aClass410Array1[anInt11279] == null || this.aBoolean777 ? this.method9620(arg1, arg2) : this.method9618(arg1, arg0, arg2);
	}

	@OriginalMember(owner = "loader!loader", name = "b", descriptor = "(Ljava/lang/String;I)V")
	private void method9628(@OriginalArg(0) String arg0) {
		if (this.aBoolean779) {
			return;
		}
		this.aBoolean779 = true;
	...
	private boolean method9629(@OriginalArg(0) File arg0, @OriginalArg(1) byte[] arg1) {
		try {
