...
public final class Class108_Sub1 extends Class108 {
	...
	@OriginalMember(owner = "loader!c", name = "a", descriptor = "(I[B)[B")
	private static byte[] method3289(@OriginalArg(1) byte[] arg0) throws IOException {
	...
	public Class108_Sub1(@OriginalArg(0) byte[] arg0) throws IOException {
		super(method3289(arg0));
	}
}
