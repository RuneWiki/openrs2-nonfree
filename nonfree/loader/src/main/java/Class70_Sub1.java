...
public final class Class70_Sub1 extends Class70 {
	...
	@OriginalMember(owner = "loader!c", name = "a", descriptor = "(B[B)[B")
	private static byte[] method1954(@OriginalArg(1) byte[] arg0) throws IOException {
	...
	public Class70_Sub1(@OriginalArg(0) byte[] arg0) throws IOException {
		super(method1954(arg0));
	}
}
