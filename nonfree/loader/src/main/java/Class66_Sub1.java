...
public final class Class66_Sub1 extends Class66 {
	...
	@OriginalMember(owner = "loader!b", name = "a", descriptor = "(B[B)[B")
	private static byte[] method1857(@OriginalArg(1) byte[] arg0) throws IOException {
	...
	public Class66_Sub1(@OriginalArg(0) byte[] arg0) throws IOException {
		super(method1857(arg0));
	}
}
