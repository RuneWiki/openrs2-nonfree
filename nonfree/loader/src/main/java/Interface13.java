...
public interface Interface13 {
	...
	@OriginalMember(owner = "loader!b", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;Z)V")
	void method6088(@OriginalArg(0) Class arg0, @OriginalArg(1) String arg1);
