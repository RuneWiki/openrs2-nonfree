...
public final class Class210 {
	...
	public void method4672() {
		...
		this.method4675(null);
	}

	@OriginalMember(owner = "loader!g", name = "a", descriptor = "(IIILjava/awt/Frame;BI)V")
	public void method4673(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Frame arg3, @OriginalArg(5) int arg4) {
		...
		if (arg4 == 0) {
			...
			for (@Pc(36) int local36 = 0; local36 < local32.length; local36++) {
				if (local32[local36].getWidth() == arg2 && arg1 == local32[local36].getHeight() && local32[local36].getBitDepth() == arg0) {
		...
		this.aGraphicsDevice1.setDisplayMode(new DisplayMode(arg2, arg1, arg0, arg4));
	}
	...
	private void method4675(@OriginalArg(0) Frame arg0) {
