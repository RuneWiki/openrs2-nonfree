...
public final class Class255 {
	...
	@OriginalMember(owner = "loader!c", name = "<init>", descriptor = "()V", line = 167)
	...
	@OriginalMember(owner = "loader!c", name = "a", descriptor = "(Ljava/awt/Frame;I)V", line = 9)
	private void method6495(@OriginalArg(0) Frame arg0) {
	...
	@OriginalMember(owner = "loader!c", name = "a", descriptor = "(I)V", line = 53)
	public void method6496() {
		...
		this.method6495(null);
	}

	@OriginalMember(owner = "loader!c", name = "b", descriptor = "(I)[I", line = 77)
	...
	@OriginalMember(owner = "loader!c", name = "a", descriptor = "(Ljava/awt/Frame;IIIII)V", line = 102)
	public void method6498(@OriginalArg(0) Frame arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(5) int arg4) {
