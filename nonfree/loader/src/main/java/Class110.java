...
public class Class110 {
	...
	public Class110(@OriginalArg(0) byte[] arg0) throws IOException {
		...
		while (true) {
			...
			while (true) {
				...
				if (local52 == -1) {
					@Pc(64) byte[] local64 = local46.toByteArray();
					this.aHashtable3.put(local25, local64);
					break;
				}
	...
	public final byte[] method3227(@OriginalArg(0) String arg0) {
