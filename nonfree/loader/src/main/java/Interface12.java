...
public interface Interface12 {
	...
	@OriginalMember(owner = "loader!a", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;Z)V")
	void method6158(@OriginalArg(0) String arg0, @OriginalArg(1) Class arg1);
}
