...
public interface Interface10 {
	...
	@OriginalMember(owner = "loader!d", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;B)V")
	void method5734(@OriginalArg(0) Class arg0, @OriginalArg(1) String arg1);
}
