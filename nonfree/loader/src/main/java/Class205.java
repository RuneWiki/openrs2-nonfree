...
public final class Class205 {
	...
	private void method4865(@OriginalArg(1) Frame arg0) {
	...
	public void method4868(@OriginalArg(1) Frame arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		...
		if (arg2 == 0) {
			...
			for (@Pc(44) int local44 = 0; local44 < local42.length; local44++) {
				if (arg3 == local42[local44].getWidth() && arg1 == local42[local44].getHeight() && local42[local44].getBitDepth() == arg4) {
					@Pc(72) int local72 = local42[local44].getRefreshRate();
					if (!local38 || Math.abs(local72 - local36) < Math.abs(arg2 - local36)) {
						arg2 = local72;
						local38 = true;
					}
				}
		...
		this.aGraphicsDevice1.setDisplayMode(new DisplayMode(arg3, arg1, arg4, arg2));
	}
}
