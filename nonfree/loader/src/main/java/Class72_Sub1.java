...
public final class Class72_Sub1 extends Class72 {
	...
	@OriginalMember(owner = "loader!d", name = "a", descriptor = "([BB)[B")
	private static byte[] method2105(@OriginalArg(0) byte[] arg0) throws IOException {
	...
	public Class72_Sub1(@OriginalArg(0) byte[] arg0) throws IOException {
		super(method2105(arg0));
	}
}
