...
public final class Class274 {
	...
	@OriginalMember(owner = "loader!f", name = "a", descriptor = "(ZLjava/awt/Component;I)V")
	public void method6086(@OriginalArg(0) boolean arg0, @OriginalArg(1) Component arg1) {
		if (arg0) {
			arg1 = null;
		} else if (arg1 == null) {
	...
	public void method6087(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aRobot1.mouseMove(arg1, arg0);
	}

	@OriginalMember(owner = "loader!f", name = "a", descriptor = "(I[ILjava/awt/Component;ILjava/awt/Point;I)V")
	public void method6088(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) Component arg2, @OriginalArg(3) int arg3, @OriginalArg(4) Point arg4) {
		if (arg1 == null) {
			arg2.setCursor(null);
		} else {
			@Pc(13) BufferedImage local13 = new BufferedImage(arg3, arg0, 2);
			local13.setRGB(0, 0, arg3, arg0, arg1, 0, arg3);
			arg2.setCursor(arg2.getToolkit().createCustomCursor(local13, arg4, null));
		}
	}
}
