...
public final class unpack_Sub1 extends unpack {
	...
	@OriginalMember(owner = "loader!d", name = "a", descriptor = "(B[B)[B", line = 10)
	private static byte[] method6501(@OriginalArg(1) byte[] arg0) throws IOException {
	...
	@OriginalMember(owner = "loader!d", name = "<init>", descriptor = "([B)V", line = 5)
	public unpack_Sub1(@OriginalArg(0) byte[] arg0) throws IOException {
		super(method6501(arg0));
	}
}
