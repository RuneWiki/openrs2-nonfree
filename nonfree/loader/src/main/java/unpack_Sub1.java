...
public final class unpack_Sub1 extends unpack {
	...
	@OriginalMember(owner = "loader!f", name = "a", descriptor = "(I[B)[B")
	private static byte[] method4781(@OriginalArg(1) byte[] arg0) throws IOException {
	...
	@OriginalMember(owner = "loader!f", name = "<init>", descriptor = "([B)V")
	public unpack_Sub1(@OriginalArg(0) byte[] arg0) throws IOException {
		super(method4781(arg0));
	}
}
