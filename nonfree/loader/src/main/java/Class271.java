...
public final class Class271 {
	...
	public void method6103() {
		...
		this.method6105(null);
	}

	@OriginalMember(owner = "loader!c", name = "a", descriptor = "(IIIILjava/awt/Frame;I)V")
	public void method6104(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) Frame arg3, @OriginalArg(5) int arg4) {
		...
		if (arg1 == 0) {
			...
			for (@Pc(46) int local46 = 0; local46 < local42.length; local46++) {
				if (local42[local46].getWidth() == arg0 && local42[local46].getHeight() == arg4 && arg2 == local42[local46].getBitDepth()) {
					@Pc(77) int local77 = local42[local46].getRefreshRate();
					if (!local44 || Math.abs(local77 - local38) < Math.abs(arg1 - local38)) {
						arg1 = local77;
						local44 = true;
					}
				}
	...
	@OriginalMember(owner = "loader!c", name = "a", descriptor = "(ZLjava/awt/Frame;)V")
	private void method6105(@OriginalArg(1) Frame arg0) {
		...
		try {
			...
			if (local1) {
				try {
					@Pc(57) Field local57 = Class.forName("sun.awt.Win32GraphicsDevice").getDeclaredField("valid");
					local57.set(this.aGraphicsDevice1, Boolean.TRUE);
