...
public final class Class271 {
	...
	public void method6052(@OriginalArg(0) boolean arg0, @OriginalArg(2) Component arg1) {
		if (arg0) {
			arg1 = null;
		} else if (arg1 == null) {
	...
	@OriginalMember(owner = "loader!e", name = "a", descriptor = "(Ljava/awt/Point;IILjava/awt/Component;Z[I)V")
	public void method6053(@OriginalArg(0) Point arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) Component arg3, @OriginalArg(5) int[] arg4) {
		if (arg4 == null) {
			arg3.setCursor(null);
		} else {
			@Pc(12) BufferedImage local12 = new BufferedImage(arg2, arg1, 2);
			local12.setRGB(0, 0, arg2, arg1, arg4, 0, arg2);
			arg3.setCursor(arg3.getToolkit().createCustomCursor(local12, arg0, null));
		}
	}
