...
public interface Interface25 {
	...
	@OriginalMember(owner = "loader!h", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;B)V")
	void method8192(@OriginalArg(0) String arg0, @OriginalArg(1) Class arg1);
