...
public interface Interface25 {
	...
	@OriginalMember(owner = "loader!a", name = "a", descriptor = "(Ljava/lang/Class;ZLjava/lang/String;)V")
	void method7881(@OriginalArg(0) Class arg0, @OriginalArg(2) String arg1);
}
