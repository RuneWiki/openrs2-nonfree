...
public final class Class207 {
	...
	@OriginalMember(owner = "loader!d", name = "a", descriptor = "(I[IIILjava/awt/Point;Ljava/awt/Component;)V")
	public void method5254(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(4) Point arg3, @OriginalArg(5) Component arg4) {
		if (arg1 == null) {
			arg4.setCursor(null);
		} else {
			@Pc(13) BufferedImage local13 = new BufferedImage(arg2, arg0, 2);
			local13.setRGB(0, 0, arg2, arg0, arg1, 0, arg2);
			arg4.setCursor(arg4.getToolkit().createCustomCursor(local13, arg3, null));
		}
	}

	@OriginalMember(owner = "loader!d", name = "a", descriptor = "(III)V")
	public void method5255(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		this.aRobot1.mouseMove(arg0, arg1);
	}

	@OriginalMember(owner = "loader!d", name = "a", descriptor = "(ZZLjava/awt/Component;)V")
	public void method5256(@OriginalArg(0) boolean arg0, @OriginalArg(2) Component arg1) {
		if (arg0) {
			arg1 = null;
		} else if (arg1 == null) {
