...
public class unpack {
	...
	@OriginalMember(owner = "loader!unpack", name = "<init>", descriptor = "()V", line = 16)
	public unpack() {
	}

	@OriginalMember(owner = "loader!unpack", name = "<init>", descriptor = "([B)V", line = 18)
	...
	@OriginalMember(owner = "loader!unpack", name = "a", descriptor = "(Ljava/lang/String;I)[B", line = 8)
	public final byte[] method6500(@OriginalArg(0) String arg0) {
