...
public final class Class254 {
	...
	public void method6153(@OriginalArg(0) Frame arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4) {
		...
		if (arg4 == 0) {
			...
			for (@Pc(39) int local39 = 0; local39 < local35.length; local39++) {
				if (arg3 == local35[local39].getWidth() && arg2 == local35[local39].getHeight() && arg1 == local35[local39].getBitDepth()) {
					@Pc(71) int local71 = local35[local39].getRefreshRate();
					if (!local37 || Math.abs(local71 - local31) < Math.abs(arg4 - local31)) {
						arg4 = local71;
						local37 = true;
					}
				}
		...
		this.aGraphicsDevice1.setDisplayMode(new DisplayMode(arg3, arg2, arg1, arg4));
	}
	...
	public void method6154() {
		...
		this.method6155(null);
	}

	@OriginalMember(owner = "loader!f", name = "a", descriptor = "(Ljava/awt/Frame;I)V")
	private void method6155(@OriginalArg(0) Frame arg0) {
