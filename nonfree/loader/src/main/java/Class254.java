...
public final class Class254 {
	...
	@OriginalMember(owner = "loader!b", name = "<init>", descriptor = "()V", line = 67)
	public Class254() throws Exception {
	}

	@OriginalMember(owner = "loader!b", name = "a", descriptor = "(IIB)V", line = 6)
	public void method6492(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		this.aRobot1.mouseMove(arg0, arg1);
	}

	@OriginalMember(owner = "loader!b", name = "a", descriptor = "([IIIILjava/awt/Point;Ljava/awt/Component;)V", line = 17)
	public void method6493(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) Point arg3, @OriginalArg(5) Component arg4) {
		if (arg0 == null) {
			arg4.setCursor(null);
		} else {
	...
	@OriginalMember(owner = "loader!b", name = "a", descriptor = "(BZLjava/awt/Component;)V", line = 35)
	public void method6494(@OriginalArg(1) boolean arg0, @OriginalArg(2) Component arg1) {
		if (arg0) {
			arg1 = null;
		} else if (arg1 == null) {
