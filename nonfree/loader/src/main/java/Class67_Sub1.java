...
public final class Class67_Sub1 extends Class67 {
	...
	@OriginalMember(owner = "loader!c", name = "a", descriptor = "([BB)[B")
	private static byte[] method1853(@OriginalArg(0) byte[] arg0) throws IOException {
	...
	public Class67_Sub1(@OriginalArg(0) byte[] arg0) throws IOException {
		super(method1853(arg0));
	}
}
