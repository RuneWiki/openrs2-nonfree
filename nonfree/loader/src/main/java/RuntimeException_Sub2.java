...
public final class RuntimeException_Sub2 extends RuntimeException {
	...
	private static String method9612(@OriginalArg(0) Throwable arg0) throws IOException {
		@Pc(6) String local6;
		if (arg0 instanceof RuntimeException_Sub2) {
			@Pc(17) RuntimeException_Sub2 local17 = (RuntimeException_Sub2) arg0;
			arg0 = local17.aThrowable2;
			local6 = local17.aString147 + " | ";
		} else {
			local6 = "";
		}
	...
	public static void method9613(@OriginalArg(0) String arg0, @OriginalArg(1) Throwable arg1, @OriginalArg(3) Applet arg2) {
		try {
			@Pc(1) String local1 = "";
			if (arg1 != null) {
				local1 = method9612(arg1);
			}
			if (arg0 != null) {
				if (arg1 != null) {
					local1 = local1 + " | ";
			...
			method9615(local1);
			local1 = method9614("%3a", local1, ":");
			local1 = method9614("%40", local1, "@");
			local1 = method9614("%26", local1, "&");
			local1 = method9614("%23", local1, "#");
			@Pc(86) URL local86 = new URL(arg2.getCodeBase(), "loadererror.ws?c=" + anInt11277 + "&v1=" + System.getProperty("java.vendor") + "&v2=" + System.getProperty("java.version") + "&e=" + local1);
	...
	private static String method9614(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2) {
	...
	private static void method9615(@OriginalArg(0) String arg0) {
		System.out.println("Error: " + method9614("\n", arg0, "%0a"));
	}

	@OriginalMember(owner = "loader!h", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lloader!h;")
	private static RuntimeException_Sub2 method9616(@OriginalArg(0) Throwable arg0, @OriginalArg(1) String arg1) {
		@Pc(5) RuntimeException_Sub2 local5;
		if (arg0 instanceof RuntimeException_Sub2) {
			local5 = (RuntimeException_Sub2) arg0;
			local5.aString147 = local5.aString147 + ' ' + arg1;
		} else {
