...
public final class RuntimeException_Sub2 extends RuntimeException {
	...
	@OriginalMember(owner = "loader!b", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/applet/Applet;BLjava/lang/String;)V")
	public static void method2171(@OriginalArg(0) Throwable arg0, @OriginalArg(1) Applet arg1, @OriginalArg(3) String arg2) {
		try {
			@Pc(1) String local1 = "";
			if (arg0 != null) {
				local1 = method2172(arg0);
			}
			if (arg2 != null) {
				if (arg0 != null) {
					local1 = local1 + " | ";
			...
			local1 = local1.replace('&', '_');
			local1 = local1.replace('#', '_');
			@Pc(92) URL local92 = new URL(arg1.getCodeBase(), "loadererror.ws?c=" + anInt3160 + "&v1=" + Class81.aString8 + "&v2=" + Class81.aString6 + "&e=" + local1);
	...
	private static String method2172(@OriginalArg(0) Throwable arg0) throws IOException {
		@Pc(6) String local6;
		...
		while (true) {
			while (true) {
				...
				if (local63 >= 0 && local70 >= 0) {
					@Pc(85) String local85 = local55.substring(local63 + 1, local70);
					@Pc(89) int local89 = local85.indexOf(".java:");
					if (local89 >= 0) {
						local85 = local85.substring(0, local89) + local85.substring(local89 + 5);
