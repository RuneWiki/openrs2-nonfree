...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface28 {
	...
	@OriginalMember(owner = "loader!c", name = "a", descriptor = "(Ljava/lang/Class;BLjava/lang/String;)V")
	@Override
	public void method8802(@OriginalArg(0) Class arg0, @OriginalArg(2) String arg1) {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(15) byte[] local15 = this.anUnpack1.method8799(arg0);
		if (local15 == null) {
