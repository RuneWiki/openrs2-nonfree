...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface28 {
	...
	@OriginalMember(owner = "loader!e", name = "a", descriptor = "(Ljava/lang/Class;ZLjava/lang/String;)V")
	@Override
	public void method9833(@OriginalArg(0) Class arg0, @OriginalArg(2) String arg1) {
		this.aHashtable8.put(arg1, arg0);
	}
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(16) byte[] local16 = this.anUnpack1.method9830(arg0);
		if (local16 == null) {
