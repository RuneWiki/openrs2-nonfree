...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface25 {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(16) byte[] local16 = this.anUnpack1.method7875(arg0);
		if (local16 == null) {
	...
	@OriginalMember(owner = "loader!f", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/Class;)V")
	@Override
	public void method7873(@OriginalArg(0) String arg0, @OriginalArg(2) Class arg1) {
