...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface13 {
	...
	@OriginalMember(owner = "loader!g", name = "<init>", descriptor = "(Lloader!unpack;)V", line = 48)
	...
	@OriginalMember(owner = "loader!g", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/Class;)V", line = 9)
	@Override
	public void method6514(@OriginalArg(0) String arg0, @OriginalArg(2) Class arg1) {
		this.aHashtable1.put(arg0, arg1);
	}

	@OriginalMember(owner = "loader!g", name = "loadClass", descriptor = "(Ljava/lang/String;Z)Ljava/lang/Class;", line = 21)
	@Override
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(16) byte[] local16 = this.anUnpack1.method6500(arg0);
		if (local16 == null) {
