...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface13 {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(15) byte[] local15 = this.anUnpack1.method6111(arg0);
		if (local15 == null) {
	...
	@OriginalMember(owner = "loader!f", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;)V")
	@Override
	public void method6114(@OriginalArg(1) String arg0, @OriginalArg(2) Class arg1) {
