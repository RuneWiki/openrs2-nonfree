...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface28 {
	...
	private final Hashtable aHashtable21 = new Hashtable();
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		@Pc(5) Class local5 = (Class) this.aHashtable21.get(arg0);
		if (local5 != null) {
			return local5;
		}
		@Pc(16) byte[] local16 = this.anUnpack1.method9229(arg0);
		if (local16 == null) {
		...
		this.aHashtable21.put(arg0, local5);
		return local5;
	}

	@OriginalMember(owner = "loader!b", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/Class;)V")
	@Override
	public void method9235(@OriginalArg(0) String arg0, @OriginalArg(2) Class arg1) {
		this.aHashtable21.put(arg0, arg1);
	}
}
