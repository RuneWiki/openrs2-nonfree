...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface28 {
	...
	@OriginalMember(owner = "loader!a", name = "a", descriptor = "(Ljava/lang/String;BLjava/lang/Class;)V")
	@Override
	public void method8657(@OriginalArg(0) String arg0, @OriginalArg(2) Class arg1) {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(16) byte[] local16 = this.anUnpack1.method8659(arg0);
		if (local16 == null) {
