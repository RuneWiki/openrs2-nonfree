...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface28 {
	...
	private final Hashtable aHashtable14 = new Hashtable();
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		@Pc(5) Class local5 = (Class) this.aHashtable14.get(arg0);
		if (local5 != null) {
			return local5;
		}
		@Pc(15) byte[] local15 = this.anUnpack1.method9048(arg0);
		if (local15 == null) {
		...
		this.aHashtable14.put(arg0, local5);
		return local5;
	}

	@OriginalMember(owner = "loader!f", name = "a", descriptor = "(ILjava/lang/Class;Ljava/lang/String;)V")
	@Override
	public void method9046(@OriginalArg(1) Class arg0, @OriginalArg(2) String arg1) {
		this.aHashtable14.put(arg1, arg0);
	}
}
