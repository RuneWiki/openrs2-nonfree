...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface13 {
	...
	@OriginalMember(owner = "loader!h", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;Z)V")
	@Override
	public void method6224(@OriginalArg(0) String arg0, @OriginalArg(1) Class arg1) {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(16) byte[] local16 = this.anUnpack1.method6212(arg0);
		if (local16 == null) {
