...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface12 {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(17) byte[] local17 = this.anUnpack1.method5991(arg0);
		if (local17 == null) {
	...
	@OriginalMember(owner = "loader!h", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/String;)V")
	@Override
	public void method6006(@OriginalArg(0) Class arg0, @OriginalArg(2) String arg1) {
