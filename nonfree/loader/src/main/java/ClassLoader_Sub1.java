...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface21 {
	...
	private final Hashtable aHashtable11 = new Hashtable();
	...
	@OriginalMember(owner = "loader!b", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/Class;)V")
	@Override
	public void method7996(@OriginalArg(1) String arg0, @OriginalArg(2) Class arg1) {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(15) byte[] local15 = this.anUnpack1.method8002(arg0);
		if (local15 == null) {
		...
		this.aHashtable11.put(arg0, local5);
		return local5;
	}
}
