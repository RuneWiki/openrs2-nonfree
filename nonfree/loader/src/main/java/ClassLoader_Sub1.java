...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface11 {
	...
	@OriginalMember(owner = "loader!a", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I)V")
	@Override
	public void method6087(@OriginalArg(0) Class arg0, @OriginalArg(1) String arg1) {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(15) byte[] local15 = this.anUnpack1.method6101(arg0);
		if (local15 == null) {
