...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface28 {
	...
	@OriginalMember(owner = "loader!a", name = "c", descriptor = "Lloader!unpack;")
	private final unpack anUnpack1;

	@OriginalMember(owner = "loader!a", name = "b", descriptor = "Ljava/security/ProtectionDomain;")
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(15) byte[] local15 = this.anUnpack1.method9392(arg0);
		if (local15 == null) {
	...
	@OriginalMember(owner = "loader!a", name = "a", descriptor = "(BLjava/lang/Class;Ljava/lang/String;)V")
	@Override
	public void method9385(@OriginalArg(1) Class arg0, @OriginalArg(2) String arg1) {
