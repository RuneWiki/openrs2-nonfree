...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface11 {
	...
	@OriginalMember(owner = "loader!g", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;I)V")
	@Override
	public void method5915(@OriginalArg(0) String arg0, @OriginalArg(1) Class arg1) {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(15) byte[] local15 = this.anUnpack1.method5893(arg0);
		if (local15 == null) {
