...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface12 {
	...
	@OriginalMember(owner = "loader!f", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;B)V")
	@Override
	public void method5686(@OriginalArg(0) Class arg0, @OriginalArg(1) String arg1) {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(16) byte[] local16 = this.anUnpack1.method5673(arg0);
		if (local16 == null) {
