...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface12 {

	@OriginalMember(owner = "loader!g", name = "a", descriptor = "Ljava/util/Hashtable;")
	private final Hashtable aHashtable2 = new Hashtable();

	@OriginalMember(owner = "loader!g", name = "b", descriptor = "Lloader!unpack;")
	private final unpack anUnpack1;

	@OriginalMember(owner = "loader!g", name = "c", descriptor = "Ljava/security/ProtectionDomain;")
	...
	@OriginalMember(owner = "loader!g", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/Class;)V")
	@Override
	public void method5806(@OriginalArg(1) String arg0, @OriginalArg(2) Class arg1) {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(16) byte[] local16 = this.anUnpack1.method5762(arg0);
		if (local16 == null) {
