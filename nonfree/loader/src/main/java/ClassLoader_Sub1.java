...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface13 {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(16) byte[] local16 = this.anUnpack1.method6016(arg0);
		if (local16 == null) {
	...
	@OriginalMember(owner = "loader!h", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/Class;)V")
	@Override
	public void method6056(@OriginalArg(1) String arg0, @OriginalArg(2) Class arg1) {
		this.aHashtable4.put(arg0, arg1);
	}
}
