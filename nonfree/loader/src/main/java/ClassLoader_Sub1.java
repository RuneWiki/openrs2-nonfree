...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface24 {
	...
	@OriginalMember(owner = "loader!e", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/String;)V")
	@Override
	public void method7909(@OriginalArg(0) Class arg0, @OriginalArg(2) String arg1) {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(16) byte[] local16 = this.anUnpack1.method7903(arg0);
		if (local16 == null) {
