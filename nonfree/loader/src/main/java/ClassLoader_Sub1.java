...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface28 {
	...
	private final Hashtable aHashtable38 = new Hashtable();

	@OriginalMember(owner = "loader!e", name = "c", descriptor = "Lloader!unpack;")
	private final unpack anUnpack1;

	@OriginalMember(owner = "loader!e", name = "b", descriptor = "Ljava/security/ProtectionDomain;")
	...
	@Override
	public void method8841(@OriginalArg(1) String arg0, @OriginalArg(2) Class arg1) {
		this.aHashtable38.put(arg0, arg1);
	}
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		@Pc(5) Class local5 = (Class) this.aHashtable38.get(arg0);
		if (local5 != null) {
			return local5;
		}
		@Pc(16) byte[] local16 = this.anUnpack1.method8839(arg0);
		if (local16 == null) {
		...
		this.aHashtable38.put(arg0, local5);
		return local5;
	}
}
