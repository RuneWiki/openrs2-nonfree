...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface28 {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(16) byte[] local16 = this.anUnpack1.method9332(arg0);
		if (local16 == null) {
	...
	@OriginalMember(owner = "loader!h", name = "a", descriptor = "(ZLjava/lang/Class;Ljava/lang/String;)V")
	@Override
	public void method9335(@OriginalArg(1) Class arg0, @OriginalArg(2) String arg1) {
