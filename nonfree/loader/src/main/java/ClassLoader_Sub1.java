...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface13 {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(16) byte[] local16 = this.anUnpack1.method6079(arg0);
		if (local16 == null) {
	...
	@OriginalMember(owner = "loader!g", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;Z)V")
	@Override
	public void method6088(@OriginalArg(0) Class arg0, @OriginalArg(1) String arg1) {
