...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface25 {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(15) byte[] local15 = this.anUnpack1.method7883(arg0);
		if (local15 == null) {
	...
	@OriginalMember(owner = "loader!b", name = "a", descriptor = "(Ljava/lang/Class;ZLjava/lang/String;)V")
	@Override
	public void method7881(@OriginalArg(0) Class arg0, @OriginalArg(2) String arg1) {
