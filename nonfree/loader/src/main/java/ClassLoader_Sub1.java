...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface28 {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(16) byte[] local16 = this.anUnpack1.method9067(arg0);
		if (local16 == null) {
	...
	@OriginalMember(owner = "loader!c", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;)V")
	@Override
	public void method9065(@OriginalArg(1) String arg0, @OriginalArg(2) Class arg1) {
