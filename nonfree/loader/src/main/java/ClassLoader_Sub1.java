...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface25 {
	...
	@OriginalMember(owner = "loader!c", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I)V")
	@Override
	public void method8450(@OriginalArg(0) Class arg0, @OriginalArg(1) String arg1) {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(17) byte[] local17 = this.anUnpack1.method8460(arg0);
		if (local17 == null) {
