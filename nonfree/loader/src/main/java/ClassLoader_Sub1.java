...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface21 {

	@OriginalMember(owner = "loader!e", name = "a", descriptor = "Ljava/util/Hashtable;")
	private final Hashtable aHashtable16 = new Hashtable();

	@OriginalMember(owner = "loader!e", name = "b", descriptor = "Lloader!unpack;")
	private final unpack anUnpack1;

	@OriginalMember(owner = "loader!e", name = "c", descriptor = "Ljava/security/ProtectionDomain;")
	private final ProtectionDomain aProtectionDomain1;

	@OriginalMember(owner = "loader!e", name = "<init>", descriptor = "(Lloader!unpack;)V")
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		@Pc(5) Class local5 = (Class) this.aHashtable16.get(arg0);
		if (local5 != null) {
			return local5;
		}
		@Pc(16) byte[] local16 = this.anUnpack1.method8028(arg0);
		if (local16 == null) {
		...
		this.aHashtable16.put(arg0, local5);
		return local5;
	}

	@OriginalMember(owner = "loader!e", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/Class;)V")
	@Override
	public void method8066(@OriginalArg(0) String arg0, @OriginalArg(2) Class arg1) {
		this.aHashtable16.put(arg0, arg1);
	}
}
