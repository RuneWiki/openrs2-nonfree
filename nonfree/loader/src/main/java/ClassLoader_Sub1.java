...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface12 {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(16) byte[] local16 = this.anUnpack1.method6151(arg0);
		if (local16 == null) {
	...
	@OriginalMember(owner = "loader!g", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;Z)V")
	@Override
	public void method6158(@OriginalArg(0) String arg0, @OriginalArg(1) Class arg1) {
