...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface22 {
	...
	@Override
	public void method8286(@OriginalArg(0) String arg0, @OriginalArg(2) Class arg1) {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(16) byte[] local16 = this.anUnpack1.method8288(arg0);
		if (local16 == null) {
