...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface21 {
	...
	@OriginalMember(owner = "loader!d", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/Class;)V")
	@Override
	public void method7498(@OriginalArg(1) String arg0, @OriginalArg(2) Class arg1) {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(16) byte[] local16 = this.anUnpack1.method7510(arg0);
		if (local16 == null) {
