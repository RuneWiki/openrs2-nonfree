...
public final class ClassLoader_Sub1 extends ClassLoader implements Interface28 {
	...
	@OriginalMember(owner = "loader!a", name = "a", descriptor = "(ZLjava/lang/String;Ljava/lang/Class;)V")
	@Override
	public void method9054(@OriginalArg(1) String arg0, @OriginalArg(2) Class arg1) {
	...
	public synchronized Class loadClass(@OriginalArg(0) String arg0, @OriginalArg(1) boolean arg1) throws ClassNotFoundException {
		...
		@Pc(15) byte[] local15 = this.anUnpack1.method9064(arg0);
		if (local15 == null) {
